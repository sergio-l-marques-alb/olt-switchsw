...
sbZfC2MmWidePortMemory36BitsNoProtection_Print(sbZfC2MmWidePortMemory36BitsNoProtection_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmWidePortMemory36BitsNoProtection:: d1prt=0x%01x"), (unsigned int)  pFromStruct->m_uData1ProtectionBits));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmWidePortMemory36BitsNoProtection:: data0=0x%08x"), (unsigned int)  pFromStruct->m_uData0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
