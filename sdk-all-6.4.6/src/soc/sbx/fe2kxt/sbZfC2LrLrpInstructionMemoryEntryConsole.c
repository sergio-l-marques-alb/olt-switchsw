...
sbZfC2LrLrpInstructionMemoryEntry_Print(sbZfC2LrLrpInstructionMemoryEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2LrLrpInstructionMemoryEntry:: thread=0x%01x"), (unsigned int)  pFromStruct->m_uThread));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2LrLrpInstructionMemoryEntry:: target=0x%05x"), (unsigned int)  pFromStruct->m_uTarget));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2LrLrpInstructionMemoryEntry:: sourceb=0x%04x"), (unsigned int)  pFromStruct->m_uSourceB));
  LOG_WARN(BSL_LS_SOC_COMMON,
