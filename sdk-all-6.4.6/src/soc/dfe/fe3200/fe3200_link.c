 /* 
 * $Id: fe3200_link.c,v 1.3 Broadcom SDK $
...
/*
 * Link Control Driver - FE3200
 */
CONST soc_linkctrl_driver_t  soc_linkctrl_driver_fe3200 = {
    NULL,                                       /* port mapping */
    _soc_fe3200_linkctrl_linkscan_hw_init,      /* ld_linkscan_hw_init */
    _soc_fe3200_linkctrl_linkscan_config,       /* ld_linkscan_config */
    _soc_fe3200_linkctrl_linkscan_pause,        /* ld_linkscan_pause */
    _soc_fe3200_linkctrl_linkscan_continue,     /* ld_linkscan_continue */
    _soc_fe3200_linkctrl_update,                /* ld_update */
    _soc_fe3200_linkctrl_hw_link_get            /* ld_hw_link_get */
