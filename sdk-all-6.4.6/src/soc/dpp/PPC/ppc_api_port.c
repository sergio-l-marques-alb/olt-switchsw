  ...
  )
{
  ...
  sal_memset(info, 0x0, sizeof(SOC_PPC_PORT_EXTEND_P2P_INFO));
  info->enable_incoming_extend_p2p = 0;
  info->enable_outgoing_extend_p2p = 0;
  ...
  )
{
  ...
  SOC_PPC_PORT_EXTEND_P2P_INFO_clear(&(info->extend_p2p_info));
  ...
  )
{
  ...
  LOG_CLI((BSL_META_U(unit,
                      "enable_incoming_extend_p2p: %u\n\r"),info->enable_incoming_extend_p2p));
  LOG_CLI((BSL_META_U(unit,
                      "enable_outgoing_extend_p2p: %u\n\r"),info->enable_outgoing_extend_p2p));
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
  ...
  )
{
  ...
  LOG_CLI((BSL_META_U(unit,
                      "extend_p2p_info:")));
  SOC_PPC_PORT_EXTEND_P2P_INFO_print(&(info->extend_p2p_info));
  LOG_CLI((BSL_META_U(unit,
