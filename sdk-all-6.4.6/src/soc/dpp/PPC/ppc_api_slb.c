...
static _soc_ppc_slb_object_info _soc_ppc_slb_object_infos[] = { 
  ...
  ABSTRACT_OBJECT_INFO(CONFIGURATION_ITEM, BASE),
    ...
    OBJECT_INFO(CONFIGURATION_ITEM_HASH_FUNCTION, CONFIGURATION_ITEM),
    ...
    OBJECT_INFO(CONFIGURATION_ITEM_HASH_OFFSET, CONFIGURATION_ITEM),
...
STATIC void SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_FUNCTION_print(SOC_SAND_IN SOC_PPC_SLB_OBJECT *untyped_obj, SOC_SAND_IN _soc_ppc_slb_object_info *info)
{
  SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_FUNCTION *obj = (SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_FUNCTION*)untyped_obj;
...
STATIC void SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_OFFSET_print(SOC_SAND_IN SOC_PPC_SLB_OBJECT *untyped_obj, SOC_SAND_IN _soc_ppc_slb_object_info *info)
{
  SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_OFFSET *obj = (SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_OFFSET*)untyped_obj;
...
void SOC_PPC_SLB_clear(SOC_SAND_OUT SOC_PPC_SLB_OBJECT *info, SOC_SAND_IN SOC_PPC_SLB_OBJECT_TYPE type)
{
  ...
  /* If clear is needed, then traverse can be used to clear all types in tree. */
