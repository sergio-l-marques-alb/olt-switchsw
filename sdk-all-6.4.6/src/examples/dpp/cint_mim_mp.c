 ...
 *
 ...
 cint
 int mim_vsi = 5; 
 * main(0, port1, port2, port3, port4,0,mim_vsi); 
 *  
 * for B-VID flooding: 
...
drop_and_continue_2pass_example(int unit, int recycle_port, int port_1) {
    ...
    rv = two_pass_snoop_set(0, bcmRxTrapMimMyBmacMulticastContinue, recycle_port, &snoop_trap_gport_id);
