...
/* $Id: cint_l2_cache.c,v 1.7 Broadcom SDK $
 ...
 *  
 * Calling l2_cache_init(0, -1, 0x0180, 0xc2000002,  $0x0188, $0xc2005505, 1, 5, 10);
 ...
 *
 * Multi Device
 *  o    For a two-unit example, call l2_cache_init(0, 1, 0x0180, 0xc2000002,  $0x0188, $0xc2005505, 1, 5, 10); 
 * Note:     
...
/*
 * Example:
 * l2_cache_init(0, -1, 0x0180, 0xc2000002,  0x0188, 0xc2005505, 1, 5, 10, 0, 0, 0);   
 */
int
l2_cache_init(int unit, int second_unit, int dest_mac1_high, int dest_mac1_low, int dest_mac2_high, int dest_mac2_low, int src_port, int dest_port, uint8 subtype, int trap_id, int vlan, int is_reserved_vlan){
    int rv;
    bcm_l2_cache_addr_t cache_addr;
    bcm_mac_t mac_add;
 ...
 *      l2_cache_run_with_defaults(0, -1, 1, 5);
 * 
 ...
 */
int 
l2_cache_run_with_defaults(int unit, int second_unit, int src_port, int dest_port){ 
    return l2_cache_init(unit, second_unit, 0x0180, 0xc2000002, 0x0188, 0xc2005505, src_port, dest_port, 10, 0, 0, 0);
}

/*
 * Example: l2_cache_vlan_run_with_defaults(0, -1);  
 * mac 01:80:c2:00:00:02 (lsb 2) vlan 10 default action is trap to CPU.
 * 
 */
int 
l2_cache_mef_l2cp_run_with_defaults(int unit, int second_unit){ 
    ...
    return l2_cache_init(unit, -1, 0x0180, 0xc2000002, 0x0188, 0xc2005505, 0, 0, 0, trap_id, 10, 1);
}
