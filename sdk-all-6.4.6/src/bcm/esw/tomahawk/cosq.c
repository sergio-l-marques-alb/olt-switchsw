    ...
    if (type == bcmCosqControlIngressPoolLimitBytes) {
        BCM_IF_ERROR_RETURN
            (_bcm_th_cosq_ing_pool_get(unit, gport, cosq,
                                       ...
                                       &pool));
        SOC_IF_ERROR_RETURN
            (READ_THDI_BUFFER_CELL_LIMIT_SPr(unit, pool, &rval));
        *arg = soc_reg_field_get(unit, THDI_BUFFER_CELL_LIMIT_SPr, rval, LIMITf);
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_th_cosq_ing_pool_get(unit, gport, cosq,
                                       ...
                                       &pool));
        SOC_IF_ERROR_RETURN
            (READ_THDI_HDRM_BUFFER_CELL_LIMIT_HPr(unit, pool, &rval));
        *arg = soc_reg_field_get(unit, THDI_HDRM_BUFFER_CELL_LIMIT_HPr, rval, LIMITf);
    } else {
        return BCM_E_PARAM;
    }
    ...
    if (type == bcmCosqControlIngressPoolLimitBytes) {
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_th_cosq_ing_pool_get(unit, gport, cosq,
                                       bcmCosqControlIngressHeadroomPool,
                                       &pool));
        soc_reg_field_set(unit, THDI_HDRM_BUFFER_CELL_LIMIT_HPr, &rval, LIMITf, arg);
        SOC_IF_ERROR_RETURN(
