...
typedef int (*sw_state_dpp_soc_arad_tm_lag_in_use_set_cb)(
    int _unit, int in_use_idx, uint8 in_use);
...
typedef int (*sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_set_cb)(
    int _unit, int local_to_reassembly_context_idx, uint32 local_to_reassembly_context);
...
int sw_state_dpp_soc_arad_tm_lag_access_cb_init(int _unit);
