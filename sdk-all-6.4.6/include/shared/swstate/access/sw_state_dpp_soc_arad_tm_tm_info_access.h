...
#ifdef LINK_ARAD_LIBRARIES
/* implemented by: sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_set */
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_set_cb)(
    int _unit, int src_port_vsq_idx_0, int src_port_vsq_idx_1, int src_port_vsq);
#endif

#ifdef LINK_ARAD_LIBRARIES
/* implemented by: sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_get */
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_get_cb)(
    int _unit, int src_port_vsq_idx_0, int src_port_vsq_idx_1, int *src_port_vsq);
#endif
...
#ifdef LINK_ARAD_LIBRARIES
typedef struct sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_cbs_s {
#ifdef LINK_ARAD_LIBRARIES
    sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_set_cb set;
    sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_get_cb get;
#endif
} sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_cbs_t;
#endif
...
#endif
#ifdef LINK_ARAD_LIBRARIES
    sw_state_dpp_soc_arad_tm_tm_info_src_port_vsq_cbs_t src_port_vsq;
#endif
#ifdef LINK_ARAD_LIBRARIES
