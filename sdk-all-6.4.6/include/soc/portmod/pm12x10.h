...
int pm12x10_port_interface_config_set(int unit, int port, pm_info_t pm_info, const portmod_port_interface_config_t* config, int all_phy);
...
int pm12x10_port_ifg_set(int unit, int port, pm_info_t pm_info, int speed, soc_port_duplex_t duplex, int ifg, int* real_ifg);
int pm12x10_port_ifg_get(int unit, int port, pm_info_t pm_info, int speed, soc_port_duplex_t duplex, int* ifg);
...
int pm12x10_port_soft_reset_set(int unit, int port, pm_info_t pm_info, int idx, int val);

/*Port tx_en=0 and softreset mac*/
int pm12x10_port_tx_down(int unit, int port, pm_info_t pm_info);

/*reconfig pgw.*/
int pm12x10_port_pgw_reconfig(int unit, int port, pm_info_t pm_info, const portmod_port_mode_info_t* pmode, int flags);
