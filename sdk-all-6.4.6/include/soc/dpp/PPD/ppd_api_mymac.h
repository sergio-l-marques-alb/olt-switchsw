...
#define SOC_PPD_MYMAC_VRRP_MODE_ALL_VSI_BASED                  SOC_PPC_MYMAC_VRRP_MODE_ALL_VSI_BASED
#define SOC_PPD_MYMAC_VRRP_MODE_256_VSI_BASED                  SOC_PPC_MYMAC_VRRP_MODE_256_VSI_BASED
#define SOC_PPD_MYMAC_VRRP_MODE_512_VSI_BASED                  SOC_PPC_MYMAC_VRRP_MODE_512_VSI_BASED
#define SOC_PPD_MYMAC_VRRP_MODE_1K_VSI_BASED                  SOC_PPC_MYMAC_VRRP_MODE_1K_VSI_BASED
#define SOC_PPD_MYMAC_VRRP_MODE_2K_VSI_BASED                  SOC_PPC_MYMAC_VRRP_MODE_2K_VSI_BASED
typedef SOC_PPC_MYMAC_VRRP_MODE                                SOC_PPD_MYMAC_VRRP_MODE;

typedef SOC_PPC_MYMAC_VRRP_INFO                                SOC_PPD_MYMAC_VRRP_INFO;
typedef SOC_PPC_MYMAC_TRILL_INFO                               SOC_PPD_MYMAC_TRILL_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_mymac_get_procs_ptr(void);
