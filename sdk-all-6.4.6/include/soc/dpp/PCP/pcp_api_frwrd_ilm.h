/* $Id: pcp_api_frwrd_ilm.h,v 1.3 Broadcom SDK $
...
#ifndef __SOC_PCP_API_FRWRD_ILM_INCLUDED__
/* { */
#define __SOC_PCP_API_FRWRD_ILM_INCLUDED__
...
typedef SOC_PPC_FRWRD_ILM_GLBL_KEY_INFO                        PCP_FRWRD_ILM_GLBL_KEY_INFO;
typedef SOC_PPC_FRWRD_ILM_GLBL_ELSP_INFO                       PCP_FRWRD_ILM_GLBL_ELSP_INFO;
typedef SOC_PPC_FRWRD_ILM_KEY                                  PCP_FRWRD_ILM_KEY;
typedef SOC_PPC_FRWRD_ILM_GLBL_INFO                            PCP_FRWRD_ILM_GLBL_INFO;
 ...
 *     "pcp_frwrd_ilm_glbl_info_set" API.
 *     Refer to "pcp_frwrd_ilm_glbl_info_set" API for
 *     details.
*********************************************************************/
uint32
  pcp_frwrd_ilm_glbl_info_get(
    SOC_SAND_IN  int                                     unit,
    SOC_SAND_OUT PCP_FRWRD_ILM_GLBL_INFO                     *glbl_info
  );
...
void
  PCP_FRWRD_ILM_GLBL_KEY_INFO_clear(
    SOC_SAND_OUT PCP_FRWRD_ILM_GLBL_KEY_INFO *info
  );

void
  PCP_FRWRD_ILM_GLBL_ELSP_INFO_clear(
    SOC_SAND_OUT PCP_FRWRD_ILM_GLBL_ELSP_INFO *info
  );

void
  PCP_FRWRD_ILM_KEY_clear(
    SOC_SAND_OUT PCP_FRWRD_ILM_KEY *info
  );

void
  PCP_FRWRD_ILM_GLBL_INFO_clear(
    SOC_SAND_OUT PCP_FRWRD_ILM_GLBL_INFO *info
  );

#if PCP_DEBUG_IS_LVL1

void
  PCP_FRWRD_ILM_GLBL_KEY_INFO_print(
    SOC_SAND_IN  PCP_FRWRD_ILM_GLBL_KEY_INFO *info
  );

void
  PCP_FRWRD_ILM_GLBL_ELSP_INFO_print(
    SOC_SAND_IN  PCP_FRWRD_ILM_GLBL_ELSP_INFO *info
  );

void
  PCP_FRWRD_ILM_KEY_print(
    SOC_SAND_IN  PCP_FRWRD_ILM_KEY *info
  );

void
  PCP_FRWRD_ILM_GLBL_INFO_print(
    SOC_SAND_IN  PCP_FRWRD_ILM_GLBL_INFO *info
  );
...
/* } __SOC_PCP_API_FRWRD_ILM_INCLUDED__*/
#endif
