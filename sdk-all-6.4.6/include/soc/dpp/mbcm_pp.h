...
(int,  int, uint32, uint16, int);

typedef int (*mbcm_pp_bfd_one_hop_lem_entry_remove_f)
(int,  uint32);

typedef int (*mbcm_pp_oam_bfd_acc_endpoint_tx_disable_f) (int, uint32, SOC_PPC_OAM_OAMP_MEP_DB_ENTRY*);
...
typedef struct mbcm_pp_functions_s {
    ...
    mbcm_pp_bfd_one_hop_lem_entry_add_f            mbcm_pp_bfd_one_hop_lem_entry_add;
    mbcm_pp_bfd_one_hop_lem_entry_remove_f 		   mbcm_pp_bfd_one_hop_lem_entry_remove;
