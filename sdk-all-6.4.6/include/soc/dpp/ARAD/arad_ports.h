...
soc_error_t arad_port_prbs_tx_enable_set(int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
soc_error_t arad_port_prbs_tx_enable_get(int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
soc_error_t arad_port_prbs_rx_enable_set(int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
soc_error_t arad_port_prbs_rx_enable_get(int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
soc_error_t arad_port_prbs_rx_status_get(int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
soc_error_t arad_port_prbs_tx_invert_data_set(int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
soc_error_t arad_port_prbs_tx_invert_data_get(int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
