...
uint32
  arad_pp_l2_lif_extender_get_internal_unsafe(
    SOC_SAND_IN  int                                     unit,
    SOC_SAND_IN  ARAD_PP_L2_LIF_EXTENDER_KEY            *extender_key,
    SOC_SAND_IN  uint8                                  ignore_key, 
    SOC_SAND_OUT ARAD_PP_LIF_ID                         *lif_index,
    SOC_SAND_OUT ARAD_PP_L2_LIF_EXTENDER_INFO           *extender_info,
    SOC_SAND_OUT uint8                                  *found
  );
...
uint32
  ARAD_PP_L2_LIF_EXTENDER_KEY_verify(
    SOC_SAND_IN  ARAD_PP_L2_LIF_EXTENDER_KEY *info
  );

uint32
  ARAD_PP_L2_LIF_EXTENDER_INFO_verify(
    SOC_SAND_IN  int unit,
