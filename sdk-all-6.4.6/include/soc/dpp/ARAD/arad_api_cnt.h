 ...
 *     algorithm.                                              */
#define  ARAD_CNT_CACHE_LENGTH (SOC_TMC_CNT_CACHE_LENGTH_ARAD)
...
#define ARAD_CNT_NOF_SRC_TYPES                               SOC_TMC_CNT_NOF_SRC_TYPES_ARAD
...
typedef SOC_TMC_CNT_VOQ_PARAMS                                 ARAD_CNT_VOQ_PARAMS;
