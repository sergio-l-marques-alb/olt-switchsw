...
/* 
 *  Copy width bits from reg_above_64_val offset reg_above_64_start_bit to bit array uint32_arr offset uint32_arr_start_bit
 *                                                                                                                                       *
...
extern uint32 soc_reg_addr_get(int unit, soc_reg_t reg, int port, int index, int is_write,
...
#define SOC_REG_BASE_TYPE(unit, mem)  ((SOC_REG_INFO(unit, reg).offset >> \
                                        23) & 0x7)
