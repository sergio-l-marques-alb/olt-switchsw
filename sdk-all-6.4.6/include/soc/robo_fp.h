...
typedef enum drv_field_qualify_e {
    ...
    drvFieldQualifyCount = 529          /* Always Last. Not a usable value. */
} drv_field_qualify_t;
...
typedef enum drv_field_action_e {
    ...
    drvFieldActionReserved1 = 370,      /* Reserved slot 1. */
    drvFieldActionReserved2 = 371,      /* Reserved slot 2. */
    drvFieldActionReserved3 = 372,      /* Reserved slot 3. */
    drvFieldActionReserved4 = 373,      /* Reserved slot 4. */
    ...
    drvFieldActionCount = 392           /* Always Last. Not a usable value. */
} drv_field_action_t;
