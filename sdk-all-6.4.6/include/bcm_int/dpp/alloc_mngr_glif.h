...
typedef struct {
    int egress_lif_to_global_lif[SOC_DPP_DEFS_MAX(NOF_EEDB_LINES)];
    int ingress_lif_to_global_lif[SOC_DPP_DEFS_MAX(NOF_LOCAL_LIFS)];
    bcm_dpp_am_global_lif_bank_type_t global_lif_egress_bank_types[_BCM_DPP_AM_MAX_GLOBAL_LIF_BANKS];
    bcm_dpp_am_global_lif_bank_type_t global_lif_ingress_bank_types[_BCM_DPP_AM_MAX_GLOBAL_LIF_BANKS];
