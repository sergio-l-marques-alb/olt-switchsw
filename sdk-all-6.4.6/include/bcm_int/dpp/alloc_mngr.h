...
int _bcm_dpp_am_template_meter_data_get(int unit,int core_id, int meter_profile,int group, int high_rate, bcm_dpp_am_meter_entry_t *meter_profile_info);
int _bcm_dpp_am_template_meter_exchange(int unit, int core_id, int meter_profile, int group, int high_rate, bcm_dpp_am_meter_entry_t *meter_profile_info,  int *is_last, int *new_meter_profile, int change_profile, int *is_allocated);
...
#define BCM_DPP_AM_FLAG_ALLOC_WITH_ID               (SHR_RES_ALLOC_WITH_ID) /*0x00000001*/
...
#define BCM_DPP_AM_FLAG_ALLOC_INGRESS               (0x00000020)
#define BCM_DPP_AM_FLAG_ALLOC_EGRESS                (0x00000040)
...
int _bcm_dpp_lif_id_is_mapped(int unit, uint8 is_ingress, int global_lif, uint8 *is_mapped);
