 ...
 *
 * File:        soc/shared/dcbformats/type26.h
 * Purpose:     Define dma control block (DCB) format for a type26 DCB
 *              used by the 56850 (Trident2)
 *
 *              This file is shared between the SDK and the embedded applications.
 */

#ifndef _SOC_SHARED_DCBFORMATS_TYPE26_H
#define _SOC_SHARED_DCBFOMATS_TYPE26_H
 ...
 */
typedef struct {
    uint32  addr;                       /* T26.0: physical address */
                                        /* T26.1: Control 0 */
#ifdef  LE_HOST
    ...
    uint32  :9,                         /* Don't care */
            ...
            c_count:16;                 /* Requested byte count */
                                        ...
                                        /* T26.2 (word 12 in EP_TO_CPU_HDR) */
    uint32  reason_hi;                  /* CPU opcode (hi bits) */
                                        /* T26.3 (word 11 in EP_TO_CPU_HDR) */
    uint32  reason;                     /* CPU opcode (low bits) */

#ifdef  LE_HOST
    union {                             /* T26.4 (word 10 in EP_TO_CPU_HDR) */
        struct {
    ...
    uint32  hgi:2,                      /* Higig Interface Format Indicator */
            ...
            srcport:7;                  /* Source port number */
                                        ...
                                        /* T26.6 (word 8 in EP_TO_CPU_HDR) */
    uint32  mh0;                        /* Module Header word 0 */
                                        /* T26.7 (word 7 in EP_TO_CPU_HDR) */
    uint32  mh1;                        /* Module Header word 1 */
                                        /* T26.8 (word 6 in EP_TO_CPU_HDR) */
    uint32  mh2;                        /* Module Header word 2 */
                                        /* T26.9 (word 5 in EP_TO_CPU_HDR) */
    uint32  mh3;                        /* Module Header word 3 */

#ifdef  LE_HOST
                                        /* T26.10 (word 4 in EP_TO_CPU_HDR) */
    ...
    union {                             /* T26.11 (word 3 in EP_TO_CPU_HDR) */
        struct {
...
#endif
                                        /* T26.12 (word 2 in EP_TO_CPU_HDR) */
    uint32  timestamp;                  /* Timestamp */

#ifdef  LE_HOST
                                        /* T26.13 (word 1 in EP_TO_CPU_HDR) */
    ...
    union {                             /* T26.14 (word 0 in EP_TO_CPU_HDR) */
