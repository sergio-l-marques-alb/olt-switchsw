/*
 * $Id: 07fa0a79f6f366a42b0d2fea6b5693b9c76a42e7 $
 * 
...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyAppType,             /*  Packet Application type
                                           (bcmFieldAppTypeXXX). */
    bcmFieldQualifySubportPktTag,       /* Ingress LLTAG. */
    bcmFieldQualifySrcVxlanGport,       /* Qualify vxlan source gport. */
    bcmFieldQualifyDstVxlanGport,       /*  Qualify vxlan destination gport. */
    bcmFieldQualifyOamMdl,              /*  Qualify OAM Maintenance Domain
                                           Levels. */
    bcmFieldQualifyReserved334 = 334,   /*  Reserved. */
    ...
    bcmFieldQualifyFhei = 338,          /*  DNX FHEI header field. */
    bcmFieldQualifyFheiSize = 339,      /*  DNX FHEI header size in bytes. */
    bcmFieldQualifyCount = 340          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionUnmodifiedPacketRedirectPort, /* Redirect Unmodified Packet to single
                                           port; param0: Destination Gport. */
    bcmFieldActionEtagNew,              /* Replace Port Extender ETAG if
                                           present, add if not present; param0:
                                           ETAG. */
    bcmFieldActionEtagDelete,           /* Delete Port Extender ETAG. */
    bcmFieldActionRedirDropPrecedence,  /* Set the redirect drop precedence of
                                           packets. param0:BCM_FIELD_COLOR_xxx
                                           param1:n/a. */
    bcmFieldActionRpRedirDropPrecedence, /* Set the redirect drop precedence of
                                           Red packets.
                                           param0:BCM_FIELD_COLOR_xxx
                                           param1:n/a. */
    bcmFieldActionYpRedirDropPrecedence, /* Set the redirect drop precedence of
                                           Yellow packets.
                                           param0:BCM_FIELD_COLOR_xxx
                                           param1:n/a. */
    bcmFieldActionGpRedirDropPrecedence, /* Set the redirect drop precedence of
                                           Green packets.
                                           param0:BCM_FIELD_COLOR_xxx
                                           param1:n/a. */
