...
/*
 *  Disable direct RDB addressing mode, write to SDB register 0x87 = 0x8000
 *  - MDIO write to reg 0x1E = 0x0087
 *  - MDIO write to reg 0x1F = 0x8000
 */
#define PHY_BCM542XX_DIS_RDB_MODE(_u, _pc)  do {  \
    SOC_IF_ERROR_RETURN  \
 ...
 */
#define PHY_BCM542XX_EN_RDB_MODE(_u, _pc)  do {  \
    SOC_IF_ERROR_RETURN  \
 ...
 */
#define PHY_BCM542XX_2ND_SERDES_MII_CTRL_REG_OFFSET  (0xb00)
 ...
 */
#define PHY_BCM542XX_2ND_SERDES_MISC_1000x_REG_OFFSET  (0xb17)
