/*
 * $Id: phy542xx_int.h 1.6 Broadcom SDK $ 
...
int
phy_bcm542xx_direct_reg_read(int unit, phy_ctrl_t *pc, uint16 reg_addr,
        uint16 *data);

int
phy_bcm542xx_direct_reg_write(int unit, phy_ctrl_t *pc, uint16 reg_addr,
        uint16 data);

int
phy_bcm542xx_direct_reg_modify(int unit, phy_ctrl_t *pc, uint16 reg_addr,
        uint16 data, uint16 mask);

int
phy_bcm542xx_qsgmii_reg_read(int unit, phy_ctrl_t *pc, int dev_port,
        uint16 block, uint8 reg, uint16 *data);
int
phy_bcm542xx_qsgmii_reg_write(int unit, phy_ctrl_t *pc, int dev_port,
        uint16 block, uint8 reg, uint16 data);
int
phy_bcm542xx_qsgmii_reg_modify(int unit, phy_ctrl_t *pc, int dev_port,
...
#define PHY_BCM542XX_DEV_PHY_ID_ORIG(_pc) (((PHY_BCM542XX_DEV_DESC_t *)((_pc) + 1))->phy_id_orig)
#define PHY_BCM542XX_DEV_PHY_ID_BASE(_pc) (((PHY_BCM542XX_DEV_DESC_t *)((_pc) + 1))->phy_id_base)
#define PHY_BCM542XX_DEV_PHY_SLICE(_pc) (((PHY_BCM542XX_DEV_DESC_t *)((_pc) + 1))->phy_slice)
#define PHY_BCM542XX_FLAGS(_pc) (((PHY_BCM542XX_DEV_DESC_t *)((_pc) + 1))->flags)
#define PHY_BCM542XX_PHYA_REV (1U << 0)

#define PHY_BCM542XX_DEV_SET_BASE_ADDR(_pc) \
        PHY_BCM542XX_DEV_PHY_ID_BASE(_pc) =  (PHY_BCM542XX_FLAGS((_pc)) & PHY_BCM542XX_PHYA_REV) ?\
                                             PHY_BCM542XX_DEV_PHY_ID_ORIG(_pc) + PHY_BCM542XX_DEV_PHY_SLICE(_pc) : \
                                             PHY_BCM542XX_DEV_PHY_ID_ORIG(_pc) - PHY_BCM542XX_DEV_PHY_SLICE(_pc)

#define PHY_BCM542XX_SLICE_ADDR(_pc, _slice) \
            (PHY_BCM542XX_FLAGS((_pc)) & PHY_BCM542XX_PHYA_REV) ? (PHY_BCM542XX_DEV_PHY_ID_BASE(_pc) - (_slice)) : \
