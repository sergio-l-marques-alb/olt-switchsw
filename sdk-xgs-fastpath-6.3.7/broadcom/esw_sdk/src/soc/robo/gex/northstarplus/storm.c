/*
 * $Id: storm.c 1.1.2.2 Broadcom SDK $
 *
...
drv_nsp_storm_control_enable_set(int unit, uint32 port, uint8 enable)
{
    ...
    soc_cm_debug(DK_PORT, "drv_nsp_storm_control_enable_set: \
...
drv_nsp_storm_control_enable_get(int unit, uint32 port, uint8 *enable)
{
    ...
    *enable = temp;
    ...
    soc_cm_debug(DK_PORT, "drv_nsp_storm_control_enable_get: \
        unit = %d, port = %d, %sable\n", unit, port, (*enable) ? "en" : "dis");
    ...
    uint32 limit, uint32 burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "drv_nsp_storm_control_set: \
    ...
    uint32 *limit, uint32 *burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "drv_nsp_storm_control_get: \
