...
/*****************************************************************************************/
/*                                                                                       */
/*  Revision      :  $Id: eagle_merlin_api_uc_common.h 586 2014-06-10 21:59:54Z kirand $ */
/*                                                                                       */
...
enum eagle_tsc_pmd_uc_cmd_enum {
  CMD_NULL                =  0,
  CMD_UC_CTRL             =  1,
  CMD_HEYE_OFFSET         =  2,
  CMD_VEYE_OFFSET         =  3,
...
enum eagle_tsc_pmd_uc_ctrl_cmd_enum {
...
enum eagle_tsc_pmd_event_rd_cmd_enum {
...
enum eagle_tsc_pmd_uc_dbg_cmd_enum {
...
enum eagle_tsc_pmd_uc_diag_cmd_enum {
...
enum eagle_tsc_diag_ber_mode_enum {
	DIAG_BER_POS  = 0,   /* bit 0 */
	DIAG_BER_NEG  = 1,
	DIAG_BER_VERT = 0<<1, /* bit 1 */
	DIAG_BER_HORZ = 1<<1,
	DIAG_BER_PASS = 0<<2, /* bit 2 */
	DIAG_BER_INTR = 1<<2,
	DIAG_BER_P1_WIDE = 0<<3, /* bit 3 */
	DIAG_BER_P1_NARROW = 1<<3,
    DIAG_BER_FAST = 1<<6     /* bit 6 */

};


/** Media type Enum */
enum eagle_tsc_media_type_enum {
