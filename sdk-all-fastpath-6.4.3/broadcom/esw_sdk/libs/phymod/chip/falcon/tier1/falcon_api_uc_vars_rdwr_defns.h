...
#define FALCON_API_UC_VARS_RDWR_DEFNS_H
  ...
  #define rdv_usr_ctrl_clk90_offset_adjust()                           falcon_tsc_rdbl_uc_var(pa,__ERR,0x3)
  #define wrv_usr_ctrl_clk90_offset_adjust(wr_val)                     falcon_tsc_wrbl_uc_var(pa,0x3,wr_val)
  ...
  #define rdv_usr_ctrl_dummy()                                         falcon_tsc_rdbl_uc_var(pa,__ERR,0x6)
  #define wrv_usr_ctrl_dummy(wr_val)                                   falcon_tsc_wrbl_uc_var(pa,0x6,wr_val)
