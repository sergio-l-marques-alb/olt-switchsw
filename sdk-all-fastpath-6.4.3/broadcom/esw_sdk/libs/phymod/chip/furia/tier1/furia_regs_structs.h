...
typedef union {
  ...
  struct {
    ...
    uint32_t reserved_05                      :  1; /* FUR_GEN_CNTRLS_gen_control2_t[05] - RSVD */ 
    uint32_t reserved_04                      :  1; /* FUR_GEN_CNTRLS_gen_control2_t[04] - RSVD */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t reserved_09                      :  1; /* FUR_GEN_CNTRLS_gen_control3_t[09] - RSVD */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t rsrvd                            : 12; /* FUR_GEN_CNTRLS_gpreg13_TYPE[11:00] - WO */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t rsrvd                            : 12; /* FUR_GEN_CNTRLS_gpreg13_TYPE[11:00] - WO */ 
    uint32_t en_auto_module_det               :  1; /* FUR_GEN_CNTRLS_gpreg13_TYPE[12] - WO */ 
...
typedef union {
  ...
  #if IS_BIG_ENDIAN
    uint32_t reserved                         :  16;
    uint32_t udms_ln0_lnk_type                :  4; /* FUR_MISC_CTRL_udms_link_t[15:12] - WO */ 
    uint32_t udms_ln1_lnk_type                :  4; /* FUR_MISC_CTRL_udms_link_t[11:08] - WO */ 
    uint32_t udms_ln2_lnk_type                :  4; /* FUR_MISC_CTRL_udms_link_t[07:04] - WO */ 
    uint32_t udms_ln3_lnk_type                :  4; /* FUR_MISC_CTRL_udms_link_t[03:00] - WO */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t udms_ln3_lnk_type                :  4; /* FUR_MISC_CTRL_udms_link_t[03:00] - WO */ 
    uint32_t udms_ln2_lnk_type                :  4; /* FUR_MISC_CTRL_udms_link_t[07:04] - WO */ 
...
typedef union {
  ...
  #if IS_BIG_ENDIAN
    uint32_t reserved                         :  16;
    uint32_t ln0_lnk_status                   :  4; /* FUR_MISC_CTRL_link_type_status_t[15:12] - RO */ 
    uint32_t ln1_lnk_status                   :  4; /* FUR_MISC_CTRL_link_type_status_t[11:08] - RO */ 
    uint32_t ln2_lnk_status                   :  4; /* FUR_MISC_CTRL_link_type_status_t[07:04] - RO */ 
    uint32_t ln3_lnk_status                   :  4; /* FUR_MISC_CTRL_link_type_status_t[03:00] - RO */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t ln3_lnk_status                   :  4; /* FUR_MISC_CTRL_link_type_status_t[03:00] - RO */ 
    uint32_t ln2_lnk_status                   :  4; /* FUR_MISC_CTRL_link_type_status_t[07:04] - RO */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t reserved_00                      :  4; /* LINE_RX_PMA_DP_dp_ctrl_t[03:00] - RSVD */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t reserved_00                      :  4; /* LINE_RX_PMA_DP_dp_ctrl_t[03:00] - RSVD */ 
    uint32_t reserved_04                      :  4; /* LINE_RX_PMA_DP_dp_ctrl_t[07:04] - RSVD */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t reserved_00                      :  4; /* LINE_TX_PMA_DP_ctrl_t[03:00] - RSVD */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t reserved_00                      :  4; /* LINE_TX_PMA_DP_ctrl_t[03:00] - RSVD */ 
    uint32_t reserved_04                      :  4; /* LINE_TX_PMA_DP_ctrl_t[07:04] - RSVD */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t reserved_00                      :  4; /* SYS_RX_PMA_DP_dp_ctrl_t[03:00] - RSVD */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t reserved_00                      :  4; /* SYS_RX_PMA_DP_dp_ctrl_t[03:00] - RSVD */ 
    uint32_t reserved_04                      :  4; /* SYS_RX_PMA_DP_dp_ctrl_t[07:04] - RSVD */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t reserved_00                      :  4; /* SYS_TX_PMA_DP_ctrl_t[03:00] - RSVD */ 
  #endif /* IS_BIG_ENDIAN */
  #if IS_LITTLE_ENDIAN
    uint32_t reserved_00                      :  4; /* SYS_TX_PMA_DP_ctrl_t[03:00] - RSVD */ 
    uint32_t reserved_04                      :  4; /* SYS_TX_PMA_DP_ctrl_t[07:04] - RSVD */ 
...
typedef union {
  ...
  struct {
    ...
    uint32_t software_mode_pmd_ln_dp_h_rstb_0  :  1; /* LINE_FALCON_IF_soft_mode0_TYPE[09] - WO */
    uint32_t software_mode_pmd_ln_dp_h_rstb_1  :  1; /* LINE_FALCON_IF_soft_mode0_TYPE[08] - WO */
    uint32_t software_mode_pmd_ln_dp_h_rstb_2  :  1; /* LINE_FALCON_IF_soft_mode0_TYPE[07] - WO */
    uint32_t software_mode_pmd_ln_dp_h_rstb_3  :  1; /* LINE_FALCON_IF_soft_mode0_TYPE[06] - WO */
...
typedef union {
  ...
  struct {
    ...
    uint32_t software_mode_pmd_ln_dp_h_rstb_0  :  1; /* SYS_FALCON_IF_soft_mode0_TYPE[09] - WO */
    uint32_t software_mode_pmd_ln_dp_h_rstb_1  :  1; /* SYS_FALCON_IF_soft_mode0_TYPE[08] - WO */
    uint32_t software_mode_pmd_ln_dp_h_rstb_2  :  1; /* SYS_FALCON_IF_soft_mode0_TYPE[07] - WO */
    uint32_t software_mode_pmd_ln_dp_h_rstb_3  :  1; /* SYS_FALCON_IF_soft_mode0_TYPE[06] - WO */
