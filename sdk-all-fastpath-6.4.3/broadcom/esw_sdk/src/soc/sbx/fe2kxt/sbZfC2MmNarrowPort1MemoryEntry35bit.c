/*
 * $Id: sbZfC2MmNarrowPort1MemoryEntry35bit.c,v 1.4 Broadcom SDK $
...
sbZfC2MmNarrowPort1MemoryEntry35bit_Pack(sbZfC2MmNarrowPort1MemoryEntry35bit_t *pFrom,
  ...
  (pToData)[0] |= (COMPILER_64_LO((pFrom)->m_uData0)) & 0xFF;
  (pToData)[1] |= (COMPILER_64_LO((pFrom)->m_uData0) >> 8) &0xFF;
  (pToData)[2] |= (COMPILER_64_LO((pFrom)->m_uData0) >> 16) &0xFF;
  (pToData)[3] |= (COMPILER_64_LO((pFrom)->m_uData0) >> 24) &0xFF;
  (pToData)[4] |= (COMPILER_64_HI((pFrom)->m_uData0)) & 0x07;
...
sbZfC2MmNarrowPort1MemoryEntry35bit_Unpack(sbZfC2MmNarrowPort1MemoryEntry35bit_t *pToStruct,
  ...
  (pToStruct)->m_uData1 =  (uint32)  ((pFromData)[4] >> 3) & 0x01;

  /* Unpack Member: m_uData0 */
  COMPILER_64_SET((pToStruct)->m_uData0, 0,  (unsigned int) (pFromData)[0]);
  {
    volatile uint64 *tmp0 = &(pToStruct)->m_uData0;
...
sbZfC2MmNarrowPort1MemoryEntry35bit_InitInstance(sbZfC2MmNarrowPort1MemoryEntry35bit_t *pFrame) {
  ...
  COMPILER_64_ZERO(pFrame->m_uData0);
