...
sbZfC2MmInternal0SegmentConfigEntry_Unpack(sbZfC2MmInternal0SegmentConfigEntry_t *pToStruct,
  ...
  (pToStruct)->m_uInternal0SegmentConfig1 =  (uint32)  ((pFromData)[4] ) & 0x7f;

  /* Unpack Member: m_uInternal0SegmentConfig0 */
  (pToStruct)->m_uInternal0SegmentConfig0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uInternal0SegmentConfig0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uInternal0SegmentConfig0 |=  (uint32)  (pFromData)[2] << 16;
  (pToStruct)->m_uInternal0SegmentConfig0 |=  (uint32)  (pFromData)[3] << 24;
