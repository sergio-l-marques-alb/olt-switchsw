...
sbZfFe2000PmProfileTimerMemory_Print(sbZfFe2000PmProfileTimerMemory_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PmProfileTimerMemory:: resv0=0x%01x"), (unsigned int)  pFromStruct->uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PmProfileTimerMemory:: resv1=0x%07x"), (unsigned int)  pFromStruct->uResv1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv2=0x%02x"), (unsigned int)  pFromStruct->uResv2));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PmProfileTimerMemory:: breset=0x%01x"), (unsigned int)  pFromStruct->bReset));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PmProfileTimerMemory:: deadline=0x%05x"), (unsigned int)  pFromStruct->uDeadline));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
sbZfFe2000PmProfileTimerMemory_SPrint(sbZfFe2000PmProfileTimerMemory_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PmProfileTimerMemory:: resv0=0x%01x", (unsigned int)  pFromStruct->uResv0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PmProfileTimerMemory:: resv1=0x%07x", (unsigned int)  pFromStruct->uResv1);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," resv2=0x%02x", (unsigned int)  pFromStruct->uResv2);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," binterrupt=0x%01x", (unsigned int)  pFromStruct->bInterrupt);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PmProfileTimerMemory:: breset=0x%01x", (unsigned int)  pFromStruct->bReset);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PmProfileTimerMemory:: deadline=0x%05x", (unsigned int)  pFromStruct->uDeadline);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");
