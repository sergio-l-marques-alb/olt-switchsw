...
STATIC void soc_cmicd_block_intr4(int unit, uint32 val);
STATIC void soc_cmicd_block_intr5(int unit, uint32 val);
#endif
#ifdef BCM_CALADAN3_SUPPORT
...
STATIC intr_handler_t soc_cmicm_intr_ser_handlers4[] = {
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 0, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 1, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 2, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 3, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 4, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 5, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 6, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 7, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 8, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 9, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 10, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 11, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 12, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 13, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 14, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 15, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 16, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 17, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 18, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 19, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 20, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 21, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 22, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 23, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 24, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 25, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 26, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 27, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 28, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 29, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 30, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr4, 31, "PARITY INTR" },
    { 0, NULL, 0, "" } /* Termination */
};

STATIC intr_handler_t soc_cmicm_intr_handlers5[] = {
    { IRQ_CMCx_PARITY, soc_cmicd_block_intr5, 0, "PARITY INTR" },
    { 0, NULL, 0, "" } /* Termination */
};
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(unit)) {
        uint32 oldmask, irqMask = SOC_CMCx_IRQ3_MASK(unit,cmc);
...
#if defined(BCM_ESW_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined(BCM_DPP_SUPPORT)
STATIC void
soc_cmicd_block_intr4(int unit, uint32 val)
{
    int cmc;
    uint32 irqStat;
#if defined(BCM_XGS_SUPPORT)
...
STATIC void
soc_cmicd_block_intr5(int unit, uint32 val)
{
    int cmc;
    uint32 irqStat;
#if defined(BCM_XGS_SUPPORT)
...
check_type4:
        for (;;) {
            ...
            } else if (soc_feature(unit, soc_feature_sbus_format_v4)) {
                intr_handler = soc_cmicm_intr_ser_handlers4;
            } else {
