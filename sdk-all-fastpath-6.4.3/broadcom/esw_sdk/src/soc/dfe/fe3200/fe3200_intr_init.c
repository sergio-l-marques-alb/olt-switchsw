...
/*
 * $Id: fe3200_intr_init.c, v1 16/06/2014 09:55:39 azarrin $
 *
...
soc_reg_t soc_fe3200_interrupt_monitor_mem_reg[] = {
    ...
    BRDC_FMAC_AC_ECC_ERR_1B_MONITOR_MEM_MASKr,
    BRDC_FMAC_AC_ECC_ERR_2B_MONITOR_MEM_MASKr,
    BRDC_FMAC_AC_PAR_ERR_MEM_MASKr,
    BRDC_FMAC_BD_ECC_ERR_1B_MONITOR_MEM_MASKr,
    BRDC_FMAC_BD_ECC_ERR_2B_MONITOR_MEM_MASKr,
    BRDC_FMAC_BD_PAR_ERR_MEM_MASKr,
...
int soc_fe3200_ser_init(int unit)
{
    ...
    for(idx=0; soc_fe3200_interrupt_monitor_mem_reg[idx] != INVALIDr; idx++) {
        rc = soc_reg_above_64_set(unit, soc_fe3200_interrupt_monitor_mem_reg[idx], 0, 0, above_64);
        SOCDNX_IF_ERR_EXIT(rc);
    }
