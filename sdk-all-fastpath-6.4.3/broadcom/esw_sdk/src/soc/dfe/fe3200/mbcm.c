...
mbcm_dfe_functions_t mbcm_fe3200_driver = {
    ...
    NULL,/*mbcm_dfe_fabric_links_secondary_only_set*/
    NULL,/*mbcm_dfe_fabric_links_secondary_only_get*/
    ...
    NULL,/*mbcm_dfe_fabric_multicast_multi_set*/
    NULL,/*mbcm_dfe_fabric_multicast_multi_get*/
    ...
    soc_fe3200_port_control_pcs_set,
    soc_fe3200_port_control_pcs_get,
    soc_fe3200_port_control_power_set,
    soc_fe3200_port_control_power_get,
    NULL,/*mbcm_dfe_port_control_strip_crc_set*/
    NULL,/*mbcm_dfe_port_control_strip_crc_get*/
    soc_fe3200_port_control_rx_enable_set,
    soc_fe3200_port_control_tx_enable_set,
    soc_fe3200_port_control_rx_enable_get,
    soc_fe3200_port_control_tx_enable_get,
    soc_fe3200_port_control_low_latency_llfc_set,
    soc_fe3200_port_control_low_latency_llfc_get,
    soc_fe3200_port_control_fec_error_detect_set,
    soc_fe3200_port_control_fec_error_detect_get,
    ...
    soc_fe3200_port_loopback_set,
    soc_fe3200_port_loopback_get,
    ...
    soc_fe3200_port_prbs_tx_enable_set,
    soc_fe3200_port_prbs_tx_enable_get,
    soc_fe3200_port_prbs_rx_enable_set,
    soc_fe3200_port_prbs_rx_enable_get,
    soc_fe3200_port_prbs_rx_status_get,
    soc_fe3200_port_prbs_polynomial_set,
    soc_fe3200_port_prbs_polynomial_get,
    soc_fe3200_port_prbs_tx_invert_data_set,
    soc_fe3200_port_prbs_tx_invert_data_get,
    ...
    soc_fe3200_port_extract_cig_from_llfc_enable_set,
    soc_fe3200_port_extract_cig_from_llfc_enable_get,
    soc_fe3200_port_phy_get,
    soc_fe3200_port_phy_set,
    NULL,/*mbcm_dfe_port_phy_modify*/
