...
soc_error_t soc_fe3200_fabric_flow_control_mid_full_threshold_set(int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value)
{
    ...
    *pipe_lcl = pipe;
    for (idx = 0 ; idx < SOC_DFE_DEFS_GET(unit, nof_instances_dcm); i++)
    {
        for (i = 0 ; i < nof_pipes; i++)
        {
            if (SOC_DCMN_FABRIC_PIPE_IS_SET(pipe_lcl, i))
    ...
    *pipe_lcl = pipe;
    for (i = 0; i < nof_pipes ; i++)
    {
        if (SOC_DCMN_FABRIC_PIPE_IS_SET(pipe_lcl, i))
        {
            if (soc_dfe_fabric_link_fifo_type_index_0 == type_index)
            {
                SOCDNX_IF_ERR_EXIT(READ_DCM_FIFOS_THRESHOLDS_P_TYPE_0r(unit, 0, i, &reg_val64));
                *value = soc_reg64_field32_get(unit, DCM_FIFOS_THRESHOLDS_P_TYPE_0r, reg_val64, DCM_FULL_TH_P_N_TYPE_0f);
                break;
            }
            else
            {
                SOCDNX_IF_ERR_EXIT(READ_DCM_FIFOS_THRESHOLDS_P_TYPE_1r(unit, 0, i, &reg_val64));
...
soc_error_t soc_fe3200_fabric_flow_control_mid_gci_threshold_set(int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value)
{
    ...
    *pipe_lcl = pipe;
    ...
    /*Configure all selected blocks*/ 
    for(idx = 0 ; idx < SOC_DFE_DEFS_GET(unit, nof_instances_dcm) ; idx++) {
        for (i=0; i < nof_pipes; i++)
        {
            if (SOC_DCMN_FABRIC_PIPE_IS_SET(pipe_lcl, i))
            {
    ...
    *pipe_lcl = pipe;
    ...
    {    
        ...
        { 
            if(soc_dfe_fabric_link_fifo_type_index_0 == type_index)
            {
                SOCDNX_IF_ERR_EXIT(READ_DCM_GCI_TH_P_TYPE_0r(unit, 0, i, &reg_val64));
                switch (type)
                {
                    case bcmFabricLinkMidGciLvl1FC:
            ...
            {
                SOCDNX_IF_ERR_EXIT(READ_DCM_GCI_TH_P_TYPE_1r(unit, 0, i, &reg_val64));
                switch (type)
                {
                    case bcmFabricLinkMidGciLvl1FC:
    ...
    *pipe_lcl = pipe;
    ...
    {    
        ...
        { 
            if(soc_dfe_fabric_link_fifo_type_index_0 == type_index)
            {
                SOCDNX_IF_ERR_EXIT(READ_DCM_RCI_TH_P_TYPE_0r(unit, 0, i, &reg_val64));
                switch (type)
                {
                    case bcmFabricLinkMidRciLvl1FC:
            ...
            {
                SOCDNX_IF_ERR_EXIT(READ_DCM_RCI_TH_P_TYPE_1r(unit, 0, i, &reg_val64));
                switch (type)
                {
                    case bcmFabricLinkMidRciLvl1FC:
...
soc_error_t soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_get(int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value)
{
    ...
    if (SOC_DCMN_FABRIC_PIPE_IS_SET(&pipe,0))
    {
        ...
        SOCDNX_IF_ERR_EXIT(READ_DCM_PIPE_0_PRIORITY_DROP_THRESHOLD_TYPEr(unit, 0, array_block, &reg_val64));
    ...
    {
        SOCDNX_IF_ERR_EXIT(READ_DCM_PIPE_1_PRIORITY_DROP_THRESHOLD_TYPEr(unit, 0, array_block, &reg_val64));
    ...
    {
        SOCDNX_IF_ERR_EXIT(READ_DCM_PIPE_2_PRIORITY_DROP_THRESHOLD_TYPEr(unit, 0, array_block, &reg_val64));
...
soc_error_t soc_fe3200_fabric_flow_control_mid_almost_full_threshold_validate(int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value)
{
    ...
    if (type_index == soc_dfe_fabric_link_fifo_type_index_0)
    {
        ...
        rc2 = soc_reg64_field_validate(unit, DCM_FIFOS_THRESHOLDS_P_TYPE_0r, ALM_FULL_1_TH_P_N_TYPE_0f, field_val_64);
    }
    else
    {
        rc1 = soc_reg64_field_validate(unit, DCM_FIFOS_THRESHOLDS_P_TYPE_1r, ALM_FULL_0_TH_P_N_TYPE_1f, field_val_64);
        rc2 = soc_reg64_field_validate(unit, DCM_FIFOS_THRESHOLDS_P_TYPE_1r, ALM_FULL_1_TH_P_N_TYPE_1f, field_val_64);
    }
    ...
    if (SOC_FAILURE(rc2))
    {
        SOCDNX_EXIT_WITH_ERR(rc2, (_BSL_SOCDNX_MSG("value %d isn't a valid for mid almost full threshold"),value));
    }
...
soc_error_t soc_fe3200_fabric_flow_control_mid_fifo_size_threshold_get(int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value)
{
    ...
    /* set an enviorment for when they fix 3rd pipe issues */
    SOCDNX_IF_ERR_EXIT(READ_DCM_FIFOS_DEPTH_TYPEr(unit, 0, array_block, &reg_val));
...
soc_error_t soc_fe3200_fabric_flow_control_tx_fifo_size_threshold_validate(int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value)
{
    ...
    if (value % 4 != 0)
    {
        SOCDNX_EXIT_WITH_ERR(rc1, (_BSL_SOCDNX_MSG("value %d isn't valid for mid fifo size threshold, value must be divisible by 4"),value));
    }

    if (value < 0 || value > 768)
    {
        SOCDNX_EXIT_WITH_ERR(rc1, (_BSL_SOCDNX_MSG("value %d isn't valid for mid fifo size threshold, value must be between 0 and 768"),value));
    }
...
soc_fe3200_init_dcm_thresholds_config(int unit, soc_dfe_drv_dcm_default_thresholds_t* dcm_thresholds_default_values)
{
	...
	switch (nof_pipes)
	{
        ...
        case 2:
            ...
            dcm_thresholds_default_values-> gci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> gci_low_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_1_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> gci_low_threshold[2] = 0;
            dcm_thresholds_default_values-> gci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> gci_med_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> gci_med_threshold[2] = 0;
            dcm_thresholds_default_values-> gci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> gci_high_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_1_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> gci_high_threshold[2] = 0;
            dcm_thresholds_default_values-> rci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> rci_low_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_1_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> rci_low_threshold[2] = 0;
            dcm_thresholds_default_values-> rci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> rci_med_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> rci_med_threshold[2] = 0;
            dcm_thresholds_default_values-> rci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> rci_high_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_1_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcm_thresholds_default_values-> rci_high_threshold[2] = 0;
            break;
        case 3:
            ...
            dcm_thresholds_default_values-> gci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_low_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_low_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_LOW_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_med_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_med_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_MED_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_high_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> gci_high_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_GCI_HIGH_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_low_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_low_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_LOW_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_med_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_med_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_MED_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_high_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            dcm_thresholds_default_values-> rci_high_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCM_DEFAULT_RCI_HIGH_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE;
            break;
	}
...
soc_fe3200_init_dcl_thresholds_config(int unit, soc_dfe_drv_dcl_default_thresholds_t* dcl_thresholds_default_values)
{
	...
	switch (nof_pipes)
	{
        ...
        case 2:            
            ...
            dcl_thresholds_default_values-> fifo_size[2] = 0;
            dcl_thresholds_default_values-> prio_0_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? 40:SOC_FE3200_DCL_DEFAULT_PRIO_0_DROP_THRESHOLD_DUAL_PIPE;
            ...
            dcl_thresholds_default_values-> llfc_threshold[2] = 0;
            dcl_thresholds_default_values-> gci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> gci_low_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_1_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> gci_low_threshold[2] = 0;
            dcl_thresholds_default_values-> gci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> gci_med_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> gci_med_threshold[2] = 0;
            dcl_thresholds_default_values-> gci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> gci_high_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_1_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_1_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> gci_high_threshold[2] = 0;
            dcl_thresholds_default_values-> rci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_RCI_LOW_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_RCI_LOW_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> rci_low_threshold[1] = SOC_FE3200_DCL_DEFAULT_RCI_THRESHOLD_PIPE_1;
            dcl_thresholds_default_values-> rci_low_threshold[2] = 0;
            dcl_thresholds_default_values-> rci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_RCI_MED_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_RCI_MED_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> rci_med_threshold[1] = SOC_FE3200_DCL_DEFAULT_RCI_THRESHOLD_PIPE_1;
            dcl_thresholds_default_values-> rci_med_threshold[2] = 0;
            dcl_thresholds_default_values-> rci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe)? SOC_FE3200_DCL_DEFAULT_RCI_HIGH_PIPE_0_IP_TDM_THRESHOLD_DUAL_PIPE:SOC_FE3200_DCL_DEFAULT_RCI_HIGH_PIPE_0_MC_UC_THRESHOLD_DUAL_PIPE;;
        ...
        case 3:  
            ...
            dcl_thresholds_default_values-> gci_low_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_low_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_low_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_LOW_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_med_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_med_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_med_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_MED_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_high_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_0_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_0_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_high_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_1_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_1_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
            dcl_thresholds_default_values-> gci_high_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe)? SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_2_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE:SOC_FE3200_DCL_DEFAULT_GCI_HIGH_PIPE_2_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE ;
