/* $Id: tmc_api_pmf_low_level_fem_tag.c,v 1.11 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/tmc/src/soc_tmcapi_pmf_low_level.c
*
  ...
  )
{
  ...
  info->shift = 0;
  info->action_type = SOC_PPC_NOF_FP_ACTION_TYPES;
  ...
  )
{
  ...
  info->type = SOC_TMC_PMF_FEM_BIT_LOC_TYPE_CST; /* To set by default 0 */
  info->val = 0;
  SOC_SAND_MAGIC_NUM_SET;
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
