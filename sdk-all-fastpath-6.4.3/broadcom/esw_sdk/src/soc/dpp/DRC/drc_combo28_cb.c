...
int soc_dpp_drc_combo28_shmoo_force_dqs(int unit, int drc_ndx , uint32 force_dqs_val, uint32 force_dqs_oeb)
{
    ...
    force_dqs_oeb = force_dqs_val ? 0xf : 0;

    /* Setting of FORCE_DQS_VALf, DQS_OEB_VALf must come before setting of OVERRIDE_DQS_OEBf */
    soc_reg_field_set(unit, DRCA_DRAM_COMPLIANCE_CONFIGURATION_REGISTERr, &reg_val, FORCE_DQS_VALf, force_dqs_val);
    soc_reg_field_set(unit, DRCA_DRAM_COMPLIANCE_CONFIGURATION_REGISTERr, &reg_val, DQS_OEB_VALf, ~force_dqs_oeb);
    soc_reg_field_set(unit, DRCA_DRAM_COMPLIANCE_CONFIGURATION_REGISTERr, &reg_val, OVERRIDE_DQS_OEBf, force_dqs_oeb);
