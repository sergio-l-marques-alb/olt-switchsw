...
#define SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(func_name)                           \
  res = arad_pp_diag_is_valid(unit, func_name, &ret_val);                    \
...
{
  return arad_pp_diag_pkt_trace_clear_unsafe(unit, SOC_PPC_DIAG_PKT_TRACE_ALL);
}
  ...
  )
{
  ...
  if (!SOC_IS_ARDON(unit)) {
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN(res, 20, exit, READ_IHP_DBG_FLP_PROGRAM_SELECTION_CAM_LINEr(unit, 0, &reg_val64));
      if (!COMPILER_64_IS_ZERO(reg_val64)) {
          *(ret_val) = 1;
          goto exit;
      }
      SOC_SAND_SOC_IF_ERROR_RETURN(res, 30, exit, READ_IHP_DBG_FLP_SELECTED_PROGRAMr(unit, 0, &reg_val));
      if (reg_val != 0) {
          *(ret_val) = 1;
          goto exit;
      }
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 40, exit, READ_IHB_DBG_PMF_SELECTED_CAM_LINE_0r(unit, REG_PORT_ANY,&reg_val));
  if (reg_val != 0) {
      *(ret_val) = 1;
      goto exit;
  }
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 50, exit, READ_IHB_DBG_PMF_SELECTED_CAM_LINE_1r(unit, REG_PORT_ANY,&reg_val));
  if (reg_val != 0) {
      *(ret_val) = 1;
      goto exit;
  }
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 60, exit, READ_IHB_DBG_PMF_SELECTED_PROGRAMr(unit, REG_PORT_ANY,&reg_val));
  if (reg_val != 0) {
      *(ret_val) = 1;
      goto exit;
  }
  ...
  )
{
  ...
  res = arad_pp_sw_db_diag_mode_set(
          unit,
          mode_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  ARAD_PP_DIAG_MODE_INFO_clear(mode_info);

  res = arad_pp_sw_db_diag_mode_get(
          unit,
          mode_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,0,208,193,20);
  }
  else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,0,192,177,20);
  }
  ...
  )
{
  ...
  if (pkt_trace & ARAD_PP_DIAG_PKT_TRACE_LIF)
  {
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  22,  exit, ARAD_REG_ACCESS_ERR, WRITE_IHP_VTT_PROGRAM_ENCOUNTEREDr(unit, SOC_CORE_ALL, clear_val_64));
  ...
  if (pkt_trace & SOC_PPC_DIAG_PKT_TRACE_FLP)
  {
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  44,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_DBG_FLP_PROGRAM_SELECTION_CAM_LINEr(unit, SOC_CORE_ALL, clear_val_64));
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  45,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_DBG_FLP_SELECTED_PROGRAMr(unit, SOC_CORE_ALL, clear_val));
  }

  if (pkt_trace & SOC_PPC_DIAG_PKT_TRACE_PMF)
  {
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  46,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHB_DBG_PMF_SELECTED_CAM_LINE_0r(unit, SOC_CORE_ALL,  clear_val));
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  47,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHB_DBG_PMF_SELECTED_CAM_LINE_1r(unit, SOC_CORE_ALL,  clear_val));
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  48,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHB_DBG_PMF_SELECTED_PROGRAMr(unit, SOC_CORE_ALL,  clear_val));  
  }
  ...
  {
    /* LLR traps */
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  110,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_DBG_LLR_TRAP_0r(unit, SOC_CORE_ALL,  clear_val));
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  120,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_DBG_LLR_TRAP_1r(unit, SOC_CORE_ALL,  clear_val));
    /* VTT traps */
    COMPILER_64_SET(field64,0,clear_val);
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  130,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_VTT_TRAPS_ENCOUNTEREDr(unit, SOC_CORE_ALL,  field64));
    /* FLP traps */
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  140,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_DBG_FLP_TRAP_0r(unit, SOC_CORE_ALL, clear_val));
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  150,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_DBG_FLP_TRAP_1r(unit, SOC_CORE_ALL, clear_val));
    /* FER traps */
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  160,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHB_DBG_FER_TRAPr(unit, SOC_CORE_ALL,  clear_val));
  }

  if (pkt_trace & ARAD_PP_DIAG_PKT_TRACE_EG_DROP_LOG)
  {
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  170,  exit, ARAD_REG_ACCESS_ERR,WRITE_EPNI_PP_INT_REGr(unit, SOC_CORE_ALL,  clear_val));
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  180,  exit, ARAD_REG_ACCESS_ERR,WRITE_EGQ_ERPP_DISCARD_INTERRUPT_REGISTERr(unit, SOC_CORE_ALL, clear_val));
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  190,  exit, ARAD_REG_ACCESS_ERR,WRITE_EGQ_ERPP_DISCARD_INTERRUPT_REGISTER_2r(unit, SOC_CORE_ALL, clear_val));
  }
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_RECEIVED_PACKET_INFO_GET);

  /* TM-port */
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,ARAD_PP_DIAG_FLD_MSB_MAX,ARAD_PP_DIAG_FLD_LSB_MIN,15); 
  tmp = 0;
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,2,ARAD_PP_DIAG_FLD_MSB_MAX,ARAD_PP_DIAG_FLD_LSB_MIN,15);
  /* pp-context */
  tmp = 0;
  res = soc_sand_bitstream_get_any_field(
          regs_val,
  ...
  {
    ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,indx+2,ARAD_PP_DIAG_FLD_MSB_MAX,ARAD_PP_DIAG_FLD_LSB_MIN,45);
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,ARAD_PP_DIAG_FLD_MSB_MAX,ARAD_PP_DIAG_FLD_LSB_MIN,55);
  res = soc_sand_bitstream_set_any_field(
          regs_val,
          cur_lsb,
          1023-cur_lsb+1,
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,206,191,65);
  tmp = regs_val[0];
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,226,219,75);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_PARSING_INFO_GET);

  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,1,104,99,5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,1,141,136,5);
  }
  tmp = regs_val[0];
  arad_pp_pkt_hdr_interanl_val_to_type_map(tmp,&pars_info->hdr_type);

  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,146,92,15);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,147,93,15);
  }
  qual[0]= regs_val[0];
  qual[1]= regs_val[1];

  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,190,156,15);
  ...
  {
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,102,99,15);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,103,100,15);
      }
    ...
    if (SOC_IS_JERICHO(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,1,194,191,15);
    } else {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,1,212,209,15);
    }
    pars_info->hdrs_stack[outer_eth_indx].eth.vlan_tag_format = (SOC_SAND_PP_ETHERNET_FRAME_VLAN_FORMAT)regs_val[0];

    if (SOC_IS_JERICHO(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,2,4,255,251,15);
        tmp = regs_val[0] & 0x1F;
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,2,5,19,0,16);
        tmp += (regs_val[0] << (255 - 251 + 1));
    } else {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,4,255,236,15);
        tmp = regs_val[0];
    }
    ...
    if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,5,4,0,15);
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,2,0,24,13,15);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,0,11,0,15);
  }
  ...
  */
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,226,219,15);
  in_port = regs_val[0];
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_TERMINATION_INFO_GET);

  ARAD_PP_DIAG_TERM_INFO_clear(term_info);

  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,0,229,226,10);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,0,211,208,10);
  }
  term_info->term_type = (ARAD_PP_PKT_TERM_TYPE)regs_val[0];

  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,146,92,20);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,1,6,147,93,20);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,7,73,65,5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,6,219,211,5);
  }
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_FRWRD_LPM_LKUP_GET);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_FRWRD_LKUP_INFO_GET);
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,0,222,209,5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,0,204,193,5);
  }
  vrf = regs_val[0];
  ...
  if (frwrd_info->frwrd_type == ARAD_PP_DIAG_FWD_LKUP_TYPE_TRILL_UC) {
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3,1,54,54,5);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4,1,34,34,5);
      }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,26, 0, 79, 0, 101);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,22, 0 , 116, 43, 101);
  }
  ...
  else if (frwrd_info->frwrd_type == ARAD_PP_DIAG_FWD_LKUP_TYPE_IPV4_MC)
  {
    ...
    ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,15,1,235,76,5);
  ...
  {
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,7,0,44,0, 5);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,21,0,45,1,5); 
      }
          ...
          )
  {
    ...
    ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,16,0,125,85,5);
    tmp = 0;
          ...
          )
  {
    ...
    if (SOC_IS_JERICHO(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,7,0,46,0, 5);
    } else {
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,21,0,90,0,5);
    }
    /*was match*/
    tmp = 0;
    ...
    else
    {
      ...
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,14,0,15,1,5); 
      /*was match*/
      frwrd_info->key_found = TRUE;
      frwrd_info->lkup_res.frwrd_decision.type = ARAD_PP_FRWRD_DECISION_TYPE_FEC;
      frwrd_info->lkup_res.frwrd_decision.additional_info.eei.type = ARAD_PP_EEI_TYPE_EMPTY;
  ...
  else
  {
    if (SOC_IS_JERICHO(unit)) {
        ...
        ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,21,0,45,0,5); 
    }
    /*was match*/
    tmp = 0;
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_TRAPS_INFO_GET);

  ARAD_PP_DIAG_TRAPS_INFO_clear(traps_info);
  
  /* LLR traps */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  10,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_DBG_LLR_TRAP_0r(unit, SOC_CORE_ALL, &regs_val[0]));
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  20,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_DBG_LLR_TRAP_1r(unit, SOC_CORE_ALL, &regs_val[1]));
  ...
  /* VTT traps */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  40,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_VTT_TRAPS_ENCOUNTEREDr(unit, SOC_CORE_ALL, &reg64_val));
  ...
  /* FLP traps */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  60,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_DBG_FLP_TRAP_0r(unit, 0, &tmp_regs_val[0]));
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  70,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_DBG_FLP_TRAP_1r(unit, 0, &tmp_regs_val[1]));
  ...
  /* FER traps */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  80,  exit, ARAD_REG_ACCESS_ERR,READ_IHB_DBG_FER_TRAPr(unit, SOC_CORE_ALL, &regs_val[0]));
  ...
  * committed Trap
  */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  100,  exit, ARAD_REG_ACCESS_ERR,READ_IHB_DBG_LAST_RESOLVED_TRAPr(unit, SOC_CORE_ALL, &reg_val));
  ...
  */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  180,  exit, ARAD_REG_ACCESS_ERR,READ_IHB_DBG_LAST_TRAP_CHANGE_DESTINATION_REGr(unit, 0, &reg_val));
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_FRWRD_DECISION_TRACE_GET);

  /* port phase forward */
  frwrd_trace_info->frwrd[ARAD_PP_DIAG_FRWRD_DECISION_PHASE_INIT_PORT].is_valid = FALSE;

  /* port trap */

  /*dbg: llrvtt_4eq5_snoop_strength [1 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 2, 0, 55, 54, 101);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 3, 0 , 42, 41, 101);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 2, 0, 120, 118, 102);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 3, 0, 105, 103, 102);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,2, 0 , 146,  139,103);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3, 0 , 131,  124,103);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,2, 0 , 138,  123,104);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3, 0 , 123,  108,104);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3, 1 , 74, 73, 105);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 0 , 23 , 22,105);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 1 , 54 , 53,105);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3, 2, 67, 65, 106);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 0 , 113 , 111,106);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 2 , 16 , 14,106);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3, 2, 110, 103, 107);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 0, 156, 149, 107);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 2, 59, 52, 107);
  }
  arad_pp_trap_cpu_trap_code_from_internal_unsafe(unit,regs_val[0],&trap_code);
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,3, 2 , 102, 87, 108);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 0 , 148, 133,108);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,4, 2 , 51, 36,108);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,  3, 2, 86, 68, 102);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,  4, 0, 132, 114, 102);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 2, 35, 17, 109);
  }
   dest = regs_val[0];
   /*dbg: ihp2ihb_vtt2flp_2eq3_eei [23 : 0] */
   if (SOC_IS_JERICHO(unit)) {
       ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 3, 2 , 135, 112, 110);
   } else if (SOC_IS_ARDON(unit)) {
       regs_val[0] = 0;
   } else {
       ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 2 , 83 , 60,110);
   }
   eei = regs_val[0];
  ...
  frwrd_trace_info->frwrd[ARAD_PP_DIAG_FRWRD_DECISION_PHASE_LIF].is_valid = 1;

  /*dbg: ihp2ihb_vtt2flp_2eq3_out_lif [15 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 3, 1, 122, 105, 111);
  } else if (SOC_IS_ARDON(unit)) {
      regs_val[0] = 0;
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 1, 157, 142, 111);
  }
 ...
 /* forwarding lookup TRAP */
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 1, 251, 250, 112);
  } else if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 1 , 34, 33, 1121);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 1 , 172, 171, 1121);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 1 , 34, 33,112);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 8, 104, 102, 113);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 6 , 229, 227,1131);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 161, 159,1131);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 12, 10,113);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 8, 151, 144, 114);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 20, 13,1141);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 208, 201,1141);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 59, 52,114);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 8, 143, 128, 115);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,  0, 7 , 12,  0,1151);
          tmp = regs_val[0] << 3;
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,  0, 6 , 255,  253,1151);
          regs_val[0] += tmp;
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 200, 185,1151);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 51, 36,115);
  }
 ...
 /* forwarding lookup forwarding decision*/
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 8, 127, 109, 116);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 6 , 252, 234, 1161);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 184, 166, 1161);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 35, 17,116);
  }
  dest = regs_val[0];

  /*dbg: flp2pmf_2eq3_eei [23 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 4, 9, 192, 169, 117);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7, 189, 166, 1171);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 8, 121, 98, 1171);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7 , 228, 205,117);
  }
  eei = regs_val[0];
  ...
  frwrd_trace_info->frwrd[ARAD_PP_DIAG_FRWRD_DECISION_PHASE_LKUP_FOUND].is_valid = 1;

  /*dbg: flp2pmf_1eq2_out_lif [15 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,  4, 10, 8,  0, 1181);
      tmp = regs_val[0] << (255-247+1);
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID,  4, 9, 255,  247, 1182);
      regs_val[0] += tmp;
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 7, 255, 240, 1181);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 8, 191, 176, 1181);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,0, 8 , 38, 23,118);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,  0, 11, 6, 0, 1191);
      tmp = regs_val[0] << (255 - (241+3) +1);
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,  0, 10, 255,  241+3, 1192);
      regs_val[0] += tmp;
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,2, 10 , 192, 174, 1191);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,9, 10 , 227, 209, 1191);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,9, 10 , 194, 176,119);
  }
  dest = regs_val[0];

  /*dbg: pmf2fer_38eq39_eei [23 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 0, 11, 161, 138, 120);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,2, 11 , 69, 46, 1201);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,9, 11 , 120, 97, 1201);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,9, 11 , 71, 48,120);
  }
  eei = regs_val[0];
  res = arad_pp_diag_fwd_decision_in_buffer_parse(
        unit,
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 0, 9, 219, 202, 121);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,2, 9 , 181, 166, 1211);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,9, 9 , 198, 183, 1211);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,9, 9 , 181, 166,121);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 2, 158+21, 158+3, 122);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,3, 2 , 120, 102, 1221);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 2 , 154, 136, 1221);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 2 , 120, 102,122);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 3, 86, 63, 123);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 3, 2 , 253, 230,1231);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 3, 48, 25, 1231);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 2 , 253, 230,123);
  }
  eei = regs_val[0];
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 1, 62, 45, 124);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit))
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,3, 1 , 15, 30, 1241);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 48, 33, 1241);
      }
  }
  else
  {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 30, 15,124);
  }
  frwrd_trace_info->frwrd[ARAD_PP_DIAG_FRWRD_DECISION_PHASE_TRAP].outlif = regs_val[0];

  /*FEC forwarding decision*/
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 31, exit, READ_IHB_DBG_LAST_RESOLVED_TRAPr(unit, REG_PORT_ANY, &reg_val));
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 4, 0, 150, 132, 125);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,5, 0 , 147, 130,1251);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,12, 0 , 147, 130,1251);
  }
  dest = regs_val[0];
  /* fer2lbp_eq2_eei [23 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 3, 86, 63, 125);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHB_ID, 3, 2, 253, 230, 125);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHB_ID, 10, 3, 48, 25, 125);
      }
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 2 , 253, 230,125);
  }
  ...
  /*dbg: fer2lbp_eq2_out_lif [15 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, 2, 1, 62, 45, 124);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,3, 1 , 30, 15, 1241);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 48, 33, 1241);
      }
  } else {
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_LEARNING_INFO_GET);
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 1, 194, 194, 101);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 177, 177,1011);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 147, 147,101);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 3, 62, 62, 101);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 3, 24, 24,1012);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 2 , 229, 229,101);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 1, 95, 95, 101);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 78, 78,1013);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 48, 48,101);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 0, 59, 20, 101);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 10, 0 , 59, 20,101);
  }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID, 2, 1, 158, 96, 101);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 141, 79,1014);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10, 1 , 111, 49,101);
  }
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_ING_VLAN_EDIT_INFO_GET);

  ARAD_PP_DIAG_VLAN_EDIT_RES_clear(vec_res);

  /* vlan-edit-info*/
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10,0,145,112,5);
  /* AC-tag info*/
  tmp = 0;
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_PKT_ASSOCIATED_TM_INFO_GET);

  ARAD_PP_DIAG_PKT_TM_INFO_clear(pkt_tm_info);

  /* tm-forwarding-info*/
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,4,1,66,0,5);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,5,1,53,0,5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,12,1,53,0,5);
  }
  sal_memcpy(regs_val_part2, regs_val, sizeof(regs_val));
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,4,0,255,0,5);
  } else if (SOC_IS_ARDON(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,5,0,255,0,5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,12,0,255,0,5);
  }
  ...
  /* Meter PTR 0 is always invalid, unless specified otherwise by SOC property. */
  /* The case where meter PTR 0 is not invalid is ignored. */
  /*METER1*/
  tmp = 0;
  res = soc_sand_bitstream_get_any_field(regs_val, SOC_IS_JERICHO(unit)? 187: 196, SOC_DPP_DEFS_GET(unit, meter_pointer_nof_bits), &tmp);
  SOC_SAND_CHECK_FUNC_RESULT(res, 115, exit);
  if (tmp)
  {
  ...
  /*METER2*/
  tmp = 0;
  res = soc_sand_bitstream_get_any_field(regs_val, SOC_IS_JERICHO(unit)? 204: 211, SOC_DPP_DEFS_GET(unit, meter_pointer_nof_bits), &tmp);
  SOC_SAND_CHECK_FUNC_RESULT(res, 125, exit);
  if (tmp)
  {
    pkt_tm_info->valid_fields |= ARAD_PP_DIAG_PKT_TM_FIELD_METER2;
    res = soc_sand_bitstream_get_any_field(regs_val, SOC_IS_JERICHO(unit)? 204: 211, SOC_DPP_DEFS_GET(unit, meter_pointer_nof_bits), &pkt_tm_info->meter2);
    SOC_SAND_CHECK_FUNC_RESULT(res, 130, exit);
  }
  /*METER-command*/
  tmp = 1;/*always valid*/
  ...
  if (tmp)
  {
    ...
    res = soc_sand_bitstream_get_any_field(regs_val_part2, SOC_IS_JERICHO(unit)? 29: 44, 16, &pkt_tm_info->ignore_cp);
    SOC_SAND_CHECK_FUNC_RESULT(res, 260, exit);
  }
  /*CUD*/
  /*dbg: fer2lbp_eq2_out_lif [15 : 0] */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,2,1,62,45,1751);
  } else  if (SOC_IS_ARADPLUS(unit)) {
      if (SOC_IS_ARDON(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,3,1,30,15,1751);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10,1,48,33,1751);
      }
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHB_ID,10,1,30,15,175);
  }
  tmp = 1; /*always valid*/
  if (tmp)
  {
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_ENCAP_INFO_GET);
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 2, SOC_IS_JERICHO(unit)? 255: 104, SOC_IS_JERICHO(unit)? 228: 76, 5);
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 9, 2, 183, 182, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 2, 0, 157, 156, 5);
  }
  tmp = 0;
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 1, 86, 83, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 2, 0, 155, 152, 5);
  }
  tmp2 = 0;
  ...
  if (tmp == 1 && tmp2 == 5) {
      ...
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 2, 0, 64 + 24 - 1, 64, 5);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 4, 0, 44, 21, 5);
      }
      ...
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 2, 0, 64 + 40 - 1, 64, 5);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 4, 0, 60, 21, 5);
      }
  ...
  curr_eep_index = 0;
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 2, 227, 96, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 1, 254, 234, 5);
  }
  tmp = 0;    
  /* action1_valid */
  res = soc_sand_bitstream_get_any_field(regs_val,0,1,&tmp);
  ...
  if (tmp) {
    tmp2 = 0;
    /* action1_outlif */
    res = soc_sand_bitstream_get_any_field(regs_val,5,16,&tmp2);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);

    if(curr_eep_index != 0 && encap_info->eep[curr_eep_index] != SOC_PPC_EG_ENCAP_NEXT_EEP_INVALID) {
        SOC_SAND_ERR_IF_NOT_EQUALS_VALUE(tmp2,encap_info->eep[curr_eep_index],SOC_E_INTERNAL,35,exit);
    }
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 1, 255, 220, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 1, 156, 136, 5);
  }
  tmp = 0;
  ...
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 1, 219, 88, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 4, 1, 58, 38, 5);
  }
  tmp = 0;
  ...
  /* VSI, Out-AC */
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 8, 0, 77, 60, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID, 8, 0, 65, 50, 5);
  }
  ...
  if (cur_eep_type != ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_AC) {
    ...
    /* VSI is taken from ESEM key */
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 11, 0, 189, 174, 5);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 11, 0, 128, 113, 5);
      }
    /* vsi */
    ...
    if (tmp) {
      ...
      ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID,11,0,15,0,5);
      /* Out-AC */
      res = soc_sand_bitstream_get_any_field(regs_val,0,16,&encap_info->out_ac);
      SOC_SAND_CHECK_FUNC_RESULT(res, 333, exit);
    } else {
      /* Take from Port default */
        if (SOC_IS_JERICHO(unit)) {
            ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 4, 0, 89+22, 89+6, 5);
        } else {
            ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 4, 0, 63+21, 63+6, 5);
        }
      /* Port-default-Out-AC */
      res = soc_sand_bitstream_get_any_field(regs_val, 0, SOC_IS_JERICHO(unit)? 17: 16, &encap_info->out_ac);
      SOC_SAND_CHECK_FUNC_RESULT(res, 335, exit);
    }
  } else {
    /* VSI is taken from LinkLayer */
    ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 8, 0, SOC_IS_JERICHO(unit)? 25: 15, SOC_IS_JERICHO(unit)? 10: 0, 5);
    /* vsi */
    res = soc_sand_bitstream_get_any_field(regs_val, 0, 16, &encap_info->ll_vsi);
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID,7,0,42,35,5);
  /* Out-Base-TM-Port */
  tmp = 0;
  ...
  ARAD_PP_DIAG_FLD_READ(&fld,ARAD_EPNI_ID,7,0,50,43,5);
  /* Out-PP-Port */
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_DB_LIF_LKUP_INFO_GET);
  ...
  if (db_info->bank_id == 0 || db_info->bank_id == 1) { /* ISEM-A & B */
     if (db_info->bank_id == 0) {
         ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 20: 13, 0, 2 * SOC_DPP_DEFS_GET(unit, isem_width) - 1, 0, 5);
     }
     else  { /* bank_id == 1 */
        
         ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 22: 15, 0, 2 * SOC_DPP_DEFS_GET(unit, isem_width) - 1, 0, 5);
     }
     ...
     if (db_info->lkup_num == 1) /*second*/
     {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 24: 11, 0, 165, 0, 10);
     ...
     {
         if (SOC_IS_JERICHO(unit)) {
             ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 24, 0, 255, 172, 12);
             tmp = 256-172;
         } else {
             ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 11, 0, 255, 166, 12);
             tmp = 256-166;
         }
        ...
        if (SOC_IS_JERICHO(unit)) {
            ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 24, 1, 75, 0, 14);
        } else {
            ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 11, 1, 69, 0, 14);
        }
        ...
        if (SOC_IS_JERICHO(unit)) {
            ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 24, 0, 171, 166, 13);
        } else {
            ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 11, 1, 75, 70, 13);
        }
  ...
  if (db_info->bank_id == 0) 
  {
      if (db_info->lkup_num == 1) /*second*/
      {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 21: 14, 0, SOC_IS_JERICHO(unit)? 18: 17, 0, 5);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 21: 14, 0, SOC_IS_JERICHO(unit)? 37: 35, SOC_IS_JERICHO(unit)? 19: 18, 5);
      }
  }
  else if (db_info->bank_id == 1) /* bank_id == 1 */
  {
      if (db_info->lkup_num == 1) /*second*/
      {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 23: 16, 0, SOC_IS_JERICHO(unit)? 18: 17, 0, 5);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld,ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 23: 16, 0, SOC_IS_JERICHO(unit)? 37: 35, SOC_IS_JERICHO(unit)? 19: 18, 5);
      }
  }
  else /* bank_id == 2 */
  {
      if (db_info->lkup_num == 1) /*second*/
      {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 25: 12, 0, (2 * SOC_DPP_DEFS_GET(unit, tcam_action_width)) + 1, 1, 5);
      }
      else
      {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, SOC_IS_JERICHO(unit)? 25: 12, 0, (4 * SOC_DPP_DEFS_GET(unit, tcam_action_width)) + 3, (2 * SOC_DPP_DEFS_GET(unit, tcam_action_width)) + 3, 5);
  ...
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_AC:
    res = arad_pp_l2_lif_ac_key_parse_unsafe(
            unit,
            &isem_key,
            &(lkup_info->key.ac)
          );
  ...
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_PWE:
    res = arad_pp_l2_lif_pwe_key_parse_unsafe(
            unit,
            &isem_key,
            &(lkup_info->key.pwe)
          );
  ...
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_MPLS_TUNNEL:
    res = arad_pp_l2_rif_mpls_key_parse_unsafe(
            unit,
            &isem_key,
            &(lkup_info->key.mpls)
          );
  ...
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_IPV4_TUNNEL:
    res = arad_pp_rif_ip_tunnel_key_parse_unsafe(
            unit,
            &isem_key,
            &lkup_info->key.ip_tunnel
      );
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);

  break;
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_TRILL:
      lkup_info->key.trill.dist_tree = isem_key.key_info.trill.dist_tree;
      lkup_info->key.trill.flags = isem_key.key_info.trill.flags;
      lkup_info->key.trill.high_vid = isem_key.key_info.trill.high_vid;
      lkup_info->key.trill.low_vid = isem_key.key_info.trill.low_vid;
      lkup_info->key.trill.ing_nick = isem_key.key_info.trill.ing_nick;
      lkup_info->key.trill.port = isem_key.key_info.trill.port;
      lkup_info->key.trill.native_inner_tpid = isem_key.key_info.trill.native_inner_tpid;
      lkup_info->key.trill.link_adj_id = isem_key.key_info.trill.link_adj_id;
      lkup_info->key.trill.nick_name = isem_key.key_info.trill.nick_name;
      lkup_info->key.trill.vsi = isem_key.key_info.trill.vsi;

      if (isem_key.key_type == ARAD_PP_ISEM_ACCESS_KEY_TYPE_TRILL_NICK) 
      {
        lkup_info->key.trill.trill_key_type = 1;                 
      }
      else if (isem_key.key_type == ARAD_PP_ISEM_ACCESS_KEY_TYPE_TRILL_APPOINTED_FORWARDER) 
      {
        lkup_info->key.trill.trill_key_type = 2;                    

      }
      else if (isem_key.key_type == ARAD_PP_ISEM_ACCESS_KEY_TYPE_TRILL_NATIVE_INNER_TPID) {
        lkup_info->key.trill.trill_key_type = 3;
      }
      else /* TRILL_VSI */
      {
        lkup_info->key.trill.trill_key_type = 4;
        lkup_info->value.trill.vsi_id = lkup_info->base_index;
      }        
  ...
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_L2GRE: 
    lkup_info->key.l2gre.vpn_key = isem_key.key_info.l2_gre.gre_key;
    break;
  case ARAD_PP_DIAG_LIF_LKUP_TYPE_VXLAN: 
    lkup_info->key.vxlan.vpn_key = isem_key.key_info.l2_vni.vni_key;
    break;
  default:
    LOG_INFO(BSL_LS_SOC_DIAG,
             (BSL_META_U(unit,
  ...
  res = arad_pp_isem_access_entry_from_buffer(
          regs_val,
          &isem_res
      );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_DB_LEM_LKUP_INFO_GET);
  ...
  /*key*/
  if (SOC_IS_JERICHO(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 26, 0, 205, 0, 5);
  } else {
      ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHB_ID, 22, 0, 234, 0, 5);
  }
  ...
  *valid = FALSE;
  ...
  if (db_info->lkup_num == 0)
  {
    ...
    /* is found*/
    if (SOC_IS_JERICHO(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 27, 0, 95, 0, 5);
    } else {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHB_ID, 21, 0, 90, 0, 5);
    }
    tmp = 0;
  ...
  else if (db_info->lkup_num == 1)
  {
    ...
    if (SOC_IS_JERICHO(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 4, 7, 62, 62, 51);
    } else  if (SOC_IS_ARADPLUS(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHB_ID, 0, 6, 189, 189, 51);
    } else {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHB_ID, 0, 6, 40, 40, 5);
    }
    tmp = regs_val[0];
  ...
  else if (db_info->lkup_num == 2)
  {
    /*key*/
      if (SOC_IS_JERICHO(unit)) {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 6, 0, 95, 0, 5);
      } else {
          ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 22, 0, 89, 0, 5);
      }
    res = soc_sand_bitstream_get_any_field(
            regs_val,
    ...
    /* is found */
    if (SOC_IS_JERICHO(unit)) {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 7, 0, 47, 0, 5);
    } else {
        ARAD_PP_DIAG_FLD_READ(&fld, ARAD_IHP_ID, 21, 0, 45, 0, 5);
    }
    tmp = 0;
    res = soc_sand_bitstream_get_any_field(regs_val, SOC_IS_JERICHO(unit)? 46: 45, 1, &tmp);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  ) 
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_EGRESS_VLAN_EDIT_INFO_GET);
  ...
  arad_pp_diag_encap_info_get_unsafe(unit, &encap_info);
  ...
  ARAD_PP_DIAG_FLD_READ(&fld, ARAD_EPNI_ID, 11, 0, SOC_IS_JERICHO(unit)? 149: 88, SOC_IS_JERICHO(unit)? 141: 81, 5);
