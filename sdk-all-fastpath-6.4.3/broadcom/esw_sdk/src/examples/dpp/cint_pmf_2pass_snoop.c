/* $Id: cint_pmf_2pass_snoop.c,v 1.1 Broadcom SDK $
...
int system_port_lookup_setup(/* in */ int unit,
  ...
  BCM_FIELD_QSET_ADD(qset, bcmFieldQualifyOutPort); /* Local Out-Port */
...
int system_port_lookup_entry_add(/* in */ int unit,
   ...
   */
  statId = (in_port << 19); /* Set internal data = in-local-port */
