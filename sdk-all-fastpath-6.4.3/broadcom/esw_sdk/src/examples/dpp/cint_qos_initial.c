...
/* 0x400-0x407 stands for the green packet from TC 0 to TC 7, and 0x200-0x207 stands for yellow packet from TC 0 to TC 7. */
int prio[2][8] = {{0x400,0x401,0x402,0x403,0x404,0x405,0x406,0x407},
...
int qos_dscp_map_create(int unit, int color, int mode) { 
    ...
    for (idx = 0; idx < 256; idx++) {
        rv = bcm_port_dscp_map_set(unit, -1, srccp[idx], mapcp[idx], prio[color][idx/32]);  /* global configuration, port has to be -1 */
        if (rv != BCM_E_NONE) {
