...
int arad_interrupt_handle_epniparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* data collection */
    rc = arad_interrupt_data_collection_for_epniparityerror(unit, block_instance, en_arad_interrupt, special_msg, &address, &corrective_action);
    SOCDNX_IF_ERR_EXIT(rc);
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, corrective_action, (void*)(&address), NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ihbparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* data collection */
    rc = arad_interrupt_data_collection_for_ihbparityerror(unit, block_instance, en_arad_interrupt, special_msg, &address, &corrective_action);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ihpparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* data collection */
    rc = arad_interrupt_data_collection_for_ihpparityerror(unit, block_instance, en_arad_interrupt, special_msg, &address, &corrective_action);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_oampparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* data collection */
    rc = arad_interrupt_data_collection_for_oampparityerror(unit, block_instance, en_arad_interrupt, special_msg, &address, &corrective_action);
    SOCDNX_IF_ERR_EXIT(rc);
