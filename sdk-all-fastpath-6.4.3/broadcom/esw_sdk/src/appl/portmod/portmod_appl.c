...
int portmod_pm12x10_add(int unit, soc_pbmp_t phys, int core_addrs[3], int blk_ids[4], void **user_data)
{
    ...
    pm_info.first_blk_id = blk_ids[0]; 
    /*PM phys*/
    ...
    *user_data = pm4x10_user_data;
    ...
    for( i = 0 ; i < 3 ; i++)
    {
        ...
        pm4x10_info->polarity[1].rx_polarity = 0;
        pm4x10_info->polarity[1].tx_polarity = 0;
        pm4x10_info->polarity[2].rx_polarity = 0;
        pm4x10_info->polarity[2].tx_polarity = 0;
        ...
        soc_physim_check_sim(unit, phymodDispatchTypeTsce, &(pm4x10_info->access), &is_sim);
        if(is_sim) {
...
int portmod_pm4x25_add(int unit, soc_pbmp_t phys, int core_addr, int first_blk_id, void **user_data)
{
    ...
    *user_data = pm4x25_user_data;
    ...
    pm4x25_info->polarity[1].rx_polarity = 0;
    pm4x25_info->polarity[1].tx_polarity = 0;
    pm4x25_info->polarity[2].rx_polarity = 0;
    pm4x25_info->polarity[2].tx_polarity = 0;
    ...
    soc_physim_check_sim(unit, phymodDispatchTypeTscf, &(pm4x25_info->access), &is_sim);
    if(is_sim) {
