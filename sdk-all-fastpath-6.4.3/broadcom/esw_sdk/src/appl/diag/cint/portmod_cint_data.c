...
static cint_function_t __cint_functions[] =
{
    ...
    CINT_FWRAPPER_ENTRY(portmod_port_adv_local_get),
    CINT_FWRAPPER_ENTRY(portmod_port_adv_local_set),
    ...
    CINT_FWRAPPER_ENTRY(portmod_port_ability_adv_get),
    CINT_FWRAPPER_ENTRY(portmod_port_ability_adv_set),
    CINT_FWRAPPER_ENTRY(portmod_port_ability_adv_remote_get),
...
__cint_maddr__portmod_pm_diag_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 2: rv = &(s->serdes_id0);break;
        case 3: rv = &(s->name);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static void*
__cint_maddr__portmod_port_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    portmod_port_config_t* s = (portmod_port_config_t*) p;
    switch(mnum)
    {
        case 0: rv = &(s->phy_polarity_config);break;
        case 1: rv = &(s->phy_reset_config);break;
        case 2: rv = &(s->pattern);break;
        case 3: rv = &(s->cl73an);break;
        case 4: rv = &(s->cx4_10g);break;
        case 5: rv = &(s->pdetect1000x);break;
        case 6: rv = &(s->cl37an);break;
        case 7: rv = &(s->an_cl72);break;
        case 8: rv = &(s->forced_init_cl72);break;
        case 9: rv = &(s->an_fec);break;
        case 10: rv = &(s->sgmii_mstr);break;
        case 11: rv = &(s->serdes_driver_current);break;
        case 12: rv = &(s->serdes_1000x_at_6250_vco);break;
        case 13: rv = &(s->tx_drive);break;
        case 14: rv = &(s->pcs_table_override);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static cint_parameter_desc_t __cint_struct_members__portmod_port_config_t[] = 
{
    {"phymod_polarity_t", "phy_polarity_config", 0, 0},
    ...
    {"int", "cl37an", 0, 0},
    {"int", "an_cl72", 0, 0},
    {"int", "forced_init_cl72", 0, 0},
    {"int", "an_fec", 0, 0},
    {"int", "sgmii_mstr", 0, 0},
    {"int", "serdes_driver_current", 0, 0},
    {"int", "serdes_1000x_at_6250_vco", 0, 0},
    {"phymod_tx_t", "tx_drive", 0, PORTMOD_TXDRV_ENTRY_NUM},
    {"int", "pcs_table_override", 0, 0},
    { NULL }
};
...
static cint_struct_type_t __cint_structures[] =
{
    ...
    sizeof(portmod_port_config_t),
    __cint_struct_members__portmod_port_config_t,
    __cint_maddr__portmod_port_config_t
    },
    {
...
static cint_enum_map_t __cint_enum_map__portmod_txdrv_inxs_t[] =
{
...
static cint_enum_type_t __cint_enums[] =
{
    ...
    {"portmod_txdrv_inxs_t", __cint_enum_map__portmod_txdrv_inxs_t },
...
{
    { "PORTMOD_TXDRV_ENTRY_NUM", PORTMOD_TXDRV_ENTRY_NUM },
