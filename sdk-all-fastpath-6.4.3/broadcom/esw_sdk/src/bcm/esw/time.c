...
_bcm_esw_time_hw_clear(int unit, bcm_time_if_t intf_id)
{
    ...
    defined(BCM_KATANA2_SUPPORT) || defined(BCM_HELIX4_SUPPORT) || defined(BCM_HURRICANE2_SUPPORT)
    /*****************************************************************************/
    /*         Perform KATANA2, HELIX4, HURRICANE2 IPROC HW configuration        */
    /*****************************************************************************/

    /* Reset Config register */
    if (soc_feature(unit, soc_feature_time_v3) ||
        SOC_IS_KATANA2(unit) || SOC_IS_HELIX4(unit) || SOC_IS_HURRICANE2(unit)) {
    ...
    /*****************************************************************************/
    /*                Non-KATANA2, HELIX4, HURRICANE2 HW configuration           */
    /*****************************************************************************/
    {
...
#if defined(BCM_TIME_V3_SUPPORT)
    if (soc_feature(unit, soc_feature_time_v3) && !SOC_IS_HURRICANE2(unit)) {
        /*
...
#endif /* defined(BCM_TIME_V3_SUPPORT) || defined(BCM_KATANA_SUPPORT) ||
          defined(BCM_TRIUMPH3_SUPPORT) || defined(BCM_TRIDENT2_SUPPORT) || defined(BCM_HURRICANE2_SUPPORT) */
...
bcm_esw_time_interface_add (int unit, bcm_time_interface_t *intf)
{
    ...
    if (intf->flags & BCM_TIME_SYNC_STAMPER) {
        ...
        if (_bcm_ptp_running(unit) == BCM_E_NONE) {
            ...
            } else if (SOC_IS_KATANA2(unit) || SOC_IS_HELIX4(unit) || SOC_IS_HURRICANE2(unit)) {
                /* IPROC / CMICD */
                if (needs_restart) {
    ...
    defined(BCM_HELIX4_SUPPORT) || defined(BCM_KATANA2_SUPPORT) || defined(BCM_HURRICANE2_SUPPORT)
    if (soc_feature(unit, soc_feature_time_v3) ||
        SOC_IS_HELIX4(unit) || SOC_IS_KATANA2(unit) || SOC_IS_HURRICANE2(unit)) {
        uint32 regval;
