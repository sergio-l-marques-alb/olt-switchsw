    ...
    int *value)
{
    ...
    for (i = 0 ; i<count ; i++)
    {
        switch (type[i])
        {
            ...
            case bcmFabricLinkMidGciLvl2FC:
            case bcmFabricLinkMidGciLvl3FC:
                rc = MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_flow_control_mid_gci_threshold_set, (unit, type[i], type_idx, fabric_pipe, value[i]));
                break;

            case bcmFabricLinkMidRciLvl1FC:
            case bcmFabricLinkMidRciLvl2FC:
            case bcmFabricLinkMidRciLvl3FC:
                rc = MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_flow_control_mid_rci_threshold_set, (unit, type[i], type_idx, fabric_pipe, value[i]));
                break;
            ...
            case bcmFabricLinkMidPrio2Drop:
            case bcmFabricLinkMidPrio3Drop:
                rc = MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_flow_control_mid_prio_drop_threshold_set, (unit, type[i], type_idx, fabric_pipe, value[i]));
                break;

            case bcmFabricLinkMidAlmostFull:
                rc = MBCM_DFE_DRIVER_CALL(unit, mbcm_dfe_fabric_flow_control_mid_almost_full_threshold_set, (unit, type_idx, fabric_pipe, value[i]));
                break;
                 
            case bcmFabricLinkMidFifoSize:
                rc = MBCM_DFE_DRIVER_CALL(unit, mbcm_dfe_fabric_flow_control_mid_fifo_size_threshold_set, (unit, type_idx, fabric_pipe, value[i]));
                break; 
            ...
            case bcmFabricLinkMidFull:
                rc = MBCM_DFE_DRIVER_CALL(unit, mbcm_dfe_fabric_flow_control_mid_full_threshold_set, (unit, type_idx, fabric_pipe, value[i]));
                break;
    ...
    int *value)
{
    ...
    for(i = 0 ; i<count; i++)
    {
        switch(type[i])
        {
          ...
          case bcmFabricLinkMidGciLvl2FC:
          case bcmFabricLinkMidGciLvl3FC:
              rc = MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_flow_control_mid_gci_threshold_get, (unit, type[i], type_idx, fabric_pipe, &(value[i])));
              break;

          case bcmFabricLinkMidRciLvl1FC:
          case bcmFabricLinkMidRciLvl2FC:
          case bcmFabricLinkMidRciLvl3FC:
              rc = MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_flow_control_mid_rci_threshold_get, (unit, type[i], type_idx, fabric_pipe, &(value[i])));
              break;
          ...
          case bcmFabricLinkMidPrio2Drop:
          case bcmFabricLinkMidPrio3Drop:
              rc = MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_flow_control_mid_prio_drop_threshold_get, (unit, type[i], type_idx, fabric_pipe, &(value[i])));
              break;

          case bcmFabricLinkMidAlmostFull:
              rc = MBCM_DFE_DRIVER_CALL(unit, mbcm_dfe_fabric_flow_control_mid_almost_full_threshold_get, (unit, type_idx, fabric_pipe, &(value[i])));
              break; 

          case bcmFabricLinkMidFifoSize:
              rc = MBCM_DFE_DRIVER_CALL(unit, mbcm_dfe_fabric_flow_control_mid_fifo_size_threshold_get, (unit, type_idx, fabric_pipe, &(value[i])));
              break; 
          ...
          case bcmFabricLinkMidFull:
              rc = MBCM_DFE_DRIVER_CALL(unit, mbcm_dfe_fabric_flow_control_mid_full_threshold_get, (unit, type_idx, fabric_pipe, &(value[i])));
              break;                                                
