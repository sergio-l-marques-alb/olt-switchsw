...
/*  Set MACSEC Port configuration. */
extern int bcm_macsec_port_config_set(
    int unit, 
    bcm_port_t port, 
    bcm_macsec_port_config_t *cfg);

/*  Get current MACSEC Port configuration. */
...
/* 
 *  Iterates over all the MACSEC ports and calls user provided callback
...
/* 
 *  Return MACSEC secure channel structure corresponding to  channel
 * identified by ID chanId.
 */
...
/*  Destroy MACSEC channel identified by channel ID. */
...
/* 
 *  This function will iterate over all the secure channels for the
 * specified port and will call the user provide callback function for
 * each of the secure channel.
 */
...
/*  Create a secure association bound to channel chanId. */
...
/* 
 *  Return secure association information for the assoc identified by 
 * assocId.
 */
...
/*  Destroy MACSEC secure association. */
...
/* 
 *  MACSEC secure assoc traverse. This function will traverse all the
 * secure assoc for the specified secure channel and call the user
...
/* 
 *  Create/Update a macsec flow and assign/update the actions for the
 * flow.
 */
...
/*  Destroy the flow with ID flowId. */
extern int bcm_macsec_flow_destroy(
    int unit, 
    bcm_port_t port, 
    int flowId);

/*  Return the flow information and its action for the flow flowId. */
...
/* 
 *  Traverse all the flow and call user provided callback function for
 * each flow.
 */
...
/*  Enables/Diable handling of the MACSEC event. */
...
/*  Sets the current statistics for the specified counter. */
