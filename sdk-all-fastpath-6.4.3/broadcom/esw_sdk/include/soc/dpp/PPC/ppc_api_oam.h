...
#define SOC_PPC_OAM_NUMBER_OF_BITS_USED_BY_OUTLIF_PCP       1 
...
typedef struct {
    ...
    uint32 port; /* Also used when storing a server entry, up MEP. Representing given tx_gport.*/
    ...
    uint32 remote_gport; /* only used for 'get' api in BFD */
                /* Also used when storing OAM server entry, down MEP. Representing trap code.*/
