...
#define SOC_PPC_PROFILE_MGMT_OUTLIF_PROFILE_AC_LIF_NOF_BITS_MAX 3 /* Only 3 bits for AC LIF */
#define SOC_PPC_PROFILE_MGMT_RIF_PROFILE_NOF_BITS 1 /*TBD*/
#define SOC_PPC_PROFILE_MGMT_INLIF_PROFILE_NOF_BITS_TRANSFERED_TO_EGRESS   (2)
...
#define SOC_PPC_PROFILE_MGMT_EG_FILTER_INLIF_PROFILE_BITMAP_MAX         ((1 << SOC_PPC_PROFILE_MGMT_INLIF_PROFILE_NOF_BITS_TRANSFERED_TO_EGRESS) - 1)

#define SOC_PPC_PROFILE_MGMT_NOF_DSCP_BITS 2
#define SOC_PPC_PROFILE_MGMT_OUTLIF_AC_NOF_BITS 3
...
typedef enum {
    SOC_PPC_PROFILE_MGMT_OUTLIF_PROFILE_TYPE_OAM_PCP = 0,
    SOC_PPC_PROFILE_MGMT_OUTLIF_PROFILE_TYPE_OAM_DEFAULT_MEP,
