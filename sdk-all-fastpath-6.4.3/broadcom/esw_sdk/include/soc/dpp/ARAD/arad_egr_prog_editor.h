...
#define ARAD_PRGE_ECN_DM_NTP_LOWER_BOUND   (1 << ((ARAD_PRGE_ECN_DM_NTP_LOWER_BIT) - (ARAD_PRGE_ECN_DM_NTP_BASIC_SHIFT)))
#define ARAD_PRGE_ECN_DM_NTP_UPPER_BOUND   (1 << ((ARAD_PRGE_ECN_DM_NTP_UPPER_BIT) - (ARAD_PRGE_ECN_DM_NTP_BASIC_SHIFT)))
#define ARAD_PRGE_ECN_DM_NTP_MAX_RANGE     ((1 << ((ARAD_PRGE_ECN_DM_NTP_UPPER_BIT) - (ARAD_PRGE_ECN_DM_NTP_LOWER_BIT) + 1)) - 1)
...
#define ARAD_PRGE_ECN_DM_PROGRAM_VAR_SET(arg) \
    if (arg < (1 << 30)) \
    { \
        arg <<= ARAD_PRGE_ECN_DM_NTP_BASIC_SHIFT;  \
    } \
    ...
    {   \
        arg = (arg & 1 << (ARAD_PRGE_ECN_DM_NTP_MAJOR_SHIFT - 1) ? ( 1 + (arg >> ARAD_PRGE_ECN_DM_NTP_MAJOR_SHIFT)) : (arg >> ARAD_PRGE_ECN_DM_NTP_MAJOR_SHIFT));  \
    }
...
#define ARAD_PRGE_ECN_DM_PROGRAM_VAR_GET(arg) \
    ...
    { \
        arg <<= (ARAD_PRGE_ECN_DM_NTP_MAJOR_SHIFT - ARAD_PRGE_ECN_DM_NTP_BASIC_SHIFT);  \
    } 
...
typedef enum
{
    ...
    ARAD_PRGE_TM_SELECT_XGS_PE_FROM_FTMH = 0,
...
typedef enum
{
    ...
    ARAD_PRGE_PP_SELECT_TTL_DECREMENT = 9,
...
typedef enum
{
    ...
    ARAD_EGR_PROG_EDITOR_LFEM_8_LSBS, /*extract EEI [23:16] to [7:0]*/ /* ARAD_EGR_PROG_EDITOR_LFEM_ARP_EXT_EXTRACT_EEI, ARAD_EGR_PROG_EDITOR_LFEM_EXTRACT_HEADER_SIZE */
...
uint32
  arad_egr_prog_editor_port_profile_to_hw_add(
    SOC_SAND_IN  int                    unit,
    SOC_SAND_IN  uint32                    port_ndx,
    SOC_SAND_IN  ARAD_EGR_PROG_TM_PORT_PROFILE  eg_profile,
