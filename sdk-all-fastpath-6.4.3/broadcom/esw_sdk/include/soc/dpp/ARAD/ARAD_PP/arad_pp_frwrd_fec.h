...
typedef enum
{
   ...
   */
  ARAD_PP_FRWRD_FEC_GLBL_INFO_SET = ARAD_PP_PROC_DESC_BASE_FRWRD_FEC_FIRST,
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  ARAD_PP_FRWRD_FEC_PROTECT_TYPE_OUT_OF_RANGE_ERR = ARAD_PP_ERR_DESC_BASE_FRWRD_FEC_FIRST,
