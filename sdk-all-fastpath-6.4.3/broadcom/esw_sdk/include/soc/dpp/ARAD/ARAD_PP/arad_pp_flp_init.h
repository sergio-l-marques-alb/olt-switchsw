...
#define ARAD_PP_FLP_KEY_OR_MASK_LAST                0x21 /* need to update this value when adding new define */
...
#define ARAD_PP_FLP_KEY_PROGRAM_BFD_SINGLE_HOP				   0x2f
#define ARAD_PP_FLP_KEY_PROGRAM_LAST                           (ARAD_PP_FLP_KEY_PROGRAM_BFD_SINGLE_HOP)
