...
/* FES zone selection: 31:0 or 39:8 */
...
#define ARAD_PP_FP_FEM_ACTION_LSB_TO_KEY_ID(_lsb)  (((_lsb) < 40)? 0: 1)
#define ARAD_PP_FP_FEM_ACTION_LSB_TO_RELATIVE_LSB(_lsb)  ((_lsb) - (40 * ARAD_PP_FP_FEM_ACTION_LSB_TO_KEY_ID(_lsb))) /* Relative to the current action table */
#define ARAD_PP_FP_FEM_ACTION_LSB_TO_KEY(_lsb)  ((ARAD_PP_FP_FEM_ACTION_LSB_TO_RELATIVE_LSB(_lsb) < ARAD_PP_FP_FEM_FES_2ND_ZONE_LSB)? 0: 1)
#define ARAD_PP_FP_FEM_ACTION_LSB_TO_FES_LSB(_lsb)  ((ARAD_PP_FP_FEM_ACTION_LSB_TO_KEY(_lsb) == 0)? 0: ARAD_PP_FP_FEM_FES_2ND_ZONE_LSB)
#define ARAD_PP_FP_FEM_ACTION_LSB_TO_SHIFT(_lsb) ((ARAD_PP_FP_FEM_ACTION_LSB_TO_KEY(_lsb) == 0)? \
    ARAD_PP_FP_FEM_ACTION_LSB_TO_RELATIVE_LSB(_lsb): ARAD_PP_FP_FEM_ACTION_LSB_TO_RELATIVE_LSB(_lsb) - ARAD_PP_FP_FEM_FES_2ND_ZONE_LSB)
...
#define ARAD_PP_FP_FEM_ACTION_LOCAL_LSB(_first_lsb, _action_length)  \
...
typedef SOC_PPC_FP_FEM_CYCLE                                    ARAD_PP_FP_FEM_CYCLE;
...
uint32
  arad_pp_fp_action_type_from_pmf_convert(
    SOC_SAND_IN  int               unit,
    SOC_SAND_IN  ARAD_PMF_FEM_ACTION_TYPE  pmf_fem_action_type,
