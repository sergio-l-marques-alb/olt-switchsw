...
#define ARAD_PP_LEM_ACCESS_KEY_PREFIX_SIZE_IN_BITS_FOR_SA_AUTH(unit)    ((SOC_IS_ARAD_B0_AND_ABOVE(unit)) ? SOC_DPP_DEFS_GET(unit, nof_lem_prefixes):26)
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM2_IN_BITS_FOR_ILM          (6)
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_IPMC_BIDIR          (12)
...
#define ARAD_PP_LEM_ACCESS_ASD_TRILL_SA_AUTH_EEP_MSB       (15)
#define ARAD_PP_LEM_ACCESS_ASD_TRILL_SA_AUTH_EEP_LEN       (ARAD_PP_LEM_ACCESS_ASD_TRILL_SA_AUTH_EEP_MSB - ARAD_PP_LEM_ACCESS_ASD_TRILL_SA_AUTH_EEP_LSB + 1)
...
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_RSRVD_MSB     (16)
...
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_ACCPT_UNTGD_LSB     (17)
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_ACCPT_UNTGD_MSB     (17)
...
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_DROP_DIF_VID_LSB     (18)
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_DROP_DIF_VID_MSB     (18)
...
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_PRMT_ALL_PORTS_LSB     (19)
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_PRMT_ALL_PORTS_MSB     (19)
...
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_OVR_VID_IN_TAGGED_LSB     (20)
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_OVR_VID_IN_TAGGED_MSB     (20)
...
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_OVR_VID_IN_UNTAGGED_LSB     (21)
#define ARAD_PP_LEM_ACCESS_ASD_SA_AUTH_OVR_VID_IN_UNTAGGED_MSB     (21)
...
#define ARAD_PP_LEM_ACCESS_HI_FROM_EEI(hi, eei) \
   ((hi) = (eei >> ARAD_PP_LEM_ACCESS_HI_FROM_EEI_LSB) & ARAD_PP_LEM_ACCESS_HI_FROM_EEI_MASK)
#define ARAD_PP_LEM_ACCESS_HI_TO_EEI(eei, hi) \
   ((eei) = (eei) | ((hi >> ARAD_PP_LEM_ACCESS_HI_FROM_EEI_LSB) & ARAD_PP_LEM_ACCESS_HI_FROM_EEI_MASK))
...
typedef enum
{
   ...
   *  Number of key types
   */
   ARAD_PP_LEM_ACCESS_NOF_KEY_TYPES = ARAD_PP_FLP_KEY_OR_MASK_LAST /*= 19,*/ 
...
int 
  arad_pp_bfd_ipv4_1_hop_lem_entry_add(
    int unit,
    int local_discriminator,
    int is_accelerated
  );

int 
  arad_pp_bfd_ipv4_1_hop_lem_entry_remove(
    int unit,
    int local_discriminator
  );
