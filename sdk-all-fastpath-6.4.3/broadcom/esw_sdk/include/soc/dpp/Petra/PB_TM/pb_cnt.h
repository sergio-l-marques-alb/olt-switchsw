/* $Id: pb_cnt.h,v 1.6 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_TM/include/soc_pb_cnt.h
*
...
#ifndef __SOC_PB_CNT_INCLUDED__
/* { */
#define __SOC_PB_CNT_INCLUDED__
...
#define SOC_PB_CNT_NOF_MODE_EG_TYPES   SOC_TMC_CNT_NOF_MODE_EG_TYPES
/* } */
/*************
 * MACROS    *
 *************/
 ...
 *     "soc_pb_cnt_counters_set_unsafe" API.
 *     Refer to "soc_pb_cnt_counters_set_unsafe" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_cnt_meter_hdr_compensation_set_unsafe" API.
 *     Refer to "soc_pb_cnt_meter_hdr_compensation_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
