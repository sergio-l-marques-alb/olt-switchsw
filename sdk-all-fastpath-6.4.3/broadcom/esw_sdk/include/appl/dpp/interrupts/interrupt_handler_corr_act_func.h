...
int arad_interrupt_data_collection_for_ihpparityerror(int unit, int block_instance, arad_interrupt_type interrupt_id, char* special_msg, uint32 *address, arad_int_corr_act_type* corrective_action);
int arad_interrupt_data_collection_for_ihbparityerror(int unit, int block_instance, arad_interrupt_type interrupt_id, char* special_msg, uint32 *address, arad_int_corr_act_type* corrective_action);
int arad_interrupt_data_collection_for_epniparityerror(int unit, int block_instance, arad_interrupt_type interrupt_id, char* special_msg, uint32 *address, arad_int_corr_act_type* corrective_action);
int arad_interrupt_data_collection_for_oampparityerror(int unit, int block_instance, arad_interrupt_type interrupt_id, char* special_msg, uint32 *address, arad_int_corr_act_type* corrective_action);
