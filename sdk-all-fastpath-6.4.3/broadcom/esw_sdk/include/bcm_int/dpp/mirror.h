...
typedef struct _bcm_petra_mirror_data_s {
    ...
    SOC_PB_ACTION_CMD_MIRROR_INFO mirrorInfo;   /* mirror information */
...
typedef struct _bcm_petra_mirror_unit_data_s {
    ...
    _bcm_petra_mirror_data_t *ingress;                  /* ingr mirror info */
} _bcm_petra_mirror_unit_data_t;


extern _bcm_petra_mirror_unit_data_t *_bcm_petra_mirror_unit_data[BCM_MAX_NUM_UNITS];
