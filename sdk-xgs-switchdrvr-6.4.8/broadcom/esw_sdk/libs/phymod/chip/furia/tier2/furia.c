...
*/
    ...
    /*Work around for TX training to work*/
    PHYMOD_IF_ERR_RETURN
       (WRITE_FURIA_PMA_PMD_REG(&phy->access,
                   0x822a, 0x40));
    return PHYMOD_E_NONE;
}
 ...
 *    @return PHYMOD_E_NONE     successful function execution
 */
int furia_phy_intr_status_get(const phymod_phy_access_t *phy, uint32_t intr_type, uint32_t* intr_status)
{
    return furia_ext_intr_status_get(&phy->access, intr_type, intr_status);
}
 ...
 *    @return PHYMOD_E_NONE     successful function execution
 */
int furia_phy_intr_enable_set(const phymod_phy_access_t *phy, uint32_t intr_type, uint32_t enable)
{
    return furia_ext_intr_enable_set(&phy->access, intr_type, enable);
} 
 ...
 *    @return PHYMOD_E_NONE     successful function execution
 */
int furia_phy_intr_enable_get(const phymod_phy_access_t *phy, uint32_t intr_type, uint32_t* enable)
{
    return furia_ext_intr_enable_get(&phy->access, intr_type, enable);
} 
 ...
 *    @return PHYMOD_E_NONE     successful function execution
 */
int furia_phy_intr_status_clear(const phymod_phy_access_t *phy, uint32_t intr_type)
{
    return furia_ext_intr_status_clear(&phy->access, intr_type);
}
