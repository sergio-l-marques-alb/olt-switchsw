...
fp_list_actions(int unit, args_t *args) {
    ...
    param_table[bcmFieldActionVxlanHeaderFlags][0] = "Vxlan Header Flags field";
    param_table[bcmFieldActionVpnSet][0] = "New VPN Value";
    param_table[bcmFieldActionOamOlpHeaderAdd][0] = "Oam Olp Header Type";
    param_table[bcmFieldActionOamDmTimeFormat][0] = "Oam TimeStamp Format";
    param_table[bcmFieldActionDscpMapNew][0] = "Qos Map Id";
    param_table[bcmFieldActionChangeL2Fields][0] = "IFP Egress next hop index";
    param_table[bcmFieldActionUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionRpUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionYpUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionGpUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionIntCosUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionIntCosUcastQueueNew][1]   = "IFP Cos";
    param_table[bcmFieldActionRpIntCosUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionRpIntCosUcastQueueNew][1]   = "IFP Cos";
    param_table[bcmFieldActionYpIntCosUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionYpIntCosUcastQueueNew][1]   = "IFP Cos";
    param_table[bcmFieldActionGpIntCosUcastQueueNew][0]   = "Queue Number";
    param_table[bcmFieldActionGpIntCosUcastQueueNew][1]   = "IFP Cos";
    param_table[bcmFieldActionServicePrioIntCosQNew][0]   = "CosQ classifier ID";
    param_table[bcmFieldActionServicePrioIntCosQNew][1]   = "Queue Number";
    param_table[bcmFieldActionRpServicePrioIntCosQNew][0]   = "CosQ classifier ID";
    param_table[bcmFieldActionRpServicePrioIntCosQNew][1]   = "Queue Number";
    param_table[bcmFieldActionYpServicePrioIntCosQNew][0]   = "CosQ classifier ID";
    param_table[bcmFieldActionYpServicePrioIntCosQNew][1]   = "Queue Number";
    param_table[bcmFieldActionGpServicePrioIntCosQNew][0]   = "CosQ classifier ID";
    param_table[bcmFieldActionGpServicePrioIntCosQNew][1]   = "Queue Number";
