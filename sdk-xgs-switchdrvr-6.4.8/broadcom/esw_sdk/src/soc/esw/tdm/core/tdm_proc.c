...
**/
void
tdm_core_prealloc(unsigned char stack[TDM_AUX_SIZE], int buffer[TDM_AUX_SIZE], short *x, char *bool, int j)
{
	int i;
...
**/
int
tdm_core_postalloc(unsigned char **vector_map, int freq, unsigned char spd, short *yy, short *y, int lr_idx_limit, unsigned char lr_stack[TDM_AUX_SIZE], int token, const char* speed, int num_ext_ports)
{
	int v, load_status;
...
**/
int
tdm_core_postalloc_vmap(unsigned char **vector_map, int freq, unsigned char spd, short *yy, short *y, int lr_idx_limit, unsigned char lr_stack[TDM_AUX_SIZE], int token, const char* speed, int num_ext_ports, int vmap_wid, int vmap_len)
{
	int v, load_status;
