;
; $Id: bcm953300p24ref.asm,v 1.6 Broadcom SDK $
;
...
; 
;
; This is the default program for the (24 port) BCM9953300P24REF
; To start it, use the following commands from BCM:
;
;       *:led load bcm953300p24ref.hex
;       *:led auto on
;       *:led start
;
; The are 2 LEDs per Gig port one for Link(Top) and one for activity(bottom).
;
; There is one bit per gigabit Ethernet LED with the following colors:
;       ONE       Black
;       ZERO      Green
;
; Each chip drives only its own LEDs and needs to write them in the order:
;       L01, A01, L02, A02, ..., L24, A24
;
