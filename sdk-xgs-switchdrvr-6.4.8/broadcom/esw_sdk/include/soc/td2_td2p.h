...
#define SOC_TD2_MMU_RQE_TOTAL_RSVD_ENTRY (SOC_IS_TRIDENT2PLUS(unit) ? 76 : 88)
#define SOC_TD2_MMU_RQE_USER_RSVD_ENTRY (SOC_IS_TRIDENT2PLUS(unit) ? (11*8) : 0)
...
#define SOC_TD2_MMU_QGROUP_MIN_RSVD (SOC_IS_TRIDENT2PLUS(unit) ? 16 : 8)
#define SOC_TD2_MMU_Q_MIN_RSVD      (SOC_IS_TRIDENT2PLUS(unit) ? 0 : 8)
...
#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_LINERATE_100G    43
#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_LINERATE_40G     22
#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_LINERATE_20G     15
#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_LINERATE_10G     11

#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_LINERATE(speed) \
            _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_LINERATE_##speed

#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_OVERSUB_40G  23
#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_OVERSUB_20G  11
#define _TD2P_MMU_EGR_MMU_CREDIT_LIMIT_OVERSUB_10G  8
...
#define _TD2_PGW_CELL_ASM_CUT_THRU_THRESHOLD (SOC_IS_TRIDENT2PLUS(unit) ? 4 : 6)
