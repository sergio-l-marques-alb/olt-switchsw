...
/* Flags for pph_valid in bcm_mirror_pkt_header_fabric_t */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_FHEI_SIZE (1 << 0)   /* FHEI extension size in
                                                          bytes. */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_FORWARDING_TYPE (1 << 1)   /* Forwarding header
                                                          type. */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_FORWARDING_HEADER_OFFSET (1 << 2)   /* Distance in bytes from
                                                          the end of DNX
                                                          internal headers to
                                                          the forwarding header. */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_BYPASS_FILTER (1 << 3)   /* If set, filtering is
                                                          bypassed. */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_SNOOP_CMND (1 << 4)   /* Snoop command (bits
                                                          3:2). */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_VPORT_ORIENTATION (1 << 5)   /* VPort orientation */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_UNKNOWN_ADDRESS (1 << 6)   /* Unknown Address. */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_LEARN_ALLOWED (1 << 7)   /* Set if learning is
                                                          allowed */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_VSWITCH (1 << 8)   /* Packet VSI */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_VRF (1 << 9)   /* Packet VRF */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_IN_VPORT (1 << 10)  /* In-VPort */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_EEI_EXTENSION (1 << 11)  /* Update EEI Extension */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_LEARN_EXTENSION (1 << 12)  /* Update Learn Extension */
#define BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_FHEI_EXTENSION (1 << 13)  /* Update FHEI Extension */
...
typedef struct bcm_mirror_pkt_header_fabric_s {
    uint32 ftmh_valid;          /* Used to specify which fields to use for
                                   header changes. Possible values will be named
                                   BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_FTMH_ */
    uint32 pph_valid;           /* Used to specify which fields to use for
                                   header changes. Possible values will be named
                                   BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_PPH_ */
    uint32 oam_ts_valid;        /* Used to specify which fields to use for
                                   header changes. Possible values will be named
                                   BCM_MIRROR_PKT_HEADER_FABRIC_UPDATE_OAM_TS_ */
    bcm_pkt_dnx_ftmh_t ftmh;    /* FTMH header fields */
    bcm_pkt_dnx_pph_t pph;      /* PPH header fields */
