...
#define BCM_OAM_LOOPBACK_PERIOD_IN_KPPS 0x8        /* Default is milliseconds.
                                                      flag may be used for kilo
                                                      packet per second. */
...
typedef enum bcm_oam_control_type_e {
    ...
    bcmOAMControlCount = 16             /* Always Last. Not a usable value. */
...
typedef struct bcm_oam_loopback_s {
    ...
    int period;                         /* Frequency of loopback tx period in
                                           milliseconds or kpps
                                           (kilo-packets/sec) depending on
                                           flags. Zero indicates single shot, -1
                                           indicates disabling loopback packets
                                           transmission */
