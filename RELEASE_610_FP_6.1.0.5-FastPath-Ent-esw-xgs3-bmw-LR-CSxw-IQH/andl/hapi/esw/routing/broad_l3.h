...
#define HAPI_BROAD_L3_NH_TBL_SIZE      (L7_L3_ARP_CACHE_SIZE + \
                                        L7_IPV6_NDP_CACHE_SIZE)
#define HAPI_BROAD_L3_HOST_TBL_SIZE    (L7_L3_ARP_CACHE_SIZE + \
                                        L7_IPV6_NDP_CACHE_SIZE)
#define HAPI_BROAD_L3_ROUTE_TBL_SIZE   (L7_L3_ROUTE_TBL_SIZE_TOTAL + \
                                        L7_IPV6_ROUTE_TBL_SIZE_TOTAL)
#else
#define HAPI_BROAD_L3_NH_TBL_SIZE      (L7_L3_ARP_CACHE_SIZE)
#define HAPI_BROAD_L3_HOST_TBL_SIZE    (L7_L3_ARP_CACHE_SIZE)
#define HAPI_BROAD_L3_ROUTE_TBL_SIZE   (L7_L3_ROUTE_TBL_SIZE_TOTAL)
