...
void hapiBroadL3HwNhopAdd (L7_uint32 egrFlags, BROAD_L3_NH_ENTRY_t *pNhopEntry,
                           bcmx_l3_egress_t *pBcmxInfo, L7_BOOL cacheOrCommit);
...
*
*******************************************************************************/
void hapiBroadL3HwNhopDelete (bcm_if_t egressId, L7_BOOL  cacheOrCommit);
...
*
*******************************************************************************/
void hapiBroadL3HwHostDelete (bcmx_l3_host_t *pBcmxInfo,
                              L7_BOOL        cacheOrCommit);
...
*
*******************************************************************************/
void hapiBroadL3HwRouteDelete (bcmx_l3_route_t *pBcmxInfo,
                               L7_BOOL          flag);
