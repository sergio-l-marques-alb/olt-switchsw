/*
 * $Id: verinet.h,v 1.1 2011/04/18 17:11:09 mruas Exp $
...
extern uint32 dma_writemem(int sockfd, uint32 addr, uint32 data);
extern uint32 dma_readmem(int sockfd,uint32 addr);
uint32 dma_write_bytes(int sockfd, uint32 addr, uint8 *data, int len);
uint32 dma_read_bytes(int sockfd, uint32 addr, uint8 *data, int len);
