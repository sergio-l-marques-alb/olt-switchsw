/*
 * $Id: socend.c,v 1.1 2011/04/18 17:11:09 mruas Exp $
...
static	mac_addr_t	mac_zero = {0, 0, 0, 0, 0, 0};
static	mac_addr_t	mac_ones = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
 ...
 */
{
	...
	if (!ENET_TAGGED((enet_hdr_t *)mb->mBlkHdr.mData)) {
	  ...
	  /* Set COS to default here */
	    ...
	    /* Copy MAC addresses */
	    sal_memcpy(eh, mb->mBlkHdr.mData, sizeof(mac_addr_t) * 2);
	...
	d_packet_format("socend TX", DECODE_ETHER, packet, l);
    }
 ...
 */
{
    ...
    if (debugk_check(DK_END+DK_PACKET)) {
	d_packet_format("socend RX", DECODE_ETHER, pckt, pckt_size);
    }
#endif /* BROADCOM_DEBUG */
    /*
