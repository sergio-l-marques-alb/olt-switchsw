/*
 * $Id: switch.h,v 1.1 2011/04/18 17:10:55 mruas Exp $
 * 
...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchTunnelIp4IdShared,         /* Share the IPv4 ID space across
                                           tunnels. */
#if defined(VENDOR_XYZ)
    bcmSwitchL2SrcDropOnPortMatchOnly,  /* L2 source MAC match packets are
                                           dropped on port match only. */
#endif
...
#if defined(VENDOR_XYZ)
#define BCM_SWITCH_CONTROL_VENDOR_STR   ,\
    "L2SrcDropOnPortMatchOnly" 
#endif
