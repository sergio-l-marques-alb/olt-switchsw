/*
 * $Id: mpls.h,v 1.1 2011/04/18 17:10:55 mruas Exp $
 * 
...
#define BCM_MPLS_PORT_EGRESS_TUNNEL         0x00001000 /* Specified egress
                                                          tunnel interface is
                                                          valid. */
#define BCM_MPLS_PORT_SERVICE_TAGGED        0x00002000 /* Service tag mode. */
#define BCM_MPLS_PORT_SERVICE_VLAN_ADD      0x00004000 /* Add SD-tag. */
#define BCM_MPLS_PORT_SERVICE_VLAN_REPLACE  0x00008000 /* Replace VLAN not TPID. */
#define BCM_MPLS_PORT_SERVICE_VLAN_DELETE   0x00010000 /* Delete VLAN tag. */
#define BCM_MPLS_PORT_SERVICE_VLAN_TPID_REPLACE 0x00020000 /* Replace VLAN and TPID. */
#define BCM_MPLS_PORT_INNER_VLAN_PRESERVE   0x00040000 /* Preserve the inner or
                                                          customer VLAN tag */
...
#define BCM_MPLS_VPN_INVALID    0xFFFF     /* Invalid MPLS VPN ID */
