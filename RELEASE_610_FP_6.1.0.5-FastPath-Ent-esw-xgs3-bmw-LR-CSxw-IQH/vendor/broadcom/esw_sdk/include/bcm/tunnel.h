/*
 * $Id: tunnel.h,v 1.1 2011/04/18 17:10:55 mruas Exp $
 * 
...
#define BCM_TUNNEL_TERM_WLAN_REMOTE_TERMINATE 0x00000010 /* Remote WLAN tunnel
                                                          termination */
#define BCM_TUNNEL_TERM_TUNNEL_WITH_ID      0x00000020 /* Create tunnel with ID */
#define BCM_TUNNEL_INIT_USE_INNER_DF        0x00000040 /* Copy DF from inner
                                                          header. Note:flag
                                                          takes precedence over
                                                          ipv4_set_df flag. */
#define BCM_TUNNEL_INIT_IPV4_SET_DF         0x00000080 /* Set DF bit in outer
                                                          header if inner header
                                                          is IPv4. */
#define BCM_TUNNEL_INIT_IPV6_SET_DF         0x00000100 /* Set DF bit in outer
                                                          header if inner header
                                                          is IPv6. */
#define BCM_TUNNEL_INIT_IP4_ID_SET_FIXED    0x00000200 /* Use fixed starting ID
                                                          for IPv4 tunnel */
#define BCM_TUNNEL_INIT_IP4_ID_SET_RANDOM   0x00000400 /* Use random starting ID
                                                          for IPv4 tunnel */
#define BCM_TUNNEL_INIT_WLAN_MTU            0x00000800 /* Set MTU for outgoing
                                                          WLAN tunnel */
#define BCM_TUNNEL_INIT_WLAN_VLAN_TAGGED    0x00001000 /* Set outgoing WLAN
                                                          tunnel vlan */
#define BCM_TUNNEL_INIT_WLAN_TUNNEL_WITH_ID 0x00002000 /* Create outgoing tunnel
                                                          with ID */
#define BCM_TUNNEL_REPLACE                  0x00004000 /* Update existing
                                                          tunnel. */
