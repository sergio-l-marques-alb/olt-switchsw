/*
 * $Id: field.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
typedef struct _field_counter32_collect_s {
    uint64 accumulated_counter_0; /* for in-band counter */
    uint64 accumulated_counter_1; /* for out-band counter */
    uint32 last_hw_value_0; /* for in-band counter */
    uint32 last_hw_value_1; /* for out-band counter */
