/*
 * $Id: port.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
/* egress port priority color Macro : for bcm53115 fo far */
#define _BCM_ROBO_COLOR_NONE    0   /* treat as inband */
#define _BCM_ROBO_COLOR_GREEN   0   /* inband */
#define _BCM_ROBO_COLOR_YELLOW  1   /* treat as Outband */
#define _BCM_ROBO_COLOR_RED     2   /* Outband (will be assigned as yellow)*/

/* color encoding rule (for bcm53115) 
 *  1. None bcm53115 : _BCM_ROBO_COLOR_NONE(==_BCM_ROBO_COLOR_GREEN)
 *  2. Green : _BCM_ROBO_COLOR_GREEN
 *  3. yellow : _BCM_ROBO_COLOR_YELLOW
 *  4. red : _BCM_ROBO_COLOR_YELLOW
 */
#define _BCM_COLOR_ENCODING(unit, color) \
        (SOC_IS_ROBO53115(unit) ? \
          (((color) == bcmColorGreen) ? _BCM_ROBO_COLOR_GREEN : \
            (((color) == bcmColorYellow) ? _BCM_ROBO_COLOR_YELLOW : \
                                          _BCM_ROBO_COLOR_YELLOW)) : \
                                          _BCM_ROBO_COLOR_NONE)
