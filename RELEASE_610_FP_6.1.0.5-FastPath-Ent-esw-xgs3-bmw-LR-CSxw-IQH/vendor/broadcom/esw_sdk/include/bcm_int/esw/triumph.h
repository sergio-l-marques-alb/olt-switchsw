/*
 * $Id: triumph.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
extern int bcm_tr_l2_cross_connect_traverse(int unit,
                                            ...
                                            void *user_data);
extern int _bcm_tr_l2_addr_replace_by_vlan_dest(int unit, uint32 flags, 
...
extern int bcm_tr_mpls_swap_nh_info_add(int unit, bcm_l3_egress_t *egr, int nh_index);
...
extern int bcm_tr_mpls_l3_label_add (int unit, bcm_mpls_label_t label, uint8 mpls_exp, int index, uint32 flags);
...
extern int bcm_tr_mpls_get_entry_type (int unit, int nh_index, uint8 *entry_type );
extern int bcm_tr_mpls_set_entry_type(int unit, int nh_index, bcm_if_t intf);
#endif /* INCLUDE_L3 */
