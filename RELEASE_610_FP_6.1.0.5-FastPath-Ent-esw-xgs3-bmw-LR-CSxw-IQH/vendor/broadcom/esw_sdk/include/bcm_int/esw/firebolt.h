/*
 * $Id: firebolt.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
#define BCM_XGS3_L3_ECMP_MAX(_u_)   (SOC_IS_SC_CQ(_u_) ? (256) : (32))
...
typedef struct _bcm_l3_ingress_intf_s {
    ...
    int global_route_enable;       /* Global route enable.  */
...
extern int bcm_xgs3_multicast_create(int unit, uint32 flags,
                                     bcm_multicast_t *group);
extern int bcm_xgs3_multicast_destroy(int unit, bcm_multicast_t group);
extern int bcm_xgs3_multicast_egress_add(int unit, bcm_multicast_t group,
                                         bcm_gport_t port,
                                         bcm_if_t encap_id);
extern int bcm_xgs3_multicast_egress_delete(int unit, bcm_multicast_t group,
                                            bcm_gport_t port,
                                            bcm_if_t encap_id);
...
extern int bcm_xgs3_multicast_egress_get(int unit, bcm_multicast_t group,
                                         int port_max,
                                         bcm_gport_t *port_array,
                                         bcm_if_t *encap_array,
                                         int *port_count);
...
extern int _bcm_field_fb_ingress_mode_set(int unit, uint8 slice_numb, 
