/*
 * $Id: vpn.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
#define _BCM_VPN_TYPE_VPWS         2
#define _BCM_VPN_TYPE_VPLS         3

#define _BCM_VPN_TYPE_MIM          4
...
#define _BCM_VPN_SET(_vpn_, _type_, _id_) \
    ((_vpn_) = ((_type_) << _BCM_VPN_TYPE_SHIFT)  | \
     ((_id_) & _BCM_VPN_ID_MASK))

#define _BCM_VPN_ID_GET(_vpn_) \
    ((_vpn_) & _BCM_VPN_ID_MASK)

#define _BCM_VPN_TYPE_GET(_vpn_) \
    (((_vpn_) >> _BCM_VPN_TYPE_SHIFT) & _BCM_VPN_TYPE_MASK)

#define _BCM_VPN_IS_L3(_vpn_)    \
        (((_vpn_) >> _BCM_VPN_TYPE_SHIFT) == _BCM_VPN_TYPE_L3)

#define _BCM_VPN_IS_VPLS(_vpn_)    \
        (((_vpn_) >> _BCM_VPN_TYPE_SHIFT) == _BCM_VPN_TYPE_VPLS)

#define _BCM_VPN_IS_VPWS(_vpn_)    \
        (((_vpn_) >> _BCM_VPN_TYPE_SHIFT) == _BCM_VPN_TYPE_VPWS)

#define _BCM_VPN_IS_MIM(_vpn_)    \
        (((_vpn_) >> _BCM_VPN_TYPE_SHIFT) == _BCM_VPN_TYPE_MIM)
