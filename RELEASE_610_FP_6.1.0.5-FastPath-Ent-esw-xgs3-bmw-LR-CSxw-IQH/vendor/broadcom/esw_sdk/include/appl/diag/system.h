/*
 * $Id: system.h,v 1.1 2011/04/18 17:10:55 mruas Exp $
...
#define FORMAT_PBMP_MAX   148   /* "0xdeadbeefdeadbeef; fe0,fe2,....ge2,hg" */
 ...
 extern int     format_pbmp(int unit, char *buf, int bufsize, soc_pbmp_t pbmp);
 extern int     format_bcm_pbmp(int unit, char *buf, int bufsize, bcm_pbmp_t pbmp);
