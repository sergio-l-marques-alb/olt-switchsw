/*
 * $Id: gport.h,v 1.1 2011/04/18 17:10:57 mruas Exp $
 ...
 * GPORT_MCAST_QUEUE_GROUP_SET  set a queue group type and value
 * GPORT_MCAST_QUEUE_GROUP_GET  get a queue group ID from a gport
 ...
 * GPORT_MIM_PORT_SET           set a MIM ID type and value
 * GPORT_MIM_PORT_GET           get a MIM ID from a MPLS gport
 * GPORT_WLAN_PORT_SET          set a WLAN ID type and value
 * GPORT_WLAN_PORT_GET          get a WLAN ID from a MPLS gport
...
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_MCAST_SUBSCRIBER_QUEUE_GROUP /* Used for sanity */
                                                            /* checks only.    */
...
#define _SHR_GPORT_LOCAL_CPU_GET(_gport)                                  \
        (((_gport) >> _SHR_GPORT_PORT_SHIFT) & _SHR_GPORT_PORT_MASK)
...
#define _SHR_GPORT_EGRESS_GROUP_SET(_egress_group_gport, _child_modid, _egress_child) \
	 ...
	 (((_egress_child) & _SHR_GPORT_EGRESS_CHILD_PORT_MASK) << (_SHR_GPORT_EGRESS_GROUP_SHIFT + 2)))
