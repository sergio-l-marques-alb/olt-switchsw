/*
 * $Id: port.h,v 1.1 2011/04/18 17:10:57 mruas Exp $
...
typedef enum _shr_port_encap_e {
    ...
    _SHR_PORT_ENCAP_HIGIG2_L2 = 4,  /* HIGIG2 Transport mode   */
    _SHR_PORT_ENCAP_HIGIG2_IP_GRE = 5,  /* HIGIG2 Tunnel mode   */
    _SHR_PORT_ENCAP_SBX = 6,        /* SBX Header mode         */
...
typedef enum _shr_port_phy_control_longreach_ability_e {
    ...
    _SHR_PORT_PHY_CONTROL_LONGREACH_ABILITY_100M_1PAIR=4,
    _SHR_PORT_PHY_CONTROL_LONGREACH_ABILITY_100M_2PAIR=8,
    _SHR_PORT_PHY_CONTROL_LONGREACH_ABILITY_100M_4PAIR=16,
    _SHR_PORT_PHY_CONTROL_LONGREACH_ABILITY_PAUSE_RX=32,
    _SHR_PORT_PHY_CONTROL_LONGREACH_ABILITY_PAUSE_TX=64
