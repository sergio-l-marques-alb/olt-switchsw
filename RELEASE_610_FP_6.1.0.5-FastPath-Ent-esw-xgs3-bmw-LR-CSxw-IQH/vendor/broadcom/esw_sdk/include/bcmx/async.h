 ...
 *
 * $Id: async.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
void	bcmx_port_control_get_async(bcmx_lport_t port, bcm_port_control_t type, int * arg, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_port_control_set_async(bcmx_lport_t port, bcm_port_control_t type, int arg, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_vlan_gport_add_async(bcm_vlan_t vlan, bcm_gport_t port, int is_untagged, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_vlan_gport_get_async(bcm_vlan_t vlan, bcm_gport_t port, int * is_untagged, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_vlan_gport_get_all_async(bcm_vlan_t vlan, int array_max, bcm_gport_t * gport_array, int * is_untagged, int * array_size, bcmx_async_cb_t async_callback, void *async_cookie);
