/*
 * $Id: hash.h,v 1.1 2011/04/18 17:10:57 mruas Exp $
...
extern uint32   soc_tr2_vlan_xlate_hash(int unit, int hash_sel, int key_nbits, 
                                       uint32 *base_entry, uint8 *key);
extern int      soc_tr2_vlan_xlate_base_entry_to_key(int unit, uint32 *entry, 
                                                    uint8 *key);
extern uint32   soc_tr2_vlan_xlate_entry_hash(int unit, int hash_sel, 
                                             uint32 *entry);
extern uint32   soc_tr2_vlan_xlate_bank_entry_hash(int unit, int bank, uint32 *entry);

extern uint32   soc_tr2_egr_vlan_xlate_hash(int unit, int hash_sel, int key_nbits, 
                                           uint8 *key);
extern int      soc_tr2_egr_vlan_xlate_base_entry_to_key(int unit, uint32 *entry, 
                                                        uint8 *key);
extern uint32   soc_tr2_egr_vlan_xlate_entry_hash(int unit, int hash_sel, 
                                                 uint32 *entry);
extern uint32   soc_tr2_egr_vlan_xlate_bank_entry_hash(int unit, int bank, uint32 *entry);

extern uint32   soc_tr2_mpls_hash(int unit, int hash_sel, int key_nbits, 
                                 uint32 *base_entry, uint8 *key);
extern int      soc_tr2_mpls_base_entry_to_key(int unit, uint32 *entry, uint8 *key);
extern uint32   soc_tr2_mpls_entry_hash(int unit, int hash_sel, uint32 *entry);
extern uint32   soc_tr2_mpls_bank_entry_hash(int unit, int bank, uint32 *entry);
#endif
...
#define SOC_HASH_VRF_BITS(unit)    \
        (SOC_IS_FIREBOLT2(unit) || SOC_IS_RAVEN(unit) || SOC_IS_HAWKEYE(unit) ? FB2_HASH_VRF_BITS : TRX_HASH_VRF_BITS)
#define SOC_HASH_VRF_MASK(unit)    \
        (SOC_IS_FIREBOLT2(unit) || SOC_IS_RAVEN(unit) || SOC_IS_HAWKEYE(unit) ? FB2_HASH_VRF_MASK : TRX_HASH_VRF_MASK)
