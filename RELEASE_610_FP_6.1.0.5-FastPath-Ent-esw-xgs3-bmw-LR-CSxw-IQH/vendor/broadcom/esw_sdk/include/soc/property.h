/*
 * $Id: property.h,v 1.1 2011/04/18 17:10:57 mruas Exp $
...
#define spn_L3_OPTIMIZE                 "l3_optimize"
#define spn_L3_V4UC_DEV_MEMSIZE         "v4uc_dev_sram_size"
#define spn_L3_V4UC_SA_DEV_MEMSIZE       "v4uc_salpm_sram_size"
#define spn_L3_V6UC_DEV_MEMSIZE         "v6uc_dev_sram_size"
#define spn_L3_V6UC_SA_DEV_MEMSIZE       "v6uc_salpm_sram_size"
...
#define spn_PHY_HC65_1LANE_MODE         "phy_hc65_1lane_mode"
#define spn_PHY_53115_WAR               "phy_53115_war"
...
#define spn_TABLE_DMA_SIZE              "table_dma_size"
...
#define spn_SERDES_SELECT_PHYA          "serdes_select_PHYA"
...
#define spn_BCM56639_28G_7X             "bcm56639_28g_7x10"
...
#define spn_SKIP_CMIC_REGTEST           "cmic_regtest_skip"
#define spn_DELAY_CORE_PLL_LOCK         "delay_core_pll_lock"
...
/* If set to 1, Batching is enabled on Caladan1 devices on PPE and RCE */
#define spn_FE_UCODE_FEATURE_BATCHING   "bcm88020_batch"
 ...
 *   spn_PORT_TYPE_ABILITY - one of  SOC_PORT_ABILITY_SFI/_SCI/_DUAL_SFI/_SFI_SCI
 *   spn_QE2K_LINKS
 *   spn_QE4K_LINKS
 *
 *   spn_SCI_PORT_MODID
...
#define spn_PORT_TYPE_ABILITY           "port_type_ability"
 ...
 *             Global SP.
 *
 *   spn_DUAL_LOCAL_GRANTS
 *      - Sirius only, dual local grants for local queues
 *
...
#define spn_DUAL_LOCAL_GRANTS             "dual_local_grants"
#define spn_IF_SUBPORTS                   "if_subports"
#define spn_IF_SUBPORTS_CREATE            "if_subports_create"
#define spn_IF_PROTOCOL                   "if_protocol"
#define spn_IF_CPU_PROTOCOL               "if_cpu_protocol"
#define spn_IF_LAGID                      "if_lagid"
...
#define spn_QE_HI_MC_PRI                  "qe_hi_mc_priority"
#define spn_QE_LO_MC_PRI                  "qe_lo_mc_priority"
...
#define spn_SIRIUS_CLOCK_SPEED                "sirius_clock_speed"
#define spn_SIRIUS_DDR3_1G_RAM_8KROWS_1KCOLS  "sirius_ddr3_1g_ram_8krows_1kcols"
#define spn_SIRIUS_DDR3_2G_RAM_16KROWS_1KCOLS "sirius_ddr3_2g_ram_16krows_1kcols"
#define spn_SIRIUS_DDR3_2G_RAM_8KROWS_2KCOLS  "sirius_ddr3_2g_ram_8krows_2kcols"
#define spn_SIRIUS_DMA_BEAT_COUNT             "sirius_fifo_beat_count"
#define spn_SIRIUS_DMA_HOSTNUM_ENTRIES        "sirius_fifo_hostnum_entries"
#define spn_SIRIUS_DDR_HW_TRAIN               "sirius_ddr_hw_train"
#define spn_SIRIUS_SW_DDR_TRAIN_INTERVAL      "sirius_ddr_sw_ddr_train_interval"
...
/*
 * Following properties are for MACSEC.
 */

/*
 * spn_MACSEC_ENABLE : Specifies to enable or disable MACSEC on a 
 * MACSEC PHY device (Default is to disable MACSEC)
 *
 * spn_MACSEC_DEVICE_ADDRESS : specifies the MDIO address for the
 * MACSEC PHY device.
 *
 * spn_MACSEC_DEVICE_PORT : specifies Port index within the multi-port
 * MACSEC PHY device.
 *
 * spn_MACSEC_PHY_SW_MAC_POLICY : specifies policy for Switch MAC speec and 
 * duplex setting with respect to Line MAC settings.
 * Default is that Switch MAC follows Line MAC speed and duplex settings.
 */
#define spn_MACSEC_ENABLE                   "macsec_enable"
#define spn_MACSEC_DEVICE_ADDRESS           "macsec_dev_addr"
#define spn_MACSEC_DEVICE_PORT              "macsec_port_index"
#define spn_MACSEC_PHY_SW_MAC_POLICY        "macsec_phy_sw_mac_policy"
