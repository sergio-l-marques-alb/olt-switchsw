/*
 * $Id: macsecphy.h,v 1.1 2011/04/18 17:10:57 mruas Exp $
 ...
 */
#define SOC_MACSECPHY_MDIO_ADDR(unit, mdio, clause45, cl45_devad) \
                        ((((unit) & 0xff) << 24)    |      \
                         (((mdio) & 0xff) << 0)     |      \
                         (((clause45) & 0x1) << 8)  |      \
                         (((clause45) & 0x3f) << 9))
...
#define SOC_MACSECPHY_ADDR2CLAUSE45_DEVAD(a)  (((a) >> 9) & 0x3f)
