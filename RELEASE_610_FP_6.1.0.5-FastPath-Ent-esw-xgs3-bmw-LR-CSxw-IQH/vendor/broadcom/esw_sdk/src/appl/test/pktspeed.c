/*
 * $Id: pktspeed.c,v 1.1 2011/04/18 17:11:00 mruas Exp $
...
pktspeed_run_test(int tx_test, pktspeed_param_t *psp)
{
    ...
    int channel;
    bcm_pkt_t *pkt = NULL;
    static mac_addr_t mac_dest = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
    static mac_addr_t mac_src  = {0x02, 0x11, 0x22, 0x33, 0x44, 0x66};
