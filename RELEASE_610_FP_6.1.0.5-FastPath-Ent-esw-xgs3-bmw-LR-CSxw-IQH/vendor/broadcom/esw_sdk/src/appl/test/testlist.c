/*
 * $Id: testlist.c,v 1.1 2011/04/18 17:11:00 mruas Exp $
...
#endif /* BCM_ESW_SUPPORT */
TEST(30,    "Counter widths",           TRC+TSEL+TALL+T88230,   0,                      0,                      ctr_test_width,         1,      0)
TEST(31,    "Counter read/write",       TRC+TSEL+TALL+T88230,   0,                      0,                      ctr_test_rw,            1,      0)
#ifdef BCM_ESW_SUPPORT
...
#endif /* BCM_ESW_SUPPORT */
TEST(39,    "New Snake Test",   TRC+TALL,                lb2_snake_init,         lb2_done,               lb2_snake_test,         1,      0)
TEST(40,    "BCM Packet Send",          TALL,                    tpacket_tx_init,        tpacket_tx_done,        tpacket_tx_test,        1,      0)
#if defined(BCM_FILTER_SUPPORT) || defined(BCM_FIELD_SUPPORT) || defined(BCM_FE2000_SUPPORT)
TEST(41,    "BCM Packet Receive",       TRC+TXGSSW+T5395+T53115+T88020, rpacket_init,  rpacket_done,           rpacket_test,           1,      0)
...
TEST(65,    "BroadSAFE Self-Test",	TSEL+TXGS3SW,	bsafe_test_init,	bsafe_test_done,	bsafe_test_test,	1,	0)
#endif
