/*
 * $Id: tpacket.c,v 1.1 2011/04/18 17:11:00 mruas Exp $
...
#   define	P_O_PORT	5	/* Send to specific ports */
    ...
    mac_addr_t	p_dst;			/* Dest mac address */
...
static	mac_addr_t	tp_mac_uc = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55};
static	mac_addr_t	tp_mac_mc = {0x01, 0x11, 0x22, 0x33, 0x44, 0x44};
static	mac_addr_t	tp_mac_bc = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
