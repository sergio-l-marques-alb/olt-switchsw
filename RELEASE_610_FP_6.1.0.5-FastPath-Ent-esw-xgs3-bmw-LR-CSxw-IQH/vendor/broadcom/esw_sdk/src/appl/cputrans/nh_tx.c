/*
 * $Id: nh_tx.c,v 1.1 2011/04/18 17:10:59 mruas Exp $
 ...
 * go out on; this sets up the dest port/mod, the COS, and gives it
 * the default source mod/port.  If the CPUTRANS_NO_L2_UPDATE is not set,
 * then the L2 header is also updated.
 */
 ...
 *      cos         - COS on which to send packet
