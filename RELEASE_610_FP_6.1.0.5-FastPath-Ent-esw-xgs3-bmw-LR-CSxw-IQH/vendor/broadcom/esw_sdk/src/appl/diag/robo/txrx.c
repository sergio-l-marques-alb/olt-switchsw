/*
 * $Id: txrx.c,v 1.1 2011/04/18 17:11:00 mruas Exp $
...
typedef struct xd_s {           /* TX/RX description */
    ...
    mac_addr_t  xd_mac_dst;     /* Destination mac address */
    mac_addr_t  xd_mac_src;     /* Source mac address */
    mac_addr_t  xd_mac_src_base;    /* Source mac address for pps */
                                        /* port source mac */
...
{
    static mac_addr_t default_mac_src ={ 0x00, 0x01, 0x02, 0x03, 0x04, 0x05 };
...
robo_rx_cb_handler(int unit, bcm_pkt_t *info, void *cookie)
{
    ...
    soc_robo_dma_dump_pkt(unit, "Data: ", BCM_PKT_DMAC(info), info->tot_len);
