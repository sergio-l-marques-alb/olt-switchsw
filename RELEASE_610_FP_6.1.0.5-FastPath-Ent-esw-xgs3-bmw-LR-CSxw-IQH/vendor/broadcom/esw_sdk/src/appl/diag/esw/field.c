...
STATIC int fp_lookup_counter_mode(char *qual_str);
...
STATIC int fp_list_actions(int unit);
STATIC int fp_list_quals(int unit);
STATIC void fp_print_options(const char *options[], int offset);
...
fp_action_add(int unit, args_t *args)
{
    ...
    switch (action) {
        ...
        case bcmFieldActionUpdateCounter:
            ...
            p0 = fp_lookup_counter_mode(subcmd);
 ...
 */
STATIC int
fp_lookup_counter_mode(char *qual_str) {
    assert(qual_str != NULL);
