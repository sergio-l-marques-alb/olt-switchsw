/*
 * $Id: i2c_cmds.c,v 1.1 2011/04/18 17:10:59 mruas Exp $
 *
...
cmd_muxsel(int unit, args_t *a)
{
    ...
    if ( (fd = bcm_i2c_open(unit, I2C_LPT_0, 0,0)) < 0) {
	printk("%s: cannot open I2C device %s: %s\n",
	       ARG_CMD(a), I2C_LPT_0, bcm_errmsg(fd));
	return CMD_FAIL;
    }
...
soc_i2c_detect_board(void)
{
    ...
    else if (id_detected && (board_id == 0x55)){
        /* Apollo   */
        board_type = G22;
    }
