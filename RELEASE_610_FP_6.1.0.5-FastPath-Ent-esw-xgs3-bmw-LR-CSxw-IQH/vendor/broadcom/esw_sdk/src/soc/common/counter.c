/*
 * $Id: counter.c,v 1.1 2011/04/18 17:11:04 mruas Exp $
...
static egr_perq_xmt_counters_entry_t *xmt_table = NULL;
...
#ifdef BCM_TRIUMPH_SUPPORT
STATIC int
_soc_counter_tr_get_info(int unit, soc_port_t port, soc_reg_t id,
                         int *base_index, int *num_entries)
{
    soc_control_t *soc;
    soc_counter_non_dma_t *non_dma;

    if (id != SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_PKT &&
        id != SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_BYTE) {
        return SOC_E_PARAM;
    }
    ...
    /* following switch statement is borrowed from c-code */
    switch (port) {
    case  0: *base_index =  0               ; break ; /* 48 */
    case  1: *base_index =  0 + 48          ; break ; /* 8 */
    case  2: *base_index =  0 + 48 + 8      ; break ; /* 24 */
    case  3: *base_index =  0 + 48 + 8 + 24 ; break ; /* 24 */

        /* (48 + 8 + 24 + 24) = 104 so far */

    case  4: *base_index = 104 + (0*8)      ; break ; /* 8 */
    case  5: *base_index = 104 + (1*8)      ; break ; /* 8 */
    case  6: *base_index = 104 + (2*8)      ; break ; /* 8 */
    case  7: *base_index = 104 + (3*8)      ; break ; /* 8 */
    case  8: *base_index = 104 + (4*8)      ; break ; /* 8 */
    case  9: *base_index = 104 + (5*8)      ; break ; /* 8 */
    case 10: *base_index = 104 + (6*8)      ; break ; /* 8 */
    case 11: *base_index = 104 + (7*8)      ; break ; /* 8 */
    case 12: *base_index = 104 + (8*8)      ; break ; /* 8 */
    case 13: *base_index = 104 + (9*8)      ; break ; /* 8 */

        /* (104 + (10*8)) = 184 so far */

    case 14: *base_index = 184             ; break ; /* 24 */
    case 15: *base_index = 184 + 24        ; break ; /* 24 */

        /* (184 + (2*24)) = 232 so far */

    case 16: *base_index = 232 + (0*8)     ; break ; /* 8 */
    case 17: *base_index = 232 + (1*8)     ; break ; /* 8 */
    case 18: *base_index = 232 + (2*8)     ; break ; /* 8 */
    case 19: *base_index = 232 + (3*8)     ; break ; /* 8 */
    case 20: *base_index = 232 + (4*8)     ; break ; /* 8 */
    case 21: *base_index = 232 + (5*8)     ; break ; /* 8 */
    case 22: *base_index = 232 + (6*8)     ; break ; /* 8 */
    case 23: *base_index = 232 + (7*8)     ; break ; /* 8 */
    case 24: *base_index = 232 + (8*8)     ; break ; /* 8 */
    case 25: *base_index = 232 + (9*8)     ; break ; /* 8 */

        /* (232 + (10*8)) = 312 so far */

    case 26: *base_index = 312 + (0*24)    ; break ; /* 24 */
    case 27: *base_index = 312 + (1*24)    ; break ; /* 24 */
    case 28: *base_index = 312 + (2*24)    ; break ; /* 24 */
    case 29: *base_index = 312 + (3*24)    ; break ; /* 24 */
    case 30: *base_index = 312 + (4*24)    ; break ; /* 24 */
    case 31: *base_index = 312 + (5*24)    ; break ; /* 24 */
    case 32: *base_index = 312 + (6*24)    ; break ; /* 24 */

        /* (312 + (7*24)) = 480 so far */

    case 33: *base_index = 480 + (0*8)     ; break ; /* 8 */
    case 34: *base_index = 480 + (1*8)     ; break ; /* 8 */
    case 35: *base_index = 480 + (2*8)     ; break ; /* 8 */
    case 36: *base_index = 480 + (3*8)     ; break ; /* 8 */
    case 37: *base_index = 480 + (4*8)     ; break ; /* 8 */
    case 38: *base_index = 480 + (5*8)     ; break ; /* 8 */
    case 39: *base_index = 480 + (6*8)     ; break ; /* 8 */
    case 40: *base_index = 480 + (7*8)     ; break ; /* 8 */
    case 41: *base_index = 480 + (8*8)     ; break ; /* 8 */
    case 42: *base_index = 480 + (9*8)     ; break ; /* 8 */

        /* (480 + (10*8)) = 560 so far */

    case 43: *base_index = 560 + (0*12)    ; break ; /* 24 */

        /* (560 + (1*24)) = 584 so far */

    case 44: *base_index = 584 + (0*8)     ; break ; /* 8 */
    case 45: *base_index = 584 + (1*8)     ; break ; /* 8 */
    case 46: *base_index = 584 + (2*8)     ; break ; /* 8 */
    case 47: *base_index = 584 + (3*8)     ; break ; /* 8 */
    case 48: *base_index = 584 + (4*8)     ; break ; /* 8 */
    case 49: *base_index = 584 + (5*8)     ; break ; /* 8 */
    case 50: *base_index = 584 + (6*8)     ; break ; /* 8 */
    case 51: *base_index = 584 + (7*8)     ; break ; /* 8 */
    case 52: *base_index = 584 + (8*8)     ; break ; /* 8 */
    case 53: *base_index = 584 + (9*8)     ; break ; /* 8 */
    default:
        return SOC_E_PARAM;
    }
...
STATIC int
_soc_counter_tr2_get_info(int unit, soc_port_t port, soc_reg_t id,
                         int *base_index, int *num_entries)
{
    soc_control_t *soc;
    soc_counter_non_dma_t *non_dma;
    ...
    /* 48 so far, these are 8 queue ports */
    case  1: 
    case  2: 
    case  3: 
    case  4: 
    ...
    case  24: 
    case  25: 
        *base_index = 48 + ((port-1)*8);
        break;

    /* 248 so far, these are 24 queue ports */
    case  26: 
    case  27: 
    case  28: 
    case  29: 
    case  30: 
    case  31: 
        *base_index = 248 + ((port-26)*24);
        break ; 

    /* 392 so far, these are 8 queue ports */
    case  32: 
    case  33: 
        *base_index = 392 + ((port-32)*8);
        break;

    /* 408 so far, these are 24 queue ports */
    case  34: 
        *base_index = 408;
        break ; 

    /* 432 so far, these are 8 queue ports */
    case  35: 
    case  36: 
    case  37: 
        *base_index = 432 + ((port-35)*8);
        break;

    /* 456 so far, these are 24 queue ports */
    case  38: 
    case  39: 
        *base_index = 456 + ((port-38)*24);
        break ; 

    /* 504 so far, these are 8 queue ports */
    case  40: 
    case  41: 
        *base_index = 504 + ((port-40)*8);
        break;

    /* 520 so far, these are 24 queue ports */
    case  42: 
    case  43: 
        *base_index = 520 + ((port-42)*24);
        break ; 

    /* 568 so far, these are 8 queue ports */
    case  44: 
    case  45: 
        *base_index = 568 + ((port-44)*8);
        break;

    /* 584 so far, these are 24 queue ports */
    case  46: 
        *base_index = 584;
        break ; 
 
    /* 608 so far, these are 8 queue ports */
    case  47: 
    case  48: 
    case  49: 
        *base_index = 608 + ((port-47)*8);
        break;

    /* 632 so far, these are 24 queue ports */
    case  50: 
    case  51: 
        *base_index = 632 + ((port-50)*24);
        break ; 

    /* 680 so far, these are 8 queue ports */
    case  52: 
    case  53: 
        *base_index = 680 + ((port-52)*8);
        break;

    /* 696 so far, these are 16 queue ports */
    case  54: 
        *base_index = 696; 
        break;
    default:
...
#ifdef BCM_ENDURO_SUPPORT
STATIC int
_soc_counter_en_get_info(int unit, soc_port_t port, soc_reg_t id,
                         int *base_index, int *num_entries)
{
    soc_control_t *soc;
    soc_counter_non_dma_t *non_dma;
    ...
    /* 344 so far, these are 8 queue ports */
    default:
        return SOC_E_PARAM;
    }
    *base_index += non_dma->base_index;
                      ...
                      int *base_index, int *num_entries, char **cname)
{
    ...
    if (ctr_reg >= NUM_SOC_REG) {
        ...
        rv = SOC_E_UNAVAIL;
#ifdef BCM_TRIUMPH_SUPPORT
        if (SOC_IS_TR_VL(unit) && !SOC_IS_TRIUMPH2(unit) && !SOC_IS_ENDURO(unit)
            && !SOC_IS_APOLLO(unit) && !SOC_IS_VALKYRIE2(unit)) {
            rv = _soc_counter_tr_get_info(unit, port, ctr_reg, base_index,
                                          num_entries);
        }
#ifdef BCM_TRIUMPH2_SUPPORT
        else if (SOC_IS_TRIUMPH2(unit) || SOC_IS_APOLLO(unit) || 
                 SOC_IS_VALKYRIE2(unit)){
            rv = _soc_counter_tr2_get_info(unit, port, ctr_reg, base_index,
                                          num_entries);
        }
#endif
#ifdef BCM_ENDURO_SUPPORT
        else if (SOC_IS_ENDURO(unit)){
            rv = _soc_counter_en_get_info(unit, port, ctr_reg, base_index,
                                          num_entries);
        }
#endif /* BCM_ENDURO_SUPPORT */
#endif /* BCM_TRIUMPH_SUPPORT */
...
{
    soc_control_t       *soc;
    int                 n_entries, n_bytes, non_dma_entries;
    ...
    /*
     * Include the non CMIC counter DMA supported counters
     */
    ...
    if (SOC_IS_TR_VL(unit)) {
        ...
        non_dma = &soc->counter_non_dma[SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_PKT -
                                        SOC_COUNTER_NON_DMA_START];
        non_dma->base_index = n_entries + non_dma_entries;
        non_dma->num_entries = soc_mem_index_count(unit,
                                                   EGR_PERQ_XMT_COUNTERSm);
        non_dma->entries_per_port = 48;
        non_dma->mem = EGR_PERQ_XMT_COUNTERSm;
        non_dma->field = PACKET_COUNTERf;
        non_dma->cname = "PERQ_PKT";
        ...
        non_dma->entries_per_port = 48;
        non_dma->mem = EGR_PERQ_XMT_COUNTERSm;
        non_dma->field = BYTE_COUNTERf;
        non_dma->cname = "PERQ_BYTE";
        non_dma_entries += non_dma->num_entries;
    }
#endif                                           
    ...
    if (SOC_IS_TR_VL(unit)) {
        ...
        count = soc_mem_index_count(unit, EGR_PERQ_XMT_COUNTERSm);
        if (xmt_table == NULL) {
            xmt_table = soc_cm_salloc(unit, count * sizeof(xmt_table[0]),
                                      "non_dma_counter");
            if (xmt_table == NULL) {
                goto error;
            }
            sal_memset(xmt_table, 0, count * sizeof(xmt_table[0]));
        }
    }
#endif /* BCM_TRIUMPH_SUPPORT */
                 ...
                 int zero, uint64 *val)
{
    ...
    /* Probably don't need to use vptr on modern compiler, it should not
     * recalculate the offset of the variable over and over.
     * but still keep it */
                 ...
                 int ar_idx, uint64 val64)
{
    ...
    for (index = index_min; index <= index_max; index++) {
        if (ctr_reg >= NUM_SOC_REG) {
            ...
            /* so far, non_dma counter are all in memory table */
            rv = soc_mem_read(unit, non_dma->mem, MEM_BLOCK_ANY,
                              port_index - non_dma->base_index + index,
                              entry);
            if (SOC_FAILURE(rv)) {
                goto counter_set_done;
            }
            soc_mem_field32_set(unit, non_dma->mem, entry, non_dma->field,
                                 COMPILER_64_LO(val64));
            rv = soc_mem_write(unit, non_dma->mem, MEM_BLOCK_ANY,
                               port_index - non_dma->base_index + index,
                               entry);
            if (SOC_FAILURE(rv)) {
                goto counter_set_done;
            ...
            if (!(SOC_REG_INFO(unit, ctr_reg).flags & SOC_REG_FLAG_64_BITS) &&
                ...
                if (prime_ctr_write) {
                    rv = soc_reg32_read(unit, addr, &val32);
                    if (SOC_FAILURE(rv)) {
                        goto counter_set_done;
                    }
                }
                rv = soc_reg_write(unit, ctr_reg, addr, val64);
                if (SOC_FAILURE(rv)) {
                    goto counter_set_done;
                }
                if (prime_ctr_write) {
...
soc_counter_set_by_port(int unit, pbmp_t pbmp, uint64 val)
{
    ...
    PBMP_ITER(pbmp, port) {
        ...
        if (SOC_IS_HBX(unit)) {
            SOC_IF_ERROR_RETURN
                (WRITE_HOLD_Xr(unit, port, COMPILER_64_LO(val)));
            SOC_IF_ERROR_RETURN
                (WRITE_HOLD_Yr(unit, port, COMPILER_64_LO(val)));
        }
#endif
    }
    ...
    PBMP_ITER(soc->counter_pbmp, port) {
        ...
        for (index = 0; index < PORT_CTR_NUM(unit, port);
            ...
            if ( (recheck_cntrs == TRUE) && (ctr_new != ctr_prev) ) {
                ...
                SOC_IF_ERROR_RETURN
                  (soc_reg32_read(unit,
                                  soc_reg_addr(unit, ctr_reg, port, 0),
                                  &ctr_new2));
...
soc_counter_collect64(int unit, int discard)
{
    ...
    PBMP_ITER(soc->counter_pbmp, port) {
        ...
        if (rxcnt_xaui &&
            ...
            if (soc_reg_read(unit, reg_1a, adr_1a, &val_1a) == 0 &&
                soc_reg_read(unit, reg_1b, adr_1b, &val_1b) == 0 &&
                soc_reg_read(unit, reg_2a, adr_2a, &val_2a) == 0 &&
                soc_reg_read(unit, reg_2b, adr_2b, &val_2b) == 0) {
                ...
                if (rxcnt_appear_valid && counter_tmp) {
                    ...
                    if (soc_reg_read(unit, reg_1b, adr_1b, &val_1b) == 0 &&
                        soc_reg_read(unit, reg_2b, adr_2b, &val_2b) == 0) {
        ...
        for (index = 0; index < PORT_CTR_NUM(unit, port); index++) {
            ...
            if (pio_hold && ctr_reg == HOLDr) {
                if (pio_hold_enable) {
                    ...
                    SOC_IF_ERROR_RETURN
                        (soc_reg32_read(unit,
                                      soc_reg_addr(unit, HOLD_Xr, port, ar_idx),
                                      &ctr_x));
                    SOC_IF_ERROR_RETURN
                        (soc_reg32_read(unit,
                                      soc_reg_addr(unit, HOLD_Yr, port, ar_idx),
                                      &ctr_y));
...
soc_counter_collect_non_dma_entries(int unit)
{
    ...
    if (SOC_IS_TR_VL(unit)) {
        ...
        count = soc_mem_index_count(unit, EGR_PERQ_XMT_COUNTERSm);
        if (SOC_FAILURE(soc_mem_read_range(unit, EGR_PERQ_XMT_COUNTERSm,
            MEM_BLOCK_ANY, 0, count - 1, xmt_table)))
        {
            return;
        }
    }
    ...
    for (id = 0; id < SOC_COUNTER_NON_DMA_END - SOC_COUNTER_NON_DMA_START;
        ...
        for (i = 0; i < non_dma->num_entries; i++) {
...
#ifdef BCM_TRIUMPH_SUPPORT
            if (SOC_IS_TR_VL(unit)) {
                switch(SOC_COUNTER_NON_DMA_START + id) {
                case SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_PKT:
                    ctr_new = soc_mem_field32_get(unit, EGR_PERQ_XMT_COUNTERSm,
                                                  &xmt_table[i],
                                                  PACKET_COUNTERf);
                    width = soc_mem_field_length(unit, EGR_PERQ_XMT_COUNTERSm,
                                                 PACKET_COUNTERf);
                    break;
            ...
            base_index = non_dma->base_index;
            ctr_prev = COMPILER_64_LO(soc->counter_hw_val[base_index + i]);
            diff = ctr_new - ctr_prev;
            if (!diff) {
            ...
            COMPILER_64_SET(soc->counter_hw_val[base_index + i], 0, ctr_new);
            COMPILER_64_ADD_32(soc->counter_sw_val[base_index + i], diff);
            COMPILER_64_SET(soc->counter_delta[base_index + i], 0, diff);
        }
    }
}
...
_soc_xgs3_counter_dma_setup(int unit)
{
    ...
    int                 blk, blk_num, port, port_num, block;
    uint32              blknum_map[13];
    uint32              portnum_map[16];
    ...
    for (ctype = 0; ctype < SOC_CTR_NUM_TYPES; ctype++) {
        ...
        for (csize = SOC_CTR_MAP_SIZE(unit, ctype) - 1; csize > 0; csize--) {
            ...
            if ((SOC_REG_INFO(unit, reg).block == ing_blk) &&
                                        (ing_c_cnt == 0)) {
                ing_c_cnt = csize + 1;
                ing_pstage = (SOC_REG_INFO(unit, reg).offset >> 24) & 0xFF;
            }
            if ((SOC_REG_INFO(unit, reg).block == egr_blk) &&
                                        (egr_c_cnt == 0)) {
                egr_c_cnt = csize + 1;
                egr_pstage = (SOC_REG_INFO(unit, reg).offset >> 24) & 0xFF;
            }
            if (((SOC_REG_INFO(unit, reg).block & SOC_BLK_GPORT) ||
                 (SOC_REG_INFO(unit, reg).block & SOC_BLK_XGPORT) ||
                 (SOC_REG_INFO(unit, reg).block & SOC_BLK_SPORT)) &&
                                            (gmac_c_cnt == 0)) {
                gmac_c_cnt = csize + 1;
            }
            if (((SOC_REG_INFO(unit, reg).block & SOC_BLK_XPORT) ||
                 SOC_REG_INFO(unit, reg).block & SOC_BLK_GXPORT) &&
                                            (xmac_c_cnt == 0)) {
                xmac_c_cnt = csize + 1;
            }
#ifdef BCM_ENDURO_SUPPORT
            if (SOC_IS_ENDURO(unit)) {
                if ((SOC_REG_INFO(unit, reg).block & SOC_BLK_XQPORT) &&
                                            (xmac_c_cnt == 0)) {
                    xmac_c_cnt = csize + 1;
                }
            }
    ...
    for(ix = 0; ix < (sizeof(portnum_map) / sizeof(portnum_map[0])); ix++) {
        portnum_map[ix] = 0;
    }
    for(ix = 0; ix < (sizeof(blknum_map) / sizeof(blknum_map[0])); ix++) {
        blknum_map[ix] = 0;
    }
    if (SOC_IS_HB_GW(unit)) {
        PBMP_ITER(pbmp, port) {
            if (((SOC_IS_HB_GW(unit) && (port >= 24)) ||
                 (SOC_IS_SC_CQ(unit) && (port > 28)))) {
                assert(0);
            }
            blk = SOC_PORT_BLOCK(unit, port);
            port_num = SOC_PORT_BINDEX(unit,port);
            blk_num = SOC_BLOCK2OFFSET(unit, blk);
            blknum_map[port / 8] |= ((blk_num & 0xf) << (4 * (port % 8)));
            portnum_map[port / 6] |= ((port_num & 0x1f) << (5 * (port % 6)));
        }
    } else {
        int     np = 8;         /* Number of ports */
        int     npm = 0xf;      /* Mask value */
        int     fw = 4;         /* field width */
#if defined(BCM_RAPTOR_SUPPORT) || defined(BCM_TRX_SUPPORT)
        if (SOC_IS_RAPTOR(unit) || SOC_IS_RAVEN(unit) || SOC_IS_TRX(unit) || 
            SOC_IS_HAWKEYE(unit)) {
            np = 4;         /* 4 port entries per register */
            npm = 0xff;     /* Mask value  for 8 bit field per port */
            fw = 8;         /* field width */
        }
        ...
        PBMP_ITER(pbmp, port) {
            ...
            if (SOC_IS_TRIUMPH2(unit) || SOC_IS_APOLLO(unit) || 
                SOC_IS_VALKYRIE2(unit) || SOC_IS_ENDURO(unit)) {
                blknum_map[port / 5] |= (block << (6 * (port % 5)));
            } else {
                blknum_map[port / 8] |= (block << (4 * (port % 8)));
            }
            portnum_map[port / np] |= ((port_num & npm) << (fw * (port % np)));
        }
    }
    soc_cm_debug(DK_COUNTER,"ing_c_cnt = %d egr_c_cnt = %d gmac_c_cnt = %d xmac_c_cnt = %d\n"
                 "ing_pstage = %d egr_pstage = %d ing_blkoff = %d egr_blkoff = %d\n",
    ...
    if (!SOC_IS_TRIUMPH2(unit) && !SOC_IS_APOLLO(unit) && 
        !SOC_IS_ENDURO(unit) && !SOC_IS_VALKYRIE2(unit)) {
    ...
    if (SOC_IS_TRX(unit)) {
        ...
        WRITE_CMIC_STAT_DMA_PORT_TYPE_MAPr(unit,
                   SOC_PBMP_WORD_GET(PBMP_HG_ALL(unit), 0) |
                   SOC_PBMP_WORD_GET(PBMP_XE_ALL(unit), 0));
        WRITE_CMIC_STAT_DMA_PORT_TYPE_MAP_HIr(unit,
                       SOC_PBMP_WORD_GET(PBMP_HG_ALL(unit), 1) |
                       SOC_PBMP_WORD_GET(PBMP_XE_ALL(unit), 1));
    ...
    if (SOC_IS_HB_GW(unit)) {
        WRITE_CMIC_STAT_DMA_PORT_TYPE_MAPr(unit,
                   SOC_PBMP_WORD_GET(PBMP_PORT_ALL(unit), 0));
...
_soc_counter_dma_setup(int unit)
{
    ...
    for (ctype = 0; ctype < SOC_CTR_NUM_TYPES; ctype++) {
        ...
        for (; csize > 0; csize--) {
            ...
            if (SOC_REG_INFO(unit, reg).block == SOC_BLK_MMU) {
...
soc_counter_start(int unit, uint32 flags, int interval, pbmp_t pbmp)
{
    ...
    if (SOC_IS_HBX(unit)) {
        if (soc_property_get(unit, spn_CDMA_PIO_HOLD_ENABLE, 0)) {
            soc->counter_flags |= SOC_COUNTER_F_HOLD;
        }
    }
#endif /* BCM_BRADLEY_SUPPORT */
