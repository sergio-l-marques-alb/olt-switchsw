/*
 * $Id: feature.c,v 1.1 2011/04/18 17:11:04 mruas Exp $
...
soc_features_bcm5673_a0(int unit, soc_feature_t feature)
{
    ...
    case soc_feature_filter_128_rules:
        return (rev_id == BCM5673_A1_REV_ID);
...
soc_features_bcm56634_a0(int unit, soc_feature_t feature)
{
    ...
    if (dev_id == 0xb639 || dev_id == 0xb526) {
        esm = FALSE;
    }
    if (dev_id == 0xb639) {
        flex_port = TRUE;
...
{
    int     l3_disable, field_slices4, hawkeye_a0_war;
    uint16  dev_id;
    uint8   rev_id;
    ...
    l3_disable = (dev_id == BCM53312_DEVICE_ID ||
