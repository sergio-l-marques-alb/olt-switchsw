/*
 * $Id: phy54684.c,v 1.1 2011/04/18 17:11:07 mruas Exp $
...
_phy_54684_no_reset_setup(int unit, soc_port_t port)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY, "_phy_54684_reset_setup: u=%d p=%d medium=%s\n",
                     unit, port,
   ...
   /* SGMII interface to MAC */
     ...
     */
    SOC_IF_ERROR_RETURN
        (MODIFY_PHY54684_AUX_1000X_CTRLr(unit, pc, 0x0040, 0x0040));
...
phy_54684_init(int unit, soc_port_t port)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY, "phy_54684_init: u=%d p=%d\n",
                     unit, port));
    ...
    SOC_DEBUG_PRINT((DK_PHY, "phy_54684_init: "
...
phy_54684_enable_set(int unit, soc_port_t port, int enable)
{
    ...
    if (pc->copper.enable && (pc->automedium || PHY_COPPER_MODE(unit, port))) {
        ...
        SOC_DEBUG_PRINT((DK_PHY, "phy_54684_enable_set: "
...
_phy_54684_fiber_100fx_setup(int unit, soc_port_t port) 
{
    ...
    SOC_IF_ERROR_RETURN
            (MODIFY_PHY54684_SERDES_100FX_CTRLr(unit, pc, 0x1, 0x1));
...
#else /* INCLUDE_PHY_54684_ESW */
int _soc_phy_54684_not_empty;
