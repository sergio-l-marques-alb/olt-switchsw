/*
 * $Id: serdes100fx.c,v 1.1 2011/04/18 17:11:08 mruas Exp $
...
phy_serdes100fx_duplex_get(int unit, soc_port_t port, int *duplex)
{
    ...
    *duplex = TRUE;
    ...
    SOC_IF_ERROR_RETURN
        (READ_SERDES100FX_1000X_STAT1r(unit, pc, &reg0_16));
                                                                                
    if (reg0_16 & FX_1000X_STATUS1_SGMII_MODE) {
