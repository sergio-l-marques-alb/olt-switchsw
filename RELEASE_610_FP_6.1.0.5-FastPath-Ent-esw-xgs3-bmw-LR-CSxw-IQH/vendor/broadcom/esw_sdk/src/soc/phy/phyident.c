/*
 * $Id: phyident.c,v 1.1 2011/04/18 17:11:08 mruas Exp $
...
#endif /* defined(INCLUDE_PHY_54580_ESW) */
...
#if defined(INCLUDE_PHY_8481)
    {_chk_8481, _phy_id_BCM8481, "BCM8481", &phy_8481drv_xe, NULL},
#endif /* INCLUDE_PHY_8481 */
 ...
 */
static _block_phy_addr_t   _soc_phy_addr_bcm88230_a0[] = {
                         ...
                         uint16 *phy_addr, uint16 *phy_addr_int)
{
    ...
    *phy_addr = *phy_addr_int = 0x0;
    ...
    phy_info = &_soc_phy_addr_bcm88230_a0[0];
...
_chk_8481(int unit, soc_port_t port, soc_phy_table_t *my_entry,
             uint16 phy_id0, uint16 phy_id1, soc_phy_info_t *pi)
{
    uint16               new_phy_id0=0, new_phy_id1=0;
    uint8                phy_addr;
    ...
    /* Cannot trust the IDs passed as arguments as A0 chips return 0 in PMA/PMD.
       Instead discard them and read the IDs from DEVAD=0x1e.
     */

    if (soc_miimc45_read(unit,phy_addr,0x1e,MII_PHY_ID0_REG,&new_phy_id0) < 0) {
        return FALSE;
    }

    if (soc_miimc45_read(unit,phy_addr,0x1e,MII_PHY_ID1_REG,&new_phy_id1) < 0) {
        return FALSE;
    }

    new_phy_id0 = soc_property_port_get(unit, port, spn_PORT_PHY_ID0, new_phy_id0);
    new_phy_id1 = soc_property_port_get(unit, port, spn_PORT_PHY_ID1, new_phy_id1);

    if (my_entry->myNum == _phy_ident_type_get(new_phy_id0, new_phy_id1)) {
        pi->phy_name = my_entry->phy_name;
        return TRUE;
    }
...
STATIC phy_id_map_t phy_id_map[] = {
    ...
    { _phy_id_BCM8073,       PHY_BCM8073_OUI,       PHY_BCM8073_MODEL,
      PHY_REV_6},
    { _phy_id_BCM8481,       PHY_BCM8481_OUI,       PHY_BCM8481_MODEL,
      PHY_REV_ALL},
