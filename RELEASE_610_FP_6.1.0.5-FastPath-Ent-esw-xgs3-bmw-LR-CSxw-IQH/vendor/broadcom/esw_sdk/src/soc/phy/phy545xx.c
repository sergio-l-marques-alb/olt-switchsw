/*
 * $Id: phy545xx.c,v 1.1 2011/04/18 17:11:07 mruas Exp $
...
_phy_54580_medium_check(int unit, soc_port_t port, int *medium)
{
    ...
    phy_dev_addr = SOC_MACSECPHY_MDIO_ADDR(unit, pc->phy_id, 0, 0);
...
phy_54580_init(int unit, soc_port_t port)
{
    ...
    phy_dev_addr    = SOC_MACSECPHY_MDIO_ADDR(unit, pc->phy_id, 0, 0); 
    macsec_dev_addr = SOC_MACSECPHY_MDIO_ADDR(unit, pc->macsec_dev_addr, 0, 0);
    qsgmii_dev_addr = SOC_MACSECPHY_MDIO_ADDR(unit, qsgmii_mdio, 0, 0); 
