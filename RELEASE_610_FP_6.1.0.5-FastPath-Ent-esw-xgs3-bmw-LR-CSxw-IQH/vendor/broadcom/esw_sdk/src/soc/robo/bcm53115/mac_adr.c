/*
 * $Id: mac_adr.c,v 1.1 2011/04/18 17:11:08 mruas Exp $
 *
...
int
_drv_bcm53115_sec_mac_set(int unit, uint32 bmp, uint32 *mac, int mcast)
{
    int         rv = SOC_E_NONE;
    soc_pbmp_t  pbmp;
...
int
_drv_bcm53115_sec_mac_remove(int unit, uint32 bmp, uint32 *mac, int mcast)
{
    int         rv = SOC_E_NONE;
    soc_pbmp_t  pbmp;
    uint32      port, temp, vid, prio;
...
int
_drv_bcm53115_sec_mac_clear(int unit, uint32 bmp)
{
    int         rv = SOC_E_NONE;
...
int 
drv_bcm53115_mac_set(int unit, soc_pbmp_t pbmp, uint32 mac_type, uint8* mac, uint32 bpdu_idx)
{
    int     rv = SOC_E_NONE, mcast = 0;
    uint32  reg_addr, port;
    uint64  reg_v64 = 0, mac_field = 0;
    int     reg_len;
...
#ifdef LVL7_FIXUP
    else if (mac_type == DRV_MAC_SECURITY_ADD)
    {
        reg_index = PORT_EAP_CONr;
        fld_index = EAP_EN_UNI_DAf;
        custEap = 1;
 ...
 */
int 
drv_bcm53115_mac_get(int unit, uint32 port, uint32 mac_type, 
