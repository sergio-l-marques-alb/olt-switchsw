/*
 * $Id: bcm53115_service.h,v 1.1 2011/04/18 17:11:08 mruas Exp $Copyright: Copyright 2009 Broadcom Corporation.
...
#ifdef LVL7_FIXUP
int drv_bcm53115_vlan_evt_entry_get(int unit, int port, int evr_id, int *out_op, uint16 *out_vid,
                                    int *in_op, uint16 *in_vid);
int drv_bcm53115_vlan_evt_entry_add(int unit, int port, int *evr_id, int out_op, uint16 out_vid,
                                    int in_op, uint16 in_vid);
int drv_bcm53115_vlan_evt_entry_delete(int unit, int port, int evr_id);
int drv_bcm53115_vlan_evt_entry_modify(int unit, int port, int evr_id, int out_op, uint16 out_vid,
                                    int in_op, uint16 in_vid);
#endif
...
#ifdef LVL7_FIXUP
/* vlan_evt_entry_add       */  drv_bcm53115_vlan_evt_entry_add,
/* vlan_evt_entry_delete    */  drv_bcm53115_vlan_evt_entry_delete,
/* vlan_evt_entry_get       */  drv_bcm53115_vlan_evt_entry_get,
/* vlan_evt_entry_modify    */  drv_bcm53115_vlan_evt_entry_modify,
#endif
