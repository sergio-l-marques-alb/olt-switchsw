/*
 * $Id: bcm5389_service.h,v 1.1 2011/04/18 17:11:09 mruas Exp $
 *
...
int drv_bcm5396_queue_port_dfsv_get
    (int unit, uint8 port, uint8 dscp, uint8 *prio, uint8 *queue_n);
int drv_bcm5396_queue_mode_set(int unit, uint32 bmp, uint32 mode);
...
int drv_bcm5389_mstp_port_get(int unit, uint32 mstp_gid, 
                                        uint32 port, uint32 *port_state);
int drv_bcm5396_port_get(int unit, uint32 port, uint32 prop_type, 
                            uint32 *prop_val);
