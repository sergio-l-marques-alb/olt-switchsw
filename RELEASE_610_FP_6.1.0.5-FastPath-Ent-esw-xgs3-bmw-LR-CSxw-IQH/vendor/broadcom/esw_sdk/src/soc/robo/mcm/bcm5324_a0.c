 ...
 *
 * $Id: bcm5324_a0.c,v 1.1 2011/04/18 17:11:09 mruas Exp $
...
static soc_reg_info_t *soc_registers_bcm5324_a0[] = {
    ...
    &soc_robo_reg_list[SOC_REG_INT_BIST_STSr],
    NULL,    /* BIST_STS0 */
    NULL,    /* BIST_STS1 */
    NULL,    /* BONDING_PAD */
    ...
    &soc_robo_reg_list[SOC_REG_INT_DEFAULT_1Q_TAGr],
    ...
    &soc_robo_reg_list[SOC_REG_INT_FCON_FLOWMIXr],
    ...
    &soc_robo_reg_list[SOC_REG_INT_FCON_RSRV_BUFNUMr],
    NULL,    /* FCON_RXBASE_BUFNUM */
    &soc_robo_reg_list[SOC_REG_INT_FCON_RX_FCON_CTRLr],
    NULL,    /* FCON_SPARE0 */
    ...
    &soc_robo_reg_list[SOC_REG_INT_PWR_DOWN_MODEr],
    ...
    &soc_robo_reg_list[SOC_REG_INT_SGMII_CTL_GPr],
    ...
    &soc_robo_reg_list[SOC_REG_INT_SPECIAL_MNGTr],
    NULL,    /* SPIDIO0 */
    NULL,    /* SPIDIO1 */
    NULL,    /* SPIDIO2 */
    NULL,    /* SPIDIO3 */
    ...
    &soc_robo_reg_list[SOC_REG_INT_TBI_CTLr],
    NULL,    /* TC2COS_MAP */
