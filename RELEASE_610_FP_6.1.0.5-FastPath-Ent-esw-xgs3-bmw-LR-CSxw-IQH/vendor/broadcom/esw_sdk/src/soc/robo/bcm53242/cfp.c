/*
 * $Id: cfp.c,v 1.1 2011/04/18 17:11:08 mruas Exp $
 *
...
_drv53242_cfp_write(int unit, uint32 ram_type, uint32 index, drv_cfp_entry_t *entry)
{
    ...
    if (ram_type == DRV_CFP_RAM_METER) {
        ...
        (DRV_SERVICES(unit)->reg_field_set)
            (unit, CFP_ACCr, &reg_acc, RATE_METER_ENf, &fld_val);
    }
    ...
    switch (*action) {
        ...
        case DRV_CFP_ACT_IB_DROP:
            ...
            if (fld_val) {
                ...
                if ((*action == DRV_CFP_ACT_IB_REDIRECT) ||
        ...
        case DRV_CFP_ACT_OB_DROP:
            ...
            if (fld_val) {
                ...
                if ((*action == DRV_CFP_ACT_OB_REDIRECT) ||
