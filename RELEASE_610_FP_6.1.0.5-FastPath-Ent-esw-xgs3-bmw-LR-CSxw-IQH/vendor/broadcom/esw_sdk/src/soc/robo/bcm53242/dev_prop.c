/*
 * $Id: dev_prop.c,v 1.1 2011/04/18 17:11:08 mruas Exp $
 *
...
/*
 *  Function : drv_bcm53242_dev_prop_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53242_dev_prop_get(int unit, uint32 prop_type, uint32 *prop_val)
{
    switch (prop_type) {
        ...
        case DRV_DEV_PROP_TRUNK_NUM:
         if (SOC_IS_ROBO53242(unit)) {
                *prop_val = DRV_TRUNK_GROUP_NUM_BCM53242;
         } else {
                *prop_val = DRV_TRUNK_GROUP_NUM_BCM53262;
         }
            break;
        ...
        case DRV_DEV_PROP_AUTH_PBMP:
            if (SOC_IS_ROBO53242(unit)) {
                *prop_val = DRV_AUTH_SUPPORT_PBMP_BCM53242;
            } else {
                *prop_val = DRV_AUTH_SUPPORT_PBMP_BCM53262;
            }
            break;
        case DRV_DEV_PROP_RATE_CONTROL_PBMP:
            if (SOC_IS_ROBO53242(unit)) {
                *prop_val = DRV_RATE_CONTROL_SUPPORT_PBMP_BCM53242;
            } else {
                *prop_val = DRV_RATE_CONTROL_SUPPORT_PBMP_BCM53262;
            }
            break;
...
/*
 *  Function : drv_bcm53242_dev_prop_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53242_dev_prop_set(int unit, uint32 prop_type, uint32 prop_val)
{
