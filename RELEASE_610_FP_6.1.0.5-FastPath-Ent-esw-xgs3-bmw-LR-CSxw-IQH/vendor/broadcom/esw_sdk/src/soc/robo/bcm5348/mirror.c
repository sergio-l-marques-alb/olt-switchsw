/*
 * $Id: mirror.c,v 1.1 2011/04/18 17:11:09 mruas Exp $
 *
 ...
 */
int 
drv_bcm5348_mirror_set(int unit, uint32 enable, uint32 monitor_port, 
 ...
 */
int 
drv_bcm5348_mirror_get(int unit, uint32 *enable, uint32 *monitor_port, 
    soc_pbmp_t *ingress_bmp, soc_pbmp_t *egress_bmp)
{
    uint32      reg_addr, reg_len;
    uint64      reg_value, temp;
