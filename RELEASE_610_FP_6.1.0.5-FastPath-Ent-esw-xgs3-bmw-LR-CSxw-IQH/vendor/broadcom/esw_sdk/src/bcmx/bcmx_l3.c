/*
 * $Id: bcmx_l3.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
...
#define BCMX_L3_RV_REPLACE(_trv, _rv)    \
...
STATIC INLINE int
_bcmx_l3ip_to_bcm(bcmx_l3_host_t *l3xip, bcm_l3_host_t *l3ip)
{
    int                rv = BCM_E_NONE;
               ...
               int *free_lpm_blk)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_status(bcm_unit, free_l3intf, free_l3,
...
bcmx_l3_info(bcm_l3_info_t *l3info)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_info(bcm_unit, l3info);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
        BCMX_L3_RV_REPLACE(tmp_rv, rv);
...
bcmx_l3_intf_create(bcmx_l3_intf_t *intf)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        ...
        if (BCM_SUCCESS(tmp_rv) && rv == BCM_E_NONE) {
            rv = tmp_rv;
        }
    }
...
bcmx_l3_egress_get(bcm_if_t intf, bcmx_l3_egress_t *egr)
{
    ...
    int bcm_unit;              /* bcm device iterator.           */
    bcm_l3_egress_t bcm_egr;   /* Egress object.                 */
    int rv = BCM_E_NOT_FOUND;  /* Overall operation result.      */

    BCMX_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_l3_egress_get(bcm_unit, intf, &bcm_egr);
        if (BCM_SUCCESS(tmp_rv)) {
            BCM_IF_ERROR_RETURN(_bcmx_l3egress_from_bcm(egr, &bcm_egr));
            return tmp_rv;
        }
        BCMX_L3_RV_REPLACE(tmp_rv, rv);
    }
...
bcmx_l3_egress_find(bcmx_l3_egress_t *egr, bcm_if_t *intf)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, unit_cntr) {
        ...
        tmp_rv = bcm_l3_egress_find(bcm_unit, &bcm_egr, intf);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
        BCMX_L3_RV_REPLACE(tmp_rv, rv);
...
bcmx_l3_egress_traverse(bcm_l3_egress_traverse_cb trav_fn, void *user_data)
{
    ...
    BCMX_LOCAL_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_l3_egress_traverse(bcm_unit, trav_fn, user_data);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
        BCMX_L3_RV_REPLACE(tmp_rv, rv);
                             ...
                             bcm_if_t *intf_array, int *intf_count)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_l3_egress_multipath_get(bcm_unit, mpintf, intf_size,
                              ...
                              bcm_if_t *mpintf)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_l3_egress_multipath_find(bcm_unit, intf_count,
                                              intf_array, mpintf);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
                                  ...
                                  void *user_data)
{
    ...
    BCMX_LOCAL_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_l3_egress_multipath_traverse(bcm_unit, trav_fn, user_data);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
        BCMX_L3_RV_REPLACE(tmp_rv, rv);
                               ...
                               bcm_ip6_t *ip6_array, int *ip6_count) 
{
    ...
    BCMX_LOCAL_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_l3_ip6_prefix_map_get(bcm_unit, map_size, 
                                           ip6_array, ip6_count);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
...
bcmx_l3_host_find(bcmx_l3_host_t *info)
{
    ...
    BCM_IF_ERROR_RETURN(_bcmx_l3ip_to_bcm(info, &bcm_l3));
...
bcmx_l3_host_delete(bcmx_l3_host_t *ip_addr)
{
    ...
    BCM_IF_ERROR_RETURN(_bcmx_l3ip_to_bcm(ip_addr, &bcm_l3));
...
bcmx_l3_host_delete_by_network(bcmx_l3_route_t *route)
{
    ...
    /* Ignore destination conversion error for 'delete_by_network' */
    (void)_bcmx_l3route_to_bcm(route, &l3_route);
...
bcmx_l3_host_delete_by_interface(bcmx_l3_host_t *info)
{
    ...
    /* Ignore destination conversion error for 'delete_by_interface' */
    (void)_bcmx_l3ip_to_bcm(info, &bcm_l3);
...
bcmx_l3_host_delete_all(bcmx_l3_host_t *info)
{
    ...
    /* Ignore destination conversion error for 'delete_all' */
    (void)_bcmx_l3ip_to_bcm(info, &bcm_l3);
                          ...
                          int *cf_count)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_host_conflict_get(bcm_unit, ipkey,
                      ...
                      void *user_data)
{
    ...
    BCMX_LOCAL_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_host_traverse(bcm_unit,
                                      flags, start, end,
                                      cb, user_data);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
...
bcmx_l3_ip_find_index(int index, bcmx_l3_host_t *info)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_ip_find_index(bcm_unit, index, &bcm_l3);
        if (BCM_SUCCESS(tmp_rv)) {
            BCM_IF_ERROR_RETURN(_bcmx_l3ip_from_bcm(info, &bcm_l3));
            return tmp_rv;
        }
...
bcmx_l3_route_add(bcmx_l3_route_t *info)
{
    ...
    BCM_IF_ERROR_RETURN(_bcmx_l3route_to_bcm(info, &l3_route));
...
bcmx_l3_route_delete_by_interface(bcmx_l3_route_t *info)
{
    ...
    /* Ignore destination conversion error for 'delete_by_interface' */
    (void)_bcmx_l3route_to_bcm(info, &l3_route);
...
{
    int rv = BCM_E_NONE, tmp_rv = BCM_E_NOT_FOUND;
    int i, bcm_unit;
    bcm_l3_route_t l3_route;
    uint32 merged_flags = 0;
                            ...
                            int *path_count)
{
    ...
    BCM_IF_ERROR_RETURN(_bcmx_l3route_to_bcm(the_route, &l3_route));
    ...
    /* Iterate across all units and break on the first good one found */
    BCMX_UNIT_ITER(bcm_unit, i) {
                       ...
                       void *user_data)
{
    ...
    BCMX_LOCAL_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_route_traverse(bcm_unit,
                                       flags, start, end,
                                       trav_fn, user_data);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
...
bcmx_l3_route_max_ecmp_get(int *max)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_route_max_ecmp_get(bcm_unit, max);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
bcmx_l3_defip_max_ecmp_get(int *max)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_defip_max_ecmp_get(bcm_unit, max);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
