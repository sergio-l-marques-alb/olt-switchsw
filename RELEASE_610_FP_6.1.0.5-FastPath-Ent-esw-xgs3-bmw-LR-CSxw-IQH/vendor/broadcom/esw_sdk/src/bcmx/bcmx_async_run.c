 ...
 *
 * $Id: bcmx_async_run.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
...
bcmx_async_run(bcmx_async_req_t *req)
{
	...
	case BCMX_ASYNC_ENTRY_DEVICE_ATTACH:
		rv = bcmx_device_attach(
			req->args.device_attach.bcm_unit);
		break;
	case BCMX_ASYNC_ENTRY_DEVICE_DETACH:
		rv = bcmx_device_detach(
			req->args.device_detach.bcm_unit);
		break;
	...
	case BCMX_ASYNC_ENTRY_IPMC_EGRESS_INTF_ADD:
		rv = bcmx_ipmc_egress_intf_add(
			req->args.ipmc_egress_intf_add.group,
	...
	case BCMX_ASYNC_ENTRY_IPMC_EGRESS_INTF_DELETE:
		rv = bcmx_ipmc_egress_intf_delete(
			req->args.ipmc_egress_intf_delete.group,
	...
	case BCMX_ASYNC_ENTRY_IPMC_EGRESS_INTF_SET:
		rv = bcmx_ipmc_egress_intf_set(
			req->args.ipmc_egress_intf_set.group,
	...
	case BCMX_ASYNC_ENTRY_MIRROR_PORT_DEST_ADD:
		rv = bcmx_mirror_port_dest_add(
			...
			req->args.mirror_port_dest_add.mirror_dest);
		break;
	case BCMX_ASYNC_ENTRY_MIRROR_PORT_DEST_DELETE:
		rv = bcmx_mirror_port_dest_delete(
			...
			req->args.mirror_port_dest_delete.mirror_dest);
		break;
	...
	case BCMX_ASYNC_ENTRY_MPLS_L3_INITIATOR_GET:
		rv = bcmx_mpls_l3_initiator_get(
			...
			req->args.mpls_l3_initiator_get.ftn,
	...
	case BCMX_ASYNC_ENTRY_MPLS_L3_INITIATOR_SET:
		rv = bcmx_mpls_l3_initiator_set(
			...
			req->args.mpls_l3_initiator_set.ftn);
		break;
	...
	case BCMX_ASYNC_ENTRY_MPLS_SWITCH_ADD:
		rv = bcmx_mpls_switch_add(
			req->args.mpls_switch_add.mapping);
		break;
	case BCMX_ASYNC_ENTRY_MPLS_SWITCH_DELETE:
		rv = bcmx_mpls_switch_delete(
			req->args.mpls_switch_delete.mapping);
		break;
	...
	case BCMX_ASYNC_ENTRY_MPLS_SWITCH_GET:
		rv = bcmx_mpls_switch_get(
			req->args.mpls_switch_get.max,
			req->args.mpls_switch_get.mapping,
			req->args.mpls_switch_get.count);
		break;
	...
	case BCMX_ASYNC_ENTRY_MPLS_VPN_CIRCUIT_GET:
		rv = bcmx_mpls_vpn_circuit_get(
			...
			req->args.mpls_vpn_circuit_get.max,
			req->args.mpls_vpn_circuit_get.vc_info,
			req->args.mpls_vpn_circuit_get.count);
		break;
	...
	case BCMX_ASYNC_ENTRY_MPLS_VPN_GET:
		rv = bcmx_mpls_vpn_get(
			...
			req->args.mpls_vpn_get.maxout,
			req->args.mpls_vpn_get.vpn_info,
			req->args.mpls_vpn_get.count);
		break;
	...
	case BCMX_ASYNC_ENTRY_PORT_ABILITY_LOCAL_GET:
		rv = bcmx_port_ability_local_get(
			...
			req->args.port_ability_local_get.ability_mask);
		break;
	...
	case BCMX_ASYNC_ENTRY_PORT_LINK_STATUS_GET:
		rv = bcmx_port_link_status_get(
			...
			req->args.port_link_status_get.up);
		break;
