/*
 * $Id: bcmx_auth.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
...
bcmx_auth_unauth_callback(bcmx_auth_cb_t func, void *cookie)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        ...
        /* the above call may return E_INIT or E_UNIT on fabrics */
        if (tmp_rv != BCM_E_INIT) {
            BCMX_RV_REPLACE_OK(tmp_rv, rv, BCM_E_UNIT);
        }
    }
