 /*
 * $Id: bcmx_field.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
...
#define FIELD_RV_REPLACE(_trv, _rv)                     \
...
bcmx_field_group_traverse(bcm_field_group_traverse_cb callback, void *user_data)
{
    ...
    int rv = BCM_E_NONE;       /* Overall operation result.      */

    BCMX_LOCAL_UNIT_ITER(bcm_unit, unit_cntr) {
        tmp_rv = bcm_field_group_traverse (bcm_unit, callback, user_data);
                                  ...
                                  bcm_field_group_t *group)
{
    ...
    *group = gid;
    ...
    return (bcm_field_group_port_create_mode_id(bcm_unit, bcm_port, qset, pri,
                                             mode, gid));
}
                        ...
                        bcm_l4_port_t max)
{
    ...
    *range = range_id;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_range_create_id(bcm_unit, range_id,
                                           flags, min, max);
    }
                           ...
                           bcm_l4_port_t max)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_range_create_id(bcm_unit, range,
                                           flags, min, max);
    }
 ...
 */
int
bcmx_field_udf_spec_set(bcm_field_udf_spec_t *udf_spec,
                        uint32 flags, uint32 offset)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_udf_spec_set(bcm_unit, udf_spec, flags, offset);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
 ...
 */
int
bcmx_field_udf_spec_get(bcm_field_udf_spec_t *udf_spec,
                        uint32 *flags, uint32 *offset)
{
    int    rv = BCM_E_NOT_FOUND;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_udf_spec_get(bcm_unit, udf_spec, flags, offset);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *     bcmx_field_udf_create
 * Purpose:
 *     Allocate a user-defined field (UDF)
 * Parameters:
 *     udf_spec - UDF spec definition
 *     udf_if   - (OUT) UDF ID
 * Returns:
 *     BCM_E_XXX         Error code
 *     BCM_E_NONE
 */
int
bcmx_field_udf_create(bcm_field_udf_spec_t *udf_spec,
                      bcm_field_udf_t *udf_id)
{
    int              rv = BCM_E_NONE, tmp_rv;
    int              i, bcm_unit;
    int              udf_created = FALSE;

    /*
     * Get the first available udf returned by BCM and
     * use that ID for the rest of the units.
     */

    BCMX_UNIT_ITER(bcm_unit, i) {
        if (!udf_created) {
            tmp_rv = bcm_field_udf_create(bcm_unit, udf_spec, udf_id);
        } else {
            tmp_rv = bcm_field_udf_create_id(bcm_unit, udf_spec, *udf_id);
        }
...
/*
 * Function:
 *     bcmx_field_udf_create_id
 * Purpose:
 *     Allocate a user-defined field (UDF) with requested UDF ID.
 * Parameters:
 *     udf_spec - UDF spec definition
 *     udf_if   - Requested UDF ID
 * Returns:
 *     BCM_E_XXX         Error code
 *     BCM_E_NONE
 */
int
bcmx_field_udf_create_id(bcm_field_udf_spec_t *udf_spec,
                         bcm_field_udf_t udf_id)
{
    int              rv = BCM_E_NONE, tmp_rv;
    int              i, bcm_unit;
...
/*
 * Function: bcmx_field_udf_ethertype_set
 *
 * Purpose:
 ...
 */
int
bcmx_field_udf_ethertype_set(int index,
                             ...
                             bcm_port_ethertype_t ethertype)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_udf_ethertype_set(bcm_unit, index,
                                             frametype, ethertype);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function: bcmx_field_udf_ethertype_get
 *
 * Purpose:
 ...
 */
int
bcmx_field_udf_ethertype_get(int index,
                             bcm_port_frametype_t *frametype,
                             bcm_port_ethertype_t *ethertype)
{
    int    rv = BCM_E_NOT_FOUND;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_udf_ethertype_get(bcm_unit, index,
                                         frametype, ethertype);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
...
/*
 * Function: bcmx_field_udf_ipprotocol_set
 *
 * Purpose:
 ...
 */
int
bcmx_field_udf_ipprotocol_set(int index,
                              uint32 flags,
                              uint8 proto)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_udf_ipprotocol_set(bcm_unit, index,
                                              flags, proto);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function: bcmx_field_udf_ipprotocol_get
 *
 * Purpose:
 ...
 */
int
bcmx_field_udf_ipprotocol_get(int index,
                              uint32 *flags,
                              uint8 *proto)
{
    int    rv = BCM_E_NOT_FOUND;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_udf_ipprotocol_get(bcm_unit, index,
                                          flags, proto);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
 ...
 */
int
bcmx_field_udf_get(bcm_field_udf_spec_t *udf_spec,
                   bcm_field_udf_t udf_id)
{
    int    rv = BCM_E_NOT_FOUND;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_udf_get(bcm_unit, udf_spec, udf_id);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
 ...
 */
int
bcmx_field_udf_destroy(bcm_field_udf_t udf_id)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;

    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_udf_destroy(bcm_unit, udf_id);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
 ...
 */
int 
bcmx_field_qset_add_udf(bcm_field_qset_t *qset,
                        bcm_field_udf_t udf_id)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qset_add_udf(bcm_unit, qset, udf_id);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
                           ...
                           bcmx_lport_t port)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcmx_dest_to_unit_port(port, &bcm_unit, &data,
                                 BCMX_DEST_CONVERT_DEFAULT));

    mask = BCM_FIELD_EXACT_MATCH_MASK;

    return bcm_field_qualify_OutPort(bcm_unit, entry, data, mask);
}
...
/*
 * Function:
 *     bcmx_field_qualify_SrcModid
 * Note
 *    Deprecated in favor of bcmx_field_qualify_SrcPort().
 */

int
bcmx_field_qualify_SrcModid(bcm_field_entry_t entry,
                            bcm_module_t data, bcm_module_t mask)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_SrcModid(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_DstModid
 * Note
 *    Deprecated in favor of bcmx_field_qualify_DstPort().
 */

int
bcmx_field_qualify_DstModid(bcm_field_entry_t entry,
                            bcm_module_t data, bcm_module_t mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_DstModid(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_LookupStatus
 */

int
bcmx_field_qualify_LookupStatus(bcm_field_entry_t entry,
                                uint32 data, uint32 mask)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_LookupStatus(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_PacketFormat
 */

int
bcmx_field_qualify_PacketFormat(bcm_field_entry_t entry,
                                uint32 data, uint32 mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_PacketFormat(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_SrcMacGroup
 */
int
bcmx_field_qualify_SrcMacGroup(bcm_field_entry_t entry,
                               uint32 data, uint32 mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_SrcMacGroup(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *    bcmx_field_qualify_UserDefined
 */

int
bcmx_field_qualify_UserDefined(bcm_field_entry_t entry,
                               bcm_field_udf_t  udf_id, 
                               uint8 *data, uint8 *mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_UserDefined(bcm_unit, entry, udf_id, 
                                               data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_Stage
 */

int
bcmx_field_qualify_Stage(bcm_field_entry_t entry,
                         bcm_field_stage_t stage)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_Stage(bcm_unit, entry, stage);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_L3IntfGroup
 */
int
bcmx_field_qualify_L3IntfGroup(bcm_field_entry_t entry,
                               bcm_if_group_t data,
                               bcm_if_group_t mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_L3IntfGroup(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_PortClass
 */
int
bcmx_field_qualify_PortClass(bcm_field_entry_t entry,
                             uint32 data, uint32 mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_PortClass(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_qualify_LookupClass0
 */
int
bcmx_field_qualify_LookupClass0(bcm_field_entry_t entry,
                                uint32 data, uint32 mask)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_LookupClass0(bcm_unit, entry, data, mask);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
                            ...
                            bcm_mac_t *mac)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_action_mac_get(bcm_unit, entry, action, mac);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *      bcmx_field_counter_create
 * Description:
 *      Create a field counter pair and associate it with a entry
 * Parameters:
 *      entry - Entry ID
 * Returns:
 *      BCM_E_NOT_FOUND  Entry not found
 *      BCM_E_EXISTS     Entry already has counter
 *      BCM_E_INTERNAL   No group exists for entry
...
int
bcmx_field_counter_create(bcm_field_entry_t entry)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;

    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_create(bcm_unit, entry);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
 ...
 *      BCM_E_EXISTS    Destination counter already exists
...
int
bcmx_field_counter_share(bcm_field_entry_t src_entry,
                         bcm_field_entry_t dst_entry)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_share(bcm_unit, src_entry, dst_entry);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_counter_destroy
 * Description:
 *     Remove a counter pair to entry association
 * Parameters:
 *     entry - Entry ID
 * Returns:
 *     BCM_E_NOT_FOUND  Entry not found
...
int
bcmx_field_counter_destroy(bcm_field_entry_t entry)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;

    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_destroy(bcm_unit, entry);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *      bcmx_field_counter_set
 * Description:
 *      Set a counter value
 * Parameters:
 *      entry       - Entry ID
 *      counter_num - Entry in counter group (0..1)
...
int
bcmx_field_counter_set(bcm_field_entry_t entry,
                       int counter_num,
                       uint64 val)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_set(bcm_unit, entry, counter_num, val);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
int
bcmx_field_counter_set32(bcm_field_entry_t entry,
                         int counter_num,
                         uint32 val)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_set32(bcm_unit, entry, counter_num, val);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
 ...
 *      BCM_E_NOT_FOUND   Entry ID not found
 *      BCM_E_EMPTY       No counter created for entry
 *      BCM_E_PARAM       counter_num does not match counter index, or
 *                        valp pointing to NULL
 *      BCM_E_INTERNAL    No group for entry??? (should never happen)
...
int
bcmx_field_counter_get(bcm_field_entry_t entry,
                       int counter_num,
                       uint64 *valp)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    BCMX_PARAM_NULL_CHECK(valp);

    COMPILER_64_ZERO(*valp);
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_get(bcm_unit, entry, counter_num, &tmp_val);
        if (BCM_SUCCESS(tmp_rv)) {
            COMPILER_64_ADD_64(*valp, tmp_val);
        }
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *      bcmx_field_counter_get32
 * Description:
 *      Get lower 32 bits of a counter value
 * Parameters:
 *      entry       - Entry ID
 *      counter_num - Entry in counter group (0..1)
 *      valp        - (OUT) Pointer to counter value
...
int
bcmx_field_counter_get32(bcm_field_entry_t entry,
                         int counter_num,
                         uint32 *valp)
{
    int    rv = BCM_E_NONE, tmp_rv;
    ...
    *valp = 0;
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_counter_get32(bcm_unit, entry, counter_num,
                                         &tmp_val);
        if (BCM_SUCCESS(tmp_rv)) {
            *valp += tmp_val;
        }
...
int
bcmx_field_meter_create(bcm_field_entry_t entry)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;

    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_meter_create(bcm_unit, entry);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *      bcmx_field_meter_share
 * Description:
 *      Share the meter group from one entry with another entry
 * Parameters:
 *      src_entry - Entry ID that has meter group
 *      dst_entry - Entry ID that will get meter group
 * Returns:
 *      BCM_E_NOT_FOUND  Source or destination entry not found
...
int
bcmx_field_meter_share(bcm_field_entry_t src_entry,
                       bcm_field_entry_t dst_entry)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_meter_share(bcm_unit, src_entry, dst_entry);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
int
bcmx_field_meter_destroy(bcm_field_entry_t entry)
{
    int    rv = BCM_E_NONE, tmp_rv;
    int    i, bcm_unit;

    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_meter_destroy(bcm_unit, entry);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
...
/*
 * Function:
 *     bcmx_field_meter_set
 * Description:
 *     Set the metering parameter
 * Parameters:
 *     entry       - Entry ID
 *     meter_num   - Entry in meter group (0..3 or -1 for all)
 *     kbits_sec   - Data rate to associate with meter (1000/sec)
 *     kbits_burst - Max burst to associate with meter (1000)
 * Returns:
 *     BCM_E_NOT_FOUND  Entry not found
 *     BCM_E_EMPTY      No entry meter exists
 *     BCM_E_PARAM      'meter_num' selecte neither peak or commit meter
 *     BCM_E_NONE
 */

int
bcmx_field_meter_set(bcm_field_entry_t entry,
                     int meter_num,
                     uint32 kbits_sec,
                     uint32 kbits_burst)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_meter_set(bcm_unit, entry, meter_num,
 ...
 *                      or 'meter_num' not selecting single meter
 *     BCM_E_NONE
 * Notes:
 *     Get value from first successful call
 */
...
int
bcmx_field_meter_get(bcm_field_entry_t entry,
                     int meter_num,
                     uint32 *kbits_sec,
                     uint32 *kbits_burst)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_meter_get(bcm_unit, entry, meter_num,
                                 kbits_sec, kbits_burst);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
...
/*
 * Function:
 *     bcmx_field_qset_udf_get
 */
int 
bcmx_field_qset_udf_get(bcm_field_qset_t *qset,
                        int udf_max, int *udf_arr,
                        int *udf_count)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qset_udf_get(bcm_unit, qset, udf_max, udf_arr, udf_count);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
        }
        FIELD_RV_REPLACE(tmp_rv, rv);
                                   ...
                                   int *qual_count)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qset_data_qualifier_get(bcm_unit, qset,
                                                   qual_max, qual_arr,
                                                   qual_count);
        if (BCM_SUCCESS(tmp_rv)) {
            return tmp_rv;
...
/*
 * Function:
 *      bcmx_field_qualify_SrcModid_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_SrcModid_get(bcm_field_entry_t entry, 
                                bcm_module_t *data, 
                                bcm_module_t *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_SrcModid_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_SrcPortTgid_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_SrcPortTgid_get(bcm_field_entry_t entry, 
                                   bcm_port_t *data, 
                                   bcm_port_t *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_SrcPortTgid_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_DstModid_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_DstModid_get(bcm_field_entry_t entry, 
                                bcm_module_t *data, 
                                bcm_module_t *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_DstModid_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_DstPortTgid_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_DstPortTgid_get(bcm_field_entry_t entry, 
                                   bcm_port_t *data, 
                                   bcm_port_t *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_DstPortTgid_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_EqualL4Port_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_EqualL4Port_get(bcm_field_entry_t entry, 
                                   uint32 *flag)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_EqualL4Port_get(bcm_unit, entry, flag);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_SrcIpEqualDstIp_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_SrcIpEqualDstIp_get(bcm_field_entry_t entry, 
                                       uint32 *flag)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_SrcIpEqualDstIp_get(bcm_unit, entry, flag);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_PacketFormat_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_PacketFormat_get(bcm_field_entry_t entry, 
                                    uint32 *data, 
                                    uint32 *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_PacketFormat_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_SrcMacGroup_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_SrcMacGroup_get(bcm_field_entry_t entry, 
                                   uint32 *data, 
                                   uint32 *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_SrcMacGroup_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_UserDefined_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_UserDefined_get(bcm_field_entry_t entry, 
                                   bcm_field_udf_t udf_id, 
                                   ...
                                   uint8 mask[BCM_FIELD_USER_FIELD_SIZE])
{
    ...
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_UserDefined_get(bcm_unit, entry, udf_id, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_L3IntfGroup_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_L3IntfGroup_get(bcm_field_entry_t entry, 
                                   bcm_if_group_t *data, 
                                   bcm_if_group_t *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_L3IntfGroup_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_PortClass_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_PortClass_get(bcm_field_entry_t entry, 
                                 uint32 *data, 
                                 uint32 *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_PortClass_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_LookupClass0_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_LookupClass0_get(bcm_field_entry_t entry, 
                                    uint32 *data, 
                                    uint32 *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_LookupClass0_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
                                           ...
                                           uint8 *mask)
{
    ...
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_ForwardingVlanValid_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
                                          ...
                                          uint8 *mask)
{
    ...
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_VlanTranslationHit_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
 ...
 */
int 
bcmx_field_qualify_IpAuth_get(bcm_field_entry_t entry, 
                              uint8 *data, 
                              uint8 *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_IpAuth_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_BigIcmpCheck_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_BigIcmpCheck_get(bcm_field_entry_t entry, 
                                    uint32 *flag, 
                                    uint32 *size)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_BigIcmpCheck_get(bcm_unit, entry, flag, size);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_IgmpTypeMaxRespTime_get
 * Purpose:
 ...
 */
int 
bcmx_field_qualify_IgmpTypeMaxRespTime_get(bcm_field_entry_t entry, 
                                           uint16 *data, 
                                           uint16 *mask)
{
    int rv = BCM_E_UNAVAIL;
    int i, bcm_unit;
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_field_qualify_IgmpTypeMaxRespTime_get(bcm_unit, entry, data, mask);
        if (BCM_SUCCESS(rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_field_qualify_EqualL4Port
 * Purpose:
 *      Set match criteria for bcmFieldQualifyEqualL4Port
 *                qualifier to the field entry.
 * Parameters:
 *      entry - (IN) BCM field entry id.
 *      flag  - (IN) Flag.
 ...
 */
int 
bcmx_field_qualify_EqualL4Port(bcm_field_entry_t entry, 
                                   uint32 flag)
{
    int rv = BCM_E_NONE, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_EqualL4Port(bcm_unit, entry, flag);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
    return rv;
}
...
/*
 * Function:
 *      bcmx_field_qualify_SrcIpEqualDstIp
 * Purpose:
 *      Set match criteria for bcmFieldQualifySrcIpEqualDstIp
 *                qualifier to the field entry.
 * Parameters:
 *      entry - (IN) BCM field entry id.
 *      flag  - (IN) Flag.
 ...
 */
int 
bcmx_field_qualify_SrcIpEqualDstIp(bcm_field_entry_t entry, 
                                   uint32 flag)
{
    int rv = BCM_E_NONE, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_field_qualify_SrcIpEqualDstIp(bcm_unit, entry, flag);
        FIELD_RV_REPLACE(tmp_rv, rv);
    }
    return rv;
}
