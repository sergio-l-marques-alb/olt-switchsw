/*
 * $Id: hercules_l3.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
...
int
bcm_hercules_lpm_defip_sw_tbl_empty(int unit, int *count)
{
    return (BCM_E_UNAVAIL);
}

int
bcm_hercules_lpm_defip_hw_tbl_empty(int unit, int *count)
{
    return (BCM_E_UNAVAIL);
}

int
bcm_hercules_lpm_check_table(int unit)
{
    return (BCM_E_UNAVAIL);
}

int
bcm_hercules_lpm_delete(int unit, _bcm_defip_cfg_t *lpm_cfg)
{
    return (BCM_E_UNAVAIL);
}

int
bcm_hercules_lpm_insert(int unit, _bcm_defip_cfg_t *lpm_cfg)
{
    return (BCM_E_UNAVAIL);
}

int
bcm_hercules_lpm_lookup(int unit, ip_addr_t iproute, 
