/*
 * $Id: triumph2_wlan.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
...
STATIC int wlan_initialized; /* Flag to check initialized status */
...
bcm_tr2_wlan_init(int unit)
{
    ...
    if (NULL == wlan_info->capwap_frag_profile) {
        ...
        rval64s[0] = &rval64;
        soc_profile_reg_add(unit, CAPWAP_FRAG_PROFILE(unit), rval64s, 1,
                            &capwap_frag_profile);
    }
