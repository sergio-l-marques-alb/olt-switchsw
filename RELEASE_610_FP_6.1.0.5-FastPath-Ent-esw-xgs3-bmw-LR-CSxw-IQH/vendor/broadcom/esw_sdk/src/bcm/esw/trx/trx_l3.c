/*
 * $Id: trx_l3.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
...
static _bcm_l3_defip_128_table_t *l3_trx_defip_128[BCM_MAX_NUM_UNITS];
...
{   
    ...
    if (NULL == BCM_TRX_DEFIP128_ARR(unit)) {
        _bcm_trx_defip_128_deinit(unit);
        return (BCM_E_MEMORY);
    }
                       ...
                       int nh_ecmp_idx) 
{
    ...
    if (BCM_L3_VRF_OVERRIDE != lpm_cfg->defip_vrf) {
        ...
        soc_mem_field32_set(unit, mem, hw_entry, VRF_ID_MASKf, 0x7ff);
