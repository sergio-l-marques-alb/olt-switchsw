/*
 * $Id: common_trunk.c,v 1.1 2011/04/18 17:11:01 mruas Exp $
...
* Parameters:
*      trunk_add_info - Pointer to structure which should be initialized
* Returns:
*      NONE
*/
void 
bcm_trunk_add_info_t_init(bcm_trunk_add_info_t *trunk_add_info)
{
    if (NULL != trunk_add_info) {
        sal_memset(trunk_add_info, 0, sizeof (*trunk_add_info));
    } 
    return;
}
