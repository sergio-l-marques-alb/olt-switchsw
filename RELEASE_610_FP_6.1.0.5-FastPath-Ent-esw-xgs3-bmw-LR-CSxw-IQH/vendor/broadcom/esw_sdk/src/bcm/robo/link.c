/*
 * $Id: link.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
...
{
    ls_cntl_t           *lc = robo_link_control[unit];
    int         cur_link, new_link = 0, change;
    ...
    if (!new_link) {
        ...
        /* early link_down callback :
         *  - this callback should be triggered before MAC link-down setting.
         */
