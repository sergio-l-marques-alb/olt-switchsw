/*
 * $Id: client_tx.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
...
#include <soc/debug.h>
#include <soc/cm.h>
#define TX_DEBUG(stuff) soc_cm_debug stuff
#else
...
{
    TX_DEBUG((DK_ERR, "bcm_tx_array ERROR:  Cannot tunnel\n"));
    return BCM_E_PARAM;
}
...
bcm_client_tx_list(int unit, bcm_pkt_t *pkt, bcm_pkt_cb_f all_done_cb,
                   void *cookie)
{
    TX_DEBUG((DK_ERR, "bcm_tx_list ERROR:  Cannot tunnel\n"));
    return BCM_E_PARAM;
}
