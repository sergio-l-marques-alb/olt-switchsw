...
#else
Key *ssh_get_first_identity(int cn, AuthenticationConnection *, char **, int);
Key *ssh_get_next_identity(int cn, AuthenticationConnection *, char **, int);
#endif /* L7_SSHD */
...
#else
int
ssh_agent_sign(int cn, AuthenticationConnection *, Key *, u_char **, u_int *, u_char *,
    u_int);
#endif /* L7_SSHD */
