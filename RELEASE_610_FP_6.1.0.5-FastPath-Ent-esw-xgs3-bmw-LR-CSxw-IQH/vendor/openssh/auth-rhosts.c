...
#else
int
auth_rhosts(int cn, struct passwd *pw, const char *client_user)
#endif /* L7_SSHD */
{
    ...
    return auth_rhosts2(cn, pw, client_user, hostname, ipaddr);
#endif /* L7_SSHD */
}
...
#else
    /*
    L7 likely not using rhosts files
    */
#endif /* L7_SSHD */
    return 0;
}
...
#else
int
auth_rhosts2(int cn, struct passwd *pw, const char *client_user, const char *hostname,
    const char *ipaddr)
#endif /* L7_SSHD */
{
    int ret;
