...
#define POE_WAIT_TIME_TO_READ_RESPONSE           10 /* in milli seconds */
...
#define POE_DRVR_ERROR_BAD_CODE                  0xAF /* Checksum failed for downloaded code. Need new code */
...
#define POE_PORT_SWITCH_HIGH_POWER               0X08
...
#define BCM5910X_PORT_VOLTAGE(x)          ((x) * 64.45)  /* In milli Volts */
