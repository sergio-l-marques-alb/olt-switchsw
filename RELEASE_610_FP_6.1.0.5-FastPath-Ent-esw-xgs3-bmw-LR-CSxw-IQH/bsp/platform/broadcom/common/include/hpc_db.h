...
#define L7_PORT_DESC_BCOM_SERDES_GIG	L7_IANA_GIGABIT_ETHERNET,           \
                                        L7_PORTCTRL_PORTSPEED_FULL_1000SX,  \
                                        (L7_PHY_CAP_PORTSPEED_FULL_1000 |   \
                                         L7_PHY_CAP_PORTSPEED_FULL_2500),   \
                                        L7_CONNECTOR_NONE

#define L7_PORT_DESC_BCOM_SERDES_2G5	L7_IANA_2G5BIT_ETHERNET,            \
                                        L7_PORTCTRL_PORTSPEED_FULL_2P5FX,   \
                                        (L7_PHY_CAP_PORTSPEED_FULL_1000 |   \
                                         L7_PHY_CAP_PORTSPEED_FULL_2500),   \
                                        L7_CONNECTOR_NONE

#define L7_PORT_DESC_BCOM_SERDES_10G    L7_IANA_10G_ETHERNET,               \
                                        L7_PORTCTRL_PORTSPEED_FULL_10GSX,   \
                                        L7_PHY_CAP_PORTSPEED_FULL_10G,      \
                                        L7_XAUI
...
typedef struct
{
  ...
  L7_uint32  system_base_mac_offset;          /* offset from system base mac for MAC addresses for this type */
