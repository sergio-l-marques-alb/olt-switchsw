                    ...
                    SR_UINT32 ospfLsdbRouterId)
{
   ...
   case I_ospfLsdbSequence:
     if (usmDbOspfLsdbSequenceGet(USMDB_UNIT_CURRENT, ospfLsdbEntryData.ospfLsdbAreaId,
                                ospfLsdbEntryData.ospfLsdbType,
                                ospfLsdbEntryData.ospfLsdbLsid,
   ...
   case I_ospfLsdbAge:
     if (usmDbOspfLsdbAgeGet(USMDB_UNIT_CURRENT, ospfLsdbEntryData.ospfLsdbAreaId,
                           ospfLsdbEntryData.ospfLsdbType,
                           ospfLsdbEntryData.ospfLsdbLsid,
                           ospfLsdbEntryData.ospfLsdbRouterId,
   ...
   case I_ospfLsdbChecksum:
     if (usmDbOspfLsdbChecksumGet(USMDB_UNIT_CURRENT, ospfLsdbEntryData.ospfLsdbAreaId,
                                ospfLsdbEntryData.ospfLsdbType,
                                ospfLsdbEntryData.ospfLsdbLsid,
                                ospfLsdbEntryData.ospfLsdbRouterId,
   ...
   case I_ospfLsdbAdvertisement:
     if (usmDbOspfLsdbAdvertisementGet(USMDB_UNIT_CURRENT, ospfLsdbEntryData.ospfLsdbAreaId,
