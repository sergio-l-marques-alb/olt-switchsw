...
snmpAgentSwitchCpuProcessEntryGet( L7_uint32 UnitIndex, L7_uint32 processIndex )
{
   ...
   return usmDbSwitchCpuProcessEntryGet(UnitIndex, processIndex, &dumpEntry);
}
...
snmpAgentSwitchCpuProcessEntryNextGet( L7_uint32 UnitIndex, L7_uint32 *processIndex)
{
  ...
  *processIndex+= 1;
  ...
  return snmpAgentSwitchCpuProcessEntryGet(UnitIndex, *processIndex);
}
...
snmpAgentLagSummaryStpModeGet ( L7_uint32 UnitIndex, L7_int32 lagIntf, L7_int32 *val )
{
  ...
  L7_RC_t rc;
    ...
    rc = usmDbDot1sPortStateGet( UnitIndex, lagIntf, &temp_bool );
...
snmpAgentLagSummaryAddPortSet ( L7_uint32 UnitIndex, L7_int32 lagIntf, L7_int32 val )
{
  ...
  if (rc == L7_SUCCESS)
  {
    if((usmDbIntIfNumFromExtIfNum(lagIntf, &lagIntIfNum) != L7_SUCCESS) ||
       (usmDbDot3adIsStaticLag(UnitIndex, lagIntIfNum, &flag) != L7_SUCCESS))
      return L7_FAILURE;
    if(flag != L7_TRUE)
    {
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case L7_PORTCTRL_PORTSPEED_FULL_2P5FX:
      ...
      if (rc == L7_SUCCESS)
      {
        ...
        {
        case L7_MTRJ:
          strcpy(buf, "dot3MauType2500BaseSXFD");
          break;

        case L7_RJ45:
          strcpy(buf, "dot3MauType2500BaseTFD");
          break;

        default:
          strcpy(buf, "dot3MauType2500BaseXFD");
          break;
        }
      }
      else
...
{
  L7_uint32 temp_val = 0, oldVal, servPortVal;
  L7_RC_t rc = L7_SUCCESS;
...
/* lvl7_@p2115 start */
    ...
    usmDbAgentBasicConfigServPortConfigProtocolDesiredGet(UnitIndex, &servPortVal);
    if (servPortVal != L7_SYSCONFIG_MODE_DHCP)
...
/* lvl7_@p2115 end */
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    {
        usmDbDhcp_release(USMDB_UNIT_CURRENT);
    }
...
snmpAgentServicePortSubnetMaskSet( L7_uint32 UnitIndex, L7_uint32 val)
{
  ...
  if ( (usmDbServicePortIPAddrGet(UnitIndex, &ipAddr) == L7_SUCCESS) &&
       (usmDbServicePortGatewayGet(UnitIndex, &gateway) == L7_SUCCESS) )
  {
    if (usmDbIpInfoValidate(ipAddr, val, gateway) == L7_SUCCESS)
...
snmpAgentServicePortDefaultGatewaySet( L7_uint32 UnitIndex, L7_uint32 val)
{
  ...
  if ( (usmDbServicePortIPAddrGet(UnitIndex, &ipAddr) == L7_SUCCESS) &&
       (usmDbServicePortNetMaskGet(UnitIndex, &netMask) == L7_SUCCESS) &&
       (usmDbServicePortGatewayGet(UnitIndex, &gateway) == L7_SUCCESS))
  {
    /* if the ip and netmask are valid in the new gateway, first clear the gateway, reset the ip and netmask, and then set the new gateway */
    if (usmDbIpInfoValidate(ipAddr, netMask, val) == L7_SUCCESS)
...
{
  L7_uint32 temp_val = 0, oldVal, networkVal;
  L7_RC_t rc = L7_SUCCESS;
...
/* lvl7_@p2115 start */
    /* DHCP can only be set for either the service port or network port, not both */
    usmDbAgentBasicConfigNetworkConfigProtocolDesiredGet(UnitIndex, &networkVal);
    if (networkVal != L7_SYSCONFIG_MODE_DHCP)
      temp_val = L7_SYSCONFIG_MODE_DHCP;
    else
      rc = L7_FAILURE;
/* lvl7_@p2115 end */
...
L7_RC_t snmpDhcpVendorClassIdModeSet(L7_uint32 val)
{
  ...
  rc = usmdbDhcpVendorClassOptionAdminModeSet(temp_val);
  return rc;
}
#endif
...
L7_RC_t snmpDhcpVendorClassIdStringSet(OctetString *os_ptr)
{
  ...
  rc  = usmdbDhcpVendorClassOptionStringSet(snmpBuff);
  if (L7_SUCCESS == rc)
  {
    return L7_SUCCESS;
  }
...
snmpAgentSwitchSnoopingAdminModeSet ( L7_uint32 UnitIndex, L7_uint32 val, L7_uchar8 family)
{
  ...
  if (rc == L7_SUCCESS)
  {
    rc = usmDbSnoopAdminModeSet(UnitIndex, temp_val, 0, 0, family);
  }
  return rc;
}
/**************************************************************************************************************/
...
snmpAgentPortPhysicalModeGet ( L7_uint32 UnitIndex, L7_uint32 intIfIndex, L7_int32 *val )
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case L7_PORTCTRL_PORTSPEED_FULL_2P5FX:
      *val = D_agentPortPhysicalMode_full_2500fx;
      break;
...
L7_RC_t snmpArpAclRuleRowStatusSet(L7_char8 *aclName, L7_uint32 ipAddr,
                                   L7_char8 *macAddr, L7_uint32 rowStatus)
{
  L7_RC_t rc = L7_SUCCESS;
...
snmpAgentPortPhysicalStatusGet ( L7_uint32 UnitIndex, L7_uint32 intIfIndex, L7_int32 *val )
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case L7_PORTCTRL_PORTSPEED_FULL_2P5FX:
      *val = D_agentPortPhysicalStatus_full_2500fx;
      break;
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    if (rc == L7_SUCCESS)
    {
      ...
      case L7_AUTH_METHOD_REJECT:
        *val = D_agentAuthenticationListMethod1_reject;
        break;
...
snmpAgentAuthenticationListMethod1Set(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case D_agentAuthenticationListMethod1_reject:
...
snmpAgentAuthenticationListMethod2Get(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 *val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    if (rc == L7_SUCCESS)
    {
      ...
      case L7_AUTH_METHOD_REJECT:
        *val = D_agentAuthenticationListMethod2_reject;
        break;
...
snmpAgentAuthenticationListMethod2Set(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case D_agentAuthenticationListMethod2_reject:
      temp_val = L7_AUTH_METHOD_REJECT;
      break;
...
snmpAgentAuthenticationListMethod3Get(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 *val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    if (rc == L7_SUCCESS)
    {
      ...
      case L7_AUTH_METHOD_REJECT:
        *val = D_agentAuthenticationListMethod3_reject;
        break;
...
snmpAgentAuthenticationListMethod3Set(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case D_agentAuthenticationListMethod3_reject:
      temp_val = L7_AUTH_METHOD_REJECT;
      break;
...
snmpAgentAuthenticationListMethod4Get(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 *val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    if (rc == L7_SUCCESS)
    {
      ...
      case L7_AUTH_METHOD_REJECT:
        *val = D_agentAuthenticationListMethod4_reject;
        break;
...
snmpAgentAuthenticationListMethod4Set(L7_uint32 UnitIndex, L7_uint32 aplIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    case D_agentAuthenticationListMethod4_reject:
      temp_val = L7_AUTH_METHOD_REJECT;
      break;
  ...
  else
  {
    if (*vlanId < L7_DOT1Q_MAX_VLAN_ID)
    {
      if (usmDbSnoopProtocolNextGet(tmpFamily, &tmpFamily) == L7_TRUE)
      {
        if (*vlanId < L7_DOT1Q_MIN_VLAN_ID)
        {
          /* This handles the first entry get */
      ...
      {
        if (usmDbSnoopProtocolNextGet(0, &tmpFamily) == L7_FALSE)
        {
          *nextFamily = 0;
          return L7_FAILURE;
        }
                            ...
                            L7_uchar8 *family)
{
  ...
  *vlanId = *vlanId + 1;
  ...
  if (snmpIntfVlanValidate(unit, *extIfNum, *vlanId, *family)
                           == L7_SUCCESS)
  {
    return L7_SUCCESS;
  }

  if(*vlanId == (L7_DOT1Q_MIN_VLAN_ID - 1))
    *vlanId = L7_DOT1Q_MIN_VLAN_ID;
...
{
  L7_RC_t rc = L7_FAILURE;
  L7_uint32 temp_val, temp_val1;
  rc  = usmDbIpsgVerifySourceGet(intIfNum, &temp_val, &temp_val1);
  if (L7_SUCCESS == rc)
  {
    switch (temp_val)
    {
      case L7_ENABLE:
        *val = D_agentIpsgIfVerifySource_true;
         rc = L7_SUCCESS;
         break;
      case L7_DISABLE:
        *val = D_agentIpsgIfVerifySource_false;
         rc = L7_SUCCESS;
        break;
      default:
        rc = L7_FAILURE;
...
L7_RC_t snmpIpsgIfPortSecurityGet(L7_uint32 intIfNum, L7_uint32 *val)
{
  ...
  if (L7_SUCCESS == rc)
  {
    ...
    {
      case L7_ENABLE:
        *val = D_agentIpsgIfPortSecurity_true;
         rc = L7_SUCCESS;
         break;
      case L7_DISABLE:
        *val = D_agentIpsgIfPortSecurity_false;
         rc = L7_SUCCESS;
        break;
      default:
        rc = L7_FAILURE;
...
L7_RC_t snmpIpsgIfVerifySourceSet(L7_uint32 intIfNum, L7_uint32 val,L7_uint32 val1)
{
  L7_RC_t rc = L7_FAILURE;
  L7_uint32 temp_val = L7_DISABLE;
  L7_uint32 temp_val1 = L7_DISABLE;

  switch (val)
  {
    case D_agentIpsgIfVerifySource_true:
      temp_val = L7_ENABLE;
      rc = L7_SUCCESS;
    break;
    case D_agentIpsgIfVerifySource_false:
      temp_val = L7_DISABLE;
      rc = L7_SUCCESS;
    break;
    default:
  ...
  switch (val1)
  {
    case D_agentIpsgIfPortSecurity_true:
      temp_val1 = L7_ENABLE;
      rc = L7_SUCCESS;
    break;
    case D_agentIpsgIfPortSecurity_false:
      temp_val1 = L7_DISABLE;
      rc = L7_SUCCESS;
    break;
    default:
      rc = L7_FAILURE;
  ...
  if ( rc == L7_SUCCESS)
  {
     return  usmDbIpsgVerifySourceSet (intIfNum, temp_val,temp_val1);
  }
                                          ...
                                          L7_uint32 rowStatus)
{
  ...
  case D_agentStaticDsBindingRowStatus_createAndGo:
    rc = usmDbDsStaticBindingAdd(&macAddr, ipAddr, vlanId, 0, ifIndex);
    break;
