...
const L7_char8 *commandShowsFlowReceivers(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if( numArg == 0)
  {
    ewsTelnetWriteAddBlanks (1, 0, 1, 2, L7_NULLPTR, ewsContext, pStrInfo_base_RcvrRcvrTimeMdataAddrPortDatagram);
    ewsTelnetWriteAddBlanks (1, 0, 1, 2, L7_NULLPTR, ewsContext, pStrInfo_base_IndexOwnerOutSizeVersion);
    ...
    do
    {
      ...
      osapiSnprintf(buf,sizeof(buf), "%-9s", owner);
      ewsTelnetWrite(ewsContext, buf);
      osapiSnprintf(buf,sizeof(buf), "%-11u", time);
      ewsTelnetWrite(ewsContext, buf);
      osapiSnprintf(buf,sizeof(buf), "%-13d", size);
      ewsTelnetWrite(ewsContext, buf);
      ...
      ewsTelnetWrite(ewsContext, buf);
      osapiSnprintf(buf,sizeof(buf), "%-30s", strIpAddr);
      ewsTelnetWrite(ewsContext, buf);
...
const L7_char8 *commandShowsFlowSamplers(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  usmDbIntIfNumTypeFirstGet(unit, L7_PHYSICAL_INTF, 0, &interface);
  do
  {
