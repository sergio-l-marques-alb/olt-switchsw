                                 ...
                                 L7_uint32 keyId )
{
  ...
  rc2 = usmDbRip2IfConfAuthenticationGet(unit, iface, &intOldType, oldKey, &oldKeyId);   /* For r
                                                                                            estoration purposes */
                             ...
                             const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetRtrRipIfMode);
    }
  }
...
const L7_char8 *commandIpRIPReceiveVersion(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetRipIf);
    }
  }
...
const L7_char8 *commandIpRIPSendVersion(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetRipIf_1);
    }
  }
