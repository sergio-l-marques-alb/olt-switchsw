    ...
    if (usmDbOspfRouterIdGet(unit, &currentRouterID) == L7_SUCCESS)
    {
      ...
      if (currentRouterID && (currentRouterID != intRouterId))
      {
        ...
        if ((rc == L7_SUCCESS) && (ospfMode == L7_ENABLE))
        {
          ...
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_OspfMustBeDsbld);
        }
      }
    }
...
const L7_char8 *commandEnableOspf (EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if( (ewsContext->commType == CLI_NORMAL_CMD) && (numArg == 0))
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext,pStrErr_common_CfgRtrIdFirst);
        /*
...
const L7_char8 *commandIpOspfAreaid (EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if ((flag == L7_FALSE) || (usmDbInetAton(strId, &areaID) == L7_SUCCESS))
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        {
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetIfAreaId);
        }
            ...
            (strcmp(argv[index+secondaryNoneIndex+1], pStrInfo_common_None_3) == 0))
        {
          ...
          {
            return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantDsblSecond);
          }
        }
      }
    }
  ...
  {/*******Check if the Flag is Set for Execution*************/
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        ewsContext->actionFunctionStatusFlag=L7_ACTION_FUNC_SUCCESS;
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantDelIfAreaId);
      }
      else if ((numArg > 0) &&
               ...
               (strcmp(argv[index+secondaryIndex+1], pStrInfo_common_None_3) == 0))
      {
        ...
        {
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantEnblSecond);
        }
      }
      else
      {
...
const L7_char8 *commandIpOspf(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(  ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetIfMode);
      }
    }
  }
  else if( ewsContext->commType == CLI_NO_CMD)
...
const L7_char8 *commandIpOspfPriority (EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if ( cliConvertTo32BitUnsignedInteger(argv[index+argPriority], &priority) == L7_SUCCESS)
    {
      if (( priority >= L7_OSPF_INTF_PRIORITY_MIN ) && ( priority <= L7_OSPF_INTF_PRIORITY_MAX ) )
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          {
            return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetIfPri);
          }
        }
      }
      else
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetIfDefPri);
      }
    }
  }
...
const L7_char8 *commandIpOspfHelloInterval(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if ( cliConvertTo32BitUnsignedInteger(argv[index+argSeconds], &seconds) == L7_SUCCESS)
    {
      if ( ( seconds >= L7_OSPF_INTF_SECONDS_MIN ) && ( seconds <= L7_OSPF_INTF_SECONDS_MAX ) )
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          {
            return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetHelloIntv);
          }
        }
      }
      else
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetDefHelloIntv);
      }
    }
  }
...
const L7_char8 *commandIpOspfDeadInterval (EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if ( cliConvertTo32BitUnsignedInteger(argv[index+argSeconds], &seconds) == L7_SUCCESS)
    {
      if ( ( seconds >= L7_OSPF_INTF_DEAD_MIN ) && ( seconds <= L7_OSPF_INTF_DEAD_MAX ) )
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          {
            return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetIfDeadInt);
          }
        }
      }
      else
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetDefIfDeadInt);
      }
    }
  }
...
const L7_char8 *commandIpOspfRetransmitInterval(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if ( cliConvertTo32BitUnsignedInteger(argv[index+argSeconds], &seconds) == L7_SUCCESS)
    {
      if (( seconds >= L7_OSPF_INTF_RETRANSMIT_MIN ) && ( seconds <= L7_OSPF_INTF_RETRANSMIT_MAX ))
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          {
            return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetIfReTxInt);
          }
        }
      }
      else
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetDefIfReTxInt);
      }
    }
  }
...
const L7_char8 *commandIpOspfTransmitDelay (EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if ( cliConvertTo32BitUnsignedInteger(argv[index+argSeconds], &seconds) == L7_SUCCESS)
    {
      if ( ( seconds >= L7_OSPF_INTF_TRANSMITDELAY_MIN ) && ( seconds <= L7_OSPF_INTF_TRANSMITDELAY_MAX ) )
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          {
            return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetTxInt);
          }
        }
      }
      else
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetDefTxInt);
      }
    }
  }
                                    ...
                                    L7_uint32 keyId)
{
  ...
  if (usmDbIntIfNumFromUSPGet(unit, s, p, &iface) != L7_SUCCESS)
  {
    ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantGetIntIfNum);
    cliSyntaxBottom(ewsContext);
    return L7_FAILURE;
  }
...
const L7_char8 *commandIpOspfCost(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(  ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if ( cliConvertTo32BitUnsignedInteger(argv[index+argCost], &cost) == L7_SUCCESS)
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        {
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetOspfCost);
        }
      }
    }
    else
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSetDefOspfCost);
      }
    }
  }
  /*************Set Flag for Script Successful******/
                                        ...
                                        const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType ==  CLI_NORMAL_CMD)
  {
    ...
    if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      usmDbOspfRedistMetricTypeGet(unit, protocol, &argMetricType);
      usmDbOspfTagGet(unit, protocol, &argTagValue);
      usmDbOspfRedistSubnetsGet(unit, protocol, &argSubnetValue);
      usmDbOspfDistListGet(unit, protocol, &distList);
    }
                                     ...
                                     const L7_char8 **argv, L7_uint32 index)
{
  ...
  if (usmDbIntIfNumFromUSPGet(unit, slot, port, &intIfNum) != L7_SUCCESS)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot, ewsContext,
                                           pStrErr_common_CantGetIntIfNum);
  }
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      if (rc == L7_FAILURE)
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_FailedToSet, ewsContext,
...
const L7_char8 *commandIpOspfMtuIgnore(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantDsblIpOspfMtuIgnore);
    }
  }
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantEnblIpOspfMtuIgnore);
    }
  }
  else
  {
