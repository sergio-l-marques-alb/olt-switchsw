...
const L7_char8 *commandIpIgmpStartupQueryInterval(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_ipmcast_SetStartupQueryIntvl);
    }
   }
    /*************Set Flag for Script Successful******/
  ewsContext->actionFunctionStatusFlag=L7_ACTION_FUNC_SUCCESS;
                                                            ...
                                                            ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    if (usmDbMgmdProxyInterfaceUnsolicitedIntervalSet(unit, L7_AF_INET, iface,
      interval) != L7_SUCCESS)
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_ipmcast_CantSetSolicitedIntvl);
    }
    }
    /*************Set Flag for Script Successful******/
    ewsContext->actionFunctionStatusFlag = L7_ACTION_FUNC_SUCCESS;
...
const L7_char8 *commandIpIgmpStartupQueryCount(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_ipmcast_SetStartupQueryCount);
    }
    }
...
const L7_char8 *commandIpIgmpLastMemberQueryCount(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if (usmDbMgmdLastMembQueryCountSet(unit, L7_AF_INET, iface,
                                       count) != L7_SUCCESS)
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_common_SetLastMbrQueryCount);
    }
    }
...
const L7_char8 *commandIpIgmpVersion(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_ipmcast_SetVer);
    }
  }
...
const L7_char8 *commandIpIgmpRobustness(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_common_SetRobustness);
    }
    }
...
const L7_char8 *commandIpIgmpLastMemberQueryInterval(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrInfo_common_SetLastMbrQueryIntvl);
    }
    }
                                                  ...
                                                  L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    if ( (rc = usmDbMgmdProxyResetHostStatus(unit, L7_AF_INET, iface)) != L7_SUCCESS )
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext,pStrErr_ipmcast_SetIntfMode);
      }
      else
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext,pStrErr_ipmcast_SetIntfMode);
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if ( (rc = usmDbMgmdInterfaceQuerierSet(unit, L7_AF_INET, iface, intMode)) != L7_SUCCESS )
      {
        if (rc == L7_NOT_SUPPORTED)
        {
          ...
          return cliSyntaxReturnPrompt (ewsContext, pStrErr_ipmcast_CfgRtrIgmpIntfSnoopingNotEnbld);
        }
        else
        {
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrInfo_ipmcast_SetIntfMode_2);
        }
        }
      }
    }
