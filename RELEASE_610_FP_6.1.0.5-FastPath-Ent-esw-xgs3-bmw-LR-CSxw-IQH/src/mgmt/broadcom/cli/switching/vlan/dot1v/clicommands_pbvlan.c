...
void buildTreeInterfaceSwDevPortVlanGroup(EwsCliCommandP depth1)
{
  ...
  if (usmDbComponentPresentCheck(unit, L7_PBVLAN_COMPONENT_ID) == L7_TRUE)
  {
    ...
    depth3 = ewsCliAddNode(depth2, pStrInfo_common_MacAclVlan_1, pStrInfo_base_CfgProtoVlan, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
    ...
    depth5 = ewsCliAddNode(depth4, pStrInfo_base_Grpid, pStrInfo_base_ShowProtoDetailedRange, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
...
void buildTreeGlobalSwDevVlanPbvlan(EwsCliCommandP depth2)
{
  ...
  if (usmDbComponentPresentCheck(unit, L7_PBVLAN_COMPONENT_ID) == L7_TRUE)
  {
    ...
    depth5 = ewsCliAddNode(depth4, pStrInfo_common_Add_1, pStrInfo_base_VlanProtoGrpAdd, commandVlanProtocolGroupAdd, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
    ...
    depth6 = ewsCliAddNode(depth5, pStrInfo_base_Grpid, pStrInfo_base_ShowProtoDetailedRange, NULL, L7_NO_OPTIONAL_PARAMS);
...
void buildTreeVlanDBSwDevVlanPbvlan(EwsCliCommandP depth1)
{
  ...
  if (usmDbComponentPresentCheck(unit, L7_PBVLAN_COMPONENT_ID) == L7_TRUE)
  {
    ...
    depth4 = ewsCliAddNode(depth3, pStrInfo_base_Grpid, pStrInfo_base_ShowProtoDetailedRange, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
