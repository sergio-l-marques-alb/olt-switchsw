...
L7_RC_t radiusDictionaryInit(void)
{
   ...
   {
     LOG_MSG("RADIUS: radiusDictionaryInit() could not allocate memory");
     rc = L7_FAILURE;
     return rc;
   }
      ...
      */
      ...
      if(strncmp(buffer, RADIUS_TOKEN_ATTRIBUTE, strlen(RADIUS_TOKEN_ATTRIBUTE)) == L7_NULL)
      {
         ...
         */
         ...
         {
            LOG_MSG("RADIUS: ATTRIBUTE entry invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         */
         ...
         {
            LOG_MSG("RADIUS: Attribute name is too long on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         {
            LOG_MSG("RADIUS: Attribute id is invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         {
            LOG_MSG("RADIUS: Attribute type is invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         if (tokenCount > RADIUS_ATTR_LINE_TOKEN_COUNT)
         {
            ...
            {
               LOG_MSG("RADIUS: Vendor name is too long on line (%d) in RADIUS dictionary", lineNumber);
               rc = L7_FAILURE;
               break;
            }
      ...
      else if(strncmp(buffer, RADIUS_TOKEN_VALUE, strlen(RADIUS_TOKEN_VALUE)) == L7_NULL)
      {
         ...
         */
         ...
         {
            LOG_MSG("RADIUS: VALUE entry invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         */
         ...
         {
            LOG_MSG("RADIUS: Value name is too long on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         {
            LOG_MSG("RADIUS: Value id is invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
      ...
      else if(strncmp(buffer, RADIUS_TOKEN_VENDOR, strlen(RADIUS_TOKEN_VENDOR)) == L7_NULL)
      {
         ...
         */
         ...
         {
            LOG_MSG("RADIUS: VENDOR entry invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         */
         if (strlen(vendorName) > RADIUS_TOKEN_LENGTH)
         {
            LOG_MSG("RADIUS: Vendor name is too long on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
         ...
         {
            LOG_MSG("RADIUS: Vendor Code is invalid on line (%d) in dictionary", lineNumber);
            rc = L7_FAILURE;
            break;
         }
