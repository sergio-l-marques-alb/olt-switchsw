...
static char __fileid[] = "$Header: /home/cvs/PR1003/PR1003/FASTPATH/RELEASE_610_FP_6.1.0.5-FastPath-Ent-esw-xgs3-bmw-LR-CSxw-IQH/src/system_support/routing/utils/routing_init.c,v 1.1 2011/04/18 17:10:53 mruas Exp $";
#endif
...
L7_RC_t routingStart(void)
{
  ...
  {
    LOG_MSG("%s: routingInit failed, rc=%d\n", __FUNCTION__, erc);
    LOG_ERROR (0);
    return erc;
  }
  OS_XX_Start();
