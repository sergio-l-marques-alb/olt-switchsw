...
static L7_uint32 transitionTable[CNFGR_MAX_EVENTS+1][CNFGR_MAX_STATE] = 
{
  ...
  /* T  */ {CNFGR_NDX0,CNFGR_NDX0,CNFGR_NDX8 ,CNFGR_NDX8 ,CNFGR_NDX12,CNFGR_NDX8 ,CNFGR_NDX12,CNFGR_NDX13,CNFGR_NDX14,CNFGR_NDX15},
...
static CNFGR_CTLR_ACTION_t actionTable[] =
{
  ...
  /*  8  : Terminate */ {L7_CNFGR_STATE_NULL,
    CNFGR_NDX8,
    L7_FALSE,
    L7_FALSE,
    L7_TRUE,
    ...
    )
{
  ...
  if ( cid != L7_LAST_COMPONENT_ID ) {
     ...
     * action is NOOP.
     */
    (void)cnfgrCrComponentTake( cid, &crHandle, &pComponent );
