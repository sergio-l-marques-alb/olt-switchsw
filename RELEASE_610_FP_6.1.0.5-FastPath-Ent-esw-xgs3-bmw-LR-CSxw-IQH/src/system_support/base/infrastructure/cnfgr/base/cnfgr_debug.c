...
void cnfgrDebugProductShow()
{
  ...
  sysapiPrintf("L7_L3_ARP_CACHE_SIZE: %d\n", L7_L3_ARP_CACHE_SIZE);
  ...
  sysapiPrintf("L7_IPV6_NDP_CACHE_SIZE: %d\n", L7_IPV6_NDP_CACHE_SIZE);
  sysapiPrintf("L7_IPV4_ECMP_ROUTES_MAX: %d\n", L7_IPV4_ECMP_ROUTES_MAX);
#ifdef L7_IPV6_PACKAGE
  sysapiPrintf("L7_IPV6_ECMP_ROUTES_MAX: %d\n", L7_IPV6_ECMP_ROUTES_MAX);
#endif
  sysapiPrintf("L7_L3_ROUTE_TBL_SIZE_TOTAL: %d\n", L7_L3_ROUTE_TBL_SIZE_TOTAL);
