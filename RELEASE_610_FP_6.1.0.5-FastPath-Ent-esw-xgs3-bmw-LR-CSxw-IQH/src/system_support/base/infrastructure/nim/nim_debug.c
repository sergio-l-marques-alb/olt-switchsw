...
static  SYSAPI_HPC_PORT_DESCRIPTOR_t portData =
{
  ...
  (L7_PHY_CAP_PORTSPEED_AUTO_NEG  |
   ...
   L7_PHY_CAP_PORTSPEED_HALF_2500 |
  ...
  if (configPort != L7_NULL)
  {
    ...
    switch (configPort->cfgInfo.ifSpeed)
    {
      ...
      case L7_PORTCTRL_PORTSPEED_FULL_2P5FX:
        sysapiPrintf("ifSpeed =  L7_PORTCTRL_PORTSPEED_FULL_2P5FX\n");
        break;
  ...
  if (port != L7_NULL)
  {
    ...
    switch (port->operInfo.ianaType)
    {
      ...
      case L7_IANA_2G5BIT_ETHERNET:
        sysapiPrintf("ifType =  L7_IANA_2G5BIT_ETHERNET\n");
        break;
    ...
    if (port->operInfo.phyCapability & L7_PHY_CAP_PORTSPEED_HALF_2500)
      sysapiPrintf(" L7_PHY_CAP_PORTSPEED_HALF_2500 |\n");
