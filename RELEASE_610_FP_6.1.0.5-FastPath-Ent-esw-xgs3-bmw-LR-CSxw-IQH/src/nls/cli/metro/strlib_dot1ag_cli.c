...
L7_char8 *pStrErr_dot1ag_InvalidDomainName = "Invalid domain name. Enter a name up to 43 alphanumeric characters including\r\n-, _, ' '.";
L7_char8 *pStrErr_dot1ag_InvalidServiceName = "Invalid service name. Enter a name up to 45 alphanumeric characters including\r\n-, _, ' '.";
L7_char8 *pStrErr_dot1ag_InvalidServiceVlanId = "Invalid service vlan id";
L7_char8 *pStrErr_dot1ag_NonAlphaNumericDomainName = "Invalid domain name. Domain name may only contain alphanumeric characters including\r\n-, _, ' '.";
L7_char8 *pStrErr_dot1ag_NonAlphaNumericServiceName = "Invalid service name. Service name may only contain alphanumeric characters including\r\n-, _, ' '.";
