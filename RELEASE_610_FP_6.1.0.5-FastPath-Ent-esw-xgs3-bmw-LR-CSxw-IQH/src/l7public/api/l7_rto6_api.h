...
* @end
*********************************************************************/
void rto6IfUp (L7_uint32 intIfNum);
...
* @end
*********************************************************************/
void rto6IfDown (L7_uint32 intIfNum);
...
* @param    intIfNum  @b{(input)} Internal Interface Number
*
* @notes    Called when a routing interface is deleted.
*
* @end
*********************************************************************/
void rto6IfRouteFlush (L7_uint32 intIfNum);
