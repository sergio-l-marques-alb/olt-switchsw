...
typedef struct 
{
  ...
  L7_uchar8   remLocPowerDeviceType;
  L7_uchar8   remLocPowerSource;
  L7_uchar8   remLocPowerPriority;
  L7_ushort16 remLocPowerValue;

  L7_uchar8   remLocPowerAck;
  L7_uchar8   remReqPowerDeviceType;
  L7_uchar8   remReqPowerSource;
  L7_uchar8   remReqPowerPriority;
  L7_ushort16 remReqPowerValue;
}lldpPoeCmdData_t;
...
* @end
******************************************************************************/
L7_RC_t lldpXdot3PoePortReqPowerDeviceTypeGet(L7_uint32 intIfNum,
...
* @end
******************************************************************************/
L7_RC_t lldpXdot3PoePortReqPowerAvGet(L7_uint32 intIfNum, 
                                         L7_uint32 *powerAv);
...
* @end
******************************************************************************/
L7_RC_t lldpXdot3PoePortReqPowerAckGet(L7_uint32 intIfNum,
                                          L7_uint32 *powerAck);
