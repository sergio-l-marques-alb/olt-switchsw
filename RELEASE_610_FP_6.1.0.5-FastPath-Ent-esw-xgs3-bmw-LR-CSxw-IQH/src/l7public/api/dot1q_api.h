...
L7_BOOL dot1qQueueEmpty( void );     // PTin added
...
* @end
*********************************************************************/
L7_RC_t dot1qIntfIsVlanMember(L7_uint32 vid, L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t dot1qInternalVlanFindNext(L7_uint32 prevVid, L7_uint32 *vlanId, 
                                  L7_uint32 *intIfNum);
