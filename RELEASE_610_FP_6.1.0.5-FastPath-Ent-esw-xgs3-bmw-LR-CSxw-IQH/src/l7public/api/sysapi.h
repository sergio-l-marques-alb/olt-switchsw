...
*
*************************************************************************/
L7_RC_t sysapiCheckCfDCRC (L7_ushort16 expected_crc, L7_uchar8 *cfd_start, L7_ushort16 cfd_size);
...
*
**********************************************************************/
  typedef struct cpuUtlization_s
  {
...
#define LVL7_CPU_UTIL_MINUTES  5
#define LVL7_CPU_UTIL_SECONDS  5
#define LVL7_CPU_UTIL_SCALAR 100

#define LVL7_TASK_UTIL_MAX_TASKS 200
...
extern void *lvl7taskSema;
extern L7_int32 bigListTotal;
extern L7_int32 lvl7percentutiltbl_idx;
extern task_util_t bigIdList[LVL7_TASK_UTIL_MAX_TASKS];
extern L7_int32 lvl7percentutiltbl[(LVL7_CPU_UTIL_MINUTES * 60) / LVL7_CPU_UTIL_SECONDS];
void bigIdListSort();
