...
typedef enum
{
  ...
  DAPI_CMD_ADDR_SET_LEARN_MODE, /* PTin added */
  ...
  /* PTin added */
  DAPI_CMD_PTIN_INIT,
  DAPI_CMD_PTIN_HW_PHY_SET,
  DAPI_CMD_PTIN_HW_RESOURCES,
  DAPI_CMD_PTIN_VLAN_DEFS,
  DAPI_CMD_PTIN_VLAN_XLATE,
  DAPI_CMD_PTIN_FPENTRY,
  DAPI_CMD_PTIN_FLOW_COUNTERS,
  DAPI_CMD_PTIN_BCASTPKT_LIMIT,
  DAPI_CMD_PTIN_BITSTREAM_UPFWD,
  DAPI_CMD_PTIN_BITSTREAM_LAG_RECHECK,
  DAPI_CMD_PTIN_GET_COUNTERS,
  DAPI_CMD_PTIN_CLEAR_COUNTERS,
  DAPI_CMD_PTIN_GET_COUNTERS_STATE,
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      L7_BOOL                     enable;
      L7_uchar8                   family;
      L7_uchar8                   CoS;    /* PTin added */
      L7_uint16                   vlanId; /* PTin added */
    } snoopConfig;
...
/*
 * Enumerations for 802.1q vlan management based parameters
 */
typedef enum
{
  DAPI_QVLAN_PROTOCOL_IP,
  DAPI_QVLAN_PROTOCOL_ARP,
  DAPI_QVLAN_PROTOCOL_IPX,
  DAPI_QVLAN_NUM_OF_PROTOCOL_ENTRIES

} DAPI_QVLAN_PROTOCOL_t;
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      L7_ushort16                 protocol[DAPI_QVLAN_NUM_OF_PROTOCOL_ENTRIES];
