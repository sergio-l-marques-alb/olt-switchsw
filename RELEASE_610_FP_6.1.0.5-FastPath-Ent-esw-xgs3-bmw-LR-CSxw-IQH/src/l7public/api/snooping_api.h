...
extern L7_BOOL snoopIsReady();

extern L7_BOOL snoopQueueEmpty( void );

extern L7_RC_t ptin_snooping_activeChannels_get(L7_uint16 vlanId, L7_uint16 client_vlanId, L7_inet_addr_t **channels, L7_uint16 *nChannels);

extern L7_RC_t ptin_snooping_clientsList_get(L7_uint32 channelIP, L7_uint16 sVlan, L7_uint32 *client_list_bmp, L7_uint16 *number_of_clients);

extern L7_RC_t snoopStaticIpAdd(L7_uint16 vlanId, L7_uint32 channelIP);

extern L7_RC_t snoopStaticIpRemove(L7_uint16 vlanId, L7_uint32 channelIP);

extern L7_RC_t snoopStaticIpRemoveAll(void);

extern L7_RC_t snoopStaticIpRefreshAll(void);

extern L7_RC_t snoopClientRemove(L7_uint16 vlanId, L7_uint16 clientVlanId, L7_uint32 intIfNum);
...
/*********************************************************************
* @purpose  Gets the Snooping Prio for the specified snooping
*           instance
*
* @param    prio       @b{(output)} Snooping priority
* @param    family     @b{(input)}  L7_AF_INET  => IGMP Snooping
*                                   L7_AF_INET6 => MLD Snooping
*
* @returns  L7_SUCCESS
