...
* @end
*********************************************************************/
extern L7_RC_t usmDbInternalVlanFindFirst(L7_uint32 *vlanId, L7_uint32 *intIfNum);
...
* @end
*********************************************************************/
extern L7_RC_t usmDbInternalVlanFindNext(L7_uint32 prevVid, L7_uint32 *vlanId, L7_uint32 *intIfNum);
...
* @end
*********************************************************************/
extern L7_uint32 usmDbInternalVlanRoutingInterfaceGet(L7_uint32 vlanId);
