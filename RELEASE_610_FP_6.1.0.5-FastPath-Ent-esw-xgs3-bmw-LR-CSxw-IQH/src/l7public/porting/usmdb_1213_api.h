...
/*********************************************************************
* @purpose  Gets the System Description as a single line of output
*          
* @param    UnitIndex   @b{(input)} the unit for this operation
* @param    *buf        @b{(ouput)} placeSystem Description
*
...
*           contains printable ASCII characters.
*
* @comments This function removes any intervening newline characters
*           from within the description string, which is often the 
*           preferred form for CLI usage.
*
* @end
*********************************************************************/
L7_RC_t usmDb1213SysDescrSingleLineGet(L7_uint32 UnitIndex, L7_char8 *buf);
