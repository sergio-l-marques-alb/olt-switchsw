...
* @end
*********************************************************************/
EXT_API L7_RC_t dtlSnoopingEnable(L7_uchar8 family, L7_uint32 intIfNum, L7_uint16 vlanId, L7_uint8 prio);
...
* @end
*********************************************************************/
EXT_API L7_RC_t dtlSnoopingDisable(L7_uint32 intIfNum, L7_uint16 vlanId, L7_uchar8 family);

/*********************************************************************
* @purpose  Enables DHCP Snooping
*
* @param    none
*
* @returns  L7_SUCCESS  if success
...
* @end
*********************************************************************/
EXT_API L7_RC_t dtlDhcpSnoopEnable(L7_uchar8 family, L7_uint32 intf, L7_uint16 vlanId);

/*********************************************************************
* @purpose  Disables DHCP Snooping
*
* @param    none
*
* @returns  L7_SUCCESS  if success
...
* @end
*********************************************************************/
EXT_API L7_RC_t dtlDhcpSnoopDisable(L7_uchar8 family, L7_uint32 intf, L7_uint16 vlanId);
...
* @end
*********************************************************************/
EXT_API L7_RC_t dtlIpBufSend(L7_uint32 intIfNum, L7_uint32 vlanId, L7_uint32 innerVlanId, L7_netBufHandle  bufHandle);
...
* @end
************************************************************************/
EXT_API L7_RC_t dtlProtectedPortDelete( L7_uint32 intIfNum );
...
//EXT_API L7_RC_t dtlPtinFlowCreate(MSG_HwEthernetMef10EvcBundling *evc);

//EXT_API L7_RC_t dtlPtinFlowKill(MSG_HwEthernetMef10p1EvcRemove *data);

//EXT_API L7_RC_t dtlPtinSetProfile(MSG_HwEthernetProfile *data);
