...
typedef enum
{
  ...
  L7_PHY_CAP_PORTSPEED_HALF_2500  = 0x2000,
  L7_PHY_CAP_PORTSPEED_FULL_2500  = 0x4000,
...
typedef enum
{
  ...
  L7_PORT_NEGO_CAPABILITY_FULL_2500 = (1 << 5),
