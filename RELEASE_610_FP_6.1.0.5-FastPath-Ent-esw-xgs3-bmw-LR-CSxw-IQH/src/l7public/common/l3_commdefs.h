...
#ifdef _L7_OS_LINUX_
/* The Linux kernel does not accept an IPv4 MTU larger than 1500 bytes. */
#define L7_L3_MAX_POSSIBLE_IP_MTU    L7_L3_MAX_IP_MTU
#else
...
/* The number of interfaces for which network connectivity is needed.  This constant
   is used to calculate various queue sizes and to calculate the number of MBUFs
   needed   * FUTURE_FUNC  
 */  
#define L7_MAX_IP_INTERFACE_COUNT (L7_RTR_MAX_RTR_INTERFACES + L7_MAX_CPU_SLOTS_PER_UNIT \
                                    +  SERVICE_PORT_PRESENT)
...
typedef enum
{
  ...
  L7_RTR_ENABLE,                            /* 1:  Routing  enabled */
  L7_RTR_DISABLE_PENDING,                   /* 2:  Routing to be disabled */
  L7_RTR_DISABLE,                           /* 3:  Routing  disable */   
  L7_RTR_INTF_ENABLE,                       /* 4:  Routing interface enable complete */
  L7_RTR_INTF_DISABLE_PENDING,              /* 5:  Routing interface disable pendng */
  L7_RTR_INTF_DISABLE,                      /* 6:  Routing interface disable complete */
  L7_RTR_INTF_IPADDR_ADD,                   /* 7:  IP MAP no longer sends */
  L7_RTR_INTF_IPADDR_DELETE_PENDING,        /* 8:  IP MAP no longer sends */
  L7_RTR_INTF_IPADDR_DELETE,                /* 9:  IP MAP no longer sends */
  L7_RTR_INTF_SECONDARY_IP_ADDR_ADD,        /* 10: Routing interface secondary ip address add   */
  L7_RTR_INTF_SECONDARY_IP_ADDR_DELETE,     /* 11: Routing interface secondary ip address delete */
  L7_RTR_INTF_CONFIG_CLEAR,                 /* 12: Routing interface configuration cleared */
  L7_RTR_INTF_MTU,                          /* 13: IP MTU has changed on this interface */
  L7_RTR_INTF_BW_CHANGE,                    /* 14: Interface bandwidth changed */
...
/* ARP operational cache size values derived from platform-specific limits:
 *  - minimum:  all locals + all statics + some number of dynamics (use static max as a guide) 
 *  - maximum:  platform max
 *
 * NOTE:  All user configuration must use these values instead of the ones
 *        defined directly in l3_platform.h.
 */
#define L7_IP_ARP_CACHE_SIZE_MIN        (L7_RTR_MAX_RTR_INTERFACES + (2 * L7_IP_ARP_CACHE_STATIC_MAX))
#define L7_IP_ARP_CACHE_SIZE_MAX        L7_L3_ARP_CACHE_SIZE
#define L7_IP_ARP_CACHE_SIZE_DEF        L7_IP_ARP_CACHE_SIZE_MAX


#define L7_IP_ARP_DYNAMIC_RENEW_DEF     L7_DISABLE

/* L7_IP_ARP_MAX_QUERY  defined in commdefs.h for benefit of DAPI */
...
typedef enum
{
  ...
  L7_V3_LINK_UNKNOWN_LSA     = 10,
  L7_V3_AREA_UNKNOWN_LSA     = 11,
  L7_V3_AS_UNKNOWN_LSA       = 12,
  L7_V3_LAST_LSA_TYPE        = 13
