...
/* Only routing interface enables and disables, and IP address configuration events are
   treated as asynchronous events */
#define L7_IPMAP_MAX_ASYNC_EVENTS           L7_RTR_MAX_RTR_INTERFACES
...
#define L7_IPMAP_BEST_ROUTE_DELAY    20   /*ms*/ 

/* Max number of best route changes IP MAP can get from RTO at once. */
#define L7_IPMAP_MAX_BEST_ROUTE_CHANGES 50
...
/*  OSPF MAP QUEUES                     */
/*--------------------------------------*/
/* Size of OSPF message queue */
#define FD_CNFGR_OSPF_MSG_COUNT (L7_RTR_MAX_RTR_INTERFACES * 3)
...
#define OSPF_PROC_MSG_COUNT (L7_MAX_IP_INTERFACE_COUNT * 4)
...
#define RIPMAP_PROC_MSG_COUNT (L7_MAX_IP_INTERFACE_COUNT * 4)
...
#define RTR_DISC_PROC_MSG_COUNT (L7_MAX_IP_INTERFACE_COUNT * 4)
...
/* VRRP msgQ size. */
#define VRRP_MSG_COUNT      (L7_VRRP_MAX_INTERFACES*3)
...
#define RLIM_PROC_MSG_COUNT ((L7_MAX_IP_INTERFACE_COUNT * 4) + 16)
...
#define L7_IPMAP_INTF_MAX_COUNT  L7_MAX_INTERFACE_COUNT
