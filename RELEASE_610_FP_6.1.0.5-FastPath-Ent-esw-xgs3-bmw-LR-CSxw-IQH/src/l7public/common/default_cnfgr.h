...
#define L7_DNS_NAME_SERVER_ENTRIES        8
...
#define L7_DOT1S_MAX_INTERFACE_COUNT           (L7_MAX_INTERFACE_COUNT + 1)
...
#define L7_ISDP_INTF_MAX_COUNT                 (L7_MAX_PORT_COUNT + L7_MAX_NUM_LAG_INTF + 1)
...
/* Could get a VLAN change event for all 4k vlans */
#define DAI_EVENTQ_MSG_COUNT        3965
...
#define WIO_QUEUE_MSG_COUNT  (2 * L7_MAX_PORT_COUNT)
