...
#else
#define FD_SIM_NETWORK_CONFIG_MODE          L7_SYSCONFIG_MODE_NONE
#define FD_SIM_SERVPORT_CONFIG_MODE         L7_SYSCONFIG_MODE_NONE  /* PTin modified: L7_SYSCONFIG_MODE_DHCP */
...
#define FD_SIM_DEFAULT_SERIAL_PORT_TIMEOUT  5
...
#define FD_HTTP_SESSION_SOFT_TIMEOUT_MIN            1       /* HTTP timeout ranges start at 1 (instead of 0). 
                                                             <<Temporory Fix to avoid EmWeb Design Issue..
                                                             which  causes Session never gets closes even the browser got closed..>> */
#define FD_HTTP_SESSION_SOFT_TIMEOUT_MAX            60      /* 60 minutes */
#define FD_HTTP_SESSION_SOFT_TIMEOUT_DEFAULT        60      /* PTin added: original value is 5 minutes */
#define FD_HTTP_SESSION_HARD_TIMEOUT_MIN            1       /* HTTP timeout ranges start at 1 (instead of 0). 
                                                             <<Temporory Fix to avoid EmWeb Design Issue..
                                                             which  causes Session never gets closes even the browser got closed..>> */
...
#define FD_SECURE_HTTP_SESSION_SOFT_TIMEOUT_DEFAULT 5       /* 5 minutes */
...
#define FD_NIM_GIG_ENET_SPEED          L7_PORTCTRL_PORTSPEED_FULL_1000SX
#define FD_NIM_2G5_ENET_SPEED          L7_PORTCTRL_PORTSPEED_FULL_2P5FX
...
#define FD_VLAN_FILTERING_MODE L7_FILTER_FILTER_UNREGISTERED	/* PTin modified */
...
#define L7_PBVLAN_MAX_CONFIGURABLE_PROTOCOLS     3
...
#define FD_DOT3AD_DEFAULT_LACP_MAXDELAY    3
...
#define FD_DHCP_SNOOPING_RATE_LIMIT          15 /* packets per second */
...
// PTin modified
#define FD_DS_MAX_ACCESS_NODE_ID_STRING (40+1)
#define FD_DS_MAX_L2_TYPE_STRING        (3+1)
#define FD_DS_MAX_SLOT_STRING           (7+1)
#define FD_DS_MAX_REMOTE_ID_STRING      64  // 33 /* Actually 33, but one char is reserved for EOS('\0').*/
...
#define FD_DOT1S_MODE                  L7_DISABLE
#define FD_DOT1S_PORT_MODE             L7_DISABLE
...
#define FD_DOT1S_AUTO_EDGE    L7_FALSE
...
#define FD_DOT1S_BPDUFLOOD    L7_FALSE
...
#define FD_DVLANTAG_MIN_ETHERTYPE           0x0000
#define FD_DVLANTAG_VMAN_ETHERTYPE          0x88A8
#define FD_DVLANTAG_802_1Q_ETHERTYPE        0x88A8      // PTin modified
#ifdef L7_METRO_PACKAGE
#define FD_DVLANTAG_DEFAULT_ETHERTYPE       FD_DVLANTAG_VMAN_ETHERTYPE
#else
#define FD_DVLANTAG_DEFAULT_ETHERTYPE       FD_DVLANTAG_802_1Q_ETHERTYPE
#endif
#define FD_DVLANTAG_PER_PORT_TPID_MASK      0x0001
#define FD_DVLANTAG_DEFAULT_CUSTID          0
#define FD_DVLANTAG_MAX_CUSTID              4095
#define FD_DVLANTAG_MIN_CUSTID              0
...
#define FD_LOG_DEFAULT_CONSOLE_ADMIN_STATUS       L7_ADMIN_MODE_DISABLE
...
#define FD_LOG_DEFAULT_CONSOLE_SEVERITY_FILTER    L7_LOG_SEVERITY_ALERT
...
#ifdef _L7_OS_LINUX_
#define FD_SSHD_PATH_SSH_USER_DIR    "/usr/local/ptin/log/fastpath/"
#endif /* _L7_OS_LINUX_ */
...
/* file system path */
#ifdef _L7_OS_LINUX_
#define FD_LOGO_IMAGE_FILE_DIR    "/usr/local/ptin/log/fastpath/"
#endif /* _L7_OS_LINUX_ */
#ifdef _L7_OS_VXWORKS_
...
#define FD_SNTP_DISCARD_TIME 3250368000.0
...
#define FD_TELNET_DEFAULT_TIMEOUT                30           /* PTin modified */
...
#define FD_DNS_CLIENT_REQUEST_TIMEOUT              32  /* seconds  - must accomodate 7 server timeout failovers */
...
#define FD_ISDP_DEFAULT_MODE                      L7_DISABLE	/* PTin modified */
#define FD_ISDP_DEFAULT_TIMER                     30
#define FD_ISDP_DEFAULT_HOLDTIME                  180
#define FD_ISDP_DEFAULT_V2MODE                    L7_DISABLE	/* PTin modified */
...
#define FD_DOT1AD_PB_INTFERFACE_TYPE_DEFAULT         DOT1AD_INTFERFACE_TYPE_UNI_P
...
#define FD_HTTP_PORT_NUM    8080
#define FD_TELNET_PORT_NUM  8023
