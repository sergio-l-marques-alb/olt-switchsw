...
*
* @purpose USMDB Edb API implementation
*
* @component edb
*
* @comments none
...
{
  return edbPhysicalEntryNextGet(physicalIndex);
}
...
{
  return edbPhysicalDescrGet(physicalIndex, physicalDescr);
}
...
{
  return edbPhysicalVendorTypeGet(physicalIndex, vendorType);
}
...
{
  return edbPhysicalContainedInGet(physicalIndex, containedIn);
}
...
{
  return edbPhysicalClassGet(physicalIndex, physicalClass);
}
...
{
  return edbPhysicalParentRelPosGet(physicalIndex, parentRelPos);
}
...
{
  return edbPhysicalNameGet(physicalIndex, name);
}
...
{
  return edbPhysicalHardwareRevGet(physicalIndex, hardwareRev);
}
...
{
  return edbPhysicalFirmwareRevGet(physicalIndex, firmwareRev);
}
...
{
  return edbPhysicalSoftwareRevGet(physicalIndex, softwareRev);
}
...
{
  return edbPhysicalSerialNumGet(physicalIndex, serialNum);
}
...
{
  return edbPhysicalSerialNumSet(physicalIndex, serialNum);
}
...
{
  return edbPhysicalMfgNameGet(physicalIndex, mfgName);
}
...
{
  return edbPhysicalModelNameGet(physicalIndex, modelName);
}
...
{
  return edbPhysicalAliasGet(physicalIndex, alias);
}
...
{
  return edbPhysicalAliasSet(physicalIndex, alias);
}
...
{
  return edbPhysicalAssetIDGet(physicalIndex, assetID);
}
...
{
  return edbPhysicalAssetIDSet(physicalIndex, assetID);
}
...
{
  return edbPhysicalIsFRUGet(physicalIndex, isFRU);
}
...
{
  return edbPhysicalContainsEntryGet(physicalIndex, childIndex);
}
...
{
  return edbPhysicalContainsEntryNextGet(physicalIndex, childIndex);
}
...
{
  return edbLastChangeTimeGet(lastChangeTime);
}
