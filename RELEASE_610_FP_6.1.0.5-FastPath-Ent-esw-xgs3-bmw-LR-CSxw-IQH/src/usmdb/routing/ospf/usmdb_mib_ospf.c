...
{
  return ospfMapMulticastExtensionsGet(val);
}
...
{
  return ospfMapLsdbSequenceGet(areaId,Type,Lsid,RouterId,val);
}
...
{
  return usmDbOspfAreaLSADbLSAAgeGet(UnitIndex, areaId, Type, Lsid, RouterId, val);
}
...
L7_RC_t usmDbOspfLsdbChecksumGet ( L7_uint32 UnitIndex, L7_uint32 areaId, 
                                   ...
                                   L7_uint32 RouterId, L7_int32 *val )
{
  return usmDbOspfAreaLSADbLSACksumGet(UnitIndex, areaId, Type, Lsid, 
                                       RouterId, val);
}
...
{
  return usmDbOspfAreaLSADbLSAAdvertiseGet(UnitIndex, areaId, Type, Lsid, 
