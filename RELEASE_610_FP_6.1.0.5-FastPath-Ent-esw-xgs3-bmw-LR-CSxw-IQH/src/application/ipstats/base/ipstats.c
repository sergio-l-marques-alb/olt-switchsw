...
L7_RC_t ipStatsCreate()
{
  ...
  if(rc == L7_FAILURE)
  {
    LOG_MSG("ipStatsCreate: Could not create ip external counters\n");
  }

  /* Create mutant counters */
  if (statsCreate (mlistSize, ipStatsMutants) != L7_SUCCESS)
  {
    LOG_MSG("ipStatsCreate: Could not create ip mutant counters\n");
  }
  ...
  if(rc == L7_FAILURE)
  {
    LOG_MSG("ipStatsCreate: Could not create ip driver counters\n");
  }
...
L7_RC_t ipStatsReset()
{
  ...
  if(rc == L7_FAILURE)
    LOG_MSG("ipStatsReset: Could not reset ip external counters\n");
  ...
  if(rc == L7_FAILURE)
    LOG_MSG("ipStatsReset: Could not reset ip mutant counters\n");
  ...
  if(rc == L7_FAILURE)
    LOG_MSG("ipStatsReset: Could not reset ip driver counters\n");
...
L7_RC_t ipStatsDelete()
{
  ...
  if(rc == L7_FAILURE)
  {
    LOG_MSG("ipStatsDelete: Could not delete IP external counters\n");
  }

  /* Delete mutant counters */
  if (statsDelete (mlistSize, ipStatsMutants) != L7_SUCCESS)
  {
    LOG_MSG("ipStatsDelete: Could not delete IP mutant counters\n");
  }
  ...
  if(rc == L7_FAILURE)
  {
    LOG_MSG("ipStatsDelete: Could not delete IP driver counters\n");
  }
