...
L7_uint32 policySystemBcastStormModeSet(L7_uint32 mode)
{
  ...
  if ( rc != L7_SUCCESS)
  {
    LOG_MSG("Failure setting system broadcast storm mode to %d\n", mode);
  }
...
L7_uint32 policySystemBcastStormThresholdSet(L7_uint32 threshold, L7_RATE_UNIT_t rate_unit)
{
  ...
  if ( rc != L7_SUCCESS)
  {
    LOG_MSG("Failure setting system broadcast storm threshold to %d\n", threshold);
  }
...
L7_uint32 policySystemMcastStormModeSet(L7_uint32 mode)
{
  ...
  if ( rc != L7_SUCCESS)
  {
    LOG_MSG("Failure setting system multicast storm mode to %d\n", mode);
  }
...
L7_uint32 policySystemMcastStormThresholdSet(L7_uint32 threshold, L7_RATE_UNIT_t rate_unit)
{
  ...
  if ( rc != L7_SUCCESS)
  {
    LOG_MSG("Failure setting system multicast storm threshold to %d\n", threshold);
  }
...
L7_uint32 policySystemUcastStormModeSet(L7_uint32 mode)
{
  ...
  if ( rc != L7_SUCCESS)
  {
    LOG_MSG("Failure setting system unicast storm mode to %d\n", mode);
  }
...
L7_uint32 policySystemUcastStormThresholdSet(L7_uint32 threshold, L7_RATE_UNIT_t rate_unit)
{
  ...
  if ( rc != L7_SUCCESS)
  {
    LOG_MSG("Failure setting system unicast storm threshold to %d\n", threshold);
  }
...
L7_uint32 policySystemBcastStormModeIntfSet(L7_uint32 interface, L7_uint32 mode)
{
  ...
  {
    LOG_MSG("Failure setting port %d broadcast storm mode to %d\n", interface, mode);
    rc = L7_FAILURE;
  }
                                                 ...
                                                 L7_RATE_UNIT_t rate_unit)
{
  ...
  {
    LOG_MSG("Failure setting port %d broadcast storm threshold to %d\n", interface, threshold);
    rc = L7_FAILURE;
  }
...
L7_uint32 policySystemMcastStormModeIntfSet(L7_uint32 interface, L7_uint32 mode)
{
  ...
  {
    LOG_MSG("Failure setting port %d multicast storm mode to %d\n", interface, mode);
    rc = L7_FAILURE;
  }
                                                 ...
                                                 L7_RATE_UNIT_t rate_unit)
{
  ...
  {
    LOG_MSG("Failure setting port %d multicast storm threshold to %d\n", interface, threshold);
    rc = L7_FAILURE;
  }
...
L7_uint32 policySystemUcastStormModeIntfSet(L7_uint32 interface, L7_uint32 mode)
{
  ...
  {
    LOG_MSG("Failure setting port %d unicast storm mode to %d\n", interface, mode);
    rc = L7_FAILURE;
  }
                                                 ...
                                                 L7_RATE_UNIT_t rate_unit)
{
  ...
  {
    LOG_MSG("Failure setting port %d unicast storm threshold to %d\n", interface, threshold);
    rc = L7_FAILURE;
  }
                                          ...
                                          L7_RATE_UNIT_t *rate_unit)
{
  ...
  /* Calling usmdb function takes care of errors */
  (void)policyMapIntfIsConfigurable(interface, &pCfg);
