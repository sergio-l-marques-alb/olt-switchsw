                                        ...
                                        L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  ...
  {
    LOG_MSG("ipv6ProvCnfgrInitPhase2Process: Failed nim registration for Interface Change Callback\n");
    *pResponse = 0;
    *pReason   = L7_CNFGR_ERR_RC_FATAL;
    ipv6ProvRC = L7_ERROR;
  ...
  {
    LOG_MSG("ipv6ProvCnfgrInitPhase2Process: Failure registering for IPv6 packets\n");
