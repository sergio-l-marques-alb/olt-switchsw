...
// ----------------------------------------------------
   ...
   EXTERN_C int send_trap_intf_alarm(int porto, int code, int status, int param);
   EXTERN_C int send_trap_gen_alarm(int porto, int code, int status, int param1, int param2);
