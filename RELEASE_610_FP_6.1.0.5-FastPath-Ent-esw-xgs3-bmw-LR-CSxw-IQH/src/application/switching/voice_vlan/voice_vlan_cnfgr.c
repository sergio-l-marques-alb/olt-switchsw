                                        ...
                                        L7_CNFGR_ERR_RC_t * pReason)
{
  ...
  *pReason = 0;
  ...
  if(nimRegisterIntfChange(L7_VOICE_VLAN_COMPONENT_ID, voiceVlanIntfChangeCallback) != L7_SUCCESS)
  {
    LOG_MSG("voiceVlanCnfgrInitPhase2Process: Unable to register for Intf change callback!\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_FATAL;
    voiceVlanRC = L7_ERROR;
  ...
  {
    LOG_MSG("voiceVlanCnfgrInitPhase2Process: Unable to register for Vlan callback\n");
  ...
  {
    LOG_MSG("voiceVlanCnfgrInitPhase2Process: Unable to register for lldp_med callback\n");
...
*********************************************************************/
static 
L7_RC_t voiceVlanCnfgrInitPhase3Process( L7_CNFGR_RESPONSE_t *pResponse,
                                     L7_CNFGR_ERR_RC_t   *pReason )
{
  L7_RC_t dot1xRC;
          ...
          ( request < L7_CNFGR_RQST_LAST ))
      {
        ...
        case L7_CNFGR_CMD_INITIALIZE:
          ...
          case L7_CNFGR_RQST_I_PHASE3_START:
            voiceVlanRC = voiceVlanCnfgrInitPhase3Process(&response, &reason);
            if (voiceVlanRC != L7_SUCCESS)
            {
