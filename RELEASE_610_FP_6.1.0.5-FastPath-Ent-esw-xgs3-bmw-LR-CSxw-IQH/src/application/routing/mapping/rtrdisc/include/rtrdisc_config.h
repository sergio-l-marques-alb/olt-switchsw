...
#define L7_RTR_DISC_CFG_VER_1        0x1
#define L7_RTR_DISC_CFG_VER_2        0x2
#define L7_RTR_DISC_CFG_VER_3        0x3
#define L7_RTR_DISC_CFG_VER_4        0x4
...
#define RTR_DISC_ERROR(format,args...)                   \
{                                                        \
   LOG_COMPONENT_MSG(L7_RTR_DISC_COMPONENT_ID, format,##args); \
}

#define RTR_DISC_ERROR_SEVERE(format,args...)            \
{                                                        \
   LOG_COMPONENT_MSG(L7_RTR_DISC_COMPONENT_ID, format,##args); \
}
