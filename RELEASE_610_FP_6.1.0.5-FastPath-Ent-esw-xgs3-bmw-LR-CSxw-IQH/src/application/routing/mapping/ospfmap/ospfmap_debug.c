                         ...
                         L7_BOOL virtFlag)
{
  ...
  if (nimGetIntIfNumFromUSP(&usp, &intIfNum) == L7_SUCCESS)
  {
    if ((p_IFO = ifoPtrGet(intIfNum)) != NULL)
    {
      ...
      osapiInetNtoa((L7_uint32)ifoCfg.DrId, debug_buf);
      SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\n\tDrId.........................%-15.15s", debug_buf);

      osapiInetNtoa((L7_uint32)ifoCfg.BackupId, debug_buf);
...
void ospfMapExtenRTOShow(void)
{
  ...
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\n\tMulticastExtensions..............%u", (L7_uint32)rtrCfg.MulticastExtensions);
  if (rtrCfg.GroupJoinFashion == TRUE)
  {
    SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\n\tGroupJoinFashion.................true");
  }
  else
  {
    SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\n\tGroupJoinFashion.................false");
  }
...
void ospfMapExtenAROShow(L7_uint32 areaId)
{
  ...
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\nTmp0.........................................0x%x", (L7_uint32)p_ARO->Tmp0);
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\nGroupMembLsaHl...............................0x%x", (L7_uint32)p_ARO->GroupMembLsaHl);
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\nNssaLsaHl....................................0x%x", (L7_uint32)p_ARO->NssaLsaHl);
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\nTmp2.........................................0x%x", (L7_uint32)p_ARO->Tmp2);
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_OSPFMAP,  "\nLinkOpaqueLsaHl..............................0x%x", (L7_uint32)p_ARO->LinkOpaqueLsaHl);
...
ospfBorderRoutersShow(void)
{
  ...
  {
    e = AVL_GetFirst(p_RTB->RtbRtBt, (void *)&p_Rte);
    while (e == E_OK)
    {
      ...
      e = AVL_GetNext(p_RTB->RtbRtBt, (void *)&p_Rte);
    }
  }
