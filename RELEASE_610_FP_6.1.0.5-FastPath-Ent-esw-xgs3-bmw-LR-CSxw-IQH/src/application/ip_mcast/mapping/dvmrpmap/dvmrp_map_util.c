  ...
  if (mode == L7_DISABLE)
  {
        ...
        != L7_SUCCESS)
    {
      L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_DVMRP_MAP_COMPONENT_ID,
              ...
              " application though DVMRP is disabled.", L7_IP_ALL_DVMRP_RTRS_ADDR, intIfNum);
      /*return L7_FAILURE;*/
    }
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_DVMRP_MAP_COMPONENT_ID,
              "Mcast Forwarding Mode Disable Failed for intIfNum - %d"
              " The Multicast Forwarding mode Disable Failed for this routing interface.", intIfNum);
    }
  }
  ...
  if (mode == L7_ENABLE)
  {
        ...
        != L7_SUCCESS)
    {
      L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_DVMRP_MAP_COMPONENT_ID,
              ...
              " be received at the application.", L7_IP_ALL_DVMRP_RTRS_ADDR, intIfNum);
      return L7_FAILURE;
    }
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_DVMRP_MAP_COMPONENT_ID,
              "Mcast Forwarding Mode Enable Failed for intIfNum - %d"
              ...
              " function on this interface.", intIfNum);
      return L7_FAILURE;
    }
  }
