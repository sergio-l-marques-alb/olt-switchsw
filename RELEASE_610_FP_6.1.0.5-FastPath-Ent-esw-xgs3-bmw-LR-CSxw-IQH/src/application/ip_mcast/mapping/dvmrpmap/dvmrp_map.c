...
static void dvmrpMapIntfChangeProcess(L7_uint32 intIfNum, 
...
void dvmrpMapTask()
{
  ...
  dvmrpGblVar_g.dvmrpQueue[DVMRP_CTRL_PKT_Q].QRecvBuffer  =&pktMsg;
      ...
      switch(QIndex)
      {
         ...
         case DVMRP_EVENT_Q:
           ...
           switch (msg.msgId)
           {
             ...
             case (DVMRPMAP_INTF_CHANGE_MSG):
               dvmrpMapIntfChangeProcess(msg.u.dvmrpMapIntfChangeParms.intIfNum,
                                    msg.u.dvmrpMapIntfChangeParms.event,
                                    msg.u.dvmrpMapIntfChangeParms.correlator);
                break;
         ...
         case DVMRP_CTRL_PKT_Q:
           dvmrpMapProtoEventChangeProcess(pktMsg.dvmrpMapCtrlPktEventParms.familyType,
                            pktMsg.dvmrpMapCtrlPktEventParms.event, 
                            (void *)&(pktMsg.dvmrpMapCtrlPktEventParms.
                                      ctrlPkt));
           break;
                                 ...
                                 ASYNC_EVENT_NOTIFY_INFO_t *pEventInfo)
{
      ...
      ((intIfNum != L7_NULL) && (dvmrpIntfIsValid(intIfNum)== L7_TRUE)))
  {
    ...
    if ((dvmrpMapDvmrpAdminModeGet(&mode) == L7_SUCCESS) && 
            (mode == L7_ENABLE))
    {
                                   ...
                                   NIM_CORRELATOR_t correlator)
{
      ...
      ((intIfNum != 0) && (dvmrpIntfIsValid(intIfNum) != L7_TRUE)))
  {
    ...
    status.component    = L7_FLEX_DVMRP_MAP_COMPONENT_ID;
  ...
  msg.msgId = DVMRPMAP_INTF_CHANGE_MSG;

  msg.u.dvmrpMapIntfChangeParms.intIfNum = intIfNum;
  msg.u.dvmrpMapIntfChangeParms.event = event;
  msg.u.dvmrpMapIntfChangeParms.correlator = correlator;
...
* @end
*********************************************************************/
void dvmrpMapIntfChangeProcess(L7_uint32 intIfNum, L7_uint32 event, 
                               NIM_CORRELATOR_t correlator)
{
  L7_uint32 mode, linkState, rtrIfNum;
  ...
  if (intIfNum != L7_NULL)
  {
    ...
    {
      /* if dvmrpMap is not interested in this interface, inform **
  ...
  switch (event)
  {
    ...
    case L7_ACTIVE:
      if ((dvmrpMapDvmrpAdminModeGet(&mode)== L7_SUCCESS) && (mode == L7_ENABLE))
      {
        if ((dvmrpMapIntfAdminModeGet(intIfNum, &mode)== L7_SUCCESS) && 
            (mode == L7_ENABLE) && (dvmrpMapIntfIsOperational(intIfNum) != 
                                    L7_TRUE))
        {
          (void)dvmrpMapIntfAdminModeApply(intIfNum, L7_ENABLE);
        }
      }
      break;
    ...
    case L7_INACTIVE:
      if (dvmrpMapIntfIsOperational(intIfNum)== L7_TRUE)
      {
        (void)dvmrpMapIntfAdminModeApply(intIfNum, L7_DISABLE);
      }
      break;
    ...
    case L7_LAG_ACQUIRE:
      if (ipMapIntIfNumToRtrIntf(intIfNum, &rtrIfNum) == L7_SUCCESS)
      {
        ...
        COMPONENT_ACQ_NONZEROMASK(dvmrpGblVar_g.DvmrpIntfInfo[rtrIfNum].
                                  acquiredList, prevAcquired);

        /* update aquired list */
        COMPONENT_ACQ_SETMASKBIT(dvmrpGblVar_g.DvmrpIntfInfo[rtrIfNum].
    ...
    case L7_LAG_RELEASE:
      ...
      {
        /* update aquired list */
        COMPONENT_ACQ_CLRMASKBIT(dvmrpGblVar_g.DvmrpIntfInfo[rtrIfNum].
                                 acquiredList, L7_DOT3AD_COMPONENT_ID);
  ...
  /* update event status record with results of processing 
   * and inform event issuer                               
   */
                             ...
                             L7_uint32 metric)
{
  ...
  if ((eventType != DVMRPMAP_ADMIN_MODE_SET) &&
      (eventType != DVMRPMAP_INTF_MODE_SET) &&
      (eventType != DVMRPMAP_INTF_METRIC_SET))
  {
                                 ...
                                 L7_uint32 msgLen, L7_VOIDPTR pMsg)
{
  ...
  {
    memset(&pktmsg, 0, sizeof(dvmrpMapPktMsg_t ));
    pktmsg.msgId = DVMRPMAP_PROTOCOL_EVENT_MSG;
    pktmsg.dvmrpMapCtrlPktEventParms.event = eventType;
    pktmsg.dvmrpMapCtrlPktEventParms.familyType = familyType;
    memcpy(&(pktmsg.dvmrpMapCtrlPktEventParms.ctrlPkt), pMsg, msgLen);    
...
L7_RC_t dvmrpApplyDebugConfigData(void)
{
  ...
  for (flagIndex = 0;  flagIndex < DVMRP_DEBUG_LAST_TRACE ; flagIndex ++)
  {
    ...
    {
      dvmrpDebugTraceFlagSet(flagIndex, L7_TRUE);
    }
    else
    {
      dvmrpDebugTraceFlagSet(flagIndex, L7_FALSE);
    }
  }
  return rc;
}
