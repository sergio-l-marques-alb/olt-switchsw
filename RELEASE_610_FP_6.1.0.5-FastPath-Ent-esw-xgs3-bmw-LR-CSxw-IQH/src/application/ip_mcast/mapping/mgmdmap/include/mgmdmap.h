...
typedef struct mgmdMapIntfChangeParms_s 
{
  L7_uint32        event;
  L7_uint32        intIfNum;
  NIM_CORRELATOR_t correlator;
} mgmdMapIntfChangeParms_t;
...
typedef struct
{
  ...
  union 
  {
    ...
    mgmdMapIntfChangeParms_t    mgmdMapIntfChangeParms;
...
* @end
*********************************************************************/
L7_RC_t mgmdMapIntfChangeCallback(L7_uint32 intIfNum, L7_uint32 event,
                                  NIM_CORRELATOR_t correlator);
