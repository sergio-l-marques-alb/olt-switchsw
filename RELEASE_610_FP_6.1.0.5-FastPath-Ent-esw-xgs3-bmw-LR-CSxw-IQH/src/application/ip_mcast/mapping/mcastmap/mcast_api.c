                                      ...
                                      L7_inet_addr_t *grpMask)
{
  ...
  if (mcastGblVariables_g.mcastMapCfgData.rtr.
      numAdminScopeEntries == L7_MCAST_MAX_ADMINSCOPE_ENTRIES)
  {
                                      ...
                                      L7_uint32       *expire)
{
  ...
  if (dvmrpMapDvmrpIsOperational() == L7_TRUE)
  {
    ...
    rc = dvmrpMapRouteExpiryTimeGet(ipMRtSrc, ipMRtSrcMask, &expiryTime);
    *expire = (L7_uint32) expiryTime;
    return rc;
  }
