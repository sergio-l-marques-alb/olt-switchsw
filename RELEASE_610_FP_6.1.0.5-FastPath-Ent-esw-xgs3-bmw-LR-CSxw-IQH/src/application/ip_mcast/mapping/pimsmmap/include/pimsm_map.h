...
typedef struct pimsmMapIntfChangeParms_s
{
  L7_uint32        event;
  L7_uint32        intIfNum;
  NIM_CORRELATOR_t correlator;
} pimsmMapIntfChangeParms_t;
...
typedef struct
{
  ...
  union
  {
    ...
    pimsmMapIntfChangeParms_t    pimsmMapIntfChangeParms;
...
#define PIMSMMAP_MSG_COUNT  (L7_RTR_MAX_RTR_INTERFACES + (L7_MGMD_GROUPS_MAX_ENTRIES*2))
...
* @end
*********************************************************************/
L7_RC_t pimsmMapIntfChangeCallback(L7_uint32 intIfNum, L7_uint32 event, 
                                   NIM_CORRELATOR_t correlator);
