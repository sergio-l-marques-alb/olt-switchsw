...
heapBuffPool_t mgmdV6HeapPoolList[] ={
  ...
  {sizeof (mgmd_cb_t), 1,"MGMD_CB", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Tree Heap Buffers for MGMD Group Membership Database */
  {MGMD_MAX_GROUPS * sizeof (avlTreeTables_t), 3,"MGMD_GROUP_TREE_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Data Heap Buffers for MGMD Group Membership Database */
  {MGMD_MAX_GROUPS * sizeof (mgmd_group_t), 1,"MGMD_GROUP_DATA_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Group Membership Source Record Buffers */
  {sizeof (mgmd_source_record_t), MGMD_MAX_SRC_RECORDS,"MGMD_SOURCE_RECORD_BUFFERS", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Query Request Node Buffers */
  {sizeof(mgmd_query_req_t), MGMD_MAX_QUERY_REQ_NODES,"MGMD_QUERY_REQ_NODES_BUFFER", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Timer Buffers */
  {sizeof (mgmd_timer_event_info_t), MGMD_MAX_TIMER_NODES,"MGMD_TIMER_NODES_BUFFER", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Handle List Buffers */
  {(sizeof(handle_member_t) * MGMD_MAX_TIMERS), 1,"MGMD_HANDLE_NODES_BUFFER", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Group Membership Source Address Buffers */
  {sizeof (L7_inet_addr_t), MGMD_MAX_SRC_RECORDS,"MGMD_SOURCE_ADDR_BUFFERS", HEAP_BUFFPOOL_NO_OVERFLOW},
...
heapBuffPool_t mgmdProxyV6HeapPoolList[] ={
  ...
  {sizeof (mgmd_host_info_t), 1,"MGMD_PROXY_CB", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Tree Heap Buffers for MGMD-Proxy Group Membership Database Database*/
  {sizeof (avlTreeTables_t) * MGMD_HOST_MAX_GROUPS, 1,"MGMD_PROXY_GRP_TREE_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Data Heap Buffers for MGMD-Proxy Group Membership Database */
  {MGMD_HOST_MAX_GROUPS * sizeof (mgmd_host_group_t), 1,"MGMD_PROXY_GROUP_DATA_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* MGMD-Proxy Host Source Record Buffers */
  {sizeof (mgmd_host_source_record_t), (MGMD_HOST_MAX_SRC_RECORDS),"MGMD_PROXY_SOURCE_RECORD_BUFFERS", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* MGMD-Proxy Unsolicited Reports Buffer */
  {sizeof (mgmd_proxy_unsolicited_rpt_t), MGMD_MAX_UNSOLICITED_REPORTS,"MGMD_PROXY_REPORTS_BUFFER", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Tree Heap Buffers for MGMD-Proxy MRT (S,G) Database*/
  {sizeof (avlTreeTables_t) * MGMD_PROXY_MRT_MAX_IPV6_ROUTE_ENTRIES, 1,"MGMD_PROXY_MRT_TREE_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Data Heap Buffers for MGMD-Proxy MRT (S,G) Database */
  {MGMD_PROXY_MRT_MAX_IPV6_ROUTE_ENTRIES * sizeof (mgmdProxyCacheEntry_t), 1,"MGMD_PROXY_MRT_DATA_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},
