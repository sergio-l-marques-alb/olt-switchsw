...
#define MGMD_PROXY_MRT_MAX_IPV4_ROUTE_ENTRIES   L7_MGMD_PROXY_MRT_MAX_IPV4_ROUTE_ENTRIES
#define MGMD_PROXY_MRT_MAX_IPV6_ROUTE_ENTRIES   L7_MGMD_PROXY_MRT_MAX_IPV6_ROUTE_ENTRIES
