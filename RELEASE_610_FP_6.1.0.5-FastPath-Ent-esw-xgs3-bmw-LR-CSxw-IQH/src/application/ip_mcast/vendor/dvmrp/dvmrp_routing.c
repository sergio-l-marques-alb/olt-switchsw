                              ...
                              L7_uint32 ifindex) 
{
  ...
  L7_char8 src[DVMRP_STRING_SIZE], grp[DVMRP_STRING_SIZE],nbrAddr[DVMRP_STRING_SIZE];
  L7_uint32 uiIntf = 0;
  L7_inet_addr_t  tmp;  
...
void dvmrp_direct_route_inject(dvmrp_interface_t *interface)
{
  ...
  L7_char8 net[DVMRP_STRING_SIZE];
                             ...
                             dvmrp_neighbor_t *nbr, L7_uint32 now)
{
  ...
  L7_char8 dstNetwork[DVMRP_STRING_SIZE], NbrRtr[DVMRP_STRING_SIZE], mask[DVMRP_STRING_SIZE];
