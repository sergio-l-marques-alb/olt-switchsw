...
/* DVMRP Heap Pool Items */
heapBuffPool_t dvmrpV4HeapPoolList[] = {

  /* DVMRP Protocol Control Block Buffer */
  {sizeof (dvmrp_t), 1, "DVMRP_CB", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* MRT (S,G) Database Buffers */
  {sizeof (dvmrp_cache_entry_t), DVMRP_MRT_MAX_IPV4_ROUTE_ENTRIES, "DVMRP_CAHCE_ENTRY", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Prune Buffers */
  {sizeof (dvmrp_prune_t), (((MCAST_MAX_INTERFACES - 1)/10) * DVMRP_MRT_MAX_IPV4_ROUTE_ENTRIES), "DVMRP_PRUNES", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Graft Buffers */
  {sizeof (dvmrp_graft_t), DVMRP_MRT_MAX_IPV4_ROUTE_ENTRIES, "DVMRP_GRAFTS", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Timer Event Buffers */
  {sizeof (dvmrp_timer_event_t), DVMRP_MRT_MAX_IPV4_ROUTE_ENTRIES, "DVMRP_TIMER_EVENTS", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Tree Heap Buffers for MRT (S,G) Database */
  {sizeof (avlTreeTables_t) * DVMRP_MRT_MAX_IPV4_ROUTE_ENTRIES, 1, "DVMRP_CACHE_TBL_TREE_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Data Heap Buffers for MRT (S,G) Database */
  {sizeof (dvmrp_cache_entry_t) * DVMRP_MRT_MAX_IPV4_ROUTE_ENTRIES, 1, "DVMRP_CACHE_TBL_DATA_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Admin Scope Boundary Database Buffers */
  {sizeof (dvmrpASBNode_t), DVMRP_MAX_ADMIN_SCOPE_ENTRIES, "DVMRP_ADM_SCP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Radix Tree Heap Buffers for Unicast Routes Database */
  {(RADIX_TREE_HEAP_SIZE(DVMRP_L3_ROUTE_TBL_SIZE_TOTAL, sizeof(dvmrpTreeKey_t))), 1, "DVMRP_ROUTING_TREE_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* Radix Data Heap Buffers for Unicast Routes Database */
  {(RADIX_DATA_HEAP_SIZE(DVMRP_L3_ROUTE_TBL_SIZE_TOTAL, sizeof(dvmrpRouteData_t))), 1, "DVMRP_ROUTING_DATA_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Tree Heap Buffers for MGMD Database */
  {sizeof (avlTreeTables_t) * DVMRP_MAX_LOCAL_MEMB_ENTRIES, 1, "DVMRP_MGMD_TREE_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},

  /* AVL Data Heap Buffers for MGMD Database */
  {sizeof (dvmrp_Group_entry_t) * DVMRP_MAX_LOCAL_MEMB_ENTRIES, 1, "DVMRP_MGMD_DATA_HEAP", HEAP_BUFFPOOL_NO_OVERFLOW},
...
void dvmrp_graceful_shutdown(dvmrp_interface_t *interface)
{
  ...
  memset(dvmrpcb->report_entries, L7_NULL, L7_L3_ROUTE_TBL_SIZE_TOTAL * sizeof(dvmrp_report_t ));    
...
L7_BOOL dvmrpIsFull (dvmrp_t *dvmrpcb)
{
  ...
  if (dvmrpcb->radix_entries  >= L7_L3_ROUTE_TBL_SIZE_TOTAL)
    return L7_TRUE;
...
dvmrpUtilMemoryInit (L7_uint32 addrFamily)
{
  ...
  {
    dvmrpHeapPoolList = dvmrpV4HeapPoolList;
  }
  else
  {
    DVMRP_DEBUG (DVMRP_DEBUG_FAILURES,
