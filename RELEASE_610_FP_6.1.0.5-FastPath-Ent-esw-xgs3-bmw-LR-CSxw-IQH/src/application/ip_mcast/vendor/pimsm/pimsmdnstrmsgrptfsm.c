...
static void pimsmSGRptIPrunePendingTimerExpiresHandler(void *pParam)
{
  ...
  {
    LOG_MSG ("PIMSM Downstream pimsmSGRptIPrunePendingTimer is NULL, But Still Expired");
    return;
  }
...
static void  pimsmSGRptIPruneExpireTimerExpiresHandler(void *pParam)
{
  ...
  {
    LOG_MSG ("PIMSM Downstream pimsmSGRptIPruneExpiryTimer is NULL, But Still Expired");
    return;
  }
