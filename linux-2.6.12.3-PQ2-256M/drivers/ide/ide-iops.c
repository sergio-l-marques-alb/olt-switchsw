...
int ide_wait_stat (ide_startstop_t *startstop, ide_drive_t *drive, u8 good, u8 bad, unsigned long timeout)
{
	...
	if ((stat = hwif->INB(IDE_STATUS_REG)) & BUSY_STAT) {
		local_irq_set(flags);
		timeout += jiffies;
#if defined(CONFIG_PTIN860T) || defined(CONFIG_PTIN857TIAD) || defined(CONFIG_UNICOM_V1) || defined(CONFIG_BROUTER8) || defined(CONFIG_PQ2_PTIN)
                timeout += PTIN_IDE_EXTRA_TIMEOUT;
#endif /* CONFIG_PTIN860T || CONFIG_PTIN857TIAD */
