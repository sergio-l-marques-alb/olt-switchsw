/*
 * $Id: 70bc575c72fb65228319604cc8d19a5025bba8ef $
 *
    ...
    uint8 prio, uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_port_prio_to_queue_set: \
    ...
    uint8 prio, uint8 *queue_n)
{
    ...
    *queue_n = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_port_prio_to_queue_get: \
        unit %d, port = %d, prio = %d, *queue_n = %d\n", 
        unit, port, prio, *queue_n);
    ...
    uint32 mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_mode_set: \
    ...
    uint32 *mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_mode_get: \
    ...
    soc_pbmp_t bmp, uint8 queue, uint32 weight)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_WRR_weight_set: \
    ...
    uint32 port, uint8 queue, uint32 *weight)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_WRR_weight_get: \
    ...
    uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_prio_set: \
    ...
    uint8 *queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_prio_get: \
        unit %d, port = %d, priority = %d, queue = %d\n", 
        unit, port, prio, *queue_n);
    ...
    uint32 mapping_type, uint8 state)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_mapping_type_set: \
    ...
    uint32 mapping_type, uint8 *state)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_mapping_type_get: \
...
drv_northstar_queue_count_set(int unit, uint32 port_type, uint8 count)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_count_set: \
...
drv_northstar_queue_count_get(int unit, uint32 port_type, uint8 *count)
{
    ...
    *count = (uint8) sch2_num_cosq;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_northstar_queue_count_get: \
        unit %d, port type = %d, queue count = %d\n", unit, port_type, *count);
