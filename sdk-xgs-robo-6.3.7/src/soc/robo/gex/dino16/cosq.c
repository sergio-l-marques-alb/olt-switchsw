/*
 * $Id: 5f3dbf84e7f1906656d0050df8b9613f33227dd3 $
 *
    ...
    uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_port_prio_to_queue_set: \
    ...
    uint8 *queue_n)
{
    ...
    *queue_n = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_port_prio_to_queue_get: \
        unit %d, port = %d, prio = %d, *queue_n = %d\n", 
        unit, port, prio, *queue_n);
    ...
    uint32 mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_mode_set: \
    ...
    uint32 *mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_mode_get: \
...
drv_dino16_queue_count_set(int unit, uint32 port_type, uint8 count)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_count_set: \
...
drv_dino16_queue_count_get(int unit, uint32 port_type, uint8 *count)
{
    ...
    *count = num_q + 1;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_count_get: \
        unit %d, port type = %d, queue count = %d\n",
        unit, port_type, *count);
...
drv_dino16_queue_prio_set(int unit, uint32 port, uint8 prio, uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_prio_set: \
...
drv_dino16_queue_prio_get(int unit, uint32 port, uint8 prio, uint8 *queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_prio_get: \
        unit %d, port = %d, priority = %d, queue = %d\n", 
        unit, port, prio, *queue_n);
    ...
    uint8 prio)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_prio_remap_set: \
    ...
    uint8 *prio)
{
    ...
    *prio = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_dino16_queue_prio_remap_get: \
        unit %d, port = %d, pre_prio = %d, *prio = %d\n", 
        unit, port, pre_prio, *prio);
