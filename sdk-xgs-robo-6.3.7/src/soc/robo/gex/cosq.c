    ...
    uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_port_prio_to_queue_set: \
    ...
    uint8 *queue_n)
{
    ...
    *queue_n = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_port_prio_to_queue_get: \
        unit %d, port = %d, prio = %d, *queue_n = %d\n", 
        unit, port, prio, *queue_n);
    ...
    uint8 prio, uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_port_dfsv_set: \
    ...
    uint8 *prio, uint8 *queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_port_dfsv_get: \
        unit %d, port = %d, dscp = %d, *prio = %d, *queue_n = %d\n", 
        unit, port, dscp, *prio, *queue_n);
    ...
    uint32 mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_mode_set: \
    ...
    uint32 *mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_mode_get: \
...
{
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_count_set: \
...
drv_gex_queue_count_get(int unit, uint32 port_type, uint8 *count)
{
    ...
    *count = NUM_COS(unit);
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_count_get: \
        unit %d, port type = %d, queue count = %d\n", unit, port_type, *count);
    ...
    soc_pbmp_t bmp, uint8 queue, uint32 weight)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_WRR_weight_set: \
    ...
    uint32 port, uint8 queue, uint32 *weight)
{
    ...
    *weight = reg_value;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_WRR_weight_get: \
...
drv_gex_queue_prio_set(int unit, uint32 port, uint8 prio, uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_prio_set: \
...
drv_gex_queue_prio_get(int unit, uint32 port, uint8 prio, uint8 *queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_prio_get: \
        unit %d, port = %d, priority = %d, queue = %d\n",
        unit, port, prio, *queue_n);
    ...
    uint8 prio)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_prio_remap_set: \
    ...
    uint8 *prio)
{
    ...
    *prio = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_prio_remap_get: \
        unit %d, port = %d, pre_prio = %d, *prio = %d\n", 
        unit, port, pre_prio, *prio);
...
drv_gex_queue_dfsv_remap_set(int unit, uint8 dscp, uint8 prio)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_dfsv_remap_set: \
...
drv_gex_queue_dfsv_remap_get(int unit, uint8 dscp, uint8 *prio)
{
    ...
    *prio = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_dfsv_remap_get: \
        unit %d, dscp = %d, *prio = %d\n", unit, dscp, *prio);
...
drv_gex_queue_dfsv_set(int unit, uint8 code_point, uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_dfsv_set: \
...
exit:
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_dfsv_get: \
        unit %d, code_point = %d, *queue_n = %d\n", unit, code_point, *queue_n);
        ...
        uint8 type, uint8 enable)
{
    ...
    soc_cm_debug(DK_VERBOSE, "%s: unit %d, bmp = 0x%x, type = %d, enable=%d\n",
...
_drv_gex2_ingress_tc_select_get(int unit, int port, uint8 type, uint8 *enable)
{
    ...
    soc_cm_debug(DK_VERBOSE, "%s: unit %d, port = 0x%x, type = %d\n",
    ...
    uint32 mapping_type, uint8 state)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_mapping_type_set: \
...
func_end : 
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_mapping_type_get: \
...
drv_gex_queue_rx_reason_set(int unit, uint8 reason, uint32 queue)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_rx_reason_set: \
...
drv_gex_queue_rx_reason_get(int unit, uint8 reason, uint32 *queue)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_gex_queue_rx_reason_get: \
        unit %d, reason = %d, *queue = %d\n", unit, reason, *queue);
