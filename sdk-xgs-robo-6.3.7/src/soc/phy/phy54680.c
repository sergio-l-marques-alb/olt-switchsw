/*
 * $Id: phy54680.c 1.166 Broadcom SDK $
...
phy_54680_toplvl_reg_read(int unit, soc_port_t port, int flags, uint8 reg_offset, uint16 *data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered phy_54680_toplvl_reg_read: "
...
phy_54680_toplvl_reg_write(int unit, soc_port_t port, int flags, uint8 reg_offset, uint16 data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered phy_54680_toplvl_reg_write: "
...
_phy_nsp_eee_war(int unit, soc_port_t port)
{
    ...
    soc_cm_debug(DK_PORT,"_phy_nsp_eee_war port %d\n", port);
...
_phy_54680_mdi_pair_set(int unit, soc_port_t port, uint32 mdi_pair_map)
{
    ...
    soc_cm_debug(DK_PORT,"_phy_54680_mdi_pair_set port %d\n", port);
...
_phy_54680_reset_setup(int unit, soc_port_t port)
{
    ...
    if (soc_phy_primary_and_offset_get(unit, port, &primary_port, &index) == SOC_E_NONE) {
        ...
        SOC_DEBUG_PRINT((DK_WARN, "_phy_54680_reset_setup: Config property 'phy_port_primary_and_offset' not set for u=%d, p=%d\n",
            unit, port));
