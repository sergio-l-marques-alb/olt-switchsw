...
bcm_rlink_traverse_server_clear(void)
{
    ...
    RLINK_DEBUG((DK_VERBOSE, "TRAVERSE server_clear\n"));
    return BCM_E_NONE;
}
...
_bcm_rlink_trav_done(bcm_rlink_traverse_data_t *data)
{
    ...
    RLINK_DEBUG((DK_VERBOSE, "TRAVERSE sync traverse done\n"));
    /* mark done */
...
_bcm_rlink_trav_send_reply(bcm_rlink_traverse_data_t *data)
{
    ...
    RLINK_DEBUG((DK_VERBOSE, "TRAVERSE sync traverse send reply %d/%d\n",
