/* $Id: field.c 1.129.2.3 Broadcom SDK $
...
_field_tr3_external_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlan,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 160, 16);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlanId,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 160, 12);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlanCfi,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 172, 1);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlanPri,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 173, 3);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyIp6TrafficClass,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 176, 8);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyIp6NextHeader,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 184, 8);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL4DstPort,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 192, 16);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL4SrcPort,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 208, 16);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifySrcIp6,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 224, 128);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifySrcMac,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 352, 48);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyDstMac,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 400, 48);
        ...
        switch (i) {
            case IP_PROTO_TCP:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, TCP);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            case IP_PROTO_UDP:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, UDP);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            case IP_PROTO_ICMP:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, ICMP);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            case IP_PROTO_IGMP:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, IGMP);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            case IP_PROTO_IPv4:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, IPv4);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            case IP_PROTO_IPv6:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, IPv6);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            case IP_PROTO_MPLS:
                soc_mem_field32_set(unit, ESM_L3_PROTOCOL_FNm, 
                                    &l3_proto_fn_entry, L3_PROTOCOL_FNf, MPLS);
                BCM_IF_ERROR_RETURN(soc_mem_write(unit, ESM_L3_PROTOCOL_FNm, 
                                        MEM_BLOCK_ALL, i, &l3_proto_fn_entry));
                break;
            default:
...
/* Version Change..Storing TR3 Logical Policer Pool Mode in Ingress
 * field control (fc->bcmFieldControlIngressLogicalPolicerPoolsMode)
 */
