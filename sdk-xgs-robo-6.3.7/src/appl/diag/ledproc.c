/*
 * $Id: ledproc.c 1.25 Broadcom SDK $
...
#define CMICM_LEDUP_MAX                2
#define CMICM_LEDUP0_PORT_MAX          64
...
ledproc_linkscan_cb(int unit, soc_port_t port, bcm_port_info_t *info)
{
	...
	if (phy_port > CMICM_LEDUP0_PORT_MAX) {
		phy_port -= CMICM_LEDUP0_PORT_MAX;
		led_ix = 1;
	} else {
		led_ix = 0;
	}
