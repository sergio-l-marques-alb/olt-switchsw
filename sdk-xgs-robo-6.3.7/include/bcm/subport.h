/*
 * $Id: c13d35985a99672fe2455327ed9e0046c8ddb204 $
 * 
...
typedef enum bcm_subport_match_e {
    BCM_SUBPORT_MATCH_INVALID,          /* Illegal. */
    BCM_SUBPORT_MATCH_PKT_VID,          /* Mod/port/trunk + LLTAG VID. */
    BCM_SUBPORT_MATCH_PKT_VID_INNER_VLAN, /* Mod/port/trunk + LLTAG VID + inner
                                           VLAN. */
    BCM_SUBPORT_MATCH_PKT_VID_OUTER_VLAN, /* Mod/port/trunk + LLTAG VID + outer
                                           VLAN. */
    BCM_SUBPORT_MATCH_COUNT             /* Must be last. */
} bcm_subport_match_t;
...
typedef enum bcm_subport_stat_e {
    bcmSubportLinkPhyStatRxFragmentBytes, /* LinkPHY subport Rx fragment bytes
                                           statistics */
    bcmSubportLinkPhyStatRxFragments,   /* LinkPHY subport Rx fragments
                                           statistics */
    ...
    bcmSubportLinkPhyStatTxFrameBytes,  /* LinkPHY subport Tx frame bytes
                                           statistics */
    bcmSubportLinkPhyStatTxFrames       /* LinkPHY subport Tx frames statistics */
} bcm_subport_stat_t;
