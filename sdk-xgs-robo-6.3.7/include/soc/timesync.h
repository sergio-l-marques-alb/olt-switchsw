/*
 * $Id: timesync.h 1.10 Broadcom SDK $
...
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_RESV0_ID_UPDATE _SHR_PORT_PHY_TIMESYNC_INBAND_TS_RESV0_ID_UPDATE
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_CAP_SRC_PORT_CLK_ID _SHR_PORT_PHY_TIMESYNC_INBAND_TS_CAP_SRC_PORT_CLK_ID 
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_VLAN_ID _SHR_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_VLAN_ID 
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_SRC_PORT_NUM _SHR_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_SRC_PORT_NUM 
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_MAC_ADDR _SHR_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_MAC_ADDR  
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_IP_ADDR _SHR_PORT_PHY_TIMESYNC_INBAND_TS_MATCH_IP_ADDR 
