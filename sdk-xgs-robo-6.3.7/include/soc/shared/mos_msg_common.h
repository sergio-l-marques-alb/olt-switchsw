/*
 * $Id: mos_msg_common.h 1.55.2.3 Broadcom SDK $
...
/* On KT2, SRAM is used to cache BS registers */
#define MSG_BS_CACHE(base) ((base) + sizeof(mos_msg_area_t) * 2 * (NUM_UCS+1) * NUM_UCS)
#endif
