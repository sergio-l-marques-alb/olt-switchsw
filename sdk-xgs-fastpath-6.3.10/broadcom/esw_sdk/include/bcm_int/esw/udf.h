...
#define BCMI_XGS5_UDF_ID_MAX 0xfffe

#define BCMI_XGS5_UDF_PKT_FORMAT_ID_MIN 0x1
#define BCMI_XGS5_UDF_PKT_FORMAT_ID_MAX 0xfffe
...
#define BCMI_XGS5_UDF_CTRL_FLEXHASH           (1 << 10)

/* TD2 - Offset Base */
#define BCMI_XGS5_UDF_OFFSET_BASE_START_OF_MH        (0)
#define BCMI_XGS5_UDF_OFFSET_BASE_START_OF_L2        (1)
#define BCMI_XGS5_UDF_OFFSET_BASE_START_OF_OUTER_L3  (2)
#define BCMI_XGS5_UDF_OFFSET_BASE_START_OF_INNER_L3  (3)
#define BCMI_XGS5_UDF_OFFSET_BASE_START_OF_L4        (4)
...
#define BCMI_XGS5_UDF_OFFSET_POLICER    (1 << 4)
...
#define BCMI_XGS5_UDF_ID_RUNNING(u) \
    ...
    (udf_control[u]->udf_id_running > BCMI_XGS5_UDF_ID_MAX ? 0 : 1))
#define BCMI_XGS5_UDF_PKT_FORMAT_ID_RUNNING(u) \
    (udf_control[u]->udf_pkt_format_id_running += \
    (udf_control[u]->udf_pkt_format_id_running > BCMI_XGS5_UDF_PKT_FORMAT_ID_MAX ? 0 : 1))
