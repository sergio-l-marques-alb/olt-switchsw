/*
 * $Id: l3.h,v 1.83.6.1 Broadcom SDK $
...
#define L3_OUT(flags, stuff)  BCM_DEBUG(flags | BCM_DBG_L3, stuff)

#define L3_WARN(stuff)        L3_OUT(BCM_DBG_WARN, stuff)
#define L3_ERR(stuff)         L3_OUT(BCM_DBG_ERR, stuff)
#define L3_VERB(stuff)        L3_OUT(BCM_DBG_VERBOSE, stuff)
