/*
 * $Id: switch.h,v 1.11 Broadcom SDK $
...
#if defined(BCM_PETRA_SUPPORT) && defined(BCM_WARM_BOOT_API_TEST)

#include <bcm_int/dpp/switch.h>

/* _BCM_DPP_WARM_BOOT_API_TEST_SYNC contains a FUNCTION_NAME() print of the called BCM API,
 * so must be defined as a macro  */
#define BCM_STATE_SYNC(_u) _BCM_DPP_WARM_BOOT_API_TEST_SYNC(_u)
