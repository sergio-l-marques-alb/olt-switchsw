 ...
 */
    ...
    /* SER_RESULT_DATA_0         */ "Corrected SBUS data if SER_CONFIG.CORRECT_1B set and ECC mode is used, else raw SBUS data. Should be considered invalid if SER_ERROR_0.ERROR_0_VAL register bit is not set",
    /* SER_RESULT_DATA_1         */ "Corrected SBUS data if SER_CONFIG.CORRECT_1B set and ECC mode is used, else raw SBUS data. Should be considered invalid if SER_ERROR_1.ERROR_1_VAL register bit is not set",
    /* SER_RESULT_EXPECTED_0     */ "Expected ECC. In parity mode, it's not updated. Valid only if SER_ERROR_0.ERROR_0_VAL is set",
    /* SER_RESULT_EXPECTED_1     */ "Expected ECC. In parity mode, it's not updated. Valid only if SER_ERROR_1.ERROR_1_VAL is set",
