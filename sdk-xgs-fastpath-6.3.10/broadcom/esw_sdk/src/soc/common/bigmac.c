...
_mac_big_drain_cells(int unit, soc_port_t port)
{
    ...
    soc_cm_debug(DK_VERBOSE, "port %d bigmac saved pause and pfc state\n", port);
    ...
    soc_cm_debug(DK_VERBOSE, "port %d bigmac mmu flush enable completed\n", port);
    ...
    soc_cm_debug(DK_VERBOSE, "port %d bigmac egress packet draining completed\n", port);
    /* Notify PHY driver */
    SOC_IF_ERROR_RETURN
    ...
    soc_cm_debug(DK_VERBOSE, "port %d bigmac TX fifo reset completed\n", port);
...
#endif
    soc_cm_debug(DK_VERBOSE, "port %d bigmac restored pause and pfc state\n", port);
    /* Bring the switch MMU out of flush */
    SOC_IF_ERROR_RETURN(soc_mmu_flush_enable(unit, port, FALSE));
    soc_cm_debug(DK_VERBOSE, "port %d bigmac mmu flush disabled\n", port);
