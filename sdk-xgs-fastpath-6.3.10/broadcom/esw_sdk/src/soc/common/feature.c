/*
 * $Id: feature.c,v 1.919.2.15 Broadcom SDK $
...
soc_features_bcm56150_a0(int unit, soc_feature_t feature)
{
    ...
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 56150_a0"));
    soc_cm_get_id(unit, &dev_id, &rev_id);
    ...
    switch (feature) {
        ...
        case soc_feature_ptp:
        case soc_feature_dual_hash_no_bank:
            return TRUE;
...
soc_features_bcm56640_a0(int unit, soc_feature_t feature)
{
    ...
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 56640_a0"));
    soc_cm_get_id(unit, &dev_id, &rev_id);
    ...
    case soc_feature_l3_lpm_128b_entries_reserved:
        ...
        return TRUE;
    case soc_feature_timesync_timestampingmode:
        /* TR3 A0/A1 does not support 48bit timestamping */
        if ((rev_id != BCM56640_B0_REV_ID) ||
            (rev_id != BCM56643_B0_REV_ID) ||
            (rev_id != BCM56644_B0_REV_ID) ||
            (rev_id != BCM56648_B0_REV_ID) ||
            (rev_id != BCM56649_B0_REV_ID)) {
            return FALSE;
        }
        return TRUE;
...
soc_features_bcm56340_a0(int unit, soc_feature_t feature)
{
    ...
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 56340_a0"));
...
soc_features_bcm56850_a0(int unit, soc_feature_t feature)
{
    ...
    uint8       rev_id;
    int         feature_enable;    
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 56850_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 53010_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 53020_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88640_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88650_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88650_b0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88660_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88750_a0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88750_b0"));
...
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 88850_p3"));
...
soc_features_bcm56450_a0(int unit, soc_feature_t feature)
{
    ...
    SOC_FEATURE_DEBUG_PRINT((DK_VERBOSE," 56450_a0"));
    soc_cm_get_id(unit, &dev_id, &rev_id);
    ...
    mpls = l3 = (dev_id == BCM55450_DEVICE_ID) ||
                (dev_id == BCM55455_DEVICE_ID);
...
{
    return soc_features_bcm56450_b0(unit, feature);
}
