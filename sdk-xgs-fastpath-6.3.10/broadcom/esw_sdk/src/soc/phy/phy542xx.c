...
_phy_bcm542xx_no_reset_setup(int unit, soc_port_t port)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY, "%s: u=%d p=%d medium=%s\n", __func__,
                     unit, port,
                         ...
                         int copper_enable)
{
    ...
    if (soc_phy_primary_and_offset_get(unit, port, &primary_port, &index) == SOC_E_NONE) {
        ...
        SOC_DEBUG_PRINT((DK_WARN,
           "phy_bcm542xx_reset_setup: Config property 'phy_port_primary_and_offset'"
           " not set for u=%d, p=%d\n", unit, port));
        return SOC_E_FAIL;
    }
...
phy_bcm542xx_duplex_set(int unit, soc_port_t port, int duplex)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY,
                    "phy_bcm542xx_duplex_set: u=%d p=%d d=%d\n",
              unit, port, duplex));
    return ( SOC_E_NONE );
}
...
phy_bcm542xx_master_set(int unit, soc_port_t port, int master)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY,
                    "phy_bcm542xx_master_set: u=%d p=%d master=%d fiber=%d\n",
                                ...
                                soc_port_ability_t *ability)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY, "phy_bcm542xx_adv_local_set: u=%d p=%d "
               "ability_hd_speed=0x%x, ability_fd_speed=0x%x, ability_pause=0x%x\n",
...
phy_bcm542xx_ability_advert_get(int unit, soc_port_t port, soc_port_ability_t *ability)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY,
               "phy_bcm542xx_adv_local_get: u=%d p=%d "
               "ability_hd_speed=0x%x, ability_fd_speed=0x%x, ability_pause=0x%x\n",
                                ...
                                soc_port_ability_t *ability)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY,
               "phy_bcm542xx_adv_remote_get: u=%d p=%d "
               "ability_hd_speed=0x%x ability_fd_speed=0x%x ability_pause=0x%x\n",
              unit, port, ability->speed_half_duplex,
              ability->speed_full_duplex, ability->pause));
    return ( SOC_E_NONE );
...
phy_bcm542xx_ability_local_get(int unit, soc_port_t port, soc_port_ability_t *ability)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY,
               "phy_bcm542xx_ability_local_get: u=%d p=%d "
               "ability_hd_speed=0x%x, ability_fd_speed=0x%x, ability_pause=0x%x\n",
              unit, port, ability->speed_half_duplex,
              ability->speed_full_duplex, ability->pause));
    return ( SOC_E_NONE );
...
phy_bcm542xx_rdb_reg_set(int unit, soc_port_t port, int rdb, int value){
    ...
    SOC_DEBUG_PRINT((DK_PHY,
               "u=%d p=%d rdb=0x%04x value read back=0x%04x\n",
...
phy_bcm542xx_rdb_reg_get(int unit, soc_port_t port, int rdb) {
    ...
    SOC_DEBUG_PRINT((DK_PHY,
               "u=%d p=%d rdb=0x%04x value=0x%04x\n",
