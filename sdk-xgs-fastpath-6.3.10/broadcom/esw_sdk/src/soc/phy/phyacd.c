...
SOC_IF_ERROR_RETURN(READ_PHY_EXP_REG(unit,l1,0xc6,&l2[6]));SOC_DEBUG_PRINT((
DK_PHY,
...
;if((l7[0]&0x0800)){SOC_DEBUG_PRINT((DK_PHY,
...
return SOC_E_FAIL;}l11->npairs = 1;l11->fuzz_len = 0;SOC_DEBUG_PRINT((DK_PHY,
