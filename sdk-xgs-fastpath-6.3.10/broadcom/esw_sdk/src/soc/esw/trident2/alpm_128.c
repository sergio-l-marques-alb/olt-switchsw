...
soc_cm_debug(DK_ERR,"Pivot find failed\n");return l124;}l140 = (alpm_pivot_t*
)l139;*l136 = 1;*l137 = PIVOT_TCAM_INDEX(l140);*bucket_index = 
PIVOT_BUCKET_INDEX(l140);return SOC_E_NONE;}static int l141(int l1,void*l5,
soc_mem_t l20,void*l142,int*l137,int*bucket_index,int*l13,int l143){uint32 l12
[SOC_MAX_MEM_FIELD_WORDS];int l144,l24,l30;int l116;uint32 l8,l145;int l124 = 
SOC_E_NONE;int l136 = 0;l30 = L3_DEFIP_MODE_128;SOC_IF_ERROR_RETURN(
soc_alpm_128_lpm_vrf_get(l1,l5,&l144,&l24));if(l144 == 0){if(
...
if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
l22);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: prefix create failed\n");return l124;}sal_memset(&l10,
0,sizeof(defip_aux_scratch_entry_t));SOC_IF_ERROR_RETURN(l6(l1,l5,l30,l8,0,&
l10));if(bucket_index == 0){l124 = l135(l1,prefix,l129,l30,l24,&l136,&l137,&
bucket_index);SOC_IF_ERROR_RETURN(l124);if(l136 == 0){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: "" Could not find bucket to insert prefix\n");return
SOC_E_NOT_FOUND;}}l124 = _soc_alpm_insert_in_bkt(l1,l20,bucket_index,l145,
l142,l12,&l116,l30);if(l124 == SOC_E_NONE){*l13 = l116;if(SOC_URPF_STATUS_GET
(l1)){l171 = soc_mem_write(l1,l20,MEM_BLOCK_ANY,_soc_alpm_rpf_entry(l1,l116),
l147);if(SOC_FAILURE(l171)){return l171;}}}if(l124 == SOC_E_FULL){l172 = 1;}
l140 = ALPM_TCAM_PIVOT(l1,l137);trie = PIVOT_BUCKET_TRIE(l140);l168 = l140;
l176 = sal_alloc(sizeof(payload_t),"Payload for 128b Key");if(l176 == NULL){
...
"Payload for pfx trie 128b key");if(l177 == NULL){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: Unable to allocate memory for ""pfx trie node \n");
sal_free(l176);return SOC_E_MEMORY;}sal_memset(l176,0,sizeof(*l176));
sal_memset(l177,0,sizeof(*l177));l176->key[0] = prefix[0];l176->key[1] = 
prefix[1];l176->key[2] = prefix[2];l176->key[3] = prefix[3];l176->key[4] = 
prefix[4];l176->len = l129;l176->index = l116;sal_memcpy(l177,l176,sizeof(*
l176));l177->bkt_ptr = l176;l124 = trie_insert(trie,prefix,NULL,l129,(
...
alpm_bucket_assign(l1,&bucket_index,l30);if(SOC_FAILURE(l124)){soc_cm_debug(
DK_ERR,"_soc_alpm_128_insert: Unable to allocate""new bucket for split\n");
bucket_index = -1;goto l194;}l124 = trie_split(trie,_MAX_KEY_LEN_144_,FALSE,
l170,&l129,&l174,NULL,FALSE);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
l178 = (payload_t*)l139;if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"unit %d Unable to find lpm for pivot: "
"0x%08x 0x%08x\n 0x%08x 0x%08x 0x%08x length: %d\n",l1,l170[0],l170[1],l170[2
],l170[3],l170[4],l129);goto l194;}if(l178->bkt_ptr){if(l178->bkt_ptr == l176
...
"ALPM 128 Bucket Handle");if(l179 == NULL){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: Unable to allocate "" memory for PIVOT trie node \n");
l124 = SOC_E_MEMORY;goto l194;}sal_memset(l179,0,sizeof(*l179));l140 = 
sal_alloc(sizeof(alpm_pivot_t),"Payload for new 128b Pivot");if(l140 == NULL)
...
{soc_cm_debug(DK_ERR,"_soc_128_alpm_insert: Bucket split failed"
"for prefix 0x%08x 0x%08x 0x%08x 0x%08x\n",prefix[1],prefix[2],prefix[3],
...
l2(l1,&lpm_entry,&l149);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: Unable to add new""pivot to tcam\n");if(l124 == 
SOC_E_FULL){VRF_PIVOT_FULL_INC(l1,l24,l30);}goto l195;}l149 = 
soc_alpm_physical_idx(l1,L3_DEFIP_PAIR_128m,l149,l30);l124 = l148(l1,l149,
l150);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"_soc_alpm_insert: Unable to init bpm_len ""for index %d\n",l149);goto l196;}
l124 = trie_insert(l138,l140->key,NULL,l140->len,(trie_node_t*)l140);if(
SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,"failed to insert into pivot trie\n");
goto l196;}ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR(l149)<<1) = l140;
PIVOT_TCAM_INDEX(l140) = SOC_ALPM_128_ADDR_LWR(l149)<<1;VRF_PIVOT_REF_INC(l1,
l24,l30);for(l123 = 0;l123<l181.count;l123++){l181.prefix[l123]->index = l119
[l123];}sal_free(l119);l124 = _soc_alpm_raw_bucket_write(l1,l20,
PIVOT_BUCKET_INDEX(l168),l145,(void*)l188,(void*)l189,-1);if(SOC_FAILURE(l124
)){goto l196;}sal_free(l187);if(l180 == -1){l124 = _soc_alpm_insert_in_bkt(l1
,l20,PIVOT_BUCKET_HANDLE(l168)->bucket_index,l145,l142,l12,&l116,l30);if(
SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: Could not insert new ""prefix into trie after split\n"
);goto l194;}if(SOC_URPF_STATUS_GET(l1)){l124 = soc_mem_write(l1,l20,
MEM_BLOCK_ANY,_soc_alpm_rpf_entry(l1,l116),l147);}*l13 = l116;l176->index = 
l116;}PIVOT_BUCKET_ENT_CNT_UPDATE(l140);VRF_BUCKET_SPLIT_INC(l1,l24,l30);}
VRF_TRIE_ROUTES_INC(l1,l24,l30);if(l22){sal_free(l177);}SOC_IF_ERROR_RETURN(
_soc_alpm_aux_op(l1,DELETE_PROPAGATE,&l10,TRUE,&l136,&l137,&bucket_index));
SOC_IF_ERROR_RETURN(_soc_alpm_aux_op(l1,INSERT_PROPAGATE,&l10,FALSE,&l136,&
l137,&bucket_index));if(SOC_URPF_STATUS_GET(l1)){l129 = soc_mem_field32_get(
l1,L3_DEFIP_AUX_SCRATCHm,&l10,DB_TYPEf);l129+= 1;soc_mem_field32_set(l1,
L3_DEFIP_AUX_SCRATCHm,&l10,DB_TYPEf,l129);SOC_IF_ERROR_RETURN(
_soc_alpm_aux_op(l1,DELETE_PROPAGATE,&l10,TRUE,&l136,&l137,&bucket_index));
SOC_IF_ERROR_RETURN(_soc_alpm_aux_op(l1,INSERT_PROPAGATE,&l10,FALSE,&l136,&
l137,&bucket_index));}PIVOT_BUCKET_ENT_CNT_UPDATE(l168);return l124;l196:l171
= l4(l1,&lpm_entry);if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
...
l140->len,&l175);if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
...
SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
...
_soc_alpm_rpf_entry(l1,l119[l123]),INVALIDm);if(SOC_FAILURE(l171)){
...
l175;if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
...
prefix->len,(trie_node_t*)l176);if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: trie reinsert failure""in bkt move rollback\n");}}else
{if(l176!= NULL){sal_free(l176);}}}if(l180 == -1){l175 = NULL;l171 = 
trie_delete(PIVOT_BUCKET_TRIE(l167),prefix,l169,&l175);l176 = (payload_t*)
l175;if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
...
,l30);if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: new bucket release ""failure: %d\n",PIVOT_BUCKET_INDEX
(l140));}trie_destroy(PIVOT_BUCKET_TRIE(l140));sal_free(l179);sal_free(l140);
sal_free(l119);sal_free(l187);l175 = NULL;l171 = trie_delete(l173,prefix,l169
,&l175);l177 = (payload_t*)l175;if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_insert: failed to delete new prefix"
"0x%08x 0x%08x from pfx trie\n",prefix[0],prefix[1]);}if(l177){sal_free(l177)
;}return l124;l194:if(l119!= NULL){sal_free(l119);}if(l187!= NULL){sal_free(
l187);}l175 = NULL;(void)trie_delete(l173,prefix,l169,&l175);l177 = (
...
&l129,&l22);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
SOC_E_PARAM;}}}l8 = 2;}l20 = L3_DEFIP_ALPM_IPV6_128m;l184 = ((uint32*)&(l182)
);SOC_ALPM_LPM_LOCK(l1);if(bucket_index == 0){l124 = l141(l1,l5,l20,l184,&
l137,&bucket_index,&l116,TRUE);}else{l124 = l16(l1,l5,l184,0,l20,0,0);}
sal_memcpy(&l198,l184,sizeof(l198));l199 = &l198;if(SOC_FAILURE(l124)){
SOC_ALPM_LPM_UNLOCK(l1);soc_cm_debug(DK_ERR,
"_soc_alpm_128_delete: Unable to find ""prefix for delete\n");return l124;}
l201 = bucket_index;l140 = ALPM_TCAM_PIVOT(l1,l137);trie = PIVOT_BUCKET_TRIE(
l140);l124 = trie_delete(trie,prefix,l129,&l175);l176 = (payload_t*)l175;if(
l124!= SOC_E_NONE){soc_cm_debug(DK_ERR,
...
prefix,l129,&l175);l204 = (payload_t*)l175;if(SOC_FAILURE(l124)){soc_cm_debug
(DK_ERR,"_soc_alpm_128_delete: Prefix not present "
"in pfx trie: 0x%08x 0x%08x 0x%08x 0x%08x\n",prefix[1],prefix[2],prefix[3],
prefix[4]);goto l205;}l139 = NULL;l124 = trie_find_lpm(l173,prefix,l129,&l139
);l178 = (payload_t*)l139;if(SOC_SUCCESS(l124)){payload_t*l206 = (payload_t*)
(l178->bkt_ptr);if(l206!= NULL){l202 = l206->len;}else{l202 = 0;}}else{
...
l124)){soc_cm_debug(DK_ERR,"_soc_alpm_128_delete: Could not find "
"replacement prefix for prefix: 0x%08x 0x%08x 0x%08x ""0x%08x\n",prefix[1],
prefix[2],prefix[3],prefix[4]);goto l207;}l203 = &lpm_entry;}else{l139 = NULL
;l124 = trie_find_lpm(l173,prefix,l129,&l139);l178 = (payload_t*)l139;if(
SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
;if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,"_soc_alpm_128_delete: Unable to "
"delete pivot 0x%08x 0x%08x 0x%08x 0x%08x \n",l140->key[1],l140->key[2],l140
->key[3],l140->key[4]);}}l124 = _soc_alpm_delete_in_bkt(l1,l20,l201,l145,l199
,l12,&l116,l30);if(!SOC_SUCCESS(l124)){SOC_ALPM_LPM_UNLOCK(l1);l124 = 
...
"empty bucket: %d\n",PIVOT_BUCKET_INDEX(l140));}l124 = trie_delete(l138,l140
->key,l140->len,&l175);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
trie_node_t*)l176);if(SOC_FAILURE(l171)){soc_cm_debug(DK_ERR,
"_soc_alpm_128_delete: Unable to reinsert"
"prefix 0x%08x 0x%08x 0x%08x 0x%08x into pfx trie\n",prefix[1],prefix[2],
...
VRF_PREFIX_TRIE_IPV6_128(l1,l123));}else{soc_cm_debug(DK_ERR,
"unit: %d Unable to clear v6_128 pfx trie for ""vrf %d\n",l1,l123);return l124
;}if(VRF_TRIE_DEFAULT_ROUTE_IPV6_128(l1,l123)!= NULL){sal_free(
VRF_TRIE_DEFAULT_ROUTE_IPV6_128(l1,l123));}}return SOC_E_NONE;}int
...
"ALPM Bucket Handle");if(l179 == NULL){soc_cm_debug(DK_ERR,
...
alpm_pivot_t),"Payload for Pivot");if(l140 == NULL){soc_cm_debug(DK_ERR,
...
"Payload for pfx trie key");if(l204 == NULL){soc_cm_debug(DK_ERR,
"soc_alpm_128_vrf_add: Unable to allocate memory ""for pfx trie node \n");
sal_free(l179);sal_free(l140);return SOC_E_MEMORY;}sal_memset(l140,0,sizeof(*
l140));sal_memset(l204,0,sizeof(*l204));l129 = 0;PIVOT_BUCKET_HANDLE(l140) = 
l179;trie_init(_MAX_KEY_LEN_144_,&PIVOT_BUCKET_TRIE(l140));PIVOT_BUCKET_INDEX
(l140) = l211;PIVOT_BUCKET_VRF(l140) = l24;PIVOT_BUCKET_IPV6(l140) = l30;
PIVOT_BUCKET_DEF(l140) = TRUE;l140->key[0] = l204->key[0] = key[0];l140->key[
1] = l204->key[1] = key[1];l140->key[2] = l204->key[2] = key[2];l140->key[3] = 
l204->key[3] = key[3];l140->key[4] = l204->key[4] = key[4];l140->len = l204->
len = l129;l124 = trie_insert(l212,key,NULL,l129,&(l204->node));if(
SOC_FAILURE(l124)){sal_free(l204);sal_free(l140);sal_free(l179);return l124;}
l124 = trie_insert(l213,key,NULL,l129,(trie_node_t*)l140);if(SOC_FAILURE(l124
)){trie_node_t*l175 = NULL;(void)trie_delete(l212,key,l129,&l175);sal_free(
l204);sal_free(l140);sal_free(l179);return l124;}index = 
soc_alpm_physical_idx(l1,L3_DEFIP_PAIR_128m,index,l30);ALPM_TCAM_PIVOT(l1,
SOC_ALPM_128_ADDR_LWR(index)<<1) = l140;PIVOT_TCAM_INDEX(l140) = 
SOC_ALPM_128_ADDR_LWR(index)<<1;VRF_PIVOT_REF_INC(l1,l24,l30);
...
,l30);l214 = -1;}l214 = soc_alpm_physical_idx(l1,L3_DEFIP_PAIR_128m,l214,l30)
;l215 = ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR(l214)<<1);l124 = l4(l1,
lpm_entry);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
(payload_t*)l175;if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
key,0,&l175);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
...
;return SOC_E_PARAM;}}if(l144!= SOC_L3_VRF_GLOBAL){if(!soc_alpm_mode_get(l1))
{if(VRF_TRIE_ROUTES_CNT(l1,l24,l7) == 0){if(!l22){soc_cm_debug(DK_ERR,
...
l24);l124 = l209(l1,l24,l7);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"soc_alpm_128_insert:VRF %d/%d trie init \n""failed\n",l24,l7);return l124;}
soc_cm_debug(DK_VERBOSE,"soc_alpm_128_insert:VRF %d/%d trie init "
"completed\n",l24,l7);}if(l217&SOC_ALPM_LOOKUP_HIT){l124 = l146(l1,l3,l184,
l199,l20,l216);}else{if(l216 == -1){l216 = 0;}l124 = l166(l1,l3,l20,l184,l199
,&index,SOC_ALPM_BKT_ENTRY_TO_IDX(l216),l217);}if(l124!= SOC_E_NONE){
soc_cm_debug(DK_WARN,"unit %d :soc_alpm_128_insert: "
"Route Insertion Failed :%s\n",l1,soc_errmsg(l124));}return(l124);}int
soc_alpm_128_lookup(int l1,void*l5,void*l12,int*l13,int*l218){
defip_alpm_ipv6_128_entry_t l182;soc_mem_t l20;int bucket_index;int l137;void
*l184;int l144,l24;int l7 = 2,l115;int l124 = SOC_E_NONE;SOC_IF_ERROR_RETURN(
soc_alpm_128_lpm_vrf_get(l1,l5,&l144,&l24));l124 = l11(l1,l5,l12,l13,&l115,&
l7);if(SOC_SUCCESS(l124)){SOC_IF_ERROR_RETURN(soc_alpm_128_lpm_vrf_get(l1,l12
,&l144,&l24));if(l144 == SOC_L3_VRF_OVERRIDE){return SOC_E_NONE;}}if(!
VRF_TRIE_INIT_COMPLETED(l1,l24,l7)){soc_cm_debug(DK_VERBOSE,
"soc_alpm_lookup:VRF %d is not ""initialized\n",l24);*l13 = 0;*l218 = 0;
return SOC_E_NOT_FOUND;}l20 = L3_DEFIP_ALPM_IPV6_128m;l184 = ((uint32*)&(l182
));SOC_ALPM_LPM_LOCK(l1);l124 = l141(l1,l5,l20,l184,&l137,&bucket_index,l13,
TRUE);SOC_ALPM_LPM_UNLOCK(l1);if(SOC_FAILURE(l124)){*l218 = l137;*l13 = 
bucket_index<<2;return l124;}l124 = l23(l1,l184,l20,l7,l144,bucket_index,*l13
,l12);*l218 = SOC_ALPM_LOOKUP_HIT|l137;return(l124);}int l219(int l1,void*l5,
void*l12,int l24,int*l137,int*bucket_index,int*l116,int l220){int l124 = 
SOC_E_NONE;int l123,l221,l30,l136 = 0;uint32 l8,l145;
defip_aux_scratch_entry_t l10;int l222,l223;int index;soc_mem_t l20,l224;int
l225,l226,l227;soc_field_t l228[4] = {IP_ADDR0_LWRf,IP_ADDR1_LWRf,
IP_ADDR0_UPRf,IP_ADDR1_UPRf};uint32 l229[SOC_MAX_MEM_FIELD_WORDS] = {0};int
l230 = -1;int l231 = 0;l30 = L3_DEFIP_MODE_128;l224 = L3_DEFIP_PAIR_128m;l222
= soc_mem_field32_get(l1,l224,l5,GLOBAL_ROUTEf);l223 = soc_mem_field32_get(l1
,l224,l5,VRF_ID_0_LWRf);soc_cm_debug(DK_VERBOSE,
...
"bucket_index %d\n",SOC_MEM_NAME(l1,l224),soc_alpm_logical_idx(l1,l224,
SOC_ALPM_128_DEFIP_TO_PAIR((*l137)>>1),1),*bucket_index);l20 = 
L3_DEFIP_ALPM_IPV6_128m;l124 = l122(l1,l5,&l226);if(SOC_FAILURE(l124)){return
l124;}l227 = SOC_ALPM_V6_SCALE_CHECK(l1,l30)?16:8;soc_cm_debug(DK_VERBOSE,
...
l184,LENGTHf);soc_cm_debug(DK_VERBOSE,
...
soc_mem_field32_get(l1,l224,l5,l228[0]);soc_cm_debug(DK_VERBOSE,
...
>= 0){continue;}soc_cm_debug(DK_VERBOSE,"Found a match in mem %s bucket %d, "
"index %d\n",SOC_MEM_NAME(l1,l20),*bucket_index,index);if(l230 == -1||l230<
l225){l230 = l225;l231 = index;sal_memcpy(l229,l184,sizeof(l184));}}if(l230!= 
-1){l124 = l23(l1,&l229,l20,l30,l24,*bucket_index,l231,l12);if(SOC_SUCCESS(
l124)){*l116 = l231;soc_cm_debug(DK_VERBOSE,
"Hit mem %s bucket %d, index %d\n",SOC_MEM_NAME(l1,l20),*bucket_index,l231);}
return l124;}*l116 = soc_alpm_logical_idx(l1,l224,SOC_ALPM_128_DEFIP_TO_PAIR(
(*l137)>>1),1);SOC_IF_ERROR_RETURN(soc_mem_read(l1,l224,MEM_BLOCK_ANY,*l116,(
void*)l12));return SOC_E_NONE;}int soc_alpm_128_find_best_match(int l1,void*
l5,void*l12,int*l13,int l220){int l124 = SOC_E_NONE;int l123,l221;int l236,
l237;defip_pair_128_entry_t l238;uint32 l239,l233,l234;int l225,l226;int l240
,l241;int l144,l24 = 0;int l137,bucket_index;soc_mem_t l224;soc_field_t l242[
4] = {IP_ADDR_MASK1_UPRf,IP_ADDR_MASK0_UPRf,IP_ADDR_MASK1_LWRf,
IP_ADDR_MASK0_LWRf};soc_field_t l243[4] = {IP_ADDR1_UPRf,IP_ADDR0_UPRf,
IP_ADDR1_LWRf,IP_ADDR0_LWRf};l224 = L3_DEFIP_PAIR_128m;if(!
SOC_URPF_STATUS_GET(l1)&&l220){return SOC_E_PARAM;}l236 = soc_mem_index_min(
l1,l224);l237 = soc_mem_index_count(l1,l224);if(SOC_URPF_STATUS_GET(l1)){l237
>>= 1;}if(soc_alpm_mode_get(l1)){l237>>= 1;l236+= l237;}if(l220){l236+= 
soc_mem_index_count(l1,l224)/2;}soc_cm_debug(DK_VERBOSE,
"Start LPM searchng from %d, count %d\n",l236,l237);for(l123 = l236;l123<l236
+l237;l123++){SOC_IF_ERROR_RETURN(soc_mem_read(l1,l224,MEM_BLOCK_ANY,l123,(
...
l239)){break;}}if(l221<4){continue;}soc_cm_debug(DK_VERBOSE,
"Hit Global High route in index = %d\n",l221);sal_memcpy(l12,&l238,sizeof(
l238));*l13 = l123;return SOC_E_NONE;}soc_cm_debug(DK_VERBOSE,
...
soc_cm_debug(DK_VERBOSE,"Not found in VRF region, try Global ""region\n");
l124 = l219(l1,l5,l12,l24,&l137,&bucket_index,l13,l220);}if(SOC_SUCCESS(l124)
){l137 = soc_alpm_logical_idx(l1,l224,SOC_ALPM_128_DEFIP_TO_PAIR(l137>>1),1);
soc_cm_debug(DK_VERBOSE,"Hit in %s region in TCAM index %d, "
"buckekt_index %d\n",l24 == SOC_L3_VRF_GLOBAL?"Global Low":"VRF",l137,
bucket_index);}else{soc_cm_debug(DK_VERBOSE,"Search miss for given address\n"
);}return(l124);}int soc_alpm_128_delete(int l1,void*l5,int l216,int l217){
int l144,l24;int l7;int l124 = SOC_E_NONE;l7 = L3_DEFIP_MODE_128;
SOC_IF_ERROR_RETURN(soc_alpm_128_lpm_vrf_get(l1,l5,&l144,&l24));if(l144 == 
SOC_L3_VRF_OVERRIDE){l124 = l4(l1,l5);if(SOC_SUCCESS(l124)){
VRF_TRIE_ROUTES_DEC(l1,MAX_VRF_ID,l7);VRF_PIVOT_REF_DEC(l1,MAX_VRF_ID,l7);}
return(l124);}else{if(!VRF_TRIE_INIT_COMPLETED(l1,l24,l7)){soc_cm_debug(
DK_VERBOSE,"soc_alpm_128_delete:VRF %d/%d is not ""initialized\n",l24,l7);
return SOC_E_NONE;}if(l216 == -1){l216 = 0;}l124 = l197(l1,l5,
...
]),l245,l248,l115,index);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"\ndel  index: H %d error %d\n",index,l124);}}static int l250(int l1,void*l5,
int l115,int*l116){l98 l248;int l124;uint16 index = (0xFFFF);l248[0] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l5)
,(l91[(l1)]->l50));l248[1] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO
(l1,L3_DEFIP_PAIR_128m)),(l5),(l91[(l1)]->l48));l248[2] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l5)
,(l91[(l1)]->l54));l248[3] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO
(l1,L3_DEFIP_PAIR_128m)),(l5),(l91[(l1)]->l52));l248[4] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l5)
...
(l1,L3_DEFIP_PAIR_128m)),(l5),(l91[(l1)]->l53));if((!(SOC_IS_HURRICANE(l1)))
&&(((l91[(l1)]->l73)!= NULL))){int l244;(void)soc_alpm_128_lpm_vrf_get(l1,l5,
(int*)&l248[8],&l244);}else{l248[8] = 0;};l124 = l112((l102[(l1)]),l245,l248,
l115,&index);if(SOC_FAILURE(l124)){*l116 = 0xFFFFFFFF;return(l124);}*l116 = 
index;return(SOC_E_NONE);}static uint16 l105(uint8*l106,int l107){return(
_shr_crc16b(0,l106,l107));}static int l108(int l17,int l93,int l94,l97**l109)
{l97*l113;int index;if(l94>l93){return SOC_E_MEMORY;}l113 = sal_alloc(sizeof(
l97),"lpm_hash");if(l113 == NULL){return SOC_E_MEMORY;}sal_memset(l113,0,
sizeof(*l113));l113->l17 = l17;l113->l93 = l93;l113->l94 = l94;l113->l95 = 
sal_alloc(l113->l94*sizeof(*(l113->l95)),"hash_table");if(l113->l95 == NULL){
sal_free(l113);return SOC_E_MEMORY;}l113->l96 = sal_alloc(l113->l93*sizeof(*(
l113->l96)),"link_table");if(l113->l96 == NULL){sal_free(l113->l95);sal_free(
l113);return SOC_E_MEMORY;}for(index = 0;index<l113->l94;index++){l113->l95[
index] = (0xFFFF);}for(index = 0;index<l113->l93;index++){l113->l96[index] = 
(0xFFFF);}*l109 = l113;return SOC_E_NONE;}static int l110(l97*l111){if(l111!= 
NULL){sal_free(l111->l95);sal_free(l111->l96);sal_free(l111);}return
SOC_E_NONE;}static int l112(l97*l113,l99 l114,l98 entry,int l115,uint16*l116)
{int l1 = l113->l17;uint16 l251;uint16 index;l251 = l105((uint8*)entry,(32*9)
)%l113->l94;index = l113->l95[l251];;;while(index!= (0xFFFF)){uint32 l12[
...
if((*l114)(entry,l104) == 0){*l116 = index;;return(SOC_E_NONE);}index = l113
->l96[index&(0x3FFF)];;};return(SOC_E_NOT_FOUND);}static int l117(l97*l113,
l99 l114,l98 entry,int l115,uint16 l118,uint16 l119){int l1 = l113->l17;
uint16 l251;uint16 index;uint16 l253;l251 = l105((uint8*)entry,(32*9))%l113->
l94;index = l113->l95[l251];;;;l253 = (0xFFFF);if(l118!= (0xFFFF)){while(
index!= (0xFFFF)){uint32 l12[SOC_MAX_MEM_FIELD_WORDS];l98 l104;int l252;l252 = 
index;SOC_IF_ERROR_RETURN(READ_L3_DEFIP_PAIR_128m(l1,MEM_BLOCK_ANY,l252,l12))
;l103(l1,l12,index,l104);if((*l114)(entry,l104) == 0){if(l119!= index){;if(
l253 == (0xFFFF)){l113->l95[l251] = l119;l113->l96[l119&(0x3FFF)] = l113->l96
[index&(0x3FFF)];l113->l96[index&(0x3FFF)] = (0xFFFF);}else{l113->l96[l253&(
0x3FFF)] = l119;l113->l96[l119&(0x3FFF)] = l113->l96[index&(0x3FFF)];l113->
l96[index&(0x3FFF)] = (0xFFFF);}};return(SOC_E_NONE);}l253 = index;index = 
l113->l96[index&(0x3FFF)];;}}l113->l96[l119&(0x3FFF)] = l113->l95[l251];l113
->l95[l251] = l119;return(SOC_E_NONE);}static int l120(l97*l113,l99 l114,l98
entry,int l115,uint16 l121){uint16 l251;uint16 index;uint16 l253;l251 = l105(
(uint8*)entry,(32*9))%l113->l94;index = l113->l95[l251];;;l253 = (0xFFFF);
while(index!= (0xFFFF)){if(l121 == index){;if(l253 == (0xFFFF)){l113->l95[
l251] = l113->l96[l121&(0x3FFF)];l113->l96[l121&(0x3FFF)] = (0xFFFF);}else{
l113->l96[l253&(0x3FFF)] = l113->l96[l121&(0x3FFF)];l113->l96[l121&(0x3FFF)] = 
(0xFFFF);}return(SOC_E_NONE);}l253 = index;index = l113->l96[index&(0x3FFF)];
;}return(SOC_E_NOT_FOUND);}static int l254(int l1,void*l12){return(SOC_E_NONE
);}void soc_alpm_128_lpm_state_dump(int l1){int l123;int l255;l255 = ((3*(128
+2+1))-1);if(!soc_cm_debug_check(DK_L3|DK_SOCMEM|DK_VERBOSE)){return;}for(
l123 = l255;l123>= 0;l123--){if((l123!= ((3*(128+2+1))-1))&&((l39[(l1)][(l123
)].l32) == -1)){continue;}soc_cm_debug(DK_L3|DK_SOCMEM|DK_VERBOSE,
"PFX = %d P = %d N = %d START = %d END = %d VENT = %d FENT = %d\n",l123,(l39[
(l1)][(l123)].l34),(l39[(l1)][(l123)].next),(l39[(l1)][(l123)].l32),(l39[(l1)
][(l123)].l33),(l39[(l1)][(l123)].l35),(l39[(l1)][(l123)].l36));}
...
l115);if(!l285){l246(l1,l3,index,0x4000,0);}l124 = l163(l1,MEM_BLOCK_ANY,
index,index,l3);if(l124>= 0){l124 = l256(l1,index,l3);}}SOC_ALPM_LPM_UNLOCK(
l1);return(l124);}static int l4(int l1,void*l5){int l115;int index;int l7;
uint32 l12[SOC_MAX_MEM_FIELD_WORDS];int l124 = SOC_E_NONE;SOC_ALPM_LPM_LOCK(
l1);l124 = l11(l1,l5,l12,&index,&l115,&l7);if(l124 == SOC_E_NONE){
soc_cm_debug(DK_L3|DK_SOCMEM,"\nsoc_alpm_lpm_delete: %d %d\n",index,l115);
l249(l1,l5,index);l124 = l276(l1,l115,l7,l12,index);}
soc_alpm_128_lpm_state_dump(l1);SOC_ALPM_LPM_UNLOCK(l1);return(l124);}static
int l15(int l1,void*l5,void*l12,int*l13){int l115;int l124;int l7;
SOC_ALPM_LPM_LOCK(l1);l124 = l11(l1,l5,l12,l13,&l115,&l7);SOC_ALPM_LPM_UNLOCK
(l1);return(l124);}static int l6(int l17,void*l5,int l7,int l8,int l9,
defip_aux_scratch_entry_t*l10){uint32 l126;uint32 l286[4] = {0,0,0,0};int l115
= 0;int l124 = SOC_E_NONE;l126 = soc_mem_field32_get(l17,L3_DEFIP_PAIR_128m,
l5,VALID0_LWRf);soc_mem_field32_set(l17,L3_DEFIP_AUX_SCRATCHm,l10,VALIDf,l126
);l126 = soc_mem_field32_get(l17,L3_DEFIP_PAIR_128m,l5,MODE0_LWRf);
soc_mem_field32_set(l17,L3_DEFIP_AUX_SCRATCHm,l10,MODEf,l126);l126 = 
soc_mem_field32_get(l17,L3_DEFIP_PAIR_128m,l5,ENTRY_TYPE0_LWRf);
soc_mem_field32_set(l17,L3_DEFIP_AUX_SCRATCHm,l10,ENTRY_TYPEf,0);l126 = 
soc_mem_field32_get(l17,L3_DEFIP_PAIR_128m,l5,GLOBAL_ROUTEf);
soc_mem_field32_set(l17,L3_DEFIP_AUX_SCRATCHm,l10,GLOBAL_ROUTEf,l126);l126 = 
soc_mem_field32_get(l17,L3_DEFIP_PAIR_128m,l5,ECMPf);soc_mem_field32_set(l17,
L3_DEFIP_AUX_SCRATCHm,l10,ECMPf,l126);l126 = soc_mem_field32_get(l17,
L3_DEFIP_PAIR_128m,l5,ECMP_PTRf);soc_mem_field32_set(l17,
L3_DEFIP_AUX_SCRATCHm,l10,ECMP_PTRf,l126);l126 = soc_mem_field32_get(l17,
L3_DEFIP_PAIR_128m,l5,NEXT_HOP_INDEXf);soc_mem_field32_set(l17,
L3_DEFIP_AUX_SCRATCHm,l10,NEXT_HOP_INDEXf,l126);l126 = soc_mem_field32_get(
l17,L3_DEFIP_PAIR_128m,l5,PRIf);soc_mem_field32_set(l17,L3_DEFIP_AUX_SCRATCHm
,l10,PRIf,l126);l126 = soc_mem_field32_get(l17,L3_DEFIP_PAIR_128m,l5,RPEf);
soc_mem_field32_set(l17,L3_DEFIP_AUX_SCRATCHm,l10,RPEf,l126);l126 =
...
l134(l17,lpm_entry,prefix,&l291,&l22);SOC_IF_ERROR_RETURN(l124);l289 = 
soc_alpm_physical_idx(l17,L3_DEFIP_PAIR_128m,l289,l7);SOC_IF_ERROR_RETURN(
soc_alpm_128_lpm_vrf_get(l17,lpm_entry,&l144,&l24));l179 = sal_alloc(sizeof(
alpm_bucket_handle_t),"ALPM Bucket Handle");if(l179 == NULL){soc_cm_debug(
DK_ERR,"Unable to allocate memory for ""PIVOT trie node \n");return SOC_E_NONE
;}sal_memset(l179,0,sizeof(*l179));l170 = sal_alloc(sizeof(alpm_pivot_t),
"Payload for Pivot");if(l170 == NULL){soc_cm_debug(DK_ERR,
"Unable to allocate memory for ""PIVOT trie node \n");sal_free(l179);return
SOC_E_MEMORY;}sal_memset(l170,0,sizeof(*l170));PIVOT_BUCKET_HANDLE(l170) = 
l179;trie_init(_MAX_KEY_LEN_144_,&PIVOT_BUCKET_TRIE(l170));key[0] = 
...
l124 = l134(l17,l295,prefix,&l129,&l22);if(SOC_FAILURE(l124)){soc_cm_debug(
DK_ERR,"prefix create failed\n");return l124;}sal_free(l295);l289 = 
soc_alpm_physical_idx(l17,L3_DEFIP_PAIR_128m,l289,l7);l140 = ALPM_TCAM_PIVOT(
l17,SOC_ALPM_128_ADDR_LWR(l289)<<1);l296 = PIVOT_BUCKET_TRIE(l140);l297 = 
sal_alloc(sizeof(payload_t),"Payload for Key");if(NULL == l297){soc_cm_debug(
DK_ERR,"Unable to allocate memory for ""trie node.\n");return SOC_E_MEMORY;}
l177 = sal_alloc(sizeof(payload_t),"Payload for pfx trie key");if(NULL == 
l177){soc_cm_debug(DK_ERR,"Unable to allocate memory for ""pfx trie node\n");
sal_free(l297);return SOC_E_MEMORY;}sal_memset(l297,0,sizeof(*l297));
sal_memset(l177,0,sizeof(*l177));l297->key[0] = prefix[0];l297->key[1] = 
prefix[1];l297->key[2] = prefix[2];l297->key[3] = prefix[3];l297->key[4] = 
prefix[4];l297->len = l129;l297->index = l293;sal_memcpy(l177,l297,sizeof(*
l297));l124 = trie_insert(l296,prefix,NULL,l129,(trie_node_t*)l297);if(
SOC_FAILURE(l124)){goto l298;}if(l7){l173 = VRF_PREFIX_TRIE_IPV6_128(l17,l24)
;}if(!l22){l124 = trie_insert(l173,prefix,NULL,l129,(trie_node_t*)l177);if(
SOC_FAILURE(l124)){goto l193;}}return l124;l193:(void)trie_delete(l296,prefix
,l129,&l175);l297 = (payload_t*)l175;l298:sal_free(l297);sal_free(l177);
return l124;}static int l299(int l17,int l30,int l24,int l214,int bkt_ptr){
int l124 = SOC_E_NONE;uint32 l129;uint32 key[5] = {0,0,0,0,0};trie_t*l300 = 
NULL;payload_t*l204 = NULL;defip_pair_128_entry_t*lpm_entry = NULL;lpm_entry = 
...
sal_memset(l204,0,sizeof(*l204));l129 = 0;l204->key[0] = key[0];l204->key[1] = 
key[1];l204->len = l129;l124 = trie_insert(l300,key,NULL,l129,&(l204->node));
if(SOC_FAILURE(l124)){sal_free(l204);return l124;}VRF_TRIE_INIT_DONE(l17,l24,
l30,1);return l124;}int soc_alpm_128_warmboot_prefix_insert(int l17,int l7,
void*lpm_entry,void*l18,int l289,int l290,int l293){int l294;int l24;int l124
...
l7,l24,l289,l290);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"VRF %d/%d trie init \n""failed\n",l24,l7);return l124;}soc_cm_debug(
DK_VERBOSE,"VRF %d/%d trie init ""completed\n",l24,l7);}l124 = l292(l17,l7,
lpm_entry,l18,l20,l289,l290,l293);if(l124!= SOC_E_NONE){soc_cm_debug(DK_WARN,
"unit %d : ""Route Insertion Failed :%s\n",l17,soc_errmsg(l124));return(l124)
;}VRF_TRIE_ROUTES_INC(l17,l24,l7);return(l124);}int
...
SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,"\tLaunched AUX operation for "
"index %d bucket %d sanity check failed\n",l123,l308);l309++;continue;}if(
l304!= l308){soc_cm_debug(DK_ERR,"\tEntry at index %d does not belong "
"to bucket %d(from bucket %d)\n",l305,l308,l304);l309++;}if(l137 == -1){l137 = 
l303;continue;}if(l137!= l303){int l151,l152;l151 = soc_alpm_logical_idx(l1,
l224,SOC_ALPM_128_DEFIP_TO_PAIR(l137>>1),1);l152 = soc_alpm_logical_idx(l1,
l224,SOC_ALPM_128_DEFIP_TO_PAIR(l303>>1),1);soc_cm_debug(DK_ERR,
"\tAliased bucket %d(returned "
"bucket %d) found from TCAM1 %d and TCAM2 %d\n",l308,l304,l151,l152);l309++;}
}}SOC_ALPM_LPM_UNLOCK(l1);if(l309 == 0){soc_cm_print(
...
l123,(void*)l12);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"\tRead memory %s index %d (original) ""return %d\n",SOC_MEM_NAME(l1,l224),
l123,l124);l309 = l124;continue;}if(soc_mem_field32_get(l1,l224,(void*)l12,
l310) == 0||soc_mem_field32_get(l1,l224,(void*)l12,l311) == 1){continue;}l315
= soc_mem_field32_get(l1,l224,(void*)l12,l312);if(l315!= 0){if(l314[l315] == 
-1){l314[l315] = l123;}else{soc_cm_debug(DK_ERR,
...
SOC_E_PARAM){soc_cm_debug(DK_ERR,"\tInvalid bucket pointer %d "
"detected, in memory %s index %d\n",l315,SOC_MEM_NAME(l1,l224),l123);l309 = 
l124;continue;}if(l124>= 0&&l313 == 0){soc_cm_debug(DK_ERR,
"\tFreed bucket pointer %d ""detected, in memory %s index %d\n",l315,
SOC_MEM_NAME(l1,l224),l123);l309 = l124;continue;}l318 = 
_soc_trident2_alpm_bkt_view_get(l1,l315<<2);if(l318!= L3_DEFIP_ALPM_IPV6_128m
...
l319,(void*)l12,&l303,&l304,&l305,FALSE);if(l303 == -1){soc_cm_debug(DK_ERR,
"\tLaunched AUX operation for PIVOT ""index %d sanity check failed\n",l123);
l309 = l124;continue;}l231 = soc_alpm_logical_idx(l1,l224,
SOC_ALPM_128_DEFIP_TO_PAIR(l303>>1),1);l124 = soc_mem_read(l1,l224,
MEM_BLOCK_ANY,l231,(void*)l12);if(SOC_FAILURE(l124)){soc_cm_debug(DK_ERR,
"\tRead memory %s index %d (nexthop) ""return %d\n",SOC_MEM_NAME(l1,l224),
l231,l124);l309 = l124;continue;}l317 = soc_mem_field32_get(l1,l224,(void*)
l12,l320);if(l316!= l317){soc_cm_debug(DK_ERR,
"\tDefault nexthop was not populated "
"correctly, TCAM index1 %d index2 %d \n",l123,l231);l309 = l124;continue;}}
SOC_ALPM_LPM_UNLOCK(l1);sal_free(l314);if(l309 == 0){soc_cm_print(
"\tMemory %s index %d Pivot sanity check passed\n",SOC_MEM_NAME(l1,l224),
index);return SOC_E_NONE;}soc_cm_debug(DK_ERR,
"\tMemory %s index %d Pivot sanity check ""failed, encountered %d error(s)\n"
,SOC_MEM_NAME(l1,l224),index,l309);return SOC_E_FAIL;}
#endif /* ALPM_ENABLE */
