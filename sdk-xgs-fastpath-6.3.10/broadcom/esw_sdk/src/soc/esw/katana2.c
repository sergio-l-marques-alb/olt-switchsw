                                    ...
                                    uint8 *phy_mode)
{
  ...
  *phy_mode = PHYCTRL_QUAD_LANE_PORT; /* XAUI */
  ...
  if (IS_XE_PORT(unit, port)) {
      SOC_IF_ERROR_RETURN(soc_katana2_get_core_port_mode(unit, port, &mode));
          ...
          if ((sal_strcmp(intf_type, "XAUI") == 0) ||
              ...
              if (mode == bcmMxqCorePortModeSingle) {
                  *phy_mode = PHYCTRL_QUAD_LANE_PORT;
                  ...
                  soc_cm_print("Discarded XAUI setting.Faliing through\n");
              }
          }
                                    ...
                                    uint8 *chip_num)
{
  ...
  *lane_num = (*kt2_port_to_mxqblock_subports[unit])[port-1];
  ...
  soc_cm_debug(DK_VERBOSE, "Checking config %s settings \n", spn_PORTGROUP);
 ...
 */
    ...
    if (_soc_kt2_mmu_params.packing_mode_d_c) {
        soc_cm_debug(DK_VERBOSE, "Packing mode enabled \n");
        _soc_kt2_mmu_params.max_pkt_size_support_packing = 10;
    } else {
        soc_cm_debug(DK_VERBOSE, "Packing mode disabled \n");
    }
...
_soc_katana2_mmu_tdm_init(int unit)
{
    ...
    case BCM56458_DEVICE_ID:
         ...
         SOC_DEBUG_PRINT((DK_VERBOSE,"Cfg=%d freq=%d size=%d raw=%d col=%d \n",
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 1:/* kt2_tdm_A_56450_1 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_1 \n"));
                sal_memcpy(arr,
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 2:/* kt2_tdm_A_56450_2 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_2 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A_ref[0], sizeof(kt2_tdm_56450A_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 3:/* kt2_tdm_A_56450_3 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_3 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A_ref[0],sizeof(kt2_tdm_56450A_ref));
                kt2_tdm_replace(arr,88,33,25,0);
                olp_port_flag=1;
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 4:/* kt2_tdm_A_56450_4 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_4 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A_ref[0], sizeof(kt2_tdm_56450A_ref));
                olp_port_flag=1;
                break;
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 5:/* kt2_tdm_A_56450_5 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_5 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A_ref[0], sizeof(kt2_tdm_56450A_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 6:/*  kt2_tdm_A_56450_6 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_6 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A_ref[0], sizeof(kt2_tdm_56450A_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 7:/* kt2_tdm_A_56450_7 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A_56450_7 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A_ref[0], sizeof(kt2_tdm_56450A_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 8:/* kt2_tdm_A1_56450_8 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A1_56450_8 \n"));
                sal_memcpy(arr,
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 9:/* kt2_tdm_A1_56450_9 */
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A1_56450_9 \n"));
                sal_memcpy(arr,
                           &kt2_tdm_56450A1_ref[0],
                           sizeof(kt2_tdm_56450A1_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 10: /* kt2_tdm_A2_56450_10 */
                  SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A2_56450_10 \n"));
                  sal_memcpy(arr,
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 11: /* kt2_tdm_A2_56450_11 */
                  SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A2_56450_11 \n"));
                  sal_memcpy(arr,
                            &kt2_tdm_56450A2_ref[0],
                            sizeof(kt2_tdm_56450A2_ref));
                  olp_port_flag=1;
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 12: /* kt2_tdm_A3_56450_12 */
                  SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A3_56450_12 \n"));
                  sal_memcpy(arr,
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 13: /* kt2_tdm_A2_56450_13 */
                  SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A2_56450_13 \n"));
                  sal_memcpy(arr,
                             &kt2_tdm_56450A2_ref[0],
                             sizeof(kt2_tdm_56450A2_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 14: /* kt2_tdm_A2_56450_14 */
                  SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A2_56450_14 \n"));
                  sal_memcpy(arr,
                             &kt2_tdm_56450A2_ref[0],
                             sizeof(kt2_tdm_56450A2_ref));
         ...
         case BCM56450_DEVICE_ID_OFFSET_CFG + 15: /* kt2_tdm_A2_56450_15 */
                  SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A2_56450_15 \n"));
                  memcpy(arr,
                         &kt2_tdm_56450A2_ref[0],
                         sizeof(kt2_tdm_56450A2_ref));
                  kt2_tdm_replace(arr,tdm_size,21,KT2_IDLE,0);
         ...
         case BCM56452_DEVICE_ID_OFFSET_CFG + 4:
                ...
                if (cfg_num == BCM56452_DEVICE_ID_OFFSET_CFG + 3) {
                    SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_C1_56452_3 \n"));
                    olp_port_flag=0;
                    kt2_tdm_replace(arr,64,KT2_OLP_PORT,KT2_IDLE,0);
                } else {
                    SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_C1_56452_4 \n"));
                    olp_port_flag=1;
                }
                break;
         case BCM56452_DEVICE_ID_OFFSET_CFG + 5:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_B_56452_5 \n"));
                sal_memcpy(arr,
         ...
         case BCM56452_DEVICE_ID_OFFSET_CFG + 6:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_B1_56452_6 \n"));
                sal_memcpy(arr,
         ...
         case BCM56452_DEVICE_ID_OFFSET_CFG + 7:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_B_56452_7 \n"));
                sal_memcpy(arr,
                          &kt2_tdm_56452B_ref[0], sizeof(kt2_tdm_56452B_ref));
                kt2_tdm_replace(arr,90,1,60,0);
                kt2_tdm_replace(arr,90,5,60,0);
         ...
         case BCM56452_DEVICE_ID_OFFSET_CFG + 8:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_B_56452_8 \n"));
                sal_memcpy(arr,
         ...
         case BCM56455_DEVICE_ID_OFFSET_CFG + 1:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_C_56455_1 \n"));
                sal_memcpy(arr,
                          &kt2_tdm_56455C_ref[0], sizeof(kt2_tdm_56455C_ref));
                olp_port_flag = 0;
                break;
         case BCM56455_DEVICE_ID_OFFSET_CFG + 2:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_C_56455_2 \n"));
                sal_memcpy(arr,
                          &kt2_tdm_56455C_ref[0], sizeof(kt2_tdm_56455C_ref));
         ...
         case BCM56248_DEVICE_ID_OFFSET_CFG + 16:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_A3_56450_16 \n"));
                sal_memcpy(arr,
                          &kt2_tdm_56450A3_ref[0], sizeof(kt2_tdm_56450A3_ref));
                olp_port_flag=1;
                break;
         case BCM56248_DEVICE_ID_OFFSET_CFG + 17:
                SOC_DEBUG_PRINT((DK_VERBOSE,"kt2_tdm_D2_56248_17 \n"));
                sal_memcpy(arr,
...
int _soc_katana2_misc_init(int unit)
{
    ...
    *  2 instances one each for evlan and ehcpm stages of epipe */
    ...
    SOC_DDR3_MEM_GRADE(unit) = soc_property_get(unit, spn_DDR3_MEM_GRADE, 
            ddr3_mem_grade);
    SOC_DEBUG_PRINT((DK_VERBOSE,"num_cis=%d num_rows=%d ddr3_clock_mhz=%d ddr3_mem_grade=%d "
...
int _soc_katana2_get_cfg_num(int unit, int *new_cfg_num)
{
    ...
    SOC_DEBUG_PRINT((DK_VERBOSE, "Info Cfg_num:%d Internal cfg_num:%d \n",cfg_num,*new_cfg_num));
    return BCM_E_NONE;
}
...
/* #ifdef BROADCOM_SVK  */
   ...
   var_set_integer("config", cfg_num, FALSE, FALSE);
   var_set_integer("BCM56450_CFG_OFFSET", 
                   BCM56450_DEVICE_ID_OFFSET_CFG, FALSE, FALSE);
   var_set_integer("BCM56452_CFG_OFFSET", 
                   BCM56452_DEVICE_ID_OFFSET_CFG, FALSE, FALSE);
   var_set_integer("BCM56454_CFG_OFFSET", 
                   BCM56454_DEVICE_ID_OFFSET_CFG, FALSE, FALSE);
   var_set_integer("BCM56455_CFG_OFFSET", 
                   BCM56455_DEVICE_ID_OFFSET_CFG, FALSE, FALSE);
   var_set_integer("BCM56248_CFG_OFFSET", 
                   BCM56248_DEVICE_ID_OFFSET_CFG, FALSE, FALSE);
   var_set_integer("olp_port", SOC_INFO(unit).olp_port, FALSE, FALSE);
   ...
   var_set_integer("xfi_0", wc_xfi_mode_sel_val[0], FALSE, FALSE);
   var_set_integer("xfi_1", wc_xfi_mode_sel_val[1], FALSE, FALSE);
   ...
   case BCM56248_DEVICE_ID_OFFSET_CFG + 0:
   case BCM56450_DEVICE_ID_OFFSET_CFG + 0:
        soc_cm_print( "portgroup_27.%d=1 \n",  unit);
        soc_cm_print( "portgroup_28.%d=1 \n", unit);
        soc_cm_print( "portgroup_29.%d=1 \n", unit);
        soc_cm_print( "portgroup_30.%d=1 \n", unit);
        soc_cm_print( "portgroup_31.%d=1 \n", unit);
        soc_cm_print( "portgroup_32.%d=1 \n", unit);
        soc_cm_print( "portgroup_33.%d=1 \n", unit);
        soc_cm_print( "portgroup_34.%d=1 \n", unit);
        break;
   case BCM56248_DEVICE_ID_OFFSET_CFG + 1:
   case BCM56248_DEVICE_ID_OFFSET_CFG + 2:
   ...
   case BCM56450_DEVICE_ID_OFFSET_CFG + 5:
        soc_cm_print( "portgroup_27.%d=1 \n", unit);
        soc_cm_print( "portgroup_33.%d=1 \n", unit);
        soc_cm_print( "portgroup_25.%d=1 \n", unit);
        soc_cm_print( "portgroup_36.%d=1 \n", unit);
   ...
   case BCM56450_DEVICE_ID_OFFSET_CFG + 7:
        ...
        soc_cm_print( "portgroup_28.%d=1 \n", unit);
        soc_cm_print( "portgroup_30.%d=1 \n", unit);
        soc_cm_print( "portgroup_26.%d=1 \n", unit);
        soc_cm_print( "portgroup_39.%d=1 \n", unit);
        break;
   case BCM56248_DEVICE_ID_OFFSET_CFG + 6:
   ...
   case BCM56450_DEVICE_ID_OFFSET_CFG + 15:
        soc_cm_print( "portgroup_27.%d=4 \n", unit);
        soc_cm_print( "portgroup_28.%d=4 \n", unit);
        break;
   case BCM56248_DEVICE_ID_OFFSET_CFG + 16:
        soc_cm_print( "portgroup_27.%d=4 \n", unit);
        soc_cm_print( "portgroup_28.%d=4 \n", unit);
   ...
   case BCM56452_DEVICE_ID_OFFSET_CFG + 3:
   case BCM56452_DEVICE_ID_OFFSET_CFG + 4:
        soc_cm_print( "portgroup_25.%d=4 \n", unit);
        soc_cm_print( "portgroup_26.%d=4 \n", unit);
        soc_cm_print( "portgroup_27.%d=4 \n", unit);
        soc_cm_print( "portgroup_28.%d=4 \n", unit);
        break; 
   case BCM56452_DEVICE_ID_OFFSET_CFG + 5:
