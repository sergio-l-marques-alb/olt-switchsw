                  ...
                  uint32 *hash_value)
{
    ...
    if (ecmp_hash_use_rtag7 == 0) {
        BCM_VERB(("Unit %d - ECMP RH Hash calculation:  non rtag7 calc not supported\n", unit));
        *hash_value =  0;
        return BCM_E_NONE;
    }
    ...
    BCM_VERB(("Unit %d - ecmp rh hash_seb_sel=%d, hash_offset=%d, concat=%d\n",
                  unit, hash_sub_sel, hash_offset, concat));
    ...
    *hash_value &= 0xffff;  
    ...
    BCM_VERB(("Unit %d - ecmp rh hash val=%d\n", unit,  *hash_value));
                         ...
                         uint32 *hash_value)
{
    ...
    BCM_VERB(("Unit %d - Trunk RH hash_sub_sel=%d, hash_offset=%d, concat=%d\n",
                unit, hash_sub_sel, hash_offset, concat));
    ...
    *hash_value &= offset_shift;  
    ...
    BCM_VERB(("Unit %d - Trunk RH hash_value=%d\n", unit, *hash_value));
                         ...
                         uint32 *hash_value)
{
    ...
    BCM_VERB(("Unit %d - HGT RH hash_sub_sel=%d, hash_offset=%d, concat=%d\n",
                unit, hash_sub_sel, hash_offset, concat));
    ...
    *hash_value &= offset_shift;  
    ...
    BCM_VERB(("Unit %d - HGT RH hash_value=%d\n", unit, *hash_value));
                                   ...
                                   uint32 *hash_value)
{
    ...
    BCM_VERB(("Unit %d - vxlan hash_seb_sel=%d, hash_offset=%d, concat=%d\n",
                  unit, hash_sub_sel, hash_offset, concat));
    BCM_IF_ERROR_RETURN
        (select_td2_hash_subfield(concat, hash_sub_sel, &hash_subfield, hash_Base)); 
    ...
    *hash_value &= offset_shift;  
    ...
    BCM_VERB(("Unit %d - vxlan hash_value=%d\n", unit, *hash_value));
                ...
                uint32* resolved_member, uint8* resolved_member_is_valid) 
{
    ...
    if (rh_mode == RTAG7_RH_MODE_ECMP) {
        ...
        *resolved_member_is_valid = soc_RH_LAG_FLOWSETm_field32_get(
        ...
        BCM_VERB(("Unit %d:RH_LAG_FLOWSET.PORT_NUMf=%d\n", unit, port_id));
        BCM_VERB(("Unit %d:RH_LAG_FLOWSET.MODULE_IDF=%d\n",unit, mod_id));
    ...
    BCM_VERB(("Unit %d: rh flowset *resolved_member=%d\n",unit, *resolved_member));
    ...
    if (ecmp_rh_enable) {
        ...
        if (resolved_member_valid) {
            *nh_id = resolved_member & 0xffff; 
            ...
            BCM_VERB(("Unit %d - Hash calculation: Such Configuration is not supported: resolved_lag_member_valid==FALSE\n", unit));
            return BCM_E_PARAM;
        }
    } else {
        /* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                  ...
                  uint8 lag_rh_enable, uint32 ethertype)
{
    ...
    if (lag_rh_enable) {
        ...
        if (resolved_member_valid) { 
            ...
            BCM_VERB(("Unit %d - Hash calculation: Such Configuration is not supported: \n", unit));
            return BCM_E_PARAM;
        }
    } else {
        BCM_IF_ERROR_RETURN
                                   ...
                                   bcm_if_t *dst_intf)
{
    ...
    if (0 != (pkt_info->flags & BCM_SWITCH_PKT_INFO_HASH_MULTIPATH)) {
        ...
        if (0 != (check_td2_ecmp_rh_enable(unit, 
            ...
            BCM_VERB(("\tECMP Hash rh value 0x%08x\n", hash_rh_value));
        } else {
    ...
    if (0 != (pkt_info->flags & BCM_SWITCH_PKT_INFO_HASH_TRUNK)) {
        ...
        if (trunk >= ti.trunk_id_min && trunk <= ti.trunk_id_max) {
            ...
            BCM_VERB(("\tTrunk RH Hash value 0x%08x\n", hash_rh_value));
            ...
            BCM_VERB(("\tHG-Trunk RH Hash value 0x%08x\n", hash_rh_value));
    ...
    /* vxlan hashing resolution */
        ...
        BCM_VERB(("\tVXlan Hash value 0x%08x\n", hash_value));
        *dst_intf = hash_value;
