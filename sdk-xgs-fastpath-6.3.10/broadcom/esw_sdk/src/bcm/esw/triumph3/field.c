/* $Id: field.c,v 1.129.2.3 Broadcom SDK $
...
_field_tr3_egress_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyInPort,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 149, 7);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 156, 1);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyMirrorCopy,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 157, 1);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlan,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 158, 16);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlanId,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 158, 12);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlanCfi,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 170, 1);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOuterVlanPri,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 171, 3);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyVlanFormat,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 174, 2);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyDstHiGig,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 176, 1);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyInterfaceClassPort,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 177, 8);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyOutPort,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 185, 7);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyIpType,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 192, 4);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyDrop,
                 _bcmFieldSliceSelFpf3, _BCM_FIELD_EFP_KEY5, 196, 1);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifySrcClassL2,
...
_field_tr3_external_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    /* _FP_EXT_ACL_L2 */
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2, 0, 4); 
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_144_IPV4, 0, 4); 
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_IPV4, 0, 4); 
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV4, 0, 4); 
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_IPV6_SHORT, 128, 4);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_IPV6_FULL, 128, 4);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyL3Routable,
                 _bcmFieldSliceSelExternal, _FP_EXT_ACL_L2_IPV6, 128, 4);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyForwardingType,
                                      ...
                                      )
{
    switch (action) {
        ...
        case bcmFieldActionPolicerLevel1:
            *result = (stage == _BCM_FIELD_STAGE_INGRESS || _BCM_FIELD_STAGE_EXTERNAL);
            return (BCM_E_NONE);

        case bcmFieldActionPolicerGroup:
        case bcmFieldActionStatGroup:
            *result = (stage == _BCM_FIELD_STAGE_LOOKUP || _BCM_FIELD_STAGE_EXTERNAL);
            return (BCM_E_NONE);
        ...
        case bcmFieldActionGpCopyToCpu:
            *result = (stage == _BCM_FIELD_STAGE_INGRESS
                                ...
                                || _BCM_FIELD_STAGE_EXTERNAL) ? TRUE
                               ...
                               )
{
    ...
    uint32 arg2 = fa->param[1];  /* Action param value      */
    ...
    if (_BCM_FIELD_STAGE_EXTERNAL != f_ent->group->stage_id) {
        ...
        case bcmFieldActionRpPortPrioIntCosQNew:
            ...
            PolicyCheck(unit, mem, R_COS_INT_PRIf, arg2);
            return (BCM_E_NONE);
        case bcmFieldActionYpPortPrioIntCosQNew:
            if (arg2 & (0x1 << 9)) {
                return (BCM_E_PARAM);
            }
            PolicyCheck(unit, mem, Y_COS_INT_PRIf, arg2);
            return (BCM_E_NONE);
        case bcmFieldActionGpPortPrioIntCosQNew:
            if (arg2 & (0x1 << 9)) {
                return (BCM_E_PARAM);
            }
            PolicyCheck(unit, mem, G_COS_INT_PRIf, arg2);
            return (BCM_E_NONE);
                                    ...
                                    )
{
    ...
    for (hw_idx = 0, n = p->size + 1 - f_st->hw_entry_count; n; --n, ++hw_idx) {
        for (i = 0; i < f_st->hw_entry_count && SHR_BITGET(p->cntr_bmp.w, hw_idx + i) == 0; ++i);
...
_field_tr3_ingress_write_slice_map(int unit, _field_stage_t *stage_fc)
{
    ...
    for (index = 0; index < vmap_size; index++) {
        soc_mem_field32_set(unit,
                            ...
                            stage_fc->vmap[_FP_VMAP_DEFAULT][index].vmap_key
                            );
        soc_mem_field32_set(unit,
                            FP_SLICE_MAPm,
                            fp_slice_map_buf.entry_data,
                            slice_group[index],
                            stage_fc->vmap[_FP_VMAP_DEFAULT][index].virtual_group
                            );
    }
                          ...
                          )
{
    ...
    switch (fa->action) {
        ...
        case bcmFieldActionCosQNew:
            ...
            PolicySet(unit, mem, buf, R_COS_INT_PRIf,
                      _FP_ACTION_UCAST_QUEUE_SET(arg));
...
_field_tr3_logical_meter_pools_init(int unit, _field_stage_t *stage_fc)
{
    ...
    int      logical_pool_idx = -1;        /* Virtual Meter pools iterator.   */
    int      logical_size = -1;            /* Virtual Allocation size.        */
                        ...
                        uint8 *updateHigherMeter)
{
    ...
    for (idx = 0 ; idx < stage_fc->num_logical_meter_pools; idx++) {
        ...
        if (fc->ingress_logical_policer_pools_mode ==
            ...
            f_mp = stage_fc->meter_pool[idx % 8];
            ...
            f_mp = stage_fc->meter_pool[idx / 2];
    ...
    *logical_pool_idx = logical_free_pool;
    ...
    FP_VVERB(("Unit(%d): %s() : Alloted Physical Pool: %d at "
                "level: %d with corresponding Logical Pool : %d\r\n",
                unit, __FUNCTION__, free_pool, f_mp->level,
                logical_free_pool));
    return (BCM_E_NONE);
}
    ...
    for (idx = startIdx; idx < endIdx; idx++) {
        ...
        if (!_FP_POLICER_IS_FLOW_MODE(f_pl)) {
            ...
            if ((0 == _FP_METER_BMP_TEST(f_mp->meter_bmp, idx))
                ...
                FP_VVERB(("Unit(%d): Alloted Physical Pool(%d): MeterIndex: %d"
        ...
        if (_FP_POLICER_IS_FLOW_MODE(f_pl)
            ...
            if (f_pl->hw_flags & _FP_POLICER_DIRTY) {
                ...
                FP_VVERB(("FP(unit %d) Error: Meter alloc called with invalid"
                            " hw_flags=%x\n", unit, f_pl->hw_flags));
                return (BCM_E_INTERNAL);
            }
            ...
            FP_VVERB(("Unit(%d): Alloted Physical Pool(%d):Index: %d at "
...
/* Version Change..Storing Hints information */
                             ...
                             )
{
    ...
    soc_field_t             index_field, modifier_field, pool_num_field;
    soc_mem_t               meter_mem = 0;
    uint32                  ent_pl_flags = 0;
    uint32                  *prate, *pburst;
    uint8                   mode_modifier;
    uint8                   meter_offset;
    uint8                   meter_pair_mode = 0;
    int                     pool_num;
    int                     pool_index;
    int                     rv, policer_id, mem_idx;

    /* Get the entry group info. */
    fg = f_ent->group;

    /* Get entry slice part info. */
    fs = f_ent[part].fs;
    sal_memset(&meter_conf, 0, sizeof(_meter_config_t));

    /* Initialize meter mode and pool information. */
    mode_modifier = 0;
    pool_index = _FP_INVALID_INDEX;
    pool_num = _FP_INVALID_INDEX;

    /* Get field control information. */
    BCM_IF_ERROR_RETURN(_field_control_get(unit, &fc));

    /* Get entry stage information. */
    stage_id = f_ent->group->stage_id;

    /* Get the stage field control information. */
    ...
    switch (stage_id) {
        case  _BCM_FIELD_STAGE_INGRESS:
            ...
            /* Check if meter is used in shared mode. */
            if (level == 1) {
                if ((meter_pair_mode = soc_mem_field32_get(unit,
                                         policy_mem,
                                         policy_buf,
                                         METER_SHARING_MODEf
                                         )
                ...
                /* Initialize the shared meter fields. */
                index_field    = SHARED_METER_PAIR_POOL_INDEXf;
                modifier_field = METER_SHARING_MODE_MODIFIERf;
                pool_num_field = SHARED_METER_PAIR_POOL_NUMBERf;
            } else {
                if ((meter_pair_mode = soc_mem_field32_get(unit,
                                        policy_mem,
                                        policy_buf,
                ...
                /* Initialize non-shared meter fields. */
                index_field    = METER_PAIR_POOL_INDEXf;
                modifier_field = METER_PAIR_MODE_MODIFIERf;
                pool_num_field = METER_PAIR_POOL_NUMBERf;
            }

            /* Get meter configuration from policy table entry. */
            pool_index = soc_mem_field32_get
                            (unit,
                             policy_mem,
                             policy_buf,
                             index_field
                             );
            mode_modifier = soc_mem_field32_get
                                (unit,
                                 policy_mem,
                                 policy_buf,
                                 modifier_field
                                 );
            pool_num = soc_mem_field32_get(unit,
                                           policy_mem,
                                           policy_buf,
                                           pool_num_field
                                           );

            /* Update meter pool slice and policer Level information. */

            f_mp = stage_fc->meter_pool[pool_num];
        ...
        case _BCM_FIELD_STAGE_EGRESS:
            ...
            meter_conf.meter_mode = soc_mem_field32_get
                                        (unit,
                                         policy_mem,
                                         policy_buf,
                                         METER_PAIR_MODEf
                                         );
            meter_conf.meter_idx = soc_mem_field32_get
                                        (unit,
                                         policy_mem,
                                         policy_buf,
                                         METER_INDEX_EVENf
                                         );
            meter_conf.meter_update_odd = soc_mem_field32_get
                                            (unit,
                                             policy_mem,
                                             policy_buf,
                                             METER_UPDATE_ODDf
                                             );
            meter_conf.meter_test_odd = soc_mem_field32_get
                                            (unit,
                                             policy_mem,
                                             policy_buf,
                                             METER_TEST_ODDf
                                             );
            meter_conf.meter_update_even = soc_mem_field32_get
                                                (unit,
                                                 policy_mem,
                                                 policy_buf,
                                                 METER_UPDATE_EVENf
                                                 );
            meter_conf.meter_test_even = soc_mem_field32_get
                                            (unit,
                                             policy_mem,
                                             policy_buf,
                                             METER_TEST_EVENf
            ...
            pool_num = fs->slice_number;
            pool_index = meter_conf.meter_idx;
            if ((meter_pair_mode == 0) && (pool_index == 0)) {
                return BCM_E_NONE;
            }
            break;
    ...
    /* Check if policer already exists */
    if (((stage_id != _BCM_FIELD_STAGE_EGRESS)
         && _FP_METER_BMP_TEST(f_mp->meter_bmp, pid))
        || ((stage_id == _BCM_FIELD_STAGE_EGRESS)
            && _FP_METER_BMP_TEST(fs->meter_bmp, meter_conf.meter_idx))) {
        ...
        for (idx = 0; idx < _FP_HASH_SZ(fc); idx++) {
            ...
            while (f_pl != NULL) {
                if ((f_pl->hw_index == pool_index) &&
                    (f_pl->pool_index == pool_num) &&
        ...
        switch (meter_pair_mode) {
            ...
            case BCM_FIELD_METER_MODE_FLOW: /* 1 */
                switch (stage_id) {
                    case _BCM_FIELD_STAGE_INGRESS:
                        f_pl->cfg.mode = bcmPolicerModeCommitted;
                        meter_offset   = mode_modifier ? 1: 0;
                        prate          = &f_pl->cfg.ckbits_sec;
                        pburst         = &f_pl->cfg.ckbits_burst;

                        mem_idx
                            = stage_fc->slices[f_pl->pool_index].start_tcam_idx
                                + (2 * f_pl->hw_index) + meter_offset;
                        _bcm_field_trx_meter_rate_burst_recover
                            (unit,
                             FP_METER_TABLEm,
                             mem_idx,
                             prate,
                    ...
                    case _BCM_FIELD_STAGE_EGRESS:
                        if (meter_conf.meter_update_even) {
                            f_pl->cfg.mode = bcmPolicerModePeak;
                            meter_offset = 0;
                            prate = &f_pl->cfg.pkbits_sec;
                            pburst = &f_pl->cfg.pkbits_burst;
        ...
        _FP_HASH_INSERT(fc->policer_hash,
                        f_pl,
        ...
        if (stage_id == _BCM_FIELD_STAGE_EGRESS) {
            ...
            _FP_METER_BMP_ADD(f_mp->meter_bmp, f_pl->pid);
            f_mp->free_meters--;
        }
                           ...
                           )
{
    ...
    switch (stage_fc->stage_id) {
        ...
        case _BCM_FIELD_STAGE_EXTERNAL:
            if (_field_tr3_ext_scache_sync_chk(unit, fc, stage_fc)) {
                soc_cm_debug(DK_ERR, "Configuration of scache size not supported   \
                                           for external stage\n"); 
                return(BCM_E_CONFIG);
            } 
    ...
    FP_VVERB(("FP(unit %d) vverb: _bcm_field_tr3_scache_sync() - Synching scache"
    ...
    for (slice_idx = 0; slice_idx < stage_fc->tcam_slices; slice_idx++) {
        FP_VVERB(("FP(unit %d) vverb: _bcm_field_tr3_scache_sync() - "
                 "Checking slice %d...\n", unit, slice_idx));
            ...
            if (soc_FP_GLOBAL_MASK_TCAMm_field32_get(unit,
                ...
                switch (tunnel_loopback_type) {
                    ...
                    case 0x7: /* TRILL_TUNNEL */
                        *loopback_type_sel = 1;
                        break;
                    case 0xb: /* MIM_LOOPBACK */
                    case 0xc: /* TRILL_NETWORK_PORT_LOOPBACK */
                    case 0xd: /* TRILL_ACCESS_PORT_LOOPBACK */
                        *loopback_type_sel = 0;
                        break;
                    default:
                        ;
                                                  ...
                                                  _field_stage_t   *stage_fc)
{
    ...
    for (logical_pool_idx = 0;
        ...
        if (isLogicalPoolModeSplit) {
            ...
            if ( logical_pool_idx % 2 == 0 ) {
                updateHigherMeter = FALSE;
                physicalSliceId = logical_pool_idx;
            } else {
                physicalSliceId = logical_pool_idx/2;
                updateHigherMeter = TRUE;
            }
                                    ...
                                    )
{
    ...
    int idx, slice_idx, vslice_idx;       /* Physical/Virtual slice index. */
    ...
    _field_meter_pool_t *f_logical_mp;          /* Meter pool descriptor. */
    uint8 dvp_type;                       /* Type of DVP qualified in entry */
    ...
    for (slice_idx = 0; slice_idx < stage_fc->tcam_slices; slice_idx++) {
        ...
        PBMP_ALL_ITER(unit, port) {
            ...
            if (intraslice) {
                ...
                READ_FP_DOUBLE_WIDE_SELECTr(unit, &dw_key_sel);
    ...
    for (slice_idx = 0; slice_idx < stage_fc->tcam_slices; slice_idx++) {
        ...
        /* If Level 2, retrieve the GIDs in this slice */
        if (fc->l2warm) {
            rv = _field_scache_slice_group_recover
                    (unit,
                     fc,
                     slice_idx,
                     &multigroup
    ...
    if (fc->l2warm)  {
        ...
        {
            FP_VVERB(("FP(unit %d) vverb: () Recovering Ingress Logical "
    ...
    if (soc_feature(unit, soc_feature_epc_linkflap_recover)) {
        if (recovered_ver_part0 >= BCM_WB_VERSION_1_6) {
                                    ...
                                    )
{
    ...
    rv = soc_mem_read(unit, policy_mem, MEM_BLOCK_ANY, entry_idx, 
                      ext_fp_policy_buf.entry_data);
    if (BCM_FAILURE(rv)) {
        soc_cm_debug(DK_ERR, "Error while reading policy entry\n");
        return(rv);
    }
        ...
        if (soc_mem_field32_get(unit,
            ...
            switch(p->esm_acl_action_control_fld) {
                ...
                case COUNTER_SET_ENABLEf:
                    /* Flex stat support for ESM is being implemented, and 
                       corresponding action recovery is to be added in later 
                       stage */
                    break;
                                 ...
                                 )
{
    ...
    if (fc->l2warm) {
        ...
        if (result != _FIELD_EXTFP_DATA_START) {
            ...
            soc_cm_debug(DK_ERR, "0:Start sequence NOT found in scache\n");
            rv = BCM_E_INTERNAL;
            fc->l2warm = 0;
            goto cleanup;
        }
        ...
        if(NULL != buf1) {
            ...
            if (result != _FIELD_EXTFP_DATA_START) {
                /* Start sequence not found */
                soc_cm_debug(DK_ERR, "1:Start sequence NOT found in scache\n");
                rv = BCM_E_INTERNAL;
                fc->l2warm = 0;
                goto cleanup;
            }
    ...
    for (slice_idx = 0; slice_idx < stage_fc->tcam_slices; ++slice_idx) {
        ...
        for (entry_cnt = entry_idx = 0;
            ...
            if (entry_cnt == 0) {
                ...
                if (fc->l2warm) {
                    ...
                    rv = _field_trx_scache_slice_group_recover(unit,
                                                               ...
                                                               0);
                    if (BCM_FAILURE(rv)) {
                        soc_cm_debug(DK_ERR, "Group recovery failed during    \
                                              level 2 warmboot\n");
                        fc->l2warm = 0;
                        goto cleanup;
                    }
                ...
                if (fg == NULL) {
                    soc_cm_debug(DK_ERR, "Error while allocating memory for   \
                                          field group\n");
                    return BCM_E_MEMORY;
                }
                ...
                if (fc->l2warm) {
                    ...
                    if ((rv = _field_group_id_generate(unit, &gid)) 
                                                              == BCM_E_NONE) {
                        ...
                        for (priority = -1, vmap = 0; 
                             ...
                             ++vmap) {
                            for (vslice = 0; 
                                 vslice < COUNTOF(stage_fc->vmap[0]); 
                                 ++vslice) {
            ...
            if (BCM_FAILURE(rv)) {
                soc_cm_debug(DK_ERR, "Error while reading tcam data entry\n");
                goto cleanup;
            }
            ...
            if (tcam_mask_mem != INVALIDm) {
                ...
                if (BCM_FAILURE(rv)) {
                    soc_cm_debug(DK_ERR, "Error while reading    \
                                          tcam mask entry\n");
                    goto cleanup;
                }
    ...
    if (fc->l2warm) {
        ...
        if (result != _FIELD_EXTFP_DATA_END) {
            ...
            soc_cm_debug(DK_ERR, "0:End sequence NOT found in scache\n");
            rv = BCM_E_INTERNAL;
            fc->l2warm = 0;
            goto cleanup;
        }
        if(NULL != buf1) {
            ...
            if (result != _FIELD_EXTFP_DATA_END) {
                /* End sequence not found */
                soc_cm_debug(DK_ERR, "1:End sequence NOT found in scache\n");
                rv = BCM_E_INTERNAL;
                fc->l2warm = 0;
                goto cleanup;
            }
