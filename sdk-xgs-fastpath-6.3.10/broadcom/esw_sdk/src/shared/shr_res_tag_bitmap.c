/*
 * $Id: shr_res_tag_bitmap.c,v 1.6 Broadcom SDK $
...
#define RES_MSG(string) "%s[%d]%s" string, __FILE__, __LINE__, FUNCTION_NAME()
#define RES_MSG1(string) "%s[%d]%s: " string, __FILE__, __LINE__, FUNCTION_NAME()
