...
#define BCM_L2_REPLACE_MATCH_STATIC         0x0001     /* Replace L2 static
                                                          entries. */
...
#define BCM_L2_REPLACE_MATCH_DEST           0x0008     /* Replace all L2 entries
                                                          ...
                                                          port/tgid */
#define BCM_L2_REPLACE_VPN_TYPE             0x0010     /* Replace all VPN type
                                                          L2 entry */
#define BCM_L2_REPLACE_VLAN_AND_VPN_TYPE    0x0020     /* Replace all VLAN and
                                                          VPN type L2 entry */
#define BCM_L2_REPLACE_DELETE               0x0100     /* L2 replace will
                                                          perform delete
                                                          operation instead of
                                                          replace on matching
                                                          entries */
#define BCM_L2_REPLACE_NEW_TRUNK            0x0200     /* New destination is a
                                                          trunk group */
#define BCM_L2_REPLACE_PENDING              0x0400     /* Replace L2 pending
                                                          entries. */
#define BCM_L2_REPLACE_NO_CALLBACKS         0x0800     /* Replace L2 entries
                                                          without callbacks. */
#define BCM_L2_REPLACE_LEARN_LIMIT          0x1000     /* Force ALL entries
