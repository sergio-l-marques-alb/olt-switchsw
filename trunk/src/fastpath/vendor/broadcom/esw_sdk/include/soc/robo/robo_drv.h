/*
 * $Id: robo_drv.h 1.2.2.1 Broadcom SDK $
 *
...
#define SOC_IS_ROBO5324(unit)   \
    ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
     (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5324))

#define SOC_IS_ROBO5324_A1(unit) \
    (SOC_ROBO_CONTROL(unit) == NULL ? 0: \
        ((SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5324) && \
        (SOC_ROBO_CONTROL(unit)->rev_id == SocRoboRevA) && \
        (SOC_ROBO_CONTROL(unit)->rev_num == 1)))

#define SOC_IS_ROBO5396(unit)   \
    ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
     (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5396))

#define SOC_IS_ROBO5389(unit)   \
    ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
     (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5389))


#define SOC_IS_ROBODINO(unit)   \
    ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
     ((SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5389) || \
     (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5396)))

#define SOC_IS_ROBO5398(unit)   \
    ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
     (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5398))

#define SOC_IS_ROBO5397(unit)   \
    ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
     (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5397))
     
#define SOC_IS_ROBO5348(unit)   \
        ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
         (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5348))
         
#define SOC_IS_ROBO5347(unit)   \
        ((SOC_ROBO_CONTROL(unit) == NULL) ? 0: \
         (SOC_ROBO_CONTROL(unit)->chip_type == SOC_ROBO_CHIP_5347))
...
#define SOC_IS_ROBO_GE_SWITCH(unit) (SOC_IS_ROBO_ARCH_GEX(unit) || \
