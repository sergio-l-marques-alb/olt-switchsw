 ...
 *
 * $Id: dispatch.h 1.465.2.35 Broadcom SDK $
...
typedef struct {
	...
	int (*cosq_pfc_config_get)(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_pfc_config_t *,int *);
	int (*cosq_pfc_config_set)(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_pfc_config_t,int *);
	...
	int (*dmux_dest_add)(int,bcm_port_t,_shr_module_t,bcm_port_t);
	...
	int (*field_qset_udf_get)(int,bcm_field_qset_t *,int,int *,int *);
	...
	int (*field_qualify_DstModid_get)(int,bcm_field_entry_t,bcm_module_t *,bcm_module_t *);
	...
	int (*field_qualify_DstPortTgid_get)(int,bcm_field_entry_t,bcm_port_t *,bcm_port_t *);
	...
	int (*field_qualify_L3IntfGroup_get)(int,bcm_field_entry_t,bcm_if_group_t *,bcm_if_group_t *);
	...
	int (*field_qualify_LookupClass0_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_PacketFormat_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_PortClass_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_SrcMacGroup_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_SrcModid_get)(int,bcm_field_entry_t,bcm_module_t *,bcm_module_t *);
	...
	int (*field_qualify_SrcPortTgid_get)(int,bcm_field_entry_t,bcm_port_t *,bcm_port_t *);
	...
	int (*field_qualify_UserDefined_get)(int,bcm_field_entry_t,bcm_field_udf_t,uint8 [BCM_FIELD_USER_FIELD_SIZE],uint8 [BCM_FIELD_USER_FIELD_SIZE]);
...
#endif	/* INCLUDE_L3 */
#ifdef	INCLUDE_PTP
	int (*ptp_acceptable_master_table_add)(int,bcm_ptp_stack_id_t,int,int,int,bcm_ptp_clock_peer_address_t *);
	int (*ptp_acceptable_master_table_clear)(int,bcm_ptp_stack_id_t,int,int);
	int (*ptp_acceptable_master_table_enabled_get)(int,bcm_ptp_stack_id_t,int,int,uint8 *);
	int (*ptp_acceptable_master_table_enabled_set)(int,bcm_ptp_stack_id_t,int,int,uint8);
	int (*ptp_acceptable_master_table_list)(int,bcm_ptp_stack_id_t,int,int,int *,bcm_ptp_clock_peer_address_t *);
	int (*ptp_acceptable_master_table_remove)(int,bcm_ptp_stack_id_t,int,int,bcm_ptp_clock_peer_address_t *);
	...
	int (*ptp_unicast_master_table_add)(int,bcm_ptp_stack_id_t,int,int,bcm_ptp_clock_unicast_master_t *);
	int (*ptp_unicast_master_table_clear)(int,bcm_ptp_stack_id_t,int,int);
	int (*ptp_unicast_master_table_list)(int,bcm_ptp_stack_id_t,int,int,int *,bcm_ptp_clock_peer_address_t *);
	int (*ptp_unicast_master_table_remove)(int,bcm_ptp_stack_id_t,int,int,bcm_ptp_clock_peer_address_t *);
	int (*ptp_unicast_master_table_size_get)(int,bcm_ptp_stack_id_t,int,int,int *);
	int (*ptp_unicast_slave_add)(int,bcm_ptp_stack_id_t,int,int,bcm_ptp_clock_peer_t *);
	int (*ptp_unicast_slave_clear)(int,bcm_ptp_stack_id_t,int,int);
	int (*ptp_unicast_slave_list)(int,bcm_ptp_stack_id_t,int,int,int *,bcm_ptp_clock_peer_t *);
	int (*ptp_unicast_slave_remove)(int,bcm_ptp_stack_id_t,int,int,bcm_ptp_clock_peer_t *);
#endif	/* INCLUDE_PTP */
	int (*qos_detach)(int);
	int (*qos_init)(int);
	...
	int (*trill_init)(int);
	int (*trill_multicast_add)(int,uint32,bcm_trill_name_t,bcm_vlan_t,bcm_mac_t,bcm_multicast_t);
	int (*trill_multicast_delete)(int,uint32,bcm_trill_name_t,bcm_vlan_t,bcm_mac_t,bcm_multicast_t);
	int (*trill_multicast_delete_all)(int,bcm_trill_name_t);
	int (*trill_multicast_source_add)(int,bcm_trill_name_t,bcm_trill_name_t,bcm_gport_t);
	int (*trill_multicast_source_delete)(int,bcm_trill_name_t,bcm_trill_name_t,bcm_gport_t);
	...
	int (*trill_multicast_traverse)(int,bcm_trill_multicast_traverse_cb,void *);
	...
	int (*trunk_member_get)(int,bcm_trunk_t,int,bcm_trunk_member_t *,int *);
	int (*trunk_member_set)(int,bcm_trunk_t,int,bcm_trunk_member_t *);
	/* bcm_trunk_member_t_init not dispatchable */
	int (*trunk_member_traverse)(int,bcm_trunk_t,bcm_trunk_member_traverse_cb,void *);
