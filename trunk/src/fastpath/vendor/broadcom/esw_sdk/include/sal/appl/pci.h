/*
 * $Id: pci.h 1.16.218.1 Broadcom SDK $
...
extern int pci_dma_putw(pci_dev_t *, sal_vaddr_t addr, uint32 data);
extern int pci_dma_puth(pci_dev_t *, sal_vaddr_t addr, uint16 data);
extern int pci_dma_putb(pci_dev_t *, sal_vaddr_t addr, uint8 data);

extern uint32 pci_dma_getw(pci_dev_t *, sal_vaddr_t addr);
extern uint16 pci_dma_geth(pci_dev_t *, sal_vaddr_t addr);
extern uint8 pci_dma_getb(pci_dev_t *, sal_vaddr_t addr);
