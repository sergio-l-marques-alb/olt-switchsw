/* $Id: field.c 1.22.4.7 Broadcom SDK $
...
_field_trident_ingress_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    _FP_QUAL_EXT_ADD(unit, stage_fc, bcmFieldQualifyDstModid,
                     ...
                     0, f3_offset + 7, 8, f3_offset + 16, 3, 0, 0, 0);
    ...
    _FP_QUAL_EXT_ADD(unit, stage_fc, bcmFieldQualifySrcModid,
                     _bcmFieldDevSelDisable, 0,
                     _bcmFieldSliceSelFpf3, 2,
                     _bcmFieldSliceSrcEntitySelect, _bcmFieldFwdEntityGlp,
                     0, f3_offset + 26, 8, f3_offset + 35, 1, 0, 0, 0);
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyPacketFormat,
                 _bcmFieldSliceSelFpf3, 3, f3_offset + 16, 4);
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyLookupStatus,
                 _bcmFieldSliceSelFpf3, 6, f3_offset, 16);
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyPacketFormat,
                 _bcmFieldSliceSelFpf3, 8, f3_offset + 20, 4);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyTranslatedVlanFormat,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyDstModid,
                 _bcmFieldSliceSelFpf3, 10, f3_offset + 26, 8);
    ...
    _FP_QUAL_EXT_ADD(unit, stage_fc, bcmFieldQualifyDstModid,
                     ...
                     _bcmFieldSliceSelFpf1, 1,
                     _bcmFieldSliceDstFwdEntitySelect, _bcmFieldFwdEntityGlp,
                     0, f1_offset + 7, 8, f1_offset + 16, 3, 0, 0, 0);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifyDstTrunk,
                               _bcmFieldSliceSelFpf1, 1,
                               _bcmFieldSliceDstFwdEntitySelect,
                               _bcmFieldFwdEntityGlp, f1_offset, 19);
    ...
    _FP_QUAL_EXT_ADD(unit, stage_fc, bcmFieldQualifySrcModid,
                     ...
                     _bcmFieldSliceSelFpf1, 1,
                     _bcmFieldSliceSrcEntitySelect, _bcmFieldFwdEntityGlp,
                     0, f1_offset + 26, 8, f1_offset + 35, 1, 0, 0, 0);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifySrcTrunk,
                               _bcmFieldSliceSelFpf1, 1,
                               _bcmFieldSliceSrcEntitySelect,
                               _bcmFieldFwdEntityGlp, f1_offset + 19, 17);
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyLookupStatus,
                 _bcmFieldSliceSelFpf1, 5, f1_offset, 16);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyMplsTerminated,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyPacketFormat,
                 _bcmFieldSliceSelFpf1, 6, f1_offset + 16, 4);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyTranslatedVlanFormat,
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyDstModid,
                 _bcmFieldSliceSelFpf1, 10, f1_offset + 26, 8);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyDstTrunk,
                 _bcmFieldSliceSelFpf1, 10, f1_offset + 19, 16);
                          ...
                          int idx, uint64 *packet_count, uint64 *byte_count)
{
    ...
    if (NULL != mem_x_buf) {
        ...
        rv = _bcm_field_td_counter_read(unit, memacc_byte_x, memacc_pkt_x,
                                        mem_x_buf,
                                        cntrs32_buf, cntrs64_buf,
                                        packet_count, byte_count);
    }
    ...
    if (NULL != mem_y_buf) {
        ...
        rv = _bcm_field_td_counter_read(unit, memacc_byte_y, memacc_pkt_y,
                                        mem_y_buf,
                                        cntrs32_buf, cntrs64_buf,
                                        packet_count, byte_count);
    }
...
_field_trident_functions_init(_field_funct_t *functions)
{
    ...
    functions->fp_udf_write            = _bcm_field_trx2_udf_write;
    functions->fp_udf_delete           = _bcm_field_trx2_udf_delete;
    functions->fp_udf_read             = _bcm_field_trx2_udf_read;
