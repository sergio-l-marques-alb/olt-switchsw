/*
 * $Id: servo.c 1.1.2.5 Broadcom SDK $
 * 
...
/*
 * Function:
 *      _bcm_ptp_servo_configuration_get
 * Purpose:
...
{   
     ...
     */
    i = 6;    
    config->osc_type = (_bcm_ptp_osc_type_t)_bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32); 
    config->transport_mode = (_bcm_ptp_transport_mode_t)_bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32);
    config->ptp_phase_mode = _bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32);
    config->freq_corr_hourly = _bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32);   
    config->hourly_corr_time.seconds = _bcm_ptp_uint64_read(resp+i);
    i += sizeof(uint64);   
    config->hourly_corr_time.nanoseconds = _bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32);  
    config->freq_calib_factory = _bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32);   
    config->factory_calib_time.seconds = _bcm_ptp_uint64_read(resp+i);
    i += sizeof(uint64);   
    config->factory_calib_time.nanoseconds = _bcm_ptp_uint32_read(resp+i);
    i += sizeof(uint32);   
...
/*
 * Function:
 *      _bcm_ptp_servo_configuration_set
 * Purpose:
...
{   
    ...
    i += sizeof(uint32);
    _bcm_ptp_uint32_write(payload+i, config.freq_corr_hourly);
    i += sizeof(uint32);
    _bcm_ptp_uint64_write(payload+i, config.hourly_corr_time.seconds);
    i += sizeof(uint64);
    _bcm_ptp_uint32_write(payload+i, config.hourly_corr_time.nanoseconds);
    i += sizeof(uint32);
    _bcm_ptp_uint32_write(payload+i, config.freq_calib_factory);
    i += sizeof(uint32);
    _bcm_ptp_uint64_write(payload+i, config.factory_calib_time.seconds);
    i += sizeof(uint64);
    _bcm_ptp_uint32_write(payload+i, config.factory_calib_time.nanoseconds);
    i += sizeof(uint32);
...
{   
     ...
     */
    i = 6;
    perf->status.fll_state = (_bcm_ptp_fll_state_t)resp[i++];
...
{   
     ...
     */
    i = 6;
    status->fll_state = (_bcm_ptp_fll_state_t)resp[i++];
