/*
 * $Id: xgxs16g.c 1.66.2.10 Broadcom SDK $
...
STATIC int
_phy_xgxs16g_tx_driver_field_get(soc_phy_control_t type,int *ln_ctrl,uint16 *mask,
                                    int *shfter)
{
    int lane_ctrl;
    ...
    *shfter = 0;
    ...
    case SOC_PHY_CONTROL_PREEMPHASIS:
         *shfter = TX_ALL_TX_DRIVER_PREEMPHASIS_SHIFT;
    ...
    case SOC_PHY_CONTROL_DRIVER_CURRENT:
         *shfter = TX_ALL_TX_DRIVER_IDRIVER_SHIFT;
                                ...
                                soc_phy_control_t type, uint32 value)
{
    ...
    SOC_IF_ERROR_RETURN
        (_phy_xgxs16g_tx_driver_field_get(type,&lane_ctrl,&mask,&shifter));
                                          ...
                                          uint32 value)
{
	...
	*/
        ...
        /* Force VCO to 6.25G x25 for 3p75G: 0x8308=0x7220 */
        SOC_IF_ERROR_RETURN
            (WRITE_XGXS16G_SERDESDIGITAL_MISC1r(unit, pc, 0x7220));
