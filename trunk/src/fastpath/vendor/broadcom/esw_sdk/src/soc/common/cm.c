/*
 * $Id: cm.c 1.186.2.22 Broadcom SDK $
...
uint32 soc_debug_level;
char *soc_debug_names[] = {SOC_DBG_NAMES};
...
static soc_cm_device_info_t soc_device_info[] = {
    ...
    {   /* Hercules with 8 ports */
        BCM5670_DEVICE_ID, BCM5670_A0_REV_ID,
        "BCM5670_A0",
        0, 0,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5670_DEVICE_ID, BCM5670_A1_REV_ID,
        "BCM5670_A1",
        BCM5670_DEVICE_ID, BCM5670_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Hercules with 4 ports bonded out, same package */
        BCM5671_DEVICE_ID, BCM5671_A0_REV_ID,
        "BCM5671_A0",
        BCM5670_DEVICE_ID, BCM5670_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5671_DEVICE_ID, BCM5671_A1_REV_ID,
        "BCM5671_A1",
        BCM5670_DEVICE_ID, BCM5670_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Hercules with 4 ports and reduced package (Maxxus) */
        BCM5671_DEVICE_ID, BCM5671_A2_REV_ID,
        "BCM5671_A2",
        BCM5670_DEVICE_ID, BCM5670_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    ...
    {   /* Lynx */
        BCM5673_DEVICE_ID, BCM5673_A0_REV_ID,
        "BCM5673_A0",
        0, 0,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5673_DEVICE_ID, BCM5673_A1_REV_ID,
        "BCM5673_A1",
        BCM5673_DEVICE_ID, BCM5673_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5673_DEVICE_ID, BCM5673_A2_REV_ID,
        "BCM5673_A2",
        BCM5673_DEVICE_ID, BCM5673_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5674_DEVICE_ID, BCM5674_A0_REV_ID,
        "BCM5674_A0",
        0, 0,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    ...
    {   /* Draco */
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        "BCM5690_A0",
        0, 0,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5690_DEVICE_ID, BCM5690_A1_REV_ID,
        "BCM5690_A1",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5690_DEVICE_ID, BCM5690_A2_REV_ID,
        "BCM5690_A2",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco without HG (Medusa) */
        BCM5691_DEVICE_ID, BCM5691_A0_REV_ID,
        "BCM5691_A0",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5691_DEVICE_ID, BCM5691_A1_REV_ID,
        "BCM5691_A1",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5691_DEVICE_ID, BCM5691_A2_REV_ID,
        "BCM5691_A2",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco without L3 */
        BCM5692_DEVICE_ID, BCM5692_A0_REV_ID,
        "BCM5692_A0",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5692_DEVICE_ID, BCM5692_A1_REV_ID,
        "BCM5692_A1",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5692_DEVICE_ID, BCM5692_A2_REV_ID,
        "BCM5692_A2",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco without HG or L3 */
        BCM5693_DEVICE_ID, BCM5693_A0_REV_ID,
        "BCM5693_A0",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5693_DEVICE_ID, BCM5693_A1_REV_ID,
        "BCM5693_A1",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5693_DEVICE_ID, BCM5693_A2_REV_ID,
        "BCM5693_A2",
        BCM5690_DEVICE_ID, BCM5690_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco 1.5 */
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        "BCM5695_A0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5695_DEVICE_ID, BCM5695_A1_REV_ID,
        "BCM5695_A1",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5695_DEVICE_ID, BCM5695_B0_REV_ID,
        "BCM5695_B0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco 1.5 without HG */
        BCM5696_DEVICE_ID, BCM5696_A0_REV_ID,
        "BCM5696_A0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5696_DEVICE_ID, BCM5696_A1_REV_ID,
        "BCM5696_A1",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5696_DEVICE_ID, BCM5696_B0_REV_ID,
        "BCM5696_B0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco 1.5 without L3 */
        BCM5697_DEVICE_ID, BCM5697_A0_REV_ID,
        "BCM5697_A0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5697_DEVICE_ID, BCM5697_A1_REV_ID,
        "BCM5697_A1",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5697_DEVICE_ID, BCM5697_B0_REV_ID,
        "BCM5697_B0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Draco 1.5 without HG or L3 */
        BCM5698_DEVICE_ID, BCM5698_A0_REV_ID,
        "BCM5698_A0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5698_DEVICE_ID, BCM5698_A1_REV_ID,
        "BCM5698_A1",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM5698_DEVICE_ID, BCM5698_B0_REV_ID,
        "BCM5698_B0",
        BCM5695_DEVICE_ID, BCM5695_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    ...
    /* For BCM566x parts, please see important notes in <soc/devid.h> */
    {   /* Tucana (48+4+1), Tucana24 (24+4+1) */
        BCM5665_DEVICE_ID, BCM5665_A0_REV_ID,
        "BCM5665_A0",
        0, 0,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Tucana (48+4+1), Tucana24 (24+4+1) */
        BCM5665_DEVICE_ID, BCM5665_B0_REV_ID,
        "BCM5665_B0",
        0, 0,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Titanium48 (48+4) */
        BCM5655_DEVICE_ID, BCM5655_A0_REV_ID,
        "BCM5655_A0",
        BCM5665_DEVICE_ID, BCM5665_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Titanium48 (48+4) */
        BCM5655_DEVICE_ID, BCM5655_B0_REV_ID,
        "BCM5655_B0",
        BCM5665_DEVICE_ID, BCM5665_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Titanium-II (24+4) */
        BCM5650_DEVICE_ID, BCM5650_A0_REV_ID,
        "BCM5650_A0",
        BCM5665_DEVICE_ID, BCM5665_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Titanium-II (24+4) */
        BCM5650_DEVICE_ID, BCM5650_B0_REV_ID,
        "BCM5650_B0",
        BCM5665_DEVICE_ID, BCM5665_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* Magnum (24+4) */
        BCM5650_DEVICE_ID, BCM5650_C0_REV_ID,
        "BCM5650_C0",
        BCM5650_DEVICE_ID, BCM5650_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    ...
    {   /* EasyRider 12G High Functionality */
        BCM56600_DEVICE_ID, BCM56600_A0_REV_ID,
        "BCM56600_A0",
        BCM56601_DEVICE_ID, BCM56601_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G High Functionality */
        BCM56600_DEVICE_ID, BCM56600_B0_REV_ID,
        "BCM56600_B0",
        BCM56601_DEVICE_ID, BCM56601_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G High Functionality */
        BCM56600_DEVICE_ID, BCM56600_C0_REV_ID,
        "BCM56600_C0",
        BCM56601_DEVICE_ID, BCM56601_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G+HG High Functionality */
        BCM56601_DEVICE_ID, BCM56601_A0_REV_ID,
        "BCM56601_A0",
        BCM56601_DEVICE_ID, BCM56601_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    {   /* EasyRider 10G+HG High Functionality */
        BCM56602_DEVICE_ID, BCM56602_A0_REV_ID,
        "BCM56602_A0",
        BCM56602_DEVICE_ID, BCM56602_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 10G+HG High Functionality */
        BCM56602_DEVICE_ID, BCM56602_B0_REV_ID,
        "BCM56602_B0",
        BCM56602_DEVICE_ID, BCM56602_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 10G+HG High Functionality */
        BCM56602_DEVICE_ID, BCM56602_C0_REV_ID,
        "BCM56602_C0",
        BCM56602_DEVICE_ID, BCM56602_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G+HG High Functionality */
        BCM56603_DEVICE_ID, BCM56603_A0_REV_ID,
        "BCM56603_A0",
        BCM56601_DEVICE_ID, BCM56601_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G+HG High Functionality */
        BCM56603_DEVICE_ID, BCM56603_B0_REV_ID,
        "BCM56603_B0",
        BCM56601_DEVICE_ID, BCM56601_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider HG+HG High Functionality */
        BCM56603_DEVICE_ID, BCM56603_C0_REV_ID,
        "BCM56603_C0",
        BCM56602_DEVICE_ID, BCM56602_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G Low Functionality */
        BCM56605_DEVICE_ID, BCM56605_A0_REV_ID,
        "BCM56605_A0",
        BCM56601_DEVICE_ID, BCM56601_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G Low Functionality */
        BCM56605_DEVICE_ID, BCM56605_B0_REV_ID,
        "BCM56605_B0",
        BCM56601_DEVICE_ID, BCM56601_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G Low Functionality */
        BCM56605_DEVICE_ID, BCM56605_C0_REV_ID,
        "BCM56605_C0",
        BCM56601_DEVICE_ID, BCM56601_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G+HG Low Functionality */
        BCM56606_DEVICE_ID, BCM56606_A0_REV_ID,
        "BCM56606_A0",
        BCM56601_DEVICE_ID, BCM56601_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G+HG Low Functionality */
        BCM56606_DEVICE_ID, BCM56606_B0_REV_ID,
        "BCM56606_B0",
        BCM56601_DEVICE_ID, BCM56601_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 12G+HG Low Functionality */
        BCM56606_DEVICE_ID, BCM56606_C0_REV_ID,
        "BCM56606_C0",
        BCM56601_DEVICE_ID, BCM56601_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 10G+HG Low Functionality */
        BCM56607_DEVICE_ID, BCM56607_A0_REV_ID,
        "BCM56607_A0",
        BCM56602_DEVICE_ID, BCM56602_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 10G+HG Low Functionality */
        BCM56607_DEVICE_ID, BCM56607_B0_REV_ID,
        "BCM56607_B0",
        BCM56602_DEVICE_ID, BCM56602_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider 10G+HG Low Functionality */
        BCM56607_DEVICE_ID, BCM56607_C0_REV_ID,
        "BCM56607_C0",
        BCM56602_DEVICE_ID, BCM56602_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider HG+HG High Functionality */
        BCM56608_DEVICE_ID, BCM56608_A0_REV_ID,
        "BCM56608_A0",
        BCM56602_DEVICE_ID, BCM56602_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider HG+HG High Functionality */
        BCM56608_DEVICE_ID, BCM56608_B0_REV_ID,
        "BCM56608_B0",
        BCM56602_DEVICE_ID, BCM56602_B0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {   /* EasyRider HG+HG High Functionality */
        BCM56608_DEVICE_ID, BCM56608_C0_REV_ID,
        "BCM56608_C0",
        BCM56602_DEVICE_ID, BCM56602_C0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
...
# if defined(BCM_RAVEN_SUPPORT)
    ...
    {   /* Katana */
        BCM56444_DEVICE_ID, BCM56444_A0_REV_ID,
        "BCM56444_A0",
        BCM56440_DEVICE_ID, BCM56440_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
...
#if defined(BCM_ROBO_SUPPORT) || defined(BCM_EA_SUPPORT)
...
{
    return CMVEC(dev).salloc(&CMDEV(dev).dev, size, name);
}
...
soc_cm_spi_read(int dev, uint32 addr, uint8 *buf, int len)
{
    if (CMVEC(dev).spi_read) {
        CMVEC(dev).spi_read(&CMDEV(dev).dev, addr, buf, len);
    }
...
soc_cm_spi_write(int dev, uint32 addr, uint8 *buf, int len)
{
    if (CMVEC(dev).spi_write) {
        CMVEC(dev).spi_write(&CMDEV(dev).dev, addr, buf, len);
    }
