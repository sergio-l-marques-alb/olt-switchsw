...
* @end
*********************************************************************/
L7_RC_t dot3adIntfCreate(L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t dot3adIntfAttach(L7_uint32 intIfNum);

/*********************************************************************
* @purpose  Prepare the interface state machines for lag operation
*
* @param    intIfNum  @b{(input)}   internal intf of the lag
*
* @returns  L7_SUCCESS
*
* @notes    The interface needs to be L7_UP and admin enabled
*
* @end
*********************************************************************/
L7_RC_t dot3adIntfProcessIntfUp(L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t dot3adIntfProcessIntfDown(L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t dot3adIntfReconcile(L7_uint32 intIfNum);
...
/*********************************************************************
* @purpose  Process the notification of completion of config application 
*
* @param    event   @b{(input)}   internal intf of the lag
*
* @returns  L7_SUCCESS
*
* @notes  Notify the configurator that hardware updates are done. 
*
* @end
*********************************************************************/
L7_RC_t dot3adConfigCompleteCallback(L7_uint32 event);
