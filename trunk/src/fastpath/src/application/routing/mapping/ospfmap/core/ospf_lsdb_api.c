...
* @end
*********************************************************************/
L7_RC_t ospfMapLsdbSequenceGet ( L7_uint32 AreaId, L7_uint32 intIfNum, 
                                 L7_int32 Type,
                                 L7_uint32 Lsid, L7_uint32 RouterId,
                                 L7_uint32 *val )
{
  if (ospfMapOspfInitialized() == L7_TRUE) 
    return ospfMapExtenLsdbSequenceGet(AreaId, intIfNum, Type, Lsid, RouterId, val);
...
* @end
*********************************************************************/
L7_uint32 ospfMapAreaLSADbLSAAgeGet(L7_uint32 areaId, L7_uint32 intIfNum, L7_int32 Type, 
                                    L7_uint32 Lsid, L7_uint32 RouterId, 
                                    L7_uint32 *val)
{
  if(ospfMapOspfInitialized() != L7_TRUE)
  ...
  return ospfMapExtenAreaLSADbLSAAgeGet(areaId, intIfNum, Type, Lsid, RouterId, val);
}
...
* @end
*********************************************************************/
L7_uint32 ospfMapAreaLSADbLSAOptionsGet(L7_uint32 areaId, L7_uint32 intIfNum, L7_int32 Type, 
                                        L7_uint32 Lsid, L7_uint32 RouterId,
                                        L7_uchar8 *val)
{
  if(ospfMapOspfInitialized() != L7_TRUE)
  ...
  return ospfMapExtenAreaLSADbLSAOptionsGet(areaId, intIfNum, Type, Lsid, RouterId, val);
}
...
* @end
*********************************************************************/
L7_uint32 ospfMapAreaLSADbLSACksumGet(L7_uint32 areaId, L7_uint32 intIfNum, 
                                      L7_int32 Type, 
                                      L7_uint32 Lsid, L7_uint32 RouterId, 
                                      L7_uint32 *val)
{
  ...
  return ospfMapExtenAreaLSADbLSACksumGet(areaId, intIfNum, Type, Lsid, RouterId, val);
}
...
* @end
*********************************************************************/
L7_uint32 ospfMapAreaLSADbLSAAdvertiseGet(L7_uint32 areaId, L7_uint32 intIfNum,
                                          L7_int32 Type, 
                                          L7_uint32 Lsid, L7_uint32 RouterId,
                                          L7_char8 **buf, L7_uint32 *buf_len)
{
  ...
  return ospfMapExtenAreaLSADbLSAAdvertiseGet(areaId, intIfNum, Type, Lsid, 
