...
typedef enum e_S_LScodes
{
   ...
   S_ASBR_SUMMARY_LSA  ,
   S_AS_EXTERNAL_LSA   ,
   S_GROUP_MEMBER_LSA  ,        /* MOSPF not supported */
   S_NSSA_LSA          ,  
   S_TMP2_LSA          ,
   S_LINK_OPAQUE_LSA   ,
   S_AREA_OPAQUE_LSA   ,
...
/* Opaque LSA types as defined by RFC 5250 */
typedef enum
{
  OPAQUE_LSA_TYPE_TE = 1,
  OPAQUE_LSA_TYPE_OPTICAL = 2,
  OPAQUE_LSA_TYPE_GRACE = 3,
  OPAQUE_LSA_TYPE_RTR_INFO = 4
} e_OpaqueType;
