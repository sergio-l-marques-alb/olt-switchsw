...
#else
#define CLISYNTAX_BOOT      "Use 'boot system [unit] <active | backup>' "
#define CLISYNTAX_DELETE    "\r\nIncorrect input! Use 'delete [unit] <active | backup>' "
#endif
...
#else
#define CLISYNTAX_BOOT      "Use 'boot system <active | backup>' "
#define CLISYNTAX_DELETE    "\r\nIncorrect input! Use 'delete <active | backup>' "
#endif
...
void buildTreeGlobalLoadBalanceMaintenanceMode(EwsCliCommandP depth2);
...
extern const L7_char8 *cliMailServerMode(EwsContext ewsContext,
                              L7_uint32 argc,
                              const L7_char8 * * argv,
                              L7_uint32 index);

extern const L7_char8 *cliMailServerPrompt(L7_uint32 depth,
                                L7_char8 * tmpPrompt,
...
const L7_char8 *commandGlobalCpuMemoryThreshold(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index);
...
const L7_char8 *commandIpIgmpSnoopingRouterAlert(EwsContext ewsContext, L7_uint32 argc,const L7_char8 **argv, L7_uint32 index);
...
const L7_char8 *commandLoggingEmailAlert(EwsContext ewsContext, L7_uint32 argc,    const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertToAddr(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertSubject(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertFromAddr(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertSMTPServer(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertSMTPServerPort(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertSMTPServerSecurity(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertusername(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertpassword(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertTest(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertLogDuration(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertUrgentSeverity(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
const L7_char8 *commandLoggingEmailAlertTrapSeverity(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index);
...
/******Command functions for IP Address Conflict Detect - Start **************/
...
/******Command functions for IP Address Conflict Detect - End ****************/
...
/*************************Device-Location*****************************************************/
const L7_char8 *cliDevLocBldngMode(EwsContext ewsContext, L7_uint32 argc,
                                   const L7_char8 * * argv, L7_uint32 index);
...
const L7_char8 *cliIntAuthServUserConfigMode(EwsContext ewsContext, L7_uint32 argc,
                                     const L7_char8 * * argv, L7_uint32 index);
...
const L7_char8 *commandReleaseDhcp(EwsContext ewsContext, L7_uint32 argc,
                                   const L7_char8 * * argv, L7_uint32 index);
#endif /* L7_ROUTING_PACKAGE */

void buildTreePrivSWMgmtDhcpConfRenew(EwsCliCommandP depth1);
const L7_char8 *commandRenewDhcp(EwsContext ewsContext, L7_uint32 argc,
                                 const L7_char8 * * argv, L7_uint32 index);
#endif
