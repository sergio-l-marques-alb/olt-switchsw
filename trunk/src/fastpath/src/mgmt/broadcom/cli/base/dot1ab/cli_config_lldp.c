  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      else if (rc != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWrite (ewsContext, CLISYNTAX_LLDP_TRANSMIT);
      }
    }
  }
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      else if (rc != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWrite (ewsContext, CLISYNTAX_LLDP_RECEIVE);
      }
    }
  }
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      else if (rc != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWrite (ewsContext, CLISYNTAX_LLDP_TXMGMT);
      }
    }
  }
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      else if (rc != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWrite (ewsContext, CLISYNTAX_LLDP_NOTIFICATION);
      }
    }
  }
  ...
  for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
  {
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
        ...
        L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_base_LldpIntfRange);
        continue;
      }
    }
    for (i = 1; i <= numArg; i++)
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
          ...
          sysCap) != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWrite (ewsContext, "Error setting LLDP Interface TLV");
      }
    }
  }
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      if (usmDbLldpXMedPortAdminModeSet(interface, mode) != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_base_LLDPMEDModeIntIf);
      }
    }
  }
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      if(usmDbLldpXMedPortConfigNotifEnableSet(interface, mode) != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_base_LLDPMEDNotifyIntIf);
      }
    }
  }
    ...
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      if (usmDbLldpXMedPortConfigTLVsEnabledGet(interface, &medCap) == L7_SUCCESS)
      {
        ...
        if (usmDbLldpXMedPortConfigTLVsEnabledSet(interface, &medCap) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrInfo_base_TLVsTransmittedLLDPPDU);
        }
      }
    }
  }
