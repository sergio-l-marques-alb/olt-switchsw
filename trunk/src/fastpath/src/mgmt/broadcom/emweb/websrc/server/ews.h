...
#define EWSTIMERANGENAME(context)   (context)->promptcontext.timeRange_context.strTimeRangeName
...
#define EWSINTFMASK(context)   (context)->promptcontext.if_context.ifMask
#define EWSINTFTYPEMASK(context)   (context)->promptcontext.if_context.ifTypeMask
...
#define EWSMAILSERVERHOST(context) (context)->promptcontext.mailserver_context.mailServerAddr
...
#define EWSWDSAPGRPID(context)   (context)->promptcontext.wirelessWdsApGroupConfig_context.groupId
#define EWSDEVLOCBLDNG(context)  (context)->promptcontext.wirelessDevLocBldngConfig_context.bldngNum
#define EWSDEVLOCBLDNGID(context)  (context)->promptcontext.wirelessDevLocFlrConfig_context.bldngNum
#define EWSDEVLOCFLR(context)  (context)->promptcontext.wirelessDevLocFlrConfig_context.flrNum
...
#define EWSDOT1XAUTHSERVUSERIDX(context)  (context)->promptcontext.dot1xAuthServUserConfig_context.userIdx
...
#   endif /* EW_CONFIG_OPTION_DYNAMIC_ETAG */
  ...
  L7_ShowRunningSaveFileFlag_t showRunningSaveFileFlag;
  ...
  union
  {
    ...
    ews_vlanContext_t               vlan_context;
    ...
    ews_mailServerContext_t		  mailserver_context;
    ...
    ews_wirelessWdsApGroupConfigContext_t     wirelessWdsApGroupConfig_context;
    ews_wirelessDevLocBldngConfigContext_t     wirelessDevLocBldngConfig_context;
    ews_wirelessDevLocFlrConfigContext_t     wirelessDevLocFlrConfig_context;
    ...
    ews_dot1xAuthServUserConfigContext_t     dot1xAuthServUserConfig_context;
    ews_timeRangeContext_t          timeRange_context;
  }promptcontext;    
