...
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityTacacsWeb_TacacsGlobalKey (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibStr256_t));
  xLibStr256_t objTacacsGlobalKeyValue;
  FPOBJ_TRACE_ENTER (bufp);

  memset(objTacacsGlobalKeyValue, 0, sizeof(objTacacsGlobalKeyValue));

  /* set the value in application */
  owa.l7rc = usmDbTacacsGblKeyGet ( objTacacsGlobalKeyValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) &objTacacsGlobalKeyValue,
                           sizeof (objTacacsGlobalKeyValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
...
xLibRC_t fpObjGet_securityTacacsWeb_TacacsKey (void *wap, void *bufp)
{
  ...
  memset(objTacacsKeyValue,0, sizeof(objTacacsKeyValue));
