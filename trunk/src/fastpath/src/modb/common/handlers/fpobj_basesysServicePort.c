...
/*******************************************************************************
* @function fpObjGet_basesysServicePort_sysServicePortLinkStatus
*
* @purpose Get 'sysServicePortLinkStatus'
*
* @description The Service Port Link Status 
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_basesysServicePort_sysServicePortLinkStatus (void *wap,
                                                             void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objsysServicePortLinkStatus;
  FPOBJ_TRACE_ENTER (bufp);

  /* get the value from application */
  objsysServicePortLinkStatus =  usmDbServicePortLinkStatusGet (L7_UNIT_CURRENT);

  FPOBJ_TRACE_VALUE (bufp, &objsysServicePortLinkStatus,
                     sizeof (objsysServicePortLinkStatus));

  /* return the object value: objsysServicePortLinkStatus */
  owa.rc =
    xLibBufDataSet (bufp, (xLibU8_t *) & objsysServicePortLinkStatus,
                    sizeof (objsysServicePortLinkStatus));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjSet_basesysServicePort_renewDHCP
*
* @purpose Set to 'renewDHCP'
*
* @description [renewDHCP]: To renew IP Address learned through DHCP.
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_basesysServicePort_renewDHCP(void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objIfval;
  FPOBJ_TRACE_ENTER (bufp);
  
  owa.rc = xLibBufDataGet (bufp, (xLibU8_t *) & objIfval, &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
