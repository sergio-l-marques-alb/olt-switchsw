...
/* Dev location MAP status*/
typedef struct wdmManagedAPOnDemandLocStatus_s
{
  L7_uint32 msgInvocationNum;
  L7_WDM_MANAGED_AP_ONDEMAND_LOC_STATUS_t locStatus;  
  L7_int32 signal;
  L7_uint8 detectedBand;
  devLocCoord_t location;
}wdmManagedAPOnDemandLocStatus_t;
...
/*********************************************************************
*
* @purpose  Get the last configuration status of managed AP.
*
* @param    L7_enetMacAddr_t       macAddr     @b{(input)} AP mac address
* @param    L7_uchar8             *apLastCfg   @b{(output)} pointer to status
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPLastCfgStatusGet (L7_enetMacAddr_t macAddr,
                            L7_uchar8 *apLastCfg);
...
/*********************************************************************
*
* @purpose  Get the mac address for radio of an AP.
*
* @param    L7_enetMacAddr_t macAddr       @b{(input)} AP mac address
* @param    L7_uchar8        radioIf       @b{(input)} radio interface
* @param    L7_enetMacAddr_t *radioMacAddr @b{(output)} pointer to radio mac
...
*
*********************************************************************/
L7_RC_t wdmAPRadioMacAddrGet(L7_enetMacAddr_t macAddr,
                                    L7_uchar8 radioIf, L7_enetMacAddr_t *radioMacAddr);
...
*
*********************************************************************/
L7_RC_t wdmManagedAPRadioMCSIndexGet(L7_enetMacAddr_t macAddr,
                                     L7_uchar8 radioIf,
                                     mcs_idx_t idx);
...
*********************************************************************/
L7_RC_t 
wdmManagedAPRadioMCSIndexGetNext(L7_enetMacAddr_t macAddr,
                                 L7_uchar8 radioIf,
                                 mcs_idx_t idx,
                                 mcs_idx_t *pIdx);
...
*
*********************************************************************/
L7_RC_t wdmManagedAPOnDemandLocStatusGet(L7_enetMacAddr_t macAddr,
                                   L7_uint32 *status);

/*********************************************************************
*
* @purpose  Set the On-Demand-Loction Status for managed AP.
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address.
* @param    L7_uint32  status  @b{(input)} status value. 
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPOnDemandLocStatusSet(L7_enetMacAddr_t macAddr,
                                   L7_uint32 status);

/*********************************************************************
*
* @purpose  Get the On-Demand-Loction Invocation number for managed AP.
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address.
* @param    L7_uint32  *num @b{(output)} Pointer to invocation number. 
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPOnDemandLocMsgInvNumGet(L7_enetMacAddr_t macAddr,
                                   L7_uint32 *num);

/*********************************************************************
*
* @purpose  Set the On-Demand-Loction Invocation number for managed AP.
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address.
* @param    L7_uint32  num @b{(input)} invocation number. 
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPOnDemandLocMsgInvNumSet(L7_enetMacAddr_t macAddr,
                                   L7_uint32 num);

/*********************************************************************
*
* @purpose  Initialize the On-Demand-Loction Status parameters for 
*           all the managed APs.
*
* @param    None.
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPOnDemandLocStatusParamsInit();

/*********************************************************************
*
* @purpose  Set the Group Id for managed AP.
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address.
* @param    L7_uchar8  groupId @b{(input)} groupId.
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPGroupIDSet(L7_enetMacAddr_t macAddr,
                                   L7_uchar8 groupId);

/*********************************************************************
*
* @purpose  Get the group id of managed AP.
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address
* @param    L7_uchar8  *groupId  @b{(output)} pointer to group id
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedAPGroupIDGet(L7_enetMacAddr_t macAddr,
                            L7_uchar8 *groupId);
...
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address.
* @param    L7_uint8  *rssi @b{(output)} received rssi value.
...
*
*********************************************************************/
L7_RC_t wdmManagedApOnDemandLocReportGet(L7_enetMacAddr_t macAddr,
                                         L7_int32 *signal,
                                         L7_uint8 *band);

/*********************************************************************
*
* @purpose  Set the On-Demand-Location detected response for managed AP.
*
* @param    L7_enetMacAddr_t  macAddr  @b{(input)} AP mac address.
* @param    L7_uint8  rssi @b{(input)} received rssi value.
* @param    L7_uint8  band @b{(input)} detected band.
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmManagedApOnDemandLocReportSet(L7_enetMacAddr_t macAddr,
                                         L7_int32 signal,
                                         L7_uint8 band);
