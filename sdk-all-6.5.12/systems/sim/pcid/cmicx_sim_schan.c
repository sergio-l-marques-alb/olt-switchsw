...
bool cmicx_schan_update(cmicx_schan_data_t *schan_data)
{
    ...
    if (schan_data->access_running) {
        ...
        if (schan_data->access_countdown==0) {
            ...
            if (cmic_schan_sbus_command_complete(schan_data->message_reg,ack_command,1,&num_words)==true) {
...
bool cmic_schan_sbus_command_complete(reg_t *command,reg_t *ack_command,int expected_resp_words,int *num_words_in_command) {
