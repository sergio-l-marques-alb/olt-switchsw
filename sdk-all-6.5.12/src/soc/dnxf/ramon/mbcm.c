...
mbcm_dnxf_functions_t mbcm_ramon_driver = {
    ...
    NULL, /*mbcm_dnxf_fabric_links_weight_validate*/
    NULL, /*mbcm_dnxf_fabric_links_weight_set*/
    NULL, /*mbcm_dnxf_fabric_links_weight_get*/
    NULL, /*mbcm_dnxf_fabric_links_secondary_only_set*/
    NULL, /*mbcm_dnxf_fabric_links_secondary_only_get*/
    ...
    NULL,/*ramon_interrupts_dnxf_control_data_init*/
    NULL,/*ramon_interrupts_dnxf_control_data_deinit*/
    soc_ramon_interrupt_all_enable_set,
    soc_ramon_interrupt_all_enable_get,
    soc_ramon_temperature_monitor_regs_get,
    NULL, /*soc_ramon_drv_test_reg_filter,*/
    NULL, /*soc_ramon_drv_test_reg_default_val_filter,*/
    NULL, /*soc_ramon_drv_test_mem_filter,*/
    NULL, /*soc_ramon_drv_test_brdc_blk_filter,*/
