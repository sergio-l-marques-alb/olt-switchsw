    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_device_mode";
    define->property.doc = 
        "\n"
...
/**
 * \brief device level function which set numeric local_routing_enable
 * numeric info:
 ...
 */
static shr_error_e
ramon_a0_dnxf_data_fabric_general_local_routing_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_general;
    int define_index = dnxf_data_fabric_general_define_local_routing_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_local_routing_enable";
    define->property.doc = 
        "\n"
        "Enables unicast local routing from FE1 to FE3\n"
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_num_pipes";
    define->property.doc = 
        "\n"
        "Configure number of fabric pipes\n"
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "system_contains_multiple_pipe_device";
    define->property.doc = 
        "\n"
        "Determines if there is a multiple pipe device in the system\n"
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_tdm_priority_min";
    define->property.doc = 
        "\n"
    ...
    define->property.mapping[0].val = soc_dnxf_fabric_priority_0;
    define->property.mapping[1].name = "1";
    define->property.mapping[1].val = soc_dnxf_fabric_priority_1;
    define->property.mapping[2].name = "2";
    define->property.mapping[2].val = soc_dnxf_fabric_priority_2;
    define->property.mapping[3].name = "3";
    define->property.mapping[3].val = soc_dnxf_fabric_priority_3;
    define->property.mapping[4].name = "NONE";
    define->property.mapping[4].val = SOC_DNXF_FABRIC_TDM_PRIORITY_NONE;
    SHR_IF_ERR_EXIT(dnxc_data_mgmt_property_read(unit, &define->property, -1, &define->data));
    /* Set data flags as property */
    define->flags |= (DNXC_DATA_F_PROPERTY);
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fe_mc_id_range";
    define->property.doc = 
        "\n"
        "Specifies the MC IDs range.\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_multicast_mode";
    define->property.doc = 
        "\n"
        "Specifies the MC mode.\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fe_mc_priority_map_enable";
    define->property.doc = 
        "\n"
    ...
    int unit)
{
    ...
    table->values[1].default_val = "DNXF_DIAG_CGM_TH_TYPE_DROP";
    table->values[2].default_val = "DNXF_DIAG_CGM_TH_STAGE_RX";
    ...
    default_data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_DROP;
    default_data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_RX;
    ...
    /* Set Default Values */
    for (threhold_id_index = 0; threhold_id_index < table->keys[0].size; threhold_id_index++)
    {
        data = (dnxf_data_fabric_congestion_thresholds_info_t *) dnxc_data_mgmt_table_data_get(unit, table, threhold_id_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    /*
     * Set Values - Entries
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_DROP;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_MIDDLE;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_DROP;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_TX;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_DROP;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_SHARED;
    data->index_type = _shr_dnxf_cgm_index_type_cast_prio;
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_FE1_FE3;
    data->is_tx = 1;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_GCI;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_TX;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_RCI;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_TX;
    data->index_type = _shr_dnxf_cgm_index_type_pipe_level;
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_FE1_FE3;
    data->is_tx = 1;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_FC;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_MIDDLE;
    data->index_type = _shr_dnxf_cgm_index_type_priority;
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_FE1_FE3;
    data->is_tx = 1;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_FIFO_SIZE;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_TX;
    data->index_type = _shr_dnxf_cgm_index_type_pipe;
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_ALL;
    data->is_tx = 1;
    data->th_validity_bmp = _SHR_FABRIC_CGM_VALIDITY_MODULO_4 | _SHR_FABRIC_CGM_DISABLE_NOT_SUPPORTED;
    data->is_to_be_displayed = 1;
    ...
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_FE1_FE3;
    data->is_tx = 1;
    data->th_validity_bmp = _SHR_FABRIC_CGM_VALIDITY_MODULO_4 | _SHR_FABRIC_CGM_VALIDITY_ONLY_TWO_PIPES | _SHR_FABRIC_CGM_DISABLE_NOT_SUPPORTED;
    data->is_to_be_displayed = 1;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_DROP;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_RX;
    data->index_type = _shr_dnxf_cgm_index_type_pipe;
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_FE1_FE3;
    data->is_tx = 0;
    data->th_validity_bmp = _SHR_FABRIC_CGM_VALIDITY_NOT_PROFILE_DEPENDENT;
    ...
    data->threshold_group = DNXF_DIAG_CGM_TH_TYPE_DYNAMIC_WEIGHT;
    data->threshold_stage = DNXF_DIAG_CGM_TH_STAGE_RX;
    data->index_type = _shr_dnxf_cgm_index_type_pipe;
    data->supported_flags = _SHR_FABRIC_TH_FLAG_SUPPORT_FE1_FE3;
    data->is_tx = 0;
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_cell_fifo_dma_enable";
    define->property.doc = 
        "\n"
        "Deterimins if to use or not to use FIFO DMA.\n"
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_cell_fifo_dma_buffer_size";
    define->property.doc = 
        "\n"
        "Size of the host memory stored allocated by the CPU.\n"
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_cell_fifo_dma_threshold";
    define->property.doc = 
        "\n"
        "The number of writes by the DMA until a threshold based interrupt is triggered.\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_cell_fifo_dma_timeout";
    define->property.doc = 
        "\n"
        "The amount of time in microseconds that passes from the first write by the DMA until a timeout based interrupt is triggered.\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "bcm_rx_thread_pri";
    define->property.doc = 
        "\n"
        "RX thread priority.\n"
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_load_balancing_mode";
    define->property.doc = 
        "\n"
        "Sets the load balancing method.\n"
        "\n"
    ...
    int unit)
{
    ...
    data_index = dnxf_data_fabric_general_define_local_routing_enable;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_general_local_routing_enable_set;
