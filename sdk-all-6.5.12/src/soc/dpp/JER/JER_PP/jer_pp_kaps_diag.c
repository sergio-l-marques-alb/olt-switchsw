...
int jer_pp_kbp_sdk_ver_test(int unit)
{
    ...
    const char* kbp_sdk_ver_arr[] =       {"KBP SDK 1.4.16 03-November-2017"};
    const uint32 sw_sdk_ver_arr_6_5[]  = {0x65b00000};
    ...
    if (sal_strncmp(kbp_sdk_ver_arr[array_index], kbp_device_get_sdk_version(), sizeof("KBP SDK 1.4.13"))) {
        LOG_ERROR(BSL_LS_SOC_TCAM,
                 (BSL_META_U(unit,
