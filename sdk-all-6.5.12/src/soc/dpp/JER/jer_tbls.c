...
int soc_jerplus_tbls_init(int unit)
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_jer_control_dynamic_mem_writes(unit, jer_plus_dynamic_mem_enable_regs, 1)); /* enable dynamic memory writes */
    ...
    SOCDNX_IF_ERR_EXIT(soc_jer_control_dynamic_mem_writes(unit, jer_plus_dynamic_mem_disable_regs, 0)); /* disable dynamic memory writes */
