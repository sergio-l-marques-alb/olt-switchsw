        ...
        if (SOC_DPP_CONFIG(unit)->pp.l3_mc_use_tcam != ARAD_PP_FLP_L3_MC_USE_TCAM_DISABLE) {
            ...
            if(JER_KAPS_ENABLE(unit)){
                ...
                if (SOC_DPP_CONFIG(unit)->pp.ipmc_lookup_model == 1) {
                    ...
                    qual_info[2].qual_offset = 16;
                    /* MSB */
                    qual_info[3].qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV4_SIP;
                    qual_info[3].qual_nof_bits = 16;
                    qual_info[4].qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV4_DIP;
                    qual_info[4].qual_offset = 16;
                    qual_info[4].qual_nof_bits = 16;
                    qual_info[5].qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV4_DIP;
                    qual_info[5].qual_offset = 4;
                    qual_info[5].qual_nof_bits = 12;
                    qual_info[6].qual_type = SOC_PPC_FP_QUAL_IRPP_VRF;
                    qual_info[6].qual_nof_bits = 14;
                    qual_info[7].qual_type = SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES;
                    qual_info[7].qual_nof_bits = 2;
                    qual_info[8].qual_type = SOC_PPC_FP_QUAL_IRPP_IN_RIF;
                    qual_info[8].qual_nof_bits = 15;
                    qual_info[9].qual_type = SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES;
                    qual_info[9].qual_nof_bits = 3;
                    nof_qual = 10;
                } else {
                    /* LSB */
                    qual_info[0].qual_type = SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES;
   ...
   )
{
    ...
    if(ARAD_KBP_ENABLE_IPV4_RPF){    /* in case of KBP is enabled */
        ...
        keys_to_table_id[6].lookup_number = 1;
