...
/********************************************************************* 
 *     clears fid reached limit interrupt
*********************************************************************/
...
/*
*    Read the last FIDs, this is done to clear the interrupt JER_INT_PPDB_B_LARGE_EM_TWO_LARGE_EM_MNGMNT_REQ_FID_EXCEED_LIMIT
*/
