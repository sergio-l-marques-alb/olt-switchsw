/*
 * $Id: wolfhound2.c,v 1.1.8.56 Broadcom SDK $
...
typedef struct soc_wh2_mmu_params_s {
    ...
    /* for lossless mode */
    uint32 num_lossy_downlink_ports;                  /* c19 configurable */
    uint32 num_lossless_downlink_ports;               /* c20 configurable */
    ...
    uint32 num_lossy_queues;                                       /* c39 */
    uint32 mmu_xoff_pkt_threshold_uplink_ports;                    /* c40 */
    uint32 mmu_xoff_pkt_threshold_downlink_ports;                  /* c41 */
    uint32 mmu_xoff_cell_threshold_1g_port_uplink_ports;           /* c42 */
    uint32 mmu_xoff_cell_threshold_2p5g_port_uplink_ports;         /* c43 */

    /* for lossy mode */
    uint32 mmu_xoff_cell_threshold_1g_downlink_ports;              /* c44 */
    uint32 mmu_xoff_cell_threshold_2p5g_downlink_ports;            /* c45 */
    /* for lossless mode */
    uint32 mmu_xoff_cell_threshold_downlink_lossy_ports;           /* c44 */
    uint32 mmu_xoff_cell_threshold_downlink_lossless_ports;        /* c45 */

    /*_device_attributes_*/
    uint32 cell_size;                                              /* c48 */
    uint32 num_egress_queues_per_port;                             /* c49 */
    uint32 num_cpu_queues;                                         /* c50 */
    uint32 num_1g_ports_uplink_ports;                              /* c51 */
    uint32 num_2p5g_ports_uplink_ports;                            /* c52 */
    uint32 num_1g_ports_downlink_ports;                            /* c53 */
    uint32 num_2p5g_ports_downlink_ports;                          /* c54 */
    uint32 num_cpu_ports;                                          /* c55 */
    uint32 number_of_uplink_ports;                                 /* c56 */
    uint32 number_of_downlink_ports;                               /* c57 */
    uint32 total_physical_memory;                                  /* c58 */
    uint32 total_cell_memory;                                      /* c59 */
    uint32 total_advertised_cell_memory;                           /* c60 */
    uint32 numxq_per_uplink_ports;                                 /* c61 */
    uint32 numxq_per_downlink_ports_and_cpu_port;                  /* c62 */
    uint32 the_number_of_pipelines_per_device;                     /* c63 */

    uint32 n_egress_queues_active_per_xpe;                         /* c65 */
    uint32 n_ingress_ports_active_per_xpe;                         /* c66 */

    /*_reservations_*/
    uint32 wrr_reserve;                                            /* c69 */
    uint32 reserved_for_cfap;                                      /* c70 */
    uint32 skidmarker;                                             /* c71 */
    uint32 skidmarker_option;                                      /* c72 */
    uint32 prefetch;                                               /* c73 */

    /*_intermediate_results_*/
    /*_general_information_*/
    uint32 min_packet_size;                                        /* c78 */
    uint32 ethernet_mtu;                                           /* c79 */
    uint32 max_packet_size;                                        /* c80 */
    uint32 standard_jumbo_frame;                                   /* c81 */
    uint32 lossless_traffic_mtu_size;                              /* c82 */
    /*_ingress_thresholds_*/
    uint32 headroom_for_1g_port;                /* c84, for lossy mode */
    uint32 headroom_for_2p5g_port;              /* c85, for lossy mode */
    uint32 headroom_for_lossless_downlink_port; /* c85, for lossless mode */

    /* for lossy mode */
    uint32 xoff_cell_thresholds_per_port_pg_1g_port_downlink_ports;   /* c86 */
    uint32 xoff_cell_thresholds_per_port_pg_2p5g_port_downlink_ports; /* c87 */
    /* for lossless mode */
    uint32 xoff_cell_thresholds_per_port_pg_downlink_lossy_ports;     /* c86 */
    uint32 xoff_cell_thresholds_per_port_pg_downlink_lossless_ports;  /* c87 */

    uint32 xoff_cell_threshold_1g_uplink_ports;                    /* c88 */
    uint32 xoff_cell_threshold_2p5g_uplink_ports;                  /* c89 */
    uint32 xoff_packet_thresholds_per_port_uplink_port;            /* c90 */
    uint32 xoff_packet_thresholds_per_port_downlink_port;          /* c91 */

    /* for lossy mode */
    uint32 discard_limit_per_port_pg_downlink_1g_port;             /* c92 */
    /* for lossless mode */
    uint32 discard_limit_per_port_pg_lossy_downlink_port;          /* c92 */

    uint32 discard_limit_per_port_pg_downlink_2p5g_port;           /* c93 */
    uint32 discard_limit_per_port_pg_uplink_port;                  /* c94 */
    /*_egress_thresholds_*/
    uint32 total_reserved_cells_for_uplink_ports;                  /* c96 */
    uint32 total_reserved_cells_for_downlink_ports;                /* c97 */
    uint32 total_reserved_cells_for_cpu_port;                      /* c98 */
    uint32 total_reserved;                                         /* c99 */
    uint32 shared_space_cells;                                     /* c100 */
    uint32 reserved_xqs_per_uplink_port;                           /* c101 */
    uint32 shared_xqs_per_uplink_port;                             /* c102 */
    uint32 reserved_xqs_per_downlink_port;                         /* c103 */
    uint32 shared_xqs_per_downlink_port;                           /* c104 */
...
STATIC int
soc_wolfhound2_mmu_lossy_config_helper(int unit)
{
    uint32 val = 0;
    uint32 fld_val = 0;
    uint32 tmp = 0;
    ...
    PBMP_ALL_ITER(unit, port) {
        ...
        if (IS_CPU_PORT(unit, port)) {
            ibppktsetlimit_pktsetlimit = \
                mmu_params.\
                xoff_packet_thresholds_per_port_downlink_port; /* c91 */
            ...
            pgcelllimit_0_2__cellsetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_1g_port_downlink_ports; /*c86*/
            pgcelllimit_3__cellsetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_1g_port_downlink_ports; /*c86*/
            pgcelllimit_4_7__cellsetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_1g_port_downlink_ports; /*c86*/
            ...
            pgcelllimit_3__cellresetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_1g_port_downlink_ports; /*c86*/
            pgcelllimit_4_7__cellresetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_1g_port_downlink_ports; /*c86*/
            pgdiscardsetlimit_0_2__discardsetlimit = \
                mmu_params.discard_limit_per_port_pg_downlink_1g_port; /* c92 */
            pgdiscardsetlimit_3__discardsetlimit = \
                mmu_params.discard_limit_per_port_pg_downlink_1g_port; /* c92 */
            pgdiscardsetlimit_4_7__discardsetlimit = \
                mmu_params.discard_limit_per_port_pg_downlink_1g_port; /* c92 */
            ...
            dynxqcntport_dynxqcntport = \
                ...
                mmu_params.prefetch; /* C104-C71-C73 */
            dynresetlimport_dynresetlimport = \
                dynxqcntport_dynxqcntport - 2; /* q80 - 2 */
...
STATIC int
soc_wolfhound2_mmu_lossy_init_helper(int unit)
{
    uint32 tmp;
    wh2_sku_info_t *matched_port_config = NULL;
    int option;
 ...
 */
    ...
    mmu_params.total_reserved_cells_for_uplink_ports = \
        ...
        (mmu_params.number_of_uplink_ports * \
         ...
         mmu_params.num_active_pri_group_lossless);
    /* c97 = c57*c30*(c39)+c57*c32*c38 */
    ...
    SOC_IF_ERROR_RETURN(soc_wolfhound2_mmu_lossy_config_helper(unit));

    return SOC_E_NONE;
}

STATIC int
soc_wolfhound2_mmu_lossless_config_helper(int unit)
{
    uint32 val = 0;
    uint32 fld_val = 0;
    uint32 tmp = 0;
    ...
    /*
     * Maximum lossless port number is 4.
     * If configured lossless port number is 0, assign default lossless pbmp.
     * If configured lossless port number is >5, no lossless port configured.
     * If configured lossless port number is 1~4, accepted the lossless pbmp.
     */
    SOC_PBMP_COUNT(pbmp_lossless, count);
    if (count <= 0) {
        LOG_WARN(BSL_LS_SOC_COMMON,
                 (BSL_META_U(unit,
                             "unit %d : No MMU lossless port assigned "
                             "by config. MMU lossless ports are default "
                             "assigned Port 2, 3, 4, 5.\n"),
                             unit));
        SOC_PBMP_PORT_ADD(pbmp_lossless, 2); /* default lossless ports */
        SOC_PBMP_PORT_ADD(pbmp_lossless, 3); /* default lossless ports */
        SOC_PBMP_PORT_ADD(pbmp_lossless, 4); /* default lossless ports */
        SOC_PBMP_PORT_ADD(pbmp_lossless, 5); /* default lossless ports */
    }
    if (count >= 5) {
        LOG_WARN(BSL_LS_SOC_COMMON,
                 (BSL_META_U(unit,
                             "unit %d : Maximum 4 MMU lossless ports allowed "
                             "but configured %d. No port is assigned MMU "
                             "lossless port.\n"),
                             unit, count));
        SOC_PBMP_CLEAR(pbmp_lossless);
    }
    ...
    PBMP_ALL_ITER(unit, port) {
        ...
        if (IS_CPU_PORT(unit, port)) {
            ...
            pgcelllimit_0_2__cellsetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_downlink_lossy_ports; /*c86*/
            pgcelllimit_3__cellsetlimit = \
                mmu_params.\
                xoff_cell_thresholds_per_port_pg_downlink_lossy_ports; /*c86*/
            ...
            pgdiscardsetlimit_0_2__discardsetlimit = \
                mmu_params.\
                discard_limit_per_port_pg_lossy_downlink_port; /* c92 */
            pgdiscardsetlimit_3__discardsetlimit = \
                mmu_params.\
                discard_limit_per_port_pg_lossy_downlink_port; /* c92 */
            ...
            holcospktsetlimit_3__pktsetlimit = \
                mmu_params.shared_xqs_per_downlink_port + \
                holcosminxqcnt_3__holcosminxqcnt; /* c104 + q68 */
            holcospktsetlimit_4_7__pktsetlimit = 0;
            holcospktresetlimit_0_2__pktresetlimit = \
                holcospktsetlimit_0_2__pktsetlimit - 1; /* q70 - 1 */
            holcospktresetlimit_3__pktresetlimit = \
...
STATIC int
soc_wolfhound2_mmu_lossless_init_helper(int unit)
{
    uint32 tmp;
    wh2_sku_info_t *matched_port_config = NULL;
    int option;
    ...
    SOC_PBMP_COUNT(pbmp_lossless, count);
    if (count <= 0) {
        /* default set ports 2, 3, 4, 5 as lossless ports */
        lossless_downlink_ports = 4;
    } else if (count >= 5) {
        lossless_downlink_ports = 0;
    } else {
        lossless_downlink_ports = count;
    }
    ...
    mmu_params.num_2p5g_ports_uplink_ports_sw_cfg = uplink_port_2p5g;
    /* c19 configurable */
    mmu_params.num_lossy_downlink_ports = lossy_downlink_ports;
    /* c20 configurable */
    mmu_params.num_lossless_downlink_ports = lossless_downlink_ports;
    /* c21 = SUM(C17:C18) */
    mmu_params.number_of_uplink_ports_sw_cfg = \
        mmu_params.num_1g_ports_uplink_ports_sw_cfg + \
        mmu_params.num_2p5g_ports_uplink_ports_sw_cfg;
    ...
    /* c35 =(c87+c45)*c20, used by later (c31) */
    mmu_params.egress_xq_min_reserve_lossless_uplink_ports = \
        (mmu_params.xoff_cell_thresholds_per_port_pg_downlink_lossless_ports + \
         mmu_params.mmu_xoff_cell_threshold_downlink_lossless_ports) * \
        mmu_params.num_lossless_downlink_ports;
    ...
    /* Program MMU settings */
    SOC_IF_ERROR_RETURN(soc_wolfhound2_mmu_lossless_config_helper(unit));
...
soc_wolfhound2_mmu_init(int unit)
{
    ...
    if (lossless_mode) {
        SOC_IF_ERROR_RETURN(soc_wolfhound2_mmu_lossless_init_helper(unit));
    } else {
        SOC_IF_ERROR_RETURN(soc_wolfhound2_mmu_lossy_init_helper(unit));
    }
