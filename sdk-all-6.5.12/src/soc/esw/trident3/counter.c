                ...
                for(pipe = 0; pipe < NUM_PIPE(unit); pipe++) {
                    ...
                    if (non_dma_extra->dma_mem[pipe] != INVALIDm) {
                        ...
                        switch(non_dma_extra->id) {
                            case SOC_COUNTER_NON_DMA_PORT_WRED_PKT_RED:
                                non_dma_extra->dma_index_min[pipe] = 0;
                                non_dma_extra->dma_index_max[pipe] = 65;
                                break;
                            case SOC_COUNTER_NON_DMA_PORT_WRED_PKT_YELLOW:
                                non_dma_extra->dma_index_min[pipe] = 66;
                                non_dma_extra->dma_index_max[pipe]= 131;
                                break;
                            case SOC_COUNTER_NON_DMA_PORT_WRED_PKT_GREEN:
                                non_dma_extra->dma_index_min[pipe] = 132;
                                non_dma_extra->dma_index_max[pipe] = 197;
                                break;
                            case SOC_COUNTER_NON_DMA_PORT_DROP_PKT_RED:
                                non_dma_extra->dma_index_min[pipe] = 198;
                                non_dma_extra->dma_index_max[pipe] = 263;
                                break;
                            case SOC_COUNTER_NON_DMA_PORT_DROP_PKT_YELLOW:
                                non_dma_extra->dma_index_min[pipe] = 264;
                                non_dma_extra->dma_index_max[pipe] = 329;
                                break;
                            default:
                                return SOC_E_PARAM;
                        }
