...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_direction >= cprimod_dir_Count) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
int cprimod_basic_frame_parser_active_table_set(int unit, int port, cprimod_basic_frame_table_id_t table)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_basic_frame_parser_active_table_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_basic_frame_parser_active_table_set(unit, port, table);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_basic_frame_assembly_active_table_set(int unit, int port, cprimod_basic_frame_table_id_t table)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_basic_frame_assembly_active_table_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_basic_frame_assembly_active_table_set(unit, port, table);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_cpri_frame_sync_mode >= cprimod_cpri_frame_sync_mode_Count) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_rsvd4_frame_sync_mode >= cprimodRsvd4FrameSyncModeCount) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_rsvd4_msg_ts_mode >= cprimod_rsvd4_msg_ts_mode_Count) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
{        
    ...
    if(SOC_E_NONE != cprimod_cpri_frame_sync_mode_t_validate(cprimod_cpri_container_config->frame_sync_mode)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("frame_sync_mode validation failed"));
    }
...
{        
    ...
    if(SOC_E_NONE != cprimod_rsvd4_msg_ts_mode_t_validate(cprimod_rsvd4_container_config->msg_ts_mode)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("msg_ts_mode validation failed"));
    }

    if(SOC_E_NONE != cprimod_rsvd4_frame_sync_mode_t_validate(cprimod_rsvd4_container_config->frame_sync_mode)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("frame_sync_mode validation failed"));
    }
...
{        
    ...
    cprimod_encap_header_config->roe_flow_id = 0xFF;
...
int cprimod_encap_ordering_info_sequence_offset_get(int unit, int port, uint32 queue, uint32 control, cprimod_cpri_ordering_info_offset_t* offset_entry)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_encap_ordering_info_sequence_offset_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_encap_ordering_info_sequence_offset_get(unit, port, queue, control, offset_entry);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_decap_ordering_info_sequence_offset_get(int unit, int port, uint32 queue, cprimod_cpri_ordering_info_offset_t* offset_entry)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_decap_ordering_info_sequence_offset_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_decap_ordering_info_sequence_offset_get(unit, port, queue, offset_entry);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_encap_memroy_clear(int unit, int port, int queue_num)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_encap_memroy_clear) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_encap_memroy_clear(unit, port, queue_num);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_encap_memroy_clear isn't implemented for driver type"));
    }
...
int cprimod_decap_memroy_clear(int unit, int port, int queue_num)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_decap_memroy_clear) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_decap_memroy_clear(unit, port, queue_num);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_decap_memroy_clear isn't implemented for driver type"));
    }
...
int cprimod_tx_framer_tgen_next_bfn_set(int unit, int port, uint16 tgen_bfn)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_bfn_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_bfn_set(unit, port, tgen_bfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_tx_framer_tgen_next_bfn_set isn't implemented for driver type"));
    }
...
int cprimod_tx_framer_tgen_next_bfn_get(int unit, int port, uint16* tgen_bfn)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_bfn_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_bfn_get(unit, port, tgen_bfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_tx_framer_tgen_next_bfn_get isn't implemented for driver type"));
    }
...
int cprimod_tx_framer_tgen_next_hfn_set(int unit, int port, uint8 tgen_hfn)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_hfn_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_hfn_set(unit, port, tgen_hfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_tx_framer_tgen_next_hfn_set isn't implemented for driver type"));
    }
...
int cprimod_tx_framer_tgen_next_hfn_get(int unit, int port, uint8* tgen_hfn)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_hfn_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_next_hfn_get(unit, port, tgen_hfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_tx_framer_tgen_next_hfn_get isn't implemented for driver type"));
    }
...
int cprimod_port_rx_interface_config_set(int unit, int port, const cprimod_port_interface_config_t* config)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_port_rx_interface_config_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_port_rx_interface_config_set(unit, port, config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_port_tx_interface_config_set(int unit, int port, const cprimod_port_interface_config_t* config)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_port_tx_interface_config_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_port_tx_interface_config_set(unit, port, config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_port_rsvd4_rx_speed_set(int unit, int port, cprimod_port_rsvd4_speed_mult_t speed)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_port_rsvd4_rx_speed_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_port_rsvd4_rx_speed_set(unit, port, speed);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_port_rsvd4_tx_speed_set(int unit, int port, cprimod_port_rsvd4_speed_mult_t speed)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_port_rsvd4_tx_speed_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_port_rsvd4_tx_speed_set(unit, port, speed);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_cpri_rx_control_word_sync_info_get(int unit, int port, uint32* basic_frame_num, uint32* hyper_frame_num, uint32* radio_frame_num)
{
    ...
    if(basic_frame_num == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("basic_frame_num NULL parameter"));
    }
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_rx_control_word_sync_info_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_rx_control_word_sync_info_get(unit, port, basic_frame_num, hyper_frame_num, radio_frame_num);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
{        
    ...
    cprimod_cpri_rx_vsd_config_info->schan_bytes = 0;
...
{        
    ...
    cprimod_cpri_tx_vsd_config_info->schan_bytes = 0;
...
int cprimod_cpri_port_tx_vsd_ctrl_flow_add(int unit, int port, uint32 group_id, const cprimod_cpri_tx_vsd_flow_info_t* config_info)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_vsd_ctrl_flow_add) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_vsd_ctrl_flow_add(unit, port, group_id, config_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_rsvd4_tx_control_flow_config_set(int unit, int port, uint32 flow_id, uint32 queue_num, cprimod_control_msg_proc_type_t proc_type)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_config_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_config_set(unit, port, flow_id, queue_num, proc_type);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_rsvd4_tx_control_flow_config_get(int unit, int port, uint32 flow_id, uint32* queue_num, cprimod_control_msg_proc_type_t* proc_type)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_config_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_config_get(unit, port, flow_id, queue_num, proc_type);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
