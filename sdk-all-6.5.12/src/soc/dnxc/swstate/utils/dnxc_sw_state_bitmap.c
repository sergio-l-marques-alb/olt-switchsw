    ...
    char *dbg_string)
{
    ...
    DNX_SW_STATE_ALLOC_BASIC(unit, module_id, location, _SHR_BITDCLSIZE(nof_bits_to_alloc) + 1, sizeof(SHR_BITDCL), flags | DNX_SW_STATE_ALLOC_BITMAP_FLAG, dbg_string);
