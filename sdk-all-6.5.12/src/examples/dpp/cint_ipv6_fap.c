...
int bcm_l3_ip6_uc_priority(int unit, int port0, int port1, int port2, int port3, int tcam) {
...
int ipv6_route_prefix_sem_traverse_cb(int unit, int i, bcm_l3_route_t *info, void *data){
