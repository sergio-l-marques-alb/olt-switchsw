...
int cint_nif_priority_config_mpls_special_label_config(int unit, int in_port, int scenario_index)
{
    ...
    int exp, prio;
    uint32 key, tpid, fifo_size_01, fifo_size_23;
    ...
    if(scenario_index == 0) {
        ...
        for(index=0;index<4;index++) {
            ...
            label_config.is_tdm = 0;
            rv = bcm_cosq_ingress_port_drop_mpls_special_label_set(unit, in_port, flags, index/4, label_config);
            if (rv != BCM_E_NONE) {
                printf("Failed(%d) bcm_cosq_ingress_port_drop_mpls_special_label_set\n", rv);
                return rv;
            }
...
int cint_nif_priority_config_soft_stage_JER2(int unit,int in_port,int lp_pcp,int low_priority,int hp_pcp,int high_priority,
                                             uint32 tpid,uint32 header,uint32 ether_type_val,
                                             uint32 lp_match_key1,uint32 hp_match_key1,
                                             uint32 lp_match_key2,uint32 hp_match_key2,
                                             uint32 lp_match_key3,uint32 hp_match_key3,
                                             uint32 lp_match_key4,uint32 hp_match_key4,
                                             uint32 offset_base,uint32 offset)
{
    int rv = BCM_E_NONE;
    uint32 flags = 0;
    int lp_key, hp_key, num_key_fields = 4;
    bcm_cosq_ingress_port_drop_map_t cosq_map;
    bcm_info_t info;
    bcm_cosq_ingress_drop_flex_key_construct_id_t key_id;
    bcm_cosq_ingress_drop_flex_key_construct_t flex_key_config;
    ...
    bcm_cosq_ingress_drop_flex_key_entry_t lp_flex_key_info;
    bcm_cosq_ingress_drop_flex_key_entry_t hp_flex_key_info;
    bcm_cosq_ingress_drop_flex_key_t lp_key_field_match1;
    bcm_cosq_ingress_drop_flex_key_t lp_key_field_match2;
    bcm_cosq_ingress_drop_flex_key_t lp_key_field_match3;
    bcm_cosq_ingress_drop_flex_key_t lp_key_field_match4;
    bcm_cosq_ingress_drop_flex_key_t hp_key_field_match1;
    bcm_cosq_ingress_drop_flex_key_t hp_key_field_match2;
    bcm_cosq_ingress_drop_flex_key_t hp_key_field_match3;
    bcm_cosq_ingress_drop_flex_key_t hp_key_field_match4;
    uint32 lp_key_index = 10;
    uint32 hp_key_index = 20;
    ...
    if((offset_base == bcmCosqIngressPortDropFlexKeyBasePacketStart) || (offset_base == bcmCosqIngressPortDropFlexKeyBaseEndOfEthHeader)) {
        ...
        flex_key_config.ether_type_header_size = 24;
    }
    ...
    flex_key_config.offset_array[0] = offset-1;
    flex_key_config.offset_array[1] = offset;
    flex_key_config.offset_array[2] = offset+1;
    flex_key_config.offset_array[3] = offset+2;
    rv = bcm_cosq_ingress_port_drop_flex_key_construct_set(unit, key_id, flags, flex_key_config);
    if (rv != BCM_E_NONE) {
    ...
    /* Add low prio key to the TCAM */
    /* If match - set to priority 2 */
    lp_key_field_match1.value = lp_match_key1;
    lp_key_field_match1.mask = 0xFF;
    lp_key_field_match2.value = lp_match_key2;
    lp_key_field_match2.mask = 0xFF;
    lp_key_field_match3.value = lp_match_key3;
    lp_key_field_match3.mask = 0xFF;
    lp_key_field_match4.value = lp_match_key4;
    lp_key_field_match4.mask = 0xFF;
    lp_flex_key_info.ether_code = ether_code;
    lp_flex_key_info.num_key_fields = num_key_fields;
    lp_flex_key_info.priority = high_priority;
    lp_flex_key_info.key_fields[0] = lp_key_field_match1;
    lp_flex_key_info.key_fields[1] = lp_key_field_match2;
    lp_flex_key_info.key_fields[2] = lp_key_field_match3;
    lp_flex_key_info.key_fields[3] = lp_key_field_match4;
    rv = bcm_cosq_ingress_port_drop_flex_key_entry_set(unit, in_port, flags, lp_key_index, lp_flex_key_info);
    if (rv != BCM_E_NONE) {
        printf("Failed(%d) bcm_cosq_ingress_port_drop_flex_key_entry_set\n", rv);
        return rv;
    ...
    /* Add high prio key to the TCAM */
    /* If match - set to priority 0 */
    hp_key_field_match1.value = hp_match_key1;
    hp_key_field_match1.mask = 0xFF;
    hp_key_field_match2.value = hp_match_key2;
    hp_key_field_match2.mask = 0xFF;
    hp_key_field_match3.value = hp_match_key3;
    hp_key_field_match3.mask = 0xFF;
    hp_key_field_match4.value = hp_match_key4;
    hp_key_field_match4.mask = 0xFF;
    hp_flex_key_info.ether_code = ether_code;
    hp_flex_key_info.num_key_fields = num_key_fields;
    hp_flex_key_info.priority = low_priority;
    hp_flex_key_info.key_fields[0] = hp_key_field_match1;
    hp_flex_key_info.key_fields[1] = hp_key_field_match2;
    hp_flex_key_info.key_fields[2] = hp_key_field_match3;
    hp_flex_key_info.key_fields[3] = hp_key_field_match4;
    rv = bcm_cosq_ingress_port_drop_flex_key_entry_set(unit, in_port, flags, hp_key_index, hp_flex_key_info);
    if (rv != BCM_E_NONE) {
        printf("Failed(%d) bcm_cosq_ingress_port_drop_flex_key_entry_set\n", rv);
        return rv;
    ...
    printf("cint_nif_priority_config_soft_stage_JER2: PASS\n\n");
    return BCM_E_NONE;
}
