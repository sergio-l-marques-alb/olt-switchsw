    ...
    sh_sand_control_t * sand_control)
{
    ...
    else
    {
        ...
        if (sal_strncasecmp(types_table_val->strval, "dnxf data", strlen("dnxf data")))
        {
            LOG_ERROR(BSL_LOG_MODULE,
    ...
    sh_sand_control_t * sand_control)
{
     ...
     */
    SHR_CLI_EXIT_IF_ERR(dnxf_data_deinit(unit), "Error - dnx data deinit\n");
    SHR_CLI_EXIT_IF_ERR(dnxf_data_init(unit), "Error - dnx data init\n");
...
static sh_sand_man_t dnxf_data_test_support_man = {
...
static sh_sand_man_t dnxf_data_test_types_man = {
...
static sh_sand_man_t dnxf_data_test_property_man = {
...
sh_sand_cmd_t dnxf_data_test_cmds[] = {
    {"input", dnxf_data_test_support, NULL, NULL, &dnxf_data_test_support_man, NULL, NULL, CTEST_PRECOMMIT},
    {"type", dnxf_data_test_types, NULL, NULL, &dnxf_data_test_types_man, NULL, NULL, CTEST_PRECOMMIT},
    {"property", dnxf_data_test_property, NULL, NULL, &dnxf_data_test_property_man, NULL, NULL, CTEST_PRECOMMIT},
    {NULL}
};
