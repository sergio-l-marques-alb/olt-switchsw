...
CINT_FWRAPPER_CREATE_RP5(int, int, 0, 0,
                         ...
                         int, int, unit, 0, 0,
                         int, int, port, 0, 0,
                         uint32*, uint32, basic_frame_num, 1, 0,
...
static cint_function_t __cint_functions[] =
{
    ...
    CINT_FWRAPPER_ENTRY(cprimod_encap_memroy_clear),
    CINT_FWRAPPER_ENTRY(cprimod_cpri_rx_framer_state_clear),
    CINT_FWRAPPER_ENTRY(cprimod_decap_memroy_clear),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_tx_framer_tgen_next_bfn_get),
    CINT_FWRAPPER_ENTRY(cprimod_tx_framer_tgen_next_bfn_set),
    CINT_FWRAPPER_ENTRY(cprimod_tx_framer_tgen_next_hfn_get),
    CINT_FWRAPPER_ENTRY(cprimod_tx_framer_tgen_next_hfn_set),
...
__cint_maddr__cprimod_port_init_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 1: rv = &(s->interface);break;
        case 2: rv = &(s->tx_cpri_speed);break;
        case 3: rv = &(s->rx_cpri_speed);break;
        case 4: rv = &(s->tx_rsvd4_speed);break;
        case 5: rv = &(s->rx_rsvd4_speed);break;
        case 6: rv = &(s->roe_stuffing_bit);break;
        case 7: rv = &(s->roe_reserved_bit);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__cprimod_cpri_rx_vsd_config_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 2: rv = &(s->schan_bytes);break;
        case 3: rv = &(s->schan_steps);break;
...
static cint_parameter_desc_t __cint_struct_members__cprimod_cpri_rx_vsd_config_info_t[] = 
{
    {"uint32", "schan_start", 0, 0},
    {"uint32", "schan_size", 0, 0},
    {"cprimod_cpri_control_schan_num_bytes_t", "schan_bytes", 0, 0},
    {"uint32", "schan_steps", 0, 0},
    {"cprimod_cpri_control_flow_num_bytes_t", "flow_bytes", 0, 0},
    {"uint32", "queue_num", 0, 0},
...
static cint_enum_map_t __cint_enum_map__cprimod_direction_t[] =
{
    { "cprimod_dir_rx", cprimod_dir_rx },
    { "cprimod_dir_tx", cprimod_dir_tx },
    { "cprimod_dir_Count", cprimod_dir_Count },
    { NULL }
};
...
static cint_enum_map_t __cint_enum_map__cprimod_cpri_frame_sync_mode_t[] =
{
    ...
    { "cprimod_cpri_frame_sync_mode_Count", cprimod_cpri_frame_sync_mode_Count },
    { NULL }
};

static cint_enum_map_t __cint_enum_map__cprimod_rsvd4_frame_sync_mode_t[] =
{
    { "cprimodRsvd4FrameSyncModeNoSync", cprimodRsvd4FrameSyncModeNoSync },
    { "cprimodRsvd4FrameSyncModeMsgOffset", cprimodRsvd4FrameSyncModeMsgOffset },
    { "cprimodRsvd4FrameSyncModeMsgAndMasterOffset", cprimodRsvd4FrameSyncModeMsgAndMasterOffset },
    { "cprimodRsvd4FrameSyncModeMsgTsNoSync", cprimodRsvd4FrameSyncModeMsgTsNoSync },
    { "cprimodRsvd4FrameSyncModeMsgTsMsgOffset", cprimodRsvd4FrameSyncModeMsgTsMsgOffset },
    { "cprimodRsvd4FrameSyncModeMsgTsMsgAndMasterOffset", cprimodRsvd4FrameSyncModeMsgTsMsgAndMasterOffset },
    { "cprimodRsvd4FrameSyncModeCount", cprimodRsvd4FrameSyncModeCount },
    { NULL }
};

static cint_enum_map_t __cint_enum_map__cprimod_rsvd4_msg_ts_mode_t[] =
{
    ...
    { "cprimod_rsvd4_msg_ts_mode_Count", cprimod_rsvd4_msg_ts_mode_Count },
    { NULL }
};
...
static cint_enum_type_t __cint_enums[] =
{
    ...
    {"cprimod_direction_t", __cint_enum_map__cprimod_direction_t },
    ...
    {"cprimod_cpri_frame_sync_mode_t", __cint_enum_map__cprimod_cpri_frame_sync_mode_t },
    {"cprimod_rsvd4_frame_sync_mode_t", __cint_enum_map__cprimod_rsvd4_frame_sync_mode_t },
    {"cprimod_rsvd4_msg_ts_mode_t", __cint_enum_map__cprimod_rsvd4_msg_ts_mode_t },
...
static cint_constants_t __cint_constants[] =
{
    ...
    { "CPRIMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_1", CPRIMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_1 },
    { "CPRIMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_2", CPRIMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_2 },
    { "CPRIMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_4", CPRIMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_4 },
    { "CPRIMOD_CPRI_CONTROL_FLOW_NUM_BYTES_2", CPRIMOD_CPRI_CONTROL_FLOW_NUM_BYTES_2 },
    { "CPRIMOD_CPRI_CONTROL_FLOW_NUM_BYTES_4", CPRIMOD_CPRI_CONTROL_FLOW_NUM_BYTES_4 },
...
static cint_parameter_desc_t __cint_typedefs[] =
{
    ...
    {"_shr_hdlc_fcs_size_t", "cprimod_cpri_hdlc_fcs_size_t" , 0 , 0},
    {"_shr_hdlc_filling_flag_pattern_t", "cprimod_cpri_hdlc_filling_flag_pattern_t" , 0 , 0},
    {"_shr_hdlc_flag_size_t", "cprimod_cpri_hdlc_num_flag_bytes_t" , 0 , 0},
    {"_shr_hdlc_crc_mode_t", "cprimod_cpri_crc_mode_t" , 0 , 0},
    {"_shr_hdlc_crc_init_val_t", "cprimod_cpri_hdlc_crc_init_val_t" , 0 , 0},
    {"_shr_control_schan_num_bytes_t", "cprimod_cpri_control_schan_num_bytes_t" , 0 , 0},
    {"_shr_control_flow_num_bytes_t", "cprimod_cpri_control_flow_num_bytes_t" , 0 , 0},
    ...
    {"_shr_control_msg_proc_type_t", "cprimod_control_msg_proc_type_t" , 0 , 0},
    {"_shr_sync_count_cycle_t", "cprimod_sync_count_cycle_t" , 0 , 0},
    {"_shr_tag_gen_entry_t", "cprimod_tag_gen_entry_t" , 0 , 0},
    {"_shr_tag_option_t", "cprimod_cpri_tag_option_t" , 0 , 0},
    {"_shr_cpri_crc_option_t", "cprimod_cpri_crc_option_t" , 0 , 0},
    {"_shr_fast_eth_config_t", "cprimod_cpri_fast_eth_config_t" , 0 , 0},
    { NULL }
};
