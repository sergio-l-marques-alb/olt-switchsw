...
int 
bcm_dfe_cpri_port_axc_agnostic_mode_enable_set(
    int unit, 
    bcm_gport_t port, 
    int enable)
{
...
int 
bcm_dfe_cpri_port_axc_agnostic_mode_set(
    int unit, 
    bcm_gport_t port, 
...
int 
bcm_dfe_cpri_port_encap_clear_all(
    int unit, 
    bcm_gport_t port)
{
    return BCM_E_UNAVAIL;
...
int 
bcm_dfe_cpri_port_encap_roe_ordering_info_clear(
    int unit, 
    bcm_gport_t port, 
    int index)
{
...
int 
bcm_dfe_cpri_port_rsvd4_rx_control_config_set(
    int unit, 
    int port, 
...
int 
bcm_dfe_cpri_port_rsvd4_rx_tag_gen_entry_add(
    int unit, 
    int port, 
    int index, 
...
int 
bcm_dfe_cpri_port_rsvd4_rx_tag_gen_entry_delete(
    int unit, 
    int port, 
    int index, 
    bcm_cpri_tag_gen_entry_t *config)
...
int 
bcm_dfe_cpri_port_rx_cw_l1_signal_info_get(
    int unit, 
    int port, 
...
int 
bcm_dfe_cpri_port_rx_cw_vsd_ctrl_flow_config_get(
    int unit, 
    int port, 
    uint16 group_id, 
...
int 
bcm_dfe_cpri_port_rx_cw_vsd_ctrl_flow_config_set(
    int unit, 
    int port, 
    uint16 group_id, 
    bcm_cpri_rx_vsd_flow_info_t *config)
...
int 
bcm_dfe_cpri_port_rx_fec_descramble_bypass_set(
    int unit, 
    int port, 
    uint8 enable)
{
...
int 
bcm_dfe_cpri_port_rx_fec_enable_set(
    int unit, 
    int port, 
    uint8 enable)
{
...
int 
bcm_dfe_cpri_port_rx_fec_soft_reset_set(
    int unit, 
    int port, 
    uint8 enable)
{
...
int 
bcm_dfe_cpri_port_rx_fec_tick_set(
    int unit, 
    int port, 
...
int 
bcm_dfe_cpri_port_rx_fec_timestamp_config_set(
    int unit, 
    int port, 
...
int 
bcm_dfe_cpri_port_stage_activate(
    int unit, 
    bcm_gport_t port, 
...
int 
bcm_dfe_cpri_port_tx_cw_l1_config_set(
    int unit, 
    int port, 
...
int 
bcm_dfe_cpri_port_tx_cw_vsd_ctrl_flow_config_set(
    int unit, 
    int port, 
    uint16 group_id, 
...
int 
bcm_dfe_cpri_port_tx_frame_tgen_enable(
    int unit, 
    bcm_gport_t port, 
    int enable)
{
...
int 
bcm_dfe_cpri_rx_tag_config_set(
    int unit, 
    int port, 
    uint32 default_tag, 
    uint32 no_match_tag)
...
int 
bcm_dfe_multicast_encap_extension_add(
    int unit, 
    uint32 flags, 
    bcm_if_t encap_id, 
...
int 
bcm_dfe_multicast_encap_extension_delete(
    int unit, 
    uint32 flags, 
    bcm_if_t encap_id)
{
...
int 
bcm_dfe_port_ilkn_lane_id_map_get(
    int unit, 
    int flags, 
    bcm_port_t port, 
    int num_of_lanes, 
...
int 
bcm_dfe_port_ilkn_lane_id_map_set(
    int unit, 
    int flags, 
    bcm_port_t port, 
    int num_of_lanes, 
...
int 
bcm_dfe_stat_counter_engine_enable_get(
    int unit, 
    uint32 flags, 
    bcm_stat_engine_t *engine, 
...
int 
bcm_dfe_stat_counter_engine_enable_set(
    int unit, 
    uint32 flags, 
    bcm_stat_engine_t *engine, 
    bcm_stat_engine_enable_t *enable)
...
#if defined(INCLUDE_XFLOW_MACSEC)
int 
bcm_dfe_xflow_macsec_subport_num_get(
    int unit, 
    bcm_xflow_macsec_id_t id, 
