...
STATIC int
_tr3_l2_delete_all_by_hw(int unit, int vfi, int preserve_static)
{
    int rv = BCM_E_NONE;
    sal_usecs_t start_time;
    int diff_time;        
    ...
    if (preserve_static) {
        /* Ensure that STATIC_BIT is 0 in data */
...
#endif        
        {    
            rv = _tr3_l2_delete_all_by_hw(unit, match_type, preserve_static);
        }    
        if (rv < 0) {
