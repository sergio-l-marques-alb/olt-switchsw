...
#define TD3_MAX_XPEPIPE             _TD3_PIPES_PER_DEV * _TD3_XPES_PER_DEV

#define TD3_MAX_POOL_COUNT          4
#define TD3_MAX_UCQ_COUNT           1328

/* Max Elements Count = UCQ + ING POOL + EGR POOL */
#define TD3_MAX_ELEMENT_COUNT       TD3_MAX_UCQ_COUNT + TD3_MAX_POOL_COUNT * 2
...
typedef struct pstats_session_s {
    ...
    bcm_pstats_session_element_t    element_array[TD3_MAX_ELEMENT_COUNT];
...
typedef struct pstats_control_s {
    ...
    pstats_buffer_t                 ucq_buffer[TD3_MAX_XPEPIPE];
                              ...
                              bcm_pstats_session_id_t *session_id)
{
    ...
    /* element check */
    if ((array_count < 0) ||
        (array_count > TD3_MAX_ELEMENT_COUNT)) {
...
int bcm_esw_trident3_pstats_not_empty;
