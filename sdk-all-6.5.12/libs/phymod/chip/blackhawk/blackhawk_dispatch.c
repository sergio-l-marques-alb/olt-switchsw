...
__phymod__dispatch__t__ phymod_blackhawk_driver = {

    blackhawk_core_identify,
    blackhawk_core_info_get,
    blackhawk_core_lane_map_set,
    blackhawk_core_lane_map_get,
    blackhawk_core_reset_set,
    blackhawk_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    blackhawk_phy_firmware_core_config_set,
    blackhawk_phy_firmware_core_config_get,
    blackhawk_phy_firmware_lane_config_set,
    blackhawk_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    blackhawk_phy_rx_restart,
    blackhawk_phy_polarity_set,
    blackhawk_phy_polarity_get,
    blackhawk_phy_tx_set,
    blackhawk_phy_tx_get,
    blackhawk_phy_media_type_tx_get,
    ...
    blackhawk_phy_reset_set,
    blackhawk_phy_reset_get,
    blackhawk_phy_power_set,
    blackhawk_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    blackhawk_phy_tx_lane_control_set,
    blackhawk_phy_tx_lane_control_get,
    blackhawk_phy_rx_lane_control_set,
    blackhawk_phy_rx_lane_control_get,
    ...
    blackhawk_phy_cl72_set,
    blackhawk_phy_cl72_get,
    blackhawk_phy_cl72_status_get,
    blackhawk_phy_autoneg_ability_set,
    blackhawk_phy_autoneg_ability_get,
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    blackhawk_phy_autoneg_set,
    blackhawk_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    blackhawk_phy_autoneg_status_get,
    blackhawk_core_init,
    blackhawk_phy_pll_multiplier_get,
    blackhawk_phy_init,
    blackhawk_phy_loopback_set,
    blackhawk_phy_loopback_get,
    blackhawk_phy_rx_pmd_locked_get,
    blackhawk_phy_rx_signal_detect_get,
    blackhawk_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    blackhawk_phy_reg_read,
    blackhawk_phy_reg_write,
    ...
    blackhawk_phy_speed_config_set,
    blackhawk_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    blackhawk_phy_tx_taps_default_get,
    blackhawk_phy_lane_config_default_get,
    blackhawk_phy_firmware_load_info_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    blackhawk_phy_tx_pam4_precoder_enable_set,
    blackhawk_phy_tx_pam4_precoder_enable_get,
    blackhawk_phy_tx_phase_lock_set,
};
