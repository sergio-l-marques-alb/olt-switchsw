...
enum blackhawk_tsc_cdr_mode_enum {
  ...
  BLACKHAWK_TSC_CDR_MODE_PAM4_NS_OS_PATTERN       = 4,
  BLACKHAWK_TSC_CDR_MODE_PAM4_NS_BR_PATTERN       = 5,
  BLACKHAWK_TSC_CDR_MODE_PAM4_ES_DFE_DATA_PATTERN = 6,
  BLACKHAWK_TSC_CDR_MODE_PAM4_ES_PATTERN          = 7
};
