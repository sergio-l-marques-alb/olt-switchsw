...
/** @file blackhawk_tsc_diag.h
 * Diagnostic functions provided to IP User
 */

#ifndef BLACKHAWK_TSC_API_DIAG_H
#define BLACKHAWK_TSC_API_DIAG_H
...
struct blackhawk_tsc_eyescan_options_st {
...
/** Column definition header for blackhawk_tsc_display_core_state() API output.
 * To be called before blackhawk_tsc_display_core_state_line() API.
 ...
 * Call blackhawk_tsc_display_core_state_hdr() API before and blackhawk_tsc_display_core_state_legend() after
...
/** Detailed description of each column in blackhawk_tsc_display_core_state_line() API output.
 * To be called after blackhawk_tsc_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function only initiates the processor actions.  User must use blackhawk_tsc_read_eye_scan_stripe() function
...
/** Column definition header for blackhawk_tsc display state.
 * To be called before blackhawk_tsc_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_display_lane_state_hdr(void);

/** Detailed explanation of each column in blackhawk_tsc display state.
 * To be called after blackhawk_tsc_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable blackhawk_tsc support.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Parameterized diagnostic function which access to all blackhawk_tsc control and status bits
 * This function is required to be implemented by upper level software to enable blackhawk_tsc support.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_poll_diag_emulation_ready(srds_access_t *sa__, uint32_t timeout_ms);
