 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: falcon2_madura_internal.h 1341 2016-02-05 20:06:55Z kirand $ *
 *                                                                                *
...
/** @file falcon2_madura_internal.h
 * Internal API functions
 */

#ifndef FALCON2_MADURA_API_INTERNAL_H
#define FALCON2_MADURA_API_INTERNAL_H
...
#include "falcon2_madura_debug_functions.h"
...
typedef struct {
       ...
       uint8_t core_status;
} falcon2_madura_core_state_st;


#ifdef MADURA_EXCLUDE_STATIC_FUNCTION_DECLARATIONS

/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current falcon2_madura lane status.
 * @param *istate Current falcon2_madura lane status read back and populated by the API
...
#else /* !MADURA_EXCLUDE_STATIC_FUNCTION_DECLARATIONS */
 ...
 * as part of falcon2_madura_display_core_state_line()
...
/*-----------------------------*/
/** Read current falcon2_madura core status.
 * @param *istate Current falcon2_madura core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pll_lock Current falcon2_madura lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current falcon2_madura lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pmd_lock Current falcon2_madura lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current falcon2_madura lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *sig_det Current falcon2_madura lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current falcon2_madura lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_madura_get_osr_mode( const phymod_access_t *pa, falcon2_madura_osr_mode_st *mode);
 ...
 * Along with falcon2_madura_core_clkgate(), all lanes should also be clock gated using falcon2_madura_lane_clkgate() to complete a Core Clockgate
...
#endif /* MADURA_EXCLUDE_STATIC_FUNCTION_DECLARATIONS */
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in falcon2_madura_functions.c.
 *
