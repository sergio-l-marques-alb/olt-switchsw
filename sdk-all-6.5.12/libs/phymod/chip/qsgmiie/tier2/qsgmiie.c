...
int qsgmiie_phy_tx_set(const phymod_phy_access_t* phy, const phymod_tx_t* tx)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_PRE, tx->pre));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_MAIN, tx->main));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_POST1, tx->post));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_POST2, tx->post2));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_POST3, tx->post3));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_AMP,  tx->amp));
    if((tx->drivermode != -1) &&
       (phy->device_op_mode & PHYMOD_INTF_CONFIG_TX_FIR_DRIVERMODE_ENABLE)) {
        PHYMOD_IF_ERR_RETURN
            (eagle_tsc_write_tx_afe(&pm_phy_copy.access, TX_AFE_DRIVERMODE,  tx->drivermode));
    }
...
int qsgmiie_phy_tx_get(const phymod_phy_access_t* phy, phymod_tx_t* tx)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_PRE, &tx->pre));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_MAIN, &tx->main));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_POST1, &tx->post));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_POST2, &tx->post2));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_POST3, &tx->post3));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_AMP, &tx->amp));
    PHYMOD_IF_ERR_RETURN
        (eagle_tsc_read_tx_afe(&pm_phy_copy.access, TX_AFE_DRIVERMODE, &tx->drivermode));
    return PHYMOD_E_NONE;
