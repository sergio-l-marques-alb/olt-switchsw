...
#define BCM_FIELD_WB_DEFAULT_VERSION            BCM_FIELD_WB_VERSION_1_24
#endif
...
#define _FIELD_FT_TRACKING_ELEMENT_TYPE_MAX                 \
                    bcmFlowtrackerExportElementTypeCount
...
typedef struct _field_ft_policy_s {
    int flow_key_profile_idx;
    int flow_data_profile_idx;
    int alu_data_profile_idx;
...
typedef enum _bcm_field_internal_element_e {
    ...
    _bcmFieldInternalElementCount = 367
...
typedef enum _bcmFieldActionNoParam_e {
    ...
    _bcmFieldActionNoParamCount  /* 60*/
