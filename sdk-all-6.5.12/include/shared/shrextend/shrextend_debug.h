...
/*
 * We assume here that vxWorks, as is, supports C99.
 */
#if (__STDC_VERSION__ >= 199901L) || defined(__VXWORKS__) || defined(VXWORKS)
...
#include <include/sal/core/time.h>
/**
 ...
 * will be done using sal_alloc. If allocation fails, exit with error
 * message.
 *
