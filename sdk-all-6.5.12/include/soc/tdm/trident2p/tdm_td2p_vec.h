...
#ifndef TDM_TD2P_VECTOR_LIBRARY_H
#define TDM_TD2P_VECTOR_LIBRARY_H
/**
@name: tdm_td2p_vector_load
@param:

Generate vector at index in TDM vector map
**/
int
tdm_td2p_vec_load(unsigned short **map, int bw, int port_speed, int yy, int len, int num_ext_ports)
{
	int i, j=0, n=0;
...
#endif /* TDM_TD2P_VECTOR_LIBRARY_H */
