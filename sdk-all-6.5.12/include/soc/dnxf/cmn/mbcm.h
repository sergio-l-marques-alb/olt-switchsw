...
typedef shr_error_e (*mbcm_dnxf_fabric_cell_type_get_f) (int unit, soc_dnxc_fabric_cell_entry_t entry, soc_dnxc_fabric_cell_type_t *cell_type);
typedef shr_error_e (*mbcm_dnxf_fabric_cell_parse_table_get_f) (int unit, soc_dnxc_fabric_cell_type_t cell_type, uint32 max_nof_lines, soc_dnxc_fabric_cell_parse_table_t *parse_table, uint32 *nof_lines);
...
typedef shr_error_e (*mbcm_dnxf_fabric_links_nof_links_get_f) (int unit, int* nof_links);
...
typedef shr_error_e (*mbcm_dnxf_fabric_links_weight_validate_f) (int unit, int val);
typedef shr_error_e (*mbcm_dnxf_fabric_links_weight_set_f) (int unit, soc_port_t link, int is_prim, int val);
typedef shr_error_e (*mbcm_dnxf_fabric_links_weight_get_f) (int unit, soc_port_t link, int is_prim, int* val);
typedef shr_error_e (*mbcm_dnxf_fabric_links_secondary_only_set_f) (int unit, soc_port_t link, int val);
typedef shr_error_e (*mbcm_dnxf_fabric_links_secondary_only_get_f) (int unit, soc_port_t link, int* val);
...
typedef shr_error_e (*mbcm_dnxf_fabric_multicast_multi_read_info_get_f) (int unit, const soc_dnxf_multicast_read_range_info_t **info, int *info_size);
...
typedef shr_error_e (*mbcm_dnxf_fabric_link_status_all_get_f) (int unit, int links_array_max_size, uint32* link_status, uint32* errored_token_count, int* links_array_count);
...
typedef shr_error_e (*mbcm_dnxf_port_control_pcs_set_f) (int unit, soc_port_t port, soc_dnxc_port_pcs_t pcs);
typedef shr_error_e (*mbcm_dnxf_port_control_pcs_get_f) (int unit, soc_port_t port, soc_dnxc_port_pcs_t* pcs);
...
typedef shr_error_e (*mbcm_dnxf_port_control_strip_crc_set_f) (int unit, soc_port_t port, int strip_crc);
typedef shr_error_e (*mbcm_dnxf_port_control_strip_crc_get_f) (int unit, soc_port_t port, int* strip_crc);
typedef shr_error_e (*mbcm_dnxf_port_control_rx_enable_set_f) (int unit, soc_port_t port, uint32 flags, int enable);
typedef shr_error_e (*mbcm_dnxf_port_control_tx_enable_set_f) (int unit, soc_port_t port, int enable);
typedef shr_error_e (*mbcm_dnxf_port_control_rx_enable_get_f) (int unit, soc_port_t port, int* enable);
typedef shr_error_e (*mbcm_dnxf_port_control_tx_enable_get_f) (int unit, soc_port_t port, int* enable);
...
typedef shr_error_e (*mbcm_dnxf_port_speed_get_f) (int unit, soc_port_t port, int *speed);
typedef shr_error_e (*mbcm_dnxf_port_speed_max_f) (int unit, soc_port_t port, int *speed);
typedef shr_error_e (*mbcm_dnxf_port_speed_set_f) (int unit, soc_port_t port, int speed);
typedef shr_error_e (*mbcm_dnxf_port_interface_set_f) (int unit, soc_port_t port, soc_port_if_t intf);
typedef shr_error_e (*mbcm_dnxf_port_interface_get_f) (int unit, soc_port_t port, soc_port_if_t *intf);
...
typedef shr_error_e (*mbcm_dnxf_port_sync_e_divider_set_f) (int unit, int divider);
typedef shr_error_e (*mbcm_dnxf_port_sync_e_link_get_f) (int unit, int is_master, int *arg);
typedef shr_error_e (*mbcm_dnxf_port_sync_e_divider_get_f) (int unit, int *arg);
...
typedef shr_error_e (*mbcm_dnxf_warm_boot_buffer_id_supported_get_f) (int unit, int buffer_id, int *is_supported);
 ...
 *  have an SBX mbcm_s?bx_driver structure, will? return _SHR_E_NONE if the
 ...
 */
/*#define MBCM_SBX_DRIVER_MAYBE_CALL(_unit, _function, _args) ((mbcm_sbx_driver[_unit])?((mbcm_sbx_driver[_unit]->_function)?(mbcm_sbx_driver[_unit]->_function)_args:_SHR_E_NONE):_SHR_E_UNAVAIL)*/
