...
shr_error_e soc_ramon_fabric_cell_parse_table_get(int unit, soc_dnxc_fabric_cell_type_t cell_type, uint32 max_nof_lines, soc_dnxc_fabric_cell_parse_table_t *parse_table, uint32 *nof_lines);
...
#define SOC_RAMON_FABRIC_CELL_CPU_CAPTURED_FORMAT {\
    ...
    {soc_dnxc_fabric_cell_dest_id_cap_cell_pipe_index, NULL,          0,                2153,           2,      "PIPE_INDEX"},\
