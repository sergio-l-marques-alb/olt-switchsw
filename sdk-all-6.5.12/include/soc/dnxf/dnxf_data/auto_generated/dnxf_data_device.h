 ...
 */
typedef uint32(
    *dnxf_data_device_access_mdio_int_out_delay_default_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnxf_data_device_access_schan_timeout_usec_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnxf_data_device_access_schan_intr_enable_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnxf_data_device_access_miim_timeout_usec_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of mdio_int_out_delay_default
     */
    dnxf_data_device_access_mdio_int_out_delay_default_get_f mdio_int_out_delay_default_get;
    /**
     ...
     */
    dnxf_data_device_access_schan_timeout_usec_get_f schan_timeout_usec_get;
    /**
     * returns numeric data of schan_intr_enable
     */
    dnxf_data_device_access_schan_intr_enable_get_f schan_intr_enable_get;
    /**
     * returns numeric data of miim_timeout_usec
     */
    dnxf_data_device_access_miim_timeout_usec_get_f miim_timeout_usec_get;
    /**
 ...
 */
typedef uint32(
    *dnxf_data_device_interrupts_intr_all_disable_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of intr_all_disable
     */
    dnxf_data_device_interrupts_intr_all_disable_get_f intr_all_disable_get;
 ...
 */
typedef uint32(
    *dnxf_data_device_ha_warmboot_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of warmboot
     */
    dnxf_data_device_ha_warmboot_get_f warmboot_get;
    /**
