...
typedef int (*dnxf_state_modid_local_map_alloc_cb)(
    int unit, uint32 nof_instances_to_alloc);

/**
 * implemented by: dnxf_state_modid_local_map_is_allocated
 */
typedef int (*dnxf_state_modid_local_map_is_allocated_cb)(
...
/**
 * implemented by: dnxf_state_modid_group_map_is_allocated
 */
typedef int (*dnxf_state_modid_group_map_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_mc_id_map_is_allocated
 */
typedef int (*dnxf_state_mc_id_map_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_lb_group_to_first_link_is_allocated
 */
typedef int (*dnxf_state_lb_group_to_first_link_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_port_cl72_conf_is_allocated
 */
typedef int (*dnxf_state_port_cl72_conf_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_port_phy_lane_config_is_allocated
 */
typedef int (*dnxf_state_port_phy_lane_config_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_port_is_connected_to_repeater_is_allocated
 */
typedef int (*dnxf_state_port_is_connected_to_repeater_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_intr_flags_is_allocated
 */
typedef int (*dnxf_state_intr_flags_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_intr_storm_timed_count_is_allocated
 */
typedef int (*dnxf_state_intr_storm_timed_count_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_intr_storm_timed_period_is_allocated
 */
typedef int (*dnxf_state_intr_storm_timed_period_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_lane_map_db_lane2serdes_is_allocated
 */
typedef int (*dnxf_state_lane_map_db_lane2serdes_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
/**
 * implemented by: dnxf_state_lane_map_db_serdes2lane_is_allocated
 */
typedef int (*dnxf_state_lane_map_db_serdes2lane_is_allocated_cb)(
    int unit, uint8 *is_allocated);
...
typedef struct {
    ...
    dnxf_state_modid_local_map_is_allocated_cb is_allocated;
    /**
...
typedef struct {
    ...
    dnxf_state_modid_group_map_is_allocated_cb is_allocated;
    /**
...
typedef struct {
    ...
    dnxf_state_mc_id_map_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_lb_group_to_first_link_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_port_cl72_conf_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_port_phy_lane_config_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_port_is_connected_to_repeater_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_intr_flags_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_intr_storm_timed_count_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_intr_storm_timed_period_is_allocated_cb is_allocated;
...
typedef struct {
    ...
    dnxf_state_lane_map_db_lane2serdes_is_allocated_cb is_allocated;
    /**
...
typedef struct {
    ...
    dnxf_state_lane_map_db_serdes2lane_is_allocated_cb is_allocated;
    /**
     * Access struct for rx_id
     */
