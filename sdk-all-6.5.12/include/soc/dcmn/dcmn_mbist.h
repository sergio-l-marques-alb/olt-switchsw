...
typedef sand_mbist_script_t dcmn_mbist_script_t;


typedef sand_mbist_dynamic_t dcmn_mbist_dynamic_t;


typedef sand_mbist_device_t dcmn_mbist_device_t;
...
typedef sand_mbist_line_offset dcmn_mbist_line_offset; /* 14 bit offset of source script line from previous read */
