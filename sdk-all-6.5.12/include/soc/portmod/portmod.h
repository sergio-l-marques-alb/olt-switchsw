...
typedef struct portmod_port_ts_adjust_s {
    int speed;
    int osts_adjust; /**< MAC pipeline delay in OSTS */
    int tsts_adjust; /**< Delay of TS timer from TS clk to TSC_Clk domain */
...
typedef struct portmod_port_add_info_s {
    ...
    phymod_lane_map_t lane_map; /**< core lane map passed to phymod */
...
/*! 
 * @brief Flags to indicate which VCO is required based on the speed config. 
 */ 
 ...
 */
int portmod_pm_supported_vcos_get(int unit, portmod_dispatch_type_t pm_type, const portmod_vcos_speed_config_t* speed_config_list, int size, portmod_dual_vcos_t* dual_vco);
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_hdlc_fcs_size_t portmod_cpri_hdlc_fcs_size_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_CPRI_HDLC_FCS_SIZE_8_BITS _shrHdlcFcsSize8Bits
#define PORTMOD_CPRI_HDLC_FCS_SIZE_16_BITS _shrHdlcFcsSize16Bits
#define PORTMOD_CPRI_HDLC_FCS_SIZE_32_BITS _shrHdlcFcsSize32Bits
#endif /* CPRIMOD_SUPPORT */

#ifdef CPRIMOD_SUPPORT
typedef _shr_hdlc_filling_flag_pattern_t portmod_cpri_hdlc_filling_flag_pattern_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_CPRI_HDLC_FILLING_FLAG_PATTERN_7E _shrHdlcFillingFlagPattern7E
#define PORTMOD_CPRI_HDLC_FILLING_FLAG_PATTERN_7F _shrHdlcFillingFlagPattern7F
#define PORTMOD_CPRI_HDLC_FILLING_FLAG_PATTERN_FF _shrHdlcFillingFlagPatternFF
#endif /* CPRIMOD_SUPPORT */

#ifdef CPRIMOD_SUPPORT
typedef _shr_hdlc_flag_size_t portmod_cpri_hdlc_num_flag_bytes_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_HDLC_FLAG_SIZE_1_BYTE _shrHdlcNumFlagSizeOneByte
#define PORTMOD_HDLC_FLAG_SIZE_2_BYTE _shrHdlcNumFlagSizeTwoByte
#endif /* CPRIMOD_SUPPORT */

#ifdef CPRIMOD_SUPPORT
typedef _shr_hdlc_crc_mode_t portmod_cpri_crc_mode_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_CPRI_HDLC_CRC_MODE_APPEND _shrHdlcCrcAppend
#define PORTMOD_CPRI_HDLC_CRC_MODE_REPLACE _shrHdlcCrcReplace
#define PORTMOD_CPRI_HDLC_CRC_MODE_NO_UPDATE _shrHdlcCrcNoUpdate
#endif /* CPRIMOD_SUPPORT */

#ifdef CPRIMOD_SUPPORT
typedef _shr_hdlc_crc_init_val_t portmod_cpri_hdlc_crc_init_val_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_CPRI_HDLC_CRC_INIT_VAL_ALL_0 _shrHdlcCrcInitValAll0
#define PORTMOD_CPRI_HDLC_CRC_INIT_VAL_ALL_1 _shrHdlcCrcInitValAll1
#endif /* CPRIMOD_SUPPORT */
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_control_schan_num_bytes_t portmod_cpri_control_schan_num_bytes_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_1 _shrVsdCtrlSchanNumBytes1
#define PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_2 _shrVsdCtrlSchanNumBytes2
#define PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_4 _shrVsdCtrlSchanNumBytes4
#endif /* CPRIMOD_SUPPORT */

#ifdef CPRIMOD_SUPPORT
typedef _shr_control_flow_num_bytes_t portmod_cpri_control_flow_num_bytes_t;
...
typedef struct portmod_cpri_rx_vsd_config_info_s {
    uint32 schan_start; /**< sub channel start location */
    uint32 schan_size; /**< sub channel size. */
    portmod_cpri_control_schan_num_bytes_t schan_bytes; /**< Number of bytes */
    uint32 schan_steps; /**< control word steps */
    portmod_cpri_control_flow_num_bytes_t flow_bytes; /**< Number of Bytes per flow. */
    uint32 queue_num; /**< Queue Number */
...
typedef _shr_control_msg_proc_type_t portmod_control_msg_proc_type_t;

#define PORTMOD_CONTROL_MSG_PROC_TYPE_FE _shrCtrlMsgProcFE
#define PORTMOD_CONTROL_MSG_PROC_TYPE_FCB _shrCtrlMsgProcFCB
#define PORTMOD_CONTROL_MSG_PROC_TYPE_PAYLOAD _shrCtrlMsgProcPayload
#define PORTMOD_CONTROL_MSG_PROC_TYPE_FULL_MESSAGE _shrCtrlMsgProcFull
#define PORTMOD_CONTROL_MSG_PROC_TYPE_FULL_MESSAGE_W_TAG _shrCtrlMsgProcFullWithTag
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_fast_eth_config_t portmod_cpri_fast_eth_config_t;
...
typedef _shr_sync_count_cycle_t portmod_sync_count_cycle_t;

#define PORTMOD_SYNC_COUNT_CYCLE_EVERY_MF _shrSyncCountCycleEveryMF
#define PORTMOD_SYNC_COUNT_CYCLE_UP_TO_6MF _shrSyncCountCycleUpToSixMF
...
typedef _shr_tag_gen_entry_t portmod_tag_gen_entry_t;
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_cpri_crc_option_t portmod_cpri_crc_option_t;

#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
#define PORTMOD_CPRI_CRC_USE_ROE _shrCrcOptionUseRoe
#define PORTMOD_CPRI_CRC_REGENERATE _shrCrcOptionRegenerate
#endif /* CPRIMOD_SUPPORT */
 ...
 * portmod_pm_vcos_get
 *
 * @brief Get the VCO values for the list of speed ids that need to be supported 
 *
 * @param [in]  unit            - unit id
 * @param [in]  pm_type         - PM type
 * @param [out]  vco_select      - struct portmod_pm_vco_setting_t, list of speed configs to be populated to retrieve available VCOs
 */
int portmod_pm_vcos_get(int unit, portmod_dispatch_type_t pm_type, portmod_pm_vco_setting_t* vco_select);
 ...
 */
int portmod_pm_is_core_initialized(int unit, int pport, int lport, int* is_initialized);
 ...
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  port_mode       - port_mode
 * @param [in]  add_info        - port add info
 ...
 * @param [in]  unit            - unit id
 * @param [in]  pm_id           - port macro id
 * @param [in]  is_serdes_reset   - whether to reset serdes core
 * @param [in]  num_vco         - number of vco to change
 * @param [in]  vco             - vco rate
 */
