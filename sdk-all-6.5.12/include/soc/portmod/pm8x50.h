...
int pm8x50_port_interface_config_set(int unit, int port, pm_info_t pm_info, const portmod_port_interface_config_t* config, int phy_init_flags);
int pm8x50_port_interface_config_get(int unit, int port, pm_info_t pm_info, portmod_port_interface_config_t* config, int phy_init_flags);
...
int pm8x50_port_ability_local_get(int unit, int port, pm_info_t pm_info, uint32 phy_flags, portmod_port_ability_t* ability);
...
int pm8x50_port_llfc_control_set(int unit, int port, pm_info_t pm_info, const portmod_llfc_control_t* control);
int pm8x50_port_llfc_control_get(int unit, int port, pm_info_t pm_info, portmod_llfc_control_t* control);
...
/*Port remote Adv get*/
int pm8x50_port_adv_remote_get(int unit, int port, pm_info_t pm_info, int* value);
...
int pm8x50_port_tsc_refclock_set(int unit, int port, pm_info_t pm_info, int ref_in, int ref_out);
int pm8x50_port_tsc_refclock_get(int unit, int port, pm_info_t pm_info, int* ref_in, int* ref_out);
...
int pm8x50_port_mib_reset_toggle(int unit, int port, pm_info_t pm_info, int port_index);
...
int pm8x50_pm_specific_capability_get(int unit, portmod_pm_capability_t* pm_cap);
...
int pm8x50_port_pm_core_init(int unit, pm_info_t pm_info, int pport, int lport, uint32 flags, const portmod_port_add_info_t* add_info);

/*Returns if the PortMacro associated with the port is initialized or not*/
int pm8x50_pm_is_initialized(int unit, pm_info_t pm_info, int pport, int lport, int* is_initialized);

/*Port speed validation.*/
int pm8x50_port_speed_config_validate(int unit, int port, const portmod_speed_config_t* speed_config, portmod_pbmp_t* affected_pbmp);

/*Enable port macro.*/
int pm8x50_pm_enable(int unit, int port, pm_info_t pm_info, int port_mode, const portmod_port_add_info_t* add_info, int enable);
...
int pm8x50_pm_vco_reconfig(int unit, int pm_id, pm_info_t pm_info, int is_serdes_reset, int num_vco, const portmod_vco_type_t* vco);
