...
typedef enum drv_field_qualify_e {
    ...
    drvFieldQualifyOamEgressClassSrcMac = 601, /* To qualify on SourceMac Class ID
                                           ...
                                           registers. */
    drvFieldQualifyMyStation2Hit = 602, /* Applicable when RIOT is enabled or l2
    ...
    drvFieldQualifySysHdrType = 693,    /* Qualifier is to match on incoming
                                           packet system header type */
    drvFieldQualifySubportTagPresent = 694, /* Match on packet's subport tag */
    drvFieldQualifyNetworkTagType = 695, /* Match on Network (VnTag/Etag) */
    drvFieldQualifyCnTagPresent = 696,  /* Match on congestion tag */
    drvFieldQualifyL2PktType = 697,     /* Match on L2 Packet Type
                                           (Ethernet/Snap/Llc/None) */
    drvFieldQualifyPktType = 698,       /* Match on Packet type after L2 header */
    drvFieldQualifyMplsCwPresent = 699, /* Match on MPLS Control word */
    drvFieldQualifyMplsMcastEthertypePresent = 700, /* Match on Multicast MPLS Ethertype */
    drvFieldQualifyIpv4OptionHdrType = 701, /* Match on IPv4 Option header types. */
    drvFieldQualifyIpv6ExtensionHdrType = 702, /* Match on IPv6 Extension header types. */
    drvFieldQualifyOverlayVlanFormat = 703, /* Match on Overlay vlan tag format. */
    drvFieldQualifyOverlayL2PktType = 704, /* Match on Overlay L2 Packet type */
    drvFieldQualifyOverlayPktType = 705, /* Match on Overlay Packet type */
    drvFieldQualifyOverlayIpv4OptionHdrType = 706, /* Match on Overlay IPv4 option header
                                           types */
    drvFieldQualifyOverlayIpv6ExtensionHdrType = 707, /* Match on Overlay IPv6 option header
                                           types */
    drvFieldQualifyFrontPanelPkt = 708, /* Match on packets incoming from Front
                                           panel ports */
    drvFieldQualifyHiGigProxyTunnelType = 709, /* Match on incoming HiGig Proxy tunnel
                                           types */
    drvFieldQualifyIpFragPkt = 710,     /* Match on IP Fragment packet */
    drvFieldQualifyOuterPriTaggedPkt = 711, /* Match on Outer priority tagged packet */
    drvFieldQualifyIpInIpPkt = 712,     /* Match on IP in IP packet */
    drvFieldQualifyIpmcV4Pkt = 713,     /* Match on packets with IPMC IPv4
                                           packet */
    drvFieldQualifyIpmcV6Pkt = 714,     /* Match on packets with IPMC IPv6
                                           packet */
    drvFieldQualifyIpChecksumOkPkt = 715, /* Match on IP packet with Checksum OK */
    drvFieldQualifyNetworkTagMulticastPkt = 716, /* Match on multicast packets with VNTAG
                                           or ETAG */
    drvFieldQualifyIpTtlZeroPkt = 717,  /* Match on IP packet with Zero TTL
                                           value */
    drvFieldQualifyPimBidirDfStatus = 718, /* Match on PIM Bi-directional
                                           Designated Forwarder status */
    drvFieldQualifyInterfaceClassL2Type = 719, /* Qualifier is to to indicate whether
                                           the Interface L2 Class ID is from VFI
                                           or VLAN */
    drvFieldQualifyIntPktVersionOne = 720, /* Match on the INT (Inband-Telemetry)
                                           Version One. The data '1' indicates
                                           the INT version is set to 1, 0
                                           indicates version other than 1. */
    drvFieldQualifyIntPktOverflowed = 721, /* Match on the INT (Inband-Telemetry)
    ...
    drvFieldQualifyIntPktLengthValid = 722, /* Match on the INT (Inband-Telemetry)
                                           ...
                                           metadata. */
    drvFieldQualifyIntPktType = 723,    /* Match on the INT (Inband-Telemetry)
                                           Message Type (bcmFieldIntPktTypeXX). */
    drvFieldQualifyIntPktFinalHop = 724, /* Match on the INT (Inband-Telemetry)
                                           Maximum Hop Limit Check, the data '1'
                                           indicates INT exceeds Max Hop Count
                                           (Hop Limit >= Hop Count). */
    drvFieldQualifyTunnelSubType = 725, /*  TunnelType (bcmFieldTunnelSubTypeXXX
                                           in bcm_field_tunnel_subtype_t). */
    drvFieldQualifyNshServicePathId = 726, /*  Match on NSH Service Path ID. */
    drvFieldQualifyNshServiceIndex = 727, /*  Match on NSH Service Index. */
    drvFieldQualifyKeyGenVar = 728,     /*  Match on Key Gen Var */
    drvFieldQualifyRoeFrameType = 729,  /*  Match on Roe frame type set in MPLS
    ...
    drvFieldQualifyBfdGoodPkt = 730,    /* Match on BFD Good packet (Good here
                                           represents the valid TTL range for
                                           1-hop and M-hop). */
    drvFieldQualifyBfdPktWithDstIpLoopbackAddr = 731, /* Match whether the incoming BFD packet
                                           has destination loopback IP Address. */
    drvFieldQualifyMplsControlPkt = 732, /* Match on MPLS Control Packet (packet
                                           with VCCV_1/2/3/4 and
                                           [LSP]/GAL/G-ACH). */
    drvFieldQualifyStageIngressFlowtracker = 733, /*  Field Processor pipeline ingress
                                           flowtracker stage. */
    drvFieldQualifyInterfaceClassMplsLookup1 = 734, /* Qualifies on Class identifier derived
                                           from MPLS label 1 entry Lookup. */
    drvFieldQualifyInterfaceClassMplsLookup2 = 735, /* Qualifies on Class identifier derived
                                           from MPLS label 2 entry Lookup. */
    drvFieldQualifyInterfaceClassMplsLookup3 = 736, /* Qualifies on Class identifier derived
                                           from MPLS label 3 entry Lookup. */
    drvFieldQualifyInterfaceClassL3Tunnel = 737, /* Qualifies on Class identifier derived
                                           from L3 Tunnel. */
    drvFieldQualifyBfdPktVersionOne = 738, /* Match on BFD Version One. The data
                                           '1' indicates the ersion as 1, 0
                                           indicates version other than 1. */
    drvFieldQualifyGenevePktVersionZero = 739, /* Match on Geneve Version Zero. The
                                           data '1' indicates the version as 0,
                                           '0' indicates version other than 0. */
    drvFieldQualifyGpePktVersionZero = 740, /* Match on Gpe Version Zero. The data
                                           '1' indicates the version as 0, '0'
                                           indicates version other than 0. */
    drvFieldQualifyGenevePktWithOam = 741, /* Match on BFD over Geneve Packet. */
    drvFieldQualifyGpePktWithOam = 742, /* Match on BFD over Gpe Packet. */
    drvFieldQualifyInnerBfdPktVersionOne = 743, /* Match on Inner BFD Version One. The
                                           data '1' indicates the ersion as 1, 0
                                           indicates version other than 1. */
    drvFieldQualifyPktDstAddrType = 744, /*  Match on Packet destination address
                                           type. */
    drvFieldQualifyPktInnerDstAddrType = 745, /*  Match on Packet inner destination
                                           address type. */
    drvFieldQualifyInnerL4Ports = 746,  /*  Four bytes after Inner L3 header are
                                           available. */
    drvFieldQualifyTafEnable = 747,     /* Qualifies on TAF (Time Aware
                                           Filtering) enable */
    drvFieldQualifyTafGateId = 748,     /* Qualifies on TAF(Time Aware
                                           Filtering) gate id */
    drvFieldQualifyTafGateState = 749,  /* Qualifies on TAF(Time Aware
                                           Filtering) gate state */
    drvFieldQualifyTafCosProfile = 750, /* Qualifies on TAF(Time Aware
                                           Filtering) CoS profile */
    drvFieldQualifyElkRangeL4DstPort = 751, /* Qualifies for L4 Dst port of ELK
                                           range */
    drvFieldQualifyElkRangeL4SrcPort = 752, /* Qualifies for L4 Src port of ELK
                                           range */
    drvFieldQualifyIp6PktNextHeader = 753, /* Qualifies for Next Header protocol
                                           field in IPv6 header. */
    drvFieldQualifyIp6PktHopLimit = 754, /* Qualifies for Hop limit protocol
                                           field in IPv6 header. */
    drvFieldQualifyIp6PktTrafficClass = 755, /* Qualifies for Traffic Class protocol
                                           field in IPv6 header. */
    drvFieldQualifyInnerIp6PktNextHeader = 756, /* Qualifies for Next Header protocol
                                           field in Inner IPv6 header. */
    drvFieldQualifyInnerIp6PktHopLimit = 757, /* Qualifies for Hop limit protocol
                                           field in Inner IPv6 header. */
    drvFieldQualifyInnerIp6PktTrafficClass = 758, /* Qualifies for Traffic Class protocol
                                           field in Inner IPv6 header. */
    drvFieldQualifyCount = 759          /* Always Last. Not a usable value. */
} drv_field_qualify_t;
...
typedef enum drv_field_action_e {
    ...
    drvFieldActionEsmSearchKeySrcMac = 490, /* This action sets ESM search key to
                                           ...
                                           Lookup */
    drvFieldActionTrunkResilientHashEnable = 491, /* Forcefully Enable Resilient hashing
                                           for Trunk groups. */
    drvFieldActionTrunkResilientHashDisable = 492, /* Forcefully Disable Resilient hashing
                                           for Trunk groups. */
    drvFieldActionEcmpResilientHashEnable = 493, /* Forcefully Enable Resilient hashing
                                           for ECMP groups. */
    drvFieldActionEcmpResilientHashDisable = 494, /* Forcefully Disable Resilient hashing
                                           for ECMP groups. */
    drvFieldActionHiGigTrunkResilientHashEnable = 495, /* Forcefully Enable Resilient hashing
                                           for HiGig Trunk groups. */
    drvFieldActionHiGigTrunkResilientHashDisable = 496, /* Forcefully Disable Resilient hashing
                                           for HiGig Trunk groups. */
    drvFieldActionMacSecDecrypt = 497,  /* This action adds MACSEC Decrypt OLP
                                           header in Egress  Pipe. This action
                                           does not modify packet in Egress
                                           Pipe. */
    drvFieldActionMacSecEncrypt = 498,  /* This action only adds MACSEC Encrypt
                                           OLP header in Egress Pipe. */
    drvFieldActionMacSecSubPortNumAdd = 499, /* This action assigns MACSEC Subport
                                           number to be used by MACSEC engine
                                           for Security Association lookup */
    drvFieldActionMacSecPktTypeSet = 500, /* This action assigns a MACSEC packet
                                           type to be used in MACSEC block.
                                           MACSEC packet type is defined by
                                           bcm_field_macsec_pkt_type_t. */
    drvFieldActionLatencyFlowId = 501,  /* Update Latency-Flow-Id in OAM-TS
                                           HEADER; param0: New Latency-Flow-Id
                                           value. */
    drvFieldActionIntEncapEnable = 502, /* This action triggers to insert INT
                                           metadata header to the incoming valid
                                           INT packet. */
    drvFieldActionIntTurnAround = 503,  /* This action triggers to turn-around
                                           the packet if it fails to detect the
                                           INT packet (one of the case if the
                                           packet reaches hop limit). */
    drvFieldActionMacSecRedirectIpmc = 504, /* This action redirects multicast
                                           MACSEC packets to MACSEC engine and
                                           also adds OLP header in Egress
                                           Pipeline. */
    drvFieldActionAddIngOuterVlanToEgrOuterVlan = 505, /* This action is to add the incoming
                                           outer VLAN tag to the outgoing packet
                                           in Egress Pipeline. */
    drvFieldActionErspan3HdrVlanCosPktCopy = 506, /* This action is to copy the incoming
                                           outer VLAN and COS in the outgoing
                                           ERSPAN3 header. */
    drvFieldActionErspan3HdrSgtAdd = 507, /* This action is to add the SGT
                                           (Security Group Tag) in ERSPAN3
                                           header. */
    ...
    drvFieldActionFlowtrackerGroupId = 510, /* This action is to associate
                                           flowtracker group. */
    drvFieldActionStatisticPtr0 = 511,  /* Statistic pointer 0 for statistic
                                           interface (stat I/F). */
    drvFieldActionStatisticPtr1 = 512,  /* Statistic pointer 1 for statistic
                                           interface (stat I/F). */
    drvFieldActionTafGatePriMap = 513,  /* This action specify the priority
                                           mapping of TAF (Time Aware Filtering)
                                           gate. */
    drvFieldActionIntEncapUpdate = 514, /* This action triggers to update
                                           existing INT metadata header of a
                                           incoming valid INT packet. */
    drvFieldActionCount = 515           /* Always Last. Not a usable value. */
} drv_field_action_t;
