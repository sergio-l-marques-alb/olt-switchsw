...
#define ARAD_KBP_ENABLE_ANY_IPV6UC_PROGRAM  (ARAD_KBP_ENABLE_IPV6_UC || ARAD_KBP_ENABLE_IPV6_EXTENDED)
...
typedef enum
{
    ...
    ARAD_KBP_FRWRD_LTR_IPV4_DC                       = 28,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED                 = 30,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED_FOR_IP          = 31,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED_FOR_IP_WITH_RPF = 32,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED_FOR_LSR         = 33,
    ARAD_KBP_FRWRD_LTR_IP_LSR_EXTENDED_IPV6          = 34,
    ARAD_KBP_FRWRD_LTR_IP_LSR_EXTENDED_P2P           = 35,

    /* Dummy forwarding */
    ARAD_KBP_FRWRD_LTR_DUMMY_FRWRD                   = 36,
    ARAD_KBP_MAX_FRWRD_LTR_ID                        = ARAD_KBP_FRWRD_LTR_DUMMY_FRWRD,

    ARAD_KBP_ACL_LTR_ID_OFFSET                       = 38,
