...
#define ARAD_PP_RIF_ISEM_RES_SERVICE_TYPE_P2P                    (7)   /* used for MPLS & PWE cases where destination is provided by the InLIF directly */
 ...
 *  PWE label is accoring to pwe_outlif entry, 
 *  tunnel labels are according to fec resolution.
