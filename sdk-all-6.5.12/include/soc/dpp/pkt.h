...
typedef struct soc_pkt_dnx_trajectory_trace_info_s {
    uint8 observation_info;     /* Observation information */
    _shr_gport_t destination;    /* Destination */
    _shr_gport_t src_sysport;    /* Source system port */
} soc_pkt_dnx_trajectory_trace_info_t;

/* Ase information */
typedef struct soc_pkt_dnx_ase_info_s {
    soc_pkt_dnx_trajectory_trace_info_t trajectory_trace_info; /* Trajectory trace information */
