...
typedef enum drv_stat_val_e {
    ...
    DRV_SNMP_BCM_RX_CODE_ERRORS = 125,  /* Fabric RX 8b/10b code errors.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_RX_RS_FEC_BIT_ERROR = 126, /* Fabric RX RS-FEC bit error counter.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_RX_RS_FEC_SYMBOL_ERROR = 127, /* RX RS-FEC symbol error counter.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_RX_LLFC_PRIMARY = 128, /* Fabric RX LLFC Primary.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_RX_LLFC_SECONDARY = 129, /* Fabric RX LLFC Secondary.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_CUSTOM_RECEIVE0 = 130, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE1 = 131, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE2 = 132, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE3 = 133, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE4 = 134, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE5 = 135, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE6 = 136, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE7 = 137, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_RECEIVE8 = 138, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT0 = 139, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT1 = 140, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT2 = 141, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT3 = 142, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT4 = 143, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT5 = 144, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT6 = 145, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT7 = 146, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT8 = 147, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT9 = 148, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT10 = 149, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT11 = 150, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT12 = 151, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT13 = 152, /* Broadcom-specific */
    DRV_SNMP_BCM_CUSTOM_TRANSMIT14 = 153, /* Broadcom-specific */
    DRV_SNMP_DOT3_STATS_IN_RANGE_LENGTH_ERROR = 154, /* RFC 1284 */
    DRV_SNMP_DOT3_OMP_EMULATION_CRC8_ERRORS = 155, /* RFC 4837 */
    DRV_SNMP_DOT3_MPCP_RX_GATE = 156,   /* RFC 4837 */
    DRV_SNMP_DOT3_MPCP_RX_REGISTER = 157, /* RFC 4837 */
    DRV_SNMP_DOT3_MPCP_TX_REG_REQUEST = 158, /* RFC 4837 */
    DRV_SNMP_DOT3_MPCP_TX_REG_ACK = 159, /* RFC 4837 */
    DRV_SNMP_DOT3_MPCP_TX_REPORT = 160, /* RFC 4837 */
    DRV_SNMP_DOT3_EPON_FEC_CORRECTED_BLOCKS = 161, /* RFC 4837 */
    DRV_SNMP_DOT3_EPON_FEC_UNCORRECTABLE_BLOCKS = 162, /* RFC 4837 */
    DRV_SNMP_BCM_PON_IN_DROPPED_OCTETS = 163, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_OUT_DROPPED_OCTETS = 164, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_IN_DELAYED_OCTETS = 165, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_OUT_DELAYED_OCTETS = 166, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_IN_DELAYED_HUNDRED_US = 167, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_OUT_DELAYED_HUNDRED_US = 168, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_IN_FRAME_ERRORS = 169, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_IN_OAM_FRAMES = 170, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_OUT_OAM_FRAMES = 171, /* Broadcom-specific */
    DRV_SNMP_BCM_PON_OUT_UNUSED_OCTETS = 172, /* Broadcom-specific */
    DRV_SNMP_BCM_ETHER_STATS_PKTS9217TO16383_OCTETS = 173, /* Broadcom-specific */
    DRV_SNMP_BCM_RECEIVED_PKTS9217TO16383_OCTETS = 174, /* Broadcom-specific */
    DRV_SNMP_BCM_TRANSMITTED_PKTS9217TO16383_OCTETS = 175, /* Broadcom-specific */
    DRV_SNMP_BCM_RX_VLAN_TAG_FRAME = 176, /* Broadcom-specific */
    DRV_SNMP_BCM_RX_DOUBLE_VLAN_TAG_FRAME = 177, /* Broadcom-specific */
    DRV_SNMP_BCM_TX_VLAN_TAG_FRAME = 178, /* Broadcom-specific */
    DRV_SNMP_BCM_TX_DOUBLE_VLAN_TAG_FRAME = 179, /* Broadcom-specific */
    DRV_SNMP_BCM_RX_P_F_C_CONTROL_FRAME = 180, /* PFC Receive Control Frame */
    DRV_SNMP_BCM_TX_P_F_C_CONTROL_FRAME = 181, /* PFC Transmit Control Frame */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY0 = 182, /* Receive PFC Frame Priority 0 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY1 = 183, /* Receive PFC Frame Priority 1 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY2 = 184, /* Receive PFC Frame Priority 2 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY3 = 185, /* Receive PFC Frame Priority 3 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY4 = 186, /* Receive PFC Frame Priority 4 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY5 = 187, /* Receive PFC Frame Priority 5 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY6 = 188, /* Receive PFC Frame Priority 6 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_XON_PRIORITY7 = 189, /* Receive PFC Frame Priority 7 XON to
                                           XOFF */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY0 = 190, /* Receive PFC Frame Priority 0 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY1 = 191, /* Receive PFC Frame Priority 1 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY2 = 192, /* Receive PFC Frame Priority 2 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY3 = 193, /* Receive PFC Frame Priority 3 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY4 = 194, /* Receive PFC Frame Priority 4 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY5 = 195, /* Receive PFC Frame Priority 5 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY6 = 196, /* Receive PFC Frame Priority 6 */
    DRV_SNMP_BCM_RX_P_F_C_FRAME_PRIORITY7 = 197, /* Receive PFC Frame Priority 7 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY0 = 198, /* Transmit PFC Frame Priority 0 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY1 = 199, /* Transmit PFC Frame Priority 1 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY2 = 200, /* Transmit PFC Frame Priority 2 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY3 = 201, /* Transmit PFC Frame Priority 3 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY4 = 202, /* Transmit PFC Frame Priority 4 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY5 = 203, /* Transmit PFC Frame Priority 5 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY6 = 204, /* Transmit PFC Frame Priority 6 */
    DRV_SNMP_BCM_TX_P_F_C_FRAME_PRIORITY7 = 205, /* Transmit PFC Frame Priority 7 */
    DRV_SNMP_FCM_PORT_CLASS3_RX_FRAMES = 206, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_CLASS3_TX_FRAMES = 207, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_CLASS3_DISCARDS = 208, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_CLASS2_RX_FRAMES = 209, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_CLASS2_TX_FRAMES = 210, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_CLASS2_DISCARDS = 211, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_INVALID_CRCS = 212, /* RFC 4044 */
    DRV_SNMP_FCM_PORT_DELIMITER_ERRORS = 213, /* RFC 4044 */
    DRV_SNMP_BCM_SAMPLE_INGRESS_PKTS = 214, /* Total number of packets eligible to
                                           be sampled by Ingress Sampler.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_SAMPLE_INGRESS_SNAPSHOT_PKTS = 215, /* Total number of eligible packets when
                                           the last packet was sampled by
                                           Ingress sampler. (Broadcom-specific) */
    DRV_SNMP_BCM_SAMPLE_INGRESS_SAMPLED_PKTS = 216, /* Total number of packets sampled by
                                           Ingress sampler. (Broadcom-specific) */
    DRV_SNMP_BCM_SAMPLE_FLEX_PKTS = 217, /* Total number of packets eligible to
                                           be sampled by Flex sampler enabled by
                                           IFP ingress sampling policy action.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_SAMPLE_FLEX_SNAPSHOT_PKTS = 218, /* Total number of eligible packets when
                                           the last packet was sampled by Flex
                                           sampler enabled by IFP ingress
                                           sampling policy action.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_SAMPLE_FLEX_SAMPLED_PKTS = 219, /* Total number of packets sampled by
                                           Flex sampler enabled by IFP ingress
                                           sampling policy action.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_EGRESS_PROTECTION_DATA_DROP = 220, /* Egress Protection data drop in EPIPE.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_TX_E2_E_C_C_CONTROL_FRAMES = 221, /* Total number of End to End Congestion
                                           Control(E2E-CC) Head of line(HOL)
                                           packets or DMVoQ flow control packets
                                           transmitted on each of the ports.
                                           (Broadcom-specific) */
    DRV_SNMP_BCM_E2_E_H_O_L_DROP_PKTS = 222, /* Total number of packets dropped due
                                           to E2EHOL (End to End Head of Line)
                                           drop status. (Broadcom-specific) */
    DRV_SNMP_ETHER_STATS_TX_CRC_ALIGN_ERRORS = 223, /* RFC 1757 (EtherStat) */
    DRV_SNMP_ETHER_STATS_TX_JABBERS = 224, /* RFC 1757 (EtherStat) */
    DRV_SNMP_BCM_MAC_MERGE_TX_FRAG = 225, /* Number of additional mPackets
                                           transmitted due to preemption. */
    DRV_SNMP_BCM_MAC_MERGE_TX_VERIFY_FRAME = 226, /* Number of transmitted verify
                                           mPackets. */
    DRV_SNMP_BCM_MAC_MERGE_TX_REPLY_FRAME = 227, /* Number of transmitted reply mPackets. */
    DRV_SNMP_BCM_MAC_MERGE_RX_FRAME_ASS_ERRORS = 228, /* Number of packets with reassembly
                                           errors in MAC receive direction. */
    DRV_SNMP_BCM_MAC_MERGE_RX_FRAME_SMD_ERRORS = 229, /* Number of received packets rejected
                                           due to unknown SMD value or arriving
                                           with an SMD-C when no packet is in
                                           progress. */
    DRV_SNMP_BCM_MAC_MERGE_RX_FRAME_ASS = 230, /* Number of received packets that were
                                           successfully reassembled. */
    DRV_SNMP_BCM_MAC_MERGE_RX_FRAG = 231, /* Number of additional mPackets
                                           received due to preemption. */
    DRV_SNMP_BCM_MAC_MERGE_RX_VERIFY_FRAME = 232, /* Number of received verify mPackets. */
    DRV_SNMP_BCM_MAC_MERGE_RX_REPLY_FRAME = 233, /* Number of received reply mPackets. */
    DRV_SNMP_BCM_MAC_MERGE_RX_FINAL_FRAG_SIZE_ERROR = 234, /* Number of the received mPackets which
                                           are less than non-final fragments
                                           size. */
    DRV_SNMP_BCM_MAC_MERGE_RX_FRAG_SIZE_ERROR = 235, /* Number of received mPackets which are
                                           less than final fragments size. */
    DRV_SNMP_BCM_MAC_MERGE_RX_DISCARD = 236, /* Number of all discarded mPackets
                                           because of error conditions. */
    DRV_SNMP_BCM_MAC_MERGE_HOLD_COUNT = 237, /* Number of hold request primitive
                                           events. */
    DRV_SNMP_BCM_RX_BIP_ERROR_COUNT = 238, /* RX BER and BIP counter. */
    DRV_SNMP_VAL_COUNT = 239 
} drv_stat_val_t;
...
{ \
    ...
    "DRV_SNMP_BCM_RX_RS_FEC_BIT_ERROR", \
    "DRV_SNMP_BCM_RX_RS_FEC_SYMBOL_ERROR", \
    ...
    "DRV_SNMP_BCM_RX_BIP_ERROR_COUNT"  \
}
