 ...
 */
#define APPL_INIT_ADVANCED_F_MEM_LEAK_DETECT   0x1
/*
 * Memory Logging
 */
#define APPL_INIT_ADVANCED_F_MEM_LOG           0x2

/*
 * Time Stamp saving Activated.
 */
#define APPL_INIT_ADVANCED_F_TIME_STAMP        0x4
/*
 * Time Stamp saving Activated.
 */
#define APPL_INIT_ADVANCED_F_TIME_LOG          0x8
/*
 * SW state resources Logging
 */
#define APPL_INIT_ADVANCED_F_SWSTATE_LOG       0x10

/*
 * SW state resources testing
 */
#define APPL_INIT_ADVANCED_F_SWSTATE_RESOURCE       0x20
...
struct appl_dnxc_init_step_s
{
    ...
    /**
     * List of substeps (optinal - might be null if not required)
     */
