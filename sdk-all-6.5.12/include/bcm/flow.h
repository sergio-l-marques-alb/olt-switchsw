...
#define BCM_FLOW_ENCAP_VNID_VALID       (1 << 0)   /* VN_ID element is valid for
                                                      this encap. */
...
#define BCM_FLOW_ENCAP_TPID_VALID       (1 << 7)   /* service tag TPID valid. */
#define BCM_FLOW_ENCAP_FLEX_KEY_VALID   (1 << 8)   /* logical fields for key. */
#define BCM_FLOW_ENCAP_FLEX_DATA_VALID  (1 << 9)   /* logical fields for
                                                      attributes. */
#define BCM_FLOW_ENCAP_DVP_GROUP_VALID  (1 << 10)  /* DVP group ID. */
#define BCM_FLOW_ENCAP_OIF_GROUP_VALID  (1 << 11)  /* L3 OUT interface group ID. */
#define BCM_FLOW_ENCAP_FLAGS_VALID      (1 << 12)  /* flags for hardware control
                                                      parameters. */
#endif
...
typedef enum bcm_flow_encap_criteria_e {
    ...
    BCM_FLOW_ENCAP_CRITERIA_COUNT = 8   /* Must be last. */
...
#define BCM_FLOW_PORT_DEFAULT           (1 << 5)   /* Create FLOW Default
                                                      Network Port */
#endif
