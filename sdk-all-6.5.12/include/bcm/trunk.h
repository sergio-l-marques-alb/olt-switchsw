...
#define BCM_TRUNK_ID_SET(trunk_id, core, pool, group)  _SHR_TRUNK_ID_SET(trunk_id, core, pool, group) 
#define BCM_TRUNK_ID_CORE_GET(core, trunk_id)  _SHR_TRUNK_ID_CORE_GET(core, trunk_id) 
...
#define BCM_TRUNK_CORE_ALL      _SHR_TRUNK_CORE_ALL 
