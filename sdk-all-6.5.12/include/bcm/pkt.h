...
typedef struct bcm_pkt_dnx_trajectory_trace_info_s {
    uint8 observation_info;     /* Observation information */
    bcm_gport_t destination;    /* Destination */
    bcm_gport_t src_sysport;    /* Source system port */
} bcm_pkt_dnx_trajectory_trace_info_t;

/* Ase information */
typedef struct bcm_pkt_dnx_ase_info_s {
    bcm_pkt_dnx_trajectory_trace_info_t trajectory_trace_info; /* Trajectory trace information */
...
typedef enum bcm_pkt_dnx_otsh_type_e {
    ...
    bcmPktDnxOtshTypeL588v2 = _SHR_PKT_DNX_OTSH_TYPE_L588v2, /* OAM-TS type is 1588v2 */
...
#define BCM_PKT_TRACE_LEARN         0x1        /* learning ensable on internal
                                                  trace packet */
#define BCM_PKT_TRACE_NO_IFP        0x2        /* disable ingress field
                                                  processor lookup on internal
                                                  trace packet */
#define BCM_PKT_TRACE_FORWARD       0x4        /* forward internal trace packet
                                                  to egress */
#define BCM_PKT_TRACE_DROP_TO_MMU   0x8        /* Drop trace packet to MMU else
                                                  forward to egress */
#define BCM_PKT_TRACE_DROP_TO_EGR   0x10       /* Drop trace packet to egress */
