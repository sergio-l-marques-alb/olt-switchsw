...
#define THREAD 512 /* offsetof(struct task_struct, thread)	 # */
#define MM 192 /* offsetof(struct task_struct, mm)	 # */
#define MMCONTEXTID 396 /* offsetof(struct mm_struct, context.id)	 # */
...
#define THREAD_NORMSAVES 32 /* offsetof(struct thread_struct, normsave[0])	 # */
#define THREAD_FPEXC_MODE 368 /* offsetof(struct thread_struct, fpexc_mode)	 # */
#define THREAD_FPR0 104 /* offsetof(struct thread_struct, fpr[0])	 # */
#define THREAD_FPSCR 360 /* offsetof(struct thread_struct, fpscr)	 # */
#define PGDIR 64 /* offsetof(struct thread_struct, pgdir)	 # */
#define THREAD_DBCR0 68 /* offsetof(struct thread_struct, dbcr0)	 # */
#define THREAD_EVR0 388 /* offsetof(struct thread_struct, evr[0])	 # */
#define THREAD_ACC 520 /* offsetof(struct thread_struct, acc)	 # */
#define THREAD_SPEFSCR 528 /* offsetof(struct thread_struct, spefscr)	 # */
#define THREAD_USED_SPE 532 /* offsetof(struct thread_struct, used_spe)	 # */
#define TI_FLAGS 64 /* offsetof(struct thread_info, flags)	 # */
...
#define TASK_SIZE -1073741824 /* TASK_SIZE	 # */
#define NUM_USER_SEGMENTS 12 /* TASK_SIZE>>28	 # */
...
#define CFG_ICACHE_BLOCKSZ 116 /* offsetof(struct vdso_data, icache_block_size)	 # */
#define CFG_DCACHE_BLOCKSZ 112 /* offsetof(struct vdso_data, dcache_block_size)	 # */
#define CFG_ICACHE_LOGBLOCKSZ 124 /* offsetof(struct vdso_data, icache_log_block_size)	 # */
#define CFG_DCACHE_LOGBLOCKSZ 120 /* offsetof(struct vdso_data, dcache_log_block_size)	 # */
...
#define PGD_TABLE_SIZE 4096 /* PGD_TABLE_SIZE	 # */
#define PTE_SIZE 4 /* sizeof(pte_t)	 # */
#define TLBCAM_SIZE 20 /* sizeof(struct tlbcam)	 # */
#define TLBCAM_MAS0 0 /* offsetof(struct tlbcam, MAS0)	 # */
#define TLBCAM_MAS1 4 /* offsetof(struct tlbcam, MAS1)	 # */
#define TLBCAM_MAS2 8 /* offsetof(struct tlbcam, MAS2)	 # */
#define TLBCAM_MAS3 12 /* offsetof(struct tlbcam, MAS3)	 # */
#define TLBCAM_MAS7 16 /* offsetof(struct tlbcam, MAS7)	 # */
