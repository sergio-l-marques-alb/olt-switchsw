...
#define FSL_GIANFAR_DEV_HAS_VLAN		0x00000000 /* PTIN (JVM) prevent cpu to add default VLAN on untagged interfaces after creating a virtual interface (vconfig add): 0x00000020 */
