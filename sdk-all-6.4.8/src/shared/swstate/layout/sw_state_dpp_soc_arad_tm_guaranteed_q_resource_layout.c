...
int sw_state_dpp_soc_arad_tm_guaranteed_q_resource_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   soc_dpp_guaranteed_q_resource_t* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(soc_dpp_guaranteed_q_resource_t),"soc_dpp_guaranteed_q_resource_t"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "guaranteed_q_resource",             /* name */         
                                   sizeof(soc_dpp_guaranteed_q_resource_t),             /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   0,                 /* array size 0 */ 
                                   0));                  /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->ocb)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
...
int sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
...
int sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_total_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->total)) - (( uint8*) dummy_struct); 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_used_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->used)) - (( uint8*) dummy_struct); 
