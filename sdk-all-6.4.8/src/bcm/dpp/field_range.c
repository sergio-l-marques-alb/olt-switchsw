/*
 * $Id: field_range.c,v 1.25 Broadcom SDK $
                                      ...
                                      int *count)
{
    ...
    int32 qualFlags;
    unsigned int index;
    bcm_field_range_t offset;
    bcm_field_range_t limit;
    _bcm_dpp_field_range_idx_t rangeCount;
    int total = 0;
    ...
    for (rangeType = 0;
        ...
        for (entryType = 0, found = FALSE;
            ...
            for (offset = 0;
                ...
                } /* if (SOC_PPD_NOF_FP_QUAL_TYPES > qual[offset]) */
                    ...
                    if (BCM_E_NONE != result) {
                        LOG_ERROR(BSL_LS_BCM_FP,
                                  (BSL_META_U(unit,
                                              ...
                                              " %s (%d) size for unit %d"
                                              " stage %u: %d (%s)\n"),
                                   SOC_PPD_FP_QUAL_TYPE_to_string(mapData[index]),
                                   mapData[index],
                                   unit,
                                   unitData->devInfo->stMapInfo[entryType].stmStage,
                                   result,
            ...
            LOG_CLI((BSL_META_U(unit,
                     ...
                     _bcm_dpp_field_qual_name[qual],
                     qual,
                     SOC_PPD_FP_QUAL_TYPE_to_string(mapData[0]),
                     mapData[0],
