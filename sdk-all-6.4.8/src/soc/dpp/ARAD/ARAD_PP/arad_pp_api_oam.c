/* $Id: arad_pp_api_oam.c,v 1.27 Broadcom SDK $
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_init()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_deinit()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_icc_map_register_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_icc_map_register_get_verify(
          unit,
          icc_ndx,
          data
        );
...
*/
  SOC_SAND_TAKE_DEVICE_SEMAPHORE;
/*
  res = arad_pp_oam_icc_map_register_get_unsafe(
          unit,
          icc_ndx,
          data
        );
...
*/
  /*res = 1;*/
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_icc_map_register_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oam1_entries_insert_default_profile()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_OAM_CLASSIFIER_OAM1_2_ENTRIES_INSERT_ACCORDING_TO_PROFILE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = arad_pp_oam_classifier_oam1_2_entries_insert_according_to_profile_verify(
          unit,
          is_server,
          classifier_mep_entry,
		  profile_data,
  ...
  res = arad_pp_oam_classifier_oam1_2_entries_insert_according_to_profile_unsafe(
          unit,
          is_server,
          classifier_mep_entry,
		  profile_data,
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oam1_2_entries_insert_according_to_profile()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem_mep_profile_replace()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem_mep_add()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_mep_delete()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_classifier_oem1_entry_set_verify(
          unit,
          oem1_key,
          oem1_payload
        );
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem1_entry_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_classifier_oem1_entry_get_verify(
          unit,
          oem1_key,
    	  oem1_payload,
    	  is_found
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem1_entry_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_classifier_oem1_entry_delete_verify(
          unit,
          oem1_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem1_entry_delete()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_classifier_oem2_entry_set_verify(
          unit,
          oem2_key,
          oem2_payload
        );
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem2_entry_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_classifier_oem2_entry_get_verify(
          unit,
          oem2_key,
    	  oem2_payload,
    	  is_found
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem2_entry_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
/*
  res = arad_pp_oam_classifier_oem2_entry_delete_verify(
          unit,
          oem1_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_oem2_entry_delete()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_rmep_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_rmep_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_rmep_delete()", 0, 0);
}

/*********************************************************************
*     Get RMEP db entry index from Exact match
 *    Details: in the H file. (search for prototype)
*********************************************************************/
uint32
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_rmep_index_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_mep_db_entry_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_mep_db_entry_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_mep_db_entry_delete()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_find_mep_and_profile_by_lif_and_mdlevel()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_counter_range_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_counter_range_get()", 0, 0);
}
...
uint32
  arad_pp_oam_event_fifo_read(
    SOC_SAND_IN  int                                        unit,
    SOC_SAND_IN   JER_PP_OAM_API_DMA_EVENT_TYPE                 event_type,
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_pp_pct_profile_set()", local_port_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_pp_pct_profile_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_eth_oam_opcode_map_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_ipv4_tos_ttl_select_set()", ipv4_tos_ttl_select_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_ipv4_tos_ttl_select_get()", ipv4_tos_ttl_select_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_ipv4_src_addr_select_set()", ipv4_src_addr_select_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_ipv4_src_addr_select_get()", ipv4_src_addr_select_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_tx_rate_set()", bfd_tx_rate_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_tx_rate_get()", bfd_tx_rate_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_req_interval_pointer_set()", req_interval_pointer, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_req_interval_pointer_get()", req_interval_pointer, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_mpls_pwe_profile_set()", push_profile, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_mpls_pwe_profile_get()", push_profile, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_mpls_udp_sport_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_mpls_udp_sport_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_ipv4_udp_sport_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_ipv4_udp_sport_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_pdu_static_register_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_pdu_static_register_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_cc_packet_static_register_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_cc_packet_static_register_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_discriminator_range_registers_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_discriminator_range_registers_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_tx_ipv4_multi_hop_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_tx_ipv4_multi_hop_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_tx_priority_registers_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_tx_priority_registers_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_enable_interrupt_message_event_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_enable_interrupt_message_event_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_diag_profile_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_diag_profile_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_flags_profile_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_bfd_flags_profile_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_mep_passive_active_enable_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_mep_passive_active_enable_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_punt_event_hendling_profile_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_punt_event_hendling_profile_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_error_trap_id_and_destination_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_oamp_error_trap_id_and_destination_get()", 0, 0);
}
  ...
  )
{
    ...
    res = arad_pp_oam_oamp_create_new_eth1731_profile_verify(unit, endpoint_id,profile_indx,was_previously_alloced,eth1731_profile);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

    SOC_SAND_TAKE_DEVICE_SEMAPHORE;

    res = arad_pp_oam_oamp_create_new_eth1731_profile_unsafe(unit, endpoint_id,profile_indx,was_previously_alloced,eth1731_profile);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
  ...
  )
{
    ...
    res = arad_pp_oam_oamp_lm_dm_remove_unsafe(unit, endpoint_id,is_lm, exists_piggy_back_down,num_removed , removed_index);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_counter_disable_map_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_classifier_counter_disable_map_get()", 0, 0);
}
       ...
       )
{
    ...
    res = arad_pp_oam_oamp_rx_trap_codes_set_unsafe(unit,mep_type,trap_code );
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
       ...
       )
{
    ...
    res = arad_pp_oam_oamp_rx_trap_codes_delete_unsafe(unit,mep_type,trap_code );
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
       ...
       )
{
    ...
    JER_PP_OAM_API_DMA_EVENT_TYPE event_type;
    uint32
      res = SOC_SAND_OK;
    ...
    event_type = (JER_PP_OAM_API_DMA_EVENT_TYPE)
    ...
    /* NOTE :
       SOC_SAND_TAKE_DEVICE_SEMAPHORE shoult NOT be taken in this case 
       since arad_pp_oam_dma_event_handler_unsafe simply regeisters a callback.
       the callback uses BCM APIs, so in case SOC_SAND_TAKE_DEVICE_SEMAPHORE is 
       taken here this can cause a deadlock scenario of 2 threads that take
       SOC_SAND_..._SEMAPHORE & ~BCM_LEVEL_SEMAPHORE in reverse order.
    */

    res = arad_pp_oam_dma_event_handler_unsafe(unit, event_type);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
    SOC_SAND_EXIT_AND_SEND_ERROR("Error in arad_pp_oam_diag_print_lookup()",0,0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
    SOC_SAND_EXIT_AND_SEND_ERROR("Error in arad_pp_get_crps_counter()",0,0);
}
