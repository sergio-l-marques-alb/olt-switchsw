...
/*	{
    ...
    printf("\nfrwrd_table_id = %d, data_indx = %d\n************************************\n", frwrd_table_id, data_indx);
	}*/
    ...
    )
{
  ...
  case ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_UC_0:
    res = arad_pp_flp_lookups_tcam_profile_set(unit,0,access_profile_id,ARAD_PP_FLP_KEY_PROGRAM_IPV4UC);
    SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
    break;
  case ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_UC_1:
    res = arad_pp_flp_lookups_tcam_profile_set(unit,1,access_profile_id,ARAD_PP_FLP_KEY_PROGRAM_IPV4UC);
    SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
    break;
  ...
  case ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_MC:
    if (SOC_DPP_CONFIG(unit)->l3.ipmc_vpn_lookup_enable) {
        res = arad_pp_flp_lookups_tcam_profile_set(unit,0,access_profile_id,ARAD_PP_FLP_KEY_PROGRAM_IPV4COMPMC_WITH_RPF);      
    } else {
  ...
  case ARAD_PP_FRWRD_IP_TCAM_ID_IPV6_UC:
      res = arad_pp_flp_lookups_tcam_profile_set(unit,0,access_profile_id,ARAD_PP_FLP_KEY_PROGRAM_IPV6UC);
    break;
  ...
  case ARAD_PP_FRWRD_IP_TCAM_ID_IPV6_MC:
      ...
      {
          res = arad_pp_flp_lookups_tcam_profile_set(unit,0,access_profile_id,ARAD_PP_FLP_KEY_PROGRAM_IPV6MC);	        
      }
    break;
  ...
  case ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_MC_SSM:
      if (soc_property_get(unit, spn_IPMC_L2_SSM_MODE, 0)) {
          res = arad_pp_flp_lookups_tcam_profile_set(unit,0,access_profile_id,ARAD_PP_FLP_KEY_PROGRAM_IPV4MC_WITH_RPF);
      }
  }
...
static 
    ARAD_PP_FRWRD_IP_TCAM_KBP_TABLE_ATTRIBUTES
        Arad_pp_frwrd_ip_tcam_kbp_table_attributes[ARAD_KBP_FRWRD_IP_NOF_TABLES] = {
            ...
            {       {{0, 32},     {32,28},      {64,12},       {0, 0},       {0, 0},},        10}, /* IPV4_MC */
