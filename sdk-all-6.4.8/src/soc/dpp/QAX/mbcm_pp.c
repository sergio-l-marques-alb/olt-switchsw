...
CONST mbcm_pp_functions_t mbcm_pp_jericho_driver = {
	...
	arad_pp_mtr_meter_ins_bucket_get,
		NULL,          /* arad_pp_ptp_p2p_delay_set */
		NULL,          /* arad_pp_ptp_p2p_delay_get */
    soc_jer_eg_encap_map_encap_intpri_color_set,
    soc_jer_eg_encap_map_encap_intpri_color_get,
	soc_jer_pp_oam_tod_set,
    NULL,   /*arad_pp_flp_dbal_bfd_echo_program_tables_init*/
    ...
    NULL, /*   arad_pp_llp_parse_packet_format_eg_info_set */
    NULL, /*arad_pp_llp_parse_packet_format_eg_info_get */
  	NULL /* mbcm_pp_oam_slm_set*/,
	NULL /*arad_pp_oam_counter_increment_bitmap_set*/	,
	NULL, /* mbcm_pp_mtr_policer_global_sharing_set */
	NULL, /* mbcm_pp_mtr_policer_global_sharing_get */
