/* $Id: ppc_api_trap_mgmt.c,v 1.22 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/ppc/src/soc_ppc_api_trap_mgmt.c
*
* MODULE PREFIX:  soc_ppc_trap
*
* FILE DESCRIPTION:
*
* REMARKS:
  ...
  )
{
  ...
  LOG_CLI((BSL_META_U(unit,
                      "is_trapped: %u\n\r"),info->is_trapped));
  LOG_CLI((BSL_META_U(unit,
                      "cpu_trap_code: %s (%u)\n\r"), SOC_PPC_TRAP_CODE_to_string(info->cpu_trap_code), info->cpu_trap_code));
  LOG_CLI((BSL_META_U(unit,
  ...
  LOG_CLI((BSL_META_U(unit,
                      "user_header_ptr: %u \n\r"),info->user_header_ptr));
  LOG_CLI((BSL_META_U(unit,
                      "lb_key: %u \n\r"),info->lb_key));
  LOG_CLI((BSL_META_U(unit,
                      "pph_unknown_addr: %u\n\r"),info->pph_unknown_addr));
  LOG_CLI((BSL_META_U(unit,
                      "pph_fwd_hdr_offset: %u \n\r"),info->pph_fwd_hdr_offset));
  LOG_CLI((BSL_META_U(unit,
                      "dsp_ext: %u \n\r"),info->dsp_ext));
  LOG_CLI((BSL_META_U(unit,
                      "stacking_ext: %u \n\r"),info->stacking_ext));
