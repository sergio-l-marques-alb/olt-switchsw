/*
 * $Id: sbZfCaPtPte4PortStateEntry.c,v 1.2 Broadcom SDK $
...
sbZfCaPtPte4PortStateEntry_Pack(sbZfCaPtPte4PortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE4PORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE4PORTSTATEENTRY_SIZE_IN_BYTES;
}
