...
sbZfC2PpeDescriptor_Unpack(sbZfC2PpeDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uBuffer =  (uint32)  ((pFromData)[173] >> 7) & 0x01;
  (pToStruct)->m_uBuffer |=  (uint32)  (pFromData)[174] << 1;
  (pToStruct)->m_uBuffer |=  (uint32)  ((pFromData)[175] & 0x1f) << 9;

  /* Unpack Member: m_uExceptIndex */
  (pToStruct)->m_uExceptIndex =  (uint32)  ((pFromData)[173] ) & 0x7f;
