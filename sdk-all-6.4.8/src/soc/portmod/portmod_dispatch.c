...
int portmod_port_add_info_t_init(int unit, portmod_port_add_info_t* portmod_port_add_info)
{
    ...
    portmod_port_add_info->sys_interface = 0;
...
int portmod_port_interface_config_set(int unit, int port, const portmod_port_interface_config_t* config, int all_phy)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_interface_config_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_interface_config_set(unit, port, pm_info, config, all_phy);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_xphy_lane_connection_t_init(int unit, portmod_xphy_lane_connection_t* portmod_xphy_lane_connection)
{
    ...
    portmod_xphy_lane_connection->ss_lane = PORTMOD_LANE_INDEX_INVALID;
    portmod_xphy_lane_connection->ls_lane = PORTMOD_LANE_INDEX_INVALID;
...
int portmod_port_phy_intr_enable_set(int unit, int port, phymod_intr_source_t intr_src, uint32 intr_enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_enable_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_enable_set(unit, port, pm_info, intr_src, intr_enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_phy_intr_enable_get(int unit, int port, phymod_intr_source_t intr_src, uint32* intr_enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_enable_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_enable_get(unit, port, pm_info, intr_src, intr_enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_phy_intr_status_get(int unit, int port, phymod_intr_source_t intr_src, uint32* intr_status)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_status_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_status_get(unit, port, pm_info, intr_src, intr_status);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_phy_intr_status_clear(int unit, int port, phymod_intr_source_t intr_src)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_status_clear) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_intr_status_clear(unit, port, pm_info, intr_src);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_polarity_update_set(int unit, int port, int lane)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_polarity_update_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_polarity_update_set(unit, port, pm_info, lane);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_polarity_update_set isn't implemented for driver type"));
    }
