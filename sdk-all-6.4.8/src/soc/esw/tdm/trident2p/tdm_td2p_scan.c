...
**/
int
tdm_td2p_scan_slice_min(unsigned char port, int *tdm, int lim, int *slice_start_idx, int pos)
{
...
**/
int
tdm_td2p_scan_slice_max(unsigned char port, int *tdm, int lim, int *slice_start_idx, int pos)
{
...
**/
int
tdm_td2p_scan_slice_size_local(unsigned char idx, int *tdm, int lim, int *slice_start_idx)
{
...
**/
int
tdm_td2p_scan_mix_slice_min(unsigned char port, int *tdm, int lim, int *slice_start_idx, int pos)
{
	int i, k=0, idx0, slice_size_min=256, slice_idx=-1 , idx_start;
	if (pos>=0 && pos<lim) {
		/* linerate */
...
**/
int
tdm_td2p_scan_mix_slice_max(unsigned char port, int *tdm, int lim, int *slice_start_idx, int pos)
{
	int i, k=0, idx0, slice_size_max=0, slice_idx=-1 , idx_start;
	if (pos>=0 && pos<lim) {
		/* linerate */
...
**/
int
tdm_td2p_scan_mix_slice_size_local(unsigned char idx, int *tdm, int lim, int *slice_start_idx)
{
	int i, slice_size=(-1), idx_start=(-1);
...
**/
int
tdm_td2p_check_shift_cond_pattern(unsigned char port, int *tdm_tbl, int tdm_tbl_len, int **tsc, int dir)
{
...
**/
int
tdm_td2p_check_shift_cond_local_slice(unsigned char port, int *tdm_tbl, int tdm_tbl_len, int **tsc, int dir)
{
