...
cint 
print lag_hashing_main(0, <in_port>, <out_port>, <nof_ports>); 
...
run: 
config_per_port_lag_hashing(0, <in_port>, 1, 1); 
...
run: 
config_per_port_lag_hashing(0, <in_port>, 3, 0); 
...
run: 
disable_lag_hashing(0); 
lag_hash_func_config(0, BCM_HASH_CONFIG_ROUND_ROBIN); 
