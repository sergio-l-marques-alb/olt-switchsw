...
mpls_lsr_config_init(int *units_ids, int nof_units, int extend_example){
    ...
    for (i = 0 ; i < nof_units ; i++){
        ...
        if (test_fec_format_c) {
          ...
          l3_egress.gport = mpls_lsr_info_1.eg_port;
          l3_egress.vlan = mpls_lsr_info_1.eg_vid;
          l3_egress.next_hop_mac_addr = mpls_lsr_info_1.next_hop_mac;
          l3_egress.intf = ingress_intf3;
          l3_egress.encap_id = encap_id;
          l3_egress.l3_egress_id = egress_intf;
          ...
          egress_intf = l3_egress.l3_egress_id;
        }
    }
    ...
    if (test_fec_format_c) {
      ...
      mpls_lsr_info_1.encap_id = l3_egress.encap_id;
      mpls_lsr_info_1.egress_intf = l3_egress.l3_egress_id;    
    }
...
int add_test_fec_format_c_fields(int unit, bcm_l3_egress_t* l3eg){
    int rv;
...
create_l3_egress(int unit, uint32 flags, int port, int vlan, int ingress_intf, bcm_mac_t nh_mac_addr, int *intf, int *encap_id) {
    ...
    if (test_fec_format_c) {
        add_test_fec_format_c_fields(unit, &l3eg);
