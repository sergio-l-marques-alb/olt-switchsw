...
CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         portmod_port_polarity_update_set,
                         int, int, unit, 0, 0,
                         int, int, port, 0, 0,
                         int, int, lane, 0, 0);
...
static cint_function_t __cint_functions[] =
{
    ...
    CINT_FWRAPPER_ENTRY(portmod_port_polarity_update_set),
...
__cint_maddr__portmod_port_interface_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 9: rv = &(s->port_op_mode);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__portmod_port_add_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 7: rv = &(s->flags);break;
        case 8: rv = &(s->ilkn_core_id);break;
        case 9: rv = &(s->ilkn_port_is_over_fabric);break;
        case 10: rv = &(s->ilkn_burst_max);break;
        case 11: rv = &(s->ilkn_burst_short);break;
        case 12: rv = &(s->ilkn_metaframe_period);break;
        case 13: rv = &(s->rx_retransmit);break;
        case 14: rv = &(s->tx_retransmit);break;
        case 15: rv = &(s->phy_op_mode);break;
        case 16: rv = &(s->phy_op_datapath);break;
        case 17: rv = &(s->sys_interface);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__portmod_xphy_lane_connection_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 1: rv = &(s->ss_lane);break;
        case 2: rv = &(s->ls_lane);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static cint_parameter_desc_t __cint_struct_members__portmod_port_add_info_t[] = 
{
    ...
    {"phymod_interface_t", "sys_interface", 0, 0},
    { NULL }
};
