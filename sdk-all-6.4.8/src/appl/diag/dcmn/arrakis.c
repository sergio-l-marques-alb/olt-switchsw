...
#include <appl/diag/dcmn/arrakis.h>
...
STATIC void diag_dnx_arrakis_export_usage(int unit);
STATIC cmd_result_t diag_dnx_arrakis_export(int unit, args_t* a);

STATIC void diag_dnx_arrakis_signals_usage(int unit);
STATIC cmd_result_t diag_dnx_arrakis_signals(int unit, args_t* a);
STATIC void diag_dnx_arrakis_dump_usage(int unit);
...
typedef enum diag_dnx_arrakis_type_e
{
    ...
    diag_dnx_arrakis_type_dump          = 3,
    diag_dnx_arrakis_type_export        = 4,
    diag_dnx_arrakis_type_signals       = 5,

    /*Must be last!*/
    diag_dnx_arrakis_type_nof = 6
...
const diag_dnx_table_t diag_dnx_arrakis_pack[] = {
    ...
    {"dump",                diag_dnx_arrakis_dump,                  diag_dnx_arrakis_dump_usage,            diag_dnx_arrakis_type_dump},
    {"signals",             diag_dnx_arrakis_signals,               diag_dnx_arrakis_signals_usage,         diag_dnx_arrakis_type_signals},
    {"export",              diag_dnx_arrakis_export,                diag_dnx_arrakis_export_usage,          diag_dnx_arrakis_type_export},
...
/* Diag Arrakis Export */
STATIC void
diag_dnx_arrakis_export_usage(int unit)
{
    cli_out("'export stage=<parser/vt/tt/flp> [file=target_file ]' - export PP Stage programs&tables into targte_file.xml\n");
}

STATIC cmd_result_t
diag_dnx_arrakis_export(int unit, args_t* args)
{
#if 1
    return CMD_FAIL;
#endif
...
STATIC void
diag_dnx_arrakis_dump_usage(int unit){
#if 1
    cli_out("Not Supported\n");
#endif

}

cmd_result_t
diag_dnx_arrakis_signals(int unit, args_t* a){
#if 1
    return CMD_FAIL;
#endif
}
STATIC void
diag_dnx_arrakis_signals_usage(int unit){
#if 1
    cli_out("'Not Supported\n");
#endif
}
