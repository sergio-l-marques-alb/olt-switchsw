/*
 * $Id: sbFe2000XtMemAccess.c,v 1.18 Broadcom SDK $
...
sbFe2000XtShowMemNames(void)
{
   ...
   for(i = 0; i < FE2KXT_MEM_MAX_INDEX; i++) {
       cli_out("%-32s",memConfigTableXt[i].memname);
       if ((i+1)%3 == 0)
	 cli_out("\n");
   }
   cli_out("\n");
   ...
   CAD_UINT                     uAddress,
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEAG0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueueAg0Entry_Unpack(&PrPortToQueueAg0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEAG1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueueAg1Entry_Unpack(&PrPortToQueueAg1Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEPCI:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueuePciEntry_Unpack(&PrPortToQueuePciRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRPORTTOQUEUESR0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueueSr0Entry_Unpack(&PrPortToQueueSr0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRPORTTOQUEUESR1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueueSr1Entry_Unpack(&PrPortToQueueSr1Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEXG0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueueXg0Entry_Unpack(&PrPortToQueueXg0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEXG1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PrPortToQueueXg1Entry_Unpack(&PrPortToQueueXg1Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRCC2TCAMCONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PrCcTcamConfigEntry_Unpack(&PrCcTcamConfigEntry,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRCC2CAMRAM:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PrCcCamRamNonLastEntry_Unpack(&PrCcCamRamNonLastEntry,(uint8 *)dbuf,sizeof(dbuf));
          if (PrCcCamRamNonLastEntry.m_uLast == 1) {
             sbZfC2PrCcCamRamLastEntry_Unpack(&PrCcCamRamLastEntry,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PRCC2QUEUERAM:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PrCcQueueRamEntry_Unpack(&PrCcQueueRamEntry,(uint8 *)dbuf,sizeof(dbuf));
          sbZfC2PrCcQueueRamEntry_Unpack(&PrCcQueueRamEntry,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PDLRPOUTPUTHEADERCOPYBUFFER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,8);
          sbZfC2PdLrpOutputHeaderCopyBufferEntry_Unpack(&PdLrpOutputHeaderCopyBufferRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PDPDOUTPUTHEADERCOPYBUFFER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,8);
          sbZfC2PdPdOutputHeaderCopyBufferEntry_Unpack(&PdPdOutputHeaderCopyBufferRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_LRLRPINSTRUCTIONMEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2LrLrpInstructionMemoryEntry_Unpack(&LrLrpInstructionMemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMBUFFERSTATE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmBufferState0Entry_Unpack(&QmBufferState0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMBUFFERSTATE1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2QmBufferState1Entry_Unpack(&QmBufferState1Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMBUFFERSTATE2:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmBufferState2Entry_Unpack(&QmBufferState2Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMBUFFERSTATE3:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmBufferState3Entry_Unpack(&QmBufferState3Record,(uint8 *)dbuf,sizeof(dbuf));
...
/* MCM was missing DequeueState0 code */
    case FE2KXT_MEM_QMDEQUEUESTATE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2QmDequeueState0Entry_Unpack(&QmDequeueState0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMDEQUEUESTATE1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmDequeueState1Entry_Unpack(&QmDequeueState1Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMFREEPAGEFIFO:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmFreePageFifoEntry_Unpack(&QmFreePageFifoRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMNEXTBUFFER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmNextBufferEntry_Unpack(&QmNextBufferRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMNEXTPAGE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmNextPageEntry_Unpack(&QmNextPageRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMQUEUECONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2QmQueueConfigEntry_Unpack(&QmQueueConfigRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMQUEUECOUNTERS:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2QmQueueCountersEntry_Unpack(&QmQueueCountersRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMQUEUEHEADPTR:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmQueueHeadPtrEntry_Unpack(&QmQueueHeadPtrRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMQUEUESTATE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmQueueState0Entry_Unpack(&QmQueueState0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMQUEUESTATE0EN:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmQueueState0EnEntry_Unpack(&QmQueueState0EnRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMQUEUESTATE1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmQueueState1Entry_Unpack(&QmQueueState1Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_QMREPLICATIONSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2QmReplicationStateEntry_Unpack(&QmReplicationStateRecord,(uint8 *)dbuf,sizeof(dbuf));
 ...
 /* MCM no PmCounter zframe */
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PmCounterMemoryEntry_Unpack(&PmCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PMPROFILEMEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PmProfileMemoryEntry_Unpack(&PmProfileMemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_SR0COUNTER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2SrCounterEntry_Unpack(&SrCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPAGGREGATEHASHBITCONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PpAggregateHashBitConfigEntry_Unpack(&PpAggregateHashBitConfigRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPAGGREGATEHASHBYTECONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PpAggregateHashByteConfigEntry_Unpack(&PpAggregateHashByteConfigRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPCAMCONFIGURATIONINSTANCE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PpCamConfigurationInstance0Entry_Unpack(&PpCamConfigurationInstance0Record,(uint8 *)dbuf,sizeof(dbuf));
 ...
 * Instance1 - 4 */
    ...
    case FE2KXT_MEM_PPCAMRAMCONFIGURATIONINSTANCE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,6);
          sbZfC2PpCamRamConfigurationInstance0Entry_Unpack(&PpCamRamConfigurationInstance0Record,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPHEADERRECORDSIZE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PpHeaderRecordSizeEntry_Unpack(&PpHeaderRecordSizeRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPINITIALQUEUESTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,5);
          sbZfC2PpInitialQueueStateEntry_Unpack(&PpInitialQueueStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPPPOUTHEADERCOPY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,8);
          sbZfC2PpPpOutHeaderCopyEntry_Unpack(&PpPpOutHeaderCopyRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPQUEUEPRIORITYGROUP:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PpQueuePriorityGroupEntry_Unpack(&PpQueuePriorityGroupRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PPRXPORTDATA:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,4);
          sbZfC2PpRxPortDataEntry_Unpack(&PpRxPortDataRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_RC0DATA:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2RcDataEntry_Unpack(&RcDataRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_ST0COUNTER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2StCounterEntry_Unpack(&StCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM0INTERNAL0MEMORY:
        ...
        sbFe2000XtImfDriver_Mm0Internal0MemoryRead(  uBaseAddress, 
                                                   ...
                                                   pData1); 
        if (status == SAND_DRV_C2_STATUS_OK) {
  cli_out("Mm0Internal0MemoryRead data0=0x%x data1=0x%x\n",*pData0, *pData1);
          sbSwapWords(pData,2);
  cli_out("Mm0Internal0MemorySWAP data0=0x%x data1=0x%x\n",*pData0, *pData1);
          sbZfC2MmInternal0MemoryEntry_Unpack(&MmInternal0MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM0INTERNAL1MEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2MmInternal1MemoryEntry_Unpack(&MmInternal1MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM0NARROWPORT0MEMORY:
        ...
        sbFe2000XtImfDriver_Mm0NarrowPort0MemoryRead(  uBaseAddress, 
                                                     ...
                                                     pData1); 
        if (status == SAND_DRV_C2_STATUS_OK) {
	  cli_out("Mm0NarrowPort0[@0x%06x]: 0x%08x 0x%08x\n",uAddress, *pData0, *pData1);
	  /*
  cli_out("Mm0NarrowPort0MemoryRead data0=0x%x data1=0x%x\n",*pData0, *pData1);
          sbSwapWords(pData,2);
  cli_out("Mm0NarrowPort0MemorySWAP data0=0x%x data1=0x%x\n",*pData0, *pData1);
          sbZfC2MmNarrowPort0MemoryEntry_Unpack(&MmNarrowPort0MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM0NARROWPORT1MEMORY:
        ...
        sbFe2000XtImfDriver_Mm0NarrowPort1MemoryRead(  uBaseAddress, 
                                                     ...
                                                     pData1); 
        if (status == SAND_DRV_C2_STATUS_OK) {
	  cli_out("Mm0NarrowPort1[@0x%06x]: 0x%08x 0x%08x\n",uAddress, *pData0, *pData1);
	  /*
          sbSwapWords(pData,2);
          sbZfC2MmNarrowPort1MemoryEntry_Unpack(&MmNarrowPort1MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM0WIDEPORTMEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2MmWidePortMemoryEntry_Unpack(&MmWidePortMemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM1NARROWPORT0MEMORY:
        ...
        sbFe2000XtImfDriver_Mm1NarrowPort0MemoryRead(  uBaseAddress, 
                                                     ...
                                                     pData1); 
        if (status == SAND_DRV_C2_STATUS_OK) {
	  cli_out("Mm1NarrowPort0[@0x%06x]: 0x%08x 0x%08x\n",uAddress, *pData0, *pData1);
          sbSwapWords(pData,2);
    ...
    case FE2KXT_MEM_MM1NARROWPORT1MEMORY:
        ...
        sbFe2000XtImfDriver_Mm1NarrowPort1MemoryRead(  uBaseAddress, 
                                                     ...
                                                     pData1); 
        if (status == SAND_DRV_C2_STATUS_OK) {
	  cli_out("Mm1NarrowPort1[@0x%06x]: 0x%08x 0x%08x\n", uAddress, *pData0, *pData1);
          sbSwapWords(pData,2);
          /* The output below can't be redirected to a file with diag shell "file=". 	  */
	  sbZfC2MmNarrowPort1MemoryEntry_Unpack(&MmNarrowPort1MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbZfC2MmNarrowPort1MemoryEntry_Print(&MmNarrowPort1MemoryRecord);
    ...
    case FE2KXT_MEM_PB0DATA:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PbDataEntry_Unpack(&PbDataRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTMIRRORINDEX:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,5);
          sbZfC2PtMirrorIndexEntry_Unpack(&PtMirrorIndexRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPORTTOQUEUEAG0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PtPortToQueueEntry_Unpack(&PtPortToQueueRecord,(uint8 *)dbuf,sizeof(dbuf));
...
/* MCM - ? use PrPortXXX_Unpack - or - us PtPortToQueueEntry_Unpack ??? */
    ...
    case FE2KXT_MEM_PTPTE0MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte0MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE0PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte0PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE1MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte1MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE1PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte1PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE2MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte2MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE2PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte2PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE3MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte3MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE3PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte3PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE4MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte4MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE4PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte4PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE5MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte5MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE5PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte5PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE6MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PtMirrorPortStateEntry_Unpack(&PtPte6MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTPTE6PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,3);
          sbZfC2PtPortStateEntry_Unpack(&PtPte6PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_PTQUEUETOPORT:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,1);
          sbZfC2PtQueueToPortEntry_Unpack(&PtQueueToPortRecord,(uint8 *)dbuf,sizeof(dbuf));
...
#else
int sbFe2000XtMemAcess_not_empty;
