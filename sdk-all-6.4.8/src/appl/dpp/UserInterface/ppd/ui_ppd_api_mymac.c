                               ...
                               )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_MYMAC_VRRP_INFO_clear(&prm_vrrp_info);
                               ...
                               )
{
  ...
  SOC_PPD_MYMAC_VRRP_INFO_print(&prm_vrrp_info);
                                ...
                                )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_MYMAC_TRILL_INFO_clear(&prm_trill_info);
                                ...
                                )
{
  ...
  SOC_PPD_MYMAC_TRILL_INFO_print(&prm_trill_info);
