...
int sesto_phy_interface_config_set(const phymod_phy_access_t* phy, uint32_t flags, const phymod_phy_inf_config_t* config)
{
    ...
    if (chip_id != SESTO_CHIP_ID_82764) {
        ...
        aux_mode->gearbox_100g_inverse_mode = PHYMOD_INTF_CONFIG_PORT_PHY_MODE_REVERSE_GET(phy);
    } else {
 ...
 *            18 = INT_MUX_SIGDET_LOST,
 *            19 = INT_MUX_SIGDET_FOUND,
 *            20 = INT_PLL_10G_LOCK_LOST
 *            21 = INT_PLL_10G_LOCK_FOUND
 *            24 = INT_DEMUX_PMD_LOCK_LOST,
 *            25 = INT_DEMUX_PMD_LOCK_FOUND,
 *            26 = INT_DEMUX_SIGDET_LOST,
 *            27 = INT_DEMUX_SIGDET_FOUND,
 *            28 = INT_PLL_25G_LOCK_LOST,
 *            29 = INT_PLL_25G_LOCK_FOUND,
 *            36 = INT_DEMUX_PCS_MON_LOCK_LOST,
 *            37 = INT_DEMUX_PCS_MON_LOCK_FOUND,
 *            38 = INT_DEMUX_FIFOERR,
 *            39 = INT_DEMUX_CL73_AN_RESTARTED,
 *            40 = INT_DEMUX_CL73_AN_COMPLETE,
 *            45 = INT_MUX_PCS_MON_LOCK_LOST,
 *            46 = INT_MUX_PCS_MON_LOCK_FOUND,
 *            47 = INT_MUX_FIFOERR,
 *            48 = INT_MUX_CL73_AN_RESTARTED,
 *            49 = INT_MUX_CL73_AN_COMPLETE,
 *            50 = INT_MUX_CL73_AN_RESTARTED_P2,
 *            51 = INT_MUX_CL73_AN_RESTARTED_P1,
 *            52 = INT_MUX_CL73_AN_COMPLETE_P2,
 *            53 = INT_MUX_CL73_AN_COMPLETE_P1
 *
