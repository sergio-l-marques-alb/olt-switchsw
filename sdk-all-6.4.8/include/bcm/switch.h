...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchNonUcVlanShapingEnable = 948, /*  Enable/disable the ability of
                                           ...
                                           queues */
    bcmSwitchReserved949 = 949,         /* SwitchReserved949 */
    bcmSwitchReserved950 = 950,         /* SwitchReserved950 */
    bcmSwitchReserved951 = 951,         /* SwitchReserved951 */
    bcmSwitchReserved952 = 952,         /* SwitchReserved952 */
    ...
    bcmSwitchEcmpGroupMemberMode = 959, /* Set/get ECMP group mode. */
    bcmSwitchReserved960 = 960,         /* Reserved960 */
    bcmSwitchReserved961 = 961,         /* Reserved961 */
    ...
    bcmSwitchHashMPLSExcludeGAL = 967,  /* To exclude GAL label from hash
                                           computation */
    bcmSwitchReserved968 = 968,         /* Reserved968 */
    bcmSwitchReserved969 = 969,         /* Reserved969 */
    bcmSwitchReserved970 = 970,         /* Reserved970 */
    ...
    bcmSwitchDropSobmhOnLinkDown = 976, /* Enable/Disable SOBMH blocking on link
                                           down egress port */
    bcmSwitch__Count = 977              /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_hash_field_e {
    ...
    bcmSwitchFlexHashFieldCount = 2 /* field count in flexible hash RAM table */
} bcm_switch_hash_field_t;

/* flexible hash entry configuration struct. */
typedef struct bcm_switch_hash_entry_config_s {
    uint32 flags;                       /* flags should be zero for today */
...
typedef enum bcm_switch_pkt_trace_resolution_e {
    ...
    bcmSwitchPktTraceResolutionCount = 52 
...
typedef enum bcm_switch_agm_type_e {
    ...
    bcmSwitchAgmTypeL3Ecmp = 2,         /* Forwarding group is an Ecmp Trunk
                                           group */
    bcmSwitchAgmTypeCount = 3           /* Maximum AGM type count */
