...
/* portmod_xphy_core_info_t initialization and validation */
...
int portmod_xphy_add(int unit, int xphy_id, const portmod_xphy_core_info_t* xphy_core_info);
int portmod_xphy_delete(int unit, int xphy_id);
int portmod_xphy_core_info_set(int unit, uint32 xphy_id, const portmod_xphy_core_info_t* xphy_core_info);
int portmod_xphy_core_info_get(int unit, uint32 xphy_id, portmod_xphy_core_info_t* xphy_core_info);
...
int portmod_phy_port_autoneg_get (int unit, int port, pm_info_t pm_info, 
