...
#define ARAD_PP_MTR_SHARING_MODE_NONE                        SOC_PPC_MTR_SHARING_MODE_NONE
#define ARAD_PP_MTR_SHARING_MODE_SERIAL                      SOC_PPC_MTR_SHARING_MODE_SERIAL
#define ARAD_PP_MTR_SHARING_MODE_PARALLEL                    SOC_PPC_MTR_SHARING_MODE_PARALLEL
#define ARAD_PP_NOF_MTR_SHARING_MODES                        SOC_PPC_NOF_MTR_SHARING_MODES
typedef SOC_PPC_MTR_SHARING_MODE                             ARAD_PP_MTR_SHARING_MODE;

#define ARAD_PP_MTR_COLOR_RESOLUTION_MODE_DEFAULT            SOC_PPC_MTR_COLOR_RESOLUTION_MODE_DEFAULT  
#define ARAD_PP_MTR_COLOR_RESOLUTION_MODE_RED_DIFF           SOC_PPC_MTR_COLOR_RESOLUTION_MODE_RED_DIFF
#define ARAD_PP_NOF_MTR_COLOR_RESOLUTION_MODES               SOC_PPC_NOF_MTR_COLOR_RESOLUTION_MODES
typedef SOC_PPC_MTR_COLOR_RESOLUTION_MODE                    ARAD_PP_MTR_COLOR_RESOLUTION_MODE;
...
typedef SOC_PPC_MTR_COLOR_DECISION_INFO                        ARAD_PP_MTR_COLOR_DECISION_INFO;
typedef SOC_PPC_MTR_COLOR_RESOLUTION_INFO                      ARAD_PP_MTR_COLOR_RESOLUTION_INFO;
