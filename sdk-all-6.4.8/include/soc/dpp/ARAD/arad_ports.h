...
#define ARAD_PP_PORT_PARSER_PROGRAM_POINTER_QUALIFIER_LSB                    (3)

#define ARAD_PORT_EG_MIRROR_NOF_VID_MIRROR_INDICES                 (7)

#define ARAD_PORT_INVALID_RCY_CONTEXT                               (-1)

#define ARAD_PORT_INVALID_PROTOCOL_OFFSET                           (-1)
/*
...
*   SOC_SAND_IN  ARAD_PORTS_LAG_INFO                      *new_lag_info -
