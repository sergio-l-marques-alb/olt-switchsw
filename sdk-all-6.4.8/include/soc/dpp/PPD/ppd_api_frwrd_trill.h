 ...
 *     Adjacent NickName.                                      */
#define  SOC_PPD_TRILL_MC_IGNORE_FIELD (SOC_PPC_TRILL_MC_IGNORE_FIELD)
...
typedef SOC_PPC_TRILL_MC_MASKED_FIELDS                         SOC_PPD_TRILL_MC_MASKED_FIELDS;
typedef SOC_PPC_TRILL_MC_ROUTE_KEY                             SOC_PPD_TRILL_MC_ROUTE_KEY;
typedef SOC_PPC_TRILL_ADJ_INFO                                 SOC_PPD_TRILL_ADJ_INFO;
typedef SOC_PPC_FRWRD_TRILL_GLOBAL_INFO                        SOC_PPD_FRWRD_TRILL_GLOBAL_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_frwrd_trill_get_procs_ptr(void);
