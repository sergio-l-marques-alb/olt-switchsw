...
#define  SOC_PPC_FP_NOF_ELK_ACTIONS           ((SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_3 - SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_0) + 1)
...
#define SOC_PPC_FP_DATABASE_INFO_FLAGS_STAGE_VT_EXTENDED     (1 << 10) /* databases in the TCAM that are defined in init for VT stage */
...
typedef enum
{
  ...
  */
  ...
  SOC_PPC_FP_QUAL_HDR_STACKING_EXT_AFTER_DSP_EXT_PETRA,
    ...
    SOC_PPC_FP_QUAL_ELK_LOOKUP_RESULT_0,/* res_0 to res_3 has to be in this order and without qualifiers in between */
