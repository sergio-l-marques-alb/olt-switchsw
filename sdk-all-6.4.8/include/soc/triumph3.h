/*
 * $Id: triumph3.h,v 1.86 Broadcom SDK $
...
#define _SOC_TR3_MAX_HG_PORT_COUNT                     16
...
extern int soc_tr3_get_ucq_count(int unit);
...
extern int soc_tr3_hsp_sched_weight_set(int unit, int port, int cosq, int weight);
...
extern int
soc_tr3_mmu_config_shared_buf_recalc(int unit, int shared_size, 
                                     int flags);
