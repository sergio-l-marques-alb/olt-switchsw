...
typedef enum drv_field_qualify_e {
    ...
    drvFieldQualifyOamEgressClassSrcMac = 601, /* To qualify on SourceMac Class ID
                                           ...
                                           registers. */
    drvFieldQualifyCount = 602          /* Always Last. Not a usable value. */
} drv_field_qualify_t;
...
typedef enum drv_field_action_e {
    ...
    drvFieldActionRedirectBufferPriority = 408, /* Buffer priority for CopyToCpu or
                                           Redirection packets */
    drvFieldActionRedirectPrioIntNew = 409, /* Internal priority for CopyToCpu or
                                           Redirection packets */
    drvFieldActionRpRedirectPrioIntNew = 410, /* Internal priority for CopyToCpu or
                                           Redirection Red packets */
    drvFieldActionYpRedirectPrioIntNew = 411, /* Internal priority for CopyToCpu or
                                           Redirection Yellow packets */
    drvFieldActionGpRedirectPrioIntNew = 412, /* Internal priority for CopyToCpu or
    ...
    drvFieldActionCount = 423           /* Always Last. Not a usable value. */
} drv_field_action_t;
