...
int dcmn_disable_block_ecc_check(int unit, int interrupt_id, soc_mem_t mem, soc_reg_above_64_val_t value, soc_reg_above_64_val_t orig_value);
...
int dcmn_get_cnt_reg_values(int unit,dcmn_memory_dc_t type,soc_reg_t cnt_reg,uint32 *cntf,uint32 *cnt_overflowf, uint32 *addrf,uint32 *addr_validf);
