...
/*
 * $Id: sbZfCaRcDataEntry.hx,v 1.4 Broadcom SDK $
...
#define SB_ZF_CARCDATAENTRY_GET_DATA3(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32) ((pFromData)[14] & 0x0f) << 16; \
          } while(0)
