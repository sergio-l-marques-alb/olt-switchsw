...
/* implemented by: sw_state_dpp_soc_arad_pp_pon_double_lookup_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_pon_double_lookup_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_pp_pon_double_lookup_pon_double_lookup_enable_verify_cb)(
    int _unit, int pon_double_lookup_enable_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_pon_double_lookup_pon_double_lookup_enable_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_pon_double_lookup_pon_double_lookup_enable_get_size_cb)(
    int _unit, int pon_double_lookup_enable_idx,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_pon_double_lookup_pon_double_lookup_enable_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_pon_double_lookup_pon_double_lookup_enable_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_pon_double_lookup_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_pon_double_lookup_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_pp_pon_double_lookup_access_cb_init(int _unit);
