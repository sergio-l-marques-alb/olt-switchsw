...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_get_size_cb)(
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_default_fec_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_default_fec_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_nof_lpm_entries_in_lpm_set_cb)(
    int _unit, uint32 nof_lpm_entries_in_lpm);
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_nof_lpm_entries_in_lpm_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_nof_lpm_entries_in_lpm_get_size_cb)(
    int _unit,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_nof_vrfs_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_nof_vrfs_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_vrf_modified_bitmask_verify_cb)(
    int _unit, int vrf_modified_bitmask_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_vrf_modified_bitmask_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_vrf_modified_bitmask_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_cache_modified_set_cb)(
    int _unit, uint8 cache_modified);
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_cache_modified_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_cache_modified_get_size_cb)(
    int _unit,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_cache_mode_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_cache_mode_get_size_cb)(
    int _unit,int *ret_size);
...
#ifdef SOC_SAND_DEBUG
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_info_lem_add_fail_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_info_lem_add_fail_get_size_cb)(
    int _unit,int *ret_size);
#endif /* SOC_SAND_DEBUG*/ 
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_default_fec_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_default_fec_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_nof_lpm_entries_in_lpm_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_nof_lpm_entries_in_lpm_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_nof_vrfs_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_nof_vrfs_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_vrf_modified_bitmask_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_vrf_modified_bitmask_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_cache_modified_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_cache_modified_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_cache_mode_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_cache_mode_get_size_cb get_size;
...
#endif /* SOC_SAND_DEBUG*/ 
#ifdef SOC_SAND_DEBUG
    sw_state_dpp_soc_arad_pp_ipv4_info_lem_add_fail_get_size_cb get_size;
#endif /* SOC_SAND_DEBUG*/ 
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_info_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_info_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_pp_ipv4_info_access_cb_init(int _unit);
