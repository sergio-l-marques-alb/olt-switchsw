...
/* implemented by: sw_state_dpp_bcm_failover_get_size */
typedef int (*sw_state_dpp_bcm_failover_get_size_cb)(
...
typedef int (*sw_state_dpp_bcm_failover_id_sequence_verify_cb)(
    int _unit, int id_sequence_idx);

/* implemented by: sw_state_dpp_bcm_failover_id_sequence_get_size */
typedef int (*sw_state_dpp_bcm_failover_id_sequence_get_size_cb)(
    int _unit, int id_sequence_idx,int *ret_size);
...
typedef struct sw_state_dpp_bcm_failover_id_sequence_cbs_s {
    ...
    sw_state_dpp_bcm_failover_id_sequence_get_size_cb get_size;
...
typedef struct sw_state_dpp_bcm_failover_cbs_s {
    ...
    sw_state_dpp_bcm_failover_get_size_cb get_size;
    sw_state_dpp_bcm_failover_id_sequence_cbs_t id_sequence;
} sw_state_dpp_bcm_failover_cbs_t;


int sw_state_dpp_bcm_failover_access_cb_init(int _unit);
