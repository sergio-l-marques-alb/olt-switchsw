...
/* implemented by: sw_state_dpp_soc_arad_pp_vtt_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_vtt_get_size_cb)(
...
/* implemented by: sw_state_dpp_soc_arad_pp_vtt_isem_key_to_entry_id_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_vtt_isem_key_to_entry_id_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_vtt_isem_key_to_entry_id_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_vtt_isem_key_to_entry_id_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_vtt_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_vtt_get_size_cb get_size;
