...
/* implemented by: sw_state_dpp_soc_arad_pp_diag_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_diag_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_pp_diag_trap_dest_verify_cb)(
    int _unit, int trap_dest_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_diag_trap_dest_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_diag_trap_dest_get_size_cb)(
    int _unit, int trap_dest_idx,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_diag_already_saved_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_diag_already_saved_get_size_cb)(
    int _unit,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_diag_mode_info_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_diag_mode_info_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_diag_trap_dest_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_diag_trap_dest_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_diag_already_saved_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_diag_already_saved_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_diag_mode_info_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_diag_mode_info_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_diag_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_diag_get_size_cb get_size;
