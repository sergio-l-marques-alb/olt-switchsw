...
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq2_mask_set_cb)(
    int _unit, int cmc_irq2_mask_idx, uint32 cmc_irq2_mask);
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq2_mask_verify_cb)(
    int _unit, int cmc_irq2_mask_idx);
#endif /* BCM_ARAD_SUPPORT*/ 

#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_cmc_irq2_mask_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq2_mask_get_size_cb)(
    int _unit, int cmc_irq2_mask_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq3_mask_set_cb)(
    int _unit, int cmc_irq3_mask_idx, uint32 cmc_irq3_mask);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq3_mask_verify_cb)(
    int _unit, int cmc_irq3_mask_idx);
#endif /* BCM_ARAD_SUPPORT*/ 

#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_cmc_irq3_mask_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq3_mask_get_size_cb)(
    int _unit, int cmc_irq3_mask_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq4_mask_set_cb)(
    int _unit, int cmc_irq4_mask_idx, uint32 cmc_irq4_mask);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq4_mask_verify_cb)(
    int _unit, int cmc_irq4_mask_idx);
#endif /* BCM_ARAD_SUPPORT*/ 

#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_cmc_irq4_mask_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_cmc_irq4_mask_get_size_cb)(
    int _unit, int cmc_irq4_mask_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_set_cb)(
    int _unit, int interrupt_data_ptr_arr_idx, CONST ARAD_INTERRUPT_DATA *interrupt_data);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_get_cb)(
    int _unit, int interrupt_data_ptr_arr_idx, ARAD_INTERRUPT_DATA *interrupt_data);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_verify_cb)(
    int _unit, int interrupt_data_ptr_arr_idx);
#endif /* BCM_ARAD_SUPPORT*/ 

#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_get_size_cb)(
    int _unit, int interrupt_data_ptr_arr_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_flags_set_cb)(
    int _unit, int interrupt_data_ptr_arr_idx, uint32 flags);
#endif /* BCM_ARAD_SUPPORT*/ 
...
#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_flags_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_flags_get_size_cb)(
    int _unit, int interrupt_data_ptr_arr_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_count_set_cb)(
    int _unit, int interrupt_data_ptr_arr_idx, uint32 storm_timed_count);
#endif /* BCM_ARAD_SUPPORT*/ 
...
#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_count_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_count_get_size_cb)(
    int _unit, int interrupt_data_ptr_arr_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_period_set_cb)(
    int _unit, int interrupt_data_ptr_arr_idx, uint32 storm_timed_period);
#endif /* BCM_ARAD_SUPPORT*/ 
...
#ifdef BCM_ARAD_SUPPORT
/* implemented by: sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_period_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_period_get_size_cb)(
    int _unit, int interrupt_data_ptr_arr_idx,int *ret_size);
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_cmc_irq2_mask_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_cmc_irq3_mask_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_cmc_irq4_mask_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_flags_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_count_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_storm_timed_period_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
...
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
    sw_state_dpp_soc_arad_tm_interrupts_interrupt_data_get_size_cb get_size;
#endif /* BCM_ARAD_SUPPORT*/ 
#ifdef BCM_ARAD_SUPPORT
...
typedef struct sw_state_dpp_soc_arad_tm_interrupts_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_interrupts_get_size_cb get_size;
#ifdef BCM_ARAD_SUPPORT
...
int sw_state_dpp_soc_arad_tm_interrupts_access_cb_init(int _unit);
