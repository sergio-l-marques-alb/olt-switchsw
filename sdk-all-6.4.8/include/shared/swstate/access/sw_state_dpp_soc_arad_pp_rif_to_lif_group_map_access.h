...
/* implemented by: sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_rif_urpf_mode_set_cb)(
    int _unit, int rif_urpf_mode_ptr_arr_idx, uint8 rif_urpf_mode);
...
typedef int (*sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_rif_urpf_mode_verify_cb)(
    int _unit, int rif_urpf_mode_ptr_arr_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_rif_urpf_mode_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_rif_urpf_mode_get_size_cb)(
    int _unit, int rif_urpf_mode_ptr_arr_idx,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_rif_urpf_mode_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_rif_urpf_mode_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_pp_rif_to_lif_group_map_access_cb_init(int _unit);
