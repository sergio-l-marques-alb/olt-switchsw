...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_set_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, CONST soc_dpp_guaranteed_q_resource_t *guaranteed_q_resource);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_get_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, soc_dpp_guaranteed_q_resource_t *guaranteed_q_resource);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_verify_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx);

/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_set_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, CONST soc_dpp_guaranteed_pair_t *dram);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_get_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, soc_dpp_guaranteed_pair_t *dram);
...
/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_set_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, uint32 total);
...
/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_set_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, uint32 used);
...
/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_set_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, CONST soc_dpp_guaranteed_pair_t *ocb);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_get_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx, soc_dpp_guaranteed_pair_t *ocb);
...
/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_total_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_total_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_used_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_used_get_size_cb)(
    int _unit, int guaranteed_q_resource_ptr_arr_idx,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_total_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_total_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_used_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_used_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_guaranteed_q_resource_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_guaranteed_q_resource_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_tm_guaranteed_q_resource_access_cb_init(int _unit);
