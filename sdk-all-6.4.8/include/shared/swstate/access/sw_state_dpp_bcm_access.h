...
/* implemented by: sw_state_dpp_bcm_get_size */
typedef int (*sw_state_dpp_bcm_get_size_cb)(
...
typedef struct sw_state_dpp_bcm_cbs_s {
    ...
    sw_state_dpp_bcm_get_size_cb get_size;
...
int sw_state_dpp_bcm_access_cb_init(int _unit);
