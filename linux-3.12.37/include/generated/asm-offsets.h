...
#define THREAD 576 /* offsetof(struct task_struct, thread)	 # */
#define MM 244 /* offsetof(struct task_struct, mm)	 # */
#define MMCONTEXTID 396 /* offsetof(struct mm_struct, context.id)	 # */
#define THREAD_INFO 8 /* offsetof(struct task_struct, stack)	 # */
#define THREAD_INFO_GAP 192 /* _ALIGN_UP(sizeof(struct thread_info), 16)	 # */
#define KSP_LIMIT 100 /* offsetof(struct thread_struct, ksp_limit)	 # */
...
#define THREAD_FPEXC_MODE 420 /* offsetof(struct thread_struct, fpexc_mode)	 # */
#define THREAD_FPSTATE 144 /* offsetof(struct thread_struct, fp_state)	 # */
#define THREAD_FPSAVEAREA 416 /* offsetof(struct thread_struct, fp_save_area)	 # */
#define FPSTATE_FPSCR 256 /* offsetof(struct thread_fp_state, fpscr)	 # */
#define PGDIR 96 /* offsetof(struct thread_struct, pgdir)	 # */
#define THREAD_DBCR0 104 /* offsetof(struct thread_struct, debug.dbcr0)	 # */
#define TI_FLAGS 128 /* offsetof(struct thread_info, flags)	 # */
#define TI_LOCAL_FLAGS 64 /* offsetof(struct thread_info, local_flags)	 # */
#define TI_PREEMPT 12 /* offsetof(struct thread_info, preempt_count)	 # */
#define TI_PREEMPT_LAZY 16 /* offsetof(struct thread_info, preempt_lazy_count)	 # */
...
#define CPU_SPEC_SETUP 52 /* offsetof(struct cpu_spec, cpu_setup)	 # */
#define CPU_SPEC_RESTORE 56 /* offsetof(struct cpu_spec, cpu_restore)	 # */
#define CPU_FLUSH_CACHES 40 /* offsetof(struct cpu_spec, cpu_flush_caches)	 # */
