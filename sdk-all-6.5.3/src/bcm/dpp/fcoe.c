    ...
    int unit)
{
    ...
    */
    ...
    BCMDNX_IF_ERR_EXIT(_bcm_dpp_rx_get_converted_trap_hw_id(unit,trap_id_sw, &trap_id_converted));
    ...
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
    soc_sand_rv = soc_ppd_trap_frwrd_profile_info_set(unit,trap_id_sw,&trap_info);
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
