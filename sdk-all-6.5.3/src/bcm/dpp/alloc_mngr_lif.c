...
{    
    ...
    switch (allocation_info->pool_id) {
        ...
        case dpp_am_res_eep_ip_tnl: /* IP tunnel */
          phase_type = (allocation_info->application_type == bcm_dpp_am_egress_encap_app_ip_tunnel_roo || allocation_info->application_type == bcm_dpp_am_egress_encap_app_l2_encap) ? SOC_PPC_EG_ENCAP_ACCESS_PHASE_TYPE_TUNNEL_1:SOC_PPC_EG_ENCAP_ACCESS_PHASE_TYPE_TUNNEL_2;
          break;
