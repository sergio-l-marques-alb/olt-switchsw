...
/* AUTO-GENERATED - DO NOT MODIFY */
int sw_state_dpp_soc_arad_pp_dbal_info_dbal_tables_table_programs_nof_bits_used_in_key_set(int unit, int dbal_tables_idx_0, int table_programs_idx_0, uint8 nof_bits_used_in_key){
    SW_STATE_INIT_FUNC_DEFS;
...
/* AUTO-GENERATED - DO NOT MODIFY */
int sw_state_dpp_soc_arad_pp_dbal_info_dbal_tables_table_programs_nof_bits_used_in_key_get(int unit, int dbal_tables_idx_0, int table_programs_idx_0, uint8 *nof_bits_used_in_key){
    SW_STATE_INIT_FUNC_DEFS;
    SHR_SW_STATE_VERIFY( sw_state_access[unit].dpp.soc.arad.pp.dbal_info.dbal_tables.table_programs.nof_bits_used_in_key.verify( unit, dbal_tables_idx_0, table_programs_idx_0));
