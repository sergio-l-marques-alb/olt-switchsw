...
struct ip_tunnel_term_glbl_info_s{
    ...
    int sip_mask2; 
    int dip_mask2; 
    int sip3; /* another sip + dip to terminate */
    int dip3; 
    int sip_mask3; 
    int dip_mask3; 
    int sip4; /* another sip + dip to terminate */
    int dip4; 
    int sip_mask4; 
    int dip_mask4; 
...
int ipv4_tunnel_term_dip_sip_vrf_example(int unit, int access_port, int provider_port1, int provider_port2){
    ...
    bcm_mac_t access_next_hop    = {0x00, 0x00, 0x00, 0x0, 0x12, 0x34};  /* access next hop */
    bcm_mac_t provider_next_hop  = {0x00, 0x00, 0x00, 0x0, 0x45, 0x67};  /* tunnel's IP next hop */

    /* tunnel term info for DIP SIP VRF lookup */
    bcm_tunnel_terminator_t tunnel_term;
    int sip1 = ip_tunnel_term_glbl_info.sip; /* default: 160.0.0.17*/
    int dip1 = ip_tunnel_term_glbl_info.dip; /* default: 161.0.0.17*/
    int sip1_mask = ip_tunnel_term_glbl_info.sip_mask;  /* default: 255.255.255.255 */ 
    ...
    /* tunnel termination info for DIP SIP lookup */
    int sip2 = ip_tunnel_term_glbl_info.sip3; /* default: 222.111.0.1 */
    int dip2 = ip_tunnel_term_glbl_info.dip3; /* default: 222.111.0.2 */
    int sip2_mask = ip_tunnel_term_glbl_info.sip_mask3; /* default: 255.240.0.0 */ 
    int dip2_mask = ip_tunnel_term_glbl_info.dip_mask3; /* default: 255.255.0.0 */
    ...
    bcm_tunnel_terminator_t_init(&tunnel_term);    
    tunnel_term.dip = dip2;
    tunnel_term.dip_mask = dip2_mask;
    tunnel_term.sip = sip2;
    ...
    l3_egress.next_hop_mac_addr = access_next_hop; /* next-hop */
    l3_egress.gport = access_port; 
    ...
    l3_egress.next_hop_mac_addr = provider_next_hop; /* next-hop */
    l3_egress.gport = provider_port2; 
    rv = l3__egress__create(unit, &l3_egress);
    if (rv != BCM_E_NONE) {
    ...
    sal_memset(&route_entry, 0, sizeof(route_entry));
    route_entry.address =  dip1; /* default: 161.0.0.17*/
    route_entry.mask = 0xfffffff0;
    rv = l3__ipv4_route__add(unit, 
                    route_entry,
