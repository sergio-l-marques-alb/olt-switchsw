...
int mpls_various_scenarios_create_fec_entries(int unit){
    ...
    l3_egress[0].l3_egress_id = 0;
    l3_egress[0].encap_id = 0;
    l3_egress[0].gport = cint_mpls_various_scenarios_info.port2;
    l3_egress[0].vlan = cint_mpls_various_scenarios_info.vlan1; /* next hop vlan*/
    l3_egress[0].intf = cint_mpls_various_scenarios_info.tunnel_id1; /* tunnel */
    ...
    cint_mpls_various_scenarios_info.fec1 = l3_egress[0].l3_egress_id;
   /* Set LL for egress tunnel */
    l3_egress[1].l3_egress_id = 0;
    l3_egress[1].encap_id = 0;
    l3_egress[1].gport = cint_mpls_various_scenarios_info.port2;
    l3_egress[1].vlan = cint_mpls_various_scenarios_info.vlan1; /* next hop vlan*/
    l3_egress[1].intf = cint_mpls_various_scenarios_info.tunnel_id2; /* tunnel */
    ...
    cint_mpls_various_scenarios_info.fec2 = l3_egress[1].l3_egress_id;

    l3_egress[2].l3_egress_id = 0;
    l3_egress[2].encap_id = 0;
    l3_egress[2].gport = cint_mpls_various_scenarios_info.port2;
    l3_egress[2].vlan = cint_mpls_various_scenarios_info.vlan1; /* next hop vlan*/
    l3_egress[2].intf = cint_mpls_various_scenarios_info.tunnel_id4; /* tunnel */
    ...
    cint_mpls_various_scenarios_info.fec3 = l3_egress[2].l3_egress_id;


    l3_egress[3].l3_egress_id = 0;
    l3_egress[3].encap_id = 0;
    l3_egress[3].gport = cint_mpls_various_scenarios_info.port2;
    l3_egress[3].vlan = cint_mpls_various_scenarios_info.vlan1; /* next hop vlan*/
    l3_egress[3].intf = cint_mpls_various_scenarios_info.tunnel_id5; /* tunnel */
    ...
    cint_mpls_various_scenarios_info.fec4 = l3_egress[3].l3_egress_id;
