...
int create_l3_egress(int unit, uint32 flags, int port, int vlan, int ingress_intf, bcm_mac_t nh_mac_addr, int label, int *intf, int *encap_id, int push) {
  ...
  if (push) {
      ...
      mpls_tunnel_properties.label_in = label;
      ...
      ingress_intf = mpls_tunnel_properties.tunnel_id;
  }
...
mpls_mc_test3_explicit_flags_example(int unit, int in_port, int out_port){
    ...
    if (!is_jer_b0) {
        rv = is_qumran_mx_b0_only(unit, &is_jer_b0);
        if (rv != BCM_E_NONE) {
    ...
    mpls_tunnel_properties.egress_action = BCM_MPLS_EGRESS_ACTION_PHP;
    mpls_tunnel_properties.flags = BCM_MPLS_EGRESS_LABEL_ACTION_VALID;
    mpls_tunnel_properties.label_in = 0;
    mpls_tunnel_properties.label_out = 0;
    mpls_tunnel_properties.next_pointer_intf = ingress_intf;
   ...
   mpls_tunnel_properties.egress_action = BCM_MPLS_EGRESS_ACTION_SWAP;
   mpls_tunnel_properties.flags = BCM_MPLS_EGRESS_LABEL_ACTION_VALID;
   mpls_tunnel_properties.label_in = mpls_mc_info.swap_label_1;
   mpls_tunnel_properties.label_out = 0;
   mpls_tunnel_properties.next_pointer_intf = ingress_intf;
