...
__cint_maddr__phymod_port_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 8: rv = &(s->port_is_higig);break;
        case 9: rv = &(s->fiber_pref);break;
        case 10: rv = &(s->port_mode);break;
        case 11: rv = &(s->is_bootmaster);break;
        case 12: rv = &(s->fs_fec);break;
        case 13: rv = &(s->is_flex);break;
        case 14: rv = &(s->quad_mode);break;
        default: rv = NULL; break;
    }
    return rv;
}
