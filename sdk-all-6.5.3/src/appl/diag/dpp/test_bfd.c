...
*/
void
test_bfd_set_global_values(void){
...
/* Create Endpoint */
int
test_bfd_createEndpoint(int unit,int local_port, int encap_id, int src_ip,
...
*/
int
test_bfd_updateEndpoint(int unit, int endpoint_1_id, int endpoint_2_id ){
    ...
    /* Due to a HW bug updating the period may have a ~4 second delay */
    sal_sleep(4);
...
*/
int
test_bfd_preDefinedUpdate(int unit, int endpoint_1_id, int endpoint_2_id){
...
*/
int
test_bfd_changeState(int unit, int endpoint_id){
...
*/
int
test_bfd_Multithreading(int unit, int endpoint_id){
...
int
test_bfd_add_host(int unit, int addr, int vrf, int intf) {
...
int
test_bfd_update_state(int unit, int endpoint_id){
...
/* Events registration */
int
test_bfd_register_events(int unit) {
...
/* Port initialization */
int
test_bfd_init_ports(int unit,int local_port, int remote_port, int vlan) {
...
*/
int
test_run_bfd(int unit, int port_1, int port_2, int numEndpoints, int seed, int numStates) {
