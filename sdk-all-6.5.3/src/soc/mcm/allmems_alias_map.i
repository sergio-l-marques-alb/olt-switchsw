 ...
 */
    ...
    /* EGQ_AUXILIARY_DATA_MEMORY_AUX_TABLE                */ INVALIDm,
    ...
    /* EGQ_DWM                                            */ INVALIDm,
    /* EGQ_DWM_8P                                         */ INVALIDm,
    /* EGQ_EGRESS_SHAPER_CALENDAR_SELECTOR_CCM            */ INVALIDm,
    /* EGQ_EGRESS_SHAPER_CONFIGURATION                    */ INVALIDm,
    /* EGQ_EGRESS_SHAPER_PER_PORT_CREDIT_BALANCE_MEMORY_CBM */ INVALIDm,
    /* EGQ_EOPM                                           */ INVALIDm,
    /* EGQ_EOPS                                           */ INVALIDm,
    ...
    /* EGQ_FQSM                                           */ INVALIDm,
    /* EGQ_FQSMAX                                         */ INVALIDm,
    /* EGQ_FREE_BUFFERS_ALLOCATION_BITMAP_MEMORY_FBM      */ INVALIDm,
    /* EGQ_FREE_DESCRIPTORS_ALLOCATION_BITMAP_MEMORY_FDM  */ INVALIDm,
    /* EGQ_FRM                                            */ INVALIDm,
    /* EGQ_HEADER_MAP                                     */ INVALIDm,
    /* EGQ_INGRESSVLANEDITCOMMANDMAP                      */ INVALIDm,
    /* EGQ_INGRESS_VLAN_EDITING_COMMAND_IVEC_TABLE        */ INVALIDm,
    ...
    /* EGQ_NON_CHANNELIZED_INTERFACES_SHAPER_CREDIT_MEMORY_NONCH_SCM */ INVALIDm,
    /* EGQ_OFP_DEQUEUE_WFQ_CONFIGURATION_MEMORY_8P_DWM_8P */ INVALIDm,
    /* EGQ_OFP_DEQUEUE_WFQ_CONFIGURATION_MEMORY_DWM       */ INVALIDm,
    /* EGQ_PACKET_PROCESSING_PER_PORT_CONFIGURATION_TABLE_PP_PPCT */ INVALIDm,
    /* EGQ_PCM                                            */ INVALIDm,
    ...
    /* EGQ_PER_INTERFACE_BUFFERS_COUNTER_MAX_MEMORY       */ INVALIDm,
    /* EGQ_PER_INTERFACE_BUFFERS_COUNTER_MEMORY           */ INVALIDm,
    /* EGQ_PER_INTERFACE_DESCRIPTORS_COUNTER_MAX_MEMORY   */ INVALIDm,
    /* EGQ_PER_INTERFACE_DESCRIPTORS_COUNTER_MEMORY       */ INVALIDm,
    /* EGQ_PER_PORT_BUFFERS_COUNTER_MAX_MEMORY            */ INVALIDm,
    /* EGQ_PER_PORT_BUFFERS_COUNTER_MEMORY                */ INVALIDm,
    /* EGQ_PER_PORT_BUFFERS_THRESHOLDS_MEMORY             */ INVALIDm,
    /* EGQ_PER_PORT_CONFIGURATION_TABLE_PPCT              */ INVALIDm,
    /* EGQ_PER_PORT_DESCRIPTORS_COUNTER_MAX_MEMORY        */ INVALIDm,
    /* EGQ_PER_PORT_DESCRIPTORS_COUNTER_MEMORY            */ INVALIDm,
    /* EGQ_PER_PORT_DESCRIPTORS_THRESHOLDS_MEMORY         */ INVALIDm,
    /* EGQ_PER_PORT_LB_RANGE                              */ INVALIDm,
    /* EGQ_PER_PORT_MAX_CREDIT_MEMORY_PMC                 */ INVALIDm,
    /* EGQ_PER_QPAI_MAX_CREDIT_MEMORY_QP_PMC              */ INVALIDm,
    /* EGQ_PER_QUEUE_BUFFERS_COUNTER_MAX_MEMORY           */ INVALIDm,
    /* EGQ_PER_QUEUE_BUFFERS_COUNTER_MEMORY               */ INVALIDm,
    /* EGQ_PER_QUEUE_BUFFERS_THRESHOLDS_MEMORY            */ INVALIDm,
    /* EGQ_PER_QUEUE_DESCRIPTORS_COUNTER_MAX_MEMORY       */ INVALIDm,
    /* EGQ_PER_QUEUE_DESCRIPTORS_COUNTER_MEMORY           */ INVALIDm,
    /* EGQ_PER_QUEUE_DESCRIPTORS_THRESHOLDS_MEMORY        */ INVALIDm,
    /* EGQ_PLM                                            */ INVALIDm,
    /* EGQ_PMC                                            */ INVALIDm,
    ...
    /* EGQ_PORT_CONFIGURATION_TABLE_PCT                   */ INVALIDm,
    /* EGQ_PPCT                                           */ EGQ_PPCTm,
    ...
    /* EGQ_QM_2                                           */ INVALIDm,
    /* EGQ_QM_3                                           */ INVALIDm,
    /* EGQ_QPAIRS_SHAPER_CREDIT_MEMORY_QP_SCM             */ INVALIDm,
    /* EGQ_QPAIR_SHAPER_CREDIT_BALANCE_MEMORY_QP_CBM      */ INVALIDm,
    /* EGQ_QP_CBM                                         */ INVALIDm,
    /* EGQ_QP_PMC                                         */ INVALIDm,
    /* EGQ_QP_SCM                                         */ INVALIDm,
    /* EGQ_QQSM                                           */ INVALIDm,
    ...
    /* EGQ_TCG_MAX_CREDIT_MEMORY_TCG_PMC                  */ INVALIDm,
    /* EGQ_TCG_PMC                                        */ INVALIDm,
    /* EGQ_TCG_SCM                                        */ INVALIDm,
    /* EGQ_TCG_SHAPER_CREDIT_BALANCE_MEMORY_TCG_CBM       */ INVALIDm,
    /* EGQ_TCG_SHAPER_CREDIT_CONFIGURATION_TCG_SCM        */ INVALIDm,
    /* EGQ_TC_DP_MAP                                      */ INVALIDm,
    /* EGQ_TSM                                            */ INVALIDm,
    /* EGQ_TTL_SCOPE                                      */ INVALIDm,
    /* EGQ_TTL_SCOPE_MEMORY_TTL_SCOPE                     */ INVALIDm,
    /* EGQ_UCFIFO                                         */ INVALIDm,
    /* EGQ_USM                                            */ INVALIDm,
    /* EGQ_USMFTMH                                        */ INVALIDm,
    /* EGQ_VLAN_TABLE                                     */ INVALIDm,
    /* EGQ_VSI_MEMBERSHIP                                 */ INVALIDm,
    /* EGQ_VSI_MEMBERSHIP_MEMORY_VSI_MEMBERSHIP           */ INVALIDm,
    /* EGQ_VSI_PROFILE                                    */ INVALIDm,
    /* EGQ_VSI_PROFILE_MEMORY_VSI_PROFILE                 */ INVALIDm,
    /* EGQ_WDM                                            */ INVALIDm,
    ...
    /* IPS_CAM_FULL_THERSHOLD                             */ INVALIDm,
    /* IPS_CFMEM                                          */ INVALIDm,
    ...
    /* IPS_CREDIT_BALANCE_BASED_THRESHOLDS_TABLE          */ INVALIDm,
    /* IPS_CREDIT_WATCHDOG_THRESHOLDS_TABLE               */ INVALIDm,
    /* IPS_CRVS                                           */ INVALIDm,
    /* IPS_CRWDTH                                         */ INVALIDm,
    /* IPS_CR_BAL_TABLE                                   */ INVALIDm,
    /* IPS_D_DQM_DQCQ_FIFO_MEMORY                         */ INVALIDm,
    /* IPS_EMPTYQCRBAL                                    */ INVALIDm,
    /* IPS_EMPTY_QUEUE_CREDIT_BALANCE_TABLE               */ INVALIDm,
    /* IPS_FLOW_ID_LOOKUP_TABLE                           */ INVALIDm,
    /* IPS_FLWID                                          */ INVALIDm,
    /* IPS_FMSBYP                                         */ INVALIDm,
    ...
    /* IPS_QSZTH                                          */ INVALIDm,
    /* IPS_QTYPE                                          */ INVALIDm,
    /* IPS_QUEUE_DESCRIPTOR_TABLE                         */ INVALIDm,
    /* IPS_QUEUE_PRIORITY_TABLE                           */ INVALIDm,
    /* IPS_QUEUE_SIZE_BASED_THRESHOLDS_TABLE              */ INVALIDm,
    /* IPS_QUEUE_SIZE_TABLE                               */ INVALIDm,
    /* IPS_QUEUE_TYPE_LOOKUP_TABLE                        */ INVALIDm,
    /* IPS_Q_PRIORITY_BIT_MAP                             */ INVALIDm,
    /* IPS_SFTH                                           */ INVALIDm,
    /* IPS_SLOW_FACTOR_THRESHOLDS_TABLE                   */ INVALIDm,
    ...
    /* MXQ_XLPORT_WC_UCMEM_DATA                           */ INVALIDm,
