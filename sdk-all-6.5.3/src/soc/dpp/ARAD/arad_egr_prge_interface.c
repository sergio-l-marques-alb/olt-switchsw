...
/*  {Field enum                      , src_select                       , offset_src                               , offset_base } */
    {PrgeDataFieldOutLifProfile5     , ARAD_EGR_PROG_EDITOR_DATA_SRC_RES, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_CONST_192, 18          },
    {PrgeDataFieldOutLifProfile6     , ARAD_EGR_PROG_EDITOR_DATA_SRC_RES, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_CONST_192, 16          },
    {PrgeDataFieldOutLifProfile7     , ARAD_EGR_PROG_EDITOR_DATA_SRC_RES, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_CONST_192, 14          },
    {PrgeDataFieldNativeLLSize       , ARAD_EGR_PROG_EDITOR_DATA_SRC_RES, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_CONST_192, 12          },
    {PrgeDataFieldCud2               , ARAD_EGR_PROG_EDITOR_DATA_SRC_RES, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_CONST_192, 10          },
    {PrgeDataFieldLBKey              , ARAD_EGR_PROG_EDITOR_DATA_SRC_RES, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_CONST_192, 5           },
...
uint32
  arad_egr_prge_interface_ce_field_parse(
    ...
    for (i = 0; i < PRGE_PREDEFINED_FIELDS_NOF; i++) {
        if (prge_field_properties[i].field_id == field) {
            instr->ce_interface_instruction.src_select = prge_field_properties[i].src_select;
            instr->ce_interface_instruction.offset_src = prge_field_properties[i].offset_src;
            instr->ce_interface_instruction.offset_base = (prge_field_properties[i].offset_base + offset_from_field_lsb) & 0xFF;
            SOC_SAND_EXIT_NO_ERROR;
        }
    }
...
uint32
  arad_egr_prge_interface_set_instr(
    ...
    instr->alu_interface_instruction.op_value = val;
    instr->alu_interface_instruction.cmp_action = ARAD_EGR_PROG_EDITOR_ALU_CMP_ALL;
    instr->alu_interface_instruction.dst_select = dst_reg;
