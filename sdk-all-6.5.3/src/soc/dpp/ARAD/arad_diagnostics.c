...
static debug_signals_t arad_debug_signals = {
    {24,22,5,11},
    {6,11,2,3},
    {ARAD_IHP_ID,ARAD_IHB_ID,ARAD_EGQ_ID,ARAD_EPNI_ID},
};

static debug_signals_t arad_plus_debug_signals = {
    {24,24,5,11},
    {6,11,2,3},
    {ARAD_IHP_ID,ARAD_IHB_ID,ARAD_EGQ_ID,ARAD_EPNI_ID},
};

static debug_signals_t jerichoplus_debug_signals = {
    {37,12,5,17},
    {10,14,3,5},
    {ARAD_IHP_ID,ARAD_IHB_ID,ARAD_EGQ_ID,ARAD_EPNI_ID},
};

static debug_signals_t jericho_debug_signals = {
    {37,14,5,11},
    {10,12,3,3},
    {ARAD_IHP_ID,ARAD_IHB_ID,ARAD_EGQ_ID,ARAD_EPNI_ID},
};

static debug_signals_t qax_debug_signals = {
    {39,13,5,11},
    {10,14,3,3},
    {ARAD_IHP_ID,ARAD_IHB_ID,ARAD_EGQ_ID,ARAD_EPNI_ID},
};
  ...
  )
{
  ...
  {
    reg_00e0r = (blk == ARAD_IHP_ID)? ihp_reg1: ihb_00e0r;
    reg_00e1r = (blk == ARAD_IHP_ID)? ihp_reg2: ihb_00e1r;
