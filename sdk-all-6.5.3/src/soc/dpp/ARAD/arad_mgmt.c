  ...
  )
{
  ...
  for (inst_idx = 0; inst_idx < SOC_DPP_DEFS_GET(unit, nof_instances_fmac); inst_idx++)
  {
      ...
      {
          conf[conf_idx].reg = SOC_IS_QAX(unit) ? FMAC_FMAC_REG_0065r : FMAC_LINK_TOPO_MODE_REG_0r;
          conf[conf_idx].field = SOC_IS_QAX(unit) ? FIELD_0_3f : LINK_TOPO_MODE_0f;
      ...
      conf[conf_idx].reg = SOC_IS_QAX(unit) ? FMAC_REG_0109r : FMAC_LINK_TOPO_MODE_REG_2r ;
      conf[conf_idx].field = SOC_IS_QAX(unit) ? FIELD_0_3f : LINK_TOPO_MODE_2f;
      conf[conf_idx].val = (enable == TRUE ? 0xf : 0x0);
      conf[conf_idx].instance_id = inst_idx;
      conf[conf_idx].polling_func = NULL;
      conf[conf_idx].failure_func = NULL;
