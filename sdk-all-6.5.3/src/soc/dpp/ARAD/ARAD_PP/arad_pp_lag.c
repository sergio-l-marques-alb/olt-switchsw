  ...
  Arad_pp_lb_hash_map_table[] =
{
  ...
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_NONE,   ARAD_PP_LB_VECTOR_INDEX_IPV6,     ARAD_PP_LB_VECTOR_INDEX_MPLSX1,        ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_NONE,   ARAD_PP_LB_VECTOR_INDEX_IPV6,     ARAD_PP_LB_VECTOR_INDEX_MPLSX2_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_NONE,   ARAD_PP_LB_VECTOR_INDEX_IPV6,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
