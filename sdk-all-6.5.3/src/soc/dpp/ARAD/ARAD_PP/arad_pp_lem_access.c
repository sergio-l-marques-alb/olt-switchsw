  ...
  )
{
    ...
    if (SOC_DPP_IS_EM_SIM_ENABLE(unit) && payload->is_dynamic == 0)
    {
  ...
  )
{
  ...
  case ARAD_PP_LEM_ACCESS_KEY_TYPE_IPV4_MC:
    ...
    if (params_ndx == 0)
    {
      nof_bits = (SOC_DPP_CONFIG(unit)->pp.ipmc_l2_ssm_mode != BCM_IPMC_SSM_DISABLE) ? ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_IPV4_MC_DBAL : ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_IPV4_MC;
    ...
    {
      nof_bits = (SOC_DPP_CONFIG(unit)->pp.ipmc_l2_ssm_mode != BCM_IPMC_SSM_DISABLE) ? ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IPV4_MC_DBAL : ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IPV4_MC;
   ...
   case ARAD_PP_LEM_ACCESS_KEY_TYPE_ILM:
     ...
     {
         if (SOC_IS_JERICHO(unit)) {
           SOC_SAND_ERR_IF_OUT_OF_RANGE(info->nof_bits, ARAD_PP_LEM_ACCESS_KEY_PARAM2_IN_BITS_FOR_ILM_JERICHO, ARAD_PP_LEM_ACCESS_KEY_PARAM2_IN_BITS_FOR_ILM_JERICHO, ARAD_PP_LEM_ACCESS_KEY_PARAM_NOF_BITS_OUT_OF_RANGE_ERR, 41, exit);
           SOC_SAND_ERR_IF_ABOVE_MAX(info->value[0], (1 << ARAD_PP_LEM_ACCESS_KEY_PARAM2_IN_BITS_FOR_ILM_JERICHO)-1, ARAD_PP_LEM_ACCESS_KEY_PARAM_VALUE_OUT_OF_RANGE_ERR, 42, exit);
