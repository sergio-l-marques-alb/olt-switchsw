...
soc_error_t soc_jer_pp_mpls_termination_spacial_labels_init(int unit) {
    ...
    SOCDNX_SAND_IF_ERR_EXIT(READ_IHP_VTT_GENERAL_CONFIGS_1r_REG32(unit, REG_PORT_ANY, &reg));
    field_val = 0x1;
    ...
    SOCDNX_SAND_IF_ERR_EXIT(WRITE_IHP_VTT_GENERAL_CONFIGS_1r_REG32(unit, REG_PORT_ANY, reg));
