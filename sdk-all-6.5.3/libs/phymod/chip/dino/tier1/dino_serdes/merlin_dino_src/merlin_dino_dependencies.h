 ...
 **************************************************************************************
 *                                                                                    *
 *  Revision      :  $Id: merlin_dino_dependencies.h 1139 2015-09-17 23:39:05Z kirand $ *
 *                                                                                    *
...
/** @file merlin_dino_dependencies.h
 * Dependencies to be provided by IP User
 */

#ifndef MERLIN_DINO_API_DEPENDENCIES_H
#define MERLIN_DINO_API_DEPENDENCIES_H
 ...
 * If using Serdes MDIO controller to access the registers, implement this function using merlin_dino_pmd_mdio_mwr_reg(..)
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function
 *
 *    merlin_dino_pmd_wr_reg(const phymod_access_t *pa,addr, ((merlin_dino_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
