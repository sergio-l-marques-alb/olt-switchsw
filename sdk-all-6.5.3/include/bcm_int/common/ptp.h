...
extern void _bcm_ptp_sw_dump(int unit);
 ...
 #define PTP_CONDITIONAL_IS_TOMAHAWK(unit) (SOC_IS_TOMAHAWK(unit))
#else
...
/* define SOC which support internal stack */
    ...
    defined(BCM_APACHE_SUPPORT) || defined(BCM_HURRICANE3_SUPPORT)
...
#define SOC_HAS_PTP_INTERNAL_STACK_SUPPORT(unit)  (PTP_CONDITIONAL_IS_KATANA(unit) || PTP_CONDITIONAL_IS_TRIUMPH3(unit) ||    \
                                                   ...
                                                   PTP_CONDITIONAL_IS_HURRICANE3(unit))
#else
...
#define PTP_MGMTMSG_PAYLOAD_CLOCK_INSTANCE_SIZE_OCTETS                 (51)
/* Management message configure clock port TLV payload size (octets). */
#define PTP_MGMTMSG_PAYLOAD_CONFIGURE_CLOCK_PORT_SIZE_OCTETS          (178)
...
#define PTP_MGMTMSG_PAYLOAD_CONFIGURE_TOD_OUT_SIZE_OCTETS             (171)
/* Management message CONFIGURE_TOD_IN TLV payload size (octets). */
#define PTP_MGMTMSG_PAYLOAD_CONFIGURE_TOD_IN_SIZE_OCTETS              (192)
...
#define PTP_MGMTMSG_PAYLOAD_PHASE_OFFSET_SIZE_OCTETS                   (34)
...
#define PTP_MGMTMSG_PAYLOAD_TDPLL_BINDINGS_SIZE_OCTETS                 (66)
