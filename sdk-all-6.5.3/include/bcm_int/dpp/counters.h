...
#define BCM_DPP_COUNTER_LIF_PROFILE_IS_INGRESS(lif_counting_profile)  ((lif_counting_profile / SOC_TMC_CNT_LIF_COUNTING_NOF_PROFILES_PER_SOURCE) ? TRUE : FALSE)
/*
...
#define COUNTER_UPDATE_SELECT_THREAD                    0x1
...
#define COUNTER_UPDATE_SELECT_ALL (COUNTER_UPDATE_SELECT_THREAD        | \
...
typedef struct _bcm_dpp_counter_fifo_info_s {
    ...
    uint8 dma_channel;                      /* DMA-Channel attached to FIFO*/
...
typedef struct _bcm_dpp_counter_state_s {
    ...
    _bcm_dpp_counter_lif_ranges_t lif_ranges[SOC_TMC_CNT_LIF_COUNTING_NOF_SOURCES][SOC_TMC_CNT_LIF_COUNTING_NOF_RANGES];
    uint8 dma_attached;
