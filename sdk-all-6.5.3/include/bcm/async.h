...
void	bcm_ipsec_sa_update_key_async(int unit, uint32 flags, uint32 spi_id, bcm_ipsec_sa_keys_t * sa, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ipsec_tunnel_add_async(int unit, uint32 flags, uint32 * tunnel_id, bcm_ipsec_tunnel_info_t tunnel_info, bcm_async_cb_t async_callback, void *async_cookie);
