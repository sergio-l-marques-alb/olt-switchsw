...
#define SW_STATE_DPP_BCM_COUNTER_RUNNING_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_BCM_COUNTER_BGWAIT_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
...
#define SW_STATE_DPP_BCM_COUNTER_DMA_ATTACHED_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_BCM_COUNTER_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_BCM_COUNTER_CUNIT_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_RUNNING_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_BGWAIT_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_NUM_COUNTER_PROCS_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_BACKGROUND_DEFER_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_BACKGROUND_ACTIVE_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_BACKGROUND_DISABLE_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_FOREGROUND_HIT_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_DIAG_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_PROC_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_COUNTER_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_FIFO_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_GLOBAL_INFO_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_LIF_RANGES_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_COUNTER_DMA_ATTACHED_LAYOUT_NOF_MAX_LAYOUT_NODES) 
...
int sw_state_dpp_bcm_counter_fifo_dma_channel_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
...
int sw_state_dpp_bcm_counter_dma_attached_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
