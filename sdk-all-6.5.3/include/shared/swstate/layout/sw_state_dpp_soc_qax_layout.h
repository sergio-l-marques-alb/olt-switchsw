...
#define SW_STATE_DPP_SOC_QAX_TM_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_QAX_TM_LB_INFO_LAYOUT_NOF_MAX_LAYOUT_NODES) 
#define SW_STATE_DPP_SOC_QAX_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_QAX_TM_LAYOUT_NOF_MAX_LAYOUT_NODES) 
