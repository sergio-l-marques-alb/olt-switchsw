...
int pm_qtc_port_interface_config_set(int unit, int port, pm_info_t pm_info, const portmod_port_interface_config_t* config, int all_phy);
int pm_qtc_port_interface_config_get(int unit, int port, pm_info_t pm_info, portmod_port_interface_config_t* config);
...
int pm_qtc_port_ability_local_get(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);

/*Set\Get autoneg*/
int pm_qtc_port_autoneg_set(int unit, int port, pm_info_t pm_info, const phymod_autoneg_control_t* an);
int pm_qtc_port_autoneg_get(int unit, int port, pm_info_t pm_info, phymod_autoneg_control_t* an);

/*Get autoneg status*/
int pm_qtc_port_autoneg_status_get(int unit, int port, pm_info_t pm_info, phymod_autoneg_status_t* an_status);

/*get link status*/
int pm_qtc_port_link_get(int unit, int port, pm_info_t pm_info, int* link);
...
/*get port auto negotiation local ability*/
int pm_qtc_port_ability_advert_set(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);
int pm_qtc_port_ability_advert_get(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);

/*Port ability remote Adv get*/
int pm_qtc_port_ability_remote_get(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);
...
/*set modid field.*/
int pm_qtc_port_mode_set(int unit, int port, pm_info_t pm_info, portmod_port_mode_info_t* mode);
