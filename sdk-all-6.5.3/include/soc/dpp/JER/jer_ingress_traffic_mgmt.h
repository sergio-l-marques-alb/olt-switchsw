 ...
 *************/
/* { */
typedef struct soc_dpp_ingress_reserved_resource_s {
    uint32 dram_reserved;
    uint32 ocb_reserved;
} soc_dpp_ingress_reserved_resource_t;
...
uint32
  jer_itm_global_resource_allocation_get(
      ...
      SOC_SAND_OUT  soc_dpp_ingress_congestion_mgmt_t *ingress_congestion_mgmt
  );
uint32
  jer_itm_global_resource_allocation_set(
      SOC_SAND_IN  int unit, 
      SOC_SAND_IN  int core, 
      SOC_SAND_IN  soc_dpp_ingress_congestion_mgmt_t *ingress_congestion_mgmt
  );
uint32
