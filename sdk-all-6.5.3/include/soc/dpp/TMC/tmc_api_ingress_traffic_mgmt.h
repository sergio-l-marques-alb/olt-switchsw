...
typedef struct soc_dpp_ingress_congestion_resource_s {
    /* Pool 0 size */
    uint32 pool_0;
    /* Pool 1 size */
    uint32 pool_1;
    ...
    /* Total memory */
    uint32 total;
} soc_dpp_ingress_congestion_resource_t;

typedef struct soc_dpp_ingress_congestion_mgmt_s {
    /* Holds resource allocation in DRAM mix */
    soc_dpp_ingress_congestion_resource_t dram;
    /* Holds resource allocation in OCB only */
    soc_dpp_ingress_congestion_resource_t ocb;
} soc_dpp_ingress_congestion_mgmt_t;
