...
#define ARAD_PP_EG_ENCAP_OUTLIF_TO_EEDB_INDEX(_unit, _outlif)  \
    ((SOC_IS_QAX(unit)) ? ((_outlif) - SOC_DPP_CONFIG(unit)->l3.nof_rifs) : (_outlif))
...
#define ARAD_PP_EG_ENCAP_ACCESS_OFFSET_TO_TOP_BANK_ID(unit, entry_offset) \
      ( ( entry_offset - ARAD_PP_EG_ENCAP_ACCESS_NOF_EEDB_ENTRIES(unit) ) / ARAD_PP_EG_ENCAP_ACCESS_NOF_TOP_BANK_ENTRIES)
