...
#define TD3_MAX_UCQ_COUNT           SOC_TD3_NUM_UC_QUEUES_PER_PIPE * TD3_MAX_XPEPIPE
...
#ifdef BCM_WARM_BOOT_SUPPORT
/* Follow WARM BOOT implementation from ECN module */
STATIC int
bcm_td3_pstats_scache_size_get(int unit, uint32 *scache_size)
{
...
STATIC int
bcm_td3_pstats_reinit(int unit, uint8 **scache_ptr)
{
...
STATIC int
bcm_td3_pstats_sync(int unit, uint8 **scache_ptr)
{
...
#ifdef BCM_WARM_BOOT_SUPPORT
    pstats_driver->scache_size_get = bcm_td3_pstats_scache_size_get;
    pstats_driver->pstats_reinit = bcm_td3_pstats_reinit;
    pstats_driver->pstats_sync = bcm_td3_pstats_sync;
#endif
#ifdef BCM_WARM_BOOT_SUPPORT_SW_DUMP
                              ...
                              bcm_pstats_session_id_t *session_id)
{
    ...
    /* element check */
    if (array_count > TD3_MAX_ELEMENT_COUNT) {
        return BCM_E_PARAM;
    }
...
_bcm_td3_pstats_session_update(int unit, pstats_session_t *session)
{
    ...
    if (TRUE) {
        total_buf = PSTATS_CTRL(unit).local_time.buf;
        mem = PSTATS_CTRL(unit).local_time.mem;
        pentry = soc_mem_table_idx_to_pointer(unit, mem, void*,
                                              total_buf, 0);
        soc_mem_field64_get(unit, mem, pentry, TIMESTAMPf,
