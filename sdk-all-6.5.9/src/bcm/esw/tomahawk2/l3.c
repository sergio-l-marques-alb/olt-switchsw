                      ...
                      int *old_id, SHR_BITDCL *ecmp_member_bitmap)
{
    ...
    if (dlb_id == -1) {
        /* Allocate a DLB ID */
        BCM_IF_ERROR_RETURN(
            _bcm_th2_ecmp_dlb_id_alloc(unit, ecmp->dynamic_mode, &dlb_id));
    }
                                  ...
                                  SHR_BITDCL *dlb_member_bitmap)
{
    ...
    BCM_IF_ERROR_RETURN(
        _bcm_th2_ecmp_dlb_free_resource(unit, ecmp_group_idx, -1));
...
bcm_th2_l3_egress_ecmp_dlb_destroy(int unit, bcm_if_t mpintf)
{
    ...
    BCM_IF_ERROR_RETURN(_bcm_th2_ecmp_dlb_free_resource(unit, ecmp_group_idx, -1));
    /*  Clear DLB bitmap */
    group_bitmap_ptr =
        BCM_XGS3_L3_ECMP_DLB_MEMBER_GROUP_PTR(unit, ecmp_group_idx);
    SHR_BITCLR_RANGE(group_bitmap_ptr, 0,
