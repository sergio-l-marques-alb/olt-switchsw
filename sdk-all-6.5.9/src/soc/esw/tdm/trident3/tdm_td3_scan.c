...
/**
@name: tdm_td3_scan_port_pm_old
@param:

Returns the PM number to which the input port belongs according to pmap
**/
int
tdm_td3_scan_port_pm_old(tdm_mod_t *_tdm_s)
{
    TD3_TOKEN_CHECK(_tdm_s->_core_data.vars_pkg.port) {
...
/**
@name: tdm_td3_scan_pipe_ethernet
@param:
...
**/
int
tdm_td3_scan_pipe_ethernet(tdm_mod_t *_tdm)
{
