...
**/
int
tdm_td3_cmn_get_port_pm(int port_token, tdm_mod_t *_tdm)
{
    int port_pm;
...
**/
int
tdm_td3_cmn_get_port_speed(int port_token, tdm_mod_t *_tdm)
{
...
**/
int
tdm_td3_cmn_get_port_state(int port_token, tdm_mod_t *_tdm)
{
    if (port_token >= _tdm->_chip_data.soc_pkg.soc_vars.fp_port_lo &&
        port_token <= _tdm->_chip_data.soc_pkg.soc_vars.fp_port_hi) {
...
**/
int 
tdm_td3_cmn_get_pipe_ethernet(int cal_id, tdm_mod_t *_tdm) 
{
...
**/
int 
tdm_td3_cmn_get_pipe_higig(int cal_id, tdm_mod_t *_tdm)
{
    int result = BOOL_FALSE;

    /* check regular ports */
    if (tdm_td3_cmn_get_pipe_ethernet(cal_id, _tdm) == BOOL_FALSE) {
        result = BOOL_TRUE;
    }
...
**/
int
tdm_td3_cmn_get_pipe_cal_len_max(int cal_id, tdm_mod_t *_tdm)
{
    int cal_len = 0;
...
**/
int
tdm_td3_cmn_get_pipe_cal_len(int cal_id, tdm_mod_t *_tdm)
{
    int cal_len = 0;
    int param_freq;
    ...
    /* get calendar length */
    if (tdm_td3_cmn_get_pipe_higig(cal_id, _tdm) == BOOL_FALSE) {
        switch (param_freq) {
    ...
    } else if (cal_len > tdm_td3_cmn_get_pipe_cal_len_max(cal_id, _tdm)) {
        cal_len = 0;
