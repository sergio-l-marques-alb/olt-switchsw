...
static const soc_td3_ep_core_cfg_t
    ...
    { 20000, 15,  9, {13, 26, 60}, {13, 26, 60}, {13, 26, 60} },   /* 20GE    */
    { 21000, 15,  9, {13, 26, 60}, {13, 26, 60}, {13, 26, 60} },   /* HG[21]  */
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state, int logical_port)
{
    ...
    if ((1525 == port_schedule_state->frequency) &&
        ...
        return soc_td3_ep_core_cfg_tbl[ct_class].egr_mmu_credit_max_freq;
    } else {
 ...
 *         Follows the sequence specified in document "TD3_uA_flexport.pdf",
 *         Section 6.6.1.1
 *         Two main parts:
