...
STATIC int
_soc_counter_trident3_get_child_dma_by_idx(int unit,
...
soc_counter_trident3_get_info(int unit, soc_port_t port, soc_reg_t id,
    ...
    case SOC_COUNTER_NON_DMA_PORT_DROP_BYTE_OBM_LOSSLESS1:
        ...
        *num_entries = 1;
        ...
        pipe = si->port_pipe[port];
        _soc_counter_trident3_get_child_dma_by_idx(unit, non_dma,
                                                   obm_id, &non_dma);
