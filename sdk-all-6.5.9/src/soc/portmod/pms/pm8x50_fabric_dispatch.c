...
__portmod__dispatch__t__ portmod_pm8x50_fabric_driver = {

    pm8x50_fabric_pm_interface_type_is_supported,
    pm8x50_fabric_pm_init,
    pm8x50_fabric_pm_destroy,
    pm8x50_fabric_port_attach,
    NULL, /* portmod_default_bus_update */
    pm8x50_fabric_pm_bypass_set,
    pm8x50_fabric_pm_core_info_get,
    pm8x50_fabric_pm_phys_get,
    pm8x50_fabric_port_detach,
    pm8x50_fabric_port_replace,
    pm8x50_fabric_port_enable_set,
    pm8x50_fabric_port_enable_get,
    pm8x50_fabric_port_interface_config_set,
    pm8x50_fabric_port_interface_config_get,
    pm8x50_fabric_port_default_interface_get,
    NULL, /* portmod_port_interface_check */
    pm8x50_fabric_port_encoding_set,
    pm8x50_fabric_port_encoding_get,
    pm8x50_fabric_port_cl72_set,
    pm8x50_fabric_port_cl72_get,
    NULL, /* portmod_port_cl72_status_get */
    pm8x50_fabric_port_loopback_set,
    pm8x50_fabric_port_loopback_get,
    ...
    pm8x50_fabric_port_link_get,
    NULL, /* portmod_port_link_latch_down_get */
    NULL, /* portmod_port_phy_link_up_event */
    NULL, /* portmod_port_phy_link_down_event */
    pm8x50_fabric_port_prbs_config_set,
    pm8x50_fabric_port_prbs_config_get,
    pm8x50_fabric_port_prbs_enable_set,
    pm8x50_fabric_port_prbs_enable_get,
    pm8x50_fabric_port_prbs_status_get,
    ...
    pm8x50_fabric_port_update,
    pm8x50_fabric_port_core_access_get,
    pm8x50_fabric_port_phy_lane_access_get,
    pm8x50_fabric_port_duplex_set,
    pm8x50_fabric_port_duplex_get,
    ...
    pm8x50_fabric_port_mode_set,
    pm8x50_fabric_port_mode_get,
    ...
    pm8x50_fabric_port_polarity_set,
    pm8x50_fabric_port_polarity_get,
