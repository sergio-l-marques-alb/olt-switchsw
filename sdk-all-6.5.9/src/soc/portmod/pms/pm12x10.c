...
int pm12x10_port_lane_map_get(int unit, int port, pm_info_t pm_info, phymod_lane_map_t* lane_map)
{
    ...
    if ((core_num<3) && (PM_4X10_DRIVER(pm_info, core_num)->f_portmod_port_lane_map_get)) {
        _rv = PM_4X10_DRIVER(pm_info, core_num)->f_portmod_port_lane_map_get(unit, port,
                                    PM_4X10_INFO(pm_info, core_num), lane_map);
    } else {
        _rv = PM_4X25_DRIVER(pm_info)->f_portmod_port_lane_map_get(unit, port,
                                    PM_4X25_INFO(pm_info), lane_map);
    }
    SOC_FUNC_RETURN;
}

int pm12x10_port_lane_map_set(int unit, int port, pm_info_t pm_info, phymod_lane_map_t* lane_map)
{
    return SOC_E_NONE;
}

int pm12x10_port_pll_div_get(int unit, int port,
