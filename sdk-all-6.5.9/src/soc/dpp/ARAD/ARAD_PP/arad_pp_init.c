    ...
    arad_pp_init_dynamic_kbp_result(int unit)
{
    ...
    res_sizes[6] = soc_property_suffix_num_get(unit, 0, spn_EXT_TCAM_RESULT_SIZE_SEGMENT, "6", 24);/* ACL6   	*/
    res_sizes[7] = soc_property_suffix_num_get(unit, 0, spn_EXT_TCAM_RESULT_SIZE_SEGMENT, "7", 16);/* ACL7		*/
