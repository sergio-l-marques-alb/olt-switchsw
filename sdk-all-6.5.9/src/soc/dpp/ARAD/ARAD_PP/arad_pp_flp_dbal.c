   ...
   )
{
    ...
    if(ARAD_KBP_ENABLE_IPV4_RPF){    /* in case of KBP is enabled */        
        ...
        keys_to_table_id[5].key_id = SOC_DPP_DBAL_PROGRAM_NOF_KEYS;
        keys_to_table_id[5].sw_table_id = SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_RPF_DUMMY_KBP;
        keys_to_table_id[5].lookup_number = 1;
        keys_to_table_id[5].public_lpm_lookup_size = 0;

        keys_to_table_id[6].key_id = SOC_DPP_DBAL_PROGRAM_KEY_D_MSB;
        keys_to_table_id[6].sw_table_id = SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KBP_DEFAULT_ROUTE_KAPS;
        keys_to_table_id[6].lookup_number = 2;
        keys_to_table_id[6].public_lpm_lookup_size = 0;
   ...
   )
{
    ...
    if(ARAD_KBP_ENABLE_IPV4_MC){
        ...
        SOCDNX_IF_ERR_EXIT(arad_pp_flp_dbal_kbp_default_route_kaps_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4MC_KBP_DEFAULT_ROUTE_KAPS));
        SOCDNX_IF_ERR_EXIT(arad_pp_flp_dbal_kbp_default_route_kaps_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KBP_DEFAULT_ROUTE_KAPS));
        ...
        keys_to_table_id[5].key_id = SOC_DPP_DBAL_PROGRAM_KEY_D_MSB;
        keys_to_table_id[5].sw_table_id = SOC_DPP_DBAL_SW_TABLE_ID_IPV4MC_KBP_DEFAULT_ROUTE_KAPS;
        keys_to_table_id[5].lookup_number = 1;
        keys_to_table_id[5].public_lpm_lookup_size = 0;
   ...
   )
{
    ...
    {        
        ...
        if (ARAD_KBP_ENABLE_IPV6_MC) {
            ...
            SOCDNX_IF_ERR_EXIT(arad_pp_flp_dbal_kbp_default_route_kaps_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV6MC_KBP_DEFAULT_ROUTE_KAPS));
            SOCDNX_IF_ERR_EXIT(arad_pp_flp_dbal_kbp_default_route_kaps_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_KBP_DEFAULT_ROUTE_KAPS));

            keys_to_table_id[nof_tables].key_id = SOC_DPP_DBAL_PROGRAM_KEY_D_MSB;
            keys_to_table_id[nof_tables].sw_table_id = SOC_DPP_DBAL_SW_TABLE_ID_IPV6MC_KBP_DEFAULT_ROUTE_KAPS;
            keys_to_table_id[nof_tables].lookup_number = 1;
            keys_to_table_id[nof_tables++].public_lpm_lookup_size = 0;
