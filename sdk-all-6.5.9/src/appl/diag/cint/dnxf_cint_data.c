...
CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         ...
                         soc_dnxc_loopback_mode_t,soc_dnxc_loopback_mode_t,loopback,0,0);  

CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         soc_dnxf_port_loopback_get,
                         int,int,unit,0,0,
                         bcm_port_t,bcm_port_t,port,0,0,
                         soc_dnxc_loopback_mode_t*,soc_dnxc_loopback_mode_t,loopback,1,0);
...
CINT_FWRAPPER_CREATE_RP4(int, int, 0, 0,
                         soc_dnxf_drv_link_to_dch_block,
                         int, int, unit, 0, 0,
                         int, int, link, 0, 0,
...
static cint_function_t __cint_dnxf_functions[] = 
    {
        ...
        CINT_FWRAPPER_ENTRY(soc_dnxf_drv_link_to_dch_block),
...
static cint_enum_map_t __cint_dnxf_enum_map__soc_dnxc_loopback_mode_t[] = 
{
    { "soc_dnxc_loopback_mode_none", soc_dnxc_loopback_mode_none },
    { "soc_dnxc_loopback_mode_mac_outer", soc_dnxc_loopback_mode_mac_outer },
    { "soc_dnxc_loopback_mode_mac_pcs", soc_dnxc_loopback_mode_mac_pcs },
    { "soc_dnxc_loopback_mode_mac_async_fifo", soc_dnxc_loopback_mode_mac_async_fifo },
    { "soc_dnxc_loopback_mode_phy_rloop", soc_dnxc_loopback_mode_phy_rloop },
    { "soc_dnxc_loopback_mode_phy_gloop", soc_dnxc_loopback_mode_phy_gloop },
    { NULL }
};
...
static cint_enum_type_t __cint_dnxf_enums[] = 
{
    ...
    { "soc_dnxc_loopback_mode_t", __cint_dnxf_enum_map__soc_dnxc_loopback_mode_t },    
    { NULL }
};
