...
cmd_result_t
cmd_sand_cpu_i2c(int unit, args_t* a)
{
#ifndef __KERNEL__
...
cmd_result_t
cmd_sand_cpu_regs(int unit, args_t* a)
{
...
cmd_result_t
cmd_sand_pcie_reg(int unit, args_t* a)
{
    char *function, *addr, *value;
...
#endif /* (defined(LINUX) || defined(UNIX)) && (defined(__DUNE_GTO_BCM_CPU__) || defined(__DUNE_WRX_BCM_CPU__) || defined(__DUNE_SLK_BCM_CPU__)) */
