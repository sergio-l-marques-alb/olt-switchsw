/*
 * $Id: tomahawk2_cos.c Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    tomahawk2_cos.c
...
char * techsupport_cos_tomahawk2_diag_cmdlist[] = {
     NULL /* Must be the last element in this structure */
 };

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "cos" feature's software dump command list valid only for Tomahawk */
char * techsupport_cos_tomahawk2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
...
static soc_mem_t techsupport_cos_tomahawk2_memory_table_list[] = {
    CPU_TS_MAPm,
 ...
 * "cos" feature for Tomahawk chipset. */
techsupport_reg_t techsupport_cos_tomahawk2_reg_list[] = {
 ...
 * "cos" feature for Tomahawk chipset. */
techsupport_data_t techsupport_cos_tomahawk2_data = {
    techsupport_cos_diag_cmdlist,
    techsupport_cos_tomahawk2_reg_list,
    techsupport_cos_tomahawk2_memory_table_list,
    techsupport_cos_tomahawk2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_cos_sw_dump_cmdlist,
    techsupport_cos_tomahawk2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
