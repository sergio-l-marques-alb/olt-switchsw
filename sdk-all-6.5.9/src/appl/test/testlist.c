...
#if defined(PLISIM) && defined(BCM_TRIDENT3_SUPPORT) && defined(BCM_CMICX_SUPPORT)
...
TEST(514,       "FlexPort test",        T56960+T56860,   flexport_test_init,     flexport_test_cleanup,          flexport_test,          1,      0)
#endif
#if defined(BCM_TRIDENT2_SUPPORT)
...
TEST(505,       "SCHAN FIFO test",      T56870,                 schanfifo_test_init,    schanfifo_test_cleanup,         schanfifo_test,         1,      0)
#endif
};
