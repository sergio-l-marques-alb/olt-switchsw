/*
 * $Id: streaming.c,v 1.0 Broadcom SDK $
                         ...
                         soc_reg_t* reg_tbyt)
{
    ...
    if (soc_feature(unit, soc_feature_cxl_mib)) {
        if (SOC_BLOCK_IS_CMP(unit, SOC_PORT_BLOCK(unit, port), 
                             SOC_BLK_CLPORT)) {
...
check_mib_counters(int unit)
{
    ...
    int pblk;
    streaming_t *streaming_p = streaming_parray[unit];
    soc_reg_t error_counters[][3] = {
        {RFLRr,    XLMIB_RFLRr,   CLMIB_RFLRr},
        {RFCSr,    XLMIB_RFCSr,   CLMIB_RFCSr},
        {RJBRr,    XLMIB_RJBRr,   CLMIB_RJBRr},
        {RMTUEr,   XLMIB_RMTUEr,  CLMIB_RMTUEr},
        {RTRFUr,   XLMIB_RTRFUr,  CLMIB_RTRFUr},
        {RERPKTr,  XLMIB_RERPKTr, CLMIB_RERPKTr},
        {RRPKTr,   XLMIB_RRPKTr,  CLMIB_RRPKTr},
        {RUNDr,    XLMIB_RUNDr,   CLMIB_RUNDr},
        {RFRGr,    XLMIB_RFRGr,   CLMIB_RFRGr},
        {RRBYTr,   XLMIB_RRBYTr,  CLMIB_RRBYTr},
        {TJBRr,    XLMIB_TJBRr,   CLMIB_TJBRr},
        {TFCSr,    XLMIB_TFCSr,   CLMIB_TFCSr},
        {TERRr,    XLMIB_TERRr,   CLMIB_TERRr},
        {TFRGr,    XLMIB_TFRGr,   CLMIB_TFRGr},
        {TRPKTr,   XLMIB_TRPKTr,  CLMIB_TRPKTr},
        {TUFLr,    XLMIB_TUFLr,   CLMIB_TUFLr},
        {TPCEr,    TPCE_64r,      TPCE_64r},
        {RDISCr,   RDISC_64r,     RDISC_64r},
        {RIPHE4r,  RIPHE4_64r,    RIPHE4_64r},
        {RIPHE6r,  RIPHE6_64r,    RIPHE6_64r},
        {RIPD4r,   RIPD4_64r,     RIPD4_64r},
        {RIPD6r,   RIPD6_64r,     RIPD6_64r},
        {RPORTDr,  RPORTD_64r,    RPORTD_64r}
    };

    for (i = 0; i < streaming_p->num_fp_ports; i++) {
        column = 0;
        if (soc_feature(unit, soc_feature_cxl_mib)) {
            pblk = SOC_PORT_BLOCK(unit, streaming_p->port_list[i]);
