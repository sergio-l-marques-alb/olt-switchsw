...
int is_xgs = 0;                             /* Device Type Configure */
...
bcm_sat_gtf_rate_pattern_mode_t gtf_rate_pattern_mode = bcmSatGtfRatePatternContinues;
 ...
 *                                                                         04 = SAT_UPMEP_TX
 *    INT_PRI                                      4     107:104  13       Internal Priority used for UP-MEP Tx. DP is assumed to be ???green????¡§???¡ì?¡ì. 
