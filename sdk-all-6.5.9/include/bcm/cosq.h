...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatEgressUCQueueMinBytesCurrent = 65, /* Current value of unicast queue
                                           minimum guarantee buffers in use in
                                           bytes. */
    bcmCosqStatMaxCount = 66            /* this should be the last one. */
} bcm_cosq_stat_t;
...
typedef enum bcm_cosq_threshold_action_type_e {
    ...
    bcmCosqThreshActionFc = 0       /* FC threshold */
...
#define BCM_COSQ_TH_INDEX_CAST_PRIO_FDWACT_SET(cast, priority, forward_action)  _SHR_COSQ_TH_INDEX_CAST_PRIO_FDWACT_SET(cast, priority, forward_action) 
