...
typedef enum bcm_fabric_threshold_type_e {
    ...
    bcmFabricTxFifoSizePipeTh = _SHR_FABRIC_TX_FIFO_SIZE_PIPE_TH, /* FIFO Sizes */
...
#define BCM_FABRIC_TH_INDEX_PIPE_SET(pipe)  _SHR_FABRIC_TH_INDEX_PIPE_SET(pipe) 
#define BCM_FABRIC_TH_INDEX_PIPE_LEVEL_SET(pipe, level)  _SHR_FABRIC_TH_INDEX_PIPE_LEVEL_SET(pipe, level) 
#define BCM_FABRIC_TH_INDEX_PRIO_SET(prio)  _SHR_FABRIC_TH_INDEX_PRIO_SET(prio) 
