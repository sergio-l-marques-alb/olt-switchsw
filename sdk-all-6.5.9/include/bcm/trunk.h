...
/* Trunk Local attributes structure. */
typedef struct bcm_trunk_local_attributes_s {
    uint32 core_bitmap; /* bitmap for the cores on which the local trunk members
                           can exist */
    int nof_priorities; /* number of port priorities of the trunk */
} bcm_trunk_local_attributes_t;
...
/* Set trunk ID according to ID info */
extern int bcm_trunk_id_set(
    int unit, 
    bcm_trunk_id_info_t *id_info, 
    bcm_trunk_t *tid);

/* Set trunk Local atteributes */
extern int bcm_trunk_local_attributes_set(
    int unit, 
    bcm_trunk_t tid, 
    uint32 flags, 
...
/* Set trunk Local atteributes */
extern int bcm_trunk_local_attributes_get(
    int unit, 
    bcm_trunk_t tid, 
    uint32 flags, 
    bcm_trunk_local_attributes_t *local_attributes);
...
/* init bcm_trunk_local_attributes_t */
extern void bcm_trunk_local_attributes_t_init(
    bcm_trunk_local_attributes_t *local_attributes);
