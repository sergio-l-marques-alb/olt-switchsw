...
#define DRV_FIELD_USER_NUM_UDFS     277        
...
typedef enum drv_field_qualify_e {
    ...
    drvFieldQualifyInnerSrcIp = 99,     /*  Inner ip header source IPv4 Address. */
    drvFieldQualifyInnerDstIp = 100,    /*  Inner ip header destination IPv4
                                           Address. */
    ...
    drvFieldQualifyEgressClassTunnel = 609, /* Class assigned by next hop tunnel */
    drvFieldQualifyEgressClassL3InterfaceTunnel = 610, /* Class assigned by egress interface
                                           tunnel */
    drvFieldQualifyStaggeredValue0 = 611, /* Value taken from action result 0 in
                                           staggered mode. */
    drvFieldQualifyStaggeredValue1 = 612, /* Value taken from action result 1 in
                                           staggered mode. */
    drvFieldQualifyStaggeredValue2 = 613, /* Value taken from action result 2 in
                                           staggered mode. */
    drvFieldQualifyStaggeredValue3 = 614, /* Value taken from action result 3 in
                                           staggered mode. */
    drvFieldQualifyStaggeredDirectValue = 615, /* Value taken from KAPS payload in
                                           staggered mode. */
    drvFieldQualifyStaggeredPreselProfile0 = 616, /* Program selection profile value taken
                                           from action result 0 in staggered
                                           mode. */
    drvFieldQualifyStaggeredPreselProfile1 = 617, /* Program selection profile value taken
                                           from action result 1 in staggered
                                           mode. */
    drvFieldQualifyStaggeredPreselProfile2 = 618, /* Program selection profile value taken
                                           from action result 2 in staggered
                                           mode. */
    drvFieldQualifyStaggeredPreselProfile3 = 619, /* Program selection profile value taken
                                           from action result 3 in staggered
                                           mode. */
    drvFieldQualifyStaggeredPreselProfileDirect = 620, /* Program selection profile value taken
                                           from KAPS payload 0 in staggered
                                           mode. */
    drvFieldQaulifyPreselId = 621,      /* Program selection value in 2nd Pass
                                           according to the 1st Pass
                                           preselector-id. */
    drvFieldQualifyEthernetData = 622,  /* Egress data qualifier base only.
                                           NWK_RCRDS Ethernet data field,
                                           containing Ethernet tags (if any) and
                                           Ethertype. */
    drvFieldQualifyPreemptablePacket = 623, /* Preemptable Packet */
    drvFieldQualifyVxlanClassValid = 624, /* VXLAN Class is valid or not */
    drvFieldQualifyVxlanPacket = 625,   /* Indicates whether it is a VXLAN
                                           packet */
    drvFieldQualifyVxlanVnidVlanTranslateHit = 626, /* VXLAN Network Identifier (VN_ID)
                                           lookup hit through vlan translation */
    drvFieldQualifyVxlanPayloadVlanFormat = 627, /* VLAN tag format in VXLAN payload */
    drvFieldQualifyTunnelPayloadDstMac = 628, /* Destination MAC address in Tunnel
                                           payload */
    drvFieldQualifyTunnelPayloadSrcMac = 629, /* Source MAC address in Tunnel payload */
    drvFieldQualifyTunnelPayloadEtherType = 630, /* Ethernet type in Tunnel payload */
    drvFieldQualifyTunnelPayloadOuterVlan = 631, /* Outer VLAN tag in Tunnel payload */
    drvFieldQualifyTunnelPayloadOuterVlanId = 632, /* Outer VLAN id in Tunnel payload */
    drvFieldQualifyTunnelPayloadOuterVlanPri = 633, /* Outer VLAN priority in Tunnel payload */
    drvFieldQualifyTunnelPayloadOuterVlanCfi = 634, /* Outer VLAN CFI in Tunnel payload */
    drvFieldQualifyTunnelPayloadSip = 635, /* IPv4 source address in Tunnel payload */
    drvFieldQualifyTunnelPayloadDip = 636, /* IPv4 destination address in Tunnel
                                           payload */
    drvFieldQualifyTunnelPayloadSip6 = 637, /* IPv6 source address in Tunnel payload */
    drvFieldQualifyTunnelPayloadDip6 = 638, /* IPv6 destination address in Tunnel
                                           payload */
    drvFieldQualifyTunnelPayloadIpProtocol = 639, /* IP Protocol value in Tunnel payload */
    drvFieldQualifyTunnelPayloadL4DstPort = 640, /* UDP/TCP destination port number in
                                           Tunnel payload */
    drvFieldQualifyTunnelPayloadL4SrcPort = 641, /* UDP/TCP source port number in Tunnel
                                           payload */
    drvFieldQualifyRoceBthOpcode = 642, /* To qualify on OP code on RoCEv1 /
                                           RoCEv2 Base Transport Header(BTH) */
    drvFieldQualifyRoceBthPartitionKey = 643, /* To qualify on partition key on RoCEv1
                                           / RoCEv2  Base Transport Header (BTH) */
    drvFieldQualifyRoceBthDstQueuePair = 644, /* To qualify on destination queue pair
                                           on RoCEv1 / RoCEv2 Base Transport
                                           Header(BTH) */
    drvFieldQualifyRoceBthFlags = 645,  /* To qualify on flags on RoCEv1 /
                                           RoCEv2 Base Transport Header(BTH) */
    drvFieldQualifyRoceVer1Pkt = 646,   /* Indicate whether it is a RoCEv1
                                           packet */
    drvFieldQualifyRoceVer2Pkt = 647,   /* Indicate whether it is a RoCEv2
                                           packet */
    drvFieldQualifySrcPortSRType = 648, /* SR (Seamless Redundancy) port type
                                           (bcmFieldPortSRTypeXXX) assigned to
                                           the source port */
    drvFieldQualifyDstPortSRType = 649, /* SR (Seamless Redundancy) port type
                                           (bcmFieldPortSRTypeXXX) assigned to
                                           the destination port */
    drvFieldQualifySrcPortSRRoleInterlink = 650, /* Indicates whether the SR role for the
                                           source is an interlink */
    drvFieldQualifyDstPortSRRoleInterlink = 651, /* Indicates whether the SR role for the
                                           destination is an interlink */
    drvFieldQualifySrcPortSRMode = 652, /* The SR port mode
                                           (bcmFieldSRPortModeXXX) assigned to
                                           the source port */
    drvFieldQualifyDstPortSRMode = 653, /* The SR port mode
                                           (bcmFieldSRPortModeXXX) assigned to
                                           the destination port */
    drvFieldQualifySrcPortSRNetId = 654, /* The SR NET ID (0~7) assigned to the
                                           source port */
    drvFieldQualifyDstPortSRNetId = 655, /* The SR NET ID (0~7) assigned to the
                                           destination port */
    drvFieldQualifySrcPortSRLanId = 656, /* The SR LAN ID (0 for LAN A and 1 for
                                           LAN B) assigned to the source port */
    drvFieldQualifyDstPortSRLanId = 657, /* The SR LAN ID (0 for LAN A and 1 for
                                           LAN B) assigned to the destination
                                           port */
    drvFieldQualifySRTagType = 658,     /* The SR (Seamless Redundancy) tag type
                                           (bcmFieldSRTagTypeXXX) identified in
                                           this packet */
    drvFieldQualifySRLanId = 659,       /* The SR LAN ID (0 for LAN A and 1 for
                                           LAN B) in the SR tag. Valid only if
                                           the packet contains an SR tag. */
    drvFieldQualifySRNetId = 660,       /* The SR NET ID (0~7) in the SR tag.
                                           Valid only if the packet contains an
                                           SR tag. */
    drvFieldQualifyVlanSREnable = 661,  /* Indicates whether SR (Seamless
                                           Redundancy) is enabled in this VLAN */
    drvFieldQualifyVlanSRLanId = 662,   /* Indicates the SR LAN ID (0 for LAN A
                                           and 1 for LAN B) for this VLAN. Valid
                                           only if SR is enabled for this VLAN. */
    drvFieldQualifySRFlowId = 663,      /* SR flow ID for the SR flow that the
                                           packet belongs to */
    drvFieldQualifyL2DestSRNodeType = 664, /* SR node type (bcmFieldSRNodeTypeXXX)
                                           for the destination address */
    drvFieldQualifySRNetIdMatched = 665, /* Indicates whether the SR packet's NET
                                           ID matches the configured NET ID on
                                           the destination port */
    drvFieldQualifySRSrcNodeIsSan = 666, /* Indicates whether the source address
                                           belongs to an SR SAN node */
    drvFieldQualifySRSupervisionType = 667, /* The SR supervision type
                                           (bcmFieldSRSupervisionTypeXXX) if
                                           it's an SR supervision packet */
    drvFieldQualifySRError = 668,       /* Indicates SR errors for the packet */
    drvFieldQualifyL2SrcMulticastHit = 669, /* Indicates L2 source address found on
                                           the correct multicast group. */
    drvFieldQualifyL2DstMulticastHit = 670, /* Indicates L2 destination address
                                           found and result is a multicast
                                           group. */
    drvFieldQualifySRDuplicate = 671,   /* SR (Seamless Redundancy): Indicates
                                           whether this packet is a duplicate SR
                                           packet */
    drvFieldQualifyTsnFlowId = 672,     /* TSN (Time-Sensitive Networking) flow
                                           ID for the TSN flow that the packet
                                           belongs to */
    drvFieldQualifyExternalValue6 = 673, /* External lookup 6 value */
    drvFieldQualifyExternalValue7 = 674, /* External lookup 7 value */
    drvFieldQualifyExternalHit6 = 675,  /* External lookup 6 hit */
    drvFieldQualifyExternalHit7 = 676,  /* External lookup 7 hit */
    drvFieldQualifyMirrorDest = 677,    /* Link Layer mirror command value */
    drvFieldQualifyPacketIsIEEE1588 = 678, /* Indicating whether the packet is 1588 */
    drvFieldQualifyIEEE1588Encapsulation = 679, /* IEEE-1588 Encapsulation according to
                                           bcm_field_IEEE1588Encap_t */
    drvFieldQualifyIEEE1588CompensateTimeStamp = 680, /* IEEE-1588 update time stamp */
    drvFieldQualifyIEEE1588Command = 681, /* Command used by egress pipeline,
                                           indicating if CF(correction field)
                                           needs to be update */
    drvFieldQualifyIEEE1588HeaderOffset = 682, /* This field indicates the offset of
                                           the IEEE-1588 header. Offset in bytes */
    drvFieldQualifyHeaderFormatExtension = 683, /* Qualify on header format extension
                                           from profile of header format */
    drvFieldQualifyMacSecTagPresent = 684, /* Qualifies the MACSEC tagged packets */
    drvFieldQualifyMacSecTag = 685,     /* Qualifies on the SecTag field in
                                           MACSEC tagged packets */
    drvFieldQualifyMacSecDstMacRangeHit = 686, /* Qualifies hit on Destination MAC
                                           addresses range; which is configured
                                           by API
                                           bcm_field_macsec_DstMacRange_set */
    drvFieldQualifyFromMacSecPort = 687, /* Packet forwarded through the internal
                                           MACSEC port */
    drvFieldQualifyMacSecFlow = 688,    /* Qualifies on the MACSEC packet flow */
    drvFieldQualifyEgressBridgedForwardingDataHigh = 689, /* Used for ACL-while-bridging. Contains
                                           the 64 bits of packet data starting
                                           80 bits after SA */
    drvFieldQualifyEgressBridgedForwardingDataLow = 690, /* Used for ACL-while-bridging. Contains
                                           the 56 bits of packet data starting
                                           144 bits after SA */
    drvFieldQualifyEgressBridgedAclDataHigh = 691, /* Used for ACL-while-bridging. Contains
                                           the 40 bits of packet data starting
                                           200 bits after SA */
    drvFieldQualifyEgressBridgedAclDataLow = 692, /*  Used for ACL-while-bridging.
                                           Contains the 32 bits of packet data
                                           starting 240 bits after SA */
    drvFieldQualifyCount = 693          /* Always Last. Not a usable value. */
} drv_field_qualify_t;
...
typedef enum drv_field_action_e {
    ...
    drvFieldActionYpDropPrecedence = 86, /* Set Yellow Priority Drop Precedence;
                                           param0: BCM_FIELD_COLOR_xxx. */
    ...
    drvFieldActionGpDropPrecedence = 138, /* Set Green Priority Drop Precedence;
                                           param0: BCM_FIELD_COLOR_xxx. */
    ...
    drvFieldActionUseTunnelPayload = 468, /* To use Tunnel payload header fields
                                           for hashing */
    drvFieldActionVlanActions = 469,    /* Set actions to modify VLAN tag
                                           fields. */
    drvFieldActionSRDuplicateDrop = 470, /* SR (Seamless Redundancy): drop the
                                           packet if it's an SR duplicate */
    drvFieldActionSRDuplicateDropCancel = 471, /* SR (Seamless Redundancy): Do not drop
                                           the duplicate packet (override
                                           another rule) */
    drvFieldActionSRNetIdFilter = 472,  /* SR (Seamless Redundancy): NET ID
                                           filtering drop the packet if its NET
                                           ID is the same as destination ports */
    drvFieldActionSRNetIdSource = 473,  /* SR: Indicates the source which NET ID
                                           comes from; param0:
                                           BCM_FIELD_SR_NET_ID_SOURCE_xxx */
    drvFieldActionFilterSrcMacPorts = 474, /* SR: Apply source port filtering based
                                           on source address */
    drvFieldActionSRCopyToCpu = 475,    /* SR: Copy all packets or only
    ...
    drvFieldActionSRTagAdd = 476,       /* Insert SR (Seamless Redundancy) tag
                                           in the packet; param0: SR packet type
                                           (BCM_FIELD_SR_TAG_TYPE_xxx) */
    drvFieldActionSRTagDelete = 477,    /* Delete SR (Seamless Redundancy) tag
                                           (if present) in the packet; param0:
                                           SR packet type
                                           (BCM_FIELD_SR_TAG_TYPE_xxx) */
    drvFieldActionSRLanIdNew = 478,     /* Specify SR(Seamless Redundancy) LAN
                                           ID; param0: 0 for LAN A, 1 for LAN B */
    drvFieldActionSRNetIdNew = 479,     /* Specify SR(Seamless Redundancy) NET
                                           ID; param0: NET ID 0~7 */
    drvFieldActionSRFlowIdNew = 480,    /* Specify SR(Seamless Redundancy) flow
                                           ID; param0: SR flow ID */
    drvFieldActionSRFlowPriMapIdNew = 481, /* Specify TSN priority map for
                                           SR(Seamless Redundancy) flow; param0:
                                           TSN priority map ID */
    drvFieldActionMtuSize = 482,        /* Specify MTU size that the packet
                                           should be checked against. It
                                           overrides the MTU size specified from
                                           MTU profile. */
    drvFieldActionStuSize = 483,        /* Specify STU (Shortest Transmission
                                           Unit) size that the packet should be
                                           checked against. It overrides the STU
                                           size specified from MTU profile. */
    drvFieldActionTsnFlowIdNew = 484,   /* Specify TSN (Time-Sensitive
                                           Networking) flow ID; param0: TSN flow
                                           ID. */
    drvFieldActionTsnFlowPriMapIdNew = 485, /* Specify TSN priority map for TSN
                                           flow; param0: TSN priority map ID */
    drvFieldActionMtuProfileIdNew = 486, /* Specify the TSN MTU profile ID;
                                           param0: new MTU profile ID */
    drvFieldActionStuProfileIdNew = 487, /* Specify the TSN STU (Shortest
                                           Transmission Unit) profile ID;
                                           param0: new STU profile ID */
    drvFieldActionExternalValue6Set = 488, /* Set External lookup 6 result */
    drvFieldActionExternalValue7Set = 489, /* Set External lookup 7 result */
    drvFieldActionEsmSearchKeySrcMac = 490, /* This action sets ESM search key to
                                           perform only L2 Source Mac Address
                                           Lookup */
    drvFieldActionMacSecDecrypt = 491,  /* This action adds MACSEC Decrypt OLP
                                           header in Egress  Pipe. This action
                                           does not modify packet in Egress
                                           Pipe. */
    drvFieldActionMacSecEncrypt = 492,  /* This action only adds MACSEC Encrypt
                                           OLP header in Egress Pipe. */
    drvFieldActionMacSecSubPortNumAdd = 493, /* This action assigns MACSEC Subport
                                           number to be used by MACSEC engine
                                           for Security Association lookup */
    drvFieldActionMacSecPktTypeSet = 494, /* This action assigns a MACSEC packet
                                           type to be used in MACSEC block.
                                           MACSEC packet type is defined by
                                           bcm_field_macsec_pkt_type_t. */
    drvFieldActionLatencyFlowId = 495,  /* Update Latency-Flow-Id in OAM-TS
                                           HEADER; param0: New Latency-Flow-Id
                                           value. */
    drvFieldActionMacSecRedirectIpmc = 496, /* This action redirects multicast
                                           MACSEC packets to MACSEC engine and
                                           also adds OLP header in Egress
                                           Pipeline. */
    drvFieldActionCount = 497           /* Always Last. Not a usable value. */
} drv_field_action_t;
