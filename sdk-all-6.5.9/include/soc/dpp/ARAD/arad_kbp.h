...
#define ARAD_KBP_NUM_OF_KBP_SEARCHES(unit)      (SOC_IS_JERICHO(unit) ? \
                                                ((SOC_DPP_CONFIG(unit)->arad->init.elk.tcam_dev_type == ARAD_NIF_ELK_TCAM_DEV_TYPE_BCM52311) ? 8 : 6) : 4)
...
typedef enum
{
    ...
    /* Exclusive */
    ARAD_KBP_FRWRD_LTR_IPV4_DC                       = 20,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED                 = 22,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED_FOR_IP          = 23, 
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED_FOR_IP_WITH_RPF = 24,
    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED_FOR_LSR         = 25,
    ARAD_KBP_FRWRD_LTR_IP_LSR_EXTENDED_IPV6          = 26,
    ARAD_KBP_FRWRD_LTR_IP_LSR_EXTENDED_P2P           = 27,

    /* Dummy forwarding */
    ARAD_KBP_FRWRD_LTR_DUMMY_FRWRD                   = 28,
    ARAD_KBP_MAX_FRWRD_LTR_ID                        = ARAD_KBP_FRWRD_LTR_DUMMY_FRWRD,

    ARAD_KBP_ACL_LTR_ID_OFFSET                       = 30,
