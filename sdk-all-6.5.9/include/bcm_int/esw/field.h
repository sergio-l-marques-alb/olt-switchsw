...
/* Version change to 22  - For 6.5.7 */
...
#define BCM_FIELD_WB_DEFAULT_VERSION            BCM_FIELD_WB_VERSION_1_22
#endif 
...
typedef enum _field_action_set_type_e {
    ...
    _FieldActionLoopbackProfileSet = 9,
    _FieldActionExtractionCtrlId = 10,
    _FieldActionOpaque4Set = 11,
    _FieldActionOpaque3Set = 12,
    _FieldActionOpaque2Set = 13,
    _FieldActionOpaque1Set = 14,
...
typedef enum _bcm_field_internal_element_e {
    ...
    _bcmFieldInternalElementCount = 365
...
#define _BCM_FP_GROUP_ADD_STATE_END                    (0xd)
...
typedef enum _bcmFieldActionNoParam_e {
    ...
    _bcmFieldActionNoParamCount  /* 51*/
