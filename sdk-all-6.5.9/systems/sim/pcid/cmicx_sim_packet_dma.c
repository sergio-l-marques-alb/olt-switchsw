        ...
        if (packet_dma_data->stat_ch_in_halt==false) {
            ...
            if ((packet_dma_data->packet_chunk_countdown==0) && (packet_dma_data->waiting_on_packet==false)) {
                ...
                do {
                    ...
                    cmicx_pcid_mem_read(packet_dma_data->cur_desc_addr,(void *)mem,CMIC_PACKET_DMA_WORDS_PER_DESCRIPTOR*CMICX_BYTES_PER_WORD);
                    ...
                    if (packet_dma_data->desc_reload==true) {
                        cmic_packet_dma_descriptor_done(packet_dma_data);
            ...
            if (packet_dma_data->packet_chunk_countdown==0) {
                ...
                if (packet_dma_data->ctrl_direction==true) {
                    ...
                    cmicx_pcid_mem_read((packet_dma_data->packet_mem_addr-front_diff),(void *)temp_packet_data,(num_words*CMICX_BYTES_PER_WORD));
                    ...
                    cmicx_pcid_mem_write(packet_dma_data->cur_desc_addr+((CMIC_PACKET_DMA_WORDS_PER_DESCRIPTOR-1)*CMICX_BYTES_PER_WORD),(void *)&(mem[3]),CMICX_BYTES_PER_WORD);
                ...
                /* for an rx transmission, write packet data from this channel's packet buffer to host memory */
                    ...
                    /* else, if we do have data available, then we can start writing this data to host memory. */
                        ...
                        if (bytes_transferred!=0) {
                            ...
                            cmicx_pcid_mem_write(packet_dma_data->packet_mem_addr,(void *)temp_packet_data,header_bytes_transferred);
                            ...
                            /* perform the actual write to memory (from our temporary buffer) */
                            cmicx_pcid_mem_write((packet_dma_data->packet_mem_addr+header_bytes_transferred+alignment_bytes),(void *)temp_packet_data,data_bytes_transferred);
