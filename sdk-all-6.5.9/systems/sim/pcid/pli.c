...
#ifdef BCM_CMICX_SIM_SUPPORT
 #include <../systems/sim/pcid/cmicx_sim.h>
#else /* BCM_CMICX_SIM_SUPPORT */
 #include <soc/cmic.h>
 #ifdef BCM_CMICM_SUPPORT
  #include <soc/cmicm.h>
 #endif
#endif /* BCM_CMICX_SIM_SUPPORT */
                   ...
                   uint32 regnum)
{
    ...
    if ((sal_strcmp(pcid_info->opt_chip_name,"BCM56870_A0") == 0) ||
        (sal_strcmp(pcid_info->opt_chip_name,"BCM56980_A0") == 0)) {
