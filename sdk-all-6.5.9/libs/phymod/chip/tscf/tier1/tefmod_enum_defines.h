...
typedef enum {
  ...
  TEFMOD_SPD_10G_25G               ,  /*!< 10G CL36 with 25G vco           */
...
typedef enum {
  ...
  TEFMOD_MSA                       ,  /*!< PHY autoneg for 25G/50G consortium spec */
  TEFMOD_CL73_MSA                  , /*!< PHY autoneg for CL73 and 25G/50G consortium spec */
  TEFMOD_AN_TYPE_ILLEGAL             /*!< Illegal value. programmatic boundary. */
} tefmod_an_type_t;

/*! \def CNT_tefmod_an_type_t Types of enum tefmod_an_type_t */
#define CNT_tefmod_an_type_t 9
...
/*! \def CNT_tefmod_fec_type_t Types of enum tefmod_fec_en_parm_t */
#define CNT_tefmod_fec_type_t 2
...
*/
extern char* e2s_tefmod_fec_type_t [CNT_tefmod_fec_type_t];
