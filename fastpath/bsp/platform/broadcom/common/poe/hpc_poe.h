...
#define HPC_POE_COMM_UART_RX_TIMEOUT 100
#define HPC_POE_COMM_UART_TX_TIMEOUT 100
#define HPC_POE_COMM_UART_FLUSH_TIMEOUT 20
...
typedef enum
{
  HPC_POE_COMM_MODE_BLOCKING=0,
  HPC_POE_COMM_MODE_NONBLOCKING=1,
  HPC_POE_COMM_MODE_INVALID = 254
} HPC_POE_COMM_MODE_t;
...
/*******************************************************************************
*
* @purpose To Flush data from the PoE Interface
*
* @param   L7_uint32              CardIndex     PoE Card Index
*          L7_uint32              flag          0 -- For Receive
                                                1 -- For Transmit
                                                2 -- For Both 
*
