...
**********************************************************************
*
* @filename usmdb_port_user.c
*
* @purpose interface for user manager user/port configuration
*
* @component usmDb
*
* @comments 
...
* @param    usrIndex (output) ptr to username index in database 
...
*********************************************************************/
L7_uint32 
usmDbPortUserGetFirst(L7_uint32 UnitIndex, L7_uint32 intIfNum, L7_uint32 *usrIndex, 
                      L7_uchar8 *pUser, L7_uint32 usrNameLen)
{
    return userMgrPortUserGetFirst( intIfNum, usrIndex, pUser, usrNameLen);
}
...
*********************************************************************/
L7_uint32 
usmDbPortUserGetNext(L7_uint32 UnitIndex, L7_uint32 intIfNum, L7_uint32 *usrIndex, 
                     L7_uchar8 *pUser, L7_uint32 usrNameLen)
{
  return userMgrPortUserGetNext( intIfNum, usrIndex, pUser, usrNameLen);
}
...
{
    return userMgrPortUserAccessSet( intIfNum, pUser, allow );
}
...
{
    return userMgrPortUserAccessGet( intIfNum, pUser, pAllow );
}
...
{
    return userMgrPortUserAccessGetIndex(intIfNum, index, pAllow);
}
