...
L7_RC_t usmDbSnoopAdminModeSet(L7_uint32 UnitIndex, L7_uint32 adminMode,
                               L7_uchar8 family)
{
  return snoopAdminModeSet(adminMode, family);
}
...
{
  return (snoopRouterAlertMandatorySet(checkRtrAlert, family));
}
...
{
  return (snoopRouterAlertMandatoryGet(checkRtrAlert, family));
}
/*****************************************************************************
...
L7_RC_t usmDbSnoopIntfApiVlanStaticMcastRtrMaskGet(L7_uint32 unit, L7_uint32 intIfNum,
                                              ...
                                              L7_uchar8 family)
{
  return (snoopIntfApiVlanStaticMcastRtrMaskGet(intIfNum, vlanStaticMcastRtr, family));
}
/*********************************************************************
...
{
  return snoopVlanCheckValid(vid);
}
/*********************************************************************
...
{
  return snoopVlanNextGet(vlanId, nextVlan);
}
