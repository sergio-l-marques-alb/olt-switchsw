...
L7_RC_t usmDbDot1qVlanStaticEntryGet ( L7_uint32 UnitIndex, L7_uint32 VlanIndex )
{
  ...
  if ( dot1qVlanCheckValid(VlanIndex) == L7_SUCCESS )
  {
    if (dot1qOperVlanTypeGet(VlanIndex, &val) == L7_SUCCESS && val != L7_DOT1Q_DYNAMIC && 
        val != L7_DOT1Q_WS_DYNAMIC  && val != L7_DOT1Q_IP_INTERNAL_VLAN && val != L7_DOT1Q_DOT1X_REGISTERED)
    {
      return L7_SUCCESS;
    }
  }
...
L7_RC_t usmDbVlanTaggedSet(L7_uint32 UnitIndex, L7_uint32 vlanIndex, L7_uint32 interface, L7_uint32 mode)
{
  ...
  return dot1qVlanTaggedMemberSet(vlanIndex, interface, mode, DOT1Q_ADMIN);
}
...
{
  return dot1qInternalVlanPolicySet(policy);
}
...
{
  return dot1qInternalVlanPolicyGet();
}
...
{
  return dot1qBaseInternalVlanIdSet(baseVlanId);
}
...
{
  return dot1qBaseInternalVlanIdGet();
}
...
* @end
*********************************************************************/
L7_RC_t usmDbDot1qInternalVlanFindFirst(L7_uint32 *vlanId)
{
  return dot1qInternalVlanFindFirst(vlanId);
}
...
{
  return dot1qInternalVlanFindNext(vid, nextvid);
}
...
{
  return dot1qInternalVlanUsageDescrGet(vid, descr);
}
