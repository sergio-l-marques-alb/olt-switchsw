...
L7_RC_t usmDbFDBAddressAgingTimeoutSet(L7_uint32 UnitIndex, L7_uint32 fdbId, L7_uint32 timeOut)
{
  ...
  if (((timeOut < L7_FDB_MIN_AGING_TIMEOUT) && (0 != timeOut)) 
       || (timeOut > L7_FDB_MAX_AGING_TIMEOUT))
   {
    return rc;
  }
