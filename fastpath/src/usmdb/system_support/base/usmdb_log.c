...
*
* @param    unitIndex @b{(input)}  the unit index
* @param    featureStatus @b{(input)} ENABLE/DISABLE
*
*
* @returns  L7_SUCCESS  if success
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertStatusSet(L7_uint32 unitIndex, L7_uint32 featureStatus)
{

  return logemailAlertAdminStatusSet(featureStatus);
}

/**********************************************************************
* @purpose  To set the severity for the urgent log messages.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    featureStatus @b{(input)} ENABLE/DISABLE
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertUrgentSeveritySet(L7_uint32 unitIndex, L7_uint32 severity)
{
  return logemailAlertUrgentSeveritySet(severity);
}

/**********************************************************************
* @purpose  TO set the severity for the Trap messages.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    featureStatus @b{(input)} ENABLE/DISABLE
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertTrapSeveritySet(L7_uint32 unitIndex, L7_uint32 severity)
{
  return logemailAlertTrapSeveritySet(severity);
}

/**********************************************************************
* @purpose  To set the email Alerting to_addr for a perticular message type
*
* @param    unitIndex @b{(input)}  the unit index
* @param    msgType @b{(input)}  msg type
* @param    toAddr @b{(input)}  to address of the email
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertToAddrSet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t msgType, L7_char8 * toAddr, L7_LOG_EMAIL_ALERT_ERROR_t *errorValue)
{
  return logEmailAlertToAddrSet(msgType, toAddr, errorValue);

}
/**********************************************************************
* @purpose  To remove the email Alerting to_addr for a perticular message type
*
* @param    unitIndex @b{(input)}  the unit index
* @param    msgType @b{(input)}  msg type
* @param    toAddr @b{(input)}  to address of the email
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertToAddrRemove(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t msgType, L7_char8 * toAddr)
{
  return logEmailAlertToAddrRemove(msgType, toAddr);

}

/**********************************************************************
* @purpose  To set the subject of the email for a perticular message type
*
* @param    unitIndex @b{(input)}  the unit index
* @param    msgType @b{(input)}  msg type
* @param    subject   @b{(input)}  subject of the email
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertSubjectSet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t msgType, L7_char8 * subject)
{
  return logEmailAlertSubjectSet(msgType, subject);
}


/**********************************************************************
* @purpose  To set the email Alerting from_addr.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    toAddr @b{(input)}  from address of the email
*
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertFromAddrSet(L7_uint32 unitIndex, L7_char8 * fromAddr, L7_LOG_EMAIL_ALERT_ERROR_t *errorValue)
{

  return logEmailAlertFromAddrSet(fromAddr, errorValue);
}
/**********************************************************************
* @purpose  To set the log time.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    logDuration @b{(input)}  log duration
*
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlerLogTimeSet(L7_uint32 unitIndex, L7_uint32 logDuration)
{
  return logEmailAlertLogTimeSet(logDuration);
}

/**********************************************************************
* @purpose  To set the security protocol for the email alert.
*
* @param    unitIndex @b{(input)}  the unit index
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerSecuritySet(L7_uint32 unitIndex, L7_char8 * mailServerAddr, L7_uint32 securityProtocol)
{
  return logEmailAlertMailServerSecurityProtocolSet(mailServerAddr, securityProtocol);
}



/**********************************************************************
* @purpose  To set the authentication parameters.
*
* @param    unitIndex @b{(input)}  the unit index
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerUsernameSet(L7_uint32 unitIndex, L7_char8 * mailServerAddr, L7_char8 * username)
{

  return logEmailAlertMailServerUsernameSet(mailServerAddr, username);
}
/**********************************************************************
* @purpose  To set the authentication parameters.
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerPasswdSet(L7_uint32 unitIndex, L7_char8 * mailServerAddr, L7_char8 * passwd)
{

  return logEmailAlertMailServerPasswdSet(mailServerAddr, passwd);
}

/**********************************************************************
* @purpose  To set the severity level.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    passwd @b{(input)}severityLevel  
*
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertNonUrgentSeveritySet(L7_uint32 unitIndex,L7_uint32 severityLevel)
{

  return logEmailAlertnonUrgentSeveritySet(severityLevel);
}

/**********************************************************************
* @purpose  To Set the SMTP server Address.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @{(input)}  Address type
* @param    host @b{(input)}  SMTP server address
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerAddressSet(L7_uint32 unitIndex, L7_IP_ADDRESS_TYPE_t type,  L7_char8 * mailServerAddr)
{

  return logEmailAlertMailServerAddressSet(type, mailServerAddr);
}

/**********************************************************************
* @purpose  To Remove the SMTP server Address.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @{(input)}  Address type
* @param    host @b{(input)}  SMTP server address
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerAddressRemove(L7_uint32 unitIndex, L7_IP_ADDRESS_TYPE_t  type,  L7_char8 * mailServerAddr)
{

  return logEmailAlertMailServerAddressRemove(type, mailServerAddr);
}


/**********************************************************************
* @purpose  To Set the SMTP Port Address.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @{(input)}  Address type
* @param    port @b{(input)}  SMTP port address
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerPortSet(L7_uint32 unitIndex, L7_char8 * mailServerAddr, L7_uint32 port)
{
  return logEmailAlertMailServerPortSet(mailServerAddr, port);
}

/**********************************************************************
* @purpose  TO get the email Alerting Admin status.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    featureStatus @b{(input)} ENABLE/DISABLE
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertStatusGet(L7_uint32 unitIndex, L7_uint32 *featureStatus)
{

  return logemailAlertAdminStatusGet(featureStatus);
}
/**********************************************************************
* @purpose  To get the first to_addr stored for a perticular msg type.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    toAddr @b{(input)}  to address of the email
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertToAddrGet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t msgType, L7_char8 * toAddr)
{

  return logEmailAlertAddrGet(msgType,toAddr);
}

/**********************************************************************
* @purpose  To get the next to_addr stored for a perticular msg type.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    toAddr @b{(input)}  to address of the email
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertNextToAddrGet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t *msgType, L7_char8 * toAddr)
{

  return logEmailAlertNextAddrGet(msgType,toAddr);
}

/**********************************************************************
* @purpose  To get the email Alerting from_addr.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    toAddr @b{(input)}  from address of the email
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertFromAddrGet(L7_uint32 unitIndex, L7_char8 * fromAddr)
{

  return logEmailAlertFromAddrGet(fromAddr);
}

/**********************************************************************
* @purpose  To get the subject configured for each message type.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    toAddr @b{(input)}  from address of the email
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertSubjectGet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t msgType, L7_char8 * subject)
{
  return logEmailAlertSubjectGet(msgType,subject);

}

/**********************************************************************
* @purpose  To get the subject configured for next message type.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    toAddr @b{(input)}  from address of the email
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertNextSubjectGet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t *msgType, L7_char8 * subject)
{
  return logEmailAlertNextSubjectGet(msgType,subject);

}

/**********************************************************************
* @purpose  To get the urgent severity level.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    urgentSeverityLevel @b{(input)}urgent severityLevel  
*
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertUrgentSeverityGet(L7_uint32 unitIndex,L7_uint32 *urgentSeverityLevel )
{
  return logEmailAlertUrgentSeverityGet(urgentSeverityLevel );

}

/**********************************************************************
* @purpose  To get the non urgent severity level.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    severityLevel @b{(input)}non urgent severity Level  
*
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertNonUrgentSeverityGet(L7_uint32 unitIndex,L7_uint32 *severityLevel)
{

  return logEmailAlertNonUrgentSeverityGet(severityLevel);
}

/**********************************************************************
* @purpose  To get the Trap severity level.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    severityLevel @b{(input)}trap severity Level  
*
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertTrapSeverityGet(L7_uint32 unitIndex,L7_uint32 *severityLevel)
{

  return logEmailAlertTrapSeverityGet(severityLevel);
}


/**********************************************************************
* @purpose  To get the log time.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    logDuration @b{(input)}  log duration
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertLogTimeGet(L7_uint32 unitIndex, L7_uint32 *logDuration)
{
  return logEmailAlertLogTimeGet(logDuration);
}

/**********************************************************************
* @purpose  To get the security protocol for the email alert.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    securityProtocol @b{(input)}  Security Protocol
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerSecurityGet(L7_uint32 unitIndex,  L7_char8 *  mailServerAddr, L7_uint32 *securityProtocol)
{

	return logEmailAlertSecurityProtocolGet(mailServerAddr, securityProtocol);
}

/**********************************************************************
* @purpose  To get the authentication parameters.
*
* @param    unitIndex @b{(input)}  the unit index
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerUsernameGet(L7_uint32 unitIndex,  L7_char8 *  mailServerAddr, L7_char8  *username)
{

  return logEmailAlertMailServerUsernameGet(mailServerAddr, username);
}
/**********************************************************************
* @purpose  To get the authentication parameters.
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerPasswdGet(L7_uint32 unitIndex,  L7_char8 * mailServerAddr, L7_char8 * passwd)
{

  return logEmailAlertMailServerPasswdGet(mailServerAddr, passwd);
}
/**********************************************************************
* @purpose  To Get the Mail server Address.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @{(input)}  Address type
* @param    host @b{(input)}  SMTP server address
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerAddressGet(L7_uint32 unitIndex, L7_IP_ADDRESS_TYPE_t type,  L7_char8 *  mailServerAddr )
{

  return logEmailAlertMailServerAddressGet( type, mailServerAddr);
}


/**********************************************************************
* @purpose  To Get the first Mail server Address.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @{(input)}  Address type
* @param    host @b{(input)}  SMTP server address
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertFirstMailServerAddressGet(L7_uint32 unitIndex, L7_IP_ADDRESS_TYPE_t *type,  L7_char8 *  mailServerAddr )
{

  return logEmailAlertMailServerAddressGetFirst( type, mailServerAddr);
}

/**********************************************************************
* @purpose  To Get the next Mail server Address.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @{(input)}  Address type
* @param    host @b{(input)}  SMTP server address
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertNextMailServerAddressGet(L7_uint32 unitIndex, L7_IP_ADDRESS_TYPE_t *type,  L7_char8 *  mailServerAddr )
{

  return logEmailAlertMailServerAddressGetNext(type, mailServerAddr);
}


/**********************************************************************
* @purpose  To Get the Mail server Port.
*
* @param    unitIndex @b{(input)}  the unit index
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertMailServerPortGet(L7_uint32 unitIndex, L7_char8 * mailServerAddr, L7_uint32   * port)
{
  return logEmailAlertMailServerPortGet(mailServerAddr, port);
}

/**********************************************************************
* @purpose  To Get email Alert Stats
*
* @param    unitIndex @b{(input)}  the unit index
* @param    emailAlertStats @b{(input)}  emailAlertStats
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertStatsGet(L7_uint32 unitIndex, emailAlertingStatsData_t* emailAlertStatistics)
{
  return logEmailAlertStatsGet(emailAlertStatistics);
}

/**********************************************************************
* @purpose  To Clear email Alert Stats
*
* @param    unitIndex @b{(input)}  the unit index
* @param    emailAlertStats @b{(input)}  emailAlertStats
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertStatsClear(L7_uint32 unitIndex)
{
  return logEmailAlertStatsClear();
}

/**********************************************************************
* @purpose  To find Mail Server Address
*
* @param    unitIndex @b{(input)}  the unit index
* @param    type @b{(input)}  Message type
* @param    address @b{(input)}  server address
* @param    serverIndex @b{(input)}  server entry index
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDblogEmailAlertMailServerEntryGet(L7_uint32 index, L7_uint32 type, L7_char8 *  address, L7_uint32 serverIndex)
{
  return logEmailAlertMailServerEntryFind(address, &serverIndex);
}

/**********************************************************************
* @purpose  To find Toaddress in database
*
* @param    type @b{(input)}  Message type
* @param    address @b{(input)}  Toaddress
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if failure 
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertToAddrFind(L7_uint32 type, L7_char8 * address)
{
  return logEmailAlertAddrFind(type, address);
}

/**********************************************************************
* @purpose  To get the email Alerting operational status.
*
* @param    unitIndex @b{(input)}  the unit index
* @param    featureStatus @b{(input)} ENABLE/DISABLE
*
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertOperationalStatusGet(L7_uint32 unitIndex, L7_uint32 *operationalStatus)
{

  return logemailAlertOperationalStatusGet(operationalStatus);
}
