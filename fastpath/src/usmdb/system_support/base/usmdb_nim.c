...
{
  return nimIsIntfSpeedAuto(intIfNum);
}
...
{
  return nimIntfDuplexGet(intIfNum, val);
}
...
{
  return nimIntfSpeedGet(intIfNum, val);
}
...
* @table{@row{@cell{L7_PORT_CAPABILITY_SPEED_10}}
*        @row{@cell{L7_PORT_CAPABILITY_SPEED_100}}
*        @row{@cell{L7_PORT_CAPABILITY_SPEED_1000}}
*        @row{@cell{L7_PORT_CAPABILITY_SPEED_10G}}
*        @row{@cell{L7_PORT_CAPABILITY_SPEED_AUTO}}
* @end
*********************************************************************/
...
* @end
*********************************************************************/
L7_RC_t usmDbIfIntfL3MacAddressGet(L7_uint32 UnitIndex, 
                                   L7_uint32 interface,
                                   L7_uchar8 *buf)
{
  return nimGetIntfL3MacAddress(interface, L7_NULL, buf);
}
...
{
  L7_uint32 SpeedCapList[3] = {0, 0, 0};
  L7_uint32 i, duplex_mode;
  L7_uint32 phyCapability,AutoNegVal = 0;
  L7_RC_t rc = L7_SUCCESS;
  
  for(i = 0; i < 3; i++) 
  {
   if((intfSpeed & L7_PORT_CAPABILITY_SPEED_10) != 0)
   {
     SpeedCapList[i] = L7_PORT_CAPABILITY_SPEED_10;
   }
   else if((intfSpeed & L7_PORT_CAPABILITY_SPEED_100) != 0)
   {
     SpeedCapList[i] = L7_PORT_CAPABILITY_SPEED_100;
   }
   else if((intfSpeed & L7_PORT_CAPABILITY_SPEED_1000) != 0)
   {
     SpeedCapList[i] = L7_PORT_CAPABILITY_SPEED_1000;
   }
   else
   {
     break;
  ...
  if((SpeedCapList[0] == 0) && ((intfSpeed & L7_PORT_CAPABILITY_SPEED_AUTO) != 0))
  {
   /* if SpeedCapList array doesnt have even one non-zero element but 
      auto-neg is set, then it is with all speed-capabilities*/  
   SpeedCapList[0] = L7_PORT_CAPABILITY_SPEED_10;
   SpeedCapList[1] = L7_PORT_CAPABILITY_SPEED_100;
   SpeedCapList[2] = L7_PORT_CAPABILITY_SPEED_1000; 
  }

  if (usmDbIfDuplexGet(intIfNum, &duplex_mode) != L7_SUCCESS)
    return L7_FAILURE;
  
  if (L7_SUCCESS != (usmDbIntfPhyCapabilityGet(intIfNum, &phyCapability)))
      return L7_FAILURE;

   /* if the code traversed into this function, then it implies speed or duplex 
      is configured as "auto"*/    

   for(i = 0; i < 3; i++)
   {
    switch(SpeedCapList[i])
    {
     case L7_PORT_CAPABILITY_SPEED_10:
         if (duplex_mode == L7_PORT_CAPABILITY_DUPLEX_AUTO)
         {
           if (((phyCapability & L7_PHY_CAP_PORTSPEED_HALF_10) != 0) || 
               ((phyCapability & L7_PHY_CAP_PORTSPEED_FULL_10) != 0))
           {
             AutoNegVal |= L7_PORT_NEGO_CAPABILITY_HALF_10;
             AutoNegVal |= L7_PORT_NEGO_CAPABILITY_FULL_10;   
           }
           else
           {
             rc = L7_ERROR;
         ...
         else if (duplex_mode == L7_PORT_CAPABILITY_DUPLEX_HALF)
         {
          if ((phyCapability & L7_PHY_CAP_PORTSPEED_HALF_10) != 0)
          {
            AutoNegVal |= L7_PORT_NEGO_CAPABILITY_HALF_10;
         ...
         else if (duplex_mode == L7_PORT_CAPABILITY_DUPLEX_FULL)
         {
          if ((phyCapability & L7_PHY_CAP_PORTSPEED_FULL_10) != 0)
          {
            AutoNegVal |= L7_PORT_NEGO_CAPABILITY_HALF_10;
          }
          else
     ...
     case L7_PORT_CAPABILITY_SPEED_100:    
         if (duplex_mode == L7_PORT_CAPABILITY_DUPLEX_AUTO)
         {
           if (((phyCapability & L7_PHY_CAP_PORTSPEED_HALF_100) != 0) ||
               ((phyCapability & L7_PHY_CAP_PORTSPEED_FULL_100) != 0))
           {
             AutoNegVal |= L7_PORT_NEGO_CAPABILITY_HALF_100;
             AutoNegVal |= L7_PORT_NEGO_CAPABILITY_FULL_100;
           }
           else
           {
             rc = L7_ERROR;
         ...
         {
          if ((phyCapability & L7_PHY_CAP_PORTSPEED_FULL_100) != 0)
          {
            AutoNegVal |= L7_PORT_NEGO_CAPABILITY_HALF_100;
          }
          else
     ...
     case L7_PORT_CAPABILITY_SPEED_1000:
         if ((duplex_mode == L7_PORT_CAPABILITY_DUPLEX_AUTO) ||
             (duplex_mode == L7_PORT_CAPABILITY_DUPLEX_FULL))
         {
           if ((phyCapability & L7_PHY_CAP_PORTSPEED_FULL_1000) != 0)
           {
             AutoNegVal |= L7_PORT_NEGO_CAPABILITY_FULL_1000; 
           }
           else
           {
             rc = L7_ERROR;
