...
{
  return dhcpVendorClassOptionAdminModeSet(adminMode, actImmediate);
}
/******************************************************************
...
usmdbDhcpVendorClassOptionStringSet (L7_uchar8 *optionString,
                                     L7_BOOL actImmediate)
{
  return dhcpVendorClassOptionStringSet(optionString, actImmediate);
}
/*********************************************************************
...
usmDbIpDhcpClientDebugTraceFlagSet (L7_BOOL rxFlag,
                                    L7_BOOL txFlag)
{
  return dhcpClientDebugTraceFlagSet (rxFlag, txFlag);
}
...
usmDbIpDhcpClientDebugTraceFlagGet (L7_BOOL *rxFlag,
                                    L7_BOOL *txFlag)
{
  return dhcpClientDebugTraceFlagGet (rxFlag, txFlag);
}
...
{
  return dhcpClientDhcpServerIPAddressGet (intIfNum, serverAddr);
}
...
{
  return dhcpClientIPAddressGet (intIfNum, clientAddr);
}
...
{
  return dhcpClientNetworkMaskGet (intIfNum, clientMask);
}
...
{
  return dhcpClientStateGet (intIfNum, clientState);
}
...
usmDbIpDhcpClientTransactionIdGet (L7_uint32 intIfNum,
                                   L7_uint32 *transId)
{
  return dhcpClientTransactionIdGet (intIfNum, transId);
}
...
{
  return dhcpClientLeaseTimeInfoGet (intIfNum, leaseTime, renewalTime,
                                     rebindTime);
}
...
{
  return dhcpClientRetryCountGet (intIfNum, retryCount);
}
...
usmDbIpDhcpClientConfiguredIPAddressSet (L7_MGMT_PORT_TYPE_t mgmtPortType,
                                         ...
                                         L7_uint32 ipGateway)
{
  return dhcpClientConfiguredIPAddressSet (mgmtPortType, ipAddr, netMask,
                                           ipGateway);
}
