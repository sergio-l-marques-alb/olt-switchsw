...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetAdminModeGet(L7_uint32 UnitIndex, L7_uint32 *pMode)
{
  L7_RC_t rc;

  rc = telnetMapAdminModeGet(pMode);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetAdminModeSet(L7_uint32 UnitIndex, L7_uint32 mode)
{
  L7_RC_t rc;

  rc = telnetMapAdminModeSet(mode);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetMaxSessionsGet(L7_uint32 UnitIndex, L7_uint32 *pMaxNoOfSessions)
{
  L7_RC_t rc;

  rc = telnetMapMaxSessionsGet(pMaxNoOfSessions);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetMaxSessionsSet(L7_uint32 UnitIndex, L7_uint32 maxNoOfSessions)
{
  L7_RC_t rc;

  rc = telnetMapMaxSessionsSet(maxNoOfSessions);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetNoOfActiveSessionsGet(L7_uint32 UnitIndex, L7_uint32 *pNoOfActiveSessions)
{
  L7_RC_t rc;

  rc = telnetMapNoOfActiveSessionsGet(pNoOfActiveSessions);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetTimeoutGet(L7_uint32 UnitIndex, L7_uint32 *pTimeout)
{
  L7_RC_t rc;

  rc=telnetMapTimeoutGet(pTimeout);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetTimeoutSet(L7_uint32 UnitIndex, L7_uint32 timeout)
{
  L7_RC_t rc;

  rc = telnetMapTimeoutSet(timeout);
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetMaxSessionsReset(L7_uint32 UnitIndex)
{
  L7_RC_t rc;

  rc = telnetMapMaxSessionsReset();
  return(rc);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbTelnetTimeoutReset(L7_uint32 UnitIndex)
{
  L7_RC_t rc;

  rc = telnetMapTimeoutReset();
  return(rc);
}
...
* @end
*********************************************************************/
L7_int32 usmDbTelnetNewCon(L7_uint32 UnitIndex, telnetParams_t *telnetParams)
{
  return telnetMapNewCon(telnetParams);
}
...
void usmDbTelnetDisconnect(L7_uint32 clientSock, L7_uint32 serverSock)
{
  telnetMapDisconnect(clientSock, serverSock);
}
...
* @end
*********************************************************************/
L7_RC_t usmdbObtServerInputHandle(L7_uint32 UnitIndex, L7_uint32 clientSock, L7_uint32 serverSock)
{
  return obtMapServerInputHandle(clientSock, serverSock);
}
...
* @end
*********************************************************************/
L7_RC_t usmdbObtClientInputHandle(L7_uint32 UnitIndex, L7_uint32 clientSock, L7_uint32 serverSock)
{
  return obtMapClientInputHandle(clientSock, serverSock);
}
...
{
  return cliObtLoginSessionStart(index);
}
...
{
  return cliObtLoginSessionEnd(index);
}
...
{
  return cliLoginSessionUpdateObtActivityTime(index);
}
