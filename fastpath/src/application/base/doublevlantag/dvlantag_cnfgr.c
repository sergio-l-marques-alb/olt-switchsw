 ...
 */
L7_uint32 dvlantagDeviceEthertype = L7_NULL;
L7_BOOL dvlantagDeviceEthertypePresent = L7_FALSE;
extern PORTEVENT_MASK_t dvlanEventMask_g;
  ...
  *pReason   = 0;
  ...
  if (osapiRWLockCreate(&dvlantagCfgRWLock, OSAPI_RWLOCK_Q_PRIORITY) == L7_FAILURE)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DVLANTAG_COMPONENT_ID,
            "dvlantagCnfgrInitPhase1Process: Unable to create r/w lock for dvlantag\n");
    *pResponse = 0;
                                        ...
                                        L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  ...
  if ((dvlantagRC = nimRegisterIntfChange(L7_DVLANTAG_COMPONENT_ID,
                                          dvlantagIntfChangeCallBack,
                                          dvlantagStartupNotifyCallBack,
                                          NIM_STARTUP_PRIO_DVLANTAG)) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DVLANTAG_COMPONENT_ID,
                                        ...
                                        L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  ...
  memset(&dvlanEventMask_g, 0, sizeof(dvlanEventMask_g));
