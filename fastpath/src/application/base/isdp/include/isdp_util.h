...
#define ISDP_ID_FORMAT_CAP_HN_STRING         "Host Name"
#define ISDP_ID_FORMAT_CAP_OTHER_STRING      "Other"

#define ISDP_DEVICE_ID_FORMAT_CAPABILITY_CURRENT_BITMASK \
 (L7_ISDP_DEVICE_ID_FORMAT_CAPABILITY_SERIAL_BITMASK|L7_ISDP_DEVICE_ID_FORMAT_CAPABILITY_HOSTNAME_BITMASK)
