                                     ...
                                     L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  ...
  /*-----------------------------------------------------------*/
  pTelnetMapCfgData = osapiMalloc(L7_TELNET_MAP_COMPONENT_ID, sizeof(L7_telnetMapCfg_t));

  /* Make sure that allocation succeded */
  if (pTelnetMapCfgData == L7_NULL)
  {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_TELNET_MAP_COMPONENT_ID,
              "%s: %d: telnetCnfgrInitPhase1Process: Error allocating memory for Outbound Telnet \
                Config structure\n",__FILE__, __LINE__);
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_TELNET_MAP_COMPONENT_ID,
            "%s: %d: telnetCnfgrInitPhase1Process: Error starting Outbound Telnet apps\n",
            __FILE__, __LINE__);
    *pResponse = 0;
                                       ...
                                       L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  rc = L7_SUCCESS;
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_TELNET_MAP_COMPONENT_ID,
                "%s: %d: telnetCnfgrInitPhase2Process: Could not register with nvStore\n",
                __FILE__, __LINE__);
    *pResponse = 0;
    *pReason   = L7_CNFGR_ERR_RC_FATAL;
    rc = L7_ERROR;
                                       ...
                                       L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  rc = L7_SUCCESS;
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_TELNET_MAP_COMPONENT_ID,
                "%s: %d: telnetCnfgrInitPhase3Process: Outbound Telnet unable to read \
                config file\n", __FILE__, __LINE__);
        *pResponse = 0;
        *pReason   = L7_CNFGR_ERR_RC_FATAL;
        rc = L7_ERROR;
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_TELNET_MAP_COMPONENT_ID,
                "%s: %d: telnetCnfgrInitPhase3Process: Outbound Telnet unable to apply \
                config\n", __FILE__, __LINE__);
        *pResponse = 0;
        *pReason   = L7_CNFGR_ERR_RC_FATAL;
        rc = L7_ERROR;
...
void telnetCnfgrFiniPhase1Process()
{
  ...
  {
    osapiFree(L7_TELNET_MAP_COMPONENT_ID, pTelnetMapCfgData);
