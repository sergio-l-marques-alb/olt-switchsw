...
typedef enum
{
  ...
  LLDP_8023_MDI_PWR_TYPE2_PSE = 0,
  LLDP_MED_EXT_PWR_DEVICE_TYPE_PD = 1,
  LLDP_8023_MDI_PWR_TYPE2_PD = 1,
  LLDP_MED_EXT_PWR_DEVICE_TYPE_RSVD1 = 2,
  LLDP_8023_MDI_PWR_TYPE1_PSE = 2,
  LLDP_MED_EXT_PWR_DEVICE_TYPE_RSVD2 = 3,
  LLDP_8023_MDI_PWR_TYPE1_PD = 3
...
#define POWER_DEVICE_TYPE2_PSE       (LLDP_8023_MDI_PWR_TYPE2_PSE << LLDP_MED_EXT_POWER_TYPE_SHIFT)
#define POWER_DEVICE_TYPE2_PD        (LLDP_8023_MDI_PWR_TYPE2_PD << LLDP_MED_EXT_POWER_TYPE_SHIFT)
#define POWER_DEVICE_TYPE1_PSE       (LLDP_8023_MDI_PWR_TYPE1_PSE << LLDP_MED_EXT_POWER_TYPE_SHIFT)
#define POWER_DEVICE_TYPE1_PD        (LLDP_8023_MDI_PWR_TYPE1_PD << LLDP_MED_EXT_POWER_TYPE_SHIFT)
...
#define LLDP_8023_POWER_MDI_PORT_CLASS        0x01
#define LLDP_8023_POWER_MDI_POWER_SUPPORT     0x02
#define LLDP_8023_POWER_MDI_POWER_STATE       0x04
#define LLDP_8023_POWER_MDI_PORT_PAIR_CNTRL   0x08

typedef struct 
{
  L7_uchar8 mdiSupport[1];  /* 7-4:Reserved , 3:Pair Control Ability , 2: Power State , 1:PSE Power Support , 0:Port Class */
  L7_uchar8 psePair[1];  
  L7_uchar8 powerClass[1];        
  L7_uchar8 type[1];        /* 7-6:PowerType , 5-4:PowerSource , 3-2:Reserved , 1-0: Priority */
  L7_uchar8 pdReqValue[2];        
  L7_uchar8 pseAllocValue[2];        
}lldp8023PowerMdiTLV_t;
...
*
*********************************************************************/
L7_RC_t lldp8023PowerMDITLVWrite(L7_uint32 index, L7_uint32 intIfNum, 
                                     lldpPDUHandle_t* pduHdl);
