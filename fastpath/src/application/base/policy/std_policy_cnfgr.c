...
extern PORTEVENT_MASK_t policyEventMask_g;
                                      ...
                                      L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  ...
  if ((policyRC = nimRegisterIntfChange(L7_POLICY_COMPONENT_ID,
                                        policyIntfChangeCallback,
                                        policyStartupNotifyCallback,
                                        NIM_STARTUP_PRIO_POLICY)) != L7_SUCCESS)
  {
  ...
  policyDeregister.policyIntfChangeCallbackFlag = L7_FALSE;
                                      ...
                                      L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  memset(&policyEventMask_g, 0, sizeof(policyEventMask_g));
...
void policyCnfgrFiniPhase2Process()
{
  ...
  policyDeregister.policyIntfChangeCallbackFlag = L7_TRUE;
