...
/* DFF - PTin added: IGMPv3 snooping */
  ...
  snoop_ptin_grouptimer_init(); // IGMPv3 grouptimer
  snoop_ptin_sourcetimer_init(); // IGMPv3 sourcetimer
  snoop_ptin_querytimer_init(); // IGMPv3 querytimer
