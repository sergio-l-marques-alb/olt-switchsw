...
typedef struct snoopPTinProxyGrouptimerParams_s
{
  L7_uint8 eventIdx;
} snoopPTinProxyGrouptimerParams_t;


#define PTIN_IGMP_TIMER_MSG_SIZE  sizeof(snoopPTinProxyGrouptimerParams_t)
...
{
  snoopPTinProxyGrouptimerParams_t msg = {0};
  L7_RC_t                     rc;
...
{
  L7_uint32                   status;
  snoopPTinProxyGrouptimerParams_t msg;
...
L7_uint16      pInterfaceIdx,qInterfaceIdx;
  ...
  pgroupAddr = ((snoopPTinProxyGrouptimer_t *) p)->groupData->snoopPTinProxyGrouptimerInfoDataKey.groupAddr;
  pVlanId         = ((snoopPTinProxyGrouptimer_t *) p)->groupData->snoopPTinProxyGrouptimerInfoDataKey.vlanId;
  pInterfaceIdx   = ((snoopPTinProxyGrouptimer_t *) p)->groupData->snoopPTinProxyGrouptimerInfoDataKey.interfaceIdx;

  qgroupAddr = ((snoopPTinProxyGrouptimer_t *) q)->groupData->snoopPTinProxyGrouptimerInfoDataKey.groupAddr;
...
{
  snoopPTinProxyGrouptimer_t *pTimerData;
  ...
  pTimerData = (snoopPTinProxyGrouptimer_t *)ll_member;
...
void timerCallback(void *param)
{
  ...
  snoopPTinProxyGrouptimerInfoData_t *groupData;
  ...
  /* Get timer handler */
  pTimerData = (snoopPTinProxyGrouptimer_t*) handleListNodeRetrieve(timerHandle);
...
//Send Report
  ...
  {
//Schedule Report
    snoop_ptin_proxy_Grouptimer_start(pTimerData, pTimerData->selectedDelay, pTimerData->mgmdsQRV,pTimerData->groupData);
    return;
  }
