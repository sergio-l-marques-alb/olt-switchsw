...
typedef struct pmlStartupNotifyParms_s
{
  NIM_STARTUP_PHASE_t startupPhase;
} pmlStartupNotifyParms_t;
...
typedef struct
{
  ...
  union
  {
    ...
    pmlStartupNotifyParms_t pmlStartupNotifyParms;
  } u;
} pmlMgmtMsg_t;
...
* @end
*********************************************************************/
L7_RC_t pmlCnfgrInitPhase3Process( L7_BOOL              warmRestart,
