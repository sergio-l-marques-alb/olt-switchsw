...
extern L7_uchar8 *pppoeInitStateNames[];

#define PPPOE_TRACE_LEN_MAX 255
...
/*********************************************************************
* @purpose  Apply a change to the PPPoE config state
*
* @param    adminMode   @b((input)) PPPoE admin mode
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
L7_RC_t pppoeAdminModeApply(L7_uint32 adminMode)
{
  if (adminMode == L7_ENABLE)
    return pppoeAdminModeEnable();
  else
    return pppoeAdminModeDisable(L7_TRUE);
}

/*********************************************************************
* @purpose  Enable PPPoE globally
*
* @param    void
*
* @returns  L7_SUCCESS
...
/*********************************************************************
* @purpose  Disable PPPoE globally.
*
