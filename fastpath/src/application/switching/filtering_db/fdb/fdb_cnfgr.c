...
L7_RC_t fdbCnfgrInitPhase3Process( L7_BOOL              warmRestart,
          ...
          case L7_CNFGR_CMD_INITIALIZE:
            switch ( request )
            {
              ...
              case L7_CNFGR_RQST_I_PHASE3_START:  /* no configuration data to be read */
                ...
                if ((fdbRC = fdbCnfgrInitPhase3Process(warmRestart, &response, &reason )) != L7_SUCCESS)
                {
