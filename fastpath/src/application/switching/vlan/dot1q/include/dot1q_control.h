...
typedef struct dot1qNimStartup_s
{
...
/* pending VLAN creation */
#define DOT1Q_MAX_PENDING_CREATES DOT1Q_MAX_EVENTS

typedef struct dot1qVlanPendingCreate_s
{
    L7_uint32            vlanId;           /* 1-4094 valid, 4095 for implementation use   */
    dot1qVlanTypeVal_t   vlanType;         /* one of dot1qVlanTypeVal_t */
} dot1qVlanPendingCreate_t;
...
L7_RC_t dot1qVlanTaggedMemberSetModify(L7_uint32 vlanId,L7_uint32 intIfNum, L7_uint32 mode, vlanRequestor_t requestor);
