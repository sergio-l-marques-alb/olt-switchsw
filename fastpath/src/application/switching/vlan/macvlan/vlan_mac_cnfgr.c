                                      ...
                                      L7_CNFGR_ERR_RC_t *pReason)
{
    ...
    *pReason = 0;
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_VLAN_MAC_COMPONENT_ID, "vlanMacCnfgrInitPhase1Process: Unable to "
                                      ...
                                      L7_CNFGR_ERR_RC_t * pReason)
{
    ...
    *pReason = 0;
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_VLAN_MAC_COMPONENT_ID, "Unable to register for VLAN change callback! "
  ...
  if (txtCfgApplyCompletionNotifyRegister(L7_VLAN_MAC_COMPONENT_ID,
                                          vlanMacTxtCfgApplyCompletionCallback))
  {
    L7_LOGF(L7_LOG_SEVERITY_ALERT, L7_VLAN_MAC_COMPONENT_ID,
           "MAC VLAN failed to register for apply config completions.");
    *pResponse  = 0;
    *pReason    = L7_CNFGR_ERR_RC_FATAL;
    vlanMacRC   = L7_ERROR;
    return vlanMacRC;
...
void  vlanMacCnfgrFiniPhase1Process()
{
    ...
    if (macVlanTreeData != L7_NULLPTR)
    {
        ...
        {
            L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_VLAN_MAC_COMPONENT_ID, "vlanMacCnfgrFiniPhase1Process: could not "
