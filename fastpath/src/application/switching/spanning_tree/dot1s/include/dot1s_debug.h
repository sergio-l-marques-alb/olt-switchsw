...
extern L7_uint32 dot1sNsfDebug;
extern L7_BOOL traceConsoleMode;
...
#define DOT1S_DEBUG_NSF_FLAG_PRINT(flag) {\
    if (dot1sNsfDebug & (flag)) \
    {\
      SYSAPI_PRINTF(SYSAPI_LOGGING_ALWAYS,"%s : L7_TRUE\n",#flag);\
    }\
}
...
#define DOT1S_DEBUG_NSF_NONE                0x0
#define DOT1S_DEBUG_NSF_NIM                 ((L7_uint32)(1 << 0))
#define DOT1S_DEBUG_NSF_CKPT                ((L7_uint32)(1 << 1))
#define DOT1S_DEBUG_NSF_CKPT_DETAIL         ((L7_uint32)(1 << 2))
#define DOT1S_DEBUG_NSF_HELPER              ((L7_uint32)(1 << 3))
#define DOT1S_DEBUG_NSF_TRANSPORT           ((L7_uint32)(1 << 4))
#define DOT1S_DEBUG_NSF_RECONCILE           ((L7_uint32)(1 << 5))
#define DOT1S_DEBUG_NSF_HELPER_DETAIL       ((L7_uint32)(1 << 6))
#define DOT1S_DEBUG_NSF_RECONCILE_EVENTS    ((L7_uint32)(1 << 7))
#define DOT1S_DEBUG_NSF_RECONCILE_STATUS    ((L7_uint32)(1 << 8))


#define DOT1S_DEBUG_NSF(flag,args...) {\
    if (dot1sNsfDebug & (flag)) \
    {\
      if (traceConsoleMode == L7_FALSE) \
      {\
      L7_uchar8           traceStr[128]; \
      osapiSnprintf(traceStr, sizeof(traceStr), args);\
      dot1sNsfTrace(traceStr);\
    }\
      else \ 
      { \
        SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,args);\
...
#define DOT1S_NSF_TRACEID 1
#define DOT1S_TRACE_WIDTH_MAX 128
