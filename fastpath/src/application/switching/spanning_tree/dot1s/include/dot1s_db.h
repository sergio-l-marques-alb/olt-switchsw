...
#define DOT1S_PORTNUM_FROM_PORTID_GET(_a) ((_a) & 0x0FFF)
 ...
 */
 ...
 /* Rate Detection */
#define RATE_DETECT_ROLLOVER    3                        /* sec's */
#define RATE_DETECT_BUCKET_SIZE (RATE_DETECT_ROLLOVER+1)
#define MAX_BPDU_RATE           15                       /* pps per interface sustained over RATE_DETECT_ROLLOVER sec's */
 L7_uchar8 				TickerCount;                     /* x number of ticks per sec */
 L7_uchar8 				currSnapshotTicker;              /* RATE_DETECT_ROLLOVER in bits */
 L7_uint32				currRxCount[RATE_DETECT_BUCKET_SIZE]; /*counter*/
