...
typedef enum
{
  ...
  DIFFSERV_CALLBACK_TABLE_ID_CHANGE_APPROVAL,
...
#define DIFFSERV_CALLBACK_REGISTRANTS_MAX_CHANGE_APPROVAL   FD_CNFGR_DIFFSERV_MAX_CALLBACK_REGISTRATIONS
...
L7_RC_t diffServChangeApprovalQuery(L7_DIFFSERV_CHANGE_APPROVAL_t policyChangeInt,
