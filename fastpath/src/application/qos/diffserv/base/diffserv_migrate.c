...
diffServMigrateConfigV2V3Convert (L7_diffServCfgV2_t * pCfgV2, L7_diffServCfgV3_t * pCfgV3)
{
  ...
  for (i = 0; i < L7_DIFFSERV_CLASS_HDR_MAX_REL_4_3; i++)
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
              "Unrecognized rowInvalidFlags 0x%8.8x in class id %u\n",
                                               ...
                                               L7_diffServClassRuleV3_t * pMibV2)
{
  ...
  default:
    ...
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
            "Unrecognized class rule entry type %d\n", (L7_int32) pMibV1->mib.entryType);
    break;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
            "Unrecognized rowInvalidFlags 0x%8.8x in class rule id (%u,%u)\n",
                                            ...
                                            L7_diffServPolicyAttrV3_t * pMibV3)
{
  ...
  default:
    /* unrecognized entry type */
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
            "Unrecognized policy attribute entry type %u\n",
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
            "Unrecognized rowInvalidFlags 0x%8.8x in policy attr id (%u,%u)\n",
                                           ...
                                           dsmibPoliceActV3_t * pActV3)
{
  ...
  default:
    ...
    *pActV3 = L7_USMDB_MIB_DIFFSERV_POLICE_ACT_NONE_V3;
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
            "Unrecognized police action type %u\n", (L7_uint32)*pActV1);
    break;
  }
}
