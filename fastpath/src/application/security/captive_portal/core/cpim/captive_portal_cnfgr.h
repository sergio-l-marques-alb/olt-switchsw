...
#define CP_IS_READY (((captivePortalCnfgrState == CAPTIVE_PORTAL_PHASE_INIT_3) || \
                      (captivePortalCnfgrState == CAPTIVE_PORTAL_PHASE_EXECUTE) || \
                      (captivePortalCnfgrState == CAPTIVE_PORTAL_PHASE_UNCONFIG_1)) ? L7_TRUE : L7_FALSE)
