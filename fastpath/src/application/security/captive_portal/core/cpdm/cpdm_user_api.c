...
L7_RC_t cpdmUserEntryAdd(uId_t uId)
{
  ...
  do 
  {
    ...
    {
      CP_DLOG(CPD_LEVEL_LOG, "%s: Already reached maximum user capacity.",__FUNCTION__);
      break;
    }
...
L7_RC_t cpdmUserGroupEntryAdd(gpId_t gpId)
{
  ...
  do 
  {
    ...
    {
      CP_DLOG(CPD_LEVEL_LOG, "%s: Already reached maximum group capacity.",
              __FUNCTION__);
      break;
    }
...
{ 
  ...
  while ((L7_FALSE==fFound) && (L7_SUCCESS==cpdmUserGroupEntryNextGet(tmpGpId,&tmpGpId)))
  {
