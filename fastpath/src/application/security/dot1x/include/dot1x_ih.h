...
extern L7_RC_t dot1xIhProcessIntfStartup(NIM_STARTUP_PHASE_t startupPhase);
extern L7_RC_t dot1xIntfActivateStartup();
extern void dot1xIntfStartupCallback(NIM_STARTUP_PHASE_t startupPhase);
