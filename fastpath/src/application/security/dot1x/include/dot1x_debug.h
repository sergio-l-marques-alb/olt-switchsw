...
{                                                           \
  ...
  {                                                        \
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DOT1X_COMPONENT_ID,format,##args); \
  }                                                        \
}

#define DOT1X_ERROR_SEVERE(format,args...)                  \
{                                                           \
    L7_LOGF(L7_LOG_SEVERITY_ERROR, L7_DOT1X_COMPONENT_ID,format,##args); \
}
...
extern void dot1xDebugLogicalPortInfoShow(L7_uint32 intIfNum, L7_uint32 lIntIfNum);
...
#define DOT1X_TRACE_CKPT            0x0800
#define DOT1X_TRACE_CKPT_DETAIL     0x1000
#define DOT1X_TRACE_RECONCILE       0x2000
#define DOT1X_TRACE_MONITORMODE     0x4000
