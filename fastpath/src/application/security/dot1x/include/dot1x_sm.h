...
typedef enum dot1xEvents_s
{
  ...
  /*26*/apmWarmRestart,                                  /*E46*/
  /*27*/apmAssignMonitorModeVlan,                        /*E47*/
  /*28*/apmMonitorModeDisable,                           /*E48*/
  /*29*/dot1xApmEvents,/*keep this last in sub group*/
  
  /***************************************************************/
  /* Events just for Authenticator Key Transmit Machine (KTX)    */
  /***************************************************************/
  /*29*/ktxInitialize,                                  /*E1.ktx*/
  /*30*/ktxPortControlNotEqualAuto,                     /*E20.ktx*/
  /*31*/ktxKeyTxEnabledAndKeyAvailableAndPortAuthorized,/*E21*/
  /*32*/ktxKeyAvailable,                                /*E22*/
  /*33*/ktxNotKeyTxEnabled,                             /*E23*/
  /*34*/ktxPortStatusEqualUnauthorized,                 /*E24.ktx*/
  ...
  /***************************************************************/
  /*35*/rtmInitialize,                                  /*E1.rtm*/
  /*36*/rtmPortControlNotEqualAuto,                     /*E20.rtm*/
  /*37*/rtmPortStatusEqualUnauthorized,                 /*E24.rtm*/
  /*38*/rtmNotReauthEnabled,                            /*E25*/
  /*39*/rtmReauthWhenEqualZero,                         /*E26*/

  /*40*/dot1xRtmEvents,/*keep this last in sub group*/
  
  /***************************************************************/
  /* Events just for Backend Authentication Machine (BAM)        */
  /***************************************************************/
  /*41*/bamInitialize,                                  /*E1.bam*/
  /*42*/bamPortControlNotEqualAuto,                     /*E20.bam*/
  /*43*/bamAuthAbort,                                   /*E27*/
  /*44*/bamAWhileEqualZeroAndReqCountNotEqualMaxReq,    /*E28*/
  /*45*/bamRxResp,                                      /*E29*/
  /*46*/bamAWhileZeroAndReqCountGreaterThanEqualMaxReq, /*E30*/
  /*47*/bamASuccess,                                    /*E31*/
  /*48*/bamAFail,                                       /*E32*/
  /*49*/bamAWhileEqualZero,                             /*E33*/
  /*50*/bamAReq,                                        /*E34*/
  /*51*/bamAuthStart,                                   /*E35*/
  /*52*/bamAssignedVlanDelete,                          /*E37*/
  /*53*/bamGuestVlanTimerExpired,                       /*E40*/
  /*54*/bamAssignUnauthenticatedVlan,                   /*E41*/
  /*55*/bamMABFailAssignGuestVlan,                      /*E45*/
  /*56*/bamWarmRestart,                                 /*E46*/
  /*56*/bamAssignMonitorModeVlan,                       /*E47*/

  /*56*/dot1xBamEvents,/*keep this last in sub group*/

  /***************************************************************/
  /* Events just for Key Receive Machine (KRX)                   */
  /***************************************************************/
  /*57*/krxInitialize,                                  /*E1.krx*/
  /*58*/krxNotPortEnabled,                              /*E3.krx*/
  /*59*/krxRxKey,                                       /*E36*/

  /*60*/dot1xKrxEvents, /*keep this last in sub group*/
