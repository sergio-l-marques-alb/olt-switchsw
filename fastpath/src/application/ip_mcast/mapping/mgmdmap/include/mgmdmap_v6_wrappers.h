...
**********************************************************************
*
* @filename  mgmd_v6_wrappers.h
*
* @purpose   MGMD Mapping  IPV6 registration functions.
*
...
#ifndef _MGMD_V6_WRAPPERS_H_
#define _MGMD_V6_WRAPPERS_H_
...
* @param    name                @b{(input)}  pointer to the name of the registered routine,
...
* @param    void
*
* @returns  protoMax  @{(output)}  maximum Number of Protocols present.
*
* @comments This routine returns the user-configured state of the router.
*
*
...
/*********************************************************************
* @purpose  Checks if Ipv6 mgmd user config data has changed
*
* @param    void
*
* @returns  L7_TRUE
