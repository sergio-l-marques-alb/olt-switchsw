...
L7_RC_t dvmrpMapExtenIntfAdminModeSet(L7_uint32 rtrIfNum, L7_uint32 mode)
{
  ...
  if (dvmrpMapIntfMetricGet (intIfNum, &intfMetric) != L7_SUCCESS)
  {
    DVMRP_MAP_DEBUG (DVMRP_MAP_DEBUG_FAILURES, "Failed to retrieve the Interface Metric "
                 "with the interface\n");
    return L7_FAILURE;
  }
  ...
  if (dvmrpAsyncActivateInterface(rtrIfNum, 
                                  mode, &ipAddr, &netMask,
                                  (L7_uint32)intfMetric) == L7_FAILURE)
  {
                                           ...
                                           L7_uint32 intfMetric)
{
  ...
  adminMode.intfMetric = intfMetric;
...
L7_RC_t dvmrpMapExtenIpMRouteExpiryTimeGet(L7_inet_addr_t *ipMRouteGroup,
                                       ...
                                       L7_uint32 *expire)
{
  return dvmrpIpMRouteExpiryTimeGet (ipMRouteGroup, 
                                ipMRouteSource, ipMRouteSourceMask, expire);
}
