...
typedef enum
{
  DVMRP_MAP_NUM_MFC_EVENTS = 0,
  DVMRP_MAP_NUM_MGMD_EVENTS,
  DVMRP_MAP_NUM_MFC_OVERFLOW_EVENTS,
  DVMRP_MAP_NUM_MGMD_OVERFLOW_EVENTS,
  DVMRP_MAP_COUNTERS_TYPE_MAX
} DVMRP_MAP_COUNTERS_TYPE_t;

typedef enum
{
  DVMRP_MAP_COUNTERS_INCREMENT,
  DVMRP_MAP_COUNTERS_DECREMENT,
  DVMRP_MAP_COUNTERS_RESET,
  DVMRP_MAP_COUNTERS_ACTION_MAX
} DVMRP_MAP_COUNTERS_ACTION_t;
...
#define DVMRPMAP_MSG_COUNT  (L7_IPMAP_INTF_MAX_COUNT + L7_MGMD_GROUPS_MAX_ENTRIES)
...
#define DVMRPMAP_PKT_SIZE   sizeof(dvmrpMapCtrlPktAndMfcMsg_t)

/* Reserving 60% buffer space of the Events Queue for MFC events */
#define DVMRPMAP_MFC_EVENTS_COUNT_LIMIT ((DVMRPMAP_PKT_COUNT * 60)/100)
...
typedef struct dvmrpMapCtrlPktAndMfcEventParms_s 
{
  L7_uint32                  event;
  L7_uchar8                  familyType;
  union
...
} dvmrpMapCtrlPktAndMfcEventParms_t;

typedef struct dvmrpMapCtrlPktAndMfcMsg_s
{
  L7_uint32   msgId;    
  dvmrpMapCtrlPktAndMfcEventParms_t dvmrpMapCtrlPktAndMfcParms;
} dvmrpMapCtrlPktAndMfcMsg_t;
