...
/*********************************************************************
* @purpose  Validate if the address is a Reserved Multicast Site-local
*           Address.
*
* @param    addr @b{(input)} InetAddress
*
* @returns  L7_TRUE  - If addr is a Reserved Site-local address
* @returns  L7_FALSE - If addr is not a Reserved Site-local address
*
* @notes    If any address is missing or a new address gets identified,
*           add it here.
*
* @end
*
...
{
  L7_in6_addr_t tempIpv6Addr;
  L7_in6_addr_t tempIpv6Addr2;
  L7_uchar8 allRoutersAddress[] = "FF05:0:0:0:0:0:0:2";
  L7_uchar8 mDNSv6Address[] = "FF05:0:0:0:0:0:0:FB";
  L7_uchar8 allDhcpServersAddress[] = "FF05:0:0:0:0:0:1:3";
  L7_uchar8 deprecatedAddress[] = "FF05:0:0:0:0:0:1:4";
  L7_uchar8 serviceLocAddressStart[] = "FF05:0:0:0:0:0:1:1000";
  L7_uchar8 serviceLocAddressEnd[] = "FF05:0:0:0:0:0:1:13FF";
  ...
  {
    /* All Routers Address */
    memset (&tempIpv6Addr, 0, sizeof(L7_in6_addr_t));
    osapiInetPton (addr->family, allRoutersAddress, (L7_uchar8 *)&tempIpv6Addr);
    if (L7_IP6_IS_ADDR_EQUAL (&addr->addr.ipv6, &tempIpv6Addr) != 0)
    {
      return L7_TRUE;
    }
    ...
    /* mDNSv6 Address */
    memset (&tempIpv6Addr, 0, sizeof(L7_in6_addr_t));
    osapiInetPton (addr->family, mDNSv6Address, (L7_uchar8 *)&tempIpv6Addr);
    if (L7_IP6_IS_ADDR_EQUAL (&addr->addr.ipv6, &tempIpv6Addr) != 0)
    {
      return L7_TRUE;
    }
    ...
    memset (&tempIpv6Addr, 0, sizeof(L7_in6_addr_t));
    osapiInetPton (addr->family, allDhcpServersAddress, (L7_uchar8 *)&tempIpv6Addr);
    if (L7_IP6_IS_ADDR_EQUAL (&addr->addr.ipv6, &tempIpv6Addr) != 0)
    {
      return L7_TRUE;
    }

    /* Deprecated (2003-03-12) Address */
    memset (&tempIpv6Addr, 0, sizeof(L7_in6_addr_t));
    osapiInetPton (addr->family, deprecatedAddress, (L7_uchar8 *)&tempIpv6Addr);
    if (L7_IP6_IS_ADDR_EQUAL (&addr->addr.ipv6, &tempIpv6Addr) != 0)
    {
      return L7_TRUE;
    }

    /* Service Location, Version 2 Address.
     * FF05:0:0:0:0:0:1:1000 to FF05:0:0:0:0:0:1:13FF.
     */
    memset (&tempIpv6Addr, 0, sizeof(L7_in6_addr_t));
    memset (&tempIpv6Addr2, 0, sizeof(L7_in6_addr_t));
    osapiInetPton (addr->family, serviceLocAddressStart, (L7_uchar8 *)&tempIpv6Addr);
    osapiInetPton (addr->family, serviceLocAddressEnd, (L7_uchar8 *)&tempIpv6Addr2);
    if ((L7_IP6_ADDR_COMPARE (&addr->addr.ipv6, &tempIpv6Addr) >= 0) &&
        (L7_IP6_ADDR_COMPARE (&addr->addr.ipv6, &tempIpv6Addr2) <= 0))
    {
      return L7_TRUE;
    }
  } /* End - else if (addr->family == L7_AF_INET6) */
  else
  {
    return L7_FALSE; /* Invalid Address Family */
  }
