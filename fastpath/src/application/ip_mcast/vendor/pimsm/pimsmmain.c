...
* @end
******************************************************************************/
MCAST_CB_HNDL_t pimsmCtrlBlockInit(L7_uchar8 family, L7_BOOL warmRestart)
{
  L7_uint32    sockfd =0;
  ...
  if ((family == L7_AF_INET6) && !sdmTemplateSupportsIpv6())
  {
    return L7_NULLPTR;
  }
  ...
  pimsmCb->pimsmRestartInProgress = warmRestart;
