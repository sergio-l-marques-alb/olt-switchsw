...
#define FD_SYSNET_HOOK_VOIP_PRECEDENCE             L7_SYSNET_HOOK_PRECEDENCE_4
#define FD_SYSNET_HOOK_VOICE_VLAN_PRECEDENCE       L7_SYSNET_HOOK_PRECEDENCE_5
#define FD_SYSNET_HOOK_DHCP_SNOOPING_PRECEDENCE    L7_SYSNET_HOOK_PRECEDENCE_6
