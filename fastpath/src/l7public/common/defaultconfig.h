...
#define FD_NIM_2G5_ENET_SPEED          L7_PORTCTRL_PORTSPEED_FULL_2P5FX   /* PTin added (2.5G) */
...
#define FD_DOT1Q_DEFAULT_INGRESS_FILTER_PORT        L7_DISABLE
...
#define FD_SYSNET_HOOK_PPPOE_SNOOPING_PRECEDENCE   L7_SYSNET_HOOK_PRECEDENCE_5
