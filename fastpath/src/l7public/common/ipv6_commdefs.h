...
#define	L7_RT6_EQ_PATH_VALID	   1    /* valid route exists for this metric/equal cost path */
} L7_EqualCostPath6_t;
...
/* router preference values per rfrc 4191 */
#define L7_IP6_RADV_RTR_PREF_HIGH                       0x01
#define L7_IP6_RADV_RTR_PREF_MEDIUM                     0x00
#define L7_IP6_RADV_RTR_PREF_LOW                        0x03
...
#define L7_RTR6_ADDR_AUTOCONFIG_ENA                0x08  
#define L7_RTR6_ADDR_DHCP_ENA                      0x10  
...
typedef enum ip6IntfAddrStates{
    ...
    L7_IPV6_INTFADDR_AUTOCONFIG,
    L7_IPV6_INTFADDR_DHCP
...
#define L7_IP6_RADV_RTR_PREF_DEF        L7_IP6_RADV_RTR_PREF_MEDIUM
