...
# define PTIN_SYSTEM_N_LAGS_EXTERNAL   PTIN_SYSTEM_INTERNAL_LAGID_BASE
...
# define PTIN_SYSTEM_IGMP_MAXPACKAGES                  0     /*Max Multicast Packages Per Card*/    
# define PTIN_SYSTEM_IGMP_MAXPACKAGES_CHANNEL_ENTRIES  0     /*Max Packages Channel Entries */   
...
# define IPC_MX_PAIR_IPADDR         ((CPLD_SLOT_ID_GET() == 0) ? IPC_MX_IPADDR_PROTECTION : IPC_MX_IPADDR_WORKING)
# define MX_PAIR_SLOT_ID            ((CPLD_SLOT_ID_GET() == 0) ? PTIN_SYS_MX2_SLOT : PTIN_SYS_MX1_SLOT)
