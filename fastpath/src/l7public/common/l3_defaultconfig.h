...
#define FD_IP_DEFAULT_ROUTING_VLAN_ID 0
#else
#define FD_IP_DEFAULT_ROUTING_VLAN_ID 1
#endif
...
/* The default values for the IRDP min advertisement interval and 
 * holdtime (aka lifetime) are dynamic. Should ask the app for them using
 * rtrDiscMinAdvIntervalDefaultGet() and rtrDiscAdvLifetimeDefaultGet() 
 * (or usmdb equivalents). These are retained because some code 
 * (e.g., ipconfig-object.xml) requires a fixed default. */
#define FD_RTR_DEFAULT_MIN_ADV_INTERVAL      (0.75 * FD_RTR_DEFAULT_MAX_ADV_INTERVAL)
#define FD_RTR_DEFAULT_ADV_LIFETIME          (3 * FD_RTR_DEFAULT_MAX_ADV_INTERVAL)
 ...
 *
 * SMB product specs set L7_L3_ARP_CACHE_STATIC_MAX.
 */
  ...
  #define L7_IP_ARP_CACHE_STATIC_MAX \
            ((platRtrArpMaxEntriesGet() >= 4096) ? 128 : \
              ((platRtrArpMaxEntriesGet() >= 1024) ? 64 : 16))
#endif
...
#define    FD_RTR_RTO_PREF_6TO4            FD_RTR_RTO_PREF_STATIC 
#define    FD_RTR_RTO_PREF_GLOBAL_DEFAULT_GATEWAY 253
#define    FD_RTR_RTO_PREF_DEFAULT_DHCP    254
...
static L7_uint32 FD_rtr_rto_preferences[L7_ROUTE_MAX_PREFERENCES + 1] = {
    ...
    FD_RTR_RTO_PREF_6TO4,
    FD_RTR_RTO_PREF_GLOBAL_DEFAULT_GATEWAY,
    FD_RTR_RTO_PREF_DEFAULT_DHCP,
...
#define FD_OSPF_MAXIMUM_PATHS                         (platRtrRouteMaxEqualCostEntriesGet())
...
#define FD_OSPF_STUB_ROUTER                           OSPF_STUB_RTR_CFG_DISABLED
#define FD_OSPF_STUB_ROUTER_OVERRIDE_SUMMARY_METRIC   L7_DISABLE
#define FD_OSPF_STUB_ROUTER_SUMMARY_METRIC            16711680 
#define FD_OSPF_HELPER_SUPPORT                        OSPF_HELPER_ALWAYS
#define FD_OSPF_STRICT_LSA_CHECKING                   L7_TRUE
#define FD_OSPF_NSF_SUPPORT                           OSPF_NSF_NONE
#define FD_OSPF_RESTART_INTERVAL                      120
...
#define FD_VRRP_DEFAULT_ADMIN_MODE                     L7_FALSE
...
#define FD_VRRP_DEFAULT_ACCEPT_MODE                    L7_FALSE
