...
/* DOT1S BPDU Flooding options */
typedef enum
{
  L7_DOT1S_BPDUFLOOD_ACTION_FILTER = L7_DISABLE,
  L7_DOT1S_BPDUFLOOD_ACTION_FLOOD = L7_ENABLE,
  L7_DOT1S_BPDUFLOOD_ACTION_AUTO,
  L7_DOT1S_BPDUFLOOD_ACTION_TOTAL,
} L7_DOT1S_BPDUFLOOD_ACTIONS_t;
...
#define DOT1S_SIGNAL_QUEUE_SIZE 1
...
#define L7_DOT1S_BRIDGE_HELLOTIME_MAX       2
