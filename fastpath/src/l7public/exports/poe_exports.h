...
#define L7_POE_UNIT_POWER_BANK_MIN 1
#define L7_POE_UNIT_POWER_BANK_MAX 8

#define POE_TYPE_STRING_LEN      20
#define POE_DECI_WATTS_TO_MILLI_WATTS(x)   ((x)*100)
#define POE_MILLI_WATTS_TO_DECI_WATTS(x)   ((x)/100)
...
typedef enum
{
  ...
  L7_POE_FEATURE_SYSTEM_POE_AT_SUPPORT,
...
typedef enum {
  L7_POE_POWER_DEVICE_TYPE2_PSE = 0,
  L7_POE_POWER_DEVICE_TYPE2_PD,
  L7_POE_POWER_DEVICE_TYPE1_PSE,
  L7_POE_POWER_DEVICE_TYPE1_PD,
  L7_POE_POWER_DEVICE_TYPE_COUNT
} L7_POE_POWER_DEVICE_TYPES_t;
