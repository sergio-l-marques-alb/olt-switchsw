...
#define L7_WIRELESS_TSPEC_TID_TOTAL                             8

/* TSPEC TID range checking macro */
#define L7_WIRELESS_TSPEC_TID_IN_RANGE(_tid) \
   (((unsigned int)(_tid) <= L7_WIRELESS_TSPEC_TID_MAX) ? L7_TRUE : L7_FALSE)
