...
typedef enum
{
  ...
  L7_SIM_NETWORK_PORT_FEATURE_ID,   /* Network Port Availability */
...
typedef enum
{
  SIM_CPU_UTIL_MONITOR_RISING_THRESHOLD_PARAM = 0,
  ...
  SIM_CPU_UTIL_MONITOR_LAST_PARAM
} simCpuUtilMonitorParam_t;
