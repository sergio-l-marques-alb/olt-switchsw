...
#define USMDB_LAG_HASH_SET_MAPPING_HASH7      L7_DOT3AD_HASH_ENHANCED
...
#define USMDB_LAG_HASH_GET_MAPPING_HASH7      7

#define USMDB_FD_DOT3AD_HASH_MODE             USMDB_LAG_HASH_SET_MAPPING_HASH3

#define L7_DOT3AD_MAX_NAME (15+1)
