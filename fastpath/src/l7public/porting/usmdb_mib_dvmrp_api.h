...
**********************************************************************
*
* @filename usmdb_mib_dvmrp_api.h
*
...
#ifndef USMDB_MIB_DVMRP_API_H
#define USMDB_MIB_DVMRP_API_H
...
*
* @returns  L7_SUCCESS
* @returns  L7_ERROR    Interface does not exist, or 
...
* @param    UnitIndex      @b{(input)} UnitIndex
* @param    intIfNum       @b{(input)} Internal Interface Number
* @param    addr           @b{(output)} Ip Address Get.
*
* @returns  L7_SUCCESS
* @returns  L7_ERROR, if interface does not exist
* @returns  L7_FAILURE
