...
*
* @comments This function only checks the Time Range name string syntax for a IP/MAC ACL.
*           It does not check if an IP/MAC ACL currently associated with this time range name.
*
* @end
*
*********************************************************************/

L7_RC_t usmDbQosAclTimeRangeNameCheck(L7_uint32 UnitIndex, L7_uchar8 *name);
...
*
*********************************************************************/
extern L7_RC_t usmDbQosAclRuleTimeRangeNameAdd(L7_uint32 UnitIndex,
                                               L7_uint32 aclnum,
                                               L7_uint32 rulenum, 
                                               L7_uchar8 *timeRangeName);
/*********************************************************************
*
...
*
*********************************************************************/
extern L7_RC_t usmDbQosAclRuleTimeRangeNameGet(L7_uint32 UnitIndex, 
                                               L7_uint32 aclIndex,
                                               L7_uint32 rulenum, 
                                               L7_uchar8 *timeRangeName);
/*********************************************************************
...
*
*********************************************************************/
extern L7_RC_t usmDbQosAclMacRuleTimeRangeNameGet(L7_uint32 UnitIndex,
                                                  L7_uint32 aclIndex,
                                                  L7_uint32 rulenum, 
                                                  L7_uchar8 *timeRangeName);
/*********************************************************************
...
*
*********************************************************************/
extern L7_RC_t usmDbQosAclMacRuleTimeRangeNameAdd(L7_uint32 UnitIndex,
                                                  L7_uint32 aclIndex, 
                                                  L7_uint32 rulenum,
                                                  L7_uchar8 *timeRangeName);
/*********************************************************************
...
*
*********************************************************************/
extern L7_RC_t usmDbQosAclRuleStatusGet(L7_uint32 UnitIndex,
                                        L7_uint32 aclIndex,
                                        L7_uint32 rulenum,
                                        L7_uint32 *status);
/*********************************************************************
...
*
*********************************************************************/
extern L7_RC_t usmDbQosAclMacRuleStatusGet(L7_uint32 UnitIndex, 
                                           L7_uint32 aclIndex,
                                           L7_uint32 rulenum, 
                                           L7_uint32 *status);
