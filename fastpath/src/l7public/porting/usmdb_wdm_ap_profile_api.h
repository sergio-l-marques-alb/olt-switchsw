...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileDisConnAPMgmtModeSet (L7_uint32 profileId,
                            L7_uint32 mode);
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileDisConnAPMgmtModeGet (L7_uint32 profileId,
                            L7_uint32 *mode);
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileDisConnAPFwdingModeSet (L7_uint32 profileId,
                            L7_uint32 mode);

#if defined(L7_AE_PROTOCOL_PACKAGE)
/*********************************************************************
*
* @purpose  Get the AE Protocol Mode from the AP Profile
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 *mode @b{(output)} 
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileAEProtocolModeGet (L7_uint32 profileId,
                                            L7_uint32 *mode);
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileAEProtocolModeSet (L7_uint32 profileId,
                                            L7_uint32 mode);
#endif
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileDisConnAPFwdingModeGet (L7_uint32 profileId,
                            L7_uint32 *mode);
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileRadioTspecModeSet(L7_uint32 profileId,
                                           L7_uint32 radioIndex,
                                           L7_uint32 val);
...
*
*********************************************************************/
L7_RC_t usmDbWdmAPProfileRadioTspecModeGet(L7_uint32 profileId,
                                           L7_uint32 radioIndex,
                                           L7_uint32 *val);
...
L7_RC_t
usmDbWdmAPProfileRadioEdcaTemplateGet(L7_uint32 profileId, 
                                      L7_uint32 radioIndex, 
...
L7_RC_t
usmDbWdmAPProfileRadioEdcaTemplateSet(L7_uint32 profileId, 
                                      L7_uint32 radioIndex, 
                                      L7_WDM_EDCA_TEMPLATE_TYPE ttype);
...
*********************************************************************/
L7_RC_t 
usmDbWdmAPProfileRadioAPEDCATemplateQValueGet(L7_WDM_EDCA_TEMPLATE_TYPE ttype,
...
*********************************************************************/
L7_RC_t 
usmDbWdmAPProfileRadioStaEDCATemplateQValueGet(L7_WDM_EDCA_TEMPLATE_TYPE ttype,
					       L7_WDM_QOS_QUEUES_t qtype,
					       L7_WDM_EDCA_QUEUE_ATTR_t qattrt,
					       L7_uint32 * pVal);
...
/*********************************************************************
* @purpose  To test the validity of an MCS index
*
...
*********************************************************************/
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexValidTest(mcs_idx_t idx);


/*********************************************************************
* @purpose  Returns the minimum value for the MCS index
*
* @param    none
*
* returns   mcs_idx_t 
...
*********************************************************************/
mcs_idx_t
usmDbWdmAPProfileRadioMCSMinIndexGet();

/*********************************************************************
* @purpose  Returns the maximum value for the MCS index
*
* @param    none
*
* returns   mcs_idx_t 
...
*********************************************************************/
mcs_idx_t
usmDbWdmAPProfileRadioMCSMaxIndexGet();
...
*********************************************************************/
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexAdd(L7_uint32 profileId, 
                                  L7_uint32 radioIndex, 
                                  mcs_idx_t idx);
...
*********************************************************************/
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexAllAdd(L7_uint32 profileId, 
                                     L7_uint32 radioIndex);


/*********************************************************************
* @purpose  Deletes entry from MCS index table for given radio
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    mcs_idx_t    idx          @b{(input)} MCS index
...
*********************************************************************/
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexDelete(L7_uint32 profileId, 
                                     L7_uint32 radioIndex, 
                                     mcs_idx_t idx);
...
*********************************************************************/
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexAllDelete(L7_uint32 profileId, 
                                        L7_uint32 radioIndex);
...
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexGet(L7_uint32 profileId, 
                                  L7_uint32 radioIndex, 
                                  mcs_idx_t idx);
...
L7_RC_t
usmDbWdmAPProfileRadioMCSIndexGetNext(L7_uint32 profileId, 
				      L7_uint32 radioIndex, 
				      mcs_idx_t idx,
				      mcs_idx_t *pIdx);
