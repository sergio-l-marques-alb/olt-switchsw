...
**********************************************************************
*
* @filename  usmdb_dhcp6s_api.h
*
* @purpose   Interface definitions for API's to DHCPv6 Server/Relay component
*
* @component unitmgr
*
* @comments
...
#ifndef _USMDB_DHCP6S_API_H_
#define _USMDB_DHCP6S_API_H_
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sAdminModeGet(L7_uint32 UnitIndex, L7_uint32 *mode);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sAdminModeSet(L7_uint32 UnitIndex, L7_uint32 mode);
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sServerDuidGet(L7_uint32 UnitIndex, L7_char8 *pDuidStr);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayOptTypeGet(L7_uint32 UnitIndex, L7_uint32 *pType);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayOptTypeSet(L7_uint32 UnitIndex, L7_uint32 type);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayOptRemoteIdTypeGet(L7_uint32 UnitIndex, L7_uint32 *pType);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayOptRemoteIdTypeSet(L7_uint32 UnitIndex, L7_uint32 type);

/*********************************************************************
* @purpose  Get the number of Solicit Received statistics 
*
* @param    UnitIndex   @b{(input)} Unit for this operation
* @param    intIfNum    @b{(input)} interface number (0 for global stats)
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sSolicitReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRequestReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sConfirmReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRenewReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRebindReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sReleaseReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sDeclineReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sInformReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayForwReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayReplyReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sAdvertiseSentGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pSent);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sReplySentGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pSent);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sReconfigureSentGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pSent);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayReplySentGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pSent);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sRelayForwSentGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pSent);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sTotalPacketSentGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
                                                    L7_uint32  *pSent);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sMalformedReceivedGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sDiscardedPacketsGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
		                                    L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sTotalPacketReceivedGet(L7_uint32 UnitIndex, 
                                   L7_uint32 intIfNum, L7_uint32  *pReceived);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sStatisticsClear(L7_uint32 UnitIndex, L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolCreate(L7_uint32 UnitIndex, L7_char8 *pPoolName);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDelete(L7_uint32 UnitIndex, L7_char8 *pPoolName);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolEntryFirst(L7_uint32 UnitIndex, L7_char8 *pPoolName,
			L7_uint32 *pPoolIndex);
/*************************************************************
* @purpose  Check whether DHCPv6 address pool exist or not
*
*
* @returns  L7_TRUE  Dhcp address pool entry found
* @returns  L7_FALSE  Dhcp address pool entry not found
*
* @comments  Check return code to determine result.
*
* @end
*********************************************************************/
L7_BOOL usmDbDhcp6sPoolsExists(L7_uchar8 exist);

/*************************************************************
* @purpose  Check whether DHCPv6 address pool exist or not
*
*
* @returns  L7_TRUE  Dhcp address pool entry not found
* @returns  L7_FALSE  Dhcp address pool entry found
*
* @comments  Check return code to determine result.
*
* @end
*********************************************************************/
L7_BOOL usmDbDhcp6sPoolsNotExists(L7_uchar8 exist);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolEntryNext(L7_uint32 UnitIndex, L7_char8 *pPoolName,
			L7_uint32 *pPoolIndex);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsServerAdd(L7_uint32 UnitIndex, L7_char8 *pPoolName,
			L7_in6_addr_t *pAddr);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsServerRemove(L7_uint32 UnitIndex, L7_char8 *pPoolName,
			L7_in6_addr_t *pAddr);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsServersGet(L7_uint32 UnitIndex, L7_char8 *pPoolName,
			L7_in6_addr_t DnsServers[L7_DHCP6S_DNS_SERVER_MAX]);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsDomainAdd(L7_uint32 UnitIndex, L7_char8 *pPoolName,
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsDomainRemove(L7_uint32 UnitIndex, L7_char8 *pPoolName,
			L7_char8 *pDomainName);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsDomainsGet(L7_uint32 UnitIndex, L7_char8 *pPoolName,
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sPoolHostAdd(L7_uint32 UnitIndex,
       		             L7_char8 *pPoolName, L7_char8 *pHostName,
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sPoolHostRemove(L7_uint32 UnitIndex, L7_char8 *pPoolName,
                             L7_char8 *pDuidStr, L7_uint32 iaid,
                             L7_in6_addr_t *prefixAddr, L7_ushort16 prefixLen);
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sIntfModeServerSet(L7_uint32 UnitIndex, 
			L7_uint32 intIfNum, L7_char8 *pPoolName,
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sIntfModeRelaySet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sIntfModeDelete(L7_uint32 UnitIndex, L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sIntfModeGet(L7_uint32 UnitIndex, L7_uint32 intIfNum,
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolValidate(L7_uint32 UnitIndex, L7_uint32 poolNumber);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolTypeGet(L7_uint32 UnitIndex, L7_char8 *pPoolName, 
				L7_uint32 *pPoolType);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolGetNext(L7_uint32 UnitIndex, L7_uint32 *poolNumber);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sNumberToPoolNameGet(L7_uint32 UnitIndex, 
			L7_uint32 poolNumber, L7_uchar8* pPoolName);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolNameByIndexGet(L7_uint32 UnitIndex, 
			L7_uint32 poolindex, L7_uchar8* pPoolName);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6sPoolNumGet(L7_uint32 UnitIndex, L7_uint32 *pNoOfPool);
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsServerGetNext(L7_uint32 UnitIndex,
                            L7_char8 *pPoolName, L7_in6_addr_t *pAddr);
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sPoolDnsDomainGetNext(L7_uint32 UnitIndex,
                             L7_char8 *pPoolName, L7_char8 *pDomainName);
...
* @end
*********************************************************************/
L7_RC_t usmdbDhcp6sPoolHostGetNext(L7_uint32 UnitIndex, 
                             L7_char8 *pPoolName, L7_char8 *pDuidStr,
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sIntfGetNext(L7_uint32 UnitIndex, L7_uint32 *intfNumber);

/*********************************************************************
 * @purpose  Verify the interface has active DHCPv6 configuration
 *
 * @param    UnitIndex        @b{(input)} Unit for this operation
 * @param    intfNumber       @b{(input)} interface number
 *
 * @returns  L7_SUCCESS
 * @returns  L7_FAILURE
 *
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sIntfValidate(L7_uint32 UnitIndex, L7_uint32 intfNumber);
 ...
 * @end
 *********************************************************************/
L7_RC_t usmDbDhcp6sBindingGetNext(L7_uint32 UnitIndex, L7_char8 *pDuidStr, L7_uint32 *iaid,
                                L7_in6_addr_t *prefixAddr, L7_ushort16 *prefixLen,
...
* @end
*********************************************************************/
L7_BOOL usmDbDhcp6MapIntfIsValid(L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6MapIntfValidFirstGet(L7_uint32 *intIfNum);
...
* @end
*********************************************************************/
L7_RC_t usmDbDhcp6MapIntfValidNextGet(L7_uint32 prevIfNum, L7_uint32 *intIfNum);

#endif /* _USMDB_DHCP6S_API_H_*/
