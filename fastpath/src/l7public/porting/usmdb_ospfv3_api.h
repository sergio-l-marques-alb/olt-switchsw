...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3NsfSupportGet(OSPF_NSF_SUPPORT_t *nsfSupport);
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3NsfSupportSet(OSPF_NSF_SUPPORT_t nsfSupport);
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3RestartIntervalGet(L7_uint32 *restartInterval);
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3RestartIntervalSet(L7_uint32 restartInterval);
#endif
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3HelperSupportGet(OSPF_HELPER_SUPPORT_t *helperSupport);
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3HelperSupportSet(OSPF_HELPER_SUPPORT_t helperSupport);
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3StrictLsaCheckingGet(L7_BOOL *strictLsaChecking);
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3StrictLsaCheckingSet(L7_BOOL strictLsaChecking);
...
* @param    nbrRtrId   Router ID of the neighbour
...
* @end
*********************************************************************/
L7_RC_t usmDbOspfv3HelpfulNbrStatusGet(L7_uint32 intIfNum, L7_uint32 nbrRtrId, 
