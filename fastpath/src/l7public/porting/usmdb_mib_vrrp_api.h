...
* @end
*********************************************************************/
extern L7_RC_t usmDbVrrpConfigPrioritySet(L7_uchar8 vrid,
                                          L7_uint32 intIfNum,
                                          L7_uchar8 priority);
...
/*********************************************************************
* @purpose  To get timer learning mode status
*
* @param    vrId     Router Id.
* @param    intIfNum    Interface Number
...
L7_RC_t usmDbVrrpOperTimerLearnGet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_BOOL* mode);

/*********************************************************************
* @purpose  To set timer learning mode status
*
* @param    vrId   Router Id.
* @param    intIfNum  Interface Number
* @param    timerlearn to set returned value of timer learn mod
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
...
L7_RC_t usmDbVrrpOperTimerLearnSet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_BOOL mode);
...
* @param    vrId     Router Id.
* @param    intIfNum    Interface Number
* @param    delay    returned value of preempt delay
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
...
* @param    vrId   Router Id.
* @param    intIfNum  Interface Number
* @param    delay  to set the preempt delay for the vrid
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
