...
/*********************************************************************
*
* @purpose Get the SNMP addr type to handle ipaddress.
*
* @param L7_uint32 UnitIndex  @b((input))  The unit for this operation
* @param L7_uint32 Index      @b((input))  Index
...
* @returns 4 DNSv6
*
* @notes Valid SNMP TrapMgr Address type Configurations returned:
*        @table{@row{@cell{1 IPv4}}
*        @row{@cell{2 IPv6}
*        @row{@cell{3 DNSv4}
*        @row{@cell{4 DNSv6}
*
...
*
*********************************************************************/
extern L7_RC_t usmDbTrapManagerIpAddrTypeGet(L7_uint32 UnitIndex, L7_uint32 Index, L7_uint32 *ip_address_type);

/*********************************************************************
*
* @purpose Set the SNMP trap ipaddress type.
*
* @param L7_uint32 UnitIndex  @b((input)) The unit for this operation
* @param L7_uint32 Index     @b((input)) The IP address
* @param L7_uint32 ip_address_type     @b((input)) Snmptrap ip address type (IPv4, IPv6, DNSv4, DNSv6)
*
* @returns 1 IPv4
* @returns 2 IPv6
* @returns 3 DNSv4
...
*
*********************************************************************/
extern L7_RC_t usmDbTrapManagerIpAddrTypeSet(L7_uint32 UnitIndex, L7_uint32 Index, L7_uint32 ip_address_type);
