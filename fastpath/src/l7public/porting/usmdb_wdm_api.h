...
*
* @param    L7_uchar8  *value  @b{(output)} pointer to the value
*
* @returns L7_SUCCESS
* @retruns L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSWDSGroupMaxAPsGet(L7_uchar8 *value);
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSWDSGroupMaxWDSLinksGet(L7_uchar8 *value);

/*********************************************************************
*
* @purpose  Start the WDS group config push to all peer switches.
*
* @param    none
*
* @returns  L7_SUCCESS
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSWDSConfigPushStart();

/*********************************************************************
*
* @purpose  Start the WDS group config push to given peer switch.
*
* @param    L7_IP_ADDR_t peerSwitchIP   @b{(input)} Peer switch IP Address
*
* @returns  L7_SUCCESS
...
*
*********************************************************************/
L7_RC_t usmDbWdmPeerSwitchWDSConfigPushStart(L7_IP_ADDR_t ipAddr);

/*********************************************************************
*
* @purpose  Set the Measurement System name.
*
* @param    L7_WDM_MEASUREMENT_SYS_NAME_t sysname  @b{(input)}system name,
*           English or Metric
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSDeviceLocationMeasurementSysSet (L7_WDM_MEASUREMENT_SYS_NAME_t sysname);

/*********************************************************************
*
* @purpose  Get the  Measurement System name .
*
* @param    L7_WDM_MEASUREMENT_SYS_NAME_t *sysname @b{(output)}
* system name, English or Metric
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSDeviceLocationMeasurementSysGet(L7_WDM_MEASUREMENT_SYS_NAME_t *sysname);

/*********************************************************************
*
* @purpose  Set the RF-Scan Device Location mode.
*
* @param    L7_BOOL  mode  @b{(input)}new mode value,  L7_TRUE or L7_FALSE
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSRFScanDeviceLocationModeSet (L7_BOOL mode);

/*********************************************************************
*
* @purpose  Get the RF-Scan Device Location mode.
*
* @param    L7_BOOL * mode  @b{(output)}   L7_TRUE or L7_FALSE
*
* @returns  L7_SUCCESS
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSRFScanDeviceLocationModeGet(L7_BOOL *mode);

/*********************************************************************
*
* @purpose  Set the RF-Scan Device Location Interval
*
* @param    L7_uint32 interval  @b{(input)} Number of seconds between iterations
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSRFScanDeviceLocationIntervalSet (L7_ushort16 interval);

/*********************************************************************
*
* @purpose  Get the RF-Scan Device Location Interval
*
* @param    L7_uint32 *interval   @b{(output)} pointer to interval
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmWSRFScanDeviceLocationIntervalGet (L7_ushort16 *interval);

/*********************************************************************
*
* @purpose  Start the password change to all peer switches and managed APs.
*
* @param    L7_uchar8 groupId  @b{(output)} WDS Group ID
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE, already in progress or there are no peer switches
*
...
*
*********************************************************************/
L7_RC_t usmDbWdmWDSGroupPasswordChangeStart(L7_uchar8 groupId);
