...
*
**********************************************************************/
#ifndef INCLUDE_SSLT_API_H
#define INCLUDE_SSLT_API_H
...
/*********************************************************************
*
* @purpose Set the first additional port number to listen on for SSLT connections.
*
* @param number @b{(input)} value of the new port setting
*
* @returns L7_SUCCESS
...
/*********************************************************************
*
* @purpose Get the first additional port number that the SSLT connection is using.
*
* @param number @b{(input)} location to store the value of the port number
*
* @returns L7_SUCCESS
...
/*********************************************************************
*
* @purpose Set the second additional port number to listen on for SSLT connections.
*
* @param number @b{(input)} value of the new port setting
*
* @returns L7_SUCCESS
...
/*********************************************************************
*
* @purpose Get the second additional port number that the SSLT connection is using.
*
* @param number @b{(input)} location to store the value of the port number
*
* @returns L7_SUCCESS
...
* @returns L7_FAILURE
*
* @comments  If certificate does not exist, keyLength must be specified
...
*                                     <= L7_SSLT_SUBJECT_DN_FIELD_MAX
*            country length must be L7_SSLT_SUBJECT_COUNTRY_SIZE
*            request buffer must be L7_SSLT_CERT_X509_SIZE_MAX
*
* @end
*
*********************************************************************/
