...
#define TRAPMGR_SPECIFIC_ACL_RULE_TIMERANGE_EVENT                    2
...
/*********************************************************************
*
* @purpose  An ACL rule time range event trap signifies the time range event notification 
*           received for a particular rule and the installation status of rule in hardware.
*   
*
* @param    pTrapData   ptr to ACL trap information
*
