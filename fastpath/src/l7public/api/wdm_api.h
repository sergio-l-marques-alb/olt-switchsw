...
/*********************************************************************
*
* @purpose function to Set config push send for WDS Group to managed AP
*
* @param   status    @b{(input)} config push send status
*
* @returns L7_SUCCESS
*          L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmWDSGroupConfigPushSendStatusSet(L7_WDM_WDS_GROUP_CONFIG_STATUS_t status);

/*********************************************************************
*
* @purpose function to Get WDS Group config push send status to managed AP
*
...
*
*********************************************************************/
L7_RC_t wdmWDSGroupConfigPushSendStatusGet(L7_WDM_WDS_GROUP_CONFIG_STATUS_t *status);
...
*
* @param    L7_WDM_MEASUREMENT_SYS_NAME_t sysname  @b{(input)}system name,  English or Metric
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmWSDeviceLocationMeasurementSysSet (L7_WDM_MEASUREMENT_SYS_NAME_t sysname);

/*********************************************************************
*
* @purpose  Get the  Measurement System name .
*
* @param    L7_WDM_MEASUREMENT_SYS_NAME_t *sysname @b{(output)} system name, English or Metric
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t wdmWSDeviceLocationMeasurementSysGet(L7_WDM_MEASUREMENT_SYS_NAME_t *sysname);
...
*
*********************************************************************/
L7_RC_t wdmWSRFScanDeviceLocationModeSet (L7_BOOL mode);
...
*
*********************************************************************/
L7_RC_t wdmWSRFScanDeviceLocationModeGet(L7_BOOL *mode);
...
*
*********************************************************************/
L7_RC_t wdmWSRFScanDeviceLocationIntervalSet (L7_ushort16 interval);
...
*
*********************************************************************/
L7_RC_t wdmWSRFScanDeviceLocationIntervalGet (L7_ushort16 *interval);
...
*
*********************************************************************/
L7_RC_t wdmWSWDSGroupMaxAPsGet(L7_uchar8 *value);
...
*
*********************************************************************/
L7_RC_t wdmWSWDSGroupMaxWDSLinksGet(L7_uchar8 *value);

/*********************************************************************
*
* @purpose  Start the WDS group config push to all the peer switches and
*           managed APs.
*
* @param    none
*
...
*
*********************************************************************/
L7_RC_t wdmWSWDSConfigPushStart();
...
*
* @param    L7_uchar8 groupId  @b{(input)} WDS Group ID
*
* @returns  L7_SUCCESS
* @returns  L7_FAILURE, already in progress or there are no peer switches
*
...
*
*********************************************************************/
L7_RC_t wdmWDSGroupPasswordChangeStart(L7_uchar8 groupId);
