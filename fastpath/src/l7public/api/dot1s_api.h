...
* @end
*********************************************************************/
extern L7_uint32 dot1sVlanToMstiConfiguredGet(L7_uint32 VID);
...
* @end
*********************************************************************/
extern L7_uint32 dot1sDefaultPortPriorityGet(L7_uint32 intIfNum);
...
L7_RC_t dot1sMstiVlanAdd(L7_uint32 mstID, L7_VLAN_MASK_t *vlan_mask);
...
* @end
*********************************************************************/
L7_RC_t dot1sMstiVlanRemove(L7_uint32 mstID, L7_VLAN_MASK_t *vlan_mask);
