...
* @end
*********************************************************************/
L7_RC_t ospfNsfSupportSet(OSPF_NSF_SUPPORT_t nsfSupport);
...
* @end
*********************************************************************/
L7_RC_t ospfNsfSupportGet(OSPF_NSF_SUPPORT_t *nsfSupport);
...
* @end
*********************************************************************/
L7_RC_t ospfRestartIntervalSet(L7_uint32 restartInterval);
...
* @end
*********************************************************************/
L7_RC_t ospfRestartIntervalGet(L7_uint32 *restartInterval);
