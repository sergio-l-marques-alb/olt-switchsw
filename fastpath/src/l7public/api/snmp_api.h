...
/*********************************************************************
* @purpose  Return a SNMP Trap Manager ipaddress type per index
*
* @param    index    table index
* @param    status   pointer to trap manager type entry
*
* @returns  L7_SUCCESS or L7_FAILURE
*
* @notes    none
...
/*********************************************************************
* @purpose  Sets a SNMP Trap Manager ipaddr type per index
*
* @param    index    table index
* @param    status   trap manager type entry
*
* @returns  L7_SUCCESS or L7_FAILURE
*
* @notes    none
