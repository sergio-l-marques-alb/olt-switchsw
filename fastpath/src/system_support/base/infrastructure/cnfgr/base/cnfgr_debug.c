...
void cnfgrDebugProductShow()
{
  ...
  sysapiPrintf("L7_MBUF_RESERVED_RX_HI_PRIO_COSX_BUFFERS: %d\n", L7_MBUF_RESERVED_RX_HI_PRIO_COSX_BUFFERS);
  sysapiPrintf("L7_MBUF_RESERVED_RX_HI_PRIO_COS8_BUFFERS: %d\n", L7_MBUF_RESERVED_RX_HI_PRIO_COS8_BUFFERS);
