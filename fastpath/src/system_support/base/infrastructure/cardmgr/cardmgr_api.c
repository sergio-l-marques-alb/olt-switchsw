  ...
  do
  {
    ...
    if (pCmdData == L7_NULLPTR)
    {
      ...
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
              "cmgrApiCnfgrCommand: Invalid command \n");
      break;   /* goto EXIT: */
    }
    ...
    /* NOTE: cmgrStartTask issued L7_LOGF */
    break; /* goto EXIT */
      }
    ...
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrApiCnfgrCommand: CardMgr is not initialized... Warning \n");
    break;   /* goto EXIT: */
    ...
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrApiCnfgrCommand: Internal fatal error \n");
    break;   /* goto EXIT: */
      }
    ...
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrApiCnfgrCommand: Failed to send message...fatal error \n");
    break; /* goto EXIT */
      }
      ...
      trapMgrNotifyEvents_t event))
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "CMGR registrar_ID %d, %s greater than CMGR_USER_LAST\n", registrar_ID, name);
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "CMGR registrar_ID %d, %s already registered\n", registrar_ID, name);
    return L7_FAILURE;
  }
    ...
    L7_uint32 adminMode)
{
  ...
  SYSAPI_HPC_CARD_DESCRIPTOR_t *cardTypeDb;
  L7_uint32 phySlot, mySlot=0, pluggable = L7_FALSE;
  L7_RC_t rc = L7_SUCCESS;

  if ((unit > CMGR_MAX_UNITS_f) || (slot > cmgrCMDBUnitMaxSlotsGet(unit)))
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotAdminModeSet: unit %d slot %d out of range\n", unit, slot);
    return L7_ERROR;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotAdminModeSet: adminMode %d invalid mode\n", adminMode);
    return L7_ERROR;
  }
  ...
  else
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
              "cmgrSlotAdminModeSet: get unit entry and slot index for unit %d slot %d - failed\n", unit, slot);
      return L7_ERROR;
    }
  ...
  if(pluggable != L7_TRUE)
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
              "cmgrSlotAdminModeSet: pluggable cannot be set when admin mode is disable - not supported\n");
      return L7_NOT_SUPPORTED;
    }
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotAdminModeSet: module info get for phySlot %d - failed\n", phySlot);
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotAdminModeSet: cardType %d - not supported\n", cardType);
    return L7_NOT_SUPPORTED;
  }
    ...
    POWER_STATUS_t *slotPower, POWER_CONTROL_t *pSource)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusGet: unit %d or slot %d - out of range\n", unit, slot);
    return L7_ERROR;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusGet: module info get for phySlot %d - failed\n", phySlot);
    return L7_FAILURE;
  }
    ...
    POWER_STATUS_t powerStatus, POWER_CONTROL_t source)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusSet: current power status get for phySlot %d - failed\n", phySlot);
    return L7_ERROR;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusSet: powerStatus %d is invalid\n", powerStatus);
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusSet: source %d is invalid\n", source);
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusSet: unit %d is invalid\n", unit);
    return L7_ERROR;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
            "cmgrSlotPowerStatusSet: phySlot %d is invalid\n", phySlot);
    return L7_ERROR;
  }
...
L7_RC_t cmgrUnitConnected (L7_uint32 unit)
{
  ...
  /* Populate the CM Db from any information in Cmpdu db */
  cmgrCMDBPopulateFromUnitCmpduDb(unit);
...
L7_RC_t cmgrUnitDisconnected (L7_uint32 unit)
{
  ...
  /* Send a unit disconnect message before sending the card remove */
  /*cmgrAsyncUnitDisconnectNotify(unit);*/
...
L7_RC_t cmgrUnitCmpduCollect(L7_uint32 unit, L7_BOOL collect)
{
  ...
  rc = cmgrUnitCmpduDbConnectedSet(unit, collect);
...
L7_RC_t cmgrIfaceMacGet(L7_INTF_TYPES_t type, L7_uint32 unit, L7_uint32 slot, L7_uint32 port, L7_uchar8 *l2_mac_addr, L7_uchar8 *l3_mac_addr)
{
  ...
  switch (mac_allocation_policy)
  {
    ...
    case SYSAPI_MAC_POLICY_REMOTE_UNIT_POOL:
      ...
      {
    memset((void *)l2_mac_addr,0,sizeof(L7_uchar8)*6);
    memset((void *)l3_mac_addr,0,sizeof(L7_uchar8)*6);
      }
      else
      {
    ...
    else
    {
       ...
       */
      rc = unitMgrIfaceMacGet(type, unit, slot, port, l2_mac_addr, l3_mac_addr);
    }
      }
      break;
    default:
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CARDMGR_COMPONENT_ID,
              "Unknown value returned from sysapiHpcMacAllocationPolicyGet() in cmgrIfaceMacGet().\n");
  }
...
{
  cmgrAsyncTaskLocalUnitIsManager(systemStartupReason, mgrFailover, lastMgrUnitId, lastMgrKey);
}
...
{
  return cmgrAsyncTaskHwApplyNotify(phase);
}
...
{
  L7_uint32 cardId, unit, slot;;

  unit = event.msgData.cardSyncFailure.unit;
  slot = event.msgData.cardSyncFailure.slot;
  if ((cardId = cmgrCMDBInsertedCardIdGet(unit, slot)) == L7_FALSE)
  {
    return;
  }
  ...
  cmgrAsyncCardUnPlugNotify(event.msgData.cardSyncFailure.unit,
                            event.msgData.cardSyncFailure.slot,
                            cardId);
