...
*
* @purpos       The purpose of this file is to define the presenter class
*
...
{
private:
	Collector  *pCollector;  // This is a pointer to the Presenter's 
							 // Collector.

public:
	Presenter(Collector *c) : pCollector(c) {}		// Constructor

	virtual ~Presenter();   						// Destructor
/*
**********************************************************************
*
...
*/
	...
	L7_RC_t statsCreate ( L7_uint32 listSize, 
...
*/
	...
	L7_RC_t statsGet ( L7_uint32 listSize, 
...
*/
	...
	L7_RC_t statsReset ( L7_uint32 listSize, 
					 pCounterValue_list_t pCounterValueList);
...
*/
	...
	L7_RC_t statsIncrement ( L7_uint32  listSize, 
						 pCounterValue_list_t  pCounterValueList);
...
*/
	...
	L7_RC_t statsDecrement ( L7_uint32 listSize, 
						 pCounterValue_list_t pCounterValueList );
...
**********************************************************************
*/
L7_RC_t statsMutlingsAdd ( L7_uint32 listSize, 
						 pStatsParm_list_t pStatsParmList);
...
**********************************************************************
*/
L7_RC_t statsMutlingsDel ( L7_uint32 listSize, 
						 pStatsParm_list_t pStatsParmList);
...
**********************************************************************
*/
L7_RC_t statsDelete ( L7_uint32 listSize, 
					  pStatsParm_list_t pStatsParmList);
