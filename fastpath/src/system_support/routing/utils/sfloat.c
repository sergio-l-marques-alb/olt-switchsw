...
static char __fileid[] = "$Header: lvl7dev\src\system_support\routing\utils\sfloat.c 1.1.3.1 2002/02/13 23:06:47EST ssaraswatula Development  $";
#endif
...
-------------------------------------------------------------------------------*/
INLINE flag8 extractFloat32Sign( float32 a )
{
...
significand.
-------------------------------------------------------------------------------*/
INLINE float32 packFloat32( flag8 zSign, int16 zExp, bits32 zSig )
{
...
-------------------------------------------------------------------------------*/
static float32 roundAndPackFloat32( flag8 zSign, int16 zExp, bits32 zSig )
{
    int8 roundingMode;
    flag8 roundNearestEven;
...
-------------------------------------------------------------------------------*/
static float32
 normalizeRoundAndPackFloat32( flag8 zSign, int16 zExp, bits32 zSig )
{
    int8 shiftCount;
...
-------------------------------------------------------------------------------*/
INLINE flag8 extractFloat64Sign( float64 a )
{
...
-------------------------------------------------------------------------------*/
INLINE float64
 packFloat64( flag8 zSign, int16 zExp, bits32 zSig0, bits32 zSig1 )
{
    float64 z;
...
static float64
 roundAndPackFloat64(
     flag8 zSign, int16 zExp, bits32 zSig0, bits32 zSig1, bits32 zSig2 )
{
    int8 roundingMode;
    flag8 roundNearestEven, increment, isTiny;
...
static float64
 normalizeRoundAndPackFloat64(
     flag8 zSign, int16 zExp, bits32 zSig0, bits32 zSig1 )
{
    int8 shiftCount;
    bits32 zSig2;
...
-------------------------------------------------------------------------------*/
static float32 addFloat32Sigs( float32 a, float32 b, flag8 zSign )
{
...
-------------------------------------------------------------------------------*/
static float32 subFloat32Sigs( float32 a, float32 b, flag8 zSign )
{
    int16 aExp, bExp, zExp;
    bits32 aSig, bSig, zSig;
    int16 expDiff;
    ...
    return packFloat32( (flag8)(float_rounding_mode == float_round_down), 0, 0 );
 bExpBigger:
    if ( bExp == 0xFF ) {
        if ( bSig ) return propagateFloat32NaN( a, b );
        return packFloat32( (flag8)(zSign ^ 1), 0xFF, 0 );
    }
    if ( aExp == 0 ) {
        ++expDiff;
    }
...
-------------------------------------------------------------------------------*/
flag8 float32_eq( float32 a, float32 b )
{
...
-------------------------------------------------------------------------------*/
flag8 float32_le( float32 a, float32 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
flag8 float32_lt( float32 a, float32 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
flag8 float32_eq_signaling( float32 a, float32 b )
{
...
-------------------------------------------------------------------------------*/
flag8 float32_le_quiet( float32 a, float32 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
flag8 float32_lt_quiet( float32 a, float32 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
static float64 addFloat64Sigs( float64 a, float64 b, flag8 zSign )
{
    int16 aExp, bExp, zExp;
...
-------------------------------------------------------------------------------*/
static float64 subFloat64Sigs( float64 a, float64 b, flag8 zSign )
{
    int16 aExp, bExp, zExp;
    ...
    return packFloat64( (flag8)(float_rounding_mode == float_round_down), 0, 0, 0 );
 bExpBigger:
    if ( bExp == 0x7FF ) {
        if ( bSig0 | bSig1 ) return propagateFloat64NaN( a, b );
        return packFloat64( (flag8)(zSign ^ 1), 0x7FF, 0, 0 );
    }
    if ( aExp == 0 ) {
        ++expDiff;
    }
...
float64 float64_rem( float64 a, float64 b )
{
 ...
 invalid:
    ...
    return
        normalizeRoundAndPackFloat64( (flag8)(aSign ^ zSign), bExp - 4, aSig0, aSig1 );
...
-------------------------------------------------------------------------------*/
flag8 float64_eq( float64 a, float64 b )
{
...
-------------------------------------------------------------------------------*/
flag8 float64_le( float64 a, float64 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
flag8 float64_lt( float64 a, float64 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
flag8 float64_eq_signaling( float64 a, float64 b )
{
...
-------------------------------------------------------------------------------*/
flag8 float64_le_quiet( float64 a, float64 b )
{
    flag8 aSign, bSign;
...
-------------------------------------------------------------------------------*/
flag8 float64_lt_quiet( float64 a, float64 b )
{
    flag8 aSign, bSign;
