...
extern void cliGetUtcTimeInMonthsAndDays(L7_uint32 utcTime, L7_char8 *buf);
...
xLibRC_t fpObjGet_securitydot1x_dot1xAuthLastEapolFrameSource (void *wap, void *bufp)
{
  ...
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibStr256_t));
  xLibStr6_t objdot1xAuthLastEapolFrameSourceValue;
  ...
  /* get the value from application */
  owa.l7rc = usmDbDot1xPortLastEapolFrameSourceGet (L7_UNIT_CURRENT, keydot1xPaePortNumberValue, emacAddr);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  memcpy(objdot1xAuthLastEapolFrameSourceValue, emacAddr, sizeof(objdot1xAuthLastEapolFrameSourceValue));
  ...
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objdot1xAuthLastEapolFrameSourceValue,
                           sizeof (objdot1xAuthLastEapolFrameSourceValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xDynamicVlanCreationMode
*
* @purpose Get 'Dot1xDynamicVlanCreationMode'
 *@description  [Dot1xDynamicVlanCreationMode] Enable/Disable dot1x dynamic vlan
* creation Support on the switch.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xDynamicVlanCreationMode (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objDot1xDynamicVlanCreationModeValue;

  FPOBJ_TRACE_ENTER(bufp);

    /* get the value from application */
    owa.l7rc = usmDbDot1xDynamicVlanCreationModeGet(L7_UNIT_CURRENT,  &objDot1xDynamicVlanCreationModeValue);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objDot1xDynamicVlanCreationModeValue, sizeof(objDot1xDynamicVlanCreationModeValue));

  /* return the object value: Dot1xDynamicVlanCreationMode */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objDot1xDynamicVlanCreationModeValue,
                      sizeof(objDot1xDynamicVlanCreationModeValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;
...
/*******************************************************************************
* @function fpObjSet_securitydot1x_Dot1xDynamicVlanCreationMode
*
* @purpose Set 'Dot1xDynamicVlanCreationMode'
 *@description  [Dot1xDynamicVlanCreationMode] Enable/Disable dot1x dynamic vlan
* creation Support on the switch.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securitydot1x_Dot1xDynamicVlanCreationMode (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objDot1xDynamicVlanCreationModeValue;
  ...
  /* retrieve object: Dot1xDynamicVlanCreationMode */
  owa.len = sizeof(objDot1xDynamicVlanCreationModeValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)&objDot1xDynamicVlanCreationModeValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objDot1xDynamicVlanCreationModeValue, owa.len);

  /* if row status object is specified and eual to delete return success */

  /* set the value in application */
  owa.l7rc = usmDbDot1xDynamicVlanCreationModeSet(L7_UNIT_CURRENT, objDot1xDynamicVlanCreationModeValue);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
  }
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xMonitorMode
*
* @purpose Get 'Dot1xMonitorMode'
 *@description  [Dot1xRadiusMonitorMode] Enable/Disable dot1x Monitor Mode 
* Support on the switch.   
* @notes       
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xMonitorMode (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xMonitorModeValue;

  FPOBJ_TRACE_ENTER (bufp);

  /* get the value from application */
  owa.l7rc = usmDbDot1xMonitorModeGet (L7_UNIT_CURRENT, &objDot1xMonitorModeValue);
  if (owa.l7rc != L7_SUCCESS)
  {
  ...
  FPOBJ_TRACE_VALUE (bufp, &objDot1xMonitorModeValue,
                     sizeof (objDot1xMonitorModeValue));

  /* return the object value: Dot1xMonitorMode */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xMonitorModeValue,
                           sizeof (objDot1xMonitorModeValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
...
/*******************************************************************************
* @function fpObjSet_securitydot1x_Dot1xMonitorMode
*
* @purpose Set 'Dot1xMonitorMode'
 *@description  [Dot1xMonitorMode] Enable/Disable dot1x Monitor Mode
* Support on the switch.   
* @notes       
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securitydot1x_Dot1xMonitorMode (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xMonitorModeValue;
  ...
  /* retrieve object: Dot1xMonitorMode */
  owa.rc = xLibBufDataGet (bufp, (xLibU8_t *) & objDot1xMonitorModeValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
  }
  FPOBJ_TRACE_VALUE (bufp, &objDot1xMonitorModeValue, owa.len);

  /* if row status object is specified and eual to delete return success */

  /* set the value in application */
  owa.l7rc = usmDbDot1xMonitorModeSet (L7_UNIT_CURRENT, objDot1xMonitorModeValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  }
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogIfaceIndex
*
* @purpose Get 'Dot1xAuthHistoryLogIfaceIndex'
*
* @description The Port number associated with this Port. 
*              
* @note  This is KEY Object
...
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogIfaceIndex (void *wap, void *bufp)
{

  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogIfaceIndexValue;
  xLibU32_t nextObjDot1xAuthHistoryLogIfaceIndexValue;
  FPOBJ_TRACE_ENTER (bufp);

  /* retrieve key: Dot1xAuthHistoryLogIfaceIndex */
  owa.rc = xLibFilterGet (wap, XOBJ_securitydot1x_Dot1xAuthHistoryLogIfaceIndex,
                          (xLibU8_t *) & objDot1xAuthHistoryLogIfaceIndexValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_CURRENT_KEY (bufp, NULL, 0);
    objDot1xAuthHistoryLogIfaceIndexValue = 0;
    nextObjDot1xAuthHistoryLogIfaceIndexValue = 0;
  }
  else
  { 
    FPOBJ_TRACE_CURRENT_KEY (bufp, &objDot1xAuthHistoryLogIfaceIndexValue, owa.len);
    nextObjDot1xAuthHistoryLogIfaceIndexValue = objDot1xAuthHistoryLogIfaceIndexValue;
  }

  owa.l7rc = usmDbDot1xAuthHistoryLogIfIndexNextGet(L7_UNIT_CURRENT,
                                                    &nextObjDot1xAuthHistoryLogIfaceIndexValue);
    
  if((owa.l7rc != L7_SUCCESS) || (nextObjDot1xAuthHistoryLogIfaceIndexValue == objDot1xAuthHistoryLogIfaceIndexValue))
  {
    owa.rc = XLIBRC_ENDOF_TABLE;
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
  }
  FPOBJ_TRACE_NEW_KEY (bufp, &nextObjDot1xAuthHistoryLogIfaceIndexValue, owa.len);

  /* return the object value: Dot1xAuthHistoryLogIfaceIndex */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & nextObjDot1xAuthHistoryLogIfaceIndexValue,
                           sizeof (objDot1xAuthHistoryLogIfaceIndexValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogEntryIndex
*
* @purpose Get 'Dot1xAuthHistoryLogEntryIndex'
*
* @description The Entry Index associated with this Port. 
*              
* @note  This is KEY Object
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogEntryIndex (void *wap, void *bufp)
{

  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogEntryIndexValue;
  xLibU32_t nextObjDot1xAuthHistoryLogEntryIndexValue;
  xLibU32_t objDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t nextObjDot1xAuthHistoryLogIfaceIndex;
  FPOBJ_TRACE_ENTER (bufp);

  /* retrieve key: Dot1xAuthHistoryLogIfaceIndex */
  owa.rc = xLibFilterGet (wap, XOBJ_securitydot1x_Dot1xAuthHistoryLogIfaceIndex,
                          (xLibU8_t *) & objDot1xAuthHistoryLogIfaceIndex, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  nextObjDot1xAuthHistoryLogIfaceIndex = objDot1xAuthHistoryLogIfaceIndex;

  /* retrieve key: Dot1xAuthHistoryLogEntryIndex */
  owa.rc = xLibFilterGet (wap, XOBJ_securitydot1x_Dot1xAuthHistoryLogEntryIndex,
                          (xLibU8_t *) & objDot1xAuthHistoryLogEntryIndexValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_CURRENT_KEY (bufp, NULL, 0);
    nextObjDot1xAuthHistoryLogEntryIndexValue = 0;
  }
  else
  { 
    FPOBJ_TRACE_CURRENT_KEY (bufp, &objDot1xAuthHistoryLogEntryIndexValue, owa.len);
    nextObjDot1xAuthHistoryLogEntryIndexValue = objDot1xAuthHistoryLogEntryIndexValue;
  }
    
  owa.l7rc = usmDbDot1xAuthHistoryLogReverseIndexNextGet(L7_UNIT_CURRENT,
                                                       &nextObjDot1xAuthHistoryLogIfaceIndex,
                                                       &nextObjDot1xAuthHistoryLogEntryIndexValue);

  if ((owa.l7rc != L7_SUCCESS) || (nextObjDot1xAuthHistoryLogIfaceIndex != objDot1xAuthHistoryLogIfaceIndex))
  {
    owa.rc = XLIBRC_ENDOF_TABLE;
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
  }
  FPOBJ_TRACE_NEW_KEY (bufp, &nextObjDot1xAuthHistoryLogEntryIndexValue, owa.len);

  /* return the object value: Dot1xAuthHistoryLogEntryIndex */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & nextObjDot1xAuthHistoryLogEntryIndexValue,
                           sizeof (objDot1xAuthHistoryLogEntryIndexValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogTimeStamp
*
* @purpose Get 'Dot1xAuthHistoryLogTimeStamp'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogTimeStamp (void *wap, void *bufp)
{
  fpObjWa_t    kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t    keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t    keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t    owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t    timeStamp=0;
  xLibStr256_t objDot1xAuthHistoryLogTimeStamp;
  FPOBJ_TRACE_ENTER (bufp);

  /* retrieve key: Dot1xAuthHistoryLogIfaceIndex */
  kwa.rc = xLibFilterGet (wap, XOBJ_securitydot1x_Dot1xAuthHistoryLogIfaceIndex,
                          (xLibU8_t *) & keyDot1xAuthHistoryLogIfaceIndex, &kwa.len);
  if (kwa.rc != XLIBRC_SUCCESS)
  {
    kwa.rc = XLIBRC_FAILURE;
    FPOBJ_TRACE_EXIT (bufp, kwa);
    return kwa.rc;
  }
  FPOBJ_TRACE_CURRENT_KEY (bufp, &keyDot1xAuthHistoryLogIfaceIndex, kwa.len);

  /* retrieve key: Dot1xAuthHistoryLogEntryIndex */
  kwa.rc = xLibFilterGet (wap, XOBJ_securitydot1x_Dot1xAuthHistoryLogEntryIndex,
                          (xLibU8_t *) & keyDot1xAuthHistoryLogEntryIndex, &kwa.len);
  if (kwa.rc != XLIBRC_SUCCESS)
  {
    kwa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, kwa);
  ...
  FPOBJ_TRACE_CURRENT_KEY (bufp, &keyDot1xAuthHistoryLogEntryIndex, kwa.len);

  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogTimeStampGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &timeStamp);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  memset(objDot1xAuthHistoryLogTimeStamp, 0x00, sizeof(objDot1xAuthHistoryLogTimeStamp));

  cliGetUtcTimeInMonthsAndDays(timeStamp, objDot1xAuthHistoryLogTimeStamp);

  /* return the object value: Dot1xAuthHistoryLogTimeStamp */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objDot1xAuthHistoryLogTimeStamp,
                           osapiStrnlen(objDot1xAuthHistoryLogTimeStamp, sizeof (objDot1xAuthHistoryLogTimeStamp)));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogEntryAge
*
* @purpose Get 'Dot1xAuthHistoryLogEntryAge'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogEntryAge (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogEntryAge=0;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogEntryAgeGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &objDot1xAuthHistoryLogEntryAge);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  /* return the object value: Dot1xAuthHistoryLogEntryAge */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xAuthHistoryLogEntryAge,
                           sizeof (objDot1xAuthHistoryLogEntryAge));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogReasonCode
*
* @purpose Get 'Dot1xAuthHistoryLogReasonCode'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogReasonCode (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibStr256_t objDot1xAuthHistoryLogReasonCode;
  xLibU32_t    reasonCode, strLen;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogReasonCodeGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &reasonCode);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  memset(objDot1xAuthHistoryLogReasonCode, 0x00, sizeof(objDot1xAuthHistoryLogReasonCode));
  strLen = sizeof(objDot1xAuthHistoryLogReasonCode);

  (void)usmDbDot1xAuthHistoryLogReasonStringGet(keyDot1xAuthHistoryLogIfaceIndex, 
                                                keyDot1xAuthHistoryLogEntryIndex,
                                                reasonCode,
                                                objDot1xAuthHistoryLogReasonCode,
                                                &strLen);

  /* return the object value: Dot1xAuthHistoryLogReasonCode */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objDot1xAuthHistoryLogReasonCode, strLen);
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogAuthStatus
*
* @purpose Get 'Dot1xAuthHistoryLogAuthStatus'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogAuthStatus (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogAuthStatus;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogAuthStatusGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &objDot1xAuthHistoryLogAuthStatus);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  /* return the object value: Dot1xAuthHistoryLogAuthStatus */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xAuthHistoryLogAuthStatus,
                           sizeof (objDot1xAuthHistoryLogAuthStatus));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogAccessStatus
*
* @purpose Get 'Dot1xAuthHistoryLogAccessStatus'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogAccessStatus (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogAccessStatus;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogAccessStatusGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &objDot1xAuthHistoryLogAccessStatus);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  /* return the object value: Dot1xAuthHistoryLogAccessStatus */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xAuthHistoryLogAccessStatus,
                           sizeof (objDot1xAuthHistoryLogAccessStatus));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogVlanId
*
* @purpose Get 'Dot1xAuthHistoryLogVlanId'
*
* @description Dot1x Authentication History Log VLAN ID 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogVlanId (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogVlanId;
  xLibU16_t  vlanId;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogVlanIdGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &vlanId);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  objDot1xAuthHistoryLogVlanId = vlanId;

  /* return the object value: Dot1xAuthHistoryLogVlanId */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xAuthHistoryLogVlanId,
                           sizeof (objDot1xAuthHistoryLogVlanId));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogMacAddress
*
* @purpose Get 'Dot1xAuthHistoryLogMacAddress'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogMacAddress (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibMac_t objDot1xAuthHistoryLogMacAddress;
  L7_enetMacAddr_t macAddr;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogSupplicantMacAddressGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &macAddr);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  memcpy(objDot1xAuthHistoryLogMacAddress, macAddr.addr, sizeof(xLibMac_t));

  /* return the object value: Dot1xAuthHistoryLogMacAddress */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objDot1xAuthHistoryLogMacAddress,
                           sizeof (objDot1xAuthHistoryLogMacAddress));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogFilterId
*
* @purpose Get 'Dot1xAuthHistoryLogFilterId'
*
* @description Dot1x Authentication History Log time stamp 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogFilterId (void *wap, void *bufp)
{
  fpObjWa_t    kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t    keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t    keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t    owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibStr256_t objDot1xAuthHistoryLogFilterId;
  xLibU32_t    filterLen;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  filterLen = sizeof(xLibStr256_t);

  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogFilterIdGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, objDot1xAuthHistoryLogFilterId, &filterLen);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  /* return the object value: Dot1xAuthHistoryLogFilterId */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objDot1xAuthHistoryLogFilterId, filterLen);
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogVlanAssigned
*
* @purpose Get 'Dot1xAuthHistoryLogVlanAssigned'
*
* @description Dot1x Authentication History Log VLAN ID 
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogVlanAssigned (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogVlanAssigned;
  xLibU16_t  vlanId;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogVlanIdAssignedGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &vlanId);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  ...
  objDot1xAuthHistoryLogVlanAssigned = vlanId;

  /* return the object value: Dot1xAuthHistoryLogVlanAssigned */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xAuthHistoryLogVlanAssigned,
                           sizeof (objDot1xAuthHistoryLogVlanAssigned));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjGet_securitydot1x_Dot1xAuthHistoryLogVlanAssignedType
*
* @purpose Get 'Dot1xAuthHistoryLogVlanAssignedType'
*
* @description Dot1x Authentication History Log VLAN ID Assigned Type
*              
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securitydot1x_Dot1xAuthHistoryLogVlanAssignedType (void *wap, void *bufp)
{
  fpObjWa_t kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyDot1xAuthHistoryLogIfaceIndex;
  xLibU32_t keyDot1xAuthHistoryLogEntryIndex;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryLogVlanAssignedType;
  xLibU8_t  assignedType;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogVlanAssignedTypeGet(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex,
                                  keyDot1xAuthHistoryLogEntryIndex, &assignedType);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  objDot1xAuthHistoryLogVlanAssignedType = assignedType;

  /* return the object value: Dot1xAuthHistoryLogVlanAssignedType */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objDot1xAuthHistoryLogVlanAssignedType,
                           sizeof (objDot1xAuthHistoryLogVlanAssignedType));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
...
/*******************************************************************************
* @function fpObjSet_securitydot1x_Dot1xAuthHistoryLogIfacePurge
*
* @purpose Set 'Dot1xAuthHistoryLogIfaceIndex'
*
* @description Clear Dot1x Authentication History Log entries by interface
*              
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securitydot1x_Dot1xAuthHistoryLogIfacePurge (void *wap, void *bufp)
{
  fpObjWa_t    kwa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t    keyDot1xAuthHistoryLogIfaceIndex;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  kwa.l7rc =
    usmDbDot1xAuthHistoryLogInterfacePurge(L7_UNIT_CURRENT, keyDot1xAuthHistoryLogIfaceIndex);
  if (kwa.l7rc != L7_SUCCESS)
  {
    kwa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, kwa);
...
/*******************************************************************************
* @function fpObjSet_securitydot1x_Dot1xAuthHistoryLogPurgeAll
*
* @purpose Set 'Dot1xAuthHistoryLogIfaceIndex'
*
* @description Clear All Dot1x Authentication History Log entries by interface
*              
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securitydot1x_Dot1xAuthHistoryLogPurgeAll (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objDot1xAuthHistoryIfaceIndex;
  FPOBJ_TRACE_ENTER (bufp);

  /* retrieve object: Dot1xAuthHistoryLogIfaceIndex */
  owa.rc = xLibBufDataGet (bufp,
                           (xLibU8_t *) & objDot1xAuthHistoryIfaceIndex,
                           &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objDot1xAuthHistoryIfaceIndex, owa.len);

  /* get the value from application */
  owa.l7rc =
    usmDbDot1xAuthHistoryLogPurgeAll(L7_UNIT_CURRENT);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
