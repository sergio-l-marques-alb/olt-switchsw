...
/* macro for invalid cable type return in xweb */
#define  L7_CABLE_INVALIDCABLETYPE 99
typedef enum
{
...
typedef enum
{
L7_DIFFSERV_POLICE_CONFORM_ACT_NONE = 0,
L7_DIFFSERV_POLICE_CONFORM_ACT_SEND = 7,
L7_DIFFSERV_POLICE_CONFORM_ACT_DROP = 1,
L7_DIFFSERV_POLICE_CONFORM_ACT_MARKCOS = 2,
L7_DIFFSERV_POLICE_CONFORM_ACT_MARKCOS2 = 3,
L7_DIFFSERV_POLICT_CONFORM_ACT_MARKCOSASCOS2 = 4,
L7_DIFFSERV_POLICE_CONFORM_ACT_MARKDSCP = 5,
L7_DIFFSERV_POLICE_CONFORM_ACT_MARKPREC = 6
}diffServPoliceConformAct_t;
...
typedef enum
{
  L7_POE_XUI_POWER_SOURCE_UNKNOWN=0,
  L7_POE_XUI_POWER_SOURCE_PSE_PRIMARY,
  L7_POE_XUI_POWER_SOURCE_PSE_BACKUP,
  L7_POE_XUI_POWER_SOURCE_PD_PSE,
  L7_POE_XUI_POWER_SOURCE_PD_BOTH,
  L7_POE_XUI_POWER_SOURCE_RSVD
}L7_POE_XUI_POWER_SOURCE_TYPES_t;

typedef enum
{
  L7_POE_XUI_POWER_DEVICE_TYPE2_PSE=0,
  L7_POE_XUI_POWER_DEVICE_TYPE2_PD,
  L7_POE_XUI_POWER_DEVICE_TYPE1_PSE,
  L7_POE_XUI_POWER_DEVICE_TYPE1_PD,
  L7_POE_XUI_POWER_DEVICE_INVALID
}L7_POE_XUI_POWER_DEVICE_TYPES_t;

typedef enum
{
  L7_TIME_RANGE_PERIODIC_DAILY=0,
  L7_TIME_RANGE_PERIODIC_WEEKDAYS,
  L7_TIME_RANGE_PERIODIC_WEEKEND,
  L7_TIME_RANGE_PERIODIC_DAY
}L7_TIME_RANGE_PERIODIC_DAYS_t;

typedef enum
{
  L7_LOGGING_EMAIL_ALERT_URGENT=1,
  L7_LOGGING_EMAIL_ALERT_NON_URGENT,
  L7_LOGGING_EMAIL_ALERT_BOTH
} L7_LOGGING_EMAIL_ALERT_MSGTYPE_t;
