...
xLibRC_t fpObjGet_basesysImage_sysImage1Version (void *wap, void *bufp)
{
  ...
  owa.l7rc = usmDbImageFileNameGet(0, objsysImage1Name);
#else
  owa.l7rc = usmDbActiveImageNameGet(keysysUnitIndexValue, objsysImage1Name);
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
  ...
  OSAPI_STRNCPY_SAFE(objsysImage1VersionValue, pStrInfo_common_None_4);
  (void)usmDbImageVersionGet ( keysysUnitIndexValue,
                                objsysImage1Name, objsysImage1VersionValue);
...
xLibRC_t fpObjGet_basesysImage_sysImage2Version (void *wap, void *bufp)
{
  ...
  /* get the name from application */
#if L7_FEAT_DIM_USE_FILENAME
  owa.l7rc = usmDbImageFileNameGet(1, objsysImage2Name);
#else
  owa.l7rc = usmDbBackupImageNameGet(keysysUnitIndexValue, objsysImage2Name);
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  ...
  /* get the value from application */
  OSAPI_STRNCPY_SAFE(objsysImage2VersionValue, pStrInfo_common_None_4);
  (void) usmDbImageVersionGet (keysysUnitIndexValue, 
                                objsysImage2Name, objsysImage2VersionValue);
...
xLibRC_t fpObjGet_basesysImage_sysImage1Descr (void *wap, void *bufp)
{
  ...
  memset(objsysImage1DescrValue,0, sizeof(objsysImage1DescrValue));
  /* get the name from application */
#if L7_FEAT_DIM_USE_FILENAME
  owa.l7rc = usmDbImageFileNameGet(0, objsysImage1Name);
#else
  owa.l7rc = usmDbActiveNameGet(objsysImage1Name);
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  ...
  /* get the value from application */
  owa.l7rc = usmDbImageDescrGet ( objsysImage1Name,
...
xLibRC_t fpObjSet_basesysImage_sysImage1Descr (void *wap, void *bufp)
{
  ...
  owa.l7rc = usmDbImageDescrSet ( objsysImage1Name, objsysImage1DescrValue);
  ...
  {
    owa.rc = XLIBRC_IMAGE_NOT_PRESENT;
  }
...
xLibRC_t fpObjGet_basesysImage_sysImage2Descr (void *wap, void *bufp)
{
  ...
  memset(objsysImage2DescrValue,0, sizeof(objsysImage2DescrValue));
  /* get the name from application */
#if L7_FEAT_DIM_USE_FILENAME
  owa.l7rc = usmDbImageFileNameGet(1, objsysImage2Name);
#else
  owa.l7rc = usmDbBackupNameGet(objsysImage2Name);
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  ...
  /* get the value from application */
  owa.l7rc = usmDbImageDescrGet ( objsysImage2Name,
...
xLibRC_t fpObjSet_basesysImage_sysImage2Descr (void *wap, void *bufp)
{
  ...
  /* set the value in application */
  owa.l7rc = usmDbImageDescrSet (objsysImage2Name, objsysImage2DescrValue);
  if (owa.l7rc == L7_IMAGE_IN_USE)
  {
    owa.rc = XLIBRC_IMAGE_IN_USE;
  }
...
xLibRC_t fpObjGet_basesysImage_sysActiveImageName (void *wap, void *bufp)
{
...
#if L7_FEAT_DIM_USE_FILENAME
#else
  xLibStr256_t objsysActiveFileName;
#endif
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
#if L7_FEAT_DIM_USE_FILENAME
  owa.l7rc = usmDbActiveImageNameGet(keysysUnitIndexValue, objsysActiveImageNameValue);
#else
  OSAPI_STRNCPY_SAFE(objsysActiveImageNameValue, pStrInfo_common_None_4);
  memset(objsysActiveFileName, 0x0, sizeof(objsysActiveFileName));
  if ((usmDbActiveImageNameGet(keysysUnitIndexValue, objsysActiveFileName) == L7_SUCCESS) &&
      (osapiStrnlen(objsysActiveFileName, sizeof(objsysActiveFileName)) != 0))
  {
    owa.l7rc = usmDbImageVersionGet(keysysUnitIndexValue, objsysActiveFileName, objsysActiveImageNameValue);
  }
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
 ...
 *******************************************************************************/
 xLibRC_t fpObjGet_basesysImage_sysActivatedImageName (void *wap, void *bufp)
 {
...
#if L7_FEAT_DIM_USE_FILENAME
#else
   xLibStr256_t objsysActivatedFileName;
#endif
   FPOBJ_TRACE_ENTER (bufp);
   ...
   /* get the value from application */
#if L7_FEAT_DIM_USE_FILENAME
   owa.l7rc = usmDbActivatedImageNameGet(keysysUnitIndexValue, objsysActivatedImageNameValue);
#else
   OSAPI_STRNCPY_SAFE(objsysActivatedImageNameValue, pStrInfo_common_None_4);
   memset(objsysActivatedFileName, 0x0, sizeof(objsysActivatedFileName));
   if ((usmDbActivatedImageNameGet(keysysUnitIndexValue, objsysActivatedFileName) == L7_SUCCESS) &&
       (osapiStrnlen(objsysActivatedFileName, sizeof(objsysActivatedFileName)) != 0))
   {
     owa.l7rc = usmDbImageVersionGet(keysysUnitIndexValue, objsysActivatedFileName, objsysActivatedImageNameValue);
   }
#endif
   if (owa.l7rc != L7_SUCCESS)
   {
...
xLibRC_t fpObjSet_basesysImage_sysActivateImage1 (void *wap, void *bufp)
{
  ...
  /* get the name from application */
#if L7_FEAT_DIM_USE_FILENAME
  owa.l7rc = usmDbImageFileNameGet(0, objsysImageName);
#else
  owa.l7rc = usmDbActiveImageNameGet(keysysUnitIndexValue, objsysImageName);
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
  ...
  /* set the value in application */
  owa.l7rc = usmDbImageActivate (keysysUnitIndexValue, objsysImageName, L7_FALSE);
  if (owa.l7rc == L7_IMAGE_IN_USE)
  {
    owa.rc = XLIBRC_IMAGE_IN_USE;
  }
...
xLibRC_t fpObjSet_basesysImage_sysDeleteImage1 (void *wap, void *bufp)
{
  ...
  /* set the value in application */
  owa.l7rc = usmDbFileDelete(keysysUnitIndexValue, objsysImageName);
  if (owa.l7rc == L7_IMAGE_IN_USE)
  {
    owa.rc = XLIBRC_IMAGE_IN_USE;
  }
  ...
  {
     owa.rc = XLIBRC_ACTIVE_IMAGE_DELETION_DENIED;
  }
  else if (owa.l7rc != L7_SUCCESS)
  {
     owa.rc = XLIBRC_IMAGE_NOT_FOUND;
...
xLibRC_t fpObjSet_basesysImage_sysActivateImage2 (void *wap, void *bufp)
{
  ...
  /* get the name from application */
#if L7_FEAT_DIM_USE_FILENAME
  owa.l7rc = usmDbImageFileNameGet(1, objsysImageName);
#else
  owa.l7rc = usmDbBackupImageNameGet(keysysUnitIndexValue, objsysImageName);
#endif
  if (owa.l7rc != L7_SUCCESS)
  {
...
xLibRC_t fpObjSet_basesysImage_sysUpdateBootcode (void *wap, void *bufp)
{
  ...
  {
    owa.rc = XLIBRC_BOOTCODE_UPDATE_FAILURE;    /* TODO: Change if required */
  }
#else
  owa.rc = XLIBRC_BOOTCODE_UPDATE_FAILURE;    /* TODO: Change if required */
#endif
...
xLibRC_t fpObjGet_basesysImage_sysActivateImage (void *wap, void *bufp)
{
  ...
  if (!FPOBJ_CMP_STR256(imagename, image1name))
  {
...
xLibRC_t fpObjSet_basesysImage_sysActivateImage (void *wap, void *bufp)
{
  ...
  /* get the name from application */
  owa.l7rc = usmDbImageFileNameGet ( objsysActivateImageValue-L7_XUI_IMAGE1, imageName);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  /* set the value in application */
  owa.l7rc = usmDbImageActivate (keysysUnitIndexValue, imageName, L7_FALSE);
