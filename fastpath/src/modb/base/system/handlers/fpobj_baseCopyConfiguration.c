	...
	FPOBJ_TRACE_CURRENT_KEY (bufp, &keyDestinationFilenameValue, kwa2.len);
      ...
      switch (keySourceFileNameValue)
      {
        case L7_XUI_RUNNING_CONFIG:
          ...
          case L7_XUI_STARTUP_CONFIG:
              osapiSnprintf(auditMsg, sizeof(auditMsg), pStrInfo_base_Auditing_FileCopy, 
                            pStrInfo_base_RunningCfg, L7_SCRIPTS_STARTUP_CONFIG_FILENAME);
              usmDbSwDevCtrlSaveConfigurationSet(L7_UNIT_CURRENT, L7_SAVE_CONFIG_TYPE_STARTUP);
              break;
          case L7_XUI_BACKUP_CONFIG:
              osapiSnprintf(auditMsg, sizeof(auditMsg), pStrInfo_base_Auditing_FileCopy, 
                            pStrInfo_base_RunningCfg, L7_SCRIPTS_BACKUP_CONFIG_FILENAME);
        ...
        case L7_XUI_STARTUP_CONFIG:
          ...
          {
            osapiSnprintf(auditMsg, sizeof(auditMsg), pStrInfo_base_Auditing_FileCopy, 
                          L7_SCRIPTS_STARTUP_CONFIG_FILENAME, L7_SCRIPTS_BACKUP_CONFIG_FILENAME);
        ...
        case L7_XUI_BACKUP_CONFIG:
          ...
          {
            osapiSnprintf(auditMsg, sizeof(auditMsg), pStrInfo_base_Auditing_FileCopy, 
                          L7_SCRIPTS_BACKUP_CONFIG_FILENAME, L7_SCRIPTS_STARTUP_CONFIG_FILENAME);
