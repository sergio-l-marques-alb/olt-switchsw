...
/*******************************************************************************
* @function fpObjGet_baseSNMPNotificationFilter_OIDTreeString
*
* @purpose Get 'OIDTreeString'
* @description  [OIDTreeString] 
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_baseSNMPNotificationFilter_OIDTreeString (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2 ();
  xLibStr256_t objOIDTreeStringValue;
  ...
  FPOBJ_CLR_STR256 (objOIDTreeStringValue);
  FPOBJ_CLR_STR256 (keyFilterNameValue);
  FPOBJ_CLR_STR256 (keyOIDTreeValue);
  FPOBJ_CLR_STR256 (subTreeValue);
  ...
  /* get the value from application */
  owa.l7rc = usmDbSnmpConfapiObjectFromOID(subTreeValue, objOIDTreeStringValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  /* return the object value: OIDTreeString */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objOIDTreeStringValue, 
                           strlen (objOIDTreeStringValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
