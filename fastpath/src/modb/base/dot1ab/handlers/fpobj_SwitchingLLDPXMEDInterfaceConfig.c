...
xLibRC_t fpObjGet_SwitchingLLDPXMEDInterfaceConfig_TLVsTxEnable (void *wap, void *bufp)
{
  ...
  {
    osapiStrncpySafe(objTLVsTxEnableValue, "0", sizeof(objTLVsTxEnableValue));
    flag=L7_TRUE;
  }
  ...
  if (capGet.bitmap[1] & LLDP_MED_CAP_EXT_PD_BITMASK)
  {
    ...
    osapiStrncat(objTLVsTxEnableValue,"4", sizeof(objTLVsTxEnableValue));
    flag=L7_TRUE;
  }
  if (capGet.bitmap[1] & LLDP_MED_CAP_INVENTORY_BITMASK)
  {
    ...
    osapiStrncat(objTLVsTxEnableValue,"5", sizeof(objTLVsTxEnableValue));
  } 
