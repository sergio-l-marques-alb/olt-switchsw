...
xLibRC_t fpObjGet_SwitchingLLDPPortConfig_TLVsTxEnable (void *wap, void *bufp)
{
  ...
  osapiStrncpySafe(objTLVsTxEnableValue, " ", sizeof(objTLVsTxEnableValue));
  if (portDesc == L7_TRUE)
  {
    osapiStrncat(objTLVsTxEnableValue, "0", sizeof(objTLVsTxEnableValue));
    flag = L7_TRUE;
  }
  if (sysName == L7_TRUE)
  {
    if(flag == L7_TRUE)
    {
      osapiStrncat(objTLVsTxEnableValue,",", sizeof(objTLVsTxEnableValue));
    }
    osapiStrncat(objTLVsTxEnableValue, " 1", sizeof(objTLVsTxEnableValue));
    flag = L7_TRUE;
  }
  if (sysDesc == L7_TRUE)
  {
    ...
    osapiStrncat(objTLVsTxEnableValue, " 2", sizeof(objTLVsTxEnableValue));
    flag = L7_TRUE;
  }
  if (sysCap == L7_TRUE)
  {
    ...
    osapiStrncat(objTLVsTxEnableValue, " 3", sizeof(objTLVsTxEnableValue));
  }
