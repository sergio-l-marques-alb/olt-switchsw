...
{
  fpObjWa_t owa = FPOBJ_INIT_WA2 ();
  xLibU8_t objTableEntryNameValue[ISCSI_NAME_LENGTH_MAX + 1];
...
{
  fpObjWa_t owa = FPOBJ_INIT_WA2 ();
  xLibU8_t objSessionTargetNameValue[ISCSI_NAME_LENGTH_MAX + 1];
...
{
  fpObjWa_t owa = FPOBJ_INIT_WA2 ();
  xLibU8_t objSessionInitiatorNameValue[ISCSI_NAME_LENGTH_MAX + 1];
