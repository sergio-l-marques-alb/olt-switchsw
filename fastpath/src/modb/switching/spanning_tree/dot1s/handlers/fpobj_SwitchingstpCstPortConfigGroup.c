...
extern void fpObj_StpDot1sFormatPortId(xLibU8_t * buf, xLibU16_t val);
...

{
  ...
  owa.l7rc =
    ...
    usmDbDot1sCistHelloTimeGet(L7_UNIT_CURRENT, &objStpCstPortHelloTimerValue);
...
/***********************************************************************************
* @function fpObjGet_SwitchingstpCstPortConfigGroup_StpCstFormattedDesignatedPortId
*
* @purpose Get 'StpCstFormattedDesignatedPortId'
*
* @description [StpCstFormattedDesignatedPortId]: The MSTP designated port ID of a
*              specific port in CIST.
*
* @return
************************************************************************************/
xLibRC_t fpObjGet_SwitchingstpCstPortConfigGroup_StpCstFormattedDesignatedPortId (void *wap,
                                                                         void *bufp)

{
  ...
  xLibU32_t tempKeyInterfaceValue;
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibStr256_t));
  xLibStr256_t objStpCstFormattedDesignatedPortIdValue={0};
  xLibU16_t portId;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc = usmDbDot1sMstiDesignatedPortIDGet (L7_UNIT_CURRENT, L7_DOT1S_CIST_INSTANCE,
                                                tempKeyInterfaceValue, &portId);
  ...
  fpObj_StpDot1sFormatPortId(objStpCstFormattedDesignatedPortIdValue, portId); 

  /* return the object value: StpCstFormattedDesignatedPortId */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) objStpCstFormattedDesignatedPortIdValue,
                           strlen (objStpCstFormattedDesignatedPortIdValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
