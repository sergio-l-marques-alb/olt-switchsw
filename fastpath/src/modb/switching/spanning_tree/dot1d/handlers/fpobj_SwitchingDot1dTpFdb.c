...
xLibRC_t fpObjGet_SwitchingDot1dTpFdb_dot1dTpFdbAddress (void *wap, void *bufp)
{
  ...
  xLibS8_t objdot1dTpFdbAddressValue[L7_FDB_KEY_SIZE];
  xLibS8_t nextObjdot1dTpFdbAddressValue[L7_FDB_KEY_SIZE];
...
xLibRC_t fpObjGet_SwitchingDot1dTpFdb_Dot1dTpFdbPort (void *wap, void *bufp)
{
  ...
  xLibS8_t keydot1dTpFdbAddressValue[L7_FDB_KEY_SIZE];
