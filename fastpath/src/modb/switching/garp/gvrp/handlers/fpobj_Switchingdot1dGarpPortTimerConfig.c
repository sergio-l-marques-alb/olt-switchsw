                                                              ...
                                                              void *bufp)
{
  ...
  owa.l7rc = usmDbGarpJoinTimeSet (L7_UNIT_CURRENT, keyInterfaceValue, objJoinTimeValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
                                                               ...
                                                               void *bufp)
{
  ...
  /* set the value in application */
  owa.l7rc = usmDbGarpLeaveTimeSet (L7_UNIT_CURRENT, keyInterfaceValue, objLeaveTimeValue);
  if (owa.l7rc != L7_SUCCESS)
  {
                                                                  ...
                                                                  void *bufp)
{
  ...
  /* set the value in application */
  owa.l7rc = usmDbGarpLeaveAllTimeSet (L7_UNIT_CURRENT, keyInterfaceValue, objLeaveAllTimeValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; 
		if (owa.l7rc == L7_ERROR)
