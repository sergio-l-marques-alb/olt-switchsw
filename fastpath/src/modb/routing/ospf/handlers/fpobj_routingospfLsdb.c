...
xLibRC_t fpObjGet_routingospfLsdb_Sequence (void *wap, void *bufp)
{
  ...
  owa.l7rc = usmDbOspfLsdbSequenceGet (L7_UNIT_CURRENT, keyAreaIdValue, 0,
                                       keyTypeValue,
                                       keyLsidValue,
...
xLibRC_t fpObjGet_routingospfLsdb_Age (void *wap, void *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbOspfLsdbAgeGet (L7_UNIT_CURRENT, keyAreaIdValue, 0,
                                  keyTypeValue,
...
xLibRC_t fpObjGet_routingospfLsdb_Checksum (void *wap, void *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbOspfLsdbChecksumGet (L7_UNIT_CURRENT, keyAreaIdValue, 0,
                                       keyTypeValue,
                                       keyLsidValue,
...
xLibRC_t fpObjGet_routingospfLsdb_Advertisement (void *wap, void *bufp)
{
  ...
  owa.l7rc = usmDbOspfLsdbAdvertisementGet (L7_UNIT_CURRENT, keyAreaIdValue, 0,
                                            keyTypeValue,
                                            keyLsidValue,
                                            keyRouterIdValue,
                                            &Str,
...
xLibRC_t fpObjGet_routingospfLsdb_Options (void *wap, void *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbOspfAreaLSADbLSAOptionsGet (L7_UNIT_CURRENT, keyAreaIdValue, 0,
                                              keyTypeValue,
                                              keyLsidValue,
                                              keyRouterIdValue,
                                              &byteOptions);
