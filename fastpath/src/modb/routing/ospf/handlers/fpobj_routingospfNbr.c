...
/*******************************************************************************
* @function fpObjGet_routingospfNbr_OspfNbrRestartHelperStatus
*
* @purpose Get 'OspfNbrRestartHelperStatus'
*
* @description [OspfNbrRestartHelperStatus]: Get the Ospf Dead timer remaining of
*              the specified neighbour router Id of the specified interface
*              
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_routingospfNbr_OspfNbrRestartHelperStatus (void *wap, void *bufp)
{
  fpObjWa_t kwa1 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyIpAddrValue;
  fpObjWa_t kwa2 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  ...
  xLibStr256_t objOspfNbrRestartHelperStatusValue;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc =
    usmDbOspfHelpfulNbrStatusGet (keyAddressLessIndexValue, keyIpAddrValue,
                                             &nbrStatus);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  ...
  switch (nbrStatus.exitReason)
  {
  case OSPF_HELPER_IN_PROGRESS:
    sprintf(objOspfNbrRestartHelperStatusValue, "Helping");
    break;
  default:
    sprintf(objOspfNbrRestartHelperStatusValue, "Not Helping");
    break;
  }

  /* return the object value: OspfNbrRestartHelperStatus */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objOspfNbrRestartHelperStatusValue,
                           sizeof (objOspfNbrRestartHelperStatusValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}

/*******************************************************************************
* @function fpObjGet_routingospfNbr_OspfNbrRestartReason
*
* @purpose Get 'OspfNbrRestartReason'
*
* @description [OspfNbrRestartReason]: Get the Ospf Dead timer remaining of
*              the specified neighbour router Id of the specified interface
*              
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_routingospfNbr_OspfNbrRestartReason (void *wap, void *bufp)
{
  fpObjWa_t kwa1 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyIpAddrValue;
  fpObjWa_t kwa2 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  ...
  /* return the object value: OspfNbrRestartReason */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & nbrStatus.restartCode,
                           sizeof (nbrStatus.restartCode));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}

/*******************************************************************************
* @function fpObjGet_routingospfNbr_OspfNbrRemainingGraceTime
*
* @purpose Get 'OspfNbrRemainingGraceTime'
*
* @description [OspfNbrRemainingGraceTime]: Get the Ospf Dead timer remaining of
*              the specified neighbour router Id of the specified interface
*              
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_routingospfNbr_OspfNbrRemainingGraceTime (void *wap, void *bufp)
{
  fpObjWa_t kwa1 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyIpAddrValue;
  fpObjWa_t kwa2 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  ...
  /* return the object value: OspfNbrRemainingGraceTime */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & nbrStatus.restartAge,
                           sizeof (nbrStatus.restartAge));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}

/*******************************************************************************
* @function fpObjGet_routingospfNbr_OspfNbrRestartHelperExitReason
*
* @purpose Get 'OspfNbrRestartHelperExitReason'
*
* @description [OspfNbrRestartHelperExitReason]: Get the Ospf Dead timer remaining of
*              the specified neighbour router Id of the specified interface
*              
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_routingospfNbr_OspfNbrRestartHelperExitReason (void *wap, void *bufp)
{
  fpObjWa_t kwa1 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t keyIpAddrValue;
  fpObjWa_t kwa2 = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  ...
  /* return the object value: OspfNbrRestartHelperExitReason */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & nbrStatus.exitReasonStr,
                           sizeof (nbrStatus.exitReasonStr));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
