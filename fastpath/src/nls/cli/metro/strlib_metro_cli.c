...
L7_char8 *pStrInfo_metro_port_list_help = "Specify the NNI Port List - separate non-consecutive ports with ',' and no spaces between the range; Use '-' for range.";
...
L7_char8 *pStrInfo_metro_DataRateKbps = "Enter an integer in the range of 1 to 4294967295 specifying conforming data rate in Kbps.";
L7_char8 *pStrInfo_metro_DiffservDataRateKbpsRobo = "Enter an integer in the range of 64 to 4294967295 specifying conforming data rate in Kbps with step size 64. Otherwise entered value will be rounded to nearest 64";
...
L7_char8 *pStrInfo_metro_service_subscr_all = "all";
L7_char8 *pStrInfo_metro_dot1ad_service_subcr_help_all = "Select 'all' to display information for all subscribed interfaces";
L7_char8 *pStrInfo_metro_service_subscr_servicename= "service-name";
L7_char8 *pStrInfo_metro_dot1ad_service_subcr_help_servicename= "Enter a service-name.";
...
L7_char8 *pStrErr_metro_CfgDot1adNonAlphaNumericSubscrName = "Invalid subscription name.Subscription name may only contain alphanumeric characters.";
...
L7_char8 *pStrErr_metro_dot1adServiceQosSyntax = "{downstream-qos | upstream-qos} assign-queue <0-3> [police-simple <64-4294967295> <1-128> conform-action [drop | transmit] violate-action [transmit | drop]]";
L7_char8 *pStrErr_metro_dot1adSubTls = "subscribe <service-name> <subscription-name> [assign-queue <0-3> [police-simple <64-4294967295> <1-128> conform-action [drop | transmit] violate-action [transmit | drop]]]";
L7_char8 *pStrErr_metro_dot1adSubCvid = "subscribe <service-name> <subscr-name> match cvid <1-4094> [remark-cvid <1-4094> ] [remove-ctag] [priority <0-7>] [assign-queue <0-3> [police-simple <64-4294967295> <1-128> conform-action [drop | transmit] violate-action [transmit | drop]]]";
L7_char8 *pStrErr_metro_dot1adSubPriority = "subscribe <service-name> <subscr-name> match priority <0-7> [assign-cvid <1-4094>] [assign-queue <0-3> [police-simple <64-4294967295> <1-128> conform-action [drop | transmit] violate-action [transmit | drop]]]";
L7_char8 *pStrErr_metro_dot1adSubUntag = "subscribe <service-name> <subscr-name> match untagged-pkt [assign-cvid <1-4094>] [assign-queue <0-3> [police-simple <64-4294967295> <1-128> conform-action [drop | transmit] violate-action [transmit | drop]]]";
