...
L7_char8 *pStrErr_ipmcast6_IpPimSm6BsrCandidate_Fp = "Use 'ipv6 pimsm bsr-candidate interface <slot/port> [hash-mask-length][priority]'";
...
L7_char8 *pStrErr_ipmcast6_IpPimSm6RpAddr = "Use 'ipv6 pimsm rp-address <rp-address> <group-address> <group-mask> [override]'";
...
L7_char8 *pStrErr_ipmcast6_Ipv6McastStaticRoute = "Use 'ipv6 mroute <src-ip-addr/prefix-length> <rpf-ip-addr> [slot/port] <preference>'";
L7_char8 *pStrErr_ipmcast6_Ipv6McastStaticRouteVlan = "Use 'ipv6 mroute <src-ip-addr/prefix-length> <rpf-ip-addr> [interface vlan <vlan-id>]<preference>'";
