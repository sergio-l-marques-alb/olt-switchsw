...
extern L7_char8 *pStrErr_common_AlnumSpaceUnderscoreHyphen;
...
extern L7_char8	*pStrInfo_common_Ucode;
extern L7_char8	*pStrInfo_submit_description_help;
extern L7_char8	*pStrInfo_refresh_description_help;
extern L7_char8	*pStrInfo_cancel_description_help;
#endif
