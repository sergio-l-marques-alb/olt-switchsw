...
extern L7_char8 *pStrInfo_qos_TimeRangeName;
extern L7_char8 *pStrInfo_qos_TimeRangeStatus;
extern L7_char8 *pStrInfo_qos_TimeRangeStatusActive;
extern L7_char8 *pStrInfo_qos_TimeRangeStatusInactive;
