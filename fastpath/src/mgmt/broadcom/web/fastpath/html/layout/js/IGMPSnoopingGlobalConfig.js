...
function IGMPSnoopingGlobalConfig_LoadEnd(arg){
      var element_1_7_1 = getInputElementByXid('1_7_1');
       ...
       if (element_1_7_1.nextSibling.value == "")
       {
         element_1_7_1.nextSibling.rows="1";
       } else
       {
         element_1_7_1.nextSibling.rows="10";
       }
       element_1_7_1.nextSibling.cols="40";
       element_1_7_1.nextSibling.overflow = scroll;
       element_1_7_1.nextSibling.disabled = false;
       element_1_7_1.nextSibling.readOnly = true;
}
