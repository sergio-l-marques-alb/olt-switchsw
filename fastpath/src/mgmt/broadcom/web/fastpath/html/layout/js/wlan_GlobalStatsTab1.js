...
function wlan_GlobalStatsTab1_SubmitStart(submitFlag)
{
}
function wlan_GlobalStatsTab1_SubmitEnd(submitFlag)
{
}

function wlan_GlobalStatsTab1_LoadStart(arg)
{
...
function wlan_GlobalStatsTab1_LoadEnd(arg)
{
  loadme();
}
