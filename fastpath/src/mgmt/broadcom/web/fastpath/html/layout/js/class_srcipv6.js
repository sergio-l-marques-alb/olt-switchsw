...
function class_srcipv6_SubmitStart(submitFlag){
...
function class_srcipv6_SubmitEnd(submitFlag){

}

function class_srcipv6_LoadStart(arg){

}

function class_srcipv6_LoadEnd(arg){
  var dummy_element = getInputElementByXid('1_6_1');
  var prefix_element = getInputElementByXid('1_6_2');
  var prefixLength_element = getInputElementByXid('1_6_3');
  var str = "/";
