...
function class_destipv6_SubmitStart(submitFlag){
  var dummy_element = getInputElementByXid('1_6_1');
  var prefix_element = getInputElementByXid('1_6_2');
  var prefixLength_element = getInputElementByXid('1_6_3');
  var pre;
...
function class_destipv6_SubmitEnd(submitFlag){

}

function class_destipv6_LoadStart(arg){

}

function class_destipv6_LoadEnd(arg){
  var dummy_element = getInputElementByXid('1_6_1');
  var prefix_element = getInputElementByXid('1_6_2');
  var prefixLength_element = getInputElementByXid('1_6_3');
  var str = "/";
