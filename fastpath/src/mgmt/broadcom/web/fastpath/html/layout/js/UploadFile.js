function UploadFile_SubmitStart()
{
}
function UploadFile_SubmitEnd()
{
}

function UploadFile_LoadStart()
{
}

function UploadFile_LoadEnd()
{
  check_status();
}
...
function check_status()
{
  var e_1_19_1 = getInputElementByXid('1_19_1');
    ...
    if (e_1_19_1.value == 1) {
      window.setTimeout(upload_refresh, 3000);
    }
}
