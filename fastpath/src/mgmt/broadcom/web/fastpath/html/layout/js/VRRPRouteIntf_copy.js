...
function VRRPRouteIntf_copy_SubmitStart(submitFlag) {
...
function VRRPRouteIntf_copy_SubmitEnd(submitFlag){
  
}

function VRRPRouteIntf_copy_LoadStart(arg){
...
function VRRPRouteIntf_copy_LoadEnd(arg){
