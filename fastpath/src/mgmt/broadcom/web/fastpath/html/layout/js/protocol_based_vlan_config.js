...
function protocol_based_vlan_config_SubmitStart(submitFlag){

}
function protocol_based_vlan_config_SubmitEnd(submitFlag){
}
function protocol_based_vlan_config_LoadEnd(arg){
   var interfacelist = getInputElementByXid('1_8_1');
   if (interfacelist != null)
   {
     interfacelist = getInputElementByXid('1_8_1').nextSibling;
     interfacelist.size = 8;
   }	
}


function protocol_based_vlan_config_LoadStart(arg){
