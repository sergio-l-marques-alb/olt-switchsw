...
const L7_char8 *commandClearIpOspfStubRouter(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 index);
/* BEGIN CONFIG */
...
const L7_char8 *commandMaxMetric(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 index);
...
const L7_char8 *commandOspfNsf(EwsContext ewsContext, L7_uint32 argc,const L7_char8 **argv, L7_uint32 index);
const L7_char8 *commandNsfRestartInterval(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 index);
const L7_char8 *commandNsfHelper(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 index);
const L7_char8 *commandNsfHelperDisable(EwsContext ewsContext, L7_uint32 argc, 
                                        const L7_char8 **argv, L7_uint32 index);
const L7_char8 *commandNsfHelperStrictLsaChecking(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 index);
...
const L7_char8 *commandIpv6OspfArea(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 index);
...
const L7_char8 *IrdpHandleMulticast(EwsContext ewsContext, L7_uint32 argc, const L7_char8 **argv, L7_uint32 iface);
...
const char *commandVrrpVrIDAcceptMode(EwsContext ewsContext, uintf argc, const char * * argv, uintf index);
const char *commandShowVrrpInterfaceStats(EwsContext ewsContext, uintf argc, const char * * argv, uintf index);
...
void buildTreeRoutingInterfaceNetDbOspfv3(EwsCliCommandP depth2, L7_uint32 intfMode);
...
const L7_char8 *commandIpGlobalDefaultGateway (EwsContext ewsContext, L7_uint32 argc,  const L7_char8 **argv,  L7_uint32 index); 
