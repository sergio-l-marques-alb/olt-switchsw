                                         ...
                                         L7_uint32 index)
{
 ...
 if (firstTime == L7_TRUE) 
 {
  ...
  /* accept mode */
  rc = usmDbVrrpOperAcceptModeGet(unit,vrID,intfcNum,&acceptMode);
  cliFormat( ewsContext, pStrInfo_routing_AcceptMode_Label);
  ewsTelnetWrite(ewsContext,strUtilEnableDisableGet(acceptMode,pStrInfo_common_Dsbl_1));
