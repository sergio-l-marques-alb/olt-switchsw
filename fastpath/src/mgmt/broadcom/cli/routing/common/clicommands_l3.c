...
void buildTreeGlobalArpBootp(EwsCliCommandP depth2)
{
    ...
    osapiSnprintf(buf, sizeof(buf), "<%d-%d> ", L7_IP_ARP_CACHE_SIZE_MIN, platRtrArpMaxEntriesGet());
...
void buildTreeIfIpAddr(EwsCliCommandP depth2)
{
  ...
  depth4 = ewsCliAddNode(depth3, pStrInfo_common_Dhcp_1, pStrInfo_routing_Dhcp, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
...
void buildTreeGlobalIpRouter(EwsCliCommandP depth2)
{
 ...
 /* (no) ip route default <nexthop>*/
  ...
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
 /* ip route default <nexthop> <pref>*/
  depth6 = ewsCliAddNode(depth5, buf,pStrErr_routing_CfgRtrRtrDiscPrefRange, NULL, 2, L7_NO_COMMAND_SUPPORTED,L7_STATUS_NORMAL_ONLY);
  depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
 /* no ip route default <pref>*/
  depth5 = ewsCliAddNode(depth4, buf, "Revert the route preference to its default", NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NO_ONLY);
...
void buildTreeRoutingInterfaceIrdp(EwsCliCommandP depth2)
{
  ...
  /* ip irdp holdtime */
  sprintf(buf, "<%d-%d> ", L7_RTR_DISC_LIFETIME_MIN, L7_RTR_DISC_LIFETIME_MAX);
  ...
  depth5 = ewsCliAddNode(depth4, buf, pStrInfo_routing_IpIrdpHoldTimeRange, NULL, L7_NO_OPTIONAL_PARAMS);
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);

  /* ip irdp maxadvertinterval */
  sprintf(buf, "<%d-%d> ", L7_RTR_DISC_MAXINTERVAL_MIN, L7_RTR_DISC_MAXINTERVAL_MAX);
  ...
  depth5 = ewsCliAddNode(depth4, buf, pStrInfo_routing_IpIrdpMaxIntvlRange, NULL, L7_NO_OPTIONAL_PARAMS);
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);

  /* ip irdp minadvertinterval */
  sprintf(buf, "<%d-%d> ", L7_RTR_DISC_MININTERVAL_MIN, L7_RTR_DISC_MININTERVAL_MAX);
  ...
  depth5 = ewsCliAddNode(depth4, buf, pStrInfo_routing_IpIrdpMinIntvlRange, NULL, L7_NO_OPTIONAL_PARAMS);
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
  ...
  /* ip irdp multicast */
  depth4 = ewsCliAddNode(depth3, "multicast", "Set the destination IP address for router advertisements", 
...
/****************************************************************************************
*@purpose Build the config Ip Defaultgateway
* 
* @param EwsCliCommandP depth2   "ip"
*
* @returntype void
...
* @end
***************************************************************/
void buildTreeGlobalIpDefaultGateway(EwsCliCommandP depth2)
{
 EwsCliCommandP depth3,depth4,depth5;
 
 depth3 = ewsCliAddNode(depth2, pStrInfo_common_DefGateway, pStrInfo_common_DefGatewaydes, 
                        commandIpGlobalDefaultGateway, 2 , L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
 
 depth4 = ewsCliAddNode(depth3, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NO_ONLY);
 depth4 = ewsCliAddNode(depth3,  pStrInfo_routing_Gatewayaddr, pStrInfo_routing_GatewayIPaddr,  
                        NULL, 4, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NORMAL_ONLY, L7_NODE_DATA_TYPE, 
