...
const L7_char8 *commandInterfaceTrafficShape(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    bandWidth = FD_QOS_COS_QCFG_INTF_SHAPING_RATE;
  }  /* END OF NO COMMAND */
...
const L7_char8 *commandCosQueueMaxBandwidth(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  L7_RC_t status = L7_SUCCESS;
  L7_uint32 interface_start, interface_end;
  ...
  {
    interface_start = 1;
    interface_end = L7_MAX_INTERFACE_COUNT;
  }
  else
  {
    interface_start = L7_ALL_INTERFACES;        /* use this for all dot1p USMDB calls */
    interface_end = L7_ALL_INTERFACES+1;
  }

  for (interface=interface_start; interface < interface_end; interface++)
  {
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      else if (usmDbQosCosQueueMinBandwidthListGet(unit,interface,&minBw) != L7_SUCCESS)
      {
        ...
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_MaxBwMinGet);
        status = L7_FAILURE;
        continue;
      }
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if (usmDbQosCosQueueMaxBandwidthListSet(unit,interface,&maxBw) != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_MaxBwSet);
          status = L7_FAILURE;
        }
      }
    }  /* END OF NORMAL COMMAND */
  ...
  for (interface=interface_start; interface < interface_end; interface++)
  {
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (usmDbQosCosQueueMgmtTypeListGet(unit, interface, &mgmtTypeList) != L7_SUCCESS)
      {
        ...
        ewsTelnetWriteAddBlanks (0, 1, 0, 0, pStrErr_common_CouldNot, ewsContext, pStrInfo_qos_GetQueueMgmtTypeList);
        continue;
      }
      ...
      if (usmDbQosCosQueueMgmtTypeListSet(unit,interface,&mgmtTypeList) != L7_SUCCESS)
      {
        ...
        ewsTelnetWriteAddBlanks (1, 1, 0, 1, L7_NULLPTR,  ewsContext,pStrErr_qos_CosQueueRandomDetectSet );
      }
    }  /* END OF NORMAL COMMAND */
    else if (ewsContext->commType == CLI_NO_CMD)
    {
...
const L7_char8 *commandRandomDetect(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (usmDbFeaturePresentCheck(0, L7_FLEX_QOS_COS_COMPONENT_ID, L7_COS_QUEUE_MGMT_INTF_ONLY_FEATURE_ID) == L7_FALSE)
  {
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_RandomDetectSet);
        }
      }
    ...
    else if (ewsContext->commType == CLI_NO_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_NoRandomDetectSet);
        }
      }
    }  /* END OF NO COMMAND */
  }
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_ExponentSet);
          status = L7_FAILURE;
        }
      }
    ...
    else if (ewsContext->commType == CLI_NO_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_NoExponentSet);
          status = L7_FAILURE;
        }
      }
  ...
  for (interface=interface_start; interface < interface_end; interface++)
  {
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (rc  != L7_SUCCESS)    /* check for min-thresh range too */
      {
        ...
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrInfo_qos_SetWredParams);
        status = L7_FAILURE;
        continue;
      }
      ...
      for (i = 0; i < totalQueueNum; i++)
      {
        if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          if (rc  != L7_SUCCESS)
          {
            ...
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrInfo_qos_SetWredParamsBackToDefl);
            status = L7_FAILURE;
          }
        }
      }
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (rc  != L7_SUCCESS)    /* check for threshold range too */
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrInfo_qos_SetTailDropParams);
          status = L7_FAILURE;
        }
      }
    }  /* END OF NORMAL COMMAND */
      ...
      for (i = 0; i < totalQueueNum; i++)
      {
        if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          if (rc  != L7_SUCCESS)
          {
            ...
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrInfo_qos_SetTailDropParamsBackToDefl);
            status = L7_FAILURE;
          }
        }
      }
...
const L7_char8 *commandClassofserviceIpDscpMapping(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  L7_RC_t rc;
  L7_uint32 numArg;
  L7_uint32 unit, s, p, interface, def_tc;
    ...
    if(ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if (usmDbQosCosMapIpDscpTrafficClassSet(unit, interface, dscpVal, trafficClassVal) != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 1, L7_NULLPTR,  ewsContext,pStrErr_qos_IpDscpMapPingSet );
          status = L7_FAILURE;
        }
      }
    }
    else if(ewsContext->commType == CLI_NO_CMD)
    {
      ...
      for (dscpVal = L7_QOS_COS_MAP_IPDSCP_MIN; dscpVal <= L7_QOS_COS_MAP_IPDSCP_MAX; dscpVal++)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 1, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_IpDscpSet);
          status = L7_FAILURE;
        }
      } /* endfor */
    }
    ...
    if(ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if (usmDbQosCosMapIpPrecTrafficClassSet(unit, interface, precVal, trafficClassVal) != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 1, L7_NULLPTR,  ewsContext,pStrErr_qos_IpPrecedenceMapPingSet );
          status = L7_FAILURE;
        }
      }
    }
    else if(ewsContext->commType == CLI_NO_CMD)
    {
      ...
      for (precVal = L7_QOS_COS_MAP_IPPREC_MIN; precVal <= L7_QOS_COS_MAP_IPPREC_MAX; precVal++)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 1, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_IpPrecedenceSet);
          status = L7_FAILURE;
        }
      } /* endfor */
    }
...
void  cosSyntaxWrite(EwsContext ewsContext)
{
  ...
  else
  {
    ...
    cliSyntaxEnd = cliSyntax + sizeof(cliSyntax);
    cliCurr = cliSyntax;
    ...
    if (usmDbFeaturePresentCheck(unit, L7_DOT1P_COMPONENT_ID, L7_DOT1P_CONFIGURE_TRAFFIC_CLASS_FEATURE_ID) == L7_TRUE)
    {
      ...
      osapiStrncpySafe(cliCurr, pStrErr_qos_CfgCosTrustDot1p, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
    }
    ...
    if (usmDbFeaturePresentCheck(unit, L7_FLEX_QOS_COS_COMPONENT_ID, L7_COS_MAP_IPDSCP_FEATURE_ID) == L7_TRUE)
    {
      ...
      osapiStrncpySafe(cliCurr, pStrErr_qos_CfgCosTrustIpDscp, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
    }
    ...
    if (usmDbFeaturePresentCheck(unit, L7_FLEX_QOS_COS_COMPONENT_ID, L7_COS_MAP_IPPREC_FEATURE_ID) == L7_TRUE)
    {
      ...
      osapiStrncpySafe(cliCurr, pStrErr_qos_CfgCosTrustIpPrecedence, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
    }
    ...
    if (usmDbFeaturePresentCheck(unit, L7_FLEX_QOS_COS_COMPONENT_ID, L7_COS_FEATURE_SUPPORTED) == L7_TRUE)
    {
      ...
      osapiStrncpySafe(cliCurr, pStrErr_qos_CfgCosTrustUntrusted, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
    }
...
const L7_char8 *commandClassofserviceTrust(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  for (interface=interface_start; interface < interface_end; interface++)
  {
    ...
    else
    {
      ...
      ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext,pStrErr_qos_IntfNotSupported);
      status = L7_FAILURE;
    }
  }
