...
/* iscsi cos */
  ...
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
  if (usmDbFeaturePresentCheck(0, L7_FLEX_QOS_ISCSI_COMPONENT_ID, L7_ISCSI_DOT1P_MARKING_FEATURE_ID) == L7_TRUE)
  {
    depth6 = ewsCliAddNode(depth5, pStrInfo_qos_IscsiRemark, pStrInfo_qos_IscsiRemarkHelp, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NORMAL_ONLY);
