...
void  aclMacClean(L7_BOOL isAclAdded, L7_uint32 aclId, L7_uint32 ruleNum)
{
  L7_uint32 unit;
  L7_RC_t   rc;
...
void  aclSyntaxWrite(EwsContext ewsContext)
{
  ...
  else
  {
    ...
    osapiStrncpySafe(cliCurr, pStrErr_qos_AclCloseSyntax, (cliSyntaxEnd-cliCurr));
    cliCurr += strlen(cliCurr);

    osapiStrncpySafe(cliCurr, pStrErr_common_AclDelSyntax, (cliSyntaxEnd-cliCurr));
    cliCurr += strlen(cliCurr);
                                 ...
                                 L7_ACL_RULE_MATCH_PROTOCOL_FEATURE_ID) == L7_TRUE)
    {
      if( more == L7_FALSE)
      {
        osapiStrncpySafe (cliCurr, pStrErr_qos_AclOrSyntax, (cliSyntaxEnd-cliCurr));
        cliCurr += strlen(cliCurr);
        more = L7_TRUE;
      }
      osapiStrncpySafe(cliCurr, pStrErr_qos_AclPortsSyntax, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
                                 ...
                                 L7_ACL_RULE_MATCH_SRCL4PORT_FEATURE_ID) == L7_TRUE )
    {
      ...
      {
        osapiStrncpySafe(cliCurr, pStrErr_qos_AclTosPostSyntax, (cliSyntaxEnd-cliCurr));
        cliCurr += strlen(cliCurr);
      }
                                 ...
                                 L7_ACL_RULE_MATCH_DSTIP_FEATURE_ID) == L7_TRUE)
    {
      ...
      osapiStrncpySafe(cliCurr, pStrErr_qos_AclBeginParenSyntax, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
                                 ...
                                 L7_ACL_RULE_MATCH_IPDSCP_FEATURE_ID) == L7_TRUE )
    {
      ...
      osapiStrncpySafe(cliCurr, pStrErr_qos_AclIpDscp, (cliSyntaxEnd-cliCurr));
      cliCurr += strlen(cliCurr);
    }
    ...
    osapiStrncpySafe(intfString, pStrErr_common_AclIntfsStacking, sizeof(intfString));
#else
    osapiStrncpySafe(intfString, pStrErr_common_AclIntfs, sizeof(intfString));
#endif
    ...
    osapiStrncpySafe(cliCurr, pStrErr_qos_AclPort, (cliSyntaxEnd-cliCurr));
    cliCurr += strlen(cliCurr);
  ...
  else
  {
                                 ...
                                 L7_ACL_RULE_MATCH_VLANID_FEATURE_ID) == L7_TRUE)
    {
                                   ...
                                   L7_ACL_RULE_MATCH_VLANID_RANGE_FEATURE_ID) == L7_TRUE)
      {
        ...
        osapiStrncpySafe(cliCurr, pStrErr_qos_MacAclVlanRangeSyntax, (cliSyntaxEnd-cliCurr));
        cliCurr += strlen(cliCurr);
      }
                                  ...
                                  const L7_char8 * * argv, L7_uint32 index)
{
  ...
  /* Time Based ACL */
  L7_BOOL timeRangeSpecified = L7_FALSE;
  ...
  if (mainMenu[cliCurrentHandleGet()] == cliGetMode(L7_IPV4_ACCESS_LIST_CONFIG_MODE))
  {
    ...
    isAclAdded = L7_FALSE;   /* named IPv4 ACLs are created before entering mode */
  }
  else
  {
  ...
  if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      switch (rc)
      {
        ...
        case L7_ERROR:
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_AclIdNotExist);

        case L7_REQUEST_DENIED:
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_AccessListReqDenyAppUsing);

        default:
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_AccessListDelFail);
      }
    }
  ...
  if (aclType == ACL_STANDARD)
  {
    while (totalArg >= relIndex)
    {
     ...
     else if(osapiStrncmp(argv[index+relIndex],pStrInfo_qos_AclTimeRangeStr,sizeof(pStrInfo_qos_AclTimeRangeStr)) == 0)
      {
        if (totalArg == relIndex)
        {
          aclSyntaxWrite(ewsContext);
        ...
        relIndex++;
        osapiStrncpySafe(timeRangeName, argv[index+relIndex],sizeof(timeRangeName));
        /* validate the input */
        if((osapiStrnlen(timeRangeName,sizeof(timeRangeName)) < L7_TIMERANGE_NAME_LEN_MIN) || (osapiStrnlen(timeRangeName,sizeof(timeRangeName)) > L7_TIMERANGE_NAME_LEN_MAX))
        {
           return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_InvalidTimeRangeNameLength);
        }
        if(usmDbTimeRangeNameStringCheck(unit, timeRangeName) != L7_SUCCESS)
        {
           return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_InvalidTimeRangeNameFormat);
        }
        timeRangeSpecified = L7_TRUE;          
       }
   #endif
      /* Assign Queue */
  ...
  if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if (configuringNamedIpAcl == L7_FALSE)
    {
      ...
      switch (rc)
      {
        ...
        case L7_FAILURE:
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_IncorrectValAclIdMustBeBetween1And199);

        case L7_TABLE_IS_FULL:
          usmDbQosAclMaxNumGet(unit, &maxAcls);        /* This function always returns L7_SUCCESS */
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,ewsContext, pStrInfo_qos_MaxOfAclsIsAlreadyCfgured, maxAcls);

        case L7_ERROR:
          isAclAdded = L7_FALSE;
          osapiSnprintfAddBlanks (2, 1, 0, 0, L7_NULLPTR, buf, sizeof(buf), pStrInfo_qos_AclAlreadyExists);         /* ACL already exists */
          break;

        case L7_REQUEST_DENIED:
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_AccessListReqDenyApp);

        default:
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, pStrErr_common_Error, ewsContext, pStrInfo_qos_UnableToCreateAccessList);
      }
    }
  ...
  /* Add the rule to acl*/
    ...
    switch (rc)
    {
      ...
      case L7_TABLE_IS_FULL:
        return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, "Maximum number of ACL rules already configured.");

      case L7_REQUEST_DENIED:
        return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_AccessListReqDenyAppRuleLimit);

      default:
        return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, pStrErr_common_Error, ewsContext, pStrErr_qos_ProcessingAcl);
    }
    ...
    /*time range */
    if (timeRangeSpecified == L7_TRUE)
    {
      rc = usmDbQosAclRuleTimeRangeNameAdd(unit, aclId, aclRuleNum, timeRangeName);
      if (rc != L7_SUCCESS)
      {
        aclClean(isAclAdded, aclId, aclRuleNum);
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Error, ewsContext, pStrErr_qos_ProcessingAcl);
      ...
      (mainMenu[cliCurrentHandleGet()] != cliGetMode(L7_IPV4_ACCESS_LIST_CONFIG_MODE)))
  {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (usmDbQosAclNameToIndex(unit, strName, &index) != L7_SUCCESS)
        {
          ...
          switch (rc)
          {
            ...
            default:
              return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext,pStrInfo_qos_UnableToCreateAccessList);
          }
    ...
    else if (ewsContext->commType == CLI_NO_CMD)
    {
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        {
          rc = usmDbQosAclDelete(unit, index);
        ...
        {
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext,pStrErr_qos_AccessListDoesntExist);
        }
      }
      /*************Set Flag for Script Successful******/
      ewsContext->actionFunctionStatusFlag=L7_ACTION_FUNC_SUCCESS;
                                     ...
                                     const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if ((numArgs < 2) || (numArgs > 3))      /* parameter check */
  {
    if (ewsContext->commType != CLI_NO_CMD)
    {
      if (usmDbFeaturePresentCheck(0, L7_FLEX_QOS_ACL_COMPONENT_ID,
    ...
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      if (L7_INTF_ISMASKBITSET(EWSINTFMASK(ewsContext), interface))
      {
                                     ...
                                     L7_ACL_INTF_DIFFSERV_COEXIST_FEATURE_ID ) == L7_FALSE)
        {
          ...
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_qos_AclAndDiffservOnSameIntf);
          status = L7_FAILURE;
          continue;
        }
        if (ewsContext->commType == CLI_NORMAL_CMD)
        ...
        if (rc == L7_FAILURE)
        {
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_qos_AclIdOrIntf);
        }
        else if (rc == L7_ERROR)
        {
          if (ewsContext->commType == CLI_NORMAL_CMD)
        ...
        {
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrInfo_qos_IntfAndDirectionAreAlreadyInUse);
        }
        else if (rc == L7_REQUEST_DENIED)
        {
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error, ewsContext, pStrErr_qos_ProcessingAcl);
        }
        else if (rc == L7_TABLE_IS_FULL)
        {
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_AclTblFull);
        }
    
        else if (rc == L7_NOT_SUPPORTED)
        {
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_IpAclNotSupported);
        }
        else if (rc != L7_SUCCESS)
        {
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_AclNotAdded);
        }
    ...
    do
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (rc != L7_SUCCESS)
        {
          ...
          {
            osapiStrncpySafe(buf, cliDisplayInterfaceHelp(unitNum, slot, port), sizeof(buf));
                                      ...
                                      const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (matchEvery == L7_FALSE)
  {
                                 ...
                                 L7_ACL_RULE_MATCH_IPV6_PROTOCOL_FEATURE_ID) == L7_TRUE)
    {
      ...
      /* icmpv6 */
      else if (strcmp(argv[index+relIndex], pStrInfo_common_Icmpv6_1) == 0)
      {
        protVal = L7_ACL_PROTOCOL_ICMPV6;
      }
      /* ip */
...
const L7_char8 *commandIpv6TrafficFilter(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  L7_char8 aclName[L7_ACL_NAME_LEN_MAX+1];
  L7_uint32 sequence = L7_ACL_AUTO_INCR_INTF_SEQ_NUM;
  L7_uint32 unit, numArgs, numArgsCheckLow, numArgsCheckHigh, unitNum, s, p;
  ...
  else
  {
    ...
    if ((numArgs > 3) && (strcmp(argv[index+argAclVlanKeyword], pStrInfo_common_MacAclVlan_1) == 0))
    {
      ...
      /* verify if the specified value is in valid range */
      if (usmDbQosAclIsValidVlan(0, vlanId) == L7_FALSE)
      {
        sprintfAddBlanks (1, 0, 0, 0, L7_NULLPTR, buf,pStrErr_qos_ValVlanIdMustBeFromTo, L7_ACL_MIN_VLAN_ID, L7_ACL_MAX_VLAN_ID);
        return cliSyntaxReturnPrompt (ewsContext, buf);
      }
  ...
  if ((numArgs < numArgsCheckLow) || (numArgs > numArgsCheckHigh))     /* parameter check */
  {
                                 ...
                                 L7_ACL_INTF_VLAN_SUPPORT_FEATURE_ID) == L7_FALSE)
    {
      ...
      else if (usmDbFeaturePresentCheck(0, L7_FLEX_QOS_ACL_COMPONENT_ID,
                                        L7_ACL_INTF_DIRECTION_OUTBOUND_FEATURE_ID) == L7_TRUE)
      {
        /* only out supported */
        if (ewsContext->commType != CLI_NO_CMD)
  ...
  if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if ((usmDbQosAclNameToIndex(0, aclName, &aclId) != L7_SUCCESS) ||
        (usmDbQosAclNamedIndexRangeCheck(0, L7_ACL_TYPE_IPV6, aclId) != L7_SUCCESS))
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext,pStrErr_qos_AccessListDoesntExist);
    }
  }
          ...
          if (direction == tempDirection)
          {
            ...
            if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
            {
              ...
              if (rc != L7_SUCCESS)
              {
                ...
                {
                  osapiStrncpySafe(buf, cliDisplayInterfaceHelp(unitNum, s, p), sizeof(buf));
                  if (commaFlag == L7_TRUE && crFlag == L7_FALSE)
                  {
                    strcat(stat, ",");
                  }
      ...
      (mainMenu[cliCurrentHandleGet()] !=cliGetMode(L7_MAC_ACCESS_LIST_CONFIG_MODE)))
  {
    ...
    else if (ewsContext->commType == CLI_NO_CMD)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if (usmDbQosAclMacNameToIndex(unit, strName, &index) == L7_SUCCESS)
        {
          rc = usmDbQosAclMacDelete(unit, index);
...
const L7_char8 *commandMacAccessGroup(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  L7_RC_t rc;
  L7_BOOL allInterfaces = L7_FALSE;
  L7_uint32 interface, aclId = 0, direction, tempDirection, feature, intListSize;
  L7_uint32 vlanId;
  L7_char8 strDir[L7_CLI_MAX_STRING_LENGTH];
  L7_char8 buf[L7_CLI_MAX_STRING_LENGTH];
  L7_char8 stat[L7_CLI_MAX_STRING_LENGTH];
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
        {
          if (L7_INTF_ISMASKBITSET(EWSINTFMASK(ewsContext), interface))
          {
            ...
            {
              ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_MacAclNotSupported);
            }
            else if (rc != L7_SUCCESS)
            {
              /* Able to remove or add an interface, so set flag to FALSE */
                                               ...
                                               const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    switch (rc)
    {
      ...
      case L7_ERROR:
        return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrInfo_qos_MacAclDoesntExist);
    ...
    if (matchOther == L7_FALSE && matchSrc == L7_TRUE && matchDst == L7_TRUE)
    {
      ...
      if (rc == L7_FAILURE)
      {
        aclMacClean(isAclAdded, aclId, aclRuleNum);
    ...
    if (timeRangeSpecified == L7_TRUE)
    {
      rc = usmDbQosAclMacRuleTimeRangeNameAdd(unit, aclId, aclRuleNum, timeRangeName);
      if (rc != L7_SUCCESS)
      {
        aclMacClean(isAclAdded, aclId, aclRuleNum);
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Error, ewsContext, pStrErr_qos_ProcessingAcl);
