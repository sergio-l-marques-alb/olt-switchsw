      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (itype != L7_LAG_INTF)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext,pStrErr_base_LagsNotValidIntf);
            continue;
          }
          ...
          if (usmDbDot3adAggCollectorMaxDelaySet(unit, iface, maxDelay) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgCollectorMaxDelay);
          }
        }
      }
    }
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (itype != L7_PHYSICAL_INTF)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 1, L7_NULLPTR, ewsContext,pStrErr_base_PhyIntfNotValidIntf);
            continue;
          }
          ...
          if (usmDbDot3adAggPortActorSystemPrioritySet(unit, iface, priorityValue) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgActorSysPri);
          }
        }
      }
    }
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggPortActorAdminKeySet(unit, iface, keyValue) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgActorAdminKey);
          }
        }
      }
    }
  ...
  else if( ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if (usmDbDot3adAggPortActorAdminKeySet(unit, iface, L7_NULL) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgActorAdminKey);
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggPortActorPortPrioritySet(unit, iface, priorityValue) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgActorPortPri);
          }
        }
      }
    }
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggPortPartnerAdminSystemPrioritySet(unit, iface, priorityValue) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgPartnerSysPri);
          }
        }
      }
    }
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggPortPartnerAdminKeySet(unit, iface, keyValue) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgPartnerAdminKey);
          }
        }
      }
    }
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if (usmDbDot3adAggPortPartnerAdminSystemIDSet(unit, iface, mac) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgPartnerSysId);
        }
      }
    }
    else
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggPortPartnerAdminPortSet(unit, iface, portID) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgPartnerPortId);
          }
        }
      }
    }
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggPortPartnerAdminPortPrioritySet(unit, iface, portPriority) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgPartnerPortPri);
            continue;
          }
        }
      }
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if (usmDbDot3adAggActorAdminKeySet(unit, iface, keyValue) != L7_SUCCESS)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgLacpAdminKey);
          }
        }
      }
    }
  ...
  for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbDot3adAggPortActorAdminStateSet(unit, iface, &adminState) != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_base_CfgLacpActorAdminState);
      }
    }
  }
                                             ...
                                             L7_uint32 index)
{
  ...
  if(numArg != 1)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, 
                                           ...
                                           ewsContext, 
                                       pStrErr_base_CfgLacpPartnerAdminState_1);
  }
  ...
  for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
  {
    ...
    if (itype != L7_PHYSICAL_INTF)
    {
      ...
      ewsTelnetWriteAddBlanks (1, 1, 0, 1, L7_NULLPTR, ewsContext,
                               pStrErr_base_PhyIntfNotValidIntf);
      continue;
    }
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbDot3adAggPortPartnerAdminStateSet(unit, iface, &adminState) 
          != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, 
                                 cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                 pStrErr_base_CfgLacpPartnerAdminState);
      }
    }
