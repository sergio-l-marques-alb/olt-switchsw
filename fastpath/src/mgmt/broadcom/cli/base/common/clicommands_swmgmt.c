...
void buildTreeGlobSWMgmtSnmpTrap(EwsCliCommandP depth1)
{
  ...
  if (usmDbComponentPresentCheck(unit, L7_SNMP_COMPONENT_ID) == L7_TRUE)
  {
    ...
    depth4 = ewsCliAddNode(depth3, pStrInfo_base_Ipaddr_2, pStrInfo_base_SnmpTrapCreateIpAddr, NULL, 2, 
                           L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
    depth5 = ewsCliAddNode(depth4, "<ipaddr|hostname> ", pStrInfo_base_SnmpTrapCreateIpAddr_hostname, NULL, 2,
                           L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
    ...
    depth5 = ewsCliAddNode(depth4, "<ip6addr|hostname>",  pStrInfo_base_SnmpTrapCreateIp_hostname, NULL, 2, L7_NO_COMMAND_SUPPORTED,
                           L7_STATUS_BOTH);
    depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, 2, L7_NO_COMMAND_SUPPORTED,
                           L7_STATUS_BOTH);
    depth6 = ewsCliAddNode(depth5, pStrInfo_base_Snmpversion,pStrInfo_base_SnmpTrapVer, NULL, 2, L7_NO_COMMAND_SUPPORTED,
    ...
    depth6 = ewsCliAddNode(depth5, "<ipaddrnew|hostnamenew> ", pStrInfo_base_SnmpTrapIpAddrIpAddrNew, NULL, L7_NO_OPTIONAL_PARAMS);
    depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
    /*#if defined(L7_IPV6_PACKAGE) || defined(L7_IPV6_MGMT_PACKAGE)
    ...
    depth5 = ewsCliAddNode(depth4, "<ipaddr|hostname> ", pStrInfo_base_SnmpTrapModeIpAddr_hostname, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
    depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
#if defined (L7_IPV6_PACKAGE) || defined (L7_IPV6_MGMT_PACKAGE)
    depth5 = ewsCliAddNode(depth4, "<ip6addr|hostname> ", pStrInfo_base_SnmpTrapModeIpAddr_hostname, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
    depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
#endif
    ...
    depth4 = ewsCliAddNode(depth3, pStrInfo_common_Name, pStrInfo_base_SnmpTrapIpAddrName, NULL, L7_NO_OPTIONAL_PARAMS);
    depth5 = ewsCliAddNode(depth4, "<ipaddr|hostname> ", pStrInfo_base_SnmpTrapModeIpAddr_hostname, NULL, L7_NO_OPTIONAL_PARAMS);
    ...
    depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
#if defined (L7_IPV6_PACKAGE) || defined (L7_IPV6_MGMT_PACKAGE)
    depth5 = ewsCliAddNode(depth4, "<ip6addr|hostname>", pStrInfo_base_SnmpTrapModeIpAddr_hostname, NULL, L7_NO_OPTIONAL_PARAMS);
    depth6 = ewsCliAddNode(depth5, pStrInfo_base_SnmpVer1, pStrInfo_base_UseSnmpV1Traps, NULL, L7_NO_OPTIONAL_PARAMS);
    depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
    depth6 = ewsCliAddNode(depth5, pStrInfo_base_SnmpVer2, pStrInfo_base_UseSnmpV2Traps, NULL, L7_NO_OPTIONAL_PARAMS);
    depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
...
void buildTreePrivSWMgmtNetworkConf(EwsCliCommandP depth1)
{
 ...
 if(usmDbFeaturePresentCheck(unit, L7_SIM_COMPONENT_ID, L7_SIM_ALLOW_LOCAL_MAC_USAGE_FEATURE_ID) == L7_TRUE)
  ...
  depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
  depth4 = ewsCliAddNode(depth3, "none", "Reset IP address and gateway on management interface", 
...
void buildTreePrivSWMgmtServicePortConfig(EwsCliCommandP depth1)
{
  ...
  if (usmDbComponentPresentCheck(unit, L7_SERVICE_PORT_PRESENT_ID) == L7_TRUE)
  {
    ...
    depth6 = ewsCliAddNode(depth5, pStrInfo_base_Gateway, pStrInfo_base_NwParmsGway, NULL, L7_NO_OPTIONAL_PARAMS);
    depth7 = ewsCliAddNode(depth6, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
    depth4 = ewsCliAddNode(depth3, "none", "Reset the IP address and gateway on the service port", 
                           NULL, L7_NO_OPTIONAL_PARAMS);
    depth5 = ewsCliAddNode(depth4, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
...
/*********************************************************************
*
* @purpose  Build the Switch Management release dhcp configuration commands tree
*
* @param struct EwsCliCommandP
*
* @returntype void
...
*
*********************************************************************/
void buildTreePrivSWMgmtDhcpConfRelease(EwsCliCommandP depth1)
{
  /* depth1 = Privileged Exec Mode */
  ...
  depth2 = ewsCliAddNode(depth1, pStrInfo_common_Release, pStrInfo_base_SwmgmtRel,
                         NULL, L7_NO_OPTIONAL_PARAMS);
  depth3 = ewsCliAddNode(depth2, pStrInfo_base_Dhcp_1, pStrInfo_base_RelMgmtIpDhcp,
                         commandReleaseDhcp, L7_NO_OPTIONAL_PARAMS);
...
/**********************************************************************
*
* @purpose  Build the Switch Management renew dhcp configuration commands tree
*
* @param struct EwsCliCommandP
*
* @returntype void
...
*
*******************************************************************/
void buildTreePrivSWMgmtDhcpConfRenew(EwsCliCommandP depth1)
{
  /* depth1 = Privileged Exec Mode */
  ...
  depth2 = ewsCliAddNode(depth1, pStrInfo_common_Renew, pStrInfo_base_SwmgmtRenew,
                         NULL, L7_NO_OPTIONAL_PARAMS);
  depth3 = ewsCliAddNode(depth2, pStrInfo_base_Dhcp_1, pStrInfo_base_RenMgmtIpDhcp,
                         commandRenewDhcp, L7_NO_OPTIONAL_PARAMS);
#ifdef L7_ROUTING_PACKAGE
  depth4 = buildTreeInterfaceHelp(depth3, L7_NO_OPTIONAL_PARAMS, L7_NO_OPTION, 
                                  L7_FIRST_COMPONENT_ID, L7_STATUS_NORMAL_ONLY);
  depth5 = ewsCliAddNode(depth4, pStrInfo_common_Cr, pStrInfo_common_NewLine,
                         NULL, L7_NO_OPTIONAL_PARAMS);
#endif
  if(usmDbFeaturePresentCheck(unit,L7_SIM_COMPONENT_ID,L7_SIM_NETWORK_PORT_FEATURE_ID) == L7_TRUE)
  {
    depth4 = ewsCliAddNode(depth3, pStrInfo_common_NetworkPort, pStrInfo_base_RenMgmtNwPort,
                           NULL, L7_NO_OPTIONAL_PARAMS);
    depth5 = ewsCliAddNode(depth4, pStrInfo_common_Cr, pStrInfo_common_NewLine,
                           NULL, L7_NO_OPTIONAL_PARAMS);
  }
  if(usmDbComponentPresentCheck(unit, L7_SERVICE_PORT_PRESENT_ID) == L7_TRUE)
  {
    depth4 = ewsCliAddNode(depth3, pStrInfo_common_ServicePort, pStrInfo_base_RenMgmtSwPort,
                           NULL, L7_NO_OPTIONAL_PARAMS);
    depth5 = ewsCliAddNode(depth4, pStrInfo_common_Cr, pStrInfo_common_NewLine,
                           NULL, L7_NO_OPTIONAL_PARAMS);
  }
