...
void buildTreePrivSwInfoLogging(EwsCliCommandP depth2)
{
  ...
  depth4 = ewsCliAddNode(depth3, pStrInfo_base_emailalertCmd, pStrInfo_base_ShowLoggingemailAlerConfig, NULL, L7_NO_OPTIONAL_PARAMS);
  depth5 = ewsCliAddNode(depth4, pStrInfo_base_emailalertConfigCmd, pStrInfo_base_ShowLoggingemailAlerConfig, commandShowLoggingEmailAlertConfig, L7_NO_OPTIONAL_PARAMS);
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);

  depth5 = ewsCliAddNode(depth4, pStrInfo_base_emailalertStatisticsCmd , pStrInfo_base_ShowLoggingemailAlerStatistics,commandShowLoggingEmailAlertStats, L7_NO_OPTIONAL_PARAMS);	
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine, NULL, L7_NO_OPTIONAL_PARAMS);
