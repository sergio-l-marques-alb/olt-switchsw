...
void buildTreePrivledgedDebug(EwsCliCommandP depth1)
{
  ...
  /* debug dhcp */
  depth3 = ewsCliAddNode(depth2, pStrInfo_base_Dhcp_1, pStrInfo_base_DebugDhcp,
                         commandDebugDhcp, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
  depth4 = ewsCliAddNode(depth3, pStrInfo_common_Pkt, pStrInfo_base_DebugDhcpPkt,
                         commandDebugDhcp, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
  depth5 = ewsCliAddNode(depth4, pStrInfo_common_Cr, pStrInfo_common_NewLine,
                         NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
  depth5 = ewsCliAddNode(depth4, pStrInfo_common_Receive_1, pStrInfo_base_DebugDhcpRxPkt,
                         NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine,
                         NULL, L7_NO_OPTIONAL_PARAMS);
  depth5 = ewsCliAddNode(depth4, pStrInfo_common_Tx_1, pStrInfo_base_DebugDhcpTxPkt,
                         NULL, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Cr, pStrInfo_common_NewLine,
                         NULL, L7_NO_OPTIONAL_PARAMS);
...
/* debuf dot3ah */
  ...
  #endif
  buildTreePrivledgedDebugOspfIpv6(depth3);
  buildTreePrivledgedDebugDHCPv6(depth3);
#endif
