...
L7_RC_t cliRunningEncodedConfig(EwsContext ewsContext);
...
L7_RC_t cliRunningConfigInterfacePfcInfo(EwsContext ewsContext, L7_uint32 interface);
#endif

#ifdef L7_STACKING_PACKAGE
void cliRunningConfigAutoCopySw(EwsContext ewsContext);
#endif
