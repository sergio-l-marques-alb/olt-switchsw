  ...
  else if (strcmp(argv[index+argStats],pStrInfo_common_Dot1xShowStats) == 0)
  {
    ...
    else if( numArgs == 2 ) 
    {
      ...
      if( usmDbRadiusServerAcctHostNameGet(unit, host, addrType, 
                     name) != L7_SUCCESS )
      {
        osapiStrncpySafe(name, pStrErr_common_NotAvailable, sizeof(name));
      }
    }
    ...
    {
      osapiStrncpySafe(buf, pStrInfo_common_NotApplicable, sizeof(buf));
    }                               /* "N\A" */
    else
    {
...
{ 
  ...
  else
  {
    if (boolVal == L7_TRUE)
    {
      osapiStrncpySafe(buf, pStrInfo_common_Yes, sizeof(buf));
    }                                /* "Yes"*/
    else
    {
      osapiStrncpySafe(buf, pStrInfo_common_No, sizeof(buf));
    }                               /* "No"*/
  }
...
*/
  ...
  {
    osapiStrncpySafe(buf, pStrErr_common_NotAvailable, sizeof(buf));
  }                                      /* "N/A" */
  else
  {
    sprintf( buf, "%u", val );
  ...
  {
    osapiStrncpySafe(buf, pStrErr_common_NotAvailable, sizeof(buf)); /* "N/A" */
    osapiStrncpySafe(buf2, pStrErr_common_NotAvailable, sizeof(buf2)); /* "N/A" */
  }
  else
  {
    memset ( buf, 0, sizeof(buf) );
    memset ( buf2, 0, sizeof(buf2) );
    osapiStrncpySafe(buf, strUtilEnableDisableGet(boolVal,pStrInfo_common_Dsbl_1), sizeof(buf)); /* "Disable" */
  ...
  else
  {
    ...
    {
      osapiStrncpySafe(buf, pStrInfo_security_Primary, sizeof(buf));
    }                                            
    else
    {
      osapiStrncpySafe(buf, pStrInfo_security_Secondary, sizeof(buf));
    }                                             
  }
  ewsTelnetWrite(ewsContext, buf); 
  ...
  {
    osapiStrncpySafe(buf, strUtilEnableDisableGet(val,pStrInfo_common_Dsbl_1), sizeof(buf)); /* "Disable" */
  }
  ewsTelnetWrite(ewsContext, buf); 
