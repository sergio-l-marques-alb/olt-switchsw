...
void buildTreeDot1xAuthHistoryClear(EwsCliCommandP depth2);
...
const L7_char8 *commandDot1xAuthenticationHistoryClear(EwsContext ewsContext,L7_uint32 argc,const L7_char8 * * argv,L7_uint32 index);
...
const L7_char8 *commandDot1xRadiusDynamicVlanCreation(EwsContext ewsContext,
                                                 L7_uint32 argc,
                                                 const L7_char8 * * argv,
                                                 L7_uint32 index);
