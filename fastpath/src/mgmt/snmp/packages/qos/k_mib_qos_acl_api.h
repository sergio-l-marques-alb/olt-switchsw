...
L7_RC_t
snmpQosAclRuleTimeRangeStatusGet ( L7_uint32 UnitIndex, L7_uint32 aclIndex,
                           L7_uint32 aclRuleIndex, L7_int32 *val )
{
  L7_uint32 temp_val;
  L7_RC_t rc;
  ...
  rc = usmDbQosAclRuleStatusGet (UnitIndex, aclIndex, aclRuleIndex, &temp_val);

  if (rc == L7_SUCCESS)
  {
    switch (temp_val)
    {
    case L7_ACL_RULE_STATUS_INACTIVE:
      *val = D_aclRuleTimeRangeStatus_inactive;
      break;

    case L7_ACL_RULE_STATUS_ACTIVE:
      *val = D_aclRuleTimeRangeStatus_active;
      break;
...
snmpQosAclRuleEntryGet(L7_uint32 UnitIndex, aclRuleEntry_t *aclRuleEntryData, L7_int32 nominator)
{
  ...
  if (usmDbQosAclRuleCheckValid(UnitIndex, aclRuleEntryData->aclIndex, aclRuleEntryData->aclRuleIndex) == L7_SUCCESS)
  {
    ...
    case I_aclRuleLogging:
       ...
       if (nominator != -1 )  break;
    #if defined (L7_TIMERANGES_PACKAGE) && (L7_FEAT_ACL_RULE_TIME_RANGE)
    case I_aclRuleTimeRangeName:
         if ((usmDbComponentPresentCheck(UnitIndex,L7_TIMERANGES_COMPONENT_ID) == L7_TRUE ) &&
             (usmDbFeaturePresentCheck(UnitIndex, L7_FLEX_QOS_ACL_COMPONENT_ID,
                                     L7_ACL_PER_RULE_ACTIVATION_ID) == L7_TRUE) &&
           (usmDbQosAclIsFieldConfigured(UnitIndex, aclRuleEntryData->aclIndex,
                                         aclRuleEntryData->aclRuleIndex,
                                         ACL_TIME_RANGE_NAME) == L7_TRUE))
       {
           memset(snmp_buffer, 0, (size_t)SNMP_BUFFER_LEN);
           if((usmDbQosAclRuleTimeRangeNameGet(UnitIndex,
                                          aclRuleEntryData->aclIndex,
                                          aclRuleEntryData->aclRuleIndex,
                                          snmp_buffer) == L7_SUCCESS) &&
            (SafeMakeOctetString(&aclRuleEntryData->aclRuleTimeRangeName,
                                 snmp_buffer,
                                 strlen((char *)snmp_buffer)) == L7_TRUE))
            {
               rc = L7_SUCCESS;
               SET_VALID(I_aclRuleTimeRangeName, aclRuleEntryData->valid);
            }
    ...
    case I_aclRuleTimeRangeStatus:
        if ((usmDbComponentPresentCheck(UnitIndex,L7_TIMERANGES_COMPONENT_ID) == L7_TRUE ) &&
           ...
           (usmDbQosAclIsFieldConfigured(UnitIndex, aclRuleEntryData->aclIndex,
                                         ...
                                         ACL_TIME_RANGE_NAME) == L7_TRUE))
       {
          rc = snmpQosAclRuleTimeRangeStatusGet(UnitIndex,
                                        aclRuleEntryData->aclIndex,
                                        aclRuleEntryData->aclRuleIndex,
                                        &aclRuleEntryData->aclRuleTimeRangeStatus);
          if (rc == L7_SUCCESS)
            SET_VALID(I_aclRuleTimeRangeStatus, aclRuleEntryData->valid);        
       }
       if (nominator != -1 ) break;
  #endif
       /* last valid nominator */
...
#if defined (L7_TIMERANGES_PACKAGE) && (L7_FEAT_ACL_RULE_TIME_RANGE)
L7_RC_t
snmpQosAclMacRuleTimeRangeStatusGet ( L7_uint32 UnitIndex, L7_uint32 aclMacIndex,
                              L7_uint32 aclMacRuleIndex, L7_int32 *val )
{
  L7_uint32 temp_val;
  L7_RC_t rc;
  ...
  rc = usmDbQosAclMacRuleStatusGet (UnitIndex, aclMacIndex, aclMacRuleIndex, &temp_val);
...
snmpQosAclMacRuleEntryGet(L7_uint32 UnitIndex, aclMacRuleEntry_t *aclMacRuleEntryData, L7_int32 nominator)
{
  ...
  if (usmDbQosAclMacRuleCheckValid(UnitIndex, aclMacRuleEntryData->aclMacIndex, aclMacRuleEntryData->aclMacRuleIndex) == L7_SUCCESS)
  {
...
#if defined (L7_TIMERANGES_PACKAGE) && (L7_FEAT_ACL_RULE_TIME_RANGE)
     case I_aclMacRuleTimeRangeName:
         if ((usmDbComponentPresentCheck(USMDB_UNIT_CURRENT,L7_TIMERANGES_COMPONENT_ID) == L7_TRUE ) &&
             (usmDbFeaturePresentCheck(USMDB_UNIT_CURRENT, L7_FLEX_QOS_ACL_COMPONENT_ID,
                                     L7_ACL_PER_RULE_ACTIVATION_ID) == L7_TRUE) &&
           (usmDbQosAclMacIsFieldConfigured(USMDB_UNIT_CURRENT, aclMacRuleEntryData->aclMacIndex,
                                         aclMacRuleEntryData->aclMacRuleIndex,
                                         ACL_MAC_TIME_RANGE_NAME) == L7_TRUE))
       {
           memset(snmp_buffer1, 0, (size_t)SNMP_BUFFER_LEN);
           if((usmDbQosAclMacRuleTimeRangeNameGet(USMDB_UNIT_CURRENT,
                                          aclMacRuleEntryData->aclMacIndex,
                                          aclMacRuleEntryData->aclMacRuleIndex,
                                          snmp_buffer1) == L7_SUCCESS) &&
            (SafeMakeOctetString(&aclMacRuleEntryData->aclMacRuleTimeRangeName,
                                 snmp_buffer1,
                                 strlen((char *)snmp_buffer1)) == L7_TRUE))
            {
               rc = L7_SUCCESS;
               SET_VALID(I_aclMacRuleTimeRangeName, aclMacRuleEntryData->valid);
            }
    ...
    case I_aclMacRuleTimeRangeStatus:
        if ((usmDbComponentPresentCheck(USMDB_UNIT_CURRENT,L7_TIMERANGES_COMPONENT_ID) == L7_TRUE ) &&
            (usmDbFeaturePresentCheck(USMDB_UNIT_CURRENT, L7_FLEX_QOS_ACL_COMPONENT_ID,
                                     L7_ACL_PER_RULE_ACTIVATION_ID) == L7_TRUE) &&
           (usmDbQosAclMacIsFieldConfigured(USMDB_UNIT_CURRENT, aclMacRuleEntryData->aclMacIndex,
                                         ...
                                         ACL_MAC_TIME_RANGE_NAME) == L7_TRUE))
       {
          rc = snmpQosAclMacRuleTimeRangeStatusGet(USMDB_UNIT_CURRENT,
                                        aclMacRuleEntryData->aclMacIndex,
                                        aclMacRuleEntryData->aclMacRuleIndex,
                                        &aclMacRuleEntryData->aclMacRuleTimeRangeStatus);
          if (rc == L7_SUCCESS)
            SET_VALID(I_aclMacRuleTimeRangeStatus, aclMacRuleEntryData->valid);        
       }
       if (nominator != -1 ) break;
#endif
        /* last valid nominator */
...
snmpQosAclIpv6RuleEntryGet(L7_uint32 UnitIndex, aclIpv6RuleEntry_t *aclIpv6RuleEntryData, L7_int32 nominator)
{
  ...
  case I_aclIpv6RuleIPDSCP:
      ...
      /* else pass through */
#if defined (L7_TIMERANGES_PACKAGE) && (L7_FEAT_ACL_RULE_TIME_RANGE)
   case I_aclIpv6RuleTimeRangeName:
         if ((usmDbComponentPresentCheck(UnitIndex,L7_TIMERANGES_COMPONENT_ID) == L7_TRUE ) &&
             (usmDbFeaturePresentCheck(UnitIndex, L7_FLEX_QOS_ACL_COMPONENT_ID,
                                     L7_ACL_PER_RULE_ACTIVATION_ID) == L7_TRUE) &&
           (usmDbQosAclIsFieldConfigured(UnitIndex, aclIpv6RuleEntryData->aclIpv6Index,
                                         ...
                                         ACL_TIME_RANGE_NAME) == L7_TRUE))
       {
           ...
           if((usmDbQosAclRuleTimeRangeNameGet(UnitIndex,
                                          ...
                                          aclIpv6RuleEntryData->aclIpv6RuleIndex,
                                          snmp_buffer) == L7_SUCCESS) &&
            (SafeMakeOctetString(&aclIpv6RuleEntryData->aclIpv6RuleTimeRangeName,
                                 snmp_buffer,
                                 strlen((char *)snmp_buffer)) == L7_TRUE))
            {
               rc = L7_SUCCESS;
               SET_VALID(I_aclIpv6RuleTimeRangeName, aclIpv6RuleEntryData->valid);
            }
    ...
    case I_aclIpv6RuleTimeRangeStatus:
        if ((usmDbComponentPresentCheck(UnitIndex,L7_TIMERANGES_COMPONENT_ID) == L7_TRUE ) &&
            (usmDbFeaturePresentCheck(UnitIndex, L7_FLEX_QOS_ACL_COMPONENT_ID,
                                     L7_ACL_PER_RULE_ACTIVATION_ID) == L7_TRUE) &&
           (usmDbQosAclIsFieldConfigured(UnitIndex, aclIpv6RuleEntryData->aclIpv6Index,
                                         ...
                                         ACL_TIME_RANGE_NAME) == L7_TRUE))
       {
          rc = snmpQosAclRuleTimeRangeStatusGet(UnitIndex,
                                        aclIpv6RuleEntryData->aclIpv6Index,
                                        aclIpv6RuleEntryData->aclIpv6RuleIndex,
                                        &aclIpv6RuleEntryData->aclIpv6RuleTimeRangeStatus);
          if (rc == L7_SUCCESS)
            SET_VALID(I_aclIpv6RuleTimeRangeStatus, aclIpv6RuleEntryData->valid);        
       }
       if (nominator != -1 ) break;
#endif
       /* last valid nominator */ 
...
L7_RC_t usmDbVlanIDCheck(L7_uint32 aclVlanIndex)
{
