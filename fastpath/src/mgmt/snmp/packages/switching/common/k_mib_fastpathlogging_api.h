...
L7_RC_t snmpAgentLogWebAdminStatusGet(L7_uint32 *WebAdminStatus);

L7_RC_t snmpAgentLogWebAdminStatusSet(L7_uint32 WebAdminStatus);

L7_RC_t snmpAgentLogSnmpAdminStatusGet(L7_uint32 *SnmpAdminStatus);

L7_RC_t snmpAgentLogSnmpAdminStatusSet(L7_uint32 SnmpAdminStatus);
