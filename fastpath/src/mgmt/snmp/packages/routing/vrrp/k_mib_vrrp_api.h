...
#ifdef I_agentRouterVrrpConfiguredPreemptDelay
L7_RC_t snmpVrrpConfigPreemptDelayGet(L7_uint32 vrId, L7_uint32 intIfNum, L7_uint32 *val)

{
  L7_ushort16 delayvalue;
  L7_RC_t rc = L7_FAILURE;

  rc = usmDbVrrpOperPreemptDelayGet(vrId, intIfNum, &delayvalue);

  *val = (L7_uint32)delayvalue;

  return rc;

}

L7_RC_t snmpVrrpConfigPreemptDelaySet(L7_uint32 vrId, L7_uint32 intIfNum, L7_uint32 val)
{
  L7_RC_t rc = L7_FAILURE;

  rc = usmDbVrrpOperPreemptDelaySet(vrId, intIfNum, (L7_ushort16)val);
  return rc;
}
#endif

#ifdef I_agentRouterVrrpTimerLearn
L7_RC_t snmpVrrpConfigTimerLearnGet(L7_uint32 vrId, L7_uint32 intIfNum, L7_uint32 *val)
{
  L7_BOOL timerlearnMode;
  L7_RC_t rc = L7_FAILURE;

  rc = usmDbVrrpOperTimerLearnGet(vrId, intIfNum, &timerlearnMode); 

  *val = (L7_uint32)timerlearnMode;

  return rc;

}

L7_RC_t snmpVrrpConfigTimerLearnset(L7_uint32 vrId, L7_uint32 intIfNum, L7_uint32 val)
{
  L7_RC_t rc = L7_FAILURE;

  rc = usmDbVrrpOperTimerLearnSet(vrId, intIfNum, (L7_BOOL)val);
  return rc;
}
#endif

#ifdef I_agentRouterVrrpVridDescription
L7_RC_t snmpVrrpConfigDescriptionSet(L7_uint32 vrId, L7_uint32 intIfNum, L7_uchar8* description )
{
  if(strlen(description) > L7_VRRP_MAX_DESCRIPTION) 
    return L7_FAILURE;
 
  if(usmDbVrrpOperDescriptionSet(vrId, intIfNum, description) != L7_SUCCESS)
    return L7_FAILURE;
                        ...
                        L7_uint32 priority)
{
  ...
  {
    if (usmDbVrrpConfigPrioritySet(vrId, intIfNum, (L7_uchar8)priority) != L7_SUCCESS)
    {
      return L7_FAILURE;
    }
  }
...
L7_RC_t          
snmpVrrpOperAcceptModeGet(L7_uint32 UnitIndex, L7_uint32 vrId, L7_uint32 intIfNum,
                           L7_uint32 *val)
 
{
  ...
  rc = usmDbVrrpOperAcceptModeGet(UnitIndex, vrId, intIfNum, &acceptMode);
  ...
  if (rc == L7_SUCCESS)
  {
      ...
      {
      case L7_FALSE:
        *val = D_vrrpOperAcceptMode_false;
        break;

      case L7_TRUE:
        *val = D_vrrpOperAcceptMode_true;
        break;
...
L7_RC_t          
snmpVrrpOperAcceptModeSet(L7_uint32 UnitIndex, L7_uint32 vrId, L7_uint32 intIfNum,
                           L7_uint32 val)
 
{
  L7_BOOL acceptMode = L7_FALSE;
  L7_RC_t rc;
  ...
  switch (val)
  {
  case D_vrrpOperAcceptMode_false:
    acceptMode = L7_FALSE;
    break;

  case D_vrrpOperAcceptMode_true:
    acceptMode = L7_TRUE;
    break;
  ...
  if (rc == L7_SUCCESS)
  {
    rc = usmDbVrrpOperAcceptModeSet(UnitIndex, vrId, intIfNum, acceptMode);
  }
...
L7_RC_t
snmpVrrpTrackRouteEntryGet(L7_uint32 UnitIndex, L7_uint32 vrId, L7_uint32 ifIndex, 
