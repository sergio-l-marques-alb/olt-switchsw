...
L7_RC_t snmpCpdmCPIntfStatusGet(L7_uint32 intf, L7_uint32 *status)
{
  ...
  if (rc == L7_SUCCESS)
  {
    ...
    {
    case L7_TRUE:
      *status = D_cpCaptivePortalIntfActivationStatus_enable;
      break;

    case L7_FALSE:
      *status = D_cpCaptivePortalIntfActivationStatus_disable;
      break;
      ...
      (status == L7_DISABLE))
  {
    ...
    if (rc == L7_SUCCESS)
    {
      ...
      case L7_INTF_WHY_DISABLED_NONE:
        *why = D_cpCaptivePortalIntfActivationDisabledReason_none;
        break;
  
      case L7_INTF_WHY_DISABLED_UNATTACHED:
        *why = D_cpCaptivePortalIntfActivationDisabledReason_intfNotAttached;
        break;
  
      case L7_INTF_WHY_DISABLED_ADMIN:
        *why = D_cpCaptivePortalIntfActivationDisabledReason_adminDisabled;
        break;
