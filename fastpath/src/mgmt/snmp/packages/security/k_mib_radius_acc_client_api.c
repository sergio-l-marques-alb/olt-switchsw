...
**********************************************************************
*
* Name: k_mib_radius_acc_client_api.c
*
...
/* Begin Function Declarations: k_mib_radius_acc_client_api.h */
...
L7_RC_t snmpRadiusAccServerEntryNextGet(L7_uint32 UnitIndex, L7_uint32 *serverIndex, L7_uchar8 *serverAddress, L7_IP_ADDRESS_TYPE_t *addrType)
{
  ...
  *serverIndex += 1;
  ...
  rc = snmpRadiusAccServerEntryGet(UnitIndex, *serverIndex, serverAddress, addrType);
