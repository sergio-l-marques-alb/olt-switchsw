...
L7_RC_t ssltStartTasks(void)
{
  ...
  if (ssltTaskSyncSema == L7_NULL)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Unable to create the task semaphore\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Failed to create the ssltTask\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Unable to initialize ssltTask\n");
    return L7_FAILURE;
  }
...
void ssltTask(void)
{
  ...
  if (ssltDiffieHellmanParamsInit() != L7_SUCCESS)
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
              "SSLT: Failed to create the ssltDiffieHellmanParamsCreate task.\n");
    }
  }
  ...
  */
  while (L7_TRUE)
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
              "SSLT: osapiMessageReceive failed, rc = %d\n", status);
    }
  } /* while */
...
L7_RC_t ssltListenTaskStartup(ssltSecureTypes_t secureType)
{
      ...
      (ssltGlobal.ssltAuxListenTaskId2 == L7_NULL))
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
              "SSLT: DH parameters have not been generated.\n");
    }
    ...
    if ((ctx = ssltContextCreate()) == L7_NULL)
    {
      ...
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
              "SSLT: Failed to create certificate.\n");
      return L7_FAILURE;
    }
    osapiSemaGive(ssltCertSema);
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Failed to create a ssltListenTask, unknown secureType.\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Failed to create the ssltListenTask: %s.\n",taskName);
...
void ssltListenReady(BIO *rdy_acc, ssltSecureTypes_t secureType)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Error accepting connection\n");
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Error creating SSL context\n");
    BIO_free(client);
  ...
  else
  {
    ...
    if (taskId == L7_ERROR)
    {
      L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSLT_COMPONENT_ID, "SSLT: Failed to create the "
...
void ssltListenTask(int argc, L7_uint32 *argv[])
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Error creating Secure server socket\n");
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Error binding Secure server socket\n");
    ssltListenTaskCleanup(secureType);
    return;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSLT_COMPONENT_ID, "SSLT: Error creating Secure server socket6. "
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Error binding Secure server socket (ipv6)\n");
    ssltListenTaskCleanup(secureType);
    return;
  }
...
void ssltConnectionTask(int argc, L7_uint32 *argv[])
{
    ...
    case SSL_ERROR_WANT_WRITE:
      {
        ...
        {
          L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
                  "SSLT: Error on accepting the SSL connection!\n");
  ...
  */
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Error opening unsecure connection to %s\n",
  ...
  if (rc == 0)
  {
...
#else
       remote.addr.ipv4.s_addr = L7_IP6_ADDR_V4MAPPED(&u_saddr.u.sa6.sin6_addr);
#endif
#endif
    }
    else
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
              "SSLT: Couldn't write peer to emWeb, %d %s\n", errno, strerror(errno));
      osapiSocketClose(sock_fd);
      ssltConnTaskCleanup(ssl);
      return;
    }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Couldn't write peername to emWeb, getpeername call failed.");
    osapiSocketClose(sock_fd);
    ssltConnTaskCleanup(ssl);
    return;
  }
  ...
  if (rc == 0)
  {
    if (addr.sin6_family == AF_INET6)
    {
      memcpy(&u_saddr.u.sa6, &addr, sizeof(struct sockaddr_in6));
#ifdef L7_CAPTIVE_PORTAL_PACKAGE
      port = osapiHtons(u_saddr.u.sa6.sin6_port);
#endif
    }
    else
    {
      memcpy(&u_saddr.u.sa, &addr, sizeof(struct sockaddr_in));
#ifdef L7_CAPTIVE_PORTAL_PACKAGE
      port = osapiHtons(u_saddr.u.sa4.sin_port);
#endif
    }
    numBytes = write(sock_fd, (char *)&u_saddr, sizeof(u_saddr));
    if (numBytes < 0)
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
              "SSLT: Couldn't write sockname to emWeb, %d %s\n", errno, strerror(errno));
      osapiSocketClose(sock_fd);
      ssltConnTaskCleanup(ssl);
      return;
    }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_SSLT_COMPONENT_ID,
            "SSLT: Couldn't write sockname to emWeb, getsockname call failed.");
    osapiSocketClose(sock_fd);
    ssltConnTaskCleanup(ssl);
    return;
  }
