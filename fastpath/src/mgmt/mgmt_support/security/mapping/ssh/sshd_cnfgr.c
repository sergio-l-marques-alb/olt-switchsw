 ...
 */
  ...
  else
  {
    if (sshdIssueCmd(SSHD_CNFGR_EVENT, pCmdData) != L7_SUCCESS)
      L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "sshdApiCnfgrCommand: Failed calling "
...
L7_RC_t sshdInit(L7_CNFGR_CMD_DATA_t *pCmdData)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "sshdInit: msgQueue creation error. "
  ...
  if (sshdIssueCmd(SSHD_CNFGR_EVENT, pCmdData) != L7_SUCCESS)
    L7_LOGF(L7_LOG_SEVERITY_ERROR, L7_FLEX_SSHD_COMPONENT_ID, "sshdInit: Failed calling sshdIssueCmd.\n");
                                    ...
                                    L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  */
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "Unable to create the global (data) "
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "Unable to create the channel (data) "
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "Unable to create the session (data) "
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "Unable to create the logging semaphore."
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "Unable to create the clean exit semaphore."
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_FLEX_SSHD_COMPONENT_ID, "Unable to create the immediate exit semaphore."
