...
extern const L7_uchar8 *const topochange_rx_str;
...
extern const L7_uchar8 *const stackRestartComplete_str;
...
extern const L7_uchar8 *const ip_address_conflict_str;
...
extern const L7_uchar8 *const cpuRisingThreshold_str;
extern const L7_uchar8 *const cpuFallingThreshold_str;
extern const L7_uchar8 *const cpuFreeMemBelowThreshold_str;
extern const L7_uchar8 *const CpuFreeMemAboveThreshold_str;

/* Stack Firmware Synchronization strings */
extern const L7_uchar8 *const sfsSyncStart_str;
extern const L7_uchar8 *const sfsSyncFailed_str;
extern const L7_uchar8 *const sfsSyncFinish_str;
