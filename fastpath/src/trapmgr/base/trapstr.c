...
const L7_uchar8 *const topochange_rx_str = "Spanning Tree Topology Change Received: MSTID: %d Unit: %d Slot: %d Port: %d";
...
const L7_uchar8 *const stackRestartComplete_str = "%s has completed on unit %d.";
...
const L7_uchar8 *const ip_address_conflict_str = "Address conflict detected for IP: %s. Conflicting Host MAC: %2.2x:%2.2x:%2.2x:%2.2x:%2.2x:%2.2x";
...
const L7_uchar8 *const cpuRisingThreshold_str = "CPU utilization exceeds Rising threshold of %d percent; %s";
const L7_uchar8 *const cpuFallingThreshold_str = "CPU utilization falls below Falling threshold of %d percent";
const L7_uchar8 *const cpuFreeMemBelowThreshold_str = "CPU Free Memory falls below threshold of %d KB. Total allocated %u KB free %u KB.";
const L7_uchar8 *const CpuFreeMemAboveThreshold_str = "CPU Free Memory rises 10 percent above threshold of %d KB. Total allocated %u KB free %u KB.";

/* Stack Firmware Synchronization strings */
const L7_uchar8 *const sfsSyncStart_str = "Stack Firmware Synchronization Start for unit %d";
const L7_uchar8 *const sfsSyncFailed_str = "Stack Firmware Synchronization Failed for unit %d";
const L7_uchar8 *const sfsSyncFinish_str = "Stack Firmware Synchronization Finished for unit %d";
