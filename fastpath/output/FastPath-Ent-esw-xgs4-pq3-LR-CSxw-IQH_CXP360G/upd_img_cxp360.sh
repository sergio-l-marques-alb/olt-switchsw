sandbox=olt/images_sandbox/CXP360G
...
expect -c "
  ...
  expect \"# \"
  send \"mv -f switchdrvr devshell_symbols.gz linux-kernel-bde.ko linux-user-bde.ko fastpath.cli fastpath.shell fastpath.ver /home/$sandbox/${platform}_fs/usr/local/ptin/sbin\n\"
  expect \"# \"
  send \"rm -f *\n\"
  expect \"# \"
  send \"exit\n\"
