...
fill_default_server_options(ServerOptions *options)
{
...
#else
    {
        ...
        if (sshdGlobal.sshdProtoLevel & SSHD_PROTO_LEVEL_V2_ONLY)
        {
            options->protocol |= SSH_PROTO_2;
        }
        if (sshdGlobal.sshdProtoLevel & SSHD_PROTO_LEVEL_V1_ONLY)
        {
...
#else
                L7_SSHD_PATH_SERVER_PRIVKEY_RSA;
#endif /* L7_SSHD */
            options->host_key_files[options->num_host_key_files++] =
#ifndef L7_SSHD
                _PATH_HOST_DSA_KEY_FILE;
#else
                L7_SSHD_PATH_SERVER_PRIVKEY_DSA;
#endif /* L7_SSHD */
        }
    }
    if (options->num_ports == 0)
        options->ports[options->num_ports++] = sshdGlobal.sshdPort;
    ...
    if (options->banner == NULL)
        options->banner = SSHD_BANNER_FILE_NAME;
#endif /* L7_SSHD */
#ifndef L7_SSHD
...
#else
    osapiSnprintf(strport, sizeof strport, "%u", port);
#endif /* L7_SSHD */
