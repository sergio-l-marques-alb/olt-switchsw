/*
 * $Id: bcm-diag-full.c 1.30.44.6 Broadcom SDK $
...
int pci_dma_putw(pci_dev_t *dev, sal_vaddr_t addr, unsigned int data)
{
    *((unsigned int *)addr) = data;
    return 0;
}

int pci_dma_puth(pci_dev_t *dev, sal_vaddr_t addr, unsigned short data)
{
    *((unsigned short *)addr) = data;
    return 0;
}

int pci_dma_putb(pci_dev_t *dev, sal_vaddr_t addr, unsigned char data)
{
    *((unsigned char *)addr) = data;
    return 0;
}

unsigned int pci_dma_getw(pci_dev_t *dev, sal_vaddr_t addr)
{
    return *((unsigned int *)addr);
}

unsigned short pci_dma_geth(pci_dev_t *dev, sal_vaddr_t addr)
{
    return *((unsigned short *)addr);
}

unsigned char pci_dma_getb(pci_dev_t *dev, sal_vaddr_t addr)
{
