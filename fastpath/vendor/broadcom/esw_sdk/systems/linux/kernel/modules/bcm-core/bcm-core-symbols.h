/*
 * $Id: bcm-core-symbols.h 1.228.2.6 Broadcom SDK $
...
EXPORT_SYMBOL(bcm_esw_switch_temperature_monitor_get);
#endif /* BCM_ESW_SUPPORT */
#ifdef BROADCOM_DEBUG
...
EXPORT_SYMBOL(_bcm_esw_ptp_input_channels_status_get);
...
#ifdef BCM_CMICM_SUPPORT
EXPORT_SYMBOL(soc_cmicm_intr0_enable);
EXPORT_SYMBOL(soc_cmicm_intr1_enable);
EXPORT_SYMBOL(soc_cmicm_intr2_enable);
EXPORT_SYMBOL(soc_cmicm_intr3_enable);
EXPORT_SYMBOL(soc_cmicm_intr4_enable);
EXPORT_SYMBOL(soc_cmicm_intr0_disable);
EXPORT_SYMBOL(soc_cmicm_intr1_disable);
EXPORT_SYMBOL(soc_cmicm_intr2_disable);
EXPORT_SYMBOL(soc_cmicm_intr3_disable);
EXPORT_SYMBOL(soc_cmicm_intr4_disable);
...
EXPORT_SYMBOL(soc_reg_field_length);
...
EXPORT_SYMBOL(soc_trident2_show_temperature_monitor);
...
EXPORT_SYMBOL(soc_tr3_show_temperature_monitor);
