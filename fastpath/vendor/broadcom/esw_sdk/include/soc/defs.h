/*
 * $Id: defs.h 1.252.2.2 Broadcom SDK $
...
/*if ARAD_A0 is defined, define also ARAD_B0 */
...
/*if ARAD_B0 is defined, define also ARAD_A0 */
 ...
 */
#if defined(BCM_56850) || defined(BCM_56150)
...
/* MACSEC device access is not allowed on FPGA or QT platform */
#define BCM_NSP_MACSEC_DEVICE_READY 0   
