/*
 * $Id: mem.h 1.93.28.3 Broadcom SDK $
...
extern  int    ser_test_mem(int unit, soc_reg_t parity_enable_reg, int tcam_parity_bit,
							soc_field_t hw_parity_field, soc_mem_t mem,
							_soc_ser_test_t test_type, soc_block_t mem_block,
							soc_port_t port, int * error_count);
int 	 		_ser_test_parity_control(int unit, soc_reg_t reg, int bit,
								 soc_field_t enable_field, soc_port_t port, int enable);
