/*
 * $Id: cmic.h 1.44.20.1 Broadcom SDK $
...
/* IRQ Register (RO) 
 * CMIC_IRQ_STAT_1 and CMIC_IRQ_STAT_2 only apply to SIRIUS
 */
 ...
 * CMIC_IRQ_MASK_1 and CMIC_IRQ_MASK_2 only apply to SIRIUS
 */
...
/* should be used only with soc_intr_block_lo_enable/disable */
#define IRQ_LO_BLOCK_0                  (1<<0 )     /* Bit 0  */
#define IRQ_LO_BLOCK_1                  (1<<1 )     /* Bit 1  */
#define IRQ_LO_BLOCK_2                  (1<<2 )     /* Bit 2  */
#define IRQ_LO_BLOCK_3                  (1<<3 )     /* Bit 3  */
#define IRQ_LO_BLOCK_4                  (1<<4 )     /* Bit 4  */
#define IRQ_LO_BLOCK_5                  (1<<5 )     /* Bit 5  */
#define IRQ_LO_BLOCK_6                  (1<<6 )     /* Bit 6  */
#define IRQ_LO_BLOCK_7                  (1<<7 )     /* Bit 7  */
#define IRQ_LO_BLOCK_8                  (1<<8 )     /* Bit 8  */
#define IRQ_LO_BLOCK_9                  (1<<9 )     /* Bit 9  */
#define IRQ_LO_BLOCK_10                 (1<<10)     /* Bit 10 */
#define IRQ_LO_BLOCK_11                 (1<<11)     /* Bit 11 */
#define IRQ_LO_BLOCK_12                 (1<<12)     /* Bit 12 */
#define IRQ_LO_BLOCK_13                 (1<<13)     /* Bit 13 */
#define IRQ_LO_BLOCK_14                 (1<<14)     /* Bit 14 */
#define IRQ_LO_BLOCK_15                 (1<<15)     /* Bit 15 */
#define IRQ_LO_BLOCK_16                 (1<<16)     /* Bit 16 */
#define IRQ_LO_BLOCK_17                 (1<<17)     /* Bit 17 */
#define IRQ_LO_BLOCK_18                 (1<<18)     /* Bit 18 */
#define IRQ_LO_BLOCK_19                 (1<<19)     /* Bit 19 */
#define IRQ_LO_BLOCK_20                 (1<<20)     /* Bit 20 */
#define IRQ_LO_BLOCK_21                 (1<<21)     /* Bit 21 */
#define IRQ_LO_BLOCK_22                 (1<<22)     /* Bit 22 */
#define IRQ_LO_BLOCK_23                 (1<<23)     /* Bit 23 */
#define IRQ_LO_BLOCK_24                 (1<<24)     /* Bit 24 */
#define IRQ_LO_BLOCK_25                 (1<<25)     /* Bit 25 */
#define IRQ_LO_BLOCK_26                 (1<<26)     /* Bit 26 */
#define IRQ_LO_BLOCK_27                 (1<<27)     /* Bit 27 */
#define IRQ_LO_BLOCK_28                 (1<<28)     /* Bit 28 */
#define IRQ_LO_BLOCK_29                 (1<<29)     /* Bit 29 */
#define IRQ_LO_BLOCK_30                 (1<<30)     /* Bit 30 */
#define IRQ_LO_BLOCK_31                 (1<<31)     /* Bit 31 */

/* should be used only with soc_intr_block_hi_enable/disable */
#define IRQ_HI_BLOCK_32                 (1<<0 )     /* Bit 0  */
#define IRQ_HI_BLOCK_33                 (1<<1 )     /* Bit 1  */
#define IRQ_HI_BLOCK_34                 (1<<2 )     /* Bit 2  */
#define IRQ_HI_BLOCK_35                 (1<<3 )     /* Bit 3  */
#define IRQ_HI_BLOCK_36                 (1<<4 )     /* Bit 4  */
#define IRQ_HI_BLOCK_37                 (1<<5 )     /* Bit 5  */
#define IRQ_HI_BLOCK_38                 (1<<6 )     /* Bit 6  */
#define IRQ_HI_BLOCK_39                 (1<<7 )     /* Bit 7  */
#define IRQ_HI_BLOCK_40                 (1<<8 )     /* Bit 8  */
#define IRQ_HI_BLOCK_41                 (1<<9 )     /* Bit 9  */
#define IRQ_HI_BLOCK_42                 (1<<10)     /* Bit 10 */
#define IRQ_HI_BLOCK_43                 (1<<11)     /* Bit 11 */
#define IRQ_HI_BLOCK_44                 (1<<12)     /* Bit 12 */
#define IRQ_HI_BLOCK_45                 (1<<13)     /* Bit 13 */
#define IRQ_HI_BLOCK_46                 (1<<14)     /* Bit 14 */
#define IRQ_HI_BLOCK_47                 (1<<15)     /* Bit 15 */
#define IRQ_HI_BLOCK_48                 (1<<16)     /* Bit 16 */
#define IRQ_HI_BLOCK_49                 (1<<17)     /* Bit 17 */
#define IRQ_HI_BLOCK_50                 (1<<18)     /* Bit 18 */
#define IRQ_HI_BLOCK_51                 (1<<19)     /* Bit 19 */
#define IRQ_HI_BLOCK_52                 (1<<20)     /* Bit 20 */
#define IRQ_HI_BLOCK_53                 (1<<21)     /* Bit 21 */
#define IRQ_HI_BLOCK_54                 (1<<22)     /* Bit 22 */
#define IRQ_HI_BLOCK_55                 (1<<23)     /* Bit 23 */
#define IRQ_HI_BLOCK_56                 (1<<24)     /* Bit 24 */
#define IRQ_HI_BLOCK_57                 (1<<25)     /* Bit 25 */
#define IRQ_HI_BLOCK_58                 (1<<26)     /* Bit 26 */
#define IRQ_HI_BLOCK_59                 (1<<27)     /* Bit 27 */
#define IRQ_HI_BLOCK_60                 (1<<28)     /* Bit 28 */
#define IRQ_HI_BLOCK_61                 (1<<29)     /* Bit 29 */
#define IRQ_HI_BLOCK_62                 (1<<30)     /* Bit 30 */
#define IRQ_HI_BLOCK_63                 (1<<31)     /* Bit 31 */
...
/* Katana Switch LEDUP0 handles all the ports */
#define CMIC_LEDUP0_CTRL               0x00020000
#define CMIC_LEDUP0_STATUS             0x00020004
#define CMIC_LEDUP0_PROGRAM_RAM_BASE   0x00020800
#define CMIC_LEDUP0_DATA_RAM_BASE      0x00020400
