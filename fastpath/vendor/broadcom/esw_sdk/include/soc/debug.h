...
#define SOC_DBG_FABRIC     (1 << 24)  /* FABRIC */
#define SOC_DBG_INIT       (1 << 25)  /* INIT */
#define SOC_DBG_STAT       (1 << 26)  /* STAT */
#define SOC_DBG_MCAST      (1 << 27)  /* Multicast */
#define SOC_DBG_TDM        (1 << 28)  /* TDM related */
#define SOC_DBG_RCPU       (1 << 29)  /* RCPU related */
#define SOC_DBG_COSQ        (1 << 30)  /* CosQ related */

#define SOC_DBG_COUNT      31
