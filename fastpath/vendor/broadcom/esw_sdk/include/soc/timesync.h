/*
 * $Id: timesync.h 1.6.114.2 Broadcom SDK $
...
#define SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_INBAND_TS_CONTROL _SHR_PORT_PHY_TIMESYNC_VALID_PHY_1588_INBAND_TS_CONTROL /* inband ts control is valid */
...
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_RESV0_ID_CHECK     _SHR_PORT_PHY_TIMESYNC_INBAND_TS_RESV0_ID_CHECK
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_SYNC_ENABLE        _SHR_PORT_PHY_TIMESYNC_INBAND_TS_SYNC_ENABLE
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_DELAY_RQ_ENABLE    _SHR_PORT_PHY_TIMESYNC_INBAND_TS_DELAY_RQ_ENABLE
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_PDELAY_RQ_ENABLE   _SHR_PORT_PHY_TIMESYNC_INBAND_TS_PDELAY_RQ_ENABLE
#define SOC_PORT_PHY_TIMESYNC_INBAND_TS_PDELAY_RESP_ENABLE _SHR_PORT_PHY_TIMESYNC_INBAND_TS_PDELAY_RESP_ENABLE
...
typedef _shr_port_phy_timesync_inband_ts_control_t soc_port_phy_timesync_inband_ts_control_t;
...
typedef struct soc_port_phy_timesync_config_s {
    ...
    soc_port_phy_timesync_inband_ts_control_t inband_ts_control; /* Inband TS control */
