/*
 * $Id: property.h 1.361.2.37 Broadcom SDK $
...
/*
 * Specify the system side interface to be configured for the PHY
 */
...
/* Option to disable the S3MII Workaround in Katana FE variants */
#define spn_S3MII_WAR_ENABLE  "s3mii_war_enable"
