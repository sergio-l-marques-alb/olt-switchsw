/*
 * $Id: mos_msg_common.h 1.15.2.21 Broadcom SDK $
...
#define MOS_MSG_SUBCLASS_BHH_SESS_POLL              \
    _BHH_SESS_POLL
#define MOS_MSG_SUBCLASS_BHH_SESS_POLL_REPLY        \
    MOS_MSG_SUBCLASS_REPLY(_BHH_SESS_POLL)
 
#define   MOS_MSG_CLASS_BHH_EVENT       8
#define MAX_MOS_MSG_CLASS       8
