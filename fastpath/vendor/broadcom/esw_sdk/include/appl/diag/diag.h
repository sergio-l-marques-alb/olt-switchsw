...
#define DIAG_FUNC_STR_MATCH(_function, _string, _short_string) 								           \
	!(sal_strncasecmp(function, _string, SOC_SAND_MAX(strlen(function),strlen(_string)))) ||		   \
    !(sal_strncasecmp(function, _short_string, SOC_SAND_MAX(strlen(function),strlen(_short_string))))
