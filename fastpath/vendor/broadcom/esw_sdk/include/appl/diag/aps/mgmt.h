...
/* AVB sub-commands */
typedef enum {
    MGMT_AVB_PORT_INFO_GET = 0x0,
    MGMT_AVB_PORT_ADMIN_MODE_SET = 0x1,
    MGMT_AVB_PORT_SPEED_SET = 0x2,
    MGMT_AVB_PORT_MASTER_SLAVE_SET = 0x3,
    MGMT_AVB_PORT_STAT_GET = 0x4,
    MGMT_AVB_DOT1AS_INFO_GET = 0x5,
    MGMT_AVB_DOT1AS_MODE_SET = 0x6,
    MGMT_AVB_DOT1AS_PRI_SET = 0x7,
    MGMT_AVB_DOT1AS_PORT_INFO_GET = 0x8,
    MGMT_AVB_DOT1AS_PORT_MODE_SET = 0x9,
    MGMT_AVB_DOT1AS_STATS_GET = 0xA,
    MGMT_AVB_DOT1AS_STATS_CLEAR = 0xB,
    MGMT_AVB_DOT1AS_INTERVAL_SET = 0xC,
    MGMT_AVB_DOT1AS_PDELAY_THRESH_SET = 0xD,
    MGMT_AVB_DOT1AS_NUM_LSTRESP_SET = 0xE,
    MGMT_AVB_VLAN_CREATE = 0xF,
    MGMT_AVB_VLAN_DELETE = 0x10,
    MGMT_AVB_VLAN_PORT_ADD = 0x11,
    MGMT_AVB_VLAN_PORT_REMOVE = 0x12,
    MGMT_AVB_VLAN_PVID_SET = 0x13,
    MGMT_AVB_VLAN_IFILTER_SET = 0x14,
    MGMT_AVB_VLAN_PRIO_SET = 0x15,
    MGMT_AVB_VLAN_GET = 0x16,
    MGMT_AVB_FDB_ENTRY_ADD = 0x17,
    MGMT_AVB_FDB_ENTRY_DELETE = 0x18,
    MGMT_AVB_FDB_ENTRY_GET = 0x19,
    MGMT_AVB_PORT_BANDWIDTH_GET = 0x1A,
    MGMT_AVB_PORT_BANDWIDTH_SET = 0x1B,
    MGMT_AVB_PCP_MAPPING_GET = 0x1C,
    MGMT_AVB_PCP_MAPPING_SET = 0x1D,
    MGMT_AVB_MIRROR_ENABLE = 0x1E,
    MGMT_AVB_MIRROR_DISABLE = 0x1F,
    MGMT_AVB_PORT_PHY_LB_SET = 0x20,
    MGMT_AVB_SWITCH_AGE_TIME_SET = 0x21,
    MGMT_AVB_SWITCH_AGE_TIME_GET = 0x22,
    MGMT_AVB_SWITCH_CONFIG_SAVE = 0x23,
    MGMT_AVB_PORT_JUMBO_MODE_SET = 0x24,
    MGMT_AVB_PORT_JUMBO_MODE_GET = 0x25
} mgmt_avb_cmd_t;
...
typedef  struct mgmt_dot1as_info_s {
    ...
    uint32   pad1;
    uint64   local_clk_id; /* Local clock identity */
    uint32   gm_present;   /* Grandmaster present? */
    uint32   pad2;
    uint64   gm_clk_id;    /* Clock identify of grandmaster */
...
/*
 * First 4 fields are enums, but since sizeof(enum) can vary
 * by compiler, use fixed size uint32 instead.
 */
typedef union  {
    uint32 port_info;

    uint32 dot1as_info;
    uint32 dot1as_port_info;
    uint32 dot1as_port_stats;
    struct {
      uint32 value;   /* Switch age time */
    } switch_age_time;
