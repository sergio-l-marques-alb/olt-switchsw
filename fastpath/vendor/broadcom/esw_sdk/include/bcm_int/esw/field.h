/*
 * $Id: field.h 1.384.6.3 Broadcom SDK $
...
typedef struct _field_data_control_s {
   ...
   uint32 single_chunk_usage_bmap;    /* Single Chunk (for example UDF1_31_0 
                                        or UDF1_95_64) usage bmap */
...
#define _FIELD_D_TYPE_POS   \
       ((SOC_IS_TRIDENT2(unit)) ? (18) : \
       ((SOC_IS_TD_TT(unit) || SOC_IS_KATANA(unit)) ? (16) : (14)))
...
extern int _field_tr2_ifp_slice_expanded_status_get(int unit,
                                                    _field_stage_t *stage_fc,
                                                    int *expanded);
extern int _field_tr2_scache_slice_group_recover(int unit,
                                                 _field_control_t *fc,
                                                 int slice_num,
                                                 int *multigroup,
                                                 _field_stage_t *stage_fc);
...
extern int _field_tr2_group_construct(int unit,
                                     ...
                                     _field_stage_id_t stage_id,
                                     int slice_idx);
extern int _field_tr2_entry_info_retrieve(int unit,
