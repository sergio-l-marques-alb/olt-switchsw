/*
 * $Id: vxlan.h 1.12.6.2 Broadcom SDK $
...
#define _BCM_VXLAN_VFI_INVALID 0x3FFF
...
#define _BCM_VXLAN_DEST_VP_ATTRIBUTE_TYPE  0x2
#define  _BCM_VXLAN_DEST_VP_TYPE_NETWORK   0x3
