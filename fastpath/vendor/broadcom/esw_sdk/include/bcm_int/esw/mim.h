/*
 * $Id: mim.h 1.5.64.1 Broadcom SDK $
...
#define _BCM_MIM_VPN_TYPE_MIM         _BCM_VPN_TYPE_MIM
...
#define _BCM_MIM_VPN_IS_SET(_vpn_)    \
        (((_vpn_) >> _BCM_MIM_VPN_TYPE_SHIFT) == _BCM_MIM_VPN_TYPE_MIM)

#define _BCM_MIM_VPN_SET(_vpn_, _type_, _id_) \
    ((_vpn_) = ((_type_) << _BCM_MIM_VPN_TYPE_SHIFT)  | \
     ((_id_) & _BCM_MIM_VPN_ID_MASK))

#define _BCM_MIM_VPN_ID_GET(_vpn_) \
    ((_vpn_) & _BCM_MIM_VPN_ID_MASK)
