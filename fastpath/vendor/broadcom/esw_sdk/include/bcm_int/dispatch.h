 ...
 *
 * $Id: dispatch.h 1.660.2.5 Broadcom SDK $
 ...
 * Generated:	Tue Feb 26 18:34:01 2013
 */
...
typedef struct {
...
#endif	/* INCLUDE_CES */
	int (*clear)(int);
	int (*cosq_bst_profile_get)(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_bst_profile_t *);
	int (*cosq_bst_profile_set)(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_bst_profile_t *);
	int (*cosq_bst_stat_get)(int,bcm_gport_t,bcm_cos_queue_t,uint32,uint64 *);
	int (*cosq_bst_stat_traverse)(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_bst_stat_traverse_cb,void *);
	...
	int (*fcoe_control_vsan_get)(int,uint32,bcm_fcoe_vsan_control_t,int *);
	int (*fcoe_control_vsan_set)(int,uint32,bcm_fcoe_vsan_control_t,int);
	int (*fcoe_enable_set)(int);
	int (*fcoe_init)(int);
	int (*fcoe_route_add)(int,bcm_fcoe_route_t *);
	int (*fcoe_route_delete)(int,bcm_fcoe_route_t *);
	int (*fcoe_route_delete_all)(int,bcm_fcoe_route_t *);
	...
	int (*fcoe_vsan_create)(int,bcm_fcoe_vsan_t *);
	int (*fcoe_vsan_destroy)(int,bcm_fcoe_vsan_t *);
	int (*fcoe_vsan_destroy_all)(int);
	int (*fcoe_vsan_get)(int,uint32,bcm_fcoe_vsan_t *);
	int (*fcoe_vsan_set)(int,uint32,bcm_fcoe_vsan_t *);
