/*
 * $Id: vlan.h 1.176.10.1 Broadcom SDK $
 * 
...
typedef enum bcm_vlan_action_e {
    ...
    bcmVlanActionCompressed /* Set VLAN compress tag. */
} bcm_vlan_action_t;
...
typedef enum bcm_vlan_tpid_action_e {
    bcmVlanTpidActionNone,  /* Do not modify. */
    bcmVlanTpidActionModify /* Set to given value. */
...
typedef enum bcm_vlan_translate_key_e {
    ...
    bcmVlanTranslateKeyPortOuterPri,    /* Use Port, (VLAN-PRI, VLAN-CFI =>
                                           O-TAG[15:12]) */
    bcmVlanTranslateKeyDoubleVsan,      /* Use I-VID[11:0], O-VID[11:0] and
                                           VSAN-ID[11:0] */
    bcmVlanTranslateKeyInnerVsan,       /* Use I-VID[11:0] and VSAN-ID[11:0] */
    bcmVlanTranslateKeyOuterVsan        /* Use O-VID[11:0] and VSAN-ID[11:0] */
...
typedef enum bcm_vlan_control_port_e {
    ...
    bcmVlanPortTranslateFcoeKeyFirst,   /* Selects key to use for first vlan
                                           xlate lookup if ethertype if FCoE */
    bcmVlanPortTranslateFcoeKeySecond   /* Selects key to use for second vlan
                                           xlate lookup if ethertype if FCoE */
} bcm_vlan_control_port_t;
...
#define BCM_VLAN_ACTION_SET_WITH_ID 0x00000001 /* Add using the specified ID. */
