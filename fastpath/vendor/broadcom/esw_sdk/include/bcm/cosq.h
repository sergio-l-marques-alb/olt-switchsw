/*
 * $Id: 6ea961c6320096459f9d2c3ec17b520c8d7bc9d3 $
 * 
...
typedef enum bcm_cosq_control_e {
    ...
    bcmCosqControlSPPortLimitState,     /* For each port , retrieve limit state
                                           of the corresponding shared pool of
                                           the port */
    bcmCosqControlPGPortLimitState,     /* For each port , retrieve limit state
                                           of the corresponding priority group
                                           of the port */
    bcmCosqControlPGPortXoffState,      /* For each port , retrieve xoff state
                                           of the corresponding priority group
                                           of the port */
    bcmCosqControlPoolRedDropState,     /* For each pool , retrieve drop state
                                           of the red packets for the pool */
    bcmCosqControlPoolYellowDropState,  /* For each pool , retrieve drop state
                                           of the yellow packets for the pool */
    bcmCosqControlPoolGreenDropState,   /* For each pool , retrieve drop state
                                           of the green packets for the pool */
    bcmCosqControlIngressPool,          /* Associate an Ingress Cos to a
                                           specific service pool */
    bcmCosqControlEEEQueueThresholdProfileSelect, /* Select queue depth threshold as the
                                           condition to exit LPI state */
    bcmCosqControlEEEPacketLatencyProfileSelect, /* Select packet max latency as the
                                           condition to exit LPI state */
    bcmCosqControlPortQueueUcast,       /* retrieve port, cosq queue number of
                                           PBSMH UC packet headers */
    bcmCosqControlPortQueueMcast        /* retrieve port, cosq queue number of
...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatHighPriDroppedPackets,   /* PGW OBM high priority dropped packet
                                           count. */
    bcmCosqStatLowPriDroppedPackets,    /* PGW OBM low priority dropped packet
                                           count. */
    bcmCosqStatHighPriDroppedBytes,     /* PGW OBM high priority dropped byte
                                           count. */
    bcmCosqStatLowPriDroppedBytes,      /* PGW OBM low priority dropped byte
                                           count. */
    bcmCosqStatGlobalHeadroomBytes0Peak, /* Total Bytes used Global Headroom by X
                                           pipe Peak */
    bcmCosqStatGlobalHeadroomBytes0Current, /* Total Bytes used Global Headroom by X
                                           pipe Current */
    bcmCosqStatGlobalHeadroomBytes1Peak, /* Total Bytes used Global Headroom by Y
                                           pipe Peak */
    bcmCosqStatGlobalHeadroomBytes1Current, /* Total Bytes used Global Headroom by Y
                                           pipe Current */
    bcmCosqStatIngressPortPoolSharedBytesPeak, /* Peak value of shared buffers in use
                                           by all ports for each service pool in
                                           bytes. */
    bcmCosqStatIngressPortPoolSharedBytesCurrent, /* Current value buffers in use by all
                                           ports for each service pool in bytes. */
    bcmCosqStatIngressPortPGMinBytesPeak, /* Peak value of buffers in use from PG
                                           min space per port per PG in bytes. */
    bcmCosqStatIngressPortPGMinBytesCurrent, /* Current value of buffers in use from
                                           PG min space per port per PG in
                                           bytes. */
    bcmCosqStatIngressPortPGSharedBytesPeak, /* Peak value of buffers in use from
                                           shared space per port per PG in
                                           bytes. */
    bcmCosqStatIngressPortPGSharedBytesCurrent, /* Current value of buffers in use from
                                           shared space per port per PG in
                                           bytes. */
    bcmCosqStatIngressPortPGHeadroomBytesPeak, /* Peak value of  buffers in use from PG
                                           headroom space in bytes. */
    bcmCosqStatIngressPortPGHeadroomBytesCurrent, /* Current value of  buffers in use from
                                           PG headroom space in bytes. */
    bcmCosqStatEgressMCQueueBytesPeak,  /* Peak value of  multicast queue
                                           buffers in use in bytes. */
    bcmCosqStatEgressMCQueueBytesCurrent, /* Current value of  multicast queue
                                           buffers in use in bytes. */
    bcmCosqStatEgressUCQueueBytesPeak,  /* Peak value of unicast queue buffers
                                           in use in bytes. */
    bcmCosqStatEgressUCQueueBytesCurrent, /* Current value of unicast queue
                                           buffers in use in bytes. */
    bcmCosqStatEgressUCQueuePortBytesPeak, /* Peak value of  unicast queue shared
                                           buffer in use in bytes. */
    bcmCosqStatEgressUCQueuePortBytesCurrent /* Current value of unicast queue shared
                                           buffer in use in bytes. */
} bcm_cosq_stat_t;
...
typedef enum bcm_bst_stat_id_e {
    bcmBstStatIdDevice,             /* Per device BST tracing resource */
    bcmBstStatIdEgrPool,            /* Per Egress Pool BST tracing resource */
    bcmBstStatIdEgrMCastPool,       /* Per Egress Pool BST tracing
                                       resource(Multicast) */
    bcmBstStatIdIngPool,            /* Per Ingress Pool BST tracing resource */
    bcmBstStatIdPortPool,           /* Per Port Pool BST tracing resource */
    bcmBstStatIdPriGroupShared,     /* Per Shared Priority Group Pool BST
                                       tracing resource */
    bcmBstStatIdPriGroupHeadroom,   /* Per Priority Group Headroom BST tracing
                                       resource */
    bcmBstStatIdUcast,              /* BST Tracing resource for unicast */
    bcmBstStatIdMcast,              /* BST Tracing resource for multicast */
    bcmBstStatIdMaxCount            /* Must be the last. Not a usable value. */
} bcm_bst_stat_id_t;
...
typedef enum bcm_cosq_control_drop_limit_alpha_value_e {
    bcmCosqControlDropLimitAlpha_1_64,  /* Use 1/64 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_1_32,  /* Use 1/32 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_1_16,  /* Use 1/16 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_1_8,   /* Use 1/8 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_1_4,   /* Use 1/4 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_1_2,   /* Use 1/2 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_1,     /* Use 1 as the alpha value for dynamic
                                           threshold */
    bcmCosqControlDropLimitAlpha_2,     /* Use 2 as the alpha value for dynamic
                                           threshold */
    bcmCosqControlDropLimitAlpha_4,     /* Use 4 as the alpha value for dynamic
                                           threshold */
    bcmCosqControlDropLimitAlpha_1_128, /* Use 1/128 as the alpha value for
                                           dynamic threshold */
    bcmCosqControlDropLimitAlpha_8,     /* Use 8 as the alpha value for dynamic
                                           threshold */
    bcmCosqControlDropLimitAlphaCount   /* Must be the last entry! */
