/*
 * $Id: field.h 1.407.2.4 Broadcom SDK $
 * 
...
typedef enum bcm_field_header_format_e {
    ...
    bcmFieldHeaderFormatIp4,            /* IPv4 packet (headers = L2, IPv4) */
    bcmFieldHeaderFormatIp6,            /* IPv6 packet (headers = L2, IPv6) */
...
typedef enum bcm_field_ForwardingType_e {
    ...
    bcmFieldForwardingTypeL2VpnExtended, /* Extended P2P forwarding */
    bcmFieldForwardingTypeIp4UcastRpf,  /* IPv4 Unicast Routing forwarding
                                           (coupled to the RPF lookup) */
    bcmFieldForwardingTypeIp6UcastRpf,  /* IPv6 Unicast Routing forwarding
                                           (coupled to the RPF lookup) */
...
typedef enum bcm_field_control_e {
    ...
    bcmFieldControlCascadedKeyWidth,    /* Default width of key cascaded between
                                           groups */
    bcmFieldControlMeterPoolCompress,   /* Enable/Disable meter pool compress
                                           operation during group compression. */
