...
/*
 * Function:
 *  drv_bcm53280_arl_learn_enable_set
 * Purpose:
 ...
 */
int
drv_bcm53280_arl_learn_enable_set(int unit, soc_pbmp_t pbmp, uint32 mode)
{
    int         rv = SOC_E_NONE;
...
/*
 * Function:
 *  drv_bcm53280_arl_learn_enable_get
 * Purpose:
 *  Setting per port SA learning process.
 * Parameters:
 *  unit    - RoboSwitch unit #
 ...
 */
int
drv_bcm53280_arl_learn_enable_get(int unit, soc_port_t port, uint32 *mode)
{
...
/*
 * Function:
 *  drv_bcm53280_arl_learn_count_set
 * Purpose:
 ...
 */
int
drv_bcm53280_arl_learn_count_set(int unit, uint32 port, 
        uint32 type, int value)
{
    ...
    if ((type == DRV_PORT_SA_LRN_CNT_LIMIT) || 
         ...
         */
        rv = _drv_bcm53280_mem_sa_lrncnt_control_set(unit, port, type, value);
    } else {
        rv = SOC_E_UNAVAIL;
    }
...
/*
 * Function:
 *  drv_bcm53280_arl_learn_count_get
 * Purpose:
 *  Get the ARL port basis learning count related information.
 * Parameters:
 *  unit    - RoboSwitch unit #
 ...
 */
int
drv_bcm53280_arl_learn_count_get(int unit, uint32 port, 
        uint32 type, int *value)
{
    int rv;
