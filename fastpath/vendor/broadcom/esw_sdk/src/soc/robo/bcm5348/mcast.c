/*
 * $Id: mcast.c 1.3.384.1 Broadcom SDK $
 *
...
/*
 *  Function : drv_bcm5348_mcast_bmp_get
 *
 *  Purpose :
 ...
 */
int  
drv_bcm5348_mcast_bmp_get(int unit, uint32 *entry, soc_pbmp_t *bmp)
{
 ...
 /*
 *  Function : drv_bcm5348_mcast_bmp_set
 *
 *  Purpose :
 ...
 */
int  
drv_bcm5348_mcast_bmp_set(int unit, uint32 *entry, soc_pbmp_t bmp, uint32 flag)
{
    int loop, mcindex = -1;
