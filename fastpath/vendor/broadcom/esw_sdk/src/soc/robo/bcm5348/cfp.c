/*
 * $Id: cfp.c 1.28.64.1 Broadcom SDK $
...
/* Ram select code for bcm5348 */
#define CFP_5348_RAM_SEL_OB_STAT 0x10
#define CFP_5348_RAM_SEL_IB_STAT 0x8
#define CFP_5348_RAM_SEL_METER 0x4
#define CFP_5348_RAM_SEL_ACT 0x2
#define CFP_5348_RAM_SEL_TCAM 0x1

/* OP code */
#define CFP_5348_OP_NONE 0x0
#define CFP_5348_OP_READ 0x1
#define CFP_5348_OP_WRITE 0x2
#define CFP_5348_OP_SEARCH 0x4

/* Flood and drop value for BCM5348 */
#define CFP_5348_DEST_FLOOD 0x3e
#define CFP_5348_DEST_DROP 0x3f

/* User defined fields for BCM5348 */ 
#define CFP_5348_UDF_NUM_MAX 10
#define CFP_5348_UDF_OFFSET_MAX 80

/* 1Gb */
#define CFP_5348_METER_RATE_MAX (1000 * 1000)
/* 64Kbits/sec */
#define CFP_5348_METER_RATE_MIN 64
/* 128Mb */
#define CFP_5348_METER_BURST_MAX (128 * 1000)   
/* 64K */
#define CFP_5348_METER_BURST_MIN 64


#define CFP_5348_KEY_PATTERN      (0xaaaabeef)

/* Slice 0~4 qualify set */
 
static int s0_qset[] = { DRV_CFP_QUAL_SRC_PORT,
                                  DRV_CFP_QUAL_1QTAG,
                                  DRV_CFP_QUAL_SPTAG,
...
static int s1_qset[] = { DRV_CFP_QUAL_SRC_PORT,
                                  DRV_CFP_QUAL_1QTAG,
                                  DRV_CFP_QUAL_SPTAG,
                                  DRV_CFP_QUAL_8023_OR_EII,
                                  DRV_CFP_QUAL_8022_LLC,
...
static int s2_qset[] = { DRV_CFP_QUAL_SRC_PORT,
                                  DRV_CFP_QUAL_1QTAG,
                                  DRV_CFP_QUAL_SPTAG,
                                  DRV_CFP_QUAL_8023_OR_EII,
                                  DRV_CFP_QUAL_8022_LLC,
                                  ...
                                  DRV_CFP_QUAL_UDF2,
                                  DRV_CFP_QUAL_INVALID};
static int s3_qset[] = { DRV_CFP_QUAL_SRC_PORT,
                                  DRV_CFP_QUAL_1QTAG,
                                  DRV_CFP_QUAL_SPTAG,
                                  DRV_CFP_QUAL_8023_OR_EII,
                                  DRV_CFP_QUAL_8022_LLC,
                                  ...
                                  DRV_CFP_QUAL_UDF3C,
                                  DRV_CFP_QUAL_INVALID};
static int s4_qset[] = { DRV_CFP_QUAL_SRC_PORT,
                                  DRV_CFP_QUAL_1QTAG,
                                  DRV_CFP_QUAL_SPTAG,
                                  DRV_CFP_QUAL_8023_OR_EII,
                                  DRV_CFP_QUAL_8022_LLC,
 ...
 */
int
_drv_cfp_field_mapping(int unit, uint32 field_type, uint32 *field_id)
{
    int rv = SOC_E_NONE;
    ...
    switch (field_type) {
        ...
        case DRV_CFP_FIELD_TCP_FLAG:
            *field_id = TCP_FLAGf;
            break;
        case DRV_CFP_FIELD_UDF2_VALID:
            *field_id = UDF2_VLDf;
            break;
         case DRV_CFP_FIELD_UDF2:
            *field_id = UDF2f;
            break;
        ...
        case DRV_CFP_FIELD_IP_TTL:
            *field_id = IP_TTLf;
            break;
        case DRV_CFP_FIELD_UDF3A_VALID:
            *field_id = UDF3A_VLDf;
            break;
        case DRV_CFP_FIELD_UDF3A:
            *field_id = UDF3Af;
            break;
        case DRV_CFP_FIELD_UDF3B_VALID:
            *field_id = UDF3B_VLDf;
            break;
        case DRV_CFP_FIELD_UDF3B:
            *field_id = UDF3Bf;
            break;
        case DRV_CFP_FIELD_UDF3C_VALID:
            *field_id = UDF3C_VLDf;
            break;
        case DRV_CFP_FIELD_UDF3C:
            *field_id = UDF3Cf;
            break;
 ...
 */
void
_drv_cfp_meter_rate2chip(int unit, uint32 kbits_sec, uint32 *chip_val)
{
 ...
 */
void
_drv_cfp_meter_chip2rate(int unit, uint32 *kbits_sec, uint32 chip_val)
{
    if (chip_val > 127) {
 ...
 */
void
_drv_cfp_meter_burst2chip(int unit, uint32 kbits_burst, uint32 *chip_val)
{
    uint32  burst;
    int i;
    
    burst = CFP_5348_METER_BURST_MAX;
    for (i = 0; i < 12; i++) {
 ...
 */
void
_drv_cfp_meter_chip2burst(int unit, uint32 *kbits_burst, uint32 chip_val)
{
    uint32 burst = CFP_5348_METER_BURST_MAX;
    int i;
 ...
 */
int
_drv_cfp_read(int unit, uint32 ram_type, uint32 index, drv_cfp_entry_t *entry)
{
    int i, rv = SOC_E_NONE;
    uint32  mem_id  = 0;
    int ram_val, retry;
    ...
    switch (ram_type) {
        case DRV_CFP_RAM_ACT:
            mem_id = CFP_ACT_POLm;
            ram_val = CFP_5348_RAM_SEL_ACT;
            break;
        case DRV_CFP_RAM_METER:
            mem_id = CFP_METERm;
            ram_val = CFP_5348_RAM_SEL_METER;
            break;
        case DRV_CFP_RAM_TCAM:
            assert(entry->tcam_mask);
            mem_id = CFP_TCAM_S0m;
            ram_val = CFP_5348_RAM_SEL_TCAM;
            break;
        default:
            rv = SOC_E_PARAM;
            return rv;
 ...
 */
int
_drv_cfp_stat_read(int unit, uint32 counter_type, uint32 index, uint32 *counter)
{
    int rv = SOC_E_NONE;
    uint32  mem_id  = 0;
    int ram_val, retry;
    ...
    switch (counter_type) {
        case DRV_CFP_RAM_STAT_IB:
            mem_id = CFP_STAT_IBm;
            ram_val = CFP_5348_RAM_SEL_IB_STAT;
            break;
        case DRV_CFP_RAM_STAT_OB:
            mem_id = CFP_STAT_OBm;
            ram_val = CFP_5348_RAM_SEL_OB_STAT;
            break;
        default:
            rv = SOC_E_PARAM;
            return rv;
 ...
 */
int
_drv_cfp_stat_write(int unit, uint32 counter_type, uint32 index, uint32 counter)
{
    int rv = SOC_E_NONE;
    uint32  mem_id  = 0;
    int ram_val, retry;
 ...
 */
int
_drv_cfp_tcam_search(int unit, uint32 flags, uint32* index, 
            drv_cfp_entry_t *entry)
{
    ...
    if (flags & DRV_CFP_SEARCH_START) {
        /* Set search op code */
        fld_val = CFP_5348_OP_SEARCH;
        (DRV_SERVICES(unit)->reg_field_set)
            (unit, CFP_ACCr, &reg_val, OP_SELf, &fld_val);
        /* Set TCAM */
        fld_val = CFP_5348_RAM_SEL_TCAM;
        (DRV_SERVICES(unit)->reg_field_set)
            (unit, CFP_ACCr, &reg_val, RAM_SELf, &fld_val);
 ...
 */
int
_drv_cfp_write(int unit, uint32 ram_type, uint32 index, drv_cfp_entry_t *entry)
{
    int i, rv = SOC_E_NONE;
    uint32  mem_id = 0;
    int ram_val, retry;
 ...
 */
int 
drv5348_cfp_init(int unit)
{
    uint32 reg_addr, reg_val;
    int retval, port, reg_len;
    pbmp_t pbm;
    
    /* Set Unlock Key */
    reg_addr = (DRV_SERVICES(unit)->reg_addr)(unit, CFP_UNLCKr, 0, 0);
    reg_len = (DRV_SERVICES(unit)->reg_length_get)(unit, CFP_UNLCKr);
    reg_val = soc_property_get(unit, spn_BCM_FIELD_KEY_PATTERN, 
            CFP_5348_KEY_PATTERN);
    if ((retval = (DRV_SERVICES(unit)->reg_write)
            (unit, reg_addr, &reg_val, reg_len)) < 0) {
            return retval;
    }
...
/*
 * Function: drv5348_cfp_action_get
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_action_get(int unit, uint32* action, 
    ...
    switch (*action) {
        ...
        case DRV_CFP_ACT_IB_COSQ_CANCEL:
            ...
            if (fld_val) {
                ...
                *action = DRV_CFP_ACT_IB_COSQ_NEW;
                *act_param = fld_val;
            } else {
        ...
        case DRV_CFP_ACT_IB_MOD_INT_PRI_CANCEL:
            ...
            if (fld_val) {
                ...
                *action = DRV_CFP_ACT_IB_MOD_INT_PRI;
                /* 
                  * Priority to queue mapping is many to one.
                  * Here cos queue to priority will return the lowest priority.
                  */
                for (i=0; i < 8; i++) {
            ...
            if (!fld_val) {
                *action = DRV_CFP_ACT_IB_NONE;
                ...
                if (fld_val) {
                    ...
                    *act_param = fld_val;
                    /* Physical port 0 is port 24 on BCM5347 */  
                    if (SOC_IS_ROBO5347(unit)) {
                        *act_param -= 24;
                    }
                } else {
                    (DRV_SERVICES(unit)->cfp_field_get)(unit, DRV_CFP_RAM_ACT, 
                        DRV_CFP_FIELD_NEW_DEST_IB, entry, &fld_val);
                    if (fld_val == CFP_5348_DEST_FLOOD) {
                        *action = DRV_CFP_ACT_IB_FLOOD;
                    } else if (fld_val == CFP_5348_DEST_DROP) {
        ...
        case DRV_CFP_ACT_OB_COSQ_CANCEL:
            ...
            if (fld_val) {
                ...
                *action = DRV_CFP_ACT_OB_COSQ_NEW;
                *act_param = fld_val;
            } else {
...
/*
 * Function: drv5348_cfp_action_set
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_action_set(int unit, uint32 action, 
    ...
    switch (action) {
        ...
        case DRV_CFP_ACT_IB_MOD_INT_PRI:
            ...
            (DRV_SERVICES(unit)->cfp_field_set)(unit, DRV_CFP_RAM_ACT, 
                DRV_CFP_FIELD_MOD_PRI_EN_IB, entry, &fld_val);
            /* 
              * act_param1 represent priority. 
              * Here we need to get the corresponding mapping cos queue.
              */            
            SOC_IF_ERROR_RETURN((DRV_SERVICES(unit)->queue_prio_get)
                (unit, -1, act_param1, &cos_val));
            fld_val = (uint32) cos_val;
            (DRV_SERVICES(unit)->cfp_field_set)(unit, DRV_CFP_RAM_ACT, 
                DRV_CFP_FIELD_MOD_PRI_MAP_IB, entry, &fld_val);
            break;
        case DRV_CFP_ACT_IB_COSQ_CANCEL:
...
/*
 * Function: drv5348_cfp_control_get
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_control_get(int unit, uint32 control_type, uint32 param1, 
            uint32 *param2)
{
    int rv = SOC_E_NONE;
    ...
    switch (control_type) {
        case DRV_CFP_ENABLE:
            ...
            (DRV_SERVICES(unit)->reg_field_get)
                (unit, CFP_GLOBAL_CTLr, (uint32 *)&reg_64, 
                EN_CFP_MAPf, (uint32 *)&fld_64);
        ...
        case DRV_CFP_LLC_ENCAP:
            reg_addr = (DRV_SERVICES(unit)->reg_addr)
                (unit, IEEE_802_2_LLCr, 0, 0);
            reg_len = (DRV_SERVICES(unit)->reg_length_get)
                (unit, IEEE_802_2_LLCr);
            if ((rv = (DRV_SERVICES(unit)->reg_read)
                (unit, reg_addr, (uint32 *)&reg_val, reg_len)) < 0) {
                return rv;
            }
            *param2 = 0; 
            (DRV_SERVICES(unit)->reg_field_get)
                (unit, IEEE_802_2_LLCr, (uint32 *)&reg_val, CTRLf, &fld_32);
            *param2 += fld_32;
            (DRV_SERVICES(unit)->reg_field_get)
                (unit, IEEE_802_2_LLCr, (uint32 *)&reg_val, CTRLf, &fld_32);
            *param2 += (fld_32 << 8);
...
/*
 * Function: drv5348_cfp_control_set
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_control_set(int unit, uint32 control_type, uint32 param1, 
            uint32 param2)
{
    int rv = SOC_E_NONE;
    ...
    switch (control_type) {
        ...
        case DRV_CFP_LLC_ENCAP:
            ...
            (DRV_SERVICES(unit)->reg_field_set)
                (unit, IEEE_802_2_LLCr, (uint32 *)&reg_val, SSAPf, &fld_32);
            fld_32 = (param2 >> 16) & 0xff; 
            (DRV_SERVICES(unit)->reg_field_set)
                (unit, IEEE_802_2_LLCr, (uint32 *)&reg_val, DSAPf, &fld_32);
            if ((rv = (DRV_SERVICES(unit)->reg_write)
                (unit, reg_addr, (uint32 *)&reg_val, reg_len)) < 0) {
                return rv;
            }
...
/*
 * Function: drv5348_cfp_entry_read
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_entry_read(int unit, uint32 index, uint32 ram_type, 
            drv_cfp_entry_t *entry)
{
    int rv = SOC_E_NONE;
    ...
    switch (ram_type) {
        case DRV_CFP_RAM_ALL:
            if ((rv = _drv_cfp_read(unit, DRV_CFP_RAM_TCAM, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
"drv_cfp_entry_read : failed to read TCAM with index = 0x%x, rv = %d. \n", 
            ...
            if ( (rv = _drv_cfp_read(unit, DRV_CFP_RAM_ACT, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
"drv_cfp_entry_read : failed to read action ram with index = 0x%x, rv = %d. \n",
            ...
            if ((rv = _drv_cfp_read(unit, DRV_CFP_RAM_METER, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
...
/*
 * Function: drv5348_cfp_entry_search
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_entry_search(int unit, uint32 flags, uint32 *index, 
            drv_cfp_entry_t *entry)
{
    int rv = SOC_E_NONE;

    if ((rv = _drv_cfp_tcam_search(unit, flags, 
...
/*
 * Function: drv5348_cfp_entry_write
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_entry_write(int unit, uint32 index, uint32 ram_type, 
            drv_cfp_entry_t *entry)
{
    int rv = SOC_E_NONE;
    ...
    switch (ram_type) {
        case DRV_CFP_RAM_ALL:
            if ((rv = _drv_cfp_write(unit, DRV_CFP_RAM_TCAM, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
    "drv_cfp_entry_write : failed to write TCAM with index = 0x%x, rv = %d. \n",
            ...
            if ((rv = _drv_cfp_write(unit, DRV_CFP_RAM_ACT, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
"drv_cfp_entry_write:failed to write action ram with index = 0x%x, rv = %d. \n",
            ...
            if ((rv = _drv_cfp_write(unit, DRV_CFP_RAM_METER, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
...
/*
 * Function: drv5348_cfp_field_get
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_field_get(int unit, uint32 mem_type, uint32 field_type, 
            drv_cfp_entry_t* entry, uint32* fld_val)
{
    ...
    if (( rv = _drv_cfp_field_mapping(unit, field_type, &fld_id)) < 0) {
        soc_cm_debug(DK_ERR,
    ...
    if ((SOC_IS_ROBO5347(unit)) && (fld_id == SRC_Pf)) {
...
/*
 * Function: drv5348_cfp_field_set
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_field_set(int unit, uint32 mem_type, uint32 field_type, 
            drv_cfp_entry_t* entry, uint32* fld_val)
{
    int rv = SOC_E_NONE;
    int mem_id;
...
/*
 * Function: drv5348_cfp_meter_get
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_meter_get(int unit, drv_cfp_entry_t* entry, uint32 *kbits_sec, 
            uint32 *kbits_burst)    
{
    int rv = SOC_E_NONE;
    uint32  fld_val;
    ...
    if (fld_val) {
        ...
        _drv_cfp_meter_chip2rate(unit, kbits_sec, fld_val);
    } else {
        *kbits_sec = 0;
    }
    ...
    _drv_cfp_meter_chip2burst(unit, kbits_burst, fld_val);

    return rv;
}

/*
 * Function: drv5348_cfp_meter_set
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_meter_set(int unit, drv_cfp_entry_t* entry, uint32 kbits_sec, 
            uint32 kbits_burst)
{
    int rv = SOC_E_NONE;
    uint32  fld_val;
    ...
    assert(entry);
    if (kbits_sec) {
        if ((kbits_sec > CFP_5348_METER_RATE_MAX) ||
            (kbits_sec < CFP_5348_METER_RATE_MIN)) {
            soc_cm_debug(DK_ERR, 
                "drv_cfp_meter_set : rate unsupported. \n");
            rv = SOC_E_UNAVAIL;
            return rv;
        }
        _drv_cfp_meter_rate2chip(unit, kbits_sec, &fld_val);
    ...
    if (kbits_burst) {
        if ((kbits_burst > CFP_5348_METER_BURST_MAX) ||
            (kbits_burst < CFP_5348_METER_BURST_MIN)) {
            soc_cm_debug(DK_ERR, 
                "drv_cfp_meter_set : burst size unsupported. \n");
            rv = SOC_E_UNAVAIL;
            return rv;
        }
        _drv_cfp_meter_burst2chip(unit, kbits_burst, &fld_val);
        (DRV_SERVICES(unit)->cfp_field_set)(unit, DRV_CFP_RAM_METER, 
                DRV_CFP_FIELD_REF_CAP, entry, &fld_val);
    } else {
        _drv_cfp_meter_burst2chip(unit, CFP_5348_METER_BURST_MIN, &fld_val);
        (DRV_SERVICES(unit)->cfp_field_set)(unit, DRV_CFP_RAM_METER, 
                DRV_CFP_FIELD_REF_CAP, entry, &fld_val);
    }
    return rv;
...
int
drv5348_cfp_meter_rate_transform(int unit, uint32 kbits_sec, uint32 kbits_burst, 
                uint32 *bucket_size, uint32 * ref_cnt, uint32 *ref_unit)
{
    ...
    if (kbits_sec) {
        ...
        if ((kbits_sec > CFP_5348_METER_RATE_MAX) ||
            (kbits_sec < CFP_5348_METER_RATE_MIN)) {
            soc_cm_debug(DK_ERR, 
                "drv5348_cfp_meter_rate_transform : rate unsupported. \n");
            rv = SOC_E_UNAVAIL;
            return rv;
        }
        _drv_cfp_meter_rate2chip(unit, kbits_sec, ref_cnt);
    } else {
        *ref_cnt = 0;
    }
    ...
    if (kbits_burst) {
        ...
        if ((kbits_burst > CFP_5348_METER_BURST_MAX) ||
            (kbits_burst < CFP_5348_METER_BURST_MIN)) {
            soc_cm_debug(DK_ERR, 
                "drv5348_cfp_meter_rate_transform : burst size unsupported. \n");
            rv = SOC_E_UNAVAIL;
            return rv;
        }
        
        _drv_cfp_meter_burst2chip(unit, kbits_burst, bucket_size);
    } else {
        *bucket_size = 0;
    }
 ...
 */
int
drv5348_cfp_qset_get(int unit, uint32 qual, drv_cfp_entry_t *entry, uint32 *val)
{
    int rv = SOC_E_NONE;
    uint32  wp, bp;
 ...
 */
int
drv5348_cfp_qset_set(int unit, uint32 qual, drv_cfp_entry_t *entry, uint32 val)
{
    int rv = SOC_E_NONE;
    uint32  wp, bp, temp = 0;
...
/*
 * Function: drv5348_cfp_slice_id_select
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_slice_id_select(int unit, drv_cfp_entry_t *entry, uint32 *slice_id, uint32 flags)
{
    uint32 i;
    int match;
...
/*
 * Function: drv5348_cfp_slice_to_qset
 *
 * Purpose:
 ...
 */
int
drv5348_cfp_slice_to_qset(int unit, uint32 slice_id, drv_cfp_entry_t *entry)
{
    uint32 i;
    uint32  slice[(DRV_CFP_QUAL_COUNT / 32) + 1];
    int     *qset;
 ...
 */
int
drv5348_cfp_stat_get(int unit, uint32 stat_type, uint32 index, uint32* counter)
{
    int rv = SOC_E_NONE;
   ...
   index_max = soc_robo_mem_index_max(unit, CFP_STAT_IBm);
    ...
    switch (stat_type) {
        case DRV_CFP_STAT_INBAND:
            _drv_cfp_stat_read(unit, DRV_CFP_RAM_STAT_IB, index, 
                counter);
            break;
        case DRV_CFP_STAT_OUTBAND:
            _drv_cfp_stat_read(unit, DRV_CFP_RAM_STAT_OB, index, 
                counter);
            break;
 ...
 */
int
drv5348_cfp_stat_set(int unit, uint32 stat_type, uint32 index, uint32 counter)
{
    int rv = SOC_E_NONE;
    uint32  index_max;
   ...
   index_max = soc_robo_mem_index_max(unit, CFP_STAT_IBm);
    ...
    switch (stat_type) {
        case DRV_CFP_STAT_INBAND:
            _drv_cfp_stat_write(unit, DRV_CFP_RAM_STAT_IB, index, 
                counter);
            break;
        case DRV_CFP_STAT_OUTBAND:
            _drv_cfp_stat_write(unit, DRV_CFP_RAM_STAT_OB, index, 
                counter);
            break;
        case DRV_CFP_STAT_ALL:
            _drv_cfp_stat_write(unit, DRV_CFP_RAM_STAT_IB, index, 
 ...
 */
int 
drv5348_cfp_udf_get(int unit, uint32 port, uint32 udf_index, 
    uint32 *offset, uint32 *base)
{
    ...
    if (udf_index >=  CFP_5348_UDF_NUM_MAX) {
        return SOC_E_CONFIG;
    }
    ...
    switch (udf_index) {
        case 0 :
            ...
            break;
        case 1 :
            reg_index = UDF_OFFSET2_Pr;
            fld_index = UDF_OFFSETf;
            break;
        case 2 :
            reg_index = UDF_OFFSET3_Pr;
            fld_index = OFFSET_Af;
            break;
        case 3 :
            reg_index = UDF_OFFSET3_Pr;
 ...
 */
int 
drv5348_cfp_udf_set(int unit, uint32 port, uint32 udf_index, 
    uint32 offset, uint32 base)
{
    int rv = SOC_E_NONE;
    uint32  reg_index, fld_index, reg_addr, reg_len, temp;
    ...
    if (offset > CFP_5348_UDF_OFFSET_MAX) {
        return SOC_E_CONFIG;
    }
 ...
 */
int 
drv5348_cfp_ranger(int unit, uint32 flags, uint32 min, uint32 max)
{
    int rv = SOC_E_NONE;
...
/*
 * Function: drv5348_cfp_range_set
 *
 * Purpose:
 *     Check ranger type and parameters.
 *
 ...
 */
int 
drv5348_cfp_range_set(int unit, uint32 type, uint32 id, uint32 param1, uint32 param2)
{
    /* 
     * BCM5348/47 doesn't support range check by setting register.
     */
    return SOC_E_UNAVAIL;
}

/*
 * Function: drv5348_cfp_range_get
 *
 * Purpose:
 ...
 */
int 
drv5348_cfp_range_get(int unit, uint32 type, uint32 id, uint32 *param1, uint32 *param2)
{
    /* 
     * BCM5348/47 doesn't support range check by setting register.
     */
