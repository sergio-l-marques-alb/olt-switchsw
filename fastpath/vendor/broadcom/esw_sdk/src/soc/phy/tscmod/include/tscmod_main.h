/*----------------------------------------------------------------------
 * $Id: tscmod_main.h 1.43.2.2 Broadcom SDK $
...
#define TSCMOD_CTRL_TYPE_DEFAULT   0x378a0000
#define TSCMOD_CTRL_TYPE_MASK          0xffff
...
#define TSCMOD_CTRL_TYPE_CL72_ON        0x100
#define TSCMOD_CTRL_TYPE_UC_STALL       0x200
#define TSCMOD_CTRL_TYPE_CL72_TR_DIS    0x400
#define TSCMOD_CTRL_TYPE_CL72_DP0_DIS   0x800
#define TSCMOD_CTRL_TYPE_CL72_DP1_DIS  0x1000
#define TSCMOD_CTRL_TYPE_LINK_DIS      0x2000
#define TSCMOD_CTRL_TYPE_ERR           0x8000
