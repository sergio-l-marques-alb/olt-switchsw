/*
 * $Id: tscmod_extra.h 1.22.2.1 Broadcom SDK $
...
/* TSCMOD_CL73_HPAM is the HP cl73 KR2 autoneg mode. In this mode
 * CL37, CL37BAM and CL73BAM is disabled. The autoneg is in software
 * controlled mode.
 */
#define TSCMOD_CL73_HPAM      3
#define TSCMOD_CL73_WO_BAM    2
#define TSCMOD_CL73_W_BAM     1
#define TSCMOD_CL73_DISABLE   0 
...
#define TSCMOD_IF_SR     (1 << SOC_PORT_IF_SR)
#define TSCMOD_IF_SR4    (1 << SOC_PORT_IF_SR4)
#define TSCMOD_IF_KR     (1 << SOC_PORT_IF_KR)
#define TSCMOD_IF_KR4    (1 << SOC_PORT_IF_KR4)
#define TSCMOD_IF_CR     (1 << SOC_PORT_IF_CR)
#define TSCMOD_IF_CR4    (1 << SOC_PORT_IF_CR4)
#define TSCMOD_IF_XFI    (1 << SOC_PORT_IF_XFI)
#define TSCMOD_IF_SFI    (1 << SOC_PORT_IF_SFI)
#define TSCMOD_IF_XLAUI  (1 << SOC_PORT_IF_XLAUI)
#define TSCMOD_IF_XGMII  (1 << SOC_PORT_IF_XGMII)
#define TSCMOD_IF_ILKN   (1 << SOC_PORT_IF_ILKN)
#define TSCMOD_40G_10G_INTF(_if)  ((_if) == SOC_PORT_IF_KR4 || (_if) == SOC_PORT_IF_XLAUI || \
                             (_if) == SOC_PORT_IF_CR4 || (_if) == SOC_PORT_IF_SR || \
                             (_if) == SOC_PORT_IF_KR || (_if) == SOC_PORT_IF_CR || \
                             (_if) == SOC_PORT_IF_XFI || (_if) == SOC_PORT_IF_SFI)

#define TSCMOD_40G_10G_INTF_ALL   (TSCMOD_IF_KR4 | TSCMOD_IF_XLAUI | TSCMOD_IF_CR4 | TSCMOD_IF_SR | \
                        TSCMOD_IF_KR | TSCMOD_IF_CR | TSCMOD_IF_XFI | TSCMOD_IF_SFI)

#define TSCMOD_UC_CTRL_XLAUI   0x3333
#define TSCMOD_UC_CTRL_SR4     0x1111
