...
/*
 * $Id: phy84728_int.h 1.7 Broadcom SDK $
...
#define  PMD_MISC_CTRLr_WAN_MODE     (1 << 0)
...
#define BSDK_RD_PHY84728_XGXSBLK0_MISCCONTROL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x4, 0x800e, (_val)) 
#define BSDK_WR_PHY84728_XGXSBLK0_MISCCONTROL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x4, 0x800e, (_val)) 
#define BSDK_MOD_PHY84728_XGXSBLK0_MISCCONTROL1r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x4, 0x800e,         \
                                     (_val), (_mask))
