/*
 * $Id: phyecd.c 1.1.2.5 Broadcom SDK $
...
0x0f00|((0xc0)&0xff),0x15,(0x4000)));l7->npairs = 4;l7->fuzz_len = 10;l7->
state = SOC_PORT_CABLE_STATE_OK;switch((l12[1]>>12)&0x000f){case 1:l7->
...
] = 0;break;}return SOC_E_NONE;}int phy_54380_ecd_cable_diag_init(int l1,
soc_port_t l2){phy_ctrl_t*l3;uint16 l4;l3 = EXT_PHY_SW_STATE(l1,l2);
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xc0)&0xff),0x15
,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xc7
)&0xff),0x15,(0xa01a)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xc8)&0xff),0x15,(0x0100)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xc9)&0xff),0x15,(0x00ef)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xCB)&0xff),0x15,(0xBFA5)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xCB)&0xff),0x15
,(0x0024)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xCB
)&0xff),0x15,(0x8080)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
...
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xcf)&0xff),0x15,(0x0000)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xcf)&0xff),0x15
,(0x3000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe0
)&0xff),0x15,(0x0E00)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xe1)&0xff),0x15,(0x0D0D)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe2)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe3)&0xff),0x15,(0x1000)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe4)&0xff),0x15
,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe7
)&0xff),0x15,(0x00a0)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xE0)&0xff),0x15,(0x0A00)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xE0)&0xff),0x15,(0x0A07)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xE0)&0xff),0x15,(0x7F00)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xE1)&0xff),0x15
,(0x0C0E)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xE1
)&0xff),0x15,(0x7F7F)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xE2)&0xff),0x15,(0x0004)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xE2)&0xff),0x15,(0x0006)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xE3)&0xff),0x15,(0x5000)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xE4)&0xff),0x15
,(0x00EC)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xef
)&0xff),0x15,(0x409f)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xcd)&0xff),0x15,(0x1000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xcd)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe0)&0xff),0x15,(0x0000)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe1)&0xff),0x15
,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe2
)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xe3)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe4)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe7)&0xff),0x15,(0x0000)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xef)&0xff),0x15
,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe0
)&0xff),0x15,(0x0400)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xe1)&0xff),0x15,(0x000C)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe2)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xef)&0xff),0x15,(0x8007)));
...
0x0f00|((0xe0)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe1)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe2)&0xff),0x15,(0x0000)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xef)&0xff),0x15
,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe1
)&0xff),0x15,(0x0103)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xe0)&0xff),0x15,(0x00e0)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe1)&0xff),0x15,(0x0501)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe2)&0xff),0x15,(0x0c06)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe3)&0xff),0x15
,(0x0E07)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xCD
)&0xff),0x15,(0x0324)));SOC_IF_ERROR_RETURN(phy_reg_ge_read((l1),(l3),0x00,
0x0f00|((0xc0)&0xff),0x15,(&l4)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(
l3),0x00,0x0f00|((0xc0)&0xff),0x15,(0x4000)));return SOC_E_NONE;}
