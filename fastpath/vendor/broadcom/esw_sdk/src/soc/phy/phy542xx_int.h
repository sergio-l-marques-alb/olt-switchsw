/*
 * $Id: phy542xx_int.h 1.5 Broadcom SDK $ 
...
#define PHY_BCM542XX_MII_AUX_REG             0x18       /* MII Auxiliary Control/Status Register */
 ...
 */
#define PHY_BCM542XX_MII_ANA_ASF             (1 << 0)/* Advertise Selector Field */
#define PHY_BCM542XX_MII_ANA_HD_10           (1 << 5)/* Half duplex 10Mb/s supported */
#define PHY_BCM542XX_MII_ANA_FD_10           (1 << 6)/* Full duplex 10Mb/s supported */
#define PHY_BCM542XX_MII_ANA_HD_100          (1 << 7)/* Half duplex 100Mb/s supported */
#define PHY_BCM542XX_MII_ANA_FD_100          (1 << 8)/* Full duplex 100Mb/s supported */
#define PHY_BCM542XX_MII_ANA_T4              (1 << 9)/* T4 */
#define PHY_BCM542XX_MII_ANA_PAUSE           (1 << 10)/* Pause supported */
#define PHY_BCM542XX_MII_ANA_ASYM_PAUSE      (1 << 11)/* Asymmetric pause supported */
#define PHY_BCM542XX_MII_ANA_RF              (1 << 13)/* Remote fault */
#define PHY_BCM542XX_MII_ANA_NP              (1 << 15)/* Next Page */
 ...
 */
#define PHY_BCM542XX_MII_GB_CTRL_MS_MAN      (1 << 12) /* Manual Master/Slave mode */
#define PHY_BCM542XX_MII_GB_CTRL_MS          (1 << 11) /* Master/Slave negotiation mode */
#define PHY_BCM542XX_MII_GB_CTRL_PT          (1 << 10) /* Port type */
#define PHY_BCM542XX_MII_GB_CTRL_ADV_1000FD  (1 << 9) /* Advertise 1000Base-T FD */
#define PHY_BCM542XX_MII_GB_CTRL_ADV_1000HD  (1 << 8) /* Advertise 1000Base-T HD */

/*
 * 1000Base-T Status Register
 */
#define PHY_BCM542XX_MII_GB_STAT_MS_FAULT    (1 << 15) /* Master/Slave Fault */
#define PHY_BCM542XX_MII_GB_STAT_MS          (1 << 14) /* Master/Slave, 1 == Master */
#define PHY_BCM542XX_MII_GB_STAT_LRS         (1 << 13) /* Local receiver status */
#define PHY_BCM542XX_MII_GB_STAT_RRS         (1 << 12) /* Remote receiver status */
#define PHY_BCM542XX_MII_GB_STAT_LP_1000FD   (1 << 11) /* Link partner 1000FD capable */
#define PHY_BCM542XX_MII_GB_STAT_LP_1000HD   (1 << 10) /* Link partner 1000HD capable */
#define PHY_BCM542XX_MII_GB_STAT_IDE         (0xff << 0) /* Idle error count */

/*
 * IEEE Extended Status Register
 */
#define PHY_BCM542XX_MII_ESR_1000_X_FD       (1 << 15) /* 1000Base-T FD capable */
#define PHY_BCM542XX_MII_ESR_1000_X_HD       (1 << 14) /* 1000Base-T HD capable */
#define PHY_BCM542XX_MII_ESR_1000_T_FD       (1 << 13) /* 1000Base-T FD capable */
#define PHY_BCM542XX_MII_ESR_1000_T_HD       (1 << 12) /* 1000Base-T FD capable */
 ...
 */
#define PHY_BCM542XX_MII_AUTO_DET_MED_2ND_SERDES  (1 << 9)
#define PHY_BCM542XX_MII_AUTO_DET_MED_EN          (1 << 0)


/*
 * Mode Control Register 
 */
#define PHY_MODE_CNTL_REG_CU_LINK       (1 << 7) /* Copper link */
#define PHY_MODE_CNTL_REG_SERDES_LINK   (1 << 6) /* Fiber, SGMII link */
#define PHY_MODE_CNTL_REG_CU_ENG_DET    (1 << 5) /* Copper energy detected */
#define PHY_MODE_CNTL_REG_FBER_SIG_DET  (1 << 4) /* Fiber signal detected */
#define PHY_MODE_CNTL_REG_MODE_SEL      (0x3 << 1) /* Fiber, SGMII link */
#define PHY_MODE_CNTL_REG_1000X_EN      (1 << 0)  /* Select 1000-X (fiber) registers Vs Copper regs*/
    
#define MODE_SEL_OPTION_COPPER_2_SGMII 0x0000
#define MODE_SEL_OPTION_FIBER_2_SGMII  0x0002
#define MODE_SEL_OPTION_SGMII_2_COPPER  0x0004
#define MODE_SEL_OPTION_GBIC            0x0006
 ...
 */
#define PHY_BCM542XX_MII_FORCE_AUTO_MDIX_MODE   (1 << 9)
#define PHY_BCM542XX_MII_BP_WIRESPEED_TIMER     (1 << 10)
#define PHY_BCM542XX_MII_WIRESPEED_EN           (1 << 4)


/* 
 * MII Broadcom Test Register(PHY_BCM542XX_MII_SHA_AUX_STAT2_REG)
 */
#define PHY_BCM542XX_MII_SHA_AUX_STAT2_LEN   (0x7 << 12) /* Enable Shadow registers */
...
int 
phy_bcm542xx_direct_reg_read(int unit, phy_ctrl_t *pc, uint16 reg_addr, uint16 *data);

int
phy_bcm542xx_direct_reg_write(int unit, phy_ctrl_t *pc, uint16 reg_addr, uint16 data);

int
phy_bcm542xx_direct_reg_modify(int unit, phy_ctrl_t *pc, uint16 reg_addr, uint16 data, uint16 mask);
...
#define PHY_BCM542XX_REG_1000X       1
#define PHY_BCM542XX_REG_QSGMII      2
...
#define PHY_BCM542XX_REG_MOD(_unit, _pc, _flags, _reg_bank, _reg_addr,      \
                                                             _val, _mask)    \
...
#define PHY_BCM542XX_CL45_REG_READ(_unit, _pc, _dev_addr, _reg_addr, _val) \
            phy_bcm542xx_cl45_reg_read((_unit), (_pc), (_dev_addr), \
                            (_reg_addr), (_val))
#define PHY_BCM542XX_CL45_REG_WRITE(_unit, _pc, \
                          _dev_addr, _reg_addr, _val) \
            phy_bcm542xx_cl45_reg_write((_unit), (_pc), (_dev_addr), \
                             (_reg_addr), (_val))
#define PHY_BCM542XX_CL45_REG_MODIFY(_unit, _pc,  _dev_addr, \
                           _reg_addr, _val, _mask) \
...
#define PHY_READ_BCM542XX_MII_CTRLr(_unit, _pc, _val)                      \
            PHY_BCM542XX_REG_RD((_unit), (_pc), 0x00, 0x0000, PHY_BCM542XX_MII_CTRL_REG, (_val)) 
#define PHY_WRITE_BCM542XX_MII_CTRLr(_unit, _pc, _val)                     \
            PHY_BCM542XX_REG_WR((_unit), (_pc), 0x00, 0x0000, PHY_BCM542XX_MII_CTRL_REG, (_val)) 
#define PHY_MODIFY_BCM542XX_MII_CTRLr(_unit, _pc, _val, _mask)             \
            PHY_BCM542XX_REG_MOD((_unit), (_pc), 0x00, 0x0000, PHY_BCM542XX_MII_CTRL_REG,         \
                               (_val), (_mask))
...
#define PHY_READ_BCM542XX_MII_ECRr(_unit, _pc, _val) \
            PHY_BCM542XX_REG_RD((_unit), (_pc), 0x00, 0x0000, PHY_BCM542XX_MII_ECR_REG, (_val)) 
#define PHY_WRITE_BCM542XX_MII_ECRr(_unit, _pc, _val) \
            PHY_BCM542XX_REG_WR((_unit), (_pc), 0x00, 0x0000, PHY_BCM542XX_MII_ECR_REG, (_val))
#define PHY_MODIFY_BCM542XX_MII_ECRr(_unit, _pc, _val, _mask) \
            PHY_BCM542XX_REG_MOD((_unit), (_pc), 0x00, 0x0000, PHY_BCM542XX_MII_ECR_REG, \
                             (_val), (_mask))
...
#define PHY_READ_BCM542XX_2ND_SERDES_CTRLr(_unit, _pc, _val) \
            PHY_BCM542XX_REG_RD((_unit), (_pc), 0x00, 0x0014, 0x1c, (_val))
#define PHY_WRITE_BCM542XX_2ND_SERDES_CTRLr(_unit, _pc, _val) \
            PHY_BCM542XX_REG_WR((_unit), (_pc), 0x00, 0x0014, 0x1c, (_val))
#define PHY_MODIFY_BCM542XX_2ND_SERDES_CTRLr(_unit, _pc, _val, _mask) \
...
#define PHY_MODIFY_BCM542XX__EEE_STAT_RX_DURATIONr(_unit, _pc, _val, _mask) \
            PHY_BCM542XX_REG_MOD((_unit), (_pc), 0x00, 0x0fabc, 0x15, (_val), (_mask))
...
#define PHY_BCM542XX_DEV_OAM_CONFIG_PTR(_pc) (&(((PHY_BCM542XX_DEV_DESC_t *)((_pc) + 1))->oam_config))
