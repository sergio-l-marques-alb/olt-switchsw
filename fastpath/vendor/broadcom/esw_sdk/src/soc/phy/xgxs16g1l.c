/*
 * $Id: xgxs16g1l.c 1.48 Broadcom SDK $
...
#ifdef XGXS16G_13G_REV_B0
#undef XGXS16G_13G_REV_B0
#define XGXS16G_13G_REV_B0(ut) (FALSE)
#endif
...
phy_xgxs16g1l_speed_set(int unit, soc_port_t port, int speed)
{
    ...
    uint16      sgmii_status, data16, temp16;
    uint16      speed_mii;
    int asymmetric_speed_mode = 0;
                                          ...
                                          uint32 value)
{
	...
	*/
        ...
        SOC_IF_ERROR_RETURN
            (WRITE_XGXS16G_SERDESDIGITAL_MISC1r(unit, pc, 0x7020));
