/*
 * $Id: bfcmap84756_a0.c 1.21 Broadcom SDK $
...
bfcmap84756_port_config_set(bfcmap_port_ctrl_t *mpc, bfcmap_port_config_t *pCfg)
{
    ...
    int maxfleng, buf_reserve, org_bbscn;
    ...
    bcm84756_a0_FCM_FCMAC_FRXB0r_FRXB_FREE_RXB_CNTf_SET(mpc, reg_frxb0,0x2000/buf_reserve);
    ...
    /* Set BB_SC_B to 0 first if it changes from one non-zero value to another non-zero value */
 ...
 */
STATIC int 
_phy_84756_fcmap_FC_firmware_is_downloaded(bfcmap_port_ctrl_t *mpc)   
{
    buint16_t      ver;
    
    BFCMAP_MDIO_READ(mpc->uc_dev_addr, BFCMAP_PORT_UC_DATA_REG14(mpc), &ver);
    if (ver)
        return 1;
    else
        return 0;
...
bfcmap84756_port_init(bfcmap_port_ctrl_t *mpc, bfcmap_port_config_t *pCfg)
{
    ...
    if (!_phy_84756_fcmap_FC_firmware_is_downloaded(mpc)) {
