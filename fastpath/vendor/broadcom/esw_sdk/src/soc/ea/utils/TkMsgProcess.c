/*
 * $Id: TkMsgProcess.c 1.1.2.4 Broadcom SDK $
...
#include <soc/ea/TkOsUtil.h>
#include <soc/ea/Ethernet.h>
#include <soc/ea/Oam.h>
#include <soc/ea/OamUtils.h>
#include <soc/ea/OamProcess.h>
#include <soc/ea/TkMsg.h>
#include <soc/ea/TkOamMem.h>
#include <soc/ea/TkInit.h>  /* FixMe */
#include <soc/ea/TkDebug.h>
...
TkDataProcessHandle(uint8 pathId, TkMsgBuff * pMsg, uint16 len)
{
    ...
    oamFlags = soc_ntohs(pOamFrame->Data.OamHead.flags);
    oamType = (oamFlags & 0x0300) >> 8;
