/*
 * $Id: feature.c 1.841.2.8 Broadcom SDK $
...
soc_features_bcm56150_a0(int unit, soc_feature_t feature)
{
    ...
    field_slice_size_128 = ((dev_id == BCM53344_DEVICE_ID) ||
                   (dev_id == BCM53346_DEVICE_ID));
    fp_stage_multi_stage = ((dev_id != BCM53344_DEVICE_ID) &&
                   (dev_id != BCM53346_DEVICE_ID));

    switch (feature) {
#ifndef _HURRICANE2_DEBUG
...
soc_features_bcm56640_a0(int unit, soc_feature_t feature)
{
    ...
    l3_reddefip = (dev_id == BCM56540_DEVICE_ID ||
                   ...
                   dev_id == BCM56545_DEVICE_ID ||
                   dev_id == BCM56546_DEVICE_ID);
    fp_stage_half_slice = fp_mp8 = l3_reddefip;
    ...
    case soc_feature_tr3_cmic_reserved_queues:
...
soc_features_bcm56850_a0(int unit, soc_feature_t feature)
{
    ...
    case soc_feature_td2_cmic_reserved_queues:
