/*
 * $Id: ism_hash_cfg.c 1.5 Broadcom SDK $
...
soc_hash_mem_set_t _soc_ism_shms[] = {
    { SOC_MEM_SET_VLAN_XLATE, &_soc_ism_shm[0], 2, NULL, 0, &_soc_ism_shk[0], 20, 0, 53 },
    { SOC_MEM_SET_L2_ENTRY, &_soc_ism_shm[2], 2, NULL, 0, &_soc_ism_shk[20], 11, 0, 68 },
    { SOC_MEM_SET_L3_ENTRY, &_soc_ism_shm[4], 3, NULL, 0, &_soc_ism_shk[31], 9, 0, 279 },
    { SOC_MEM_SET_EP_VLAN_XLATE, &_soc_ism_shm[7], 1, NULL, 0, &_soc_ism_shk[40], 4, 0, 43 },
    { SOC_MEM_SET_MPLS, &_soc_ism_shm[8], 2, NULL, 0, &_soc_ism_shk[44], 8, 0, 89 }
};
...
soc_hash_mem_view_t _soc_ism_shmv[] = {
    { SOC_MEM_VIEW_VLAN_XLATE_1_XLATE, { XLATE__KEYf, -1 }, 45, XLATE__HASH_LSBf, &_soc_ism_shm[0] },
    { SOC_MEM_VIEW_VLAN_XLATE_1_VLAN_MAC, { VLAN_MAC__KEYf, -1 }, 53, VLAN_MAC__HASH_LSBf, &_soc_ism_shm[0] },
    { SOC_MEM_VIEW_VLAN_XLATE_1_VIF, { VIF__KEYf, -1 }, 45, VIF__HASH_LSBf, &_soc_ism_shm[0] },
    { SOC_MEM_VIEW_VLAN_XLATE_2_XLATE, { XLATE__KEY_0f, -1 }, 45, XLATE__HASH_LSBf, &_soc_ism_shm[1] },
    { SOC_MEM_VIEW_VLAN_XLATE_2_MAC_IP_BIND, { MAC_IP_BIND__KEY_0f, -1 }, 37, MAC_IP_BIND__HASH_LSBf, &_soc_ism_shm[1] },
    { SOC_MEM_VIEW_L2_ENTRY_1_L2, { L2__KEYf, -1}, 66, L2__HASH_LSBf, &_soc_ism_shm[2] },
    { SOC_MEM_VIEW_L2_ENTRY_1_VLAN, { VLAN__KEYf, -1 }, 28, VLAN__HASH_LSBf, &_soc_ism_shm[2] },
    { SOC_MEM_VIEW_L2_ENTRY_1_VIF, { VIF__KEYf, -1 }, 31, VIF__HASH_LSBf, &_soc_ism_shm[2] },
    { SOC_MEM_VIEW_L2_ENTRY_1_TRILL_NONUC_NETWORK_LONG, { TRILL_NONUC_NETWORK_LONG__KEYf, -1 }, 68, TRILL_NONUC_NETWORK_LONG__HASH_LSBf, &_soc_ism_shm[2] },
    { SOC_MEM_VIEW_L2_ENTRY_1_TRILL_NONUC_NETWORK_SHORT, { TRILL_NONUC_NETWORK_SHORT__KEYf, -1 }, 20, TRILL_NONUC_NETWORK_SHORT__HASH_LSBf, &_soc_ism_shm[2] },
    { SOC_MEM_VIEW_L2_ENTRY_1_BFD, { BFD__KEYf, -1 }, 37, BFD__HASH_LSBf, &_soc_ism_shm[2] },
    { SOC_MEM_VIEW_L2_ENTRY_2_L2, { L2__KEY_0f, -1 }, 66, L2__HASH_LSBf, &_soc_ism_shm[3] },
    { SOC_MEM_VIEW_L3_ENTRY_1_IPV4UC, { IPV4UC__KEYf, -1 }, 49, IPV4UC__HASH_LSBf, &_soc_ism_shm[4] },
    { SOC_MEM_VIEW_L3_ENTRY_1_LMEP, { LMEP__KEYf, -1 }, 33, LMEP__HASH_LSBf, &_soc_ism_shm[4] },
    { SOC_MEM_VIEW_L3_ENTRY_1_RMEP, { RMEP__KEYf, -1 }, 52, RMEP__HASH_LSBf, &_soc_ism_shm[4] },
    { SOC_MEM_VIEW_L3_ENTRY_1_TRILL, { TRILL__KEYf, -1 }, 24, TRILL__HASH_LSBf, &_soc_ism_shm[4] },
    { SOC_MEM_VIEW_L3_ENTRY_2_IPV4UC, { IPV4UC__KEY_0f, -1, }, 49, IPV4UC__HASH_LSBf, &_soc_ism_shm[5] },
    { SOC_MEM_VIEW_L3_ENTRY_2_IPV4MC, { IPV4MC__KEY_0f, -1 }, 95, IPV4MC__HASH_LSBf, &_soc_ism_shm[5] },
    { SOC_MEM_VIEW_L3_ENTRY_2_IPV6UC, { IPV6UC__KEY_0f, IPV6UC__KEY_1f, -1 }, 145 /*81+64*/, IPV6UC__HASH_LSBf, &_soc_ism_shm[5] },
    { SOC_MEM_VIEW_L3_ENTRY_4_IPV6UC, { IPV6UC__KEY_0f, IPV6UC__KEY_1f, -1 }, 145 /*81+64*/, IPV6UC__HASH_LSBf, &_soc_ism_shm[6] },
    { SOC_MEM_VIEW_L3_ENTRY_4_IPV6MC, { IPV6MC__KEY_0f, IPV6MC__KEY_1f, IPV6MC__KEY_2f, IPV6MC__KEY_3f, -1 }, 279 /*95+64+96+24*/, IPV6MC__HASH_LSBf, &_soc_ism_shm[6] },
    { SOC_MEM_VIEW_EP_VLAN_XLATE_1_XLATE, { XLATE__KEYf, -1 }, 43, XLATE__HASH_LSBf, &_soc_ism_shm[7] },
    { SOC_MEM_VIEW_EP_VLAN_XLATE_1_MIM_ISID, { MIM_ISID__KEYf, -1 }, 33, MIM_ISID__HASH_LSBf, &_soc_ism_shm[7] },
    { SOC_MEM_VIEW_MPLS_ENTRY_1_MPLS, { MPLS__KEYf, -1 }, 43, MPLS__HASH_LSBf, &_soc_ism_shm[8] },
    { SOC_MEM_VIEW_MPLS_ENTRY_2_MPLS, { MPLS__KEY_0f, -1 }, 41, MPLS__HASH_LSBf, &_soc_ism_shm[9] },
    { SOC_MEM_VIEW_MPLS_ENTRY_2_MIM_NVP, { MIM_NVP__KEY_0f, -1 }, 65, MIM_NVP__HASH_LSBf, &_soc_ism_shm[9] },
    { SOC_MEM_VIEW_MPLS_ENTRY_2_MIM_ISID, { MIM_ISID__KEY_0f, -1 }, 89, MIM_ISID__HASH_LSBf, &_soc_ism_shm[9] },
    { SOC_MEM_VIEW_MPLS_ENTRY_2_TRILL, { TRILL__KEY_0f, -1 }, 21, TRILL__HASH_LSBf, &_soc_ism_shm[9] }
};
...
soc_hash_key_t _soc_ism_shk[] = {
    ...
    { SOC_MEM_KEY_L2_ENTRY_1_TRILL_NONUC_NETWORK_LONG_TRILL_NONUC_NETWORK_LONG, &_soc_ism_shmv[8] },
    { SOC_MEM_KEY_L2_ENTRY_1_TRILL_NONUC_NETWORK_SHORT_TRILL_NONUC_NETWORK_SHORT, &_soc_ism_shmv[9] },
