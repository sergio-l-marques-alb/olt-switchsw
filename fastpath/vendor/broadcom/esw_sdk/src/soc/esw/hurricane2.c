/*
 * $Id: hurricane2.c 1.37.2.3 Broadcom SDK $
...
STATIC _soc_parity_info_t _soc_hu2_ip2_parity_info[] = {
    ...
    { PARITY_ENf, EGR_MASK_PAR_ERRf, "EGR_MASK table parity error",
      ...
      INVALIDr, INVALIDr },
    { PARITY_ENf, MODPORT_MAP_SW_PAR_ERRf, "EGR_MASK table parity error",
    ...
    { PARITY_ENf, MODPORT_MAP_EM_PAR_ERRf, "MODPORT_MAP_EM table parity error",
      ...
      INVALIDr, INVALIDr },
/* OAM_LM_COUNTERS_PAR_ERRf, "OAM_LM_COUNTERS table parity error.", */
    { INVALIDf, INVALIDf }, /* table terminator */
};
...
STATIC _soc_parity_info_t _soc_hu2_xlp_parity_info[] = {
    { TXFIFO_ECC_ENf, TXFIFO0_ERRf, "XQBOD_RXFIFO",
      INVALIDm, _SOC_PARITY_INFO_TYPE_SINGLE_ECC,
      XLPORT_ECC_CONTROLr,
      XLPORT_TXFIFO0_ECC_STATUSr, XLPORT_FORCE_SINGLE_BIT_ERRORr,
      INVALIDr, XLPORT_FORCE_DOUBLE_BIT_ERRORr },
    { BOD_ECC_ENABLEf, BOD_XLP0_ERRf, "XQBOD_RXFIFO",
      INVALIDm, _SOC_PARITY_INFO_TYPE_SINGLE_ECC,
      XLPORT_ECC_CONTROLr,
      XLPORT_BOD_XLP0_ECC_STATUSr, XLPORT_FORCE_SINGLE_BIT_ERRORr,
      INVALIDr, XLPORT_FORCE_DOUBLE_BIT_ERRORr },
    {  MIB_RSC1_MEM_EN_COR_ERR_RPTf, MIB_RSC1_MEM_ERRf, "XQBOD_RXFIFO",
      INVALIDm, _SOC_PARITY_INFO_TYPE_SINGLE_ECC,
      XLPORT_ECC_CONTROLr,
      XLPORT_MIB_RSC1_ECC_STATUSr, XLPORT_FORCE_SINGLE_BIT_ERRORr,
      INVALIDr, XLPORT_FORCE_DOUBLE_BIT_ERRORr },
    { MIB_RSC0_MEM_EN_COR_ERR_RPTf, MIB_RSC0_MEM_ERRf, "XQBOD_RXFIFO",
      INVALIDm, _SOC_PARITY_INFO_TYPE_SINGLE_ECC,
      XLPORT_ECC_CONTROLr,
      XLPORT_MIB_RSC0_ECC_STATUSr, XLPORT_FORCE_SINGLE_BIT_ERRORr,
      INVALIDr, XLPORT_FORCE_DOUBLE_BIT_ERRORr },
    { MIB_TSC1_MEM_EN_COR_ERR_RPTf, MIB_TSC1_MEM_ERRf, "XQBOD_RXFIFO",
      INVALIDm, _SOC_PARITY_INFO_TYPE_SINGLE_ECC,
      XLPORT_ECC_CONTROLr,
      XLPORT_MIB_TSC1_ECC_STATUSr, XLPORT_FORCE_SINGLE_BIT_ERRORr,
      INVALIDr, XLPORT_FORCE_DOUBLE_BIT_ERRORr },
    { MIB_TSC0_MEM_EN_COR_ERR_RPTf, MIB_TSC0_MEM_ERRf, "XQBOD_RXFIFO",
      INVALIDm, _SOC_PARITY_INFO_TYPE_SINGLE_ECC,
      XLPORT_ECC_CONTROLr,
      XLPORT_MIB_TSC0_ECC_STATUSr, XLPORT_FORCE_SINGLE_BIT_ERRORr,
      INVALIDr, XLPORT_FORCE_DOUBLE_BIT_ERRORr },
    { INVALIDf, INVALIDf }, /* table terminator */
};
...
STATIC int
_soc_hurricane2_process_mmu_parity_error(int unit, int group,
                                       soc_port_t block_port, int table,
                                       char *msg)
{
    _soc_parity_info_t *info;
...
_soc_hurricane2_process_parity_error(int unit)
{
    ...
    for (group = 0; _soc_hu2_parity_group_info[group].cpi_bit; group++) {
        ...
        SOC_BLOCK_ITER(unit, blk,
            ...
            SOC_IF_ERROR_RETURN(soc_reg32_get(unit, group_reg, block_port, 0, &group_status));
            ...
            for (table = 0; info[table].error_field != INVALIDf; table++) {
                ...
                case _SOC_PARITY_INFO_TYPE_MMU_PARITY:
                    SOC_IF_ERROR_RETURN
                        (_soc_hurricane2_process_mmu_parity_error(unit,
...
STATIC int
_soc_hurricane2_mem_nack_error_process(int unit, soc_mem_t mem, int copyno)
{
    int group, table;
    _soc_parity_info_t *info;
    soc_port_t block_port;
...
STATIC int
_soc_hurricane2_mem_ecc_force(int unit, soc_port_t block_port,
                            _soc_parity_info_t *info)
{
...
int
_soc_hurricane2_mem_nack_error_test(int unit)
{
            ...
            for (table = 0; info[table].error_field != INVALIDf; table++) {
                ...
                case _SOC_PARITY_INFO_TYPE_SINGLE_ECC:
                    if (block_port != REG_PORT_ANY) {
                        ...
                        SOC_IF_ERROR_RETURN
                            (_soc_hurricane2_mem_ecc_force(unit, block_port,
                                                         &(info[table])));
                    }
                    par_ecc_field = ECCf;
                    break;
                ...
                if ((rv = soc_mem_read(unit, mem, blk, index, tmp_entry)) < 0) {
                    if (rv == SOC_E_FAIL) {
                        soc_cm_debug(DK_ERR,
                                     ...
                                     unit, SOC_MEM_NAME(unit, mem), index);
                        if ((rv = _soc_hurricane2_mem_nack_error_process(unit,
                                                                       mem, blk)) < 0) {
                            soc_cm_debug(DK_ERR,
...
static int _hu2_port_config_id = -1;
...
soc_hu2_init_port_mapping(int unit)
{
    ...
    for (port = 0; port < num_port; port++) {
        ...
        rval = 0;
        soc_reg_field_set(unit, LOG_TO_PHY_PORT_MAPPINGr, &rval, PHY_PORTf,
                          phy_port == -1 ? 0x3f : phy_port);
        /* This reg not valid for Logical Port 1... */
        if (port != 1) {
            SOC_IF_ERROR_RETURN
...
#define NUM_XLPORT 4
    ...
    if (soc_property_get(unit, spn_PARITY_ENABLE, TRUE)) {
        ...
        if (soc_property_get(unit, "parity_test", FALSE)) {
            _soc_hurricane2_mem_nack_error_test(unit);
        }
#endif
    }
...
/* Config Overrides for testing */
        switch (_hu2_port_config_id) {
            ...
            case 11:
                ...
                break;
            case 12:
                mode = (port == 26) ? SOC_HU2_PORT_MODE_QUAD : SOC_HU2_PORT_MODE_DUAL;
                si->port_num_lanes[port] = (port == 26) ?  4 : 2;
                break;
            case 13:
                mode = SOC_HU2_PORT_MODE_QUAD;
                break;
    ...
    soc_reg_field_set(unit, MEMFAILINTMASKr, &imask,
                     IPMCVALNXPORTPARITYERRORINTMASKf, 1);
    soc_reg_field_set(unit, MEMFAILINTMASKr, &imask,
                     IPMCVALNGPORTPARITYERRORINTMASKf, 1);
    soc_reg_field_set(unit, MEMFAILINTMASKr, &imask,
                     IPMCGROUP1PARITYERRORINTMASKf, 1);
    soc_reg_field_set(unit, MEMFAILINTMASKr, &imask,
                     IPMCGROUP0PARITYERRORINTMASKf, 1);
    soc_reg_field_set(unit, MEMFAILINTMASKr, &imask,
