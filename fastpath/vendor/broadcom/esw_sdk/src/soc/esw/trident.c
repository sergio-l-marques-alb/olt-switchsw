/*
 * $Id: trident.c 1.189.2.3 Broadcom SDK $
                     ...
                     void *d3, void *d4)
{
    ...
    int at = (reg_mem == _SOC_TD_SER_REG) ?
                        (address & 0xE00) >> 9 : (address & 0xE0000) >> 17;
    ...
    if (reg_mem == _SOC_TD_SER_MEM) {
        if ((rv = _soc_trident_mem_nack_error_process(unit, FALSE, reg_mem, nack_reg_mem, block, pipe)) < 0) {
            soc_cm_debug(DK_ERR,
        ...
        if ((rv = _soc_trident_mem_nack_error_process(unit, FALSE, reg_mem, nack_reg_mem, block, 0)) < 0) {
            soc_cm_debug(DK_ERR,
                         "unit %d pipe: 0 REG SCHAN NACK analysis failure.\n", unit);
        }
        if ((rv = _soc_trident_mem_nack_error_process(unit, FALSE, reg_mem, nack_reg_mem, block, 1)) < 0) {
            soc_cm_debug(DK_ERR,
...
soc_trident_stat_nack(int unit, int *fixed)
{
    ...
    nack_reg_mem.reg = -1;
    if ((rv = _soc_trident_mem_nack_error_process(unit, TRUE, 1, nack_reg_mem, 0, 0)) < 0) {
        soc_cm_debug(DK_ERR,
                     "unit %d pipe: 0 STAT SCHAN NACK analysis failure.\n", unit);
    }
    if ((rv = _soc_trident_mem_nack_error_process(unit, TRUE, 1, nack_reg_mem, 0, 1)) < 0) {
        soc_cm_debug(DK_ERR,
...
STATIC _soc_ser_parity_info_t _soc_td_ser_parity_info[] = {
    ...
    { FP_UDF_TCAMm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_3_PARITY_BITSf, 139, CMIC_SER_RANGE3_DATAENTRY_LENr, 0, 0, 0},
    { CPU_COS_MAPm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_4_PARITY_BITSf, 141, CMIC_SER_RANGE4_DATAENTRY_LENr, 0, 0, 0},
    { L2_USER_ENTRYm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_5_PARITY_BITSf, 123, CMIC_SER_RANGE5_DATAENTRY_LENr, 0, 0, 0},
    { L3_TUNNELm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_6_PARITY_BITSf, 211, CMIC_SER_RANGE6_DATAENTRY_LENr, 0, 0, 0},
    { VLAN_SUBNETm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_7_PARITY_BITSf, 129, CMIC_SER_RANGE7_DATAENTRY_LENr, 0, 0, 0},
    { MY_STATION_TCAMm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_8_PARITY_BITSf, 135, CMIC_SER_RANGE8_DATAENTRY_LENr, 0, 0, 0},
    { L3_DEFIPm, _SOC_SER_PARITY_MODE_2BITS,
      ...
      RANGE_9_PARITY_BITSf, 178, CMIC_SER_RANGE9_DATAENTRY_LENr, 0, 0, 0},
