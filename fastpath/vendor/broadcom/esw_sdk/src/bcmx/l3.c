/*
 * $Id: l3.c 1.79.56.1 Broadcom SDK $
...
int
bcmx_l3_age(uint32 flags, bcm_l3_age_cb age_out)
{
...
int
bcmx_l3_status(int *free_l3intf,
               int *free_l3,
               int *free_defip,
               int *free_lpm_blk)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_status(bcm_unit, free_l3intf, free_l3,
                           free_defip, free_lpm_blk);
...
/*
 * Function:
 *      bcmx_l3_untagged_update
 */

int
bcmx_l3_untagged_update(void)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_untagged_update(bcm_unit);
        BCM_IF_ERROR_RETURN(BCMX_L3_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/**************************************************************
 * bcmx_l3_interface_xxx (superseded by bcmx_l3_intf_xxx)
 **************************************************************/

/*
 * Function:
 *      bcmx_l3_interface_id_create
 */

int
bcmx_l3_interface_id_create(bcm_mac_t mac_addr,
                            bcm_vlan_t vid,
                            int intf_idx,
                            int add_to_arl)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_interface_id_create(bcm_unit, mac_addr, vid,
                                            intf_idx, add_to_arl);
        BCM_IF_ERROR_RETURN(BCMX_L3_SET_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *      bcmx_l3_interface_id_update
 */

int
bcmx_l3_interface_id_update(bcm_mac_t mac_addr,
                            bcm_vlan_t vid,
                            int intf_idx,
                            int add_to_arl)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_interface_id_update(bcm_unit, mac_addr, vid,
                                            intf_idx, add_to_arl);
        BCM_IF_ERROR_RETURN(BCMX_L3_SET_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *      bcmx_l3_interface_create
 */

int
bcmx_l3_interface_create(bcm_mac_t mac_addr,
                         bcm_vlan_t vid,
                         int add_to_arl)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_interface_create(bcm_unit, mac_addr, vid, add_to_arl);
        BCM_IF_ERROR_RETURN(BCMX_L3_SET_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *      bcmx_l3_interface_destroy
 */

int
bcmx_l3_interface_destroy(int interface)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_interface_destroy(bcm_unit, interface);
        BCM_IF_ERROR_RETURN(BCMX_L3_DELETE_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *     bcmx_l3_interface_lookup
 *
 */

int
bcmx_l3_interface_lookup(bcm_mac_t mac_addr,
                         bcm_vlan_t vid,
                         int *intf_id)
{
    int rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_interface_lookup(bcm_unit, mac_addr, vid, intf_id);
        if (BCMX_L3_GET_IS_VALID(bcm_unit, rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_l3_interface_find
 */

int
bcmx_l3_interface_find(int interface,
                       bcm_vlan_t *vid,
                       bcm_mac_t mac_addr)
{
    int rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_interface_find(bcm_unit, interface, vid, mac_addr);
        if (BCMX_L3_GET_IS_VALID(bcm_unit, rv)) {
            return rv;
        }
    }
...
/*
 * Function:
 *      bcmx_l3_interface_find_by_vlan
 */

int
bcmx_l3_interface_find_by_vlan(bcm_vlan_t vid,
                               int *interface)
{
    int rv;
    int i, bcm_unit;
    ...
    BCMX_PARAM_NULL_CHECK(interface);

    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_interface_find_by_vlan(bcm_unit, vid, interface);
        if (BCMX_L3_GET_IS_VALID(bcm_unit, rv)) {
            return rv;
        }
    }
...
/**************************************************************
 * bcmx_l3_ip_xxx (superseded by bcmx_l3_host_xxx)
 **************************************************************/
...
int
bcmx_l3_ip_find(bcmx_l3_host_t *info)
{
    return bcmx_l3_host_find(info);
}


/*
 * Function:
 *      bcmx_l3_ip_find_index
 */

int
bcmx_l3_ip_find_index(int index, bcmx_l3_host_t *info)
{
    int rv;
    int i, bcm_unit;
    bcm_l3_host_t bcm_l3;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_l3_ip_find_index(bcm_unit, index, &bcm_l3);
        if (BCMX_L3_GET_IS_VALID(bcm_unit, rv)) {
            if (BCM_SUCCESS(rv)) {
                rv = _bcmx_l3ip_from_bcm(info, &bcm_l3);
            }
            return rv;
        }
    }
...
int
bcmx_l3_ip_add(bcmx_l3_host_t *info)
{
    return bcmx_l3_host_add(info);
}
...
int
bcmx_l3_ip_delete(bcm_ip_t ip_addr)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_ip_delete(bcm_unit, ip_addr);
        BCM_IF_ERROR_RETURN(BCMX_L3_DELETE_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *      bcmx_l3_ip_delete_by_prefix
 */

int
bcmx_l3_ip_delete_by_prefix(bcm_ip_t ip_addr, bcm_ip_t mask)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_ip_delete_by_prefix(bcm_unit, ip_addr, mask);
        BCM_IF_ERROR_RETURN(BCMX_L3_DELETE_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *      bcmx_l3_ip_delete_by_interface
 */

int
bcmx_l3_ip_delete_by_interface(int intf)
{
    bcmx_l3_host_t info;

    BCMX_L3_INIT_CHECK;

    bcmx_l3_host_t_init(&info);
    info.l3a_intf = intf;
    return bcmx_l3_host_delete_by_interface(&info);
}


/*
 * Function:
 *      bcmx_l3_ip_delete_all
 */

int
bcmx_l3_ip_delete_all(void)
{
    bcmx_l3_host_t info;
    ...
    bcmx_l3_host_t_init(&info);
    return bcmx_l3_host_delete_all(&info);
}


/*
 * Function:
 *      bcmx_l3_conflict_get
 */

int
bcmx_l3_conflict_get(bcm_l3_key_t *ipkey,
                     bcm_l3_key_t *cf_array,
                     int cf_max,
                     int *cf_count)
{
    return bcmx_l3_host_conflict_get(ipkey, cf_array, cf_max, cf_count);
}

/*
 * Function:
 *      bcmx_l3_invalidate_entry
 *      bcmx_l3_validate_entry
 */

int
bcmx_l3_invalidate_entry(bcm_ip_t ip_addr)
{
    return bcmx_l3_host_invalidate_entry(ip_addr);
}

int
bcmx_l3_validate_entry(bcm_ip_t ip_addr)
{
    return bcmx_l3_host_validate_entry(ip_addr);
}

/*
 * Function:
 *     bcmx_l3_ip_update_entry_by_key
 *
 */

int
bcmx_l3_ip_update_entry_by_key(bcmx_l3_host_t *info)
{
    BCMX_PARAM_NULL_CHECK(info);
...
int
bcmx_l3_defip_add(bcmx_l3_route_t *info)
{
    return bcmx_l3_route_add(info);
}


/*
 * Function:
 *      bcmx_l3_defip_delete
 */

int
bcmx_l3_defip_delete(bcmx_l3_route_t *info)
{
    return bcmx_l3_route_delete(info);
}
...
int
bcmx_l3_defip_get(bcmx_l3_route_t *info)
{
    return bcmx_l3_route_get(info);
}


/*
 * Function:
 *      bcmx_l3_defip_delete_by_interface
 */

int
bcmx_l3_defip_delete_by_interface(int intf)
{
    bcmx_l3_route_t info;

    bcmx_l3_route_t_init(&info);
    info.l3a_intf = intf;

    return bcmx_l3_route_delete_by_interface(&info);
}


/*
 * Function:
 *      bcmx_l3_defip_delete_all
 */

int
bcmx_l3_defip_delete_all(void)
{
    bcmx_l3_route_t info;

    bcmx_l3_route_t_init(&info);

    return bcmx_l3_route_delete_all(&info);
}
...
int
bcmx_l3_defip_age(bcm_l3_route_traverse_cb age_out)
{
    return BCM_E_UNAVAIL;
}
...
/*
 * Function:
 *     bcmx_l3_defip_max_ecmp_get
 *
 */

int
bcmx_l3_defip_max_ecmp_get(int *max)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    int tmp_max;
    ...
    *max = 0;
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_defip_max_ecmp_get(bcm_unit, &tmp_max);
...
/*
 * Function:
 *     bcmx_l3_defip_max_ecmp_set
 *
 */

int
bcmx_l3_defip_max_ecmp_set(int max)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_l3_defip_max_ecmp_set(bcm_unit, max);
        BCM_IF_ERROR_RETURN(BCMX_L3_SET_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
 ...
 *      nstat     - Number of elements in stat array
 *      stat_arr  - Collected statistics descriptors array
 *      value_arr - Collected counters values to set
 * Returns:
 *      BCM_E_XXX
 * Notes:
 */
