 ...
 *
 * $Id: traverse_client.c 1.41 Broadcom SDK $
 ...
 * Generated:	Tue Feb  5 15:08:34 2013
 */
...
int
bcm_client_cosq_bst_stat_traverse(
	int	unit,
	bcm_gport_t	port,
	...
	void *	user_data)
{
	...
	int	r_rv;
	uint32	r_key[] = {
		0x0a5b81db,0x08a7706d,0xfec65d0f,0x3281dc37,0xac62e488 };
	bcm_gport_t	r_port;
	...
	if (BCM_SUCCESS(r_rv)) {
		...
		BCM_PACK_U32(r_req.tx_ptr, cosq);
		BCM_PACK_U32(r_req.tx_ptr, flags);
		...
		while (bcm_rlink_traverse_reply_get(unit, &r_req)) {
			...
			r_req.rx_ptr = _bcm_unpack_uint64(r_req.rx_ptr, &r_value);

			r_rv = cb(unit, r_port, r_cosq, r_flags, r_value, user_data);
	...
	void *	user_data)
{
	...
	uint32	r_key[] = {
		...
		0xacb66cf9,0x5b79d333,0x12dccc05,0xa7a39b44,0xf20e57a5
#else
		0xcda398e5,0x50353bb4,0xda38c3e0,0x291ee7e1,0x8a74cf80
	...
	void *	user_data)
{
	...
	uint32	r_key[] = {
#ifndef	BCM_RPC_PBMP_64
		0xfa0b0f65,0x89f95004,0xe094f644,0xd35fd02f,0xe4c29248
#else
		0xc63d5868,0xfc7b651a,0xf97ab768,0x8e94365b,0x61cb0957
#endif	/* BCM_RPC_PBMP_64 */
	};
	bcm_l2_addr_t	r_info;
	bcm_l2_addr_t *	r_p_info;
