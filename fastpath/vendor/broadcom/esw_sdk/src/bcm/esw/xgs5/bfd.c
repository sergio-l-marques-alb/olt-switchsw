/* 
 * $Id: bfd.c 1.14.8.1 Broadcom SDK $
 ...
 */
static _bcm_xgs5_bfd_hw_defs_t  *_bcm_xgs5_bfd_hw_defs[BCM_MAX_NUM_UNITS] = {0};

/* Maximum Memory Entry */
typedef uint32 max_mem_entry_t[SOC_MAX_MEM_WORDS];

#define BFD_HW(_u)                (_bcm_xgs5_bfd_hw_defs[(_u)])
#define BFD_HW_L2(_u)             (_bcm_xgs5_bfd_hw_defs[(_u)]->l2)
#define BFD_HW_L3_IPV4(_u)        (_bcm_xgs5_bfd_hw_defs[(_u)]->l3_ipv4)
#define BFD_HW_L3_IPV6(_u)        (_bcm_xgs5_bfd_hw_defs[(_u)]->l3_ipv6)
#define BFD_HW_L3_TUNNEL(_u)      (_bcm_xgs5_bfd_hw_defs[(_u)]->l3_tunnel)
#define BFD_HW_MPLS(_u)           (_bcm_xgs5_bfd_hw_defs[(_u)]->mpls)

#define BFD_HW_L2_MEM(_u)         (BFD_HW_L2((_u))->mem)
#define BFD_HW_L3_IPV4_MEM(_u)    (BFD_HW_L3_IPV4((_u))->mem)
#define BFD_HW_L3_IPV6_MEM(_u)    (BFD_HW_L3_IPV6((_u))->mem)
#define BFD_HW_L3_TUNNEL_MEM(_u)  (BFD_HW_L3_TUNNEL((_u))->mem)
#define BFD_HW_MPLS_MEM(_u)       (BFD_HW_MPLS((_u))->mem)
...
/* BFD Event Handler */
typedef struct _bcm_xgs5_event_handler_s {
    struct _bcm_xgs5_event_handler_s *next;
    bcm_bfd_event_types_t event_types;
    bcm_bfd_event_cb cb;
    void *user_data;
} _bcm_xgs5_event_handler_t;

/* BFD Endpoint Configuration SW Data Structure */
typedef struct _bcm_xgs5_bfd_endpoint_config_s {
    int endpoint_index;
...
} _bcm_xgs5_bfd_endpoint_config_t;

/* BFD Information SW Data Structure */
typedef struct _bcm_xgs5_bfd_info_s {
    ...
    _bcm_xgs5_bfd_endpoint_config_t *endpoints;  /* Array to Endpoints */
    ...
    _bcm_xgs5_event_handler_t *event_handler_list; /* List of event handlers */
    uint32 event_mask;                       /* Mask of all events */
} _bcm_xgs5_bfd_info_t;

static _bcm_xgs5_bfd_info_t *_bcm_xgs5_bfd_info[BCM_MAX_NUM_UNITS] = {0};

#define BFD_INFO(_u)                     (_bcm_xgs5_bfd_info[(_u)])
#define BFD_ENDPOINT_CONFIG(_u, _index)  \
    (&(BFD_INFO((_u))->endpoints[(_index)]))
...
#define BFD_INIT(_u)                                        \
    ((BFD_INFO(_u) != NULL) && (BFD_INFO(_u)->initialized))
...
#define FEATURE_CHECK(_u)                        \
    if (!soc_feature((_u), soc_feature_cmicm)) { \
        return BCM_E_UNAVAIL;                    \
    } 

/* Checks that BFD module has been initialized */
#define BFD_INIT_CHECK(_u)                                          \
    if ((BFD_INFO(_u) == NULL) || (!BFD_INFO(_u)->initialized)) {   \
        return BCM_E_INIT;                  \
    }

/* Checks that required feature(s) is available and BFD has been initialized */
#define BFD_FEATURE_INIT_CHECK(_u)              \
    do {                                        \
        FEATURE_CHECK(_u);                      \
        BFD_INIT_CHECK(_u);                     \
    } while (0)
...
#define ENDPOINT_INDEX_CHECK(_u, _index)                                \
    if ((_index) < 0 || (_index) >= BFD_INFO(_u)->endpoint_count) {     \
        return BCM_E_PARAM;                                             \
    }

/* Checks that SHA1 Authentication index is valid */
#define AUTH_SHA1_INDEX_CHECK(_u, _index)                               \
    if ((_index) >= BFD_INFO(_u)->num_auth_sha1_keys) { \
        return BCM_E_PARAM;                                             \
    }

/* Checks that Simple Password Authentication index is valid */
#define AUTH_SP_INDEX_CHECK(_u, _index)                                 \
    if ((_index) >= BFD_INFO(_u)->num_auth_sp_keys) {   \
        return BCM_E_PARAM;                                             \
    }
...
#define _BFD_UC_MSG_TIMEOUT_USECS             20000000 /* 20 secs */
#define _BFD_UC_MSG_TIMEOUT_USECS_QUICKTURN  300000000 /* 5 mins */

static sal_usecs_t _bfd_uc_msg_timeout_usecs = _BFD_UC_MSG_TIMEOUT_USECS;
...
#define _BFD_MPLS_MAX_LABELS    3   /* Max MPLS labels */
 ...
 */
STATIC void *
_bcm_xgs5_bfd_alloc_clear(unsigned int size, char *description)
{
    void *block = NULL;
 ...
 */
STATIC void
_bcm_xgs5_bfd_free_resource(int unit)
{
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);;

    if (_bcm_xgs5_bfd_info[unit] != NULL) {
        ...
        sal_free(_bcm_xgs5_bfd_info[unit]);
        _bcm_xgs5_bfd_info[unit] = NULL;
    }
...
STATIC int
_bcm_xgs5_bfd_alloc_resource(int unit, int num_sessions,
                             int num_auth_sha1_keys, int num_auth_sp_keys)
{
    _bcm_xgs5_bfd_info_t *bfd_info;

    if (_bcm_xgs5_bfd_info[unit] != NULL) {
        _bcm_xgs5_bfd_free_resource(unit);
    }

    /* Allocate memory for BFD Information Data Structure */
    if ((_bcm_xgs5_bfd_info[unit] =
         _bcm_xgs5_bfd_alloc_clear(sizeof(_bcm_xgs5_bfd_info_t),
                                   "BFD info")) == NULL) {
        return BCM_E_MEMORY;
    }
    ...
    if ((bfd_info->endpoints =
         _bcm_xgs5_bfd_alloc_clear(num_sessions *
                                   sizeof(_bcm_xgs5_bfd_endpoint_config_t),
                                   "BFD endpoints")) == NULL) {
        return BCM_E_MEMORY;
    }

    if ((bfd_info->endpoints_in_use =
         _bcm_xgs5_bfd_alloc_clear(SHR_BITALLOCSIZE(num_sessions),
    ...
    if (num_auth_sha1_keys > 0) {
        if ((bfd_info->auth_sha1 =
             _bcm_xgs5_bfd_alloc_clear(num_auth_sha1_keys *
    ...
    if (num_auth_sp_keys > 0) {
        if ((bfd_info->auth_sp =
             _bcm_xgs5_bfd_alloc_clear(num_auth_sp_keys *
...
/*
 * Function:
 *      _bcm_xgs5_bfd_event_unregister_all
 * Purpose:
 ...
 */
STATIC void
_bcm_xgs5_bfd_event_unregister_all(int unit)
{
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_event_handler_t *event_handler;
    _bcm_xgs5_event_handler_t *event_handler_to_delete;
 ...
 */
STATIC int
_bcm_xgs5_bfd_convert_uc_error(uint32 uc_rv)
{
    int rv = BCM_E_NONE;
...
/*
 * Function:
 *      _bcm_xgs5_bfd_msg_send_receive
 * Purpose:
 ...
 */
STATIC int
_bcm_xgs5_bfd_msg_send_receive(int unit, uint8 s_subclass,
                               ...
                               uint8 r_subclass, uint16 *r_len)
{
    ...
    rv     = _bcm_xgs5_bfd_convert_uc_error(uc_rv);
 ...
 */
STATIC int
_bcm_xgs5_bfd_event_mask_set(int unit)
{
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_event_handler_t *event_handler;
    uint32 event_mask = 0;
 ...
 */
STATIC void
_bcm_xgs5_bfd_callback_thread(int unit)
{
    int rv;
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_event_handler_t *event_handler;
    ...
    uint32 event_mask;
    int invoke = 0;
    soc_cm_debug(DK_VERBOSE, "BFD callback thread starting\n");
    ...
    soc_cm_debug(DK_VERBOSE, "BFD callback thread stopped\n");
    sal_thread_exit(0);
}

/*
 * Function:
 *      _bcm_xgs5_bfd_find_free_endpoint
 * Purpose:
 ...
 */
STATIC int
_bcm_xgs5_bfd_find_free_endpoint(SHR_BITDCL *endpoints_in_use,
                                 int endpoint_count)
{
    int endpoint_index;
...
/*
 * Function:
 *      _bcm_xgs5_bfd_find_ipv4_entry
 */
STATIC int
_bcm_xgs5_bfd_find_ipv4_entry(int unit, bcm_vrf_t vrf,
...
/*
 * Function:
 *      _bcm_xgs5_bfd_find_ipv6_entry
 */
STATIC int
_bcm_xgs5_bfd_find_ipv6_entry(int unit, bcm_vrf_t vrf,
...
STATIC int
_bcm_xgs5_bfd_l2_entry_set(int unit,
                           int endpoint_index,
                           ...
                           int int_pri, int cpu_qid)
{
    ...
    SOC_IF_ERROR_RETURN(soc_mem_insert(unit, BFD_HW_L2_MEM(unit),
                                       MEM_BLOCK_ANY, &l2_entry));
...
/*
 * Function:
 *      _bcm_xgs5_bfd_l2_entry_clear
 */
STATIC int
_bcm_xgs5_bfd_l2_entry_clear(int unit,
                             int mpls, int mpls_label, int your_discr)
{
...
/*
 * Function:
 *      _bcm_xgs5_bfd_l2x_entry_set
 */
STATIC int
_bcm_xgs5_bfd_l2x_entry_set(int unit,
                            _bcm_xgs5_bfd_endpoint_config_t *endpoint_config,
                            int mpls)
{
    ...
    return(_bcm_xgs5_bfd_l2_entry_set(unit,
...
/*
 * Function:
 *      _bcm_xgs5_bfd_l3_entry_set
 */
STATIC int
_bcm_xgs5_bfd_l3_entry_set(int unit,
                           bcm_bfd_endpoint_info_t *endpoint_info)
{
    int rv = BCM_E_NONE;
    int l3_index = 0;
    ...
    if (endpoint_info->flags & BCM_BFD_ENDPOINT_IPV6) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_find_ipv6_entry(unit,
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_find_ipv4_entry(unit,
                                           endpoint_info->vrf_id,
...
/*
 * Function:
 *      _bcm_xgs5_bfd_l3_entry_clear
 */
STATIC int
_bcm_xgs5_bfd_l3_entry_clear(int unit,
                             bcm_bfd_endpoint_info_t *endpoint_info)
{
    int rv = BCM_E_NONE;
    int l3_index = 0;
...
/*
 * Function:
 *      _bcm_xgs5_bfd_find_l3_tunnel_entry
 */
STATIC int
_bcm_xgs5_bfd_find_l3_tunnel_entry(int unit,
                                   bcm_bfd_endpoint_info_t *endpoint_info,
                                   soc_tunnel_term_t *tunnel_entry)
{
    ...
    if ((_ESW_BFD_DRV(unit) == NULL) ||
        (_ESW_BFD_DRV(unit)->l3_tnl_term_entry_init == NULL)) {
        return BCM_E_UNAVAIL;
    }
    BCM_IF_ERROR_RETURN
        (_ESW_BFD_DRV(unit)->l3_tnl_term_entry_init(unit, &tunnel, &key));
...
STATIC int
_bcm_xgs5_bfd_l3_tunnel_entry_set(int unit,
                                  bcm_bfd_endpoint_info_t *endpoint_info)
{
    soc_tunnel_term_t tunnel_entry;
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_find_l3_tunnel_entry(unit, endpoint_info,
                                            &tunnel_entry));
...
STATIC int
_bcm_xgs5_bfd_l3_tunnel_entry_clear(int unit,
                                    bcm_bfd_endpoint_info_t *endpoint_info)
{
    soc_tunnel_term_t tunnel_entry;
    uint32 *tunnel_entry_ptr;
...
/*
 * Function:
 *      _bcm_xgs5_bfd_mpls_entry_set
 */
STATIC int
_bcm_xgs5_bfd_mpls_entry_set(int unit,
                             _bcm_xgs5_bfd_endpoint_config_t *endpoint_config)
{
...
/*
 * Function:
 *      _bcm_xgs5_bfd_mpls_entry_clear
 */
STATIC int
_bcm_xgs5_bfd_mpls_entry_clear(int unit,
                               bcm_bfd_endpoint_info_t *endpoint_info)
{
#if defined(BCM_MPLS_SUPPORT)
    mpls_entry_entry_t mpls_entry;
 ...
 */
STATIC int
_bcm_xgs5_bfd_hw_init(int unit)
{
    int rv = BCM_E_NONE;
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    uint32 val;
     ...
     */
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_l2_entry_set(unit,
...
/*
 * Functions:
 *      _bcm_xgs5_bfd_<header/label>_pack
 * Purpose:
 ...
 */
STATIC uint8 *
_bcm_xgs5_bfd_udp_header_pack(uint8 *buffer, _udp_header_t *udp)
{
...
STATIC uint8 *
_bcm_xgs5_bfd_ipv4_header_pack(uint8 *buffer, _ipv4_header_t *ip)
{
    uint32  tmp;
...
STATIC uint8 *
_bcm_xgs5_bfd_ipv6_header_pack(uint8 *buffer, _ipv6_header_t *ip)
{
    uint32  tmp;
    int     i;
...
STATIC uint8 *
_bcm_xgs5_bfd_gre_header_pack(uint8 *buffer, _gre_header_t *gre)
{
    uint32  tmp;
...
STATIC uint8 *
_bcm_xgs5_bfd_ach_header_pack(uint8 *buffer, _ach_header_t *ach)
{
    uint32  tmp;
...
STATIC uint8 *
_bcm_xgs5_bfd_mpls_label_pack(uint8 *buffer, _mpls_label_t *mpls)
{
    uint32  tmp;
...
STATIC uint8 *
_bcm_xgs5_bfd_l2_header_pack(uint8 *buffer, _l2_header_t *l2)
{
    uint32  tmp;
    int     i;
...
STATIC uint8 *
_bcm_xgs5_bfd_hg_header_pack(uint8 *buffer, int unit,
                             _bcm_xgs5_bfd_endpoint_config_t *endpoint_config,
                             _l2_header_t *l2)
{
...
STATIC uint8 *
_bcm_xgs5_bfd_hg2_header_pack(uint8 *buffer, int unit,
                              _bcm_xgs5_bfd_endpoint_config_t *endpoint_config,
                              _l2_header_t *l2)
{
...
/*
 * Function:
 *      _bcm_xgs5_bfd_udp_checksum_set
 * Purpose:
 ...
 */
STATIC void
_bcm_xgs5_bfd_udp_checksum_set(int v6,
                               ...
                               _udp_header_t *udp)
{
    ...
    /* Add UDP header */
    cur_ptr = _bcm_xgs5_bfd_udp_header_pack(cur_ptr, udp);
...
/*
 * Functions:
 *      _bcm_xgs5_bfd_<header/label>_get
 * Purpose:
 ...
 */
STATIC int
_bcm_xgs5_bfd_udp_header_get(int unit, bcm_bfd_endpoint_info_t *endpoint_info,
...
STATIC int
_bcm_xgs5_bfd_ipv4_header_get(int data_length, uint8 protocol,
                              uint8 tos, uint8 ttl,
                              ...
                              _ipv4_header_t *ip)
{
    ...
    _bcm_xgs5_bfd_ipv4_header_pack(buffer, ip);
...
STATIC int
_bcm_xgs5_bfd_ipv6_header_get(int data_length, uint8 protocol,
                              uint8 tos, uint8 ttl,
...
STATIC int
_bcm_xgs5_bfd_ip_headers_get(bcm_bfd_endpoint_info_t *endpoint_info,
                             uint32 packet_flags,
                             int udp_length,
                             uint16 *etype,
                             _ipv4_header_t *ipv4, _ipv6_header_t *ipv6,
                             ...
                             _ipv6_header_t *inner_ipv6)
{
    ...
    if (packet_flags & _BFD_ENCAP_PKT_IP__V6) {
        *etype = SHR_BFD_L2_ETYPE_IPV6;
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_ipv6_header_get(ip_length,
                                           ip_protocol,
        ...
        *etype = SHR_BFD_L2_ETYPE_IPV4;
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_ipv4_header_get(ip_length,
                                           ip_protocol,
                                           endpoint_info->ip_tos,
                                           endpoint_info->ip_ttl,
                                           endpoint_info->src_ip_addr,
...
STATIC int
_bcm_xgs5_bfd_gre_header_get(uint32 packet_flags, _gre_header_t *gre)
{
...
STATIC int
_bcm_xgs5_bfd_ach_header_get(uint32 packet_flags, _ach_header_t *ach)
{
...
STATIC int
_bcm_xgs5_bfd_mpls_label_get(uint32 label, uint8 exp, uint8 s, uint8 ttl,
                             _mpls_label_t *mpls)
{
...
STATIC int
_bcm_xgs5_bfd_mpls_gal_label_get(_mpls_label_t *mpls)
{
    return _bcm_xgs5_bfd_mpls_label_get(SHR_BFD_MPLS_GAL_LABEL,
                                        0, 1, 1, mpls);
}

STATIC int
_bcm_xgs5_bfd_mpls_router_alert_label_get(_mpls_label_t *mpls)
{
    return _bcm_xgs5_bfd_mpls_label_get(SHR_BFD_MPLS_ROUTER_ALERT_LABEL,
                                        0, 0, 1, mpls);
}

STATIC int
_bcm_xgs5_bfd_mpls_labels_get(int unit, bcm_bfd_endpoint_info_t *endpoint_info,
                              uint32 packet_flags,
                              ...
                              int *mpls_count)
{
    ...
    if (BCM_SUCCESS
        ...
        for (i = 0; (i < label_count) && (count < max_count); i++) {
            _bcm_xgs5_bfd_mpls_label_get(label_array[i].label,
                                         label_array[i].exp,
                                         0,
                                         label_array[i].ttl,
                                         &mpls[count++]);
    ...
    if (packet_flags & _BFD_ENCAP_PKT_MPLS_ROUTER_ALERT) {
        _bcm_xgs5_bfd_mpls_router_alert_label_get(&mpls[count++]);
    }
    ...
    if (BCM_GPORT_IS_MPLS_PORT(endpoint_info->gport)) {
        ...
        if (BCM_FAILURE
            ...
            _bcm_xgs5_bfd_mpls_label_get(mpls_port.egress_label.label,
...
STATIC int
_bcm_xgs5_bfd_l2_header_get(int unit, bcm_bfd_endpoint_info_t *endpoint_info,
...
/*
 * Function:
 *      _bcm_xgs5_bfd_encap_build_pack
 * Purpose:
 ...
 */
STATIC int
_bcm_xgs5_bfd_encap_build_pack(int unit,
                               _bcm_xgs5_bfd_endpoint_config_t *endpoint_config,
                               uint32 packet_flags,
                               uint8 *buffer)
{
    ...
    if (packet_flags & _BFD_ENCAP_PKT_UDP) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_udp_header_get(unit, endpoint_info,
                                          packet_flags, &udp));
    }

    if (packet_flags & _BFD_ENCAP_PKT_IP) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_ip_headers_get(endpoint_info,
    ...
    if (packet_flags & _BFD_ENCAP_PKT_UDP) {
        ...
        if (packet_flags & _BFD_ENCAP_PKT_INNER_IP) {
            ...
            _bcm_xgs5_bfd_udp_checksum_set(v6, &inner_ipv4, &inner_ipv6, &udp);
        } else {
            if (packet_flags & _BFD_ENCAP_PKT_IP__V6) {
                v6 = 1;
            }
            _bcm_xgs5_bfd_udp_checksum_set(v6, &ipv4, &ipv6, &udp);
        }
    }

    if (packet_flags & _BFD_ENCAP_PKT_GRE) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_gre_header_get(packet_flags, &gre));
    }

    if (packet_flags & _BFD_ENCAP_PKT_G_ACH) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_ach_header_get(packet_flags, &ach));
    }

    if (packet_flags & _BFD_ENCAP_PKT_GAL) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_mpls_gal_label_get(&mpls_gal));
    }

    if (packet_flags & _BFD_ENCAP_PKT_MPLS) {
        etype = SHR_BFD_L2_ETYPE_MPLS_UCAST;
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_mpls_labels_get(unit, endpoint_info,
                                           packet_flags,
                                           _BFD_MPLS_MAX_LABELS,
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_l2_header_get(unit, endpoint_info, packet_flags,
                                     tx_port, etype, &l2));
    ...
    if (packet_flags & _BFD_ENCAP_PKT_HG) {
        cur_ptr = _bcm_xgs5_bfd_hg_header_pack(cur_ptr, unit,
                                               endpoint_config, &l2);
    } else if (packet_flags & _BFD_ENCAP_PKT_HG2) {
        cur_ptr = _bcm_xgs5_bfd_hg2_header_pack(cur_ptr, unit,
                                                endpoint_config, &l2);
    }
    if (cur_ptr == NULL) {
        return BCM_E_INTERNAL;
    ...
    cur_ptr = _bcm_xgs5_bfd_l2_header_pack(cur_ptr, &l2);

    if (packet_flags & _BFD_ENCAP_PKT_MPLS) {
        for (i = 0; i < mpls_count; i++) {
            cur_ptr = _bcm_xgs5_bfd_mpls_label_pack(cur_ptr, &mpls_labels[i]);
        }
    }

    /* Remaining packet headers */
    if (packet_flags & _BFD_ENCAP_PKT_GAL) {
        cur_ptr = _bcm_xgs5_bfd_mpls_label_pack(cur_ptr, &mpls_gal);
    }
    if (packet_flags & _BFD_ENCAP_PKT_G_ACH) {
        cur_ptr = _bcm_xgs5_bfd_ach_header_pack(cur_ptr, &ach);
    }
    if (packet_flags & _BFD_ENCAP_PKT_GRE) {
    }
    if (packet_flags & _BFD_ENCAP_PKT_IP) {
        ...
        if (packet_flags & _BFD_ENCAP_PKT_IP__V6) {
            cur_ptr = _bcm_xgs5_bfd_ipv6_header_pack(cur_ptr, &ipv6);
        } else {
            cur_ptr = _bcm_xgs5_bfd_ipv4_header_pack(cur_ptr, &ipv4);
        }
    }
    if (packet_flags & _BFD_ENCAP_PKT_GRE) {
        cur_ptr = _bcm_xgs5_bfd_gre_header_pack(cur_ptr, &gre);
    }
    if (packet_flags & _BFD_ENCAP_PKT_INNER_IP) {
        if (packet_flags & _BFD_ENCAP_PKT_INNER_IP__V6) {
            cur_ptr = _bcm_xgs5_bfd_ipv6_header_pack(cur_ptr, &inner_ipv6);
        } else {
            cur_ptr = _bcm_xgs5_bfd_ipv4_header_pack(cur_ptr, &inner_ipv4);
        }
    }
    if (packet_flags & _BFD_ENCAP_PKT_UDP) {
        cur_ptr = _bcm_xgs5_bfd_udp_header_pack(cur_ptr, &udp);
 ...
 */
void
_bcm_xgs5_bfd_encap_data_dump(uint8 *buffer, int length)
{
    int i;
 ...
 */
int
_bcm_xgs5_bfd_ip_validate_1(bcm_bfd_endpoint_info_t *endpoint_info,
                            uint32 packet_flags)
{
 ...
 */
int
_bcm_xgs5_bfd_ip_validate_2(bcm_bfd_endpoint_info_t *endpoint_info,
                            uint32 packet_flags)
{
    int ip_ttl = 0;
 ...
 */
STATIC int
_bcm_xgs5_bfd_encap_create(int unit,
                           _bcm_xgs5_bfd_endpoint_config_t *endpoint_config,
                           uint8 *encap_data)
{
    bcm_bfd_endpoint_info_t *endpoint_info;
    ...
    case bcmBFDTunnelTypeUdp:
        ...
        BCM_IF_ERROR_RETURN(_bcm_xgs5_bfd_ip_validate_1(endpoint_info,
                                                        packet_flags));
        break;
    ...
    case bcmBFDTunnelTypeIp4in4:
        ...
        BCM_IF_ERROR_RETURN(_bcm_xgs5_bfd_ip_validate_1(endpoint_info,
                                                        packet_flags));
        BCM_IF_ERROR_RETURN(_bcm_xgs5_bfd_ip_validate_2(endpoint_info,
                                                        packet_flags));
        break;
    ...
    case bcmBFDTunnelTypeMplsTpCc:
        ...
        if (endpoint_config->is_l3_vpn) {
            packet_flags |= _BFD_ENCAP_PKT_GAL;
        }
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_encap_build_pack(unit,
                                        endpoint_config,
                                        packet_flags,
                                        encap_data));
    ...
    _bcm_xgs5_bfd_encap_data_dump(encap_data, endpoint_config->encap_length);
#endif
 ...
 */
STATIC int
_bcm_xgs5_bfd_session_hw_set(int unit,
                             _bcm_xgs5_bfd_endpoint_config_t *endpoint_config)
{
    int rv = BCM_E_NONE;
    bcm_bfd_endpoint_info_t *endpoint_info;
    ...
    case bcmBFDTunnelTypeUdp:
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_l2x_entry_set(unit, endpoint_config, 0));

        /* L3 entry */
        _bcm_esw_l3_lock(unit);
        rv = _bcm_xgs5_bfd_l3_entry_set(unit, endpoint_info);
    ...
    case bcmBFDTunnelTypeGre6In6:
        ...
        /* L3_TUNNEL */
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_l3_tunnel_entry_set(unit, endpoint_info));
...
#if defined(BCM_MPLS_SUPPORT)
        if ((_ESW_BFD_DRV(unit) == NULL) ||
            (_ESW_BFD_DRV(unit)->mpls_lock == NULL) ||
            (_ESW_BFD_DRV(unit)->mpls_unlock == NULL)) {
            return BCM_E_UNAVAIL;
        }

        /* Set L2_ENTRY entry, MPLS lookup */
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_l2x_entry_set(unit, endpoint_config, 1));

        /* MPLS entry */
        BCM_IF_ERROR_RETURN(_ESW_BFD_DRV(unit)->mpls_lock(unit));
        rv = _bcm_xgs5_bfd_mpls_entry_set(unit, endpoint_config);
        _ESW_BFD_DRV(unit)->mpls_unlock(unit);
#else
        return BCM_E_UNAVAIL;
#endif /* BCM_MPLS_SUPPORT */
        break;
...
/*
 * Function:
 *      _bcm_xgs5_bfd_session_hw_delete
 * Purpose:
 ...
 */
STATIC int
_bcm_xgs5_bfd_session_hw_delete(int unit,
                                _bcm_xgs5_bfd_endpoint_config_t *endpoint_config)
{
    int rv = BCM_E_NONE;
    bcm_bfd_endpoint_info_t *endpoint_info;
    ...
    case bcmBFDTunnelTypeUdp:
        ...
        /* L3 entry */
        _bcm_esw_l3_lock(unit);
        rv = _bcm_xgs5_bfd_l3_entry_clear(unit, endpoint_info);
        _bcm_esw_l3_unlock(unit);

        /* L2_ENTRY */
        rv = _bcm_xgs5_bfd_l2_entry_clear(unit, 0,
                                          endpoint_info->label,
                                          endpoint_info->local_discr);
        break;
    ...
    case bcmBFDTunnelTypeGre6In6:
        /* L3_TUNNEL */
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_l3_tunnel_entry_clear(unit, endpoint_info));
    ...
    case bcmBFDTunnelTypePweTtl:
        ...
        /* MPLS entry */
        BCM_IF_ERROR_RETURN(_ESW_BFD_DRV(unit)->mpls_lock(unit));
        rv = _bcm_xgs5_bfd_mpls_entry_clear(unit, endpoint_info);
        _ESW_BFD_DRV(unit)->mpls_unlock(unit);
        BCM_IF_ERROR_RETURN(rv);

        /* L2_ENTRY */
        rv = _bcm_xgs5_bfd_l2_entry_clear(unit, 1,
                                          endpoint_info->label,
                                          endpoint_info->local_discr);
#else
        return BCM_E_UNAVAIL;
 ...
 */
int
_bcm_xgs5_bfd_init(int unit,
                   _esw_bfd_drv_t *drv,
                   _bcm_xgs5_bfd_hw_defs_t *hw_defs)
{
#ifdef BCM_CMICM_SUPPORT
    int rv = BCM_E_NONE;
    _bcm_xgs5_bfd_info_t *bfd_info;
    ...
    if (SAL_BOOT_QUICKTURN) {
        _bfd_uc_msg_timeout_usecs = _BFD_UC_MSG_TIMEOUT_USECS_QUICKTURN;
    } else {
        _bfd_uc_msg_timeout_usecs = _BFD_UC_MSG_TIMEOUT_USECS;
    }
    ...
    if (BFD_INIT(unit)) {
        BCM_IF_ERROR_RETURN(_bcm_xgs5_bfd_detach(unit));
    }

    /* Install Tables */
    _ESW_BFD_DRV(unit) = drv;
    BFD_HW(unit)       = hw_defs;

    /* Get SOC properties */
    num_sessions = soc_property_get(unit, spn_BFD_NUM_SESSIONS, 256);
    if (num_sessions > _BFD_MAX_NUM_ENDPOINTS) {
        return BCM_E_CONFIG;
    }
     ...
     */
    rv = _bcm_xgs5_bfd_alloc_resource(unit, num_sessions,
    ...
    rv = _bcm_xgs5_bfd_msg_send_receive(unit,
...
_bcm_xgs5_bfd_detach(int unit)
{
    ...
    for (index = 0; index < bfd_info->endpoint_count; index++) {
        if (SHR_BITGET(bfd_info->endpoints_in_use, index)) {
            ...
            _bcm_xgs5_bfd_session_hw_delete(unit, endpoint_config);
    ...
    if (bfd_info->event_thread_id) {
         ...
         *to free _bcm_xgs5_bfd_info below and we will loose reference to the thread*/
        ...
        while (bfd_info->event_thread_id != NULL) {
            if (sal_time_usecs() < timeout) {
                ...
                /*timeout*/
                soc_cm_debug(DK_ERR, "BFD event thread did not exit.\n");
                return BCM_E_INTERNAL;
            }
        }
    }
    ...
    (void) _bcm_xgs5_bfd_l2_entry_clear(unit,
                                        0, 0,
                                        SHR_BFD_DISCR_UNKNOWN_YOUR_DISCR);

    /* Free resources */
    _bcm_xgs5_bfd_event_unregister_all(unit);
    _bcm_xgs5_bfd_free_resource(unit);
    _bcm_xgs5_bfd_info[unit] = NULL;

    /* Uninstall Tables */
    _ESW_BFD_DRV(unit) = NULL;
    BFD_HW(unit)       = NULL;
 ...
 */
int
_bcm_xgs5_bfd_endpoint_create(int unit,
                              bcm_bfd_endpoint_info_t *endpoint_info)
{
#ifdef BCM_CMICM_SUPPORT
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    ...
    if (endpoint_info->flags & BCM_BFD_ENDPOINT_WITH_ID) {
        ...
        /* Allocate endpoint */
        endpoint_index =
            _bcm_xgs5_bfd_find_free_endpoint(bfd_info->endpoints_in_use,
    ...
    if (!update || (endpoint_info->flags & BCM_BFD_ENDPOINT_ENCAP_SET)) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_session_hw_set(unit, endpoint_config));
        encap = 1;
    }
     ...
     *
     * The function _bcm_xgs5_bfd_encap_create() is called first
     * since this sets some fields in 'endpoint_config' which are
     * used in the message.
     */
    if (encap) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_bfd_encap_create(unit, endpoint_config,
                                        msg_sess.encap_data));
    }
    ...
    _bcm_xgs5_bfd_mpls_label_get(endpoint_info->label, 0, 0, 0,
                                 &mpls_label);
    _bcm_xgs5_bfd_mpls_label_pack(msg_sess.mpls_label, &mpls_label);
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_msg_send_receive(unit,
 ...
 */
int
_bcm_xgs5_bfd_endpoint_get(int unit,
...
/*
 * Function:
 *      _bcm_xgs5_bfd_endpoint_destroy
 * Purpose:
 ...
 */
int
_bcm_xgs5_bfd_endpoint_destroy(int unit, bcm_bfd_endpoint_t endpoint)
{
#ifdef BCM_CMICM_SUPPORT
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_bfd_endpoint_config_t *endpoint_config;
...
/*
 * Function:
 *      _bcm_xgs5_bfd_endpoint_destroy_all
 * Purpose:
 ...
 */
int
_bcm_xgs5_bfd_endpoint_destroy_all(int unit)
{
#ifdef BCM_CMICM_SUPPORT
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_bfd_endpoint_config_t *endpoint_config;
 ...
 */
int
_bcm_xgs5_bfd_endpoint_poll(int unit, bcm_bfd_endpoint_t endpoint)
{
#ifdef BCM_CMICM_SUPPORT
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_bfd_endpoint_config_t *endpoint_config;
 ...
 */
int
_bcm_xgs5_bfd_event_register(int unit,
                             bcm_bfd_event_types_t event_types,
                             bcm_bfd_event_cb cb, void *user_data)
{
    ...
    uint32 result;
    _bcm_xgs5_event_handler_t *event_handler;
    _bcm_xgs5_event_handler_t *previous = NULL;
    ...
    /* Update Events mask */
    return _bcm_xgs5_bfd_event_mask_set(unit);
...
/*
 * Function:
 *      _bcm_xgs5_bfd_event_unregister
 * Purpose:
 ...
 */
int
_bcm_xgs5_bfd_event_unregister(int unit,
                               bcm_bfd_event_types_t event_types,
                               bcm_bfd_event_cb cb)
{
#ifdef BCM_CMICM_SUPPORT
...
/*
 * Function:
 *      _bcm_xgs5_bfd_endpoint_stat_get
 * Purpose:
 ...
 */
int
_bcm_xgs5_bfd_endpoint_stat_get(int unit,
                                bcm_bfd_endpoint_t endpoint,
 ...
 */
int
_bcm_xgs5_bfd_auth_sha1_set(int unit,
 ...
 */
int
_bcm_xgs5_bfd_auth_sha1_get(int unit,
                            int index, bcm_bfd_auth_sha1_t *sha1)
{
#ifdef BCM_CMICM_SUPPORT
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
...
/*
 * Function:
 *      _bcm_xgs5_bfd_auth_simple_password_set
 * Purpose:
 ...
 */
int
_bcm_xgs5_bfd_auth_simple_password_set(int unit,
                                       int index,
...
/*
 * Function:
 *      _bcm_xgs5_bfd_auth_simple_password_get
 * Purpose:
 ...
 */
int
_bcm_xgs5_bfd_auth_simple_password_get(int unit,
                                       int index,
                                       bcm_bfd_auth_simple_password_t *sp)
{
#ifdef BCM_CMICM_SUPPORT
 ...
 */
void
_bcm_xgs5_bfd_sw_dump(int unit)
{
    _bcm_xgs5_bfd_info_t *bfd_info = BFD_INFO(unit);
    _bcm_xgs5_bfd_endpoint_config_t *endpoint_config;
    int endpoint_idx;
