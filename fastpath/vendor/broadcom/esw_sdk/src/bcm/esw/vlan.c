/*
 * $Id: vlan.c 1.363.2.30 Broadcom SDK $
...
#endif /* (BCM_TRIDENT_SUPPORT || BCM_ENDURO_SUPPORT) && INCLUDE_L3 */
#if defined(BCM_TRIDENT_SUPPORT) && defined(INCLUDE_L3)
    if (soc_feature(unit, soc_feature_trill) && BCM_GPORT_IS_TRILL_PORT(port)) {
         rv = bcm_td_trill_vlan_multicast_group_add(unit, vlan);
    } else
#endif /* BCM_TRIDENT_SUPPORT && INCLUDE_L3 */
...
#if defined(BCM_TRIDENT_SUPPORT) && defined(INCLUDE_L3)
    if (soc_feature(unit, soc_feature_trill) && BCM_GPORT_IS_TRILL_PORT(port)) {
         rv = bcm_td_trill_vlan_multicast_group_delete(unit, vlan);
    } else
#endif /* BCM_TRIDENT_SUPPORT && INCLUDE_L3 */
    {
        bcm_pbmp_t pbmp;
