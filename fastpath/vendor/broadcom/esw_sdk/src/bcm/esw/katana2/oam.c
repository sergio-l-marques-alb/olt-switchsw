/* $Id: oam.c 1.12.2.4 Broadcom SDK $
...
#define _BCM_OAM_OPCODE_TYPE_CFM_MASK      0x1F
...
STATIC mep_ctr_info_t mep_ctr_info[] = {     
    { LMEP__CTR1_BASE_PTRf, LMEP__CTR1_VALIDf,            
      LMEP__CTR1_MEP_TYPEf, LMEP__CTR1_MEP_MDLf,                      
      LMEP__CTR1_SERVICE_PRI_MAP_PROFILE_PTRf 
    },
    { LMEP__CTR2_BASE_PTRf, LMEP__CTR2_VALIDf,
      LMEP__CTR2_MEP_TYPEf, LMEP__CTR2_MEP_MDLf,
      LMEP__CTR2_SERVICE_PRI_MAP_PROFILE_PTRf 
    }
};
STATIC mep_ctr_info_t egr_mep_ctr_info[] = {     
    { CTR1_BASE_PTRf, CTR1_VALIDf,            
      CTR1_MEP_TYPEf, CTR1_MEP_MDLf,                      
      CTR1_SERVICE_PRI_MAP_PROFILE_PTRf 
    },
    { CTR2_BASE_PTRf, CTR2_VALIDf,
      CTR2_MEP_TYPEf, CTR2_MEP_MDLf,
      CTR2_SERVICE_PRI_MAP_PROFILE_PTRf
    } 
};

typedef enum field_offset_e {
    OpcodeActionDrop,
    OpcodeActionCopyToCpu,
    OpcodeActionLowMdlDrop,
    OpcodeActionLowMdlCopyToCpu,
    OpcodeActionLowMdlFwdAsData,

    OpcodeActionUcDrop,
    OpcodeActionUcCopyToCpu,
    OpcodeActionFwdToCpu,

    OpcodeActionMcDrop,
    OpcodeActionMcCopyToCpu,
    OpcodeActionMcFwdAsData,
    OpcodeActionMcFwdToCpu,

    OpcodeActionLowMdlFwdToCpu,

    OpcodeActionMyStationMissDrop,
    OpcodeActionMyStationMissCopyToCpu,
    OpcodeActionMyStationMissFwdAsData,
    OpcodeActionMyStationMissFwdToCpu,

    OpcodeActionFwdAsData,
    OpcodeActionCount
} field_offset_t;
...
_bcm_kt2_oam_tpid_set(int unit, int tpid_type, int index, int value)
{
    int  rv = BCM_E_NONE;
    uint32 rval = 0;
    int outer_tpid[4] = { OUTER_TPID_0r, OUTER_TPID_1r, 
                          OUTER_TPID_2r, OUTER_TPID_3r };

    int subport_tpid[4] = { SUBPORT_TAG_TPID_0r, SUBPORT_TAG_TPID_1r, 
...
/*
 * Function:
 *     _bcm_kt2_oam_other_opcode_profile_entry_set
 * Purpose:
 *     Program the other opcode fields of OAM opcode control profile.
 * Parameters:
 *     unit  - (IN) BCM device number
 *     flags - (IN) Bitmap of opcode control settings.
 *     group - (IN) Indicates other opcode group 1 or 2
 *     entry - (IN/OUT) Pointer to opcode control profile table entry buffer.
 * Retruns:
 *     BCM_E_XXX
 */
STATIC int
_bcm_kt2_oam_other_opcode_profile_entry_set(int unit,
                                      uint32 flags,
                                      uint32 group,
                                      uint32 *entry)
{
    uint32 ep_opcode;        /* Endpoint opcode flag bits. */
    uint32 other_opcode_count = 0; /* Number of bits set.        */
    int    bp;               /* bit position.              */

    /* Get number of valid other opcodes supported. */
    other_opcode_count = _shr_popcount(_BCM_KT2_OAM_OTHER_OPCODE_MASK);

    /*
     * Iterate over other opcode flag bits and set corresponding fields
     * in entry buffer.
     */
    for (bp = 0; bp < other_opcode_count; bp++) {
        ep_opcode = (flags & (1 << bp));

        switch (ep_opcode) {
#ifdef _KATANA2_DEBUG
            case BCM_OAM_OTHER_OPCODE_UC_MY_STATION_HIT_COPYTO_CPU:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
            ...
            case BCM_OAM_OTHER_OPCODE_UC_MY_STATION_MISS_DROP:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
            ...
            case BCM_OAM_OTHER_OPCODE_UC_MY_STATION_MISS_FWD:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
                           OTHER_OPCODE_GROUP_1_UC_MY_STATION_MISS_ACTIONf:
                           OTHER_OPCODE_GROUP_2_UC_MY_STATION_MISS_ACTIONf), 
            ...
            case BCM_OAM_OTHER_OPCODE_UC_MY_STATION_MISS_COPYTO_CPU:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
            ...
            case BCM_OAM_OTHER_OPCODE_MC_FWD:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
            ...
            case BCM_OAM_OTHER_OPCODE_MC_DROP:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
                           OTHER_OPCODE_GROUP_1_MC_ACTIONf:
                           OTHER_OPCODE_GROUP_2_MC_ACTIONf),
            ...
            case BCM_OAM_OTHER_OPCODE_MC_COPYTO_CPU:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
            ...
            case BCM_OAM_OTHER_OPCODE_LOW_MDL_FWD:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
            ...
            case BCM_OAM_OTHER_OPCODE_LOW_MDL_DROP:  
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
                           OTHER_OPCODE_GROUP_1_LOW_MDL_ACTIONf:
                           OTHER_OPCODE_GROUP_2_LOW_MDL_ACTIONf), 
            ...
            case BCM_OAM_OTHER_OPCODE_LOW_MDL_COPYTO_CPU:
                soc_OAM_OPCODE_CONTROL_PROFILEm_field32_set(unit, entry,
                    ((group == _BCM_OAM_OTHER_OPCODE_GROUP_1) ?
...
_bcm_kt2_oam_opcode_group_init(int unit)
{
   ...
   /* Set ingress and egress OAM opcode group */
    ...
    index_max = soc_mem_index_max(unit, EGR_OAM_OPCODE_GROUPm);
                               ...
                               _bcm_oam_hash_key_t *key)
{
    ...
    if (NULL != ep_info) {
        _BCM_OAM_KEY_PACK(loc, oc->group_info[ep_info->group].name,
                            ...
                            egr_mp_group_entry_t *egr_mp_grp_key_p)
{
    ...
    if (h_data_p->flags & BCM_OAM_ENDPOINT_PBB_TE) {
        ...
        soc_L3_ENTRY_IPV4_UNICASTm_field32_set
            (unit, egr_mp_grp_key_p, LMEP__SGLPf, h_data_p->dglp);
...
_bcm_kt2_oam_control_free(int unit, _bcm_oam_control_t *oc)
{
    ...
    if (NULL != oc->egr_lm_ctr_pool[0]) {
        shr_aidxres_list_destroy(oc->egr_lm_ctr_pool[0]);
        oc->egr_lm_ctr_pool[0] = NULL;
    }
    if (NULL != oc->egr_lm_ctr_pool[1]) {
        shr_aidxres_list_destroy(oc->egr_lm_ctr_pool[1]);
        oc->egr_lm_ctr_pool[1] = NULL;
    }
    if (soc_feature(unit, soc_feature_bhh)) {
#if defined(INCLUDE_BHH)
...
_bcm_kt2_oam_handle_interrupt(int unit, soc_field_t field)
{
    ...
    for (intr = _kt2_oam_interrupts; intr->status_register != INVALIDr;
        ...
        if ((1 == intr_cur_status) && (intr_count > 0)) {
            ...
            /* Get endpoint index for this interrupt. */
            if (INVALIDf != intr->endpoint_index_field ) {
                ep_index = soc_reg_field_get(unit, intr->status_register,
                                              intr_rval,
                                              intr->endpoint_index_field);

                /* Get Remote endpoint index for this local MEP. */
                remote_ep_index = oc->oam_hash_data[ep_index].remote_index;
            } else {
                /* Endpoint not valid for this interrupt. */
                ep_index = BCM_OAM_ENDPOINT_INVALID;
 ...
 *     mp_group_entry_p - (IN/OUT) Pointer to match entry data.
 * Retruns:
 *     BCM_E_XXX
 */
STATIC int
 ...
 *     unit      - (IN) BCM device number
 *     ep_info_p - (IN) Pointer to remote endpoint information.
 *     lmep_tx_ctr1 -(OUT) - Tx counter
 *     lmep_tx_ctr2 -(OUT) - Tx counter
 * Retruns:
 *     BCM_E_XXX
 */
STATIC int
_bcm_kt2_oam_lmep_tx_counters_get(int unit, 
                                  const bcm_oam_endpoint_info_t *ep_info_p, 
                                  int *lmep_tx_ctr1, int *lmep_tx_ctr2)
{
                          ...
                          _bcm_oam_hash_data_t *hash_data) 
{
    ...
    if (hash_data->rx_ctr != _BCM_OAM_INVALID_INDEX) {
        if (hash_data->flags & BCM_OAM_ENDPOINT_UP_FACING) {
            rv =  shr_aidxres_list_free(oc->egr_lm_ctr_pool[
                                     (hash_data->rx_ctr >> 24)], 
                           ...
                           shr_idxres_element_t *ctr_index)
{
    ...
    if (is_ingress) {
        ...
        /* Allocate 8 consecutive couters from the egress pool */
        rv =  shr_aidxres_list_alloc_block(oc->egr_lm_ctr_pool[pool_id],
                                  8, ctr_index);
        if (BCM_FAILURE(rv)) {
 ...
 */
STATIC int
_bcm_kt2_oam_rx_counter_set(int unit, soc_mem_t  mem, 
                            uint32 *entry,
                            shr_idxres_element_t *ctr_index,
                            int *pool_id) 
{
    ...
    if (mem == L3_ENTRY_IPV4_UNICASTm) { 
        ...
        ctr2_field = LMEP__CTR1_VALIDf;
        is_ingress = 1;
    } else {
        ctr1_field = CTR1_VALIDf;
        ctr2_field = CTR1_VALIDf;
    }
    ...
    if ((1 == ctr1_valid) && (1 == ctr2_valid)) {
        ...
        OAM_ERR(("OAM(unit %d) Error: 2 counters are already \
                 allocated for EP on this service interfaces" " \
                 %s.\n", unit, bcm_errmsg(rv)));
        return (rv);
    } else if ((0 == ctr1_valid) && (1 == ctr2_valid)) {
        *pool_id = 0;
        rv = _bcm_kt2_oam_alloc_counter(unit, *pool_id, is_ingress, ctr_index);
        if (BCM_FAILURE(rv)) {
        ...
        *pool_id = 0;
        ...
        if (BCM_FAILURE(rv)) {
            *pool_id = 1;
            rv = _bcm_kt2_oam_alloc_counter(unit, *pool_id, is_ingress, 
                                                                  ctr_index);
            if (BCM_FAILURE(rv)) {
                OAM_ERR(("OAM(unit %d) Error: LM counter block alloc - %s.\n",
                     unit, bcm_errmsg(rv)));
                                  ...
                                  const bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if ((ep_info_p->flags & BCM_OAM_ENDPOINT_UP_FACING)) {
        if (BCM_SUCCESS
            ...
            rv = _bcm_kt2_oam_rx_counter_set(unit, L3_ENTRY_IPV4_UNICASTm, 
            ...
            soc_L3_ENTRY_IPV4_UNICASTm_field32_set(unit, &l3_entry,
                               mep_ctr_info[pool_id].ctr_base_ptr, ctr_index);
            soc_L3_ENTRY_IPV4_UNICASTm_field32_set(unit, &l3_entry,
                                  mep_ctr_info[pool_id].ctr_mep_type, 1);
            soc_L3_ENTRY_IPV4_UNICASTm_field32_set(unit, &l3_entry,
                           mep_ctr_info[pool_id].ctr_mep_mdl, ep_info_p->level);
            soc_L3_ENTRY_IPV4_UNICASTm_field32_set(unit, &l3_entry,
                         mep_ctr_info[pool_id].ctr_profile, ep_info_p->ing_map);
        ...
        if (BCM_SUCCESS(_bcm_kt2_oam_find_egr_lmep(unit, hash_data,
            ...
            rv = _bcm_kt2_oam_rx_counter_set(unit, EGR_MP_GROUPm, 
            ...
            soc_EGR_MP_GROUPm_field32_set(unit, &egr_mp_group,
                         egr_mep_ctr_info[pool_id].ctr_base_ptr, ctr_index);
            soc_EGR_MP_GROUPm_field32_set(unit, &egr_mp_group,
                        egr_mep_ctr_info[pool_id].ctr_mep_type, 0);
            soc_EGR_MP_GROUPm_field32_set(unit, &egr_mp_group,
                     egr_mep_ctr_info[pool_id].ctr_mep_mdl, ep_info_p->level);
            soc_EGR_MP_GROUPm_field32_set(unit, &egr_mp_group,
                     egr_mep_ctr_info[pool_id].ctr_profile, ep_info_p->egr_map);

            hash_data->tx_ctr = pool_id << 24 || (ctr_index);
        } else {  /* port based downMEP */
            if (hash_data->oam_domain == _BCM_OAM_DOMAIN_PORT) {
                rv = _bcm_kt2_oam_rx_counter_set(unit, EGR_MP_GROUPm, 
                                  (uint32 *)&egr_mp_group, &ctr_index, &pool_id);
                if (BCM_FAILURE(rv)) {
                    OAM_ERR(("OAM(unit %d) Error: Port based MEP \
                              EP=%d counter allocation failure" "  %s.\n",
                              unit, ep_info_p->id, bcm_errmsg(rv)));
                    return (rv);
                }
                hash_data->tx_ctr = pool_id << 24 || (ctr_index);
...
/*
 * Function:
 *     _bcm_oam_kt_local_tx_mep_hw_set
 * Purpose:
 ...
 */
STATIC int
_bcm_oam_kt_local_tx_mep_hw_set(int unit,
                             const bcm_oam_endpoint_info_t *ep_info_p)
{
    int                  rv = BCM_E_NONE;/* Operation return status.         */
    _bcm_oam_hash_data_t *hash_data; /* Pointer to endpoint hash data. */
     ...
     */
    soc_LMEPm_field32_set(unit, &entry, SVIDf, ep_p->vlan);

    soc_LMEPm_field32_set(unit, &entry, CVIDf, ep_p->inner_vlan);
    ...
    if ((hash_data->oam_domain == _BCM_OAM_DOMAIN_SVLAN) || 
        (hash_data->oam_domain == _BCM_OAM_DOMAIN_S_PLUS_CVLAN)) { 
        ...
        soc_LMEPm_field32_set(unit, &entry, SVLAN_TPID_INDEXf, 
                                (ep_p->outer_tpid ? ep_p->outer_tpid :
                                                 BCM_OAM_DEFAULT_TPID)); 
    } else if ((hash_data->oam_domain == _BCM_OAM_DOMAIN_CVLAN) || 
        /* C or S+C */
        (hash_data->oam_domain == _BCM_OAM_DOMAIN_S_PLUS_CVLAN)) { 
        rv = _bcm_kt2_tpid_entry_add(unit, 
        ...
        if (BCM_FAILURE(rv)) {
            ...
            return (rv);
              ...
              (_BCM_KT2_GPORT_IS_SUBTAG_SUBPORT_PORT(hash_data->gport))) {
        /* CoE port */
        rv = _bcm_kt2_tpid_entry_add(unit, 
        ...
        soc_LMEPm_field32_set(unit, &entry, SUBPORT_TAG_TPID_INDEXf, 
                                (ep_p->subport_tpid ? ep_p->subport_tpid :
                                                 BCM_OAM_DEFAULT_TPID)); 
    }
    ...
    /* If COE or LINKPHY port replacement offset should be increased 
       by 2 to accomodate - steam_id/subport tag */ 
    if (BCM_GPORT_IS_SUBPORT_PORT(hash_data->gport)) {
        if ((_BCM_KT2_GPORT_IS_SUBTAG_SUBPORT_PORT(hash_data->gport)) ||
            (_BCM_KT2_GPORT_IS_LINKPHY_SUBPORT_PORT(hash_data->gport))) {
    ...
    if (subport) {
        soc_LMEP_1m_field32_set(unit, &entry_1, VLAN_TAG_CONTROLf, 
                                   (subport  || (hash_data->oam_domain & 0x3)));
    } else {
        soc_LMEP_1m_field32_set(unit, &entry_1, VLAN_TAG_CONTROLf, 
                                   (hash_data->oam_domain & 0x3));
...
#ifdef _KATANA2_DEBUG
    _bcm_kt2_oam_lmep_tx_counters_get(unit, ep_info_p, &lmep_tx_ctr1,
                                                      &lmep_tx_ctr2);
  ...
  /* Set Counter 1 ID and action */
    soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_1_IDf, 
                                              hash_data->counter_1);
    soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_1_ACTIONf, 
                                           hash_data->counter_1_action);

    /* Set Counter 2 ID and action */
    soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_2_IDf, 
                                              hash_data->counter_2);
    soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_2_ACTIONf, 
                                           hash_data->counter_2_action);

    /* Set Outgoing Subport tag to be inserted into CCM packet */
    if (!(ep_p->flags & BCM_OAM_ENDPOINT_UP_FACING)) {
        if (ep_p->vlan_tag_control == 2) {
            soc_LMEP_1m_field32_set(unit, &entry_1, SUBPORT_TAGf, 
                                             ep_p->subport_tag);
        } else {
            /* if the port is of type link phy - derive stream id?? */
            soc_LMEP_1m_field32_set(unit, &entry_1, DEVICE_STREAM_ID, 
                                                    ep_p->stream_id);
        }
    }
    ...
    /* For DownMEP, set Queue number to which this packet must be enqueued 
       NOTE : Queue number has to be derived using the DGPP and int pri    */  
    if (!(ep_p->flags & BCM_OAM_ENDPOINT_UP_FACING)) {
        soc_LMEP_1m_field32_set(unit, &entry_1, QUEUE_NUMf, ep_p->cpu_qid);
    }
    if (ep_p->flags & BCM_OAM_ENDPOINT_UP_FACING) {
     /* Set the source on which packet is received */
        soc_LMEP_1m_field32_set(unit, &entry_1, PP_PORTf, hash_data->sglp);
    } else {
     /* Set the destination portt on which packet needs to Tx. */
        soc_LMEP_1m_field32_set(unit, &entry_1, PP_PORTf, hash_data->dglp);
    } 

    /* Set CCM packet internal priority used for scheduling. */
    soc_LMEP_1m_field32_set(unit, &entry_1, INT_PRIf, ep_p->int_pri);
   ...
   /* If the OAM domain is port, set source trunk map table */
    if (0 == ep_info_p->vlan) {
       /* Derive index to SOURCE_TRUNK_MAP table based on module ID and port */
        if (BCM_GPORT_IS_SET(h_data_p->sglp)) {
            BCM_IF_ERROR_RETURN(_bcm_esw_gport_resolve(unit, h_data_p->sglp,
            ...
            if (!SOC_PORT_VALID(unit, (int)h_data_p->sglp)) {
                return BCM_E_PORT;
            }
            BCM_IF_ERROR_RETURN(bcm_esw_stk_my_modid_get(unit, &my_modid));
            BCM_IF_ERROR_RETURN(_bcm_esw_src_mod_port_table_index_get(unit,
                                      my_modid, h_data_p->sglp, &stm_index));
       ...
       /* Need to set MDL bit map in port table */
        if ((BCM_GPORT_IS_SUBPORT_PORT(h_data_p->gport)) &&
              ((_BCM_KT2_GPORT_IS_SUBTAG_SUBPORT_PORT(h_data_p->gport)) || 
              (_BCM_KT2_GPORT_IS_LINKPHY_SUBPORT_PORT(h_data_p->gport)))) {
            index = port_id;
        } else {
            index = SOC_PORT_MOD_OFFSET(unit, h_data_p->sglp);
        } 
        rv = soc_mem_read(unit, PORT_TABm, MEM_BLOCK_ANY, index, &port_entry);
        if (BCM_FAILURE(rv)) {
            OAM_ERR(("OAM(unit %d) Error: Port table entry  read failed for\
                      EP=%d" "  %s.\n", unit, ep_p->id, bcm_errmsg(rv)));
            return (rv);
        }
        ...
        rv = soc_mem_write(unit, PORT_TABm, MEM_BLOCK_ALL, index, &port_entry);
        if (BCM_FAILURE(rv)) {
            OAM_ERR(("OAM(unit %d) Error: Port table update failed for\
                      EP=%d" "  %s.\n", unit, ep_p->id, bcm_errmsg(rv)));
            return (rv);
        }
        ...
        if ((BCM_GPORT_IS_SUBPORT_PORT(h_data_p->gport)) &&
            ...
            index = SOC_PORT_MOD_OFFSET(unit, h_data_p->dglp);
        } 
        rv = soc_mem_read(unit, EGR_PORTm, MEM_BLOCK_ANY, index, 
                          &egr_port_entry);
        if (BCM_FAILURE(rv)) {
            OAM_ERR(("OAM(unit %d) Error: Egr Port table entry  read failed for\
                      EP=%d" "  %s.\n", unit, ep_p->id, bcm_errmsg(rv)));
            return (rv);
        }
        /* read and update MDL bitmap */
        ...
        if (BCM_FAILURE(rv)) {
            OAM_ERR(("OAM(unit %d) Error: Egr Port table update failed for\
                      EP=%d" "  %s.\n", unit, ep_p->id, bcm_errmsg(rv)));
            return (rv);
        }
    }
                          ...
                          const bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if (BCM_SUCCESS
        ...
        soc_L3_ENTRY_IPV4_UNICASTm_field32_set(unit, &l3_entry, mdl_field,
                                                     (1 << ep_p->level));
        ...
        if ((ep_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) && (!up_mep))  {
            ...
            soc_L3_ENTRY_IPV4_UNICASTm_field32_set(unit, &l3_entry,
                         mep_ctr_info[pool_id].ctr_profile, ep_p->ing_map);
        ...
        rv = soc_mem_insert(unit, L3_ENTRY_IPV4_UNICASTm, MEM_BLOCK_ALL, &l3_entry);
        if (BCM_FAILURE(rv)) {
    ...
    _bcm_esw_l3_unlock(unit);
#ifdef _KATANA2_DEBUG
    if ((h_data_p->local_tx_enabled) && (upmep)) {
        /* get TX counter for upmep */
        if ((1 == ctr1_valid) &&
            (soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, 
                 &l3_entry, CTR1_MEP_TYPEf) == upmep) &&
            (soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, &l3_entry, 
                                CTR1_MDLf) >= ep_p->level)) {
             h_data_p->lmep_tx_ctr1 = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit,
                                              &l3_entry, LMEP__CTR1_BASE_PTRf);
        } else if ((1 == ctr2_valid) &&
            (soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, 
                &l3_entry, CTR2_MEP_TYPEf) == upmep) &&
            (soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, &l3_entry, 
                                         CTR2_MDLf) >= ep_p->level)) {
                             
             h_data_p->lmep_tx_ctr2 = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit,
                                              &l3_entry, LMEP__CTR2_BASE_PTRf);
        }
    }
#endif
    return (BCM_E_NONE);
                          ...
                          shr_idxres_element_t *ctr_index)
{
    ...
    if (BCM_SUCCESS
        ...
        /* set MDL bitmap passive or active depending on up or down mep */
        soc_EGR_MP_GROUPm_field32_set(unit, &egr_mp_group, mdl_field,
                                                     (1 << ep_p->level));
        ...
        if ((ep_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) && (up_mep))  {
            ...
            soc_EGR_MP_GROUPm_field32_set(unit, &egr_mp_group,
                         egr_mep_ctr_info[pool_id].ctr_profile, ep_p->egr_map);
        ...
        if (BCM_FAILURE(rv)) {
            OAM_ERR(("OAM(unit %d) Error: L3_ENTRY table update failed for\
                      EP=%d" "  %s.\n", unit, ep_p->id, bcm_errmsg(rv)));
            soc_mem_unlock(unit, EGR_MP_GROUPm);
            rv =  shr_aidxres_list_free(oc->egr_lm_ctr_pool[pool_id], 
                                                              *ctr_index);
            if (BCM_FAILURE(rv)) {
                OAM_ERR(("OAM(unit %d) Error: LM counter block free failed \
                          (EP=%d) - %s.\n",
...
#ifdef _KATANA2_DEBUG
    if ((h_data_p->local_tx_enabled) && !(upmep)) {
        /* get TX counter for downmep */
        if ((1 == ctr1_valid) &&
            (soc_EGR_MP_GROUPm_field32_get(unit, 
                 &l3_entry, CTR1_MEP_TYPEf) == 0) &&
            (soc_EGR_MP_GROUPm_field32_get(unit, &l3_entry, 
                                CTR1_MDLf) >= ep_p->level)) {
            h_data_p->lmep_tx_ctr1 = soc_EGR_MP_GROUPm_field32_get(unit,
                                               &l3_entry, CTR1_BASE_PTRf);
        } else if ((1 == ctr2_valid) &&
            (soc_EGR_MP_GROUPm_field32_get(unit, 
                &l3_entry, CTR2_MEP_TYPEf) == 0) &&
            (soc_EGR_MP_GROUPm_field32_get(unit, &l3_entry, 
                                         CTR2_MDLf) >= ep_p->level)) {
                             
            h_data_p->lmep_tx_ctr2 = soc_EGR_MP_GROUPm_field32_get(unit,
                                                   &l3_entry, CTR2_BASE_PTRf);
        }
    }
#endif
    return (BCM_E_NONE);
                             ...
                             const bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    /* TBD - setting of DGLP2_OLP_HDR_ADD, DGLP1_OLP_HDR_ADD
             DGLP2_PROFILE_PTR and DGLP1_PROFILE_PTR */
                              ...
                              uint8 *active_mdl)
{
    ...
    if (h_data_p->flags & BCM_OAM_ENDPOINT_UP_FACING) {
        mdl_field = LMEP__MDL_BITMAP_PASSIVEf;
        other_mdl_field = LMEP__MDL_BITMAPf;
    } else {
        mdl_field = LMEP__MDL_BITMAPf;
    ...
    if (BCM_SUCCESS(rv)) {
        ...
        if (0 != mdl) {
            ...
            /* check if other MDL bitmap is also zero (passive bitmap incase 
               of donmep and active bitmap in case of upmep), if so delete the
               entry completely */
        ...
        if ((0 == mdl) && (0 == other_mdl)) {
            ma_base_index = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, &l3_entry,
                                                        LMEP__MA_BASE_PTRf);
        ...
        OAM_ERR(("OAM(unit %d) Error: RMEP table write (EP=%d) -"\
                " %s.\n", unit, h_data_p->ep_id, bcm_errmsg(rv)));
        return (rv);
    }
    return (BCM_E_NONE);
                                ...
                                uint32 *dst_glp)
{
    ...
    /* we need to convert the physical port to pp port here. Index to
       ING_PHYSICAL_PORT_TABLE using sglp and get sgpp */
    if ((BCM_GPORT_IS_SUBPORT_PORT(ep_info_p->gport)) &&
              ((_BCM_KT2_GPORT_IS_SUBTAG_SUBPORT_PORT(ep_info_p->gport)) || 
              (_BCM_KT2_GPORT_IS_LINKPHY_SUBPORT_PORT(ep_info_p->gport)))) {

        rv = bcm_kt2_subport_port_resolve(unit, ep_info_p->gport, &module_id, 
                                     &port_id, &trunk_id, &local_id);
        if (BCM_FAILURE(rv)) {
            return (rv);
        }
                                  ...
                                  bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    /* Hash table lookup key does not use endpoint ID.
     * So, verify the endpoint status here.
     */
    rv = shr_idxres_list_elem_state(oc->mep_pool, ep_info_p->id);
...
_bcm_kt2_oam_ing_flexible_oam_domain_ctrl_set(int unit)
{
    ...
    for (index = 0; ;index++) { 
        ...
        while (entry_index <= max_index) {  
            for (; entry_index < end_index; entry_index++) {
    ...
    rv = soc_mem_write_range(unit, ING_OAM_FLEXIBLE_DOMAIN_CONTROLm, 
                             MEM_BLOCK_ALL, 0, (max_index + 1), ent_buf); 
    if (BCM_FAILURE(rv)) {
        if (ent_buf) {
...
_bcm_kt2_oam_egr_flexible_oam_domain_ctrl_set(int unit)
{
    ...
    rv = soc_mem_write_range(unit, ING_OAM_FLEXIBLE_DOMAIN_CONTROLm, 
                             MEM_BLOCK_ALL, 0, (max_index + 1), egr_ent_buf); 
    if (BCM_FAILURE(rv)) {
        if (egr_ent_buf) {
...
_bcm_kt2_oam_egr_flexible_drop_ctrl_set(int unit)
{
    ...
    _bcm_oam_egr_flexible_drop_ctrl_t egr_flex_drop[] = {
        ...
        { EGR_OAM_S_INTERFACE_DROP_CONTROL_64r,    0x1e06948, 1, 0, 0 },
...
_bcm_kt2_oam_olp_header_type_mapping_set(int unit) 
{
    ...
    /* Allocate buffer to store the DMAed table entries. */
    entry_buf = soc_cm_salloc(unit, entry_mem_size * 16,
 ...
 */
STATIC int
_bcm_kt2_oam_lm_cng_cpu_ctrl_set(int unit) 
{
    uint32   rval = 0;
...
_bcm_kt2_oam_olp_magic_port_set(int unit)
{
    ...
    soc_reg64_field_set(unit, IARB_OLP_CONFIGr, &rval, MY_MODIDf, set_val);
    COMPILER_64_SET(set_val, 0, _BCM_OAM_OLP_COMMUNICATION_PORT);
    soc_reg64_field_set(unit, IARB_OLP_CONFIGr, &rval, MY_PORT_NUMf, set_val);

    SOC_IF_ERROR_RETURN(WRITE_IARB_OLP_CONFIGr(unit, rval));
    return (BCM_E_NONE);
}
                                ...
                                _bcm_oam_hash_data_t   *h_data_p)
{
    ...
    if (mem == L3_ENTRY_IPV4_UNICASTm) {
        ...
        map = &h_data_p->ing_map;
    } else if (mem == EGR_MP_GROUPm) {
        ctr_info = egr_mep_ctr_info;
        ctr_pool = oc->egr_lm_ctr_pool;
        map = &h_data_p->egr_map;
    } else {
        return BCM_E_INTERNAL; 
    }
                          ...
                          l3_entry_1_entry_t *l3_entry)
{
   ...
   /* Has to be a valid RMEP, return error otherwise. */
    ...
    h_data_p->lmep_tx_ctr1 = _BCM_OAM_INVALID_INDEX;
    h_data_p->lmep_tx_ctr2 = _BCM_OAM_INVALID_INDEX;
    ...
    source_type
        = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, l3_entry, RMEP__SOURCE_TYPEf);
                         ...
                         port_tab_entry_t *port_entry)
{
    ...
    for (mdl = 0; mdl < _BCM_OAM_EP_LEVEL_COUNT; mdl++) {
        ...
        if (mdl_bitmap & (1 << mdl)) {
            ...
            h_data_p->local_rx_index = ((soc_SOURCE_TRUNK_MAP_TABLEm_field32_get(unit, &stm_entry,
                        MA_BASE_PTRf) << _BCM_OAM_EP_LEVEL_BIT_COUNT) | mdl);
...
cleanup:
    ...
    if (NULL != h_data_p
        ...
        shr_idxres_list_free(oc->egr_ma_idx_pool, h_data_p->local_rx_index);
                                    ...
                                    l3_entry_1_entry_t *l3_entry)
{
    ...
    OAM_VVERB(("OAM(unit %d) Info: _bcm_kt2_oam_lmep_downmep_rx_config_recover .\n", unit));
    /*
     * Get OAM control structure.
     *     Note: Lock taken by calling routine.
     */
    ...
    /* recover DownMEPs */
    mdl_bitmap
        = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, l3_entry, LMEP__MDL_BITMAPf);
    ...
    for (mdl = 0; mdl < _BCM_OAM_EP_LEVEL_COUNT; mdl++) {
        ...
        if (mdl_bitmap & (1 << mdl)) {
            ...
            h_data_p->oam_domain = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit,l3_entry,
                                                 LMEP__OAM_LMEP_KEY_SUBTYPEf);

            switch (h_data_p->oam_domain) {
                case _BCM_OAM_DOMAIN_CVLAN:
                    h_data_p->flags |= BCM_OAM_ENDPOINT_MATCH_INNER_VLAN;
                    h_data_p->inner_vlan = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, 
            ...
            rv = _bcm_kt2_oam_rx_counter_recover(unit, L3_ENTRY_IPV4_UNICASTm, (uint32 *)l3_entry,
                                                                      h_data_p);
            if (BCM_FAILURE(rv)) {
            ...
            glp = soc_L3_ENTRY_IPV4_UNICASTm_field32_get(unit, l3_entry, LMEP__SGLPf);
...
bcm_kt2_oam_init(int unit)
{
    ...
    /* Mem_3: Create MEP Rx state tracker table index endpoint list - DnMEP */
    ...
    /* Mem_4: Create MEP Rx state tracker table index endpoint list -UpMEP */
    rv = shr_idxres_list_create(&oc->egr_ma_idx_pool, 8, 
                                oc->egr_ma_idx_count - 1,
                                8, oc->egr_ma_idx_count -1, "egr_ma_idx pool");
    if (BCM_FAILURE(rv)) {
        _bcm_kt2_oam_control_free(unit, oc);
        return (rv);
    ...
    rv = shr_aidxres_list_create(&oc->ing_lm_ctr_pool[0], 1, 
                         oc->lm_counter_cnt - 1, 1, 
    ...
    rv = shr_aidxres_list_create(&oc->ing_lm_ctr_pool[1], 1, 
                         oc->lm_counter_cnt - 1, 1,
    ...
    /* Index management for Egress LM counter pool 1 */
    rv = shr_aidxres_list_create(&oc->egr_lm_ctr_pool[0], 1, 
                         oc->lm_counter_cnt - 1, 1,
                         oc->lm_counter_cnt - 1, 8, "ing_lm_idx pool2");
    if (BCM_FAILURE(rv)) {
        _bcm_kt2_oam_control_free(unit, oc);
    ...
    /* Index management for Egress LM counter pool 2 */
    rv = shr_aidxres_list_create(&oc->egr_lm_ctr_pool[1], 1, 
                         oc->lm_counter_cnt - 1, 1,
                         oc->lm_counter_cnt - 1, 8, "ing_lm_idx pool2");
    if (BCM_FAILURE(rv)) {
        _bcm_kt2_oam_control_free(unit, oc);
    ...
    /* Set OAM LM cng and cpu data control*/
    rv = _bcm_kt2_oam_lm_cng_cpu_ctrl_set(unit); 
    if (BCM_FAILURE(rv)) {
        _bcm_kt2_oam_control_free(unit, oc);
        return (rv);
    }
...
bcm_kt2_oam_endpoint_create(int unit, bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if ((BCM_GPORT_IS_SUBPORT_PORT(endpoint_info->gport)) &&
              ((_BCM_KT2_GPORT_IS_SUBTAG_SUBPORT_PORT(endpoint_info->gport)) || 
              (_BCM_KT2_GPORT_IS_LINKPHY_SUBPORT_PORT(endpoint_info->gport)))) {

        index = sglp;
    } else {
        index = SOC_PORT_MOD_OFFSET(unit, sglp);
    } 
    ...
    if (key_type != _BCM_OAM_DOMAIN_PORT) {
         if ((oam_key1 > 0) && (oam_key2 > 0)) {
            if ((oam_key1 == key_type) || (oam_key2 == key_type)) {
                ...
                OAM_ERR(("OAM(unit %d) Error: Invalid OAM domain resolve \
                         (EP=%d) - %s.\n",
                          unit, endpoint_info->id, bcm_errmsg(rv)));
                _BCM_OAM_UNLOCK(oc);
                return (BCM_E_PARAM);
    ...
    hash_data->lmep_tx_ctr1 = _BCM_OAM_INVALID_INDEX;
    hash_data->lmep_tx_ctr2 = _BCM_OAM_INVALID_INDEX;
    ...
    if (1 == remote) {
        ...
        if (mep_ccm_rx) {
            ...
            if (BCM_FAILURE(rv)) {
                ...
                if (!(endpoint_info->flags & BCM_OAM_ENDPOINT_REPLACE)) {
                    ...
                    shr_idxres_list_free(oc->egr_ma_idx_pool,
                                         hash_data->local_rx_index);
        ...
        if (mep_ccm_tx) {
            rv = _bcm_oam_kt_local_tx_mep_hw_set(unit, endpoint_info);
            if (BCM_FAILURE(rv)) {
   ...
   /* 
    ...
    if (key_type != _BCM_OAM_DOMAIN_PORT) {
        if ((oam_key1 != key_type) && (oam_key2 == 0)) {
            if (key_type > oam_key1) {
                soc_PORT_TABm_field32_set(unit, &port_entry, OAM_KEY2f, 
                                                                 key_type);
            } else {
        ...
        if ((oam_key2 != key_type) && (oam_key1 == 0)) {
            if (key_type < oam_key2) {
                soc_PORT_TABm_field32_set(unit, &port_entry, OAM_KEY1f, 
                                                                 key_type);
            } else {
                soc_PORT_TABm_field32_set(unit, &port_entry, 
                                                      OAM_KEY1f, oam_key2);
    ...
    if ((BCM_GPORT_IS_SUBPORT_PORT(dglp)) &&
              ((_BCM_KT2_GPORT_IS_SUBTAG_SUBPORT_PORT(dglp)) || 
              (_BCM_KT2_GPORT_IS_LINKPHY_SUBPORT_PORT(dglp)))) {
        index = dglp;
    } else {
        index = SOC_PORT_MOD_OFFSET(unit, dglp);
    } 
    rv = soc_mem_read(unit, EGR_PORTm, MEM_BLOCK_ANY, index, &egr_port_entry);
    ...
    if (key_type != _BCM_OAM_DOMAIN_PORT) {
        if ((oam_key1 != key_type) && (oam_key2 == 0)) {
            if (key_type > oam_key1) {
                soc_EGR_PORTm_field32_set(unit, &egr_port_entry, OAM_KEY2f, 
                                                                 key_type);
            } else {
                soc_EGR_PORTm_field32_set(unit, &egr_port_entry, 
                                                      OAM_KEY1f, key_type);
        ...
        if ((oam_key2 != key_type) && (oam_key1 == 0)) {
            if (key_type < oam_key2) {
                soc_EGR_PORTm_field32_set(unit, &egr_port_entry, OAM_KEY1f, 
                                                                 key_type);
            } else {
                soc_EGR_PORTm_field32_set(unit, &egr_port_entry, 
                                                      OAM_KEY1f, oam_key2);
        ...
        /* Select OAM_KEY from EGR_DVP_ATTR Table and Select OAM_KEY1 from
           EGR_PORT_TAB when EGR_DVP override is set */
        soc_EGR_PORTm_field32_set(unit, &egr_port_entry,
                                          OAM_KEY1_OVERRIDE_EGR_DVPf, 1);
        rv = soc_mem_write(unit, EGR_PORTm, MEM_BLOCK_ALL, index,
                           &egr_port_entry);
        if (BCM_FAILURE(rv)) {
            OAM_ERR(("OAM(unit %d) Error: Port table update failed for\
                   EP=%d" "  %s.\n", unit, endpoint_info->id, bcm_errmsg(rv)));
                         ...
                         bcm_oam_endpoint_info_t *endpoint_info)
{
        ...
        if (1 == h_data_p->is_remote) {
            ...
            if (1 == h_data_p->local_tx_enabled) {
                ...
                endpoint_info->pkt_pri
                    = soc_LMEPm_field32_get(unit, &lmep_entry, LMEP_PRIORITYf);

                endpoint_info->int_pri
                    = soc_LMEPm_field32_get(unit, &lmep_entry, INT_PRIf);
    ...
    endpoint_info->ing_map = h_data_p->ing_map;
    endpoint_info->egr_map = h_data_p->egr_map;
...
int
_kt2_oam_opcode_control_field_set(int unit, field_offset_t field_index, 
                                  ...
                                  void *profile) 
{
    ...
    soc_field_t cfm_field[OpcodeActionCount][_BCM_OAM_OPCODE_TYPE_NON_CFM_FIRST] =  { 
                 /* OpcodeActionDrop */
    ...
    soc_field_t non_cfm_field[OpcodeActionCount][2]= {
                  /* OpcodeActionDrop */
    ...
    if ((field_index == OpcodeActionLowMdlDrop) && 
    ...
    if ((oam_opcode < _BCM_OAM_OPCODE_TYPE_NON_CFM_FIRST) &&
        (cfm_field[field_index][oam_opcode] != 0)) {
...
int
_bcm_kt2_oam_resolve_dglp(int unit, soc_mem_t mem, bcm_port_t port, 
...
{ 
    ...
    /* Check if gport passed is OLP port or not */
                    ...
                    switch (action_i) {
                        ...
                        case bcmOAMActionDrop:
                            rv = _kt2_oam_opcode_control_field_set(unit, 
                                             OpcodeActionDrop, mem, 
                                             opcode_i, 
                                             _BCM_OAM_DROP_PACKET, profile); 
                            if (opcode_i >= _BCM_OAM_OPCODE_TYPE_NON_CFM_FIRST) {
                                break_the_loop = 1;   
                            }
                            break;
                        case bcmOAMActionCopyToCpu:             
                            rv = _kt2_oam_opcode_control_field_set(unit, 
                                           OpcodeActionCopyToCpu, mem, opcode_i,
                                            _BCM_OAM_COPY_TO_CPU, profile);
                            if (opcode_i >= 
                                     _BCM_OAM_OPCODE_TYPE_NON_CFM_FIRST) {
                                break_the_loop = 1;   
                            }
                            break;
                        ...
                        case bcmOAMActionFwd:      
                            /* forward CCM packets to DGLP1 or DGLP2 */
                            if (!skip_ma_index_modify) {
                                rv = _bcm_kt2_oam_resolve_dglp(unit, mem, 
                                                        ...
                                                        &olp_enable); 
                                if (BCM_FAILURE(rv)) {
                                   OAM_ERR(("OAM(unit %d) Error: Gport resolve \
                                       to dglp - %s.\n", unit, bcm_errmsg(rv)));
                                   return (rv);
                                }
                                if (profile_index  != _BCM_OAM_INVALID_INDEX) {
                                    ...
                                    rv = _bcm_kt2_ma_index_entry_modify(unit, 
                                         h_data_p->local_rx_index, ma_index_mem,
                                          profile_index, olp_enable, &dglp_ptr);
                                    if (BCM_FAILURE(rv)) {
                                        return rv;
                                    } 
                                }
                            ...
                            _kt2_oam_opcode_control_field_set(unit, 
                                           OpcodeActionFwdToCpu, mem, opcode_i,
                                           dglp_ptr, profile); 
                            break_the_loop = 1;   
                            break;
                        ...
                        case bcmOAMActionUcFwd:       
                            /* forward UC packets to DGLP1 or DGLP2 */
                            if (!skip_ma_index_modify) {
                                rv = _bcm_kt2_oam_resolve_dglp(unit, mem, 
                                                           action->destination, 
                                                           (uint32 *)&profile_index,
                        ...
                        case bcmOAMActionLowMdlFwd:
                            ...
                            rv = _kt2_oam_opcode_control_field_set(unit, 
                                      OpcodeActionLowMdlFwdToCpu, mem, opcode_i,
                                           dglp_ptr, profile);
                            break;
                        ...
                        case bcmOAMActionMyStationMissFwd:
                            ...
                            rv = _kt2_oam_opcode_control_field_set(unit, 
                                      OpcodeActionMyStationMissFwdToCpu, mem, 
                                      opcode_i, dglp_ptr, profile);
                            break;
