/*
 * $Id: stats.c 1.1.2.7 Broadcom SDK $
 * 
...
static const _bcm_ptp_packet_counters_t counters_zero;
...
static int _bcm_ptp_packet_counters_msg_get(int unit, bcm_ptp_stack_id_t ptp_id,
    int clock_num, _bcm_ptp_packet_counters_t *counters);
