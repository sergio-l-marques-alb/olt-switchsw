/* $Id: field.c 1.229.2.94 Broadcom SDK $
...
static soc_field_t _trx_vfp_src_type_sel[]= {
                          ...
                          int tcam_idx, _field_action_t *fa, uint32 *buf)
{
    ...
    case bcmFieldActionCosQNew:
        ...
        if (SOC_IS_KATANA(unit)) {
            BCM_IF_ERROR_RETURN
                (_field_kt_action_update(unit, mem,
        ...
        switch (action) {
          ...
          case bcmFieldActionFabricQueue:
              *result = (soc_feature(unit,
                            ...
                            && (f_ent->group->stage_id
                            == _BCM_FIELD_STAGE_INGRESS)) ? TRUE : FALSE;
              break;
          case bcmFieldActionSrcMacNew:
#if defined(INCLUDE_L3)
              if ((_BCM_FIELD_STAGE_INGRESS == f_ent->group->stage_id) &&
                    ...
                    if (SOC_IS_TD_TT(unit) || SOC_IS_KATANA(unit)) {
                        ...
                        */
                        ...
                        if (soc_mem_field_valid(
                            unit,EGR_L3_NEXT_HOPm,IFP_ACTIONS__VNTAG_ACTIONf)) {
        ...
        case MIRRORf:
            {
                ...
                if (SOC_IS_ENDURO(unit) || SOC_IS_HURRICANE(unit)) {
                    /* Enduro has this field, but as an overlay -- 
                                         ...
                                         )
{
    ...
    vmap_cnt =
        ...
        (SOC_IS_TD_TT(unit) || SOC_IS_KATANA(unit)) ? 1 : _FP_VMAP_CNT;
...
#if defined(BCM_KATANA_SUPPORT)
    if ((stat_present) && (SOC_IS_KATANA(unit)) && 
        (soc_feature(unit, soc_feature_advanced_flex_counter)) &&
