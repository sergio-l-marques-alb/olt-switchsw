/* $Id: field.c 1.36.20.2 Broadcom SDK $
...
_field_en_ingress_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifySrcClassField,
                               _bcmFieldSliceSelFpf1, 0,
                               _bcmFieldSliceSrcClassSelect, 3, 189, 6);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifyVrf,
                               _bcmFieldSliceSelFpf1, 0,
                               _bcmFieldSliceFwdFieldSelect, 
    ...
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyLookupStatus,
                 _bcmFieldSliceSelFpf1, 5, 189, 16);
    _FP_QUAL_ADD(unit, stage_fc, bcmFieldQualifyMplsTerminated,
    ...
    /* DWF2 */
    _FP_QUAL_INTRASLICE_ADD(unit, stage_fc, bcmFieldQualifyLookupStatus,
...
_field_en_functions_init(_field_funct_t *functions)
{
    ...
    functions->fp_udf_write            = _bcm_field_trx_udf_write;
    functions->fp_udf_delete           = _bcm_field_trx_udf_write;
    functions->fp_udf_read             = _bcm_field_trx_udf_read;
