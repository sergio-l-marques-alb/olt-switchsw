/* 
 * $Id: mbcm.c 1.9.56.1 Broadcom SDK $
...
unimpl(char *desc)
{
    soc_cm_debug(DK_VERBOSE,
		 "WARNING: function %s not implemented for Triumph2\n", desc);
    return SOC_E_NONE;
}

#ifdef BCM_METER_SUPPORT

int bcm_tr2_meter_init(int unit)
{
    return unimpl("bcm_tr_meter_init");
}

int bcm_tr2_meter_create(int unit, int port, int *mid)
{
    return unimpl("bcm_tr_meter_create");
}

int bcm_tr2_meter_delete(int unit, int port, int mid)
{
    return unimpl("bcm_tr_meter_delete");
}

int bcm_tr2_meter_delete_all(int unit)
{
    return unimpl("bcm_tr_meter_delete_all");
}

int bcm_tr2_meter_get(int unit, int port, int mid,
		     uint32 *kbits_sec, uint32 *kbits_burst)
{
    return unimpl("bcm_tr_meter_get");
}

int bcm_tr2_meter_set(int unit, int port, int mid,
		     uint32 kbits_sec, uint32 kbits_burst)
{
    return unimpl("bcm_tr_meter_set");
}

int bcm_tr2_ffppacketcounter_set(int unit, int port, int mid,
				uint64 val)
{
    return unimpl("bcm_tr_ffppacketcounter_set");
}

int bcm_tr2_ffppacketcounter_get(int unit, int port, int mid,
				uint64 *val)
{
    return unimpl("bcm_tr_ffppacketcounter_get");
}

int bcm_tr2_ffpcounter_init(int unit)
{
    return unimpl("bcm_tr_ffpcounter_init");
}

int bcm_tr2_ffpcounter_create(int unit, int port, int *ffpcounterid)
{
    return unimpl("bcm_tr_ffpcounter_create");
}

int bcm_tr2_ffpcounter_delete(int unit, int port, int ffpcounterid)
{
    return unimpl("bcm_tr_ffpcounter_delete");
}

int bcm_tr2_ffpcounter_delete_all(int unit)
{
    return unimpl("bcm_tr_ffpcounter_delete_all");
}

int bcm_tr2_ffpcounter_set(int unit, int port, int ffpcounterid,
			  uint64 val)
{
    return unimpl("bcm_tr_ffpcounter_set");
}

int bcm_tr2_ffpcounter_get(int unit, int port, int ffpcounterid,
			  uint64 *val)
{
    return unimpl("bcm_tr_ffpcounter_get");
}

#endif /* BCM_METER_SUPPORT */

mbcm_functions_t mbcm_triumph2_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_tr2_cosq_init,
    bcm_tr2_cosq_detach,
    bcm_tr2_cosq_config_set,
    bcm_tr2_cosq_config_get,
    bcm_tr2_cosq_mapping_set,
    bcm_tr2_cosq_mapping_get,
    bcm_tr2_cosq_port_sched_set,
    bcm_tr2_cosq_port_sched_get,
    bcm_tr_cosq_sched_weight_max_get, /* Use TR version */
    bcm_tr2_cosq_port_bandwidth_set,
    bcm_tr2_cosq_port_bandwidth_get,
    bcm_tr2_cosq_discard_set,
    bcm_tr2_cosq_discard_get,
    bcm_tr2_cosq_discard_port_set,
    bcm_tr2_cosq_discard_port_get,
    ...
    /*  Meter functions */
    bcm_tr2_meter_init,
    bcm_tr2_meter_create,
    bcm_tr2_meter_delete,
    bcm_tr2_meter_delete_all,
    bcm_tr2_meter_get,
    bcm_tr2_meter_set,
    bcm_tr2_ffppacketcounter_set,
    bcm_tr2_ffppacketcounter_get,
    bcm_tr2_ffpcounter_init,
    bcm_tr2_ffpcounter_create,
    bcm_tr2_ffpcounter_delete,
    bcm_tr2_ffpcounter_delete_all,
    bcm_tr2_ffpcounter_set,
    bcm_tr2_ffpcounter_get,
...
int bcm_esw_triumph2_mbcm_not_empty;
