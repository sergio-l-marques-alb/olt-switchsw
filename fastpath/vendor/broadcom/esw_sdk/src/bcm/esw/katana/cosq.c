/*
 * $Id: cosq.c 1.13.2.60 Broadcom SDK $
            ...
            while (poll_active) {
                ...
                if (soc_timeout_check(&timeout)) {
                    ...
                    BCM_ERR(("ERROR: Queue %d old L1 index %d wrr0/1_not_empty %d %d\n", 
                              ...
                              wrr1_not_empty));
                    BCM_ERR(("spare %d min_list %d ef_list %d %d\n", spare, min_list, 
                              ef_list)); 
                    return BCM_E_TIMEOUT; 
                 }                    
            }    
                       ...
                       int *mode, int num_weights, int weights[])
{
    ...
    case _BCM_KT_COSQ_NODE_LEVEL_ROOT: /* port scheduler */
        ...
        num_spri = soc_mem_field32_get(unit, LLS_PORT_CONFIGm, &port_cfg, P_NUM_SPRIf);
    ...
    case _BCM_KT_COSQ_NODE_LEVEL_L0: /* L0 scheduler */
        ...
        num_spri = soc_mem_field32_get(unit, LLS_L0_CONFIGm, &l0_cfg, P_NUM_SPRIf);
    ...
    case _BCM_KT_COSQ_NODE_LEVEL_L1: /* L1 scheduler */
        ...
        num_spri = soc_mem_field32_get(unit, LLS_L1_CONFIGm, &l1_cfg, P_NUM_SPRIf);
                        ...
                        uint32 flags)
{
    ...
    if (min_quantum == NULL || max_quantum == NULL || 
        burst_min_quantum == NULL || burst_min_quantum == NULL) {
        return BCM_E_PARAM;
    }
