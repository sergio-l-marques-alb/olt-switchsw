...
_field_katana_lookup_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifySrcPort,
                 _bcmFieldSliceSelFpf1, 0,_bcmFieldSliceSrcTypeSelect, 0, 191, 20);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifySrcModid,
                 _bcmFieldSliceSelFpf1, 0,_bcmFieldSliceSrcTypeSelect, 0, 198, 8);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc, bcmFieldQualifySrcTrunk,
                 _bcmFieldSliceSelFpf1, 0, _bcmFieldSliceSrcTypeSelect, 1,191, 20);
    _FP_QUAL_TWO_SLICE_SEL_ADD(unit, stage_fc,
