/*
 * $Id: l3.c 1.316.26.1 Broadcom SDK $
 ...
 */
STATIC
bcm_error_t _bcm_esw_l3_egress_stat_counter_get(
            int              unit, 
            bcm_if_t         intf_id, 
            bcm_l3_stat_t    stat, 
            uint32           num_entries, 
...
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return _bcm_esw_l3_egress_stat_counter_get(unit,intf_id,stat,
...
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return _bcm_esw_l3_ingress_stat_counter_get(unit,intf_id,stat,
                      num_entries,counter_indexes,counter_values);
    } else
#endif
#if defined(BCM_TRIUMPH2_SUPPORT) || defined(BCM_TRIDENT_SUPPORT)
...
{ 
    ...
    if (flags & BCM_L3_QUEUE_MAP) {
        ...
        if (SOC_MEM_FIELD_VALID(unit, mem, EH_TAG_TYPEf)) {
            soc_mem_field32_set(unit, mem, &in_entry, EH_TAG_TYPEf, 2);
        }
    } else {
          /* set EH_TAG_TYPE to 1 to indicate that EH_QUEUE_TAG is the
                  actual cosq */
        if (SOC_MEM_FIELD_VALID(unit, mem, EH_TAG_TYPEf)) {
            soc_mem_field32_set(unit, mem, &in_entry, EH_TAG_TYPEf, 1);
        }
    }
    ...
    if (SOC_IS_XGS3_SWITCH(unit) && soc_feature(unit, soc_feature_l3)) {
        ...
        if (ecmp->max_paths > 0) {
            rv = bcm_xgs3_l3_egress_multipath_max_create(unit, ecmp->flags,
                    ecmp->max_paths, intf_count, intf_array, &ecmp->ecmp_intf);
        } else {
            rv = bcm_xgs3_l3_egress_multipath_create(unit, ecmp->flags,
                    intf_count, intf_array, &ecmp->ecmp_intf);
        }
...
{
    return _bcm_esw_l3_egress_ecmp_create(unit, ecmp, intf_count, intf_array,
            BCM_L3_ECMP_MEMBER_OP_SET, 0);
}
...
bcm_esw_l3_egress_ecmp_add(int unit, bcm_l3_egress_ecmp_t *ecmp, bcm_if_t intf)
{
    ...
    if (SOC_IS_XGS3_SWITCH(unit) && soc_feature(unit, soc_feature_l3)) {
        ...
        rv = _bcm_esw_l3_egress_ecmp_create(unit, ecmp, intf_count + 1,
                intf_array, BCM_L3_ECMP_MEMBER_OP_ADD, intf);
        ...
        bcm_if_t intf)
{
    ...
    if (SOC_IS_XGS3_SWITCH(unit) && soc_feature(unit, soc_feature_l3)) {
        ...
        ecmp->flags |= BCM_L3_REPLACE | BCM_L3_WITH_ID;
        rv = _bcm_esw_l3_egress_ecmp_create(unit, ecmp, intf_count - 1,
                intf_array, BCM_L3_ECMP_MEMBER_OP_DELETE, intf);
            ...
            bcm_stat_value_t  *counter_values)
{
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return _bcm_esw_l3_vrf_stat_counter_get(unit,vrf,stat,
                      num_entries,counter_indexes,counter_values);
    } else
#endif
#if defined(BCM_TRIUMPH2_SUPPORT) || defined(BCM_TRIDENT_SUPPORT)
    if (soc_feature(unit,soc_feature_gport_service_counters)) {
        ...
        rv = bcm_esw_l3_vrf_stat_get(unit,vrf,stat,&val);
 ...
 *      BCM_E_XXX
 */
bcm_error_t bcm_esw_l3_host_stat_attach(
            int unit,
            bcm_l3_host_t *info,
            uint32 stat_counter_id)
{
 ...
 *
 */
bcm_error_t bcm_esw_l3_host_stat_detach(
            int unit,
            bcm_l3_host_t *info)
{
#if defined(BCM_TRIUMPH3_SUPPORT)
 ...
 *
 */
bcm_error_t bcm_esw_l3_host_stat_counter_get(
            int unit,
            bcm_l3_host_t *info,
            bcm_l3_stat_t stat,
            uint32 num_entries,
...
{
#if defined(BCM_TRIUMPH3_SUPPORT)
    return _bcm_tr3_l3_host_stat_counter_get(
                unit, info, stat, num_entries, counter_indexes, counter_values);
#else
    return BCM_E_UNAVAIL;
#endif
}
 ...
 *
 */
bcm_error_t bcm_esw_l3_host_stat_counter_set(
            int unit,
            bcm_l3_host_t *info,
            bcm_l3_stat_t stat,
            uint32 num_entries,
...
{
#if defined(BCM_TRIUMPH3_SUPPORT)
    return _bcm_tr3_l3_host_stat_counter_set(
                unit, info, stat, num_entries, counter_indexes, counter_values);
#else
    return BCM_E_UNAVAIL;
#endif
 ...
 *
 */
bcm_error_t bcm_esw_l3_host_stat_id_get(
            int unit,
            bcm_l3_host_t *info,
            bcm_l3_stat_t stat,
            uint32 *stat_counter_id)
...
bcm_error_t  bcm_esw_l3_route_stat_attach (
                            int                 unit,
                            bcm_l3_route_t	    *info,
                            uint32              stat_counter_id)
{
 ...
 *
 */
bcm_error_t  bcm_esw_l3_route_stat_detach (
                            int                 unit,
                            bcm_l3_route_t	    *info)
{
int     rv = BCM_E_UNAVAIL;
 ...
 *
 */
 bcm_error_t  bcm_esw_l3_route_stat_counter_get(
                            int                 unit, 
                            bcm_l3_route_t	    *info,
 ...
 *
 */
 bcm_error_t  bcm_esw_l3_route_stat_counter_set(
                            int                 unit, 
                            bcm_l3_route_t	    *info,
                            bcm_l3_route_stat_t stat, 
                            uint32              num_entries, 
 ...
 */
 ...
 bcm_error_t  bcm_esw_l3_route_stat_multi_get(
                            int                 unit, 
                            bcm_l3_route_t	    *info,
                            int                 nstat, 
 ...
 *
 */
 bcm_error_t  bcm_esw_l3_route_stat_multi_get32(
                            int                 unit, 
                            bcm_l3_route_t	    *info,
                            int                 nstat, 
                            bcm_l3_route_stat_t *stat_arr,
 ...
 *
 */
bcm_error_t  bcm_esw_l3_route_stat_multi_set(
                            int                 unit, 
                            bcm_l3_route_t	    *info,
                            int                 nstat, 
                            bcm_l3_route_stat_t *stat_arr,
 ...
 */
 ...
 bcm_error_t  bcm_esw_l3_route_stat_multi_set32(
                            int                 unit, 
                            bcm_l3_route_t	    *info,
                            int                 nstat, 
                            bcm_l3_route_stat_t *stat_arr,
 ...
 */
 ...
 bcm_error_t  bcm_esw_l3_route_stat_id_get(
                            int                 unit,
                            bcm_l3_route_t	    *info,
                            bcm_l3_route_stat_t stat, 
                            uint32              *stat_counter_id) 
