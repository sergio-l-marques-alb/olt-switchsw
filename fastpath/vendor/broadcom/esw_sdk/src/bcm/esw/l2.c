/*
 * $Id: l2.c 1.256.2.21 Broadcom SDK $
    ...
    if (soc_feature(unit, soc_feature_class_based_learning)) {
        ...
        if (soc_mem_is_valid(unit, PORT_CBL_TABLE_MODBASEm)) {
            ...
            if (!SOC_WARM_BOOT(unit)) {
                ...
                /* PORT_CBL_TABLE_MODBASE should be 0 for all modid which
                 * should match with the allocated default profile index */
            }
