/*
 * $Id: cosq.c 1.80.2.18 Broadcom SDK $
                        ...
                        uint32 burst_quantum, uint32 flags)
{
    ...
    if (COMPILER_64_NE(rval64, orig_rval64)) { /* value changed */
        if (orig_burst != min_quantum) { /* we use min_quantum for min burst */
