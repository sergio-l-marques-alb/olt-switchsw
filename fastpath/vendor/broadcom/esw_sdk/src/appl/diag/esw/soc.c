/*
 * $Id: soc.c 1.34.76.1 Broadcom SDK $
...
char cmd_cmicm_intr_usage[] =
    "Usages:\n"
    "  CmicmINTR <offset> Enable   [<mask> | <irq_name> ...]   - Enable interrupts\n"
    "  CmicmINTR <offset> Disable  [<mask> | <irq_name> ...]   - Disable interrupts\n"
    "  CmicmINTR <offset> Mask                                 - Show current mask reg\n"
    "  CmicmINTR <offset> Pending                              - Show current state of interrupts\n"
    "  CmicmINTR <offset> Names                                - List interrupt names\n"
    "  Offset value should be 0 - 4\n";

typedef struct intr_info_s {
    char *name;
    soc_field_t field;
    soc_reg_t status_reg; 
    soc_reg_t config_reg; /* specifying the config register tells that the field is writable */ 
} intr_info_t;

intr_info_t cmicm_irq_info[][32] = 
{ 
    /* array of all possible fields of all supported devices */
    {
        {"SBUSDMA_CH1_DONE", SBUSDMA_CH1_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"SBUSDMA_CH0_DONE", SBUSDMA_CH0_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"FIFO_CH3_DMA_INTR", FIFO_CH3_DMA_INTRf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"FIFO_CH2_DMA_INTR", FIFO_CH2_DMA_INTRf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"FIFO_CH1_DMA_INTR", FIFO_CH1_DMA_INTRf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"FIFO_CH0_DMA_INTR", FIFO_CH0_DMA_INTRf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"SBUSDMA_CH2_DONE", SBUSDMA_CH2_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"MIIM_OP_DONE", MIIM_OP_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH3_DESC_DONE", CH3_DESC_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH3_CHAIN_DONE", CH3_CHAIN_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH2_DESC_DONE", CH2_DESC_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH2_CHAIN_DONE", CH2_CHAIN_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH1_DESC_DONE", CH1_DESC_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH1_CHAIN_DONE", CH1_CHAIN_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH0_DESC_DONE", CH0_DESC_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH0_CHAIN_DONE", CH0_CHAIN_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH3_INTR_COALESCING_INTR", CH3_INTR_COALESCING_INTRf, 
         CMIC_CMC0_IRQ_STAT0r, CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH2_INTR_COALESCING_INTR", CH2_INTR_COALESCING_INTRf, 
         CMIC_CMC0_IRQ_STAT0r, CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH1_INTR_COALESCING_INTR", CH1_INTR_COALESCING_INTRf, 
         CMIC_CMC0_IRQ_STAT0r, CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CH0_INTR_COALESCING_INTR", CH0_INTR_COALESCING_INTRf, 
         CMIC_CMC0_IRQ_STAT0r, CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"SCHAN_OP_DONE", SCHAN_OP_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"CROSS_COUPLED_MEMORYDMA_DONE", CROSS_COUPLED_MEMORYDMA_DONEf, 
         CMIC_CMC0_IRQ_STAT0r, CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"SW_INTR", SW_INTRf, CMIC_CMC0_IRQ_STAT0r, CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"SBUSDMA_ECCERR", SBUSDMA_ECCERRf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"SLAM_DMA_DONE", SLAM_DMA_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"TABLE_DMA_DONE", TABLE_DMA_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {"STATS_DMA_ITER_DONE", STATS_DMA_ITER_DONEf, CMIC_CMC0_IRQ_STAT0r, 
         CMIC_CMC0_PCIE_IRQ_MASK0r}, 
        {NULL, 0, 0, 0},  
    },

    {  
        {"I2C_INTR", I2C_INTRf, CMIC_CMC0_IRQ_STAT1r, CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"PCIE_ECRC_ERR_INTR", PCIE_ECRC_ERR_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"TIMESYNC_INTR", TIMESYNC_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"PHY_LINSCAN_LINKSTATUS_CHD", PHY_LINKSCAN_LINKSTATUS_CHDf, 
         CMIC_CMC0_IRQ_STAT1r, CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"PHY_PAUSESCAN_PAUSESTATUS_CHD", PHY_PAUSESCAN_PAUSESTATUS_CHDf, 
         CMIC_CMC0_IRQ_STAT1r, CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"SPI_INTERRUPT", SPI_INTERRUPTf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"UART0_INTERRUPT", UART0_INTERRUPTf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"UART1_INTERRUPT", UART1_INTERRUPTf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"COMMON_SCHAN_DONE", COMMON_SCHAN_DONEf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"MIIM_OP_DONE", MIIM_OP_DONEf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"GPIO_INTR", GPIO_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"CHIP_FUNC_INTR", CHIP_FUNC_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"UC_0_PMUIRQ", UC_0_PMUIRQf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"UC_1_PMUIRQ", UC_1_PMUIRQf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"WDT_0_INTR", WDT_0_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"WDT_1_INTR", WDT_1_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"TIM0_INTR1", TIM0_INTR1f, CMIC_CMC0_IRQ_STAT1r,
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"TIM0_INTR2", TIM0_INTR2f, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"TIM1_INTR1", TIM1_INTR1f, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"TIM1_INTR2", TIM1_INTR2f, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"PCIEINTF_NEEDS_CLEANUP", PCIEINTF_NEEDS_CLEANUPf, 
         CMIC_CMC0_IRQ_STAT1r, CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"SRAM_ECC_INTR", SRAM_ECC_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {"BROADSYNC_INTR", BROADSYNC_INTRf, CMIC_CMC0_IRQ_STAT1r, 
         CMIC_CMC0_PCIE_IRQ_MASK1r}, 
        {NULL, 0, 0, 0},  
    },

    { 
        {"CHIP_PARITY_INTERUPT_STATUS", CHIP_PARITY_INTERUPT_STATUSf, 
         CMIC_CMC0_IRQ_STAT2r, CMIC_CMC0_PCIE_IRQ_MASK2r}, 
        /* Katana uses field name as CHIP_PARITY_INTERUPT_STATUSf in status 
         * register(CMIC_CMC0_IRQ_STAT2r) and uses MASKf in mask 
         * register(CMIC_CMC0_PCIE_IRQ_MASK2r) So add 2 entries, one for status 
         * register with config reg as 0 and other entry for write register 
         * with status register as 0. if CHIP_PARITY_INTERUPT_STATUS is used 
         * to enable a interrupt, then we will do the following try to set 
         * CHIP_PARITY_INTERUPT_STATUSf to 1 in CMIC_CMC0_PCIE_IRQ_MASK2r. 
         * But since there is no such field, the set will fail. 
         * we will continue to the next entry which has config register as 0. 
         * so go to next entry. 
         * This entry contains proper field. So set will be successful
         */
         {"CHIP_PARITY_INTERUPT_STATUS", CHIP_PARITY_INTERUPT_STATUSf, 
          CMIC_CMC0_IRQ_STAT2r, 0}, 
         {"CHIP_PARITY_INTERUPT_STATUS", MASKf, 0, CMIC_CMC0_PCIE_IRQ_MASK2r}, 
         {NULL, 0, 0, 0},  
    },

    {
        {"SBUS_SLAVE_INTERRUPTS", SBUS_SLAVE_INTERRUPTSf, CMIC_CMC0_IRQ_STAT3r,
         CMIC_CMC0_PCIE_IRQ_MASK3r}, 
        {"SBUS_SLAVE_INTERRUPTS", SBUS_SLAVE_INTERRUPTSf, CMIC_CMC0_IRQ_STAT3r, 0}, 
        {"SBUS_SLAVE_INTERRUPTS", MASKf, 0, CMIC_CMC0_PCIE_IRQ_MASK3r}, 
        {NULL, 0, 0, 0},  
    },

    {  
        {"SBUS_SLAVE_INTERRUPTS4", SBUS_SLAVE_INTERRUPTSf, CMIC_CMC0_IRQ_STAT4r, 
         CMIC_CMC0_PCIE_IRQ_MASK4r}, 
        {"SBUS_SLAVE_INTERRUPTS4", SBUS_SLAVE_INTERRUPTSf,  CMIC_CMC0_IRQ_STAT4r, 0}, 
        {"SBUS_SLAVE_INTERRUPTS4", MASKf, 0, CMIC_CMC0_PCIE_IRQ_MASK4r}, 
        {NULL, 0, 0, 0},  
    } 
}; 

static int 
cmicm_parse_irq_list_and_set(int unit, args_t *a, int ch, uint32* old_mask, 
                             int enable)
{
    char *intr;
    int i = 0;
    int j = 0;
    intr_info_t* intr_info_ptr = NULL;
    uint32 irq_mask = 0;
    ...
    intr_info_ptr = cmicm_irq_info[ch];

    if ((irq_mask = sal_ctoi(intr, 0)) == 0) { /* Assume arg list */
        do {
            found = 0;  
            for (i = 0; intr_info_ptr[i].name; i++) {
                if (!parse_cmp(intr_info_ptr[i].name, intr, '\0')) {
                    continue;
                }

                if (!intr_info_ptr[i].config_reg || 
                    !SOC_REG_IS_VALID(unit, intr_info_ptr[i].config_reg)) {
                    continue;
                }
             
                if (!soc_reg_field_valid(unit, intr_info_ptr[i].config_reg, 
                                         intr_info_ptr[i].field)) {
                    continue;
                } 

                field_len = soc_reg_field_length(unit, 
                                                 intr_info_ptr[i].config_reg,
                                                 intr_info_ptr[i].field);
                max_val = (1 << field_len) - 1;
                reg_info = &SOC_REG_INFO(unit, intr_info_ptr[i].config_reg);  
                for (j = 0; j < reg_info->nFields; j++) {  
                    field_info = &reg_info->fields[reg_info->nFields - 1 - j];
                    if (field_info->flags & SOCF_RES) {
                        continue;
                    }

                    if (field_info->field == intr_info_ptr[i].field) { 
                        irq_mask |= (max_val << field_info->bp);
                        found = 1;
                        break;
                    } 
                }
            ...
            if (!found) {
                printk("Unable to find the interrupt %s\n", intr);
            } 
        } while ((intr = ARG_GET(a)) != NULL);
    } 
    
    /* If we reach here then we should have irq_mask */
    switch (ch) {
       case 0:
           if (enable) {
               *old_mask = soc_cmicm_intr0_enable(unit, irq_mask); 
           } else {
               *old_mask = soc_cmicm_intr0_disable(unit, irq_mask); 
           }
           break;        

       case 1:
           if (enable) {
               *old_mask = soc_cmicm_intr1_enable(unit, irq_mask); 
           } else {
               *old_mask = soc_cmicm_intr1_disable(unit, irq_mask); 
           }
           break;        

       case 2:
           if (enable) {
               *old_mask = soc_cmicm_intr2_enable(unit, irq_mask); 
           } else {
               *old_mask = soc_cmicm_intr2_disable(unit, irq_mask); 
           }
           break;        

       case 3:
           if (enable) {
               *old_mask = soc_cmicm_intr3_enable(unit, irq_mask); 
           } else {
               *old_mask = soc_cmicm_intr3_disable(unit, irq_mask); 
           }
           break;        

       case 4:
           if (enable) {
               *old_mask = soc_cmicm_intr4_enable(unit, irq_mask); 
           } else {
               *old_mask = soc_cmicm_intr4_disable(unit, irq_mask); 
           }
           break;        
...
print_cmicm_intr_names(int ch)
{
    ...
    for (i = 0; intr_info_ptr[i].name; i++) { 
        ...
        if (!intr_info_ptr[i].status_reg) {
            continue; 
        } 

        if (!SOC_REG_IS_VALID(unit, intr_info_ptr[0].status_reg)) {
            continue;
        }

        if (soc_reg_field_valid(unit, intr_info_ptr[i].status_reg, 
                                intr_info_ptr[i].field)) {
            if (!(prev && !sal_strcasecmp(prev, intr_info_ptr[i].name))) {
                printk("%s\n", intr_info_ptr[i].name);  
            }   
            prev = intr_info_ptr[i].name;   
        }
    }
}

static int 
prepare_names_list_for_channel(char** names, int* count, int ch)
{
    uint32 rval;
    int unit = 0; 
    intr_info_t* intr_info_ptr = cmicm_irq_info[ch];
    int i = 0, j = 0;
    

    for (i = 0; intr_info_ptr[i].name; i++) {
        if (!intr_info_ptr[i].status_reg  || 
            !SOC_REG_IS_VALID(unit, intr_info_ptr[i].status_reg)) {
            continue; 
        } 

        soc_pci_getreg(unit, soc_reg_addr(unit, intr_info_ptr[i].status_reg, 
                       REG_PORT_ANY, 0), &rval);
        if (!soc_reg_field_valid(unit, intr_info_ptr[i].status_reg, 
                                 intr_info_ptr[i].field)) {
            continue;    
        ...
        if (soc_reg_field_get(unit, intr_info_ptr[i].status_reg, rval, 
                              intr_info_ptr[i].field)) {
            names[j++] =  intr_info_ptr[i].name; 
        }
        i++; 
    } 
    *count = j; 
...
cmd_cmicm_intr(int unit, args_t *a)
{
    ...
    if (!soc_feature(unit, soc_feature_cmicm)) {
        printk("Please use INTR command\n"); 
        return CMD_FAIL; 
    }   

    ch = strtoul(subcmd, NULL, 10);  
    if (ch < 0 || ch > 4) {
        printk("Invalid cmc number. Range is from 0 - 4\n");
        return CMD_FAIL;  
    }   

    while ( (subcmd = ARG_GET(a)) != NULL) {
        cmd_valid = 1; 
        if (!sal_strcasecmp(subcmd, "Pending")) {
            prepare_names_list_for_channel(names, &count, ch);   
            if (count) {
                printk("Pending interrupts for channel %d are:\n",ch); 
                for (i = 0; i < count; i++) {
                    printk("%s\n", names[i]);   
                } 
            } else {
                printk("No Pending interrupts\n");
            }   
            return CMD_OK;
        } else if (!sal_strcasecmp(subcmd, "names")) {
            print_cmicm_intr_names(ch);
            return CMD_OK;
        } else if (!sal_strcasecmp(subcmd, "Enable")) {
            if (cmicm_parse_irq_list_and_set(unit, a, ch, &old_mask, 1) != 0) {
                printk("Unable to enable the interrupts\n");
                return CMD_FAIL;
            }
            printk("Old Mask was 0x%x\n", old_mask);  
        } else if (!sal_strcasecmp(subcmd, "Disable")) {
            if (cmicm_parse_irq_list_and_set(unit, a, ch, &old_mask, 0) != 0) {
                printk("Unable to disable the interrupts\n");
                return CMD_FAIL;
            }  
            printk("Old Mask was 0x%x\n", old_mask);  
        } else if (!sal_strcasecmp(subcmd, "mask")) {
             switch (ch) {
                 case 0: 
                     old_mask = soc_cmicm_intr0_enable(unit, 0); 
                     break;

                 case 1: 
                     old_mask = soc_cmicm_intr1_enable(unit, 0); 
                     break;

                 case 2: 
                     old_mask = soc_cmicm_intr2_enable(unit, 0); 
                     break;

                 case 3: 
                     old_mask = soc_cmicm_intr3_enable(unit, 0); 
                     break;

                 case 4: 
                     old_mask = soc_cmicm_intr4_enable(unit, 0); 
                     break;
             }
             printk("Mask is 0x%x\n", old_mask);
        } else {
...
cmd_intr(int unit, args_t *a)
{
    ...
    if (soc_feature(unit, soc_feature_cmicm)) {
        printk("Please use CmicmINTR command\n"); 
        return CMD_FAIL; 
    }   
