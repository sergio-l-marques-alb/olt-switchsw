/* 
 * $Id: reg_skip.c 1.127.2.3 Broadcom SDK $
...
rval_test_skip_reg(int unit, soc_regaddrinfo_t *ainfo) {
    ...
    if(SOC_IS_ARAD(unit)) {
        switch(ainfo->reg) {
            case CFC_PARITY_ERR_CNTr:
            case DRCA_INTERRUPT_REGISTERr:
            case DRCD_INTERRUPT_REGISTERr:
            case ECI_VERSION_REGISTERr:
            case ECI_REG_0272r:
            case ECI_GLOBAL_16r:
            case EGQ_DBF_ECC_1B_ERR_ADDRr:
            case EGQ_DBF_ECC_2B_ERR_ADDRr:
            case FCR_ECC_2B_ERR_CNTr:
            case FDR_CPU_DATA_CELL_A_PRIMARYr:
            case FDR_REG_01B7r:
            case FDR_CPU_DATA_CELL_B_PRIMARYr:
            case FDR_REG_01CAr:
            case FDR_CPU_DATA_CELL_C_PRIMARYr:
            case FDR_REG_01DDr:
            case FDR_CPU_DATA_CELL_D_PRIMARYr:
            case FDR_REG_01F0r:
            case FDR_ECC_1B_ERR_CNT_PRIMARYr:
            case FDR_INBAND_HEADERr:
            case FDR_INBAND_PAYLOAD_LSBr:
            case FDR_INBAND_PAYLOAD_MSBr:
            case FDT_ECC_1B_ERR_CNTr:
            case FDT_ECC_2B_ERR_CNTr:
            case FDT_PARITY_ERR_CNTr:
            case FMAC_ECC_1B_ERR_ADDRr:
            case FMAC_ECC_2B_ERR_ADDRr:
            case IDR_INTERRUPT_REGISTERr:
            case IDR_MMU_ECC_ERR_CNTr:
            case IDR_MMU_ECC_ERR_REGr:
            case IDR_PARITY_ERR_CNTr:
            case IDR_WATERMARK_REG_7r:
            case IPS_ECC_1B_ERR_CNTr:
            case IPS_ECC_2B_ERR_CNTr:
            case IPS_PARITY_ERR_CNTr:
            case IPT_CRC_ERR_DELETED_BUFFERS_FIFO_HEADr:
            case IPT_ECC_1B_ERR_CNTr:
            case IPT_ECC_2B_ERR_CNTr:
            case IPT_PARITY_ERR_CNTr:
            case IRE_ECC_1B_ERR_CNTr:
            case IRE_ECC_2B_ERR_CNTr:
            case IRE_PARITY_ERR_CNTr:
            case IRR_ECC_1B_ERR_CNTr:
            case IRR_PARITY_ERR_CNTr:
            case IRR_REG_0202r:
            case IRR_REG_0209r:
            case IRR_REG_0210r:
            case IRR_WATERMARK_REG_1r:
            case IRR_WATERMARK_REG_3r:
            case MMU_ECC_1B_ERR_CNTr:
            case MMU_ECC_2B_ERR_CNTr:
            case NBI_ILKN_MULTIPLE_USE_BITS_STATUSr:
            case OAMP_ECC_1B_ERR_CNTr:
            case OAMP_ECC_2B_ERR_CNTr:
            case OAMP_PARITY_ERR_CNTr:
            case OLP_PARITY_ERR_CNTr:
            case SCH_LAST_FLOW_RESTART_EVENTr:
                return 1; /* Skip these registers */
            default:
                break;
        }
