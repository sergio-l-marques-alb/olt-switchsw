/*
 * $Id: testlist.c 1.119.8.4 Broadcom SDK $
...
----------------------------------------------------------------------------------------------------------------------------------------------------------*/
#if defined (BCM_ESW_SUPPORT) || defined (BCM_SIRIUS_SUPPORT) || defined (BCM_DFE_SUPPORT) || defined (BCM_PETRA_SUPPORT) || defined (BCM_POLAR_SUPPORT)
TEST(1,     "Register reset defaults",  (TALL+T88230)|DPP_DFE|T88030|T89500,            0,                      0,                      rval_test,              1,      0)
#endif /* BCM_ESW_SUPPORT || BCM_SIRIUS_SUPPORT || defined (BCM_DFE_SUPPORT)|| defined (BCM_PETRA_SUPPORT) */
...
#endif /* BCM_ESW_SUPPORT ||BCM_SIRIUS_SUPPORT || BCM_DFE_SUPPORT || BCM_PETRA_SUPPORT || BCM_POLAR_SUPPORT */
...
TEST(8,     "Memories Flip/Flop Test",               DPP_DFE,             0,                                    0,  mem_flipflop_test,             1,      0)
#endif
#endif
...
TEST(21,    "CPU Benchmarks",           (TALL+TROBO)|DPP_DFE,                   benchmark_init,         benchmark_done,         benchmark_test,         1,      0)
#endif
#if defined (BCM_ESW_SUPPORT) || defined (BCM_PETRA_SUPPORT)
TEST(22,    "CPU S/G, Reload",          (TRC+TSEL+TALL)/*|DPP_DFE*/, lb_reload_init,   lb_reload_done,         lb_reload_test,         1,      0)
TEST(23,    "CPU S/G, Simple",          (TRC+TSEL+TALL)/*|DPP_DFE*/,  lb_sg_dma_init,  lb_sg_dma_done,         lb_sg_dma_test,         1,      0)
TEST(24,    "CPU S/G, Random",          (TRC+TSEL+TALL)/*|DPP_DFE*/,  lb_random_init,  lb_random_done,         lb_random_test,         1,      0)
#endif /* BCM_ESW_SUPPORT */
TEST(30,    "Counter widths",           (TRC+TSEL+TALL+T88230+TROBO)| DPP_DFE | T88030 ,   0,                      0,                      ctr_test_width,         1,      0)
TEST(31,    "Counter read/write",       (TRC+TSEL+TALL+T88230+TROBO)| DPP_DFE | T88030,   0,                      0,                      ctr_test_rw,            1,      0)
...
TEST(40,    "BCM Packet Send",          (TALL+TROBO) | DPP_DFE,                    tpacket_tx_init,        tpacket_tx_done,        tpacket_tx_test,        1,      0)
#if defined(BCM_FIELD_SUPPORT) || defined(BCM_FE2000_SUPPORT) || defined(BCM_ROBO_SUPPORT) || defined (BCM_PETRA_SUPPORT)
TEST(41,    "BCM Packet Receive",       (TRC+TXGSSW+TROBO+T88020)/* | DPP_DFE*/, rpacket_init,  rpacket_done,           rpacket_test,           1,      0)
#endif /* BCM_FIELD_SUPPORT || BCM_FE2000_SUPPORT ||  BCM_ROBO_SUPPORT || defined (BCM_PETRA_SUPPORT)*/
#if defined (BCM_ESW_SUPPORT) || defined (BCM_PETRA_SUPPORT)
TEST(48,    "MAC Loopback - Mark 2",    (TRC+TALL)/*|DPP_DFE*/,               lb2_mac_init,           lb2_done,               lb2_port_test,          1,      0)
#endif /* BCM_ESW_SUPPORT || defined (BCM_PETRA_SUPPORT) */
TEST(49,    "PHY Loopback - Mark 2",    (TRC+TALL+TROBO)/*|DPP_DFE*/,              lb2_phy_init,           lb2_done,               lb2_port_test,          1,      0)
...
TEST(53,    "DDR Memory Fill/Verify",   TRC+TALL+T88030,               ddr_test_init,          ddr_test_done,          ddr_test,               1,      0)
#endif
#ifdef BCM_XGS_SWITCH_SUPPORT
...
TEST(72,    "Traffic Test",             (TRC+TALL+TROBO)/*|DPP_DFE*/,                traffic_test_init,      traffic_test_done,      traffic_test,           1,      0)
...
#endif
TEST(90,    "TX Reload Test",        (TRC+TALL)|DPP_DFE,                   pktspeed_test_init,   pktspeed_test_done,        pktspeed_test_tx,        1,      0)
TEST(91,    "RX Reload Test",        (TRC+TALL)/*|DPP_DFE*/,                   pktspeed_test_init,   pktspeed_test_done,        pktspeed_test_rx,        1,      0)

#if defined(BCM_TRX_SUPPORT) /* || defined (BCM_PETRA_SUPPORT)  */
TEST(100,   "VLAN xlate Overflow Ins",  (T56624|T56820)&(~T56640), tr_vlan_xlate_ov_test_init, tr_vlan_xlate_test_done, tr_vlan_xlate_test_ov,
                                                                                                                                        1,      0)
TEST(101,   "VLAN xlate Hashing",       (T56624|T56820)&(~T56640), tr_vlan_xlate_hash_test_init, tr_vlan_xlate_test_done, tr_vlan_xlate_test_hash,
                                                                                                                                        1,      0)
TEST(102,   "Egr VLAN xlate Ovrflw Ins", (T56624|T56820)&(~T56640), tr_egr_vlan_xlate_ov_test_init, tr_egr_vlan_xlate_test_done, tr_egr_vlan_xlate_test_ov,
                                                                                                                                        1,      0)
TEST(103,   "Egr VLAN xlate Hashing",   (T56624|T56820)&(~T56640), tr_egr_vlan_xlate_hash_test_init, tr_egr_vlan_xlate_test_done, tr_egr_vlan_xlate_test_hash,
                                                                                                                                        1,      0)
#ifdef BCM_TRIUMPH_SUPPORT
TEST(104,   "MPLS Overflow Ins",        (T56624)&(~T56640), tr_mpls_ov_test_init, tr_mpls_test_done,     tr_mpls_test_ov,        1,      0)
TEST(105,   "MPLS Hashing",             (T56624)&(~T56640), tr_mpls_hash_test_init, tr_mpls_test_done,   tr_mpls_test_hash,      1,      0)
...
TEST(140,    "DDR bist test",            T56450+DPP_DFE,      ddr_bist_test_init,          ddr_bist_test_done,              ddr_bist_test,           1, 0)
#endif
...
#ifdef BCM_ARAD_SUPPORT
TEST(142,    "ARAD field tests",          DPP_DFE,      arad_field_test_init,         arad_field_test_done,             arad_field_test,       1, 0)
#endif

#if defined(BCM_ARAD_SUPPORT) || defined(BCM_DFE_SUPPORT)
#ifdef BCM_WARM_BOOT_SUPPORT
TEST(143,    "WARMBOOT test",        DPP_DFE,      init_warmboot_test_init,      init_warmboot_test_done,          init_warmboot_test,    1, 0)
#endif /*BCM_WARM_BOOT_SUPPORT*/
#endif /*BCM_ARAD_SUPPORT*/
#if defined(BCM_TRIUMPH2_SUPPORT)
TEST(144, "Software Error Recovery", T56634 , ser_test_init, ser_test_done, ser_test, 1, 0)
#endif
};
