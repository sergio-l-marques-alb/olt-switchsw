...
#if PLAT_BCM_CHIP == L7_BCM_RAVEN
#define PLAT_ACL_MAX_RULES_PER_MULTILIST          12  /* 18 as per actual tbl size */
#else
...
#if PLAT_BCM_CHIP == L7_BCM_RAVEN
#define     PLAT_L3_ARP_CACHE_SIZE                512   /* 2048 as per actual tbl size */
#define     PLAT_IPV4_ECMP_ROUTES_MAX             512   /* 4000 as per actual tbl size */
#define     PLAT_L3_ROUTE_TBL_SIZE_TOTAL          512   /* 4000 as per actual tbl size */
#else
#define     PLAT_L3_ARP_CACHE_SIZE                63 
#define     PLAT_IPV4_ECMP_ROUTES_MAX             64
#define     PLAT_L3_ROUTE_TBL_SIZE_TOTAL          64
#endif
#else
#if PLAT_BCM_CHIP == L7_BCM_RAVEN
#define     PLAT_L3_ARP_CACHE_SIZE                512   /* 4096 as per actual tbl size */
#define     PLAT_IPV4_ECMP_ROUTES_MAX             512   /* 8000 as per actual tbl size */
#define     PLAT_L3_ROUTE_TBL_SIZE_TOTAL          512   /* 8000 as per actual tbl size */
#else
#define     PLAT_L3_ARP_CACHE_SIZE                254
#define     PLAT_IPV4_ECMP_ROUTES_MAX             254
#define     PLAT_L3_ROUTE_TBL_SIZE_TOTAL          254 
#endif
...
#define     PLAT_IPV6_ECMP_ROUTES_MAX             PLAT_IPV6_ROUTE_TBL_SIZE_TOTAL
#else
#define     PLAT_IPV6_ROUTE_TBL_SIZE_TOTAL        127
#define     PLAT_IPV6_NDP_CACHE_SIZE              512
#define     PLAT_IPV6_ECMP_ROUTES_MAX             127
#endif
...
/* PIMSM */
#define PLAT_PIMSM_MAX_S_G_RPT_IPV4_TABLE_SIZE            64
#define PLAT_PIMSM_MAX_S_G_RPT_IPV6_TABLE_SIZE            64
#define PLAT_PIMSM_MAX_S_G_IPV4_TABLE_SIZE                64
#define PLAT_PIMSM_MAX_S_G_IPV6_TABLE_SIZE                64
#define PLAT_PIMSM_MAX_STAR_G_IPV4_TABLE_SIZE             64
#define PLAT_PIMSM_MAX_STAR_G_IPV6_TABLE_SIZE             64
/* PIMDM */
#define PLAT_PIMDM_MAX_MRT_IPV4_TABLE_SIZE                64
#define PLAT_PIMDM_MAX_MRT_IPV6_TABLE_SIZE                64
/* DVMRP */
...
#define PLAT_MGMD_PROXY_MAX_MRT_IPV4_TABLE_SIZE           64
#define PLAT_MGMD_PROXY_MAX_MRT_IPV6_TABLE_SIZE           64
