...
{
{ L7_PHYSICAL_INTF,       2}, /* physical port  = sysmac+2 */
{ L7_STACK_INTF,          0}, /* stack port     = sysmac   */
{ L7_CPU_INTF,            0}, /* cpu port       = sysmac   */
/* Logical Interfaces */    
{ L7_LAG_INTF,            2}, /* lag port       = sysmac+2 */
{ L7_LOGICAL_VLAN_INTF,   2}, /* logical port   = sysmac+2 */
};
