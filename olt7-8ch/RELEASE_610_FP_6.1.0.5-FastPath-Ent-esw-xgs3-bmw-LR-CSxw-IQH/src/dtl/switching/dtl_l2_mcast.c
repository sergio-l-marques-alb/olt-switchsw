...
* @end
*********************************************************************/
L7_RC_t dtlSnoopingEnable(L7_uchar8 family, L7_uint32 intIfNum, L7_uint16 vlanId, L7_uint8 prio)
{
  nimUSP_t usp;
  DAPI_USP_t ddUsp;
  ...
  for (i=0; i<nPorts; i++)
  {
    ...
    dapiCmd.cmdData.snoopConfig.CoS = prio;
...
* @end
*********************************************************************/
L7_RC_t dtlSnoopingDisable(L7_uint32 intIfNum, L7_uint16 vlanId, L7_uchar8 family)
{
  nimUSP_t usp;
  DAPI_USP_t ddUsp;
  DAPI_SYSTEM_CMD_t dapiCmd;
...
* @end
*********************************************************************/
L7_RC_t dtlDhcpSnoopEnable(L7_uchar8 family, L7_uint32 intf, L7_uint16 vlanId)
{
  DAPI_SYSTEM_CMD_t dapiCmd;
  L7_RC_t dr;
  DAPI_USP_t ddUsp;
  ...
  if (usmDbDot3adValidIntfCheck(1,intf))
  {
    // Get list of ports, of this LAG
    nPorts = L7_SYSTEM_N_PORTS;
    if (usmDbDot3adMemberListGet(1,intf,&nPorts,member_list)!=L7_SUCCESS || nPorts==0)
    {
      return L7_FAILURE;
    }
  }
  ...
  for (i=0; i<nPorts; i++)
  {
    ...
    dr = dapiCtl(&ddUsp, DAPI_CMD_SYSTEM_DHCP_CONFIG, &dapiCmd);
    if (dr != L7_SUCCESS)
      return dr;
  }
...
* @end
*********************************************************************/
L7_RC_t dtlDhcpSnoopDisable(L7_uchar8 family, L7_uint32 intf, L7_uint16 vlanId)
{
  DAPI_USP_t ddUsp;
  DAPI_SYSTEM_CMD_t dapiCmd;
  L7_RC_t dr;
