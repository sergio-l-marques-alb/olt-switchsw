...
{
  return dhcpVendorClassOptionAdminModeGet(adminMode);
}
...
{
  return dhcpVendorClassOptionAdminModeSet(adminMode);
}
/******************************************************************
...
{
  return dhcpVendorClassOptionStringGet(optionString);
}
/*********************************************************************
...
{
  return dhcpVendorClassOptionStringSet(optionString);
}
/*********************************************************************
...
{
  return dhcpDNSOptionIsPresent(option);
}
...
{
  return dhcpDomainNameOptionIsPresent(domain);
}
