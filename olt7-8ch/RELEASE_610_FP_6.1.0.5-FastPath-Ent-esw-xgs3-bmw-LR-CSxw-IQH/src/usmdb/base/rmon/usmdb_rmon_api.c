...
**********************************************************************
*
* @filename usmdb_rmon_api.c
*
* @purpose Provide interface to RMON-MIB components
*
* @component base
*
* @comments
...
{
  return rmonEtherStatsEntryGet(Index);
}
...
{
  return rmonEtherStatsEntryNextGet(Index);
}
...
{
  return rmonEtherStatsDataSourceGet(Index, val);
}
...
{
  return usmDbStatGet(UnitIndex, L7_CTR_ETHER_STATS_DROP_EVENTS, Index, val);
}
...
{
  return rmonEtherStatsOwnerGet(Index, buf);
}
...
{
  return rmonEtherStatsStatusGet(Index, val);
}
...
{
  return rmonEtherStatsDataSourceSet(UnitIndex, Index, ifIndex);
}
...
{
  return rmonEtherStatsOwnerSet(Index, buf);
}
...
{
  return rmonEtherStatsStatusSet(Index, val);
}
...
{
  return rmonHistoryControlEntryGet(Index);
}
...
{
  return rmonHistoryControlEntryNextGet(Index);
}
...
{
  return rmonHistoryControlDataSourceGet(Index, val);
}
...
{
  return rmonHistoryControlBucketsRequestedGet(Index, val);
}
...
{
  return rmonHistoryControlBucketsGrantedGet(Index, val);
}
...
{
  return rmonHistoryControlIntervalGet(Index, val);
}
...
{
  return rmonHistoryControlOwnerGet(Index, buf);
}
...
{
  return rmonHistoryControlStatusGet(Index, val);
}
...
{
  return rmonHistoryControlInternalInteraceNumGet(Index, val);
}
...
{
  return rmonHistoryControlDataSourceSet(UnitIndex, Index, val);
}
...
{
  return rmonHistoryControlBucketsRequestedSet(Index, val);
}
...
{
  return rmonHistoryControlIntervalSet(Index, val);
}
...
{
  return rmonHistoryControlOwnerSet(Index, buf);
}
...
{
  return rmonHistoryControlStatusSet(Index, val);
}
...
{
  return rmonEtherHistoryEntryGet(Index, SampleIndex);
}
...
L7_RC_t usmDbEtherHistoryEntryNext ( L7_uint32 UnitIndex, L7_int32 Index, L7_int32 *SampleIndex )
{
  ...
  rc = rmonEtherHistoryEntryNextGet(&tempIndex, SampleIndex);
  if (rc == L7_SUCCESS)
  {
    /* if the history index has changed, return failure */
    if (tempIndex != Index)
    {
      rc = L7_FAILURE;
    }
...
{
  return rmonEtherHistoryIntervalStartGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryDropEventsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryOctetsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryPktsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryBroadcastPktsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryMulticastPktsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryCRCAlignErrorsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryUndersizePktsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryOversizePktsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryFragmentsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryJabbersGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryCollisionsGet(Index, SampleIndex, val);
}
...
{
  return rmonEtherHistoryUtilizationGet(Index, SampleIndex, val);
}
...
{
  return rmonAlarmEntryGet(0, Index);
}
...
{
  return rmonAlarmEntryNextGet(Index);
}
...
{
  return rmonAlarmIntervalGet(Index, val);
}
...
{
  return rmonAlarmVariableGet(Index, buf);
}
...
{
  return rmonAlarmSampleTypeGet(Index, val);
}
...
{
  return rmonAlarmValueGet(Index, val);
}
...
{
  return rmonAlarmStartUpAlarmGet(Index, val);
}
...
{
  return rmonAlarmRisingThresholdGet(Index, val);
}
...
{
  return rmonAlarmFallingThresholdGet(Index, val);
}
...
{
  return rmonAlarmRisingEventIndexGet(Index, val);
}
...
{
  return rmonAlarmFallingEventIndexGet(Index, val);
}
...
{
  return rmonAlarmOwnerGet(Index, buf);
}
...
{
  return rmonAlarmStatusGet(Index, val);
}
...
{
  return rmonAlarmIntervalSet(Index, val);
}
...
{
  return rmonAlarmVariableSet(Index, buf);
}
...
{
  return rmonAlarmSampleTypeSet(Index, val);
}
...
{
  return rmonAlarmStartUpAlarmSet(Index, val);
}
...
{
  return rmonAlarmRisingThresholdSet(Index, val);
}
...
{
  return rmonAlarmFallingThresholdSet(Index, val);
}
...
{
  return rmonAlarmRisingEventIndexSet(Index, val);
}
...
{
  return rmonAlarmFallingEventIndexSet(Index, val);
}
...
{
  return rmonAlarmOwnerSet(Index, buf);
}
...
{
  return rmonAlarmStatusSet(Index, val);
}
...
{
  return rmonEventEntryGet(0, Index);
}
...
{
  return rmonEventEntryNextGet(Index);
}
...
{
  return rmonEventDescriptionGet(Index, buf);
}
...
{
  return rmonEventTypeGet(Index, val);
}
...
{
  return rmonEventCommunityGet(Index, buf);
}
...
{
  return rmonEventLastTimeSentGet(Index, val);
}
...
{
  return rmonEventOwnerGet(Index, buf);
}
...
{
  return rmonEventStatusGet(Index, val);
}
...
{
  return rmonEventDescriptionSet(Index, buf);
}
...
{
  return rmonEventTypeSet(Index, val);
}
...
{
  return rmonEventCommunitySet(Index, buf);
}
...
{
  return rmonEventOwnerSet(Index, buf);
}
...
{
  return rmonEventStatusSet(Index, val);
}
...
{
  return rmonLogEntryGet(0, EventIndex, Index);
}
...
{
  L7_RC_t rc;
  L7_int32 tempEventIndex;

  tempEventIndex = EventIndex;

  rc = rmonLogEntryNextGet(&tempEventIndex, Index);
  if (rc == L7_SUCCESS)
  {
    if (tempEventIndex != EventIndex)
    {
      rc = L7_FAILURE;
    }
  }
...
{
  return rmonLogTimeGet(EventIndex, Index, val);
}
...
{
  return rmonLogDescriptionGet(EventIndex, Index, buf);
}
