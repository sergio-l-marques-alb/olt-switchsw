...
**********************************************************************
*
* @filename usmdb_isdp.c
*
* @purpose Contains isdp provisioning function usmdb APIs
*
* @component
*
* @comments
...
{
  return isdpHoldTimeSet(holdTime);
}
...
{
  return isdpHoldTimeGet(holdTime);
}
...
{
  return isdpIntfModeSet(intIfNum, mode);
}
...
{
  return isdpIntfModeGet(intIfNum, mode);
}
...
{
  return isdpTrafficCountersClear();
}
...
* @end
*********************************************************************/
L7_RC_t usmdbIsdpIntfNeighborGetNext(
    L7_uint32 intIfNum,
    L7_uchar8 *deviceId,
    L7_uchar8 *nextDeviceId)
{
  return isdpIntfNeighborGetNext(intIfNum, deviceId, nextDeviceId);
}
...
L7_RC_t usmdbIsdpNeighborGetNext(
    ...
    L7_uchar8 *nextDeviceId)
{
  return isdpNeighborGetNext(intIfNum, deviceId, nextIntIfNum,
      nextDeviceId);
}
...
L7_RC_t usmdbIsdpIntfNeighborPlatformGet(
    ...
    L7_uchar8 *platform)
{
  return isdpIntfNeighborPlatformGet(intIfNum, deviceId, platform);
}
...
L7_RC_t usmdbIsdpDeviceIdNeighborGetNext(
    ...
    L7_uchar8 *nextDeviceId)
{
  return isdpDeviceIdNeighborGetNext(
      intIfNum,
      deviceId,
      nextIntIfNum,
      nextDeviceId);
...
L7_RC_t usmdbIsdpIntfNeighborVersionGet(
    ...
    L7_uchar8 *version)
{
  return isdpIntfNeighborVersionGet(intIfNum, deviceId, version);
}
...
L7_RC_t usmdbIsdpIntfNeighborPortIdGet(
    ...
    L7_uchar8 *portId)
{
  return isdpIntfNeighborPortIdGet(intIfNum, deviceId, portId);
}
...
L7_RC_t usmdbIsdpIntfNeighborAddressGetNext(
    ...
    L7_uint32 *nextIndex)
{
  return isdpIntfNeighborAddressGetNext(intIfNum, deviceId, index,
                                        nextIndex);
}
...
L7_RC_t usmdbIsdpIntfNeighborIpAddressGet(
    ...
    L7_uint32 *ipAddress)
{
  return isdpIntfNeighborIpAddressGet(intIfNum, deviceId, index,
                                      ipAddress);
}
...
* @end
*********************************************************************/
L7_RC_t usmdbIsdpIntfNeighborCapabilitiesGet(
    L7_uint32 intIfNum,
    L7_uchar8 *deviceId,
    L7_uint32 *capabilities)
{
  return isdpIntfNeighborCapabilitiesGet(intIfNum, deviceId, capabilities);
}
...
* @end
*********************************************************************/
L7_RC_t usmdbIsdpIntfNeighborHoldTimeGet(
    L7_uint32 intIfNum,
    L7_uchar8 *deviceId,
    L7_uchar8 *holdTime)
{
  return isdpIntfNeighborHoldTimeGet(intIfNum, deviceId, holdTime);
}
...
* @end
*********************************************************************/
L7_RC_t usmdbIsdpIntfNeighborProtocolVersionGet(
    L7_uint32 intIfNum,
    L7_uchar8 *deviceId,
    L7_uchar8 *protoVersion)
{
  return isdpIntfNeighborProtocolVersionGet(intIfNum, deviceId, protoVersion);
}
...
{
  return isdpIntfNeighborLastChangeTimeGet(intIfNum, deviceId, lastChangeTime);
}
...
{
  return isdpTrafficPduReceivedGet();
}
...
{
  return isdpTrafficV1PduReceivedGet();
}
...
{
  return isdpTrafficV2PduReceivedGet();
}
...
{
  return isdpTrafficBadHeaderPduReceivedGet();
}
...
{
  return isdpTrafficChkSumErrorPduReceivedGet();
}
...
{
  return isdpTrafficInvalidFormatPduReceivedGet();
}
...
{
  return isdpTrafficPduTransmitGet();
}
...
{
  return isdpTrafficV1PduTransmitGet();
}
...
{
  return isdpTrafficV2PduTransmitGet();
}
...
{
  return isdpTrafficFailurePduTransmitGet();
}
...
{
  return isdpTrafficTableFullGet();
}
...
{
  return isdpTrafficIpAddressTableFullGet();
}
...
{
  return isdpNeighborsTableLastChangeTimeGet();
}
...
{
  return isdpDebugTracePacketTxModeSet(txTraceMode);
}
...
{
  return isdpDebugTracePacketTxModeGet(txTraceMode);
}
...
{
  return isdpDebugTracePacketRxModeSet(rxTraceMode);
}
...
{
  return isdpDebugTracePacketRxModeGet(rxTraceMode);
}
...
{
  return isdpDebugTraceEventsModeSet(eventsTraceMode);
}
...
{
  return isdpDebugTraceEventsModeGet(eventsTraceMode);
}
...
{
  return isdpDeviceIdFormatCapabilityGet(deviceIdFormatCpb);
}
...
{
  return isdpDeviceIdFormatGet(deviceIdFormat);
}
...
{
  isdpCapabilityCharGet(cap, capCh, size);
  return L7_SUCCESS;
}
...
{
  isdpCapabilityStringGet(cap, capCh, size);
  return L7_SUCCESS;
}
...
{
  isdpDevIdFormatCapabilityStringGet(cap, capCh, size);
  return L7_SUCCESS;
}
...
{
  isdpDevIdFormatStringGet(cap, capCh, size);
  return L7_SUCCESS;
}
...
L7_RC_t usmdbIsdpNeighborIndexedGetNext(L7_uint32 intIfNum, L7_uint32 index,
                                   ...
                                   L7_char8 *deviceId)
{
  return isdpNeighborIndexedGetNext(intIfNum, index, nextIntIfNum, nextIndex,
                                    deviceId);
}
...
L7_RC_t usmdbIsdpNeighborIndexedGet(L7_uint32 intIfNum, L7_uint32 index,
                                    L7_char8 *deviceId)
{
  return isdpNeighborIndexedGet(intIfNum, index, deviceId);
}
...
{
  return isdpIsValidIntf(intIfNum);
}
