...
L7_RC_t usmDbOspfOpaqueLSAModeGet(L7_uint32 UnitIndex, L7_uint32 *val)
{
  ...
  rc = ospfMapOpaqueLSAModeGet(val);
...
L7_RC_t usmDbOspfMapOpaqueLSAModeSet(L7_uint32 UnitIndex, L7_uint32 mode)
{
  ...
  rc = ospfMapOpaqueLSAModeSet(mode);
...
{
  L7_RC_t rc = ospfMapAreaLSADbLSATypeGet(areaId, val);
  return rc;
}
...
{
  L7_RC_t rc = ospfMapAreaLSADbLSAAgeGet(areaId, Type, Lsid, RouterId, val);
  return rc;
}
...
{
  L7_RC_t rc = ospfMapAreaLSADbLSALSIdGet(areaId, val);
  return rc;
}
...
{
  L7_RC_t rc = ospfMapAreaLSADbLSARouterIdGet(areaId, val);
  return rc;
}
...
{
  L7_RC_t rc = ospfMapAreaLSADbLSASequenceGet(areaId, val);
  return rc;
}
...
{
  L7_RC_t rc = ospfMapAreaLSADbLSAOptionsGet(areaId, Type, Lsid, RouterId, val);
  return rc;
}
...
L7_RC_t usmDbOspfAreaLSADbLSACksumGet(L7_uint32 UnitIndex, L7_uint32 areaId,
                                      ...
                                      L7_uint32 RouterId, L7_uint32 *val)
{
  L7_RC_t rc = ospfMapAreaLSADbLSACksumGet(areaId, Type, Lsid, RouterId, val);
  return rc;
}
...
L7_RC_t usmDbOspfAreaLSADbLSAAdvertiseGet(L7_uint32 UnitIndex, L7_uint32 areaId, 
                                          ...
                                          L7_uint32 *buf_len)
{
  L7_RC_t rc = ospfMapAreaLSADbLSAAdvertiseGet(areaId, Type, Lsid, RouterId, buf, buf_len);
  return rc;
}
...
{
  L7_RC_t rc = ospfMapNbrLSRetransQLenGet(intIfNum, routerId, val);
  return rc;
}
