                                    ...
                                    L7_int32 *sgmode)
{
     ...
     return L7_FAILURE;/* we can Remove it */

    /*return mcastMapCmd(L7_MCAST_IANA_MROUTE_PIM_SM,
                       MCAST_PIMSM_NEW_MIB_SG_MODE_ENTRY_GET_CMD, 
          addrType,(L7_uint32)pimSGGrpAddr,(L7_uint32)pimSGSrcAddr,(L7_uint32)sgmode,0,0,0,0,0,0);*/
}
