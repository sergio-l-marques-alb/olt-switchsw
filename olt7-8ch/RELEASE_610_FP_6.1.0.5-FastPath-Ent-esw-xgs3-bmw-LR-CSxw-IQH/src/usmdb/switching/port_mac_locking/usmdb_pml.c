...
void usmDbPmlDebugDump(L7_uint32 intIfNum)
{
  ...
  usmDbPmlAdminModeGet(0,&globalMode);
  usmDbPmlIntfModeGet(0, intIfNum, &intfMode);
  usmDbPmlIntfDynamicLimitGet(0, intIfNum, &dynamicLimit);
  usmDbPmlIntfStaticLimitGet(0, intIfNum, &staticLimit);
  usmDbPmlIntfStaticCountGet(0, intIfNum, &staticCount);
  usmDbPmlIntfViolationTrapModeGet(0, intIfNum, &trapMode);
