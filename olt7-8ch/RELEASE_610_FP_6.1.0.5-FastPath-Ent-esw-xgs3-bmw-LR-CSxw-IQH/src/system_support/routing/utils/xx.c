...
static char __fileid[] = "$Header: /home/cvs/PR1003/PR1003/FASTPATH/RELEASE_610_FP_6.1.0.5-FastPath-Ent-esw-xgs3-bmw-LR-CSxw-IQH/src/system_support/routing/utils/xx.c,v 1.1 2011/04/18 17:10:53 mruas Exp $";
#endif
...
void XX_DisplayMemExt(t_Handle Heap, byte level)
{
   ...
   if (level > 1)
   {
     sprintf(prntBuf, "Buffer sizes do not include overhead of %d bytes per buffer.\n",
             MEMORY_OVERHEAD + ALIGN);
     XX_Print(prntBuf);
