...
* @returns  void
*
* @notes    This tests uses LOG_MSG only, as this is the most commonly used
*           log macro.
*
*
* @end
...
void logDebugMsgLogAddN( L7_uint32 numEntries)
{
    ...
    for (i=1; i <= numEntries; i++)
    {
        LOG_MSG("LOG number %d - This is a veeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeery "
                "long message!!!!!!!!!!!!!!!!!!!!!!!!!!", i);
    }
}
...
{
    LOG_MSG("LOG - This is a veeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeery "
            "long message!!!!!!!!!!!!!!!!!!!!!!!!!!");
}
...
void logUnitTest()
{
  ...
  for (ndx = 0; ndx < 50; ndx++)
    L7_LOG(L7_LOG_SEVERITY_CRITICAL, L7_DRIVER_COMPONENT_ID, "LOG - Hi Mom!");
  logStatusShow();
}
...
void logUnitTest3()
{
  ...
  L7_LOG(L7_LOG_SEVERITY_ERROR, L7_DRIVER_COMPONENT_ID,
    "LOG - This is a veeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeery "
    "long message!!!!!!!!!!!!!!!!!!!!!!!!!!");
  L7_LOGF(L7_LOG_SEVERITY_EMERGENCY, L7_DRIVER_COMPONENT_ID, "LOGF - "
    "Formatted output: %d %d %d %d", 1,2,3,4);
  L7_LOGNC(L7_LOG_SEVERITY_ALERT, "LOGNC - Hi Mom!");
  L7_LOGFNC(L7_LOG_SEVERITY_NOTICE, "LOGFNC - Formatted output %d", 1);
  L7_LOG(L7_LOG_SEVERITY_INFO, L7_DRIVER_COMPONENT_ID, "Hi Mom!");
...
void logUnitTest4()
{
  ...
  L7_LOG(L7_LOG_SEVERITY_CRITICAL, L7_DRIVER_COMPONENT_ID, "LOG - Hi Mom!");
  L7_LOG(L7_LOG_SEVERITY_ERROR, L7_DRIVER_COMPONENT_ID, "LOG - This "
  "is a veeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeery "
  "long message!!!!!!!!!!!!!!!!!!!!!!!!!!");
  L7_LOG(L7_LOG_SEVERITY_CRITICAL, L7_DRIVER_COMPONENT_ID, "LOG - This "
  "is a veeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeery long "
  "message!!!!!!!!!!!!!!!!!!!!!!!!!!");
  L7_LOGF(L7_LOG_SEVERITY_EMERGENCY, L7_DRIVER_COMPONENT_ID, "LOGF - "
  "Formatted output: %d %d %d %d", 1,2,3,4);
  L7_LOGNC(L7_LOG_SEVERITY_ALERT, "LOGNC - Hi Mom!");
  L7_LOGFNC(L7_LOG_SEVERITY_NOTICE, "LOGFNC - Formatted output %d", 1);
  L7_LOGFNC(L7_LOG_SEVERITY_CRITICAL, "LOGFNC - Formatted output %d", 1);
  L7_LOG(L7_LOG_SEVERITY_INFO, L7_DRIVER_COMPONENT_ID, "Hi Mom!");
  L7_LOG(L7_LOG_SEVERITY_EMERGENCY, L7_DRIVER_COMPONENT_ID, "Hi Mom!");
  logStatusShow();
}
...
void logUnitTestComponent()
{
  ...
  for (component = L7_FIRST_COMPONENT_ID; component < L7_LAST_COMPONENT_ID; component++)
    L7_LOGF(L7_LOG_SEVERITY_EMERGENCY, component, "component %d", component);
}
