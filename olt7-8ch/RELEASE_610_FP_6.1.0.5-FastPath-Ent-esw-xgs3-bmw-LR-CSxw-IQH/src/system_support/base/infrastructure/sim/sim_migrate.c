...
simMigrateConfigV5V6Convert (simCfgData_ver5_t * pCfgV5, simCfgData_ver6_t * pCfgV6)
{
  ...
  MIGRATE_COPY_STRUCT (pCfgV6->systemBIA, pCfgV5->systemBIA);
...
void simBuildDefaultConfigDataV3(simCfgData_ver3_t *pCfgV3)
{
  ...
  if ((rc = sysapiRegistryGet(SYS_MAC, MAC_ENTRY, &(pCfgV3->systemBIA))) != L7_SUCCESS)
...
void simBuildDefaultConfigDataV4(simCfgData_ver4_t *pCfgV4)
{
  ...
  if ((rc = sysapiRegistryGet(SYS_MAC, MAC_ENTRY, &(pCfgV4->systemBIA))) != L7_SUCCESS)
    LOG_MSG("Error on call to sysapiRegistryGet routine with key SYS_MAC\n");
...
void simBuildDefaultConfigDataV5(simCfgData_ver5_t *pCfgV5)
{
  ...
  if ((rc = sysapiRegistryGet(SYS_MAC, MAC_ENTRY, &pCfgV5->systemBIA)) != L7_SUCCESS)
    LOG_MSG("Error on call to sysapiRegistryGet routine with key SYS_MAC\n");
