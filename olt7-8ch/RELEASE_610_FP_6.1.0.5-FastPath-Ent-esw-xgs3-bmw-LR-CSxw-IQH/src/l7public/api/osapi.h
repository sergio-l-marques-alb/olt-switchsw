...
#define JAN_1970_OFFSET   2208988800.0

/** Clock scaling factor */
#define SNTP_CLOCK_PHI       (15.0e-6)

/* The minimum correction to the local clock in seconds.
* Timestamps that differ from the local clock by less than
* this amount are not applied to the local clock. They are
* still used in the clock filtering algorithm. (In seconds)
* This value generally does not need to be changed until a new
* generation of oscillators is present in in the COTS arena.
*/
#define SNTP_MIN_CORRECTION     0.128
...
*
*************************************************************************/
EXT_API void osapiDebugMallocSummary(L7_COMPONENT_IDS_t compId);
...
/**************************************************************************
*
* @purpose  Retrieve number of milliseconds since last reset (64bit version)
*
* @param    none
*
* @returns  milliseconds since last reset
...
* @end
*********************************************************************/
EXT_API L7_double64 osapiNTPTimeGet(void);
...
*           (correction).
*           If this time is greater than the L7_SNTP_MIN_CORRECTION,
...
EXT_API L7_RC_t osapiNTPTimeSet(L7_double64 start, L7_double64 offset);
...
*
*************************************************************************/
EXT_API L7_RC_t osapiBaudRateChange( L7_uint32 rate );
...
* @end
*********************************************************************/
EXT_API L7_RC_t osapiIpReasmTimeoutsGet(L7_uint32 *val);
...
* @end
*********************************************************************/
EXT_API L7_uint32 osapiBootCodeUpdate(char *fileName);
...
*
***************************************************************************/
EXT_API L7_RC_t osapiStdInConfig(void);
