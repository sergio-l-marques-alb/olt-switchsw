...
/*********************************************************************
* @purpose  Function to Set the VRRP priority
*
* @param    routerID - router Id
* @param    intIfNum - Interface Number
...
* @end
*********************************************************************/
L7_RC_t L7_vrrpOperPrioritySet(L7_uchar8 routerID, 
                               L7_uint32 intIfNum, 
                               L7_uchar8 priority);
...
* @end
*********************************************************************/
L7_RC_t L7_vrrpVMacGet(L7_uint32 ipAddress, L7_uchar8* vMac);
...
/*********************************************************************
* @purpose  Callback function To handle NIM Interface Change notification. 
*
...
/*********************************************************************
* @purpose  If any VRRP router's IP address is equal to that of the 
*           routing interface, this routine sets the VRRP router's 
*           priority to MAX prority (as per RFC 2338) else if the 
*           VRRP router's priority was previously set to 255, it 
*           changes it back to default
*
* @param    intIfNum @b{(input)} - Internal Interface Number
*
* @returns  void
...
* @end
*********************************************************************/
void vrrpMaxPrioritySetIfOwner(L7_uint32 intIfNum);
