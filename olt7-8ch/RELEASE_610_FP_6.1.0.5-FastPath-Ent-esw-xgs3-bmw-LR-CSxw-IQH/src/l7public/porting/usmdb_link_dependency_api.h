...
**********************************************************************
*
* @filename usmdb_link_dependency_api.h
*
...
#ifndef USMDB_LINK_DEPENDENCY_API_H
#define USMDB_LINK_DEPENDENCY_API_H
...
* @end
*********************************************************************/
L7_RC_t usmDbLinkDependencyGroupSet( L7_uint32       groupId,
                                     L7_INTF_MASK_t *members,
                                     L7_INTF_MASK_t *dependencies );
...
#endif  /* not USMDB_LINK_DEPENDENCY_API_H */
