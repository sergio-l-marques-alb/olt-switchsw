...
#define PML_MSG_COUNT                             DEFAULT_MSG_COUNT
...
#define L7_HIGH_TASK_PRIORITY                                1    /* PTin added for LACP processing */
...
#define DAPI_TRACE_ENTRY_SIZE_MAX    (64)
