...
void sFlowApiCnfgrCommand(L7_CNFGR_CMD_DATA_t * pCmdData)
{
  ...
  {
    L7_LOG(L7_LOG_SEVERITY_ALERT, L7_SFLOW_COMPONENT_ID, 
                                    ...
                                    L7_CNFGR_ERR_RC_t *pReason)
{
  ...
  *pReason = 0;
  ...
  {
    LOG_MSG("sFlowCnfgrInitPhase1Process: Error allocating data for poller AVL Tree \n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  {
    LOG_MSG("sFlowCnfgrInitPhase1Process: Error allocating data for sampler AVL Tree \n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  {
    LOG_MSG("Error allocating buffers\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  /* Timer Initializations */
   if(bufferPoolInit(SFLOW_MAX_POLLERS ,
                     ...
                     != L7_SUCCESS)
   {
     LOG_MSG("sFlowCnfgrInitPhase1Process: Falied to allocate memory for Sflow timer buffers\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  {
    LOG_MSG("sFlowCnfgrInitPhase1Process: App Timer Initialization Failed.\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  if ((agent.handleListMemHndl =
        (handle_member_t*) osapiMalloc (L7_SFLOW_COMPONENT_ID,
                        ...
                        == L7_NULLPTR)
  {
    LOG_MSG("sFlowCnfgrInitPhase1Process: Error allocating Handle List Buffers\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  if(handleListInit (L7_SFLOW_COMPONENT_ID, SFLOW_MAX_POLLERS,
                  ...
                  != L7_SUCCESS)
  {
    LOG_MSG("sFlowCnfgrInitPhase1Process: Unable to create timer handle list\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
  ...
  {
    LOG_MSG("sFlowCnfgrInitPhase1Process: Unable to create sockets\n");
    *pResponse = 0;
    *pReason = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    sFlowRC = L7_ERROR;
    return sFlowRC;
                                    ...
                                    L7_CNFGR_ERR_RC_t *pReason)
{
  ...
  *pReason    = 0;
  ...
  if (nimRegisterIntfChange(L7_SFLOW_COMPONENT_ID, sFlowIntfChangeCallback) != L7_SUCCESS)
  {
    LOG_MSG("sflowCnfgrInitPhase2Process: Unable to register with NIM\n");
...
static L7_RC_t sFlowAgentCreate(void)
{
  ...
  {
    LOG_MSG("Unable to initialize sFlowTask()\n");
    return(L7_FAILURE);
  }
