...
void dhcpsConfigDataTestShow(void);
static void dhcpsCfgDataShow();

static void dhcpsLeaseConfigDataTestShow(void);
static void dhcpsLeaseCfgDataShow();
