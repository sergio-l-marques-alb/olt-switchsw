                          ...
                          L7_dvmrp_inet_addr_t *source, L7_uchar8 *data, L7_int32 datalen)
{
  ...
  L7_char8 src[DVMRP_STRING_SIZE];
      ...
      while (L7_NULLPTR != entry)
      {
            ...
            prune = pruneNext)
        {
          ...
          if (prune->neighbor == nbr)
          {
            ...
            L7_char8 printNBR[DVMRP_STRING_SIZE];
                          ...
                          L7_dvmrp_inet_addr_t *source, L7_uchar8 *data, L7_int32 datalen)
{
  ...
  while (endp - data > 0)
  {
    ...
    if (L7_SUCCESS != inetAddressSet(dvmrpcb->family, &mask, &addrmask))
    {
      DVMRP_DEBUG(DVMRP_DEBUG_FAILURES, "%s:%d Failed to set the address\n",
                  __FUNCTION__, __LINE__);
      return L7_FAILURE;
    ...
    do 
    {
      ...
      *(L7_ulong32 *)origin = osapiNtohl (*(L7_ulong32 *)origin);
      if (L7_SUCCESS != inetAddressSet(dvmrpcb->family, &origin, &inetAddr))
      {
        DVMRP_DEBUG(DVMRP_DEBUG_FAILURES, "%s:%d Failed to set the address\n",
                    __FUNCTION__, __LINE__);
        return L7_FAILURE;
                           ...
                           L7_int32 fromTimeout)
{
  ...
  L7_uint32 skipentries = 0;
  dvmrpTreeKey_t key;
  L7_char8 nbrAddr[DVMRP_STRING_SIZE],src[DVMRP_STRING_SIZE],grp[DVMRP_STRING_SIZE];
                          ...
                          L7_dvmrp_inet_addr_t *addr)
{
  ...
  L7_uchar8 nbrNode[DVMRP_STRING_SIZE];
  L7_uchar8 src[DVMRP_STRING_SIZE] ={'\0'};
                          ...
                          dvmrp_neighbor_t *neighbor)
{
  ...
  L7_uint32 skipentries = 0;
  dvmrpTreeKey_t key;
  L7_char8 src_str[DVMRP_STRING_SIZE];  
