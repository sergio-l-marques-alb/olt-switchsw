...
static void pimsmStarStarRpIPrunePendingTimerExpiresHandler(void *pParam)
{
  ...
  {
    LOG_MSG ("PIMSM Downstream pimsmStarStarRpIPrunePendingTimer is NULL, But Still Expired");
    return;
  }
...
static void pimsmStarStarRpIJoinExpiryTimerExpiresHandler(void *pParam)
{
  ...
  {
    LOG_MSG ("PIMSM Downstream pimsmStarStarRpIJoinExpiryTimer is NULL, But Still Expired");
    return;
  }
