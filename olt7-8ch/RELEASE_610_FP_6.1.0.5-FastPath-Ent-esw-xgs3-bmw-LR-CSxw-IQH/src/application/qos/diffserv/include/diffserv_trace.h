...
#define DS_TRACE_ENTRY_SIZE_MAX             32                                   
...
typedef struct
{
  ...
  L7_uchar8         rc;                         /* 20   : return code         */
  L7_uchar8         rsvd_21;                    /* 21   : (currently unused)  */
  L7_ushort16       tlvType;                    /* 22-23: TLV type            */
  L7_ushort16       tlvLen;                     /* 24-25: TLV length          */
  L7_ushort16       rsvd_26_27;                 /* 26-27: (currently unused)  */
  L7_ulong32        instKey;                    /* 28-31: instance key        */
...
#define DS_TRACE_PT_POL_TLV_ADD_DTL(_pidx, _pidx2, _iin, _dir, _hndl, _rc, \
  ...
  dsTracePtPolTlvDtl(DS_TRACE_ID_POL_TLV_ADD_DTL, \
                     ...
                     (L7_ushort16)(_tlvtype), (L7_ushort16)(_tlvlen), \
                     (L7_ulong32)(_key))
