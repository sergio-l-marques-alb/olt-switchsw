...
#define ACL_CALLBACK_REGISTRANTS_MAX_DELETE_APPROVAL  FD_CNFGR_ACL_MAX_CALLBACK_REGISTRATIONS
...
typedef enum
{
  ...
  ACL_CALLBACK_TABLE_ID_DELETE_APPROVAL,
