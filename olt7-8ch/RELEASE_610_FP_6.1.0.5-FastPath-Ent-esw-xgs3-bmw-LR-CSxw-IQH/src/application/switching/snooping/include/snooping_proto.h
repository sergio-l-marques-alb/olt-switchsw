...
#define IGMP_FRAME_SIZE  (L7_ENET_HDR_SIZE+L7_ENET_ENCAPS_HDR_SIZE+L7_IP_HDR_LEN+SNOOP_IGMPv1v2_HEADER_LENGTH)
#define IGMPv3_FRAME_SIZE  (L7_ENET_HDR_SIZE+L7_ENET_ENCAPS_HDR_SIZE+L7_IP_HDR_LEN+SNOOP_IGMPV3_HEADER_MIN_LENGTH)

#define MLD_FRAME_SIZE  (L7_ENET_HDR_SIZE+L7_ENET_ENCAPS_HDR_SIZE+L7_IP6_HEADER_LEN+SNOOP_MLDV1_HEADER_LENGTH)
#define MLDv2_FRAME_SIZE  (L7_ENET_HDR_SIZE+L7_ENET_ENCAPS_HDR_SIZE+L7_IP6_HEADER_LEN+SNOOP_MLDV2_HEADER_MIN_LENGTH)
