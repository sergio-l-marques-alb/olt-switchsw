...
L7_char8* dot1qDebugEventStringGet(L7_uint32 event)
{
	...
	case dot1q_vlan_tagged_set_static:return"dot1q_vlan_tagged_set_static";
...
void dot1qTraceQueueMsgFormat(DOT1Q_MSG_t *msg, L7_uint32 direction)
{
	...
	case dot1q_vlan_tagged_set_static:
        DOT1Q_TRACE("%s: dot1q_vlan_tagged_set_static: vlan %d, intIfNum %d, mode = %d\n", 
                    traceDirection, msg->vlanId, msg->data.intIfNum, msg->mode );
		break;

	case dot1q_vlan_member_set:
        DOT1Q_TRACE("%s: dot1q_vlan_member_set: vlan %d, intIfNum %d, mode %d, Req %d \n", 
                    traceDirection, msg->vlanId, msg->data.intIfNum, msg->mode,msg->requestor);
		break;

#if defined(DOT1Q_FUTURE_FUNC_GROUP_FILTER) && DOT1Q_FUTURE_FUNC_GROUP_FILTER
	case dot1q_vlan_group_filter_static:
        DOT1Q_TRACE("%s: dot1q_vlan_group_filter_static: vlan %d, intIfNum %d, mode %d\n", 
                    traceDirection, msg->vlanId, msg->data.intIfNum, msg->mode );
		break;
#endif
	...
	case dot1q_vlan_group_filter_dynamic:
        DOT1Q_TRACE("%s: dot1q_vlan_group_filter_dynamic: vlan %d, intIfNum %d, mode %d\n", 
                    traceDirection, msg->vlanId, msg->data.intIfNum, msg->mode );
		break;
#endif
	...
	case dot1q_qports_vid_set:
        DOT1Q_TRACE("%s: dot1q_qports_vid_set: vlan %d, intIfNum %d, mode %d\n", 
                    traceDirection, msg->vlanId, msg->data.intIfNum, msg->mode );
		break;

	case dot1q_qports_accept_frame_type_set:
        DOT1Q_TRACE("%s: dot1q_qports_accept_frame_type_set: intIfNum %d, mode %d\n", 
                    traceDirection, msg->data.intIfNum, msg->mode );
		break;

	case dot1q_qports_default_user_prio_set:
        DOT1Q_TRACE("%s: dot1q_qports_default_user_prio_set: intIfNum %d, mode %d\n", 
                    traceDirection, msg->data.intIfNum, msg->mode );
		break;
	...
	case dot1q_qports_ingress_filter_set:
        DOT1Q_TRACE("%s: dot1q_qports_ingress_filter_set:  intIfNum %d, mode %d\n", 
                    traceDirection, msg->data.intIfNum, msg->mode );
		break;
	...
	case dot1q_qports_traffic_class_set:
        DOT1Q_TRACE("%s: dot1q_qports_traffic_class_set: intIfNum %d\n", 
                    traceDirection, msg->data.intIfNum );
		break;

	case dot1q_qports_num_traffic_classes_set:
        DOT1Q_TRACE("%s: dot1q_qports_num_traffic_classes_set:  intIfNum %d, mode %d\n", 
                    traceDirection, msg->data.intIfNum, msg->mode );
		break;
   ...
   case dot1q_clear:
	...
	case dot1q_intfChange:
        DOT1Q_TRACE("%s: dot1q_intfChange: intIfNum %d, event %d\n", 
                    traceDirection, msg->data.intIfNum, msg->data.status.event ); 
		break;
	...
	case dot1q_qports_vlan_membership_delta_mask_set:
		DOT1Q_TRACE("%s:dot1q_qports_vlan_membership_delta_mask_set: interface %d", traceDirection, msg->data.intfVlanMask.intIfNum);
		break;

	case dot1q_qports_vlan_tagging_delta_mask_set:
		DOT1Q_TRACE("%s:dot1q_qports_vlan_tagging_delta_mask_set: interface %d",  traceDirection,  msg->data.intfVlanMask.intIfNum);
		break;
    ...
    */
    ...
    if (directive == 1)
    {
        ...
        */
        ...
        if (dot1qVlanTaggedMemberSet(vlanId, intIfNum, parm1) != L7_SUCCESS)
