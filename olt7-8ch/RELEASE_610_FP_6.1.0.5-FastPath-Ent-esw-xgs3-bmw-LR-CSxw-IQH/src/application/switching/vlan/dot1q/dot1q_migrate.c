...
{
  printf("sizeof dot1qCfgV5_t %d \n", sizeof(dot1qCfgV5_t));
  printf("sizeof dot1qGlobCfgData_t %d \n", sizeof(dot1qGlobCfgData_t));
  printf("sizeof dot1qIntfCfgData_t %d \n", sizeof(dot1qIntfCfgData_t));
  printf("sizeof dot1qVlanCfgDataV5_t %d \n", sizeof (dot1qVlanCfgDataV5_t));
  printf("sizeof dot1q_vlan_cfgV5_t %d \n",  sizeof(dot1q_vlan_cfgV5_t));
  printf("sizeof DOT1Q_VLAN_MASK_REL_4_X_t %d \n", sizeof(DOT1Q_VLAN_MASK_REL_4_X_t));
  printf("L7_DOT1Q_MAX_INTF_REL_4_4 %d\n", L7_DOT1Q_MAX_INTF_REL_4_4);
  printf("L7_MAX_VLANS_REL_4_4 %d\n", L7_MAX_VLANS_REL_4_4);
  printf("sizeof NIM_INTF_MASK_REL_4_4_t %d\n", sizeof(NIM_INTF_MASK_REL_4_4_t));
  printf("version 6 numbers \n");
  printf("sizeof dot1qCfgData_t %d \n", sizeof(dot1qCfgData_t));
  printf("sizeof dot1qVlanCfgData_t %d\n", sizeof(dot1qVlanCfgData_t));
  printf("sizeof dot1q_vlan_cfg_t %d\n",  sizeof(dot1q_vlan_cfg_t));
  printf("sizeof L7_VLAN_MASK_t %d\n",  sizeof(L7_VLAN_MASK_t));
  printf("DOT1Q_INTF_MAX_COUNT %d\n", DOT1Q_INTF_MAX_COUNT);
  printf("L7_MAX_VLANS %d\n", L7_MAX_VLANS);
  printf("sizeof NIM_INTF_MASK_t %d\n", sizeof(NIM_INTF_MASK_t));
