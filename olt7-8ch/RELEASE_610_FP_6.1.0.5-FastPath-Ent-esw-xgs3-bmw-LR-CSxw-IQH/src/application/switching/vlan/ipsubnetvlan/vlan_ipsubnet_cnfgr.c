                                            ...
                                            L7_CNFGR_ERR_RC_t   *pReason )
{
    ...
    *pReason   = 0;
    ...
    {
		L7_LOG(L7_LOG_SEVERITY_NOTICE, L7_VLAN_IPSUBNET_COMPONENT_ID, "vlanIpSubnetCnfgrInitPhase1Process: Unable "
...
void vlanIpSubnetCnfgrFiniPhase1Process()
{
    ...
    if (vlanIpSubnetTreeData != L7_NULLPTR)
    {
        ...
        if (vlanIpSubnetTreeData->semId != L7_NULLPTR &&
			...
			L7_LOG(L7_LOG_SEVERITY_NOTICE, L7_VLAN_IPSUBNET_COMPONENT_ID, "vlanIpSubnetCnfgrFiniPhase1Process: "
