...
typedef enum dot1sMgmtEvents_s
{
  ...
  /***************************************************************/
  /*100*/dot1sMgmtBegin = DOT1S_MGMT_EVENTS_BEGIN,

  /***************************************************************/
  /* Events from switch commands                                 */
  /***************************************************************/
  /*101*/switchModeEnable,
  /*102*/switchModeDisable,
  /*103*/switchForceVersionSet,
  /*104*/switchConfigFormatSelectorSet,
  /*105*/switchConfigNameSet,
  /*106*/switchConfigRevisionSet,
  /*107*/switchUnused01,                    /* available for use */
  /*108*/switchUnused02,                    /* available for use */
  /*109*/switchPortAdminModeEnable,
  /*110*/switchPortAdminModeDisable,
  /*111*/switchPortStateSet,
  /*112*/switchPortMigrationCheck,
  /*113*/switchMacAddrChange,
  /*114*/switchBpduGuardModeSet,
  /*115*/switchBpduFilterModeSet,

  /*116*/dot1sMgmtSwitchEvents, /*keep this last in sub group*/

  /***************************************************************/
  /* Events from common commands                                 */
  /***************************************************************/
  /*117*/commonPrioritySet,
  /*118*/commonBridgeMaxAgeSet,
  /*119*/commonBridgeHelloTimeSet,
  /*120*/commonBridgeFwdDelaySet,
  /*121*/commonPortPathCostSet,
  /*122*/commonPortPrioritySet,
  /*123*/commonPortEdgePortEnable,
  /*124*/commonPortEdgePortDisable,
  /*125*/commonPortPointToPointMacSet,
  /*126*/commonBridgeMaxHopSet,
  /*124*/commonBridgeTxHoldCountSet,
  /*127*/commonPortExtPathCostSet,
  /*128*/commonPortAdminHelloTimeSet,
  /*129*/commonPortBpduFilterModeSet,
  /*130*/commonPortBpduFloodModeSet,
  /*126*/commonPortRestrictedRoleSet,
  /*126*/commonPortLoopGuardSet,  
  /*126*/commonPortRestrictedTcnSet,
  /*126*/commonPortAutoEdgeSet,


  /*131*/dot1sMgmtCommonEvents, /*keep this last in sub group*/
  ...
  /*132*/instanceCreate,
  /*133*/instanceDelete,
  /*134*/instancePrioritySet,
  /*135*/instanceVlanAdd,
  /*136*/instanceVlanRemove,
  /*137*/instancePortPathCostSet,
  /*138*/instancePortPrioritySet,
  /*139*/instanceQueueSynchronize,

  /*140*/dot1sMgmtInstanceEvents, /*keep this last in sub group*/
  
  /***************************************************************/
  /* Events from network pdu received                            */
  /***************************************************************/
  /*141*/dot1sBpduReceived,

  /*142*/dot1sNetworkEvents,
  
  /***************************************************************/
  /* Events from interface state changes                         */
  /***************************************************************/
  /*143*/dot1sIntfChange,
  /*144*/dot1sIntfStateSet,

  /*145*/dot1sIntfChangeEvents,
