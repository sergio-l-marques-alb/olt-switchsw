...
L7_uchar8 *ipMapRouterEventNames[L7_LAST_RTR_STATE_CHANGE] =
{
    ...
    "Interface Enable", "Interface Disable Pending", "Interface Disable",
    "Address Add", "Address Delete Pending", "Address Delete",
    "Secondary Address Add", "Secondary Address Delete", "Interface Config Clear",
    "IP MTU Change"
};
...
L7_uchar8 *ipMapProcMessageNames[IPMAP_LAST_MSG] =
{
    ...
    "ASYNC EVENT COMPLETE", "RTO CHANGE", "ARP GW"
};
...
void ipMapDebugRegisteredRoutingInfoDump(void);
...
void ipMapDebugRoutingInfoDumpRegister(void)
{
    ...
    supportDebugCategory.info.supportRoutine = ipMapDebugRegisteredRoutingInfoDump;
    (void) strncpy(supportDebugCategory.info.supportRoutineName, "ipMapDebugRegisteredRoutingInfoDump",
...
void rtrIntfShow(L7_uint32 unit, L7_uint32 slot, L7_uint32 port)
{
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_IPMAP, "\n\nInterface acquired:  %s",
                (ipMapIntfInfo[intIfNum].intfAcquired ? "yes" : "no"));
...
void ipMapCfgIntfShow(L7_uint32 unit, L7_uint32 slot, L7_uint32 port)
{
  ...
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_IPMAP,  "---------------");
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_IPMAP,
                 "\ninterface   IP            IP             admin    mcast   net    proxy   local");
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_IPMAP,
                 "\n           address        mask            mode    fwd     bcast   arp    proxy");
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_IPMAP,
                 "\n                                                  mode    mode    mode   arp");
  SYSAPI_PRINTF( SYSAPI_APPLICATION_LOGGING_IPMAP,
                 "\n                                                                         mode");
...
void dbg_arp_req(L7_uint32 intIfNum, L7_uint32 ipSa, L7_uint32 ipDa)
{
    ...
    L7_uint32 bufHandle;
    L7_ushort16 pFlag = L7_LL_ENCAP_ENET;
