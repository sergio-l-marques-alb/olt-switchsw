                                            ...
                                            L7_uchar8 *buf, L7_uint32 *offset, L7_ushort16 *len)
{
  ...
  if (authStatus == L7_TRUE)
  {
    ...
    {
      LOG_MSG("%s: %s client IP address", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }

    if (cpdmClientConnStatusCpIdGet(&clientMacAddr, &cpId) != L7_SUCCESS)
    {
      LOG_MSG("%s: %s client CPID.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
  }
                                       ...
                                       L7_uchar8 *buf, L7_uint32 *offset, L7_ushort16 *len)
{
  ...
  if (blkUnblkStatus == L7_TRUE)
  {
    ...
    {
      LOG_MSG("%s: %s cpId %d block status", __FUNCTION__, failed_to_get, cpBlkUnblk);
      return L7_FAILURE;
    }
                                           ...
                                           L7_uchar8 *buf, L7_uint32 *offset, L7_ushort16 *len)
{
  ...
  if (authStatus == L7_TRUE)
  {
    ...
    {
      LOG_MSG("%s: %s client %02x:%02x:%02x:%02x:%02x:%02x info.\n",
                                        ...
                                        L7_uchar8 *buf, L7_uint32 *offset, L7_ushort16 *len)
{
  ...
  do
  {
    ...
    if (intf != 0)
    {
      ...
      {
        LOG_MSG("%s: %s %d status", __FUNCTION__, failed, intf);
        return L7_FAILURE;
      }

      if (cpdmIntfStatusGetUsers(intf, &intfAuthUsers) != L7_SUCCESS)
      {
        LOG_MSG("%s: %s %d auth users", __FUNCTION__, failed, intf);
        return L7_FAILURE;
      }
...
static L7_RC_t cpConfigMsgGlobalBuildSend(L7_enetMacAddr_t swMacAddr)
{
  ...
  {
    LOG_MSG("%s: %s CP global mode", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s global http port", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s global additional http secure port1", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s global additional http secure port2", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s peer switch stats reporting interval", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s auth session timeout", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s client authentication failure trap mode", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s client connection trap mode", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s client database full trap mode", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: %s client disconnection trap mode", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  LOG_MSG("%s: Sending CP global cfg msg of size %d to switch %02x:%02x:%02x:%02x:%02x:%02x",
          __FUNCTION__,
  ...
  {
    LOG_MSG("%s: Switch %02x:%02x:%02x:%02x:%02x:%02x not in cluster, msg not sent",
            __FUNCTION__,
  ...
  {
    LOG_MSG("%s: Failed to send CP global cfg msg to switch %02x:%02x:%02x:%02x:%02x:%02x",
            __FUNCTION__,
            swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
            swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
    return L7_FAILURE;
...
static L7_RC_t cpConfigMsgCPsBuildSend(L7_enetMacAddr_t swMacAddr)
{
  ...
  while (cpdmCPConfigNextGet(cpId, &cpId) == L7_SUCCESS)
  {
    ...
    {
      LOG_MSG("%s: %s configuration name", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s configuration mode", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s protocol mode", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s verification mode", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s redirect mode", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s redirect url", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s radius server", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s groupID", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s session timeout", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s idle timeout", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s CP bandwidth up rate", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s CP bandwidth down rate", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s CP max input octets", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s CP max output octets", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s CP max total octets", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s foreground color", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s background color", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s separator color", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    while (cpdmCPConfigWebIdNextGet(cpId, webId, &webId) == L7_SUCCESS)
    {
      ...
      {
        LOG_MSG("%s: %s language code", __FUNCTION__, failed_to_get);
        return L7_FAILURE;
      }
      ...
      {
        LOG_MSG("%s: %s locale link", __FUNCTION__, failed_to_get);
        return L7_FAILURE;
      }
    ...
    LOG_MSG("%s: Sending CP instance config message of size %d to switch %02x:%02x:%02x:%02x:%02x:%02x",
            __FUNCTION__,
            message->msgLen, swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
            swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
    ...
    if (clusterMsgSend(&swMacAddr, CLUSTER_MSG_DELIVERY_RELIABLE, 
                       CP_CLUSTER_CP_CONFIG_SYNC_MSG, pdu.offset, buf) != L7_SUCCESS)
    {
      LOG_MSG("%s: Failed to send CP instance config message to switch %02x:%02x:%02x:%02x:%02x:%02x",
              __FUNCTION__,
              swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
              swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
      return L7_FAILURE;
...
static L7_RC_t cpConfigMsgUserGroupBuildSend(L7_enetMacAddr_t swMacAddr)
{
  ...
  while (cpdmUserGroupEntryNextGet(gId, &gId) == L7_SUCCESS)
  {
    ...
    {
      LOG_MSG("%s: %s group name", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    LOG_MSG("%s: Sending CP user group config message of size %d to switch %02x:%02x:%02x:%02x:%02x:%02x", __FUNCTION__,
            message->msgLen, swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
            swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
    ...
    if (cpClusterSwitchEntryGet(swMacAddr) != L7_SUCCESS)
    {
      LOG_MSG("%s: Switch %02x:%02x:%02x:%02x:%02x:%02x not in cluster, msg not sent", __FUNCTION__,
              swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
              swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
      return L7_FAILURE;
    }
    ...
    if (clusterMsgSend(&swMacAddr, CLUSTER_MSG_DELIVERY_RELIABLE, 
                       CP_CLUSTER_CP_CONFIG_SYNC_MSG, pdu.offset, buf) != L7_SUCCESS)
    {
      LOG_MSG("%s: Failed to send CP user group config message to switch %02x:%02x:%02x:%02x:%02x:%02x", 
              __FUNCTION__,
              swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
              swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
      return L7_FAILURE;
...
static L7_RC_t cpConfigMsgLocalUserBuildSend(L7_enetMacAddr_t swMacAddr)
{
  ...
  while (cpdmUserEntryNextGet(uId, &uId) == L7_SUCCESS)
  {
    ...
    {
      LOG_MSG("%s: %s user name.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user pwd.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user session timeout.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user idle timeout.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user bandwidth up rate.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user bandwidth down rate.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user max input octets.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user max output octets.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    {
      LOG_MSG("%s: %s user max total octets.", __FUNCTION__, failed_to_get);
      return L7_FAILURE;
    }
    ...
    LOG_MSG("%s: Sending CP local user config message of size %d to switch %02x:%02x:%02x:%02x:%02x:%02x",
            __FUNCTION__,
            message->msgLen, swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
            swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
    ...
    if (clusterMsgSend(&swMacAddr, CLUSTER_MSG_DELIVERY_RELIABLE, 
                       CP_CLUSTER_CP_CONFIG_SYNC_MSG, pdu.offset, buf) != L7_SUCCESS)
    {
      LOG_MSG("%s: Failed to send CP local user config message to switch %02x:%02x:%02x:%02x:%02x:%02x",
              __FUNCTION__,
              swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
              swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
      return L7_FAILURE;
...
static void cpConfigMsgGlobalProcess(L7_uchar8 *msgCfgSyncBuf, L7_int32 totalIELen)
{
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP global config msg failed.", __FUNCTION__);
      return;
    }
    ...
    case CP_CLUSTER_IE_CLIENT_DISCONN_TRAP_TYPE:
      ...
      break;
    default:
      LOG_MSG("%s: Unknown msg IE type:%d.\n", __FUNCTION__, mType);
      break;
    }
...
static void cpConfigMsgCPProcess(L7_uchar8 *msgCfgSyncBuf, L7_int32 totalIELen)
{
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP config msg failed.", __FUNCTION__);
      return;
    }
...
static void cpConfigMsgGroupProcess(L7_uchar8 *msgCfgSyncBuf, L7_int32 totalIELen)
{
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP group config msg failed.", __FUNCTION__);
      return;
    }
...
static void cpConfigMsgUserProcess(L7_uchar8 *msgCfgSyncBuf, L7_int32 totalIELen)
{
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP user config msg failed.", __FUNCTION__);
      return;
    }
...
static void cpdmWebLocaleUpdate(void)
{
  ...
  while (cpdmCPConfigNextGet(cpId, &cpId) == L7_SUCCESS)
  {
    ...
    while (cpdmCPConfigWebIdNextGet(cpId, webId, &webId) == L7_SUCCESS)
    {
      ...
      {
        LOG_MSG("%s: Failed to add locale defaults.", __FUNCTION__);
      }
    }
  }
...
void cpClusterMemberEventCallback(clusterEvent eventType, clusterMemberID_t *memberID)
{
  ...
  case CLUSTER_EVENT_LOCAL_SWITCH_LEFT:
    if (cpdmOprData->cpLocalSw.status == CP_CLUSTER_SWITCH_CONTROLLER)
    {
      ...
      {
        LOG_MSG("%s: Failed to purge peer switch clients from connected clients table.", __FUNCTION__);
      }
    }
    ...
    {
      LOG_MSG("%s: Failed to purge peer switch client table.", __FUNCTION__);
    }

    if (cpClusterSwitchEntriesPurge() != L7_SUCCESS)
    {
      LOG_MSG("%s: Failed to purge peer switch table.", __FUNCTION__);
    }
  ...
  case CLUSTER_EVENT_SWITCH_JOINED:
    ...
    {
      LOG_MSG("%s: Failed to add peer switch %02x:%02x:%02x:%02x:%02x:%02x.\n",
              __FUNCTION__,
    ...
    {
      LOG_MSG("%s: Failed to set peer joined flag.", __FUNCTION__);
  ...
  case CLUSTER_EVENT_SWITCH_LEFT:
    if (cpdmOprData->cpLocalSw.status == CP_CLUSTER_SWITCH_CONTROLLER)
    {
      ...
      {
        LOG_MSG("%s: Failed to delete peer switch %02x:%02x:%02x:%02x:%02x:%02x clients from CC database.\n",
                __FUNCTION__,
                macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
        return;
      }
    ...
    {
      LOG_MSG("%s: Failed to delete peer switch %02x:%02x:%02x:%02x:%02x:%02x clients.\n",
              __FUNCTION__,
              macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
      return;
    }
    ...
    {
      LOG_MSG("%s: Failed to delete peer switch %02x:%02x:%02x:%02x:%02x:%02x.\n",
              __FUNCTION__,
              macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
      return;
    }
  ...
  case CLUSTER_EVENT_CONTROLLER_ELECTED:
    ...
    if (memcmp(&cpdmOprData->cpLocalSw.macAddr, &macAddr, sizeof(L7_enetMacAddr_t)) == 0)
    {
      ...
      if (cpClusterValidMacAddr(prevCtrlMac.addr) == L7_TRUE)
      {
        ...
        {
          LOG_MSG("%s: Failed to update peer switch %02x:%02x:%02x:%02x:%02x:%02x status.\n",
                  __FUNCTION__,
    ...
    else
    {
      ...
      {
        LOG_MSG("%s: Failed to set CP cluster controller elected flag.", __FUNCTION__);
...
L7_RC_t cpClusterClientNotificationMsgPeerSend(L7_enetMacAddr_t peerMac) 
{
  ...
  while (totalClients > 0)
  {
    ...
    while (cpdmClientConnStatusNextGet(&macAddr, &macAddr) == L7_SUCCESS)
    {
      if (clientCount == 0) 
      {
        ...
        {
          LOG_MSG("%s: %s client %02x:%02x:%02x:%02x:%02x:%02x switch MAC address",
                  __FUNCTION__, failed_to_get,
                  macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],
                  macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
          return L7_FAILURE;
      ...
      {
        LOG_MSG("%s: Failed to build client %02x:%02x:%02x:%02x:%02x:%02x notification msg.\n",
                __FUNCTION__,
                macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],
                macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
        return L7_FAILURE;
    ...
    {
      LOG_MSG("%s: Failed to send client notification msg to switch %02x:%02x:%02x:%02x:%02x:%02x",
              __FUNCTION__,
  ...
  LOG_MSG("%s: CP client notification msg sent to switch %02x:%02x:%02x:%02x:%02x:%02x",
          __FUNCTION__,
          peerMac.addr[0],peerMac.addr[1],peerMac.addr[2],
          peerMac.addr[3],peerMac.addr[4],peerMac.addr[5]);
  return L7_SUCCESS;
...
L7_RC_t cpClusterClientNotificationMsgSend(L7_enetMacAddr_t clientMacAddr, L7_BOOL authStatus)
{
  ...
  {
    LOG_MSG("%s: %s local switch MAC address.", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
  ...
  memset(&macAddr, 0, sizeof(L7_enetMacAddr_t));
  {
    ...
    while (gotAddr == L7_TRUE)
    {
      if (clusterMsgSend(&macAddr, CLUSTER_MSG_DELIVERY_RELIABLE, 
                         CP_CLUSTER_CP_CLIENT_NOTIFICATION_MSG, pdu.offset, buf) != L7_SUCCESS)
      {
        LOG_MSG("%s: CP client notification to switch %02x:%02x:%02x:%02x:%02x:%02x failed",
                __FUNCTION__,
                macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],
                macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
        return L7_FAILURE;
  ...
  LOG_MSG("%s: CP client notification msg sent to all peers.", __FUNCTION__);
  return L7_SUCCESS;
}
...
L7_RC_t cpClusterClientAuthReqMsgSend(L7_enetMacAddr_t swMacAddr, L7_enetMacAddr_t clientMacAddr)
{
  ...
  {
    LOG_MSG("%s: Failed to build client %02x:%02x:%02x:%02x:%02x:%02x auth req msg",
            __FUNCTION__,
            clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
            clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
    return L7_FAILURE;
  ...
  {
    LOG_MSG("%s: Failed to send CP client auth request to switch %02x:%02x:%02x:%02x:%02x:%02x",
            __FUNCTION__,
            swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
            swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
    return L7_FAILURE;
  ...
  LOG_MSG("%s: CP client auth request msg sent to peer.", __FUNCTION__);
  return L7_SUCCESS;
}
...
L7_RC_t cpClusterClientAuthReplyMsgSend(L7_enetMacAddr_t swMacAddr, L7_enetMacAddr_t clientMacAddr)
{
  ...
  {
    LOG_MSG("%s: Failed to build client %02x:%02x:%02x:%02x:%02x:%02x auth reply msg", __FUNCTION__,
            clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
            clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
    return L7_FAILURE;
  }
  ...
  {
    LOG_MSG("%s: Failed to send CP client auth reply to switch %02x:%02x:%02x:%02x:%02x:%02x",
            __FUNCTION__,
            swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
            swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
    return L7_FAILURE;
  ...
  LOG_MSG("%s: CP client auth reply msg sent to peer.", __FUNCTION__);
  return L7_SUCCESS;
}
                                      ...
                                      L7_uint32 cpBlkUnblk, L7_BOOL blkUnblkStatus)
{
  ...
  if (cpControllerCmdMsgBuild(clientMacAddr, cpId, cpBlkUnblk, blkUnblkStatus,
                              pdu.bufPtr, &pdu.offset, &message->msgLen) != L7_SUCCESS)
  {
    LOG_MSG("%s: Failed to build controller command msg", __FUNCTION__);
    return L7_FAILURE;
  }
  ...
  if (memcmp(&swMacAddr, &tmpMacAddr, sizeof(L7_enetMacAddr_t)) != 0)
  {
    ...
    {
      LOG_MSG("%s: Can't send controller cmd to switch %02x:%02x:%02x:%02x:%02x:%02x",
              __FUNCTION__,
              swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
              swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
      return L7_FAILURE;
  ...
  LOG_MSG("%s: CP controller cmd msg sent to peer", __FUNCTION__);
  return L7_SUCCESS;
}
...
do {
    ...
    {
      LOG_MSG("%s: Can't build client %02x:%02x:%02x:%02x:%02x:%02x update msg",
              __FUNCTION__,
              clientMacAddr->addr[0],clientMacAddr->addr[1],clientMacAddr->addr[2],
              clientMacAddr->addr[3],clientMacAddr->addr[4],clientMacAddr->addr[5]);
      break;
    ...
    if (L7_SUCCESS != rc)
    {
      LOG_MSG("%s: Can't update ctrllr %02x:%02x:%02x:%02x:%02x:%02x failed",
              __FUNCTION__,
      ...
      /* add this client */
        if (L7_SUCCESS !=
           cpConnClientsUpdateMsgBuild(clientMac, authStatus, 
                                         pdu.bufPtr, &pdu.offset, &message->msgLen))
        {
           LOG_MSG("%s: Can't add client %02x:%02x:%02x:%02x:%02x:%02x to msg",
                __FUNCTION__,
        ...
        if ((message->msgLen + CONN_CLIENT_INFO_SIZE) >= CLUSTER_MAX_RELIABLE_MSG_SIZE)
        {
          ...
          if (L7_SUCCESS != 
              clusterMsgSend(ctrlMacAddr, CLUSTER_MSG_DELIVERY_RELIABLE, 
                             CP_CLUSTER_CP_CONNECTED_CLIENTS_UPDATE_MSG, pdu.offset, buf))
          {
            LOG_MSG("%s: Connected clients update to ctrllr %02x:%02x:%02x:%02x:%02x:%02x failed",
                    __FUNCTION__,
                    ctrlMacAddr->addr[0],ctrlMacAddr->addr[1],ctrlMacAddr->addr[2],
                    ctrlMacAddr->addr[3],ctrlMacAddr->addr[4],ctrlMacAddr->addr[5]);
            return L7_FAILURE;
                                       ...
                                       L7_enetMacAddr_t ctrlMacAddr)
{
  ...
  if (cpId == 0)
  {
    while (cpdmCPConfigNextGet(cp_id, &cp_id) == L7_SUCCESS)
    {
      ...
      {
        LOG_MSG("%s: %s CP ID %d authenticated users", __FUNCTION__, failed_to_get, cp_id);
        return L7_FAILURE;
      }
      ...
      if (cpInstIntfUpdateMsgBuild(cpId, cpIdStatus, cpIdAuthUsers, intf,
                                   pdu.bufPtr, &pdu.offset, &message->msgLen) != L7_SUCCESS)
      {
        LOG_MSG("%s: Failed to build CPID %d update msg",  __FUNCTION__, cpId);
        return L7_FAILURE;
      }
    }
  }
  ...
  {
    LOG_MSG("%s: Failed to send CP instance interface update to controller %02x:%02x:%02x:%02x:%02x:%02x",
            __FUNCTION__,
            ctrlMacAddr.addr[0],ctrlMacAddr.addr[1],ctrlMacAddr.addr[2],
            ctrlMacAddr.addr[3],ctrlMacAddr.addr[4],ctrlMacAddr.addr[5]);
    return L7_FAILURE;
  ...
  LOG_MSG("%s: CP instance interface update msg sent to cluster controller.", __FUNCTION__);
  return L7_SUCCESS;
}
...
L7_RC_t cpClusterStatsUpdateMsgSend(L7_enetMacAddr_t ctrlMacAddr)
{
  ...
  memcpy(&switchMacAddr, &cpdmOprData->cpLocalSw.macAddr, sizeof(L7_enetMacAddr_t));
  {
    ...
    if (memcmp(&switchMacAddr, &nullMacAddr, sizeof(L7_enetMacAddr_t)) == 0)
    {
      LOG_MSG("%s: Can't get local switch MAC addr", __FUNCTION__);
      return L7_FAILURE;
    }
  }
  memset(&macAddr, 0, sizeof(L7_enetMacAddr_t));
  ...
  while (cpdmClientConnStatusNextGet(&macAddr, &macAddr) == L7_SUCCESS)
  {
     ...
     {
        LOG_MSG("%s: Can't build client %02x:%02x:%02x:%02x:%02x:%02x stats update msg",
                __FUNCTION__,
                macAddr.addr[0],macAddr.addr[1],macAddr.addr[2],
                macAddr.addr[3],macAddr.addr[4],macAddr.addr[5]);
        return L7_FAILURE;
...
L7_RC_t cpClusterConfigSyncMsgSend(L7_enetMacAddr_t swMacAddr)
{
      ...
      (status == L7_ENABLE))
  {
    ...
    if (rc != L7_SUCCESS)
    {
      LOG_MSG("%s: Failed to send config message to switch %02x:%02x:%02x:%02x:%02x:%02x.\n",
              __FUNCTION__,
              swMacAddr.addr[0],swMacAddr.addr[1],swMacAddr.addr[2],
              swMacAddr.addr[3],swMacAddr.addr[4],swMacAddr.addr[5]);
      rc = L7_ERROR;
  ...
  {
    LOG_MSG("%s: clusterConfigSendDone() failed.", __FUNCTION__);
    return L7_FAILURE;
  }
...
L7_RC_t cpClusterResendMsgSend(L7_uchar8 type)
{
  ...
  {
    LOG_MSG("%s: Failed to build resend msg", __FUNCTION__);
    return L7_FAILURE;
  }
  ...
  if (type == CP_CLUSTER_RESEND_CLIENT_NOTIFICATION)
  {
    for (i=0; i<CP_CLUSTER_MEMBERS; i++)
    {
      if (memcmp(&resendPeer[i], &tmpMacAddr, sizeof(L7_enetMacAddr_t)) != 0)
      {
        ...
        {
          LOG_MSG("%s: Failed to send resend request to switch %02x:%02x:%02x:%02x:%02x:%02x",
                  __FUNCTION__,
  ...
  LOG_MSG("%s: CP resend request msg sent", __FUNCTION__);
  return L7_SUCCESS;
}
                          ...
                          L7_uint32 msgLen, L7_uchar8 *buf)
{
  ...
  {
    LOG_MSG(tooLong, msgLen, CLUSTER_MAX_RELIABLE_MSG_SIZE);
    return;
  }

  if ((method == CLUSTER_MSG_DELIVERY_DATAGRAM) && (msgLen > CLUSTER_MAX_DATAGRAM_MSG_SIZE))
  {
    LOG_MSG(tooLong, msgLen, CLUSTER_MAX_DATAGRAM_MSG_SIZE);
    return;
  }
  ...
  case CP_CLUSTER_CP_CONFIG_SYNC_MSG:
    ...
    {
      LOG_MSG("Error exists! Msg type 0x%x is ignored.", msgType);
    }
    break;

  case CP_CLUSTER_CP_RESEND_MSG:
    LOG_MSG(msgTypeStr, msgType, "Resend");
    cpClusterResendMsgProcess(buf);
    break;

  default:
    LOG_MSG("Msg type: 0x%x UNKNOWN", msgType);
    break;
  }
}
...
void cpClusterClientNotificationMsgProcess(L7_uchar8 *buf)
{
  ...
  if (L7_NULLPTR == buf)
  {
    LOG_MSG("%s: Bad buffer", __FUNCTION__);
    return;
  }
  ...
  {
    LOG_MSG("%s: Invalid msg length %d, msg dropped.\n", __FUNCTION__, mLen);
    return;
  }
  ...
  if (totalIELen == 0)
  {
    LOG_MSG("%s: No IEs in msg, msg dropped.\n", __FUNCTION__ );
    return;
  }
  ...
  {
    LOG_MSG("%s: Invalid msg, msg dropped.\n", __FUNCTION__ );
    return;
  }

  if (cpClusterSwitchEntryGet(switchMacAddr) != L7_SUCCESS)
  {
    LOG_MSG("%s: Switch %02x:%02x:%02x:%02x:%02x:%02x not in cluster, msg dropped", __FUNCTION__ ,
  ...
  if (cpdmOprData->cpGlobalStatus.status != L7_CP_MODE_ENABLED)
  {
    ...
    {
      LOG_MSG("%s: Failed to set CP clients notification resend request flag", __FUNCTION__ );
    }
    return;
  }
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP client notification msg failed.", __FUNCTION__ );
      return;
    }
    ...
    case CP_CLIENT_NOTIFICATION_IE_TYPE_CLIENT_STATUS:
      ...
      break;
    default:
      LOG_MSG("%s: Unknown msg IE type: 0x%x.", __FUNCTION__ , mType);
      break;
    }
    ...
    if (ieCount == CP_CLIENT_NOTIFICATION_MSG_TOTAL_IE_COUNT)
    {
      if (clientStatus == CP_CLUSTER_CLIENT_CONNECTED)
      {
        if (cpdmOprData->cpLocalSw.status == CP_CLUSTER_SWITCH_MEMBER)
        {
          if (cpdmClientConnStatusGet(&clientMacAddr) == L7_SUCCESS)
          {
            ...
            {
              LOG_MSG("%s: Failed to delete connected client %02x:%02x:%02x:%02x:%02x:%02x.\n",
                      __FUNCTION__ ,
                      clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                      clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
            }
        ...
        if (cpClusterSwitchClientEntryGet(clientMacAddr) != L7_SUCCESS)
        {
          ...
          {
            LOG_MSG("%s: Peer Switch Client database full, msg dropped.", __FUNCTION__ );
            return;
          }
        }
        ...
        {
            LOG_MSG("%s: Failed to update peer switch client %02x:%02x:%02x:%02x:%02x:%02x.\n",
                    __FUNCTION__ ,
                    clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                    clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
        }
      ...
      else
      {
        ...
        {
          LOG_MSG("%s: Failed to delete peer switch client %02x:%02x:%02x:%02x:%02x:%02x.\n",
                  __FUNCTION__ ,
                  clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                  clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
        }
...
void cpClusterClientAuthRequestMsgProcess(L7_uchar8 *buf)
{
  ...
  if (cpdmOprData->cpGlobalStatus.status != L7_CP_MODE_ENABLED)
  {
    LOG_MSG("%s: CP disabled, msg dropped.", __FUNCTION__);
    return;
  }
  ...
  if (totalIELen == 0)
  {
    LOG_MSG("%s: No IEs in msg, msg dropped.", __FUNCTION__);
    return;
  }
  ...
  {
    LOG_MSG("%s: Invalid msg, msg dropped.", __FUNCTION__);
    return;
  }

  if (cpClusterSwitchEntryGet(switchMacAddr) != L7_SUCCESS)
  {
    LOG_MSG("%s: Switch %02x:%02x:%02x:%02x:%02x:%02x not in cluster, msg dropped.\n",
            __FUNCTION__,
            switchMacAddr.addr[0],switchMacAddr.addr[1],switchMacAddr.addr[2],
            switchMacAddr.addr[3],switchMacAddr.addr[4],switchMacAddr.addr[5]);
    return;
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP client auth request msg failed.", __FUNCTION__);
      return;
    }
    ...
    if (ieCount == CP_CLIENT_AUTH_REQUEST_MSG_TOTAL_IE_COUNT)
    {
      ...
      if (cpdmClientConnStatusGet(&clientMacAddr) == L7_SUCCESS)
      {
        ...
        {
          LOG_MSG("%s: Failed to set client auth reply send flag.", __FUNCTION__);
...
void cpClusterClientAuthReplyMsgProcess(L7_uchar8 *buf)
{
  ...
  if ((mLen <=0) || ((mLen-CP_CLUSTER_MSG_HDR_SIZE) <= 0))
  {
    LOG_MSG("%s: Invalid msg length %d, msg dropped", __FUNCTION__, mLen);
    return;
  }
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP client auth reply msg failed.", __FUNCTION__);
      return;
    }
...
void cpClusterControllerCmdMsgProcess(L7_uchar8 *buf)
{
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP controller command msg failed.", __FUNCTION__);
	    return;
	}
	...
	switch (mType)
	{
      ...
      if (mLen == CP_CTRL_CMD_IE_INST_UNBLOCK_SIZE)
      {
		...
		break;
	    default:
      LOG_MSG("%s: Unknown msg IE type:%d", __FUNCTION__, mType);
		break;
	}
    ...
    if (ieCount == CP_CTRL_CMD_MSG_TOTAL_IE_COUNT)
    {
      if (cpBlock != 0)
      {
        ...
        {
          LOG_MSG("%s: Failed to block instance %d", __FUNCTION__, cpBlock);
		}
      }
      else if (cpUnblock != 0)
      {
        ...
        {
          LOG_MSG("%s: Failed to unblock instance %d", __FUNCTION__, cpUnblock);
		}
      }
      else
      {
        if (memcmp(&clientMacAddr, &tmpMacAddr, sizeof(L7_enetMacAddr_t)) != 0)
        {
          if (cpdmClientConnStatusGet(&clientMacAddr) == L7_SUCCESS)
          {
            ...
            if (cpdmClientConnStatusDelete(&clientMacAddr) != L7_SUCCESS)
            {
              LOG_MSG("%s: Failed to deauth client %02x:%02x:%02x:%02x:%02x:%02x",
                      __FUNCTION__,
                      clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                      clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
            }
        ...
        else
        {
          if (cpId != 0)
          {
            ...
            {
              LOG_MSG("%s: Failed to deauth clients on instance %d", __FUNCTION__, cpId);
            }
          }
          else
          {
            ...
            {
              LOG_MSG("%s: Failed to deauth all clients.", __FUNCTION__);
            }
          }
        }
      }
...
void cpClusterConnClientsUpdateMsgProcess(L7_uchar8 *buf)
{
  ...
  if (cpdmOprData->cpLocalSw.status != CP_CLUSTER_SWITCH_CONTROLLER)
  {
    LOG_MSG("%s: Not a cluster controller, msg dropped.", __FUNCTION__);
    return;
  }
  ...
  if (cpdmOprData->cpGlobalStatus.status != L7_CP_MODE_ENABLED)
  {
    ...
    {
      LOG_MSG("%s: Failed to set CP connected clients resend request flag.", __FUNCTION__);
    }
    return;
  }
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP connected client update msg failed.", __FUNCTION__);
      return;
    }
    ...
    if (ieCount == CP_CONN_CLIENTS_UPDATE_MSG_TOTAL_IE_COUNT)
    {
      if (clientStatus == CP_CLUSTER_CLIENT_CONNECTED)
      {
        if (cpdmClientConnStatusTotalGet(&totalClients) == CP_CLIENT_CONN_STATUS_MAX)
        {
          ...
          {
            LOG_MSG("%s: Can't enq client for deauth?", __FUNCTION__);            
          }
          return;
        }
        ...
        if (cpdmClientConnStatusGet(&clientMacAddr) == L7_SUCCESS)
        {
          ...
          {
            LOG_MSG("%s: %s client switch type.", __FUNCTION__, failed_to_get);
          }
          ...
          if (swType == CP_AUTH_ON_PEER_SWITCH)
          {
            ...
            {
              LOG_MSG("%s: Failed to update peer client %02x:%02x:%02x:%02x:%02x:%02x",
                       __FUNCTION__,
                      clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                      clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
            }
          ...
          else
          {
            ...
            {
              LOG_MSG("%s: Failed to update ctrl client %02x:%02x:%02x:%02x:%02x:%02x",
                       __FUNCTION__,
                      clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                      clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
            }
        ...
        else
        {
          ...
          {
            LOG_MSG("%s: Failed to add peer client %02x:%02x:%02x:%02x:%02x:%02x.\n",__FUNCTION__,
                    clientMacAddr.addr[0],clientMacAddr.addr[1],clientMacAddr.addr[2],
                    clientMacAddr.addr[3],clientMacAddr.addr[4],clientMacAddr.addr[5]);
          }
        }
...
void cpClusterInstIntfUpdateMsgProcess(L7_uchar8 *buf)
{
  ...
  if (cpdmOprData->cpGlobalStatus.status != L7_CP_MODE_ENABLED)
  {
    ...
    {
      LOG_MSG("%s: Failed to set CP instance interface resend request flag.", __FUNCTION__);
    }
    return;
  }
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP instance interface update msg failed.", __FUNCTION__);
      return;
    }
    ...
    while (cpIEDone != L7_TRUE)
    {
      ...
      {
        LOG_MSG("%s: Parsing CP instance %d IE failed.\n",  __FUNCTION__, cpId);
        return;
      }
      ...
      if (ieCount == CP_INST_INTF_UPDATE_MSG_TOTAL_IE_COUNT)
      {
        ...
        {
          LOG_MSG("%s: Failed to update Peer Switch %02x:%02x:%02x:%02x:%02x:%02x parms",
                  __FUNCTION__,
                  switchMacAddr.addr[0],switchMacAddr.addr[1],switchMacAddr.addr[2],
                  switchMacAddr.addr[3],switchMacAddr.addr[4],switchMacAddr.addr[5]);
          continue;
...
void cpClusterStatsUpdateMsgHandle(L7_uchar8 *buf, L7_uint32 msgLen)
{
  ...
  if (pCaptivePortalMsgQueue == L7_NULL)
  {
    LOG_MSG("%s: CP message queue not created.", __FUNCTION__);
    return;
  }

  memset(&msg, 0, sizeof(captivePortalTaskMsg));
  msg.msgID = CP_CLUSTER_MSG_ID_STATS_UPDATE;
  memcpy(msg.type.statsMsg.buf, buf, msgLen);
  msg.type.statsMsg.msgLen = msgLen;

  if (osapiMessageSend(pCaptivePortalMsgQueue, &msg, sizeof(captivePortalTaskMsg),
                       L7_NO_WAIT, L7_MSG_PRIORITY_NORM) != L7_SUCCESS)
  {
    LOG_MSG("%s: osapiMessageSend failed.", __FUNCTION__);
  }
}
...
void cpClusterStatsUpdateMsgProcess(L7_uchar8 *buf, L7_uint32 msgLen)
{
  ...
  if ((mLen - CP_CLUSTER_MSG_HDR_SIZE) <= 0)
  {
    LOG_MSG("%s: Invalid msg length %d, msg dropped.",  __FUNCTION__, msgLen);
    return;
  }
  ...
  {
    LOG_MSG("%s: Actual msg length (%d) less than stated in msg (%d).",
  ...
  {
    LOG_MSG("%s: Invalid msg: expected type %d, got %d. Dropped.",
  ...
  while(totalIELen >= CONN_CLIENT_STATS_SIZE)
  {
     ...
     {
       LOG_MSG("Malformed IE: expected type %d, length %d: got %d, %d instead",
     ...
     {
        LOG_MSG("Failed to update peer switch stats.");
     }
  }
}
...
void cpClusterConfigSyncMsgProcess(L7_uchar8 *buf)
{
  ...
  case CP_CLUSTER_CONFIG_MSG_IE_GLOBAL_TYPE:
    ...
    LOG_MSG("Processed CP Globals sync msg, IE type: %d", mType);
    break;
  case CP_CLUSTER_CONFIG_MSG_IE_CP_TYPE:
    cpConfigMsgCPProcess(msgCfgSyncBuf, totalIELen);
    LOG_MSG("Processed CP Instances sync msg, IE type: %d",  mType);
    break;
  case CP_CLUSTER_CONFIG_MSG_IE_GROUP_TYPE:
    cpConfigMsgGroupProcess(msgCfgSyncBuf, totalIELen);
    LOG_MSG("Processed CP Groups sync msg, IE type: %d", mType);
    break;
  case CP_CLUSTER_CONFIG_MSG_IE_USER_TYPE:
    cpConfigMsgUserProcess(msgCfgSyncBuf, totalIELen);
    LOG_MSG("Processed CP Local Users sync msg, IE type: %d", mType);
    break;
  default:
    LOG_MSG("%s:Unknown Sync msg IE type: %d", __FUNCTION__, mType);
    break;
  }
}
...
void cpClusterResendMsgProcess(L7_uchar8 *buf)
{
  ...
  while (totalIELen > 0)
  {
    ...
    {
      LOG_MSG("%s: Parsing CP resend msg failed.", __FUNCTION__);
      return;
    }
    ...
    if (ieCount == CP_RESEND_MSG_TOTAL_IE_COUNT)
    {
      if (type == CP_CLUSTER_RESEND_CLIENT_NOTIFICATION)
      {
        ...
        {
          LOG_MSG("%s: Failed to set client notification resend flag.", __FUNCTION__);
          memset(&cpdmOprData->cpNewPeer, 0, sizeof(L7_enetMacAddr_t));
          return;
        }
      }
      else if (type == CP_CLUSTER_RESEND_CONN_CLIENTS_UPDATE)
      {
        ...
        {
          LOG_MSG("%s: Failed to set connected clients resend flag.", __FUNCTION__);
          return;
        }
      }
      else
      {
        ...
        {
          LOG_MSG("%s: Failed to set instance interface resend flag.", __FUNCTION__);
          return;
        }
      }
...
L7_RC_t cpClusterConfigPushStatusGet(L7_uint32 *status)
{
  ...
  {
    LOG_MSG("%s: %s CP config push status.", __FUNCTION__, failed_to_get);
    return L7_FAILURE;
  }
#endif
...
void cpClusterConfigSendCallback(clusterMemberID_t *memberID)
{
  ...
  {
    LOG_MSG("%s: Failed to set CP config send flag.", __FUNCTION__);
...
void cpClusterConfigRxCallback(clusterConfigCmd cmd)
{
  ...
  {
    LOG_MSG("%s: Failed to set CP config received flag.", __FUNCTION__);
  }
...
void cpClusterConfigSyncCmdProcess(clusterConfigCmd cmd)
{
  ...
  case CLUSTER_CONFIG_CMD_END_TRANSFER:
    ...
    {
      LOG_MSG("%s: clusterConfigRxDone() failed.", __FUNCTION__);
    }
    break;
  case CLUSTER_CONFIG_CMD_APPLY:
    ...
    break;
  default:
    LOG_MSG("%s: Unknown cmd %d received.\n", __FUNCTION__, cmd);
    break;
  }
}
