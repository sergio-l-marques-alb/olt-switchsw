...
#define DOT1X_DEBUG_PACKET_RX_FORMAT     "Pkt RX - Intf: %d/%d/%d(%d),SrcMac: %s DestMac: %s Type: %s\n"
#define DOT1X_DEBUG_PACKET_RX_EAP_FORMAT "Pkt RX - Intf: %d/%d/%d(%d),SrcMac: %s DestMac: %s Type: %s Code: %s Id:%d\n"
#define DOT1X_DEBUG_PACKET_TX_FORMAT     "Pkt TX - Intf: %d/%d/%d(%d),SrcMac: %s DestMac: %s Type: %s Code: %s\n"
#define DOT1X_DEBUG_PACKET_TX_EAP_FORMAT "Pkt TX - Intf: %d/%d/%d(%d),SrcMac: %s DestMac: %s Type: %s Code: %s Id:%d\n"
...
void dot1xDebugPortMacInfoShow(L7_uint32 lIntIfNum)
{
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,
                "ApmState                  = %d", logicalPortInfo->apmState);
  switch (logicalPortInfo->apmState)
  {
  case APM_INITIALIZE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Initialize\r\n");}
    break;
  case APM_DISCONNECTED:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Disconnected\r\n");}
    break;
  case APM_CONNECTING:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Connecting\r\n");}
    break;
  case APM_AUTHENTICATING:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Authenticating\r\n");}
    break;
  case APM_AUTHENTICATED:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Authenticated\r\n");}
    break;
  case APM_ABORTING:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Aborting\r\n");}
    break;
  case APM_HELD:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Held\r\n");}
    break;
  case APM_FORCE_AUTH:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Force_Auth\r\n");}
    break;
  case APM_FORCE_UNAUTH:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Force_Unauth\r\n");}
    break;
  default:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Unknown\r\n");}
    break;
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,
                "ktxState                  = %d", logicalPortInfo->ktxState);
  switch (logicalPortInfo->ktxState)
  {
  case KTX_NO_KEY_TRANSMIT:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " No_Key_Transmit\r\n");}
    break;
  case KTX_KEY_TRANSMIT:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Key_Transmit\r\n");}
    break;
  default:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Unknown\r\n");}
    break;
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,
                "rtmState                  = %d", logicalPortInfo->rtmState);
  ...
  case RTM_REAUTHENTICATE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Reauthenticate\r\n");}
    break;
  default:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Unknown\r\n");}
    break;
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,
                "bamState                  = %d", logicalPortInfo->bamState);
  switch (logicalPortInfo->bamState)
  {
  case BAM_REQUEST:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Request\r\n");}
    break;
  case BAM_RESPONSE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Response\r\n");}
    break;
  case BAM_SUCCESS:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Success\r\n");}
    break;
  case BAM_FAIL:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Fail\r\n");}
    break;
  case BAM_TIMEOUT:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Timeout\r\n");}
    break;
  case BAM_IDLE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Idle\r\n");}
    break;
  case BAM_INITIALIZE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Initialize\r\n");}
    break;
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,
                "krxState                  = %d", logicalPortInfo->krxState);
  switch (logicalPortInfo->krxState)
  {
  case KRX_NO_KEY_RECEIVE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " No_Key_Receive\r\n");}
    break;
  case KRX_KEY_RECEIVE:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Key_Receive\r\n");}
    break;
  default:
    {SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " Unknown\r\n");}
    break;
  ...
  bzero(buf, 32);
  sprintf((L7_char8 *)buf, "%02X:%02X:%02X:%02X:%02X:%02X",
  ...
  SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS,
                "MAB Client            = %d", logicalPortInfo->isMABClient);
  if (logicalPortInfo->isMABClient  == L7_TRUE)
  {
    SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " True\r\n");
  }
  else if (logicalPortInfo->isMABClient == L7_FALSE)
  {
    SYSAPI_PRINTF(SYSAPI_APPLICATION_LOGGING_ALWAYS, " False\r\n");
  }
  else
      ...
      if (nimGetUnitSlotPort(intIfNum, &usp) == L7_SUCCESS)
      {
        if((dot1xDebugPacketTraceRxFlag == L7_TRUE) && (rxFlag == L7_TRUE))
        {
          DOT1X_USER_TRACE_RX(DOT1X_DEBUG_PACKET_RX_EAP_FORMAT,
              ...
              intIfNum,srcMac, destMac, type,code,eapPkt->id);
        }
