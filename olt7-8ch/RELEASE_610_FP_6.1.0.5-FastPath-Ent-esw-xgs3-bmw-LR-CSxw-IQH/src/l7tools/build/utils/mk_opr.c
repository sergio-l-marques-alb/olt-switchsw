					...
					unsigned short symbols_crc)
{
  ...
  */
  ...
  strncpy(image_header.vpd.timestamp, ctime(&t), IPL_VPD_TIME_SIZE);
  image_header.vpd.timestamp[strlen(image_header.vpd.timestamp) - 1] = '\0';
  strncpy(image_header.vpd.filename, image_file, IPL_VPD_FILENAME_SIZE);
  ...
  strcpy(image_header.copyright,copyright_string);
  ...
  */
  ...
  printf ("CRC............................0x%x (%d)\n", ntohs(image_header.crc), ntohs(image_header.crc));
  printf ("Target Device..................0x%x\n", ntohl(image_header.target_device));
  printf ("Size...........................0x%x (%d)\n", ntohl(image_header.size), ntohl(image_header.size));
  printf ("Number of Components...........%d\n\n", ntohl(image_header.num_components));


  printf ("Operational Code Size..........0x%x (%d)\n", 
          ntohl(image_header.component[OPCODE].component_size),
          ntohl(image_header.component[OPCODE].component_size));
  printf ("Operational Code Offset........0x%x (%d)\n",
          ntohl (image_header.component[OPCODE].component_offset),
          ntohl (image_header.component[OPCODE].component_offset));
  printf ("Operational Code FLASH flag....%d\n",
          ntohl (image_header.component[OPCODE].store_in_flash));
  printf ("Operational Code CRC...........0x%X\n\n",
          ntohs(image_header.component[OPCODE].crc));


  if ( bootcode_size )
  {
    printf ("Boot Code Version..............%d\n",
            ntohl(image_header.component[BOOTCODE].version));
    printf ("Boot Code Size.................0x%x (%d)\n", 
            ntohl(image_header.component[BOOTCODE].component_size), 
            ntohl(image_header.component[BOOTCODE].component_size));
    printf ("Boot Code Offset...............0x%x (%d)\n", 
            ntohl(image_header.component[BOOTCODE].component_offset), 
            ntohl(image_header.component[BOOTCODE].component_offset));
    printf ("Boot Code FLASH flag...........%d\n",
            ntohl (image_header.component[BOOTCODE].store_in_flash));
    printf ("Boot Code CRC..................0x%X\n\n",
            ntohs(image_header.component[BOOTCODE].crc));
  }

  if ( symbols_size )
  {
    printf ("Symbols Version..............%d\n",
            ntohl(image_header.component[SYMBOLS].version));
    printf ("Symbols Size.................0x%x (%d)\n", 
            ntohl(image_header.component[SYMBOLS].component_size), 
            ntohl(image_header.component[SYMBOLS].component_size));
    printf ("Symbols Offset...............0x%x (%d)\n", 
            ntohl(image_header.component[SYMBOLS].component_offset), 
            ntohl(image_header.component[SYMBOLS].component_offset));
    printf ("Symbols FLASH flag...........%d\n",
            ntohl (image_header.component[SYMBOLS].store_in_flash));
    printf ("Symbols CRC..................0x%X\n\n",
            ntohs(image_header.component[SYMBOLS].crc));
  }
