...
<td id="tabr0" bgcolor="#c81016" align="right"><img src="spacer_dark.gif" border="0" height="18" width="1"></td>
  ...
  */
  ...
  osapiSnprintf(tbuf, sizeof(tbuf), "\n<td id=\"tabl%d\" bgcolor=\"%s\">&nbsp;</TD>", tabIndex, tabcolor); 
  osapiStrncpy(buf, tbuf, buflen-1);
  buf[buflen-1] = '\0';
  ...
  osapiSnprintf(tbuf, sizeof(tbuf), "\n<td id=\"tabr%d\" bgcolor=\"%s\" align=right><img src=\"%s\" width=%d height=%d border=0></TD>\n",
...
void usmWebTabWrapperTop(L7_char8 *buf, L7_uint32 buflen)
{
  ...
  osapiStrncat(buf, "<tr><td><img src=\"/base/images/spacer_h4.gif\" width=1 height=4 border=0></td></tr>\n", (buflen-1-strlen(buf)));
  osapiStrncat(buf, "<tr><td width=\"100%%\" valign=top>\n", (buflen-1-strlen(buf)));
...
void usmWebTabWrapperMiddle(L7_char8 *buf, L7_uint32 buflen)
{
  ...
  osapiStrncat(buf, tbuf, (buflen-1-strlen(buf)));
  osapiStrncat(buf, "</table></td></tr>", (buflen-1-strlen(buf)));
  osapiSnprintf(tbuf, sizeof(tbuf), "<tr><td width=\"100%%\" valign=top>\n<table cellpadding=0 cellspacing=0 border=0 bgcolor=\"%s\" width=\"100%%\"><tr>\n",
               TAB_COLOR_BACKGROUND); 
  osapiStrncat(buf, tbuf, (buflen-1-strlen(buf)));
}
