...
L7_RC_t
snmpAgentSwitchDvlanTagIsDefaultTPid(L7_uint32 UnitIndex, L7_uint32 etherType)
{
  L7_RC_t rc = L7_FAILURE;
  L7_uint32 tpidValue;
...
snmpAgentPortDVlanTagModeGet(L7_uint32 UnitIndex, L7_uint32 intIfIndex, L7_uint32 *val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    switch (temp_val)
    {
#ifdef I_agentSwitchPortDVlanTagMode 
    case L7_ENABLE:
      *val = D_agentSwitchPortDVlanTagMode_enable;
      break;

    case L7_DISABLE:
      *val = D_agentSwitchPortDVlanTagMode_disable;
      break;
#endif
...
snmpAgentPortDVlanTagModeSet(L7_uint32 UnitIndex, L7_uint32 intIfIndex, L7_uint32 val)
{
  ...
  {
#ifdef I_agentSwitchPortDVlanTagMode 
  case D_agentSwitchPortDVlanTagMode_enable:
    temp_val = L7_ENABLE;
    break;

  case D_agentSwitchPortDVlanTagMode_disable:
    temp_val = L7_DISABLE;
    break;
#endif
...
snmpAgentSwitchPortDvlanTagEntryGet(L7_uint32 UnitIndex, L7_uint32 intIfIndex, L7_uint32 etherType)
{
  ...
  if(usmDbPhysicalIntIfNumberCheck(UnitIndex, intIfIndex) != L7_SUCCESS)
  {
    return L7_FAILURE;
  }
                                                  ...
                                                  L7_uint32 *nextEtherType)
{
  ...
  if(usmDbNextPhysicalExtIfNumberGet(UnitIndex, intIfIndex, nextIntfIndex) == L7_SUCCESS)
  {
