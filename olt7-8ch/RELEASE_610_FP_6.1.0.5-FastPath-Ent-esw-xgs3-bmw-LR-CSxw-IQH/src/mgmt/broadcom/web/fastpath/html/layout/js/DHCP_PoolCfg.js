...
//Assigning Lease Time object with the values of days,hours and minutes
   ...
   if((parseInt(hours)<0)||(parseInt(hours)>22))
   {
      hours = hourscurr;
      alert("Error!Hours should be in the range of 0-22");
   }
   if((parseInt(minutes)<0)||(parseInt(minutes)>86399))
   {
      minutes = minutescurr; 
      alert("Error!Minutes should be in the range of 0-86399");
   }
   
   if((leaseTimeSelect.value == "Specified Duration")||(leaseTimeSelect.nextSibling.value ==  "Specified Duration"))
   {	
