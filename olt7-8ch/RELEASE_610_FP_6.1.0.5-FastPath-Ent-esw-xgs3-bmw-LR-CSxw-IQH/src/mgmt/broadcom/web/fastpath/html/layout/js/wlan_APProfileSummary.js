...
function wlan_APProfileSummary_SubmitStart(submitFlag)
{
}
function wlan_APProfileSummary_SubmitEnd(submitFlag)
{
}

function wlan_APProfileSummary_LoadStart(arg)
{
  xeData.nTabInfo = tabsList;
/* xeData.nTabInfo = [ ["Summary","APProfileSummary.html"], ["Default",["Global","APProfileGlobalConfiguration.html"],["Radio","APProfileRadioConfiguration.html"],["VAP","APProfileVAPConfiguration.html"], ["QoS","APProfileQoSConfiguration.html"]] ];*/

}

function wlan_APProfileSummary_LoadEnd(arg)
{
  ...
  var range_of_values = xui_oem_getAllWebEnums("1_1_2");
  //glbCheckVariable = document.getElementById("1_1_1").nextSibling.nextSibling.childNodes[0].value;
  glbCheckVariable = getInputElementByXid("1_1_2").value;
  ...
  for ( var i=1; i < range_of_values.length; i++ )
  {
     ...
     for ( var j=0; j < additionalTab.length; j++)
     {
       ...
       tempArray[j][1]= tempString+"?v_1_1_2="+range_of_values[i]+"&submit_target="+tempString+"&submit_flag=8";
     }
  ...
  var addBtn = document.getElementById("2_3_2");
  if(addBtn != null)
  {
    addBtn.width = "1%";
    addBtn.align = "right";
  ...
  var copyBtn = document.getElementById("2_3_3");
  if(copyBtn != null)
  {
    copyBtn.align = "left";
  }
