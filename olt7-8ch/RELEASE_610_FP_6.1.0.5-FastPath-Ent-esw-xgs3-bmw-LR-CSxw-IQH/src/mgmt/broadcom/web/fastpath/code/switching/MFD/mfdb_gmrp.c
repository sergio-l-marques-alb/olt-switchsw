 ...
 **********************************************************************
 *
 * @filename src/mgmt/emweb/web/switching/mfdb/mfdb_gmrp.c
 *
 * @purpose Code in support of the mfdb_gmrp.html page
 *
 * @component unitmgr
 *
 * @comments tba
...
*
*********************************************************************/
L7_char8 *usmWebMfdbGmrpTableInfoGet(L7_uint32 unit, usmWeb_MfdbEntry_t *entry)
{
  L7_RC_t rc;
  L7_char8 type[36];
...
*
* @param form pointer to the mfdb_gmrp form
*
* @returns none
*
* @end
*
*********************************************************************/
void ewaFormServe_mfdb_gmrp(EwsContext context, EwaForm_mfdb_gmrpP form)
{
...
*
* @returns mfdb_gmrp.html
*
* @end
*
*********************************************************************/
char *ewaFormSubmit_mfdb_gmrp ( EwsContext context, EwaForm_mfdb_gmrpP form )
{
  EwaNetHandle net;

  net = ewsContextNetHandle(context);
  ewsContextSendReply(context, pStrInfo_switching_HtmlFileMfdbGmrp);
  return NULL;
}
