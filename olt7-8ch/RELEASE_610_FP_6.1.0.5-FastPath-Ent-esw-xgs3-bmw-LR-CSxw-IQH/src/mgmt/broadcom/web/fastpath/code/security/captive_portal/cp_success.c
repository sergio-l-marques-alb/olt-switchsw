 ...
 **********************************************************************
 *
 * @filename cp_success.html
 *
 * @purpose  User logout de-authentication success notify page
 *
 * @comments 
 *
 * @create 12-16-2008
...
/*****************************************************************************
 ****************************************************************************/
void ewaFormServe_logoutSuccess ( EwsContext context, EwaForm_logoutSuccessP form )
{
}

/******************************************************************************
******************************************************************************/
char *ewaFormSubmit_logoutSuccess ( EwsContext context, EwaForm_logoutSuccessP form )
{
  EwaNetHandle net;
  cpAppInfo_t appInfo;
