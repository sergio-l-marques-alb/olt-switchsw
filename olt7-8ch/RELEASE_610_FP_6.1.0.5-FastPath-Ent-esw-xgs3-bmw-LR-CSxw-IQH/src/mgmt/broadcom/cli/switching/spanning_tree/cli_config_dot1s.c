...
{
  L7_uint32 argName = 1;
  L7_char8 name[DOT1S_MAX_CONFIG_NAME_SIZE];
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if (strlen(argv[index+argName]) > (DOT1S_MAX_CONFIG_NAME_SIZE-1))
    {
      return cliSyntaxReturnPromptAddBlanks (1,1, 0, 0, pStrErr_common_Error,ewsContext, pStrErr_switching_Dot1sCfgNameLen, (DOT1S_MAX_CONFIG_NAME_SIZE-1));
    }
    ...
    L7_uint32 index)
{
  ...
  {
    /* Invalid port */
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_switching_Dot1sGenSlotPortErrorMsg);
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sEdgePort);
    }
  }
    ...
    L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sAutoEdge);
    }
  }
    ...
    L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sRootGuard);
    }
  }
    ...
    L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sPortGuard);
    }
    ...
    L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sTcnGuard);
    }
  }
    ...
    L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sPortPathCost);
    }
  }
    ...
    L7_uint32 index)
{
  ...
  {
    priority = FD_DOT1S_PORT_PRIORITY;
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sPortPri);
    }
    ...
    L7_uint32 index)
{
  ...
  for (i = 0; i < vlanCount; i++)
  {
    ...
    {
      osapiSnprintfAddBlanks (1, 0, 0, 0, L7_NULLPTR,  buf, sizeof(buf), pStrErr_switching_Dot1sInvalidVlan_1, vlanID);
      ewsTelnetWrite(ewsContext, buf);
      flag = L7_FALSE;
      continue;      
  }
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    /* Determine the previous mstid associated with this vlan for informational message */
      if ( usmDbDot1sVlanToMstiGet( unit, vlanID, &prevMstid ) != L7_SUCCESS )
    {
      /* Set prevMstid to CIST to handle as if associated with CIST.  No informational
         message will be displayed. */
      prevMstid = L7_DOT1S_CIST_INSTANCE;
    }

    /**Check if the script execute Flag is set for execute then execute the usmdb**/
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
        if ( usmDbDot1sMstiVlanAdd(unit, mstid, vlanID) != L7_SUCCESS )
      {
          osapiSnprintfAddBlanks (1, 0, 0, 0, L7_NULLPTR,  buf, sizeof(buf), pStrErr_switching_Dot1sMstVlanAdd, vlanID);
          ewsTelnetWrite(ewsContext, buf);
          flag = L7_FALSE;                       
        }        
        else if (prevMstid != L7_DOT1S_CIST_INSTANCE && prevMstid != mstid )
        {
          osapiSnprintfAddBlanks (1, 0, 0, 0, L7_NULLPTR,  buf, sizeof(buf), pStrInfo_switching_Dot1sMstVlanAddInfo, vlanID, prevMstid, mstid );
  ...
  else if(ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
        if ( usmDbDot1sMstiVlanRemove(unit, mstid, vlanID) != L7_SUCCESS )
      {
          osapiSnprintfAddBlanks (1, 0, 0, 0, L7_NULLPTR,  buf, sizeof(buf), pStrErr_switching_Dot1sMstVlanRemove, vlanID);
          ewsTelnetWrite(ewsContext, buf);
          flag = L7_FALSE;                      
        }
      }
  ...
  if (strcmp(argv[index+2],pStrInfo_common_Cost2) <= 0)
  {
    ...
    else if (ewsContext->commType == CLI_NO_CMD)
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if ( usmDbDot1sMstiPortPathCostSet(unit, mstid, iface, cost) != L7_SUCCESS )
        {
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sPortPathCostNo);
        }
      }
  ...
  else if (strcmp(argv[index+2],pStrInfo_switching_PortPri_1) <= 0)
  {
    ...
    else if (ewsContext->commType == CLI_NO_CMD)
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if( usmDbDot1sMstiPortPrioritySet(unit, mstid, iface, &priority) != L7_SUCCESS )
        {
          return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sPortPriNo);
        }
      }
    }
    /**Check if the script execute Flag is set for execute then execute the usmdb**/
...
const L7_char8 *commandSpanningTreeIntfBpduFilter(EwsContext ewsContext,
    ...
    L7_uint32 index)
{
  L7_uint32 slot, port, iface,unit;
  L7_BOOL mode = L7_FALSE;
  L7_uint32 numArg;
    ...
    L7_uint32 index)
{
  ...
  if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_switching_Dot1sBpdu);
    }
  }
