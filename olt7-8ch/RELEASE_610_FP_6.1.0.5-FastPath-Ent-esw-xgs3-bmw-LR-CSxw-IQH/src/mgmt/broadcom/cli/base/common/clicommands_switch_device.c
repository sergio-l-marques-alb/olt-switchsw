...
void buildTreeVlanDBSwDevVlan(EwsCliCommandP depth1)
{
  ...
  )
  {
    ...
    for (idx = 0; idx < 2; idx++)
    {
      ...
      // PTin added
      depth6 = ewsCliAddNode(depth5, pStrInfo_base_Querier_mrouter_vlan, pStrInfo_switching_CfgureIgmpSnoopingQuerierXlateVlan, commandSetSnoopingQuerierVlanXlate, 2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_BOTH);
