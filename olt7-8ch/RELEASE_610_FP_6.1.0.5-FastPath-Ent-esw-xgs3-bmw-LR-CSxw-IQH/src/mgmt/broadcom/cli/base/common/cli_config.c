 ...
 *
 *
 * @cmdsyntax  network parms <ipaddress> <netmask> [<gateway>]
 *
 * @cmdhelp
 *
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  /* if more than 3 or less than 2 arguments, display syntax */
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    if (gateway != 0 && usmDbAgentIpIfDefaultRouterSet(unit, gateway) != L7_SUCCESS) /* SET GATEWAY */
    {
      ...
      if ((ipAddr != oldIpAddr) || (oldNetMask != netMask))
      {
        usmDbAgentIpIfAddressSet(unit, oldIpAddr);                                     /* RESET IP */
        usmDbAgentIpIfNetMaskSet(unit, oldNetMask);                                    /* RESET NETMASK */
      }
      ...
      (strcmp(argv[index+argProtocol], pStrInfo_common_Dhcp_1) == 0) )
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      if (strcmp(argv[index+argProtocol], pStrInfo_common_None_3) == 0)
      {
        ...
        {
          usmDbDhcp_release(unit);
        }
        usmDbAgentIpIfDefaultRouterSet(unit, 0);
        usmDbAgentIpIfAddressSet(unit, 0);
        usmDbAgentIpIfNetMaskSet(unit, 0);
...
const L7_char8 *commandNetworkMgmtVlan(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if(usmDbMgmtVlanIdSet(unit, vlanid)!=L7_SUCCESS)
    {
      return cliSyntaxReturnPromptAddBlanks (0, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_base_MgmtVlanNotSet);
    }
  }
 ...
 *
 *
 * @cmdsyntax  serviceport ip <ipaddr> <netmask> [<gateway>]
 *
 * @cmdhelp
 *
 * @cmddescript  check for valid ip addr and valid subnet mask.
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    /* Get the old ip address & subnet mask, and gateway in case something fails */
    usmDbServicePortIPAddrGet(unit, &oldIpAddr);
    usmDbServicePortNetMaskGet(unit, &oldNetMask);
    usmDbServicePortGatewayGet(unit, &oldGateway);
    ...
    /* If the triad is valid reset gateway, ip address, and netmask */
    usmDbServicePortGatewaySet(unit, 0);                                               /* CLEAR GATEWAY */

    /* only if ip or netmask changed */
    if ((ipAddr != oldIpAddr) || (oldNetMask != netMask))
    {
      /* set up the netmask, ip addr with user specified values */
      if (usmDbServicePortIPAndNetMaskSet(unit, ipAddr, netMask, &errorNum) != L7_SUCCESS)  /* SET IP/NETMASK */
      {
        /* If we could not set the IP and NetMask, reset the gateway, and return with the given error message */
    ...
    if (gateway != 0 && usmDbServicePortGatewaySet(unit, gateway) != L7_SUCCESS)       /* SET GATEWAY */
    {
      ...
      if ((ipAddr != oldIpAddr) || (oldNetMask != netMask))
      {
        usmDbServicePortIPAddrSet(unit, oldIpAddr);                                      /* RESET IP */
        usmDbServicePortNetMaskSet(unit, oldNetMask);                                    /* RESET NETMASK */
      }
      ...
      (strcmp(argv[index+argProtocol], pStrInfo_common_Dhcp_1) == 0) )
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      if (strcmp(argv[index+argProtocol], pStrInfo_common_None_3) == 0)
      {
        ...
        usmDbServicePortIPAddrSet(unit, 0);
        usmDbServicePortNetMaskSet(unit, 0);
...
const L7_char8 *commandSetPrompt(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (temp[0] != '"' && strlen((L7_char8 *)argv[index+arg1]) < L7_PROMPT_SIZE)
  {
    if (cliPromptIsAlphaNum(temp) != L7_SUCCESS)
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput, ewsContext, pStrErr_base_CfgPrompt_1);
    }
  }
 ...
 * @notes none
 *
 * @cmdsyntax  snmptrap ipddr <ipaddrold> <name> <ipaddrnew>
 *
 * @cmdhelp
 *
 * @cmddescript
...
L7_uchar8     str_addr[64];*/
  ...
  if(strcmp(argv[index],pStrInfo_base_Ipaddr_2) == 0)
  {
    ...
    if (usmDbInetAton(strIpAddr, &ipAddr) != L7_SUCCESS || (ipAddr == 0) ||
        usmDbInetAton(strIpAddrNew, &ipAddrNew) != L7_SUCCESS || (ipAddrNew == 0))
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput,  ewsContext, pStrErr_common_CfgNwIp);
    }
  }
 ...
 * @notes none
 *
 * @cmdsyntax  snmptrap snmpversion <name> <ipaddr> <snmpversion>
 *
 * @cmdhelp
 *
 * @cmddescript
 ...
 * @notes none
 *
 * @cmdsyntax snmptrap mode <name> <ipaddress>
 *
 * @cmdhelp
 *
 * @cmddescript
...
const L7_char8 *commandShutdown(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1,1, 0, 0, L7_NULLPTR,ewsContext, pStrInfo_base_FeatNotSupported, cliSyntaxInterfaceHelp());
    }
...
const L7_char8 *commandAutoNegotiate(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Cant,  ewsContext, pStrInfo_base_AutoNegotiate_1);
  }

  rc = usmDbIfTypeGet(unit, interface, &intIfType);
  if ( (intIfType == L7_IANA_GIGABIT_ETHERNET || intIfType == L7_IANA_2G5BIT_ETHERNET) &&
      (phyCapability & L7_PHY_CAP_PORTSPEED_AUTO_NEG) != L7_TRUE)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrInfo_base_OperationHasNoEffectOnGigabitPorts);
  }
...
const L7_char8 *commandPortLacpMode(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if ( usmDbIntfTypeGet(interface, &itype) == L7_SUCCESS )
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_LagCantEnblDsbl);
    }
  }
...
const L7_char8 *commandStormControlIntfMcast(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (unit == 0)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrErr_base_StormCntrlMcast_2);
  }
...
const L7_char8 *commandStormControlIntfUcast(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (unit == 0)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot, ewsContext, pStrErr_base_StormCntrlUcast_2);
  }
...
const L7_char8 *commandInterfaceAddPort(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (cliIsStackingSupported() == L7_TRUE)
  {
    unitNum = EWSUNIT(ewsContext);
  }
  else
  {
    unitNum = cliGetUnitId();
  }

  slot = EWSSLOT(ewsContext);
  port =EWSPORT(ewsContext);
  if (usmDbIntIfNumFromUSPGet(unitNum, slot, port, &interface) != L7_SUCCESS)
  {
    return cliPrompt(ewsContext);
  }
  ...
  if (itype == L7_LAG_INTF)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext,pStrErr_base_LagsCantBeAddedToOtherLagsAsMbrPorts);
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if(usmDbDot3adIsStaticLag(unit, intIfNum, &val) == L7_SUCCESS)
    {
      ...
      if(val != L7_TRUE)
      {
        ...
        {
          osapiSnprintf(buf, sizeof(buf), "\r\n%s ", cliDisplayInterfaceHelp(unitNum, slot, port));
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Error, ewsContext, pStrErr_base_LagStaticCheckingFailed);
  ...
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_MirroredOrProbePortsCantBeLagMbrs);
  }
...
#if 0 /* redundant -- already checked above */
  if (usmDbDot3adIsConfigured(unit, intIfNum) == L7_FALSE)      /* checking to see if the ifIndex is valid and has been configured/created */
  {
    osapiSnprintf(buf, sizeof(buf), "\r\n%s ", cliDisplayInterfaceHelp(unit, logicalSlot, logicalPort));
    OSAPI_STRNCAT(buf, pStrErr_base_IsNotACfguredLag);  /*     is not a configured portChannel.   */
...
const L7_char8 *commandPortChannelLoadBalanceGlobalLAG(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  else
  {
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      {
        hashMode=atoi(strHashMode);
        usmDbDot3adLagHashModeSet(unit, lagIntIfNum, hashMode);
      }
    }
    else
    {
 ...
 * @notes none
 *
 * @cmdsyntax  port-vhannel system priority <priority>
 *
 * @cmdhelp .
 *
 * @cmddescript .
...
const L7_char8 *commandPortMirroring(EwsContext ewsContext, L7_uint32 argc,const L7_char8 * * argv, L7_uint32 index)
{
  ...
  else   /* ewsContext->commType == CLI_NO_CMD */
  {
    ...
    else     /* numArg == 4  or numArg == 5*/
    {
      ...
      else if(strcmp(strThirdParam, pStrInfo_common_Ipv6DhcpRelayDest) == 0 && numArg == 5)  /* for destination only 4 arguments are valid */
      {
        /*******Check if the Flag is Set for Execution*************/
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
...
const L7_char8 *commandSetIGMPInterfaceGroupMembershipInterval(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_FailedToSet,  ewsContext, pStrErr_base_SetGrpMbrshipIntvl);
    }
  }
...
const L7_char8 *commandSetIGMPInterfaceMaxResponse(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_FailedToSet,  ewsContext, pStrErr_base_SetMaxRespTime);
    }
  }
...
const L7_char8 *commandSetIGMPInterfaceMcRtrExpireTime(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_FailedToSet,  ewsContext, pStrErr_base_SetMcastRtrPresentExpirationTime);
    }
  }
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  /* Fetching the port information from ewsContext */
  intSlot = EWSSLOT(ewsContext);
  intPort =EWSPORT(ewsContext);
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if ( usmDbGarpJoinTimeSet(unit, interface, intTime) != L7_SUCCESS )
    {
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  else
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if ( usmDbGarpJoinTimeSet(unit, current, intTime) != L7_SUCCESS )
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_JoinTimerBeSet);
      }
    }
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    if ( usmDbGarpLeaveTimeSet(unit, interface, intTime) != L7_SUCCESS )
    {
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  else
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if ( usmDbGarpLeaveTimeSet(unit, current, intTime) != L7_SUCCESS )
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_LeaveTimerBeSet);
      }
    }
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (usmDbIntIfNumFromUSPGet(unit, intSlot, intPort,
  ...
  {
    /* examine the argument that represent the time in centiseconds */
    if ( usmDbGarpLeaveAllTimeSet(unit, interface, intTime) != L7_SUCCESS )
    {
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  else
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if ( usmDbGarpLeaveAllTimeSet(unit, current, intTime) != L7_SUCCESS )
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_LeaveAllTimerBeSet);
      }
    }
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  slot = EWSSLOT(ewsContext);
  port =EWSPORT(ewsContext);
  rc = usmDbIntIfNumFromUSPGet(unit, slot, port, &interface);
  if (rc != L7_SUCCESS || usmDbGarpIsValidIntf(unit, interface) != L7_TRUE)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_InvalidSlotPort_1);
  }
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      rc = usmDbSnoopAdminModeSet(unit, L7_ENABLE, 0, 0, family);
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      rc = usmDbSnoopAdminModeSet(unit, L7_DISABLE, 0, 0, family);
    }
  }
  else
  {
    ...
    const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if (rc != L7_SUCCESS)
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_FailedToSet,  ewsContext, pStrErr_base_SetIntf);
    }
  }
  /*************Set Flag for Script Successful******/
  ewsContext->actionFunctionStatusFlag=L7_ACTION_FUNC_SUCCESS;
...
const L7_char8 *commandSetIGMPInterfaceFastLeave(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      rc = usmDbSnoopIntfFastLeaveAdminModeSet(unit, intIfNum, L7_ENABLE, family);
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      rc = usmDbSnoopIntfFastLeaveAdminModeSet(unit, intIfNum, L7_DISABLE, family);
    }
  }
  else
  {
  ...
  if (rc != L7_SUCCESS)
  {
    return cliSyntaxReturnPromptAddBlanks (0, 1, 0, 0, pStrErr_common_FailedToSet,  ewsContext, pStrErr_base_SetIntfFastLeave);
  }
...
const L7_char8 *commandSetIGMPMrouterInterface(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(cliConvertTo32BitUnsignedInteger(argv[index+argInterface], &vlanId) == L7_SUCCESS)
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        rc = usmDbsnoopIntfApiVlanStaticMcastRtrSet(unit, intIfNum, vlanId, L7_ENABLE, family);
      }
    }
    else
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        rc = usmDbSnoopIntfMrouterSet(unit, intIfNum, L7_ENABLE, family);
      }
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(cliConvertTo32BitUnsignedInteger(argv[index+argInterface], &vlanId) == L7_SUCCESS)
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        rc = usmDbsnoopIntfApiVlanStaticMcastRtrSet(unit, intIfNum, vlanId, L7_DISABLE, family);
      }
    }
    else
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        rc = usmDbSnoopIntfMrouterSet(unit, intIfNum, L7_DISABLE, family);
      }
    }
  }
  else
...
const L7_char8 *commandSpeed(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index){
  ...
  if (usmDbDot3adIsMember(unit, interface) == L7_SUCCESS)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Cant,  ewsContext, pStrErr_base_CantChgSpeedOfALagMbr);
  }
  ...
  if (usmDbIfAutoNegAdminStatusGet(unit, interface, &val) == L7_SUCCESS)
  {
    if (val == L7_ENABLE)
    {
      return cliSyntaxReturnPromptAddBlanks (1, 2, 0, 0, L7_NULLPTR,  ewsContext, pStrInfo_base_DsblAutoNeg);
    }
  }
      ...
      (portCapability & L7_PHY_CAP_PORTSPEED_FULL_1000))
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      rc = usmDbIfSpeedSet(unit, interface, L7_PORTCTRL_PORTSPEED_FULL_1000SX);
    }
  }
  ...
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_PhyModeForPort);
  }
 ...
 *
 * @cmdsyntax snmptrap <name> <ipaddr>  snmpversion <snmpversion>
 *
 * @cmdhelp
 *
 * @cmddescript
    ...
    if (ewsContext->commType == CLI_NORMAL_CMD)
    {
      ...
      else
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
          ...
          if(ipAddrType == 4)
          {
            rc = usmDbTrapManagerIpAddrSet(unit, emptyTrapCommIndex, strIpAddr);
          }
#if defined (L7_IPV6_PACKAGE) || defined (L7_IPV6_MGMT_PACKAGE)
          if(ipAddrType ==6)
          {
            rc = usmDbTrapManagerIPv6AddrSet(unit, emptyTrapCommIndex, &ipv6_address);
          }
#endif
...
const L7_char8 *commandMaxFrameSize(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (usmDbIntfParmCanSet(iface, L7_INTF_PARM_FRAMESIZE) != L7_TRUE)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_InvalidSlotPort_1);
  }
  ...
  if(  ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if (( cliConvertTo32BitUnsignedInteger(argv[index+argMaxFrameSize], &maxFrameSize) == L7_SUCCESS))
    {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        if(usmDbIfConfigMaxFrameSizeSet(iface, maxFrameSize) != L7_SUCCESS)
        {
  ...
  else if(  ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbIfConfigMaxFrameSizeSet(iface, L7_MIN_FRAME_SIZE) != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CfgMaxFrameSize);
      }
    }
...
const L7_char8 *commandSntpServer(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    else
    {
      ...
      /* type */
      if (cliIPHostAddressValidate(ewsContext, strServHost, &ipAddr, &type) != L7_SUCCESS)
      {
        /* Invalid Host Address*/
        return cliSyntaxReturnPrompt (ewsContext, pStrInfo_common_EmptyString);
      }
...
const L7_char8 *commandPortChannelStaticLAG(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (usmDbIntIfNumFromUSPGet(unit, slot, port, &lagIntIfNum) != L7_SUCCESS)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_InvalidSlotPort_1);
  }

  /* Only LAGS are allowed */
  if( usmDbIntfTypeGet(lagIntIfNum, &itype) != L7_SUCCESS )
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_InvalidSlotPort_1);
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    rc=usmDbDot3adLagStaticModeSet(unit, lagIntIfNum, mode);
  }
  if (rc != L7_SUCCESS)
  {
    if (rc==L7_TABLE_IS_FULL)
    {
      return cliSyntaxReturnPromptAddBlanks (1,1, 0, 0, L7_NULLPTR,ewsContext, pStrInfo_base_LagsTaticDynLagFull,platIntfDynamicLagIntfMaxCountGet());

    }
    else
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_LagsTatic);
...
const L7_char8 *commandPortChannelLoadBalanceLAG(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (rc != L7_SUCCESS)
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_LagReturn);
  }
  /*************Set Flag for Script Successful******/
  ewsContext->actionFunctionStatusFlag=L7_ACTION_FUNC_SUCCESS;
    ...
    L7_uint32 index)
{
  ...
  if (ewsContext->commType ==  CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_base_IntfDecsrSetting);
      }
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
...
const L7_char8 *commandPortLacpTimeout(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (mainMenu[cliCurrentHandleGet()] == cliGetMode(L7_INTERFACE_CONFIG_MODE))
  {
    ...
    range[0].start = interface;
    range[0].end = interface;
  }
  else
  {
    memcpy(range, ((ewsContext)->promptcontext.rangeContext.range), sizeof((ewsContext)->promptcontext.rangeContext.range));
  }

  for (i=0; range[i].start !=0; i++)
  {
    for (j = range[i].start; j <= range[i].end; j++)
    {
      if (usmDbIntfTypeGet(j, &itype) != L7_SUCCESS)
      {
        memset (buf, 0, sizeof(buf));
        usmDbUnitSlotPortGet(j, &unit, &s, &p);
      ...
      /* Don't allow logical vlan and logical interfaces to be added */
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        {
          rc = usmDbDot3adAggPortActorAdminStateGet(unit, j, (L7_uchar8 *) &currentVal);
          ...
          rc = usmDbDot3adAggPortActorAdminStateSet(unit, j, (L7_uchar8 *) &val);
        }
        if (cliNoCaseCompare(dest, pStrInfo_base_Partner) == L7_TRUE)
        {
          rc = usmDbDot3adAggPortPartnerAdminStateGet(unit, j, (L7_uchar8 *) &currentVal);
          if (val == (L7_uchar8)DOT3AD_STATE_LACP_TIMEOUT)
          {
            val = (L7_uchar8) (currentVal | val);
          }
          ...
          rc = usmDbDot3adAggPortPartnerAdminStateSet(unit, j, (L7_uchar8 *) &val);
        }
                                    ...
                                    const L7_char8 **argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if (usmDbDNSClientDefaultDomainSet(name) != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, 
               pStrErr_common_Error,  ewsContext, 
               pStrErr_base_UnableDefineDDname);
