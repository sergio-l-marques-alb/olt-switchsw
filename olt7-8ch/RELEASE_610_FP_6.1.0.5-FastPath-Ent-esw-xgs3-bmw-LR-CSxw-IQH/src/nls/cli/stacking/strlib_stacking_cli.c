...
L7_char8 *pStrInfo_stacking_CfgSwitchPri = "Set priority of a stack switch.";
...
L7_char8 *pStrErr_stacking_CfgSwitchPri_1 = "Use 'switch <unit> priority <value>'.";
L7_char8 *pStrErr_stacking_CfgSwitchCmdsSplit = "Use 'switch <unit> priority <value>'\r\n             or  Use 'switch <unit> renumber <newunit>'.";
...
L7_char8 *pStrErr_stacking_UnitProconfigOrOK = "Error: Cannot set unit as standby\r\nUnit should have either joined the stack properly or pre-configured.\n";
