...
xLibRC_t fpObjGet_ipmcastpimBsrElectedBSRTable_pimBsrElectedBSRAddress (void *wap, void *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbPimsmXUIElectedBSRAddressGet (objpimBsrElectedBSRAddressType,
...
xLibRC_t fpObjGet_ipmcastpimBsrElectedBSRTable_pimBsrElectedBSRPriority (void *wap, void *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbPimsmXUIElectedBSRPriorityGet (objpimBsrElectedBSRAddressType,
                                                                               ...
                                                                               void *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbPimsmXUIElectedBSRHashMaskLengthGet (objpimBsrElectedBSRAddressType,
...
xLibRC_t fpObjGet_ipmcastpimBsrElectedBSRTable_pimBsrElectedBSRExpiryTime (void *wap, void *bufp)
{
  ...
  usmDbTimeSpec_t objpimBsrElectedBSRExpiryTimeValue;
  xLibU32_t objpimBsrElectedBSRAddressType;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  /* get the value from application */
  owa.l7rc = usmDbPimsmXUIElectedBSRExpiryTimeSpecGet (objpimBsrElectedBSRAddressType,
