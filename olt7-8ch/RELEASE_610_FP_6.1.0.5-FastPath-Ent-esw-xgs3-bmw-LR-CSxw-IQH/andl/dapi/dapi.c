...
{DAPI_CMD_SYSTEM_DHCP_CONFIG_NAME},
...
{DAPI_CMD_ADDR_SET_LEARN_MODE_NAME},  /* PTin added */
...
/* L2 LAG */
{DAPI_CMD_LAG_PENDING_CONFIGS_NAME},    /* PTin added */
...
{DAPI_CMD_PTIN_HW_PHY_SET_NAME},
{DAPI_CMD_PTIN_HW_RESOURCES_NAME},
{DAPI_CMD_PTIN_VLAN_DEFS_NAME},
{DAPI_CMD_PTIN_VLAN_XLATE_NAME},
{DAPI_CMD_PTIN_FPENTRY_NAME},
{DAPI_CMD_PTIN_FLOW_COUNTERS_NAME},
{DAPI_CMD_PTIN_BCASTPKT_LIMIT_NAME},
{DAPI_CMD_PTIN_BITSTREAM_UPFWD_NAME},
{DAPI_CMD_PTIN_BITSTREAM_LAG_RECHECK_NAME},
{DAPI_CMD_PTIN_GET_COUNTERS_NAME},
{DAPI_CMD_PTIN_CLEAR_COUNTERS_NAME},
{DAPI_CMD_PTIN_GET_COUNTERS_STATE_NAME},
};
...
L7_RC_t dapiCtl(DAPI_USP_t *usp, DAPI_CMD_t cmd, void *data)
{
  ...
  else
  {
    ...
    case DAPI_CMD_ADDR_SET_LEARN_MODE:  /* PTin added */
    ...
    case DAPI_CMD_LAG_PENDING_CONFIGS:    /* PTin added */
    ...
    case DAPI_CMD_PTIN_HW_PHY_SET:
    case DAPI_CMD_PTIN_HW_RESOURCES:
    case DAPI_CMD_PTIN_VLAN_DEFS:
    case DAPI_CMD_PTIN_VLAN_XLATE:
    case DAPI_CMD_PTIN_FPENTRY:
    case DAPI_CMD_PTIN_FLOW_COUNTERS:
    case DAPI_CMD_PTIN_BCASTPKT_LIMIT:
    case DAPI_CMD_PTIN_BITSTREAM_UPFWD:
    case DAPI_CMD_PTIN_BITSTREAM_LAG_RECHECK:
    case DAPI_CMD_PTIN_GET_COUNTERS:
    case DAPI_CMD_PTIN_CLEAR_COUNTERS:
    case DAPI_CMD_PTIN_GET_COUNTERS_STATE:
    ...
    case DAPI_CMD_SYSTEM_DHCP_CONFIG:         /* For dealing with physical interfaces (not CPU)*/
      // PTin added
      // This situation corresponds to all interfaces
      ...
      else if (dapi_g->unit[dapiUsp.unit]->slot[dapiUsp.slot]->cardPresent == L7_FALSE)
      {
        ...
        /* smanders temp stacking - change once apps are complient with stacking */
        /* result = L7_FAILURE; */

        if ((bad_usp_count % 1000) == 0)
        {
          LOG_MSG ("\nError: usp %d/%d/%d: Card Not Attached\n", dapiUsp.unit, dapiUsp.slot, dapiUsp.port);
        }
        bad_usp_count++;
        result = L7_SUCCESS;
      }
...
L7_RC_t dapiCtlLagIntf(DAPI_USP_t *usp, DAPI_CMD_t cmd, void *data)
{
  ...
  else if ((cmd == DAPI_CMD_LAG_PENDING_CONFIGS)    ||    /* PTin added */
           (cmd == DAPI_CMD_LAG_CREATE)             ||
