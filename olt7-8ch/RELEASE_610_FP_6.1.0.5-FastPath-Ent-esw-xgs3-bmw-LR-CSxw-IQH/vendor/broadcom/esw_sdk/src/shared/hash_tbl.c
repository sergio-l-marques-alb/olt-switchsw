/*
 * $Id: hash_tbl.c,v 1.1 2011/04/18 17:11:04 mruas Exp $
 ...
 * Notes:
 * This hash function was taken from the public domain.   It provides uniform
 * distribution over a variable length of bytes. 
...
htb_default_hash_f(uint8 *k, uint32 length)
{
    ...
    c = 0x171b32ec;      /* the previous hash value; or an arbirary value */
