/* 
 * $Id: enduro_mbcm.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
...
unimpl(char *desc)
{
    soc_cm_debug(DK_VERBOSE,
		 "WARNING: function %s not implemented for Enduro\n", desc);
    return SOC_E_NONE;
}

#ifdef BCM_METER_SUPPORT

int bcm_en_meter_init(int unit)
{
    return unimpl("bcm_en_meter_init");
}

int bcm_en_meter_create(int unit, int port, int *mid)
{
    return unimpl("bcm_en_meter_create");
}

int bcm_en_meter_delete(int unit, int port, int mid)
{
    return unimpl("bcm_en_meter_delete");
}

int bcm_en_meter_delete_all(int unit)
{
    return unimpl("bcm_en_meter_delete_all");
}

int bcm_en_meter_get(int unit, int port, int mid,
		     uint32 *kbits_sec, uint32 *kbits_burst)
{
    return unimpl("bcm_en_meter_get");
}

int bcm_en_meter_set(int unit, int port, int mid,
		     uint32 kbits_sec, uint32 kbits_burst)
{
    return unimpl("bcm_en_meter_set");
}

int bcm_en_ffppacketcounter_set(int unit, int port, int mid,
				uint64 val)
{
    return unimpl("bcm_en_ffppacketcounter_set");
}

int bcm_en_ffppacketcounter_get(int unit, int port, int mid,
				uint64 *val)
{
    return unimpl("bcm_en_ffppacketcounter_get");
}

int bcm_en_ffpcounter_init(int unit)
{
    return unimpl("bcm_en_ffpcounter_init");
}

int bcm_en_ffpcounter_create(int unit, int port, int *ffpcounterid)
{
    return unimpl("bcm_en_ffpcounter_create");
}

int bcm_en_ffpcounter_delete(int unit, int port, int ffpcounterid)
{
    return unimpl("bcm_en_ffpcounter_delete");
}

int bcm_en_ffpcounter_delete_all(int unit)
{
    return unimpl("bcm_en_ffpcounter_delete_all");
}

int bcm_en_ffpcounter_set(int unit, int port, int ffpcounterid,
			  uint64 val)
{
    return unimpl("bcm_en_ffpcounter_set");
}

int bcm_en_ffpcounter_get(int unit, int port, int ffpcounterid,
			  uint64 *val)
{
    return unimpl("bcm_en_ffpcounter_get");
}

#endif /* BCM_METER_SUPPORT */

mbcm_functions_t mbcm_enduro_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_en_cosq_init,
    bcm_en_cosq_detach,
    bcm_en_cosq_config_set,
    bcm_en_cosq_config_get,
    bcm_en_cosq_mapping_set,
    bcm_en_cosq_mapping_get,
    bcm_en_cosq_port_sched_set,
    bcm_en_cosq_port_sched_get,
    bcm_bradley_cosq_sched_weight_max_get,
    bcm_en_cosq_port_bandwidth_set,
    bcm_en_cosq_port_bandwidth_get,
    bcm_en_cosq_discard_set,
    bcm_en_cosq_discard_get,
    bcm_en_cosq_discard_port_set,
    bcm_en_cosq_discard_port_get,
    ...
    bcm_en_meter_create,
    bcm_en_meter_delete,
    bcm_en_meter_delete_all,
    bcm_en_meter_get,
    bcm_en_meter_set,
    bcm_en_ffppacketcounter_set,
    bcm_en_ffppacketcounter_get,
    bcm_en_ffpcounter_init,
    bcm_en_ffpcounter_create,
    bcm_en_ffpcounter_delete,
    bcm_en_ffpcounter_delete_all,
    bcm_en_ffpcounter_set,
    bcm_en_ffpcounter_get,
...
int bcm_esw_enduro_mbcm_not_empty;
