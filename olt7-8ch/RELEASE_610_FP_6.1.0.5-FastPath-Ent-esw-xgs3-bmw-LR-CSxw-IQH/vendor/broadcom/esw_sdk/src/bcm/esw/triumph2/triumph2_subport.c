/*
 * $Id: triumph2_subport.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
...
#define _TR2_SUBPORT_NUM_GROUP            (_TR2_SUBPORT_NUM_VP / 8)
                                          ...
                                          int fs_idx)
{
    ...
    rv = soc_mem_field32_modify(unit, EGR_VLAN_XLATEm, vt_index,
                                          ...
                                          int fs_idx)
{
    ...
    rv = soc_reg_field32_modify(unit, SOURCE_VPm, vp_base,
                                VINTF_CTR_IDXf, fs_idx);
    return rv;
}
