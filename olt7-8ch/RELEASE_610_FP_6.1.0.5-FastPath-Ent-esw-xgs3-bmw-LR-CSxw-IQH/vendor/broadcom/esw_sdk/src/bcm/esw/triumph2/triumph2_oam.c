/*
 * $Id: triumph2_oam.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
 * 
...
static int _bcm_oam_warm_boot(int unit)
{
    _bcm_oam_info_t *oam_info_p;
    int group_index;
    ...
    int unit)
{
    ...
    soc_triumph2_oam_handler_register(_bcm_tr2x_oam_handle_interrupt);
    ...
    int unit)
{
    ...
    soc_triumph2_oam_handler_register(NULL);
    ...
    _bcm_oam_endpoint_t *endpoint_p, bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if (endpoint_p->is_remote)
    {
        ...
        BCM_IF_ERROR_RETURN(_bcm_tr2x_oam_read_clear_faults(unit,
            endpoint_index, endpoint_faults, RMEPm, (uint32 *) &rmep_entry,
