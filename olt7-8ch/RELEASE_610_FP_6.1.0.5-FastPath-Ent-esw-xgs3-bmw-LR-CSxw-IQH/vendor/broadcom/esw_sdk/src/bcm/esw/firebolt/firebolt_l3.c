/*
 * $Id: firebolt_l3.c,v 1.1 2011/04/18 17:11:02 mruas Exp $
...
static _bcm_l3_module_data_t *l3_module_data[BCM_MAX_NUM_UNITS];
...
#endif /* BCM_RAPTOR_SUPPORT || defined(BCM_MIRAGE_SUPPORT */
...
{
    bcm_l3_egress_t tmp_nh;   /* Temp next hop info.  */
     ...
     */
    sal_memcpy(&tmp_nh, buf, sizeof(bcm_l3_egress_t));
    ...
    if (SOC_IS_EASYRIDER(unit)) {
        /* Include mpls label only if it is valid. */
        if (!BCM_XGS3_L3_MPLS_LBL_VALID(tmp_nh.mpls_label)) {
            tmp_nh.mpls_label = 0;
        }
    }
#endif /* BCM_EASYRIDER_SUPPORT */
    *hash = _shr_crc16(0, (uint8 *)&tmp_nh, sizeof(bcm_l3_egress_t));
...
STATIC int
_bcm_xgs3_l3_nh_reinit(int unit)
{
...
_bcm_xgs3_l3_intf_reinit(int unit)
{
    ...
    for (idx = index_min; idx <= index_max; idx++) {
        ...
        if (0 == intf_info.l3i_vid && idx != index_max) {
            continue;
        }
...
_bcm_xgs3_l3_ecmp_reinit(int unit)
{
    ...
    int index_max;                /* Last  entry index.            */
    int entry;			  /* Buffer.                       */
    _bcm_l3_tbl_t *tbl_ptr;	  /* ECMP table ptr. 		   */    
    ...
    BCM_XGS3_L3_ECMP_MAX_PATHS(unit) = entry;

    /* Initialize the number of ECMP groups */	
    tbl_ptr->idx_max = BCM_XGS3_L3_ECMP_TBL_SIZE(unit) / 
 ...
 */
STATIC int
_bcm_xgs3_l3_vrf_reinit(int unit)
{
    int index_min;                /* First entry index.        */
    int index_max;                /* Last  entry index.        */
...
_bcm_xgs3_l3_reinit(int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN(_bcm_xgs3_l3_nh_reinit(unit));
    ...
    if (soc_feature(unit, soc_feature_gport_service_counters)) {
         ...
         BCM_IF_ERROR_RETURN(_bcm_xgs3_l3_vrf_reinit(unit));
    }
#endif /* BCM_TRIUMPH2_SUPPORT */
...
_bcm_xgs3_l3_free_resource(int unit)
{
    ...
    if (soc_feature(unit, soc_feature_virtual_switching)) {
        ...
        _bcm_virtual_cleanup(unit);
        _bcm_common_cleanup(unit);
    }
#endif /* BCM_TRX_SUPPORT */
                        ...
                        _bcm_l3_cfg_t *l3cfg, _bcm_defip_cfg_t *lpm_cfg)
{
    ...
    sal_memset(nh_entry, 0, sizeof(bcm_l3_egress_t));
 ...
 */
STATIC void 
_bcm_xgs3_l3_l2cpu_nh_cb(int unit, int modid, void *userdata)
{
...
_bcm_xgs3_l3_ecmp_group_init(int unit)
{
    ...
    /*
     *  Calculate nuber of ecmp groupsp. 
     */
    tbl_ptr->idx_min = 0;
...
bcm_xgs3_l3_tables_init(int unit)
{
    ...
    rv = _bcm_esw_stk_modid_chg_cb_register(unit, _bcm_xgs3_l3_l2cpu_nh_cb, 
                                            NULL);
    if (BCM_FAILURE(rv)) {
        _bcm_xgs3_l3_free_resource(unit);
        return rv;
...
bcm_xgs3_l3_tables_cleanup(int unit)
{
    ...
    if (BCM_XGS3_L3_INITIALIZED(unit)) {
        ...
        _bcm_esw_stk_modid_chg_cb_unregister(unit, _bcm_xgs3_l3_l2cpu_nh_cb);
    }
    return (BCM_E_NONE);
}
...
_bcm_xgs3_tbl_add(int unit, _bcm_l3_tbl_op_t *data)
{
    ...
    if (!(data->oper_flags & _BCM_L3_SHR_WRITE_DISABLE)) {
        /* Set the entry to hw. */
        rv = (*(data->add_func)) (unit, data->entry_index, data->entry_buffer);
        if (rv < 0) {
...
_bcm_xgs3_tbl_del(int unit,  _bcm_l3_tbl_op_t *data)
{
    ...
    return (*(data->delete_func)) (unit, data->entry_index);
}
...
bcm_xgs3_nh_get(int unit, int nh_idx, bcm_l3_egress_t *nh_info)
{
    ...
    if (SOC_IS_TR_VL(unit) && (soc_feature(unit, soc_feature_mpls))) {
        BCM_IF_ERROR_RETURN(bcm_tr_mpls_swap_nh_info_get (unit, nh_info, nh_idx));
        BCM_IF_ERROR_RETURN(bcm_tr_mpls_l3_label_get (unit, nh_idx, nh_info));		
    } 
                      ...
                      _bcm_defip_cfg_t *lpm_cfg, int *index)
{
    ...
    uint32 flags;             /* Next hop entry flags.   */ 
    ...
    if (BCM_XGS3_L3_EGRESS_MODE_ISSET(unit)) {
        ...
        return bcm_xgs3_get_nh_from_egress_object(unit, intf, flags, index);
    }
 ...
 * Parameters:
 *      unit         - (IN)SOC unit number.
 *      ecmp_grp_id  - (IN)Ecmp group id. 
 *      *grp_sz      - (OUT)Ecmp group size. 
 * Returns:
 *      void
 */
STATIC INLINE void
_bcm_xgs3_ecmp_max_grp_size_get(int unit, int ecmp_grp_id, int *grp_sz)
{
     ...
     */
    if (ecmp_grp_id == BCM_XGS3_L3_TBL(unit, ecmp_grp).idx_max) {
        /* 
         * Check if ecmp table uses all the entries.
         * NOTE: Ecmp group id is zero based.
         */
        if ((ecmp_grp_id + 1) * max_grp_size == 
            BCM_XGS3_L3_ECMP_TBL_SIZE(unit)) {
            /* Last group has 1 entry less. */
            max_grp_size--;
        }
 ...
 */
STATIC INLINE void
_bcm_xgs3_ecmp_grp_size_get(int unit, int ecmp_grp_id, 
                            int *nh_arr, int *grp_sz)
{
    int ecmp_max_paths;                 /* Maximum number of paths for group. */
    int ecmp_count;                     /* Ecmp group next hop count.         */
    int idx;                            /* Iteration index.                   */

    /* Calculate maximum group size. */
    _bcm_xgs3_ecmp_max_grp_size_get(unit, ecmp_grp_id, &ecmp_max_paths);
 ...
 * Parameters:
 *      unit         - (IN)SOC unit number.
 *      ecmp_idx     - (IN)First ecmp entry index to read. 
 ...
 */
STATIC INLINE int
_bcm_xgs3_ecmp_tbl_read(int unit, int ecmp_idx, 
                        int *ecmp_grp, int *ecmp_count)
{
    int rv = BCM_E_UNAVAIL;     /* Operation return value. */
    int max_cnt = BCM_XGS3_L3_ECMP_MAX_PATHS(unit);
    ...
    if (BCM_XGS3_L3_HWCALL_CHECK(unit, ecmp_grp_get)) {
        rv = BCM_XGS3_L3_HWCALL_EXEC
            (unit, ecmp_grp_get) (unit, ecmp_idx, max_cnt, ecmp_grp);
    }

    /* Get group size. */
    if (ecmp_count) {
        _bcm_xgs3_ecmp_grp_size_get(unit, ecmp_idx, ecmp_grp, ecmp_count);
    }
    return rv;
}
...
_bcm_xgs3_ecmp_grp_cmp(int unit, void *buf, int grp_idx, int *cmp_result)
{
    ...
    int ecmp_idx;               /* Group first entry index in hw.*/
    ...
    _bcm_xgs3_ecmp_max_grp_size_get(unit, grp_idx, &ecmp_max_paths);

    /* Calculate group start index. */
    ecmp_idx = grp_idx * BCM_XGS3_L3_ECMP_MAX_PATHS(unit);
    ...
    rv = _bcm_xgs3_ecmp_tbl_read(unit, ecmp_idx, ecmp_grp, NULL);
    if (BCM_FAILURE(rv)) {
        sal_free(ecmp_grp);
        return (rv);
    }
 ...
 * Parameters:
 *      unit          - (IN)SOC unit number.
 *      ecmp_index    - (IN)Ecmp group id.
 * Returns:
 *      BCM_E_XXX
 */
int
bcm_xgs3_ecmp_group_del(int unit, int ecmp_index)
{
    int ecmp_group;
    ...
    ecmp_group = ecmp_index / BCM_XGS3_L3_ECMP_MAX_PATHS(unit);
    if ((ecmp_group > data.tbl_ptr->idx_max) || 
        (ecmp_group < data.tbl_ptr->idx_min)) {
        return (BCM_E_PARAM);
    }

    data.entry_index = ecmp_group;
    data.width = _BCM_SINGLE_WIDE;
 ...
 */
STATIC int
_bcm_xgs3_ecmp_group_add(int unit, uint32 flags, int ecmp_count,  
 ...
 * Purpose:
 *      Translates egress object id to next hop/ecmp group index.
 * Parameters:
 *      unit       - (IN)  bcm device.
                          ...
                          bcm_if_t *intf)
{
...
#if defined(BCM_TRIUMPH_SUPPORT) && defined(BCM_MPLS_SUPPORT)
    uint8  entry_type=0;              /* Next Hop Entry_type */
#endif /* BCM_TRX_SUPPORT  && BCM_MPLS_SUPPORT */
...
#if defined(BCM_TRIUMPH_SUPPORT)
    if ((SOC_IS_TR_VL(unit)) && (soc_feature(unit, soc_feature_mpls))) {
       /* The MPLS Tunnel interface MUST be setup prior to creation of Egress Object */
         if (!(flags &  BCM_L3_ROUTE_LABEL)) { 
              if (egr->mpls_label != 0 ) {
                   BCM_IF_ERROR_RETURN(bcm_tr_mpls_set_entry_type(unit, index, egr->intf));
                   BCM_IF_ERROR_RETURN(bcm_tr_mpls_swap_nh_info_add (unit, egr, index));
              }
         }
     }
#endif /* BCM_TRIUMPH_SUPPORT */
    ...
    if ((SOC_IS_TR_VL(unit)) && (soc_feature(unit, soc_feature_mpls))) {
        ...
        BCM_IF_ERROR_RETURN(bcm_tr_mpls_get_entry_type(unit, index, &entry_type));
        if (flags &  BCM_L3_ROUTE_LABEL) {
              if ((egr->mpls_label != 0) || (entry_type == 1) ){
                   BCM_IF_ERROR_RETURN(bcm_tr_mpls_set_entry_type(unit, index, egr->intf));
                   BCM_IF_ERROR_RETURN(bcm_tr_mpls_l3_label_add (unit, egr->mpls_label, egr->mpls_exp, index, flags));
              }
        }
    } 
#endif /* BCM_TRX_SUPPORT  && BCM_MPLS_SUPPORT */
                                    ...
                                    bcm_if_t *intf_array, bcm_if_t *mpintf)
{
    ...
    /* Create ecmp group. */
    rv  = _bcm_xgs3_ecmp_group_add(unit, shr_flags, intf_count,
...
bcm_xgs3_l3_egress_multipath_destroy(int unit, bcm_if_t mpintf) 
{
    ...
    int ecmp_index;           /* Ecmp table index for group.*/
    ...
    /* Ecmp table index for the group. */
    ecmp_index = ecmp_group_id * BCM_XGS3_L3_ECMP_MAX_PATHS(unit);

    /* Delete ecmp group. */
    BCM_IF_ERROR_RETURN(_bcm_xgs3_ecmp_group_remove(unit, ecmp_index, TRUE));
                          ...
                          void *user_data)
{
    ...
    for (idx = tbl_ptr->idx_min; idx <= tbl_ptr->idx_maxused; idx++) {
        ...
        (*trav_fn)(unit, (idx + BCM_XGS3_MPATH_EGRESS_IDX_MIN), intf_count,
...
bcm_xgs3_l3_del(int unit, _bcm_l3_cfg_t *l3cfg)
{
    ...
    if (BCM_XGS3_L3_MCAST_ENTRY(l3cfg)) {
        ...
        if ((BCM_E_NOT_FOUND == rv) || (BCM_E_DISABLED == rv)) {
            return  bcm_xgs3_host_as_route(unit, l3cfg, BCM_XGS3_L3_OP_DEL, rv);
        }
        BCM_IF_ERROR_RETURN(rv);
...
bcm_xgs3_l3_del_prefix(int unit, _bcm_l3_cfg_t *l3cfg)
{
    ...
    return _bcm_xgs3_l3_del_match(unit, l3cfg->l3c_flags, (void *)l3cfg,
                                  _bcm_xgs3_l3_prefix_cmp, NULL, NULL);
}
...
bcm_xgs3_l3_del_all(int unit)
{
    ...
    tmp_rv = _bcm_xgs3_l3_del_match(unit, 0, NULL, NULL, NULL, NULL);

    /* Delete all ipv6 entries. */
    rv = _bcm_xgs3_l3_del_match(unit, BCM_L3_IP6, NULL, NULL, NULL, NULL);
                ...
                void *user_data)
{
    ...
    tmp_rv = _bcm_xgs3_l3_del_match(unit, flags, (void *)&flags,
                                  _bcm_xgs3_l3_cmp_hit, age_out, user_data);

    /* Age all ipv6 entries. */
    flags |= BCM_L3_IP6;
    rv = _bcm_xgs3_l3_del_match(unit, flags, (void *)&flags,
                                  _bcm_xgs3_l3_cmp_hit, age_out, user_data);
                         ...
                         bcm_l3_host_traverse_cb cb, void *user_data)
{
    ...
    return _bcm_xgs3_l3_traverse(unit, 0, start, end, cb, user_data);
}
                         ...
                         bcm_l3_host_traverse_cb cb, void *user_data)
{
    ...
    return _bcm_xgs3_l3_traverse(unit, BCM_L3_IP6, start, end, cb, user_data);
}
...
bcm_xgs3_l3_info(int unit, bcm_l3_info_t *l3info)
{
    ...
    l3info->l3info_max_vrf = 0;
    l3info->l3info_used_vrf = 0;
...
_bcm_xgs3_lpm_get_nh_info(int unit, _bcm_defip_cfg_t *lpm_cfg, int nh_idx)
{
    ...
    if (BCM_XGS3_L3_EGRESS_MODE_ISSET(unit)) {
        if (lpm_cfg->defip_flags & BCM_L3_MULTIPATH) {
            lpm_cfg->defip_intf = (nh_idx / BCM_XGS3_L3_ECMP_MAX_PATHS(unit)) \
 ...
 *      ecmp_grp_id  - (IN)New Ecmp group id.
 * Returns:
 *      BCM_E_XXX
 */
STATIC int
_bcm_xgs3_defip_mpath_add(int unit, _bcm_defip_cfg_t *lpm_cfg, int ecmp_grp_id)
{
    int ecmp_index;             /* Index in ecmp table.       */
    int rv = BCM_E_UNAVAIL;     /* Operation return status.   */

    /* Ecmp table index for the allocated group. */
    ecmp_index = ecmp_grp_id * BCM_XGS3_L3_ECMP_MAX_PATHS(unit);

    /* Set zero based number of paths to lpm entry. */
    _bcm_xgs3_ecmp_max_grp_size_get(unit, ecmp_grp_id, &lpm_cfg->defip_ecmp_count);
    ...
    if (rv < 0) {
        bcm_xgs3_ecmp_group_del(unit, ecmp_index);
        return rv;
    }
...
{
    int index;                  /* New ecmp group index.      */
    int ecmp_index;             /* Index in ecmp table.       */
    int rv = BCM_E_UNAVAIL;     /* Operation return status.   */

    /* Add ecmp group to the hw. */
    BCM_IF_ERROR_RETURN
        (_bcm_xgs3_ecmp_group_add(unit, 0, ecmp_count, ecmp_group, &index));

    /* Ecmp table index for the allocated group. */
    ecmp_index = index * BCM_XGS3_L3_ECMP_MAX_PATHS(unit);

    /* Set zero based number of paths to lpm entry. */
    _bcm_xgs3_ecmp_max_grp_size_get(unit, index, &lpm_cfg->defip_ecmp_count);
    lpm_cfg->defip_ecmp_count--;
                         ...
                         int ecmp_grp_idx, int nh_index)
{
    ...
    if (BCM_XGS3_L3_INVALID_INDEX != ecmp_grp_idx) {

        /* Extract maximum ecmp group size. */
        _bcm_xgs3_ecmp_max_grp_size_get(unit, ecmp_grp_idx, &ecmp_max_count);

        /* Read ecmp group members from hw. */
        rv = _bcm_xgs3_ecmp_tbl_read(unit, ecmp_grp_idx,
                                     ecmp_grp, &ecmp_count);
        if (BCM_FAILURE(rv)) {
            sal_free(ecmp_grp);
            return (rv);
 ...
 */
STATIC int
_bcm_xgs3_defip_ecmp_del(int unit, _bcm_defip_cfg_t *lpm_cfg, int ecmp_idx)
{
     ...
     */
    rv = bcm_xgs3_ecmp_group_del(unit, ecmp_idx);
    sal_free(ecmp_grp);
    return rv;
}
                           ...
                           
{
    ...
    if (lpm_cfg->defip_ecmp) {
        ...
        for (idx = 0; idx < ecmp_count; idx++) {
            BCM_XGS3_L3_ENT_REF_CNT_INC(nh_tbl_ptr, ecmp_group[idx],
                                        _BCM_SINGLE_WIDE);
        } 
    } else {  /* Unipath route. */
...
_bcm_xgs3_ecmp_grp_get(int unit, int ecmp_idx, int ecmp_count, int *nh_idx)
{
    ...
    if (SOC_MEM_IS_VALID(unit, L3_ECMP_COUNTm)) {
        ...
        rv = soc_mem_read(unit, L3_ECMP_COUNTm, MEM_BLOCK_ANY, ecmp_idx, hw_buf);
        if (BCM_FAILURE(rv)) {
            return rv;
        }
 ...
 */
STATIC int
_bcm_xgs3_ecmp_grp_add(int unit, int ecmp_grp, void *buf)
{
    uint32 hw_buf[SOC_MAX_MEM_FIELD_WORDS]; /* Buffer to read hw entry.*/
    int max_grp_size;                       /* Maximum ecmp group size.*/
    ...
    /* Get number of path's in ecmp group. */
    _bcm_xgs3_ecmp_max_grp_size_get(unit, ecmp_grp, &max_grp_size);
 ...
 */
STATIC int
_bcm_xgs3_ecmp_grp_del(int unit, int ecmp_grp)
{
    ecmp_entry_t ecmp_entry;    /* Buffer to write to hw.  */
    int max_grp_size;           /* Maximum ecmp group size.*/
    int ecmp_idx;               /* Ecmp table entry index. */
    int idx;                    /* Iteration index.        */
    int rv = BCM_E_UNAVAIL;     /* Operation return value. */
    ...
    for (idx = 0; idx < max_grp_size; idx++) {
        /* Write buffer to hw. */
        rv = WRITE_L3_ECMPm(unit, MEM_BLOCK_ALL, (ecmp_idx + idx), &ecmp_entry);
        if (BCM_FAILURE(rv)) {
            return rv;
        }
...
#ifdef BCM_TRX_SUPPORT
    if (SOC_MEM_IS_VALID(unit, L3_ECMP_COUNTm)) {
        rv = WRITE_L3_ECMP_COUNTm(unit, MEM_BLOCK_ALL, ecmp_idx, &ecmp_entry);
        BCM_IF_ERROR_RETURN(rv);

        if (SOC_MEM_IS_VALID(unit, INITIAL_L3_ECMP_COUNTm)) {
            rv = WRITE_INITIAL_L3_ECMP_COUNTm(unit, MEM_BLOCK_ALL, ecmp_idx, 
                    &ecmp_entry);
        }
                          ...
                          bcm_tunnel_initiator_t *tnl_info)
{
    ...
    if (BCM_XGS3_TUNNEL_INIT_V4 == entry_type) {
        ...
        /* Get destination ip. */
        soc_mem_field_get(unit, mem, tnl_entry, DIPf, (uint32 *)tnl_info->dip6);

        /* Get source ip. */
        soc_mem_field_get(unit, mem, tnl_entry, SIPf, (uint32 *)tnl_info->sip6);
    }
 ...
 */
STATIC int
_bcm_xgs3_l3_tnl_init_add(int unit, int idx, void *buf)
{
    ...
    soc_mem_field_set(unit, mem, tnl_entry, DIPf, 
                ((ipv6) ? (uint32 *)tnl_info->dip6 : (uint32 *)&tnl_info->dip));

    /* Set source address. */
    soc_mem_field_set(unit, mem, tnl_entry, SIPf,
                ((ipv6) ? (uint32 *)tnl_info->sip6 : (uint32 *)&tnl_info->sip));
 ...
 */
STATIC int
_bcm_xgs3_l3_tnl_init_del(int unit, int idx)
{
    uint32 tnl_entry[SOC_MAX_MEM_FIELD_WORDS];  /* Buffer to write hw entry.  */
 ...
 */
STATIC int
_bcm_xgs3_nh_del(int unit, int idx)
{
    uint32 hw_entry[SOC_MAX_MEM_FIELD_WORDS];/* Buffer to fill nh entry.   */
    soc_mem_t mem;                           /* Table memory.              */
    int rv;                                  /* Operation return status.   */
 ...
 */
STATIC int
_bcm_fb_nh_add(int unit, int idx, void *buf)
{
...
_bcm_fb_l3_ipmc_ent_init(int unit, uint32 *buf_p, _bcm_l3_cfg_t *l3cfg)
{
    ...
    defined(BCM_TRX_SUPPORT)
            /* Set virtual router id. */
            if (SOC_MEM_FIELD_VALID(unit, mem, vrff[idx])) {
                     ...
                     defip_entry_t *lpm_entry)
{
    ...
    if (SOC_MEM_FIELD_VALID(unit, BCM_XGS3_L3_MEM(unit, defip), VRF_ID_0f)) {
...
_bcm_rp_l3_entry_add(int unit, int rule_idx, _bcm_rp_l3_entry_t *l3_entry)
{
...
#endif /* BCM_MIRAGE_SUPPORT */
    {
        /* Add unknown unicast. */
        BCM_IF_ERROR_RETURN
            (bcm_esw_field_qualify_LookupStatus(unit, rule_hdlr,
                                                BCM_FIELD_LOOKUP_L3_ROUTABLE,
                                                BCM_FIELD_LOOKUP_L3_ROUTABLE));
...
#endif /* BCM_MIRAGE_SUPPORT */
    {
        BCM_FIELD_QSET_ADD(qset, bcmFieldQualifyLookupStatus);
    }
 ...
 */
STATIC int
_bcm_er_nh_add(int unit, int idx, void *buf)
{
 ...
 */
STATIC int
_bcm_er_adj_mac_add(int unit, int idx, void *buf)
{
 ...
 */
STATIC int
_bcm_er_adj_mac_del(int unit, int idx)
{
    egress_adjacent_mac_entry_t amac_entry;     /* Buffer to write to hw.  */
    int rv;                     /* Operation return value. */
