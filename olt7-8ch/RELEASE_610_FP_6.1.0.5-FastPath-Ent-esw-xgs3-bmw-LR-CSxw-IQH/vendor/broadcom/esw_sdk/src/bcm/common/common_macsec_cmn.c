/*
 * $Id: common_macsec_cmn.c,v 1.1 2011/04/18 17:11:01 mruas Exp $
                             ...
                             void *user_data)
{
    ...
    if (SOC_MACSEC_PORTID2UNIT(p) == ua->unit) {
        callback = (bcm_macsec_port_traverse_cb) ua->user_cb;
                             ...
                             void *user_data)
{
    ...
    bmacsec_port_traverse(_bcm_macsec_port_traverse_cb, (void*) &ua);
                                      ...
                                      void *user_data)
{
    ...
    if ((SOC_MACSEC_PORTID2UNIT(p) == ua->unit) && 
        ...
        callback = (bcm_macsec_chan_traverse_cb) ua->user_cb;
        callback(SOC_MACSEC_PORTID2UNIT(p), 
                 SOC_MACSEC_PORTID2PORT(p), 
                                       ...
                                       void *user_data)
{
    ...
    if ((SOC_MACSEC_PORTID2UNIT(p) == ua->unit) && 
        (SOC_MACSEC_PORTID2PORT(p) == ua->port)) {
        callback = (bcm_macsec_secure_assoc_traverse_cb) ua->user_cb;
        callback(SOC_MACSEC_PORTID2UNIT(p), 
                 SOC_MACSEC_PORTID2PORT(p), 
                               ...
                               void *user_data)
{
    ...
    if ((SOC_MACSEC_PORTID2UNIT(p) == ua->unit) && 
        (SOC_MACSEC_PORTID2PORT(p) == ua->port)) {
        callback = (bcm_macsec_flow_traverse_cb) ua->user_cb;
        callback(SOC_MACSEC_PORTID2UNIT(p), 
                 SOC_MACSEC_PORTID2PORT(p), 
                    ...
                    int chanId, int assocId, uint64 *val)
{
    ...
    p = SOC_MACSEC_PORTID(unit, port);
    rv = bmacsec_stat_get(p, stat, chanId, assocId, val);
    return BCM_ERROR(rv);
}
                    ...
                    int chanId, int assocId, uint64 val)
{
    ...
    p = SOC_MACSEC_PORTID(unit, port);
    rv = bmacsec_stat_set(p, stat, chanId, assocId, val);
    return BCM_ERROR(rv);
}
