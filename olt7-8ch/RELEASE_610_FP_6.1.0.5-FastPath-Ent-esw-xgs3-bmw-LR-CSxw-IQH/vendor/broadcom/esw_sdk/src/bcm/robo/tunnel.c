/*
 * $Id: tunnel.c,v 1.1 2011/04/18 17:11:03 mruas Exp $
 ...
 */
int
bcm_robo_tunnel_terminator_vlan_set(int unit, bcm_gport_t tunnel, 
 ...
 */
int
bcm_robo_tunnel_terminator_vlan_get(int unit, bcm_gport_t tunnel, 
                               bcm_vlan_vector_t *vlan_vec)
{
    return BCM_E_UNAVAIL;
}
