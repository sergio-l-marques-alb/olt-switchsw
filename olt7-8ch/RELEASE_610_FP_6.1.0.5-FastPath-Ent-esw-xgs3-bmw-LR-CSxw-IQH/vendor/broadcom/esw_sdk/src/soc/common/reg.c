/*
 * $Id: reg.c,v 1.1 2011/04/18 17:11:04 mruas Exp $
	      ...
	      uint32 data)
{
    ...
    schan_msg.writecmd.header.srcblk = (SOC_IS_SIRIUS(unit) ? 0 : schan_msg.writecmd.header.srcblk);
