/*
 * $Id: phy8481.h,v 1.1 2011/04/18 17:11:07 mruas Exp $
...
#define PHY8481_SELECT_REGS_CU(_unit, _phy_ctrl) \
            { \
                ...
                SOC_IF_ERROR_RETURN \
                    (WRITE_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), 0x4110, 0x0003)); \
            }
...
#define PHY8481_SELECT_REGS_XAUI(_unit, _phy_ctrl) \
            { \
                ...
                SOC_IF_ERROR_RETURN \
                    (WRITE_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), 0x4110, 0x2004)); \
            }
...
#define READ_PHY8481_MII_ECRr(_unit, _phy_ctrl, _val) \
            PHY8481_D7_FFXX_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0000, 0xfff0, (_val)) 
#define WRITE_PHY8481_MII_ECRr(_unit, _phy_ctrl, _val) \
            PHY8481_D7_FFXX_REG_WRITE((_unit), (_phy_ctrl), 0x00, 0x0000, 0xfff0, (_val))
#define MODIFY_PHY8481_MII_ECRr(_unit, _phy_ctrl, _val, _mask) \
...
The register is CLKRST_SCRATCH_REG, dev=0x1e, mdio_addr=0x418b. The bits are:
 
CLKRST_SCRATCH_REG[0] - fiber detected, 1=active, 0=inactive
CLKRST_SCRATCH_REG[1] - copper detected, 1=active, 0=inactive
CLKRST_SCRATCH_REG[2] - priority, 1=fiber priority, 0=copper priority
CLKRST_SCRATCH_REG[4:3] - copper speed, 11=10G, 10=1G, 01=100M, 00=10M
CLKRST_SCRATCH_REG[5] - copper link, 1=link up, 0=link down
CLKRST_SCRATCH_REG[7:6] - fiber speed, 11=10G, 10=1G, 01=100M, 00=10M
CLKRST_SCRATCH_REG[8] - fiber link, 1=link up, 0=link down
 
*/

#define CLKRST_SCRATCH_REG              0x418b

#define CLKRST_SCRATCH_REG_FIBER_ACT    0x0001 /* fiber detected, 1=active, 0=inactive */
#define CLKRST_SCRATCH_REG_COPPER_ACT   0x0002 /* copper detected, 1=active, 0=inactive */
#define CLKRST_SCRATCH_REG_FIBER_PRIO   0x0004 /* 1=fiber priority, 0=copper priority */
#define CLKRST_SCRATCH_REG_COPPER_LINK  0x0020 /* copper link, 1=link up, 0=link down */
#define CLKRST_SCRATCH_REG_FIBER_LINK   0x0100 /* fiber link, 1=link up, 0=link down */

#define READ_PHY8481_CLKRST_SCRATCH_REG(_unit, _phy_ctrl, _val) \
            READ_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), CLKRST_SCRATCH_REG,(_val))

#define WRITE_PHY8481_CLKRST_SCRATCH_REG(_unit, _phy_ctrl, _val) \
            WRITE_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), CLKRST_SCRATCH_REG,(_val))

#define MODIFY_PHY8481_CLKRST_SCRATCH_REG(_unit, _phy_ctrl, _val, _mask) \
            MODIFY_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), CLKRST_SCRATCH_REG,(_val),(_mask))
