/*
 * $Id: phy54xx.c,v 1.1 2011/04/18 17:11:07 mruas Exp $
...
#ifdef BCM_5690
    /*
     * Autonegotiation is disabled in the Draco internal PHY.  Therefore
     * when this PHY is connected to Draco, it is necessary to disable
     * autonegotiation on the SGMII (Draco) side.
     */

    if (SOC_IS_DRACO(unit)) {
        SOC_IF_ERROR_RETURN(phy_reg_ge_write(unit, pc, 0x00, 0x001f, 0x1c, 0xfc01)); 

        SOC_IF_ERROR_RETURN
            (MODIFY_PHY54XX_SGMII_1000X_CTRLr(unit, pc, 0x0004, 0x0004));
