/*
 * $Id: robo_5324_service.h,v 1.1 2011/04/18 17:11:08 mruas Exp $
 *
...
int drv_queue_mode_set(int unit, uint32 bmp, uint32 mode);
...
int drv_mirror_set(int unit, uint32 enable, uint32 monitor_port, 
                                            uint32 ingress_bmp, uint32 egress_bmp);
int drv_mirror_get(int unit, uint32 *enable, uint32 *monitor_port, 
                                            uint32 *ingress_bmp, uint32 *egress_bmp);
...
int drv_mstp_port_get(int unit, uint32 mstp_gid, 
                                        uint32 port, uint32 *port_state);
int drv_trap_set(int unit, uint32 trap_mask);
int drv_trap_get(int unit, uint32 *trap_mask);
