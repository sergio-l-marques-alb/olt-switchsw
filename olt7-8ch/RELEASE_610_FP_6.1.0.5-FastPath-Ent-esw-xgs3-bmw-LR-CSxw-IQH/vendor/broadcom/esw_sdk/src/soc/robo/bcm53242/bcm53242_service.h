/*
 * $Id: bcm53242_service.h,v 1.1 2011/04/18 17:11:08 mruas Exp $
 *
...
int drv_bcm53242_mirror_set
    (int unit, uint32 enable, uint32 monitor_port, soc_pbmp_t ingress_bmp, soc_pbmp_t egress_bmp);
int drv_bcm53242_mirror_get
    (int unit, uint32 *enable, uint32 *monitor_port, soc_pbmp_t *ingress_bmp, soc_pbmp_t *egress_bmp);
...
int drv_bcm53242_queue_port_dfsv_get
    (int unit, uint8 port, uint8 dscp, uint8 *prio, uint8 *queue_n);
int drv_bcm53242_queue_mode_set(int unit, uint32 bmp, uint32 mode);
...
static drv_if_t drv_bcm53242_services = {
