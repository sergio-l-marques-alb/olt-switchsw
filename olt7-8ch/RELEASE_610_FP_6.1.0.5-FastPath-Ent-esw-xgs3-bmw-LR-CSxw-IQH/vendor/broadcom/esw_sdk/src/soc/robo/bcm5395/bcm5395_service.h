/*
 * $Id: bcm5395_service.h,v 1.1 2011/04/18 17:11:09 mruas Exp $
 *
...
int drv_bcm5395_mstp_port_get(int unit, uint32 mstp_gid, 
                                        uint32 port, uint32 *port_state);
int drv_bcm5395_trap_set(int unit, soc_pbmp_t bmp, uint32 trap_mask);
...
int drv_bcm5395_rate_get(int unit, uint32 port, uint8 queue_n,
                                int direction, uint32 * limit, uint32 * burst_size);
...
#ifdef LVL7_FIXUP
/*vlan_evt_entry_add        */ NULL,
/*vlan_evt_entry_delete     */ NULL,
/*vlan_evt_entry_get        */ NULL,
/*vlan_evt_entry_modify       */ NULL,
#endif
};
