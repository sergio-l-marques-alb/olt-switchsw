/*
 * $Id: cmdlist.c,v 1.1 2011/04/18 17:10:59 mruas Exp $
...
#endif
#if defined(BCM_BSAFE_SUPPORT)
    {"BSAFE",       cmd_bsafe,      cmd_bsafe_usage,
     "BroadSAFE test commands"},
#endif
...
#endif
#ifdef VXWORKS
#if defined(INCLUDE_XMODEM) /* XMODEM support removed */
    {"XModem",          if_xmodem,              if_xmodem_usage,        "Use XModem Protocol to send/receive files." },
#endif
#endif
#ifdef INCLUDE_I2C
...
/*  ------------+---------------------------+---------------------+---------------------------------------------------- */
    ...
    {"break",       cmd_sbx_break,          cmd_sbx_break_usage,        "place to hang a breakpoint" },
#ifdef BCM_FE2000_SUPPORT
#ifdef INCLUDE_I2C
...
#ifdef BCM_FE2000_SUPPORT
#ifdef BCM_FE2000_P2_SUPPORT
    {"GU2CLSAdd",   cmd_sbx_gu2_cls_add,    cmd_sbx_gu2_cls_add_usage,  "Add classifier rule" },
    {"GU2CLSRemove",cmd_sbx_gu2_cls_rem,    cmd_sbx_gu2_cls_rem_usage,   "Remove classifier rule" },

    {"GU2Demo",     cmd_sbx_gu2_demo,       cmd_sbx_gu2_demo_usage,     "GU2 demo control" },
    {"GU2Get",      cmd_sbx_gu2_get,        cmd_sbx_gu2_get_usage,      "Table Read" },
    {"GU2ReadCount", cmd_sbx_gu2_readcount, cmd_sbx_gu2_readcount_usage, "Read Counter" },
    {"GU2Set",      cmd_sbx_gu2_set,        cmd_sbx_gu2_set_usage,      "Table Write" },
    {"GU2Util",     cmd_sbx_gu2_util,       cmd_sbx_gu2_util_usage,     "G2P2 microcode utilities" },
#endif
    ...
    {"LIBInit",     cmd_sbx_lib_init,       cmd_sbx_lib_init_usage,     "Initialize library"},
#endif /* BCM_FE2000_SUPPORT */
    {"LINKscan",    if_esw_linkscan,        if_esw_linkscan_usage,      "Configure/Display link scanning" },
#ifdef BCM_SIRIUS_SUPPORT
...
#ifdef BCM_SIRIUS_SUPPORT
    {"MUlticast",   cmd_sbx_multicast,      cmd_sbx_multicast_usage,    "Manipulate multicast APIs"},
#endif /* BCM_SIRIUS_SUPPORT */
...
#ifdef BCM_FE2000_SUPPORT
#ifdef BCM_FE2000_P2_SUPPORT
    {"RHSet",       cmd_sbx_fe2000_rhs,     cmd_sbx_fe2000_rhs_usage,   "Define a default Route Header"},
#endif /* BCM_FE2000_P2_SUPPORT */
#endif
    ...
    {"SFI",         cmd_sbx_sfi,            cmd_sbx_sfi_usage,          "SFI/SCI controls" },
#endif
...
#ifdef BCM_FE2000_P2_SUPPORT
    {"TCalScan",    cmd_sbx_fe2000_tcalscan, cmd_sbx_fe2000_tcalscan_usage,"Scan OAM TCal table for valid entries"},
#endif
#endif /* BCM_FE2000_SUPPORT */
#ifdef INCLUDE_TEST
    {"TestClear",       test_clear,             test_clear_usage,       "Clear run statisistics for a test"},
