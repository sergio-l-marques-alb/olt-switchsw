/*
 * $Id: system_snake.c,v 1.1 2011/04/18 17:10:59 mruas Exp $
...
STATIC mac_addr_t ss_mac_src[SS_MAX_SNAKE] = {
...
STATIC mac_addr_t ss_mac_dst[SS_MAX_SNAKE] = {
...
ss_unit_setup(system_snake_opts_t *opts, int unit)
{
    ...
    ss_pbm = pcfg[unit].e;
    if (soc_property_get_str(unit, spn_SYSSNAKE_IGNORE_PBMP)) {
        ignore_pbm = soc_property_get_bcm_pbmp(unit, spn_SYSSNAKE_IGNORE_PBMP, 0);
