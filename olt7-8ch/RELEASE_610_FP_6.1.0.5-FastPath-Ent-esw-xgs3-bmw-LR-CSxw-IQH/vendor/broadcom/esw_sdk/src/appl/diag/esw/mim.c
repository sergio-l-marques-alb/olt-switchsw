/*
 * $Id: mim.c,v 1.1 2011/04/18 17:11:00 mruas Exp $
...
STATIC _bcm_tr2_mim_flag_t mim_port_match_flags[] = {
    ...
    {"ServiceVlanTpid", BCM_MIM_PORT_MATCH_SERVICE_VLAN_TPID},
    {NULL, 0}
};
...
_bcm_tr2_mim_cli_vpn_port_add(int unit, args_t * a)
{
    ...
    memcpy(mport.match_tunnel_srcmac, mtsmac, sizeof(mac_addr_t));
    mport.match_service_tpid = mstpid;
    mport.egress_tunnel_vlan = etvlan;
    memcpy(mport.egress_tunnel_srcmac, etsmac, sizeof(mac_addr_t));
    memcpy(mport.egress_tunnel_dstmac, etdmac, sizeof(mac_addr_t));
