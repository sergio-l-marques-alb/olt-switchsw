/*
 * $Id: testlist.h,v 1.1 2011/04/18 17:11:00 mruas Exp $
...
extern  int     bsafe_test_init(int, args_t *, void **);
extern  int     bsafe_test_test(int, args_t *, void *);
extern  int     bsafe_test_done(int, void *);
#endif
