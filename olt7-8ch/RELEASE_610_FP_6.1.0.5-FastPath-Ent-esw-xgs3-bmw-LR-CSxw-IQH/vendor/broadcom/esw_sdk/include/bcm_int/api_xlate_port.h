/*
 * $Id: api_xlate_port.h,v 1.1 2011/04/18 17:10:55 mruas Exp $
...
#define BCM_API_XLATE_PORT_DECL(_var)           bcm_port_t _var
...
#define BCM_API_XLATE_PORT_PBMP_SAVE(_t,_p)     BCM_PBMP_ASSIGN(_t,_p)
#define BCM_API_XLATE_PORT_PBMP_RESTORE(_p,_t)  BCM_PBMP_ASSIGN(_p,_t)
