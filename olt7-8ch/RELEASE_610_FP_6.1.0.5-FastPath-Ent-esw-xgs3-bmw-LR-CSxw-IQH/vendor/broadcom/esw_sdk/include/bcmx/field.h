...
/* Group Management */
extern int bcmx_field_group_traverse(bcm_field_group_traverse_cb callback,
                                     void *user_data);
...
extern int bcmx_field_group_wlan_create_mode(bcm_field_qset_t qset,
                                        int pri,
                                        bcm_field_group_mode_t mode,
                                        bcm_field_group_t *group);

extern int bcmx_field_group_wlan_create_mode_id(bcm_field_qset_t qset,
                                           int pri,
                                           bcm_field_group_mode_t mode,
                                           bcm_field_group_t group);
...
extern int bcmx_field_group_compress(bcm_field_group_t group);
...
extern int bcmx_field_qualify_OuterVlanId(bcm_field_entry_t entry,
                                          bcm_vlan_t data, bcm_vlan_t mask);

extern int bcmx_field_qualify_ForwardingVlanId(bcm_field_entry_t entry,
                                          bcm_vlan_t data, bcm_vlan_t mask);

extern int bcmx_field_qualify_OuterVlanPri(bcm_field_entry_t entry,
                                           uint8 data, uint8 mask);

extern int bcmx_field_qualify_OuterVlanCfi(bcm_field_entry_t entry,
                                          uint8 data, uint8 mask);

extern int bcmx_field_qualify_InnerVlan(bcm_field_entry_t entry,
                                        bcm_vlan_t data, bcm_vlan_t mask);

extern int bcmx_field_qualify_InnerVlanId(bcm_field_entry_t entry,
                                          bcm_vlan_t data, bcm_vlan_t mask);

extern int bcmx_field_qualify_InnerVlanPri(bcm_field_entry_t entry,
                                           uint8 data, uint8 mask);

extern int bcmx_field_qualify_InnerVlanCfi(bcm_field_entry_t entry,
                                          uint8 data, uint8 mask);
...
extern int bcmx_field_qualify_InnerIpType(bcm_field_entry_t entry, 
                                          bcm_field_IpType_t type);

extern int bcmx_field_qualify_ForwardingType(bcm_field_entry_t entry,
...
extern int bcmx_field_qualify_DstHiGig(bcm_field_entry_t entry,
                                        uint8 data, uint8 mask);
...
extern int bcmx_field_qualify_InnerIpProtocolCommon(bcm_field_entry_t entry, 
                                                    bcm_field_IpProtocolCommon_t protocol);
...
extern int bcmx_field_qualify_Vpn(bcm_field_entry_t entry,
...
extern int bcmx_field_qualify_VlanTranslationHit(bcm_field_entry_t entry, 
                                                 uint8 data, uint8 mask);
extern int bcmx_field_qualify_InnerIp6FlowLabel(bcm_field_entry_t entry, 
                                                uint32 data, 
                                                uint32 mask);
extern int bcmx_field_qualify_InnerL4DstPort(bcm_field_entry_t entry, 
                                             bcm_l4_port_t data, 
                                             bcm_l4_port_t mask);
extern int bcmx_field_qualify_InnerL4SrcPort(bcm_field_entry_t entry, 
                                             bcm_l4_port_t data, 
                                             bcm_l4_port_t mask);
...
extern int bcmx_field_action_get(bcm_field_entry_t entry,
                                 ...
                                 uint32 *param0,
                                 uint32 *param1);
extern int bcmx_field_action_mac_add(bcm_field_entry_t entry,
                            bcm_field_action_t action,
                            bcm_mac_t mac);
extern int bcmx_field_action_mac_get(bcm_field_entry_t entry,
                            bcm_field_action_t action,
                            bcm_mac_t *mac);
...
extern int bcmx_field_group_priority_set(bcm_field_group_t group,
                                         int priority);

extern int bcmx_field_group_priority_get(bcm_field_group_t group,
                                         int *priority);
...
extern void bcmx_field_data_qualifier_t_init(bcmx_field_data_qualifier_t *data_qual);

extern void bcmx_field_data_ethertype_t_init(bcmx_field_data_ethertype_t *etype);

extern void bcmx_field_data_ip_protocol_t_init(bcmx_field_data_ip_protocol_t *ip_protocol);

extern void bcmx_field_data_packet_format_t_init(
                 bcmx_field_data_packet_format_t *packet_format);

extern int bcmx_field_data_qualifier_create(bcmx_field_data_qualifier_t *data_qualifier);

extern int bcmx_field_data_qualifier_destroy(int qual_id);

extern int bcmx_field_data_qualifier_destroy_all(void);

extern int bcmx_field_data_qualifier_ethertype_add(int qual_id,
                                                   bcmx_field_data_ethertype_t *etype);

extern int bcmx_field_data_qualifier_ethertype_delete(int qual_id,
               bcmx_field_data_ethertype_t *etype);

extern int bcmx_field_data_qualifier_ip_protocol_add(int qual_id,
               bcmx_field_data_ip_protocol_t *ip_protocol);

extern int bcmx_field_data_qualifier_ip_protocol_delete(int qual_id,
               bcmx_field_data_ip_protocol_t *ip_protocol);

extern int bcmx_field_data_qualifier_packet_format_add(int qual_id,
               bcmx_field_data_packet_format_t *packet_format);

extern int bcmx_field_data_qualifier_packet_format_delete(int qual_id,
               bcmx_field_data_packet_format_t *packet_format);

extern int bcmx_field_qset_data_qualifier_add(bcm_field_qset_t *qset,
                                              int qual_id);

extern int bcmx_field_qualify_data(bcm_field_entry_t eid, int qual_id,
                                   uint8 *data, uint8 *mask, uint16 length);

extern int bcmx_field_qset_udf_get(bcm_field_qset_t *qset, int udf_max, 
                                   int *udf_arr, int *udf_count);

extern int bcmx_field_qset_data_qualifier_get(bcm_field_qset_t *qset,
                                              int qual_max, int *qual_arr,
                                              int *qual_count);

/* Add Translated vlan format field qualification to a field entry. */
extern int bcmx_field_qualify_TranslatedVlanFormat(bcm_field_entry_t entry,
                              uint8 data, uint8 mask);
/* Add loopback field qualification to a field entry. */
extern int bcmx_field_qualify_Loopback(bcm_field_entry_t entry, 
                                       uint8 data, uint8 mask);

/* Add loopback type field qualification to a field entry. */
extern int bcmx_field_qualify_LoopbackType(bcm_field_entry_t entry, 
                                           bcm_field_LoopbackType_t loopback_type);

/* Add tunnel type field qualification to a field entry. */
extern int bcmx_field_qualify_TunnelType(bcm_field_entry_t entry, 
                                         bcm_field_TunnelType_t tunnel_type);

/* bcm_field_qualify_DstL3Egress */
extern int bcmx_field_qualify_DstL3Egress(bcm_field_entry_t entry, 
                                          bcm_if_t if_id);

/* bcm_field_qualify_DstMulticastGroup */
extern int bcmx_field_qualify_DstMulticastGroup(bcm_field_entry_t entry, 
                                                bcm_gport_t group);

/* bcm_field_qualify_SrcMplsGport */
extern int bcmx_field_qualify_SrcMplsGport(bcm_field_entry_t entry, 
                                           bcm_gport_t mpls_port_id);

/* bcm_field_qualify_DstMplsGport */
extern int bcmx_field_qualify_DstMplsGport(bcm_field_entry_t entry, 
                                           bcm_gport_t mpls_port_id);

/* bcm_field_qualify_SrcMimGport */
extern int bcmx_field_qualify_SrcMimGport(bcm_field_entry_t entry, 
                                          bcm_gport_t mim_port_id);

/* bcm_field_qualify_DstMimGport */
extern int bcmx_field_qualify_DstMimGport(bcm_field_entry_t entry, 
                                          bcm_gport_t mim_port_id);

/* bcm_field_qualify_SrcWlanGport */
extern int bcmx_field_qualify_SrcWlanGport(bcm_field_entry_t entry, 
                                           bcm_gport_t wlan_port_id);

/* bcm_field_qualify_DstWlanGport */
extern int bcmx_field_qualify_DstWlanGport(bcm_field_entry_t entry, 
                                           bcm_gport_t wlan_port_id);
 ...
 */
extern int bcmx_field_qualify_IntPriority(bcm_field_entry_t entry, 
                                          uint8 data, uint8 mask);
 ...
 *                qualifier in the field entry.
 */
extern int bcmx_field_qualify_Color(bcm_field_entry_t entry, 
                                    uint8 color);
 ...
 *                qualifier in the field entry.
 */
extern int bcmx_field_qualify_SrcModPortGport(bcm_field_entry_t entry, 
                                              bcm_gport_t data);


/*Get loopback type field qualification from a field entry. */
extern int bcmx_field_qualify_LoopbackType_get(bcm_field_entry_t entry, 
                                              bcm_field_LoopbackType_t *loopback_type);
/*Get tunnel type field qualification from a field entry. */
extern int bcmx_field_qualify_TunnelType_get(bcm_field_entry_t entry, 
                                            bcm_field_TunnelType_t *tunnel_type);
/*
 * Get match criteria for bcmFieldQualifyDstL3Egress
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstL3Egress_get(bcm_field_entry_t entry, 
                                             bcm_if_t *if_id);
/*
 * Get match criteria for bcmFieldQualifyDstMulticastGroup
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstMulticastGroup_get(bcm_field_entry_t entry, 
                                                   bcm_gport_t *group);
/*
 * Get match criteria for bcmFieldQualifySrcMplsGport
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcMplsGport_get(bcm_field_entry_t entry, 
                                              bcm_gport_t *mpls_port_id);
/*
 * Get match criteria for bcmFieldQualifyDstMplsGport
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstMplsGport_get(bcm_field_entry_t entry, 
                                              bcm_gport_t *mpls_port_id);
/*
 * Get match criteria for bcmFieldQualifySrcMimGport
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcMimGport_get(bcm_field_entry_t entry, 
                                             bcm_gport_t *mim_port_id);
/*
 * Get match criteria for bcmFieldQualifyDstMimGport
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstMimGport_get(bcm_field_entry_t entry, 
                                             bcm_gport_t *mim_port_id);
/*
 * Get match criteria for bcmFieldQualifySrcWlanGport
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcWlanGport_get(bcm_field_entry_t entry, 
                                              bcm_gport_t *wlan_port_id);
/*
 * Get match criteria for bcmFieldQualifyDstWlanGport
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstWlanGport_get(bcm_field_entry_t entry, 
                                              bcm_gport_t *wlan_port_id);
/*Get loopback field qualification from  a field entry. */
extern int bcmx_field_qualify_Loopback_get(bcm_field_entry_t entry, 
                                          uint8 *data, 
                                          uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InPort_get(bcm_field_entry_t entry, 
                                        bcm_port_t *data, 
                                        bcm_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OutPort_get(bcm_field_entry_t entry, 
                                         bcm_port_t *data, 
                                         bcm_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InPorts_get(bcm_field_entry_t entry, 
                                         bcm_pbmp_t *data, 
                                         bcm_pbmp_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OutPorts_get(bcm_field_entry_t entry, 
                                          bcm_pbmp_t *data, 
                                          bcm_pbmp_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Drop_get(bcm_field_entry_t entry, 
                                      uint8 *data, 
                                      uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcModid_get(bcm_field_entry_t entry, 
                                          bcm_module_t *data, 
                                          bcm_module_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcPortTgid_get(bcm_field_entry_t entry, 
                                             bcm_port_t *data, 
                                             bcm_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcPort_get(bcm_field_entry_t entry, 
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcTrunk_get(bcm_field_entry_t entry, 
                                          bcm_trunk_t *data, 
                                          bcm_trunk_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstModid_get(bcm_field_entry_t entry, 
                                          bcm_module_t *data, 
                                          bcm_module_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstPortTgid_get(bcm_field_entry_t entry, 
                                             bcm_port_t *data, 
                                             bcm_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstPort_get(bcm_field_entry_t entry, 
                                         bcm_module_t *data_modid, 
                                         bcm_module_t *mask_modid, 
                                         bcm_port_t *data_port, 
                                         bcm_port_t *mask_port);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstTrunk_get(bcm_field_entry_t entry, 
                                          bcm_trunk_t *data, 
                                          bcm_trunk_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerL4SrcPort_get(bcm_field_entry_t entry, 
                                                bcm_l4_port_t *data, 
                                                bcm_l4_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerL4DstPort_get(bcm_field_entry_t entry, 
                                                bcm_l4_port_t *data, 
                                                bcm_l4_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L4SrcPort_get(bcm_field_entry_t entry, 
                                           bcm_l4_port_t *data, 
                                           bcm_l4_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L4DstPort_get(bcm_field_entry_t entry, 
                                           bcm_l4_port_t *data, 
                                           bcm_l4_port_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OuterVlan_get(bcm_field_entry_t entry, 
                                           bcm_vlan_t *data, 
                                           bcm_vlan_t *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OuterVlanId_get(bcm_field_entry_t entry, 
                                              bcm_vlan_t *data, 
                                              bcm_vlan_t *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_ForwardingVlanId_get(bcm_field_entry_t entry, 
                                              bcm_vlan_t *data, 
                                              bcm_vlan_t *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OuterVlanPri_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OuterVlanCfi_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerVlan_get(bcm_field_entry_t entry, 
                                           bcm_vlan_t *data, 
                                           bcm_vlan_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerVlanId_get(bcm_field_entry_t entry, 
                                              bcm_vlan_t *data, 
                                              bcm_vlan_t *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerVlanPri_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerVlanCfi_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_EtherType_get(bcm_field_entry_t entry, 
                                           uint16 *data, 
                                           uint16 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_EqualL4Port_get(bcm_field_entry_t entry, 
                                             uint32 *flag);
/*
 * Get match criteria for bcmFieldQualifyIpProtocol
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpProtocol_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpInfo_get(bcm_field_entry_t entry, 
                                        uint32 *data, 
                                        uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_PacketRes_get(bcm_field_entry_t entry, 
                                           uint32 *data, 
                                           uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcIp_get(bcm_field_entry_t entry, 
                                       bcm_ip_t *data, 
                                       bcm_ip_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstIp_get(bcm_field_entry_t entry, 
                                       bcm_ip_t *data, 
                                       bcm_ip_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DSCP_get(bcm_field_entry_t entry, 
                                      uint8 *data, 
                                      uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpFlags_get(bcm_field_entry_t entry, 
                                         uint8 *data, 
                                         uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_TcpControl_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_TcpSequenceZero_get(bcm_field_entry_t entry, 
                                                 uint32 *flag);
/*
 * Get match criteria for bcmFieldQualifyTcpHeaderSize
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_TcpHeaderSize_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Ttl_get(bcm_field_entry_t entry, 
                                     uint8 *data, 
                                     uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_RangeCheck_get(bcm_field_entry_t entry, 
                                            int max_count, 
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcIp6_get(bcm_field_entry_t entry, 
                                        bcm_ip6_t *data, 
                                        bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstIp6_get(bcm_field_entry_t entry, 
                                        bcm_ip6_t *data, 
                                        bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcIp6High_get(bcm_field_entry_t entry, 
                                            bcm_ip6_t *data, 
                                            bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcIpEqualDstIp_get(bcm_field_entry_t entry, 
                                                 uint32 *flag);
/*
 * Get match criteria for bcmFieldQualifyDstIp6High
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstIp6High_get(bcm_field_entry_t entry, 
                                            bcm_ip6_t *data, 
                                            bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Ip6NextHeader_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Ip6TrafficClass_get(bcm_field_entry_t entry, 
                                                 uint8 *data, 
                                                 uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerIp6FlowLabel_get(bcm_field_entry_t entry, 
                                                   uint32 *data, 
                                                   uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Ip6FlowLabel_get(bcm_field_entry_t entry, 
                                              uint32 *data, 
                                              uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Ip6HopLimit_get(bcm_field_entry_t entry, 
                                             uint8 *data, 
                                             uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcMac_get(bcm_field_entry_t entry, 
                                        bcm_mac_t *data, 
                                        bcm_mac_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstMac_get(bcm_field_entry_t entry, 
                                        bcm_mac_t *data, 
                                        bcm_mac_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_PacketFormat_get(bcm_field_entry_t entry, 
                                              uint32 *data, 
                                              uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcMacGroup_get(bcm_field_entry_t entry, 
                                             uint32 *data, 
                                             uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerIpType_get(bcm_field_entry_t entry, 
                                             bcm_field_IpType_t *type);
/*
 * Get match criteria for bcmFieldQualifyForwardingType
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_ForwardingType_get(bcm_field_entry_t entry, 
                                                bcm_field_ForwardingType_t *type);
/*
 * Get match criteria for bcmFieldQualifyIpType
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpType_get(bcm_field_entry_t entry, 
                                        bcm_field_IpType_t *type);
/*
 * Get match criteria for bcmFieldQualifyL2Format
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L2Format_get(bcm_field_entry_t entry, 
                                          bcm_field_L2Format_t *type);
/*
 * Get match criteria for bcmFieldQualifyVlanFormat
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_VlanFormat_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_TranslatedVlanFormat_get(bcm_field_entry_t entry, 
                                                       uint8 *data, 
                                                       uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_MHOpcode_get(bcm_field_entry_t entry, 
                                          uint8 *data, 
                                          uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_UserDefined_get(bcm_field_entry_t entry, 
                                             bcm_field_udf_t udf_id, 
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstHiGig_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_HiGig_get(bcm_field_entry_t entry, 
                                        uint8 *data, 
                                        uint8 *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InterfaceClassPort_get(bcm_field_entry_t entry, 
                                                    uint32 *data, 
                                                    uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InterfaceClassL2_get(bcm_field_entry_t entry, 
                                                  uint32 *data, 
                                                  uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InterfaceClassL3_get(bcm_field_entry_t entry, 
                                                  uint32 *data, 
                                                  uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcClassL2_get(bcm_field_entry_t entry, 
                                            uint32 *data, 
                                            uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcClassL3_get(bcm_field_entry_t entry, 
                                            uint32 *data, 
                                            uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcClassField_get(bcm_field_entry_t entry, 
                                               uint32 *data, 
                                               uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstClassL2_get(bcm_field_entry_t entry, 
                                            uint32 *data, 
                                            uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstClassL3_get(bcm_field_entry_t entry, 
                                            uint32 *data, 
                                            uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DstClassField_get(bcm_field_entry_t entry, 
                                               uint32 *data, 
                                               uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L3IntfGroup_get(bcm_field_entry_t entry, 
                                             bcm_if_group_t *data, 
                                             bcm_if_group_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpProtocolCommon_get(bcm_field_entry_t entry, 
                                                  bcm_field_IpProtocolCommon_t *protocol);
/*
 * Get match criteria for bcmFieldQualifyInnerIpProtocolCommon
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerIpProtocolCommon_get(bcm_field_entry_t entry, 
                                                       bcm_field_IpProtocolCommon_t *protocol);
/*
 * Get match criteria for bcmFieldQualifySnap
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Snap_get(bcm_field_entry_t entry, 
                                      bcm_field_snap_header_t *data, 
                                      bcm_field_snap_header_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Llc_get(bcm_field_entry_t entry, 
                                     bcm_field_llc_header_t *data, 
                                     bcm_field_llc_header_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerTpid_get(bcm_field_entry_t entry, 
                                           uint16 *tpid);
/*
 * Get match criteria for bcmFieldQualifyOuterTpid
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_OuterTpid_get(bcm_field_entry_t entry, 
                                           uint16 *tpid);
/*
 * Get match criteria for bcmFieldQualifyPortClass
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_PortClass_get(bcm_field_entry_t entry, 
                                           uint32 *data, 
                                           uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L3Routable_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpFrag_get(bcm_field_entry_t entry, 
                                        bcm_field_IpFrag_t *frag_info);
/*
 * Get match criteria for bcmFieldQualifyLookupClass0
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_LookupClass0_get(bcm_field_entry_t entry, 
                                              uint32 *data, 
                                              uint32 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Vrf_get(bcm_field_entry_t entry, 
                                     uint32 *data, 
                                     uint32 *mask);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_Vpn_get(bcm_field_entry_t entry, 
                                     bcm_vpn_t *data, 
                                     bcm_vpn_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_ExtensionHeaderType_get(bcm_field_entry_t entry, 
                                                     uint8 *data, 
                                                     uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_ExtensionHeaderSubCode_get(bcm_field_entry_t entry, 
                                                        uint8 *data, 
                                                        uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L4Ports_get(bcm_field_entry_t entry, 
                                         uint8 *data, 
                                         uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_MirrorCopy_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_TunnelTerminated_get(bcm_field_entry_t entry, 
                                                  uint8 *data, 
                                                  uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_MplsTerminated_get(bcm_field_entry_t entry, 
                                                uint8 *data, 
                                                uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerSrcIp_get(bcm_field_entry_t entry, 
                                            bcm_ip_t *data, 
                                            bcm_ip_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerDstIp_get(bcm_field_entry_t entry, 
                                            bcm_ip_t *data, 
                                            bcm_ip_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerSrcIp6_get(bcm_field_entry_t entry, 
                                             bcm_ip6_t *data, 
                                             bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerDstIp6_get(bcm_field_entry_t entry, 
                                             bcm_ip6_t *data, 
                                             bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerSrcIp6High_get(bcm_field_entry_t entry, 
                                                 bcm_ip6_t *data, 
                                                 bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerDstIp6High_get(bcm_field_entry_t entry, 
                                                 bcm_ip6_t *data, 
                                                 bcm_ip6_t *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerTtl_get(bcm_field_entry_t entry, 
                                          uint8 *data, 
                                          uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerDSCP_get(bcm_field_entry_t entry, 
                                           uint8 *data, 
                                           uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerIpProtocol_get(bcm_field_entry_t entry, 
                                                 uint8 *data, 
                                                 uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_InnerIpFrag_get(bcm_field_entry_t entry, 
                                             bcm_field_IpFrag_t *frag_info);
/*
 * Get match criteria for bcmFieldQualifyDosAttack
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_DosAttack_get(bcm_field_entry_t entry, 
                                           uint8 *data, 
                                           uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpmcStarGroupHit_get(bcm_field_entry_t entry, 
                                                  uint8 *data, 
                                                  uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L3DestRouteHit_get(bcm_field_entry_t entry, 
                                                uint8 *data, 
                                                uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L3DestHostHit_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L3SrcHostHit_get(bcm_field_entry_t entry, 
                                              uint8 *data, 
                                              uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L2CacheHit_get(bcm_field_entry_t entry, 
                                            uint8 *data, 
                                            uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L2StationMove_get(bcm_field_entry_t entry, 
                                               uint8 *data, 
                                               uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L2DestHit_get(bcm_field_entry_t entry, 
                                           uint8 *data, 
                                           uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L2SrcStatic_get(bcm_field_entry_t entry, 
                                             uint8 *data, 
                                             uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_L2SrcHit_get(bcm_field_entry_t entry, 
                                          uint8 *data, 
                                          uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IngressStpState_get(bcm_field_entry_t entry, 
                                                 uint8 *data, 
                                                 uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_ForwardingVlanValid_get(bcm_field_entry_t entry, 
                                                     uint8 *data, 
                                                     uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_VlanTranslationHit_get(bcm_field_entry_t entry, 
                                                    uint8 *data, 
                                                    uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IpAuth_get(bcm_field_entry_t entry, 
                                        uint8 *data, 
                                        uint8 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_BigIcmpCheck_get(bcm_field_entry_t entry, 
                                              uint32 *flag, 
                                              uint32 *size);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IcmpTypeCode_get(bcm_field_entry_t entry, 
                                              uint16 *data, 
                                              uint16 *mask);
/*
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_IgmpTypeMaxRespTime_get(bcm_field_entry_t entry, 
                                                     uint16 *data, 
                                                     uint16 *mask);
/*
 ...
 *      qualifier from the field entry.
 */
extern int bcmx_field_qualify_IntPriority_get(bcm_field_entry_t entry, 
                                              uint8 *data, uint8 *mask);
/*
 *      Get match criteria for bcmFieldQualifyColor
 *      qualifier from the field entry.
 */
extern int bcmx_field_qualify_Color_get(bcm_field_entry_t entry, 
                                        uint8 *color);
 ...
 *                qualifier from the field entry.
 */
extern int bcmx_field_qualify_SrcModPortGport_get(bcm_field_entry_t entry, 
                                                  bcm_gport_t *data);

/* Remove match criteria from a field processor entry. */
extern int bcmx_field_qualifier_delete(bcm_field_entry_t entry, 
 ...
 */
extern int bcmx_field_qualify_TcpSequenceZero(bcm_field_entry_t entry, 
                                              uint32 flag);
/*
 * Set match criteria for bcmFieldQualifyTcpHeaderSize
 *                qualifier to the field entry.
 */
extern int bcmx_field_qualify_TcpHeaderSize(bcm_field_entry_t entry, 
                                            uint8 data, 
                                            uint8 mask);
/*
 ...
 *                qualifier to the field entry.
 */
extern int bcmx_field_qualify_EqualL4Port(bcm_field_entry_t entry, 
                                          uint32 flag);
 ...
 *                qualifier to the field entry.
 */
extern int bcmx_field_qualify_SrcIpEqualDstIp(bcm_field_entry_t entry, 
                                              uint32 flag);
