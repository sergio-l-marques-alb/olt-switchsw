/* 
 * $Id: multicast.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
extern int bcmx_multicast_mim_encap_get(bcm_multicast_t group,
                                        bcm_gport_t port, 
                                        bcm_gport_t mim_port_id,
                                        bcm_if_t *encap_id);

extern int bcmx_multicast_wlan_encap_get(bcm_multicast_t group,
                                         bcm_gport_t port, 
