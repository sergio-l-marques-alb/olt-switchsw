/*
 * $Id: tunnel.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
typedef struct bcmx_tunnel_terminator_s {
    ...
    bcm_gport_t          remote_port;  /* Remote termination port */
...
extern int bcmx_tunnel_terminator_vlan_set(bcm_gport_t tunnel,
                                           bcm_vlan_vector_t vlan_vec);
extern int bcmx_tunnel_terminator_vlan_get(bcm_gport_t tunnel, 
                                           bcm_vlan_vector_t *vlan_vec);
