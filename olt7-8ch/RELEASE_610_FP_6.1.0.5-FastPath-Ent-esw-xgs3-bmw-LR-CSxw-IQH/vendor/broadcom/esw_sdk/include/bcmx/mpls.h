/*
 * $Id: mpls.h,v 1.1 2011/04/18 17:10:56 mruas Exp $
...
extern void bcmx_mpls_circuit_t_init(bcmx_mpls_circuit_t *mpls_vc);
...
extern int bcmx_mpls_label_stat_clear(bcm_mpls_label_t label, bcm_gport_t port,
