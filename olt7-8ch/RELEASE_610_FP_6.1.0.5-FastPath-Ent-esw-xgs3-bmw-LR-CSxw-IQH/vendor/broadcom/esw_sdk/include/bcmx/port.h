...
extern void bcmx_port_config_t_init(bcmx_port_config_t *pconfig);
extern void bcmx_port_ability_t_init(bcmx_port_ability_t *ability);
extern void bcmx_port_encap_config_t_init(bcmx_port_encap_config_t *encap_config);
...
extern int bcmx_port_link_failed_clear(bcm_gport_t port);
...
extern int bcmx_port_encap_config_set(bcm_gport_t gport, 
                                      bcmx_port_encap_config_t *encap_config);
extern int bcmx_port_encap_config_get(bcm_gport_t gport, 
                                      bcmx_port_encap_config_t *encap_config);
...
extern int bcmx_port_control_set(bcmx_lport_t port,
                                 bcm_port_control_t type, int arg);

extern int bcmx_port_control_get(bcmx_lport_t port,
                                 bcm_port_control_t type, int *arg);

extern int bcmx_port_stat_enable_set(bcm_gport_t port, int enable);
extern int bcmx_port_stat_get(bcm_gport_t port,
                              bcm_port_stat_t stat, uint64 *val);
extern int bcmx_port_stat_get32(bcm_gport_t port,
                                bcm_port_stat_t stat, uint32 *val);
extern int bcmx_port_stat_set(bcm_gport_t port,
                              bcm_port_stat_t stat, uint64 val);
extern int bcmx_port_stat_set32(bcm_gport_t port,
                                bcm_port_stat_t stat, uint32 val);
extern int bcmx_port_stat_multi_get(bcm_gport_t port, int nstat,
                                    bcm_port_stat_t *stat_arr,
                                    uint64 *value_arr);
extern int bcmx_port_stat_multi_get32(bcm_gport_t port, int nstat,
                                      bcm_port_stat_t *stat_arr,
                                      uint32 *value_arr);
extern int bcmx_port_stat_multi_set(bcm_gport_t port, int nstat,
                                    bcm_port_stat_t *stat_arr,
                                    uint64 *value_arr);
extern int bcmx_port_stat_multi_set32(bcm_gport_t port, int nstat,
                                      bcm_port_stat_t *stat_arr,
                                      uint32 *value_arr);

extern int bcmx_port_subsidiary_ports_get(bcm_gport_t port,
