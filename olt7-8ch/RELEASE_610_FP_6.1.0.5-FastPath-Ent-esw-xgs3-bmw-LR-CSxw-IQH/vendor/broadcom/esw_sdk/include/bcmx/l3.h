...
extern void bcmx_l3_source_bind_t_init(bcmx_l3_source_bind_t *info);
...
extern int bcmx_l3_route_delete_by_interface(bcmx_l3_route_t *info);
 ...
 * L3 VRF statistics
 */
extern int bcmx_l3_vrf_stat_enable_set(bcm_vrf_t vrf, int enable);
extern int bcmx_l3_vrf_stat_get(bcm_vrf_t vrf,
                                bcm_l3_vrf_stat_t stat, uint64 *val);
extern int bcmx_l3_vrf_stat_get32(bcm_vrf_t vrf,
                                  bcm_l3_vrf_stat_t stat, uint32 *val);
extern int bcmx_l3_vrf_stat_set(bcm_vrf_t vrf, 
                                bcm_l3_vrf_stat_t stat, uint64 val);
extern int bcmx_l3_vrf_stat_set32(bcm_vrf_t vrf, 
                                  bcm_l3_vrf_stat_t stat, uint32 val);
extern int bcmx_l3_vrf_stat_multi_get(bcm_vrf_t vrf, int nstat, 
                                      bcm_l3_vrf_stat_t *stat_arr, 
                                      uint64 *value_arr);
extern int bcmx_l3_vrf_stat_multi_get32(bcm_vrf_t vrf, int nstat, 
                                        bcm_l3_vrf_stat_t *stat_arr, 
                                        uint32 *value_arr);
extern int bcmx_l3_vrf_stat_multi_set(bcm_vrf_t vrf, int nstat, 
                                      bcm_l3_vrf_stat_t *stat_arr, 
                                      uint64 *value_arr);
extern int bcmx_l3_vrf_stat_multi_set32(bcm_vrf_t vrf, int nstat, 
                                        bcm_l3_vrf_stat_t *stat_arr, 
                                        uint32 *value_arr);
 ...
 * IP to MACSA Binding
 */
extern int bcmx_l3_source_bind_enable_set(bcm_gport_t port, int enable);
extern int bcmx_l3_source_bind_enable_get(bcm_gport_t port, int *enable);
extern int bcmx_l3_source_bind_add(bcmx_l3_source_bind_t *info);
extern int bcmx_l3_source_bind_delete(bcmx_l3_source_bind_t *info);
extern int bcmx_l3_source_bind_delete_all(void);
extern int bcmx_l3_source_bind_get(bcmx_l3_source_bind_t *info);
