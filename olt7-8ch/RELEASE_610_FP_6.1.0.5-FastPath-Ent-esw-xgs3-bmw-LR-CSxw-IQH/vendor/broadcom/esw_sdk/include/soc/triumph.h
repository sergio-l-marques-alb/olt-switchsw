/*
 * $Id: triumph.h,v 1.1 2011/04/18 17:10:57 mruas Exp $
...
extern int soc_triumph_esm_init_pvt_comp(int unit, soc_reg_t reg,
...
extern int soc_shadow_ext_l2_entry_deinit(int unit);
extern int soc_shadow_ext_l2_entry_write(int unit, int index,
                                         ext_l2_entry_entry_t *entry);
extern int soc_shadow_ext_l2_entry_read(int unit, int index,
                                        ext_l2_entry_entry_t **entry);
extern int soc_shadow_ext_l2_entry_search(int unit, sal_mac_addr_t mac,
                                          int module, int port,
                                          int include_static, int stop_on_hit,
