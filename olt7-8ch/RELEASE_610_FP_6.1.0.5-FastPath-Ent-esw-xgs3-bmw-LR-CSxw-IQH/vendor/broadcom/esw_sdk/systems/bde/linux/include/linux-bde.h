/***********************************************************************
 *
 * $Id: linux-bde.h,v 1.1 2011/04/18 17:11:09 mruas Exp $
...
/* max devices */
/* 16 switch chips + 2 out of bands ethernet */
...
/*
 * The user bde has a kernel module portion
 * which depends upon the real kernel bde 
 * to manage the device. 
 *
 * However, to virtualize interrupts correctly, 
 * the user bde has to do some goofy things with 
 * the actual IRQs, which are not
 * available through the bde interface. 
 *
 * The kernel bde provides some backdoors for
 * the user bde to accomplish this, 
 * declared here. 
 *
 */
extern int lkbde_get_irq(int d);
