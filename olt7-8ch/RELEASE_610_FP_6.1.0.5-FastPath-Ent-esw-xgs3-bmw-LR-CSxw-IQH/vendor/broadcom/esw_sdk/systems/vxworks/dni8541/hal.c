...
static int dni8541_upgrade_image(char *fname, unsigned int flags, 
...
static char * dni8541_flash_dev_name(void)
{
    return "no flash fs";
}

static int dni8541_format_flash(int format, unsigned int flags)
{
    return 0;
}

static int dni8541_arm_wdog(unsigned int usec)
{
    return 0;
}
...
static int dni8541_print_info(void)
{
    UINT32	tb, pci, cpu = 0;
    int         ramClk;
    int         factor;
...
static int dni8541_led_write_string(const char * s)
{
...
static platform_hal_t dni8541_hal_info = {
    .name                       = "dni8541",
    .caps                       = (PLATFORM_CAP_PCI | PLATFORM_CAP_FLASH_FS),
    .f_dump_info                = dni8541_print_info,
    .f_upgrade_image            = dni8541_upgrade_image,
    .f_flash_device_name        = dni8541_flash_dev_name,
    .f_format_fs                = dni8541_format_flash,
    .f_start_wdog               = dni8541_arm_wdog,
    .f_led_write_string         = dni8541_led_write_string
};
...
int platform_attach(platform_hal_t **platform_info)
{
    ...
    *platform_info = &dni8541_hal_info;
    return 0;
}
