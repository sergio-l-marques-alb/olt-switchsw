...
static int gtx_upgrade_image(char *fname, unsigned int flags, 
...
static char * gtx_flash_dev_name(void)
{
    return FLASH_FS_NAME;
}

static int gtx_format_flash(int format, unsigned int flags)
{
    int	rv = 0;
...
static int gtx_led_write_string(const char * s)
{
    NSX_LED_REG(0) = s[3];
    NSX_LED_REG(1) = s[2];
    NSX_LED_REG(2) = s[1];
...
static platform_hal_t gtx_hal_info = {
    "GTX",                                         /* name */
    0,                                             /* flags */
    ...
    0,                                             /* bus_caps */
    NULL,                                          /* f_dump_info */
    gtx_upgrade_image,                             /* f_upgrade_image */
    gtx_flash_dev_name,                            /* f_flash_device_name */
    gtx_format_flash,                              /* f_format_fs */
    ...
    NULL,                                          /* f_start_wdog */
    NULL,                                          /* f_reboot */
    gtx_led_write_string                           /* f_led_write_string */
};
