...
#if defined(CONFIG_SBC82xx) || defined(CONFIG_UNICOM_V1) || defined(CONFIG_BROUTER8) || defined(CONFIG_PQ2_PTIN)
#define F1_RXCLK	9
#define F1_TXCLK	10
...
#endif
#if defined(CONFIG_PQ2_PTIN) || defined(CONFIG_BROUTER8)
    fcc_restart(dev,1);
#endif
	if (cep->tx_free)
						...
						volatile cpm2_map_t *immap)
{
	 ...
	 * this area.
	 */
	mem_addr = cpm_dpalloc(/*size*/128,/*align*/32);/*  CPM_FCC_SPECIAL_BASE + (fip->fc_fccnum * 128); */
...
#else
#if !(defined(CONFIG_RPX8260) || defined(CONFIG_BROUTER8) || defined(CONFIG_PQ2_PTIN))
		if (i == 3) {
...
#if defined(CONFIG_USE_MDIO) || defined(CONFIG_TQM8260) || defined(CONFIG_PQ2_PTIN) || defined(CONFIG_BROUTER8)
