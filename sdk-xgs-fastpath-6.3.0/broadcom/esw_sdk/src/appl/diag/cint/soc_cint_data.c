/*
 * $Id: soc_cint_data.c 1.45.2.4 Broadcom SDK $
 *
...
#include <soc/drv.h>
#include <soc/intr.h>
#if defined(BCM_ARAD_SUPPORT) && defined(INCLUDE_KBP) && !defined(BCM_88030_A0)
...
__cint_maddr__soc_c3_rce_action_uc_desc_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    case 1: return &(s->enableIndex);
    case 2: return &(s->disableVal);
    case 3: return &(s->loc);
    default: return NULL;
    }
}
...
__cint_maddr__soc_c3_rce_unit_desc_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    case 1: return &(s->rangeMaxCount);
    case 2: return &(s->groupMaxCount);
    case 3: return &(s->entryMaxCount);
    case 4: return &(s->rangesInUse);
    case 5: return &(s->groupsInUse);
...
__cint_maddr__soc_c3_rce_program_desc_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    case 4: return &(s->actFieldCount);
    case 5: return &(s->keyFields);
    case 6: return &(s->actFields);
    case 7: return &(s->entriesInUse);
    case 8: return &(s->groupsInUse);
    default: return NULL;
    }
}
...
__cint_maddr__soc_c3_rce_group_desc_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    case 5: return &(s->qualCount);
    case 6: return &(s->qualData);
    case 7: return &(s->entriesInUse);
    default: return NULL;
    }
}
                                 ...
                                 )
{
    ...
    soc_sand_rc = arad_pp_ihb_tcam_tbl_read_unsafe(device_id, bank_ndx, nof_entries_in_line, entry_offset, data);
                                  ...
                                  )
{
    ...
    soc_sand_rc = arad_pp_ihb_tcam_tbl_write_unsafe(device_id, bank_ndx, nof_entries_in_line, entry_offset, data);
    if(SOC_SAND_FAILURE(soc_sand_rc)){
        return -1;
    }
    return 0;
                                    ...
                                    )
{
    ...
    soc_sand_rc = arad_pp_ihb_tcam_tbl_compare_unsafe(device_id, bank_ndx, nof_entries_in_line, compare_data, found_data);
    if(SOC_SAND_FAILURE(soc_sand_rc)){
        return -1;
    }
    return 0;
...
static cint_constants_t __cint_soc_constants[] =
{
    ...
    { "SOC_C3_RCE_DUMP_PROGRAM_INCLUDE_ACTION", SOC_C3_RCE_DUMP_PROGRAM_INCLUDE_ACTION },
    ...
    { "SOC_C3_RCE_DUMP_PROGRAM_INCLUDE_GROUPS", SOC_C3_RCE_DUMP_PROGRAM_INCLUDE_GROUPS },
    ...
    { "SOC_C3_RCE_DUMP_GROUP_INCLUDE_ENTRIES", SOC_C3_RCE_DUMP_GROUP_INCLUDE_ENTRIES },
