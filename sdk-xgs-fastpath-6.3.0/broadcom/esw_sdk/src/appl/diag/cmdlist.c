/*
 * $Id: cmdlist.c 1.330.10.3 Broadcom SDK $
...
#endif
#ifdef BCM_CMICM_SUPPORT
    {"CmicmINTR",       cmd_cmicm_intr,         cmd_cmicm_intr_usage,   "Enable, disable, show interrupts" },
#endif
...
/*  ------------+---------------------------+---------------------+---------------------------------------------------- */
    ...
    {"PrefixSearch", cmd_sbx_caladan3_prefix_search, cmd_sbx_caladan3_prefix_search_usage, "Search a specific prefix"},
#endif
