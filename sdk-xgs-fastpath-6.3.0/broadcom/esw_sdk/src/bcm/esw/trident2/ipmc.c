...
/*
 * Function:
 *      bcm_td2_ipmc_required_scache_size_get
 * Purpose:
...
/*
 * Function:
 *      bcm_td2_ipmc_scache_recover
 * Purpose:
 *      Recover info from scache.
 * Parameters:
 ...
 */
int
bcm_td2_ipmc_scache_recover(int unit, uint8 **scache_ptr) 
{
    int num_rp, i;
    SHR_BITDCL *rp_bitmap = NULL;
