 ...
 * Function Vectors
 */
static _esw_bfd_drv_t _bcm_kt_bfd_drv = {
    /* init                     */ _bcm_kt_bfd_init,
...
/* L2 Table */
static _bcm_xgs5_bfd_l2_table_t _bcm_kt_bfd_l2_table = {
    /* mem                */  L2Xm,
    /* key_type           */  KEY_TYPEf,
    /* bfd_key_type       */  0x4,
    /* valid              */  VALIDf,
...
static _bcm_xgs5_bfd_l3_ipv4_table_t _bcm_kt_bfd_l3_ipv4_table = {
...
static _bcm_xgs5_bfd_l3_ipv6_table_t _bcm_kt_bfd_l3_ipv6_table = {
...
/* L3 Tunnel Table */
static _bcm_xgs5_bfd_l3_tunnel_table_t _bcm_kt_bfd_l3_tunnel_table = {
    /* mem                */ L3_TUNNELm,
    /* bfd_enable         */ BFD_ENABLEf,
};

/* MPLS Table */
static _bcm_xgs5_bfd_mpls_table_t _bcm_kt_bfd_mpls_table = {
    /* mem                */ MPLS_ENTRYm,
    /* valid              */ VALIDf,
    /* key_type           */ KEY_TYPEf,
    /* key_type_value     */ 0x0,
...
/* HW Definitions */
static _bcm_xgs5_bfd_hw_defs_t    _bcm_kt_bfd_hw_defs;
 ...
 */
int
_bcm_kt_bfd_init(int unit)
{

    /* HW Definition Tables */
    sal_memset(&_bcm_kt_bfd_hw_defs, 0, sizeof(_bcm_kt_bfd_hw_defs));
    _bcm_kt_bfd_hw_defs.l2        = &_bcm_kt_bfd_l2_table;
    _bcm_kt_bfd_hw_defs.l3_ipv4   = &_bcm_kt_bfd_l3_ipv4_table;
    _bcm_kt_bfd_hw_defs.l3_ipv6   = &_bcm_kt_bfd_l3_ipv6_table;
    _bcm_kt_bfd_hw_defs.l3_tunnel = &_bcm_kt_bfd_l3_tunnel_table;
    _bcm_kt_bfd_hw_defs.mpls      = &_bcm_kt_bfd_mpls_table;

    /* Initialize Common XGS5 BFD module */
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_init(unit, &_bcm_kt_bfd_drv, &_bcm_kt_bfd_hw_defs));
