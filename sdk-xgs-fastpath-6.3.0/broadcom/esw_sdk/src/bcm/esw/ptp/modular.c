/*
 * $Id: modular.c 1.1.18.1 Broadcom SDK $
 *
    ...
    int clock_num)
{
    ...
    if (BCM_FAILURE(rv = bcm_esw_ptp_sync_phy(unit, ptp_id, clock_num, physync_input))) {
        PTP_ERROR_FUNC("bcm_esw_ptp_sync_phy()");
        return rv;
    }
    ...
    uint64 ref_phase)
{
    ...
    if (BCM_FAILURE(rv = bcm_esw_port_phy_timesync_config_set(unit, port, &config))) {
        PTP_ERROR_FUNC("bcm_esw_port_phy_timesync_config_set()");
        return rv;
    }
    ...
    if (BCM_FAILURE(rv = bcm_esw_port_control_phy_timesync_set(unit, port,
            bcmPortControlPhyTimesyncLocalTime, localTime))) {
        PTP_ERROR_FUNC("bcm_esw_port_control_phy_timesync_set()");
        return rv;
    }
