                           ...
                           int tbl_idx, int offset)
{
    ...
    uint32    *single_chunk_usage_bmap;    /* Single chunk usage bmap */
    ...
    single_chunk_usage_bmap = &stage_fc->data_ctrl->single_chunk_usage_bmap;
#endif /* BCM_ENDURO_SUPPORT */
    ...
    for (idx = 0; idx <= _FP_DATA_DATA1_WORD_MAX; idx++) {
        ...
        if(SOC_IS_ENDURO(unit) || SOC_IS_HURRICANEX(unit)) {
            if ((0 == idx) && !((*usage_bmap) & (1 << 0x1)) &&
                ...
                *single_chunk_usage_bmap |= (0x1 << 2);
            } else if ((1 == idx) && (*single_chunk_usage_bmap & 0x3)) {
                /* 
