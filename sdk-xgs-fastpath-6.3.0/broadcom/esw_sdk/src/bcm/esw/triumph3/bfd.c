 ...
 * Function Vectors
 */
static _esw_bfd_drv_t _bcm_tr3_bfd_drv = {
    /* init                     */ _bcm_tr3_bfd_init,
    /* detach                   */ _bcm_xgs5_bfd_detach,
    /* endpoint_create          */ _bcm_xgs5_bfd_endpoint_create,
    /* endpoint_get             */ _bcm_xgs5_bfd_endpoint_get,
    /* endpoint_destroy         */ _bcm_xgs5_bfd_endpoint_destroy,
    /* endpoint_destroy_all     */ _bcm_xgs5_bfd_endpoint_destroy_all,
    /* endpoint_poll            */ _bcm_xgs5_bfd_endpoint_poll,
    /* event_register           */ _bcm_xgs5_bfd_event_register,
    /* event_unregister         */ _bcm_xgs5_bfd_event_unregister,
    /* endpoint_stat_get        */ _bcm_xgs5_bfd_endpoint_stat_get,
    /* auth_sha1_set            */ _bcm_xgs5_bfd_auth_sha1_set,
    /* auth_sha1_get            */ _bcm_xgs5_bfd_auth_sha1_get,
    /* auth_simple_password_set */ _bcm_xgs5_bfd_auth_simple_password_set,
    /* auth_simple_password_get */ _bcm_xgs5_bfd_auth_simple_password_get,
...
/* L2 Table */
static _bcm_xgs5_bfd_l2_table_t _bcm_tr3_bfd_l2_table = {
    /* mem                */ L2_ENTRY_1m,
    /* key_type           */ KEY_TYPEf,
...
static _bcm_xgs5_bfd_l3_ipv4_table_t _bcm_tr3_bfd_l3_ipv4_table = {
    /* mem                */ L3_ENTRY_1m,
...
static _bcm_xgs5_bfd_l3_ipv6_table_t _bcm_tr3_bfd_l3_ipv6_table = {
    /* mem                */ L3_ENTRY_2m,
...
/* L3 Tunnel Table */
static _bcm_xgs5_bfd_l3_tunnel_table_t _bcm_tr3_bfd_l3_tunnel_table = {
    /* mem                */ L3_TUNNELm,
    /* bfd_enable         */ IP__BFD_ENABLEf,
};

/* MPLS Table */
static _bcm_xgs5_bfd_mpls_table_t _bcm_tr3_bfd_mpls_table = {
    /* mem                */ MPLS_ENTRYm,
    /* valid              */ VALIDf,
    /* key_type           */ KEY_TYPEf,
    /* key_type_value     */ 16,
...
/* HW Definitions */
static _bcm_xgs5_bfd_hw_defs_t    _bcm_tr3_bfd_hw_defs;
 ...
 */
int
_bcm_tr3_bfd_init(int unit)
{

    /* HW Definition Tables */
    sal_memset(&_bcm_tr3_bfd_hw_defs, 0, sizeof(_bcm_tr3_bfd_hw_defs));
    _bcm_tr3_bfd_hw_defs.l2        = &_bcm_tr3_bfd_l2_table;
    _bcm_tr3_bfd_hw_defs.l3_ipv4   = &_bcm_tr3_bfd_l3_ipv4_table;
    _bcm_tr3_bfd_hw_defs.l3_ipv6   = &_bcm_tr3_bfd_l3_ipv6_table;
    _bcm_tr3_bfd_hw_defs.l3_tunnel = &_bcm_tr3_bfd_l3_tunnel_table;
    _bcm_tr3_bfd_hw_defs.mpls      = &_bcm_tr3_bfd_mpls_table;

    /* Initialize Common XGS5 BFD module */
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_bfd_init(unit, &_bcm_tr3_bfd_drv, &_bcm_tr3_bfd_hw_defs));

    return BCM_E_NONE;
}

#else   /* BCM_TRIUMPH3_SUPPORT && INCLUDE_BFD */
int _bcm_esw_tr3_bfd_not_empty;
