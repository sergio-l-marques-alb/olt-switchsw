/*
 * $Id: cosq.c 1.98.8.2 Broadcom SDK $
                                 ...
                                 int average_time)
{
    ...
    discard.flags = color | BCM_COSQ_DISCARD_ENABLE;
    ...
    BCM_IF_ERROR_RETURN(
        bcm_cosq_gport_discard_set(unit, port, cosq, &discard));
                                 ...
                                 int *average_time)
{
    ...
    BCM_IF_ERROR_RETURN(
        bcm_cosq_gport_discard_get(unit, port, cosq, &discard));
    ...
    bcm_cosq_gport_discard_t *discard)
{
    ...
    discard->flags = drv_config.flags;
