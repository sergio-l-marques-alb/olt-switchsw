/*
 * $Id: hash.c 1.6.24.1 Broadcom SDK $
                 ...
                 int key_nbits, void *base_entry, uint8 *key)
{
    ...
    if (use_lsb && (hash_offset + SOC_CONTROL(unit)->hash_bits_l3x > 48)) {
        ...
        case TD2_L3_HASH_KEY_TYPE_V6MC:
            ...
            break;
        case TD2_L3_HASH_KEY_TYPE_LMEP:
        case TD2_L3_HASH_KEY_TYPE_LMEP_SVID_CVID:
            return 0;
        case TD2_L3_HASH_KEY_TYPE_RMEP:
        case TD2_L3_HASH_KEY_TYPE_RMEP_SVID_CVID:
            return 0;
...
soc_hash_index_get(int unit, int mem, int bank, int bucket)
{
    ...
    case L2Xm:
        ...
        if (SOC_SUCCESS(rv)) {
            return bank_base + bank * entries_per_row + bucket_offset;
        }
        break;
    case L3_ENTRY_ONLYm:
    case L3_ENTRY_IPV4_UNICASTm:
