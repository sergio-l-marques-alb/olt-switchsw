/*
 * $Id: phy5464cdiag.c 1.5 Broadcom SDK $
...
l97,l98;int16 l84;int16 l99;l84 = 0x0000;l84|= l43(l13->l4,0x11,&l99);l99
...
0x05,&l94);if(l94&0x0020){l97 = ((l94>>1)&0x01);l95 = (l94>>
...
int16 l286[4],l287[4],l288;int32 l289[4],l47[4];int16 l80[4];int16 l73
...
l114];for(l40=0;l40<4;l40++){if((0x1<<(l40*4+l114))&
