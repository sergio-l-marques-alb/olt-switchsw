/*
 * $Id: phy84756_fcmap.c 1.38.6.1 Broadcom SDK $
 *
...
phy_84756_fcmap_an_set(int unit, soc_port_t port, int autoneg)
{
    ...
    SOC_IF_ERROR_RETURN
        (BFCMAP_MOD_PHY84756_LN_DEV7_AN_MSIC2r(pc, autoneg ? 0x0 : 0x20, 0x20));
...
_phy_84756_control_dump(int unit, soc_port_t port)
{
    ...
    soc_cm_print("Port %d: mode=%s, MACSEC support=%s\n", 
                 port, _phy_84756_mode_name_get(unit, port),
