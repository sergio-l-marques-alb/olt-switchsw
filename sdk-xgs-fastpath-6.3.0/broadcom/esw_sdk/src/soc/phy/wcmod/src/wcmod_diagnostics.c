/*
 * $Id: wcmod_diagnostics.c 1.61 Broadcom SDK $
 *
...
int wcmod_diag_autoneg(wcmod_st *ws)
{
  ...
  if (data & XGXSBLK4_TOPANSTATUS1_CL37_AUTONEG_COMPLETE_MASK) {
    strcat(msg, "CL37 AN complete\n");
    ws->accData |= AUTONEG_DONE_MASK;
  } else if (data & XGXSBLK4_TOPANSTATUS1_CL73_AUTONEG_COMPLETE_MASK) {
