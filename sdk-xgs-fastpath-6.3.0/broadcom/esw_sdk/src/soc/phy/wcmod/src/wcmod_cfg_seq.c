/*
 * $Id: wcmod_cfg_seq.c 1.107 Broadcom SDK $
 *
...
int wcmod_tx_pi_control(wcmod_st* pc)
{
  ...
  val = ((cntl & 0xff) & XGXSBLK8_TX_PI_CONTROL2_TX_PI_RX_LANE_SEL_MASK) <<
          XGXSBLK8_TX_PI_CONTROL2_TX_PI_RX_LANE_SEL_SHIFT;
  if (cntl & 0x01000000) {
    MODIFY_WC40_XGXSBLK8_TX_PI_CONTROL2r(pc->unit, pc, val,
                                XGXSBLK8_TX_PI_CONTROL2_TX_PI_RX_LANE_SEL_MASK);
    MODIFY_WC40_XGXSBLK8_TX_PI_CONTROL1r(pc->unit, pc,
                            (XGXSBLK8_TX_PI_CONTROL1_TX_PI_EN_BITS
                               << XGXSBLK8_TX_PI_CONTROL1_TX_PI_EN_SHIFT),
                            XGXSBLK8_TX_PI_CONTROL1_TX_PI_EN_MASK);
  } else {
    MODIFY_WC40_XGXSBLK8_TX_PI_CONTROL1r(pc->unit, pc,
         (XGXSBLK8_TX_PI_CONTROL1_TX_PI_EN_ALIGN
           << XGXSBLK8_TX_PI_CONTROL1_TX_PI_EN_SHIFT),
          XGXSBLK8_TX_PI_CONTROL1_TX_PI_EN_MASK);
  }
  return SOC_E_NONE;
