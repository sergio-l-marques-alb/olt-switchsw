/*
 * $Id: triumph2.h 1.90 Broadcom SDK $
...
extern int bcm_tr2_l3_ecmp_defragment_no_lock(int unit);
...
extern int _bcm_tr2_l3_ecmp_grp_add(int unit, int ecmp_grp, void *buf, int max_paths);
...
extern int bcm_tr2_update_vlan_pbmp(int unit, bcm_vlan_t vlan,
        bcm_pbmp_t *pbmp);
...
extern int _bcm_esw_flex_stat_enable_set(int unit,
                         ...
                         _bcm_flex_stat_src_index_set_f fs_set_cb,
                                         ...
                                         int enable,
                                         int cnt_inx);
extern int _bcm_esw_flex_stat_ext_get(int unit, 
                                  _bcm_flex_stat_type_t type,
                                  _bcm_flex_stat_handle_t handle, 
...
extern int _bcm_esw_flex_stat_get(int unit, 
                                  ...
                                  _bcm_flex_stat_t stat, 
                                  uint64 *val);
extern int _bcm_esw_flex_stat_ext_get32(int unit, 
                                    _bcm_flex_stat_type_t type,
                                    _bcm_flex_stat_handle_t handle, 
                                    _bcm_flex_stat_t stat, 
                                    uint32 *val);
...
extern int _bcm_field_tr2_stat_hw_mode_to_bmap(int unit, uint8 mode,
