 ...
 *
 * $Id: async.h 1.668.2.4 Broadcom SDK $
...
void	bcm_fcoe_control_vsan_get_async(int unit, uint32 vsan_id, bcm_fcoe_vsan_control_t type, int * arg, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_fcoe_control_vsan_set_async(int unit, uint32 vsan_id, bcm_fcoe_vsan_control_t type, int arg, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_fcoe_route_delete_all_async(int unit, bcm_fcoe_route_t * route, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_fcoe_vsan_get_async(int unit, uint32 vsan_id, bcm_fcoe_vsan_t * vsan, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_fcoe_vsan_set_async(int unit, uint32 vsan_id, bcm_fcoe_vsan_t * vsan, bcm_async_cb_t async_callback, void *async_cookie);
