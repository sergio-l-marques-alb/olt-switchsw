/*
 * $Id: property.h 1.625.2.3 Broadcom SDK $
 ...
 * Range: 0 - 0xFFFFFFFF
 */
#define spn_DRAM_CRC_DEL_BUFFER_FIFO_DEPTH  "dram_crc_del_buffer_fifo_depth"
/*
 * If set, DRAM interface swap its HW PIN pairs during init. Note: Only one of DRAMs can have its PIN swapped.
 * Valid values: FALSE/TRUE
 */
...
#define spn_EXT_IPV4_UC_RPF_ACL_RESULT_SIZE  "ext_ipv4_uc_rpf_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_IPV4_UC_ACL_RESULT_SIZE  "ext_ipv4_uc_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_IPV4_MC_ACL_RESULT_SIZE  "ext_ipv4_mc_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_IPV6_UC_RPF_ACL_RESULT_SIZE  "ext_ipv6_uc_rpf_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_IPV6_UC_ACL_RESULT_SIZE  "ext_ipv6_uc_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_IPV6_MC_ACL_RESULT_SIZE  "ext_ipv6_mc_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_MPLS_ACL_RESULT_SIZE  "ext_mpls_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_EXTENDED_P2P_VLAN_ACL_RESULT_SIZE  "ext_extended_p2p_vlan_acl_result_size"

/* Result size of the External lookups. Unit: bytes. */
#define spn_EXT_L2_ACL_RESULT_SIZE  "ext_l2_acl_result_size"
/*
 ...
 *  is disabled. In BCM 88650 number of global VRRP My-MAC-MSB will be decreased by one
 */
