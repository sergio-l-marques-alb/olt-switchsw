/*
 * $Id: feature.h 1.512.10.3 Broadcom SDK $
...
SHR_G_ENTRY(P, field_stage_half_slice), /* Ingress FP tables with holes. */ \
SHR_G_ENTRY(P, field_slice_size128),/* Ingress FP tables with holes in wolfhound. */ \
...
SHR_G_ENTRY(P, tr3_cmic_reserved_queues), /* CMIC has reserved queues     */ \
SHR_G_ENTRY(P, td2_cmic_reserved_queues), /* CMIC has reserved queues     */ \
