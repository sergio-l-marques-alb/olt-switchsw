...
enum_mapping_t portmod_txdrv_inxs_t_mapping[] = {
    {"portmod_TXDRV_XFI_INX", portmod_TXDRV_XFI_INX},
    {"portmod_TXDRV_XLAUI_INX", portmod_TXDRV_XLAUI_INX},
    {"portmod_TXDRV_SFI_INX", portmod_TXDRV_SFI_INX},
    {"portmod_TXDRV_SFIDAC_INX", portmod_TXDRV_SFIDAC_INX},
    {"portmod_TXDRV_SR4_INX", portmod_TXDRV_SR4_INX},
    {"portmod_TXDRV_AN_INX", portmod_TXDRV_AN_INX},
    {"portmod_TXDRV_DFT_INX", portmod_TXDRV_DFT_INX},
    {NULL, 0}
};
