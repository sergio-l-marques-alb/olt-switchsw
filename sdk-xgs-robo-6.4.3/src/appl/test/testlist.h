...
extern int tomahawk_mbist_pattern0(int unit, int *error_count);
extern int tomahawk_mbist_pattern1(int unit, int *error_count);
extern int tomahawk_mbist_pattern2(int unit, int *error_count);
extern int tomahawk_mbist_pattern3(int unit, int *error_count);
