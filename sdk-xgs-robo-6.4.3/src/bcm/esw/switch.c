                     ...
                     hash_offset_info_t *info)
{
     ...
     *
     * For td2p, the index is got from PORT_TAB.RTAG7_PORT_PROFILE_INDEX.
     *
...
defined(BCM_TRIDENT_SUPPORT)
    ...
    { bcmSwitchNonEtagDropToCpu, TR3 | HX4 | TD2 | TD2P | TH,
        CPU_CONTROL_0r, DISCARD_VNTAG_NOT_PRESENT_TOCPUf,
        NULL, soc_feature_port_extension},
    { bcmSwitchMplsGalAlertLabelToCpu, TR3 | HX4 | TD2 | TD2P | TH,
        CPU_CONTROL_Mr, MPLS_GAL_EXPOSED_TO_CPUf,
        NULL, 0},
    { bcmSwitchMplsRalAlertLabelToCpu, TR3 | HX4 | TD2 | TD2P | TH,
        CPU_CONTROL_Mr, MPLS_RAL_EXPOSED_TO_CPUf,
        NULL, 0},
    { bcmSwitchMplsIllegalReservedLabelToCpu, TR3 | HX4 | TD2 | TD2P | TH,
