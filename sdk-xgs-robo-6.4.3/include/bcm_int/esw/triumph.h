...
extern int _bcm_tr_mpls_match_add(int unit, bcm_mpls_port_t *mpls_port, int vp, int vpn);
extern int _bcm_esw_mpls_match_delete(int unit, int vp);
extern int _bcm_esw_mpls_match_add(int unit, bcm_mpls_port_t *mpls_port, int vp, int vpn);
