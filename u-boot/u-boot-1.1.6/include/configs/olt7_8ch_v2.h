...
//#define CONFIG_BOOTARGS     "root=/dev/hda2 rw,noatime,nodiratime console=ttyCPM0,19200 devfs=nomount"
  #define CONFIG_BOOTARGS     "root=/dev/hda2 rw,noatime,nodiratime console=ttyCPM0,19200 devfs=nomount mem=112M"
 ...
 */
  ...
  #define CFG_PROMPT          "OLT7-8CH> "    /* Monitor Command Prompt   */
  #if (CONFIG_COMMANDS & CFG_CMD_KGDB)
...
//#undef CFG_OR9_PRELIM
//#undef CFG_BR9_PRELIM
