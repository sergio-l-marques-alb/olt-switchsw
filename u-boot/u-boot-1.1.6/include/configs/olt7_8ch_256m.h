 ...
 */
  ...
  #define CONFIG_PQ2PTIN             1  /* PT Inovacao PQ2PTIN board */
...
//#define CONFIG_BOOTARGS     "root=/dev/hda2 rw,noatime,nodiratime console=ttyCPM0,19200 devfs=nomount"
  #define CONFIG_BOOTARGS     "root=/dev/hda2 rw,noatime,nodiratime console=ttyCPM0,19200 devfs=nomount mem=245M"

  #define CONFIG_ETHADDR      00:06:91:01:01:01 // temporary
  #define CONFIG_IPADDR       192.168.1.10
  #define CONFIG_SERVERIP     192.168.1.53

  #define  CONFIG_SHOW_BOOT_PROGRESS 1    /* Show boot progress               */

  #define CONFIG_AUTOBOOT_KEYED           /* use key strings to stop autoboot */
  #define CONFIG_AUTOBOOT_STOP_STR   " "  /* Default. Can be overwritten by   */
/* environment var stopkey.         */
 ...
 */
  ...
  #define CFG_PROMPT          "OLT7-256M> "    /* Monitor Command Prompt   */
  #if (CONFIG_COMMANDS & CFG_CMD_KGDB)
...
//#define CFG_DEFAULT_IMMR  0x0F010000
  ...
  #define CFG_MEMTEST_START   (CFG_SDRAM_BASE+0x00100000)      /* memtest works on */
  #define CFG_MEMTEST_END     (CFG_SDRAM_BASE+0x00f00000)      /* 1 ... 15 MB in DRAM  */
  #define CFG_LOAD_ADDR       (CFG_SDRAM_BASE+0x00100000)      /* default load address */
...
// 256M
  //#define CFG_PSDMR_BASE        0x012db683
  //#define CFG_BR1_PRELIM        CFG_SDRAM_BASE | 0x00000041  //em 15/03/2007 by Celso Lemos para resolver o problema do IP
  //#define CFG_OR1_PRELIM        0xf0002510  /* 0xf8002510 256M */

  #define CFG_PSDMR_BASE        0x8431b683
  #define CFG_BR1_PRELIM        (CFG_SDRAM_BASE | 0x00000041)
  #define CFG_OR1_PRELIM        0xF0002910

//CS2 - PLD @0xFF500000, 8bit, no parity
...
//CS3
  #define CFG_OR3_PRELIM        0xfff01100
  #define CFG_BR3_PRELIM        0x500008c1
...
//CS5
  #define CFG_OR5_PRELIM        0xfff01100
  #define CFG_BR5_PRELIM        0x700008c1

//CS6
  #define CFG_OR6_PRELIM        0xfff01100
  #define CFG_BR6_PRELIM        0x100008c1

//CS7
  #define CFG_OR7_PRELIM        0xffff8ef4
  #define CFG_BR7_PRELIM        0x200008c1

//CS8
  #undef CFG_OR8_PRELIM         //0xffff8ef4 
  #undef CFG_BR8_PRELIM         //0x400008c1 

//CS9
  #undef CFG_OR9_PRELIM         //0xffff1100 
  #undef CFG_BR9_PRELIM         //0x101008c1 
...
//#define CFG_HRCW_MASTER       0x04620740 //Alterado por Licinio de 0x04620343 --> 0x04620740, para activar o modo PCI
  #define CFG_HRCW_MASTER       0x04660740 //Alterado por Licinio de 0x04620343 --> 0x04620740, para activar o modo PCI
...
/* PCI Memory map (if different from default map */
  ...
  #define CFG_PICMR0_MASK_ATTRIB   (PICMR_MASK_512MB | PICMR_ENABLE | PICMR_PREFETCH_EN)
