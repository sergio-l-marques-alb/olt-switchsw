...
int tefmod_init_pcs_ilkn(PHYMOD_ST* pc)              /* INIT_PCS_ILKN */
{
  ...
  /*SC_X4_BYPASSr_t reg_sc_bypass;     wniu commented out
...
int tefmod_autoneg_set(PHYMOD_ST* pc, tefmod_an_adv_ability_t *cl73_adv)
{
  ...
  if (model == 0x15) {
    ...
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_KR1 ) & 1) {
        ...
        AN_X4_LD_BASE_ABIL_3_GEN2r_BASE_25G_KR1_SELf_SET(AN_X4_LD_BASE_ABIL_3_GEN2r_reg, 9);
    }     
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_CR1 ) & 1) {
        ...
        /* IEEE bit location for KR1/Cr1 is 9 */ 
        AN_X4_LD_BASE_ABIL_3_GEN2r_BASE_25G_CR1_SELf_SET(AN_X4_LD_BASE_ABIL_3_GEN2r_reg, 9);
    }     
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_KRS1 ) & 1) {
        ...
        AN_X4_LD_BASE_ABIL_4_GEN2r_BASE_25G_KRS1_SELf_SET(AN_X4_LD_BASE_ABIL_4_GEN2r_reg, 10);
    }     
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_CRS1 ) & 1) {
        ...
        AN_X4_LD_BASE_ABIL_4_GEN2r_BASE_25G_CRS1_SELf_SET(AN_X4_LD_BASE_ABIL_4_GEN2r_reg, 10);
    }     
    MODIFY_AN_X4_LD_BASE_ABIL_3_GEN2r(pc, AN_X4_LD_BASE_ABIL_3_GEN2r_reg);
    MODIFY_AN_X4_LD_BASE_ABIL_4_GEN2r(pc, AN_X4_LD_BASE_ABIL_4_GEN2r_reg);
    ...
    MODIFY_AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r(pc, AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_reg);
  }    
  ...
  if(cl73_adv->an_base_speed & 1 << TEFMOD_CL73_1GBASE_KX) {
      ...
      if(plldiv_r_val<=4) {  /* pll_div <= 132; for 156MHz only */
          ...
          MODIFY_MAIN0_SETUPr(pc, reg_setup);
      } else {
  ...
  /*next we decode which vco to use for the AN based on the advertized speed */
  if ((cl73_adv->an_bam_speed1 & 1 << TEFMOD_CL73_BAM_25GBASE_KR1) ||
      (cl73_adv->an_bam_speed1 & 1 << TEFMOD_CL73_BAM_25GBASE_CR1) ||
      (cl73_adv->an_bam_speed & 1 << TEFMOD_CL73_BAM_50GBASE_KR2) ||
      (cl73_adv->an_bam_speed & 1 << TEFMOD_CL73_BAM_50GBASE_CR2)) {
      MAIN0_SETUPr_CL73_VCOf_SET(reg_setup, 1);
      MODIFY_MAIN0_SETUPr(pc, reg_setup); 
  }

  if ((cl73_adv->an_bam_speed1 & 1 << TEFMOD_CL73_BAM_20GBASE_KR1) ||
      (cl73_adv->an_bam_speed1 & 1 << TEFMOD_CL73_BAM_20GBASE_CR1) ||
      (cl73_adv->an_bam_speed & 1 << TEFMOD_CL73_BAM_40GBASE_KR2) ||     
      (cl73_adv->an_bam_speed & 1 << TEFMOD_CL73_BAM_40GBASE_CR2) ||
      (cl73_adv->an_bam_speed & 1 << TEFMOD_CL73_BAM_20GBASE_KR2) ||     
      (cl73_adv->an_bam_speed & 1 << TEFMOD_CL73_BAM_20GBASE_CR2) ||
      (cl73_adv->an_base_speed & 1 << TEFMOD_CL73_10GBASE_KR1)) {
      MAIN0_SETUPr_CL73_VCOf_SET(reg_setup, 0);
      MODIFY_MAIN0_SETUPr(pc, reg_setup); 
  }
...
int tefmod_set_an_single_port_mode(PHYMOD_ST* pc, int an_enable)    /* SET_AN_PORT_MODE */
{
 /* uint16_t rdata; */
  ...
  return PHYMOD_E_NONE;
} /* tefmod_set_an_single_port_mode(PHYMOD_ST* pc, int num_of_lanes, int starting_lane, int single_port) */
