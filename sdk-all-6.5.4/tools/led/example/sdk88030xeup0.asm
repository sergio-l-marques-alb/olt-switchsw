; $Id: sdk88030xeup0.asm,v 1.1 Broadcom SDK $
...
;
;
; This is a sample LED program for the BCM88030 12 10G reference system: LEDProc0
;
; In 12 10G+LEDProc0:
; There are 24 LEDs for 12 GE  ports, one for link and one for link&activity
...
;     Bit (1):  Link + Activity 
;
; Total bits for ports = 2 bit for 12 ports  = 24 bits.
;
;
