...
STATIC
 ...
 {
    /* normal:If FifosDepthType has an illegal size do hard_reset nIf there are more than 10 legal occurrences of overflow per second do a hard_reset nNote nFifo depth size rules n Minimal size of 8 in a used pipe n Total size of all pipes per type smaller or equal to 384 n Size must be dividable by 4 */
...
{
    /* auto generated code . manually interrupt register should be done after */
