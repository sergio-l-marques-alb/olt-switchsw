...
void jer_kaps_sw_init(int unit)
{
    ...
    for(search_idx = 0; search_idx < JER_KAPS_NOF_SEARCHES; search_idx++) 
    {
         ...
         */
        jer_kaps_search_config_info[unit][search_idx].max_tables_num = SOC_IS_QAX(unit) ? jer_kaps_search_config_info[unit][search_idx].valid_tables_num : JER_KAPS_MAX_NUM_OF_PARALLEL_SEARCHES;
    }
