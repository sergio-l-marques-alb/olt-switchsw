...
soc_dpp_wb_engine_init_tables(int unit, int buffer_id)
{
     ...
     */
        ...
        {
             SOC_DPP_WB_ENGINE_ADD_ARR(SOC_DPP_WB_ENGINE_VAR_JER_LOCAL_OUTLIF_FAILOVER_LINK_LIST_DB,
                "Outlif Failover-id Link lists DB",
                SOC_DPP_WB_ENGINE_BUFFER_JER_LOCAL_OUTLIF_SW_DB,
                sizeof(failover_free_lif_linked_list_t),
                 _BCM_DPP_AM_LOCAL_LIF_NOF_FAILOVER_IDS,
                VERSION(1));
