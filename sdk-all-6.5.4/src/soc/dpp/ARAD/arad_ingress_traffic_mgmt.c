...
/* Until QAX there is an ASIC bug that the granularity is actually 4096 rather than 2048 like stated in reg spec */
  ...
  )
{
  ...
  if (hw_q_type == ARAD_SW_DB_QUEUE_TYPE_NOT_AVAILABLE) {
      ...
      if (!SOC_IS_ARADPLUS_AND_BELOW(unit) && !SOC_IS_QUX(unit)) {
