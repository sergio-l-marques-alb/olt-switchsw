...
static 
   uint32  /* action name, hw-id, size*/
       Qax_pmf_fem_action_type_encoding[SOC_PPC_NOF_FP_ACTION_TYPES][NUM_ACTION_ELEMENTS] = {
           ...
           {SOC_PPC_FP_ACTION_TYPE_USER_HEADER_3            ,59 , 32       }, 
           {SOC_PPC_FP_ACTION_TYPE_USER_HEADER_4            ,60 , 32       }, 
           {SOC_PPC_FP_ACTION_TYPE_USER_HEADER_1_TYPE       ,61 , 2        }, 
           {SOC_PPC_FP_ACTION_TYPE_USER_HEADER_2_TYPE       ,62 , 2        }, 
           {SOC_PPC_FP_ACTION_TYPE_USER_HEADER_3_TYPE       ,63 , 2        }, 
           {SOC_PPC_FP_ACTION_TYPE_USER_HEADER_4_TYPE       ,64 , 2        }, 

           {SOC_PPC_FP_ACTION_TYPE_IN_LIF_PROFILE           ,65,  4        },
           {SOC_PPC_FP_ACTION_TYPE_IN_RIF_PROFILE           ,66,  4        },
           {SOC_PPC_FP_ACTION_TYPE_NATIVE_VSI               ,67,  1+15     },
           {SOC_PPC_FP_ACTION_TYPE_ITPP_DELTA               ,69 , 8+1      }, /* +1 is for valid bit */
           {SOC_PPC_FP_ACTION_TYPE_STATISTICS_POINTER_0     ,70 , 21       }, 
           {SOC_PPC_FP_ACTION_TYPE_STATISTICS_POINTER_1     ,71 , 21       }, 
           {SOC_PPC_FP_ACTION_TYPE_ADMIT_PROFILE            ,72 , 3        }, 
           {SOC_PPC_FP_ACTION_TYPE_LATENCY_FLOW_ID          ,73 , 19       }, 
           {SOC_PPC_FP_ACTION_TYPE_PPH_RESERVE_VALUE        ,74 , 2+1      }, /* +1 is for valid bit */
           {SOC_PPC_FP_ACTION_TYPE_PEM_CONTEXT              ,75 , 0        }, 
           {SOC_PPC_FP_ACTION_TYPE_PEM_GENERAL_DATA_0       ,76 , 0        }, 
           {SOC_PPC_FP_ACTION_TYPE_PEM_GENERAL_DATA_1       ,77 , 0        }, 


           {SOC_PPC_FP_ACTION_TYPE_TRAP_REDUCED             ,6 ,  8+3      }, /* Trap strength + Trap code No Trap qualifier */
           {SOC_PPC_FP_ACTION_TYPE_INVALID_NEXT             ,126,  0        }, /* Not in use */
