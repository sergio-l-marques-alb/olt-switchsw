  ...
  )
{
  ...
  *ret_val = SOC_PPC_DIAG_OK;
  ...
  dpp_dsig_read(unit, core_id, "IRPP", "TT", "FLP", "Packet_Format_Code", &tmp, 1);
  ...
  )
{
  ...
  *ret_val = SOC_PPC_DIAG_OK;
  ...
  else if (frwrd_info->frwrd_type == SOC_PPC_DIAG_FWD_LKUP_TYPE_IPV6_MC)
  {
    ...
    /* dpp_dsig_read(unit, core_id, "IRPP", "FLP", "TCAM", "Key", regs_val, 5); */
    ARAD_PP_DIAG_FLD_READ(&fld,core_id,ARAD_IHB_ID,15,1,235,76,5);
    res = soc_sand_bitstream_get_any_field(regs_val,0,120,frwrd_info->lkup_key.ipv6_mc.group.ipv6_address.address);
  ...
  if (diag_flavor & SOC_PPC_DIAG_FLAVOR_RAW)
  {
      dpp_dsig_read(unit, core_id, "IRPP", "LEM", "LL", "LEM_Result", frwrd_info->lkup_res.raw, 2);
      if (SOC_IS_JERICHO(unit)) {
  ...
  )
{
  ...
  *ret_val = SOC_PPC_DIAG_OK;                                                           
  ...
  if (tmp)
  {
    ...
    dpp_dsig_read(unit, core_id, "IRPP", "LBP", NULL, "TM_Cmd.Counter_B_Ptr", &pkt_tm_info->counter1, 1);
  }
  /*COUNTER2*/
  ...
  if (tmp)
  {
    ...
    dpp_dsig_read(unit, core_id, "IRPP", "LBP", NULL, "TM_Cmd.Counter_A_Ptr", &pkt_tm_info->counter2, 1);
  }
  ...
  )
{
  ...
  *ret_val = SOC_PPC_DIAG_OK;                                                           
  ...
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_0_Valid", regs_val, 1); */
  if (SOC_IS_QAX(unit)) {
  ...
  if (tmp)
  {
    ...
    /* Command (4) */
    tmp = 0;
    /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_0", %tmp, 1); */
  ...
  /* dpp_dsig_read(unit, core_id, "ETPP", "LL Editor", NULL, "FHEI_Code", &tmp, 1); */
  if (SOC_IS_QAX(unit)) {
  ...
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "FHEI_Code", &tmp2, 1); */
  if (SOC_IS_JERICHO(unit)) {
  ...
  if (tmp == 1 && tmp2 == 5) {
      ...
      /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "FHEI", regs_val, 1); */
      if (SOC_IS_JERICHO(unit)) {
      ...
      /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "FHEI", regs_val, 2); */
      if (SOC_IS_JERICHO(unit)) {
  ...
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_1", regs_val, 5); */
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_1_Valid", &tmp, 1); */
  if (SOC_IS_QAX(unit)) {
  ...
  /* Modify to adjust to separate action - valid concept */
  res = arad_pp_diag_encap_info_decode_ees_action(unit, encap_info, regs_val);
  SOC_SAND_CHECK_FUNC_RESULT(res, 101, exit);


  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_2", regs_val, 5); */
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_2_Valid", &tmp, 1); */
  if (SOC_IS_QAX(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,core_id,ARAD_EPNI_ID,4,2,255,228,5);
  } else if (SOC_IS_JERICHO(unit)) {
  ...
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_3", regs_val, 5); */
  /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_3_Valid", &tmp, 1); */
  if (SOC_IS_QAX(unit)) {
      ARAD_PP_DIAG_FLD_READ(&fld,core_id,ARAD_EPNI_ID,4,2,227,96,5);
  } else if (SOC_IS_JERICHO(unit)) {
  ...
  if (SOC_IS_QAX(unit)) {
      /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_4", regs_val, 5); */
      /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_4_Valid", &tmp, 1); */
      ARAD_PP_DIAG_FLD_READ(&fld,core_id,ARAD_EPNI_ID,4,1,255,220,5);

      res = arad_pp_diag_encap_info_decode_ees_action(unit, encap_info, regs_val);
      SOC_SAND_CHECK_FUNC_RESULT(res, 104, exit);

      /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_5", regs_val, 5); */
      /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", NULL, "EES_Action_6_Valid", &tmp, 1); */
      ARAD_PP_DIAG_FLD_READ(&fld,core_id,ARAD_EPNI_ID,4,1,219,88,5);
  ...
  if (cur_eep_type != ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_AC) {
    ...
    if (tmp) {
      ...
      /* Take from Port default */
        /* dpp_dsig_read(unit, core_id, "ETPP", "Preprocessor", "LL", "Default_SEM_Result", &encap_info->out_ac, 1); */
        if (SOC_IS_JERICHO(unit)) {
...
uint32
  arad_pp_diag_prge_first_instr_get(int unit, int core_id, uint32 *first_instruction) {
    ...
    /* dpp_dsig_read(unit, core_id, "PRGE", NULL, "PRGE_Instruction_1_Index", first_instruction, 1); */
