...
_phy_82381_init_pass1(int unit, soc_port_t port)
{
    ...
    if (DEVID(pc) == FURIA_ID_82071) { 
        ...
        sal_strncpy (dev_name, "BCM82071", sal_strlen("BCM82071"));
    } else if (DEVID(pc) == FURIA_ID_82070) { 
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82070", sal_strlen("BCM82070"));
    } else if (DEVID(pc) == FURIA_ID_82073) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82073", sal_strlen("BCM82073"));
    } else if (DEVID(pc) == FURIA_ID_82072) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82072", sal_strlen("BCM82072"));
    } else if (DEVID(pc) == FURIA_ID_82380) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82380", sal_strlen("BCM82380"));
    } else if (DEVID(pc) == FURIA_ID_82381) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82381", sal_strlen("BCM82381"));
    } else if (DEVID(pc) == FURIA_ID_82208) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82208", sal_strlen("BCM82208"));
    } else if (DEVID(pc) == FURIA_ID_82209) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82209", sal_strlen("BCM82209"));
    } else if (DEVID(pc) == FURIA_ID_82212) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82212", sal_strlen("BCM82212"));
    } else if (DEVID(pc) == FURIA_ID_82216) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82216", sal_strlen("BCM82216"));
    } else if (DEVID(pc) == FURIA_ID_82314) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82314", sal_strlen("BCM82314"));
    } else if (DEVID(pc) == FURIA_ID_82315) {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "BCM82315", sal_strlen("BCM82315"));
    } else {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "Furia", sal_strlen("Furia"));
    }
