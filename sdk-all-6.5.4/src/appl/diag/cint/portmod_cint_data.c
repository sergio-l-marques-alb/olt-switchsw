...
__cint_maddr__portmod_default_user_access_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 2: rv = &(s->is_legacy_phy_present);break;
        case 3: rv = &(s->cmd_for_phy);break;
        case 4: rv = &(s->blk_id);break;
        case 5: rv = &(s->mutex);break;
...
__cint_maddr__portmod_port_init_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 9: rv = &(s->sgmii_mstr);break;
        case 10: rv = &(s->serdes_driver_current);break;
        case 11: rv = &(s->serdes_1000x_at_6250_vco);break;
        case 12: rv = &(s->pll_divider_req);break;
        case 13: rv = &(s->rxaui_mode);break;
        case 14: rv = &(s->port_fallback_lane);break;
        case 15: rv = &(s->tx_params_user_flag);break;
        case 16: rv = &(s->tx_params);break;
        case 17: rv = &(s->an_cl37);break;
        case 18: rv = &(s->cl37_sgmii_war);break;
        case 19: rv = &(s->cl37_sgmii_cnt);break;
        case 20: rv = &(s->cl37_sgmii_RESTART_CNT);break;
        case 21: rv = &(s->an_cl73);break;
        case 22: rv = &(s->is_hg);break;
        case 23: rv = &(s->ext_phy_tx_params_user_flag);break;
        case 24: rv = &(s->ext_phy_tx_params);break;
        case 25: rv = &(s->polarity);break;
        case 26: rv = &(s->polarity_overwrite);break;
        case 27: rv = &(s->lane_map);break;
        case 28: rv = &(s->lane_map_overwrite);break;
        case 29: rv = &(s->fw_load_method);break;
        case 30: rv = &(s->fw_load_method_overwrite);break;
        case 31: rv = &(s->ref_clk);break;
        case 32: rv = &(s->ref_clk_overwrite);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__portmod_port_add_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 12: rv = &(s->ilkn_burst_short);break;
        case 13: rv = &(s->ilkn_metaframe_period);break;
        case 14: rv = &(s->rx_retransmit);break;
        case 15: rv = &(s->tx_retransmit);break;
        case 16: rv = &(s->phy_op_mode);break;
        case 17: rv = &(s->phy_op_datapath);break;
        case 18: rv = &(s->ilkn_inb_cal_len_rx);break;
        case 19: rv = &(s->ilkn_inb_cal_len_tx);break;
        case 20: rv = &(s->ilkn_oob_cal_len_rx);break;
        case 21: rv = &(s->ilkn_oob_cal_len_tx);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static cint_constants_t __cint_constants[] =
{
    ...
    { "PORTMOD_PORT_ADD_F_ILKN_TAKE_4_SEGMENTS", PORTMOD_PORT_ADD_F_ILKN_TAKE_4_SEGMENTS },
