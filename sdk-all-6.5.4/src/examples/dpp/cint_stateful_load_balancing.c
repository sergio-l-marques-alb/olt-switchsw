 ...
 */
int slb_two_keys_sip(const int unit , int bcm_hash_config) 
{
	int result;
	...
	result = slb_field_group_hash_two_keys(unit, hash_dq_qualifier, hash_dq_length, hash_dq_offset, hash_dq_data_qual, hash_dq_nof, key_dq_qualifier, key_dq_length, key_dq_offset, key_dq_data_qual, key_dq_nof, preselector_header_format);
	if (BCM_E_NONE != result) {
 ...
 */
int slb_two_keys_sport_sip(const int unit , int bcm_hash_config) 
{
	int result;
	bcm_field_header_format_t preselector_header_format = bcmFieldHeaderFormatIp4AnyL2L3;
 ...
 */
int flexibal_IP_L2_fwrd_with_UDP(int unit, int inPort, int outPort0, int outPort1, int outPort2) {
