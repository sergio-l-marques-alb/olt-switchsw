...
mim_info_roo_init(int unit, int port1, int port2, int port3, int port4) {
    ...
    mim_info_roo.fec_id_3 = (16 << 26) + 0x4000;/*0x40000000 + 0x4000;*/
    mim_info_roo.fec_id_4 = (16 << 26) + 0x4002;/*0x40000000 + 0x4002;*/
    ...
    ) 
{
    ...
    mim_port->flags |= is_device_or_above(unit, QUMRAN_AX) ? 0 : BCM_MIM_PORT_ENCAP_OVERLAY;
...
int mim_setup_roo_encapsulation(int unit) {
    ...
    mim_info_roo.l3_egr_intf_port_1.flags = is_device_or_above(unit, QUMRAN_AX) ? BCM_L3_NATIVE_ENCAP : 0;
    ...
    mim_info_roo.l3_egr_intf_port_2.flags = is_device_or_above(unit, QUMRAN_AX) ? BCM_L3_NATIVE_ENCAP : 0;
