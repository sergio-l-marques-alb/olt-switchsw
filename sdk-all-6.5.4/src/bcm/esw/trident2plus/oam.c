...
#define _BCM_FP_OAM_MPLS_LM_DM_OAM_PM_EVENT_TYPE(event_type) \
...
#define BCM_WB_BHH_DEFAULT_VERSION  BCM_WB_VERSION_1_0
                                               ...
                                               bcm_oam_event_type_t event_type)
{
    ...
    if (!_BCM_FP_OAM_MPLS_LM_DM_OAM_PM_EVENT_TYPE(event_type)) {
