...
#define BCM_XGS3_L3_ECMP_MAX(_u_)   \
   ((SOC_IS_TOMAHAWK(_u_) &&        \
    ...
    ((SOC_IS_GREYHOUND(_u_) || SOC_IS_HURRICANE3(_u_))) ? (64) : (32))
...
#define BCM_XGS3_L3_ECMP_MAX_GROUPS(_u_)                  \
    ((soc_feature(unit, soc_feature_l3_ecmp_4k_groups)) ? (4096) : \
    ((soc_feature(unit, soc_feature_l3_ecmp_2k_groups)) ? (2048) : \
    (SOC_IS_TRIUMPH3(_u_)                             ||  \
     (soc_feature(_u_, soc_feature_l3_ecmp_1k_groups)) ||  \
    (BCM_XGS3_L3_MAX_ECMP_MODE(_u_))) ?                   \
   (1024) : \
   ((SOC_IS_GREYHOUND(_u_) || SOC_IS_HURRICANE3(_u_))) ? (128) :(512)))
