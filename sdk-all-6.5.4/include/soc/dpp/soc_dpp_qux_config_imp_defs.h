...
#define SOC_DPP_NOF_NON_CHANNELIZED_INTERFACES_QUX           (96)
#define SOC_DPP_NOF_CORE_INTERFACES_QUX                      (128)
...
#define SOC_DPP_MIRROR_SNOOP_DESTINATION_MULTICAST_ENCODING_QUX (1|17<<8 |18<<16)
