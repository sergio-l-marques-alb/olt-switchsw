...
#define JER_KAPS_CR_SUPPORTED_VERSION 0
#define JER_KAPS_IS_CR_MODE (((soc_property_get(unit, spn_HA_HW_JOURNAL_MODE, HW_LOG_MODE_Disabled) != HW_LOG_MODE_Disabled)?1:0)&&JER_KAPS_CR_SUPPORTED_VERSION)
#define JER_KAPS_NV_MEMORY_SIZE (50*1024*1024+23*512*1024)
#endif
