 ...
 *  Disable cl73(0),
 *  Enable cl73_wo_c73bam(1),
 *  Enable cl73_and_c73bam(2).
 */
 ...
 * 		     bit0: Polarity for physical port <phys_port>
 * 		     bit1: Polarity for physical port <phys_port+1>
 * 		     etc.
 * 	For Example: phy_tx_polarity_flip{1.0} = 1	Internal Serdes TX polarity flip is enabled on physical port 1
 * 		     phy_tx_polarity_flip{1.1} = 1	TX polarity flip is enabled for the physical port 1 in the innermost external phy
 */
 ...
 * 1: Similar speed profile
 * 2: Extreme speed profile (Default)
 */
 ...
 * for the proper operation of a MT2 system.
 */
...
/*
 * The size of data buffer in the OCB for link bonding.
...
/* Enable OAM features CFM and Y1731 */
...
/* This soc property will be used to define the rcy port which will be used in LBM up-mep */
