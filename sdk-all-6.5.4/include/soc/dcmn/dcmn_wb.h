...
extern _dcmn_wb_skip_decision_t dcmn_bcm_warm_boot_api_test_reset_skip_decider(int unit);
...
extern int  dcmn_wb_exp_backoff(int test_counter);
/*************************************************************************************************/
...
#define TR_141_COMMAND(is_cr) ((is_cr) ? "tr 141 w=1 NoSync=1 NoDump=1" : "tr 141 W=1")
