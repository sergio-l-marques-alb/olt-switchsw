...
typedef enum bcm_rx_trap_e {
    ...
    bcmRxTrapCount = 278                /* Must be last: enum count size. */
} bcm_rx_trap_t;
...
/* maps the MTU value from input to LIF value from input */
extern int bcm_rx_lif_mtu_set(
    int unit, 
    uint32 flags, 
    bcm_port_t port, 
    uint32 mtu);

/* return MTU value that was set for LIF */
extern int bcm_rx_lif_mtu_get(
    int unit, 
    uint32 flags, 
    bcm_port_t port, 
    uint32 *mtu);
