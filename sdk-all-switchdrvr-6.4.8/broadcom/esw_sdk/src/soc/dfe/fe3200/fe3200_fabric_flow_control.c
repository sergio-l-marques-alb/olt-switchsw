...
soc_error_t soc_fe3200_fabric_flow_control_tx_bypass_llfc_threshold_set(int unit,soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int fe1, int fe3, int value)
{
    ...
    if (SOC_DFE_IS_FE13_ASYMMETRIC(unit) && ((!fe1) || (!fe3))) /* if asymmetric fe13 and we want to configure just fe1 or fe3 links */
    {  
        min_idx_dcmb = 0; /* quads 26,35 - the quads moved from FE to FAP in fe13, look at DCMB registers to determine their threshold*/
        if (fe1) /* nothing to write for blocks 0-1*/
        {     
            max_idx_dcmb = -1;
        }
        else /* write to all dcmb blocks */
        {            
            max_idx_dcmb = 3;
        }
    }
    ...
    {
        min_idx_dcmb = min_idx;
        max_idx_dcmb = max_idx;
    }
...
soc_fe3200_init_dcl_thresholds_config(int unit, soc_dfe_drv_dcl_default_thresholds_t* dcl_thresholds_default_values)
{
	...
	switch (nof_pipes)
	{
        ...
        case 2:            
            ...
            dcl_thresholds_default_values-> fifo_size[2] = 0;
            dcl_thresholds_default_values-> prio_0_threshold[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_fabric_pipe_map_dual_tdm_non_tdm)? 40:SOC_FE3200_DCL_DEFAULT_PRIO_0_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_0_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_0_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_0_threshold[2] = 0;
            dcl_thresholds_default_values-> prio_1_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_1_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_1_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_1_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_1_threshold[2] = 0;
            dcl_thresholds_default_values-> prio_2_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_2_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_2_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_2_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_2_threshold[2] = 0;
            dcl_thresholds_default_values-> prio_3_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_3_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_3_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_3_DROP_THRESHOLD_DUAL_PIPE;
            dcl_thresholds_default_values-> prio_3_threshold[2] = 0;
        ...
        case 3:  
            ...
            dcl_thresholds_default_values-> prio_0_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_0_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_0_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_0_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_0_threshold[2] = SOC_FE3200_DCL_DEFAULT_PRIO_0_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_1_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_1_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_1_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_1_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_1_threshold[2] = SOC_FE3200_DCL_DEFAULT_PRIO_1_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_2_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_2_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_2_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_2_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_2_threshold[2] = SOC_FE3200_DCL_DEFAULT_PRIO_2_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_3_threshold[0] = SOC_FE3200_DCL_DEFAULT_PRIO_3_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_3_threshold[1] = SOC_FE3200_DCL_DEFAULT_PRIO_3_DROP_THRESHOLD_TRIPLE_PIPE;
            dcl_thresholds_default_values-> prio_3_threshold[2] = SOC_FE3200_DCL_DEFAULT_PRIO_3_DROP_THRESHOLD_TRIPLE_PIPE;
