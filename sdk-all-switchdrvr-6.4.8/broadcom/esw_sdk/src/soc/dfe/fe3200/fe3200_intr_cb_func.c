...
STATIC
 ...
 fe3200_hard_reset(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    rc = fe3200_interrupt_handles_corrective_action(unit, block_instance, en_interrupt, msg, FE3200_INT_CORR_ACT_SOFT_RESET, NULL, NULL);
...
STATIC
 ...
 fe3200_none(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    SOCDNX_INIT_FUNC_DEFS;
    /* print info */
    rc = fe3200_interrupt_print_info(unit, block_instance, en_interrupt, 0, FE3200_INT_CORR_ACT_NONE, msg);
    SOCDNX_IF_ERR_EXIT(rc);
...
STATIC
 ...
 fe3200_shutdown_link(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    rc = fe3200_interrupt_handles_corrective_action(unit, block_instance, en_interrupt, msg, FE3200_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, NULL, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
STATIC
 ...
 fe3200_special_handling_normal_0(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    SOCDNX_INIT_FUNC_DEFS;
    rc = fe3200_interrupt_print_info(unit, block_instance, en_interrupt, 0, FE3200_INT_CORR_ACT_SOFT_RESET, msg);
    SOCDNX_IF_ERR_EXIT(rc);
...
void fe3200_interrupt_cb_init(int unit)
{
    ...
    dcmn_intr_add_handler_ext(unit, FE3200_INT_RTP_ECC_ECC_1B_ERR_INT, 1000,100,fe3200_none,fe3200_hard_reset,"FE3200_INT_RTP_ECC_ECC_1B_ERR_INT");
    dcmn_intr_add_handler_ext(unit, FE3200_INT_RTP_ECC_ECC_2B_ERR_INT, 0,0,fe3200_hard_reset,NULL,"FE3200_INT_RTP_ECC_ECC_2B_ERR_INT");
