...
{	
    /* print stack usage */
    /* TDM_PRINT_STACK_SIZE("tdm_th_corereq"); */
...
tdm_th_scheduler_wrap_pipe( tdm_mod_t *_tdm )
{
    ...
    if ((_tdm->_chip_data.soc_pkg.soc_vars.th.higig_mgmt==BOOL_FALSE)&&(ethernet_encap) &&
        ...
        switch (param_clk_freq) {
            case 850: param_cal_len = LEN_850MHZ_EN; break;
            case 766:
            case 765: param_cal_len = LEN_765MHZ_EN; break;
            case 672: param_cal_len = LEN_672MHZ_EN; break;
            case 645: param_cal_len = LEN_645MHZ_EN; break;
            case 545: param_cal_len = LEN_545MHZ_EN; break;
            default:
        ...
        switch (param_clk_freq) {
            case 850: param_cal_len = LEN_850MHZ_HG; break;
            case 766:
            case 765: param_cal_len = LEN_765MHZ_HG; break;
            case 672: param_cal_len = LEN_672MHZ_HG; break;
            case 645: param_cal_len = LEN_645MHZ_HG; break;
            case 545: param_cal_len = LEN_545MHZ_HG; break;
            default:
                TDM_PRINT1("Invalid frequency - %0dMHz not supported\n",param_clk_freq);
                return 0;
                break;
...
tdm_th_pmap_transcription( tdm_mod_t *_tdm )
{
	...
	/* print stack usage */
	/* TDM_PRINT_STACK_SIZE("tdm_th_pmap_transcription"); */
