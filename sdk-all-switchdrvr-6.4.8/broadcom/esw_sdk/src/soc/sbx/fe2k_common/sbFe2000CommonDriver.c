/*****************************************************************************
 * $Id: sbFe2000CommonDriver.c,v 1.9 Broadcom SDK $
 *
...
uint32 
sbFe2000ByteHashConfigAccess(sbhandle userDeviceHandle, uint32 uTemplateId, uint32 uRead)
{
    uint32 uCtrl, uTimeout, bAccessDone, uTemp;
...
uint32 
sbFe2000BitHashConfigAccess(sbhandle userDeviceHandle, uint32 uTemplateId, uint32 uRead)
{
    uint32 uTemp, uCtrl, bAccessDone, uTimeout;
