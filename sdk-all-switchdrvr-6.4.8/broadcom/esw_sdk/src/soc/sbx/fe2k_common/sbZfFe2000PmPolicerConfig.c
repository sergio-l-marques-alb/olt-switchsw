...
sbZfFe2000PmPolicerConfig_Unpack(sbZfFe2000PmPolicerConfig_t *pToStruct,
  ...
  (pToStruct)->uRfcMode =  (uint32)  ((pFromData)[21] >> 1) & 0x03;

  /* Unpack Member: uLenShift */
  (pToStruct)->uLenShift =  (uint32)  ((pFromData)[20] >> 6) & 0x03;
  (pToStruct)->uLenShift |=  (uint32)  ((pFromData)[21] & 0x01) << 2;

  /* Unpack Member: uRate */
  (pToStruct)->uRate =  (uint32)  ((pFromData)[16] >> 6) & 0x03;
  (pToStruct)->uRate |=  (uint32)  (pFromData)[17] << 2;
  (pToStruct)->uRate |=  (uint32)  (pFromData)[18] << 10;
  (pToStruct)->uRate |=  (uint32)  (pFromData)[19] << 18;
  (pToStruct)->uRate |=  (uint32)  ((pFromData)[20] & 0x3f) << 26;

  /* Unpack Member: uCBS */
  (pToStruct)->uCBS =  (uint32)  ((pFromData)[12] >> 6) & 0x03;
  (pToStruct)->uCBS |=  (uint32)  (pFromData)[13] << 2;
  (pToStruct)->uCBS |=  (uint32)  (pFromData)[14] << 10;
  (pToStruct)->uCBS |=  (uint32)  (pFromData)[15] << 18;
  (pToStruct)->uCBS |=  (uint32)  ((pFromData)[16] & 0x3f) << 26;

  /* Unpack Member: uCIR */
  (pToStruct)->uCIR =  (uint32)  ((pFromData)[8] >> 6) & 0x03;
  (pToStruct)->uCIR |=  (uint32)  (pFromData)[9] << 2;
  (pToStruct)->uCIR |=  (uint32)  (pFromData)[10] << 10;
  (pToStruct)->uCIR |=  (uint32)  (pFromData)[11] << 18;
  (pToStruct)->uCIR |=  (uint32)  ((pFromData)[12] & 0x3f) << 26;

  /* Unpack Member: uEBS */
  (pToStruct)->uEBS =  (uint32)  ((pFromData)[4] >> 6) & 0x03;
  (pToStruct)->uEBS |=  (uint32)  (pFromData)[5] << 2;
  (pToStruct)->uEBS |=  (uint32)  (pFromData)[6] << 10;
  (pToStruct)->uEBS |=  (uint32)  (pFromData)[7] << 18;
  (pToStruct)->uEBS |=  (uint32)  ((pFromData)[8] & 0x3f) << 26;

  /* Unpack Member: uEIR */
  (pToStruct)->uEIR =  (uint32)  ((pFromData)[0] >> 6) & 0x03;
  (pToStruct)->uEIR |=  (uint32)  (pFromData)[1] << 2;
  (pToStruct)->uEIR |=  (uint32)  (pFromData)[2] << 10;
  (pToStruct)->uEIR |=  (uint32)  (pFromData)[3] << 18;
  (pToStruct)->uEIR |=  (uint32)  ((pFromData)[4] & 0x3f) << 26;

  /* Unpack Member: uRsvd */
  (pToStruct)->uRsvd =  (uint32)  ((pFromData)[0] >> 5) & 0x01;

  /* Unpack Member: bBlindMode */
  (pToStruct)->bBlindMode =  (uint32)  ((pFromData)[0] >> 4) & 0x01;

  /* Unpack Member: bDropOnRed */
  (pToStruct)->bDropOnRed =  (uint32)  ((pFromData)[0] >> 3) & 0x01;

  /* Unpack Member: bCoupling */
  (pToStruct)->bCoupling =  (uint32)  ((pFromData)[0] >> 2) & 0x01;

  /* Unpack Member: bCBSNoDecrement */
  (pToStruct)->bCBSNoDecrement =  (uint32)  ((pFromData)[0] >> 1) & 0x01;

  /* Unpack Member: bEBSNoDecrement */
  (pToStruct)->bEBSNoDecrement =  (uint32)  ((pFromData)[0] ) & 0x01;
