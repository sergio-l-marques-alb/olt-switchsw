/*
 * $Id: sbZfCaPtPte1PortStateEntry.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaPtPte1PortStateEntry.hx"
...
uint32
sbZfCaPtPte1PortStateEntry_Pack(sbZfCaPtPte1PortStateEntry_t *pFrom,
                                uint8 *pToData,
                                uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_CAPTPTE1PORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE1PORTSTATEENTRY_SIZE_IN_BYTES;
}
...
void
sbZfCaPtPte1PortStateEntry_Unpack(sbZfCaPtPte1PortStateEntry_t *pToStruct,
                                  uint8 *pFromData,
                                  uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfCaPtPte1PortStateEntry_InitInstance(sbZfCaPtPte1PortStateEntry_t *pFrame) {
