/*
 * $Id: sbZfCaMmWidePortMemoryEntry.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaMmWidePortMemoryEntry.hx"
...
uint32
sbZfCaMmWidePortMemoryEntry_Pack(sbZfCaMmWidePortMemoryEntry_t *pFrom,
                                 uint8 *pToData,
                                 uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_CAMMWIDEPORTMEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAMMWIDEPORTMEMORYENTRY_SIZE_IN_BYTES;
}
...
void
sbZfCaMmWidePortMemoryEntry_Unpack(sbZfCaMmWidePortMemoryEntry_t *pToStruct,
                                   uint8 *pFromData,
                                   uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfCaMmWidePortMemoryEntry_InitInstance(sbZfCaMmWidePortMemoryEntry_t *pFrame) {
