/*
 * $Id: sbZfFe2000ClsInstruction.c,v 1.4 Broadcom SDK $
...
sbZfFe2000ClsInstruction_Unpack(sbZfFe2000ClsInstruction_t *pToStruct,
  ...
  (pToStruct)->uOpCodeMsb =  (uint32)  ((pFromData)[2] >> 2) & 0x03;

  /* Unpack Member: uOpCodeLsb */
  (pToStruct)->uOpCodeLsb =  (uint32)  ((pFromData)[2] ) & 0x03;

  /* Unpack Member: uSField */
  (pToStruct)->uSField =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: uMField */
  (pToStruct)->uMField =  (uint32)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: uAField */
  (pToStruct)->uAField =  (uint32)  (pFromData)[0] ;
