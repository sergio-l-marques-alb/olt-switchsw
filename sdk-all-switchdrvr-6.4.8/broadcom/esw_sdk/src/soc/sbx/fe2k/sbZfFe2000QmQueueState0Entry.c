/*
 * $Id: sbZfFe2000QmQueueState0Entry.c,v 1.4 Broadcom SDK $
...
sbZfFe2000QmQueueState0Entry_Pack(sbZfFe2000QmQueueState0Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FE2000QMQUEUESTATE0ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FE2000QMQUEUESTATE0ENTRY_SIZE_IN_BYTES;
}
...
sbZfFe2000QmQueueState0Entry_Unpack(sbZfFe2000QmQueueState0Entry_t *pToStruct,
  ...
  (pToStruct)->m_uTailPtr =  (uint32)  ((pFromData)[1] >> 7) & 0x01;
  (pToStruct)->m_uTailPtr |=  (uint32)  (pFromData)[2] << 1;
  (pToStruct)->m_uTailPtr |=  (uint32)  ((pFromData)[3] & 0x07) << 9;

  /* Unpack Member: m_uDepthInPages */
  (pToStruct)->m_uDepthInPages =  (uint32)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_uDepthInPages |=  (uint32)  ((pFromData)[1] & 0x7f) << 6;

  /* Unpack Member: m_uEmpty */
  (pToStruct)->m_uEmpty =  (uint32)  ((pFromData)[0] >> 1) & 0x01;

  /* Unpack Member: m_uEnable */
  (pToStruct)->m_uEnable =  (uint32)  ((pFromData)[0] ) & 0x01;
