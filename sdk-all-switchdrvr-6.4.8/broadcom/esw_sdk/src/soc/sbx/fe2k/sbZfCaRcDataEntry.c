/*
 * $Id: sbZfCaRcDataEntry.c,v 1.2 Broadcom SDK $
...
sbZfCaRcDataEntry_Pack(sbZfCaRcDataEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CARCDATAENTRY_SIZE_IN_BYTES;
  ...
  (pToData)[14] |= ((pFrom)->m_uSpare3 & 0x0f) <<4;
  (pToData)[15] |= ((pFrom)->m_uSpare3 >> 4) &0xFF;

  /* Pack Member: m_uData3 */
  (pToData)[12] |= ((pFrom)->m_uData3) & 0xFF;
  (pToData)[13] |= ((pFrom)->m_uData3 >> 8) &0xFF;
  (pToData)[14] |= ((pFrom)->m_uData3 >> 16) & 0x0f;

  /* Pack Member: m_uSpare2 */
  (pToData)[10] |= ((pFrom)->m_uSpare2 & 0x0f) <<4;
  (pToData)[11] |= ((pFrom)->m_uSpare2 >> 4) &0xFF;

  /* Pack Member: m_uData2 */
  (pToData)[8] |= ((pFrom)->m_uData2) & 0xFF;
  (pToData)[9] |= ((pFrom)->m_uData2 >> 8) &0xFF;
  (pToData)[10] |= ((pFrom)->m_uData2 >> 16) & 0x0f;

  /* Pack Member: m_uSpare1 */
  (pToData)[6] |= ((pFrom)->m_uSpare1 & 0x0f) <<4;
  (pToData)[7] |= ((pFrom)->m_uSpare1 >> 4) &0xFF;

  /* Pack Member: m_uData1 */
  (pToData)[4] |= ((pFrom)->m_uData1) & 0xFF;
  (pToData)[5] |= ((pFrom)->m_uData1 >> 8) &0xFF;
  (pToData)[6] |= ((pFrom)->m_uData1 >> 16) & 0x0f;

  /* Pack Member: m_uSpare0 */
  (pToData)[2] |= ((pFrom)->m_uSpare0 & 0x0f) <<4;
  (pToData)[3] |= ((pFrom)->m_uSpare0 >> 4) &0xFF;

  /* Pack Member: m_uData0 */
  (pToData)[0] |= ((pFrom)->m_uData0) & 0xFF;
  (pToData)[1] |= ((pFrom)->m_uData0 >> 8) &0xFF;
  (pToData)[2] |= ((pFrom)->m_uData0 >> 16) & 0x0f;

  return SB_ZF_CARCDATAENTRY_SIZE_IN_BYTES;
}
...
sbZfCaRcDataEntry_Unpack(sbZfCaRcDataEntry_t *pToStruct,
  ...
  (pToStruct)->m_uData35 =  (uint32)  (pFromData)[140] ;
  (pToStruct)->m_uData35 |=  (uint32)  (pFromData)[141] << 8;
  (pToStruct)->m_uData35 |=  (uint32)  (pFromData)[142] << 16;
  (pToStruct)->m_uData35 |=  (uint32)  (pFromData)[143] << 24;

  /* Unpack Member: m_uData34 */
  (pToStruct)->m_uData34 =  (uint32)  (pFromData)[136] ;
  (pToStruct)->m_uData34 |=  (uint32)  (pFromData)[137] << 8;
  (pToStruct)->m_uData34 |=  (uint32)  (pFromData)[138] << 16;
  (pToStruct)->m_uData34 |=  (uint32)  (pFromData)[139] << 24;

  /* Unpack Member: m_uData33 */
  (pToStruct)->m_uData33 =  (uint32)  (pFromData)[132] ;
  (pToStruct)->m_uData33 |=  (uint32)  (pFromData)[133] << 8;
  (pToStruct)->m_uData33 |=  (uint32)  (pFromData)[134] << 16;
  (pToStruct)->m_uData33 |=  (uint32)  (pFromData)[135] << 24;

  /* Unpack Member: m_uData32 */
  (pToStruct)->m_uData32 =  (uint32)  (pFromData)[128] ;
  (pToStruct)->m_uData32 |=  (uint32)  (pFromData)[129] << 8;
  (pToStruct)->m_uData32 |=  (uint32)  (pFromData)[130] << 16;
  (pToStruct)->m_uData32 |=  (uint32)  (pFromData)[131] << 24;

  /* Unpack Member: m_uData31 */
  (pToStruct)->m_uData31 =  (uint32)  (pFromData)[124] ;
  (pToStruct)->m_uData31 |=  (uint32)  (pFromData)[125] << 8;
  (pToStruct)->m_uData31 |=  (uint32)  (pFromData)[126] << 16;
  (pToStruct)->m_uData31 |=  (uint32)  (pFromData)[127] << 24;

  /* Unpack Member: m_uData30 */
  (pToStruct)->m_uData30 =  (uint32)  (pFromData)[120] ;
  (pToStruct)->m_uData30 |=  (uint32)  (pFromData)[121] << 8;
  (pToStruct)->m_uData30 |=  (uint32)  (pFromData)[122] << 16;
  (pToStruct)->m_uData30 |=  (uint32)  (pFromData)[123] << 24;

  /* Unpack Member: m_uData29 */
  (pToStruct)->m_uData29 =  (uint32)  (pFromData)[116] ;
  (pToStruct)->m_uData29 |=  (uint32)  (pFromData)[117] << 8;
  (pToStruct)->m_uData29 |=  (uint32)  (pFromData)[118] << 16;
  (pToStruct)->m_uData29 |=  (uint32)  (pFromData)[119] << 24;

  /* Unpack Member: m_uData28 */
  (pToStruct)->m_uData28 =  (uint32)  (pFromData)[112] ;
  (pToStruct)->m_uData28 |=  (uint32)  (pFromData)[113] << 8;
  (pToStruct)->m_uData28 |=  (uint32)  (pFromData)[114] << 16;
  (pToStruct)->m_uData28 |=  (uint32)  (pFromData)[115] << 24;

  /* Unpack Member: m_uData27 */
  (pToStruct)->m_uData27 =  (uint32)  (pFromData)[108] ;
  (pToStruct)->m_uData27 |=  (uint32)  (pFromData)[109] << 8;
  (pToStruct)->m_uData27 |=  (uint32)  (pFromData)[110] << 16;
  (pToStruct)->m_uData27 |=  (uint32)  (pFromData)[111] << 24;

  /* Unpack Member: m_uData26 */
  (pToStruct)->m_uData26 =  (uint32)  (pFromData)[104] ;
  (pToStruct)->m_uData26 |=  (uint32)  (pFromData)[105] << 8;
  (pToStruct)->m_uData26 |=  (uint32)  (pFromData)[106] << 16;
  (pToStruct)->m_uData26 |=  (uint32)  (pFromData)[107] << 24;

  /* Unpack Member: m_uData25 */
  (pToStruct)->m_uData25 =  (uint32)  (pFromData)[100] ;
  (pToStruct)->m_uData25 |=  (uint32)  (pFromData)[101] << 8;
  (pToStruct)->m_uData25 |=  (uint32)  (pFromData)[102] << 16;
  (pToStruct)->m_uData25 |=  (uint32)  (pFromData)[103] << 24;

  /* Unpack Member: m_uData24 */
  (pToStruct)->m_uData24 =  (uint32)  (pFromData)[96] ;
  (pToStruct)->m_uData24 |=  (uint32)  (pFromData)[97] << 8;
  (pToStruct)->m_uData24 |=  (uint32)  (pFromData)[98] << 16;
  (pToStruct)->m_uData24 |=  (uint32)  (pFromData)[99] << 24;

  /* Unpack Member: m_uData23 */
  (pToStruct)->m_uData23 =  (uint32)  (pFromData)[92] ;
  (pToStruct)->m_uData23 |=  (uint32)  (pFromData)[93] << 8;
  (pToStruct)->m_uData23 |=  (uint32)  (pFromData)[94] << 16;
  (pToStruct)->m_uData23 |=  (uint32)  (pFromData)[95] << 24;

  /* Unpack Member: m_uData22 */
  (pToStruct)->m_uData22 =  (uint32)  (pFromData)[88] ;
  (pToStruct)->m_uData22 |=  (uint32)  (pFromData)[89] << 8;
  (pToStruct)->m_uData22 |=  (uint32)  (pFromData)[90] << 16;
  (pToStruct)->m_uData22 |=  (uint32)  (pFromData)[91] << 24;

  /* Unpack Member: m_uData21 */
  (pToStruct)->m_uData21 =  (uint32)  (pFromData)[84] ;
  (pToStruct)->m_uData21 |=  (uint32)  (pFromData)[85] << 8;
  (pToStruct)->m_uData21 |=  (uint32)  (pFromData)[86] << 16;
  (pToStruct)->m_uData21 |=  (uint32)  (pFromData)[87] << 24;

  /* Unpack Member: m_uData20 */
  (pToStruct)->m_uData20 =  (uint32)  (pFromData)[80] ;
  (pToStruct)->m_uData20 |=  (uint32)  (pFromData)[81] << 8;
  (pToStruct)->m_uData20 |=  (uint32)  (pFromData)[82] << 16;
  (pToStruct)->m_uData20 |=  (uint32)  (pFromData)[83] << 24;

  /* Unpack Member: m_uData19 */
  (pToStruct)->m_uData19 =  (uint32)  (pFromData)[76] ;
  (pToStruct)->m_uData19 |=  (uint32)  (pFromData)[77] << 8;
  (pToStruct)->m_uData19 |=  (uint32)  (pFromData)[78] << 16;
  (pToStruct)->m_uData19 |=  (uint32)  (pFromData)[79] << 24;

  /* Unpack Member: m_uData18 */
  (pToStruct)->m_uData18 =  (uint32)  (pFromData)[72] ;
  (pToStruct)->m_uData18 |=  (uint32)  (pFromData)[73] << 8;
  (pToStruct)->m_uData18 |=  (uint32)  (pFromData)[74] << 16;
  (pToStruct)->m_uData18 |=  (uint32)  (pFromData)[75] << 24;

  /* Unpack Member: m_uData17 */
  (pToStruct)->m_uData17 =  (uint32)  (pFromData)[68] ;
  (pToStruct)->m_uData17 |=  (uint32)  (pFromData)[69] << 8;
  (pToStruct)->m_uData17 |=  (uint32)  (pFromData)[70] << 16;
  (pToStruct)->m_uData17 |=  (uint32)  (pFromData)[71] << 24;

  /* Unpack Member: m_uData16 */
  (pToStruct)->m_uData16 =  (uint32)  (pFromData)[64] ;
  (pToStruct)->m_uData16 |=  (uint32)  (pFromData)[65] << 8;
  (pToStruct)->m_uData16 |=  (uint32)  (pFromData)[66] << 16;
  (pToStruct)->m_uData16 |=  (uint32)  (pFromData)[67] << 24;

  /* Unpack Member: m_uData15 */
  (pToStruct)->m_uData15 =  (uint32)  (pFromData)[60] ;
  (pToStruct)->m_uData15 |=  (uint32)  (pFromData)[61] << 8;
  (pToStruct)->m_uData15 |=  (uint32)  (pFromData)[62] << 16;
  (pToStruct)->m_uData15 |=  (uint32)  (pFromData)[63] << 24;

  /* Unpack Member: m_uData14 */
  (pToStruct)->m_uData14 =  (uint32)  (pFromData)[56] ;
  (pToStruct)->m_uData14 |=  (uint32)  (pFromData)[57] << 8;
  (pToStruct)->m_uData14 |=  (uint32)  (pFromData)[58] << 16;
  (pToStruct)->m_uData14 |=  (uint32)  (pFromData)[59] << 24;

  /* Unpack Member: m_uData13 */
  (pToStruct)->m_uData13 =  (uint32)  (pFromData)[52] ;
  (pToStruct)->m_uData13 |=  (uint32)  (pFromData)[53] << 8;
  (pToStruct)->m_uData13 |=  (uint32)  (pFromData)[54] << 16;
  (pToStruct)->m_uData13 |=  (uint32)  (pFromData)[55] << 24;

  /* Unpack Member: m_uData12 */
  (pToStruct)->m_uData12 =  (uint32)  (pFromData)[48] ;
  (pToStruct)->m_uData12 |=  (uint32)  (pFromData)[49] << 8;
  (pToStruct)->m_uData12 |=  (uint32)  (pFromData)[50] << 16;
  (pToStruct)->m_uData12 |=  (uint32)  (pFromData)[51] << 24;

  /* Unpack Member: m_uData11 */
  (pToStruct)->m_uData11 =  (uint32)  (pFromData)[44] ;
  (pToStruct)->m_uData11 |=  (uint32)  (pFromData)[45] << 8;
  (pToStruct)->m_uData11 |=  (uint32)  (pFromData)[46] << 16;
  (pToStruct)->m_uData11 |=  (uint32)  (pFromData)[47] << 24;

  /* Unpack Member: m_uData10 */
  (pToStruct)->m_uData10 =  (uint32)  (pFromData)[40] ;
  (pToStruct)->m_uData10 |=  (uint32)  (pFromData)[41] << 8;
  (pToStruct)->m_uData10 |=  (uint32)  (pFromData)[42] << 16;
  (pToStruct)->m_uData10 |=  (uint32)  (pFromData)[43] << 24;
  ...
  (pToStruct)->m_uSpare3 =  (uint32)  ((pFromData)[14] >> 4) & 0x0f;
  (pToStruct)->m_uSpare3 |=  (uint32)  (pFromData)[15] << 4;

  /* Unpack Member: m_uData3 */
  (pToStruct)->m_uData3 =  (uint32)  (pFromData)[12] ;
  (pToStruct)->m_uData3 |=  (uint32)  (pFromData)[13] << 8;
  (pToStruct)->m_uData3 |=  (uint32)  ((pFromData)[14] & 0x0f) << 16;

  /* Unpack Member: m_uSpare2 */
  (pToStruct)->m_uSpare2 =  (uint32)  ((pFromData)[10] >> 4) & 0x0f;
  (pToStruct)->m_uSpare2 |=  (uint32)  (pFromData)[11] << 4;

  /* Unpack Member: m_uData2 */
  (pToStruct)->m_uData2 =  (uint32)  (pFromData)[8] ;
  (pToStruct)->m_uData2 |=  (uint32)  (pFromData)[9] << 8;
  (pToStruct)->m_uData2 |=  (uint32)  ((pFromData)[10] & 0x0f) << 16;

  /* Unpack Member: m_uSpare1 */
  (pToStruct)->m_uSpare1 =  (uint32)  ((pFromData)[6] >> 4) & 0x0f;
  (pToStruct)->m_uSpare1 |=  (uint32)  (pFromData)[7] << 4;

  /* Unpack Member: m_uData1 */
  (pToStruct)->m_uData1 =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uData1 |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->m_uData1 |=  (uint32)  ((pFromData)[6] & 0x0f) << 16;

  /* Unpack Member: m_uSpare0 */
  (pToStruct)->m_uSpare0 =  (uint32)  ((pFromData)[2] >> 4) & 0x0f;
  (pToStruct)->m_uSpare0 |=  (uint32)  (pFromData)[3] << 4;

  /* Unpack Member: m_uData0 */
  (pToStruct)->m_uData0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uData0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uData0 |=  (uint32)  ((pFromData)[2] & 0x0f) << 16;
