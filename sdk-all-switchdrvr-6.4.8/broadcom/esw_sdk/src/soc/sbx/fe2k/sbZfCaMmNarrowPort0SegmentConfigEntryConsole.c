...
sbZfCaMmNarrowPort0SegmentConfigEntry_Print(sbZfCaMmNarrowPort0SegmentConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmNarrowPort0SegmentConfigEntry:: narrowport0segmentconfig1=0x%07x"), (unsigned int)  pFromStruct->m_uNarrowPort0SegmentConfig1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmNarrowPort0SegmentConfigEntry:: narrowport0segmentconfig0=0x%08x"), (unsigned int)  pFromStruct->m_uNarrowPort0SegmentConfig0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
