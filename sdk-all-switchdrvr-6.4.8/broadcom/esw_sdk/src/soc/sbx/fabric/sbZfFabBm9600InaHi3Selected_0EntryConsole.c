...
sbZfFabBm9600InaHi3Selected_0Entry_Print(sbZfFabBm9600InaHi3Selected_0Entry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaHi3Selected_0Entry:: pri=0x%01x"), (unsigned int)  pFromStruct->m_uPri));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaHi3Selected_0Entry:: sysport=0x%03x"), (unsigned int)  pFromStruct->m_uSysport));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
