...
sbZfC2RceInstruction_Unpack(sbZfC2RceInstruction_t *pToStruct,
  ...
  (pToStruct)->m_uOpcode =  (uint32)  ((pFromData)[2] >> 1) & 0x0f;

  /* Unpack Member: m_uOpcodeSuspension */
  (pToStruct)->m_uOpcodeSuspension =  (uint32)  ((pFromData)[1] >> 5) & 0x07;
  (pToStruct)->m_uOpcodeSuspension |=  (uint32)  ((pFromData)[2] & 0x01) << 3;

  /* Unpack Member: m_uOpcodeMismatch */
  (pToStruct)->m_uOpcodeMismatch =  (uint32)  ((pFromData)[1] >> 1) & 0x0f;

  /* Unpack Member: m_uOperandA */
  (pToStruct)->m_uOperandA =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uOperandA |=  (uint32)  ((pFromData)[1] & 0x01) << 8;
