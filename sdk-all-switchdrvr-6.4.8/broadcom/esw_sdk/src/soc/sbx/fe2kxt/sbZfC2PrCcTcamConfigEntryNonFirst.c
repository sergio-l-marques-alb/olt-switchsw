...
sbZfC2PrCcTcamConfigEntryNonFirst_Unpack(sbZfC2PrCcTcamConfigEntryNonFirst_t *pToStruct,
  ...
  (pToStruct)->m_uMaskState =  (uint32)  (pFromData)[27] ;
  (pToStruct)->m_uMaskState |=  (uint32)  ((pFromData)[28] & 0x3f) << 8;
  ...
  (pToStruct)->m_uState =  (uint32)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_uState |=  (uint32)  (pFromData)[1] << 6;
