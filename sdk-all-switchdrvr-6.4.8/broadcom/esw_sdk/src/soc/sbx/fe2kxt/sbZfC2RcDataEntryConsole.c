...
sbZfC2RcDataEntry_Print(sbZfC2RcDataEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data39=0x%08x"), (unsigned int)  pFromStruct->m_uData39));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data38=0x%08x"), (unsigned int)  pFromStruct->m_uData38));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data37=0x%08x"), (unsigned int)  pFromStruct->m_uData37));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data36=0x%08x"), (unsigned int)  pFromStruct->m_uData36));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data35=0x%08x"), (unsigned int)  pFromStruct->m_uData35));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data34=0x%08x"), (unsigned int)  pFromStruct->m_uData34));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data33=0x%08x"), (unsigned int)  pFromStruct->m_uData33));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data32=0x%08x"), (unsigned int)  pFromStruct->m_uData32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data31=0x%08x"), (unsigned int)  pFromStruct->m_uData31));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data30=0x%08x"), (unsigned int)  pFromStruct->m_uData30));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data29=0x%08x"), (unsigned int)  pFromStruct->m_uData29));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data28=0x%08x"), (unsigned int)  pFromStruct->m_uData28));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data27=0x%08x"), (unsigned int)  pFromStruct->m_uData27));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data26=0x%08x"), (unsigned int)  pFromStruct->m_uData26));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data25=0x%08x"), (unsigned int)  pFromStruct->m_uData25));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data24=0x%08x"), (unsigned int)  pFromStruct->m_uData24));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data23=0x%08x"), (unsigned int)  pFromStruct->m_uData23));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data21=0x%08x"), (unsigned int)  pFromStruct->m_uData21));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data20=0x%08x"), (unsigned int)  pFromStruct->m_uData20));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data18=0x%08x"), (unsigned int)  pFromStruct->m_uData18));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data17=0x%08x"), (unsigned int)  pFromStruct->m_uData17));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data15=0x%08x"), (unsigned int)  pFromStruct->m_uData15));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data14=0x%08x"), (unsigned int)  pFromStruct->m_uData14));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data12=0x%08x"), (unsigned int)  pFromStruct->m_uData12));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data11=0x%08x"), (unsigned int)  pFromStruct->m_uData11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data9=0x%08x"), (unsigned int)  pFromStruct->m_uData9));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data8=0x%08x"), (unsigned int)  pFromStruct->m_uData8));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare7=0x%03x"), (unsigned int)  pFromStruct->m_uSpare7));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data7=0x%06x"), (unsigned int)  pFromStruct->m_uData7));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare6=0x%03x"), (unsigned int)  pFromStruct->m_uSpare6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data6=0x%06x"), (unsigned int)  pFromStruct->m_uData6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare5=0x%03x"), (unsigned int)  pFromStruct->m_uSpare5));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data5=0x%06x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare4=0x%03x"), (unsigned int)  pFromStruct->m_uSpare4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data4=0x%06x"), (unsigned int)  pFromStruct->m_uData4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare3=0x%03x"), (unsigned int)  pFromStruct->m_uSpare3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data3=0x%06x"), (unsigned int)  pFromStruct->m_uData3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare2=0x%03x"), (unsigned int)  pFromStruct->m_uSpare2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data2=0x%06x"), (unsigned int)  pFromStruct->m_uData2));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry:: data1=0x%06x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" spare0=0x%03x"), (unsigned int)  pFromStruct->m_uSpare0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data0=0x%06x"), (unsigned int)  pFromStruct->m_uData0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
