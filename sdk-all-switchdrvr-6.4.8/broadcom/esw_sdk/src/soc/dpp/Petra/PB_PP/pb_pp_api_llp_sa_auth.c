/* $Id: pb_pp_api_llp_sa_auth.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_llp_sa_auth.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_SA_AUTH_PORT_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(port_auth_info);

  res = soc_pb_pp_llp_sa_auth_port_info_set_verify(
          unit,
          local_port_ndx,
          port_auth_info
        );
  ...
  res = soc_pb_pp_llp_sa_auth_port_info_set_unsafe(
          unit,
          local_port_ndx,
          port_auth_info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_sa_auth_port_info_set()", local_port_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_SA_AUTH_PORT_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(port_auth_info);

  res = soc_pb_pp_llp_sa_auth_port_info_get_verify(
          unit,
          local_port_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_llp_sa_auth_port_info_get_unsafe(
          unit,
          local_port_ndx,
          port_auth_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_sa_auth_port_info_get()", local_port_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_SA_AUTH_MAC_INFO_SET);
  ...
  res = soc_pb_pp_llp_sa_auth_mac_info_set_verify(
          unit,
          mac_address_key,
          mac_auth_info,
          enable
  ...
  res = soc_pb_pp_llp_sa_auth_mac_info_set_unsafe(
          unit,
          mac_address_key,
          mac_auth_info,
          enable,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_sa_auth_mac_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_SA_AUTH_MAC_INFO_GET);
  ...
  res = soc_pb_pp_llp_sa_auth_mac_info_get_verify(
          unit,
          mac_address_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_sa_auth_mac_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_SA_AUTH_GET_BLOCK);
  ...
  res = soc_pb_pp_llp_sa_auth_get_block_verify(
          unit,
          rule,
          block_range
        );
  ...
  res = soc_pb_pp_llp_sa_auth_get_block_unsafe(
          unit,
          rule,
          block_range,
          mac_address_key_arr,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_sa_auth_get_block()", 0, 0);
}
