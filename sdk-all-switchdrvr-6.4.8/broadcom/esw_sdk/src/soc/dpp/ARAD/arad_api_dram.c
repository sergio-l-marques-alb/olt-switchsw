...
/* $Id: arad_api_dram.c,v 1.12 Broadcom SDK $
...
/*
 DRAM bufers mmu indirect read/write 
*/
...
/*
  DRAM buffers mennage buffer errors & delition.
*/
  ...
  )
{
  ...
  info->nof_cols = ARAD_NOF_DRAM_AP_POSITIONS;
