...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_pwe_map_range_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_pwe_map_range_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_pwe_add()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_pwe_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_pwe_remove()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vlan_compression_add()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vlan_compression_remove()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vlan_compression_get()", local_port_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_map_key_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_map_key_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_LIF_AC_MP_INFO_SET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_mp_info_set()", lif_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_LIF_AC_MP_INFO_GET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_mp_info_get()", lif_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_add()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_with_cos_add()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_with_cos_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_ac_remove()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_l2cp_trap_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_l2cp_trap_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_isid_add()", vsi_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_isid_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vsi_to_isid()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_isid_remove()", /*vsi_ndx*/0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_gre_add()", lif_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_gre_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_gre_remove()", /*vsi_ndx*/0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vxlan_add()", lif_index, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vxlan_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_vxlan_remove()", /*vsi_ndx*/0, 0);
}
...
exit_semaphore:
    ...
    ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
    SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_extender_add()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_default_frwrd_info_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_l2_lif_default_frwrd_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_PPC_L2_LIF_TRILL_INFO_clear(info);
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
...
void
  ARAD_PP_L2_LIF_EXTENDER_KEY_clear(
    SOC_SAND_OUT ARAD_PP_L2_LIF_EXTENDER_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);

  SOC_PPC_L2_LIF_EXTENDER_KEY_clear(info);
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}

void
  ARAD_PP_L2_LIF_EXTENDER_INFO_clear(
    SOC_SAND_OUT ARAD_PP_L2_LIF_EXTENDER_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);

  SOC_PPC_L2_LIF_EXTENDER_INFO_clear(info);
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
...
void
  ARAD_PP_L2_LIF_EXTENDER_KEY_print(
    SOC_SAND_OUT ARAD_PP_L2_LIF_EXTENDER_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  ...
  SOC_PPC_L2_LIF_EXTENDER_KEY_print(info);
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}

void
  ARAD_PP_L2_LIF_EXTENDER_INFO_print(
    SOC_SAND_OUT ARAD_PP_L2_LIF_EXTENDER_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  ...
  SOC_PPC_L2_LIF_EXTENDER_INFO_print(info);
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
