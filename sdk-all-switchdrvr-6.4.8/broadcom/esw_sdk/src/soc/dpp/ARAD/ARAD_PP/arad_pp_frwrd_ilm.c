    ...
    )
{
  ...
  num_bits = ARAD_PP_LEM_ACCESS_KEY_PARAM2_IN_BITS_FOR_ILM;
  ...
  )
{
  ...
  for(fld_ndx = 0; fld_ndx < ARAD_PP_IHB_MPLS_EXP_REG_NOF_FLDS; ++fld_ndx) 
  {
    ...
    /*soc_reg_field_set(unit, IHP_MPLS_EXP_MAPr, &data32, MPLS_EXPf, fld_val);*/
  ...
  )
{
  ...
  for(fld_ndx = 0; fld_ndx < ARAD_PP_IHB_MPLS_EXP_REG_NOF_FLDS; ++fld_ndx) 
  {
    ...
    /* Current code also works */
    /*fld_val = soc_reg_field_get(unit, IHP_MPLS_EXP_MAPr, &data32, MPLS_EXPf);*/
    fld_val = 0;
