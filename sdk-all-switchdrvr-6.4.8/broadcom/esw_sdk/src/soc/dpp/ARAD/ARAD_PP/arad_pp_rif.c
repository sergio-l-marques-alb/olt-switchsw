  ...
  )
{
    ...
    arad_pp_rif_ip_tunnel_term_lookups_get(unit,&dip_exact_enabled,&sip_exact_enabled,&dip_sip_tcam_enabled,&dip_sip_tcam_next_protocol_enabled,&dip_sip_vrf_tcam_enabled);
