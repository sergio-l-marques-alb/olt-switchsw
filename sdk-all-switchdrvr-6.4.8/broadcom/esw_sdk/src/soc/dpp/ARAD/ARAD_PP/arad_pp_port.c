...
#define ARAD_PP_PORT_STP_STATE_MAX                     (ARAD_PP_NOF_PORT_STP_STATES-1)

#define ARAD_PP_PORT_PORT_PROFILE_MAX                  (7)
#define ARAD_PP_PORT_DA_NOT_FOUND_PROFILE_MAX          (1)
#define ARAD_PP_PORT_PORT_TYPE_MAX                     (SOC_SAND_PP_NOF_PORT_L2_TYPES-1)
#define ARAD_PP_PORT_ORIENTATION_MAX                   (SOC_SAND_PP_NOF_HUB_SPOKE_ORIENTATIONS-1)
#define ARAD_PP_PORT_ETHER_TYPE_BASED_PROFILE_MAX      (7)
#define ARAD_PP_PORT_MTU_MAX                           (SOC_SAND_U32_MAX)
#define ARAD_PP_PORT_VLAN_TRANSLATION_MAX              (7)
#define ARAD_PP_PORT_VSI_PROFILE_MAX                   (7)
...
typedef SOC_PPC_PORT_STP_STATE_FLD_VAL                         ARAD_PP_PORT_STP_STATE_FLD_VAL;
#define ARAD_PP_PORT_STP_STATE_FLD_VAL_BLOCK               SOC_PPC_PORT_STP_STATE_FLD_VAL_BLOCK
#define ARAD_PP_PORT_STP_STATE_FLD_VAL_LEARN               SOC_PPC_PORT_STP_STATE_FLD_VAL_LEARN
#define ARAD_PP_PORT_STP_STATE_FLD_VAL_FORWARD             SOC_PPC_PORT_STP_STATE_FLD_VAL_FORWARD

typedef enum
{
  ARAD_PP_PORT_STP_STATE_EG_FLD_VAL_BLOCK = 1,
  ARAD_PP_PORT_STP_STATE_EG_FLD_VAL_LEARN = 1,/*actually block*/
  ARAD_PP_PORT_STP_STATE_EG_FLD_VAL_FORWARD = 0
} ARAD_PP_PORT_STP_STATE_EG_FLD_VAL;
  ...
  Arad_pp_procedure_desc_element_port[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_STP_STATE_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_TM_TO_PP_MAP_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_GET_PROCS_PTR),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORT_GET_ERRS_PTR),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORTS_REGS_INIT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PORTS_INIT),
  /*
  ...
  Arad_pp_error_desc_element_port[] =
{
   ...
   */
  {
    ARAD_PP_PORT_TOPOLOGY_ID_NDX_OUT_OF_RANGE_ERR,
    "ARAD_PP_PORT_TOPOLOGY_ID_NDX_OUT_OF_RANGE_ERR",
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_PORT_STP_STATES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  ...
  uint32
    epni_stp_data[8],
    ihp_stp_data[SOC_DPP_DEFS_MAX(IHP_STP_TABLE_NOF_LONGS)],
    pinfo_llr_tbl[3],
...
{ 
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_INFO_SET_UNSAFE);
  ...
  if (port_info->extend_p2p_info.enable_incoming_extend_p2p) 
  {
    pinfo_flp_tbl.program_selection_profile |= ARAD_PP_FLP_PORT_PROFILE_EXTENDED_P2P;
  }
  ...
  if(port_info->is_n_port){
    ...
    */
  if (arad_sw_db_tdm_mode_get(unit) != ARAD_MGMT_TDM_MODE_PACKET)
  {
    pct_tbl.port_profile = ARAD_EGR_PROG_TM_PORT_PROFILE_CPU;
  }
  ...
  res = arad_egq_pct_tbl_set_unsafe(unit, core_id, local_port_ndx, &pct_tbl);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  res = ARAD_PP_PORT_INFO_verify(unit, port_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_INFO_GET_VERIFY);
  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  ...
  )
{
  ...
  ARAD_PP_PORT_INFO_clear(port_info);
  ...
  pon_double_lookup_enabled = ARAD_PP_PON_DOUBLE_LOOKUP_PORT_GET(local_port_ndx);
  /************************************************************************/
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_STP_STATE_SET_UNSAFE);
  ...
  switch (stp_state)
  {
  case ARAD_PP_PORT_STP_STATE_BLOCK:
    fld_val = ARAD_PP_PORT_STP_STATE_FLD_VAL_BLOCK;
    break;
  case ARAD_PP_PORT_STP_STATE_LEARN:
    fld_val = ARAD_PP_PORT_STP_STATE_FLD_VAL_LEARN;
    break;
  case ARAD_PP_PORT_STP_STATE_FORWARD:
    fld_val = ARAD_PP_PORT_STP_STATE_FLD_VAL_FORWARD;
    break;
  default:
    SOC_SAND_ERR_IF_ABOVE_MAX(stp_state, ARAD_PP_PORT_STP_STATE_MAX, ARAD_PP_PORT_STP_STATE_OUT_OF_RANGE_ERR, 15, exit);
  }
  ...
  eg_stp_state_bit = (stp_state == ARAD_PP_PORT_STP_STATE_FORWARD) ? ARAD_PP_PORT_STP_STATE_EG_FLD_VAL_FORWARD : ARAD_PP_PORT_STP_STATE_EG_FLD_VAL_BLOCK;
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_STP_STATE_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(topology_id_ndx, SOC_DPP_DEFS_GET(unit, nof_topology_ids), ARAD_PP_PORT_TOPOLOGY_ID_NDX_OUT_OF_RANGE_ERR, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(stp_state, ARAD_PP_PORT_STP_STATE_MAX, ARAD_PP_PORT_STP_STATE_OUT_OF_RANGE_ERR, 30, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_STP_STATE_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_STP_STATE_GET_UNSAFE);
  ...
  switch (fld_val)
  {
  case ARAD_PP_PORT_STP_STATE_FLD_VAL_BLOCK:
     *stp_state = ARAD_PP_PORT_STP_STATE_BLOCK;
    break;
  case ARAD_PP_PORT_STP_STATE_FLD_VAL_LEARN:
    *stp_state = ARAD_PP_PORT_STP_STATE_LEARN;
    break;
  case ARAD_PP_PORT_STP_STATE_FLD_VAL_FORWARD:
    *stp_state = ARAD_PP_PORT_STP_STATE_FORWARD;
    break;
  }
...
uint32
  arad_pp_port_tm_to_pp_map_set_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_TM_PORT                             local_tm_port_ndx,
    SOC_SAND_IN  ARAD_PP_PORT_DIRECTION                      direction_ndx,
    SOC_SAND_IN  ARAD_PP_PORT                                local_pp_port
  )
{ /* not supported in Arad */
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_TM_TO_PP_MAP_SET_UNSAFE);
  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 1, exit);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("arad_pp_vsi_map_add_unsafe() not supported", local_tm_port_ndx, 0);
}
...
{ /* not supported in Arad */
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_TM_TO_PP_MAP_SET_VERIFY);
  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 1, exit);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("arad_pp_vsi_map_add_unsafe() not supported", local_tm_port_ndx, 0);
}
...
{ /* not supported in Arad */
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_TM_TO_PP_MAP_GET_VERIFY);
  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 1, exit);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("arad_pp_vsi_map_add_unsafe() not supported", local_tm_port_ndx, 0);
}
...
uint32
  arad_pp_port_tm_to_pp_map_get_unsafe(
    SOC_SAND_IN  int                                     unit,
    SOC_SAND_IN  ARAD_PP_TM_PORT                                 local_tm_port_ndx,
    SOC_SAND_OUT ARAD_PP_PORT                                    *local_pp_port_in,
    SOC_SAND_OUT ARAD_PP_PORT                                    *local_pp_port_out
  )
{ /* not supported in Arad */
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_TM_TO_PP_MAP_GET_UNSAFE);
  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 1, exit);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("arad_pp_vsi_map_add_unsafe() not supported", local_tm_port_ndx, 0);
}
  ...
  )
{
   ...
   * Special case if TM only for default trap destination
   */
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_ACTION_PROFILE, &(info->initial_action_profile), 14, exit);
  if (!SOC_DPP_PP_ENABLE(unit)) {
       ARAD_DO_NOTHING_AND_EXIT;
  }

  SOC_SAND_ERR_IF_ABOVE_MAX(info->port_profile, ARAD_PP_PORT_PORT_PROFILE_MAX, ARAD_PP_PORT_PORT_PROFILE_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->tpid_profile, ARAD_PP_TPID_PROFILE_MAX, ARAD_PP_PORT_TPID_PROFILE_OUT_OF_RANGE_ERR, 11, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(info->vlan_domain, SOC_DPP_DEFS_GET(unit, nof_vlan_domains), ARAD_PP_PORT_VLAN_DOMAIN_OUT_OF_RANGE_ERR, 12, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->port_type, ARAD_PP_PORT_PORT_TYPE_MAX, ARAD_PP_PORT_PORT_TYPE_OUT_OF_RANGE_ERR, 13, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->orientation, ARAD_PP_PORT_ORIENTATION_MAX, ARAD_PP_PORT_ORIENTATION_OUT_OF_RANGE_ERR, 19, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->ether_type_based_profile, ARAD_PP_PORT_ETHER_TYPE_BASED_PROFILE_MAX, ARAD_PP_PORT_ETHER_TYPE_BASED_PROFILE_OUT_OF_RANGE_ERR, 20, exit);
  /*ARAD_PP_STRUCT_VERIFY(ARAD_PP_PORT_EXTEND_P2P_INFO, &(info->extend_p2p_info), 21, exit);*/ 
  SOC_SAND_ERR_IF_ABOVE_MAX(info->mtu, ARAD_PP_PORT_MTU_MAX, ARAD_PP_PORT_MTU_OUT_OF_RANGE_ERR, 24, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->da_not_found_profile, ARAD_PP_PORT_DA_NOT_FOUND_PROFILE_MAX, ARAD_PP_PORT_PORT_PROFILE_OUT_OF_RANGE_ERR, 25, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(info->dflt_egress_ac, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_AC_ID_OUT_OF_RANGE_ERR, 26, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->vlan_translation_profile, ARAD_PP_PORT_VLAN_TRANSLATION_MAX, ARAD_PP_PORT_VT_PROFILE_OUT_OF_RANGE_ERR, 40, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->ac_p2p_to_pbb_vsi_profile, ARAD_PP_PORT_VSI_PROFILE_MAX, ARAD_PP_PORT_VSI_PROFILE_OUT_OF_RANGE_ERR, 50, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->label_pwe_p2p_vsi_profile, ARAD_PP_PORT_VSI_PROFILE_MAX, ARAD_PP_PORT_VSI_PROFILE_OUT_OF_RANGE_ERR, 60, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_PORT_INFO_verify()",0,0);
}
