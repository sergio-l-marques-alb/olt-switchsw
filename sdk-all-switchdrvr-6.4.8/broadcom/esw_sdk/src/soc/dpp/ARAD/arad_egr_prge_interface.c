...
/*  {Field enum                      , src_select                       , offset_src                               , offset_base } */
    {PrgePktFieldFheiSize            , ARAD_EGR_PROG_EDITOR_DATA_SRC_PKT, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_REG_2    , 1           },
    {PrgePktFieldFwdHdrOffset        , ARAD_EGR_PROG_EDITOR_DATA_SRC_PKT, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_REG_2    , 4           },
    {PrgePktFieldEthTypeNoTag        , ARAD_EGR_PROG_EDITOR_DATA_SRC_PKT, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_REG_1    , 28          },
    {PrgePktFieldEthTypeSingleTag    , ARAD_EGR_PROG_EDITOR_DATA_SRC_PKT, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_REG_1    , 36          },
