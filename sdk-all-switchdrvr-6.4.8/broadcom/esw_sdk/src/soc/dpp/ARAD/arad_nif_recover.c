...
STATIC
int arad_nif_recover_run_sequence(int unit, soc_pbmp_t *pbmp, int iterations, int is_init_sequence)
{
    int i = 0, tx_counters_match = 1, rx_traffic_rcv;
    char* fail_type;
...
int arad_nif_recover_run_recovery_test(int unit, soc_pbmp_t* pbmp, int iterations, int is_init_sequence)
{
    ...
    SOCDNX_IF_ERR_EXIT(arad_nif_recover_run_sequence(unit, &xlp_pbmp, iterations, is_init_sequence));
    SOCDNX_IF_ERR_EXIT(arad_nif_recover_run_sequence(unit, &clp_pbmp, iterations, is_init_sequence));
