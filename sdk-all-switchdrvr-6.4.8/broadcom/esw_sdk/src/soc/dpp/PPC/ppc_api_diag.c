...
void soc_ppc_diag_glem_outlif_print(soc_ppc_diag_glem_outlif_t *info){
    ...
    /* Format the display according to the lif's source. */
    switch (info->source) {
    ...
    case soc_ppc_diag_glem_outlif_source_user:
        /* 
         *  If the user gave an outlif to check, there's no point is displaying its source.
         *  Also, unlike in last packet lookup, the accessed value may not always be true,
         *  so it's worth displaying.
         */ 
