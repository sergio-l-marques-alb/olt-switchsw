  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_sa_auth_port_info_set,(unit, core_id, local_port_ndx, port_auth_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_sa_auth_port_info_get,(unit, core_id, local_port_ndx, port_auth_info));
