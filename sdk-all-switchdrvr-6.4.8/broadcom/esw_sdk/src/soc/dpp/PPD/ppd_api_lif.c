    ...
    SOC_SAND_OUT uint8                              *found)
{
    ...
    /* SOC_PPD_ARAD_ONLY_DEVICE_CALL(l2_lif_extender_get,(unit, extender_key, lif_index, extender_info, found)); */

    SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  /* SOC_PPD_FUNC_PRINT(soc_ppd_l2_lif_extender_get_print,(unit, extender_key, lif_index, extender_info)); */
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_l2_lif_extender_get()", 0, 0);
}
