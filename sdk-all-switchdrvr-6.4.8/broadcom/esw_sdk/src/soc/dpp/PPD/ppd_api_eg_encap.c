    ...
    SOC_SAND_IN  SOC_PPC_EG_ENCAP_PROTECTION_INFO       *protection_info)
{
  ...
  SOC_SAND_CHECK_NULL_INPUT(protection_info);

  SOC_PPD_ARAD_ONLY_DEVICE_CALL(eg_encap_protection_info_set,(unit, out_lif_id, is_full_entry_extension, protection_info));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_eg_encap_protection_info_set_print,(unit, protection_info));
  ...
  )
{
  ...
  SOC_PPC_EG_ENCAP_ENTRY_INFO_print(unit, info);
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
...
void soc_ppd_eg_encap_protection_info_set_print(
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  SOC_PPC_EG_ENCAP_PROTECTION_INFO   *protection_info)
{
  LOG_CLI((BSL_META_U(unit,
                      "protection_info:")));
  SOC_PPC_EG_ENCAP_PROTECTION_INFO_print((protection_info));
