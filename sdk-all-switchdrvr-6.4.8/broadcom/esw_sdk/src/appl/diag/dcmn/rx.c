...
{    
     ...
     */
      ...
      if(pkt->src_port == (int8)ARAD_OLP_PORT_ID) {
            ...
            learn_events.events = sal_alloc(sizeof(SOC_PPD_FRWRD_MACT_EVENT_INFO)*learn_msg.max_nof_events,"learn_events.events");
