...
{   
  ...
  SOC_PPD_MPLS_TERM_LKUP_INFO_clear(&prm_lkup_info);
...
{   
  ...
  SOC_PPD_MPLS_TERM_LKUP_INFO_print(&prm_lkup_info);
...
{   
  ...
  uint32   
    prm_range_ndx;
  SOC_PPD_MPLS_TERM_LABEL_RANGE_INFO   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_MPLS_TERM_LABEL_RANGE_INFO_clear(&prm_label_range_info);
  prm_label_range_info.term_info.next_prtcl = SOC_PPD_L3_NEXT_PRTCL_TYPE_MPLS;
  ...
  { 
    ...
    if ((prm_label_range_info.term_info.next_prtcl == SOC_PPD_L3_NEXT_PRTCL_TYPE_IPV4) ||
       (prm_label_range_info.term_info.next_prtcl == SOC_PPD_L3_NEXT_PRTCL_TYPE_IPV6))
    {
      prm_label_range_info.term_info.next_prtcl = SOC_PPD_L3_NEXT_PRTCL_TYPE_IPV4;
    }
  } 
...
{   
  ...
  SOC_PPD_MPLS_TERM_LABEL_RANGE_INFO_print(&prm_label_range_info);
...
{   
  uint32 
    ret;   
  SOC_PPD_MPLS_TERM_RESERVED_LABELS_GLBL_INFO   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_MPLS_TERM_RESERVED_LABELS_GLBL_INFO_clear(&prm_reserved_labels_info);
...
{   
  ...
  SOC_PPD_MPLS_TERM_RESERVED_LABELS_GLBL_INFO_print(&prm_reserved_labels_info);
...
{   
  ...
  SOC_SAND_PP_MPLS_LABEL   
    prm_label_ndx;
  SOC_PPD_MPLS_TERM_RESERVED_LABEL_INFO   
    prm_label_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_MPLS_TERM_RESERVED_LABEL_INFO_clear(&prm_label_info);
  ...
  { 
    ...
    if ((prm_label_info.term_info.next_prtcl == SOC_PPD_L3_NEXT_PRTCL_TYPE_IPV4) ||
      (prm_label_info.term_info.next_prtcl == SOC_PPD_L3_NEXT_PRTCL_TYPE_IPV6))
    {
      prm_label_info.term_info.next_prtcl = SOC_PPD_L3_NEXT_PRTCL_TYPE_IPV4;
    }
  } 
  ...
  { 
    ...
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
    prm_label_info.non_bos_action.trap_code = (SOC_PPD_TRAP_CODE)param_val->numeric_equivalent;
  } 
  */
  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_MPLS_TERM_RESERVED_LABEL_INFO_SET_RESERVED_LABEL_INFO_SET_LABEL_INFO_NON_BOS_ACTION_TRAP_CODE_LSB_ID,1)) 
  { 
    ...
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
    prm_label_info.non_bos_action.trap_code = (SOC_PPD_TRAP_CODE)param_val->value.ulong_value;
  } 
  ...
  { 
    ...
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
    prm_label_info.bos_action.trap_code = (SOC_PPD_TRAP_CODE)param_val->numeric_equivalent;
  } 
  */
  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_MPLS_TERM_RESERVED_LABEL_INFO_SET_RESERVED_LABEL_INFO_SET_LABEL_INFO_BOS_ACTION_TRAP_CODE_LSB_ID,1)) 
  { 
    ...
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
    prm_label_info.bos_action.trap_code = (SOC_PPD_TRAP_CODE)param_val->value.ulong_value;
  } 
...
{   
  ...
  SOC_PPD_MPLS_TERM_RESERVED_LABEL_INFO_print(&prm_label_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_MPLS_TERM_COS_INFO_clear(&prm_term_cos_info);
...
{   
  ...
  SOC_PPD_MPLS_TERM_COS_INFO_print(&prm_term_cos_info);
...
{   
  uint32 
    ret;   
  SOC_PPD_MPLS_TERM_LABEL_COS_KEY   
    prm_cos_key;
  SOC_PPD_MPLS_TERM_LABEL_COS_VAL   
    prm_cos_val;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_MPLS_TERM_LABEL_COS_KEY_clear(&prm_cos_key);
  SOC_PPD_MPLS_TERM_LABEL_COS_VAL_clear(&prm_cos_val);
...
{   
  ...
  SOC_PPD_MPLS_TERM_LABEL_COS_VAL_print(&prm_cos_val);
...
{   
  uint32
    ...
    ret;   
  SOC_PPD_MPLS_TERM_PROFILE_INFO  
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_MPLS_TERM_PROFILE_INFO_clear(&prm_term_profile_info);
  ...
  {  
	...
	UI_MACROS_CHECK_GET_VAL_OF_ERROR;   
	prm_term_profile_info.flags |= (uint8)param_val->value.ulong_value ? SOC_PPD_MPLS_TERM_DISCARD_TTL_0 : 0;
  } 
  ...
  {  
	...
	UI_MACROS_CHECK_GET_VAL_OF_ERROR;   
	prm_term_profile_info.flags |= (uint8)param_val->value.ulong_value ? SOC_PPD_MPLS_TERM_DISCARD_TTL_1 : 0;
  } 
  ...
  {  
	...
	UI_MACROS_CHECK_GET_VAL_OF_ERROR;   
	prm_term_profile_info.flags |= (uint8)param_val->value.ulong_value ? SOC_PPD_MPLS_TERM_HAS_CW : 0;
  } 
  ...
  {  
	...
	UI_MACROS_CHECK_GET_VAL_OF_ERROR;   
	prm_term_profile_info.flags |= (uint8)param_val->value.ulong_value ? SOC_PPD_MPLS_TERM_SKIP_ETH : 0;
  } 
...
{   
  ...
  SOC_PPD_MPLS_TERM_PROFILE_INFO_print(&prm_term_profile_info);
