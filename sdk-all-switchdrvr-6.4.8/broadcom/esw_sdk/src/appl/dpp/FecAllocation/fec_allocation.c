...
static int fec_allocation_copy_fec(int unit, bcm_if_t desired_fec_copy_id, bcm_if_t original_fec_id, bcm_if_t failover_if_id, bcm_if_t failover_id) {
   ...
   {
		 bcm_l3_egress_get(unit,original_fec_id-1,&bug);
 ...
 *
 */
int fec_allocation_main(int unit)
{
  int rc;
  bcm_l3_egress_ecmp_t ecmp[100];
  bcm_l3_egress_t regular_fecs[100];
  bcm_l3_egress_t superfec_base[100];
  bcm_l3_egress_t superfec_failover[100];
