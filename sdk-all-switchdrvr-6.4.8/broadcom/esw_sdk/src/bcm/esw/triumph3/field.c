...
STATIC
int _field_tr3_meter_index_in_use(int unit,
                                 _field_meter_pool_t *f_mp,
                             ...
                             )
{
    ...
    _field_meter_pool_t     *f_logical_mp = NULL;   /* Logical Meter pool descriptor */
    ...
    uint32                  *prate, *pburst;
    uint8                   mode_modifier;
    uint8                   meter_offset = 0;
    uint8                   meter_pair_mode = 0;
    int                     pool_num;
    int                     pool_index;
    int                     rv, policer_id, mem_idx;
    int                     logicalIdx = 0;
    uint8                   logical_pool_idx = 0;   /* Logical Meter pool index. */
    ...
    if (((stage_id != _BCM_FIELD_STAGE_EGRESS)
         && BCM_SUCCESS(_field_tr3_meter_index_in_use(
                        unit, f_mp, meter_pair_mode, mode_modifier, pool_index)))
