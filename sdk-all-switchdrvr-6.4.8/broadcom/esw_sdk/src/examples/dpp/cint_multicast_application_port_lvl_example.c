/* $Id: arad_egr_queuing.c,v 1.88 Broadcom SDK $
...
/* Verify script cint_multicast_applications.c is in the same folder */
...
int run_port_lvl_multicast_example1(int unit)
{
...
int run_port_lvl_multicast_example2(int unit)
{
    bcm_error_t rv = BCM_E_NONE;
    bcm_gport_t voqs[2];
    int cuds[2];
...
int set_params_port_lvl_multicast (int is_arad) {
    return set_params_port_lvl_multicast_with_ports (1, (is_arad ? 14 : 4), 1, BCM_IF_INVALID);
}

/*util function to set relevent param for arad and PetraB*/
int set_params_port_lvl_multicast_with_ports (int port0, int port1, int is_arad, int cud0) {
