...
/*
forward - first header for ECMP hashing. if forward==1 first header will be the forwarding header, 
             else first header will be the header below the forwarding header (the terminated header) 
*/ 
int ecmp_first_header_set(int unit, int in_port, int forward) {
  int rc;
  int arg;
  bcm_switch_control_t type;
