...
/*               global_mac              |            my_mac_lsb              |                payload_mac */              
    {0x00, 0x11, 0x00, 0x00, 0x00, 0x00}, {0x00, 0x00, 0x00, 0x00, 0x01, 0x11},   {0x00, 0x00, 0x00, 0x00, 0x01, 0x12},    
};
...
int mpls_protection_create_l3_interfaces(int unit){
   ...
   /* configure fec for next hop information */
    ...
    l3_egress.vlan = l3_egress.intf = cint_mpls_protection_info.vsi;
    l3_egress.gport = cint_mpls_protection_info.port2;
    ...
    cint_mpls_protection_info.fec = l3_egress.l3_egress_id;;
