...
/* $Id: sysLib.c,v 1.27 2011/07/21 16:14:28 yshtil Exp $
...
#ifdef AUXCLK       /* not defined by default */
...
#include "sysEtEnd.c"
#include "sysNet.c"
#ifdef ROBODVT /* For internal ROBO DVT test */
#include "robotxrx.c"
#endif
...
void sysHwInit2 (void)
{
    ...
    */
    ...
    /* Get the END device unit number */
#ifndef BUILD_VXBOOT
    name = getvar(NULL,"boardtype");
    if (name == NULL) {
        end_unit = 0;
    ...
    Bcm53000HiMemSize = SI_TLB_SDRAM_SIZE-BCM53000_SDRAM_SZ;
    Bcm53000HiMemAddr = SI_TLB_SDRAM_VIRT_CACHED+BCM53000_SDRAM_SZ;

    memAddToPool(Bcm53000HiMemAddr,Bcm53000HiMemSize); 
