;
; $Id: sdk56629.asm,v 1.6 Broadcom SDK $
;
...
; 
;
; This is the default program for the (25 GE + 8 XE/HG port) BCM56629 SDKs.
; To start it, use the following commands from BCM:
;
;       led load sdk56629.hex
;       led auto on
;       led start
;
...
;       A01/L01,L02/A02,A03/L03,L04/A04,A05/L05,L06/A06,A07/L07,L08/A08
;
