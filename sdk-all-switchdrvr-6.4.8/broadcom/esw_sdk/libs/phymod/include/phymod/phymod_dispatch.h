...
typedef int (*__dispatch__phymod_phy_intr_enable_set_f)(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t enable);
typedef int (*__dispatch__phymod_phy_intr_enable_get_f)(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t* enable);
typedef int (*__dispatch__phymod_phy_intr_status_get_f)(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t* intr_status);
typedef int (*__dispatch__phymod_phy_intr_status_clear_f)(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src);
