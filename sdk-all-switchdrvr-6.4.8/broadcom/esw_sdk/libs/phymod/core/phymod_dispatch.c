...
int phymod_phy_rx_signal_detect_get(const phymod_phy_access_t* phy, uint32_t* rx_pmd_locked)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_rx_signal_detect_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_rx_signal_detect_get(phy, rx_pmd_locked);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_intr_source_t_validate(phymod_intr_source_t phymod_intr_source)
{
    ...
    if(phymod_intr_source >= phymodIntrSrcCount) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("Parameter is out of range")));
    }
...
int phymod_phy_intr_enable_set(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t enable)
{
    ...
    if(PHYMOD_E_OK != phymod_intr_source_t_validate(intr_src)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("intr_src validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_set(phy, intr_src, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_phy_intr_enable_get(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t* enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_get(phy, intr_src, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_phy_intr_status_get(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t* intr_status)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_get(phy, intr_src, intr_status);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_phy_intr_status_clear(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_clear) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_clear(phy, intr_src);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
