...
#define MADURA_FW_DLOAD_RETRY_CNT           20
...
#define MADURA_DISABLE                      0
#define MADURA_ENABLE                       1
#define MADURA_M0_INTR_GRP                  0 
#define MADURA_MM_INTR_GRP                  1
#define MADURA_DF_INTR_GRP                  2 
#define MADURA_DEMUX_INTR_GRP               3 
#define MADURA_MUX_INTR_GRP                 4 
...
typedef struct {
    ...
    uint16_t reserved_a1; 
    MADURA_CORE_TYPE passthru_sys_side_core;
    uint16_t reserved_a2;
...
typedef enum {
  ...
  /*Sesto Specific*/
  MADURA_PLL_MODE_33  = 0x10,
  MADURA_PLL_MODE_32  = 0x11,
  MADURA_PLL_MODE_16  = 0x12,
  MADURA_PLL_MODE_82P5= 0x13,
  MADURA_PLL_MODE_40  = 0x14,
  MADURA_PLL_MODE_70  = 0x15,
  MADURA_PLL_MODE_INVALID = -1
} MADURA_PLL_MODE_E;

typedef enum  {
  MADURA_INT_M0_SLV_SYSRESET_REQ = 0,
  MADURA_INT_M0_MST_SYSRESET_REQ,
  MADURA_INT_M0_SLV_LOCKUP,
  MADURA_INT_M0_MST_LOCKUP,
  MADURA_INT_M0_SLV_MISC_INTR,
  MADURA_INT_M0_MST_MISC_INTR,
  MADURA_INT_M0_SLV_MSGOUT_INTR,
  MADURA_INT_M0_MST_MSGOUT_INTR,
  MADURA_INT_M0_SLV_DED,
  MADURA_INT_M0_SLV_SEC,
  ...
  MADURA_INT_MUX_PMD_LOCK_LOST,
  MADURA_INT_MUX_PMD_LOCK_FOUND,
  MADURA_INT_MUX_SIGDET_LOST,
  MADURA_INT_MUX_SIGDET_FOUND,
  MADURA_INT_PLL_10G_LOCK_LOST,
  MADURA_INT_PLL_10G_LOCK_FOUND,
  MADURA_INT_MERLIN_PMI_ARB_WDOG_EXP,
  MADURA_INT_MERLIN_PMI_M0_WDOG_EXP,
  MADURA_INT_DEMUX_PMD_LOCK_LOST,
  MADURA_INT_DEMUX_PMD_LOCK_FOUND,
  MADURA_INT_DEMUX_SIGDET_LOST,
  MADURA_INT_DEMUX_SIGDET_FOUND,
  MADURA_INT_PLL_25G_LOCK_LOST,
  MADURA_INT_PLL_25G_LOCK_FOUND,
  MADURA_INT_FALCON_PMD_ARB_WDOG_EXP,
  MADURA_INT_FALCON_PMD_M0_WDOG_EXP,
  MADURA_INT_CL91_RX_ALIGN_LOST,
  MADURA_INT_CL91_RX_ALIGN_FOUND,
  MADURA_INT_DEMUX_ONEG_INBAND_MSG_LOST,
  MADURA_INT_DEMUX_ONEG_INBAND_MSG_FOUND,
  MADURA_INT_DEMUX_PCS_MON_LOCK_LOST,
  MADURA_INT_DEMUX_PCS_MON_LOCK_FOUND,
  MADURA_INT_DEMUX_FIFOERR,
  MADURA_INT_DEMUX_CL73_AN_RESTARTED,
  MADURA_INT_DEMUX_CL73_AN_COMPLETE,
  MADURA_INT_CL91_TX_ALIGN_LOST,
  MADURA_INT_CL91_TX_ALIGN_FOUND,
  MADURA_INT_MUX_ONEG_INBAND_MSG_LOST,
  MADURA_INT_MUX_ONEG_INBAND_MSG_FOUND,
  MADURA_INT_MUX_PCS_MON_LOCK_LOST,
  MADURA_INT_MUX_PCS_MON_LOCK_FOUND,
  MADURA_INT_MUX_FIFOERR,
  MADURA_INT_MUX_CL73_AN_RESTARTED,
  MADURA_INT_MUX_CL73_AN_COMPLETE,
  MADURA_INT_MUX_CL73_AN_RESTARTED_P2,
  MADURA_INT_MUX_CL73_AN_RESTARTED_P1,
  MADURA_INT_MUX_CL73_AN_COMPLETE_P2,
  MADURA_INT_MUX_CL73_AN_COMPLETE_P1
} MADURA_INTR_TYPE_E;
...
#define MADURA_CHIP_FIELD_WRITE(acc, reg_name, field_name, value)                 \
    do {                                                                         \
        reg_name##_t cfw_tmp;                                               \
        READ_MADURA_PMA_PMD_REG(acc, reg_name##_ADR, cfw_tmp.data);               \
        cfw_tmp.fields.field_name = value;                                       \
        WRITE_MADURA_PMA_PMD_REG(acc, reg_name##_ADR, cfw_tmp.data);              \
      } while (0);

#define MADURA_CHIP_FIELD_READ(acc, reg_name, field_name, value)                  \
    do {                                                                         \
        reg_name##_TYPE_T cfr_tmp;                                               \
        READ_MADURA_PMA_PMD_REG(acc, reg_name##_ADR, cfr_tmp.data);               \
...
#define MADURA_GET_CORE(_C, _LT, _ST)                                                                               \
    {                                                                                                              \
        ...
        } else if (_C.data_rate == MADURA_SPD_100G) {                                                               \
            _LT = (aux_mode_m->gearbox_100g_inverse_mode) ? MADURA_2X_FALCON_CORE : MADURA_FALCON_CORE ;                  \
        } else {                                                                                                   \
...
#define MADURA_GET_CORE_SLICE_INFO(_ACC, _IP, _CON, _C_V, _M_V)           \
    do {                                                                 \
        ...
        _madura_lane_cast_get(_ACC, _IP, _C_V, _M_V);                     \
    }while(0);
...
#define MADURA_GET_PORT_FROM_MODE(_C, _PRT, aux_mode)                          \
    do {                                                                      \
        if (_C->data_rate == MADURA_SPD_100G) {                                \
            ...
            _PRT = 2;                                                         \
        } else if (_C->data_rate == MADURA_SPD_20G) {                          \
            _PRT = 2;                                                         \
...
typedef enum {
    ...
    MADURA_CL73_1000BASE_KX = 0x1,
    MADURA_CL73_10GBASE_KX4 = 0x2,
    MADURA_CL73_10GBASE_KR = 0x4,
    MADURA_CL73_40GBASE_KR4 = 0x8,
    MADURA_CL73_40GBASE_CR4 = 0x10,
    MADURA_CL73_100GBASE_CR10 = 0x20,
    MADURA_CL73_100GBASE_KP4 = 0x40,
...
#define MADURA_FALCON 
#define MADURA_MERLIN 
...
int _madura_map_mer_pll_div(MADURA_PLL_MODE_E pll_mode);
...
int _madura_ext_intr_status_get(const phymod_access_t *pa, uint32_t intr_type, uint32_t* intr_status);

int _madura_ext_intr_enable_set(const phymod_access_t *pa, uint32_t intr_type, uint32_t enable);

int _madura_ext_intr_enable_get(const phymod_access_t *pa, uint32_t intr_type, uint32_t* enable);

int _madura_ext_intr_status_clear(const phymod_access_t *pa, uint32_t intr_type);
...
int _madura_autoneg_set(const phymod_access_t* pa, const phymod_autoneg_control_t* an);
...
int phymod_aer_iblk_read(const phymod_access_t *pa, uint32_t reg_addr, uint32_t *data);
int phymod_aer_iblk_write(const phymod_access_t *pa, uint32_t addr, uint32_t data);
int madura_reg_modify(const phymod_access_t *pa,
                     uint32_t addr,
                     uint16_t reg_data,
                     uint16_t reg_mask);
