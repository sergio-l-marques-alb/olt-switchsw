/****************************************************************************
 * File Name  :  falcon2_madura_functions.h
 * Created On :  29/04/2013
 * Created By :  Kiran Divakar
 * Description:  Header file with API functions for Serdes IPs
 * Revision   :  $Id: falcon2_madura_functions.h 1077 2015-07-06 14:47:39Z kirand $
 *
...
#ifndef FALCON2_MADURA_API_FUNCTIONS_H
#define FALCON2_MADURA_API_FUNCTIONS_H
 ...
 */
#define _error(err_code) (0) /* _print_err_msg(err_code) */
...
/**
 * This build includes register access macros for the FALCON2/MADURA core.
 */
#include "falcon2_madura_fields.h"
 ...
 * variables.
 */
#include "falcon2_madura_api_uc_vars_rdwr_defns.h"
 ...
 * either case, execution should not be allowed to proceed on NULL return.
 */
#define ENULL_STRNCAT(dst, src) ENULL((USR_STRCAT((dst), (src))))
