...
#define BCM_HGPROXY_SUBTAG_COE_PORT_ITER(i, gport)                          \
    if (soc_feature(unit, soc_feature_hgproxy_subtag_coe) &&                \
        ...
        for (i = 0; i < TD2P_SUBPORT_COE_PORT_MAX; i++)                \
...
#define _BCM_SB2_LINKPHY_TX_DATA_BUF_START_ADDR_MAX 3392
#define _BCM_SB2_LINKPHY_TX_DATA_BUF_END_ADDR_MIN   31
#define _BCM_SB2_LINKPHY_TX_DATA_BUF_END_ADDR_MAX   3423
...
* Ports.
*/
#define _BCM_KT2_LINKPHY_TX_STREAM_START_ADDR_OFFSET 0x60

#define _BCM_KT2_LINKPHY_STREAM_ID_FLUSH_TIMEOUT    20000

#define _BCM_SB2_LINKPHY_TX_STREAM_START_ADDR_OFFSET 0x80
