...
#define _FP_PORT_BITWIDTH(_unit_)    \
                  ((SOC_IS_TOMAHAWK(_unit_) || SOC_IS_KATANA2(_unit_)) ? 8 :    \
                   (SOC_IS_TD_TT(_unit_) || SOC_IS_KATANA(_unit_)) ? 7 : 6)
...
typedef enum _bcm_field_internal_element_e {
    ...
    _bcmFieldInternalElementCount = 361
...
extern int _field_entry_info_retrieve(int unit, bcm_field_entry_t *eid,
    ...
    _field_entry_wb_t *f_ent_wb, uint8 *color_independent);
