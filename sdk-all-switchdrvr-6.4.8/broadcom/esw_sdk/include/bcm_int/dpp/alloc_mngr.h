...
typedef struct {
    ...
    int egr_interface_unicast_thresh_map[SOC_DPP_IMP_DEFS_MAX(NOF_CORE_INTERFACES)*SOC_DPP_IMP_DEFS_MAX(NOF_CORES)];
    int egr_interface_multicast_thresh_map[SOC_DPP_IMP_DEFS_MAX(NOF_CORE_INTERFACES)*SOC_DPP_IMP_DEFS_MAX(NOF_CORES)];
