...
typedef struct bcm_dpp_am_local_inlif_table_bank_info_s
{
    uint8  valid;
    uint32 phase_bmp;
    bcm_dpp_am_local_inlif_six_packs_info_t packs_info[_BCM_DPP_AM_LOCAL_LIF_NOF_INLIF_HALF_ENTRIES_PER_BANK/6];
