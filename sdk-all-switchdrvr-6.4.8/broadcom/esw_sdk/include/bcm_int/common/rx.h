...
/* Some default values */
#define ROBO_RX_PKT_SIZE_DFLT       (2 * 1024)    /* 2 K packets */
#define ROBO_RX_PPC_DFLT            1             /* 1 pkts/chain */
#define ROBO_RX_CHAINS_DFLT         (NRXD-1)      /* # of chains */
#define ROBO_RX_CHAINS_MAX (NRXD-1)      /* # of chains */

#define ROBO_RX_Q_MAX_DFLT 1000
...
typedef struct rx_chan_ctl_s {
    ...
    eth_dv_t       *robo_dv[ROBO_RX_CHAINS_MAX];
...
#define BCM_RX_F_STARTED          0x1  /* Started? */
    ...
    int               pkts_owned;
    int               tunnelled;
    _sbx_reason_map_t reasonMap[SBX_RX_MAX_REASONS];
