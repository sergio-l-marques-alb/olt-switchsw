...
/*********************************************************************
* NAME:
*   soc_sand_multi_set_get_multis_array_ptr_from_handle
* TYPE:
*   PROC
* DATE:
*   May 31 2015
* FUNCTION:
*   Get value of 'multis_array' pointer (See SOC_SAND_MULTI_SET_INFO)
*   from handle.
* INPUT:
...
*   SOC_SAND_INOUT  SOC_SAND_MULTI_SET_INFO        **multis_array_ptr_ptr -
*     This procedure loads pointed memory by address of corersponding
*     element in array of pointers 'multis_array' (of specified multi set).
*     This is the address to an element of type SOC_SAND_MULTI_SET_INFO.
* REMARKS:
*   This procedure is exceptional. It is added here so we can use
*   the buffer pointed by 'multis_array' as a work space whose address
...
*   and NOT WRITE into pointed SOC_SAND_MULTI_SET_INFO structure.
*   
* RETURNS:
*     OK or ERROR indication.
*********************************************************************/
