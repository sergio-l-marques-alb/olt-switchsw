...
#define SOC_PPC_OAM_OPCODE_MAP_BFD    0
...
#define SOC_PPC_OAM_NUMBER_OF_BITS_USED_BY_OUTLIF_PCP       (SOC_IS_JERICHO_A0(unit) || SOC_IS_QMX(unit))? 0 :1  
...
#define SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_LOOPBACK_PERIOD_IN_KPPS       0x800
