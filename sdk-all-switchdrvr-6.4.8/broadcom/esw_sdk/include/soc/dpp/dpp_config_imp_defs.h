...
#define SOC_DPP_IMP_DEFS_MAX5(x0,x1,x2,x3,x4)                    SOC_DPP_IMP_DEFS_MAX2(SOC_DPP_IMP_DEFS_MAX2(SOC_DPP_IMP_DEFS_MAX2(SOC_DPP_IMP_DEFS_MAX2(x0, x1),x2),x3),x4)
#define SOC_DPP_IMP_DEFS_MAX(dpp_define)                 SOC_DPP_IMP_DEFS_MAX5(SOC_DPP_GET_QAX(dpp_define),SOC_DPP_GET_ARDON(dpp_define),SOC_DPP_GET_JERICHO(dpp_define),SOC_DPP_GET_PETRAB(dpp_define),SOC_DPP_GET_ARAD(dpp_define))
