...
#define SOC_TMC_CNT_LIF_COUNTING_NUMBER_OF_STACK_IDS(source) ((source == SOC_TMC_CNT_SRC_TYPE_ING_PP) ? 4 : 3)
#define SOC_TMC_CNT_LIF_COUNTING_MASK_SINGLE_SIZE 2
#define SOC_TMC_CNT_LIF_COUNTING_MASK_SIZE(source) (SOC_TMC_CNT_LIF_COUNTING_MASK_SINGLE_SIZE * SOC_TMC_CNT_LIF_COUNTING_NUMBER_OF_STACK_IDS(source))
#define SOC_TMC_CNT_LIF_COUNTING_MASK_MAX(source) ((1 << SOC_TMC_CNT_LIF_COUNTING_MASK_SIZE(source)) - 1)
...
#define SOC_TMC_CNT_LIF_COUNTING_MASK_MASK(source, lif_stack_level) ((lif_stack_level >= SOC_TMC_CNT_LIF_COUNTING_NUMBER_OF_STACK_IDS(source)) ? 0x0 : 0x3)
#define SOC_TMC_CNT_LIF_COUNTING_MASK_SHIFT(lif_stack_level) (lif_stack_level * SOC_TMC_CNT_LIF_COUNTING_MASK_SINGLE_SIZE)
#define SOC_TMC_CNT_LIF_COUNTING_MASK_SET(source, lif_counting_mask, lif_range_stack_0, lif_range_stack_1, lif_range_stack_2, lif_range_stack_3) \
            (lif_counting_mask = \
            ((SOC_TMC_CNT_LIF_COUNTING_MASK_MASK(source, 0) & lif_range_stack_0) << SOC_TMC_CNT_LIF_COUNTING_MASK_SHIFT(0)) | \
            ((SOC_TMC_CNT_LIF_COUNTING_MASK_MASK(source, 1) & lif_range_stack_1) << SOC_TMC_CNT_LIF_COUNTING_MASK_SHIFT(1)) | \
            ((SOC_TMC_CNT_LIF_COUNTING_MASK_MASK(source, 2) & lif_range_stack_2) << SOC_TMC_CNT_LIF_COUNTING_MASK_SHIFT(2)) | \
            ((SOC_TMC_CNT_LIF_COUNTING_MASK_MASK(source, 3) & lif_range_stack_3) << SOC_TMC_CNT_LIF_COUNTING_MASK_SHIFT(3)))

#define SOC_TMC_CNT_LIF_COUNTING_MASK_GET(source, lif_counting_mask, lif_stack_level) \
                                ((lif_counting_mask >> SOC_TMC_CNT_LIF_COUNTING_MASK_SHIFT(lif_stack_level)) & SOC_TMC_CNT_LIF_COUNTING_MASK_MASK(source, lif_stack_level))

#define SOC_TMC_CNT_LIF_COUNTING_MASK_TO_FIELD_VAL(lif_counting_mask_i)  (((~lif_counting_mask_i) & 0x2) | (lif_counting_mask_i & 0x1))

#define SOC_TMC_CNT_LIF_COUNTING_MASK_FIELD_VAL_GET(source, lif_counting_mask, lif_stack_level) \
            SOC_TMC_CNT_LIF_COUNTING_MASK_TO_FIELD_VAL(SOC_TMC_CNT_LIF_COUNTING_MASK_GET(source, lif_counting_mask, lif_stack_level))

/*In the IRPP - we cannot count the ountter-most-LIF and field-val 0 is don't count anything*/
