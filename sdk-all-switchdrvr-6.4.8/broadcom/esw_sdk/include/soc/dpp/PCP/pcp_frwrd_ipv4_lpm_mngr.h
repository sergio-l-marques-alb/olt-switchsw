/* $Id: pcp_frwrd_ipv4_lpm_mngr.h,v 1.3 Broadcom SDK $
...
#ifndef __SOC_PCP_IPV4_LPM_INCLUDED__
/* { */
#define __SOC_PCP_IPV4_LPM_INCLUDED__
...
*************/
/* { */
typedef SOC_SAND_U64 PCP_IPV4_LPM_MNGR_INST;

/*
 * LPM model
 */
typedef enum {
  PCP_IPV4_LPM_PXX_MODEL_UNKNOWN = 0,
  PCP_IPV4_LPM_PXX_MODEL_P4X = 1, /* Timna with  elide enc. only */
  PCP_IPV4_LPM_PXX_MODEL_P6X = 2, /* Soc_petra A */ 
  PCP_IPV4_LPM_PXX_MODEL_P6N = 3, /* Soc_petra B */
  PCP_IPV4_LPM_PXX_MODEL_P4X_COMPLETE = 4, /* Timna */
  PCP_IPV4_LPM_PXX_MODEL_P6M = 5, /* for Arad */
  PCP_IPV4_LPM_PXX_MODEL_LP4 = 6  /* PCP (Ramon) */
} PCP_IPV4_LPM_PXX_MODEL;


/*********************************************************************
* NAME:
*     PCP_IPV4_LPM_MNGR_SW_DB_TREE_NODE_INFO_SET
* FUNCTION:
...
typedef
  uint32
    (*PCP_IPV4_LPM_MNGR_SW_DB_MEM_ALLOCATOR_GET)(
...
typedef
  uint32
    (*PCP_IPV4_LPM_MNGR_SW_DB_PAT_TREE_GET)(
      SOC_SAND_IN  int                      prime_handle,
      SOC_SAND_IN  uint32                      sec_handle,
      SOC_SAND_IN  uint32                      vrf_ndx,
      SOC_SAND_OUT SOC_SAND_PAT_TREE_INFO            **pat_tree
...
typedef
  uint32
    (*PCP_IPV4_LPM_MNGR_SW_DB_NOF_ENTRIES_FOR_HW_LPM_SET_FUN)(
...
typedef
  uint32
    (*PCP_IPV4_LPM_MNGR_SW_DB_NOF_ENTRIES_FOR_HW_LPM_GET_FUN)(
      SOC_SAND_IN  int                    unit,
...
#define PCP_LPV4_LPM_SUPPORT_CACHE  (1)
#define PCP_LPV4_LPM_SUPPORT_DEFRAG  (2)
...
typedef struct {
 ...
 /* primary handle of the LPM manager to identify the LPM manager instance */
  ...
  /* p6x, p4x, p6n, etc. */
  PCP_IPV4_LPM_PXX_MODEL pxx_model;
  /* memory managements length nof_memories */
  PCP_ARR_MEM_ALLOCATOR_INFO *mem_allocators;
  ...
  PCP_IPV4_LPM_MNGR_SW_DB_MEM_ALLOCATOR_GET mem_alloc_get_fun;
/*  pat_tree_get_fun maps from VRF to PAT tree instance */
  PCP_IPV4_LPM_MNGR_SW_DB_PAT_TREE_GET pat_tree_get_fun;
...
typedef struct {
  ...
  uint32  prefix_nodes;
  uint32  free_nodes;
} PCP_IPV4_LPM_MNGR_STATUS;

/*********************************************************************
* NAME:
*     pcp_ipv4_lpm_mngr_create
* FUNCTION:
*  Create LPM manager instance.
* INPUT:
*  SOC_SAND_INOUT  PCP_IPV4_LPM_MNGR_INFO  *lpm_mngr -
...
/*********************************************************************
* NAME:
*     pcp_ipv4_lpm_mngr_all_vrfs_clear
* FUNCTION:
...
*     OK or ERROR indication.
*********************************************************************/
uint32 pcp_ipv4_lpm_mngr_clear(
  SOC_SAND_INOUT  PCP_IPV4_LPM_MNGR_INFO  *lpm_mngr
);

/*********************************************************************
* NAME:
*     pcp_ipv4_lpm_mngr_destroy
* FUNCTION:
...
/*********************************************************************
* NAME:
*   pcp_ipv4_lpm_mngr_mark_non_lpm_route_pending_type_set
* TYPE:
*   PROC
* FUNCTION:
...
/*********************************************************************
* NAME:
*     pcp_ipv4_lpm_mngr_prefix_lookup
* FUNCTION:
...
/*********************************************************************
* NAME:
*     pcp_ipv4_lpm_mngr_prefix_is_exist
* FUNCTION:
...
*     OK or ERROR indication.
*********************************************************************/
uint32 pcp_ipv4_lpm_mngr_sys_fec_get(
  SOC_SAND_INOUT  PCP_IPV4_LPM_MNGR_INFO  *lpm_mngr,
  SOC_SAND_IN  uint32                     vrf_ndx,
  SOC_SAND_IN  SOC_SAND_PP_IPV4_SUBNET           *key,
...
uint32
  pcp_ipv4_lpm_mngr_get_stat(
    SOC_SAND_INOUT  PCP_IPV4_LPM_MNGR_INFO   *lpm_mngr,
    SOC_SAND_IN  uint32                      vrf_ndx,
    SOC_SAND_OUT  PCP_IPV4_LPM_MNGR_STATUS  *lpm_stat
  );

uint32
  pcp_ipv4_lpm_mngr_lookup0(
...
int32
  pcp_ipv4_lpm_mngr_row_to_base_addr(
    SOC_SAND_IN  PCP_IPV4_LPM_MNGR_INFO *lpm_mngr,
    SOC_SAND_IN PCP_IPV4_LPM_MNGR_INST *inst,
    SOC_SAND_IN uint32 depth, /* depth of the instruction inst */
    SOC_SAND_IN  uint32                     prev_stride /* the stride that brings us here */		 /* depth of the instruction inst */
  );

int32
  pcp_ipv4_lpm_mngr_update_base_addr(
    SOC_SAND_IN  PCP_IPV4_LPM_MNGR_INFO *lpm_mngr,
    SOC_SAND_INOUT PCP_IPV4_LPM_MNGR_INST *inst,
    SOC_SAND_IN uint32 depth,
    SOC_SAND_IN uint32 new_ptr
  );

void
  pcp_PCP_IPV4_LPM_MNGR_INFO_clear(
    SOC_SAND_INOUT  PCP_IPV4_LPM_MNGR_INFO  *info
  );

void
  pcp_PCP_IPV4_LPM_MNGR_STATUS_clear(
    SOC_SAND_INOUT  PCP_IPV4_LPM_MNGR_STATUS  *info
  );
