...
#define ARAD_KBP_TABLE_INDX_TO_DUMMY_TABLE_ID(_index)    \
     ((_index == 0) ? ARAD_KBP_FRWRD_TBL_ID_DUMMY_0 : ((_index == 1) ? ARAD_KBP_FRWRD_TBL_ID_DUMMY_1 : \
     ((_index == 2) ? ARAD_KBP_FRWRD_TBL_ID_DUMMY_2 : ARAD_KBP_FRWRD_TBL_ID_DUMMY_3)))
...
/* In Arad, only WA for IPv6 RPF. Compilation flag to allow the SIP lookup */
#ifndef ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF
#define ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF    (1) 
...
typedef enum
{
    ARAD_KBP_FRWRD_DB_TYPE_IPV4_UC      = 0,
    ARAD_KBP_FRWRD_DB_TYPE_IPV4_UC_RPF  = 1,
    ARAD_KBP_FRWRD_DB_TYPE_IPV4_MC_RPF  = 2,

    ARAD_KBP_FRWRD_DB_TYPE_IPV6_UC      = 3,
    ARAD_KBP_FRWRD_DB_TYPE_IPV6_UC_RPF_2PASS = 4,
    ARAD_KBP_FRWRD_DB_TYPE_IPV6_UC_RPF  = 5,
    ARAD_KBP_FRWRD_DB_TYPE_IPV6_MC_RPF  = 6,

    ARAD_KBP_FRWRD_DB_TYPE_LSR          = 7,
    ARAD_KBP_FRWRD_DB_TYPE_TRILL_UC     = 8,
    ARAD_KBP_FRWRD_DB_TYPE_TRILL_MC     = 9,

    ARAD_KBP_FRWRD_DB_TYPE_IP_LSR_SHARED = 10,
    ARAD_KBP_FRWRD_DB_TYPE_IP_LSR_SHARED_FOR_IP = 11,
    ARAD_KBP_FRWRD_DB_TYPE_IP_LSR_SHARED_FOR_IP_WITH_RPF = 12,
    ARAD_KBP_FRWRD_DB_TYPE_IP_LSR_SHARED_FOR_LSR = 13,

    ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6 = 14,
    ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_P2P = 15,

    ARAD_KBP_FRWRD_DB_TYPE_INRIF_MAPPING = 16,

    ARAD_KBP_FRWRD_DB_NOF_TYPES         = 17,
...
typedef enum
{
    ARAD_KBP_LTR_ID_FIRST           = 40,

    ARAD_KBP_FRWRD_LTR_IPV4_UC      = ARAD_KBP_LTR_ID_FIRST + ARAD_KBP_FRWRD_DB_TYPE_IPV4_UC,
    ARAD_KBP_FRWRD_LTR_IPV4_UC_RPF  = ARAD_KBP_FRWRD_LTR_IPV4_UC 		+ 1,
    ARAD_KBP_FRWRD_LTR_IPV4_MC_RPF  = ARAD_KBP_FRWRD_LTR_IPV4_UC_RPF 	+ 2, /* UC_RPF CMP3 use 2 LTRs */
    ARAD_KBP_FRWRD_LTR_IPV6_UC      = ARAD_KBP_FRWRD_LTR_IPV4_MC_RPF 	+ 1,
    ARAD_KBP_FRWRD_LTR_IPV6_UC_RPF_2PASS  = ARAD_KBP_FRWRD_LTR_IPV6_UC  + 1,
    ARAD_KBP_FRWRD_LTR_IPV6_UC_RPF = ARAD_KBP_FRWRD_LTR_IPV6_UC_RPF_2PASS   + 2, /* UC_RPF_2PASS CMP3 use 2 LTRs */
    ARAD_KBP_FRWRD_LTR_IPV6_MC_RPF  = ARAD_KBP_FRWRD_LTR_IPV6_UC_RPF 	+ 2, /* UC_RPF CMP3 use 2 LTRs */
    ARAD_KBP_FRWRD_LTR_LSR          = ARAD_KBP_FRWRD_LTR_IPV6_MC_RPF 	+ 1, 
    ARAD_KBP_FRWRD_LTR_TRILL_UC     = ARAD_KBP_FRWRD_LTR_LSR 			+ 1,
    ARAD_KBP_FRWRD_LTR_TRILL_MC     = ARAD_KBP_FRWRD_LTR_TRILL_UC 		+ 1,

    ARAD_KBP_FRWRD_LTR_IP_LSR_SHARED = ARAD_KBP_FRWRD_LTR_TRILL_MC + 3,
    ...
    ARAD_KBP_MAX_ACL_LTR_ID         = ARAD_KBP_LTR_ID_FIRST + ARAD_KBP_MAX_NUM_OF_FRWRD_DBS,
...
typedef enum
{
    ...
    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV4_RPF     = ARAD_PP_FLP_KEY_PROGRAM_IPV4UC_WITH_RPF, /*  3 */
    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV4_UC      = ARAD_PP_FLP_KEY_PROGRAM_IPV4UC,          /*  4 */
    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV4_MC_COMP = ARAD_PP_FLP_KEY_PROGRAM_IPV4COMPMC_WITH_RPF, /* 18 */

    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_UC      = ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, /* 5 */
    ARAD_KBP_FRWRD_TABLE_OPCODE_EXTENDED_P2P = ARAD_PP_FLP_KEY_PROGRAM_P2P, /* 6 */    
    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_MC_RPF  = ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, /* 7 */    

    ARAD_KBP_FRWRD_TABLE_OPCODE_LSR          = ARAD_PP_FLP_KEY_PROGRAM_LSR, /* 8 */
    ARAD_KBP_FRWRD_TABLE_OPCODE_TRILL_UC     = ARAD_PP_FLP_KEY_PROGRAM_TRILL_UC, /* 10 */
    ARAD_KBP_FRWRD_TABLE_OPCODE_TRILL_MC     = ARAD_PP_FLP_KEY_PROGRAM_TRILL_MC_ONE_TAG, /* 11 */
    ...
    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_UC_RPF  = ARAD_PP_FLP_KEY_PROGRAM_IPV6UC_WITH_RPF, /* 32, program is dynamically allocated */
    ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_UC_RPF_2PASS = ARAD_PP_FLP_KEY_PROGRAM_IPV6UC_WITH_RPF_2PASS, /* 46, program is dynamically allocated */
...
#define ARAD_KBP_AD_WIDTH_TYPE_TO_BITS(width)    \
     ((width == NLM_TBL_ADLEN_32B) ? 32 : ((width == NLM_TBL_ADLEN_64B) ? 64 : \
     ((width == NLM_TBL_ADLEN_128B) ? 128 : 0)))
...
typedef struct {
    ...
    ARAD_PMF_CE_IRPP_QUALIFIER_ATTRIBUTES Arad_pmf_ce_dynamic_kbp_qualifiers_values[4];
...
uint32
    arad_kbp_result_configurations_update(int unit, ARAD_KBP_FRWRD_IP_DB_TYPE db_type, int results_size[ARAD_PP_FLP_KBP_MAX_NUMBER_OF_RESULTS], 
                                          int results_valid[ARAD_PP_FLP_KBP_MAX_NUMBER_OF_RESULTS]);
void
    arad_kbp_sw_init(
       SOC_SAND_IN  int  unit
    );
