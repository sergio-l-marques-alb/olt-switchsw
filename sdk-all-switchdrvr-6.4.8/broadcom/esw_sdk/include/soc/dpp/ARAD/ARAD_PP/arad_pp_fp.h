...
typedef enum
{
   ...
   */
  ARAD_PP_FP_PACKET_FORMAT_GROUP_SET = ARAD_PP_PROC_DESC_BASE_FP_FIRST,
  ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_PRINT,
  ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_UNSAFE,
  ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_VERIFY,
  ARAD_PP_FP_PACKET_FORMAT_GROUP_GET,
  ARAD_PP_FP_PACKET_FORMAT_GROUP_GET_PRINT,
  ...
  ARAD_PP_FP_PACKET_DIAG_GET_PRINT,
  ARAD_PP_FP_PACKET_DIAG_GET_UNSAFE,
  ARAD_PP_FP_PACKET_DIAG_GET_VERIFY,
   ...
   */
   ...
   ARAD_PP_FP_QUAL_TYPES_VERIFY_FIRST_STAGE,
   ARAD_PP_FP_ACTION_TYPES_VERIFY_FIRST_STAGE,
   ARAD_PP_FP_ACTION_TYPE_TO_CE_COPY,
   ...
   ARAD_PP_FP_QUAL_TYPE_PREDEFINED_KEY_GET,
   ARAD_PP_FP_PREDEFINED_KEY_GET,
   ARAD_PP_FP_KEY_GET,
   ARAD_PP_FP_QUAL_TYPE_TO_TCAM_TYPE_CONVERT,
   ARAD_PP_FP_QUAL_TYPE_TO_KEY_FLD_CONVERT,
   ARAD_PP_FP_PREDEFINED_KEY_SIZE_AND_TYPE_GET,
   ARAD_PP_FP_ENTRY_VALIDITY_GET,
   ARAD_PP_FP_QUAL_TYPE_PRESET1,
...
#define TOTAL_NOF_PROGRAMS_IN_QUALIFIER_SHARING   4
...
int
  dip_sip_sharing_is_sharing_enabled_for_program(int unit, int prog_id);

void
  dip_sip_sharing_is_shared_qualifier_qset(int unit, int prog_id, ARAD_PP_FP_QUAL_TYPE qual_type, int* is_exists, ARAD_PP_FP_SHARED_QUAL_INFO* shared_qual_info);
...
uint32
  arad_pp_fp_key_get(
    ...
    SOC_SAND_OUT ARAD_PP_FP_PREDEFINED_ACL_KEY  *predefined_acl_key
  );
 ...
 *   ARAD_FP_DATABASE_STAGE     stage           - (IN) stage.
