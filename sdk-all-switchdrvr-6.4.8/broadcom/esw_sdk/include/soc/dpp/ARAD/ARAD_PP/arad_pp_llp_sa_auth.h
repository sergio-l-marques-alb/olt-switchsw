...
#define ARAD_PP_LLP_SA_NO_AUTH(mac_based_info)    \
      (((mac_based_info)->expect_system_port.sys_id == ARAD_PP_LLP_SA_AUTH_ACCEPT_ALL_PORTS) &&    \
      ((mac_based_info)->expect_tag_vid == ARAD_PP_LLP_SA_AUTH_ACCEPT_ALL_VIDS) &&     \
