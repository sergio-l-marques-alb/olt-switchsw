...
typedef enum
{
    ...
    ARAD_PP_ISEM_ACCESS_PROG_VT_EXTENDER_PE,
	ARAD_PP_ISEM_ACCESS_PROG_VT_TEST2,
...
typedef enum
{
    ...
    ARAD_PP_ISEM_ACCESS_PROG_TT_IPV4_ROUTER_DIP_SIP_VRF_PROG,
    /* nof progs */
...
typedef struct
{
  ...
  uint8 ipv4_term_dip_sip_enable; /* 0 - disable, 1 - enable, 2 - include IPV4 next protocol, 3 - include VRF */
  uint8 e_o_ip_enable;
  uint8 vxlan_enable;
  uint8 nvgre_enable;
