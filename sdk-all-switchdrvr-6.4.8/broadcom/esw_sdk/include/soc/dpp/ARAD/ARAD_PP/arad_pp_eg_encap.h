 ...
 *   ARAD_PP_EG_ENCAP_PROTECTION_INFO                   protection_info
...
uint32 arad_pp_eg_encap_protection_info_get_unsafe(
    ...
    SOC_SAND_IN int                                 out_lif_id,
    SOC_SAND_IN uint8                               is_full_entry_extension,
    SOC_SAND_OUT ARAD_PP_EG_ENCAP_PROTECTION_INFO   *protection_info);
...
uint32 ARAD_PP_EG_ENCAP_PROTECTION_INFO_verify(
    SOC_SAND_IN  int                              unit,
