...
/******************************************************************
*
* FILENAME:       DuneDriver/Arad/PB_PP/include/soc_pb_pp_lif_ing_vlan_edit.h
*
...
typedef enum
{
  ...
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET_PRINT,
  ...
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET_PRINT,
...
uint32
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO *info
  );

uint32
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY_verify(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY *info
  );

uint32
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_verify(
