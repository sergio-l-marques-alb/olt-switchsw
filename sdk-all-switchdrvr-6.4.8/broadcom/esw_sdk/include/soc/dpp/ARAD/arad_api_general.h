/* $Id: arad_api_general.h,v 1.39 Broadcom SDK $
...
/* ARAD number of traffic classes.*/
 ...
 * ARAD_FAP_EGRESS_REPLICATION_SCH_PORT_ID:
 *  The Port ID When attaching flow / aggregate scheduler to it
 * ARAD_FAP_EGRESS_REPLICATION_IPS_PORT_ID:
 *  The port ID when mapping the system port to it.
 */
#define ARAD_FAP_EGRESS_REPLICATION_BASE_Q_PAIR       248 /* base queue pair */
...
*/
/* #define ARAD_SCH_MAX_RATE_MBPS                 (ARAD_RATE_1K * 105) */
...
#define ARAD_B0_MAX_ECN_QUEUE_BYTES 0x7e00000 /* maximum queue size in bytes that ARAD Bo/B1 supports */

/* Multicast-ID min: Value 0 */
#define ARAD_MULT_ID_MIN                 0
/* Multicast-ID max: Value 16,383. */
#define ARAD_MULT_ID_MAX                 ARAD_MULT_NOF_MULTICAST_GROUPS-1

#define ARAD_MULT_NOF_MULTICAST_GROUPS       SOC_TMC_MULT_NOF_MULTICAST_GROUPS_ARAD

#define ARAD_MULT_NOF_MULT_VLAN_ERP_GROUPS   (8*1024) /* 4K in Petra */
 ...
 *  ARAD family devices ARAD-A, ARAD-B...,
...
/*
 * ARAD Multicast ID: 0-(16k-1)
 */
typedef SOC_TMC_MULT_ID ARAD_MULT_ID;

/*
 * ARAD IPQ Queue type - Traffic Class. Range: 0-7
 */
typedef SOC_TMC_TR_CLS ARAD_TR_CLS;

/* 
 * ARAD TCG Traffic class groups. Range: 0-7
 */
...
/*#define ARAD_MAX_NIF_ID (ARAD_IF_NOF_NIFS - 1)*/
...
/* Arad Packet swap mode defines that are SOC_TMC equivalent */
...
*   Feb 26 2013
* FUNCTION:
*     Resets the ARAD SWAP information structure ARAD_SWAP_INFO.
* INPUT:
*   SOC_SAND_OUT  ARAD_SWAP_INFO  *info -
*       A pointer to the ARAD SWAP information structure.
* RETURNS:
*   NA.
*********************************************************************/
void
...
*   Feb 26 2013
* FUNCTION:
*     Converts ARAD SWAP Mode enum value to a string
* INPUT:
*   SOC_SAND_IN  ARAD_SWAP_MODE  enum_val -
*       ARAD SWAP Mode enum value
* RETURNS:
*   ARAD SWAP Mode enum equivalent string or Unknown.
*********************************************************************/
const char*
  arad_ARAD_SWAP_MODE_to_string(
     SOC_SAND_IN ARAD_SWAP_MODE enum_val
...
*   Feb 26 2013
* FUNCTION:
*     Prints the data in ARAD_SWAP_INFO.
* INPUT:
