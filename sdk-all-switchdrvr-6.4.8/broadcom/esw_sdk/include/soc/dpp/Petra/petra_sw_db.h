...
typedef struct
{
  ...
  SOC_SAND_SORTED_LIST_PTR    priorities;
...
typedef struct
{
  SOC_SAND_MULTI_SET_PTR egr_editor_profiles_multi_set;
  SOC_SAND_MULTI_SET_PTR egr_editor_stk_prune_bmps_set;
...
typedef struct
{
   ...
   */
  SOC_SAND_MULTI_SET_PTR header_profiles_multi_set;
  /*
   * PMF PP Port Profile multiset of the PP Ports
   */
  SOC_SAND_MULTI_SET_PTR pp_port_profiles_multi_set;
  /*
   * Profile of this HW index
   */
   ...
   */
  SOC_SAND_MULTI_SET_PTR pgm_profiles_multi_set;
  /*
