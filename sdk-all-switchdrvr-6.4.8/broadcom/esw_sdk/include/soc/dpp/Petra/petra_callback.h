/* $Id: petra_callback.h,v 1.6 Broadcom SDK $
...
#ifndef __SOC_PETRA_CALLBACK_INCLUDED__
/* { */
#define __SOC_PETRA_CALLBACK_INCLUDED__
...
typedef struct
{
  ...
  SOC_PETRA_INTERRUPT_CAUSE     interrupt_cause;

} SOC_PETRA_USER_CALLBACK_STRUCT ;
...
uint32
  soc_petra_callback_function_register_unsafe(
...
uint32
  soc_petra_callback_all_functions_unregister_unsafe(
    SOC_SAND_IN  int                 unit
  );
