/* $Id: pb_pp_api_mymac.h,v 1.8 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_mymac.h
*
...
#ifndef __SOC_PB_PP_API_MYMAC_INCLUDED__
/* { */
#define __SOC_PB_PP_API_MYMAC_INCLUDED__
...
#define SOC_PB_PP_MYMAC_VRRP_MODE_ALL_VSI_BASED                SOC_PPC_MYMAC_VRRP_MODE_ALL_VSI_BASED
#define SOC_PB_PP_MYMAC_VRRP_MODE_256_VSI_BASED                SOC_PPC_MYMAC_VRRP_MODE_256_VSI_BASED
#define SOC_PB_PP_NOF_MYMAC_VRRP_MODES                         (SOC_PPC_NOF_MYMAC_VRRP_MODES - 3)
typedef SOC_PPC_MYMAC_VRRP_MODE                                SOC_PB_PP_MYMAC_VRRP_MODE;

typedef SOC_PPC_MYMAC_VRRP_INFO                                SOC_PB_PP_MYMAC_VRRP_INFO;
typedef SOC_PPC_MYMAC_TRILL_INFO                               SOC_PB_PP_MYMAC_TRILL_INFO;
...
/*********************************************************************
*     Gets the configuration set by the "soc_pb_pp_mymac_msb_set"
 *     API.
 *     Refer to "soc_pb_pp_mymac_msb_set" API for details.
*********************************************************************/
uint32
 ...
 *     "soc_pb_pp_mymac_vsi_lsb_set" API.
 *     Refer to "soc_pb_pp_mymac_vsi_lsb_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_mymac_vrrp_info_set" API.
 *     Refer to "soc_pb_pp_mymac_vrrp_info_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_mymac_vrrp_mac_set" API.
 *     Refer to "soc_pb_pp_mymac_vrrp_mac_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_mymac_trill_info_set" API.
 *     Refer to "soc_pb_pp_mymac_trill_info_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_my_bmac_msb_set" API.
 *     Refer to "soc_pb_pp_lif_my_bmac_msb_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_my_bmac_port_lsb_set" API.
 *     Refer to "soc_pb_pp_lif_my_bmac_port_lsb_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_MYMAC_INCLUDED__*/
#endif
