/* $Id: pb_pp_llp_vid_assign.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_llp_vid_assign.h
*
...
#ifndef __SOC_PB_PP_LLP_VID_ASSIGN_INCLUDED__
/* { */
#define __SOC_PB_PP_LLP_VID_ASSIGN_INCLUDED__
...
typedef enum
{
   ...
   */
  SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO_SET = SOC_PB_PP_PROC_DESC_BASE_LLP_VID_ASSIGN_FIRST,
  SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO_SET_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO_GET_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_MAC_BASED_ADD_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_MAC_BASED_REMOVE_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_MAC_BASED_GET_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_MAC_BASED_GET_BLOCK_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_BASED_SET_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_BASED_GET_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_PROTOCOL_BASED_SET_PRINT,
  ...
  SOC_PB_PP_LLP_VID_ASSIGN_PROTOCOL_BASED_GET_PRINT,
  SOC_PB_PP_LLP_VID_ASSIGN_PROTOCOL_BASED_GET_VERIFY,
  SOC_PB_PP_LLP_VID_ASSIGN_PROTOCOL_BASED_GET_UNSAFE,
  SOC_PB_PP_LLP_VID_ASSIGN_GET_PROCS_PTR,
  SOC_PB_PP_LLP_VID_ASSIGN_GET_ERRS_PTR,
  /*
   ...
   */
  SOC_PB_PP_LLP_VID_ASSIGN_PROCEDURE_DESC_LAST
} SOC_PB_PP_LLP_VID_ASSIGN_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  SOC_PB_PP_LLP_VID_ASSIGN_SUCCESS_OUT_OF_RANGE_ERR = SOC_PB_PP_ERR_DESC_BASE_LLP_VID_ASSIGN_FIRST,
   ...
   * Last element. Do no touch.
   */
  SOC_PB_PP_LLP_VID_ASSIGN_ERR_LAST
} SOC_PB_PP_LLP_VID_ASSIGN_ERR;
 ...
 *     "soc_pb_pp_llp_vid_assign_port_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_vid_assign_port_info_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_vid_assign_port_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_vid_assign_ipv4_subnet_based_set_unsafe" API.
 *     Refer to
 *     "soc_pb_pp_llp_vid_assign_ipv4_subnet_based_set_unsafe" API
 *     for details.
*********************************************************************/
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_vid_assign_protocol_based_set_unsafe" API.
 *     Refer to
 *     "soc_pb_pp_llp_vid_assign_protocol_based_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_llp_vid_assign_protocol_based_get_unsafe(
...
/* } __SOC_PB_PP_LLP_VID_ASSIGN_INCLUDED__*/
#endif
