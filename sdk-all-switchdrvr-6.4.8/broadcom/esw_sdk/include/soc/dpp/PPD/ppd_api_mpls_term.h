...
/*     MPLS Labels 0-15 are reserved labels                    */
#define  SOC_PPD_MPLS_TERM_MAX_NOF_TERM_LABELS (SOC_PPC_MPLS_TERM_MAX_NOF_TERM_LABELS)

#define  SOC_PPD_MPLS_TERM_DISCARD_TTL_0         (SOC_PPC_MPLS_TERM_DISCARD_TTL_0)
#define  SOC_PPD_MPLS_TERM_DISCARD_TTL_1         (SOC_PPC_MPLS_TERM_DISCARD_TTL_1)
#define  SOC_PPD_MPLS_TERM_HAS_CW                (SOC_PPC_MPLS_TERM_HAS_CW)
#define  SOC_PPD_MPLS_TERM_SKIP_ETH              (SOC_PPC_MPLS_TERM_SKIP_ETH)

#define  SOC_PPD_MPLS_TERM_RESERVED_LABEL_GAL    (SOC_PPC_MPLS_TERM_RESERVED_LABEL_GAL)
/* } */
/*************
 * MACROS    *
 *************/
...
#define SOC_PPD_MPLS_TERM_MODEL_PIPE                           SOC_PPC_MPLS_TERM_MODEL_PIPE
#define SOC_PPD_MPLS_TERM_MODEL_UNIFORM                        SOC_PPC_MPLS_TERM_MODEL_UNIFORM
typedef SOC_PPC_MPLS_TERM_MODEL_TYPE                           SOC_PPD_MPLS_TERM_MODEL_TYPE;

#define SOC_PPD_MPLS_TERM_KEY_TYPE_LABEL                       SOC_PPC_MPLS_TERM_KEY_TYPE_LABEL
#define SOC_PPD_MPLS_TERM_KEY_TYPE_LABEL_RIF                   SOC_PPC_MPLS_TERM_KEY_TYPE_LABEL_RIF
typedef SOC_PPC_MPLS_TERM_KEY_TYPE                             SOC_PPD_MPLS_TERM_KEY_TYPE;

typedef SOC_PPC_MPLS_TERM_LABEL_RANGE                          SOC_PPD_MPLS_TERM_LABEL_RANGE;
typedef SOC_PPC_MPLS_TERM_LKUP_INFO                            SOC_PPD_MPLS_TERM_LKUP_INFO;
typedef SOC_PPC_MPLS_TERM_INFO                                 SOC_PPD_MPLS_TERM_INFO;
typedef SOC_PPC_MPLS_TERM_LABEL_RANGE_INFO                     SOC_PPD_MPLS_TERM_LABEL_RANGE_INFO;
typedef SOC_PPC_MPLS_TERM_RESERVED_LABEL_INFO                  SOC_PPD_MPLS_TERM_RESERVED_LABEL_INFO;
typedef SOC_PPC_MPLS_TERM_RESERVED_LABELS_GLBL_INFO            SOC_PPD_MPLS_TERM_RESERVED_LABELS_GLBL_INFO;
typedef SOC_PPC_MPLS_TERM_COS_INFO                             SOC_PPD_MPLS_TERM_COS_INFO;
typedef SOC_PPC_MPLS_TERM_LABEL_COS_KEY                        SOC_PPD_MPLS_TERM_LABEL_COS_KEY;
typedef SOC_PPC_MPLS_TERM_LABEL_COS_VAL                        SOC_PPD_MPLS_TERM_LABEL_COS_VAL;
typedef SOC_PPC_MPLS_TERM_PROFILE_INFO                         SOC_PPD_MPLS_TERM_PROFILE_INFO;
 ...
 *     ARAD range: 0-7.
 *   SOC_SAND_IN  SOC_PPD_ACTION_PROFILE		              *action_profile_info -
 ...
 *     Action profile Table Entry.
 *     ARAD range: 0-7.
 *   SOC_SAND_OUT SOC_PPD_ACTION_PROFILE		              *action_profile_info -
 *     Action profile related attributes.
 * REMARKS:
 *   None.
 * RETURNS:
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_mpls_term_get_procs_ptr(void);
