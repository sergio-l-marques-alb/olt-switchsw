...
#define SOC_PPD_EG_QOS_UNIFORM_PHP_POP_INTO_IPV4               SOC_PPC_EG_QOS_UNIFORM_PHP_POP_INTO_IPV4
#define SOC_PPD_EG_QOS_UNIFORM_PHP_POP_INTO_IPV6               SOC_PPC_EG_QOS_UNIFORM_PHP_POP_INTO_IPV6
typedef SOC_PPC_EG_QOS_UNIFORM_PHP_TYPE                        SOC_PPD_EG_QOS_UNIFORM_PHP_TYPE;

typedef SOC_PPC_EG_QOS_MAP_KEY                                 SOC_PPD_EG_QOS_MAP_KEY;
typedef SOC_PPC_EG_QOS_PARAMS                                  SOC_PPD_EG_QOS_PARAMS;
typedef SOC_PPC_EG_ENCAP_QOS_MAP_KEY                           SOC_PPD_EG_ENCAP_QOS_MAP_KEY;
typedef SOC_PPC_EG_ENCAP_QOS_PARAMS                            SOC_PPD_EG_ENCAP_QOS_PARAMS;
typedef SOC_PPC_EG_QOS_PHP_REMARK_KEY                          SOC_PPD_EG_QOS_PHP_REMARK_KEY;
typedef SOC_PPC_EG_QOS_PORT_INFO                               SOC_PPD_EG_QOS_PORT_INFO;

#ifdef BCM_88660
typedef SOC_PPC_EG_QOS_GLOBAL_INFO                             SOC_PPD_EG_QOS_GLOBAL_INFO;
typedef SOC_PPC_EG_QOS_MARKING_KEY                             SOC_PPD_EG_QOS_MARKING_KEY;
typedef SOC_PPC_EG_QOS_MARKING_PARAMS                          SOC_PPD_EG_QOS_MARKING_PARAMS;
#endif /* BCM_88660 */
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_eg_qos_get_procs_ptr(void);
...
void
  soc_ppd_eg_encap_qos_params_remark_set_print(
    SOC_SAND_IN  int                               unit,
    SOC_SAND_IN  SOC_PPD_EG_ENCAP_QOS_MAP_KEY                      *in_qos_key,
    SOC_SAND_IN  SOC_PPD_EG_QOS_PARAMS                       *out_qos_params
  );
