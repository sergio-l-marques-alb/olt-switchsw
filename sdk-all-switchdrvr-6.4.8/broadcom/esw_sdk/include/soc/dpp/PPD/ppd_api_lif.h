...
#define  SOC_PPD_LIF_IGNORE_INNER_VID     (SOC_PPC_LIF_IGNORE_INNER_VID)
#define  SOC_PPD_LIF_IGNORE_INTERNAL_VID  (SOC_PPC_LIF_IGNORE_INNER_VID)

/*     Used when the AC mapping is only according to the port
 *     (port default).                                         */
#define  SOC_PPD_LIF_IGNORE_OUTER_VID     (SOC_PPC_LIF_IGNORE_OUTER_VID)
...
/*     Used when the AC mapping is only according to the port
 *     and outer VID and innver VID                                  */
#define  SOC_PPD_LIF_IGNORE_ETHER_TYPE    (SOC_PPC_LIF_IGNORE_ETHER_TYPE)

/*     Used when the AC mapping ignores Outer-PCP                   */
#define  SOC_PPD_LIF_IGNORE_OUTER_PCP     (SOC_PPC_LIF_IGNORE_OUTER_PCP)
 ...
 *     ID mapping to VSI                                       */
#define  SOC_PPD_ISID_DM_DISABLE          (SOC_PPC_ISID_DM_DISABLE)

/*     VSI that should be used for P2P service                 */
#define  SOC_PPD_VSI_P2P_SERVICE          (SOC_PPC_VSI_P2P_SERVICE)

/*     VSI Equal to initial VID of the packet                 */

/* VSI equal to VSI in LIF table */
#define  SOC_PPD_VSI_EQ_VSI_BASE          (SOC_PPC_VSI_EQ_VSI_BASE)
/* VSI equal to LIF-index */
#define  SOC_PPD_VSI_EQ_IN_LIF          (SOC_PPC_VSI_EQ_IN_LIF)
...
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT                    SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN               SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN_VLAN          SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN          SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN_COMP_VLAN SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN_COMP_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_RAW                     SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_RAW
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN                SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN_VLAN           SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_INITIAL_VLAN       SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_INITIAL_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN           SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN_VLAN      SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL             SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN   SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN_COMP_VLAN      SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN_COMP_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_PCP_ETHER_TYPE_COMP_VLAN_COMP_VLAN      SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_PCP_ETHER_TYPE_COMP_VLAN_COMP_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_TLS_PORT_TUNNEL         SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_TLS_PORT_TUNNEL
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_TRILL_DESIGNATED_VLAN   SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_TRILL_DESIGNATED_VLAN
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_NONE                    SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_NONE
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID         SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID_VID     SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID_VID
#define SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_TEST2                   SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_TEST2
typedef SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE                         SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE;

#define SOC_PPD_L2_LIF_DFLT_FRWRD_SRC_VSI                      SOC_PPC_L2_LIF_DFLT_FRWRD_SRC_VSI
#define SOC_PPD_L2_LIF_DFLT_FRWRD_SRC_LIF                      SOC_PPC_L2_LIF_DFLT_FRWRD_SRC_LIF
typedef SOC_PPC_L2_LIF_DFLT_FRWRD_SRC                          SOC_PPD_L2_LIF_DFLT_FRWRD_SRC;

#define SOC_PPD_L2_LIF_AC_SERVICE_TYPE_MP                      SOC_PPC_L2_LIF_AC_SERVICE_TYPE_MP
#define SOC_PPD_L2_LIF_AC_SERVICE_TYPE_AC2AC                   SOC_PPC_L2_LIF_AC_SERVICE_TYPE_AC2AC
#define SOC_PPD_L2_LIF_AC_SERVICE_TYPE_AC2PWE                  SOC_PPC_L2_LIF_AC_SERVICE_TYPE_AC2PWE
#define SOC_PPD_L2_LIF_AC_SERVICE_TYPE_AC2PBB                  SOC_PPC_L2_LIF_AC_SERVICE_TYPE_AC2PBB
typedef SOC_PPC_L2_LIF_AC_SERVICE_TYPE                         SOC_PPD_L2_LIF_AC_SERVICE_TYPE;

#define SOC_PPD_L2_LIF_PWE_SERVICE_TYPE_MP                     SOC_PPC_L2_LIF_PWE_SERVICE_TYPE_MP
#define SOC_PPD_L2_LIF_PWE_SERVICE_TYPE_P2P                    SOC_PPC_L2_LIF_PWE_SERVICE_TYPE_P2P
#define SOC_PPD_L2_LIF_PWE_SERVICE_TYPE_P2P_CUSTOM             SOC_PPC_L2_LIF_PWE_SERVICE_TYPE_P2P_CUSTOM
typedef SOC_PPC_L2_LIF_PWE_SERVICE_TYPE                        SOC_PPD_L2_LIF_PWE_SERVICE_TYPE;

#define SOC_PPD_L2_LIF_ISID_SERVICE_TYPE_MP                    SOC_PPC_L2_LIF_ISID_SERVICE_TYPE_MP
#define SOC_PPD_L2_LIF_ISID_SERVICE_TYPE_P2P                   SOC_PPC_L2_LIF_ISID_SERVICE_TYPE_P2P
typedef SOC_PPC_L2_LIF_ISID_SERVICE_TYPE                       SOC_PPD_L2_LIF_ISID_SERVICE_TYPE;

#define SOC_PPD_L2_LIF_AC_LEARN_DISABLE                        SOC_PPC_L2_LIF_AC_LEARN_DISABLE
#define SOC_PPD_L2_LIF_AC_LEARN_SYS_PORT                       SOC_PPC_L2_LIF_AC_LEARN_SYS_PORT
#define SOC_PPD_L2_LIF_AC_LEARN_INFO                           SOC_PPC_L2_LIF_AC_LEARN_INFO
typedef SOC_PPC_L2_LIF_AC_LEARN_TYPE                           SOC_PPD_L2_LIF_AC_LEARN_TYPE;

#define SOC_PPD_L2_LIF_L2CP_HANDLE_TYPE_NORMAL                 SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_NORMAL
#define SOC_PPD_L2_LIF_L2CP_HANDLE_TYPE_TUNNEL                 SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_TUNNEL
#define SOC_PPD_L2_LIF_L2CP_HANDLE_TYPE_PEER                   SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_PEER
#define SOC_PPD_L2_LIF_L2CP_HANDLE_TYPE_DROP                   SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_DROP
typedef SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE                        SOC_PPD_L2_LIF_L2CP_HANDLE_TYPE;


typedef SOC_PPC_L2_LIF_AC_KEY_QUALIFIER                        SOC_PPD_L2_LIF_AC_KEY_QUALIFIER;
typedef SOC_PPC_L2_LIF_IN_VC_RANGE                             SOC_PPD_L2_LIF_IN_VC_RANGE;
typedef SOC_PPC_L2_LIF_DEFAULT_FORWARDING_INFO                 SOC_PPD_L2_LIF_DEFAULT_FORWARDING_INFO;
typedef SOC_PPC_L2_LIF_PWE_LEARN_RECORD                        SOC_PPD_L2_LIF_PWE_LEARN_RECORD;
typedef SOC_PPC_L2_LIF_PWE_ADDITIONAL_INFO                     SOC_PPD_L2_LIF_PWE_ADDITIONAL_INFO;
typedef SOC_PPC_L2_LIF_PWE_INFO                                SOC_PPD_L2_LIF_PWE_INFO;

#define SOC_PPD_LIF_VLAN_RANGE_MAX_SIZE                        SOC_PPC_LIF_VLAN_RANGE_MAX_SIZE
typedef SOC_PPC_L2_VLAN_RANGE_KEY                              SOC_PPD_L2_VLAN_RANGE_KEY;
typedef SOC_PPC_L2_PORT_VLAN_RANGE_INFO                        SOC_PPD_L2_PORT_VLAN_RANGE_INFO;

typedef SOC_PPC_L2_LIF_AC_KEY                                  SOC_PPD_L2_LIF_AC_KEY;
typedef SOC_PPC_L2_LIF_AC_LEARN_RECORD                         SOC_PPD_L2_LIF_AC_LEARN_RECORD;
typedef SOC_PPC_L2_LIF_AC_ING_EDIT_INFO                        SOC_PPD_L2_LIF_AC_ING_EDIT_INFO;
typedef SOC_PPC_L2_LIF_AC_INFO                                 SOC_PPD_L2_LIF_AC_INFO;
typedef SOC_PPC_L2_LIF_AC_MP_INFO                              SOC_PPD_L2_LIF_AC_MP_INFO;
typedef SOC_PPC_L2_LIF_L2CP_KEY                                SOC_PPD_L2_LIF_L2CP_KEY;
typedef SOC_PPC_L2_LIF_AC_GROUP_INFO                           SOC_PPD_L2_LIF_AC_GROUP_INFO;
typedef SOC_PPC_L2_LIF_ISID_KEY                                SOC_PPD_L2_LIF_ISID_KEY;
typedef SOC_PPC_L2_LIF_ISID_INFO                               SOC_PPD_L2_LIF_ISID_INFO;
typedef SOC_PPC_L2_LIF_TRILL_INFO                              SOC_PPD_L2_LIF_TRILL_INFO;
typedef SOC_PPC_L2_LIF_GRE_KEY                                 SOC_PPD_L2_LIF_GRE_KEY;
typedef SOC_PPC_L2_LIF_GRE_INFO                                SOC_PPD_L2_LIF_GRE_INFO;
typedef SOC_PPC_L2_LIF_VXLAN_KEY                               SOC_PPD_L2_LIF_VXLAN_KEY;
typedef SOC_PPC_L2_LIF_VXLAN_INFO                              SOC_PPD_L2_LIF_VXLAN_INFO;
typedef SOC_PPC_L2_LIF_DEFAULT_FRWRD_KEY                       SOC_PPD_L2_LIF_DEFAULT_FRWRD_KEY;
typedef SOC_PPC_L2_LIF_DEFAULT_FRWRD_ACTION                    SOC_PPD_L2_LIF_DEFAULT_FRWRD_ACTION;
typedef SOC_PPC_L2_LIF_EXTENDER_KEY                            SOC_PPD_L2_LIF_EXTENDER_KEY;
typedef SOC_PPC_L2_LIF_EXTENDER_INFO                           SOC_PPD_L2_LIF_EXTENDER_INFO;

#define SOC_PPD_LIF_AC_SPOOF_MODE_ENABLE                       SOC_PPC_LIF_AC_SPOOF_MODE_ENABLE
#define SOC_PPD_LIF_AC_SPOOF_MODE_ENABLE_SET                   (SOC_PPD_LIF_AC_SPOOF_MODE_ENABLE << 5)
#define SOC_PPD_LIF_AC_SPOOF_MODE_DISABLE_SET                  (~SOC_PPD_LIF_AC_SPOOF_MODE_ENABLE_SET)
#define SOC_PPD_LIF_AC_LOCAL_SWITCHING_COS_PROFILE             SOC_PPC_LIF_AC_LOCAL_SWITCHING_COS_PROFILE


#define SOC_PPD_LIF_AC_VAMC_COS_PROFILE_DISABLE             SOC_PPC_LIF_AC_VAMC_COS_PROFILE_DISABLE
#define SOC_PPD_LIF_AC_VAMC_COS_PROFILE_ENABLE              SOC_PPC_LIF_AC_VAMC_COS_PROFILE_ENABLE
#define SOC_PPD_LIF_AC_VAMC_COS_PROFILE_LSB                 SOC_PPC_LIF_AC_VAMC_COS_PROFILE_LSB
#define SOC_PPD_LIF_AC_VAMC_COS_PROFILE_LSB_NOF_BITS        SOC_PPC_LIF_AC_VAMC_COS_PROFILE_LSB_NOF_BITS
...
uint32
  soc_ppd_l2_lif_pwe_add(
    ...
    SOC_SAND_IN  SOC_SAND_PP_MPLS_LABEL                      in_vc_label,
    SOC_SAND_IN  SOC_PPD_LIF_ID                              lif_index,
    SOC_SAND_IN  SOC_PPD_L2_LIF_PWE_ADDITIONAL_INFO                     *pwe_additional_info,
    SOC_SAND_IN  SOC_PPD_L2_LIF_PWE_INFO                     *pwe_info,
    SOC_SAND_OUT SOC_SAND_SUCCESS_FAILURE                    *success
  );
...
uint32
  soc_ppd_l2_lif_pwe_get(
    ...
    SOC_SAND_IN  SOC_SAND_PP_MPLS_LABEL                      in_vc_label,
    SOC_SAND_OUT SOC_PPD_LIF_ID                              *lif_index,
    SOC_SAND_OUT SOC_PPD_L2_LIF_PWE_ADDITIONAL_INFO          *pwe_additional_info,
    SOC_SAND_OUT SOC_PPD_L2_LIF_PWE_INFO                     *pwe_info,
    SOC_SAND_OUT uint8                               *found
  );
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_ppd_t20e_l2_lif_ac_map_key_set" API.
 *     Refer to "soc_ppd_t20e_l2_lif_ac_map_key_set" API for details.
*********************************************************************/
uint32
  soc_ppd_t20e_l2_lif_ac_map_key_get(
    SOC_SAND_IN  int                               unit,
 ...
 *   SOC_SAND_OUT SOC_PPD_L2_LIF_EXTENDER_INFO      *extender_info -
 ...
 *   OK or ERROR indication.
*********************************************************************/
uint32 soc_ppd_l2_lif_extender_get(
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  SOC_PPD_L2_LIF_EXTENDER_KEY        *extender_key,
    SOC_SAND_OUT SOC_PPD_LIF_ID                     *lif_index,
    SOC_SAND_OUT SOC_PPD_L2_LIF_EXTENDER_INFO       *extender_info,
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_lif_get_procs_ptr(void);
...
void
  SOC_PPD_L2_LIF_PWE_ADDITIONAL_INFO_clear(
    SOC_SAND_OUT SOC_PPD_L2_LIF_PWE_ADDITIONAL_INFO *info
  );
...
void SOC_PPD_L2_LIF_EXTENDER_KEY_print(
    SOC_SAND_IN  SOC_PPD_L2_LIF_EXTENDER_KEY *info);

void SOC_PPD_L2_LIF_EXTENDER_INFO_print(
    SOC_SAND_IN  SOC_PPD_L2_LIF_EXTENDER_INFO *info);
...
void soc_ppd_l2_lif_extender_add_print(
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  SOC_PPD_L2_LIF_EXTENDER_KEY        *extender_key,
    SOC_SAND_IN  SOC_PPD_LIF_ID                     lif_index,
    SOC_SAND_IN  SOC_PPD_L2_LIF_EXTENDER_INFO       *extender_info);
