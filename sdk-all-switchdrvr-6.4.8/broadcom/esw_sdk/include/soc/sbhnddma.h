/*
 * $Id: sbhnddma.h,v 1.5 Broadcom SDK $
...
#ifndef	_sbhnddma_soc_h_
#define	_sbhnddma_soc_h_
...
typedef volatile struct {
	dma32regs_soc_t	xmt;		/* dma tx channel */
	dma32regs_soc_t	rcv;		/* dma rx channel */
} dma32regp_soc_t;
...
#define	D32MAXDD	(D32MAXRINGSZ / sizeof (dma32dd_soc_t))
...
typedef volatile struct {
	dma64regs_soc_t	tx;		/* dma64 tx channel */
	dma64regs_soc_t	rx;		/* dma64 rx channel */
} dma64regp_soc_t;
...
#define	D64MAXDD	(D64MAXRINGSZ / sizeof (dma64dd_soc_t))
#elif defined(IPROC_CMICD)
/*
 * Descirptor table is limited to 512 entries, ensuring that the entire table is contained with in
 * a single 8KB page.
 */
#define	D64MAXRINGSZ	8192
#define	D64RINGALIGN	8192
