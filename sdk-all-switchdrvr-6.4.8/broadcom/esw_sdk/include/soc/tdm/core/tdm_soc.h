...
typedef struct _m_tdm_vmap_alloc_t {
	...
	int num_40g;
	int num_100g;
	unsigned char tri_chk;
	unsigned char tri_en_50;
	unsigned char tri_en_40;
	unsigned char tri_en_20;
	unsigned char prox_swap;
	unsigned char os1[TDM_AUX_SIZE];
	unsigned char os10[TDM_AUX_SIZE];
	unsigned char os20[TDM_AUX_SIZE];
	unsigned char os25[TDM_AUX_SIZE];
	unsigned char os40[TDM_AUX_SIZE];
	unsigned char os50[TDM_AUX_SIZE];
	unsigned char os100[TDM_AUX_SIZE];
	unsigned char os120[TDM_AUX_SIZE];
} m_tdm_vmap_alloc_t;
...
typedef struct {
	unsigned char **vmap; /* Vector mapping for VBS traversal algorithm */
	int vmap_max_len;
	int vmap_max_wid;
