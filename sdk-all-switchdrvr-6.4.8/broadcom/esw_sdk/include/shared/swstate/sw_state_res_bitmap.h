 ...
 *  
 *  Most of the functionality of this module is currently encapsulated in
 *  sw_state_res_tag_bitmap. You could change it by removing the compilation flag
 *  SW_STATE_RES_BITMAP_USE_TAG_BITMAP, but it should be done in addition to
 *  converting this module to use SW state.
 *  
 */
 ...
 *
 *  SW_STATE_RES_BITMAP_SEARCH_RESUME: If TRUE, this module will track the first
 ...
 */
#define SW_STATE_RES_BITMAP_SEARCH_RESUME TRUE
