...
/* implemented by: sw_state_dpp_soc_arad_pp_fec_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_fec_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_fec_entry_type_verify_cb)(
    int _unit, int fec_entry_type_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_fec_fec_entry_type_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_fec_fec_entry_type_get_size_cb)(
    int _unit, int fec_entry_type_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_verify_cb)(
    int _unit, int flp_progs_mapping_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_get_size_cb)(
    int _unit, int flp_progs_mapping_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_verify_cb)(
    int _unit, int lem_prefix_mapping_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_get_size_cb)(
    int _unit, int lem_prefix_mapping_idx,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_fec_fec_entry_type_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_fec_fec_entry_type_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_fec_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_fec_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_pp_fec_access_cb_init(int _unit);
