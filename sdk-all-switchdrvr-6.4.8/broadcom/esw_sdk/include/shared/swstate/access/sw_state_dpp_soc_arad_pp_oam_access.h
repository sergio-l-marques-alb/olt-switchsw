...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_recycle_set_cb)(
    int _unit, uint32 trap_code_recycle);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_trap_code_recycle_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_recycle_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_snoop_set_cb)(
    int _unit, uint32 trap_code_snoop);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_trap_code_snoop_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_snoop_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_frwrd_set_cb)(
    int _unit, uint32 trap_code_frwrd);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_trap_code_frwrd_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_frwrd_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_drop_set_cb)(
    int _unit, uint32 trap_code_drop);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_trap_code_drop_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_drop_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_level_set_cb)(
    int _unit, uint32 trap_code_trap_to_cpu_level);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_level_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_level_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_passive_set_cb)(
    int _unit, uint32 trap_code_trap_to_cpu_passive);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_passive_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_passive_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_snoop_to_cpu_set_cb)(
    int _unit, uint32 mirror_profile_snoop_to_cpu);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_mirror_profile_snoop_to_cpu_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_snoop_to_cpu_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_recycle_set_cb)(
    int _unit, uint32 mirror_profile_recycle);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_mirror_profile_recycle_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_recycle_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_level_set_cb)(
    int _unit, uint32 mirror_profile_err_level);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_level_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_level_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_passive_set_cb)(
    int _unit, uint32 mirror_profile_err_passive);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_passive_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_passive_get_size_cb)(
    int _unit,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_pp_oam_tcam_last_entry_id_set_cb)(
    int _unit, uint32 tcam_last_entry_id);
...
/* implemented by: sw_state_dpp_soc_arad_pp_oam_tcam_last_entry_id_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_oam_tcam_last_entry_id_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_oam_trap_code_recycle_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_trap_code_recycle_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_trap_code_snoop_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_trap_code_snoop_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_trap_code_frwrd_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_trap_code_frwrd_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_trap_code_drop_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_trap_code_drop_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_level_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_level_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_passive_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_trap_code_trap_to_cpu_passive_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_mirror_profile_snoop_to_cpu_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_mirror_profile_snoop_to_cpu_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_mirror_profile_recycle_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_mirror_profile_recycle_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_level_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_level_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_passive_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_mirror_profile_err_passive_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_tcam_last_entry_id_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_tcam_last_entry_id_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_oam_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_pp_oam_access_cb_init(int _unit);
