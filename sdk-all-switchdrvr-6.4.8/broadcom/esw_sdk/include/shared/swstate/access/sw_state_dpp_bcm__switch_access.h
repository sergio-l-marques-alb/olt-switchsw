...
/* implemented by: sw_state_dpp_bcm__switch_get_size */
typedef int (*sw_state_dpp_bcm__switch_get_size_cb)(
...
/* implemented by: sw_state_dpp_bcm__switch_interrupts_event_storm_nominal_get_size */
typedef int (*sw_state_dpp_bcm__switch_interrupts_event_storm_nominal_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_bcm__switch_interrupts_event_storm_nominal_cbs_s {
    ...
    sw_state_dpp_bcm__switch_interrupts_event_storm_nominal_get_size_cb get_size;
...
typedef struct sw_state_dpp_bcm__switch_cbs_s {
    ...
    sw_state_dpp_bcm__switch_get_size_cb get_size;
...
int sw_state_dpp_bcm__switch_access_cb_init(int _unit);
