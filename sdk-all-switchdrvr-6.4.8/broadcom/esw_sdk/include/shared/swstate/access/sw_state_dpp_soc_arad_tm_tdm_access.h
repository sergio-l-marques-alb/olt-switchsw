...
/* implemented by: sw_state_dpp_soc_arad_tm_tdm_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_tdm_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_tm_tdm_context_map_set_cb)(
    int _unit, int context_map_idx, ARAD_INTERFACE_ID context_map);
...
typedef int (*sw_state_dpp_soc_arad_tm_tdm_context_map_verify_cb)(
    int _unit, int context_map_idx);

/* implemented by: sw_state_dpp_soc_arad_tm_tdm_context_map_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_tdm_context_map_get_size_cb)(
    int _unit, int context_map_idx,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_tm_tdm_context_map_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_tdm_context_map_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_tdm_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_tdm_get_size_cb get_size;
