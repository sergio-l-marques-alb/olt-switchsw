...
typedef int (*sw_state_dpp_soc_arad_tm_modport2sysport_set_cb)(
    int _unit, int modport2sysport_ptr_arr_idx, ARAD_SYSPORT modport2sysport);
...
typedef int (*sw_state_dpp_soc_arad_tm_modport2sysport_verify_cb)(
    int _unit, int modport2sysport_ptr_arr_idx);

/* implemented by: sw_state_dpp_soc_arad_tm_modport2sysport_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_modport2sysport_get_size_cb)(
    int _unit, int modport2sysport_ptr_arr_idx,int *ret_size);
...
int sw_state_dpp_soc_arad_tm_modport2sysport_access_cb_init(int _unit);
