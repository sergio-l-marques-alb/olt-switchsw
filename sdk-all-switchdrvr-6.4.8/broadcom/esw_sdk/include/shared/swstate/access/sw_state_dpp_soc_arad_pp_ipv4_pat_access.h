...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_pat_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_set_cb)(
    int _unit, int occ_bm_hndl_ptr_arr_idx, SOC_SAND_OCC_BM_PTR occ_bm_hndl);
...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_verify_cb)(
    int _unit, int occ_bm_hndl_ptr_arr_idx);

/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_get_size_cb)(
    int _unit, int occ_bm_hndl_ptr_arr_idx,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_pat_nof_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_nof_get_size_cb)(
    int _unit,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_ipv4_pat_counter_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_counter_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_pat_nof_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_pat_nof_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_pat_counter_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_pat_counter_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_ipv4_pat_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_ipv4_pat_get_size_cb get_size;
