...
#define SHMOO_COMBO28_GDDR5_SEQUENCE_COUNT          13
/* BEGIN: EXTRA */
...
extern int soc_combo28_shmoo_ctl(int unit, int drc_ndx, int shmoo_type, int stat, int plot, int action, combo28_shmoo_config_param_t *config_param);
