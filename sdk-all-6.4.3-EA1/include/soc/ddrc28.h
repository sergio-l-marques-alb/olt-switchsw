...
extern int soc_phy_ddrc28_reg32_read(int unit, soc_reg_t reg, int instance, 
                                     uint32 *data);
extern int soc_phy_ddrc28_reg32_write(int unit, soc_reg_t reg, int instance, uint32 
                                      data);

extern void soc_phy_ddrc28_reg_field_set(int unit, soc_reg_t reg, uint32 *regval,
                                         soc_field_t field, uint32 value);
extern uint32 soc_phy_ddrc28_reg_field_get(int unit, soc_reg_t reg, uint32 regval, 
                                           soc_field_t field);
