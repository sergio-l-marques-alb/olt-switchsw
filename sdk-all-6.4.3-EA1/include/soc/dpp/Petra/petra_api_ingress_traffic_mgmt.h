...
#define SOC_PETRA_ITM_VSQ_GROUPA_SZE                           SOC_TMC_ITM_VSQ_GROUPA_SZE
#define SOC_PETRA_ITM_VSQ_GROUPB_SZE                           SOC_TMC_ITM_VSQ_GROUPB_SZE
#define SOC_PETRA_ITM_VSQ_GROUPC_SZE                           SOC_TMC_ITM_VSQ_GROUPC_SZE
#define SOC_PETRA_ITM_VSQ_GROUPD_SZE                           SOC_TMC_ITM_VSQ_GROUPD_SZE
typedef SOC_TMC_ITM_VSQ_GROUP_SIZE                             SOC_PETRA_ITM_VSQ_GROUP_SIZE;

#define SOC_PETRA_ITM_VSQ_NDX_MIN                              SOC_TMC_ITM_VSQ_NDX_MIN
#define SOC_PETRA_ITM_VSQ_NDX_MAX                              SOC_TMC_ITM_VSQ_NDX_MAX_PETRA
