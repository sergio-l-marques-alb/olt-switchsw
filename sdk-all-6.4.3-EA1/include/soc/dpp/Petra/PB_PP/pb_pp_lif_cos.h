/* $Id: pb_pp_lif_cos.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_lif_cos.h
*
...
#ifndef __SOC_PB_PP_LIF_COS_INCLUDED__
/* { */
#define __SOC_PB_PP_LIF_COS_INCLUDED__
...
typedef enum
{
   ...
   */
  SOC_PB_PP_LIF_COS_PROCEDURE_DESC_LAST
} SOC_PB_PP_LIF_COS_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  SOC_PB_PP_LIF_COS_PROFILE_NDX_OUT_OF_RANGE_ERR = SOC_PB_PP_ERR_DESC_BASE_LIF_COS_FIRST,
   ...
   * Last element. Do no touch.
   */
  SOC_PB_PP_LIF_COS_ERR_LAST
} SOC_PB_PP_LIF_COS_ERR;
 ...
 *     "soc_pb_pp_lif_cos_ac_profile_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_ac_profile_info_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_ac_profile_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_pwe_profile_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_pwe_profile_info_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_pwe_profile_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_profile_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_profile_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_profile_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_profile_map_l2_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_profile_map_l2_info_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_profile_map_l2_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_profile_map_ip_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_profile_map_ip_info_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_profile_map_ip_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_profile_map_tc_dp_info_set_unsafe" API.
 *     Refer to
 *     "soc_pb_pp_lif_cos_profile_map_tc_dp_info_set_unsafe" API
 *     for details.
*********************************************************************/
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_opcode_types_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_opcode_types_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_opcode_types_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_opcode_ipv6_tos_map_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_opcode_ipv6_tos_map_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_opcode_ipv6_tos_map_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_opcode_ipv4_tos_map_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_opcode_ipv4_tos_map_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_opcode_ipv4_tos_map_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_opcode_tc_dp_map_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_opcode_tc_dp_map_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_opcode_tc_dp_map_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_cos_opcode_vlan_tag_map_set_unsafe" API.
 *     Refer to "soc_pb_pp_lif_cos_opcode_vlan_tag_map_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_lif_cos_opcode_vlan_tag_map_get_unsafe(
...
/* } __SOC_PB_PP_LIF_COS_INCLUDED__*/
#endif
