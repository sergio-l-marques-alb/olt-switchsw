...
typedef enum
{
   ...
   * invalid out-port
   */
  SOC_PPC_TRAP_EG_TYPE_INVALID_OUT_PORT = (1 << 16), /* 0x10000, */
  /*
   * CNM packet
   */
  SOC_PPC_TRAP_EG_TYPE_CNM_PACKET = (2 << 16),
  /*
   *  IPv4 version error
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_VERSION_ERROR  = (3 << 16),
  /*
   *  IPv4 header checksum error
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_CHECKSUM_ERROR = (4 << 16),
  /*
   *  IPv4 header length is < 20B
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_HEADER_LENGTH_ERROR = (5 << 16),
  /*
   *  IPv4 total length is < 20B
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_TOTAL_LENGTH_ERROR = (6 << 16),
  /*
   *  IP TTL=0
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IP_TTL0 = (7 << 16),
  /*
   *  IP with options
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IP_HAS_OPTIONS = (8 << 16),
  /*
   *  IP TTL=1
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IP_TTL1 = (9 << 16),
  /*
   *  SIP equal DIP
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_SIP_EQUAL_DIP = (10 << 16),
  /*
   *  IPv4 DIP is 0.0.0.0
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_DIP_ZERO = (11 << 16),
  /*
   * . SIP is multicast
   *  ARAD only.
   *  not relevant for Soc_petra-B.
   */
  SOC_PPC_TRAP_EG_TYPE_IPV4_SIP_IS_MC = (12 << 16),
  /*
   *  Forwarding header DIP = ::
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_UNSPECIFIED_DESTINATION = (13 << 16),
  /*
   *  DIP = ::1 or SIP = ::1
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_LOOPBACK_ADDRESS = (14 << 16),
  /*
   *  The MSB of the SIP = 0xFF
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_MULTICAST_SOURCE = (15 << 16),
  /*
   *  SIP = ::
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_UNSPECIFIED_SOURCE = (16 << 16),
  /*
   *  Bits 127:118 of the destination-IP are
   *  equal to 0x3FA
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_LOCAL_LINK_DESTINATION = (17 << 16),
  /*
   *  Bits 127:118 of the DIP = 0x3FB
   *  (deprecated)
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_LOCAL_SITE_DESTINATION = (18 << 16),
  /*
   *  Bits 127:118 of the SIP = 0x3FA
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_LOCAL_LINK_SOURCE = (19 << 16),
  /*
   *  Bits 127:118 of the SIP = 0x3FB
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_LOCAL_SITE_SOURCE = (20 << 16),
  /*
   *  Bits 127:32 of the DIP = 0
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_IPV4_COMPATIBLE_DESTINATION = (21 << 16),
  /*
   *  Bits 127:32 of the DIP are equal to
   *  0000_FFF_0000_0000_0000_0000
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_IPV4_MAPPED_DESTINATION = (22 << 16),
  /*
   *  MSB of the DIP=0xFF
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_MULTICAST_DESTINATION = (23 << 16),
  /*
   *  hob-by-hop address
   */
  SOC_PPC_TRAP_EG_TYPE_IPV6_HOP_BY_HOP  = (24 << 16),
