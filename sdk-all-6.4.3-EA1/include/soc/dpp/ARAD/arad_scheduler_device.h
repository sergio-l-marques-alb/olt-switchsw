/* $Id: arad_scheduler_device.h,v 1.3 Broadcom SDK $
...
*     ARAD_INTERFACE_ID (when used in Arad-A mode) or internal id
*     (ARAD_INTERFACE_ID in arad-B mode converted to internal using
...
/*********************************************************************
* NAME:
*     arad_sch_if_shaper_rate_set_unsafe
* TYPE:
*   PROC
* DATE:
*   Dec  2 2007
...
/*********************************************************************
* NAME:
*     arad_sch_if_shaper_rate_get_unsafe
* TYPE:
*   PROC
* DATE:
*   Dec  2 2007
...
/* } __ARAD_SCHEDULER_DEVICE_H_INCLUDED_*/
#endif
