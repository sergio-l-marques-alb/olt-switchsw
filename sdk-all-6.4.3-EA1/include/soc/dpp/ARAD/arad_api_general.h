 ...
 */
#define ARAD_FAP_EGRESS_REPLICATION_SCH_PORT_ID       248
 ...
 *  depending on the credit size
 */
#define ARAD_SCH_MAX_RATE_MBPS        (SOC_TMC_SCH_MAX_RATE_KBPS_ARAD)
#define ARAD_IF_MAX_RATE_MBPS         (SOC_TMC_IF_MAX_RATE_MBPS_ARAD)
 ...
 *  depending on the credit size
 */
#define ARAD_IF_MAX_RATE_KBPS         (SOC_TMC_IF_MAX_RATE_KBPS_ARAD)
...
#define ARAD_ERP_PORT_ID                   ARAD_FAP_EGRESS_REPLICATION_SCH_PORT_ID
