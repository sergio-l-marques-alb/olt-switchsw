...
#define ARAD_PP_RIF_ROUTE_ENABLE_TYPE_NONE                   SOC_PPC_RIF_ROUTE_ENABLE_TYPE_NONE
#define ARAD_PP_RIF_ROUTE_ENABLE_TYPE_IP_UC                  SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IP_UC
#define ARAD_PP_RIF_ROUTE_ENABLE_TYPE_IP_MC                  SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IP_MC
#define ARAD_PP_RIF_ROUTE_ENABLE_TYPE_MPLS                   SOC_PPC_RIF_ROUTE_ENABLE_TYPE_MPLS
#define ARAD_PP_RIF_ROUTE_ENABLE_TYPE_ALL                    SOC_PPC_RIF_ROUTE_ENABLE_TYPE_ALL
#define ARAD_PP_NOF_RIF_ROUTE_ENABLE_TYPES                   SOC_PPC_NOF_RIF_ROUTE_ENABLE_TYPES
typedef SOC_PPC_RIF_ROUTE_ENABLE_TYPE                          ARAD_PP_RIF_ROUTE_ENABLE_TYPE;
