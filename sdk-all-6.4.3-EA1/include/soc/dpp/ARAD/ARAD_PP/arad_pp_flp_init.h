...
#define ARAD_PP_FLP_KEY_OR_MASK_LAST                0x20 /* need to update this value when adding new define */
...
#define ARAD_PP_FLP_KEY_PROGRAM_LAST                           (ARAD_PP_FLP_KEY_PROGRAM_IPV6UC_WITH_RPF_2PASS)
