...
typedef uint32 (*mbcm_dpp_sch_port_sched_set_f) ( 
    SOC_SAND_IN  int                unit, 
    SOC_SAND_IN  SOC_TMC_SCH_PORT_ID        port_ndx, 
...
typedef uint32 (*mbcm_dpp_mult_eg_all_groups_close_f) ( 
    SOC_SAND_IN  int                 unit 
  ); 
...
typedef uint32 (*mbcm_dpp_mult_eg_vlan_membership_all_groups_close_f) ( 
    SOC_SAND_IN  int                 unit 
  ); 
...
typedef uint32 (*mbcm_dpp_mult_ing_all_groups_close_f) ( 
    SOC_SAND_IN  int                 unit 
  ); 
...
typedef uint32 (*mbcm_dpp_ofp_rates_egq_single_port_rate_sw_set_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 ofp_ndx,
    SOC_SAND_IN  uint32                 rate
  );
typedef uint32 (*mbcm_dpp_ofp_rates_egq_single_port_rate_hw_set_f)(
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 ofp_ndx
  );
...
typedef uint32(*mbcm_dpp_ofp_rates_egq_single_port_rate_hw_get_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 ofp_ndx,
    SOC_SAND_OUT uint32                 *rate
  );
...
typedef uint32 (*mbcm_dpp_ofp_rates_egq_interface_shaper_set_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 ofp_ndx,
    SOC_SAND_IN SOC_TMC_OFP_SHPR_UPDATE_MODE rate_update_mode,
    SOC_SAND_IN  uint32                 if_shaper_rate
  );
typedef uint32 (*mbcm_dpp_ofp_rates_egq_interface_shaper_get_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 ofp_ndx,
...
typedef struct mbcm_dpp_functions_s {
    ...
    mbcm_dpp_mult_eg_all_groups_close_f           mbcm_dpp_mult_eg_all_groups_close; 
    ...
    mbcm_dpp_mult_eg_vlan_membership_all_groups_close_f mbcm_dpp_mult_eg_vlan_membership_all_groups_close; 
    ...
    mbcm_dpp_mult_ing_all_groups_close_f          mbcm_dpp_mult_ing_all_groups_close; 
    /* ofp_rates functions */ 
