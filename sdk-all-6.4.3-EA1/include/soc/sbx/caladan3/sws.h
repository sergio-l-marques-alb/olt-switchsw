...
extern
void soc_sbx_caladan3_sws_pr_icc_program_port_match_entries(int unit);
...
/*
 * Function:
 *     sws_pr_icc_reserved_rules_get
 * Purpose:
 *     Get the current reserved rules
 */
extern int sws_pr_icc_reserved_rules_get(int unit, int instance);

/*
 * Function:
 *     sws_pr_icc_reserved_rules_set
 * Purpose:
 *     Set number of reserved rules, only update local var
 */
extern void sws_pr_icc_reserved_rules_set(int unit, int instance, int idx);
