...
#include <appl/diag/dpp/asic/asic_init_cfg.h>
#endif
...
DCL_CMD(cmd_dpp_mem_insert, cmd_dpp_mem_insert_usage)
DCL_CMD(cmd_dpp_mem_lkup, cmd_dpp_mem_lkup_usage)
DCL_CMD(cmd_dpp_mem_delete, cmd_dpp_mem_delete_usage)
...
DCL_CMD(cmd_dpp_sweep, cmd_dpp_sweep_usage)

DCL_CMD(cmd_dpp_switch_control, cmd_dpp_switch_control_usage)

#if defined(__DUNE_GTO_BCM_CPU__) && defined(BCM_88650_A0)
