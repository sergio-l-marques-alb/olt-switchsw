/*
 * $Id: wb_db_l2.h,v 1.5 Broadcom SDK $
 ...
 *
 * File:        wb_db_l2.h
 * Purpose:     WarmBoot - Level 2 support (L2 Module)
 */

#ifndef _BCM_DPP_WB_DB_L2_H_
#define _BCM_DPP_WB_DB_L2_H_
 ...
 *
 * Currently there is a single handle for L2 module.
...
#define BCM_DPP_WB_L2_VERSION_1_0            SOC_SCACHE_VERSION(1,0)
#define BCM_DPP_WB_L2_CURRENT_VERSION        BCM_DPP_WB_L2_VERSION_1_0


#define BCM_DPP_WB_L2_INFO(unit)             (_dpp_wb_l2_info_p[unit])
#define BCM_DPP_WB_L2_INFO_INIT(unit)        ( (_dpp_wb_l2_info_p[unit] != NULL) &&          \
                                               (_dpp_wb_l2_info_p[unit]->init_done == TRUE) )
 ...
 */
#define BCM_DPP_WB_L2_MAX_LEM_PUNT_TEMPLATES(unit)                                          \
                        (100 /*_DPP_AM_TEMPLATE_LEM_PUNT_COUNT*/)


#define BCM_DPP_WB_DEV_L2_DIRTY_BIT_SET(unit)                                       \
                        SOC_CONTROL_LOCK(unit);                                     \
                        SOC_CONTROL(unit)->scache_dirty = 1;                        \
                        BCM_DPP_WB_L2_INFO(unit)->is_dirty = 1;                     \
                        SOC_CONTROL_UNLOCK(unit);

#define BCM_DPP_WB_L2_DIRTY_BIT_CLEAR(unit)                                         \
                        SOC_CONTROL_LOCK(unit);                                     \
                        BCM_DPP_WB_L2_INFO(unit)->is_dirty = 0;                     \
                        SOC_CONTROL_UNLOCK(unit);

#define BCM_DPP_WB_L2_IS_DIRTY(unit)                                                \
                        (BCM_DPP_WB_L2_INFO(unit)->is_dirty == 1)
 ...
 * runtime information
 */
typedef struct bcm_dpp_wb_l2_info_s {
    int            init_done;
    int            is_dirty;
...
} bcm_dpp_wb_l2_info_t;

extern bcm_dpp_wb_l2_info_t   *_dpp_wb_l2_info_p[BCM_MAX_NUM_UNITS];
/*
 * Functions
 */
extern int
...
extern void 
_bcm_l2_cb_entry_get(int unit, int idx, bcm_l2_addr_callback_t *fn, void **fn_data);
