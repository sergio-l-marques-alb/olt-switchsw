...
extern int _bcm_esw_failover_ecmp_prot_nhi_create(int unit, int ecmp, int nh_index, 
                             int prot_nh_index, bcm_failover_t failover_id);
extern int _bcm_esw_failover_ecmp_prot_nhi_cleanup(int unit, int ecmp, int nh_index);
extern int _bcm_esw_failover_ecmp_prot_nhi_get(int unit, int ecmp, int nh_index,
                             bcm_failover_t *failover_id, int *prot_nh_index);
extern int _bcm_esw_failover_ecmp_prot_nhi_update(int unit, int ecmp, 
