...
typedef struct {
	...
	int (*field_compress_create)(int,bcm_field_compression_t,bcm_field_compress_attr_t *);
	int (*field_compress_destroy)(int,int);
	int (*field_compress_get)(int,int,bcm_field_qualify_t,uint64 *,uint16,uint32 *,uint32 *,uint16 *);
	int (*field_compress_multi_get)(int,int,uint16,uint32 *,uint32 *,uint16 *);
	int (*field_compress_multi_set)(int,int,int,uint32 *,uint32 *);
	int (*field_compress_set)(int,int,bcm_field_qualify_t,int,uint32 *,uint32 *,uint64);
	int (*field_compress_size_get)(int,bcm_field_qualify_t,int *);
	int (*field_compressed_mask_length_get)(int,bcm_field_qualify_t,int *);
	...
	int (*oam_performance_event_register)(int,bcm_oam_event_types_t,bcm_oam_performance_event_cb,bcm_oam_performance_event_data_t *,void *);
	...
	int (*port_get)(int,bcm_port_t,bcm_port_interface_info_t *,bcm_port_mapping_info_t *);
	...
	int (*sat_ctf_bin_limit_get)(int,int,int *,bcm_sat_ctf_bin_limit_t *);
	...
	int (*switch_pkt_trace_info_get)(int,bcm_switch_pkt_trace_info_t *);
