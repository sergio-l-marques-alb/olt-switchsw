...
#define BCM_L3_L2ONLY                       (1 << 0)   /* L2 switch only on
                                                          interface. */
#define BCM_L3_UNTAG                        (1 << 1)   /* Packet goes out
                                                          untagged. */
#define BCM_L3_S_HIT                        (1 << 2)   /* Source IP address
                                                          match. */
...
#define BCM_L3_ADD_TO_ARL                   (1 << 5)   /* Add interface address
                                                          MAC to ARL. */
#define BCM_L3_WITH_ID                      (1 << 6)   /* ID is provided. */
#define BCM_L3_NEGATE                       (1 << 7)   /* Negate a set. */
#define BCM_L3_INGRESS_ONLY                 BCM_L3_NEGATE /* configure ingress
                                                          objects only. */
#define BCM_L3_REPLACE                      (1 << 8)   /* Replace existing
                                                          entry. */
#define BCM_L3_TGID                         (1 << 9)   /* Port belongs to trunk. */
#define BCM_L3_OVERLAY_ENCAP                BCM_L3_TGID /* LL encapsulation, used
                                                          for overlay LL for
                                                          intra DC routed
                                                          packets */
#define BCM_L3_RPE                          (1 << 10)  /* Pick up new priority
                                                          (COS). */
#define BCM_BCM_L3_ENCAP_SPACE_OPTIMIZED    BCM_L3_RPE /* Optimize encapsulation
                                                          database resources. */
#define BCM_L3_IPMC                         (1 << 11)  /* Set IPMC for real IPMC
                                                          entry. */
#define BCM_L3_L2TOCPU                      (1 << 12)  /* Packet to CPU
                                                          unrouted, XGS12: Set
                                                          IPMC for UC address. */
#define BCM_L3_NATIVE_ENCAP                 BCM_L3_L2TOCPU /* Eth encapsulation,
                                                          used for nativ
                                                          Ethernet for intra DC
                                                          routed packets */
#define BCM_L3_DEFIP_CPU                    (1 << 13)  /* Strata: DEFIP CPU bit
                                                          set. */
#define BCM_L3_DEFIP_LOCAL                  BCM_L3_DEFIP_CPU /* XGS: Local DEFIP
                                                          route. */
#define BCM_L3_VIRTUAL_OBJECT               (1 << 13)  /* FEC/egress-encap
                                                          (virtual FEC). */
#define BCM_L3_EGRESS_ONLY                  BCM_L3_VIRTUAL_OBJECT /*  Configure Egress
                                                          objects only. */
#define BCM_L3_MULTIPATH                    (1 << 14)  /* Specify ECMP
                                                          treatment. */
#define BCM_L3_HOST_LOCAL                   (1 << 15)  /* Packet to local IP
                                                          stack. */
...
#define BCM_L3_DST_DISCARD                  (1 << 20)  /* Destination match
                                                          discard. */
#define BCM_L3_SECONDARY                    (1 << 21)  /* Secondary L3
                                                          interface. */
#define BCM_L3_ROUTE_LABEL                  (1 << 22)  /* Indicates that MPLS
                                                          label in route entry
                                                          is valid. */
#define BCM_L3_COPY_TO_CPU                  (1 << 23)  /* Send a copy to CPU. */
#define BCM_L3_KEEP_SRCMAC                  (1 << 24)  /* Disable SA replacement
                                                          for L3UC packets. */
#define BCM_L3_KEEP_DSTMAC                  (1 << 25)  /* Disable DA replacement
                                                          for L3UC packets. */
#define BCM_L3_KEEP_VLAN                    (1 << 26)  /* Disable VLAN
                                                          replacement for L3UC
                                                          packets. */
#define BCM_L3_KEEP_TTL                     (1 << 27)  /* Disable TTL
                                                          replacement for L3UC
                                                          packets. */
#define BCM_L3_TRILL_ONLY                   (1 << 28)  /* Specific for TRILL
                                                          Nexthop */
#define BCM_L3_L2GRE_ONLY                   (1 << 29)  /* Specific for L2GRE
                                                          Nexthop */
#define BCM_L3_QUEUE_MAP                    (1 << 30)  /* Use queue map to
                                                          derive queue number */
#define BCM_L3_DEREFERENCED_NEXTHOP         (1 << 30)  /* Indicates this is a
                                                          wider L3 entry. */
#define BCM_L3_ECMP_RH_REPLACE              BCM_L3_DEREFERENCED_NEXTHOP /* Replace ECMP member
                                                          without RH flowset
                                                          table shuffle. */
#define BCM_L3_VXLAN_ONLY                   (1 << 31)  /* Specific for VXLAN
                                                          Nexthop */
