...
typedef struct bcm_bfd_endpoint_stat_s {
    uint64 packets_in;          /* Total packets in. */
    uint64 packets_out;         /* Total packets out. */
    uint64 packets_drop;        /* Total packets drop. */
    uint64 packets_auth_drop;   /* Packets drop due to authentication failure. */
