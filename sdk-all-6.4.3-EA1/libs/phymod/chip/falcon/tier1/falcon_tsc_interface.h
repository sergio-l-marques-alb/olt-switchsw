...
/***********************************************************************************/
/*                                                                                 */
/*  Revision    :  $Id: falcon_api_interface.h 651 2014-08-04 23:22:26Z kirand $ */
/*                                                                                 */
 ...
 * \section API_sec API
 *
 * falcon_api_interface.h - provides the primary functionality.
 *
 * falcon_api_dependencies.h - defines the functions to be provided by the IP user
 *
 *
 */

/** @file falcon_api_interface.h
 * Main interface functions provided to IP User
 */

#ifndef SERDES_API_INTERFACE_H
#define SERDES_API_INTERFACE_H
...
struct falcon_uc_lane_config_field_st {
...
struct falcon_uc_core_config_field_st {
#ifdef FALCON
  uint8_t  vco_rate          ;
...
/** Lane Config Struct */
struct  falcon_uc_lane_config_st {
  struct falcon_uc_lane_config_field_st field;  
  uint16_t word;                       
                  
}; 

/** Core Config Struct */
struct  falcon_uc_core_config_st {
  struct falcon_uc_core_config_field_st field; 
  uint16_t word;         
};
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_tsc_get_uc_core_config(const phymod_access_t *pa, struct falcon_uc_core_config_st *struct_val);
...
/** Column definition header for serdes display core state.
 * To be called before falcon_display_core_state_line(pa ) function 
 ...
 * Call functions falcon_display_core_state_hdr before and falcon_display_core_state_legend(pa ) after 
 * to get a formatted core state display with legend 
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_display_core_state_line(const phymod_access_t *pa);

/** Detailed explanation of each column in serdes display core state.
 * To be called after falcon_display_core_state_line(pa ) function to display the legends 
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_display_state (void);


/** Display current Core and Lane config.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_display_config (void);
 ...
 * API returns the fixed pattern generator mode select which needs to be passed to the falcon_tx_shared_patt_gen_en(pa, ) function
 ...
 * User needs to configure all lanes through falcon_lane_config_for_iddq(pa ) before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * Along with falcon_core_pwrdn(pa, ), all lanes powerdowns should also be issued using falcon_tsc_lane_pwrdn(pa, ) to complete a Core Powerdown 
 ...
 * If using MDIO interface to access the registers, use this function to implement falcon_pmd_mwr_reg(pa, ..)
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_tsc_get_uc_lane_cfg(const phymod_access_t *pa, struct falcon_uc_lane_config_st *struct_val);
 ...
 */
err_code_t falcon_validate_txfir_cfg(const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2);  
 ...
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_apply_txfir_cfg(const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2);    
 ...
 */
err_code_t falcon_config_tx_hpf(uint8_t hpf_val);
 ...
 * @return Error Code generated by invalid settings (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_rd_tx_hpf_config(uint8_t *hpf_val);
#endif
 ...
 * @param param selects the parameter to write based on falcon_tx_afe_settings_enum
 ...
 * It relies on the accuracy of falcon_delay_us(pa, ) function and recommend:
 *  eyescan_options.horz_max = 31;
 *  eyescan_options.horz_min = -31;
 *  eyescan_options.vert_max = 31;
 *  eyescan_options.vert_min = -31;
...
/** Displays Eye Density Data measured with falcon_meas_eye_density_data()
 *  
 *  eyescan_options.horz_max = 31;
 *  eyescan_options.horz_min = -31;
 *  eyescan_options.vert_max = 31;
 ...
 * @param eyescan_options is structure of options which control min,max,step, time, and linerate
 * @param *buffer is pointer to array which contains all samples.
 * @param buffer_size must provide buffer_size which is returned from falcon_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * falcon_start_ber_scan_test, falcon_read_ber_scan_data, falcon_display_ber_scan_data
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use enum ber_scan_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * Call functions falcon_tsc_display_lane_state_hdr(pa ) before and falcon_tsc_display_lane_state_legend(pa ) after 
...
/** Column definition header for serdes display state.
 * To be called before falcon_tsc_display_lane_state(pa ) function 
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_tsc_display_lane_state_hdr(const phymod_access_t *pa);


/** Detailed explanation of each column in serdes display state.
 * To be called after falcon_tsc_display_lane_state(pa ) function to display the legends 
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps
 * @param param Enum (falcon_rx_afe_settings_enum) to select the required RX AFE setting to be modified
 ...
 * @param param Enum (falcon_rx_afe_settings_enum) to select the required RX AFE setting to be read
 * @param *val Value to be written to the selected AFE setting
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * Note: The patt_length input to the function should be the value sent to the falcon_config_shared_tx_pattern(pa, ) function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in falcon_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */ 
 ...
 * Once the PRBS generator is configured, it can be enabled using the falcon_tsc_tx_prbs_en(pa, ) function
 ...
 * Once the PRBS checker is configured, it can be enabled using the falcon_tsc_rx_prbs_en(pa, ) function
 ...
 * User needs to configure all lanes through falcon_lane_config_for_iddq(pa ) and also call falcon_core_config_for_iddq(pa ) 
