/*~~~~~~~~~~~~~~~~~~~~~~~~~~ RCPU ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*
 * $Id: cint_cmic_rcpu.c,v 1.2 Broadcom SDK $
 *
 ...
 *          b. read  eci_test_register=0x230                                   887456000101000100080008000000002C0002000000023          
 *                                                                                                                                      
...
int cmic_rcpu_appl(int unit)
{
    ...
    rv = cmic_rcpu_example(unit, cpu_rcpu_port, out_port, lmac, rmac, sig, ethertype, vlan, tpid);
    if (rv != BCM_E_NONE) {
