                              ...
                              int offset, uint32 value)
{
    ...
    if ( value ) {
        phy_bcm542xx_direct_reg_write( unit, pc,
                ...
                (offset & PHY_BCM542XX_SYNCE_RECOVERY_CLK_REG_REC_CLK1_SEL)
                | (data & 0xf0) );    /* 0xf0 keeps REC_CLK2 unchanged */
    } else {
        phy_bcm542xx_direct_reg_write( unit, pc,
                PHY_BCM542XX_SYNCE_RECOVERY_CLK_REG_OFFSET, 
                                        ...
                                        int offset, uint32 value)
{
    ...
    if ( value ) {
        phy_bcm542xx_direct_reg_write( unit, pc,
                PHY_BCM542XX_SYNCE_RECOVERY_CLK_REG_OFFSET, 
                (offset & PHY_BCM542XX_SYNCE_RECOVERY_CLK_REG_REC_CLK2_SEL)
                | (data & 0x0f) );    /* 0x0f keeps REC_CLK1 unchanged */
    } else {
        phy_bcm542xx_direct_reg_write( unit, pc,
                PHY_BCM542XX_SYNCE_RECOVERY_CLK_REG_OFFSET, 
