  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(eg_encap_port_erspan_set,(unit, local_port_ndx, is_erspan));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(eg_encap_port_erspan_get,(unit, local_port_ndx, is_erspan));
