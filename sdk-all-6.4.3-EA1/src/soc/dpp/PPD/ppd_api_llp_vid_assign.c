  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_vid_assign_port_info_set,(unit, local_port_ndx, port_vid_assign_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_vid_assign_port_info_get,(unit, local_port_ndx, port_vid_assign_info));
