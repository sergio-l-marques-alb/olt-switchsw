  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(lag_hashing_port_info_set,(unit, port_ndx, lag_hash_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(lag_hashing_port_info_get,(unit, port_ndx, lag_hash_info));
