  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_FRWRD_DEVICE_CALL(frwrd_mact_entry_remove,(unit, mac_entry_key));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_FRWRD_DEVICE_CALL(frwrd_mact_get_block,(unit, rule, block_range, mact_keys, mact_vals, nof_entries));
