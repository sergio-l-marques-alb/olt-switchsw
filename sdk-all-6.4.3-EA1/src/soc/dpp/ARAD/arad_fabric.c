...
#define ARAD_FABRIC_LLFC_RX_MAX                             (0xff)
  ...
  )
{
  ...
  int i;
    ...
    for (link_ndx=0; link_ndx < fbr_nof_links; link_ndx++) {
        ...
        */
        SOCDNX_IF_ERR_EXIT(READ_FMAC_FMAL_TX_CONTROL_BURST_CONFIGURATIONr(unit, blk_id, &reg_val));
  ...
  )
{
  ...
  case ARAD_FABRIC_CONNECT_MODE_MESH:
    value_3 = ARAD_FBC_CONNECT_MESH_VAL_3;
