...
/* $Id: arad_pp_api_port.c,v 1.7 Broadcom SDK $
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_INFO_SET);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_port_info_set()", local_port_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_INFO_GET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_port_info_get()", local_port_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_STP_STATE_SET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_port_stp_state_set()", local_port_ndx, topology_id_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_PORT_STP_STATE_GET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_port_stp_state_get()", local_port_ndx, topology_id_ndx);
}
