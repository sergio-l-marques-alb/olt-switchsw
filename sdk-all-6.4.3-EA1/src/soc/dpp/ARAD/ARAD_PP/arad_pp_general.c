...
#define ARAD_PP_ENCODE_NOF_BITS_19_FEC_PTR                       (15)
  ...
  )
{
  ...
  case ARAD_PP_FRWRD_DECISION_TYPE_FEC:
    ...
    {
    case ARAD_PP_DEST_ENCODE_TYPE_19_BITS:
      SOC_SAND_ERR_IF_ABOVE_MAX(info->dest_id, (1<<ARAD_PP_ENCODE_NOF_BITS_19_FEC_PTR)-1, ARAD_PP_FRWRD_DEST_FEC_PTR_OUT_OF_RANGE_ERR, 40, exit);
      break;
    default:
