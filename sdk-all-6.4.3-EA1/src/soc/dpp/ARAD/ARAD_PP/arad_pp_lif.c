...
#define ARAD_PP_LIF_KEY_MAPPING_MAX                              (ARAD_PP_NOF_L2_LIF_AC_MAP_KEY_TYPES-1)
#define ARAD_PP_LIF_HANDLE_TYPE_MAX                              (ARAD_PP_NOF_L2_LIF_L2CP_HANDLE_TYPES-1)
#define ARAD_PP_LIF_DEFAULT_FRWD_TYPE_MAX                        (ARAD_PP_NOF_L2_LIF_DFLT_FRWRD_SRCS-1)
...
#define ARAD_PP_LIF_PROTECTION_POINTER_MAX                       (0x3fff)
...
#define ARAD_PP_LIF_PWE_SERVICE_TYPE_MAX                         (ARAD_PP_NOF_L2_LIF_PWE_SERVICE_TYPES-1)
#define ARAD_PP_LIF_RAW_KEY_MAX                                  (SOC_SAND_U32_MAX)
#define ARAD_PP_LIF_LEARN_TYPE_MAX                               (ARAD_PP_NOF_L2_LIF_AC_LEARN_TYPES-1)
...
#define ARAD_PP_LIF_AC_SERVICE_TYPE_MAX                          (ARAD_PP_NOF_L2_LIF_AC_SERVICE_TYPES-1)
#define ARAD_PP_LIF_ISID_SERVICE_TYPE_MAX                        (ARAD_PP_NOF_L2_LIF_ISID_SERVICE_TYPES-1)

#define ARAD_PP_LIF_GRE_VPN_MAX                                  ((1 << 24)-1)
#define ARAD_PP_LIF_VXLAN_VPN_MAX                                  ((1 << 24)-1)


#define ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_LSB           (0)
#define ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_MSB           (5)
#define ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_SHIFT         (ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_LSB)
#define ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_MASK          (SOC_SAND_BITS_MASK(ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_MSB, ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_LSB))

#define ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_LSB                 (6)
#define ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_MSB                 (6)
#define ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_SHIFT               (ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_LSB)
#define ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_MASK                (SOC_SAND_BITS_MASK(ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_MSB, ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_LSB))
...
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_LSB     (0)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_MSB     (0)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_SHIFT   (ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_LSB)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_MASK    (SOC_SAND_BITS_MASK(ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_MSB, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_LSB))

#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_LSB         (1)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_MSB         (2)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_SHIFT       (ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_LSB)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_MASK        (SOC_SAND_BITS_MASK(ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_MSB, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_LSB))

#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_LSB             (3)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_MSB             (4)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_SHIFT           (ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_LSB)
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_MASK            (SOC_SAND_BITS_MASK(ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_MSB, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_LSB))

/* Internal profile for VSI assignment VSQ EQ VLAN */
...
#define ARAD_PP_L2_LIF_L2CP_KEY_ENTRY_OFFSET(l2cp_profile, da_mac_address_lsb)  \
          SOC_SAND_SET_FLD_IN_PLACE(da_mac_address_lsb, ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_SHIFT, ARAD_PP_L2_LIF_L2CP_KEY_DA_MAC_ADDRESS_LSB_MASK) | \
          SOC_SAND_SET_FLD_IN_PLACE(l2cp_profile, ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_SHIFT, ARAD_PP_L2_LIF_L2CP_KEY_L2CP_PROFILE_MASK)
...
#define ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_ENTRY_OFFSET(port_da_not_found_profile, da_type, lif_default_forward_profile)  \
          SOC_SAND_SET_FLD_IN_PLACE(port_da_not_found_profile, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_SHIFT, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_PORT_DA_PROFILE_MASK) | \
          SOC_SAND_SET_FLD_IN_PLACE(da_type, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_SHIFT, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_DA_TYPE_MASK) | \
          SOC_SAND_SET_FLD_IN_PLACE(lif_default_forward_profile, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_SHIFT, ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_LIF_PROFILE_MASK)
  ...
  Arad_pp_procedure_desc_element_lif[] =
{
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_LIF_AC_MP_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_LIF_AC_MP_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_LIF_AC_MP_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_LIF_AC_MP_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_LIF_AC_MP_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_LIF_AC_MP_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_lif[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_L2_LIF_AC_MAP_KEY_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_L2_LIF_L2CP_HANDLE_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_L2_LIF_DFLT_FRWRD_SRCS-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_L2_LIF_PWE_SERVICE_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_L2_LIF_AC_LEARN_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  ...
  /* 
   *  VSI-Assignment-Mode settings:
   *  Profiles use:
   *    SOC_PPC_VSI_EQ_VSI_BASE (0x0)
   *    SOC_PPC_VSI_EQ_IN_LIF (0x3)
   *    SOC_PPC_VSI_EQ_IN_VID, ,ARAD_PP_L2_LIF_VSI_ASSIGNMENT_MODE_VSI_EQ_VLAN (0x2)
   *    SOC_PPC_VSI_EQ_IN_VID_PLUS_VSI_BASE (0x1)
   */

  /* 
   * VSI-Masks.Base is taking part only in Profile 0 (SOC_PPC_VSI_EQ_VSI_BASE), 1 (SOC_PPC_VSI_EQ_IN_VID_PLUS_VSI_BASE)
   */
  ...
  /* 
   * VSI-Masks.Key-C is taking part in profile 2 (SOC_PPC_VSI_EQ_IN_VID) and 1 (SOC_PPC_VSI_EQ_IN_VID_PLUS_VSI_BASE)
   * VSI mask only 12 bits since it is the VLAN-tag (or initial_VID)  
   */
  ...
  /* 
   * VSI-Masks.Key-Result-B used for profiles 3 (SOC_PPC_VSI_EQ_IN_LIF)
   */
  ...
  /* 
   * VSI-Masks.Key-Result-C used for profiles 0 when Trill transparent service is enabled
   */
  ...
  /* 
   * VSI-Mask-Profile (2) = {VSI-Assignment-Mode (2),
   *    [in Arad+, Result-A-Found (1), ]
   *    Result-B-Found (1), Result-C-Found (1)} 
   * VSI-Mask-Profile 0 = {0, Dont care, Dont care}
   * VSI-Mask-Profile 1 = {1, Dont care, Dont care}
   * VSI-Mask-Profile 2 = {2, Dont care, Dont care}                                          
   * VSI-Mask-Profile 3 = {3, Dont care, Dont care}                                                                          
   */
  /*
   * For the TRILL VSI assignment mode (3), need two separate profiles: one for ISB-Found and one for (!ISB-Found & TCAM-Found).
   * Currently, we use ISB-Found-Profile = 3, TCAM-Found-Profile = 0.
   * IHP.VsiMaskProfileMap[63:62] = ISB-Found-Profile 
   * IHP.VsiMaskProfileMap[61:60] = ISB-Found-Profile
   * IHP.VsiMaskProfileMap[59:58] = TCAM-Found-Profile   
   * IHP.VsiMasksResultB[ISB-Found-Profile]=0xffff
   * IHP.VsiMasksResultC[TCAM-Found-Profile]=0xffff
   * All other VSI masks for these two profiles set to 0.
   * ARAD VSI Mask profile map for TRILL VSI assignment mode (3): [01](!ISB-Found & TCAM-Found)
   *      ------------------
   *      | 11 | 11| 00 | 11 | -> 0xF3
   *      -----------------
    * ARAD Plus VSI Mask profile map for TRILL VSI assignment mode (3): [001](!ISA-Found & !ISB-Found & TCAM-Found),  [101](ISA-Found & !ISB-Found & TCAM-Found)
   *      ----------------------------------
   *      | 11 | 11| 00 | 11 | 11 | 11 | 00 | 11 | -> 0xF3F3
   *      ----------------------------------
   */ 
  ...
  )
{
  ...
  res = arad_pp_sw_db_mpls_termination_label_index_enable_get(unit,&use_label_index);
  ...
  {        
    ...
    case SOC_PPC_MPLS_LABEL_INDEX_FIRST:
      isem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_MPLS_L1; /*GAL not supported */
      break;
    ...
    case SOC_PPC_MPLS_LABEL_INDEX_THIRD:
      isem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_MPLS_L3; /*GAL not supported */
      break;
  ...
  {
    isem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_MPLS; /*GAL not supported */
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_IN_VC_RANGE, in_vc_range, 10, exit);
  ...
  )
{
  ...
  */
  ...
  {
    if (pwe_info->service_type == ARAD_PP_L2_LIF_PWE_SERVICE_TYPE_P2P)
    {
      ...
      {
        data.eei_or_out_lif_type = 0; /* eei */ 
      }
      else 
      {
        data.eei_or_out_lif_type = 1; /* out-lif */
      }

      data.in_lif_profile = pwe_info->lif_profile;
      data.protection_pointer = pwe_info->protection_pointer;
      data.protection_path = pwe_info->protection_pass_value;
      data.oam_lif_set = pwe_info->oam_valid; 
      data.termination_profile = pwe_info->term_profile & 0x3; /* 2 bits LSB */
      data.termination_profile_msb = (pwe_info->term_profile >> 2) & 0x1; /* 1 bit MSB */
      ...
      if(pwe_info->default_frwrd.default_forwarding.additional_info.eei.type != SOC_PPC_EEI_TYPE_EMPTY) 
      {
        /* Entry has EEI: EEI-or-Out-LIF 24b */        
        res = soc_sand_bitstream_get_field(&temp, 0, 24, &data.eei_or_out_lif);
        SOC_SAND_CHECK_FUNC_RESULT(res, 39, exit);      
      } 
      else
      {
        /* Entry has OutLIF: EEI-or-Out-LIF[16] = Out-LIF-Valid, EEI-or-Out-LIF[15:0] = Out-LIF */
        data.eei_or_out_lif = temp; /* Out-LIF */
        res = soc_sand_bitstream_set_bit(&data.eei_or_out_lif, 16); /* Valid */
        SOC_SAND_CHECK_FUNC_RESULT(res, 39, exit);     
      }
    ...
    if (pwe_info->service_type == ARAD_PP_L2_LIF_PWE_SERVICE_TYPE_MP)
    {
      ...
      /* In Jericho, this field is not split into two fields anymore. */
      if (SOC_IS_JERICHO(unit)) {
      ...
      if(pwe_info->learn_record.learn_info.additional_info.eei.type != ARAD_PP_EEI_TYPE_EMPTY) {
        payload.flags |= ARAD_PP_FWD_DECISION_PARSE_EEI;
      }
      else if(pwe_info->learn_record.learn_info.additional_info.outlif.type != ARAD_PP_OUTLIF_ENCODE_TYPE_NONE) {
        payload.flags |= ARAD_PP_FWD_DECISION_PARSE_OULTIF;
      }

      /* 
       * LEM payload data size is different in Arad and Jericho.
       * It's also different between forwarding and learning information. 
       * Forwarding depends on the device, learning is always in Arad mode.                                                          .
       */
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 20, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_PWE_INFO, pwe_info, 30, exit);
  ...
  )
{
  ...
  ARAD_PP_L2_LIF_PWE_INFO_clear(pwe_info);
  ...
  if (!ignore_key)
  {
    ...
    res = arad_pp_lif_pwe_vc_label_to_isem_key_unsafe(
            unit,
            in_vc_label,
            0, /* has_gal will be filled inside arad_pp_isem_access_entry_get_unsafe */
            &sem_key
          );
    SOC_SAND_CHECK_FUNC_RESULT(res, 22, exit);
  ...
  if (*found)
  {
    *lif_index = sem_entry.sem_result_ndx;
    ...
    if (data.type == 0x0) /* pwe_p2p */
      {
        pwe_info->service_type = ARAD_PP_L2_LIF_PWE_SERVICE_TYPE_P2P;
        ...
        pwe_info->default_frwrd.default_frwd_type = ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_LIF;
        ...
        /* Internal parsing to make temp to be eei or outlif */
        if (data.eei_or_out_lif_type) 
        {
          /* Outlif */
          res = soc_sand_bitstream_get_field(&data.eei_or_out_lif, 0, 16, &temp);
          SOC_SAND_CHECK_FUNC_RESULT(res, 39, exit);
          flags |= ARAD_PP_FWD_DECISION_PARSE_OULTIF;
        } 
        else
        {
          /* EEI */
    ...
    do
    {
      ...
      if (data.type == 0x1) /* pwe_mp */
      {
		  ...
		  pwe_info->service_type = ARAD_PP_L2_LIF_PWE_SERVICE_TYPE_MP;
		  pwe_info->lif_profile = data.in_lif_profile;
		  ...
		  pwe_info->learn_record.enable_learning = SOC_SAND_NUM2BOOL(data.tt_learn_enable);
                 pwe_info->default_frwrd.default_frwd_type = ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_VSI;
  ...
  )
{
  ...
  for (range_ndx = 0; range_ndx < ARAD_PP_LIF_VLAN_RANGE_MAX_SIZE; range_ndx++)
  {
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_VLAN_RANGE_KEY, vlan_range_key, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, (ARAD_NOF_LOCAL_PORTS-1), ARAD_PORT_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ...
  )
{
  ...
  /* check if entry exists in multiset - search qual_key in db */
  res = arad_sw_db_multiset_lookup(
    unit,
  ...
  if (ref_count == 0) /* qual_key does not exist in db */
  {
	  /* add new qual_key to db */
	  res = arad_sw_db_multiset_add(
		  unit,
		  ARAD_PP_SW_DB_MULTI_SET_L2_LIF_PROFILE,
		  &qual_key_ndx,
	  ...
	  /* use the entry_ndx from db for the isem_entry */
  ...
  {
	  if (key_mapping == SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_DEFAULT) /* type default: remove existing entry */
	  {
		  /* remove entry by adding entry with type default */
		  res = arad_sw_db_multiset_remove(
			  unit,
			  ARAD_PP_SW_DB_MULTI_SET_L2_LIF_PROFILE,
			  &qual_key_ndx,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_KEY_QUALIFIER, qual_key, 15, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(key_mapping, ARAD_PP_LIF_KEY_MAPPING_MAX, ARAD_PP_LIF_KEY_MAPPING_OUT_OF_RANGE_ERR, 30, exit);

  if (qual_key->pkt_parse_info.inner_tpid == ARAD_PP_LLP_PARSE_TPID_INDEX_NONE)
  {
    if (key_mapping == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN_VLAN || key_mapping == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN_COMP_VLAN)
    {
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_LIF_ILLEGAL_KEY_MAPPING_ERR, 10, exit);
    }
  }

  if (qual_key->pkt_parse_info.outer_tpid == ARAD_PP_LLP_PARSE_TPID_INDEX_NONE
    && qual_key->pkt_parse_info.inner_tpid == ARAD_PP_LLP_PARSE_TPID_INDEX_NONE)
  {
    if (key_mapping == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN)
    {
  ...
  )
{
  ...
  if (ref_count != 0) /* qual_key exists in db */
  {
	  /* use the entry_ndx from db to get the isem_entry */
  ...
  {
	  /* return key default (i.e. not exist) */
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_LIF_AC_MP_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_LIF_AC_MP_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_NOF(lif_ndx, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_MP_INFO, info, 20, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_LIF_AC_MP_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_LIF_AC_MP_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(info);

  ARAD_PP_L2_LIF_AC_MP_INFO_clear(info);
...
{
  ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE
    simple_type,
    type_vlan;
  ...
  simple_type = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT;

  if ((ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN ||
      ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN_COMP_VLAN)
    )
  {
    type_vlan = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN;
  }
  else
  {
    type_vlan = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN;
  }
  
  if ((ac_key->inner_vid == ARAD_PP_LIF_IGNORE_INNER_VID &&
      ac_key->outer_vid == ARAD_PP_LIF_IGNORE_OUTER_VID)
  ...
  else if (ac_key->inner_vid == ARAD_PP_LIF_IGNORE_INNER_VID
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_INITIAL_VLAN)
  {
    sem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD_INITIAL_VID;    
    sem_key->key_info.l2_eth.outer_vid = ac_key->outer_vid;
  }
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_TRILL_DESIGNATED_VLAN)
  {
    sem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_TRILL_DESIGNATED_VID;
    sem_key->key_info.l2_eth.outer_vid = ac_key->outer_vid;
  }
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN)
  {
    sem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD_PCP_VID;    
    sem_key->key_info.l2_eth.outer_vid = ac_key->outer_vid;
    sem_key->key_info.l2_eth.outer_pcp = ac_key->outer_pcp;
  }
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN_VLAN)
  {
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL)
  {
    sem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL;    
    sem_key->key_info.l2_pon.port = ac_key->vlan_domain; /* In-PP-Port */
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN)
  {
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN_COMP_VLAN)
  {
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_PCP_ETHER_TYPE_COMP_VLAN_COMP_VLAN)
  {
    sem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID;    
    sem_key->key_info.l2_pon.port = ac_key->vlan_domain; /* In-PP-Port */
    sem_key->key_info.l2_pon.port_valid = TRUE;
    sem_key->key_info.l2_pon.tunnel_id = ac_key->tunnel; 
    sem_key->key_info.l2_pon.tunnel_id_valid = (ac_key->tunnel == ARAD_PP_LIF_IGNORE_TUNNEL_VID) ? FALSE:TRUE;
    sem_key->key_info.l2_pon.outer_vid = ac_key->outer_vid; 
    sem_key->key_info.l2_pon.outer_vid_valid = (ac_key->outer_vid == ARAD_PP_LIF_IGNORE_OUTER_VID) ? FALSE:TRUE;
    sem_key->key_info.l2_pon.inner_vid = ac_key->inner_vid; 
    sem_key->key_info.l2_pon.inner_vid_valid = (ac_key->inner_vid == ARAD_PP_LIF_IGNORE_INNER_VID) ? FALSE:TRUE;
    sem_key->key_info.l2_pon.ether_type = ac_key->ethertype; 
    sem_key->key_info.l2_pon.ether_type_valid = (ac_key->ethertype == ARAD_PP_LIF_IGNORE_ETHER_TYPE) ? FALSE:TRUE;
    ...
    sem_key->key_info.l2_pon.outer_pcp_valid = (ac_key->outer_pcp == ARAD_PP_LIF_IGNORE_OUTER_PCP) ? FALSE:TRUE;
  }

  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_TLS_PORT_TUNNEL)
  {
    sem_key->key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL;    
    sem_key->key_info.l2_pon.port = ac_key->vlan_domain; /* In-PP-Port */
    sem_key->key_info.l2_pon.port_valid = TRUE;
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID)
  {
  ...
  if (ac_key->key_type == ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID_VID)
  {
  ...
  )
{
  ...
  ignore_key = (ac_key->key_type == SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_NONE ) ? TRUE : FALSE;
  ...
  )
{
  ...
  if (!ignore_key)
  {
    ...
    if (sem_key.key_type == ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD)
    {
      ...
      vtt_port_config_tbl.default_port_lif = lif_index;
  ...
  if (*success == SOC_SAND_SUCCESS || *success == SOC_SAND_FAILURE_OUT_OF_RESOURCES_2)
  {
    if (ac_info->service_type == ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2AC)
    {
      ARAD_PP_IHP_LIF_TABLE_AC_P2P_TO_AC_TBL_DATA
        data;

      data.type = 0x0; /* ac_p2p_to_ac */
      ...
      data.protection_path = ac_info->protection_pass_value;
      data.protection_pointer = ac_info->protection_pointer;
      data.use_in_lif = ac_info->use_lif;
      data.destination_valid = 1;
      data.out_lif = 0;
      data.out_lif_valid = 1; /* out-lif */
    ...
    if (ac_info->service_type == ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2PWE)
    {
      ARAD_PP_IHP_LIF_TABLE_AC_P2P_TO_PWE_TBL_DATA
        data;

      data.type = 0x1; /* ac_p2p_to_pwe */
      data.cos_profile = ac_info->cos_profile;
      data.vlan_edit_pcp_dei_profile = ac_info->ing_edit_info.edit_pcp_profile;
      data.vlan_edit_profile = ac_info->ing_edit_info.ing_vlan_edit_profile;
      data.vlan_edit_vid_1 = ac_info->ing_edit_info.vid;
      data.orientation_is_hub = ac_info->orientation == SOC_SAND_PP_HUB_SPOKE_ORIENTATION_HUB ? 1 : 0;
      data.in_lif_profile = ac_info->lif_profile;
      data.vsi_assignment_mode = (ac_info->vsi_assignment_mode == ARAD_PP_VSI_EQ_IN_VID) ? ARAD_PP_L2_LIF_VSI_ASSIGNMENT_MODE_VSI_EQ_VLAN:ac_info->vsi_assignment_mode;
      data.oam_lif_set = ac_info->oam_valid;
      data.protection_path = ac_info->protection_pass_value;
      data.protection_pointer = ac_info->protection_pointer;
      data.use_in_lif = ac_info->use_lif;
      ...
      if(ac_info->default_frwrd.default_forwarding.additional_info.eei.type != SOC_PPC_EEI_TYPE_EMPTY) 
      {
        /* Entry has EEI: EEI-or-Out-LIF-Identifier 4b (mpls label command), Out-LIF-or-Label 20b (label) */        
      ...
      {
        /* Entry has OutLIF: EEI-or-Out-LIF-Identifier 4b (0), Out-LIF-or-Label 20b (OutLif) */
        data.eei_or_out_lif = temp; /* Out-LIF */
    ...
    if (ac_info->service_type == ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2PBB)
    {
      ARAD_PP_IHP_LIF_TABLE_AC_P2P_TO_PBB_TBL_DATA
        data;

      data.type = 0x2; /* ac_p2p_to_pbb */
      data.cos_profile = ac_info->cos_profile;
      data.vlan_edit_pcp_dei_profile = ac_info->ing_edit_info.edit_pcp_profile;
      data.vlan_edit_profile = ac_info->ing_edit_info.ing_vlan_edit_profile;
      data.vlan_edit_vid_1 = ac_info->ing_edit_info.vid;
    ...
    if (ac_info->service_type == ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP)
    {
      ...
      /* 
       * if type = ARAD_PP_L2_LIF_AC_LEARN_DISABLE: then learning is disabled
       * if type = ARAD_PP_L2_LIF_AC_LEARN_SYS_PORT: then valid = 0
       * else: fill data.learn_info
      */
      data.tt_learn_enable = SOC_SAND_BOOL2NUM(ac_info->learn_record.learn_type != ARAD_PP_L2_LIF_AC_LEARN_DISABLE);
      if (ac_info->learn_record.learn_type == ARAD_PP_L2_LIF_AC_LEARN_INFO)
      {
          /* fill the 16b learn info field according to the learn info (reverse forwarding decision info) */
          /*data.learn_info = ac_info->learn_record.learn_info.type == SOC_PPC_FRWRD_DECISION_TYPE_FEC ? (1<<15) ^ ac_info->learn_record.learn_info.dest_id : 
              ac_info->learn_record.learn_info.type == SOC_PPC_FRWRD_DECISION_TYPE_UC_FLOW ? 
              ac_info->learn_record.learn_info.dest_id >> 2 : 0;*/
      ...
      else{ /* learning is disable or set by FLP write zero to learn-info */
          data.learn_info = 0;
      }
      ...
      if (SOC_IS_ARADPLUS(unit) && soc_property_get(unit, spn_BCM886XX_L3_INGRESS_URPF_ENABLE, 0)) {
        ...
        res = SOC_DPP_WB_ENGINE_GET_ARR(unit, SOC_DPP_WB_ENGINE_VAR_ARAD_PP_RIF_URPF_MODE, &urpf_mode, data.vsi);
        SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 701, exit);

        res = MBCM_PP_DRIVER_CALL(unit,mbcm_pp_profile_mgmt_if_profile_val_set,(unit, SOC_PPC_PROFILE_MGMT_TYPE_INLIF, SOC_PPC_PROFILE_MGMT_INLIF_PROFILE_TYPE_STRICT_URPF, 
		                                                                              (urpf_mode == ARAD_PP_FRWRD_FEC_RPF_MODE_UC_STRICT) ? 1 : 0, &data.in_lif_profile));
  ...
  )
{
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 20, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_INFO, ac_info, 30, exit);
  ...
  )
{
  ...
  ARAD_PP_L2_LIF_AC_INFO_clear(ac_info);
  ...
  *lif_index = sem_entry.sem_result_ndx;
  ...
  /* according to SW state check what is LIF type */
  ...
  if (*found && entry_type == ARAD_PP_LIF_ENTRY_TYPE_EMPTY && 
  ...
  {
    switch (sub_type) {
    case ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2AC:
        {
          ARAD_PP_IHP_LIF_TABLE_AC_P2P_TO_AC_TBL_DATA
            data;
          ...
          if (data.type == 0x0) /* ac_p2p_to_ac */
          {
            ac_info->service_type = ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2AC;
            ...
            ac_info->learn_record.learn_type = ARAD_PP_L2_LIF_AC_LEARN_DISABLE;
            ac_info->lif_profile = data.in_lif_profile;
            ac_info->oam_valid = data.oam_lif_set;
            ac_info->protection_pass_value = data.protection_path;
            ac_info->protection_pointer = data.protection_pointer;
            ac_info->use_lif = data.use_in_lif;
            ac_info->default_frwrd.default_frwd_type = ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_LIF;
        ...
        case ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2PWE:
        {
          ARAD_PP_IHP_LIF_TABLE_AC_P2P_TO_PWE_TBL_DATA
            data;
          ...
          if (data.type == 0x1) /* ac_p2p_to_pwe */
          {
            ac_info->service_type = ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2PWE;
            ac_info->cos_profile = data.cos_profile;
            ac_info->ing_edit_info.edit_pcp_profile = data.vlan_edit_pcp_dei_profile;
            ac_info->ing_edit_info.ing_vlan_edit_profile = data.vlan_edit_profile;
            ac_info->ing_edit_info.vid = data.vlan_edit_vid_1;
            ...
            ac_info->vsi_assignment_mode = (data.vsi_assignment_mode == ARAD_PP_L2_LIF_VSI_ASSIGNMENT_MODE_VSI_EQ_VLAN) ? ARAD_PP_VSI_EQ_IN_VID:data.vsi_assignment_mode;
            ac_info->oam_valid = data.oam_lif_set;
            ac_info->protection_pass_value = data.protection_path;
            ac_info->protection_pointer = data.protection_pointer;
            ac_info->use_lif = data.use_in_lif;
    ...
    case ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2PBB:
        {
          ARAD_PP_IHP_LIF_TABLE_AC_P2P_TO_PBB_TBL_DATA
            data;
          ...
          if (data.type == 0x2) /* ac_p2p_to_pbb */
          {
            ac_info->service_type = ARAD_PP_L2_LIF_AC_SERVICE_TYPE_AC2PBB;
            ac_info->cos_profile = data.cos_profile;
            ac_info->ing_edit_info.edit_pcp_profile = data.vlan_edit_pcp_dei_profile;
            ac_info->ing_edit_info.ing_vlan_edit_profile = data.vlan_edit_profile;
            ac_info->ing_edit_info.vid = data.vlan_edit_vid_1;
            ...
            flags = ARAD_PP_FWD_DECISION_PARSE_DEST | ARAD_PP_FWD_DECISION_PARSE_EEI_MIM ; /* Always EEI */
    ...
    case ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP:
        {
          ARAD_PP_IHP_LIF_TABLE_AC_MP_TBL_DATA
            data;
          ...
          {
                ac_info->service_type = ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP;
                ...
                ac_info->protection_pointer = data.protection_pointer;
                ac_info->use_lif = data.use_in_lif;
                ac_info->default_frwrd.default_frwd_type = ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_VSI;
                ...
                {
                    ac_info->learn_record.learn_type = ARAD_PP_L2_LIF_AC_LEARN_SYS_PORT;
                }
                else
                {
                    ac_info->learn_record.learn_type = ARAD_PP_L2_LIF_AC_LEARN_INFO;
                }
            
                if (data.learn_info != 0 && ac_info->learn_record.learn_type == ARAD_PP_L2_LIF_AC_LEARN_INFO)
                {
                    ...
                    if(ac_info->use_lif) {
                        ...
                        ac_info->learn_record.learn_info.additional_info.outlif.type = ARAD_PP_OUTLIF_ENCODE_TYPE_RAW;
                    }
  ...
  )
{
  ...
  res = ARAD_PP_L2_LIF_AC_KEY_verify(unit, ac_key);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(base_lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 20, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_GROUP_INFO, acs_group_info, 30, exit);
  ...
  )
{
  ...
  ignore_key = (ac_key->key_type == SOC_PPD_L2_LIF_AC_MAP_KEY_TYPE_NONE);

  /* If we're deleting a port without match, we're using the lif index. */
  if (ignore_key) {
      SOC_SAND_CHECK_NULL_INPUT(lif_index);
      SOC_SAND_ERR_IF_ABOVE_NOF(*lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 5, exit);
  }
  ...
  if (!ignore_key) {
      ...
      /* Return the removed LIF according to the matched LIF */
      if ((lif_index != NULL) && (found_in_isem || found_vd)) {
          *lif_index = tmp_lif_index;
      }
  }

  /*
   * Perform any AC/LIF removal operation
   */
  if (ignore_key || found_in_isem || found_vd) {
      ...
      /* Perform LIF removal operations if a LIF parameter was supplied */
      if (lif_index != NULL) {

#ifdef BCM_88660_A0
          if (SOC_IS_ARADPLUS(unit) && soc_property_get(unit, spn_BCM886XX_L3_INGRESS_URPF_ENABLE, 0)) {

              /* If type is ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP then remove the lif from the its rif group. */
              ARAD_PP_LIF_ENTRY_TYPE type;
              uint32 sub_type;
              
              res = arad_pp_sw_db_lif_table_entry_use_get(unit, *lif_index, &type, &sub_type);
              SOC_SAND_CHECK_FUNC_RESULT(res, 170, exit);

              if (sub_type == ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP) {
          ...
          /* Mark the LIF entry as EMPTY in the SW. The HW reamins untouched. */
          res = arad_pp_sw_db_lif_table_entry_use_set(
                    unit,
                    *lif_index,
                    ARAD_PP_LIF_ENTRY_TYPE_EMPTY,
  ...
  )
{
  ...
  index = ARAD_PP_L2_LIF_L2CP_KEY_ENTRY_OFFSET(l2cp_key->l2cp_profile, l2cp_key->da_mac_address_lsb);
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1000, exit, READ_IHP_MEF_L_2_CP_PEER_BITMAPr(unit, reg_above64_val));
  res = soc_sand_bitstream_set(reg_above64_val, index, SOC_SAND_NUM2BOOL(handle_type == ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_PEER));

  /*LOG_INFO(BSL_LS_SOC_LIF,
             (BSL_META_U(unit,
                         "a soc_sand_bitstream_test_bit(reg_above64_val, index): %lx\n"), soc_sand_bitstream_test_bit(reg_above64_val, index)));*/

  SOC_SAND_CHECK_FUNC_RESULT(res, 12, exit);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1010, exit, WRITE_IHP_MEF_L_2_CP_PEER_BITMAPr(unit, reg_above64_val));

  SOC_REG_ABOVE_64_CLEAR(reg_above64_val);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1020, exit, READ_IHP_MEF_L_2_CP_DROP_BITMAPr(unit, reg_above64_val));
  res = soc_sand_bitstream_set(reg_above64_val, index, SOC_SAND_NUM2BOOL(handle_type == ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_DROP));
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 17, exit);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1030, exit, WRITE_IHP_MEF_L_2_CP_DROP_BITMAPr(unit, reg_above64_val));

  SOC_REG_ABOVE_64_CLEAR(reg_above64_val);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1040, exit, READ_IHP_MEF_L_2_CP_TRANSPARENT_BITMAPr(unit, REG_PORT_ANY, reg_above64_val));
  res = soc_sand_bitstream_set(reg_above64_val, index, SOC_SAND_NUM2BOOL(handle_type == ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_TUNNEL));
  ...
  /*SOC_REG_ABOVE_64_CLEAR(reg_above64_val);
  READ_IHP_MEF_L_2_CP_TRANSPARENT_BITMAPr(unit, REG_PORT_ANY, reg_above64_val);
  LOG_INFO(BSL_LS_SOC_LIF,
           (BSL_META_U(unit,
                       "last soc_sand_bitstream_test_bit(reg_above64_val, index): %lx\n"), soc_sand_bitstream_test_bit(reg_above64_val, index)));*/
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_L2CP_KEY, l2cp_key, 10, exit);
  ...
  )
{
  ...
  *handle_type = ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_NORMAL;
  index = ARAD_PP_L2_LIF_L2CP_KEY_ENTRY_OFFSET(l2cp_key->l2cp_profile, l2cp_key->da_mac_address_lsb);

  SOC_REG_ABOVE_64_CLEAR(reg_above64_val);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1150, exit, READ_IHP_MEF_L_2_CP_PEER_BITMAPr(unit, reg_above64_val));
  *handle_type = soc_sand_bitstream_test_bit(reg_above64_val, index) ? ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_PEER : *handle_type;

  /*LOG_INFO(BSL_LS_SOC_LIF,
             (BSL_META_U(unit,
                         "soc_sand_bitstream_test_bit(reg_above64_val, index): %d\n"), soc_sand_bitstream_test_bit(reg_above64_val, index)));*/

  SOC_REG_ABOVE_64_CLEAR(reg_above64_val);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1160, exit, READ_IHP_MEF_L_2_CP_DROP_BITMAPr(unit, reg_above64_val));
  *handle_type = soc_sand_bitstream_test_bit(reg_above64_val, index) ? ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_DROP : *handle_type;
  ...
  *handle_type = soc_sand_bitstream_test_bit(reg_above64_val, index) ? ARAD_PP_L2_LIF_L2CP_HANDLE_TYPE_TUNNEL : *handle_type;
  ...
  )
{
  ...
  if (isid_info->service_type == ARAD_PP_L2_LIF_ISID_SERVICE_TYPE_P2P)
  {
      ...
      data.protection_path = isid_info->protection_pass_value;
      data.protection_pointer = isid_info->protection_pointer;
      ...
      else 
      {
          data.eei_or_out_lif_type = 1; /* out-lif */ 
          /* Entry has OutLIF: EEI-or-Out-LIF[16] = Out-LIF-Valid, EEI-or-Out-LIF[15:0] = Out-LIF */
          res = soc_sand_bitstream_set_bit(eei_or_out_lif, 16); /* Out-LIF-Valid */
          SOC_SAND_CHECK_FUNC_RESULT(res, 25, exit);     
      }

      /* eei_or_out_lif is divided into LSB (2 bits) and MSB (22 bits) */
    ...
    if (isid_info->service_type == ARAD_PP_L2_LIF_ISID_SERVICE_TYPE_MP)
    {
      ...
      data.type = 0x1; /* isid_mp */
      data.service_type_lsb = 0x0;
      data.destination_valid = 0x0; /* destination is NULL */
      data.cos_profile = isid_info->cos_profile;
      data.tpid_profile = isid_info->tpid_profile_index;
      ...
      /* 
       * map vsi to isid, as well
       * done only for MP
       */
      if (!ignore_key && !(SOC_DPP_CONFIG(unit)->pp.mim_vsi_mode))
      {
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(vsi_ndx, ARAD_PP_SYS_VSI_ID_MAX, ARAD_PP_SYS_VSI_ID_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_ISID_KEY, isid_key, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 30, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_ISID_INFO, isid_info, 40, exit);
  ...
  )
{
  ...
  ARAD_PP_L2_LIF_ISID_INFO_clear(isid_info);
  *vsi_index = 0;
  ...
  if (*found)
  {
    *lif_index = sem_entry.sem_result_ndx;
    ...
    do
    {
      ...
      {
          isid_info->service_type = ARAD_PP_L2_LIF_ISID_SERVICE_TYPE_P2P;
          ...
          isid_info->protection_pass_value = data.protection_path;
          isid_info->protection_pointer = data.protection_pointer;
          isid_info->use_lif = data.use_in_lif;
          isid_info->vsi_assignment_mode = data.vsi_assignment_mode;
          isid_info->default_frwrd.default_frwd_type = ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_LIF;
		  ...
		  /* if type is outlif reset valid bit [16] to get outlif value*/
		  if (data.eei_or_out_lif_type == 1) { 
			  eei_or_out_lif &= (~(1<<16));
			  parse_flags = ARAD_PP_FWD_DECISION_PARSE_OULTIF;
		  }
		  else{
          ...
          res = arad_pp_fwd_decision_in_buffer_parse(
              ...
              data.destination, 
              eei_or_out_lif,
              parse_flags|ARAD_PP_FWD_DECISION_PARSE_DEST, /* flags */
              &isid_info->default_frwrd.default_forwarding
              );
          SOC_SAND_CHECK_FUNC_RESULT(res, 22, exit);
    ...
    do
    {
      ...
      {
          isid_info->service_type = ARAD_PP_L2_LIF_ISID_SERVICE_TYPE_MP;
          isid_info->cos_profile = data.cos_profile;
          isid_info->tpid_profile_index = data.tpid_profile;
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_ISID_KEY, isid_key, 10, exit);
  ...
  if (found)
  {
    *lif_index = sem_entry.sem_result_ndx;
    ...
    do
    {
      ...
      /* get vsi, before removing the entry */
      res = arad_pp_ihp_lif_table_isid_p2p_tbl_get_unsafe(  
        unit,
        sem_entry.sem_result_ndx,
        &data
  ...
  )
{
  ...
  res = arad_pp_epni_isid_table_tbl_set_unsafe(
         unit,
         gre_info->vsid & 0xFFF, /* only 12 lsb matter */
         &isid_tbl_data
       );
  SOC_SAND_CHECK_FUNC_RESULT(res, 45, exit);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_GRE_KEY, gre_key, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 30, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_GRE_INFO, gre_info, 40, exit);
  ...
  )
{
  ...
  ARAD_PP_L2_LIF_GRE_INFO_clear(gre_info);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_GRE_KEY, gre_key, 10, exit);
  ...
  )
{
  ...
  res = arad_pp_epni_isid_table_tbl_set_unsafe(
         unit,
         vxlan_info->vsid & 0xFFF, /* only 12 lsb matter */
         &isid_tbl_data
       );
  SOC_SAND_CHECK_FUNC_RESULT(res, 45, exit);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_VXLAN_KEY, vxlan_key, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_index, SOC_DPP_DEFS_GET(unit, nof_local_lifs), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 30, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_VXLAN_INFO, vxlan_info, 40, exit);
  ...
  )
{
  ...
  ARAD_PP_L2_LIF_VXLAN_INFO_clear(vxlan_info);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_VXLAN_KEY, vxlan_key, 10, exit);
  ...
  )
{
  ...
  {
    /* In case of TRUE use offset parameter */
    destination_enc = action_info->offset;
  }
  else
  {
    /* In case of FALSE use forward destination parameter */
    res = arad_pp_fwd_decision_in_buffer_build(
            unit,
            ARAD_PP_FRWRD_DECISION_APPLICATION_TYPE_DFLT,
  ...
  index = ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_ENTRY_OFFSET(dflt_frwrd_key->port_da_not_found_profile, dflt_frwrd_key->da_type, dflt_frwrd_key->lif_default_forward_profile);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY, dflt_frwrd_key, 20, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_DEFAULT_FRWRD_ACTION, action_info, 30, exit);
  ...
  )
{
  ...
  ARAD_PP_L2_LIF_DEFAULT_FRWRD_ACTION_clear(action_info);
  ...
  {
    /* In case of FALSE, use forward dest parameter */
    res = arad_pp_fwd_decision_in_buffer_parse(
          unit,
          ARAD_PP_FRWRD_DECISION_APPLICATION_TYPE_DFLT,
          destination_enc,
...
uint32
  arad_pp_l2_lif_ac_key_parse_unsafe(
    ...
    SOC_SAND_OUT ARAD_PP_L2_LIF_AC_KEY               *ac_key
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);

  ARAD_PP_L2_LIF_AC_KEY_clear(ac_key);
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD_PCP_VID:
    ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_PCP_VLAN;
    ac_key->vlan_domain = isem_key->key_info.l2_eth.vlan_domain;
    ac_key->outer_vid   = isem_key->key_info.l2_eth.outer_vid;
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL:
    ...
    {
      ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_TLS_PORT_TUNNEL;
    } 
    else
    {
      ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL;
    }
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL_VID:
    ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN;
    ac_key->vlan_domain = isem_key->key_info.l2_pon.port;
    ac_key->tunnel      = isem_key->key_info.l2_pon.tunnel_id;    
    ac_key->outer_vid   = isem_key->key_info.l2_pon.outer_vid;    
    break;
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL_VID_VID:
    ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_COMP_VLAN_COMP_VLAN;
    ac_key->vlan_domain = isem_key->key_info.l2_pon.port;
    ac_key->tunnel      = isem_key->key_info.l2_pon.tunnel_id;    
    ac_key->outer_vid   = isem_key->key_info.l2_pon.outer_vid;    
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID:
    ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_TUNNEL_PCP_ETHER_TYPE_COMP_VLAN_COMP_VLAN;          
    ac_key->vlan_domain = isem_key->key_info.l2_pon.port;
    ac_key->tunnel      = (isem_key->key_info.l2_pon.tunnel_id_valid) ? isem_key->key_info.l2_pon.tunnel_id:ARAD_PP_LIF_IGNORE_TUNNEL_VID;    
    ac_key->outer_vid   = (isem_key->key_info.l2_pon.outer_vid_valid) ? isem_key->key_info.l2_pon.outer_vid:ARAD_PP_LIF_IGNORE_OUTER_VID;
    ac_key->inner_vid   = (isem_key->key_info.l2_pon.inner_vid_valid) ? isem_key->key_info.l2_pon.inner_vid:ARAD_PP_LIF_IGNORE_INNER_VID;
    ac_key->ethertype   = (isem_key->key_info.l2_pon.ether_type_valid) ? isem_key->key_info.l2_pon.ether_type:ARAD_PP_LIF_IGNORE_ETHER_TYPE;
    ac_key->outer_pcp   = (isem_key->key_info.l2_pon.outer_pcp_valid) ? isem_key->key_info.l2_pon.outer_pcp:ARAD_PP_LIF_IGNORE_OUTER_PCP;    
    break;
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_FLEXIBLE_Q_IN_Q_SINGLE_TAG:
    ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID;
    ac_key->vlan_domain = isem_key->key_info.l2_eth.vlan_domain;
    ac_key->outer_vid   = isem_key->key_info.l2_eth.outer_vid;
    break;
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_FLEXIBLE_Q_IN_Q_DOUBLE_TAG:
    ac_key->key_type    = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_FLEXIBLE_Q_IN_Q_PORT_INITIAL_VID_VID;
    ac_key->vlan_domain = isem_key->key_info.l2_eth.vlan_domain;
    ac_key->outer_vid   = isem_key->key_info.l2_eth.outer_vid;
    ac_key->inner_vid   = isem_key->key_info.l2_eth.inner_vid;
    break;
...
uint32
  arad_pp_l2_lif_isid_key_parse_unsafe(
    SOC_SAND_IN  int                               unit,
    SOC_SAND_IN  ARAD_PP_ISEM_ACCESS_KEY              *isem_key,
    SOC_SAND_OUT ARAD_PP_L2_LIF_ISID_KEY              *isid_key
  )
{
...
uint32
  ARAD_PP_L2_LIF_AC_KEY_QUALIFIER_verify(
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_PARSE_INFO, &info->pkt_parse_info, 10, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_KEY_QUALIFIER_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_IN_VC_RANGE_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_IN_VC_RANGE_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_DEFAULT_FORWARDING_INFO_verify(
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_DECISION_INFO, &(info->default_forwarding), 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_DEFAULT_FORWARDING_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_PWE_LEARN_RECORD_verify(
  ...
  )
{
  ...
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_DECISION_INFO, &(info->learn_info), 11, exit);
  }

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_PWE_LEARN_RECORD_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_PWE_INFO_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->vsid, ARAD_PP_VSI_ID_MAX, ARAD_PP_VSI_ID_OUT_OF_RANGE_ERR, 10, exit);

  if (info->service_type == ARAD_PP_L2_LIF_PWE_SERVICE_TYPE_MP)
  {
    if (info->default_frwrd.default_frwd_type != ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_VSI)
    {
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_LIF_PWE_MP_DEFAULT_FRWRD_OUT_OF_RANGE_ERR, 15, exit);
    }
  }
  ...
  {
    if (info->default_frwrd.default_frwd_type != ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_LIF)
    {
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_LIF_PWE_P2P_DEFAULT_FRWRD_OUT_OF_RANGE_ERR, 16, exit);
    }
  }
  if (info->service_type == ARAD_PP_L2_LIF_PWE_SERVICE_TYPE_P2P)
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_DEFAULT_FORWARDING_INFO, &(info->default_frwrd), 11, exit);
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_PWE_LEARN_RECORD, &(info->learn_record), 12, exit);
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->protection_pointer, ARAD_PP_LIF_PROTECTION_POINTER_MAX, ARAD_PP_LIF_PROTECTION_POINTER_OUT_OF_RANGE_ERR, 23, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_PWE_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_VLAN_RANGE_KEY_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_VLAN_RANGE_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_AC_KEY_verify(
    SOC_SAND_IN  int                   unit,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_AC_LEARN_RECORD_verify(
  ...
  )
{
  ...
  if (!((info->learn_type == ARAD_PP_L2_LIF_AC_LEARN_SYS_PORT) || (info->learn_type == ARAD_PP_L2_LIF_AC_LEARN_DISABLE)))
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_DECISION_INFO, &(info->learn_info), 11, exit);
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_LEARN_RECORD_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_AC_ING_EDIT_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_ING_EDIT_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_AC_INFO_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->vsid, ARAD_PP_VSI_ID_MAX, ARAD_PP_VSI_ID_OUT_OF_RANGE_ERR, 11, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_LEARN_RECORD, &(info->learn_record), 12, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_ING_EDIT_INFO, &(info->ing_edit_info), 13, exit);
  if (info->default_frwrd.default_frwd_type != ARAD_PP_L2_LIF_DFLT_FRWRD_SRC_VSI)
  {
    if (info->service_type != ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP)
    {
      ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_DEFAULT_FORWARDING_INFO, &(info->default_frwrd), 14, exit);
    }
  }
  if (info->service_type == ARAD_PP_L2_LIF_AC_SERVICE_TYPE_MP)
  {
  ...
  if (info->vsi_assignment_mode != ARAD_PP_VSI_EQ_IN_VID) 
  {
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->protection_pointer, ARAD_PP_LIF_PROTECTION_POINTER_MAX, ARAD_PP_LIF_PROTECTION_POINTER_OUT_OF_RANGE_ERR, 26, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_AC_MP_INFO_verify(
    SOC_SAND_IN  ARAD_PP_L2_LIF_AC_MP_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->mp_level, ARAD_PP_MP_LEVEL_MAX, ARAD_PP_MP_LEVEL_OUT_OF_RANGE_ERR, 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_MP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_L2CP_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_L2CP_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_AC_GROUP_INFO_verify(
  ...
  )
{
  ...
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_AC_INFO, &(info->acs_info[ind]), 10, exit);
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_AC_GROUP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_ISID_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_ISID_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_ISID_INFO_verify(
  ...
  )
{
  ...
  if (info->service_type == ARAD_PP_L2_LIF_ISID_SERVICE_TYPE_P2P) {
      ARAD_PP_STRUCT_VERIFY(ARAD_PP_L2_LIF_DEFAULT_FORWARDING_INFO, &(info->default_frwrd), 10, exit);
  }
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->protection_pointer, ARAD_PP_LIF_PROTECTION_POINTER_MAX, ARAD_PP_LIF_PROTECTION_POINTER_OUT_OF_RANGE_ERR, 19, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_ISID_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_TRILL_INFO_verify(
    SOC_SAND_IN  ARAD_PP_L2_LIF_TRILL_INFO *info
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->fec_id, ARAD_PP_FEC_ID_MAX, ARAD_PP_FEC_ID_OUT_OF_RANGE_ERR, 10, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_GRE_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_GRE_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_GRE_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_VXLAN_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_VXLAN_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_VXLAN_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_VXLAN_INFO_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_DEFAULT_FRWRD_KEY_verify()",0,0);
}

uint32
  ARAD_PP_L2_LIF_DEFAULT_FRWRD_ACTION_verify(
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_DECISION_INFO, &(info->frwrd_dest), 15, exit);
  
  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_L2_LIF_DEFAULT_FRWRD_ACTION_verify()",0,0);
}
