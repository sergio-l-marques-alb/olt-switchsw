...
#define ARAD_PP_LLP_VID_ASSIGN_RULE_TYPE_MAX                     (ARAD_PP_NOF_LLP_VID_ASSIGN_MATCH_RULE_TYPES-1)
    ...
    Arad_pp_procedure_desc_element_llp_vid_assign[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET_UNSAFE),
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET_UNSAFE);
  ...
  * save to SW DB
  */
  res = arad_pp_sw_db_llp_vid_assign_port_sa_set(
          unit,
          local_port_ndx,
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO, port_vid_assign_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(port_vid_assign_info);

  ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_clear(port_vid_assign_info);
  ...
  )
{
  ...
  */
  ARAD_PP_LLP_SA_AUTH_MAC_INFO_clear(&old_sa_auth_info);
  ...
  if (is_found)
  {
    ...
    if (old_sa_auth_info.expect_tag_vid != ARAD_PP_LLP_SA_AUTH_ACCEPT_ALL_VIDS)
    {
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_VID_ASSIGN_MAC_INFO, mac_based_info, 20, exit);
  ...
  )
{
  ...
  ARAD_PP_LLP_SA_AUTH_MAC_INFO
    old_sa_auth_info;
  ARAD_PP_LLP_VID_ASSIGN_MAC_INFO
    no_vid_assign_info;
  uint8
    is_found = FALSE; 
  uint32
  ...
  {
    ARAD_PP_LLP_VID_ASSIGN_MAC_INFO_clear(&no_vid_assign_info);
  ...
  )
{
  ...
  ARAD_PP_LLP_VID_ASSIGN_MAC_INFO_clear(mac_based_info);
  ...
  *nof_entries = 0;
  ...
  for ( read_index = 0; read_index < tmp_nof_entries; ++read_index)
  {
    if ((read_keys[read_index].type == ARAD_PP_LEM_ACCESS_KEY_TYPE_SA_AUTH))    
    {
      ...
      ARAD_PP_LLP_VID_ASSIGN_MAC_INFO_clear(&vid_assign_info_arr[*nof_entries]);
      ...
      if ((!(rule->rule_type & ARAD_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE_TAGGED))&& vid_assign_info_arr[*nof_entries].override_tagged)
      {
        continue;
      }
      if ((!(rule->rule_type & ARAD_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE_UNTAGGED))&& vid_assign_info_arr[*nof_entries].use_for_untagged)
      {
        continue;
      }
      ++*nof_entries;
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_VID_ASSIGN_MATCH_RULE, rule, 10, exit);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO, subnet_based_info, 30, exit);
  ...
  )
{
  ...
  ARAD_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_clear(subnet_based_info);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_VID_ASSIGN_PRTCL_INFO, prtcl_assign_info, 30, exit);
  ...
  )
{
  ...
  ARAD_PP_LLP_VID_ASSIGN_PRTCL_INFO_clear(prtcl_assign_info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_VID_ASSIGN_MAC_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_VID_ASSIGN_PRTCL_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_VID_ASSIGN_MATCH_RULE_verify()",0,0);
}
