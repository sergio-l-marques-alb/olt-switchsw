  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  20,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, EGQ_EGRESS_SHAPER_ENABLE_SETTINGSr, SOC_CORE_ALL, 0, OTM_SPR_ENAf,  fld_val));
  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  10,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, EGQ_EGRESS_SHAPER_ENABLE_SETTINGSr, SOC_CORE_ALL, 0, OTM_SPR_ENAf, &fld_val));
    ...
    SOC_SAND_IN  ARAD_DBG_RST_DOMAIN      rst_domain)
{
   ...
   LOG_VERBOSE(BSL_LS_SOC_INIT,
    ...
    if (is_ingr) {
        ...
        ARAD_FLD_TO_REG64(ECI_BLOCKS_SOFT_INITr, NBI_INITf, fld64_val, soft_init_reg_val, 64, exit);
        ARAD_FLD_TO_REG64(ECI_BLOCKS_SOFT_INITr, CLP_0_INITf, fld64_val, soft_init_reg_val, 68, exit);
        ARAD_FLD_TO_REG64(ECI_BLOCKS_SOFT_INITr, CLP_1_INITf, fld64_val, soft_init_reg_val, 70, exit);
        ARAD_FLD_TO_REG64(ECI_BLOCKS_SOFT_INITr, XLP_0_INITf, fld64_val, soft_init_reg_val, 72, exit);
        ARAD_FLD_TO_REG64(ECI_BLOCKS_SOFT_INITr, XLP_1_INITf, fld64_val, soft_init_reg_val, 74, exit);
