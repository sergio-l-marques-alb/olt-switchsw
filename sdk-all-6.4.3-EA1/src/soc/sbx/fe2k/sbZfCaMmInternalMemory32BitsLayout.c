/*
 * $Id: sbZfCaMmInternalMemory32BitsLayout.c,v 1.2 Broadcom SDK $
...
sbZfCaMmInternalMemory32BitsLayout_Pack(sbZfCaMmInternalMemory32BitsLayout_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAMMINTERNALMEMORY32BITSLAYOUT_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAMMINTERNALMEMORY32BITSLAYOUT_SIZE_IN_BYTES;
}
