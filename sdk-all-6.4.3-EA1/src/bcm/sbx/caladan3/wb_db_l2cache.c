...
bcm_caladan3_wb_l2_cache_state_sync (int unit)
{
    ...
    switch(version)
    {
        case BCM_CALADAN3_WB_L2_CACHE_VERSION_1_0:
            ...
            SBX_WB_DB_SYNC_MEMORY(_l2cpmac_entry, _l2_cache[unit].max_idx, (_l2cpmac_entry *)(_l2_cache[unit]._l2cpmac_table));
...
_bcm_caladan3_wb_l2_cache_state_restore (int unit)
{
    ...
    switch(version)
    {
        case BCM_CALADAN3_WB_L2_CACHE_VERSION_1_0:
            ...
            _l2_cache[unit]._l2cpmac_table = (uint32) sal_alloc((_l2_cache[unit].max_idx) * sizeof(_l2cpmac_entry), "l2cpmac table");
            ...
            SBX_WB_DB_RESTORE_MEMORY(_l2cpmac_entry, _l2_cache[unit].max_idx, (_l2cpmac_entry *)_l2_cache[unit]._l2cpmac_table);
