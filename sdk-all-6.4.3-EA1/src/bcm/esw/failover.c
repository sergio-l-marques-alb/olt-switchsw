...
int
_bcm_esw_failover_ecmp_prot_nhi_create(int unit, int ecmp,
                                       int nh_index, int prot_nh_index,
                                       bcm_failover_t failover_id)
{
    int rv = BCM_E_UNAVAIL;
...
#ifdef BCM_TRIUMPH2_SUPPORT
    if (soc_feature(unit, soc_feature_failover)) {
        rv = bcm_tr2_failover_ecmp_prot_nhi_set(unit, ecmp, nh_index,
                                                prot_nh_index, failover_id);
        return rv;
    }
#endif
...
int
_bcm_esw_failover_ecmp_prot_nhi_cleanup(int unit, int ecmp, int nh_index)
{
    int rv = BCM_E_UNAVAIL;

#ifdef BCM_TRIUMPH2_SUPPORT
    if (soc_feature(unit, soc_feature_failover)) {
        rv = bcm_tr2_failover_ecmp_prot_nhi_cleanup(unit, ecmp, nh_index);
        return rv;
    }
#endif
...
int
_bcm_esw_failover_ecmp_prot_nhi_get(int unit, int ecmp, int nh_index,
                                    bcm_failover_t *failover_id, 
                                    int *prot_nh_index)
{
    int rv = BCM_E_UNAVAIL;
...
#ifdef BCM_TRIUMPH2_SUPPORT
    if (soc_feature(unit, soc_feature_failover)) {
        rv = bcm_tr2_failover_ecmp_prot_nhi_get(unit, ecmp, nh_index, 
                                                failover_id, prot_nh_index);
        return rv;
    }
#endif
...
int
_bcm_esw_failover_ecmp_prot_nhi_update(int unit, int ecmp, 
...
#ifdef BCM_TRIUMPH2_SUPPORT
    if (soc_feature(unit, soc_feature_failover)) {
        rv = bcm_tr2_failover_ecmp_prot_nhi_set(unit, ecmp, 
                                                old_nh_index, new_nh_index, 
