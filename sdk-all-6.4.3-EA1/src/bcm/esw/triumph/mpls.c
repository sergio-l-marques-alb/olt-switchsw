            ...
            if (rv == BCM_E_NONE) {
                BCM_IF_ERROR_RETURN(
                    _bcm_ing_pri_cng_map_entry_reference(
                        unit, (value * ing_pri_cng_chunk), ing_pri_cng_chunk));
                soc_SOURCE_VPm_field32_set(unit, &svp, TRUST_DOT1P_PTRf, value);
            }
