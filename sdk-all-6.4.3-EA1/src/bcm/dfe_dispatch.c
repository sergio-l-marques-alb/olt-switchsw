...
int 
bcm_dfe_field_compress_destroy(
    int unit, 
    int compress_id)
{
    return BCM_E_UNAVAIL;
...
int 
bcm_dfe_field_compress_multi_get(
    int unit, 
    int compress_id, 
    uint16 alloc_size, 
    uint32 *orig_data, 
...
int 
bcm_dfe_field_compress_multi_set(
    int unit, 
    int compress_id, 
    int alloc_size, 
    uint32 *orig_data, 
...
int 
bcm_dfe_field_compress_size_get(
    int unit, 
    bcm_field_qualify_t qual, 
    int *max_size)
{
...
int 
bcm_dfe_field_compressed_mask_length_get(
    int unit, 
    bcm_field_qualify_t qual, 
    int *length)
{
