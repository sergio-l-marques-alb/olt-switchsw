...
/*
 * $Id: sbFe2000XtMemWrite.c,v 1.14 Broadcom SDK $
   ...
   CAD_UINT                     uAddress,
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEAG0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PrPortToQueueAg0Entry_Pack(&PrPortToQueueAg0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEAG1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrPortToQueueAg1Entry_Pack(&PrPortToQueueAg1Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEPCI:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrPortToQueuePciEntry_Pack(&PrPortToQueuePciRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRPORTTOQUEUESR0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrPortToQueueSr0Entry_Pack(&PrPortToQueueSr0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRPORTTOQUEUESR1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrPortToQueueSr1Entry_Pack(&PrPortToQueueSr1Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEXG0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrPortToQueueXg0Entry_Pack(&PrPortToQueueXg0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRPORTTOQUEUEXG1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrPortToQueueXg1Entry_Pack(&PrPortToQueueXg1Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PRCC2TCAMCONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PrCcTcamConfigEntry_Pack(&PrCcTcamConfigEntry,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,14);
          status =
    ...
    case FE2KXT_MEM_PRCC2CAMRAM:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if (!last){
            sbZfC2PrCcCamRamNonLastEntry_Pack(&PrCcCamRamNonLastEntry,(uint8 *)dbuf,sizeof(dbuf));
          }else{
            sbZfC2PrCcCamRamLastEntry_Pack(&PrCcCamRamLastEntry,(uint8 *)dbuf,sizeof(dbuf));
          }
          sbSwapWords(pData,SB_ZF_C2PRCCCAMRAMLASTENTRY_SIZE_IN_WORDS);
          status =
    ...
    case FE2KXT_MEM_PRCC2QUEUERAM:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2PrCcQueueRamEntry_Pack(&PrCcQueueRamEntry,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,SB_ZF_C2PRCCQUEUERAMENTRY_SIZE_IN_WORDS);
          status =
    ...
    case FE2KXT_MEM_PDLRPOUTPUTHEADERCOPYBUFFER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PdLrpOutputHeaderCopyBufferEntry_Pack(&PdLrpOutputHeaderCopyBufferRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,8);
          status =
    ...
    case FE2KXT_MEM_PDPDOUTPUTHEADERCOPYBUFFER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PdPdOutputHeaderCopyBufferEntry_Pack(&PdPdOutputHeaderCopyBufferRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,8);
          status =
    ...
    case FE2KXT_MEM_LRLRPINSTRUCTIONMEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2LrLrpInstructionMemoryEntry_Pack(&LrLrpInstructionMemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_QMBUFFERSTATE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          sbZfC2QmBufferState0Entry_Pack(&QmBufferState0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMBUFFERSTATE1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmBufferState1Entry_Pack(&QmBufferState1Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_QMBUFFERSTATE2:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmBufferState2Entry_Pack(&QmBufferState2Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMBUFFERSTATE3:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmBufferState3Entry_Pack(&QmBufferState3Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
...
/* MCM was missing DequeueState0 code */
    case FE2KXT_MEM_QMDEQUEUESTATE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmDequeueState0Entry_Pack(&QmDequeueState0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_QMDEQUEUESTATE1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmDequeueState1Entry_Pack(&QmDequeueState1Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMFREEPAGEFIFO:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmFreePageFifoEntry_Pack(&QmFreePageFifoRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMNEXTBUFFER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmNextBufferEntry_Pack(&QmNextBufferRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMNEXTPAGE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmNextPageEntry_Pack(&QmNextPageRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMQUEUECONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmQueueConfigEntry_Pack(&QmQueueConfigRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_QMQUEUECOUNTERS:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmQueueCountersEntry_Pack(&QmQueueCountersRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_QMQUEUEHEADPTR:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmQueueHeadPtrEntry_Pack(&QmQueueHeadPtrRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMQUEUESTATE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmQueueState0Entry_Pack(&QmQueueState0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMQUEUESTATE0EN:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmQueueState0EnEntry_Pack(&QmQueueState0EnRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMQUEUESTATE1:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmQueueState1Entry_Pack(&QmQueueState1Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_QMREPLICATIONSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2QmReplicationStateEntry_Pack(&QmReplicationStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
 ...
 /* MCM no PmCounter zframe */
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          sbSwapWords(pData,2);
          sbZfC2PbCounterEntry_Unpack(&PbCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
          status = sbZfC2PbCounterEntry_SetField(&PbCounterRecord,fieldname,val);
          if(status != 0) return CMD_USAGE;
          sbZfC2PbCounterEntry_Pack(&PbCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PMPROFILEMEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PmProfileMemoryEntry_Pack(&PmProfileMemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_SR0COUNTER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2SrCounterEntry_Pack(&SrCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PPAGGREGATEHASHBITCONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpAggregateHashBitConfigEntry_Pack(&PpAggregateHashBitConfigRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,10);
          status =
    ...
    case FE2KXT_MEM_PPAGGREGATEHASHBYTECONFIG:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpAggregateHashByteConfigEntry_Pack(&PpAggregateHashByteConfigRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PPCAMCONFIGURATIONINSTANCE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpCamConfigurationInstance0Entry_Pack(&PpCamConfigurationInstance0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,14);
          status =
 ...
 * Instance1 - 4 */
    ...
    case FE2KXT_MEM_PPCAMRAMCONFIGURATIONINSTANCE0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpCamRamConfigurationInstance0Entry_Pack(&PpCamRamConfigurationInstance0Record,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,6);
          status =
    ...
    case FE2KXT_MEM_PPHEADERRECORDSIZE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpHeaderRecordSizeEntry_Pack(&PpHeaderRecordSizeRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PPINITIALQUEUESTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpInitialQueueStateEntry_Pack(&PpInitialQueueStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,5);
          status =
    ...
    case FE2KXT_MEM_PPPPOUTHEADERCOPY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpPpOutHeaderCopyEntry_Pack(&PpPpOutHeaderCopyRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,8);
          status =
    ...
    case FE2KXT_MEM_PPQUEUEPRIORITYGROUP:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpQueuePriorityGroupEntry_Pack(&PpQueuePriorityGroupRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
    ...
    case FE2KXT_MEM_PPRXPORTDATA:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PpRxPortDataEntry_Pack(&PpRxPortDataRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,4);
          status =
    ...
    case FE2KXT_MEM_RC0DATA:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2RcDataEntry_Pack(&RcDataRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,40);
          status =
    ...
    case FE2KXT_MEM_ST0COUNTER:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2StCounterEntry_Pack(&StCounterRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
 ...
 cli_out("Mm0Internal0MemoryRead SWAP data0=0x%x data1=0x%x\n",*pData0, *pData1);
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2MmInternal0MemoryEntry_Pack(&MmInternal0MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
 ...
 cli_out("Mm0Internal0MemoryRead SwapUpdate data0=0x%x data1=0x%x\n",*pData0, *pData1);
    ...
    case FE2KXT_MEM_MM0INTERNAL1MEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2MmInternal1MemoryEntry_Pack(&MmInternal1MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_MM0NARROWPORT0MEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2MmNarrowPort0MemoryEntry_Pack(&MmNarrowPort0MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
    ...
    case FE2KXT_MEM_MM0NARROWPORT1MEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2MmNarrowPort1MemoryEntry_Pack(&MmNarrowPort1MemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_MM0WIDEPORTMEMORY:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2MmWidePortMemoryEntry_Pack(&MmWidePortMemoryRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PB0DATA:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PbDataEntry_Pack(&PbDataRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,24);
          status =
    ...
    case FE2KXT_MEM_PTMIRRORINDEX:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorIndexEntry_Pack(&PtMirrorIndexRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,5);
          status =
    ...
    case FE2KXT_MEM_PTPORTTOQUEUEAG0:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortToQueueEntry_Pack(&PtPortToQueueRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
...
/* MCM - ? use PrPortXXX_Unpack - or - us PtPortToQueueEntry_Pack ??? */
    ...
    case FE2KXT_MEM_PTPTE0MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte0MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE0PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte0PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTPTE1MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte1MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE1PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte1PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTPTE2MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte2MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE2PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte2PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTPTE3MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte3MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE3PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte3PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTPTE4MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte4MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE4PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte4PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTPTE5MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte5MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE5PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte5PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTPTE6MIRRORPORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtMirrorPortStateEntry_Pack(&PtPte6MirrorPortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,2);
          status =
    ...
    case FE2KXT_MEM_PTPTE6PORTSTATE:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtPortStateEntry_Pack(&PtPte6PortStateRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,3);
          status =
    ...
    case FE2KXT_MEM_PTQUEUETOPORT:
        ...
        if (status == SAND_DRV_C2_STATUS_OK) {
          ...
          if(status != 0) return CMD_USAGE;
          sbZfC2PtQueueToPortEntry_Pack(&PtQueueToPortRecord,(uint8 *)dbuf,sizeof(dbuf));
          sbSwapWords(pData,1);
          status =
...
#else
int sbFe2000XtMemWrite_not_empty;
