/* $Id: ref_design_starter.c,v 1.4 Broadcom SDK $
...
#include "DuneDriver/SOC_SAND_FE600/include/fe600_general.h"
...
/* } */
  ...
  else if ( (host_board_type == LINE_CARD_GFA_PETRA_B_DDR3) ||
            (host_board_type == LINE_CARD_GFA_PETRA_B_DDR3_STREAMING))
  {
...
/* } */
  ...
  else if (host_board_type == LINE_CARD_GFA_PETRA_B_INTERLAKEN)
  {
#if LINK_PB_LIBRARIES
    /* { */
