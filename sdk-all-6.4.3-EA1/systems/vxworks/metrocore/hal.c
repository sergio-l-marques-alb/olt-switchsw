...
static int metrocore_upgrade_image(char *fname, unsigned int flags, 
...
static char * metrocore_flash_dev_name(void)
{
    return FLASH_FS_NAME;
}

static int metrocore_format_flash(int format, unsigned int flags)
{
    int	rv = 0;
...
static platform_hal_t metrocore_hal_info = {
    "METROCORE",                                   /* name */
    0,                                             /* flags */
    ...
    0,                                             /* bus_caps */
    NULL,                                          /* f_dump_info */
    metrocore_upgrade_image,                       /* f_upgrade_image */
    metrocore_flash_dev_name,                      /* f_flash_device_name */
    metrocore_format_flash,                        /* f_format_fs */
...
int platform_attach(platform_hal_t **platform_info)
{
    ...
    *platform_info = &metrocore_hal_info;
    return 0;
}
