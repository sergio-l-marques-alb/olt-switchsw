...
#include "falcon_furia_sesto_debug_functions.h"
...
typedef struct {
    ...
    uint8_t tx_rx;   
}falcon_furia_sesto_osr_mode_st;
...
typedef struct {    
       ...
       uint8_t br_pd_en;
} falcon_furia_sesto_lane_state_st;
...
typedef struct {
       ...
       int16_t die_temp;
} falcon_furia_sesto_core_state_st;
...
/*-----------------------------*/
/** Read current falcon_furia_sesto core status.
 * @param *istate Current falcon_furia_sesto core status read back and populated by the API
...
/*-----------------------------*/
/** Read current falcon_furia_sesto lane status.
 * @param *istate Current falcon_furia_sesto lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon_furia_sesto_get_osr_mode( const phymod_access_t *pa, falcon_furia_sesto_osr_mode_st *mode);
 ...
 * Along with falcon_furia_sesto_core_clkgate(), all lanes should also be clock gated using falcon_furia_sesto_lane_clkgate() to complete a Core Clockgate 
...
/* Lane Config Struct */
void _update_uc_lane_config_st( const phymod_access_t *pa, struct falcon_furia_sesto_uc_lane_config_st *st);
void _update_uc_lane_config_word( const phymod_access_t *pa, struct falcon_furia_sesto_uc_lane_config_st *st);

/* Lane User Control Disable Startup Function Struct */
void _update_usr_ctrl_disable_functions_st( const phymod_access_t *pa, struct falcon_furia_sesto_usr_ctrl_disable_functions_st *st);
void _update_usr_ctrl_disable_functions_byte( const phymod_access_t *pa, struct falcon_furia_sesto_usr_ctrl_disable_functions_st *st);

/* Lane User Control Disable Startup DFE Function Struct */
void _update_usr_ctrl_disable_dfe_functions_st( const phymod_access_t *pa, struct falcon_furia_sesto_usr_ctrl_disable_dfe_functions_st *st);
void _update_usr_ctrl_disable_dfe_functions_byte( const phymod_access_t *pa, struct falcon_furia_sesto_usr_ctrl_disable_dfe_functions_st *st);

/* Core Config Struct */
void _update_uc_core_config_st( const phymod_access_t *pa, struct  falcon_furia_sesto_uc_core_config_st *st);
void _update_uc_core_config_word( const phymod_access_t *pa, struct  falcon_furia_sesto_uc_core_config_st *st);
