 ...
 *
 */
int viper_remote_loopback_ena (const PHYMOD_ST *pa, uint8_t enable)
{
    DIG_CTL1000X1r_t  x1reg;
...
int viper_phy_enable_set(const PHYMOD_ST *pa, int enable )
{
    LANECTL3r_t ctl3;
    DIG_MISC3r_t misc3;
    uint8_t lane_ena;
...
int viper_speed_ctrl_reset(PHYMOD_ST *pa)
{
    ...
    PHYMOD_IF_ERR_RETURN(WRITE_DIG_CTL1000X1r(pa, x1reg));
