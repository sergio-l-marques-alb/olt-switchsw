 ...
 *  Revision      :  $Id: eagle_tsc_functions.h 775 2014-11-11 04:37:38Z kirand $ *
 *                                                                                 *
...
/** Macro to read and display value of lane register field */
#define DISP_REG(x) ESTM(USR_PRINTF(("%s = %d\n",#x,rd_ ## x ## ())))

/** Macro to read and display value of core register field */
