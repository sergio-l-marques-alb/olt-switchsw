...
#define _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET     11008 /* 11K - 256 endpoints for BHH */
...
#define _BCM_OAM_DOMAIN_MPLS_LMDM_PW                   0x05
#define _BCM_OAM_DOMAIN_ING_MPLS_LMDM_LSP              0x06
#define _BCM_OAM_DOMAIN_BHH                            0x06
#define _BCM_OAM_DOMAIN_EGR_MPLS_LMDM_LSP              0x07
#define _BCM_OAM_DOMAIN_MPLS_SECTION                   0x08
#define _BCM_OAM_DOMAIN_MPLS_SECTION_CVLAN             0x09
#define _BCM_OAM_DOMAIN_MPLS_SECTION_SVLAN             0xA
#define _BCM_OAM_DOMAIN_MPLS_SECTION_S_PLUS_CVLAN      0xB
...
#ifdef BCM_SABER2_SUPPORT
#define _BCM_OAM_MAX_PRI_MAP_TABLES 3
#else
#define _BCM_OAM_MAX_PRI_MAP_TABLES 1
#endif
...
#define _BCM_SB2_MAX_OAM_LM_CTRS_POOL_0 2048 /*Pool1: 2k entries */
#define _BCM_SB2_MAX_OAM_LM_CTRS_POOL_1 1024 /*Pool2: 1k entries */
#define _BCM_SB2_MAX_OAM_LM_CTRS_POOL_2 1024 /*Pool3: 1k entries */
...
struct _bcm_oam_hash_data_s {
...
#if defined(INCLUDE_BHH)
    uint8               cpu_qid;            /* CPU queue for BHH             */
    bcm_cos_t           int_pri;            /* internal priority for BHH     */
    bcm_oam_vccv_type_t vccv_type;          /* VCCV pseudowire type          */
    int                 bhh_endpoint_index;
    bcm_vpn_t           vpn;
    ...
    uint8               eth_lm_dm_cpu_qid;            /* CPU queue for BHH             */
    uint32  			eth_lm_dm_int_flag;           /* InternaL FLAG FOR ETH_LM_DM   */
    bcm_mac_t           mac_sa;
...
_bcm_oam_olp_hw_index_olp_type_get(
        ...
        int hwindex,
        bcm_field_olp_header_type_t *olp_hdr_type );
/*Trident2p specific OLP header type mapping*/  
/* OLP_HDR_TYPE_COMPRESSED is filled with one of the below values.
 *
 */
#define _BCM_TD2P_BFD_OLP_HDR_TYPE_COMPRESSED              0

#define _BCM_TD2P_ETH_OAM_CCM_OLP_HDR_TYPE_COMPRESSED      1
#define _BCM_TD2P_ETH_OAM_LM_OLP_HDR_TYPE_COMPRESSED       2
#define _BCM_TD2P_ETH_OAM_DM_OLP_HDR_TYPE_COMPRESSED       3
#define _BCM_TD2P_ETH_OAM_OTHER_OC_OLP_HDR_TYPE_COMPRESSED 4

#define _BCM_TD2P_BHH_CCM_OLP_HDR_TYPE_COMPRESSED          5
#define _BCM_TD2P_BHH_LM_OLP_HDR_TYPE_COMPRESSED           6
#define _BCM_TD2P_BHH_DM_OLP_HDR_TYPE_COMPRESSED           7
#define _BCM_TD2P_BHH_OTHER_OC_OLP_HDR_TYPE_COMPRESSED     8

#define _BCM_TD2P_MPLS_LMDM_DLM_OLP_HDR_TYPE_COMPRESSED    9
#define _BCM_TD2P_MPLS_LMDM_DM_OLP_HDR_TYPE_COMPRESSED     10
#define _BCM_TD2P_MPLS_LMDM_DLM_DM_OLP_HDR_TYPE_COMPRESSED 11
#define _BCM_TD2P_MPLS_LMDM_ILM_OLP_HDR_TYPE_COMPRESSED    12
#define _BCM_TD2P_MPLS_LMDM_ILM_DM_OLP_HDR_TYPE_COMPRESSED 13
#define _BCM_TD2P_SAT_OLP_HDR_TYPE_COMPRESSED              14
#define _BCM_TD2P_OTH_ACH_OLP_HDR_TYPE_COMPRESSED          15

/* 
 * OLP_HEADER_TYPE filled with one of the following values.
 */
#define _BCM_TD2P_OLP_HEADER_TYPE_TX 0
#define _BCM_TD2P_OLP_HEADER_TYPE_RX 1 


/* OLP_HEADER_SUBTYPE filled with one of the following values */
/* Down mep subtypes */
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_CCM             0x01
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_LM              0x02
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_DM              0x03
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_OTHER_OC        0x04
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_BHH_CCM                 0x05
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_BHH_LM                  0x06
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_BHH_DM                  0x07
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_BHH_OTHER_OC            0x08
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_BFD                     0x09
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_MPLS_LMDM_DLM           0x0A
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_MPLS_LMDM_DM            0x0B
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_MPLS_LMDM_DLM_DM        0x0C
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_MPLS_LMDM_ILM           0x0D
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_MPLS_LMDM_ILM_DM        0x0E
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_SAT                     0x0F
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_OTH_ACH                 0x10

/* Up mep subtypes */
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_CCM_UP             0x11
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_LM_UP              0x12
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_DM_UP              0x13
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_ETH_OAM_OTHER_OC_UP        0x14
#define _BCM_TD2P_OLP_HEADER_SUBTYPE_SAT_UP                     0x15

/* KEY formation logic for EGR_OLP_HEADER_TYPE_MAPPING table */
#define _BCM_TD2P_OAM_OLP_HDR_MAP_DIR_DOWN_OR_IFP 0
#define _BCM_TD2P_OAM_OLP_HDR_MAP_DIR_UP          1 
#define _BCM_TD2P_NO_OF_BITS_COMP_HDR             4
#define _BCM_TD2P_OAM_OLP_HDR_TYPE_MAP_KEY_FORM(dir, comp_hdr) \
    ((dir << _BCM_TD2P_NO_OF_BITS_COMP_HDR) | (comp_hdr))

#define _BCM_TD2P_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(comp_hdr) \
    _BCM_TD2P_OAM_OLP_HDR_TYPE_MAP_KEY_FORM(_BCM_TD2P_OAM_OLP_HDR_MAP_DIR_DOWN_OR_IFP,  \
            ( comp_hdr))
#define _BCM_TD2P_OAM_OLP_HDR_TYPE_MAP_UPMEP_KEY_FORM(comp_hdr) \
    _BCM_TD2P_OAM_OLP_HDR_TYPE_MAP_KEY_FORM(_BCM_TD2P_OAM_OLP_HDR_MAP_DIR_UP,   \
            (comp_hdr))
