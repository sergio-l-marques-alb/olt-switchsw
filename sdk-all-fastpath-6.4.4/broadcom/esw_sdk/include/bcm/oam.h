...
typedef enum bcm_oam_action_type_e {
    ...
    bcmOAMActionSLMEnable = 24,         /* Count SLM packets, disable of data
                                           packets counting. */
    bcmOAMActionLowMdlProcessInInernalOamEngine = 25, /* Process Low MDL packets in internal
                                           OAM/CCM engine. */
    bcmOAMActionL2StationMissProcessInInternalOamEngine = 26, /* Process l2 station miss packets in
                                           internal CCM engine. */
    bcmOAMActionL2StationHitProcessInInernalOamEngine = 27, /* Process L2 station hit packets in
                                           internal CCM engine. */
...
typedef enum bcm_oam_condition_e {
    ...
    bcmOamConditionCount = 30           /* Always Last. Not a usable value. */
} bcm_oam_condition_t;
...
#define BCM_OAM_CONDITION_CLEAR_ALL(_condition)  SHR_BITCLR_RANGE(((_condition).cbits), 0, bcmOamLookupTypeCount) 
