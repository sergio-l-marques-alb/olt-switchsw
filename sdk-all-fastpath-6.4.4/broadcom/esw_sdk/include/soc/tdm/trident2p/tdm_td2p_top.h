...
typedef struct {
	...
	int clk_freq;
	int port_rates_array[TD2P_NUM_EXT_PORTS];
...
/* API shim layer */
LINKER_DECL tdm_chip_legacy_t tdm_chip_td2p_shim_core( tdm_mod_t *_tdm );
LINKER_DECL tdm_chip_legacy_t tdm_chip_td2p_shim__ing_wrap( tdm_mod_t *_tdm );
LINKER_DECL tdm_chip_legacy_t tdm_chip_td2p_shim__egr_wrap( tdm_mod_t *_tdm );
