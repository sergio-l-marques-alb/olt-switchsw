...
#define SOC_TMC_NOF_VSQ_GROUPS 6
...
#define SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_MNT_MSB       59
#define SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_MNT_LSB       53
#define SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_MNT_NOF_BITS  (SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_MNT_MSB - SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_MNT_LSB + 1)
#define SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_EXP_MSB       64
#define SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_EXP_LSB       60
#define SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_EXP_NOF_BITS  (SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_EXP_MSB - SOC_TMC_ITM_VSQ_MIN_WRED_AVRG_TH_EXP_LSB + 1)


#define SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_MNT_MSB       47
#define SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_MNT_LSB       41
#define SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_MNT_NOF_BITS  (SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_MNT_MSB - SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_MNT_LSB + 1)
#define SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_EXP_MSB       52
#define SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_EXP_LSB       48
#define SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_EXP_NOF_BITS  (SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_EXP_MSB - SOC_TMC_ITM_VSQ_MAX_WRED_AVRG_TH_EXP_LSB + 1)
