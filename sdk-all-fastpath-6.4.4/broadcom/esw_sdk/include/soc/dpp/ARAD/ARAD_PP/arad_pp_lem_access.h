...
#define ARAD_PP_LEM_ACCESS_KEY_PREFIX_SIZE_IN_BITS_FOR_SA_AUTH(unit)    ((SOC_IS_ARAD_B0_AND_ABOVE(unit)) ? (SOC_IS_JERICHO(unit)? 10:SOC_DPP_DEFS_GET(unit, nof_lem_prefixes)):26)
