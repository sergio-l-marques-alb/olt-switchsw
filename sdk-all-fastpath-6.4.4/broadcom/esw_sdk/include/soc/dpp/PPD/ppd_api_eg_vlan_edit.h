...
#define SOC_PPD_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_IDS             (SOC_PPC_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_IDS)
#define SOC_PPD_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS        (SOC_PPC_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS)
...
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_EMPTY                 SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_EMPTY
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG             SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_INNER_TAG             SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_INNER_TAG
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_0           SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_0
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_1           SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_1
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_ENCAP_INFO            SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_ENCAP_INFO
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_VSI                   SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_VSI
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_CEP_EDIT_INFO         SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_CEP_EDIT_INFO
#define SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_PEP_EDIT              SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_PEP_EDIT
typedef SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC                       SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC;

#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_NONE                  SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_NONE
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_MAP               SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_MAP
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG         SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG         SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_0       SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_0
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_1       SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_1
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_CEP_EDIT_INFO     SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_CEP_EDIT_INFO
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_PEP_EDIT          SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_PEP_EDIT
typedef SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC                   SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC;

#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_TC_DP         SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_TC_DP
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_PCP           SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_PCP
#define SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_DSCP_EXP      SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_DSCP_EXP
typedef SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY               SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY;

typedef SOC_PPC_EG_VLAN_EDIT_PEP_INFO                          SOC_PPD_EG_VLAN_EDIT_PEP_INFO;
typedef SOC_PPC_EG_VLAN_EDIT_COMMAND_KEY                       SOC_PPD_EG_VLAN_EDIT_COMMAND_KEY;
typedef SOC_PPC_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO            SOC_PPD_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO;
typedef SOC_PPC_EG_VLAN_EDIT_COMMAND_INFO                      SOC_PPD_EG_VLAN_EDIT_COMMAND_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_eg_vlan_edit_get_procs_ptr(void);
void
