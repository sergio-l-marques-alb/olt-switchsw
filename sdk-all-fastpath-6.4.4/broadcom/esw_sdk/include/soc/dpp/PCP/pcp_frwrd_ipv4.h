/* $Id: pcp_frwrd_ipv4.h,v 1.5 Broadcom SDK $
...
#ifndef __SOC_PCP_FRWRD_IPV4_INCLUDED__
/* { */
#define __SOC_PCP_FRWRD_IPV4_INCLUDED__
...
typedef enum
{
   ...
   */
  PCP_FRWRD_IP_ROUTES_CACHE_MODE_ENABLE_SET = PCP_PROC_DESC_BASE_FRWRD_IPV4_FIRST,
  PCP_FRWRD_IP_ROUTES_CACHE_MODE_ENABLE_SET_PRINT,
  ...
  PCP_FRWRD_IP_ROUTES_CACHE_MODE_ENABLE_GET_PRINT,
  ...
  PCP_FRWRD_IPV4_VRF_ALL_ROUTING_TABLES_CLEAR_PRINT,
   ...
   */
  PCP_FRWRD_IPV4_DEF_ACTION_SET,
  PCP_FRWRD_IPV4_L3_VPN_DEFAULT_ROUTING_ENABLE_SET,
  PCP_FRWRD_IPV4_L3_VPN_DEFAULT_ROUTING_ENABLE_GET,
  PCP_FRWRD_IPV4_LPM_ROUTE_ADD,
  PCP_FRWRD_IPV4_LPM_ROUTE_IS_EXIST,
  PCP_FRWRD_IPV4_LPM_ROUTE_CLEAR,
  ...
  PCP_FRWRD_IPV4_LEM_ROUTE_REMOVE,
  PCP_FRWRD_IPV4_UC_OR_VPN_ROUTE_ADD,
  PCP_FRWRD_IPV4_UC_OR_VPN_ROUTE_GET,
  PCP_FRWRD_IPV4_UC_OR_VPN_ROUTE_GET_BLOCK,
  PCP_FRWRD_IPV4_UC_OR_VPN_ROUTE_REMOVE,
  PCP_FRWRD_IPV4_UC_OR_VPN_ROUTING_TABLE_CLEAR,

/*
   * Last element. Do no touch.
   */
  PCP_FRWRD_IPV4_PROCEDURE_DESC_LAST
} PCP_FRWRD_IPV4_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  PCP_FRWRD_IPV4_ROUTE_TYPES_OUT_OF_RANGE_ERR = PCP_ERR_DESC_BASE_FRWRD_IPV4_FIRST,
 ...
 *     API.
 *     Refer to
 *     "pcp_frwrd_ip_routes_cache_mode_enable_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  pcp_frwrd_ip_routes_cache_mode_enable_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_ipv4_glbl_info_set_unsafe" API.
 *     Refer to "pcp_frwrd_ipv4_glbl_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  pcp_frwrd_ipv4_glbl_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_ipv4_vrf_info_set_unsafe" API.
 *     Refer to "pcp_frwrd_ipv4_vrf_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  pcp_frwrd_ipv4_vrf_info_get_unsafe(
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  pcp_frwrd_ipv4_get_procs_ptr(void);
...
CONST SOC_ERROR_DESC_ELEMENT*
  pcp_frwrd_ipv4_get_errs_ptr(void);
...
uint32
  PCP_FRWRD_IPV4_MC_ROUTE_KEY_verify(
...
uint32
  PCP_FRWRD_IPV4_MC_ROUTE_INFO_verify(
...
/* } __SOC_PCP_FRWRD_IPV4_INCLUDED__*/
#endif
