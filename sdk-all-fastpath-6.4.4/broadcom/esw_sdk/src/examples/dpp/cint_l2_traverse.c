...
int l2_mact_run(int unit, int port1, int port2){
    ...
    /* open mc */
    rv = open_ingress_mc_group(unit, l2_mact_table_info1.mc_id, l2_mact_table_info1.dest_port_1, l2_mact_table_info1.dest_port_2, 0, 0);
    if (rv != BCM_E_NONE) {
...
/* utilities */
int generat_mac_address(char* mac){
    int indx;
...
int open_ingress_mc_group(int unit, int mc_group_id, int port1, int port2, int cud1, int cud2){
    int dest_arr[2];
    int cud_arr[2];
