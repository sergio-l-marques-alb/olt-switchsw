...
#define ARAD_PP_EG_QOS_PHP_TYPE_MAX                              (ARAD_PP_NOF_EG_QOS_UNIFORM_PHP_TYPES-1)
...
#define ARAD_PP_EG_QOS_ETH_REMARK_PROFILE_INDEX_MAX              (3)
...
#define ARAD_PP_EG_ENCAP_QOS_PKT_TYPE_MIN                        (ARAD_PP_PKT_HDR_TYPE_ETH)
#define ARAD_PP_EG_ENCAP_QOS_PKT_TYPE_MAX                        (ARAD_PP_PKT_HDR_TYPE_MPLS)
...
/* For DSCP/EXP Marking { */
    ...
    #define ARAD_PP_EG_QOS_INLIF_PROFILE_NOF_BITS                (2)
    #define ARAD_PP_EG_QOS_INLIF_PROFILE_MAX                     ARAD_PP_EG_QOS_MAX_BY_BITS(ARAD_PP_EG_QOS_INLIF_PROFILE_NOF_BITS)
    #define ARAD_PP_EG_QOS_RESOLVED_DP_NOF_BITS                  (1)
    #define ARAD_PP_EG_QOS_RESOLVED_DP_MAX                       ARAD_PP_EG_QOS_MAX_BY_BITS(ARAD_PP_EG_QOS_RESOLVED_DP_NOF_BITS)
    #define ARAD_PP_EG_QOS_DP_NOF_BITS                           (2)
    #define ARAD_PP_EG_QOS_MARKING_PROFILE_NOF_BITS              (2)
    #define ARAD_PP_EG_QOS_MARKING_PROFILE_MAX                   ARAD_PP_EG_QOS_MAX_BY_BITS(ARAD_PP_EG_QOS_MARKING_PROFILE_NOF_BITS)
    ...
    #define ARAD_PP_EG_QOS_INLIF_PROFILE_BITMAP_MAX              ARAD_PP_EG_QOS_BITMAP_MAX_BY_BITS(ARAD_PP_EG_QOS_INLIF_PROFILE_NOF_BITS)
 ...
 */ 
#define ARAD_PP_EPNI_REMARK_ETH_TO_EXP_KEY_ENTRY_OFFSET(remark_profile, ecn_capable, dp) \
  ((15 << 5) + (ecn_capable << 4) + (remark_profile << 2) + (dp))
 ...
 */ 
#define ARAD_PP_EPNI_REMARK_ETH_TO_DSCP_KEY_ENTRY_OFFSET(remark_profile, ecn_capable, dp, dscp_exp) \
  ((15 << 6) + (ecn_capable << 5) + (remark_profile << 3) + (dp << 1) + (dscp_exp >> 2))
  ...
  Arad_pp_procedure_desc_element_eg_qos[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PORT_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_QOS_PARAMS_REMARK_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_eg_qos[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_QOS_UNIFORM_PHP_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
...
/*     Remark encapsulation IPV4
    ...
    in_encap_qos_key.pkt_hdr_type   = ARAD_PP_PKT_HDR_TYPE_IPV4;
    for (in_dscp = 0; in_dscp <= ARAD_PP_EG_QOS_IN_DSCP_EXP_MAX; ++in_dscp) {
      for (dp = 0; dp <= ARAD_PP_EG_QOS_DP_MAX; ++dp) {
    ...
    {
    case (ARAD_PP_PKT_HDR_TYPE_IPV4):
  ...
  *value = 0;
  ...
  switch(pkt_hdr_type)
  {
    case ARAD_PP_PKT_HDR_TYPE_IPV4:
      ...
      SHR_BITCOPY_RANGE(&in_dscp_exp, 3, &uindex, 0, 5);
      SHR_BITCOPY_RANGE(&remark_profile, 0, &uindex, 5, 4);
      break;
    case ARAD_PP_PKT_HDR_TYPE_IPV6:
      ...
      SHR_BITCOPY_RANGE(&remark_profile, 0, &uindex, 5, 4);
      break;
    case ARAD_PP_PKT_HDR_TYPE_MPLS:
...
/*    entry_offset,*/
  ...
  ARAD_PP_EPNI_EXP_REMARK_TBL_DATA
    mpls_tbl_data;
    */
  ARAD_PP_EG_QOS_PHP_REMARK_KEY
    php_remark;
  soc_reg_above_64_val_t reg_above64_val;
  ARAD_PP_EG_ENCAP_QOS_MAP_KEY
    in_encap_qos_key;
  ARAD_PP_EG_ENCAP_QOS_PARAMS
...
*/
  ...
  pkt_hdr_type = ARAD_PP_PKT_HDR_TYPE_IPV4;
  ...
  /*
  in_encap_qos_key.pkt_hdr_type = ARAD_PP_PKT_HDR_TYPE_IPV6;
  for (in_dscp = 0; in_dscp <= ARAD_PP_EG_QOS_IN_DSCP_EXP_MAX; ++in_dscp) {
    for (dp = 0; dp <= ARAD_PP_EG_QOS_DP_MAX; ++dp) {
      in_encap_qos_key.dp = dp;
      in_encap_qos_key.in_dscp_exp  = in_dscp;
  ...
  */
  ...
  pkt_hdr_type = ARAD_PP_PKT_HDR_TYPE_IPV6;
  ...
  /*
  in_encap_qos_key.pkt_hdr_type   = ARAD_PP_PKT_HDR_TYPE_MPLS;
  for (in_dscp = 0; in_dscp <= SOC_SAND_PP_MPLS_DSCP_MAX; ++in_dscp) {
    for (dp = 0; dp <= ARAD_PP_EG_QOS_DP_MAX; ++dp) {
      in_encap_qos_key.dp           = dp;
      in_encap_qos_key.in_dscp_exp  = in_dscp;
  ...
  */
  pkt_hdr_type = ARAD_PP_PKT_HDR_TYPE_MPLS;
  ...
  if (SOC_IS_ARAD_B0_AND_ABOVE(unit)) {
    ...
    in_encap_qos_key.pkt_hdr_type = ARAD_PP_PKT_HDR_TYPE_ETH;
  ...
  /* PHP */
  ARAD_PP_EG_QOS_PHP_REMARK_KEY_clear(&php_remark);
  for (in_dscp = 0; in_dscp <= SOC_SAND_PP_MPLS_DSCP_MAX; ++in_dscp) {
    for (php_remark.php_type = ARAD_PP_EG_QOS_UNIFORM_PHP_POP_INTO_IPV4; php_remark.php_type < ARAD_PP_NOF_EG_QOS_UNIFORM_PHP_TYPES; ++php_remark.php_type) {
      php_remark.exp_map_profile = 0;
      php_remark.exp = in_dscp;
       
      /* in-DSCP-EXP = out-DSCP-EXP */
      res = arad_pp_eg_qos_params_php_remark_set_unsafe(unit, &php_remark, in_dscp);
      SOC_SAND_CHECK_FUNC_RESULT(res, 90, exit);      
    }
  }

  if (SOC_IS_ARAD_B0_AND_ABOVE(unit)){
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  100,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, EPNI_REMARK_PROFILE_CONFIGURATIONr, SOC_CORE_ALL, 0, LINK_LAYER_REMARK_PROFILE_MAPf,  12816));
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PORT_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PORT_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_PORT_INFO, port_qos_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PORT_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PORT_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(port_qos_info);

  ARAD_PP_EG_QOS_PORT_INFO_clear(port_qos_info);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_SET_UNSAFE);
  ...
  {
  case ARAD_PP_EG_QOS_UNIFORM_PHP_POP_INTO_IPV4:
    ...
    break;
  case ARAD_PP_EG_QOS_UNIFORM_PHP_POP_INTO_IPV6:
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_PHP_REMARK_KEY, php_key, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_PHP_REMARK_GET_VERIFY);
  ...
  )
{
  ...
  uint32 key_fields[4]; 
  uint32 key_sizes[] = { 
      ARAD_PP_EG_QOS_MARKING_PROFILE_NOF_BITS, 
      ARAD_PP_EG_QOS_INLIF_PROFILE_NOF_BITS,
      ARAD_PP_EG_QOS_RESOLVED_DP_NOF_BITS,
      ARAD_PP_EG_QOS_TC_NDX_NOF_BITS
  };
  ...
  soc_mem_field32_set(unit, EPNI_IP_TOS_MARKINGm, &val, IP_TOS_MARKING_DSCPf, qos_params->ip_dscp);
  soc_mem_field32_set(unit, EPNI_IP_TOS_MARKINGm, &val, IP_TOS_MARKING_EXPf, qos_params->mpls_exp);
  
  
  res = WRITE_EPNI_IP_TOS_MARKINGm(unit, MEM_BLOCK_ANY, key, &val);
  SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_MARKING_KEY, qos_key, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_MARKING_PARAMS, qos_params, 20, exit);
  ...
  )
{
  ...
  res = READ_EPNI_IP_TOS_MARKINGm(unit, MEM_BLOCK_ANY, key, &val);
  SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);

  qos_params->ip_dscp = soc_mem_field32_get(unit, EPNI_IP_TOS_MARKINGm, &val, IP_TOS_MARKING_DSCPf);
  qos_params->mpls_exp = soc_mem_field32_get(unit, EPNI_IP_TOS_MARKINGm, &val, IP_TOS_MARKING_EXPf);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_GLOBAL_INFO, info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_REMARK_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_REMARK_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_MAP_KEY, in_qos_key, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_QOS_PARAMS, out_qos_params, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_REMARK_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_QOS_PARAMS_REMARK_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(in_qos_key);
  SOC_SAND_CHECK_NULL_INPUT(out_qos_params);

  ARAD_PP_EG_QOS_PARAMS_clear(out_qos_params);
  ...
  )
{
  ...
  uint32
    ...
    ecn_ip_enabled = 1, ecn_mpls_enabled = 1;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_QOS_PARAMS_REMARK_SET_UNSAFE);
  ...
  if (SOC_IS_ARAD_B0_AND_ABOVE(unit)) 
  {
    if (in_encap_qos_key->pkt_hdr_type == ARAD_PP_PKT_HDR_TYPE_IPV4 ||
      in_encap_qos_key->pkt_hdr_type == ARAD_PP_PKT_HDR_TYPE_IPV6) 
    {
    ...
    if (SOC_IS_ARAD_B0_AND_ABOVE(unit))
    {
      ...
      for (ecn_capable = 0; ecn_capable < 2; ecn_capable++) {
          for (ecn_congestion = 0; ecn_congestion < 2; ecn_congestion++) {
              ...
              entry_offset = ARAD_PP_EPNI_REMARK_ETH_TO_DSCP_KEY_ENTRY_OFFSET(in_encap_qos_key->remark_profile, ecn_capable, in_encap_qos_key->dp, in_encap_qos_key->in_dscp_exp);
              index_offset = 0;
              ...
              entry_offset = ARAD_PP_EPNI_REMARK_ETH_TO_EXP_KEY_ENTRY_OFFSET(in_encap_qos_key->remark_profile, ecn_capable, in_encap_qos_key->dp);
              index_offset = 0;
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_QOS_PARAMS_REMARK_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_QOS_MAP_KEY, in_encap_qos_key, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_QOS_PARAMS, out_encap_qos_params, 40, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_QOS_PARAMS_REMARK_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_QOS_PARAMS_REMARK_GET_UNSAFE);
  ...
  case (ARAD_PP_PKT_HDR_TYPE_ETH):
    if (SOC_IS_ARAD_B0_AND_ABOVE(unit)) {
        ...
        entry_offset = ARAD_PP_EPNI_REMARK_ETH_TO_EXP_KEY_ENTRY_OFFSET(in_encap_qos_key->remark_profile, 0, in_encap_qos_key->dp);
        index = in_encap_qos_key->in_dscp_exp;
        index_offset = index * ARAD_PP_EG_ENCAP_OUT_EXP_NOF_BITS;
        ...
        entry_offset = ARAD_PP_EPNI_REMARK_ETH_TO_DSCP_KEY_ENTRY_OFFSET(in_encap_qos_key->remark_profile, 0, in_encap_qos_key->dp, in_encap_qos_key->in_dscp_exp);
        index = (in_encap_qos_key->in_dscp_exp & 0x3); /* 2b' LSB */
        index_offset = index * ARAD_PP_EG_ENCAP_OUT_DSCP_NOF_BITS;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_MAP_KEY_verify()",0,0);
}

uint32
  ARAD_PP_EG_ENCAP_QOS_MAP_KEY_verify(
    SOC_SAND_IN  ARAD_PP_EG_ENCAP_QOS_MAP_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
  ...
  {    
    ...
    SOC_SAND_ERR_IF_ABOVE_MAX(info->remark_profile, ARAD_PP_EG_QOS_ETH_REMARK_PROFILE_INDEX_MAX, ARAD_PP_REMARK_PROFILE_OUT_OF_RANGE_ERR, 70, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_QOS_MAP_KEY_verify()",0,0);
}

uint32
  ARAD_PP_EG_QOS_PARAMS_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_PARAMS_verify()",0,0);
}

uint32
  ARAD_PP_EG_ENCAP_QOS_PARAMS_verify(
    SOC_SAND_IN  ARAD_PP_EG_ENCAP_QOS_PARAMS *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
uint32
  ARAD_PP_EG_QOS_PHP_REMARK_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_PHP_REMARK_KEY_verify()",0,0);
}

uint32
  ARAD_PP_EG_QOS_PORT_INFO_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->exp_map_profile, ARAD_PP_EG_QOS_EXP_MAP_PROFILE_MAX, ARAD_PP_EG_QOS_EXP_MAP_PROFILE_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->marking_profile, ARAD_PP_EG_QOS_MARKING_PROFILE_MAX, ARAD_PP_EG_QOS_PHP_TYPE_OUT_OF_RANGE_ERR, 20, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_PORT_INFO_verify()",0,0);
}

#ifdef BCM_88660
uint32
  ARAD_PP_EG_QOS_MARKING_KEY_verify(
    SOC_SAND_IN  ARAD_PP_EG_QOS_MARKING_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);

  SOC_SAND_ERR_IF_ABOVE_MAX(info->resolved_dp_ndx, ARAD_PP_EG_QOS_RESOLVED_DP_MAX, ARAD_PP_EG_QOS_IN_DSCP_EXP_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->tc_ndx, ARAD_PP_TC_MAX_VAL, ARAD_PP_EG_QOS_IN_DSCP_EXP_OUT_OF_RANGE_ERR, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->in_lif_profile, ARAD_PP_EG_QOS_INLIF_PROFILE_MAX, ARAD_PP_EG_QOS_IN_DSCP_EXP_OUT_OF_RANGE_ERR, 30, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->marking_profile, ARAD_PP_EG_QOS_MARKING_PROFILE_MAX, ARAD_PP_EG_QOS_IN_DSCP_EXP_OUT_OF_RANGE_ERR, 40, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_MARKING_KEY_verify()",0,0);
}
uint32
  ARAD_PP_EG_QOS_MARKING_PARAMS_verify(
    SOC_SAND_IN  ARAD_PP_EG_QOS_MARKING_PARAMS *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_MARKING_PARAMS_verify()",0,0);
}
uint32 ARAD_PP_EG_QOS_GLOBAL_INFO_verify(SOC_SAND_IN ARAD_PP_EG_QOS_GLOBAL_INFO *info)
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_QOS_GLOBAL_INFO_verify()",0,0);
}
#endif /* BCM_88660 */
