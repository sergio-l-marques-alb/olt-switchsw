...
#define JER_EGQ_TXI_TH_ID_1GB        0
#define JER_EGQ_TXI_TH_ID_10GB       1
#define JER_EGQ_TXI_TH_ID_40GB       2
#define JER_EGQ_TXI_TH_ID_100GB      3
#define JER_EGQ_TXI_TH_ID_CPU_OAM    4 
#define JER_EGQ_TXI_TH_ID_OLP        5
#define JER_EGQ_TXI_TH_ID_RCY        6
#define JER_EGQ_TXI_TH_ID_150GB      7
#define JER_EGQ_TXI_TH_ID_300GB      8
#define JER_EGQ_TXI_TH_ID_600GB      9
#define JER_EGQ_TXI_TH_ID_25GB       10
#define JER_EGQ_TXI_TH_ID_OFF        11
   ...
   )
{
    ...
    uint32 fq_rdy_sel_val, txi_sel_val, base_q_pair, phy_port;
    int rv, core; 
    ...
    if(interface != SOC_PORT_IF_ERP) {
        ...
        if(interface == SOC_PORT_IF_CPU || interface == SOC_PORT_IF_OAMP) {
            ...
            txi_sel_val = JER_EGQ_TXI_TH_ID_CPU_OAM;
            cancel_en1 = 1;
            cancel_en2 = 1;
            cancel_en3 = 1;
        } else if (interface == SOC_PORT_IF_OLP) {
            fq_rdy_sel_val = JER_EGQ_FQ_RDY_TH_ID_OLP;
            txi_sel_val = JER_EGQ_TXI_TH_ID_OLP;
            cancel_en1 = 1;
            cancel_en2 = 1;
            cancel_en3 = 1;
        } else if (interface == SOC_PORT_IF_RCY) {
            fq_rdy_sel_val = JER_EGQ_FQ_RDY_TH_ID_RCY;
            txi_sel_val = JER_EGQ_TXI_TH_ID_RCY;
            cancel_en1 = 1;
            cancel_en2 = 1;
            cancel_en3 = 1;
            ...
            txi_sel_val = JER_EGQ_TXI_TH_ID_1GB;
            cancel_en1 = 1;
            cancel_en2 = 1;
            cancel_en3 = 1;
            ...
            txi_sel_val = JER_EGQ_TXI_TH_ID_25GB;
            cancel_en1 = 1;
            cancel_en2 = 1;
            cancel_en3 = 1;
   ...
   )
{
    ...
    int core, ps;
    soc_reg_above_64_val_t data;
    uint32 fq_rdy_sel_val, txi_sel_val, invalid_otm;
                            ...
                            soc_port_t                  *port)
{
    ...
    phy_line = soc_reg_field_get(unit, NBI_SYNC_ETH_CFGr, reg_val, SYNC_ETH_CLOCK_SEL_Nf) + 1;
  ...
  )
{
    ...
    if (header_type == SOC_TMC_PORT_HEADER_TYPE_TDM) {
        ...
        if (interface_type == SOC_PORT_IF_ILKN) {
            ...
            SOCDNX_IF_ERR_EXIT(soc_port_sw_db_channel_get(unit, tm_port, &channel)); 
