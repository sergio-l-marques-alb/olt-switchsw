/*
 * $Id: sbZfFe2000RcDmaFormatConsole.c,v 1.5 Broadcom SDK $
...
sbZfFe2000RcDmaFormat_Print(sbZfFe2000RcDmaFormat_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: instr0=0x%08x"), (unsigned int)  pFromStruct->uInstruction0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" instr1=0x%08x"), (unsigned int)  pFromStruct->uInstruction1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" instr2=0x%08x"), (unsigned int)  pFromStruct->uInstruction2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: instr3=0x%08x"), (unsigned int)  pFromStruct->uInstruction3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv0=0x%08x"), (unsigned int)  pFromStruct->uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv1=0x%08x"), (unsigned int)  pFromStruct->uResv1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv2=0x%08x"), (unsigned int)  pFromStruct->uResv2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv3=0x%08x"), (unsigned int)  pFromStruct->uResv3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv4=0x%08x"), (unsigned int)  pFromStruct->uResv4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv5=0x%08x"), (unsigned int)  pFromStruct->uResv5));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv6=0x%08x"), (unsigned int)  pFromStruct->uResv6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv7=0x%08x"), (unsigned int)  pFromStruct->uResv7));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv8=0x%08x"), (unsigned int)  pFromStruct->uResv8));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv9=0x%08x"), (unsigned int)  pFromStruct->uResv9));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv10=0x%08x"), (unsigned int)  pFromStruct->uResv10));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv11=0x%08x"), (unsigned int)  pFromStruct->uResv11));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv12=0x%08x"), (unsigned int)  pFromStruct->uResv12));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv13=0x%08x"), (unsigned int)  pFromStruct->uResv13));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv14=0x%08x"), (unsigned int)  pFromStruct->uResv14));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv15=0x%08x"), (unsigned int)  pFromStruct->uResv15));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv16=0x%08x"), (unsigned int)  pFromStruct->uResv16));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv17=0x%08x"), (unsigned int)  pFromStruct->uResv17));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv18=0x%08x"), (unsigned int)  pFromStruct->uResv18));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv19=0x%08x"), (unsigned int)  pFromStruct->uResv19));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv20=0x%08x"), (unsigned int)  pFromStruct->uResv20));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv21=0x%08x"), (unsigned int)  pFromStruct->uResv21));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv22=0x%08x"), (unsigned int)  pFromStruct->uResv22));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv23=0x%08x"), (unsigned int)  pFromStruct->uResv23));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv24=0x%08x"), (unsigned int)  pFromStruct->uResv24));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv25=0x%08x"), (unsigned int)  pFromStruct->uResv25));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: resv26=0x%08x"), (unsigned int)  pFromStruct->uResv26));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv27=0x%08x"), (unsigned int)  pFromStruct->uResv27));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb00patt310=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern0_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb00patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern0_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb00patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern0_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb00patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern0_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb01patt310=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern1_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb01patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern1_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb01patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern1_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb01patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern1_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb02patt310=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern2_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb02patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern2_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb02patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern2_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb02patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern2_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb03patt310=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern3_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb03patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern3_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb03patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern3_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb03patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb0Pattern3_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb10patt310=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern0_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb10patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern0_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb10patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern0_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb10patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern0_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb11patt310=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern1_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb11patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern1_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb11patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern1_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb11patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern1_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb12patt310=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern2_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb12patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern2_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb12patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern2_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb12patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern2_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb13patt310=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern3_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb13patt6332=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern3_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000RcDmaFormat:: sb13patt6495=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern3_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb13patt12796=0x%08x"), (unsigned int)  pFromStruct->uSb1Pattern3_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfFe2000RcDmaFormat_SPrint(sbZfFe2000RcDmaFormat_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
