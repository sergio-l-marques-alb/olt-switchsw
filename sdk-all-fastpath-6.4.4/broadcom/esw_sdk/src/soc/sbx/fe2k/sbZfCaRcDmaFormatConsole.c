/*
 * $Id: sbZfCaRcDmaFormatConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaRcDmaFormat_Print(sbZfCaRcDmaFormat_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: instr0=0x%08x"), (unsigned int)  pFromStruct->m_uInstruction0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" instr1=0x%08x"), (unsigned int)  pFromStruct->m_uInstruction1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" instr2=0x%08x"), (unsigned int)  pFromStruct->m_uInstruction2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: instr3=0x%08x"), (unsigned int)  pFromStruct->m_uInstruction3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv0=0x%08x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv1=0x%08x"), (unsigned int)  pFromStruct->m_uResv1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv2=0x%08x"), (unsigned int)  pFromStruct->m_uResv2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv3=0x%08x"), (unsigned int)  pFromStruct->m_uResv3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv4=0x%08x"), (unsigned int)  pFromStruct->m_uResv4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv5=0x%08x"), (unsigned int)  pFromStruct->m_uResv5));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv6=0x%08x"), (unsigned int)  pFromStruct->m_uResv6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv7=0x%08x"), (unsigned int)  pFromStruct->m_uResv7));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv8=0x%08x"), (unsigned int)  pFromStruct->m_uResv8));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv9=0x%08x"), (unsigned int)  pFromStruct->m_uResv9));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv10=0x%08x"), (unsigned int)  pFromStruct->m_uResv10));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv11=0x%08x"), (unsigned int)  pFromStruct->m_uResv11));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv12=0x%08x"), (unsigned int)  pFromStruct->m_uResv12));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv13=0x%08x"), (unsigned int)  pFromStruct->m_uResv13));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv14=0x%08x"), (unsigned int)  pFromStruct->m_uResv14));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv15=0x%08x"), (unsigned int)  pFromStruct->m_uResv15));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv16=0x%08x"), (unsigned int)  pFromStruct->m_uResv16));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv17=0x%08x"), (unsigned int)  pFromStruct->m_uResv17));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv18=0x%08x"), (unsigned int)  pFromStruct->m_uResv18));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv19=0x%08x"), (unsigned int)  pFromStruct->m_uResv19));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv20=0x%08x"), (unsigned int)  pFromStruct->m_uResv20));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv21=0x%08x"), (unsigned int)  pFromStruct->m_uResv21));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv22=0x%08x"), (unsigned int)  pFromStruct->m_uResv22));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv23=0x%08x"), (unsigned int)  pFromStruct->m_uResv23));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv24=0x%08x"), (unsigned int)  pFromStruct->m_uResv24));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv25=0x%08x"), (unsigned int)  pFromStruct->m_uResv25));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: resv26=0x%08x"), (unsigned int)  pFromStruct->m_uResv26));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv27=0x%08x"), (unsigned int)  pFromStruct->m_uResv27));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb00patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern0_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb00patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern0_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb00patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern0_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb00patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern0_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb01patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern1_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb01patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern1_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb01patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern1_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb01patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern1_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb02patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern2_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb02patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern2_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb02patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern2_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb02patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern2_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb03patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern3_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb03patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern3_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb03patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern3_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb03patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb0Pattern3_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb10patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern0_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb10patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern0_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb10patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern0_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb10patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern0_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb11patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern1_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb11patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern1_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb11patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern1_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb11patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern1_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb12patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern2_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb12patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern2_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb12patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern2_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb12patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern2_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb13patt310=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern3_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb13patt6332=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern3_63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sb13patt6495=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern3_95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaRcDmaFormat:: sb13patt12796=0x%08x"), (unsigned int)  pFromStruct->m_uSb1Pattern3_127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaRcDmaFormat_SPrint(sbZfCaRcDmaFormat_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
