/*
 * $Id: sbZfCaDiagUcodeShared.c,v 1.2 Broadcom SDK $
...
sbZfCaDiagUcodeShared_Unpack(sbZfCaDiagUcodeShared_t *pToStruct,
  ...
  (pToStruct)->m_ulMemSizeMm0N0 =  (uint32)  ((pFromData)[0] ) & 0x07;

  /* Unpack Member: m_ulMemSizeMm0N1 */
  (pToStruct)->m_ulMemSizeMm0N1 =  (uint32)  ((pFromData)[0] >> 3) & 0x07;

  /* Unpack Member: m_ulMemSizeMm0W */
  (pToStruct)->m_ulMemSizeMm0W =  (uint32)  ((pFromData)[0] >> 6) & 0x03;
  (pToStruct)->m_ulMemSizeMm0W |=  (uint32)  ((pFromData)[1] & 0x01) << 2;

  /* Unpack Member: m_ulMemSizeMm1N0 */
  (pToStruct)->m_ulMemSizeMm1N0 =  (uint32)  ((pFromData)[1] >> 1) & 0x07;

  /* Unpack Member: m_ulMemSizeMm1N1 */
  (pToStruct)->m_ulMemSizeMm1N1 =  (uint32)  ((pFromData)[1] >> 4) & 0x07;

  /* Unpack Member: m_ulMemSizeMm1W */
  (pToStruct)->m_ulMemSizeMm1W =  (uint32)  ((pFromData)[1] >> 7) & 0x01;
  (pToStruct)->m_ulMemSizeMm1W |=  (uint32)  ((pFromData)[2] & 0x03) << 1;

  /* Unpack Member: m_ulRandomSeed */
  (pToStruct)->m_ulRandomSeed =  (uint32)  ((pFromData)[2] >> 2) & 0x3f;
  (pToStruct)->m_ulRandomSeed |=  (uint32)  (pFromData)[3] << 6;
