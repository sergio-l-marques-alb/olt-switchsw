/*
 * $Id: sbZfFabBm9600NmEmtdebugbank1Entry.c,v 1.3 Broadcom SDK $
...
sbZfFabBm9600NmEmtdebugbank1Entry_Pack(sbZfFabBm9600NmEmtdebugbank1Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_NMEMTDEBUGBANK1ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_NMEMTDEBUGBANK1ENTRY_SIZE_IN_BYTES;
}
