...
soc_fe3200_drv_fe13_graceful_shutdown_set(int unit, soc_pbmp_t active_links, soc_pbmp_t unisolated_links, int shutdown) 
{
    ...
    if (shutdown)
    {
        ...
        {
            rv = soc_dcmn_port_control_rx_enable_set(unit, port, 0, 0);
            SOCDNX_IF_ERR_EXIT(rv);
        }
        ...
        SOC_PBMP_ITER(active_links, port)
        {
            rv = soc_dcmn_port_control_tx_enable_set(unit, port, 0);
            SOCDNX_IF_ERR_EXIT(rv);
        }
        ...
        SOC_PBMP_ITER(active_links, port)
        {
            rv = soc_dcmn_port_control_tx_enable_set(unit, port, 1);
            SOCDNX_IF_ERR_EXIT(rv);
        }
        ...
        SOC_PBMP_ITER(active_links, port)
        {
            rv = soc_dcmn_port_control_rx_enable_set(unit, port, 0, 1);
            SOCDNX_IF_ERR_EXIT(rv);
        }
