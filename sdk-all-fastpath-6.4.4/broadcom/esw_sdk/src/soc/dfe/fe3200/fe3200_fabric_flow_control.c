    ...
    if (SOC_DFE_IS_FE13(unit) && SOC_DFE_CONFIG(unit).fabric_local_routing_enable)
    {
        switch (nof_pipes)
        {
            case 1:
                ...
                break;
            case 2:
                dcm_thresholds_default_values-> local_switch_fifo_size[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe) ? SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_LOCAL_SWITCH_IP_TDM_DUAL_PIPE : SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_LOCAL_SWITCH_UC_MC_DUAL_PIPE;
                dcm_thresholds_default_values-> local_switch_fifo_size[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe) ? SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_LOCAL_SWITCH_IP_TDM_DUAL_PIPE : 0;
                dcm_thresholds_default_values-> local_switch_fifo_size[2] = 0;

                dcm_thresholds_default_values-> local_switch_almost_full_0_threshold[0] = dcm_thresholds_default_values-> local_switch_fifo_size[0] - SOC_FE3200_DCM_LOCAL_SWITCH_ALMOST_FULL_OFFSET;
                dcm_thresholds_default_values-> local_switch_almost_full_0_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe) ? dcm_thresholds_default_values-> local_switch_fifo_size[1] - SOC_FE3200_DCM_LOCAL_SWITCH_ALMOST_FULL_OFFSET  : SOC_FE3200_DCM_MAX_THRESHOLD;
                dcm_thresholds_default_values-> local_switch_almost_full_0_threshold[2] = SOC_FE3200_DCM_MAX_THRESHOLD;

                dcm_thresholds_default_values-> local_switch_almost_full_1_threshold[0] = dcm_thresholds_default_values-> local_switch_fifo_size[0]/2;
                dcm_thresholds_default_values-> local_switch_almost_full_1_threshold[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_tdm_non_tdm_config_dual_pipe) ? dcm_thresholds_default_values-> local_switch_fifo_size[1]/2 : SOC_FE3200_DCM_MAX_THRESHOLD;
                dcm_thresholds_default_values-> local_switch_almost_full_1_threshold[2] = SOC_FE3200_DCM_MAX_THRESHOLD;
               
                break;
            case 3:
                dcm_thresholds_default_values-> local_switch_fifo_size[0] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe) ? SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE_0 : SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE_0;
                dcm_thresholds_default_values-> local_switch_fifo_size[1] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe) ? SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE_1 : SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE_1;
                dcm_thresholds_default_values-> local_switch_fifo_size[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe) ? SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_UC_MCH_MCL_THRESHOLD_TRIPLE_PIPE_2 : SOC_FE3200_DCM_DEFAULT_FIFO_SIZE_UC_MC_TDM_THRESHOLD_TRIPLE_PIPE_2;

                dcm_thresholds_default_values-> local_switch_almost_full_0_threshold[0] = dcm_thresholds_default_values-> local_switch_fifo_size[0] - SOC_FE3200_DCM_LOCAL_SWITCH_ALMOST_FULL_OFFSET;
                dcm_thresholds_default_values-> local_switch_almost_full_0_threshold[1] = SOC_FE3200_DCM_MAX_THRESHOLD;
                dcm_thresholds_default_values-> local_switch_almost_full_0_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe) ? SOC_FE3200_DCM_MAX_THRESHOLD : dcm_thresholds_default_values-> local_switch_fifo_size[2] - SOC_FE3200_DCM_LOCAL_SWITCH_ALMOST_FULL_OFFSET;

                dcm_thresholds_default_values-> local_switch_almost_full_1_threshold[0] = dcm_thresholds_default_values-> local_switch_fifo_size[0]/2;
                dcm_thresholds_default_values-> local_switch_almost_full_1_threshold[1] = SOC_FE3200_DCM_MAX_THRESHOLD;
                dcm_thresholds_default_values-> local_switch_almost_full_1_threshold[2] = (SOC_DFE_FABRIC_PIPES_CONFIG(unit).mapping_type == soc_dcmn_drv_uc_hp_mc_lp_mc_config_triple_pipe) ? SOC_FE3200_DCM_MAX_THRESHOLD : dcm_thresholds_default_values-> local_switch_fifo_size[2]/2 ;
