...
int arad_interrupt_handle_epniparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    rc = arad_pp_em_ser_address_get(unit, shadow_correct_info.mem, shadow_correct_info.array_index, shadow_correct_info.min_index - shadow_correct_info.array_index, &address, &is_em_ser);
    SOCDNX_IF_ERR_EXIT(rc); 

    if (is_em_ser) {
        /* EM SER */
        corrective_action = ARAD_INT_CORR_ACT_EPNI_EM_SOFT_RECOVERY;
        info = (void*)(&address);
    }
    else {
        /* non-EM SER */
...
int arad_interrupt_handle_ihbparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    if (is_em_ser) {
        /* EM SER */
        corrective_action = ARAD_INT_CORR_ACT_IHB_EM_SOFT_RECOVERY;
        info = (void*)(&address);
    }
    else {
        /* non-EM SER */
...
int arad_interrupt_handle_ihpparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    if (is_em_ser) {
        /* EM SER */
        corrective_action = ARAD_INT_CORR_ACT_IHP_EM_SOFT_RECOVERY;
        info = (void*)(&address);
    }
    else {
        /* non-EM SER */
...
int arad_interrupt_handle_oampparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    if (is_em_ser) {
        /* EM SER */
        corrective_action = ARAD_INT_CORR_ACT_OAMP_EM_SOFT_RECOVERY;
        info = (void*)(&address);
    }
    else {
        /* non-EM SER */
