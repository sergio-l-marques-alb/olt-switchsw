...
int sesto_phy_intr_enable_set(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t enable);
int sesto_phy_intr_enable_get(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t* enable);

/*PHY interrupt status get*/
int sesto_phy_intr_status_get(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src, uint32_t* intr_status);

/*Clear PHY interrupt status */
int sesto_phy_intr_status_clear(const phymod_phy_access_t* phy, phymod_intr_source_t intr_src);
