/*
 * $Id: type25.h,v 1.1 Broadcom SDK $
 ...
 * Purpose:     Define dma control block (DCB) format for a type25 DCB
 *              used by the 88030 (caladan3)
 *
 *              This file is shared between the SDK and the embedded applications.
 */

#ifndef _SOC_SHARED_DCBFORMATS_TYPE25_H
#define _SOC_SHARED_DCBFORMATS_TYPE25_H
...
typedef struct {
        ...
        uint32  inner_pri:3,            /* Inner priority */
                ...
                repl_nhi:18,            /* Replication or Next Hop index */
