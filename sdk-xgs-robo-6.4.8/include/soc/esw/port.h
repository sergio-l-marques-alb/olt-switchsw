 ...
 * Internal flags
 *
 *   SOC_PORT_RESOURCE_I_MAP    : Indicates port is part of the legacy
 *                                inactive mapping config ':i'.
 *                                To be used only by legacy API.
 *
 *   SOC_PORT_RESOURCE_INACTIVE : Indicates is port is inactive or active
 *                                To be used only by legacy API.
 *
...
#define SOC_PORT_RESOURCE_NEW        (1 << 29)
#define SOC_PORT_RESOURCE_DESTROY    (1 << 28)
#define SOC_PORT_RESOURCE_REMAP      (1 << 27)
