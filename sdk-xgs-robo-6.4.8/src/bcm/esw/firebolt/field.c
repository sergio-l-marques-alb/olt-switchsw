                                      ...
                                      int slice_num, int *multigroup)
{
    ...
    while (next_group_valid) {
        ...
        if (version >= BCM_WB_VERSION_1_10) {
                           ...
                           uint8 *color_independent)
{
    ...
    *eid = *sid = *pid = 0;
    ...
    if (version >= BCM_WB_VERSION_1_13) {
        *color_independent = (buf[fc->scache_pos] >> 7) & 1;
        fc->scache_pos++;
    }
...
#define BCM_IF_ERROR_RETURN_WITH_FREE(_rv_, e, p, max_idx) {    \
            do {                                                \
                int __i__;                                      \
                if (BCM_FAILURE(_rv_)) {                        \
                    sal_free(e);                                \
