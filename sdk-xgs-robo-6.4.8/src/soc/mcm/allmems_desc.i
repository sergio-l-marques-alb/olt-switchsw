 ...
 */
    ...
    /* CFC_CAT_2_TC_CGM_MAP_HCFC */ "Mapping configuration of category2 and TC VSQs (24-31) to 256 HCFC bitmap.",
    /* CFC_CAT_2_TC_CGM_MAP_NIF  */ "Mapping configuration of category2 and TC VSQs (24-31) to 384 PFC bitmap presented to the NIF. __REGGEN_NL__ Notes: __REGGEN_NL__ * Bitmap is presented to the NIF only if Cat2TcMapEna is set of the corresponding VSQ. __REGGEN_NL__ * If flow control is set, all bitmap set bits will be set. Else, all bitmap bits will be reset with no considuration for previous decision.",
    ...
    /* CFC_GLB_RSC_CGM_MAP       */ "Mapping configuration of Cgm global resources indication to 384 PFC/256 HCFC bitmap. Access this table with: resource_type; hp/lp; flow_control dest ==> 0<=addr <= 8 for NIF; 9 <= addr <= 17 for Recycle; 18 <= addr <= 26 for HCFC",
    ...
    /* CFC_OOB_RX_CAL            */ "Mapping of the SPI/HCFC/ILKN-OOB-RX-0 received FC status frames  __REGGEN_NL__ Note: __REGGEN_NL__ - OOB-RX-0 uses only RX interface 0 in the PADS.",
    ...
    /* CFC_OOB_TX_CAL            */ "Mapping of the SPI/HCFC/ILKN-OOB-TX calendar channels to the possible generated FC indications.",
    /* CFC_PP_RX_4_CAL           */ "Mapping of the PP-RX received FC status frames  __REGGEN_NL__  __REGGEN_NL__",
    ...
    /* CFMTRAP                   */ "",
    /* CGM_CNI_PRMS              */ "CNI (Congestion Notification Indication) reject parameters. __REGGEN_NL__ Access usign VOQ.Rate-Class.",
    /* CGM_CNI_STATUS            */ "VOQ CNI status. __REGGEN_NL__ Holds for each VOQ its current CNI status. __REGGEN_NL__  __REGGEN_NL__ Each entry hold 32 statuses for 32 VOQs __REGGEN_NL__ Access to the table using VOQ14:5",
    /* CGM_DP_MAPPING            */ "Maps dp-meter-cmd, incoming dp, Ethernet-meter-dp and meter-processor-dp to ingress-DP and egress-DP. __REGGEN_NL__ Egress-DP is stamped to the FTMH and ingress-DP is forward to IQM. __REGGEN_NL__ key to the table: __REGGEN_NL__ dp-meter-cmd, incoming-dp, Ethernet-meter-dp, mrps-dp __REGGEN_NL__",
    /* CGM_DRAM_RPRT_RX          */ "DRAM report RX FIFO. __REGGEN_NL__  __REGGEN_NL__ Access to this FIFO is forbidden.",
    /* CGM_DROP_REASON_RJCT_MASK */ "Drop-Reason reject mask table. __REGGEN_NL__ Defines for 8 drop-reasons its relevant admission tests. __REGGEN_NL__  __REGGEN_NL__ Each entry holds masks for a single drop reason.",
    /* CGM_ETH_MTR_PTR_MAP       */ "Access to this table using pointers from PP that calculated according to: __REGGEN_NL__  (In-PP-Port)*5+Packet-Type-Value. __REGGEN_NL__  __REGGEN_NL__ Packet-Type-Value: __REGGEN_NL__ 0x0 - Unknown Unicast __REGGEN_NL__ 0x1 - Known Unicast __REGGEN_NL__ 0x2 - Unknown MC __REGGEN_NL__ 0c3 - Known MC __REGGEN_NL__ 0x4 - BC (Broadcast) __REGGEN_NL__  __REGGEN_NL__ In-PP-Port value is 0-255, the",
    ...
    /* CGM_HAPM                  */ "Header-Append-Pointer mapping table  __REGGEN_NL__  __REGGEN_NL__ Access to this table using Header-Append-Pointer",
    /* CGM_IPPPM                 */ "In-PP-Port to mapping table __REGGEN_NL__ Maps Incoming PP-Port to PB-VSQs indexes (LLFC & PG). __REGGEN_NL__  __REGGEN_NL__ Access to this table using In-PP-Port  __REGGEN_NL__  __REGGEN_NL__ VSQ-E (LLFC)  = NIF-Port __REGGEN_NL__ VSQ-F (PG)     = PG-Base + VsqPgTcBitmapTcBitmapIndex, TC",
    /* CGM_IPP_HCP               */ "In-PP-Port Header-Compensation-Profile table. __REGGEN_NL__  __REGGEN_NL__ Access to this table using In-PP-Port",
    /* CGM_IRPP_CTR_CPM          */ "IRPP header compenstaion - Header-Compensation-Profile mapping. __REGGEN_NL__ (Map Header-Compensation-Profile to header delta)",
    /* CGM_IRPP_CTR_HCM          */ "IRPP header compenstaion - Header-Compensation mask table. __REGGEN_NL__ Access using IRPP-Counter-Pointer-A/B MSBs __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Entries 0 to 31 are assinged to Counter-A logic __REGGEN_NL__  - Entries 32 to 53 are assinged to Counter-B logic",
    /* CGM_IS_ING_MC             */ "Define for the lower 64k Multicast-ID whether they are Ingress-MC or Fabric/Egress-MC. __REGGEN_NL__  __REGGEN_NL__ Each entry holds 32b for 32 MC-IDs. __REGGEN_NL__ Access to this table using MC-ID15:5. __REGGEN_NL__ MC-ID4:0 selects the relevant bit in the entry.",
    /* CGM_MRPS_IN_DP_MAPPING    */ "Maps dp-meter-cmd, incoming dp, Ethernet-meter-dp and Ethernet-meter-invalid to MRPS in-DP and in-Drop. __REGGEN_NL__ key to the table: __REGGEN_NL__ dp-meter-cmd, incoming-dp, Ethernet-meter-dp, Ethernet-meter-invalid",
    /* CGM_PB_VSQ_POOL_FC_TH     */ "PB-VSQ flow control. __REGGEN_NL__ Access to this table using Priority, Pool",
    /* CGM_PB_VSQ_PRMS           */ "PB-VSQ (Port-Base VSQs) parameters table __REGGEN_NL__  __REGGEN_NL__ Access to this table using PG (VSQ-F) Index __REGGEN_NL__",
    /* CGM_PB_VSQ_RJCT_MASK      */ "PB-VSQ reject mask table. __REGGEN_NL__ Mask admission tests based on PB-VSQ parameters. __REGGEN_NL__  __REGGEN_NL__ Access to this table using: __REGGEN_NL__ 3 - PG.Is-Lossless __REGGEN_NL__ 2:0 - PG.Admit-Profile",
    /* CGM_PB_VSQ_SRAM_BUFFERS_RJCT_MAP */ "PB-VSQ SRAM-Buffers reject mapping table. __REGGEN_NL__ Map all current admission reject statuses into single reject bit. __REGGEN_NL__  __REGGEN_NL__ Address to this table is: __REGGEN_NL__ 2:0 - PG.Admit-Profile __REGGEN_NL__ 3 - Total-Free-Shared-Resource-Status __REGGEN_NL__ 4 - Port-PG-Shared-Resource-Status __REGGEN_NL__ 5 - Headroom-Extension-Reject-Status __REGGEN_NL__ 6 - Total-Free-Headroom-Resource-Status __REGGEN_NL__ 7 - Port-Headroom-Resource-Status __REGGEN_NL__ 8 - PG-Headroom-No ...",
    /* CGM_PB_VSQ_SRAM_PDS_RJCT_MAP */ "PB-VSQ SRAM-PDs reject mapping table. __REGGEN_NL__ Map all current admission reject statuses into single reject bit. __REGGEN_NL__  __REGGEN_NL__ Address to this table is: __REGGEN_NL__ 2:0 - PG.Admit-Profile __REGGEN_NL__ 3 - Total-Free-Shared-Resource-Status __REGGEN_NL__ 4 - Port-PG-Shared-Resource-Status __REGGEN_NL__ 5 - Headroom-Extension-Reject-Status __REGGEN_NL__ 6 - Total-Free-Headroom-Resource-Status __REGGEN_NL__ 7 - Port-Headroom-Resource-Status __REGGEN_NL__ 8 - PG-Headroom-Nomina ...",
    /* CGM_PB_VSQ_WORDS_RJCT_MAP */ "PB-VSQ Words reject mapping table. __REGGEN_NL__ Map all current admission reject statuses into single reject bit. __REGGEN_NL__  __REGGEN_NL__ Address to this table is: __REGGEN_NL__ 2:0 - PG.Admit-Profile __REGGEN_NL__ 3 - Total-Free-Shared-Resource-Reject-Status __REGGEN_NL__ 4 - Port-PG-Shared-Resource-Reject-Status __REGGEN_NL__ 5 - Total-Free-Headroom-Resource-Reject-Status __REGGEN_NL__ 6 - Port-PG-Headroom-Resource-Reject-Status __REGGEN_NL__ 7 - VOQ-Grntd-Status __REGGEN_NL__ 9:8 - VSQ- ...",
    /* CGM_PCM                   */ "Packet-Constructor memory. __REGGEN_NL__ Hold packet data waiting for TAR processing completion. __REGGEN_NL__  __REGGEN_NL__ Access to this is forbidden.",
    /* CGM_PP_RJCT_MASK          */ "PP reject mask table. __REGGEN_NL__ Mask admission tests based on Admit-Profile generated by the PP. __REGGEN_NL__ Access to this table using PP.Admit-Profile(3)",
    /* CGM_QSPM                  */ "VOQ to System-Port mapping table. __REGGEN_NL__ Access with VOQ14:2 (Every quartet is assigned to System-Port). __REGGEN_NL__  __REGGEN_NL__ Used for System-RED admission logic",
    /* CGM_SCH_CPM               */ "Credit (SCH) header compenstaion - Header-Compensation-Profile mapping. __REGGEN_NL__ (Map Header-Compensation-Profile to header delta)",
    /* CGM_SCH_HCM               */ "Credit (SCH) header compenstaion - Header-Compensation mask table. __REGGEN_NL__ Access using VOQ.Credit-Class",
    /* CGM_SNP_MRR_RJCT_TABLE    */ "Snoop-Mirror reject table. __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Entries 0 to 15 are assinged to Snoop copies (access with Snoop-Command) __REGGEN_NL__  - Entries 16 to 32 are assinged to Mirror copies (access with Mirror-Command)",
    /* CGM_SNP_MRR_TM_TABLE      */ "Snoop-Mirror TM table. __REGGEN_NL__ Allows overwrite fields from the TM command per TM/Snoop-Command __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Entries 0 to 15 are assinged to Snoop copies (access with Snoop-Command) __REGGEN_NL__  - Entries 16 to 32 are assinged to Mirror copies (access with Mirror-Command)",
    /* CGM_STAT_CPM              */ "Statistics header compenstaion - Header-Compensation-Profile mapping. __REGGEN_NL__ (Map Header-Compensation-Profile to header delta)",
    /* CGM_STAT_HCM              */ "Statistics header compenstaion - Header-Compensation mask table. __REGGEN_NL__ Access using Statistics-Pointer MSBs",
    /* CGM_STAT_SCRB_TH          */ "Scrubber buffer thresholds (Static) __REGGEN_NL__ Each entry include buffer thresholds to be compared to occupied or free buffer counters, this defines the Global-Buffer-Consumption field in the scrubber statistics report (used in Qsize statistics report mode). __REGGEN_NL__ The thresholds define 16 ranges of buffer occupancy. __REGGEN_NL__ Each line coresponds to another level of thresholds. __REGGEN_NL__ The IQM will present the worst result of the 3 buffers types. __REGGEN_NL__ The reference  ...",
    /* CGM_ST_PORT_DATA          */ "Statistics-Port data FIFO. __REGGEN_NL__  __REGGEN_NL__ Access to this FIFO is forbidden.",
    /* CGM_SYS_RED_QSIZE_RANGES  */ "Source Q size range thresholds. __REGGEN_NL__ Defines 16 ranges of the instantaneous VOQ words size that define the 4-bit System-RED-VOQ size value. __REGGEN_NL__  __REGGEN_NL__ VOQ-Words-Size below RangeThN is defined with Source-VOQ-Size N. __REGGEN_NL__  __REGGEN_NL__ Note:  __REGGEN_NL__  - Units of Words (16B) __REGGEN_NL__  - Maximal Value allowed is 2^28 - any value above will disable this TH",
    /* CGM_SYS_RED_RJCT_PRMS     */ "System RED reject parameters. __REGGEN_NL__ Access using VOQ.Rate-Class, DP",
    /* CGM_SYS_RED_SIZE          */ "System-RED size table __REGGEN_NL__ Holds for each System-Port the maximal size. __REGGEN_NL__ Access using System-Port. __REGGEN_NL__  __REGGEN_NL__ Used for for System-RED admission logic",
    /* CGM_TAR_FIFO              */ "TAR descriptors FIFO. __REGGEN_NL__ Holds descriptor of UC/MCH/MCL ready for process by TAR. __REGGEN_NL__  __REGGEN_NL__ Access to this table is forbidden.",
    /* CGM_TAR_FIFO_RJCT_TH      */ "TAR descriptors FIFO reject threshold __REGGEN_NL__  __REGGEN_NL__ Access to this table using FIFO-ID, DP __REGGEN_NL__ FIFO-ID: 0x0 - UC, 0x1 - MCH, 0x2 - MCL",
    /* CGM_TM_CTR_CPM            */ "TM header compenstaion - Header-Compensation-Profile mapping. __REGGEN_NL__ (Map Header-Compensation-Profile to header delta)",
    /* CGM_TM_CTR_HCM            */ "TM header compenstaion - Header-Compensation mask table. __REGGEN_NL__ Access using TM-Counter-Pointer-A/B MSBs __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Entries 0 to 31 are assinged to Counter-A logic __REGGEN_NL__  - Entries 32 to 53 are assinged to Counter-B logic",
    /* CGM_VOQ_AVRG_PRMS         */ "VOQ Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VOQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VOQ_DRAM_BLOCK_STATE  */ "VOQ DRAM block state. __REGGEN_NL__ Define for each VOQ its DRAM block state. __REGGEN_NL__ This is dynamic memory -> access for debug purpose only. __REGGEN_NL__  __REGGEN_NL__ Each entry holds 16 states for 16 VOQs. __REGGEN_NL__ Access to this table using VOQ14:4. __REGGEN_NL__ VOQ3:0 selects the relevant VOQ state in the entry.",
    /* CGM_VOQ_DRAM_BOUND_PRMS   */ "VOQ DRAM bound parameters. __REGGEN_NL__ Holds parameters for defining thresholds according which VOQ will be indicated to move traffic from SRAM to DRAM. __REGGEN_NL__  __REGGEN_NL__ Access using VOQ.Rate-Class",
    /* CGM_VOQ_DRAM_BOUND_STATE  */ "VOQ DRAM Bound state. __REGGEN_NL__ Holds one of the following DRAM-Bound state (2) per VOQ: __REGGEN_NL__ 0x0 - Sram-To-Fabric __REGGEN_NL__ 0x1 - Congested __REGGEN_NL__ 0x2 - Recovery   __REGGEN_NL__  __REGGEN_NL__ Each entry holds 16 states for 16 VOQs. __REGGEN_NL__ Address to the table using VOQ14:4",
    /* CGM_VOQ_GRNTD_PRMS        */ "VOQ Guaranteed parameters table __REGGEN_NL__ Table holds static threshold for guaranteed space allocation per VOQ. __REGGEN_NL__ Allocation is seperated for each resource: Words, SRAM-Words and SRAM-PDs. __REGGEN_NL__  __REGGEN_NL__ Access to this table is by VOQ.Rate-Class.",
    /* CGM_VOQ_GRNTD_RJCT_MASK   */ "VOQ Guaranteed reject mask table. __REGGEN_NL__ Mask admission tests based on VOQ state in guaranteed. __REGGEN_NL__  __REGGEN_NL__ Access to this table using: __REGGEN_NL__ 2 - VOQ-Words-In-Guranteed __REGGEN_NL__ 1 - VOQ-SRAM-Words-In-Guranteed __REGGEN_NL__ 0 - VOQ-SRAM-PDs-In-Guranteed",
    /* CGM_VOQ_HCP               */ "VOQ Header-Compensation-Profile table. __REGGEN_NL__  __REGGEN_NL__ Access to this table using VOQ.Credit-Class __REGGEN_NL__ Note: only first 32 entries are used.",
    /* CGM_VOQ_PROFILES          */ "VOQ-Profiles table. __REGGEN_NL__ Table hold all profiles required for ENQ/DEQ process. __REGGEN_NL__ Access to this table using VOQ13:2. __REGGEN_NL__ Entry holds 4 sets of profiles for 4 VOQs (selecting between sets using VOQ1:0.",
    /* CGM_VOQ_SHRD_OC_RJCT_TH   */ "VOQ shared occupancy reject thresholds. __REGGEN_NL__ Access to this table using DP.",
    /* CGM_VOQ_SIZE              */ "VOQ-Sizes table. __REGGEN_NL__ Table hold all instantaneous VOQ sizes. __REGGEN_NL__ Access to this table using VOQ.",
    /* CGM_VOQ_SRAM_DRAM_ONLY_MODE */ "VOQ SRAM-DRAM only mode. __REGGEN_NL__ Define for VOQ.Rate-Class its SRAM-DRAM operation mode.",
    /* CGM_VOQ_SRAM_PDS_RJCT_PRMS */ "VOQ SRAM-PDs reject parameters __REGGEN_NL__ Table holds set of parameters for FADT (Fair-Adaptive-Dynamic-Th) admission logic (on VOQ SRAM-Words size) __REGGEN_NL__  __REGGEN_NL__ Access to the table using VOQ.Rate-Class, DP __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Max value is 2^15",
    /* CGM_VOQ_SRAM_WORDS_RJCT_PRMS */ "VOQ SRAM-Words reject parameters __REGGEN_NL__ Table holds set of parameters for FADT (Fair-Adaptive-Dynamic-Th) admission logic (on VOQ SRAM-Words size) __REGGEN_NL__  __REGGEN_NL__ Access to the table using VOQ.Rate-Class, DP __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Max value is 2^18",
    /* CGM_VOQ_VSQS_PRMS         */ "VOQ - VSQ parameters. __REGGEN_NL__ This table hold for each VOQ its VSQ parameters (for QB-VSQs). __REGGEN_NL__  __REGGEN_NL__ Each entry holds 4 sets of parameters for 4 VOQs. __REGGEN_NL__ Access to this table using VOQ14:2. __REGGEN_NL__ VOQ1:0 selects the relevant set in the entry.",
    /* CGM_VOQ_WORDS_RJCT_PRMS   */ "VOQ Words reject parameters __REGGEN_NL__ Table holds set of parameters for FADT (Fair-Adaptive-Dynamic-Th) admission logic (on VOQ Words size) __REGGEN_NL__  __REGGEN_NL__ Access to the table using VOQ.Rate-Class, DP __REGGEN_NL__  __REGGEN_NL__ Note: __REGGEN_NL__  - Max value is 2^28",
    /* CGM_VSQA_AVRG_PRMS        */ "VSQ - Group A - Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VSQA_MAX_SIZE         */ "VSQ - Group A - Max size tracking memory",
    /* CGM_VSQA_PRMS             */ "VSQ (Virtual Statistics Queue) - Group A (Categoty) parameters. __REGGEN_NL__ Access table using VSQ-A-Index.",
    /* CGM_VSQA_SRAM_BUFFERS_FC_PRMS */ "VSQ - Group A - Flow-Control SRAM-Buffers parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQA_SRAM_BUFFERS_RJCT_PRMS */ "VSQ - Group A - SRAM-Buffers-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQA_SRAM_BUFFERS_SIZE */ "Instantaneous VSQ-A SRAM-Buffers Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-A Index",
    /* CGM_VSQA_SRAM_PDS_FC_PRMS */ "VSQ - Group A - Flow-Control SRAM-PDs parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQA_SRAM_PDS_RJCT_PRMS */ "VSQ - Group A - SRAM-PDs-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQA_SRAM_PDS_SIZE    */ "Instantaneous VSQ-A SRAM-PDs Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-A Index",
    /* CGM_VSQA_WORDS_FC_PRMS    */ "VSQ - Group A - Flow-Control Words parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQA_WORDS_RJCT_PRMS  */ "VSQ - Group A - Words-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQA_WORDS_SIZE       */ "Instantaneous VSQ-A Words Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-A Index",
    /* CGM_VSQA_WRED_RJCT_PRMS   */ "VSQ - Group A - WRED asmission test parameters table __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class, DP",
    /* CGM_VSQB_AVRG_PRMS        */ "VSQ - Group B - Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VSQB_MAX_SIZE         */ "VSQ - Group B - Max size tracking memory",
    /* CGM_VSQB_PRMS             */ "VSQ (Virtual Statistics Queue) - Group B (Categoty x VOQ.TC) parameters. __REGGEN_NL__ Access table using VSQ-B-Index.",
    /* CGM_VSQB_SRAM_BUFFERS_FC_PRMS */ "VSQ - Group B - Flow-Control SRAM-Buffers parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQB_SRAM_BUFFERS_RJCT_PRMS */ "VSQ - Group B - SRAM-Buffers-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQB_SRAM_BUFFERS_SIZE */ "Instantaneous VSQ-B SRAM-Buffers Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-B Index",
    /* CGM_VSQB_SRAM_PDS_FC_PRMS */ "VSQ - Group B - Flow-Control SRAM-PDs parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQB_SRAM_PDS_RJCT_PRMS */ "VSQ - Group B - SRAM-PDs-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQB_SRAM_PDS_SIZE    */ "Instantaneous VSQ-A SRAM-PDs Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-B Index",
    /* CGM_VSQB_WORDS_FC_PRMS    */ "VSQ - Group B - Flow-Control Words parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQB_WORDS_RJCT_PRMS  */ "VSQ - Group B - Words-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQB_WORDS_SIZE       */ "Instantaneous VSQ-B Words Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-B Index",
    /* CGM_VSQB_WRED_RJCT_PRMS   */ "VSQ - Group B - WRED asmission test parameters table __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class, DP",
    /* CGM_VSQC_AVRG_PRMS        */ "VSQ - Group C - Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VSQC_MAX_SIZE         */ "VSQ - Group C - Max size tracking memory",
    /* CGM_VSQC_PRMS             */ "VSQ (Virtual Statistics Queue) - Group B (Categoty x VOQ.Connection-Class) parameters. __REGGEN_NL__ Access table using VSQ-C-Index.",
    /* CGM_VSQC_SRAM_BUFFERS_FC_PRMS */ "VSQ - Group C - Flow-Control SRAM-Buffers parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQC_SRAM_BUFFERS_RJCT_PRMS */ "VSQ - Group C - SRAM-Buffers-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQC_SRAM_BUFFERS_SIZE */ "Instantaneous VSQ-C SRAM-Buffers Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-C Index",
    /* CGM_VSQC_SRAM_PDS_FC_PRMS */ "VSQ - Group C - Flow-Control SRAM-PDs parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQC_SRAM_PDS_RJCT_PRMS */ "VSQ - Group C - SRAM-PDs-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQC_SRAM_PDS_SIZE    */ "Instantaneous VSQ-C SRAM-PDs Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-D Index",
    /* CGM_VSQC_WORDS_FC_PRMS    */ "VSQ - Group C - Flow-Control Words parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQC_WORDS_RJCT_PRMS  */ "VSQ - Group C - Words-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQC_WORDS_SIZE       */ "Instantaneous VSQ-C Words Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-C Index",
    /* CGM_VSQC_WRED_RJCT_PRMS   */ "VSQ - Group C - WRED asmission test parameters table __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class, DP",
    /* CGM_VSQD_AVRG_PRMS        */ "VSQ - Group D - Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VSQD_MAX_SIZE         */ "VSQ - Group D - Max size tracking memory",
    /* CGM_VSQD_PRMS             */ "VSQ (Virtual Statistics Queue) - Group B (Statistics-VSQ-Ptr) parameters. __REGGEN_NL__ Access table using VSQ-D-Index.",
    /* CGM_VSQD_SRAM_BUFFERS_FC_PRMS */ "VSQ - Group D - Flow-Control SRAM-Buffers parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQD_SRAM_BUFFERS_RJCT_PRMS */ "VSQ - Group D - SRAM-Buffers-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQD_SRAM_BUFFERS_SIZE */ "Instantaneous VSQ-D SRAM-Buffers Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-D Index",
    /* CGM_VSQD_SRAM_PDS_FC_PRMS */ "VSQ - Group D - Flow-Control SRAM-PDs parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQD_SRAM_PDS_RJCT_PRMS */ "VSQ - Group D - SRAM-PDs-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQD_SRAM_PDS_SIZE    */ "Instantaneous VSQ-D SRAM-PDs Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-E Index",
    /* CGM_VSQD_WORDS_FC_PRMS    */ "VSQ - Group D - Flow-Control Words parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQD_WORDS_RJCT_PRMS  */ "VSQ - Group D - Words-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQD_WORDS_SIZE       */ "Instantaneous VSQ-D Words Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-D Index",
    /* CGM_VSQD_WRED_RJCT_PRMS   */ "VSQ - Group D - WRED asmission test parameters table __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class, DP",
    /* CGM_VSQE_AVRG_PRMS        */ "VSQ - Group E - Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VSQE_MAX_SIZE         */ "VSQ - Group E - Max size tracking memory",
    /* CGM_VSQE_PRMS             */ "VSQ (Virtual Statistics Queue) - Group E (LLFC) parameters. __REGGEN_NL__ Access table using VSQ-E-Index.",
    /* CGM_VSQE_SRAM_BUFFERS_FC_PRMS */ "VSQ - Group E - Flow-Control SRAM-Buffers parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using PG.Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQE_SRAM_BUFFERS_RJCT_PRMS */ "VSQ - Group E - SRAM-Buffers-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQE_SRAM_BUFFERS_SIZE */ "Instantaneous VSQ-E (LLFC) SRAM-Buffers Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-E Index",
    /* CGM_VSQE_SRAM_PDS_FC_PRMS */ "VSQ - Group E - Flow-Control SRAM-PDs parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using PG.Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQE_SRAM_PDS_RJCT_PRMS */ "VSQ - Group E - SRAM-PDs-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQE_SRAM_PDS_SIZE    */ "Instantaneous VSQ-E (LLFC) SRAM-PDs Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-A Index",
    /* CGM_VSQE_WORDS_FC_PRMS    */ "VSQ - Group E - Flow-Control Words parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using PG.Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQE_WORDS_RJCT_PRMS  */ "VSQ - Group E - Words-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQE_WORDS_SIZE       */ "Instantaneous VSQ-E (LLFC) Words Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-E Index",
    /* CGM_VSQE_WRED_RJCT_PRMS   */ "VSQ - Group E - WRED asmission test parameters table __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class, DP",
    /* CGM_VSQF_AVRG_PRMS        */ "VSQ - Group F - Average parameters table. __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class __REGGEN_NL__  __REGGEN_NL__ Average-Size = (Average-Size - (Average-Size >>AvrgWeight) +  __REGGEN_NL__                                               (VSQ-Words-Size >>AvrgWeight))",
    /* CGM_VSQF_MAX_SIZE         */ "VSQ - Group F - Max size tracking memory",
    /* CGM_VSQF_PRMS             */ "VSQ (Virtual Statistics Queue) - Group F (PFC/PG) parameters. __REGGEN_NL__ Access table using VSQ-F-Index.",
    /* CGM_VSQF_SRAM_BUFFERS_FC_PRMS */ "VSQ - Group F - Flow-Control SRAM-Buffers parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQF_SRAM_BUFFERS_RJCT_PRMS */ "VSQ - Group F - SRAM-Buffers-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQF_SRAM_BUFFERS_SIZE */ "Instantaneous VSQ-F (PFC/PG) SRAM-Buffers Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-F Index",
    /* CGM_VSQF_SRAM_PDS_FC_PRMS */ "VSQ - Group F - Flow-Control SRAM-PDs parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQF_SRAM_PDS_RJCT_PRMS */ "VSQ - Group F - SRAM-PDs-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQF_SRAM_PDS_SIZE    */ "Instantaneous VSQ-F (PFC/PG) SRAM-PDs Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-F Index",
    /* CGM_VSQF_WORDS_FC_PRMS    */ "VSQ - Group F - Flow-Control Words parameters table __REGGEN_NL__  __REGGEN_NL__ Access to the table using VSQ.Rate-Class",
    /* CGM_VSQF_WORDS_RJCT_PRMS  */ "VSQ - Group F - Words-Size reject parameters table __REGGEN_NL__  __REGGEN_NL__ Each entry hold statis threshold per DP. __REGGEN_NL__ Access to the table using Pool-ID, VSQ.Rate-Class",
    /* CGM_VSQF_WORDS_SIZE       */ "Instantaneous VSQ-F (PFC/PG) Words Size memory. __REGGEN_NL__ Access to this table (for debug purpose only) using VSQ-F Index",
    /* CGM_VSQF_WRED_RJCT_PRMS   */ "VSQ - Group F - WRED asmission test parameters table __REGGEN_NL__  __REGGEN_NL__ Access using VSQ.Rate-Class, DP",
    /* CGM_VSQ_GRNTD_RJCT_MASK   */ "VSQ Guaranteed reject mask table. __REGGEN_NL__ Mask admission tests based on VSQ state in guaranteed. __REGGEN_NL__  __REGGEN_NL__ Access to this table using: __REGGEN_NL__ 2 - VSQ-Words-In-Guranteed __REGGEN_NL__ 1 - VSQ-SRAM-Buffers-In-Guranteed __REGGEN_NL__ 0 - VSQ-SRAM-PDs-In-Guranteed",
    /* CGM_VSQ_PG_TC_BITMAP      */ "VSQ PG TC bitmap table. __REGGEN_NL__ Maps In-PP-Port.TcBitmapIndex, TC to PG-Offset. __REGGEN_NL__  __REGGEN_NL__ Access to this table using TC. __REGGEN_NL__ Each entry holds 16 PG-Offsets(8) for 16 In-PP-Port.TcBitmapIndex. __REGGEN_NL__  __REGGEN_NL__ VSQ-E (LLFC)  = NIF-Port __REGGEN_NL__ VSQ-F (PG)     = PG-Base + VsqPgTcBitmapTcBitmapIndex, TC",
    /* CGM_VSQ_SHRD_OC_RJCT_TH   */ "VSQ shared occupancy reject thresholds. __REGGEN_NL__ Access to this table using DP.",
    ...
    /* CRPS_CRPS_CNTS_MEM        */ "CounterProcessor - counters memory. __REGGEN_NL__ Each memory holds all 16k counters pairs of Crps0-16. Each entry in the memory holds 2 counters: packets and bytes (octets) as described below, or 2 counters of 32 bits each according to configuration in Crps0-16CountMode __REGGEN_NL__ Accroding to CrpsCntSrcMode each entry may behave as a single wide counter.",
    /* CRPS_CRPS_OVTH_MEM        */ "CounterProcessor - over the threshold memory. __REGGEN_NL__ Each memory holds an indication per each entry in Crps0-16CntsMem whether one of the counters in the entry's counters pair is over the threshold (thresholds are configured in CrpsThresholdsCfg0-16). __REGGEN_NL__ This memory is used by the scanner module to search counters that are over the threshold and should be read first (LR(T)).",
    ...
    /* DDP                       */ "",
    /* DDP_MAX_LATENCY           */ "The MLM measures latency from the packet OAM-TS extension. __REGGEN_NL__ In this memory the 8 maximal latency's are kept, with the pointer associated with them",
    ...
    /* DQM_BUNDLE_DESCRIPTOR_MEMORY */ "Full Multicast User Count __REGGEN_NL__ Number of duplications of the FullMulticast Dbuffs (UserCnt+1).",
    ...
    /* EDB_OUTRIF_TABLE          */ "This table holds the outrif information instead of keeping it in the eedb. __REGGEN_NL__ The data that was omitted is: Drop  outlif-profile  oam-lif-set  vsi  arp-pointer-valid  arp-pointer. __REGGEN_NL__ Instead we use RifProfileTable (index taken from this table) to establish: drop (1)  outlif-profile (6)  oam-lif-set (1).  __REGGEN_NL__ VSI = 0,RIF14:0 and ARP-pointer is never valid. __REGGEN_NL__ The system can support upto 32k outrifs, in a resolution of 4k (4k, 8k, 12k...). __REGGEN_NL__ E ...",
    /* EDB_PROTECTION_ENTRY      */ "EEDB format when used to hold 15 bits protection pointers to the ProtectionPtrTable. There are 4 Pointers per row, the relevant one is selected according to outlif2:1.  __REGGEN_NL__ For (Coupled mode & wide ees entry, i.e the outlif pointed to mpls or ip): bit14 in the protection pointer must be equal to the data in ProtectionPtrTable1'b0, protection-ptr13:0 in order to PASS the packet. __REGGEN_NL__ For (Coupled mode + half entry) OR* De-Coupled mode + full entry): all 15 bits are the address  ...",
    ...
    /* EPNI_IFC_2_NIF_PORT_MAP   */ "Map EGQ/EPNI internal interface number to NIF port number 1.  pm_num(4),  __REGGEN_NL__ 2. pm_internal_port(4),  __REGGEN_NL__ 3. bicast_valid(1),  __REGGEN_NL__ 4. bicast_pm_num(4),  __REGGEN_NL__ 5. bicast_pm_internal_port(4) __REGGEN_NL__ 6. nif_port(7) __REGGEN_NL__",
    ...
    /* EPNI_LBG_FIFO_CONFIG      */ "The Index of the memory is the LBG FIFO number. __REGGEN_NL__ There are 6 link bonding groups. For each LBG there are  two FIFOs. All FIFOs share the same 384 entries memory. This table contains the Link Bonding FIFOs configuration. __REGGEN_NL__ The FIFOs corresponding to LBG0 are FIFO 0 and 1, the FIFOs corresponding to LBG1 are FIFO 2 and 3, and so on. __REGGEN_NL__",
    ...
    /* EPNI_MAX_LATENCY_TRACK    */ "The ETPP measures latency from the packet OAM-TS extension. __REGGEN_NL__ In this memory the 8 maximal latency's are kept, with the pointer associated with them",
    ...
    /* EPNI_PARSERA_FIFO         */ "FFC instructions and enable __REGGEN_NL__",
    ...
    /* EPNI_PARSERA_UPDATE_INSTRUCTIONS */ "update instructions __REGGEN_NL__ instructions 0-4 are accessed from p0 and instructions 5-9 are accessed from p1",
    ...
    /* EPNI_PRGEA_FIFO           */ "FFC instructions and enable __REGGEN_NL__",
    ...
    /* EPNI_PRGEA_UPDATE_INSTRUCTIONS */ "update instructions __REGGEN_NL__ instructions 0-4 are accessed from p0 and instructions 5-9 are accessed from p1",
    ...
    /* IEP_CONTEXT_COLOR         */ "Color memory per context __REGGEN_NL__",
    /* IEP_CONTEXT_SIZE_HIGH     */ "Packet size memory per context.  __REGGEN_NL__ Higher 138 values __REGGEN_NL__ (total of 330 contexts in Jericho)",
    /* IEP_CONTEXT_SIZE_LOW      */ "Packet size memory per context.  __REGGEN_NL__ Lower 192 values",
    /* IEP_MCDA_DYNAMIC          */ "MCD-A - dynamic data __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - (1280-1)",
    /* IEP_MCDA_HEADER_APPEND_SIZE_PTR_MAP */ "MCDA - Mapping Header Append Size Ptr (Out LIF Adjust Profile). __REGGEN_NL__ Value = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IEP_MCDA_IN_PP_PORT_MAP   */ "MCDA - Mapping In-PP-Port(8) into In-PP-Port-Profile(3) __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IEP_MCDA_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDA - Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8) __REGGEN_NL__ Values = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IEP_MCDA_PCUC             */ "MCDA - Update color memory per context. __REGGEN_NL__ Holds the LB (color) that was updated on SOP.",
    /* IEP_MCDA_PRFCFG_0         */ "MCD-A - profile configuration. __REGGEN_NL__ First copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IEP_MCDA_PRFCFG_1         */ "MCD-A - profile configuration. __REGGEN_NL__ Second copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IEP_MCDA_PRFCFG_SHARING_DIS */ "MCD-A - profile configuration. __REGGEN_NL__ This table defines the profile config memory fields when the profile SharingFlag is reset. __REGGEN_NL__",
    /* IEP_MCDA_PRFCFG_SHARING_EN */ "MCD-A - profile configuration. __REGGEN_NL__ This table defines the profile config memory fields when the profile SharingFlag is set.",
    /* IEP_MCDA_PRFSEL           */ "MCD-A - index to profile mapping. __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - (1280-1)",
    /* IEP_MCDB_DYNAMIC          */ "MCD-B - dynamic data __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - (8-1)",
    /* IEP_MCDB_HEADER_APPEND_SIZE_PTR_MAP */ "MCDB - Mapping Header Append Size Ptr (Out LIF Adjust Profile). __REGGEN_NL__ Value = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IEP_MCDB_IN_PP_PORT_MAP   */ "MCDB - Mapping In-PP-Port(8) into In-PP-Port-Profile(3) __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IEP_MCDB_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDB- Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8) __REGGEN_NL__ Values = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IEP_MCDB_PCUC             */ "MCDB - Update color memory per context. __REGGEN_NL__ Holds the LB (color) that was updated on SOP.",
    /* IEP_MCDB_PRFCFG_0         */ "MCD-B - profile configuration. __REGGEN_NL__ First copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IEP_MCDB_PRFCFG_1         */ "MCD-B - profile configuration. __REGGEN_NL__ Second copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IEP_MCDB_PRFSEL           */ "MCD-B - index to profile mapping. __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - (8-1)",
    /* IEP_PCD_MAP               */ "Parallel color decision mapping table (64 entries x 4) __REGGEN_NL__ Address (6) to this table is: __REGGEN_NL__ On Dual mode: __REGGEN_NL__ - bits 5:4 - MCD-B color decision __REGGEN_NL__ - bits 3 - MCD-B other bucket has credits __REGGEN_NL__ - bits 2:1 - MCD-A color decision __REGGEN_NL__ - bits 0 - MCD-A other bucket has credits __REGGEN_NL__ Notes:  __REGGEN_NL__ - If color decision is yellow -> other bucket is based on the CBL. Otherwise EBL. __REGGEN_NL__ - This table is used in all confi ...",
    ...
    /* IHB_FERA_FIFO             */ "FFC instructions and enable __REGGEN_NL__",
    ...
    /* IHB_FERA_UPDATE_INSTRUCTIONS */ "update instructions __REGGEN_NL__ instructions 0-4 are accessed from p0 and instructions 5-9 are accessed from p1",
    /* IHB_FER_PEM_PROGRAM_SELECTION_TCAM */ "Fer Pem Program Selection Tcam",
    /* IHB_FIFO_DSP              */ "FIFO for data sample __REGGEN_NL__",
    ...
    /* IHB_FIFO_OAMP_PASS_1      */ "FIFO for oamp 1st lookup result __REGGEN_NL__",
    /* IHB_FIFO_OAMP_PASS_2      */ "FIFO for oamp 2nd lookup result __REGGEN_NL__",
    ...
    /* IHB_PMF_UPDATE_KEY_GEN_LSB */ "Program Instruction Table per program for all 4 keys LSB __REGGEN_NL__ lines 0-31 : for instructions 0-7 __REGGEN_NL__ lines 32-63 : for instructions 8-15",
    /* IHB_PMF_UPDATE_KEY_GEN_MSB */ "Program Instruction Table per program for all 4 keys LSB __REGGEN_NL__ lines 0-31 : for instructions 0-7 __REGGEN_NL__ lines 32-63 : for instructions 8-15",
    ...
    /* IHP_FLPA_FIFO             */ "FFC instructions and enable __REGGEN_NL__",
    ...
    /* IHP_FLPA_UPDATE_INSTRUCTIONS */ "update instructions __REGGEN_NL__ instructions 0-4 are accessed from p0 and instructions 5-9 are accessed from p1",
    ...
    /* IHP_PCP_MAP_TABLE         */ "PCP map table. __REGGEN_NL__ Accessed with Cos-Profile, Cos-Profile-Map-Key-Lsb, each line holds 4 values",
    ...
    /* IHP_PRSRA_FIFO            */ "FFC instructions and enable __REGGEN_NL__",
    ...
    /* IHP_PRSRA_UPDATE_INSTRUCTIONS */ "update instructions __REGGEN_NL__ instructions 0-4 are accessed from p0 and instructions 5-9 are accessed from p1",
    ...
    /* ILB_PORT_CONFIG_TABLE     */ "Per port configuration table for LBG traffic. __REGGEN_NL__ Map NIF traffic to ILB logic or bypass, according to the LbType.",
    /* ILB_VLAN_CONFIG_TABLE     */ "Map incoming Port and VLAN id to modems. __REGGEN_NL__ Access this table using concatenation of the port with the 4 least significant bits of the VLAN id. __REGGEN_NL__ Every entry packs 8 modems, to save on ECC bits",
    /* ILKN0CALRX                */ "",
    /* ILKN0CALTX                */ "",
    /* ILKN0SCHMAP               */ "",
    /* ILKN1CALRX                */ "",
    ...
    /* IMP_CONTEXT_COLOR         */ "Color memory per context __REGGEN_NL__",
    /* IMP_CONTEXT_SIZE_HIGH     */ "Packet size memory per context.  __REGGEN_NL__ Higher 138 values __REGGEN_NL__ (total of 330 contexts in Jericho)",
    /* IMP_CONTEXT_SIZE_LOW      */ "Packet size memory per context.  __REGGEN_NL__ Lower 192 values",
    /* IMP_MCDA_DYNAMIC          */ "MCD-A - dynamic data __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - 32k-1",
    /* IMP_MCDA_HEADER_APPEND_SIZE_PTR_MAP */ "MCDA - Mapping Header Append Size Ptr (Out LIF Adjust Profile). __REGGEN_NL__ Value = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IMP_MCDA_IN_PP_PORT_MAP   */ "MCDA - Mapping In-PP-Port(8) into In-PP-Port-Profile(3) __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IMP_MCDA_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDA - Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8) __REGGEN_NL__ Values = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IMP_MCDA_PCUC             */ "MCDA - Update color memory per context. __REGGEN_NL__ Holds the LB (color) that was updated on SOP.",
    /* IMP_MCDA_PRFCFG_0         */ "MCD-A - profile configuration. __REGGEN_NL__ First copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IMP_MCDA_PRFCFG_1         */ "MCD-A - profile configuration. __REGGEN_NL__ Second copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IMP_MCDA_PRFCFG_SHARING_DIS */ "MCD-A - profile configuration. __REGGEN_NL__ This table defines the profile config memory fields when the profile Sharing Flag is reset. __REGGEN_NL__",
    /* IMP_MCDA_PRFCFG_SHARING_EN */ "MCD-A - profile configuration. __REGGEN_NL__ This table defines the profile config memory fields when the profile SharingFlag is set.",
    /* IMP_MCDA_PRFSEL           */ "MCD-A - index to profile mapping. __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - 32k-1",
    /* IMP_MCDB_DYNAMIC          */ "MCD-B - dynamic data __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - 32k-1",
    /* IMP_MCDB_HEADER_APPEND_SIZE_PTR_MAP */ "MCDB - Mapping Header Append Size Ptr (Out LIF Adjust Profile). __REGGEN_NL__ Value = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IMP_MCDB_IN_PP_PORT_MAP   */ "MCDB - Mapping In-PP-Port(8) into In-PP-Port-Profile(3) __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IMP_MCDB_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDB- Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8) __REGGEN_NL__ Values = -128, +127 __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry has 4 mappings __REGGEN_NL__ - Indexes 0 - 256-1",
    /* IMP_MCDB_PCUC             */ "MCDB - Update color memory per context. __REGGEN_NL__ Holds the LB (color) that was updated on SOP.",
    /* IMP_MCDB_PRFCFG_0         */ "MCD-B - profile configuration. __REGGEN_NL__ First copy  __REGGEN_NL__ Both copies should be initialized the same",
    /* IMP_MCDB_PRFCFG_1         */ "MCD-B - profile configuration. __REGGEN_NL__ Second copy __REGGEN_NL__ Both copies should be initialized the same",
    /* IMP_MCDB_PRFSEL           */ "MCD-B - index to profile mapping. __REGGEN_NL__ Notes:  __REGGEN_NL__ - Each entry map 4 meters to profiles which are processed simultaneously. __REGGEN_NL__ - Indexes 0 - 32k-1",
    /* IMP_PCD_MAP               */ "Parallel color decision mapping table (64 entries x 4) __REGGEN_NL__ Address (6) to this table is: __REGGEN_NL__ On Dual mode: __REGGEN_NL__ - bits 5:4 - MCD-B color decision __REGGEN_NL__ - bits 3 - MCD-B other bucket has credits __REGGEN_NL__ - bits 2:1 - MCD-A color decision __REGGEN_NL__ - bits 0 - MCD-A other bucket has credits __REGGEN_NL__ Notes:  __REGGEN_NL__ - If color decision is yellow -> other bucket is based on the CBL. Otherwise EBL. __REGGEN_NL__ - This table is used in all confi ...",
    ...
    /* IPS_CFMEM                 */ "IFC CamFull Memory. __REGGEN_NL__ Threshold for DRAM/Fabric CAM full per Qtype. CAM maximum value is 'd127.",
    ...
    /* IPS_CRVS                  */ "Each source device is associated with one of two possible CreditValues. __REGGEN_NL__ Each bit in this bitmap determines if CreditValue0 or CreditValue1 is to be used. __REGGEN_NL__ This table is enabled by CrValSelEnable register.",
    ...
    /* ITE_MAX_LATENCY           */ "The ITPP measures latency from the packet OAM-TS extension. __REGGEN_NL__ In this memory the 8 maximal latency's are kept, with the pointer associated with them",
    /* ITE_SNP_MIRR_CMD_MAP      */ "snoop/mirror command (taken from the CUD) mapped to outlif and dsp extension in the FTMH header __REGGEN_NL__ Address to this table is  __REGGEN_NL__  mirror or snoop (1 bit), cmd3:0  __REGGEN_NL__ if snoop, addr msb = 1 __REGGEN_NL__ if mirror addr msb = 0 __REGGEN_NL__ NOTE: This should only be used when System headers are Petra Headers. __REGGEN_NL__ For Arad / Jericho headers, should use AradSnpMirStampEn and AradSnpMirStampValues",
    /* ITE_SNP_MIRR_SYS_HEADER_INFO */ "The ITPP stamps for snoop or mirror packet the following fields according to the enable bits, per snoop/mirror command from the IQM's outlif field. __REGGEN_NL__ The address of this table access is is_snoop(~mirror), snoop/mirror-cmd. __REGGEN_NL__ Meaning that the first rows of the table are for mirror and the last rows are for snoop",
    ...
    /* KAPS_RPB_TCAM_CPU_CMD     */ "TCAM command: The command can be write/read/compare/search. In case of write and compare  the Din is needed. __REGGEN_NL__ A command can be performed to addresses 0-4095, representing the 4K TCAM memory. There is one interface per RPB",
    /* KAPS_RPB_TCAM_CPU_COMMAND */ "RPB TCAM command: The command can be write/read/compare/search. In case of write and compare  the Din is needed. __REGGEN_NL__ A command can be performed to addresses 0-4095, representing the 4K TCAM memory (1 I/F per RPB)",
    ...
    /* PEM_MAP_0_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_0_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_1_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_1_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_2_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_2_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_3_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_3_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_4_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_4_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_5_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_5_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_6_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_6_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_7_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_7_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_8_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_8_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    /* PEM_MAP_9_PHYSICAL_ADDR_CONSTRUCTION */ "32 FFC instructions. Each instruction is composed from: __REGGEN_NL__ Dbus-offset(9b), field-width(4b), key-offset(4b)",
    ...
    /* PEM_MAP_9_VIRTUAL_ADDR_CONSTRUCTION */ "FFC instructions and enable __REGGEN_NL__",
    ...
    /* PPDB_A_ISEM_STEP_TABLE    */ "Step Table __REGGEN_NL__ (The Item bit ordering matches must emc_include.v)",
    ...
    /* PPDB_B_ISEM_STEP_TABLE    */ "Step Table __REGGEN_NL__ (The Item bit ordering matches must emc_include.v)",
    ...
    /* PTS_PER_SHAPER_CFG        */ "Configuration per PTS shaper, __REGGEN_NL__ addr=0 : LOCAL-HP __REGGEN_NL__ addr=1 : LOCAL-LP __REGGEN_NL__ addr=2 : LOCAL __REGGEN_NL__",
    /* PTS_PER_WFQ_CFG           */ "Configuration per PTS WFQ __REGGEN_NL__ addr=0 : SRAM:DRAM - LOCAL-HP __REGGEN_NL__ addr=1 : SRAM:DRAM - LOCAL-LP __REGGEN_NL__ addr=2 : SRAM:DRAM - FUC-HP __REGGEN_NL__  __REGGEN_NL__ All the WFQs arbitrates between 2 contexts, each one has its weight.",
    /* PTS_PER_WFQ_MESH_CFG      */ "Configuration per PTS Mesh-WFQ __REGGEN_NL__ addr=0 : LOCAL:DEV1:DEV2 - HP __REGGEN_NL__ addr=1 : LOCAL:DEV1:DEV2 - LP __REGGEN_NL__ The WFQs arbitrates between 3 contexts, each one has its weight.",
    /* PTS_SHAPER_FMC_CFG        */ "Configurations for PTS fabric-MC shaper __REGGEN_NL__ Index0 : FMC-HP __REGGEN_NL__ Index1 : FMC-LP __REGGEN_NL__ Index2 : FMC (total)",
    ...
    /* SPB_COUNTERS_SHADOW       */ "Counters per reassembly context, read from here also clear the counters. __REGGEN_NL__ Write is not working, ignored.",
    /* SPB_FBM_0                 */ "Free Buffer Memory Num0",
    /* SPB_FBM_1                 */ "Free Buffer Memory Num1",
    /* SPB_PACKET_REJECT_CFG     */ "Per packet profile ContextProfile2,TC3DP2 a configuration of reject or not when SPB is almost full (amount of free buffer is below a configurable TH). __REGGEN_NL__ Because TH should maintain TH1 =< TH2 =< TH3 the first TH (TH1) is low priority and TH2 is high priority. for high pririty TC-DP set the RejectOnTh2 and for low priority set RejectOnTh1 or both RejectOnTh1 and RejectOnTh2.",
    /* SPB_RCNT                  */ "Read Counter Memory. __REGGEN_NL__ Every row has 4 counters of 12b (up to 4k copies).",
    /* SPB_RSM                   */ "PEC Reassembly State Memory",
    /* SPB_SRAM_ADDRESS_SPACE    */ "SRAM memory space, addressable by CPU. __REGGEN_NL__ Address should be logical (i.e. represent duff pointer).",
    ...
    /* SQM_PACKET_DESCRIPTOR_MEMORY */ "Full Multicast User Count __REGGEN_NL__ Number of duplications of the FullMulticast Dbuffs (UserCnt+1).",
    ...
    /* TAR_BITMAP_MAPPING_TABLE  */ "Bitmap mapping table. __REGGEN_NL__ Map Offset (2), Index(6) to destination.",
    /* TAR_DESTINATION_TABLE     */ "This memory maps a system port ID to a queue number and a traffic class profile",
    /* TAR_FLOW_AGR_MAP          */ "Flow-Aggregate mapping table __REGGEN_NL__ Map Flow-Aggregate-ID12:0 to Flow-Quartet and Lag-Group.",
    /* TAR_FLOW_TABLE            */ "Flow profile per Folw. __REGGEN_NL__ There are 16K flows. Profile per 4 flows. __REGGEN_NL__ Access this table with flow14:4 and pick profile from the entry using flow3:2",
    /* TAR_LAG_MAPPING           */ "LAG mapping table. __REGGEN_NL__ Given the LAG and its member specifies the destination. __REGGEN_NL__ Entry into table is LAG, LAG-member.",
    ...
    /* TAR_LAG_TO_LAG_RANGE      */ "LAG range memory table. __REGGEN_NL__ Specifies for each LAG its range",
    /* TAR_MCDB                  */ "96k Ingress Multicast Replication Data Base. (Physically shared with egress MLL table). Each multicast ID can result in up to 4k different copies of the incoming packet at the ingress FAP. Each copy is associated with a configurable Queue/destination System port and an OutLif.  __REGGEN_NL__ Ingress - each entry in this table can either: __REGGEN_NL__  - Single copy pointed to the next entry in the linked list. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup ...",
    /* TAR_MCDB_BITMAP_REPLICATION */ "Ingress __REGGEN_NL__ Bitmap replication vector",
    /* TAR_MCDB_DOUBLE_REPLICATION */ "Ingress __REGGEN_NL__ Double replication pointed to the next entry in the table. Each copy has dedicated Outlif. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup and can be used by egress Packet Processor.",
    /* TAR_MCDB_EGRESS_BITMAP_FORMAT */ "Egress: __REGGEN_NL__ Generate up to 64 copies. All having the same OutLIF.",
    /* TAR_MCDB_EGRESS_BITMAP_POINTER_FORMAT */ "Egress: __REGGEN_NL__ Generate up to 256 copies, according to the bitmap that is pointed to by the Bitmap-Pointer. All copies get the OutLIF indicated in the entry.",
    /* TAR_MCDB_EGRESS_DOUBLE_CUD_FORMAT */ "Egress: __REGGEN_NL__ Generate up to two copies, both having the same OutLIF(36 bits) but different PP-DSP.",
    /* TAR_MCDB_EGRESS_TDM_FORMAT */ "Egress: __REGGEN_NL__ Egress TDM Format",
    /* TAR_MCDB_EGRESS_TWO_COPIES_FORMAT */ "Egress: __REGGEN_NL__ Generate up to two copies, each copy has its OutLIF.",
    /* TAR_MCDB_SINGLE_REPLICATION */ "Ingress __REGGEN_NL__ Single copy pointed to the next entry in the linked list. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup and can be used by egress Packet Processor.",
    /* TAR_SMOOTH_DIVISION       */ "Smooth division is used in lag resolution in case LagToLagRange.Mode == 2. __REGGEN_NL__ Maps lag-range (from LagToLagRange) and Lag-Lb-Key to Member. __REGGEN_NL__ Access this table with lag-range, lag-lb-key7:1",
    /* TAR_SMOOTH_DIVISION_GROUP_SIZE */ "",
    /* TAR_SNOOP_MIRROR_DEST_TABLE */ "Snoop and Mirror table. This memory maps the incoming snoop command or mirror command to a replication. The first half is for mirror; the second half is for snoop. __REGGEN_NL__ This table is split into two parts.",
    /* TAR_STACK_FEC_RESOLVE     */ "Access if UseStackResolve is set and destination is system port and resolved-queue16:6 == 11'h7ff. __REGGEN_NL__ Access with resolved-queue5:0 lag-lb-key7:4 __REGGEN_NL__ The resolved StackLag is used to access StackTrunkResolve.",
    /* TAR_STACK_TRUNK_RESOLVE   */ "Access if UseStackResolve is set and destination is system port and resolved-queue16:6 == 11'h7ff. __REGGEN_NL__ Access with StackLag, lag-lb-key5:0. __REGGEN_NL__ Resolved queue = BaseQueue + Traffic-Class",
    /* TAR_TRAFFIC_CLASS_MAPPING */ "The traffic class is mapped according to packet's source and destination. __REGGEN_NL__ Table is accessed with the following key key_msb,orig_tc, where: __REGGEN_NL__ * key_msb (4 bits): __REGGEN_NL__   - 2'b00,TC-Mapping-Profile if Destination is System-Port-ID __REGGEN_NL__   - 2'b01,Flow-Profile if Destination is Flow __REGGEN_NL__   - 2'b10,2'b00 if Destination is fabric or egress multicast __REGGEN_NL__ * ingress_shape (1 bit) is '0' before ingress shaping, and '1' after ingress shaping __R ...",
    /* TCAMACTION0               */ "",
    /* TCAMACTION1               */ "",
    /* TCAMACTION2               */ "",
    /* TCAMACTION3               */ "",
    ...
    /* TXQ_PER_WFQ_CFG           */ "Configuration per PTS WFQ __REGGEN_NL__ addr=0 : SRAM:DRAM - DTQ0 __REGGEN_NL__ addr=1 : SRAM:DRAM - DTQ1 __REGGEN_NL__ addr=2 : SRAM:DRAM - DTQ2 __REGGEN_NL__ addr=4 : SRAM: DRAM - EGQ __REGGEN_NL__ All the WFQs arbitrates between 2 contexts, wach on has its weight.",
    /* TXQ_PRIORITY_BITS_MAPPING_2_FDT */ "This table maps the incoming index, build from various packet parameters to 2 priority bits send to the FDT. __REGGEN_NL__ The fields building the input of the table are: __REGGEN_NL__ hp, mc, dp2 trfcls3",
