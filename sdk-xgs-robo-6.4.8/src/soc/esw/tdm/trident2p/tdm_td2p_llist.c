...
**/
void
tdm_td2p_ll_append(struct ll_node *llist, unsigned char port_append, int *pointer)
{
	struct ll_node *mbox,
...
**/
void
tdm_td2p_ll_insert(struct ll_node *llist, unsigned char port_insert, int idx)
{
	int i;
	struct ll_node *mbox,
					*right=llist,
