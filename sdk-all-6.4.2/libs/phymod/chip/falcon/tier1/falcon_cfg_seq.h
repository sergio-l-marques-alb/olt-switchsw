...
int falcon_tsc_pwrdn_set(const phymod_access_t *pa, int tx_rx, int pwrdn);
int falcon_tsc_pwrdn_get(const phymod_access_t *pa, power_status_t *pwrdn);
int falcon_pmd_lane_swap (const phymod_access_t *pa, uint32_t lane_map);
int falcon_pmd_lane_swap_tx_get(const phymod_access_t *pa, uint32_t *lane_map);
int falcon_pmd_loopback_get(const phymod_access_t *pa, uint32_t *enable);   
...
int falcon_lane_soft_reset_release(const phymod_access_t *pa, uint32_t enable);   /* pmd core soft reset */
int falcon_lane_hard_soft_reset_release(const phymod_access_t *pa, uint32_t enable);
...
int falcon_pmd_cl72_receiver_status(const phymod_access_t *pa, uint32_t *status); 
int falcon_tsc_ucode_init( const phymod_access_t *pa );
int falcon_pram_firmware_enable(const phymod_access_t *pa, int enable, int wait);  
int falcon_pmd_reset_seq(const phymod_access_t *pa, int pmd_touched);
int falcon_pll_reset_enable_set(const phymod_access_t *pa, int enable);
int falcon_tsc_read_pll_range(const phymod_access_t *pa, uint32_t *pll_range);
int falcon_tsc_signal_detect (const phymod_access_t *pa, uint32_t *signal_detect);
int falcon_force_tx_set_rst (const phymod_access_t *pa, uint32_t rst);
int falcon_force_tx_get_rst (const phymod_access_t *pa, uint32_t *rst);
int falcon_force_rx_set_rst (const phymod_access_t *pa, uint32_t rst);
int falcon_force_rx_get_rst (const phymod_access_t *pa, uint32_t *rst);
