/*
 * $Id: sbZfFe2000PedDescriptorConsole.c,v 1.5 Broadcom SDK $
...
sbZfFe2000PedDescriptor_Print(sbZfFe2000PedDescriptor_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: cntbyte=0x%02x"), (unsigned int)  pFromStruct->m_uContinueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: buffer=0x%04x"), (unsigned int)  pFromStruct->m_uBuffer));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: mridx=0x%01x"), (unsigned int)  pFromStruct->m_uMirrorIndex));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: dque=0x%02x"), (unsigned int)  pFromStruct->m_uDestinationQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: srcfrmlen=0x%04x"), (unsigned int)  pFromStruct->m_uSourceFrameLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata3=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata7=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata11=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata15=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte15));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata19=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte19));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata23=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte23));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata27=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte27));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata31=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte31));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata35=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte35));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata39=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte39));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata43=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte43));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata47=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte47));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata51=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte51));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata55=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte55));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata59=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte59));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata63=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte63));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata67=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte67));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata71=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte71));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata75=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte75));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata79=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte79));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata83=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte83));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata87=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte87));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata91=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte91));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata95=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte95));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata99=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte99));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata102=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte102));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata105=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte105));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata108=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte108));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata111=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte111));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata114=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte114));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata117=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte117));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata120=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte120));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata123=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte123));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata126=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte126));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata129=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte129));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata132=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte132));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata135=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte135));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata138=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte138));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata141=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte141));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata144=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte144));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata147=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte147));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata150=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte150));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PedDescriptor:: pdata153=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte153));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfFe2000PedDescriptor_SPrint(sbZfFe2000PedDescriptor_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
