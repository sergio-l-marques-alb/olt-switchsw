/*
 * $Id: sbZfCaSwsDescriptorConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaSwsDescriptor_Print(sbZfCaSwsDescriptor_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: resv0=0x%01x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" srcbuffer=0x%04x"), (unsigned int)  pFromStruct->m_uSourceBuffer));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: buffer=0x%04x"), (unsigned int)  pFromStruct->m_uBufferNumber));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" expidx=0x%02x"), (unsigned int)  pFromStruct->m_uExceptionIndex));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" squeue=0x%02x"), (unsigned int)  pFromStruct->m_uSourceQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv2=0x%02x"), (unsigned int)  pFromStruct->m_uResv2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: repcnt=0x%03x"), (unsigned int)  pFromStruct->m_uReplicantCnt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" repbit=0x%01x"), (unsigned int)  pFromStruct->m_uReplicantBit));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: dque=0x%02x"), (unsigned int)  pFromStruct->m_uDqueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv4=0x%05x"), (unsigned int)  pFromStruct->m_uResv4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata1=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata5=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata9=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte9));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata13=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte13));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata17=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte17));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata21=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte21));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata25=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte25));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata29=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte29));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata33=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte33));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata37=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte37));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata41=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte41));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata45=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte45));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata49=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte49));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata53=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte53));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata57=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte57));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata61=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte61));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata65=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte65));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata69=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte69));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata73=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte73));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata77=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte77));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata81=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte81));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata85=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte85));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata89=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte89));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata93=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte93));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata97=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte97));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata101=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte101));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata105=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte105));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata109=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte109));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata113=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte113));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata117=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte117));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata121=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte121));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata125=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte125));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata129=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte129));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata133=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte133));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata137=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte137));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata141=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte141));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata145=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte145));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata149=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte149));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaSwsDescriptor:: pdata153=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte153));
  LOG_WARN(BSL_LS_SOC_COMMON,
