...
trie_destroy(l249);sal_free(PIVOT_BUCKET_HANDLE(l251));(void)trie_destroy(
PIVOT_BUCKET_TRIE(l251));sal_free(l251);return l127;}int soc_alpm_insert(int
l1,void*l5,uint32 l24,int l252,int l253){defip_alpm_ipv4_entry_t l214,l215;
defip_alpm_ipv6_64_entry_t l216,l217;soc_mem_t l23;void*l218,*l232;int l148,
l27;int index;int l9;int l127 = SOC_E_NONE;uint32 l25;l9 = 
...
}}if(l148!= SOC_L3_VRF_GLOBAL){if(!soc_alpm_mode_get(l1)){if(
VRF_TRIE_ROUTES_CNT(l1,l27,l9) == 0){if(!l25){LOG_ERROR(BSL_LS_SOC_ALPM,(
...
spn_IPV6_LPM_128B_ENABLE,1)){uint32 l339 = 0;if(l336!= SOC_ALPM_MODE_PARALLEL
){uint32 l340;l340 = soc_property_get(l1,spn_NUM_IPV6_LPM_128B_ENTRIES,2048);
if(l340!= 2048){if(SOC_URPF_STATUS_GET(l1)){LOG_CLI((BSL_META_U(l1,
"URPF supported in combined mode only""with 2048 v6-128 entries\n")));return
SOC_E_PARAM;}if((l340!= 1024)&&(l340!= 3072)){LOG_CLI((BSL_META_U(l1,
"Only supported values for v6-128 in"
"nonURPF combined mode are 1024 and 3072\n")));return SOC_E_PARAM;}}}
SOC_IF_ERROR_RETURN(READ_L3_DEFIP_KEY_SELr(l1,&l339));soc_reg_field_set(l1,
L3_DEFIP_KEY_SELr,&l339,V6_KEY_SEL_CAM0_1f,0x1);soc_reg_field_set(l1,
L3_DEFIP_KEY_SELr,&l339,V6_KEY_SEL_CAM2_3f,0x1);soc_reg_field_set(l1,
L3_DEFIP_KEY_SELr,&l339,V6_KEY_SEL_CAM4_5f,0x1);soc_reg_field_set(l1,
L3_DEFIP_KEY_SELr,&l339,V6_KEY_SEL_CAM6_7f,0x1);SOC_IF_ERROR_RETURN(
WRITE_L3_DEFIP_KEY_SELr(l1,l339));}}l305 = (3*(64+32+2+1));SOC_ALPM_LPM_LOCK(
l1);l337 = sizeof(l41)*(l305);if((l43[(l1)]!= NULL)){if(soc_alpm_deinit(l1)<0
){SOC_ALPM_LPM_UNLOCK(l1);return SOC_E_INTERNAL;}}l95[l1] = sal_alloc(sizeof(
l93),"lpm_field_state");if(NULL == l95[l1]){SOC_ALPM_LPM_UNLOCK(l1);return(
SOC_E_MEMORY);}(l95[l1])->l45 = soc_mem_fieldinfo_get(l1,L3_DEFIPm,CLASS_ID0f
);(l95[l1])->l46 = soc_mem_fieldinfo_get(l1,L3_DEFIPm,CLASS_ID1f);(l95[l1])->
l47 = soc_mem_fieldinfo_get(l1,L3_DEFIPm,DST_DISCARD0f);(l95[l1])->l48 = 
...
l1);return(SOC_E_NONE);}static int l4(int l1,void*l5,int*l341){int l119;int
index;int l9;uint32 l14[SOC_MAX_MEM_FIELD_WORDS];int l127 = SOC_E_NONE;int
l342 = 0;sal_memcpy(l14,soc_mem_entry_null(l1,L3_DEFIPm),soc_mem_entry_words(
...
SOC_ALPM_LPM_UNLOCK(l1);return(l127);}}else{l342 = 1;}*l341 = index;if(l127 == 
...
"\nsoc_alpm_lpm_insert: %d %d\n"),index,l119));if(!l342){l290(l1,l5,index,
...
int l10,int l11,defip_aux_scratch_entry_t*l12){uint32 l128;uint32 l343[4] = {
...
CLASS_IDf,l128);if(l9){l343[2] = soc_mem_field32_get(l20,L3_DEFIPm,l7,
IP_ADDR0f);l343[3] = soc_mem_field32_get(l20,L3_DEFIPm,l7,IP_ADDR1f);}else{
l343[0] = soc_mem_field32_get(l20,L3_DEFIPm,l7,IP_ADDR0f);}soc_mem_field_set(
l20,L3_DEFIP_AUX_SCRATCHm,(uint32*)l12,IP_ADDRf,(uint32*)l343);if(l9){l128 = 
...
_soc_aux_op_t l344,defip_aux_scratch_entry_t*l12,int l345,int*l141,int*l142,
int*bucket_index){uint32 l338 = 0;uint32 l346 = 0;int l347;soc_timeout_t l348
;int l127 = SOC_E_NONE;int l349 = 0;if(l345){SOC_IF_ERROR_RETURN(
WRITE_L3_DEFIP_AUX_SCRATCHm(l1,MEM_BLOCK_ANY,0,l12));}l350:l338 = 0;switch(
...
OPCODEf,l347);soc_reg_field_set(l1,L3_DEFIP_AUX_CTRLr,&l338,STARTf,1);
SOC_IF_ERROR_RETURN(WRITE_L3_DEFIP_AUX_CTRLr(l1,l338));soc_timeout_init(&l348
,50000,5);l347 = 0;do{SOC_IF_ERROR_RETURN(READ_L3_DEFIP_AUX_CTRLr(l1,&l338));
l347 = soc_reg_field_get(l1,L3_DEFIP_AUX_CTRLr,l338,DONEf);if(l347 == 1){l127
= SOC_E_NONE;break;}if(soc_timeout_check(&l348)){SOC_IF_ERROR_RETURN(
READ_L3_DEFIP_AUX_CTRLr(l1,&l338));l347 = soc_reg_field_get(l1,
L3_DEFIP_AUX_CTRLr,l338,DONEf);if(l347 == 1){l127 = SOC_E_NONE;}else{LOG_WARN
...
"parity error !!\n"),l1));l349++;if(SOC_CONTROL(l1)->alpm_bulk_retry){
sal_sem_take(SOC_CONTROL(l1)->alpm_bulk_retry,1000000);}if(l349<5){LOG_WARN(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"unit %d: Retry DEFIP AUX Operation..\n"),l1))
;goto l350;}else{LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"unit %d: Aborting DEFIP AUX Operation ""due to un-correctable error !!\n"),
l1));return SOC_E_INTERNAL;}}if(l344 == PREFIX_LOOKUP){if(l141&&l142){*l141 = 
...
READ_L3_DEFIP_AUX_CTRL_1r(l1,&l346));*bucket_index = soc_reg_field_get(l1,
L3_DEFIP_AUX_CTRL_1r,l346,BKT_PTRf);}}}return l127;}static int l19(int l20,
void*lpm_entry,void*l21,void*l22,soc_mem_t l23,uint32 l24,uint32*l351){uint32
l128;uint32 l343[4] = {0,0};int l119 = 0;int l127 = SOC_E_NONE;int l9;uint32
...
CLASS_ID0f);soc_mem_field32_set(l20,l23,l21,CLASS_IDf,l128);l343[0] = 
soc_mem_field32_get(l20,L3_DEFIPm,lpm_entry,IP_ADDR0f);if(l9){l343[1] = 
soc_mem_field32_get(l20,L3_DEFIPm,lpm_entry,IP_ADDR1f);}soc_mem_field_set(l20
,l23,(uint32*)l21,KEYf,(uint32*)l343);if(l9){l128 = soc_mem_field32_get(l20,
...
_ipmask2pfx(l128,&l119))<0){return(l127);}}if((l119 == 0)&&(l343[0] == 0)&&(
l343[1] == 0)){l25 = 1;}if(l351!= NULL){*l351 = l25;}soc_mem_field32_set(l20,
...
static int l26(int l20,void*l21,soc_mem_t l23,int l9,int l27,int l28,int index
,void*lpm_entry){uint32 l128;uint32 l343[4] = {0,0};uint32 l119 = 0;
...
l23,l21,KEYf,l343);if(l9){soc_mem_field32_set(l20,L3_DEFIPm,lpm_entry,
IP_ADDR1f,l343[1]);}soc_mem_field32_set(l20,L3_DEFIPm,lpm_entry,IP_ADDR0f,
l343[0]);l128 = soc_mem_field32_get(l20,l23,l21,LENGTHf);if(l9){if(l128>= 32)
...
lpm_entry,int l352,int l353){int l127 = SOC_E_NONE;uint32 key[2] = {0,0};
alpm_pivot_t*l203 = NULL;alpm_bucket_handle_t*l212 = NULL;int l148 = 0,l27 = 
0;uint32 l354;trie_t*l249 = NULL;uint32 prefix[5] = {0};int l25 = 0;l127 = 
l133(l20,lpm_entry,prefix,&l354,&l25);SOC_IF_ERROR_RETURN(l127);
SOC_IF_ERROR_RETURN(soc_alpm_lpm_vrf_get(l20,lpm_entry,&l148,&l27));l352 = 
soc_alpm_physical_idx(l20,L3_DEFIPm,l352,l9);l212 = sal_alloc(sizeof(
...
(l20,lpm_entry,IP_ADDR0f);}PIVOT_BUCKET_INDEX(l203) = l353;PIVOT_TCAM_INDEX(
l203) = l352;if(l148!= SOC_L3_VRF_OVERRIDE){if(l9 == 0){l249 = 
...
sal_memcpy(l203->key,prefix,sizeof(prefix));l203->len = l354;l127 = 
trie_insert(l249,l203->key,NULL,l203->len,(trie_node_t*)l203);if(SOC_FAILURE(
l127)){sal_free(l212);sal_free(l203);return l127;}}ALPM_TCAM_PIVOT(l20,l352) = 
...
static int l355(int l20,int l9,void*lpm_entry,void*l21,soc_mem_t l23,int l352
,int l353,int l356){int l357;int l27;int l127 = SOC_E_NONE;int l25 = 0;uint32
prefix[5] = {0,0,0,0,0};uint32 l140;void*l358 = NULL;trie_t*l359 = NULL;
trie_t*l206 = NULL;trie_node_t*l208 = NULL;payload_t*l360 = NULL;payload_t*
...
soc_alpm_lpm_vrf_get(l20,lpm_entry,&l357,&l27));l23 = (l9)?
...
SOC_IF_ERROR_RETURN(l26(l20,l21,l23,l9,l357,l353,l352,l358));l127 = l133(l20,
l358,prefix,&l140,&l25);if(SOC_FAILURE(l127)){LOG_ERROR(BSL_LS_SOC_ALPM,(
BSL_META_U(l20,"prefix create failed\n")));return l127;}sal_free(l358);l145 = 
ALPM_TCAM_PIVOT(l20,l352);l359 = PIVOT_BUCKET_TRIE(l145);l360 = sal_alloc(
sizeof(payload_t),"Payload for Key");if(NULL == l360){LOG_ERROR(
...
l360);return SOC_E_MEMORY;}sal_memset(l360,0,sizeof(*l360));sal_memset(l210,0
,sizeof(*l210));l360->key[0] = prefix[0];l360->key[1] = prefix[1];l360->key[2
] = prefix[2];l360->key[3] = prefix[3];l360->key[4] = prefix[4];l360->len = 
l140;l360->index = l356;sal_memcpy(l210,l360,sizeof(*l360));l127 = 
trie_insert(l359,prefix,NULL,l140,(trie_node_t*)l360);if(SOC_FAILURE(l127)){
goto l361;}if(l9){l206 = VRF_PREFIX_TRIE_IPV6(l20,l27);}else{l206 = 
...
void)trie_delete(l359,prefix,l140,&l208);l360 = (payload_t*)l208;l361:
sal_free(l360);sal_free(l210);return l127;}static int l362(int l20,int l33,
int l27,int l129,int bkt_ptr){int l127 = SOC_E_NONE;uint32 l140;uint32 key[2]
= {0,0};trie_t*l363 = NULL;payload_t*l239 = NULL;defip_entry_t*lpm_entry = 
...
VRF_PREFIX_TRIE_IPV4(l20,l27));l363 = VRF_PREFIX_TRIE_IPV4(l20,l27);}else{
VRF_TRIE_DEFAULT_ROUTE_IPV6(l20,l27) = lpm_entry;trie_init(_MAX_KEY_LEN_144_,
&VRF_PREFIX_TRIE_IPV6(l20,l27));l363 = VRF_PREFIX_TRIE_IPV6(l20,l27);}l239 = 
...
key[1];l239->len = l140;l127 = trie_insert(l363,key,NULL,l140,&(l239->node));
...
lpm_entry,void*l21,int l352,int l353,int l356){int l357;int l27;int l127 = 
SOC_E_NONE;soc_mem_t l23;l352 = soc_alpm_physical_idx(l20,L3_DEFIPm,l352,l9);
l23 = (l9)?L3_DEFIP_ALPM_IPV6_64m:L3_DEFIP_ALPM_IPV4m;SOC_IF_ERROR_RETURN(
soc_alpm_lpm_vrf_get(l20,lpm_entry,&l357,&l27));if(l357 == 
...
l27));l127 = l362(l20,l9,l27,l352,l353);if(SOC_FAILURE(l127)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l20,"VRF %d/%d trie init \n""failed\n"),l27,l9));
return l127;}LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(l20,
"VRF %d/%d trie init completed\n"),l27,l9));}l127 = l355(l20,l9,lpm_entry,l21
,l23,l352,l353,l356);if(l127!= SOC_E_NONE){LOG_WARN(BSL_LS_SOC_ALPM,(
...
soc_alpm_warmboot_lpm_reinit_done(int l20){int l129;int l364 = ((3*(64+32+2+1
...
l20)][(l129)].l36)){continue;}(l43[(l20)][(l129)].l38) = l364;(l43[(l20)][(
l364)].next) = l129;(l43[(l20)][(l364)].l40) = (l43[(l20)][(l129)].l36)-(l43[
(l20)][(l364)].l37)-1;l364 = l129;}(l43[(l20)][(l364)].next) = -1;(l43[(l20)]
[(l364)].l40) = l283-(l43[(l20)][(l364)].l37)-1;}else{(l43[(l20)][(((3*(64+32
+2+1))-1))].l38) = -1;for(l129 = ((3*(64+32+2+1))-1);l129>(((3*(64+32+2+1))-1
)/3);l129--){if(-1 == (l43[(l20)][(l129)].l36)){continue;}(l43[(l20)][(l129)]
.l38) = l364;(l43[(l20)][(l364)].next) = l129;(l43[(l20)][(l364)].l40) = (l43
[(l20)][(l129)].l36)-(l43[(l20)][(l364)].l37)-1;l364 = l129;}(l43[(l20)][(
l364)].next) = -1;(l43[(l20)][(l364)].l40) = l283-(l43[(l20)][(l364)].l37)-1;
l364 = (((3*(64+32+2+1))-1)/3);(l43[(l20)][((((3*(64+32+2+1))-1)/3))].l38) = 
-1;for(l129 = ((((3*(64+32+2+1))-1)/3)-1);l129>-1;l129--){if(-1 == (l43[(l20)
][(l129)].l36)){continue;}(l43[(l20)][(l129)].l38) = l364;(l43[(l20)][(l364)]
.next) = l129;(l43[(l20)][(l364)].l40) = (l43[(l20)][(l129)].l36)-(l43[(l20)]
[(l364)].l37)-1;l364 = l129;}(l43[(l20)][(l364)].next) = -1;(l43[(l20)][(l364
)].l40) = (l283>>1)-(l43[(l20)][(l364)].l37)-1;}return(SOC_E_NONE);}int
soc_alpm_warmboot_lpm_reinit(int l20,int l9,int l129,void*lpm_entry){int l16;
defip_entry_t*l365;if(soc_L3_DEFIPm_field32_get(l20,lpm_entry,VALID0f)||
...
;}}else{if(soc_L3_DEFIPm_field32_get(l20,lpm_entry,VALID1f)){l365 = sal_alloc
(sizeof(defip_entry_t),"lpm_entry_hi");soc_alpm_lpm_ip4entry1_to_0(l20,
lpm_entry,l365,TRUE);SOC_IF_ERROR_RETURN(l34(l20,l365,&l16));if((l43[(l20)][(
l16)].l39) == 0){(l43[(l20)][(l16)].l36) = l129;(l43[(l20)][(l16)].l37) = 
l129;}else{(l43[(l20)][(l16)].l37) = l129;}sal_free(l365);(l43[(l20)][(l16)].
l39)++;}}return(SOC_E_NONE);}typedef struct l366{int v4;int v6_64;int v6_128;
int l367;int l368;int l369;int l285;}l370;typedef enum l371{l372 = 0,l373,
l374,l375,l376,l377}l378;static void l379(int l1,alpm_vrf_counter_t*l380){
l380->v4 = soc_mem_index_count(l1,L3_DEFIPm)*2;l380->v6_128 = 
...
l380->v4>>1;}if(SOC_URPF_STATUS_GET(l1)){l380->v4>>= 1;l380->v6_128>>= 1;l380
->v6_64>>= 1;}}static void l381(int l1,int l148,alpm_vrf_handle_t*l382,l378
l383){alpm_vrf_counter_t*l384;int l170,l385,l386,l387;int l342 = 0;
alpm_vrf_counter_t l380;switch(l383){case l372:LOG_CLI((BSL_META_U(l1,
"\nAdd Counter:\n")));break;case l373:LOG_CLI((BSL_META_U(l1,
"\nDelete Counter:\n")));break;case l374:LOG_CLI((BSL_META_U(l1,
"\nInternal Debug Counter - 1:\n")));break;case l375:l379(l1,&l380);LOG_CLI((
BSL_META_U(l1,"\nPivot Occupancy: Max v4/v6-64/v6-128 = %d/%d/%d\n"),l380.v4,
l380.v6_64,l380.v6_128));break;case l376:LOG_CLI((BSL_META_U(l1,
"\nInternal Debug Counter - LPM Shift:\n")));break;case l377:LOG_CLI((
BSL_META_U(l1,"\nInternal Debug Counter - LPM Full:\n")));break;default:break
;}LOG_CLI((BSL_META_U(l1,"\n      VRF  v4      v6-64   v6-128  |   Total\n"))
);LOG_CLI((BSL_META_U(l1,"-----------------------------------------------\n")
));l385 = l386 = l387 = 0;for(l170 = 0;l170<MAX_VRF_ID+1;l170++){int l388,
l389,l390;if(l382[l170].init_done == 0&&l170!= MAX_VRF_ID){continue;}if(l148
!= -1&&l148!= l170){continue;}l342 = 1;switch(l383){case l372:l384 = &l382[
l170].add;break;case l373:l384 = &l382[l170].del;break;case l374:l384 = &l382
[l170].bkt_split;break;case l376:l384 = &l382[l170].lpm_shift;break;case l377
:l384 = &l382[l170].lpm_full;break;case l375:l384 = &l382[l170].pivot_used;
break;default:l384 = &l382[l170].pivot_used;break;}l388 = l384->v4;l389 = 
l384->v6_64;l390 = l384->v6_128;l385+= l388;l386+= l389;l387+= l390;do{
LOG_CLI((BSL_META_U(l1,"%9d  %-7d %-7d %-7d |   %-7d %s\n"),(l170 == 
MAX_VRF_ID?-1:l170),(l388),(l389),(l390),((l388+l389+l390)),(l170) == 
MAX_VRF_ID?"GHi":(l170) == SOC_VRF_MAX(l1)+1?"GLo":""));}while(0);}if(l342 == 
0){LOG_CLI((BSL_META_U(l1,"%9s\n"),"Specific VRF not found"));}else{LOG_CLI((
BSL_META_U(l1,"-----------------------------------------------\n")));do{
LOG_CLI((BSL_META_U(l1,"%9s  %-7d %-7d %-7d |   %-7d \n"),"Total",(l385),(
l386),(l387),((l385+l386+l387))));}while(0);}return;}int soc_alpm_debug_show(
int l1,int l148,uint32 flags){int l170,l391,l342 = 0;l370*l392;l370 l393;l370
l394;if(l148>(SOC_VRF_MAX(l1)+1)){return SOC_E_PARAM;}l391 = MAX_VRF_ID*
sizeof(l370);l392 = sal_alloc(l391,"_alpm_dbg_cnt");if(l392 == NULL){return
SOC_E_MEMORY;}sal_memset(l392,0,l391);l393.v4 = ALPM_IPV4_BKT_COUNT;l393.
v6_64 = ALPM_IPV6_64_BKT_COUNT;l393.v6_128 = ALPM_IPV6_128_BKT_COUNT;if(!
soc_alpm_mode_get(l1)&&!SOC_URPF_STATUS_GET(l1)){l393.v6_64<<= 1;l393.v6_128
<<= 1;}LOG_CLI((BSL_META_U(l1,"\nBucket Occupancy:\n")));if(flags&(
SOC_ALPM_DEBUG_SHOW_FLAG_BKT)){do{LOG_CLI((BSL_META_U(l1,
"\n  BKT/VRF  Min     Max     Cur     |   Comment\n")));}while(0);LOG_CLI((
BSL_META_U(l1,"-----------------------------------------------\n")));}for(
l170 = 0;l170<MAX_PIVOT_COUNT;l170++){alpm_pivot_t*l395 = ALPM_TCAM_PIVOT(l1,
l170);if(l395!= NULL){l370*l396;int l27 = PIVOT_BUCKET_VRF(l395);if(l27<0||
l27>(SOC_VRF_MAX(l1)+1)){continue;}if(l148!= -1&&l148!= l27){continue;}if(
flags&SOC_ALPM_DEBUG_SHOW_FLAG_BKT){l342 = 1;do{LOG_CLI((BSL_META_U(l1,
"%5d/%-4d %-7d %-7d %-7d |   %-7s\n"),l170,l27,PIVOT_BUCKET_MIN(l395),
PIVOT_BUCKET_MAX(l395),PIVOT_BUCKET_COUNT(l395),PIVOT_BUCKET_DEF(l395)?"Def":
(l27) == SOC_VRF_MAX(l1)+1?"GLo":""));}while(0);}l396 = &l392[l27];if(
...
}l396->l285 = TRUE;}}if(flags&SOC_ALPM_DEBUG_SHOW_FLAG_BKT){if(l342 == 0){
LOG_CLI((BSL_META_U(l1,"%9s\n"),"Specific VRF not found"));}}sal_memset(&l394
,0,sizeof(l394));l342 = 0;if(flags&SOC_ALPM_DEBUG_SHOW_FLAG_BKTUSG){LOG_CLI((
BSL_META_U(l1,"\n      VRF  v4      v6-64   v6-128  |   Total\n")));LOG_CLI((
BSL_META_U(l1,"-----------------------------------------------\n")));for(l170
= 0;l170<MAX_VRF_ID;l170++){l370*l396;if(l392[l170].l285!= TRUE){continue;}if
(l148!= -1&&l148!= l170){continue;}l342 = 1;l396 = &l392[l170];do{(&l394)->v4
+= (l396)->v4;(&l394)->l367+= (l396)->l367;(&l394)->v6_64+= (l396)->v6_64;(&
l394)->l368+= (l396)->l368;(&l394)->v6_128+= (l396)->v6_128;(&l394)->l369+= (
l396)->l369;}while(0);do{LOG_CLI((BSL_META_U(l1,
"%9d  %02d.%d%%   %02d.%d%%   %02d.%d%%   |   %02d.%d%% %5s\n"),(l170),(l396
->l367)?(l396->v4)*100/(l396->l367):0,(l396->l367)?(l396->v4)*1000/(l396->
l367)%10:0,(l396->l368)?(l396->v6_64)*100/(l396->l368):0,(l396->l368)?(l396->
v6_64)*1000/(l396->l368)%10:0,(l396->l369)?(l396->v6_128)*100/(l396->l369):0,
(l396->l369)?(l396->v6_128)*1000/(l396->l369)%10:0,((l396->l367+l396->l368+
l396->l369))?((l396->v4+l396->v6_64+l396->v6_128))*100/((l396->l367+l396->
l368+l396->l369)):0,((l396->l367+l396->l368+l396->l369))?((l396->v4+l396->
v6_64+l396->v6_128))*1000/((l396->l367+l396->l368+l396->l369))%10:0,(l170) == 
SOC_VRF_MAX(l1)+1?"GLo":""));}while(0);}if(l342 == 0){LOG_CLI((BSL_META_U(l1,
"%9s\n"),"Specific VRF not found"));}else{LOG_CLI((BSL_META_U(l1,
"-----------------------------------------------\n")));do{LOG_CLI((BSL_META_U
(l1,"%9s  %02d.%d%%   %02d.%d%%   %02d.%d%%   |   %02d.%d%% \n"),"Total",((&
l394)->l367)?((&l394)->v4)*100/((&l394)->l367):0,((&l394)->l367)?((&l394)->v4
)*1000/((&l394)->l367)%10:0,((&l394)->l368)?((&l394)->v6_64)*100/((&l394)->
l368):0,((&l394)->l368)?((&l394)->v6_64)*1000/((&l394)->l368)%10:0,((&l394)->
l369)?((&l394)->v6_128)*100/((&l394)->l369):0,((&l394)->l369)?((&l394)->
v6_128)*1000/((&l394)->l369)%10:0,(((&l394)->l367+(&l394)->l368+(&l394)->l369
))?(((&l394)->v4+(&l394)->v6_64+(&l394)->v6_128))*100/(((&l394)->l367+(&l394)
->l368+(&l394)->l369)):0,(((&l394)->l367+(&l394)->l368+(&l394)->l369))?(((&
l394)->v4+(&l394)->v6_64+(&l394)->v6_128))*1000/(((&l394)->l367+(&l394)->l368
+(&l394)->l369))%10:0));}while(0);}}if(flags&SOC_ALPM_DEBUG_SHOW_FLAG_PVT){
l381(l1,l148,alpm_vrf_handle[l1],l375);}if(flags&SOC_ALPM_DEBUG_SHOW_FLAG_CNT
){l381(l1,l148,alpm_vrf_handle[l1],l372);l381(l1,l148,alpm_vrf_handle[l1],
l373);}if(flags&SOC_ALPM_DEBUG_SHOW_FLAG_INTDBG){l381(l1,l148,alpm_vrf_handle
[l1],l374);l381(l1,l148,alpm_vrf_handle[l1],l377);l381(l1,l148,
alpm_vrf_handle[l1],l376);}sal_free(l392);return SOC_E_NONE;}int
...
uint32 l14[SOC_MAX_MEM_FIELD_WORDS];uint32 l397[SOC_MAX_MEM_FIELD_WORDS];int
l398,l399,l400;defip_entry_t lpm_entry;int l271,l401;soc_mem_t l23;int l191,
l263,l402,l403;int l404 = 0;soc_field_t l405[2] = {VALID0f,VALID1f};
soc_field_t l406[2] = {GLOBAL_HIGH0f,GLOBAL_HIGH1f};soc_field_t l407[2] = {
ALG_BKT_PTR0f,ALG_BKT_PTR1f};l271 = soc_mem_index_min(l1,l260);l401 = 
soc_mem_index_max(l1,l260);if((index>= 0)&&(index<l271||index>l401)){return
SOC_E_PARAM;}else if(index>= 0){l271 = index;l401 = index;}SOC_ALPM_LPM_LOCK(
l1);for(l170 = l271;l170<= l401;l170++){SOC_ALPM_LPM_UNLOCK(l1);
...
l14,MODE0f);if(l9){l263 = 1;l23 = L3_DEFIP_ALPM_IPV6_64m;l402 = 16;}else{l263
= 2;l23 = L3_DEFIP_ALPM_IPV4m;l402 = 24;}for(l191 = 0;l191<l263;l191++){if(
soc_mem_field32_get(l1,l260,(void*)l14,l405[l191]) == 0||soc_mem_field32_get(
l1,l260,(void*)l14,l406[l191]) == 1){continue;}l403 = soc_mem_field32_get(l1,
l260,(void*)l14,l407[l191]);if(l191 == 1){soc_alpm_lpm_ip4entry1_to_0(l1,l14,
l397,PRESERVE_HIT);}else{soc_alpm_lpm_ip4entry0_to_0(l1,l14,l397,PRESERVE_HIT
);}l127 = soc_alpm_lpm_vrf_get(l1,l397,&l148,&l27);if(SOC_FAILURE(l127)){
continue;}if(SOC_ALPM_V6_SCALE_CHECK(l1,l9)){l402<<= 1;}l142 = -1;for(l257 = 
0;l257<l402;l257++){l127 = _soc_alpm_mem_index(l1,l23,l403,l257,l137,&l266);
...
void*)l14,VALIDf)){continue;}l127 = l26(l1,(void*)l14,l23,l9,l148,l403,0,&
lpm_entry);if(SOC_FAILURE(l127)){continue;}l127 = l146(l1,(void*)&lpm_entry,
l23,(void*)l14,&l398,&l399,&l400,FALSE);if(SOC_FAILURE(l127)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tLaunched AUX operation for "
"index %d bucket %d sanity check failed\n"),l170,l403));l404++;continue;}if(
l399!= l403){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"\tEntry at index %d does not belong ""to bucket %d(from bucket %d)\n"),l400,
l403,l399));l404++;}if(l142 == -1){l142 = l398;continue;}if(l142!= l398){int
l408,l409;l408 = soc_alpm_logical_idx(l1,l260,l142>>1,1);l409 = 
soc_alpm_logical_idx(l1,l260,l398>>1,1);LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U
(l1,"\tAliased bucket %d(returned "
"bucket %d) found from TCAM1 %d and TCAM2 %d\n"),l403,l399,l408,l409));l404++
;}}}}SOC_ALPM_LPM_UNLOCK(l1);if(l404 == 0){LOG_INFO(BSL_LS_SOC_ALPM,(
...
"encountered %d error(s)\n"),SOC_MEM_NAME(l1,l260),index,l404));return
SOC_E_FAIL;}int soc_alpm_pivot_sanity_check(int l1,soc_mem_t l260,int index){
int l170,l191,l285 = 0;int l266,l271,l401;int l127 = SOC_E_NONE;int*l410 = 
NULL;int l398,l399,l400;uint32 l14[SOC_MAX_MEM_FIELD_WORDS];int l130,l9 = 0,
l263 = 2;int l411,l412[2];soc_mem_t l413,l414;int l404 = 0;soc_field_t l405[2
...
= {ALG_BKT_PTR0f,ALG_BKT_PTR1f};l271 = soc_mem_index_min(l1,l260);l401 = 
soc_mem_index_max(l1,l260);if((index>= 0)&&(index<l271||index>l401)){return
SOC_E_PARAM;}else if(index>= 0){l271 = index;l401 = index;}l410 = sal_alloc(
sizeof(int)*MAX_PIVOT_COUNT,"Bucket index array");if(l410 == NULL){l127 = 
SOC_E_MEMORY;return l127;}sal_memset(l410,0xff,sizeof(int)*MAX_PIVOT_COUNT);
SOC_ALPM_LPM_LOCK(l1);for(l170 = l271;l170<= l401;l170++){SOC_ALPM_LPM_UNLOCK
...
l170,l127));l404++;continue;}l9 = soc_mem_field32_get(l1,l260,(void*)l14,
MODE0f);if(l9){l263 = 1;l414 = L3_DEFIP_ALPM_IPV6_64m;}else{l263 = 2;l414 = 
L3_DEFIP_ALPM_IPV4m;}for(l191 = 0;l191<l263;l191++){if(soc_mem_field32_get(l1
,l260,(void*)l14,l405[l191]) == 0||soc_mem_field32_get(l1,l260,(void*)l14,
l406[l191]) == 1){continue;}l130 = soc_mem_field32_get(l1,l260,(void*)l14,
l407[l191]);if(l130!= 0){if(l410[l130] == -1){l410[l130] = l170;}else{
...
,l260),l410[l130],l170));l404++;continue;}}l127 = alpm_bucket_is_assigned(l1,
...
SOC_MEM_NAME(l1,l260),l170));l404++;continue;}if(l127>= 0&&l285 == 0){
LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tFreed bucket pointer %d "
"detected, in memory %s index %d\n"),l130,SOC_MEM_NAME(l1,l260),l170));l404++
;continue;}l413 = _soc_trident2_alpm_bkt_view_get(l1,l130<<2);if(l414!= l413)
{LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tMismatched bucket entry memory "
"type in bucket %d, expected %s, actual"" %s\n"),l130,SOC_MEM_NAME(l1,l414),
SOC_MEM_NAME(l1,l413)));l404++;continue;}l411 = soc_mem_field32_get(l1,l260,(
void*)l14,l415[l191]);if(l191 == 1){l127 = soc_alpm_lpm_ip4entry1_to_0(l1,l14
,l14,PRESERVE_HIT);if(SOC_FAILURE(l127)){continue;}}l398 = -1;l127 = l146(l1,
l14,l414,(void*)l14,&l398,&l399,&l400,FALSE);if(l398 == -1){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tLaunched AUX operation for PIVOT "
"index %d sanity check failed\n"),l170));l404++;continue;}l266 = 
soc_alpm_logical_idx(l1,l260,l398>>1,1);l127 = soc_mem_read(l1,l260,
MEM_BLOCK_ANY,l266,(void*)l14);if(SOC_FAILURE(l127)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tRead memory %s index %d (nexthop) "
"return %d\n"),SOC_MEM_NAME(l1,l260),l266,l127));l404++;continue;}l412[0] = 
soc_mem_field32_get(l1,l260,(void*)l14,l415[0]);l412[1] = soc_mem_field32_get
(l1,l260,(void*)l14,l415[1]);if(l411!= l412[l398&1]){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tDefault nexthop was not populated "
"correctly, TCAM index1 %d entry1 %d, index2 %d ""entry2 %d\n"),l170,l191,
l266,l398&1));l404++;continue;}}}SOC_ALPM_LPM_UNLOCK(l1);sal_free(l410);if(
l404 == 0){LOG_INFO(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
...
),SOC_MEM_NAME(l1,l260),index,l404));return SOC_E_FAIL;}
#endif
#endif /* ALPM_ENABLE */
