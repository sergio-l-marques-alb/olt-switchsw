...
const soc_dfe_property_str_enum_t soc_dfe_property_str_enum_fabric_device_mode[] = {
    ...
    {soc_dfe_fabric_device_mode_multi_stage_fe13_asymmetric, "MULTI_STAGE_FE13_ASYMMETRIC"},
...
const soc_dfe_property_str_enum_t soc_dfe_property_str_enum_backplane_serdes_encoding[] = {
    {soc_dfe_port_pcs_8_9_legacy_fec,       "0"},
    {soc_dfe_port_pcs_8_10,                 "1"},
    {soc_dfe_port_pcs_64_66_fec,            "2"},
    {soc_dfe_port_pcs_64_66_bec,            "3"},
    {soc_dfe_port_pcs_64_66,                "4"},
    {soc_dfe_port_pcs_64_66_rs_fec,         "5"},
    {soc_dfe_port_pcs_64_66_ll_rs_fec,      "6"},
    {soc_dfe_port_pcs_64_66_fec,            "KR_FEC"},
    {soc_dfe_port_pcs_64_66,                "64_66"},
    {soc_dfe_port_pcs_64_66_rs_fec,         "RS_FEC"},
    {soc_dfe_port_pcs_64_66_ll_rs_fec,      "LL_RS_FEC"},
