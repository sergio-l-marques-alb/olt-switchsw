  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_vlan_add,(unit, out_port_ndx, vid_ndx, enable_mirror, success));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_eg_mirror_port_vlan_add_print,(unit,out_port_ndx,vid_ndx,enable_mirror));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_vlan_remove,(unit, out_port_ndx, vid_ndx));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_vlan_get,(unit, out_port_ndx, vid_ndx, enable_mirror));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_dflt_set,(unit, local_port_ndx, dflt_mirroring_info));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_eg_mirror_port_dflt_set_print,(unit,local_port_ndx,dflt_mirroring_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_dflt_get,(unit, local_port_ndx, dflt_mirroring_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(eg_mirror_port_info_get,(unit, local_port_ndx, info));
  ...
  )
{
  ...
  LOG_CLI((BSL_META_U(unit,
                      "dflt_mirroring_info:")));
  SOC_PPD_EG_MIRROR_PORT_DFLT_INFO_print((dflt_mirroring_info));
