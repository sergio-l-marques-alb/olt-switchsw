  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_mirror_port_vlan_add,(unit, local_port_ndx, vid_ndx, mirror_profile, success));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_mirror_port_vlan_remove,(unit, local_port_ndx, vid_ndx));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_mirror_port_vlan_get,(unit, local_port_ndx, vid_ndx, mirror_profile));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_mirror_port_dflt_set,(unit, local_port_ndx, dflt_mirroring_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_mirror_port_dflt_get,(unit, local_port_ndx, dflt_mirroring_info));
