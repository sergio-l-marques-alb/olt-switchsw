 ...
 * BCM88670 supports both Bridging over PWE and Routing over PWE
 *
 *
 ...
 * |                                                                                                     |
 * |      +---------------------+    +--------------------------------------+  +-----------------+       |
 * |      |  IP   | Ethr | Data |    | IP | Ethr | MPLS | PWE | Ethr | Data |  |IP | Ethr | Data |       |
 * |      +---------------------+    +--------------------------------------+  +-----------------+       | 
 * |                                                                                                     |
 * |                      +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+      |
...
struct cint_vswitch_vpls_roo_info_s {
    ...
    int out_to_core_vlan; /* vlan in Core direction */
...
vswitch_vpls_forward_group_mpls_port_create(int unit){
    ...
    /* Set parameters for egress mpls port */
    mpls_port_1.flags |= BCM_MPLS_PORT_FORWARD_GROUP/*|BCM_MPLS_PORT_CASCADED*/; 
