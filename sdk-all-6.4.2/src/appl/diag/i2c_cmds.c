...
typedef enum{
    ...
    G41,    /* BCM53416K, BCM53411K, BCM53406K */
    G42,    /* BCM56960k */
    ENG,    /* Special */
    UNK     /* Unknown */
} board_type_t;
...
soc_i2c_detect_board(void)
{
        ...
        for( id = 0; id < soc_i2c_device_count(dev); id++) {
            ...
            if ( i2c_dev ) {
                ...
                if (( i2c_dev->driver->id == LTC1427_DEVICE_TYPE) ||
                   (i2c_dev->driver->id == LTC388X_DEVICE_TYPE)) {
                    n_dac++;
                }
    ...
    else if ((soc_ndev > 0) && SOC_IS_GREYHOUND(0)) {
        /* Greyhound */
        board_type = G41;
    }
...
dac_params[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    {{0,"Core",  -1,1,0,0,LTC1427_MIN_DACVAL,LTC1427_MAX_DACVAL,LTC1427_MID_DACVAL,1},
     ...
     {3,"Analog",-1,1,0,0,LTC1427_MIN_DACVAL,LTC1427_MAX_DACVAL,LTC1427_MID_DACVAL,1},
     {0}},
    /* Greyhound SVK : ada G41 */
    {{0,"Core",-1,1,0,0,LTC3880_MIN_DACVAL,LTC3880_MAX_DACVAL,LTC3880_MID_DACVAL,1}},
...
bb_vs_config[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    {{0, "Core",  1 << MUX_0, "adc0", I2C_ADC_CH6, "dac0", DAC_UNCALIBRATED},
     ...
     {0}},
    /* Greyhound G41 */
    {{0, "Core", NO_MUX, I2C_LTC3880_62, I2C_ADC_CH0, I2C_LTC3880_62, DAC_UNCALIBRATED}},
...
bb_vs_all[NUM_BOARD_TYPES][MAX_VOLTAGES_PER_BOARD] = {
    ...
    /* Greyhound design : ada G41 */
    {{0, "CORE (Core)*       ", 0, I2C_LTC3880_62, I2C_ADC_CH0, NULL, 0}},
    /* Tomahawk design : aka G42 */
    {{ 0, "VDD_1V (Core)*    ", 0,          "adc0",      I2C_ADC_CH0,     NULL, 0},
     { 0, "VDD_2.5V (2.5)    ", 0,          "adc0",      I2C_ADC_CH1,     NULL, 0},
...
typedef enum {
    ...
    BCM953416K = 1,
    BCM953406K = 2,
    GH_BOARD_TYPE_NUMS = 3
} GH_BOARD_TYPE;

STATIC i2c_regulator_volt_dac_param_t gh_core_dac_param = {
    1050000, 850000   /* uV_max, uV_min */
};

STATIC i2c_regulator_volt_dac_param_t gh_3p3_dac_param = {
    3630000, 2970000  /* uV_max, uV_min */
};

STATIC i2c_regulator_volt_dac_param_t gh_2p5_dac_param = {
    2750000, 2250000  /* uV_max, uV_min */
};

STATIC i2c_regulator_volt_dac_param_t gh_1p8_dac_param = {
    1980000, 1620000  /* uV_max, uV_min */
};

STATIC i2c_regulator_volt_dac_param_t gh_1p5_dac_param = {
    1650000, 1350000 /* uV_max, uV_min */
};

STATIC i2c_regulator_volt_dac_param_t gh_1p0_dac_param = {
    1100000, 900000 /* uV_max, uV_min */
};

STATIC i2c_regulator_volt_config_t gh_vs_953411[] = {
    /* BCM953411K */
    {"3.3V", 0, I2C_LTC3880_60, I2C_LTC3880_60, NULL, &gh_3p3_dac_param},
    {"2.5V", 1, I2C_LTC3880_60, I2C_LTC3880_60, NULL, &gh_2p5_dac_param},
    {"1.8V", 0, I2C_LTC3880_61, I2C_LTC3880_61, NULL, &gh_1p8_dac_param},
    {"1.5V", 1, I2C_LTC3880_61, I2C_LTC3880_61, NULL, &gh_1p5_dac_param},
    {"Core", 0, I2C_LTC3880_62, I2C_LTC3880_62, NULL, &gh_core_dac_param},
    {"Analog", 1, I2C_LTC3880_62, I2C_LTC3880_62, NULL, &gh_1p0_dac_param},
    {"3.3V(EXT_IO)", 0, I2C_LTC3880_64, NULL, NULL, NULL},
    {"5V(EXT_IO)", 1, I2C_LTC3880_64, NULL, NULL, NULL},
    {"DDR_CORE", 0, I2C_LTC3880_65, I2C_LTC3880_65, NULL, &gh_1p0_dac_param},
    {"1.0V(EXTPHY_CORE)", 1, I2C_LTC3880_65, NULL, NULL, NULL}
};

STATIC i2c_regulator_volt_config_t gh_vs_953416[] = {
    /* BCM953416K */
    {"3.3V", 0, I2C_LTC3880_60, I2C_LTC3880_60, NULL, &gh_3p3_dac_param},
    {"2.5V", 1, I2C_LTC3880_60, I2C_LTC3880_60, NULL, &gh_2p5_dac_param},
    {"1.8V", 0, I2C_LTC3880_61, I2C_LTC3880_61, NULL, &gh_1p8_dac_param},
...
STATIC i2c_regulator_volt_config_t gh_vs_953406[] = {
    /* BCM953406K */
    {"3.3V", 0, I2C_LTC3880_60, I2C_LTC3880_60, NULL, &gh_3p3_dac_param},
    {"2.5V", 1, I2C_LTC3880_60, I2C_LTC3880_60, NULL, &gh_2p5_dac_param},
    {"1.8V", 0, I2C_LTC3880_61, I2C_LTC3880_61, NULL, &gh_1p8_dac_param},
...
STATIC int
bb_greyhound_get_board_type(int unit)
{
    ...
    if (board_name != NULL) {
        if (sal_strcmp(board_name, "BCM953406K") == 0) {
            board_type = BCM953406K;
        } else if (sal_strcmp(board_name, "BCM953411K") == 0) {
            board_type = BCM953411K;
        } else if (sal_strcmp(board_name, "BCM953416K") == 0) {
            board_type = BCM953416K;
        } else {
            LOG_WARN(BSL_LS_SOC_COMMON, (BSL_META_U(unit,"board_name = %s, supported board "
                            "names are BCM953406K, BCM953411K, "
                            "and BCM953416K.\nPlease define "
                            "board_name in config.bcm\n"),
                        board_name));
        }
    }
    else {
        LOG_WARN(BSL_LS_SOC_COMMON, (BSL_META_U(unit, "Please define board_name in "
                        "config.bcm, supported board names are "
                        "BCM953406K, BCM953411K, and BCM953416K.\n")));
    }
    return board_type;
}
...
STATIC int
bb_greyhound_regulator_volt_init(int unit, regulator_config_t *rcfg)
{
    int rv = SOC_E_NONE;
    i2c_regulator_volt_config_t *vcfgs;
    int board_type, vcfgs_num;
    regulator_volt_t *volt;

    rcfg->ptr = NULL;
    rcfg->table_size = 0;

    board_type = bb_greyhound_get_board_type(unit);
    if (board_type < 0) {
    ...
    switch(board_type) {
        case BCM953416K:
            vcfgs = gh_vs_953416;
            vcfgs_num = sizeof(gh_vs_953416)/sizeof(i2c_regulator_volt_config_t);
            break;
        case BCM953411K:
            vcfgs = gh_vs_953411;
            vcfgs_num = sizeof(gh_vs_953411)/sizeof(i2c_regulator_volt_config_t);
            break;
        case BCM953406K:
            vcfgs = gh_vs_953406;
            vcfgs_num = sizeof(gh_vs_953406)/sizeof(i2c_regulator_volt_config_t);
            break;
        default:
            return SOC_E_UNAVAIL;
    }
    ...
    if (volt != NULL) {
        volt->voltcfg_table = vcfgs;
        volt->voltcfg_table_size = vcfgs_num;
...
STATIC int
bb_greyhound_regulator_volt_deinit(int unit, regulator_config_t *rcfg)
{
...
STATIC int
bb_greyhound_regulator_callback(int unit, regulator_func_t func,
        regulator_type_t type, regulator_config_t *rcfg)
{
    int rv = SOC_E_PARAM;
    if (type == REGULATOR_TYPE_VOLT) {
        if (func == REGULATOR_FUNC_INIT) {
            rv = bb_greyhound_regulator_volt_init(unit, rcfg);
        } else if (func == REGULATOR_FUNC_DEINIT) {
            rv = bb_greyhound_regulator_volt_deinit(unit, rcfg);
        }
    }
    return rv;
}
...
/*
 * example of soc/common/regulator.c functions usage,
 * through bb voltage command
 */
STATIC int
bb_greyhound_voltage(int unit, int bx, char *source, char* value)
{
    int rv;
    void *vcfg;
    int cfg_num, i, uV, attr;
    char *name;
    void *hndl;

    rv = soc_regulator_init(unit, REGULATOR_TYPE_VOLT,
            bb_greyhound_regulator_callback, &hndl);
    if (rv != SOC_E_NONE) {
        cli_out("gh soc_regulator_init for "
                "REGULATOR_TYPE_VOLT failed (%s)\n", bcm_errmsg(rv));
        return CMD_FAIL;
    }
    if (source == NULL) {
        rv = soc_regulator_get_cfg_nums(unit, hndl, &cfg_num);
        if (rv != SOC_E_NONE) {
            goto err_cmd_fail;
        }
        for (i=0; i<cfg_num; i++) {
            rv = soc_regulator_get_voltcfg_and_name_by_index(unit, hndl, i,
                    &vcfg, &name);
            if (rv != SOC_E_NONE) {
                cli_out("failed to get index %d of "
                        "volt config\n", i);
                goto err_cmd_fail;
            }
            rv = soc_regulator_get_voltcfg_attribute(unit, hndl, vcfg, &attr);
            if (rv != SOC_E_NONE) {
                cli_out("failed to get volt attribute\n");
                goto err_cmd_fail;
            }
            if (IS_REGULATOR_VOLT_ABLE_TO_RD(attr)) {
                rv = soc_regulator_get_volt(unit, hndl, vcfg, &uV);
                if (rv != SOC_E_NONE) {
                    cli_out("%s : fail to get voltage(%s)\n",
                            name, bcm_errmsg(rv));
                    goto err_cmd_fail;
                }
                if (IS_REGULATOR_VOLT_ABLE_TO_WR(attr)) {
                    cli_out("VDD_%s* %s%d.%03d Volts \n",
                            name, uV >= 0 ? "  " : " ",
                            INT_FRAC_3PT_3(uV));
                } else {
                   cli_out("VDD_%s%s%d.%03d Volts\n",
        ...
        rv = soc_regulator_get_voltcfg_by_name(unit, hndl, source, &vcfg);
        if (rv != SOC_E_NONE) {
            goto err_cmd_usage;
        }
        rv = soc_regulator_get_voltcfg_attribute(unit, hndl, vcfg, &attr);
        ...
        if (!IS_REGULATOR_VOLT_ABLE_TO_WR(attr)) {
            cli_out("VDD_%s is not configurable\n",
                    source);
            goto err_cmd_fail;
        }
        if (value == NULL) {
            ...
            uV = _shr_atof_exp10(value, 6);
            if (uV > 0) {
                cli_out("Configuring voltage on [%s] to %duV\n",
                        source, uV);
                rv = soc_regulator_set_volt(unit, hndl, vcfg, uV);
                if (rv != SOC_E_NONE) {
                    cli_out( "%s : fail to set voltage(%s)\n",
                            source, bcm_errmsg(rv));
                    goto err_cmd_fail;
                }
                rv = soc_regulator_get_volt(unit, hndl, vcfg, &uV);
    ...
    soc_regulator_deinit(unit, hndl);
    return CMD_OK;
err_cmd_fail:
    return CMD_FAIL;
err_cmd_usage:
...
#undef BB_DEBUG
    ...
    if(!sal_strncasecmp(function,"voltage",sal_strlen(function))) {
        ...
        if (SOC_IS_GREYHOUND(unit)) {
            return bb_greyhound_voltage(unit, bx, source, value);
        }
#endif
        ...
        if( ! source){
            for(i = 0; i < bb_vs_all_len[bx]; i++){
                ...
                if (bb_vs_all[bx][i].flags == PWR_DAC_IO_SRC) {
                    /* Setting the Mux for reading voltage from LTC device */
         ...
         * associated DAC) open and ready for commands.
         */
        /* Lines from 6483-6504 looks repeatative */
        if (value) {
            /* Going to calibrate and/or set a voltage; open the correct DAC */
            if ( (dac = bcm_i2c_open(unit, bb_vs_config[bx][i].dac,
                            flags, 0)) < 0) {
