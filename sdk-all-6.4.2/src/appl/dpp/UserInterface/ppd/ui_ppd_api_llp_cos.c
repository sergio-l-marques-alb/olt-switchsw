                                 ...
                                 )
{
  ...
  SOC_PPD_LLP_COS_GLBL_INFO_clear(&prm_glbl_info);
                                 ...
                                 )
{
  ...
  SOC_PPD_LLP_COS_GLBL_INFO_print(&prm_glbl_info);
                                 ...
                                 )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_LLP_COS_PORT_INFO_clear(&prm_port_info);
                                 ...
                                 )
{
  ...
  SOC_PPD_LLP_COS_PORT_INFO_print(&prm_port_info);
  ...
  )
{
  uint32
    ret;
  SOC_PPD_LLP_COS_MAPPING_TABLE
    prm_mapping_tbl_ndx;
  uint32
    prm_table_id_ndx;
  uint32
    prm_entry_ndx;
  SOC_PPD_LLP_COS_MAPPING_TABLE_ENTRY_INFO
    prm_entry;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_LLP_COS_MAPPING_TABLE_ENTRY_INFO_clear(&prm_entry);
  ...
  )
{
  ...
  SOC_PPD_LLP_COS_MAPPING_TABLE_ENTRY_INFO_print(&prm_entry);
  ...
  )
{
  ...
  uint32
    prm_range_ndx;
  SOC_PPD_LLP_COS_L4_PORT_RANGE_INFO
    prm_range_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_LLP_COS_L4_PORT_RANGE_INFO_clear(&prm_range_info);
  ...
  )
{
  ...
  SOC_PPD_LLP_COS_L4_PORT_RANGE_INFO_print(&prm_range_info);
  ...
  )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_LLP_COS_TC_INFO_clear(&prm_tc_info);
  ...
  )
{
  ...
  SOC_PPD_LLP_COS_TC_INFO_print(&prm_tc_info);
  ...
  )
{
  ...
  SOC_SAND_PP_IPV4_SUBNET
    prm_subnet_key;
  SOC_PPD_LLP_COS_IPV4_SUBNET_INFO
  ...
  SOC_PPD_LLP_COS_IPV4_SUBNET_INFO_clear(&prm_subnet_based_info);
  ...
  )
{
  ...
  SOC_PPD_LLP_COS_IPV4_SUBNET_INFO_print(&prm_subnet_based_info);
                                      ...
                                      )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_LLP_COS_PRTCL_INFO_clear(&prm_prtcl_assign_info);
                                      ...
                                      )
{
  ...
  SOC_PPD_LLP_COS_PRTCL_INFO_print(&prm_prtcl_assign_info);
