...
#define BCM_COSQ_GPORT_VSQ_CT_SET(_gport, _core_id, _category)  \
    (_SHR_COSQ_GPORT_VSQ_CT_SET(_gport, _core_id, _category)) 

#define BCM_COSQ_GPORT_IS_VSQ_CT(_gport)  \
    (_SHR_COSQ_GPORT_IS_VSQ_CT(_gport)) 

#define BCM_COSQ_GPORT_VSQ_CTTC_SET(_gport, _core_id, _category, _traffic_class)  \
    (_SHR_COSQ_GPORT_VSQ_CTTC_SET(_gport, _core_id, _category, _traffic_class)) 

#define BCM_COSQ_GPORT_IS_VSQ_CTTC(_gport)  \
    (_SHR_COSQ_GPORT_IS_VSQ_CTTC(_gport)) 

#define BCM_COSQ_GPORT_VSQ_CTCC_SET(_gport, _core_id, _category, _connection_class)  \
    (_SHR_COSQ_GPORT_VSQ_CTCC_SET(_gport, _core_id, _category, _connection_class)) 

#define BCM_COSQ_GPORT_IS_VSQ_CTCC(_gport)  \
    (_SHR_COSQ_GPORT_IS_VSQ_CTCC(_gport)) 

#define BCM_COSQ_GPORT_VSQ_PP_SET(_gport, _statistics_tag)  \
    (_SHR_COSQ_GPORT_VSQ_PP_SET(_gport, _statistics_tag)) 

#define BCM_COSQ_GPORT_IS_VSQ_PP(_gport)  \
    (_SHR_COSQ_GPORT_IS_VSQ_PP(_gport)) 

#define BCM_COSQ_GPORT_VSQ_SRC_PORT_SET(_gport, _src_port_vsq_id)  \
    (_SHR_COSQ_GPORT_VSQ_SRC_PORT_SET(_gport, _src_port_vsq_id)) 

#define BCM_COSQ_GPORT_IS_VSQ_SRC_PORT(_gport)  \
    (_SHR_COSQ_GPORT_IS_VSQ_SRC_PORT(_gport)) 

#define BCM_COSQ_GPORT_VSQ_PG_SET(_gport, _pg_vsq_id)  \
    (_SHR_COSQ_GPORT_VSQ_PG_SET(_gport, _pg_vsq_id)) 
...
typedef enum bcm_forwarding_type_e {
    bcmForwardingTypeL2 = 0,            /* L2 switching forwarding. */
    bcmForwardingTypeIp4Ucast = 1,      /* IPv4 Unicast Routing forwarding. */
    bcmForwardingTypeIp4Mcast = 2,      /* IPv4 Multicast Routing forwarding. */
    bcmForwardingTypeIp6Ucast = 3,      /* IPv6 Unicast Routing forwarding. */
    bcmForwardingTypeIp6Mcast = 4,      /* IPv6 Multicast Routing forwarding. */
    bcmForwardingTypeMpls = 5,          /* MPLS Switching forwarding. */
    bcmForwardingTypeTrill = 6,         /* Trill forwarding. */
    bcmForwardingTypeRxReason = 7,      /* Forwarding according to a RxReason. */
    bcmForwardingTypeTrafficManagement = 8, /* Traffic Management forwarding, when
                                           an external Packet Processor sets the
                                           forwarding decision. */
    bcmForwardingTypeSnoop = 9,         /* Snooped packet. */
    bcmForwardingTypeFCoE = 10,         /* Fiber Channel over Ethernet
                                           forwarding. */
    bcmForwardingTypeCount = 11         /* Always Last. Not a usable value. */
