...
#define _BCM_PETRA_L3_NOF_ITFS (4096)
...
typedef struct _bcm_tunnel_bookkeeping_s {
    int *egress_tunnel_id;
    int *vsi_usage;
} _bcm_dpp_tunnel_bookkeeping_t;
...
typedef struct bcm_dpp_l3_state_s {
    ...
    sal_mutex_t lock;
    int         urpf_mode;
    _bcm_dpp_tunnel_bookkeeping_t _bcm_dpp_tunnel_bk_info;
    int *_bcm_tunnel_intf_to_eep;         /* The associated EEP per interface */
