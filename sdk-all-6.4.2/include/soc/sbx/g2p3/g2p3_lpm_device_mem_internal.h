...
/*
 * $Id: g2p3_lpm_device_mem_internal.h,v 1.4 Broadcom SDK $
 *
...
typedef struct g2p3_lpmDeviceMem_s {
    ...
    uint32  *infoArr;           /* ---- Block management info (sizes, next-links, etc.) */
    uint32  *reverseLinkInfoArr; /* reverse link management info(sizes, prev-links, etc.) */
