...
enum drc_reg_set {
    ...
    DRC_CALIB_BIST_DBI_ERROR_OCCURREDr,
    DRC_CALIB_BIST_DBI_FULL_MASK_ERROR_COUNTERr,
    ...
    /* DRC_GLOBALF - found only in DRCA to DRCD causes accumulated offset of 1 */
    ...
    DRC_PERIODIC_DRAM_TEMP_SENS_CFGr,
    DRC_PERIODIC_DRAM_TEMP_SENS_STATUSr,
    DRC_PERIODIC_PHY_CDR_MONITOR_CFGr,
    DRC_PERIODIC_PHY_CDR_MONITOR_STATUSr,
    DRC_PHY_CALIBRATIONr,
    DRC_PHY_CALIBRATION_CFGr,
    DRC_PHY_CALIBRATION_CTRLr,
    DRC_PHY_CALIBRATION_RES_FIFO_CFGr,
    ...
    DRC_REG_0091r,
    DRC_REG_0092r,
    /* DRC_REG_0093 - found only in DRCA to DRCD causes accumulated offset of 2 */
    DRC_REG_0209r,
    DRC_REG_0210r,
    DRC_REG_0211r,
    DRC_REG_0212r,
    DRC_REG_0242r,
    DRC_REG_0243r,
    /* DRC_REG_00AF - found only in DRCA to DRCD causes accumulated offset of 3 */
    DRC_REG_00B0r,
    DRC_REG_00B1r,
    DRC_REG_00B2r,
    DRC_REG_00B3r,
    ...
    DRC_REG_020Fr,
    DRC_REG_021Cr,
    DRC_RESERVED_MIRROR_ADDRr,
    DRC_RESERVED_MTCDr,
    DRC_RESERVED_MTCPr,
    DRC_RESERVED_PCMI_0_Sr,
    DRC_RESERVED_PCMI_0_Tr,
    DRC_RESERVED_PCMI_1_Sr,
    DRC_RESERVED_PCMI_1_Tr,
    DRC_RESERVED_PCMI_2_Sr,
    DRC_RESERVED_PCMI_2_Tr,
    DRC_RESERVED_PCMI_3_Sr,
    DRC_RESERVED_PCMI_3_Tr,
    DRC_RESERVED_PCMI_4_Sr,
    DRC_RESERVED_PCMI_4_Tr,
    DRC_RESERVED_SPARE_0r,
    DRC_RESERVED_SPARE_1r,
    DRC_RESERVED_SPARE_2r,
    DRC_RESERVED_SPARE_3r,
