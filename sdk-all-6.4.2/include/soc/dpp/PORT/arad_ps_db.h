...
int arad_ps_db_find_free_binding_ps(int unit, soc_port_t port, int out_port_priority, int* base_q_pair);
int arad_ps_db_alloc_binding_ps_with_id(int unit, soc_port_t port, int out_port_priority, int base_q_pair);
int arad_ps_db_find_free_non_binding_ps(int unit, int core, int* base_q_pair);
