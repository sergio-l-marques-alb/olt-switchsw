...
#define SOC_PPD_FRWRD_FCF_ZONE_REMOVE_BY_VFT SOC_PPC_FRWRD_FCF_ZONE_REMOVE_BY_VFT
/* remove entries match D_ID */
#define SOC_PPD_FRWRD_FCF_ZONE_REMOVE_BY_D_ID SOC_PPC_FRWRD_FCF_ZONE_REMOVE_BY_D_ID
...
typedef SOC_PPC_FRWRD_FCF_VFI     SOC_PPD_FRWRD_FCF_VFI;



typedef SOC_PPC_FRWRD_FCF_ROUTE_STATUS                          SOC_PPD_FRWRD_FCF_ROUTE_STATUS;

typedef SOC_PPC_FRWRD_FCF_GLBL_INFO                    SOC_PPD_FRWRD_FCF_GLBL_INFO;
typedef SOC_PPC_FRWRD_FCF_ROUTE_KEY                    SOC_PPD_FRWRD_FCF_ROUTE_KEY;
typedef SOC_PPC_FRWRD_FCF_ROUTE_INFO                   SOC_PPD_FRWRD_FCF_ROUTE_INFO;
typedef SOC_PPC_FRWRD_FCF_ZONING_KEY                   SOC_PPD_FRWRD_FCF_ZONING_KEY;
typedef SOC_PPC_FRWRD_FCF_ZONING_INFO                  SOC_PPD_FRWRD_FCF_ZONING_INFO;
 ...
 *   SOC_SAND_OUT SOC_PPD_FRWRD_FCF_ROUTE_INFO      *routing_info -
 ...
 *   SOC_SAND_IN  int                               unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPD_FRWRD_FCF_VFI                vfi -
