...
soc_error_t arad_link_control_strip_crc_set(int unit, bcm_port_t port, int strip_crc);
soc_error_t arad_link_control_strip_crc_get(int unit, bcm_port_t port, int* strip_crc);
soc_error_t arad_link_control_rx_enable_set(int unit, bcm_port_t port, int enable);
soc_error_t arad_link_control_tx_enable_set(int unit, bcm_port_t port, int enable);
soc_error_t arad_link_control_rx_enable_get(int unit, bcm_port_t port, int* enable);
soc_error_t arad_link_control_tx_enable_get(int unit, bcm_port_t port, int* enable);
