/* $Id: sand_pp_ipv4_lpm_mngr.h,v 1.6 Broadcom SDK $
...
#ifndef __SOC_SAND_PP_IPV4_LPM_INCLUDED__
/* { */
#define __SOC_SAND_PP_IPV4_LPM_INCLUDED__
...
*************/
/* { */
typedef SOC_SAND_U64 SOC_SAND_PP_IPV4_LPM_MNGR_INST;

/* $Id: sand_pp_ipv4_lpm_mngr.h,v 1.6 Broadcom SDK $
 * LPM model
 */
typedef enum {
  SOC_SAND_PP_IPV4_LPM_PXX_MODEL_UNKNOWN = 0,
  SOC_SAND_PP_IPV4_LPM_PXX_MODEL_P4X = 1,
  SOC_SAND_PP_IPV4_LPM_PXX_MODEL_P6X = 2,
  SOC_SAND_PP_IPV4_LPM_PXX_MODEL_P6N = 3,
  SOC_SAND_PP_IPV4_LPM_PXX_MODEL_P4X_COMPLETE = 4
} SOC_SAND_PP_IPV4_LPM_PXX_MODEL;


/*********************************************************************
* NAME:
*     SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_TREE_NODE_INFO_SET
* FUNCTION:
...
typedef
  uint32
    (*SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_MEM_ALLOCATOR_GET)(
      SOC_SAND_IN  uint32                      prime_handle,
...
typedef
  uint32
    (*SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_PAT_TREE_GET)(
      SOC_SAND_IN  uint32                      prime_handle,
      SOC_SAND_IN  uint32                      sec_handle,
      SOC_SAND_IN  uint32                      vrf_ndx,
      SOC_SAND_OUT SOC_SAND_PAT_TREE_INFO            **pat_tree
...
typedef
  uint32
    (*SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_NOF_ENTRIES_FOR_HW_LPM_SET_FUN)(
...
typedef
  uint32
    (*SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_NOF_ENTRIES_FOR_HW_LPM_GET_FUN)(
      SOC_SAND_IN  int                    unit,
...
typedef struct {
 ...
 /* primary handle of the LPM manager to identify the LPM manager instance */
  ...
  /* p6x, p4x, p6n, etc. */
  SOC_SAND_PP_IPV4_LPM_PXX_MODEL pxx_model;
  ...
  SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_MEM_ALLOCATOR_GET mem_alloc_get_fun;
/*  pat_tree_get_fun maps from VRF to PAT tree instance */
  SOC_SAND_PP_IPV4_LPM_MNGR_SW_DB_PAT_TREE_GET pat_tree_get_fun;
...
} SOC_SAND_PP_IPV4_LPM_MNGR_INIT_INFO;
...
typedef struct
{
  ...
  SOC_SAND_PP_IPV4_LPM_MNGR_T
    data_info;
} SOC_SAND_PP_IPV4_LPM_MNGR_INFO;
...
typedef struct {
  ...
  uint32  prefix_nodes;
  uint32  free_nodes;
} SOC_SAND_PP_IPV4_LPM_MNGR_STATUS;

/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_create
* FUNCTION:
*  Create LPM manager instance.
* INPUT:
*  SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO  *lpm_mngr -
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_vrf_init
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_vrf_clear
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_all_vrfs_clear
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_clear
* FUNCTION:
...
*     OK or ERROR indication.
*********************************************************************/
uint32 soc_sand_pp_ipv4_lpm_mngr_clear(
  SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO  *lpm_mngr
);

/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_destroy
* FUNCTION:
...
/*********************************************************************
* NAME:
 *   soc_sand_pp_ipv4_lpm_mngr_hw_sync
 * TYPE:
 *   PROC
 * FUNCTION:
...
/*********************************************************************
* NAME:
*   soc_sand_pp_ipv4_lpm_mngr_mark_non_lpm_route_pending_type_set
* TYPE:
*   PROC
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_prefix_add
* FUNCTION:
*  Add route to VRF.
* INPUT:
*  SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO  *lpm_mngr -
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_prefix_remove
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_prefix_lookup
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_prefix_is_exist
* FUNCTION:
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_sys_fec_get
* FUNCTION:
...
*     OK or ERROR indication.
*********************************************************************/
uint32 soc_sand_pp_ipv4_lpm_mngr_sys_fec_get(
  SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO  *lpm_mngr,
  SOC_SAND_IN  uint32                     vrf_ndx,
  SOC_SAND_IN  SOC_SAND_PP_IPV4_SUBNET           *key,
...
/*********************************************************************
* NAME:
*     soc_sand_pp_ipv4_lpm_mngr_get_stat
* FUNCTION:
...
uint32
  soc_sand_pp_ipv4_lpm_mngr_get_stat(
    SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO   *lpm_mngr,
    SOC_SAND_IN  uint32                      vrf_ndx,
    SOC_SAND_OUT  SOC_SAND_PP_IPV4_LPM_MNGR_STATUS  *lpm_stat
  );


uint32
  soc_sand_pp_ipv4_lpm_mngr_get_block(
    SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO  *lpm_mngr,
    SOC_SAND_IN  uint32                     vrf_ndx,
...
void
  soc_sand_pp_SAND_PP_IPV4_LPM_MNGR_INFO_clear(
    SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_INFO  *info
  );

void
  soc_sand_pp_SAND_PP_IPV4_LPM_MNGR_STATUS_clear(
    SOC_SAND_INOUT  SOC_SAND_PP_IPV4_LPM_MNGR_STATUS  *info
  );
...
/* } __SOC_SAND_PP_IPV4_LPM_INCLUDED__*/
#endif
