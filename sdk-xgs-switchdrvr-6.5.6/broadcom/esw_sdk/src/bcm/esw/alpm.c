 ...
 */
STATIC int
_bcm_esw_alpm_lpm_vrf_init(int unit, _bcm_defip_cfg_t *lpm_cfg,
 ...
 */
STATIC void
_bcm_esw_alpm_lpm64_key_init(int unit, _bcm_defip_cfg_t *lpm_cfg,
 ...
 */
STATIC int
_bcm_esw_alpm_lpm_init(int unit, _bcm_defip_cfg_t *lpm_cfg,
                       defip_entry_t *lpm_entry, int nh_ecmp_idx, uint32 *flags)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_esw_alpm_lpm_vrf_init(unit, lpm_cfg, &vrf_id, &vrf_mask));
    ...
    if (ipv6) {
        ...
        _bcm_esw_alpm_lpm64_key_init(unit, lpm_cfg, lpm_entry);
...
/*
 * Function:
 *     _bcm_esw_alpm_lpm128_addr_init
 * Purpose:
 ...
 */
STATIC void
_bcm_esw_alpm_lpm128_addr_init(int unit, soc_mem_t mem, uint32 *entry,
...
/*
 * Function:
 *     _bcm_esw_alpm_lpm128_mask_init
 * Purpose:
 ...
 */
STATIC void
_bcm_esw_alpm_lpm128_mask_init(int unit, soc_mem_t mem, uint32 *entry,
                               const ip6_addr_t ip6)
{
    uint32              ip6_field[4];
    ip6_field[3] = ((ip6[12] << 24)| (ip6[13] << 16) |
...
STATIC int
_bcm_esw_alpm_lpm128_init(int unit, _bcm_defip_cfg_t *lpm_cfg,
             defip_pair_128_entry_t *lpm_entry, int nh_ecmp_idx, uint32 *flags)
{
    ...
    /* Set prefix ip address & mask. */
    _bcm_esw_alpm_lpm128_addr_init(unit, L3_DEFIP_PAIR_128m,
                                      (uint32 *)lpm_entry, 
                                      lpm_cfg->defip_ip6_addr);

    _bcm_esw_alpm_lpm128_mask_init(unit, L3_DEFIP_PAIR_128m,
 ...
 */
STATIC void
_bcm_esw_alpm_lpm64_key_parse(int unit, const void *lpm_key,
 ...
 */
STATIC void
_bcm_esw_alpm_lpm_key_parse(int unit, _bcm_defip_cfg_t *lpm_cfg,
                            defip_entry_t *lpm_entry)
{
    ...
    /* Set prefix ip address & mask. */
    if (ipv6) {
        _bcm_esw_alpm_lpm64_key_parse(unit, lpm_entry, lpm_cfg);
    } else {
        /* Get ipv4 address. */
        lpm_cfg->defip_ip_addr =
 ...
 */
STATIC INLINE void
_bcm_esw_alpm_lpm_data_parse(int unit, _bcm_defip_cfg_t *lpm_cfg,
                             int *nh_ecmp_idx, defip_entry_t *lpm_entry)
{
    ...
    if (soc_feature(unit, soc_feature_ipmc_defip) &&
        ...
        lpm_cfg->defip_mc_group = soc_L3_DEFIPm_field32_get(unit,
...
/*
 * Function:
 *     _bcm_esw_alpm_lpm128_mask_parse
 * Purpose:
 ...
 */
STATIC void
_bcm_esw_alpm_lpm128_mask_parse(int unit, soc_mem_t mem, const void *entry,
                                ip6_addr_t ip6)
{
    uint32              ip6_field[4];
...
/*
 * Function:
 *     _bcm_esw_alpm_lpm128_addr_parse
 * Purpose:
 ...
 */
STATIC void
_bcm_esw_alpm_lpm128_addr_parse(int unit, soc_mem_t mem, const void *entry,
                                ip6_addr_t ip6)
{
    uint32              ip6_field[4];
 ...
 */
STATIC int
_bcm_esw_alpm_lpm128_key_parse(int unit, uint32 *hw_entry,
                               _bcm_defip_cfg_t *lpm_cfg)
{
    ...
    /* Extract ip6 address. */
    _bcm_esw_alpm_lpm128_addr_parse(unit, mem, hw_entry,
                                      lpm_cfg->defip_ip6_addr);

    /* Extract subnet mask. */
    _bcm_esw_alpm_lpm128_mask_parse(unit, mem, hw_entry, mask);
    lpm_cfg->defip_sub_len = bcm_ip6_mask_length(mask);
...
STATIC INLINE void
_bcm_esw_alpm_lpm128_data_parse(int unit, _bcm_defip_cfg_t *lpm_cfg,
 ...
 */
STATIC void
_bcm_esw_alpm_ent64_key_parse(int unit, const void *alpm_key, soc_mem_t mem,
                              _bcm_defip_cfg_t *lpm_cfg)
{
    uint8 *ip6;                 /* Ip6 address.       */
    uint8 mask[BCM_IP6_ADDRLEN];        /* Subnet mask.       */
 ...
 */
STATIC void
_bcm_esw_alpm_ent_key_parse(int unit, _bcm_defip_cfg_t *lpm_cfg,
                            ...
                            void *alpm_entry)
{
    ...
    /* Set prefix ip address & mask. */
    if (ipv6) {
        _bcm_esw_alpm_ent64_key_parse(unit, alpm_entry, alpm_mem, lpm_cfg);
    } else {
        /* Get ipv4 address. */
 ...
 */
STATIC void
_bcm_esw_alpm_ent_data_parse(int unit, _bcm_defip_cfg_t *lpm_cfg, int *nh_ecmp_idx,
                             soc_mem_t alpm_mem, void *alpm_entry)
{
   ...
   /*hurricane does not have ecmp flag*/
    if (soc_mem_field32_get(unit, alpm_mem, alpm_entry, ECMPf)) {
        /* Mark entry as ecmp */
        lpm_cfg->defip_ecmp = 1;
        lpm_cfg->defip_flags |= BCM_L3_MULTIPATH;
...
STATIC int
_bcm_esw_alpm_ent128_key_parse(int unit, soc_mem_t mem, uint32 *alpm_entry,
                               _bcm_defip_cfg_t *lpm_cfg)
{
    uint32 ip6_word[4];
...
STATIC int
_bcm_esw_alpm_ent128_data_parse(int unit, soc_mem_t mem, uint32 *hw_entry,
...
int
_bcm_esw_alpm_warmboot_db_type_update(int unit)
{
    int rv = BCM_E_NONE;
        ...
        if (valid) {
            ...
            if (db_type > 0) { /* > 0 means Private routes */
                ...
                if (db_type != ndb_type) {
                    ...
                    soc_mem_field32_set(unit, mem, aux_entry, ENTRY_TYPE0f, nent_type);
                    updated = 1;
                }
            }
        }
        ...
        if (valid) {
            ...
            if (db_type > 0) { /* > 0 means Private routes */
                ...
                if (db_type != ndb_type) {
                    ...
                    soc_mem_field32_set(unit, mem, aux_entry, ENTRY_TYPE1f, nent_type);
                    updated = 1;
                }
            }
        }
 ...
 */
STATIC int
_bcm_esw_alpm_warmboot_walk(int unit, _bcm_l3_trvrs_data_t *trv_data)
{
    int ipv6;                   /* IPv6 flag.                   */
    int idx;                    /* Iteration index.             */
    ...
    int alpm_bkt_bits = SOC_ALPM_BUCKET_BITS(unit);

    defip_alpm_ipv4_1_entry_t    alpm_entry_v4;
    defip_alpm_ipv6_64_1_entry_t alpm_entry_v6_64;


    _bcm_esw_alpm_warmboot_db_type_update(unit);
    ...
    bank_count = soc_alpm_cmn_banks_get(unit);
    ...
    for (idx = 0; idx < idx_end; idx++) {
        ...
        for (tmp_idx = 0; tmp_idx < step_count; tmp_idx++) {
            ...
            bank_disable = soc_th_alpm_bank_dis(unit, vrf);
            ...
            if (bkt_ptr == 0) {
                ...
                _bcm_esw_alpm_lpm_data_parse(unit, &lpm_cfg, &nh_ecmp_idx,
                                            lpm_entry);
                _bcm_esw_alpm_lpm_key_parse(unit, &lpm_cfg, lpm_entry);
            ...
            for (bkti = 0; bkti < bkt_count; bkti++) {
                ...
                soc_alpm_cmn_bkt_view_set(unit, bkt_addr, alpm_mem);

                /* Zero destination buffer first. */
                sal_memset(&lpm_cfg, 0, sizeof(_bcm_defip_cfg_t));

                /* Parse the entry. */
                _bcm_esw_alpm_ent_data_parse(unit, &lpm_cfg, &nh_ecmp_idx,
                                        alpm_mem, alpm_entry);
...
/*
 * Function:
 *      _bcm_esw_alpm_128_warmboot_walk
 * Purpose:
 ...
 */
STATIC int
_bcm_esw_alpm_128_warmboot_walk(int unit, _bcm_l3_trvrs_data_t *trv_data)
{
    ...
    for (idx = 0; idx < idx_end; idx++) {
        ...
        for (tmp_idx = 0; tmp_idx < step_count; tmp_idx++) {
            ...
            if (bkt_ptr == 0) {
                ...
                sal_memset(&lpm_cfg, 0, sizeof(_bcm_defip_cfg_t));
                (void) _bcm_esw_alpm_lpm128_key_parse(unit, (uint32 *)lpm_entry,
                                                     &lpm_cfg);
                (void) soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry,
                                            &lpm_cfg.defip_vrf, &nh_ecmp_idx);
                _bcm_esw_alpm_lpm128_data_parse(unit, &lpm_cfg, &nh_ecmp_idx, lpm_entry);
                lpm_cfg.defip_index = idx;
                if (trv_data->op_cb) {
                    (void) (*trv_data->op_cb)(unit, (void *)trv_data,
                                              (void *)&lpm_cfg,
            ...
            for (bkti = 0; bkti < bkt_count; bkti++) {
                ...
                _bcm_esw_alpm_ent128_key_parse(unit, alpm_mem, alpm_entry, &lpm_cfg);

                (void)soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry, &lpm_cfg.defip_vrf, &vrf);
                /* get associated data */
                _bcm_esw_alpm_ent128_data_parse(unit, alpm_mem, alpm_entry,
                                            &lpm_cfg, &nh_ecmp_idx);
...
STATIC int
_bcm_esw_alpm_128_update_match(int unit, _bcm_l3_trvrs_data_t *trv_data)
{
    ...
    for (idx = (idx_end - 1); idx >= idx_start; idx--) {    
        ...
        for (tmp_idx = 0; tmp_idx < step_count; tmp_idx++) {
            ...
            (void)soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry, &lpm_cfg.defip_vrf,
                                              &cmp_result);
            bank_disable = soc_th_alpm_bank_dis(unit, cmp_result);
    ...
    for (idx = 0; idx < def_arr_idx; idx++) {
        ...
        (void)soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry, &lpm_cfg.defip_vrf,
                                          &cmp_result);
        _bcm_esw_alpm_ent128_data_parse(unit, alpm_mem, alpm_entry, &lpm_cfg,
                                    &nh_ecmp_idx);
 ...
 */
int
_bcm_esw_alpm_update_match(int unit, _bcm_l3_trvrs_data_t *trv_data)
{
    ...
    if (SOC_WARM_BOOT(unit)) {
        rv =_bcm_esw_alpm_warmboot_walk(unit, trv_data);
        if (rv < 0) {
        ...
        if (soc_mem_index_count(unit, L3_DEFIP_PAIR_128m) != 0) {
            /* v6-128 entries */
            rv = _bcm_esw_alpm_128_warmboot_walk(unit, trv_data);
            if (rv < 0) {
                LOG_ERROR(BSL_LS_SOC_ALPM,
                         (BSL_META_U(unit,
    ...
    if (ipv6 && soc_mem_index_count(unit, L3_DEFIP_PAIR_128m) != 0) {
        ...
        rv = _bcm_esw_alpm_128_update_match(unit, trv_data);
#ifdef BCM_CB_ABORT_ON_ERR
        if (BCM_FAILURE(rv) && SOC_CB_ABORT_ON_ERR(unit)) {
            return rv;
        }
    ...
    for (idx = (idx_end - 1); idx >= idx_start; idx--) {
        ...
        for (tmp_idx = tmp_start; tmp_idx != tmp_end; tmp_idx += tmp_delta) {
            ...
            for (bkt_idx = 0; bkt_idx < bkt_count; bkt_idx++) {
                ...
                /* Fill entry IP address and subnet mask. */
                _bcm_esw_alpm_ent_key_parse(unit, &lpm_cfg, lpm_entry,
                                          alpm_mem, alpm_entry);
 ...
 */
int
_bcm_esw_alpm_find(int unit, _bcm_defip_cfg_t *lpm_cfg, int *nh_ecmp_idx)
{
    ...
    case L3_DEFIP_PAIR_128m:
        /* Initialize lkup key. */
        BCM_IF_ERROR_RETURN(_bcm_esw_alpm_lpm128_init(unit, lpm_cfg,
                                            &lpm_128_key, 0, &flags));
        /* Perform hw lookup. */
        ...
        _bcm_esw_alpm_lpm128_data_parse(unit, lpm_cfg, nh_ecmp_idx, &lpm_128_entry);
        /* OVERRIDE VRF Processing */
        _bcm_esw_alpm_lpm128_key_parse(unit, (uint32 *)&lpm_128_entry, lpm_cfg);
        soc_th_alpm_128_lpm_vrf_get(unit, &lpm_128_entry, &lpm_cfg->defip_vrf, &tmp);

        break;
    default:
        /* Initialize lkup key. */
        BCM_IF_ERROR_RETURN(_bcm_esw_alpm_lpm_init(unit, lpm_cfg, &lpm_key, 0,
                                                   &flags));
        /* Perform hw lookup. */
        ...
        /* Parse hw buffer to defip entry. */
        _bcm_esw_alpm_lpm_data_parse(unit, lpm_cfg, nh_ecmp_idx, &lpm_entry);
        _bcm_esw_alpm_lpm_key_parse(unit, lpm_cfg, &lpm_entry);
