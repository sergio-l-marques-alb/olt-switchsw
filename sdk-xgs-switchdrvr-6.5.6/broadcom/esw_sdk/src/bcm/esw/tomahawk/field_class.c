                          ...
                          uint32 valid_bit)
{
    ...
    static const soc_mem_t src_class_mem[] = {
                                ...
                                /* SOC Per Pipe Memory.               */
    static const soc_mem_t dst_class_mem[] = {
    ...
    if (valid_bit > 1) {
     ...
     /*VALIDf in SRC_COMPRESSIONm and DST_COMPRESSIONm is two bit wide on TH2.*/
    if (valid_bit == 1 && SOC_IS_TOMAHAWK2(unit)) {
        valid_bit = 3;
    }
