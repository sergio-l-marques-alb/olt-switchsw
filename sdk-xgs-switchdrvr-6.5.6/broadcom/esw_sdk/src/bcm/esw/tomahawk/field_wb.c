...
/*
 * Function:
 *      _field_wb_em_timestamp_set_recover
 * Purpose:
 ...
 */
int
_field_wb_em_timestamp_set_recover(int unit, _field_entry_t *f_ent,
                                      uint32 *ebuf)
{
    _bcm_field_action_offset_t a_offset;
    _field_action_t *f_act = NULL, *prev_act = NULL;
...
/*
 * Function:
 *      _field_wb_em_instrumentation_set_recover
 * Purpose:
 ...
 */
int
_field_wb_em_instrumentation_set_recover(int unit, _field_entry_t *f_ent,
                                      uint32 *ebuf)
{
    _bcm_field_action_offset_t a_offset;
    _field_action_t *f_act = NULL, *prev_act = NULL;
...
/*
 * Function:
 *      _field_wb_em_dlb_hgt_lag_set_recover
 * Purpose:
 ...
 */
int
_field_wb_em_dlb_hgt_lag_set_recover(int unit, _field_entry_t *f_ent,
                                      uint32 *ebuf)
{
    _bcm_field_action_offset_t a_offset;
    _field_action_t *f_act = NULL, *prev_act = NULL;
    ...
    int hw_index = 0, i = 0, valid = 0;
    bcm_field_action_t action_arr[] = {
                                        bcmFieldActionDynamicTrunkAllEnable,
                                        bcmFieldActionDynamicTrunkAllCancel,
                                      };
...
/*
 * Function:
 *      _field_wb_em_protection_switching_set_recover
 * Purpose:
 ...
 */
int
_field_wb_em_protection_switching_set_recover(int unit, _field_entry_t *f_ent,
                                      uint32 *ebuf)
{
    _bcm_field_action_offset_t a_offset;
    _field_action_t *f_act = NULL, *prev_act = NULL;
...
/*
 * Function:
 *      _field_wb_em_dlb_ecmp_set_recover
 * Purpose:
 ...
 */
int
_field_wb_em_dlb_ecmp_set_recover(int unit, _field_entry_t *f_ent,
                                      uint32 *ebuf)
{
    _bcm_field_action_offset_t a_offset;
    _field_action_t *f_act = NULL, *prev_act = NULL;
...
/*
 * Function:
 *      _field_wb_em_dlb_alternate_path_control_set_recover
 * Purpose:
 ...
 */
int
_field_wb_em_dlb_alternate_path_control_set_recover(int unit, _field_entry_t *f_ent,
                                      uint32 *ebuf)
{
    _bcm_field_action_offset_t a_offset;
    _field_action_t *f_act = NULL, *prev_act = NULL;
...
#define ACTION_PROFILES_COUNT_TH2  23
/*
 * Function:
...
_field_wb_action_profile_parse(int unit, _field_entry_t *f_ent, uint32 *ebuf, uint32 *act_data)
{
    ...
    int i, temp;
    uint32 umask;
    int action_count, counter_len;

#ifdef BCM_TOMAHAWK2_SUPPORT
    if (SOC_IS_TOMAHAWK2(unit)) {
        action_count = ACTION_PROFILES_COUNT_TH2;
        counter_len = 26;
    } else
#endif /*BCM_TOMAHAWK2_SUPPORT*/
    {
        action_count = ACTION_PROFILES_COUNT;
        counter_len = 25;
    }
           ...
           case 6:
            ...
            case 16:
                _field_wb_em_counter_set_recover(unit, f_ent, act_data);
                 ACTION_DATA_SHIFT(act_data, counter_len);
                break;
#ifdef BCM_TOMAHAWK2_SUPPORT
#if defined(INCLUDE_L3)
            case 17:
                _field_wb_em_dlb_alternate_path_control_set_recover(unit, f_ent, act_data);
                ACTION_DATA_SHIFT(act_data, 10);
                break;
            case 18:
                _field_wb_em_dlb_ecmp_set_recover(unit, f_ent, act_data);
                ACTION_DATA_SHIFT(act_data, 2);
                break;
            case 22:
                _field_wb_em_protection_switching_set_recover(unit, f_ent, act_data);
                 ACTION_DATA_SHIFT(act_data, 1);
                break;
#endif /*INCLUDE_L3*/
            case 19:
                _field_wb_em_dlb_hgt_lag_set_recover(unit, f_ent, act_data);
                ACTION_DATA_SHIFT(act_data, 2);
                break;
            case 20:
                _field_wb_em_timestamp_set_recover(unit, f_ent, act_data);
                ACTION_DATA_SHIFT(act_data, 4);
                break;
            case 21:
                _field_wb_em_instrumentation_set_recover(unit, f_ent, act_data);
                 ACTION_DATA_SHIFT(act_data, 1);
                break;
#endif /*BCM_TOMAHAWK2_SUPPORT*/
