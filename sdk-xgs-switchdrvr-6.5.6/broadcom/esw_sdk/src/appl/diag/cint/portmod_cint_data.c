...
__cint_maddr__portmod_port_add_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 14: rv = &(s->ilkn_metaframe_period);break;
        case 15: rv = &(s->rx_retransmit);break;
        case 16: rv = &(s->tx_retransmit);break;
        case 17: rv = &(s->phy_op_mode);break;
        case 18: rv = &(s->phy_op_datapath);break;
        case 19: rv = &(s->ilkn_inb_cal_len_rx);break;
        case 20: rv = &(s->ilkn_inb_cal_len_tx);break;
        case 21: rv = &(s->ilkn_oob_cal_len_rx);break;
        case 22: rv = &(s->ilkn_oob_cal_len_tx);break;
        case 23: rv = &(s->reserved_channel_rx);break;
        case 24: rv = &(s->reserved_channel_tx);break;
        default: rv = NULL; break;
    }
    return rv;
}
