                                   ...
                                   int *non_dma_entries)
{
    ...
    *non_dma_entries += non_dma1->num_entries;
    ...
    non_dma0->cname = "UCQ_DROP_PKT";
    non_dma0->dma_buf[0] = buf;
    non_dma0->dma_index_max[0] = 16383;
    non_dma0->dma_mem[0] = non_dma0->mem;
    *non_dma_entries += non_dma0->num_entries;
    ...
    *non_dma_entries += non_dma1->num_entries;
    ...
    non_dma0->num_entries = 74; /* one per port */
    non_dma0->mem = MMU_CTR_COLOR_DROP_MEMm;
    non_dma0->reg = INVALIDr;
    non_dma0->field = PKTCNTf;
    non_dma0->cname = "DROP_PKT_YEL";
    non_dma0->dma_buf[0] = buf;
    non_dma0->dma_index_min[0] = 74 * 4;
    non_dma0->dma_index_max[0] = (74 * 4) + 73;
    non_dma0->dma_mem[0] = non_dma0->mem;
    *non_dma_entries += non_dma0->num_entries;
    ...
    *non_dma1 = *non_dma0;
    ...
    non_dma1->cname = "DROP_PKT_RED";
    /* TO DO: APACHE For this ver of regs file num of entries changed */
    non_dma1->dma_index_min[0] = 74 * 3;
    non_dma1->dma_index_max[0] = (74 * 3) + 73;
    *non_dma_entries += non_dma1->num_entries;
    ...
    *non_dma1 = *non_dma0;
    ...
    non_dma1->cname = "WRED_PKT_GRE";
    /* TO DO: APACHE For this ver of regs file num of entries changed */
    non_dma1->dma_index_min[0] = 74 * 2;
    non_dma1->dma_index_max[0] = (74 * 2) + 73;
    *non_dma_entries += non_dma1->num_entries;
    ...
    *non_dma1 = *non_dma0;
    ...
    non_dma1->cname = "WRED_PKT_YEL";
    /* TO DO: APACHE For this ver of regs file num of entries changed */
    non_dma1->dma_index_min[0] = 74 * 1;
    non_dma1->dma_index_max[0] = (74 * 1) + 73;
    *non_dma_entries += non_dma1->num_entries;
    ...
    *non_dma_entries += non_dma1->num_entries;
     ...
     *   [1]     [3]        [2n-1]
     */
    non_dma0->extra_ctr_ct = _AP_PBLKS_PER_PIPE; /* 9 OBMs per Pipe */
    ...
    if (non_dma0->extra_ctrs == NULL) {
        ...
        rv = soc_counter_apache_extra_obm_ctrs_init(unit,
                                                non_dma0,
                                                non_dma0->extra_ctrs,
    ...
    *non_dma1 = *non_dma0;
    ...
    non_dma1->cname = "OBM_LOSSY_L0_DRP_BYTE";
...
_soc_counter_apache_non_dma_pbmp_update(int unit)
{
    ...
    int soc_counter_non_dma2[] = {
        ...
        SOC_COUNTER_NON_DMA_PORT_DROP_BYTE_OBM_LOSSY_LO, /* OBM_LOSSY_L0_DRP_BYTE */
                 ...
                 int zero, int sync_mode, uint64 *val)
{
    ...
    if (SOC_IS_TOMAHAWKX(unit) &&
        ...
        if (soc_tomahawk_mem_is_xpe(unit,
...
*/
    ...
    if (!_SOC_CONTROLLED_COUNTER_USE(unit, port)) {
        ...
        if (ctr_reg >= NUM_SOC_REG) {
            ...
            if (SOC_REG_INFO(unit, ctr_reg).flags & SOC_REG_FLAG_RO) {
                ctr_is_readonly = 1;
            }
        }
#if defined(BCM_PETRA_SUPPORT)
                                    ...
                                    soc_reg_t ctr_reg)
{
    ...
    int index_min = 0, index_max = 0, max_pipe, pipe, entries_per_pipe = 0;
    ...
    max_pipe = NUM_PIPE(unit); /* store locally */
            ...
            do {
                ...
                if (ctr_reg == INVALIDr) {
                    if (non_dma->dma_mem[0] != INVALIDm) {
                        entries_per_pipe = soc_mem_index_count(unit, non_dma->dma_mem[0]);
                    }
                ...
                if ((non_dma->flags & _SOC_COUNTER_NON_DMA_FLEX_MAPPING)
                    ...
                    for (pipe = 0; pipe < max_pipe; pipe++) {
                        ...
                        base_index = non_dma->base_index +
                                    (pipe - invalid_pipe_ct) * entries_per_pipe;
                        for (i = 0 ; i < entries_per_pipe; i++) {
                            soc_mem_field_get(unit, non_dma->mem,
...
soc_counter_start(int unit, uint32 flags, int interval, pbmp_t pbmp)
{
    ...
    if ((soc_feature(unit, soc_feature_counter_eviction)) &&
        (!SOC_WARM_BOOT(unit))) {
        /* During WB, evition will be enabled post WB init */
    ...
    for (; id < non_dma_counter_end; id++) {
        ...
        if (non_dma->mem != INVALIDm) {
            ...
            do {
                ...
                for (j = 0; j < 2; j++) { /* for packet and byte */
                    for (i = 0; i < num_non_dma_entries; i++) {
                        if (ctr_reg == INVALIDr) {
 ...
 */
int
soc_th_ser_update_counter(int unit, int is_reg, soc_reg_t restore_reg,
...
#endif /* defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_SAND_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) */
