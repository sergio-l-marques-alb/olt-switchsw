 ...
 *      SOC_E_XXX
 */
int portmod_xphy_add(int unit, int xphy_addr, const phymod_core_access_t* core_access)
{
    int xphy_idx;
...
#if defined(PORTMOD_PM4X25_SUPPORT) || defined(PORTMOD_PM4X10_SUPPORT) || defined(PORTMOD_DNX_FABRIC_SUPPORT) || defined(PORTMOD_PM12X10_SUPPORT) || defined(PORTMOD_PM4x10Q_SUPPORT) || defined(PORTMOD_PM_OS_ILKN_SUPPORT) || defined(PORTMOD_DNX_FABRIC_SUPPORT)
STATIC
...
#endif /* defined(PORTMOD_PM4X25_SUPPORT) || defined(PORTMOD_PM4X10_SUPPORT) || defined(PORTMOD_DNX_FABRIC_SUPPORT) || defined(PORTMOD_PM12X10_SUPPORT) || defined(PORTMOD_PM4x10Q_SUPPORT) || defined(PORTMOD_PM_OS_ILKN_SUPPORT) || defined(PORTMOD_DNX_FABRIC_SUPPORT) */
