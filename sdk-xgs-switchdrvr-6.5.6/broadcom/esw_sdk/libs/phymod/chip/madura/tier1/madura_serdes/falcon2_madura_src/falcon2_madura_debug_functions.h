 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: falcon2_madura_debug_functions.h 1356 2016-02-12 23:27:16Z cvazquez $ *
 *                                                                                       *
...
/** @file falcon2_madura_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef FALCON2_MADURA_DEBUG_FUNCTIONS_H
#define FALCON2_MADURA_DEBUG_FUNCTIONS_H

#include "falcon2_madura_usr_includes.h"

#include "falcon2_madura_enum.h"
#include "falcon2_madura_common.h"
#include "falcon2_madura_api_uc_common.h"

/** Lane User Control Function Structure in Microcode */
struct falcon2_madura_usr_ctrl_func_st {
...
struct falcon2_madura_usr_ctrl_dfe_func_st {
...
struct falcon2_madura_usr_ctrl_disable_functions_st {
  struct falcon2_madura_usr_ctrl_func_st field;
  uint16_t word;
};

/** Lane User Control Disable DFE Function Struct */
struct falcon2_madura_usr_ctrl_disable_dfe_functions_st {
  struct falcon2_madura_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};

/** Falcon Lane status Struct */
struct falcon2_madura_detailed_lane_status_st {
 ...
 */
err_code_t falcon2_madura_isolate_ctrl_pins( const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_isolate_lane_ctrl_pins( const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_isolate_core_ctrl_pins( const phymod_access_t *pa, uint8_t enable);
 ...
 */
err_code_t falcon2_madura_meas_eye_density_data(const phymod_access_t *pa, const struct falcon2_madura_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t *buffer_size);

/** Displays Eye Density Data measured with falcon2_madura_meas_eye_density_data().
 *
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param buffer_size must provide buffer_size which is returned from falcon2_madura_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_display_eye_density_data(const phymod_access_t *pa, const struct falcon2_madura_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t buffer_size);
 ...
 * Note: Stop the microcode [use falcon2_madura_stop_rx_adaptation()] before using this API
 ...
 */
err_code_t falcon2_madura_tx_pi_jitt_gen( const phymod_access_t *pa, uint8_t enable, int16_t freq_override_val, enum srds_tx_pi_freq_jit_gen_enum jit_type, uint8_t tx_pi_jit_freq_idx, uint8_t tx_pi_jit_amp);
 ...
 */
uint8_t falcon2_madura_rdbl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t falcon2_madura_rdwl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t falcon2_madura_rdbls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t falcon2_madura_rdwls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t falcon2_madura_rdbc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t falcon2_madura_rdwc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t falcon2_madura_rdbcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t falcon2_madura_rdwcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 */
err_code_t falcon2_madura_apply_txfir_cfg( const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2, int8_t post3);

/** Reads current pmd lane status and populates the provided structure of type #falcon2_madura_detailed_lane_status_st.
...
/** Displays the lane status stored in the input struct of type #falcon2_madura_detailed_lane_status_st.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_wrw_uc_ram( const phymod_access_t *pa, uint16_t addr, uint16_t wr_val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_wrb_uc_ram( const phymod_access_t *pa, uint16_t addr, uint8_t wr_val);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t falcon2_madura_rdw_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t falcon2_madura_rdb_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_wrws_uc_ram( const phymod_access_t *pa, uint16_t addr, int16_t wr_val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_wrbs_uc_ram( const phymod_access_t *pa, uint16_t addr, int8_t wr_val);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t falcon2_madura_rdws_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t falcon2_madura_rdbs_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_rdblk_uc_ram( const phymod_access_t *pa, uint8_t *mem, uint16_t addr, uint16_t cnt);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_madura_pll_drv_hv_disable( const phymod_access_t *pa, uint8_t disable);
