...
int tefmod_autoneg_set(PHYMOD_ST* pc, tefmod_an_adv_ability_t *cl73_adv)
{
  ...
  if((cl73_adv->an_fec == TEFMOD_FEC_CL74_SUPRTD_REQSTD) || 
      (cl73_adv->an_fec == TEFMOD_FEC_CL91_SUPRTD_REQSTD)) {
    AN_X4_LD_BASE_ABIL1r_FEC_REQf_SET(AN_X4_ABILITIES_LD_BASE_ABILITIES_1r_reg, 3);
  }
  ...
  if (model == TSCF_GEN2) {
    ...
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_KR1 ) & 1) {
        ...
        /* IEEE bit location for KR1/Cr1 is 9 */ 
        AN_X4_LD_BASE_ABIL_3_GEN2r_BASE_25G_KR1_SELf_SET(AN_X4_LD_BASE_ABIL_3_GEN2r_reg, 10);
    }     
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_CR1 ) & 1) {
        ...
        /* IEEE bit location for KR1/Cr1 is 9 */ 
        AN_X4_LD_BASE_ABIL_3_GEN2r_BASE_25G_CR1_SELf_SET(AN_X4_LD_BASE_ABIL_3_GEN2r_reg, 10);
    }     
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_KRS1 ) & 1) {
        ...
        /* IEEE bit location for KRS1/CrS1 is 10 */ 
        AN_X4_LD_BASE_ABIL_4_GEN2r_BASE_25G_KRS1_SELf_SET(AN_X4_LD_BASE_ABIL_4_GEN2r_reg, 9);
    }     
    if((cl73_adv->an_base_speed  >> TEFMOD_CL73_25GBASE_CRS1 ) & 1) {
        ...
        AN_X4_LD_BASE_ABIL_4_GEN2r_BASE_25G_CRS1_SELf_SET(AN_X4_LD_BASE_ABIL_4_GEN2r_reg, 9);
    }     
    ...
    if (cl73_adv->an_fec == TEFMOD_FEC_SUPRTD_NOT_REQSTD) {
        /* we need to clear the selection for the both cl74 and cl91 */
        AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_BASE_R_FEC_REQ_SELf_SET(AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_reg, 0);
        AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_RS_FEC_REQ_SELf_SET(AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_reg, 0);
    } else {
        if (cl73_adv->an_fec & TEFMOD_FEC_CL74_SUPRTD_REQSTD) {
            AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_BASE_R_FEC_REQ_SELf_SET(AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_reg, 24);
        ...
        if (cl73_adv->an_fec & TEFMOD_FEC_CL91_SUPRTD_REQSTD) {
            AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_RS_FEC_REQ_SELf_SET(AN_X4_LD_FEC_BASEPAGE_ABIL_GEN2r_reg, 23);
  ...
  if (model == TSCF_GEN2) {
    ...
    if ((cl73_adv->an_bam_speed) || (cl73_adv->an_bam_speed1)) {
        ...
        if (cl73_adv->an_fec == TEFMOD_FEC_SUPRTD_NOT_REQSTD) {
            AN_X4_LD_UP1_ABIL_1_GEN2r_CL74_REQf_SET(AN_X4_LD_UP1_ABIL_1_GEN2r_reg, 0x0);
            AN_X4_LD_UP1_ABIL_1_GEN2r_CL91_REQf_SET(AN_X4_LD_UP1_ABIL_1_GEN2r_reg, 0x0);
        }
        if (cl73_adv->an_fec & TEFMOD_FEC_CL74_SUPRTD_REQSTD) {
            AN_X4_LD_UP1_ABIL_1_GEN2r_CL74_REQf_SET(AN_X4_LD_UP1_ABIL_1_GEN2r_reg, 0x3);
        }
        if (cl73_adv->an_fec & TEFMOD_FEC_CL91_SUPRTD_REQSTD) {
            AN_X4_LD_UP1_ABIL_1_GEN2r_CL91_REQf_SET(AN_X4_LD_UP1_ABIL_1_GEN2r_reg, 0x3);
        }
...
int tefmod_tx_loopback_control(PHYMOD_ST* pc, int pcs_gloop_en, int starting_lane, int num_lanes)           /* TX_LOOPBACK_CONTROL  */
{
  ...
  tefmod_trigger_speed_change(pc);
...
int tefmod_FEC_control(PHYMOD_ST* pc, tefmod_fec_type_t fec_type, int enable, int cl74or91)
{
  ...
  /* CL91 AN handling */
  if(fec_type == TEFMOD_CL91) {
      /*for tscf gen2 version */
      if (model == TSCF_GEN2) {
        SC_X4_SC_X4_OVRR_GEN2r_t SC_X4_SC_X4_OVRR_reg;
        SC_X4_SC_X4_OVRR_GEN2r_CLR(SC_X4_SC_X4_OVRR_reg);
          if(enable == TEFMOD_PHY_CONTROL_FEC_AUTO) {
              SC_X4_SC_X4_OVRR_GEN2r_AN_FEC_SEL_OVERRIDEf_SET(SC_X4_SC_X4_OVRR_reg, 0x0);
              PHYMOD_IF_ERR_RETURN(MODIFY_SC_X4_SC_X4_OVRR_GEN2r(pc, SC_X4_SC_X4_OVRR_reg));
          } else if(enable == TEFMOD_PHY_CONTROL_FEC_OFF) {
              SC_X4_SC_X4_OVRR_GEN2r_AN_FEC_SEL_OVERRIDEf_SET(SC_X4_SC_X4_OVRR_reg, 0x1);
              PHYMOD_IF_ERR_RETURN(MODIFY_SC_X4_SC_X4_OVRR_GEN2r(pc, SC_X4_SC_X4_OVRR_reg));
          }
      
      } else { /*tscf gen1 version */  
          if(enable == TEFMOD_PHY_CONTROL_FEC_AUTO) {
              MAIN0_LN_SWPr_CLR(MAIN0_LANE_SWAPr_reg);
  ...
  *fec_en = 0;
  ...
  if (fec_type == TEFMOD_CL91) {
      if (model == TSCF_GEN2)  {
            ...
            uint32_t fec_mode;
            READ_TX_X4_TX_CTL0_GEN2r(pc, &tx_x4_tx_ctrl_reg);
            fec_mode = TX_X4_TX_CTL0_GEN2r_CL91_FEC_MODEf_GET(tx_x4_tx_ctrl_reg);
            if (fec_mode == 0) {
                *fec_en = 0;
            } else {
                *fec_en = 1;
...
/* also add the default for 25G/50G AM marker to use 100G instead of 40G */
int tefmod_default_init(PHYMOD_ST* pc)               /* default set*/
{
  MAIN0_SPD_CTL_GEN2r_t main_spd_ctl_gen2r;
  SC_X4_MSA_25G_50G_CTL_GEN2r_t msa_25g_50g_ctrl;
  MAIN0_SPD_CTL_GEN2r_CLR(main_spd_ctl_gen2r);
  SC_X4_MSA_25G_50G_CTL_GEN2r_CLR(msa_25g_50g_ctrl);
  MAIN0_SPD_CTL_GEN2r_TSC_CREDIT_SELf_SET(main_spd_ctl_gen2r, 1);
  SC_X4_MSA_25G_50G_CTL_GEN2r_MSA_25G_AM0_FORMATf_SET(msa_25g_50g_ctrl, 1);
  SC_X4_MSA_25G_50G_CTL_GEN2r_MSA_25G_AM123_FORMATf_SET(msa_25g_50g_ctrl, 1);
  SC_X4_MSA_25G_50G_CTL_GEN2r_MSA_50G_AM123_FORMATf_SET(msa_25g_50g_ctrl, 1);
  SC_X4_MSA_25G_50G_CTL_GEN2r_MSA_50G_AM0_FORMATf_SET(msa_25g_50g_ctrl, 1);
  PHYMOD_IF_ERR_RETURN(MODIFY_MAIN0_SPD_CTL_GEN2r(pc, main_spd_ctl_gen2r));
  PHYMOD_IF_ERR_RETURN(MODIFY_SC_X4_MSA_25G_50G_CTL_GEN2r(pc, msa_25g_50g_ctrl));  
...
int tefmod_sw_an_ctl_sts_get(PHYMOD_ST* pc, phymod_sw_an_ctrl_status_t *an_ctrl_status)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (tefmod_pxgng_status_an_ack_complete_get(pc, &ack_complete)); 
    an_ctrl_status->page_req = AN_X4_SW_CTL_STS_GEN2r_LD_PAGE_REQf_GET(AN_X4_SW_CTL_STSr_reg);
    an_ctrl_status->page_req = ack_complete;
