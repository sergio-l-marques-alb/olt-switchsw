/**************************************************************************************
 *  File Name     :  merlin16_tsc_usr_includes.h                                        *
...
/** @file merlin16_tsc_usr_includes.h
...
#ifndef MERLIN16_TSC_API_USR_INCLUDES_H
#define MERLIN16_TSC_API_USR_INCLUDES_H
...
#define USR_DELAY_MS(...) merlin16_tsc_delay_ms(sa__, __VA_ARGS__)
#define USR_DELAY_US(...) merlin16_tsc_delay_us(sa__, __VA_ARGS__)
#define USR_DELAY_NS(...) merlin16_tsc_delay_ns(sa__, __VA_ARGS__)
#endif
