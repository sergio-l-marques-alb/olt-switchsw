/**************************************************************************************
 **************************************************************************************
 *  File Name     :  falcon2_dino_field_access.h                                        *
 *  Created On    :  29/04/2013                                                       *
 *  Created By    :  Kiran Divakar                                                    *
 *  Description   :  Serdes IP Register and Field access APIs                         *
 *  Revision      :  $Id: falcon2_dino_field_access.h 1337 2016-02-04 00:15:32Z kirand $ *
 *                                                                                    *
...
/** @file falcon2_dino_field_access.h
 * Registers and field access
 */

#ifndef FALCON2_DINO_API_FIELD_ACCESS_H
#define FALCON2_DINO_API_FIELD_ACCESS_H
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _falcon2_dino_pmd_rdt_field_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _falcon2_dino_pmd_rdt_field_signed_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
