            ...
            if ((lane_mask & 0xf) != 0) {
                ...
                if (if_side == DINO_IF_SYS) {
                    if ((lane_mask == DINO_100G_TYPE1_LANE_MASK) || ((lane_mask & 0xf) == 0xf)) {
                        ...
                        BCMI_DINO_MODECTL0r_MODE_100G_GBOX_1TO10f_SET(mode_ctrl0, 0);
                        BCMI_DINO_MODECTL0r_MODE_100G_GBOX_2TO11f_SET(mode_ctrl0, 0);
                    } else if ((lane_mask == DINO_100G_TYPE2_LANE_MASK) || ((lane_mask & 0xe) == 0xe)) {
                        BCMI_DINO_MODECTL0r_MODE_100G_GBOX_1TO10f_SET(mode_ctrl0, 1);
                        BCMI_DINO_MODECTL0r_MODE_100G_GBOX_0TO9f_SET(mode_ctrl0, 0);
                        BCMI_DINO_MODECTL0r_MODE_100G_GBOX_2TO11f_SET(mode_ctrl0, 0);
                    } else if ((lane_mask == DINO_100G_TYPE3_LANE_MASK) || ((lane_mask & 0xc) == 0xc)) {
                     ...
                     uint16_t lane, const phymod_tx_t* tx) 
{
    if (DINO_IS_FALCON_SIDE(if_side, lane)) {
        ...
        PHYMOD_IF_ERR_RETURN(falcon2_dino_write_tx_afe(pa, TX_AFE_PRE, tx->pre));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_write_tx_afe(pa, TX_AFE_MAIN, tx->main));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_write_tx_afe(pa, TX_AFE_POST1, tx->post));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_write_tx_afe(pa, TX_AFE_POST2, tx->post2));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_write_tx_afe(pa, TX_AFE_POST3, tx->post3));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_write_tx_afe(pa, TX_AFE_AMP, tx->amp));
    } else {
                     ...
                     uint16_t lane, phymod_tx_t* tx)
{
    if (DINO_IS_FALCON_SIDE(if_side, lane)) {
        ...
        PHYMOD_IF_ERR_RETURN(falcon2_dino_read_tx_afe(pa, TX_AFE_PRE, &tx->pre));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_read_tx_afe(pa, TX_AFE_MAIN, &tx->main));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_read_tx_afe(pa, TX_AFE_POST1, &tx->post));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_read_tx_afe(pa, TX_AFE_POST2, &tx->post2));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_read_tx_afe(pa, TX_AFE_POST3, &tx->post3));
        PHYMOD_IF_ERR_RETURN(falcon2_dino_read_tx_afe(pa, TX_AFE_AMP, &tx->amp));
    } else {
        PHYMOD_DEBUG_VERBOSE(("Merlin TXFIR get\n"));
        PHYMOD_IF_ERR_RETURN(merlin_dino_read_tx_afe(pa, TX_AFE_PRE, &tx->pre));
        PHYMOD_IF_ERR_RETURN(merlin_dino_read_tx_afe(pa, TX_AFE_MAIN, &tx->main));
        PHYMOD_IF_ERR_RETURN(merlin_dino_read_tx_afe(pa, TX_AFE_POST1, &tx->post));
        PHYMOD_IF_ERR_RETURN(merlin_dino_read_tx_afe(pa, TX_AFE_POST2, &tx->post2));
    }
    return PHYMOD_E_NONE;
}
...
/** Get dino interrupt type number from PHYMOD intr type
 *
    ...
    switch (intr_type) {
    	case PHYMOD_INTR_PLL_EVENT:
            if (intf_side == DINO_IF_SYS){
	            if (lane_mask & 0xf ){/* core 0: merlin*/
		            converted_val = INT_SYS_10G_0_PLL_LOCK_LOST;
                } else if (lane_mask & 0xf0) { /* core 1: merlin */
		            converted_val = INT_SYS_10G_1_PLL_LOCK_LOST;
                } else { /* core 2: merlin */
		            converted_val = INT_SYS_10G_2_PLL_LOCK_LOST;
                }
	        } else {/*line side*/
	            if (lane_mask & 0xf ){/* falcon */
		            converted_val = INT_LIN_25G_0_PMD_LOCK_LOST;
	            } else if (lane_mask & 0xf0) { /* core 1: merlin */
		            converted_val = INT_LIN_10G_1_PLL_LOCK_LOST;
                } else { /* core 2: merlin */
		            converted_val = INT_LIN_10G_2_PLL_LOCK_LOST;
                }
	        }		
 	    break;
	    case PHYMOD_INTR_AUTONEG_EVENT:
    	    if (intf_side == DINO_IF_LINE) {
	            if (lane_mask & 0xf ){/* core0: falcon*/
		            converted_val = INT_CL73_P0_AN_COMPLETE;
	            } else if (lane_mask & 0xf0) { /* core 1: merlin */
		            converted_val = INT_CL73_P1_AN_COMPLETE;
	            } else { /* core 2: merlin */
		            converted_val = INT_CL73_P2_AN_COMPLETE;
                }
	        }
 	    break;
	    case PHYMOD_INTR_EMON_EVENT:
            switch (lane_mask >> 2) {
                case 0:
                    converted_val = (intf_side == DINO_IF_SYS) ?INT_SYS_LANE_0_PCS_MON_LOCK_LOST : INT_LIN_LANE_0_PCS_MON_LOCK_LOST;
                break;    
                case 1:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_1_PCS_MON_LOCK_LOST : INT_LIN_LANE_1_PCS_MON_LOCK_LOST;
                break;    
                case 2:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_2_PCS_MON_LOCK_LOST : INT_LIN_LANE_2_PCS_MON_LOCK_LOST;
                break;    
                case 3:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_3_PCS_MON_LOCK_LOST : INT_LIN_LANE_3_PCS_MON_LOCK_LOST;
                break;    
                case 4:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_4_PCS_MON_LOCK_LOST : INT_LIN_LANE_4_PCS_MON_LOCK_LOST;
                break;    
                case 5:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_5_PCS_MON_LOCK_LOST : INT_LIN_LANE_5_PCS_MON_LOCK_LOST;
                break;    
                case 6:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_6_PCS_MON_LOCK_LOST : INT_LIN_LANE_6_PCS_MON_LOCK_LOST;
                break;    
                case 7:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_7_PCS_MON_LOCK_LOST : INT_LIN_LANE_7_PCS_MON_LOCK_LOST;
                break;    
                case 8:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_8_PCS_MON_LOCK_LOST : INT_LIN_LANE_8_PCS_MON_LOCK_LOST;
                break;    
                case 9:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_9_PCS_MON_LOCK_LOST : INT_LIN_LANE_9_PCS_MON_LOCK_LOST;
                break;    
                case 10:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_10_PCS_MON_LOCK_LOST : INT_LIN_LANE_10_PCS_MON_LOCK_LOST;
                break;    
                case 11:
                    converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_LANE_11_PCS_MON_LOCK_LOST : INT_LIN_LANE_11_PCS_MON_LOCK_LOST;
                break;    
            }
	    break;	
	    case PHYMOD_INTR_LINK_EVENT:
            if (lane_mask & 0xf) {
                converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_10G_0_PMD_LOCK_LOST : INT_LIN_25G_0_PMD_LOCK_LOST;
            } else if (lane_mask & 0xf0) {
                converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_10G_1_PMD_LOCK_LOST : INT_LIN_10G_1_PMD_LOCK_LOST;
            } else {
                converted_val = (intf_side == DINO_IF_SYS) ? INT_SYS_10G_2_PMD_LOCK_LOST : INT_LIN_10G_2_PMD_LOCK_LOST;
            }
        break;
	    default:
	        return PHYMOD_E_PARAM;
...
int  _dino_get_intr_reg (const phymod_phy_access_t *phy, uint32_t intr_type, uint16_t *bit_pos, uint16_t *int_grp)
{
    ...
    lane_mask = PHYMOD_ACC_LANE_MASK(pa);
    intr_type = convert_phymod_to_dino(intr_type, intf_side, lane_mask);   
    ...
    switch (intr_type) {
		...
		case INT_MST_DED:
			...
			*int_grp =  0;
		break;
		case INT_MST_MSGOUT_INTR:
			*bit_pos =  2;
			*int_grp =  0;
		break;
		case INT_MST_MISC_INTR:
			*bit_pos =  3;
			*int_grp =  0;
		break;
		case INT_MST_LOCKUP:
			...
			*int_grp =  0;
		break;
		case INT_MST_SYSRESETREQ:
			*bit_pos =  5;
			*int_grp =  0;
		break;
		case INT_IP_PMI_LP_EN_SQUELCH:
			*bit_pos =  6;
			*int_grp =  0;
		break;
		case INT_LIN_25G_0_PLL_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  1;
		break;
		case INT_LIN_25G_0_PLL_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  1;
		break;
		case INT_LIN_25G_0_SIGDET_FOUND:
			 *bit_pos =  2;
			 *int_grp =  1;
		break;
		case INT_LIN_25G_0_SIGDET_LOST:
			*bit_pos =  3;
			*int_grp =  1;
		break;
		case INT_LIN_25G_0_PMD_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  1;
		break;
		case INT_LIN_25G_0_PMD_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  1;
		break;
		case INT_LIN_10G_1_PLL_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  2;
		break;
		case INT_LIN_10G_1_PLL_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  2;
		break;
		case INT_LIN_10G_1_SIGDET_FOUND:
			*bit_pos =  2;
			*int_grp =  2;
		break;
		case INT_LIN_10G_1_SIGDET_LOST:
			*bit_pos =  3;
			*int_grp =  2;
		break;
		case INT_LIN_10G_1_PMD_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  2;
		break;
		case INT_LIN_10G_1_PMD_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  2;
		break;
		case INT_LIN_10G_2_PLL_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  3;
		break;
		case INT_LIN_10G_2_PLL_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  3;
		break;
		case INT_LIN_10G_2_SIGDET_FOUND:
			*bit_pos =  2;
			*int_grp =  3;
		break;
		case INT_LIN_10G_2_SIGDET_LOST:
			*bit_pos =  3;
			*int_grp =  3;
		break;
		case INT_LIN_10G_2_PMD_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  3;
		break;
		case INT_LIN_10G_2_PMD_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  3;
		break;
		case INT_SYS_10G_0_PLL_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  4;
		break;
		case INT_SYS_10G_0_PLL_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  4;
		break;
		case INT_SYS_10G_0_SIGDET_FOUND:
			*bit_pos =  2;
			*int_grp =  4;
		break;
		case INT_SYS_10G_0_SIGDET_LOST:
			*bit_pos =  3;
			*int_grp =  4;
		break;
		case INT_SYS_10G_0_PMD_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  4;
		break;
		case INT_SYS_10G_0_PMD_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  4;
		break;
		case INT_SYS_10G_1_PLL_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  5;
		break;
		case INT_SYS_10G_1_PLL_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  5;
		break;
		case INT_SYS_10G_1_SIGDET_FOUND:
			*bit_pos =  2;
			*int_grp =  5;
		break;
		case INT_SYS_10G_1_SIGDET_LOST:
			*bit_pos =  3;
			*int_grp =  5;
		break;
		case INT_SYS_10G_1_PMD_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  5;
		break;
		case INT_SYS_10G_1_PMD_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  5;
		break;
		case INT_SYS_10G_2_PLL_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  6;
		break;
		case INT_SYS_10G_2_PLL_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  6;
		break;
		case INT_SYS_10G_2_SIGDET_FOUND:
			*bit_pos =  2;
			*int_grp =  6;
		break;
		case INT_SYS_10G_2_SIGDET_LOST:
			*bit_pos =  3;
			*int_grp =  6;
		break;
		case INT_SYS_10G_2_PMD_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  6;
		break;
		case INT_SYS_10G_2_PMD_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  6;
		break;
		case INT_SYS_LANE_0_PCS_MON_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_0_PCS_MON_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_1_PCS_MON_LOCK_FOUND:
			*bit_pos =  2;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_1_PCS_MON_LOCK_LOST:
			*bit_pos =  3;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_2_PCS_MON_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_2_PCS_MON_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_3_PCS_MON_LOCK_FOUND:
			*bit_pos =  6;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_3_PCS_MON_LOCK_LOST:
			*bit_pos =  7;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_4_PCS_MON_LOCK_FOUND:
			*bit_pos =  8;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_4_PCS_MON_LOCK_LOST:
			*bit_pos =  9;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_5_PCS_MON_LOCK_FOUND:
			*bit_pos =  10;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_5_PCS_MON_LOCK_LOST:
			*bit_pos =  11;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_6_PCS_MON_LOCK_FOUND:
			*bit_pos =  12;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_6_PCS_MON_LOCK_LOST:
			*bit_pos =  13;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_7_PCS_MON_LOCK_FOUND:
			*bit_pos =  14;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_7_PCS_MON_LOCK_LOST:
			*bit_pos =  15;
			*int_grp =  7;
		break;
		case INT_SYS_LANE_8_PCS_MON_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  8;
		break;
		case INT_SYS_LANE_8_PCS_MON_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  8;
		break;
		case INT_SYS_LANE_9_PCS_MON_LOCK_FOUND:
			*bit_pos =  2;
			*int_grp =  8;
		break;
		case INT_SYS_LANE_9_PCS_MON_LOCK_LOST:
			*bit_pos =  3;
			*int_grp =  8;
		break;
		case INT_SYS_LANE_10_PCS_MON_LOCK_FOUND:
		   *bit_pos =  4;
		   *int_grp =  8;
		break;
		case INT_SYS_LANE_10_PCS_MON_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  8;
		break;
		case INT_SYS_LANE_11_PCS_MON_LOCK_FOUND:
		   *bit_pos =  6;
		   *int_grp =  8;
		break;
		case INT_SYS_LANE_11_PCS_MON_LOCK_LOST:
			*bit_pos =  7;
			*int_grp =  8;
		break;
		case INT_LIN_LANE_0_PCS_MON_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  9;                                                                          
		break;
		case INT_LIN_LANE_0_PCS_MON_LOCK_LOST:
			*bit_pos =  1;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_1_PCS_MON_LOCK_FOUND:
			*bit_pos =  2;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_1_PCS_MON_LOCK_LOST:
			*bit_pos =  3;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_2_PCS_MON_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_2_PCS_MON_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_3_PCS_MON_LOCK_FOUND:
			*bit_pos =  6;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_3_PCS_MON_LOCK_LOST:
			*bit_pos =  7;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_4_PCS_MON_LOCK_FOUND:
			*bit_pos =  8;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_4_PCS_MON_LOCK_LOST:
			*bit_pos =  9;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_5_PCS_MON_LOCK_FOUND:
			*bit_pos =  10;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_5_PCS_MON_LOCK_LOST:
			*bit_pos =  11;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_6_PCS_MON_LOCK_FOUND:
			*bit_pos =  12;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_6_PCS_MON_LOCK_LOST:
			*bit_pos =  13;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_7_PCS_MON_LOCK_FOUND:
			*bit_pos =  14;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_7_PCS_MON_LOCK_LOST:
			*bit_pos =  15;
			*int_grp =  9;
		break;
		case INT_LIN_LANE_8_PCS_MON_LOCK_FOUND:
			*bit_pos =  0;
			*int_grp =  10;
		break;
		case INT_LIN_LANE_8_PCS_MON_LOCK_LOST:
			 *bit_pos =  1;
			 *int_grp =  10;
		break;
		case INT_LIN_LANE_9_PCS_MON_LOCK_FOUND:
			*bit_pos =  2;
			*int_grp =  10;
		break;
		case INT_LIN_LANE_9_PCS_MON_LOCK_LOST:
			*bit_pos =  3;
			*int_grp =  10;
		break;
		case INT_LIN_LANE_10_PCS_MON_LOCK_FOUND:
			*bit_pos =  4;
			*int_grp =  10;
		break;
		case INT_LIN_LANE_10_PCS_MON_LOCK_LOST:
			*bit_pos =  5;
			*int_grp =  10;
		break;
		case INT_LIN_LANE_11_PCS_MON_LOCK_FOUND:
			*bit_pos =  6;
			*int_grp =  10;
		break;
		case INT_LIN_LANE_11_PCS_MON_LOCK_LOST:
			*bit_pos =  7;
			*int_grp =  10;
		break;
		case INT_CL91_TX_PCS_ALIGN_FOUND:
			*bit_pos =  8;
			*int_grp =  10;
		break;
		case INT_CL91_TX_PCS_ALIGN_LOST:
			*bit_pos =  9;
			*int_grp =  10;
		break;
		case INT_CL91_RX_FEC_ALIGN_FOUND:
			*bit_pos =  10;
			*int_grp =  10;
		break;
		case INT_CL91_RX_FEC_ALIGN_LOST:
			*bit_pos =  11;
			*int_grp =  10;
		break;
		case INT_CL73_P0_AN_COMPLETE:
			*bit_pos =  0;
			*int_grp =  11;
		break;
		case INT_CL73_P1_AN_COMPLETE:
			*bit_pos =  1;
			*int_grp =  11;
		break;
		case INT_CL73_P2_AN_COMPLETE:
			*bit_pos =  2;
			*int_grp =  11;
		break;
		case INT_CL73_P0_AN_RESTARTED:
			*bit_pos =  3;
			*int_grp =  11;
		break;
		case INT_CL73_P1_AN_RESTARTED:
			*bit_pos =  4;
			*int_grp =  11;
		break;
		case INT_CL73_P2_AN_RESTARTED:
			*bit_pos =  5;
			*int_grp =  11;
		break;
		case INT_CL73_P0_INCOMPATIBLE_LINK:
			*bit_pos =  6;
			*int_grp =  11;
		break;	
		case INT_CL73_P1_INCOMPATIBLE_LINK:
			*bit_pos =  7;
			*int_grp =  11;
		break;
		case INT_CL73_P2_INCOMPATIBLE_LINK:
			*bit_pos =  8;
			*int_grp =  11;
		break;
		case INT_CL73_P0_LINK_FAIL_INHIBIT_TIMER_DONE:
			*bit_pos =  9;
			*int_grp =  11;
		break;
		case INT_CL73_P1_LINK_FAIL_INHIBIT_TIMER_DONE:
			*bit_pos =  10;
			*int_grp =  11;
		break;
		case INT_CL73_P2_LINK_FAIL_INHIBIT_TIMER_DONE:
			*bit_pos =  11; 
			*int_grp =  11;
		break;
		...
		case INT_MUX_FIFOERR:
			...
			*int_grp =  12;
		break;
		case INT_MOD_ABS_3_LOW:
			*bit_pos =  0;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_4_LOW:
			*bit_pos =  1;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_5_LOW:
			*bit_pos =  2;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_6_LOW:
			*bit_pos =  3;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_7_LOW:
			*bit_pos =  4;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_8_LOW:
			*bit_pos =  5;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_9_LOW:
			*bit_pos =  6;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_10_LOW:
			*bit_pos =  7;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_11_LOW:
			*bit_pos =  8;
			*int_grp =  13;
		break;
		case INT_MOD_ABS_3_HIGH:
			*bit_pos =  0;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_4_HIGH:
			*bit_pos =  1;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_5_HIGH:
			*bit_pos =  2;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_6_HIGH:
			*bit_pos =  3;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_7_HIGH:
			*bit_pos =  4;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_8_HIGH:
			*bit_pos =  5;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_9_HIGH:
			*bit_pos =  6;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_10_HIGH:
			*bit_pos =  7;
			*int_grp =  14;
		break;
		case INT_MOD_ABS_11_HIGH:
			*bit_pos =  8;
			*int_grp =  14;
		break;
        default:
...
int _dino_phy_intr_enable_set(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t enable)
{
    ...
    BCMI_DINO_SYS_MISC_0_EIERr_t sys_misc_0_eier;
    BCMI_DINO_SYS_MISC_1_EIERr_t sys_misc_1_eier;
    BCMI_DINO_LIN_MISC_0_EIERr_t line_misc_0_eier;
    BCMI_DINO_LIN_MISC_1_EIERr_t line_misc_1_eier;
    BCMI_DINO_LIN_MISC_2_EIERr_t line_misc_2_eier;
    BCMI_DINO_MISC_EIERr_t misc_eier;
    BCMI_DINO_MOD_ABS_LOW_EIERr_t mod_abs_low_eier;
    BCMI_DINO_MOD_ABS_HI_EIERr_t mod_abs_hi_eier;

    PHYMOD_MEMSET(&m0_eier, 0, sizeof(BCMI_DINO_M0_EIERr_t));
    ...
    PHYMOD_MEMSET(&sys_misc_0_eier, 0, sizeof(BCMI_DINO_SYS_MISC_0_EIERr_t));
    PHYMOD_MEMSET(&sys_misc_1_eier, 0, sizeof(BCMI_DINO_SYS_MISC_1_EIERr_t));
    PHYMOD_MEMSET(&line_misc_0_eier, 0, sizeof(BCMI_DINO_LIN_MISC_0_EIERr_t));
    PHYMOD_MEMSET(&line_misc_1_eier, 0, sizeof(BCMI_DINO_LIN_MISC_1_EIERr_t));
    ...
    PHYMOD_MEMSET(&mod_abs_low_eier, 0, sizeof(BCMI_DINO_MOD_ABS_LOW_EIERr_t));
    PHYMOD_MEMSET(&mod_abs_hi_eier, 0, sizeof(BCMI_DINO_MOD_ABS_HI_EIERr_t));
    ...
    switch(intr_grp) {
        case 0:
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_READ_M0_EIERr(pa, &m0_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_M0_EIERr_GET(m0_eier)) : (intr_mask & BCMI_DINO_M0_EIERr_GET(m0_eier)));
            BCMI_DINO_M0_EIERr_SET(m0_eier, data);
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_WRITE_M0_EIERr(pa, m0_eier));                    
        break;
        case 1:
	        PHYMOD_IF_ERR_RETURN(
        ...
        case 7:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_0_EIERr(pa, &sys_misc_0_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_SYS_MISC_0_EIERr_GET(sys_misc_0_eier)) : (intr_mask & BCMI_DINO_SYS_MISC_0_EIERr_GET(sys_misc_0_eier)));
            BCMI_DINO_SYS_MISC_0_EIERr_SET(sys_misc_0_eier, data);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_SYS_MISC_0_EIERr(pa, sys_misc_0_eier));
        break;
        case 8:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_1_EIERr(pa, &sys_misc_1_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_SYS_MISC_1_EIERr_GET(sys_misc_1_eier)) : (intr_mask & BCMI_DINO_SYS_MISC_1_EIERr_GET(sys_misc_1_eier)));
            BCMI_DINO_SYS_MISC_1_EIERr_SET(sys_misc_1_eier, data);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_SYS_MISC_1_EIERr(pa, sys_misc_1_eier));
        break;
        case 9:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_0_EIERr(pa, &line_misc_0_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_LIN_MISC_0_EIERr_GET(line_misc_0_eier)) : (intr_mask & BCMI_DINO_LIN_MISC_0_EIERr_GET(line_misc_0_eier)));
            BCMI_DINO_LIN_MISC_0_EIERr_SET(line_misc_0_eier, data);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_LIN_MISC_0_EIERr(pa, line_misc_0_eier));
        break;
        case 10:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_1_EIERr(pa, &line_misc_1_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_LIN_MISC_1_EIERr_GET(line_misc_1_eier)) : (intr_mask & BCMI_DINO_LIN_MISC_1_EIERr_GET(line_misc_1_eier)));
            BCMI_DINO_LIN_MISC_1_EIERr_SET(line_misc_1_eier, data);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_LIN_MISC_1_EIERr(pa, line_misc_1_eier));
        break;
        case 11:
	        PHYMOD_IF_ERR_RETURN(
        ...
        case 13:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_LOW_EIERr(pa, &mod_abs_low_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_MOD_ABS_LOW_EIERr_GET(mod_abs_low_eier)) : (intr_mask & BCMI_DINO_MOD_ABS_LOW_EIERr_GET(mod_abs_low_eier)));
            BCMI_DINO_MOD_ABS_LOW_EIERr_SET(mod_abs_low_eier, data);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_MOD_ABS_LOW_EIERr(pa, mod_abs_low_eier));
        break;
        case 14:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_HI_EIERr(pa, &mod_abs_hi_eier));
  	        data = (enable ? (intr_mask | BCMI_DINO_MOD_ABS_HI_EIERr_GET(mod_abs_hi_eier)) : (intr_mask & BCMI_DINO_MOD_ABS_HI_EIERr_GET(mod_abs_hi_eier)));
            BCMI_DINO_MOD_ABS_HI_EIERr_SET(mod_abs_hi_eier, data);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_MOD_ABS_HI_EIERr(pa, mod_abs_hi_eier));
        break;
        default:
            return PHYMOD_E_PARAM;
    }
...
int _dino_phy_intr_enable_get(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* enable)
{
    ...
    switch(intr_grp) {
        case 0:
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_READ_M0_EIERr(pa, &m0_eier));
  	        data = BCMI_DINO_M0_EIERr_GET(m0_eier);
        break;
        case 1:
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_READ_LIN_25G_0_EIERr(pa, &line_25g_0_eier));
        ...
        case 7:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_0_EIERr(pa, &sys_misc_0_eier));
  	        data = BCMI_DINO_SYS_MISC_0_EIERr_GET(sys_misc_0_eier);
        break;
        case 8:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_1_EIERr(pa, &sys_misc_1_eier));
  	        data = BCMI_DINO_SYS_MISC_1_EIERr_GET(sys_misc_1_eier);
        break;
        case 9:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_0_EIERr(pa, &line_misc_0_eier));
  	        data = BCMI_DINO_LIN_MISC_0_EIERr_GET(line_misc_0_eier);
        break;
        case 10:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_1_EIERr(pa, &line_misc_1_eier));
  	        data = BCMI_DINO_LIN_MISC_1_EIERr_GET(line_misc_1_eier);
        break;
        case 11:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_2_EIERr(pa, &line_misc_2_eier));
        ...
        case 13:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_LOW_EIERr(pa, &mod_abs_low_eier));
  	        data = BCMI_DINO_MOD_ABS_LOW_EIERr_GET(mod_abs_low_eier);
        break;
        case 14:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_HI_EIERr(pa, &mod_abs_hi_eier));
  	        data = BCMI_DINO_MOD_ABS_HI_EIERr_GET(mod_abs_hi_eier);
        break;
        default:
            return PHYMOD_E_PARAM;
    }
...
int _dino_phy_intr_status_get(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* intr_status)
{
    uint16_t intr_grp = 0;
    uint16_t bit_pos = 0;
    uint16_t data = 0;
    BCMI_DINO_M0_EISRr_t m0_eisr;
    ...
    BCMI_DINO_SYS_MISC_0_EISRr_t sys_misc_0_eisr;
    BCMI_DINO_SYS_MISC_1_EISRr_t sys_misc_1_eisr;
    BCMI_DINO_LIN_MISC_0_EISRr_t line_misc_0_eisr;
    BCMI_DINO_LIN_MISC_1_EISRr_t line_misc_1_eisr;
    BCMI_DINO_LIN_MISC_2_EISRr_t line_misc_2_eisr;
    BCMI_DINO_MISC_EISRr_t misc_eisr;
    BCMI_DINO_MOD_ABS_LOW_EISRr_t mod_abs_low_eisr;
    BCMI_DINO_MOD_ABS_HI_EISRr_t mod_abs_hi_eisr;
    const phymod_access_t *pa = &phy->access;

    PHYMOD_MEMSET(&m0_eisr, 0, sizeof(BCMI_DINO_M0_EISRr_t));
    ...
    PHYMOD_MEMSET(&sys_misc_0_eisr, 0, sizeof(BCMI_DINO_SYS_MISC_0_EISRr_t));
    PHYMOD_MEMSET(&sys_misc_1_eisr, 0, sizeof(BCMI_DINO_SYS_MISC_1_EISRr_t));
    PHYMOD_MEMSET(&line_misc_0_eisr, 0, sizeof(BCMI_DINO_LIN_MISC_0_EISRr_t));
    PHYMOD_MEMSET(&line_misc_1_eisr, 0, sizeof(BCMI_DINO_LIN_MISC_1_EISRr_t));
    ...
    PHYMOD_MEMSET(&mod_abs_low_eisr, 0, sizeof(BCMI_DINO_MOD_ABS_LOW_EISRr_t));
    PHYMOD_MEMSET(&mod_abs_hi_eisr, 0, sizeof(BCMI_DINO_MOD_ABS_HI_EISRr_t));
    ...
    switch(intr_grp) {
        case 0:
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_READ_M0_EISRr(pa, &m0_eisr));
  	        data = BCMI_DINO_M0_EISRr_GET(m0_eisr);
        break;
        case 1:
	        PHYMOD_IF_ERR_RETURN(
        ...
        case 7:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_0_EISRr(pa, &sys_misc_0_eisr));
  	        data = BCMI_DINO_SYS_MISC_0_EISRr_GET(sys_misc_0_eisr);
        break;
        case 8:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_1_EISRr(pa, &sys_misc_1_eisr));
  	        data = BCMI_DINO_SYS_MISC_1_EISRr_GET(sys_misc_1_eisr);
        break;
        case 9:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_0_EISRr(pa, &line_misc_0_eisr));
  	        data = BCMI_DINO_LIN_MISC_0_EISRr_GET(line_misc_0_eisr);
        break;
        case 10:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_1_EISRr(pa, &line_misc_1_eisr));
  	        data = BCMI_DINO_LIN_MISC_1_EISRr_GET(line_misc_1_eisr);
        break;
        case 11:
	        PHYMOD_IF_ERR_RETURN(
        ...
        case 13:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_LOW_EISRr(pa, &mod_abs_low_eisr));
  	        data = BCMI_DINO_MOD_ABS_LOW_EISRr_GET(mod_abs_low_eisr);
        break;
        case 14:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_HI_EISRr(pa, &mod_abs_hi_eisr));
  	        data = BCMI_DINO_MOD_ABS_HI_EISRr_GET(mod_abs_hi_eisr);
        break;
        default:
            return PHYMOD_E_PARAM;
    }
...
int _dino_phy_intr_status_clear(const phymod_phy_access_t* phy, uint32_t intr_type)
{
    ...
    switch(intr_grp) {
        case 0:
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_READ_M0_EISRr(pa, &m0_eisr));
            BCMI_DINO_M0_EISRr_SET(m0_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_WRITE_M0_EISRr(pa, m0_eisr));                    
        break;
        case 1:
	        PHYMOD_IF_ERR_RETURN(
                BCMI_DINO_READ_LIN_25G_0_EISRr(pa, &line_25g_0_eisr));
        ...
        case 7:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_0_EISRr(pa, &sys_misc_0_eisr));
            BCMI_DINO_SYS_MISC_0_EISRr_SET(sys_misc_0_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_SYS_MISC_0_EISRr(pa, sys_misc_0_eisr));
        break;
        case 8:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_SYS_MISC_1_EISRr(pa, &sys_misc_1_eisr));
            BCMI_DINO_SYS_MISC_1_EISRr_SET(sys_misc_1_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_SYS_MISC_1_EISRr(pa, sys_misc_1_eisr));
        break;
        case 9:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_0_EISRr(pa, &line_misc_0_eisr));
            BCMI_DINO_LIN_MISC_0_EISRr_SET(line_misc_0_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_LIN_MISC_0_EISRr(pa, line_misc_0_eisr));
        break;
        case 10:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_1_EISRr(pa, &line_misc_1_eisr));
            BCMI_DINO_LIN_MISC_1_EISRr_SET(line_misc_1_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_LIN_MISC_1_EISRr(pa, line_misc_1_eisr));
        break;
        case 11:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_LIN_MISC_2_EISRr(pa, &line_misc_2_eisr));
        ...
        case 13:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_LOW_EISRr(pa, &mod_abs_low_eisr));
            BCMI_DINO_MOD_ABS_LOW_EISRr_SET(mod_abs_low_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_MOD_ABS_LOW_EISRr(pa, mod_abs_low_eisr));
        break;
        case 14:
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_READ_MOD_ABS_HI_EISRr(pa, &mod_abs_hi_eisr));
            BCMI_DINO_MOD_ABS_HI_EISRr_SET(mod_abs_hi_eisr, intr_mask);
	        PHYMOD_IF_ERR_RETURN(
	            BCMI_DINO_WRITE_MOD_ABS_HI_EISRr(pa, mod_abs_hi_eisr));
        break;
        default:
            return PHYMOD_E_PARAM;
    }
