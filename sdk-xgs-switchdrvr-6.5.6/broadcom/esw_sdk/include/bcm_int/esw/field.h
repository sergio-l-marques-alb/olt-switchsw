...
#define BCM_FIELD_WB_DEFAULT_VERSION            BCM_FIELD_WB_VERSION_1_21
#endif 
...
typedef enum _field_action_set_type_e {
    ...
    _FieldEmActionTimeStampSet = 17,
    _FieldEmActionDlbEcmpSet = 18,
    _FieldEmActionDlbHgtLagSet = 19,
    _FieldEmActionDlbAlternatePathControlSet = 20,
    _FieldEmActionProtectionSwitchingSet = 21,
    _FieldEmActionInstrumentationSet = 22,
    _FieldEmActionSetCount = 23
} _field_action_set_type_t;
...
typedef enum _bcmFieldActionNoParam_e {
    ...
    _bcmFieldActionNoParamCount  /* 48 */
