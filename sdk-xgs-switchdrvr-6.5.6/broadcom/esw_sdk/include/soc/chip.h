...
typedef enum soc_block_type_e {
    ...
    SOC_BLK_PGW_GE,
    SOC_BLK_END_NOT_DNX,
    SOC_BLK_FIRST_DNX = 10000, /* all DNX blocks should apear betweenSOC_BLK_FIRST_DNX SOC_BLK_LAST_DNX*/
    SOC_BLK_FIRST_DPP = SOC_BLK_FIRST_DNX,
    /* Petra-B block info */
...
typedef struct {
    ...
    soc_reg_t en_reg;
    soc_field_t en_fld;
    soc_reg_t ecc_1b_report_en_reg;
    soc_field_t ecc_1b_report_en_fld;
