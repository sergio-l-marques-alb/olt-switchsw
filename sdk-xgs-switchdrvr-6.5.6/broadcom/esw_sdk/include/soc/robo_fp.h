...
typedef enum drv_field_qualify_e {
    ...
    drvFieldQaulifyPreselId = 619,      /* Program selection value in 2nd Pass
                                           ...
                                           preselector-id. */
    drvFieldQualifyCount = 620          /* Always Last. Not a usable value. */
} drv_field_qualify_t;
...
typedef enum drv_field_action_e {
    ...
    drvFieldActionDynamicTrunkAllEnable = 448, /* Force packets to use DLB when matched
                                           by IFP rules, even though the Group
                                           Table indicates hash-based load
                                           balancing is to be used. */
    drvFieldActionDynamicEcmpCancel = drvFieldActionEcmpLoadBalanceCancel, /* Same as
                                           bcmFieldActionEcmpLoadBalanceCancel. */
    drvFieldActionDynamicTrunkAllCancel = 449, /* Force packets to use hash-based load
    ...
    drvFieldActionCount = 466           /* Always Last. Not a usable value. */
} drv_field_action_t;
...
typedef struct drv_policer_config_s {
    ...
    uint32 max_ckbits_sec;              /* Maximum Committed rate, Applicable
                                           only for cascade mode. */
