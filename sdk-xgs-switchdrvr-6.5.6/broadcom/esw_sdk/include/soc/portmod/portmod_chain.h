...
int
portmod_port_line_interface_is_valid(const phymod_phy_access_t* phy_acc, soc_port_t port, int data_rate,
                                  phymod_interface_t line_intf, int num_lanes, uint32_t intf_mode, int *is_valid);

int
portmod_port_line_interface_map_for_xphy(const phymod_phy_access_t* phy_acc, soc_port_t port,
                                  soc_port_if_t line_intf, soc_port_if_t *mapped_line_intf);

int portmod_port_phymod_xphy_default_interface_get(const phymod_phy_access_t* phy_acc,
