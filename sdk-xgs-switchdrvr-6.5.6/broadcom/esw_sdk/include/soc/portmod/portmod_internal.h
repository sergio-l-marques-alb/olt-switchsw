...
#define PORTMOD_PM4X10Q_USER_ACC_CMD_FOR_PHY_GET(a, idx) \
        ((portmod_pm4x10q_user_data_t *)((a[idx].access).user_acc))->qsgmiie_user_data.cmd_for_phy
#define PORTMOD_PM4X10Q_USER_ACC_CMD_FOR_PHY_SET(a, idx) \
        ((portmod_pm4x10q_user_data_t *)((a[idx].access).user_acc))->qsgmiie_user_data.cmd_for_phy = 1
#define PORTMOD_PM4X10Q_USER_ACC_CMD_FOR_PHY_CLR(a, idx) \
        ((portmod_pm4x10q_user_data_t *)((a[idx].access).user_acc))->qsgmiie_user_data.cmd_for_phy = 0

#define PORTMOD_PHY_ACC_CMD_FOR_PHY_GET(a, idx) \
        (a[idx].type == phymodDispatchTypeQsgmiie) ?\
        (PORTMOD_PM4X10Q_USER_ACC_CMD_FOR_PHY_GET(a, idx)) :\
        (PORTMOD_USER_ACC_CMD_FOR_PHY_GET(a, idx))
#define PORTMOD_PHY_ACC_CMD_FOR_PHY_SET(a, idx) \
        (a[idx].type == phymodDispatchTypeQsgmiie) ?\
        (PORTMOD_PM4X10Q_USER_ACC_CMD_FOR_PHY_SET(a, idx)) :\
        (PORTMOD_USER_ACC_CMD_FOR_PHY_SET(a, idx))
#define PORTMOD_PHY_ACC_CMD_FOR_PHY_CLR(a, idx) \
        (a[idx].type == phymodDispatchTypeQsgmiie) ?\
        (PORTMOD_PM4X10Q_USER_ACC_CMD_FOR_PHY_CLR(a, idx)) :\
        (PORTMOD_USER_ACC_CMD_FOR_PHY_CLR(a, idx))
