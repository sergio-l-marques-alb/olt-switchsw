...
void cliTreePolicyClassMapViolateAction(EwsCliCommandP depth1)
{
  ...
  if (usmDbFeaturePresentCheck(unit, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
                               L7_DIFFSERV_POLICY_ATTR_MARK_COS_POLICE_ACTION_FEATURE_ID) == L7_TRUE)
  {
  ...
  if ((usmDbFeaturePresentCheck(unit, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID, L7_DIFFSERV_POLICY_ATTR_MARK_COSASCOS2_FEATURE_ID) == L7_TRUE) &&
      (usmDbFeaturePresentCheck(unit, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID, L7_DIFFSERV_POLICY_ATTR_MARK_COS_POLICE_ACTION_FEATURE_ID) == L7_TRUE))
  {
