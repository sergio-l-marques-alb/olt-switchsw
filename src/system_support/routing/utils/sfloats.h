 ...
 * @create          
 *
 * @author          Nelson Morgan and John Wawrzynek
 *
 * @end
 *
 * ********************************************************************/
...
otherwise returns 0.
-------------------------------------------------------------------------------*/
flag8 float32_is_nan( float32 a )
{
...
-------------------------------------------------------------------------------*/
flag8 float32_is_signaling_nan( float32 a )
{
...
{
    flag8 aIsNaN, aIsSignalingNaN, bIsNaN, bIsSignalingNaN;
...
otherwise returns 0.
-------------------------------------------------------------------------------*/
flag8 float64_is_nan( float64 a )
{
...
NaN; otherwise returns 0.
-------------------------------------------------------------------------------*/
flag8 float64_is_signaling_nan( float64 a )
{
