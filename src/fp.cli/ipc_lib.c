...
*            PR710_SDH_RA                                               *
*                                                                       *
* Descri��o: Este m�dulo possui as fun��es necess�rias para controlo de *
*            canais de comunicacao entre processos                      *
*                                                                       *
*                                                                       *
* Hist�rico:                                                            *
*            12 Mar�o 2003 - as mensagens de debuf foram colocadas      *
*                            sob a condi�ao de defini�ao do #define     *
*                            _IPC_DEBUG_.                               *
*                                                                       *
*            19 Fevereiro 2003 - primeira vers�o                        *
*                                                                       *
*                                                                       *
* Autor: Celso Lemos                                                    *
************************************************************************/
...
* Fun��o:         send_data                                                      *
*                                                                                *
* Descri��o:      Metodo que permite enviar uma mensagem para um determinado     *
...
*                                                                                *
* retorno:                                                                       *
*                 0: Opera��o decorrida com sucesso                              *
...
/*********************************************************************************
* Fun��o:         clone_proc_msg                                                 *
*                                                                                *
* Descri��o:      Metodo que suporta o clone de escuta no porto de recepcao      *
...
* Fun��o:         init_ipc_lib                                                   *
*                                                                                *
* Descri��o:      Este metodo deve se chamado antes de qualquer um dos outros.   *
...
* Fun��o:         close_ipc                                                      *
*                                                                                *
* Descri��o:      Metodo que permite destruir um canal de comunicacao alocado    *
