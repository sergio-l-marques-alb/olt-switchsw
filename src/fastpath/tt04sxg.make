...
cli:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-tt04sxg.make

shell:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-tt04sxg.make

cli_clean:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-tt04sxg.make clean

shell_clean:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-tt04sxg.make clean
