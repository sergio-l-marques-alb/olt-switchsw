...
export KERNEL_PATH        = $(OLT_DIR)/../lib/kernel/linux-3.6.5_kt2-olt1t0f
...
welcome: 
	...
	@echo "##############################################"
	@echo "#                                            #"
	@echo "#  FastPath Makefile for the OLT1T0F card    #"
	@echo "#                                            #"
	@echo "##############################################"
	@echo ""
...
cli:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-olt1t0f.make

shell:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-olt1t0f.make

cli_clean:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-olt1t0f.make clean

shell_clean:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-olt1t0f.make clean
