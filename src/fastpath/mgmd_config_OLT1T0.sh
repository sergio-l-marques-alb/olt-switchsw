#############################################
#                                           #
# MGMD configure script for the TG16G card  #
#                                           #
...
LD_LIBRARY_PATH=/opt/broadcom/lib
MAX_CHANNELS=4096
MAX_WHITELIST=16384
MAX_CLIENTS=512
MAX_FP_PORTS=12
...
sed -i "s|export LD_LIBRARY_PATH=.*|export LD_LIBRARY_PATH=$LD_LIBRARY_PATH|" $TEMPORARY_CONFIG_FILE
