...
kernel:
	cd $(KERNEL_PATH) && ./build_tt08sxg.sh
...
welcome: 
	...
	@echo "###########################################"
	@echo "#                                         #"
	@echo "#  FastPath Makefile for the TT08SXG card #"
	@echo "#                                         #"
	@echo "###########################################"
	@echo ""
...
cli:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-tt08sxg.make

shell:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-tt08sxg.make

cli_clean:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-tt08sxg.make clean

shell_clean:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-tt08sxg.make clean
