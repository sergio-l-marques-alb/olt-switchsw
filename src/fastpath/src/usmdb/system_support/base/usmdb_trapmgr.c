...
L7_RC_t usmDbTrapManagerIpAddrSet(L7_uint32 UnitIndex, L7_uint32 Index, L7_char8 *ip_address)
{
  ...
  else if (usmDbNetworkAddressValidate(inetint) == L7_SUCCESS)
  {
...
L7_RC_t usmDbTrapManagerIPv6AddrSet(L7_uint32 UnitIndex, L7_uint32 Index, L7_in6_addr_t *ipv6_address)
{
  ...
  if (inetIpAddressValidityCheck(L7_AF_INET6, &inetAddr) == L7_SUCCESS)
  {
...
/*********************************************************************
*
* @purpose Get the SNMP IP Address Type per index.
*
* @param L7_uint32 UnitIndex    @b((input))  The unit for this operation
* @param L7_uint32 Index        @b((input))  Index
* @param L7_uint32 *ip_address_type  @b((output)) Returned IP address Type
*
* @returns L7_SUCCESS
* @returns L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbTrapManagerIpAddrTypeGet(L7_uint32 UnitIndex, L7_uint32 Index, L7_uint32 *ip_address_type)
{
  #ifdef L7_SNMP_PACKAGE
    return SnmpTrapMgrIpAddrTypeGet(Index, ip_address_type);
  #else
    return L7_NOT_SUPPORTED;
  #endif
}
...
/*********************************************************************
*
* @purpose Set the SNMP IP Address Type per index.
*
* @param L7_uint32 UnitIndex           @b((input)) The unit for this operation
* @param L7_uint32 TrapCommIndex  @b((input)) Index number
* @param L7_uint32  *ip_address_type         @b((input)) The IP address Type
*
* @returns L7_SUCCESS
* @returns L7_FAILURE
*
...
*
*********************************************************************/
L7_RC_t usmDbTrapManagerIpAddrTypeSet(L7_uint32 UnitIndex, L7_uint32 Index, L7_uint32 ip_address_type)
{
  #ifdef L7_SNMP_PACKAGE
    return SnmpTrapMgrIpAddrTypeSet(Index, ip_address_type);
  #else
    return L7_NOT_SUPPORTED;
  #endif
}
...
/*********************************************************************
*
* @purpose Issue a StackRestartComplete trap.
*
* @param L7_int32   unitId @b((input)) The unit that completed the restart
* @param L7_LAST_STARTUP_REASON_t   reason @b((input)) The restart reason
*
* @returns L7_SUCCESS, if success
* @returns L7_FAILURE, if failure
*
...
*
*********************************************************************/
L7_RC_t usmDbTrapMgrStackRestartCompleteTrapSend(L7_int32 unitId,
                                               L7_LAST_STARTUP_REASON_t reason)
{
  return trapMgrStackRestartCompleteLogTrap(unitId, reason);
}
...
/*********************************************************************
*
* @purpose Issue a SFS Start trap.
*
* @param L7_int32 unitNumber @b((input)) Stack member unit number
*
* @returns L7_SUCCESS, if success
* @returns L7_FAILURE, if failure
*
...
*
*********************************************************************/
L7_RC_t usmDbTrapMgrUnitMgrSfsStartTrapSend(L7_int32 unitNumber)
{
  return trapMgrUnitMgrSfsStartTrapSend(unitNumber);
}

/*********************************************************************
*
* @purpose Issue a SFS complete trap.
*
* @param L7_int32 unitNumber @b((input)) Stack member unit number
*
* @returns L7_SUCCESS, if success
...
*
*********************************************************************/
L7_RC_t usmDbTrapMgrUnitMgrSfsFinishTrapSend(L7_int32 unitNumber)
{
  return trapMgrUnitMgrSfsFinishTrapSend(unitNumber);
}

/*********************************************************************
*
* @purpose Issue a SFS Failure trap.
*
* @param L7_int32 unitNumber @b((input)) Stack member unit number
*
* @returns L7_SUCCESS, if success
...
*
*********************************************************************/
L7_RC_t usmDbTrapMgrUnitMgrSfsFailTrapSend(L7_int32 unitNumber)
{
  return trapMgrUnitMgrSfsFailTrapSend(unitNumber);
}
/*********************************************************************
*
* @purpose Issue a Email send Failure trap.
*
* @param L7_int32 noEmailFailures@b((input)) No of emails failed
*
* @returns L7_SUCCESS, if success
* @returns L7_FAILURE, if failure
*
