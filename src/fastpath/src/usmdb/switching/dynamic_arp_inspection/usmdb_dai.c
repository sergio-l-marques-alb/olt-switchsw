...
* @end
*********************************************************************/
L7_RC_t usmDbArpAclRuleGet(L7_uchar8 *aclName, L7_uint32 ipAddr, L7_enetMacAddr_t *macAddr)
{
...
* @end
*********************************************************************/
L7_RC_t usmDbArpAclRuleNextGet(L7_uchar8 *aclNameIn, L7_uint32 ipAddrIn, L7_enetMacAddr_t *macAddrIn,
                               L7_uchar8 *aclNameOut, L7_uint32 *ipAddrOut, L7_enetMacAddr_t *macAddrOut)
{
...
* @end
*********************************************************************/
L7_RC_t usmDbArpAclRuleInAclNextGet(L7_uchar8 *aclName, L7_uint32 ipAddrIn, L7_enetMacAddr_t *macAddrIn,
