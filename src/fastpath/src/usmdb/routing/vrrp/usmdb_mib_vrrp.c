...
**********************************************************************
*
* @filename src\usmdb\usmdb_mib_vrrp.c
*
* @purpose  Provide interface to hardware API's VRRP rfc2787/2338 MIB components
*                  
* @component usmdb
*
* @comments tba
...
L7_RC_t usmDbVrrpOperVirtualMacAddrGet(L7_uint32 unitIndex, 
                                       L7_uchar8 vrId, 
                                       L7_uint32 intIfNum, 
                                       L7_uchar8* vmac)
{
  return L7_vrrpOperVirtualMacAddrGet(vrId,intIfNum,vmac);
}
...
L7_RC_t usmDbVrrpOperIpAddrCountGet(L7_uint32 unitIndex, 
                                    L7_uchar8 vrId, 
                                    L7_uint32 intIfNum, 
                                    L7_uchar8* count)
{
  return L7_vrrpOperIpAddrCountGet(vrId, intIfNum, 
                                   count);
}
...
L7_RC_t usmDbVrrpOperAuthTypeGet(L7_uint32 unitIndex, 
                                 L7_uchar8 vrId, 
                                 L7_uint32 intIfNum, 
                                 L7_AUTH_TYPES_t* authType)
{
  return L7_vrrpOperAuthTypeGet(vrId, intIfNum, 
                                authType);
}
...
L7_RC_t usmDbVrrpOperAuthTypeSet(L7_uint32 unitIndex, 
                                 L7_uchar8 vrId, 
                                 L7_uint32 intIfNum, 
                                 L7_AUTH_TYPES_t authType)
{
  return L7_vrrpOperAuthTypeSet(vrId,intIfNum, 
                                authType);
}
...
L7_RC_t usmDbVrrpOperAuthKeyGet(L7_uint32 unitIndex, 
                                L7_uchar8 vrId, 
                                L7_uint32 intIfNum, 
                                L7_uchar8* authKey)
{
  return L7_vrrpOperAuthKeyGet(vrId, intIfNum, 
                               authKey);
}
...
L7_RC_t usmDbVrrpOperAuthKeySet(L7_uint32 unitIndex, 
                                L7_uchar8 vrId, 
                                L7_uint32 intIfNum, 
                                L7_uchar8* authKey)
{
  return L7_vrrpOperAuthKeySet(vrId, intIfNum, 
                               authKey);
}
...
L7_RC_t usmDbVrrpOperTrackIntfAdd(L7_uint32 unitIndex, L7_uchar8 vrId,
                                       ...
                                       L7_uchar8 prio_dec )
{
  return L7_vrrpOperTrackIntfAdd(vrId, intIfNum,
                                 trackIntIfNum, 
                                 prio_dec);
}
...
L7_RC_t usmDbVrrpOperTrackIntfDelete(L7_uint32 unitIndex, L7_uchar8 vrId,
                                          L7_uint32 intIfNum, L7_uint32 trackIntIfNum)
{
  return L7_vrrpOperTrackIntfDelete( vrId, intIfNum,
                                     trackIntIfNum );
}
...
L7_RC_t usmDbVrrpOperTrackIntfPrioGet(L7_uint32 unitIndex, L7_uchar8 vrId,
                                      ...
                                      L7_uchar8 *prio_dec )
{
  return  L7_vrrpOperTrackIntfPrioGet(vrId, intIfNum, trackIntIfNum, prio_dec);
}
...
L7_RC_t usmDbVrrpOperTrackIntfStateGet(L7_uint32 unitIndex, L7_uchar8 vrId,
                                       ...
                                       L7_BOOL *state )
{
  return L7_vrrpOperTrackIntfStateGet (vrId, intIfNum, trackIntIfNum,state);
}
...
L7_RC_t usmDbVrrpOperTrackIntfNextGet(L7_uint32 unitIndex,L7_uchar8 *vrId, 
                                      L7_uint32 *intIfNum,L7_uint32 * trackIntIfNum)
{
  return  L7_vrrpOperTrackIntfNextGet(vrId, intIfNum, trackIntIfNum);
}
...
{
  return  L7_vrrpVrIdIntfTrackIntfNextGet(vrId, intIfNum, trackIntIfNum, prio_dec);
}
...
{
   return  L7_vrrpVrIdIntfTrackIntfGet(vrId, intIfNum, trackIntIfNum);
}
...
L7_RC_t usmDbVrrpVrIdIntfTrackRouteGet(L7_uint32 unitIndex, L7_uchar8 vrId,
                                       ...
                                       L7_uint32 netMask )
{
  return L7_vrrpVrIdIntfTrackRouteGet(vrId, intIfNum, ipAddr, netMask);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpVrTrackedRouteGetFirst(L7_uchar8 vrId, L7_uint32 intIfNum, 
                                        L7_uint32 *ipAddr, L7_uint32 *netmask)
{
  return vrrpVrTrackedRouteGetFirst(vrId, intIfNum, ipAddr, netmask);
}
...
L7_RC_t usmDbVrrpOperTrackRouteNextGet(L7_uint32 unitIndex, L7_uchar8 *vrId, 
                                       ...
                                       L7_uint32 * mask )
{
  return L7_vrrpOperTrackRouteNextGet (vrId, intIfNum, ipAddr, mask);
}
...
{
  return L7_vrrpVridIntfTrackRouteNextGet (vrId, intIfNum, ipAddr, mask, prio_dec);
}
...
* @param    mask @b{(input)} Mask of the Route
* @param    prio_dec @b{(input)} priority to be decremented
*
* @returns  L7_SUCCESS  if router configuraion is present
* @returns  L7_FAILURE  if no configuration found.
...
L7_RC_t usmDbVrrpOperTrackRouteAdd(L7_uint32 unitIndex, L7_uchar8 vrId,
                                   ...
                                   L7_uint32 mask, L7_uchar8 prio_dec)
{
  return L7_vrrpOperTrackRouteAdd( vrId, intIfNum, 
                                   netAddr, mask,
                                   prio_dec);
}
...
L7_RC_t usmDbVrrpOperTrackRouteDelete(L7_uint32 unitIndex, L7_uchar8 vrId,
                                      ...
                                      L7_uint32 mask)
{
  return L7_vrrpOperTrackRouteDelete(vrId, intIfNum, netAddr, mask);
}
...
L7_RC_t usmDbVrrpOperTrackRoutePrioGet(L7_uint32 unitIndex,
                                       ...
                                       L7_uchar8 *prio_dec )
{
  return L7_vrrpOperTrackRoutePrioGet (vrId, intIfNum, ipAddr, netMask, prio_dec);
}
...
L7_RC_t usmDbVrrpOperTrackRouteReachabilityGet(L7_uint32 unitIndex,L7_uchar8 vrId,
                                               ...
                                               L7_BOOL *reachable )
{
  return L7_vrrpOperTrackRouteReachabilityGet(vrId, intIfNum, ipAddr, netMask, reachable);
}
...
* @param    vrId    @b{input} Router Id. 
* @param    intIfNum  @b{input} Interface Number
* @param    priority   @b{output} returned value of priority 
*
* @returns  L7_SUCCESS  if router configuraion is present 
* @returns  L7_FAILURE  if no configuration found.
*
...
L7_RC_t usmDbVrrpOperPriorityGet(L7_uint32 unitIndex, 
                                 L7_uchar8 vrId, 
                                 L7_uint32 intIfNum,
                                 L7_uchar8* priority)
{

 return L7_vrrpOperPriorityGet(vrId, intIfNum, 
                               priority);
}

/*********************************************************************
* @purpose  Function to get the VRRP Configured priority
*
* @param    routerID @b{input} router Id
* @param    intIfNum @b{input} Interface Number
* @param    priority @b{output} pointer to priority
*
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpConfigPriorityGet(L7_uint32 unitIndex,L7_uchar8 routerID,
                                 L7_uint32 intIfNum,
                                 L7_uchar8* priority)
{
  return L7_vrrpConfigPriorityGet(routerID, intIfNum, priority);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpConfigPrioritySet(L7_uchar8 vrid,
                                   L7_uint32 intIfNum,
                                   L7_uchar8 priority)
{
  return vrrpConfigPrioritySet(vrid, intIfNum, priority);
}
...
L7_RC_t usmDbVrrpOperAdvertisementIntervalGet(L7_uint32 unitIndex, 
                                              L7_uchar8 vrId, 
                                              L7_uint32 intIfNum,
                                              L7_uchar8* advIntvl)
{
  return L7_vrrpOperAdvertisementIntervalGet(vrId, 
                                             intIfNum, 
                                             advIntvl);
}
...
L7_RC_t usmDbVrrpOperAdvertisementIntervalSet(L7_uint32 unitIndex, 
                                              L7_uchar8 vrId, 
                                              L7_uint32 intIfNum,
                                              L7_uchar8 advIntvl)
{

  return L7_vrrpOperAdvertisementIntervalSet(vrId, 
                                             intIfNum, advIntvl);
}
...
L7_RC_t usmDbVrrpOperPreemptModeGet(L7_uint32 unitIndex, 
                                    L7_uchar8 vrId, 
                                    L7_uint32 intIfNum,
                                    L7_BOOL* prmtFlg)
{
  return L7_vrrpOperPreemptModeGet(vrId, intIfNum, 
                                   prmtFlg);
}
...
L7_RC_t usmDbVrrpOperPreemptModeSet(L7_uint32 unitIndex, 
                                    L7_uchar8 vrId, 
                                    L7_uint32 intIfNum,
                                    L7_BOOL prmtFlg)
{
  return L7_vrrpOperPreemptModeSet(vrId, 
                                   intIfNum, prmtFlg);
}
...
L7_RC_t usmDbVrrpRouterIdCreate(L7_uint32 unitIndex, L7_uchar8 vrId, L7_uint32 intIfNum )
{
    return (L7_vrrpVirtualRouterConfigAdd(vrId,intIfNum));
}
...
L7_RC_t usmDbVrrpRouterIdDelete(L7_uint32 unitIndex, L7_uchar8 vrId, L7_uint32 intIfNum )
{
   return (L7_vrrpVirtualRouterConfigDelete(vrId,intIfNum));
}

/*********************************************************************
* @purpose  Configure the primary IP address on a virtual router.
*
* @param    unitIndex    Unit for this operation
* @param    vrId         virtual router ID
* @param    intIfNum     internal interface number where virtual router operates
...
*
* @returns  L7_SUCCESS if address change is accepted
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpAssocIpAddress(L7_uint32 unitIndex, 
                                L7_uchar8 vrId,L7_uint32 intIfNum, 
                                L7_uint32 ipAddress)
{
  return L7_vrrpAssocIpAddress(vrId,intIfNum,ipAddress);
}
...
* @end
*********************************************************************/ 
L7_RC_t usmDbVrrpOperVrrpModeSet(L7_uint32 unitIndex, 
                                 L7_uchar8 vrId, 
                                 L7_uint32 intIfNum, 
                                 L7_vrrpStartState_t state)
{
  return L7_vrrpVrrpModeSet(vrId,intIfNum,state );
}
...
L7_RC_t usmDbVrrpOperVrrpModeGet(L7_uint32 unitIndex, 
                                 ...
                                 L7_vrrpStartState_t* state)
{
  return L7_vrrpVrrpModeGet(vrId,intIfNum,state );
}
...
L7_RC_t usmDbVrrpNodeVersionGet(L7_uint32 unitIndex,L7_uint32* version) 
{
  return L7_vrrpNodeVersionGet(version);
}
...
L7_RC_t usmDbVrrpNotificationCntlGet(L7_uint32 unitIndex,
                                     L7_uchar8* Mode) 
{
  return L7_vrrpNotificationCntlGet(Mode);
}                                         
...
extern L7_RC_t usmDbVrrpNotificationCntlSet(L7_uint32 unitIndex, 
                                            L7_uchar8 Mode)
{
  return L7_vrrpNotificationCntlSet(Mode);
}
...
{
    return L7_vrrpStateGet(vrId, intIfNum, state);
}
...
L7_RC_t usmDbVrrpOperIpAddressGet(L7_uint32 unitIndex, 
                                  ...
                                  L7_uint32* ipAddress )
{
  return L7_vrrpIpAddressGet(vrId, intIfNum, ipAddress);
}
...
L7_RC_t usmDbVrrpOperMasterIpAddressGet(L7_uint32 unitIndex, 
                                        ...
                                        L7_uint32* ipAddress )
{
  return L7_vrrpMasterIpAddressGet(vrId, intIfNum, ipAddress);
}
...
L7_RC_t usmDbVrrpOperUpTimeGet(L7_uint32 unitIndex, 
                               ...
                               L7_uint32* uptime)
{
   return L7_vrrpUpTimeGet(vrId, intIfNum, uptime);
}                                                                       

/*********************************************************************
* @purpose  To Get the The particular protocol being controlled by 
*         the Virtual Router
*
* @param    unitIndex  Unit for this operation
* @param    vrId   Router Id. 
...
{
  return L7_vrrpProtocolGet(vrId,intIfNum,protocol);

}

/*********************************************************************
* @purpose  To Set the The particular protocol being controlled by 
*         the Virtual Router
*
* @param    unitIndex  Unit for this operation
* @param    vrId   Router Id. 
...
{
  return L7_vrrpProtocolSet(vrId,intIfNum,protocol);
...
{
   return L7_vrrpChecksumErrorGet( checkSumError);
}
...
{
     return L7_vrrpRouterVerErrorGet(versionError);
}
                                  ...
                                  L7_uint32* vrIdError)
{
  ...
  return L7_vrrpVridErrorGet(vrIdError);
}
...
{
  return L7_vrrpStateMasterGet(vrId, intIfNum, 
                               masterState);
}
...
{
  return L7_vrrpAdverReceived(vrId, intIfNum, 
                              addReceived);
}
...
{
  return L7_vrrpAddIntErrorGet(vrId, 
                                 intIfNum, addIntErrors);
}
...
{
  return L7_vrrpAuthFailedGet(vrId, intIfNum, 
                                authFailedPkt);
...
{
  return L7_vrrpIpTTLFailedGet(vrId, intIfNum, 
                                 ttlFailedPkt);
...
{
  return L7_vrrpZeroPriorityRcvGet(vrId, intIfNum, 
                                     zeroPriorRcvPkt);
}
...
{
  return L7_vrrpZeroPrioritySentGet(vrId, intIfNum, 
                                      zeroPriorSentPkt);
}
...
{
  return L7_vrrpInvldTypePktGet(vrId, intIfNum, 
                                  invalidTypePkt);
}
...
{
  return L7_vrrpAddListErrGet(vrId, intIfNum, 
                                addListerrPkt);
...
{ 
  return L7_vrrpInvldAuthTypeGet(vrId, intIfNum, 
                                   invAuthTypePkt);
}
...
{
  return L7_vrrpAuthTypeMismatchGet(vrId, intIfNum, 
                                      authMismatchPkt);
}
...
L7_RC_t usmDbVrrpStatsPktLengthGet (L7_uint32 unitIndex, 
                                   ...
                                   L7_uint32* pktError)
{
  return L7_vrrpInvldPktGet(vrId, intIfNum, pktError);
}
...
{
  return L7_vrrpAdminModeGet(mode);
}
...
L7_RC_t usmDbVrrpOperAdminStateSet(L7_uint32 unitIndex, 
                                  L7_BOOL mode)
{
  return L7_vrrpAdminModeSet(mode);
...
L7_RC_t usmDbVrrpOperFirstGet(L7_uint32 unitIndex,
                              L7_uchar8* vrId, L7_uint32* intIfNum)
{
  return L7_vrrpFirstGet(vrId,intIfNum);
}
...
L7_RC_t usmDbVrrpOperNextGet(L7_uint32 unitIndex, L7_uchar8 vrId, 
                             L7_uint32 intIfNum, L7_uchar8* nextVrId, 
                             L7_uint32* nextInfNum)
{
  return L7_vrrpNextGet(vrId,intIfNum,nextVrId,nextInfNum);
}
...
L7_RC_t usmDbVrrpOperEntryGet(L7_uint32 unitIndex, L7_uchar8 vrId, 
                              L7_uint32 intIfNum)
{
  return L7_vrrpOperEntryGet(vrId,intIfNum);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpOperEntryNextGet(L7_uint32 unitIndex,
                                  L7_uchar8 vrId, 
                                  L7_uint32 intIfNum,
                                  L7_uchar8* nextVrId, 
                                  L7_uint32* nextInfNum)
{
  return L7_vrrpOperEntryNextGet(vrId,intIfNum,nextVrId,nextInfNum);
}
...
{
  L7_uint32 ipAddr;
  if( L7_vrrpIpAddressGet(vrId,intIfNum, &ipAddr)== L7_SUCCESS)
  {
    if( ipAddr == ipAddress)
    {
      return L7_SUCCESS;
...
{
  return L7_vrrpAssoIpAddrEntryNextGet(vrId, intIfNum, ipAddress, vrIdNext,
                                              intIfNumNext, ipAddressNext);
}
...
{
  L7_uchar8 vrId;
  return L7_vrrpVMacGet(ipAddress,vMac, &vrId);
}
...
L7_RC_t usmDbVrrpIpGet(L7_uint32 UnitIndex, L7_uchar8* vMac,
                       L7_uint32 *ipAddress)
{
  return L7_vrrpIpGet(vMac,ipAddress);
}
...
L7_RC_t usmDbVrrpZeroPriorityFlgGet(L7_uint32 unitIndex, 
                                    ...
                                    L7_BOOL *zeroFlg)
{
  return L7_vrrpZeroPriorityFlgGet(vrId, intIfNum, zeroFlg);
}
...
L7_RC_t usmDbVrrpZeroPriorityFlgSet(L7_uint32 unitIndex, 
                                    ...
                                    L7_BOOL zeroFlg)
{
  return L7_vrrpZeroPriorityFlgSet(vrId, intIfNum, zeroFlg);
}
...
L7_RC_t usmDbVrrpOperRowStatusGet(L7_uint32  unitIndex, 
                                  ...
                                  L7_uint32* rowStatus)
{
  return L7_vrrpOperRowStatusGet(vrId, intIfNum, rowStatus);
}
...
{
  return L7_vrrpAssocIpRowStatusGet(vrId, intIfNum, assocIpRowStat);
}
...
L7_RC_t usmDbVrrpAssocIpRowStatusSet(L7_uint32 unitIndex, 
                                    ...
                                    L7_uint32 assocIpRowStat)
{
  return L7_vrrpAssocIpRowStatusSet(vrId, intIfNum, assocIpRowStat);
}
...
{
  return trapMgrGetTrapVrrp(mode, trapType);
}
...
{
  return trapMgrSetTrapVrrp(mode, trapType);
}
...
L7_RC_t usmDbVrrpAssocSecondaryIpAddress(L7_uint32 UnitIndex,
                              ...
                              L7_uint32 ipAddress)
{
  return L7_vrrpAssocSecondaryIpAddress(routerID, intIfNum, ipAddress);
}
...
L7_RC_t usmDbVrrpDissocSecondaryIpAddress(L7_uint32 UnitIndex,
                                          ...
                                          L7_uint32 ipAddress)
{
  return L7_vrrpDissocSecondaryIpAddress(routerID, intIfNum, ipAddress);
}
...
{
  return L7_vrrpIpAddressNextGet(routerID, intIfNum, ipAddress, pIpAddress);
}
...
{
  return L7_vrrpIntfIsValid(intIfNum);
}

/*********************************************************************
* @purpose  Turns on/off the displaying of vrrp acket debug info
*
...
{
  return  vrrpDebugPacketTraceFlagSet(flag);
}
/*********************************************************************
...
{
  return vrrpDebugPacketTraceFlagGet();
}
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpOperAcceptModeSet(L7_uint32 unitIndex, 
                                   L7_uchar8 vrId,
                                   L7_uint32 intIfNum,
                                   L7_BOOL accept_mode)
{
  return L7_vrrpOperAcceptModeSet(vrId, intIfNum, accept_mode);
}
...
* @end
*********************************************************************/
L7_RC_t usmDbVrrpOperAcceptModeGet(L7_uint32 unitIndex, 
                                   L7_uchar8 vrId,
                                   L7_uint32 intIfNum,
                                   L7_BOOL *accept_mode)
{
  return L7_vrrpOperAcceptModeGet(vrId, intIfNum, accept_mode);
}

/*********************************************************************
* @purpose  To get Description string 
*
* @param    vrId     Router Id.
* @param    intIfNum    Interface Number
* @param    description returned value of Description string
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
...
L7_RC_t usmDbVrrpOperDescriptionGet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_uchar8* description)
{
  return L7_vrrpOperDescriptionGet(vrId, intIfNum, description);
}

/*********************************************************************
* @purpose  To set Description string
*
* @param    vrId   Router Id.
* @param    intIfNum  Interface Number
* @param    description  to set the description string for the vrid
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
...
L7_RC_t usmDbVrrpOperDescriptionSet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_uchar8* description)
{
  return L7_vrrpOperDescriptionSet(vrId, intIfNum, description);
}

/*********************************************************************
* @purpose  To get Timer Learning status
*
* @param    vrId     Router Id.
* @param    intIfNum    Interface Number
* @param    timerlearn returned value of timer learn mode
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
...
L7_RC_t usmDbVrrpOperTimerLearnGet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_BOOL* timerlearn)
{
  return L7_vrrpOperTimerLearnGet(vrId, intIfNum, timerlearn);
}

/*********************************************************************
* @purpose  To set Timer learning status
*
* @param    vrId   Router Id.
* @param    intIfNum  Interface Number
* @param    description  to set the description string for the vrid
...
L7_RC_t usmDbVrrpOperTimerLearnSet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_BOOL timerlearn)
{
  return L7_vrrpOperTimerLearnSet(vrId, intIfNum, timerlearn);
}

/*********************************************************************
* @purpose  To get preemption delay configured
*
* @param    vrId     Router Id.
* @param    intIfNum    Interface Number
* @param    description returned value of timer learn mode
*
* @returns  L7_SUCCESS   if router configuraion is present
* @returns  L7_FAILURE   if no configuration found.
*
...
L7_RC_t usmDbVrrpOperPreemptDelayGet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_ushort16* delay)
{
  return L7_vrrpOperPreemptDelayGet(vrId, intIfNum, delay);
...
L7_RC_t usmDbVrrpOperPreemptDelaySet(L7_uchar8 vrId, L7_uint32 intIfNum, L7_ushort16 delay)
{
  return L7_vrrpOperPreemptDelaySet(vrId, intIfNum, delay);
}
