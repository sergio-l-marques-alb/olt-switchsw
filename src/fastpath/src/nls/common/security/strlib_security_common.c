...
L7_char8 *pStrInfo_security_Dot1xVlanAssigned_Monitor= "Monitor";
...
L7_char8 *pStrInfo_security_Dot1xVlanAssigned_MonitorMode= "Monitor Mode";
L7_char8 *pStrInfo_security_Dot1xShowNumMonitorModeClients="Clients Authenticated using Monitor Mode";
L7_char8 *pStrInfo_security_Dot1xShowNumClients="Clients Authenticated using Dot1x";
