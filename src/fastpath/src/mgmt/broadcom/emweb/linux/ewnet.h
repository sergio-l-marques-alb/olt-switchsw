...
/************************************* XUI *********************************/
  /* Repeat Variables */
  #define EWS_MAX_PAGE_REPEATS 10
  int repeatCount[EWS_MAX_PAGE_REPEATS];
  int repeatMax[EWS_MAX_PAGE_REPEATS];
  int repeatCounter[EWS_MAX_PAGE_REPEATS];
  int repeatSplitCount[EWS_MAX_PAGE_REPEATS];
  char repeatRetVal[EWS_MAX_PAGE_REPEATS][32];
 ...
 /* int repeatCount;
  ...
  char lvlCheckBuf[32];
/*  boolean repeatMore; */
  boolean repeatMore[EWS_MAX_PAGE_REPEATS];
  /* Repeat Variables */
