                               ...
                               L7_uint32 aclNumber )
{
  ...
  if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    rc = usmDbDiffServClassCreate(unit, classId, L7_TRUE);
    if (rc == L7_REQUEST_DENIED)
    {
      ewsTelnetWriteAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_DiffservReqDenyApp);
      return L7_FAILURE;
    }
    else if (rc != L7_SUCCESS)
    {
      ewsTelnetWriteAddBlanks (2, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_DiffservClassEntryCreateFailed);
      return L7_FAILURE;
    }
                         ...
                         L7_uint32 direction)
{
  ...
  if (usmDbFeaturePresentCheck(0, L7_FLEX_QOS_DIFFSERV_COMPONENT_ID,
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    for (interface=1; interface < L7_MAX_INTERFACE_COUNT; interface++)
    {
      ...
      if (usmDbIntfTypeGet(interface, &intfType) != L7_SUCCESS)
      {
        ...
        ewsTelnetPrintf (ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        status = L7_FAILURE;
        continue;
      }
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if (needCreate == L7_TRUE)
        {
          ...
          if (usmDbDiffServServiceCreate(unit, interface, direction, L7_TRUE ) != L7_SUCCESS)
          {
            ...
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_AttachPolicy);
            status = L7_FAILURE;
            continue;
          }
        }
        ...
        if (needCreate == L7_TRUE)
        {
                                                  ...
                                                  L7_USMDB_MIB_DIFFSERV_ROW_STATUS_ACTIVE) != L7_SUCCESS)
          {
            ...
            usmDbDiffServServiceDelete(unit, interface, direction);
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_qos_AttachPolicy_1);
            status = L7_FAILURE;
            continue;
          }
        }
    ...
    else if (argc== depth +1)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        else if (ewsContext->commType == CLI_NO_CMD && result == L7_SUCCESS)
        {
          ...
          result = usmDbDiffServClassDelete(unit, classId );

          if (L7_REQUEST_DENIED == result)
          {
            ewsTelnetWriteAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_DiffservReqDenyAppUsingClass);
            return NULL;
          }
          else if (L7_SUCCESS != result)
          {
            ewsTelnetWriteAddBlanks (2, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext,pStrErr_qos_CantDelDiffServClass);
            return NULL;
          }
          return cliSyntaxReturnPrompt (ewsContext, "");
        }
...
const L7_char8 *cliPolicyMapMode(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    if (ewsContext->commType == CLI_NO_CMD && result == L7_SUCCESS)
    {
      ...
      rc = usmDbDiffServPolicyDelete(unit, policyId );

      if (rc == L7_REQUEST_DENIED)
      {
        return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_DiffservReqDenyAppUsingPolicy);
      }
      else if (rc != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_DiffservPolicyRemoveFailed);
      }
    ...
    else if (ewsContext->commType != CLI_NO_CMD && result != L7_SUCCESS)
    {
      ...
      rc = usmDbDiffServPolicyCreate(unit, policyId, L7_TRUE);
      if (rc == L7_REQUEST_DENIED)
      {
        ewsTelnetWriteAddBlanks (2, 1, 1, 0, L7_NULLPTR, ewsContext, pStrErr_qos_DiffservReqDenyApp);
        return NULL;
      }
      else if (rc != L7_SUCCESS)
      {
        ewsTelnetWriteAddBlanks (2, 1, 1, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_CreateDiffservPolicy_1);
        return NULL;
      }

      /* set the name of the policy */
      if (usmDbDiffServPolicyNameSet(unit, policyId, strName) != L7_SUCCESS)
      {
        /* delete the row entry just created*/
  ...
  if (argc ==  depth+1 && mainMenu[cliCurrentHandleGet()] != cliGetMode(L7_POLICY_CLASS_MODE))
  {
    ...
    if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      if (ewsContext->commType == CLI_NORMAL_CMD && result!= L7_SUCCESS)
      {
        ...
        rc = usmDbDiffServPolicyInstCreate(unit, policyId, policyInstId, L7_TRUE);
        if (rc == L7_REQUEST_DENIED)
        {
          ewsTelnetWriteAddBlanks (2, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_qos_DiffservReqDenyAppPolicyInstLimit);
          return NULL;
        }
        else if (rc != L7_SUCCESS)
        {
          ewsTelnetWriteAddBlanks (2, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_qos_CantAddDiffservClass);
          return NULL;
        }
      ...
      else if (ewsContext->commType != CLI_NORMAL_CMD && result== L7_SUCCESS)
      {
        ...
        rc = usmDbDiffServPolicyInstDelete(unit, policyId, policyInstId);
        ...
        {
          return cliSyntaxReturnPromptAddBlanks (2, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrInfo_qos_DiffservCantRemove);
        }
