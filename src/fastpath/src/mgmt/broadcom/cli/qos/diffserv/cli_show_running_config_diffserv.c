    ...
    */
                                 ...
                                 L7_DIFFSERV_CLASS_L3PROTO_IPV6_FEATURE_ID) == L7_TRUE)
    {
      ...
      case L7_USMDB_MIB_DIFFSERV_CLASS_L3PROTOCOL_IPV4:
        osapiStrncpySafe(classL3ProtoStr, pStrInfo_common_Diffserv_4, sizeof(classL3ProtoStr));
        break;
      case L7_USMDB_MIB_DIFFSERV_CLASS_L3PROTOCOL_IPV6:
        osapiStrncpySafe(classL3ProtoStr, pStrInfo_common_Diffserv_5, sizeof(classL3ProtoStr));
        break;
      default:
        continue;
      }
