...
void buildTreeInterfaceConfigLacp(EwsCliCommandP depth1)
{
  ...
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Range0to65535, pStrInfo_base_LacpActorPortPriInput, NULL,
                         2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NORMAL_ONLY);
...
#if 0
 /* This command has been moved to the global config mode*/
  ...
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Range0to65535, pStrInfo_base_LacpPartnerPortPriInput, NULL,
                         2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NORMAL_ONLY);
  ...
  depth6 = ewsCliAddNode(depth5, pStrInfo_common_Range0to65535, pStrInfo_base_LacpPartnerSysPriInput, NULL,
                         2, L7_NO_COMMAND_SUPPORTED, L7_STATUS_NORMAL_ONLY);
