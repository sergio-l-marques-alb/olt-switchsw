                               ...
                               L7_uint32 size )
{
  ...
  if ( usmDbDot1sMstiPortRoleGet( unit, instance, iface, &val ) == L7_SUCCESS )
  {
    ...
    case L7_DOT1S_ROLE_ROOT:
      strcpy( role, pStrInfo_common_RootPort);     /*"Root Port" */
      break;
    case L7_DOT1S_ROLE_DESIGNATED:
      strcpy( role, pStrInfo_common_DesignatedPort);     /* "Designated Port" */
      break;
    case L7_DOT1S_ROLE_ALTERNATE:
      strcpy( role, pStrInfo_common_AlternatePort);     /* "Alternate Port" */
      break;
    case L7_DOT1S_ROLE_BACKUP:
      strcpy( role, pStrInfo_common_Backup);     /* "Backup Port" */
      break;
    case L7_DOT1S_ROLE_MASTER:
      strcpy( role, pStrInfo_common_Master);     /* "Master Port" */
      break;
    case L7_DOT1S_ROLE_DISABLED:
      strcpy( role, pStrInfo_common_Dsbld);     /* "Disabled Port" */
      break;
    default:
      strcpy( role, pStrInfo_common_Blank);     /* "------" */
      break;
    }
...
/*********************************************************************
* @purpose  Returns TRUE if the the specified port is not disabled
*
* @param    unit index
* @param    instance spanningtree instance to use
* @param    iface
...
* @end
*********************************************************************/
L7_BOOL cliIsSpanningTreePortActive(L7_uint32 unit, L7_uint32 instance,
                                    L7_uint32 iface)
{
  L7_BOOL portActive = L7_FALSE;
  L7_uint32 val;
                                            ...
                                            iface, &val) == L7_SUCCESS )
  {
    ...
    case L7_DOT1S_DISCARDING:
      if ((usmDbDot1sMstiPortLoopInconsistentStateGet(unit, instance, iface, &val) == L7_SUCCESS) 
            && (val == L7_TRUE))
      {
        strcpy( stat, pStrInfo_common_DiscardingErr );        /* "Discarding*" */
      }
      else
      {
        strcpy( stat, pStrInfo_common_Discarding );        /* "Discarding" */
      }
      break;
    case L7_DOT1S_LEARNING:
      strcpy( stat, pStrInfo_common_Learning );        /* "Learning" */
      break;
    case L7_DOT1S_FORWARDING:
      strcpy( stat, pStrInfo_common_Fwd );        /* "Forwarding" */
      break;
    case L7_DOT1S_MANUAL_FWD:
      strcpy( stat, pStrInfo_common_ManualFwd );        /* "Manual forwarding" */
      break;
    case L7_DOT1S_NOT_PARTICIPATE:
      strcpy( stat, pStrErr_switching_NotParticipating );        /* "Not participating" */
      break;
    case L7_DOT1S_DISABLED:
      strcpy( stat, pStrInfo_common_Dsbld );        /* "Disabled" */
      break;
    default:
      return L7_FAILURE;
      /*PASSTHRU*/
