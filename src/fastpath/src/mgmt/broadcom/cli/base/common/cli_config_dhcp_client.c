                                              ...
                                              const L7_char8 **argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    {
      if (usmdbDhcpVendorClassOptionAdminModeSet(L7_ENABLE, L7_TRUE) != L7_SUCCESS)
      {
  ...
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmdbDhcpVendorClassOptionAdminModeSet(L7_DISABLE, L7_TRUE) != L7_SUCCESS)
      {
        cliSyntaxNewLine(ewsContext);
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR,  
                                                    ...
                                                    L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmdbDhcpVendorClassOptionStringSet(vendorIdStr, L7_TRUE) != L7_SUCCESS)
      {
        cliSyntaxNewLine(ewsContext);
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR,  
