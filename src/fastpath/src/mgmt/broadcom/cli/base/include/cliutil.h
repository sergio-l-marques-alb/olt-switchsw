...
EwsCliCommandP buildTreeInterfaceRangeHelp(EwsCliCommandP depth, L7_uint32 count, 
    EwsCliCommandOptions opt, L7_COMPONENT_IDS_t componentId, EwsCliNodeNoFormStatus noFormStatus);
...
L7_RC_t cliParseEthernetRangeInput(const L7_char8 *buf, L7_INTF_MASK_t *ifMask, L7_uint32 *ifTypeMask);
