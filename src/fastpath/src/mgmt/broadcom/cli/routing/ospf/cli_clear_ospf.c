...
/*********************************************************************
* @purpose    Terminate stub router mode.
*
* @param EwsContext ewsContext
* @param L7_uint32 argc
* @param const L7_char8 **argv
...
* @notes
*
* @cmdsyntax for normal command: clear ip ospf stub-router
*
* @cmdsyntax for no command: no command does not exist
*
* @cmdhelp
...
* @end
*********************************************************************/
const L7_char8 *commandClearIpOspfStubRouter(EwsContext ewsContext, L7_uint32 argc, 
                                             const L7_char8 **argv, L7_uint32 index)
{
  L7_uint32 numArg = cliNumFunctionArgsGet();
  L7_uchar8 *syntax = "Use 'clear ip ospf stub-router'.";
  ...
  if (usmDbOspfStubRouterClear() != L7_SUCCESS)
  {
    return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, NULL, ewsContext, 
                                          "Failed to remove OSPF from stub router mode.");
  }
