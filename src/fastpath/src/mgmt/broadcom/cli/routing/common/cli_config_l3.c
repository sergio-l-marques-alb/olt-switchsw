...
const L7_char8 *commandIpVlanRouting(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      {
        /* VLAN in use as the management VLAN */
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "VLAN %u is the management VLAN. "
                                              "Cannot enable routing on the management VLAN.",
                                              vlanID);
      }
  ...
  else if(  ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      ...
      if((rc = usmDbIp6RtrIntfModeSet(intIfNum, L7_DISABLE)) != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext,pStrInfo_routing_UnableCfgIpVlanRoutingDel);
      }
#endif
                                                  ...
                                                  const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbDot1qBaseInternalVlanIdSet(vlanID) != L7_SUCCESS)
      {
  ...
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbDot1qBaseInternalVlanIdSet(FD_DOT1Q_BASE_INTERNAL_VLAN) != L7_SUCCESS)
      {
                                                    ...
                                                    const L7_char8 **argv, L7_uint32 index)
{
  ...
  DOT1Q_INTERNAL_VLAN_POLICY policy;
  L7_uint32 numArg;
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbDot1qInternalVlanPolicySet(policy) != L7_SUCCESS)
      {
  ...
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbDot1qInternalVlanPolicySet(FD_DOT1Q_INTERNAL_VLAN_POLICY) != L7_SUCCESS)
      {
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if(usmDbIfBandwidthSet(iface, bandwidth) == L7_FAILURE)
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_Set_3);
          }
        }
      }
    }
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if (usmDbIpNetDirectBcastsSet(unit, iface, L7_ENABLE) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1,1, 0, 0, pStrErr_common_CouldNot,ewsContext,  pStrErr_routing_DirectedBcastsEnbl);
          continue;
        }
      }
    }
...
*
* @cmdsyntax for normal command: ip address  {<ipaddr> <subnet-mask> <secondary>|dhcp}
*
* @cmdsyntax for no command: no ip address {<ipaddr> <subnet-mask>|dhcp}
*
* @cmdhelp
*
...
const L7_char8 *commandIpAddress(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  {
    if ((osapiStrncmp(strIPaddr, pStrInfo_common_Dhcp_1, 4)==0) && (numArg==1)) 
    {
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        if (!L7_INTF_ISMASKBITSET(EWSINTFMASK(ewsContext), iface) ||
        ...
        if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
        {
          if (ewsContext->commType == CLI_NORMAL_CMD)
          {
            if(usmDbIntfIpAddressMethodSet (iface, L7_INTF_IP_ADDR_METHOD_DHCP,
                                            L7_MGMT_IPPORT, L7_FALSE)
                                         != L7_SUCCESS)
            {
              status = L7_FAILURE;
              ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext,
                                       pStrInfo_common_SetIntfConfigDhcpMethod);
              continue;
            }
          }
          if(ewsContext->commType == CLI_NO_CMD)
          {
            if(usmDbIntfIpAddressMethodSet (iface, L7_INTF_IP_ADDR_METHOD_NONE,
                                            L7_MGMT_IPPORT, L7_FALSE)
                                         != L7_SUCCESS)
            {
              status = L7_FAILURE;
              ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext,
                                       pStrInfo_common_ResetIntfConfigDhcpMethod);
              continue;
            }
          }
        }
        ...
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
              ...
              (intfType == L7_LOOPBACK_INTF))
          {
            if (usmDbNetmaskValidate32(subnetMask) != L7_SUCCESS)
            {
              status = L7_FAILURE;
              ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
              ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_InvalidSubnetMask32);
              continue;
            }
          }
          else
          {
            if (usmDbNetmaskValidate(subnetMask) != L7_SUCCESS)
            {
              status = L7_FAILURE;
              ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
              ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR,  ewsContext, pStrErr_common_InvalidSubnetMask);
              continue;
            }
          }
          ...
          if (rc != L7_SUCCESS)
          {
            ...
            case L7_TABLE_IS_FULL:
              ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR,  ewsContext, 
                                       "Failed to add IP address to interface. Routing table is full "
                                       "and does not have space for another local route.");
              break;
            case L7_ALREADY_CONFIGURED:
...
const L7_char8 *commandArpCacheSize(EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(  ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    {
      if ( ( intCacheSize >= L7_IP_ARP_CACHE_SIZE_MIN ) && ( intCacheSize <= platRtrArpMaxEntriesGet() ) )
      {
        /*******Check if the Flag is Set for Execution*************/
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
  ...
  else if(  ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      if (usmDbIpArpCacheSizeSet(unit, platRtrArpMaxEntriesGet()) != L7_SUCCESS)
      {
        ...
        (argc == 2 && (ewsContext->commType == CLI_NO_CMD))))
  {
    if(ewsContext->commType == CLI_NORMAL_CMD)
    {
      osapiSnprintfAddBlanks (1, 0, 0, 0, pStrErr_common_IncorrectInput, stat, sizeof(stat),
                              pStrErr_routing_Arp_1, L7_IP_ARP_CACHE_SIZE_MIN, platRtrArpMaxEntriesGet(),
      ...
      if ( cliConvertMac(buf, strMacAddr) == L7_TRUE )
      {
        ...
        if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
        {
              ...
              != L7_SUCCESS)
          {
            if (rc == L7_ADDR_INUSE)
            {
              ewsTelnetWrite(ewsContext, "Cannot create static ARP entry. "
            ...
            {
              ewsTelnetWrite(ewsContext, "Cannot create static ARP entry. "
                             "The maximum number of static ARP entries are already configured.");
              cliSyntaxBottom(ewsContext);
            }
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if (usmDbIfEncapsulationTypeSet(iface, L7_ENCAP_ETHERNET) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetEncapsTo);
          continue;
        }
      }
    }
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if (usmDbIfEncapsulationTypeSet(iface, L7_ENCAP_802) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetEncapsTosSnap);
          continue;
        }
      }
    }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (intIface=1; intIface < L7_MAX_INTERFACE_COUNT; intIface++)
    {
      ...
      if ( usmDbIpRtrIntfModeSet(unit, intIface, intMode) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetIfRouting);
        continue;
      }
      ...
      if ( usmDbIp6RtrIntfModeSet(intIface, intMode) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_common_CantSwitchIpv6);
      }
#endif
    }
  }
...
* @Mode  Interface Config
*
* @cmdsyntax for normal command:  ip irdp [ { multicast | holdtime <holdtime> |
*             maxadvertinterval <max> | minadvertinterval <min> | preference
*             <pref> | address <address> [ <number> ] } ]
*
* @cmdsyntax for no command: no ip irdp [{ multicast | holdtime | maxadvertinterval |
                              ...
                              const L7_char8 * * argv, L7_uint32 index)
{
      ...
      if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
        {
          ...
          if ( usmDbRtrDiscAdvertiseSet(unit, iface, flag) != L7_SUCCESS )
          {
            status = L7_FAILURE;
            ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
            ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_CouldNot,  ewsContext, pStrErr_routing_CantSetRtrDiscOnIf);
          }
        }
      }
    }
  ...
  else
  {
    ...
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      else if (strcmp(strMode, "multicast") == 0)
      {
        IrdpHandleMulticast(ewsContext, argc, argv, iface);
      }
    }
  }
  /*************Set Flag for Script Successful******/
...
*
*********************************************************************/
const L7_char8 *IrdpHandleMaxAdvertInterval(EwsContext ewsContext, L7_uint32 argc, 
                                            const L7_char8 **argv, L7_uint32 iface)
{
  L7_uint32 maxAdvIntPos = 3;
  L7_uint32 unit;
  L7_uint32 maxAdvInt;
  L7_RC_t rc;
  L7_char8 syntax[L7_CLI_MAX_STRING_LENGTH];

  osapiSnprintf(syntax, L7_CLI_MAX_STRING_LENGTH, 
                "Use 'ip irdp maxadvertinterval <%u - %u>'.", 
                L7_RTR_DISC_MAXINTERVAL_MIN, L7_RTR_DISC_MAXINTERVAL_MAX);
  ...
  {
    if ((argc != 4) || 
        (cliConvertTo32BitUnsignedInteger(argv[maxAdvIntPos], &maxAdvInt) != L7_SUCCESS))
    {
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      rc = usmDbRtrDiscMaxAdvIntervalSet(unit, iface, maxAdvInt);
      if (rc == L7_ERROR)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "The maximum advertisement interval is out of range.");
      }
      else if (rc == L7_REQUEST_DENIED)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "The maximum advertisement interval cannot be set less than"
                                              " the minimum advertisement interval.");
      }
      else if (rc != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              pStrErr_routing_CantSetMaxIntvl);
      }
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput, ewsContext, 
                                             pStrErr_routing_CfgRtrNoDiscMaxIntvl);
    }
    /*******Check if the Flag is Set for Execution*************/
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      ...
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                               pStrErr_routing_CantSetDefMaxIntvl);
      }
    }
  }
...
*
*********************************************************************/
const L7_char8 *IrdpHandleMinAdvertInterval(EwsContext ewsContext, L7_uint32 argc, 
                                            const L7_char8 **argv, L7_uint32 iface)
{
  L7_uint32 minAdvIntPos = 3;
  L7_uint32 unit;
  L7_RC_t rc;
  L7_uint32 minAdvInt;
  L7_char8 syntax[L7_CLI_MAX_STRING_LENGTH];
  ...
  osapiSnprintf(syntax, L7_CLI_MAX_STRING_LENGTH, 
                "Use 'ip irdp minadvertinterval <%u - %u>'.", 
                L7_RTR_DISC_MININTERVAL_MIN, L7_RTR_DISC_MININTERVAL_MAX);
  ...
  {
    if ((argc != 4) || 
        (cliConvertTo32BitUnsignedInteger(argv[minAdvIntPos], &minAdvInt) != L7_SUCCESS))
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput, 
                                             ewsContext, syntax);
    }
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      rc = usmDbRtrDiscMinAdvIntervalSet(unit, iface, minAdvInt);
      if (rc == L7_ERROR)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "The minimum advertisement interval is out of range.");
      }
      else if (rc == L7_REQUEST_DENIED)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "The minimum advertisement interval cannot be longer than the maximum advertisement interval.");
      }
      else if (rc != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              pStrErr_routing_CantSetMinIntvl);
      }
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput, ewsContext, 
                                             pStrErr_routing_CfgRtrNoDiscMinIntvl);
    }
    /*******Check if the Flag is Set for Execution*************/
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if (usmDbRtrDiscMinAdvIntervalRevert(iface) != L7_SUCCESS) 
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                               "Failed to revert the minimum advertisement interval to the default");
      }
    }
  }
  /*************Set Flag for Script Successful******/
...
const L7_char8 *IrdpHandleHoldTime( EwsContext ewsContext, L7_uint32 argc, const L7_char8 * * argv, L7_uint32 iface)
{
  ...
  osapiSnprintf(syntax, L7_CLI_MAX_STRING_LENGTH, 
                "Use 'ip irdp holdtime <%u - %u>'.", 
                L7_RTR_DISC_LIFETIME_MIN, L7_RTR_DISC_LIFETIME_MAX);
  ...
  {
    if ((argc != 4) || 
        (cliConvertTo32BitUnsignedInteger(argv[holdTimePos], &holdtime) != L7_SUCCESS))
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput, 
                                             ewsContext, syntax);
    }
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      rc = usmDbRtrDiscAdvLifetimeSet(unit, iface, holdtime);
      if (rc == L7_ERROR)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "The advertisement lifetime is out of range.");
      }
      else if (rc == L7_REQUEST_DENIED)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "The advertisement lifetime cannot be less than the maximum advertisement interval.");
      }
      else if (rc != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              pStrErr_routing_CantSetHoldTime);
      }
    }
  }
  ...
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput, 
                                             ewsContext, pStrErr_routing_CfgRtrNoDiscHoldTime);
    }
    /*******Check if the Flag is Set for Execution*************/
    if(ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if (usmDbRtrDiscAdvLifetimeRevert(iface) != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                               pStrErr_routing_CantSetDefHoldTime);
      }
    }
  }
...
* @notes Called by the commandIpIrdp function.
*
*        This has been implemented incorrectly. The "address" option was used where
*        the "multicast" option should have been. As of FP 6.2, continuing to accept
*        "ip irdp address," but show run uses "ip irdp multicast."
*
* @end
*
*********************************************************************/
...
/*********************************************************************
*
* @purpose  Utility routine to handle multicast option for ip irdp command
*
* @param EwsContext ewsContext
* @param const L7_char8 **argv
* @param L7_uint32 index
...
*
*********************************************************************/
const L7_char8 *IrdpHandleMulticast(EwsContext ewsContext, L7_uint32 argc, 
                                    const L7_char8 **argv, L7_uint32 iface)
{
  L7_uint32 unit;
  L7_uchar8 *syntax = "Use 'ip irdp multicast'.";
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if (usmDbRtrDiscAdvAddrSet(unit, iface, L7_DEFAULT_ADV_ADDR) != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks(1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                              "Failed to set the destination of router advertisements to 224.0.0.1");
      }
    }
  }
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if (usmDbRtrDiscAdvAddrSet(unit, iface, 0xFFFFFFFF) != L7_SUCCESS)
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, 
                                               "Failed to set the destination of router advertisements to 255.255.255.255");
      }
    }
  }
  /*************Set Flag for Script Successful******/
                                     ...
                                     const L7_char8 * * argv, L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_common_ClrArpCacheError);
    }
  }
  ...
  if (ewsContext->commType == CLI_NORMAL_CMD)
  {
    ...
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if (ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
      {
        ...
        if ((ipMtuSize < L7_L3_MIN_IP_MTU) || (ipMtuSize > maxIpMtu))
        {
        ...
        else if (rc == L7_ERROR)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          osapiSnprintf(buf, sizeof(buf), pStrErr_routing_IpMtuOutOfRange, L7_L3_MIN_IP_MTU, maxIpMtu);
          ewsTelnetWriteAddBlanks (1,1, 0, 0, L7_NULLPTR,ewsContext, buf);
          continue;
        }
      }
  ...
  else if (ewsContext->commType == CLI_NO_CMD)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if (usmDbIntfIpMtuSet(unit, iface, FD_IP_DEFAULT_IP_MTU) == L7_FAILURE)
      {
        ...
        ewsTelnetWriteAddBlanks (1, 1, 1, 0, L7_NULLPTR,  ewsContext, pStrErr_routing_SetIpAddr);
      }
    }
  }
      ...
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if (ewsContext->commType == CLI_NORMAL_CMD)
        {
           if (usmDbIpMapICMPUnreachablesModeSet(unit, iface, L7_ENABLE) != L7_SUCCESS) 
           {
              status = L7_FAILURE;
              ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
              ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_routing_CantSetIpUnreachables);
           }
        }
        else if (ewsContext->commType == CLI_NO_CMD)
        {
    ...
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if (ewsContext->commType == CLI_NORMAL_CMD)
      {
        if (usmDbIpMapIfICMPRedirectsModeSet(unit, iface, L7_ENABLE) != L7_SUCCESS)
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, L7_NULLPTR, ewsContext, pStrErr_routing_CantSetIpRedirects);
        }
      }
      else if (ewsContext->commType == CLI_NO_CMD)
      {
                                              ...
                                              L7_uint32 index)
{
  ...
  if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
  {
    for (intIfNum=1; intIfNum < L7_MAX_INTERFACE_COUNT; intIfNum++)
    {
      ...
      if (cliValidateRtrIntf(ewsContext, intIfNum) != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWrite(ewsContext, CLISYNTAX_INVALIDROUTERINTF);
        continue;
      }
  ...
  /*************Set Context ewsContextlag for Script Successful******/
  if (status == L7_SUCCESS)
  {
    ewsContext->actionFunctionStatusFlag = L7_ACTION_FUNC_SUCCESS;
  }
...
* @Mode  Global Config
*
* @cmdsyntax for normal command: ip default-gateway <ipaddress>
*
* @cmdsyntax for no command:no ip default-gateway <ipaddress>
*
* @cmdhelp
*
* @cmddescript  check for valid IP addr.
*
*
* @end
*
*******************************************************************/
const L7_char8 *commandIpGlobalDefaultGateway (EwsContext ewsContext, 
                                               L7_uint32 argc,
                                               const L7_char8 **argv,
                                               L7_uint32 index)
{
  ...
  if (numArg == 1)
  {
    ...
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if (ewsContext->commType == CLI_NORMAL_CMD)
      {
        rc = usmDbIpGlobalDefaultGatewayAddressSet(IPaddr);
      }
    }
    ...
    if (rc != L7_SUCCESS)
    {
      ...
      {
        case L7_FAILURE:
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_Error,
                                   ewsContext, pStrErr_routing_CantCfgureDefGateway);
          break;
        case L7_REQUEST_DENIED:
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_Error,
                                   ewsContext, pStrErr_routing_Subnetconflict);
          break;
        case L7_NOT_EXIST:
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR,
                                  ewsContext, pStrErr_routing_GatewayInactive);
         break;
        case L7_NOT_SUPPORTED:
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_Error,
                                  ewsContext, pStrErr_routing_GatewayInvalid);
         break;
        default:
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR,  ewsContext,
                                   pStrErr_routing_CantCfgureDefGateway);
          break;
      }
    }
  }
  else if ((numArg == 0) && (ewsContext->commType == CLI_NO_CMD))
  {
    if (ewsContext->scriptActionFlag == L7_EXECUTE_SCRIPT)
    {
      if(usmDbIpGlobalDefaultGatewayAddressReset() != L7_SUCCESS)
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_Error,
                                 ewsContext, pStrErr_common_FailedToRemove);
        return cliPrompt(ewsContext);
      }
    }
  }
  else
  {
    ...
    {
      ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_IncorrectInput, ewsContext,
                               pStrErr_routing_DefGateway);
      return cliSyntaxReturnPrompt (ewsContext, "");
    }
    if((ewsContext->commType == CLI_NO_CMD) && (numArg != 0))
    {
      ewsTelnetWriteAddBlanks (1, 0, 0, 0, pStrErr_common_IncorrectInput, ewsContext,
                               pStrErr_routing_No_defGateway);
      return cliSyntaxReturnPrompt (ewsContext, "");
    }
  }
