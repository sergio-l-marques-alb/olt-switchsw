...
* @notes
*
* @cmdsyntax  [no] dot1x system-auth-control [monitor]
*
* @cmdhelp
*
* @cmddescript
                                              ...
                                              L7_uint32 index)
{
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    ...
    {
      if ( usmDbDot1xMonitorModeSet(unit, mode) != L7_SUCCESS )
      {
        return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_security_Dot1xAdminMode_1);
      }
    }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xPortControlModeSet(unit, iface, mode) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortCntrlMode);
        continue;
      }
    }
  }
...
/*******Check if the Flag is Set for Execution*************/
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ((cliDot1xInterfaceValidate(ewsContext, unit, iface ) != L7_SUCCESS ))
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
      ...
      case 1:
        if ( usmDbDot1xPortQuietPeriodSet(unit, iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortQuietPeriod);
        }
        break;
      ...
      case 2:
        if ( usmDbDot1xPortReAuthPeriodSet(unit, iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortReAuthPeriod);
        }
        break;
      ...
      case 3:
        if ( usmDbDot1xPortServerTimeoutSet(unit, iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortReAuthSrvrTimeout);
        }
        break;
      ...
      case 4:
        if ( usmDbDot1xPortSuppTimeoutSet(unit, iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortReAuthSuppTimeout);
        }
        break;
      ...
      case 5:
        if ( usmDbDot1xPortTxPeriodSet(unit, iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortTxPeriod);
        }
        break;
      ...
      case 6:
        if ( usmDbDot1xAdvancedPortGuestVlanPeriodSet(unit, iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortGuestVlanPeriod);
        }
        break;
      }
    }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xPortMaxReqSet(unit, iface, value) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortMaxReqs);
      }
    }
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xPortReAuthEnabledSet(unit, iface, mode) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortReAuthEnbl);
      }
    }
  }
                                 ...
                                 uintf index)
{
  ...
  osapiStrncpySafe(strUserName, argv[index+1], sizeof(strUserName));
  if ((usmDbUserLoginIndexGet(unit, strUserName, &i) != L7_SUCCESS) &&
      (usmDbUserMgrIASUserDBUserIndexGet(strUserName, &i) != L7_SUCCESS))
  {
...
/*********************************************************************
*
* @purpose  Enable/Disable dot1x dynamic vlan creation Support on the switch
*
*
* @param EwsContext ewsContext
* @param L7_uint32 argc
...
* @notes
*
* @cmdsyntax  [no] dot1x dynamic-vlan enable
*
* @cmdhelp
*
* @cmddescript
                                                 ...
                                                 L7_uint32 index)
{
  ...
  if ( cliNumFunctionArgsGet() != 0 )
  {
    return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_IncorrectInput,  ewsContext, pStrErr_security_CfgDot1xDynamicVlanCreation);
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    if ( usmDbDot1xDynamicVlanCreationModeSet(unit, mode) != L7_SUCCESS )
    {
      return cliSyntaxReturnPromptAddBlanks (1, 1, 0, 0, pStrErr_common_ErrCouldNot,  ewsContext, pStrErr_security_Dot1xDynamicVlanCreation);
    }
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xAdvancedGuestPortsCfgSet(unit, iface,value)!= L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortGuestVlan);
      }
    }
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xPortMaxUsersSet(unit, iface, value) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortMaxUsers);
        continue;
      }
    }
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xPortUnauthenticatedVlanSet(unit, iface,value)!= L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortUnauthenticatedVlan);
      }
    }
  }
    ...
    if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
    {
      for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
      {
        ...
        if ( usmDbDot1xPortPaeCapabilitiesSet(iface, paeCapability) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortPaeCapability);
          continue;
        }
      }
    }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xSupplicantPortControlModeSet(iface, mode) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xSupplicantPortCntrlMode);
        continue;
      }
    }
  }
  ...
  if(ewsContext->scriptActionFlag==L7_EXECUTE_SCRIPT)
  {
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      if ( usmDbDot1xSupplicantPortMaxStartSet(iface, value) != L7_SUCCESS )
      {
        status = L7_FAILURE;
        ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
        ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortMaxStarts);
        continue;
      }
    }
  }
    ...
    for (iface=1; iface < L7_MAX_INTERFACE_COUNT; iface++)
    {
      ...
      case 1:
        if ( usmDbDot1xSupplicantPortStartPeriodSet(iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortStartPeriod);
        }
        break;
      case 2:
        if ( usmDbDot1xSupplicantPortHeldPeriodSet(iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortHeldPeriod);
        }
        break;
      ...
      case 3:
        if ( usmDbDot1xSupplicantPortAuthPeriodSet(iface, period) != L7_SUCCESS )
        {
          status = L7_FAILURE;
          ewsTelnetWriteAddBlanks (1, 0, 0, 0, L7_NULLPTR, ewsContext, cliDisplayInterfaceHelp(unit, s, p));
          ewsTelnetWriteAddBlanks (1, 1, 0, 0, pStrErr_common_Error,  ewsContext, pStrErr_security_Dot1xPortAuthPeriod);
        }
        break;
      }
    }
