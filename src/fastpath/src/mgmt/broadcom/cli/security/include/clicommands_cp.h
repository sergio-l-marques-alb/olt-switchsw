...
/* support */
const char *commandSupportCaptivePortalAll(EwsContext ewsContext, uintf argc,
                                      const char * * argv, uintf index);
const char *commandSupportCaptivePortalDefault(EwsContext ewsContext, uintf argc,
                                       const char * * argv, uintf index);
const char *commandSupportCaptivePortalDiag(EwsContext ewsContext, uintf argc,
                                       const char * * argv, uintf index);
const char *commandSupportCaptivePortalEvent(EwsContext ewsContext, uintf argc,
                                          const char * * argv, uintf index);
