...
function Dot1xAuthServUserDBConfig_SubmitStart(submitFlag)
{
 var element_1_3_1 = getInputElementByXid('1_3_1');
 var element_1_9_1 = getInputElementByXid('1_9_1');
...
function Dot1xAuthServUserDBConfig_SubmitEnd(submitFlag)
{
}

function Dot1xAuthServUserDBConfig_LoadStart(arg)
{
}

function Dot1xAuthServUserDBConfig_LoadEnd(arg)
{ 
}
