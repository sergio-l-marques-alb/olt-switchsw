...
function wlan_GlobalStatsTab6_SubmitStart(submitFlag)
{
}
function wlan_GlobalStatsTab6_SubmitEnd(submitFlag)
{
}

function wlan_GlobalStatsTab6_LoadStart(arg)
{
...
function wlan_GlobalStatsTab6_LoadEnd(arg)
{
  loadme();
}
