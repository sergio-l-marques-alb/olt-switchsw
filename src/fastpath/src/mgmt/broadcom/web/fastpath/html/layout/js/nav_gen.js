...
function _load_other_nodes(nodes, parent) {
  ...
  nodes.each(function(n) {
    ...
    if (n.link != '') {
      if ( n.link == "nv_launch.html" )
      {
        count++;
        //nl = gLnk("R", "Launch", "nv_launch.html");
        //nf = "status=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no,directories=no,location=no,width=700,height=500";
        //sideNavHtml = sideNavHtml + "somthing"+(count-1)+ "= insFld("+parentDummy+", gFld(\"Launch...\", \"javascript:parent.window.open('/nv_launch.html','1062731320','status=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no,directories=no,location=no,width=700,height=500')\"));"
        sideNavHtml = sideNavHtml + "somthing"+(count-1)+ "= insFld("+parentDummy+", gFld(\"Launch...\", 'javascript:void(window.open(\"/nv_launch.html\",\"1062731320\",\"status=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no,directories=no,location=no,width=700,height=500\"))'));"

        //sideNavHtml = sideNavHtml +  "<a href=\"javascript: void(0)\" onclick=\"window.open('/nv_launch.html', 'visualization', 'width=700, height=500, location=no, scrollbars=yes,resizable=yes,menubar=no,toolbar=no,directories=no'); return false;\" style=\"color: white; background-color: rgb(102, 102, 102);\">Launch...</a>"; 
      }
      else
      {
