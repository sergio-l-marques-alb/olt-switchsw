...
function AssocClientStatsAssocSummary_SubmitStart()
{
}


function AssocClientStatsAssocSummary_SubmitEnd()
{
}

function AssocClientStatsAssocSummary_LoadStart()
{
...
function AssocClientStatsAssocSummary_LoadEnd()
{
  loadme();
}
