...
{
  var obj_xids= new Array("1_12_1","1_2_1");
  var idx=0;
  while (idx <= 2)
  {
...
function service_cfg_LoadEnd(arg)
{
  ...
  var element_2_4_1 = getInputElementByXid('2_4_1');
       ...
       if(element_1_5_1 == null || element_1_5_1.nextSibling == null )
          return;
       if(element_2_4_1 == null || element_2_4_1.nextSibling == null )
          return;
     ...
     element_2_4_1 = getInputElementByXid('2_4_1').nextSibling;
     element_2_4_1.size = 8;
     element_2_4_1.readOnly = true;
     element_2_4_1.overflow = scroll;
     element_2_4_1.disabled = false;
}
...
function parseAndGetLowerLimit(range)
{
