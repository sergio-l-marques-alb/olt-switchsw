...
snmpAgentCosQueueSchedulerTypeSet(L7_uint32 UnitIndex, L7_uint32 intIfNum, L7_uint32 agentCosQueueIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    rc = usmDbQosCosQueueSchedulerTypeSet(UnitIndex, intIfNum, 0/*Default QueueGroup*/, agentCosQueueIndex, temp_val);
  }
...
snmpAgentCosQueueMinBandwidthSet(L7_uint32 UnitIndex, L7_uint32 intIfNum, L7_uint32 agentCosQueueIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    rc = usmDbQosCosQueueMinBandwidthSet(UnitIndex, intIfNum, 0/*Default QueueGroup*/, agentCosQueueIndex, val);
  }
...
snmpAgentCosQueueMaxBandwidthSet(L7_uint32 UnitIndex, L7_uint32 intIfNum, L7_uint32 agentCosQueueIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    rc = usmDbQosCosQueueMaxBandwidthSet(UnitIndex, intIfNum, 0/*Default QueueGroup*/, agentCosQueueIndex, val);
  }
...
snmpAgentCosQueueMgmtTypeSet(L7_uint32 UnitIndex, L7_uint32 intIfNum, L7_uint32 agentCosQueueIndex, L7_uint32 val)
{
  ...
  if (rc == L7_SUCCESS)
  {
    rc = usmDbQosCosQueueMgmtTypeSet(UnitIndex, intIfNum, 0/*Default QueueGroup*/, agentCosQueueIndex, temp_val);
  }
