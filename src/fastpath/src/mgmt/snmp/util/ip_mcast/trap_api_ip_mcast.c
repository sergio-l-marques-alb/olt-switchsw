...
void SnmpTrapSendCallback_ip_mcast(L7_uint32 trap_id, void *data)
{
  ...
  case L7_SNMP_TRAP_IP_MCAST_PimNeighborLoss:
    (void)snmp_pimNeighborLossTrapSend(((L7_SNMP_TRAP_IP_MCAST_PimNeighborLoss_t*)data)->pimNeighborUpTime);
    break;
...
* @end
*********************************************************************/
L7_RC_t SnmpPimNeighborLossTrapSend(L7_uint32 pimNeighborUpTime)
{
...
void SnmpTestTraps_ip_mcast()
{
  ...
  rc = SnmpPimNeighborLossTrapSend(0);
