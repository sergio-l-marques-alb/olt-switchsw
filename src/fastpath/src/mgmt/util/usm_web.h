...
#define USMWEB_USERNAME_SIZE  L7_LOGIN_SIZE
...
extern L7_uint32 usmWebNumActiveInterfacesGet(L7_uint32 unit);
...
#define USMWEB_STATIC_BUFFER_SIZE       8192
...
L7_uint32 web2DefEtherType (L7_uchar8 val, L7_uint32 def);
