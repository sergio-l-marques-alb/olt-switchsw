...
#define VRRP_IP_ICMP_ECHO_REQ 0x08
...
typedef struct vrrpVirtRouterOperData_s
{
  ...
  L7_uchar8          master_advt_int; /* Master advertisement interval to know master_time_down interval */
  L7_BOOL            preempt_delay_config; /* Flag to check preemption delay configuration availability */
  L7_clocktime       preempt_startTime;  /* time at which the last VRRP packet can cause preemtpion */
