...
L7_RC_t ospfMapExtenStubRtrModeSet(OSPF_STUB_ROUTER_CFG_t stubRtrMode, 
                                   L7_uint32 startupDuration);

L7_RC_t ospfMapExtenStubRtrSummaryMetricSet(L7_uint32 overrideSummaryMetric, 
...
* @end
*********************************************************************/
L7_RC_t ospfMapExtenAreaLSADbLSAAgeGet(L7_uint32 areaId, L7_uint32 intIfNum, L7_int32 Type, 
...
* @end
*********************************************************************/
L7_RC_t ospfMapExtenAreaLSADbLSACksumGet(L7_uint32 areaId, L7_uint32 intIfNum, L7_int32 Type, 
                                         L7_uint32 Lsid, L7_uint32 RouterId,
                                         L7_uint32 *val);
...
* @end
*********************************************************************/
L7_RC_t ospfMapExtenAreaLSADbLSAAdvertiseGet(L7_uint32 areaId, L7_uint32 intIfNum,
                                             L7_int32 Type, 
                                             L7_uint32 Lsid, L7_uint32 RouterId,
...
* @end
*********************************************************************/
L7_RC_t ospfMapExtenLsdbSequenceGet(L7_uint32 areaId, L7_uint32 intIfNum, 
                                    L7_int32 Type,
                                    L7_uint32 Lsid, L7_uint32 RouterId,
                                    L7_uint32 *val);
...
* @end
*********************************************************************/
L7_RC_t ospfMapExtenAreaLSADbLSAOptionsGet(L7_uint32 areaId, L7_uint32 intIfNum, L7_int32 Type, 
                                           L7_uint32 Lsid, L7_uint32 RouterId,
                                           L7_uchar8 *val);
...
L7_RC_t ospfMapExtenStubRouterClear(void);

L7_RC_t ospfMapExtenRTOConfigSet(t_S_RouterCfg *p_rtoCfg);

L7_RC_t ospfMapExtenRestartInitiate(void);

L7_RC_t ospfMapExtenHelperSupportSet(OSPF_HELPER_SUPPORT_t helperSupport);
L7_RC_t ospfMapExtenStrictLsaCheckingSet(L7_BOOL strictLsaChecking);
L7_RC_t ospfMapExtenNsfSupportSet(OSPF_NSF_SUPPORT_t nsfSupport);
L7_RC_t ospfMapExtenRestartIntervalSet(L7_uint32 restartInterval);
L7_RC_t ospfMapExtenHelpfulNbrStatusGet(L7_uint32 intIfNum, L7_uint32 nbrIpAddr, 
                                        L7_ospfHelpfulNbrStatus_t *nbrStatus);

L7_RC_t ospfMapExtenBeginGracefulRestart(void);
L7_RC_t ospfMapExtenStartupDone(void);
L7_BOOL ospfMapExtenGraceLsasPending(void);
L7_RC_t ospfGrConfigDataApply(void);
