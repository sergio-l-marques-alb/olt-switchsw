...
L7_RC_t ripMapVendInit(void)
{
  ...
  if (osapiSocketLibInit(OSAPI_SOCKETLIB_INET_BSD) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendInit: INET BSD socket initialization error\n");
    return L7_FAILURE;
  }
  if (osapiSocketLibInit(OSAPI_SOCKETLIB_ROUTE_BSD) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendInit: ROUTE BSD socket initialization error\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendInit: Unable to create RIP task control semaphore\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendInit: Unable to create RIP radix tree semaphore\n");
    return L7_FAILURE;
  }
  ...
  (void) osapiStrncpySafe(intfCom.intfPipeName, RIP_INTF_PIPE_NAME, strlen(RIP_INTF_PIPE_NAME)+1);
  intfCom.intfPipe = -1;
  if (osapiPipeCreate(intfCom.intfPipeName, intfCom.intfPipeMaxMsgs,
                      intfCom.intfPipeMsgLen) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendInit: Unable to create RIP communication pipe\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendInit: Unable to open RIP communication pipe\n");
    return L7_FAILURE;
  }
...
L7_RC_t ripMapVendDeinit(void)
{
  ...
  if (ripMapFiniTasks() != L7_SUCCESS)
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
              "Unable to FINI RIP tasks\n");


  if (osapiPipeClose(intfCom.intfPipe) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "Unable to close RIP communication pipe\n");
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            " Unable to delete RIP communication pipe\n");
  }
  ...
  {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
              "INET BSD socket deinitialization error\n");
  }

  if (osapiSocketLibDeinit( OSAPI_SOCKETLIB_ROUTE_BSD) != L7_SUCCESS)
  {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
              "ROUTE BSD socket deinitialization error\n");
  }
  #endif
...
int ripMapVendRipRoutesMaxGet(void)
{
  ...
  return (int) platRtrRouteMaxEntriesGet();
}
...
/*  if (osapiSemaTake(ripMapCtrl_g.taskCtrl.semId, L7_WAIT_FOREVER) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
           "ripMapVendTaskControl: osapiSemTake error\n");
    return;
  }
  if (osapiSemaGive(ripMapCtrl_g.taskCtrl.semId) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
           "ripMapVendTaskControl: osapiSemGive error\n");
    return;
  }
*/
}
...
int ripMapVendRnTreeCritEnter(void)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendRnTreeCritEnter: osapiSemTake error\n");
    return -1;
  }
  return 0;
}
...
int ripMapVendRnTreeCritExit(void)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_RIP_MAP_COMPONENT_ID,
            "ripMapVendRnTreeCritExit: osapiSemGive error\n");
    return -1;
  }
  return 0;
}
