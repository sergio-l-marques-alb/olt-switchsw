...
typedef enum dot1xControlEvents_s
{
  ...
  /*101*/dot1xMgmtAdminMonitorModeEnable,
  /*102*/dot1xMgmtAdminMonitorModeDisable,
...
extern L7_RC_t dot1xRadiusServerVlanConversionHandle(const L7_char8 *vlanName, L7_uint32 *vlanId);
