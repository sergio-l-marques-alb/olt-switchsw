...
typedef struct dot1xCfg_s
{
  ...
  L7_uint32                monitorMode;       /* Global Monitor Mode */
  L7_uint32                dynamicVlanMode;   /* Global mode to create dynamic vlan, if radius assigned vlan not present */
...
extern L7_BOOL dot1xCnfgrIsRestartTypeWarm();
...
extern L7_uint32 dot1xMaxAllocMemGet();
...
extern L7_RC_t dot1xCnfgrInitPhase2Process( L7_CNFGR_RESPONSE_t *pResponse,
                                            L7_CNFGR_ERR_RC_t   *pReason );
extern L7_RC_t dot1xCnfgrInitPhase3Process( L7_BOOL warmRestart,
