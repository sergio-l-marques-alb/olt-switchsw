...
#define WIO_IS_READY (((wioInfo->cnfgrState == WIO_PHASE_INIT_3) || \
                       (wioInfo->cnfgrState == WIO_PHASE_EXECUTE) || \
                       (wioInfo->cnfgrState == WIO_PHASE_UNCONFIG_1)) ? (L7_TRUE) : (L7_FALSE))
