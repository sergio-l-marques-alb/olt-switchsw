...
L7_int32 dvmrpAdminModeReset(dvmrp_t *dvmrpcb)
{
  ...
  for (rtrIfNum =1;rtrIfNum < MAX_INTERFACES;rtrIfNum++)
  {
    ...
    {
      dvmrp_interface_activate(dvmrpcb,rtrIfNum,L7_DISABLE,L7_NULLPTR,L7_NULLPTR, 0);  
    }
  }
    ...
    case MCAST_EVENT_MGMD_GROUP_UPDATE:
      {
        ...
        L7_char8 grp[IPV6_DISP_ADDR_LEN];
            ...
            dvmrp_interface_t *interface)
{
  ...
  L7_char8 dstAddr[IPV6_DISP_ADDR_LEN],src[IPV6_DISP_ADDR_LEN];
  ...
  inetAddressGet(L7_AF_INET, &tmp_addr.addr, &ipaddr);
