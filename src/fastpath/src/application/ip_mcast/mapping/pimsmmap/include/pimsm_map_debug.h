...
typedef enum
{
  ...
  PIMSM_MAP_DEBUG_CONFIGURED,/* Trace all instances which configured **
                             ** alrealdy                             */
  PIMSM_MAP_DEBUG_NSF,       /* Trace all NSF events */
...
#define PIMSM_MAP_LOG_MSG(familyType, __fmt__, __args__...) \
 ...
 {\
   ...
   L7_LOGF(L7_LOG_SEVERITY_INFO, L7_FLEX_PIMSM_MAP_COMPONENT_ID, __buf2__);                               \
 }while(0) 

#define PIMSM_PKT_TYPE_STR_LEN 40
#define PIMSM_USER_TRACE(__fmt__, __args__... )                              \
  LOG_USER_TRACE(L7_FLEX_PIMSM_MAP_COMPONENT_ID, __fmt__,##__args__);        \
