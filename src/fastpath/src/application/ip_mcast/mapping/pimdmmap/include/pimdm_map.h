...
#define PIMDMMAP_MSG_COUNT  (L7_IPMAP_INTF_MAX_COUNT + L7_MGMD_GROUPS_MAX_ENTRIES + ((L7_MGMD_GROUPS_MAX_ENTRIES*60)/100))
...
#define PIMDM_WARM_RESTART_INTERVAL_MSEC  30*1000     /* time to wait before declaring the restart process complete in milliseconds */
