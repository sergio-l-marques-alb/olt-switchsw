                              ...
                              L7_MGMD_INTF_MODE_t intfType)
{
  ...
  switch (intfType)
  {
    ...
    default: /* MGMD_INTERFACE_MODE_NULL */
        MGMD_MAP_DEBUG(MGMD_MAP_DEBUG_APIS, "Invalid Interface Type = %d\n", intfType);
        return L7_FAILURE;
  }/*End-of-Switch*/
                               ...
                               L7_MGMD_INTF_MODE_t intfType)
{
  ...
  {
    MGMD_MAP_DEBUG(MGMD_MAP_DEBUG_FAILURES,
                   "ERROR converting intIfNum to rtrIntf\n");
    return L7_SUCCESS;
  }
  ...
  switch (familyType)
  {
    case L7_AF_INET:
      *mgmdMapCbPtr = &mgmdMapCB_g[MGMD_MAP_IPV4_CB];
      ...
      {
        MGMD_MAP_DEBUG (MGMD_MAP_DEBUG_FAILURES, "MCAST Ctrl Block not initialized\n");
        return L7_FAILURE;
      }
      /* PTin end */
      break;
