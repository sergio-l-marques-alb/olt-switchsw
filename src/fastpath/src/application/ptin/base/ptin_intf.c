...
#ifdef NGPON2_SUPPORTED
static L7_RC_t ptin_intf_apply_ngpon2_configuration(L7_uint32 ngpon2_id);
...
L7_RC_t ptin_intf_NGPON2_add_group_port(ptin_NGPON2group_t *group_info)
{
  ...
  for(i = 0; ((i < group_info->numIntf) && NGPON2_groups_info[group_idx].admin); i++)
  {
    ...
    if ( new_group )
    {
      ...
      ptin_intf_apply_ngpon2_configuration(group_info->GroupId);
    }
...
#ifdef NGPON2_SUPPORTED
/**
 * ptin_intf_apply_ngpon2_configuration(L7_uint32 ngpon2_id)
 *  
 * @param msg 
 * 
 * @return L7_RC_t 
