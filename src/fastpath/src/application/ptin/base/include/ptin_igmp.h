...
#define PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_DISABLE_UINT64   0xFFFFFFFFFFFFFFFFULL /*(L7_uint64) -1 */
#define PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_DISABLE_UINT32   0xFFFFFFFF /*((L7_uint32) -1 )*/
#define PTIN_IGMP_ADMISSION_CONTROL_MAX_CHANNELS_DISABLE           (L7_uint16) -1

#define PTIN_IGMP_ADMISSION_CONTROL_MAX_CHANNELS                   16384
#define PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_KBPS             100000000 /*100.000.000 kbps*/
#define PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_BPS              100000000000ULL /*100.000.000.000 bps*/

#if PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_KBPS > PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_DISABLE_UINT32
