...
#define PTIN_IGMP_ADMISSION_CONTROL_MAX_BANDWIDTH_IN_BPS_DISABLE      0xFFFFFFFFFFFFFFFFULL /*(L7_uint64) -1 */
...
#define PTIN_IGMP_GROUP_MASK_MIN  18  
 ...
 * @param ptin_port : interface 
 */
extern void ptin_igmp_pool_groupclient_id_get(L7_int32 ptin_port);
