...
typedef enum  {
  ...
  DHCP_STAT_FIELD_RX_CLIENT_REQUESTS_WITH_OPTION37,
  DHCP_STAT_FIELD_RX_CLIENT_REQUESTS_WITH_OPTION18,
  ...
  DHCP_STAT_FIELD_TX_SERVER_REPLIES_WITH_OPTION37,
  DHCP_STAT_FIELD_TX_SERVER_REPLIES_WITH_OPTION18,

#if 1 /* Eu quero remover esta merda! */
