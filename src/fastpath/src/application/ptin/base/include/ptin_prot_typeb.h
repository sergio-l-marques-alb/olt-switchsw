 ...
 * @return L7_RC_t : L7_SUCCESS/L7_FAILURE
 */
extern L7_RC_t ptin_prottypeb_intf_config_get(L7_uint32 ptin_port, ptin_prottypeb_intf_config_t* data);
 ...
 * @return L7_RC_t : L7_SUCCESS/L7_FAILURE
 */
extern L7_RC_t ptin_prottypeb_intf_switch_notify(L7_uint32 ptin_port, L7_uint8 status);
