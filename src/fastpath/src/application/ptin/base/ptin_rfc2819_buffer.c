...
L7_RC_t ptin_rfc2819_buffer_write(L7_int buffer_index, void *data, L7_int flag) 
{
    ...
    PT_LOG_TRACE(LOG_CTX_RFC2819, "ptin_rfc2819_buffer_write(buffer_index=%d, wrptr=%d, flag=%d)", buffer_index, bufferQualRFC2819.wrptr[buffer_index], flag);
...
void ptin_rfc2819_buffer_print_ctrl(void)
{
    ...
    PT_LOG_INFO(LOG_CTX_RFC2819, " Index  wrptr  rdflag   nreg");
    printf("+++++++++++++++++++++++++++++");
    ...
    for ( i=0; i<MAX_QUAL_RFC2819_BUFFERS; i++ ) {
        ...
        PT_LOG_INFO(LOG_CTX_RFC2819, "%4d     %4d      %d   %4d",i,bufferQualRFC2819.wrptr[i], bufferQualRFC2819.bufferfull[i],nregs);
    }
    PT_LOG_INFO(LOG_CTX_RFC2819, "+++++++++++++++++++++++++++++\n\r");
}
...
{
  PT_LOG_TRACE(LOG_CTX_RFC2819, "buffer_index=%d, reg_index=%d, full=%d ",
            buffer_index,
            reg_index,
...
L7_RC_t ptin_rfc2819_buffer_fill(L7_uint8 buffer, L7_int n_elementos) 
{
    ...
    if (buffer>=MAX_QUAL_RFC2819_BUFFERS) {
        PT_LOG_TRACE(LOG_CTX_RFC2819, "buffer overflow (%d)",buffer);
    }
