...
L7_RC_t ptin_pppoe_instance_remove(L7_uint32 evc_idx)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_PPPOE,"Error unconfiguring PPPOE snooping for pppoe_idx=%u",pppoe_idx);
    return L7_FAILURE;
  }
                              ...
                              L7_uint16 options, ptin_clientCircuitId_t *circuitId, L7_char8 *remoteId)
{
       ...
       (client.mask & PTIN_CLIENT_MASK_FIELD_INNERVLAN) )
  {
    ...
    {
      PT_LOG_ERR(LOG_CTX_PPPOE,"Invalid ptin_intf %u/%u", client.ptin_intf.intf_type,client.ptin_intf.intf_id);
    }
  }
...
L7_BOOL ptin_pppoe_intf_validate(L7_uint32 intIfNum)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_PPPOE,"Invalid arguments: intIfNum=%u",intIfNum);
    return L7_FALSE;
  }
...
L7_BOOL ptin_pppoe_intfVlan_validate(L7_uint32 intIfNum, L7_uint16 intVlanId /*, L7_uint16 innerVlanId*/)
{
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_ERR(LOG_CTX_PPPOE,"Invalid arguments: intIfNum=%u intVlan=%u",intIfNum,intVlanId);
    return L7_FALSE;
  }
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_ERR(LOG_CTX_PPPOE,"Error acquiring interface %u/%u configuarion from EVC id %u",
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_ERR(LOG_CTX_PPPOE,"Interface %u/%u (intIfNum=%u) is not in use for EVC %u",
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_ERR(LOG_CTX_PPPOE,"For unstrusted interface %u/%u (evc=%u) inner vlan must be used",
              ptin_intf.intf_type,ptin_intf.intf_id,pppoeInst->evc_idx);
    return L7_FALSE;
  }
  #endif
                                ...
                                L7_int client_idx, L7_uint16 *uni_ovid, L7_uint16 *uni_ivid)
{
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_TRACE(LOG_CTX_PPPOE, "Error getting intf configuration for intVlan %u, intIfNum %u", intOVlan, intIfNum);
    return L7_FAILURE;
  }
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_TRACE(LOG_CTX_PPPOE, "intVlan %u / intIfNum %u is not used", intOVlan, intIfNum);
    return L7_FAILURE;
  }
                                  ...
                                  L7_uint *client_index)
{
  ...
  if (client->mask & PTIN_CLIENT_MASK_FIELD_INTF)
  {
    if (intIfNum!=0 && intIfNum!=L7_ALL_INTERFACES)
    {
      ...
      {
        if (ptin_debug_pppoe_snooping)
          PT_LOG_ERR(LOG_CTX_PPPOE,"Connot convert client intIfNum %u to ptin_port_format",intIfNum);
        return L7_FAILURE;
      }
    }
  }
                                ...
                                L7_char8 *circuitId, L7_char8 *remoteId)
{
...
#endif
  {
    ...
    {
      if (ptin_debug_pppoe_snooping)
        PT_LOG_ERR(LOG_CTX_PPPOE,"Non existent client in PPPOE instance %u (EVC id %u)",pppoe_idx,pppoeInstances[pppoe_idx].evc_idx);
      return L7_FAILURE;
    }
                                     ...
                                     L7_BOOL *isActiveOp37, L7_BOOL *isActiveOp18)
{
  ...
  if (L7_NULLPTR != isActiveOp18)
  {
...
#endif
   {
      ...
      {
         if (ptin_debug_pppoe_snooping)
            PT_LOG_ERR(LOG_CTX_PPPOE, "Non existent client in PPPOE instance %u (EVC id %u)",
...
static L7_RC_t ptin_pppoe_client_find(L7_uint pppoe_idx, ptin_client_id_t *client_ref, ptinPppoeClientInfoData_t **client_info)
{
  ...
  if (client_ref->mask & PTIN_CLIENT_MASK_FIELD_INTF)
  {
    ...
    {
      if (ptin_debug_pppoe_snooping)
        PT_LOG_ERR(LOG_CTX_PPPOE,"Cannot convert client_ref intf %u/%u to ptin_port format",client_ref->ptin_intf.intf_type,client_ref->ptin_intf.intf_id);
      return L7_FAILURE;
    }
  }
  #endif
...
static L7_RC_t ptin_pppoe_inst_get_fromIntVlan(L7_uint16 intVlan, st_PppoeInstCfg_t **pppoeInst, L7_uint *pppoeInst_idx)
{
  ...
  {
    if (ptin_debug_pppoe_snooping)
      PT_LOG_ERR(LOG_CTX_PPPOE,"Inconsistency: PPPOE index %u (EVCid=%u, Vlan %u) has EVC not in use (evc=%u)",pppoe_idx,evc_idx,intVlan,pppoeInstances[pppoe_idx].evc_idx);
    return L7_FAILURE;
  }
