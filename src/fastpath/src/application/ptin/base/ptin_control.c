...
#if ( PTIN_BOARD == PTIN_BOARD_CXO640G || PTIN_BOARD == PTIN_BOARD_AE48GE || \
      PTIN_BOARD == PTIN_BOARD_TA48GE  || PTIN_BOARD == PTIN_BOARD_TG16G  || \
      PTIN_BOARD == PTIN_BOARD_TG16GF  || PTIN_BOARD == PTIN_BOARD_AG16GA )
