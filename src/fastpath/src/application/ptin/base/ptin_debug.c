...
//printf("  ptin_igmp_snoop_dump <id>                                       - prints IGMP snooping entries (use -1 to display all)\r\n");
  ...
  printf("  ptin_igmp_pool_groupclient_id_get <ptin_port>                   - prints status of group clients ID for ptin_port (-1 for all)\r\n");
  ...
  printf("  ptin_ipdtl0_dump                                                - Dump ipdtl0 routing configurations\r\n");
...
L7_RC_t ptin_debug_example(L7_uint32 intIfNum, L7_uint operation, L7_uint param1, L7_uint param2)
{
  ...
  PT_LOG_INFO(LOG_CTX_MISC, "Executing generic DTL processor: intIfNum=%u operation=%u param1=%u param2=%u sizeof(ptin_dtl_example_t)=%zu",
