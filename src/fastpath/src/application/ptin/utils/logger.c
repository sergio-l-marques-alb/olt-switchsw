...
static struct log_cfg_entry_s log_cfg[LOG_CONTEXT_LAST] = {
    {LOG_CTX_LOGGER,            LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_IPC,               LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_MSGHANDLER,   LOG_SEV_TRACE,       LOG_COLOR_MAGENTA},
    {LOG_CTX_PTIN_MSG,          LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_INTF,         LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_TRUNKS,       LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_HAPI,         LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_DTL,          LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_L2,           LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_XLATE,        LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_API,          LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_EVC,          LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_CONTROL,      LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_IGMP,         LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_DHCP,         LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_PPPOE,        LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_SSM,          LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_PACKET,       LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_PTIN_CNFGR,        LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_MISC,              LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_OAM,               LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
    {LOG_CTX_ERPS,              LOG_SEV_TRACE,       LOG_COLOR_DEFAULT},
