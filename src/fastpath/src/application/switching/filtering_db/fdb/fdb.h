...
#define L7_FDB_INTF_INDEX_MAX      (L7_MAX_INTERFACE_COUNT + 1)
...
* @end
*********************************************************************/
L7_uint32 fdbCnfgrPhaseGet(void);
/*********************************************************************
* @purpose  Determine whether FDB is in a state ready to process
*           other component requests.
*
* @param     none
*
* @returns  L7_TRUE - FDB is ready.
*           L7_FALSE - FDB is not ready.
*
* @notes
*
* @end
*********************************************************************/
L7_BOOL fdbPhaseStatusCheck(void);
#endif /* FDB_H */
