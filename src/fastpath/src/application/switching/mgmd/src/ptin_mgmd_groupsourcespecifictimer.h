...
RC_t   ptin_mgmd_groupspecifictimer_start(ptinMgmdGroupInfoData_t* groupEntry, uint16 portId,uint32 clientId, ptin_IgmpProxyCfg_t *igmpCfg);       //Start a Q(G)
RC_t   ptin_mgmd_groupsourcespecifictimer_start(ptinMgmdGroupInfoData_t* groupEntry, uint16 portId,uint32 clientId, ptin_IgmpProxyCfg_t *igmpCfg); //Start a Q(G,S)
