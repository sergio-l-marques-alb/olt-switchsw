...
#define PTIN_MGMD_EVENT_MSG_SIZE_MAX          max(max((PTIN_MGMD_EVENT_CTRL_DATA_SIZE_MAX+16), (PTIN_MGMD_EVENT_TIMER_DATA_SIZE_MAX+8)), (PTIN_MGMD_EVENT_PACKET_DATA_SIZE_MAX+16))  
...
typedef enum
{
  ...
  PTIN_MGMD_EVENT_DEBUG_GROUP_RECORDS_DUMP = 0x0105,
  PTIN_MGMD_EVENT_DEBUG_WHITELIST_DUMP     = 0x0106,
