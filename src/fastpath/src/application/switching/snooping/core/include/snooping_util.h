...
void    snoopTraceWrite(L7_uchar8 *traceMsg);
...
L7_RC_t snoopPacketRtrIntfsForward(struct mgmdSnoopControlPkt_s *mcastPacket, L7_uint8 igmp_type);
/* PTin added: IGMP snooping */
#if 1
L7_RC_t snoopPacketClientIntfsForward(struct mgmdSnoopControlPkt_s *mcastPacket, L7_uint8 igmp_type);
#endif
