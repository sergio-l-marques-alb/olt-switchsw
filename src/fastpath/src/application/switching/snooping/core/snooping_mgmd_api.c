...
/*********************************test function **********************************************************************/
L7_RC_t teste_snooping_tx_general_query(unsigned int service_id, unsigned int port_id, unsigned int client_id)
{
    unsigned char frame[46] = { 0x45, 0x00, 0x00, 0x1c, 0x65, 0x54, 0x00, 0x00, 0x01, 0x02, 0xb2, 0xe0, 0xc0, 0xa8, 0x01, 0x02,
                                0xe0, 0x00, 0x00, 0x01, 0x11, 0x64, 0xee, 0x9b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

    unsigned char* payload = frame;

    return snooping_tx_packet(payload, 46 /*length*/, service_id, port_id, client_id, L7_AF_INET, -1);
}

L7_RC_t teste_snooping_tx_leave_group(unsigned int service_id, unsigned int port_id, unsigned int client_id)
{
    /*Leave Group (225.1.1.3)*/
    unsigned char frame[46] = { 0x46, 0x00, 0x00, 0x20, 0x00, 0x00, 0x40, 0x00, 0x01, 0x02, 0x38, 0x64, 0xc0, 0xa8, 0x0b, 0xc9,
                                0xe0, 0x00, 0x00, 0x02, 0x94, 0x04, 0x00, 0x00, 0x17, 0x00, 0x06, 0xfb, 0xe1, 0x01, 0x01, 0x03,
                                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
L7_RC_t teste_snooping_tx_membership_report(unsigned int service_id, unsigned int port_id, unsigned int client_id)
{
    /*Leave Group (225.1.1.5)*/
    unsigned char frame[46] = { 0x46, 0x00, 0x00, 0x20, 0x00, 0x00, 0x40, 0x00, 0x01, 0x02, 0x36, 0x60, 0xc0, 0xa8, 0x0b, 0xc9,
                                0xe1, 0x01, 0x01, 0x05, 0x94, 0x04, 0x00, 0x00, 0x16, 0x00, 0x07, 0xf9, 0xe1, 0x01, 0x01, 0x05,
                                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
L7_RC_t teste_snooping_tx_group_specific_query(unsigned int service_id, unsigned int port_id, unsigned int client_id)
{
    /*Group Specific query (225.1.1.5)*/
    unsigned char frame[46]  = { 0x45, 0x00, 0x00, 0x1c, 0x65, 0x53, 0x00, 0x00, 0x01, 0x02, 0xb0, 0xdd, 0xc0, 0xa8, 0x01, 0x02,
                                 0xe1, 0x01, 0x01, 0x04, 0x11, 0x0a, 0x0c, 0xf0, 0xe1, 0x01, 0x01, 0x04, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
L7_RC_t teste_snooping_mld_query(unsigned int service_id, unsigned int port_id, unsigned int client_id)
{

     unsigned char frame[1000]  = { 0x60, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
                                  ...
                                  0x82, 0x00, 0x7a, 0xc1, 0x03, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
                                  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
     unsigned char* payload = frame;

    return snooping_tx_packet(payload, 72 /*length*/, service_id, port_id, client_id, L7_AF_INET6, -1);
}
