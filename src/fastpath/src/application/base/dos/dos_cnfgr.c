  ...
  *pReason   = 0;
  ...
  if (osapiRWLockCreate(&doSCfgRWLock, OSAPI_RWLOCK_Q_PRIORITY) == L7_FAILURE)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DOSCONTROL_COMPONENT_ID,
            "doSCnfgrInitPhase1Process: Unable to create r/w lock for DOSCONTROL\n");
    *pResponse = 0;
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DOSCONTROL_COMPONENT_ID,
            "doSCnfgrInitPhase1Process: msgQueue creation error.\n");
    *pResponse = 0;
    *pReason   = L7_CNFGR_ERR_RC_FATAL;
    doSRC = L7_ERROR;
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DOSCONTROL_COMPONENT_ID,
            "doSCnfgrInitPhase1Process: Task could not be started.\n");
    *pResponse = 0;
    *pReason   = L7_CNFGR_ERR_RC_FATAL;
    doSRC = L7_ERROR;
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DOSCONTROL_COMPONENT_ID,
            "doSCnfgrInitPhase1Process: could not allocate memory to dosMapTbl.\n");
    *pResponse = 0;
    *pReason   = L7_CNFGR_ERR_RC_LACK_OF_RESOURCES;
    doSRC   = L7_ERROR;
                                      ...
                                      L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason   = 0;
  ...
  if (nimRegisterIntfChange(L7_DOSCONTROL_COMPONENT_ID,
                            dosIntfChangeCallback,
                            dosStartupNotifyCallback,
                            NIM_STARTUP_PRIO_DOS) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_DOSCONTROL_COMPONENT_ID,
            "L7_DOSCONTROL_COMPONENT_ID: Unable to register with NIM\n");
                                      ...
                                      L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  memset(&dosPortEventMask_g, 0, sizeof(dosPortEventMask_g));
