...
typedef enum
{
  ...
  L7_ACL_PER_RULE_ACTIVATION_ID,  /* Per rule activation used by Time Based ACLs */
...
typedef enum
{
  L7_ACL_RULE_STATUS_NONE = 0,                 /* NO STATE    */
  L7_ACL_RULE_STATUS_INACTIVE ,                 /* INACTIVE    */
  L7_ACL_RULE_STATUS_ACTIVE,                       /* ACTIVE           */  

} L7_ACL_RULE_STATUS_t;
