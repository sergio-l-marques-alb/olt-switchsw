...
# define PTIN_SYSTEM_N_IGMP_INSTANCES               16    /* Maximum nr of IGMP instances */
...
# define PTIN_SYSTEM_IGMP_MAXCLIENTS                max (PTIN_SYSTEM_IGMP_MAXONUS, 1 /*PTIN_SYSTEM_IGMP_MAXCLIENTS_PER_INTF*PTIN_SYSTEM_N_INTERF*/)
...
# define PTIN_SYSTEM_N_DHCP_INSTANCES               16    /* Maximum nr of DHCP instances */
# define PTIN_SYSTEM_N_PPPOE_INSTANCES              16    /* Maximum nr of PPPoE instances */
