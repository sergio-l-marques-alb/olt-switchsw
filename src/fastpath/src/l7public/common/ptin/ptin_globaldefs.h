...
#endif
#if PTIN_BOARD_IS_MATRIX || (PTIN_BOARD == PTIN_BOARD_OLT1T0) || (PTIN_BOARD == PTIN_BOARD_TG16G)
...
# define PTIN_VLAN_MASK(vlanId)       (PTIN_VLAN_IS_QUATTRO(vlanId)) ? (PTIN_SYSTEM_EVC_QUATTRO_VLAN_MASK) : \
