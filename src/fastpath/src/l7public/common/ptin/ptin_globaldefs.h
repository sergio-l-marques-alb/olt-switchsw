...
# define EVC_QUATTRO_FLOWS_FEATURE              1
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MASK  0x3ff
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLANS      (PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MASK+1)
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MIN   (PTIN_SYSTEM_EVC_P2MP_VLAN_MAX+1)
...
# define PTIN_SYSTEM_EVC_P2MP_VLAN_MAX     (PTIN_SYSTEM_EVC_VLANS_PER_BLOCK*PTIN_SYSTEM_EVC_P2MP_VLAN_BLOCKS-1)
/* For QUATTRO P2P services */
# define EVC_QUATTRO_FLOWS_FEATURE              0
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MASK  0x3ff
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLANS      (PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MASK+1)
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MIN   (PTIN_SYSTEM_EVC_P2MP_VLAN_MAX+1)
# define PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MAX   (PTIN_SYSTEM_EVC_QUATTRO_P2P_VLAN_MIN+PTIN_SYSTEM_EVC_QUATTRO_P2P_VLANS-1)
