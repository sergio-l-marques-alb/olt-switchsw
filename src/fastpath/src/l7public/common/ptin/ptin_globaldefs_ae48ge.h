...
#define BACKPLANE_INTLAGS_MAX       AE48GE_BACKPLANE_INTLAGS_MAX
#define BACKPLANE_1ST_MEMBER(lag)   backplane_intlag_map_ae48ge[lag][0]
#define BACKPLANE_2ND_MEMBER(lag)   backplane_intlag_map_ae48ge[lag][1]
