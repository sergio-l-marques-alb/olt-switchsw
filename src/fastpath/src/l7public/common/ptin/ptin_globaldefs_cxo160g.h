#ifndef _PTIN_GLOBALDEFS_CXO160G_H
...
#define PTIN_PHY_CXO2TC16SXG_POST   10
...
# define PTIN_SYSTEM_N_CLIENT_PORTS     PTIN_SYSTEM_N_PORTS

# define PTIN_SYSTEM_INTERNAL_LAGID_BASE    10
# define PTIN_SYSTEM_PROTECTION_LAGID_BASE  13

# define PTIN_SYSTEM_PON_PORTS_MASK    0x0000ULL
# define PTIN_SYSTEM_ETH_PORTS_MASK    0x000FULL
# define PTIN_SYSTEM_10G_PORTS_MASK    0xFFF0ULL
...
#define PTIN_IPC_IF_NAME               "eth0:1"
