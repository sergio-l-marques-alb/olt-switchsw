...
# define PTIN_SYSTEM_EVC_ETREE_VLAN_BLOCKS        (PTIN_SYSTEM_EVC_ETREE_CPU_VLAN_BLOCKS + PTIN_SYSTEM_EVC_ETREE_CPU_MC_VLAN_BLOCKS+PTIN_SYSTEM_EVC_ETREE_BS_VLAN_BLOCKS)
