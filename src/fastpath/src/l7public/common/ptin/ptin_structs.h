...
#define ENDIAN_SWAP32(val) \
  ((unsigned int) (((unsigned long)(val) >> 24) | (((unsigned long)(val) >> 8) & 0x0000ff00UL) | \
...
#define ENDIAN_SWAP8(val)  ((unsigned char) (val))
#define ENDIAN_SWAP16(val) ((unsigned short) (val))
#define ENDIAN_SWAP32(val) ((unsigned int) (val))
#define ENDIAN_SWAP64(val) ((unsigned long long) (val))
...
#define PTIN_IS_MASK_WORD_SET(array,idx)  (array[((idx)/UINT32_BITSIZE)] == 0 ? 0 : 1)
...
enum ptin_portactivity_mask_e {
    PTIN_PORTACTIVITY_MASK_RX_ACTIVITY         = 0x0001,
    PTIN_PORTACTIVITY_MASK_TX_ACTIVITY         = 0x0002,
    PTIN_PORTACTIVITY_MASK_TX_COLLISIONS       = 0x0004,
    PTIN_PORTACTIVITY_MASK_RX_CRC_ERRORS       = 0x0008,
    PTIN_PORTACTIVITY_MASK_RX_JABBERS          = 0x0010,
    PTIN_PORTACTIVITY_MASK_RX_FRAGMENTS        = 0x0020,
    PTIN_PORTACTIVITY_MASK_RX_OVERSIZEPACKETS  = 0x0040,
    PTIN_PORTACTIVITY_MASK_RX_UNDERSIZEPACKETS = 0x0080,
    PTIN_PORTACTIVITY_MASK_RX_DROPPACKETS      = 0x0100,
};
...
#define PTIN_QOS_COS_TAIL_THRESHOLDS_MASK 0x80
