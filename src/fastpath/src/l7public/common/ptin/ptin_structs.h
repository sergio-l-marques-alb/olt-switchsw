...
#define PTIN_EVC_MASK_SERV_TYPE       0x00030000

#define PTIN_EVC_SERV_TYPE_P2MP       0x00000000
#define PTIN_EVC_SERV_TYPE_P2P        0x00010000
#define PTIN_EVC_SERV_TYPE_QUATTRO    0x00020000
