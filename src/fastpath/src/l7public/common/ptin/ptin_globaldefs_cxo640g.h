...
# define PTIN_SYSTEM_EVC_CPU_UNKUC_VLAN_BLOCKS    8     /* Number of vlan blocks for CPU services with MAC learning */
# define PTIN_SYSTEM_EVC_BS_UNKUC_VLAN_BLOCKS     16    /* Number of vlan blocks for Bitstream with MAC learning services */
...
# define PTIN_SYSTEM_EVC_MCAST_UNKUC_VLAN_MIN    PTIN_SYSTEM_EVC_MCAST_VLAN_MIN
# define PTIN_SYSTEM_EVC_MCAST_UNKUC_VLAN_MAX   (/*PTIN_SYSTEM_EVC_MCAST_UNKUC_VLAN_MIN +*/ PTIN_SYSTEM_EVC_CPU_UNKUC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
# define PTIN_SYSTEM_EVC_MCAST_UNKUC_VLAN_MASK  (~(PTIN_SYSTEM_EVC_MCAST_UNKUC_VLAN_MAX /*- PTIN_SYSTEM_EVC_MCAST_UNKUC_VLAN_MIN*/) & 0xfff)

# define PTIN_SYSTEM_EVC_BCAST_UNKUC_VLAN_MIN   (PTIN_SYSTEM_EVC_BCAST_VLAN_MIN + 1)
# define PTIN_SYSTEM_EVC_BCAST_UNKUC_VLAN_MAX   (PTIN_SYSTEM_EVC_BCAST_UNKUC_VLAN_MIN + PTIN_SYSTEM_EVC_CPU_UNKUC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
# define PTIN_SYSTEM_EVC_BCAST_UNKUC_VLAN_MASK  (~(PTIN_SYSTEM_EVC_BCAST_UNKUC_VLAN_MAX - PTIN_SYSTEM_EVC_BCAST_UNKUC_VLAN_MIN) & 0xfff)

# define PTIN_SYSTEM_EVC_BITSTR_UNKUC_VLAN_MIN   PTIN_SYSTEM_EVC_BITSTR_VLAN_MIN
# define PTIN_SYSTEM_EVC_BITSTR_UNKUC_VLAN_MAX  (PTIN_SYSTEM_EVC_BITSTR_UNKUC_VLAN_MIN + PTIN_SYSTEM_EVC_BS_UNKUC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
# define PTIN_SYSTEM_EVC_BITSTR_UNKUC_VLAN_MASK (~(PTIN_SYSTEM_EVC_BITSTR_UNKUC_VLAN_MAX - PTIN_SYSTEM_EVC_BITSTR_UNKUC_VLAN_MIN) & 0xfff)
