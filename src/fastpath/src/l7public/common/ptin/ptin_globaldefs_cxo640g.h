...
# define PTIN_SYSTEM_EVC_ETREE_CPU_BC_VLAN_BLOCKS 8     /* Number of vlan blocks for E-Tree CPU-BC services */
# define PTIN_SYSTEM_EVC_ETREE_CPU_MC_VLAN_BLOCKS 8     /* Number of vlan blocks for E-Tree CPU-MC services */
# define PTIN_SYSTEM_EVC_ETREE_CPU_VLAN_BLOCKS    (PTIN_SYSTEM_EVC_ETREE_CPU_BC_VLAN_BLOCKS + PTIN_SYSTEM_EVC_ETREE_CPU_MC_VLAN_BLOCKS)
...
# define PTIN_SYSTEM_EVC_ELAN_VLAN_MAX        (PTIN_SYSTEM_EVC_ELAN_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)

# define PTIN_SYSTEM_EVC_BITSTREAM_VLAN_MIN    PTIN_VLAN_MIN
# define PTIN_SYSTEM_EVC_BITSTREAM_VLAN_MAX   (PTIN_SYSTEM_EVC_BITSTREAM_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)

# define PTIN_SYSTEM_EVC_CPU_VLAN_MIN         (PTIN_SYSTEM_EVC_BITSTREAM_VLAN_MAX + 1)
...
# define PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MIN    PTIN_SYSTEM_EVC_CPU_VLAN_MIN
# define PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MAX   (PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MIN + PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
# define PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MASK  (~(PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MAX - PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MIN) & 0xfff)

# define PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MIN   (PTIN_SYSTEM_EVC_CPU_BCAST_VLAN_MAX + 1)
# define PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MAX   (PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MIN + PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
# define PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MASK  (~(PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MAX - PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MIN) & 0xfff)
...
# define PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MIN     PTIN_SYSTEM_EVC_ETREE_VLAN_MIN
# define PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MAX    (PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MIN + PTIN_SYSTEM_EVC_ETREE_CPU_BC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_ETREE_VLAN_BLOCKS - 1)
# define PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MASK   (~(PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MAX - PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MIN) & 0xfff)

# define PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MIN    (PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MAX + 1)
# define PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MAX    (PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MIN + PTIN_SYSTEM_EVC_ETREE_CPU_MC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_ETREE_VLAN_BLOCKS - 1)
# define PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MASK   (~(PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MAX - PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MIN) & 0xfff)

# define PTIN_SYSTEM_EVC_ETREE_BS_VLAN_MIN    (PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MAX + 1)
# define PTIN_SYSTEM_EVC_ETREE_BS_VLAN_MAX    (PTIN_SYSTEM_EVC_ETREE_BS_VLAN_MIN + PTIN_SYSTEM_EVC_ETREE_BS_VLAN_BLOCKS*PTIN_SYSTEM_EVC_ETREE_VLAN_BLOCKS - 1)
