...
# define PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MIN     PTIN_SYSTEM_EVC_ETREE_CPU_VLAN_MIN
# define PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MAX    (PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MIN + PTIN_SYSTEM_EVC_ETREE_CPU_MC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
# define PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MASK   (~(PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MAX - PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MIN) & 0xfff)

# define PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MIN    (PTIN_SYSTEM_EVC_ETREE_MC_VLAN_MAX + 1)
# define PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MAX    (PTIN_SYSTEM_EVC_ETREE_BC_VLAN_MIN + PTIN_SYSTEM_EVC_ETREE_CPU_BC_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1)
