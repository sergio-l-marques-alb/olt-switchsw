...
# define PTIN_SYSTEM_N_PORTS           15
# define PTIN_SYSTEM_N_PONS            0
# define PTIN_SYSTEM_N_ETH             12
...
# define PTIN_SYSTEM_ETH_PORTS_MASK    0x0000000000000FFFULL
# define PTIN_SYSTEM_10G_PORTS_MASK    0x0000000000007000ULL
