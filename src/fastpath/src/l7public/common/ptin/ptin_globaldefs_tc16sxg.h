...
# define PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_BLOCKS    64    /* Number of vlan blocks for CPU-Multicast services */
...
# define PTIN_SYSTEM_EVC_MCAST_VLAN_MAX   (/*PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_MIN +*/ PTIN_SYSTEM_EVC_CPU_MCAST_VLAN_BLOCKS*PTIN_SYSTEM_EVC_VLANS_PER_BLOCK - 1) /*2048*/ 
...
#  define PTIN_SYSTEM_EVC_QUATTRO_VLANS          1024
#  define PTIN_SYSTEM_EVC_QUATTRO_VLAN_MIN       PTIN_SYSTEM_EVC_BITSTR_VLAN_MAX
