...
* @end
*********************************************************************/
L7_RC_t bootpDhcpRelayrtrCIDOptionModeGet(dhcpRelayIntfValue_t *circuitIDIntfOptionMode,
                                          L7_uint32 intIfNum);
...
* @end
*********************************************************************/
L7_RC_t bootpDhcpRelayrtrCIDOptionCheckModeGet(dhcpRelayIntfValue_t *cidOptionCheckMode,
                                               L7_uint32 intIfNum);
