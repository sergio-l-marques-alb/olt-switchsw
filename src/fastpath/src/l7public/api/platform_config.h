...
* @returns
*
* @notes    Based on the SDM template limit.
*           Can be reduced by user configuration of the ARP application.
*
* @end
*********************************************************************/
...
/*********************************************************************
*
* @purpose  Get the maximum number of APs in a WDS Group.
*
...
/*********************************************************************
*
* @purpose  Get the maximum number of WDS Links in a WDS Group.
*
* @param    L7_ushort16  *value  @b{(output)} pointer to the value
*
* @returns L7_SUCCESS
