...
* @end
*********************************************************************/
L7_RC_t filterSrcIntfMaskModify(L7_uchar8* macAddr, L7_uint32 vlanId,
...
* @end
*********************************************************************/
L7_RC_t filterDstIntfFilterAdd(L7_uchar8* macAddr,
                         L7_uint32 vlanId, 
                         L7_uint32 dstIntf);
...
* @end
*********************************************************************/
L7_RC_t filterDstIntfFilterDelete(L7_uchar8* macAddr,
                            L7_uint32 vlanId,
                            L7_uint32 dstIntf);
