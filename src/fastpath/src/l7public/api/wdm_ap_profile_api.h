...
/*********************************************************************
*
* @purpose  Set the Disconnected AP Management Mode in the AP Profile
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
...
*
*********************************************************************/
L7_RC_t wdmAPProfileDisConnAPMgmtModeSet(L7_uint32 profileId, L7_uint32 mode);

/*********************************************************************
*
* @purpose  Get the Disconnect AP Management Mode for the AP Profile.
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
...
*
*********************************************************************/
L7_RC_t wdmAPProfileDisConnAPMgmtModeGet (L7_uint32 profileId, L7_uint32 *mode);

/*********************************************************************
*
* @purpose  Set the Disconnected AP Forwarding Mode in the AP Profile
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 mode @b{(input)} L7_ENABLE or L7_DISABLE
*
...
*
*********************************************************************/
L7_RC_t wdmAPProfileDisConnAPFwdingModeSet(L7_uint32 profileId, L7_uint32 mode);

/*********************************************************************
*
* @purpose  Get the Disconnect AP Forwarding Mode for the AP Profile.
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 *mode @b{(output)} L7_ENABLE or L7_DISABLE
*
...
*
*********************************************************************/
L7_RC_t wdmAPProfileDisConnAPFwdingModeGet (L7_uint32 profileId,
                            L7_uint32 *mode);

#if defined(L7_AE_PROTOCOL_PACKAGE)
/*********************************************************************
*
* @purpose  Set the AE Protocol Mode in the AP Profile
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 mode @b{(input)} L7_ENABLE or L7_DISABLE
*
...
*
*********************************************************************/
L7_RC_t wdmAPProfileAEProtocolModeSet(L7_uint32 profileId, L7_uint32 mode);

/*********************************************************************
*
* @purpose  Get the AE Protocol Mode for the AP Profile.
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 *mode @b{(output)} L7_ENABLE or L7_DISABLE
*
...
*
*********************************************************************/
L7_RC_t wdmAPProfileAEProtocolModeGet (L7_uint32 profileId,
                                       L7_uint32 *mode);
#endif
...
/*********************************************************************
*
* @purpose  Set the TSPEC Mode for the AP Profile Radio.
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 radioIndex @b{(input)} Radio Index
...
*
*********************************************************************/
L7_RC_t wdmAPProfileRadioTspecModeSet(L7_uint32 profileId,
                                      L7_uint32 radioIndex,
                                      L7_uint32 val);

/*********************************************************************
*
* @purpose  Get the TSPEC Mode for the AP Profile Radio.
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 radioIndex @b{(input)} Radio Index
...
*
*********************************************************************/
L7_RC_t wdmAPProfileRadioTspecModeGet(L7_uint32 profileId,
                                      L7_uint32 radioIndex,
                                      L7_uint32 *val);
...
/*********************************************************************
*
* @purpose  Get the value for an AP EDCA queue attribute from a
*           template
*
* @param    L7_WDM_EDCA_TEMPLATE_TYPE @b{(input)} ttype  template type
* @param    L7_WDM_QOS_QUEUES_t @b{(input)} qtype  queue type
* @param    L7_WDM_EDCA_QUEUE_ATTR_t @b{(input)} qattrt  queue attr key
* @param    L7_uint32 @b{(output)} pVal  pointer to result
*
* @returns   L7_SUCCESS
* @returns   L7_FAILURE
*
* @comments  Returns L7_FAILURE for the custom template type
*
* @end
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioAPEDCATemplateQValueGet(L7_WDM_EDCA_TEMPLATE_TYPE ttype,
                                         L7_WDM_QOS_QUEUES_t qtype,
                                         L7_WDM_EDCA_QUEUE_ATTR_t qattrt,
                                         L7_uint32 * pVal);

/*********************************************************************
*
* @purpose  Get the value for a Station EDCA queue attribute from a
*           template
*
* @param    L7_WDM_EDCA_TEMPLATE_TYPE @b{(input)} ttype  template type
* @param    L7_WDM_QOS_QUEUES_t @b{(input)} qtype  queue type
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStaEDCATemplateQValueGet(L7_WDM_EDCA_TEMPLATE_TYPE ttype,
                                            L7_WDM_QOS_QUEUES_t qtype,
                                          L7_WDM_EDCA_QUEUE_ATTR_t qattrt,
                                          L7_uint32 * pVal);
...
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 radioIndex  @b{(input)} Radio Index
* @param    L7_uint32 queueId @b{(input)} QoS Queue ID
*
* @returns   L7_SUCCESS
* @returns   L7_FAILURE
*
...
* @param    L7_uint32 radioIndex  @b{(input)} Radio Index
* @param    L7_uint32 *queueId @b{(output)} QoS Queue ID
*
* @returns   L7_SUCCESS
* @returns   L7_FAILURE
*
...
L7_RC_t wdmAPProfileRadioAPEdcaCWMinSet (L7_uint32 profileId,
                        L7_uint32 radioIndex, L7_uint32 queueId,
                        L7_ushort16 cwmin);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioAPEdcaCWMinGet (L7_uint32 profileId,
                                 L7_uint32 radioIndex, 
                                 L7_uint32 queueId,
                                 L7_ushort16 *cwmin);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioAPEdcaCWMaxSet (L7_uint32 profileId,
                                 L7_uint32 radioIndex,
                                 L7_uint32 queueId,
                                 L7_ushort16 cwmax);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioAPEdcaCWMaxGet(L7_uint32 profileId,
                                L7_uint32 radioIndex, 
                                L7_uint32 queueId,
                                L7_ushort16 *cwmax);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioAPEdcaBurstLengthSet (L7_uint32 profileId,
                                       L7_uint32 radioIndex, 
                                       L7_uint32 queueId,
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioAPEdcaBurstLengthGet(L7_uint32 profileId,
                                      L7_uint32 radioIndex, 
                                      L7_uint32 queueId,
                                      L7_uint32 *burstLength);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaAifsSet (L7_uint32 profileId,
                                     L7_uint32 radioIndex, 
                                     L7_uint32 queueId,
                                     L7_ushort16 aifs);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaAifsGet(L7_uint32 profileId,
                                    L7_uint32 radioIndex, 
                                    L7_uint32 queueId,
                                    L7_ushort16 *aifs);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaCWMinSet(L7_uint32 profileId,
                                     L7_uint32 radioIndex, 
                                     L7_uint32 queueId,
                                     L7_ushort16 cwmin);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaCWMinGet(L7_uint32 profileId,
                                     L7_uint32 radioIndex, 
                                     L7_uint32 queueId,
                                     L7_ushort16 *cwmin);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaCWMaxSet (L7_uint32 profileId,
                                      L7_uint32 radioIndex, 
                                      L7_uint32 queueId,
                                      L7_ushort16 cwmax);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaCWMaxGet(L7_uint32 profileId,
                                     L7_uint32 radioIndex, 
                                     L7_uint32 queueId,
                                     L7_ushort16 *cwmax);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaTxOpLimitSet(L7_uint32 profileId, 
                                         L7_uint32 radioIndex, 
                                         L7_uint32 queueId,
                                         L7_uint32 txOpLimit);
...
*********************************************************************/
L7_RC_t 
wdmAPProfileRadioStationEdcaTxOpLimitGet(L7_uint32 profileId, 
                                         L7_uint32 radioIndex,
                                         L7_uint32 queueId,
                                         L7_uint32 *txOpLimit);
...
/*********************************************************************
* @purpose  Get current EDCA template type 
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 radioIndex  @b{(input)} Radio Index
* @param    L7_WDM_EDCA_TEMPLATE_TYPE *ttype @b{(output)} Template type
*
* @returns   L7_SUCCESS
* @returns   L7_FAILURE
*
...
L7_RC_t
wdmAPProfileRadioEdcaTemplateGet(L7_uint32 profileId, 
                                 L7_uint32 radioIndex, 
                                 L7_WDM_EDCA_TEMPLATE_TYPE * ttype);


/*********************************************************************
* @purpose  Set current EDCA template type 
*
* @param    L7_uint32 profileId @b{(input)} AP Profile ID
* @param    L7_uint32 radioIndex  @b{(input)} Radio Index
* @param    L7_WDM_EDCA_TEMPLATE_TYPE ttype @b{(input)} Template type
*
* @returns   L7_SUCCESS
* @returns   L7_FAILURE
*
* @comments  Will set EDCA values for both AP and station if
*            the new type != L7_WDM_EDCA_TEMPLATE_CUSTOM
*
* @end
*********************************************************************/
...
L7_RC_t
wdmAPProfileRadioEdcaTemplateSet(L7_uint32 profileId, 
                                 L7_uint32 radioIndex, 
                                 L7_WDM_EDCA_TEMPLATE_TYPE ttype);
...
*
* returns   L7_SUCCESS
* returns   L7_TABLE_IS_FULL      Too many different QoS definitions being used for wireless
* returns   L7_FAILURE
*
* @notes    An L7_TABLE_IS_FULL response means too many different ACLs and/or
*           DiffServ policies are assigned to wireless networks for client QoS.
*           For a given AP profile, wireless imposes a finite upper limit on 
*           the number of access list and policy definitions that the AP can support.
*
* @end
*********************************************************************/
...
/*********************************************************************
* @purpose  Adds entry to MCS index table for given radio
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    mcs_idx_t    vapId        @b{(input)} MCS index
*
* returns   L7_SUCCESS
* returns   L7_FAILURE
*
...
*********************************************************************/
L7_RC_t
wdmAPProfileRadioMCSIndexAdd(L7_uint32 profileId, 
                             L7_uint32 radioIndex, 
                             mcs_idx_t idx);

/*********************************************************************
* @purpose  Adds all possible entries to MCS index table for given radio
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    mcs_idx_t    vapId        @b{(input)} MCS index
...
*********************************************************************/
L7_RC_t
wdmAPProfileRadioMCSIndexAllAdd(L7_uint32 profileId, 
                                L7_uint32 radioIndex);
...
*********************************************************************/
L7_RC_t
wdmAPProfileRadioMCSIndexDelete(L7_uint32 profileId, 
                                L7_uint32 radioIndex, 
                                mcs_idx_t idx);

/*********************************************************************
* @purpose  Deletes all entries from MCS index table for given radio
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    mcs_idx_t    vapId        @b{(input)} MCS index
...
*********************************************************************/
L7_RC_t
wdmAPProfileRadioMCSIndexAllDelete(L7_uint32 profileId, 
                                   L7_uint32 radioIndex);

/*********************************************************************
* @purpose  To verify the existence of an index in a radio 
*           configuration's MCS index table
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    mcs_idx_t    idx          @b{(input)}  index
* 
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
L7_RC_t
wdmAPProfileRadioMCSIndexGet(L7_uint32 profileId, 
                             L7_uint32 radioIndex, 
                             mcs_idx_t idx);

/*********************************************************************
* @purpose  To find the next index in a radio configuration's MCS 
*           index table
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    mcs_idx_t    idx          @b{(input)}  idx
* @param    mcs_idx_t    *pIdx        @b{(output)} pIdx
* 
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
L7_RC_t
wdmAPProfileRadioMCSIndexGetNext(L7_uint32 profileId, 
                                 L7_uint32 radioIndex, 
                                 mcs_idx_t idx,
                                 mcs_idx_t *pIdx);
...
/*********************************************************************
* @purpose  To serialize an MCS index value array into a buffer of
*           bytes. 
*
* @param    L7_uint32    profileId    @b{(input)} AP Profile ID 
* @param    L7_uint32    radioId      @b{(input)} Radio interface
* @param    L7_uchar8    *pBytes      @b{(output)} byte array
* 
* @returns  L7_SUCCESS
* @returns  L7_FAILURE
*
...
L7_RC_t
wdmAPProfileRadioMCSIndicesAsBytesGet(L7_uint32 profileId, 
                                      L7_uint32 radioIndex, 
                                      L7_uchar8 *pBytes);
