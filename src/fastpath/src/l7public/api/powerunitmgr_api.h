...
**********************************************************************
*
* @filename   powerunitmgr_api.h
*
* @purpose    Component APIs for the Power Unit Manager
*
...
#ifndef POWER_UNIT_MANAGER_API_H
#define POWER_UNIT_MANAGER_API_H
...
* @end
******************************************************************************/
extern void pumgrApiCnfgrCommand(L7_CNFGR_CMD_DATA_t *pCmdData);
...
* @end
******************************************************************************/
extern L7_RC_t pumgrAllTrapsRegister( L7_COMPONENT_IDS_t registrar_ID,
...
/******************************************************************************
* @purpose  This function gets the handle for first entry in the power
...
* @end
******************************************************************************/
extern L7_RC_t pumgrModuleStatusFirstGet(L7_uint32 *pHandle);

/******************************************************************************
* @purpose  This function gets the handle to the next entry in the 
*           power unit manager module database, based on the 
*           specified  handle
*
...
* @end
******************************************************************************/
extern L7_RC_t pumgrModuleStatusNextGet(L7_uint32 handle,
                                        L7_uint32 *pNextHandle);


/******************************************************************************
* @purpose  This function gets the handle for the entry in the power
...
* @end
******************************************************************************/
extern L7_RC_t pumgrModuleStatusSlotGet(L7_uint32 slotNum,
                                        L7_uint32 *pHandle);
...
* @end
******************************************************************************/
extern L7_RC_t pumgrModuleStatusGet(L7_uint32 handle, 
                                    L7_MODULE_DATABASE_PARAMS_t param, 
                                    void *pEntry);

#endif /* POWER_UNIT_MANAGER_API_H */
