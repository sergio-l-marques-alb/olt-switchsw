...
typedef struct wdmClientTSStatus_s
{
  ...
  L7_uchar8             acindex;        /* access category index per L7_WIRELESS_TSPEC_AC_t */
...
*
* @param    L7_enetMacAddr_t       macAddr     @b{(input)}  client MAC address
* @param    L7_uint32              tid         @b{(input)}  TSPEC traffic stream identifier
...
/*********************************************************************
*
* @purpose  Creates a client TSPEC traffic stream entry for the specified TID.
*
* @param    L7_enetMacAddr_t        macAddr       @b{(input)}  client MAC address
* @param    L7_uint32               tid           @b{(input)}  traffic stream identifier
...
*           only if one does not already exist for the TID.
*
* @end
*
*********************************************************************/
L7_RC_t wdmAssocClientTsEntryCreate(L7_enetMacAddr_t macAddr, L7_uint32 tid, L7_BOOL *newAlloc);

/*********************************************************************
*
* @purpose  Deletes a client TSPEC traffic stream entry for the specified TID.
*
* @param    L7_enetMacAddr_t        macAddr       @b{(input)}  client MAC address
* @param    L7_uint32               tid           @b{(input)}  traffic stream identifier
*
...
*
*********************************************************************/
L7_RC_t wdmAssocClientTsEntryDelete(L7_enetMacAddr_t macAddr, L7_uint32 tid);
...
*
*********************************************************************/
L7_RC_t wdmAssocClientTsEntryGet(L7_enetMacAddr_t macAddr, L7_uint32 tid);
...
*
*********************************************************************/
L7_RC_t wdmAssocClientTsEntryNextGet(L7_enetMacAddr_t macAddr, L7_uint32 tid,
...
*
*********************************************************************/
L7_RC_t wdmAssocClientTsTidValid(L7_enetMacAddr_t       macAddr,
                                 L7_uint32              tid);
...
*
*********************************************************************/
L7_RC_t wdmAssocClientTsTidActive(L7_enetMacAddr_t       macAddr,
                                  L7_uint32              tid);
...
*
*********************************************************************/
L7_RC_t wdmAssocClientTsAccessCategoryGet(L7_enetMacAddr_t       macAddr,
                                          L7_uint32              tid,
                                          L7_uchar8             *val);
