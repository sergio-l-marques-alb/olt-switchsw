...
* @end
*********************************************************************/
extern L7_RC_t poeFirstValidPSEIntfNumber(L7_uint32 *pFirstIntIfNum);
...
* @end
*********************************************************************/
extern L7_RC_t poeNextValidPSEIntf(L7_uint32 intIfNum, L7_uint32 *pNextIntIfNum);

/*********************************************************************
* @purpose  Return Internal Interface Number of the first valid interface
*           capable of supporting PD.
*
* @param    pFirstIntIfNum @b{(output)}  pointer to first internal interface number
*
* @returns  L7_SUCCESS  if success
...
* @end
*********************************************************************/
extern L7_RC_t poeFirstValidPDIntfNumber(L7_uint32 *pFirstIntIfNum);
...
* @end
*********************************************************************/
extern L7_RC_t poeNextValidPDIntf(L7_uint32 intIfNum, L7_uint32 *pNextIntIfNum);
...
/*********************************************************************
*
* @purpose Sets the Power Limit in PSE bypassing the Configuration Save.
*
* @param    intIfNum    pointer to intIfNum,
*                       (@b{Returns: intIfNum})
* @param    val         pointer to value,
...
*
*********************************************************************/
extern L7_RC_t poePethPsePortBypassCfgPowerLimitSet(L7_uint32 intIfNum,
                                             L7_uint32 val);
/*********************************************************************
*
* @purpose Sets the Violation type in PSE Bypassing hte Configuration Save.
*
* @param    intIfNum    pointer to intIfNum,
*                       (@b{Returns: intIfNum})
* @param    val         pointer to value,
...
*
*********************************************************************/
extern L7_RC_t poePethPsePortBypassCfgViolationTypeSet(L7_uint32 intIfNum,
                                              L7_uint32 val);
/*********************************************************************
*
...
* @end
*********************************************************************/
extern L7_RC_t poePethPsePortSwitchTo803ATMode(L7_uint32 intIfNum, L7_uint32 val);
...
L7_RC_t poeFWImageVersionGet(L7_char8 *imageVersion);
   ...
   /* PoE+ API */
/*********************************************************************
* @purpose Gets the power negotiated via LLDP on a given interface
*
* @param    intIfNum Internal Interface Number
* @param    val         pointer to counter,
*
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpNegotiatedPowerGet(L7_uint32 intIfNum,L7_uint32* val);

/*********************************************************************
* @purpose  Gets the Local PoE Device Power Type
*
* @param    intIfNum    Internal Interface Number
* @param    powerType   Pointer to power type,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpPowerTypeGet(L7_uint32 intIfNum,L7_uchar8 *powerType);

/*********************************************************************
* @purpose  Gets the Remote PoE Device Power Type
*
* @param    intIfNum    Internal Interface Number
* @param    powerType   Pointer to power type,
*
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpMirroredPowerTypeGet(L7_uint32 intIfNum,L7_uchar8 *powerType);

/*********************************************************************
* @purpose  Gets the Local PoE Device Power Source
*
* @param    intIfNum      Internal Interface Number
* @param    powerSource   Pointer to power Source,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpPowerSourceGet(L7_uint32 intIfNum,L7_uchar8 *powerSource);

/*********************************************************************
* @purpose  Gets the Remote PoE Device Power Source
*
* @param    intIfNum      Internal Interface Number
* @param    powerSource   Pointer to power Source,
*
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpMirroredPowerSourceGet(L7_uint32 intIfNum,L7_uchar8 *powerSource);

/*********************************************************************
* @purpose  Gets the Local PoE Device Power Priority
*
* @param    intIfNum        Internal Interface Number
* @param    powerPriority   Pointer to power priority,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpPowerPriorityGet(L7_uint32 intIfNum,L7_uchar8 *powerPriority);

/*********************************************************************
* @purpose  Gets the Remote PoE Device Power Priority
*
* @param    intIfNum    Internal Interface Number
* @param    powerPriority   Pointer to power priority,
*
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpMirroredPowerPriorityGet(L7_uint32 intIfNum,L7_uchar8 *powerPriority);

/*********************************************************************
* @purpose  Gets the Local PoE Device Response Time
*
* @param    intIfNum    Internal Interface Number
* @param    respTime    Pointer to response time,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpResponseTimeGet(L7_uint32 intIfNum,L7_uint32 *respTime);

/*********************************************************************
* @purpose  Gets the Local PoE Device Data Link Layer Ready information
*
* @param    intIfNum    Internal Interface Number
* @param    dllReady    Pointer to data link layer ready,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpReadyGet(L7_uint32 intIfNum,L7_BOOL *dllReady);

/*********************************************************************
* @purpose  Gets the Local PoE PSE Device Allocated Power Value
*
* @param    intIfNum          Internal Interface Number
* @param    allocPowerValue   Pointer to allocated power value
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpPSEAllocatedPowerValueGet(L7_uint32 intIfNum,L7_uint32 *allocPowerValue);

/*********************************************************************
* @purpose  Gets the Local PoE PD Device Power Requested Value
*
* @param    intIfNum        Internal Interface Number
* @param    reqPowerValue   Pointer to requested power value,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpPDRequestedPowerValueGet(L7_uint32 intIfNum,L7_uint32 *reqPowerValue);

/*********************************************************************
* @purpose  Gets the Remote PoE PSE Device Allocated Power Value
*
* @param    intIfNum          Internal Interface Number
* @param    allocPowerValue   Pointer to allocated power value,
*
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpMirroredPSEAllocatedPowerValueGet(L7_uint32 intIfNum,L7_uint32 *allocPowerValue);

/*********************************************************************
* @purpose  Gets the Remote PoE PD Device Requested Power Value
*
* @param    intIfNum        Internal Interface Number
* @param    reqPowerValue   Pointer to requested power value,
*
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpMirroredPDRequestedPowerValueGet(L7_uint32 intIfNum,L7_uint32 *reqPowerValue);

/*********************************************************************
* @purpose  Sets the Local PoE Device Power Priority
*
* @param    intIfNum        Internal Interface Number
* @param    powerPriority   New power priority,
*
* @returns  L7_SUCCESS  if success
* @returns  L7_ERROR    if interface does not exist
* @returns  L7_FAILURE  if other failure
...
* @end
*********************************************************************/
L7_RC_t poePethPortLldpPowerPrioritySet(L7_uint32 intIfNum,L7_uchar8 powerPriority);
...
* @end
*********************************************************************/
L7_RC_t poePethPdRequestingPowerSet(L7_uint32 intIfNum,L7_uint32 powerRequested);
