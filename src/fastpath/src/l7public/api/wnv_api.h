...
typedef enum
{
  ...
  L7_WNV_EVENT_DETECTED_CLIENT_ADD,    /* index is MAC, use wdmDetectedClient* APIs */
  L7_WNV_EVENT_DETECTED_CLIENT_UPDATE,
  L7_WNV_EVENT_DETECTED_CLIENT_DELETE,
  L7_WNV_EVENT_BLDG_ADD,
  L7_WNV_EVENT_BLDG_DELETE,
  L7_WNV_EVENT_BLDG_FLR_ADD,
  L7_WNV_EVENT_BLDG_FLR_DELETE,
  L7_WNV_EVENT_LOC_GLOBAL_STATUS_UPDATE,
  L7_WNV_EVENT_LOC_TRIG_STATUS_UPDATE,
  L7_WNV_EVENT_LOC_FLOOR_STATUS_UPDATE
} L7_WNV_EVENT_t;
