...
typedef enum
{
  ...
  SYSAPI_CARD_TYPE_VLAN_PORT,         /* PTin added: virtual ports */
...
typedef struct
{
  ...
  L7_uint32           nsfSupport;            /* Does this unit support non-stop forwarding */
...
typedef enum
{
  ...
  HPC_EVENT_STARTUP_COMPLETE,
  HPC_EVENT_UNIT_FAILURE,
  HPC_EVENT_CARD_INSERT_FAILURE,
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      L7_uint32 failedUnitNum;
      L7_enetMacAddr_t failedUnitKey;
      L7_BOOL          masterFailover;
      L7_enetMacAddr_t newMasterKey;
    } unitFailure;
...
typedef struct
{
  void        (*notify)(hpcStackEventMsg_t event);
} hpcHwStackEventCallback_t;
...
typedef enum
{
  HPC_REGISTRAR_RECEIVE_MSGS_FROM_UNKNOWN_UNIT = 0x1,

  HPC_REGISTRAR_LAST_FLAG
} HPC_REGISTRAR_FLAGS_t;
...
#if L7_FEAT_PWR_AVERAGE
  L7_uint32 power;
  L7_int32 pwrAvgStartTime;
  L7_double64 pwrTotal;
  L7_uint32 pwrNumSamples;
#endif
...
#endif
  SYSAPI_HPC_POE_MAIN_POWER_SOURCE_UPDATE,
  SYSAPI_HPC_POE_PORT_SWITCH_TO_803AT_MODE,
...
#endif
    struct                              /* SYSAPI_HPC_POE_PORT_CLASSIFICATION_TYPE */
    {
      L7_uint32  mode;
    } portClassificationTypeSet;
     struct                              /* Power Bank Configuration */
    {
      L7_uint32  powerBank;
      L7_uint32  powerValue;
    } mainPowerBankSet;
