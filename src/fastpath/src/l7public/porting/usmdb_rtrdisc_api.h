...
* @end
*********************************************************************/
extern L7_RC_t usmDbRtrDiscMinAdvIntervalDefaultGet(L7_uint32 intIfNum, L7_uint32 *defMinAdvInt);
...
* @end
*********************************************************************/
extern L7_RC_t usmDbRtrDiscMinAdvIntervalRevert(L7_uint32 intIfNum);
...
* @end
*********************************************************************/
extern L7_RC_t usmDbRtrDiscAdvLifetimeDefaultGet(L7_uint32 intIfNum, L7_uint32 *defLifetime);
...
* @end
*********************************************************************/
extern L7_RC_t usmDbRtrDiscAdvLifetimeRevert(L7_uint32 intIfNum);
