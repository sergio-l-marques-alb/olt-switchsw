...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertNextToAddrGet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t *messageType, L7_char8 * toAddr);
...
* @end
*********************************************************************/
L7_RC_t usmDbLogEmailAlertSubjectGet(L7_uint32 unitIndex, L7_LOG_EMAIL_ALERT_MSGTYPE_t messageType, L7_char8 * subject);
