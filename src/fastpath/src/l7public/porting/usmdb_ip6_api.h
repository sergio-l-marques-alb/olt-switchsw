...
* @end
*********************************************************************/
L7_RC_t usmDbIp6RtrRadvRtrPrefSet( L7_uint32 intIfNum, L7_uint32 val);
...
* @end
*********************************************************************/
L7_RC_t usmDbIp6RtrRadvRtrPrefGet( L7_uint32 intIfNum, L7_uint32 *val);
...
* @end
*********************************************************************/
L7_RC_t usmDbIp6DhcpClientIntIfNumGet(L7_uint32 *intIfNum);
...
* @end
*********************************************************************/
L7_RC_t usmDbIp6RtrIntfConfigModeGet (L7_uint32 intIfNum, L7_uint32 *automode,
                                      L7_uint32 *dhcpmode);
