...

{
  ...
  cnfgrCCtlrWarmRestartSet(warmRestart);
}
      ...
      if (pQueryData->type == L7_CNFGR_QRY_TYPE_SINGLE) { /* single cid */
        ...
        if ( cid > L7_FIRST_COMPONENT_ID && cid < L7_LAST_COMPONENT_ID ) {
            ...
            if ( cnfgrRC == L7_SUCCESS ) {
                ...
                case L7_CNFGR_QRY_RQST_HW_APPLY_PHASES:
                    if ( pComponent != L7_NULLPTR ) {

                        pQueryData->data.hwApplyPhases = pComponent->hwApplyPhases;
                        cnfgrRC = L7_SUCCESS;
...
/*********************************************************************
* @purpose  This function searches for component (cid) in CR.
    ...
    *pFound      = L7_FALSE;                     /* output */
    ...
    if (crRC1 == L7_SUCCESS)
    {
                    ...
                    else
                    {
                        ...
                        if ( crRC != L7_SUCCESS )
                        {
                            ...
                            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                                    "cnfgrCrComponentFind: Could not get next component from CR... exiting \n");
        ...
        else
        {
            /* log message and return to caller */
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                    "cnfgrCrComponentFind: Could not get first component from CR... exiting \n");
        ...
        if (crRC1 != L7_SUCCESS)
        {
            /* log message and return to caller */
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                    "cnfgrCrComponentFind: failed to unlock CR... exiting \n");
    ...
    else
    {
        /* log message and return to caller */
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrComponentFind: failed to lock CR... exiting \n");
    ...
    *ppComponent = *pCrHandle = L7_NULLPTR;                  /* output */
    ...
    if (crRC1 == L7_SUCCESS)
    {
        ...
        if (crRC1 == L7_SUCCESS)
        {
            if (crRC == L7_SUCCESS)
            {
                ...
                else
                {
                    /* log message and return to caller */
                    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                            "cnfgrCrComponentFirstTake: failed to lock component... exiting \n");
            ...
            else
            {
                /* log message and return to caller */
                L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                        "cnfgrCrComponentFirstTake: failed to obtain member from CR... exiting \n");
        ...
        else
        {
            /* log message and return to caller */
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                    "cnfgrCrComponentFirstTake: failed to unlock CR... exiting \n");
    ...
    {
        (void) osapiSemaGive( crLock );
        /* log message and return to caller */
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrComponentFirstTake: failed to lock CR... exiting \n");
...
L7_RC_t cnfgrCrComponentGive( CNFGR_IN CNFGR_CR_HANDLE_t crHandle )
{
    ...
    if ( crHandle != L7_NULLPTR )
    {
        ...
        if (crRC == L7_SUCCESS)
        {
            ...
            if (crRC == L7_SUCCESS)
            {
                ...
                if (crRC != L7_SUCCESS)
                {
                    /* log message and return to caller */
                    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                            "cnfgrCrComponentGive: failed to unlock CR... exiting \n");
            ...
            else
            {
                ...
                /* log message and return to caller */
                L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                        "cnfgrCrComponentGive: failed to unlock component... exiting \n");
        ...
        else
        {
            /* log message and return to caller */
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                    "cnfgrCrComponentGive: failed to lock CR... exiting \n");
    ...
    else
    {
        /* log message and return to caller */
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrComponentGive: invalid Handle... exiting \n");
                              ...
                              CNFGR_OUT CNFGR_CR_COMPONENT_t **ppComponent )
{
    ...
    *ppComponent = *pCrHandle = L7_NULLPTR;                /* output */
    ...
    if ( crRC1 == L7_SUCCESS )
    {
        ...
        if ( crRC1 == L7_SUCCESS )
        {
            if ( crRC == L7_SUCCESS )
            {
                if ( found == L7_TRUE )
                {
                    ...
                    else
                    {
                        /* log message and return to caller */
                        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                                "cnfgrCrComponentTake: failed to lock component... exiting \n");
            ...
            else
            {
                /* log message and return to caller */
                L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                        "cnfgrCrComponentTake: failed to obtain member from CR... exiting \n");
        ...
        else
        {
            /* log message and return to caller */
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                    "cnfgrCrComponentTake: failed to unlock CR... exiting \n");
    ...
    else
    {
        /* log message and return to caller */
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrComponentTake: failed to lock CR... exiting \n");
...
L7_RC_t cnfgrCrInitialize()
{
    ...
    if (local_unit == L7_NULLPTR)
    {
        ...
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrInitialize: failed to obtain LocalUnitDescriptor... exiting \n");
    ...
    */
    ...
    if ((crLock = osapiSemaMCreate( options )) == L7_NULLPTR)
    {
        /* FATAL ERROR: log message and return to caller */
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrInitialize: failed to obtain crLock... exiting \n");
          ...
          if (skip_component == L7_FALSE)
          {
            ...
            */
            ...
            if (pComponentData != L7_NULLPTR)
            {
              ...
              pComponentData->hwApplyPhases      = cil[i].hwApplyPhases;
                  ...
                  if (crRC == L7_SUCCESS)
                  {
                      ...
                      */
                      ...
                      if (crRC != L7_SUCCESS)
                      {
                          /* FATAL ERROR: log message and return to caller */
                          L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                                  "cnfgrCrInitialize: failed to obtain table member... exiting \n");
              ...
              else
              {
                  /* FATAL ERROR: log message and return to caller */
                  L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                          "cnfgrCrInitialize: failed to obtain componentData lock... exiting \n");
            ...
            else
            {
                /* FATAL ERROR: log message and return to caller */
                L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                        "cnfgrCrInitialize: failed to obtain componentData... exiting \n");
    ...
    else
    {
        /* FATAL ERROR: log message and return to caller */
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_CNFGR_COMPONENT_ID,
                "cnfgrCrInitialize: failed to obtain CR (DLL)... exiting \n");
