...
traceRouteHandleToEntry( L7_ushort16 handle, traceRouteTable_t **entry )
{
    ...
    L7_LOGF(L7_LOG_SEVERITY_DEBUG, L7_SIM_COMPONENT_ID, "%s %d: %s : \n", __FILE__, __LINE__,
            __FUNCTION__);
...
traceRouteVrIdSet( L7_ushort16 handle, L7_ushort16 vrId )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid vrId to traceRouteVrIdSet");
        return L7_FAILURE;
    }
...
traceRouteProbePerHopSet( L7_ushort16 handle, L7_ushort16 count )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid probePerHop.");
        return L7_FAILURE;
    }
...
traceRouteProbeIntervalSet( L7_ushort16 handle, L7_ushort16 interval )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid probeInterval.");
        return L7_FAILURE;
    }
...
traceRouteProbeSizeSet( L7_ushort16 handle, L7_ushort16 size )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid probeSize - size "
...
traceRouteMaxTtlSet( L7_ushort16 handle, L7_ushort16 maxTtl )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid maxTtl.");
        return L7_FAILURE;
    }
...
traceRouteInitTtlSet( L7_ushort16 handle, L7_ushort16 initTtl )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid initTtl.");
        return L7_FAILURE;
    }
...
traceRouteMaxFailSet( L7_ushort16 handle, L7_ushort16 maxFail )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid maxFail.");
        return L7_FAILURE;
    }
...
traceRouteStart( L7_ushort16 handle )
{
    ...
    {
        L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid state - cannot start");
        osapiWriteLockGive( traceRouteLock_g );
        return L7_FAILURE;
    }
...
//  }
    ...
    else
    {
        ...
        {
            L7_LOGF(L7_LOG_SEVERITY_WARNING, L7_SIM_COMPONENT_ID, "Invalid Hop Index." );
            osapiReadLockGive( traceRouteLock_g );
            return L7_FAILURE;
        }
