...
#define L7_TLV_BLK_SIZE_MAX       196608        /* max TLV block size allowed */
...
#define L7_TLV_TYPE_VAL_MAX     (~0)            /* max TLV type value allowed */
#define L7_TLV_LENGTH_VAL_MAX   (~0)            /* max TLV len value allowed  */
