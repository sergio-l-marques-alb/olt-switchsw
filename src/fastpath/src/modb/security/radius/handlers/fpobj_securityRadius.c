...
xLibRC_t fpObjSet_securityRadius_RadiusServerStatus (void *wap, void *bufp)
{
  ...
  if (objRadiusServerStatusValue == L7_ROW_STATUS_CREATE_AND_GO)
  {
   ...
   /* We should validate ipaddress. wheather it is dns name or dotted format ip address */
    ...
    {
      owa.rc = XLIBRC_INVALID_HOST_NAME_OR_IPV4_ADDR;    /* TODO: Add error string */
      FPOBJ_TRACE_EXIT (bufp, owa);
      return owa.rc;
    }
...
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objRadiusAccountingIndexNextValidValue = 0;
  FPOBJ_TRACE_ENTER (bufp);
...
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objRadiusServerIndexNextValidValue = 0;
  FPOBJ_TRACE_ENTER (bufp);
...
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusServerPriority
*
* @purpose Set 'RadiusServerPriority'
 *@description  [RadiusServerPriority] Specify this server's priority which
...
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusServerPriority (void *wap, void *bufp)
{

  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusServerPriorityValue;
  xLibU32_t keyRadiusServerIndexValue;
  xLibStr256_t addrValueStr;
  L7_IP_ADDRESS_TYPE_t addrType;
  memset(addrValueStr,0x00,sizeof(addrValueStr));
  ...
  /* retrieve object: RadiusServerPriority */
  owa.len = sizeof(objRadiusServerPriorityValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)&objRadiusServerPriorityValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerPriorityValue, owa.len);


  /* retrieve key: RadiusServerIndex */
  owa.len = sizeof(keyRadiusServerIndexValue);
  owa.rc = xLibFilterGet(wap, XOBJ_securityRadius_RadiusServerIndex,
                                (xLibU8_t *) &keyRadiusServerIndexValue, 
                                &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  ...
  FPOBJ_TRACE_CURRENT_KEY(bufp, &keyRadiusServerIndexValue, owa.len);
  ...
  owa.l7rc = usmDbRadiusServerPrioritySet (addrValueStr, objRadiusServerPriorityValue);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusServerPriority
*
* @purpose Get 'RadiusServerPriority'
 *@description  [RadiusServerPriority] Specify this server's priority which
* determines the order in which the servers are used, where 0 is the
* highest priority.
* @notes
...
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusServerPriority (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusServerPriorityValue;
  xLibU32_t keyRadiusServerIndexValue;
  ...
  owa.l7rc = usmDbRadiusServerPriorityGet (addrValueStr, &objRadiusServerPriorityValue);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerPriorityValue, sizeof(objRadiusServerPriorityValue));

  /* return the object value: RadiusServerPriority */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusServerPriorityValue,
                      sizeof(objRadiusServerPriorityValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusServerSourceIP
*
* @purpose Get 'RadiusServerSourceIP'
 *@description  [RadiusServerSourceIP] The Source IP address to use for the
* communication in radius transactions.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusServerSourceIP (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibIpV4_t objRadiusServerSourceIPValue;
  L7_IP_ADDRESS_TYPE_t addrType;
  xLibStr256_t addrValueStr;
  memset(addrValueStr,0x00,sizeof(addrValueStr));
  L7_RADIUS_SERVER_CONFIGPARAMS_FLAG_t paramStatus;
  ...
  owa.l7rc = usmDbRadiusServerSourceIPGet(addrValueStr, &objRadiusServerSourceIPValue, &paramStatus);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerSourceIPValue, sizeof(objRadiusServerSourceIPValue));

  /* return the object value: RadiusServerSourceIP */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusServerSourceIPValue,
                      sizeof(objRadiusServerSourceIPValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusServerSourceIP
*
* @purpose Set 'RadiusServerSourceIP'
 *@description  [RadiusServerSourceIP] The Source IP address to use for the
* communication in radius transactions.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusServerSourceIP (void *wap, void *bufp)
{
  ...
  /* retrieve object: RadiusServerSourceIP */
  owa.len = sizeof(objRadiusServerSourceIPValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)&objRadiusServerSourceIPValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  owa.l7rc = usmDbRadiusServerSourceIPSet(addrValueStr, objRadiusServerSourceIPValue, L7_RADIUSLOCAL);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusServerDeadTime
*
* @purpose Get 'RadiusServerDeadTime'
 *@description  [RadiusServerDeadTime] Time to stop using a server that doesnt
* respond.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusServerDeadTime (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusServerDeadTimeValue;
  L7_IP_ADDRESS_TYPE_t addrType;
  xLibStr256_t addrValueStr;
  memset(addrValueStr,0x00,sizeof(addrValueStr));
  L7_RADIUS_SERVER_CONFIGPARAMS_FLAG_t paramStatus;
  ...
  /* retrieve object: RadiusServerDeadTime */
  owa.len = sizeof(objRadiusServerDeadTimeValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)&objRadiusServerDeadTimeValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerDeadTimeValue, owa.len);
  ...
  owa.l7rc = usmDbRadiusServerDeadtimeGet ( addrValueStr, &objRadiusServerDeadTimeValue, &paramStatus);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerDeadTimeValue, sizeof(objRadiusServerDeadTimeValue));

  /* return the object value: RadiusServerDeadTime */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusServerDeadTimeValue,
                      sizeof(objRadiusServerDeadTimeValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusServerDeadTime
*
* @purpose Set 'RadiusServerDeadTime'
 *@description  [RadiusServerDeadTime] Time to stop using a server that doesnt
* respond.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusServerDeadTime (void *wap, void *bufp)
{
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerDeadTimeValue, owa.len);
    ...
    FPOBJ_TRACE_CURRENT_KEY(bufp, &keyRadiusServerIndexValue,
            owa.len);
  ...
  owa.l7rc = usmDbRadiusServerDeadtimeSet ( addrValueStr, objRadiusServerDeadTimeValue, L7_RADIUSLOCAL);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusSourceIP
*
* @purpose Get 'RadiusSourceIP'
 *@description  [RadiusSourceIP] The Source IP address to use for the
* communication in radius transactions.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusSourceIP (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibIpV4_t objRadiusSourceIPValue;
  L7_uchar8 strIpAddr[20];
  L7_RADIUS_SERVER_CONFIGPARAMS_FLAG_t paramStatus;
  ...
  /* get the value from application */
  owa.l7rc =  usmDbRadiusServerSourceIPGet(strIpAddr, &objRadiusSourceIPValue, &paramStatus );
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusSourceIPValue, sizeof(objRadiusSourceIPValue));

  /* return the object value: RadiusSourceIP */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusSourceIPValue,
                      sizeof(objRadiusSourceIPValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusSourceIP
*
* @purpose Set 'RadiusSourceIP'
 *@description  [RadiusSourceIP] The Source IP address to use for the
* communication in radius transactions.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusSourceIP (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibIpV4_t objRadiusSourceIPValue;
  L7_uchar8 strIpAddr[20];
  ...
  /* retrieve object: RadiusSourceIP */
  owa.len = sizeof(objRadiusSourceIPValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)&objRadiusSourceIPValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusSourceIPValue, owa.len);
  /* if row status object is specified and eual to delete return success */

  /* set the value in application */
  owa.l7rc = usmDbRadiusServerSourceIPSet(strIpAddr, objRadiusSourceIPValue, L7_RADIUSGLOBAL);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT(bufp, owa);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusSecret
*
* @purpose Get 'RadiusSecret'
 *@description  [RadiusSecret] Configured shared sercret for the RADIUS servers.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusSecret (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibStr256_t objRadiusSecretValue;
  L7_uchar8 strIpAddr[20];
  L7_RADIUS_SERVER_CONFIGPARAMS_FLAG_t dummyVaribale;
  ...
  FPOBJ_TRACE_ENTER(bufp);
/*  if((usmDbRadiusHostNameServerSharedSecretConfigured( strIpAddr,&isconfigured) == L7_SUCCESS) && isconfigured == L7_TRUE)
  {*/
          owa.l7rc =
            usmDbRadiusHostNameServerSharedSecretGet (
                                                      strIpAddr,
                                                      objRadiusSecretValue,
                                                      &dummyVaribale);
          if (owa.l7rc != L7_SUCCESS)
          {
            owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  ...
  FPOBJ_TRACE_VALUE (bufp, objRadiusSecretValue, strlen(objRadiusSecretValue));
  /* return the object value: RadiusSecret */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)objRadiusSecretValue,
                      strlen(objRadiusSecretValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusSecret
*
* @purpose Set 'RadiusSecret'
 *@description  [RadiusSecret] Configured shared sercret for the RADIUS servers.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusSecret (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibStr256_t objRadiusSecretValue;
  L7_uchar8 strIpAddr[20];
  ...
  /* retrieve object: RadiusSecret */
  owa.len = sizeof(objRadiusSecretValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)objRadiusSecretValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, objRadiusSecretValue, owa.len);

  /* set the value in application */
  owa.l7rc = usmDbRadiusHostNameServerSharedSecretSet( strIpAddr, objRadiusSecretValue, L7_RADIUSGLOBAL );
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusDeadTime
*
* @purpose Get 'RadiusDeadTime'
 *@description  [RadiusDeadTime] Time to stop using a server that doesnt respond.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusDeadTime (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusDeadTimeValue;
  L7_uchar8 strIpAddr[20];
  L7_RADIUS_SERVER_CONFIGPARAMS_FLAG_t paramStatus;
  ...
  /* get the value from application */
  owa.l7rc = usmDbRadiusServerDeadtimeGet(strIpAddr, &objRadiusDeadTimeValue, &paramStatus);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusDeadTimeValue, sizeof(objRadiusDeadTimeValue));

  /* return the object value: RadiusDeadTime */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusDeadTimeValue,
                      sizeof(objRadiusDeadTimeValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;
}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusDeadTime
*
* @purpose Set 'RadiusDeadTime'
 *@description  [RadiusDeadTime] Time to stop using a server that doesnt respond.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusDeadTime (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusDeadTimeValue;
  L7_uchar8 strIpAddr[20];
  ...
  /* retrieve object: RadiusDeadTime */
  owa.len = sizeof(objRadiusDeadTimeValue);
  owa.rc = xLibBufDataGet(bufp,
              (xLibU8_t *)&objRadiusDeadTimeValue,
              &owa.len);
  if(owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusDeadTimeValue, owa.len);

  /* set the value in application */
  owa.l7rc = usmDbRadiusServerDeadtimeSet(strIpAddr, objRadiusDeadTimeValue, L7_RADIUSGLOBAL);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusServerMaxTransmit
*
* @purpose Get 'RadiusServerMaxTransmit'
 *@description  [RadiusServerMaxTransmit] Maximum number of retransmissions of a
* RADIUS request packet
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusServerMaxTransmit (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusServerMaxTransmitValue;
  xLibU32_t keyRadiusServerIndexValue;
  xLibStr256_t addrValueStr;
  L7_IP_ADDRESS_TYPE_t addrType;
  L7_RADIUS_SERVER_CONFIGPARAMS_FLAG_t paramStatus;
  ...
  owa.l7rc = usmDbRadiusServerRetransGet( addrValueStr , &objRadiusServerMaxTransmitValue, &paramStatus);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT(bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerMaxTransmitValue, sizeof(objRadiusServerMaxTransmitValue));

  /* return the object value: RadiusServerMaxTransmit */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusServerMaxTransmitValue,
                      sizeof(objRadiusServerMaxTransmitValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusServerMaxTransmit
*
* @purpose Set 'RadiusServerMaxTransmit'
 *@description  [RadiusServerMaxTransmit] Maximum number of retransmissions of a
* RADIUS request packet
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusServerMaxTransmit (void *wap, void *bufp)
{
  ...
  /* retrieve object: RadiusServerMaxTransmit */
  owa.len = sizeof(objRadiusServerMaxTransmitValue);
  owa.rc = xLibBufDataGet (bufp,
                           (xLibU8_t *)&objRadiusServerMaxTransmitValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
  ...
  owa.l7rc = usmDbRadiusServerRetransSet( addrValueStr , objRadiusServerMaxTransmitValue, L7_RADIUSLOCAL);
  if(owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE; /* TODO: Change if required */
    FPOBJ_TRACE_EXIT(bufp, owa);
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusServerTimeout
*
* @purpose Get 'RadiusServerTimeout'
 *@description  [RadiusServerTimeout] Time out duration (in seconds) before
* packets are retransmitted
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusServerTimeout (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusServerTimeoutValue;
  xLibU32_t keyRadiusServerIndexValue;
  ...
  owa.l7rc = usmDbRadiusServerTimeOutGet( addrValueStr, &objRadiusServerTimeoutValue, &paramStatus );
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerTimeoutValue, sizeof(objRadiusServerTimeoutValue));

  /* return the object value: RadiusServerTimeout */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusServerTimeoutValue,
                      sizeof(objRadiusServerTimeoutValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusServerTimeout
*
* @purpose Set 'RadiusServerTimeout'
 *@description  [RadiusServerTimeout] Time out duration (in seconds) before
* packets are retransmitted
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusServerTimeout (void *wap, void *bufp)
{
  ...
  /* retrieve object: RadiusServerTimeout */
  owa.len = sizeof(objRadiusServerTimeoutValue);
  owa.rc = xLibBufDataGet (bufp,
                           (xLibU8_t *) &objRadiusServerTimeoutValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
  ...
  owa.l7rc = usmDbRadiusServerTimeOutSet( addrValueStr, objRadiusServerTimeoutValue, L7_RADIUSLOCAL );
...
/*******************************************************************************
* @function fpObjGet_securityRadius_RadiusServerUsage
*
* @purpose Get 'RadiusServerUsage'
 *@description  [RadiusServerUsage] RADIUS server usage type.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjGet_securityRadius_RadiusServerUsage (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA2();
  xLibU32_t objRadiusServerUsageValue;
  xLibU32_t keyRadiusServerIndexValue;
  xLibStr256_t addrValueStr;
  L7_IP_ADDRESS_TYPE_t addrType;
  memset(addrValueStr,0x00,sizeof(addrValueStr));
  ...
  owa.l7rc = usmDbRadiusServerUsageTypeGet( addrValueStr, &objRadiusServerUsageValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  FPOBJ_TRACE_VALUE (bufp, &objRadiusServerUsageValue, sizeof(objRadiusServerUsageValue));

  /* return the object value: RadiusServerUsage */
  owa.rc = xLibBufDataSet(bufp, (xLibU8_t *)&objRadiusServerUsageValue,
                      sizeof(objRadiusServerUsageValue));
  FPOBJ_TRACE_EXIT(bufp, owa);
  return owa.rc;

}
/*******************************************************************************
* @function fpObjSet_securityRadius_RadiusServerUsage
*
* @purpose Set 'RadiusServerUsage'
 *@description  [RadiusServerUsage] RADIUS server usage type.
* @notes
*
* @return
*******************************************************************************/
xLibRC_t fpObjSet_securityRadius_RadiusServerUsage (void *wap, void *bufp)
{
  ...
  /* retrieve object: RadiusServerUsage */
  owa.len = sizeof(objRadiusServerUsageValue);
  owa.rc = xLibBufDataGet (bufp,
                           (xLibU8_t *) &objRadiusServerUsageValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    FPOBJ_TRACE_EXIT (bufp, owa);
    return owa.rc;
  ...
  owa.l7rc = usmDbRadiusServerUsageTypeSet( addrValueStr, objRadiusServerUsageValue);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
