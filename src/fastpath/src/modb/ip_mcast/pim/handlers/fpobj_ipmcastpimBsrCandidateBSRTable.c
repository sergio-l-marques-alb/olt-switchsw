...
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objpimBsrCandidateBSRAddressType = L7_NULL;
  ...
  /* get the value from application */
  owa.l7rc = usmDbPimsmElectedBSRExpiryTimeGet(L7_UNIT_CURRENT, objpimBsrCandidateBSRAddressType, &objpimBsrCandidateBSRBootstrapTimerValue);
