...
xLibRC_t fpObjSet_fastPathQOSCOSCosMapCfg_CosMapGlobalTrustRestoreDefaults (void *wap, void *bufp)
{
  ...
  /* set the value in application */
   owa.l7rc = usmDbQosCosMapTrustModeSet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, FD_QOS_COS_MAP_INTF_TRUST_MODE);
...
xLibRC_t fpObjSet_fastPathQOSCOSCosMapCfg_CosMapGlobalIpDscpRestoreDefaults (void *wap, void *bufp)
{
  ...
  /* set the value in application */
    ...
    {
      usmDbQosCosMapIpDscpDefaultTrafficClassGet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, dscp, &queueID);
      rc = usmDbQosCosMapIpDscpTrafficClassSet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, dscp, queueID);
      if (rc != L7_SUCCESS)
      {
         owa.l7rc = L7_FAILURE;
         break;
...
xLibRC_t fpObjSet_fastPathQOSCOSCosMapCfg_CosMapglobalIpPrecRestoreDefaults (void *wap, void *bufp)
{
  ...
  /* set the value in application */
    ...
    {
      usmDbQosCosMapIpPrecDefaultTrafficClassGet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, prec, &queueID);
      rc = usmDbQosCosMapIpPrecTrafficClassSet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, prec, queueID);
      if (rc != L7_SUCCESS)
      {
         owa.l7rc = L7_FAILURE;
         break;
                                                                    ...
                                                                    void *bufp)
{
  ...
  owa.l7rc =
    usmDbQosCosMapIpPrecTrafficClassGet (L7_UNIT_CURRENT,
                                         keyCosMapIpPrecIntfIndexValue, L7_QOS_QSET_PORT, 
                                                                    ...
                                                                    void *bufp)
{
  ...
  owa.l7rc =
    usmDbQosCosMapIpDscpTrafficClassGet (L7_UNIT_CURRENT,
                                         keyCosMapIpDscpIntfIndexValue, L7_QOS_QSET_PORT, 
                                         keyCosMapIpDscpValueValue,
                                                               ...
                                                               void *bufp)
{
  ...
  owa.l7rc =
    usmDbQosCosMapTrustModeGet (L7_UNIT_CURRENT,
                                keyCosMapIntfTrustIntfIndexValue, L7_QOS_QSET_PORT, 
...
xLibRC_t fpObjSet_fastPathQOSCOSCosMapCfg_CosMapIntfTrustRestoreDefaults (void *wap, void *bufp)
{
  ...
  {
   owa.l7rc = usmDbQosCosMapTrustModeSet(L7_UNIT_CURRENT, keyCosMapIntfTrustIntfIndexValue, L7_QOS_QSET_PORT, FD_QOS_COS_MAP_INTF_TRUST_MODE);
  }
...
xLibRC_t fpObjSet_fastPathQOSCOSCosMapCfg_CosMapIntfIpDscpRestoreDefaults (void *wap, void *bufp)
{
  ...
  if(objCosMapIntfIpDscpRestoreDefaultsValue)
  {
    ...
    while((rc == L7_SUCCESS) && (list_cnt < L7_QOS_COS_MAP_NUM_IPDSCP))
    {
      usmDbQosCosMapIpDscpDefaultTrafficClassGet(L7_UNIT_CURRENT, keyCosMapIpDscpIntfIndexValue, L7_QOS_QSET_PORT, dscp, &queueID);
      rc = usmDbQosCosMapIpDscpTrafficClassSet(L7_UNIT_CURRENT, keyCosMapIpDscpIntfIndexValue, L7_QOS_QSET_PORT, dscp, queueID);
      if (rc != L7_SUCCESS)
      {
         owa.rc = XLIBRC_FAILURE;
         break;
...
xLibRC_t fpObjSet_fastPathQOSCOSCosMapCfg_CosMapIntfIpPrecRestoreDefaults (void *wap, void *bufp)
{
  ...
  if(objCosMapIntfIpPrecRestoreDefaultsValue)
  {
    ...
    while((rc == L7_SUCCESS) && (list_cnt < L7_QOS_COS_MAP_NUM_IPPREC))
    {
      usmDbQosCosMapIpPrecDefaultTrafficClassGet(L7_UNIT_CURRENT, keyCosMapIpPrecIntfIndexValue, L7_QOS_QSET_PORT, prec, &queueID);
      rc = usmDbQosCosMapIpPrecTrafficClassSet(L7_UNIT_CURRENT, keyCosMapIpPrecIntfIndexValue, L7_QOS_QSET_PORT, prec, queueID);
      if (rc != L7_SUCCESS)
      {
         owa.rc = XLIBRC_FAILURE;
         break;
