...
xLibRC_t fpObjGet_fastPathQOSCOSCosQueueCfg_CosQueueGlobalShapingRate (void *wap, void *bufp)
{
  ...
  /* get the value from application */
    ...
    usmDbQosCosQueueIntfShapingRateGet (L7_UNIT_CURRENT,
                                        L7_ALL_INTERFACES, L7_QOS_QSET_PORT, 
...
xLibRC_t fpObjSet_fastPathQOSCOSCosQueueCfg_CosQueueGlobalRestoreDefaults (void *wap, void *bufp)
{
  ...
  {
    owa.l7rc = usmDbQosCosQueueIntfShapingRateSet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, FD_QOS_COS_QCFG_INTF_SHAPING_RATE, (L7_uint32)-1/*Default*/);
    if (owa.l7rc != L7_SUCCESS)
    {
        owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
        FPOBJ_TRACE_EXIT (bufp, owa);
    ...
    {
        owa.l7rc = usmDbQosCosQueueWredDecayExponentSet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, FD_QOS_COS_QCFG_WRED_DECAY_EXP);
...
xLibRC_t fpObjGet_fastPathQOSCOSCosQueueCfg_GlobalCosQueueMgmtType (void *wap, void *bufp)
{
  ...
  owa.l7rc =
    usmDbQosCosQueueMgmtTypeListGet (L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT,
                                     &MgmtTypeList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
...
xLibRC_t fpObjSet_fastPathQOSCOSCosQueueCfg_GlobalCosQueueDefaultsRestore (void *wap, void *bufp)
{
  ...
  /* set the value in application */
  owa.l7rc =
    usmDbQosCosQueueDefaultsRestore (L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
  }
...
xLibRC_t fpObjSet_fastPathQOSCOSCosQueueCfg_GlobalCosQueueMinBandwidth (void *wap, void *bufp)
{
  ...
  (void)usmDbQosCosQueueMinBandwidthListGet(L7_UNIT_CURRENT,L7_ALL_INTERFACES,L7_QOS_QSET_PORT,&minbwList);
  listIndex = keyCosQueueIndexValue - L7_QOS_COS_QUEUE_ID_MIN;
                                                                                 ...
                                                                                 void *bufp)
{
  ...
  owa.l7rc = usmDbQosCosQueueMinBandwidthListGet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, &qosCosQueueBwList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
                                                                           ...
                                                                           *bufp)
{
  ...
  owa.l7rc = usmDbQosCosQueueDropParmsListGet(L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, &dropParmsList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
                                                                           ...
                                                                           *bufp)
{
  ...
  /* set the value in application */
  listIndex = keyCosQueueDropPrecIndexValue - L7_QOS_COS_DROP_PREC_LEVEL_MIN;
  owa.l7rc = usmDbQosCosQueueDropParmsListGet(L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, &dList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  owa.l7rc = usmDbQosCosQueueDropParmsListSet(L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, &dList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
                                                                     ...
                                                                     void *bufp)
{
  ...
  owa.l7rc =
    usmDbQosCosQueueIntfShapingRateGet (L7_UNIT_CURRENT,
                                        keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, 
                                                                     ...
                                                                     void *bufp)
{
  ...
  /* set the value in application */
  owa.l7rc =
    usmDbQosCosQueueDefaultsRestore (L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
                                                                  ...
                                                                  void *bufp)
{
  ...
  if((objCosQueueMinBandwidthValue != L7_QOS_COS_QUEUE_MIN_BANDWIDTH_MIN) && (objCosQueueMinBandwidthValue != L7_QOS_COS_QUEUE_MIN_BANDWIDTH_MAX) &&
        ...
        (void)usmDbQosCosQueueMinBandwidthListGet(L7_UNIT_CURRENT,keyCosQueueIntfIndexValue,L7_QOS_QSET_PORT,&minbwList);
        listIndex = keyCosQueueIndexValue - L7_QOS_COS_QUEUE_ID_MIN;
                                                              ...
                                                              void *bufp)
{
  ...
  /* get the value from application */
   L7_uint32 listIndex = keyCosQueueIndexValue - L7_QOS_COS_QUEUE_ID_MIN;
  owa.l7rc =
    usmDbQosCosQueueMgmtTypeListGet (L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT,
                                     &MgmtTypeList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
                                                                         ...
                                                                         *bufp)
{
  ...
  {
    owa.l7rc = usmDbQosCosQueueIntfShapingRateSet(L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, FD_QOS_COS_QCFG_INTF_SHAPING_RATE, (L7_uint32)-1/*Default*/);
  }
  ...
  if(objCosQueueIntfRestoreDefaultsValue)
  {
    if ((usmDbFeaturePresentCheck(L7_UNIT_CURRENT, L7_FLEX_QOS_COS_COMPONENT_ID, L7_COS_QUEUE_WRED_SUPPORT_FEATURE_ID) == L7_TRUE) &&
            (usmDbFeaturePresentCheck(L7_UNIT_CURRENT, L7_FLEX_QOS_COS_COMPONENT_ID, L7_COS_QUEUE_WRED_DECAY_EXP_SYSTEM_ONLY_FEATURE_ID) != L7_TRUE))
    {
        owa.l7rc = usmDbQosCosQueueWredDecayExponentSet(L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, FD_QOS_COS_QCFG_WRED_DECAY_EXP);
                                                                           ...
                                                                           *bufp)
{
  ...
  /* get the value from application */
  owa.l7rc = usmDbQosCosQueueMinBandwidthListGet(L7_UNIT_CURRENT, keyCosQueueIntfIndexValue, L7_QOS_QSET_PORT, &qosCosQueueBwList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
                                                                           ...
                                                                           *bufp)
{
  ...
  /* get the value from application */
  listIndex = keyCosQueueDropPrecIndexValue - L7_QOS_COS_DROP_PREC_LEVEL_MIN;
  owa.l7rc = usmDbQosCosQueueDropParmsListGet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, &dropParmsList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
                                                                           ...
                                                                           *bufp)
{
  ...
  listIndex = keyCosQueueDropPrecIndexValue - L7_QOS_COS_DROP_PREC_LEVEL_MIN;
  owa.l7rc = usmDbQosCosQueueDropParmsListGet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, &dList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
  ...
  dList.queue[keyCosQueueIndexValue].tailDropMaxThreshold[listIndex] = objCosQueueMgmtTailDropThresholdValue;
  owa.l7rc = usmDbQosCosQueueDropParmsListSet(L7_UNIT_CURRENT, L7_ALL_INTERFACES, L7_QOS_QSET_PORT, &dList);
  if (owa.l7rc != L7_SUCCESS)
  {
    owa.rc = XLIBRC_FAILURE;    /* TODO: Change if required */
    FPOBJ_TRACE_EXIT (bufp, owa);
