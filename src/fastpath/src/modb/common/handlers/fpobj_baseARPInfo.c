...
/*******************************************************************************
* @function fpObjSet_baseARPInfo_ArpSwitchClear
*
...
* @return
*******************************************************************************/
xLibRC_t fpObjSet_baseARPInfo_ArpSwitchClear (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  ...
  owa.l7rc = usmDbArpSwitchClear (L7_UNIT_CURRENT);
  if (owa.l7rc != L7_SUCCESS)
  {
