...
/*******************************************************************************
* @function fpObjGet_baseCardTypeDetails_SupportedCardModelIdentifier
*
* @purpose Get 'CardModelIdentifier'
*
* @description [CardModelIdentifier] Card Model Identifier.
...
* @return
*******************************************************************************/
xLibRC_t fpObjGet_baseCardTypeDetails_SupportedCardModelIdentifier (void *wap, void *bufp)
{
  ...
  /* retrieve key: CardIndex */
  memset(objCardModelIdentifierValue, L7_EOS, sizeof(objCardModelIdentifierValue));
  kwaCardIndex.rc = xLibFilterGet (wap, XOBJ_baseCardTypeDetails_SupportedCardIndex,
                                   (xLibU8_t *) & keyCardIndexValue, &kwaCardIndex.len);
  if (kwaCardIndex.rc != XLIBRC_SUCCESS)
  {
    kwaCardIndex.rc = XLIBRC_FILTER_MISSING;
...
/*******************************************************************************
* @function fpObjGet_baseCardTypeDetails_SupportedCardIndex
*
* @purpose Get 'CardIndex'
*
* @description [CardIndex] Card Number. 
...
* @return
*******************************************************************************/
xLibRC_t fpObjGet_baseCardTypeDetails_SupportedCardIndex (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objSwitchIndexValue = 0;
  xLibU32_t objCardIndexValue = 0;
  xLibU32_t objSlotIndexValue = 0;
  xLibU32_t nextObjSlotIndexValue = 0;
  xLibU32_t nextObjSwitchIndexValue = 0;
  FPOBJ_TRACE_ENTER (bufp);
  /* retrieve key: SwitchIndex */
  owa.rc = xLibFilterGet (wap, XOBJ_baseCardTypeDetails_SwitchIndex,
                          (xLibU8_t *) & objSwitchIndexValue, &owa.len);
  if (owa.rc != XLIBRC_SUCCESS)
  {
    ...
    nextObjSwitchIndexValue = objSwitchIndexValue;
    /* retrieve key: SupportedSlotIndex */
    owa.rc = xLibFilterGet (wap, XOBJ_baseCardTypeDetails_SupportedSlotIndex,
    ...
    owa.rc = xLibFilterGet (wap, XOBJ_baseCardTypeDetails_SupportedCardIndex,
                          (xLibU8_t *) & objCardIndexValue, &owa.len);
    ...
    owa.l7rc  =  usmDbCardInSlotSupportedNextGet(&objSwitchIndexValue, &objSlotIndexValue, &objCardIndexValue);
    if ((owa.l7rc != L7_SUCCESS) || (nextObjSlotIndexValue != objSlotIndexValue)|| (nextObjSwitchIndexValue != objSwitchIndexValue))
    {
     owa.rc = XLIBRC_ENDOF_TABLE;
     FPOBJ_TRACE_EXIT (bufp, owa);
     return owa.rc;
...
xLibRC_t fpObjGet_baseCardTypeDetails_SupportedSlotIndex (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objSwitchIndexValue = 0;
  xLibU32_t nextObjSwitchIndexValue = 0;
  ...
  owa.l7rc  =  usmDbSlotSupportedIndexNextGet(&objSwitchIndexValue, &objSlotIndexValue);
  if ((owa.l7rc != L7_SUCCESS) || (nextObjSwitchIndexValue != objSwitchIndexValue))
  {
   owa.rc = XLIBRC_ENDOF_TABLE;
   FPOBJ_TRACE_EXIT (bufp, owa);
   return owa.rc;
  ...
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objSlotIndexValue, sizeof (objSlotIndexValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}

xLibRC_t fpObjSet_baseCardTypeDetails_SupportedSlotIndex (void *wap, void *bufp)
{
 return XLIBRC_SUCCESS;
}

xLibRC_t fpObjGet_baseCardTypeDetails_SupportedSlotNumber (void *wap, void *bufp)
{
  fpObjWa_t owa = FPOBJ_INIT_WA (sizeof (xLibU32_t));
  xLibU32_t objSwitchIndexValue = 0;
  xLibU32_t objSlotIndexValue = 0;
  xLibU32_t objSlotNumberValue = 0;
  FPOBJ_TRACE_ENTER (bufp);
  ...
  owa.l7rc  =  usmDbSlotSupportedSlotNumberGet(objSwitchIndexValue, objSlotIndexValue, &objSlotNumberValue);
  if (owa.l7rc != L7_SUCCESS)
  {
   owa.rc = XLIBRC_FAILURE;
   FPOBJ_TRACE_EXIT (bufp, owa);
 ...
 /* return the object value: SupportedSlotIndex */
  owa.rc = xLibBufDataSet (bufp, (xLibU8_t *) & objSlotNumberValue, sizeof (objSlotNumberValue));
  FPOBJ_TRACE_EXIT (bufp, owa);
  return owa.rc;
}
