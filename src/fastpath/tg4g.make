...
CARD_FOLDER     = FastPath-Ent-esw-xgs4-e500-LR-CSxw-IQH_TG4G
...
welcome: 
	...
	@echo "###########################################"
	@echo "#                                         #"
	@echo "#  FastPath Makefile for the TG4G card    #"
	@echo "#                                         #"
	@echo "###########################################"
	@echo ""
...
cli:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-tg4g.make

shell:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-tg4g.make

cli_clean:
	@$(MAKE) -C $(FP_CLI_PATH) -f fp.cli-tg4g.make clean

shell_clean:
	@$(MAKE) -C $(FP_SHELL_PATH) -f fp.shell-tg4g.make clean
