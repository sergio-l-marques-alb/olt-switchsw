...
#define L7_BCM_TRIDENT3_X3                        11  /* PTin added: new switch 56370 (Trident3-X3)*/
...
#define PTIN_BOARD_OLT1T0F                         0x1000
#define PTIN_BOARD_TG16GF                          0x2000
#define PTIN_BOARD_TT04SXG                         0x4000
#define PTIN_BOARD_AG16GA                          0x8000
#define PTIN_BOARD_TC16SXG                        0x10000
...
#define PTIN_BOARD_LINECARD_FAMILY    ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TG16G | PTIN_BOARD_TG16GF | PTIN_BOARD_TG4G | PTIN_BOARD_TA48GE | PTIN_BOARD_TT04SXG | PTIN_BOARD_AG16GA | PTIN_BOARD_TC16SXG)
#define PTIN_BOARD_STANDALONE_FAMILY  ( PTIN_BOARD_OLT7_8CH_B | PTIN_BOARD_OLT1T0 | PTIN_BOARD_OLT1T0F)
#define PTIN_BOARD_GPON_FAMILY        ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TG16G | PTIN_BOARD_TG16GF | PTIN_BOARD_TG4G | PTIN_BOARD_OLT1T0 | PTIN_BOARD_OLT1T0F | PTIN_BOARD_TT04SXG | PTIN_BOARD_AG16GA | PTIN_BOARD_TC16SXG)
#define PTIN_BOARD_ACTIVETH_FAMILY    ( PTIN_BOARD_TA48GE )
#define PTIN_BOARD_SWITCHABLE_FAMILY  ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TC16SXG | PTIN_BOARD_TA48GE )
...
#define PTIN_BOARD_IS_SWITCHABLE      ( PTIN_BOARD & PTIN_BOARD_SWITCHABLE_FAMILY )
...
#define L7_MAX_PHYSICAL_SLOTS_PER_UNIT           1
#define L7_MAX_PORTS_PER_SLOT                    21
...
#define L7_MAX_PHYSICAL_SLOTS_PER_UNIT           1
#define L7_MAX_PORTS_PER_SLOT                    9
#define L7_MAX_PHYSICAL_PORTS_PER_SLOT           9
#define L7_MAX_PHYSICAL_PORTS_PER_UNIT           9
