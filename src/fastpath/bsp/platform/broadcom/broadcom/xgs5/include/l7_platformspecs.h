...
#define PTIN_BOARD_LINECARD_FAMILY    ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TG16G | PTIN_BOARD_TG16GF | PTIN_BOARD_TG4G | PTIN_BOARD_TA48GE )
#define PTIN_BOARD_STANDALONE_FAMILY  ( PTIN_BOARD_OLT7_8CH_B | PTIN_BOARD_OLT1T0 | PTIN_BOARD_OLT1T0F)
#define PTIN_BOARD_GPON_FAMILY        ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TG16G | PTIN_BOARD_TG16GF | PTIN_BOARD_TG4G | PTIN_BOARD_OLT1T0 | PTIN_BOARD_OLT1T0F)
