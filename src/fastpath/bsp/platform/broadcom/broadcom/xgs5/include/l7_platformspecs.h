...
#define PTIN_BOARD_GPON_FAMILY        ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TG16G | PTIN_BOARD_TG16GF | PTIN_BOARD_TG4G | PTIN_BOARD_OLT1T0 | PTIN_BOARD_OLT1T0F | PTIN_BOARD_TT04SXG )
#define PTIN_BOARD_ACTIVETH_FAMILY    ( PTIN_BOARD_TA48GE | PTIN_BOARD_AE48GE )
#define PTIN_BOARD_PASSIVE_LC_FAMILY  ( PTIN_BOARD_AG16GA | PTIN_BOARD_AE48GE )
...
#define PTIN_BOARD_IS_PASSIVE_LC      ( PTIN_BOARD & PTIN_BOARD_PASSIVE_LC_FAMILY )
