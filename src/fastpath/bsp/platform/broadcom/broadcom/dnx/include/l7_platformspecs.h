...
#define PTIN_BOARD_TA12XGE                         0x0400
...
#define PTIN_BOARD_LINECARD_FAMILY    ( PTIN_BOARD_TOLT8G | PTIN_BOARD_TG16G | PTIN_BOARD_TA48GE | PTIN_BOARD_TA12XGE)
...
#define PTIN_BOARD_ACTIVETH_FAMILY    ( PTIN_BOARD_TA48GE | PTIN_BOARD_TA12XGE)
...
#if (PTIN_BOARD == PTIN_BOARD_TA12XGE)
