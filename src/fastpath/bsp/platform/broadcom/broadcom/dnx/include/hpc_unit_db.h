...
{
  {     
     UNIT_BROAD_CXO2T4_88370_REV_1_ID,       /* unitTypeID */
     "BCM-88370-00",                                  /* unitModel */
     "Broadcom DNX-ARAD Development System - CXO2T4",  /* unitDescription */
...
#error __FILE__, __LINE__: Neither L7_SWITCHING_PACKAGE nor L7_ROUTING_PACKAGE defined.
   ...
   hpc_data_UNIT_BROAD_CXO2T4_88370_REV_1        /* pointer to hpc platform specific data */
},
