...
#error __FILE__, __LINE__: Neither L7_SWITCHING_PACKAGE nor L7_ROUTING_PACKAGE defined.
     ...
     {
       {L7_CPU_SLOT_NUM, L7_LOGICAL_CARD_CPU_GENERIC_REV_1_ID},
     ...
     3,      /* 3 stacking ports */
     {
         /* First Stacking Port Descriptor */
         {
          ...
          40,       /* 40 Gb/s */
          0,17,0,0  /* Bcm unit, Bcm port, unused, unused */
         },
...
{
  {     
     UNIT_BROAD_8_ETH_3_BCK_88360_REV_1_ID,       /* unitTypeID */
     "BCM-88360-00",                                  /* unitModel */
     "Broadcom DNX-ARAD Development System - 8 ETH, 3 BCK",  /* unitDescription */
     L7_UNITMGR_MGMTFUNC_UNASSIGNED,                /* managementPreference */
     "1.3.6.1.4.1.4413",                             /* systemOID */
     1,                                              /* numPowerSupply */
     4,                                              /* numFans */
...
#error __FILE__, __LINE__: Neither L7_SWITCHING_PACKAGE nor L7_ROUTING_PACKAGE defined.
     ...
     3,      /* 3 stacking ports */
     {
         ...
         {
          1,     /* Front Panel Stacking stacking port */
          0, 9,  /* slot/port for the stacking port */
          {'0', '/', '9'},  /* Port identifier */
          40,       /* 40 Gb/s */
          0,17,0,0  /* Bcm unit, Bcm port, unused, unused */
         },
   ...
   hpc_data_UNIT_BROAD_8_ETH_3_BCK_88650_REV_1        /* pointer to hpc platform specific data */
},

/* PTin added: new switch ARAD 1+3 */
{
  {     
     UNIT_BROAD_1_ETH_3_BCK_88360_REV_1_ID,       /* unitTypeID */
     "BCM-88360-00",                                  /* unitModel */
     "Broadcom DNX-ARAD Development System - 1 ETH, 3 BCK",  /* unitDescription */
     L7_UNITMGR_MGMTFUNC_UNASSIGNED,                /* managementPreference */
     "1.3.6.1.4.1.4413",                             /* systemOID */
     1,                                              /* numPowerSupply */
     4,                                              /* numFans */
...
#error __FILE__, __LINE__: Neither L7_SWITCHING_PACKAGE nor L7_ROUTING_PACKAGE defined.
     ...
     3,      /* 3 stacking ports */
     {
         ...
         {
          1,     /* Front Panel Stacking stacking port */
          0, 2,  /* slot/port for the stacking port */
          {'0', '/', '2'},  /* Port identifier */
          40,       /* 40 Gb/s */
          0,17,0,0  /* Bcm unit, Bcm port, unused, unused */
         },
         ...
         {
          1,     /* Front Panel Stacking stacking port */
          0, 3,  /* slot/port for the stacking port */
          {'0', '/', '3'},  /* Port identifier */
          40,       /* 40 Gb/s */
          0,18,0,0  /* Bcm unit, Bcm port, unused, unused */
         },
         ...
         {
          1,     /* Front Panel Stacking stacking port */
          0, 4,  /* slot/port for the stacking port */
          {'0', '/', '4'},  /* Port identifier */
          40,       /* 40 Gb/s */
          0,19,0,0  /* Bcm unit, Bcm port, unused, unused */
         }
   ...
   hpc_data_UNIT_BROAD_1_ETH_3_BCK_88650_REV_1        /* pointer to hpc platform specific data */
},
