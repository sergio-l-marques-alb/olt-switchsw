...
#ifdef HPC_TRANSPORT_MSG_LENGTH
#define HPC_BROAD_TRANSPORT_MSG_LENGTH      HPC_TRANSPORT_MSG_LENGTH
#else
#define HPC_BROAD_TRANSPORT_MSG_LENGTH      8192
#endif
/*********************************************************************
...
{
  return(HPC_BROAD_TRANSPORT_MSG_LENGTH);
}
