...
SHR_G_ENTRY(P, field_egress_metering), /* FP allows metering in egress mode */ \
...
SHR_G_ENTRY(P, l2gre_default_tunnel),           /* Default tunnel based forwarding during L2-GRE VPN lookup failure    */ \
...
SHR_G_ENTRY(P, mirror_cos),      /* Mirror UC/MC COS controls */ \
SHR_G_ENTRY(P, lltag),           /* The out most tag as the LLTAG */\
SHR_G_ENTRY(P, l2_no_vfi), /* No VFI support */ \
SHR_G_ENTRY(P, special_egr_ip_tunnel_ser), /* EGR_IP_TUNNEL overlay memory ser support for older devices */ \
SHR_G_ENTRY(P, fifo_dma_hu2), /* use the hu2 driver fucntion to handle the fifo dma */ \
SHR_G_ENTRY(P, uc),              /* Embedded core(s) for applications */ \
SHR_G_ENTRY(P, eee_bb_mode), /* EEE burst and batch mode */ \
SHR_G_ENTRY(P, mem_parity_eccmask), /* memory fields of Parity and ECC masking  */ \
