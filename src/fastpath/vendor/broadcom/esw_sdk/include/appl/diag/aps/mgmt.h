...
typedef struct mgmt_reply_sw_version_s {
    uint32      version;
    int8        suffix[8];
} mgmt_reply_sw_version_t;
...
typedef union  {
    ...
    mgmt_reply_sw_version_t sw_version; /* software version */
    struct {
      uint32 value;   /* Switch age time */
    } switch_age_time;
