...
typedef enum bcm_rx_control_e {
    bcmRxControlCRCStrip,       /* Strip CRC from packets. */
    bcmRxControlVTagStrip,      /* Strip VLAN tag from packets. */
    bcmRxControlRateStall,      /* Use stall instead of discard. */
    bcmRxControlMultiDCB,       /* Scatter data with multiple DCBs. */
    bcmRxControlOversizedOK,    /* Accept packets larger than bufsize. */
    bcmRxControlIgnoreHGHeader, /* Force HiGig Header into packet for fabric
                                   device. */
    bcmRxControlIgnoreSLHeader  /* Force SL tag into packet on SL stacking. */
} bcm_rx_control_t;
...
typedef enum bcm_rx_trap_e {
    bcmRxTrapMimDiscardMacsaFwd,        /* Triggered by port control
                                           bcmPortControlDiscardMacsaAction with
                                           BCM_PORT_CONTROL_DISCARD_MACSA_FWD. */
    bcmRxTrapMimDiscardMacsaDrop,       /* Triggered by port control
                                           bcmPortControlDiscardMacsaAction with
                                           BCM_PORT_CONTROL_DISCARD_MACSA_DROP. */
    bcmRxTrapMimDiscardMacsaTrap,       /*  Triggered by port control
                                           bcmPortControlDiscardMacsaAction with
                                           BCM_PORT_CONTROL_DISCARD_MACSA_TRAP. */
    bcmRxTrapMimDiscardMacsaSnoop,      /* Triggered by port control
                                           bcmPortControlDiscardMacsaAction with
                                           BCM_PORT_CONTROL_DISCARD_MACSA_SNOOP. */
    bcmRxTrapMimTeSaMove,               /*  Packet's BVID is in TE-BVID range,
                                           SA lookup succeeds, butSystem Port ID
                                           of SA lookup is different from source
                                           system Port ID. */
    bcmRxTrapMimTeSaUnknown,            /*  Packet's BVID is in TE-BVID range,
                                           SA lookup fails. */
    bcmRxTrapMimSaMove,                 /* Packet's BVID is not in TE-BVID
                                           range, SA lookup succeeds. */
    bcmRxTrapMimSaUnknown,              /* Packet's BVID is not in TE-BVID
                                           range, SA lookup fails. */
    bcmRxTrapAuthSaLookupFail,          /* SA authentication fails: SA lookup
                                           fails. */
    bcmRxTrapAuthSaPortFail,            /* SA authentication fails: SA lookup
                                           succeeds in an unpermitted port. */
    bcmRxTrapAuthSaVlanFail,            /* SA authentication fails: SA lookup
                                           succeeds in an unpermitted VLAN. */
    bcmRxTrapSaMulticast,               /* SA is multicast. */
    bcmRxTrapSaEqualsDa,                /* SA equals DA. */
    bcmRxTrap8021xFail,                 /* 8021x authentication fails. */
    bcmRxTrapArpMyIp,                   /* If InPort is enabled for ARP trapping
                                           AND ARP request TPA is equal to My-IP
                                           (two configurable IP addresses). */
    bcmRxTrapArp,                       /* ARP Request incoming on InPort which
                                           is enabled for ARP trapping. If DA is
                                           set to be ignored for ARP replies,
                                           ARP replies are also trapped with
                                           this trap code. */
    bcmRxTrapIgmpMembershipQuery,       /* Packet is IGMP and first octet in the
                                           IGMP payload is 0x11. */
    bcmRxTrapIgmpReportLeaveMsg,        /* Packet is IGMP and first octet in the
                                           IGMP payload is 0x12, 0x16, 0x17, or
                                           0x22. */
    bcmRxTrapIgmpUndefined,             /* Packet is IGMP and first octet in the
                                           IGMP payload is not 0x11, 0x12, 0x16,
                                           0x17, or 0x22. */
    bcmRxTrapIcmpv6MldMcListenerQuery,  /* . */
    bcmRxTrapL2Cache,                   /* Triggered by  bcm_l2_cache_set 
                                           entry. */
    bcmRxTrapDhcpv6Server,              /* DHCP packet sent to server over
                                           IPv6oE. */
    bcmRxTrapDhcpv6Client,              /* DHCP packet sent to client over
                                           IPv6oE. */
    bcmRxTrapPortNotVlanMember,         /*  Initial VID membership error. */
    bcmRxTrapHeaderSizeErr,             /* Parser indicates header size error. */
    bcmRxTrapMyBmacUknownTunnel,        /* BSA lookup fail and (BDA = My-BDA). */
    bcmRxTrapMyBmacUnknownISid,         /*   Unknown I-SID. */
    bcmRxTrapStpStateBlock,             /* Packet ingresses on a blocked port.
                                           Note - BPDU will be forwarded with
                                           strength 6. */
    bcmRxTrapStpStateLearn,             /* Packet ingresses a port in a LEARN
                                           state. */
    bcmRxTrapIpCompMcInvalidIp,         /*   L2 compatible MC, but IP does not
                                           match. */
    bcmRxTrapMyMacAndIpDisabled,        /*   Terminated My-MAC over IP, but
                                           routing is disabled for InRIF. */
    bcmRxTrapTrillVersion,              /* Invalid TRILL version. */
    bcmRxTrapTrillTtl0,                 /* Invalid TRILL TTL. */
    bcmRxTrapTrillChbh,                 /* Unsupported TRILL option flags. */
    bcmRxTrapTrillUnknonwnIngressNickname, /* Unknown ingress nickname. */
    bcmRxTrapTrillCite,                 /* Unsupported TRILL options flags. */
    bcmRxTrapTrillIllegalInnerMc,       /*  Invalid packet format. */
    bcmRxTrapMyMacAndMplsDisable,       /* Terminated My-MAC over MPLS, but MPLS
                                           is disabled for InRIF. */
    bcmRxTrapArpReply,                  /* ARP reply to My-MAC. */
    bcmRxTrapMyMacAndUnknownL3,         /* Terminated My-MAC but L3 protocol is
                                           unknown. */
    bcmRxTrapMplsLabel0150,             /* Triggerd by MPLS labels 0-15
                                           forwarding Trap Code. */
    bcmRxTrapMplsLabel0151,             /* Triggerd by MPLS labels 0-15
                                           forwarding Trap Code. */
    bcmRxTrapMplsLabel0152,             /* Triggerd by MPLS labels 0-15
                                           forwarding Trap Code. */
    bcmRxTrapMplsLabel0153,             /* Triggerd by MPLS labels 0-15
                                           forwarding Trap Code. */
    bcmRxTrapMplsTerminationFail,       /* MPLS already terminated twice by
                                           label range match. Additional labels
                                           may not be terminated by Label range
                                           match. */
    bcmRxTrapMplsUnexpectedBos,         /* Terminated MPLS label indicates that
                                           another MPLS shim is to follow,
                                           however the terminated label is BOS. */
    bcmRxTrapMplsUnexpectedNoBos,       /* Reserved MPLS label (0.15) is mapped
                                           to this action by
                                           ppd_mpls_term_reserved_label_info_set(). */
    bcmRxTrapCfmAcceleratedIngress,     /* ITU Y.1731 packet observed (CFM). */
    bcmRxTrapIllegelPacketFormat,       /* Parser failure. */
    bcmRxTrapL2DiscardMacsaFwd,         /* Triggered by contorl
                                           bcmPortControlDiscardMacsaAction with
                                            BCM_PORT_CONTROL_DISCARD_MACSA_FWD. */
    bcmRxTrapL2DiscardMacsaDrop,        /* Triggered by contorl
                                           bcmPortControlDiscardMacsaAction with
                                            BCM_PORT_CONTROL_DISCARD_MACSA_FWD . */
    bcmRxTrapL2DiscardMacsaTrap,        /* Triggered by contorl
                                           bcmPortControlDiscardMacsaAction with
                                            BCM_PORT_CONTROL_DISCARD_MACSA_DROP. */
    bcmRxTrapL2DiscardMacsaSnoop,       /* Triggered by contorl
                                           bcmPortControlDiscardMacsaAction with
                                            BCM_PORT_CONTROL_DISCARD_MACSA_TRAP. */
    bcmRxTrapL2Learn0,                  /* Triggeerd by bcm_port_learn_set with
                                           flag =
                                           BCM_PORT_LEARN_ARL|BCM_PORT_LEARN_FWD. */
    bcmRxTrapL2Learn1,                  /* Triggeerd by bcm_port_learn_set with
                                           flag =
                                           BCM_PORT_LEARN_CPU|BCM_PORT_LEARN_FWD. */
    bcmRxTrapL2Learn2,                  /* Triggeerd by bcm_port_learn_set with
                                           flag = BCM_PORT_LEARN_ARL. */
    bcmRxTrapL2Learn3,                  /* Triggeerd by bcm_port_learn_set with
                                           flag = BCM_PORT_LEARN_FWD |
                                           BCM_PORT_LEARN_CPU. */
    bcmRxTrapVlanUnknownDa,             /* Per VLAN/VSI 8 flooding profiled can
    ...
    bcmRxTrapL2DlfFwd,                  /* per port trap when DA is not found,
                                           see bcmPortControlUnknownMacDaAction
                                           BCM_PORT_CONTROL_UNKNOWN_MACDA_FWD. */
    bcmRxTrapL2DlfDrop,                 /* BCM_PORT_CONTROL_UNKNOWN_MACDA_DROP. */
    bcmRxTrapL2DlfTrap,                 /* BCM_PORT_CONTROL_UNKNOWN_MACDA_TRAP. */
    bcmRxTrapL2DlfSnoop,                /* BCM_PORT_CONTROL_UNKNOWN_MACDA_SNOOP. */
    bcmRxTrapExtendedP2pLookupFail,     /* Transparent P2P Lookup key is not
                                           found in the ELK/LEM. */
    bcmRxTrapSameInterface,             /* Source interface is equal to
                                           destination interface (hair-pin). */
    bcmRxTrapTrillUnknownUc,            /* Forwarding Code is TRILL, lookup key
                                           is not found in ELK/LEM. */
    bcmRxTrapTrillUnknownMc,            /* Forwarding Code is TRILL, lookup key
                                           is not found in ELK/LEM. */
    bcmRxTrapUcLooseRpfFail,            /* Forwarding Code is IPv4 UC and RPF
                                           FEC Pointer Valid is not set. */
    bcmRxTrapDefaultUcv6,               /* IPv6 UC default forwarding. */
    bcmRxTrapDefaultMcv6,               /* IPv6 MC default forwarding. */
    bcmRxTrapMplsP2pNoBos,              /* Lookup key is found in ELK/LEM,
                                           P2P-Service If lookup result is set,
                                           and header is not BOS.. */
    bcmRxTrapMplsControlWordTrap,       /* Lookup key is found in ELK/LEM,
                                           P2P-Service If lookup result is set,
                                           lookup result determines that there's
                                           a control word, nibble after MPLS
                                           stack equal '1'. */
    bcmRxTrapMplsControlWordDrop,       /* Lookup key is found in ELK/LEM,
                                           P2P-Service If lookup result is set,
                                           lookup result determines that there's
                                           a control word, nibble after MPLS
                                           stack does not equal '1' or '0'. */
    bcmRxTrapMplsUnknownLabel,          /* Lookup key is not found in ELK/LEM. */
    bcmRxTrapMplsExtendP2pMplsx4,       /* Extended P2P service with 4 MPLS
                                           labels. */
    bcmRxTrapFrwrdIgmpMembershipQuery,  /* Forwarded packet is IGMP and first
                                           octet in the IGMP payload is 0x11. */
    bcmRxTrapFrwrdIgmpReportLeaveMsg,   /* Forwarded packet is IGMP and first
                                           octet in the IGMP payload is 0x12,
                                           0x16, 0x17, or 0x22. */
    bcmRxTrapFrwrdIgmpUndefined,        /* Forwarded packet is IGMP and first
                                           octet in the IGMP payload is not
                                           0x11, 0x12, 0x16, 0x17, or 0x22. */
    bcmRxTrapFrwrdIcmpv6MldMcListenerQuery, /* Forwarded packet is ICMPv6 with an
                                           MLD type, IPv6 packet with IP
                                           protocol 58 and the ICMPv6 type is
                                           130. */
    bcmRxTrapFrwrdIcmpv6MldReportDone,  /* Forwarded packet is ICMPv6 with an
                                           MLD type, IPv6 packet with IP
                                           protocol 58 and the ICMPv6 type is
                                           131,132 or 143. */
    bcmRxTrapFrwrdIcmpv6MldUndefined,   /* Forwarded packet is ICMPv6 with an
                                           MLD type, IPv6 packet with IP
                                           protocol 58 and the ICMPv6 type is
                                           other than 130,131,132 or 143. */
    bcmRxTrapIpv4VersionError,          /* Version is different than 4. */
    bcmRxTrapIpv4ChecksumError,         /*  IHL is 5 and the checksum over the
                                           first 20 bytes doesn't verify. */
    bcmRxTrapIpv4HeaderLengthError,     /* IHL (Internet Header Length) is less
                                           than 5. */
    bcmRxTrapIpv4TotalLengthError,      /* Total length is less than 20. */
    bcmRxTrapIpv4Ttl0,                  /* TTL is equal to 0. */
    bcmRxTrapIpv4HasOptions,            /* IHL (Internet Header Length) is
                                           greater than 5. */
    bcmRxTrapIpv4Ttl1,                  /* In-TTL is 0. */
    bcmRxTrapIpv4SipEqualDip,           /* Source-IP is equal to destination IP. */
    bcmRxTrapIpv4DipZero,               /* Destination IP is 0. */
    bcmRxTrapIpv4SipIsMc,               /* Source-IP is multicast. */
    bcmRxTrapIpv4TunnelTerminationAndFragmented, /* Fragmented  IPv4 packet over an IPv4
                                           tunnel. */
    bcmRxTrapIpv6VersionError,          /* Version is different than 6. */
    bcmRxTrapIpv6HopCount0,             /* Hop count (TTL) is 0. */
    bcmRxTrapIpv6HopCount1,             /* Hop count (TTL) is 1. */
    bcmRxTrapIpv6UnspecifiedDestination, /* Forwarding header DIP = ::. */
    bcmRxTrapIpv6LoopbackAddress,       /* DIP = ::1 or SIP = ::1. */
    bcmRxTrapIpv6MulticastSource,       /* The MSB of the SIP = 0xFF. */
    bcmRxTrapIpv6NextHeaderNull,        /* Next-protocol is zero. */
    bcmRxTrapIpv6UnspecifiedSource,     /* SIP = ::. */
    bcmRxTrapIpv6LocalLinkDestination,  /* Bits 127:118 of the destination-IP
                                           are equal to 0x3FA. */
    bcmRxTrapIpv6LocalSiteDestination,  /* Bits 127:118 of the DIP = 0x3FB
                                           (deprecated). */
    bcmRxTrapIpv6LocalLinkSource,       /* Bits 127:118 of the SIP = 0x3FA. */
    bcmRxTrapIpv6LocalSiteSource,       /* Bits 127:118 of the SIP = 0x3FB. */
    bcmRxTrapIpv6Ipv4CompatibleDestination, /* Bits 127:32 of the DIP = 0. */
    bcmRxTrapIpv6Ipv4MappedDestination, /* Bits 127:32 of the DIP are equal to
                                           0000_FFF_0000_0000_0000_0000. */
    bcmRxTrapIpv6MulticastDestination,  /* MSB of the DIP=0xFF. */
    bcmRxTrapMplsTtl0,                  /* TTL is equal to 0. */
    bcmRxTrapMplsTtl1,                  /* TTL is equal to 1. */
    bcmRxTrapTcpSnFlagsZero,            /* L4 Sequence-Number and Flags (6) are
                                           both zero. */
    bcmRxTrapTcpSnZeroFlagsSet,         /* L4 Sequence-Number is zero and either
                                           Flags. FIN, Flags. URG or FLAGS. PSH
                                           are set. */
    bcmRxTrapTcpSynFin,                 /* Both Flags. SYN and Flags. FIN are
                                           set. */
    bcmRxTrapTcpEqualPorts,             /* Source-Port equals Destination-Port. */
    bcmRxTrapTcpFragmentIncompleteHeader, /* L3 is IPv4 and IP-Header. Fragmented
                                           and IP-Header. Fragment-Offset zero
                                           and (IPv4-Header. Total-Length - 4 *
                                           IPv4-Header. IHL) is less than 20B. */
    bcmRxTrapTcpFragmentOffsetLt8,      /* L3 is IPv4 and IP-Header. Fragmented
                                           and IP-Header. Fragment-Offset is
                                           less than 8. */
    bcmRxTrapUdpEqualPorts,             /* Source-Port equals Destination-Port. */
    bcmRxTrapIcmpDataGt576,             /* L3 is IPv4 and (IPv4-Header.
                                           Total-Length - 4* IPv4-Header. IHL)
                                           is greater than 576B or layer-3 is
                                           IPv6 and IPv6-Header. Payload-Length
                                           is greater than 576B. */
    bcmRxTrapIcmpFragmented,            /* IP-Header. Fragmented is set. */
    bcmRxTrapFailoverFacilityInvalid,   /* Both Destination-0-Valid and
                                           Destination-1-Valid are not set. */
    bcmRxTrapUcStrictRpfFail,           /* UC-RPF-Mode is 'Strict' and OutRIF is
                                           not equal to packet InRIF . */
    bcmRxTrapMcExplicitRpfFail,         /* RPF-Entry. Expected-InRIF is not
                                           equal to packet InRIF Relevant when
                                           FEC-Entry. MC-RPF-Mode is 'Explicit'. */
    bcmRxTrapMcUseSipRpfFail,           /* Out-RIF is not equal to In-RIF when
                                           MC-RPF-Mode is 'Use-SIP-WITH-ECMP'
                                           Note: . */
    bcmRxTrapMcUseSipMultipath,         /* Found RPF-ECMP-Group-Size > '1'
                                           Relevant when MC-RPF-Mode is
                                           'Use-SIP'. */
    bcmRxTrapIcmpRedirect,              /* ICMP-Redirect is enabled,
                                           Forwarding-Code is IPv4|6-UC, and
                                           packet InRIF is equal to FEC-Entry.
                                           OutRIF. */
    bcmRxTrapOamp,                      /* . */
    bcmRxTrapOamEthAccelerated,         /* . */
    bcmRxTrapOamMplsAccelerated,        /* In T20E this trap code cannot be used
                                           in
    ...
    bcmRxTrapOmaBfdPweAccelerated,      /* . */
    bcmRxTrapOmaEthUpAccelerated,       /* . */
    bcmRxTrapEgPortNotVlanMember,       /* egress vlan membership. */
    bcmRxTrapEgHairPinFilter,           /* . */
    bcmRxTrapEgSplitHorizonFilter,      /* . */
    bcmRxTrapEgUnknownDa,               /* uc unknown DA. */
    bcmRxTrapEgMtuFilter,               /* packet size > mtu. */
    bcmRxTrapEgPvlanFilter,             /* private vlan filter. */
    bcmRxTrapEgDiscardFrameTypeFilter,  /* not acceptable frame type on port
                                           (tagged, untagged). */
    bcmRxTrapEgTrillHairPinFilter,      /* trill same in/out interface. */
    bcmRxTrapEgTrillBounceBack,         /* prevent bounce back of trill
                                           terminated unicast packets by the
                                           egress router bridge in case of a DA
                                           not found. */
    bcmRxTrapEgTrillTtl0,               /* trill invalid ttl (egress). */
    bcmRxTrapEgIpmcTtlErr,              /* IPv4 MC packet with invalid ttl. */
    bcmRxTrapEgCfmAccelerated,          /* CFM packet at egress. */
    bcmRxTrapDssStacking,               /* Trap according to Dss stacking denail
                                           (history Bitmap). */
    bcmRxTrapLagMulticast,              /* Trap Lag Multicast Packets. */
    bcmRxTrapExEgCnm,                   /* CNM packet. */
    bcmRxTrapTrillDesignatedVlanNoMymac, /* EoTrilloE packet is not designtated
                                           vlan but with my-mac, or designated
                                           vlan but without my-mac. Disable
                                           bridging for such packets. */
    bcmRxTrapAdjacentCheckFail,         /* TRILL adjacent check fail. */
    bcmRxTrapFcoeSrcIdMismatchSa,       /* FCoE, where FC.SrC is mismatch
                                           Eth.SA. */
    bcmRxTrapSipMove,                   /* sip transplant. */
    bcmRxTrapOamY1731MplsTp,            /* . */
    bcmRxTrapOamY1731Pwe,               /* . */
    bcmRxTrapOamBfdIpv4,                /* . */
    bcmRxTrapOamBfdMpls,                /* . */
    bcmRxTrapOamBfdPwe,                 /* . */
    bcmRxTrapOamBfdCcMplsTp,            /* . */
    bcmRxTrapOamBfdCvMplsT,             /* . */
    bcmRxTrapOamLevel,                  /* OAM packet with mdlevel below highest
                                           MEP on active side. */
    bcmRxTrapOamPassive,                /* OAM packet equal or below highest MEP
                                           level on passive side. */
    bcmRxTrap1588,                      /* 1588 protocol packet. */
    bcmRxTrapMplsLabelIndexNoSupport,   /* No support to forward according to
                                           MPLS forth label. */
    bcmRxTrapDhcpv4Client,              /* DHCP packet sent to client over
                                           IPv4oE. */
    bcmRxTrapDhcpv4Server,              /* DHCP packet sent to server over
                                           IPv4oE. */
    bcmRxTrapEtherIpVersion,            /* IPv4 version error, for
                                           IPv4oEtheroIPv4oEth packet. */
    bcmRxTrapEgressObjectAccessed,      /* Egress object entry was accessed due
                                           to packet lookup. */
    bcmRxTrapIcmpv6MldReportDone,       /* ICMPv6 packet with an MLD with done
                                           message. */
    bcmRxTrapIcmpv6MldUndefined,        /* ICMPv6 packet with an MLD with other
                                           message. */
    bcmRxTrapFailover1Plus1Fail,        /* 1 plus 1 protected LIF and failover
                                           status is down. */
    bcmRxTrapEgInvalidDestPort,         /* Egress trap: Invalid out port number. */
    bcmRxTrapEgIpv4VersionError,        /* Egress trap: Version is different
                                           than 4.. */
    bcmRxTrapEgIpv4ChecksumError,       /* Egress trap: IHL is 5 and the
                                           checksum over the first 20 bytes
                                           doesn't verify. */
    bcmRxTrapEgIpv4HeaderLengthError,   /* Egress trap: IHL (Internet Header
                                           Length) is less than 5. */
    bcmRxTrapEgIpv4TotalLengthError,    /* Egress trap: Total length is less
                                           than 20. */
    bcmRxTrapEgIpv4Ttl0,                /* Egress trap: TTL is equal to 0. */
    bcmRxTrapEgIpv4HasOptions,          /* Egress trap: IHL (Internet Header
                                           Length) is greater than 5. */
    bcmRxTrapEgIpv4Ttl1,                /* Egress trap: In-TTL is 0. */
    bcmRxTrapEgIpv4SipEqualDip,         /* Egress trap: Source-IP is equal to
                                           destination IP. */
    ...
    bcmRxTrapEgIpv6MulticastSource,     /* Egress trap: The MSB of the SIP =
                                           0xFF. */
    bcmRxTrapEgIpv6UnspecifiedSource,   /* Egress trap: SIP = ::. */
    bcmRxTrapEgIpv6LocalLinkDestination, /* Egress trap: Bits 127:118 of the
                                           destination-IP are equal to 0x3FA. */
    bcmRxTrapEgIpv6LocalSiteDestination, /* Egress trap: Bits 127:118 of the DIP
                                           = 0x3FB (deprecated). */
    bcmRxTrapEgIpv6LocalLinkSource,     /* Egress trap: Bits 127:118 of the SIP
                                           = 0x3FA. */
    bcmRxTrapEgIpv6LocalSiteSource,     /* Egress trap: Bits 127:118 of the SIP
                                           = 0x3FB. */
    bcmRxTrapEgIpv6Ipv4CompatibleDestination, /* Egress trap: Bits 127:32 of the DIP =
                                           0. */
    bcmRxTrapEgIpv6Ipv4MappedDestination, /* Egress trap: Bits 127:32 of the DIP
                                           are equal to
                                           0000_FFF_0000_0000_0000_0000. */
    ...
    bcmRxTrapUserDefine,                /* User define traps. */
    bcmRxTrapArpIPUnknown,              /* ARP request with unknown host
                                           address. */
    bcmRxTrapFcoeZoneCheckFail,         /* Fcoe zone check failed. */
    bcmRxTrapArplookupFail,             /* For ARP packet, lookup for VRF and
                                           TPA (IP) failed. */
    bcmRxTrapCount                      /* Must be last: enum count size. */
} bcm_rx_trap_t;
