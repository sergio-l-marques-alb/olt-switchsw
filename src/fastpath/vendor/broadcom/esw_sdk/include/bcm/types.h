/*
 * $Id: ffb537ded95177113076a15aff8f5d6ee358d8aa $
 * 
...
typedef enum bcm_vlan_action_e {
    ...
    bcmVlanActionMappedAdd,     /* Add a new VLAN tag according to Mapped VLAN. */
    bcmVlanActionMappedReplace, /* Replace existing VLAN tag according to Mapped
                                   VLAN. */
    bcmVlanActionOuterAdd,      /* Add a new VLAN tag with the Outer VLAN tag
                                   value. */
    bcmVlanActionInnerAdd,      /* Add a new VLAN tag with the Inner VLAN tag
                                   value. */
    bcmVlanActionCopyVsan,      /* Copy VSAN and Pri. */
    bcmVlanActionReplaceVsan    /* Replace VSAN and Pri. */
} bcm_vlan_action_t;
