/*
 * $Id: ces.h 1.8.2.17 Broadcom SDK $
 * 
 ...
 * Macros
 */
#define bcm_ces_service_is_valid(s) (s < (bcm_ces_service_t)BCM_CES_CIRCUIT_IDX_MAX) /* No need to check < 0 as service is unsigned */
...
extern int bcm_esw_ces_detach(
    int unit);
#endif
int bcm_esw_ces_rclock_status_get(int unit, int rcr_index, bcm_ces_crm_status_msg_t *ces_rcr_status);
