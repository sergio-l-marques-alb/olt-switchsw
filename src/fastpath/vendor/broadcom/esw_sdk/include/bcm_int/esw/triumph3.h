/*
 * $Id: triumph3.h 1.111 Broadcom SDK $
...
/* L3 LPM state */
#define BCM_TR3_DEFIP_PAIR128_HASH_SZ             (0x6)
#define BCM_TR3_DEFIP_PAIR128(_unit_)             l3_tr3_defip_pair128[(_unit_)]
#define BCM_TR3_DEFIP_PAIR128_ARR(_unit_)         BCM_TR3_DEFIP_PAIR128((_unit_))->entry_array
#define BCM_TR3_DEFIP_PAIR128_IDX_MAX(_unit_)     BCM_TR3_DEFIP_PAIR128((_unit_))->idx_max
#define BCM_TR3_DEFIP_PAIR128_USED_COUNT(_unit_)  BCM_TR3_DEFIP_PAIR128((_unit_))->used_count
#define BCM_TR3_DEFIP_PAIR128_TOTAL(_unit_)       BCM_TR3_DEFIP_PAIR128((_unit_))->total_count
#define BCM_TR3_DEFIP_PAIR128_URPF_OFFSET(_unit_) BCM_TR3_DEFIP_PAIR128((_unit_))->urpf_offset
#define BCM_TR3_DEFIP_PAIR128_ENTRY_SET(_unit_, _idx_, _plen_, _hash_)          \
            BCM_TR3_DEFIP_PAIR128_ARR((_unit_))[(_idx_)].prefix_len = (_plen_); \
            BCM_TR3_DEFIP_PAIR128_ARR((_unit_))[(_idx_)].entry_hash = (_hash_)

typedef struct _bcm_tr3_l3_defip_pair128_entry_s {
    uint8  prefix_len; /* Route entry  prefix length.*/
    uint8  entry_hash; /* Route entry key hash.      */
} _bcm_tr3_l3_defip_pair128_entry_t;

typedef struct _bcm_tr3_l3_defip_pair128_table_s {
    _bcm_tr3_l3_defip_pair128_entry_t *entry_array; /* Cam entries array.      */
...
} _bcm_tr3_l3_defip_pair128_table_t;
...
extern int bcm_tr3_wlan_tunnel_terminator_vlan_get(int unit, bcm_gport_t tunnel, 
                                              bcm_vlan_vector_t *vlan_vec);
extern int _bcm_tr3_lport_field_set(int unit, bcm_gport_t wlan_port_id, 
                                    soc_field_t field, int value);
extern int _bcm_tr3_lport_field_get(int unit, bcm_gport_t wlan_port_id, 
                                    soc_field_t field, int *value);
...
extern int _bcm_tr3_bfd_init(int unit);
#endif /* INCLUDE_BFD */
