/*
 * $Id: trident.h 1.47.4.14 Broadcom SDK $
...
extern int bcm_td_trill_source_trill_idx_name_get(int  unit, 
                                                                   int  trill_name_index,
                                                                   bcm_trill_name_t  *source_trill_name);
extern int bcm_td_trill_vlan_multicast_group_add(int unit, bcm_vlan_t vlan);
extern int bcm_td_trill_vlan_multicast_group_delete(int unit, bcm_vlan_t vlan);
...
extern int bcm_td_l2_trill_network_multicast_entry_traverse (int unit, _bcm_td_trill_multicast_traverse_t *trav_st);
extern int bcm_td_l2_trill_access_multicast_entry_traverse (int unit, _bcm_td_trill_multicast_traverse_t *trav_st);
