/*
 * $Id: trident2.h 1.52.2.1 Broadcom SDK $
...
#define _BCM_TD2_DEFIP_TCAM_DEPTH    1024

/* L3 LPM state */
#define BCM_TD2_DEFIP_PAIR128_HASH_SZ             (0x6)
#define BCM_TD2_DEFIP_PAIR128(_unit_)             l3_td2_defip_pair128[(_unit_)]
#define BCM_TD2_DEFIP_PAIR128_ARR(_unit_)         BCM_TD2_DEFIP_PAIR128((_unit_))->entry_array
#define BCM_TD2_DEFIP_PAIR128_IDX_MAX(_unit_)     BCM_TD2_DEFIP_PAIR128((_unit_))->idx_max
#define BCM_TD2_DEFIP_PAIR128_USED_COUNT(_unit_)  BCM_TD2_DEFIP_PAIR128((_unit_))->used_count
#define BCM_TD2_DEFIP_PAIR128_TOTAL(_unit_)       BCM_TD2_DEFIP_PAIR128((_unit_))->total_count
#define BCM_TD2_DEFIP_PAIR128_URPF_OFFSET(_unit_) BCM_TD2_DEFIP_PAIR128((_unit_))->urpf_offset
#define BCM_TD2_DEFIP_PAIR128_ENTRY_SET(_unit_, _idx_, _plen_, _hash_)          \
            BCM_TD2_DEFIP_PAIR128_ARR((_unit_))[(_idx_)].prefix_len = (_plen_); \
            BCM_TD2_DEFIP_PAIR128_ARR((_unit_))[(_idx_)].entry_hash = (_hash_)

typedef struct _bcm_td2_l3_defip_pair128_entry_s {
    uint8  prefix_len; /* Route entry  prefix length.*/
    uint8  entry_hash; /* Route entry key hash.      */
} _bcm_td2_l3_defip_pair128_entry_t;

typedef struct _bcm_td2_l3_defip_pair128_table_s {
    _bcm_td2_l3_defip_pair128_entry_t *entry_array; /* Cam entries array.      */
...
} _bcm_td2_l3_defip_pair128_table_t;
...
/*LPM */
extern int _bcm_td2_l3_lpm_get(int unit, _bcm_defip_cfg_t *lpm_cfg, int *nh_ecmp_idx);
extern int _bcm_td2_l3_lpm_add(int unit, _bcm_defip_cfg_t *lpm_cfg, int nh_ecmp_idx);
extern int _bcm_td2_l3_lpm_del(int unit, _bcm_defip_cfg_t *lpm_cfg);
extern int _bcm_td2_l3_lpm_update_match(int unit, _bcm_l3_trvrs_data_t *trv_data);
extern int _bcm_td2_l3_defip_init(int unit);
extern int _bcm_td2_l3_defip_deinit(int unit);
extern int _bcm_td2_l3_defip_urpf_enable(int unit, int enable);
...
extern int bcm_td2_ipmc_required_scache_size_get(int unit, uint32 *size);
extern int bcm_td2_ipmc_sync(int unit, uint8 **scache_ptr);
extern int bcm_td2_ipmc_scache_recover(int unit, uint8 **scache_ptr); 
...
extern int bcm_td2_vxlan_egress_set(int unit, int nh_index);
...
extern int _bcm_esw_vxlan_multicast_leaf_entry_check(int unit,  bcm_ip_t mc_ip_addr, int flag);
extern int bcm_td2_vxlan_multicast_leaf_entry_check(int unit, bcm_ip_t mc_ip_addr, int enable_flag);
