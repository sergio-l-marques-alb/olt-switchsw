...
extern int bcm_common_ptp_lock(int unit);
extern int bcm_common_ptp_unlock(int unit);
...
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT) || defined(BCM_TRIDENT2_SUPPORT) || defined(BCM_ARAD_SUPPORT)     
...
#define PTP_CLOCK_FLAGS_SIGNALING_MULTI_TLV_BIT                        (7u)
...
#else
/* Non-Keystone stack */
#define _PTP_MAX_PEER_DATASET_ENTRIES           290
#define _PTP_MAX_PEER_DATASET_CHUNK_SIZE        10
#define _PTP_MAX_FOREIGN_MASTER_DATASET_ENTRIES 10
#endif  /* PTP_KEYSTONE_STACK */
...
extern int bcm_common_ptp_clock_port_identity_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    uint32 clock_port,
...
extern int bcm_common_ptp_clock_time_get(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num,
