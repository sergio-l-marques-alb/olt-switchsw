 ...
 * GPORT_EXTENDER_PORT_ID_SET   set a Extender ID type and value 
 * GPORT_EXTENDER_PORT_ID_GET   get a Extender ID from an Extender gport
...
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_MAC_PORT /* Used for sanity */
                                                /* checks only.    */
...
#define _SHR_GPORT_EXTENDER_PORT_MASK                   0xffffff
...
#define _SHR_GPORT_TRAP_STRENGTH_SHIFT          	 10
#define _SHR_GPORT_TRAP_STRENGTH_MASK          		 0xf
#define _SHR_GPORT_TRAP_SNOOP_STRENGTH_SHIFT             14
