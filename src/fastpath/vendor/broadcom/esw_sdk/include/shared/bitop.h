/*
 * $Id: bitop.h 1.15.104.6 Broadcom SDK $
...
#if defined(__KERNEL__) || defined(BCM_UKERNEL)
  #define BITOP_FIX_INLINE extern
#else
  #define BITOP_FIX_INLINE INLINE
#endif
...
BITOP_FIX_INLINE void shr_bitop_range_clear(SHR_BITDCL *a, CONST int b, CONST int c);
#define SHR_BITCLR_RANGE(_a, _b, _c)            \
    (shr_bitop_range_clear(_a, _b, _c))

/* set _c bits starting from _b in bit array _a */
BITOP_FIX_INLINE void shr_bitop_range_set(SHR_BITDCL *a, CONST int b, CONST int c);
 ...
 */
BITOP_FIX_INLINE void shr_bitop_range_copy(SHR_BITDCL *a,
                                 CONST int b,
                                 CONST SHR_BITDCL *c,
                                 CONST int d,
                                 CONST int e);
...
BITOP_FIX_INLINE void shr_bitop_range_and(CONST SHR_BITDCL *bits1,
                                CONST SHR_BITDCL *bits2,
                                CONST int first,
                                CONST int bit_count,
                                SHR_BITDCL *dest);
BITOP_FIX_INLINE void shr_bitop_range_or(CONST SHR_BITDCL *bits1,
                               CONST SHR_BITDCL *bits2,
                               CONST int first,
                               CONST int bit_count,
                               SHR_BITDCL *dest);
BITOP_FIX_INLINE void shr_bitop_range_xor(CONST SHR_BITDCL *bits1,
                                CONST SHR_BITDCL *bits2,
                                CONST int first,
                                CONST int bit_count,
                                SHR_BITDCL *dest);
BITOP_FIX_INLINE void shr_bitop_range_remove(CONST SHR_BITDCL *bits1,
                                   CONST SHR_BITDCL *bits2,
                                   CONST int first,
                                   CONST int bit_count,
                                   SHR_BITDCL *dest);
...
BITOP_FIX_INLINE void shr_bitop_range_negate(CONST SHR_BITDCL *bits1,
                                   CONST int first,
                                   CONST int bit_count,
                                   SHR_BITDCL *dest);
...
BITOP_FIX_INLINE int shr_bitop_range_null(CONST SHR_BITDCL *a, CONST int first, CONST int bit_count);
BITOP_FIX_INLINE int shr_bitop_range_eq(CONST SHR_BITDCL *bits1, CONST SHR_BITDCL *bits2,
                         CONST int first, CONST int range);
BITOP_FIX_INLINE void shr_bitop_range_count(CONST SHR_BITDCL *bits, CONST int first,
