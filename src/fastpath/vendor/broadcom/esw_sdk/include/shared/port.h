/*
 * $Id: port.h 1.105.6.2 Broadcom SDK $
...
#define _SHR_PORT_PHY_TIMESYNC_CAP_MPLS                             (1U << 27)
#define _SHR_PORT_PHY_TIMESYNC_CAP_ENHANCED_TSFIFO                  (1U << 28)
#define _SHR_PORT_PHY_TIMESYNC_CAP_INBAND_TS                        (1U << 29)
#define _SHR_PORT_PHY_TIMESYNC_CAP_FOLLOW_UP_ASSIST                 (1U << 30)
#define _SHR_PORT_PHY_TIMESYNC_CAP_DELAY_RESP_ASSIST                (1U << 31)
