/*
 * $Id: dev_prop.c 1.16 Broadcom SDK $
 *
 ...
 */
int 
drv_bcm53125_dev_prop_get(int unit, uint32 prop_type, uint32 *prop_val)
{
    ...
    switch (prop_type) {
        ...
        case DRV_DEV_PROP_LOW_POWER_SUPPORT_PBMP:
            *prop_val = DRV_MAC_LOW_POWER_SUPPORT_PBMP;
            break;
        default:
            return SOC_E_PARAM;
    }
 ...
 */
int 
drv_bcm53125_dev_prop_set(int unit, uint32 prop_type, uint32 prop_val)
{
    uint32 reg_val = 0, temp = 0;
    soc_pbmp_t  pbmp;
    int i, rv = SOC_E_NONE;
    ...
    switch (prop_type) {
        ...
        case DRV_DEV_PROP_EEE_INIT:
            ...
            /* per device */
            SOC_IF_ERROR_RETURN(
                drv_bcm53125_dev_prop_set(unit, 
