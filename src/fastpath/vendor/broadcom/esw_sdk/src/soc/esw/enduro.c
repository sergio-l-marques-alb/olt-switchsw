/*
 * $Id: enduro.c 1.93.2.13 Broadcom SDK $
            ...
            for (table = 0; info[table].error_field != INVALIDf; table++) {
                ...
                case _SOC_PARITY_INFO_TYPE_GENERIC:
                    if (info[table].enable_field == START_BY_START_ERR_ENf) {
                        uint32 rr;
                        SOC_IF_ERROR_RETURN
                            (WRITE_START_BY_START_ERRORr(unit, 0));
                        SOC_IF_ERROR_RETURN
...
soc_enduro_mem_config(int unit)
{
    ...
    case BCM56321_DEVICE_ID:
        ...
        sop->memState[VLAN_XLATEm].index_max = 2047;
        sop->memState[EGR_VLAN_XLATEm].index_max = 2047;
        sop->memState[L3_ENTRY_ONLYm].index_max = 2047;
        sop->memState[L3_ENTRY_HIT_ONLYm].index_max = 127;
        sop->memState[L3_ENTRY_VALID_ONLYm].index_max = 127;
        sop->memState[L3_ENTRY_IPV4_MULTICASTm].index_max = 1023;
