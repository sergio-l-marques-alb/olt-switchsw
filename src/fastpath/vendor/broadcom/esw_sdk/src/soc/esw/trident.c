    /*
 * $Id: trident.c 1.221.2.6 Broadcom SDK $
                                 ...
                                 int schan, char *prefix_str, char *mem_str)
{
    ...
    int bucket_size, entry_idx, idx, bank_bkt_idx, bits, has_error;
    _soc_ser_correct_info_t spci;
...
/*This structure should be temporary, until issues with these memories can be fixed.*/
const skipped_mem_t ser_test_skipped_mems[] = {
    { EGR_VLANm, _SOC_ACC_TYPE_PIPE_GROUP},
    ...
    { DLB_HGT_FLOWSET_PORTm, _SOC_ACC_TYPE_PIPE_GROUP},
    { DLB_HGT_FLOWSET_PORTm, _SOC_ACC_TYPE_PIPE_Y},
    {INVALIDm}
};
 ...
 */
soc_error_t
soc_td_ser_inject_error(int unit, soc_mem_t mem, int pipe_target,
                        int block, int index)
{
    _soc_ser_parity_info_t *tcam_info = _soc_td_ser_parity_info[unit];
    int num_tcams = COUNTOF(_soc_td_ser_parity_info_template) - 1;
    ...
    for (i = 0; i < num_tcams; i++) {
        ...
        if (tcam_info[i].mem == mem && 
            ...
            test_data.test_field =
                test_data.mem_info->fields[test_data.mem_info->nFields-1].field;
