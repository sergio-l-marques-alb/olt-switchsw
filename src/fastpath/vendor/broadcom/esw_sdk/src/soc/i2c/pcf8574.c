	  ...
	  void* data, int len)
{
	...
	soc_cm_debug(DK_VERBOSE, "%s: mux control 0x%x\n",
	...
	soc_cm_debug(DK_VERBOSE, "%s: baseboard id 0x%x\n",
		     soc_i2c_devname(unit, devno), lpt_val);
	...
	soc_cm_debug(DK_VERBOSE, "%s: hclk control 0x%x\n",
		     soc_i2c_devname(unit, devno), lpt_val);
