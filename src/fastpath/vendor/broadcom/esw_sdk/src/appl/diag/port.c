/*
 * $Id: port.c 1.286.2.3 Broadcom SDK $
...
_phy_diag_fast_eyescan(int unit, bcm_pbmp_t pbmp, args_t *args)
{
    ...
    inst = PHY_DIAG_INSTANCE(phy_unit, phy_unit_if, (lane_num == 0xff)? PHY_DIAG_LN_DFLT: lane_num);
...
void config_port_sync_1k(int unit, bcm_port_t port)
{
    ...
    rv = bcm_port_control_phy_timesync_set(unit, port, bcmPortControlPhyTimesyncLocalTime,  _compiler_64_arg(0x0, 0x0));
