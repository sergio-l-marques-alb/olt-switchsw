/*
 * $Id: bcm-core-symbols.h 1.262.2.6 Broadcom SDK $
...
EXPORT_SYMBOL(sal_i2c_config_set);
...
EXPORT_SYMBOL(socdnx_mdebug_config);
EXPORT_SYMBOL(socdnx_mdebug_init);
EXPORT_SYMBOL(socdnx_mdebug_print);
...
#include <bcm_int/dpp/wb_db_mpls.h>
...
EXPORT_SYMBOL(_bcm_dpp_lif_bk_info);
...
EXPORT_SYMBOL(_counter_state_init);
...
EXPORT_SYMBOL(_dpp_wb_mpls_info_p);
...
EXPORT_SYMBOL(Soc_sand_physical_print_device_id_or_base_address);
