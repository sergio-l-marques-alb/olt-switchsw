...
#else
        if (osapiStrCaseCmp((char *) cp, (char *) keywords[i].name, strlen(cp)) == 0)
#endif /* L7_SSHD */
...
#else
    int opcode, *intptr, value=0, value2;
#endif /* L7_SSHD */
    size_t len;
    Forward fwd;
...
#else
        osapiSnprintf(fwdarg, sizeof(fwdarg), "%s:%s", arg, arg2);
#endif /* L7_SSHD */
...
#else
        if (osapiStrCaseCmp(arg, "inet", strlen("inet")) == 0)
#endif /* L7_SSHD */
            value = AF_INET;
#ifndef L7_SSHD
        else if (strcasecmp(arg, "inet6") == 0)
#else
        else if (osapiStrCaseCmp(arg, "inet6", strlen("inet6")) == 0)
#endif /* L7_SSHD */
            value = AF_INET6;
#ifndef L7_SSHD
        else if (strcasecmp(arg, "any") == 0)
#else
        else if (osapiStrCaseCmp(arg, "any", strlen("any")) == 0)
#endif /* L7_SSHD */
            value = AF_UNSPEC;
        else
...
#else
        if (osapiStrCaseCmp(arg, "ethernet", strlen("ethernet")) == 0)
#endif /* L7_SSHD */
            value = SSH_TUNMODE_ETHERNET;
#ifndef L7_SSHD
        else if (strcasecmp(arg, "point-to-point") == 0)
#else
        else if (osapiStrCaseCmp(arg, "point-to-point", strlen("point-to-point")) == 0)
#endif /* L7_SSHD */
            value = SSH_TUNMODE_POINTOPOINT;
#ifndef L7_SSHD
        else if (strcasecmp(arg, "yes") == 0)
#else
        else if (osapiStrCaseCmp(arg, "yes", strlen("yes")) == 0)
#endif /* L7_SSHD */
            value = SSH_TUNMODE_DEFAULT;
#ifndef L7_SSHD
        else if (strcasecmp(arg, "no") == 0)
#else
        else if (osapiStrCaseCmp(arg, "no", strlen("no")) == 0)
#endif /* L7_SSHD */
...
#else
            osapiSnprintf(options->identity_files[options->num_identity_files++],
#endif /* L7_SSHD */
