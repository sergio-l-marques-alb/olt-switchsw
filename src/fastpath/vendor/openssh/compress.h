...
#ifdef L7_SSHD
void     buffer_compress_init_send(int, int);
void     buffer_compress_init_recv(int);
void     buffer_compress_uninit(int);
void     buffer_compress(int, Buffer *, Buffer *);
void     buffer_uncompress(int, Buffer *, Buffer *);
#else
