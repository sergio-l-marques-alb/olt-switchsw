...
//tx->etherStatsDropEvents = 0;
  ...
  portStats->Mask = 0x03;
  portStats->RxMask = 0xFF7FF;  /* without Collisions, but include Pkts1024to1518Octets (0x20000) and Throughput (0x40000) */
  portStats->TxMask = 0xFF93F; /* without UndersizePkts, CRCAlignErrors, Fragments, Jabbers,
