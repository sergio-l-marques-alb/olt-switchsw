...
L7_RC_t broad_ptin_example(DAPI_USP_t *usp, DAPI_CMD_GET_SET_t operation, L7_uint32 dataSize, void *data, DAPI_t *dapi_g)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI, "Invalid data size (%u VS %zu)", dataSize, sizeof(ptin_dtl_example_t));
    return L7_FAILURE;
  }
...
L7_RC_t broad_ptin_l3_intf(DAPI_USP_t *usp, DAPI_CMD_GET_SET_t operation, L7_uint32 dataSize, void *data, DAPI_t *dapi_g)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI, "Invalid data size (%u VS %zu)", dataSize, sizeof(ptin_dtl_l3_intf_t));
    return L7_FAILURE;
  }
...
L7_RC_t broad_ptin_l3_ipmc(DAPI_USP_t *usp, DAPI_CMD_GET_SET_t operation, L7_uint32 dataSize, void *data, DAPI_t *dapi_g)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI, "Invalid data size (%u VS %zu)", dataSize, sizeof(ptin_dtl_ipmc_addr_t));
    return L7_FAILURE;
  }
...
L7_RC_t broad_ptin_qos_classify(DAPI_USP_t *usp, DAPI_CMD_GET_SET_t operation, L7_uint32 dataSize, void *data, DAPI_t *dapi_g)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI, "Invalid data size (%u VS %zu)", dataSize, sizeof(ptin_dtl_qos_t));
    return L7_FAILURE;
  }
...
L7_RC_t broad_ptin_qos_remark(DAPI_USP_t *usp, DAPI_CMD_GET_SET_t operation, L7_uint32 dataSize, void *data, DAPI_t *dapi_g)
{
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI, "Invalid data size (%u VS %zu)", dataSize, sizeof(L7_uint32));
    return L7_FAILURE;
  }
...
L7_RC_t hapiBroadHwApply(DAPI_USP_t *usp, DAPI_CMD_t cmd, void *data, DAPI_t *dapi_g)
{
  ...
  case PTIN_HWPROC_TX_ENABLE:
    if (hwproc->operation == DAPI_CMD_SET)
    {
      rc = ptin_hapi_tx_enable(usp, dapi_g, hwproc->param1);
    }
    else
    {
      PT_LOG_ERR(LOG_CTX_HAPI, "Operation not recognized: %u", hwproc->operation);
...
L7_RC_t hapiBroadPTinPrbsEnable(DAPI_USP_t *usp, L7_BOOL enable, DAPI_t *dapi_g)
{
  ...
  /* PRBS generated by internal PHY - please check _if_esw_phy_prbs()*/
  rv = bcm_port_control_set(0, bcm_port, bcmPortControlPrbsMode, 0); //"hc" mode
  if (BCM_E_NONE != rv)
  {
    PT_LOG_ERR(LOG_CTX_HAPI,
               "bcmPortControlPrbsMode to port %d, bcm_port=%d => %d (%s)",
               port, bcm_port, rv, bcm_errmsg(rv));
    return L7_FAILURE;
  }
  /* PRBS polynomial 31 */
  rv = bcm_port_control_set(0, bcm_port, bcmPortControlPrbsPolynomial, BCM_PORT_PRBS_POLYNOMIAL_X31_X28_1);
  if (BCM_E_NONE != rv)
  {
    PT_LOG_ERR(LOG_CTX_HAPI,
               "bcmPortControlPrbsPolynomial port %d, bcm_port=%d => %d (%s)",
               port, bcm_port, rv, bcm_errmsg(rv));
    return L7_FAILURE;
  }
...
#endif
  {
    ...
    {
      PT_LOG_ERR(LOG_CTX_HAPI,
                 "bcmPortControlPrbsTxInvertData port %d, bcm_port=%d => %d (%s)",
                 port, bcm_port, rv, bcm_errmsg(rv));
      return L7_FAILURE;
    }
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI,
               "bcmPortControlPrbsTxEnable %d port %d, bcm_port=%d => %d (%s)",
  ...
  {
    PT_LOG_ERR(LOG_CTX_HAPI,
               "bcmPortControlPrbsRxEnable %d port %d, bcm_port=%d => %d (%s)",
               enable, port, bcm_port, rv, bcm_errmsg(rv));
    return L7_FAILURE;
  }
#endif
  ...
  PT_LOG_TRACE(LOG_CTX_HAPI, "PRBS TX/RX %s for port %d, bcm_port=%d",
...
_hapiBroadPtinMEPCreate_nokend:
  if (!alrdy) {
      ...
      PT_LOG_TRACE(LOG_CTX_API, "ERROR: r=%d\n\r", r);
  }
