...
void hapiBroadPortLinkStatusChange(bcmx_lport_t lport, bcm_port_info_t *portInfo)
{
 ...
 LOG_NOTICE(LOG_CTX_HAPI,"LPort 0x%08x link=%d", lport, portInfo->linkstatus);
...
void hapiBroadPortLinkStatusChange(bcmx_lport_t lport, bcm_port_info_t *portInfo)
{
  ...
  {
    /* link is up */
    LOG_NOTICE(LOG_CTX_HAPI,"LPort 0x%08x link is up", lport);
  ...
  {
    /* link is down */
    LOG_NOTICE(LOG_CTX_HAPI,"LPort 0x%08x link is down", lport);
