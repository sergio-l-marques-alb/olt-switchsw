...
export KERNEL_PATH        = $(OLT_DIR)/../lib/kernel/linux-3.6.5-arm-cma
...
clean-ptin clean-switching clean-routing clean-base clean-andl clean-xweb clean-xlib clean-emweb clean-modb clean-cli clean-snmp clean-mgmt: setsdk
	$(MAKE) -j$(NUM_CPUS) -C $(CCVIEWS_HOME)/$(OUTPATH) $@
	$(RM) -f $(TMP_FILE)
