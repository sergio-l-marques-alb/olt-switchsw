  ...
  else
  {
    ...
    if (s < 0)
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
              "osapimRouteEntryAdd - failed to open socket.\n");
      return L7_FAILURE;
    }
    ...
    */
    ...
    /*
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
    "Attempting to add route IP 0x%x Mask 0x%x Gate 0x%x IF %s\n",
    ...
    if (strchr(device, ':') != NULL)
    {
        if (ioctl(s, SIOCGIFADDR, &ifr) == -1)
        {
            ...
            */
            ...
            /*
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapimRouteEntryAdd: device %s does not exist ... \n",
              device);
            */
            ...
            *(strchr(device, ':')) = '\0';
            ...
            /*
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapimRouteEntryAdd: adding 0x%x to %s instead\n",
              destIp, device);
            */
        }
    }
  ...
  L7_long32 mask, L7_uint32 tos, L7_uint32 flags, L7_uint32 proto)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapimRouteEntryDelete - Unsupported protocol %d\n", proto);
    return L7_FAILURE;
  }
  else
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
              "osapimRouteEntryDelete - failed to open socket.\n");
      return L7_FAILURE;
    }
    ...
    if (strchr(device, ':') != NULL)
    {
        if (ioctl(s, SIOCGIFADDR, &ifr) == -1)
        {
            ...
            */
            ...
            /*
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapimRouteEntryDelete: device %s does not exist ... \n",
              device);
            */
            ...
            *(strchr(device, ':')) = '\0';
            ...
            /*
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapimRouteEntryDelete: deleting 0x%x from %s instead\n",
              destIp, device);
            */
        }
    }
...
static L7_RC_t osapiRawMRouteAdd( L7_uint32 ipAddr, L7_uint32 netmask, L7_uint32 gateway )
{
  ...
  if ((ioctl(sock, SIOCADDRT, &rtEntry) < 0) && (errno != EEXIST))
  {
    ...
    L7_uchar8 gwStr[OSAPI_INET_NTOA_BUF_SIZE];
    osapiInetNtoa(ipAddr, destStr);
    osapiInetNtoa(netmask, maskStr);
    osapiInetNtoa(gateway, gwStr);
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_OSAPI_COMPONENT_ID,
           "Failed to add route to %s %s via %s to the IP stack routing table.",
...
L7_RC_t osapiRawIfAddrGet( L7_uchar8 *ifName, L7_uint32 *ipAddr )
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiNetIPGet: unable to open a socket! sock = %d\n", sock);
    return L7_FAILURE;
  }
                               ...
                               L7_uint32 *bufSize )
{
  ...
  L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
          "osapiNetMbufGetNextBuffer not yet implemented!\n");
...
void *osapiNetMbufGetNextMbuf(void *mbuf)
{
  ...
  L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
          "osapiNetMbufGetNextMbuf not yet implemented!\n");
...
L7_uint32 osapiNetMbufGetFrameLength(void *mbuf)
{
  ...
  L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
          "osapiNetMbufGetFrameLength not yet implemented!\n");
...
void osapiNetMbufFree(void *bufHandle)
{
  ...
  L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
          "osapiNetMbufFree not yet implemented!\n");
...
#if defined(L7_IPV6_PACKAGE) || defined(L7_IPV6_MGMT_PACKAGE)
  {
    ...
    if (SERVICE_PORT_PRESENT) {
        osapiSnprintf(procfs_path, 79,
                      "/proc/sys/net/ipv6/conf/%s%d/ipv6_enable",
                      bspapiServicePortNameGet(),bspapiServicePortUnitGet());
        osapi_proc_set(procfs_path, "1");
        memset(procfs_path, 0, 80);
        osapiSnprintf(procfs_path, 79,
                      "/proc/sys/net/ipv6/conf/%s%d/autoconf",
                      bspapiServicePortNameGet(),bspapiServicePortUnitGet());
                          ...
                          L7_uint32 ipNetMask )
{
  ...
  /*
  L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
  "osapiNetIfConfig: setting addr 0x%x, intf %s\n", ipAddr,
    ifr.ifr_name);
  */
...
L7_RC_t osapiNetlinkDumpOpen(L7_uint32 *sd, struct sockaddr_nl *nladdr)
{
  ...
  *sd = socket(AF_NETLINK,SOCK_RAW,NETLINK_ROUTE);
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiNetlinkDumpOpen: unable to bind socket! errno = %d\n",errno);
    close(*sd);
    return L7_FAILURE;
  }
                             ...
                             L7_RC_t (*callback)(struct nlmsghdr *nm, void *arg))
{
  ...
  while (messages_pending)
  {
    ...
    while (1)
    {
      ...
      {
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
                "osapiNetlinkDumpProcess: error receiving arp table contents!  errno = %d\n",errno);
        return L7_FAILURE;
      }
      ...
      */
      ...
      {
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
                "osapiNetlinkDumpProcess: wrong sequence number, got %d, expected %d!\n",
               rmsg->nlmsg_seq, seq);
        return L7_FAILURE;
      }
...
L7_RC_t osapiNbrFlushCallback(struct nlmsghdr *rmsg, void *arg)
{
  ...
  {
     L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
             "osapiNbrFlushCallback(): error! corrupt datagram length!\n");
     return L7_FAILURE;
  }
  ...
  while (RTA_OK(neigh_attr,remaining_length))
  {
     ...
     case RTA_DST:
         ...
         * multicast addresses. Ignore the multicast addresses. */
       {
         ...
         if(dInfo->addrs)
         {
           ...
           {
             L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
                     "osapiNbrFlushCallback(): sending delete failed for %s\n",addrStr);
             return L7_SUCCESS;
           }
          }
        }
     ...
     case RTA_IIF:
        ...
        if(! dInfo->addrs)
        {
          ...
          {
            L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
                    "osapiNbrFlushCallback(): sending delete failed\n");
            return L7_SUCCESS;
          }
        }
        break;
     default:
        L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
                "osapiNbrFlushCallback(): panic: unknown RTA message in netlink response\n");
        return L7_FAILURE;
     }/*end switch*/
...
void osapiArpFlush(L7_uchar8 *ifName)
{
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiArpFlush: failed to open dump socket\n");
    return;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiArpFlush: failed to send dump request\n");
    close(sd);
    return;
  }
...
L7_RC_t osapiIfIpv6AddrsGetCallback(struct nlmsghdr *rmsg, void *arg)
{
  ...
  {
     L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
             "osapiIfIpv6AddrsGet: error! corrupt datagram length!\n");
     return L7_FAILURE;
  }
...
L7_RC_t osapiIfIpv6AddrsGet(L7_uchar8 *ifName, L7_in6_prefix_t *addrs, L7_uint32 *acount)
{
  ...
  if(0 != ifName)
  {
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
              "osapiIfIpv6AddrsGet: could not open socket for ifreq! errno = %d\n",errno);
      close(sd);
      return L7_FAILURE;
    }
    ...
    {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
              "osapiIfIpv6AddrsGet: could not get interface %s! errno = %d\n",
        ifr.ifr_name, errno);
      close (sd);
      return L7_FAILURE;
    }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiIfIpv6AddrsGet: failed to open dump socket\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiIfIpv6AddrsGet: failed to send dump request\n");
    close(sd);
    return L7_FAILURE;
  }
...
L7_RC_t osapiIfIpv6DefaultRoutersGet( L7_uchar8 *ifName, L7_in6_addr_t *addrs, L7_uint32 *acount)
{
  ...
  if (strcmp(ifName, bspapiServicePortNameGet()) == 0)
    sprintf(ifr.ifr_name,"%s%d", ifName, bspapiServicePortUnitGet());
  else if (strcmp(ifName, L7_DTL_PORT_IF) == 0)
    sprintf(ifr.ifr_name,"%s%d", ifName, 0);
  else osapiStrncpySafe(ifr.ifr_name, ifName, IFNAMSIZ);

  sd = socket(AF_INET,SOCK_DGRAM,0);
  if (sd < 0)
  {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
              "osapiDefaultRoutersGet: could not open socket for ifreq! errno = %d\n",errno);
      close(sd);
      return L7_FAILURE;
  }
  ...
  {
      L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
              "osapiDefaultRoutersGet: could not get interface %s! errno = %d\n",
        ifr.ifr_name, errno);
      close(sd);
      return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiDefaultRoutersGet: failed to open dump socket\n");
    return L7_FAILURE;
  }
  ...
  {
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiDefaultRoutersGet: failed to send dump request\n");
    close(sd);
    return L7_FAILURE;
  }
...
* @end
*************************************************************************/
L7_RC_t osapiMacAddrChange(L7_uchar8 *newMac, L7_uchar8 *intfName, int intfNum)
{
  int    sock;
  struct ifreq ifr;
  L7_short16 flags;
  ...
  memset(&ifr, 0x00, sizeof (ifr));
  sprintf (ifr.ifr_name, "%s%d", intfName, intfNum);
...
* @end
*************************************************************************/
L7_RC_t osapiIfGratArpSend(L7_uchar8 *intfName)
{
  L7_uint32     sock;
  struct arpreq arpr;
  ...
  memset(&arpr, 0x00, sizeof (arpr));
  arpr.arp_pa.sa_family = AF_INET;
  osapiSnprintf(arpr.arp_dev, sizeof(arpr.arp_dev), "%s", intfName);

  if (ioctl(sock, SIOCSGRATARP, &arpr) < 0)
  {
    L7_LOGF(L7_LOG_SEVERITY_NOTICE, L7_OSAPI_COMPONENT_ID,
            "Failed to send gratuitous arp on %s with error %s", intfName, strerror(errno));
  }
...
L7_uint32 osapiPingTimed(L7_char8 *hostName, L7_int32 numPackets, L7_uint32 msWait)
{
  ...
  if (inet_aton(hostName, &(dest.sin_addr)) == 0)
  {
    ...
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiPingTimed - inet_aton error, host = %s\n", hostName);
    return(L7_ERROR);
  ...
  */
                                    ...
                                    L7_DEFAULT_TASK_SLICE)) == L7_ERROR)
  {
    ...
    close (sock);
    L7_LOGF(L7_LOG_SEVERITY_INFO, L7_OSAPI_COMPONENT_ID,
            "osapiPingTimed - osapiTaskCreate error %d\n", errno);
    return(L7_ERROR);
...
L7_RC_t osapiIfIpv6AcceptRASet( L7_uint32 intIfNum, L7_BOOL val)
{
    ...
    osapiSnprintf(procfs_message, 79, "/proc/sys/net/ipv6/conf/%s/accept_ra",
                  ifName);
    osapi_proc_set(procfs_message, (val==L7_TRUE)?"1":"0");
    osapiSnprintf(procfs_message, 79, "/proc/sys/net/ipv6/conf/%s/forwarding",
                  ifName);
    osapi_proc_set(procfs_message, (val==L7_TRUE)?"0":"1");
