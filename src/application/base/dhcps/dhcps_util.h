...
#ifndef L7_NSF_PACKAGE
#define DHCPS_SET_LEASE_CONFIG_DATA_DIRTY        {pDhcpsMapLeaseCfgData->cfgHdr.dataChanged = L7_TRUE;} while(0);
#define DHCPS_SET_LEASE_CONFIG_DATA_DIRTY_LATER  {pDhcpsMapLeaseCfgData->cfgHdr.dataChanged = L7_TRUE;} while(0);
#else
#define DHCPS_SET_LEASE_CONFIG_DATA_DIRTY        {pDhcpsMapLeaseCfgData->cfgHdr.dataChanged = L7_TRUE; dhcpsSaveLeaseCfgNSF(__FILE__, __LINE__, L7_TRUE);} while(0);
#define DHCPS_SET_LEASE_CONFIG_DATA_DIRTY_LATER  {pDhcpsMapLeaseCfgData->cfgHdr.dataChanged = L7_TRUE; dhcpsSaveLeaseCfgNSF(__FILE__, __LINE__, L7_FALSE);} while(0);
...
#define DHCPS_MAP_MSGLVL_CFG    1
#define DHCPS_MAP_MSGLVL_HI     10
