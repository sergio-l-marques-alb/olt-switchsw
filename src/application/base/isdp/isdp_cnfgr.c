...
extern PORTEVENT_MASK_t isdpNimEventMask;
                                     ...
                                     L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  isdpMapTbl      = osapiMalloc(L7_ISDP_COMPONENT_ID, sizeof(L7_uint32) * L7_ISDP_INTF_MAX_COUNT);
  isdpIntfTbl     = osapiMalloc(L7_ISDP_COMPONENT_ID, sizeof(isdpIntfInfoData_t) * L7_ISDP_INTF_MAX_COUNT);
  ...
  memset(isdpMapTbl,    0, sizeof(L7_uint32) * L7_ISDP_INTF_MAX_COUNT);
  memset(isdpIntfTbl,   0, sizeof(isdpIntfInfoData_t) * L7_ISDP_INTF_MAX_COUNT);
                                   ...
                                   L7_CNFGR_ERR_RC_t   *pReason)
{
  ...
  *pReason    = 0;
  ...
  if (nimRegisterIntfChange(L7_ISDP_COMPONENT_ID, isdpIntfChangeCallback,
                            isdpIntfStartupCallback, NIM_STARTUP_PRIO_DEFAULT) != L7_SUCCESS)
  {
    L7_LOGF(L7_LOG_SEVERITY_ALERT, L7_ISDP_COMPONENT_ID,
            "%s: Failed to register interface callbacks with NIM!", __FUNCTION__);
    *pResponse  = 0;
    *pReason    = L7_CNFGR_ERR_RC_FATAL;
    isdpRC     = L7_ERROR;
    return isdpRC;
                                    ...
                                    L7_CNFGR_ERR_RC_t   *pReason )
{
  ...
  *pReason    = 0;
  ...
  /* clear NIM port event mask until ready to receive events */
  memset(&isdpNimEventMask, 0, sizeof(isdpNimEventMask));
