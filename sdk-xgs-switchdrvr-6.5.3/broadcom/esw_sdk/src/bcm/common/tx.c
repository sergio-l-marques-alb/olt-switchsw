...
int _bcm_olp_l2_hdr_get(int unit, int glp, soc_olp_l2_hdr_t *l2hdr)
{
    int rv = BCM_E_NONE;
    uint64 rval;
    uint64 mac_field;
...
_tx_pkt_olp_desc_add(int unit, bcm_pkt_t *pkt, dv_t *dv, int pkt_idx)
{
    ...
    _bcm_olp_l2_hdr_get(unit, sglp, &(opkt.l2_hdr));
