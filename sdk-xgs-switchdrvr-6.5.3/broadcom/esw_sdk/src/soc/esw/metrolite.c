...
const static  ml_port_speeds_t ml_port_speeds_56270_1 = {
              {10000,0,0,2500},{10000,10000,0,10000},{10000,10000,0,10000},
              };
...
const static  ml_port_speeds_t ml_port_speeds_56271_2 = {
              {0,0,0,2500},{0,0,0,0},{10000,0,0,10000},
              };

const static  ml_port_speeds_t ml_port_speeds_56271_3 = {
              {10000,0,0,2500},{0,0,0,0},{10000,10000,0,10000},
              };

const static  ml_port_speeds_t ml_port_speeds_56272_1 = {
              {10000,0,0,2500},{0,0,0,0},{10000,10000,10000,10000},
              };
...
/*1*/	1,		9,		ML_IDLE, ML_IDLE,
/*2*/	2,		10,		ML_IDLE, ML_IDLE,
/*3*/	3,		11,		ML_IDLE, ML_IDLE,
/*4*/	4,		12,		ML_CMIC, ML_LPBK
};

const static soc_port_details_t ml_port_details_56263_2[]={
    {1, 6, 1,GE_PORT,1000},
    {0,0,0,0} /* End */
};
...
soc_error_t soc_metrolite_get_port_block(
...
int _soc_metrolite_misc_init(int unit)
{
    ...
    if ((soc_feature(unit, soc_feature_linkphy_coe) &&
         ...
         my_modid_list[1] = 1;
         my_modid_valid[1] = 1;
         my_modid_port_base_ptr[1] = _BCM_ML_SUBPORT_PP_PORT_INDEX_MIN;
    }
...
/* Enable back pressure status from MMU for lossless mode */
    ...
    /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    for (sub_port = ML_MIN_SUBPORT_INDEX;
         sub_port <= ML_MAX_SUBPORTS;
         sub_port ++) {
...
_soc_metrolite_mmu_init(int unit)
{
    ...
    /* SOC_IF_ERROR_RETURN(_soc_metrolite_perq_flex_counters_init(unit)); */
...
soc_metrolite_pbmp_init(int unit, ml_pbmp_t ml_pbmp) 
{
    ...
    /* SOC_PBMP_CLEAR(*ml_pbmp.pbmp_valid); */
    ...
    while(ml_selected_port_details[loop_index].port_speed != 0) {
        ...
        for (port =  ml_selected_port_details[loop_index].start_port_no;
           ...
           port += ml_selected_port_details[loop_index].port_incr) {
            ...
            if ((ml_selected_port_details[loop_index].port_type & XE_PORT) ||
...
soc_metrolite_subport_init(int unit)
{
    ...
    available_subport = ML_MAX_SUBPORTS;
    prev_port = 0;
    si->port_num_subport[prev_port] = 0;
    si->port_subport_base[prev_port] = ML_MIN_SUBPORT_INDEX;
    ...
    if (SOC_PBMP_NOT_NULL(si->linkphy_allowed_pbm)) {
        ...
        SOC_PBMP_ITER(si->linkphy_allowed_pbm, port) {
            if (port < SOC_MAX_NUM_PORTS) {
                ...
                if (num_subport > ML_MAX_LINKPHY_SUBPORTS_PER_PORT) {
                    num_subport = ML_MAX_LINKPHY_SUBPORTS_PER_PORT;
                }
                ...
                s1_xlp0_index += ML_MAX_LINKPHY_STREAMS_PER_PORT;
