...
#define BCM_AP_L3_ALPM_TABLE_MEM(_u_, _v6_, _mem_)             \
            _mem_ = (_v6_) ? L3_DEFIP_ALPM_IPV6_64m : L3_DEFIP_ALPM_IPV4m

/* Add suport for Extended */
#define BCM_AP_L3_ALPM_ENTRY_BUF(_v6_, _mem_, _buf_, _v4ent_, _v6ent_)  \
...
#ifdef BCM_WARM_BOOT_SUPPORT_SW_DUMP
extern void _bcm_ap_fcoe_sw_dump(int unit);
#endif /* BCM_WARM_BOOT_SUPPORT_SW_DUMP */
