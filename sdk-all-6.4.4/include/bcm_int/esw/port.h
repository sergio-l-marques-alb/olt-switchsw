...
/*
 * Define:
 *     EGR_LPORT_PROFILE table definitions
 * Purpose:
 *     Table indexes for EGR_LPORT Profile Tables.
 */
#define EGR_LPORT_PROFILE_LPORT_TAB         0
#define EGR_LPORT_PROFILE_VLAN_CONTROL_1    1
#define EGR_LPORT_PROFILE_VLAN_CONTROL_2    2
#define EGR_LPORT_PROFILE_VLAN_CONTROL_3    3
#define EGR_LPORT_PROFILE_IPMC_CFG2         4
#define EGR_LPORT_PROFILE_MTU               5
#define EGR_LPORT_PROFILE_PORT_1            6
#define EGR_LPORT_PROFILE_COUNTER_CONTROL   7
#define EGR_LPORT_PROFILE_SHAPING_CONTROL   8
