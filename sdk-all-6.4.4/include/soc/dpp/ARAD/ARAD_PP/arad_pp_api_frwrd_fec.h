...
#define ARAD_PP_FEC_TYPE_MPLS_LSR_EEI_OUTLIF                 SOC_PPC_FEC_TYPE_MPLS_LSR_EEI_OUTLIF
#define ARAD_PP_FEC_TYPE_TUNNELING                           SOC_PPC_FEC_TYPE_TUNNELING
#define ARAD_PP_FEC_TYPE_TUNNELING_EEI_OUTLIF                SOC_PPC_FEC_TYPE_TUNNELING_EEI_OUTLIF
#define ARAD_PP_FEC_TYPE_TUNNELING_EEI_MPLS_COMMAND          SOC_PPC_FEC_TYPE_TUNNELING_EEI_MPLS_COMMAND
