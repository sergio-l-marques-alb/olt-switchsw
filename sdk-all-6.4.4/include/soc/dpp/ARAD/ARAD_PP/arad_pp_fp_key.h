...
#define ARAD_PP_FP_KEY_MAX_NOF_INSTRS_PER_KEY          ARAD_PP_FP_NOF_QUALS_PER_DB_MAX
...
typedef struct
{
    ...
    ARAD_PP_FP_QUAL_TYPE   qual_type; /* qualifier this CE is used for */
...
typedef struct
{
   ...
   *  LSB of the containing key.
   */
  ARAD_PP_FP_KEY_FLD_DESC fields[ARAD_PP_FP_NOF_QUALS_PER_DB_MAX];
...
typedef struct
{
    ...
    ARAD_PP_FP_QUAL_TYPE                qual_type[ARAD_PMF_LOW_LEVEL_NOF_CE_IN_PROG_MAX_ALL_LEVELS]; /* qualifier type */
