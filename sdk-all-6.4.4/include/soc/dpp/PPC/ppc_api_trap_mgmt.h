...
typedef enum
{
   ...
   */
 SOC_PPC_NOF_TRAP_ACTION_PROFILE_OVERWRITES_ARAD = 12
...
typedef struct
{
  ...
  uint8 lb_ext_en;
  /*
   *	PPH Mode. If true, Soc_petra-B. Else, Soc_petra-A.
   */
  uint8 pph_eep_ext;
  /*
   *	Stacking enabled.
...
typedef struct
{
  ...
  */
  ...
  PPH unknown_addr 
  */
  uint32 pph_unknown_addr;

  /*
  PPH pph_fwd_hdr_offset
  */

  uint32 pph_fwd_hdr_offset;
