/* $Id: pb_pp_eg_vlan_edit.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_eg_vlan_edit.h
*
...
#ifndef __SOC_PB_PP_EG_VLAN_EDIT_INCLUDED__
/* { */
#define __SOC_PB_PP_EG_VLAN_EDIT_INCLUDED__
...
typedef enum
{
   ...
   */
  SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_SET = SOC_PB_PP_PROC_DESC_BASE_EG_VLAN_EDIT_FIRST,
  SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_SET_PRINT,
  SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_SET_UNSAFE,
  SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_SET_VERIFY,
  SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_GET,
  SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_GET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_COMMAND_INFO_SET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_COMMAND_INFO_GET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PORT_VLAN_TRANSMIT_OUTER_TAG_SET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PORT_VLAN_TRANSMIT_OUTER_TAG_GET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_PROFILE_INFO_SET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_PROFILE_INFO_GET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_STAG_SET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_STAG_GET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_CTAG_SET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_CTAG_GET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_UNTAGGED_SET_PRINT,
  ...
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_UNTAGGED_GET_PRINT,
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_UNTAGGED_GET_VERIFY,
  SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_UNTAGGED_GET_UNSAFE,
  SOC_PB_PP_EG_VLAN_EDIT_GET_PROCS_PTR,
  SOC_PB_PP_EG_VLAN_EDIT_GET_ERRS_PTR,
  /*
   * } Auto generated. Do not edit previous section.
   */

  SOC_PB_PP_EG_VLAN_EDIT_PCP_DEI_TBL_SET,
  SOC_PB_PP_EG_VLAN_EDIT_PCP_DEI_TBL_GET,

  /*
   * Last element. Do no touch.
   */
  SOC_PB_PP_EG_VLAN_EDIT_PROCEDURE_DESC_LAST
} SOC_PB_PP_EG_VLAN_EDIT_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  SOC_PB_PP_EG_VLAN_EDIT_TRANSMIT_OUTER_TAG_OUT_OF_RANGE_ERR = SOC_PB_PP_ERR_DESC_BASE_EG_VLAN_EDIT_FIRST,
   ...
   * Last element. Do no touch.
   */
  SOC_PB_PP_EG_VLAN_EDIT_ERR_LAST
} SOC_PB_PP_EG_VLAN_EDIT_ERR;
 ...
 *     "soc_pb_pp_eg_vlan_edit_pep_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_eg_vlan_edit_pep_info_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_eg_vlan_edit_pep_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_vlan_edit_command_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_eg_vlan_edit_command_info_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_eg_vlan_edit_command_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_vlan_edit_pcp_profile_info_set_unsafe" API.
 *     Refer to
 *     "soc_pb_pp_eg_vlan_edit_pcp_profile_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_eg_vlan_edit_pcp_profile_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_vlan_edit_pcp_map_stag_set_unsafe" API.
 *     Refer to "soc_pb_pp_eg_vlan_edit_pcp_map_stag_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_eg_vlan_edit_pcp_map_stag_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_vlan_edit_pcp_map_ctag_set_unsafe" API.
 *     Refer to "soc_pb_pp_eg_vlan_edit_pcp_map_ctag_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_eg_vlan_edit_pcp_map_ctag_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_vlan_edit_pcp_map_untagged_set_unsafe" API.
 *     Refer to
 *     "soc_pb_pp_eg_vlan_edit_pcp_map_untagged_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_eg_vlan_edit_pcp_map_untagged_get_unsafe(
...
/* } __SOC_PB_PP_EG_VLAN_EDIT_INCLUDED__*/
#endif
