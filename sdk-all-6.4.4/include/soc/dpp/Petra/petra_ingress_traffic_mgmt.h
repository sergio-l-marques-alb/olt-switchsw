/* $Id: petra_ingress_traffic_mgmt.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/soc_petra/include/soc_petra_ingress_traffic_mgmt.h
*
...
#ifndef __SOC_PETRA_INGRESS_TRAFFIC_MGMT_INCLUDED__
/* { */
#define __SOC_PETRA_INGRESS_TRAFFIC_MGMT_INCLUDED__
...
#define SOC_PETRA_ITM_HUNGRY_TH_MULTIPLIER_OFFSET  4

  /* Maximum ITM-Connection-Class: Value 31   */
#define  SOC_PETRA_ITM_QT_CC_CLS_MAX              31

  /* Maximum ITM-Credit-Class: Value 15 */
#define SOC_PETRA_ITM_IPS_QT_MAX                  (SOC_PETRA_ITM_NOF_QT_NDXS -1)

  /* Maximum ITM-Credit-Class: Value 15  */
#define  SOC_PETRA_ITM_QT_CR_CLS_MAX              (SOC_PETRA_ITM_NOF_CR_DISCNT_CLS_NDXS - 1)

  /*  Maximum ITM-Rate-Class: Value 63 */
#define  SOC_PETRA_ITM_QT_RT_CLS_MAX              63

/* Maximum ITM-WRED exponent maximal value */
#define SOC_PETRA_ITM_WQ_MAX                      31
...
typedef enum
{
  SOC_PETRA_ITM_FWD_ACTION_TYPE_FWD = 0,
  SOC_PETRA_ITM_FWD_ACTION_TYPE_SNOOP = 1,
  SOC_PETRA_ITM_FWD_ACTION_TYPE_INBND_MIRR = 2,
  SOC_PETRA_ITM_FWD_ACTION_TYPE_OUTBND_MIRR = 3,
  SOC_PETRA_ITM_NOF_FWD_ACTION_TYPES = 4
}SOC_PETRA_ITM_FWD_ACTION_TYPE;
...
/*********************************************************************
* NAME:
*     soc_petra_ingress_traffic_mgmt_init
* FUNCTION:
*     Initialization of the Soc_petra blocks configured in this module.
* INPUT:
*  SOC_SAND_IN  int                 unit -
 ...
 *     "soc_petra_itm_ecn_enable_set_unsafe" API.                  
 *     Refer to "soc_petra_itm_ecn_enable_set_unsafe" API for 
 *     details.                                                
*********************************************************************/
uint32  
...
/*********************************************************************
* NAME:
*     soc_petra_itm_dram_buffs_set_unsafe
* TYPE:
*   PROC
* DATE:
*   Apr 21 2008
...
*  SOC_SAND_IN  int                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  SOC_PETRA_ITM_DRAM_BUFFERS_INFO *dram_buffs -
...
*     the SOC_PETRA_ITM_ADMIT_ONE_TEST_TMPLT type consists of 4 Booleans,
...
*   Nov 18 2007
* FUNCTION:
*     Convert the type uint32 to SOC_PETRA_ITM_ADMIT_ONE_TEST_TMPLT
...
/* } __SOC_PETRA_INGRESS_TRAFFIC_MGMT_INCLUDED__*/
#endif
