...
typedef enum bcm_sat_stamp_type_e {
    ...
    bcmSatStampCount = 4            /* Always Last. Not a usable value. */
...
typedef enum bcm_sat_gtf_rate_pattern_mode_e {
    bcmSatGtfRatePatternContinues = 0,  /* Burst only */
    bcmSatGtfRatePatternSimpleBurst = 1, /* Interval only */
    bcmSatGtfRatePatternCombined = 2,   /* Combined mode */
    bcmSatGtfRatePatternsCount = 3      /* Always Last. Not a usable value. */
...
typedef struct bcm_sat_stamp_s {
    ...
    uint32 offset;                      /* Stamp offset in bytes - where to
                                           stamp the counter, beginning from
                                           start of packet */
} bcm_sat_stamp_t;
