...
typedef enum bcm_rx_trap_e {
    ...
    bcmRxTrapInnerMyMacAndIpDisabled = 240, /* Terminated Inner-My-MAC over IP, but
                                           routing is disabled for InRIF */
    bcmRxTrapEgFieldSnoop0 = 241,       /* Egress snoop from Egress Field
                                           Processor profile 0 */
    bcmRxTrapEgFieldSnoop1 = 242,       /* Egress snoop from Egress Field
                                           Processor profile 1 */
    bcmRxTrapEgFieldSnoop2 = 243,       /* Egress snoop from Egress Field
                                           Processor profile 2 */
    bcmRxTrapEgFieldSnoop3 = 244,       /* Egress snoop from Egress Field
                                           Processor profile 3 */
    bcmRxTrapEgFieldSnoop4 = 245,       /* Egress snoop from Egress Field
                                           Processor profile 4 */
    bcmRxTrapEgFieldSnoop5 = 246,       /* Egress snoop from Egress Field
                                           Processor profile 5 */
    bcmRxTrapEgFieldSnoop6 = 247,       /* Egress snoop from Egress Field
                                           Processor profile 6 */
    bcmRxTrapEgFieldSnoop7 = 248,       /* Egress snoop from Egress Field
                                           Processor profile 7 */
    bcmRxTrapEgFieldSnoop8 = 249,       /* Egress snoop from Egress Field
                                           Processor profile 8 */
    bcmRxTrapEgFieldSnoop9 = 250,       /* Egress snoop from Egress Field
                                           Processor profile 9 */
    bcmRxTrapEgFieldSnoop10 = 251,      /* Egress snoop from Egress Field
                                           Processor profile 10 */
    bcmRxTrapEgFieldSnoop11 = 252,      /* Egress snoop from Egress Field
                                           Processor profile 11 */
    bcmRxTrapEgFieldSnoop12 = 253,      /* Egress snoop from Egress Field
                                           Processor profile 12 */
    bcmRxTrapEgFieldSnoop13 = 254,      /* Egress snoop from Egress Field
                                           Processor profile 13 */
    bcmRxTrapEgFieldSnoop14 = 255,      /* Egress snoop from Egress Field
                                           Processor profile 14 */
    bcmRxTrapEgFieldSnoop15 = 256,      /* Egress snoop from Egress Field
                                           Processor profile 15 */
    bcmRxTrapOutVPortDiscard = 257,     /* Out-VPort discarding any traffic */
    bcmRxTrapEgStpStateFail = 258,      /* ess STP state failure */
    bcmRxTrapEgProtectionPathUnexpected = 259, /* Unexpected Traffic on a Protecting
                                           Path */
    ...
    bcmRxTrapCount = 266                /* Must be last: enum count size. */
} bcm_rx_trap_t;
...
typedef enum bcm_rx_trap_forwarding_header_e {
    ...
    bcmRxTrapForwardingHeaderCount = 6  /* Always Last. Not a usable value. */
