...
/*!
\brief
This array returns the string version of the enum #e2s_tefmod_regacc_type_t when indexed
by the enum var.
...
typedef enum {
  ...
  #if 0 
    TEFMOD_SERDES_DIAG          = 0x80000000UL ,  /*!< PMD Triage */
    TEFMOD_DIAG_ALL             = 0xffffffffUL ,  /*!< Everything but eye margin                */
  #else
...
#define CNT_tefmod_diag_type_t 18
...
/*!
\brief
This array returns the string of #tefmod_os_mode_type when indexed by the enum.

*/
extern char* e2s_tefmod_os_mode_type [CNT_tefmod_os_mode_type];
/*!
\brief
This array returns the over sampling value of #tefmod_os_mode_type when indexed by
