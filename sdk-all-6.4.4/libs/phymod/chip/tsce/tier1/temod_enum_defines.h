...
temod_an_type enumerates different types of autoneg modes in the PHY.

*/

typedef enum {
  TEMOD_CL73                 = 0   ,  /*!< PHY autoneg CL73 enable */
  TEMOD_CL37                       ,  /*!< PHY autoneg CL37 enable */
  TEMOD_CL73_BAM                   ,  /*!< PHY autoneg CL73 enable with Brcm Aneg Mode */
  TEMOD_CL37_BAM                   ,  /*!< PHY autoneg CL37 enable with  Brcm Aneg Mode */
  TEMOD_CL37_SGMII                 ,  /*!< PHY autoneg for SGMII */
  TEMOD_HPAM                       ,  /*!< PHY autoneg for HP aneg */
  TEMOD_AN_TYPE_ILLEGAL              /*!< Illegal value. programmatic boundary. */
} temod_an_type;

/*! \def CNT_temod_an_type Types of enum temod_an_type */
#define CNT_temod_an_type 7
...
*/
extern char* e2s_temod_an_type [CNT_temod_an_type];
