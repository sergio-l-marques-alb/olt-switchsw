/*
 * $Id: sbZfFe2000PmPolicerRawFormat.c,v 1.4 Broadcom SDK $
...
sbZfFe2000PmPolicerRawFormat_Pack(sbZfFe2000PmPolicerRawFormat_t *pFrom,
  ...
  (pToData)[0] |= (COMPILER_64_LO((pFrom)->uMeterState)) & 0xFF;
  (pToData)[1] |= (COMPILER_64_LO((pFrom)->uMeterState) >> 8) &0xFF;
  (pToData)[2] |= (COMPILER_64_LO((pFrom)->uMeterState) >> 16) &0xFF;
  (pToData)[3] |= (COMPILER_64_LO((pFrom)->uMeterState) >> 24) &0xFF;
  (pToData)[4] |= (COMPILER_64_HI((pFrom)->uMeterState)) &0xFF;
  (pToData)[5] |= (COMPILER_64_HI((pFrom)->uMeterState) >> 8) &0xFF;
  (pToData)[6] |= (COMPILER_64_HI((pFrom)->uMeterState) >> 16) & 0x1f;
...
sbZfFe2000PmPolicerRawFormat_Unpack(sbZfFe2000PmPolicerRawFormat_t *pToStruct,
  ...
  {
    volatile uint64 *tmp0 = &(pToStruct)->uMeterState;
...
sbZfFe2000PmPolicerRawFormat_InitInstance(sbZfFe2000PmPolicerRawFormat_t *pFrame) {
  ...
  COMPILER_64_ZERO(pFrame->uMeterState);
