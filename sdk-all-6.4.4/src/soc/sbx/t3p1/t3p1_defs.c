...
int soc_sbx_t3p1_entry_generic_fast_word_set(int unit,
                ...
                uint32 *vs)
{
    int s, i, posbase, shift, wordoff, words, offset COMPILER_ATTRIBUTE((unused)), addrshift COMPILER_ATTRIBUTE((unused)), mwidth,
...
int soc_sbx_t3p1_entry_generic_fast_small_set(int unit,
                ...
                uint32 *vs)
{
    int i, s, mwidth, entriesperword, offset COMPILER_ATTRIBUTE((unused)), fieldshift, entryshift, shift;
