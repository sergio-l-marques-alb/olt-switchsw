...
sbZfC2PmProfileMemoryEntry_Print(sbZfC2PmProfileMemoryEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: type2=0x%01x"), (unsigned int)  pFromStruct->m_uType2));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: rfcmode=0x%01x"), (unsigned int)  pFromStruct->m_uRfcMode));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: excessbucketnodecrement=0x%01x"), (unsigned int)  pFromStruct->m_uExcessBucketNoDecrement));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: excessinformationrate=0x%05x"), (unsigned int)  pFromStruct->m_uExcessInformationRate));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: excessburstsize=0x%03x"), (unsigned int)  pFromStruct->m_uExcessBurstSize));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: committedbucketnodecrement=0x%01x"), (unsigned int)  pFromStruct->m_uCommittedBucketNoDecrement));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: committedinformationrate=0x%05x"), (unsigned int)  pFromStruct->m_uCommittedInformationRate));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileMemoryEntry:: committedburstsize=0x%03x"), (unsigned int)  pFromStruct->m_uCommittedBurstSize));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2PmProfileMemoryEntry_SPrint(sbZfC2PmProfileMemoryEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
