  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_event_fifo_read,(unit, rmeb_db_ndx, event_id, valid, event_data));
  ...
  )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_lm_dm_remove,(unit, endpoint_id,is_lm,exists_piggy_back_down, num_removed , removed_index));
