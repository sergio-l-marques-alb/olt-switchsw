/* $Id: pb_pp_api_eg_ac.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_eg_ac.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(ac_info);

  res = soc_pb_pp_eg_ac_info_set_verify(
          unit,
          out_ac_ndx,
          ac_info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_info_set()", out_ac_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(ac_info);

  res = soc_pb_pp_eg_ac_info_get_verify(
          unit,
          out_ac_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_info_get()", out_ac_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_MP_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_pp_eg_ac_mp_info_set_verify(
          unit,
          out_ac_ndx,
          info
        );
  ...
  res = soc_pb_pp_eg_ac_mp_info_set_unsafe(
          unit,
          out_ac_ndx,
          info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_mp_info_set()", out_ac_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_MP_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_pp_eg_ac_mp_info_get_verify(
          unit,
          out_ac_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_ac_mp_info_get_unsafe(
          unit,
          out_ac_ndx,
          info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_mp_info_get()", out_ac_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_PORT_VSI_INFO_ADD);
  ...
  res = soc_pb_pp_eg_ac_port_vsi_info_add_verify(
          unit,
          out_ac_ndx,
          vbp_key,
          ac_info
  ...
  res = soc_pb_pp_eg_ac_port_vsi_info_add_unsafe(
          unit,
          out_ac_ndx,
          vbp_key,
          ac_info,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_port_vsi_info_add()", out_ac_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_PORT_VSI_INFO_REMOVE);
  ...
  res = soc_pb_pp_eg_ac_port_vsi_info_remove_verify(
          unit,
          vbp_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_ac_port_vsi_info_remove_unsafe(
          unit,
          vbp_key,
          out_ac
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_port_vsi_info_remove()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_PORT_VSI_INFO_GET);
  ...
  res = soc_pb_pp_eg_ac_port_vsi_info_get_verify(
          unit,
          vbp_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_ac_port_vsi_info_get_unsafe(
          unit,
          vbp_key,
          out_ac,
          ac_info,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_port_vsi_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_PORT_CVID_INFO_ADD);
  ...
  res = soc_pb_pp_eg_ac_port_cvid_info_add_verify(
          unit,
          out_ac_ndx,
          cep_key,
          ac_info
  ...
  res = soc_pb_pp_eg_ac_port_cvid_info_add_unsafe(
          unit,
          out_ac_ndx,
          cep_key,
          ac_info,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_port_cvid_info_add()", out_ac_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_PORT_CVID_INFO_REMOVE);
  ...
  res = soc_pb_pp_eg_ac_port_cvid_info_remove_verify(
          unit,
          cep_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_ac_port_cvid_info_remove_unsafe(
          unit,
          cep_key,
          out_ac
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_port_cvid_info_remove()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_AC_PORT_CVID_INFO_GET);
  ...
  res = soc_pb_pp_eg_ac_port_cvid_info_get_verify(
          unit,
          cep_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_ac_port_cvid_info_get_unsafe(
          unit,
          cep_key,
          out_ac,
          ac_info,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_ac_port_cvid_info_get()", 0, 0);
}
