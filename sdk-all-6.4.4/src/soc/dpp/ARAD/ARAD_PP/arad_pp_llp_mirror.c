  ...
  )
{
  ...
  *success = SOC_SAND_SUCCESS;
  ...
  ll_mirror_profile_tbl_offset =
    ARAD_TBL_IHP_LL_MIRROR_PROFILE_KEY_ENTRY_OFFSET(internal_vid_ndx, pp_port);
  ...
  )
{
  ...
  if (ref_count > 0)
  {
    ...
    if (ll_mirror_profile_tbl_data.ll_mirror_profile != ARAD_PP_LLP_MIRROR_PROFILE_INVALID)
    {
      ...
      ll_mirror_profile_tbl_offset =
        ARAD_TBL_IHP_LL_MIRROR_PROFILE_KEY_ENTRY_OFFSET(ARAD_PP_LLP_MIRROR_TAGGED_NDX, pp_port);
  ...
  )
{
  ...
  /* Untagged */
  ll_mirror_profile_tbl_offset =
    ARAD_TBL_IHP_LL_MIRROR_PROFILE_KEY_ENTRY_OFFSET(ARAD_PP_LLP_MIRROR_UNTAGGED_NDX, pp_port);
