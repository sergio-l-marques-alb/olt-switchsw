...
{    
    ...
    rv = soc_dcmn_drv_fabric_pipe_map_initalize_valid_configurations(unit, SOC_DPP_CONFIG(unit)->arad->init.fabric.fabric_tdm_priority_min, fabric_pipe_map_valid_config);
    ...
    if (nof_pipes == 1)
    {
        ...
        for (i = 0; i < SOC_DCMN_FABRIC_PIPE_MAX_NUM_OF_PRIORITIES ; ++i)
        {
            ...
            SOC_DPP_FABRIC_PIPES_CONFIG(unit).mapping_type = soc_dcmn_drv_config_single_pipe;
        }
        SOC_EXIT;
    }
