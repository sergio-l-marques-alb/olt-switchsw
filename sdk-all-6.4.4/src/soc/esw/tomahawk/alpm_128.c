...
soc_th_alpm_lpm_delete(int l1,void*key_data);typedef struct l46{int l47;int
l48;int l49;int next;int l50;int l51;}l52,*l53;static l53 l54[
SOC_MAX_NUM_DEVICES];typedef struct l55{soc_field_info_t*l56;soc_field_info_t
*l57;soc_field_info_t*l58;soc_field_info_t*l59;soc_field_info_t*l60;
...
soc_field_info_t*l100;}l101,*l102;static l102 l103[SOC_MAX_NUM_DEVICES];
typedef struct l104{int unit;int l105;int l106;uint16*l107;uint16*l108;}l109;
typedef uint32 l110[9];typedef int(*l111)(l110 l112,l110 l113);static l109*
l114[SOC_MAX_NUM_DEVICES];static void l115(int l1,void*l10,int index,l110 l116
);static uint16 l117(uint8*l118,int l119);static int l120(int unit,int l105,
int l106,l109**l121);static int l122(l109*l123);static int l124(l109*l125,
l111 l126,l110 entry,int l127,uint16*l128);static int l129(l109*l125,l111 l126
,l110 entry,int l127,uint16 l130,uint16 l39);static int l131(l109*l125,l111
l126,l110 entry,int l127,uint16 l132);static int l133(int l1,const void*entry
,int*l127){int l134,l135;int l136[4] = {IP_ADDR_MASK0_LWRf,IP_ADDR_MASK1_LWRf
,IP_ADDR_MASK0_UPRf,IP_ADDR_MASK1_UPRf};uint32 l137;l137 = 
...
l149 == 0){if(soc_th_alpm_mode_get(l1)){return SOC_E_PARAM;}}
...
l6 = 2;}if(l149!= SOC_L3_VRF_OVERRIDE){sal_memset(&l8,0,sizeof(
defip_aux_scratch_entry_t));SOC_IF_ERROR_RETURN(l4(l1,key_data,l28,l6,0,&l8))
;SOC_ALPM_LPM_LOCK(l1);l135 = _soc_th_alpm_128_find(l1,key_data,l17,l152,&
tcam_index,&bktid,&index,TRUE);SOC_ALPM_LPM_UNLOCK(l1);SOC_IF_ERROR_RETURN(
l135);soc_mem_field32_set(l1,l17,alpm_data,SUB_BKT_PTRf,ALPM_BKT_SIDX(bktid))
;SOC_IF_ERROR_RETURN(soc_mem_write(l1,l17,MEM_BLOCK_ANY,ALPM_ENT_INDEX(l128),
alpm_data));if(SOC_URPF_STATUS_GET(l1)){soc_mem_field32_set(l1,l17,
alpm_sip_data,SUB_BKT_PTRf,ALPM_BKT_SIDX(bktid));SOC_IF_ERROR_RETURN(
soc_mem_write(l1,l17,MEM_BLOCK_ANY,_soc_th_alpm_rpf_entry(l1,ALPM_ENT_INDEX(
l128)),alpm_sip_data));}l141 = soc_mem_field32_get(l1,L3_DEFIP_AUX_SCRATCHm,&
l8,IP_LENGTHf);soc_mem_field32_set(l1,L3_DEFIP_AUX_SCRATCHm,&l8,REPLACE_LENf,
l141);SOC_IF_ERROR_RETURN(_soc_th_alpm_aux_op(l1,DELETE_PROPAGATE,&l8,TRUE,&
l145,&tcam_index,&bktid));if(SOC_URPF_STATUS_GET(l1)){l141 = 
soc_mem_field32_get(l1,L3_DEFIP_AUX_SCRATCHm,&l8,DB_TYPEf);l141+= 1;
soc_mem_field32_set(l1,L3_DEFIP_AUX_SCRATCHm,&l8,DB_TYPEf,l141);
SOC_IF_ERROR_RETURN(_soc_th_alpm_aux_op(l1,DELETE_PROPAGATE,&l8,TRUE,&l145,&
tcam_index,&bktid));}}return l135;}static int l153(int l1,int l37,int l35){
int l135,l141,l154,l155;defip_aux_table_entry_t l156,l157;l154 = 
SOC_ALPM_128_ADDR_LWR(l37);l155 = SOC_ALPM_128_ADDR_UPR(l37);l135 = 
soc_mem_read(l1,L3_DEFIP_AUX_TABLEm,MEM_BLOCK_ANY,l154,&l156);
SOC_IF_ERROR_RETURN(l135);l135 = soc_mem_read(l1,L3_DEFIP_AUX_TABLEm,
MEM_BLOCK_ANY,l155,&l157);SOC_IF_ERROR_RETURN(l135);soc_mem_field32_set(l1,
L3_DEFIP_AUX_TABLEm,&l156,BPM_LENGTH0f,l35);soc_mem_field32_set(l1,
L3_DEFIP_AUX_TABLEm,&l156,BPM_LENGTH1f,l35);soc_mem_field32_set(l1,
L3_DEFIP_AUX_TABLEm,&l157,BPM_LENGTH0f,l35);soc_mem_field32_set(l1,
L3_DEFIP_AUX_TABLEm,&l157,BPM_LENGTH1f,l35);l141 = soc_mem_field32_get(l1,
L3_DEFIP_AUX_TABLEm,&l156,DB_TYPE0f);l135 = soc_mem_write(l1,
...
SOC_IF_ERROR_RETURN(l135);if(SOC_URPF_STATUS_GET(l1)){l141++;
...
){sal_free(l130);}if(l38!= NULL){sal_free(l38);}return l135;}void l189(int l1
,defip_pair_128_entry_t*l190,void*key_data,int tcam_index,alpm_pivot_t*
...
l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,"_soc_alpm_insert: Failed to"
"read prefix ""0x%08x 0x%08x 0x%08x 0x%08x for move\n"),l203.prefix[l134]->
key[1],l203.prefix[l134]->key[2],l203.prefix[l134]->key[3],l203.prefix[l134]
->key[4]));(void)_soc_th_alpm_rollback_bkt_move(l1,l30->key_data,l17,l202,l30
->pivot_pyld,&l203,l39,l44);sal_free(l130);return l135;}if(
SOC_URPF_STATUS_GET(l1)){l135 = soc_mem_read(l1,l17,MEM_BLOCK_ANY,
_soc_th_alpm_rpf_entry(l1,l127->index),l180);if(SOC_FAILURE(l135)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"_soc_alpm_insert: Failed to"
"read rpf prefix ""0x%08x 0x%08x 0x%08x 0x%08x for move\n"),l203.prefix[l134]
->key[1],l203.prefix[l134]->key[2],l203.prefix[l134]->key[3],l203.prefix[l134
]->key[4]));(void)_soc_th_alpm_rollback_bkt_move(l1,l30->key_data,l17,l202,
l30->pivot_pyld,&l203,l39,l44);sal_free(l130);return l135;}}
soc_mem_field32_set(l1,l17,l179,SUB_BKT_PTRf,ALPM_BKT_SIDX(l30->bktid));
soc_mem_field32_set(l1,l17,l180,SUB_BKT_PTRf,ALPM_BKT_SIDX(l30->bktid));l135 = 
_soc_th_alpm_insert_in_bkt(l1,l17,l30->bktid,l150,l179,l10,&l128,l28);if(
SOC_SUCCESS(l135)){if(SOC_URPF_STATUS_GET(l1)){l135 = soc_mem_write(l1,l17,
MEM_BLOCK_ANY,_soc_th_alpm_rpf_entry(l1,l128),l180);}l206++;l207++;}}else{
...
l177;}}}if(l135 == SOC_E_FULL){if(PIVOT_BUCKET_COUNT(ALPM_TCAM_PIVOT(l1,
tcam_index))<= 3){int l212;l135 = soc_th_alpm_bs_alloc(l1,&l212,l22,l28);
SOC_IF_ERROR_RETURN(l135);l135 = _soc_th_alpm_128_move_trie(l1,l28,bktid,l212
);SOC_IF_ERROR_RETURN(l135);bktid = l212;soc_mem_field32_set(l1,l17,alpm_data
,SUB_BKT_PTRf,ALPM_BKT_SIDX(bktid));l135 = _soc_th_alpm_insert_in_bkt(l1,l17,
bktid,l150,alpm_data,l10,&l128,l28);if(l135 == SOC_E_NONE){*l11 = l128;if(
SOC_URPF_STATUS_GET(l1)){soc_mem_field32_set(l1,l17,alpm_sip_data,
SUB_BKT_PTRf,ALPM_BKT_SIDX(bktid));l177 = soc_mem_write(l1,l17,MEM_BLOCK_ANY,
_soc_th_alpm_rpf_entry(l1,l128),alpm_sip_data);if(SOC_FAILURE(l177)){return
l177;}}}}else{l209 = 1;}}pivot_pyld = ALPM_TCAM_PIVOT(l1,tcam_index);trie = 
...
}bktid = l30.bktid;tcam_index = PIVOT_TCAM_INDEX(l30.pivot_pyld);}else{
soc_th_alpm_bu_upd(l1,bktid,tcam_index,l22,l28,1);}VRF_TRIE_ROUTES_INC(l1,l22
,l28);if(l19){sal_free(l211);}SOC_IF_ERROR_RETURN(_soc_th_alpm_aux_op(l1,
...
if(SOC_URPF_STATUS_GET(l1)){l33 = soc_mem_field32_get(l1,
L3_DEFIP_AUX_SCRATCHm,&l8,DB_TYPEf);l33+= 1;soc_mem_field32_set(l1,
L3_DEFIP_AUX_SCRATCHm,&l8,DB_TYPEf,l33);SOC_IF_ERROR_RETURN(
_soc_th_alpm_aux_op(l1,DELETE_PROPAGATE,&l8,TRUE,&l145,&tcam_index,&bktid));
SOC_IF_ERROR_RETURN(_soc_th_alpm_aux_op(l1,INSERT_PROPAGATE,&l8,FALSE,&l145,&
tcam_index,&bktid));}PIVOT_BUCKET_ENT_CNT_UPDATE(l202);return l135;}static int
l24(int unit,uint32*key,int len,int l22,int l5,defip_pair_128_entry_t*
lpm_entry,int l25,int l26){uint32 l141;if(l26){sal_memset(lpm_entry,0,sizeof(
...
return(SOC_E_NONE);}static int l213(int l1,void*key_data,int bktid,int
tcam_index,int l128){alpm_pivot_t*pivot_pyld;defip_alpm_ipv6_128_entry_t l181
,l214,l182;defip_aux_scratch_entry_t l8;uint32 l10[SOC_MAX_MEM_FIELD_WORDS];
soc_mem_t l17;void*l179,*l215,*l180 = NULL;int l149;int l135 = SOC_E_NONE,
l177 = SOC_E_NONE;uint32 l216[5],prefix[5];int l28,l22;uint32 l33;int l217;
uint32 l6,l150;int l145,l19 = 0;trie_t*trie,*l31;uint32 l218;
defip_pair_128_entry_t lpm_entry,*l219;payload_t*l210 = NULL,*l220 = NULL,*
...
,&l149,&l22));if(l149!= SOC_L3_VRF_OVERRIDE){soc_th_alpm_bank_db_type_get(l1,
l22,&l150,&l6);l135 = _alpm_128_prefix_create(l1,key_data,prefix,&l33,&l19);
if(SOC_FAILURE(l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"_soc_alpm_128_delete: prefix create failed\n")));return l135;}if(!
soc_th_alpm_mode_get(l1)){if(l149!= SOC_L3_VRF_GLOBAL){if(VRF_TRIE_ROUTES_CNT
(l1,l22,l28)>1){if(l19){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"VRF %d: Cannot v6-128 delete ""default route if other routes are present "
"in this mode"),l22));return SOC_E_PARAM;}}}l6 = 2;}l17 = 
L3_DEFIP_ALPM_IPV6_128m;l179 = ((uint32*)&(l181));SOC_ALPM_LPM_LOCK(l1);if(
bktid == 0){l135 = _soc_th_alpm_128_find(l1,key_data,l17,l179,&tcam_index,&
bktid,&l128,TRUE);}else{l135 = l14(l1,key_data,l179,0,l17,0,0,bktid);}
sal_memcpy(&l214,l179,sizeof(l214));l215 = &l214;if(SOC_FAILURE(l135)){
SOC_ALPM_LPM_UNLOCK(l1);LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"_soc_alpm_128_delete: Unable to find ""prefix for delete\n")));return l135;}
l217 = bktid;pivot_pyld = ALPM_TCAM_PIVOT(l1,tcam_index);trie = 
...
,l33,&l191);l220 = (payload_t*)l191;if(SOC_FAILURE(l135)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"_soc_th_alpm_128_delete: Prefix not present "
"in pfx trie: 0x%08x 0x%08x 0x%08x 0x%08x\n"),prefix[1],prefix[2],prefix[3],
prefix[4]));goto l221;}l147 = NULL;l135 = trie_find_lpm(l31,prefix,l33,&l147)
;l198 = (payload_t*)l147;if(SOC_SUCCESS(l135)){payload_t*l222 = (payload_t*)(
l198->bkt_ptr);if(l222!= NULL){l218 = l222->len;}else{l218 = 0;}}else{
LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"_soc_th_alpm_128_delete: Could not find"
" replacement bpm for prefix: 0x%08x 0x%08x ""0x%08x 0x%08x\n"),prefix[1],
prefix[2],prefix[3],prefix[4]));goto l223;}sal_memcpy(l216,prefix,sizeof(
prefix));l138((l216),(l33),(l28));l135 = l24(l1,l216,l218,l22,l28,&lpm_entry,
...
l216,l33,l22,l28,&lpm_entry,0,0);if(SOC_URPF_STATUS_GET(l1)){if(SOC_SUCCESS(
l135)){l180 = ((uint32*)&(l182));l177 = soc_mem_read(l1,l17,MEM_BLOCK_ANY,
_soc_th_alpm_rpf_entry(l1,ALPM_ENT_INDEX(l128)),l180);}}if((l218 == 0)&&
SOC_FAILURE(l177)){l219 = VRF_TRIE_DEFAULT_ROUTE_IPV6_128(l1,l22);sal_memcpy(
&lpm_entry,l219,sizeof(lpm_entry));l135 = l24(l1,prefix,l218,l22,l28,&
...
prefix[2],prefix[3],prefix[4]));goto l223;}l219 = &lpm_entry;}else{l147 = 
NULL;l135 = trie_find_lpm(l31,prefix,l33,&l147);l198 = (payload_t*)l147;if(
SOC_FAILURE(l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"_soc_th_alpm_128_delete: Could not find "
"default route in the trie for vrf %d\n"),l22));goto l221;}l198->bkt_ptr = 0;
l218 = 0;l219 = VRF_TRIE_DEFAULT_ROUTE_IPV6_128(l1,l22);}l135 = l4(l1,l219,
l28,l6,l218,&l8);if(SOC_FAILURE(l135)){goto l223;}l135 = _soc_th_alpm_aux_op(
l1,DELETE_PROPAGATE,&l8,TRUE,&l145,&tcam_index,&bktid);if(SOC_FAILURE(l135)){
goto l223;}if(SOC_URPF_STATUS_GET(l1)){uint32 l141;if(l180!= NULL){l141 = 
...
(l1,DELETE_PROPAGATE,&l8,TRUE,&l145,&tcam_index,&bktid);}if(SOC_FAILURE(l135)
){goto l223;}}sal_free(l210);if(!l19){sal_free(l220);}
PIVOT_BUCKET_ENT_CNT_UPDATE(pivot_pyld);if((pivot_pyld->len!= 0)&&(trie->trie
== NULL)){uint32 l224[5];sal_memcpy(l224,pivot_pyld->key,sizeof(l224));l138((
l224),(pivot_pyld->len),(l28));l24(l1,l224,pivot_pyld->len,l22,l28,&lpm_entry
...
_soc_th_alpm_delete_in_bkt(l1,l17,l217,l150,l215,l10,&l128,l28);if(
SOC_FAILURE(l135)){SOC_ALPM_LPM_UNLOCK(l1);return l135;}if(
SOC_URPF_STATUS_GET(l1)){l135 = soc_mem_alpm_delete(l1,l17,
SOC_TH_ALPM_RPF_BKT_IDX(l1,ALPM_BKT_IDX(l217)),MEM_BLOCK_ALL,l150,l215,l10,&
...
SOC_TH_ALPM_BKT_IDX_TO_ENTRY(l1,ALPM_BKT_IDX(l217)),INVALIDm);if(
SOC_TH_ALPM_SCALE_CHECK(l1,l28)){int l225 = ALPM_BKT_IDX(l217)+1;
_soc_tomahawk_alpm_bkt_view_set(l1,SOC_TH_ALPM_BKT_IDX_TO_ENTRY(l1,l225),
INVALIDm);}}}VRF_TRIE_ROUTES_DEC(l1,l22,l28);if(VRF_TRIE_ROUTES_CNT(l1,l22,
l28) == 0){l135 = l27(l1,l22,l28);}SOC_ALPM_LPM_UNLOCK(l1);return l135;l223:
l177 = trie_insert(l31,prefix,NULL,l33,(trie_node_t*)l220);if(SOC_FAILURE(
...
prefix[3],prefix[4]));}l221:l177 = trie_insert(trie,prefix,NULL,l33,(
...
static int l226(int l1,int l22,int l28){defip_pair_128_entry_t*lpm_entry,l227
;int l228 = 0;int index;int l135 = SOC_E_NONE;uint32 key[5] = {0,0,0,0,0};
uint32 l33;alpm_bucket_handle_t*l201;alpm_pivot_t*pivot_pyld;payload_t*l220;
trie_t*l229;trie_t*l230 = NULL;trie_init(_MAX_KEY_LEN_144_,&
VRF_PIVOT_TRIE_IPV6_128(l1,l22));l230 = VRF_PIVOT_TRIE_IPV6_128(l1,l22);
trie_init(_MAX_KEY_LEN_144_,&VRF_PREFIX_TRIE_IPV6_128(l1,l22));l229 = 
...
DEFAULT_MISSf,1);}l135 = soc_th_alpm_bs_alloc(l1,&l228,l22,l28);
soc_L3_DEFIP_PAIR_128m_field32_set(l1,lpm_entry,ALG_BKT_PTRf,ALPM_BKT_IDX(
l228));soc_L3_DEFIP_PAIR_128m_field32_set(l1,lpm_entry,ALG_SUB_BKT_PTRf,
ALPM_BKT_SIDX(l228));sal_memcpy(&l227,lpm_entry,sizeof(l227));l135 = l2(l1,&
l227,&index);l201 = sal_alloc(sizeof(alpm_bucket_handle_t),
...
)));sal_free(l201);return SOC_E_MEMORY;}l220 = sal_alloc(sizeof(payload_t),
"Payload for pfx trie key");if(l220 == NULL){LOG_ERROR(BSL_LS_SOC_ALPM,(
BSL_META_U(l1,"soc_th_alpm_128_vrf_add: Unable to allocate memory "
"for pfx trie node \n")));sal_free(l201);sal_free(pivot_pyld);return
SOC_E_MEMORY;}sal_memset(pivot_pyld,0,sizeof(*pivot_pyld));sal_memset(l220,0,
sizeof(*l220));l33 = 0;PIVOT_BUCKET_HANDLE(pivot_pyld) = l201;trie_init(
_MAX_KEY_LEN_144_,&PIVOT_BUCKET_TRIE(pivot_pyld));PIVOT_BUCKET_INDEX(
pivot_pyld) = l228;PIVOT_BUCKET_VRF(pivot_pyld) = l22;PIVOT_BUCKET_IPV6(
pivot_pyld) = l28;PIVOT_BUCKET_DEF(pivot_pyld) = TRUE;pivot_pyld->key[0] = 
l220->key[0] = key[0];pivot_pyld->key[1] = l220->key[1] = key[1];pivot_pyld->
key[2] = l220->key[2] = key[2];pivot_pyld->key[3] = l220->key[3] = key[3];
pivot_pyld->key[4] = l220->key[4] = key[4];pivot_pyld->len = l220->len = l33;
l135 = trie_insert(l229,key,NULL,l33,&(l220->node));if(SOC_FAILURE(l135)){
sal_free(l220);sal_free(pivot_pyld);sal_free(l201);return l135;}l135 = 
trie_insert(l230,key,NULL,l33,(trie_node_t*)pivot_pyld);if(SOC_FAILURE(l135))
{trie_node_t*l191 = NULL;(void)trie_delete(l229,key,l33,&l191);sal_free(l220)
...
int l28){defip_pair_128_entry_t*lpm_entry;int l231;int l135 = SOC_E_NONE;
uint32 key[2] = {0,0},l139[SOC_MAX_MEM_FIELD_WORDS];payload_t*l210;
alpm_pivot_t*l232;trie_node_t*l191;trie_t*l229;trie_t*l230 = NULL;soc_mem_t
...
l1,lpm_entry,(void*)l139,&l231);if(SOC_FAILURE(l135)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"soc_th_alpm_vrf_delete: unable to get internal"" pivot idx for vrf %d/%d\n")
,l22,l28));l231 = -1;}l231 = soc_th_alpm_physical_idx(l1,L3_DEFIP_PAIR_128m,
l231,l28);l232 = ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR(l231)<<1);l135 = 
...
VRF_TRIE_DEFAULT_ROUTE_IPV6_128(l1,l22) = NULL;l229 = 
VRF_PREFIX_TRIE_IPV6_128(l1,l22);VRF_PREFIX_TRIE_IPV6_128(l1,l22) = NULL;
VRF_TRIE_INIT_DONE(l1,l22,l28,0);l135 = trie_delete(l229,key,0,&l191);l210 = 
...
sal_free(l210);(void)trie_destroy(l229);l230 = VRF_PIVOT_TRIE_IPV6_128(l1,l22
);VRF_PIVOT_TRIE_IPV6_128(l1,l22) = NULL;l191 = NULL;l135 = trie_delete(l230,
key,0,&l191);if(SOC_FAILURE(l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"Unable to delete internal pivot node for vrf"" %d/%d\n"),l22,l28));}(void)
trie_destroy(l230);(void)trie_destroy(PIVOT_BUCKET_TRIE(l232));sal_free(
PIVOT_BUCKET_HANDLE(l232));sal_free(l232);return l135;}int
soc_th_alpm_128_insert(int l1,void*l3,uint32 l18,int l233,int l234){
defip_alpm_ipv6_128_entry_t l181,l182;soc_mem_t l17;void*l179,*l215;int l149,
...
l215 = ((uint32*)&(l182));if(l233!= -1){l20 = ALPM_BKTID(ALPM_BKT_IDX(
SOC_TH_ALPM_BKT_ENTRY_TO_IDX(l1,l233)),(l233>>ALPM_ENT_INDEX_BITS));}
SOC_IF_ERROR_RETURN(l14(l1,l3,l179,l215,l17,l18,&l19,l20));
...
index);if(SOC_SUCCESS(l135)){VRF_TRIE_ROUTES_INC(l1,MAX_VRF_ID,l5);
VRF_PIVOT_REF_INC(l1,MAX_VRF_ID,l5);}else if(l135 == SOC_E_FULL){
VRF_PIVOT_FULL_INC(l1,MAX_VRF_ID,l5);}return(l135);}else if(l22 == 0){if(
...
l22,l5) == 0){if(!l19){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
...
&SOC_ALPM_LOOKUP_HIT){l135 = l151(l1,l3,l179,l215,l17,l233);}else{if(l233 == 
-1){l233 = 0;}l233 = ALPM_BKTID(ALPM_BKT_IDX(SOC_TH_ALPM_BKT_ENTRY_TO_IDX(l1,
l233)),l233>>ALPM_ENT_INDEX_BITS);l135 = l208(l1,l3,l17,l179,l215,&index,l233
,l234);}if(l135!= SOC_E_NONE){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"unit %d :soc_th_alpm_128_insert: ""Route Insertion Failed :%s\n"),l1,
soc_errmsg(l135)));}return(l135);}int soc_th_alpm_128_lookup(int l1,void*
key_data,void*l10,int*l11,int*l235){defip_alpm_ipv6_128_entry_t l181;
...
l149,&l22));if(l149 == SOC_L3_VRF_OVERRIDE){return SOC_E_NONE;}}if(!
VRF_TRIE_INIT_COMPLETED(l1,l22,l5)){LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(
l1,"soc_th_alpm_128_lookup:VRF %d is not ""initialized\n"),l22));*l11 = 0;*
l235 = 0;return SOC_E_NOT_FOUND;}l17 = L3_DEFIP_ALPM_IPV6_128m;l179 = ((
...
SOC_FAILURE(l135)){*l235 = tcam_index;*l11 = (ALPM_BKT_SIDX(bktid)<<
ALPM_ENT_INDEX_BITS)|SOC_TH_ALPM_BKT_IDX_TO_ENTRY(l1,bktid);return l135;}l135
= l21(l1,l179,l17,l5,l149,bktid,*l11,l10);*l235 = SOC_ALPM_LOOKUP_HIT|
tcam_index;*l11 = (ALPM_BKT_SIDX(bktid)<<ALPM_ENT_INDEX_BITS)|*l11;return(
l135);}int l236(int l1,void*key_data,void*l10,int l22,int*tcam_index,int*
bucket_index,int*l128,int l237){int l135 = SOC_E_NONE;int l134,l238,l28,l145 = 
0;uint32 l6,l150;defip_aux_scratch_entry_t l8;int l239,l240;int index;
soc_mem_t l17,l171;int l241,l242,l243;soc_field_t l244[4] = {IP_ADDR0_LWRf,
IP_ADDR1_LWRf,IP_ADDR0_UPRf,IP_ADDR1_UPRf};uint32 l245[
SOC_MAX_MEM_FIELD_WORDS] = {0};int l246 = -1;int l247 = 0;l28 = 
L3_DEFIP_MODE_128;l171 = L3_DEFIP_PAIR_128m;l239 = soc_mem_field32_get(l1,
l171,key_data,GLOBAL_ROUTEf);l240 = soc_mem_field32_get(l1,l171,key_data,
...
"Global":"VRF",l28,l239,l240));if(l22 == SOC_L3_VRF_GLOBAL){l6 = l237?1:0;
soc_mem_field32_set(l1,l171,key_data,GLOBAL_ROUTEf,1);soc_mem_field32_set(l1,
l171,key_data,VRF_ID_0_LWRf,0);}else{l6 = l237?3:2;}
...
){soc_mem_field32_set(l1,l171,key_data,GLOBAL_ROUTEf,l239);
soc_mem_field32_set(l1,l171,key_data,VRF_ID_0_LWRf,l240);}SOC_IF_ERROR_RETURN
...
key_data,&l242);if(SOC_FAILURE(l135)){return l135;}l243 = 
...
,l243,l242));for(l134 = 0;l134<l243;l134++){uint32 l179[
SOC_MAX_MEM_FIELD_WORDS] = {0};uint32 l248[4] = {0};uint32 l249[4] = {0};
uint32 l250[4] = {0};int l251;l135 = _soc_th_alpm_mem_index(l1,l17,
...
l251 = soc_mem_field32_get(l1,l17,&l179,VALIDf);l241 = soc_mem_field32_get(l1
,l17,&l179,LENGTHf);LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"Bucket [%d,%d] index %6d: valid %d, length %d\n"),ALPM_BKT_IDX(*bucket_index
),ALPM_BKT_SIDX(*bucket_index),index,l251,l241));if(!l251||(l241>l242)){
continue;}SHR_BITSET_RANGE(l248,128-l241,l241);(void)soc_mem_field_get(l1,l17
,(uint32*)&l179,KEYf,(uint32*)l249);l250[3] = soc_mem_field32_get(l1,l171,
key_data,l244[3]);l250[2] = soc_mem_field32_get(l1,l171,key_data,l244[2]);
l250[1] = soc_mem_field32_get(l1,l171,key_data,l244[1]);l250[0] = 
soc_mem_field32_get(l1,l171,key_data,l244[0]);LOG_VERBOSE(BSL_LS_SOC_ALPM,(
BSL_META_U(l1,"\tmask %08x %08x %08x %08x \n""\t key %08x %08x %08x %08x \n"
"\thost %08x %08x %08x %08x \n"),l248[3],l248[2],l248[1],l248[0],l249[3],l249
[2],l249[1],l249[0],l250[3],l250[2],l250[1],l250[0]));for(l238 = 3;l238>= 0;
l238--){if((l250[l238]&l248[l238])!= (l249[l238]&l248[l238])){break;}}if(l238
>= 0){continue;}LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"Found a match in mem %s bucket [%d,%d], ""index %d\n"),SOC_MEM_NAME(l1,l17),
ALPM_BKT_IDX(*bucket_index),ALPM_BKT_SIDX(*bucket_index),index));if(l246 == -
1||l246<l241){l246 = l241;l247 = index;sal_memcpy(l245,l179,sizeof(l179));}}
if(l246!= -1){l135 = l21(l1,&l245,l17,l28,l22,*bucket_index,l247,l10);if(
SOC_SUCCESS(l135)){*l128 = l247;if(bsl_check(bslLayerSoc,bslSourceAlpm,
...
bucket_index),ALPM_BKT_SIDX(*bucket_index),l247));}}return l135;}*l128 = 
...
void*l10,int*l11,int l237){int l135 = SOC_E_NONE;int l134,l238;int l252,l253;
defip_pair_128_entry_t l254;uint32 l255,l249,l250;int l241,l242;int l256,l257
;int l149,l22 = 0;int tcam_index,bucket_index;soc_mem_t l171;soc_field_t l258
[4] = {IP_ADDR_MASK1_UPRf,IP_ADDR_MASK0_UPRf,IP_ADDR_MASK1_LWRf,
IP_ADDR_MASK0_LWRf};soc_field_t l259[4] = {IP_ADDR1_UPRf,IP_ADDR0_UPRf,
IP_ADDR1_LWRf,IP_ADDR0_LWRf};l171 = L3_DEFIP_PAIR_128m;if(!
SOC_URPF_STATUS_GET(l1)&&l237){return SOC_E_PARAM;}l252 = soc_mem_index_min(
l1,l171);l253 = soc_mem_index_count(l1,l171);if(SOC_URPF_STATUS_GET(l1)){l253
>>= 1;}if(soc_th_alpm_mode_get(l1)){l253>>= 1;l252+= l253;}if(l237){l252+= 
soc_mem_index_count(l1,l171)/2;}LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"Start LPM searchng from %d, count %d\n"),l252,l253));for(l134 = l252;l134<
l252+l253;l134++){SOC_IF_ERROR_RETURN(soc_mem_read(l1,l171,MEM_BLOCK_ANY,l134
,(void*)&l254));if(!soc_mem_field32_get(l1,l171,&l254,VALID0_LWRf)){continue;
}l256 = soc_mem_field32_get(l1,l171,&l254,GLOBAL_HIGHf);l257 = 
soc_mem_field32_get(l1,l171,&l254,GLOBAL_ROUTEf);if(!(soc_th_alpm_mode_get(l1
)!= 2&&l256&&l257)&&!(soc_th_alpm_mode_get(l1) == 2&&l257)){continue;}l135 = 
l133(l1,key_data,&l242);l135 = l133(l1,&l254,&l241);if(SOC_FAILURE(l135)||(
l241>l242)){continue;}for(l238 = 0;l238<4;l238++){l255 = soc_mem_field32_get(
l1,l171,&l254,l258[l238]);l249 = soc_mem_field32_get(l1,l171,&l254,l259[l238]
);l250 = soc_mem_field32_get(l1,l171,key_data,l259[l238]);if((l250&l255)!= (
l249&l255)){break;}}if(l238<4){continue;}LOG_VERBOSE(BSL_LS_SOC_ALPM,(
BSL_META_U(l1,"Hit Global High route in index = %d\n"),l238));sal_memcpy(l10,
&l254,sizeof(l254));*l11 = l134;return SOC_E_NONE;}LOG_VERBOSE(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"Global high lookup miss, use AUX engine to "
"search for Global Low and VRF routes\n")));SOC_IF_ERROR_RETURN(
soc_th_alpm_128_lpm_vrf_get(l1,key_data,&l149,&l22));l135 = l236(l1,key_data,
l10,l22,&tcam_index,&bucket_index,l11,l237);if(l135 == SOC_E_NOT_FOUND){l22 = 
SOC_L3_VRF_GLOBAL;LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"Not found in VRF region, try Global ""region\n")));l135 = l236(l1,key_data,
l10,l22,&tcam_index,&bucket_index,l11,l237);}if(SOC_SUCCESS(l135)){tcam_index
...
soc_th_alpm_128_delete(int l1,void*key_data,int l233,int l234){int l149,l22;
int l5;int l135 = SOC_E_NONE;int l260;l5 = L3_DEFIP_MODE_128;
SOC_IF_ERROR_RETURN(soc_th_alpm_128_lpm_vrf_get(l1,key_data,&l149,&l22));if(
l149 == SOC_L3_VRF_OVERRIDE){l135 = soc_th_alpm_128_lpm_delete(l1,key_data);
if(SOC_SUCCESS(l135)){VRF_TRIE_ROUTES_DEC(l1,MAX_VRF_ID,l5);VRF_PIVOT_REF_DEC
(l1,MAX_VRF_ID,l5);}return(l135);}else{if(!VRF_TRIE_INIT_COMPLETED(l1,l22,l5)
){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l1,
"soc_th_alpm_128_delete:VRF %d/%d is not ""initialized\n"),l22,l5));return
SOC_E_NONE;}if(l233 == -1){l233 = 0;}l260 = l233;l233 = ALPM_BKTID(
ALPM_BKT_IDX(SOC_TH_ALPM_BKT_ENTRY_TO_IDX(l1,l260)),l260>>ALPM_ENT_INDEX_BITS
);l135 = l213(l1,key_data,l233,l234&~SOC_ALPM_LOOKUP_HIT,l233);}return(l135);
...
SOC_IS_HURRICANE(l1)))&&(((l103[(l1)]->l88)!= NULL))){int l261;(void)
soc_th_alpm_128_lpm_vrf_get(l1,l10,(int*)&l116[8],&l261);}else{l116[8] = 0;};
}static int l262(l110 l112,l110 l113){int l231;for(l231 = 0;l231<9;l231++){{
if((l112[l231])<(l113[l231])){return-1;}if((l112[l231])>(l113[l231])){return 1
;}};}return(0);}static void l263(int l1,void*l3,uint32 l264,uint32 l130,int
l127){l110 l265;if(soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,
...
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3)
,(l103[(l1)]->l82))){l265[0] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3),(l103[(l1)]->l65));l265[1] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3)
,(l103[(l1)]->l63));l265[2] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3),(l103[(l1)]->l69));l265[3] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3)
,(l103[(l1)]->l67));l265[4] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3),(l103[(l1)]->l66));l265[5] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3)
,(l103[(l1)]->l64));l265[6] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3),(l103[(l1)]->l70));l265[7] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l3)
,(l103[(l1)]->l68));if((!(SOC_IS_HURRICANE(l1)))&&(((l103[(l1)]->l88)!= NULL)
)){int l261;(void)soc_th_alpm_128_lpm_vrf_get(l1,l3,(int*)&l265[8],&l261);}
else{l265[8] = 0;};l129((l114[(l1)]),l262,l265,l127,l130,l264);}}static void
l266(int l1,void*key_data,uint32 l264){l110 l265;int l127 = -1;int l135;
uint16 index;l265[0] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,
L3_DEFIP_PAIR_128m)),(key_data),(l103[(l1)]->l65));l265[1] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(
key_data),(l103[(l1)]->l63));l265[2] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(key_data),(l103[(l1)]->l69));l265[3] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(
key_data),(l103[(l1)]->l67));l265[4] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(key_data),(l103[(l1)]->l66));l265[5] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(
key_data),(l103[(l1)]->l64));l265[6] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(key_data),(l103[(l1)]->l70));l265[7] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(
key_data),(l103[(l1)]->l68));if((!(SOC_IS_HURRICANE(l1)))&&(((l103[(l1)]->l88
)!= NULL))){int l261;(void)soc_th_alpm_128_lpm_vrf_get(l1,key_data,(int*)&
l265[8],&l261);}else{l265[8] = 0;};index = l264;l135 = l131((l114[(l1)]),l262
,l265,l127,index);if(SOC_FAILURE(l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U
(l1,"\ndel  index: H %d error %d\n"),index,l135));}}static int l267(int l1,
void*key_data,int l127,int*l128){l110 l265;int l135;uint16 index = (0xFFFF);
l265[0] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,
L3_DEFIP_PAIR_128m)),(key_data),(l103[(l1)]->l65));l265[1] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(
key_data),(l103[(l1)]->l63));l265[2] = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(key_data),(l103[(l1)]->l69));l265[3] = 
...
l265[8],&l261);}else{l265[8] = 0;};l135 = l124((l114[(l1)]),l262,l265,l127,&
...
,l110 entry,int l127,uint16*l128){int l1 = l125->unit;uint16 l268;uint16 index
;l268 = l117((uint8*)entry,(32*9))%l125->l106;index = l125->l107[l268];;;
while(index!= (0xFFFF)){uint32 l10[SOC_MAX_MEM_FIELD_WORDS];l110 l116;int l269
;l269 = index;SOC_IF_ERROR_RETURN(READ_L3_DEFIP_PAIR_128m(l1,MEM_BLOCK_ANY,
l269,l10));l115(l1,l10,index,l116);if((*l126)(entry,l116) == 0){*l128 = index
...
uint16 l130,uint16 l39){int l1 = l125->unit;uint16 l268;uint16 index;uint16
l270;l268 = l117((uint8*)entry,(32*9))%l125->l106;index = l125->l107[l268];;;
;l270 = (0xFFFF);if(l130!= (0xFFFF)){while(index!= (0xFFFF)){uint32 l10[
SOC_MAX_MEM_FIELD_WORDS];l110 l116;int l269;l269 = index;SOC_IF_ERROR_RETURN(
READ_L3_DEFIP_PAIR_128m(l1,MEM_BLOCK_ANY,l269,l10));l115(l1,l10,index,l116);
if((*l126)(entry,l116) == 0){if(l39!= index){;if(l270 == (0xFFFF)){l125->l107
[l268] = l39;l125->l108[l39&(0x3FFF)] = l125->l108[index&(0x3FFF)];l125->l108
[index&(0x3FFF)] = (0xFFFF);}else{l125->l108[l270&(0x3FFF)] = l39;l125->l108[
l39&(0x3FFF)] = l125->l108[index&(0x3FFF)];l125->l108[index&(0x3FFF)] = (
0xFFFF);}};return(SOC_E_NONE);}l270 = index;index = l125->l108[index&(0x3FFF)
];;}}l125->l108[l39&(0x3FFF)] = l125->l107[l268];l125->l107[l268] = l39;
return(SOC_E_NONE);}static int l131(l109*l125,l111 l126,l110 entry,int l127,
uint16 l132){uint16 l268;uint16 index;uint16 l270;l268 = l117((uint8*)entry,(
32*9))%l125->l106;index = l125->l107[l268];;;l270 = (0xFFFF);while(index!= (
0xFFFF)){if(l132 == index){;if(l270 == (0xFFFF)){l125->l107[l268] = l125->
l108[l132&(0x3FFF)];l125->l108[l132&(0x3FFF)] = (0xFFFF);}else{l125->l108[
l270&(0x3FFF)] = l125->l108[l132&(0x3FFF)];l125->l108[l132&(0x3FFF)] = (
0xFFFF);}return(SOC_E_NONE);}l270 = index;index = l125->l108[index&(0x3FFF)];
;}return(SOC_E_NOT_FOUND);}static int l271(int l1,void*l10){return(SOC_E_NONE
);}void soc_th_alpm_128_lpm_state_dump(int l1){int l134;int l272;l272 = ((3*(
128+2+1))-1);if(!bsl_check(bslLayerSoc,bslSourceAlpm,bslSeverityVerbose,l1)){
return;}for(l134 = l272;l134>= 0;l134--){if((l134!= ((3*(128+2+1))-1))&&((l54
...
COMPILER_REFERENCE(l271);}static int l273(int l1,int index,uint32*l10){int
l274;uint32 l275,l276,l277;uint32 l278;int l279;if(!SOC_URPF_STATUS_GET(l1)){
return(SOC_E_NONE);}if(soc_feature(l1,soc_feature_l3_defip_hole)){l274 = (
soc_mem_index_count(l1,L3_DEFIP_PAIR_128m)>>1);}else if(SOC_IS_APOLLO(l1)){
l274 = (soc_mem_index_count(l1,L3_DEFIP_PAIR_128m)>>1)+0x0400;}else{l274 = (
...
l10),(l103[(l1)]->l57),(0));}l275 = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l10),(l103[(l1)]->l69));l278 = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l10
),(l103[(l1)]->l70));l276 = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(
l1,L3_DEFIP_PAIR_128m)),(l10),(l103[(l1)]->l67));l277 = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l10
),(l103[(l1)]->l68));l279 = ((!l275)&&(!l278)&&(!l276)&&(!l277))?1:0;l275 = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l10
),(l103[(l1)]->l84));l278 = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(
l1,L3_DEFIP_PAIR_128m)),(l10),(l103[(l1)]->l82));l276 = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l10
),(l103[(l1)]->l83));l277 = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(
l1,L3_DEFIP_PAIR_128m)),(l10),(l103[(l1)]->l83));if(l275&&l278&&l276&&l277){
soc_meminfo_fieldinfo_field32_set((&SOC_MEM_INFO(l1,L3_DEFIP_PAIR_128m)),(l10
),(l103[(l1)]->l81),(l279));}return l166(l1,MEM_BLOCK_ANY,index+l274,index,
l10);}static int l280(int l1,int l281,int l282){uint32 l10[
SOC_MAX_MEM_FIELD_WORDS];SOC_IF_ERROR_RETURN(READ_L3_DEFIP_PAIR_128m(l1,
MEM_BLOCK_ANY,l281,l10));l263(l1,l10,l282,0x4000,0);SOC_IF_ERROR_RETURN(l166(
l1,MEM_BLOCK_ANY,l282,l281,l10));SOC_IF_ERROR_RETURN(l273(l1,l282,l10));do{
int l283 = soc_th_alpm_physical_idx((l1),L3_DEFIP_PAIR_128m,(l281),1);int l284
= soc_th_alpm_physical_idx((l1),L3_DEFIP_PAIR_128m,(l282),1);int l285 = 
SOC_ALPM_128_ADDR_LWR((l284))<<1;ALPM_TCAM_PIVOT((l1),l285) = ALPM_TCAM_PIVOT
((l1),SOC_ALPM_128_ADDR_LWR((l283))<<1);if(ALPM_TCAM_PIVOT((l1),l285)){
PIVOT_TCAM_INDEX(ALPM_TCAM_PIVOT((l1),l285)) = l285;
soc_th_alpm_lpm_move_bu_upd((l1),PIVOT_BUCKET_INDEX(ALPM_TCAM_PIVOT((l1),l285
)),l285);}ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR((l283))<<1) = NULL;}while(
0);return(SOC_E_NONE);}static int l286(int l1,int l127,int l5){int l281;int
l282;l282 = (l54[(l1)][(l127)].l48)+1;l281 = (l54[(l1)][(l127)].l47);if(l281
!= l282){SOC_IF_ERROR_RETURN(l280(l1,l281,l282));VRF_PIVOT_SHIFT_INC(l1,
MAX_VRF_ID,l5);}(l54[(l1)][(l127)].l47)+= 1;(l54[(l1)][(l127)].l48)+= 1;
return(SOC_E_NONE);}static int l287(int l1,int l127,int l5){int l281;int l282
;l282 = (l54[(l1)][(l127)].l47)-1;if((l54[(l1)][(l127)].l50) == 0){(l54[(l1)]
[(l127)].l47) = l282;(l54[(l1)][(l127)].l48) = l282-1;return(SOC_E_NONE);}
l281 = (l54[(l1)][(l127)].l48);SOC_IF_ERROR_RETURN(l280(l1,l281,l282));
VRF_PIVOT_SHIFT_INC(l1,MAX_VRF_ID,l5);(l54[(l1)][(l127)].l47)-= 1;(l54[(l1)][
(l127)].l48)-= 1;return(SOC_E_NONE);}static int l288(int l1,int l127,int l5,
void*l10,int*l289){int l290;int l291;int l292;int l293;if((l54[(l1)][(l127)].
l50) == 0){l293 = ((3*(128+2+1))-1);if((soc_th_alpm_mode_get(l1) == 
SOC_ALPM_MODE_PARALLEL)||(soc_th_alpm_mode_get(l1) == SOC_ALPM_MODE_TCAM_ALPM
)){if(l127<= (((3*(128+2+1))/3)-1)){l293 = (((3*(128+2+1))/3)-1);}}while((l54
[(l1)][(l293)].next)>l127){l293 = (l54[(l1)][(l293)].next);}l291 = (l54[(l1)]
[(l293)].next);if(l291!= -1){(l54[(l1)][(l291)].l49) = l127;}(l54[(l1)][(l127
)].next) = (l54[(l1)][(l293)].next);(l54[(l1)][(l127)].l49) = l293;(l54[(l1)]
[(l293)].next) = l127;(l54[(l1)][(l127)].l51) = ((l54[(l1)][(l293)].l51)+1)/2
;(l54[(l1)][(l293)].l51)-= (l54[(l1)][(l127)].l51);(l54[(l1)][(l127)].l47) = 
(l54[(l1)][(l293)].l48)+(l54[(l1)][(l293)].l51)+1;(l54[(l1)][(l127)].l48) = (
l54[(l1)][(l127)].l47)-1;(l54[(l1)][(l127)].l50) = 0;}l292 = l127;while((l54[
(l1)][(l292)].l51) == 0){l292 = (l54[(l1)][(l292)].next);if(l292 == -1){l292 = 
l127;break;}}while((l54[(l1)][(l292)].l51) == 0){l292 = (l54[(l1)][(l292)].
l49);if(l292 == -1){if((l54[(l1)][(l127)].l50) == 0){l290 = (l54[(l1)][(l127)
].l49);l291 = (l54[(l1)][(l127)].next);if(-1!= l290){(l54[(l1)][(l290)].next)
= l291;}if(-1!= l291){(l54[(l1)][(l291)].l49) = l290;}}return(SOC_E_FULL);}}
while(l292>l127){l291 = (l54[(l1)][(l292)].next);SOC_IF_ERROR_RETURN(l287(l1,
l291,l5));(l54[(l1)][(l292)].l51)-= 1;(l54[(l1)][(l291)].l51)+= 1;l292 = l291
;}while(l292<l127){SOC_IF_ERROR_RETURN(l286(l1,l292,l5));(l54[(l1)][(l292)].
l51)-= 1;l290 = (l54[(l1)][(l292)].l49);(l54[(l1)][(l290)].l51)+= 1;l292 = 
l290;}(l54[(l1)][(l127)].l50)+= 1;(l54[(l1)][(l127)].l51)-= 1;(l54[(l1)][(
l127)].l48)+= 1;*l289 = (l54[(l1)][(l127)].l48);sal_memcpy(l10,
soc_mem_entry_null(l1,L3_DEFIP_PAIR_128m),soc_mem_entry_words(l1,
L3_DEFIP_PAIR_128m)*4);return(SOC_E_NONE);}static int l294(int l1,int l127,
int l5,void*l10,int l295){int l290;int l291;int l281;int l282;uint32 l296[
SOC_MAX_MEM_FIELD_WORDS];int l135;int l141;l281 = (l54[(l1)][(l127)].l48);
l282 = l295;(l54[(l1)][(l127)].l50)-= 1;(l54[(l1)][(l127)].l51)+= 1;(l54[(l1)
][(l127)].l48)-= 1;if(l282!= l281){if((l135 = READ_L3_DEFIP_PAIR_128m(l1,
MEM_BLOCK_ANY,l281,l296))<0){return l135;}l263(l1,l296,l282,0x4000,0);if((
l135 = l166(l1,MEM_BLOCK_ANY,l282,l281,l296))<0){return l135;}if((l135 = l273
(l1,l282,l296))<0){return l135;}}l141 = soc_th_alpm_physical_idx(l1,
L3_DEFIP_PAIR_128m,l282,1);l295 = soc_th_alpm_physical_idx(l1,
L3_DEFIP_PAIR_128m,l281,1);ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR(l141)<<1)
= ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR(l295)<<1);if(ALPM_TCAM_PIVOT(l1,
...
SOC_ALPM_128_ADDR_LWR(l141)<<1)),SOC_ALPM_128_ADDR_LWR(l141)<<1);}
ALPM_TCAM_PIVOT(l1,SOC_ALPM_128_ADDR_LWR(l295)<<1) = NULL;sal_memcpy(l296,
soc_mem_entry_null(l1,L3_DEFIP_PAIR_128m),soc_mem_entry_words(l1,
L3_DEFIP_PAIR_128m)*4);l263(l1,l296,l281,0x4000,0);if((l135 = l166(l1,
MEM_BLOCK_ANY,l281,l281,l296))<0){return l135;}if((l135 = l273(l1,l281,l296))
<0){return l135;}if((l54[(l1)][(l127)].l50) == 0){l290 = (l54[(l1)][(l127)].
l49);assert(l290!= -1);l291 = (l54[(l1)][(l127)].next);(l54[(l1)][(l290)].
next) = l291;(l54[(l1)][(l290)].l51)+= (l54[(l1)][(l127)].l51);(l54[(l1)][(
l127)].l51) = 0;if(l291!= -1){(l54[(l1)][(l291)].l49) = l290;}(l54[(l1)][(
l127)].next) = -1;(l54[(l1)][(l127)].l49) = -1;(l54[(l1)][(l127)].l47) = -1;(
l54[(l1)][(l127)].l48) = -1;}return(l135);}int soc_th_alpm_128_lpm_vrf_get(
int unit,void*lpm_entry,int*l22,int*l297){int l149;if(((l103[(unit)]->l92)!= 
NULL)){l149 = soc_L3_DEFIP_PAIR_128m_field32_get(unit,lpm_entry,VRF_ID_0_LWRf
);*l297 = l149;if(soc_L3_DEFIP_PAIR_128m_field32_get(unit,lpm_entry,
...
l22 = SOC_L3_VRF_GLOBAL;*l297 = SOC_VRF_MAX(unit)+1;}else{*l22 = 
SOC_L3_VRF_OVERRIDE;}}else{*l22 = SOC_L3_VRF_DEFAULT;}return(SOC_E_NONE);}
static int l298(int l1,void*entry,int*l12){int l127=0;int l135;int l149;int
l299;l135 = l133(l1,entry,&l127);if(l135<0){return l135;}l127+= 0;
SOC_IF_ERROR_RETURN(soc_th_alpm_128_lpm_vrf_get(l1,entry,&l149,&l135));l299 = 
soc_th_alpm_mode_get(l1);switch(l149){case SOC_L3_VRF_GLOBAL:if((l299 == 
SOC_ALPM_MODE_PARALLEL)||(l299 == SOC_ALPM_MODE_TCAM_ALPM)){*l12 = l127+((3*(
128+2+1))/3);}else{*l12 = l127;}break;case SOC_L3_VRF_OVERRIDE:*l12 = l127+2*
((3*(128+2+1))/3);break;default:if((l299 == SOC_ALPM_MODE_PARALLEL)||(l299 == 
...
l298(l1,key_data,&l127);*l12 = l127;if(l267(l1,key_data,l127,&l128) == 
...
SOC_E_NOT_FOUND);}}int soc_th_alpm_128_lpm_init(int l1){int l272;int l134;int
l300;int l301;if(!soc_feature(l1,soc_feature_lpm_tcam)){return(SOC_E_UNAVAIL)
;}l272 = (3*(128+2+1));l301 = sizeof(l52)*(l272);if((l54[(l1)]!= NULL)){
...
) = sal_alloc(l301,"LPM 128 prefix info");if(NULL == (l54[(l1)])){sal_free(
l103[l1]);l103[l1] = NULL;return(SOC_E_MEMORY);}SOC_ALPM_LPM_LOCK(l1);
sal_memset((l54[(l1)]),0,l301);for(l134 = 0;l134<l272;l134++){(l54[(l1)][(
l134)].l47) = -1;(l54[(l1)][(l134)].l48) = -1;(l54[(l1)][(l134)].l49) = -1;(
l54[(l1)][(l134)].next) = -1;(l54[(l1)][(l134)].l50) = 0;(l54[(l1)][(l134)].
l51) = 0;}l300 = soc_mem_index_count(l1,L3_DEFIP_PAIR_128m);if(
SOC_URPF_STATUS_GET(l1)){l300>>= 1;}if((soc_th_alpm_mode_get(l1) == 
SOC_ALPM_MODE_PARALLEL)||(soc_th_alpm_mode_get(l1) == SOC_ALPM_MODE_TCAM_ALPM
)){(l54[(l1)][(((3*(128+2+1))-1))].l48) = (l300>>1)-1;(l54[(l1)][(((((3*(128+
2+1))/3)-1)))].l51) = l300>>1;(l54[(l1)][((((3*(128+2+1))-1)))].l51) = (l300-
(l54[(l1)][(((((3*(128+2+1))/3)-1)))].l51));}else{(l54[(l1)][((((3*(128+2+1))
-1)))].l51) = l300;}if((l114[(l1)])!= NULL){if(l122((l114[(l1)]))<0){
SOC_ALPM_LPM_UNLOCK(l1);return SOC_E_INTERNAL;}(l114[(l1)]) = NULL;}if(l120(
l1,l300*2,l300,&(l114[(l1)]))<0){SOC_ALPM_LPM_UNLOCK(l1);return SOC_E_MEMORY;
...
SOC_MAX_MEM_FIELD_WORDS];int l135 = SOC_E_NONE;int l302 = 0;sal_memcpy(l10,
soc_mem_entry_null(l1,L3_DEFIP_PAIR_128m),soc_mem_entry_words(l1,
L3_DEFIP_PAIR_128m)*4);SOC_ALPM_LPM_LOCK(l1);l135 = l9(l1,l3,l10,&index,&l127
,&l5);if(l135 == SOC_E_NOT_FOUND){l135 = l288(l1,l127,l5,l10,&index);if(l135<
0){SOC_ALPM_LPM_UNLOCK(l1);return(l135);}}else{l302 = 1;}*l170 = index;if(
l135 == SOC_E_NONE){soc_th_alpm_128_lpm_state_dump(l1);LOG_INFO(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"soc_th_alpm_128_lpm_insert: %d %d\n"),index,
l127));if(!l302){l263(l1,l3,index,0x4000,0);}l135 = l166(l1,MEM_BLOCK_ANY,
index,index,l3);if(l135>= 0){l135 = l273(l1,index,l3);}}SOC_ALPM_LPM_UNLOCK(
...
"soc_th_alpm_lpm_delete: %d %d\n"),index,l127));l266(l1,key_data,index);l135 = 
l294(l1,l127,l5,l10,index);}soc_th_alpm_128_lpm_state_dump(l1);
...
uint32 l137;uint32 l303[4] = {0,0,0,0};int l127 = 0;int l135 = SOC_E_NONE;
...
soc_mem_field32_set(unit,L3_DEFIP_AUX_SCRATCHm,l8,CLASS_IDf,l137);l303[0] = 
soc_mem_field32_get(unit,L3_DEFIP_PAIR_128m,key_data,IP_ADDR0_LWRf);l303[1] = 
soc_mem_field32_get(unit,L3_DEFIP_PAIR_128m,key_data,IP_ADDR1_LWRf);l303[2] = 
soc_mem_field32_get(unit,L3_DEFIP_PAIR_128m,key_data,IP_ADDR0_UPRf);l303[3] = 
...
l303);l135 = l133(unit,key_data,&l127);if(SOC_FAILURE(l135)){return l135;}
...
soc_mem_t l17,uint32 l18,uint32*l304,int l20){uint32 l137;uint32 l303[4];int
...
,l15,SUB_BKT_PTRf,ALPM_BKT_SIDX(l20));l303[0] = soc_mem_field32_get(unit,
L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR0_LWRf);l303[1] = soc_mem_field32_get(
unit,L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR1_LWRf);l303[2] = 
soc_mem_field32_get(unit,L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR0_UPRf);l303[3] = 
soc_mem_field32_get(unit,L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR1_UPRf);
soc_mem_field_set(unit,l17,(uint32*)l15,KEYf,(uint32*)l303);l135 = l133(unit,
lpm_entry,&l127);if(SOC_FAILURE(l135)){return l135;}if((l127 == 0)&&(l303[0]
== 0)&&(l303[1] == 0)&&(l303[2] == 0)&&(l303[3] == 0)){l19 = 1;}if(l304!= 
...
int l22,int l23,int index,void*lpm_entry){uint32 l137;uint32 l303[4];uint32
...
soc_mem_field_get(unit,l17,l15,KEYf,l303);soc_mem_field32_set(unit,
L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR0_LWRf,l303[0]);soc_mem_field32_set(unit,
L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR1_LWRf,l303[1]);soc_mem_field32_set(unit,
L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR0_UPRf,l303[2]);soc_mem_field32_set(unit,
L3_DEFIP_PAIR_128m,lpm_entry,IP_ADDR1_UPRf,l303[3]);l303[0] = l303[1] = l303[
2] = l303[3] = 0;l137 = soc_mem_field32_get(unit,l17,l15,LENGTHf);l142(unit,
...
= 0,l22 = 0;uint32 l307;trie_t*l230 = NULL;uint32 prefix[5] = {0};int l19 = 0
...
(l306)<<1;if(l149!= SOC_L3_VRF_OVERRIDE){l230 = VRF_PIVOT_TRIE_IPV6_128(unit,
l22);if(l230 == NULL){trie_init(_MAX_KEY_LEN_144_,&VRF_PIVOT_TRIE_IPV6_128(
unit,l22));l230 = VRF_PIVOT_TRIE_IPV6_128(unit,l22);}sal_memcpy(l32->key,
prefix,sizeof(prefix));l32->len = l307;l135 = trie_insert(l230,l32->key,NULL,
l32->len,(trie_node_t*)l32);if(SOC_FAILURE(l135)){sal_free(l201);sal_free(l32
);return l135;}}ALPM_TCAM_PIVOT(unit,SOC_ALPM_128_ADDR_LWR(l306)<<1) = l32;
PIVOT_BUCKET_VRF(l32) = l22;PIVOT_BUCKET_IPV6(l32) = l5;
PIVOT_BUCKET_ENT_CNT_UPDATE(l32);if(key[0] == 0&&key[1] == 0&&key[2] == 0&&
key[3] == 0){PIVOT_BUCKET_DEF(l32) = TRUE;}VRF_PIVOT_REF_INC(unit,l22,l5);
return l135;}static int l308(int unit,int l5,void*lpm_entry,void*l15,
soc_mem_t l17,int l306,int bktid,int l309){int l310;int l22;int l135 = 
SOC_E_NONE;int l19 = 0;uint32 prefix[5] = {0,0,0,0,0};uint32 l33;
defip_pair_128_entry_t l311;trie_t*l40 = NULL;trie_t*l31 = NULL;trie_node_t*
l191 = NULL;payload_t*l312 = NULL;payload_t*l211 = NULL;alpm_pivot_t*
pivot_pyld = NULL;if((NULL == lpm_entry)||(NULL == l15)){return SOC_E_PARAM;}
SOC_IF_ERROR_RETURN(soc_th_alpm_128_lpm_vrf_get(unit,lpm_entry,&l310,&l22));
l17 = L3_DEFIP_ALPM_IPV6_128m;SOC_IF_ERROR_RETURN(l21(unit,l15,l17,l5,l310,
bktid,l306,&l311));l135 = _alpm_128_prefix_create(unit,&l311,prefix,&l33,&l19
);if(SOC_FAILURE(l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(unit,
"prefix create failed\n")));return l135;}pivot_pyld = ALPM_TCAM_PIVOT(unit,
l306);l40 = PIVOT_BUCKET_TRIE(pivot_pyld);l312 = sal_alloc(sizeof(payload_t),
"Payload for Key");if(NULL == l312){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(
unit,"Unable to allocate memory for trie node.\n")));return SOC_E_MEMORY;}
l211 = sal_alloc(sizeof(payload_t),"Payload for pfx trie key");if(NULL == 
l211){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(unit,
...
int l22,int l231,int bkt_ptr){int l135 = SOC_E_NONE;uint32 l33;uint32 key[5] = 
{0,0,0,0,0};trie_t*l316 = NULL;payload_t*l220 = NULL;defip_pair_128_entry_t*
...
VRF_PREFIX_TRIE_IPV6_128(unit,l22);l220 = sal_alloc(sizeof(payload_t),
"Payload for pfx trie key");if(l220 == NULL){LOG_ERROR(BSL_LS_SOC_ALPM,(
BSL_META_U(unit,"Unable to allocate memory for pfx trie node \n")));return
SOC_E_MEMORY;}sal_memset(l220,0,sizeof(*l220));l220->key[0] = key[0];l220->
key[1] = key[1];l220->len = l33 = 0;l135 = trie_insert(l316,key,NULL,l33,&(
l220->node));if(SOC_FAILURE(l135)){sal_free(l220);return l135;}
...
SOC_IF_ERROR_RETURN(soc_th_alpm_128_lpm_vrf_get(unit,lpm_entry,&l310,&l22));
if(l310 == SOC_L3_VRF_OVERRIDE){return(l135);}if(!VRF_TRIE_INIT_COMPLETED(
unit,l22,l5)){LOG_VERBOSE(BSL_LS_SOC_ALPM,(BSL_META_U(unit,
"VRF %d is not initialized\n"),l22));l135 = l315(unit,l5,l22,l306,bktid);if(
SOC_FAILURE(l135)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(unit,
...
soc_th_alpm_128_warmboot_bucket_bitmap_set(int l1,int l22,int l28,int l233){
int l317 = 1;SHR_BITDCL*l318 = SOC_TH_ALPM_VRF_BUCKET_BMAP(l1);if(l22 == 
SOC_VRF_MAX(l1)+1){l318 = SOC_TH_ALPM_GLB_BUCKET_BMAP(l1);}if(
SOC_TH_ALPM_SCALE_CHECK(l1,l28)){l317 = 2;}SHR_BITSET_RANGE(l318,l233,l317);
return SOC_E_NONE;}int soc_th_alpm_128_warmboot_lpm_reinit_done(int unit){int
l231;int l319 = ((3*(128+2+1))-1);int l300 = soc_mem_index_count(unit,
L3_DEFIP_PAIR_128m);if(SOC_URPF_STATUS_GET(unit)){l300>>= 1;}if(!
soc_th_alpm_mode_get(unit)){(l54[(unit)][(((3*(128+2+1))-1))].l49) = -1;for(
l231 = ((3*(128+2+1))-1);l231>-1;l231--){if(-1 == (l54[(unit)][(l231)].l47)){
continue;}(l54[(unit)][(l231)].l49) = l319;(l54[(unit)][(l319)].next) = l231;
(l54[(unit)][(l319)].l51) = (l54[(unit)][(l231)].l47)-(l54[(unit)][(l319)].
l48)-1;l319 = l231;}(l54[(unit)][(l319)].next) = -1;(l54[(unit)][(l319)].l51)
= l300-(l54[(unit)][(l319)].l48)-1;}else{(l54[(unit)][(((3*(128+2+1))-1))].
l49) = -1;for(l231 = ((3*(128+2+1))-1);l231>(((3*(128+2+1))-1)/3);l231--){if(
-1 == (l54[(unit)][(l231)].l47)){continue;}(l54[(unit)][(l231)].l49) = l319;(
l54[(unit)][(l319)].next) = l231;(l54[(unit)][(l319)].l51) = (l54[(unit)][(
l231)].l47)-(l54[(unit)][(l319)].l48)-1;l319 = l231;}(l54[(unit)][(l319)].
next) = -1;(l54[(unit)][(l319)].l51) = l300-(l54[(unit)][(l319)].l48)-1;l319 = 
(((3*(128+2+1))-1)/3);(l54[(unit)][((((3*(128+2+1))-1)/3))].l49) = -1;for(
l231 = ((((3*(128+2+1))-1)/3)-1);l231>-1;l231--){if(-1 == (l54[(unit)][(l231)
].l47)){continue;}(l54[(unit)][(l231)].l49) = l319;(l54[(unit)][(l319)].next)
= l231;(l54[(unit)][(l319)].l51) = (l54[(unit)][(l231)].l47)-(l54[(unit)][(
l319)].l48)-1;l319 = l231;}(l54[(unit)][(l319)].next) = -1;(l54[(unit)][(l319
)].l51) = (l300>>1)-(l54[(unit)][(l319)].l48)-1;}return(SOC_E_NONE);}int
soc_th_alpm_128_warmboot_lpm_reinit(int unit,int l5,int l231,void*lpm_entry){
int l12;l263(unit,lpm_entry,l231,0x4000,0);SOC_IF_ERROR_RETURN(l298(unit,
lpm_entry,&l12));if((l54[(unit)][(l12)].l50) == 0){(l54[(unit)][(l12)].l47) = 
l231;(l54[(unit)][(l12)].l48) = l231;}else{(l54[(unit)][(l12)].l48) = l231;}(
l54[(unit)][(l12)].l50)++;return(SOC_E_NONE);}int
soc_th_alpm_128_bucket_sanity_check(int l1,soc_mem_t l171,int index){int l135
= SOC_E_NONE;int l134,l238,l247,l5,tcam_index = -1;int l149 = 0,l22;uint32
l150 = 0;uint32 l10[SOC_MAX_MEM_FIELD_WORDS];int l320,l321,l322;
defip_pair_128_entry_t lpm_entry;int l252,l323;soc_mem_t l17 = 
...
ALG_BKT_PTRf;soc_field_t l330 = ALG_SUB_BKT_PTRf;l5 = L3_DEFIP_MODE_128;l252 = 
soc_mem_index_min(l1,l171);l323 = soc_mem_index_max(l1,l171);if((index>= 0)&&
(index<l252||index>l323)){return SOC_E_PARAM;}else if(index>= 0){l252 = index
;l323 = index;}SOC_ALPM_LPM_LOCK(l1);for(l134 = l252;l134<= l323;l134++){l135
...
}tcam_index = -1;for(l238 = 0;l238<l324;l238++){l135 = _soc_th_alpm_mem_index
(l1,l17,bkt_ptr,l238,l150,&l247);if(SOC_FAILURE(l135)){continue;}l135 = 
soc_mem_read(l1,l17,MEM_BLOCK_ANY,l247,(void*)l10);if(SOC_FAILURE(l135)){
...
l134,l331;int l247,l252,l323;int l135 = SOC_E_NONE;int*l332 = NULL;int l320,
...
ALG_BKT_PTRf;soc_field_t l330 = ALG_SUB_BKT_PTRf;l252 = soc_mem_index_min(l1,
l171);l323 = soc_mem_index_max(l1,l171);if((index>= 0)&&(index<l252||index>
l323)){return SOC_E_PARAM;}else if(index>= 0){l252 = index;l323 = index;}l134
...
l135;}sal_memset(l332,0xff,l134);SOC_ALPM_LPM_LOCK(l1);for(l134 = l252;l134<= 
...
;l326 = l135;continue;}l247 = soc_th_alpm_logical_idx(l1,l171,
SOC_ALPM_128_DEFIP_TO_PAIR(l320>>1),1);l135 = soc_mem_read(l1,l171,
MEM_BLOCK_ANY,l247,(void*)l10);if(SOC_FAILURE(l135)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l1,"\tRead memory %s index %d (nexthop) "
"return %d\n"),SOC_MEM_NAME(l1,l171),l247,l135));l326 = l135;continue;}l334 = 
