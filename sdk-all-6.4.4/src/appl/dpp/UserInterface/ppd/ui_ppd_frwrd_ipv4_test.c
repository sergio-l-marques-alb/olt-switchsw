/* $Id: ui_ppd_frwrd_ipv4_test.c,v 1.6 Broadcom SDK $
...
/******************************************************************** 
 *  Function handler: frwrd_ipv4_test_clear_vrf (section soc_pb_pp_frwrd_ipv4_test)
 ********************************************************************/
int 
  ui_ppd_frwrd_ipv4_test_frwrd_ipv4_test_clear_vrf(
    CURRENT_LINE *current_line 
  ) 
{   
  uint32 
    ret;   
  SOC_PB_PP_FRWRD_IPV4_CLEAR_INFO   
    prm_clear_info;
  ...
  SOC_PB_PP_FRWRD_IPV4_CLEAR_INFO_clear(&prm_clear_info);
  ...
  /* Call function */
  ret = soc_pb_pp_frwrd_ipv4_test_clear_vrf(
          unit,
          &prm_clear_info
        );
  if (soc_sand_get_error_code_from_error_word(ret) != SOC_SAND_OK) 
  { 
    send_string_to_screen(" *** soc_pb_pp_frwrd_ipv4_test_clear_vrf - FAIL", TRUE); 
...
/******************************************************************** 
 *  Function handler: frwrd_ipv4_test_print_mem (section soc_pb_pp_frwrd_ipv4_test)
 ********************************************************************/
int 
  ui_ppd_frwrd_ipv4_test_frwrd_ipv4_test_print_mem(
    CURRENT_LINE *current_line 
  ) 
{   
  uint32 
  ...
  /* Call function */
  ret = soc_pb_pp_frwrd_ipv4_test_print_mem(
          unit,
          0xff,
          4
        );
  if (soc_sand_get_error_code_from_error_word(ret) != SOC_SAND_OK) 
  { 
    send_string_to_screen(" *** soc_pb_pp_frwrd_ipv4_test_print_mem - FAIL", TRUE); 
 ...
 ********************************************************************/
int 
  ui_ppd_frwrd_ipv4_test_frwrd_ipv4_test_lookup(
    CURRENT_LINE *current_line 
  ) 
{   
  uint32 
    ret;   
  SOC_PB_PP_FRWRD_IPV4_TEST_LKUP_INFO   
    prm_lkup_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PB_PP_FRWRD_IPV4_TEST_LKUP_INFO_clear(&prm_lkup_info);
  ...
  /* Call function */
  ret = soc_pb_pp_frwrd_ipv4_test_lookup(
          unit,
          &prm_lkup_info
        );
  if (soc_sand_get_error_code_from_error_word(ret) != SOC_SAND_OK) 
...
/******************************************************************** 
 *  Function handler: frwrd_ipv4_test_vrf (section soc_pb_pp_frwrd_ipv4_test)
 ********************************************************************/
int 
  ui_ppd_frwrd_ipv4_test_frwrd_ipv4_test_vrf(
    CURRENT_LINE *current_line 
  ) 
{   
  uint32 
  ...
  /* Call function */
  ret = soc_pb_pp_frwrd_ipv4_test_vrf(
          unit,
          prm_vrf_ndx,
          prm_nof_iterations
        );
  if (soc_sand_get_error_code_from_error_word(ret) != SOC_SAND_OK) 
  { 
    send_string_to_screen(" *** soc_pb_pp_frwrd_ipv4_test_vrf - FAIL", TRUE); 
...
/******************************************************************** 
 *  Function handler: frwrd_ipv4_test_run (section soc_pb_pp_frwrd_ipv4_test)
 ********************************************************************/
int 
  ui_ppd_frwrd_ipv4_test_frwrd_ipv4_test_run(
    CURRENT_LINE *current_line 
  ) 
{   
  uint32 
    ret;   
  SOC_PB_PP_FRWRD_IPV4_TEST_INFO   
    prm_tes_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PB_PP_FRWRD_IPV4_TEST_INFO_clear(&prm_tes_info);
  ...
  /* Call function */
  ret = soc_pb_pp_frwrd_ipv4_test_run(
          unit,
          &prm_tes_info
        );
  if (soc_sand_get_error_code_from_error_word(ret) != SOC_SAND_OK) 
  { 
    send_string_to_screen(" *** soc_pb_pp_frwrd_ipv4_test_run - FAIL", TRUE); 
...
#endif
#ifdef UI_PPD_FRWRD_IPV4_TEST/* { soc_pb_pp_frwrd_ipv4_test*/
/******************************************************************** 
 *  Section handler: soc_pb_pp_frwrd_ipv4_test
 ********************************************************************/ 
int 
  ui_ppd_frwrd_ipv4_test( 
    CURRENT_LINE *current_line 
  ) 
{   
  int
  ...
  { 
    ret = ui_ppd_frwrd_ipv4_test_frwrd_ipv4_test_clear_vrf(current_line); 
  } 
...
#endif /* soc_pb_pp_frwrd_ipv4_test */ 
