                                     ...
                                     )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_BMACT_BVID_INFO_clear(&prm_bvid_info);
                                     ...
                                     )
{
  ...
  SOC_PPD_BMACT_BVID_INFO_print(&prm_bvid_info);
  ...
  )
{
  uint32
    ret;
  SOC_PPD_BMACT_PBB_TE_VID_RANGE
    prm_pbb_te_bvids;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_BMACT_PBB_TE_VID_RANGE_clear(&prm_pbb_te_bvids);
  ...
  )
{
  ...
  SOC_PPD_BMACT_PBB_TE_VID_RANGE_print(&prm_pbb_te_bvids);
    ...
    )
{
  uint32
    ret;
  SOC_PPD_BMACT_ENTRY_KEY
    prm_bmac_key;
  SOC_PPD_BMACT_ENTRY_INFO
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_BMACT_ENTRY_KEY_clear(&prm_bmac_key);
  SOC_PPD_BMACT_ENTRY_INFO_clear(&prm_bmact_entry_info);
