                       ...
                       bcm_l2_cache_addr_t *l2caddr, l2u_entry_t *l2u_entry)
{
 ...
 || defined(BCM_RAVEN_SUPPORT)
        ...
        if (soc_feature(unit, soc_feature_l2_entry_used_as_my_station)) {
            if (my_station_config) {
                if (_l2u_field32_get(unit, l2u_entry, DESTINATIONf) 
                ...
                if ((_l2u_field32_get(unit, l2u_entry, DEST_TYPEf) == 1)
                        && (_l2u_field32_get(unit, l2u_entry, DESTINATIONf) 
