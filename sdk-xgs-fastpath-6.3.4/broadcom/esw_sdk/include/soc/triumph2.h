/*
 * $Id: triumph2.h 1.27 Broadcom SDK $
...
extern int soc_tr2_ser_inject_error(int unit, soc_mem_t mem, int pipeTarget, int block, int index);
extern int soc_tr2_ser_mem_test(int unit, soc_mem_t mem, _soc_ser_test_t test_type, int cmd);
extern int soc_tr2_ser_test(int unit, _soc_ser_test_t test_type);
extern int _soc_triumph2_mem_nack_error_test(int unit, _soc_ser_test_t test_type,
                                                   int *testErrors);
#endif
