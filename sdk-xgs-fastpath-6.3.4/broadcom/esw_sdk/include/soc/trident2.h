/*
 * $Id: trident2.h 1.49.2.8 Broadcom SDK $
...
#define SOC_TD2_RAM_OFFSET_ING_L3_NEXT_HOP         4096
...
extern void soc_trident2_ser_fail(int unit);
extern void soc_trident2_ser_set_long_delay(int delay);
extern void soc_trident2_ser_error(void *unit_vp, void *d1, void *d2,
                                   void *d3, void *d4);
...
extern int soc_trident2_tsc_ports_get(int unit, int tsc, int *ports_len,
                                      int *ports);
...
extern soc_error_t soc_td2_ser_inject_error(int unit, soc_mem_t mem,
                                            int pipe_target, int block,
                                            int index);
