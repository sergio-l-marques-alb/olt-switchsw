/*
 * $Id: a7bbebf4577f5e00b85f376cd3edc34f83b1bb78 $
 ...
 */
#define REGEX_DEBUG(flags, stuff) BCM_DEBUG((flags) | BCM_DBG_REGEX, stuff)
#define REGEX_OUT(stuff)          BCM_DEBUG(BCM_DBG_REGEX, stuff)
#define REGEX_WARN(stuff)         REGEX_DEBUG(BCM_DBG_WARN, stuff)
#define REGEX_ERR(stuff)          REGEX_DEBUG(BCM_DBG_ERR, stuff)
#define REGEX_VERB(stuff)         REGEX_DEBUG(BCM_DBG_VERBOSE, stuff)
#define REGEX_VVERB(stuff)        REGEX_DEBUG(BCM_DBG_VVERBOSE, stuff)
#define REGEX_SHOW(stuff)         ((*soc_cm_print) stuff)
...
#define RegexPolicyCheck(_unit_, _mem_, _field_, _value_)               \
    if ((uint32)(_value_) > (uint32)RegexPolicyMax((_unit_), (_mem_), (_field_))) { \
        REGEX_ERR(("FT(unit %d) Error: Policy _value_ %d > %d (max) mem (%d) policy (%d).\n", \
                   _unit_, (_value_),                                   \
