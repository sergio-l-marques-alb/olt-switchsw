...
extern int bcm_kt_cosq_gport_stat_get(int unit, bcm_gport_t port, 
                                bcm_cos_queue_t cosq,
                                bcm_cosq_gport_stats_t stat, uint64 *value);
...
extern int bcm_kt2_cosq_port_flush(int unit, bcm_port_t port);
extern int bcm_kt2_cosq_confirm_port_flushing(int unit);
#endif
