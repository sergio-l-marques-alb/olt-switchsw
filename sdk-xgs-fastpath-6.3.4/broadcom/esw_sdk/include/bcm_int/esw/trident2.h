...
extern int bcm_td2_fcoe_vsan_create(int unit,  bcm_fcoe_vsan_t *vsan);
extern int bcm_td2_fcoe_vsan_destroy(int unit,  bcm_fcoe_vsan_t *vsan);
...
#define _BCM_QOS_VFT_MAP_SHIFT               10
