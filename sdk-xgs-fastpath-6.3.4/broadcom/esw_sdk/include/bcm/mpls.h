/*
 * $Id: bbde4dca376c08ae9a9add81fa577d67cff44001 $
 * 
...
typedef enum bcm_mpls_port_match_e {
    ...
    BCM_MPLS_PORT_MATCH_PORT_SUBPORT_PKT_VID, /* Mod/port/trunk + LLTAG VLAN ID. */
    BCM_MPLS_PORT_MATCH_PORT_SUBPORT_PKT_VID_OUTER_VLAN, /* Mod/port/trunk + LLTAG VLAN ID +
                                           outer VLAN ID. */
    BCM_MPLS_PORT_MATCH_PORT_SUBPORT_PKT_VID_INNER_VLAN, /* Mod/port/trunk + LLTAG VLAN ID +
                                           inner VLAN ID. */
