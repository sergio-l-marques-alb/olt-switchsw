/*
 * $Id: e51da765866ffd1ed6aac1c431398681edb7ae19 $
 * 
...
typedef enum bcm_rx_control_e {
    ...
    bcmRxControlTmSnoopCount    /* Indicate the number of snoop commands used
                                   for Traffic Management (TM) processing. */
} bcm_rx_control_t;
...
typedef enum bcm_rx_trap_e {
    ...
    bcmRxTrapIcmpRedirect,              /* ICMP-Redirect is enabled,
                                           ...
                                           OutRIF. */
    bcmRxTrapOamp,                      /* . */
    bcmRxTrapOampTrapErr,               /* Packet arrived to the OAMP with
                                           illegal trap code. */
    bcmRxTrapOampTypeErr,               /* Packet arrived to the OAMP with
                                           illegal mep type. */
    bcmRxTrapOampRmepErr,               /* Packet arrived to the OAMP with RMEP
                                           index miss. */
    bcmRxTrapOampMaidErr,               /* Packet arrived to the OAMP with MAID
                                           miss. */
    bcmRxTrapOampMdlErr,                /* Packet arrived to the OAMP with MDL
                                           miss. */
    bcmRxTrapOampCcmIntrvErr,           /* Packet arrived to the OAMP with CCM
                                           interval miss. */
    bcmRxTrapOampMyDiscErr,             /* Packet arrived to the OAMP with My
                                           Discriminator miss (BFD). */
    bcmRxTrapOampSrcIpErr,              /* Packet arrived to the OAMP with
                                           source IP address miss (BFD). */
    bcmRxTrapOampYourDiscErr,           /* Packet arrived to the OAMP with Your
                                           Discriminator miss (BFD). */
    bcmRxTrapOampSrcPortErr,            /* Packet arrived to the OAMP with UDP
                                           source port miss (BFD). */
    bcmRxTrapOampRmepStateChange,       /* BFD packet arrived that does not
                                           match the current RMEP state. */
    bcmRxTrapOampParityErr,             /* Parity error occurred in the OAMP. */
    bcmRxTrapOampTimestampErr,          /* Packet arrived to the OAMP with
                                           timestamp miss. */
    bcmRxTrapOampProtection,            /* OAMP protection packet. */
    ...
    bcmRxTrapArplookupFail,             /* For ARP packet, lookup for VRF and
                                           TPA (IP) failed. */
    bcmRxTrapL2cpPeer,                  /* L2CP trapped to peer destination. */
    bcmRxTrapL2cpDrop,                  /* L2CP dropped. */
    bcmRxTrapMimMyBmacMulticastContinue, /* Terminated BMAC header indicates
