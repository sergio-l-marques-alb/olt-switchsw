/*
 * $Id: ffbf8eb1e589ccde3edd3864bcc47ae531c9761c $
 * 
...
typedef enum bcm_port_extender_type_e {
    BCM_PORT_EXTENDER_TYPE_UPLINK, 
    BCM_PORT_EXTENDER_TYPE_DOWNLINK_ACCESS, 
    BCM_PORT_EXTENDER_TYPE_DOWNLINK_TRANSIT, 
    BCM_PORT_EXTENDER_TYPE_SWITCH, 
    BCM_PORT_EXTENDER_TYPE_NONE 
} bcm_port_extender_type_t;

/* Port COS remap Selection. */
typedef enum bcm_port_cos_remap_e {
    BCM_PORT_COS_REMAP_VLAN_PRI, 
    BCM_PORT_COS_REMAP_DSCP, 
    BCM_PORT_COS_REMAP_EXP 
...
typedef enum bcm_port_class_e {
    bcmPortClassFieldLookup,            /* Class for field stage Lookup */
    bcmPortClassFieldIngress,           /* Class for field stage Ingress */
    bcmPortClassFieldEgress,            /* Class for field stage Egress */
    bcmPortClassVlanTranslateEgress,    /* Class for egress VLAN translation */
    bcmPortClassIngress,                /* Class for ingress basis grouping */
    bcmPortClassId,                     /* Class for mapping local-port to
                                           vlan-domain. vlan domain is used in
                                           mapping packet VID to Vlan */
    bcmPortClassFieldIngressPacketProcessing, /* Packet processing port Class for
                                           field stage Ingress */
    bcmPortClassFieldEgressPacketProcessing, /* Packet processing port Class for
                                           field stage Egress */
    bcmPortClassL2Lookup,               /* Class for L2 lookup */
    bcmPortClassForwardIngress,         /* Class for ingress forwarding */
    bcmPortClassForwardEgress           /* Class for egress forwarding */
} bcm_port_class_t;
...
typedef enum bcm_port_control_e {
    ...
    bcmPortControlDoNotCheckVlanFromCpu, /* Enable/disable spanning tree and Vlan
    ...
    bcmPortControlRemoteCpuEnable,      /* Enables the port to accept packets
                                           from Remote CPU */
    bcmPortControlRemoteCpuTcMapping,   /* Enable/Disable the mapping between TC
    ...
    bcmPortControlFaultResponseLocalDataAndIdle, /* If Local Fault indicated, continue
                                           sending data, send Idles */
    bcmPortControlFaultResponseLocalDataAndRf, /* If Local Fault indicated, continue
                                           sending data, send Remote Fault
                                           Indication */
    bcmPortControlFaultResponseLocalDataAndLf, /* If Local Fault indicated, continue
                                           sending data, send Local Fault
                                           Indication */
    bcmPortControlFaultResponseLocalNoDataIdle, /* If Local Fault indicated, stop
                                           sending data, send Idles */
    bcmPortControlFaultResponseLocalNoDataRf, /* If Local Fault indicated, stop
                                           sending data, send Remote Fault
                                           Indication */
    bcmPortControlFaultResponseLocalNoDataLf, /* If Local Fault indicated, stop
                                           sending data, send Local Fault
                                           Indication */
    bcmPortControlFaultResponseRemoteDataAndIdle, /* If Remote Fault indicated, continue
                                           sending data, send Idles */
    bcmPortControlFaultResponseRemoteDataAndRf, /* If Remote Fault indicated, continue
                                           sending data, send Remote Fault
                                           Indication */
    bcmPortControlFaultResponseRemoteDataAndLf, /* If Remote Fault indicated, continue
                                           sending data, send Remote Fault
                                           Indication */
    bcmPortControlFaultResponseRemoteNoDataIdle, /* If Remote Fault indicated, stop
                                           sending data, send Idles */
    bcmPortControlFaultResponseRemoteNoDataRf, /* If Remote Fault indicated, stop
                                           sending data, send Remote Fault
                                           Indication */
    bcmPortControlFaultResponseRemoteNoDataLf, /* If Remote Fault indicated, stop
                                           sending data, send Remote Fault
                                           Indication */
    bcmPortControlPCS,                  /* The Physical Coding Sub-layer of the
                                           port */
    bcmPortControlLinkDownPowerOn,      /* 0: The Link is disabled on the MAC
    ...
    bcmPortControlMplsEntropyHashSet,   /* Select one of 2 sets of configuration
                                           ...
                                           1/0) */
    bcmPortControlStripCRC,             /* If set no cell CRC is calculated,
                                           else 8-bit CRC will be added to each
                                           data cell. Relevant for VSC256 mode
                                           only. */
    bcmPortControlPrivateVlanIsolate,   /* Argument = 1/0. Enable, disable
    ...
    bcmPortControlFloodUnknownUcastGroup, /* Override the per-vsi settings. */
    bcmPortControlFloodUnknownMcastGroup, /* Override the per-vsi settings. */
    bcmPortControlFloodBroadcastGroup,  /* Override the per-vsi settings. */
    bcmPortControlDefaultQueue,         /* Specify default queue ID for use with
                                           the port */
    bcmPortControlL2GreEnable,          /* Set per port enable for L2-GRE
                                           (Value=TRUE/FALSE) */
    bcmPortControlL2GreTunnelbasedVpnId, /* Set per port VPNID lookup key
                                           (Value=TRUE/FALSE) */
    bcmPortControlL2GreDefaultTunnelEnable, /* Set per port dafult-SVP for Tunnel
                                           lookup failure(Value=TRUE/FALSE) */
    bcmPortControlL2SaAuthenticaion,    /* to enable SA authentication check on
                                           a port */
    bcmPortControlUnknownMacDaAction,   /* Per port configures set of actions
                                           that are taken by the device when an
                                           unknown destination address is
                                           recognized on an ingressing packet */
    bcmPortControlDiscardMacSaAction,   /* Per port configures set of actions
                                           that are taken by the device upon SA
                                           lookup when L2 entry flag with
                                           SA-discard */
    bcmPortControlManagementPacketIp6Reserved, /* Classify Packets with IPV6 multicast
                                           reserved address FF0X:0:0:0:0:0:0:0
                                           on a port as management frames */
    bcmPortControlManagementPacketIp4Reserved, /* Classify Packets with IPV4 multicast
                                           reserved address 224.0.0.x on a port
                                           as management frames */
    bcmPortControlManagementPacketLinkConstrained, /* Classify Packets with
                                           link-constrained multicast range
                                           DMAC=01-80-C2-00-00-0x as management
                                           frames */
    bcmPortControlManagementPacketGarp, /* Classify Packets with DA range
                                           0x0180c2000020 through 0x0180c200002f
                                           as management frames */
    bcmPortControlManagementPacketCos,  /* COS assignment for Management Packets */
    bcmPortControlManagementPacketColor, /* Drop Precedence for Management
                                           Packets */
    bcmPortControlTaggedL3PacketPktPri, /* Set packet Priority source for tagged
                                           L3 packets (enumerated value within
                                           bcm_port_cos_remap_t) */
    bcmPortControlTaggedMPLSPacketPktPri, /* Set packet Priority source for tagged
                                           MPLS packets (enumerated value within
                                           bcm_port_cos_remap_t) */
    bcmPortControlTaggedMPLSL3PacketPktPri, /* Set packet Priority source for tagged
                                           MPLS L3 packets (enumerated value
                                           within bcm_port_cos_remap_t) */
    bcmPortControlEEEEventCountSymmetric, /* Operate EEE counter in symmetric
                                           mode, where TX and RX counters
                                           increment together */
    bcmPortControlEEELinkActiveDuration, /* Time(in microsecs) to wait before EEE
                                           transitions to Active state after
                                           link status becomes active */
    bcmPortControlEsmEligibility,       /* Indicates if ESM search is enabled
                                           for packets coming in on this port */
    bcmPortControlTrillDesignatedVlan,  /* VLAN which carries Trill packets
                                           between RBridges */
    bcmPortControlMplsFRREnable,        /* Enable or disable FRR on MPLS
                                           packets. */
    bcmPortControlMplsContextSpecificLabelEnable, /* Enable or disable Upstream assignment
                                           label on MPLS packets. */
    bcmPortControlVxlanEnable,          /* Set per port enable for VXLAN
                                           (Value=TRUE/FALSE) */
    bcmPortControlVxlanTunnelbasedVnId, /* Set per port VNID lookup key
                                           (Value=TRUE/FALSE) */
    bcmPortControlVxlanDefaultTunnelEnable, /* Set per port dafult-SVP for Tunnel
                                           lookup failure(Value=TRUE/FALSE) */
    bcmPortControlFieldEgressClassSelect, /* Select Class Id to pass to EFP */
    bcmPortControlPonMpcpDiscoveryRate, /* EPON Port MPCP Discovery rate in
                                           miliseconds. */
    bcmPortControlPonMpcpDiscoveryGrantLength, /* EPON Port MPCP Discovery Grant length
                                           in bytes. */
    bcmPortControlPonMpcpOneRegistrationPerGrant, /* Allow only one registration per grant */
    bcmPortControlPonOamHeartbeatRate,  /* EPON port OAM heartbeat rate in
                                           seconds */
    bcmPortControlPonMaxLinks,          /* EPON port maximum number of links */
    bcmPortControlPonRamanMitigationMode, /* EPON port Raman Mitigation mode */
    bcmPortControlPonLoopTimeMinPropDelay, /* Epon Loop Timing Minimum Propagation
                                           Delay */
    bcmPortControlPonLoopTimeMaxPropDelay, /* Epon Loop Timing Maximum Propagation
                                           Delay */
    bcmPortControlPonLoopTimeOnuDelay,  /* Epon Loop Timing Onu Delay */
    bcmPortControlPonLoopTimeNullGrantSize, /* Epon Loop Timing Null Grant size */
    bcmPortControlPonLoopTimeOltDelay,  /* Epon Loop Timing OLT delay */
    bcmPortControlPonSfecAllowedBitErrors, /* Epon SFEC Allowed bit errors */
    bcmPortControlPonTfecAllowedBitErrors, /* Epon TFEC Allowed bit errors */
    bcmPortControlPonFecRxBypass,       /* Rx FEC Bypass mode */
    bcmPortControlPonSyncTime,          /* Epon Sync Time in 16ns(TQ) unit */
    bcmPortControlPonEncryptionMode,    /* Epon encryption mode (0 : None, 1 :
                                           AE, 2 : CTC, 3 : Zero-overhead AE). */
    bcmPortControlPonEncryptionDirection, /* Epon encryption direction (1 :
                                           downstream only, 2 : bi-direction). */
    bcmPortControlPonOamKeyExchangeMsgBypass, /* Bypass processing Key Exchange OAM
                                           from Pon port */
    bcmPortControlTunnelIdIngressSource, /* Move outermost VLAN tag to Tunnel ID
                                           on ingress */
    bcmPortControlTunnelIdEgressAdd,    /* Add outermost VLAN tag as Tunnel ID
                                           on egress */
    bcmPortControlPonOamHeartbeatTimeout, /* Epon Oam heartbeat timeout in sec
                                           unit */
    bcmPortControlPonMpcpReportTimeout, /* Epon report timeout in ms unit */
    bcmPortControlPon1GDiscoveryWindow, /* Enable 1G discovery window */
    bcmPortControlPon10GDiscoveryWindow, /* Enable 10G discovery window */
    bcmPortControlExtendedPortVid,      /* Extended port VID (value range
                                           0-0xfff) */
    bcmPortControlNonEtagDrop,          /* Set Ingress drop control, if ETAG is
                                           not present (value = TRUE/FALSE) */
    bcmPortControlEtagDrop,             /* Set Ingress drop control, if ETAG is
                                           present (value = TRUE/FALSE) */
    bcmPortControlNonEtagAdd,           /* Set ADD tag action, when ETAG is not
                                           present (value = TRUE/FALSE) */
    bcmPortControlEtagIngressReplace,   /* Set REPLACE Ingress tag action, when
                                           ETAG is present (value = TRUE/FALSE) */
    bcmPortControlEtagEgressReplace,    /* Set REPLACE Egress tag action, when
                                           ETAG is present (value = TRUE/FALSE) */
    bcmPortControlEtagIngressDelete,    /* Set DELETE Ingress tag action, when
                                           ETAG is present (value = TRUE/FALSE) */
    bcmPortControlEtagEgressDelete,     /* Set DELETE Egress tag action, when
                                           ETAG is present (value = TRUE/FALSE) */
    bcmPortControlExtenderRpfCheck,     /* Set incoming packet ETAG.SVID RPF
                                           check control (value = TRUE/FALSE) */
    bcmPortControlExtenderSourceKnockout, /* Set source extended port VID pruning
                                           control (value = TRUE/FALSE) */
    bcmPortControlExtenderForwardPort,  /* Set destination port for upstream
                                           Extender forwarding (value = local
                                           port number) */
    bcmPortControlExtenderType,         /* Set Extender port type (enumerated
                                           value within
                                           bcm_port_extender_type_t) */
    bcmPortControlExtenderNameSpace,    /* Set namespace value (value range
                                           0-0xfff) */
    bcmPortControlEtagPcpDeSelect,      /* Set source of PCP and DE fields when
                                           adding an ETAG to an ingress packet
                                           (value =
                                           bcm_extender_pcp_de_select_t) */
    bcmPortControlEtagPcp,              /* Set default PCP field when adding an
                                           ETAG to an ingress packet (value =
                                           0-7) */
    bcmPortControlEtagDe,               /* Set default DE field when adding an
                                           ETAG to an ingress packet (value =
                                           0-1) */
    bcmPortControlUseEtagPri,           /* Use ETAG PCP and DE fields to derive
                                           internal priority and color */
    bcmPortControlProhibitedDot1p,      /* Set prohibited 802.1p values */
    bcmPortControlEgressFilterDisable,  /* Enable/ disable Egress Filtering */
    bcmPortControlLLFCReceive,          /* Link Level Flow Control packet
                                           receive enable */
    bcmPortControlLLFCTransmit,         /* Link Level Flow Control packet
                                           transmit enable */
    bcmPortControlSAFCReceive,          /* Service Aware Flow Control packet
                                           receive enable */
    bcmPortControlSAFCTransmit,         /* Service Aware Flow Control packet
                                           transmit enable */
    bcmPortControlMacSwap,              /* Enable or Disable MAC swapping on the
                                           port for incoming packet */
    bcmPortControlFloodPktDropTc,       /* Set TC(internal Traffic Class) bitmap
                                           to force drop on the flooding packet
                                           per TC of this port.(e.g. bit7 for
                                           TC7) */
    bcmPortControlIngressTcSelectTable, /* Assign user defined ingress
                                           TC(internal Traffic Class) mapping
                                           mode on internal TC select Table */
    bcmPortControlOverlayRecycle,       /* Set port as recycle port for overlay
                                           packets second pass */
    bcmPortControlEvbType,              /* Set EVB port type (enumerated value
                                           within bcm_port_evb_type_t) */
    bcmPortControlOamLookupWithDvp,     /* Use DVP as one of the keys for OAM
                                           lookup */
    bcmPortControlSubportTagEnable,     /* Enable/disable 'third VLAN tag'
                                           (subport tag) channelization over
                                           Ethernet */
    bcmPortControlEgressModifyOuterPktPri, /* Enable/Disable outer tag priority
                                           modification. */
    bcmPortControlEgressModifyInnerPktPri, /* Enable/Disable inner tag priority
                                           modification. */
    bcmPortControlVMac,                 /* Enable/Disable VMAC function. */
    bcmPortControlEgressModifyDscp,     /* Enable DSCP/EXP marking. In simple
                                           mode enable on port. In advanced mode
                                           enable on inlif profile. */
    bcmPortControlFcoeRouteEnable,      /* Enables FCOE routing */
    bcmPortControlFcoeVftEnable,        /* Controls VFT header expected on port */
    bcmPortControlFcoeZoneCheckEnable,  /* Enables zone check */
    bcmPortControlFcoeSourceBindCheckEnable, /* Enables source bind check */
    bcmPortControlFcoeFpmaPrefixCheckEnable, /* Enables FPMA prefix check */
    bcmPortControlFcoeDoNotLearn,       /* Disables learning for packets with
                                           FCOE ethertype */
    bcmPortControlFcoeNetworkPort,      /* Sets whether the port is network
                                           (uplink) or not (downfacing) */
    bcmPortControlFcoeFabricSel,        /* Selects the source of fabric Id and
                                           priority */
    bcmPortControlFcoeFabricId,         /* Sets the port default 12-bit fabric
                                           Id */
    bcmPortControlFcoeFabricPri,        /* Sets the port default fabric priority */
    bcmPortControlFcoeFcCrcAction,      /* Sets the FC CRC action to take */
    bcmPortControlFcoeFcCrcRecompute,   /* Sets the re-compute CRC options */
    bcmPortControlFcoeFcEofIgnore,      /* Sets the control to Ignore EOF */
    bcmPortControlMcastGroupRemap,      /* Enable remapping of multicast group
                                           index. */
    bcmPortControlLocalSwitching,       /* to enable Local route switching on a
                                           port */
    bcmPortControlFecErrorDetectEnable, /* Enables marking of failed error
                                           correction on the cells */
    bcmPortControlLowLatencyLLFCEnable, /* Enables an improvment in latency on
                                           the expense of bandwidth */
    bcmPortControlErspanEnable,         /* Enable/Disable ERSPAN mirroring */
    bcmPortControlPFCXOffTime,          /* Priority Flow Control xoff time */
    bcmPortControlOamDefaultProfile,    /* OAM default profile */
    bcmPortControlSubportPktTagDrop,    /* Set Ingress drop control, if LLTAG is
                                           present  (value = TRUE/FALSE) */
    bcmPortControlNoSubportPktTagDrop,  /* Set Ingress drop control, if LLTAG is
                                           not present  (value = TRUE/FALSE) */
    bcmPortControlUseSubportPktTagPri,  /* Use LLTAG PCP and DE fields to derive
                                           internal priority and color */
    bcmPortControlVlanVpGroupEgress,    /* VP group for egress vlan membership */
    bcmPortControlVlanVpGroupIngress,   /* VP group for ingress vlan membership */
    bcmPortControlEEEMode,              /* Select Energy Efficient Ethernet mode */
    bcmPortControlProbeSerdesReset,     /* Request to reset SerDes on next probe
                                           to the SerDes */
    ...
    bcmPortControlRxFastLOS = 282,      /* Enable/disable accelerated linkscan
                                           capability on port */
    bcmPortControlFcoeTranslateKeyFirst, /* The key to use for the first VLAN
                                           translate search if the Ethertype is
                                           FCOE */
    bcmPortControlFcoeTranslateKeySecond, /* The key to use for the second VLAN
                                           translate search if the Ethertype is
                                           FCOE */
    bcmPortControlMmuDrain,             /* Draining the cells of the port */
    bcmPortControlMmuTrafficEnable,     /* Enable/disable enqueing the packets
                                           to the port */
    bcmPortControlStatCollectionEnable  /* Enable/disable the gathering of MIB
                                           statistics on the port */
} bcm_port_control_t;

/* EEE modes. */
typedef enum bcm_port_eee_mode_e {
    bcmPortEEENativeMode,       /* EEE native mode */
    bcmPortEEEBurstAndBatchMode /* EEE burst and batch mode */
} bcm_port_eee_mode_t;

/* Types of Tunnel ID. */
typedef enum bcm_port_tunnel_id_e {
    BCM_PORT_TUNNEL_ID_NONE,    /* No Tunnel ID */
    BCM_PORT_TUNNEL_ID_VLAN     /* VLAN tag as Tunnel ID */
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_PORT_PCP_VLAN,       /*  Mod/port/trunk + outer VLAN + outer
                                           PCP. */
    BCM_PORT_MATCH_PORT_PCP_VLAN_STACKED, /*  Mod/port/trunk + outer/inner VLAN +
                                           outer/inner PCP. */
    BCM_PORT_MATCH_PORT_INITIAL_VLAN,   /*  Mod/port/trunk + Initial-VID */
    BCM_PORT_MATCH_PORT_PON_TUNNEL,     /*  Mod/port/trunk + PON Tunnel Value. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_VLAN, /*  Mod/port/trunk + PON Tunnel Value +
                                           outer VLAN. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_VLAN_STACKED, /*  Mod/port/trunk + PON Tunnel Value +
                                           outer VLAN + inner VLAN. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_PCP_VLAN, /*  Mod/port/trunk + PON Tunnel Value +
                                           outer PCP + outer VLAN. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_PCP_VLAN_STACKED, /*  Mod/port/trunk + PON Tunnel Value +
                                           outer PCP + outer VLAN + inner VLAN. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_PCP_VLAN_ETHERTYPE, /*  Mod/port/trunk + PON Tunnel Value +
                                           Outer PCP + outer VLAN + Ethertype. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_PCP_VLAN_VLAN_ETHERTYPE, /*  Mod/port/trunk + PON Tunnel Value +
                                           Outer PCP + outer VLAN + Inner VLAN +
                                           Ethertype. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_ETHERTYPE, /*  Mod/port/trunk + PON Tunnel Value +
                                           Ethertype. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_VLAN_ETHERTYPE, /*  Mod/port/trunk + PON Tunnel Value +
                                           outer VLAN + Ethertype. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_VLAN_STACKED_ETHERTYPE, /*  Mod/port/trunk + PON Tunnel Value +
                                           outer VLAN + inner VLAN + Ethertype. */
    BCM_PORT_MATCH_PORT_VLAN16,         /* Mod/port/trunk + 16-bit outer VLAN
                                           tag. */
    BCM_PORT_MATCH_PORT_PON_TUNNEL_PCP, /* Mod/port/trunk + PON Tunnel Value +
                                           outer PCP. */
...
typedef enum bcm_port_evb_type_e {
    bcmPortEvbTypeNone, 
    bcmPortEvbTypeUplinkAccess, 
    bcmPortEvbTypeCount         /* Must be last */
} bcm_port_evb_type_t;
...
typedef enum bcm_port_field_egress_class_select_e {
    bcmPortEgressClassSelectNone,       /* Class Id Not Assigned. */
    bcmPortEgressClassSelectPort,       /* Class Id from Port Interface. */
    bcmPortEgressClassSelectSvp,        /* Class Id from SVP. */
    bcmPortEgressClassSelectL3Interface, /* Class Id from L3 IIF Interface. */
    bcmPortEgressClassSelectFieldSrc,   /* Class Id from VFP HI. */
    bcmPortEgressClassSelectFieldDst,   /* Class Id from VFP LOW. */
    bcmPortEgressClassSelectL2Src,      /* Class Id from L2 SRC. */
    bcmPortEgressClassSelectL2Dst,      /* Class Id from L2 DST. */
    bcmPortEgressClassSelectL3Src,      /* Class Id from L3 SRC. */
    bcmPortEgressClassSelectL3Dst,      /* Class Id from L3 DST. */
    bcmPortEgressClassSelectVlan,       /* Class Id from VLAN Interface. */
    bcmPortEgressClassSelectVrf,        /* Class Id from VRF. */
    bcmPortEgressClassSelectFieldIngress, /* Class Id from IFP Policy Table. */
    bcmPortEgressClassSelectCount       /* Always Last. Not a usable value. */
...
typedef enum bcm_stat_threshold_type_e {
    bcmStatThresholdDisabled, 
    bcmStatThresholdSingle, 
    bcmStatThresholdRange, 
    bcmStatThresholdZero, 
    bcmStatThresholdSigned 
...
typedef enum bcm_port_fcoe_vsan_select_e {
    bcmPortFcoeVsanSelectVft,       /* use VFT header */
    bcmPortFcoeVsanSelectPort,      /* use Port Table value */
    bcmPortFcoeVsanSelectInnerVlan, /* use incoming inner VID/COS */
    bcmPortFcoeVsanSelectOuterVlan  /* use incoming outer VID/COS */
