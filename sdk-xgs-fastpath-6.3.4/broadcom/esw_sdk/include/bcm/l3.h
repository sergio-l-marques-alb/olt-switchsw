/*
 * $Id: 210867859c4a3a03c5f728d17b60a0686c2de445 $
 * 
...
typedef struct bcm_l3_egress_ecmp_s {
    ...
    bcm_if_t ecmp_intf;                 /* L3 interface ID pointing to egress
                                           ecmp object. */
    int max_paths;                      /* Max number of paths in ECMP group. */
...
typedef enum bcm_l3_route_stat_e {
    bcmL3RouteInPackets,    /* Packets that ingress on the l3 route */
    bcmL3RouteInBytes       /* Bytes that ingress on the l3 route */
} bcm_l3_route_stat_t;
...
typedef enum bcm_l3_ip4_options_action_e {
    bcmIntfIPOptionActionNone,          /* No action. */
    bcmIntfIPOptionActionCopyToCPU,     /* Copy to CPU action. */
    bcmIntfIPOptionActionDrop,          /* Drop action. */
    bcmIntfIPOptionActionCopyCPUAndDrop /* Copy to CPU and Drop action. */
