/*
 * $Id: phy542xx_regdefs.h 1.14 Broadcom SDK $ 
...
/*REGS used to enable RDB register access mode */
...
/* REGS used to Rd/Wr using RDB mode */
...
/*
     Disable direct RDB addressing mode, write to Expansion register 0x7E = 0x8000
     1. MDIO write to reg 0x17 = 0x0F7E
     2. MDIO write to reg 0x15 = 0x8000
    */
#define PHY_BCM542XX_DIS_RDB_MODE(temp) {\
    (temp) = PHY_BCM542XX_REG_1E_SELECT_RDB;\
    SOC_IF_ERROR_RETURN \
        (PHY_BCM542XX_WRITE_PHY_REG(unit, pc, PHY_BCM542XX_RDB_ADDR_REG_OFFSET, temp));\
    (temp) = PHY_BCM542XX_REG_15_RDB_DIS;\
    SOC_IF_ERROR_RETURN \
        (PHY_BCM542XX_WRITE_PHY_REG(unit, pc, PHY_BCM542XX_RDB_DATA_REG_OFFSET, temp));\
}

/*
     Enable direct RDB addressing mode, write to Expansion register 0x7E = 0x0000
     1. MDIO write to reg 0x17 = 0x0F7E
     2. MDIO write to reg 0x15 = 0x0000
    */
#define PHY_BCM542XX_EN_RDB_MODE(temp) {\
    temp = PHY_BCM542XX_REG_17_SELECT_EXP_7E;\
    SOC_IF_ERROR_RETURN \
        (PHY_BCM542XX_WRITE_PHY_REG(unit, pc, PHY_BCM542XX_REG_17_OFFSET, temp));\
    temp = PHY_BCM542XX_REG_15_RDB_EN;\
    SOC_IF_ERROR_RETURN \
        (PHY_BCM542XX_WRITE_PHY_REG(unit, pc, PHY_BCM542XX_REG_15_OFFSET, temp));\
}
...
#define PHY_BCM542XX_TOP_MISC_MII_BUFF_CNTL_PHYN(n) (PHY_BCM542XX_TOP_MISC_MII_BUFF_CNTL_PHY0 +  BMACSEC_TOP_MISC_REG_SIZE*(n)*2/*skip one reg*/)
 ...
 *  
*/
#define PHY_BCM542XX_TOP_INTERRUPT_STATUS 0x82c
 ...
 *  
*/
#define PHY_BCM542XX_TOP_INTERRUPT_MASK 0x82d
...
#define PHY_BCM542XX_TOP_MISC_DPATH_SEL_REG_MACSEC_BPASS_PORTN(n) ((PHY_BCM542XX_TOP_MISC_DPATH_SEL_REG_MACSEC_BPASS_PORT0) << (n))
...
#define PHY_BCM542XX_TOP_MISC_MACSEC_RESET_REG_RST_PORTN(n)  (PHY_BCM542XX_TOP_MISC_MACSEC_RESET_REG_RST_PORT0 << (n))
...
#define PHY_BCM542XX_TOP_MISC_MACSEC_PHYA_DUPLEX_CFG_REG_SP_SW_DUPLEX_PORTN(n) (PHY_BCM542XX_TOP_MISC_MACSEC_PHYA_DUPLEX_CFG_REG_SP_SW_DUPLEX_PORT0 << (n))
 ...
 *
*/
#define SIZE_OF_PHY_BCM542XX_TOP_1588_REGS 1
#define PHY_BCM542XX_TOP_1588_TX_MODE_PORT_0_OFFSET (0xA11) 
#define PHY_BCM542XX_TOP_1588_TX_MODE_PORT_N_OFFSET(n) (PHY_BCM542XX_TOP_1588_TX_MODE_PORT_0_OFFSET + (SIZE_OF_PHY_BCM542XX_TOP_1588_REGS * (n)))
...
#define PHY_BCM542XX_TOP_1588_RX_MODE_PORT_N_OFFSET(n) (PHY_BCM542XX_TOP_1588_RX_MODE_PORT_0_OFFSET + (SIZE_OF_PHY_BCM542XX_TOP_1588_REGS * (n)))
...
#define PHY_BCM542XX_TOP_1588_RX_PORTN_LINK_DELAY_LSB(N) \
                ...
                + (N) * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS * (2) /*skip one MSB register*/)
...
#define PHY_BCM542XX_TOP_1588_TX_PORT_N_TS_OFFSET_MSB(N) (PHY_BCM542XX_TOP_1588_TX_PORT_0_TS_OFFSET_MSB + (N) * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS * (2) /*skip one LSB register*/)
...
#define PHY_BCM542XX_TOP_1588_RX_PORT_N_TS_OFFSET_LSB(N) (PHY_BCM542XX_TOP_1588_RX_PORT_0_TS_OFFSET_LSB + (N) * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS * (2) /*skip one MSB register*/)
...
#define PHY_BCM542XX_TOP_1588_RX_PORT_N_TS_OFFSET_MSB(N) (PHY_BCM542XX_TOP_1588_RX_PORT_0_TS_OFFSET_MSB + (N) * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS * (2) /*skip one LSB register*/)
...
#define PHY_BCM542XX_TOP_1588_NSE_NCO_6_REG_GMODE  (BIT15 | BIT14)
#define PHY_BCM542XX_TOP_1588_NSE_NCO_6_REG_TS_CAP (BIT13)
#define PHY_BCM542XX_TOP_1588_NSE_NCO_6_REG_NSE_INIT (BIT12)
#define PHY_BCM542XX_TOP_1588_NSE_NCO_6_REG_FRAMESYN_MODE (BIT5 | BIT4 | BIT3 | BIT2)
#define PHY_BCM542XX_TOP_1588_NSE_NCO_6_REG_SYNCOUT_MODE (BIT1 | BIT0)
...
#define PHY_BCM542XX_TOP_1588_TS_RD_START_END_REG_TS_END(n)   (BIT1 << (2*n))
#define PHY_BCM542XX_TOP_1588_TS_RD_START_END_REG_TS_START(n) (BIT0 << (2*n))
#define PHY_BCM542XX_TOP_1588_TS_RD_START_END_ALL_PORTS       (0xffff)
/*
...
#define PHY_BCM542XX_TOP_1588_LABEL_N_LSB_MASK_REG_OFFSET(n) (PHY_BCM542XX_TOP_1588_LABEL1_LSB_MASK_REG_OFFSET + (n-1) * PHY_BCM542XX_TOP_1588_NEXT_LABEL_OFFSET * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS)
...
#define PHY_BCM542XX_TOP_1588_LABEL_N_MSB_MASK_REG_OFFSET(n) (PHY_BCM542XX_TOP_1588_LABEL1_MSB_MASK_REG_OFFSET + (n-1) * PHY_BCM542XX_TOP_1588_NEXT_LABEL_OFFSET * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS)
...
#define PHY_BCM542XX_TOP_1588_LABEL_N_LSB_VAL_REG_OFFSET(n) (PHY_BCM542XX_TOP_1588_LABEL1_LSB_VAL_REG_OFFSET + (n-1) * PHY_BCM542XX_TOP_1588_NEXT_LABEL_OFFSET * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS)
...
#define PHY_BCM542XX_TOP_1588_LABEL_N_MSB_VAL_REG_OFFSET(n) (PHY_BCM542XX_TOP_1588_LABEL1_MSB_VAL_REG_OFFSET + (n-1) * PHY_BCM542XX_TOP_1588_NEXT_LABEL_OFFSET * SIZE_OF_PHY_BCM542XX_TOP_1588_REGS)
...
#define PHY_BCM542XX_TOP_1588_RX_CF_UPD(dev_port) ((1 << (dev_port) *2))
#define PHY_BCM542XX_TOP_1588_RX_CS_UPD(dev_port) ((2 << (dev_port) *2))
...
#define PHY_BCM542XX_TOP_1588_TX_CS_UPD_MODE2(dev_port) ((1 << (dev_port) *2))
#define PHY_BCM542XX_TOP_1588_TX_CS_UPD_MODE3(dev_port) ((2 << (dev_port) *2))
...
#define PHY_BCM542XX_TOP_1588_64b_TIMECODE_SEL_RX_N(port) (PHY_BCM542XX_TOP_1588_64b_TIMECODE_SEL_RX_0 << port)
#define PHY_BCM542XX_TOP_1588_64b_TIMECODE_SEL_TX_0 (BIT0)
#define PHY_BCM542XX_TOP_1588_64b_TIMECODE_SEL_TX_N(port) (PHY_BCM542XX_TOP_1588_64b_TIMECODE_SEL_TX_0 << port)
...
#define PHY_BCM542XX_TOP_1588_SOP_SEL_TX_PORT_N(port) ((port) << PHY_BCM542XX_TOP_1588_SOP_SEL_TX_PORT_0_SHIFT)
#define PHY_BCM542XX_TOP_1588_SOP_SEL_RX_PORT_N(port) ((port) << PHY_BCM542XX_TOP_1588_SOP_SEL_RX_PORT_0_SHIFT)

/*
 * TOP_1588_INBAND_CNTL_0 
 *
 *
*/
...
#define PHY_BCM542XX_TOP_1588_TIMESTAMP_DELTA_1 (BIT15)
#define PHY_BCM542XX_TOP_1588_TIMESTAMP_DELTA_2 (BIT14)
#define PHY_BCM542XX_TOP_1588_TIMESTAMP_DELTA_0 (0x3fff)
