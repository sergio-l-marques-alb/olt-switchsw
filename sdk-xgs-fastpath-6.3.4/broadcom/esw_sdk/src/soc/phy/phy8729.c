/*
 * $Id: phy8729.c 1.26 Broadcom SDK $
 *
...
phy_8729_init(int unit, soc_port_t port)
{
    ...
    if (mmi_mdio_addr < 0) {
        soc_cm_debug(DK_WARN, "phy_8729_init: "
    ...
    if(rv != BMACSEC_E_NONE) {
        SOC_DEBUG_PRINT((DK_WARN, "phy_8729_init: bmacsec_phy_mac_addr_set "
    ...
    SOC_DEBUG_PRINT((DK_PHY, "phy_8729_init: "
...
phy_8729_enable_set(int unit, soc_port_t port, int enable)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY, "phy_8729_enable_set: "
...
phy_8729_firmware_set(int unit, int port, int offset, uint8 *data,int len)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY,"PHY8729 firmware upgrade successful:"
                             "u=%d p=%d\n", unit, port));
