/*
 * $Id: b89f56c644296bbcd313244f7da540d817fa87cf $
...
drv_dino16_mem_clear(int unit, uint32 mem)
{
    ...
    soc_cm_debug(DK_MEM, "drv_dino16_mem_clear : mem=0x%x\n", mem);
    switch (mem) {
        case DRV_MEM_ARL:
        case DRV_MEM_ARL_HW:
            mem_id = INDEX(L2_ARLm);
    ...
    uint32 *key, uint32 *entry, uint32 *entry1, uint32 flags)
{
    ...
    soc_cm_debug(DK_MEM, "drv_dino16_mem_search : mem=0x%x, flags = 0x%x)\n",
         mem, flags);
    switch (mem) {
        case DRV_MEM_ARL:
        case DRV_MEM_MARL:
...
drv_dino16_mem_insert(int unit, uint32 mem, uint32 *entry, uint32 flags)
{
    ...
    soc_cm_debug(DK_MEM, "drv_dino16_mem_insert : mem=0x%x, flags = 0x%x)\n",
         mem, flags);
    switch (mem) {
        case DRV_MEM_ARL:
        case DRV_MEM_MARL:            
    ...
    uint32 flags)
{
    ...
    soc_cm_debug(DK_MEM, "drv_dino16_mem_delete : mem=0x%x, flags = 0x%x)\n",
         mem, flags);
    switch (mem) {
        case DRV_MEM_ARL:
        case DRV_MEM_MARL:
