    ...
    uint32 burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "_drv_polar_port_erc_set: \
    ...
    uint8 queue_n, uint32 limit, uint32 burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "_drv_polar_port_erc_per_queue_set: \
        unit = %d, port = %d, limit = %d, burst_size = %d\n",
        unit, port, limit, burst_size);
    ...
    uint32 *burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "_drv_polar_port_erc_get: \
    ...
    uint8 queue_n, uint32 *limit, uint32 *burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "_drv_polar_port_erc_per_queue_get: \
      unit = %d, port = %d, limit = %dK, burst size = %dKB\n", 
      unit, port, *limit, *burst_size);
    ...
    uint32 burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "_drv_gex_port_erc_set: \
        unit = %d, port = %d, limit = %d, burst_size = %d\n", 
        unit, port, limit, burst_size);
    ...
    uint32 *burst_size)
{
    ...
    soc_cm_debug(DK_PORT, "_drv_gex_port_erc_get: \
        unit = %d, port = %d, limit = %dK, burst size = %dKB\n", 
        unit, port, *limit, *burst_size);
    ...
    uint32 value)
{
    ...
    soc_cm_debug(DK_PORT, "drv_gex_rate_config_set: \
     ...
     uint32 *value)
{
    ...
    soc_cm_debug(DK_PORT, "drv_gex_rate_config_get: \
