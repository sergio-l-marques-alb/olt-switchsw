/*
 * $Id: shr_template.c 1.20.2.1 Broadcom SDK $
 * 
                      ...
                      int *is_allocated)
{
    ...
    if ((flags & SHR_TEMPLATE_MANAGE_IGNORE_DATA) && !(flags & SHR_TEMPLATE_MANAGE_SET_WITH_ID)) {
        TEMPLATE_ERR((TEMPLATE_MSG1("SHR_TEMPLATE_MANAGE_IGNORE_DATA is only valid in combination with SHR_TEMPLATE_MANAGE_SET_WITH_ID\n")));
        return BCM_E_PARAM;
    }
