/*
 * $Id: switchctl.c 1.3 Broadcom SDK $
...
cmd_ea_switch_control(int unit, args_t *a)
{
    ...
    if (!sal_strcasecmp(subcmd, "show")) {
        ...
        printk("bcmSwitchPonOamFailsafeState = %d\n", arg);
        ...
        printk("bcmSwitchEquipmentAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchPowerAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchBatteryMissingAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchBatteryFailureAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchBatteryVoltLowAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchPhysicalIntrusionAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchSelfTestFailureAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchPonIfSwitchAlarmState = %d\n", arg);
        ...
        printk("bcmSwitchBatteryVoltLowAlarmReportThreshold = %d\n", arg);
        ...
        printk("bcmSwitchBatteryVoltLowAlarmClearThreshold = %d\n", arg);
