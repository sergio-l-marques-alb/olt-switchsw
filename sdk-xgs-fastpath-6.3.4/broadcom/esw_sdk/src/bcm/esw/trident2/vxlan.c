/*
 * $Id: vxlan.c 1.90.2.2 Broadcom SDK $
 *
...
STATIC int _bcm_td2_vxlan_sd_tag_set( int unit, bcm_vxlan_vpn_config_t *vxlan_vpn_info, 
                         ...
                         int *tpid_index );
STATIC void  _bcm_td2_vxlan_egr_xlate_entry_key_set(int unit, int vp, bcm_vpn_t vpn, bcm_vxlan_port_match_t criteria,
                                  egr_vlan_xlate_entry_t   *tr_ent, int clean_flag);
STATIC int _bcm_td2_vxlan_egr_xlate_entry_reset(int unit, bcm_vpn_t vpn, int vp, bcm_vxlan_port_match_t criteria);
STATIC void _bcm_td2_vxlan_sd_tag_get( int unit, bcm_vxlan_vpn_config_t *vxlan_vpn_info, 
                         bcm_vxlan_port_t *vxlan_port, 
                         egr_l3_next_hop_entry_t *egr_nh, 
                         egr_vlan_xlate_entry_t   *vxlate_entry,
                         int network_port_flag );
STATIC int _bcm_td2_vxlan_port_get(int unit, bcm_vpn_t vpn, int vp, bcm_vxlan_port_t  *vxlan_port);
...
bcm_td2_vxlan_vpn_create(int unit, bcm_vxlan_vpn_config_t *info)
{
    ...
    if ((info->flags & BCM_VXLAN_VPN_WITH_VPNID) || 
        (info->flags & BCM_VXLAN_VPN_SERVICE_TAGGED)) {
        rv = _bcm_td2_vxlan_egr_xlate_entry_set(unit, &vxlate_entry);
        if (info->flags & BCM_VXLAN_VPN_WITH_VPNID) {
            BCM_IF_ERROR_RETURN(rv);
        } else  if (info->flags & BCM_VXLAN_VPN_SERVICE_TAGGED) {
            _BCM_VXLAN_CLEANUP(rv);
        }
    } 
    return rv;
...
bcm_td2_vxlan_vpn_destroy(int unit, bcm_vpn_t l2vpn)
{
    ...
    rv = _bcm_td2_vxlan_egr_xlate_entry_reset(unit, l2vpn, -1, BCM_VXLAN_PORT_MATCH_VN_ID);
    BCM_IF_ERROR_RETURN(rv);
...
bcm_td2_vxlan_vpn_get( int unit, bcm_vpn_t l2vpn, bcm_vxlan_vpn_config_t *info)
{
    ...
    /* Get SDTAG settings */
    (void) _bcm_td2_vxlan_egr_xlate_entry_key_set(unit, -1,
                      l2vpn, BCM_VXLAN_PORT_MATCH_VN_ID, &vxlate_entry, 1);

    rv = soc_mem_search(unit, EGR_VLAN_XLATEm, MEM_BLOCK_ANY, &vxlate_index,
                    &vxlate_entry, &vxlate_entry, 0);
    if (BCM_SUCCESS(rv)) {
          (void)  _bcm_td2_vxlan_sd_tag_get( unit, info, NULL, NULL,
                            &vxlate_entry, 1);
    }
...
STATIC void
_bcm_td2_vxlan_multicast_tunnel_state_set (int unit, int  tunnel_idx, uint8 tunnel_state)
{
    _bcm_td2_vxlan_bookkeeping_t *vxlan_info;
...
/*
 * Function:
 *          _bcm_td2_vxlan_multicast_tunnel_state_get
 * Purpose:
 *          Set VXLAN Tunnel terminator Multicast State
 * Returns: BCM_E_XXX
 */
...
STATIC void
_bcm_td2_vxlan_multicast_tunnel_state_get (int unit, 
...
bcm_td2_vxlan_multicast_leaf_entry_check(int unit, bcm_ip_t mc_ip_addr, bcm_ip_t  src_ip_addr, int multicast_flag)
{
    ...
    uint8 tunnel_multicast_state = _BCM_VXLAN_TUNNEL_TERM_DEFAULT;
    ...
    if (tunnel_ref_count < 1) {
        ...
        return BCM_E_NONE;
         ...
         (void ) _bcm_td2_vxlan_multicast_tunnel_state_get (unit, 
...
bcm_td2_vxlan_tunnel_terminator_create(int unit, bcm_tunnel_terminator_t *tnl_info)
{
    ...
    if (BCM_SUCCESS(rv) && (tunnel_idx != -1)) {
       ...
       vxlan_info->vxlan_tunnel_term[tunnel_idx].tunnel_state = _BCM_VXLAN_TUNNEL_TERM_DEFAULT;
    }
    return rv;
}
...
bcm_td2_vxlan_tunnel_terminator_get(int unit, bcm_tunnel_terminator_t *tnl_info)
{
    ...
    if (soc_VLAN_XLATEm_field32_get(unit, &vxlate_entry,
        VXLAN_DIP__IGNORE_UDP_CHECKSUMf) == 0) {
...
bcm_td2_vxlan_port_egress_nexthop_reset(int unit, int nh_index, int vp_type, int vp, bcm_vpn_t vpn)
{
    ...
    BCM_IF_ERROR_RETURN(soc_mem_read(unit, hw_mem, 
                                  MEM_BLOCK_ANY, nh_index, &egr_nh));
    if (0x1 == soc_mem_field32_get(unit, hw_mem, &egr_nh,
                                  L3__DVP_VALIDf)) { /* Only for VXLAN Multicast Nexthops */
                                         ...
                                         vlan_xlate_entry_t *return_ent)
{
    ...
    soc_VLAN_XLATEm_field32_set(unit, return_ent, XLATE__VLAN_ACTION_VALIDf,1);
...
_bcm_td2_vxlan_elan_port_add(int unit, bcm_vpn_t vpn, bcm_vxlan_port_t *vxlan_port)
{
    ...
    source_vp_entry_t svp;
    source_vp_2_entry_t svp_2_entry;
    int tpid_enable = 0, tpid_index=-1, tunnel_idx=-1;
   ...
   /* ======== Allocate/Get Virtual_Port =============== */
    ...
    /* Set Tunnel-State for Multicast-Tunnels */
    if ((vxlan_port->flags & BCM_VXLAN_PORT_EGRESS_TUNNEL) &&
       (vxlan_port->flags & BCM_VXLAN_PORT_MULTICAST)) {
        tunnel_idx = BCM_GPORT_TUNNEL_ID_GET(vxlan_port->match_tunnel_id);
        (void)  _bcm_td2_vxlan_multicast_tunnel_state_set(unit, 
...
_bcm_td2_vxlan_elan_port_delete(int unit, bcm_vpn_t vpn, int vp)
{
    ...
    if (vxlan_port.flags & BCM_VXLAN_PORT_EGRESS_TUNNEL) {
        tunnel_idx = BCM_GPORT_TUNNEL_ID_GET(vxlan_port.match_tunnel_id);
        (void)  _bcm_td2_vxlan_multicast_tunnel_state_set(unit, 
                             tunnel_idx, _BCM_VXLAN_TUNNEL_TERM_DEFAULT);
    }
...
bcm_td2_vxlan_port_delete(int unit, bcm_vpn_t vpn, bcm_gport_t vxlan_port_id)
{
    ...
    if (bcm_esw_vxlan_stat_id_get(unit, vxlan_port_id, vpn,
    ...
    if (num_ctr != 0) {
        BCM_IF_ERROR_RETURN(
           bcm_esw_vxlan_stat_detach(unit, vxlan_port_id, vpn));
    }
