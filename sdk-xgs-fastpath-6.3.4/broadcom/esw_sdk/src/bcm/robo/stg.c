...
_bcm_robo_stg_vlan_add(int unit, bcm_stg_t stg, bcm_vlan_t vid)
{
    ...
    if ((stg_cur != stg) || 
        ...
        BCM_IF_ERROR_RETURN(bcm_vlan_stg_set(unit, vid, stg));
...
STATIC int
_bcm_robo_stg_vlan_remove(int unit, bcm_stg_t stg, bcm_vlan_t vid)
{
    bcm_stg_info_t  *si = &robo_stg_info[unit];
    int  stg_cur;
    ...
    BCM_IF_ERROR_RETURN(bcm_vlan_stg_set(unit, vid, si->stg_defl));
...
int bcm_robo_stg_init(int unit)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_init()..\n");
...
bcm_robo_stg_clear(int unit)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_clear()..\n");
    CHECK_INIT(unit, si);
...
bcm_robo_stg_default_get(int unit, bcm_stg_t *stg_ptr)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_default_get()..\n");
    CHECK_INIT(unit, si);
...
bcm_robo_stg_default_set(int unit, bcm_stg_t stg)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_default_set()..\n");
    if (!STG_BITMAP_TST(si, stg)) {
        return BCM_E_NOT_FOUND;
    }
...
bcm_robo_stg_vlan_add(int unit, bcm_stg_t stg, bcm_vlan_t vid)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_vlan_add()..\n");
    CHECK_INIT(unit, si);
    CHECK_STG(si, stg);
...
bcm_robo_stg_vlan_remove(int unit, bcm_stg_t stg, bcm_vlan_t vid)
{
   bcm_stg_info_t  *si = &robo_stg_info[unit];
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_vlan_remove()..\n");
    CHECK_INIT(unit, si);
    CHECK_STG(si, stg);
    _ROBO_VLAN_CHK_ID(unit, vid);

    rv = _bcm_robo_stg_vlan_remove(unit, stg, vid);
...
bcm_robo_stg_vlan_remove_all(int unit, bcm_stg_t stg)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_vlan_remove_all()..\n");
    CHECK_INIT(unit, si);
    CHECK_STG(si, stg);
    ...
    while ((vid = si->vlan_first[stg]) != VLAN_NULL) {
        if ((rv = _bcm_robo_stg_vlan_remove(unit, stg, vid)) < 0) {
            return rv;
        }
			     ...
			     bcm_vlan_t **list, int *count)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_vlan_list()..\n");
    CHECK_INIT(unit, si);
    CHECK_STG(si, stg);
...
bcm_robo_stg_vlan_list_destroy(int unit, bcm_vlan_t *list, int count)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_vlan_list_destroy()..\n");
    if (list != NULL) {
	sal_free(list);
    }
...
bcm_robo_stg_create(int unit, bcm_stg_t *stg_ptr) /* Generate new ID */
{
   bcm_stg_info_t  *si = &robo_stg_info[unit];
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_create()..\n");
    CHECK_INIT(unit, si);
...
bcm_robo_stg_create_id(int unit, bcm_stg_t stg)	/* Use specific ID */
{
   bcm_stg_info_t  *si = &robo_stg_info[unit];
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_create_id()..\n");
    CHECK_INIT(unit, si);
    CHECK_STG(si, stg);
...
bcm_robo_stg_destroy(int unit, bcm_stg_t stg)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_destroy()..\n");
    CHECK_INIT(unit, si);
    CHECK_STG(si, stg);
...
bcm_robo_stg_list(int unit, bcm_stg_t **list, int *count)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_list()..\n");
    CHECK_INIT(unit, si);
...
bcm_robo_stg_list_destroy(int unit, bcm_stg_t *list, int count)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_list_destroy()..\n");
    if (list != NULL) {
        sal_free(list);
    }
...
bcm_robo_stg_count_get(int unit, int *max_stg)
{
    ...
    soc_cm_debug(DK_STP, "BCM API : bcm_robo_stg_count_get()..\n");
    CHECK_INIT(unit, si);
