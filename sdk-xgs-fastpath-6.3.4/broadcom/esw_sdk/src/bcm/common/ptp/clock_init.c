    ...
    bcm_ptp_clock_info_t *clock_info)
{
    ...
    if (soc_feature(unit, soc_feature_ptp)) {
        ...
        _bcm_common_ptp_unit_array[unit].stack_array[ptp_id].clock_array[clock_info->clock_num].clock_info = *clock_info;
        _bcm_common_ptp_unit_array[unit].stack_array[ptp_id].clock_array[clock_info->clock_num].in_use = 1;
