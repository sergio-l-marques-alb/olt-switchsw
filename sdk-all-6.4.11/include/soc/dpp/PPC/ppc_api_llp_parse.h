...
typedef struct
{
   ...
   *  SOC_PPD_TRAP_CODE_ACCEPTABLE_FRAME_TYPE_DROP to drop
   *  packet. Use trap code
   *  SOC_PPD_TRAP_CODE_ACCEPTABLE_FRAME_TYPE_ACCEPT to accept
   *  packet.use SOC_PPD_TRAP_CODE_ACCEPTABLE_FRAME_TYPE_CUSTOM1
   *  and SOC_PPD_TRAP_CODE_ACCEPTABLE_FRAME_TYPE_CUSTOM2 for
