...
typedef enum
{
   ...
   *  SOC_PPD_TRAP_CODE_UC_LOOSE_RPF_FAIL trap code
   *  Relevant for: Soc_petra-B, Arad.
   */
   ...
   *  if fail packet is trapped/snooped according to
   *  SOC_PPD_TRAP_CODE_MC_EXPLICIT_RPF_FAIL trap code
   *  Relevant for: Soc_petra-B, Arad.
   */
   ...
   *  packet is trapped according to SOC_PPD_TRAP_CODE_MC_USE_SIP_RPF_FAIL
   *  if fail packet is trapped/snooped according to
   *  SOC_PPD_TRAP_CODE_MC_USE_SIP_RPF_FAIL trap code
   *  or SOC_PPD_TRAP_CODE_MC_USE_SIP_ECMP if SIP lookup returned ECMP
   ...
   *  to the trap code SOC_PPD_TRAP_CODE_MC_USE_SIP_ECMP
   *  if fail packet is trapped/snooped according to
   *  SOC_PPD_TRAP_CODE_MC_USE_SIP_AS_IS_RPF_FAIL trap code
   *  Relevant for: Soc_petra-B, Arad.
   */
...
typedef enum
{
   ...
   *  with trap code SOC_PPD_TRAP_CODE_FACILITY_INVALIDIn order to
...
typedef enum
{
   ...
   *  - see SOC_PPD_FRWRD_FEC_MATCH_RULE.
   */
...
typedef struct
{
   ...
   *  packet with trap code SOC_PPD_TRAP_CODE_FEC_ENTRY_ACCESSED,
