...
#define SOC_PPC_OAM_NUMBER_OF_BITS_USED_BY_OUTLIF_PCP       ((SOC_IS_JERICHO_B0_AND_ABOVE(unit))? 1 :0  )
...
typedef struct {
    ...
    uint8 forwarding_strength;/* Ingress*/
...
#define SOC_PPC_BFD_DISCRIMINATOR_TO_ACC_MEP_ID_START_MASK         (SOC_PPC_OAM_MAX_NUMBER_OF_LOCAL_MEPS(unit) -1) /* Should be mapped to a legal MEP-DB entry*/
