/* $Id: arad_pp_api_frwrd_extend_p2p.h,v 1.5 Broadcom SDK $
...
#ifndef __ARAD_PP_API_FRWRD_EXTEND_P2P_INCLUDED__
/* { */
#define __ARAD_PP_API_FRWRD_EXTEND_P2P_INCLUDED__
...
typedef SOC_PPC_FRWRD_EXTEND_P2P_GLBL_LIF_INFO                 ARAD_PP_FRWRD_EXTEND_P2P_GLBL_LIF_INFO;
typedef SOC_PPC_FRWRD_EXTEND_P2P_GLBL_INFO                     ARAD_PP_FRWRD_EXTEND_P2P_GLBL_INFO;
typedef SOC_PPC_FRWRD_EXTEND_P2P_FRWRD_INFO                    ARAD_PP_FRWRD_EXTEND_P2P_FRWRD_INFO;
typedef SOC_PPC_FRWRD_EXTEND_PWE_KEY                           ARAD_PP_FRWRD_EXTEND_PWE_KEY;
 ...
 *     "arad_pp_frwrd_extend_p2p_glbl_info_set" API.
 *     Refer to "arad_pp_frwrd_extend_p2p_glbl_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __ARAD_PP_API_FRWRD_EXTEND_P2P_INCLUDED__*/
#endif
