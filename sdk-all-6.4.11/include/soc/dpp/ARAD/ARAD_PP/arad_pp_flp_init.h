...
#define PROG_FLP_FC_REMOTE                          0x13 /* FCoE*/
#define PROG_FLP_FC_WITH_VFT_REMOTE                 0x14 /* FCoE*/
#define PROG_FLP_FC                                 0x15 /* FCoE*/
#define PROG_FLP_FC_WITH_VFT                        0x16 /* FCoE*/
...
#define PROG_FLP_FC_N_PORT                          0x28 /* FCoE*/
#define PROG_FLP_FC_WITH_VFT_N_PORT                 0x29 /* FCoE*/
...
#define PROG_FLP_LAST                               (PROG_FLP_IPV4UC_PUBLIC_RPF)
