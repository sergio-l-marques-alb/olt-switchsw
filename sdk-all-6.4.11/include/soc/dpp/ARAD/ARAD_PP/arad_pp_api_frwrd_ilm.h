/* $Id: arad_pp_api_frwrd_ilm.h,v 1.6 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/ARAD/ARAD_PP/include/arad_pp_api_frwrd_ilm.h
*
...
#ifndef __ARAD_PP_API_FRWRD_ILM_INCLUDED__
/* { */
#define __ARAD_PP_API_FRWRD_ILM_INCLUDED__
...
#define ARAD_PP_FRWRD_ILM_TABLE_NOF_ENTRIES                     ARAD_PP_LEM_NOF_ENTRIES
...
typedef SOC_PPC_FRWRD_ILM_GLBL_KEY_INFO                        ARAD_PP_FRWRD_ILM_GLBL_KEY_INFO;
typedef SOC_PPC_FRWRD_ILM_GLBL_ELSP_INFO                       ARAD_PP_FRWRD_ILM_GLBL_ELSP_INFO;
typedef SOC_PPC_FRWRD_ILM_KEY                                  ARAD_PP_FRWRD_ILM_KEY;
typedef SOC_PPC_FRWRD_ILM_GLBL_INFO                            ARAD_PP_FRWRD_ILM_GLBL_INFO;

/*     SOC_PPC_FRWRD_ILM_KEY_XXX flags */
#define ARAD_PP_FRWRD_ILM_KEY_COUPLING                     (SOC_PPC_FRWRD_ILM_KEY_COUPLING)
...
/*********************************************************************
* NAME:
 *   arad_pp_frwrd_ilm_glbl_info_set
 * TYPE:
 *   PROC
 * FUNCTION:
 ...
 *     "arad_pp_frwrd_ilm_glbl_info_set" API.
 *     Refer to "arad_pp_frwrd_ilm_glbl_info_set" API for
 *     details.
*********************************************************************/
uint32
...
void
  ARAD_PP_FRWRD_ILM_GLBL_KEY_INFO_clear(
    SOC_SAND_OUT ARAD_PP_FRWRD_ILM_GLBL_KEY_INFO *info
  );

void
  ARAD_PP_FRWRD_ILM_GLBL_ELSP_INFO_clear(
    SOC_SAND_OUT ARAD_PP_FRWRD_ILM_GLBL_ELSP_INFO *info
  );

void
  ARAD_PP_FRWRD_ILM_KEY_clear(
    SOC_SAND_OUT ARAD_PP_FRWRD_ILM_KEY *info
  );

void
  ARAD_PP_FRWRD_ILM_GLBL_INFO_clear(
    SOC_SAND_OUT ARAD_PP_FRWRD_ILM_GLBL_INFO *info
  );

#if ARAD_PP_DEBUG_IS_LVL1

void
  ARAD_PP_FRWRD_ILM_GLBL_KEY_INFO_print(
    SOC_SAND_IN  ARAD_PP_FRWRD_ILM_GLBL_KEY_INFO *info
  );

void
  ARAD_PP_FRWRD_ILM_GLBL_ELSP_INFO_print(
    SOC_SAND_IN  ARAD_PP_FRWRD_ILM_GLBL_ELSP_INFO *info
  );

void
  ARAD_PP_FRWRD_ILM_KEY_print(
    SOC_SAND_IN  ARAD_PP_FRWRD_ILM_KEY *info
  );

void
  ARAD_PP_FRWRD_ILM_GLBL_INFO_print(
...
/* } __ARAD_PP_API_FRWRD_ILM_INCLUDED__*/
#endif
