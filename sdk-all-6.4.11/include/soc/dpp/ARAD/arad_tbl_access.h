...
#define ARAD_PP_RIF_RIF_PROFILE_STRUCTURE_IPMC_BRIDGE_V4MC_BIT  3
...
typedef struct
{
  ...
  uint32 ipmc_bridge_v4mc_enable_mask;
...
/*********************************************************************
* NAME:
 *   arad_tbl_mem_cache_dma_set
 * FUNCTION:
 *   Set DMA caching mode for supported tables
 * INPUT:
 *  unit id
 *  value. 0/1
*********************************************************************/
void arad_tbl_mem_cache_dma_set(int unit, uint32 value);
/*********************************************************************
* NAME:
 *   arad_tbl_mem_cache_dma_get
 * FUNCTION:
 *   Get DMA caching mode
 * INPUT:
 *  unit id
 * Returns:
 *  DMA caching mode value
*********************************************************************/
uint32 arad_tbl_mem_cache_dma_get(int unit);
