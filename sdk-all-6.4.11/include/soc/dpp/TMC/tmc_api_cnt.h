...
#define SOC_TMC_CNT_LIF_COUNTING_NOF_RANGES 2
#define SOC_TMC_CNT_LIF_COUNTING_NOF_PROFILES_PER_SOURCE 2
#define SOC_TMC_CNT_LIF_COUNTING_NOF_PROFILES (SOC_TMC_CNT_LIF_COUNTING_NOF_PROFILES_PER_SOURCE * SOC_TMC_CNT_LIF_COUNTING_NOF_SOURCES)
