...
#define SOC_TMC_ITM_VSQ_QT_RT_CLS_MAX  (SOC_IS_ARADPLUS_AND_BELOW(unit) ? 15 : 31)
...
#define SOC_TMC_ITM_DBUFF_SIZE_BYTES_MAX SOC_TMC_ITM_DBUFF_SIZE_BYTES_2048
   ...
   */
#define SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE 4
  /*
   *  32: Category & Traffic Class VSQs: 4 categories * 8 Traffic Classes
   */
#define SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE 32
  /*
   *  64: 32 Category2/3 & Connection Class VSQs: (2 Category2/3 * 32 Connection Class)
   */
#define SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE 64
  /*
   *  256: Statistics VSQs
   */
#define SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE 256
  /*
  *  32: LLFCs
  */
#define SOC_TMC_ITM_ARAD_VSQ_GROUPE_SZE 32
  /*
  *  256: PFCs
  */
#define SOC_TMC_ITM_ARAD_VSQ_GROUPF_SZE 256
typedef int SOC_TMC_ITM_ARAD_VSQ_NDX_RNG;

  /*
   *  ITM-VSQ first index: Value 0
   */
#define SOC_TMC_ITM_ARAD_VSQ_NDX_MIN 0
  /*
   *  ITM-VSQ last index = sum of group sizes:Value 355.
   */       
#define SOC_TMC_ITM_ARAD_VSQ_NDX_MAX_PETRA \
        (SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE + \
         SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE + \
         SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE + \
         SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE - 1)
#define SOC_TMC_ITM_ARAD_VSQ_NDX_RNG_LAST_PETRA (SOC_TMC_ITM_ARAD_VSQ_NDX_MAX_PETRA + 1)
  /*
   *  Must be the last value
   */
#define SOC_TMC_ITM_ARAD_VSQ_NDX_MAX   \
    (SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE + \
     SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE + \
     SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE + \
     SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE + \
     SOC_TMC_ITM_ARAD_VSQ_GROUPE_SZE + \
     SOC_TMC_ITM_ARAD_VSQ_GROUPF_SZE - 1)
 /*
  *  Must be the last value
  */
#define SOC_TMC_ITM_ARAD_VSQ_NDX_RNG_LAST (SOC_TMC_ITM_ARAD_VSQ_NDX_MAX + 1)
  /*
   *  4: Category VSQs: There are 4 categories.
   */
#define SOC_TMC_ITM_JERICHO_VSQ_GROUPA_SZE 4
  /*
   *  32: Category & Traffic Class VSQs: 4 categories * 8 Traffic Classes
   */
#define SOC_TMC_ITM_JERICHO_VSQ_GROUPB_SZE 32
  /*
   *  64: 32 Category2/3 & Connection Class VSQs: (2 Category2/3 * 32 Connection Class)
   */
#define SOC_TMC_ITM_JERICHO_VSQ_GROUPC_SZE 64
  /*
   *  256: Statistics VSQs
   */
#define SOC_TMC_ITM_JERICHO_VSQ_GROUPD_SZE 256
  /*
  *  32: LLFCs
  */
#define SOC_TMC_ITM_JERICHO_VSQ_GROUPE_SZE 128
  /*
  *  256: PFCs
  */
#define SOC_TMC_ITM_JERICHO_VSQ_GROUPF_SZE 512

  /*
   *  ITM-VSQ first index: Value 0
   */
#define SOC_TMC_ITM_JERICHO_VSQ_NDX_MIN 0
#define SOC_TMC_ITM_JERICHO_VSQ_NDX_MAX    \
    (SOC_TMC_ITM_JERICHO_VSQ_GROUPA_SZE +  \
     SOC_TMC_ITM_JERICHO_VSQ_GROUPB_SZE +  \
     SOC_TMC_ITM_JERICHO_VSQ_GROUPC_SZE +  \
     SOC_TMC_ITM_JERICHO_VSQ_GROUPD_SZE +  \
     SOC_TMC_ITM_JERICHO_VSQ_GROUPE_SZE +  \
     SOC_TMC_ITM_JERICHO_VSQ_GROUPF_SZE - 1)
 /*
  *  Must be the last value
  */
#define SOC_TMC_ITM_JERICHO_VSQ_NDX_RNG_LAST (SOC_TMC_ITM_JERICHO_VSQ_NDX_MAX + 1)

#define SOC_TMC_ITM_VSQ_GROUPA_SZE(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPA_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE)
#define SOC_TMC_ITM_VSQ_GROUPB_SZE(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPB_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE)
#define SOC_TMC_ITM_VSQ_GROUPC_SZE(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPC_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE)
#define SOC_TMC_ITM_VSQ_GROUPD_SZE(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPD_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE)
#define SOC_TMC_ITM_VSQ_GROUPE_SZE(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPE_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPE_SZE)
#define SOC_TMC_ITM_VSQ_GROUPF_SZE(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPF_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPF_SZE)

#define SOC_TMC_ITM_VSQ_NDX_MIN(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_NDX_MIN : SOC_TMC_ITM_ARAD_VSQ_NDX_MIN)
#define SOC_TMC_ITM_VSQ_NDX_MAX(unit) (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_NDX_MAX : SOC_TMC_ITM_ARAD_VSQ_NDX_MAX)
...
typedef struct
{
  ...
  /* Packet Q head pointer */
  uint32 pq_head_ptr;

  /* 0: Q is empty, 1: Q has data */
...
typedef struct
{
  /*  the guaranteed queue size in bytes */
  uint32 guaranteed_size;
  /*  the guaranteed queue size in buffers, not used in Soc_petra */
