...
#define SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_SERVER                         SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_SERVER
...
/* For BFD - explicit timeout detection time setting */
#define SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_BFD_TIMEOUT_SET_EXPLICITLY     SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_BFD_TIMEOUT_SET_EXPLICITLY
/* For OAM this flag is used to by down MEP server when tx_gport is LAG */
#define SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_DOWNMEP_TX_GPORT_IS_LAG        SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_DOWNMEP_TX_GPORT_IS_LAG
...
#define SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_MEP_EGRESS_ONLY                SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_MEP_EGRESS_ONLY
#define SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_BFD_ECHO                       SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_BFD_ECHO
#define SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_LOOPBACK_PERIOD_IN_PPS         SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_LOOPBACK_PERIOD_IN_PPS
...
#define SOC_PPD_OAM_MAX_PROTECTION_HEADER_SIZE                     SOC_PPC_OAM_MAX_PROTECTION_HEADER_SIZE
#define SOC_PPD_OAM_FULL_PROTECTION_HEADER_SIZE                    SOC_PPC_OAM_FULL_PROTECTION_HEADER_SIZE
...
typedef SOC_PPC_OAM_OAMP_PROTECTION_HEADER                         SOC_PPD_OAM_OAMP_PROTECTION_HEADER;
