...
#define  SOC_PPD_RIF_MPLS_LABEL_FRR                     (SOC_PPC_RIF_MPLS_LABEL_FRR)
#define  SOC_PPD_RIF_MPLS_LABEL_COUPLING                (SOC_PPC_RIF_MPLS_LABEL_COUPLING)
#define  SOC_PPD_RIF_MPLS_LABEL_ELI                     (SOC_PPC_RIF_MPLS_LABEL_ELI)
#define  SOC_PPD_RIF_MPLS_LABEL_EXPECT_BOS              (SOC_PPC_RIF_MPLS_LABEL_EXPECT_BOS)
#define  SOC_PPD_RIF_MPLS_LABEL_LOOKUP_NONE             (SOC_PPC_RIF_MPLS_LABEL_LOOKUP_NONE)
#define  SOC_PPD_RIF_MPLS_LABEL_EVPN_IML                (SOC_PPC_RIF_MPLS_LABEL_EVPN_IML)

/*
 * termination key to include both SIP
 */
#define  SOC_PPD_RIF_IP_TERM_FLAG_IPV6          (SOC_PPC_RIF_IP_TERM_FLAG_IPV6)
#define  SOC_PPD_RIF_IP_TERM_FLAG_KEY_ONLY      (SOC_PPC_RIF_IP_TERM_FLAG_KEY_ONLY)
#define  SOC_PPD_RIF_IP_TERM_FLAG_USE_DIP_DUMMY (SOC_PPC_RIF_IP_TERM_FLAG_USE_DIP_DUMMY)
...
#define SOC_PPD_RIF_MAX_NOF_ROUTING_ENABLERS_BITMAPS           SOC_PPC_RIF_MAX_NOF_ROUTING_ENABLERS_BITMAPS


#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_NONE                     SOC_PPC_RIF_ROUTE_ENABLE_TYPE_NONE
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_IP_UC                    SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IP_UC
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_IPV4_UC                  SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IPV4_UC
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_IPV6_UC                  SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IPV6_UC
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_IP_MC                    SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IP_MC
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_IPV4_MC                  SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IPV4_MC
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_IPV6_MC                  SOC_PPC_RIF_ROUTE_ENABLE_TYPE_IPV6_MC
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_MPLS                     SOC_PPC_RIF_ROUTE_ENABLE_TYPE_MPLS
#define SOC_PPD_RIF_ROUTE_ENABLE_TYPE_ALL                      SOC_PPC_RIF_ROUTE_ENABLE_TYPE_ALL
typedef SOC_PPC_RIF_ROUTE_ENABLE_TYPE                          SOC_PPD_RIF_ROUTE_ENABLE_TYPE;

typedef SOC_PPC_RIF_MPLS_LABELS_RANGE                          SOC_PPD_RIF_MPLS_LABELS_RANGE;
typedef SOC_PPC_MPLS_LABEL_RIF_KEY                             SOC_PPD_MPLS_LABEL_RIF_KEY;
typedef SOC_PPC_RIF_INFO                                       SOC_PPD_RIF_INFO;
typedef SOC_PPC_RIF_IP_TERM_INFO                               SOC_PPD_RIF_IP_TERM_INFO;
typedef SOC_PPC_RIF_IP_TERM_KEY                               SOC_PPD_RIF_IP_TERM_KEY;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_rif_get_procs_ptr(void);
