...
#define SOC_PPD_LLP_VID_ASSIGN_MATCH_RULE_TYPE_TAGGED          SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE_TAGGED
#define SOC_PPD_LLP_VID_ASSIGN_MATCH_RULE_TYPE_UNTAGGED        SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE_UNTAGGED
#define SOC_PPD_LLP_VID_ASSIGN_MATCH_RULE_TYPE_ALL             SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE_ALL
typedef SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE                 SOC_PPD_LLP_VID_ASSIGN_MATCH_RULE_TYPE;

typedef SOC_PPC_LLP_VID_ASSIGN_PORT_INFO                       SOC_PPD_LLP_VID_ASSIGN_PORT_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_MAC_INFO                        SOC_PPD_LLP_VID_ASSIGN_MAC_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_IPV4_SUBNET_INFO                SOC_PPD_LLP_VID_ASSIGN_IPV4_SUBNET_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_PRTCL_INFO                      SOC_PPD_LLP_VID_ASSIGN_PRTCL_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE                      SOC_PPD_LLP_VID_ASSIGN_MATCH_RULE;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_llp_vid_assign_get_procs_ptr(void);
