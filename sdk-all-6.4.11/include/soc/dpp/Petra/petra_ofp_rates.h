/* $Id: soc_petra_ofp_rates.h,v 1.5 Broadcom SDK $
...
#ifndef __SOC_PETRA_OFP_RATES_INCLUDED__
/* { */
#define __SOC_PETRA_OFP_RATES_INCLUDED__
...
#define SOC_PETRA_OFP_RATES_CAL_LEN_EGQ_MAX           0x0080
#define SOC_PETRA_OFP_RATES_CALCAL_LEN_EGQ_MAX        0x0080
#define SOC_PETRA_OFP_RATES_CAL_LEN_SCH_MAX           0x0400
#define SOC_PETRA_OFP_RATES_CAL_LEN_SCH_OFFSET        0x1000
#define SOC_PETRA_OFP_RATES_CAL_CPU_BASE_SCH_OFFSET   0x0800
#define SOC_PETRA_OFP_RATES_CAL_RCY_BASE_SCH_OFFSET   0x2800
 ...
 */
typedef uint32 SOC_PETRA_OFP_SCH_RATES_CAL_ENTRY;
...
typedef struct
{
  SOC_PETRA_OFP_EGQ_RATES_CAL_ENTRY slots[SOC_PETRA_OFP_RATES_CAL_LEN_EGQ_MAX];
...
typedef struct
{
  SOC_PETRA_OFP_SCH_RATES_CAL_ENTRY slots[SOC_PETRA_OFP_RATES_CAL_LEN_SCH_MAX];
}SOC_PETRA_OFP_RATES_CAL_SCH;

typedef enum
{
  SOC_PETRA_OFP_RATES_EGQ_MAL_00   = 0,
  SOC_PETRA_OFP_RATES_EGQ_MAL_01   = 1,
  SOC_PETRA_OFP_RATES_EGQ_MAL_02   = 2,
  SOC_PETRA_OFP_RATES_EGQ_MAL_03   = 3,
  SOC_PETRA_OFP_RATES_EGQ_MAL_04   = 4,
  SOC_PETRA_OFP_RATES_EGQ_MAL_05   = 5,
  SOC_PETRA_OFP_RATES_EGQ_MAL_06   = 6,
  SOC_PETRA_OFP_RATES_EGQ_MAL_07   = 7,
  SOC_PETRA_OFP_RATES_EGQ_MAL_CPU  = 8,
  SOC_PETRA_OFP_RATES_EGQ_MAL_RCY  = 9,
  SOC_PETRA_OFP_RATES_EGQ_NOF_MALS = 10,
  SOC_PETRA_OFP_RATES_EGQ_MAL_INVALID = 0xff
 ...
 */
uint32
  soc_petra_ofp_rates_port_mal_get(
...
uint32
  soc_petra_ofp_rates_test_settings_unsafe(
    SOC_SAND_IN  int                    unit,
...
/* } __SOC_PETRA_OFP_RATES_INCLUDED__*/
#endif
