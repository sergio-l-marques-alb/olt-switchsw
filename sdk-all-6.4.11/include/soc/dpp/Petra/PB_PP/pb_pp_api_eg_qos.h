/* $Id: pb_pp_api_eg_qos.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_eg_qos.h
*
...
#ifndef __SOC_PB_PP_API_EG_QOS_INCLUDED__
/* { */
#define __SOC_PB_PP_API_EG_QOS_INCLUDED__
...
#define SOC_PB_PP_EG_QOS_UNIFORM_PHP_POP_INTO_IPV4             SOC_PPC_EG_QOS_UNIFORM_PHP_POP_INTO_IPV4
#define SOC_PB_PP_EG_QOS_UNIFORM_PHP_POP_INTO_IPV6             SOC_PPC_EG_QOS_UNIFORM_PHP_POP_INTO_IPV6
#define SOC_PB_PP_NOF_EG_QOS_UNIFORM_PHP_TYPES                 SOC_PPC_NOF_EG_QOS_UNIFORM_PHP_TYPES
typedef SOC_PPC_EG_QOS_UNIFORM_PHP_TYPE                        SOC_PB_PP_EG_QOS_UNIFORM_PHP_TYPE;

typedef SOC_PPC_EG_QOS_MAP_KEY                                 SOC_PB_PP_EG_QOS_MAP_KEY;
typedef SOC_PPC_EG_ENCAP_QOS_MAP_KEY                           SOC_PB_PP_EG_ENCAP_QOS_MAP_KEY;
typedef SOC_PPC_EG_QOS_PARAMS                                  SOC_PB_PP_EG_QOS_PARAMS;
typedef SOC_PPC_EG_ENCAP_QOS_PARAMS                            SOC_PB_PP_EG_ENCAP_QOS_PARAMS;
typedef SOC_PPC_EG_QOS_PHP_REMARK_KEY                          SOC_PB_PP_EG_QOS_PHP_REMARK_KEY;
typedef SOC_PPC_EG_QOS_PORT_INFO                               SOC_PB_PP_EG_QOS_PORT_INFO;
 ...
 *     "soc_pb_pp_eg_qos_port_info_set" API.
 *     Refer to "soc_pb_pp_eg_qos_port_info_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_qos_params_php_remark_set" API.
 *     Refer to "soc_pb_pp_eg_qos_params_php_remark_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_qos_params_remark_set" API.
 *     Refer to "soc_pb_pp_eg_qos_params_remark_set" API for
 *     details.
*********************************************************************/
uint32
...
void
  SOC_PB_PP_EG_ENCAP_QOS_MAP_KEY_print(
    SOC_SAND_IN  SOC_PB_PP_EG_ENCAP_QOS_MAP_KEY *info
  );
...
/* } __SOC_PB_PP_API_EG_QOS_INCLUDED__*/
#endif
