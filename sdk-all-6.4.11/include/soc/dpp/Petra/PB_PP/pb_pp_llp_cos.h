/* $Id: soc_pb_pp_llp_cos.h,v 1.6 Broadcom SDK $
...
#ifndef __SOC_PB_PP_LLP_COS_INCLUDED__
/* { */
#define __SOC_PB_PP_LLP_COS_INCLUDED__
...
#define SOC_PB_PP_LLP_TRAP_NOF_UD_ETHER_TYPE   (7)


/* $Id: soc_pb_pp_llp_cos.h,v 1.6 Broadcom SDK $
* Number of User Priority to Traffic class tables
*/
#define SOC_PB_PP_LLP_COS_NOF_UP_TO_TC_TABLES (4)

/*
* Number of User Priority to Drop Precedence tables
*/
#define SOC_PB_PP_LLP_COS_NOF_UP_TO_DP_TABLES (2)

/*
* Number of Drop Eligibility to Drop Precedence tables
*/
#define SOC_PB_PP_LLP_COS_NOF_DE_TO_DP_TABLES (1)

/*
* Maximum value of User Priority.
*/
#define SOC_PB_PP_LLP_COS_MAX_UP (7)

/*
* Maximum value of DE (Drop Eligibility )
*/
#define SOC_PB_PP_LLP_COS_MAX_DE (1)

/*
* Maximum value of DP (Drop Precedence)
*/
#define SOC_PB_PP_LLP_COS_MAX_DP (3)
...
typedef enum
{
  ...
  SOC_PB_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_L4_PORT_RANGE_INFO_GET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_L4_PORT_RANGE_TO_TC_INFO_SET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_L4_PORT_RANGE_TO_TC_INFO_GET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_IPV4_SUBNET_BASED_SET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_IPV4_SUBNET_BASED_GET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_PROTOCOL_BASED_SET_PRINT,
  ...
  SOC_PB_PP_LLP_COS_PROTOCOL_BASED_GET_PRINT,
  SOC_PB_PP_LLP_COS_PROTOCOL_BASED_GET_VERIFY,
  SOC_PB_PP_LLP_COS_PROTOCOL_BASED_GET_UNSAFE,
  SOC_PB_PP_LLP_COS_GET_PROCS_PTR,
  SOC_PB_PP_LLP_COS_GET_ERRS_PTR,
  /*
   * } Auto generated. Do not edit previous section.
   */

  SOC_PB_PP_LLP_COS_PROTOCOL_BASED_ETHER_TYPE_PROCESS,

  /*
   * Last element. Do no touch.
   */
  SOC_PB_PP_LLP_COS_PROCEDURE_DESC_LAST
} SOC_PB_PP_LLP_COS_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  SOC_PB_PP_LLP_COS_LOCAL_PORT_NDX_OUT_OF_RANGE_ERR = SOC_PB_PP_ERR_DESC_BASE_LLP_COS_FIRST,
  ...
  SOC_PB_PP_LLP_COS_ETHER_TYPE_NDX_OUT_OF_RANGE_ERR,
  SOC_PB_PP_LLP_COS_SUCCESS_OUT_OF_RANGE_ERR,
  SOC_PB_PP_LLP_COS_DEFAULT_DP_OUT_OF_RANGE_ERR,
  SOC_PB_PP_LLP_COS_TC_OUT_OF_RANGE_ERR,
  ...
  SOC_PB_PP_LLP_COS_DEFAULT_TC_OUT_OF_RANGE_ERR,
   ...
   * Last element. Do no touch.
   */
  SOC_PB_PP_LLP_COS_ERR_LAST
} SOC_PB_PP_LLP_COS_ERR;
...
uint32
  soc_pb_pp_llp_cos_l2_next_prtcl_type_to_ndx(
    SOC_SAND_IN  SOC_PB_PP_L2_NEXT_PRTCL_TYPE prtcl_type,
 ...
 *     "soc_pb_pp_llp_cos_glbl_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_cos_glbl_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_llp_cos_glbl_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_cos_port_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_cos_port_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_llp_cos_port_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_cos_mapping_table_entry_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_cos_mapping_table_entry_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_cos_mapping_table_entry_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_cos_l4_port_range_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_cos_l4_port_range_info_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_cos_l4_port_range_info_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_cos_l4_port_range_to_tc_info_set_unsafe" API.
 *     Refer to
 *     "soc_pb_pp_llp_cos_l4_port_range_to_tc_info_set_unsafe" API
 *     for details.
*********************************************************************/
 ...
 *     Identifier of the device to access.
 *   SOC_SAND_IN  uint32                                  entry_ndx -
 *     Entry index in the subnet table. Range: Soc_petraB: 0 - 15.
 *     T20E: 0 - 23.
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_cos_ipv4_subnet_based_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_cos_ipv4_subnet_based_set_unsafe"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_cos_ipv4_subnet_based_get_unsafe(
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_cos_protocol_based_set_unsafe" API.
 *     Refer to "soc_pb_pp_llp_cos_protocol_based_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_cos_protocol_based_get_unsafe(
...
/* } __SOC_PB_PP_LLP_COS_INCLUDED__*/
#endif
