/* $Id: soc_pb_ssr.h,v 1.5 Broadcom SDK $
...
#ifndef __SOC_PB_SSR_H_INCLUDED__
/* { */
#define __SOC_PB_SSR_H_INCLUDED__
...
#define SOC_PB_SSR_BASE_SAND_VER 2830 /* first driver version supporting soc_petra SSR */
...
typedef struct
{
  SOC_PB_SW_DB_DEVICE_SSR_V01  ssr_v01;

}  SOC_PB_SSR_DATA_V01;

typedef struct
{
  SOC_PB_SW_DB_DEVICE_SSR_V02  ssr_v01;

}  SOC_PB_SSR_DATA_V02;

typedef SOC_PB_SSR_DATA_V01 SOC_PB_SSR_DATA;
...
typedef struct
{
  ...
  SOC_PB_SSR_HEADER device_header;

  union
  {
    SOC_PB_SSR_DATA_V01 ssr_data;

    uint8         stream[sizeof(SOC_PB_SSR_DATA_V01)];
  }info;
...
typedef struct
{
  ...
  union
  {
    SOC_PB_SSR_DATA_V02 ssr_data;

    uint8         stream[sizeof(SOC_PB_SSR_DATA_V02)];
  }info;

}  SOC_PB_SSR_BUFF_V02;

typedef SOC_PB_SSR_BUFF_V01 SOC_PB_SSR_BUFF;
