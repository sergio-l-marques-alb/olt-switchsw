...
typedef struct _sbZfC2PpInitialQueueStateEntry {
  uint32 m_uEnetSmacMcast;
  uint32 m_uEnetVlan0Eq3FF;
  uint32 m_uEnetVlan0EqZero;
  uint32 m_uSyncSPortLt1024;
  uint32 m_uUnkMpls0Lbl;
  uint32 m_uUnkMpls1Lbl;
  uint32 m_uUnkMpls2Lbl;
  uint32 m_uEnetVlan2EqZero;
  uint32 m_uEnetVlan2Eq3FF;
  uint32 m_uIpv6SaOrDaMatch;
  uint32 m_uIpv6SaOrDaLpbk;
  uint32 m_uIpv4SaOrDaMatch;
  uint32 m_uIpv4SaOrDaMartian;
  uint32 m_uUdpSpEqDp;
  uint32 m_uTcpTinyFrag;
  uint32 m_uTcpSynFin;
  uint32 m_uTcpXmasScan;
  uint32 m_uTcpNullScan;
  uint32 m_uTcpSpEqDp;
  uint32 m_uEnetTypeValue;
  uint32 m_uEnetMacEqZero;
  uint32 m_uInvPppAddrCtrl;
  uint32 m_uInvPppPid;
  uint32 m_uEnetVlan1EqZero;
  uint32 m_uEnetVlan1Eq3FF;
  uint32 m_uEnetSmacEqDmac;
  uint32 m_uInvGreRes0;
  uint32 m_uIpv4SaOrDaLpbk;
  uint32 m_uIpv4RuntPkt;
  uint32 m_uIpv4Options;
  uint32 m_uInvIpv4Checksum;
  uint32 m_uInvIpv4Version;
  uint32 m_uInvIpv4RuntHdr;
  uint32 m_uIpv4LenError;
  uint32 m_uIpv4PktLenErr;
  uint32 m_uIpv4InvSa;
  uint32 m_uIpv4InvDa;
  uint32 m_uIpv4SaEqDa;
  uint32 m_uIpv6RuntPkt;
  uint32 m_uInvIpv6Ver;
  uint32 m_uIpv6PktLenErr;
  uint32 m_uIpv6InvSa;
  uint32 m_uIpv6InvDa;
  uint32 m_uIpv6SaEqDa;
  uint32 m_uQueueHash;
  uint32 m_uHeaderShift;
  uint32 m_uHeaderType;
  uint32 m_uState;
  uint32 m_uVariable;
...
#define SB_ZF_C2PPINITIALQUEUESTATEENTRY_GET_QUEUEHASH(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32) (pFromData)[9] << 6; \
           (nToData) |= (uint32) (pFromData)[10] << 14; \
           (nToData) |= (uint32) (pFromData)[11] << 22; \
           (nToData) |= (uint32) ((pFromData)[12] & 0x03) << 30; \
          } while(0)
