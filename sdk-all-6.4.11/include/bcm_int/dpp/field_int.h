...
/*typedef struct _bcm_dpp_field_qual_set_s {
    SHR_BITDCL w[_SHR_BITDCLSIZE(SOC_PPD_NOF_FP_QUAL_TYPES)]; 
} _bcm_dpp_field_qual_set_t;

typedef struct _bcm_dpp_field_action_set_s {
    SHR_BITDCL w[_SHR_BITDCLSIZE(SOC_PPD_NOF_FP_ACTION_TYPES)]; 
 ...
 * Type of this element is, effectively, ARAD_PP_FP_ACTION_TYPE.
 * See NUM_ACTION_ELEMENTS above.
 */
...
typedef struct _bcm_dpp_field_group_s {
    ...
    SHR_BITDCL pqset[_SHR_BITDCLSIZE(SOC_PPD_NOF_FP_QUAL_TYPES)];         /* DPP qualifiers */
    /*_bcm_dpp_field_action_set_t paset;  */        
    SHR_BITDCL paset[_SHR_BITDCLSIZE(SOC_PPD_NOF_FP_ACTION_TYPES)];    /* DPP actions */
...
typedef struct _bcm_dpp_field_stage_s {
    ...
    SHR_BITDCL ppqset[_SHR_BITDCLSIZE(SOC_PPD_NOF_FP_QUAL_TYPES)];           /* presel PPD qual set */
...
typedef struct _bcm_jericho_added_action_s {
    ...
    bcm_field_action_t bcmAction ;
       ...
       */
    ARAD_PP_FP_ACTION_TYPE added_actions[SOC_PPC_NOF_FP_DATABASE_STAGES_ARAD][3] ;
...
typedef struct _bcm_jericho_field_added_actions_s {
       ...
       */
    ARAD_FP_DATABASE_STAGE num_stages ;
      /*
       * Number of stages in the 'added_actions' array below.
       */
 ...
 *      obligatory sequential decisions as written. It'd be better if this
