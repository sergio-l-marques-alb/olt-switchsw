...
typedef struct bcm_dpp_trill_state_s {
    int                                         init;
    int                                         mask_set;
    SOC_PPD_AC_ID                               trill_out_ac;   
    SOC_PPD_LIF_ID                              trill_local_in_lif;
 ...
 */
int 
_bcm_dpp_trill_gport_to_fwd_decision(int unit, bcm_gport_t gport, bcm_multicast_t mc_id, SOC_PPD_FRWRD_DECISION_INFO  *fwd_decsion);
