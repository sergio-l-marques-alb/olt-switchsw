...
#define _BCM_DPP_AM_NOF_GLOBAL_IN_LIF_BANKS(_unit) (_BCM_DPP_AM_NOF_GLOBAL_IN_LIFS(_unit) / _BCM_DPP_AM_GLOBAL_LIF_NOF_ENTRIES_PER_BANK)
...
#define _BCM_DPP_AM_NOF_GLOBAL_OUT_LIF_BANKS(_unit) (_BCM_DPP_AM_NOF_GLOBAL_OUT_LIFS(_unit) / _BCM_DPP_AM_GLOBAL_LIF_NOF_ENTRIES_PER_BANK)
