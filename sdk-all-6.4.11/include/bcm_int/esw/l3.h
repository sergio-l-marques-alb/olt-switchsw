...
#define BCM_L3_MAX_ECMP_GROUPS      4096
#else
#define BCM_L3_MAX_ECMP_GROUPS      1024
#endif

#define _BCM_DEFIP_IPMC_EXPECTED_L3IIF_MAX   0x2fff
#define _BCM_DEFIP_IPMC_RP_ID_BASE           0x3000
#define _BCM_DEFIP_IPMC_RP_SET(rp)           (rp | _BCM_DEFIP_IPMC_RP_ID_BASE)
