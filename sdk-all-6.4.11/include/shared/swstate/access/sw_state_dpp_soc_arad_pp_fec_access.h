...
typedef int (*sw_state_dpp_soc_arad_pp_fec_fec_entry_type_set_cb)(
    int _unit, int fec_entry_type_idx_0, ARAD_PP_FEC_TYPE fec_entry_type);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_fec_entry_type_verify_cb)(
    int _unit, int fec_entry_type_idx_0);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_set_cb)(
    int _unit, int flp_progs_mapping_idx_0, uint8 flp_progs_mapping);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_flp_progs_mapping_verify_cb)(
    int _unit, int flp_progs_mapping_idx_0);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_set_cb)(
    int _unit, int lem_prefix_mapping_idx_0, uint8 lem_prefix_mapping);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_lem_prefix_mapping_verify_cb)(
    int _unit, int lem_prefix_mapping_idx_0);
...
typedef int (*sw_state_dpp_soc_arad_pp_fec_is_protected_verify_cb)(
    int _unit, int is_protected_idx_0);

/* implemented by: sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_set */
typedef int (*sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_set_cb)(
    int _unit, uint8 protected_bitmap_init);

/* implemented by: sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_get */
typedef int (*sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_get_cb)(
    int _unit, uint8 *protected_bitmap_init);

/* implemented by: sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_verify */
typedef int (*sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_verify_cb)(
    int _unit);
...
typedef struct sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_cbs_s {
    sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_set_cb set;
    sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_get_cb get;
    sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_verify_cb verify;
} sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_cbs_t;
...
typedef struct sw_state_dpp_soc_arad_pp_fec_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_fec_protected_bitmap_init_cbs_t protected_bitmap_init;
