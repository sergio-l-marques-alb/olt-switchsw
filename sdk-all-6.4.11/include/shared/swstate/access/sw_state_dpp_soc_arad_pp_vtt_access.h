...
typedef int (*sw_state_dpp_soc_arad_pp_vtt_isem_key_to_entry_id_set_cb)(
    int _unit, SOC_SAND_HASH_TABLE_PTR isem_key_to_entry_id);
...
int sw_state_dpp_soc_arad_pp_vtt_access_cb_init(int _unit);
