...
typedef enum bcm_cosq_control_e {
    ...
    bcmCosqControlE2ECCTransmitEnable = 126, /*  Enabling Transmission of E2ECC
                                           message */
    bcmCosqControlDefaultInvalidQueue = 127, /*  Configures the default queue that
                                           traffic will be redirected to in case
                                           it's destined for invalid queue */
    bcmCosqControlIngressPortPGHeadroomLimitBytes = 128, /*  Ingress port PG Headroom limit
                                           setting */
    bcmCosqControlIngressPortPGResetFloorBytes = 129, /*  Ingress port PG reset floor setting */
    bcmCosqControlEgressPoolSharedLimitBytes = 130, /*  Shared limit setting for per chip
                                           based egress Service Pool */
    bcmCosqControlEgressPoolResumeLimitBytes = 131, /*  Resume limit setting for per chip
                                           based egress Service Pool */
    bcmCosqControlEgressPoolYellowSharedLimitBytes = 132, /*  Shared limit setting for per chip
                                           based egress Service Pool for yellow
                                           packets */
    bcmCosqControlEgressPoolYellowResumeLimitBytes = 133, /*  Resume limit setting for per chip
                                           based egress Service Pool for yellow
                                           packets */
    bcmCosqControlEgressPoolRedSharedLimitBytes = 134, /*  Shared limit setting for per chip
                                           based egress Service Pool for red
                                           packets */
    bcmCosqControlEgressPoolRedResumeLimitBytes = 135, /*  Resume limit setting for per chip
                                           based egress Service Pool for red
                                           packets */
    bcmCosqControlIngressPortDropTpid1 = 136, /* cosq ingress port drop global TPID 1. */
    bcmCosqControlIngressPortDropTpid2 = 137, /* cosq ingress port drop global TPID 2. */
    bcmCosqControlIngressPortDropUntaggedPCP = 138 /* cosq ingress port drop untagged PCP. */
} bcm_cosq_control_t;
