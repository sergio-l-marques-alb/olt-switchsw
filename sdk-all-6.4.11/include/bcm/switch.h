...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchECMPResilientHashKey1Shift = 983, /* Shift right the
                                           Stateful-Hashing-Lb-Key(47 bit) to
                                           create ECMP key-1 */
    bcmSwitchVpnDetachPorts = 984,      /* Set VPN detach mode to either detach
                                           ports that are attached to the VSI or
                                           ignore them. Default: 1 - Detach
                                           ports. */
    ...
    bcmSwitchHashSctpL4Port = 988,      /* To set that RTAG7 hashing can be
                                           performed on SCTP. */
    bcmSwitchGlobalTpidEnable = 989,    /* Enable/Disable global TPIDs. */
    bcmSwitchECMPResilientHashCombine = 990, /* Combine both regular and resilient
                                           hashing for ECMP key. */
    bcmSwitchHashSetTflowMode = 991,    /* enable/disable using hash offset
                                           b0/b1 regardless of th_tflow_enabled */
    bcmSwitch__Count = 992              /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_tpid_type_e {
    ...
    bcmTpidTypeReserved0 = 4,           /* Reserved TPID type */
    bcmTpidTypeReserved1 = 5,           /* Reserved TPID type */
...
typedef enum bcm_switch_pkt_trace_drop_reason_e {
    ...
    bcmSwitchPktTraceDropReasonRpfCheckFail = 34, /* Packet dropped due to unicast RPF
                                           check fail */
    bcmSwitchPktTraceDropReasonCount = 35 
