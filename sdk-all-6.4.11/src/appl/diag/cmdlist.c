...
#if defined(BCM_ESW_SUPPORT) || defined(BCM_ARAD_SUPPORT) || defined(BCM_CALADAN3_SUPPORT)
...
#ifdef INCLUDE_CES
    {"CES",             cmd_esw_ces,            cmd_esw_ces_usage,      "Set/Display CES characteristics"},
#endif
...
#endif /* INCLUDE_I2C && BCM_FE2000_SUPPORT */
    {"Dump",        cmd_sbx_dump,           cmd_sbx_dump_usage,         "Dump misc. info" },
#ifdef BCM_FE2000_SUPPORT
    {"EXTernTuneSBX",     cmd_sbx_ddr_tune, cmd_sbx_ddr_tune_usage,     "External memory automatic tuning" },
#endif /* BCM_FE2000_SUPPORT */
...
#else
    /* ESW_CMD_MODE is the default mode while BCM_ESW_SUPPORT. */
#if defined(BCM_ESW_SUPPORT)
...
#if defined(BCM_EA_SUPPORT)
    case EA_CMD_MODE:
        cur_cmd_list = bcm_ea_cmd_list;
        cur_cmd_cnt = bcm_ea_cmd_cnt;
        break;
#endif
#if defined(BCM_SBX_SUPPORT)
    case SBX_CMD_MODE:
...
#if defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT)
    case DPP_CMD_MODE:
        cur_cmd_list = bcm_dpp_cmd_list;
        cur_cmd_cnt = bcm_dpp_cmd_cnt;
        break;
#endif
#if defined(BCM_ESW_SUPPORT)
    case ESW_CMD_MODE:
