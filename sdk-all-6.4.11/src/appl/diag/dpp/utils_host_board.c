...
#include "DuneDriver/Petra/include/petra_general.h"
/*
 * }
 */
...
/* { */
      ...
      if(chip_ver == FAP20V_EXPECTED_CHIP_VER_01)
      {
...
/* { */
       ...
       * Call to the GFA init.
       */
      d_printf("call: gfa_petra_init_host_board(1)\n\r");
      gfa_petra_init_host_board(
        board_version,
        host_board_serial_number,
        card_type,
    ...
    case LOAD_BOARD_PB:
      {
        ...
        int
          err ;
        d_printf("call: gfa_petra_init_host_board(2)\n\r");
        err = gfa_petra_init_host_board(        
                board_version,
                host_board_serial_number,
                card_type,
                &chip_ver
        ...
        {
          d_printf(
            "ERROR reported by gfa_petra_init_host_board (code %d)\r\n",
            err
            ) ;
        }
        board_set_device_type(
 ...
 */
  ...
  if (
#if LINK_FAP20V_LIBRARIES
     (gfa_is_db_exist_on_board())
#endif
#if (LINK_FAP20V_LIBRARIES && LINK_FAP21V_LIBRARIES)
     ||
#endif
#if LINK_FAP21V_LIBRARIES
     (gfa_fap21v_is_db_exist_on_board())
#endif
    )
  {
