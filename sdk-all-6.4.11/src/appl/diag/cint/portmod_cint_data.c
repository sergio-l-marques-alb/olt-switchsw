...
__cint_maddr__portmod_port_add_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 17: rv = &(s->ilkn_inb_cal_len_rx);break;
        case 18: rv = &(s->ilkn_inb_cal_len_tx);break;
        case 19: rv = &(s->ilkn_oob_cal_len_rx);break;
        case 20: rv = &(s->ilkn_oob_cal_len_tx);break;
        default: rv = NULL; break;
    }
    return rv;
}
