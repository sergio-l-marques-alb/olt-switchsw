  ...
  )
{
  ...
  SOC_PPD_LIF_ING_VLAN_EDIT_COMMAND_KEY_clear(&prm_command_key);
  ...
  )
{
  ...
  uint32
    prm_command_ndx;
  SOC_PPD_LIF_ING_VLAN_EDIT_COMMAND_INFO
    prm_command_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_LIF_ING_VLAN_EDIT_COMMAND_INFO_clear(&prm_command_info);
  ...
  )
{
  ...
  SOC_PPD_LIF_ING_VLAN_EDIT_COMMAND_INFO_print(&prm_command_info);
