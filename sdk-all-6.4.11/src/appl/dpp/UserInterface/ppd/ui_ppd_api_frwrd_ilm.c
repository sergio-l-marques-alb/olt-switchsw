                                   ...
                                   )
{
  ...
  SOC_PPD_FRWRD_ILM_GLBL_INFO_clear(&prm_glbl_info);
                                   ...
                                   )
{
  ...
  SOC_PPD_FRWRD_ILM_GLBL_INFO_print(&prm_glbl_info);
                         ...
                         )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_ILM_KEY_clear(&prm_ilm_key);
  SOC_PPD_FRWRD_DECISION_INFO_clear(&prm_ilm_val);
  ...
  if(prm_ilm_val.additional_info.eei.type == SOC_PPD_EEI_TYPE_MPLS) {
                         ...
                         )
{
  ...
  SOC_PPD_FRWRD_DECISION_INFO_print(&prm_ilm_val);
