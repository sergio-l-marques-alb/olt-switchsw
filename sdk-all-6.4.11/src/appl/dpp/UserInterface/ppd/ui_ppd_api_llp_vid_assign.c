/* $Id: ui_ppd_api_llp_vid_assign.c,v 1.7 Broadcom SDK $
...
{   
  ...
  SOC_PPD_PORT   
    prm_local_port_ndx;
  SOC_PPD_LLP_VID_ASSIGN_PORT_INFO   
  ...
  SOC_PPD_LLP_VID_ASSIGN_PORT_INFO_clear(&prm_port_vid_assign_info);
...
{   
  ...
  SOC_PPD_LLP_VID_ASSIGN_PORT_INFO_print(&prm_port_vid_assign_info);
...
{   
  ...
  SOC_SAND_PP_MAC_ADDRESS   
    prm_mac_address_key;
  SOC_PPD_LLP_VID_ASSIGN_MAC_INFO   
    prm_mac_based_info;
  ...
  SOC_PPD_LLP_VID_ASSIGN_MAC_INFO_clear(&prm_mac_based_info);
...
{   
  ...
  SOC_PPD_LLP_VID_ASSIGN_MAC_INFO_print(&prm_mac_based_info);
...
{   
  uint32 
    ret;   
  SOC_PPD_LLP_VID_ASSIGN_MATCH_RULE   
    prm_rule;
  ...
  SOC_PPD_LLP_VID_ASSIGN_MAC_INFO_print(&prm_vid_assign_info_arr);
...
{   
  ...
  SOC_SAND_PP_IPV4_SUBNET   
    prm_subnet;
  SOC_PPD_LLP_VID_ASSIGN_IPV4_SUBNET_INFO   
  ...
  SOC_PPD_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_clear(&prm_subnet_based_info);
...
{   
  ...
  SOC_PPD_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_print(&prm_subnet_based_info);
...
{   
  ...
  uint16   
    prm_ether_type_ndx;
  SOC_PPD_LLP_VID_ASSIGN_PRTCL_INFO   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_LLP_VID_ASSIGN_PRTCL_INFO_clear(&prm_prtcl_assign_info);
...
{   
  ...
  SOC_PPD_LLP_VID_ASSIGN_PRTCL_INFO_print(&prm_prtcl_assign_info);
