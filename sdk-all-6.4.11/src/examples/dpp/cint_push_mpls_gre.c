...
int push_mpls_gre_example(int unit, int provider_port)
{
    ...
    rv = ipv4_tunnel_build_tunnels(unit, provider_port, out_tunnel_intf_ids, out_tunnel_gports); 
    if (rv != BCM_E_NONE) {
    ...
    l3_egress_fec.port = provider_port; 
    l3_egress_fec.encap_id = mpls_tunnel_properties.tunnel_id; /* tunnel */
