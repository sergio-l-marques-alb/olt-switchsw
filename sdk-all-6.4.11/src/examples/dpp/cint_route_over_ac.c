...
int route_over_ac_l2_l3_create(int unit, int rif_index, int host_index)
{
    ...
    l3_egress_encap.gport = g_route_over_ac.rif_def[rif_index].sys_port;
    ...
    l3_egress_encap.encap_id = g_route_over_ac.host_def[host_index].encap_id;
    rv = l3__egress_only_encap__create(unit, &l3_egress_encap);
    if (rv != BCM_E_NONE) {
          printf("Fail  l3__egress_only__create ");
          return rv;
    }
    g_route_over_ac.host_def[host_index].encap_id = l3_egress_encap.encap_id;
