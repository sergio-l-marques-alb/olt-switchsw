...
/*
 * Function:
 *     td2p_mpls_tunnel_stat_get_table_info
 * Description:
 ...
 */
static
bcm_error_t td2p_mpls_tunnel_stat_get_table_info(
           int                        unit,
           bcm_if_t                   intf_id,
           ...
           bcm_stat_flex_table_info_t *table_info)
{
    ...
    mpls_index = soc_EGR_L3_INTFm_field32_get(unit, &if_entry,
                                              MPLS_TUNNEL_INDEXf);
    index = mpls_index / _BCM_MPLS_NUM_MPLS_ENTRIES_PER_INDEX(unit);
 ...
 *
 */
STATIC bcm_error_t td2p_mpls_tunnel_stat_attach(
            int      unit,
            bcm_if_t intf_id,
            uint32   stat_counter_id)
{
    ...
    BCM_IF_ERROR_RETURN(td2p_mpls_tunnel_stat_get_table_info(
 ...
 */
STATIC
bcm_error_t td2p_mpls_tunnel_stat_detach(
            int      unit,
            bcm_if_t intf_id)
{
    uint32                     count = 0;
...
/*
 * Function:
 *      td2p_mpls_tunnel_stat_counter_get
 *
 * Description:
 ...
 */
STATIC
bcm_error_t td2p_mpls_tunnel_stat_counter_get(
                    int              unit,
                    int              sync_mode,
                    bcm_if_t         intf_id,
...
/*
 * Function:
 *      td2p_mpls_tunnel_stat_counter_set
 *
 * Description:
 ...
 */
STATIC
bcm_error_t td2p_mpls_tunnel_stat_counter_set(
            int              unit,
            bcm_if_t         intf_id,
            bcm_mpls_stat_t  stat,
            uint32           num_entries,
 ...
 */
STATIC
int td2p_mpls_tunnel_stat_id_get(
            int             unit,
            bcm_if_t        intf_id,
            bcm_mpls_stat_t   stat,
            uint32          *stat_counter_id)
...
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return td2p_mpls_tunnel_stat_attach(unit, intf_id, stat_counter_id);
    }
#endif
#endif
    return BCM_E_UNAVAIL;
...
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return td2p_mpls_tunnel_stat_detach(unit, intf_id);
    }
#endif
#endif
    return BCM_E_UNAVAIL;
...
#ifdef BCM_MPLS_SUPPORT
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
    return td2p_mpls_tunnel_stat_counter_get(unit, 0, intf_id, stat,
                                        num_entries,
                                        counter_indexes,
                                        counter_values);
#endif
...
#ifdef BCM_MPLS_SUPPORT
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
    return td2p_mpls_tunnel_stat_counter_get(unit, 1, intf_id, stat,
...
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return td2p_mpls_tunnel_stat_counter_set(unit, intf_id, stat,
...
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
    if (soc_feature(unit,soc_feature_advanced_flex_counter)) {
        return td2p_mpls_tunnel_stat_id_get(unit, intf_id, stat,
                                stat_counter_id);
    }
#endif
#endif
...
int rv = BCM_E_UNAVAIL;
    ...
    if (SOC_IS_TR_VL(unit)) {
         rv = _bcm_tr_mpls_match_add(unit, mpls_port, vp, vpn);
         return rv;
    }
#endif
#endif
