 ...
 */
int
_bcm_dpp_am_cosq_region_alloc(int unit, int core, bcm_dpp_cosq_bmp_type_t type, int requested_region, int max_regions, int *region)
{
    int rv = BCM_E_NONE;
    int cur_region;
    uint8 result;
                                            ...
                                            _dpp_res_pool_cosq_t *dpp_res_cosq_pool, _dpp_res_type_cosq_t *dpp_res_cosq_type)
{
    ...
    rv = _bcm_dpp_am_cosq_region_alloc(unit, core_id, bmp_type, requested_region, max_regions, &region);
    BCMDNX_IF_ERR_EXIT(rv);
