/*
 * $Id: switch.c,v 1.75 Broadcom SDK $
...
typedef struct {
    ...
    uint32 reg_offset;
    uint32 reg_data_mask;
    uint32 reg_data_shift;
} sbx_sw_ctrl_desc_t;
 ...
 */
int
_bcm_g2p3_drop_on_exception_set(int unit, uint8 drop)
{
    int                     i, rv = BCM_E_NONE;
                                    ...
                                    int arg)
{
    ...
    case bcmSwitchReserveLowL3InterfaceId:
        if (arg >= BCM_FE2K_L3_INTF_BASE) {
            arg = _FE2K_IFID_FROM_USER_HANDLE(arg);
            rv = _sbx_gu2_range_reserve(unit, SBX_GU2K_USR_RES_IFID,
                                        FALSE, (uint32)arg);
        } else {
            rv = BCM_E_PARAM;
        }
    ...
    case bcmSwitchReserveLowL3EgressId:
        if (arg >= BCM_FE2K_L3_FTE_BASE) {
            arg = _FE2K_GET_FTE_IDX_FROM_USER_HANDLE(arg);
            rv = _sbx_gu2_range_reserve(unit, SBX_GU2K_USR_RES_FTE_L3,
                                        FALSE, (uint32)arg);
        } else {
            rv = BCM_E_PARAM;
        }
...
#define SBX_GLOBAL_GPORT_SIZE(unit) (SBX_GLOBAL_GPORT_FTE_END(unit) - SBX_GLOBAL_GPORT_FTE_BASE(unit))
    ...
    case bcmSwitchReserveLowL2Egress:
        rv = bcm_fe2000_l2_egress_range_reserve(unit, FALSE, (uint32)arg);
        break;
    case bcmSwitchReserveHighL2Egress:
        rv = bcm_fe2000_l2_egress_range_reserve(unit, TRUE, (uint32)arg);
        break;
    ...
    case bcmSwitchReserveLowFailoverId:
        rv = _sbx_gu2_range_reserve(unit, SBX_GU2K_USR_RES_PROTECTION,
                                    FALSE, (uint32)arg);
        break;
    ...
    case bcmSwitchReserveLowOamEndPointId:
        rv = bcm_fe2000_oam_endpoint_range_reserve(unit, FALSE, (uint32)arg);
        break;
    case bcmSwitchReserveHighOamEndPointId:
        rv = bcm_fe2000_oam_endpoint_range_reserve(unit, TRUE, (uint32)arg);
        break;
    case bcmSwitchReserveLowOamGroupId:
        rv = bcm_fe2000_oam_group_range_reserve(unit, FALSE, (uint32)arg);
        break;
    case bcmSwitchReserveHighOamGroupId:
        rv = bcm_fe2000_oam_group_range_reserve(unit, TRUE, (uint32)arg);
        break;
    ...
    case bcmSwitchIgmpPktDrop:
        rv = soc_sbx_g2p3_igmp_proxy_mode_set(unit, (uint32)arg);
        break;
/*
 ...
 */
    case bcmSwitchMeterAdjust:
        rv = soc_sbx_g2p3_switch_meter_adjust_set(unit, (uint32)arg);
        break;
    case bcmSwitchMplsLabelCache:
        ...
        rv = _bcm_fe2000_mpls_label_commit_enable_set(unit, (uint32)arg);
        break;
    case bcmSwitchMplsLabelCommit:
        rv = _bcm_fe2000_mpls_label_commit(unit);
        break;
    default:
                                    ...
                                    int *arg)
{
    ...
    case bcmSwitchReserveLowL3InterfaceId:
        rv = _sbx_gu2_alloc_range_get(unit, SBX_GU2K_USR_RES_IFID,
                                      (uint32*)arg, &junk);
        *arg = _FE2K_USER_HANDLE_FROM_IFID(*arg);
        break;
    ...
    case bcmSwitchReserveLowL3EgressId:
        rv = _sbx_gu2_alloc_range_get(unit, SBX_GU2K_USR_RES_FTE_L3,
                                      (uint32*)arg, &junk);
        *arg = _FE2K_GET_USER_HANDLE_FROM_FTE_IDX(*arg);
        break;
    ...
    case bcmSwitchReserveHighEncap:
        ...
        *arg = SOC_SBX_ENCAP_ID_FROM_OHI(*arg);
        break;
    case bcmSwitchReserveLowL2Egress:
        rv = bcm_fe2000_l2_egress_range_get(unit, (uint32*)arg, &junk);
        break;
    case bcmSwitchReserveHighL2Egress:
        *arg = SOC_SBX_OFFSET_FROM_L2_ENCAP_ID(*arg);
        rv = bcm_fe2000_l2_egress_range_get(unit, &junk, (uint32*)arg);
        break;
    case bcmSwitchReserveLowVpn:
        rv = _sbx_gu2_alloc_range_get(unit, SBX_GU2K_USR_RES_VSI,
                                      (uint32*)arg, &junk);
    ...
    case bcmSwitchReserveHighVpn:
        ...
        break;
    case bcmSwitchReserveLowFailoverId:
        rv = _sbx_gu2_alloc_range_get(unit, SBX_GU2K_USR_RES_PROTECTION,
                                    (uint32*)arg, &junk);
        break;
    case bcmSwitchReserveHighFailoverId:
        rv = _sbx_gu2_alloc_range_get(unit, SBX_GU2K_USR_RES_PROTECTION,
        ...
        break;
    case bcmSwitchReserveLowOamEndPointId:
        rv = bcm_fe2000_oam_endpoint_range_get(unit, (uint32*)arg, &junk);
        break;
    case bcmSwitchReserveHighOamEndPointId:
        rv = bcm_fe2000_oam_endpoint_range_get(unit, &junk, (uint32*)arg);
        break;
    case bcmSwitchReserveLowOamGroupId:
        rv = bcm_fe2000_oam_group_range_get(unit, (uint32*)arg, &junk);
        break;
    case bcmSwitchReserveHighOamGroupId:
        rv = bcm_fe2000_oam_group_range_get(unit, &junk, (uint32*)arg);
        break;
    case bcmSwitchSynchronousPortClockSource:
        if (!SOC_IS_SBX_FE2KXT(unit)){
            return BCM_E_UNAVAIL;
    ...
    case bcmSwitchIgmpPktToCpu:
        ...
        break;
    case bcmSwitchIgmpPktDrop:
        rv = soc_sbx_g2p3_igmp_proxy_mode_get(unit, (uint32*)arg);
        break;
/*
 ...
 */
    case bcmSwitchMeterAdjust:
        rv = soc_sbx_g2p3_switch_meter_adjust_get(unit, (uint32*)arg);
        break;
    case bcmSwitchMplsLabelCache:
        rv = _bcm_fe2000_mpls_label_commit_enable_get(unit, (uint32*)arg);
        if (*arg == 0) {
            *arg = 1;
        } else {
            *arg = 0;
