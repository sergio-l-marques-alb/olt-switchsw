...
sbZfC2PedDescriptor_Unpack(sbZfC2PedDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uBuffer =  (uint32)  ((pFromData)[165] >> 7) & 0x01;
  (pToStruct)->m_uBuffer |=  (uint32)  (pFromData)[166] << 1;
  (pToStruct)->m_uBuffer |=  (uint32)  ((pFromData)[167] & 0x1f) << 9;

  /* Unpack Member: m_uExceptionIndex */
  (pToStruct)->m_uExceptionIndex =  (uint32)  ((pFromData)[165] ) & 0x7f;
