...
sbZfC2PrCcTcamConfigEntryFirst_Print(sbZfC2PrCcTcamConfigEntryFirst_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: mask0_31=0x%08x"), (unsigned int)  pFromStruct->m_uMask0_31));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: mask64_95=0x%08x"), (unsigned int)  pFromStruct->m_uMask64_95));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: mask128_159=0x%08x"), (unsigned int)  pFromStruct->m_uMask128_159));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask160_191=0x%08x"), (unsigned int)  pFromStruct->m_uMask160_191));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: mask192_199=0x%02x"), (unsigned int)  pFromStruct->m_uMask192_199));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" maskreserved=0x%03x"), (unsigned int)  pFromStruct->m_uMaskReserved));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: maskport=0x%02x"), (unsigned int)  pFromStruct->m_uMaskPort));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: packet32_63=0x%08x"), (unsigned int)  pFromStruct->m_uPacket32_63));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" packet64_95=0x%08x"), (unsigned int)  pFromStruct->m_uPacket64_95));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: packet96_127=0x%08x"), (unsigned int)  pFromStruct->m_uPacket96_127));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: packet128_159=0x%08x"), (unsigned int)  pFromStruct->m_uPacket128_159));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: packet160_191=0x%08x"), (unsigned int)  pFromStruct->m_uPacket160_191));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntryFirst:: reserved=0x%03x"), (unsigned int)  pFromStruct->m_uReserved));
  LOG_WARN(BSL_LS_SOC_COMMON,
