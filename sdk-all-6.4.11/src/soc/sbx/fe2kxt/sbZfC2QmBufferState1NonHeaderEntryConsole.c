...
sbZfC2QmBufferState1NonHeaderEntry_Print(sbZfC2QmBufferState1NonHeaderEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2QmBufferState1NonHeaderEntry:: reserved=0x%02x"), (unsigned int)  pFromStruct->m_uReserved));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2QmBufferState1NonHeaderEntry:: drop=0x%01x"), (unsigned int)  pFromStruct->m_uDrop));
  LOG_WARN(BSL_LS_SOC_COMMON,
