...
#include "sbTypes.h"
#include "sbZfC2PpCamRamConfigurationInstance0Entry.hx"
...
sbZfC2PpCamRamConfigurationInstance0Entry_Pack(sbZfC2PpCamRamConfigurationInstance0Entry_t *pFrom,
  ...
  return SB_ZF_C2PPCAMRAMCONFIGURATIONINSTANCE0ENTRY_SIZE_IN_BYTES;
}
...
sbZfC2PpCamRamConfigurationInstance0Entry_Unpack(sbZfC2PpCamRamConfigurationInstance0Entry_t *pToStruct,
  ...
  (pToStruct)->m_uLengthUnits =  (uint32)  ((pFromData)[20] >> 4) & 0x03;

  /* Unpack Member: m_uLengthMask */
  (pToStruct)->m_uLengthMask =  (uint32)  ((pFromData)[20] >> 1) & 0x07;

  /* Unpack Member: m_uLengthPtr */
  (pToStruct)->m_uLengthPtr =  (uint32)  ((pFromData)[19] >> 4) & 0x0f;
  (pToStruct)->m_uLengthPtr |=  (uint32)  ((pFromData)[20] & 0x01) << 4;

  /* Unpack Member: m_uStateMask */
  (pToStruct)->m_uStateMask =  (uint32)  ((pFromData)[16] >> 4) & 0x0f;
  (pToStruct)->m_uStateMask |=  (uint32)  (pFromData)[17] << 4;
  (pToStruct)->m_uStateMask |=  (uint32)  (pFromData)[18] << 12;
  (pToStruct)->m_uStateMask |=  (uint32)  ((pFromData)[19] & 0x0f) << 20;
...
sbZfC2PpCamRamConfigurationInstance0Entry_InitInstance(sbZfC2PpCamRamConfigurationInstance0Entry_t *pFrame) {
  ...
  pFrame->m_uStateMask =  (unsigned int)  0;
