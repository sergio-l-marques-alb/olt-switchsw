...
sbZfC2PpFilterDataOverlayFormat_Unpack(sbZfC2PpFilterDataOverlayFormat_t *pToStruct,
  ...
  (pToStruct)->m_uFragment =  (uint8)  ((pFromData)[1] >> 7) & 0x01;

  /* Unpack Member: m_uLocalStationId */
  (pToStruct)->m_uLocalStationId =  (uint8)  ((pFromData)[1] >> 2) & 0x1f;

  /* Unpack Member: m_uFilterMatch0 */
  (pToStruct)->m_uFilterMatch0 =  (uint8)  ((pFromData)[1] >> 1) & 0x01;

  /* Unpack Member: m_uFilterMatch1 */
  (pToStruct)->m_uFilterMatch1 =  (uint8)  ((pFromData)[1] ) & 0x01;

  /* Unpack Member: m_uFilterId0 */
  (pToStruct)->m_uFilterId0 =  (uint8)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: m_uFilterId1 */
  (pToStruct)->m_uFilterId1 =  (uint8)  ((pFromData)[0] ) & 0x0f;
