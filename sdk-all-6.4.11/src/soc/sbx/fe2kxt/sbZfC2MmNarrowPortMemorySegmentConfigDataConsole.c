...
sbZfC2MmNarrowPortMemorySegmentConfigData_Print(sbZfC2MmNarrowPortMemorySegmentConfigData_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmNarrowPortMemorySegmentConfigData:: resv0=0x%02x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmNarrowPortMemorySegmentConfigData:: ding=0x%01x"), (unsigned int)  pFromStruct->m_uDataIntegrity));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmNarrowPortMemorySegmentConfigData:: lmask=0x%06x"), (unsigned int)  pFromStruct->m_uLimitMask));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2MmNarrowPortMemorySegmentConfigData_SPrint(sbZfC2MmNarrowPortMemorySegmentConfigData_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
