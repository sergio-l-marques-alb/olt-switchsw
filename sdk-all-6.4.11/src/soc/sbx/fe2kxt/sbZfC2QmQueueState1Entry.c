...
sbZfC2QmQueueState1Entry_Unpack(sbZfC2QmQueueState1Entry_t *pToStruct,
  ...
  (pToStruct)->m_uDrop =  (uint32)  ((pFromData)[3] >> 1) & 0x01;

  /* Unpack Member: m_uOverflow */
  (pToStruct)->m_uOverflow =  (uint32)  ((pFromData)[3] ) & 0x01;

  /* Unpack Member: m_uPb1PagesAllocated */
  (pToStruct)->m_uPb1PagesAllocated =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;
  (pToStruct)->m_uPb1PagesAllocated |=  (uint32)  (pFromData)[2] << 4;

  /* Unpack Member: m_uPb0PagesAllocated */
  (pToStruct)->m_uPb0PagesAllocated =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uPb0PagesAllocated |=  (uint32)  ((pFromData)[1] & 0x0f) << 8;
