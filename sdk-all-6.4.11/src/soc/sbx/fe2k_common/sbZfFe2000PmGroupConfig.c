...
sbZfFe2000PmGroupConfig_Unpack(sbZfFe2000PmGroupConfig_t *pToStruct,
  ...
  (pToStruct)->uEnable =  (uint32)  ((pFromData)[15] >> 7) & 0x01;

  /* Unpack Member: uSpare2 */
  (pToStruct)->uSpare2 =  (uint32)  ((pFromData)[14] >> 7) & 0x01;
  (pToStruct)->uSpare2 |=  (uint32)  ((pFromData)[15] & 0x7f) << 1;

  /* Unpack Member: uMinPolicerId */
  (pToStruct)->uMinPolicerId =  (uint32)  (pFromData)[12] ;
  (pToStruct)->uMinPolicerId |=  (uint32)  (pFromData)[13] << 8;
  (pToStruct)->uMinPolicerId |=  (uint32)  ((pFromData)[14] & 0x7f) << 16;

  /* Unpack Member: uSpare1 */
  (pToStruct)->uSpare1 =  (uint32)  ((pFromData)[10] >> 7) & 0x01;
  (pToStruct)->uSpare1 |=  (uint32)  (pFromData)[11] << 1;

  /* Unpack Member: uMaxPolicerId */
  (pToStruct)->uMaxPolicerId =  (uint32)  (pFromData)[8] ;
  (pToStruct)->uMaxPolicerId |=  (uint32)  (pFromData)[9] << 8;
  (pToStruct)->uMaxPolicerId |=  (uint32)  ((pFromData)[10] & 0x7f) << 16;

  /* Unpack Member: uRefreshCount */
  (pToStruct)->uRefreshCount =  (uint32)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: uRefreshThresh */
  (pToStruct)->uRefreshThresh =  (uint32)  (pFromData)[6] ;
  (pToStruct)->uRefreshThresh |=  (uint32)  ((pFromData)[7] & 0x0f) << 8;

  /* Unpack Member: uRefreshPeriod */
  (pToStruct)->uRefreshPeriod =  (uint32)  (pFromData)[4] ;
  (pToStruct)->uRefreshPeriod |=  (uint32)  (pFromData)[5] << 8;

  /* Unpack Member: uSpare0 */
  (pToStruct)->uSpare0 =  (uint32)  ((pFromData)[3] >> 7) & 0x01;

  /* Unpack Member: uTimerEnable */
  (pToStruct)->uTimerEnable =  (uint32)  ((pFromData)[3] >> 6) & 0x01;

  /* Unpack Member: uTimestampOffset */
  (pToStruct)->uTimestampOffset =  (uint32)  ((pFromData)[3] ) & 0x3f;

  /* Unpack Member: uTimerTickPeriod */
  (pToStruct)->uTimerTickPeriod =  (uint32)  (pFromData)[0] ;
  (pToStruct)->uTimerTickPeriod |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->uTimerTickPeriod |=  (uint32)  (pFromData)[2] << 16;
