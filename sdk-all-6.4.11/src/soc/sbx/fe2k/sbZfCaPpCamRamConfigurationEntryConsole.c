...
sbZfCaPpCamRamConfigurationEntry_Print(sbZfCaPpCamRamConfigurationEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: unused_spare=0x%01x"), (unsigned int)  pFromStruct->m_uUnused_Spare));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: hashstart=0x%01x"), (unsigned int)  pFromStruct->m_uHashStart));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: checkeroffset=0x%02x"), (unsigned int)  pFromStruct->m_uCheckerOffset));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: headeravalid=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderAValid));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: headerabaselength=0x%02x"), (unsigned int)  pFromStruct->m_uHeaderABaseLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" headerbvalid=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderBValid));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: headerbtype=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderBType));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" headerbbaselength=0x%02x"), (unsigned int)  pFromStruct->m_uHeaderBBaseLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: shift=0x%02x"), (unsigned int)  pFromStruct->m_uShift));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" variablemask=0x%08x"), (unsigned int)  pFromStruct->m_uVariableMask));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamRamConfigurationEntry:: variabledata=0x%08x"), (unsigned int)  pFromStruct->m_uVariableData));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaPpCamRamConfigurationEntry_SPrint(sbZfCaPpCamRamConfigurationEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
