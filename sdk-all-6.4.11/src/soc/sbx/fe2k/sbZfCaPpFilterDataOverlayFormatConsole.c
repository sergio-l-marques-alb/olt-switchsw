...
sbZfCaPpFilterDataOverlayFormat_Print(sbZfCaPpFilterDataOverlayFormat_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpFilterDataOverlayFormat:: frag=0x%01x"), (unsigned int)  pFromStruct->m_uFragment));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpFilterDataOverlayFormat:: fid1=0x%01x"), (unsigned int)  pFromStruct->m_uFilterId1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
