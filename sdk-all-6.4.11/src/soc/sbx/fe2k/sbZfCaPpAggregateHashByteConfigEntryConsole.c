...
sbZfCaPpAggregateHashByteConfigEntry_Print(sbZfCaPpAggregateHashByteConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashByteConfigEntry:: data1=0x%02x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfCaPpAggregateHashByteConfigEntry_SPrint(sbZfCaPpAggregateHashByteConfigEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
