/*
 * $Id: sbZfCaPmLrMeterRequest.c,v 1.2 Broadcom SDK $
...
sbZfCaPmLrMeterRequest_Unpack(sbZfCaPmLrMeterRequest_t *pToStruct,
  ...
  (pToStruct)->m_uPolicerId =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uPolicerId |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->m_uPolicerId |=  (uint32)  (pFromData)[6] << 16;
  (pToStruct)->m_uPolicerId |=  (uint32)  ((pFromData)[7] & 0x01) << 24;

  /* Unpack Member: m_uResv1 */
  (pToStruct)->m_uResv1 =  (uint32)  ((pFromData)[2] >> 2) & 0x3f;
  (pToStruct)->m_uResv1 |=  (uint32)  (pFromData)[3] << 6;

  /* Unpack Member: m_uBlind */
  (pToStruct)->m_uBlind =  (uint8)  ((pFromData)[2] >> 1) & 0x01;

  /* Unpack Member: m_uDropOnRed */
  (pToStruct)->m_uDropOnRed =  (uint8)  ((pFromData)[2] ) & 0x01;

  /* Unpack Member: m_uPacketLength */
  (pToStruct)->m_uPacketLength =  (uint32)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_uPacketLength |=  (uint32)  (pFromData)[1] << 6;
