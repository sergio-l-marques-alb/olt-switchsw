/*
 * $Id: sbZfCaQmDequeueState0Entry.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaQmDequeueState0Entry.hx"
...
sbZfCaQmDequeueState0Entry_Pack(sbZfCaQmDequeueState0Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAQMDEQUEUESTATE0ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAQMDEQUEUESTATE0ENTRY_SIZE_IN_BYTES;
}
