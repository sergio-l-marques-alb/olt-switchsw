/*
 * $Id: sbZfFe2000PpeDescriptor.c,v 1.4 Broadcom SDK $
...
#include "sbZfFe2000PpeDescriptor.hx"
...
uint32
sbZfFe2000PpeDescriptor_Pack(sbZfFe2000PpeDescriptor_t *pFrom,
                             uint8 *pToData,
                             uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_FE2000PPEDESCRIPTOR_SIZE_IN_BYTES;
  ...
  (pToData)[175] |= ((pFrom)->m_uBuffer & 0x03) <<3;
  ...
  /* Pack Member: m_uRxPortData0 */
  (pToData)[171] |= ((pFrom)->m_uRxPortData0) & 0xFF;

  /* Pack Member: m_uReplicantCnt */
  (pToData)[169] |= ((pFrom)->m_uReplicantCnt & 0x0f) <<4;
  (pToData)[170] |= ((pFrom)->m_uReplicantCnt >> 4) &0xFF;

  /* Pack Member: m_bReplicantBit */
  (pToData)[169] |= ((pFrom)->m_bReplicantBit & 0x01) <<3;

  /* Pack Member: m_uResv0 */
  (pToData)[169] |= ((pFrom)->m_uResv0 & 0x01) <<2;

  /* Pack Member: m_uDrop */
  (pToData)[169] |= ((pFrom)->m_uDrop & 0x01) <<1;

  /* Pack Member: m_uEnqueue */
  (pToData)[169] |= ((pFrom)->m_uEnqueue & 0x01);

  /* Pack Member: m_uDqueue */
  (pToData)[168] |= ((pFrom)->m_uDqueue) & 0xFF;

  /* Pack Member: m_uRxPortData1 */
  (pToData)[165] |= ((pFrom)->m_uRxPortData1 & 0x03) <<6;
  (pToData)[166] |= ((pFrom)->m_uRxPortData1 >> 2) &0xFF;
  (pToData)[167] |= ((pFrom)->m_uRxPortData1 >> 10) &0xFF;

  /* Pack Member: m_uFrameLength */
  (pToData)[164] |= ((pFrom)->m_uFrameLength) & 0xFF;
  (pToData)[165] |= ((pFrom)->m_uFrameLength >> 8) & 0x3f;

  /* Pack Member: m_uAggrHash */
  (pToData)[160] |= ((pFrom)->m_uAggrHash) & 0xFF;
  (pToData)[161] |= ((pFrom)->m_uAggrHash >> 8) &0xFF;
  (pToData)[162] |= ((pFrom)->m_uAggrHash >> 16) &0xFF;
  (pToData)[163] |= ((pFrom)->m_uAggrHash >> 24) &0xFF;

  /* Pack Member: m_uVariable */
  (pToData)[156] |= ((pFrom)->m_uVariable) & 0xFF;
  (pToData)[157] |= ((pFrom)->m_uVariable >> 8) &0xFF;
  (pToData)[158] |= ((pFrom)->m_uVariable >> 16) &0xFF;
  (pToData)[159] |= ((pFrom)->m_uVariable >> 24) &0xFF;
  ...
  return SB_ZF_FE2000PPEDESCRIPTOR_SIZE_IN_BYTES;
}
...
void
sbZfFe2000PpeDescriptor_Unpack(sbZfFe2000PpeDescriptor_t *pToStruct,
                               uint8 *pFromData,
                               uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
  ...
  (pToStruct)->m_uBuffer =  (uint32)  ((pFromData)[175] >> 3) & 0x03;
  ...
  /* Unpack Member: m_uRxPortData0 */
  (pToStruct)->m_uRxPortData0 =  (uint32)  (pFromData)[171] ;

  /* Unpack Member: m_uReplicantCnt */
  (pToStruct)->m_uReplicantCnt =  (uint32)  ((pFromData)[169] >> 4) & 0x0f;
  (pToStruct)->m_uReplicantCnt |=  (uint32)  (pFromData)[170] << 4;

  /* Unpack Member: m_bReplicantBit */
  (pToStruct)->m_bReplicantBit =  (uint32)  ((pFromData)[169] >> 3) & 0x01;

  /* Unpack Member: m_uResv0 */
  (pToStruct)->m_uResv0 =  (uint32)  ((pFromData)[169] >> 2) & 0x01;

  /* Unpack Member: m_uDrop */
  (pToStruct)->m_uDrop =  (uint32)  ((pFromData)[169] >> 1) & 0x01;

  /* Unpack Member: m_uEnqueue */
  (pToStruct)->m_uEnqueue =  (uint32)  ((pFromData)[169] ) & 0x01;

  /* Unpack Member: m_uDqueue */
  (pToStruct)->m_uDqueue =  (uint32)  (pFromData)[168] ;

  /* Unpack Member: m_uRxPortData1 */
  (pToStruct)->m_uRxPortData1 =  (uint32)  ((pFromData)[165] >> 6) & 0x03;
  (pToStruct)->m_uRxPortData1 |=  (uint32)  (pFromData)[166] << 2;
  (pToStruct)->m_uRxPortData1 |=  (uint32)  (pFromData)[167] << 10;
  ...
  /* Unpack Member: m_uAggrHash */
  (pToStruct)->m_uAggrHash =  (uint32)  (pFromData)[160] ;
  (pToStruct)->m_uAggrHash |=  (uint32)  (pFromData)[161] << 8;
  (pToStruct)->m_uAggrHash |=  (uint32)  (pFromData)[162] << 16;
  (pToStruct)->m_uAggrHash |=  (uint32)  (pFromData)[163] << 24;

  /* Unpack Member: m_uVariable */
  (pToStruct)->m_uVariable =  (uint32)  (pFromData)[156] ;
  (pToStruct)->m_uVariable |=  (uint32)  (pFromData)[157] << 8;
  (pToStruct)->m_uVariable |=  (uint32)  (pFromData)[158] << 16;
  (pToStruct)->m_uVariable |=  (uint32)  (pFromData)[159] << 24;
...
void
sbZfFe2000PpeDescriptor_InitInstance(sbZfFe2000PpeDescriptor_t *pFrame) {
  ...
  pFrame->m_uRxPortData0 =  (unsigned int)  0;
  pFrame->m_uReplicantCnt =  (unsigned int)  0;
  pFrame->m_bReplicantBit =  (unsigned int)  0;
  ...
  pFrame->m_uRxPortData1 =  (unsigned int)  0;
  pFrame->m_uFrameLength =  (unsigned int)  0;
  pFrame->m_uAggrHash =  (unsigned int)  0;
