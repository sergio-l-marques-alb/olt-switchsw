/*
 * $Id: sbZfFe2000MmInternal1MemoryEntry.c,v 1.4 Broadcom SDK $
...
uint32
sbZfFe2000MmInternal1MemoryEntry_Pack(sbZfFe2000MmInternal1MemoryEntry_t *pFrom,
                                      uint8 *pToData,
                                      uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_FE2000INTERNAL1MEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FE2000INTERNAL1MEMORYENTRY_SIZE_IN_BYTES;
}
...
void
sbZfFe2000MmInternal1MemoryEntry_Unpack(sbZfFe2000MmInternal1MemoryEntry_t *pToStruct,
                                        uint8 *pFromData,
                                        uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfFe2000MmInternal1MemoryEntry_InitInstance(sbZfFe2000MmInternal1MemoryEntry_t *pFrame) {
