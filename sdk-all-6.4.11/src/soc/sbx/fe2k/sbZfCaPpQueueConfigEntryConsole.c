/*
 * $Id: sbZfCaPpQueueConfigEntryConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPpQueueConfigEntry_Print(sbZfCaPpQueueConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpQueueConfigEntry:: data2=0x%08x"), (unsigned int)  pFromStruct->m_udata2));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpQueueConfigEntry:: initialhdrtype=0x%01x"), (unsigned int)  pFromStruct->m_uInitialHdrType));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
