/*
 * $Id: phy82109.c,v 1.1.2.25 Broadcom SDK $
...
_phy_82109_init_pass1(int unit, soc_port_t port)
{
    ...
    if (DEVID(pc) == HURACAN_ID_82109) { 
        ...
        sal_strncpy (dev_name, "BCM82109", sal_strlen("BCM82109"));
    } else {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "Huracan", sal_strlen("Huracan"));
    }
