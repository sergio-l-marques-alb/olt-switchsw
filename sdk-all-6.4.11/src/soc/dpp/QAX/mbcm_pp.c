...
CONST mbcm_pp_functions_t mbcm_pp_qax_driver = {
    ...
    NULL, /*soc_qax_pp_oam_oamp_punt_event_hendling_profile_set*/
    NULL, /*soc_qax_pp_oam_oamp_punt_event_hendling_profile_get*/
    soc_jer_eg_encap_ip_tunnel_size_protocol_template_set,
	NULL, /*mbcm_pp_mtr_policer_ipg_compensation_set*/
	NULL, /*mbcm_pp_mtr_policer_ipg_compensation_get*/
