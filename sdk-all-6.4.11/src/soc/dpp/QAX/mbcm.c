...
CONST mbcm_dpp_functions_t mbcm_qax_driver = {
    ...
    NULL, /* mbcm_dpp_ipq_default_invalid_queue_set */
    NULL, /* mbcm_dpp_ipq_default_invalid_queue_get */
    ...
    NULL, /*jer_itm_congestion_statistics_get*/
    ...
    NULL,  /* mbcm_dpp_fc_cmic_rx_set */
    NULL,  /* mbcm_dpp_fc_cmic_rx_get */
