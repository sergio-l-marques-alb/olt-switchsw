  ...
  )
{
    ...
    res = soc_petra_ofp_rates_egq_single_port_rate_sw_set(unit, tm_port, rate);
  ...
  )
{
    ...
    res = soc_petra_ofp_rates_egq_single_port_rate_hw_set(unit, tm_port);
    rv = handle_sand_result(res);
    SOC_IF_ERROR_RETURN(rv);
  ...
  )
{
    ...
    res = soc_petra_ofp_rates_egq_single_port_rate_hw_get(unit, tm_port, rate);
    rv = handle_sand_result(res);
    SOC_IF_ERROR_RETURN(rv);
  ...
  )
{
    ...
    res = soc_petra_ofp_rates_egq_interface_shaper_set(unit, core, ofp_ndx, rate_update_mode, if_shaper_rate);
    rv = handle_sand_result(res);
    SOC_IF_ERROR_RETURN(rv);
  ...
  )
{
    ...
    res = soc_petra_ofp_rates_sch_interface_shaper_get(unit, ofp_ndx, if_shaper_rate);
    rv = handle_sand_result(res);
    SOC_IF_ERROR_RETURN(rv);
