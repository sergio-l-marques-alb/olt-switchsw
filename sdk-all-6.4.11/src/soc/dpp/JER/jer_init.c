    ...
    int unit)
{
    ...
    uint32 default_init_all_dynamic_tables =0;

    SOCDNX_INIT_FUNC_DEFS;

    if (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "dynamic_tbl_full_init", default_init_all_dynamic_tables)) {
