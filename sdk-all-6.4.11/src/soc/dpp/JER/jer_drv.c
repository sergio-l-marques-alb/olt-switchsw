...
int 
soc_jer_qsgmii_id_to_phy_pbmp_get(int unit, soc_port_t port, uint32 id, uint32 default_nof_lanes, soc_pbmp_t *phy_pbmp)
{
    soc_jer_ucode_port_config_t config;

    SOCDNX_INIT_FUNC_DEFS;

    soc_jer_qsgmii_phy_pbmp_get(unit, port, id, default_nof_lanes, &config);

    *phy_pbmp = config.phy_pbmp;
