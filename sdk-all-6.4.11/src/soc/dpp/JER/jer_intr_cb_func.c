...
int jer_intr_handle_generic_none(int unit, int block_instance, jer_interrupt_type en_jer_interrupt,char *msg)
{
    ...
    /* corrective action */
    rc = jer_interrupt_handles_corrective_action(unit, block_instance, en_jer_interrupt, msg, DCMN_INT_CORR_ACT_NONE, NULL, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int jer_interrupt_handle_oamppendingevent(int unit, int block_instance, jer_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = jer_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_HANDLE_OAMP_EVENT_FIFO, NULL, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int jer_interrupt_handle_oamppendingstatevent(int unit, int block_instance, jer_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = jer_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_HANDLE_OAMP_STAT_EVENT_FIFO, NULL, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
STATIC
 ...
 jer_hard_reset(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    rc = jer_interrupt_handles_corrective_action(unit, block_instance,en_interrupt, info_msg, DCMN_INT_CORR_ACT_HARD_RESET , NULL,NULL);
...
STATIC
 ...
 jer_hard_reset_w_fabric(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    rc = jer_interrupt_handles_corrective_action(unit, block_instance,en_interrupt, info_msg, DCMN_INT_CORR_ACT_SOFT_RESET , NULL,NULL);
...
STATIC
 ...
 jer_shutdown_link(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
     ...
     SOCDNX_IF_ERR_EXIT(rc);
     rc = jer_interrupt_handles_corrective_action(unit, block_instance,en_interrupt, info_msg, DCMN_INT_CORR_ACT_SHUTDOWN_FBR_LINKS , NULL,info_msg);
     SOCDNX_IF_ERR_EXIT(rc);
