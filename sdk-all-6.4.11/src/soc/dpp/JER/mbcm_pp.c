...
CONST mbcm_pp_functions_t mbcm_pp_jericho_driver = {
    ...
    jer_pp_frwrd_ip_ipmc_ssm_add,/*mbcm_pp_ipmc_ssm_entry_add*/
    jer_pp_frwrd_ip_ipmc_ssm_delete,/*mbcm_pp_ipmc_ssm_entry_delete*/
    jer_pp_frwrd_ip_ipmc_ssm_get,/*mbcm_pp_ipmc_ssm_entry_get*/
	...
	NULL,/*mbcm_pp_frwrd_fec_entry_urpf_mode_set*/
};
