...
#define OCB_FMC_BULK_SIZE (32*1024)
...
int soc_jer_ocb_dram_buffer_conf_calc(int unit) 
{
    ...
    uint32                              fbc_fmc_0_size = 0,       fbc_fmc_1_size = 0,   fbc_mnmc_0_size = 0,    fbc_mnmc_1_size = 0;
    ...
    if(max_nof_dram_buffers == 0) 
    {
        ...
        mnmc_total_size = SOC_SAND_MIN( (max_nof_buffers - (fmc_ocb_total_bulk_size)), (max_nof_dram_buffers - (OCB_FMC_BULK_SIZE * fmc_total_used_bulks)) );
    ...
    /** Verify Alignment **/
    /* OCB_0, OCB_1, FMC_0 and FMC_1 transitions needs to be on 32k alignment */
    if ((dbuffs->ocb_0.start % (32 * 1024) != 0) || (dbuffs->ocb_1.start % (32 * 1024) != 0) || (dbuffs->fmc_0.start % (32 * 1024) != 0) || (dbuffs->fmc_1.start % (32 * 1024) != 0))
    {
