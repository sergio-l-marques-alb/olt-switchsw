  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_GLOBAL_DROP_SET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_global_drop_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_global_drop_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_GLOBAL_FC_SET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_global_fc_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_GLOBAL_FC_GET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_global_fc_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_MC_TC_FC_SET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_mc_tc_fc_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_MC_TC_FC_GET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_mc_tc_fc_get()", 0, 0);
}
  ...
  )
{
    ...
    SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_SP_TC_DROP_SET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_sp_tc_drop_set()", 0, 0);
}
  ...
  )
{
    ...
    SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_SP_TC_DROP_GET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_sp_tc_drop_get()", 0, 0);
}
  ...
  )
{
    ...
    SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_EGR_QUEUING_SP_RESERVED_SET);
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_egr_queuing_sp_reserved_set()", 0, 0);
}
