...
#define _JER_IPQ_TC_SHAPE_OFF (_JER_IPQ_TC_CLS_NOF_BITS + _JER_IPQ_TC_CLS_OFF)
#define _JER_IPQ_TC_SHAPE_NOF_BITS 1
#define _JER_IPQ_TC_SHAPE_MASK ((1 << _JER_IPQ_TC_SHAPE_NOF_BITS) - 1)

#define _JER_IPQ_TC_PROF_OFF (_JER_IPQ_TC_SHAPE_NOF_BITS + _JER_IPQ_TC_SHAPE_OFF)
#define _JER_IPQ_TC_PROF_NOF_BITS 2
#define _JER_IPQ_TC_PROF_MASK ((1 << _JER_IPQ_TC_PROF_NOF_BITS) - 1)

#define _JER_IPQ_TC_FLOW_OFF (_JER_IPQ_TC_PROF_NOF_BITS + _JER_IPQ_TC_PROF_OFF)
#define _JER_IPQ_TC_FLOW_NOF_BITS 2
#define _JER_IPQ_TC_FLOW_MASK ((1 << _JER_IPQ_TC_FLOW_NOF_BITS) - 1)

#define JER_IPQ_TC_ENTRY(is_flow_or_multicast, profile_ndx, is_ingress_shape ,tr_cls_ndx) \
    (\
    ((is_flow_or_multicast & _JER_IPQ_TC_FLOW_MASK)  << _JER_IPQ_TC_FLOW_OFF)   | \
    ((profile_ndx          & _JER_IPQ_TC_PROF_MASK)  << _JER_IPQ_TC_PROF_OFF)   | \
    ((is_ingress_shape     & _JER_IPQ_TC_SHAPE_MASK) << _JER_IPQ_TC_SHAPE_OFF)  | \
...
#define ARAD_IPQ_TC_ENTRY(unit, is_flow_or_multicast, profile_ndx, is_ingress_shape ,tr_cls_ndx) \
            ...
            (JER_IPQ_TC_ENTRY(is_flow_or_multicast, profile_ndx, is_ingress_shape ,tr_cls_ndx))) \
