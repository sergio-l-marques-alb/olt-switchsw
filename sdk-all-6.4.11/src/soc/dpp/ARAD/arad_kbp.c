    ...
    ARAD_KBP_TABLE_CONFIG
        Arad_kbp_table_config_info_static[ARAD_KBP_FRWRD_IP_NOF_TABLES] = {
            ...
            {   
				...
				{/* entry_key_parsing */
					3, 
					{{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX},{"DIP", 4, KBP_KEY_FIELD_PREFIX},{"SIP", 4, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
            ...
            {   
				...
				{/* entry_key_parsing */
					3, 
					{{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX},{"DIP", 16, KBP_KEY_FIELD_PREFIX},{"SIP", 16, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
    ...
    ARAD_KBP_LTR_CONFIG
        Arad_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 2: IPv4 MC with RPF */
            {
                ...
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
                {3, {{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 4, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}}},
                {2, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}}}
                },
                /* master key */
            ...
            /* DB 5: IPv6 MC with RPF */
            {
                ...
                { /* ltr searches */
#ifdef ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF
                    {3, {{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 16, KBP_KEY_FIELD_PREFIX}, {"SIP", 16, KBP_KEY_FIELD_PREFIX}}},
                    {2, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 16, KBP_KEY_FIELD_PREFIX}}}
#else /* ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF */
                    {2, {{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 16, KBP_KEY_FIELD_PREFIX}}}
#endif /* ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF */
                },
                /* master key */
#ifdef ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF
...
#else /* ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF */
                {3, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 16, KBP_KEY_FIELD_PREFIX}}},
#endif /* ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF */
                NULL, /* ARAD_KBP_INSTRUCTION */
                NULL, /* ARAD_KBP_KEY */
            }, 
...
static
    ARAD_KBP_TABLE_CONFIG
        Arad_plus_kbp_table_config_info_static[ARAD_KBP_FRWRD_IP_NOF_TABLES] = {
			...
			/*	both tacles below are dummy tables in order to support IPV6MC and IPV4MC RPF on lookup 2
			 *	further explanation in the 
			 */
			/* TABLE 19 (DUMMY-IPV4-MC) */ 
            {   
                FALSE, /* Valid */
...
ARAD_KBP_LTR_SINGLE_SEARCH ipv6_uc_extended_search = 
	   {3, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"IN-RIF", 2, KBP_KEY_FIELD_PREFIX},{"DIP", 16, KBP_KEY_FIELD_PREFIX} }};
    ...
    ARAD_KBP_LTR_CONFIG
        Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 2: IPv4 MC with RPF */
            {
                ...
                {ARAD_KBP_FRWRD_TBL_ID_IPV4_MC, ARAD_KBP_FRWRD_TBL_ID_DUMMY_IPV4_MC, ARAD_KBP_FRWRD_TBL_ID_IPV4_UC_RPF_1, ARAD_KBP_FRWRD_TBL_ID_DUMMY_3}, /* tbl_id's*/
                {ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_NOF_DB_TYPES}, /* Search Types*/ 
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
                {3, {{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 4, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}}},
...
#ifdef ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF
                0x7, /* parallel_srches_bmp */
                {ARAD_KBP_FRWRD_TBL_ID_IPV6_MC, ARAD_KBP_FRWRD_TBL_ID_DUMMY_IPV6_MC, ARAD_KBP_FRWRD_TBL_ID_IPV6_UC_RPF_1, ARAD_KBP_FRWRD_TBL_ID_DUMMY_3}, /* tbl_id's*/
                {ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_NOF_DB_TYPES}, /* Search Types*/ 
#else /* ARAD_KBP_IPV6_INSERT_SIP_IN_MASTER_KEY_FOR_VRF */
                0x1, /* parallel_srches_bmp */
                {ARAD_KBP_FRWRD_TBL_ID_IPV6_MC, ARAD_KBP_FRWRD_TBL_ID_DUMMY_1, ARAD_KBP_FRWRD_TBL_ID_DUMMY_2, ARAD_KBP_FRWRD_TBL_ID_DUMMY_3}, /* tbl_id's*/
    ...
    arad_kbp_frwd_ltr_db_t
        Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 2 : IPv4 MC PROGRAM */
            {
                ...
                ARAD_KBP_FRWRD_TABLE_OPCODE_IPV4_MC_COMP, 
                /* Result Data Length for each of 4 lookups */
                {ARAD_KBP_LUT_AD_TRANSFER_6B, ARAD_KBP_LUT_AD_TRANSFER_4B, ARAD_KBP_LUT_AD_TRANSFER_2B, 0x0},
                /* Result Data Format */
                {NLM_ARAD_INDEX_AND_64B_AD, NLM_ARAD_INDEX_AND_32B_AD, NLM_ARAD_INDEX_AND_32B_AD, NLM_ARAD_NO_INDEX_NO_AD},
                /* Result Total Length */
                (1 + ARAD_KBP_LUT_AD_TRANSFER_6B + ARAD_KBP_LUT_AD_TRANSFER_4B + ARAD_KBP_LUT_AD_TRANSFER_2B)
            },
    ...
    ARAD_KBP_GTM_OPCODE_CONFIG_INFO
        Arad_plus_kbp_gtm_opcode_config_info_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 2 : IPv4 MC + RPF PROGRAM */
            {
                (12 - 1), /* TX Data Size (10 bytes, minus 1) */
                1, /* TX Data Type (REQUEST) */
                (1 + 6 + 4 + 2 - 1), /* RX Data Size (1 (action) + 6 (First Result) + 2 (Second Result) - 1 (minus 1)  */
                3 /* RX Data Type (REPLY) */
            },
            ...
            /* DB 6 : IPv6 MC + RPF PROGRAM */
            {
                (36 - 1), /* TX Data Size (18 bytes, minus 1) */
                1, /* TX Data Type (REQUEST) */
                (1 + 6 + 4 + 2 - 1), /* RX Data Size (1 (action) + 6 (First Result) + 4 + (Second result) + 2 (Third Result) - 1 (minus 1)  */
                3 /* RX Data Type (REPLY) */
            },
    ...
    )
{
    ...
    if (SOC_IS_ARADPLUS(unit) && (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "ext_rpf_fwd_parallel", 0) == 0)){
        ...
        if (ARAD_KBP_ENABLE_IPV6_EXTENDED){/* in this case the RPF table is primary table. */
			...
			if(soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "inrif_mapping_ipv6_uc", 0))
			{
				Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].parallel_srches_bmp = 0x3;

				Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].tbl_id[1] = ARAD_KBP_FRWRD_TBL_ID_INRIF_MAPPING;
				Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].search_type[1] = ARAD_KBP_DB_TYPE_ACL;

				Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].ltr_search[1] = inrif_mapping_search;
				Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].master_key_fields = ipv6_uc_extended_search;

				Arad_plus_kbp_gtm_lut_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].rec_size = 20;
				Arad_plus_kbp_gtm_lut_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].result1_idx_ad_cfg =  ARAD_KBP_LUT_AD_TRANSFER_4B;
				Arad_plus_kbp_gtm_lut_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].result1_idx_or_ad  =  ARAD_KBP_LUT_TRANSFER_AD_ONLY;

				Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].res_data_len[1] = ARAD_KBP_LUT_AD_TRANSFER_4B;
				Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].res_format[1] = NLM_ARAD_INDEX_AND_32B_AD;
				Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].res_total_data_len = 1 + ARAD_KBP_LUT_AD_TRANSFER_15B + ARAD_KBP_LUT_AD_TRANSFER_4B;

				Arad_plus_kbp_gtm_opcode_config_info_static[ARAD_KBP_FRWRD_DB_TYPE_EXTENDED_IPv6].rx_data_size = (1 + 15 - 1);
        ...
        for (i = 0; i < ARAD_KBP_FRWRD_DB_NOF_TYPES; i++) {            
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_ltr_config.set(unit, i, &Arad_plus_kbp_ltr_config_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 10+i, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_lut_info.set(unit, i, &Arad_plus_kbp_gtm_lut_info_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 50+i, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_ltr_info.set(unit, i, &Arad_plus_kbp_gtm_ltr_info_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 100+i, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_opcode_config_info.set(unit, i, &Arad_plus_kbp_gtm_opcode_config_info_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 150+i, exit);
        }
        for (i = 0; i < ARAD_KBP_FRWRD_IP_NOF_TABLES; i++) {            
    ...
    {
        for (i = 0; i < ARAD_KBP_FRWRD_DB_NOF_TYPES; i++) {            
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_ltr_config.set(unit, i, &Arad_kbp_ltr_config_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 10+i, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_lut_info.set(unit, i, &Arad_kbp_gtm_lut_info_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 50+i, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_ltr_info.set(unit, i, &Arad_kbp_gtm_ltr_info_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 100+i, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_opcode_config_info.set(unit, i, &Arad_kbp_gtm_opcode_config_info_static[i]); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 150+i, exit);
        }
        for (i = 0; i < ARAD_KBP_FRWRD_IP_NOF_TABLES; i++) {            
          ...
          tbl_idx++ ) 
    {
        ...
        if (table_size > 0x0) 
        {
			/* In case of IPV4MC or/and IPV6MC are valid table,
			 * enable also the dummy tables accordingly. 
			 */
   ...
   {
        arad_kbp_lut_data_t Arad_kbp_gtm_lut_info = {0};
        ...
        ARAD_KBP_GTM_OPCODE_CONFIG_INFO_clear(&Arad_kbp_gtm_opcode_config_info);
        ...
        for ( db_type = ARAD_KBP_FRWRD_DB_ACL_OFFSET; 
              ...
              db_type++) 
        { 
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_lut_info.set(unit, db_type, &Arad_kbp_gtm_lut_info); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 10+db_type, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_ltr_config.set(unit, db_type, &Arad_kbp_ltr_config); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 50+db_type, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_ltr_info.set(unit, db_type, &Arad_kbp_gtm_ltr_info); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 100+db_type, exit);
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_opcode_config_info.set(unit, db_type, &Arad_kbp_gtm_opcode_config_info); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 150+db_type, exit); 
        }
    ...
    for(db_type = 0; db_type < ARAD_KBP_MAX_NUM_OF_FRWRD_DBS; db_type++) 
    {
        ...
        valid_ltr = (ltr_config_info.parallel_srches_bmp > 0) ? TRUE : FALSE;

        for ( tbl_idx = 0; tbl_idx < ARAD_KBP_MAX_NUM_OF_PARALLEL_SEARCHES; tbl_idx++) 
        {
            if (SHR_BITGET(&(ltr_config_info.parallel_srches_bmp), tbl_idx)) {
                /* If one of the tables is not valid, then LTR is not valid */
				uint8 curr_ltr_valid = 0;
                table_id = ltr_config_info.tbl_id[tbl_idx];                
                res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_table_config_info.valid.get(unit, table_id, &curr_ltr_valid); 
                SOC_SAND_CHECK_FUNC_RESULT(res, 290+i, exit);
				valid_ltr &= curr_ltr_valid;
            }
        }

        res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_ltr_config.valid.set(unit, db_type, valid_ltr); 
 ...
 */
STATIC uint32 
	arad_kbp_get_masker_key_by_ltr_id(
	...
	)
{
    ...
    sal_memset(master_key, 0x0, sizeof(*master_key));
	ARAD_KBP_LTR_CONFIG_clear(&ltr_config_info);
    ...
    arad_kbp_result_configurations_update(int unit, ARAD_KBP_FRWRD_IP_DB_TYPE db_type, int results_size[ARAD_PP_FLP_KBP_MAX_NUMBER_OF_RESULTS], int results_valid[ARAD_PP_FLP_KBP_MAX_NUMBER_OF_RESULTS])
{
    ...
    for (i = 0; i < ARAD_PP_FLP_KBP_MAX_NUMBER_OF_RESULTS; i++) {
        ...
        if (!results_valid[i]) {
            res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_ltr_info.res_format.set(unit, db_type, i, NLM_ARAD_NO_INDEX_NO_AD); 
            SOC_SAND_CHECK_FUNC_RESULT(res, 120, exit);
        } else {
			last_valid_result = i;
			total_size_valid_lookups += results_size[i];
			res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_ltr_info.res_format.set(unit, db_type, i, (results_size[i]+3)/4); 
    ...
    res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_gtm_opcode_config_info.rx_data_size.set(unit, db_type, total_size_all_lookups); 
    SOC_SAND_CHECK_FUNC_RESULT(res, 200, exit);
    ...
    )
{
    ...
    for (pgm_ndx = pgm_ndx_min; pgm_ndx < pgm_ndx_max; ++pgm_ndx)
    {
        ...
        if (pgm_ndx == prog_index) {/* for IPv6 the prog index allocated dynamiclly so the prog index != opcode */
		...
		if(SOC_IS_JERICHO(unit)){
			...
			arad_kbp_get_masker_key_by_ltr_id(unit, ltr_id, &num_of_frwd_segments, &master_key_fields);
    ...
    SOC_SAND_IN	uint8					*result)
{
	...
	for (i=0;i<ARAD_KBP_MAX_NUM_OF_PARALLEL_SEARCHES;i++) {
		...
		if (Arad_kbp_ltr_config.tbl_id[i] == ARAD_KBP_FRWRD_TBL_ID_DUMMY_0 ||
			Arad_kbp_ltr_config.tbl_id[i] == ARAD_KBP_FRWRD_TBL_ID_DUMMY_1 ||
			Arad_kbp_ltr_config.tbl_id[i] == ARAD_KBP_FRWRD_TBL_ID_DUMMY_2 ||
			Arad_kbp_ltr_config.tbl_id[i] == ARAD_KBP_FRWRD_TBL_ID_DUMMY_3) 
