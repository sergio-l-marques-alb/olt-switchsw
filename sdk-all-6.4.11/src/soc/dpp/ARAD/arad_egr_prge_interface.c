...
/*  {Field enum                      , src_select                       , offset_src                               , offset_base } */
    {PrgePktFieldFheiSize            , ARAD_EGR_PROG_EDITOR_DATA_SRC_PKT, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_REG_2    , 1           }, /* Assuming registers_source==TM and no changes to R2 */
    {PrgePktFieldFwdHdrOffset        , ARAD_EGR_PROG_EDITOR_DATA_SRC_PKT, ARAD_EGR_PROG_EDITOR_OFFSET_SRC_REG_2    , 4           }, /* Assuming registers_source==TM and no changes to R2 */
