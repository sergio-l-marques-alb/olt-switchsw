...
/* $Id: arad_pp_llp_cos.c,v 1.17 Broadcom SDK $
...
#define ARAD_PP_LLP_COS_MAPPING_TBL_NDX_MAX                      (ARAD_PP_NOF_LLP_COS_MAPPING_TABLES-1)
#define ARAD_PP_LLP_COS_TABLE_ID_NDX_MAX                         (ARAD_PP_NOF_LLP_COS_MAPPING_TABLES-1)
  ...
  Arad_pp_procedure_desc_element_llp_cos[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_GLBL_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_PORT_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_llp_cos[] =
{
   ...
   */
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_LLP_COS_MAPPING_TABLES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  {
    ARAD_PP_LLP_COS_MAPPING_TABLE_NOT_SUPPORTED_ERR,
    "ARAD_PP_LLP_COS_MAPPING_TABLE_NOT_SUPPORTED_ERR",
  ...
  )
{
  uint32
    res = SOC_SAND_OK;
  ARAD_PP_LLP_COS_MAPPING_TABLE
    mapping_tbl_ndx;
  ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO
    entry;
  uint32
    table_id_ndx = 0,
    entry_ndx = 0;
  ...
  ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO_clear(&entry);

  /* Mapping UP to DE,TC */
  mapping_tbl_ndx = ARAD_PP_LLP_COS_MAPPING_TABLE_UP_TO_DE_TC;
  ...
  /* Mapping UP to DP */
  mapping_tbl_ndx = ARAD_PP_LLP_COS_MAPPING_TABLE_UP_TO_DP;
  ...
  /* Mapping DE to UP */
  mapping_tbl_ndx = ARAD_PP_LLP_COS_MAPPING_TABLE_DE_TO_DP;
...
uint32
  arad_pp_llp_cos_glbl_info_set_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_LLP_COS_GLBL_INFO                   *glbl_info
  )
{
  uint32
    res;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_GLBL_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_GLBL_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_GLBL_INFO, glbl_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_GLBL_INFO_GET_VERIFY);
...
uint32
  arad_pp_llp_cos_glbl_info_get_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_OUT ARAD_PP_LLP_COS_GLBL_INFO                   *glbl_info
  )
{
  uint32
    res,
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_GLBL_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(glbl_info);

  ARAD_PP_LLP_COS_GLBL_INFO_clear(glbl_info);
...
uint32
  arad_pp_llp_cos_port_info_set_unsafe(
    ...
    SOC_SAND_IN  ARAD_PP_LLP_COS_PORT_INFO                   *port_info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_PORT_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_PORT_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_PORT_INFO, port_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_PORT_INFO_GET_VERIFY);
...
uint32
  arad_pp_llp_cos_port_info_get_unsafe(
    ...
    SOC_SAND_IN  int                                        core_id,
    SOC_SAND_IN  ARAD_PP_PORT                                local_port_ndx,
    SOC_SAND_OUT ARAD_PP_LLP_COS_PORT_INFO                   *port_info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_PORT_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(port_info);

  ARAD_PP_LLP_COS_PORT_INFO_clear(port_info);
...
uint32
  arad_pp_llp_cos_mapping_table_entry_set_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_LLP_COS_MAPPING_TABLE             mapping_tbl_ndx,
    SOC_SAND_IN  uint32                                  table_id_ndx,
    SOC_SAND_IN  uint32                                  entry_ndx,
    SOC_SAND_IN  ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO  *entry
  )
{
  uint32  
      res = SOC_SAND_OK,
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_SET_UNSAFE);
  ...
  {
  case ARAD_PP_LLP_COS_MAPPING_TABLE_UP_TO_DE_TC:
    /*
  ...
  case ARAD_PP_LLP_COS_MAPPING_TABLE_IPV4_TOS_TO_DP_TC_VALID:
    is_ipv4 = 1;
    /* Fall-through on purpose. Both cases are handled the same way, with different
       is_ipv4 value */

  case ARAD_PP_LLP_COS_MAPPING_TABLE_IPV6_TC_TO_DP_TC_VALID:
  ...
  case ARAD_PP_LLP_COS_MAPPING_TABLE_INCOMING_UP_TO_UP:
    /*
  ...
  case ARAD_PP_LLP_COS_MAPPING_TABLE_TC_TO_UP:
  ...
  case ARAD_PP_LLP_COS_MAPPING_TABLE_DE_TO_DP:
  ...
  case ARAD_PP_LLP_COS_MAPPING_TABLE_UP_TO_DP:
  ...
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_LLP_COS_MAPPING_TABLE_NOT_SUPPORTED_ERR, 140, exit);
    break;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_SET_VERIFY);
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO, entry, 40, exit);
  ...
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_LLP_COS_MAPPING_TABLE_NOT_SUPPORTED_ERR, 50, exit);
    break;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_VERIFY);
...
uint32
  arad_pp_llp_cos_mapping_table_entry_get_unsafe(
    ...
    SOC_SAND_IN  uint32                                  table_id_ndx,
    SOC_SAND_IN  uint32                                  entry_ndx,
    SOC_SAND_OUT ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO    *entry
  )
{
  uint32  
      res = SOC_SAND_OK,
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_UNSAFE);
...
uint32
  arad_pp_llp_cos_l4_port_range_info_set_unsafe(
    ...
    SOC_SAND_IN  ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO          *range_info
  )
{
  uint32
    reg_val,
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(range_ndx, ARAD_PP_LLP_COS_RANGE_NDX_MAX, ARAD_PP_LLP_COS_RANGE_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO, range_info, 20, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_GET_VERIFY);
...
uint32
  arad_pp_llp_cos_l4_port_range_info_get_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  uint32                                  range_ndx,
    SOC_SAND_OUT ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO          *range_info
  )
{
  uint32
    reg_val,
  ...
  ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_clear(range_info);
...
uint32
  arad_pp_llp_cos_l4_port_range_to_tc_info_set_unsafe(
    ...
    SOC_SAND_IN  ARAD_PP_LLP_COS_TC_INFO                     *tc_info
  )
{
  uint32
    res = SOC_SAND_OK,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_TC_INFO, tc_info, 40, exit);
...
uint32
  arad_pp_llp_cos_l4_port_range_to_tc_info_get_unsafe(
    ...
    SOC_SAND_IN  uint32                                  src_port_match_range_ndx,
    SOC_SAND_IN  uint32                                  dest_port_match_range_ndx,
    SOC_SAND_OUT ARAD_PP_LLP_COS_TC_INFO                     *tc_info
  )
{
  uint32
    res = SOC_SAND_OK,
  ...
  ARAD_PP_LLP_COS_TC_INFO_clear(tc_info);
  SOC_REG_ABOVE_64_CLEAR(reg_above64_val);
...
uint32
  arad_pp_llp_cos_ipv4_subnet_based_set_unsafe(
    ...
    SOC_SAND_IN  ARAD_PP_LLP_COS_IPV4_SUBNET_INFO            *subnet_based_info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_IPV4_SUBNET_INFO, subnet_based_info, 30, exit);
...
uint32
  arad_pp_llp_cos_ipv4_subnet_based_get_unsafe(
    ...
    SOC_SAND_OUT ARAD_PP_LLP_COS_IPV4_SUBNET_INFO            *subnet_based_info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_PP_LLP_COS_IPV4_SUBNET_INFO_clear(subnet_based_info);
...
uint32
  arad_pp_llp_cos_protocol_based_set_unsafe(
    ...
    SOC_SAND_IN  ARAD_PP_LLP_COS_PRTCL_INFO                  *prtcl_assign_info,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_PRTCL_INFO, prtcl_assign_info, 30, exit);
...
uint32
  arad_pp_llp_cos_protocol_based_get_unsafe(
    ...
    SOC_SAND_IN  uint32                                  profile_ndx,
    SOC_SAND_IN  SOC_SAND_PP_ETHER_TYPE                        ether_type_ndx,
    SOC_SAND_OUT ARAD_PP_LLP_COS_PRTCL_INFO                  *prtcl_assign_info
  )
{
  uint32
    res = SOC_SAND_OK,
  ...
  ARAD_PP_LLP_COS_PRTCL_INFO_clear(prtcl_assign_info);
...
uint32
  ARAD_PP_LLP_COS_GLBL_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_GLBL_INFO *info
  )
{
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_GLBL_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_TC_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_TC_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_TC_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_UP_USE_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_UP_USE *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_UP_USE_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_PORT_L2_TABLE_INDEXES_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_PORT_L2_TABLE_INDEXES *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_PORT_L2_TABLE_INDEXES_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_PORT_L2_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_PORT_L2_INFO *info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_UP_USE, &(info->up_use), 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_PORT_L2_TABLE_INDEXES, &(info->tbls_select), 13, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_PORT_L2_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_PORT_L3_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_PORT_L3_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_PORT_L3_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_PORT_L4_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_PORT_L4_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_PORT_L4_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_PORT_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_PORT_INFO *info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_PORT_L2_INFO, &(info->l2_info), 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_PORT_L3_INFO, &(info->l3_info), 11, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_COS_PORT_L4_INFO, &(info->l4_info), 12, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->default_tc, SOC_SAND_PP_TC_MAX, SOC_SAND_PP_TC_OUT_OF_RANGE_ERR, 13, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_PORT_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_IPV4_SUBNET_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_IPV4_SUBNET_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_IPV4_SUBNET_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_PRTCL_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_PRTCL_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_PRTCL_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_verify()",0,0);
}
