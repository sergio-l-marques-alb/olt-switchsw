...
#define ARAD_PP_MPLS_TERM_KEY_TYPE_MAX                           (ARAD_PP_NOF_MPLS_TERM_KEY_TYPES-1)
    ...
    Arad_pp_procedure_desc_element_mpls_term[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LKUP_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_LABEL_RANGE_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MPLS_TERM_COS_INFO_GET_UNSAFE),
    ...
    Arad_pp_error_desc_element_mpls_term[] =
{
  ...
  {
    ARAD_PP_MPLS_TERM_KEY_TYPE_OUT_OF_RANGE_ERR,
    "ARAD_PP_MPLS_TERM_KEY_TYPE_OUT_OF_RANGE_ERR",
    "The parameter 'key_type' is out of range. \n\r "
    "The range is: 0 - ARAD_PP_NOF_MPLS_TERM_KEY_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  uint32
    res = SOC_SAND_OK;
  ARAD_PP_MPLS_TERM_PROFILE_INFO
    term_profile_info;
  ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO
    mpls_label_range_info;

  SOC_SAND_INIT_ERROR_DEFINITIONS(0);


  ARAD_PP_MPLS_TERM_PROFILE_INFO_clear(&term_profile_info);
  res = arad_pp_mpls_term_profile_info_set_unsafe(unit,0,&term_profile_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);

  /* GAL is requred for Load Balancing */
  ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_clear(&mpls_label_range_info);
  mpls_label_range_info.range.first_label = ARAD_PP_MPLS_TERM_RESERVED_LABEL_GAL;
  mpls_label_range_info.range.last_label  = ARAD_PP_MPLS_TERM_RESERVED_LABEL_GAL;
  res = arad_pp_mpls_term_label_range_set_unsafe(unit,ARAD_PP_MPLS_RANGE_NDX_GAL,&mpls_label_range_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);

  if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
    /* 
     * MPLS range ELI, GAL support
     */
    ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_clear(&mpls_label_range_info);
    mpls_label_range_info.range.first_label = ARAD_PP_MPLS_TERM_RESERVED_LABEL_ELI;
    mpls_label_range_info.range.last_label  = ARAD_PP_MPLS_TERM_RESERVED_LABEL_ELI;
  ...
  if (SOC_IS_JERICHO(unit)) {
    /* 
     * IPv4,6 NULL label support
     */
    ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_clear(&mpls_label_range_info);
    mpls_label_range_info.range.first_label = ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV4_EXP;
    mpls_label_range_info.range.last_label  = ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV4_EXP;
    res = arad_pp_mpls_term_label_range_set_unsafe(unit,ARAD_PP_MPLS_RANGE_NDX_IPV4,&mpls_label_range_info);
    SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);

    ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_clear(&mpls_label_range_info);
    mpls_label_range_info.range.first_label = ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV6_EXP;
    mpls_label_range_info.range.last_label  = ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV6_EXP;
...
*     Being set on init. not functinoal for ARAD. 
...
{  
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LKUP_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LKUP_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_TERM_LKUP_INFO, lkup_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LKUP_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LKUP_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(lkup_info);

  ARAD_PP_MPLS_TERM_LKUP_INFO_clear(lkup_info);
  ...
  if (with_in_rif)
  {
    lkup_info->key_type = ARAD_PP_MPLS_TERM_KEY_TYPE_LABEL_RIF;
  }
  else
  {
    lkup_info->key_type = ARAD_PP_MPLS_TERM_KEY_TYPE_LABEL;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LABEL_RANGE_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LABEL_RANGE_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(range_ndx, ARAD_PP_MPLS_TERM_RANGE_NDX_MAX, ARAD_PP_MPLS_TERM_RANGE_NDX_OUT_OF_RANGE_ERR, 10, exit);
  res = ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_verify(unit, label_range_info);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_LABEL_RANGE_GET_VERIFY);
  ...
  )
{
  ...
  res = ARAD_PP_MPLS_TERM_RESERVED_LABELS_GLBL_INFO_verify(unit, reserved_labels_info);
  ...
  )
{
  ...
  ARAD_PP_MPLS_TERM_RESERVED_LABELS_GLBL_INFO_clear(reserved_labels_info);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET_UNSAFE);
  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 10, exit);
exit:
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(label_ndx, SOC_SAND_PP_MPLS_LABEL_MAX, SOC_SAND_PP_MPLS_LABEL_OUT_OF_RANGE_ERR, 10, exit);
  res = ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_verify(unit, label_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET_VERIFY);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET_UNSAFE);
  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 10, exit);
exit:
 ...
 * COVERITY
 *
 * The value bit_index is set inside the function arad_pp_mpls_term_range_label_to_bit_index_get.
 */
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_COS_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_COS_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_TERM_COS_INFO, term_cos_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_COS_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_COS_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(term_cos_info);

  ARAD_PP_MPLS_TERM_COS_INFO_clear(term_cos_info);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_TERM_LABEL_COS_KEY, cos_key, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_TERM_LABEL_COS_VAL, cos_val, 20, exit);
  ...
  )
{
  ...
  ARAD_PP_MPLS_TERM_LABEL_COS_VAL_clear(cos_val);
...
/*********************************************************************
*     Set the termination profile attributes.
 *     Details: in the H file. (search for prototype)
*********************************************************************/
uint32
  ...
  )
{
	...
	SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_PROFILE_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_PROFILE_INFO_SET_VERIFY);
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_TERM_PROFILE_INFO, term_profile_info, 10, exit);
  ...
  )
{
 uint32
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MPLS_TERM_PROFILE_INFO_GET_VERIFY);
...
/*********************************************************************
*     Get the termination profile attributes.
 *     Details: in the H file. (search for prototype)
*********************************************************************/
uint32
...
/*********************************************************************
*     Set the termination action profile attributes.
 *     Details: in the H file. (search for prototype)
*********************************************************************/
uint32
  ...
  )
{
 uint32
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_ACTION_PROFILE, action_profile, 10, exit);
...
/*********************************************************************
*     Get the termination action profile attributes.
 *     Details: in the H file. (search for prototype)
*********************************************************************/
uint32
  ...
  )
{
	...
	ARAD_PP_ACTION_PROFILE_clear(action_profile);
...
soc_error_t arad_pp_mpls_termination_spacial_labels_init(int unit) {
    ...
    if (SOC_DPP_CONFIG(unit)->pp.explicit_null_support) {
        /* Add entries to TCAM for Explicit NULL */                
        ...
        isem_key.key_info.mpls.label = ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV4_EXP;
        ...
        SOCDNX_CLEAR(&isem_key, ARAD_PP_ISEM_ACCESS_KEY, 1);
        isem_key.key_type = ARAD_PP_ISEM_ACCESS_KEY_TYPE_MPLS_EXPLICIT_NULL;
        isem_key.key_info.mpls.label = ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV6_EXP;
        isem_entry.sem_result_ndx = SOC_DPP_CONFIG(unit)->pp.explicit_null_support_lif_id;
        res = arad_pp_isem_access_entry_add_unsafe(unit, &isem_key, &isem_entry, &success);
        SOCDNX_SAND_IF_ERR_EXIT(res);
...
uint32
  ARAD_PP_MPLS_TERM_LABEL_RANGE_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_LABEL_RANGE_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_LKUP_INFO_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->key_type, ARAD_PP_MPLS_TERM_KEY_TYPE_MAX, ARAD_PP_MPLS_TERM_KEY_TYPE_OUT_OF_RANGE_ERR, 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_LKUP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_INFO_verify(
    SOC_SAND_IN  int                    unit,
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_NOT_EQUALS_VALUE(info->next_prtcl, SOC_PPC_NOF_L3_NEXT_PRTCL_TYPES, ARAD_RIF_MPLS_TERM_NEXT_PRTCL_OUT_OF_RANGE_ERR, 15, exit); /* Not supported by ARAD */
  ...
  SOC_SAND_MAGIC_NUM_VERIFY(info);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_verify(
    SOC_SAND_IN  int                                unit,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_TERM_LABEL_RANGE, &(info->range), 10, exit);
  res = ARAD_PP_MPLS_TERM_INFO_verify(unit, &(info->term_info));
  SOC_SAND_CHECK_FUNC_RESULT(res, 11, exit);
  
  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_verify(
    SOC_SAND_IN  int                                   unit,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_ACTION_PROFILE, &(info->bos_action), 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_ACTION_PROFILE, &(info->non_bos_action), 11, exit);
  res = ARAD_PP_MPLS_TERM_INFO_verify(unit, &(info->term_info));
  ...
  SOC_SAND_ERR_IF_OUT_OF_RANGE(
    ...
    ARAD_PP_TRAP_CODE_MPLS_LABEL_VALUE_0,
    ARAD_PP_TRAP_CODE_MPLS_LABEL_VALUE_3,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_RESERVED_LABELS_GLBL_INFO_verify(
    SOC_SAND_IN  int                                         unit,
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(info->default_rif, SOC_DPP_CONFIG(unit)->l3.nof_rifs, ARAD_PP_RIF_ID_OUT_OF_RANGE_ERR, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_RESERVED_LABELS_GLBL_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_COS_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_COS_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_LABEL_COS_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_LABEL_COS_KEY_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_LABEL_COS_VAL_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_LABEL_COS_VAL_verify()",0,0);
}

uint32
  ARAD_PP_MPLS_TERM_PROFILE_INFO_verify(
    SOC_SAND_IN  ARAD_PP_MPLS_TERM_PROFILE_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_TERM_PROFILE_INFO_verify()",0,0);
}
