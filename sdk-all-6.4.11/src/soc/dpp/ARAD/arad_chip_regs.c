    ...
    arad_fast_reg_value_init(int unit)
{
    ...
    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISA_INTERRUPT_REGISTER].reg                   = SOC_IS_JERICHO(unit)? IHB_ISEM_INTERRUPT_REGISTER_ONEr: IHP_ISA_INTERRUPT_REGISTER_ONEr;
    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISA_INTERRUPT_REGISTER].index                 = 0;

    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISB_INTERRUPT_REGISTER].reg                   = SOC_IS_JERICHO(unit)? IHB_ISEM_INTERRUPT_REGISTER_ONEr: IHP_ISB_INTERRUPT_REGISTER_ONEr;
    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISB_INTERRUPT_REGISTER].index                 = 0;

    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISA_MANAGEMENT_UNIT_FAILURE].reg              = SOC_IS_JERICHO(unit)? IHB_ISEM_MANAGEMENT_UNIT_FAILUREr: IHP_ISA_MANAGEMENT_UNIT_FAILUREr;
    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISA_MANAGEMENT_UNIT_FAILURE].index            = 0;

    g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_ISB_MANAGEMENT_UNIT_FAILURE].reg              = SOC_IS_JERICHO(unit)? IHB_ISEM_MANAGEMENT_UNIT_FAILUREr: IHP_ISB_MANAGEMENT_UNIT_FAILUREr;
    ...
    g_fast_reg_info_table[unit][ARAD_FAST_REG_OAMP_BFD_TX_IPV4_MULTI_HOP].reg  = OAMP_BFD_TX_IPV4_MULTI_HOPr;
    ...
    if (SOC_IS_JERICHO(unit)) {
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_WORD].reg                   = KAPS_IBC_RESPONSE_WORDr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_WORD].index                 = 0;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_WORD].reg                    = KAPS_IBC_COMMAND_WORDr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_WORD].index                  = 0;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_0].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_0].index                = 0;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_1].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_1].index                = 1;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_2].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_2].index                = 2;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_3].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_3].index                = 3;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_4].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_4].index                = 4;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_5].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_5].index                = 5;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_6].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_6].index                = 6;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_7].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_7].index                = 7;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_8].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_8].index                = 8;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_9].reg                  = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_9].index                = 9;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_10].reg                 = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_10].index               = 10;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_11].reg                 = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_11].index               = 11;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_12].reg                 = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_12].index               = 12;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_13].reg                 = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_13].index               = 13;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_14].reg                 = KAPS_IBC_COMMAND_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_COMMAND_DATA_14].index               = 14;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_0].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_0].index               = 0;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_1].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_1].index               = 1;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_2].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_2].index               = 2;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_3].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_3].index               = 3;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_4].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_4].index               = 4;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_5].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_5].index               = 5;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_6].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_6].index               = 6;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_7].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_7].index               = 7;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_8].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_8].index               = 8;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_9].reg                 = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_9].index               = 9;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_10].reg                = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_10].index              = 10;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_11].reg                = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_11].index              = 11;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_12].reg                = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_12].index              = 12;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_13].reg                = KAPS_IBC_RESPONSE_DATAr;
        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_13].index              = 13;

        g_fast_reg_info_table[unit][ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_DATA_14].reg                = KAPS_IBC_RESPONSE_DATAr;
    ...
    arad_fast_field_value_init(int unit)
{
    ...
    g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_ISA_INTERRUPT_REGISTER_ONE_ISA_MANAGEMENT_COMPLETED].reg   = SOC_IS_JERICHO(unit)? IHB_ISEM_INTERRUPT_REGISTER_ONEr: IHP_ISA_INTERRUPT_REGISTER_ONEr;
    ...
    g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_ISB_INTERRUPT_REGISTER_ONE_ISB_MANAGEMENT_COMPLETED].reg   = SOC_IS_JERICHO(unit)? IHB_ISEM_INTERRUPT_REGISTER_ONEr: IHP_ISB_INTERRUPT_REGISTER_ONEr;
    ...
    g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_ISA_MANAGEMENT_UNIT_FAILURE_ISA_MNGMNT_UNIT_FAILURE_VALID].reg   = SOC_IS_JERICHO(unit)? IHB_ISEM_MANAGEMENT_UNIT_FAILUREr: IHP_ISA_MANAGEMENT_UNIT_FAILUREr;
    ...
    g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_ISB_MANAGEMENT_UNIT_FAILURE_ISB_MNGMNT_UNIT_FAILURE_VALID].reg   = SOC_IS_JERICHO(unit)? IHB_ISEM_MANAGEMENT_UNIT_FAILUREr: IHP_ISB_MANAGEMENT_UNIT_FAILUREr;
    ...
    g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_ISA_MANAGEMENT_UNIT_FAILURE_ISA_MNGMNT_UNIT_FAILURE_REASON].reg   = SOC_IS_JERICHO(unit)? IHB_ISEM_MANAGEMENT_UNIT_FAILUREr: IHP_ISA_MANAGEMENT_UNIT_FAILUREr;
    ...
    g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_ISB_MANAGEMENT_UNIT_FAILURE_ISB_MNGMNT_UNIT_FAILURE_REASON].reg   = SOC_IS_JERICHO(unit)? IHB_ISEM_MANAGEMENT_UNIT_FAILUREr: IHP_ISB_MANAGEMENT_UNIT_FAILUREr;
    ...
    if (SOC_IS_JERICHO(unit)){
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_BLKID].reg   = KAPS_IBC_COMMAND_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_BLKID].field = BLKIDf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_CMD].reg   = KAPS_IBC_COMMAND_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_CMD].field = CMDf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_FUNC].reg   = KAPS_IBC_COMMAND_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_FUNC].field = FUNCf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_OFFSET].reg   = KAPS_IBC_COMMAND_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_OFFSET].field = OFFSETf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_BLKID].reg   = KAPS_IBC_RESPONSE_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_BLKID].field = BLKIDf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_RSP].reg   = KAPS_IBC_RESPONSE_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_RSP].field = RSPf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_FUNC].reg   = KAPS_IBC_RESPONSE_WORDr;
        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_FUNC].field = FUNCf;

        g_fast_field_info_table[unit][ARAD_FAST_FIELD_IHP_KAPS_IBC_RESPONSE_WORD_STATUS].reg   = KAPS_IBC_RESPONSE_WORDr;
    ...
    arad_fast_reg_access_init(int unit)
{
    ...
    if (SOC_IS_JERICHO(unit)){
        last_fast_reg = ARAD_FAST_REG_TYPE_LAST;
    }else{
        last_fast_reg = ARAD_FAST_REG_TYPE_LAST_NOT_JERICHO;
    }

    for (i = 0; i < last_fast_reg; i++) {
    ...
    arad_fast_field_access_init(int unit)
{
    ...
    if (SOC_IS_JERICHO(unit)){
        last_fast_field = ARAD_FAST_FIELD_TYPE_LAST;
    }else{
        last_fast_field = ARAD_FAST_FIELD_TYPE_LAST_NOT_JERICHO;
    }

    for (i = 0; i < last_fast_field; i++) {
