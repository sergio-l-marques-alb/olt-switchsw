  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(diag_vsi_info_get,(unit, core_id, vsi_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_pkt_trace_clear,(unit, core_id, pkt_trace));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_received_packet_info_get,(unit, core_id, rcvd_pkt_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_parsing_info_get,(unit, core_id, pars_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_termination_info_get,(unit, core_id, term_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_frwrd_lkup_info_get,(unit, core_id, frwrd_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_frwrd_lpm_lkup_get,(unit, core_id, lpm_key, fec_ptr, found, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_traps_info_get,(unit, core_id, traps_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_DEVICE_CALL(diag_trapped_packet_info_get,(unit, buff, max_size, buff_len, packet_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_frwrd_decision_trace_get,(unit, core_id, frwrd_trace_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_learning_info_get,(unit, core_id, learn_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_ing_vlan_edit_info_get,(unit, core_id, vec_res, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_pkt_associated_tm_info_get,(unit, core_id, pkt_tm_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_encap_info_get,(unit, core_id, encap_info, ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_db_lif_lkup_info_get,(unit, core_id, db_info, lkup_info,ret_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(diag_db_lem_lkup_info_get,(unit, core_id, db_info, type, key, val, valid));
  ...
  )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(diag_egress_vlan_edit_info_get,(unit, core_id, prm_vec_res, ret_val));
