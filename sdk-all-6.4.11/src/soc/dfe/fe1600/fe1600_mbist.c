/* $Id: fe1600_mbist.c,v 1.13 Broadcom SDK $
...
int soc_bist_all_fe1600(const int unit, const int skip_errors)
{
    ...
    /* initialize MBIST */
    SOCDNX_IF_ERR_EXIT(soc_dcmn_mbist_init(unit, &fe1600_mbist_device, &dynamic));
...
/*********************************************************************
*     Repeatedly perform an mbist test to check SER on FE1600.
*     Stop on errors or not depending on skip_errors.
*********************************************************************/
