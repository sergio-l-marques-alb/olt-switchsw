...
tdm_fill_ovs( tdm_mod_t *_tdm )
{
	...
	unsigned char tsc_stack[TDM_AUX_SIZE], *ovs_buf;
	short *z;
	tdm_calendar_t *cal;
...
**/
int
tdm_fill_ovs_simple(short *z, unsigned char ovs_buf[TDM_AUX_SIZE], int *bucket1, unsigned char *z11, int *bucket2, unsigned char *z22, int *bucket3, unsigned char *z33, int *bucket4, unsigned char *z44, int *bucket5, unsigned char *z55, int *bucket6, unsigned char *z66, int *bucket7, unsigned char *z77, int *bucket8, unsigned char *z88, int grp_len)
{
	TDM_SML_BAR
