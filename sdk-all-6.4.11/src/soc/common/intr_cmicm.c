...
STATIC intr_handler_t soc_cmicdv2_intr_handlers3[] = {
    ...
    { IRQ_CMCx_BLOCK(2),  soc_cmicdv2_parity_intr,  2, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(4),  soc_cmicdv2_parity_intr,  4, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(5),  soc_cmicdv2_parity_intr,  5, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(6),  soc_cmicdv2_parity_intr,  6, "BLOCK 6 INTR" },
    { IRQ_CMCx_BLOCK(7),  soc_cmicdv2_parity_intr,  7, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(8),  soc_cmicdv2_parity_intr,  8, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(9),  soc_cmicdv2_parity_intr,  9, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(10), soc_cmicdv2_parity_intr,  10, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(11), soc_cmicdv2_parity_intr,  11, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(12), soc_cmicdv2_parity_intr,  12, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(13), soc_cmicdv2_parity_intr,  13, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(14), soc_cmicdv2_parity_intr,  14, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(15), soc_cmicdv2_parity_intr,  15, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(16), soc_cmicdv2_parity_intr,  16, "BLOCK 4 INTR" },
    { IRQ_CMCx_BLOCK(25), soc_cmicdv2_parity_intr, 25, "BLOCK 25 INTR" },
...
STATIC intr_handler_t soc_cmicdv2_intr_handlers4[] = {
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 0, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 1, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 2, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 3, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 4, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 5, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 6, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 7, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 8, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 9, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 10, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 11, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 12, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 13, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 14, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 15, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 16, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 17, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 18, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 19, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 20, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 21, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 22, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 23, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 24, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 25, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 26, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 27, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 28, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 29, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 30, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv2_block_intr4, 31, "PARITY INTR" },
    { 0, NULL, 0, "" } /* Termination */
...
soc_cmicm_intr_sbusdma_done(int unit, uint32 ch)
{
	...
	/* Coverity issue, only 3 SBUSDMA channels per CMC */
	cmc = ch / 3;
	ch = ch % 3;
...
#endif
    } else if (SOC_IS_JERICHO(unit) && (ch == SOC_MEM_FIFO_DMA_CHANNEL_2))  {
#ifdef BCM_DPP_SUPPORT
        uint8 oam_is_init=0;
        uint8 bfd_is_init=0;
        uint32 rv;
...
#endif
    } else if (SOC_IS_JERICHO(unit) && (ch == SOC_MEM_FIFO_DMA_CHANNEL_0))  {
#ifdef BCM_DPP_SUPPORT
        /* Enable is done in the end of the handler */
        (void)soc_cmicm_intr0_disable(unit, IRQ_CMCx_FIFO_CH_DMA(ch));
        sal_dpc(arad_pp_frwrd_mact_learning_dma_event_handler, INT_TO_PTR(unit), 0, 0, 0, 0);
    ...
    if (SOC_IS_CALADAN3(unit)) {
	    ...
	    switch (val) {
	        ...
	        case SOC_SBX_CALADAN3_CM_INTR_POS:
	    	     ...
	    	     */
	    	    sal_dpc(soc_sbx_caladan3_cmu_ring_processing_wakeup,
...
check_type3:
    ...
    if (soc_feature(unit, soc_feature_cmicm_extended_interrupts) && !soc_feature(unit, soc_feature_short_cmic_error)) {
        ...
        for (;;) {
            ...
            LOG_VERBOSE(BSL_LS_SOC_COMMON,
                (BSL_META_U(unit, "soc_cmicm_intr unit %d: irqStat3 = 0x%x\n"),
                 unit, irqStat));
