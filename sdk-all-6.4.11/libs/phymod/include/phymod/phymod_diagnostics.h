...
typedef struct phymod_phy_eyescan_options_s {
    ...
    int8_t vstep;
    int8_t mode;
    int8_t ber_proj_scan_mode; /**< For BER projection Controls the direction and polarity of the test. */
    int8_t ber_proj_timer_cnt; /**< BER proj total measurement time in units of ~1.3 seconds. */
    int8_t ber_proj_err_cnt; /**< BER proj the error threshold it uses to step to next measurement in units of 16. */
