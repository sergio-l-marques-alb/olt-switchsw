 ...
 * Revision   :  $Id: falcon2_dino_functions.h 1172 2015-10-06 19:34:58Z kirand $
 *
...
/** Baseof lane variable block, FALCON/FALCON2 variant. */
#define FALCON2_DINO_LANE_VAR_RAM_BASE (0x420)
/** Sizeof lane variable block, FALCON/FALCON2 variant. */
 ...
 * `*(_FALCON2_DINO_ERR)' and returns it from a containing function if it is unequal to
 * `ERR_CODE_NONE'.
 *
