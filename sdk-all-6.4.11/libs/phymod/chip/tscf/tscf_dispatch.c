...
__phymod__dispatch__t__ phymod_tscf_driver = {
    ...
    tscf_phy_rx_set,
    tscf_phy_rx_get,
    tscf_phy_rx_adaptation_resume,
    tscf_phy_reset_set,
    tscf_phy_reset_get,
    tscf_phy_power_set,
    tscf_phy_power_get,
    tscf_phy_hg2_codec_control_set,
    tscf_phy_hg2_codec_control_get,
    ...
    tscf_phy_autoneg_oui_set,
    tscf_phy_autoneg_oui_get,
    tscf_phy_eee_set,
    tscf_phy_eee_get,
