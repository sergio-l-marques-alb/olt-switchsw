...
#include <phymod/chip/huracan_diagnostics.h>


__phymod_diagnostics__dispatch__t__ phymod_diagnostics_huracan_diagnostics_driver = {

    NULL, /* phymod_phy_rx_slicer_position_set */
    NULL, /* phymod_phy_rx_slicer_position_get */
    NULL, /* phymod_phy_rx_slicer_position_max_get */
    NULL, /* phymod_phy_prbs_config_set */
    NULL, /* phymod_phy_prbs_config_get */
    NULL, /* phymod_phy_prbs_enable_set */
    NULL, /* phymod_phy_prbs_enable_get */
    NULL, /* phymod_phy_prbs_status_get */
