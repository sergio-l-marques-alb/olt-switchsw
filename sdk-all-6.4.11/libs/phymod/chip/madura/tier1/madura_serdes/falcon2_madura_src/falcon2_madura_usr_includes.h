/**************************************************************************************
 *  File Name     :  falcon2_madura_usr_includes.h                                        *
 *  Created On    :  05/07/2014                                                       *
 *  Created By    :  Kiran Divakar                                                    *
 *  Description   :  Header file which includes all required std libraries and macros *
 *  Revision      :  $Id: falcon2_madura_usr_includes.h 996 2015-03-30 22:39:03Z kirand $ *
 *                                                                                    *
...
/** @file falcon2_madura_usr_includes.h
...
/*#undef SERDES_API_FLOATING_POINT*/
#undef COMPILER_HAS_DOUBLE

#ifndef FALCON2_MADURA_API_USR_INCLUDES_H
#define FALCON2_MADURA_API_USR_INCLUDES_H
