 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: merlin_koi_interface.h 1075 2015-07-02 22:59:52Z kirand $   *
 *                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/merlin_koi/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * merlin_koi_interface.h - provides the primary functionality.
 *
 * merlin_koi_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file merlin_koi_interface.h
 * Main interface functions provided to IP User
 */

#ifndef MERLIN_KOI_API_INTERFACE_H
#define MERLIN_KOI_API_INTERFACE_H

#include "merlin_koi_usr_includes.h"

#include "merlin_koi_enum.h"
...
struct merlin_koi_uc_lane_config_field_st {
...
struct merlin_koi_uc_core_config_field_st {
...
/** Lane Config Struct */
struct  merlin_koi_uc_lane_config_st {
  struct merlin_koi_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  merlin_koi_uc_core_config_st {
  struct merlin_koi_uc_core_config_field_st field;
  uint16_t word;
  int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct merlin_koi_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_get_uc_core_config(struct merlin_koi_uc_core_config_st *struct_val);
...
/** Column definition header for merlin_koi_display_core_state() API output.
 * To be called before merlin_koi_display_core_state_line() API.
 ...
 * Call merlin_koi_display_core_state_hdr() API before and merlin_koi_display_core_state_legend() after
 * calling this API to get a formatted core state display with legend.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_display_core_state_line(void);

/** Detailed description of each column in merlin_koi_display_core_state_line() API output.
 * To be called after merlin_koi_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * \n Note: Micro should be loaded only after issuing a merlin_koi_uc_reset(1) followed by asserting and de-asserting
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [merlin_koi_ucode_crc_verify()] and verifying the CRC value [merlin_koi_start_ucode_crc_calc()].
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [merlin_koi_ucode_crc_verify()] and verifying the CRC value [merlin_koi_start_ucode_crc_calc()].
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * Note: merlin_koi_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 * Note: User also needs to configure all lanes through merlin_koi_lane_config_for_iddq()
 ...
 * Along with merlin_koi_core_pwrdn(), all lanes powerdowns should also be issued using
 * merlin_koi_lane_pwrdn() to complete a Core Powerdown.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_get_uc_lane_cfg(struct merlin_koi_uc_lane_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_configure_pll(enum merlin_koi_pll_enum pll_cfg);
 ...
 */
err_code_t merlin_koi_validate_txfir_cfg(int8_t pre, int8_t main, int8_t post1, int8_t post2);
 ...
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_apply_txfir_cfg(int8_t pre, int8_t main, int8_t post1, int8_t post2);
 ...
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_read_tx_afe(enum srds_tx_afe_settings_enum param, int8_t *val);
 ...
 */
err_code_t merlin_koi_config_tx_hpf(uint8_t hpf_val);
 ...
 * @return Error Code generated by invalid settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_rd_tx_hpf_config(uint8_t *hpf_val);
 ...
 * It relies on the accuracy of merlin_koi_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use merlin_koi_read_eye_scan_stripe() function
 ...
 * merlin_koi_start_ber_scan_test(), merlin_koi_read_ber_scan_data(), merlin_koi_display_ber_scan_data().
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * \n Note: Call functions merlin_koi_display_lane_state_hdr() before and merlin_koi_display_lane_state_legend() after
 * to get a formatted lane state display with legend
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_display_lane_state(void);

/** Column definition header for merlin_koi display state.
 * To be called before merlin_koi_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_koi_display_lane_state_hdr(void);

/** Detailed explanation of each column in merlin_koi display state.
 * To be called after merlin_koi_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable merlin_koi support.
...
/** Parameterized diagnostic function which access to all merlin_koi control and status bits
 * This function is required to be implemented by upper level software to enable merlin_koi support.
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the merlin_koi_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: The patt_length input to the function should be the value sent to the merlin_koi_config_shared_tx_pattern() function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in merlin_koi_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Once the PRBS generator is configured, to enable PRBS use the merlin_koi_tx_prbs_en() API.
 ...
 * Once the PRBS checker is configured, use the merlin_koi_rx_prbs_en() API to enable the checker.
 ...
 * Note: User needs to configure all lanes through merlin_koi_lane_config_for_iddq() and also call merlin_koi_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
