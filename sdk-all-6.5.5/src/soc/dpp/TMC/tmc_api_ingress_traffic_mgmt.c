...
{
  const char* str = NULL;
  if(enum_val == SOC_TMC_ITM_VSQ_GROUPA_SZE(unit))
  {
    str = "vsq_groupa_sze";
  } else if (enum_val == SOC_TMC_ITM_VSQ_GROUPB_SZE(unit)) {
    str = "vsq_groupb_sze";
  } else if (enum_val == SOC_TMC_ITM_VSQ_GROUPC_SZE(unit)) {
    str = "vsq_groupc_sze";
  } else if (enum_val == SOC_TMC_ITM_VSQ_GROUPD_SZE(unit)) {
    str = "vsq_groupd_sze";
  } else {
    str = " Unknown";
  }
