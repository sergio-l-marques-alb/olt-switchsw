...
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_DIP_MASK_LSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_IP_GRE_TUNNEL_MSB(unit) + 1)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_MSB(unit)         (SOC_IS_QAX(unit) ? 3 : 2)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_TUNNEL_LSB(unit)              (SOC_IS_QAX(unit) ? 4 : 3)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_TUNNEL_MSB(unit)              (SOC_IS_QAX(unit) ? 14: 13)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_OUTER_VID_LSB(unit)           (SOC_IS_QAX(unit) ? 15 : 14)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_OUTER_VID_MSB(unit)           (SOC_IS_QAX(unit) ? 26 : 25)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_INNER_VID_LSB(unit)           (SOC_IS_QAX(unit) ? 27 : 26)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_INNER_VID_MSB(unit)           (SOC_IS_QAX(unit) ? 38 : 37)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_VLAN_DOMAIN_MSB(unit)         (SOC_IS_QAX(unit) ? 3 : 2)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_TUNNEL_LSB(unit)              (SOC_IS_QAX(unit) ? 4 : 3)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_TUNNEL_MSB(unit)              (SOC_IS_QAX(unit) ? 14 : 13)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_ETHERTYPE_LSB(unit)           (SOC_IS_QAX(unit) ? 15 : 14)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_ETHERTYPE_MSB(unit)           (SOC_IS_QAX(unit) ? 30 : 29)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_OUTER_VID_LSB(unit)           (SOC_IS_QAX(unit) ? 31 : 30)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_OUTER_VID_MSB(unit)           (SOC_IS_QAX(unit) ? 42 : 41)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_OUTER_DEI_LSB(unit)           (SOC_IS_QAX(unit) ? 43 : 42)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_OUTER_DEI_MSB(unit)           (SOC_IS_QAX(unit) ? 43 : 42)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_OUTER_PCP_LSB(unit)           (SOC_IS_QAX(unit) ? 44 : 43)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_OUTER_PCP_MSB(unit)           (SOC_IS_QAX(unit) ? 46 : 45)
...
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_INNER_VID_LSB(unit)           (SOC_IS_QAX(unit) ? 47 : 46)
#define ARAD_PP_ISEM_ACCESS_KEY_PON_VD_ETHERTYPE_TUNNEL_PCP_VID_VID_INNER_VID_MSB(unit)           (SOC_IS_QAX(unit) ? 58 : 57)
  ...
  )
{
  ...
  if (vt_programs[unit][PROG_VT_INDX_MPLS_PORT_L1].prog_used != -1) {
      SET_VT_PROGRAM_SELECTION(prog_indx);
      vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_MPLS_PORT_L1].priority[unit] = prog_indx;
      vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_MPLS_PORT_L1].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_INDEXED_MPLS_PORT_L1;
  }
   ...
   * {   
   */    
  if (vt_programs[unit][PROG_VT_VD_OUTERVID_L1L2].prog_used != -1)
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INITIALVID_L1L2].priority[unit]  = prog_indx;
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INITIALVID_L1L2].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_L1L2;
    prog_indx++; /* adding 2 program selections in one call */
  }
  
  if (vt_programs[unit][PROG_VT_VD_INITIALVID_L1L2].prog_used != -1)
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTERVID_L1L2].priority[unit]  = prog_indx;
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTERVID_L1L2].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VD_OUTERVID_L1L2;
    prog_indx++; /* adding 2 program selections in one call */
  }
  ...
  )
{
  ...
  */
  ...
  if (tt_programs[unit][PROG_TT_COUPLING_L3_L4].prog_used != -1)
  {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_COUPLING_L3_L4].priority[unit]  = prog_indx;
      tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_COUPLING_L3_L4].prog_name[unit] = ARAD_PP_DBAL_TT_PROG_COUPLING_L3_L4;
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  else
  {
      ...
      /* VT MPLS Port termination */
      if(SOC_DPP_CONFIG(unit)->pp.custom_feature_mpls_port_termination)
      {
         SET_VT_PROGRAM_ID(unit, PROG_VT_INDX_MPLS_PORT_L1);
         vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_INDEXED_MPLS_PORT_L1].prog_used[unit] = (last_vt_program_id - 1);
      }
      ...
      if ((!prog_soc_prop.port_vlan_pcp_lookup) && (!prog_soc_prop.match_port_vlan_critiria_64K) && (!prog_soc_prop.custom_feature_vt_tst1))
      {
          ...
          if (!prog_soc_prop.mpls_index && !prog_soc_prop.mpls_use_in_rif)
          {
              ...
              {
                  /* Coupling */
                  SET_VT_PROGRAM_ID(unit, PROG_VT_VD_INITIALVID_L1L2);
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_L1L2].prog_used[unit] = (last_vt_program_id - 1);
                  if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
                  {
                      SET_VT_PROGRAM_ID(unit, PROG_VT_VD_OUTERVID_L1L2);
                      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VD_OUTERVID_L1L2].prog_used[unit] = (last_vt_program_id - 1);
                  }
              }
          }
  ...
  if ((!prog_soc_prop.port_vlan_pcp_lookup) && (!prog_soc_prop.match_port_vlan_critiria_64K))
  {
    if ((!prog_soc_prop.mpls_index) && (!prog_soc_prop.mpls_use_in_rif)) 
    {
      ...
      {
        /* Coupling */
        SET_TT_PROGRAM_ID(PROG_TT_COUPLING_L3_L4);
        tt_dbal_programs[ARAD_PP_DBAL_TT_PROG_COUPLING_L3_L4].prog_used[unit] = (last_tt_program_id - 1);
      }
    }
    else if (prog_soc_prop.mpls_index && prog_soc_prop.mpls_use_in_rif) 
    {
  ...
  /* Jericho Explicit NULL WA program */
  ...
  )
{
  ...
  else
  {
      ...
      if (coupling_enable) { /* Enable when MPLS context specific is enabled */
          ...
          res = arad_tcam_access_create_unsafe(unit,ARAD_PP_ISEM_ACCESS_TCAM_MPLS_COUPLING_DB_PROFILE,&tcam_access_info, &success);
          SOC_SAND_CHECK_FUNC_RESULT(res, 15, exit);
      }
...
#define  prog_soc_prop     (&(g_prog_soc_prop[unit]))
    ...
    res = sw_state_access[unit].dpp.soc.arad.pp.oper_mode.mpls_info.mpls_coupling_enable.get(unit,&(prog_soc_prop->coupling_enable));
    ...
    { /* Default lookups : !pcp, !64K */   
               ...
               vt_profile == SOC_PPC_PORT_DEFINED_VT_PROFILE_DOUBLE_TAG_PRIORITY_INITIAL_VID)
      {
        ...
        tables_access_ids[0] = (isem_key->key_type == ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD_VID_VID) ? ARAD_PP_ISEM_ACCESS_ID_ISEM_A:ARAD_PP_ISEM_ACCESS_ID_ISEM_B;        
               ...
               && (vt_profile == SOC_PPC_PORT_DEFINED_VT_PROFILE_FRR_COUPLING || vt_profile == SOC_PPC_PORT_DEFINED_VT_PROFILE_FRR_COUPLING_USE_INITIAL_VID)) /* Port support FRR and/or Coupling - L2 in TCAM */
      {
    ...
    arad_pp_isem_access_isem_entry_get_unsafe(int unit, uint32 key_buffer[ARAD_PP_ISEM_ACCESS_KEY_SIZE], uint32 entry_buffer[SOC_DPP_DEFS_MAX(ISEM_PAYLOAD_NOF_UINT32)], uint32 tbl_access_id, uint8* success)
{
    ...
    SOC_SAND_INIT_ERROR_DEFINITIONS(0);
#ifdef CRASH_RECOVERY_SUPPORT
       soc_dcmn_cr_suppress(unit, dcmn_cr_no_support_em_tables);
  ...
  )
{
    ...
    case PROG_VT_VD_OUTERVID_L1FRR:
        ...
        break;
    case PROG_VT_VD_INITIALVID_L1L2:
        prog_name = "PROG_VT_VD_INITIALVID_L1L2";
        break;
    case PROG_VT_VD_OUTERVID_L1L2:
        prog_name = "PROG_VT_VD_OUTERVID_L1L2";
        break;        
  ...
  )
{
    ...
    case PROG_TT_L2_L3ELI:
        ...
        break;
    case PROG_TT_COUPLING_L3_L4:
        prog_name = "PROG_TT_COUPLING_L3_L4";
        break;
