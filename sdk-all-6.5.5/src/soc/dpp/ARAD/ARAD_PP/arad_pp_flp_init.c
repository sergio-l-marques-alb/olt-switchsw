   ...
   )
{
  ...
  if (vrf_update) {
      res = arad_pp_flp_set_app_id_and_get_cam_sel(unit, PROG_FLP_IPV4UC_VRF_UPDATE_PUBLIC_RPF, FALSE, TRUE, &cam_sel_id, prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  } else{
  ...
  if (vrf_update) {
      prog_selection_cam_tbl.tt_processing_profile      = ARAD_PP_IHP_VTT_TT_PROCESSING_PROFILE_VRF_UPDATE;
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
exit:
 SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_flp_prog_sel_cam_ipv4uc_with_l3vpn", vrf_update, 0);
}
   ...
   )
{
  ...
  if (vrf_update) {
      SOC_SAND_CHECK_NULL_INPUT(prog_id);
      res = arad_pp_flp_set_app_id_and_get_cam_sel(unit, PROG_FLP_IPV4UC_VRF_UPDATE_PUBLIC, FALSE, TRUE, &cam_sel_id, prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  } else{
   ...
   )
{
  ...
  if (vrf_update) {
      SOC_SAND_CHECK_NULL_INPUT(prog_id);
      res = arad_pp_flp_set_app_id_and_get_cam_sel(unit, PROG_FLP_IPV4UC_VRF_UPDATE_RPF, FALSE, TRUE, &cam_sel_id, prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  } else{
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
exit:
 SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_flp_prog_sel_cam_ipv4uc_with_rpf", vrf_update, 0);
}
   ...
   )
{
  ...
  if (vrf_update) {
      SOC_SAND_CHECK_NULL_INPUT(prog_id);
      res = arad_pp_flp_set_app_id_and_get_cam_sel(unit, PROG_FLP_IPV4UC_VRF_UPDATE, FALSE, TRUE, &cam_sel_id, prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  } else{
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
exit:
 SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_flp_prog_sel_cam_ipv4uc", vrf_update, 0);
}
   ...
   )
{
  ...
  if (vrf_update) {
      res = arad_pp_flp_set_app_id_and_get_cam_sel(unit,PROG_FLP_IPV6UC_VRF_UPDATE_RPF,FALSE,TRUE,&cam_sel_id, prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  } else {
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
exit:
 SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_flp_prog_sel_cam_ipv6uc_with_rpf", vrf_update, 0);
}
#endif
   ...
   )
{
  ...
  if (vrf_update) {
      SOC_SAND_CHECK_NULL_INPUT(prog_id);
      res = arad_pp_flp_set_app_id_and_get_cam_sel(unit, PROG_FLP_IPV6UC_VRF_UPDATE, FALSE, TRUE, &cam_sel_id, prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  } else {
...
if (SOC_IS_JERICHO(unit)) {
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
exit:
 SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_flp_prog_sel_cam_ipv6uc", vrf_update, 0);
}
   ...
   )
{
  ...
  res = arad_pp_flp_set_app_id_and_get_cam_sel(unit,PROG_FLP_COUPLING_LSR,TRUE,TRUE,&cam_sel_id, NULL);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
   ...
   )
{
  ...
  if(vrf_update) {
      res = arad_pp_flp_app_to_prog_index_get(unit,PROG_FLP_IPV4UC_VRF_UPDATE_RPF,&prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 41, exit);
  } else{
      prog_id = PROG_FLP_IPV4UC_RPF;
  }
   ...
   )
{
  ...
  if (custom_prgrm) {
      ...
      if(vrf_update) {
          res = arad_pp_flp_app_to_prog_index_get(unit,PROG_FLP_IPV4UC_VRF_UPDATE_PUBLIC,&prog_id);
          SOC_SAND_CHECK_FUNC_RESULT(res, 41, exit);
      } else{
   ...
   )
{
  ...
  /*ARAD_PP_FLP_INIT_PRINT_ADVANCE("arad_pp_flp_process_ipv4uc_with_rpf");*/
  if(vrf_update) {
      res = arad_pp_flp_app_to_prog_index_get(unit,PROG_FLP_IPV4UC_VRF_UPDATE,&prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 41, exit);
  } else{
   ...
   )
{
  ...
  /*ARAD_PP_FLP_INIT_PRINT_ADVANCE("arad_pp_flp_process_ipv6uc");*/
  if(vrf_update) {
      res = arad_pp_flp_app_to_prog_index_get(unit,PROG_FLP_IPV6UC_VRF_UPDATE,&prog_id);
      SOC_SAND_CHECK_FUNC_RESULT(res, 41, exit);
  } else{
      prog_id = PROG_FLP_IPV6UC;
  }
     ...
     int unit)
{
  ...
  if (is_routing_enabled) {
      ...
      /* COUPLING LSR */
      ARAD_PP_FLP_COMPILER_64_BITSET_WITH_VALIDATION(hw_prog_bitmap, PROG_FLP_COUPLING_LSR);
...
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
    uint8 vrf_update_ipv4_enabled;
    uint8 vrf_update_ipv6_enabled;
#endif
#endif /* INCLUDE_L3 */
...
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
  vrf_update_ipv4_enabled = SOC_DPP_CONFIG(unit)->pp.l3_route_vrf_update_ipv4;
  vrf_update_ipv6_enabled = SOC_DPP_CONFIG(unit)->pp.l3_route_vrf_update_ipv6;
#endif
  ...
  {      
...
#else
      {
          ...
          if(JER_KAPS_ENABLE(unit) && SOC_DPP_CONFIG(unit)->pp.custom_ip_route){
              int prog_id = 0;
              arad_pp_flp_prog_sel_cam_ipv4uc_l3vpn_custom_prgrm(unit,&prog_id); /* this will update prog_id*/
              arad_pp_flp_dbal_ipv4uc_l3vpn_program_tables_init(unit,prog_id,FALSE,0);
              arad_pp_flp_process_ipv4uc_l3vpn(unit,prog_id,FALSE);
          }
    #endif
      }

      /* ---------------------------------*/
      /* -- IPv4 UC VRF Update + L3VPN ---*/
      /* ---------------------------------*/
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
      if (vrf_update_ipv4_enabled && JER_KAPS_ENABLE(unit) && !ARAD_KBP_ENABLE_IPV4_UC){
          int prog_id;
          arad_pp_flp_prog_sel_cam_ipv4uc_l3vpn(unit, TRUE, &prog_id);
          arad_pp_flp_dbal_ipv4uc_l3vpn_program_tables_init(unit,0,TRUE,prog_id);
          arad_pp_flp_process_ipv4uc_l3vpn(unit,0,TRUE);
      }
#endif 
...
#endif
      {
          arad_pp_flp_prog_sel_cam_ipv4uc_l3vpn(unit, FALSE, NULL);
#if defined(BCM_88675_A0) && defined(INCLUDE_KBP) && !defined(BCM_88030)
          if(JER_KAPS_ENABLE(unit)){
              arad_pp_flp_dbal_ipv4uc_l3vpn_program_tables_init(unit,0,FALSE,0);
          }
          else
#endif
          {
          ...
          arad_pp_flp_process_ipv4uc_l3vpn(unit,0,FALSE);
      }

      /* ---------------------------------*/
      /* --- IPv4 UC VRF Update + RPF ----*/
      /* ---------------------------------*/
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
      if ((vrf_update_ipv4_enabled)&&(JER_KAPS_ENABLE(unit) || (ARAD_KBP_ENABLE_IPV4_RPF && SOC_IS_JERICHO(unit)))){
          int prog_id;
          arad_pp_flp_prog_sel_cam_ipv4uc_with_rpf(unit, TRUE, &prog_id);
          arad_pp_flp_dbal_ipv4uc_rpf_program_tables_init(unit,TRUE,prog_id);
          arad_pp_flp_process_ipv4uc_rpf(unit,TRUE);
      }
#endif 
      ...
      /* ----------- IPv4 UC + RPF -------------*/
      /* ---------------------------------------*/
      arad_pp_flp_prog_sel_cam_ipv4uc_with_rpf(unit,FALSE, NULL);
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
      if((JER_KAPS_ENABLE(unit)) || (ARAD_KBP_ENABLE_IPV4_RPF && SOC_IS_JERICHO(unit))) {
          arad_pp_flp_dbal_ipv4uc_rpf_program_tables_init(unit,FALSE,PROG_FLP_IPV4UC_RPF);
      }
      else 
#endif
      {
      ...
      arad_pp_flp_process_ipv4uc_rpf(unit,FALSE);

      /* ---------------------------------*/
      /* ------ IPv4 UC VRF Update--------*/
      /* ---------------------------------*/
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
      if ((vrf_update_ipv4_enabled)&&(JER_KAPS_ENABLE(unit) || (ARAD_KBP_ENABLE_IPV4_UC && SOC_IS_JERICHO(unit)))){
          int prog_id;
          arad_pp_flp_prog_sel_cam_ipv4uc(unit, TRUE, &prog_id);
          arad_pp_flp_dbal_ipv4uc_program_tables_init(unit,TRUE,prog_id);
          arad_pp_flp_process_ipv4uc(unit,TRUE);
      }
#endif 
      ...
      /* ----------- IPv4 UC -------------*/
      /* ---------------------------------*/
      arad_pp_flp_prog_sel_cam_ipv4uc(unit,FALSE,NULL);
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
      if(JER_KAPS_ENABLE(unit) || (ARAD_KBP_ENABLE_IPV4_UC && SOC_IS_JERICHO(unit))){
          arad_pp_flp_dbal_ipv4uc_program_tables_init(unit,FALSE,PROG_FLP_IPV4UC);
      }
      else 
#endif 
      {
      ...
      arad_pp_flp_process_ipv4uc(unit,FALSE);
    ...
    if (SOC_IS_ARADPLUS_A0(unit) && SOC_DPP_CONFIG(unit)->pp.oam_statistics) {
...
#if defined(BCM_88675_A0) && defined(INCLUDE_KBP) && !defined(BCM_88030)
      if(vrf_update_ipv6_enabled && SOC_IS_JERICHO(unit)){
          int prog_id;
          arad_pp_flp_prog_sel_cam_ipv6uc(unit,TRUE,&prog_id);
          arad_pp_flp_dbal_ipv6uc_program_tables_init(unit,TRUE,prog_id);
          arad_pp_flp_process_ipv6uc(unit,TRUE);
      }
#endif
      ...
      /* ----------- IPv6 UC -------------*/
      /* ---------------------------------*/
      arad_pp_flp_prog_sel_cam_ipv6uc(unit,FALSE,NULL);

#if defined(BCM_88675_A0) && defined(INCLUDE_KBP) && !defined(BCM_88030)
      if(ARAD_KBP_ENABLE_IPV6_UC){
          if (SOC_IS_JERICHO(unit)) {
              arad_pp_flp_dbal_ipv6uc_program_tables_init(unit,FALSE,PROG_FLP_IPV6UC);
          }
          else{
      ...
      arad_pp_flp_process_ipv6uc(unit,FALSE);

      /* ---------------------------------*/
      /* ----------- IPv6 MC -------------*/
      /* ---------------------------------*/
      arad_pp_flp_prog_sel_cam_ipv6mc(unit, &ipv6mc_cam_sel_id);
      ...
      /* ---------------------------------------*/
      /* ------ IPv6 UC VRF update + RPF -------*/
      /* ---------------------------------------*/
      if(!soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "l3_ipv6_uc_use_tcam", 0)) {
          if((JER_KAPS_ENABLE(unit) || ARAD_KBP_ENABLE_IPV6_UC)&&vrf_update_ipv6_enabled){
              int prog_id;
              arad_pp_flp_prog_sel_cam_ipv6uc_with_rpf(unit,TRUE, &prog_id);
              arad_pp_flp_dbal_ipv6uc_with_rpf_program_tables_init(unit, TRUE,prog_id);
      ...
      if (SOC_IS_JERICHO(unit)) {
          ...
          if(!soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "l3_ipv6_uc_use_tcam", 0)) {
              int prog_id;
              arad_pp_flp_prog_sel_cam_ipv6uc_with_rpf(unit,FALSE,&prog_id);

              if (JER_KAPS_ENABLE(unit) || ARAD_KBP_ENABLE_IPV6_UC) {
                  arad_pp_flp_dbal_ipv6uc_with_rpf_program_tables_init(unit, FALSE,prog_id);
              }
              arad_pp_flp_process_ipv6uc_with_rpf(unit, prog_id);
          }
      } else {
...
#if defined(BCM_88675_A0) && defined(INCLUDE_KBP) && !defined(BCM_88030)
      /* -----------------------------------------*/
      /* ---- IPv4 UC VRF update + L3VPN + RPF ---*/
      /* -----------------------------------------*/
      if (vrf_update_ipv4_enabled && JER_KAPS_ENABLE(unit) && !ARAD_KBP_ENABLE_IPV4_UC){
          int prog_id;
          arad_pp_flp_prog_sel_cam_ipv4uc_l3vpn_rpf(unit,TRUE,&prog_id);
          arad_pp_flp_dbal_ipv4uc_l3vpn_rpf_program_tables_init(unit,TRUE, prog_id);  
      ...
      if (JER_KAPS_ENABLE(unit) && !ARAD_KBP_ENABLE_IPV4_UC) {
          int prog_id;
          arad_pp_flp_prog_sel_cam_ipv4uc_l3vpn_rpf(unit, FALSE, &prog_id);
          arad_pp_flp_dbal_ipv4uc_l3vpn_rpf_program_tables_init(unit,FALSE, prog_id);  
          arad_pp_flp_process_ipv4uc_l3vpn_rpf(unit, prog_id);
      }
#endif
  ...
  )
{
  ...
  for (indx = 0; indx < SOC_DPP_DEFS_GET(unit, nof_flp_program_selection_lines); indx++) {
      ...
      if (flp_cam_tbl_data.parser_leaf_context != ARAD_PMF_PGM_SEL_PARSER_PROFILE_BFD_SINGLE_HOP) {
...
)
{
    ...
    case PROG_FLP_IPV4UC_VRF_UPDATE_PUBLIC:
        return "PROG_FLP_IPV4UC_VRF_UPDATE_PUBLIC";
    case PROG_FLP_IPV4UC_VRF_UPDATE_RPF:
        return "PROG_FLP_IPV4UC_VRF_UPDATE_RPF";
    case PROG_FLP_IPV4UC_VRF_UPDATE:
       return "PROG_FLP_IPV4UC_VRF_UPDATE";
    case PROG_FLP_IPV4UC_VRF_UPDATE_PUBLIC_RPF:
       return "PROG_FLP_IPV4UC_PUBLIC_VRF_UPDATE_RPF";
    case PROG_FLP_IPV6UC_VRF_UPDATE:
       return "PROG_FLP_IPV6UC_VRF_UPDATE";
    case PROG_FLP_IPV6UC_VRF_UPDATE_RPF:
       return "PROG_FLP_IPV6UC_VRF_UPDATE_RPF";
    default:
