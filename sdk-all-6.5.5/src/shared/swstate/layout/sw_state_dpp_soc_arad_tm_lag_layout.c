...
int sw_state_dpp_soc_arad_tm_lag_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   ARAD_LAGS_INFO* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(ARAD_LAGS_INFO),"ARAD_LAGS_INFO"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "lag",             /* name */         
                                   sizeof(ARAD_LAGS_INFO),    /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   "ARAD_LAGS_INFO",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_lag_in_use_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->local_to_reassembly_context)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   ...
                                   0,                 /* nof pointers */ 
                                   "uint8",              /* param type */
                                   ARAD_NOF_LAG_GROUPS_MAX,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
...
int sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "local_to_reassembly_context",             /* name */         
                                   sizeof(uint32),    /* size of the element's type*/          
                                   0,                 /* nof pointers */ 
                                   "uint32",              /* param type */
                                   ARAD_NOF_LOCAL_PORTS_MAX,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
