...
STATIC int rval_test_skip_mem(int unit, soc_mem_t mem, tr7_dbase_t *tr7_ptr)
{
    ...
    if(SOC_IS_RAMON_A0(unit)) {
        switch(mem) {
            case  BRDC_LCM_AUTO_DOC_NAME_19m:
            case  BRDC_QRH_CUCTm:
            case BRDC_QRH_DLLUm:
            case BRDC_QRH_DUCTm:
            case BRDC_QRH_FFLBm:
            ...
            case BRDC_QRH_MNOLm:
            case BRDC_QRH_RESERVED_21m:
            case BRDC_QRH_RESERVED_22m:
            case BRDC_QRH_RESERVED_23m:
            ...
            case QRH_MCSFFm:
            case QRH_MNOLm:
            case QRH_RESERVED_21m:
            case QRH_RESERVED_22m:
            case QRH_RESERVED_23m:
            case RTP_FLGMm:
            case RTP_GCILBTm:
            case RTP_MCLBTPm:
            case RTP_MCLBTSm:
            ...
            case RTP_MULTI_TBm:
            case RTP_RCGLBTm:
            case RTP_RESERVED_21m:
            case RTP_RESERVED_22m:
            case RTP_RESERVED_23m:
            case RTP_RMHMTm:
            case RTP_RRMAm:
            case RTP_SCTINCm:
            case RTP_SGRm:
