 ...
 */
STATIC void
diag_sand_reg_addrinfo_get(int unit, soc_regaddrinfo_t *ainfo, uint32 addr,
                        uint32 cmic_blk)
{
    int                     reg;
    uint32                  lkup_addr;
 ...
 */
STATIC void
diag_sand_reg_do_list(int unit, soc_regaddrinfo_t *ainfo, int use_reset,
...
STATIC void
diag_sand_print_regname(int unit, soc_reg_t reg, int *col, int pflags)
{
    int             len;
...
STATIC void
diag_sand_list_regs_by_type(int unit, soc_block_t blk, int *col, int pflag)
{
    soc_reg_t       reg;
...
cmd_result_t
cmd_dnx_reg_list(int unit, args_t *a)
{
    char           *str;
    char           *val;
    ...
    while (((str = ARG_GET(a)) != NULL) && (str[0] == '-')) {
        ...
        if (sal_strcasecmp(str, "type") == 0 ||
            ...
            for (i = 0; i < COUNTOF(SOC_INFO(unit).has_block); i++) {
                ...
                diag_sand_list_regs_by_type(unit, SOC_INFO(unit).has_block[i],
                                   &col, pflag);
            }
            bsl_log_add(BSL_APPL_SHELL, bslSeverityNormal, bslSinkIgnore, unit, "\n");
            return CMD_OK;
 ...
 */
STATIC  void
diag_sand_reg_print(int unit, soc_regaddrinfo_t *ainfo, soc_reg_above_64_val_t val, uint32 flags,
 ...
 */
STATIC  int
diag_sand_reg_print_one_field(int unit, soc_regaddrinfo_t *ainfo, soc_reg_above_64_val_t val, uint32 flags,
 ...
 */
STATIC int
diag_sand_reg_print_all(int unit, soc_regaddrlist_t *alist, uint32 flags)
{
    int                 j;
    soc_reg_above_64_val_t value; 
 ...
 */
STATIC int
diag_sand_reg_print_field(int unit, soc_regaddrlist_t *alist, uint32 flags, char *field_name)
{
    int                 j;
    soc_reg_above_64_val_t value; 
    int                 r, rv = 0, array_index, blk;
...
diag_sand_regtype_lookup_name(char* str)
{
    int i;
 ...
 */
STATIC int
diag_sand_reg_get_by_type(int unit, uint32 regaddr, uint32 cmic_blk, soc_regtype_t regtype,
...
static int
diag_sand_filter_regs(int unit , soc_reg_t reg){
...
int 
diag_sand_all_reg_get(int unit, int is_debug)
{
    int rc, blk, port,j;
 ...
 */
cmd_result_t
cmd_dnx_reg_get(int unit, args_t *a)
{
    soc_reg_above_64_val_t          regval;
    ...
    if(1 == all_regs) {
        ...
        return diag_sand_all_reg_get(unit, is_debug);
    }
 ...
 */
STATIC int
diag_sand_reg_set_by_type(int unit, uint32 regaddr, uint32 cmic_blk, soc_regtype_t regtype,
...
STATIC int
diag_sand_modify_reg_fields(int unit, soc_reg_t regno,
 ...
 */
STATIC cmd_result_t
diag_sand_do_reg_set(int unit, args_t *a, int mod)
{
    soc_reg_above_64_val_t regval;
 ...
 */
cmd_result_t
cmd_dnx_reg_set(int unit, args_t *a)
{
    return diag_sand_do_reg_set(unit, a, 0);
}

char cmd_dnx_reg_modify_usage[] =
 ...
 */
cmd_result_t
cmd_dnx_reg_modify(int unit, args_t * a)
{
