...
/* HW Definitions */
static bcm_xgs5_bfd_hw_defs_t    bcm_tr3_bfd_hw_defs;
...
bcmi_tr3_bfd_init(int unit)
{
    ...
    bcm_tr3_bfd_hw_defs.hw_call   = &bcm_tr3_bfd_hw_calls;
    bcm_tr3_bfd_hw_defs.l2        = &bcm_tr3_bfd_l2_table;
    bcm_tr3_bfd_hw_defs.l3_ipv4   = &bcm_tr3_bfd_l3_ipv4_table;
    bcm_tr3_bfd_hw_defs.l3_ipv6   = &bcm_tr3_bfd_l3_ipv6_table;
    bcm_tr3_bfd_hw_defs.l3_tunnel = &bcm_tr3_bfd_l3_tunnel_table;
    bcm_tr3_bfd_hw_defs.mpls      = &bcm_tr3_bfd_mpls_table;
    ...
    if (bfd_feature_enable & BFD_MHOP_FEATURE_ENABLE) {
         ...
         bcm_tr3_bfd_hw_defs.bfd_feature_enable = BFD_MHOP_FEATURE_ENABLE;
        ...
        /* Set UDP Dest port for Micro BFD session */
          ...
          bcm_tr3_bfd_hw_defs.bfd_feature_enable = BFD_MICRO_FEATURE_ENABLE;
          ...
          bcm_tr3_bfd_hw_defs.bfd_feature_enable = BFD_ECHO_FEATURE_ENABLE;
    }

    /* Initialize Common XGS5 BFD module */
    BCM_IF_ERROR_RETURN
        (bcmi_xgs5_bfd_init(unit, &bcm_tr3_bfd_drv, &bcm_tr3_bfd_hw_defs));

    return BCM_E_NONE;
}

#else   /* BCM_TRIUMPH3_SUPPORT && INCLUDE_BFD */
int bcm_esw_tr3_bfd_not_empty;
