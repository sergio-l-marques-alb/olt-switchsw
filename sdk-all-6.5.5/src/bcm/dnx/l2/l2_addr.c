  ...
  bcm_l2_addr_t * l2addr)
{
  ...
  /*
   * - if VSI > 4k, check it's allocated
   * - Check flags support 
   */
  ...
  bcm_l2_addr_t * l2addr)
{
  ...
  /*
   * GPORT MGMT missing. Currently assuming no GPORT encoding.
   */
  ...
  SHR_IF_ERR_EXIT(dbal_entry_field32_set
                  (unit, entry_handle_id, DBAL_FIELD_MODE_IS_KEY, DBAL_FIELD_FID,
                   l2addr->vid));
  SHR_IF_ERR_EXIT(dbal_entry_array8_set
                  (unit, entry_handle_id, DBAL_FIELD_MODE_IS_KEY, DBAL_FIELD_L2_MAC,
                   l2addr->mac));
  SHR_IF_ERR_EXIT(dbal_entry_field32_set
                  (unit, entry_handle_id, DBAL_FIELD_MODE_IS_VALUE, DBAL_FIELD_PORT_ID,
                   destination));
