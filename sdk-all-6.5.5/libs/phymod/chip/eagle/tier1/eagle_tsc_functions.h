/****************************************************************************
* File Name  :  eagle_tsc_functions.h
* Created On :  29/04/2013
* Created By :  Kiran Divakar
* Description:  Header file with API functions for Serdes IPs
* Revision   :  $Id: eagle_tsc_functions.h 996 2015-03-30 22:39:03Z kirand $
*
...
#ifndef EAGLE_TSC_API_FUNCTIONS_H
#define EAGLE_TSC_API_FUNCTIONS_H
...
/**
 * This build includes register access macros for EAGLE cores.
 */
