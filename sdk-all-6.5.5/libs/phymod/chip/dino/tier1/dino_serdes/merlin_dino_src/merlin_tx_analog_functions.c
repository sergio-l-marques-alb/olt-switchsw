 ...
 *  Revision      :  $Id: merlin_tx_analog_functions.c 1389 2016-04-06 21:38:57Z kirand $ *
 *                                                                                       *
...
err_code_t merlin_dino_validate_txfir_cfg( const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2) {
...
err_code_t merlin_dino_apply_txfir_cfg( const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2) {

  err_code_t failcode = merlin_dino_validate_txfir_cfg( pa, pre, main, post1, post2);
...
err_code_t merlin_dino_read_tx_afe( const phymod_access_t *pa, enum srds_tx_afe_settings_enum param, int8_t *val) {
    if(!val) {
...
err_code_t merlin_dino_config_tx_hpf( const phymod_access_t *pa, uint8_t val) {
...
err_code_t merlin_dino_rd_tx_hpf_config( const phymod_access_t *pa, uint8_t *pval) {
