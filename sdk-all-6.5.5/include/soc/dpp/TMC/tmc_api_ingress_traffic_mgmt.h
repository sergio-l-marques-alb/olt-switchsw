...
#define SOC_TMC_ITM_JERICHO_VSQ_NDX_RNG_LAST (SOC_TMC_ITM_JERICHO_VSQ_NDX_MAX + 1)
   ...
   *  4: Category VSQs: There are 4 categories.
   */
#define SOC_TMC_ITM_QAX_VSQ_GROUPA_SZE 4
  /*
   *  32: Category & Traffic Class VSQs: 4 categories * 8 Traffic Classes
   */
#define SOC_TMC_ITM_QAX_VSQ_GROUPB_SZE 32
  /*
   *  64: 32 Category2/3 & Connection Class VSQs: (2 Category2/3 * 32 Connection Class)
   */
#define SOC_TMC_ITM_QAX_VSQ_GROUPC_SZE 128
  /*
   *  256: Statistics VSQs
   */
#define SOC_TMC_ITM_QAX_VSQ_GROUPD_SZE 256
  /*
  *  128: LLFCs
  */
#define SOC_TMC_ITM_QAX_VSQ_GROUPE_SZE 128
  /*
  *  384: PFCs
  */
#define SOC_TMC_ITM_QAX_VSQ_GROUPF_SZE 384

  /*
   *  ITM-VSQ first index: Value 0
   */
#define SOC_TMC_ITM_QAX_VSQ_NDX_MIN 0
#define SOC_TMC_ITM_QAX_VSQ_NDX_MAX    \
    (SOC_TMC_ITM_QAX_VSQ_GROUPA_SZE +  \
     SOC_TMC_ITM_QAX_VSQ_GROUPB_SZE +  \
     SOC_TMC_ITM_QAX_VSQ_GROUPC_SZE +  \
     SOC_TMC_ITM_QAX_VSQ_GROUPD_SZE +  \
     SOC_TMC_ITM_QAX_VSQ_GROUPE_SZE +  \
     SOC_TMC_ITM_QAX_VSQ_GROUPF_SZE - 1)
 /*
  *  Must be the last value
  */
#define SOC_TMC_ITM_QAX_VSQ_NDX_RNG_LAST (SOC_TMC_ITM_QAX_VSQ_NDX_MAX + 1)

#define SOC_TMC_ITM_VSQ_GROUPA_SZE(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_GROUPA_SZE) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPA_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE))
#define SOC_TMC_ITM_VSQ_GROUPB_SZE(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_GROUPB_SZE) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPB_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE))
#define SOC_TMC_ITM_VSQ_GROUPC_SZE(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_GROUPC_SZE) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPC_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE))
#define SOC_TMC_ITM_VSQ_GROUPD_SZE(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_GROUPD_SZE) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPD_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE))
#define SOC_TMC_ITM_VSQ_GROUPE_SZE(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_GROUPE_SZE) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPE_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPE_SZE))
#define SOC_TMC_ITM_VSQ_GROUPF_SZE(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_GROUPF_SZE) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_GROUPF_SZE : SOC_TMC_ITM_ARAD_VSQ_GROUPF_SZE))

#define SOC_TMC_ITM_VSQ_NDX_MIN(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_NDX_MIN) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_NDX_MIN : SOC_TMC_ITM_ARAD_VSQ_NDX_MIN))
#define SOC_TMC_ITM_VSQ_NDX_MAX(unit) (SOC_IS_QAX(unit) ? (SOC_TMC_ITM_QAX_VSQ_NDX_MAX) : \
        (SOC_IS_JERICHO(unit) ? SOC_TMC_ITM_JERICHO_VSQ_NDX_MAX : SOC_TMC_ITM_ARAD_VSQ_NDX_MAX))
...
typedef struct
{
    ...
    uint32 adjust_factor[SOC_TMC_INGRESS_THRESHOLD_NOF_TYPES];
...
typedef struct
{
    ...
    uint32 max_guaranteed[SOC_TMC_INGRESS_THRESHOLD_NOF_TYPES];
    /* Max shared - FADT */
    SOC_TMC_ITM_VSQ_FADT_INFO max_shared[SOC_TMC_INGRESS_THRESHOLD_NOF_TYPES];
    /* Max headroom */
