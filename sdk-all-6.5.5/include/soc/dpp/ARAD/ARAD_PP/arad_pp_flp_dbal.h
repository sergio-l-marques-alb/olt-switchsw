...
uint32 arad_pp_flp_dbal_ipv4uc_rpf_program_tables_init(int unit, uint8 vrf_update, int prog_id);
uint32 arad_pp_flp_dbal_ipv4uc_program_tables_init(int unit, uint8 vrf_update, int prog_id);
...
uint32 arad_pp_flp_dbal_ipv4uc_l3vpn_program_tables_init(int unit, int custom_prgrm, uint8 vrf_update, int vrf_update_prog_id);
uint32 arad_pp_flp_dbal_ipv4uc_l3vpn_rpf_program_tables_init(int unit, uint8 vrf_update, int prog_id);
uint32 arad_pp_flp_dbal_ipv6uc_program_tables_init(int unit, uint8 vrf_update, int prog_id);
uint32 arad_pp_flp_dbal_ipv6uc_with_rpf_program_tables_init(int unit, uint8 vrf_update, int prog_id);
