...
#define SOC_DPP_CORE_CLOCK_FREQ_MHZ_QAX                      (600)
...
#define SOC_DPP_MAX_GBPS_RATE_EGQ_QAX                        (500)
...
#define SOC_DPP_DPP_COSQ_PB_ING_QUEUE_MAX_SIZE_DEFAULT_VAL_QAX (192*1024*16)
#define SOC_DPP_MAX_VSQ_RT_CLS_QAX                           (15)
#define SOC_DPP_MAX_VSQ_A_RT_CLS_QAX                         (3)
#define SOC_DPP_FIELD_LARGE_DIRECT_LU_KEY_LENGTH_QAX         (14)
