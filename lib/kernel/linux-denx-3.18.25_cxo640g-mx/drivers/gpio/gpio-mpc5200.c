 ...
 *
 * There's a maximum of 8 sint GPIOs. Which of these are available
 * for use depends on your board setup.
 *
 * 0 -> ETH_16
 * 1 -> ETH_15
...
static int __devinit mpc52xx_sint_gpiochip_probe(struct of_device *ofdev,
...
static const struct of_device_id mpc52xx_sint_gpiochip_match[] = {
	{
		.compatible = "fsl,mpc5200-gpio-sint",
	},
	{}
};

static struct of_platform_driver mpc52xx_sint_gpiochip_driver = {
	.name = "sint_wkup",
	.match_table = mpc52xx_sint_gpiochip_match,
	.probe = mpc52xx_sint_gpiochip_probe,
	.remove = mpc52xx_gpiochip_remove,
};
...
static int __init mpc52xx_gpio_init(void)
{
	...
	if (of_register_platform_driver(&mpc52xx_sint_gpiochip_driver))
