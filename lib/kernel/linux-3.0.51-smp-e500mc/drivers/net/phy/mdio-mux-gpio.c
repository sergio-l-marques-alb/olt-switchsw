...
static int __init mdio_mux_gpio_driver_init(void)
{
	return platform_driver_register(&mdio_mux_gpio_driver);
}

static void __exit mdio_mux_gpio_driver_exit(void)
{
	platform_driver_unregister(&mdio_mux_gpio_driver);
}

module_init(mdio_mux_gpio_driver_init);
module_exit(mdio_mux_gpio_driver_exit);
