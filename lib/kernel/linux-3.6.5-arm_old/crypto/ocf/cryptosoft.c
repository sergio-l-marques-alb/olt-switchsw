...
#define	CRYPTO_TFM_MODE_ECB	0
	...
	#define ctr(X)								#X , CRYPTO_TFM_MODE_CTR
...
static struct crypto_details crypto_details[] = {
	...
	[CRYPTO_DES_ECB]         = { ecb(des),          SW_TYPE_BLKCIPHER, },
	[CRYPTO_3DES_CBC]        = { cbc(des3_ede),     SW_TYPE_BLKCIPHER, },
	[CRYPTO_3DES_ECB]        = { ecb(des3_ede),     SW_TYPE_BLKCIPHER, },
	...
	[CRYPTO_AES_ECB]         = { ecb(aes),          SW_TYPE_BLKCIPHER, },
	[CRYPTO_AES_CTR]         = { ctr(aes),          SW_TYPE_BLKCIPHER, },
