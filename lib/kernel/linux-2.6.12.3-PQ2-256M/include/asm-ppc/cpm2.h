...
#if !(defined(CONFIG_BROUTER8) || defined(CONFIG_PQ2_PTIN))
...
#endif
#else /* !CONFIG_BROUTER8 */
#define CPM_DATAONLY_BASE       ((uint)0xA000)
#define CPM_DATAONLY_SIZE       ((uint)0xBF80 - CPM_DATAONLY_BASE)
#endif
...
#else
#define PROFF_SMC1      (0xBF80)
#define PROFF_SMC2      (0xBFC0)
#endif  
