						    ...
						    struct pci_dev *dev)
{
    ...
    //printk("LMP-PCI-> pci_match_device (0x%X) (0x%X)\n", drv->id_table->vendor, dev->vendor);
	...
	spin_unlock(&drv->dynids.lock);
    //printk("LMP-PCI-> pci_match_device (static)\n");
...
__pci_device_probe(struct pci_driver *drv, struct pci_dev *pci_dev)
{
    ...
    //printk("LMP-PCI-> __pci_device_probe\n");
...
static int pci_device_probe(struct device * dev)
{
    ...
    //printk("LMP-PCI-> pci_device_probe\n");
