...
scripts/dtc/dtc -O dtb -o p1010_ptin_unicom.dtb -b 0 -p 1024 arch/powerpc/boot/dts/p1010_ptin_unicom.dts
cp arch/powerpc/boot/uImage  kernelImageP1010_unicom.z
