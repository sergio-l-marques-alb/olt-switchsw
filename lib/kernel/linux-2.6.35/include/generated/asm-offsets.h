...
#define THREAD_FPEXC_MODE 320 /* offsetof(struct thread_struct, fpexc_mode)	 # */
#define THREAD_FPR0 56 /* offsetof(struct thread_struct, fpr[0])	 # */
#define THREAD_FPSCR 312 /* offsetof(struct thread_struct, fpscr)	 # */
#define PGDIR 16 /* offsetof(struct thread_struct, pgdir)	 # */
#define THREAD_DBCR0 20 /* offsetof(struct thread_struct, dbcr0)	 # */
#define THREAD_EVR0 332 /* offsetof(struct thread_struct, evr[0])	 # */
#define THREAD_ACC 464 /* offsetof(struct thread_struct, acc)	 # */
#define THREAD_SPEFSCR 472 /* offsetof(struct thread_struct, spefscr)	 # */
#define THREAD_USED_SPE 476 /* offsetof(struct thread_struct, used_spe)	 # */
...
#define CFG_SYSCALL_MAP32 60 /* offsetof(struct vdso_data, syscall_map_32)	 # */
...
#define CFG_ICACHE_BLOCKSZ 108 /* offsetof(struct vdso_data, icache_block_size)	 # */
#define CFG_DCACHE_BLOCKSZ 104 /* offsetof(struct vdso_data, dcache_block_size)	 # */
#define CFG_ICACHE_LOGBLOCKSZ 116 /* offsetof(struct vdso_data, icache_log_block_size)	 # */
#define CFG_DCACHE_LOGBLOCKSZ 112 /* offsetof(struct vdso_data, dcache_log_block_size)	 # */
