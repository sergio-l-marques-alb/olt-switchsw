...
#define MMCONTEXTID 392 /* offsetof(struct mm_struct, context.id)	 # */
#define THREAD_INFO 8 /* offsetof(struct task_struct, stack)	 # */
...
#define THREAD_NORMSAVES 64 /* offsetof(struct thread_struct, normsave[0])	 # */
#define THREAD_FPEXC_MODE 400 /* offsetof(struct thread_struct, fpexc_mode)	 # */
#define THREAD_FPR0 136 /* offsetof(struct thread_struct, fpr[0])	 # */
#define THREAD_FPSCR 392 /* offsetof(struct thread_struct, fpscr)	 # */
#define PGDIR 96 /* offsetof(struct thread_struct, pgdir)	 # */
#define THREAD_DBCR0 100 /* offsetof(struct thread_struct, dbcr0)	 # */
...
#define CPU_SPEC_SETUP 44 /* offsetof(struct cpu_spec, cpu_setup)	 # */
#define CPU_SPEC_RESTORE 48 /* offsetof(struct cpu_spec, cpu_restore)	 # */
