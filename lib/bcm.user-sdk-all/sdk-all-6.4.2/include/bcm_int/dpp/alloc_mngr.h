...
#define _DPP_AM_TEMPLATE_TPID_PROFILE_COUNT (8)
#define _DPP_AM_TEMPLATE_TPID_PROFILE_MAX_ENTITIES(unit) (_BCM_PETRA_NOF_PP_PORTS(unit))
...
#define BCM_DPP_AM_TRAP_EGRESS_MAX_ENTITIES_NO_FIELD (SOC_PPD_NOF_TRAP_EG_TYPES + 3) 

/* Egress thresh */
#define _DPP_AM_TEMPLATE_COSQ_EGR_THRESH_COUNT(unit)\
    (SOC_IS_ARAD(unit) ? 16 : 4)


typedef int (*dpp_am_cosq_flow_region_set_f)(int, int, int, int, int);
typedef int (*dpp_am_cosq_queue_region_set_f)(int, int, int, int);
...
typedef struct {
    ...
    bcm_dpp_am_cosq_pool_entry_t  *entries;
                                     /* region info */
...
typedef struct {
    ...
    dpp_am_cosq_resource_info_t  resource_info;
...
#define _BCM_DPP_AM_LIF_NOF_BANKS (SOC_PPD_EG_ENCAP_NOF_BANKS) /* Number of banks 64K/4K */
/* pool ids for Egress encaps */
typedef enum _dpp_res_arad_pool_egress_encap_e {
    dpp_res_arad_pool_egress_encap_bank_start = (dpp_am_res_count),  /* SHOULD BE FIRST *//*dpp_res_arad_TYPE_cosq - on purpose - DON'T TOUCH -has to do with cosq impelmentation*/
    dpp_res_arad_pool_egress_encap_bank_end = (dpp_res_arad_pool_egress_encap_bank_start + _BCM_DPP_AM_LIF_NOF_BANKS)       
} _dpp_res_arad_pool_egress_encap_t;


/* Type ids for Egress encaps */
typedef enum _dpp_res_arad_type_egress_encap_e {
    dpp_res_arad_type_egress_encap_bank_start = (dpp_am_res_count),  /* SHOULD BE FIRST */
    dpp_res_arad_type_egress_encap_bank_end = (dpp_res_arad_type_egress_encap_bank_start + _BCM_DPP_AM_LIF_NOF_BANKS)       
} _dpp_res_arad_type_egress_encap_t;

/* pool ids for Ingress LIFs */
typedef enum _dpp_res_arad_pool_ingress_lif_e {
    dpp_res_arad_pool_ingress_lif_bank_start = (dpp_res_arad_pool_egress_encap_bank_end),  /* SHOULD BE FIRST */
    dpp_res_arad_pool_ingress_lif_bank_end = (dpp_res_arad_pool_ingress_lif_bank_start + _BCM_DPP_AM_LIF_NOF_BANKS)       
} _dpp_res_arad_pool_ingress_lif_t;

/* Type ids for Ingress LIFs */
typedef enum _dpp_res_arad_type_ingress_lif_e {
    dpp_res_arad_type_ingress_lif_bank_start = (dpp_res_arad_type_egress_encap_bank_end),  /* SHOULD BE FIRST */
    dpp_res_arad_type_ingress_lif_bank_end = (dpp_res_arad_type_ingress_lif_bank_start + _BCM_DPP_AM_LIF_NOF_BANKS)       
} _dpp_res_arad_type_ingress_lif_t;
...
int
bcm_dpp_am_l2_vpn_pwe_is_alloced(
        int unit,
        SOC_PPD_LIF_ID lif,
        uint32 eep);
...
int _bcm_dpp_am_template_trap_egress_init(
        ...
        SOC_SAND_OUT SOC_PPD_TRAP_EG_ACTION_PROFILE_INFO *init_data);
...
int _bcm_dpp_am_template_l2_trap_rm_exchange(int unit, int flag, int port, int mac_lsb, bcm_dpp_user_defined_traps_t* data, int *old_template, int *is_last, int *template,int *is_allocated,bcm_dpp_rx_virtual_traps_t *virtual_traps_p);
...
/* OAM ICC MAP - Start */
int _bcm_dpp_am_template_oam_icc_map_ndx_alloc(int unit, int flags, SOC_PPD_OAM_ICC_MAP_DATA *data, int *is_allocated, int *icc_ndx);
...
/* BFD Flags - Start */  
int _bcm_dpp_am_template_bfd_flags_profile_alloc(int unit, int flags, uint32 *data, int *is_allocated, int *profile_ndx); 
...
int _bcm_dpp_am_template_oam_mep_profile_non_accelerated_alloc(int unit, int flags, SOC_PPD_OAM_LIF_PROFILE_DATA *data, int *is_allocated, int *profile);
...
int _bcm_dpp_am_template_oam_mep_profile_accelerated_alloc(int unit, int flags, SOC_PPD_OAM_LIF_PROFILE_DATA *data, int *is_allocated, int *profile);
...
int _bcm_dpp_am_template_bfd_mep_profile_non_accelerated_alloc(int unit, int flags, SOC_PPD_OAM_LIF_PROFILE_DATA *data, int *is_allocated, int *profile);
...
int _bcm_dpp_am_template_bfd_mep_profile_accelerated_alloc(int unit, int flags, SOC_PPD_OAM_LIF_PROFILE_DATA *data, int *is_allocated, int *profile);
...
int _bcm_dpp_am_template_bfd_mep_profile_accelerated_data_from_profile_get(int unit, int profile, SOC_PPD_OAM_LIF_PROFILE_DATA* data);
...
int _bcm_dpp_am_template_l2_prog_trap_alloc(int unit, int flags, SOC_PPD_LLP_TRAP_PROG_TRAP_QUALIFIER *qual, bcm_dpp_user_defined_traps_t *trap_res, int *template,int *is_allocated, bcm_dpp_rx_virtual_traps_t *virtual_traps_p, int is_virtual_traps_p_set);
...
int _bcm_dpp_am_template_fid_aging_profile_init(int unit, int fid_aging_profile, int aging_cycles);
int _bcm_dpp_am_template_fid_aging_profile_fid_profile_mapping_get(int unit, int vsi, int *event_handle_profile);
int _bcm_dpp_am_template_fid_aging_profile_data_get(int unit, int vsi, int *aging_cycles);
int _bcm_dpp_am_template_fid_aging_profile_exchange(int unit, int flags, int vsi, int aging_cycle, int *old_profile, int *is_last, int *new_profile,int *is_allocated);
...
int _bcm_dpp_am_template_vsq_rate_cls_ref_get(int unit, int template, uint32 *ref_count);
int _bcm_dpp_am_template_vsq_rate_cls_allocate_group(int unit, uint32 flags, bcm_dpp_cosq_vsq_rate_class_info_t *data_rate_cls, int ref_count, int *is_allocated, int *template);
int _bcm_dpp_am_template_vsq_rate_cls_tdata_get(int unit, int template, bcm_dpp_cosq_vsq_rate_class_info_t *data_rate_cls);
...
int _bcm_dpp_am_template_queue_discount_cls_ref_get(int unit, int template, uint32 *ref_count);
int _bcm_dpp_am_template_queue_discount_cls_allocate_group(int unit, uint32 flags, SOC_TMC_ITM_CR_DISCOUNT_INFO *data_discount_cls, int ref_count, int *is_allocated, int *template);
int _bcm_dpp_am_template_queue_discount_cls_tdata_get(int unit, int template, SOC_TMC_ITM_CR_DISCOUNT_INFO *data_discount_cls);

/* Ingress queue discount class - End */

/* Egress port discount class - Start */

int _bcm_dpp_am_template_egress_port_discount_cls_init(int unit,int port,const SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO* data_discount_cls);
int _bcm_dpp_am_template_egress_port_discount_cls_data_get(int unit,int port, SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO * data_discount_cls);
int _bcm_dpp_am_template_egress_port_discount_cls_exchange(int unit,int port, SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO * data_discount_cls, int *old_discount_cls, int *is_last, int *new_discount_cls,int *is_allocated);
/* int _bcm_dpp_am_template_egress_port_discount_cls_ref_get(int unit, int template, uint32 *ref_count); */
int _bcm_dpp_am_template_egress_port_discount_cls_per_header_type_ref_get(int unit,int template , SOC_TMC_PORT_HEADER_TYPE header_type ,uint32 *ref_count);
...
int _bcm_dpp_am_template_egress_port_discount_cls_per_header_type_tdata_get(int unit, int template, SOC_TMC_PORT_HEADER_TYPE header_type, SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO *data_discount_cls);

/* Egress port discount class - End */

/* COSQ Port hr flow control profile - Start */

int _bcm_dpp_am_template_cosq_port_hr_fc_profile_mapping_set(int unit, int port, int profile);
int _bcm_dpp_am_template_cosq_port_hr_fc_init(int unit, int template_init_id, int *fc_data_init);

int _bcm_dpp_am_template_cosq_port_hr_fc_data_get(int unit, int port, int *data);

int _bcm_dpp_am_template_cosq_port_hr_fc_exchange(int unit, int port, int *data, int *old_template, int *is_last, int *template, int *is_allocated);

int _bcm_dpp_am_template_cosq_hr_fc_ref_get(int unit, int template, uint32 *ref_count);

int _bcm_dpp_am_template_cosq_hr_fc_allocate_group(int unit, uint32 flags, int *data, int ref_count, int *is_allocated, int *template);
...
int _bcm_dpp_am_template_cosq_sched_class_allocate(int unit, int flags, int *data, int *is_allocated, int *class_template);

int _bcm_dpp_am_template_cosq_sched_class_free(int unit, int class_template, int *is_last);

int _bcm_dpp_am_template_cosq_sched_class_data_get(int unit, int class_template, int *data);

int _bcm_dpp_am_template_cosq_sched_class_exchange(int unit, int flags,int *data, int old_class_template, int *is_last, int *class_template, int *is_allocated);

int _bcm_dpp_am_template_cosq_sched_class_ref_get(int unit, int template, uint32 *ref_count);

int _bcm_dpp_am_template_cosq_sched_class_allocate_group(int unit, uint32 flags, int *data, int ref_count, int *is_allocated, int *template);

/* COSQ CL scheduler profile - End */


/* MPLS push profile - Start */
int _bcm_dpp_am_template_mpls_push_profile_exchange(int unit, int push_profile, SOC_PPD_EG_ENCAP_PUSH_PROFILE_INFO *push_profile_info,  int *is_last, int *new_push_profile,int *is_allocated, uint8 with_id);
...
int _bcm_dpp_am_template_meter_data_get(int unit,int meter_profile,int group,int high_rate,bcm_dpp_am_meter_entry_t *meter_profile_info);
int _bcm_dpp_am_template_meter_exchange(int unit, int meter_profile, int group, int high_rate, bcm_dpp_am_meter_entry_t *meter_profile_info,  int *is_last, int *new_meter_profile, int change_profile, int *is_allocated);
...
int _bcm_dpp_am_template_ptp_port_profile_exchange(int unit, int port_ndx, SOC_PPD_PTP_PORT_INFO *new_profile_data, SOC_PPD_PTP_IN_PP_PORT_PROFILE *new_profile_ndx);
...
#define BCM_DPP_AM_FLAG_ALLOC_GLOBAL   (0x00010000)
...
#define BCM_DPP_AM_FLAG_ALLOC_WITH_ID   (SHR_RES_ALLOC_WITH_ID)
/* if exist then reuse, can be set only if with id is present */
#define BCM_DPP_AM_FLAG_ALLOC_REPLACE      (0x00000008)

/* Enforces a EEDB entry allocation for Egress protection according to the Coupling mode */
#define BCM_DPP_AM_FLAG_ALLOC_EG_COUPLED_PAIR       (0x00000002)
#define BCM_DPP_AM_FLAG_ALLOC_EG_DECOUPLED_EVEN     (0x00000004)
#define BCM_DPP_AM_FLAG_ALLOC_EG_DECOUPLED_ODD      (0x00000010)
...
bcm_dpp_am_fec_dealloc(
    int unit,
    uint32 flags,
    _bcm_dpp_am_fec_alloc_usage, /* Currently ignored. */
...
/* Sync global lif */
int bcm_dpp_am_global_sync_lif_alloc(int unit, uint32 flags, int *global_lif);
int bcm_dpp_am_global_sync_lif_dealloc(int unit, int global_lif);

/* Egress global lif */
int bcm_dpp_am_global_egress_lif_alloc(int unit, uint32 flags, int *global_lif);
int bcm_dpp_am_global_egress_lif_is_alloced(int unit, int global_lif);
int bcm_dpp_am_global_egress_lif_dealloc(int unit, int global_lif);

/* Ingress global lif */
int bcm_dpp_am_global_ingress_lif_alloc(int unit, uint32 flags, int *global_lif);
int bcm_dpp_am_global_ingress_lif_is_alloced(int unit, int global_lif);
int bcm_dpp_am_global_ingress_lif_dealloc(int unit, int global_lif);
...
extern bcm_dpp_am_cosq_res_info_t cosq_res_info[BCM_MAX_NUM_UNITS];
