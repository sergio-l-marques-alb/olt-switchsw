...
typedef struct bcm_dpp_qos_state_s {
    ...
    SHR_BITDCL     *ing_lif_cos_mpls_bitmap;
    SHR_BITDCL     *ing_lif_cos_ipv4_bitmap;
    SHR_BITDCL     *ing_lif_cos_ipv6_bitmap;
    SHR_BITDCL     *ing_lif_cos_l2_inner_bitmap;
    SHR_BITDCL     *ing_lif_cos_l2_outer_bitmap;
    SHR_BITDCL     *ing_lif_cos_l2_untag_bitmap;
    SHR_BITDCL     *ing_pcp_vlan_ctag_bitmap;
    SHR_BITDCL     *ing_pcp_vlan_utag_bitmap;
    SHR_BITDCL     *ing_pcp_vlan_stag_bitmap;
    SHR_BITDCL     *egr_remark_encap_mpls_bitmap;
    SHR_BITDCL     *egr_remark_encap_ipv6_bitmap;
    SHR_BITDCL     *egr_remark_encap_ipv4_bitmap;
    SHR_BITDCL     *egr_remark_encap_l2_bitmap;
    SHR_BITDCL     *egr_remark_mpls_bitmap;
    SHR_BITDCL     *egr_remark_ipv6_bitmap;
    SHR_BITDCL     *egr_remark_ipv4_bitmap;
    SHR_BITDCL     *egr_mpls_php_ipv6_bitmap;
    SHR_BITDCL     *egr_mpls_php_ipv4_bitmap;
    SHR_BITDCL     *egr_pcp_vlan_ctag_bitmap;
    SHR_BITDCL     *egr_pcp_vlan_utag_bitmap;
    SHR_BITDCL     *egr_pcp_vlan_stag_bitmap;
    SHR_BITDCL     *egr_pcp_vlan_mpls_bitmap;
    SHR_BITDCL     *egr_pcp_vlan_ipv6_bitmap;
    SHR_BITDCL     *egr_pcp_vlan_ipv4_bitmap;
    SHR_BITDCL     *egr_l2_i_tag_bitmap;
#ifdef BCM_88660
    SHR_BITDCL     *egr_dscp_exp_marking_bitmap;
#endif /* BCM_88660 */
