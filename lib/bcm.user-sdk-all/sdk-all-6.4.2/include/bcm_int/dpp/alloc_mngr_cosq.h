...
int
_bcm_dpp_resources_fill_type_cosq(int unit, _dpp_res_type_cosq_t* dpp_res_cosq_type);

int
_bcm_dpp_resources_fill_pool_cosq(int unit, _dpp_res_pool_cosq_t* dpp_res_cosq_pool);
