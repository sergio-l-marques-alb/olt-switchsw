/*
 * $Id: trident2.h,v 1.72 Broadcom SDK $
...
extern int bcm_td2_port_init(int unit);
...
extern int 
_bcm_field_td2_qualify_ip_type(int unit, _field_entry_t *f_ent, 
                                          bcm_field_IpType_t type);
extern int 
_bcm_field_td2_qualify_ip_type_get(int unit, _field_entry_t *f_ent, 
                                              bcm_field_IpType_t *type);
extern int 
...
extern int _bcm_td2_l3_ip4_options_sync(int unit, uint8 **scache_ptr);
#endif /* BCM_WARM_BOOT_SUPPORT */
...
extern int bcm_td2_vxlan_egress_set(int unit, int nh_index, uint32 flags);
...
extern int bcm_td2_vxlan_multicast_leaf_entry_check(int unit, bcm_ip_t mc_ip_addr, bcm_ip_t  src_ip_addr, int enable_flag);
...
extern int bcm_td2_l2gre_match_delete(int unit,  int vp);
...
extern int _bcm_td2_proxy_nh_add(int unit, int idx, void *buf, int max_paths);
...
extern int bcm_td2_hg_rh_dynamic_size_encode(int dynamic_size,
        int *encoded_value);
