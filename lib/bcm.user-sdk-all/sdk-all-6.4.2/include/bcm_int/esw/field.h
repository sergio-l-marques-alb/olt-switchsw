...
typedef struct _field_stage_s {
    ...
    int                    pipes;           /* Number of pipelines in a stage */
    ...
    _field_counter32_collect_t *_field_32_counters[_FIELD_MAX_NUM_PIPES];
    _field_counter64_collect_t *_field_64_counters[_FIELD_MAX_NUM_PIPES];
...
typedef struct _field_funct_s {
    ...
    int (*fp_stat_value_get)(int unit, _field_stat_t *f_st,
