...
#define SOC_TMC_NOF_FAP_PORTS_MAX             SOC_SAND_MAX(SOC_TMC_NOF_FAP_PORTS_PETRA,SOC_TMC_NOF_FAP_PORTS_ARAD)  
...
*/               
#define SOC_TMC_SCH_MAX_RATE_MBPS_ARAD            (SOC_TMC_RATE_1K * 300)
#define SOC_TMC_SCH_MAX_RATE_MBPS_PETRA           (SOC_TMC_RATE_1K * 105)
/* Soc_petra-B default */
...
*  depending on the credit size
*/
#define SOC_TMC_SCH_MAX_RATE_KBPS_PETRA            (SOC_TMC_RATE_1K * SOC_TMC_SCH_MAX_RATE_MBPS_PETRA)
#define SOC_TMC_SCH_MAX_RATE_KBPS_ARAD             (SOC_TMC_RATE_1K * SOC_TMC_SCH_MAX_RATE_MBPS_ARAD)
/* Soc_petra-B default */
 ...
 *  depending on the credit size
 */
#define SOC_TMC_IF_MAX_RATE_MBPS_PETRA             (SOC_TMC_RATE_1K * 80)
#define SOC_TMC_IF_MAX_RATE_MBPS_ARAD              (SOC_TMC_RATE_1K * 300) 
/* Soc_petra-B default */
/*
 * Maximal interface rate, in Kilo-bits per second.
 * This is the upper boundary, it can be lower
 *  depending on the credit size
 */
#define SOC_TMC_IF_MAX_RATE_KBPS_PETRA             (SOC_TMC_RATE_1K * SOC_TMC_IF_MAX_RATE_MBPS_PETRA)
#define SOC_TMC_IF_MAX_RATE_KBPS_ARAD              (SOC_TMC_RATE_1K * SOC_TMC_IF_MAX_RATE_MBPS_ARAD)
/* Soc_petra-B default */
...
#define SOC_TMC_MULT_NOF_MULTICAST_GROUPS_PETRA (16*1024)
...
#define SOC_TMC_NOF_LAG_GROUPS              (256)
#define SOC_TMC_MAX_LAG_GROUP_ID            (SOC_TMC_NOF_LAG_GROUPS - 1)
