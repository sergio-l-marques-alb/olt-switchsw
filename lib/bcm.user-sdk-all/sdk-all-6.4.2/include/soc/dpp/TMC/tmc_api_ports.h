...
{
   /* 
    * 8/9 Forward error correction mode.
    */ 
    SOC_TMC_PORT_PCS_8_9_LEGACY_FEC = _SHR_PORT_PCS_8B9BLFEC,   
   /* 
    * 8/10 Forward error correction mode.
    */ 
    SOC_TMC_PORT_PCS_8_10           = _SHR_PORT_PCS_8B10B,
   /* 
    * 64/66 Forward error correction mode.
    */ 
    SOC_TMC_PORT_PCS_64_66_FEC      = _SHR_PORT_PCS_64B66BFEC,
   /* 
    * 64/66 Backward error correction mode.
    */ 
    SOC_TMC_PORT_PCS_64_66_BEC      = _SHR_PORT_PCS_64B66BBEC,
    /* 
    * 64/66 
    */ 
    SOC_TMC_PORT_PCS_64_66          = _SHR_PORT_PCS_64B66B,
    /* 
    * Number of EC types.
    */ 
    SOC_TMC_PORT_PCS_NOF_TYPES      = 5
