...
#define ARAD_MULT_FABRIC_SHAPER_MAX_BURST_SHIFT  26
#define ARAD_MULT_FABRIC_SHAPER_MAX_BURST_SIZE   6

#define ARAD_MULT_FABRIC_SHAPER_RATE_SHIFT       0
#define ARAD_MULT_FABRIC_SHAPER_RATE_SIZE        26
...
*     ARAD_MULT_FABRIC_INFO *exact_info - Exact credit source
