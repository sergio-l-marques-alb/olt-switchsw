...
#define ARAD_ITM_VSQ_QT_RT_CLS_MAX  15

#define ARAD_ITM_RATE_CLASS_MAX    63

#define ARAD_ITM_VSQ_GROUP_CTGRY_SIZE 4
#define ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE \
  ((ARAD_NOF_TRAFFIC_CLASSES)*ARAD_ITM_VSQ_GROUP_CTGRY_SIZE)
#define ARAD_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS_SIZE ((ARAD_ITM_QT_CC_CLS_MAX+1)*2)
#define ARAD_ITM_VSQ_GROUP_STTSTCS_TAG_SIZE 256
#define ARAD_ITM_VSQ_GROUP_LLFC_SIZE 32
#define ARAD_ITM_VSQ_GROUP_PFC_SIZE  256
...
#define ARAD_ITM_NOF_QT_NDXS                              SOC_TMC_ITM_NOF_QT_NDXS
...
#define ARAD_ITM_VSQ_GROUPA_SZE                           SOC_TMC_ITM_VSQ_GROUPA_SZE
#define ARAD_ITM_VSQ_GROUPB_SZE                           SOC_TMC_ITM_VSQ_GROUPB_SZE
#define ARAD_ITM_VSQ_GROUPC_SZE                           SOC_TMC_ITM_VSQ_GROUPC_SZE
#define ARAD_ITM_VSQ_GROUPD_SZE                           SOC_TMC_ITM_VSQ_GROUPD_SZE
#define ARAD_ITM_VSQ_GROUPE_SZE                           SOC_TMC_ITM_VSQ_GROUPE_SZE
#define ARAD_ITM_VSQ_GROUPF_SZE                           SOC_TMC_ITM_VSQ_GROUPF_SZE
typedef SOC_TMC_ITM_VSQ_GROUP_SIZE                             ARAD_ITM_VSQ_GROUP_SIZE;

#define ARAD_ITM_VSQ_NDX_MIN                              SOC_TMC_ITM_VSQ_NDX_MIN
#define ARAD_ITM_VSQ_NDX_MAX                              SOC_TMC_ITM_VSQ_NDX_MAX_ARAD
