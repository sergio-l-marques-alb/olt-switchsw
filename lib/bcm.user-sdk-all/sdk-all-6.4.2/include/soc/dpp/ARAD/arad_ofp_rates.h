/* $Id: arad_ofp_rates.h,v 1.12 Broadcom SDK $
 ...
 */
#define ARAD_OFP_RATES_CAL_LEN_EGQ_REG_MAX           0x0080

/* 
 * Calender maximum length for first 2 channelize arbiters
 */
#define ARAD_OFP_RATES_CAL_LEN_EGQ_0_1_MAX       0x0100

#define ARAD_OFP_RATES_CAL_LEN_EGQ_MAX          (SOC_SAND_MAX(ARAD_OFP_RATES_CAL_LEN_EGQ_REG_MAX,ARAD_OFP_RATES_CAL_LEN_EGQ_0_1_MAX))
...
/* 
 * Having a generic representation of EGQ calendar info 
 */
typedef enum
{
  /* Represents Channelize arbiter calendar */
  ARAD_OFP_RATES_EGQ_CAL_CHAN_ARB = 0,

  /* Represents TCG calendar */
  ARAD_OFP_RATES_EGQ_CAL_TCG = 1,

  /* Represents Port Priority calendar */
  ARAD_OFP_RATES_EGQ_CAL_PORT_PRIORITY = 2

} ARAD_OFP_RATES_EGQ_CAL_TYPE;
...
typedef struct
{
   ...
   *  Calendar type.   
   */
  ARAD_OFP_RATES_EGQ_CAL_TYPE cal_type;
  /*
   *  More information:
...
/*********************************************************************
* NAME:
*   arad_ofp_static_cal_build_from_rates
* TYPE:
*   PROC
* FUNCTION:
