...
typedef struct
{
  ...
  /*
  * warm boot variable index get/set of occ_bm variables.
  */
  int32 wb_var_index;

  /*
  * needed for warm boot set API (relevant only when wb_var_index != SOC_DPP_WB_ENGINE_VAR_NONE)
  */
  int unit;
...
{
 /*
  *  array to hold pointers to the levels arrays.
  */
  uint8 **levels;
 /*
...
typedef SOC_SAND_OCC_BM_T*  SOC_SAND_OCC_BM_PTR;
...
/*********************************************************************
* NAME:
*     soc_sand_occ_bm_occup_status_get
* TYPE:
*   PROC
* DATE:
*   Mar  6 2008
