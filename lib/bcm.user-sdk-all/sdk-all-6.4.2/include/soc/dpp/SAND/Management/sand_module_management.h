...
/******************************************************************
*
* FILENAME:       soc_sand_module_management.h
*
* AUTHOR:         Dune (S.Z.)
*
* FILE DESCRIPTION:
...
*      be larger than SOC_SAND_MAX_DEVICE.
...
*      than SOC_SAND_MIN_TCM_ACTIVATION_PERIOD.
...
*      is of size SOC_SAND_CALLBACK_BUF_SIZE and is replaced
*      by the user every time 'user_error_handler' is invoked.
*      Note bthat at 'soc_sand_module_close', user error handler
...
*          SOC_SAND_MIN_TIME_BETWEEN_INT_ERR_01 -
...
*            Procedure soc_sand_init_chip_descriptors() returned with
*            error indication.
*          SOC_SAND_HANDLES_INIT_ERR_01 -
*            Procedure soc_sand_handles_init_handles() returned with
*            error indication.
*          SOC_SAND_TCM_CALLBACK_ENGINE_START_ERR_01 -
*            Procedure soc_sand_tcm_callback_engine_start() returned with
*            error indication.
*          SOC_SAND_INDIRECT_SET_INFO_ERR_01 -
*            Procedure soc_sand_indirect_clear_info_all() returned with
*            error indication.
...
#endif
/* } __SOC_SAND_MODULE_MANAGEMENT_H_INCLUDED__*/
#endif
