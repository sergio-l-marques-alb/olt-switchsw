...
#define SOC_FE3200_FABRIC_CELL_CPU_CAPTURED_FORMAT_NOF_LINES_ONE_CELL (7)
#define SOC_FE3200_FABRIC_CELL_CPU_CAPTURED_FORMAT_NOF_LINES_DOUBLE_CELL (8)
...
#define SOC_FE3200_FABRIC_CELL_CPU_CAPTURED_FORMAT {\
    ...
    {soc_dcmn_fabric_cell_dest_id_cap_cell_dst,        NULL,          0,                1071,           19,     "DESTINATION_DEVICE"},\
    {soc_dcmn_fabric_cell_dest_id_cap_cell_size,       NULL,          0,                1117,           8,      "CELL_SIZE"},\
    {soc_dcmn_fabric_cell_dest_id_cap_cell_prio,       NULL,          0,                1113,           2,      "PRIORITY"},\
