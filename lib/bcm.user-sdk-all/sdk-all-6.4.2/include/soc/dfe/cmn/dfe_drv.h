...
typedef struct soc_dfe_mgmt_mode_s {
    ...
    int fabric_clk_freq_quad_26; /*This property is used in asymmetric FE13, for determining the additional quads (connected to FAP) clk speed */
    int fabric_clk_freq_quad_35; /*This property is used in asymmetric FE13, for determining the additional quads (connected to FAP) clk speed */
