...
typedef int (*mbcm_dfe_drv_graceful_shutdown_set_f) (int unit, soc_pbmp_t active_links, int shutdown, soc_pbmp_t unisolated_links);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_tx_almost_full_threshold_set_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int is_fe1, int is_fe3, int value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_tx_fifo_size_threshold_set_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int is_fe1, int is_fe3, int value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_gci_threshold_set_f) (int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value);
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_gci_threshold_get_f) (int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_rci_threshold_set_f) (int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value);
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_rci_threshold_get_f) (int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_prio_drop_threshold_set_f) (int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value);
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_prio_drop_threshold_get_f) (int unit, bcm_fabric_link_threshold_type_t type, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_almost_full_threshold_set_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value);
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_almost_full_threshold_get_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_fifo_size_threshold_set_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value);
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_fifo_size_threshold_get_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int* value);
...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_full_threshold_set_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int value);
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_full_threshold_get_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int *value);
...
typedef soc_error_t (*mbcm_dfe_port_control_pcs_set_f) (int unit, soc_port_t port, soc_dfe_port_pcs_t pcs);
typedef soc_error_t (*mbcm_dfe_port_control_pcs_get_f) (int unit, soc_port_t port, soc_dfe_port_pcs_t* pcs);
typedef soc_error_t (*mbcm_dfe_port_control_power_set_f) (int unit, soc_port_t port, uint32 flags, soc_dfe_port_power_t power);
typedef soc_error_t (*mbcm_dfe_port_control_power_get_f) (int unit, soc_port_t port, soc_dfe_port_power_t* power);
...
typedef soc_error_t (*mbcm_dfe_port_phy_control_set_f) (int unit, soc_port_t port, soc_phy_control_t type, uint32 value);
typedef soc_error_t (*mbcm_dfe_port_phy_control_get_f) (int unit, soc_port_t port, soc_phy_control_t type, uint32 *value);
...
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_enable_set_f) (int unit, soc_port_t port, int mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_enable_get_f) (int unit, soc_port_t port, int mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_rx_enable_set_f) (int unit, soc_port_t port, int mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_rx_enable_get_f) (int unit, soc_port_t port, int mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_rx_status_get_f) (int unit, soc_port_t port, int mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_polynomial_set_f) (int unit, soc_port_t port, int mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_polynomial_get_f) (int unit, soc_port_t port, int mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_invert_data_set_f) (int unit, soc_port_t port, int mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_invert_data_get_f) (int unit, soc_port_t port, int mode, int *value);
...
typedef soc_error_t (*mbcm_dfe_cosq_pipe_rx_weight_set_f) (int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int weight);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_rx_weight_get_f) (int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int *weight);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_mid_weight_set_f) (int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int weight);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_mid_weight_get_f) (int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int *weight);
...
typedef soc_error_t (*mbcm_dfe_cosq_pipe_rx_threshold_set_f) (int unit, int pipe, int threshold);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_rx_threshold_get_f) (int unit, int pipe, int *threshold);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_mid_threshold_set_f) (int unit, int pipe, int threshold);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_mid_threshold_get_f) (int unit, int pipe, int *threshold);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_tx_threshold_set_f) (int unit, int pipe, int threshold);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_tx_threshold_get_f) (int unit, int pipe, int *threshold);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_rx_rate_set_f) (int unit, int pipe, soc_dfe_cosq_shaper_mode_t shaper_mode, uint32 rate);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_rx_rate_get_f) (int unit, int pipe, soc_dfe_cosq_shaper_mode_t *shaper_mode, uint32 *rate);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_tx_rate_set_f) (int unit, soc_dfe_cosq_shaper_mode_t shaper_mode, uint32 rate);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_tx_rate_get_f) (int unit, soc_dfe_cosq_shaper_mode_t *shaper_mode, uint32 *rate);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_tx_rate_enable_set_f) (int unit, int pipe, int enable);
typedef soc_error_t (*mbcm_dfe_cosq_pipe_tx_rate_enable_get_f) (int unit, int pipe, int *enable);
...
extern mbcm_dfe_functions_t *mbcm_dfe_driver[BCM_MAX_NUM_UNITS]; /* USE _CALL MACRO FOR DISPATCH */
