...
/* Drop all traffic except local TDM according to Delete-FIFO available resources (number of packet descriptors which can be added to Delete-FIFO). */
#define spn_EGRESS_FABRIC_DROP_THRESHOLD_ALL_EXCEPT_LOCAL_TDM  "egress_fabric_drop_threshold_all_except_local_tdm"
...
/* Set the Clock Divider for the selected recovered clock (master-0, slave-1) */
#define spn_SYNC_CLK_DIVIDER_CLK  "sync_clk_divider_clk"
...
/* Select egress queue for TDM traffic. Use -1 to avoid dedicated queue for TDM traffic. */
#define spn_TDM_EGRESS_QUEUE  "tdm_egress_queue"
