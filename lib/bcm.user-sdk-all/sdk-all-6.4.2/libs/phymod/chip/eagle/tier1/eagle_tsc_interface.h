 ...
 * API returns the fixed pattern generator mode select which needs to be passed to the eagle_tsc_tx_shared_patt_gen_en() function
 ...
 * User needs to configure all lanes through eagle_tsc_lane_config_for_iddq() before enabling IDDQ by asserting IDDQ pin.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * Along with eagle_tsc_core_pwrdn(), all lanes powerdowns should also be issued using eagle_tsc_lane_pwrdn() to complete a Core Powerdown 
 * @param pa phymod_access_t struct
 ...
 * If using MDIO interface to access the registers, use this function to implement eagle_tsc_pmd_mwr_reg(..)
 * @param pa phymod_access_t struct
 ...
 * @param pa phymod_access_t struct
 * @param param selects the parameter to write based on eagle_tsc_tx_afe_settings_enum
 ...
 * It relies on the accuracy of eagle_tsc_delay_us() function and recommend:
 *  eyescan_options.horz_max = 31;
 *  eyescan_options.horz_min = -31;
 *  eyescan_options.vert_max = 31;
 *  eyescan_options.vert_min = -31;
 ...
 * Call functions eagle_tsc_display_lane_state_hdr() before and eagle_tsc_display_lane_state_legend() after 
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps
 * @param pa phymod_access_t struct
 * @param param Enum (eagle_tsc_rx_afe_settings_enum) to select the required RX AFE setting to be modified
 ...
 * @param pa phymod_access_t struct
 * @param param Enum (eagle_tsc_rx_afe_settings_enum) to select the required RX AFE setting to be read
 * @param *val Value to be written to the selected AFE setting
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * Once the PRBS generator is configured, it can be enabled using the eagle_tsc_tx_prbs_en() function
 * @param pa phymod_access_t struct
 ...
 * Once the PRBS checker is configured, it can be enabled using the eagle_tsc_rx_prbs_en() function
 * @param pa phymod_access_t struct
 ...
 * User needs to configure all lanes through eagle_tsc_lane_config_for_iddq() and also call eagle_tsc_core_config_for_iddq() 
