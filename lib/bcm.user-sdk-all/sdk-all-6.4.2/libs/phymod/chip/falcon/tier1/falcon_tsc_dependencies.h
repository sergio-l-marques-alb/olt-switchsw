...
/**************************************************************************************/
/*                                                                                    */
/*  Revision      :  $Id: falcon_api_dependencies.h 641 2014-07-25 21:55:03Z kirand $ */
/*                                                                                    */
...
/** @file falcon_api_dependencies.h
 ...
 */
err_code_t falcon_pmd_rdt_reg(const phymod_access_t *pa, uint16_t address, uint16_t *val);           
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)  
 */
err_code_t falcon_pmd_wr_reg(const phymod_access_t *pa, uint16_t address, uint16_t val); 


/** Masked Register Write to the currently selected Serdes IP core/lane.
 * If using Serdes MDIO controller to access the registers, implement this function using falcon_pmd_mdio_mwr_reg(pa, ..)
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function
 *
 *    falcon_pmd_wr_reg(pa, addr, ((falcon_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)  
 */
err_code_t falcon_pmd_mwr_reg(const phymod_access_t *pa, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t val); 
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)  
 */
err_code_t falcon_delay_ns(const phymod_access_t *pa, uint16_t delay_ns); 
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)  
 */
/* err_code_t falcon_delay_us(const phymod_access_t *pa, uint32_t delay_us); */
err_code_t falcon_delay_us(uint32_t delay_us);
 ...
 */
uint8_t falcon_get_lane(const phymod_access_t *pa);
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in falcon_api_functions.c.
...
*/ 
err_code_t falcon_get_uc_ln_info(falcon_uc_lane_info_st *ext_uc_lane_info);
...
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
*/ 
err_code_t falcon_uc_lane_idx_to_system_id(const  char *string , uint8_t uc_lane_idx);
...
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
*/ 
err_code_t falcon_rdw_ram(uint16_t *rd_val, uint16_t addr, uint16_t size);
...
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
*/ 
err_code_t falcon_rdb_ram(uint8_t *rd_val, uint16_t addr, uint16_t size);
...
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
*/ 
err_code_t falcon_wrb_ram(uint16_t addr, uint16_t size, uint8_t *wr_val);
...
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
*/ 
err_code_t falcon_wrw_ram(uint16_t addr, uint16_t size, uint16_t *wr_val);
#endif
