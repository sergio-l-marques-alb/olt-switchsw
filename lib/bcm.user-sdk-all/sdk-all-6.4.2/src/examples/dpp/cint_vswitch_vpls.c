...
static int special_flexible_termination_testing = 0;
...
vswitch_vlps_info_init(int extend_example, int ac_port, int pwe_in_port, int pwe_out_port, int ac_port1_outer_vlan, int ac_port1_inner_vlan,
    ...
    vswitch_vpls_info_1.access_index_1 = special_flexible_termination_testing?1:2;
    vswitch_vpls_info_1.access_index_2 = special_flexible_termination_testing?2:3;
    vswitch_vpls_info_1.access_index_3 = special_flexible_termination_testing?2:(is_gal?2:3);
    if (extend_example) {
        ...
        vswitch_vpls_info_2.access_index_1 = special_flexible_termination_testing?1:2;
        vswitch_vpls_info_2.access_index_2 = special_flexible_termination_testing?2:3;
        vswitch_vpls_info_2.access_index_3 = special_flexible_termination_testing?2:(is_gal?2:3); 
    }
...
mpls_tunnels_config(int unit, int second_unit, int extend_example){
    ...
    if (mpls_termination_label_index_enable || st) {
...
vswitch_vpls_add_network_port_2(int unit,  bcm_gport_t *port_id){
    ...
    if (mpls_termination_label_index_enable) {
        BCM_MPLS_INDEXED_LABEL_SET(&mpls_port_1.match_label, vswitch_vpls_info_2.in_vc_label, vswitch_vpls_info_2.access_index_3);
    }
    else {
