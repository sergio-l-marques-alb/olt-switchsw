                      ...
                      int max_size) 
{
    ...
    return arad_tdm_example_multi_device (unit, 
                      local_port_id, 
                      dest_gport_local,
                      is_mc, 
                      is_opt ,
 ...
 */
int arad_tdm_example_multi_device (int unit, 
                      int local_port_id, 
                      bcm_gport_t dest_gport,
                      int is_mc, 
                      int is_opt ,
    ...
    if(is_mc){
        ...
        rv = setup_tdm(unit, local_port_id, dest_gport, 0, add_crc, bcmFabricTdmEditingAppend ,bcmFabricTdmEditingRemove, user_field_size, user_field_data);
        if (rv != BCM_E_NONE)
            return rv;
    }
