/*
 * $Id: field.c,v 1.192 Broadcom SDK $
            ...
            for (extra_qual = 0; extra_qual < 2; extra_qual++) {
                ...
                for (i = 0; i < part_count; i++) {
                    ...
                    if (k == fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].size) {
                        ...
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].field = 
                            f_qual_arr->conf_arr[0].offset.field;
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].offset = 
                            f_qual_arr->conf_arr[0].offset.offset;
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].width = 
                            f_qual_arr->conf_arr[0].offset.width;
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].offset1 = 
                            f_qual_arr->conf_arr[0].offset.offset1;
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].width1 = 
                            f_qual_arr->conf_arr[0].offset.width1;
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].offset2 = 
                            f_qual_arr->conf_arr[0].offset.offset2;
                        fg_p->qual_arr[_FP_ENTRY_TYPE_DEFAULT][i].offset_arr[size - 1].width2 = 
 ...
 */
int
_bcm_field_raptor_qualify_ip_type_get(int unit, _field_entry_t *f_ent, 
                                  bcm_field_IpType_t *type) 
{
