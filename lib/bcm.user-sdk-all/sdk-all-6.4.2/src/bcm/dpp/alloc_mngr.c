...
#define _DPP_AM_TEMPLATE_BFD_TOS_TTL_PROFILE_COUNT (16)
...
_bcm_dpp_am_template_user_defined_port_trap_mapping_get(int unit, int port,int *user_defined_trap)
{
    ...
    soc_sand_rv = soc_ppd_port_info_get(soc_sand_dev_id,port,&port_info);
...
int _bcm_dpp_am_template_egress_queue_mapping_data_get(int unit, uint32 tm_port, int core, bcm_dpp_cosq_egress_queue_mapping_info_t * mapping_profile)
{
    ...
    rc = MBCM_DPP_SOC_DRIVER_CALL(unit, mbcm_dpp_egr_q_profile_map_get,(unit, tm_port, core, (uint32*)&index));
    BCMDNX_IF_ERR_EXIT(rc);
...
int _bcm_dpp_am_template_egress_queue_mapping_exchange(int unit, uint32 tm_port, int core, CONST bcm_dpp_cosq_egress_queue_mapping_info_t * mapping_profile, int *old_profile, int *is_last, int *new_profile,int *is_allocated)
{
    ...
    BCMDNX_INIT_FUNC_DEFS;
    rc = MBCM_DPP_SOC_DRIVER_CALL(unit,mbcm_dpp_egr_q_profile_map_get,(unit, tm_port, core, (uint32*)&tmp_old_profile));
    BCMDNX_IF_ERR_EXIT(rc);
...
_bcm_dpp_am_template_l2_cache_rm_port_profile_mapping_get(int unit, int port, int *profile)
{
    ...
    soc_sand_rv = soc_ppd_llp_trap_port_info_get(soc_sand_dev_id, port, &trap_port_info);
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
...
_bcm_dpp_am_template_port_tpid_class_egress_acceptable_frame_type_port_profile_mapping_get(int unit, int port, int *profile) {
    ...
    soc_sand_rv = soc_ppd_eg_filter_port_info_get(soc_sand_dev_id, port, &port_info);
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
...
_bcm_dpp_am_template_queue_rate_cls_mapping_get(int unit, int queue,int *rate_cls)
{
    ...
    soc_sand_rv = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_itm_queue_info_get,(unit, queue,&queue_info)));
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
...
STATIC int
_bcm_dpp_am_template_egress_port_discount_cls_mapping_get(int unit, int port,int *discount_profile,SOC_TMC_PORT_HEADER_TYPE *header_type_outgoing)
{
    bcm_error_t rc = BCM_E_NONE;
    uint32 soc_sand_rv, pp_port;
    ...
    soc_sand_rv = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_egr_hdr_credit_discount_select_get,(unit,port,&discount_type)));    
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);   
    *discount_profile = discount_type;

    soc_sand_rv = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_header_type_get,(unit,core,pp_port,&header_type_incoming,header_type_outgoing)));
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
...
int _bcm_dpp_am_template_egress_port_discount_cls_init(int unit,int port,const SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO* data_discount_cls)
{
    ...
    BCMDNX_INIT_FUNC_DEFS;
    /*flags = SHR_TEMPLATE_MANAGE_SET_WITH_ID;*/
    rc = _bcm_dpp_am_template_egress_port_discount_cls_mapping_get(unit,port,&template, &header_type);
    BCMDNX_IF_ERR_EXIT(rc);
    ...
    result = dpp_am_template_allocate(unit, BCM_DPP_AM_DEFAULT_CORE_ID, template_type, flags, data_discount_cls, &is_allocated,&template);
    BCMDNX_IF_ERR_EXIT(result);
...
int _bcm_dpp_am_template_egress_port_discount_cls_data_get(int unit,int port,SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO * data_discount_cls)
{
    ...
    rc = _bcm_dpp_am_template_egress_port_discount_cls_mapping_get(unit,port,&discount_profile, &header_type);
    ...
    switch (header_type_map) {
        case SOC_TMC_PORT_HEADER_TYPE_RAW:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID,dpp_am_template_egress_port_discount_cls_type_raw,discount_profile,data_discount_cls);
            break;    
        case SOC_TMC_PORT_HEADER_TYPE_CPU:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID,dpp_am_template_egress_port_discount_cls_type_cpu,discount_profile,data_discount_cls);
            break;   
        case SOC_TMC_PORT_HEADER_TYPE_ETH:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID,dpp_am_template_egress_port_discount_cls_type_eth,discount_profile,data_discount_cls);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_TM:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID,dpp_am_template_egress_port_discount_cls_type_tm,discount_profile,data_discount_cls);
            break;
        default: 
            rc = BCM_E_PARAM;
...
int _bcm_dpp_am_template_egress_port_discount_cls_exchange(int unit,int port, SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO * data_discount_cls, int *old_discount_profile, int *is_last, int *new_discount_cls,int *is_allocated)
{
    int rc = BCM_E_NONE;
    ...
    rc = _bcm_dpp_am_template_egress_port_discount_cls_mapping_get(unit,port,&tmp_old_discount_profile,&header_type);
    BCMDNX_IF_ERR_EXIT(rc);
    rc = _bcm_dpp_hedear_type_map(unit,header_type, &header_type_map);
    BCMDNX_IF_ERR_EXIT(rc);
    ...
    rc = dpp_am_template_exchange(unit, BCM_DPP_AM_DEFAULT_CORE_ID,template_type,0,data_discount_cls,tmp_old_discount_profile,&tmp_is_last,new_discount_cls,is_allocated);
    BCMDNX_IF_ERR_EXIT(rc);
...
int
_bcm_dpp_am_template_egress_port_discount_cls_per_header_type_ref_get(int unit, int template, SOC_TMC_PORT_HEADER_TYPE header_type, uint32 *ref_count)
{
    ...
    switch (header_type_map) {
        case SOC_TMC_PORT_HEADER_TYPE_RAW: 
            rc = dpp_am_template_ref_count_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_raw, template, ref_count);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_CPU:
            rc = dpp_am_template_ref_count_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_cpu, template, ref_count);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_ETH:
            rc = dpp_am_template_ref_count_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_eth, template, ref_count);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_TM:
            rc = dpp_am_template_ref_count_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_tm, template, ref_count);
            break;
        default: 
            rc = BCM_E_PARAM;
    }
...
int
_bcm_dpp_am_template_egress_port_discount_cls_per_header_type_tdata_get(int unit, int template, SOC_TMC_PORT_HEADER_TYPE header_type, SOC_TMC_PORT_EGR_HDR_CR_DISCOUNT_INFO *data_discount_cls)
{
    SOC_TMC_PORT_HEADER_TYPE header_type_map;
    int rc = BCM_E_NONE;
    ...
    switch (header_type_map) {
        case SOC_TMC_PORT_HEADER_TYPE_RAW:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_raw, template, (void *)data_discount_cls);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_CPU:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_cpu, template, (void *)data_discount_cls);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_ETH:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_eth, template, (void *)data_discount_cls);
            break;
        case SOC_TMC_PORT_HEADER_TYPE_TM:
            rc = dpp_am_template_data_get(unit, BCM_DPP_AM_DEFAULT_CORE_ID, dpp_am_template_egress_port_discount_cls_type_tm, template, (void *)data_discount_cls);
            break;
        default: 
            rc = BCM_E_PARAM;
    }
...
STATIC int _bcm_dpp_am_template_vlan_port_protocol_mapping_get(int unit, int port, int *template)
{
    ...
    soc_sand_rv = soc_ppd_llp_vid_assign_port_info_get(soc_sand_dev_id, port, &port_vid_assign_info);
    BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
...
int
bcm_dpp_am_template_eedb_roo_ll_format_eth_type_index_free(int unit, int eth_type_index_ndx, int *is_last)
{
    int rc = BCM_E_NONE;
