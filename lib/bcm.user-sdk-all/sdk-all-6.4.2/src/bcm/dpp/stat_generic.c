                      ...
                      uint64 *val)
{
    ...
    case snmpEtherStatsPkts64Octets:
        REG_ADD(unit, port, R_64r, count);
        REG_ADD(unit, port, T_64r, count);
        break;
    case snmpEtherStatsPkts65to127Octets:
        REG_ADD(unit, port, R_127r, count);
        REG_ADD(unit, port, T_127r, count);
        break;
    case snmpEtherStatsPkts128to255Octets:
        REG_ADD(unit, port, R_255r, count);
        REG_ADD(unit, port, T_255r, count);
        break;
    case snmpEtherStatsPkts256to511Octets:
        REG_ADD(unit, port, R_511r, count);
        REG_ADD(unit, port, T_511r, count);
        break;
    case snmpEtherStatsPkts512to1023Octets:
        REG_ADD(unit, port, R_1023r, count);
        REG_ADD(unit, port, T_1023r, count);
        break;
    case snmpEtherStatsPkts1024to1518Octets:
        REG_ADD(unit, port, R_1518r, count);
        REG_ADD(unit, port, T_1518r, count);
        break;
    ...
    case snmpBcmEtherStatsPkts1522to2047Octets: /* not in rfc1757 */
        REG_ADD(unit, port, R_2047r, count);
        REG_SUB(unit, port, RMGVr, count);
        REG_ADD(unit, port, T_2047r, count);
        REG_SUB(unit, port, TMGVr, count);
        break;
    case snmpBcmEtherStatsPkts2048to4095Octets: /* not in rfc1757 */
        REG_ADD(unit, port, R_4095r, count);
        REG_ADD(unit, port, T_4095r, count);
        break;
    case snmpBcmEtherStatsPkts4095to9216Octets: /* not in rfc1757 */
        REG_ADD(unit, port, R_9216r, count);
        REG_ADD(unit, port, T_9216r, count);
        break;

    case snmpBcmEtherStatsPkts9217to16383Octets: /* not in rfc1757 */
        REG_ADD(unit, port, R_16383r, count);
        REG_ADD(unit, port, T_16383r, count);
        break;
