/*
 * $Id: esw_diag.c,v 1.109 Broadcom SDK $
...
char if_esw_port_usage[] =
    ...
    "ASF Modes: [0]SAF [1]Same Speed [2]Slow to Fast [3]Fast to Slow\n"
#else
    "EEE: Energy Efficient Ethernet.\n"
#endif
#endif
...
char cmd_esw_tx_usage[] =
    ...
    "      PacketTraceSrcPort=<value>  - Source Port where the PacketTrace pkt injected\n"
#endif
    "\n"
...
#if defined(BCM_TOMAHAWK_SUPPORT)
    "  - Internal Pkt Trace options: Tomahawk only\n"
    "      PacketTrace=<val>       - Enable Packet Trace\n"
#endif
#endif
    ;
