  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_qos_port_info_set,(unit, local_port_ndx, port_qos_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_qos_port_info_get,(unit, local_port_ndx, port_qos_info));
