  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_FC_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_fc_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_FC_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_fc_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_TAIL_DROP_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_tail_drop_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_TAIL_DROP_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_WRED_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_wred_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_WRED_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_wred_get()",0,0);
}
/*********************************************************************
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_INGRESS_SHAPE_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_ingress_shape_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_INGRESS_SHAPE_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_ingress_shape_get()",0,0);
}
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(ARAD_ITM_VSQ_CONVERT_GLOBAL_INDX_TO_CTGRY_INDX);

  SOC_SAND_CHECK_NULL_INPUT(vsq_group);
  SOC_SAND_CHECK_NULL_INPUT(vsq_in_group_ndx);

  if (vsq_ndx<ARAD_ITM_VSQ_GROUP_CTGRY_SIZE)
  {
    *vsq_group = ARAD_ITM_VSQ_GROUP_CTGRY;
    *vsq_in_group_ndx = vsq_ndx;
  }
  else if (vsq_ndx<ARAD_ITM_VSQ_GROUP_CTGRY_SIZE + ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE)
  {
  ...
  else if (vsq_ndx<ARAD_ITM_VSQ_GROUP_CTGRY_SIZE + ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE + ARAD_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS_SIZE)
  {
    ...
    *vsq_in_group_ndx = vsq_ndx - ARAD_ITM_VSQ_GROUP_CTGRY_SIZE - ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE;
  }
  else if(vsq_ndx < ARAD_ITM_VSQ_GROUP_CTGRY_SIZE + ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE + ARAD_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS_SIZE
          + ARAD_ITM_VSQ_GROUP_STTSTCS_TAG_SIZE)
  {
    ...
    *vsq_in_group_ndx = vsq_ndx - ARAD_ITM_VSQ_GROUP_CTGRY_SIZE - ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE - ARAD_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS_SIZE;
          ...
          + ARAD_ITM_VSQ_GROUP_STTSTCS_TAG_SIZE + ARAD_ITM_VSQ_GROUP_LLFC_SIZE)
  {
    ...
    *vsq_in_group_ndx = vsq_ndx - ARAD_ITM_VSQ_GROUP_CTGRY_SIZE - ARAD_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE - ARAD_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS_SIZE
    ...
    + ARAD_ITM_VSQ_GROUP_STTSTCS_TAG_SIZE + ARAD_ITM_VSQ_GROUP_LLFC_SIZE + ARAD_ITM_VSQ_GROUP_PFC_SIZE)
  {
