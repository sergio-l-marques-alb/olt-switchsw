...
#define ARAD_PP_EG_VLAN_EDIT_EDIT_PROFILE_MAX                    (15)
  ...
  )
{
  ...
  /* consider tag format as tagged for TX-tagged processing */
  ...
  )
{
  ...
  entry_offset = ARAD_PP_EPNI_EGRESS_EDIT_CMD_TBL_INDX(command_key->tag_format, command_key->edit_profile);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_VLAN_EDIT_COMMAND_KEY, command_key, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->edit_profile, ARAD_PP_EG_VLAN_EDIT_EDIT_PROFILE_MAX, ARAD_PP_EG_VLAN_EDIT_EDIT_PROFILE_OUT_OF_RANGE_ERR, 11, exit);
