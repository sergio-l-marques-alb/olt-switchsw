    ...
    )
{
  ...
  if (ack_status->reason == ARAD_PP_LEM_ACCESS_FAIL_REASON_EMC_PROBLEM)
  {
     ...
     */
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  31,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_MACT_INTERRUPT_REGISTER_TWOr(unit, &reg_interrupt2));
    ...
    ARAD_FLD_FROM_REG(
        SOC_IS_JERICHO(unit)? PPDB_B_LARGE_EM_INTERRUPT_REGISTER_TWOr: IHP_MACT_INTERRUPT_REGISTER_TWOr,
        SOC_IS_JERICHO(unit)? LARGE_EM_ERROR_LEARN_REQUEST_OVER_STATICf : MACT_ERROR_LEARN_REQUEST_OVER_STATICf,
        fld_val, reg_interrupt2, 43, exit);
    if (fld_val != 0x0)
    {
    ...
    ARAD_FLD_FROM_REG(
        SOC_IS_JERICHO(unit)? PPDB_B_LARGE_EM_INTERRUPT_REGISTER_TWOr: IHP_MACT_INTERRUPT_REGISTER_TWOr,
        SOC_IS_JERICHO(unit)? LARGE_EM_ERROR_CHANGE_REQUEST_OVER_STATICf : MACT_ERROR_CHANGE_REQUEST_OVER_STATICf,
        fld_val, reg_interrupt2, 44, exit);
    if (fld_val != 0x0)
    {
