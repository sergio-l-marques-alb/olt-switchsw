    ...
    )
{
  ...
  res = arad_ofp_rates_egq_tcg_rate_hw_set_unsafe(unit);
    ...
    )
{
  ...
  res = arad_ofp_rates_egq_port_priority_max_burst_set_unsafe(unit, 
                                                    fap_port,  
                                                    port_priority_ndx,   
                                                    max_burst);
    ...
    )
{
  ...
  res = arad_ofp_rates_egq_port_priority_rate_hw_set_unsafe(unit);
