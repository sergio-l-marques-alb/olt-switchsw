/*
 * $Id: sbZfCaDiagUcodeSharedConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaDiagUcodeShared_Print(sbZfCaDiagUcodeShared_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaDiagUcodeShared:: memsize0=0x%01x"), (unsigned int)  pFromStruct->m_ulMemSizeMm0N0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaDiagUcodeShared:: memsize4=0x%01x"), (unsigned int)  pFromStruct->m_ulMemSizeMm1N1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfCaDiagUcodeShared_SPrint(sbZfCaDiagUcodeShared_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
