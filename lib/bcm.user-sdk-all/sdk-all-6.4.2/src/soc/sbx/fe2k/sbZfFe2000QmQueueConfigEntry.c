/*
 * $Id: sbZfFe2000QmQueueConfigEntry.c,v 1.4 Broadcom SDK $
...
sbZfFe2000QmQueueConfigEntry_Unpack(sbZfFe2000QmQueueConfigEntry_t *pToStruct,
  ...
  (pToStruct)->m_uEnforcePoliceMarkings =  (uint32)  ((pFromData)[9] >> 6) & 0x01;

  /* Unpack Member: m_uDropThresh2 */
  (pToStruct)->m_uDropThresh2 =  (uint32)  ((pFromData)[8] >> 3) & 0x1f;
  (pToStruct)->m_uDropThresh2 |=  (uint32)  ((pFromData)[9] & 0x3f) << 5;

  /* Unpack Member: m_uDropThresh1 */
  (pToStruct)->m_uDropThresh1 =  (uint32)  (pFromData)[7] ;
  (pToStruct)->m_uDropThresh1 |=  (uint32)  ((pFromData)[8] & 0x07) << 8;

  /* Unpack Member: m_uFlowControlThresh2 */
  (pToStruct)->m_uFlowControlThresh2 =  (uint32)  ((pFromData)[5] >> 5) & 0x07;
  (pToStruct)->m_uFlowControlThresh2 |=  (uint32)  (pFromData)[6] << 3;

  /* Unpack Member: m_uFlowControlThresh1 */
  (pToStruct)->m_uFlowControlThresh1 =  (uint32)  ((pFromData)[4] >> 2) & 0x3f;
  (pToStruct)->m_uFlowControlThresh1 |=  (uint32)  ((pFromData)[5] & 0x1f) << 6;

  /* Unpack Member: m_uFlowControlEnable */
  (pToStruct)->m_uFlowControlEnable =  (uint32)  ((pFromData)[4] >> 1) & 0x01;

  /* Unpack Member: m_uFlowControlTarget */
  (pToStruct)->m_uFlowControlTarget =  (uint32)  ((pFromData)[4] ) & 0x01;

  /* Unpack Member: m_uFlowControlPort */
  (pToStruct)->m_uFlowControlPort =  (uint32)  ((pFromData)[2] >> 7) & 0x01;
  (pToStruct)->m_uFlowControlPort |=  (uint32)  (pFromData)[3] << 1;

  /* Unpack Member: m_uMaxPages */
  (pToStruct)->m_uMaxPages =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;
  (pToStruct)->m_uMaxPages |=  (uint32)  ((pFromData)[2] & 0x7f) << 4;

  /* Unpack Member: m_uMinPages */
  (pToStruct)->m_uMinPages =  (uint32)  ((pFromData)[0] >> 1) & 0x7f;
  (pToStruct)->m_uMinPages |=  (uint32)  ((pFromData)[1] & 0x0f) << 7;
