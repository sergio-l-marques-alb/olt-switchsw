/*
 * $Id: sbZfCaPdHeaderConfigConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPdHeaderConfig_Print(sbZfCaPdHeaderConfig_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPdHeaderConfig:: spare0=0x%02x"), (unsigned int)  pFromStruct->m_uSpare0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPdHeaderConfig:: spare2=0x%01x"), (unsigned int)  pFromStruct->m_uSpare2));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfCaPdHeaderConfig_SPrint(sbZfCaPdHeaderConfig_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
