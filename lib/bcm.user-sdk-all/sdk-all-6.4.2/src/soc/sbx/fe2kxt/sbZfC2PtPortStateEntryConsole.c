...
sbZfC2PtPortStateEntry_Print(sbZfC2PtPortStateEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: pktinprogress=0x%01x"), (unsigned int)  pFromStruct->m_uPktInProgress));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: doubledequeued=0x%01x"), (unsigned int)  pFromStruct->m_uDoubleDequeued));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" eopextraburst=0x%01x"), (unsigned int)  pFromStruct->m_uEopExtraBurst));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" residuebyte=0x%01x"), (unsigned int)  pFromStruct->m_uResidueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: pktrequeststate=0x%01x"), (unsigned int)  pFromStruct->m_uPktRequestState));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" line=0x%01x"), (unsigned int)  pFromStruct->m_uLine));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" lastpage=0x%01x"), (unsigned int)  pFromStruct->m_uLastPage));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: nextpagestate=0x%01x"), (unsigned int)  pFromStruct->m_uNextPageState));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" nextpage=0x%04x"), (unsigned int)  pFromStruct->m_uNextPage));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" nextlength=0x%02x"), (unsigned int)  pFromStruct->m_uNextLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: page=0x%04x"), (unsigned int)  pFromStruct->m_uPage));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" savedbytes=0x%01x"), (unsigned int)  pFromStruct->m_uSavedBytes));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" remainingbytes=0x%02x"), (unsigned int)  pFromStruct->m_uRemainingBytes));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: sop=0x%01x"), (unsigned int)  pFromStruct->m_uSop));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtPortStateEntry:: sourcequeue=0x%02x"), (unsigned int)  pFromStruct->m_uSourceQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
