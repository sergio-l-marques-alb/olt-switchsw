...
sbZfC2PpRxPortDataPpDescriptorFormat_Print(sbZfC2PpRxPortDataPpDescriptorFormat_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortDataPpDescriptorFormat:: rxportdata3=0x%02x"), (unsigned int)  pFromStruct->m_uRxPortMask_57_50));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" rxportdata1=0x%05x"), (unsigned int)  pFromStruct->m_uRxPortMask_49_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortDataPpDescriptorFormat:: rxportdata0=0x%08x"), (unsigned int)  pFromStruct->m_uRxPortMask_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" rxportpad=0x%02x"), (unsigned int)  pFromStruct->m_uPad));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortDataPpDescriptorFormat:: rxportmask3=0x%02x"), (unsigned int)  pFromStruct->m_uRxPortData_57_50));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" rxportmask1=0x%05x"), (unsigned int)  pFromStruct->m_uRxPortData_49_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortDataPpDescriptorFormat:: rxportmask0=0x%08x"), (unsigned int)  pFromStruct->m_uRxPortData_31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2PpRxPortDataPpDescriptorFormat_SPrint(sbZfC2PpRxPortDataPpDescriptorFormat_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
