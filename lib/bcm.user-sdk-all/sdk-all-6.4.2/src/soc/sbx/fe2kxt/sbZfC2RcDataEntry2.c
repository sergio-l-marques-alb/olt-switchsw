...
sbZfC2RcDataEntry2_Unpack(sbZfC2RcDataEntry2_t *pToStruct,
  ...
  (pToStruct)->m_uData39 =  (uint32)  (pFromData)[156] ;
  (pToStruct)->m_uData39 |=  (uint32)  (pFromData)[157] << 8;
  (pToStruct)->m_uData39 |=  (uint32)  (pFromData)[158] << 16;
  (pToStruct)->m_uData39 |=  (uint32)  (pFromData)[159] << 24;

  /* Unpack Member: m_uData38 */
  (pToStruct)->m_uData38 =  (uint32)  (pFromData)[152] ;
  (pToStruct)->m_uData38 |=  (uint32)  (pFromData)[153] << 8;
  (pToStruct)->m_uData38 |=  (uint32)  (pFromData)[154] << 16;
  (pToStruct)->m_uData38 |=  (uint32)  (pFromData)[155] << 24;

  /* Unpack Member: m_uData37 */
  (pToStruct)->m_uData37 =  (uint32)  (pFromData)[148] ;
  (pToStruct)->m_uData37 |=  (uint32)  (pFromData)[149] << 8;
  (pToStruct)->m_uData37 |=  (uint32)  (pFromData)[150] << 16;
  (pToStruct)->m_uData37 |=  (uint32)  (pFromData)[151] << 24;

  /* Unpack Member: m_uData36 */
  (pToStruct)->m_uData36 =  (uint32)  (pFromData)[144] ;
  (pToStruct)->m_uData36 |=  (uint32)  (pFromData)[145] << 8;
  (pToStruct)->m_uData36 |=  (uint32)  (pFromData)[146] << 16;
  (pToStruct)->m_uData36 |=  (uint32)  (pFromData)[147] << 24;
  ...
  (pToStruct)->m_uSpare7 =  (uint32)  ((pFromData)[30] >> 5) & 0x07;
  (pToStruct)->m_uSpare7 |=  (uint32)  (pFromData)[31] << 3;

  /* Unpack Member: m_uData7 */
  (pToStruct)->m_uData7 =  (uint32)  (pFromData)[28] ;
  (pToStruct)->m_uData7 |=  (uint32)  (pFromData)[29] << 8;
  (pToStruct)->m_uData7 |=  (uint32)  ((pFromData)[30] & 0x1f) << 16;

  /* Unpack Member: m_uSpare6 */
  (pToStruct)->m_uSpare6 =  (uint32)  ((pFromData)[26] >> 5) & 0x07;
  (pToStruct)->m_uSpare6 |=  (uint32)  (pFromData)[27] << 3;

  /* Unpack Member: m_uData6 */
  (pToStruct)->m_uData6 =  (uint32)  (pFromData)[24] ;
  (pToStruct)->m_uData6 |=  (uint32)  (pFromData)[25] << 8;
  (pToStruct)->m_uData6 |=  (uint32)  ((pFromData)[26] & 0x1f) << 16;

  /* Unpack Member: m_uSpare5 */
  (pToStruct)->m_uSpare5 =  (uint32)  ((pFromData)[22] >> 5) & 0x07;
  (pToStruct)->m_uSpare5 |=  (uint32)  (pFromData)[23] << 3;

  /* Unpack Member: m_uData5 */
  (pToStruct)->m_uData5 =  (uint32)  (pFromData)[20] ;
  (pToStruct)->m_uData5 |=  (uint32)  (pFromData)[21] << 8;
  (pToStruct)->m_uData5 |=  (uint32)  ((pFromData)[22] & 0x1f) << 16;

  /* Unpack Member: m_uSpare4 */
  (pToStruct)->m_uSpare4 =  (uint32)  ((pFromData)[18] >> 5) & 0x07;
  (pToStruct)->m_uSpare4 |=  (uint32)  (pFromData)[19] << 3;

  /* Unpack Member: m_uData4 */
  (pToStruct)->m_uData4 =  (uint32)  (pFromData)[16] ;
  (pToStruct)->m_uData4 |=  (uint32)  (pFromData)[17] << 8;
  (pToStruct)->m_uData4 |=  (uint32)  ((pFromData)[18] & 0x1f) << 16;

  /* Unpack Member: m_uSpare3 */
  (pToStruct)->m_uSpare3 =  (uint32)  ((pFromData)[14] >> 5) & 0x07;
  (pToStruct)->m_uSpare3 |=  (uint32)  (pFromData)[15] << 3;

  /* Unpack Member: m_uData3 */
  (pToStruct)->m_uData3 =  (uint32)  (pFromData)[12] ;
  (pToStruct)->m_uData3 |=  (uint32)  (pFromData)[13] << 8;
  (pToStruct)->m_uData3 |=  (uint32)  ((pFromData)[14] & 0x1f) << 16;

  /* Unpack Member: m_uSpare2 */
  (pToStruct)->m_uSpare2 =  (uint32)  ((pFromData)[10] >> 5) & 0x07;
  (pToStruct)->m_uSpare2 |=  (uint32)  (pFromData)[11] << 3;

  /* Unpack Member: m_uData2 */
  (pToStruct)->m_uData2 =  (uint32)  (pFromData)[8] ;
  (pToStruct)->m_uData2 |=  (uint32)  (pFromData)[9] << 8;
  (pToStruct)->m_uData2 |=  (uint32)  ((pFromData)[10] & 0x1f) << 16;

  /* Unpack Member: m_uSpare1 */
  (pToStruct)->m_uSpare1 =  (uint32)  ((pFromData)[6] >> 5) & 0x07;
  (pToStruct)->m_uSpare1 |=  (uint32)  (pFromData)[7] << 3;

  /* Unpack Member: m_uData1 */
  (pToStruct)->m_uData1 =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uData1 |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->m_uData1 |=  (uint32)  ((pFromData)[6] & 0x1f) << 16;

  /* Unpack Member: m_uSpare0 */
  (pToStruct)->m_uSpare0 =  (uint32)  ((pFromData)[2] >> 5) & 0x07;
  (pToStruct)->m_uSpare0 |=  (uint32)  (pFromData)[3] << 3;

  /* Unpack Member: m_uData0 */
  (pToStruct)->m_uData0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uData0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uData0 |=  (uint32)  ((pFromData)[2] & 0x1f) << 16;
