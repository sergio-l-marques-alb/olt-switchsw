...
/* LTC3882/LTC3880 an integrated power control IC */
extern i2c_driver_t _soc_i2c_ltc388x_driver;
...
STATIC i2c_device_t i2c_devices[] = {
    ...
    I2CDEV(LTC3880, 45, ltc388x),
    I2CDEV(LTC3882, 0, ltc388x),
    I2CDEV(LTC3882, 1, ltc388x),
    I2CDEV(LTC2974, 0, ltc2974),

#ifdef BCM_CALADAN3_SVK
    I2CDEV(CXP, 0, cxp),
#endif
    I2CDEV(LTC3880, 60, ltc388x),
    I2CDEV(LTC3880, 61, ltc388x),
    I2CDEV(LTC3880, 62, ltc388x),
    I2CDEV(LTC3880, 64, ltc388x),
    I2CDEV(LTC3880, 65, ltc388x),
};
#undef	I2CDEV
#undef	I2CDEVTD
...
static char *soc_i2c_saddr_to_string_table[0x80] = {
    ...
    /* 0X46 */ "LTC 3882-0 Voltage Controller",
    /* 0X47 */ "LTC 3882-1 Voltage Controller",
    ...
    if (SOC_E_NONE ==
        ...
        if (SOC_IS_GREYHOUND(unit)) {
            ...
            if (board_name != NULL) {
                ...
                if (check_devs > 0) {
                    if (i2c_devices[devid].driver != &_soc_i2c_ltc388x_driver) {
...
#endif
        {
            if (i2c_devices[devid].driver == &_soc_i2c_ltc388x_driver) {
                if ((i2c_devices[devid].saddr == I2C_LTC3880_SADDR60) ||
                        ...
                        (i2c_devices[devid].saddr == I2C_LTC3880_SADDR62) ||
                        (i2c_devices[devid].saddr == I2C_LTC3880_SADDR64) ||
                        (i2c_devices[devid].saddr == I2C_LTC3880_SADDR65)) {
                    return SOC_E_NOT_FOUND;
                }
            }
        }
