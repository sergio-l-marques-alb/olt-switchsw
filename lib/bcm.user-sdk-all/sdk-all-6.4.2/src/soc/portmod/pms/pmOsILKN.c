...
int pmOsILKN_pm_interface_type_is_supported(int unit, int pm_id, soc_port_if_t interface, int* is_supported)
{
...
int pmOsILKN_pm_init(int unit, const portmod_pm_create_info_t* pm_add_info, int wb_buffer_index, pm_info_t pm_info)
{
