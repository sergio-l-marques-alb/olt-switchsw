...
soc_dfe_cpu2cpu_write(
    int                            unit,
    const dfe_sr_cell_link_list_t  *sr_link_list,
    uint32                         data_in_size,
    uint32                         *data_in
  )
{
...
soc_dfe_route2sr_link_list(
  ...
  dfe_sr_cell_link_list_t *sr_link_list
)
{ 
    int  hop_index, rc;
