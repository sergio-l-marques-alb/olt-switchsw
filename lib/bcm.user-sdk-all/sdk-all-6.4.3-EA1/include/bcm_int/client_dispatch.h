 ...
 * Generated:	Tue Aug 19 17:55:03 2014
 */
...
extern int bcm_client_field_compress_create(int,bcm_field_compression_t,bcm_field_compress_attr_t *);
extern int bcm_client_field_compress_destroy(int,int);
extern int bcm_client_field_compress_get(int,int,bcm_field_qualify_t,uint64 *,uint16,uint32 *,uint32 *,uint16 *);
extern int bcm_client_field_compress_multi_get(int,int,uint16,uint32 *,uint32 *,uint16 *);
extern int bcm_client_field_compress_multi_set(int,int,int,uint32 *,uint32 *);
extern int bcm_client_field_compress_set(int,int,bcm_field_qualify_t,int,uint32 *,uint32 *,uint64);
extern int bcm_client_field_compress_size_get(int,bcm_field_qualify_t,int *);
extern int bcm_client_field_compressed_mask_length_get(int,bcm_field_qualify_t,int *);
...
extern int bcm_client_port_get(int,bcm_port_t,bcm_port_interface_info_t *,bcm_port_mapping_info_t *);
...
extern int bcm_client_switch_pkt_trace_info_get(int,bcm_switch_pkt_trace_info_t *);
