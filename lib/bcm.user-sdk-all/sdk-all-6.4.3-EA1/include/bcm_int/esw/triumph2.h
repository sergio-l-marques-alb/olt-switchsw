...
extern int bcm_tr2_failover_ecmp_prot_nhi_set(int unit, int ecmp, int nh_index, 
                              uint32 prot_nh_index, bcm_failover_t failover_id);
extern int bcm_tr2_failover_ecmp_prot_nhi_get(int unit, int ecmp, int nh_index, 
                              bcm_failover_t *failover_id, int *prot_nh_index);
extern int bcm_tr2_failover_ecmp_prot_nhi_cleanup(int unit, int ecmp, int nh_index);
