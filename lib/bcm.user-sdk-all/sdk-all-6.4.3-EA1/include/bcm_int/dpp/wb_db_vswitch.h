/*
 * $Id: wb_db_vswitch.h,v 1.1 Broadcom SDK $
 ...
 *
 * File:        wb_db_vswitch.h
 * Purpose:     WarmBoot - Level 2 support (VSWITCH Module)
 */

#ifndef _BCM_DPP_WB_DB_VSWITCH_H_
#define _BCM_DPP_WB_DB_VSWITCH_H_
 ...
 *
 * Currently there is a single handle for VSWITCH module.
...
#define BCM_DPP_WB_VSWITCH_VERSION_1_0            SOC_SCACHE_VERSION(1,0)
#define BCM_DPP_WB_VSWITCH_CURRENT_VERSION        BCM_DPP_WB_VSWITCH_VERSION_1_0


#define BCM_DPP_WB_VSWITCH_INFO(unit)             (_dpp_wb_vswitch_info_p[unit])
#define BCM_DPP_WB_VSWITCH_INFO_INIT(unit)        ( (_dpp_wb_vswitch_info_p[unit] != NULL) &&          \
                                                 (_dpp_wb_vswitch_info_p[unit]->init_done == TRUE) )
...
#define BCM_DPP_WB_DEV_VSWITCH_DIRTY_BIT_SET(unit)                                       \
                        SOC_CONTROL_LOCK(unit);                                       \
                        SOC_CONTROL(unit)->scache_dirty = 1;                          \
                        BCM_DPP_WB_VSWITCH_INFO(unit)->is_dirty = 1;                     \
                        SOC_CONTROL_UNLOCK(unit);

#define BCM_DPP_WB_VSWITCH_DIRTY_BIT_CLEAR(unit)                                         \
                        SOC_CONTROL_LOCK(unit);                                       \
                        BCM_DPP_WB_VSWITCH_INFO(unit)->is_dirty = 0;                     \
                        SOC_CONTROL_UNLOCK(unit);

#define BCM_DPP_WB_VSWITCH_IS_DIRTY(unit)                                                \
                        (BCM_DPP_WB_VSWITCH_INFO(unit)->is_dirty == 1)
 ...
 * runtime information
 */
typedef struct bcm_dpp_wb_vswitch_info_s {
    int            init_done;
    int            is_dirty;
...
} bcm_dpp_wb_vswitch_info_t;

extern bcm_dpp_wb_vswitch_info_t   *_dpp_wb_vswitch_info_p[BCM_MAX_NUM_UNITS];
...
#endif /* _BCM_DPP_WB_DB_VSWITCH_H_ */
