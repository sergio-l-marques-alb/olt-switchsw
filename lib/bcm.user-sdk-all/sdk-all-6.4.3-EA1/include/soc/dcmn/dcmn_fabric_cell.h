 ...
 * Logging: field_name: entry[src_start_bit:src_start_bit+length] 
 */
soc_error_t soc_dcmn_fabric_cell_parser(int unit, soc_dcmn_fabric_cell_entry_t entry, soc_dcmn_fabric_cell_parse_table_t *parse_table, uint32 nof_lines, soc_dcmn_fabric_cell_info_t *cell_info);
