...
soc_error_t arad_port_prbs_tx_enable_set(int unit, soc_port_t port, int value);
soc_error_t arad_port_prbs_tx_enable_get(int unit, soc_port_t port, int* value);
soc_error_t arad_port_prbs_rx_enable_set(int unit, soc_port_t port, int value);
soc_error_t arad_port_prbs_rx_enable_get(int unit, soc_port_t port, int* value);
soc_error_t arad_port_prbs_rx_status_get(int unit, soc_port_t port, int* value);
