...
typedef SOC_TMC_PORTS_LAG_INFO_ARAD                            ARAD_PORTS_LAG_INFO;
...
#define ARAD_PORT_PCS_8_9_LEGACY_FEC               SOC_TMC_PORT_PCS_8_9_LEGACY_FEC
#define ARAD_PORT_PCS_8_10                         SOC_TMC_PORT_PCS_8_10
#define ARAD_PORT_PCS_64_66_FEC                    SOC_TMC_PORT_PCS_64_66_FEC
#define ARAD_PORT_PCS_64_66_BEC                    SOC_TMC_PORT_PCS_64_66_BEC
#define ARAD_PORT_PCS_64_66                        SOC_TMC_PORT_PCS_64_66
#define ARAD_PORT_PCS_NOF_TYPES                    SOC_TMC_PORT_PCS_NOF_TYPES
typedef SOC_TMC_PORT_PCS                                ARAD_PORT_PCS;
...
*  SOC_SAND_OUT  ARAD_PORT_LAG_SYS_PORT_INFO *port_lag_info_incoming -
 ...
 * Purpose:
 *      Enable/disable packet RX on specific port
 * Parameters:
 *      unit     -   (IN)    unit number.
 *      port_ndx      -   (IN)    Fap PON port index. Range: 0 - 7.
 *      enable        -   (IN)    Enable or disable value
 * Returns:
 *      BCM_E_NONE     No Error  
 *      BCM_E_XXX      Error occurred  
 **********************************************************************/
 ...
 *      unit     -   (IN)    unit number.
 *      port_ndx      -   (IN)    Fap PON port index. Range: 0 - 7.
 *      enable        -   (OUT)    Enable or disable value
 * Returns:
 *      BCM_E_NONE     No Error  
 *      BCM_E_XXX      Error occurred  
 **********************************************************************/
