/* $Id: arad_api_framework.h,v 1.167 Broadcom SDK $
...
#define ARAD_MGMT_CREDIT_WORTH_SET_UNSAFE                                          (  20|ARAD_PROC_BITS)
...
/*#define ARAD_IPQ_EXPLICIT_MAPPING_MODE_INFO_SET_UNSAFE                                ( 316|ARAD_PROC_BITS)
#define ARAD_IPQ_EXPLICIT_MAPPING_MODE_INFO_GET_UNSAFE                                ( 317|ARAD_PROC_BITS)
#define ARAD_IPQ_TRAFFIC_CLASS_MAP_SET_UNSAFE                                         ( 318|ARAD_PROC_BITS)
#define ARAD_IPQ_TRAFFIC_CLASS_MAP_GET_UNSAFE                                         ( 319|ARAD_PROC_BITS)
#define ARAD_IPQ_DESTINATION_ID_PACKETS_BASE_QUEUE_ID_SET_UNSAFE                      ( 320|ARAD_PROC_BITS)
#define ARAD_IPQ_DESTINATION_ID_PACKETS_BASE_QUEUE_ID_GET_UNSAFE                      ( 321|ARAD_PROC_BITS)
*/
...
#define ARAD_PORTS_LAG_SYS_PORT_INFO_GET                                           ((ARAD_INTERNAL_FUNCS_BASE +  655)|ARAD_PROC_BITS)
#define ARAD_PORTS_LAG_SYS_PORT_INFO_GET_UNSAFE                                    ((ARAD_INTERNAL_FUNCS_BASE +  656)|ARAD_PROC_BITS)
...
typedef enum
{
  ...
  ARAD_PMF_CE_PACKET_HEADER_ENTRY_SET_VERIFY,
  ARAD_PMF_CE_PACKET_HEADER_ENTRY_GET,
  ARAD_PMF_CE_PACKET_HEADER_ENTRY_GET_PRINT,
  ARAD_PMF_CE_PACKET_HEADER_ENTRY_GET_VERIFY,
  ...
  ARAD_PMF_CE_IRPP_INFO_ENTRY_SET_VERIFY,
  ARAD_PMF_CE_IRPP_INFO_ENTRY_GET,
  ARAD_PMF_CE_IRPP_INFO_ENTRY_GET_PRINT,
  ARAD_PMF_CE_IRPP_INFO_ENTRY_GET_VERIFY,
  ...
  ARAD_PMF_CE_NOP_ENTRY_SET_VERIFY,
  ARAD_PMF_CE_NOP_ENTRY_GET,
  ARAD_PMF_CE_NOP_ENTRY_GET_PRINT,
  ARAD_PMF_CE_NOP_ENTRY_GET_VERIFY,
...
{
/*
 * Start Error number for specific errors in the ARAD driver.
 */
 ...
 */
  ...
  */
  ...
  ARAD_CNT_MODE_ING_OUT_OF_RANGE_ERR,
...
/*****************************************************
*NAME
* arad_add_arad_errors
*TYPE:
*  PROC
*DATE:
*  08/14/2007
*FUNCTION:
*  Add the pool of ARAD errors to the all-system
*  sorted pool.
*CALLING SEQUENCE:
*  arad_add_arad_errors()
*INPUT:
...
/*****************************************************
*NAME
* arad_add_arad_procedure_desc
*TYPE:
*  PROC
*DATE:
*  08/14/2007
*FUNCTION:
*  Add the pool of arad procedure descriptors to
...
*CALLING SEQUENCE:
*  arad_get_err_text(err_id,err_name,err_text)
*INPUT:
*  SOC_SAND_DIRECT:
*    uint32 err_id -
...
*  SOC_SAND_DIRECT:
*    uint32 -
*      See formatting rules in ARAD_ERROR RETURN VALUES above.
*      If error code is not arad_NO_ERR then
...
/* } __ARAD_API_FRAMEWORK_H_INCLUDED__*/
#endif
