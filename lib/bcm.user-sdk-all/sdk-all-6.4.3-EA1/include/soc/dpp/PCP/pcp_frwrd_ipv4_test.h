/* $Id: pcp_frwrd_ipv4_test.h,v 1.4 Broadcom SDK $
...
#ifndef __SOC_PCP_FRWRD_IPV4_TEST_INCLUDED__
/* { */
#define __SOC_PCP_FRWRD_IPV4_TEST_INCLUDED__
...
typedef struct
{
   ...
   *  subnet
   */
  PCP_FRWRD_IPV4_VPN_ROUTE_KEY key;
 ...
 *   SOC_SAND_IN  PCP_FRWRD_IPV4_CLEAR_INFO *clear_info -
 *     Clear information
 * REMARKS:
 *   None
 * RETURNS:
...
/* } __SOC_PCP_FRWRD_IPV4_TEST_INCLUDED__*/
#endif
