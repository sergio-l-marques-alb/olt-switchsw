...
#define DPP_MC_NOF_EGRESS_BITMAP_WORDS (DPP_MC_NOF_EGRESS_PORTS/(sizeof(uint32)*8)) /* number uint32s in a bitmap */
#if 0
...
typedef struct
{
  ...
  uint32 vlan_membership[DPP_MC_NOF_EGRESS_BITMAP_WORDS];
} dpp_mc_egr_bitmap_t;
