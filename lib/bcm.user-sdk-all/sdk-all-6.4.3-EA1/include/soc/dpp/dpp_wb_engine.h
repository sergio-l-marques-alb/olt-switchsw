...
int soc_dpp_wb_engine_state_init_vlan_edit(int unit);
int soc_dpp_wb_engine_state_init_gport_info(int unit);
int soc_dpp_wb_engine_state_deinit_gport_info(int unit);
...
int soc_dpp_wb_engine_sand_bitstream_set_any_field(int unit,int var_ndx,uint32 start_bit,uint32 nof_bits,uint32 *input_buffer);
int soc_dpp_wb_engine_sand_bitstream_get_any_field(int unit,int var_ndx,uint32 start_bit,uint32 nof_bits,uint32 *output_buffer);
...
typedef enum
{
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_OAM_MY_MAC_LSB            =  0,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_MGMT_OPERATION_MODE             =  1,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LLP_FILTER                =  2,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LLP_MIRROR                =  3,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LLP_VID_ASSIGN            =  4,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_PON_DOUBLE_LOOKUP         =  5,
    ...
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_ILM_INFO                  =  9,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_FWD_MACT                  = 10, 
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LIF_COS                   = 11,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LIF_TABLE                 = 12, 
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_FEC                       = 13, 
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_DIAG                      = 14,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LAG                       = 15,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_VRRP_INFO                 = 16, 
    ...
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_HEADER_DATA               = 22,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PORT_SW_DB                         = 23,
    SOC_DPP_WB_ENGINE_BUFFER_ALLOC_MNGR                              = 24,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_MAC_LIMIT_PER_TUNNEL_INFO = 25,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_PMF                          = 26,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_RESTORATION_DATA        = 27,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM                         = 28,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_MGMT                    = 29,
    ...
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PORT                               = 38,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_VLAN_EDIT_EG_ACTION_MAPPING        = 39,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_VLAN_EDIT_ING_ACTION               = 40,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_VLAN_EDIT_EG_ACTION                = 41,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_RIF_TO_LIF_GROUP_MAP            = 42,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_GPORT                              = 43,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PLUS_CONFIG                        = 44,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TM                           = 45,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_LOCATION_TBL            = 46,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_HASH_TBL                = 47,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_DB_BANK_OCC_BMS_DYNAMIC = 48,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_GLOBAL_LOCATION_TBL     = 49,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_FRWRD_IP                     = 50,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_TM_GUARANTEED_Q_RESOURCE           = 51,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_SLB_CONFIG                   = 52,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_RESERVED_REASSEMBLY_CONTEXTS       = 53,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_IPMC_INFO_INIT                     = 54,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_ECMP                               = 55,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PORT_MAP                           = 56,
    SOC_DPP_WB_ENGINE_BUFFER_RX                                      = 57,
    SOC_DPP_WB_ENGINE_BUFFER_DPP_L3                                  = 58,
    SOC_DPP_WB_ENGINE_BUFFER_ALLOC_MNGR_MULTI_CORE                   = 59,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_LIF_RIF_PROFILE              = 60,
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_KBP                                = 61,
#endif /* defined(INCLUDE_KBP) && !defined(BCM_88030) */
    SOC_DPP_WB_ENGINE_BUFFER_OUTLIF_DB                               = 62,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_BFD_YDISCR_RANGE_REF_COUNTER    = 63,
	SOC_DPP_WB_ENGINE_BUFFER_JER_MODID_GROUP_MAP_TO_DEST             = 64,
...
typedef enum
{
    ...
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_OAM_MY_MAC_LSB_REF_COUNT,
    ...
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LLP_FILTER_REF_COUNT,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LLP_VID_ASSIGN_VID_SA_BASED_ENABLE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_PON_DOUBLE_LOOKUP_PON_DOUBLE_LOOKUP_ENABLE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_ILM_INFO_MASK_INRIF,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_ILM_INFO_MASK_PORT,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FWD_MACT_LEARNING_MODE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FWD_MACT_IS_PETRA_A_COMPATIBLE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FWD_MACT_TRAVERSE_MODE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FWD_MACT_TRAVERSE_ENTRY_IN_USE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FWD_MACT_FLUSH_DB_DATA,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LIF_COS_MAP_FROM_TC_DP,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LIF_TABLE_LIF_USE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LIF_TABLE_LIF_SUB_USE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FEC_FEC_ENTRY_TYPE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_FEC_FLP_PROGS_MAPPING,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LEM_PREFIX_MAPPING,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_DIAG_MODE_INFO,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LAG_LB_KEY_IS_SYMTRC,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LAG_MASKS,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_VRRP_INFO_VRRP_MAC_USE_BIT_MAP,  
	 SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_HEADER_DATA_FTMH_LB_KEY_EXT_EN, 
	 SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_HEADER_DATA_FTMH_STACKING_EXT_ENABLE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_HEADER_DATA_SYSTEM_HEADERS_MODE,
    ...
    /* SOC_DPP_WB_ENGINE_BUFFER_ARAD_PORT_SW_DB buufer */
    ...
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_MAC_LIMIT_PER_TUNNEL_INFO,
    /*alloc mngr vars*/
    ...
    /*arad_sw_db tm*/
    SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TM_POWER_SAVE_INIT_CALLED,
    ...
    /*arad_sw_db lif/rif profile */
    SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_INLIF_PROFILE_MASK,
    SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_OUTLIF_PROFILE_MASK,
    SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_RIF_PROFILE_MASK,
    ...
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_BFD_YDISCR_RANGE_REF_COUNTER,
    ...
    /*arad_sw_db tcam location table*/
    ...
    SOC_DPP_WB_ENGINE_VAR_ARAD_RESERVED_REASSEMBLY_CONTEXTS,

    /*port */
    SOC_DPP_WB_ENGINE_VAR_PORT_NUM_TPIDS,

    /* vars for VLAN edit tables */
    SOC_DPP_WB_ENGINE_VAR_ARAD_VLAN_EDIT_EG_ACTION_MAPPING,
    SOC_DPP_WB_ENGINE_VAR_ARAD_VLAN_EDIT_ING_ACTION,
    SOC_DPP_WB_ENGINE_VAR_ARAD_VLAN_EDIT_EG_ACTION,

    /* RIF urpf mode */
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_RIF_URPF_MODE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PLUS_CONFIG,
    SOC_DPP_WB_ENGINE_VAR_ARAD_GPORT_FEC_LIF_REMOTE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_TM_GUARANTEED_Q_RESOURCE,

#if defined(INCLUDE_KBP) && !defined(BCM_88030)
    SOC_DPP_WB_ENGINE_VAR_ARAD_LOCATION_TABLE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_KBP_CACHE_MODE,
#endif /* defined(INCLUDE_KBP) && !defined(BCM_88030) */

#ifdef BCM_88660_A0
    SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_SLB_AGING_TIME,
#endif /* BCM_88660_A0 */

    SOC_DPP_WB_ENGINE_VAR_ARAD_IPMC_INFO_INIT,

    SOC_DPP_WB_ENGINE_VAR_ARAD_ECMP_CUR_SIZE,
    SOC_DPP_WB_ENGINE_VAR_ARAD_ECMP_MAX_SIZE,

    /* SOC_DPP_WB_ENGINE_BUFFER_ARAD_PORT_MAP buffer */
    SOC_DPP_WB_ENGINE_VAR_ARAD_PORT_MAP_PP_PORT,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PORT_MAP_PP_PORT_USE,

    /* SOC_DPP_WB_ENGINE_BUFFER_RX */
    SOC_DPP_WB_ENGINE_VAR_RX_VIRTUAL_TRAPS,

    /* L3 */
    SOC_DPP_WB_ENGINE_VAR_DPP_L3_VRRP_PROTOCOL_GROUP_MEMBERS,
    SOC_DPP_WB_ENGINE_VAR_DPP_L3_VRRP_PROTOCOL_GROUP_COUNT,

    /* New multi core warmboot buffer */
    SOC_DPP_WB_ENGINE_VAR_ALLOC_MNGR_MULTI_CORE_RESOURCE_TO_BASE_POOL_MAP,
    SOC_DPP_WB_ENGINE_VAR_ALLOC_MNGR_MULTI_CORE_TEMPLATE_TO_BASE_POOL_MAP,
    SOC_DPP_WB_ENGINE_VAR_ALLOC_MNGR_MULTI_CORE_GLOBAL_LIF_EGRESS_BANK_TYPES,
    SOC_DPP_WB_ENGINE_VAR_ALLOC_MNGR_MULTI_CORE_GLOBAL_LIF_INGRESS_BANK_TYPES,
    SOC_DPP_WB_ENGINE_VAR_ALLOC_MNGR_MULTI_CORE_GLOBAL_LIF_EGRESS_COUNT,
    SOC_DPP_WB_ENGINE_VAR_ALLOC_MNGR_MULTI_CORE_GLOBAL_LIF_INGRESS_COUNT,

    /* KBP */
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
    SOC_DPP_WB_ENGINE_VAR_ARAD_KBP_DB_INFO,
    SOC_DPP_WB_ENGINE_VAR_ARAD_KBP_LTR_INFO,
#endif /* defined(INCLUDE_KBP) && !defined(BCM_88030) */

    /* SOC_DPP_WB_ENGINE_BUFFER_OUTLIF_DB */
    SOC_DPP_WB_ENGINE_VAR_OUTLIF_INFO,

    /* SOC_DPP_WB_ENGINE_BUFFER_JER_MODID_GROUP_MAP_TO_DEST */
    SOC_DPP_WB_ENGINE_VAR_JER_MODID_GROUP_MAP_DEST_0,
    SOC_DPP_WB_ENGINE_VAR_JER_GROUP_MAP_DEST_0_COUNT,
    SOC_DPP_WB_ENGINE_VAR_JER_MODID_GROUP_MAP_DEST_1,
    SOC_DPP_WB_ENGINE_VAR_JER_GROUP_MAP_DEST_1_COUNT,
    SOC_DPP_WB_ENGINE_VAR_JER_MODID_GROUP_MAP_DEST_2,
    SOC_DPP_WB_ENGINE_VAR_JER_GROUP_MAP_DEST_2_COUNT,
