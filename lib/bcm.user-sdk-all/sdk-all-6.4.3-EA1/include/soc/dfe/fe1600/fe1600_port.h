...
soc_error_t soc_fe1600_port_control_pcs_set(int unit, soc_port_t port, soc_dfe_port_pcs_t pcs);
soc_error_t soc_fe1600_port_control_pcs_get(int unit, soc_port_t port, soc_dfe_port_pcs_t* pcs);
soc_error_t soc_fe1600_port_control_power_set(int unit, soc_port_t port, uint32 flags, soc_dfe_port_power_t power);
soc_error_t soc_fe1600_port_control_power_get(int unit, soc_port_t port, soc_dfe_port_power_t* power);
...
soc_error_t soc_fe1600_port_prbs_tx_enable_set(int unit, soc_port_t port, int mode, int value);
soc_error_t soc_fe1600_port_prbs_tx_enable_get(int unit, soc_port_t port, int mode, int* value);
soc_error_t soc_fe1600_port_prbs_rx_enable_set(int unit, soc_port_t port, int mode, int value);
soc_error_t soc_fe1600_port_prbs_rx_enable_get(int unit, soc_port_t port, int mode, int* value);
soc_error_t soc_fe1600_port_prbs_rx_status_get(int unit, soc_port_t port, int mode, int* value);
soc_error_t soc_fe1600_port_prbs_polynomial_set(int unit, soc_port_t port, int mode, int value);
soc_error_t soc_fe1600_port_prbs_polynomial_get(int unit, soc_port_t port, int mode, int* value);
soc_error_t soc_fe1600_port_prbs_tx_invert_data_set(int unit, soc_port_t port, int mode, int value);
soc_error_t soc_fe1600_port_prbs_tx_invert_data_get(int unit, soc_port_t port, int mode, int* value);
...
soc_error_t soc_fe1600_port_phy_control_set(int unit, soc_port_t port, soc_phy_control_t type, uint32 value);
soc_error_t soc_fe1600_port_phy_control_get(int unit, soc_port_t port, soc_phy_control_t type, uint32 *value);
