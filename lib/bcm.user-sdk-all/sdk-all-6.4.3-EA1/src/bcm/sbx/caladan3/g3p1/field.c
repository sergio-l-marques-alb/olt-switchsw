...
/*
 *  Functoin
 *     bcm_caladan3_g3p1_field_glob_t_size_get
 *  Purpose
 *     Return the size of _bcm_caladan3_g3p1_field_glob_t structure
 *  Parameters
 *     (out) size
 *  Returns
 *     None
 */
void bcm_caladan3_g3p1_field_glob_t_size_get(unsigned int *size)
{
    *size = sizeof(_bcm_caladan3_g3p1_field_glob_t);
    return;
}
