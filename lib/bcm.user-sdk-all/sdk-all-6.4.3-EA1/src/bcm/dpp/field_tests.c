...
#define _BCM_PETRA_FIELD_GROUP_PRIO_HIGHEST           127
...
#define _BCM_PETRA_FIELD_TEST_MAXIMAL_GROUP_ID        127
...
#define _BCM_PETRA_FIELD_TEST_MAX_DATA_QUALIFIER_ID                  (SOC_PPC_FP_QUAL_HDR_USER_DEF_LAST - SOC_PPC_FP_QUAL_HDR_USER_DEF_0)
...
#define _BCM_PETRA_FIELD_TEST_MAX_ENTRIES_DIRECT_EXTRACTION          16
                                                                   ...
                                                                   uint32 *mask)
{
    ...
    if(prototype == 15) {
        ...
        } else if(qualifier == bcmFieldQualifyVlanFormat && stage != _BCM_DPP_FIELD_STAGE_INDEX_EGRESS) {
...
cmd_result_t _bcm_petra_field_test_itmh_field_group(int unit, _bcm_dpp_field_stage_idx_t stage, uint32 x, _bcmPetraFieldTestSpeedMode mode, uint8 do_warmboot)
{
    ...
    return _bcm_petra_field_test_itmh_field_group_tag(unit, stage, x, mode, FALSE, 1, do_warmboot);
}
...
cmd_result_t _bcm_petra_field_test_itmh_field_group_traffic(int unit, _bcm_dpp_field_stage_idx_t stage, uint32 x, _bcmPetraFieldTestSpeedMode mode, uint8 do_warmboot)
{
    ...
    return _bcm_petra_field_test_itmh_field_group_tag(unit, stage, x, mode, TRUE, _BCM_PETRA_FIELD_TEST_ITMH_NOF_FIELD_GROUPS_TRAFFIC, do_warmboot);
}
