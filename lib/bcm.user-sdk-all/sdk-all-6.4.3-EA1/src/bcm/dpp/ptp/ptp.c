    ...
    int unit)
{
    ...
    SOC_PPD_PTP_PORT_INFO default_port_profile;
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        rc = _bcm_dpp_am_template_ptp_port_profile_init(unit, SOC_PPD_PTP_IN_PP_PORT_PROFILE_0, &default_port_profile);
        ...
        soc_sand_rv = soc_ppd_trap_frwrd_profile_info_get(soc_sand_dev_id, SOC_PPD_TRAP_CODE_1588_PACKET_1, &profile_info); 
        BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
        ...
        soc_sand_rv = soc_ppd_trap_frwrd_profile_info_set(soc_sand_dev_id, 
                                                          SOC_PPD_TRAP_CODE_1588_PACKET_0 + SOC_PPD_PTP_ACTION_FIELD_ACTION_INDEX_DROP, 
                                                          &profile_info); 
        BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
