...
/************************************************************************/
    case bcmSwitchPortHeaderType:
        ...
        /* Get TM Header type */
        soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_header_type_get,(unit, tm_port, &soc_tmcport_header_type, &soc_tmcport_header_type)));
        BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
    ...
    case bcmSwitchMcastTrunkHashMin:
        if (SOC_IS_ARAD(unit)) {
            soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_direct_lb_key_min_get,(unit, port, (uint32 *)arg)));
            BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
        } else {
           BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("Supported only in Arad")));
        }
    ...
    case bcmSwitchMcastTrunkHashMax:
        if (SOC_IS_ARAD(unit)) {
            soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_direct_lb_key_max_get,(unit, port, (uint32 *)arg)));
            BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
        } else {
           BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("Supported only in Arad")));
        }
...
/************************************************************************/
    ...
    case bcmSwitchEgressKeepSystemHeader:
        ...
        if ((bcm_type == bcmSwitchPortHeaderType) || (SOC_IS_ARAD_B0_AND_ABOVE(unit))) {
            ...
            if (bcm_type == bcmSwitchPortHeaderType) {
                ...
                /* Set TM Header type */
                soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_header_type_set,(unit, tm_port, SOC_TMC_PORT_DIRECTION_BOTH, soc_tmcport_header_type)));
    ...
    case bcmSwitchMcastTrunkHashMin:
        if(SOC_IS_ARAD(unit)){
            soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_direct_lb_key_min_set,(unit, port, arg)));
            BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
        } else {
           BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("Supported only in Arad")));
        }
    ...
    case bcmSwitchMcastTrunkHashMax:
        if (SOC_IS_ARAD(unit)) {
            soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_direct_lb_key_max_set,(unit, port, arg)));
            BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
        } else {
           BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("Supported only in Arad")));
        }
    ...
    case bcmSwitchStackRouteHistoryBitmap1:
        if (SOC_IS_ARAD(unit)) {
            soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_stacking_route_history_bitmap_set,(unit, port, SOC_TMC_STACK_EGR_PROG_TM_PORT_PROFILE_STACK1, arg)));
            BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
            rv = BCM_E_NONE;
        } else {
           BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("Supported only in Arad")));
    ...
    case bcmSwitchStackRouteHistoryBitmap2:
        if (SOC_IS_ARAD(unit)) {
            soc_sand_rc = (MBCM_DPP_DRIVER_CALL(unit,mbcm_dpp_port_stacking_route_history_bitmap_set,(unit, port, SOC_TMC_STACK_EGR_PROG_TM_PORT_PROFILE_STACK2, arg)));
            BCM_SAND_IF_ERR_EXIT(soc_sand_rc);
            rv = BCM_E_NONE;
        } else {
           BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("Supported only in Arad")));
