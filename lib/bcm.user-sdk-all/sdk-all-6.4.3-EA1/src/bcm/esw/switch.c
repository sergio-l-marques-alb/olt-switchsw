...
_bcm_switch_control_sync(int unit, int arg)
{
...
#ifdef BCM_TRIDENT2_SUPPORT
        if (_BCM_SYNC_SUCCESS(rv)) {
            rv = _bcm_esw_udf_scache_sync(unit);
        }
#endif /* BCM_TRIDENT2_SUPPORT */
        if (_BCM_SYNC_SUCCESS(rv)) {
    ...
    if (_BCM_SYNC_SUCCESS(rv) &&
        ...
        (SOC_IS_TRIDENT2(unit) || SOC_IS_TRIUMPH3(unit) || SOC_IS_TOMAHAWK(unit))) {
...
_bcm_kt_pkt_age_set(int unit, int arg)
{
    ...
    if (!arg) {
        ...
        soc_reg_field_set(unit, PKTEXTAGINGTIMERr, &pat_val, AGINGTICKSELf, 0); 
                                    ...
                                    int arg)
{
    ...
    if (SOC_IS_TRIUMPH2(unit) || SOC_IS_APOLLO(unit) ||
        SOC_IS_VALKYRIE2(unit) || SOC_IS_ENDURO(unit) || SOC_IS_KATANA(unit) ||
...
#ifdef BCM_TRIDENT2_SUPPORT
    if (BCM_SUCCESS(rv) && (SOC_IS_TRIDENT2(unit) || SOC_IS_TOMAHAWK(unit))) {
...
bcm_xgs3_route_tables_resize(int unit,  int arg)
{
    ...
    if (soc_feature(unit, soc_feature_l3_shared_defip_table)) {
        if (SOC_L3_DEFIP_MAX_128B_ENTRIES(unit) != arg) {
...
bcm_switch_binding_t xgs3_bindings[] =
{
    ...
    { bcmSwitchOamUnknownVersionToCpu, TR2 | AP | VL2 | EN | TD | TR3 | HX4 | KT | KT2
        ...
        NULL, 0},
    { bcmSwitchL3SrcBindFailToCpu, TR2 | AP | VL2 | TD | TR3 | HX4 | KT | KT2 | TD2 | TH,
        CPU_CONTROL_Mr, MAC_BIND_FAILf,
        NULL, 0},
    { bcmSwitchTunnelIp4IdShared, TR2 | AP | VL2 | TD | TR3 | HX4 | KT | KT2 | TD2 | TH,
    ...
    { bcmSwitchOamXconCcmToCpu, KT | KT2 | TR3 | HX4 | TD2,
        ...
        NULL, 0},
    { bcmSwitchOamXconOtherToCpu, KT | TR3 | HX4 | TD2,
        CCM_COPYTO_CPU_CONTROLr, XCON_OTHER_COPY_TOCPUf,
        NULL, 0},
#endif /* !BCM_TRIUMPH3_SUPPORT */

#if defined(BCM_TRIDENT_SUPPORT)
    { bcmSwitchL3InterfaceUrpfEnable, TD | TR3 | HX4 | KT | KT2 | TD2 | TH,
    ...
    { bcmSwitchMplsPortIndependentUpperRange2, TRVL|KT2,
        ...
        NULL, 0},
    { bcmSwitchL3UrpfRouteEnableExternal, TRVL | TD2 | TH,
...
defined(BCM_TRIDENT_SUPPORT)
...
#if defined (BCM_TRIDENT_SUPPORT) || defined (BCM_KATANA_SUPPORT)
    { bcmSwitchDosAttackIcmpPktOversize, TD | TR3 | HX4 | KT | KT2 | TD2 | TH,
        DOS_CONTROL_3r, BIG_ICMP_PKT_SIZEf,
        NULL, 0 },
    { bcmSwitchDosAttackIcmpV6PingSize, TD | TR3 | HX4 | KT | KT2 | TD2 | TH,
        DOS_CONTROL_3r, BIG_ICMPV6_PKT_SIZEf,
        NULL, soc_feature_big_icmpv6_ping_check },
    { bcmSwitchDosAttackMinTcpHdrSize, TD | TR3 | HX4 | KT | KT2 | TD2 | TH,
        DOS_CONTROL_3r, MIN_TCPHDR_SIZEf,
        NULL, 0 },
    { bcmSwitchIpmcSameVlanPruning, TD,
        CPQLINKMEMDEBUGr, IPMC_IND_MODEf,
        _bool_invert, 0 },
    { bcmSwitchHashNivSrcIfEtagSvidSelect0, TD | TR3 | HX4 | KT | TD2 | TH,
        RTAG7_HASH_CONTROL_2r, RTAG7_HASH_BIN_0_SELECT_Af,
        NULL, 0 },
    { bcmSwitchHashNivSrcIfEtagSvidSelect1, TD | TR3 | HX4 | KT | TD2 | TH,
        RTAG7_HASH_CONTROL_2r, RTAG7_HASH_BIN_0_SELECT_Bf,
        NULL, 0 },
    { bcmSwitchHashNivDstIfEtagVidSelect0, TD | TR3 | HX4 | KT | TD2 | TH,
        RTAG7_HASH_CONTROL_2r, RTAG7_HASH_BIN_1_SELECT_Af,
        NULL, 0 },
    { bcmSwitchHashNivDstIfEtagVidSelect1, TD | TR3 | HX4 | KT | TD2 | TH,
    ...
    { bcmSwitchPrioDropToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, DOT1P_ADMITTANCE_DROP_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchNivPrioDropToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, DOT1P_ADMITTANCE_DROP_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchNivInterfaceMissToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, NIV_FORWARDING_DROP_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchNivRpfFailToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, NIV_RPF_CHECK_FAIL_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchNivTagInvalidToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, VNTAG_FORMAT_DROP_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchNivTagDropToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, DISCARD_VNTAG_PRESENT_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchNivUntagDropToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, DISCARD_VNTAG_NOT_PRESENT_TOCPUf,
        NULL, soc_feature_niv},
    { bcmSwitchTrillTtlErrToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, TRILL_HOPCOUNT_CHECK_FAIL_TOCPUf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillHeaderErrToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, TRILL_ERROR_FRAMES_TOCPUf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillMismatchToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, TRILL_UNEXPECTED_FRAMES_TOCPUf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillNameMissToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, TRILL_RBRIDGE_LOOKUP_MISS_TOCPUf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillRpfFailToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, TRILL_RPF_CHECK_FAIL_TOCPUf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillOptionsToCpu, TD | TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, TRILL_OPTIONS_TOCPUf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillNameErrDrop, TD | TR3 | HX4 | TD2 | TH,
        TRILL_DROP_CONTROLr, INGRESS_RBRIDGE_EQ_EGRESS_RBRIDGE_DROPf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillHeaderVersionErrDrop, TD | TR3 | HX4 | TD2 | TH,
        TRILL_DROP_CONTROLr, TRILL_HDR_VERSION_NON_ZERO_DROPf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillNameMissDrop, TD | TR3 | HX4 | TD2 | TH,
        TRILL_DROP_CONTROLr, UNKNOWN_INGRESS_RBRIDGE_DROPf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillAdjacencyFailDrop, TD | TR3 | HX4 | TD2 | TH,
        TRILL_DROP_CONTROLr, TRILL_ADJACENCY_FAIL_DROPf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillHeaderErrDrop, TD | TR3 | HX4 | TD2 | TH,
        TRILL_DROP_CONTROLr, UC_TRILL_HDR_MC_MACDA_DROPf,
        NULL, soc_feature_trill},
    { bcmSwitchTrillRpfFailDrop, TD | TR3 | HX4 | TD2 | TH,
        TRILL_DROP_CONTROLr, RPF_CHECK_FAIL_DROPf,
        NULL, soc_feature_trill},
    { bcmSwitchIngParseL2TunnelTermDipSipSelect, TD | TR3 | HX4 | TD2 | TH | KT | KT2,
        ING_L2_TUNNEL_PARSE_CONTROLr, IFP_L2_TUNNEL_PAYLOAD_FIELD_SELf ,
        NULL, 0},
    { bcmSwitchIngParseL3L4IPv4, TD | TR3 | HX4 | TD2 | TH | KT | KT2,
        ING_L2_TUNNEL_PARSE_CONTROLr, IGMP_ENABLEf ,
        NULL, 0},
    { bcmSwitchIngParseL3L4IPv6, TD | TR3 | HX4 | TD2 | TH | KT | KT2,
        ING_L2_TUNNEL_PARSE_CONTROLr, MLD_ENABLEf ,
        NULL, 0},
    { bcmSwitchV6L3LocalLinkDrop, TD | TR3 | HX4 | TD2 | TH,
...
#if defined(BCM_TRIUMPH3_SUPPORT) || defined(BCM_TRIDENT2_SUPPORT)
    { bcmSwitchExtenderInterfaceMissToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, NIV_FORWARDING_DROP_TOCPUf,
        NULL, soc_feature_port_extension},
    { bcmSwitchExtenderRpfFailToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, NIV_RPF_CHECK_FAIL_TOCPUf,
        NULL, soc_feature_port_extension},
    { bcmSwitchEtagInvalidToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, VNTAG_FORMAT_DROP_TOCPUf,
        NULL, soc_feature_port_extension},
    { bcmSwitchEtagDropToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, DISCARD_VNTAG_PRESENT_TOCPUf,
        NULL, soc_feature_port_extension},
    { bcmSwitchNonEtagDropToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_0r, DISCARD_VNTAG_NOT_PRESENT_TOCPUf,
        NULL, soc_feature_port_extension},
    { bcmSwitchMplsGalAlertLabelToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_Mr, MPLS_GAL_EXPOSED_TO_CPUf,
        NULL, 0},
    { bcmSwitchMplsRalAlertLabelToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_Mr, MPLS_RAL_EXPOSED_TO_CPUf,
        NULL, 0},
    { bcmSwitchMplsIllegalReservedLabelToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_Mr, MPLS_ILLEGAL_RSVD_LABEL_TO_CPUf,
        NULL, 0},
    { bcmSwitchMplsUnknownAchTypeToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_Mr, MPLS_UNKNOWN_ACH_TYPE_TO_CPUf,
        NULL, 0},
    { bcmSwitchMplsUnknownAchVersionToCpu, TR3 | HX4 | TD2 | TH,
    ...
    { bcmSwitchMplsReservedEntropyLabelToCpu, TR3 | HX4,
        ...
        NULL, 0},
    { bcmSwitchL3SrcBindMissToCpu, TR3 | HX4 | TD2 | TH,
    ...
    { bcmSwitchMplsLookupsExceededToCpu, TR3 | HX4,
        ...
        NULL, 0},
    { bcmSwitchTimesyncUnknownVersionToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_Mr, UNKNOWN_1588_VERSION_TO_CPUf,
        NULL, 0},
    { bcmSwitchTimesyncIngressVersion, TR3 | HX4 | TD2 | TH,
        ING_1588_PARSING_CONTROLr, VERSION_CONTROLf,
        NULL, 0},
    { bcmSwitchTimesyncEgressVersion, TR3 | HX4 | TD2 | TH,
    ...
    { bcmSwtichCongestionCnmProxyToCpu, TR3 | HX4 | TD2,
        ...
        NULL, 0},
    { bcmSwitchL2GreTunnelMissToCpu, TR3 | HX4 | TD2 | TH,
        CPU_CONTROL_Mr, L2GRE_SIP_LOOKUP_FAIL_COPY_TOCPUf,
        NULL, 0},
    { bcmSwitchL2GreVpnIdMissToCpu, TR3 | HX4 | TD2 | TH,
...
#if defined(BCM_TRIDENT_SUPPORT)
    { bcmSwitchHashField0Ip6FlowLabel, TD | TR3 | HX4 | TD2 | TH,
       RTAG7_HASH_CONTROL_2r, ENABLE_FLOW_LABEL_IPV6_Af,
        NULL, 0},
    { bcmSwitchHashField1Ip6FlowLabel, TD | TR3 | HX4 | TD2 | TH,
       RTAG7_HASH_CONTROL_2r, ENABLE_FLOW_LABEL_IPV6_Bf,
        NULL, 0},
#endif
#if defined(BCM_TRIDENT_SUPPORT) || defined(BCM_KATANA_SUPPORT)
    { bcmSwitchHashHg2PktFieldsEnable, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, TREAT_PPD2_AS_KNOWN_PPDf,
        NULL, 0},
    { bcmSwitchHashField0OverlayCntagRpidEnable, TD | TR3 | HX4 | KT | TD2 | TH,
       RTAG7_HASH_CONTROL_2r, ENABLE_BIN_12_OVERLAY_Af,
        NULL, 0},
    { bcmSwitchMimPayloadTpidEnable, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, MIM_PAYLOAD_TPID_ENABLEf,
        NULL, soc_feature_mim},
    { bcmSwitchHashMimUseTunnelHeader0, TD | TR3 | HX4 | KT | TD2 | TH,
       RTAG7_HASH_CONTROL_2r, DISABLE_HASH_MIM_INNER_L2_Af,
        NULL, soc_feature_mim},
    { bcmSwitchHashMimUseTunnelHeader1, TD | TR3 | HX4 | KT | TD2 | TH,
       RTAG7_HASH_CONTROL_2r, DISABLE_HASH_MIM_INNER_L2_Bf,
        NULL, soc_feature_mim},
    { bcmSwitchHashField1OverlayCntagRpidEnable, TD | TR3 | HX4 | KT | TD2 | TH,
       RTAG7_HASH_CONTROL_2r, ENABLE_BIN_12_OVERLAY_Bf,
        NULL, 0},
    { bcmSwitchHashUseFlowSelTrunkUc , TR3 | HX4 | KT2 | TD2 | TH,
       RTAG7_HASH_SELr, USE_FLOW_SEL_TRUNK_UCf,
        NULL, 0},
    { bcmSwitchHashUseFlowSelEcmp, TR3 | HX4 | KT2 | TD2 | TH,
       RTAG7_HASH_SELr, USE_FLOW_SEL_ECMPf,
        NULL, 0}
#endif
                            ...
                            int arg)
{
    ...
    if (SOC_DCB_TYPE(unit) == 23 || SOC_DCB_TYPE(unit) == 26 || 
        SOC_DCB_TYPE(unit) == 29 || SOC_DCB_TYPE(unit) == 31 || SOC_DCB_TYPE(unit) == 30){
                                ...
                                int arg)
{
...
#endif
            if (SOC_IS_FBX(unit) && !SOC_IS_TOMAHAWK(unit)) {
    ...
    defined(BCM_TRIDENT2_SUPPORT) || defined(BCM_GREYHOUND_SUPPORT)
        ...
        case bcmSwitchEntropyHashSet0Offset:
            if (SOC_IS_KATANAX(unit) || SOC_IS_TRIUMPH3(unit) ||
                SOC_IS_TRIDENT2(unit) || SOC_IS_TOMAHAWK(unit)) {
                return _bcm_xgs3_fieldoffset_set(unit, port, type, arg);
            }
            return BCM_E_UNAVAIL;
            break;
 ...
 return BCM_E_NONE;
   ...
   case bcmSwitchEEEPacketLatencyProfile0:
    ...
    case bcmSwitchL3RouteCache:
        ...
        if (SOC_IS_TD2_TT2(unit)) {
            if (soc_property_get(unit, spn_L3_ALPM_ENABLE, 0)) {
                BCM_IF_ERROR_RETURN(soc_mem_cache_set(unit, L3_DEFIP_ALPM_IPV4m,
                                            MEM_BLOCK_ALL, arg ? TRUE : FALSE));
                BCM_IF_ERROR_RETURN(soc_mem_cache_set(unit, L3_DEFIP_ALPM_IPV6_64m,
                                            MEM_BLOCK_ALL, arg ? TRUE : FALSE));
                BCM_IF_ERROR_RETURN(soc_mem_cache_set(unit, L3_DEFIP_ALPM_IPV6_128m,
                                            MEM_BLOCK_ALL, arg ? TRUE : FALSE));
            } else {
                BCM_IF_ERROR_RETURN(soc_mem_cache_set(unit, L3_DEFIPm,
                                        MEM_BLOCK_ALL, arg ? TRUE : FALSE));
                if (SOC_MEM_IS_VALID(unit, L3_DEFIP_PAIR_128m)) {
                    BCM_IF_ERROR_RETURN(soc_mem_cache_set(unit, L3_DEFIP_PAIR_128m,
                                        MEM_BLOCK_ALL, arg ? TRUE : FALSE));
                }
            }
    ...
    case bcmSwitchL3Max128BV6Entries:
        ...
        if (soc_feature(unit, soc_feature_l3) &&
            soc_feature(unit, soc_feature_l3_shared_defip_table)) {
            if (SOC_IS_TRIDENT2(unit) || SOC_IS_TRIUMPH3(unit) || SOC_IS_TOMAHAWK(unit)) {
#ifdef BCM_TRX_SUPPORT
...
#ifdef BCM_TRIDENT2_SUPPORT
        if (SOC_IS_TD2_TT2(unit)) {
            soc_mem_t mem = soc_property_get(unit, spn_L3_ALPM_ENABLE, 0) ?
                                L3_DEFIP_ALPM_IPV4m : L3_DEFIPm;
...
_bcm_esw_l3_route_info_get(int u, bcm_switch_object_t object, int *entries)
{
    ...
    if (soc_property_get(u, spn_L3_ALPM_ENABLE, 0)) {
        return BCM_E_UNAVAIL;
    }
#ifdef BCM_TRX_SUPPORT
    /* Route info is not setup for external tcam devices.
       return BCM_E_UNAVAIL */
    if (EXT_TCAM_IS_L3_ENABLED(u)) {
        return BCM_E_UNAVAIL;
    }
#endif /* BCM_TRX_SUPPORT */
    switch(object) {
        case bcmSwitchObjectL3RouteV4RoutesMax:
            return soc_lpm_max_v4_route_get(u, entries);
        case bcmSwitchObjectL3RouteV6Routes64bMax:
            return soc_lpm_max_64bv6_route_get(u, entries);
        case bcmSwitchObjectL3RouteV6Routes128bMax:
            return soc_lpm_max_128bv6_route_get(u, entries);
        case bcmSwitchObjectL3RouteV4RoutesFree:
            return soc_lpm_free_v4_route_get(u, entries);
        case bcmSwitchObjectL3RouteV6Routes64bFree:
            return soc_lpm_free_64bv6_route_get(u, entries);
        case bcmSwitchObjectL3RouteV6Routes128bFree:
            return soc_lpm_free_128bv6_route_get(u, entries);
    ...
    *entries = 0;
    ...
    switch (object)
    {
        ...
        case bcmSwitchObjectIpmcHeadTableFree:
            if (SOC_IS_TRIUMPH3(unit) || SOC_IS_KATANA2(unit)||SOC_IS_TRIDENT2(unit)){
 ...
 */
int 
bcm_esw_switch_pkt_trace_info_get(int unit, 
                              bcm_switch_pkt_trace_info_t *pkt_trace_info)
{
    if (soc_feature(unit, soc_feature_visibility)) {
        if (SOC_IS_TOMAHAWK(unit)) {
            return _bcm_th_pkt_trace_info_get(unit, pkt_trace_info);
        }
    }
    return BCM_E_UNAVAIL;
}
