...
uint32
soc_th_mpls_entry_hash(int unit, int hash_sel, uint32 *entry)
{
    int             key_nbits;
    uint8           key[SOC_MAX_MEM_WORDS * 4];
    uint32          index;
...
soc_th_mpls_bank_entry_hash(int unit, int bank, uint32 *entry)
{
    ...
    return soc_th_mpls_entry_hash(unit, hash_sel, entry);
}
...
uint32
soc_th_vlan_xlate_entry_hash(int unit, int hash_sel, uint32 *entry)
{
    int             key_nbits;
    uint8           key[SOC_MAX_MEM_WORDS * 4];
    uint32          index;
...
soc_th_vlan_xlate_bank_entry_hash(int unit, int bank, uint32 *entry)
{
    ...
    return soc_th_vlan_xlate_entry_hash(unit, hash_sel, entry);
}
...
uint32
soc_th_egr_vlan_xlate_entry_hash(int unit, int hash_sel, uint32 *entry)
{
    int             key_nbits;
    uint8           key[SOC_MAX_MEM_WORDS * 4];
    uint32          index;
...
soc_th_egr_vlan_xlate_bank_entry_hash(int unit, int bank, uint32 *entry)
{
    ...
    return soc_th_egr_vlan_xlate_entry_hash(unit, hash_sel, entry);
}
