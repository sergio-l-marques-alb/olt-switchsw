...
#include "sbZfC2MmInternalMemorySegmentConfigDataConsole.hx"



/* Print members in struct */
void
sbZfC2MmInternalMemorySegmentConfigData_Print(sbZfC2MmInternalMemorySegmentConfigData_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmInternalMemorySegmentConfigData:: resv0=0x%07x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmInternalMemorySegmentConfigData:: ding=0x%01x"), (unsigned int)  pFromStruct->m_uDataIntegrity));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmInternalMemorySegmentConfigData:: lmask=0x%04x"), (unsigned int)  pFromStruct->m_uLimitMask));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2MmInternalMemorySegmentConfigData_SPrint(sbZfC2MmInternalMemorySegmentConfigData_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2MmInternalMemorySegmentConfigData:: resv0=0x%07x", (unsigned int)  pFromStruct->m_uResv0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2MmInternalMemorySegmentConfigData:: ding=0x%01x", (unsigned int)  pFromStruct->m_uDataIntegrity);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2MmInternalMemorySegmentConfigData:: lmask=0x%04x", (unsigned int)  pFromStruct->m_uLimitMask);
...
int
sbZfC2MmInternalMemorySegmentConfigData_Validate(sbZfC2MmInternalMemorySegmentConfigData_t *pZf) {
...
int
sbZfC2MmInternalMemorySegmentConfigData_SetField(sbZfC2MmInternalMemorySegmentConfigData_t *s, char* name, int value) {
