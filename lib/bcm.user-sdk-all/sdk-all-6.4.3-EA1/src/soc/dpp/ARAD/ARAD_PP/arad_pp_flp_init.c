...
#define ARAD_PP_FLP_16B_INST_P6_VSI_D_13_BITS                                                        (ARAD_PP_FLP_16B_INST_P6_VSI(13))
...
#define ARAD_PP_FLP_PROG_SEL_CAM_P2P_BASE                  1 /* 1 through 3 */
...
#define ARAD_PP_FWD_CODE_CUSTOM1                    0x9 /* FCF */
...
#define ARAD_PP_FLP_SW_DB_FLP_PROGRAM_ID_SET(unit, prog_id, app_id) \
  { \
    ...
    res = arad_pp_sw_db_flp_prog_index_to_app_set((unit), (prog_id), (app_id)); \
...
STATIC
    ARAD_FLP_CUSTOM_LPM_LOOKUP_INFO
        Arad_flp_custom_lpm_lookup_info[] = {
    /* app ID, lookup_num, {, {}, ... } */
    {ARAD_PP_FLP_KEY_PROGRAM_ETHERNET_ING_LEARN, 2, 
        {
            { 2, 0, 2, /*  key index, key OR val, number of instructions */
                {
                    { ARAD_PP_FLP_16B_INST_P6_VT_LOOKUP0_PAYLOAD_D, 1, 0}, /* instruction, is_inst_6_11, id */
                    { ARAD_PP_FLP_16B_INST_P6_FORWARDING_ACTION_TC_D, 1, 1},
                }
            } ,
            { 2, 2, 2, /* if the 2nd lookup uses the same key as first lookup, 2nd lookup instructions are ignored */
                {
                    { ARAD_PP_FLP_16B_INST_P6_VT_LOOKUP0_PAYLOAD_D, 1, 0},
                    { ARAD_PP_FLP_16B_INST_P6_FORWARDING_ACTION_TC_D, 1, 1},
                }
            } 
        }
   ...
   )
{
  ...
  *prog = arad_pp_get_first_zero_bit(unit, FALSE, &prog_status);
  ...
  res = arad_pp_sw_db_flp_prog_index_to_app_set(unit,*prog,prog_usage);
   ...
   )
{
  ...
  for (i=0; i<3; i++)
  {
    ...
    prog_selection_cam_tbl.service_type = i;
    ...
    prog_selection_cam_tbl.port_profile = ARAD_PP_FLP_PORT_PROFILE_EXTENDED_P2P; 
    prog_selection_cam_tbl.ptc_profile  = 0;
    prog_selection_cam_tbl.parser_leaf_context_mask = 0x01;
    prog_selection_cam_tbl.port_profile_mask = ARAD_PP_FLP_PORT_PROFILE_MASK_CONSIDER_ALL;
    ...
    prog_selection_cam_tbl.vt_lookup_0_found = 0x0;
    prog_selection_cam_tbl.vt_lookup_0_found_mask = 0x0;
   ...
   )
{
  ...
  for (i = 0; i < 2; i++) { /* DHCP, static */
    ...
    prog_selection_cam_tbl.cos_profile = ARAD_PP_FLP_COS_PROFILE_ANTI_SPOOFING;
    prog_selection_cam_tbl.cos_profile_mask = 0x1F; /* 6'b011111 */
    prog_selection_cam_tbl.tt_lookup_0_found = (flp_prog_sel == ARAD_PP_FLP_PROG_SEL_CAM_ETH_TK_EPON_UNI_V6_DHCP) ? 0x1:0x0;
    prog_selection_cam_tbl.tt_lookup_0_found_mask = 0x0;
   ...
   )
{
  ...
  prog_selection_cam_tbl.parser_leaf_context_mask       = 0x1;/* ignore lsb*/
    ...
    )
{
    ...
    /* Get resources from first group of instructions */

    res = arad_pp_ihb_flp_key_construction_tbl_get_unsafe(
            unit, 
            prog_id, 
            &flp_key_construction_tbl
          );
    ...
    if (0 != flp_key_construction_tbl.instruction_0_16b) {
        ce_rsrc |= 0x1;
    }
    if (0 != flp_key_construction_tbl.instruction_1_16b) {
        ce_rsrc |= 0x2;
    }
    if (0 != flp_key_construction_tbl.instruction_2_16b) {
        ce_rsrc |= 0x4;
    }
    if (0 != flp_key_construction_tbl.instruction_3_32b) {
        ce_rsrc |= 0x8;
    }
    if (0 != flp_key_construction_tbl.instruction_4_32b) {
        ce_rsrc |= 0x10;
    }
    if (0 != flp_key_construction_tbl.instruction_5_32b) {
        ce_rsrc |= 0x20;
    }
    
    /* Get resources from second group of instructions */

    res = arad_pp_ihb_flp_key_construction_tbl_get_unsafe(
            unit, 
            prog_id + ARAD_PP_FLP_INSTRUCTIONS_NOF, 
            &flp_key_construction_tbl
          );
   ...
   )
{
    ...
    res = READ_IHP_PROTOCOL_TRAPS_PROGRAM_SELECTr(unit, reg_val);
    SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 40, exit);
    SHR_BITCOPY_RANGE(reg_val,3*ARAD_PP_FLP_KEY_PROGRAM_IPV6UC,&tmp,0,3);
    res = WRITE_IHP_PROTOCOL_TRAPS_PROGRAM_SELECTr(unit, reg_val);
   ...
   )
{
  ...
  for (i = 0; i < 2; i++) { /* DHCP, static */
    ...
    flp_lookups_tbl.lem_1st_lkp_valid      = (ingress_learn_enable && !ingress_learn_oppurtunistic)? 1 : 0;
   ...
   )
{
  ...
  flp_key_construction_tbl.instruction_0_16b        = ARAD_PP_FLP_16B_INST_P6_IN_PORT_D;
   ...
   )
{
  ...
  /*ARAD_PP_FLP_INIT_PRINT_ADVANCE("arad_pp_flp_process_p2p");*/
   ...
   )
{
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 43, exit);
  flp_key_construction_tbl.instruction_3_32b       = ARAD_PP_FLP_32B_INST_0_P6_VT_ISA_KEY_D;
  flp_key_construction_tbl.key_a_inst_0_to_5_valid = 0x8 /*hex 6'b001000 */;
  flp_key_construction_tbl.key_b_inst_0_to_5_valid = 0x0 /*6'b000000*/;
  flp_key_construction_tbl.key_c_inst_0_to_5_valid = 0x0 /*6'b000000*/;
   ...
   )
{
  ...
  for (i = 0; i < 2; i++) { /* DHCP, static */
    ...
    flp_process_tbl.sa_lkp_process_enable          = (ingress_learn_enable && !ingress_learn_oppurtunistic)? 1 : 0;
    flp_process_tbl.procedure_ethernet_default     = 3;
    flp_process_tbl.enable_hair_pin_filter         = 1;
    flp_process_tbl.learn_enable                   = learn_enable;
   ...
   )
{
  ...
  flp_key_construction_tbl.key_c_inst_0_to_5_valid    = 0x8 /*6'b001000*/;
   ...
   )
{
  ...
  flp_key_construction_tbl.instruction_1_16b     = (in_port) ? ARAD_PP_FLP_16B_INST_P6_IN_PORT_D:ARAD_PP_FLP_16B_INST_8_ZEROS;
   ...
   )
{
    ...
    if (is_vsan_from_vsi == 0) {
        ...
        vsi_vft_instuction = ARAD_PP_FLP_16B_INST_P6_VSI_D_13_BITS;
    }
    ...
    if (is_vsan_from_vsi == 0) {
      ...
      flp_key_construction_tbl.instruction_1_16b = ARAD_PP_FLP_16B_INST_P6_VSI_D_13_BITS;}
   ...
   )
{
  ...
  if (is_vsan_from_vsi == 0) {
      ...
      flp_key_construction_tbl.instruction_0_16b     = ARAD_PP_FLP_16B_INST_P6_VSI_D_13_BITS;}
  flp_key_construction_tbl.instruction_1_16b     = ARAD_PP_FLP_16B_INST_N_ZEROS(1);
   ...
   )
{
  ...
  flp_key_construction_tbl.instruction_1_16b = ARAD_PP_FLP_16B_INST_P6_IN_PORT_D;
   ...
   )
{
  ...
  SOC_SAND_OUT ARAD_PP_TRAP_CODE_INTERNAL   trap_code_internal;
    ...
    res = arad_pp_trap_mgmt_trap_code_to_internal(SOC_PPC_TRAP_CODE_IPV6_UC_RPF_2PASS, &trap_code_internal, &strength_fld_fwd, &strength_fld_snp);
    SOC_SAND_CHECK_FUNC_RESULT(res, 240, exit);  
   ...
   )
{
 ...
 /* forwarding not found */
  ...
  SOC_REG_ABOVE_64_CLEAR(reg_val);
  res = READ_IHB_PROTOCOL_TRAPS_PROGRAM_SELECTr(unit,reg_val);
  ...
  res = WRITE_IHB_PROTOCOL_TRAPS_PROGRAM_SELECTr(unit,reg_val);
   ...
   )
{
  ...
  if(ARAD_KBP_ENABLE_IPV4_MC){
      ...
      flp_key_construction_tbl.key_a_inst_0_to_5_valid = 0xb;  /*  VRF + In-RIF + SIP*/
   ...
   )
{
  ...
  flp_lookups_tbl.lem_1st_lkp_and_value  = ((~prefix) & 0xF); 
  flp_lookups_tbl.lem_1st_lkp_or_value   = prefix;
  /* TCAM: {RIF,SIP,DIP} - key-C */
  flp_lookups_tbl.tcam_lkp_db_profile    = tcam_access_profile_id;
  flp_lookups_tbl.tcam_lkp_key_select    = ARAD_PP_FLP_TCAM_LKP_KEY_SELECT_KEY_C_HW_VAL;
  flp_lookups_tbl.tcam_traps_lkp_db_profile_0 = 0x3F;
  ...
  for(addr = 0; addr < SOC_DPP_DEFS_GET(unit, nof_flp_programs); ++addr)
  {
    ...
    if (SOC_IS_ARADPLUS(unit)) { 
        ...
        if (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "ext_rpf_fwd_parallel", 0)) {
            ...
            soc_mem_field_set(unit, IHB_ELK_PAYLOAD_FORMATm, &mem_val, EXT_FOUND_OFFSETf, &fld_val);
            fld_val = 0x7; /* bits 109:56 is lookup-result-1 */
            soc_mem_field_set(unit, IHB_ELK_PAYLOAD_FORMATm, &mem_val, EXT_DATA_OFFSETf, &fld_val);
        }
        else {
...
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
        if(ARAD_KBP_ENABLE_IPV4_MPLS_EXTENDED || ARAD_KBP_ENABLE_IPV6_EXTENDED) {
            /* In Arad+, if KBP is supported, initialized how the results are parsed */
            fld_val = 0x7; /* bit 7 is lookup-found-0 */
            soc_mem_field_set(unit, IHP_ELK_PAYLOAD_FORMATm, &mem_val, FWD_FOUND_OFFSETf, &fld_val);
            fld_val = 0x9; /* bits 119:112 is lookup-result-0 */
   ...
   )
{
  ...
  /* The p2p program overwrites the initial values and this causes a problem for dynamic programs. */
  /* If used in the future, it should be checked that there is no problem with the line used by dynamic programs being overwritten. */
  if (0) {
  ...
  if (SOC_DPP_L3_SRC_BIND_IPV4_ENABLE(unit)) {
    ...
    arad_pp_flp_lookups_ethernet_tk_epon_uni_v4(unit, ingress_learn_enable,ingress_learn_oppurtunistic);
    arad_pp_flp_process_ethernet_tk_epon_uni_v4(unit, TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic);
   }
  if (SOC_DPP_L3_SRC_BIND_IPV6_ENABLE(unit)) {
    ...
    arad_pp_flp_lookups_ethernet_tk_epon_uni_v6(unit, ARAD_TCAM_ACCESS_PROFILE_INVALID, ingress_learn_enable,ingress_learn_oppurtunistic);
    arad_pp_flp_process_ethernet_tk_epon_uni_v6(unit, TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic);
  }
  ...
  if(ARAD_PP_L3_ROUTING_ENABLED(unit))
  {
      ...
      arad_pp_flp_lookups_ipv4mc_bridge(unit,ingress_learn_enable,ingress_learn_oppurtunistic);
      arad_pp_flp_process_ipv4mc_bridge(unit,TRUE,ingress_learn_enable,ingress_learn_oppurtunistic);
      ...
      if (SOC_DPP_CONFIG(unit)->trill.mode) {        
        ...
        if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
          ...
          arad_pp_flp_lookups_TRILL_mc_after_recycle_overlay(unit, ingress_learn_enable,ingress_learn_oppurtunistic);
          arad_pp_flp_process_TRILL_mc_after_recycle_overlay(unit,TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic);
        }
      }
  ...
  if (SOC_DPP_CONFIG(unit)->pp.pon_application_enable) {
      ...
      if (SOC_DPP_L3_SRC_BIND_ARP_RELAY_ENABLE(unit)) {
        arad_pp_flp_pon_arp_prog_init(unit, ingress_learn_enable, ingress_learn_oppurtunistic);
      }
      ...
      if (SOC_DPP_CONFIG(unit)->pp.local_switching_enable) {
          ...
          arad_pp_flp_lookups_ethernet_pon_local_route(unit, ingress_learn_enable,ingress_learn_oppurtunistic, prog_id);
          arad_pp_flp_process_ethernet_pon_local_route(unit, TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic, prog_id);  
      } 
      ...
      arad_pp_flp_lookups_ethernet_pon_default_upstream(unit, ingress_learn_enable,ingress_learn_oppurtunistic, prog_id);
      arad_pp_flp_process_ethernet_pon_default_upstream(unit, TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic, prog_id);
      ...
      arad_pp_flp_lookups_ethernet_pon_default_downstream(unit, ingress_learn_enable,ingress_learn_oppurtunistic, prog_id);
      arad_pp_flp_process_ethernet_pon_default_downstream(unit, TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic, prog_id);
  } else {
      int32 mac_in_mac_prog_id;
      ...
      arad_pp_flp_lookups_ethernet_ing_learn(unit, ingress_learn_enable,ingress_learn_oppurtunistic);
      arad_pp_flp_process_ethernet_ing_learn(unit, TRUE,ingress_learn_enable ,ingress_learn_oppurtunistic);  
  ...
  if (SOC_DPP_CONFIG(unit)->pp.vmac_enable) {
    res = arad_pp_flp_vmac_progs_init(unit, ingress_learn_enable, ingress_learn_oppurtunistic);
...
/*
  * initialize custom LPM lookups. This function should be called after all programs have been initialized.
  *
  */
uint32
   ...
   )
{
    ...
    for (indx=0; indx<sizeof(Arad_flp_custom_lpm_lookup_info)/sizeof(Arad_flp_custom_lpm_lookup_info[0]); ++indx) {
        lpm_lookup = &Arad_flp_custom_lpm_lookup_info[indx];
        res = arad_pp_sw_db_flp_prog_app_to_index_get(unit, lpm_lookup->app_id, &prog);
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

        for (lookup=0; lookup<lpm_lookup->lookup_num; ++lookup) {
            key = &lpm_lookup->key[lookup];

            if ( (lookup == 0) || (key->key != lpm_lookup->key[0].key) ) { /* do key construction once if we are using the same key */
                res = arad_pp_ihb_flp_key_construction_tbl_get_unsafe(unit, prog, &flp_key_construction_tbl_0_5);
                SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);

                res = arad_pp_ihb_flp_key_construction_tbl_get_unsafe(unit, prog+ARAD_PP_FLP_INSTRUCTIONS_NOF, &flp_key_construction_tbl_6_11);
                SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
                ...
                if (inst_0_to_5_valid) {
                    ...
                    res = arad_pp_ihb_flp_key_construction_tbl_set_unsafe(unit, prog, &flp_key_construction_tbl_0_5);
                ...
                if (inst_6_to_11_valid) {
                    ...
                    res = arad_pp_ihb_flp_key_construction_tbl_set_unsafe(unit, prog+ARAD_PP_FLP_INSTRUCTIONS_NOF, &flp_key_construction_tbl_6_11);
                    SOC_SAND_CHECK_FUNC_RESULT(res, 90, exit);
                }
            }
        ...
        if (flp_process_tbl.include_lpm_1st_in_result_a || flp_process_tbl.include_lpm_1st_in_result_b 
            || flp_process_tbl.include_lpm_2nd_in_result_a || flp_process_tbl.include_lpm_2nd_in_result_b) {
            /* should not reach here - print warning message */
            flp_process_tbl.include_lpm_1st_in_result_a = 0;
            flp_process_tbl.include_lpm_1st_in_result_b = 0;
            flp_process_tbl.include_lpm_2nd_in_result_a = 0;
            flp_process_tbl.include_lpm_2nd_in_result_b = 0;
   ...
   )
{
  ...
  if (SOC_DPP_CONFIG(unit)->arad->enable_lpm_custom_lookup) {
   ...
   )
{
  ...
  res = arad_pp_flp_lookups_ethernet_ing_learn(unit,ingress_learn_enable,ingress_learn_oppurtunistic);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

  res = arad_pp_flp_process_ethernet_ing_learn(unit,learn_enable,ingress_learn_enable,ingress_learn_oppurtunistic);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  res = arad_pp_flp_lookups_ipv4mc_bridge(unit, ingress_learn_enable,ingress_learn_oppurtunistic);
  SOC_SAND_CHECK_FUNC_RESULT(res, 25, exit);

  res = arad_pp_flp_process_ipv4mc_bridge(unit, learn_enable, ingress_learn_enable,ingress_learn_oppurtunistic);
  SOC_SAND_CHECK_FUNC_RESULT(res, 25, exit);
  ...
  if (SOC_DPP_CONFIG(unit)->trill.mode) 
  {
    ...
    if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
      res = arad_pp_flp_lookups_TRILL_mc_after_recycle_overlay(unit,ingress_learn_enable,ingress_learn_oppurtunistic);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

      res = arad_pp_flp_process_TRILL_mc_after_recycle_overlay(unit,learn_enable,ingress_learn_enable,ingress_learn_oppurtunistic);
      SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
    }
  }
  ...
  if (SOC_DPP_L3_SRC_BIND_IPV4_ENABLE(unit))
  {
    ...
    res = arad_pp_flp_lookups_ethernet_tk_epon_uni_v4(unit,ingress_learn_enable,ingress_learn_oppurtunistic);
    SOC_SAND_CHECK_FUNC_RESULT(res, 45, exit);

    res = arad_pp_flp_process_ethernet_tk_epon_uni_v4(unit,learn_enable,ingress_learn_enable,ingress_learn_oppurtunistic);
    SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
  }
  ...
  if (SOC_DPP_L3_SRC_BIND_IPV6_ENABLE(unit))
  {
    ...
    res = arad_pp_flp_lookups_ethernet_tk_epon_uni_v6(unit,tcam_access_profile_id,ingress_learn_enable,ingress_learn_oppurtunistic);
    SOC_SAND_CHECK_FUNC_RESULT(res, 60, exit);
    
    res = arad_pp_flp_process_ethernet_tk_epon_uni_v6(unit,learn_enable,ingress_learn_enable,ingress_learn_oppurtunistic);
  ...
  if (SOC_DPP_CONFIG(unit)->pp.l3_src_bind_arp_relay & SOC_DPP_L3_SRC_BIND_FOR_ARP_RELAY_UP) {
    ...
    /* ingress learning for Spoof v4 */
    res = arad_pp_flp_lookups_pon_arp_upstream(unit,ingress_learn_enable,ingress_learn_oppurtunistic, prog_id);
    SOC_SAND_CHECK_FUNC_RESULT(res, 80, exit);

    res = arad_pp_flp_process_pon_arp_upstream(unit,learn_enable,ingress_learn_enable,ingress_learn_oppurtunistic, prog_id);
    SOC_SAND_CHECK_FUNC_RESULT(res, 90, exit);
  }
...
uint32 arad_pp_flp_app_to_prog_index_get(
   ...
   uint8  *prog_index
    ...
    for (indx = 0; indx < SOC_DPP_DEFS_GET(unit, nof_flp_programs); ++indx) {
        res = arad_pp_sw_db_flp_prog_index_to_app_get(unit,indx,&cur_prog_id);
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
   ...
   )
{
    ...
    if(flp_key_construction_tbl.instruction_0_16b == ARAD_PP_FLP_16B_INST_P6_VSI_D_13_BITS){
   ...
   )
{
  ...
  if (SOC_DPP_CONFIG(unit)->pp.l3_src_bind_arp_relay & SOC_DPP_L3_SRC_BIND_FOR_ARP_RELAY_UP) {
    ...
    res = arad_pp_flp_process_pon_arp_upstream(unit, TRUE, ingress_learn_enable,ingress_learn_oppurtunistic, prog_id);
    SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);
  }
  ...
  )
{
    ...
    for (prog_indx = 0; prog_indx < SOC_DPP_DEFS_GET(unit, nof_flp_programs); prog_indx++) {
        res = arad_pp_sw_db_flp_prog_index_to_app_get(unit,prog_indx,&cur_prog_id);
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
    ...
    for (pgm_ndx = 0; pgm_ndx < SOC_DPP_DEFS_GET(unit, nof_flp_programs); pgm_ndx++)
    {
        ...
        {
            /* Program found */
            res = arad_pp_sw_db_flp_prog_index_to_app_get(unit,pgm_ndx,&cur_prog_id);
            SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
