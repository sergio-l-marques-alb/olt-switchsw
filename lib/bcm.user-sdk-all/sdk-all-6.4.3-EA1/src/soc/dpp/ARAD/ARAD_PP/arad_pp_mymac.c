  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  80,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_ALL_ESADI_RBRIDGESr(unit, reg_val));
  ...
  )
{
  ...
  /* Esadi mac */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  50,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_ALL_ESADI_RBRIDGESr(unit, &reg_val));
