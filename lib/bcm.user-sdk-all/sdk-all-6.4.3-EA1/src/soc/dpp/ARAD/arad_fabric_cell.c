/*
* $Id: arad_fabric_cell.c,v 1.8 Broadcom SDK $
*
...
soc_arad_cell_filter_clear(int unit)
{
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_FDR_PROGRAMMABLE_DATA_CELL_COUNTER_1r(unit, cleared_64));
    SOCDNX_IF_ERR_EXIT(WRITE_FDR_PROGRAMMABLE_DATA_CELL_COUNTER_MASK_0r(unit, cleared_reg));
    SOCDNX_IF_ERR_EXIT(WRITE_FDR_PROGRAMMABLE_DATA_CELL_COUNTER_MASK_1r(unit, cleared_64));
exit:
    SOCDNX_FUNC_RETURN;
}
 ...
 * COVERITY
 *
 * The variable packed_cpu_data_cell_rcv is assigned inside arad_cell_ack_get.
 */
