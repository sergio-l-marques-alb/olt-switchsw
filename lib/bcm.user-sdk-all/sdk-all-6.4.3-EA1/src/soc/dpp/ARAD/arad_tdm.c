...
#define ARAD_TDM_FTMH_STANDARD_MC_MC_ID_MAX                      (16*1024-1)
  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 1220, exit, soc_port_sw_db_tm_port_to_base_q_pair_get(unit, port_ndx, 0, &base_q_pair));
  ...
  )
{
  ...
  if (configure_egress) {
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN(res, 1780, exit, soc_port_sw_db_tm_port_to_base_q_pair_get(unit, port_ndx, 0, &base_q_pair));
  ...
  )
{
  ...
  if (is_egress_enabled) { /* get egress configuration */
      ...
      uint32 base_q_pair;
      int results;
      SOC_SAND_SOC_IF_ERROR_RETURN(res, 100, exit, soc_port_sw_db_tm_port_to_base_q_pair_get(unit, port_ndx, 0, &base_q_pair));
