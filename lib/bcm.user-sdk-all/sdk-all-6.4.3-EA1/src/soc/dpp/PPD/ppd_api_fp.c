  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(fp_control_set,(unit, control_ndx, info, success));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(fp_control_get,(unit, control_ndx, info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(fp_packet_diag_get,(unit, info));
