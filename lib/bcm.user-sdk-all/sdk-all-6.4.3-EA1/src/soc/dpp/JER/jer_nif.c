...
{
    int pm, phy, l, quad, pml, xlp_instance, block_index;
    soc_dpp_config_t *dpp = NULL;
    portmod_pm_create_info_t pm_info;
...
STATIC soc_error_t
_soc_jer_port_fabric_config_get(int unit, soc_port_t port, int is_init_sequence, dcmn_port_default_config_t* port_config)
{
    int speed;
    char *pcs_str;
    SOCDNX_INIT_FUNC_DEFS;
...
soc_jer_portmod_probe(int unit, pbmp_t pbmp, pbmp_t *okay_pbmp, int is_init_sequence)
{
    ...
    soc_pbmp_t phys, counter_pbmp, virtual_pbmp;
