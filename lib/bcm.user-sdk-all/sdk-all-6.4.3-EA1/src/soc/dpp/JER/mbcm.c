...
CONST mbcm_dpp_functions_t mbcm_jericho_driver = {
    ...
    dpp_mult_eg_vlan_membership_group_range_set,
    dpp_mult_eg_vlan_membership_group_range_get,
    ...
    dpp_mult_eg_all_groups_close,
    dpp_mult_eg_vlan_membership_group_open,  
    dpp_mult_eg_vlan_membership_group_update,
    dpp_mult_eg_vlan_membership_group_close,
    dpp_mult_eg_vlan_membership_port_add, 
    dpp_mult_eg_vlan_membership_port_remove,
    dpp_mult_eg_vlan_membership_group_get,
    dpp_mult_eg_vlan_membership_all_groups_close,
