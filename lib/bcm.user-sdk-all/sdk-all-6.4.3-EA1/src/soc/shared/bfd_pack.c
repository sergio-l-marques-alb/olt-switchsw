...
{
    _SHR_PACK_U32(buf, msg->sess_id);
    _SHR_PACK_U64(buf, msg->packets_in);
    _SHR_PACK_U64(buf, msg->packets_out);
    _SHR_PACK_U64(buf, msg->packets_drop);
    _SHR_PACK_U64(buf, msg->packets_auth_drop);
...
{
    _SHR_UNPACK_U32(buf, msg->sess_id);
    _SHR_UNPACK_U64(buf, msg->packets_in);
    _SHR_UNPACK_U64(buf, msg->packets_out);
    _SHR_UNPACK_U64(buf, msg->packets_drop);
    _SHR_UNPACK_U64(buf, msg->packets_auth_drop);
