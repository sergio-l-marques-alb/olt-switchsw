    ...
    if (!stat) {
        switch(phyType) {
            ...
            case DDR_PHYTYPE_ENG:
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "A04. Wait for a while after clock divider enable\n")));
                sal_usleep(2000);
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "A06. Wait for a while after clock divider enable\n")));
                sal_usleep(2000);
#endif
                break;
...
/*
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "C11. DRC configuration and initialization\n")));
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "C13. Configure operating conditions\n")));
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "C14. DRC configuration complete\n")));
                SOC_IF_ERROR_RETURN(DRC_REG_READ(unit, DRCALL, DRC_DDR_CONTROLLER_TRIGGERSr, &rval)); 
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "C15. DRC initialization complete\n")));
                SOC_IF_ERROR_RETURN(READ_ECI_BLOCKS_SOFT_INITr(unit,&rval64));
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "C16. Finishing DRAM initialization\n")));
                for (ciC = 0; ciC < MAX_SHMOO_INTERFACES; ciC++) {
                    if(!_check_dram(ciC)) {
                        continue;
                    }
                    ...
                    do {
                        ...
                        if (soc_timeout_check(&to)) {
                            LOG_ERROR(BSL_LS_SOC_COMMON,
                                      (BSL_META_U(unit,
                                                  "CI%d: Timed out DRAM initialization\n"), ciC));
                            return SOC_E_TIMEOUT;
                        }
                    } while (TRUE);
                }
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "C17. Clear interrupts and Read/Write FIFO errors\n")));
    ...
    if (!stat) {
        switch(ctlType) {
            ...
            /*    _soc_ddr40_arad_phy_init_mem_set_wrapper(unit, &T1fgmss, freq_loc, grade_loc);
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "B01. Set Strap and parameter per speed and grade\n")));
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit,
                                     "B02. Make sure PHY AUTOINIT at strap is NOT set\n")));
