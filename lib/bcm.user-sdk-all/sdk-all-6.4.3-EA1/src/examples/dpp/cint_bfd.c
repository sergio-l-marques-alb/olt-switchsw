...
int bfd_ipv4_example(int unit, int endpoint_acc, bcm_gport_t remote_gport) {
  ...
  /*
  * Adding BFDoIPV4 one hop endpoint
  */
  ...
  bfd_endpoint_info.dst_ip_addr = 0; /* field should be set only in the case of multi hop.*/
...
int cmp_structs(bcm_bfd_endpoint_info_t* endpoint_create,bcm_bfd_endpoint_info_t* endpoint_get, int type  ){
  ...
  if (type == bcmBFDTunnelTypeUdp) { /*ip single hop - dest ip should be zero.*/
