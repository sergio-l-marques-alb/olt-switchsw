...
/* $Id: cint_field_vmac_pon.c,v 1.1 xfei Exp $
                                         ...
                                         bcm_pbmp_t in_pbmp)
{
    ...
    if (BCM_E_NONE != result) 
    {
        ...
        auxRes = bcm_field_presel_destroy(unit, presel_id_up);
        return result;
    }
  
    result = bcm_field_qualify_Stage(unit, presel_id_up | BCM_FIELD_QUALIFY_PRESEL, bcmFieldStageIngress);
    if (BCM_E_NONE != result)
    {
    ...
    result = bcm_field_qualify_InPorts(unit, presel_id_up | BCM_FIELD_QUALIFY_PRESEL, pbm, pbm_mask);
    if (BCM_E_NONE != result)
    {
    ...
    result = bcm_field_qualify_InterfaceClassVPort(unit, presel_id_up | BCM_FIELD_QUALIFY_PRESEL, 0x1, 0x1);
    if (BCM_E_NONE != result)
    {
        printf("Error in bcm_field_qualify_InPorts\n");
        auxRes = bcm_field_presel_destroy(unit, presel_id_up);
                                         ...
                                         bcm_pbmp_t in_pbmp)
{
    ...
    {
        printf("Error in bcm_field_presel_create_id\n");
        auxRes = bcm_field_presel_destroy(unit, presel_id_down);
        return result;
    }
  
    result = bcm_field_qualify_Stage(unit, presel_id_down | BCM_FIELD_QUALIFY_PRESEL, bcmFieldStageIngress);
    if (BCM_E_NONE != result)
    {
        printf("Error in bcm_field_qualify_Stage\n");
        auxRes = bcm_field_presel_destroy(unit, presel_id_down);
    ...
    result = bcm_field_qualify_InPorts(unit, presel_id_down | BCM_FIELD_QUALIFY_PRESEL, pbm, pbm_mask);
    if (BCM_E_NONE != result)
    {
        printf("Error in bcm_field_qualify_InPorts\n");
        auxRes = bcm_field_presel_destroy(unit, presel_id_down);
    ...
    /* Select on LIF-Profile[0] = 0x1 */
    result = bcm_field_qualify_InterfaceClassVPort(unit, presel_id_down | BCM_FIELD_QUALIFY_PRESEL, 0x1, 0x1);
    if (BCM_E_NONE != result)
    {
        printf("Error in bcm_field_qualify_InPorts\n");
        auxRes = bcm_field_presel_destroy(unit, presel_id_down);
...
int vmac_upstream_user_header(int unit, int pon_port) 
{
    ...
    {
        bcm_field_presel_destroy(unit, presel_id_up);
        printf("Error in vmac_wa_field_group_set_upstream_hd1\n");
        return result;
    }
    ...
    {
        bcm_field_presel_destroy(unit, presel_id_up);
        printf("Error in vmac_wa_field_group_set_upstream_hd2\n");
        return result;
    }
