...
/*Get phy diagnostics information*/
int falcon_phy_meas_lowber_eye(const phymod_phy_access_t* phy, phymod_phy_eyescan_options_t eyescan_options, uint32_t* buffer);

/*Get phy diagnostics information*/
int falcon_phy_display_lowber_eye(const phymod_phy_access_t* phy, phymod_phy_eyescan_options_t eyescan_options, uint32_t* buffer);

/*Get phy diagnostics information*/
int falcon_phy_pmd_ber_end_cmd(const phymod_phy_access_t* phy, uint8_t supp_info, uint32_t timeout_ms);

/*Get phy diagnostics information*/
int falcon_phy_meas_eye_scan_start(const phymod_phy_access_t* phy, uint8_t direction);

/*Get phy diagnostics information*/
int falcon_phy_read_eye_scan_stripe(const phymod_phy_access_t* phy, uint32_t* buffer, uint16_t* status);

/*Get phy diagnostics information*/
int falcon_phy_display_eye_scan_header(const phymod_phy_access_t* phy, int8_t i);

/*Get phy diagnostics information*/
int falcon_phy_display_eye_scan_stripe(const phymod_phy_access_t* phy, int8_t y, uint32_t* buffer);

/*Get phy diagnostics information*/
int falcon_phy_display_eye_scan_footer(const phymod_phy_access_t* phy, int8_t i);

/*Get phy diagnostics information*/
int falcon_phy_meas_eye_scan_done(const phymod_phy_access_t* phy);

/*Get phy diagnostics information*/
int falcon_phy_eye_scan_debug_info_dump(const phymod_phy_access_t* phy);

/*Get phy diagnostics information*/
int falcon_phy_ladder_setting_to_mV(const phymod_phy_access_t* phy, int8_t y, int16_t* level);
