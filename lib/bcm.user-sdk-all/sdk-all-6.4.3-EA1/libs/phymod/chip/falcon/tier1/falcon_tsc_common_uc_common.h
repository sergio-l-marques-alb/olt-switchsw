...
/**********************************************************************************/
/*                                                                                */
/*  Revision      :  $Id: _falcon_comn_api_uc_common.h $  */
/*                                                                                */
...
/** @file _falcon_comn_api_uc_common.h
...
/** DSC_STATES Enum */
enum _falcon_comn_dsc_state_enum {
...
enum _falcon_comn_pmd_uc_cmd_enum {
  CMD_NULL                =  0,
  CMD_UC_CTRL             =  1,
  CMD_HEYE_OFFSET         =  2,
  CMD_VEYE_OFFSET         =  3,
...
enum _falcon_comn_pmd_event_rd_cmd_enum {
...
enum _falcon_comn_pmd_uc_dbg_cmd_enum {
...
/** Media type Enum */
enum _falcon_comn_media_type_enum {
...
enum _falcon_comn_diag_ber_mode_enum {
    DIAG_BER_POS  = 0,
    DIAG_BER_NEG  = 1,
    DIAG_BER_VERT = 0,
    DIAG_BER_HORZ = 1<<1,
...
enum _falcon_comn_event_code_enum {       
...
enum _falcon_comn_event_err_code_enum {
    GENERIC_UC_ERROR = 0,
    INVALID_REENTRY_ID,
