...
__phymod_diagnostics__dispatch__t__ phymod_diagnostics_tsce_diagnostics_driver = {
    ...
    tsce_phy_diagnostics_get,
    tsce_phy_pmd_info_dump,
    tsce_phy_pcs_info_dump,
    tsce_phy_meas_lowber_eye,
    tsce_phy_display_lowber_eye,
    NULL, /* phymod_phy_pmd_ber_end_cmd */
    tsce_phy_meas_eye_scan_start,
    tsce_phy_read_eye_scan_stripe,
    tsce_phy_display_eye_scan_header,
    tsce_phy_display_eye_scan_stripe,
    tsce_phy_display_eye_scan_footer,
    tsce_phy_meas_eye_scan_done,
    tsce_phy_eye_scan_debug_info_dump,
    NULL, /* phymod_phy_ladder_setting_to_mV */
};
