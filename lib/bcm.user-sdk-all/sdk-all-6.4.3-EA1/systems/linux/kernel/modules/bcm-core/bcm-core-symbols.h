...
EXPORT_SYMBOL(soc_i2c_regulator_get_voltcfg_and_name_by_index);
EXPORT_SYMBOL(soc_i2c_regulator_get_voltcfg_by_name);
EXPORT_SYMBOL(soc_i2c_regulator_get_voltcfg_attribute);
EXPORT_SYMBOL(soc_i2c_regulator_set_volt);
EXPORT_SYMBOL(soc_i2c_regulator_get_volt);
#endif /* INCLUDE_I2C */
EXPORT_SYMBOL(soc_regulator_init);
EXPORT_SYMBOL(soc_regulator_deinit);
EXPORT_SYMBOL(soc_regulator_get_cfg_nums);
EXPORT_SYMBOL(soc_regulator_get_voltcfg_and_name_by_index);
EXPORT_SYMBOL(soc_regulator_get_voltcfg_by_name);
EXPORT_SYMBOL(soc_regulator_get_voltcfg_attribute);
EXPORT_SYMBOL(soc_regulator_set_volt);
EXPORT_SYMBOL(soc_regulator_get_volt);
...
EXPORT_SYMBOL(SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_to_string);
EXPORT_SYMBOL(SOC_PPD_EG_VLAN_EDIT_TAG_VID_SRC_to_string);
EXPORT_SYMBOL(SOC_PPD_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_to_string);
EXPORT_SYMBOL(SOC_PPD_LIF_ING_VLAN_EDIT_TAG_VID_SRC_to_string);
EXPORT_SYMBOL(SOC_PPD_FRWRD_IP_ROUTE_LOCATION_to_string);
EXPORT_SYMBOL(SOC_PPD_FRWRD_IP_ROUTE_STATUS_to_string);
EXPORT_SYMBOL(soc_sand_SAND_PP_ETHERNET_FRAME_VLAN_FORMAT_to_string);
EXPORT_SYMBOL(SOC_PPD_EG_VLAN_EDIT_COMMAND_INFO_clear);
EXPORT_SYMBOL(SOC_PPD_EG_VLAN_EDIT_COMMAND_KEY_clear);
EXPORT_SYMBOL(SOC_PPD_LIF_ING_VLAN_EDIT_COMMAND_INFO_clear);
EXPORT_SYMBOL(SOC_PPD_LIF_ING_VLAN_EDIT_COMMAND_KEY_clear);
EXPORT_SYMBOL(SOC_PPD_IP_ROUTING_TABLE_RANGE_clear);
...
EXPORT_SYMBOL(test_cnt);
EXPORT_SYMBOL(test_list);
...
EXPORT_SYMBOL(SOC_PPD_DIAG_VSI_INFO_clear);
EXPORT_SYMBOL(SOC_PPD_DIAG_VSI_INFO_print);
...
EXPORT_SYMBOL(SOC_PPD_DIAG_LIF_PROFILE_INFO_clear);
EXPORT_SYMBOL(SOC_PPD_DIAG_LIF_PROFILE_INFO_print);
EXPORT_SYMBOL(SOC_PPC_INLIF_PROFILE_USAGE_print);
EXPORT_SYMBOL(SOC_PPC_OUTLIF_PROFILE_USAGE_print);
EXPORT_SYMBOL(arad_pp_profile_mgmt_if_profile_diag_info_get);
...
EXPORT_SYMBOL(_bcm_petra_mirror_unit_data);
EXPORT_SYMBOL(_cell_id_curr);
EXPORT_SYMBOL(_dpp_phy_addr_multi_get);
EXPORT_SYMBOL(_dpp_cosq_config);
EXPORT_SYMBOL(_dpp_l3_info);
EXPORT_SYMBOL(_dpp_policer_state);
EXPORT_SYMBOL(_dpp_port_config);
EXPORT_SYMBOL(_dpp_state);
EXPORT_SYMBOL(_dpp_wb_alloc_info_p);
EXPORT_SYMBOL(_dpp_wb_gport_info_p);
EXPORT_SYMBOL(_dpp_wb_l2_info_p);
EXPORT_SYMBOL(_dpp_wb_l3_info_p);
EXPORT_SYMBOL(_dpp_wb_mirror_info_p);
EXPORT_SYMBOL(_dpp_wb_multicast_info_p);
EXPORT_SYMBOL(_dpp_wb_policer_info_p);
EXPORT_SYMBOL(_dpp_wb_port_info_p);
EXPORT_SYMBOL(_dpp_wb_qos_info_p);
EXPORT_SYMBOL(_dpp_wb_stg_info_p);
EXPORT_SYMBOL(_dpp_wb_switch_info_p);
EXPORT_SYMBOL(_dpp_wb_trill_info_p);
EXPORT_SYMBOL(_dpp_wb_vswitch_info_p);
EXPORT_SYMBOL(_l3_sw_db);
EXPORT_SYMBOL(_mirror_sw_db);
EXPORT_SYMBOL(stg_info);
EXPORT_SYMBOL(trill_state);
EXPORT_SYMBOL(tt_programs);
EXPORT_SYMBOL(vt_programs);
EXPORT_SYMBOL(programs);
EXPORT_SYMBOL(warmboot_test_mode);
EXPORT_SYMBOL(wb_field_is_scheduled_sync);
EXPORT_SYMBOL(wb_switch_state);
EXPORT_SYMBOL(wb_vlan_is_scheduled_sync);
...
EXPORT_SYMBOL(_arad_wb_db_info_p);
...
EXPORT_SYMBOL(bcm_dpp_wb_port_config);
EXPORT_SYMBOL(bcm_dpp_wb_stack_config);
EXPORT_SYMBOL(bcm_trunk_control);
EXPORT_SYMBOL(bcm_wb_trunk_control);
...
EXPORT_SYMBOL(last_program_id);
EXPORT_SYMBOL(last_program_pointer);
...
EXPORT_SYMBOL(soc_dpp_cosq_ingress_alpha_get);
EXPORT_SYMBOL(soc_dpp_cosq_ingress_queue_category_get);
EXPORT_SYMBOL(soc_dpp_cosq_ingress_queue_dyn_info_get);
...
EXPORT_SYMBOL(SOC_PPD_FRWRD_MACT_LEARN_MSG_PARSE_INFO_print);
...
EXPORT_SYMBOL(soc_dpp_p3_mem_delete);
EXPORT_SYMBOL(soc_dpp_p3_mem_insert);
EXPORT_SYMBOL(soc_dpp_p3_mem_lkup);
...
EXPORT_SYMBOL(soc_warmboot_is_allowed_verify);
...
EXPORT_SYMBOL(gfa_bi_fpga_pcp_hw_reset);
EXPORT_SYMBOL(gfa_petra_board_synt_nominal_freq_get);
EXPORT_SYMBOL(gfa_petra_board_synt_set);
#endif /* BCM_DPP_SUPPORT */
