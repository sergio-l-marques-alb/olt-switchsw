 ...
 *  Defines
 */
#define FURIA_FW_DLOAD_RETRY_CNT 5
                                 ...
                                 uint8_t prg_eeprom)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (READ_FURIA_PMA_PMD_REG(pa,\
                                ...
                                &micro_boot_por.data));
    if((micro_boot_por.fields.serboot) &&
       ...
       (micro_boot_por.fields.slv_dwld_done)) {
        ...
        return mst_running_byte_cnt.fields.mst_running_byte_cnt_val;
    }
    ...
    if(prg_eeprom) {
        ...
        PHYMOD_IF_ERR_RETURN
            (READ_FURIA_PMA_PMD_REG(pa,\
                                    FUR_GEN_CNTRLS_gen_control2_Adr,\
                                    &gen_ctrl2.data));
        gen_ctrl2.fields.reserved_05 = 0; 
        gen_ctrl2.fields.reserved_04 = 0; 
        ...
        PHYMOD_IF_ERR_RETURN
            (READ_FURIA_PMA_PMD_REG(pa,\
                                    FUR_GEN_CNTRLS_gen_control2_Adr,\
                                    &gen_ctrl2.data));
        gen_ctrl2.fields.reserved_05 = 1; 
        gen_ctrl2.fields.reserved_04 = 1; 
    ...
    if(prg_eeprom) {
        PHYMOD_IF_ERR_RETURN
            (_furia_wait_mst_msgout(pa, MSGOUT_PRGRM_DONE, 10));
        /* Assert Reset by writing zero to spi_rstb, spi2x_rstb */
        PHYMOD_IF_ERR_RETURN
            (READ_FURIA_PMA_PMD_REG(pa,\
                                    FUR_GEN_CNTRLS_gen_control2_Adr,\
