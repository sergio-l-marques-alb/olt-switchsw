...
int get_mapped_speed(temod_spd_intfc_type spd_intf, int *speed)
{
  ...
  case TEMOD_SPD_20000_SCR         : *speed = digital_operationSpeeds_SPEED_20G_X2; break;  /* or SPEED_20G_CX2 */
  case TEMOD_SPD_20000             : *speed = digital_operationSpeeds_SPEED_20G_X4; break;
...
int get_actual_speed(int speed_id, int *speed)
{
  ...
  case digital_operationSpeeds_SPEED_20G_X2             : *speed = TEMOD_SPD_20000_SCR; break;  /* or SPEED_20G_CX2 */
  case digital_operationSpeeds_SPEED_20G_X4             : *speed = TEMOD_SPD_20000; break;
