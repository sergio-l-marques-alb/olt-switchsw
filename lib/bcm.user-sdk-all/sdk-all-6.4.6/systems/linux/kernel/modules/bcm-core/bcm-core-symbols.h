...
EXPORT_SYMBOL(soc_alpm_128_bucket_sanity_check);
EXPORT_SYMBOL(soc_alpm_128_pivot_sanity_check);
EXPORT_SYMBOL(soc_alpm_bucket_sanity_check);
EXPORT_SYMBOL(soc_alpm_debug_show);
EXPORT_SYMBOL(soc_alpm_pivot_sanity_check);
#endif /* BCM_TRIDENT2_SUPPORT */
...
EXPORT_SYMBOL(soc_th_alpm_128_bucket_sanity_check);
EXPORT_SYMBOL(soc_th_alpm_128_pivot_sanity_check);
EXPORT_SYMBOL(soc_th_alpm_bucket_sanity_check);
EXPORT_SYMBOL(soc_th_alpm_debug_show);
EXPORT_SYMBOL(soc_th_alpm_debug_brief_show);
EXPORT_SYMBOL(soc_th_alpm_pivot_sanity_check);
...
EXPORT_SYMBOL(soc_th_ifp_index_invalid);
#ifndef BCM_TH_ASF_EXCLUDE
...
EXPORT_SYMBOL(cmd_portmod_diag);
EXPORT_SYMBOL(portmod_diag_usage);
...
EXPORT_SYMBOL(SOC_PPD_DIAG_EG_DROP_LOG_INFO_clear);
EXPORT_SYMBOL(SOC_PPD_DIAG_EG_DROP_LOG_INFO_print);
...
EXPORT_SYMBOL(arad_pp_dbal_dynamic_table_test);
EXPORT_SYMBOL(arad_pp_signal_mngr_signal_get);
EXPORT_SYMBOL(soc_ppd_rif_info_get);
EXPORT_SYMBOL(SOC_PPD_RIF_INFO_print);
EXPORT_SYMBOL(SOC_PPD_RIF_INFO_clear);
...
EXPORT_SYMBOL(arad_pp_oam_diag_print_em);
EXPORT_SYMBOL(arad_pp_oam_diag_print_ak);
EXPORT_SYMBOL(arad_pp_oam_diag_print_oamp_counter);
EXPORT_SYMBOL(arad_pp_oam_diag_print_debug);
EXPORT_SYMBOL(arad_pp_oam_diag_print_oam_id);
