                                     ...
                                     const char *name)
{
    ...
    *desc = sal_alloc(sizeof(**desc),"Hash template main descriptor");
    ...
    multi_set_init_info.max_duplications = (*desc)->max_entities;
    multi_set_init_info.member_size = ((*desc)->data_size);
    multi_set_init_info.nof_members = (*desc)->template_count;
    multi_set_init_info.sec_handle = 0;
    multi_set_init_info.prime_handle = 0;
    multi_set_init_info.wb_var_index = -1 /*=SOC_DPP_WB_ENGINE_VAR_NONE*/;
...
static int _shr_template_hash_destroy(_shr_template_pool_desc_t *desc)
{
    ...
    soc_sand_rv = soc_sand_multi_set_destroy(BSL_UNIT_UNKNOWN, hash_data->multi_set);
...
static int _shr_template_hash_clear(_shr_template_pool_desc_t *desc)
{
    ...
    soc_sand_rv = soc_sand_multi_set_clear(BSL_UNIT_UNKNOWN, hash_data->multi_set);
    SOC_SAND_IF_ERR_RETURN(soc_sand_rv);    
