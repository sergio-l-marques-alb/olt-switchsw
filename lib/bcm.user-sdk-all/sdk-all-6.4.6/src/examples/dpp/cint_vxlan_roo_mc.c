...
int vxlan_roo_mc_run(int unit, 
    ...
    bshell(0, "  mod IRR_MCDB_EGRESS_FORMAT_2 118784 1 ENTRY_FORMAT=1, NEW_FORMAT=1, BMP_PTR=0x2, LINK_PTR=118786,  OUTLIF_1=0xF "); 
    ...
    tmp_forwarding_entry.mc_ip += 2; /* 224.0.0.1.3 */   
    tmp_forwarding_entry.mc_ip6[15] += 2;
    ...
    int encap_array[2] = {g_vxlan_roo_mc.access_vlan, g_vxlan_roo_mc.access_vlan};/* encap_id aka CUD: outRif */
    nof_member_of_mc = 2;
    rv = multicast__add_multicast_entry(unit,
                                        ipmc_index,  /* mc group */
                                        members_of_mc, /* port members of mc group */
    ...
    /* add host entry */
    tmp_forwarding_entry.mc_ip -= 1; /* 224.0.0.1.2 */
    tmp_forwarding_entry.mc_ip6[15] -= 1;
    rv = multicast__create_forwarding_entry_dip_sip(unit, 
                                                    tmp_forwarding_entry,
                                                    ipmc_index, 
                                                    vpn, /* inRif */
