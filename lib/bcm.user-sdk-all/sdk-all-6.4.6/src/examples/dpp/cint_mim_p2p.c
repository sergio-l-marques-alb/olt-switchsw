/* $Id: cint_mim_p2p.c,v 1.11 Broadcom SDK $
...
int 
p2p_main(int unit, int port1, int port2) {
    ...
    mim_port_config(&(mim_p2p_info.mim_port), mim_p2p_info.port_1, mim_p2p_info.bvid.vpn, mim_p2p_info.src_bmac,
                    mim_p2p_info.bvid.vpn, mim_p2p_info.dest_bmac, 16777215 /* I-SID for P2P port */); 
    rv = bcm_mim_port_add(unit, 0xffff, &(mim_p2p_info.mim_port)); /* use invalid VPN (=0xffff) to create P2P port */
    if (rv != BCM_E_NONE) {
