 ...
 *
 * Initialization: 
 *      Due to the Petra ingress mirror erratum that can't mirror origal packet, we need to
 *      add the following port configuration to config.bcm if we use the ingress mirror.
 *      tm_port_header_type_2.BCM88640 = RAW
 *
 * Note: This cint script is for Petra-B, if want to know how to run mirror at Arad,
 *      Please refer to cint_petra_mirror_tests.c.
 *
 ...
 *      BCM> cint examples/dpp/cint_petra_mirror_tests.c
 *      BCM> cint
