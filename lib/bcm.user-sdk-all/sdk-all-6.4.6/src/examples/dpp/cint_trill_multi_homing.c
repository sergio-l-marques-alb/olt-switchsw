...
bcm_port_t     trill_mh_recycle_port = 40;

/* recycle ports config */
bcm_gport_t    trill_mh_snoop_trap_gport_id_2;
bcm_gport_t    trill_mh_snoop_trap_gport_id_3;
...
int port_config_recycle_port(int unit, 
    ...
    rv = port_config(unit, recycle_port, vid_desig);
    BCM_IF_ERROR_RETURN(rv);
    ...
    rv = system_port_lookup_ptch(unit, 20, 17, port, recycle_port); 
    BCM_IF_ERROR_RETURN(rv);
...
int trill_multi_homing(int unit) {
   ...
   /* egress_link_failure_and_egress_trill_no_da_match(unit); */
    ...
    rv = port_config_recycle_port(unit, trill_mh_recycle_port, trill_mh_port_3, trill_mh_vid_3_desig, 
                                  &trill_mh_snoop_trap_gport_id_3, &trill_mh_snoop_group_3);
    if (rv != BCM_E_NONE) {
...
test_trill_multi_homing(int unit, 
                        ...
                        int trill_ether_type) {
    trill_mh_port_1 =  p1;
    trill_mh_port_2  = p2;
    trill_mh_port_3 = p3;
    trill_mh_port_4 = p4;
    trill_mh_port_trap_cpu = trap_port;
    trill_mh_recycle_port = recycle_port;
