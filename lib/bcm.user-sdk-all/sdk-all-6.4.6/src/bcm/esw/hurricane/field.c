...
#include <soc/defs.h>
#if defined(BCM_HURRICANE_SUPPORT) && defined(BCM_FIELD_SUPPORT)
...
STATIC void _field_hu_functions_init(_field_funct_t *functions) ;

/*
 * Function:
 *     _field_hu_ingress_qualifiers_init
 * Purpose:
 ...
 */
STATIC int
_field_hu_ingress_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    _FP_QUAL_DECL;
 ...
 */
STATIC int
_field_hu_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    switch (stage_fc->stage_id) {
      case _BCM_FIELD_STAGE_INGRESS:
          rv = _field_hu_ingress_qualifiers_init(unit, stage_fc);
          break;
...
/*
 * Function:
 *     _field_hu_write_slice_map_ingress
 *
 * Purpose:
 ...
 */
STATIC int
_field_hu_write_slice_map_ingress(int unit, _field_stage_t *stage_fc)
{
    ...
    int rv;                          /* Operation return status. */
    uint32 virtual_to_physical_map_hu[4] = {
    ...
    uint32 virtual_to_group_map_hu[4] = {
 ...
 */
int
_bcm_field_hu_write_slice_map(int unit, _field_stage_t *stage_fc,
                              _field_group_t *fg)
{
    int rv = BCM_E_PARAM;   /* Operation return status. */

    if (stage_fc->stage_id == _BCM_FIELD_STAGE_INGRESS) {
        rv = _field_hu_write_slice_map_ingress(unit, stage_fc);
    }
    return (rv);
}
 ...
 */
int
_bcm_field_hu_init(int unit, _field_control_t *fc) 
{
    ...
    while (stage_fc) {
        ...
        BCM_IF_ERROR_RETURN(_field_hu_qualifiers_init(unit, stage_fc));
    ...
    _field_hu_functions_init(&fc->functions);;
 ...
 */
STATIC void
_field_hu_functions_init(_field_funct_t *functions)
{
    ...
    functions->fp_write_slice_map      = _bcm_field_hu_write_slice_map;
...
#else /* BCM_HURRICANE_SUPPORT && BCM_FIELD_SUPPORT */
int _hurricane_field_not_empty;
#endif  /* BCM_HURRICANE_SUPPORT && BCM_FIELD_SUPPORT */
