...
_bcm_switch_control_sync(int unit, int arg)
{
...
#endif /* BCM_SHADOW_SUPPORT */
    {
        ...
        _BCM_SYNC_MODULE(unit, SHR_BPROF_BCM_COMMON, _bcm_common_scache_sync, rv);
#endif /* BCM_TRX_SUPPORT */
...
STATIC int
_bcm_switch_olp_dglp_get(int unit, int dglp, bcm_mac_t *mac,int *Index)
{
    egr_olp_dgpp_config_entry_t eolp_dgpp_cfg;
    int        index = 0;
    int        max_entries = 0;
