      ...
      char * filename) 
{
  ...
  sal_fprintf(ofp,"%d: >>>>>>>   Link2Prge packet# 00 \n%d-",line_index, 1+line_index);
  line_index++;
    ...
    )
{
  ...
  sal_fprintf(ofp, "\n%d-resolved_data      = 0x%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s", line_index, resolved_data->p2_oam_id_and_oam_sub_type, 
              resolved_data->p2_prge_pp_port_var,resolved_data->p2_prge_tm_port_var,resolved_data->p2_prge_out_lif,resolved_data->p2_ace_variable,
              resolved_data->p2_vsi_variable,resolved_data->term2prge_tod_ntp,resolved_data->term2prge_tod_1588,resolved_data->oam_sub_type,
              resolved_data->p2_oam_id,resolved_data->p2_oam_counter_value,resolved_data->p2_out_pp_port,resolved_data->p2_out_tm_port,
              resolved_data->p2_prge_program_variable,resolved_data->p2_ees_data_action2,resolved_data->p2_ees_data_action1,resolved_data->p2_sys_headers_size,
              resolved_data->p2_nwk_headers_size,resolved_data->p2_dst_system_port,resolved_data->p2_src_system_port); 
}
    ...
    )
{
    ...
    rv = soc_ppd_diag_received_packet_info_get(unit, core_id, &info);
