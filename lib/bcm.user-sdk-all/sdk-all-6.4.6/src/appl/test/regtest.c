...
{
    soc_block_type_t block  = REG_FIRST_BLK_TYPE(blocks);
...
try_reg_dispatch(int unit, soc_regaddrinfo_t *ainfo, void *data)
{
    ...
    if(SOC_IS_DFE(unit)) { 
        ...
        case DRCA_INDIRECT_COMMANDr:
        case DRCB_INDIRECT_COMMANDr:
        case DRCC_INDIRECT_COMMANDr:
        case DRCD_INDIRECT_COMMANDr:
        case DRCE_INDIRECT_COMMANDr:
        case DRCF_INDIRECT_COMMANDr:
        case DRCG_INDIRECT_COMMANDr:
        case DRCH_INDIRECT_COMMANDr:
