...
CONST soc_dpp_defines_t soc_dpp_defines_qax= {
    ...
    SOC_DPP_LPM_WIDTH_QAX,
    SOC_DPP_NOF_LPM_LINES_QAX,
    SOC_DPP_NOF_LPM_PAYLOADS_QAX,
    SOC_DPP_EEDB_WIDTH_QAX,
    SOC_DPP_NOF_EEDB_LINES_QAX,
    SOC_DPP_NOF_EEBD_PAYLOADS_QAX,
    SOC_DPP_FEC_NOF_BITS_QAX,
    SOC_DPP_NOF_FECS_QAX,
    SOC_DPP_NOF_FEC_BANKS_QAX,
    SOC_DPP_NOF_FEC_PAYLOADS_QAX,
    ...
    SOC_DPP_NOF_VSI_UPPERS_QAX,
    SOC_DPP_IN_RIF_NOF_BITS_QAX,
    SOC_DPP_NOF_RIFS_QAX,
    SOC_DPP_NOF_RIF_PAYLOADS_QAX,
    SOC_DPP_OEM1_WIDSTH_QAX,
    SOC_DPP_NOF_OEM1_LINES_QAX,
    SOC_DPP_NOF_OEM1_PAYLOADS_QAX,
    SOC_DPP_OEM2_WIDSTH_QAX,
    SOC_DPP_NOF_OEM2_LINES_QAX,
    SOC_DPP_NOF_OEM2_PAYLOADS_QAX,
    SOC_DPP_RMEP_EM_WIDTH_QAX,
    SOC_DPP_NOF_RMEP_EM_LINES_QAX,
    SOC_DPP_NOF_RMEP_EM_PAYLOADS_QAX,
    ...
    SOC_DPP_OAM_TYPE_NOF_BITS_QAX,
    SOC_DPP_NOF_OAM_TYPES_QAX,
    ...
    SOC_DPP_IN_PP_PORT_FORWARDING_LOOKUP_PROFILE_NOF_BITS_QAX,
    ...
    SOC_DPP_CORE_CLOCK_FREQ_MHZ_QAX,
    ...
    SOC_DPP_FC_RX_MLF_HRF_MAX_QAX,
    SOC_DPP_FC_RX_MLF_MAX_QAX,
};
