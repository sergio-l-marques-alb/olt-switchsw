/* $Id: pb_pp_api_trap_mgmt.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_trap_mgmt.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_FRWRD_PROFILE_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(profile_info);

  res = soc_pb_pp_trap_frwrd_profile_info_set_verify(
          unit,
          trap_code_ndx,
          profile_info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_frwrd_profile_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_FRWRD_PROFILE_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(profile_info);

  res = soc_pb_pp_trap_frwrd_profile_info_get_verify(
          unit,
          trap_code_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_frwrd_profile_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_SNOOP_PROFILE_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(profile_info);

  res = soc_pb_pp_trap_snoop_profile_info_set_verify(
          unit,
          trap_code_ndx,
          profile_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_snoop_profile_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_SNOOP_PROFILE_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(profile_info);

  res = soc_pb_pp_trap_snoop_profile_info_get_verify(
          unit,
          trap_code_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_snoop_profile_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_TO_EG_ACTION_MAP_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_trap_to_eg_action_map_set_verify(
          unit,
  ...
  res = soc_pb_pp_trap_to_eg_action_map_set_unsafe(
          unit,
          trap_type_bitmap_ndx,
          eg_action_profile
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_to_eg_action_map_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_TO_EG_ACTION_MAP_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(eg_action_profile);

  res = soc_pb_pp_trap_to_eg_action_map_get_verify(
          unit,
          trap_type_bitmap_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_trap_to_eg_action_map_get_unsafe(
          unit,
          trap_type_bitmap_ndx,
          eg_action_profile
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_to_eg_action_map_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_EG_PROFILE_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(profile_info);

  res = soc_pb_pp_trap_eg_profile_info_set_verify(
          unit,
          profile_ndx,
          profile_info
        );
  ...
  res = soc_pb_pp_trap_eg_profile_info_set_unsafe(
          unit,
          profile_ndx,
          profile_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_eg_profile_info_set()", profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_EG_PROFILE_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(profile_info);

  res = soc_pb_pp_trap_eg_profile_info_get_verify(
          unit,
          profile_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_trap_eg_profile_info_get_unsafe(
          unit,
          profile_ndx,
          profile_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_eg_profile_info_get()", profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_MACT_EVENT_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(buff_len);

  res = soc_pb_pp_trap_mact_event_get_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_trap_mact_event_get_unsafe(
          unit,
          buff,
          buff_len
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_mact_event_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_TRAP_MACT_EVENT_PARSE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(mact_event);

  res = soc_pb_pp_trap_mact_event_parse_verify(
          unit,
          buff,
          buff_len
        );
  ...
  res = soc_pb_pp_trap_mact_event_parse_unsafe(
          unit,
          buff,
          buff_len,
          mact_event
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_trap_mact_event_parse()", 0, 0);
}
