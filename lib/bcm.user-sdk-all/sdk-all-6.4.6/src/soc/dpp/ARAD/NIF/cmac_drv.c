/*
 * $Id: cmac_drv.c,v 1.15 Broadcom SDK $
 *
...
soc_cmac_drv_init(int unit, soc_port_t port)
{
    ...
    /* WrapCore Bypass mode - Need to set WC if in BYPASS mode (for ILKN or CAUI)*/
...
soc_cmac_drv_enable_set(int unit, soc_port_t port, int enable)
{
    ...
    /* Put the CMAC in a soft reset state when disabled to allow packets to drain from the TX FIFO */ 
    soc_reg_field_set(unit, CLP_CMAC_CTRLr, &ctrl, SOFT_RESETf, enable ? 0 : 1); 
    if (ctrl != octrl) {
        SOCDNX_IF_ERR_EXIT(WRITE_CLP_CMAC_CTRLr(unit, port, ctrl));
    }
    if(enable) {
        /*CMAC port requires MIB reset when enabled*/
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_PORT_MIB_RESETr(unit, port, reg_val));
        /*disable the drop in the PORT block*/
        SOCDNX_IF_ERR_EXIT(READ_PORT_TXFIFO_PKT_DROP_CTLr(unit, port, &reg_val));
 ...
 * Purpose:
 *      Get current MAC enable setting.
 * Parameters:
 *      unit - unit number.
 *      port - Port number.
...
soc_cmac_drv_speed_set(int unit, soc_port_t port, int speed)
{
    ...
    /*make sure that mac is disabled*/
...
CONST mac_driver_t soc_cmac_driver = {
    "DPP CMAC Driver",              /* drv_name */
    soc_cmac_drv_init,              /* md_init  */
    soc_cmac_drv_enable_set,        /* md_enable_set */
    soc_cmac_drv_enable_get,        /* md_enable_get */
    NULL,                           /* md_duplex_set */
    NULL,                           /* md_duplex_get */
    soc_cmac_drv_speed_set,         /* md_speed_set */
    NULL,                           /* md_speed_get */
    soc_cmac_pause_set,             /* md_pause_set */
    soc_cmac_pause_get,             /* md_pause_get */
    soc_cmac_pause_addr_set,        /* md_pause_addr_set */
    soc_cmac_pause_addr_get,        /* md_pause_addr_get */
    soc_cmac_drv_loopback_set,      /* md_lb_set */
    soc_cmac_drv_loopback_get,      /* md_lb_get */
    NULL,                           /* md_interface_set */
    NULL,                           /* md_interface_get */
    NULL,                           /* md_ability_get - Deprecated */
    soc_cmac_drv_frame_max_set,     /* md_frame_max_set */
    soc_cmac_drv_frame_max_get,     /* md_frame_max_get */
    NULL,                           /* md_ifg_set */
    NULL,                           /* md_ifg_get */
    NULL,                           /* md_encap_set */
    NULL,                           /* md_encap_get */
    soc_cmac_drv_control_set,       /* md_control_set */
    soc_cmac_drv_control_get,       /* md_control_get */
    soc_cmac_ability_local_get      /* md_ability_local_get */
 };
