...

{
    ...
    if (protocol_offset/ARAD_NIF_NUM_OF_OFFSETS_IN_PROTOCOL_GROUP != (phy_port-1)/ARAD_NIF_NUM_OF_LANES_IN_PROTOCOL_GROUP) {
...
uint32
arad_port_link_up_mac_update(int unit, soc_port_t port)
{
