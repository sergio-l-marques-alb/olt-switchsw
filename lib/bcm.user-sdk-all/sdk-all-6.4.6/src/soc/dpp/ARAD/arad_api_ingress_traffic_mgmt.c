  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_CATEGORY_RNGS_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_category_rngs_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_CATEGORY_RNGS_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_category_rngs_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_WRED_EXP_WQ_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

   SOC_SAND_TAKE_DEVICE_SEMAPHORE;

  res = arad_itm_wred_exp_wq_verify(
    unit,
    rt_cls_ndx,
    exp_wq
  );
  ...
  res = arad_itm_wred_exp_wq_set_unsafe(
    unit,
    rt_cls_ndx,
    exp_wq
  );
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_wred_exp_wq_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_WRED_EXP_WQ_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
  ...
  res = arad_itm_wred_exp_wq_get_unsafe(
    unit,
    rt_cls_ndx,
    exp_wq
  );
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_wred_exp_wq_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_WRED_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);
  SOC_SAND_CHECK_NULL_INPUT(exact_info);

  res = arad_itm_wred_verify(
    unit,
    rt_cls_ndx,
    drop_precedence_ndx,
    info
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_wred_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_WRED_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_wred_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_TAIL_DROP_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);
  SOC_SAND_CHECK_NULL_INPUT(exact_info);

  res = arad_itm_tail_drop_verify(
    unit,
    rt_cls_ndx,
    drop_precedence_ndx,
    info
  ...
  res = arad_itm_tail_drop_set_unsafe(
    unit,
    rt_cls_ndx,
    drop_precedence_ndx,
    info,
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_tail_drop_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_TAIL_DROP_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
  ...
  res = arad_itm_tail_drop_get_unsafe(
    unit,
    rt_cls_ndx,
    drop_precedence_ndx,
    info
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_tail_drop_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_QT_RT_CLS_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_qt_rt_cls_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_QT_RT_CLS_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_qt_rt_cls_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_VSQ_TAIL_DROP_DEFAULT_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_vsq_tail_drop_get()",0,0);
}
  ...
  )
{
  ...
  res = arad_itm_queue_dyn_info_get_unsafe(
    unit,
    core,
    queue_ndx,
    info
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_queue_dyn_info_get()",0,0);
}
  ...
  )
{
  ...
  SOCDNX_SAND_IF_ERR_EXIT(arad_itm_dyn_total_thresh_set_unsafe(unit, reservation_increase));
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_SYS_RED_QUEUE_SIZE_BOUNDARIES_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_sys_red_queue_size_boundaries_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_SYS_RED_QUEUE_SIZE_BOUNDARIES_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_sys_red_queue_size_boundaries_get()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_SYS_RED_GLOB_RCS_SET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_sys_red_glob_rcs_set()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_SYS_RED_GLOB_RCS_GET);
  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_sys_red_glob_rcs_get()",0,0);
}
  ...
  )
{
  ...
  vsq_ndx_tmp *= arad_itm_vsq_is_ocb_max(unit); /*If we support OCB only vsqs, we double the number of entries*/
  if (is_ocb_only) {
  ...
  )
{
  ...
  vsq_is_ocb_max = arad_itm_vsq_is_ocb_max(unit); /*If we support OCB only vsqs, we double the number of entries*/
...
const char*
  arad_ARAD_ITM_VSQ_GROUP_SIZE_to_string(
    SOC_SAND_IN  ARAD_ITM_VSQ_GROUP_SIZE enum_val
  )
{
  const char* str = NULL;
  switch(enum_val)
  {
  case SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE:
    str = "vsq_groupa_sze";
  break;
  case SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE:
    str = "vsq_groupb_sze";
  break;
  case SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE:
    str = "vsq_groupc_sze";
  break;
  case SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE:
    str = "vsq_groupd_sze";
  break;
  default:
    str = " Unknown";
...
const char*
  arad_ARAD_ITM_VSQ_NDX_RNG_to_string(
    SOC_SAND_IN  ARAD_ITM_VSQ_NDX_RNG enum_val
  )
{
  const char* str = NULL;
  switch(enum_val)
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_COMMITTED_Q_SIZE_SET);
  ...
  res = arad_itm_committed_q_size_set_verify(
          unit,
          rt_cls_ndx,
          info
        );
  ...
  res = arad_itm_committed_q_size_set_unsafe(
          unit,
          rt_cls_ndx,
          info,
          exact_info
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_itm_committed_q_size_set()", rt_cls_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_COMMITTED_Q_SIZE_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(exact_info);

  res = arad_itm_committed_q_size_get_verify(
          unit,
          rt_cls_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = arad_itm_committed_q_size_get_unsafe(
          unit,
          rt_cls_ndx,
          exact_info
        );
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_itm_committed_q_size_get()", rt_cls_ndx, 0);
}
  ...
  )
{
  soc_error_t
    rv;
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_DISCARD_DP_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  rv = arad_itm_dp_discard_set_verify(
          unit,
          discard_dp
        );
  if(SOC_FAILURE(rv)) {
  ...
  rv = arad_itm_dp_discard_set_unsafe(
          unit,
          discard_dp
        );
  if(SOC_FAILURE(rv)) {
    SOC_SAND_SET_ERROR_CODE(SOC_SAND_ERR, 20, exit_semaphore);
  }
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_itm_dp_discard_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_ITM_DISCARD_DP_GET);
  ...
  rv = arad_itm_dp_discard_get_unsafe(
          unit,
          discard_dp
        );
  if(SOC_FAILURE(rv)) {
...
exit_semaphore:
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_itm_dp_discard_get()", 0, 0);
}
  ...
  )
{
  ...
  res = arad_itm_congestion_statistics_get_unsafe(
    unit,
    stats
  );
  SOC_SAND_CHECK_FUNC_RESULT(res, 100, exit_semaphore);
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_itm_congestion_statistics_get()",0,0);
}
