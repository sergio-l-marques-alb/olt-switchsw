...
/* $Id: arad_pp_llp_trap.c,v 1.20 Broadcom SDK $
...
#define ARAD_PP_LLP_TRAP_SUB_TYPE_MAX                            (SOC_SAND_U8_MAX) /*need to uncomment this line below if this value reduced: SOC_SAND_ERR_IF_ABOVE_MAX(info->sub_type, ARAD_PP_LLP_TRAP_SUB_TYPE_MAX*/
#define ARAD_PP_LLP_TRAP_SUB_TYPE_BITMAP_MAX                     (SOC_SAND_U8_MAX)

#define ARAD_PP_LLP_TRAP_PORT_INFO_TRAP_ENABLE_MASK_MAX (0x7ff)
#define ARAD_PP_LLP_TRAP_ACTION_PROFILE_TRAP_CODE_LSB_MAX (ARAD_PP_TRAP_CODE_RESERVED_MC_7)
#define ARAD_PP_LLP_TRAP_ACTION_PROFILE_TRAP_CODE_LSB_MIN (ARAD_PP_TRAP_CODE_RESERVED_MC_0)
  ...
  Arad_pp_procedure_desc_element_llp_trap[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_PORT_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LLP_TRAP_ARP_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_llp_trap[] =
{
  ...
  },
  {
    ...
    "ARAD_PP_LLP_TRAP_ENABLE_MASK_OUT_OF_RANGE_ERR",
    "The parameter 'trap_enable_mask' is out of range. \n\r "
    "The range is: 0 - 255 or 0xffffffff (see ARAD_PP_LLP_TRAP_PORT_ENABLE).\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_PORT_INFO_SET_UNSAFE);
  ...
  ihp_pinfo_llr_tbl_data.enable_arp_trap =
    SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_ARP);

  ihp_pinfo_llr_tbl_data.enable_dhcp_trap =
    SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_DHCP);

  ihp_pinfo_llr_tbl_data.enable_igmp_trap =
    SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_IGMP);

  ihp_pinfo_llr_tbl_data.enable_mld_trap =
    SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_MLD);

  /* Enable bit for each prog trap, if enabled */
  ihp_pinfo_llr_tbl_data.general_trap_enable = (0xf &
    ((SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_0)) |
     (SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_1) << 1) |
     (SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_2) << 2) |
     (SOC_SAND_BOOL2NUM(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_3) << 3)));
  ...
  vtt_in_pp_port_config_tbl_data.all_vlan_member = SOC_SAND_NUM2BOOL_INVERSE(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_ING_VLAN_MEMBERSHIP);
  ...
  ihb_in_pp_port_flp_tbl_data.enable_unicast_same_interface_filter = SOC_SAND_NUM2BOOL(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_SAME_INTERFACE);
  ...
  ihb_in_pp_port_fer_tbl_data.icmp_redirect_enable = SOC_SAND_NUM2BOOL(port_info->trap_enable_mask & ARAD_PP_LLP_TRAP_PORT_ENABLE_ICMP_REDIRECT);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_PORT_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_PORT_INFO, port_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_PORT_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_PORT_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(port_info);

  ARAD_PP_LLP_TRAP_PORT_INFO_clear(port_info);
  ...
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_ARP;
  }
  if (ihp_pinfo_llr_tbl_data.enable_dhcp_trap)
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_DHCP;
  }
  if (ihp_pinfo_llr_tbl_data.enable_igmp_trap)
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_IGMP;
  }
  if (ihp_pinfo_llr_tbl_data.enable_mld_trap)
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_MLD;
  }
  
  /* Enable bit for each prog trap, if enabled */
  if (SOC_SAND_GET_BIT(ihp_pinfo_llr_tbl_data.general_trap_enable,0))
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_0;
  }
  if (SOC_SAND_GET_BIT(ihp_pinfo_llr_tbl_data.general_trap_enable,1))
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_1;
  }
  if (SOC_SAND_GET_BIT(ihp_pinfo_llr_tbl_data.general_trap_enable,2))
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_2;
  }
  if (SOC_SAND_GET_BIT(ihp_pinfo_llr_tbl_data.general_trap_enable,3))
  {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_PROG_TRAP_3;
  }
  ...
  if(!vtt_in_pp_port_config_tbl_data.all_vlan_member) {
      port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_ING_VLAN_MEMBERSHIP;
  }
  ...
  if (ihb_in_pp_port_flp_tbl_data.enable_unicast_same_interface_filter) {
    port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_SAME_INTERFACE;
  }
  ...
  if(ihb_in_pp_port_fer_tbl_data.icmp_redirect_enable) {
      port_info->trap_enable_mask |= ARAD_PP_LLP_TRAP_PORT_ENABLE_ICMP_REDIRECT;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_ARP_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_ARP_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_ARP_INFO, arp_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_ARP_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LLP_TRAP_ARP_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(arp_info);

  ARAD_PP_LLP_TRAP_ARP_INFO_clear(arp_info);
  ...
  )
{
  ...
  ihp_reserved_mc_tbl_data.cpu_trap_code = (trap_action->trap_code - ARAD_PP_TRAP_CODE_RESERVED_MC_0);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_RESERVED_MC_KEY, reserved_mc_key, 10, exit);
  ...
  )
{
  ...
  ARAD_PP_ACTION_PROFILE_clear(trap_action);
  ...
  trap_action->trap_code = ihp_reserved_mc_tbl_data.cpu_trap_code + ARAD_PP_TRAP_CODE_RESERVED_MC_0;
  ...
  )
{
  ...
  res = READ_IHP_GENERAL_TRAPr(unit, REG_PORT_ANY, prog_trap_ndx /* or 2 */, reg_above64_val);
  ...
  )
{
  ...
  /* Enable bitmap */
  fld_above64_val[0] = 0;
  if (prog_trap_qual->enable_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_DA)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_DA;
  }
  if (prog_trap_qual->enable_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_ETHER_TYPE)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_ETHER_TYPE;
  }
  if (prog_trap_qual->enable_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_SUB_TYPE)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_SUB_TYPE;
  }
  if (prog_trap_qual->enable_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_IP_PRTCL)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_IP_PROTOCOL;
  }
  if (prog_trap_qual->enable_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_L4_PORTS)
  {
  ...
  /* inverse bitmap */
  fld_above64_val[0] = 0;
  if (prog_trap_qual->inverse_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_DA)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_DA;
  }
  if (prog_trap_qual->inverse_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_ETHER_TYPE)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_ETHER_TYPE;
  }
  if (prog_trap_qual->inverse_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_SUB_TYPE)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_SUB_TYPE;
  }
  if (prog_trap_qual->inverse_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_IP_PRTCL)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_IP_PROTOCOL;
  }
  if (prog_trap_qual->inverse_bitmap & ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_L4_PORTS)
  {
    fld_above64_val[0] |= ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_L4_PORTS;
  }
  soc_reg_above_64_field_set(unit, IHP_GENERAL_TRAPr, reg_above64_val, GENERAL_TRAP_INVERSE_BMPf, fld_above64_val);

  /* after setting all the fields - write to the register */
  res = WRITE_IHP_GENERAL_TRAPr(unit, REG_PORT_ANY, prog_trap_ndx /* or 1 */, reg_above64_val);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_PROG_TRAP_QUALIFIER, prog_trap_qual, 20, exit);
  ...
  if (prog_trap_ndx > 1)
  {
    ...
    enable_bitmap_test =
      (prog_trap_qual->enable_bitmap & (~(ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_DA | ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_ETHER_TYPE)));
    inverse_bitmap_test =
      (prog_trap_qual->inverse_bitmap & (~(ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_DA | ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_ETHER_TYPE)));
  ...
  )
{
  ...
  ARAD_PP_LLP_TRAP_PROG_TRAP_QUALIFIER_clear(prog_trap_qual);
  ...
  {
    prog_trap_qual->enable_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_DA;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_ETHER_TYPE)
  {
    prog_trap_qual->enable_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_ETHER_TYPE;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_SUB_TYPE)
  {
    prog_trap_qual->enable_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_SUB_TYPE;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_IP_PROTOCOL)
  {
    prog_trap_qual->enable_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_IP_PRTCL;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_L4_PORTS)
  {
    prog_trap_qual->enable_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_L4_PORTS;
  }
  ...
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_DA)
  {
    prog_trap_qual->inverse_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_DA;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_ETHER_TYPE)
  {
    prog_trap_qual->inverse_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_ETHER_TYPE;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_SUB_TYPE)
  {
    prog_trap_qual->inverse_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_SUB_TYPE;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_IP_PROTOCOL)
  {
    prog_trap_qual->inverse_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_IP_PRTCL;
  }
  if (fld_above64_val[0] & ARAD_PP_LLP_TRAP_PROG_TRAP_BITMAP_L4_PORTS)
  {
    prog_trap_qual->inverse_bitmap |= ARAD_PP_LLP_TRAP_PROG_TRAP_COND_SELECT_L4_PORTS;
  }
...
uint32
  ARAD_PP_LLP_TRAP_PORT_INFO_verify(
  ...
  )
{
  ...
  if (info->trap_enable_mask != ARAD_PP_LLP_TRAP_PORT_ENABLE_ALL)
  {
    SOC_SAND_ERR_IF_ABOVE_MAX(info->trap_enable_mask, ARAD_PP_LLP_TRAP_PORT_INFO_TRAP_ENABLE_MASK_MAX, ARAD_PP_LLP_TRAP_ENABLE_MASK_OUT_OF_RANGE_ERR, 20, exit);
  }

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_PORT_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_TRAP_ARP_INFO_verify(
  ...
  )
{
  ...
  for (ind = 0; ind < ARAD_PP_TRAP_NOF_MY_IPS; ++ind)
  {
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_ARP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_TRAP_RESERVED_MC_KEY_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_RESERVED_MC_KEY_verify()",0,0);
}

uint32
  ARAD_PP_LLP_TRAP_PROG_TRAP_L2_INFO_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->sub_type, ARAD_PP_LLP_TRAP_SUB_TYPE_MAX, ARAD_PP_LLP_TRAP_SUB_TYPE_OUT_OF_RANGE_ERR, 13, exit);
  */
  /* SOC_SAND_ERR_IF_ABOVE_MAX(info->sub_type_bitmap, ARAD_PP_LLP_TRAP_SUB_TYPE_BITMAP_MAX, ARAD_PP_LLP_TRAP_SUB_TYPE_BITMAP_OUT_OF_RANGE_ERR, 14, exit); */

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_PROG_TRAP_L2_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_TRAP_PROG_TRAP_L3_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_PROG_TRAP_L3_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_TRAP_PROG_TRAP_L4_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_PROG_TRAP_L4_INFO_verify()",0,0);
}

uint32
  ARAD_PP_LLP_TRAP_PROG_TRAP_QUALIFIER_verify(
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_PROG_TRAP_L2_INFO, &(info->l2_info), 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_PROG_TRAP_L3_INFO, &(info->l3_info), 11, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LLP_TRAP_PROG_TRAP_L4_INFO, &(info->l4_info), 12, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LLP_TRAP_PROG_TRAP_QUALIFIER_verify()",0,0);
}
