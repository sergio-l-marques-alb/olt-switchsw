...
#define ARAD_PP_FP_PFG_NDX_MAX                                   (ARAD_PP_FP_NOF_PFGS-1)
#define ARAD_PP_FP_DB_ID_NDX_MAX                                 (ARAD_PP_FP_NOF_DBS-1)
#define ARAD_PP_FP_ENTRY_ID_NDX_MAX                              (SOC_SAND_UINT_MAX-1)
#define ARAD_PP_FP_FWD_TYPE_NDX_MAX                              (ARAD_PP_NOF_FP_FWD_TYPES-1)
#define ARAD_PP_FP_PORT_PROFILE_NDX_MAX                          (3)
#define ARAD_PP_FP_QUAL_TYPES_MAX                                (ARAD_PP_NOF_FP_QUAL_TYPES-1)
#define ARAD_PP_FP_ACTION_TYPES_MAX                              (ARAD_PP_NOF_FP_ACTION_TYPES-1)
#define ARAD_PP_FP_DATABASE_TYPE_MAX                             (ARAD_PP_NOF_FP_DATABASE_TYPES-1)
#define ARAD_PP_FP_STRENGTH_MAX                                  (ARAD_PP_FP_NOF_DBS-1)
...
#define ARAD_PP_FP_NOF_FIELDS_MAX                                (ARAD_PP_FP_DIR_EXTR_MAX_NOF_FIELDS)
#define ARAD_PP_FP_DE_ENTRY_ID_NDX_MAX                           (63)
#define ARAD_PP_FP_DB_ID_MAX                                     (ARAD_PP_FP_NOF_DBS-1)
#define ARAD_PP_FP_CONTROL_TYPE_MAX                              (ARAD_PP_NOF_FP_CONTROL_TYPES-1)
...
#define ARAD_PP_FP_NOF_OUT_LIF_RANGES                            (2)
...
#define ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_SUB_HEADER_NDX      (0)
#define ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX          (1)
#define ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX        (2)
#define ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_PARTIAL_QUAL_NDX    (3)
#define ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_STAGE_NDX           (4)
...
#define ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_DIRECT_EXTRACTION          (32)
#define ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_FLP                        (160) /* Assumption of using only key-c*/
#define ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_SLB                        (8*32) 
#define ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_TCAM                       (320)
#define ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_DIRECT_TABLE_SMALL_BANK    (7)
...
#define ARAD_TCAM_KEY_LENGTH_DIRECT_TABLE_PER_BANK(unit, bank_id)   \
  ((bank_id < SOC_DPP_DEFS_GET(unit, nof_tcam_big_banks))? SOC_DPP_DEFS_GET(unit, tcam_big_bank_key_nof_bits):ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_DIRECT_TABLE_SMALL_BANK)

#define ARAD_PP_FP_NOF_FLP2EGW_KEY_SIGNALS (5)

#define ARAD_PP_FP_NOF_PROFILE_OBJECTS(unit, control_type) ((control_type == SOC_PPC_FP_CONTROL_TYPE_FLP_PGM_PROFILE)? SOC_DPP_DEFS_GET(unit, nof_flp_programs): ARAD_NOF_LOCAL_PORTS)
...
typedef struct
{
  ARAD_PP_FP_PREDEFINED_ACL_KEY predefined_key;
    ...
    Arad_pp_procedure_desc_element_fp[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_DIAG_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_DIAG_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_DIAG_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PACKET_DIAG_GET_VERIFY),
   ...
   */
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_TYPES_VERIFY_FIRST_STAGE),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_ACTION_TYPES_VERIFY_FIRST_STAGE),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_ACTION_TYPE_TO_CE_COPY),
   ...
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_ACTION_TYPE_TO_PMF_CONVERT),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_ACTION_TYPE_FROM_PMF_CONVERT),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_ACTION_TYPE_MAX_SIZE_GET),
   ...
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_TYPE_PREDEFINED_KEY_GET),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_PREDEFINED_KEY_GET),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_KEY_GET),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_TYPE_TO_TCAM_TYPE_CONVERT),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_TYPE_TO_KEY_FLD_CONVERT),
   ...
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_VAL_ENCODE),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_TYPE_PRESET1),
   ...
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FP_QUAL_TYPE_AND_LOCAL_LSB_GET),
    ...
    Arad_pp_error_desc_element_fp[] =
{
  ...
  {
    ARAD_PP_FP_FWD_TYPE_NDX_OUT_OF_RANGE_ERR,
    "ARAD_PP_FP_FWD_TYPE_NDX_OUT_OF_RANGE_ERR",
    "The parameter 'fwd_type_ndx' is out of range. \n\r "
    "The range is: 0 - ARAD_PP_NOF_FP_FWD_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FP_QUAL_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FP_DATABASE_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  {
    ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR,
    "ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR",
  ...
  {
    ARAD_PP_FP_DATABASE_TYPE_OUT_OF_RANGE_ERR,
    "ARAD_PP_FP_DATABASE_TYPE_OUT_OF_RANGE_ERR",
    "The parameter 'db_type' is out of range. \n\r "
    "The range is: 0 - ARAD_PP_NOF_FP_DATABASE_TYPES.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ARAD_PP_FP_ACTION_TYPES_OUT_OF_RANGE_ERR,
    "ARAD_PP_FP_ACTION_TYPES_OUT_OF_RANGE_ERR",
    "The parameter 'action_types' is out of range. \n\r "
    "The range is: 0 - ARAD_PP_NOF_FP_ACTION_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  {
    ARAD_PP_FP_QUAL_TYPES_NOT_PREDEFINED_ACL_KEY_ERR,
    "ARAD_PP_FP_QUAL_TYPES_NOT_PREDEFINED_ACL_KEY_ERR",
  ...
  {
    ARAD_PP_FP_QUAL_TYPES_END_OF_LIST_ERR,
    "ARAD_PP_FP_QUAL_TYPES_END_OF_LIST_ERR",
    "The parameter 'qual_types' has reached end of list \n\r "
    "but a non ARAD_PP_NOF_FP_QUAL_TYPES is inserted after that.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ARAD_PP_FP_ACTION_TYPES_END_OF_LIST_ERR,
    "ARAD_PP_FP_ACTION_TYPES_END_OF_LIST_ERR",
    "The parameter 'action_types' has reached end of list \n\r "
    "but a non ARAD_PP_NOF_FP_ACTION_TYPES is inserted after that.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  {
    ARAD_PP_FP_PACKET_SIZE_OUT_OF_RANGE_ERR,
    "ARAD_PP_FP_PACKET_SIZE_OUT_OF_RANGE_ERR",
  ...
  {
    ARAD_PP_FP_NOF_DBS_PER_BANK_OUT_OF_RANGE_ERR,
    "ARAD_PP_FP_NOF_DBS_PER_BANK_OUT_OF_RANGE_ERR",
  ...
  )
{
    ...
    LOG_ERROR(BSL_LS_SOC_FP,
              (BSL_META_U(unit,
               ...
               unit, SOC_PPC_FP_DATABASE_STAGE_to_string(stage), ARAD_PP_FP_QUAL_TYPE_to_string(qual_type)));
...
uint32
    arad_pp_fp_db_stage_info_get(
          ...
          SOC_SAND_OUT ARAD_FP_DATABASE_STAGE  *stage
    )
{
  ARAD_FP_DATABASE_STAGE
      stage_lcl = ARAD_FP_DATABASE_STAGE_INGRESS_PMF;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_DB_STAGE_GET);

  switch (fp_database_info->db_type) {
  case ARAD_PP_FP_DB_TYPE_EGRESS:
      stage_lcl = ARAD_FP_DATABASE_STAGE_EGRESS;
      break;
  case ARAD_PP_FP_DB_TYPE_FLP:
      stage_lcl = ARAD_FP_DATABASE_STAGE_INGRESS_FLP;
      break;
  case ARAD_PP_FP_DB_TYPE_SLB:
      stage_lcl = ARAD_FP_DATABASE_STAGE_INGRESS_SLB;
      break;
  case ARAD_PP_FP_DB_TYPE_VT:
      stage_lcl = ARAD_FP_DATABASE_STAGE_INGRESS_VT;
      break;
  case ARAD_PP_FP_DB_TYPE_TT:
      stage_lcl = ARAD_FP_DATABASE_STAGE_INGRESS_TT;
      break;
  default:
      stage_lcl = ARAD_FP_DATABASE_STAGE_INGRESS_PMF;
      break;
    ...
    )
{
  ...
  *lookup_id = 0;
  ...
  for(action_indx = 0;  (action_indx < SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX) && (fp_database_info.action_types[action_indx] != ARAD_PP_ACTION_TYPE_INVALID); ++action_indx) {
      if (fp_database_info.action_types[action_indx] == ARAD_PP_FP_ACTION_TYPE_CHANGE_KEY) {
          *is_cascaded = TRUE;
          *lookup_id = 0;
      }
  }
  ...
  for (qual_ndx = 0; qual_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; qual_ndx++)
  {
    if (fp_database_info.qual_types[qual_ndx] == ARAD_PP_FP_QUAL_IRPP_KEY_CHANGED)
    {
        if (*lookup_id == 1) {
          LOG_ERROR(BSL_LS_SOC_FP,
                    (BSL_META_U(unit,
...
STATIC
  uint32
    arad_pp_fp_entry_validity_get(
      SOC_SAND_IN  int                     unit,
      SOC_SAND_IN  ARAD_PP_FP_DATABASE_INFO        *fp_database_info,
      SOC_SAND_IN  ARAD_PP_FP_QUAL_VAL             qual_vals[ARAD_PP_FP_NOF_QUALS_PER_DB_MAX],
      SOC_SAND_IN  ARAD_PP_FP_ACTION_TYPE          action_types[ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX]
    )
{
  uint32
    res;
  ...
  for (qual_type_ndx = 0; qual_type_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; ++qual_type_ndx)
  {
    if (qual_vals[qual_type_ndx].type != ARAD_PP_NOF_FP_QUAL_TYPES)
    {
      is_type_found = FALSE;
      for (qual_type_ndx2 = 0; (qual_type_ndx2 < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX) && (is_type_found == FALSE); ++qual_type_ndx2)
      {
  ...
  {
    if (action_types[action_type_ndx] != ARAD_PP_ACTION_TYPE_INVALID)
    {
      is_type_found = FALSE;
      for (action_type_ndx2 = 0; (action_type_ndx2 < ARAD_PP_NOF_FP_ACTION_TYPES) && (is_type_found == FALSE); ++action_type_ndx2)
      {
    ...
    )
{
  ...
  if (info->stage != ARAD_FP_DATABASE_STAGE_INGRESS_PMF) {
      *is_pfg_tm = FALSE;
      ARAD_DO_NOTHING_AND_EXIT;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_UNSAFE);
  ...
  *success = SOC_SAND_SUCCESS;
  ...
  flags |= ARAD_PMF_SEL_ALLOC_CHECK_ONLY;
  if (is_for_delete) {
  ...
  if (psl_alloc_success) {
      ...
      if (!psl_alloc_success) {
        ...
        LOG_ERROR(BSL_LS_SOC_FP,
                  (BSL_META_U(unit,
                              "Unit %d Pfg index %d - The insertion with check only succedded, however, the real insertion failed.\n\r"),
                   unit, pfg_ndx));
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(pfg_ndx, ARAD_PP_FP_PFG_NDX_MAX, ARAD_PP_FP_PFG_NDX_OUT_OF_RANGE_ERR, 10, exit);

  res = ARAD_PP_FP_PFG_INFO_verify(unit, info);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET_VERIFY);

  /* Don't know the stage here, cannot decide the exact limit */
  SOC_SAND_ERR_IF_ABOVE_MAX(pfg_ndx, ARAD_PP_FP_NOF_PFGS, ARAD_PP_FP_PFG_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(info);

  ARAD_PP_FP_PFG_INFO_clear(info);
  ...
  )
{
  ...
  if (total_length == 0)
  {
    for (qual_ndx = 0; qual_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; qual_ndx++)
    {
      if (info->qual_types[qual_ndx] == ARAD_PP_NOF_FP_QUAL_TYPES)
      {
        continue;
      }
  ...
  )
{
    ...
    if (is_default_db
        && (db_info->db_type != ARAD_PP_FP_DB_TYPE_FLP)
        && (db_info->db_type != ARAD_PP_FP_DB_TYPE_SLB)
        && (db_info->db_type != ARAD_PP_FP_DB_TYPE_VT)
        && (db_info->db_type != ARAD_PP_FP_DB_TYPE_TT)
        && (db_info->db_type != ARAD_PP_FP_DB_TYPE_DIRECT_TABLE)
        && (db_info->db_type != ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION)) {
  ...
  )
{
    ...
    for (stage_lcl = 0; stage_lcl < ARAD_NOF_FP_DATABASE_STAGES; stage_lcl ++) {
...
STATIC uint32
  arad_pp_fp_qual_tm_verify(
    ...
    SOC_SAND_IN  ARAD_FP_DATABASE_STAGE     stage,
    SOC_SAND_IN  ARAD_PP_FP_DATABASE_INFO   *info,
    SOC_SAND_OUT ARAD_PP_FP_ACTION_TYPE     *action_type,
  ...
  )
{
  ...
  for (qual_ndx = 0; qual_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; qual_ndx++)
  {
      ...
      res = sw_state_access[unit].dpp.soc.arad.tm.pmf.fp_info.udf.get(
              unit,
              stage,
              (info->qual_types[qual_ndx] - ARAD_PP_FP_QUAL_HDR_USER_DEF_0),
              &qual_info
            );
  ...
  nof_actions = 0;
  for(action_indx = 0;  (action_indx < SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX) && (info->action_types[action_indx] != ARAD_PP_ACTION_TYPE_INVALID); ++action_indx) {
      nof_actions ++;
  ...
  )
{
  ...
  if (stage != SOC_PPC_FP_DATABASE_STAGE_INGRESS_PMF) {
     ...
     * some use FEM 
     */
    if (info->db_type == ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION) {
...
{
  uint32 min_prog_indx, max_prog_indx, program_id, pgm_bmp_used;
  uint32 res = SOC_SAND_OK;
  int nof_qualifiers = 0, i;
  char table_name[50];
  ARAD_FP_DATABASE_STAGE stage = ARAD_FP_DATABASE_STAGE_INGRESS_FLP, stage_indx;
  ...
  ARAD_PP_FP_DATABASE_INFO fp_database_info;  
  ...
  if(fp_database_info.db_type == SOC_PPC_FP_DB_TYPE_FLP){
    stage = ARAD_FP_DATABASE_STAGE_INGRESS_FLP;
  }else{
    stage = ARAD_FP_DATABASE_STAGE_INGRESS_VT;
  }
  ...
  nof_qualifiers = 0;
  for(i = 0; (i < SOC_PPC_FP_NOF_QUALS_PER_DB_MAX) && (fp_database_info.qual_types[i]!= ARAD_PP_NOF_FP_QUAL_TYPES); i++){
    uint8 qual_full_size = 0, is_in_hdr = 0, remain_bits = 0;

    arad_pp_dbal_qualifier_full_size_get(unit, stage, fp_database_info.qual_types[i], &qual_full_size, &is_in_hdr);
  ...
  for (stage_indx = 0; stage_indx < ARAD_NOF_FP_DATABASE_STAGES; stage_indx++) {
      res = sw_state_access[unit].dpp.soc.arad.tm.pmf.fp_info.db_info.set(
              unit,
              stage_indx,
              db_id_ndx,
  ...
  res = arad_pmf_psl_pmf_pgms_get(unit, stage, fp_database_info.supported_pfgs_arad, 0, 0, &pgm_bmp_used,
  ...
  for (program_id = min_prog_indx; program_id < max_prog_indx; ++program_id){
    ...
    if (stage == ARAD_FP_DATABASE_STAGE_INGRESS_FLP) {
      ...
      keys_to_table_id[0].key_id = MEM_TYPE_TO_KEY(fp_database_info.physicalDB);
    }    
    keys_to_table_id[0].lookup_number = 0xFF; /* use 0xFF to dynamic allocation */
    
    res = arad_pp_dbal_program_to_tables_associate(unit, program_id, /* stage */ARAD_FP_DATABASE_STAGE_INGRESS_FLP, keys_to_table_id, NULL, 1/*num of lookups*/);
    SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);   
  ...
  )
{
  ...
  *success = SOC_SAND_FAILURE_OUT_OF_RESOURCES;
  ...
  if ((info->flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_EXTENDED_DATABASES) || (info->flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_STAGE_VT_EXTENDED) || (info->flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_DBAL) ) {
      is_skip_hw = TRUE;
  }
  ...
  /* Insert a min key contraint only on the current Database */
 /* Check if there is a key-change action or qualifier */
  ...
  else if((info->db_type == ARAD_PP_FP_DB_TYPE_FLP) || (info->db_type == ARAD_PP_FP_DB_TYPE_VT) || (info->db_type == ARAD_PP_FP_DB_TYPE_TT)) {
    /* 
  ...
  else if(info->db_type == ARAD_PP_FP_DB_TYPE_SLB) {
    /* 
   ...
   *  - Perform 2 loops, where:
   *  1. In the 1st loop, compute the minimum size for the action, then key,
   *  check both can be allocated
   *  (but with flags 'dont commit', neither in SW nor in HW)
   *  In the same round, create the TCAM DB. Destroy it if fail to allocate
   *  
   *  2. In the 2nd loop, perform the same computations for key and action,
   *  just this time commit to HW & SW
   */
    /* Just check in the 1st round */
   ...
   if(info->db_type == SOC_PPC_FP_DB_TYPE_DIRECT_TABLE) {
       for(zone_idx = 0; zone_idx < ARAD_PP_FP_KEY_NOF_ZONES; zone_idx++) {
           if((zone_idx == 0 && total_bits_in_zone[zone_idx] > SOC_DPP_DEFS_GET(unit, tcam_big_bank_key_nof_bits)) 
   ...
   if (SOC_IS_ARADPLUS(unit))
   {
       ...
       if (is_slb_hash_in_quals) {
           uint32 found, length_best_unused, length_worst_unused, nof_bits_for_slb_hash;
           ...
           if (!(found && ((total_bits_in_zone[1] >= nof_bits_for_slb_hash) || (total_bits_in_zone[3] >= nof_bits_for_slb_hash)))) {
              SOC_SAND_SET_ERROR_CODE(ARAD_TCAM_ENTRY_SIZE_OUT_OF_RANGE_ERR, 120, exit); 
           }
    ...
    */
    ...
    if((info->db_type != ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION) 
       && (info->db_type != ARAD_PP_FP_DB_TYPE_FLP)
       && (info->db_type != ARAD_PP_FP_DB_TYPE_VT)
       && (info->db_type != ARAD_PP_FP_DB_TYPE_TT)
       && (info->db_type != ARAD_PP_FP_DB_TYPE_SLB))
    {
        ...
        if(action_size_needed > action_size_constraint) {
          LOG_ERROR(BSL_LS_SOC_FP,
            ...
            SOC_SAND_SET_ERROR_CODE(ARAD_PMF_LOW_LEVEL_ID_OUT_OF_RANGE_ERR, 130, exit); /* need more bits in TCAM action as expected */
        }
        ...
        if((info->flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_SMALL_BANKS) 
           && ((info->db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) 
               && (total_bits_in_zone[0] > ARAD_TCAM_BANK_KEY_SIZE_IN_BITS_DIRECT_TABLE_SMALL)))
        {
          LOG_ERROR(BSL_LS_SOC_FP,
            ...
            SOC_SAND_SET_ERROR_CODE(ARAD_TCAM_BANK_ENTRY_SIZE_OUT_OF_RANGE_ERR, 140, exit); /* need more bits in TCAM action as expected */
        }
        ...
        tcam_info.prefix_size = (info->db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) ? 0 : SOC_SAND_MIN(prefix_nof_bits_max, ARAD_TCAM_PREFIX_SIZE_MAX); 
        tcam_info.entry_size = key_size;
        tcam_info.callback = arad_pp_fp_tcam_callback;
        tcam_info.user_data = db_id_ndx;
        tcam_info.is_direct = (info->db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) ? TRUE : FALSE;
        ...
        if(res != 0) {
             tcam_info.bank_owner = (stage == ARAD_FP_DATABASE_STAGE_EGRESS) ? /* Different bank owner per stage */
        ...
        default:
          ...
          LOG_DEBUG(BSL_LS_SOC_FP,
                    (BSL_META_U(unit,
                                "\n\r")));
            SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_PFG_NDX_OUT_OF_RANGE_ERR, 148, exit);
        ...
        if(info->db_type != ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) {
        ...
        for (db_id_other_ndx = 0; db_id_other_ndx < ARAD_PP_FP_NOF_DBS; ++db_id_other_ndx)
        {
            res = sw_state_access[unit].dpp.soc.arad.tm.pmf.fp_info.db_info.get(
                    unit,
                    stage,
             ...
             */
            if((info->db_type != ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) 
               && (other_db_info.db_type != ARAD_PP_FP_DB_TYPE_DIRECT_TABLE)
               && (other_db_info.db_type != ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION))
            {
        ...
        SHR_BITCOPY_RANGE(tcam_info.forbidden_dbs, ARAD_PP_FP_DB_ID_TO_TCAM_DB_SHIFT, forbidden_db_bmp, 0, ARAD_PP_FP_NOF_DBS);
    ...
    /* For FLP, FES/FEM allocation not relevant */
    if ((stage != ARAD_FP_DATABASE_STAGE_EGRESS) && 
        (stage != ARAD_FP_DATABASE_STAGE_INGRESS_SLB) &&  
        (info->db_type != SOC_PPC_FP_DB_TYPE_DIRECT_EXTRACTION) && 
        (info->db_type != SOC_PPC_FP_DB_TYPE_FLP)) {
        /*
         * allocate action resources for exist DB, that need to be duplicated in new programs
         */
        ARAD_PP_FEM_ACTIONS_CONSTRAINT_clear(&action_const);
        
        action_const.action_size = action_size_constraint; 
        action_const.tcam_res_id[0] = 0; /* Not used */
        action_const.tcam_res_id[1] = 1; /* Not used */
        ...
        if(!action_alloced)
        {
          LOG_ERROR(BSL_LS_SOC_FP,
                    (BSL_META_U(unit,
                                "   Error in database create: "
                                "For database %d creation, stage %s, no success for Action allocation \n\r"),
                     db_id_ndx, SOC_PPC_FP_DATABASE_STAGE_to_string(stage)));
          LOG_ERROR(BSL_LS_SOC_FP,
                    (BSL_META_U(unit,
                                "   Parameters: alloc_flags %d, strength %d \n\r"), alloc_flags, info->strength));
          LOG_ERROR(BSL_LS_SOC_FP,
                    (BSL_META_U(unit,
                                "\n\r")));
            /* Destroy the TCAM DB */
...
exit_tm:
  *success = SOC_SAND_SUCCESS;
  ...
  /* 
   * 2nd loop: at this stage, the creation is theoretically ensured to be successful 
   ...
   */
    ...
    if(info->db_type == ARAD_PP_FP_DB_TYPE_FLP)
    {
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
      ...
      */
      ...
      for (config_phase = 0; config_phase < 2; config_phase++) 
      {
        ...
        for (pmf_pgm_ndx = pmf_pgm_ndx_min; pmf_pgm_ndx < pmf_pgm_ndx_max; ++pmf_pgm_ndx)
        {
            ...
            SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 193, exit);
            ...
            if (config_phase != 0) 
            {
              res = arad_pp_flp_elk_prog_config(
                        unit,
                        pmf_pgm_ndx,
                        ARAD_KBP_FLP_PROG_TO_OPCODE(pmf_pgm_ndx),
                        key_size_in_bytes
                    );
              SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 194, exit);
            }
        }
...
#else
      *success = SOC_SAND_FAILURE_INTERNAL_ERR;
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_STAGE_OUT_OF_RANGE_ERR, 196, exit);
#endif
  }
  else 
  {
        ...
        /* Do not allocate action and key for large DE DBs, inserted on entry insertion */
            ...
            if(!key_alloced) {
              LOG_ERROR(BSL_LS_SOC_FP,
                        (BSL_META_U(unit,
                                    "    "
                                    "Key: fail to allocate Database %d in program %d, with flags %d, selected_cycle %d, "
                                    "place_cons %d, ce_rsrc_bmp_glbl %d, total_ce_indx %d, place_start %d"  "\n\r"), 
                         db_id_ndx, pmf_pgm_ndx_duplicate, alloc_flags, selected_cycle[pmf_pgm_ndx], place_cons, 0, 
                         total_ce_indx, place_start));
                *success = SOC_SAND_FAILURE_OUT_OF_RESOURCES;
                goto exit_failure; /* done with FAIL*/
            }
            ...
            /* Do not allocate FES / FEM at egress  - there is none */
            /* For Direct Extraction, allocate at the entry insertion */
            if ((stage == ARAD_FP_DATABASE_STAGE_INGRESS_PMF) &&  (info->db_type != SOC_PPC_FP_DB_TYPE_DIRECT_EXTRACTION)) {
                /* Allocate the Action */
...
exit_failure:
  ...
  if (*success != SOC_SAND_SUCCESS) {
     ARAD_PP_FP_DATABASE_INFO_clear(&fp_pp_database_info);
     for (stage = 0; stage < ARAD_NOF_FP_DATABASE_STAGES; stage ++) {
          res = sw_state_access[unit].dpp.soc.arad.tm.pmf.fp_info.db_info.set(
                  unit,
                  stage,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FP_DATABASE_INFO, info, 20, exit);
   ...
   */
    ...
    case ARAD_PP_FP_DB_TYPE_VT:
    case ARAD_PP_FP_DB_TYPE_TT:
      key_max_length = ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_FLP;
      break;
    case ARAD_PP_FP_DB_TYPE_SLB:
      key_max_length = ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_SLB;
      break;
    case ARAD_PP_FP_DB_TYPE_TCAM:
    case ARAD_PP_FP_DB_TYPE_EGRESS:
      key_max_length = ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_TCAM;
      break;
    case ARAD_PP_FP_DB_TYPE_DIRECT_TABLE:
      key_max_length = SOC_DPP_DEFS_GET(unit, tcam_big_bank_key_nof_bits);
      break;
    case ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION:
      key_max_length = ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_DIRECT_EXTRACTION;
      break;
    default:
      key_max_length = 0;
    }
    ...
    if (SOC_IS_ARADPLUS(unit))
    {
        ...
        soc_res = arad_pp_fp_is_qual_in_qual_arr(unit, 
                                                 info->qual_types, 
                                                 ARAD_PP_FP_NOF_QUALS_PER_DB_MAX, 
                                                 SOC_PPC_FP_QUAL_KEY_AFTER_HASHING, 
                                                 &is_slb_hash_in_quals);
     ...
     */
        ...
        if ((stage == ARAD_FP_DATABASE_STAGE_INGRESS_PMF) || (stage == ARAD_FP_DATABASE_STAGE_EGRESS)) { /* do not check for FLP */
           if ((info->db_type == ARAD_PP_FP_DB_TYPE_TCAM) || (info->db_type == ARAD_PP_FP_DB_TYPE_EGRESS))
            {
              action_length_max = ARAD_TCAM_ACTION_SIZE_FORTH_20_BITS;
            }
            else if (info->db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE)
            {
              action_length_max = ARAD_TCAM_ACTION_SIZE_SECOND_20_BITS;
            }
            else
            {
    ...
    if (info->db_type == ARAD_PP_FP_DB_TYPE_SLB) {
  ...
  )
{
  ...
  ARAD_PP_FP_DATABASE_INFO_clear(info);
  /*
  ...
  )
{
  ...
  if ((fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_EXTENDED_DATABASES) || (fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_STAGE_VT_EXTENDED)|| (fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_DBAL))
  {
     goto exit_without_field_hardware_update;
  }

  if (fp_database_info.db_type == ARAD_PP_NOF_FP_DATABASE_TYPES)
  {
   ...
   */
  if ((fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_TCAM)
        && (fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_EGRESS))
  {
  ...
  if (is_for_tm) {
     ...
     */
    if ((fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_TCAM) 
        || (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE))
    {
        res = arad_pp_fp_action_dealloc(
                unit,
                db_id_ndx,
...
exit_without_field_hardware_update:
    ...
    if ((fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_TCAM) 
        ...
        || (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_EGRESS))
    {
      tcam_db_id = ( fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_STAGE_VT_EXTENDED ) ? (ARAD_PP_ISEM_ACCESS_VT_CLASSIFICATIONS_TCAM_BASE + fp_database_info.internal_table_id) :   ARAD_PP_FP_DB_ID_TO_TCAM_DB(db_id_ndx);
      res = arad_tcam_access_destroy_unsafe(
              unit,
              tcam_db_id
            );
    ...
    if((fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_EXTENDED_DATABASES) || 
        (fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_STAGE_VT_EXTENDED) || (fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_DBAL)) {
      ARAD_DO_NOTHING_AND_EXIT;
    }
  }
  ...
  )
{
  ...
  if(bank_ndx >= SOC_DPP_DEFS_GET_TCAM_NOF_BANKS(unit)) {
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_NOF_DBS_PER_BANK_OUT_OF_RANGE_ERR, 40, exit);
  }
  ...
  *bank_id = bank_ndx;
  ...
  for (qual_type_ndx = 0; qual_type_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX ; ++qual_type_ndx)
  {
    if (info->qual_vals[qual_type_ndx].type == ARAD_PP_NOF_FP_QUAL_TYPES) {
      break;
    }
    ...
    for (bit_ndx = 0; bit_ndx < ARAD_TCAM_KEY_LENGTH_DIRECT_TABLE_PER_BANK(unit, bank_ndx); ++bit_ndx)
    {
        if ((bit_ndx >= qual_lsb)
...
{
    uint32  res = SOC_SAND_OK,
            entry_ndx_dt, entry_dt_first = 0, is_dt_bit_meaningful = 0, phase_ndx, bank_id = 0;
    uint8   is_used;
  ...
  /* map action to tcam action buffer */
    res = arad_pp_fp_action_value_to_buffer(unit,info->actions,db_id_ndx,action.value);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
...
uint32 
    arad_pp_fp_extended_database_entry_add(int unit, ARAD_FP_DATABASE_STAGE stage, uint32 db_id_ndx, uint32 entry_id_ndx, const  ARAD_PP_FP_ENTRY_INFO *info, uint32 result[ARAD_TCAM_ACTION_MAX_LEN], SOC_SAND_SUCCESS_FAILURE *success)
{
    uint32 res = 0;
    uint8   elk_data[SOC_DPP_TCAM_ACTION_ELK_KBP_MAX_LEN_BYTES] = {0};
    uint8   elk_mask[SOC_DPP_TCAM_ACTION_ELK_KBP_MAX_LEN_BYTES] = {0};
  ...
  )
{
    ...
    if (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) {
        ...
        if ((fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_EXTENDED_DATABASES)) {
            ...
            if ((fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_DBAL)) {
                if ((fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_HANDLE_ENTRIES_BY_KEY)) {                    
                  ...
                  arad_pp_dbal_table_physical_db_get(unit, fp_database_info.internal_table_id, &physical_db_type);
                  
                  if (physical_db_type == SOC_DPP_DBAL_PHYSICAL_DB_TYPE_LEM) {
                      ARAD_PP_LEM_ACCESS_PAYLOAD lem_payload;
                      uint32 field_val = 0;
                      ARAD_PP_LEM_ACCESS_PAYLOAD_clear(&lem_payload);
                      lem_payload.dest = action.value[0] & 0x7ffff; /*19 bit of the destination */
                      lem_payload.asd = action.value[1] & 0x1fffff; /* 24 bit of the asd */
                      /* getting the is_dynamic and sa_drop fields, the 19 bit offset change is because we are counting only from the asd, the 19 bit of the destination is in param0*/
                      soc_sand_bitstream_get_any_field(&(action.value[1]), SOC_DPP_DEFS_GET(unit, lem_is_dynamic_lsb) - 19, 1, &field_val);
                      lem_payload.is_dynamic = field_val;
                      soc_sand_bitstream_get_any_field(&(action.value[1]), SOC_DPP_DEFS_GET(unit, lem_sa_drop_lsb) - 19, 1, &field_val);
                      lem_payload.sa_drop = field_val;

                      lem_payload.has_cw = (action.value[1] >> 21) & 0x1;
                      lem_payload.tpid_profile = (action.value[1] >> 20) & 0x1;
                      lem_payload.is_learn_data = 0x0;      /* No. The meaning is the learned payload is from the in-lif table of the in- lif*/
                      lem_payload.flags = ARAD_PP_LEM_ACCESS_ASD_OUTLIF;
                      lem_payload.age = 0;
                      res = arad_pp_dbal_entry_add(unit, fp_database_info.internal_table_id, (SOC_PPC_FP_QUAL_VAL*)(info->qual_vals), info->priority, (void *)(&lem_payload), success);
                    } else{
                ...
                if (stage == SOC_PPC_FP_DATABASE_STAGE_INGRESS_FLP) {
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
                    res = arad_pp_frwrd_ip_tcam_kbp_tcam_entry_add(unit, (ARAD_KBP_ACL_TABLE_ID_OFFSET + db_id_ndx), entry_id_ndx, info->is_for_update,
                                                                   info->priority, entry.value, entry.mask, action.value, success);                    
                    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
#else /* INCLUDE_KBP */      
                  ...
                  /* Add entry to internal TCAM (ACL) */                    
                    ...
                    res = arad_tcam_managed_db_entry_add_unsafe(
                       ...
                       tcam_db_id,
                       entry_id_ndx,
                       (fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_SINGLE_BANK),
                       info->priority,
                       &entry,
                       &action,
                       success
  ...
  )
{
  ...
  ARAD_PP_FP_DATABASE_INFO
    fp_database_info;
  ARAD_PP_FP_ACTION_TYPE
    fp_action_type[ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX];
  uint32
    action_type_ndx;
  uint8
    is_found;
  ARAD_PP_FP_ENTRY_INFO
    entry_info;
  ARAD_FP_DATABASE_STAGE
      stage;
  ...
  res = ARAD_PP_FP_ENTRY_INFO_verify(unit, info, stage);
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
  ...
  if ((fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_TCAM)
        && (fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_FLP)
        && (fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_DIRECT_TABLE)
        && (fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_EGRESS))
  {
  ...
  sal_memcpy(&entry_info, info, sizeof(ARAD_PP_FP_ENTRY_INFO)); 
  ...
  if((is_found && !(info->is_for_update)) 
...
STATIC uint32
  arad_pp_fp_direct_table_entry_get(int unit, ARAD_FP_DATABASE_STAGE stage, uint32 db_id_ndx, uint32 entry_id_ndx, ARAD_PP_FP_ENTRY_INFO* info, uint8* is_found, uint32 value_in[ARAD_PP_FP_TCAM_ENTRY_SIZE], uint32 mask_in[ARAD_PP_FP_TCAM_ENTRY_SIZE], ARAD_TCAM_ACTION* action)
{
  uint32
     res = SOC_SAND_OK,
     entry_ndx_dt,
  ...
  SHR_BITCOPY_RANGE(value_in, 0, &entry_dt_first, 0, 10);
  SHR_BITCOPY_RANGE(mask_in, 0, &is_dt_bit_meaningful, 0, 10);
  ...
  if (bank_ndx >= SOC_DPP_DEFS_GET_TCAM_NOF_BANKS(unit)) {
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_NOF_DBS_PER_BANK_OUT_OF_RANGE_ERR, 25, exit);
  }
  ...
  )
{
  ...
  *is_found = FALSE;
  ...
  if (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) {
    ...
    ARAD_PP_FP_ENTRY_INFO_clear(info);
    ...
    if (is_fp_db_extended_fwrd) {
      ...
      tcam_key_type = ARAD_IP_TCAM_FROM_KBP_FRWRD_IP_TBL_ID(tcam_db_id);
    } else
#endif
    {
      if (is_vt_match) {
        tcam_db_id = (ARAD_PP_ISEM_ACCESS_VT_CLASSIFICATIONS_TCAM_BASE + fp_database_info.internal_table_id);
        tcam_key_type = ARAD_IP_NOF_TCAM_ENTRY_TYPES;
      } else {
...
STATIC uint32
  arad_pp_fp_direct_table_entry_remove(int unit, ARAD_FP_DATABASE_STAGE stage, uint32 db_id_ndx, uint32 entry_id_ndx, ARAD_PP_FP_ENTRY_INFO* entry_info, uint8* found)
{
  uint32
     res = SOC_SAND_OK,
     entry_ndx_dt,
  ...
  res = arad_pp_fp_action_value_to_buffer(unit, entry_info->actions, db_id_ndx, action.value);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  ARAD_FP_DATABASE_STAGE    stage;
  ARAD_PP_FP_ENTRY_INFO     entry_info;
    ...
    if (ARAD_IP_TCAM_ENTRY_TYPE_IS_KBP(tcam_key_type)) {
        if (is_sw_remove_only) {
            ARAD_SW_KBP_HANDLE location;
             ...
             res = sw_state_access[unit].dpp.soc.arad.tm.kbp_frwrd_ip.location_tbl.set(unit, entry_id_ndx, &location);             
        }else{
...
#endif
  {
    if (fp_database_info.flags & SOC_PPC_FP_DATABASE_INFO_FLAGS_USE_DBAL) {
      ...
      /* Get the entry info */
      ARAD_PP_FP_ENTRY_INFO_clear(&entry_info);
      ...
      if (found) {
        if (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) {
          ...
          SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
            ...
            /* Remove entry */
            res = arad_tcam_managed_db_entry_remove_unsafe(unit, tcam_db_id, entry_id_ndx );
  ...
  if (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_DIRECT_TABLE) {
    if (0 == fp_entry.nof_db_entries) {
      ...
      /* if bank allocation failed */
      if (SOC_SAND_SUCCESS != success) {
        SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_NOF_DBS_PER_BANK_OUT_OF_RANGE_ERR, 90, exit);
      }
    }
  }
  ...
  )
{
  ...
  SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
    ...
    for (entry_ndx = block_range->iter; entry_ndx < block_range->iter + block_range->entries_to_scan; ++entry_ndx)
    {
      ...
      ARAD_PP_FP_ENTRY_INFO_clear(&entries[nof_valid_entries]);
      res = arad_pp_fp_entry_get_unsafe(
              unit,
              db_id_ndx,
              entry_ndx,
  ...
  )
{
  ...
  ARAD_FP_DATABASE_STAGE
      stage; 
  ARAD_PP_FP_QUAL_TYPE         
      qual_types[ARAD_PP_FP_NOF_QUALS_PER_DB_MAX];
  ARAD_PP_FP_CE_CONSTRAINT     
      *ce_const = NULL;
  ARAD_PP_FP_ACTION_TYPE
    fp_action_type[ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX];
  ...
  if ( (!is_large_direct_extraction) && (!use_fes)) {
      ...
      *success = SOC_SAND_SUCCESS;
      ...
      for (qual_type_ndx = 0; qual_type_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; qual_type_ndx++) {
          qual_types[qual_type_ndx] = (qual_type_ndx < ARAD_PP_FP_DIR_EXTR_MAX_NOF_FIELDS)? 
              info->actions[0].fld_ext[qual_type_ndx].type: ARAD_PP_NOF_FP_QUAL_TYPES;
      }
      ...
      for (pmf_pgm_ndx = pmf_pgm_ndx_min; pmf_pgm_ndx < pmf_pgm_ndx_max; ++pmf_pgm_ndx)
      {
          ...
          if (is_large_direct_extraction) {
            ...
            LOG_ERROR(BSL_LS_SOC_FP,
             ...
             SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 200, exit);
              ...
              action_const.tcam_res_id[1] += info->actions[0].fld_ext[0].fld_lsb + sw_db_ce.lsb; /*Add the number of lost bits to action offset*/
          }
          ...
          if (info->qual_vals[0].type != ARAD_PP_NOF_FP_QUAL_TYPES) {
  ...
  )
{
  ...
  uint8
    ...
    is_fes,
    is_found;
  ARAD_PP_FP_DIR_EXTR_ENTRY_INFO
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);
  if (fp_database_info.db_type != ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION)
  {
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 22, exit);
  res = ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_verify(unit, info, ARAD_FP_DATABASE_STAGE_INGRESS_PMF, is_large_direct_extraction);
   ...
   */
  if (!is_large_direct_extraction) {
      ARAD_ALLOC(dir_extr_entry_info, ARAD_PP_FP_DIR_EXTR_ENTRY_INFO, 1, "arad_pp_fp_direct_extraction_entry_add_verify.dir_extr_entry_info");
      ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_clear(dir_extr_entry_info);
  ...
  )
{
  ...
  *is_fes = FALSE;
  ...
  ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_clear(info);
    ...
    for (cycle_ndx = 0; (cycle_ndx < ARAD_PMF_NOF_CYCLES) && (fes_is_found == FALSE); ++cycle_ndx)
    {
     ...
     if (fes_is_found) {
       ...
       *is_fes = TRUE;
         ...
         */ 
        /* Set the qual type array */
        for (qual_type_ndx = 0; qual_type_ndx < ARAD_PP_FP_DIR_EXTR_MAX_NOF_FIELDS; qual_type_ndx++) {
  ...
  )
{
  ...
  ARAD_ALLOC(dir_extr_entry_info, ARAD_PP_FP_DIR_EXTR_ENTRY_INFO, 1, "arad_pp_fp_direct_extraction_entry_remove_unsafe.dir_extr_entry_info");
  ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_clear(dir_extr_entry_info);
  res = arad_pp_fp_direct_extraction_entry_get_unsafe(
          unit,
          db_id_ndx,
  ...
  )
{
  ...
  ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_clear(entries);
  ...
  )
{
    ...
    *block = MEM_BLOCK_ANY;
    ...
    switch (control_type) {
    case ARAD_PP_FP_CONTROL_TYPE_EGR_PP_PORT_DATA:
        port_table = EGQ_PP_PPCTm;
        break;
    case ARAD_PP_FP_CONTROL_TYPE_EGR_TM_PORT_DATA:
        port_table = EGQ_PPCTm;
        break;
    case ARAD_PP_FP_CONTROL_TYPE_FLP_PP_PORT_DATA:
        ...
        break;
    case ARAD_PP_FP_CONTROL_TYPE_ING_PP_PORT_DATA:
        if(SOC_IS_JERICHO(unit)) {
        ...
        break;
    case ARAD_PP_FP_CONTROL_TYPE_ING_TM_PORT_DATA:
  ...
  )
{
  ...
  *success = SOC_SAND_SUCCESS;
  ...
  {
  case ARAD_PP_FP_CONTROL_TYPE_L4OPS_RANGE:
  ...
  case ARAD_PP_FP_CONTROL_TYPE_ING_TM_PORT_DATA:
      ...
      res = soc_mem_write(unit, port_table, block, control_ndx->val_ndx, tbl_data);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 18, exit);
    break;

  case ARAD_PP_FP_CONTROL_TYPE_ACE_POINTER_PP_PORT:
      sal_memset(tbl_data, 0x0, ARAD_PP_FP_KEY_GEN_VAR_MAX_IN_LONGS * sizeof(uint32));
      /* Set / get the table field */
      ...
      res = soc_mem_write(unit, EPNI_ACE_TABLEm, MEM_BLOCK_ANY, control_ndx->val_ndx / ARAD_PP_FP_NOF_ACE_POINTERS_IN_LINE_PRGE_VAR, tbl_data);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 34, exit);
    break;

  case ARAD_PP_FP_CONTROL_TYPE_PACKET_SIZE_RANGE:
  ...
  case ARAD_PP_FP_CONTROL_TYPE_OUT_LIF_RANGE:
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  45,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, IHB_OUT_LIF_RANGEr, SOC_CORE_ALL,  control_ndx->val_ndx, OUT_LIF_RANGE_MIN_Nf,  info->val[0]));
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  47,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, IHB_OUT_LIF_RANGEr, SOC_CORE_ALL,  control_ndx->val_ndx, OUT_LIF_RANGE_MAX_Bf,  info->val[1]));
    break;

  case ARAD_PP_FP_CONTROL_TYPE_INNER_ETH_NOF_VLAN_TAGS:
  ...
  case ARAD_PP_FP_CONTROL_TYPE_KEY_CHANGE_SIZE:
    ...
    break;
  case ARAD_PP_FP_CONTROL_TYPE_EGRESS_DP:
    break;
  case ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF:
    ...
    if (control_ndx->db_id == 0) {
        ARAD_FP_DATABASE_STAGE stage = info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_STAGE_NDX];
        /* 
         * instruction is built according to offset+size from packet headers
         */
        switch (info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_SUB_HEADER_NDX])
        {
        case ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_0:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_0;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_1:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_1;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_2:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_2;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_3:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_3;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_4:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_4;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_5:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_5;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_FWD:
          base_header_type = ARAD_PMF_CE_SUB_HEADER_FWD;
          break;
        case ARAD_PP_FP_BASE_HEADER_TYPE_FWD_POST:
        ...
        qual_info.header_qual_info.qual_type = ARAD_PP_FP_QUAL_HDR_USER_DEF_0 + control_ndx->val_ndx;
        qual_info.header_qual_info.header_ndx_0 = base_header_type;
        if(info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] & ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_FLAG_NEGATIVE) {
            qual_info.header_qual_info.msb =  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] & (~ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_FLAG_NEGATIVE);/* gives the positive value*/
            qual_info.header_qual_info.msb *= -1;
        } else {
            qual_info.header_qual_info.msb =  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX];
        }
        qual_info.header_qual_info.lsb = qual_info.header_qual_info.msb
                                   + info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] - 1;
        qual_info.stage = stage;
    } else {
        /* 
         * instruction is built by taking some of the bits of a defined qualifier
         */
        ARAD_PP_FP_QUAL_TYPE     qual_type = info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_PARTIAL_QUAL_NDX];
        if (qual_type >= ARAD_PP_NOF_FP_QUAL_TYPES) {
            ...
            if (is_found) {
                ...
                qual_info.is_header_qual = 1;
                qual_info.header_qual_info.lsb -= info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX];
                qual_info.header_qual_info.msb = qual_info.header_qual_info.lsb - info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] + 1;
                ...
                for (index=0; index < 2; ++index) {
                    if (qual_info.irpp_qual_info[index].info.qual_nof_bits) {
                        qual_info.irpp_qual_info[index].info.buffer_lsb += info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX];
                        if (info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] + info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] >
                            qual_info.irpp_qual_info[index].info.qual_nof_bits) {
                            SOC_SAND_CHECK_FUNC_RESULT(res, 92, exit);
                        }
                        qual_info.irpp_qual_info[index].info.qual_nof_bits = info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX];
                    }
                }
  ...
  case SOC_PPC_FP_CONTROL_TYPE_KBP_CACHE:
    /* set KBP cache value */
    res = sw_state_access[unit].dpp.soc.arad.tm.kbp_frwrd_ip.kbp_cache_mode.set(unit, info->val[0]);
    SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 150, exit);
    break;
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FP_CONTROL_INDEX, control_ndx, 10, exit);
  res = ARAD_PP_FP_CONTROL_INFO_verify(
          unit,
          control_ndx->type,
          info
        );
  ...
  )
{
  ...
  ARAD_PP_FP_CONTROL_INFO_clear(info);
  ...
  case ARAD_PP_FP_CONTROL_TYPE_PACKET_SIZE_RANGE:
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  40,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, IHB_PACKET_HEADER_SIZE_RANGEr, SOC_CORE_ALL,  control_ndx->val_ndx, PKT_HDR_SIZE_RANGE_LOW_Nf, &info->val[0]));
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  42,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, IHB_PACKET_HEADER_SIZE_RANGEr, SOC_CORE_ALL,  control_ndx->val_ndx, PKT_HDR_SIZE_RANGE_HIGH_Nf, &info->val[1]));
    info->val[0] ++;
    info->val[1] ++;
    break;

  case ARAD_PP_FP_CONTROL_TYPE_OUT_LIF_RANGE:
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  45,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, IHB_OUT_LIF_RANGEr, SOC_CORE_ALL,  control_ndx->val_ndx, OUT_LIF_RANGE_MIN_Nf, &info->val[0]));
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  47,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, IHB_OUT_LIF_RANGEr, SOC_CORE_ALL,  control_ndx->val_ndx, OUT_LIF_RANGE_MAX_Bf, &info->val[1]));
    break;
  case ARAD_PP_FP_CONTROL_TYPE_INNER_ETH_NOF_VLAN_TAGS:
  ...
  case ARAD_PP_FP_CONTROL_TYPE_KEY_CHANGE_SIZE:
    res = sw_state_access[unit].dpp.soc.arad.tm.pmf.fp_info.key_change_size.get(unit, ARAD_FP_DATABASE_STAGE_INGRESS_PMF, &key_change_size);
  ...
  case ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF:
    ...
    res = sw_state_access[unit].dpp.soc.arad.tm.pmf.fp_info.udf.get(
            unit,
            ARAD_FP_DATABASE_STAGE_INGRESS_PMF, /* Take any stage since all are set similarly */
            control_ndx->val_ndx,
            &qual_info
          );
    SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 86, exit);
      ...
      if (SOC_PPC_FP_IS_QUAL_TYPE_USER_DEFINED(qual_info.header_qual_info.qual_type)) {
          ...
          case ARAD_PMF_CE_SUB_HEADER_0:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_0;
            break;
          case ARAD_PMF_CE_SUB_HEADER_1:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_1;
            break;
          case ARAD_PMF_CE_SUB_HEADER_2:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_2;
            break;
          case ARAD_PMF_CE_SUB_HEADER_3:
            base_header_type = ARAD_PMF_CE_SUB_HEADER_3;
            break;
          case ARAD_PMF_CE_SUB_HEADER_4:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_4;
            break;
          case ARAD_PMF_CE_SUB_HEADER_5:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_HEADER_5;
            break;
          case ARAD_PMF_CE_SUB_HEADER_FWD:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_FWD;
            break;
          case ARAD_PMF_CE_SUB_HEADER_FWD_POST:
            base_header_type = ARAD_PP_FP_BASE_HEADER_TYPE_FWD_POST;
            break;
          default:
            SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_VAL_NDX_OUT_OF_RANGE_ERR, 82, exit);
          }
          info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_SUB_HEADER_NDX] = base_header_type;
          if(qual_info.header_qual_info.msb >= 0) {
              info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] = qual_info.header_qual_info.msb;
          } else {
              info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] = (-qual_info.header_qual_info.msb) | ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_FLAG_NEGATIVE;
          }
          info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] = (uint32)(qual_info.header_qual_info.lsb - qual_info.header_qual_info.msb) + 1;
      } else {
          uint8 is_found;
          uint8 is_found_lsb;
          ARAD_FP_DATABASE_STAGE stage = qual_info.stage;
          if (qual_info.is_header_qual) {
              ...
              if (!is_found) {
                  ...
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_PARTIAL_QUAL_NDX] = qual_info.header_qual_info.qual_type;
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] = header_qual_info.lsb - qual_info.header_qual_info.lsb;
                /* Here we are always with positive offset. */
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] = qual_info.header_qual_info.lsb - qual_info.header_qual_info.msb + 1;
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_SUB_HEADER_NDX] = ARAD_NOF_PMF_CE_SUB_HEADERS;
              }
          } else {
              ...
              if (is_found) {
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_PARTIAL_QUAL_NDX] = qual_info.irpp_qual_info[1].info.irpp_field;
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] = qual_info.irpp_qual_info[1].info.buffer_lsb - irpp_qual_info.info.buffer_lsb;
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] = qual_info.irpp_qual_info[1].info.qual_nof_bits;
              }
              else {
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_PARTIAL_QUAL_NDX] = qual_info.irpp_qual_info[0].info.irpp_field;
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_OFFSET_NDX] = qual_info.irpp_qual_info[0].info.buffer_lsb - irpp_qual_info.info.buffer_lsb;
                  info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_NOF_BITS_NDX] = qual_info.irpp_qual_info[0].info.qual_nof_bits;
              }
              info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_SUB_HEADER_NDX] = ARAD_NOF_PMF_CE_SUB_HEADERS;
          }
          info->val[ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_STAGE_NDX] = qual_info.stage;
  ...
  case SOC_PPC_FP_CONTROL_TYPE_KBP_CACHE:
    {
        uint8 val;
        /* set KBP cache value */
        res = sw_state_access[unit].dpp.soc.arad.tm.kbp_frwrd_ip.kbp_cache_mode.get(unit, &val);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(fwd_type_ndx, ARAD_PP_FP_FWD_TYPE_NDX_MAX, ARAD_PP_FP_FWD_TYPE_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ...
  )
{
    ...
    /* Different behavior for Direct Table database */
    if ((fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_TCAM) || (fp_database_info.db_type == ARAD_PP_FP_DB_TYPE_EGRESS))
    {
  ...
  )
{
...
#endif /* BCM_88660_A0 */
  else /* ARAD_FP_DATABASE_STAGE_INGRESS_FLP */ {
  ...
  /* Get the PMF-Program index, assumption of a single program */
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  50,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, selected_pgm, REG_PORT_ANY, 0, selected_pgm_fld, &pmf_progs_bmp));
      for (selected_cam_line_ndx = 0; selected_cam_line_ndx < nof_selected_cam_line_regs; selected_cam_line_ndx++) {
          SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  51 + selected_cam_line_ndx,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field_read(unit, selected_cam_line[selected_cam_line_ndx], REG_PORT_ANY, 0, selected_cam_line_fld[selected_cam_line_ndx], &pfg_bmp[selected_cam_line_ndx]));
      }
  }
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  53,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, selected_pgm, REG_PORT_ANY, 0, selected_pgm_fld, &pmf_progs_bmp));
  fld_val = (1 << soc_reg_field_length(unit, selected_pgm, selected_pgm_fld)) - 1; /* field all ones to invalidate it */
#ifdef ARAD_PP_FP_DIAG_LAST_PACKET_RESET_DBG_PMF
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  54,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, selected_pgm, REG_PORT_ANY, 0, selected_pgm_fld,  fld_val)); 
#endif /* ARAD_PP_FP_DIAG_LAST_PACKET_RESET_DBG_PMF */
  for (selected_cam_line_ndx = 0; selected_cam_line_ndx < nof_selected_cam_line_regs; selected_cam_line_ndx++) {
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  55 + selected_cam_line_ndx,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field_read(unit, selected_cam_line[selected_cam_line_ndx], REG_PORT_ANY, 0, selected_cam_line_fld[selected_cam_line_ndx], &pfg_bmp[selected_cam_line_ndx]));
  }
...
uint32
  arad_pp_fp_packet_diag_buffer_to_value_get_unsafe(
    ...
    SOC_SAND_INOUT ARAD_PP_FP_PACKET_DIAG_INFO *info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_ALLOC(qual_vals_out, ARAD_PP_FP_QUAL_VAL, SOC_PPC_FP_NOF_QUALS_PER_DB_MAX, "arad_pp_fp_packet_diag_get_unsafe.qual_vals_out");
  res = arad_pp_fp_key_buffer_to_value(unit, stage, db_id_ndx, data_in, mask_in, qual_vals_out);
  SOC_SAND_CHECK_FUNC_RESULT(res, 180, exit);
  for(qual_index = 0; qual_index < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX ; ++qual_index) {
  ...
  )
{
  uint32
    ...
    res = SOC_SAND_OK;
  ARAD_PP_DIAG_RECEIVED_PACKET_INFO
    rcvd_pkt_info;
  ...
  ARAD_PP_EGQ_PMF_PROGRAM_SELECTION_CAM_TBL_DATA 
      egress_pmf_cam;
  uint32
    egress_pmf_cam_data[SOC_DPP_DEFS_MAX(IHB_PMF_PROGRAM_SELECTION_CAM_NOF_LONGS)];
  ARAD_PP_EGQ_PP_PPCT_TBL_DATA
    egq_pp_ppct_tbl;
  ARAD_EGQ_PPCT_TBL_DATA
    egq_ppct_tbl;
  ARAD_PMF_PGM_PKT_HDR_TYPE
    hdr_type = ARAD_PMF_PGM_NOF_PKT_HDR_TYPES;
  uint8
    cycle_db_id,
      is_320b,
    is_found;
  ...
  ARAD_PMF_FEM_INPUT_INFO
    fem_input_info;
  ARAD_PP_FP_DIR_EXTR_ACTION_VAL
    *dir_extr_action_val = NULL;
  ARAD_PP_FP_QUAL_VAL
    qual_val;
  soc_reg_above_64_val_t
      last_fes,
      key_built[ARAD_PP_FP_NOF_CYCLES][ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_ALL_STAGES + 1];
  const static soc_mem_t
    ihb_pmf_pass_lookup[ARAD_PP_FP_NOF_CYCLES] = {IHB_PMF_PASS_1_LOOKUPm, IHB_PMF_PASS_2_LOOKUPm};
  ...
  const static
      ARAD_PP_FP_ACTION_TYPE
        flp_action_types[SOC_PPC_FP_NOF_INGRESS_FLP_ACTIONS] = {
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_DIAG_GET_UNSAFE);
  ...
  ARAD_PP_FP_PACKET_DIAG_INFO_clear(info);
  ...
  for (stage_ndx = 0; stage_ndx < nof_stages; stage_ndx++) {
      ...
      db_id_curr = 0;
      stage = (stage_ndx == 0)? ARAD_FP_DATABASE_STAGE_INGRESS_FLP: ARAD_FP_DATABASE_STAGE_INGRESS_SLB; 
      ...
      for (db_id_ndx = 0; db_id_ndx < ARAD_PP_FP_NOF_DBS; ++db_id_ndx)
      {
        ...
        else { /* ARAD_FP_DATABASE_STAGE_INGRESS_SLB */
      ...
      if (stage == ARAD_FP_DATABASE_STAGE_INGRESS_SLB) {
          /* No action */
          continue;
      }
      /* 
       ...
       */
      sal_memset(val, 0x0, ARAD_PP_DIAG_DBG_VAL_LEN * 4);
      ARAD_PP_FP_DIAG_FLD_FILL(&reg_fld, reg_fld_egw2flp_result);
      res = arad_pp_diag_dbg_val_get_unsafe(
              unit,
              core_id,
              SOC_IS_JERICHO(unit)? ARAD_IHP_ID: ARAD_IHB_ID,
      ...
      action_curr = 0;
      for (action_ndx = 0; action_ndx < SOC_PPC_FP_NOF_INGRESS_FLP_ACTIONS; action_ndx++) {
          /* Get the value */
          res = arad_pmf_db_fes_action_size_get_unsafe(
                    unit,
...
exit_ingress_pmf:
  ...
  for (hdr_type_ndx = 0; hdr_type_ndx < ARAD_PMF_PGM_NOF_PKT_HDR_TYPES; hdr_type_ndx++)
  {
    hdr_type = 1 << hdr_type_ndx;
    res = arad_pmf_pgm_packet_format_code_convert(
            unit,
            hdr_type,
            &pfc
          );
  ...
  {
      for (cycle_ndx = 0; cycle_ndx < ARAD_PP_FP_NOF_CYCLES; ++cycle_ndx)
      {
  ...
  for (cycle_ndx = 0; cycle_ndx < ARAD_PP_FP_NOF_CYCLES; ++cycle_ndx)
  {
    ...
    for (key_ndx = 0; key_ndx < ARAD_PMF_LOW_LEVEL_NOF_KEYS; ++key_ndx)
    {
        access_profile_id = soc_mem_field32_get(unit, ihb_pmf_pass_lookup[cycle_ndx], &tbl_data, fields[key_ndx]);
        ...
        /* for (pd_ndx = 0; pd_ndx < ARAD_PP_FP_NOF_PDS; ++pd_ndx) */
        {
            ...
            if (access_profile_id == val[0]) {
                ...
                /* Copy the LSB key */
                nof_bits_lsb = 0;
                if (SOC_IS_JERICHO(unit)? (reg_fld_key_sent_jericho[pd_ndx][1][0] != 0): (reg_fld_key_sent_arad[pd_ndx][1][0] != 0)) {
                    /* LSB signal exists */
                    sal_memset(val, 0x0, ARAD_PP_DIAG_DBG_VAL_LEN * 4);
                ...
                if (action_found[pd_ndx][0] != 0) { 
                    /* Entry matched */
                    nof_bits_lsb = 0;
                    if (SOC_IS_JERICHO(unit)? (reg_fld_action_jericho[pd_ndx][1][0] != 0): (reg_fld_action_arad[pd_ndx][1][0] != 0)) {
                        /* LSB signal exists */
                        sal_memset(val, 0x0, ARAD_PP_DIAG_DBG_VAL_LEN * 4);
  ...
  for (db_id_ndx = 0; db_id_ndx < ARAD_PP_FP_NOF_DBS; ++db_id_ndx)
  {
    ...
    for (key_id = 0; key_id < 2; key_id++) {
        ...
        access_profile_id = soc_mem_field32_get(unit, ihb_pmf_pass_lookup[cycle_db_id], &tbl_data, fields[key_ndx]);
        for (pd_ndx = 0; pd_ndx < ARAD_PP_FP_NOF_PDS; ++pd_ndx)
        {
            if (action_found[pd_ndx][1] == access_profile_id) {
                ...
                if (action_found[pd_ndx][0]) {
                    ...
                    if (key_id)
                    {
                      for (ind = 0; ind < ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX; ++ind) {
                        if (info->tcam[cycle_ndx][bank_ndx].actions[ind].type == ARAD_PP_FP_ACTION_TYPE_CHANGE_KEY)
                        {
  ...
  for (cycle_ndx = 0; cycle_ndx < ARAD_PMF_NOF_CYCLES; ++cycle_ndx)
  {
      for (fem_macro_ndx = 0; fem_macro_ndx < SOC_PPC_FP_NOF_MACRO_SIMPLES; ++fem_macro_ndx)
      {
          ...
          if (fes_info.is_used == TRUE) {
              ...
              res = READ_IHB_DBG_LAST_FESm(unit, MEM_BLOCK_ANY, fes_ndx, last_fes);
              SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 300, exit);
  ...
  ARAD_ALLOC(dir_extr_action_val, ARAD_PP_FP_DIR_EXTR_ACTION_VAL, 1, "arad_pp_fp_packet_diag_get_unsafe.dir_extr_action_val")
  /* using the macro SOC_DPP_DEFS_MAX can compare definitions of the same value */
  /* coverity[same_on_both_sides] */
  for (cycle_ndx = 0; cycle_ndx < ARAD_PMF_NOF_CYCLES; ++cycle_ndx)
  {
    for (fem_macro_ndx = 0; fem_macro_ndx < ARAD_PP_FP_NOF_MACROS; ++fem_macro_ndx)
    {
      /*
       * Get the source
       */
      ARAD_PMF_FEM_INPUT_INFO_clear(&fem_input_info);
      fes_ndx = fem_macro_ndx + (cycle_ndx * ARAD_PP_FP_NOF_MACROS);
      ...
      SOC_SAND_CHECK_FUNC_RESULT(res, 330, exit);
       ...
       /* Read the table and see which action has been done */
      res = READ_IHB_DBG_LAST_FEMm(unit, MEM_BLOCK_ANY, fes_ndx, last_fes);
      ...
      if (((soc_IHB_DBG_LAST_FEMm_field32_get(unit, last_fes, IN_PROGRAMf) != ARAD_PMF_FEM_PGM_FOR_ETH) &&
          (soc_IHB_DBG_LAST_FEMm_field32_get(unit, last_fes, IN_PROGRAMf) != ARAD_PMF_FEM_PGM_FOR_TM))
      ...
      fem_ndx.id = fes_ndx;
      ARAD_PP_FP_FEM_ENTRY_clear(&fem_entry);
      ARAD_PP_FP_DIR_EXTR_ACTION_VAL_clear(dir_extr_action_val);
      ARAD_PP_FP_QUAL_VAL_clear(&qual_val);
      res = arad_pp_fp_fem_configuration_de_get(
              unit,
              fem_macro_ndx,
              cycle_ndx,
      ...
      if (fem_entry.is_for_entry == TRUE)
      {
        ...
        if (qual_val.type != ARAD_PP_NOF_FP_QUAL_TYPES) {
      ...
      {
          /* Invalid action */
        info->macro[cycle_ndx][fem_macro_ndx].action.type = ARAD_PP_FP_ACTION_TYPE_NOP;
...
exit_egress:
   ...
   */
  stage = ARAD_FP_DATABASE_STAGE_EGRESS;
  ...
  for (pfg_ndx = 0; pfg_ndx < ARAD_PMF_NOF_LINES; pfg_ndx++) {
      ...
      res = READ_EGQ_PMF_PROGRAM_SELECTION_CAMm(unit, MEM_BLOCK_ANY, pfg_ndx, val);
  ...
  )
{
  ...
  ARAD_PP_FP_RESOURCE_DIAG_INFO_clear(info);
  ...
  )
{
  uint32
    ...
    *bank_db_prefix = NULL,
    ...
    action_lsbs[SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX+1],
    action_lengths[SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX+1],
    /* key_cur_loc will be 2 dimensions array of [ARAD_PP_FP_NOF_DBS][ARAD_PP_FP_KEY_NOF_ZONES].
   ...
   */
  for(db_idx = 0; db_idx < ARAD_PP_FP_NOF_DBS; db_idx++)
  {
    ...
    if(info->db[db_idx].valid)
    {
      ...
      sal_memset(&fp_db_info, 0x0, sizeof(ARAD_PP_FP_DATABASE_INFO));
      ...
      if(info->db[db_idx].type == SOC_PPC_FP_DB_TYPE_TCAM 
         || info->db[db_idx].type == SOC_PPC_FP_DB_TYPE_DIRECT_TABLE
      ...
      for(bank_id = 0; bank_id < SOC_DPP_DEFS_GET_TCAM_NOF_BANKS(unit); bank_id++)
      {
           ...
           || is_used)
        {
          ...
          {
            SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_NOF_DBS_PER_BANK_OUT_OF_RANGE_ERR, 70, exit);
          }
      ...
      {
        info->db[db_idx].key_size = SOC_DPP_DEFS_GET(unit, tcam_big_bank_key_nof_bits);
      }
      else if(info->db[db_idx].type == SOC_PPC_FP_DB_TYPE_DIRECT_EXTRACTION)
      {
        info->db[db_idx].key_size = ARAD_PP_FP_DB_TYPE_TCAM_KEY_MAX_LENGTH_DIRECT_EXTRACTION;
      }
       ...
       */
      for (action_idx = 0; action_idx < ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX; action_idx++) 
      {
          if(fp_db_info.action_types[action_idx] == ARAD_PP_FP_ACTION_TYPE_CHANGE_KEY) 
          {
              info->db[db_idx].db_tcam.action[action_idx].valid = 1;
              info->db[db_idx].db_tcam.action[action_idx].action_type = ARAD_PP_FP_ACTION_TYPE_CHANGE_KEY;
  ...
  ARAD_ALLOC(key_cur_loc, uint32, ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES * SOC_PPC_NOF_FP_DATABASE_STAGES, "arad_pp_fp_resource_diag_get_unsafe.key_cur_loc");
  sal_memset(key_cur_loc, 0x0, sizeof(uint32) * ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES * SOC_PPC_NOF_FP_DATABASE_STAGES);
  ...
  for(db_idx = 0; db_idx < ARAD_PP_FP_NOF_DBS; db_idx++)
  {
      ...
      for(stage = 0; stage < SOC_PPC_NOF_FP_DATABASE_STAGES; stage++)
      {
        ...
        key_cur_loc[(stage * ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES) + (db_idx * ARAD_PP_FP_KEY_NOF_ZONES) + ARAD_PP_FP_KEY_ZONE_MSB_0] = msb_loc;
        key_cur_loc[(stage * ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES) + (db_idx * ARAD_PP_FP_KEY_NOF_ZONES) + ARAD_PP_FP_KEY_ZONE_MSB_1] = msb_loc;
      }
  }
          ...
          for(lsb_msb = 0; lsb_msb < ARAD_PMF_LOW_LEVEL_NOF_LSB_MSB; lsb_msb++)
          {
            for(ce_idx = 0; ce_idx < ARAD_PMF_LOW_LEVEL_NOF_CE_IN_PROG_LSB; ce_idx++)
            {
              ...
              if(pgm_ce.is_used)
              {
                  ...
                  if(mode >= ARAD_PP_FP_RESOURCE_MODE_WITH_AVAILABLE_RESOURCES) {
                    ...
                    info->available.key[stage][pgm_idx][cycle_idx][pmf_db_info.used_key[pgm_idx][key_idx]].is_lsb_db =
                          info->db[pgm_ce.db_id].type == ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION ? ( (key_rsrc >> (key_idx *2)) & 0x1 ) : TRUE;
                    info->available.key[stage][pgm_idx][cycle_idx][pmf_db_info.used_key[pgm_idx][key_idx]].is_msb_db =
                          info->db[pgm_ce.db_id].type == ARAD_PP_FP_DB_TYPE_DIRECT_EXTRACTION ? ( (key_rsrc >> (key_idx *2)) & 0x2 ) : pgm_ce.is_msb;
                }
                ...
                diag_db_key[pgm_ce.db_id].key_qual[diag_db_key[pgm_ce.db_id].nof_ces].key_loc.lsb = key_cur_loc[(stage * ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES) + (pgm_ce.db_id * ARAD_PP_FP_KEY_NOF_ZONES) + key_idx]; 
                diag_db_key[pgm_ce.db_id].key_qual[diag_db_key[pgm_ce.db_id].nof_ces].key_loc.msb = key_cur_loc[(stage * ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES) + (pgm_ce.db_id * ARAD_PP_FP_KEY_NOF_ZONES) + key_idx] + pgm_ce.msb; 
                key_cur_loc[(stage * ARAD_PP_FP_NOF_DBS * ARAD_PP_FP_KEY_NOF_ZONES) + (pgm_ce.db_id * ARAD_PP_FP_KEY_NOF_ZONES) + key_idx] += pgm_ce.msb + 1;
              ...
              if(diag_db_key_args[pgm_ce.db_id].complete)
              {
                ...
                if(mode >= ARAD_PP_FP_RESOURCE_MODE_DIAG)
                {
                ...
                if(!found)
                {
                  ...
                  if(found)
                  {
                    ...
                    if(irpp_qual_info.info.irpp_field != irpp_field)
                    {
                        ...
                        SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_QUAL_TYPES_END_OF_LIST_ERR, 155, exit);
                    }
  ...
  for(cycle_idx = 0; cycle_idx < ARAD_PMF_LOW_LEVEL_NOF_CYCLES; cycle_idx++)
  {
     ...
     */
    for (is_tm = FALSE; is_tm <= (stage == SOC_PPC_FP_DATABASE_STAGE_INGRESS_PMF && soc_property_get(unit, spn_ITMH_PROGRAMMABLE_MODE_ENABLE, FALSE)); is_tm++) {
    /* Each cycle starts with 16 FESs */
      res = arad_pmf_prog_select_pmf_pgm_borders_get(
                unit,
                stage,
      ...
      for(pgm_idx = pgm_idx_min; pgm_idx < pgm_idx_max; pgm_idx++)
      {
        if(stage == SOC_PPC_FP_DATABASE_STAGE_INGRESS_PMF && mode >= ARAD_PP_FP_RESOURCE_MODE_WITH_AVAILABLE_RESOURCES) {
          info->available.is_used = TRUE;
        ...
        for(fes_group_idx = 0; fes_group_idx < ARAD_PMF_LOW_LEVEL_NOF_FESS_PER_GROUP; fes_group_idx++)
        {
          ...
          if(fes_info.is_used && mode >= ARAD_PP_FP_RESOURCE_MODE_WITH_AVAILABLE_RESOURCES)
          {
            ...
            if(fes_info.is_used && mode >= ARAD_PP_FP_RESOURCE_MODE_DIAG) {
    ...
    for(fem_group_idx = 0; fem_group_idx < SOC_PPC_FP_NOF_MACROS; fem_group_idx++)
    {
         ...
         fem_entry.action_type[0] != SOC_PPC_FP_ACTION_TYPE_INVALID)
      {
            ...
            ARAD_PP_FP_DIR_EXTR_ACTION_VAL_clear(&fem_info);
            res = arad_pp_fp_fem_configuration_de_get(
                    unit,
                    fem_id,
                    cycle_idx,
  ...
  for(db_idx = 0; db_idx < SOC_PPC_FP_NOF_DBS; db_idx++)
  {
    ...
    sal_memset(action_types, 0x0, sizeof(ARAD_PP_FP_ACTION_TYPE) * SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX);
    sal_memset(action_lsbs, 0x0, sizeof(uint32) * (SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX + 1));
    sal_memset(action_lengths, 0x0, sizeof(uint32) * (SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX + 1));
    sal_memset(&fp_db_info, 0x0, sizeof(ARAD_PP_FP_DATABASE_INFO));
    ...
    for(action_idx = 0; action_idx < ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX; action_idx++)
    {
      ...
      {
          info->db[db_idx].db_tcam.action[action_idx].action_type = ARAD_PP_ACTION_TYPE_INVALID;
      }
    ...
    if(SOC_PPC_FP_DB_TYPE_FLP != info->db[db_idx].type) /* internal TCAM specific verification */
    {
        tcam_db_idx = ARAD_PP_FP_DB_ID_TO_TCAM_DB(db_idx);
  ...
  ARAD_ALLOC(pfg_info, ARAD_PP_FP_PFG_INFO, 1, "arad_pp_fp_resource_diag_get_unsafe.pfg_info");
  ...
  for(stage = 0; stage < SOC_PPC_NOF_FP_DATABASE_STAGES; stage++)
  {
    ...
    if(mode >= ARAD_PP_FP_RESOURCE_MODE_WITH_AVAILABLE_RESOURCES) {
      info->available.is_used = TRUE;
      for(pfg_idx = 0; pfg_idx < ARAD_PMF_NOF_GROUPS; ++pfg_idx) {
           ...
           ((ARAD_TCAM_BANK_ENTRY_SIZE_320_BITS == entry_size) && !(bank_id % 2)))
        {
          ...
          for(entry_idx = 0; entry_idx < bank_nof_lines; entry_idx++)
          {
            ...
            if(tcam_entry.valid)
            {
              ...
              if (info->db[ARAD_PP_FP_TCAM_DB_TO_FP_ID(tcam_db_idx)].type != ARAD_PP_FP_DB_TYPE_TCAM){
                  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FP_DB_TYPE_OUT_OF_RANGE_ERR, 385, exit);
              }

              /* Validate this entry is in Occupation Bitmap */
              found = FALSE;
              occ_bm = arad_sw_db_tcam_bank_entries_used_get(
                         unit,
                         bank_id,
                         0
                       );
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_FP_QUAL_TYPES_MAX, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 10, exit);
  ...
  if (qual_length <= 32) {
      ...
      SOC_SAND_ERR_IF_ABOVE_MAX(info->val.arr[0], max_val, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 30, exit);
      SOC_SAND_ERR_IF_ABOVE_MAX(info->is_valid.arr[0], max_val, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 32, exit);
      SOC_SAND_ERR_IF_ABOVE_MAX(info->val.arr[1], 0, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 34, exit);
      SOC_SAND_ERR_IF_ABOVE_MAX(info->is_valid.arr[1], 0, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 36, exit);
  }
  else {
      SOC_SAND_MAX_VAL_FOR_BIT_LEN(max_val, (qual_length - 32));     
      SOC_SAND_ERR_IF_ABOVE_MAX(info->val.arr[1], max_val, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 40, exit);
      SOC_SAND_ERR_IF_ABOVE_MAX(info->is_valid.arr[1], max_val, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 42, exit);
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_QUAL_VAL_verify()",0,0);
}

uint32
  ARAD_PP_FP_PFG_INFO_verify(
      SOC_SAND_IN  int               unit,
      SOC_SAND_IN  ARAD_PP_FP_PFG_INFO *info
  )
{
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_PFG_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FP_DATABASE_INFO_verify(
    SOC_SAND_IN  ARAD_PP_FP_DATABASE_INFO *info
  )
{
  uint32
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->db_type, ARAD_PP_FP_DATABASE_TYPE_MAX, ARAD_PP_FP_DATABASE_TYPE_OUT_OF_RANGE_ERR, 10, exit);
  ...
  end_of_list = FALSE;
  for (ind = 0; ind < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; ++ind)
  {
      if (info->qual_types[ind] == ARAD_PP_NOF_FP_QUAL_TYPES)
      {
        end_of_list = TRUE;
      }
    ...
    {
      SOC_SAND_ERR_IF_ABOVE_MAX(info->qual_types[ind], ARAD_PP_NOF_FP_QUAL_TYPES, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 110, exit);
    }
    else /* end_of_list == TRUE */
    {
      SOC_SAND_ERR_IF_OUT_OF_RANGE(info->qual_types[ind], ARAD_PP_NOF_FP_QUAL_TYPES, ARAD_PP_NOF_FP_QUAL_TYPES, ARAD_PP_FP_QUAL_TYPES_END_OF_LIST_ERR, 111, exit);
    }
  }
  ...
  for (ind = 0; ind < ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX; ++ind)
  {
    ...
    if (end_of_list == FALSE)
    {
      SOC_SAND_ERR_IF_ABOVE_MAX(info->action_types[ind], ARAD_PP_NOF_FP_ACTION_TYPES, ARAD_PP_FP_ACTION_TYPES_OUT_OF_RANGE_ERR, 112, exit);
    }
    else /* end_of_list == TRUE */
    {
      SOC_SAND_ERR_IF_OUT_OF_RANGE(info->action_types[ind], SOC_PPC_FP_ACTION_TYPE_INVALID, SOC_PPC_FP_ACTION_TYPE_INVALID, ARAD_PP_FP_ACTION_TYPES_END_OF_LIST_ERR, 121, exit);
    }
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_DATABASE_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FP_ACTION_VAL_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_NOF_FP_ACTION_TYPES, ARAD_PP_FP_ACTION_TYPES_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->val, ARAD_PP_FP_VAL_MAX, ARAD_PP_FP_VAL_OUT_OF_RANGE_ERR, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_ACTION_VAL_verify()",0,0);
}

uint32
  ARAD_PP_FP_ENTRY_INFO_verify(
      SOC_SAND_IN  int                 unit,
      SOC_SAND_IN  ARAD_PP_FP_ENTRY_INFO *info,
      SOC_SAND_IN     ARAD_FP_DATABASE_STAGE    stage
  )
{
  ...
  for (ind = 0; ind < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; ++ind)
  {
      if (info->qual_vals[ind].type != ARAD_PP_NOF_FP_QUAL_TYPES)
      {
          res = ARAD_PP_FP_QUAL_VAL_verify(unit, &(info->qual_vals[ind]), stage);
          SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
      }
  }
  for (ind = 0; ind < ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX; ++ind)
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_FP_ACTION_VAL, &(info->actions[ind]), 11, exit);
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_ENTRY_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FP_DIR_EXTR_ACTION_LOC_verify(
      SOC_SAND_IN  int                    unit,
  ...
  )
{
  ...
  if (info->type == ARAD_PP_NOF_FP_QUAL_TYPES) {
      ...
      SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_FP_QUAL_TYPES_MAX, ARAD_PP_FP_QUAL_TYPES_OUT_OF_RANGE_ERR, 20, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_DIR_EXTR_ACTION_LOC_verify()",0,0);
}

uint32
  ARAD_PP_FP_DIR_EXTR_ACTION_VAL_verify(
      SOC_SAND_IN  int                    unit,
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_FP_ACTION_TYPES_MAX, ARAD_PP_FP_ACTION_TYPES_OUT_OF_RANGE_ERR, 10, exit);
  ...
  {
      res = ARAD_PP_FP_DIR_EXTR_ACTION_LOC_verify(unit, &(info->fld_ext[ind]), stage, is_large_direct_extraction);
      SOC_SAND_CHECK_FUNC_RESULT(res, 22, exit);
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_DIR_EXTR_ACTION_VAL_verify()",0,0);
}

uint32
  ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_verify(
      SOC_SAND_IN  int                    unit,
      SOC_SAND_IN  ARAD_PP_FP_DIR_EXTR_ENTRY_INFO *info,
      SOC_SAND_IN  ARAD_FP_DATABASE_STAGE    stage,
      SOC_SAND_IN  uint8                           is_large_direct_extraction
  )
{
  ...
  for (ind = 0; ind < ARAD_PP_FP_NOF_ACTIONS_PER_DB_MAX; ++ind)
  {
    if (info->actions[ind].type != ARAD_PP_ACTION_TYPE_INVALID)
    {
        ...
        res = ARAD_PP_FP_DIR_EXTR_ACTION_VAL_verify(unit, &(info->actions[ind]), stage, is_large_direct_extraction);
        SOC_SAND_CHECK_FUNC_RESULT(res, 11, exit);
    }
  }
  SOC_SAND_ERR_IF_ABOVE_MAX(info->priority, ARAD_PP_FP_PRIORITY_MAX, ARAD_PP_FP_PRIORITY_OUT_OF_RANGE_ERR, 12, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_DIR_EXTR_ENTRY_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FP_CONTROL_INDEX_verify(
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_FP_CONTROL_TYPE_MAX, ARAD_PP_FP_TYPE_OUT_OF_RANGE_ERR, 20, exit);
  ...
  case ARAD_PP_FP_CONTROL_TYPE_L2_L3_KEY_IN_LIF_ENABLE:
  case ARAD_PP_FP_CONTROL_TYPE_L3_IPV6_TCP_CTL_ENABLE:
  case ARAD_PP_FP_CONTROL_TYPE_KEY_CHANGE_SIZE:
  ...
  case ARAD_PP_FP_CONTROL_TYPE_INNER_ETH_NOF_VLAN_TAGS:
    SOC_SAND_ERR_IF_ABOVE_MAX(info->val_ndx, ARAD_PP_FP_NOF_PFGS, ARAD_PP_FP_VAL_NDX_OUT_OF_RANGE_ERR, 150, exit);
    break;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_CONTROL_INDEX_verify()",0,0);
}

uint32
  ARAD_PP_FP_CONTROL_INFO_verify(
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  ARAD_PP_FP_CONTROL_TYPE type,
    SOC_SAND_IN  ARAD_PP_FP_CONTROL_INFO *info
  )
{
  uint32
  ...
  case ARAD_PP_FP_CONTROL_TYPE_OUT_LIF_RANGE:
    for (val_ndx = 0; val_ndx < 2; val_ndx++)
    {
      SOC_SAND_ERR_IF_OUT_OF_RANGE(info->val[val_ndx], 1, SOC_DPP_DEFS_GET(unit, nof_out_lifs) - 1, ARAD_PP_FP_VAL_OUT_OF_RANGE_ERR, 30, exit);
    }
    break;
  ...
  case ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF:
    SOC_SAND_ERR_IF_ABOVE_MAX(info->val[0], ARAD_PP_NOF_FP_BASE_HEADER_TYPES, ARAD_PP_FP_VAL_NDX_OUT_OF_RANGE_ERR, 40, exit);
    if(info->val[1] & ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_FLAG_NEGATIVE) {
      SOC_SAND_ERR_IF_ABOVE_MAX(info->val[1] & (~ARAD_PP_FP_CONTROL_TYPE_HDR_USER_DEF_FLAG_NEGATIVE), ARAD_PP_UD_HEADER_OFFSET_MAX, ARAD_PP_FP_VAL_NDX_OUT_OF_RANGE_ERR, 41, exit);
    } else {
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FP_CONTROL_INFO_verify()",0,0);
}
  ...
  )
{
    ...
    ARAD_ALLOC(entry, ARAD_PP_FP_ENTRY_INFO, 1, "arad_pp_fp_pp_test1.entry");
    ARAD_PP_FP_ENTRY_INFO_clear(entry);
    entry->priority = 100;
    entry->actions[0].type = ARAD_PP_FP_ACTION_TYPE_DEST;
    entry->actions[0].val = 20;
    entry->qual_vals[0].is_valid.arr[0] = 0xFFFFFFFF;
    entry->qual_vals[0].type = ARAD_PP_FP_QUAL_IRPP_SYSTEM_VSI;
    entry->qual_vals[0].val.arr[0] = 0x123;

    ARAD_PP_FP_DATABASE_INFO_clear(&db_info);

    /* type */
    db_info.db_type = ARAD_PP_FP_DB_TYPE_TCAM;
    /* actions */
    db_info.action_types[0] = ARAD_PP_FP_ACTION_TYPE_DEST;
    db_info.action_types[1] = ARAD_PP_FP_ACTION_TYPE_OUTLIF;
    /* qual */
    db_info.qual_types[0] = ARAD_PP_FP_QUAL_IRPP_STP_STATE;
    db_info.qual_types[1] = ARAD_PP_FP_QUAL_IRPP_SYSTEM_VSI;
    db_info.strength = 3;
    ...
    )
{
    ...
    SOC_SAND_ERR_IF_OUT_OF_RANGE(packet->size_bytes, 64, 200, ARAD_PP_FP_PACKET_SIZE_OUT_OF_RANGE_ERR, 10, exit);
    ...
    )
{
    ...
    soc_reg_field_set(unit, ire_reg_fap_port_configuration_reg, &reg_val, REG_PORT_TERMINATION_CONTEXTf, packet->local_port_src);
    ...
    for(i = 0; i < packet->size_bytes; i += ARAD_PP_FP_IRE_PACKET_NOF_BYTES_MAX_PER_WRITE) {
        ...
        for(reg_ndx = 0; reg_ndx < nof_regs; reg_ndx++) {
            ire_regi_pkt_data_reg = SOC_IS_JERICHO(unit)? ire_regi_pkt_data_jericho[reg_ndx]: IRE_REGI_PKT_DATAr;
            ...
            for(j = 0; j <ARAD_PP_FP_IRE_PACKET_NOF_LONGS_COPY_REG ; ++j) {
                SHR_BITCOPY_RANGE(reg_above_64, 32*j, packet->buffer, 
                                  (ARAD_PP_FP_IRE_PACKET_NOF_LONGS_COPY_REG * i) + 32 * ( ARAD_PP_FP_IRE_PACKET_NOF_LONGS_COPY_REG - 1 - j), 32);
            }
...
exit:
    SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_ire_traffic_send()", 0, 0);
}
