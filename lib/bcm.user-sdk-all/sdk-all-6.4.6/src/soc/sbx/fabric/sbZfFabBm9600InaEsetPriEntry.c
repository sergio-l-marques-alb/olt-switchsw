/*
 * $Id: sbZfFabBm9600InaEsetPriEntry.c,v 1.2 Broadcom SDK $
...
sbZfFabBm9600InaEsetPriEntry_Pack(sbZfFabBm9600InaEsetPriEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_INAESETPRIENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_INAESETPRIENTRY_SIZE_IN_BYTES;
}
