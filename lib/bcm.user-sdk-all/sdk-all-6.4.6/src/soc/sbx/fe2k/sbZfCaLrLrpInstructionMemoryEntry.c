/*
 * $Id: sbZfCaLrLrpInstructionMemoryEntry.c,v 1.2 Broadcom SDK $
...
sbZfCaLrLrpInstructionMemoryEntry_Unpack(sbZfCaLrLrpInstructionMemoryEntry_t *pToStruct,
  ...
  (pToStruct)->m_uThread =  (uint32)  ((pFromData)[11] >> 5) & 0x07;

  /* Unpack Member: m_uOpcode */
  (pToStruct)->m_uOpcode =  (uint32)  ((pFromData)[10] >> 4) & 0x0f;
  (pToStruct)->m_uOpcode |=  (uint32)  ((pFromData)[11] & 0x1f) << 4;

  /* Unpack Member: m_uRa */
  (pToStruct)->m_uRa =  (uint32)  ((pFromData)[10] >> 3) & 0x01;

  /* Unpack Member: m_uRb */
  (pToStruct)->m_uRb =  (uint32)  ((pFromData)[10] >> 2) & 0x01;

  /* Unpack Member: m_uTarget */
  (pToStruct)->m_uTarget =  (uint32)  (pFromData)[8] ;
  (pToStruct)->m_uTarget |=  (uint32)  (pFromData)[9] << 8;
  (pToStruct)->m_uTarget |=  (uint32)  ((pFromData)[10] & 0x03) << 16;

  /* Unpack Member: m_uSourceA */
  (pToStruct)->m_uSourceA =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uSourceA |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->m_uSourceA |=  (uint32)  (pFromData)[6] << 16;
  (pToStruct)->m_uSourceA |=  (uint32)  (pFromData)[7] << 24;

  /* Unpack Member: m_uSourceB */
  (pToStruct)->m_uSourceB =  (uint32)  (pFromData)[2] ;
  (pToStruct)->m_uSourceB |=  (uint32)  (pFromData)[3] << 8;

  /* Unpack Member: m_uReserved */
  (pToStruct)->m_uReserved =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uReserved |=  (uint32)  (pFromData)[1] << 8;
