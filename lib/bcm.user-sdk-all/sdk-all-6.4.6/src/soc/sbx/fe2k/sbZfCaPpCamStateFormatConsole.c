/*
 * $Id: sbZfCaPpCamStateFormatConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPpCamStateFormat_Print(sbZfCaPpCamStateFormat_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamStateFormat:: resv1=0x%02x"), (unsigned int)  pFromStruct->m_uResv1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamStateFormat:: resv0=0x%01x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpCamStateFormat:: pbits1=0x%01x"), (unsigned int)  pFromStruct->m_uPropBits1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfCaPpCamStateFormat_SPrint(sbZfCaPpCamStateFormat_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
