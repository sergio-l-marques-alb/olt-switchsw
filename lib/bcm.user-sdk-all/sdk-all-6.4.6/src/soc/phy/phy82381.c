...
STATIC int 
phy_82381_intr_enable_set(phy_ctrl_t *pc, uint32 value);
STATIC int 
phy_82381_intr_enable_get(phy_ctrl_t *pc, uint32 *value);
STATIC int 
phy_82381_intr_status_get(phy_ctrl_t *pc, uint32 *value);
STATIC int
...
phy_82381_control_get(int unit, soc_port_t port, soc_phy_control_t type, uint32 *value)
{
    ...
    *value = 0;
    ...
    case SOC_PHY_CONTROL_INTR_MASK:
        rv = phy_82381_intr_enable_get(pc, value);
    break;
    case SOC_PHY_CONTROL_INTR_STATUS:
        rv = phy_82381_intr_status_get(pc, value);
    break;
 ...
 */
STATIC int 
phy_82381_rx_vga_set(phy_ctrl_t *pc, int32 intf, uint32 value)
{
    phymod_phy_access_t *pm_phy;
    phymod_rx_t         phymod_rx;
    int                 idx;
...
phy_82381_control_set(int unit, soc_port_t port, soc_phy_control_t type, uint32 value)
{
    ...
    /* RX VGA */
    case SOC_PHY_CONTROL_RX_VGA:
        rv = phy_82381_rx_vga_set(pc, intf, value);
        break;
    /* RX TAP */
    case SOC_PHY_CONTROL_RX_TAP1:
    ...
    break;
    case SOC_PHY_CONTROL_INTR_MASK:
        rv = phy_82381_intr_enable_set(pc, value);
    break;
    case SOC_PHY_CONTROL_XSW_LANE_MAP:
