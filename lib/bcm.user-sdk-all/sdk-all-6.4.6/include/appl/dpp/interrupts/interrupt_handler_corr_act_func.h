...
typedef enum {
    ...
    ARAD_INT_CORR_ACT_IPS_QDESC = 0x13,
    ARAD_INT_CORR_ACT_IHP_EM_SOFT_RECOVERY = 0x14,
 	ARAD_INT_CORR_ACT_IHB_EM_SOFT_RECOVERY = 0x15,
 	ARAD_INT_CORR_ACT_EPNI_EM_SOFT_RECOVERY = 0x16,
 	ARAD_INT_CORR_ACT_OAMP_EM_SOFT_RECOVERY = 0x17
...
int arad_interrupt_data_collection_for_recurring_mac_oof_int( int unit, int block_instance, arad_interrupt_type en_arad_interrupt, soc_dcmn_port_pcs_t* p_pcs, arad_int_corr_act_type* p_corrective_action,char* special_msg, uint8* array_links);
