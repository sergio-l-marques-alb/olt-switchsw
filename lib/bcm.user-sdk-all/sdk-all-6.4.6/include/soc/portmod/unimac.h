...
int unimac_init(int unit, soc_port_t port, int is_auto_cfg, uint32 rsv_mask, int init_flags);
...
int unimac_soft_reset_set     (int unit, soc_port_t p, int enable);
int unimac_soft_reset_get     (int unit, soc_port_t p, int *enable);
int unimac_rx_max_size_set    (int unit, soc_port_t p, int value);
int unimac_rx_max_size_get    (int unit, soc_port_t p, int *value);
int unimac_tx_average_ipg_set (int unit, soc_port_t p, int ipg_val);
int unimac_tx_average_ipg_get (int unit, soc_port_t p, int *ipg_val);

int unimac_tx_preamble_length_set    (int unit, soc_port_t p, int length);

/***************************************************************************** 
 SDK Support Functions 
******************************************************************************/
int unimac_eee_set (int u, int p, const portmod_eee_t* eee);
int unimac_eee_get (int u, int p, const portmod_eee_t* eee);

int unimac_pfc_config_set (int u, int p, const portmod_pfc_config_t* pfc_cfg);
int unimac_pfc_config_get (int u, int p, const portmod_pfc_config_t* pfc_cfg);

int unimac_diag_fifo_status_get (int u, int p, const portmod_fifo_status_t* inf);

int unimac_pass_control_frame_set(int unit, int port, int value);

int unimac_mac_ctrl_set    (int u, int p, uint64 ctrl);
