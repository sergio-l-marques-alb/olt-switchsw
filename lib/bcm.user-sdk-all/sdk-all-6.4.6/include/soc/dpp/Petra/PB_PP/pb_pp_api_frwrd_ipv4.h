/* $Id: pb_pp_api_frwrd_ipv4.h,v 1.6 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_frwrd_ipv4.h
*
...
#ifndef __SOC_PB_PP_API_FRWRD_IPV4_INCLUDED__
/* { */
#define __SOC_PB_PP_API_FRWRD_IPV4_INCLUDED__
...
#define  SOC_PB_PP_FRWRD_IP_ALL_VRFS_ID (SOC_PPC_FRWRD_IP_ALL_VRFS_ID)
...
#define SOC_PB_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC    SOC_PPC_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC
#define SOC_PB_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_ACTION_PROFILE SOC_PPC_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_ACTION_PROFILE
#define SOC_PB_PP_NOF_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPES   SOC_PPC_NOF_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPES
typedef SOC_PPC_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE          SOC_PB_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE;

#define SOC_PB_PP_FRWRD_IPV4_HOST_TABLE_RESOURCE_LPM_ONLY      SOC_PPC_FRWRD_IPV4_HOST_TABLE_RESOURCE_LPM_ONLY
#define SOC_PB_PP_FRWRD_IPV4_HOST_TABLE_RESOURCE_LEM_THEN_LPM  SOC_PPC_FRWRD_IPV4_HOST_TABLE_RESOURCE_LEM_THEN_LPM
typedef SOC_PPC_FRWRD_IPV4_HOST_TABLE_RESOURCE                 SOC_PB_PP_FRWRD_IPV4_HOST_TABLE_RESOURCE;

#define SOC_PB_PP_FRWRD_IPV4_MC_HOST_TABLE_RESOURCE_TCAM_ONLY  SOC_PPC_FRWRD_IPV4_MC_HOST_TABLE_RESOURCE_TCAM_ONLY
#define SOC_PB_PP_NOF_FRWRD_IPV4_MC_HOST_TABLE_RESOURCES       SOC_PPC_NOF_FRWRD_IPV4_MC_HOST_TABLE_RESOURCES
typedef SOC_PPC_FRWRD_IPV4_MC_HOST_TABLE_RESOURCE              SOC_PB_PP_FRWRD_IPV4_MC_HOST_TABLE_RESOURCE;

#define SOC_PB_PP_FRWRD_IP_CACHE_MODE_NONE                        SOC_PPC_FRWRD_IP_CACHE_MODE_NONE
#define SOC_PB_PP_FRWRD_IP_CACHE_MODE_IPV4_UC_LPM                 SOC_PPC_FRWRD_IP_CACHE_MODE_IPV4_UC_LPM
#define SOC_PB_PP_NOF_FRWRD_IP_CACHE_MODES                        SOC_PPC_NOF_FRWRD_IP_CACHE_MODES
typedef SOC_PPC_FRWRD_IP_CACHE_MODE                               SOC_PB_PP_FRWRD_IP_CACHE_MODE;

#define SOC_PB_PP_FRWRD_IP_ROUTE_STATUS_COMMITED               SOC_PPC_FRWRD_IP_ROUTE_STATUS_COMMITED
#define SOC_PB_PP_NOF_FRWRD_IP_ROUTE_STATUSS                   SOC_PPC_NOF_FRWRD_IP_ROUTE_STATUSS
typedef SOC_PPC_FRWRD_IP_ROUTE_STATUS                          SOC_PB_PP_FRWRD_IP_ROUTE_STATUS;

#define SOC_PB_PP_FRWRD_IP_ROUTE_LOCATION_HOST                 SOC_PPC_FRWRD_IP_ROUTE_LOCATION_HOST
#define SOC_PB_PP_FRWRD_IP_ROUTE_LOCATION_LPM                  SOC_PPC_FRWRD_IP_ROUTE_LOCATION_LPM
#define SOC_PB_PP_FRWRD_IP_ROUTE_LOCATION_TCAM                 SOC_PPC_FRWRD_IP_ROUTE_LOCATION_TCAM
#define SOC_PB_PP_NOF_FRWRD_IP_ROUTE_LOCATIONS                 SOC_PPC_NOF_FRWRD_IP_ROUTE_LOCATIONS
typedef SOC_PPC_FRWRD_IP_ROUTE_LOCATION                        SOC_PB_PP_FRWRD_IP_ROUTE_LOCATION;

typedef SOC_PPC_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_VAL           SOC_PB_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_VAL;
typedef SOC_PPC_FRWRD_IPV4_ROUTER_DEFAULT_ACTION               SOC_PB_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION;
typedef SOC_PPC_FRWRD_IPV4_ROUTER_INFO                         SOC_PB_PP_FRWRD_IPV4_ROUTER_INFO;
typedef SOC_PPC_FRWRD_IPV4_VRF_INFO                            SOC_PB_PP_FRWRD_IPV4_VRF_INFO;
typedef SOC_PPC_FRWRD_IPV4_GLBL_INFO                           SOC_PB_PP_FRWRD_IPV4_GLBL_INFO;
typedef SOC_PPC_FRWRD_IPV4_UC_ROUTE_KEY                        SOC_PB_PP_FRWRD_IPV4_UC_ROUTE_KEY;
typedef SOC_PPC_FRWRD_IPV4_MC_ROUTE_KEY                        SOC_PB_PP_FRWRD_IPV4_MC_ROUTE_KEY;
typedef SOC_PPC_FRWRD_IPV4_VPN_ROUTE_KEY                       SOC_PB_PP_FRWRD_IPV4_VPN_ROUTE_KEY;
typedef SOC_PPC_FRWRD_IPV4_HOST_KEY                            SOC_PB_PP_FRWRD_IPV4_HOST_KEY;
typedef SOC_PPC_FRWRD_IPV4_HOST_ROUTE_INFO                     SOC_PB_PP_FRWRD_IPV4_HOST_ROUTE_INFO;
typedef SOC_PPC_FRWRD_IPV4_MC_ROUTE_INFO                       SOC_PB_PP_FRWRD_IPV4_MC_ROUTE_INFO;
typedef SOC_PPC_FRWRD_IPV4_MEM_STATUS                          SOC_PB_PP_FRWRD_IPV4_MEM_STATUS;
typedef SOC_PPC_FRWRD_IPV4_MEM_DEFRAG_INFO                     SOC_PB_PP_FRWRD_IPV4_MEM_DEFRAG_INFO;
 ...
 *     "soc_pb_pp_frwrd_ip_routes_cache_mode_enable_set" API.
 *     Refer to "soc_pb_pp_frwrd_ip_routes_cache_mode_enable_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_ipv4_glbl_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_ipv4_glbl_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_ipv4_vrf_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_ipv4_vrf_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_FRWRD_IPV4_INCLUDED__*/
#endif
