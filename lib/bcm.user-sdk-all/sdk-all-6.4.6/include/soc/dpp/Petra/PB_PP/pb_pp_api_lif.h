/* $Id: pb_pp_api_lif.h,v 1.10 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_lif.h
*
...
#ifndef __SOC_PB_PP_API_LIF_INCLUDED__
/* { */
#define __SOC_PB_PP_API_LIF_INCLUDED__
...
#define  SOC_PB_PP_LIF_IGNORE_INNER_VID     (SOC_PPC_LIF_IGNORE_INNER_VID)

/*     Used when the AC mapping is only according to the port
 *     (port default).                                         */
#define  SOC_PB_PP_LIF_IGNORE_OUTER_VID     (SOC_PPC_LIF_IGNORE_OUTER_VID)

/*     AC Group maximal size.                                  */

/* VSI that should be used for P2P service */
#define SOC_PB_PP_VSI_P2P_SERVICE           (SOC_PPC_VSI_P2P_SERVICE)
...
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT                  SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN             SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN_VLAN        SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_VLAN_VLAN
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_RAW                   SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_RAW
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN              SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN_VLAN         SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_RAW_VLAN_VLAN
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN           SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN
#define SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN_COMP_VLAN SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE_PORT_COMP_VLAN_COMP_VLAN
#define SOC_PB_PP_NOF_L2_LIF_AC_MAP_KEY_TYPES                  SOC_PPC_NOF_L2_LIF_AC_MAP_KEY_TYPES_PB
typedef SOC_PPC_L2_LIF_AC_MAP_KEY_TYPE                         SOC_PB_PP_L2_LIF_AC_MAP_KEY_TYPE;

#define SOC_PB_PP_L2_LIF_DFLT_FRWRD_SRC_VSI                    SOC_PPC_L2_LIF_DFLT_FRWRD_SRC_VSI
#define SOC_PB_PP_L2_LIF_DFLT_FRWRD_SRC_LIF                    SOC_PPC_L2_LIF_DFLT_FRWRD_SRC_LIF
#define SOC_PB_PP_NOF_L2_LIF_DFLT_FRWRD_SRCS                   SOC_PPC_NOF_L2_LIF_DFLT_FRWRD_SRCS
typedef SOC_PPC_L2_LIF_DFLT_FRWRD_SRC                          SOC_PB_PP_L2_LIF_DFLT_FRWRD_SRC;

#define SOC_PB_PP_L2_LIF_AC_SERVICE_TYPE_MP                    SOC_PPC_L2_LIF_AC_SERVICE_TYPE_MP
#define SOC_PB_PP_L2_LIF_AC_SERVICE_TYPE_AC2AC                 SOC_PPC_L2_LIF_AC_SERVICE_TYPE_AC2AC
#define SOC_PB_PP_L2_LIF_AC_SERVICE_TYPE_AC2PWE                SOC_PPC_L2_LIF_AC_SERVICE_TYPE_AC2PWE
#define SOC_PB_PP_L2_LIF_AC_SERVICE_TYPE_AC2PBB                SOC_PPC_L2_LIF_AC_SERVICE_TYPE_AC2PBB
#define SOC_PB_PP_NOF_L2_LIF_AC_SERVICE_TYPES                  SOC_PPC_NOF_L2_LIF_AC_SERVICE_TYPES
typedef SOC_PPC_L2_LIF_AC_SERVICE_TYPE                         SOC_PB_PP_L2_LIF_AC_SERVICE_TYPE;

#define SOC_PB_PP_L2_LIF_PWE_SERVICE_TYPE_MP                   SOC_PPC_L2_LIF_PWE_SERVICE_TYPE_MP
#define SOC_PB_PP_L2_LIF_PWE_SERVICE_TYPE_P2P                  SOC_PPC_L2_LIF_PWE_SERVICE_TYPE_P2P
#define SOC_PB_PP_NOF_L2_LIF_PWE_SERVICE_TYPES                 SOC_PPC_NOF_L2_LIF_PWE_SERVICE_TYPES
typedef SOC_PPC_L2_LIF_PWE_SERVICE_TYPE                        SOC_PB_PP_L2_LIF_PWE_SERVICE_TYPE;

#define SOC_PB_PP_L2_LIF_ISID_SERVICE_TYPE_MP                  SOC_PPC_L2_LIF_ISID_SERVICE_TYPE_MP
#define SOC_PB_PP_L2_LIF_ISID_SERVICE_TYPE_P2P                 SOC_PPC_L2_LIF_ISID_SERVICE_TYPE_P2P
#define SOC_PB_PP_NOF_L2_LIF_ISID_SERVICE_TYPES                SOC_PPC_NOF_L2_LIF_ISID_SERVICE_TYPES
typedef SOC_PPC_L2_LIF_ISID_SERVICE_TYPE                       SOC_PB_PP_L2_LIF_ISID_SERVICE_TYPE;

#define SOC_PB_PP_L2_LIF_AC_LEARN_DISABLE                      SOC_PPC_L2_LIF_AC_LEARN_DISABLE
#define SOC_PB_PP_L2_LIF_AC_LEARN_SYS_PORT                     SOC_PPC_L2_LIF_AC_LEARN_SYS_PORT
#define SOC_PB_PP_L2_LIF_AC_LEARN_INFO                         SOC_PPC_L2_LIF_AC_LEARN_INFO
#define SOC_PB_PP_NOF_L2_LIF_AC_LEARN_TYPES                    SOC_PPC_NOF_L2_LIF_AC_LEARN_TYPES
typedef SOC_PPC_L2_LIF_AC_LEARN_TYPE                           SOC_PB_PP_L2_LIF_AC_LEARN_TYPE;

#define SOC_PB_PP_L2_LIF_L2CP_HANDLE_TYPE_NORMAL               SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_NORMAL
#define SOC_PB_PP_L2_LIF_L2CP_HANDLE_TYPE_TUNNEL               SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_TUNNEL
#define SOC_PB_PP_L2_LIF_L2CP_HANDLE_TYPE_PEER                 SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_PEER
#define SOC_PB_PP_L2_LIF_L2CP_HANDLE_TYPE_DROP                 SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE_DROP
#define SOC_PB_PP_NOF_L2_LIF_L2CP_HANDLE_TYPES                 SOC_PPC_NOF_L2_LIF_L2CP_HANDLE_TYPES
typedef SOC_PPC_L2_LIF_L2CP_HANDLE_TYPE                        SOC_PB_PP_L2_LIF_L2CP_HANDLE_TYPE;

typedef SOC_PPC_L2_LIF_AC_KEY_QUALIFIER                        SOC_PB_PP_L2_LIF_AC_KEY_QUALIFIER;
typedef SOC_PPC_L2_LIF_IN_VC_RANGE                             SOC_PB_PP_L2_LIF_IN_VC_RANGE;
typedef SOC_PPC_L2_LIF_DEFAULT_FORWARDING_INFO                 SOC_PB_PP_L2_LIF_DEFAULT_FORWARDING_INFO;
typedef SOC_PPC_L2_LIF_PWE_LEARN_RECORD                        SOC_PB_PP_L2_LIF_PWE_LEARN_RECORD;
typedef SOC_PPC_L2_LIF_PWE_INFO                                SOC_PB_PP_L2_LIF_PWE_INFO;

#define SOC_PB_PP_LIF_VLAN_RANGE_MAX_SIZE                      SOC_PPC_LIF_VLAN_RANGE_MAX_SIZE
typedef SOC_PPC_L2_VLAN_RANGE_KEY                              SOC_PB_PP_L2_VLAN_RANGE_KEY;
typedef SOC_PPC_L2_PORT_VLAN_RANGE_INFO                        SOC_PB_PP_L2_PORT_VLAN_RANGE_INFO;

typedef SOC_PPC_L2_LIF_AC_KEY                                  SOC_PB_PP_L2_LIF_AC_KEY;
typedef SOC_PPC_L2_LIF_AC_LEARN_RECORD                         SOC_PB_PP_L2_LIF_AC_LEARN_RECORD;
typedef SOC_PPC_L2_LIF_AC_ING_EDIT_INFO                        SOC_PB_PP_L2_LIF_AC_ING_EDIT_INFO;
typedef SOC_PPC_L2_LIF_AC_INFO                                 SOC_PB_PP_L2_LIF_AC_INFO;
typedef SOC_PPC_L2_LIF_AC_MP_INFO                              SOC_PB_PP_L2_LIF_AC_MP_INFO;
typedef SOC_PPC_L2_LIF_L2CP_KEY                                SOC_PB_PP_L2_LIF_L2CP_KEY;
typedef SOC_PPC_L2_LIF_AC_GROUP_INFO                           SOC_PB_PP_L2_LIF_AC_GROUP_INFO;
typedef SOC_PPC_L2_LIF_ISID_KEY                                SOC_PB_PP_L2_LIF_ISID_KEY;
typedef SOC_PPC_L2_LIF_ISID_INFO                               SOC_PB_PP_L2_LIF_ISID_INFO;
typedef SOC_PPC_L2_LIF_TRILL_INFO                              SOC_PB_PP_L2_LIF_TRILL_INFO;
 ...
 *     "soc_pb_pp_l2_lif_pwe_map_range_set" API.
 *     Refer to "soc_pb_pp_l2_lif_pwe_map_range_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_l2_lif_ac_mp_info_set" API.
 *     Refer to "soc_pb_pp_l2_lif_ac_mp_info_set" API for details.
*********************************************************************/
uint32
 ...
 *   SOC_PB_PP_eg_ac_info_set()When Adding an AC to the system, the
 ...
 *     Exact Match table
 * REMARKS:
 *   - See remarks of SOC_PB_PP_l2_lif_ac_add()- Map VLAN Domain
 ...
 *   configured via the API SOC_PB_PP_lif_cos_opcode_types_set
 * RETURNS:
 *   OK or ERROR indication.
*********************************************************************/
uint32
 ...
 *   SOC_PB_PP_l2_lif_ac_with_cos_add() and SOC_PB_PP_l2_lif_ac_add(). In
 ...
 *     according to in-AC see SOC_PB_PP_l2_lif_ac_add()).
 ...
 *   SOC_PB_PP_TRAP_CODE_L2CP_DROP/SOC_PB_PP_TRAP_CODE_L2CP_PEER. - In
 *   order to set the forwarding/snooping action use
 *   SOC_PB_PP_trap_frwrd_profile_info_set()/SOC_PB_PP_trap_snoop_profile_info_set
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_l2_lif_l2cp_trap_set" API.
 *     Refer to "soc_pb_pp_l2_lif_l2cp_trap_set" API for details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_LIF_INCLUDED__*/
#endif
