...
#define SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(_var, _var_string, _buffer, _multi_set, _nof_members, _counter_size, _max_duplications, _table_size, \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_HASH_TABLE(_var + WB_ENGINE_MULTI_SET_HASH_TABLE, \
                                                _var_string,        \
                                                _buffer,            \
                                                _multi_set.multiset_data.hash_table[0], \
                                                _table_size,        \
                                                _key_size,          \
                                                _ptr_size,          \
                                                _table_width,       \
...
#define SOC_DPP_ADD_ARAD_VARS_DEPRECATED_CODE \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LLP_MIRROR_MIRROR_PROFILE_MULTI_SET,                                                                                                                                       \
                                               ...
                                               SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_LLP_MIRROR,                                                                                                                                                             \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0],                                                                                                                                                         \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].init_info.nof_members,                                                                                                                                   \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.counter_size,                                                                                                                              \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].init_info.max_duplications,                                                                                                                              \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                           \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                             \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                             \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                          \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                              \
                                               PP_SW_DB_DEVICE->llp_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                            \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LLP_TRAP_L3_PROTOCOLS_MULTI_SET,                                                                                                                                           \
                                               ...
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0],                                                                                                                                                             \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].init_info.nof_members,                                                                                                                                       \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.counter_size,                                                                                                                                  \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].init_info.max_duplications,                                                                                                                                  \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                               \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                                 \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                                 \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                              \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                                  \
                                               PP_SW_DB_DEVICE->llp_trap->l3_protocols_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                                \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_EG_MIRROR_MIRROR_PROFILE_MULTI_SET,                                                                                                                                        \
                                               ...
                                               SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_EG_MIRROR,                                                                                                                                                              \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0],                                                                                                                                                          \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].init_info.nof_members,                                                                                                                                    \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.counter_size,                                                                                                                               \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].init_info.max_duplications,                                                                                                                               \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                            \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                              \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                              \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                           \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                               \
                                               PP_SW_DB_DEVICE->eg_mirror->mirror_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                             \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                                              \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_EG_ENCAP_PROG_DATA,                                                                                                                                                        \
                                               ...
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0],                                                                                                                                                                          \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].init_info.nof_members,                                                                                                                                                    \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.counter_size,                                                                                                                                               \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].init_info.max_duplications,                                                                                                                                               \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                                            \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                                              \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                                              \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                                           \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                                               \
                                               PP_SW_DB_DEVICE->eg_encap->prog_data[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                                             \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                                              \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_LLP_COS_ETHER_TYPE_MULTI_SET,                                                                                                                                              \
                                               ...
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0],                                                                                                                                                                \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].init_info.nof_members,                                                                                                                                          \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.counter_size,                                                                                                                                     \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].init_info.max_duplications,                                                                                                                                     \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                                  \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                                    \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                                    \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                                 \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                                     \
                                               PP_SW_DB_DEVICE->llp_cos->ether_type_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                                   \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                                              \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_ETH_POLICER_MTR_PROFILE_ETH_METER_PROFILE_MULTI_SET,                                                                                                                       \
                                               ...
                                               SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_ETH_POLICER_MTR_PROFILE,                                                                                                                                                \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0],                                                                                                                                         \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].init_info.nof_members,                                                                                                                   \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.counter_size,                                                                                                              \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].init_info.max_duplications,                                                                                                              \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                           \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                             \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                             \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                          \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                              \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->eth_meter_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                            \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_ETH_POLICER_MTR_PROFILE_GLOBAL_METER_PROFILE_MULTI_SET,                                                                                                                    \
                                               ...
                                               SOC_DPP_WB_ENGINE_BUFFER_ARAD_PP_SW_DB_ETH_POLICER_MTR_PROFILE,                                                                                                                                                \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0],                                                                                                                                      \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].init_info.nof_members,                                                                                                                \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.counter_size,                                                                                                           \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].init_info.max_duplications,                                                                                                           \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                        \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                          \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                          \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                       \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                           \
                                               PP_SW_DB_DEVICE->eth_policer_mtr_profile->global_meter_profile_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                         \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                                              \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_L2_LIF_AC_AC_KEY_MAP_MULTI_SET,                                                                                                                                            \
                                               ...
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0],                                                                                                                                                              \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].init_info.nof_members,                                                                                                                                        \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.counter_size,                                                                                                                                   \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].init_info.max_duplications,                                                                                                                                   \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                                \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                                  \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                                  \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                               \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                                   \
                                               PP_SW_DB_DEVICE->l2_lif_ac->ac_key_map_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                                 \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                                              \
    /*ARAD_PP_SW_DB_L2_LIF_AC module*/                                                                                                                                                                                                                        \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(SOC_DPP_WB_ENGINE_VAR_ARAD_PP_SW_DB_L2_LIF_VLAN_COMPRESSION_RANGE_MULTI_SET,                                                                                                                                   \
                                               ...
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0],                                                                                                                                                     \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].init_info.nof_members,                                                                                                                               \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.counter_size,                                                                                                                          \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].init_info.max_duplications,                                                                                                                          \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                                                                                       \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                                                                                         \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                                                                                         \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                                                                                      \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                                                                                          \
                                               PP_SW_DB_DEVICE->l2_lif->vlan_compression_range_multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                                                                                        \
                                               VERSION(1));                                                                                                                                                                                                   \
                                                                                                                                                                                                                                                              \
    ...
    for (i = SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED; i <= SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED_LAST; i+=WB_ENGINE_OCC_BM_INNER_VARS_NUM ) {                                                                               \
        SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_OCC_BM_DYNAMIC(i,                                                                                                                                                                                                    \
                             ...
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_bank_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED)/WB_ENGINE_OCC_BM_INNER_VARS_NUM)][0]),                                                                  \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_bank_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED)/WB_ENGINE_OCC_BM_INNER_VARS_NUM)][0]->buffer_size),                                                     \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_bank_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED)/WB_ENGINE_OCC_BM_INNER_VARS_NUM)][0]->support_cache),                                                   \
                             VERSION(1));                                                                                                                                                                                                                     \
    }                                                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                              \
    for (i = SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED_INVERSE; i <= SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED_INVERSE_LAST; i+=WB_ENGINE_OCC_BM_INNER_VARS_NUM ) {                                                               \
        SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_OCC_BM_DYNAMIC(i,                                                                                                                                                                                                    \
                             ...
                             SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_TCAM_OCC_BMS_DYNAMIC,                                                                                                                                                                        \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_bank_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED_INVERSE)/WB_ENGINE_OCC_BM_INNER_VARS_NUM)][1]),                                                          \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_bank_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED_INVERSE)/WB_ENGINE_OCC_BM_INNER_VARS_NUM)][1]->buffer_size),                                             \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_bank_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_BANK_ENTRIES_USED_INVERSE)/WB_ENGINE_OCC_BM_INNER_VARS_NUM)][1]->support_cache),                                           \
                             VERSION(1));                                                                                                                                                                                                                     \
    }                                                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                              \
    for (i = SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_DB_BANK_ENTRIES_USED; i <= SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_DB_BANK_ENTRIES_USED_LAST; i+= (WB_ENGINE_OCC_BM_INNER_VARS_NUM * SOC_DPP_DEFS_MAX_TCAM_NOF_BANKS)) {                                                 \
        for (j = 0; j < (SOC_DPP_DEFS_GET_TCAM_NOF_BANKS(unit) * WB_ENGINE_OCC_BM_INNER_VARS_NUM); j+=WB_ENGINE_OCC_BM_INNER_VARS_NUM) {                                                                                                                                        \
            SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_OCC_BM_DYNAMIC(i + j,                                                                                                                                                                                            \
                 ...
                 (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_DB_BANK_ENTRIES_USED)/(WB_ENGINE_OCC_BM_INNER_VARS_NUM * SOC_DPP_DEFS_MAX_TCAM_NOF_BANKS))][j/WB_ENGINE_OCC_BM_INNER_VARS_NUM]),                \
                 (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_DB_BANK_ENTRIES_USED)/(WB_ENGINE_OCC_BM_INNER_VARS_NUM * SOC_DPP_DEFS_MAX_TCAM_NOF_BANKS))][j/WB_ENGINE_OCC_BM_INNER_VARS_NUM]->buffer_size),   \
                 (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_entries_used[((i-SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_TCAM_DB_BANK_ENTRIES_USED)/(WB_ENGINE_OCC_BM_INNER_VARS_NUM * SOC_DPP_DEFS_MAX_TCAM_NOF_BANKS))][j/WB_ENGINE_OCC_BM_INNER_VARS_NUM]->support_cache), \
                 VERSION(1));                                                                                                                                                                                                                                 \
        }                                                                                                                                                                                                                                                     \
    }                                                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                              \
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_HASH_TABLE(SOC_DPP_WB_ENGINE_VAR_TCAM_DB_ENTRY_ID_TO_LOCATION,                                                                                                                                                           \
                         ...
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0]),                                                                                                                                                                     \
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0].init_info.table_size),                                                                                                                                                \
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0].init_info.key_size),                                                                                                                                                  \
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0].hash_data.ptr_size),                                                                                                                                                  \
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0].init_info.table_width),                                                                                                                                               \
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0].hash_data.memory_use->buffer_size),                                                                                                                                   \
                         (Arad_sw_db.arad_device_sw_db[unit]->tcam.entry_id_to_location[0].hash_data.memory_use->support_cache),                                                                                                                                 \
                         VERSION(1));                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                              \
    for (i = SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY; i <= SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY_LAST; i+=WB_ENGINE_SORTED_LIST_INNER_VARS_NUM ) {                                                                                                            \
        SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_SORTED_LIST_DYNAMIC(i,                                                                                                                                                                                               \
                             ...
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0]),                                                                                \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0].init_info.key_size),                                                             \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0].init_info.list_size),                                                            \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0].list_data.ptr_size),                                                             \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0].init_info.data_size),                                                            \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0].list_data.memory_use->buffer_size),                                              \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)][0].list_data.memory_use->support_cache),                                            \
                             VERSION(1));                                                                                                                                                                                                                     \
    }                                                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                              \
    /* arad_sw_db module - sand data structs */                                                                                                                                                                                                               \
   ...
   {                                                                                                                                                                                                                                                          \
    ...
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_HASH_TABLE(SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_VTT_ISEM_KEY_TO_ENTRY_ID,                                                                                                                                                    \
                     ...
                     SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_SAND_DATA_STRUCTS,                                                                                                                                                                                   \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0]),                                                                                                                                                                          \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0].init_info.table_size),                                                                                                                                                     \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0].init_info.key_size),                                                                                                                                                       \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0].hash_data.ptr_size),                                                                                                                                                       \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0].init_info.table_width),                                                                                                                                                    \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0].hash_data.memory_use->buffer_size),                                                                                                                                        \
                     (Arad_sw_db.arad_device_sw_db[unit]->vtt.isem_key_to_entry_id[0].hash_data.memory_use->support_cache),                                                                                                                                      \
                     VERSION(1));                                                                                                                                                                                                                             \
                                                                                                                                                                                                                                                              \
    SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_HASH_TABLE(SOC_DPP_WB_ENGINE_VAR_ARAD_SW_DB_FRWRD_IP_ROUTE_KEY_TO_ENTRY_ID,                                                                                                                                              \
                     ...
                     SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_SAND_DATA_STRUCTS,                                                                                                                                                                                   \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0]),                                                                                                                                                                    \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0].init_info.table_size),                                                                                                                                               \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0].init_info.key_size),                                                                                                                                                 \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0].hash_data.ptr_size),                                                                                                                                                 \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0].init_info.table_width),                                                                                                                                              \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0].hash_data.memory_use->buffer_size),                                                                                                                                  \
                     (Arad_sw_db.arad_device_sw_db[unit]->frwrd_ip.route_key_to_entry_id[0].hash_data.memory_use->support_cache),                                                                                                                                \
                     VERSION(1));                                                                                                                                                                                                                             \
                                                                                                                                                                                                                                                              \
    if (SOC_IS_ARADPLUS(unit) && soc_property_get(unit, spn_BCM886XX_L3_INGRESS_URPF_ENABLE, 0)) {                                                                                                                                                            \
     ...
     SOC_DPP_WB_ENGINE_ADD_VAR_DEPRECATED(SOC_DPP_WB_ENGINE_VAR_ARAD_TM_GUARANTEED_Q_RESOURCE,                                                                                                                                                                \
      ...
      for (i = SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET; i <= (SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET_LAST-1); i+=WB_ENGINE_MULTI_SET_INNER_VARS_NUM ) {                                                                                                        \
         SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_MULTI_SET(i,                                                                                                                                                                                                       \
                                                     ...
                                                     SOC_DPP_WB_ENGINE_BUFFER_CHIP_SIM,                                                                                                                                                                       \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0],                                                                                       \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].init_info.nof_members,                                                                 \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.counter_size,                                                            \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].init_info.max_duplications,                                                            \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.hash_table[0].init_info.table_size,                                         \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.hash_table[0].init_info.key_size,                                           \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.hash_table[0].hash_data.ptr_size,                                           \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.hash_table[0].init_info.table_width,                                        \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->buffer_size,                            \
                                                     Arad_em_blocks[unit][((i-SOC_DPP_WB_ENGINE_VAR_CHIP_SIM_MULTI_SET)/WB_ENGINE_MULTI_SET_INNER_VARS_NUM)].multi_set[0].multiset_data.hash_table[0].hash_data.memory_use->support_cache,                          \
                                                     VERSION(1));                                                                                                                                                                                             \
      }                                                                                                                                                                                                                                                       \
                                                                                                                                                                                                                                                              \
