 ...
 */
#define SOC_SAND_MULTI_SET_ITER_BEGIN(iter) \
  (iter = 0)
/*
 * Check if the multiset iterator arrives to the end of the multiset
 */
#define SOC_SAND_MULTI_SET_ITER_END(iter)  \
...
/*
 * the ADT of multiset, use this type to manipulate the has table.
 */
typedef struct SOC_SAND_MULTI_SET_INFO_T*  SOC_SAND_MULTI_SET_PTR_WORKAROUND;
/*
...
typedef struct {
 ...
 /*
  * saving warm boot variable index get/set of multiset variables.
  */
  int32 wb_var_index;
...
typedef SOC_SAND_MULTI_SET_INFO*  SOC_SAND_MULTI_SET_PTR;
...
*   Mar  6 2008
* FUNCTION:
*     Clear the Multiset without free the memory
* INPUT:
*  SOC_SAND_IN  int                        unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  SOC_SAND_MULTI_SET_INFO   *multi_set -
