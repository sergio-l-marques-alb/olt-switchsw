/* $Id: arad_nif.h,v 1.34 Broadcom SDK $
...
/* If number of lanes of A + B is over 22 included, verify one of the interface has a number of lanes modulo 4 = 0 */
...
#define ARAD_NIF_NOF_MAC_TYPES                             (3) /* 0-XLP and 1-CLP-XMAC and 2-CLP-CMAC */
...
/*********************************************************************
*     Allocate channelize arbiter for channlize interfaces
*********************************************************************/
uint32
...
/*
 *    Convert from Arad NIF-id to internal representation (0 - 31).
 *  Expects ARAD-style indexing
 */
uint32
  arad_nif2intern_id(
    SOC_SAND_IN  int  unit,
...
int arad_port_enable_get(int unit, soc_port_t port, int* enable);
...
uint32 arad_port_link_up_mac_update(int unit, soc_port_t port);
/*Fabric*/
