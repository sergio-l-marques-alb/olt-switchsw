...
#define ARAD_PP_FP_QUAL_HDR_FWD_VLAN_TAG                     SOC_PPC_FP_QUAL_HDR_FWD_VLAN_TAG
#define ARAD_PP_FP_QUAL_HDR_FWD_SA                           SOC_PPC_FP_QUAL_HDR_FWD_SA
#define ARAD_PP_FP_QUAL_HDR_FWD_DA                           SOC_PPC_FP_QUAL_HDR_FWD_DA
#define ARAD_PP_FP_QUAL_HDR_FWD_ETHERTYPE                    SOC_PPC_FP_QUAL_HDR_FWD_ETHERTYPE
#define ARAD_PP_FP_QUAL_HDR_FWD_2ND_VLAN_TAG                 SOC_PPC_FP_QUAL_HDR_FWD_2ND_VLAN_TAG
#define ARAD_PP_FP_QUAL_HDR_INNER_VLAN_TAG                   SOC_PPC_FP_QUAL_HDR_INNER_VLAN_TAG
#define ARAD_PP_FP_QUAL_HDR_INNER_SA                         SOC_PPC_FP_QUAL_HDR_INNER_SA
#define ARAD_PP_FP_QUAL_HDR_INNER_DA                         SOC_PPC_FP_QUAL_HDR_INNER_DA
#define ARAD_PP_FP_QUAL_HDR_INNER_ETHERTYPE                  SOC_PPC_FP_QUAL_HDR_INNER_ETHERTYPE
#define ARAD_PP_FP_QUAL_HDR_INNER_2ND_VLAN_TAG               SOC_PPC_FP_QUAL_HDR_INNER_2ND_VLAN_TAG
#define ARAD_PP_FP_QUAL_HDR_VLAN_FORMAT                      SOC_PPC_FP_QUAL_HDR_VLAN_FORMAT
#define ARAD_PP_FP_QUAL_HDR_VLAN_TAG                   SOC_PPC_FP_QUAL_HDR_VLAN_TAG
#define ARAD_PP_FP_QUAL_HDR_SA                         SOC_PPC_FP_QUAL_HDR_SA
#define ARAD_PP_FP_QUAL_HDR_DA                         SOC_PPC_FP_QUAL_HDR_DA
#define ARAD_PP_FP_QUAL_HDR_ETHERTYPE                  SOC_PPC_FP_QUAL_HDR_ETHERTYPE
#define ARAD_PP_FP_QUAL_HDR_2ND_VLAN_TAG               SOC_PPC_FP_QUAL_HDR_2ND_VLAN_TAG
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_NEXT_PRTCL              SOC_PPC_FP_QUAL_HDR_FWD_IPV4_NEXT_PRTCL
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DF                      SOC_PPC_FP_QUAL_HDR_FWD_IPV4_DF
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_MF                      SOC_PPC_FP_QUAL_HDR_FWD_IPV4_MF
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_SIP                     SOC_PPC_FP_QUAL_HDR_FWD_IPV4_SIP
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DIP                     SOC_PPC_FP_QUAL_HDR_FWD_IPV4_DIP
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_SRC_PORT                SOC_PPC_FP_QUAL_HDR_FWD_IPV4_SRC_PORT
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DEST_PORT               SOC_PPC_FP_QUAL_HDR_FWD_IPV4_DEST_PORT
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_TOS                     SOC_PPC_FP_QUAL_HDR_FWD_IPV4_TOS
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_TCP_CTL                 SOC_PPC_FP_QUAL_HDR_FWD_IPV4_TCP_CTL
#define ARAD_PP_FP_QUAL_HDR_FWD_IPV4_IN_VID                  SOC_PPC_FP_QUAL_HDR_FWD_IPV4_IN_VID
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_NEXT_PRTCL            SOC_PPC_FP_QUAL_HDR_INNER_IPV4_NEXT_PRTCL
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_DF                    SOC_PPC_FP_QUAL_HDR_INNER_IPV4_DF
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_MF                    SOC_PPC_FP_QUAL_HDR_INNER_IPV4_MF
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_SIP                   SOC_PPC_FP_QUAL_HDR_INNER_IPV4_SIP
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_DIP                   SOC_PPC_FP_QUAL_HDR_INNER_IPV4_DIP
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_SRC_PORT              SOC_PPC_FP_QUAL_HDR_INNER_IPV4_SRC_PORT
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_DEST_PORT             SOC_PPC_FP_QUAL_HDR_INNER_IPV4_DEST_PORT
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_TOS                   SOC_PPC_FP_QUAL_HDR_INNER_IPV4_TOS
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_TTL                   SOC_PPC_FP_QUAL_HDR_INNER_IPV4_TTL
#define ARAD_PP_FP_QUAL_HDR_INNER_IPV4_TCP_CTL               SOC_PPC_FP_QUAL_HDR_INNER_IPV4_TCP_CTL
#define ARAD_PP_FP_QUAL_HDR_IPV4_NEXT_PRTCL                  SOC_PPC_FP_QUAL_HDR_IPV4_NEXT_PRTCL
#define ARAD_PP_FP_QUAL_HDR_IPV4_DF                          SOC_PPC_FP_QUAL_HDR_IPV4_DF
#define ARAD_PP_FP_QUAL_HDR_IPV4_MF                          SOC_PPC_FP_QUAL_HDR_IPV4_MF
#define ARAD_PP_FP_QUAL_HDR_IPV4_SIP                         SOC_PPC_FP_QUAL_HDR_IPV4_SIP
#define ARAD_PP_FP_QUAL_HDR_IPV4_DIP                         SOC_PPC_FP_QUAL_HDR_IPV4_DIP
#define ARAD_PP_FP_QUAL_HDR_IPV4_SRC_PORT                    SOC_PPC_FP_QUAL_HDR_IPV4_SRC_PORT
#define ARAD_PP_FP_QUAL_HDR_IPV4_DEST_PORT                   SOC_PPC_FP_QUAL_HDR_IPV4_DEST_PORT
#define ARAD_PP_FP_QUAL_HDR_IPV4_TOS                         SOC_PPC_FP_QUAL_HDR_IPV4_TOS
#define ARAD_PP_FP_QUAL_HDR_IPV4_TTL                         SOC_PPC_FP_QUAL_HDR_IPV4_TTL
#define ARAD_PP_FP_QUAL_HDR_IPV4_TCP_CTL                     SOC_PPC_FP_QUAL_HDR_IPV4_TCP_CTL
#define ARAD_PP_FP_QUAL_HDR_IPV4_L4OPS_HI                    SOC_PPC_FP_QUAL_HDR_IPV4_L4OPS_HI
#define ARAD_PP_FP_QUAL_HDR_IPV4_L4OPS_LOW                   SOC_PPC_FP_QUAL_HDR_IPV4_L4OPS_LOW
#define ARAD_PP_FP_QUAL_HDR_IPV6_SIP_HIGH                    SOC_PPC_FP_QUAL_HDR_IPV6_SIP_HIGH
#define ARAD_PP_FP_QUAL_HDR_IPV6_SIP_LOW                     SOC_PPC_FP_QUAL_HDR_IPV6_SIP_LOW
#define ARAD_PP_FP_QUAL_HDR_IPV6_DIP_HIGH                    SOC_PPC_FP_QUAL_HDR_IPV6_DIP_HIGH
#define ARAD_PP_FP_QUAL_HDR_IPV6_DIP_LOW                     SOC_PPC_FP_QUAL_HDR_IPV6_DIP_LOW
#define ARAD_PP_FP_QUAL_HDR_IPV6_NEXT_PRTCL                  SOC_PPC_FP_QUAL_HDR_IPV6_NEXT_PRTCL
#define ARAD_PP_FP_QUAL_HDR_IPV6_TCP_CTL                     SOC_PPC_FP_QUAL_HDR_IPV6_TCP_CTL
#define ARAD_PP_FP_QUAL_HDR_IPV6_L4OPS                       SOC_PPC_FP_QUAL_HDR_IPV6_L4OPS
#define ARAD_PP_FP_QUAL_HDR_IPV6_TC                          SOC_PPC_FP_QUAL_HDR_IPV6_TC
#define ARAD_PP_FP_QUAL_HDR_IPV6_FLOW_LABEL                  SOC_PPC_FP_QUAL_HDR_IPV6_FLOW_LABEL
#define ARAD_PP_FP_QUAL_HDR_IPV6_HOP_LIMIT                   SOC_PPC_FP_QUAL_HDR_IPV6_HOP_LIMIT
#define ARAD_PP_FP_QUAL_HDR_MPLS_LABEL_FWD                   SOC_PPC_FP_QUAL_HDR_MPLS_LABEL_FWD
#define ARAD_PP_FP_QUAL_HDR_MPLS_LABEL_ID_FWD                SOC_PPC_FP_QUAL_HDR_MPLS_LABEL_ID_FWD
#define ARAD_PP_FP_QUAL_HDR_MPLS_EXP_FWD                     SOC_PPC_FP_QUAL_HDR_MPLS_EXP_FWD
#define ARAD_PP_FP_QUAL_HDR_MPLS_TTL_FWD                     SOC_PPC_FP_QUAL_HDR_MPLS_TTL_FWD
#define ARAD_PP_FP_QUAL_HDR_MPLS_BOS_FWD                     SOC_PPC_FP_QUAL_HDR_MPLS_BOS_FWD
#define ARAD_PP_FP_QUAL_HDR_MPLS_LABEL1                      SOC_PPC_FP_QUAL_HDR_MPLS_LABEL1
#define ARAD_PP_FP_QUAL_HDR_MPLS_EXP1                        SOC_PPC_FP_QUAL_HDR_MPLS_EXP1
#define ARAD_PP_FP_QUAL_HDR_MPLS_TTL1                        SOC_PPC_FP_QUAL_HDR_MPLS_TTL1
#define ARAD_PP_FP_QUAL_HDR_MPLS_BOS1                        SOC_PPC_FP_QUAL_HDR_MPLS_BOS1
#define ARAD_PP_FP_QUAL_HDR_MPLS_LABEL2                      SOC_PPC_FP_QUAL_HDR_MPLS_LABEL2
#define ARAD_PP_FP_QUAL_HDR_MPLS_EXP2                        SOC_PPC_FP_QUAL_HDR_MPLS_EXP2
#define ARAD_PP_FP_QUAL_HDR_MPLS_TTL2                        SOC_PPC_FP_QUAL_HDR_MPLS_TTL2
#define ARAD_PP_FP_QUAL_HDR_MPLS_BOS2                        SOC_PPC_FP_QUAL_HDR_MPLS_BOS2
#define ARAD_PP_FP_QUAL_HDR_MPLS_LABEL3                      SOC_PPC_FP_QUAL_HDR_MPLS_LABEL3
#define ARAD_PP_FP_QUAL_HDR_MPLS_EXP3                        SOC_PPC_FP_QUAL_HDR_MPLS_EXP3
#define ARAD_PP_FP_QUAL_HDR_MPLS_TTL3                        SOC_PPC_FP_QUAL_HDR_MPLS_TTL3
#define ARAD_PP_FP_QUAL_HDR_MPLS_BOS3                        SOC_PPC_FP_QUAL_HDR_MPLS_BOS3
#define ARAD_PP_FP_QUAL_IRPP_SRC_TM_PORT                     SOC_PPC_FP_QUAL_IRPP_SRC_TM_PORT
#define ARAD_PP_FP_QUAL_IRPP_SRC_SYST_PORT                   SOC_PPC_FP_QUAL_IRPP_SRC_SYST_PORT
#define ARAD_PP_FP_QUAL_IRPP_SRC_PP_PORT                     SOC_PPC_FP_QUAL_IRPP_SRC_PP_PORT
#define ARAD_PP_FP_QUAL_IRPP_PROCESSING_TYPE                 SOC_PPC_FP_QUAL_IRPP_PROCESSING_TYPE
#define ARAD_PP_FP_QUAL_IRPP_PKT_HDR_TYPE                    SOC_PPC_FP_QUAL_IRPP_PKT_HDR_TYPE
#define ARAD_PP_FP_QUAL_IRPP_ETH_TAG_FORMAT                  SOC_PPC_FP_QUAL_IRPP_ETH_TAG_FORMAT
#define ARAD_PP_FP_QUAL_IRPP_FWD_DEC_DEST                    SOC_PPC_FP_QUAL_IRPP_FWD_DEC_DEST
#define ARAD_PP_FP_QUAL_IRPP_FWD_DEC_TC                      SOC_PPC_FP_QUAL_IRPP_FWD_DEC_TC
#define ARAD_PP_FP_QUAL_IRPP_FWD_DEC_DP                      SOC_PPC_FP_QUAL_IRPP_FWD_DEC_DP
#define ARAD_PP_FP_QUAL_IRPP_FWD_DEC_CPU_TRAP_CODE           SOC_PPC_FP_QUAL_IRPP_FWD_DEC_CPU_TRAP_CODE
#define ARAD_PP_FP_QUAL_IRPP_FWD_DEC_CPU_TRAP_QUAL           SOC_PPC_FP_QUAL_IRPP_FWD_DEC_CPU_TRAP_QUAL
#define ARAD_PP_FP_QUAL_IRPP_UP                              SOC_PPC_FP_QUAL_IRPP_UP
#define ARAD_PP_FP_QUAL_IRPP_SNOOP_CODE                      SOC_PPC_FP_QUAL_IRPP_SNOOP_CODE
#define ARAD_PP_FP_QUAL_IRPP_LEARN_DECISION_DEST             SOC_PPC_FP_QUAL_IRPP_LEARN_DECISION_DEST
#define ARAD_PP_FP_QUAL_IRPP_LEARN_ADD_INFO                  SOC_PPC_FP_QUAL_IRPP_LEARN_ADD_INFO
#define ARAD_PP_FP_QUAL_IRPP_IN_LIF                          SOC_PPC_FP_QUAL_IRPP_IN_LIF
#define ARAD_PP_FP_QUAL_IRPP_LL_MIRROR_CMD                   SOC_PPC_FP_QUAL_IRPP_LL_MIRROR_CMD
#define ARAD_PP_FP_QUAL_IRPP_SYSTEM_VSI                      SOC_PPC_FP_QUAL_IRPP_SYSTEM_VSI
#define ARAD_PP_FP_QUAL_IRPP_ORIENTATION_IS_HUB              SOC_PPC_FP_QUAL_IRPP_ORIENTATION_IS_HUB
#define ARAD_PP_FP_QUAL_IRPP_VLAN_ID                         SOC_PPC_FP_QUAL_IRPP_VLAN_ID
#define ARAD_PP_FP_QUAL_IRPP_VLAN_PCP                        SOC_PPC_FP_QUAL_IRPP_VLAN_PCP
#define ARAD_PP_FP_QUAL_IRPP_VLAN_DEI                        SOC_PPC_FP_QUAL_IRPP_VLAN_DEI
#define ARAD_PP_FP_QUAL_IRPP_STP_STATE                       SOC_PPC_FP_QUAL_IRPP_STP_STATE
#define ARAD_PP_FP_QUAL_IRPP_FWD_TYPE                        SOC_PPC_FP_QUAL_IRPP_FWD_TYPE
#define ARAD_PP_FP_QUAL_IRPP_SUB_HEADER_NDX                  SOC_PPC_FP_QUAL_IRPP_SUB_HEADER_NDX
#define ARAD_PP_FP_QUAL_IRPP_KEY_CHANGED                     SOC_PPC_FP_QUAL_IRPP_KEY_CHANGED
#define ARAD_PP_FP_QUAL_IRPP_IN_RIF                          SOC_PPC_FP_QUAL_IRPP_IN_RIF
#define ARAD_PP_FP_QUAL_IRPP_VRF                             SOC_PPC_FP_QUAL_IRPP_VRF
#define ARAD_PP_FP_QUAL_IRPP_PCKT_IS_COMP_MC                 SOC_PPC_FP_QUAL_IRPP_PCKT_IS_COMP_MC
#define ARAD_PP_FP_QUAL_IRPP_MY_BMAC                         SOC_PPC_FP_QUAL_IRPP_MY_BMAC
#define ARAD_PP_FP_QUAL_IRPP_IN_TTL                          SOC_PPC_FP_QUAL_IRPP_IN_TTL
#define ARAD_PP_FP_QUAL_IRPP_IN_DSCP_EXP                     SOC_PPC_FP_QUAL_IRPP_IN_DSCP_EXP
#define ARAD_PP_FP_QUAL_IRPP_PACKET_SIZE_RANGE               SOC_PPC_FP_QUAL_IRPP_PACKET_SIZE_RANGE
#define ARAD_PP_FP_QUAL_IRPP_TERM_TYPE                       SOC_PPC_FP_QUAL_IRPP_TERM_TYPE
#define ARAD_PP_FP_QUAL_ERPP_PP_PORT_DATA                    SOC_PPC_FP_QUAL_ERPP_PP_PORT_DATA
#define ARAD_PP_FP_QUAL_ERPP_IPV4_NEXT_PROTOCOL              SOC_PPC_FP_QUAL_ERPP_IPV4_NEXT_PROTOCOL
#define ARAD_PP_FP_QUAL_ERPP_FTMH                            SOC_PPC_FP_QUAL_ERPP_FTMH
#define ARAD_PP_FP_QUAL_ERPP_PAYLOAD                         SOC_PPC_FP_QUAL_ERPP_PAYLOAD
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_0                       SOC_PPC_FP_QUAL_HDR_USER_DEF_0
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_1                       SOC_PPC_FP_QUAL_HDR_USER_DEF_1
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_2                       SOC_PPC_FP_QUAL_HDR_USER_DEF_2
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_3                       SOC_PPC_FP_QUAL_HDR_USER_DEF_3
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_4                       SOC_PPC_FP_QUAL_HDR_USER_DEF_4
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_5                       SOC_PPC_FP_QUAL_HDR_USER_DEF_5
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_6                       SOC_PPC_FP_QUAL_HDR_USER_DEF_6
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_7                       SOC_PPC_FP_QUAL_HDR_USER_DEF_7
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_8                       SOC_PPC_FP_QUAL_HDR_USER_DEF_8
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_9                       SOC_PPC_FP_QUAL_HDR_USER_DEF_9
#define ARAD_PP_FP_QUAL_HDR_USER_DEF_LAST                    SOC_PPC_FP_QUAL_HDR_USER_DEF_LAST
#define ARAD_PP_FP_QUAL_IRPP_LEM_2ND_LKUP_ASD                SOC_PPC_FP_QUAL_IRPP_LEM_2ND_LKUP_ASD
#define ARAD_PP_NOF_FP_QUAL_TYPES                            SOC_PPC_NOF_FP_QUAL_TYPES
typedef SOC_PPC_FP_QUAL_TYPE                                   ARAD_PP_FP_QUAL_TYPE;
                                                               

#define ARAD_PP_FP_ACTION_TYPE_DEST                          SOC_PPC_FP_ACTION_TYPE_DEST
#define ARAD_PP_FP_ACTION_TYPE_DP                            SOC_PPC_FP_ACTION_TYPE_DP
#define ARAD_PP_FP_ACTION_TYPE_TC                            SOC_PPC_FP_ACTION_TYPE_TC
#define ARAD_PP_FP_ACTION_TYPE_TRAP                           SOC_PPC_FP_ACTION_TYPE_TRAP
#define ARAD_PP_FP_ACTION_TYPE_TRAP_REDUCED                  SOC_PPC_FP_ACTION_TYPE_TRAP_REDUCED
#define ARAD_PP_FP_ACTION_TYPE_SNP                           SOC_PPC_FP_ACTION_TYPE_SNP
#define ARAD_PP_FP_ACTION_TYPE_MIRROR                        SOC_PPC_FP_ACTION_TYPE_MIRROR
#define ARAD_PP_FP_ACTION_TYPE_MIR_DIS                       SOC_PPC_FP_ACTION_TYPE_MIR_DIS
#define ARAD_PP_FP_ACTION_TYPE_EXC_SRC                       SOC_PPC_FP_ACTION_TYPE_EXC_SRC
#define ARAD_PP_FP_ACTION_TYPE_IS                            SOC_PPC_FP_ACTION_TYPE_IS
#define ARAD_PP_FP_ACTION_TYPE_METER                         SOC_PPC_FP_ACTION_TYPE_METER
#define ARAD_PP_FP_ACTION_TYPE_COUNTER                       SOC_PPC_FP_ACTION_TYPE_COUNTER
#define ARAD_PP_FP_ACTION_TYPE_STAT                          SOC_PPC_FP_ACTION_TYPE_STAT
#define ARAD_PP_FP_ACTION_TYPE_OUTLIF                        SOC_PPC_FP_ACTION_TYPE_OUTLIF
#define ARAD_PP_FP_ACTION_TYPE_LAG_LB                        SOC_PPC_FP_ACTION_TYPE_LAG_LB
#define ARAD_PP_FP_ACTION_TYPE_ECMP_LB                       SOC_PPC_FP_ACTION_TYPE_ECMP_LB
#define ARAD_PP_FP_ACTION_TYPE_STACK_RT_HIST                 SOC_PPC_FP_ACTION_TYPE_STACK_RT_HIST
#define ARAD_PP_FP_ACTION_TYPE_VSQ_PTR                       SOC_PPC_FP_ACTION_TYPE_VSQ_PTR
#define ARAD_PP_FP_ACTION_TYPE_CHANGE_KEY                    SOC_PPC_FP_ACTION_TYPE_CHANGE_KEY
#define ARAD_PP_FP_ACTION_TYPE_NOP                           SOC_PPC_FP_ACTION_TYPE_NOP
#define ARAD_PP_FP_ACTION_TYPE_EGR_TRAP                      SOC_PPC_FP_ACTION_TYPE_EGR_TRAP
#define ARAD_PP_FP_ACTION_TYPE_EGR_OFP                       SOC_PPC_FP_ACTION_TYPE_EGR_OFP
#define ARAD_PP_FP_ACTION_TYPE_EGR_TC_DP                     SOC_PPC_FP_ACTION_TYPE_EGR_TC_DP
#define ARAD_PP_FP_ACTION_TYPE_EGR_OUTLIF                    SOC_PPC_FP_ACTION_TYPE_EGR_OUTLIF

#define ARAD_PP_FP_ACTION_TYPE_EEI                           SOC_PPC_FP_ACTION_TYPE_EEI
#define ARAD_PP_FP_ACTION_TYPE_IN_PORT                       SOC_PPC_FP_ACTION_TYPE_IN_PORT
#define ARAD_PP_FP_ACTION_TYPE_USER_PRIORITY                 SOC_PPC_FP_ACTION_TYPE_USER_PRIORITY
#define ARAD_PP_FP_ACTION_TYPE_METER_A                       SOC_PPC_FP_ACTION_TYPE_METER_A
#define ARAD_PP_FP_ACTION_TYPE_METER_B                       SOC_PPC_FP_ACTION_TYPE_METER_B
#define ARAD_PP_FP_ACTION_TYPE_COUNTER_A                     SOC_PPC_FP_ACTION_TYPE_COUNTER_A
#define ARAD_PP_FP_ACTION_TYPE_COUNTER_B                     SOC_PPC_FP_ACTION_TYPE_COUNTER_B
#define ARAD_PP_FP_ACTION_TYPE_DP_METER_COMMAND              SOC_PPC_FP_ACTION_TYPE_DP_METER_COMMAND
#define ARAD_PP_FP_ACTION_TYPE_SRC_SYST_PORT                 SOC_PPC_FP_ACTION_TYPE_SRC_SYST_PORT
#define ARAD_PP_FP_ACTION_TYPE_FWD_CODE                      SOC_PPC_FP_ACTION_TYPE_FWD_CODE
#define ARAD_PP_FP_ACTION_TYPE_FWD_OFFSET                    SOC_PPC_FP_ACTION_TYPE_FWD_OFFSET
#define ARAD_PP_FP_ACTION_TYPE_BYTES_TO_REMOVE               SOC_PPC_FP_ACTION_TYPE_BYTES_TO_REMOVE
#define ARAD_PP_FP_ACTION_TYPE_SYSTEM_HEADER_PROFILE_ID      SOC_PPC_FP_ACTION_TYPE_SYSTEM_HEADER_PROFILE_ID
#define ARAD_PP_FP_ACTION_TYPE_VSI                           SOC_PPC_FP_ACTION_TYPE_VSI
#define ARAD_PP_FP_ACTION_TYPE_ORIENTATION_IS_HUB            SOC_PPC_FP_ACTION_TYPE_ORIENTATION_IS_HUB
#define ARAD_PP_FP_ACTION_TYPE_VLAN_EDIT_COMMAND             SOC_PPC_FP_ACTION_TYPE_VLAN_EDIT_COMMAND
#define ARAD_PP_FP_ACTION_TYPE_VLAN_EDIT_VID_1               SOC_PPC_FP_ACTION_TYPE_VLAN_EDIT_VID_1
#define ARAD_PP_FP_ACTION_TYPE_VLAN_EDIT_VID_2               SOC_PPC_FP_ACTION_TYPE_VLAN_EDIT_VID_2
#define ARAD_PP_FP_ACTION_TYPE_VLAN_EDIT_PCP_DEI             SOC_PPC_FP_ACTION_TYPE_VLAN_EDIT_PCP_DEI
#define ARAD_PP_FP_ACTION_TYPE_IN_RIF                        SOC_PPC_FP_ACTION_TYPE_IN_RIF
#define ARAD_PP_FP_ACTION_TYPE_VRF                           SOC_PPC_FP_ACTION_TYPE_VRF
#define ARAD_PP_FP_ACTION_TYPE_IN_TTL                        SOC_PPC_FP_ACTION_TYPE_IN_TTL
#define ARAD_PP_FP_ACTION_TYPE_IN_DSCP_EXP                   SOC_PPC_FP_ACTION_TYPE_IN_DSCP_EXP
#define ARAD_PP_FP_ACTION_TYPE_RPF_DESTINATION_VALID         SOC_PPC_FP_ACTION_TYPE_RPF_DESTINATION_VALID
#define ARAD_PP_FP_ACTION_TYPE_RPF_DESTINATION               SOC_PPC_FP_ACTION_TYPE_RPF_DESTINATION
#define ARAD_PP_FP_ACTION_TYPE_INGRESS_LEARN_ENABLE          SOC_PPC_FP_ACTION_TYPE_INGRESS_LEARN_ENABLE
#define ARAD_PP_FP_ACTION_TYPE_EGRESS_LEARN_ENABLE           SOC_PPC_FP_ACTION_TYPE_EGRESS_LEARN_ENABLE
#define ARAD_PP_FP_ACTION_TYPE_LEARN_FID                     SOC_PPC_FP_ACTION_TYPE_LEARN_FID
#define ARAD_PP_FP_ACTION_TYPE_LEARN_SA_0_TO_15              SOC_PPC_FP_ACTION_TYPE_LEARN_SA_0_TO_15
#define ARAD_PP_FP_ACTION_TYPE_LEARN_SA_16_TO_47             SOC_PPC_FP_ACTION_TYPE_LEARN_SA_16_TO_47
#define ARAD_PP_FP_ACTION_TYPE_LEARN_DATA_0_TO_15            SOC_PPC_FP_ACTION_TYPE_LEARN_DATA_0_TO_15
#define ARAD_PP_FP_ACTION_TYPE_LEARN_DATA_16_TO_39           SOC_PPC_FP_ACTION_TYPE_LEARN_DATA_16_TO_39
#define ARAD_PP_FP_ACTION_TYPE_LEARN_OR_TRANSPLANT           SOC_PPC_FP_ACTION_TYPE_LEARN_OR_TRANSPLANT
#define ARAD_PP_FP_ACTION_TYPE_IN_LIF                        SOC_PPC_FP_ACTION_TYPE_IN_LIF
#define ARAD_PP_FP_ACTION_TYPE_SEQUENCE_NUMBER_TAG           SOC_PPC_FP_ACTION_TYPE_SEQUENCE_NUMBER_TAG
#define ARAD_PP_FP_ACTION_TYPE_IGNORE_CP                     SOC_PPC_FP_ACTION_TYPE_IGNORE_CP
#define ARAD_PP_FP_ACTION_TYPE_PPH_TYPE                      SOC_PPC_FP_ACTION_TYPE_PPH_TYPE
#define ARAD_PP_FP_ACTION_TYPE_PACKET_IS_BOOTP_DHCP          SOC_PPC_FP_ACTION_TYPE_PACKET_IS_BOOTP_DHCP
#define ARAD_PP_FP_ACTION_TYPE_UNKNOWN_ADDR                  SOC_PPC_FP_ACTION_TYPE_UNKNOWN_ADDR
#define ARAD_PP_FP_ACTION_TYPE_FWD_HDR_ENCAPSULATION         SOC_PPC_FP_ACTION_TYPE_FWD_HDR_ENCAPSULATION
#define ARAD_PP_FP_ACTION_TYPE_IEEE_1588                     SOC_PPC_FP_ACTION_TYPE_IEEE_1588
#define ARAD_PP_FP_ACTION_TYPE_OAM                           SOC_PPC_FP_ACTION_TYPE_OAM
#define ARAD_PP_FP_ACTION_TYPE_USER_HEADER_1                 SOC_PPC_FP_ACTION_TYPE_USER_HEADER_1
#define ARAD_PP_FP_ACTION_TYPE_USER_HEADER_2                 SOC_PPC_FP_ACTION_TYPE_USER_HEADER_2
#define ARAD_PP_FP_ACTION_TYPE_NATIVE_VSI                    SOC_PPC_FP_ACTION_TYPE_NATIVE_VSI
#define ARAD_PP_FP_ACTION_TYPE_IN_LIF_PROFILE                SOC_PPC_FP_ACTION_TYPE_IN_LIF_PROFILE
#define ARAD_PP_FP_ACTION_TYPE_INVALID_NEXT                  SOC_PPC_FP_ACTION_TYPE_INVALID_NEXT

#define ARAD_PP_NOF_FP_ACTION_TYPES                          SOC_PPC_NOF_FP_ACTION_TYPES_ARAD
#define ARAD_PP_ACTION_TYPE_INVALID                          SOC_PPC_FP_ACTION_TYPE_INVALID
typedef SOC_PPC_FP_ACTION_TYPE                                 ARAD_PP_FP_ACTION_TYPE;
...
#define  ARAD_PP_FP_NOF_DBS (SOC_PPC_FP_NOF_DBS)

#define ARAD_PMF_NOF_LINES_MAX_ALL_STAGES       SOC_DPP_DEFS_MAX(NOF_INGRESS_PMF_PROGRAM_SELECTION_LINES)
#define ARAD_PMF_NOF_GROUPS                                      (SOC_PPC_FP_NOF_PFGS_ARAD)
#define ARAD_PMF_GROUP_LEN                      (ARAD_BIT_TO_U32(ARAD_PMF_NOF_GROUPS))
...
typedef struct
{
  ...
  */
   ...
   */
  ARAD_PP_FP_ACTION_TYPE action_type;
...
typedef SOC_PPC_FP_DATABASE_INFO                               ARAD_PP_FP_DATABASE_INFO;
...
typedef SOC_PPC_FP_QUAL_TYPE                         			ARAD_PMF_IRPP_INFO_FIELD;
...
typedef struct
{
   ...
   *  IRPP field
   */
  ARAD_PMF_IRPP_INFO_FIELD            irpp_field;
...
typedef struct
{
  ARAD_PMF_IRPP_INFO_FIELD   qual_type;
  int32            msb;
  int32            lsb;
...
typedef SOC_PPC_FP_FEM_ENTRY                                   ARAD_PP_FP_FEM_ENTRY;
...
typedef struct
{
   ...
   */
  SHR_BITDCL pfgs_db_pmb[ARAD_PMF_NOF_GROUPS][ARAD_BIT_TO_U32(ARAD_PMF_NOF_DBS)];
  /*
...
typedef struct
{
    ...
    ARAD_PP_FP_FEM_ENTRY fem_entry[ARAD_PMF_NOF_FEM_PGMS][ARAD_PMF_LOW_LEVEL_NOF_FEMS];
