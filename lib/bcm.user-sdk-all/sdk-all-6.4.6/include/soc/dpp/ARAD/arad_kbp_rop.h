...
uint32 arad_kbp_lut_write(int unit, uint8 addr, arad_kbp_lut_data_t* lut_data, soc_reg_above_64_val_t lut_data_raw); 

uint32 arad_kbp_lut_read(int unit, uint8 addr,arad_kbp_lut_data_t* lut_data, soc_reg_above_64_val_t lut_raw_data);
