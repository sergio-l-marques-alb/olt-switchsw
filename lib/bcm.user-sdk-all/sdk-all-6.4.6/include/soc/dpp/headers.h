...
typedef struct soc_dpp_itmh_s {
    ...
    soc_dpp_itmh_base_t     base;     /* 4 Bytes base header */
    soc_dpp_itmh_sp_ext_t   ext;      /* 2 Bytes Source Port extension header */
#ifdef BCM_ARAD_SUPPORT
    soc_dpp_itmh_dest_ext_t dest_ext; /* 3 Bytes destination information extension header */
#endif
} soc_dpp_itmh_t;
...
typedef enum {
    DPP_HDR_none = 0,
    DPP_HDR_itmh_base,              /* ITMH base header only */
    DPP_HDR_itmh_sp_ext,            /* ITMH base + source port extension */
    DPP_HDR_itmh_dest_ext,          /* ITMH base + destination information extension */
    DPP_HDR_ftmh_base,              /* FTMH base header only */
    DPP_HDR_ftmh_outlif_ext,        /* FTMH base + outlif extension */
    DPP_HDR_ftmh_mc_lb_ext,         /* FTMH base + mc_lb extension */
    DPP_HDR_ftmh_outlif_mc_lb_ext,  /* FTMH base + outlif + mc_lb extensions */
    DPP_HDR_otmh_base,              /* OTMH base header only */
    DPP_HDR_otmh_outlif_ext,        /* OTMH base + outlif extension */
    DPP_HDR_otmh_sp_ext,            /* OTMH base + sp extension */
    DPP_HDR_otmh_dp_ext,            /* OTMH base + dp extension */
    DPP_HDR_otmh_outlif_sp_ext,     /* OTMH base + outlif + sp extensions */
    DPP_HDR_otmh_outlif_dp_ext,     /* OTMH base + outlif + dp extensions */
    DPP_HDR_otmh_sp_dp_ext,         /* OTMH base + sp + dp extensions */
    DPP_HDR_otmh_outlif_sp_dp_ext,  /* OTMH base + outlif + sp + dp 
                                       extensions */
    DPP_HDR_COUNT
}DPP_HDR_hdr_type_t;
...
#define DPP_HDR_MAX_LEN                     (10) /* this should reflect 
                                                    the largest header */
