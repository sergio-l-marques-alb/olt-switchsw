 ...
 */
typedef struct soc_sbx_fe2000_config_s {
    uint32             mm0wx18;
    uint32             mm0n0awidth;
    uint32             mm0n0dwidth;
    uint32             mm0n1awidth;
    ...
    uint32             mm1wawidth;
    uint32             mm1wdwidth;
    sbFe2000InitParams_t init_params;
    sbFe2000XtInitParams_t xt_init_params;
    /* The below elements are valid when soc parameter
     * bcm88020_batch=1 */
    sbFe2000InitPortBatchMap_t batchMap[SB_G2P3_MAX_BATCH_SUPPORTED];
    uint32             maxBatch; /* Maximum batch supported */
...
typedef struct soc_sbx_config_s {
    ...
    union {
        soc_sbx_fe2000_config_t fe2000_cfg;
#ifdef BCM_CALADAN3_SUPPORT
...
#endif
#ifdef BCM_FE2000_SUPPORT
    sbFe2000DdrConfigRwFunc_t   fe2kxt_ddrconfig_rw;
#endif
    /*
     * Add new ones here
     */
...
#define SOC_SBX_CFG_FE2000(unit)  (&(SOC_SBX_CONTROL(unit)->cfg->chip_u.fe2000_cfg))
...
#define SOC_IS_SBX_FE(unit) \
        ((SOC_IS_SBX_FE2000(unit)) || (SOC_IS_SBX_CALADAN3(unit)))
...
#define CFG_FTE_BASE(u,g) \
    ((SOC_IS_SBX_FE2000(u))  ? (SOC_SBX_CFG_FE2000(u)->fteMap[(g)]) : (SOC_SBX_CFG_CALADAN3(u)->fteMap[(g)]))
#else
#define CFG_FTE_BASE(u,g)       SOC_SBX_CFG_FE2000(u)->fteMap[g]
#endif
...
#if defined(BCM_CALADAN3_SUPPORT)
#define SBX_DYNAMIC_VSI_END(u)    \
    ((SOC_IS_SBX_FE2000(u)) ? (SOC_SBX_CFG_FE2000(u)->vsiEnd) : (SOC_SBX_CFG_CALADAN3(u)->vsiEnd))
#else
#define SBX_DYNAMIC_VSI_END(u)    SOC_SBX_CFG_FE2000(u)->vsiEnd
#endif
...
#define SBX_MC_QID_BASE          (SOC_IS_SBX_FE2KXT(unit) ? \
				  soc_property_get(unit, spn_SBX_MC_QID_BASE, (SBX_UC_QID_END + 1)) :  \
				  (SBX_UC_QID_END + 1))
