...
#define KBP_SDK_VERSION "KBP SDK 1.3.8"
...
enum kbp_device_properties {
    ...
    KBP_DEVICE_PROP_LAST_PARITY_ERRORS_STATUS,/**< Last seen parity error address's status of specific device
    ...
    KBP_DEVICE_PROP_READ_TYPE,         /**< read type, 0: read from SM, 1: read from device/model */
    KBP_DEVICE_PROP_DEBUG_LEVEL,       /**< debug level, default 0, non zero value repreaset the level of debug prints */
