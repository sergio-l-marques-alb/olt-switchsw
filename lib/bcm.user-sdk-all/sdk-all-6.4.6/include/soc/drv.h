...
#define SOC_IS_BCM88773(unit) (CMDEV(unit).dev.dev_id == BCM88773_DEVICE_ID)
#define SOC_IS_BCM88773_A1(unit) (CMDEV(unit).dev.dev_id == BCM88773_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88773_A1_REV_ID)
#define SOC_IS_BCM88774(unit) (CMDEV(unit).dev.dev_id == BCM88774_DEVICE_ID)
#define SOC_IS_BCM88774_A1(unit) (CMDEV(unit).dev.dev_id == BCM88774_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88774_A1_REV_ID)
#define SOC_IS_BCM88775(unit) (CMDEV(unit).dev.dev_id == BCM88775_DEVICE_ID)
#define SOC_IS_BCM88775_A1(unit) (CMDEV(unit).dev.dev_id == BCM88775_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88775_A1_REV_ID)
#define SOC_IS_BCM88776(unit) (CMDEV(unit).dev.dev_id == BCM88776_DEVICE_ID)
#define SOC_IS_BCM88776_A1(unit) (CMDEV(unit).dev.dev_id == BCM88776_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88776_A1_REV_ID)
...
#define MRTPS_EM_BLOCK(unit, instance) \
...
#define   SOC_F_RESET              (SOC_F_ATTACHED|SOC_F_INITED|SOC_F_RE_INITED|SOC_F_POLLED|SOC_F_KNET_MODE)
