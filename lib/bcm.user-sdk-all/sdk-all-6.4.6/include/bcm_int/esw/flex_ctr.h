...
bcm_flex_ctr_field_stat_types_get(int unit, uint32 flex_sid, 
                                   bcm_stat_group_mode_attr_selector_t *attr_selectors,
                                   uint32                              *num_selectors);
extern bcm_stat_counter_map_t *stat_counter_map[BCM_MAX_STAT_COUNTER_IDS];

extern void 
_bcm_fill_stat_counter_map(int id, uint32 mode, uint32 pool, uint32 base_idx,
                        bcm_stat_object_t object, bcm_stat_group_mode_t group);
extern void 
_bcm_get_stat_counter_map(int id, bcm_stat_counter_map_t *stat_ctr_map);
...
bcm_field_qualify_t _bcm_esw_stat_get_field_stage_from_stat_ctr(uint32 stat_counter_id);
