...
/*
 * $Id: cint_tm_fap.c,v 1.2 Broadcom SDK $
 *
...
int main(void)
{
    ...
    bcm_gport_t gport_ucast_voq_connector_group[6];
    bcm_gport_t gport_ucast_queue_group[6];
    bcm_gport_t gport_ucast_scheduler[6];
    bcm_gport_t e2e_parent_gport[6];
    int ports[6] = {1,13,14,15,16,17};
    int voq;
