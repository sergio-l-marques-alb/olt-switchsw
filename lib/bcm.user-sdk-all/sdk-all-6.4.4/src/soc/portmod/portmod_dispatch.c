...
int portmod_ext_phy_attach_to_pm(int unit, pm_info_t pm_info, const phymod_core_access_t* ext_phy_access)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_ext_phy_attach_to_pm) {
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_ext_phy_attach_to_pm(unit, pm_info, ext_phy_access);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
