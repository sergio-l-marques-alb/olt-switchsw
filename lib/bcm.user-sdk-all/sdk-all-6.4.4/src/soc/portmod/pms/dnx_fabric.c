...
int dnx_fabric_core_init_phase1(int unit, int port, pm_info_t pm_info, const portmod_port_add_info_t* add_info)
{
    ...
    /* Init Core */
    SOCDNX_IF_ERR_EXIT(dnx_fabric_port_core_access_get(unit, port, pm_info, 0, 1, &core_access, &cores_num, NULL));
...
int dnx_fabric_port_attach(int unit, int port, pm_info_t pm_info, const portmod_port_add_info_t* add_info)
{
    ...
    params.phyn = 0;
    SOCDNX_IF_ERR_EXIT(dnx_fabric_port_phy_lane_access_get(unit, port, pm_info, &params, 1, &phy_access, &phys, NULL));
