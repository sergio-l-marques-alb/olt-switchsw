...
STATIC int
_pm_tx_fir_pre_set (const phymod_core_access_t* core, 
                    int chain_length, uint32 value)
{
    ...
    PM_ITER_ALL_PHYS(rv, phy_idx) {
        ...
        pm_phy = (phymod_phy_access_t *)(&core[phy_idx--]);
...
STATIC int
_pm_tx_fir_main_set (const phymod_core_access_t* core, 
                    int chain_length, uint32 value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
    ...
    if (core == NULL) return SOC_E_INTERNAL;
    PM_ITER_ALL_PHYS(rv, phy_idx) {
...
STATIC int
_pm_tx_fir_post_set (const phymod_core_access_t* core, 
                    int chain_length, uint32 value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_tx_fir_post2_set (const phymod_core_access_t* core,
                    int chain_length, uint32 value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_tx_fir_post3_set (const phymod_core_access_t* core,
                    int chain_length, uint32 value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_per_lane_preemphasis_set (const phymod_core_access_t* core, 
...
STATIC int
_pm_preemphasis_set (const phymod_core_access_t* core, 
                     int chain_length, phymod_tx_t *ln_txparam, 
                     int lane_map, uint32 value) 
{
    ...
    PM_ITER_ALL_PHYS(rv, phy_idx) {
        ...
        /* CHECK: If we need a loop for all internal cores */ 
        ln = 0; 
        while(lane_map) { 
           if (lane_map & 1) {
...
STATIC int
_pm_driver_current_set (const phymod_core_access_t* core,
                     int chain_length, phymod_tx_t *ln_txparam, 
...
STATIC int
_pm_per_lane_driver_current_set (const phymod_core_access_t* core,
                     int chain_length, phymod_tx_t *ln_txparam, 
...
STATIC int
_pm_prbs_tx_poly_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
/* CHECK IF LOOP ON CORE IS NEEDED */
STATIC int
_pm_prbs_rx_poly_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
/* CHECK IF LOOP ON CORE IS NEEDED */
STATIC int
_pm_prbs_tx_invert_data_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
/* CHECK IF LOOP ON CORE IS NEEDED */
STATIC int
_pm_prbs_rx_invert_data_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
/* CHECK IF LOOP ON CORE IS NEEDED */
STATIC int
_pm_prbs_tx_enable_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    uint32_t              flags = 0;
    int                   rv = PHYMOD_E_NONE;
...
/* CHECK IF LOOP ON CORE IS NEEDED */
STATIC int
_pm_prbs_rx_enable_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    uint32_t              flags = 0;
    int                   rv = PHYMOD_E_NONE;
...
STATIC int
_pm_cl72_enable_set(const phymod_core_access_t* core, int chain_length, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    int                   rv = PHYMOD_E_NONE;
    int                   phy_idx = chain_length-1;
 ...
 */
int
pm4x10_phy_control_set (int unit, soc_port_t port, pm_info_t pm_info, 
                        soc_phy_control_t type, phymod_tx_t *ln_txparam, 
                        uint32 lane_map, uint32 value)
{
    phymod_core_access_t core_access[1+MAX_PHYN];
    int rv = PHYMOD_E_NONE, chain_len = 0;

    SOC_IF_ERROR_RETURN (portmod_port_chain_core_access_get(unit, port, pm_info, 
                                               core_access ,(1+MAX_PHYN),
                                               &chain_len));
    switch(type) {

        case SOC_PHY_CONTROL_TX_FIR_PRE:
             rv = _pm_tx_fir_pre_set(core_access, chain_len, value);
             break;

        case SOC_PHY_CONTROL_TX_FIR_MAIN:
             rv = _pm_tx_fir_main_set(core_access, chain_len, value);
             break;

        case SOC_PHY_CONTROL_TX_FIR_POST:
             rv = _pm_tx_fir_post_set(core_access, chain_len, value);
             break;

        case SOC_PHY_CONTROL_TX_FIR_POST2:
             rv = _pm_tx_fir_post2_set(core_access, chain_len, value);
             break;

        case SOC_PHY_CONTROL_TX_FIR_POST3:
             rv = _pm_tx_fir_post3_set(core_access, chain_len, value);
             break;

        /* PREEMPHASIS */
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE0:
             rv = _pm_per_lane_preemphasis_set(core_access, chain_len, ln_txparam, lane_map, 0, value);
             break;
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE1:
             rv = _pm_per_lane_preemphasis_set(core_access, chain_len, ln_txparam, lane_map, 1, value);
             break;
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE2:
             rv = _pm_per_lane_preemphasis_set(core_access, chain_len, ln_txparam, lane_map, 2, value);
             break;
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE3:
             rv = _pm_per_lane_preemphasis_set(core_access, chain_len, ln_txparam, lane_map, 3, value);
             break;

        case SOC_PHY_CONTROL_PREEMPHASIS:
             rv = _pm_preemphasis_set(core_access, chain_len, ln_txparam, lane_map, value);
             break;

        /* DRIVER CURRENT */
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE0:
             rv = _pm_per_lane_driver_current_set(core_access, chain_len, ln_txparam, lane_map, 0, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE1:
             rv = _pm_per_lane_driver_current_set(core_access, chain_len, ln_txparam, lane_map, 1, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE2:
             rv = _pm_per_lane_driver_current_set(core_access, chain_len, ln_txparam, lane_map, 2, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE3:
             rv = _pm_per_lane_driver_current_set(core_access, chain_len, ln_txparam, lane_map, 3, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT:
             rv = _pm_driver_current_set(core_access, chain_len, ln_txparam, lane_map, value);
             break;

        /* decoupled PRBS */
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_POLYNOMIAL:
             rv = _pm_prbs_tx_poly_set(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_INVERT_DATA:
             rv = _pm_prbs_tx_invert_data_set(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_ENABLE:
             rv = _pm_prbs_tx_enable_set(core_access, chain_len, value);
             break; 
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_POLYNOMIAL:
             rv = _pm_prbs_rx_poly_set(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_INVERT_DATA:
             rv = _pm_prbs_rx_invert_data_set(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE:
             rv = _pm_prbs_rx_enable_set(core_access, chain_len, value);
             break;
        ...
        case SOC_PHY_CONTROL_CL72:
             rv = _pm_cl72_enable_set(core_access, chain_len, value);
             break;
...
STATIC int
_pm_tx_fir_pre_get (const phymod_core_access_t* core, 
                    int chain_length, uint32 *value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_tx_fir_main_get (const phymod_core_access_t* core, 
                    int chain_length, uint32 *value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_tx_fir_post_get (const phymod_core_access_t* core, 
                    int chain_length, uint32 *value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_tx_fir_post2_get (const phymod_core_access_t* core,
                    int chain_length, uint32 *value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_tx_fir_post3_get (const phymod_core_access_t* core,
                    int chain_length, uint32 *value)
{
    phymod_phy_access_t* pm_phy;
    phymod_tx_t          phymod_tx;
...
STATIC int
_pm_per_lane_preemphasis_get (const phymod_core_access_t* core, 
                              int chain_length, phymod_tx_t *ln_txparam, 
                              int lane_map, int lane, uint32 *value) 
{
    phymod_phy_access_t  pm_phy_copy, *pm_phy;
...
STATIC int
_pm_per_lane_driver_current_get (const phymod_core_access_t* core,
                     int chain_length, phymod_tx_t *ln_txparam, 
                     uint32 lane_map, int lane, uint32 *value)
{
    phymod_phy_access_t  pm_phy_copy, *pm_phy;
...
STATIC int
_pm_prbs_tx_poly_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
STATIC int
_pm_prbs_rx_poly_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
STATIC int
_pm_prbs_tx_invert_data_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
STATIC int
_pm_prbs_rx_invert_data_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_prbs_t         prbs;
    uint32_t              flags = 0;
...
STATIC int
_pm_prbs_tx_enable_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    uint32_t              flags = 0;
    int                   rv = PHYMOD_E_UNAVAIL;
...
STATIC int
_pm_prbs_rx_enable_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    uint32_t              flags = 0;
    int                   rv = PHYMOD_E_UNAVAIL;
...
STATIC int
_pm_prbs_rx_status_get(const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t    *pm_phy;
...
STATIC int
_pm_cl72_enable_get (const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
...
STATIC int
_pm_cl72_status_get (const phymod_core_access_t* core, int chain_length, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_cl72_status_t  status;
    int                   rv = PHYMOD_E_UNAVAIL;
 ...
 */
int
pm4x10_phy_control_get(int unit, soc_port_t port, pm_info_t pm_info,
                        soc_phy_control_t type, phymod_tx_t *ln_txparam, 
                        uint32 lane_map, uint32 *value)
{
    phymod_core_access_t core_access[1+MAX_PHYN];
    ...
    switch(type) {
        ...
        case SOC_PHY_CONTROL_TX_FIR_PRE:
             rv = _pm_tx_fir_pre_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_TX_FIR_MAIN:
             rv = _pm_tx_fir_main_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_TX_FIR_POST:
             rv = _pm_tx_fir_post_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_TX_FIR_POST2:
             rv = _pm_tx_fir_post2_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_TX_FIR_POST3:
             rv = _pm_tx_fir_post3_get(core_access, chain_len, value);
             break;

        /* PREEMPHASIS */
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE0:
             rv = _pm_per_lane_preemphasis_get(core_access, chain_len, ln_txparam, lane_map, 0, value);
             break;
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE1:
             rv = _pm_per_lane_preemphasis_get(core_access, chain_len, ln_txparam, lane_map, 1, value);
             break;
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE2:
             rv = _pm_per_lane_preemphasis_get(core_access, chain_len, ln_txparam, lane_map, 2, value);
             break;
        case SOC_PHY_CONTROL_PREEMPHASIS_LANE3:
             rv = _pm_per_lane_preemphasis_get(core_access, chain_len, ln_txparam, lane_map, 3, value);
             break;

        /* DRIVER CURRENT */
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE0:
             rv = _pm_per_lane_driver_current_get(core_access, chain_len, ln_txparam, lane_map,  0, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE1:
             rv = _pm_per_lane_driver_current_get(core_access, chain_len,  ln_txparam, lane_map, 1, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE2:
             rv = _pm_per_lane_driver_current_get(core_access, chain_len,  ln_txparam, lane_map, 2, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT_LANE3:
             rv = _pm_per_lane_driver_current_get(core_access, chain_len,  ln_txparam, lane_map, 3, value);
             break;
        case SOC_PHY_CONTROL_DRIVER_CURRENT:
             rv = _pm_per_lane_driver_current_get(core_access, chain_len,  ln_txparam, lane_map, 0, value);
             break;
        ...
        /* PRBS */
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_POLYNOMIAL:
             rv = _pm_prbs_tx_poly_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_INVERT_DATA:
             rv = _pm_prbs_tx_invert_data_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_ENABLE:
             rv = _pm_prbs_tx_enable_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_POLYNOMIAL:
             rv = _pm_prbs_rx_poly_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_INVERT_DATA:
             rv = _pm_prbs_rx_invert_data_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE:
             rv = _pm_prbs_rx_enable_get(core_access, chain_len, value);
             break;
        case SOC_PHY_CONTROL_PRBS_POLYNOMIAL:
             rv = _pm_prbs_tx_poly_get(core_access, chain_len, value);
             break;
        ...
        case SOC_PHY_CONTROL_PRBS_RX_STATUS:
            rv = _pm_prbs_rx_status_get(core_access, chain_len, value);
            break;
        case SOC_PHY_CONTROL_CL72:
            rv = _pm_cl72_enable_get(core_access, chain_len, value);
            break;
        case SOC_PHY_CONTROL_CL72_STATUS:
            rv = _pm_cl72_status_get(core_access, chain_len, value);
            break;
