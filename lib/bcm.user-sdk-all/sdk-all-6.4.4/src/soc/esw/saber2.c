...
#define _SOC_SB2_DEFIP_MAX_TCAMS   6
...
/* USED IN FLEX-IO OPERATION.. NEEDS TO BE REVISITED as it is not actually required */
sb2_port_speeds_t *sb2_port_speeds_s[] = {
               (sb2_port_speeds_t*)sb2_port_speeds_56260_0,     /* Dummy */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* 56460_1 Cfg=1:IntCfg=1 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56460_2 Cfg=2:IntCfg=2 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56460_3 Cfg=3:IntCfg=3 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56460_4 Cfg=4:IntCfg=4 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56460_5 Cfg=5:IntCfg=5 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56460_6 Cfg=6:IntCfg=6 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56462_1 Cfg=1:IntCfg=7 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56462_2 Cfg=2:IntCfg=8 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56463_1 Cfg=1:IntCfg=9 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56463_2 Cfg=2:IntCfg=10 */
               (sb2_port_speeds_t*)sb2_port_speeds_56460_1,     /* Dummy 56463_3 Cfg=3:IntCfg=11 */
               (sb2_port_speeds_t*)sb2_port_speeds_56260_1,     /* 56260 Cfg=1:IntCfg=12 */
               (sb2_port_speeds_t*)sb2_port_speeds_56260_1,     /* 56260 Cfg=2:IntCfg=13 */
               (sb2_port_speeds_t*)sb2_port_speeds_56260_1,     /* 56262 Cfg=1:IntCfg=14 */
               (sb2_port_speeds_t*)sb2_port_speeds_56260_1,     /* 56262 Cfg=2:IntCfg=15 */
               (sb2_port_speeds_t*)sb2_port_speeds_56260_1,     /* 56263 Cfg=1:IntCfg=16 */
               (sb2_port_speeds_t*)sb2_port_speeds_56260_1,     /* 56263 Cfg=2:IntCfg=17 */
};
...
const static soc_port_details_t sb2_port_details_56460_1[]={
    {1,24,1,GE_PORT,1000},
...
const static soc_port_details_t sb2_port_details_56460_2[]={
    {1,21,4,XE_PORT,10000},
...
const static soc_port_details_t sb2_port_details_56460_3[]={
    {1,5,4, XE_PORT,10000},
    {9,20,1,GE_PORT,1000},
    {21,21,1,XE_PORT,10000},
...
const static soc_port_details_t sb2_port_details_56460_4[]={
    {1,9,4, XE_PORT,10000},
    {13,15,2,GE_PORT,1000},
    {21,21,1,XE_PORT,10000},
    {25,27,2,XE_PORT,10000},
    {26,28,2,GE_PORT,1000},
    {0,0,0,0} /* End */
...
const static soc_port_details_t sb2_port_details_56460_5[]={
    {1,9,4, XE_PORT,10000},
...
const static soc_port_details_t sb2_port_details_56460_6[]={
    {1,1,1, XE_PORT,10000},
    {5,8,1, GE_PORT,1000},
    {17,20,1, GE_PORT,1000},
    {21,21,1,XE_PORT,10000},
...
const static soc_port_details_t sb2_port_details_56462_1[]={
    {1,9,4, XE_PORT,10000},
    {13,24,1, GE_PORT,1000},
...
const static soc_port_details_t sb2_port_details_56462_2[]={
    {1,5,4, XE_PORT,10000},
    {13,24,1, GE_PORT,1000},
    {25,27,2,XE_PORT,10000},
    {26,28,2,GE_PORT,1000},
...
const static soc_port_details_t sb2_port_details_56463_1[]={
    {1,8,1, GE_PORT,1000},
...
const static soc_port_details_t sb2_port_details_56463_2[]={
    {1,24,1, GE_PORT,1000},
...
const static soc_port_details_t sb2_port_details_56463_3[]={
    {1,4,1, GE_PORT,1000},
    {5,21,16,XE_PORT,10000},
    {25,25,1,XE_PORT,10000},
    {0,0,0,0} /* End */
};
...
const static soc_port_details_t sb2_port_details_56260_1[]={
    {1, 8, 1,GE_PORT,2500},
...
const static soc_port_details_t sb2_port_details_56260_2[]={
    {1, 5, 4,XE_PORT,10000},
    {21,21,1,XE_PORT,10000},
    {25,27,2,XE_PORT,10000},
    {26,28,2,GE_PORT,1000},
...
const static soc_port_details_t sb2_port_details_56262_1[]={
    {1, 8, 1,GE_PORT,2500},
    {0,0,0,0} /* End */
};

/* 56262_2: bcm5626x_config = 2 */
/* F.XAUI F.XAUI - - - - 4x2.5G	2.5G EA	75 MHz	34.5G */
static uint32 sb2_tdm_EA_56262_2[SB2_TDM_EA_SIZE]={0}; /* Filled up Runtime */
const  static sb2_speed_t sb2_speed_56262_2 = {
       10000, 0000, 0000, 0000,      /* 1  - 4  */
       10000, 0000, 0000, 0000,      /* 5  - 8  */
       0000, 0000, 0000, 0000,      /* 9  - 12 */
       0000, 0000, 0000, 0000,      /* 13 - 16 */
...
const static soc_port_details_t sb2_port_details_56262_2[]={
    {1, 5, 4,XE_PORT,10000},
    {25, 28, 1,GE_PORT,2500},
    {0,0,0,0} /* End */
};
...
const static soc_port_details_t sb2_port_details_56263_1[]={
    {1, 8, 1,GE_PORT,1000},
    {21, 28, 1,GE_PORT,1000},
    {0,0,0,0} /* End */
};
...
const static soc_port_details_t sb2_port_details_56263_2[]={
    {1, 3, 1,GE_PORT,1000},
    {5, 7, 1,GE_PORT,1000},
    {0,0,0,0} /* End */
};
...
static uint32 *bcm56260_tdm[]={
               ...
               sb2_tdm_EA_56262_2,    /* 56262 Cfg=2:IntCfg=15 */
               sb2_tdm_A1A_56263_1,    /* 56263 Cfg=1:IntCfg=16 */
               sb2_tdm_A1_56263_2,    /* 56263 Cfg=2:IntCfg=17 */
};
const static uint32 *bcm56260_speed_s[]={
               ...
               sb2_speed_56262_2,                /* 56262 Cfg=2:IntCfg=15 */
               sb2_speed_56263_1,                /* 56263 Cfg=1:IntCfg=16 */
               sb2_speed_56263_2,                /* 56263 Cfg=2:IntCfg=17 */
};
static sb2_speed_t *bcm56260_speed[SOC_MAX_NUM_DEVICES]={NULL};
...
const static soc_port_details_t  *sb2_port_details[]={
               ...
               sb2_port_details_56262_2,          /* 56262 Cfg=2:IntCfg=15 */
               sb2_port_details_56263_1,          /* 56263 Cfg=1:IntCfg=16 */
               sb2_port_details_56263_2,          /* 56263 Cfg=2:IntCfg=17 */
};
...
static bcm56260_tdm_info_t bcm56260_tdm_info[]={
            ...
            /* 56262_2 Cfg=2:IntCfg=15 */
            {SB2_TDM_EA_FREQ, SB2_TDM_EA_SIZE, SB2_TDM_EA_ROW, SB2_TDM_EA_COL},

            /* 56263_1 Cfg=1:IntCfg=16 */
            {SB2_TDM_A1A_FREQ, SB2_TDM_A1A_SIZE, SB2_TDM_A1A_ROW, SB2_TDM_A1A_COL},
            /* 56263_2 Cfg=1:IntCfg=17 */
...
STATIC _soc_saber2_counter_info_t _soc_saber2_counter_info[] = {
    ...
    { _SOC_COUNTER_TYPE_DROP_ENQ_GREEN, 0x0, 3 },
    /* yellow pkt drops, index = ACCEPT=1'b0, COLOR=2'b11 */
    { _SOC_COUNTER_TYPE_DROP_ENQ_YELLOW, 0x3, 4 },
    /* red pkt drops, index = ACCEPT=1'b0, COLOR=2'b01 */
    { _SOC_COUNTER_TYPE_DROP_ENQ_RED, 0x1, 5 },
    /* green accepted pkts, index = ACCEPT=1'b1, COLOR=2'b00 */
    { _SOC_COUNTER_TYPE_ACCEPT_ENQ_GREEN, 0x4, 6 },
    /* yellow accepted pkts, index = ACCEPT=1'b1, COLOR=2'b11 */
    { _SOC_COUNTER_TYPE_ACCEPT_ENQ_YELLOW, 0x7, 7 },
    /* red accepted pkts, index = ACCEPT=1'b1, COLOR=2'b01 */
    { _SOC_COUNTER_TYPE_ACCEPT_ENQ_RED, 0x5, 8 },
    { _SOC_COUNTER_TYPE_ACCEPT_DEQ, 0, 4 } 
};
...
typedef struct _soc_sb2_mmu_params {
...
typedef struct _soc_sb2_mmu_intermediate_results {
...
STATIC int
_soc_saber_tspll_bspll_config(int unit)
{
    uint32 rval;
   ...
   /* Both BSPLLs configured the same, for 20MHz output by default */
    ...
    bsl_printf("bs_ndiv_high : 0x%x bs_ndiv_low: 0x%x\n", bs_ndiv_high, bs_ndiv_low);
...
int _soc_saber2_misc_init(int unit)
{
    ...
    if(!(SAL_BOOT_BCMSIM || SAL_BOOT_PLISIM || SAL_BOOT_XGSSIM)) {
        if (soc_feature(unit, soc_feature_ddr3)) {
            ...
            if (SOC_WARM_BOOT(unit)) {
                ...
                SOC_DDR3_NUM_COLUMNS(unit) = soc_property_get(unit,
                                                spn_EXT_RAM_COLUMNS,
                                                1024);
    ...
    if ((soc_feature(unit, soc_feature_linkphy_coe) &&
         ...
         my_modid_list[1] = 1;
         my_modid_valid[1] = 1;
         my_modid_port_base_ptr[1] = _BCM_SB2_SUBPORT_PP_PORT_INDEX_MIN;
    }
    ...
    _soc_saber_tspll_bspll_config(unit);
...
#define SB2_MAX_TDM_FREQUENCY 15
...
void soc_saber2_save_tdm_pos(int unit, uint32 new_tdm_size,uint32 *new_tdm) {
    ...
    for (pos = 0; pos < new_tdm_size ; pos++) {
         port= new_tdm[pos];
         if ((port == SB2_IDLE) || (port == SB2_LPBK) || (port == SB2_CMIC)) {
              continue;
         }
...
_soc_saber2_mmu_tdm_init(int unit) 
{
    ...
    case BCM56468_DEVICE_ID:
        ...
        case BCM56262_DEVICE_ID_OFFSET_CFG + 1:
             ...
             lpbk_port_speed=2500;
             break;
        case BCM56262_DEVICE_ID_OFFSET_CFG + 2:
             /* 56262_2 */
             /* F.XAUI	F.XAUI	- - - -	4x2.5G	2.5G EA	75 MHz	34.5G */
             sal_memcpy(arr,
                        &sb2_tdm_56260_EA_ref[0],sizeof(sb2_tdm_56260_EA_ref));
             sb2_tdm_replace(arr,tdm_size, 2, 1, 0);
             sb2_tdm_replace(arr,tdm_size, 3, 1, 0);
             sb2_tdm_replace(arr,tdm_size, 4, 1, 0);
             sb2_tdm_replace(arr,tdm_size, 6, 5, 0);
             sb2_tdm_replace(arr,tdm_size, 7, 5, 0);
             sb2_tdm_replace(arr,tdm_size, 8, 5, 0);
             lpbk_port_speed=2500;
             break;
...
soc_error_t soc_saber2_get_xl_phy_core_port_mode(
    ...
    case 1: *phy_mode=bcmXlPhyPortModeSingle;
           ...
           break;
    case 2:
           if (num_ports == SOC_PORT_NUM(unit, xl)) {
                *phy_mode=bcmXlPhyPortModeQuad;
    ...
    LOG_VERBOSE(BSL_LS_SOC_COMMON, (BSL_META_U(unit,
            "Setting XLPort Phy and Core mode to Quad\n")));
    *phy_mode=bcmXlPhyPortModeQuad;
    *core_mode=bcmXlCorePortModeQuad;
...
int _soc_saber2_mmu_init_helper(int unit)
{
    ...
    soc_cm_get_id(unit, &dev_id, &rev_id);
    /* C12 */
    _soc_sb2_mmu_params.packing_mode_d_c =  soc_property_get(unit, 
...
/* Enable back pressure status from MMU for lossless mode */
    ...
    /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    for (sub_port = SB2_MIN_SUBPORT_INDEX;
         sub_port <= SB2_MAX_SUBPORTS;
         sub_port ++) {
...
_soc_saber2_mmu_port_init(int unit) {
    ...
    int         depth, threshold, port_bw, start_threshold;
    int         port, block_port, first_port = -1, last_port = -1, block, loop;
...
STATIC int
_soc_saber2_perq_flex_counters_init(int unit)
{
    ...
    soc_reg_field_set (unit, CTR_SYS_CONTROLr, &rval, DEQ_FIRST_BRICKf, seg);
    soc_reg_field_set (unit, CTR_SYS_CONTROLr, &rval, DEQ_LAST_BRICKf, seg + 1);
    SOC_IF_ERROR_RETURN (WRITE_CTR_SYS_CONTROLr (unit, rval));

    /* set enq stats config */
    for (i = _SOC_COUNTER_TYPE_DROP_ENQ;
         i < _SOC_COUNTER_TYPE_ACCEPT_DEQ; i++) {

        if (!soc_feature(unit, soc_feature_cosq_gport_stat_ability) &&
                (i != _SOC_COUNTER_TYPE_DROP_ENQ) && 
       ...
       if (i == _SOC_COUNTER_TYPE_DROP_ENQ) {
           rval = 0;
            ...
            SOC_IF_ERROR_RETURN
                (soc_reg32_set(unit, CTR_ENQ_STATS_CFGr,
                       REG_PORT_ANY,
                       counter_info[_SOC_COUNTER_TYPE_DROP_ENQ_GREEN].index,
                       rval));
            SOC_IF_ERROR_RETURN
                (soc_reg32_set(unit, CTR_ENQ_STATS_CFGr, 
                         REG_PORT_ANY, 
                         counter_info[_SOC_COUNTER_TYPE_DROP_ENQ_RED].index,
                         rval));
            SOC_IF_ERROR_RETURN
                (soc_reg32_set(unit, CTR_ENQ_STATS_CFGr,
                         REG_PORT_ANY, 
                         counter_info[_SOC_COUNTER_TYPE_DROP_ENQ_YELLOW].index,
                         rval));
        } else if (i == _SOC_COUNTER_TYPE_ACCEPT_ENQ) {
            rval = 0 ;
            soc_reg_field_set(unit, CTR_ENQ_STATS_CFGr, &rval, ACTIVE0f, 1);
            soc_reg_field_set(unit, CTR_ENQ_STATS_CFGr, &rval, SEG0f, seg);
            SOC_IF_ERROR_RETURN
                (soc_reg32_set(unit, CTR_ENQ_STATS_CFGr,
                         REG_PORT_ANY,
                         counter_info[_SOC_COUNTER_TYPE_ACCEPT_ENQ_GREEN].index,
                         rval));
            SOC_IF_ERROR_RETURN
                (soc_reg32_set(unit, CTR_ENQ_STATS_CFGr,
                        REG_PORT_ANY,
                        counter_info[_SOC_COUNTER_TYPE_ACCEPT_ENQ_RED].index,
                        rval));
            SOC_IF_ERROR_RETURN
                (soc_reg32_set(unit, CTR_ENQ_STATS_CFGr,
                        REG_PORT_ANY, 
                        counter_info[_SOC_COUNTER_TYPE_ACCEPT_ENQ_YELLOW].index,
                        rval));
        } else {
            SOC_IF_ERROR_RETURN
...
_soc_saber2_mmu_init(int unit)
{
    ...
    if (soc_feature(unit, soc_feature_ddr3)) {
        ...
        soc_reg_field_set(unit, EMC_CFGr, &rval, NUM_CISf, 2);
        ...
        soc_reg_field_set(unit, EMC_FREE_POOL_SIZESr, &rval, RSFP_SIZEf, 0x80);
    ...
    if(!(SAL_BOOT_BCMSIM || SAL_BOOT_PLISIM || SAL_BOOT_XGSSIM)) {
        ...
        for(i=0; i<16; i++) {
            SOC_IF_ERROR_RETURN(READ_TOQ_EXT_MEM_BW_MAP_TABLEr(unit, i,
                                &rval));
            soc_reg_field_set(unit, TOQ_EXT_MEM_BW_MAP_TABLEr, &rval,
                                                GBL_GUARENTEE_BW_LIMITf,
                                                0x1C2);
            soc_reg_field_set(unit, TOQ_EXT_MEM_BW_MAP_TABLEr, &rval,
                                                WR_PHASEf, wr_phase);
            soc_reg_field_set(unit, TOQ_EXT_MEM_BW_MAP_TABLEr, &rval,
    ...
    SOC_IF_ERROR_RETURN(_soc_saber2_perq_flex_counters_init(unit));
...
#if 0
             sop->memState[EGR_VLAN_XLATEm].index_max = 4095;
#endif
             break;
        }
    }
...
STATIC int
_soc_saber2_mdio_addr_to_port(uint32 phy_addr)
{
#if 0
                              ...
                              uint32 phy_reg, uint32 phy_data)
{
    ...
    phy_port = _soc_saber2_mdio_addr_to_port(phy_addr);
...
soc_saber2_pbmp_init(int unit, sb2_pbmp_t sb2_pbmp) 
{
    ...
    soc_port_details_t  *sb2_selected_port_details=NULL;
   ...
   LOG_DEBUG(BSL_LS_SOC_COMMON, (BSL_META_U(unit,
    ...
    sal_memcpy(sb2_port_speeds[unit], (sb2_port_speeds_s[sb2_port_details_index]),
    ...
    sb2_selected_port_details= (soc_port_details_t *)
   ...
   LOG_DEBUG(BSL_LS_SOC_COMMON, (BSL_META_U(unit,
    ...
    /* Fill in pbmps */
    loop_index=0;
    while(sb2_selected_port_details[loop_index].port_speed != 0) {
          LOG_VERBOSE(BSL_LS_SOC_COMMON, (BSL_META_U(unit, 
        ...
        for (port =  sb2_selected_port_details[loop_index].start_port_no;
           ...
           port += sb2_selected_port_details[loop_index].port_incr) {
            ...
            if (sb2_selected_port_details[loop_index].port_type & GE_PORT) {
                ...
                switch(sb2_selected_port_details[loop_index].port_speed) {
                    case 1000:
                        if ((port >=1) && (port <= 24)) {
                            SOC_PBMP_PORT_ADD(*sb2_pbmp.pbmp_mxq1g, port);
                        } else {
                            SOC_PBMP_PORT_ADD(*sb2_pbmp.pbmp_xl1g, port);
                            /* For 1G multi lanes is not supported during init */
            ...
            if ((sb2_selected_port_details[loop_index].port_type & XE_PORT) || 
                ...
                if ((port >=1) && (port <= 24)) {
                     ...
                     /* Even if port_incr is 2, the eagle lanes is set to 1 */
                     /* Refer config bcm56260 config 2 */
            ...
            si->port_num_lanes[port] = soc_property_port_get(unit, port, 
                    spn_PORTGROUP, si->port_num_lanes[port]);
        } /* for port */
...
soc_saber2_subport_init(int unit)
{
    ...
    available_subport = SB2_MAX_SUBPORTS;
    prev_port = 0;
    si->port_num_subport[prev_port] = 0;
    si->port_subport_base[prev_port] = SB2_MIN_SUBPORT_INDEX;
    ...
    if (SOC_PBMP_NOT_NULL(si->linkphy_pbm)) {
        ...
        SOC_PBMP_ITER(si->linkphy_pbm, port) {
            if (port < SOC_MAX_NUM_PORTS) {
                ...
                if (num_subport > SB2_MAX_LINKPHY_SUBPORTS_PER_PORT) {
                    num_subport = SB2_MAX_LINKPHY_SUBPORTS_PER_PORT;
                }
