/*
 * $Id: sbZfCaLrpDescriptorConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaLrpDescriptor_Print(sbZfCaLrpDescriptor_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: contbyte=0x%02x"), (unsigned int)  pFromStruct->m_uContinueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: hdr4=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderType4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: locn0=0x%02x"), (unsigned int)  pFromStruct->m_uLocation0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: locn5=0x%02x"), (unsigned int)  pFromStruct->m_uLocation5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: str=0x%01x"), (unsigned int)  pFromStruct->m_uStreamSelector));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" tc=0x%01x"), (unsigned int)  pFromStruct->m_uTruncationCommand));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: hccpy=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderCopy));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mirridx=0x%01x"), (unsigned int)  pFromStruct->m_uMirrorIndex));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: dropbit=0x%01x"), (unsigned int)  pFromStruct->m_uDropBit));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" enq=0x%01x"), (unsigned int)  pFromStruct->m_uEnqueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" dqueue=0x%02x"), (unsigned int)  pFromStruct->m_uDestinationQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: packmark=0x%01x"), (unsigned int)  pFromStruct->m_uPacketMarking));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv1=0x%01x"), (unsigned int)  pFromStruct->m_uResv1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" frmlen=0x%04x"), (unsigned int)  pFromStruct->m_uFrameLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv2=0x%08x"), (unsigned int)  pFromStruct->m_uResv2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: resv3=0x%08x"), (unsigned int)  pFromStruct->m_uResv3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata3=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata7=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata11=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata15=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte15));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata19=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte19));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata23=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte23));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata27=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte27));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata31=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte31));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata35=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte35));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata39=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte39));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata43=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte43));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata47=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte47));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata51=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte51));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata55=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte55));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata59=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte59));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata63=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte63));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata67=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte67));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata71=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte71));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata75=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte75));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata79=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte79));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata83=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte83));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata87=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte87));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata91=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte91));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata95=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte95));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata99=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte99));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata103=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte103));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata107=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte107));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata111=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte111));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata115=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte115));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata119=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte119));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata123=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte123));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata127=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte127));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata131=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte131));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata135=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte135));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata139=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte139));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata143=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte143));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata147=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte147));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata151=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte151));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaLrpDescriptor:: pdata155=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte155));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaLrpDescriptor_SPrint(sbZfCaLrpDescriptor_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
