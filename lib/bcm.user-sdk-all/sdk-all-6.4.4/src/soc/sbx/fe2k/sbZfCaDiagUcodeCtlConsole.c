/*
 * $Id: sbZfCaDiagUcodeCtlConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaDiagUcodeCtl_Print(sbZfCaDiagUcodeCtl_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaDiagUcodeCtl:: status=0x%01x"), (unsigned int)  pFromStruct->m_ulStatus));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaDiagUcodeCtl:: ucloaded=0x%01x"), (unsigned int)  pFromStruct->m_ulUcLoaded));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaDiagUcodeCtl:: memexst2=0x%01x"), (unsigned int)  pFromStruct->m_ulMemExstMm0W));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaDiagUcodeCtl:: testoffset=0x%05x"), (unsigned int)  pFromStruct->m_ulTestOffset));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
