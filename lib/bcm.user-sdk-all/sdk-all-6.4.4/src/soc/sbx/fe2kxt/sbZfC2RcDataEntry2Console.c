...
sbZfC2RcDataEntry2_Print(sbZfC2RcDataEntry2_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data39=0x%08x"), (unsigned int)  pFromStruct->m_uData39));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data36=0x%08x"), (unsigned int)  pFromStruct->m_uData36));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data33=0x%08x"), (unsigned int)  pFromStruct->m_uData33));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data30=0x%08x"), (unsigned int)  pFromStruct->m_uData30));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data27=0x%08x"), (unsigned int)  pFromStruct->m_uData27));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data24=0x%08x"), (unsigned int)  pFromStruct->m_uData24));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data21=0x%08x"), (unsigned int)  pFromStruct->m_uData21));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data18=0x%08x"), (unsigned int)  pFromStruct->m_uData18));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data15=0x%08x"), (unsigned int)  pFromStruct->m_uData15));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data12=0x%08x"), (unsigned int)  pFromStruct->m_uData12));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data9=0x%08x"), (unsigned int)  pFromStruct->m_uData9));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data7=0x%06x"), (unsigned int)  pFromStruct->m_uData7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data5=0x%06x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data3=0x%06x"), (unsigned int)  pFromStruct->m_uData3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2RcDataEntry2:: data1=0x%06x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
