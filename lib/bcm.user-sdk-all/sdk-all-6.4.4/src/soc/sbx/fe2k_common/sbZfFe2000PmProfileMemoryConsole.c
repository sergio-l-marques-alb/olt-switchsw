...
sbZfFe2000PmProfileMemory_Print(sbZfFe2000PmProfileMemory_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PmProfileMemory:: resv0=0x%01x"), (unsigned int)  pFromStruct->uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" proftype=0x%01x"), (unsigned int)  pFromStruct->uProfType));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" oamproftype=0x%01x"), (unsigned int)  pFromStruct->uOamProfType));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PmProfileMemory:: resv1=0x%07x"), (unsigned int)  pFromStruct->uResv1));
  LOG_WARN(BSL_LS_SOC_COMMON,
