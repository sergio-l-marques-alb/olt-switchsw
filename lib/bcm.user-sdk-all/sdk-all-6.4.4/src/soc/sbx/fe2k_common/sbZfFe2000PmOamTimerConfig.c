...
sbZfFe2000PmOamTimerConfig_Unpack(sbZfFe2000PmOamTimerConfig_t *pToStruct,
  ...
  /* Unpack Member: uRate */
  (pToStruct)->uRate =  (uint32)  ((pFromData)[4] >> 4) & 0x0f;

  /* Unpack Member: uDeadline */
  (pToStruct)->uDeadline =  (uint32)  ((pFromData)[0] >> 4) & 0x0f;
  (pToStruct)->uDeadline |=  (uint32)  (pFromData)[1] << 4;
  (pToStruct)->uDeadline |=  (uint32)  (pFromData)[2] << 12;
  (pToStruct)->uDeadline |=  (uint32)  (pFromData)[3] << 20;
  (pToStruct)->uDeadline |=  (uint32)  ((pFromData)[4] & 0x0f) << 28;

  /* Unpack Member: bStarted */
  (pToStruct)->bStarted =  (uint32)  ((pFromData)[0] >> 3) & 0x01;

  /* Unpack Member: bStrict */
  (pToStruct)->bStrict =  (uint32)  ((pFromData)[0] >> 2) & 0x01;

  /* Unpack Member: bReset */
  (pToStruct)->bReset =  (uint32)  ((pFromData)[0] >> 1) & 0x01;

  /* Unpack Member: bInterrupt */
  (pToStruct)->bInterrupt =  (uint32)  ((pFromData)[0] ) & 0x01;
