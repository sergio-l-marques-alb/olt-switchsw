...
typedef enum _bcm_field_internal_qualify_e {
    ...
    _bcmFieldQualifyCount                     /* [0x0c] Always last not used. */
...
/* end markers */
#define _BCM_FIELD_CONTROL_END_MARKER           0xceab1122
#define _BCM_FIELD_STAT_END_MARKER              0xceab3344
#define _BCM_FIELD_POLICER_END_MARKER           0xceab5566
#define _BCM_FIELD_HINT_END_MARKER              0xceab7788
...
typedef enum _bcm_field_internal_element_e {
    ...
    _bcmFieldInternalActionId = 62,
    _bcmFieldInternalActionParam = 63,
    _bcmFieldInternalActionHwIndex = 64,
    _bcmFieldInternalActionOldIndex = 65,
    ...
    _bcmFieldInternalControlStage = 118,
    ...
    _bcmFieldInternalStatnStat1 = 145,
    ...
    _bcmFieldInternalElementCount = 305
