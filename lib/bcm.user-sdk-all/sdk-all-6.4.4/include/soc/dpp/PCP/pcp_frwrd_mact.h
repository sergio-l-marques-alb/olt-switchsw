/* $Id: pcp_frwrd_mact.h,v 1.5 Broadcom SDK $
...
#ifndef __SOC_PCP_FRWRD_MACT_INCLUDED__
/* { */
#define __SOC_PCP_FRWRD_MACT_INCLUDED__
...
#define PCP_FID_MAX                                          (16*1024-1)

#define PCP_FRWRD_MACT_TABLE_NOF_ENTRIES                     PCP_LEM_NOF_ENTRIES
#define PCP_FRWRD_MACT_TABLE_ENTRY_MAX                       (PCP_FRWRD_MACT_TABLE_NOF_ENTRIES - 1)
#define PCP_FRWRD_MACT_ENTRY_KEY_AGE_STATUS_MAX              (6)

#define PCP_FRWRD_MACT_NOF_MS_IN_SEC                         (1000)
#define PCP_FRWRD_MACT_NOF_MICROSEC_IN_MS                    (1000)
...
typedef enum
{
   ...
   */
  PCP_FRWRD_MACT_PROCEDURE_DESC_LAST
} PCP_FRWRD_MACT_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  PCP_FRWRD_MACT_ADD_TYPE_OUT_OF_RANGE_ERR = PCP_ERR_DESC_BASE_FRWRD_MACT_FIRST,
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  pcp_frwrd_mact_get_procs_ptr(void);
...
CONST SOC_ERROR_DESC_ELEMENT*
  pcp_frwrd_mact_get_errs_ptr(void);
