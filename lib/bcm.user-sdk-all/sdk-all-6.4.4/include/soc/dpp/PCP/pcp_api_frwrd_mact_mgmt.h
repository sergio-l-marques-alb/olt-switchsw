/* $Id: pcp_api_frwrd_mact_mgmt.h,v 1.3 Broadcom SDK $
...
#ifndef __SOC_PCP_API_FRWRD_MACT_MGMT_INCLUDED__
/* { */
#define __SOC_PCP_API_FRWRD_MACT_MGMT_INCLUDED__
...
#define  PCP_FRWRD_MACT_EVENT_BUFF_MAX_SIZE (SOC_PPC_FRWRD_MACT_EVENT_BUFF_MAX_SIZE)
...
#define PCP_FRWRD_MACT_LEARNING_MODE_INGRESS_DISTRIBUTED SOC_PPC_FRWRD_MACT_LEARNING_MODE_INGRESS_DISTRIBUTED
#define PCP_FRWRD_MACT_LEARNING_MODE_INGRESS_CENTRALIZED SOC_PPC_FRWRD_MACT_LEARNING_MODE_INGRESS_CENTRALIZED
#define PCP_FRWRD_MACT_LEARNING_MODE_EGRESS_DISTRIBUTED  SOC_PPC_FRWRD_MACT_LEARNING_MODE_EGRESS_DISTRIBUTED
#define PCP_FRWRD_MACT_LEARNING_MODE_EGRESS_CENTRALIZED  SOC_PPC_FRWRD_MACT_LEARNING_MODE_EGRESS_CENTRALIZED
#define PCP_FRWRD_MACT_LEARNING_MODE_EGRESS_INDEPENDENT      SOC_PPC_FRWRD_MACT_LEARNING_MODE_EGRESS_INDEPENDENT
#define PCP_NOF_FRWRD_MACT_LEARNING_MODES                SOC_PPC_NOF_FRWRD_MACT_LEARNING_MODES
typedef SOC_PPC_FRWRD_MACT_LEARNING_MODE                       PCP_FRWRD_MACT_LEARNING_MODE;

#define PCP_FRWRD_MACT_SHADOW_MODE_NONE                  SOC_PPC_FRWRD_MACT_SHADOW_MODE_NONE
#define PCP_FRWRD_MACT_SHADOW_MODE_ARP                   SOC_PPC_FRWRD_MACT_SHADOW_MODE_ARP
#define PCP_FRWRD_MACT_SHADOW_MODE_LAG                   SOC_PPC_FRWRD_MACT_SHADOW_MODE_LAG
#define PCP_FRWRD_MACT_SHADOW_MODE_ALL                   SOC_PPC_FRWRD_MACT_SHADOW_MODE_ALL
#define PCP_NOF_FRWRD_MACT_SHADOW_MODES                  SOC_PPC_NOF_FRWRD_MACT_SHADOW_MODES
typedef SOC_PPC_FRWRD_MACT_SHADOW_MODE                         PCP_FRWRD_MACT_SHADOW_MODE;

#define PCP_FRWRD_MACT_MSG_HDR_TYPE_RAW                        SOC_PPC_FRWRD_MACT_MSG_HDR_TYPE_RAW
#define PCP_FRWRD_MACT_MSG_HDR_TYPE_ITMH                       SOC_PPC_FRWRD_MACT_MSG_HDR_TYPE_ITMH
#define PCP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_ITMH                 SOC_PPC_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_ITMH
#define PCP_NOF_FRWRD_MACT_MSG_HDR_TYPES                       SOC_PPC_NOF_FRWRD_MACT_MSG_HDR_TYPES
typedef SOC_PPC_FRWRD_MACT_MSG_HDR_TYPE                              PCP_FRWRD_MACT_MSG_HDR_TYPE;

#define PCP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_NONE     SOC_PPC_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_NONE
#define PCP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_INTERRUPT SOC_PPC_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_INTERRUPT
#define PCP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_MSG      SOC_PPC_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_MSG
#define PCP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_EVENT    SOC_PPC_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_EVENT
#define PCP_NOF_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPES     SOC_PPC_NOF_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPES
typedef SOC_PPC_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE            PCP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE;

#define PCP_NOF_FRWRD_MACT_TRAP_TYPES                    SOC_PPC_NOF_FRWRD_MACT_TRAP_TYPES
typedef SOC_PPC_FRWRD_MACT_TRAP_TYPE                           PCP_FRWRD_MACT_TRAP_TYPE;

#define PCP_FRWRD_MACT_EVENT_TYPE_AGED_OUT                     SOC_PPC_FRWRD_MACT_EVENT_TYPE_AGED_OUT
#define PCP_FRWRD_MACT_EVENT_TYPE_LEARN                        SOC_PPC_FRWRD_MACT_EVENT_TYPE_LEARN
#define PCP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT                   SOC_PPC_FRWRD_MACT_EVENT_TYPE_TRANSPLANT
#define PCP_FRWRD_MACT_EVENT_TYPE_REFRESH                      SOC_PPC_FRWRD_MACT_EVENT_TYPE_REFRESH
#define PCP_FRWRD_MACT_EVENT_TYPE_ACK                          SOC_PPC_FRWRD_MACT_EVENT_TYPE_ACK
#define PCP_FRWRD_MACT_EVENT_TYPE_REQ_FAIL                     SOC_PPC_FRWRD_MACT_EVENT_TYPE_REQ_FAIL
#define PCP_NOF_FRWRD_MACT_EVENT_TYPES                         SOC_PPC_NOF_FRWRD_MACT_EVENT_TYPES
typedef SOC_PPC_FRWRD_MACT_EVENT_TYPE                                PCP_FRWRD_MACT_EVENT_TYPE;

#define PCP_FRWRD_MACT_EVENT_PATH_TYPE_MSG_SINGLE                     SOC_PPC_FRWRD_MACT_EVENT_PATH_TYPE_MSG_SINGLE
#define PCP_FRWRD_MACT_EVENT_PATH_TYPE_MSG_AGGR                       SOC_PPC_FRWRD_MACT_EVENT_PATH_TYPE_MSG_AGGR
#define PCP_FRWRD_MACT_EVENT_PATH_TYPE_DIRECT_ACCESS                         SOC_PPC_FRWRD_MACT_EVENT_PATH_TYPE_DIRECT_ACCESS
#define PCP_NOF_FRWRD_MACT_EVENT_PATH_TYPES                           SOC_PPC_NOF_FRWRD_MACT_EVENT_PATH_TYPES
typedef SOC_PPC_FRWRD_MACT_EVENT_PATH_TYPE                                  PCP_FRWRD_MACT_EVENT_PATH_TYPE;

typedef SOC_PPC_FRWRD_MACT_IP_COMPATIBLE_MC_INFO               PCP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO;
typedef SOC_PPC_FRWRD_MACT_AGING_INFO                          PCP_FRWRD_MACT_AGING_INFO;
typedef SOC_PPC_FRWRD_MACT_EVENT_HANDLE_KEY                          PCP_FRWRD_MACT_EVENT_HANDLE_KEY;
typedef SOC_PPC_FRWRD_MACT_EVENT_HANDLE_INFO                         PCP_FRWRD_MACT_EVENT_HANDLE_INFO;
typedef SOC_PPC_FRWRD_MACT_AGING_EVENTS_HANDLE                       PCP_FRWRD_MACT_AGING_EVENTS_HANDLE;
typedef SOC_PPC_FRWRD_MACT_MSG_DISTR_INFO                            PCP_FRWRD_MACT_MSG_DISTR_INFO;
typedef SOC_PPC_FRWRD_MACT_EVENT_PROCESSING_INFO                                 PCP_FRWRD_MACT_EVENT_PROCESSING_INFO;
typedef SOC_PPC_FRWRD_MACT_OPER_MODE_INFO                      PCP_FRWRD_MACT_OPER_MODE_INFO;
typedef SOC_PPC_FRWRD_MACT_MAC_LIMIT_INFO                      PCP_FRWRD_MACT_MAC_LIMIT_INFO;
typedef SOC_PPC_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO             PCP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO;
typedef SOC_PPC_FRWRD_MACT_MAC_LIMIT_GLBL_INFO                      PCP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO;
typedef SOC_PPC_FRWRD_MACT_PORT_INFO                           PCP_FRWRD_MACT_PORT_INFO;
typedef SOC_PPC_FRWRD_MACT_EVENT_LAG_INFO                 PCP_FRWRD_MACT_EVENT_LAG_INFO;
typedef SOC_PPC_FRWRD_MACT_EVENT_INFO                     PCP_FRWRD_MACT_EVENT_INFO;
typedef SOC_PPC_FRWRD_MACT_EVENT_BUFFER                        PCP_FRWRD_MACT_EVENT_BUFFER;

/* 
 *	Function from Soc_petra-PP vsi.
 */
typedef SOC_PPC_VSI_INFO                                       PCP_VSI_INFO;
 ...
 *     "pcp_frwrd_mact_oper_mode_info_set" API.
 *     Refer to "pcp_frwrd_mact_oper_mode_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_aging_info_set" API.
 *     Refer to "pcp_frwrd_mact_aging_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_aging_events_handle_info_set" API.
 *     Refer to "pcp_frwrd_mact_aging_events_handle_info_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_fid_profile_to_fid_map_set" API.
 *     Refer to "pcp_frwrd_mact_fid_profile_to_fid_map_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_mac_limit_glbl_info_set" API.
 *     Refer to "pcp_frwrd_mact_mac_limit_glbl_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_learn_profile_limit_info_set" API.
 *     Refer to "pcp_frwrd_mact_learn_profile_limit_info_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_event_handle_profile_set" API.
 *     Refer to "pcp_frwrd_mact_event_handle_profile_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_event_handle_info_set" API.
 *     Refer to "pcp_frwrd_mact_event_handle_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_learn_msgs_distribution_info_set" API.
 *     Refer to
 *     "pcp_frwrd_mact_learn_msgs_distribution_info_set" API
 *     for details.
*********************************************************************/
 ...
 *     API.
 *     Refer to
 *     "pcp_frwrd_mact_shadow_msgs_distribution_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_port_info_set" API.
 *     Refer to "pcp_frwrd_mact_port_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_trap_info_set" API.
 *     Refer to "pcp_frwrd_mact_trap_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "pcp_frwrd_mact_ip_compatible_mc_info_set" API.
 *     Refer to "pcp_frwrd_mact_ip_compatible_mc_info_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the "pcp_vsi_info_set"
 *     API.
 *     Refer to "pcp_vsi_info_set" API for details.
*********************************************************************/
uint32
  pcp_vsi_info_get(
    SOC_SAND_IN  int                                 unit,
...
/* } __SOC_PCP_API_FRWRD_MACT_MGMT_INCLUDED__*/
#endif
