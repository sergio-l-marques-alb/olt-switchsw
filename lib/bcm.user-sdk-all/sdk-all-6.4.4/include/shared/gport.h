...
#define _SHR_GPORT_TYPE_VP_GROUP           39  /* VP group gport */
#define _SHR_GPORT_TYPE_PROFILE            40
#define _SHR_GPORT_TYPE_DESTMOD_QUEUE_GROUP      41 /* DMVOQ gport */
#define _SHR_GPORT_TYPE_LOCAL_CPU_IEEE     42 /* CPU ethernet gport*/
#define _SHR_GPORT_TYPE_LOCAL_CPU_HIGIG    43 /* CPU higig gport*/
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_LOCAL_CPU_HIGIG /* Used for sanity */
                                                /* checks only.    */
/* COSQ GPORT subtypes*/
...
#define _SHR_COSQ_GPORT_VSQ_TYPE_SHIFT                  16
#define _SHR_COSQ_GPORT_VSQ_TYPE_INFO_MASK              0xFFFF
...
#define _SHR_VSQ_TYPE_INFO_CORE_SHIFT                   12
#define _SHR_VSQ_TYPE_INFO_OCB_ONLY_MASK                1
#define _SHR_VSQ_TYPE_INFO_OCB_ONLY_SHIFT               15
...
#define _SHR_VSQ_TYPE_INFO_STATISTICS_TAG_MASK          0xff
...
#define _SHR_COSQ_GPORT_SCHED_CIR_MASK                  0x1FFFF /* WAS 0xFFFFF */
#define _SHR_COSQ_GPORT_SCHED_CIR_CORE_SHIFT            17
#define _SHR_COSQ_GPORT_SCHED_CIR_CORE_MASK             _SHR_COSQ_GPORT_COMMON_CORE_MASK
#define _SHR_COSQ_GPORT_SCHED_PIR_SHIFT                 0
#define _SHR_COSQ_GPORT_SCHED_PIR_MASK                  0x1FFFF /* WAS 0xFFFFF */
#define _SHR_COSQ_GPORT_SCHED_PIR_CORE_SHIFT            17
#define _SHR_COSQ_GPORT_SCHED_PIR_CORE_MASK             _SHR_COSQ_GPORT_COMMON_CORE_MASK
...
#define _SHR_COSQ_GPORT_VOQ_CONNECTOR_ID_MASK           0x1FFFF
#define _SHR_GPORT_VOQ_CONNECTOR_CORE_SHIFT             17
#define _SHR_GPORT_VOQ_CONNECTOR_CORE_MASK              _SHR_COSQ_GPORT_COMMON_CORE_MASK
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_FLOW_SHIFT        0
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_FLOW_MASK         0x1FFFF
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_SHIFT        17
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_MASK         _SHR_COSQ_GPORT_COMMON_CORE_MASK
...
#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_TYPE_MASK       0x7ff
...
#define _SHR_COSQ_GPORT_ISQ_ROOT_SET(_gport) \
        ((_gport) = (_SHR_GPORT_TYPE_SCHEDULER << _SHR_GPORT_TYPE_SHIFT)  | \
         ...
         (((_SHR_CORE_ID2FIELD(_SHR_CORE_ALL)) & _SHR_GPORT_SCHEDULER_CORE_MASK) << _SHR_GPORT_SCHEDULER_CORE_SHIFT))
...
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_GET(_gport)  \
        (_SHR_CORE_FIELD2ID((((_gport) >> _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_SHIFT) & _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_MASK)))
...
#define _SHR_COSQ_GPORT_VSQ_FLAGS2TYPE(_flags, _type) do { \
             int _i;                                       \
             _type = -1;                                   \
             for (_i = 0; _i < 32; _i++) {                 \
                 if (_flags & (0x1 << _i)) {               \
...
#define _SHR_COSQ_GPORT_VSQ_SET(_gport, _flags, _type_info) do {                                               \
             uint32 _type_encode;                                                                              \
             _SHR_COSQ_GPORT_VSQ_FLAGS2TYPE(_flags, _type_encode);                                             \
             ((_gport) = _SHR_COSQ_GPORT_VSQ_TYPE(_type_encode) |                                              \
...
#define _SHR_COSQ_GPORT_VSQ_FLAGS_GET(_gport)    \
        (!_SHR_COSQ_GPORT_IS_VSQ(_gport) ? -1 : (0x1 << _SHR_COSQ_GPORT_VSQ_TYPE_GET(_gport)))
...
#define _SHR_COSQ_GPORT_VSQ_GL_SET(_gport, _core_id)  \
             ((_gport) = (_SHR_COSQ_GPORT_VSQ_TYPE(_SHR_COSQ_VSQ_GL)) |                                         \
                        ((_core_id & _SHR_VSQ_TYPE_INFO_CORE_MASK) << _SHR_VSQ_TYPE_INFO_CORE_SHIFT))
...
#define _SHR_COSQ_GPORT_VSQ_PP_SET(_gport, _statistics_tag) \
...
#define _SHR_COSQ_GPORT_VSQ_SRC_PORT_SET(_gport, _src_port_vsq_id, _tc) \
             (_gport = (_SHR_COSQ_GPORT_VSQ_TYPE(_SHR_COSQ_VSQ_SRC_PORT)) |  \
                       ...
                       ((_tc & _SHR_VSQ_TYPE_INFO_TC_MASK) << _SHR_VSQ_TYPE_INFO_TC_SHIFT))

#define _SHR_COSQ_GPORT_IS_VSQ_SRC_PORT(_gport) \
             (_SHR_COSQ_GPORT_VSQ_TYPE_GET(_gport) == _SHR_COSQ_VSQ_SRC_PORT)

#define _SHR_COSQ_GPORT_VSQ_PG_SET(_gport, _pg_vsq_id) \
             (_gport = (_SHR_COSQ_GPORT_VSQ_TYPE(_SHR_COSQ_VSQ_PG)) | \
                       ((_pg_vsq_id & _SHR_VSQ_TYPE_INFO_SRC_PORT_MASK) << _SHR_VSQ_TYPE_INFO_SRC_PORT_SHIFT))
...
#define _SHR_COSQ_GPORT_VSQ_CORE_ID_GET(_gport) \
             (!(_SHR_COSQ_GPORT_IS_VSQ_GL(_gport) || _SHR_COSQ_GPORT_IS_VSQ_CT(_gport) || _SHR_COSQ_GPORT_IS_VSQ_CTTC(_gport) || _SHR_COSQ_GPORT_IS_VSQ_CTCC(_gport)) ? - 1 : \
                ((((_gport) >> _SHR_VSQ_TYPE_INFO_CORE_SHIFT) & _SHR_VSQ_TYPE_INFO_CORE_MASK) == _SHR_COSQ_GPORT_COMMON_ALL_CORES_VALUE ? _SHR_CORE_ALL : \
                 (((_gport) >> _SHR_VSQ_TYPE_INFO_CORE_SHIFT) & _SHR_VSQ_TYPE_INFO_CORE_MASK)))
#define _SHR_COSQ_GPORT_VSQ_IS_OCB_ONLY(_gport) \
             (!(_SHR_COSQ_GPORT_IS_VSQ_CT(_gport) || _SHR_COSQ_GPORT_IS_VSQ_CTTC(_gport) || _SHR_COSQ_GPORT_IS_VSQ_CTCC(_gport)) ? - 1 : \
                (((_gport) >> _SHR_VSQ_TYPE_INFO_OCB_ONLY_SHIFT) & _SHR_VSQ_TYPE_INFO_OCB_ONLY_MASK))
...
#define _SHR_COSQ_GPORT_VOQ_CONNECTOR_CORE_SET(_gport, _cid, _core_id)             \
    ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |                \
         ...
         (((_SHR_CORE_ID2FIELD(_core_id)) & _SHR_GPORT_VOQ_CONNECTOR_CORE_MASK) << _SHR_GPORT_VOQ_CONNECTOR_CORE_SHIFT) )
...
#define  _SHR_COSQ_GPORT_VOQ_CONNECTOR_CORE_GET(_gport) \
        _SHR_CORE_FIELD2ID((((_gport) >> _SHR_GPORT_VOQ_CONNECTOR_CORE_SHIFT) & _SHR_GPORT_VOQ_CONNECTOR_CORE_MASK))
...
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_SET(_gport_sf2, gport, _core_id) \
    if (_SHR_GPORT_IS_SCHEDULER(gport))  { \
        (_gport_sf2) = ((_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT) |                                       \
                        ...
                        (((_SHR_CORE_ID2FIELD(_core_id)) & _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_MASK) << _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_SHIFT) ) ;        \
...
#define _SHR_COSQ_GPORT_SCHED_CIR_CORE_SET(_gport_cir, _gport, _core_id)              \
        ((_gport_cir) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |           \
         ...
         (((_SHR_CORE_ID2FIELD(_core_id)) & _SHR_COSQ_GPORT_SCHED_CIR_CORE_MASK) << _SHR_COSQ_GPORT_SCHED_CIR_CORE_SHIFT) )
...
#define  _SHR_COSQ_GPORT_SCHED_CIR_CORE_GET(_gport) \
        _SHR_CORE_FIELD2ID((((_gport) >> _SHR_COSQ_GPORT_SCHED_CIR_CORE_SHIFT) & _SHR_COSQ_GPORT_SCHED_CIR_CORE_MASK))
...
#define _SHR_COSQ_GPORT_SCHED_PIR_CORE_SET(_gport_pir, _gport, _core_id)              \
        ((_gport_pir) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |           \
         ...
         (((_SHR_CORE_ID2FIELD(_core_id)) & _SHR_COSQ_GPORT_SCHED_PIR_CORE_MASK) << _SHR_COSQ_GPORT_SCHED_PIR_CORE_SHIFT) )
...
#define  _SHR_COSQ_GPORT_SCHED_PIR_CORE_GET(_gport) \
    _SHR_CORE_FIELD2ID((((_gport) >> _SHR_COSQ_GPORT_SCHED_PIR_CORE_SHIFT) & _SHR_COSQ_GPORT_SCHED_PIR_CORE_MASK))
...
#define _SHR_GPORT_IS_PROFILE(_gport) \
...
#define _SHR_GPORT_PROFILE_SET(_gport, _profile)                              \
...
#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_UCAST_SET(_gport, _core)  \
    _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _SHR_GPORT_FABRIC_RX_QUEUE_TYPE_UCAST) 

#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_MCAST_SET(_gport, _core)  \
    _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _SHR_GPORT_FABRIC_RX_QUEUE_TYPE_MCAST) 

#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_TDM_SET(_gport, _core)  \
    _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _SHR_GPORT_FABRIC_RX_QUEUE_TYPE_TDM) 

#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_LOCAL_UCAST_SET(_gport, _core)  \
    _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _SHR_GPORT_FABRIC_RX_QUEUE_TYPE_LOCAL_UCAST) 

#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_LOCAL_MCAST_SET(_gport, _core)  \
    _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _SHR_GPORT_FABRIC_RX_QUEUE_TYPE_LOCAL_MCAST) 

#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_LOCAL_TDM_SET(_gport, _core)  \
    _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _SHR_GPORT_FABRIC_RX_QUEUE_TYPE_LOCAL_TDM) 

#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _fabric_rx_queue_type)\
            ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   | \
...
#define _SHR_COSQ_GPORT_CORE_GET(_gport)                                                                           \
        (((((_gport) >> _SHR_COSQ_GPORT_CORE_SHIFT) & _SHR_COSQ_GPORT_CORE_MASK) == (_SHR_CORE_ALL & _SHR_COSQ_GPORT_CORE_MASK)) ? (_SHR_CORE_ALL) : \
