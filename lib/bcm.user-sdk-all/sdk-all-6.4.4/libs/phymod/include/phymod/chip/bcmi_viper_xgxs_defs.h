...
#define LANECTL0r_CL36_PCS_EN_RXf_GET BCMI_VIPER_XGXS_LANECTL2r_CL36_PCS_EN_RXf_GET
#define LANECTL0r_CL36_PCS_EN_RXf_SET BCMI_VIPER_XGXS_LANECTL2r_CL36_PCS_EN_RXf_SET
#define LANECTL0r_CL36_PCS_EN_TXf_GET BCMI_VIPER_XGXS_LANECTL2r_CL36_PCS_EN_TXf_GET
#define LANECTL0r_CL36_PCS_EN_TXf_SET BCMI_VIPER_XGXS_LANECTL2r_CL36_PCS_EN_TXf_SET
...
#define BCMI_VIPER_XGXS_LANECTL2r_CDET_EN1Gf_SET(r,f) (r).lanectl2[0]=(((r).lanectl2[0] & ~((uint32_t)0x0xf << 12)) | ((((uint32_t)f) & 0xf) << 12)) | (0xf << (16 + 12))
