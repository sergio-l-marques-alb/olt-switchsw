 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: eagle_tsc_interface.h 816 2014-12-05 02:44:44Z kirand $   *
 *                                                                                 *
 ...
 */
 /*
err_code_t eagle_tsc_meas_eye_density_data(const struct eagle_tsc_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t *buffer_size);
*/
