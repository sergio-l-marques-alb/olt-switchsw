	...
	/* while (tsc_fetch_cnt<4 && ++n<4) {
		for (l=1; l<=*z; l++) {
			if (((check_type_2(ovs_buf[l],tsc))+tsc_fetch_cnt)<4) {
				for (i=0; i<4; i++) {
					if (_tdm->_chip_data.soc_pkg.pmap[which_tsc(ovs_buf[l],tsc)][i]!=_tdm->_chip_data.soc_pkg.num_ext_ports && _tdm->_chip_data.soc_pkg.speed[_tdm->_chip_data.soc_pkg.pmap[which_tsc(ovs_buf[l],tsc)][i]]==_tdm->_chip_data.soc_pkg.speed[ovs_buf[l]]) {
						for (j=1; j<=*z; j++) {
							if (ovs_buf[j]==_tdm->_chip_data.soc_pkg.pmap[which_tsc(ovs_buf[l],tsc)][i]) {
								if ((++tsc_fetch_cnt)<4) {
									tsc_stack[tsc_fetch_cnt]=_tdm->_chip_data.soc_pkg.pmap[which_tsc(ovs_buf[l],tsc)][i];
									for (k=j; k<*z; k++) {
										ovs_buf[k]=ovs_buf[k+1];
									}
								}
...
{	
	...
	while (_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z4 > 0) {
		if (tdm_fill_ovs_simple((&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z4)), _tdm->_core_data.vars_pkg.m_tdm_vmap_alloc.os40, cal->cal_grp[0], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z11)), cal->cal_grp[1], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z22)), cal->cal_grp[2], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z33)), cal->cal_grp[3], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z44)), cal->cal_grp[4], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z55)), cal->cal_grp[5], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z66)), cal->cal_grp[6], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z77)), cal->cal_grp[7], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z88)), cal->grp_len)==FAIL) {
	...
	while (_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z7 > 0) {
		if (tdm_fill_ovs_simple((&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z7)), _tdm->_core_data.vars_pkg.m_tdm_vmap_alloc.os40, cal->cal_grp[0], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z11)), cal->cal_grp[1], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z22)), cal->cal_grp[2], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z33)), cal->cal_grp[3], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z44)), cal->cal_grp[4], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z55)), cal->cal_grp[5], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z66)), cal->cal_grp[6], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z77)), cal->cal_grp[7], (&(_tdm->_core_data.vars_pkg.m_tdm_core_vbs_scheduler.z88)), cal->grp_len)==FAIL) {
