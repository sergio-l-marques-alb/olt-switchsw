...
#define PHY82381_MAX_LANE                   4
#define PHY82381_CHIP_ID_SIZE               25
typedef enum PHY82381_INTERRUPT {
    INT_M0_SLV_MISC_INTR = 4,
    INT_M0_MST_MISC_INTR = 5,  
    INT_M0_SLV_MSGOUT_INTR = 6,  
    INT_M0_MST_MSGOUT_INTR = 7, 
    INT_SYS_PLL_LOCK_LOST  = 18, 
    INT_SYS_PLL_LOCK_FOUND = 19, 
    INT_LINE_PLL_LOCK_LOST = 28, 
    INT_LINE_PLL_LOCK_FOUND = 29, 
    INT_CL73_AN_RESTARTED_0 = 40, 
    INT_CL73_AN_RESTARTED_1 = 41, 
    INT_CL73_AN_RESTARTED_2 = 42, 
    INT_CL73_AN_RESTARTED_3 = 43, 
    INT_CL73_AN_COMPLETE_0 = 44, 
    INT_CL73_AN_COMPLETE_1 = 45, 
    INT_CL73_AN_COMPLETE_2 = 46, 
    INT_CL73_AN_COMPLETE_3 = 47,
    PHY82381_MAX_INT = 16
}PHY82381_INTERRUPT_T;

uint32_t int_array[PHY82381_MAX_INT] = {INT_M0_SLV_MISC_INTR, INT_M0_MST_MISC_INTR, INT_M0_SLV_MSGOUT_INTR,
                                        INT_M0_MST_MSGOUT_INTR, INT_SYS_PLL_LOCK_LOST, INT_SYS_PLL_LOCK_FOUND,
                                        INT_LINE_PLL_LOCK_LOST, INT_LINE_PLL_LOCK_FOUND, INT_CL73_AN_RESTARTED_0,
                                        INT_CL73_AN_RESTARTED_1, INT_CL73_AN_RESTARTED_2, INT_CL73_AN_RESTARTED_3,
                                        INT_CL73_AN_COMPLETE_0, INT_CL73_AN_COMPLETE_1, INT_CL73_AN_COMPLETE_2,
...
STATIC int
phy_82381_per_lane_tx_get(soc_phymod_ctrl_t *pmc, int32 intf, soc_phy_control_t type, int lane, uint32 *value);
STATIC int
phy_82381_per_lane_tx_set(soc_phymod_ctrl_t *pmc, int32 intf, soc_phy_control_t type, int lane, uint32 value);
STATIC int
phy_82381_cl72_enable_get(soc_phymod_ctrl_t *pmc, int32 intf, uint32 *value);
STATIC int
phy_82381_cl72_status_get(soc_phymod_ctrl_t *pmc, int32 intf, uint32 *value);
STATIC int
phy_82381_cl72_enable_set(soc_phymod_ctrl_t *pmc, int32 intf, uint32 value);
STATIC int
phy_82381_link_monitor_status_get (soc_phymod_ctrl_t *pmc, int32 intf, int32 lane);
STATIC int
phy_82381_link_monitor_set (soc_phymod_ctrl_t *pmc, int32 intf, int32 lane, uint32 value);
STATIC int 
phy_82381_intr_enable_set(soc_phymod_ctrl_t *pmc, uint32 value);
STATIC int 
phy_82381_intr_enable_get(soc_phymod_ctrl_t *pmc, uint32 *value);
STATIC int 
phy_82381_intr_status_get(soc_phymod_ctrl_t *pmc, uint32 *value);
STATIC int
phy_82381_tx_lane_squelch_get(soc_phymod_ctrl_t *pmc, int32 intf, uint32 *value);
STATIC int
phy_82381_per_lane_tx_lane_squelch_get(soc_phymod_ctrl_t *pmc, int32 intf, int lane, uint32 *value);
STATIC int 
phy_82381_fec_enable_set(soc_phymod_ctrl_t *pmc, uint32 value);
STATIC int
phy_82381_cross_switch_swap_get(soc_phymod_ctrl_t *pmc, uint16 intf, uint32 *value);
STATIC int
phy_82381_cross_switch_swap_set(soc_phymod_ctrl_t *pmc, uint16 intf, uint32 value);
STATIC int 
...
_phy_82381_init_pass1(int unit, soc_port_t port)
{
    ...
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        SOC_IF_ERROR_RETURN
                  (phy_82381_fec_enable_set(pmc, 0));
        ...
        SOC_IF_ERROR_RETURN(
            phy_82381_driver_current_set(pmc, PHY82381_LINE_SIDE, 0xf));
        SOC_IF_ERROR_RETURN(
            phy_82381_tx_fir_main_set(pmc, PHY82381_LINE_SIDE, 0x3c));
        SOC_IF_ERROR_RETURN(
            phy_82381_tx_fir_post_set(pmc, PHY82381_LINE_SIDE, 0));
        SOC_IF_ERROR_RETURN(
            phy_82381_tx_fir_post_set(pmc, PHY82381_LINE_SIDE, 0));
...
phy_82381_lb_set(int unit, soc_port_t port, int enable)
{
    ...
    pmc = &pc->phymod_ctrl;
    SOC_IF_ERROR_RETURN (
        phy_82381_loopback_internal_pmd_set(pmc, PHY82381_LINE_SIDE, enable));
 ...
 */
STATIC int 
phy_82381_gpio_config_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_phy_access_t pm_phy_copy;
 ...
 */
STATIC int 
phy_82381_gpio_value_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_phy_access_t pm_phy_copy;
    int gpio_pin_no = 0;
...
phy_82381_control_get(int unit, soc_port_t port, soc_phy_control_t type, uint32 *value)
{
    ...
    case SOC_PHY_CONTROL_CL72:
        rv = phy_82381_cl72_enable_get(pmc, intf, value);
    break;
    case SOC_PHY_CONTROL_CL72_STATUS:
        rv = phy_82381_cl72_status_get(pmc, intf, value);
    break;
    case SOC_PHY_CONTROL_INTR_MASK:
        rv = phy_82381_intr_enable_get(pmc, value);
    break;
    case SOC_PHY_CONTROL_INTR_STATUS:
        rv = phy_82381_intr_status_get(pmc, value);
    break;
    case SOC_PHY_CONTROL_TX_LANE_SQUELCH:
        rv = phy_82381_tx_lane_squelch_get(pmc, intf, value);
    break;
    case SOC_PHY_CONTROL_XSW_LANE_MAP:
        rv = phy_82381_cross_switch_swap_get(pmc, intf, value);
    break;
    case SOC_PHY_CONTROL_GPIO_CONFIG:
        rv = phy_82381_gpio_config_get(pmc, value);
    break;
    case SOC_PHY_CONTROL_GPIO_VALUE:
        rv = phy_82381_gpio_value_get(pmc, value);
    break;
    default:
       rv = SOC_E_UNAVAIL;
       break;
                     ...
                     soc_phy_control_t type, uint32 *value)
{
    ...
    case SOC_PHY_CONTROL_TX_FIR_POST2:
    case SOC_PHY_CONTROL_TX_FIR_POST3:
        rv = phy_82381_per_lane_tx_get(pmc, intf, type, lane, value);
        break;
    case SOC_PHY_CONTROL_TX_LANE_SQUELCH:
        rv = phy_82381_per_lane_tx_lane_squelch_get(pmc, intf, lane, value);
        break;
...
phy82381_lb_get(int unit, soc_port_t port, int *enable)
{
    ...
    pmc = &pc->phymod_ctrl;
    SOC_IF_ERROR_RETURN(
        phy_82381_loopback_internal_pmd_get(pmc, PHY82381_LINE_SIDE, &out_en));
    *enable = (int) out_en;
 ...
 */
STATIC int
phy_82381_gpio_config_set(soc_phymod_ctrl_t *pmc, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    int                  idx;
    phymod_phy_access_t pm_phy_copy;
 ...
 */
STATIC int
phy_82381_gpio_value_set(soc_phymod_ctrl_t *pmc, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    int                  idx;
    phymod_phy_access_t pm_phy_copy;
...
phy_82381_control_set(int unit, soc_port_t port, soc_phy_control_t type, uint32 value)
{
    ...
    break;
    case SOC_PHY_CONTROL_CL72:
        rv = phy_82381_cl72_enable_set(pmc, intf, value);
    break;
    case SOC_PHY_CONTROL_INTR_MASK:
        rv = phy_82381_intr_enable_set(pmc, value);
    break;
    case SOC_PHY_CONTROL_XSW_LANE_MAP:
        rv = phy_82381_cross_switch_swap_set(pmc, intf, value);
    break;
    case SOC_PHY_CONTROL_GPIO_CONFIG:
        rv = phy_82381_gpio_config_set(pmc, value);
    break;
    case SOC_PHY_CONTROL_GPIO_VALUE:
        rv = phy_82381_gpio_value_set(pmc, value);
    break;
    default:
        rv = SOC_E_UNAVAIL;
        break; 
...
phy_82381_per_lane_control_set(int unit, soc_port_t port, int lane, soc_phy_control_t type, uint32 value)
{
 ...
 intf, lane, value);
    ...
    case SOC_PHY_CONTROL_TX_FIR_POST2:
    case SOC_PHY_CONTROL_TX_FIR_POST3:
        rv = phy_82381_per_lane_tx_set(pmc, intf, type, lane, value);
        break;
    default:
        rv = SOC_E_UNAVAIL;
        break; 
...
STATIC int phy_82381_diag_eyescan(soc_port_t port, soc_phymod_ctrl_t *pmc, int32 intf, int32 lane)
{
    phymod_phy_access_t     *pm_phy;
    int                     idx = 0, rv = 0;
    phymod_phy_access_t     pm_phy_copy;
...
STATIC int 
phy_82381_diag_dsc(soc_phymod_ctrl_t *pmc, int32 intf)
{
    phymod_phy_access_t  *pm_phy;
    int                    idx;
    phymod_phy_access_t pm_phy_copy;
    ...
    void *arg)       /* command argument based on op_type/op_cmd */
{
    ...
    switch(op_cmd) {
        case PHY_DIAG_CTRL_DSC:
            rv = phy_82381_diag_dsc(pmc, intf);
            break;
        case PHY_DIAG_CTRL_START_FAST_EYESCAN:
            rv =  phy_82381_diag_eyescan(port, pmc, intf, lane);
        break;
        case PHY_DIAG_CTRL_LINKMON_MODE:
        {
            uint32_t value = PTR_TO_INT(arg);
            rv = phy_82381_link_monitor_set(pmc, intf, lane, value);
        }
        break;
        case PHY_DIAG_CTRL_LINKMON_STATUS:
        {
            rv = phy_82381_link_monitor_status_get(pmc, intf, lane);
        }
        break;
        default:
...
phy_82381_intr_enable_set(soc_phymod_ctrl_t *pmc, uint32 value)
{
    ...
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        for (int_index = 0; int_index < PHY82381_MAX_INT; int_index ++) {
            if ( value & (1 << int_index)) {
                SOC_IF_ERROR_RETURN(
                    phymod_phy_intr_enable_set(&pm_phy_copy, int_array[int_index], 1));
            } else {
                SOC_IF_ERROR_RETURN(
                    phymod_phy_intr_enable_set(&pm_phy_copy, int_array[int_index], 0));
            }
        }
    }
...
phy_82381_intr_enable_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    ...
    *value = 0;
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        for (int_index = 0; int_index < PHY82381_MAX_INT; int_index ++) {
            SOC_IF_ERROR_RETURN(
                  phymod_phy_intr_enable_get(&pm_phy_copy, int_array[int_index], &ena_get));
            if (ena_get) {
                *value |= (1 << int_index);
            } 
        }
...
phy_82381_intr_status_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    ...
    *value = 0;
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        for (int_index = 0; int_index < PHY82381_MAX_INT; int_index ++) {
            SOC_IF_ERROR_RETURN(
                  phymod_phy_intr_status_get(&pm_phy_copy, int_array[int_index], &sts_get));
            if (sts_get) {
                *value |= (1 << int_index);    
                SOC_IF_ERROR_RETURN(
                  phymod_phy_intr_status_clear(&pm_phy_copy, int_array[int_index]));
            } 
        }
    }
