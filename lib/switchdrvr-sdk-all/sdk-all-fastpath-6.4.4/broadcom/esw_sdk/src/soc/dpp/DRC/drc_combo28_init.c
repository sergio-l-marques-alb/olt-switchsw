...
int soc_dpp_drc_combo28_drc_addr_bank_swap(int unit, int drc_ndx, soc_dpp_drc_combo28_info_t *drc_info)
{
    ...
    for (bit = 0; bit < SOC_DPP_DRC_COMBO28_NOF_ADDR_BANK_BITS_PER_INTERFACE ; ++bit) {
        ...
        if (drc_info->dram_addr_bank_swap[drc_ndx][bit] != SOC_DPP_DRC_COMBO28_ADDR_BANK_SWAP_VAL_DEFAULT_NO_SWAP)  {
 ...
 */
int soc_dpp_drc_combo28_init_check_bist_result(int unit, int dram_ndx, combo28_bist_err_cnt_t *combo28_bist_err_cnt)
{
    ...
    if ((combo28_bist_err_cnt->bist_err_occur != 0x0)          || (combo28_bist_err_cnt->bist_full_err_cnt != 0x0)   || 
        ...
        (combo28_bist_err_cnt->bist_edc_global_err_cnt != 0x0) || (combo28_bist_err_cnt->bist_edc_err_occur != 0x0)     )
    {
...
int soc_dpp_drc_combo28_init_run_bist_unsafe(int unit, int drc_ndx, soc_dpp_drc_combo28_info_t *drc_info)
{
    ...
    SOCDNX_IF_ERR_EXIT( soc_dpp_drc_combo28_init_check_bist_result(unit, drc_ndx, &combo28_bist_err_cnt));
