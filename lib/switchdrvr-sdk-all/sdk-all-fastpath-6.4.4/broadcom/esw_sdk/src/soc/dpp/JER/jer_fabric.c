...
#define SOC_JER_FABRIC_FDA_EGQ_NUMELS       (2)
  ...
  )
{
  ...
  /*GCI 1*/
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_1r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_0_1f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_1_LEVEL_0));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_1r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_1_1f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_1_LEVEL_1));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_1r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_2_1f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_1_LEVEL_2));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_1r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_3_1f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_1_LEVEL_3));


  /*GCI 2*/
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_2r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_0_2f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_2_LEVEL_0));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_2r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_1_2f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_2_LEVEL_1));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_2r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_2_2f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_2_LEVEL_2));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_2r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_3_2f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_2_LEVEL_3));

  /*GCI 3*/
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_3r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_0_3f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_3_LEVEL_0));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_3r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_1_3f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_3_LEVEL_1));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_3r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_2_3f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_3_LEVEL_2));
  SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit, IPT_GCI_BACKOFF_MASK_LUT_3r,  REG_PORT_ANY, 0, GCI_BACKOFF_MASK_3_3f,  ARAD_FABRIC_IPT_GCI_BACKOFF_GCI_3_LEVEL_3));
  ...
  )
{
    ...
    SOC_DPP_CORES_ITER(SOC_CORE_ALL, i) {
        SOCDNX_IF_ERR_EXIT(READ_EGQ_GENERAL_RQP_CONFIGr(unit, i, &reg_val)); 
        soc_reg_field_set(unit, EGQ_GENERAL_RQP_CONFIGr, &reg_val, RCM_MODEf, 2);
        SOCDNX_IF_ERR_EXIT(WRITE_EGQ_GENERAL_RQP_CONFIGr(unit, i, reg_val));
    }
    /*enable segmetation*/
    ...
    switch (map_type) {
    case soc_dcmn_drv_uc_mc_tdm_config_triple_pipe:
        tdm_pipe_field_val = 0x4; 
        break;
    case soc_dcmn_drv_tdm_non_tdm_config_dual_pipe:
        tdm_pipe_field_val = 0x2; 
        break;
    /*case soc_dcmn_drv_tdm_only_single_pipe: (currently not supported) 
  ...
  )
{
    ...
    if (fabric_links_core_map_mode == SOC_DPP_FABRIC_LINKS_TO_CORE_MAP_DEDICATED) {
        SOCDNX_IF_ERR_EXIT(READ_RTP_RTP_ENABLEr(unit, &reg_val));
        soc_reg_field_set(unit, RTP_RTP_ENABLEr, &reg_val, FABRIC_18_18f, 1);
        SOCDNX_IF_ERR_EXIT(WRITE_RTP_RTP_ENABLEr(unit, reg_val));
    ...
    for ( i = 0; i < nof_instances_fmac; ++i) {
        SOCDNX_IF_ERR_EXIT(READ_FMAC_GENERAL_CONFIGURATION_REGISTERr(unit, i, &reg_val)); 
        soc_reg_field_set(unit, FMAC_GENERAL_CONFIGURATION_REGISTERr, &reg_val, TX_WIDE_INTERFACEf, 1);
        SOCDNX_IF_ERR_EXIT(WRITE_FMAC_GENERAL_CONFIGURATION_REGISTERr(unit, i, reg_val));
    }
  ...
  )
{
    ...
    PBMP_SFI_ITER(unit, link) {
        ...
        if (repeater_link_enable) {
            SOCDNX_IF_ERR_EXIT(soc_jer_fabric_link_repeater_enable_set(unit, link, 1, SOC_DPP_DEFS_GET(unit, repeater_default_empty_cell_size)));
        }
    }
  ...
  )
{
    ...
    if (fabric->fabric_pcp_enable) {
        ...
        SOCDNX_IF_ERR_EXIT(READ_FDR_FDR_ENABLERS_REGISTER_2r(unit, &regval));
        soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &regval, PCP_ENABLEDf, 1);
        SOCDNX_IF_ERR_EXIT(WRITE_FDR_FDR_ENABLERS_REGISTER_2r(unit, regval));
         ...
         */
        SOCDNX_IF_ERR_EXIT(READ_FDT_SIMPLE_PACKING_CONFIGURATIONr(unit, &regval));
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_FDT_SIMPLE_PACKING_CONFIGURATIONr(unit, regval));
  ...
  )
{
    ...
    uint32 pipe_map_table[SOC_MAX_MEM_WORDS];
    ...
    SOCDNX_IF_ERR_EXIT(READ_FDR_FDR_ENABLERS_REGISTER_2r(unit, &reg_val));
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, PARALLEL_DATA_PATHf, nof_pipes - 1);
    SOCDNX_IF_ERR_EXIT(WRITE_FDR_FDR_ENABLERS_REGISTER_2r(unit, reg_val));
     ...
     */
    SOCDNX_IF_ERR_EXIT(READ_FDR_FDR_ENABLERS_REGISTER_2r(unit, &reg_val));
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, UC_PRI_0_PIPEf, fabric_pipe_map.config_uc[0]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, UC_PRI_1_PIPEf, fabric_pipe_map.config_uc[1]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, UC_PRI_2_PIPEf, fabric_pipe_map.config_uc[2]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, UC_PRI_3_PIPEf, fabric_pipe_map.config_uc[3]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, MC_PRI_0_PIPEf, fabric_pipe_map.config_mc[0]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, MC_PRI_1_PIPEf, fabric_pipe_map.config_mc[1]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, MC_PRI_2_PIPEf, fabric_pipe_map.config_mc[2]);
    soc_reg_field_set(unit, FDR_FDR_ENABLERS_REGISTER_2r, &reg_val, MC_PRI_3_PIPEf, fabric_pipe_map.config_mc[3]);
    SOCDNX_IF_ERR_EXIT(WRITE_FDR_FDR_ENABLERS_REGISTER_2r(unit, reg_val));

    /* 
     * Configure DTQs according to pipe confiugration
     */
    for (i = 0; i < SOC_JER_FABRIC_PRIORITY_NDX_NOF; ++i) {
        ...
        SHR_BITCOPY_RANGE(pipe_map_table, i * SOC_JER_FABRIC_PRIORITY_LENGTH, &pipe_num, 0, SOC_JER_FABRIC_PRIORITY_LENGTH);
    }

    SOCDNX_IF_ERR_EXIT(WRITE_IPT_IPT_0_DEST_PIPE_MAPPING_2_FDTm(unit, MEM_BLOCK_ALL, 0, &pipe_map_table));
    SOCDNX_IF_ERR_EXIT(WRITE_IPT_IPT_1_DEST_PIPE_MAPPING_2_FDTm(unit, MEM_BLOCK_ALL, 0, &pipe_map_table));
...
{
    int i, divider, master_port, slave_port;
    SOCDNX_INIT_FUNC_DEFS;

    for (i = 0; i < SOC_JER_FABRIC_SYNCE_NOF_CLKS; ++i) {
        divider = soc_property_suffix_num_get(unit, i, spn_SYNC_ETH_CLK_DIVIDER, "", 0x0);
        if (divider) {
            SOCDNX_IF_ERR_EXIT(soc_jer_fabric_port_sync_e_divider_set(unit, divider));
        }
        master_port = soc_property_suffix_num_get(unit, i, spn_SYNC_ETH_CLK_TO_PORT_ID_CLK, "", 0xffffffff);
        if (master_port != 0xffffffff && master_port >= FABRIC_LOGICAL_PORT_BASE(unit)) {
            SOCDNX_IF_ERR_EXIT(soc_jer_fabric_port_sync_e_link_set(unit, 1, master_port));
        }
        slave_port = soc_property_suffix_num_get(unit, i, spn_SYNC_ETH_CLK_TO_PORT_ID_CLK, "", 0xffffffff);
        if (slave_port != 0xffffffff && slave_port >= FABRIC_LOGICAL_PORT_BASE(unit)) {
  ...
  )
{
    ...
    if (fabric_pipe_type != soc_dpp_cosq_gport_fabric_pipe_ingress) {
        ...
        if ((1)) {
            ...
            SOCDNX_IF_ERR_EXIT(READ_FDA_FAB_18_SCH_WFQ_CFGr(unit, &reg_val));
            soc_reg_field_set(unit, FDA_FAB_18_SCH_WFQ_CFGr, &reg_val, field, weight);
            SOCDNX_IF_ERR_EXIT(WRITE_FDA_FAB_18_SCH_WFQ_CFGr(unit, reg_val));
        }
        switch (pipe) {
        case 0:
        ...
        SOCDNX_IF_ERR_EXIT(READ_FDA_FAB_36_SCH_WFQ_CFGr(unit, &reg_val));
        soc_reg_field_set(unit, FDA_FAB_36_SCH_WFQ_CFGr, &reg_val, field, weight);
        SOCDNX_IF_ERR_EXIT(WRITE_FDA_FAB_36_SCH_WFQ_CFGr(unit, reg_val));
    }
    ...
    if (fabric_pipe_type != soc_dpp_cosq_gport_fabric_pipe_egress) {
        ...
        SOCDNX_IF_ERR_EXIT(READ_FDT_IPT_0_WFQ_CONFIGr(unit, &reg_val));
        soc_reg_field_set(unit, FDT_IPT_0_WFQ_CONFIGr, &reg_val, field, weight);
        SOCDNX_IF_ERR_EXIT(WRITE_FDT_IPT_0_WFQ_CONFIGr(unit, reg_val));
        ...
        SOCDNX_IF_ERR_EXIT(READ_FDT_IPT_1_WFQ_CONFIGr(unit, &reg_val));
        soc_reg_field_set(unit, FDT_IPT_1_WFQ_CONFIGr, &reg_val, field, weight);
        SOCDNX_IF_ERR_EXIT(WRITE_FDT_IPT_1_WFQ_CONFIGr(unit, reg_val));
    }
  ...
  )
{
    ...
    if (fabric_pipe_type == soc_dpp_cosq_gport_fabric_pipe_egress) {       
        ...
        SOCDNX_IF_ERR_EXIT(READ_FDA_FAB_36_SCH_WFQ_CFGr(unit, &reg_val));
        *weight = soc_reg_field_get(unit, FDA_FAB_36_SCH_WFQ_CFGr, reg_val, field);
    } else {    
        switch (pipe) {
        case 0:
            field = IPT_0_WFQ_CTX_0_WEIGHTf;
        ...
        SOCDNX_IF_ERR_EXIT(READ_FDT_IPT_0_WFQ_CONFIGr(unit, &reg_val));
        *weight = soc_reg_field_get(unit, FDT_IPT_0_WFQ_CONFIGr, reg_val, field);
    }
  ...
  )
{
    ...
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast:
        for (i = 0; i < SOC_JER_FABRIC_FDA_EGQ_NUMELS; ++i) {
    ...
    SOC_SAND_IN  soc_dpp_cosq_gport_egress_core_fifo_t   fifo_type)
{
    ...
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast:
        for (i = 0; i < SOC_JER_FABRIC_FDA_EGQ_NUMELS; ++i) {
            SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_WFQr(unit, i, &reg_val)); 
            soc_reg64_field32_set(unit, FDA_FDA_EGQ_WFQr, &reg_val, EGQ_N_WFQ_WEIGHT_FABFIF_0f, weight);
            SOCDNX_IF_ERR_EXIT(WRITE_FDA_FDA_EGQ_WFQr(unit, i, reg_val));
        }
        break;
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_mcast:
        for (i = 0; i < SOC_JER_FABRIC_FDA_EGQ_NUMELS; ++i) {
            SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_WFQr(unit, i, &reg_val));
            soc_reg64_field32_set(unit, FDA_FDA_EGQ_WFQr, &reg_val, EGQ_N_WFQ_WEIGHT_FABFIF_1f, weight);
            SOCDNX_IF_ERR_EXIT(WRITE_FDA_FDA_EGQ_WFQr(unit, i, reg_val));
        }
        break;
    case soc_dpp_cosq_gport_egress_core_fifo_local_mcast:
        for (i = 0; i < SOC_JER_FABRIC_FDA_EGQ_NUMELS; ++i) {
            SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_WFQr(unit, i, &reg_val));
            soc_reg64_field32_set(unit, FDA_FDA_EGQ_WFQr, &reg_val, EGQ_N_WFQ_WEIGHT_MESHMCf, weight);
            SOCDNX_IF_ERR_EXIT(WRITE_FDA_FDA_EGQ_WFQr(unit, i, reg_val));
        }
        break;
    default:
  ...
  )
{
    ...
    switch (fifo_type) {
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast:
        SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_WFQr(unit, 0, &reg_val));
        *weight = soc_reg64_field32_get(unit, FDA_FDA_EGQ_WFQr, reg_val, EGQ_N_WFQ_WEIGHT_FABFIF_0f);
        break;
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_mcast:
        SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_WFQr(unit, 0, &reg_val));
        *weight = soc_reg64_field32_get(unit, FDA_FDA_EGQ_WFQr, reg_val, EGQ_N_WFQ_WEIGHT_FABFIF_1f);
        break;
    case soc_dpp_cosq_gport_egress_core_fifo_local_mcast:
        SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_WFQr(unit, 0, &reg_val));
        *weight = soc_reg64_field32_get(unit, FDA_FDA_EGQ_WFQr, reg_val, EGQ_N_WFQ_WEIGHT_MESHMCf);
        break;
    default:
        SOCDNX_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_SOC_MSG("invalid argument fifo_type")));
        break;
  ...
  )
{
    ...
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast:
        for (i = 0; i < SOC_JER_FABRIC_FDA_EGQ_NUMELS; ++i) {
            SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_FABRIC_RCIr(unit, i, &reg_val));
            soc_reg_field_set(unit, FDA_FDA_EGQ_FABRIC_RCIr, &reg_val, EGQ_N_FABRIC_RCI_THRf, threshold_val);
            soc_reg_field_set(unit, FDA_FDA_EGQ_FABRIC_RCIr, &reg_val, EGQ_N_FABRIC_RCI_SELf, 0);
            SOCDNX_IF_ERR_EXIT(WRITE_FDA_FDA_EGQ_FABRIC_RCIr(unit, i, reg_val));
        }
        break;
  ...
  )
{
    ...
    switch (fifo_type) {
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast:
        SOCDNX_IF_ERR_EXIT(READ_FDA_FDA_EGQ_FABRIC_RCIr(unit, 0, &reg_val)); 
        *threshold_val = soc_reg_field_get(unit, FDA_FDA_EGQ_FABRIC_RCIr, reg_val, EGQ_N_FABRIC_RCI_THRf);
        break;
    case soc_dpp_cosq_gport_egress_core_fifo_local_ucast:
        SOCDNX_IF_ERR_EXIT(READ_IPT_DATA_QUEUE_EGQ_THRESHOLDr(unit, reg_above_64_val));
...
{
    int i;
    uint64 reg64_val, link_arr_bmp, link_delay_bmp;
    uint32 local_core0_id, group_ctx, reg_val;
    soc_module_t dest_fap_id_arr[SOC_DPP_MAX_NOF_FAP_ID_MAPPED_TO_DEST_LIMIT];
    ...
    /*update links bitmap*/
    SOCDNX_IF_ERR_EXIT(READ_FDT_MESH_MC_RELICATIONr(unit, local_dest_id, &reg64_val));
    soc_reg64_field_set(unit, FDT_MESH_MC_RELICATIONr, &reg64_val, MESH_MC_N_BITMAPf, link_arr_bmp);
    SOCDNX_IF_ERR_EXIT(WRITE_FDT_MESH_MC_RELICATIONr(unit, local_dest_id, reg64_val));
    ...
    for (i = 0; i < fap_id_count; ++i) {
        offset = (dest_fap_id_arr[i] % 16) * 3; /*isolate bits 0:3*/
        if (offset < 32) {
    ...
    SOCDNX_IF_ERR_EXIT(jer_mgmt_system_fap_id_get(unit, &local_core0_id));
    if (dest_fap_id_arr[0] > local_core0_id) {
        ...
        link_delay_bmp = soc_reg64_field_get(unit, MESH_TOPOLOGY_REG_010Fr, reg64_val, FIELD_0_35f);
        COMPILER_64_NOT(link_arr_bmp);
        COMPILER_64_AND(link_delay_bmp, link_arr_bmp);
        soc_reg64_field_set(unit, MESH_TOPOLOGY_REG_010Fr, &reg64_val, FIELD_0_35f, link_delay_bmp); 
  ...
  )
{
    ...
    uint32 local_core0_id, reg_val, group_ctx;
    int nof_fab_links = SOC_DPP_DEFS_GET(unit, nof_fabric_links);
    int fap_id_count, offset;
    SHR_BITDCLNAME (dqcq_map, 32);
    ...
    jer_mgmt_system_fap_id_get(unit, &local_core0_id);
    if (dest_fap_id_arr[0] > local_core0_id) {
        SOCDNX_IF_ERR_EXIT(READ_MESH_TOPOLOGY_MESH_TOPOLOGYr(unit, &reg_val));
        soc_reg_field_set(unit, MESH_TOPOLOGY_MESH_TOPOLOGYr, &reg_val, MULTI_FAPf, 0);
        SOCDNX_IF_ERR_EXIT(WRITE_MESH_TOPOLOGY_MESH_TOPOLOGYr(unit, reg_val));

        SOCDNX_IF_ERR_EXIT(READ_MESH_TOPOLOGY_REG_010Fr(unit, &reg64_val));
        bmp_val = soc_reg64_field_get(unit, MESH_TOPOLOGY_REG_010Fr, reg64_val, FIELD_0_35f);
        for (i = 0; i < links_count; ++i) {
            COMPILER_64_BITCLR(bmp_val, SOC_DPP_FABRIC_PORT_TO_LINK(unit, links_arr[i]));
        }
        soc_reg64_field_set(unit, MESH_TOPOLOGY_REG_010Fr, &reg64_val, FIELD_0_35f, bmp_val);
        SOCDNX_IF_ERR_EXIT(WRITE_MESH_TOPOLOGY_REG_010Fr(unit, reg64_val));
    }
exit:
  SOCDNX_FUNC_RETURN;
  ...
  )
{
    ...
    if (is_mesh_mc && local_dest_id >= SOC_DPP_FABRIC_MAX_DEST_MESH_MC_MODE) {
        SOCDNX_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_SOC_MSG("in Mesh MC mode there can only be two destinations")));
    } else if (is_mesh && local_dest_id >= SOC_DPP_FABRIC_MAX_DEST_MESH_MODE) {
        SOCDNX_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_SOC_MSG("in Mesh mode there can only be three destinations")));
    }
  ...
  )
{
    ...
    */
    ...
    for (i = 0; i < SOC_JER_FABRIC_SR_CELL_RECEIVED_NOF_SIDES; ++i) {
  ...
  )
{
    ...
    queues_info->soc_dpp_fabric_dtq_data_max_occ_val = soc_reg_field_get(unit, IPT_FIFOS_MAX_OCC_1r, reg32_val, FDTD_MAX_OCf);
    queues_info->soc_dpp_fabric_dtq_data_max_occ_ctx = soc_reg_field_get(unit, IPT_FIFOS_MAX_OCC_1r, reg32_val, FDTD_MAX_OC_QNUMf);
    queues_info->soc_dpp_fabric_dtq_ctrl_max_occ_val = soc_reg_field_get(unit, IPT_FIFOS_MAX_OCC_1r, reg32_val, FDTC_MAX_OCf);
    queues_info->soc_dpp_fabric_dtq_ctrl_max_occ_ctx = soc_reg_field_get(unit, IPT_FIFOS_MAX_OCC_1r, reg32_val, FDTC_MAX_OC_QNUMf);
    
    /*get DQCF info*/
    
    SOCDNX_IF_ERR_EXIT(READ_IPT_FIFOS_MAX_OCC_0r(unit, &reg64_val));
    queues_info->soc_dpp_fabric_dblf0_max_occ_val = soc_reg64_field32_get(unit, IPT_FIFOS_MAX_OCC_0r, reg64_val, DBLF_0_MAX_OCf);
    queues_info->soc_dpp_fabric_dblf0_max_occ_ctx = soc_reg64_field32_get(unit, IPT_FIFOS_MAX_OCC_0r, reg64_val, DBLF_0_MAX_OC_QNUMf);
    queues_info->soc_dpp_fabric_dblf1_max_occ_val = soc_reg64_field32_get(unit, IPT_FIFOS_MAX_OCC_0r, reg64_val, DBLF_1_MAX_OCf);
    queues_info->soc_dpp_fabric_dblf1_max_occ_ctx = soc_reg64_field32_get(unit, IPT_FIFOS_MAX_OCC_0r, reg64_val, DBLF_1_MAX_OC_QNUMf);
  ...
  )
{
    ...
    /*Status 2*/
    SOCDNX_IF_ERR_EXIT(READ_MESH_TOPOLOGY_REG_01B9r(unit, &reg64_val));
    mesh_topology_diag->status_2 = soc_reg64_field32_get(unit, MESH_TOPOLOGY_REG_01B9r, reg64_val, FIELD_0_31f);
    mesh_topology_diag->status_2_id1 = soc_reg64_field32_get(unit, MESH_TOPOLOGY_REG_01B9r, reg64_val, FIELD_32_38f);
    mesh_topology_diag->status_2_id2 = soc_reg64_field32_get(unit, MESH_TOPOLOGY_REG_01B9r, reg64_val, FIELD_39_49f);
  ...
  )
{
    ...
    if ((port < SOC_INFO(unit).fabric_logical_port_base) || 
        (port >= SOC_INFO(unit).fabric_logical_port_base + SOC_DPP_DEFS_GET(unit, nof_fabric_links)) ||
    ...
    if (is_master) {
        ...
        soc_reg_field_set(unit, FSRD_SYNC_E_SELECTr, &reg_val2, MASTER_CLK_SELf,  SOC_DPP_FABRIC_PORT_TO_LINK(unit, port) % SOC_DPP_DEFS_GET(unit, nof_links_in_fsrd));
    } else {
        /*update eci register*/
        soc_reg_field_set(unit, ECI_SELECT_OUTPUT_OF_SYNCHRONOUS_ETHERNET_PADSr, &reg_val, FABRIC_SLAVE_SYNC_E_SELf, fsrd_block);
        /*update fsrd register*/
        soc_reg_field_set(unit, FSRD_SYNC_E_SELECTr, &reg_val2, SLAVE_CLK_SELf,  SOC_DPP_FABRIC_PORT_TO_LINK(unit, port) % SOC_DPP_DEFS_GET(unit, nof_links_in_fsrd));
    }
  ...
  )
{
    ...
    reg = (is_master) ? ECI_SYNCE_MASTER_PLL_CONFIGr : ECI_MISC_PLL_8_CONFIGr;
    field = (is_master) ? SYNCE_MASTER_PLL_CFG_REFRENCE_NIF_SELf : SYNCE_SLAVE_PLL_CFG_REFRENCE_NIF_SELf;

    if (IS_SFI_PORT(unit, port_id)) {
  ...
  )
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, reg, REG_PORT_ANY, 0, reg_above_64_val));
    *is_fabric_synce = soc_reg_above_64_field32_get(unit, reg, reg_above_64_val, field);
