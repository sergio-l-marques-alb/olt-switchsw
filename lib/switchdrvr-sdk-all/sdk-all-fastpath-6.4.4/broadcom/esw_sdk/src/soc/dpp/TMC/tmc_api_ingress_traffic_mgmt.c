/* $Id: tmc_api_ingress_traffic_mgmt.c,v 1.12 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/tmc/src/soc_tmcapi_ingress_traffic_mgmt.c
*
* MODULE PREFIX:  soc_tmcitm
*
* FILE DESCRIPTION:
*
* REMARKS:
  ...
  )
{
  ...
  switch(enum_val)
  {
  case SOC_TMC_ITM_VSQ_GROUPA_SZE:
    str = "vsq_groupa_sze";
  break;
  case SOC_TMC_ITM_VSQ_GROUPB_SZE:
    str = "vsq_groupb_sze";
  break;
  case SOC_TMC_ITM_VSQ_GROUPC_SZE:
    str = "vsq_groupc_sze";
  break;
  case SOC_TMC_ITM_VSQ_GROUPD_SZE:
    str = "vsq_groupd_sze";
  break;
  default:
    str = " Unknown";
  ...
  )
{
  ...
  switch(enum_val)
  {
  case SOC_TMC_ITM_VSQ_NDX_MIN:
    str = "vsq_ndx_min";
  break;
  case SOC_TMC_ITM_VSQ_NDX_MAX_PETRA:
  case SOC_TMC_ITM_VSQ_NDX_MAX_ARAD:
    str = "vsq_ndx_max";
  break;
  default:
    str = " Unknown";
