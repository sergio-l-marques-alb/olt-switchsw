...
void arad_pp_dbal_sw_db_mpls_prefix_sem_property_set     (int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 mpls_label); /* mpls label | bos(depend on soc property) */
...
/*
   ...
   bitmask |                           |                                                     |                                                     |                             |    Info     */
    ...
    { 0, "VTT MPLS UNINDEXED SEM A"          , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_UNINDEXED_PREFIX_SEM_A   , arad_pp_dbal_sw_db_mpls_prefix_sem_property_set       , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A , 0                                                        , MPLS_LABEL_0      }, /* mpls label | bos(depend on soc property) */
    { 0, "VTT MPLS UNINDEXED SEM B"          , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_UNINDEXED_PREFIX_SEM_B   , arad_pp_dbal_sw_db_mpls_prefix_sem_property_set       , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B , 0                                                        , MPLS_LABEL_0      }, /* mpls label | bos(depend on soc property) */
    ...
    { 0, "VTT MPLS LABEL2  SEM A"            , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L2_SEM_A                 , arad_pp_dbal_sw_db_mpls_prefix_sem_property_set       , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A , 0                                                        , MPLS_LABEL_1      }, /* mpls label | bos(depend on soc property) */
    { 0, "VTT MPLS LABEL2  SEM B"            , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L2_SEM_B                 , arad_pp_dbal_sw_db_mpls_prefix_sem_property_set       , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B , 0                                                        , MPLS_LABEL_1      }, /* mpls label | bos(depend on soc property) */
...
void arad_pp_dbal_tt_program_mpls_l2_property_set  (int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused );
 ...
 *   |                                 |              function                        |  Program */
    ...
    {ARAD_PP_DBAL_TT_PROG_MPLS_L2      , arad_pp_dbal_tt_program_mpls_l2_property_set  , {-1}    , 0      },
...
int32 arad_pp_dbal_vt_cam_vdxinitialvid_set                  (int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused );
int32 arad_pp_dbal_vt_cam_vdxoutervid_set                    (int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused );
 ...
 *                                                                     |                                                       |          |                           */
        ...
        {ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INITIALVID                  , arad_pp_dbal_vt_cam_vdxinitialvid_set                  , {-1}, {ARAD_PP_DBAL_VT_PROG_INVALID}, 0           },
        {ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTERVID                    , arad_pp_dbal_vt_cam_vdxoutervid_set                    , {-1}, {ARAD_PP_DBAL_VT_PROG_INVALID}, 0           },
 ...
 *                                                   |                                   |          |                      */
        ...
        {ARAD_PP_DBAL_TT_PROG_SELECTION_MPLS_2       , arad_pp_dbal_tt_cam_mpls2_set     , {-1}, {ARAD_PP_DBAL_TT_PROG_INVALID}, 0         },
...
void arad_pp_dbal_sw_db_vdxvid_sem_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 vid_type)
{
    ...
    switch(vid_type)
    {
        ...
        case OUTER_VID:
            ...
            sw_db_property->qual_info[2].qual_nof_bits = 1;
...
void arad_pp_dbal_sw_db_mpls_prefix_sem_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 mpls_label)
{
    int index=0;
...
uint32  arad_pp_dbal_vt_program_set(int unit)
{
    ...
    for(i=0; i<ARAD_PP_DBAL_VT_NOF_PROGRAMS; i++)
    {
        ...
        if(vt_dbal_programs[i].prog_used[unit] != -1)
        {
            ...
            {
                res = arad_sw_db_tcam_db_access_profile_id_get( unit, program_property.tcam_profile, 0, /* No 320b DB */ &program_property.tcam_profile);
...
uint32 arad_pp_dbal_vt_program_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 program )
{
    ...
    ihp_vtt1st_key_construction_tbl_data.isa_and_mask         = program_property->key_property[0].key_and_mask;
    ihp_vtt1st_key_construction_tbl_data.isa_or_mask          = program_property->key_property[0].key_or_mask;
    ihp_vtt1st_key_construction_tbl_data.isa_lookup_enable    = program_property->key_property[0].lookup_enable;
    ihp_vtt1st_key_construction_tbl_data.isb_and_mask         = program_property->key_property[1].key_and_mask;
    ihp_vtt1st_key_construction_tbl_data.isb_or_mask          = program_property->key_property[1].key_or_mask;
    ihp_vtt1st_key_construction_tbl_data.isb_lookup_enable    = program_property->key_property[1].lookup_enable;
...
void arad_pp_dbal_vt_program_vdxinitialvid_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->key_property[0].key_and_mask   = (0x0);
    program_property->key_property[0].key_or_mask    = ARAD_PP_ISEM_ACCESS_BRIDGE_PREFIX;
    program_property->key_property[0].lookup_enable  = (0x1);
    program_property->vtt_table_index[0]             = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_VDxINITIALVID_SEM_A);
    program_property->key_property[1].key_and_mask   = (0x0);
    program_property->key_property[1].key_or_mask    = ARAD_PP_ISEM_ACCESS_MPLS_UNINDEXED_PREFIX;
    program_property->key_property[1].lookup_enable  = (0x1);
    program_property->vtt_table_index[1]             = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_UNINDEXED_PREFIX_SEM_B);
    program_property->tcam_profile                   = ARAD_TCAM_ACCESS_PROFILE_INVALID;
    ...
    if(g_prog_soc_prop[unit].mpls_1_database == ARAD_PP_ISEM_ACCESS_ID_ISEM_A)
    {
        ...
        program_property->vtt_table_index[0]             = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_UNINDEXED_PREFIX_SEM_A);
...
void arad_pp_dbal_vt_program_vdxoutervid_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused )
{
    ...
    if(!SOC_IS_JERICHO(unit))
    {
        ...
        program_property->qual_to_ce_info.use_32_bit_ce[vdxouter_vid_index][3] = 1;
    }
}
...
void arad_pp_dbal_vt_program_vdxouter_inner_vid_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused )
{
    int vdxouter_vid_index =1;

    program_property->nof_keys = 2;
    program_property->key_property[1].key_and_mask   = (0x0);
    program_property->key_property[1].key_or_mask    = ARAD_PP_ISEM_ACCESS_BRIDGE_PREFIX;
    program_property->key_property[1].lookup_enable  = (0x1);
...
void arad_pp_dbal_vt_program_vdxouter_inner_vid_or_outervid_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused )
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[1][1] = SOC_IS_JERICHO(unit) ? 7  : 5;
    program_property->qual_to_ce_info.qualifier_to_ce_id[1][2] = SOC_IS_JERICHO(unit) ? 6  : 4;
...
void arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 tpid)
{
    ...
    program_property->implicit_flag = 1;
    program_property->key_property[0].key_and_mask   = (0x0);
    program_property->key_property[0].key_or_mask    = (tpid == TPID1) ? ARAD_PP_ISEM_ACCESS_QINQ_COMPRESSED_TPID1_PREFIX : ARAD_PP_ISEM_ACCESS_QINQ_COMPRESSED_TPID2_PREFIX;
    program_property->key_property[0].lookup_enable  = (0x1);
    ...
    program_property->key_property[1].key_and_mask   = (0x0);
    program_property->key_property[1].key_or_mask    = (tpid == TPID1) ? ARAD_PP_ISEM_ACCESS_QINANY_PCP_TPID1_PREFIX : ARAD_PP_ISEM_ACCESS_QINANY_PCP_TPID2_PREFIX;
    program_property->key_property[1].lookup_enable  = (0x1);
...
void arad_pp_dbal_vt_program_outer_pcp_tst2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 tpid)
{
    ...
    program_property->key_property[0].key_and_mask   = (0x0);
    program_property->key_property[0].key_or_mask    = (tpid == TPID1) ? ARAD_PP_ISEM_ACCESS_1Q_COMPRESSED_PCP_TPID1_PREFIX : ARAD_PP_ISEM_ACCESS_1Q_COMPRESSED_PCP_TPID2_PREFIX;
    program_property->key_property[0].lookup_enable  = (0x1);
    ...
    program_property->key_property[1].key_and_mask   = (0x0);
    program_property->key_property[1].key_or_mask    = (tpid == TPID1) ? ARAD_PP_ISEM_ACCESS_1Q_COMPRESSED_TPID1_PREFIX : ARAD_PP_ISEM_ACCESS_1Q_COMPRESSED_TPID2_PREFIX;
    program_property->key_property[1].lookup_enable  = (0x1);
...
void arad_pp_dbal_vt_program_outer_inner_tst2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 tpid)
{
    ...
    program_property->key_property[1].key_and_mask   = (0x0);
    program_property->key_property[1].key_or_mask    = (tpid == TPID1) ? ARAD_PP_ISEM_ACCESS_QINANY_TPID1_PREFIX : ARAD_PP_ISEM_ACCESS_QINANY_TPID2_PREFIX;
    program_property->key_property[1].lookup_enable  = (0x1);
...
void arad_pp_dbal_vt_program_outer_tst2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 tpid)
{
    ...
    program_property->key_property[0].key_and_mask   = (0x0);
    program_property->key_property[0].key_or_mask    = (tpid == TPID1) ? ARAD_PP_ISEM_ACCESS_1Q_TPID1_PREFIX : ARAD_PP_ISEM_ACCESS_1Q_TPID2_PREFIX;
    program_property->key_property[0].lookup_enable  = (0x1);
...
void arad_pp_dbal_vt_program_untagged_tst2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->key_property[0].key_and_mask   = (0x0);
    program_property->key_property[0].key_or_mask    = ARAD_PP_ISEM_ACCESS_QINQ_COMPRESSED_TPID1_PREFIX;
    program_property->key_property[0].lookup_enable  = (0x1);
...
uint32 arad_pp_dbal_tt_program_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 program )
{
    ...
    ihp_vtt2nd_key_construction_tbl_data.isa_and_mask            = program_property->key_property[0].key_and_mask;
    ihp_vtt2nd_key_construction_tbl_data.isa_or_mask             = program_property->key_property[0].key_or_mask;
    ihp_vtt2nd_key_construction_tbl_data.isa_lookup_enable       = program_property->key_property[0].lookup_enable;
    ihp_vtt2nd_key_construction_tbl_data.isb_and_mask            = program_property->key_property[1].key_and_mask;
    ihp_vtt2nd_key_construction_tbl_data.isb_or_mask             = program_property->key_property[1].key_or_mask;
    ihp_vtt2nd_key_construction_tbl_data.isb_lookup_enable       = program_property->key_property[1].lookup_enable;
...
void arad_pp_dbal_tt_program_mpls_l2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused )
{
    ...
    program_property->key_property[1].key_or_mask    = ARAD_PP_ISEM_ACCESS_MPLS_UNINDEXED_PREFIX;
    program_property->key_property[1].lookup_enable  = 0x1;
    program_property->vtt_table_index[0]             = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L2_SEM_B);
    program_property->pd_bitmap_0     = 0x8;
    program_property->pd_bitmap_1     = 0x0;
    program_property->tcam_profile    = ARAD_TCAM_ACCESS_PROFILE_INVALID;
    ...
    {
        arad_pp_dbal_vtt_program_property_swap(program_property );
        program_property->vtt_table_index[0]    = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L2_SEM_A);
    }
...
void arad_pp_dbal_tt_program_bridge_property_set (int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    else
    {
        ...
        {
            program_property->key_property[1].key_and_mask  = (0x7);
            program_property->key_property[1].key_or_mask   = ARAD_PP_ISEM_ACCESS_IPV4_SPOOF_PREFIX;
            program_property->key_property[1].lookup_enable = (0x1);
...
void arad_pp_dbal_vtt_program_property_swap(ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property )
{
    ...
    ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY_SWAP_FIELD(program_property->key_property[0].key_and_mask , program_property->key_property[1].key_and_mask);
    ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY_SWAP_FIELD(program_property->key_property[0].key_or_mask  , program_property->key_property[1].key_or_mask);
    ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY_SWAP_FIELD(program_property->key_property[0].lookup_enable, program_property->key_property[1].lookup_enable);
