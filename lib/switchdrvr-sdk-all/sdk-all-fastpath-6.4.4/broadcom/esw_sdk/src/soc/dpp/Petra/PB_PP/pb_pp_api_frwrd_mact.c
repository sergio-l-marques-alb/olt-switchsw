/* $Id: pb_pp_api_frwrd_mact.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_frwrd_mact.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_MACT_ENTRY_ADD);
  ...
  res = soc_pb_pp_frwrd_mact_entry_add_verify(
          unit,
          add_type,
          mac_entry_key,
          mac_entry_value
  ...
  res = soc_pb_pp_frwrd_mact_entry_add_unsafe(
          unit,
          add_type,
          mac_entry_key,
          mac_entry_value,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_mact_entry_add()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_MACT_ENTRY_REMOVE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(mac_entry_key);

  res = soc_pb_pp_frwrd_mact_entry_remove_verify(
          unit,
          mac_entry_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_mact_entry_remove_unsafe(
          unit,
          mac_entry_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_mact_entry_remove()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_MACT_ENTRY_GET);
  ...
  res = soc_pb_pp_frwrd_mact_entry_get_verify(
          unit,
          mac_entry_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_mact_entry_get_unsafe(
          unit,
          mac_entry_key,
          mac_entry_value,
          found
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_mact_entry_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_MACT_TRAVERSE);
  ...
  res = soc_pb_pp_frwrd_mact_traverse_verify(
          unit,
          rule,
          action,
          wait_till_finish
  ...
  res = soc_pb_pp_frwrd_mact_traverse_unsafe(
          unit,
          rule,
          action,
          wait_till_finish,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_mact_traverse()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_MACT_TRAVERSE_STATUS_GET);
  ...
  res = soc_pb_pp_frwrd_mact_traverse_status_get_unsafe(
          unit,
          status
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_mact_traverse_status_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_MACT_GET_BLOCK);
  ...
  res = soc_pb_pp_frwrd_mact_get_block_verify(
          unit,
          rule,
          block_range
        );
  ...
  res = soc_pb_pp_frwrd_mact_get_block_unsafe(
          unit,
          rule,
          block_range,
          mact_keys,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_mact_get_block()", 0, 0);
}
