/* $Id: pb_pp_api_llp_parse.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_llp_parse.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_TPID_VALUES_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(tpid_vals);

  res = soc_pb_pp_llp_parse_tpid_values_set_verify(
          unit,
          tpid_vals
        );
  ...
  res = soc_pb_pp_llp_parse_tpid_values_set_unsafe(
          unit,
          tpid_vals
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_tpid_values_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_TPID_VALUES_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(tpid_vals);

  res = soc_pb_pp_llp_parse_tpid_values_get_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_tpid_values_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_TPID_PROFILE_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(tpid_profile_info);

  res = soc_pb_pp_llp_parse_tpid_profile_info_set_verify(
          unit,
          tpid_profile_ndx,
          tpid_profile_info
        );
  ...
  res = soc_pb_pp_llp_parse_tpid_profile_info_set_unsafe(
          unit,
          tpid_profile_ndx,
          tpid_profile_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_tpid_profile_info_set()", tpid_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_TPID_PROFILE_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(tpid_profile_info);

  res = soc_pb_pp_llp_parse_tpid_profile_info_get_verify(
          unit,
          tpid_profile_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_tpid_profile_info_get()", tpid_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_PORT_PROFILE_TO_TPID_PROFILE_MAP_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_llp_parse_port_profile_to_tpid_profile_map_set_verify(
          unit,
          port_profile_ndx,
          tpid_profile_id
        );
  ...
  res = soc_pb_pp_llp_parse_port_profile_to_tpid_profile_map_set_unsafe(
          unit,
          port_profile_ndx,
          tpid_profile_id
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_port_profile_to_tpid_profile_map_set()", port_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_PORT_PROFILE_TO_TPID_PROFILE_MAP_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(tpid_profile_id);

  res = soc_pb_pp_llp_parse_port_profile_to_tpid_profile_map_get_verify(
          unit,
          port_profile_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_llp_parse_port_profile_to_tpid_profile_map_get_unsafe(
          unit,
          port_profile_ndx,
          tpid_profile_id
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_port_profile_to_tpid_profile_map_get()", port_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_PACKET_FORMAT_INFO_SET);
  ...
  res = soc_pb_pp_llp_parse_packet_format_info_set_verify(
          unit,
          port_profile_ndx,
          parse_key,
          format_info
  ...
  res = soc_pb_pp_llp_parse_packet_format_info_set_unsafe(
          unit,
          port_profile_ndx,
          parse_key,
          format_info
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_packet_format_info_set()", port_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_LLP_PARSE_PACKET_FORMAT_INFO_GET);
  ...
  res = soc_pb_pp_llp_parse_packet_format_info_get_verify(
          unit,
          port_profile_ndx,
          parse_key
        );
  ...
  res = soc_pb_pp_llp_parse_packet_format_info_get_unsafe(
          unit,
          port_profile_ndx,
          parse_key,
          format_info
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_llp_parse_packet_format_info_get()", port_profile_ndx, 0);
}
  ...
  )
{
  ...
  /* default value for Soc_petra-B, should not be changed */
  ...
  )
{
  ...
  info->tpid1.type = SOC_SAND_PP_VLAN_TAG_TYPE_ANY;
  info->tpid2.type = SOC_SAND_PP_VLAN_TAG_TYPE_ANY;
