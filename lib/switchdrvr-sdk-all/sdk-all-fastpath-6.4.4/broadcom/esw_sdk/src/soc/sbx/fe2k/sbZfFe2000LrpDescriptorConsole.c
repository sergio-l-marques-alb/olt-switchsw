/*
 * $Id: sbZfFe2000LrpDescriptorConsole.c,v 1.5 Broadcom SDK $
...
sbZfFe2000LrpDescriptor_Print(sbZfFe2000LrpDescriptor_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: contbyte=0x%02x"), (unsigned int)  pFromStruct->m_uContinueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: hdr4=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderType4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: locn0=0x%02x"), (unsigned int)  pFromStruct->m_uLocation0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: locn4=0x%02x"), (unsigned int)  pFromStruct->m_uLocation4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: locn8=0x%02x"), (unsigned int)  pFromStruct->m_uLocation8));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: expidx=0x%02x"), (unsigned int)  pFromStruct->m_uExceptIndex));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" hccpy=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderCopy));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: cpycnt=0x%03x"), (unsigned int)  pFromStruct->m_uCopyCount));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" crcmode=0x%01x"), (unsigned int)  pFromStruct->m_uCrcMode));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" dropbit=0x%01x"), (unsigned int)  pFromStruct->m_uDropBit));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: dqueue=0x%02x"), (unsigned int)  pFromStruct->m_uDestinationQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: frmlen=0x%04x"), (unsigned int)  pFromStruct->m_uFrameLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata0=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata4=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata8=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte8));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata12=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte12));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata16=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte16));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata20=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte20));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata24=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte24));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata28=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte28));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata32=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte32));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata36=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte36));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata40=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte40));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata44=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte44));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata48=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte48));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata52=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte52));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata56=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte56));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata60=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte60));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata64=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte64));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata68=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte68));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata72=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte72));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata76=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte76));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata80=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte80));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata84=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte84));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata88=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte88));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata92=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte92));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata96=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte96));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata100=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte100));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata103=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte103));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata106=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte106));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata109=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte109));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata112=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte112));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata115=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte115));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata118=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte118));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata121=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte121));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata124=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte124));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata127=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte127));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata130=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte130));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata133=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte133));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata136=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte136));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata139=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte139));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata142=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte142));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata145=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte145));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata148=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte148));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata151=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte151));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000LrpDescriptor:: pdata154=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte154));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfFe2000LrpDescriptor_SPrint(sbZfFe2000LrpDescriptor_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
