/*
 * $Id: sbZfCaUcodeAccessDescriptor.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaUcodeAccessDescriptor.hx"
...
sbZfCaUcodeAccessDescriptor_Pack(sbZfCaUcodeAccessDescriptor_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAUCODEACCESSDESCRIPTOR_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAUCODEACCESSDESCRIPTOR_SIZE_IN_BYTES;
}
...
sbZfCaUcodeAccessDescriptor_Unpack(sbZfCaUcodeAccessDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_nRWN =  (int32)  ((pFromData)[6] >> 2) & 0x01;

  /* Unpack Member: m_nPort */
  (pToStruct)->m_nPort =  (int32)  ((pFromData)[5] >> 5) & 0x07;
  (pToStruct)->m_nPort |=  (int32)  ((pFromData)[6] & 0x03) << 3;

  /* Unpack Member: m_nAddr */
  (pToStruct)->m_nAddr =  (int32)  ((pFromData)[1] >> 6) & 0x03;
  (pToStruct)->m_nAddr |=  (int32)  (pFromData)[2] << 2;
  (pToStruct)->m_nAddr |=  (int32)  (pFromData)[3] << 10;
  (pToStruct)->m_nAddr |=  (int32)  (pFromData)[4] << 18;
  (pToStruct)->m_nAddr |=  (int32)  ((pFromData)[5] & 0x03) << 26;

  /* Unpack Member: m_nData */
  (pToStruct)->m_nData =  (int32)  (pFromData)[0] ;
  (pToStruct)->m_nData |=  (int32)  ((pFromData)[1] & 0x3f) << 8;
