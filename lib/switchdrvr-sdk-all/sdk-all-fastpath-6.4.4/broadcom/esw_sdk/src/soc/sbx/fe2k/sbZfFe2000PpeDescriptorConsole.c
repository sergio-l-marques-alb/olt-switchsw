/*
 * $Id: sbZfFe2000PpeDescriptorConsole.c,v 1.5 Broadcom SDK $
...
#include "sbZfFe2000PpeDescriptorConsole.hx"



/* Print members in struct */
void
sbZfFe2000PpeDescriptor_Print(sbZfFe2000PpeDescriptor_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: contbyte=0x%02x"), (unsigned int)  pFromStruct->m_uContinueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: hdr4=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderType4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: locn0=0x%02x"), (unsigned int)  pFromStruct->m_uLocation0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: locn4=0x%02x"), (unsigned int)  pFromStruct->m_uLocation4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" locn5=0x%02x"), (unsigned int)  pFromStruct->m_uLocation5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: locn8=0x%02x"), (unsigned int)  pFromStruct->m_uLocation8));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" locn9=0x%02x"), (unsigned int)  pFromStruct->m_uLocation9));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" str=0x%01x"), (unsigned int)  pFromStruct->m_uStreamSelector));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: sque=0x%02x"), (unsigned int)  pFromStruct->m_uSourceQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" rxport0=0x%02x"), (unsigned int)  pFromStruct->m_uRxPortData0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" repcnt=0x%03x"), (unsigned int)  pFromStruct->m_uReplicantCnt));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: resv0=0x%01x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" drop=0x%01x"), (unsigned int)  pFromStruct->m_uDrop));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" enq=0x%01x"), (unsigned int)  pFromStruct->m_uEnqueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" dqueue=0x%02x"), (unsigned int)  pFromStruct->m_uDqueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: rxport1=0x%05x"), (unsigned int)  pFromStruct->m_uRxPortData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" frmlen=0x%04x"), (unsigned int)  pFromStruct->m_uFrameLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" aggrhash=0x%08x"), (unsigned int)  pFromStruct->m_uAggrHash));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: variable=0x%08x"), (unsigned int)  pFromStruct->m_uVariable));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata2=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte2));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata6=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte6));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata10=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte10));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata14=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte14));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata18=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte18));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata22=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte22));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata26=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte26));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata30=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte30));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata34=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte34));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata38=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte38));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata42=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte42));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata46=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte46));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata50=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte50));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata54=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte54));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata58=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte58));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata62=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte62));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata66=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte66));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata70=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte70));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata74=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte74));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata78=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte78));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata82=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte82));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata86=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte86));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata90=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte90));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata94=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte94));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata98=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte98));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata102=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte102));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata105=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte105));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata108=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte108));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata111=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte111));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata114=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte114));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata117=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte117));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata120=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte120));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata123=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte123));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata126=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte126));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata129=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte129));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata132=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte132));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata135=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte135));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata138=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte138));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata141=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte141));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata144=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte144));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata147=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte147));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata150=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte150));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpeDescriptor:: pdata153=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte153));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfFe2000PpeDescriptor_SPrint(sbZfFe2000PpeDescriptor_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: contbyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: hdr4=0x%01x", (unsigned int)  pFromStruct->m_uHeaderType4);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: locn0=0x%02x", (unsigned int)  pFromStruct->m_uLocation0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: locn4=0x%02x", (unsigned int)  pFromStruct->m_uLocation4);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," locn5=0x%02x", (unsigned int)  pFromStruct->m_uLocation5);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: locn8=0x%02x", (unsigned int)  pFromStruct->m_uLocation8);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," locn9=0x%02x", (unsigned int)  pFromStruct->m_uLocation9);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," str=0x%01x", (unsigned int)  pFromStruct->m_uStreamSelector);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: sque=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," rxport0=0x%02x", (unsigned int)  pFromStruct->m_uRxPortData0);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," repcnt=0x%03x", (unsigned int)  pFromStruct->m_uReplicantCnt);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," repbit=0x%01x", (unsigned int)  pFromStruct->m_bReplicantBit);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: resv0=0x%01x", (unsigned int)  pFromStruct->m_uResv0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," dqueue=0x%02x", (unsigned int)  pFromStruct->m_uDqueue);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: rxport1=0x%05x", (unsigned int)  pFromStruct->m_uRxPortData1);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," frmlen=0x%04x", (unsigned int)  pFromStruct->m_uFrameLength);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," aggrhash=0x%08x", (unsigned int)  pFromStruct->m_uAggrHash);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: variable=0x%08x", (unsigned int)  pFromStruct->m_uVariable);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata2=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte2);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata6=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte6);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata10=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte10);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata14=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte14);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata18=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte18);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata22=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte22);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata26=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte26);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata30=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte30);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata34=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte34);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata38=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte38);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata42=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte42);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata46=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte46);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata50=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte50);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata54=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte54);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata58=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte58);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata62=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte62);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata66=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte66);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata70=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte70);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata74=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte74);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata78=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte78);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata82=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte82);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata86=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte86);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata90=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte90);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata94=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte94);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata98=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte98);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata102=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte102);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata105=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte105);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata108=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte108);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata111=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte111);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata114=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte114);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata117=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte117);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata120=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte120);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata123=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte123);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata126=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte126);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata129=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte129);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata132=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte132);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata135=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte135);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata138=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte138);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata141=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte141);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata144=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte144);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata147=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte147);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata150=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte150);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000PpeDescriptor:: pdata153=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte153);
...
int
sbZfFe2000PpeDescriptor_Validate(sbZfFe2000PpeDescriptor_t *pZf) {
...
int
sbZfFe2000PpeDescriptor_SetField(sbZfFe2000PpeDescriptor_t *s, char* name, int value) {
