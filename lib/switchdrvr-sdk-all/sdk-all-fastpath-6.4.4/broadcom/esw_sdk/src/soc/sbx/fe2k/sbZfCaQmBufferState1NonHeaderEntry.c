/*
 * $Id: sbZfCaQmBufferState1NonHeaderEntry.c,v 1.2 Broadcom SDK $
...
sbZfCaQmBufferState1NonHeaderEntry_Unpack(sbZfCaQmBufferState1NonHeaderEntry_t *pToStruct,
  ...
  (pToStruct)->m_uReserved =  (uint32)  ((pFromData)[3] >> 2) & 0x1f;

  /* Unpack Member: m_uReplicationState */
  (pToStruct)->m_uReplicationState =  (uint32)  ((pFromData)[1] >> 7) & 0x01;
  (pToStruct)->m_uReplicationState |=  (uint32)  (pFromData)[2] << 1;
  (pToStruct)->m_uReplicationState |=  (uint32)  ((pFromData)[3] & 0x03) << 9;

  /* Unpack Member: m_uDrop */
  (pToStruct)->m_uDrop =  (uint32)  ((pFromData)[1] >> 6) & 0x01;
