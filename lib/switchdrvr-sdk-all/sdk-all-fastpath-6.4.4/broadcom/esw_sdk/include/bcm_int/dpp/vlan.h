...
typedef struct _bcm_dpp_vlan_unit_state_s {
    ...
    _bcm_dpp_vlan_translate_action_t edit_ing_action[SOC_PPD_NOF_INGRESS_VLAN_EDIT_ACTION_IDS];
    _bcm_dpp_vlan_translate_action_t edit_eg_action[SOC_PPD_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_IDS];
    uint8 edit_eg_action_mapping[SOC_PPD_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS];
