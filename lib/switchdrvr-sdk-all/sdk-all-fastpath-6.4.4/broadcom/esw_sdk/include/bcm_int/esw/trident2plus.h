...
extern int  bcm_td2p_failover_prot_nhi_update(int unit, int old_nh_index,
        int new_nh_index);
extern int bcm_td2p_vxlan_dvp_vlan_xlate_key_set(int unit, 
        bcm_gport_t port_id, int key_type);
extern int bcm_td2p_vxlan_dvp_vlan_xlate_key_get(int unit, 
        bcm_gport_t port_id, int *key_type);
...
extern int _bcm_vlan_vfi_memebershipship_profile_entry_op(int unit,
                                                          void **entries,
                                                          int entries_per_set,
                                                          int del,
                                                          int egress,
...
extern int _bcm_vlan_vfi_memebership_profile_mem_reference(int unit,
                                                           int index,
                                                           int entries_per_set,
                                                           int egress);
