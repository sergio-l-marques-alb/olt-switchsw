...
#define ALU_SET_IF(_op1, _cmp_type, _op2, _res, _dst) \
                arad_egr_prge_interface_set_if_instr(unit, _op1, (ARAD_EGR_PROG_EDITOR_ALU_CMP_##_cmp_type), _op2, _res, _dst, &instr)
...
typedef enum predefined_data_s {
    ...
    PrgePktFieldFheiSize,
    PrgePktFieldFwdHdrOffset,
    PrgePktFieldEthTypeNoTag,
    PrgePktFieldEthTypeSingleTag,
