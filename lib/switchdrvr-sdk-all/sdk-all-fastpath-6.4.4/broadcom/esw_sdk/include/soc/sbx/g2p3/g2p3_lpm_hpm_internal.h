...
/*
 * $Id: g2p3_lpm_hpm_internal.h,v 1.4 Broadcom SDK $
 *
...
typedef struct g2p3_lpmPayload_s {
    uint32 refs;                       /* number of refs to this payload */
    uint8 data[1];                     /* start of payload data */
...
typedef struct g2p3_lpmHPM_s {
    ...
    uint32 bytesPerPayload;            /* bytes of data in each payload */
