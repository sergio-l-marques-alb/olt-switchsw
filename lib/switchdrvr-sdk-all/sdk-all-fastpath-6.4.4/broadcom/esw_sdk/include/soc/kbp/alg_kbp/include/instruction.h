...
{
    /* ONLY INDEX */
    KBP_INDEX_AND_NO_AD,    /**< Only index is returned in the search result.*/

    /* INDEX AND ASSOCIATED DATA */
    KBP_INDEX_AND_8B_AD,    /**< Index and 8-bit AD is returned in the search result. */
    KBP_INDEX_AND_16B_AD,   /**< Index and 16-bit AD is returned in the search result. */
    KBP_INDEX_AND_24B_AD,   /**< Index and 24-bit AD is returned in the search result. */
    KBP_INDEX_AND_32B_AD,   /**< Index and 32-bit AD is returned in the search result. */
    KBP_INDEX_AND_40B_AD,   /**< Index and 40-bit AD is returned in the search result. */
    KBP_INDEX_AND_48B_AD,   /**< Index and 48-bit AD is returned in the search result. */
    KBP_INDEX_AND_56B_AD,   /**< Index and 56-bit AD is returned in the search result. */
    KBP_INDEX_AND_64B_AD,   /**< Index and 64-bit AD is returned in the search result. */
    KBP_INDEX_AND_72B_AD,   /**< Index and 72-bit AD is returned in the search result. */
    KBP_INDEX_AND_80B_AD,   /**< Index and 80-bit AD is returned in the search result. */
    KBP_INDEX_AND_88B_AD,   /**< Index and 88-bit AD is returned in the search result. */
    KBP_INDEX_AND_96B_AD,   /**< Index and 96-bit AD is returned in the search result. */
    KBP_INDEX_AND_104B_AD,  /**< Index and 104-bit AD is returned in the search result. */
    KBP_INDEX_AND_112B_AD,  /**< Index and 112-bit AD is returned in the search result. */
    KBP_INDEX_AND_120B_AD,  /**< Index and 120-bit AD is returned in the search result. */
    KBP_INDEX_AND_128B_AD,  /**< Index and 128-bit AD is returned in the search result. */
    KBP_INDEX_AND_136B_AD,  /**< Index and 136-bit AD is returned in the search result. */
    KBP_INDEX_AND_144B_AD,  /**< Index and 144-bit AD is returned in the search result. */
    KBP_INDEX_AND_152B_AD,  /**< Index and 152-bit AD is returned in the search result. */
    KBP_INDEX_AND_160B_AD,  /**< Index and 160-bit AD is returned in the search result. */
    KBP_INDEX_AND_168B_AD,  /**< Index and 168-bit AD is returned in the search result. */
    KBP_INDEX_AND_176B_AD,  /**< Index and 176-bit AD is returned in the search result. */
    KBP_INDEX_AND_184B_AD,  /**< Index and 184-bit AD is returned in the search result. */
    KBP_INDEX_AND_192B_AD,  /**< Index and 192-bit AD is returned in the search result. */
    KBP_INDEX_AND_200B_AD,  /**< Index and 200-bit AD is returned in the search result. */
    KBP_INDEX_AND_208B_AD,  /**< Index and 208-bit AD is returned in the search result. */
    KBP_INDEX_AND_216B_AD,  /**< Index and 216-bit AD is returned in the search result. */
    KBP_INDEX_AND_224B_AD,  /**< Index and 224-bit AD is returned in the search result. */
    KBP_INDEX_AND_232B_AD,  /**< Index and 232-bit AD is returned in the search result. */
    KBP_INDEX_AND_240B_AD,  /**< Index and 240-bit AD is returned in the search result. */
    KBP_INDEX_AND_248B_AD,  /**< Index and 248-bit AD is returned in the search result. */
    KBP_INDEX_AND_256B_AD,  /**< Index and 256-bit AD is returned in the search result. */

    /* ONLY ASSOCIATED DATA */
    KBP_ONLY_AD_8B,    /**< Only 8-bit AD is returned in the search result. */
    KBP_ONLY_AD_16B,   /**< Only 16-bit AD is returned in the search result. */
    KBP_ONLY_AD_24B,   /**< Only 24-bit AD is returned in the search result. */
    KBP_ONLY_AD_32B,   /**< Only 32-bit AD is returned in the search result. */
    KBP_ONLY_AD_40B,   /**< Only 40-bit AD is returned in the search result. */
    KBP_ONLY_AD_48B,   /**< Only 48-bit AD is returned in the search result. */
    KBP_ONLY_AD_56B,   /**< Only 56-bit AD is returned in the search result. */
    KBP_ONLY_AD_64B,   /**< Only 64-bit AD is returned in the search result. */
    KBP_ONLY_AD_72B,   /**< Only 72-bit AD is returned in the search result. */
    KBP_ONLY_AD_80B,   /**< Only 80-bit AD is returned in the search result. */
    KBP_ONLY_AD_88B,   /**< Only 88-bit AD is returned in the search result. */
    KBP_ONLY_AD_96B,   /**< Only 96-bit AD is returned in the search result. */
    KBP_ONLY_AD_104B,  /**< Only 104-bit AD is returned in the search result. */
    KBP_ONLY_AD_112B,  /**< Only 112-bit AD is returned in the search result. */
    KBP_ONLY_AD_120B,  /**< Only 120-bit AD is returned in the search result. */
    KBP_ONLY_AD_128B,  /**< Only 128-bit AD is returned in the search result. */
    KBP_ONLY_AD_136B,  /**< Only 136-bit AD is returned in the search result. */
    KBP_ONLY_AD_144B,  /**< Only 144-bit AD is returned in the search result. */
    KBP_ONLY_AD_152B,  /**< Only 152-bit AD is returned in the search result. */
    KBP_ONLY_AD_160B,  /**< Only 160-bit AD is returned in the search result. */
    KBP_ONLY_AD_168B,  /**< Only 168-bit AD is returned in the search result. */
    KBP_ONLY_AD_176B,  /**< Only 176-bit AD is returned in the search result. */
    KBP_ONLY_AD_184B,  /**< Only 184-bit AD is returned in the search result. */
    KBP_ONLY_AD_192B,  /**< Only 192-bit AD is returned in the search result. */
    KBP_ONLY_AD_200B,  /**< Only 200-bit AD is returned in the search result. */
    KBP_ONLY_AD_208B,  /**< Only 208-bit AD is returned in the search result. */
    KBP_ONLY_AD_216B,  /**< Only 216-bit AD is returned in the search result. */
    KBP_ONLY_AD_224B,  /**< Only 224-bit AD is returned in the search result. */
    KBP_ONLY_AD_232B,  /**< Only 232-bit AD is returned in the search result. */
    KBP_ONLY_AD_240B,  /**< Only 240-bit AD is returned in the search result. */
    KBP_ONLY_AD_248B,  /**< Only 248-bit AD is returned in the search result. */
    KBP_ONLY_AD_256B   /**< Only 256-bit AD is returned in the search result. */
};
