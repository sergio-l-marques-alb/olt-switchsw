;
; $Id: bcm956024p48ref.asm,v 1.6 Broadcom SDK $
;
...
; 
;
; This is the default program for the (48+2+2 port) BCM956024P48REF
; reference board.
; To start it, use the following commands from BCM:
;
;       led load bcm956024p48ref.hex
;       led auto on
;       led start
;
...
RX_TIMERS       equ     0xc0+0         ; NUM_PORT bytes C0 - DF
