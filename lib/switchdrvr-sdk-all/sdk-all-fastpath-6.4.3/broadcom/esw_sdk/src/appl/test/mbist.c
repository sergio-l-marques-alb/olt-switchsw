...
memory_logic_bist_test(int u, args_t *a, void *p)
{
    ...
    if ((*bist_type == MEMORY_BIST) || (*bist_type == ALL_BIST)) {
        if (SOC_IS_TRIDENT2(u)) {
            ...
            cli_out("MEMORY BIST...\n");
            (void)tomahawk_mbist_pattern0(u, error_count);
            (void)tomahawk_mbist_pattern1(u, error_count);
            (void)tomahawk_mbist_pattern2(u, error_count);
            (void)tomahawk_mbist_pattern3(u, error_count);

            /* Print out accumulated pass/fail results */
            if ((error_count[0] == 0) && (error_count[1] == 0)) {
