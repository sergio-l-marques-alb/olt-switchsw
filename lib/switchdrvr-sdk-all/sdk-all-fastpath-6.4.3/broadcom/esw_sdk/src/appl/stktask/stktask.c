...
st_linkscan_handler(int unit, bcm_port_t port, bcm_port_info_t *info)
{
    ...
    if ((info->linkstatus != BCM_PORT_LINK_STATUS_UP ) &&  
         ...
         *        application.
         */
        /* If bcm_st_cur_db is updated, then call topo_board_rapid_recovery */
        if (bcm_st_cur_db) {
        ...
        /* If bcm_st_cur_db is NULL, then update the LINK_DOWN event, Stack
         * Thread will process these events at later stage.
         */
