                      ...
                      int queue_id)
{
    ...
    BCM_DPP_ASSYMETRIC_CORES_ITER(SOC_CORE_ALL, core) {
        ...
        /* update state */
        rc = _bcm_petra_cosq_ucast_qid_range_set(unit, core, qid_start, qid_end);
        BCMDNX_IF_ERR_EXIT(rc);

#ifdef BCM_WARM_BOOT_SUPPORT
        rc = _bcm_dpp_wb_cosq_update_ucast_data(unit, core, qid_start, qid_end);
        BCMDNX_IF_ERR_EXIT(rc);
#endif /* BCM_WARM_BOOT_SUPPORT */
    }
                                            ...
                                            int queue_id)
{
    ...
    if (is_run_allocation) {
        ...
        rc = _bcm_dpp_am_cosq_process_queue_region(unit, SOC_CORE_ALL, queue_region_config);
        BCMDNX_IF_ERR_EXIT(rc);
