...
#if defined (BCM_TRIDENT_SUPPORT) || defined (BCM_KATANA2_SUPPORT) || defined (BCM_HELIX4_SUPPORT)
#if defined(BCM_WARM_BOOT_SUPPORT)
int
_bcm_esw_udf_scache_sync(int unit)
{
    if (SOC_IS_TD_TT(unit) || SOC_IS_KATANA2(unit) || SOC_IS_HELIX4(unit)) {
...
#endif /* BCM_TRIDENT_SUPPORT || BCM_KATANA2_SUPPORT || BCM_HELIX4_SUPPORT */
