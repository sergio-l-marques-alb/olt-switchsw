...
soc_error_t
soc_fe3200_cosq_pipe_rx_weight_set(int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int weight)
{
    soc_error_t rc;
...
soc_error_t
soc_fe3200_cosq_pipe_rx_weight_get(int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int *weight)
{
    soc_error_t rc;
    uint32 reg_val32;
    ...
    if (mode == soc_dfe_cosq_weight_mode_regular) 
    {
        SOCDNX_IF_ERR_EXIT(READ_DCH_PIPES_WEIGHTS_REGISTERr(unit, 0, &reg_val32));
    ...
    {
        SOCDNX_IF_ERR_EXIT(READ_DCH_DYN_PIPES_WEIGHTS_REGISTERr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_mid_weight_set(int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int weight)
{
    soc_error_t rc;
...
soc_error_t  
soc_fe3200_cosq_pipe_mid_weight_get(int unit, int pipe, soc_dfe_cosq_weight_mode_t mode, int *weight)
{
    soc_error_t rc;
    uint32 reg_val32;
    ...
    if (mode == soc_dfe_cosq_weight_mode_regular) 
    {
        SOCDNX_IF_ERR_EXIT(READ_DCM_PIPES_WEIGHTS_REGISTERr(unit, 0, &reg_val32));
    ...
    {
        SOCDNX_IF_ERR_EXIT(READ_DCM_DYN_PIPES_WEIGHTS_REGISTERr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_rx_threshold_set(int unit, int pipe, int threshold)
{
    soc_error_t rc;
...
soc_error_t  
soc_fe3200_cosq_pipe_rx_threshold_get(int unit, int pipe, int *threshold)
{
    soc_error_t rc;
    uint32 reg_val32;
    ...
    SOCDNX_IF_ERR_EXIT(READ_DCH_DYN_WFQ_WEIGHT_THD_REGISTEr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_mid_threshold_set(int unit, int pipe, int threshold)
{
    soc_error_t rc;
...
soc_error_t  
soc_fe3200_cosq_pipe_mid_threshold_get(int unit, int pipe, int *threshold)
{
    soc_error_t rc;
    uint32 reg_val32;
    ...
    SOCDNX_IF_ERR_EXIT(READ_DCM_DYN_WFQ_WEIGHT_THD_REGISTERr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_tx_threshold_set(int unit, int pipe, int threshold)
{
    soc_error_t rc;
...
soc_error_t  
soc_fe3200_cosq_pipe_tx_threshold_get(int unit, int pipe, int *threshold)
{
    soc_error_t rc;
    uint32 reg_val32;
    ...
    SOCDNX_IF_ERR_EXIT(READ_DCL_LINK_WEIGHT_CONFIG_THRESHOLDSr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_rx_rate_set(int unit, int pipe, soc_dfe_cosq_shaper_mode_t shaper_mode, uint32 rate)
{
...
soc_error_t  
soc_fe3200_cosq_pipe_rx_rate_get(int unit, int pipe, soc_dfe_cosq_shaper_mode_t *shaper_mode, uint32 *rate)
{
    ...
    */ 
    ...
    SOCDNX_IF_ERR_EXIT(READ_DCH_LP_PIPE_SHAPER_REGISTERr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_tx_rate_set(int unit, soc_dfe_cosq_shaper_mode_t shaper_mode, uint32 rate)
{
...
soc_error_t
soc_fe3200_cosq_pipe_tx_rate_get(int unit, soc_dfe_cosq_shaper_mode_t *shaper_mode, uint32 *rate)
{
    uint32 inc_size, shaper_rate, reg_val32, core_clock_speed;
    ...
    SOCDNX_IF_ERR_EXIT(READ_DCL_SHAPER_AND_WFQ_CFGr(unit, 0, &reg_val32));
...
soc_error_t  
soc_fe3200_cosq_pipe_tx_rate_enable_set(int unit, int pipe, int enable)
{
...
soc_error_t  
soc_fe3200_cosq_pipe_tx_rate_enable_get(int unit, int pipe, int *enable)
{
    uint32 reg_val32, pipes_bmp;
