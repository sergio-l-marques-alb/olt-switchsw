...
#include "sbZfCaMmNarrowPortMemorySegmentConfigDataConsole.hx"



/* Print members in struct */
void
sbZfCaMmNarrowPortMemorySegmentConfigData_Print(sbZfCaMmNarrowPortMemorySegmentConfigData_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmNarrowPortMemorySegmentConfigData:: resv0=0x%02x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmNarrowPortMemorySegmentConfigData:: ding=0x%01x"), (unsigned int)  pFromStruct->m_uDataIntegrity));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmNarrowPortMemorySegmentConfigData:: lmask=0x%06x"), (unsigned int)  pFromStruct->m_uLimitMask));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" baddr=0x%06x"), (unsigned int)  pFromStruct->m_uBaseAddress));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaMmNarrowPortMemorySegmentConfigData_SPrint(sbZfCaMmNarrowPortMemorySegmentConfigData_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaMmNarrowPortMemorySegmentConfigData:: resv0=0x%02x", (unsigned int)  pFromStruct->m_uResv0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaMmNarrowPortMemorySegmentConfigData:: ding=0x%01x", (unsigned int)  pFromStruct->m_uDataIntegrity);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaMmNarrowPortMemorySegmentConfigData:: lmask=0x%06x", (unsigned int)  pFromStruct->m_uLimitMask);
...
int
sbZfCaMmNarrowPortMemorySegmentConfigData_Validate(sbZfCaMmNarrowPortMemorySegmentConfigData_t *pZf) {
...
int
sbZfCaMmNarrowPortMemorySegmentConfigData_SetField(sbZfCaMmNarrowPortMemorySegmentConfigData_t *s, char* name, int value) {
