/*
 * $Id: sbZfCaPpCamConfigurationInstance0Entry.c,v 1.2 Broadcom SDK $
...
sbZfCaPpCamConfigurationInstance0Entry_Unpack(sbZfCaPpCamConfigurationInstance0Entry_t *pToStruct,
  ...
  (pToStruct)->m_uMask5 =  (uint32)  ((pFromData)[43] >> 2) & 0x3f;
  (pToStruct)->m_uMask5 |=  (uint32)  (pFromData)[44] << 6;
  (pToStruct)->m_uMask5 |=  (uint32)  (pFromData)[45] << 14;
  (pToStruct)->m_uMask5 |=  (uint32)  ((pFromData)[46] & 0x03) << 22;

  /* Unpack Member: m_uMask4 */
  (pToStruct)->m_uMask4 =  (uint32)  ((pFromData)[39] >> 2) & 0x3f;
  (pToStruct)->m_uMask4 |=  (uint32)  (pFromData)[40] << 6;
  (pToStruct)->m_uMask4 |=  (uint32)  (pFromData)[41] << 14;
  (pToStruct)->m_uMask4 |=  (uint32)  (pFromData)[42] << 22;
  (pToStruct)->m_uMask4 |=  (uint32)  ((pFromData)[43] & 0x03) << 30;

  /* Unpack Member: m_uMask3 */
  (pToStruct)->m_uMask3 =  (uint32)  ((pFromData)[35] >> 2) & 0x3f;
  (pToStruct)->m_uMask3 |=  (uint32)  (pFromData)[36] << 6;
  (pToStruct)->m_uMask3 |=  (uint32)  (pFromData)[37] << 14;
  (pToStruct)->m_uMask3 |=  (uint32)  (pFromData)[38] << 22;
  (pToStruct)->m_uMask3 |=  (uint32)  ((pFromData)[39] & 0x03) << 30;

  /* Unpack Member: m_uMask2 */
  (pToStruct)->m_uMask2 =  (uint32)  ((pFromData)[31] >> 2) & 0x3f;
  (pToStruct)->m_uMask2 |=  (uint32)  (pFromData)[32] << 6;
  (pToStruct)->m_uMask2 |=  (uint32)  (pFromData)[33] << 14;
  (pToStruct)->m_uMask2 |=  (uint32)  (pFromData)[34] << 22;
  (pToStruct)->m_uMask2 |=  (uint32)  ((pFromData)[35] & 0x03) << 30;

  /* Unpack Member: m_uMask1 */
  (pToStruct)->m_uMask1 =  (uint32)  ((pFromData)[27] >> 2) & 0x3f;
  (pToStruct)->m_uMask1 |=  (uint32)  (pFromData)[28] << 6;
  (pToStruct)->m_uMask1 |=  (uint32)  (pFromData)[29] << 14;
  (pToStruct)->m_uMask1 |=  (uint32)  (pFromData)[30] << 22;
  (pToStruct)->m_uMask1 |=  (uint32)  ((pFromData)[31] & 0x03) << 30;

  /* Unpack Member: m_uMask0 */
  (pToStruct)->m_uMask0 =  (uint32)  ((pFromData)[23] >> 2) & 0x3f;
  (pToStruct)->m_uMask0 |=  (uint32)  (pFromData)[24] << 6;
  (pToStruct)->m_uMask0 |=  (uint32)  (pFromData)[25] << 14;
  (pToStruct)->m_uMask0 |=  (uint32)  (pFromData)[26] << 22;
  (pToStruct)->m_uMask0 |=  (uint32)  ((pFromData)[27] & 0x03) << 30;

  /* Unpack Member: m_uData5 */
  (pToStruct)->m_uData5 =  (uint32)  ((pFromData)[20] >> 2) & 0x3f;
  (pToStruct)->m_uData5 |=  (uint32)  (pFromData)[21] << 6;
  (pToStruct)->m_uData5 |=  (uint32)  (pFromData)[22] << 14;
  (pToStruct)->m_uData5 |=  (uint32)  ((pFromData)[23] & 0x03) << 22;

  /* Unpack Member: m_uData4 */
  (pToStruct)->m_uData4 =  (uint32)  ((pFromData)[16] >> 2) & 0x3f;
  (pToStruct)->m_uData4 |=  (uint32)  (pFromData)[17] << 6;
  (pToStruct)->m_uData4 |=  (uint32)  (pFromData)[18] << 14;
  (pToStruct)->m_uData4 |=  (uint32)  (pFromData)[19] << 22;
  (pToStruct)->m_uData4 |=  (uint32)  ((pFromData)[20] & 0x03) << 30;

  /* Unpack Member: m_uData3 */
  (pToStruct)->m_uData3 =  (uint32)  ((pFromData)[12] >> 2) & 0x3f;
  (pToStruct)->m_uData3 |=  (uint32)  (pFromData)[13] << 6;
  (pToStruct)->m_uData3 |=  (uint32)  (pFromData)[14] << 14;
  (pToStruct)->m_uData3 |=  (uint32)  (pFromData)[15] << 22;
  (pToStruct)->m_uData3 |=  (uint32)  ((pFromData)[16] & 0x03) << 30;

  /* Unpack Member: m_uData2 */
  (pToStruct)->m_uData2 =  (uint32)  ((pFromData)[8] >> 2) & 0x3f;
  (pToStruct)->m_uData2 |=  (uint32)  (pFromData)[9] << 6;
  (pToStruct)->m_uData2 |=  (uint32)  (pFromData)[10] << 14;
  (pToStruct)->m_uData2 |=  (uint32)  (pFromData)[11] << 22;
  (pToStruct)->m_uData2 |=  (uint32)  ((pFromData)[12] & 0x03) << 30;

  /* Unpack Member: m_uData1 */
  (pToStruct)->m_uData1 =  (uint32)  ((pFromData)[4] >> 2) & 0x3f;
  (pToStruct)->m_uData1 |=  (uint32)  (pFromData)[5] << 6;
  (pToStruct)->m_uData1 |=  (uint32)  (pFromData)[6] << 14;
  (pToStruct)->m_uData1 |=  (uint32)  (pFromData)[7] << 22;
  (pToStruct)->m_uData1 |=  (uint32)  ((pFromData)[8] & 0x03) << 30;
  ...
  (pToStruct)->m_uData0 |=  (uint32)  ((pFromData)[4] & 0x03) << 30;
