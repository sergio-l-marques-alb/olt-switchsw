/*
 * $Id: sbZfCaPpRxPortDataEntry.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaPpRxPortDataEntry.hx"
...
sbZfCaPpRxPortDataEntry_Pack(sbZfCaPpRxPortDataEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPRXPORTDATAENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPRXPORTDATAENTRY_SIZE_IN_BYTES;
}
...
sbZfCaPpRxPortDataEntry_Unpack(sbZfCaPpRxPortDataEntry_t *pToStruct,
  ...
  (pToStruct)->m_uMask1 =  (uint32)  ((pFromData)[11] >> 2) & 0x3f;
  (pToStruct)->m_uMask1 |=  (uint32)  (pFromData)[12] << 6;
  (pToStruct)->m_uMask1 |=  (uint32)  (pFromData)[13] << 14;
  (pToStruct)->m_uMask1 |=  (uint32)  ((pFromData)[14] & 0x0f) << 22;

  /* Unpack Member: m_uMask0 */
  (pToStruct)->m_uMask0 =  (uint32)  ((pFromData)[7] >> 2) & 0x3f;
  (pToStruct)->m_uMask0 |=  (uint32)  (pFromData)[8] << 6;
  (pToStruct)->m_uMask0 |=  (uint32)  (pFromData)[9] << 14;
  (pToStruct)->m_uMask0 |=  (uint32)  (pFromData)[10] << 22;
  (pToStruct)->m_uMask0 |=  (uint32)  ((pFromData)[11] & 0x03) << 30;
  ...
  (pToStruct)->m_uData1 |=  (uint32)  ((pFromData)[7] & 0x03) << 24;
