  ...
  )
{
  ...
  info->vrf_id = 0;
  info->cos_profile = 0;
  info->ttl_scope_index = 0;
  info->routing_enablers_bm = 0;
  info->enable_default_routing = 0;
  info->uc_rpf_enable = SOC_PPC_FRWRD_FEC_RPF_MODE_NONE;
  SOC_SAND_MAGIC_NUM_SET;
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
