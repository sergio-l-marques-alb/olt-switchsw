  ...
  )
{
  ...
  SOC_SAND_CHECK_NULL_INPUT(hash_table);
  SOC_SAND_CHECK_NULL_INPUT(hash_table->init_info.get_entry_fun);
  SOC_SAND_CHECK_NULL_INPUT(hash_table->init_info.set_entry_fun);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_HASH_TABLE_DESTROY);
  SOC_SAND_CHECK_NULL_INPUT(hash_table);
  ...
  )
{
  ...
  {
      unit = (init_info_ptr->prime_handle);

      res = SOC_DPP_WB_ENGINE_SET_ARR(unit, init_info_ptr->wb_var_index + WB_ENGINE_HASH_TABLE_KEYS, 
                                      key, 
                                      entry_offset);
  ...
  */
  if (first)
  {
      ...
      else
      {
          ...
          res = SOC_DPP_WB_ENGINE_SET_ARR(unit, init_info_ptr->wb_var_index + WB_ENGINE_HASH_TABLE_LISTS_HEAD, 
                                          next_entry, 
                                          prev_entry);
  ...
  else
  {
      ...
      else
      {
          ...
          res = SOC_DPP_WB_ENGINE_SET_ARR(unit, init_info_ptr->wb_var_index + WB_ENGINE_HASH_TABLE_NEXT, 
                                          next_entry, 
                                          prev_entry);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_HASH_TABLE_ENTRY_REMOVE_BY_INDEX);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_HASH_TABLE_ENTRY_LOOKUP);
  ...
  )
{
  ...
  else
  {
      ...
      res = SOC_DPP_WB_ENGINE_MEMSET_ARR(unit, init_info_ptr->wb_var_index + WB_ENGINE_HASH_TABLE_KEYS, 0);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);                

      res = SOC_DPP_WB_ENGINE_MEMSET_ARR(unit, init_info_ptr->wb_var_index + WB_ENGINE_HASH_TABLE_NEXT, 0xFF);
      SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);                

      res = SOC_DPP_WB_ENGINE_MEMSET_ARR(unit, init_info_ptr->wb_var_index + WB_ENGINE_HASH_TABLE_LISTS_HEAD, 0xFF);
      SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);                
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_HASH_TABLE_GET_NEXT);
  ...
  )
{
  ...
  /* create DS*/
  res = soc_sand_hash_table_create(hash_table);
  SOC_SAND_CHECK_FUNC_RESULT(res,20, exit);
