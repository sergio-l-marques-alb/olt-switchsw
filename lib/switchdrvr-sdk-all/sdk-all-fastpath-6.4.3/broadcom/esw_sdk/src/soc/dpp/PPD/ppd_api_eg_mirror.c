  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_vlan_add,(unit, core_id, out_port_ndx, vid_ndx, success, config));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_mirror_port_vlan_get,(unit, out_port_ndx, vid_ndx, config));
