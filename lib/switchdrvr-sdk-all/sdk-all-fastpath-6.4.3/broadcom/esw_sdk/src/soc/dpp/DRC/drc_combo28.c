...
int _soc_dpp_drc_combo28_str_prop_ext_ram_dq_swap(int unit, int drc_ndx, uint32 dq_swap[8][4][8])
{
    ...
    for (byte = 0; byte < SOC_DPP_DRC_COMBO28_NOF_PER_INTERFACE_BYTES; byte++) {
        for (bit = 0; bit < SOC_DPP_DRC_COMBO28_NOF_BITS_IN_BYTE; bit++) {
            sal_sprintf(suffix, "dram%d_byte%d_bit%d", drc_ndx, byte, bit);
...
int soc_dpp_drc_combo28_info_config(int unit, soc_dpp_drc_combo28_info_t *drc_info) 
{
    ...
    drc_info->ref_clk_mhz = soc_property_get(unit, spn_SYNTH_DRAM_FREQ, 25);
    ...
    SOC_PBMP_ITER(drc_info->dram_bitmap, i) {
        soc_dpp_drc_combo28_shmoo_cfg_get(unit, i, &(drc_info->shmoo_config_param[i]));
    }
...
int soc_dpp_drc_combo28_shmoo_cfg_get(int unit, int drc_ndx, combo28_shmoo_config_param_t* shmoo_config_param)
{
    ...
    for (byte = 0; byte < SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte) {
        ...
        sal_sprintf(name_str, "%s_byte%d", spn_COMBO28_TUNE_DQ_WR_MIN_VDL, byte);
        soc_property_ci_get_csv(unit, drc_ndx, name_str, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_WR_MIN_VDL_DBI, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);   
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_WR_MIN_VDL_EDC, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array); 
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));    
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_WR_MAX_VDL_DATA, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_WR_MAX_VDL_DQS, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    for (byte = 0; byte < SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte) {
        ...
        sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));     
        sal_sprintf(name_str, "%s_byte%d", spn_COMBO28_TUNE_DQ_RD_MIN_VDL, byte);
        soc_property_ci_get_csv(unit, drc_ndx, name_str, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_RD_MIN_VDL_DBI, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);   
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_RD_MIN_VDL_EDC, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);  
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_RD_MAX_VDL_DQSP, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);   
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_RD_MAX_VDL_DQSN, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);   
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_REN_FIFO_CONFIG, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array); 
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));    
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_EDCEN_FIFO_CONFIG, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);  
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_READ_MAX_VDL_FSM, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array); 
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_VREF_DAC_CONFIG, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
    ...
    sal_memset(var_array, 0, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY*sizeof(int));
    soc_property_ci_get_csv(unit, drc_ndx, spn_COMBO28_TUNE_DQ_MACRO_RESERVED_REG, SOC_DPP_COMBO28_SHMOO_SIZE_OF_GET_VERAIBLE_ARRAY, var_array);
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
...
int soc_dpp_drc_combo28_shmoo_cfg_set(int unit, int drc_ndx, combo28_shmoo_config_param_t* shmoo_config_param)
{
    ...
    for (byte=0; byte < SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte) {
        ...
        sal_sprintf(name_str, "%s_byte%d_ci%d.%d", spn_COMBO28_TUNE_DQ_WR_MIN_VDL, byte, drc_ndx, unit);
        
        val_str[0]=0;
        for(bit=0; bit<SHMOO_COMBO28_BYTE; ++bit){
            sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_wr_min_vdl_bit[byte][bit] );    
        }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_WR_MIN_VDL_DBI, drc_ndx, unit);     
    
    val_str[0]='\0';
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_wr_min_vdl_dbi[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_WR_MIN_VDL_EDC, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_wr_min_vdl_edc[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_WR_MAX_VDL_DATA, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_wr_max_vdl_data[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_WR_MAX_VDL_DQS, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_wr_max_vdl_dqs[byte]);    
    }
    ...
    for (byte = 0; byte < SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte) {
        ...
        sal_sprintf(name_str, "%s_byte%d_ci%d.%d", spn_COMBO28_TUNE_DQ_RD_MIN_VDL, byte, drc_ndx, unit);
        val_str[0]=0; 
        for(bit=0; bit<SHMOO_COMBO28_BYTE; ++bit){
            sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_rd_min_vdl_bit[byte][bit] );    
        }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_RD_MIN_VDL_DBI, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_rd_min_vdl_dbi[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_RD_MIN_VDL_EDC, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_rd_min_vdl_edc[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_RD_MAX_VDL_DQSP, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_rd_max_vdl_dqsp[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_RD_MAX_VDL_DQSN, drc_ndx, unit);     
    
    val_str[0]=0;    
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_rd_max_vdl_dqsn[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_REN_FIFO_CONFIG, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_ren_fifo_config[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_EDCEN_FIFO_CONFIG, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_edcen_fifo_config[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_READ_MAX_VDL_FSM, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_rd_max_vdl_fsm[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_VREF_DAC_CONFIG, drc_ndx, unit);     
    
    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_vref_dac_config[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_DQ_MACRO_RESERVED_REG, drc_ndx, unit);     

    val_str[0]=0;
    for(byte=0; byte<SHMOO_COMBO28_DQ_CONFIG_NOF_BYTE; ++byte){
        sal_sprintf(val_str + sal_strlen(val_str), "0x%08x,", shmoo_config_param->dq_byte_macro_reserved_reg[byte]);    
    }
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_AQ_L_MAX_VDL_ADDR, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->aq_l_max_vdl_addr);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_AQ_L_MAX_VDL_CTRL, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->aq_l_max_vdl_ctrl);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_AQ_L_MACRO_RESERVED_REG, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->aq_l_macro_reserved_reg);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_AQ_U_MAX_VDL_ADDR, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->aq_u_max_vdl_addr);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_AQ_U_MAX_VDL_CTRL, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->aq_u_max_vdl_ctrl);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_AQ_U_MACRO_RESERVED_REG, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->aq_u_macro_reserved_reg);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_COMMON_MACRO_RESERVED_REG, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->common_macro_reserved_reg);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_CONTROL_REGS_READ_CLOCK_CONFIG, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->control_regs_read_clock_config);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_CONTROL_REGS_INPUT_SHIFT_CTRL, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->control_regs_input_shift_ctrl);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_CONTROL_REGS_REN_FIFO_CENTRAL_INITIALIZER, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->control_regs_ren_fifo_central_init);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_CONTROL_REGS_EDCEN_FIFO_CENTRAL_INIT, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->control_regs_edcen_fifo_central_init);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_CONTROL_REGS_SHARED_VREF_DAC_CONFIG, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->control_regs_shared_vref_dac_config);
    ...
    sal_sprintf(name_str, "%s_ci%d.%d", spn_COMBO28_TUNE_CONTROL_REGS_RESERVED_REG, drc_ndx, unit);

    sal_sprintf(val_str, "0x%08x", shmoo_config_param->control_regs_reserved_reg);
...
{   
    ...
    static soc_reg_t 
        DRC_DRAM_SPECIAL_FEATURESl[] = {DRCA_DRAM_SPECIAL_FEATURESr, DRCB_DRAM_SPECIAL_FEATURESr, DRCC_DRAM_SPECIAL_FEATURESr, 
                                        DRCD_DRAM_SPECIAL_FEATURESr, DRCE_DRAM_SPECIAL_FEATURESr},     
        DRC_DRAM_COMPLIANCE_CONFIGURATION_REGISTERl[] = {DRCA_DRAM_COMPLIANCE_CONFIGURATION_REGISTERr, DRCB_DRAM_COMPLIANCE_CONFIGURATION_REGISTERr, DRCC_DRAM_COMPLIANCE_CONFIGURATION_REGISTERr, 
    ...
    /* Configure Dram side */
    SOCDNX_IF_ERR_EXIT(soc_reg32_get(unit, DRC_DRAM_COMPLIANCE_CONFIGURATION_REGISTERl[drc_ndx], REG_PORT_ANY, 0, &reg_val));
