...
void	bcm_field_qualify_EthernetOamClassSourceVP_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassSourceVP_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassVFI_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassVFI_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassVxlt1_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassVxlt1_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassVxlt2_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamClassVxlt2_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_EthernetOamSourceVPLmStatPoolId_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamSourceVPLmStatPoolId_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamSrcPortLmStatPoolId_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamSrcPortLmStatPoolId_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_EthernetOamVxlt1LmStatPoolId_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamVxlt1LmStatPoolId_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamVxlt2LmStatPoolId_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_EthernetOamVxlt2LmStatPoolId_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_MplsOamClassMpls_async(int unit, bcm_field_entry_t entry, uint16 data, uint16 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_MplsOamClassMpls_get_async(int unit, bcm_field_entry_t entry, uint16 * data, uint16 * mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_MplsOamControlPktType_async(int unit, bcm_field_entry_t entry, bcm_field_MplsOam_Control_pktType_t data, bcm_field_MplsOam_Control_pktType_t mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_MplsOamControlPktType_get_async(int unit, bcm_field_entry_t entry, bcm_field_MplsOam_Control_pktType_t * data, bcm_field_MplsOam_Control_pktType_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_MplsOamMplsLmStatPoolId_async(int unit, bcm_field_entry_t entry, uint8 data, uint8 mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_MplsOamMplsLmStatPoolId_get_async(int unit, bcm_field_entry_t entry, uint8 * data, uint8 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_oam_performance_event_register_async(int unit, bcm_oam_event_types_t event_types, bcm_oam_performance_event_cb cb, bcm_oam_performance_event_data_t * event_data, void * user_data, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_sat_ctf_bin_limit_get_async(int unit, int max_bins_count, int * bins_count, bcm_sat_ctf_bin_limit_t * bins, bcm_async_cb_t async_callback, void *async_cookie);
