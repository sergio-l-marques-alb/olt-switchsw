...
extern int _bcm_field_th_stat_action_set(int unit, _field_entry_t *f_ent,
                                         ...
                                         uint32 *buf);
extern int
_bcm_field_th_forwardingType_set(int unit, bcm_field_entry_t entry,
                                 bcm_field_ForwardingType_t type,
                                 uint32 *data, uint32 *mask);
extern int 
_bcm_field_th_forwardingType_get(int unit, bcm_field_entry_t entry,
                                 uint32 data,  uint32 mask,
                                 bcm_field_ForwardingType_t *type);
extern int
...
extern bcm_error_t _bcm_niv_gport_get(int unit, bcm_gport_t glp,
                              int dst_vif, bcm_gport_t *niv_gport);
extern bcm_error_t _bcm_extender_gport_get(int unit, bcm_gport_t glp,
...
extern int bcm_th_mpls_tunnel_switch_delete_all(int unit);
extern int
...
extern bcm_error_t _bcm_th_l3_vp_entry_del(int unit, int ipv6, 
                                           _bcm_l3_cfg_t *l3cfg, uint32 *bufentry);
#ifdef BCM_WARM_BOOT_SUPPORT
