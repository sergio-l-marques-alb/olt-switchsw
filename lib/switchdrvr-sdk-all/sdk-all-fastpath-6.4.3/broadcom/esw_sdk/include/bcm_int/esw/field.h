...
#define _FP_QUAL_MULTI_INFO_ADD(_unit_, _stage_fc_, _qual_id_,                 \
         ...
         do {                                                                  \
            ...
            (_fp_qual_conf_).offset.offset[0]       = (_offset_0_);            \
            (_fp_qual_conf_).offset.width[0]        = (_width_0_);             \
            (_fp_qual_conf_).offset.qual_width      = (_width_0_);             \
...
#ifdef BCM_TOMAHAWK_SUPPORT /* BCM_TOMAHAWK_SUPPORT */
...
typedef struct _field_lt_entry_s {
    ...
    struct _field_group_s *group;    /* Group with which this entry is
                                        associated.                            */
...
typedef struct _field_ext_sel_s {
    ...
    int8 l3_e1_sel[2];          /* Level 3 1b extractors.               */
...
typedef struct _field_stage_s {
    ...
    int num_logical_tables;                  /* Number of logical tables.    */
    _field_lt_slice_t *lt_slices[_FP_MAX_NUM_PIPES]; /* Array of LT slices.  */
    _field_keygen_profiles_t keygen_profile[_FP_MAX_NUM_PIPES]; /* Keygen
                                                                   Profiles.  */
    _field_lt_config_t *lt_info[_FP_MAX_NUM_PIPES][_FP_MAX_NUM_LT]; /* Logical
                                                                       table
                                                                       info.  */
...
#define _BCM_FIELD_SLICE_HW_ENABLE                (1 << 7)  /* Indicates whether the 
                                                               slice is operationally Enabled */
...
#endif
#ifdef BCM_TOMAHAWK_SUPPORT
    uint32 last_allocated_lt_eid;         /* Last allocated LT entry ID.    */
#endif /* !BCM_TOMAHAWK_SUPPORT */
