...
#define _BCM_DPP_MPLS_EEDB_TYPES(entry_type) \
  (entry_type == SOC_PPD_EG_ENCAP_ENTRY_TYPE_MPLS_ENCAP ||  \
   entry_type == SOC_PPD_EG_ENCAP_ENTRY_TYPE_POP_CMND || \
   entry_type == SOC_PPD_EG_ENCAP_ENTRY_TYPE_SWAP_CMND)
...
extern SOC_PPD_FRWRD_ILM_KEY *_bcm_mpls_traverse_ilm_keys[BCM_MAX_NUM_UNITS];
extern SOC_PPD_FRWRD_DECISION_INFO *_bcm_mpls_traverse_ilm_vals[BCM_MAX_NUM_UNITS];
