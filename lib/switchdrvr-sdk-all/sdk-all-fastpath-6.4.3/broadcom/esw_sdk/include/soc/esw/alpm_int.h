...
extern int soc_th_alpm_bucket_assign(int u, int *bucket_pointer, int v6);
extern int soc_th_alpm_bucket_release(int u, int bucket_pointer, int v6);
extern int soc_th_alpm_bucket_is_assigned(int u, int bucket_ptr, int ipv6, int *used);
...
extern int _soc_th_alpm_mem_index(int u, soc_mem_t mem, int bucket_index, 
                                  int offset, uint32 bank_disable, int *key_index);
extern int _soc_th_alpm_raw_bucket_read(int u, soc_mem_t mem, int bucket_index, 
                                        void *raw_entry, void *raw_sip_entry);
extern int _soc_th_alpm_raw_bucket_write(int u, soc_mem_t mem, int bucket_index, 
                                         uint32 bank_disable,
                                         void *raw_entry, void *raw_sip_entry,
                                         int entry_cnt);
extern void _soc_th_alpm_raw_mem_read(int unit, soc_mem_t mem, void *raw, 
                                      int index, void *entry);
extern void _soc_th_alpm_raw_mem_write(int unit, soc_mem_t mem, void *raw, 
                                       int index, void *entry);
extern void _soc_th_alpm_raw_parity_set(int u, soc_mem_t mem, void *alpm_data);
