...
/*
 * $Id: g2p3_lpm_dma_internal.h,v 1.4 Broadcom SDK $
 *
...
typedef struct writeRequest_s {
    ...
    uint32 nWords;                /* number of words to transfer */
    uint32 datum;                 /* datum to write */
    uint8  level;                 /* sync level */
...
typedef struct g2p3_lpmDma_s {
    ...
    uint8 lastLevel;              /* sync level of last slab */
    ...
    uint32 slabWords;             /* uint32 words */
    uint32 nReqs;                 /* # of unflushed requests */
    uint32 maxReqs;               /* maximum # of unflushed requests */
    ...
    uint32 hostAllocBytes;        /* total from host memory manager */
} g2p3_lpmDma_t;
