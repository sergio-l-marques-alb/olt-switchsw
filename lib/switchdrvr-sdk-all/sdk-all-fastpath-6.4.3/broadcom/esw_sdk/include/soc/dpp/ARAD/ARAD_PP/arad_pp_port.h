...
soc_error_t arad_pp_port_property_set(int unit, int port, SOC_PPC_PORT_PROPERTY port_property, uint32 value);
soc_error_t arad_pp_port_property_get(int unit, int port, SOC_PPC_PORT_PROPERTY port_property, uint32 *value);
...
*  uint32             additional_tpids - Array of additional TPIDs.
*     For ARAD/ARAD+, only additional_tpids[0] is used.
*     For Jericho, 
*     additional_tpids[0] is used as AdditionalOuterTpid0. 
*     additional_tpids[1] is used as AdditionalOuterTpid1.
*     additional_tpids[2] is used as AdditionalInnerTpid0.
*     additional_tpids[3] is used as AdditionalInnerTpid1.
* RETURNS:
*     SOC_E_XXX.
*********************************************************************/
soc_error_t arad_pp_port_additional_tpids_set(int unit, uint32 *additional_tpids);
...
*     SOC_E_XXX.
*********************************************************************/
soc_error_t arad_pp_port_additional_tpids_get(int unit, uint32 *additional_tpids);
