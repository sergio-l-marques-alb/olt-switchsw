...
typedef enum
{
    ...
    SOC_DPP_WB_ENGINE_BUFFER_JER_FAILOVER_SW_DB                      = 67,
    SOC_DPP_WB_ENGINE_BUFFER_ARAD_SW_DB_SRC_BIND_SPOOF_ID_REF_CNT    = 68,
    SOC_DPP_WB_ENGINE_BUFFER_CHIP_SIM                                = 69,
    SOC_DPP_WB_ENGINE_BUFFER_DPP_INTERRUPTS                          = 70,
    SOC_DPP_WB_ENGINE_BUFFER_BFD_S_HOP                               = 71,
...
typedef enum
{
    ...
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_BFD_S_HOP_REF_COUNTER,
    ...
    SOC_DPP_WB_ENGINE_VAR_JER_FAILOVER_ID_SEQ_SIZE,
    ...
    SOC_DPP_WB_ENGINE_VAR_DPP_INTERRUPTS_BCM_SWITCH_EVENT_STORM_NOMINAL,

    
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_BFD_YDISCR_RANGE_REF_COUNTER,
    SOC_DPP_WB_ENGINE_VAR_ARAD_PP_BFD_S_HOP_TOS_VALUE,
