/* $Id: pb_pp_api_frwrd_extend_p2p.h,v 1.6 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_frwrd_extend_p2p.h
*
...
#ifndef __SOC_PB_PP_API_FRWRD_EXTEND_P2P_INCLUDED__
/* { */
#define __SOC_PB_PP_API_FRWRD_EXTEND_P2P_INCLUDED__
...
typedef SOC_PPC_FRWRD_EXTEND_P2P_GLBL_LIF_INFO                 SOC_PB_PP_FRWRD_EXTEND_P2P_GLBL_LIF_INFO;
typedef SOC_PPC_FRWRD_EXTEND_P2P_GLBL_INFO                     SOC_PB_PP_FRWRD_EXTEND_P2P_GLBL_INFO;
typedef SOC_PPC_FRWRD_EXTEND_P2P_FRWRD_INFO                    SOC_PB_PP_FRWRD_EXTEND_P2P_FRWRD_INFO;
typedef SOC_PPC_FRWRD_EXTEND_PWE_KEY                           SOC_PB_PP_FRWRD_EXTEND_PWE_KEY;
 ...
 *     "soc_pb_pp_frwrd_extend_p2p_glbl_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_extend_p2p_glbl_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_FRWRD_EXTEND_P2P_INCLUDED__*/
#endif
