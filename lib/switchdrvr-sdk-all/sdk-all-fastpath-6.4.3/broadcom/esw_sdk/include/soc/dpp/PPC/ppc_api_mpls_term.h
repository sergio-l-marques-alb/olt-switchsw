...
typedef struct
{
   ...
   *  case When RIF == SOC_PPD_RIF_NULL, the default RIF ID is not
   *  updated.
   */
...
typedef struct
{
   ...
   *  SOC_PPD_TRAP_CODE_MPLS_LABEL_VALUE_0 -
   *  SOC_PPD_TRAP_CODE_MPLS_LABEL_VALUE_3. Only trap_code from
...
typedef struct
{
   ...
   *  RIF == SOC_PPD_RIF_NULL, the default RIF ID and RPF enable
