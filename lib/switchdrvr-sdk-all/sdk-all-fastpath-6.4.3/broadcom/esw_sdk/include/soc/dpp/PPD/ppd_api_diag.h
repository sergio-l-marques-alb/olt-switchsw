...
typedef SOC_PPC_DIAG_FWD_LKUP_TYPE                             SOC_PPD_DIAG_FWD_LKUP_TYPE;

#define SOC_PPD_DIAG_TCAM_USAGE_FRWRDING                       SOC_PPC_DIAG_TCAM_USAGE_FRWRDING
#define SOC_PPD_DIAG_TCAM_USAGE_PMF                            SOC_PPC_DIAG_TCAM_USAGE_PMF
#define SOC_PPD_DIAG_TCAM_USAGE_EGR_ACL                        SOC_PPC_DIAG_TCAM_USAGE_EGR_ACL
typedef SOC_PPC_DIAG_TCAM_USAGE                                SOC_PPD_DIAG_TCAM_USAGE;
#define SOC_PPD_DIAG_FLAVOR_NONE                               SOC_PPC_DIAG_FLAVOR_NONE
#define SOC_PPD_DIAG_FLAVOR_RAW                                SOC_PPC_DIAG_FLAVOR_RAW
#define SOC_PPD_DIAG_FLAVOR_CLEAR_ON_GET                       SOC_PPC_DIAG_FLAVOR_CLEAR_ON_GET
typedef SOC_PPC_DIAG_FLAVOR                                    SOC_PPD_DIAG_FLAVOR;

typedef SOC_PPC_DIAG_LEM_LKUP_TYPE                             SOC_PPD_DIAG_LEM_LKUP_TYPE;

typedef SOC_PPC_DIAG_LIF_LKUP_TYPE                             SOC_PPD_DIAG_LIF_LKUP_TYPE;

typedef SOC_PPC_DIAG_DB_TYPE                                   SOC_PPD_DIAG_DB_TYPE;

typedef SOC_PPC_DIAG_FRWRD_DECISION_PHASE                      SOC_PPD_DIAG_FRWRD_DECISION_PHASE;

typedef SOC_PPC_DIAG_MPLS_TERM_TYPE                            SOC_PPD_DIAG_MPLS_TERM_TYPE;

#define SOC_PPD_DIAG_PKT_TRACE_LIF                             SOC_PPC_DIAG_PKT_TRACE_LIF
#define SOC_PPD_DIAG_PKT_TRACE_TUNNEL_RNG                      SOC_PPC_DIAG_PKT_TRACE_TUNNEL_RNG
#define SOC_PPD_DIAG_PKT_TRACE_TRAP                            SOC_PPC_DIAG_PKT_TRACE_TRAP
#define SOC_PPD_DIAG_PKT_TRACE_FEC                             SOC_PPC_DIAG_PKT_TRACE_FEC
#define SOC_PPD_DIAG_PKT_TRACE_EG_DROP_LOG                     SOC_PPC_DIAG_PKT_TRACE_EG_DROP_LOG
#define SOC_PPD_DIAG_PKT_TRACE_ALL                             SOC_PPC_DIAG_PKT_TRACE_ALL
typedef SOC_PPC_DIAG_PKT_TRACE                                 SOC_PPD_DIAG_PKT_TRACE;

#define SOC_PPD_DIAG_EG_DROP_REASON_MODIFY_SNOOPED_PACKET      SOC_PPC_DIAG_EG_DROP_REASON_MODIFY_SNOOPED_PACKET
#define SOC_PPD_DIAG_EG_DROP_REASON_MODIFY_SNOOPED_PACKET      SOC_PPC_DIAG_EG_DROP_REASON_MODIFY_SNOOPED_PACKET
#define SOC_PPD_DIAG_EG_DROP_REASON_MODIFY_SNOOPED_PACKET      SOC_PPC_DIAG_EG_DROP_REASON_MODIFY_SNOOPED_PACKET
typedef SOC_PPC_DIAG_EG_DROP_REASON                            SOC_PPD_DIAG_EG_DROP_REASON;

typedef SOC_PPC_DIAG_PKT_TM_FIELD                              SOC_PPD_DIAG_PKT_TM_FIELD;

typedef SOC_PPC_DIAG_BUFFER                                    SOC_PPD_DIAG_BUFFER;
typedef SOC_PPC_DIAG_MODE_INFO                                 SOC_PPD_DIAG_MODE_INFO;
typedef SOC_PPC_DIAG_VSI_INFO                                  SOC_PPD_DIAG_VSI_INFO;
typedef SOC_PPC_DIAG_DB_USE_INFO                               SOC_PPD_DIAG_DB_USE_INFO;
typedef SOC_PPC_DIAG_TCAM_USE_INFO                             SOC_PPD_DIAG_TCAM_USE_INFO;
typedef SOC_PPC_DIAG_RECEIVED_PACKET_INFO                      SOC_PPD_DIAG_RECEIVED_PACKET_INFO;
typedef SOC_PPC_DIAG_TRAP_PACKET_INFO                          SOC_PPD_DIAG_TRAP_PACKET_INFO;
typedef SOC_PPC_DIAG_TRAP_INFO                                 SOC_PPD_DIAG_TRAP_INFO;
typedef SOC_PPC_DIAG_SNOOP_INFO                                SOC_PPD_DIAG_SNOOP_INFO;
typedef SOC_PPC_DIAG_TRAPS_INFO                                SOC_PPD_DIAG_TRAPS_INFO;
typedef SOC_PPC_DIAG_TRAP_TO_CPU_INFO                          SOC_PPD_DIAG_TRAP_TO_CPU_INFO;
typedef SOC_PPC_DIAG_LEM_KEY                                   SOC_PPD_DIAG_LEM_KEY;
typedef SOC_PPC_DIAG_LIF_KEY                                   SOC_PPD_DIAG_LIF_KEY;
typedef SOC_PPC_DIAG_LIF_VALUE                                 SOC_PPD_DIAG_LIF_VALUE;
typedef SOC_PPC_DIAG_LIF_LKUP_INFO                             SOC_PPD_DIAG_LIF_LKUP_INFO;
typedef SOC_PPC_DIAG_TCAM_KEY                                  SOC_PPD_DIAG_TCAM_KEY;
typedef SOC_PPC_DIAG_TCAM_VALUE                                SOC_PPD_DIAG_TCAM_VALUE;
typedef SOC_PPC_DIAG_LEM_VALUE                                 SOC_PPD_DIAG_LEM_VALUE;
typedef SOC_PPC_DIAG_PARSING_L2_INFO                           SOC_PPD_DIAG_PARSING_L2_INFO;
typedef SOC_PPC_DIAG_PARSING_MPLS_INFO                         SOC_PPD_DIAG_PARSING_MPLS_INFO;
typedef SOC_PPC_DIAG_PARSING_IP_INFO                           SOC_PPD_DIAG_PARSING_IP_INFO;
typedef SOC_PPC_DIAG_PARSING_HEADER_INFO                       SOC_PPD_DIAG_PARSING_HEADER_INFO;
typedef SOC_PPC_DIAG_PARSING_INFO                              SOC_PPD_DIAG_PARSING_INFO;
typedef SOC_PPC_DIAG_TERM_MPLS_LABEL_INFO                      SOC_PPD_DIAG_TERM_MPLS_LABEL_INFO;
typedef SOC_PPC_DIAG_TERMINATED_MPLS_LABEL_INFO                SOC_PPD_DIAG_TERMINATED_MPLS_LABEL_INFO;
typedef SOC_PPC_DIAG_TERM_MPLS_INFO                            SOC_PPD_DIAG_TERM_MPLS_INFO;
typedef SOC_PPC_DIAG_TERM_INFO                                 SOC_PPD_DIAG_TERM_INFO;
typedef SOC_PPC_DIAG_IPV4_VPN_KEY                              SOC_PPD_DIAG_IPV4_VPN_KEY;
typedef SOC_PPC_DIAG_IPV6_VPN_KEY                              SOC_PPD_DIAG_IPV6_VPN_KEY;
typedef SOC_PPC_DIAG_FRWRD_LKUP_KEY                            SOC_PPD_DIAG_FRWRD_LKUP_KEY;
typedef SOC_PPC_DIAG_FRWRD_LKUP_VALUE                          SOC_PPD_DIAG_FRWRD_LKUP_VALUE;
typedef SOC_PPC_DIAG_FRWRD_LKUP_INFO                           SOC_PPD_DIAG_FRWRD_LKUP_INFO;
typedef SOC_PPC_DIAG_LEARN_INFO                                SOC_PPD_DIAG_LEARN_INFO;
typedef SOC_PPC_DIAG_VLAN_EDIT_RES                             SOC_PPD_DIAG_VLAN_EDIT_RES;
typedef SOC_PPC_DIAG_FRWRD_DECISION_INFO                       SOC_PPD_DIAG_FRWRD_DECISION_INFO;
typedef SOC_PPC_DIAG_FRWRD_DECISION_TRACE_INFO                 SOC_PPD_DIAG_FRWRD_DECISION_TRACE_INFO;
typedef SOC_PPC_DIAG_PKT_TM_INFO                               SOC_PPD_DIAG_PKT_TM_INFO;
typedef SOC_PPC_DIAG_ENCAP_INFO                                SOC_PPD_DIAG_ENCAP_INFO;
typedef SOC_PPC_DIAG_EG_DROP_LOG_INFO                          SOC_PPD_DIAG_EG_DROP_LOG_INFO;
typedef SOC_PPC_DIAG_ETH_PACKET_INFO                           SOC_PPD_DIAG_ETH_PACKET_INFO;
typedef SOC_PPC_DIAG_PACKET_INFO                               SOC_PPD_DIAG_PACKET_INFO;
typedef SOC_PPC_DIAG_EGRESS_VLAN_EDIT_RES                      SOC_PPD_DIAG_EGRESS_VLAN_EDIT_RES; 
typedef SOC_PPC_DIAG_LIF_PROFILE_INFO                          SOC_PPD_DIAG_LIF_PROFILE_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_diag_get_procs_ptr(void);
