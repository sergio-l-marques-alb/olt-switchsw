...
typedef enum soc_dfe_fabric_link_fifo_type_index_t
{
...
{
    soc_dfe_port_pcs_8_9_legacy_fec        = _SHR_PORT_PCS_8B9BLFEC,
    soc_dfe_port_pcs_8_10                  = _SHR_PORT_PCS_8B10B,
    soc_dfe_port_pcs_64_66_fec             = _SHR_PORT_PCS_64B66BFEC,
    soc_dfe_port_pcs_64_66_bec             = _SHR_PORT_PCS_64B66BBEC,
    soc_dfe_port_pcs_64_66                 = _SHR_PORT_PCS_64B66B,
    soc_dfe_port_pcs_64_66_rs_fec          = _SHR_PORT_PCS_64B66B_RS_FEC,
    soc_dfe_port_pcs_64_66_ll_rs_fec      = _SHR_PORT_PCS_64B66B_LOW_LATENCY_RS_FEC
} soc_dfe_port_pcs_t;

typedef enum soc_dfe_port_power_e
{
    soc_dfe_port_power_off       = 0,
    soc_dfe_port_power_on        = 1
} soc_dfe_port_power_t;
