...
int fe1600_interrupt_data_collection_for_handle_mac_oof_int( int unit,int block_instance,fe1600_interrupt_type en_fe1600_inter, soc_dfe_port_pcs_t* p_pcs,char* special_msg);
int fe1600_interrupt_data_collection_for_recurring_mac_oof_int( int unit, int block_instance, fe1600_interrupt_type en_fe1600_interrupt, soc_dfe_port_pcs_t* p_pcs, fe1600_int_corr_act_type* p_corrective_action,char* special_msg, uint8* array_links);
int fe1600_interrupt_data_collection_for_handle_mac_decerr_int( int unit,int block_instance, fe1600_interrupt_type en_fe1600_interrupt, soc_dfe_port_pcs_t* p_pcs, fe1600_int_corr_act_type* p_corrective_action, char* special_msg, uint8* array_links);
