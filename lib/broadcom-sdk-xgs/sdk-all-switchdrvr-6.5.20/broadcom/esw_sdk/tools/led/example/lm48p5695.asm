;
; $Id: lm48p5695.asm,v 1.9 Broadcom SDK $
;
; $Copyright: (c) 2020 Broadcom.
; Broadcom Proprietary and Confidential. All rights reserved.$
; 
;
; This is the default program for 5695s on the 48 port Line module.
; To start it, use the following commands from BCM:
;
;	led load lm48p5695.hex
;	led auto on
;	led start
;
; The 5695 on the 48 port Line module has 2 LEDs per Gig port.
;
...
;	L01, L02, A02, A01,..., L11, L12,A12, A11
;
