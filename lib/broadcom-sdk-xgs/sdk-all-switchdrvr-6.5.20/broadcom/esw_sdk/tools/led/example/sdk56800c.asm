;
; $Id: sdk56800c.asm,v 1.7 Broadcom SDK $
;
; $Copyright: (c) 2020 Broadcom.
; Broadcom Proprietary and Confidential. All rights reserved.$
; 
;
; This is the default program for the (20 GE port) BCM56800 SDKs.
; To start it, use the following commands from BCM:
;
;       led load sdk56800c.hex
;       led auto on
;       led start
;
...
up1:
        ...
        call    activity        ; Left LED for this port
        call    link_status     ; Right LED for this port
