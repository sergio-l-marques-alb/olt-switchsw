;
; $Id: poe48p56504.asm,v 1.6 Broadcom SDK $
;
; $Copyright: (c) 2020 Broadcom.
; Broadcom Proprietary and Confidential. All rights reserved.$
; 
;
; This is the default program for the (48+4 port) BCM956504P48POEREF.
; To start it, use the following commands from BCM:
;
;       *:led load poe48p56504.hex
;       *:led auto on
;       *:led start
;
...
;       L01, A01, L02, A02, ..., L24, A24, L25, A25, L26, A26
;
...
;
; L25-L26 reflects higig/10G link enable/status:
;       Black: no link
;       amber: Enable
;       Green: 10 Gb/s
; A25-A26 reflects port 25-28 activity
;       Black: idle
;       Green: RX (pulse extended to 1/3 sec)
;       Amber: TX (pulse extended to 1/3 sec, takes precedence over RX)
;       Green/Amber alternating at 6 Hz: both RX and TX
...
up1:
        ...
        ; Put out 4 bits for higig/10G port
up1_5:
        port    a
        ld      (PORT_NUM),a
...
no_link:
        ...
        pack
chk_act:
        call    activity        ; Down LED for this port
