...
__phymod__dispatch__t__ phymod_madura_driver = {
    ...
    madura_phy_firmware_lane_config_set,
    madura_phy_firmware_lane_config_get,
    ...
    madura_phy_rx_set,
    madura_phy_rx_get,
    madura_phy_rx_adaptation_resume,
    ...
    madura_phy_tx_lane_control_set,
    madura_phy_tx_lane_control_get,
    madura_phy_rx_lane_control_set,
    madura_phy_rx_lane_control_get,
    ...
    madura_phy_cl72_set,
    madura_phy_cl72_get,
    madura_phy_cl72_status_get,
    madura_phy_autoneg_ability_set,
    madura_phy_autoneg_ability_get,
    madura_phy_autoneg_remote_ability_get,
    madura_phy_autoneg_set,
    madura_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    madura_phy_autoneg_status_get,
    madura_core_init,
    ...
    madura_phy_intr_enable_set,
    madura_phy_intr_enable_get,
    madura_phy_intr_status_get,
    madura_phy_intr_status_clear,
    madura_phy_i2c_read,
    madura_phy_i2c_write,
    madura_phy_gpio_config_set,
    madura_phy_gpio_config_get,
    madura_phy_gpio_pin_value_set,
    madura_phy_gpio_pin_value_get,
