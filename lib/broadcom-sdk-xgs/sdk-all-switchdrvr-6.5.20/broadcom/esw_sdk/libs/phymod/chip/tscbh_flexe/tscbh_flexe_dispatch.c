...
__phymod__dispatch__t__ phymod_tscbh_flexe_driver = {

    tscbh_flexe_core_identify,
    tscbh_flexe_core_info_get,
    tscbh_flexe_core_lane_map_set,
    tscbh_flexe_core_lane_map_get,
    tscbh_flexe_core_reset_set,
    tscbh_flexe_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    tscbh_flexe_phy_firmware_lane_config_set,
    tscbh_flexe_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    tscbh_flexe_phy_rx_restart,
    tscbh_flexe_phy_polarity_set,
    tscbh_flexe_phy_polarity_get,
    tscbh_flexe_phy_tx_set,
    tscbh_flexe_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    tscbh_flexe_phy_media_type_tx_get,
    tscbh_flexe_phy_tx_override_set,
    tscbh_flexe_phy_tx_override_get,
    ...
    tscbh_flexe_phy_reset_set,
    tscbh_flexe_phy_reset_get,
    tscbh_flexe_phy_power_set,
    tscbh_flexe_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    tscbh_flexe_phy_tx_lane_control_set,
    tscbh_flexe_phy_tx_lane_control_get,
    tscbh_flexe_phy_rx_lane_control_set,
    tscbh_flexe_phy_rx_lane_control_get,
    NULL, /* phymod_phy_fec_enable_set */
    NULL, /* phymod_phy_fec_enable_get */
    tscbh_flexe_phy_fec_override_set,
    tscbh_flexe_phy_fec_override_get,
    ...
    tscbh_flexe_phy_cl72_set,
    tscbh_flexe_phy_cl72_get,
    tscbh_flexe_phy_cl72_status_get,
    NULL, /* phymod_phy_autoneg_ability_set */
    NULL, /* phymod_phy_autoneg_ability_get */
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    tscbh_flexe_phy_autoneg_set,
    tscbh_flexe_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    tscbh_flexe_phy_autoneg_status_get,
    tscbh_flexe_core_init,
    tscbh_flexe_phy_pll_multiplier_get,
    tscbh_flexe_phy_init,
    tscbh_flexe_phy_loopback_set,
    tscbh_flexe_phy_loopback_get,
    tscbh_flexe_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_local_fault_info_get */
    tscbh_flexe_phy_rx_signal_detect_get,
    ...
    tscbh_flexe_timesync_enable_set,
    tscbh_flexe_timesync_enable_get,
    ...
    tscbh_flexe_timesync_adjust_set,
    ...
    tscbh_flexe_phy_speed_config_set,
    tscbh_flexe_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    tscbh_gen2_phy_tx_taps_default_get,
    tscbh_gen2_phy_lane_config_default_get,
    tscbh_flexe_phy_firmware_load_info_get,
    tscbh_flexe_phy_autoneg_advert_ability_set,
    tscbh_flexe_phy_autoneg_advert_ability_get,
    tscbh_flexe_phy_autoneg_remote_advert_ability_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    tscbh_flexe_phy_tx_pam4_precoder_enable_set,
    tscbh_flexe_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_set */
    tscbh_flexe_phy_pll_reconfig,
    ...
    tscbh_flexe_phy_pcs_enable_set,
    tscbh_flexe_phy_rx_ppm_get,
    blackhawk_phy_channel_loss_hint_set,
    blackhawk_phy_channel_loss_hint_get,
    tscbh_intr_handler,
    tscbh_gen2_timesync_tx_info_get,
    NULL, /* phymod_phy_master_set */
    NULL, /* phymod_phy_master_get */
    tscbh_phy_pcs_lane_swap_adjust,
    tscbh_flexe_phy_load_speed_id_entry,
    tscbh_phy_pmd_override_enable_set,
    NULL, /* phymod_phy_duplex_set */
    NULL, /* phymod_phy_duplex_get */
    blackhawk_phy_pmd_info_init,
    tscbh_flexe_phy_pll_powerdown_get,
    NULL, /* phymod_phy_pmd_info_size_get */
    tscbh_flexe_phy_fec_bypass_indication_set,
    tscbh_flexe_phy_fec_bypass_indication_get,
    tscbh_flexe_phy_fec_corruption_period_set,
    tscbh_flexe_phy_fec_corruption_period_get,
    tscbh_phy_codec_mode_set,
    tscbh_phy_codec_mode_get,
    tscbh_flexe_phy_autoneg_speed_id_table_reload,
    ...
    tscbh_flexe_phy_pcs_lane_map_set,
    blackhawk_phy_pll_clock_buffer_pwrdn,
    tscbh_flexe_phy_50g_nofec_20k_am_spacing_enable_set,
    tscbh_flexe_phy_50g_nofec_20k_am_spacing_enable_get,
    tscbh_flexe_phy_rx_pmd_lock_counter_get,
    tscbh_phy_fec_three_cw_bad_state_get,
    tscbh_flexe_phy_tdm_mode_update,
