...
#include "osprey7_v2l8p1_cfg_seq.h"
...
err_code_t osprey7_v2l8p1_tx_rx_polarity_set(phymod_access_t *sa__, uint32_t tx_pol, uint32_t rx_pol)
{
...
err_code_t osprey7_v2l8p1_tx_rx_polarity_get(phymod_access_t *sa__, uint32_t *tx_pol, uint32_t *rx_pol)
{
...
err_code_t osprey7_v2l8p1_uc_active_set(phymod_access_t *sa__, uint32_t enable)
{
...
err_code_t osprey7_v2l8p1_uc_active_get(phymod_access_t *sa__, uint32_t *enable)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_pmd_force_signal_detect(phymod_access_t *sa__, uint8_t force_en, uint8_t force_val)
{
...
err_code_t osprey7_v2l8p1_pmd_force_signal_detect_get(phymod_access_t *sa__, uint8_t *force_en, uint8_t *force_val)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_osr_mode_set(phymod_access_t *sa__, int osr_mode)
{
...
err_code_t osprey7_v2l8p1_osr_mode_get(phymod_access_t *sa__, int *osr_mode)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
    int osr_forced;
...
err_code_t osprey7_v2l8p1_dig_lpbk_get(phymod_access_t *sa__, uint32_t *lpbk)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_rmt_lpbk_get(phymod_access_t *sa__, uint32_t *lpbk)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_pmd_cl72_receiver_status(phymod_access_t *sa__, uint32_t *status)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_pram_firmware_enable(phymod_access_t *sa__, int enable, int wait)   /* release the pmd core soft reset */
{
    ...
    if (enable == 1) {
        ...
        micro_orig = osprey7_v2l8p1_get_micro_idx(sa__);
        num_micros = rdc_micro_num_uc_cores();
        for (micro_idx = 0; micro_idx < num_micros; micro_idx++) {
            srds_err_code += osprey7_v2l8p1_set_micro_idx(sa__, micro_idx);
            PHYMOD_EFUN_WR(wrc_micro_core_clk_en(1));
        }
        srds_err_code += osprey7_v2l8p1_set_micro_idx(sa__, micro_orig);
    }

    return srds_err_code;
}

err_code_t osprey7_v2l8p1_pmd_lane_map_get(phymod_access_t *sa__, uint32_t *tx_lane_map, uint32_t *rx_lane_map) {
...
err_code_t osprey7_v2l8p1_tx_pi_control_get(phymod_access_t *sa__, int16_t* value)
{
...
err_code_t osprey7_v2l8p1_pmd_ln_h_rstb_pkill_override(phymod_access_t *sa__, uint16_t val)
{
    /*
...
err_code_t osprey7_v2l8p1_lane_soft_reset(phymod_access_t *sa__, uint32_t enable)   /* Assert the pmd lane soft reset */
{
...
err_code_t osprey7_v2l8p1_lane_soft_reset_get(phymod_access_t *sa__, uint32_t *enable)
{
    uint32_t data;
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_lane_hard_soft_reset_release(phymod_access_t *sa__, uint32_t enable)   /* release the pmd lane soft reset */
{
...
err_code_t osprey7_v2l8p1_clause72_control(phymod_access_t *sa__, uint32_t cl_72_en)                /* CLAUSE_72_CONTROL */
{
    if (cl_72_en) {
...
err_code_t osprey7_v2l8p1_clause72_control_get(phymod_access_t *sa__, uint32_t *cl_72_en)                /* CLAUSE_72_CONTROL */
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_channel_loss_set(phymod_access_t *sa__, uint32_t loss_in_db)
{
    PHYMOD_EFUN_WR(wrv_osprey7_v2l8p1_usr_ctrl_pam4_chn_loss(sa__, loss_in_db));
    return ERR_CODE_NONE;
}

err_code_t osprey7_v2l8p1_channel_loss_get(phymod_access_t *sa__, uint32_t *loss_in_db)
{
    err_code_t srds_err_code = ERR_CODE_NONE;

    *loss_in_db = rdv_osprey7_v2l8p1_usr_ctrl_pam4_chn_loss(sa__);
...
err_code_t osprey7_v2l8p1_ucode_init(phymod_access_t *sa__ )
{
    ...
    PHYMOD_EFUN_WR(osprey7_v2l8p1_INTERNAL_poll_micro_ra_initdone(sa__, 250)); /* Poll status of data RAM initialization */
...
*/
err_code_t osprey7_v2l8p1_signal_detect(phymod_access_t *sa__, uint32_t *signal_detect)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_tx_shared_patt_gen_en_get(phymod_access_t *sa__, uint8_t *enable) {
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_config_shared_tx_pattern_idx_get(phymod_access_t *sa__, uint32_t *pattern_len, uint32_t *pattern) {
    uint8_t mode_sel;
...
err_code_t osprey7_v2l8p1_tx_disable_get(phymod_access_t *sa__, uint8_t *enable)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_comclk_set(phymod_access_t *sa__, phymod_ref_clk_t ref_clock)
{
    switch (ref_clock) {
...
err_code_t osprey7_v2l8p1_tx_nrz_mode_get(phymod_access_t *sa__, uint16_t *tx_nrz_mode)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_signalling_mode_status_get(phymod_access_t *sa__, phymod_phy_signalling_method_t *mode)
{
...
err_code_t osprey7_v2l8p1_tx_tap_mode_get(phymod_access_t *sa__, uint8_t *mode)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_pam4_tx_pattern_enable_get(phymod_access_t *sa__, phymod_PAM4_tx_pattern_t pattern_type, uint32_t* enable)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_tx_pam4_precoder_enable_set(phymod_access_t *sa__, int enable)
{
...
err_code_t osprey7_v2l8p1_tx_pam4_precoder_enable_get(phymod_access_t *sa__, int *enable)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_pll_pwrdn_get(phymod_access_t *sa__, uint32_t *is_pwrdn)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_pll_lock_get(phymod_access_t *sa__, uint32_t *pll_lock)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_rx_ppm(phymod_access_t *sa__, int16_t *rx_ppm)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
...
err_code_t osprey7_v2l8p1_clk4sync_enable_set(phymod_access_t *sa__, uint32_t en, uint32_t srds_div)
{
...
err_code_t osprey7_v2l8p1_clk4sync_enable_get(phymod_access_t *sa__, uint32_t *en, uint32_t *srds_div)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
