...
#ifndef OSPREY7_V2L8P1_API_INTERNAL_ERROR_H
#define OSPREY7_V2L8P1_API_INTERNAL_ERROR_H
 ...
 */
#define osprey7_v2l8p1_error_report(sa__, err_code) \
        osprey7_v2l8p1_INTERNAL_print_err_msg_and_triage_info(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
/* Prints error code, containing function, file and line number */
#define osprey7_v2l8p1_error(sa__, err_code) \
        osprey7_v2l8p1_INTERNAL_print_err_msg(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
 ...
 * @return Error Code.
 */
err_code_t osprey7_v2l8p1_INTERNAL_print_err_msg(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 * @return Error Code.
 */
err_code_t osprey7_v2l8p1_INTERNAL_print_err_msg_and_triage_info(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 */
const char* osprey7_v2l8p1_INTERNAL_e2s_err_code(err_code_t err_code);
