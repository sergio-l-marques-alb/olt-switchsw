...
#include <phymod/chip/phy8806x_diagnostics.h>


__phymod_diagnostics__dispatch__t__ phymod_diagnostics_phy8806x_diagnostics_driver = {

    phy8806x_phy_rx_slicer_position_set,
    phy8806x_phy_rx_slicer_position_get,
    phy8806x_phy_rx_slicer_position_max_get,
    phy8806x_phy_prbs_config_set,
    phy8806x_phy_prbs_config_get,
    phy8806x_phy_prbs_enable_set,
    phy8806x_phy_prbs_enable_get,
    phy8806x_phy_prbs_status_get,
    phy8806x_phy_pattern_config_set,
    phy8806x_phy_pattern_config_get,
    phy8806x_phy_pattern_enable_set,
    phy8806x_phy_pattern_enable_get,
    phy8806x_core_diagnostics_get,
    phy8806x_phy_diagnostics_get,
    phy8806x_phy_pmd_info_dump,
    NULL, /* phymod_phy_pcs_info_dump */
    phy8806x_phy_eyescan_run,
