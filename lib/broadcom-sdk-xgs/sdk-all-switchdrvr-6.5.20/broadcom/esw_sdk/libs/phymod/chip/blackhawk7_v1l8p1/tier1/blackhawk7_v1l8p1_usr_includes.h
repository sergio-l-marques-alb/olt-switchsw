...
/**************************************************************************************
 *  File Name     :  blackhawk7_v1l8p1_usr_includes.h                                        *
...
/** @file blackhawk7_v1l8p1_usr_includes.h
...
#ifndef BLACKHAWK7_V1L8P1_API_USR_INCLUDES_H
#define BLACKHAWK7_V1L8P1_API_USR_INCLUDES_H
...
# endif
/* USR_VPRINTF() is likely not being used, and may be removed in the future.
...
#endif
#define USR_DELAY_MS(stuff) blackhawk7_v1l8p1_acc_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) blackhawk7_v1l8p1_acc_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) blackhawk7_v1l8p1_acc_delay_ns(sa__,stuff)
