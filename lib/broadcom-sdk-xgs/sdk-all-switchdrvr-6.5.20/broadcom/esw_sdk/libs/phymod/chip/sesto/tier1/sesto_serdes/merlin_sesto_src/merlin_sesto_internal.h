 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: merlin_sesto_internal.h 857 2015-01-16 22:22:38Z kirand $ *
 *                                                                                *
...
/** @file merlin_sesto_internal.h 
 * Internal API functions
 */

#ifndef MERLIN_SESTO_API_INTERNAL_H
#define MERLIN_SESTO_API_INTERNAL_H
...
/*-----------------------------*/
/** Read current merlin_sesto core status.
 * @param *istate Current merlin_sesto core status read back and populated by the API
...
/*-----------------------------*/
/** Read current merlin_sesto lane status.
 * @param *istate Current merlin_sesto lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_sesto_get_osr_mode(const phymod_access_t *pa, merlin_sesto_osr_mode_st *mode);
 ...
 * Along with merlin_sesto_core_clkgate(), all lanes should also be clock gated using merlin_sesto_lane_clkgate() to complete a Core Clockgate 
