...
const sc_pmd_entry_st tscbh_sc_pmd_entry[] = {
  ...
  /*`TBHMOD_SPD_50G_BRCM_CR2_KR2_RS_FEC_FLEXE:44*/{ OS_MODE_1, TBHMOD_PLL_MODE_DIV_165},
  /*`TBHMOD_SPD_50G_BRCM_FEC_544_CR2_KR2_FLEXE:45*/{OS_MODE_1, TBHMOD_PLL_MODE_DIV_170},
  /*`NULL ENTRY:46*/                              {         0, 0},
  /*`NULL ENTRY:47*/                              {         0, 0},
  /*`NULL ENTRY:48*/                              {         0, 0},
  /*`NULL ENTRY:49*/                              {         0, 0},
...
const sc_pmd_entry_st tscbh_sc_pmd_entry_312M_ref[] = {
  ...
  /*`TBHMOD_SPD_50G_BRCM_CR2_KR2_RS_FEC_FLEXE:44*/{ OS_MODE_1, TBHMOD_PLL_MODE_DIV_82P5},
  /*`TBHMOD_SPD_50G_BRCM_FEC_544_CR2_KR2_FLEXE:45*/{OS_MODE_1, TBHMOD_PLL_MODE_DIV_85},
  /*`NULL ENTRY:46*/                              {         0, 0},
  /*`NULL ENTRY:47*/                              {         0, 0},
  /*`NULL ENTRY:48*/                              {         0, 0},
  /*`NULL ENTRY:49*/                              {         0, 0},
...
uint32_t spd_id_entry_26[TSCBH_SPEED_ID_TABLE_SIZE][TSCBH_SPEED_ID_ENTRY_SIZE] = {
    ...
    { 0x34312895, 0x0020f000, 0x0010383d, 0x01402a04, 0x00194a0a },
    { 0x1d912905, 0x0020f003, 0x0010383d, 0x01402a04, 0x0019540a },
...
uint32_t spd_id_entry_25[TSCBH_SPEED_ID_TABLE_SIZE][TSCBH_SPEED_ID_ENTRY_SIZE] = {
    ...
    { 0x34312895, 0x0020f000, 0x0010383d, 0x01402a08, 0x00194a0a },
    { 0x1d912905, 0x0020f003, 0x0010383d, 0x01402a08, 0x0019540a },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
...
uint32_t spd_id_entry_20[TSCBH_SPEED_ID_TABLE_SIZE][TSCBH_SPEED_ID_ENTRY_SIZE] = {
    ...
    { 0x34312895, 0x0020f000, 0x0210183d, 0x01402a0a, 0x00194a0a },
    { 0x1d912905, 0x0020f003, 0x0210183d, 0x01402a0a, 0x0019540a },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000000, 0x400c6000, 0x00000000, 0x00000000 },
...
int tbhmod_get_mapped_speed_7nm(tbhmod_spd_intfc_type_t spd_intf, int *speed)
{
    *speed = -1;
    ...
    if (spd_intf == TBHMOD_SPD_50G_BRCM_FEC_528_CR1_KR1)            *speed = 28;
    if (spd_intf == TBHMOD_SPD_50G_IEEE_KR1_CR1)                    *speed = 5;
    if (spd_intf == TBHMOD_SPD_50G_BRCM_CR2_KR2_RS_FEC_FLEXE)       *speed = 44;
    if (spd_intf == TBHMOD_SPD_50G_BRCM_FEC_544_CR2_KR2_FLEXE)      *speed = 45;
    if (spd_intf == TBHMOD_SPD_100G_MLD_NO_FEC_X4)                  *speed = 37;
    if (spd_intf == TBHMOD_SPD_100G_MLD_X4)                         *speed = 6;
    if (spd_intf == TBHMOD_SPD_100G_BRCM_FEC_544_1XN_KR4_CR4)       *speed = 33;
    if (spd_intf == TBHMOD_SPD_100G_BRCM_NOFEC_KR2_CR2)             *speed = 36;
