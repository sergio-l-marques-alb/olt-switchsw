...
__phymod__dispatch__t__ phymod_furia_driver = {

    furia_core_identify,
    furia_core_info_get,
    NULL, /* phymod_core_lane_map_set */
    NULL, /* phymod_core_lane_map_get */
    furia_core_reset_set,
    furia_core_reset_get,
    furia_core_firmware_info_get,
    furia_phy_firmware_core_config_set,
    furia_phy_firmware_core_config_get,
    furia_phy_firmware_lane_config_set,
    furia_phy_firmware_lane_config_get,
    furia_core_pll_sequencer_restart,
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    furia_phy_polarity_set,
    furia_phy_polarity_get,
    furia_phy_tx_set,
    furia_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    furia_phy_media_type_tx_get,
    ...
    furia_phy_rx_set,
    furia_phy_rx_get,
    furia_phy_rx_adaptation_resume,
    furia_phy_reset_set,
    furia_phy_reset_get,
    furia_phy_power_set,
    furia_phy_power_get,
    ...
    furia_phy_tx_lane_control_set,
    furia_phy_tx_lane_control_get,
    furia_phy_rx_lane_control_set,
    furia_phy_rx_lane_control_get,
    furia_phy_fec_enable_set,
    furia_phy_fec_enable_get,
    ...
    furia_phy_interface_config_set,
    furia_phy_interface_config_get,
    furia_phy_cl72_set,
    furia_phy_cl72_get,
    furia_phy_cl72_status_get,
    furia_phy_autoneg_ability_set,
    furia_phy_autoneg_ability_get,
    furia_phy_autoneg_remote_ability_get,
    furia_phy_autoneg_set,
    furia_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    NULL, /* phymod_phy_autoneg_status_get */
    furia_core_init,
    NULL, /* phymod_phy_pll_multiplier_get */
    furia_phy_init,
    furia_phy_loopback_set,
    furia_phy_loopback_get,
    furia_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_local_fault_info_get */
    NULL, /* phymod_phy_rx_signal_detect_get */
    furia_phy_link_status_get,
    furia_phy_status_dump,
    ...
    furia_phy_lane_cross_switch_map_set,
    furia_phy_lane_cross_switch_map_get,
    furia_phy_intr_enable_set,
    furia_phy_intr_enable_get,
    furia_phy_intr_status_get,
    furia_phy_intr_status_clear,
    furia_phy_i2c_read,
    furia_phy_i2c_write,
    furia_phy_gpio_config_set,
    furia_phy_gpio_config_get,
    furia_phy_gpio_pin_value_set,
    furia_phy_gpio_pin_value_get,
    ...
    furia_phy_short_chn_mode_enable_set,
    furia_phy_short_chn_mode_enable_get,
