...
enum srds_err_code_enum {
    ...
    ERR_CODE_INVALID_PRBS_ERR_ANALYZER_NO_PLL_LOCK,
    ...
    ERR_CODE_INVALID_DIG_LPBK_STATE,
    ERR_CODE_MEM_ALLOC_FAIL,
    ERR_CODE_PRBS_CHK_DISABLED,
    ERR_CODE_RX_CLKGATE_FRC_ON,
    ERR_CODE_NO_PMD_RX_LOCK,
    ERR_CODE_SRDS_REG_ACCESS_FAIL,
    ERR_CODE_INVALID_UAPI_CASE,
