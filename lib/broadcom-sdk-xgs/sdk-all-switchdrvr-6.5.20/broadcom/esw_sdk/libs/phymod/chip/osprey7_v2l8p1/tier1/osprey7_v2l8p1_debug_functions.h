...
#ifndef OSPREY7_V2L8P1_DEBUG_FUNCTIONS_H
#define OSPREY7_V2L8P1_DEBUG_FUNCTIONS_H
...
/** Reads current pmd lane status and populates the provided structure of type #osprey7_v2l8p1_detailed_lane_status_st.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Displays the lane status stored in the input struct of type #osprey7_v2l8p1_detailed_lane_status_st.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
#define OSPREY7_V2L8P1_DAC4CK_MASK 0x08
