...
/*********************************************************************************
 *********************************************************************************
 *  File Name  :  blackhawk7_v1l8p1_functions.h
...
#ifndef BLACKHAWK7_V1L8P1_API_FUNCTIONS_H
#define BLACKHAWK7_V1L8P1_API_FUNCTIONS_H
    ...
    do  { \
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return blackhawk7_v1l8p1_error_report(sa__, *(__ERR)); \
        }\
        (void)srds_err_code; \
    }   while(0)
