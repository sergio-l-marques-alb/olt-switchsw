 ...
 */
enum falcon_tsc_flr_timeout_enum {
    FALCON_TSC_FLR_TIMEOUT_50MS  = 0,
    FALCON_TSC_FLR_TIMEOUT_75MS  = 1,
    FALCON_TSC_FLR_TIMEOUT_100MS = 2,
    FALCON_TSC_FLR_TIMEOUT_150MS = 3
};
