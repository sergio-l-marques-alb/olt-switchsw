 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: merlin_dino_internal.h 1341 2016-02-05 20:06:55Z kirand $ *
 *                                                                                *
...
/** @file merlin_dino_internal.h
 * Internal API functions
 */

#ifndef MERLIN_DINO_API_INTERNAL_H
#define MERLIN_DINO_API_INTERNAL_H
...
#include "merlin_dino_field_access.h"
#include "../common/srds_api_err_code.h"
#include "merlin_dino_interface.h"
#include "merlin_dino_debug_functions.h"
...
typedef struct {
       ...
       uint8_t core_status;
} merlin_dino_core_state_st;
#ifdef DINO_EXCLUDE_STATIC_FUNCTION_DECLARATIONS
/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current merlin_dino lane status.
 * @param *istate Current merlin_dino lane status read back and populated by the API
 ...
 * as part of merlin_dino_display_core_state_line()
 ...
 */
SDK_STATIC err_code_t _falcon_display_event( const phymod_access_t *pa, uint8_t event_id, uint8_t entry_len, uint8_t prev_cursor, uint8_t curr_cursor, uint8_t post_cursor, uint8_t *supp_info);
...
/*-----------------------------*/
/** Read current merlin_dino core status.
 * @param *istate Current merlin_dino core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pll_lock Current merlin_dino lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current merlin_dino lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pmd_lock Current merlin_dino lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current merlin_dino lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *sig_det Current merlin_dino lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current merlin_dino lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_dino_get_osr_mode( const phymod_access_t *pa, merlin_dino_osr_mode_st *mode);
 ...
 * Along with merlin_dino_core_clkgate(), all lanes should also be clock gated using merlin_dino_lane_clkgate() to complete a Core Clockgate
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin_dino_functions.c.
 *
