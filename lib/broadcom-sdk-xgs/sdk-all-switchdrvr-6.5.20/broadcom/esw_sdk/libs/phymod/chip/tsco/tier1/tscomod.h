...
#define TSCOMOD_AUTONEG_SPEED_ID_COUNT 44
...
#define TSCOMOD_PCS_FOUR_COPY_REG_BLOCK2  0xc170
#define TSCOMOD_PCS_FOUR_COPY_REG_BLOCK3  0xc210
...
#define TSCOMOD_AN_UF_PAGE1_BAM_50G_BRCM_NO_FEC_CR1_KR1_MASK 0x1
#define TSCOMOD_AN_UF_PAGE1_BAM_50G_BRCM_NO_FEC_CR1_KR1_OFFSET 0xD
...
#define TSCOMOD_UI_20G_NRZ_OSX1 0x0C698000
#define TSCOMOD_UI_20G_NRZ_OSX2 0x18D30000
#define TSCOMOD_UI_25G_PAM4 0x04F70000
#define TSCOMOD_UI_25G_NRZ_OSX1 0x09EE0000
#define TSCOMOD_UI_25G_NRZ_OSX2P5 0x18D30000
#define TSCOMOD_UI_26G_PAM4 0x04D19E00
#define TSCOMOD_UI_26G_NRZ 0x09A33C00


/* FCLK period macros definition. */
#define TSCOMOD_FCLK_PERIOD_20G_DIV8 0x634c
#define TSCOMOD_FCLK_PERIOD_20G_DIV6 0x4a79
#define TSCOMOD_FCLK_PERIOD_25G 0x4f70
#define TSCOMOD_FCLK_PERIOD_26G 0x4d19

/* PMD datapath latency. From Blackhawk7 user spec datapath latency table. */
#define TSCOMOD_PMD_TX_DP_LATENCY_NRZ 167
#define TSCOMOD_PMD_TX_DP_LATENCY_PAM4 147
#define TSCOMOD_PMD_RX_DP_LATENCY_NRZ 125
#define TSCOMOD_PMD_RX_DP_LATENCY_PAM4 85
...
typedef enum {
    TSCOMOD_DUAL_PORT  = 0,          /*!< Each channel is one logical port */
    TSCOMOD_SINGLE_PORT,             /*!< single port mode: 4 channels as one logical port */
    TSCOMOD_MULTI_MPP_PORT,          /*!< single port mode: 8 channels as one logical port */
...
typedef enum {
    TSCOMOD_PORT_MODE_DUAL  = 0,    /* dual port mode.  */
    TSCOMOD_PORT_MODE_SINGLE,       /* single port mode */
    TSCOMOD_PORT_MODE_MULTI_MPP,    /* 8 lane port      */
    TSCOMOD_PORT_MODE_COUNT
} tscomod_port_mode_type;
...
extern int tscomod_set_an_timers(PHYMOD_ST* pc, phymod_ref_clk_t refclk, uint32_t *pam4_an_timer_value);
...
extern int tscomod_pcs_single_tx_lane_swap_set(PHYMOD_ST* pc, int tx_physical_lane, int tx_logical_lane);
extern int tscomod_pcs_single_rx_lane_swap_set(PHYMOD_ST* pc, int rx_physical_lane, int rx_logical_lane);
...
extern int tscomod_fec_correctable_counter_get(PHYMOD_ST* pc, uint32_t* count);
extern int tscomod_fec_uncorrectable_counter_get(PHYMOD_ST* pc, uint32_t* count);
...
extern int tscomod_pcs_ts_config(PHYMOD_ST *pc, int sfd, int rpm);
...
extern int tscomod_pcs_measure_tx_lane_skew (PHYMOD_ST *pc, uint32_t vco, int os_mode, int pam4, int normalize_to_latest, int *tx_max_skew);
