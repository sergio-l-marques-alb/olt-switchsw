...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  blackhawk_tsc_field_access.h                                        *
...
/** @file blackhawk_tsc_field_access.h
 * Registers and field access
 */

#ifndef BLACKHAWK_TSC_API_FIELD_ACCESS_H
#define BLACKHAWK_TSC_API_FIELD_ACCESS_H
 ...
 */
err_code_t _blackhawk_tsc_pmd_rdt_field(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint16_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _blackhawk_tsc_pmd_rdt_field_signed(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int16_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _blackhawk_tsc_pmd_mwr_reg_byte(srds_access_t *sa__, uint16_t addr, uint16_t mask, uint8_t lsb, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _blackhawk_tsc_pmd_rdt_field_byte(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _blackhawk_tsc_pmd_rdt_field_signed_byte(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk_tsc_pmd_rdt_reg().
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk_tsc_pmd_wr_reg().
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk_tsc_pmd_mwr_reg().
 * @param sa__ is an opaque state vector passed through to device access functions.
