...
__phymod_diagnostics__dispatch__t__ phymod_diagnostics_furia_diagnostics_driver = {

    NULL, /* phymod_phy_rx_slicer_position_set */
    NULL, /* phymod_phy_rx_slicer_position_get */
    NULL, /* phymod_phy_rx_slicer_position_max_get */
    furia_phy_prbs_config_set,
    furia_phy_prbs_config_get,
    furia_phy_prbs_enable_set,
    furia_phy_prbs_enable_get,
    furia_phy_prbs_status_get,
    ...
    furia_phy_diagnostics_get,
    furia_phy_pmd_info_dump,
    NULL, /* phymod_phy_pcs_info_dump */
    furia_phy_eyescan_run,
    furia_phy_link_mon_enable_set,
    furia_phy_link_mon_enable_get,
    furia_phy_link_mon_status_get,
