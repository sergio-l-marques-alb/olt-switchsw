...
**********************************************************************************
*                                                                                *
*  Revision    :  $Id: falcon2_monterey_internal.h 1560 2017-07-17 23:46:38Z kirand $ *
*                                                                                *
...
/** @file falcon2_monterey_internal.h
 * Internal API functions
 */

#ifndef FALCON2_MONTEREY_API_INTERNAL_H
#define FALCON2_MONTEREY_API_INTERNAL_H
...
/* Verbose level used in BER projection */
#define BER_PROJ_VERBOSE 0
...
typedef struct {
	...
	uint16_t link_time;
	/** OSR Mode */
	falcon2_monterey_osr_mode_st osr_mode;
	/** Signal Detect */
	uint8_t sig_det;
...
} falcon2_monterey_lane_state_st;
...
typedef struct {
	...
	uint8_t core_status;
} falcon2_monterey_core_state_st;
 ...
 * as part of falcon2_monterey_display_core_state_line()
 * @param pa phymod_access_t struct
 * @param val PLL_DIV register value
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _falcon2_monterey_display_pll_to_divider (const phymod_access_t *pa, uint8_t val);
...
/*-----------------------------*/
/** Read current falcon2_monterey core status.
 * @param pa phymod_access_t struct
 * @param *istate Current falcon2_monterey core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_monterey_read_core_state (const phymod_access_t *pa, falcon2_monterey_core_state_st *istate);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _falcon2_monterey_display_core_state_no_newline (const phymod_access_t *pa);

/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current falcon2_monterey lane status.
 * @param pa phymod_access_t struct
 * @param *istate Current falcon2_monterey lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_monterey_read_lane_state (const phymod_access_t *pa, falcon2_monterey_lane_state_st *istate);
 ...
 * @param pa phymod_access_t struct
 * @param *pll_lock Current falcon2_monterey lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current falcon2_monterey lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_monterey_pll_lock_status (const phymod_access_t *pa, uint8_t *pll_lock, uint8_t *pll_lock_chg);

/** Read current PMD Lock and PMD Lock change status of a lane.
 * @param pa phymod_access_t struct
 * @param *pmd_lock Current falcon2_monterey lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current falcon2_monterey lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_monterey_pmd_lock_status (const phymod_access_t *pa, uint8_t *pmd_lock, uint8_t *pmd_lock_chg);

/** Read current Signal_detect and Signal_detect change status of a lane.
 * @param pa phymod_access_t struct
 * @param *sig_det Current falcon2_monterey lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current falcon2_monterey lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_monterey_sigdet_status (const phymod_access_t *pa, uint8_t *sig_det, uint8_t *sig_det_chg);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_monterey_get_osr_mode (const phymod_access_t *pa, falcon2_monterey_osr_mode_st *mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _falcon2_monterey_display_lane_state_no_newline (const phymod_access_t *pa);
 ...
 * Along with falcon2_monterey_core_clkgate(), all lanes should also be clock gated using falcon2_monterey_lane_clkgate() to complete a Core Clockgate
 * @param pa phymod_access_t struct
 * @param enable Enable clockgate (1 = Enable clokgate; 0 = Disable clockgate)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _falcon2_monterey_core_clkgate (const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _falcon2_monterey_lane_clkgate (const phymod_access_t *pa, uint8_t enable);
...
/* Lane Config Struct */
static err_code_t _update_uc_lane_config_st (const phymod_access_t *pa, struct falcon2_monterey_uc_lane_config_st *st);
static err_code_t _update_uc_lane_config_word (const phymod_access_t *pa, struct falcon2_monterey_uc_lane_config_st *st);

/* Lane User Control Disable Startup Function Struct */
static err_code_t _update_usr_ctrl_disable_functions_st (const phymod_access_t *pa, struct falcon2_monterey_usr_ctrl_disable_functions_st *st);
static err_code_t _update_usr_ctrl_disable_functions_byte (const phymod_access_t *pa, struct falcon2_monterey_usr_ctrl_disable_functions_st *st);

/* Lane User Control Disable Startup DFE Function Struct */
static err_code_t _update_usr_ctrl_disable_dfe_functions_st (const phymod_access_t *pa, struct falcon2_monterey_usr_ctrl_disable_dfe_functions_st *st);
static err_code_t _update_usr_ctrl_disable_dfe_functions_byte (const phymod_access_t *pa, struct falcon2_monterey_usr_ctrl_disable_dfe_functions_st *st);

/* Core Config Struct */
static err_code_t _update_uc_core_config_st (const phymod_access_t *pa, struct  falcon2_monterey_uc_core_config_st *st);
static err_code_t _update_uc_core_config_word (const phymod_access_t *pa, struct  falcon2_monterey_uc_core_config_st *st);

static uint8_t _falcon2_monterey_rdb_uc_var (const phymod_access_t *pa, err_code_t *err_code_p, uint16_t addr);
static uint16_t _falcon2_monterey_rdw_uc_var (const phymod_access_t *pa, err_code_t *err_code_p, uint16_t addr);
static err_code_t _falcon2_monterey_wrb_uc_var (const phymod_access_t *pa, uint16_t addr, uint8_t wr_val);
static err_code_t _falcon2_monterey_wrw_uc_var (const phymod_access_t *pa, uint16_t addr, uint16_t wr_val);
static err_code_t _falcon2_monterey_display_ber_scan_data (const phymod_access_t *pa, uint8_t ber_scan_mode, uint8_t timer_control, uint8_t max_error_control);
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in falcon2_monterey_functions.c.
 *
 * @param pa phymod_access_t struct
...
/** Polls for register field "cl93n72_fctts_sn_to_trn_req" to be 0 within the time interval specified by timeout_ms.
 * Function returns 0 if polling passes, else it returns error code.
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in falcon2_monterey_functions.c.
 * @param pa phymod_access_t struct
 * @param timeout_ms Maximum time interval in milliseconds for which the polling is done
