...
/* Please note that when adding entries here you should update the #defines in the merlin16_pcieg3_common.h */

/** OSR_MODES Enum */
enum merlin16_pcieg3_osr_mode_enum {
  MERLIN16_PCIEG3_OSX1    = 0,
  MERLIN16_PCIEG3_OSX2    = 1,
  MERLIN16_PCIEG3_OSX3    = 2,
  MERLIN16_PCIEG3_OSX3P3  = 3,
  MERLIN16_PCIEG3_OSX4    = 4,
  MERLIN16_PCIEG3_OSX5    = 5,
  MERLIN16_PCIEG3_OSX7P5  = 6,
  MERLIN16_PCIEG3_OSX8    = 7,
  MERLIN16_PCIEG3_OSX8P25 = 8,
  MERLIN16_PCIEG3_OSX10   = 9
};

/** LANE_RATE Enum **/
enum merlin16_pcieg3_rate_enum {
  MERLIN16_PCIEG3_GEN1 = 0,
  MERLIN16_PCIEG3_GEN2 = 1,
  MERLIN16_PCIEG3_GEN3 = 2
};
