...
/* There are 16 Small BBs with 512 rows. So total of 16 * 512 = 8K bits needed in the bitmap. Each byte
will have 8 bits. So we need 8k/8 = 1024 bytes for storing the bitmap*/
