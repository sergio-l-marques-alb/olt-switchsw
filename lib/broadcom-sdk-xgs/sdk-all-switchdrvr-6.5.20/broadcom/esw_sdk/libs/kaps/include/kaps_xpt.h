...
struct kaps_xpt
{
    ...
    * Should be set to KAPS_DEVICE_KAPS.
    */
    ...
    * Search function.
    *
    * @param xpt pointer to the xpt that was passed to kaps_device_init() is passed back here.
    ...
    *
    * @return KAPS_OK if successfully dispatched to device
    */
