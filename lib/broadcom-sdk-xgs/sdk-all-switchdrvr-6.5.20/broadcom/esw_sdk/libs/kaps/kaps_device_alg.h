...
#define KAPS_MAX_NUM_RPB_BLOCKS (8)
...
#define KAPS_NUM_SMALL_BB_PER_RPT (8)

#define KAPS_TOTAL_NUM_SMALL_BB (32)

#define KAPS_SMALL_BBS_PUBLIC_PRIVATE (16)

#define KAPS_NUM_ROWS_IN_SMALL_BB (512)

#define KAPS2_NUM_AB_PER_RPB (1024)
...
RPT lmpsofar*/
#define KAPS_ADS2_X_TABLE_SIZE ((16 * 16 * 1024) + 1024)

#define KAPS_ADS2_RPT_LMPSOFAR_VIRTUAL_IX_START (16 * 16 * 1024)
...
{
    int32_t x_table[KAPS_ADS2_X_TABLE_SIZE]; /**< Given the virtual IT location, we get the corresponding real location*/
...
{
    struct kaps_sub_ab sub_ab_bricks[KAPS_TOTAL_NUM_SMALL_BB / 2];  /**< Info about the bricks for this AB*/
 ...
 * @param is_xy whether in XY mode or DM mode
 *
 * @return KAPS_OK on success or an error code otherwise.
 */
