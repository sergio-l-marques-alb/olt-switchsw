 ...
 */
    ...
    {
        uint32_t chunk_id:4;              /**< Chunk identifier */
        uint32_t use_count:2;             /**< Used with AB vertical partitiooning */
        uint32_t sb_no:8;                /**< UDA super block number to which this chunk belongs to */
        uint32_t offset_in_sb:18;         /**< offset of the first entry within the UDA super block */
        uint32_t uda_address;             /**< base address of this chunk */
 ...
 * uda_address  UDA address where this AD is stored
 ...
 */
    struct kaps_ad_db
    {
        ...
        struct kaps_ix_mgr *mgr[KAPS_MAX_NUM_CORES];         /**< Points to the Ix Mgr */
