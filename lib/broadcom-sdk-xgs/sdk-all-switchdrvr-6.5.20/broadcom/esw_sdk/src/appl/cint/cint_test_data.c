/*
 * $Id: cint_test_data.c,v 1.17 Broadcom SDK $
...
typedef ct_enum_t (*ct_kitchen_sink_callback_f)(char, short, int, const char*, ct_enum_t, ct_bitmap_t, ct_struct_t*); 
...
CINT_FWRAPPER_CREATE_RP7(ct_enum_t,ct_enum_t,0,0,
                         ct_kitchen_sink,
                         char,char,c,0,0,
                         short,short,s,0,0,
                         int,int,i,0,0,
