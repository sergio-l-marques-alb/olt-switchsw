 ...
 * bcm_pbmp_t variables with many/all ports added may require bigger buffer to
 * print into without truncation
 *
 */
#ifndef CINT_CONFIG_MAX_STACK_PRINT_BUFFER
#if CINT_CONFIG_INCLUDE_CINT_LOGGER == 1
#define CINT_CONFIG_MAX_STACK_PRINT_BUFFER 5120
#else
...
/*
 * CINT Logger - disabled by default
 */
#ifndef CINT_CONFIG_INCLUDE_CINT_LOGGER
#define CINT_CONFIG_INCLUDE_CINT_LOGGER 0
#endif
