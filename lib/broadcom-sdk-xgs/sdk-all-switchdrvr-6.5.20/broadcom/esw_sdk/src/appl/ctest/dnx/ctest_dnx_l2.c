    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, core1, "ETPP", "PRP2", "", "Out_TM_Port", (uint32 *) &tm_port, 1, NULL, return_value, 0));
    ...
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, core2, "ETPP", "PRP2", "", "Out_TM_Port", (uint32 *) &tm_port, 1, NULL, return_value, 0));
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Layer_Offsets.0", &signal_values[0], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Layer_Offsets.1", &signal_values[1], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Layer_Protocols.0",
                     (uint32 *) &eth_layer_protocol, 1, NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Layer_Qualifiers.1", &signal_values[2], 1,
                     NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT5", "", "In_Port", &mapping_info_in_port.pp_port, 1,
                     NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "LLR", "", "Incoming_Tag_Exist", &signal_values[3], 1,
                     NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "LLR", "", "Initial_VID", &vid, 1, NULL, return_value,
                     0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "LLR", "", "Vlan_Domain", (uint32 *) &in_port, 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Fwd_Domain_ID.type", (uint32 *) &type_vsi, 1,
                     NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Fwd_Domain_ID.value", &vsi, 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Incoming_Tag_Structure",
                     (uint32 *) &c_tag_val, 1, NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "VLAN_Edit_Cmd", &signal_values[4], 39, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "VTT1", "", "Fwd_Layer_Index", &signal_values[5], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "FWD2", "", "Fwd_Action_Dst.Type",
                     (uint32 *) &physical_port_type, 1, NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "FWD2", "", "Fwd_Action_Dst.Value", (uint32 *) &out_port,
                     1, NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "FWD2", "", "Out_LIFs", &signal_values[6], 44, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "FER", "", "Fwd_Action_Dst.Type",
                     (uint32 *) &physical_port_type, 1, NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_in_port.core, "IRPP", "FER", "", "Fwd_Action_Dst.Value", (uint32 *) &out_port,
                     1, NULL, return_value, 0));
    ...
    if (system_headers_mode != DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
    {
        ...
        SHR_IF_ERR_EXIT(sand_signal_verify
                        (unit, mapping_info_out_port.core, "ERPP", "Fabric", "", "FTMH_Base.FTMH_PP_DSP",
                         &masked_out_port, 1, NULL, return_value, 0));
    }
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "PRP2", "", "Fabric_or_Egress_MC", &signal_values[8], 1,
                     NULL, return_value, 0));

    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "PRP2", "", "Fwd_Code", (uint32 *) &forward_code_eth, 1,
                     NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "PRP2", "", "EPP_Layer_Protocols.0",
                     (uint32 *) &eth_layer_protocol, 1, NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "PRP2", "", "EPP_Layer_Offsets.0", &signal_values[9], 1,
                     NULL, return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "Term", "", "ETPS_Valid.1", &signal_values[10], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "Term", "", "ETPS_Valid.2", &signal_values[11], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "Term", "", "ETPS_Valid.3", &signal_values[12], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
                    (unit, mapping_info_out_port.core, "ETPP", "Term", "", "ETPS_Valid.4", &signal_values[13], 1, NULL,
                     return_value, 0));
    SHR_IF_ERR_EXIT(sand_signal_verify
