...
static sh_sand_man_t sw_state_ll_max_nodes_test_man = {
    "Test linked list variable usage",
    "Test the entire set of functionality of the linked list DS variable for the maximum amount of nodes."
};
...
static sh_sand_man_t sw_state_bt_test_man = {
    "Test binary tree variable usage",
    "Test the entire set of functionality of the binary tree DS variable."
};
...
sh_sand_cmd_t dnx_swstate_test_cmds[] = {
    ...
    {"binarytree", sw_state_bt_test_cmd, NULL, NULL, &sw_state_bt_test_man, NULL, NULL, CTEST_PRECOMMIT},
