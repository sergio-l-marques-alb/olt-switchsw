...
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_TEST_POSITIVE    "pos"
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_TEST_NEGATIVE    "neg"

#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_TEST_MODE        "mode"
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_MODE_PREDEFINED  "predefined"
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_MODE_USERDEFINED "userdefined"
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_MODE_ACTIONS     "actions"
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_MODE_OAM         "oam"
#define CTEST_DNX_RX_TRAPS_INGRESS_OPTION_MODE_GET         "get"
