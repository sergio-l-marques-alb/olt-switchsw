    ...
    sh_sand_control_t * sand_control)
{
    ...
    int nof_match_per_lif = 15;

#ifndef ADAPTER_SERVER_MODE
    uint32 threshold_time_per_timer[8] = { 600, 400, 100000, 100000, 600, 600, 60000, 600 };
...
#ifndef ADAPTER_SERVER_MODE
    uint32 threshold_time_per_timer[8] = { 600, 400, 600, 600, 600, 600, 60000, 600 };
                                                                                    /** Very loose threshold, to pass all CPUs and compilation */
    uint8 threshold_error = FALSE;
#endif
...
#ifndef ADAPTER_SERVER_MODE
    uint32 threshold_time_per_timer[6] = { 800, 400, 800, 800, 60000, 800 };
                                                                          /** Very loose threshold, to pass all CPUs and compilation */
    uint8 threshold_error = FALSE;
#endif
    PRT_INIT_VARS;
