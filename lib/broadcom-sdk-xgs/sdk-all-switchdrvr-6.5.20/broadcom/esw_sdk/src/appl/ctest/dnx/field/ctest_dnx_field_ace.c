    ...
    int ace_test_clean)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_id_is_allocated(unit, DNX_FIELD_STAGE_IPMF1, context_id, &context_existed_ipmf1));
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_id_is_allocated(unit, DNX_FIELD_STAGE_EPMF, context_id, &context_existed_epmf));
    if (context_existed_ipmf1 == FALSE)
    {
        SHR_IF_ERR_EXIT(dnx_field_context_create
