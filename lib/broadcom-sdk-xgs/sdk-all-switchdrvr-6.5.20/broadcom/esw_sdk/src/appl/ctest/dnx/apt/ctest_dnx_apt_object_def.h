...
#define DNX_APT_TIME_TO_RATE(_microseconds_) ((int)(1000000.0 / (_microseconds_)))
#define DNX_APT_RATE_TO_TIME(_entries_per_second_) ((double)(1000000.0 / ((double)(_entries_per_second_))))
...
typedef enum
{
     ...
     */
    /** Incidates that the test is supported also with KBP. */
    DNX_APT_SUPPORT_KBP_SUPPORTED = DNX_APT_SUPPORT_INTERNAL_KBP_CHECK_SKIP,
    /** Incidates that the test is supported only with KBP. */
