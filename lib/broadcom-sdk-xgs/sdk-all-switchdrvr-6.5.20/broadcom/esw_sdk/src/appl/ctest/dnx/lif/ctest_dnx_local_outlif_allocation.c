    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_lif_mngr_outlif_sw_info_get
                    (unit, local_outlif_1, &dbal_table_id, NULL, &outlif_phase, NULL, NULL, NULL));
    ...
    SHR_IF_ERR_EXIT(dnx_lif_mngr_outlif_sw_info_get
                    (unit, local_outlif_2, &dbal_table_id, NULL, &outlif_phase, NULL, NULL, NULL));
...
ctest_dnx_local_outlif_allocation_capacity_test(
    ...
    sh_sand_control_t * sand_control)
{
    int outlif_phase_idx, total_outlifs = 0, rv, lif_idx, lifs_in_allocation_bank;
