...
/* "l3uc" feature's diag command list valid only for apache */
char * techsupport_l3uc_apache_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "l3uc" feature's software dump command list valid only for apache */
char * techsupport_l3uc_apache_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "l3uc" feature for apache chipset. */
static soc_mem_t techsupport_l3uc_apache_memory_table_list[] = {
    PORT_TABm,
    L3_TUNNELm,
    MY_STATION_TCAMm,
    VLAN_MPLSm,
 ...
 * "l3uc" feature for apache chipset. */
techsupport_reg_t techsupport_l3uc_apache_reg_list[] = {
 ...
 * "l3uc" feature for apache chipset. */
techsupport_data_t techsupport_l3uc_apache_data = {
    techsupport_l3uc_diag_cmdlist,
    techsupport_l3uc_apache_reg_list,
    techsupport_l3uc_apache_memory_table_list,
    techsupport_l3uc_apache_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_l3uc_sw_dump_cmdlist,
    techsupport_l3uc_apache_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
