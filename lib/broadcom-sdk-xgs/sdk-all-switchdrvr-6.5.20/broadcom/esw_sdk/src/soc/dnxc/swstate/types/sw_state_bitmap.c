/** \file sw_state_bitmap.c
 * This file contains sw state bitmaps functions
 */
/*
 * $Id: $
    ...
    char *dbg_string)
{
    ...
    /* get the offset to the SHR_BITDCL that contains the bit */
    byte_offset = (dest_offset / SHR_BITWID) * sizeof(SHR_BITDCL);

    /* calculate the bit offset in the SHR_BITDCL */
    ...
    /* set of possible operations here */
    switch(op_type) {
    ...
    char *dbg_string)
{
    ...
    /* write back to sw state memory and journal*/
    ...
    char *dbg_string)
{
    ...
    /* read bitmap data to temporary storage */
    ...
    char *dbg_string)
{
    ...
    /* copy sw state memory to temporary location */
    ...
    /* copy bit range from temporary source location to result location */
