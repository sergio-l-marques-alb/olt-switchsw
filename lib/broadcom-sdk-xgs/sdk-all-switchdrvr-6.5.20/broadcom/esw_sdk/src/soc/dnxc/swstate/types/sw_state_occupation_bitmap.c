/** \file sw_state_occupation_bitmap.c
 *
    ...
    uint32 alloc_flags)
{
    ...
    DNX_SW_STATE_ALLOC(unit, module_id, *bit_map_ptr, **bit_map_ptr, /*number of elements*/ 1, DNXC_SW_STATE_NO_FLAGS, "sw_state occ bitmap");
...
*     Identifier of the device to access.
*  sw_state_occ_bm_t bit_map -
*     The bitmap to perform the get operation on.
*   uint8 val -
    ...
    sw_state_occ_bitmap_init_info_t * init_info)
{
    ...
    /*
     * Add occ_bitmap levels array size.
     */
    ...
    {
        /*
         * Add occ_bitmap levels_cache array size.
         */
        size += (sizeof(uint32) * nof_levels);
    }

    /*
     * Add occ_bitmap levels_size array size.
     */
    size += (sizeof(uint32) * nof_levels);
    ...
    {
        /*
         * Add occ_bitmap levels_cache_buffer size.
         */
        size += (sizeof(uint8) * all_level_size);
    }

    /*
     * Add occ_bitmap levels_buffer size.
     */
    size += (sizeof(uint8) * all_level_size);
