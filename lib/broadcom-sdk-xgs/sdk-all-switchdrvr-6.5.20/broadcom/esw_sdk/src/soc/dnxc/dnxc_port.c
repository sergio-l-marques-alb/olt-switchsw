    ...
    int enable)
{
    ...
    {
        /*
         * This function is meant only to unisolate after we reenabled the port.
         * Do nothing if not enabling
         */
        if (enable)
        {
    ...
    int *actual_errcnt)
{
    ...
    *actual_errcnt = 0;
     ...
     */
    SHR_IF_ERR_EXIT(portmod_common_post_ber_proj_get(unit, port, 0 /* phyn */ , lane, 0 /* sys_side */ ,
    ...
    for (i = 0; i < *actual_errcnt; i++)
    {
        ...
        /** ber_proj_prbs_errcnt array size is 16 */
        for (j = 0; j < 16; j++)
        {
