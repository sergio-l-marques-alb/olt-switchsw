...
/**
 * \brief device level function which set numeric hard_reset_disable
 * numeric info:
...
/**
 * \brief device level function which set numeric mdio_int_div_out_delay
 * numeric info:
...
/**
 * \brief device level function which set numeric mdio_ext_div_out_delay
 * numeric info:
 ...
 */
/**
 * \brief device level function which set define nof_all_blocks
 * define info:
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_blocks_override_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_device_blocks_table_override");
