 ...
 */
shr_error_e
dnxf_data_property_unsupported_verify(
    int unit)
{
    const dnxc_data_table_info_t *table_info;
    const dnxf_data_device_properties_unsupported_t *prop_info;
    int property_index;
    char *val = NULL;
    ...
    table_info = dnxf_data_device.properties.unsupported_info_get(unit);
    ...
    {
        prop_info = dnxf_data_device.properties.unsupported_get(unit, property_index);
