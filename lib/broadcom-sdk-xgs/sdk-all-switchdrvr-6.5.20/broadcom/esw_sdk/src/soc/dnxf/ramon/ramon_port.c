...
soc_ramon_port_enable_set(int unit, soc_port_t port, int enable)
{
     ...
     * The case is similar for enable sequence so we have to isolate prior to enable also
     *
     * NOTE! Executed only for dynamic procedures (check function implementation)
     */
    if (dnxf_data_port.
