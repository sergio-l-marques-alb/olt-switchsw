...
int soc_jer_port_ports_to_same_quad_get(int unit, soc_port_t port, soc_pbmp_t* ports)
{
    ...
    SOC_PBMP_ITER((*ports), port_i) 
    {
        ...
        /*If own is ilkn_over_fabric, we should remove all the port which are not ilkn over_fabric*/
        /*If own is not ilkn_over_fabric, we should remove all the port which are ilkn over_fabric*/
