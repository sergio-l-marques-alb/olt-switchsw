  ...
  )
{
  ...
  /* 
   *  Force flow control on HR before disabling HR. This is a solution for Dynamic port during traffic
  ...
  /* 
   *  Disable force flow control on HR after enabling HR. This is a solution for Dynamic port during traffic
   *  that leads to scheduler being stuck due to toggling of SCH_PORT_ENABLE_PORTEN.
   */
  if (is_port_hr_val)
  {
