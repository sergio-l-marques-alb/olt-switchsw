...
int soc_dpp_drc_combo28_gddr5_shmoo_drc_bist_conf_set(int unit, int drc_ndx, combo28_gddr5_bist_info_t info)
{
    ...
    bist_info.data_pattern_mode = SOC_TMC_DRAM_BIST_DATA_PATTERN_CUSTOM; /* custom pattern */
    bist_info.dbi_pattern_mode  = SOC_TMC_DRAM_BIST_DATA_PATTERN_CUSTOM; /* custom pattern */
    bist_info.edc_pattern_mode  = SOC_TMC_DRAM_BIST_DATA_PATTERN_CUSTOM; /* custom pattern */
...
int soc_dpp_drc_combo28_shmoo_vendor_info_get(int unit, int drc_ndx, combo28_vendor_info_t *info)
{
    ...
    /* Fix read value according to dq byte swaps */
