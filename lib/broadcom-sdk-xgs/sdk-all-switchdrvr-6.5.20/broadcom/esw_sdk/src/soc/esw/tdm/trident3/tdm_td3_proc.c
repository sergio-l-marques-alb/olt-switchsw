...
/**
@name: tdm_td3_proc_cal_ancl
@param:

Allocate ancillary slots with matched speed rates accordingly
**/
int
tdm_td3_proc_cal_ancl(tdm_mod_t *_tdm)
{
...
/**
@name: tdm_td3_proc_cal_idle
@param:

Allocate idle slots with matched speed rates accordingly
**/
int
tdm_td3_proc_cal_idle( tdm_mod_t *_tdm )
{
    int i, result=PASS;
    int empty_slot_cnt = 0;
    int param_lr_limit, param_ancl_num, param_cal_len, 
