...
**/
int
tdm_th_legacy_which_tsc(unsigned short port, int **tsc)
{
...
**/
int
tdm_th_slice_size_local(unsigned short idx, int *tdm, int lim)
{
	int i, slice_size=(-1);
...
**/
int
tdm_th_slice_size(unsigned short port, int *tdm, int lim)
{
...
**/
int
tdm_th_slice_idx(unsigned short port, int *tdm, int lim)
{
...
**/
int
tdm_th_slice_prox_local(unsigned short idx, int *tdm, int lim, int **tsc)
{
...
**/
int
tdm_th_scan_slice_size_local(unsigned short idx, int *tdm, int lim, int *slice_start_idx)
{
...
**/
int
tdm_th_scan_slice_min(unsigned short port, int *tdm, int lim, int *slice_start_idx, int pos)
{
...
**/
int
tdm_th_scan_slice_max(unsigned short port, int *tdm, int lim, int *slice_start_idx, int pos)
{
...
**/
int
tdm_th_scan_mix_slice_size_local(unsigned short idx, int *tdm, int lim, int *slice_start_idx)
{
	int i, slice_size=(-1), idx_start=(-1);
...
**/
int
tdm_th_scan_mix_slice_min(unsigned short port, int *tdm, int lim, int *slice_start_idx, int pos)
{
	int i, k=0, idx0, slice_size_min=256, slice_idx=-1 , idx_start;
	if (pos>=0 && pos<lim) {
		/* linerate */
...
**/
int
tdm_th_scan_mix_slice_max(unsigned short port, int *tdm, int lim, int *slice_start_idx, int pos)
{
	int i, k=0, idx0, slice_size_max=0, slice_idx=-1 , idx_start;
	if (pos>=0 && pos<lim) {
		/* linerate */
...
**/
int
tdm_th_check_shift_cond_pattern(unsigned short port, int *tdm_tbl, int tdm_tbl_len, int **tsc, int dir)
{
...
**/
int
tdm_th_check_shift_cond_local_slice(unsigned short port, int *tdm_tbl, int tdm_tbl_len, int **tsc, int dir)
{
