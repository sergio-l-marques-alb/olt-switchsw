...
int
soc_counter_helix5_generic_get_info(int unit, soc_ctr_control_info_t
        ...
        case SOC_CTR_INSTANCE_TYPE_PORT:
            ...
            switch (id) {
                ...
                case SOC_COUNTER_NON_DMA_PORT_OBM_FC_EVENTS:
                    return soc_counter_helix5_get_info(unit, port, id,
                    ...
                    *num_entries = non_dma->entries_per_port;
                    ...
                    if (IS_CPU_PORT(unit, port)) {
                        ...
                        *base_index += pipe_offset +
                                        (mmu_port & SOC_HX5_MMU_PORT_STRIDE);
                    }
                    *base_index *= _HX5_MMU_NUM_PG;
                    break;
...
int
soc_counter_helix5_get_info(int unit, soc_port_t port, soc_reg_t id,
                            int *base_index, int *num_entries)
{
    ...
    case SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_PKT:
    case SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_BYTE:
        /* For EGR_PERQ_XMT_COUNTERSm
         * MCQ range is 1280-2617
         */
        *base_index  = si->port_cosq_base[port] + SOC_HX5_NUM_UC_QUEUES_PER_PIPE;
        *num_entries = si->port_num_cosq[port];
        break;
    case SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_PKT_UC:
    case SOC_COUNTER_NON_DMA_EGR_PERQ_XMT_BYTE_UC:
...
STATIC int
soc_counter_helix5_extra_obm_ctrs_init(int unit,
...
#define LOSSLESS1 3
    ...
    soc_reg_t obm_drop_pkt_regs[][4] = {
        {IDB_OBM0_Q_LOSSY_LO_PKT_DROP_COUNTr, IDB_OBM0_Q_LOSSY_HI_PKT_DROP_COUNTr,
         IDB_OBM0_Q_LOSSLESS0_PKT_DROP_COUNTr, IDB_OBM0_Q_LOSSLESS1_PKT_DROP_COUNTr
        },
        {IDB_OBM1_Q_LOSSY_LO_PKT_DROP_COUNTr, IDB_OBM1_Q_LOSSY_HI_PKT_DROP_COUNTr,
         IDB_OBM1_Q_LOSSLESS0_PKT_DROP_COUNTr, IDB_OBM1_Q_LOSSLESS1_PKT_DROP_COUNTr
        },
        {IDB_OBM2_Q_LOSSY_LO_PKT_DROP_COUNTr, IDB_OBM2_Q_LOSSY_HI_PKT_DROP_COUNTr,
         IDB_OBM2_Q_LOSSLESS0_PKT_DROP_COUNTr, IDB_OBM2_Q_LOSSLESS1_PKT_DROP_COUNTr
        },
        ...
        {IDB_OBM0_48_LOSSY_LO_PKT_DROP_COUNTr, IDB_OBM0_48_LOSSY_HI_PKT_DROP_COUNTr,
         IDB_OBM0_48_LOSSLESS0_PKT_DROP_COUNTr, IDB_OBM0_48_LOSSLESS1_PKT_DROP_COUNTr
        },
        {IDB_OBM1_48_LOSSY_LO_PKT_DROP_COUNTr, IDB_OBM1_48_LOSSY_HI_PKT_DROP_COUNTr,
         IDB_OBM1_48_LOSSLESS0_PKT_DROP_COUNTr, IDB_OBM1_48_LOSSLESS1_PKT_DROP_COUNTr
        },
        {IDB_OBM2_48_LOSSY_LO_PKT_DROP_COUNTr, IDB_OBM2_48_LOSSY_HI_PKT_DROP_COUNTr,
         IDB_OBM2_48_LOSSLESS0_PKT_DROP_COUNTr, IDB_OBM2_48_LOSSLESS1_PKT_DROP_COUNTr
        },
    };
    soc_reg_t obm_drop_byte_regs[][4] = {
        {IDB_OBM0_Q_LOSSY_LO_BYTE_DROP_COUNTr, IDB_OBM0_Q_LOSSY_HI_BYTE_DROP_COUNTr,
         IDB_OBM0_Q_LOSSLESS0_BYTE_DROP_COUNTr, IDB_OBM0_Q_LOSSLESS1_BYTE_DROP_COUNTr
        },
        {IDB_OBM1_Q_LOSSY_LO_BYTE_DROP_COUNTr, IDB_OBM1_Q_LOSSY_HI_BYTE_DROP_COUNTr,
         IDB_OBM1_Q_LOSSLESS0_BYTE_DROP_COUNTr, IDB_OBM1_Q_LOSSLESS1_BYTE_DROP_COUNTr
        },
        {IDB_OBM2_Q_LOSSY_LO_BYTE_DROP_COUNTr, IDB_OBM2_Q_LOSSY_HI_BYTE_DROP_COUNTr,
         IDB_OBM2_Q_LOSSLESS0_BYTE_DROP_COUNTr, IDB_OBM2_Q_LOSSLESS1_BYTE_DROP_COUNTr
        },
        ...
        {IDB_OBM0_48_LOSSY_LO_BYTE_DROP_COUNTr, IDB_OBM0_48_LOSSY_HI_BYTE_DROP_COUNTr,
         IDB_OBM0_48_LOSSLESS0_BYTE_DROP_COUNTr, IDB_OBM0_48_LOSSLESS1_BYTE_DROP_COUNTr
        },
        {IDB_OBM1_48_LOSSY_LO_BYTE_DROP_COUNTr, IDB_OBM1_48_LOSSY_HI_BYTE_DROP_COUNTr,
         IDB_OBM1_48_LOSSLESS0_BYTE_DROP_COUNTr, IDB_OBM1_48_LOSSLESS1_BYTE_DROP_COUNTr
        },
        {IDB_OBM2_48_LOSSY_LO_BYTE_DROP_COUNTr, IDB_OBM2_48_LOSSY_HI_BYTE_DROP_COUNTr,
         IDB_OBM2_48_LOSSLESS0_BYTE_DROP_COUNTr, IDB_OBM2_48_LOSSLESS1_BYTE_DROP_COUNTr
        },
    };
    soc_reg_t obm_fc_event_regs[] = {
        IDB_OBM0_Q_FLOW_CONTROL_EVENT_COUNTr,
        IDB_OBM1_Q_FLOW_CONTROL_EVENT_COUNTr,
        IDB_OBM2_Q_FLOW_CONTROL_EVENT_COUNTr,
        ...
        IDB_OBM0_48_FLOW_CONTROL_EVENT_COUNTr,
        IDB_OBM1_48_FLOW_CONTROL_EVENT_COUNTr,
        IDB_OBM2_48_FLOW_CONTROL_EVENT_COUNTr,
    };
 ...
 */
int
soc_counter_helix5_non_dma_init(int unit, int nports,
                                ...
                                int *non_dma_entries)
{
    ...
    *non_dma_entries = 0;
    ...
    soc_ctr_ctrl->port_obm_info_get = soc_helix5_port_obm_info_get;

    /* EGR_PERQ_XMT_COUNTERSm is the largest table to be DMA'ed */
    ...
    *non_dma2 = *non_dma0;
    ...
    non_dma2->entries_per_port = 26; /* Stacking ports have max 26 UC Qs Per port */
    ...
    *non_dma_entries += non_dma1->num_entries;
    ...
    non_dma0->base_index = non_dma_start_index + *non_dma_entries;
    non_dma0->entries_per_port = 26; /* Stacking ports have max 26 UC Qs Per port */
    ...
    *non_dma_entries += non_dma0->num_entries;
     ...
     *   [1]     [3]        [2n-1]
     */
     /* 10 OBMs for each PORTMACRO; 4 ports in each OBM;
      * IDB_OBM0_LOSSY_LO_PKT_DROP_COUNTr [0-2]
      * IDB_OBM0_Q_LOSSY_LO_PKT_DROP_COUNT [0-3]
      * IDB_OBM0_48_LOSSY_LO_PKT_DROP_COUNT [0-2]
      */
    non_dma0->extra_ctr_ct = _HX5_OBMS_PER_PIPE; /* 10 OBMs per Pipe */
    alloc_size = (non_dma0->extra_ctr_ct << 1) * sizeof(soc_counter_non_dma_t);
    ...
    if (non_dma0->extra_ctrs == NULL) {
        ...
        sal_memset(non_dma0->extra_ctrs, 0, alloc_size);
        rv = soc_counter_helix5_extra_obm_ctrs_init(unit,
                                                      non_dma0,
                                                      non_dma0->extra_ctrs,
                                                      non_dma0->extra_ctr_ct,
                                                      &num_extra_ctr_entries);
