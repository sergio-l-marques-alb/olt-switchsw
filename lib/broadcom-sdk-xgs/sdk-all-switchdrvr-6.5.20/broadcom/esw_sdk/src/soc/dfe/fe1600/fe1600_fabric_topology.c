...
/*
 * Function:
 *      soc_fe1600_fabric_all_reachable_integrity_update
 * Purpose:
 *      Re-calculate all-reachable vector, taking into account integrity vector.
 * Parameters:
 *      unit - (IN) Unit number.
 * Returns:
 *      SOC_E_xxx
...
soc_fe1600_fabric_topology_all_reachable_integrity_update(int unit)
{
    ...
    /* Trigger All-reachable calculation */
