    ...
    char *sdk_location)
{
    ...
    /*
     * Pointer cannot be NULL - this is clear error
     */
    ...
    if (ISEMPTY(sdk_location_base))
    {
        ...
        /*
         * This routine should be use only for development environment
         * Assumption is that application is initialized from some place in the $SDK/systems
         * So fetch the current location - find systems and set SDK location to parent folder of it
         */
        ...
        soc_reg_t   reg)
{
    ...
    {
        /* Device was not initiated - leave peacefully */
        return 0;
    }
    ...
    xml_node curTop)
{
    ...
    {
        /*
         * No Section registers - means no need for = leave peacefully
         */
        SHR_EXIT();
    }
    ...
    xml_node curTop)
{
    ...
    {
        /*
         * No Section memories - means no need for = leave peacefully
         */
        SHR_EXIT();
    }
    ...
    device_t *device)
{
    ...
    /*
     * Go through the entries looking for either specific chip name or driver name or family one
     * The order matters - first match only will be considered
     */
    RHDATA_ITERATOR(cur, curSubTop, "device")
    {
        ...
        {
            /*
             * We succeeded to find the device
             */
...
#else
    /*
    * Avoid double initiation for the device
    */
    if(sand_device_array[unit] != NULL)
    {
    ...
    /*
     * Call to init sdk location, failure should not interfere with init
     */
    {
    ...
    /*
     * ANy failures inside should not influence init sequence
     */
