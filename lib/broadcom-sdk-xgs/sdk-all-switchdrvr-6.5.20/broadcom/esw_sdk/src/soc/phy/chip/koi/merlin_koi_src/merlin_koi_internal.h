 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: merlin_koi_internal.h 1075 2015-07-02 22:59:52Z kirand $ *
 *                                                                                *
...
/** @file merlin_koi_internal.h
 * Internal API functions
 */

#ifndef MERLIN_KOI_API_INTERNAL_H
#define MERLIN_KOI_API_INTERNAL_H
...
#include "merlin_koi_interface.h"
#include "merlin_koi_debug_functions.h"
...
typedef struct {
       ...
       uint8_t core_status;
} merlin_koi_core_state_st;

/* Print DSC diagnostic for KOI. */
void get_dsc_param_koi(void);
 ...
 * as part of merlin_koi_display_core_state_line()
 * @param val PLL_DIV register value
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _merlin_koi_display_pll_to_divider(uint8_t val);
...
/*-----------------------------*/
/** Read current merlin_koi core status.
 * @param *istate Current merlin_koi core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_koi_read_core_state(merlin_koi_core_state_st *istate);

/** Display current core state.
 * Reads and displays all important core state values.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _merlin_koi_display_core_state_no_newline(void);

/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current merlin_koi lane status.
 * @param *istate Current merlin_koi lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_koi_read_lane_state(merlin_koi_lane_state_st *istate);
 ...
 * @param *pll_lock Current merlin_koi lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current merlin_koi lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_koi_pll_lock_status(uint8_t *pll_lock, uint8_t *pll_lock_chg);

/** Read current PMD Lock and PMD Lock change status of a lane.
 * @param *pmd_lock Current merlin_koi lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current merlin_koi lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_koi_pmd_lock_status(uint8_t *pmd_lock, uint8_t *pmd_lock_chg);

/** Read current Signal_detect and Signal_detect change status of a lane.
 * @param *sig_det Current merlin_koi lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current merlin_koi lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_koi_sigdet_status(uint8_t *sig_det, uint8_t *sig_det_chg);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_koi_get_osr_mode(merlin_koi_osr_mode_st *mode);

/** Display current lane state.
 * Reads and displays all important lane state values.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _merlin_koi_display_lane_state_no_newline(void);
 ...
 * Along with merlin_koi_core_clkgate(), all lanes should also be clock gated using merlin_koi_lane_clkgate() to complete a Core Clockgate
 * @param enable Enable clockgate (1 = Enable clokgate; 0 = Disable clockgate)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _merlin_koi_core_clkgate(uint8_t enable);

/** Serdes Lane ClockGate.
 * @param enable Enable lane clockgate (1 = Enable clockgate; 0 = Disable clockgate)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _merlin_koi_lane_clkgate(uint8_t enable);
...
/* Lane Config Struct */
static err_code_t _update_uc_lane_config_st(struct merlin_koi_uc_lane_config_st *st);
static err_code_t _update_uc_lane_config_word(struct merlin_koi_uc_lane_config_st *st);

/* Lane User Control Disable Startup Function Struct */
static err_code_t _update_usr_ctrl_disable_functions_st(struct merlin_koi_usr_ctrl_disable_functions_st *st);
static err_code_t _update_usr_ctrl_disable_functions_byte(struct merlin_koi_usr_ctrl_disable_functions_st *st);

/* Lane User Control Disable Startup DFE Function Struct */
static err_code_t _update_usr_ctrl_disable_dfe_functions_st(struct merlin_koi_usr_ctrl_disable_dfe_functions_st *st);
static err_code_t _update_usr_ctrl_disable_dfe_functions_byte(struct merlin_koi_usr_ctrl_disable_dfe_functions_st *st);

/* Core Config Struct */
static err_code_t _update_uc_core_config_st(struct  merlin_koi_uc_core_config_st *st);
static err_code_t _update_uc_core_config_word(struct  merlin_koi_uc_core_config_st *st);

static uint8_t _merlin_koi_rdb_uc_var(err_code_t *err_code_p, uint16_t addr);
static uint16_t _merlin_koi_rdw_uc_var(err_code_t *err_code_p, uint16_t addr);
static err_code_t _merlin_koi_wrb_uc_var(uint16_t addr, uint8_t wr_val);
static err_code_t _merlin_koi_wrw_uc_var(uint16_t addr, uint16_t wr_val);
static err_code_t _merlin_koi_display_ber_scan_data(uint8_t ber_scan_mode, uint8_t timer_control, uint8_t max_error_control);
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin_koi_functions.c.
 *
