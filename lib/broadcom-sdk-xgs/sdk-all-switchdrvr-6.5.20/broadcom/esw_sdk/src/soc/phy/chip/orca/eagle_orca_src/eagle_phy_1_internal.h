 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: eagle_phy_1_internal.h 1553 2017-05-12 21:01:08Z cvazquez $ *
 *                                                                                *
...
/** @file eagle_phy_1_internal.h
 * Internal API functions
 */

#ifndef EAGLE_PHY_1_API_INTERNAL_H
#define EAGLE_PHY_1_API_INTERNAL_H
...
#include "eagle_phy_1_interface.h"
#include "eagle_phy_1_debug_functions.h"
...
typedef struct {
       ...
       uint8_t core_status;
} eagle_phy_1_core_state_st;

/* Print DSC diagnostic for ORCA. */
 ...
 * as part of eagle_phy_1_display_core_state_line()
...
/*-----------------------------*/
/** Read current eagle_phy_1 core status.
 * @param *istate Current eagle_phy_1 core status read back and populated by the API
...
/*-----------------------------*/
/** Read current eagle_phy_1 lane status.
 * @param *istate Current eagle_phy_1 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pll_lock Current eagle_phy_1 lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current eagle_phy_1 lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pmd_lock Current eagle_phy_1 lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current eagle_phy_1 lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *sig_det Current eagle_phy_1 lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current eagle_phy_1 lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _eagle_phy_1_get_osr_mode(eagle_phy_1_osr_mode_st *mode);
 ...
 * Along with eagle_phy_1_core_clkgate(), all lanes should also be clock gated using eagle_phy_1_lane_clkgate() to complete a Core Clockgate
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in eagle_phy_1_functions.c.
 *
