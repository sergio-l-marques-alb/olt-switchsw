...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_QOS_PROFIILE_SW_INFO /* table id*/, is_valid /* is valid*/, "QOS_PROFIILE_SW_INFO" /* table name*/, DBAL_ACCESS_METHOD_SW_STATE /* access method*/));
    /** maturity level  */
    ...
    /** interface results  */
    {
        ...
        /** interface result fields init  */
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_QOS_PROFILE_NAME_SPACE /* field id*/, DBAL_FIELD_TYPE_DEF_QOS_PROFILE_NAME_SPACE /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_sw_state_set_indirect_table_size(unit, cur_table_param, "DNX_DATA.qos.qos.nof_ingress_profiles" /* table property size*/, dnx_data_qos.qos.nof_ingress_profiles_get(unit) /* table property size as int*/));
