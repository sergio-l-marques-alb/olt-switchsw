...
/**
 * \brief device level function which set values for table table_way_to_macro_mapping
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_dh_table_way_to_macro_mapping_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_dh_table_table_way_to_macro_mapping");
...
/**
 * \brief device level function which set values for table mdb_13_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_mdb_13_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_em_table_mdb_13_info");
...
/**
 * \brief device level function which set define nof_rows_in_rpb
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define nof_rows_in_small_ads
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define nof_rows_in_small_rpb_hitbits
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
