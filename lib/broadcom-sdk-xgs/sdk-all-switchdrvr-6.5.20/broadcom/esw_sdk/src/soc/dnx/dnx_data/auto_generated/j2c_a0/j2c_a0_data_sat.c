    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 384000000;

    /* Set value */
    define->data = 384000000;
    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 224000000;

    /* Set value */
    define->data = 224000000;
    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 33000000;

    /* Set value */
    define->data = 33000000;
    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 30000000;

    /* Set value */
    define->data = 30000000;
