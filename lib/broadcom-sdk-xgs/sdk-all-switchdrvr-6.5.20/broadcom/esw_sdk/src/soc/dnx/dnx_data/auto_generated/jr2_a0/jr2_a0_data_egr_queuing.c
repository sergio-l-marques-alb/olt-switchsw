/** \file jr2_a0_data_egr_queuing.c
 * 
...
/**
 * \brief device level function which set define chan_arb_calendar_size
 * define info:
...
/**
 * \brief device level function which set define port_prio_calendar_size
 * define info:
...
/**
 * \brief device level function which set define tcg_calendar_size
 * define info:
...
/**
 * \brief device level function which set define cal_res_packet_mode
 * define info:
...
/**
 * \brief device level function which set define initial_packet_mode
 * define info:
...
/**
 * \brief device level function which set define slow_port_speed
 * define info:
...
/**
 * \brief device level function which set define mux_calendar_resolution
 * define info:
