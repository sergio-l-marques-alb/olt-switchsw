 ...
 */
/**
 * \brief device level function which set define nof_ca_bits
 * define info:
...
/**
 * \brief device level function which set define bytes_per_channel
 * define info:
...
/**
 * \brief device level function which set define training_fifo_depth
 * define info:
...
/**
 * \brief device level function which set numeric refresh_mechanism_enable
 * numeric info:
...
/**
 * \brief device level function which set numeric dynamic_calibration_enable
 * numeric info:
...
/**
 * \brief device level function which set numeric cdr_enable
 * numeric info:
...
/**
 * \brief device level function which set numeric write_recovery
 * numeric info:
 * write recovery
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric cabi
 * numeric info:
 * enable cabi
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric dram_mode
 * numeric info:
 * dram mode
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric cal_termination
 * numeric info:
 * CAL Termination
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric cah_termination
 * numeric info:
 * CAH Termination
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric command_pipe_extra_delay
 * numeric info:
...
/**
 * \brief device level function which set numeric use_11bits_ca
 * numeric info:
...
/**
 * \brief device level function which set numeric ck_odt
 * numeric info:
 * CK ODT
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric dynamic_calibration_period
 * numeric info:
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_refresh_intervals_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_refresh_intervals");
...
/**
 * \brief device level function which set values for table dq_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_dq_map_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_dq_map");
...
/**
 * \brief device level function which set values for table dq_channel_swap
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_dq_channel_swap_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_dq_channel_swap");
...
/**
 * \brief device level function which set values for table dq_byte_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_dq_byte_map_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_dq_byte_map");
...
/**
 * \brief device level function which set values for table ca_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_ca_map_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_ca_map");
...
/**
 * \brief device level function which set values for table cadt_byte_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_cadt_byte_map_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_cadt_byte_map");
...
/**
 * \brief device level function which set values for table channel_regs
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_channel_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_channel_regs");
...
/**
 * \brief device level function which set values for table controller_regs
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_controller_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_controller_regs");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_channel_interrupt_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_channel_interrupt_regs");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_controller_interrupt_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_controller_interrupt_regs");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_channel_debug_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_channel_debug_regs");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_channel_counter_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_channel_counter_regs");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_channel_type_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_channel_type_regs");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_controller_info_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_controller_info_regs");
...
/**
 * \brief device level function which set values for table master_phy
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_gddr6_master_phy_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_gddr6_table_master_phy");
...
/**
 * \brief device level function which set numeric command_parity_latency
 * numeric info:
...
/**
 * \brief device level function which set numeric crc_write_latency
 * numeric info:
 * crc write latency
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric crc_read_latency
 * numeric info:
 * crc read latency
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric crc_write
 * numeric info:
 * write crc
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric crc_read
 * numeric info:
 * read crc
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric device_size
 * numeric info:
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_general_info_mr_defaults_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_general_info_table_mr_defaults");
...
/**
 * \brief device level function which set define nof_atms
 * define info:
...
/**
 * \brief device level function which set define dram_bist_mode_nof_bits
 * define info:
