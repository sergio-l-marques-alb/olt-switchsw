/** \file dnx/swstate/auto_generated/access/dnx_algo_lane_map_access.c
 *
...
/*
 *
 * is_init function for the variable dnx_algo_lane_map_db
...
/*
 *
 * init function for the variable dnx_algo_lane_map_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
