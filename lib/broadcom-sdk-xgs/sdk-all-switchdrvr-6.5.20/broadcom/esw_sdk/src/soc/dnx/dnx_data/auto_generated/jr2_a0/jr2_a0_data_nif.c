...
/**
 * \brief device level function which set define is_nif_56G_speed_supported
 * define info:
...
/**
 * \brief device level function which set define is_fabric_56G_speed_supported
 * define info:
...
/**
 * \brief device level function which set values for table supported_an_abilities
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_supported_an_abilities_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_nif_eth_table_supported_an_abilities");
