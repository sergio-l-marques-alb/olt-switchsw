 ...
 */
static shr_error_e
q2a_a0_dnx_data_fc_general_ilkn_oob_en_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_fc_coe_nof_supported_vlan_ids_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_fc_general_ilkn_oob_en_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_fc_coe_nof_supported_vlan_ids_set;
