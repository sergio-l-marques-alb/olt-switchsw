...
/**
 * \brief device level function which set define lpm_strength_profile_support
 * define info:
...
/**
 * \brief device level function which set define nof_lpm_profiles
 * define info:
...
/**
 * \brief device level function which set define nof_prefix_ranges
 * define info:
...
/**
 * \brief device level function which set define member_table_row_width
 * define info:
