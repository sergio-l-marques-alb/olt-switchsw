...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_sw_state_set_indirect_table_size(unit, cur_table_param, "DNX_DATA.mpls.general.nof_mpls_range_elements" /* table property size*/, dnx_data_mpls.general.nof_mpls_range_elements_get(unit) /* table property size as int*/));
