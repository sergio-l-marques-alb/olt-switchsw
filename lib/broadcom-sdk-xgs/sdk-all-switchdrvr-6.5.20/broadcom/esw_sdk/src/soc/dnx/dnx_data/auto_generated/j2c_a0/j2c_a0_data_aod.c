 ...
 * Module - 'aod', Submodule - 'tables', table - 'ERPP_FWD_CONTEXT_FILTER___image'
 * table related image
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_ERPP_FWD_CONTEXT_FILTER___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_ERPP_FWD_CONTEXT_FILTER___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'ERPP_FWD_CONTEXT_FILTER'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_ERPP_FWD_CONTEXT_FILTER_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_ERPP_FWD_CONTEXT_FILTER");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'EGRESS_PER_FORWARD_CODE___image'
 * table related image
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    table->values[0].default_val = "standard_1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_EGRESS_PER_FORWARD_CODE___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_EGRESS_PER_FORWARD_CODE___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'EGRESS_PER_FORWARD_CODE'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_EGRESS_PER_FORWARD_CODE_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_EGRESS_PER_FORWARD_CODE");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'ERPP_FORWARD_CODE_SELECTION___image'
 * table related image
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    table->values[0].default_val = "standard_1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_ERPP_FORWARD_CODE_SELECTION___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_ERPP_FORWARD_CODE_SELECTION___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'ETPP_FORWARD_CODE_SELECTION___image'
 * table related image
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    table->values[0].default_val = "standard_1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_ETPP_FORWARD_CODE_SELECTION___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_ETPP_FORWARD_CODE_SELECTION___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'EGRESS_PARSING_START_TYPE_CONTEXT___image'
 * table related image
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    table->values[0].default_val = "standard_1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'EGRESS_PARSING_START_TYPE_CONTEXT'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image'
 * table related image
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    table->values[0].default_val = "standard_1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image'
 * table related image
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    table->values[0].default_val = "standard_1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image_t, (1 + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image");
 ...
 * Module - 'aod', Submodule - 'tables', table - 'MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_aod_tables_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES");
