 ...
 */
static shr_error_e
jr2_a0_dnx_data_macsec_general_is_macsec_supported_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_a0_dnx_data_macsec_general_macsec_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_macsec;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_macsec_general_ports_in_macsec_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_macsec;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_macsec_general_macsec_nof_bits_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_macsec_general_ports_in_macsec_nof_bits_set;
    ...
    feature->set = jr2_a0_dnx_data_macsec_general_is_macsec_supported_set;
