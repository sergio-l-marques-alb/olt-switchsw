...
typedef struct
{
    ...
    /** access DB */
    int is_hook_active; /** incase that the hook is active the access to the table is done by dedicated functions. hooks are generally used to fix HW issues or support specific HW behaviors */
...
/**
 * \brief
 * This function calculate the allocator indication for table and field
 */
