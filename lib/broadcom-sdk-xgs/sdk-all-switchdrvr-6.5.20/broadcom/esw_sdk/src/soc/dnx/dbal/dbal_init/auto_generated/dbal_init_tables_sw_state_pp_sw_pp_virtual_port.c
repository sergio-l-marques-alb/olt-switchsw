...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_sw_state_set_indirect_table_size(unit, cur_table_param, "DNX_DATA.device.general.nof_cores*DNX_DATA.port_pp.general.nof_virtual_port_tcam_entries" /* table property size*/, dnx_data_device.general.nof_cores_get(unit)*dnx_data_port_pp.general.nof_virtual_port_tcam_entries_get(unit) /* table property size as int*/));
