 ...
 */
static shr_error_e
q2a_a0_dnx_data_esem_feature_etps_properties_assignment_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esem_feature_key_with_sspa_contains_member_id_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_esem;
    ...
    int unit)
{
    ...
    feature->set = q2a_a0_dnx_data_esem_feature_etps_properties_assignment_set;
    data_index = dnx_data_esem_feature_key_with_sspa_contains_member_id;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_esem_feature_key_with_sspa_contains_member_id_set;
