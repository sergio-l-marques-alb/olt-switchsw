...
/**
 *  \brief ETPS ARR value extraction logic
 */
static shr_error_e
    ...
    char to_n[RHNAME_MAX_SIZE])
{
    ...
    /*
     * get first table_id and result_type SW value for the data_type
     */
    ...
    {
        /*
         * if result type is in range of data entries just skip without error
         */
    ...
    for (field_idx = 0; field_idx < table->multi_res_info[result_type].nof_result_fields; field_idx++)
    {
        ...
        else
        {
            ...
            /*
             * field with prefix is no larger than 32bits - prepand {prefix, field}
             */
