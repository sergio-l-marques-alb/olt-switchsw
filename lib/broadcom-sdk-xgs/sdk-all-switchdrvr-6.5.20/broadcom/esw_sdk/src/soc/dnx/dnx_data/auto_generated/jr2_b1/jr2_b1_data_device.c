 ...
 */
static shr_error_e
jr2_b1_dnx_data_device_general_rqp_ecc_err_exist_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b1_dnx_data_device_general_core_clock_khz_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b1_dnx_data_device_general_device_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_device;
    ...
    int unit)
{
    ...
    define->set = jr2_b1_dnx_data_device_general_core_clock_khz_set;
    data_index = dnx_data_device_general_define_device_id;
    define = &submodule->defines[data_index];
    define->set = jr2_b1_dnx_data_device_general_device_id_set;
    ...
    feature->set = jr2_b1_dnx_data_device_general_rqp_ecc_err_exist_set;
