            ...
            while (cluster_index < nof_clusters)
            {
                ...
                while (entry_index < end_address * entries_per_row)
                {
                    ...
                    if (op_iter == 0)
                    {
                        ...
                        SHR_IF_ERR_EXIT(mdb_eedb_table_entry_add(unit, physical_tables, 0, &entry, entry_flags[0]));
                        if (full_time == FALSE)
                        {
                    ...
                    if (op_iter == 2)
                    {
                        ...
                        SHR_IF_ERR_EXIT(mdb_eedb_table_entry_delete(unit, physical_tables, 0, &entry, entry_flags[0]));
                        if (full_time == FALSE)
                        {
