 ...
 */
static shr_error_e
j2p_a0_dnx_data_stack_general_dest_port_base_queue_min_set(
    int unit)
{
 ...
 */
static shr_error_e
j2p_a0_dnx_data_stack_general_dest_port_base_queue_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stack;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_stack_general_dest_port_base_queue_min_set;
    data_index = dnx_data_stack_general_define_dest_port_base_queue_max;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_stack_general_dest_port_base_queue_max_set;
