 ...
 */
static shr_error_e
j2p_a0_dnx_data_ingress_cs_parser_parsing_context_map_enable_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = j2p_a0_dnx_data_ingress_cs_parser_parsing_context_map_enable_set;
