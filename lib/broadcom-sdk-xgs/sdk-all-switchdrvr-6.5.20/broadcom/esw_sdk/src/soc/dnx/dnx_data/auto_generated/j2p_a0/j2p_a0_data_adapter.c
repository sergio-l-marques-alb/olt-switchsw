...
#include <src/bcm/dnx/rx/auto_generated/rx_internal_j2p_a0.h>
/*
 * }
 */
 ...
 */
static shr_error_e
j2p_a0_dnx_data_adapter_rx_packet_header_signal_id_set(
    int unit)
{
    ...
    /* Set default value */
    define->default_data = PACKET_HEADER_SIGNAL_ID_J2P_A0;

    /* Set value */
    define->data = PACKET_HEADER_SIGNAL_ID_J2P_A0;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_adapter_rx_constant_header_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_adapter_general_lib_ver_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_adapter_rx_packet_header_signal_id_set;
    data_index = dnx_data_adapter_rx_define_constant_header_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_rx_constant_header_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_lib_ver_set;
