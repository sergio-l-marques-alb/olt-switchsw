...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, cur_field_types_info, "KBP_DEVICE_MODE" /* name*/, 2 /* size*/, is_valid /* is field valid*/, FALSE /* has resource name*/, DBAL_FIELD_PRINT_TYPE_ENUM /* print*/, 0 /* is common*/, 1 /* is default*/, FALSE /* is_standard_1 is set by Autocoder*/));
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** enum values  */
