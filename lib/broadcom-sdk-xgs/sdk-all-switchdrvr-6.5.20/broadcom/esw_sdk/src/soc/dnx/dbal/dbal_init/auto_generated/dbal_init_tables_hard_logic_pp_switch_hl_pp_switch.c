/** \file dbal_init_tables_hard_logic_pp_switch_hl_pp_switch.c
 * Logical DB enums \n 
...
shr_error_e
_dbal_init_tables_hard_logic_pp_switch_hl_pp_switch_split_horizon_filter_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_SPLIT_HORIZON_FILTER;
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_SPLIT_HORIZON_FILTER /* table id*/, is_valid /* is valid*/, "SPLIT_HORIZON_FILTER" /* table name*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    /** maturity level  */
    ...
    /** interface results  */
    {
        ...
        /** interface result fields init  */
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_SPLIT_HORIZON_FILTER_ENABLE /* field id*/, DBAL_FIELD_TYPE_DEF_BOOL /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 1;
    ...
    /** image infos  */
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_SPLIT_HORIZON_FILTER, is_standard_1, is_compatible_with_all_images));
    }
    ...
    /** build access hl direct  */
    {
        ...
        /** set (hl direct) accesses for field: SPLIT_HORIZON_FILTER_ENABLE  */
        {
            ...
            /** set access  */
            {
                ...
                /** set access field id  */
                access_params->access_field_id = DBAL_FIELD_SPLIT_HORIZON_FILTER_ENABLE + instance_index;
                ...
                /** set register/memory information for current access  */
                {
                    ...
                    regMemHwEntityId = ETPPC_CFG_SPLIT_HORIZON_FILTERr;
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_SPLIT_HORIZON_FILTER, table_info));
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
_dbal_init_tables_hard_logic_pp_switch_hl_pp_switch_svtag_default_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_SVTAG_DEFAULT;
    int is_valid = dnx_data_switch.svtag.supported_get(unit);
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_SVTAG_DEFAULT /* table id*/, is_valid /* is valid*/, "SVTAG_DEFAULT" /* table name*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    table_entry->nof_labels = 1;
    SHR_ALLOC_SET_ZERO(table_entry->table_labels, table_entry->nof_labels * sizeof(dbal_labels_e), "table labels allocation", "%s%s%s\r\n", table_entry->table_name, EMPTY, EMPTY);
    table_entry->table_labels[0] = DBAL_LABEL_SVTAG;
    /** no interface keys  */
    /** interface results  */
    {
        int field_index = 0;
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_SVTAG_DEFAULT_VALUE /* field id*/, DBAL_FIELD_TYPE_DEF_UINT /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 32;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
    ...
    /** image infos  */
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_SVTAG_DEFAULT, is_standard_1, is_compatible_with_all_images));
    }
    /** set app to phy db general information  */
    /** core mode  */
    table_entry->core_mode = DBAL_CORE_MODE_SBC;
    ...
    /** build access hl direct  */
    {
        ...
        access_counter = 0;
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY /* result type*/, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        /** set (hl direct) accesses for field: SVTAG_DEFAULT_VALUE  */
        {
            table_db_access_params_struct_t * access_params;
            /** set access  */
            {
                ...
                /** set access information  */
                /** set access field id  */
                access_params->access_field_id = DBAL_FIELD_SVTAG_DEFAULT_VALUE + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 /* field size*/, 0 /* field offset*/, DBAL_VALUE_FIELD_ENCODE_NONE /* encode type*/, 0 /* encode value*/));
                /** set register/memory information for current access  */
                {
                    int regMemHwEntityId = INVALIDr;
                    ...
                    /** set reg/mem hw Entity id  */
                    /** set field hw Entity id  */
                    fieldHwEntityId = DEFAULT_SVTAGf;
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_ETPP_DEFAULT_SVTAG /* group id*/, regMemHwEntityId /* reg/mem hw entity id*/, fieldHwEntityId /* field hw entity id*/, INVALIDr /* alias hw entity id*/));
                }
            }
        }
        /** set nof access for field mapping  */
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_SVTAG_DEFAULT, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_switch_hl_pp_switch_split_horizon_filter_init(unit, cur_table_param, table_info));
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_switch_hl_pp_switch_svtag_default_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
