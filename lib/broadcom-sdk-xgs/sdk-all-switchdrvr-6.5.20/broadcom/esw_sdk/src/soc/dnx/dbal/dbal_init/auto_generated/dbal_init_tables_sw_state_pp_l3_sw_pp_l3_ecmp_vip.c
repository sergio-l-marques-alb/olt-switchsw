...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECMP_VIP_CONFIG_SW /* table id*/, is_valid /* is valid*/, "ECMP_VIP_CONFIG_SW" /* table name*/, DBAL_ACCESS_METHOD_SW_STATE /* access method*/));
    /** maturity level  */
