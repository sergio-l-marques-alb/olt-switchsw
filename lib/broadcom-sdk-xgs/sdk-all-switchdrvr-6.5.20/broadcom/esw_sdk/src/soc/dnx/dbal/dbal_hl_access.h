 ...
 *  from the XML. if there is an block offset will return the
 *  block index and num_of_blocks == 1, if no block index
 *  specification in the XML will use block calculation in a
 *  semetric way. 0..n/2-1 blocks for core 0 and n/2...n-1
 *  blocks for core 1.
 */
 ...
 *  implemened for this table the function reurns error */
...
/**
 *  \brief
 *  General hook function for entry set, dispatcher for all hooks according to tables. incase of no hook is
 *  implemened for this table the function reurns error */
...
/**
 *  \brief
 *  General hook function for entry res_type_resolution, dispatcher for all hooks according to tables. incase of no hook is
 *  implemened for this table the function reurns error */
...
/**
 * \brief
 * this function write from the table according to the access type (register/memory/sw). handling packed mode
 */
...
/**
 * \brief
 * this function reads from the table according to the access type (register/memory/sw). handling packed mode
 */
