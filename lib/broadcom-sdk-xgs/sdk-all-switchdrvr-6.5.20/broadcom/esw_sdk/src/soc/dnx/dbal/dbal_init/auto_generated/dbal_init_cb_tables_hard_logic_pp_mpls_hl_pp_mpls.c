...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_FULL_KEY_VALUE(unit, eh, full_key_value);
    /** sizes of LABELS_TO_TERMINATE + SPECIAL_BEFORE_TUNNEL + SPECIAL_AFTER_TUNNEL + PHB_COMPARE_STRENGTH + REMARK_COMPARE_STRENGTH + ECN_COMPARE_STRENGTH + TTL_COMPARE_STRENGTH + PHB_PROPAGATION_STRENGTH + REMARK_PROPAGATION_STRENGTH + ECN_PROPAGATION_STRENGTH + TTL_PROPAGATION_STRENGTH + QOS_MAPPING_PROFILE + ECN_MAPPING_PROFILE + FORCE_PARSER_CONTEXT + FORCE_PARSER_CONTEXT_VALUE + FORCE_HAS_CW + FORCE_IS_OAM + CHECK_BOS + EXPECTED_BOS + CHECK_TTL + EXPECTED_TTL fields  */
