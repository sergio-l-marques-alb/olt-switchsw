/** \file dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_ipmf2.c
 * Logical DB enums \n 
...
shr_error_e
_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_ipmf2_kleap_ipmf2_kbr_info_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_KLEAP_IPMF2_KBR_INFO;
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_IPMF2_KBR_INFO /* table id*/, is_valid /* is valid*/, "KLEAP_IPMF2_KBR_INFO" /* table name*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    /** maturity level  */
    ...
    /** image infos  */
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_KLEAP_IPMF2_KBR_INFO, is_standard_1, is_compatible_with_all_images));
    }
        ...
        /** set (hl direct) accesses for field: FFC_BITMAP  */
        {
            ...
            /** set access  */
            {
                ...
                /** set register/memory information for current access  */
                {
                    ...
                    regMemHwEntityId = IPPC_PMF_KBR_PASS_2m;
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_KLEAP_IPMF2_KBR_INFO, table_info));
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_ipmf2_kleap_ipmf2_ffc_instruction_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_KLEAP_IPMF2_FFC_INSTRUCTION;
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_IPMF2_FFC_INSTRUCTION /* table id*/, is_valid /* is valid*/, "KLEAP_IPMF2_FFC_INSTRUCTION" /* table name*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    /** maturity level  */
    /** default maturity level  */
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    /** *************  */
    ...
    /** interface keys  */
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 2 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "KLEAP_IPMF2_FFC_INSTRUCTION" /* table name*/, EMPTY, EMPTY);
        /** interface key fields init  */
        {
            dbal_db_field = &table_entry->keys_info[field_index];
    ...
    /** interface results  */
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_IPMF2_FFC_INSTRUCTION /* field id*/, DBAL_FIELD_TYPE_DEF_IPMF2_FFC_INSTRUCTION /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
    ...
    /** image infos  */
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_KLEAP_IPMF2_FFC_INSTRUCTION, is_standard_1, is_compatible_with_all_images));
    }
    /** set app to phy db general information  */
    /** core mode  */
    table_entry->core_mode = DBAL_CORE_MODE_SBC;
    ...
    /** build access hl direct  */
    {
        ...
        access_counter = 0;
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY /* result type*/, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        /** set (hl direct) accesses for field: IPMF2_FFC_INSTRUCTION  */
        {
            table_db_access_params_struct_t * access_params;
            /** set access  */
            {
                ...
                /** set access information  */
                /** set access field id  */
                access_params->access_field_id = DBAL_FIELD_IPMF2_FFC_INSTRUCTION + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 /* field size*/, 0 /* field offset*/, DBAL_VALUE_FIELD_ENCODE_NONE /* encode type*/, 0 /* encode value*/));
                /** set register/memory information for current access  */
                {
                    int regMemHwEntityId = INVALIDm;
                    int fieldHwEntityId = INVALIDf;
                    /** set reg/mem hw Entity id  */
                    regMemHwEntityId = IPPC_PMF_KEY_GEN_PASS_2m;
                    /** set field hw Entity id  */
                    fieldHwEntityId = INVALIDf;
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY /* group id*/, regMemHwEntityId /* reg/mem hw entity id*/, fieldHwEntityId /* field hw entity id*/, INVALIDm /* alias hw entity id*/));
                    access_params->entry_offset.formula_cb = field_context_hash_configuration_compression_dataoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_ipmf2_ffc_instruction_ipmf2_ffc_instruction_dataoffset_0_cb;
                }
            }
        }
        /** set nof access for field mapping  */
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_KLEAP_IPMF2_FFC_INSTRUCTION, table_info));
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_ipmf2_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_ipmf2_kleap_ipmf2_kbr_info_init(unit, cur_table_param, table_info));
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_ipmf2_kleap_ipmf2_ffc_instruction_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
