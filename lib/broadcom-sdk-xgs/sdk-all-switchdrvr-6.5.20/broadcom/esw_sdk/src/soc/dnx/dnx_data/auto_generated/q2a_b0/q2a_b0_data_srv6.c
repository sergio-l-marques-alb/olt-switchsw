 ...
 */
static shr_error_e
q2a_b0_dnx_data_srv6_termination_max_nof_terminated_sids_usp_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = q2a_b0_dnx_data_srv6_termination_max_nof_terminated_sids_usp_set;
