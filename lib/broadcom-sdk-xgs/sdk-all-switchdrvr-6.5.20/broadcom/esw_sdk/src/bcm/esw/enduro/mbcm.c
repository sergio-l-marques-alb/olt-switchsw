...
mbcm_functions_t mbcm_enduro_driver = {
    ...
    bcm_tr_cosq_init,
    bcm_tr_cosq_detach,
    bcm_tr_cosq_config_set,
    bcm_tr_cosq_config_get,
    bcm_tr_cosq_mapping_set,
    bcm_tr_cosq_mapping_get,
    bcm_tr_cosq_port_sched_set,
    bcm_tr_cosq_port_sched_get,
    bcm_tr_cosq_sched_weight_max_get,
    bcm_tr_cosq_port_bandwidth_set,
    bcm_tr_cosq_port_bandwidth_get,
    bcm_tr_cosq_discard_set,
    bcm_tr_cosq_discard_get,
    bcm_tr_cosq_discard_port_set,
    bcm_tr_cosq_discard_port_get,
...
typedef int bcm_esw_enduro_mbcm_not_empty; /* Make ISO compilers happy. */
