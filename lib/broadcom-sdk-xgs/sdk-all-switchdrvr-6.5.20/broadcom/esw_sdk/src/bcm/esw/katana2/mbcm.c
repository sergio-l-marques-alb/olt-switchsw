...
mbcm_functions_t mbcm_katana2_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_kt2_cosq_port_bandwidth_set,
    bcm_kt2_cosq_port_bandwidth_get,
...
typedef int bcm_esw_katana2_mbcm_not_empty; /* Make ISO compilers happy. */
