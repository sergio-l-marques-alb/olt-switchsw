...
mbcm_functions_t mbcm_bradley_driver = {
    /*  L2 functions */
    bcm_fb_l2_init,
    bcm_fb_l2_term,
    bcm_fb_l2_addr_get,
...
#else  /* BCM_HB_GW_SUPPORT */
typedef int bcm_esw_bradley_mbcm_not_empty; /* Make ISO compilers happy. */
#endif /* BCM_HB_GW_SUPPORT */
