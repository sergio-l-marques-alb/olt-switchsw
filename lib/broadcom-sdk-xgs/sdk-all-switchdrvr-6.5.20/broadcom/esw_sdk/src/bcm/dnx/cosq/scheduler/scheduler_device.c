    ...
    uint32 *internal)
{
    ...
    if (*internal != 0)
    {
        ...
        /*
         * we must ensure both lower and upper bound
         * lower - since is required by HW specification
         * upper - the internal value is reverse proportional vs. actual rate,
         *         so low rate causes high internal value;
         *         we can't require mininal rate from the user, so we must limit the upper bound
         */
