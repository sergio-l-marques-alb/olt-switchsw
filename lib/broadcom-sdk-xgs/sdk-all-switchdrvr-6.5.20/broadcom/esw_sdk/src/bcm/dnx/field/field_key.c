    ...
    dnx_field_key_ffc_instruction_info_t * ffc_instruction_p)
{
    ...
    if (is_initial)
    {
         ...
         * by the occupation bmp allocation (see dnx_algo_field_key_ipmf1_initial_key_occupation_bmp_allocate).
         * In this case, we do not take the ffc_index*32'b into calculations.
         */
...
/**
* \brief
*  This function determines if the initial FFCs for the given IPMF2 qualifier
...
/**
* \brief
*  Checks and get split info of a key qualifier that needs to be spill over to the next key.
* \param [in] unit                    - Device ID
* \param [in] offset_within_key       - Offset of the qualifier in the first key
* \param [in,out] key_qual_map_p          - lsb and size of the qualifier
* \param [in,out] dnx_qual_info_p     - Qualifier info
* \param [out] second_qual_map_p      - Size of the qualifier on the second key
* \param [out] second_dnx_qual_info_p - Qualifier info regarding the second key
* \param [out] was_split_p            - Whether the qualifier needs to be split or not
* \return
*   shr_error_e             - Error Type
* \remark
* \see
    ...
    dnx_field_app_db_id_t * app_db_id_p)
{
     ...
     * Otherwise, 'half key' allocation was employed.
     */
    ...
    dnx_field_context_t context_id)
{
    ...
    {
        /*
         * If the stage is iPMF1 reserve bits on the initial key.
         */
        LOG_DEBUG_EX(BSL_LOG_MODULE,
    ...
    {
        /*
         * If the stage is iPMF2 allocate bits on key.
         */
    ...
    dnx_field_context_t context_id)
{
    ...
    {
        /*
         * If the stage is iPMF1 free reserved bits on the initial key.
         */
        LOG_DEBUG_EX(BSL_LOG_MODULE,
    ...
    {
        /*
         * If the stage is iPMF2 deallocate bits on key.
         */
        dnx_field_key_id_t key_id;
