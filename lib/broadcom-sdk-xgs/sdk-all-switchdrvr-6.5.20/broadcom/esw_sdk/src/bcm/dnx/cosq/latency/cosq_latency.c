...
/**
* \brief
*  voq latency based admission - for devices that don't have the
*  eco need to add for CGM to always get the VOQ-Latency-Flow
*  and keep the VOQ profiles bellow 16 - need to set field
*  VoqLatencyRjctFlowProfileNull to 16(cgm
*  reads 4b from the header flow instead of 5, if the flow is 16
*  it will read 0000 and compare it to
*  VoqLatencyRjctFlowProfileNull, meaning
*  VoqLatencyRjctFlowProfileNull should be different than 0 in
*  order to always get the VOQ-Latency-Flow),
*  for devices with the ECO enabled
*  VoqLatencyRjctFlowProfileNull should be set to 0 as all 32
    ...
    int unit)
{
        ...
        DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO2_MODE)
    {
         ...
         *  Below code configures the left shift in the ITPP
         */
