    ...
    int unit)
{
    ...
    {
        /*
         * When the device uses usage counters in the BDB release mechanism,
         * the BDB release is done based on used BDs for each BDB instead of
         * free-BDB indication.
         * This threshold's default value is 3, but since the mechanism is
         * now reversed, we need to count 3 BDBs from the FIFOs max value (which is 15).
         */
