...
/**
* \brief
*     Get gtf config rate from SW.
* \par
* \param [in] unit - Relevant unit.
* \param [in] gtf_id -  gtf id.
* \param [out] gtf_config_rate -  gtf max rate config by user.
* \param [out] gtf_rate_compensation -  gtf rate compensation.
* \param [out] packet_length_compensation -  packet length compensation.
* \retval
...
* \param [in] unit - Relevant unit.
* \param [in] gtf_id -  gtf id.
* \param [in] gtf_config_rate -  gtf max rate config by user.
* \param [in] gtf_rate_compensation -  gtf rate compensation.
* \param [in] packet_length_compensation -  packet length compensation.
* \retval
*   * Zero if no error was detected
*   * Negative if error was detected. See \ref
*     shr_error_e
...
* \param [in] gtf_rate_factor -  sat gtf rate factor.
* \retval
*   * Zero if no error was detected
*   * Negative if error was detected. See \ref
*     shr_error_e
    ...
    bcm_sat_gtf_packet_config_t * config)
{
    ...
    /*
     * Save config max rate into sw dbal
     */
