    ...
    int unit)
{
     ...
     * Since the delay is given, we can calculate the calendar by the
     ...
     *
     * The full rate is:
     *                               core_clock_mhz * bus_size_in_bits * 105
     * shaper_rate_per_link_mbps =  ------------------------------------------
     *                                                100
     
     *                shaper_rate_per_link_mbps    (shaper_delay + 1)       core_clock_mhz * bus_size_in_bits * 105     (shaper_delay + 1) 
     * shaper_cal =  --------------------------- * ------------------- = ------------------------------------------- * --------------------
     *                     core_clock_mhz                   8                        core_clock_mhz * 100                        8
     *
     * Which makes the final formula:
     *                                 bus_size_in_bits * 105 * (shaper_delay + 1)
     *                  shaper_cal =  --------------------------------------------
     *                                                   8 * 100
     */
