...
pfcdm_field_compare_stat_metata_set(int unit)
{
     ...
     */
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_compare_fg_id);
    if (rv != BCM_E_NONE)
    {
...
int pfcdm_field_ipv4_ipmf2_em_init(int unit)
{
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_em_flow_fg_id);
    if(rv != BCM_E_NONE)
    {
...
int pfcdm_field_ipv4_ipmf2_tcam_init(int unit)
{
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_tcam_flow_fg_id);
    if(rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_group_add\n", rv);
        return rv;
...
*/	
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_hash_udf_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
int pfcdm_field_trap_code_to_udh_data_init(int unit)
{
     ...
     * Add the FG.
     */
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_hash_trap_code_to_udh_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
/*    fg_info.qual_types[1] = bcmFieldQualifyDstPort;*/
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN | BCM_FIELD_FLAG_WITH_ID, &fg_info, &pfcdm_congest_mon_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
int pfcdm_field_ipmf3_gen_group_init(int unit)
{
    ...
    */
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_ipmf3_gen_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
*/
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &pfcdm_egress_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
