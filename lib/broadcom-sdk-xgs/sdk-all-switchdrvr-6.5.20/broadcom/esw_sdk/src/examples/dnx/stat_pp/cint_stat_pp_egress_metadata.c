/*
 * $Id: cint_stat_pp_egress_outrif.c,v 1.15 2019/12/29 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2020 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_egress_metadata.c Purpose: Statistics examples for SDK egress statistics and metadata APIs using an L2 application.
 */
