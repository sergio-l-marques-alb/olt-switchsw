 ...
 *
 *  Should recieve 2 packets: forward copy + snoop copy. ToD timestamp is on the tail edit footer in the snooped copy.
 ...
 * And snooped copy, including system headers and tail edit with timestamp information
 ...
 * Snoop copy, including system headers and tail edit with timestamp information:
