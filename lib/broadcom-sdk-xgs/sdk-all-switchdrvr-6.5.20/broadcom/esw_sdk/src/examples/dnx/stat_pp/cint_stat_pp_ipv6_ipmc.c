/*
 * $Id: cint_stat_pp_ipv6_ipmc.c,v 1.15 2018/09/13 12:47:34 Huili Zhang Exp $
 $Copyright: (c) 2020 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_ipv6_ipmc.c Purpose: Statistics examples for SDK ingress APIs using an ipv6 ipmc application.
 */
