 ...
 * terminating the outter layers before sending packet to Egress, this in order
 * makes the 144B window that are sent to PP have the last IP layer cut, therefore resulting in
 * missing data in the last layers when rebuilding the packets.
 *
 */
