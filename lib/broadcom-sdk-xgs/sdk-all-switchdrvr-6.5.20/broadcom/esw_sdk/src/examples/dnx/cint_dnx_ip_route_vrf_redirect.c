/*
 * $Id: cint_dnx_ip_route_vrf_redirect.c,v 1.15 Broadcom SDK $
 $Copyright: (c) 2020 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_ip_route_vrf_redirect.c Purpose: examples for vrf redirect.
 */
