...
/*
 * When JR2 is working at jr1 system mode, the OLP DSP packet hasn't entry_group field. 
 * So we couldn't support fast flush based on entry_group such as JR2 system mode. 
