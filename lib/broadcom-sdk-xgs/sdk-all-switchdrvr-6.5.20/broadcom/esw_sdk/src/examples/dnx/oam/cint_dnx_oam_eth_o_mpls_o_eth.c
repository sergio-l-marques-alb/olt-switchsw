/*
 * $Id: cint_dnx_oam_eth_o_mpls_o_eth.c.c, Exp $
 $Copyright: (c) 2020 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_oam_eth_o_mpls_o_eth.c Purpose: OAM CFMoEthoMplsoEth functions.
 */
