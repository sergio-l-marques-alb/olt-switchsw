/*
 * $Id: cint_vpls_roo_advanced.c, Exp $
 $Copyright: (c) 2020 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_vpls_roo_advanced.c Purpose: adding advanced scenarios of vpls roo
 */
