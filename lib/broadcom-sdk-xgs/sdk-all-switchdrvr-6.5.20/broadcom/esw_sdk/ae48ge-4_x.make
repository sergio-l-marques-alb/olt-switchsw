...
export TARGET_ARCHITECTURE:= arm-broadcom-linux-gnueabi
export COMPILER           = $(TOOLCHAIN_BIN_DIR)/arm-linux-
export KERNEL_PATH        = /home/olt_shared/switchdrvr/netband-libs/trunk/linux-ae48ge/linux-4.14.48
...
export KBUILD_EXTRA_SYMBOLS=$(SDK)/bin/Module.symvers

.PHONY: all clean

all:
	gmake -j10 V=1 -C $(SRC_PATH)/$(PLATFORM_NAME)
