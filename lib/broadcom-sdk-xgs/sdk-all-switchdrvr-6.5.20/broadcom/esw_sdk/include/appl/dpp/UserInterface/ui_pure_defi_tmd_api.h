/* $Id: ui_pure_defi_tmd_api.h,v 1.2 Broadcom SDK $
 * $Copyright: (c) 2020 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
*/


#ifndef __UI_PURE_DEFI_TMD_API_INCLUDED__
/* { */
#define __UI_PURE_DEFI_TMD_API_INCLUDED__
...
/*
 * Note:
 * the following definitions must range between PARAM_TMD_API_START_RANGE_ID
 * and PARAM_TMD_API_END_RANGE_ID.
 * See ui_pure_defi.h
 */
typedef enum
{
  PARAM_TMD_REGISTER_DEVICE_REGISTER_DEVICE_ID = PARAM_TMD_API_START_RANGE_ID,
  ...
  PARAM_TMD_MGMT_OPERATION_MODE_SET_OPERATION_MODE_SET_OP_MODE_REF_CLOCKS_CONF_COMBO_REF_CLK_ID,
  PARAM_TMD_MGMT_OPERATION_MODE_SET_OPERATION_MODE_SET_OP_MODE_REF_CLOCKS_CONF_FABRIC_REF_CLK_ID,
  PARAM_TMD_MGMT_OPERATION_MODE_SET_OPERATION_MODE_SET_OP_MODE_REF_CLOCKS_CONF_NIF_REF_CLK_ID,
  ...
  PARAM_TMD_PORTS_LAG_SET_LAG_SET_INFO_LAG_MEMBER_SYS_PORTS_INDEX_ID,
  ...
  PARAM_TMD_PORTS_LAG_SET_LAG_SET_INFO_NOF_ENTRIES_ID,
  ...
  PARAM_TMD_PORTS_LAG_MEMBER_ADD_LAG_MEMBER_ADD_LAG_MEMBER_SYS_PORT_INDEX_ID,
  ...
  PARAM_TMD_NIF_ON_OFF_SET_ON_OFF_SET_ID,
  PARAM_TMD_NIF_ON_OFF_SET_ON_OFF_SET_NIF_NDX_ID,
  PARAM_TMD_NIF_ON_OFF_SET_ON_OFF_SET_INFO_SERDES_ALSO_ID,
  PARAM_TMD_NIF_ON_OFF_SET_ON_OFF_SET_INFO_ON_OFF_ID,
  PARAM_TMD_NIF_ON_OFF_GET_ON_OFF_GET_ID,
  PARAM_TMD_NIF_ON_OFF_GET_ON_OFF_GET_NIF_NDX_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_SET_MAL_BASIC_CONF_SET_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_SET_MAL_BASIC_CONF_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_SET_MAL_BASIC_CONF_SET_NIF_INFO_LANES_SWAP_SWAP_TX_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_SET_MAL_BASIC_CONF_SET_NIF_INFO_LANES_SWAP_SWAP_RX_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_SET_MAL_BASIC_CONF_SET_NIF_INFO_SERDES_RATE_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_SET_MAL_BASIC_CONF_SET_NIF_INFO_TYPE_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_GET_MAL_BASIC_CONF_GET_ID,
  PARAM_TMD_NIF_MAL_BASIC_CONF_GET_MAL_BASIC_CONF_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_TOPOLOGY_VALIDATE_TOPOLOGY_VALIDATE_ID,
  PARAM_TMD_NIF_MAL_ENABLE_SET_MAL_ENABLE_SET_ID,
  PARAM_TMD_NIF_MAL_ENABLE_SET_MAL_ENABLE_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_MAL_ENABLE_SET_MAL_ENABLE_SET_IS_ENABLED_ID,
  PARAM_TMD_NIF_MAL_ENABLE_GET_MAL_ENABLE_GET_ID,
  PARAM_TMD_NIF_MAL_ENABLE_GET_MAL_ENABLE_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_IF_NDX_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_DIRECTION_NDX_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_INFO_RATE_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_INFO_IS_AUTONEG_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_INFO_MODE_ID,
  PARAM_TMD_NIF_SGMII_CONF_SET_SGMII_CONF_SET_INFO_ENABLE_ID,
  PARAM_TMD_NIF_SGMII_CONF_GET_SGMII_CONF_GET_ID,
  PARAM_TMD_NIF_SGMII_CONF_GET_SGMII_CONF_GET_IF_NDX_ID,
  PARAM_TMD_NIF_SGMII_STATUS_GET_SGMII_STATUS_GET_ID,
  PARAM_TMD_NIF_SGMII_STATUS_GET_SGMII_STATUS_GET_IF_NDX_ID,
  PARAM_TMD_NIF_SGMII_RATE_SET_SGMII_RATE_SET_ID,
  PARAM_TMD_NIF_SGMII_RATE_SET_SGMII_RATE_SET_IF_NDX_ID,
  PARAM_TMD_NIF_SGMII_RATE_SET_SGMII_RATE_SET_RATE_ID,
  PARAM_TMD_NIF_SGMII_RATE_GET_SGMII_RATE_GET_ID,
  PARAM_TMD_NIF_SGMII_RATE_GET_SGMII_RATE_GET_IF_NDX_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_DIRECTION_NDX_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_CH_CONF_IS_BURST_INTERLEAVING_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_CH_CONF_BCT_CHANNEL_BYTE_NDX_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_CH_CONF_BCT_SIZE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_CH_CONF_ENABLE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_CRC_MODE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_IPG_DIC_MODE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_IPG_SIZE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_IPG_ENABLE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_PREAMBLE_SKIP_SOP_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_PREAMBLE_SIZE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_PREAMBLE_ENABLE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_LINK_PARTNER_DOUBLE_SIZE_BUS_ID,
  PARAM_TMD_NIF_SPAUI_CONF_SET_SPAUI_CONF_SET_INFO_ENABLE_ID,
  PARAM_TMD_NIF_SPAUI_CONF_GET_SPAUI_CONF_GET_ID,
  PARAM_TMD_NIF_SPAUI_CONF_GET_SPAUI_CONF_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_TYPE_GET_TYPE_GET_ID,
  PARAM_TMD_NIF_TYPE_GET_TYPE_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_LOCAL_FAULT_OVRD_SET_LOCAL_FAULT_OVRD_SET_ID,
  PARAM_TMD_NIF_LOCAL_FAULT_OVRD_SET_LOCAL_FAULT_OVRD_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_LOCAL_FAULT_OVRD_SET_LOCAL_FAULT_OVRD_SET_IS_LF_OVRD_ID,
  PARAM_TMD_NIF_LOCAL_FAULT_OVRD_GET_LOCAL_FAULT_OVRD_GET_ID,
  PARAM_TMD_NIF_LOCAL_FAULT_OVRD_GET_LOCAL_FAULT_OVRD_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_FAT_PIPE_SET_FAT_PIPE_SET_ID,
  PARAM_TMD_NIF_FAT_PIPE_SET_FAT_PIPE_SET_INFO_BYPASS_ENABLE_ID,
  PARAM_TMD_NIF_FAT_PIPE_SET_FAT_PIPE_SET_INFO_NIFS_INDEX_ID,
  PARAM_TMD_NIF_FAT_PIPE_SET_FAT_PIPE_SET_INFO_NOF_PORTS_ID,
  PARAM_TMD_NIF_FAT_PIPE_SET_FAT_PIPE_SET_INFO_ENABLE_ID,
  PARAM_TMD_NIF_FAT_PIPE_GET_FAT_PIPE_GET_ID,
  PARAM_TMD_NIF_MDIO22_WRITE_MDIO22_WRITE_ID,
  PARAM_TMD_NIF_MDIO22_WRITE_MDIO22_WRITE_PHY_ADDR_ID,
  PARAM_TMD_NIF_MDIO22_WRITE_MDIO22_WRITE_REG_ADDR_ID,
  PARAM_TMD_NIF_MDIO22_WRITE_MDIO22_WRITE_SIZE_IN_WORDS_ID,
  PARAM_TMD_NIF_MDIO22_WRITE_MDIO22_WRITE_DATA_ID,
  PARAM_TMD_NIF_MDIO22_READ_MDIO22_READ_ID,
  PARAM_TMD_NIF_MDIO22_READ_MDIO22_READ_PHY_ADDR_ID,
  PARAM_TMD_NIF_MDIO22_READ_MDIO22_READ_REG_ADDR_ID,
  PARAM_TMD_NIF_MDIO22_READ_MDIO22_READ_SIZE_IN_WORDS_ID,
  PARAM_TMD_NIF_MDIO45_WRITE_MDIO45_WRITE_ID,
  PARAM_TMD_NIF_MDIO45_WRITE_MDIO45_WRITE_PORT_ADDR_ID,
  PARAM_TMD_NIF_MDIO45_WRITE_MDIO45_WRITE_DEV_ADDR_ID,
  PARAM_TMD_NIF_MDIO45_WRITE_MDIO45_WRITE_REG_ADDR_ID,
  PARAM_TMD_NIF_MDIO45_WRITE_MDIO45_WRITE_SIZE_IN_WORDS_ID,
  PARAM_TMD_NIF_MDIO45_WRITE_MDIO45_WRITE_DATA_ID,
  PARAM_TMD_NIF_MDIO45_READ_MDIO45_READ_ID,
  PARAM_TMD_NIF_MDIO45_READ_MDIO45_READ_PORT_ADDR_ID,
  PARAM_TMD_NIF_MDIO45_READ_MDIO45_READ_DEV_ADDR_ID,
  PARAM_TMD_NIF_MDIO45_READ_MDIO45_READ_REG_ADDR_ID,
  PARAM_TMD_NIF_MDIO45_READ_MDIO45_READ_SIZE_IN_WORDS_ID,
  PARAM_TMD_NIF_MIN_PACKET_SIZE_SET_MIN_PACKET_SIZE_SET_ID,
  PARAM_TMD_NIF_MIN_PACKET_SIZE_SET_MIN_PACKET_SIZE_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_MIN_PACKET_SIZE_SET_MIN_PACKET_SIZE_SET_DIRECTION_NDX_ID,
  PARAM_TMD_NIF_MIN_PACKET_SIZE_SET_MIN_PACKET_SIZE_SET_PCKT_SIZE_ID,
  PARAM_TMD_NIF_MIN_PACKET_SIZE_GET_MIN_PACKET_SIZE_GET_ID,
  PARAM_TMD_NIF_MIN_PACKET_SIZE_GET_MIN_PACKET_SIZE_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_SET_PAUSE_QUANTA_SET_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_SET_PAUSE_QUANTA_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_SET_PAUSE_QUANTA_SET_DIRECTION_NDX_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_SET_PAUSE_QUANTA_SET_PAUSE_QUANTA_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_GET_PAUSE_QUANTA_GET_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_GET_PAUSE_QUANTA_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_PAUSE_QUANTA_GET_PAUSE_QUANTA_GET_DIRECTION_NDX_ID,
  PARAM_TMD_NIF_PAUSE_FRAME_SRC_ADDR_SET_PAUSE_FRAME_SRC_ADDR_SET_ID,
  PARAM_TMD_NIF_PAUSE_FRAME_SRC_ADDR_SET_PAUSE_FRAME_SRC_ADDR_SET_MAL_NDX_ID,
  PARAM_TMD_NIF_PAUSE_FRAME_SRC_ADDR_SET_PAUSE_FRAME_SRC_ADDR_SET_MAC_ADDR_ID,
  PARAM_TMD_NIF_PAUSE_FRAME_SRC_ADDR_GET_PAUSE_FRAME_SRC_ADDR_GET_ID,
  PARAM_TMD_NIF_PAUSE_FRAME_SRC_ADDR_GET_PAUSE_FRAME_SRC_ADDR_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_NIF_NDX_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_INFO_TX_ON_IF_CLEARED_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_INFO_TX_CB_ENABLE_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_INFO_TX_LL_MODE_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_INFO_RX_TREAT_LL_CLASS_BASED_ID,
  PARAM_TMD_NIF_FC_SET_FC_SET_INFO_RX_LL_MODE_ID,
  PARAM_TMD_NIF_FC_GET_FC_GET_ID,
  PARAM_TMD_NIF_FC_GET_FC_GET_NIF_NDX_ID,
  PARAM_TMD_NIF_LOOPBACK_SET_LOOPBACK_SET_ID,
  PARAM_TMD_NIF_LOOPBACK_SET_LOOPBACK_SET_NIF_NDX_ID,
  PARAM_TMD_NIF_LOOPBACK_SET_LOOPBACK_SET_ENABLE_ID,
  PARAM_TMD_NIF_LOOPBACK_GET_LOOPBACK_GET_ID,
  PARAM_TMD_NIF_LOOPBACK_GET_LOOPBACK_GET_NIF_NDX_ID,
  PARAM_TMD_API_NIF_ID,
  PARAM_TMD_NIF_GLOBAL_STATUS_GET_NIF_GLOBAL_STATUS_GET_ID,
  PARAM_TMD_NIF_GLOBAL_STATUS_GET_NIF_GLOBAL_STATUS_GET_STATUS_ID,
  PARAM_TMD_NIF_DIAG_LAST_PACKET_GET_NIF_DIAG_LAST_PACKET_GET_ID,
  PARAM_TMD_CPU_IF_PORT_CONF_SET_CPU_IF_PORT_CONF_SET_ID,
  PARAM_TMD_CPU_IF_PORT_CONF_SET_CPU_IF_PORT_CONF_SET_CONF_TBD_ID,
  PARAM_TMD_CPU_IF_PORT_CONF_GET_CPU_IF_PORT_CONF_GET_ID,
  PARAM_TMD_CPU_IF_STREAMING_CONF_SET_CPU_IF_STREAMING_CONF_SET_ID,
  PARAM_TMD_CPU_IF_STREAMING_CONF_SET_CPU_IF_STREAMING_CONF_SET_CONF_TBD_ID,
  PARAM_TMD_CPU_IF_STREAMING_CONF_GET_CPU_IF_STREAMING_CONF_GET_ID,
  PARAM_TMD_CPU_IF_STREAMING_STATUS_GET_CPU_IF_STREAMING_STATUS_GET_ID,
  PARAM_TMD_MIRROR_INGRESS_PORT_SET_MIRROR_INGRESS_PORT_SET_ID,
  PARAM_TMD_MIRROR_INGRESS_PORT_SET_MIRROR_INGRESS_PORT_SET_IN_PORT_NDX_ID,
  PARAM_TMD_MIRROR_INGRESS_PORT_SET_MIRROR_INGRESS_PORT_SET_CONF_DESTINATION_ID,
  PARAM_TMD_MIRROR_INGRESS_PORT_SET_MIRROR_INGRESS_PORT_SET_CONF_ENABLE_ID,
  PARAM_TMD_MIRROR_INGRESS_PORT_GET_MIRROR_INGRESS_PORT_GET_ID,
  PARAM_TMD_MIRROR_INGRESS_PORT_GET_MIRROR_INGRESS_PORT_GET_IN_PORT_NDX_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_SET_MIRROR_EGRESS_PORT_SET_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_SET_MIRROR_EGRESS_PORT_SET_OUT_PORT_NDX_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_SET_MIRROR_EGRESS_PORT_SET_CONF_MIRROR_ONLY_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_SET_MIRROR_EGRESS_PORT_SET_CONF_DESTINATION_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_SET_MIRROR_EGRESS_PORT_SET_CONF_ENABLE_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_GET_MIRROR_EGRESS_PORT_GET_ID,
  PARAM_TMD_MIRROR_EGRESS_PORT_GET_MIRROR_EGRESS_PORT_GET_OUT_PORT_NDX_ID,
  PARAM_TMD_API_DIAGNOSTICS_ID,
  ...
  PARAM_TMD_ITM_DRAM_BUFFS_GET_ITM_DRAM_BUFFS_GET_DRAM_BUFFS_MINI_MC_NOF_BUFFS_ID,
  PARAM_TMD_ITM_DRAM_BUFFS_GET_ITM_DRAM_BUFFS_GET_DRAM_BUFFS_FULL_MC_NOF_BUFFS_ID,
  PARAM_TMD_ITM_DRAM_BUFFS_GET_ITM_DRAM_BUFFS_GET_DRAM_BUFFS_UC_NOF_BUFFS_ID,
  PARAM_TMD_ITM_DRAM_BUFFS_GET_ITM_DRAM_BUFFS_GET_DRAM_BUFFS_DBUFF_SIZE_ID,
  ...
  PARAM_TMD_ITM_CATEGORY_RNGS_SET_ITM_CATEGORY_RNGS_SET_INFO_VSQ_CTGRY2_END_ID,
  PARAM_TMD_ITM_CATEGORY_RNGS_SET_ITM_CATEGORY_RNGS_SET_INFO_VSQ_CTGRY1_END_ID,
  PARAM_TMD_ITM_CATEGORY_RNGS_SET_ITM_CATEGORY_RNGS_SET_INFO_VSQ_CTGRY0_END_ID,
  PARAM_TMD_ITM_CATEGORY_RNGS_GET_ITM_CATEGORY_RNGS_GET_ID,
  PARAM_TMD_ITM_ADMIT_TEST_TMPLT_SET_ITM_ADMIT_TEST_TMPLT_SET_ID,
  ...
  PARAM_TMD_ITM_VSQ_COUNTER_GET_ITM_VSQ_COUNTER_GET_VSQ_GROUP_NDX_ID,
  PARAM_TMD_ITM_VSQ_COUNTER_GET_ITM_VSQ_COUNTER_GET_VSQ_IN_GROUP_NDX_ID,
  ...
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_RT_CLS_NDX_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_SYS_RED_DP_NDX_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_INFO_DRP_PROB_HIGH_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_INFO_DRP_PROB_LOW_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_INFO_DRP_TH_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_INFO_PROB_TH_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_INFO_ADM_TH_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_SET_ITM_SYS_RED_Q_BASED_SET_INFO_ENABLE_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_GET_ITM_SYS_RED_Q_BASED_GET_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_GET_ITM_SYS_RED_Q_BASED_GET_RT_CLS_NDX_ID,
  PARAM_TMD_ITM_SYS_RED_Q_BASED_GET_ITM_SYS_RED_Q_BASED_GET_SYS_RED_DP_NDX_ID,
  ...
  PARAM_TMD_EGR_MCI_FC_SET_EGR_MCI_FC_SET_THRESH_ENABLE_MODE_ID,
  ...
  PARAM_TMD_OFP_RATES_SET_SET_OFP_RATE_TBL_RATES_PORT_ID_ID,
  PARAM_TMD_OFP_RATES_SET_SET_OFP_RATE_TBL_NOF_VALID_ENTRIES_ID,
  ...
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_SHAPER_EGQ_SHAPER_RATE_ID,
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_SHAPER_EGQ_SHAPER_RATE_UPDATE_MODE_ID,
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_SHAPER_SCH_SHAPER_RATE_ID,
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_SHAPER_SCH_SHAPER_RATE_UPDATE_MODE_ID,
  ...
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_OFP_RATE_PORT_ID_ID,
  ...
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_SE_TYPE_INFO_FQ_NO_INFO_ID,
  ...
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_SE_TYPE_ID,
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_SE_STATE_ID,
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_SE_ID_ID,
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_FLOW_IS_SLOW_ENABLED_ID,
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_FLOW_FLOW_TYPE_ID,
  ...
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  ...
  PARAM_TMD_SCH_AGGREGATE_SET_SCH_AGGREGATE_SET_FLOW_SUB_FLOW_ID_ID,
  ...
  PARAM_TMD_SCH_FLOW_SET_SCH_FLOW_SET_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  ...
  PARAM_TMD_SCH_FLOW_SET_SCH_FLOW_SET_FLOW_SUB_FLOW_ID_ID,
  ...
  PARAM_TMD_SCH_FLOW_DELETE_SCH_FLOW_DELETE_ID,
  PARAM_TMD_SCH_FLOW_DELETE_SCH_FLOW_DELETE_FLOW_NDX_ID,
  ...
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_AGG_BASE_ID_FQ_MAX_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_AGG_BASE_ID_FQ_MIN_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_AGG_BASE_ID_CL_MAX_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_AGG_BASE_ID_CL_MIN_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_AGG_BASE_ID_HR_MAX_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_AGG_BASE_ID_HR_MIN_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_NOF_TRAFFIC_CLASSES_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_RCY_PORT_ID_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_NOF_CPU_PORTS_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_MAX_NOF_PORTS_PER_FAP_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_SAVE_AQFM_SYSTEM_INFO_SAVE_P_INFO_MAX_NOF_FAPS_IN_SYSTEM_ID,
  PARAM_TMD_AQFM_SYSTEM_INFO_DEFAULTS_GET_AQFM_SYSTEM_INFO_DEFAULTS_GET_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_PORT_INFO_LOWEST_HP_CLASS_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_PORT_INFO_HR_MODE_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_PORT_INFO_MAX_EXPECTED_RATE_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_PORT_INFO_ENABLE_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_EG_PORT_MAX_BURST_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_EG_PORT_EGQ_RATE_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_EG_PORT_SCH_RATE_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_EG_PORT_PORT_ID_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_ID_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_PORT_INFO_LOWEST_HP_CLASS_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_PORT_INFO_HR_MODE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_PORT_INFO_MAX_EXPECTED_RATE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_PORT_INFO_ENABLE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_EG_PORT_MAX_BURST_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_EG_PORT_EGQ_RATE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_EG_PORT_SCH_RATE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_EG_PORT_PORT_ID_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_PORT_ID_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_PORT_INFO_LOWEST_HP_CLASS_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_PORT_INFO_HR_MODE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_PORT_INFO_MAX_EXPECTED_RATE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_PORT_INFO_ENABLE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_EG_PORT_MAX_BURST_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_EG_PORT_EGQ_RATE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_EG_PORT_SCH_RATE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_EG_PORT_PORT_ID_ID,
  PARAM_TMD_AQFM_PORT_CLOSE_AQFM_PORT_CLOSE_ID,
  PARAM_TMD_AQFM_PORT_CLOSE_AQFM_PORT_CLOSE_PORT_ID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_INDEX_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_VALID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_FLOW_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_GROUP_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_IS_DUAL_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_TYPE_INFO_FQ_NO_INFO_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_TYPE_INFO_CL_ID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_TYPE_INFO_HR_MODE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_TYPE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_STATE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_SE_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_CLOSE_AQFM_AGG_PORT_AGGS_CLOSE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_CLOSE_AQFM_AGG_PORT_AGGS_CLOSE_PORT_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_PORT_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_VALID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_GROUP_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_IS_DUAL_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_INFO_FQ_NO_INFO_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_INFO_CL_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_INFO_HR_MODE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_STATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_SE_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_FLOWS_INFO_FLOWS_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_PORT_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGG_LEVEL_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGG_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_VALID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_FLOW_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_GROUP_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_IS_DUAL_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_INFO_FQ_NO_INFO_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_INFO_CL_ID_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_INFO_HR_MODE_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_TYPE_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_STATE_ID,
  PARAM_TMD_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AQFM_AGG_PORT_SINGLE_AGGS_UPDATE_AGGS_INFO_ITEM_SE_ID_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_INDEX_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_SIGNATURE_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_VSQ_TRAFFIC_CLS_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_VSQ_CONNECTION_CLS_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_RATE_CLS_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_CREDIT_CLS_ID,
  PARAM_TMD_AQFM_ALL_QUEUES_OPEN_AQFM_ALL_QUEUES_OPEN_P_INFO_QUEUES_CR_REQ_TYPE_NDX_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_DESTINATION_FAP_ID_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_DESTINATION_PORT_ID_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_INDEX_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_SIGNATURE_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_VSQ_TRAFFIC_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_VSQ_CONNECTION_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_RATE_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_CREDIT_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_OPEN_AQFM_QUEUES_OPEN_AUTO_QUEUE_INFO_QUEUES_CR_REQ_TYPE_NDX_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_DESTINATION_FAP_ID_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_DESTINATION_PORT_ID_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_INDEX_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_SIGNATURE_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_VSQ_TRAFFIC_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_VSQ_CONNECTION_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_RATE_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_CREDIT_CLS_ID,
  PARAM_TMD_AQFM_QUEUES_UPDATE_AQFM_QUEUES_UPDATE_QUEUES_INFO_QUEUES_CR_REQ_TYPE_NDX_ID,
  PARAM_TMD_AQFM_QUEUES_CLOSE_AQFM_QUEUES_CLOSE_ID,
  PARAM_TMD_AQFM_QUEUES_CLOSE_AQFM_QUEUES_CLOSE_DESTINATION_FAP_ID_ID,
  PARAM_TMD_AQFM_QUEUES_CLOSE_AQFM_QUEUES_CLOSE_DESTINATION_PORT_ID_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_INDEX_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_ALL_FLOWS_OPEN_AQFM_ALL_FLOWS_OPEN_P_INFO_FLOWS_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_PORT_ID_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_INDEX_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_FLOW_OPEN_AQFM_FLOW_OPEN_FLOW_INFO_FLOWS_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_PORT_ID_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_INDEX_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_IS_SLOW_ENABLED_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_FLOW_TYPE_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_INDEX_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_ID_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_FQ_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_WEIGHT_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_CL_SP_CLASS_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_WEIGHT_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_CREDIT_SOURCE_SE_INFO_HR_SP_CLASS_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_SLOW_RATE_NDX_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_BURST_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_SHAPER_MAX_RATE_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_ID_ID,
  PARAM_TMD_AQFM_FLOW_UPDATE_AQFM_FLOW_UPDATE_FLOW_INFO_FLOWS_SUB_FLOW_IS_VALID_ID,
  PARAM_TMD_AQFM_FLOW_CLOSE_AQFM_FLOW_CLOSE_ID,
  PARAM_TMD_AQFM_FLOW_CLOSE_AQFM_FLOW_CLOSE_PORT_ID_ID,
  PARAM_TMD_API_AUTO_QUEUE_FLOW_MGMT_ID,
  ...
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_UP_TO_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_MC_GROUP_OUTLIF_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_MC_GROUP_DESTINATION_ID_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_MC_GROUP_DESTINATION_TYPE_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_MC_GROUP_UP_TO_OUTLIF_ID,
  PARAM_TMD_MULT_ING_GROUP_OPEN_MULT_ING_GROUP_OPEN_MC_GROUP_UP_TO_DESTINATION_ID_ID,
  ...
  PARAM_TMD_MULT_ING_GROUP_GET_MULT_ING_GROUP_GET_ID,
  PARAM_TMD_MULT_ING_GROUP_GET_MULT_ING_GROUP_GET_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_ING_GROUP_GET_MULT_ING_GROUP_GET_UP_TO_MULTICAST_ID_NDX_ID,
  ...
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_ID,
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_UP_TO_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_MC_GROUP_OUTLIF_ID,
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_MC_GROUP_PORT_ID,
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_MC_GROUP_UP_TO_OUTLIF_ID,
  PARAM_TMD_MULT_EG_GROUP_OPEN_MULT_EG_GROUP_OPEN_MC_GROUP_UP_TO_PORT_ID,
  PARAM_TMD_MULT_EG_GROUP_UPDATE_MULT_EG_GROUP_UPDATE_ID,
  PARAM_TMD_MULT_EG_GROUP_UPDATE_MULT_EG_GROUP_UPDATE_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_EG_GROUP_UPDATE_MULT_EG_GROUP_UPDATE_MC_GROUP_OUTLIF_ID,
  PARAM_TMD_MULT_EG_GROUP_UPDATE_MULT_EG_GROUP_UPDATE_MC_GROUP_PORT_ID,
  PARAM_TMD_MULT_EG_GROUP_UPDATE_MULT_EG_GROUP_UPDATE_MC_GROUP_SIZE_ID,
  ...
  PARAM_TMD_MULT_EG_GROUP_GET_MULT_EG_GROUP_GET_ID,
  PARAM_TMD_MULT_EG_GROUP_GET_MULT_EG_GROUP_GET_MULTICAST_ID_NDX_ID,
  PARAM_TMD_MULT_EG_GROUP_GET_MULT_EG_GROUP_GET_UP_TO_MULTICAST_ID_NDX_ID,
  ...
  PARAM_TMD_MULT_FABRIC_CREDIT_SOURCE_SET_MULT_FABRIC_CREDIT_SOURCE_SET_INFO_BEST_EFFORT_BE_SCH_PORT_INDEX_ID,
  PARAM_TMD_MULT_FABRIC_CREDIT_SOURCE_SET_MULT_FABRIC_CREDIT_SOURCE_SET_INFO_BEST_EFFORT_BE_SCH_PORT_WEIGHT_ID,
  PARAM_TMD_MULT_FABRIC_CREDIT_SOURCE_SET_MULT_FABRIC_CREDIT_SOURCE_SET_INFO_BEST_EFFORT_BE_SCH_PORT_BE_SCH_PORT_MULTICAST_CLASS_VALID_ID,
  PARAM_TMD_MULT_FABRIC_CREDIT_SOURCE_SET_MULT_FABRIC_CREDIT_SOURCE_SET_INFO_BEST_EFFORT_BE_SCH_PORT_BE_SCH_PORT_MCAST_CLASS_PORT_ID_ID,
  ...
  PARAM_TMD_MULT_FABRIC_CREDIT_SOURCE_SET_MULT_FABRIC_CREDIT_SOURCE_SET_INFO_GUARANTEED_GR_SCH_PORT_MULTICAST_CLASS_VALID_ID,
  PARAM_TMD_MULT_FABRIC_CREDIT_SOURCE_SET_MULT_FABRIC_CREDIT_SOURCE_SET_INFO_GUARANTEED_GR_SCH_PORT_MCAST_CLASS_PORT_ID_ID,
  ...
  PARAM_TMD_DRAM_WINDOW_VALIDITY_GET_WINDOW_VALIDITY_GET_ID,
  PARAM_TMD_DRAM_WINDOW_VALIDITY_GET_WINDOW_VALIDITY_GET_DRAM_NDX_ID,
  PARAM_TMD_DRAM_WINDOW_VALIDITY_GET_WINDOW_VALIDITY_GET_PATTERN_DATA_INDEX_ID,
  PARAM_TMD_DRAM_WINDOW_VALIDITY_GET_WINDOW_VALIDITY_GET_PATTERN_DATA_ID,
  PARAM_TMD_DRAM_WINDOW_VALIDITY_GET_WINDOW_VALIDITY_GET_PATTERN_MODE_ID,
  PARAM_TMD_SRD_RATE_SET_SRD_RATE_SET_ID,
  PARAM_TMD_SRD_RATE_SET_SRD_RATE_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_RATE_SET_SRD_RATE_SET_RATE_ID,
  PARAM_TMD_SRD_RATE_GET_SRD_RATE_GET_ID,
  PARAM_TMD_SRD_RATE_GET_SRD_RATE_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_EXPLICIT_SRD_TX_PHYS_PARAMS_SET_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_INTERNAL_SRD_TX_PHYS_PARAMS_SET_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_MEDIA_TYPE_SRD_TX_PHYS_PARAMS_SET_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_ATTEN_SRD_TX_PHYS_PARAMS_SET_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_ATTEN_SRD_TX_PHYS_PARAMS_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_EXPLICIT_SRD_TX_PHYS_PARAMS_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_INTERNAL_SRD_TX_PHYS_PARAMS_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_MEDIA_TYPE_SRD_TX_PHYS_PARAMS_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_MEDIA_TYPE_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_MEDIA_TYPE_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_EXPLCT_POST_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_EXPLCT_PRE_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_EXPLCT_SWING_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_ATTEN_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_INTERNAL_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_INTERN_POST_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_INTERNAL_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_INTERN_PRE_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_INTERNAL_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_INTERN_MAIN_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_SET_INTERNAL_SRD_TX_PHYS_PARAMS_SET_INFO_CONF_INTERN_AMP_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_GET_SRD_TX_PHYS_PARAMS_GET_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_GET_SRD_TX_PHYS_PARAMS_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_TX_PHYS_PARAMS_GET_SRD_TX_PHYS_PARAMS_GET_CONF_MODE_NDX_ID,
  PARAM_TMD_SRD_LANE_POLARITY_SET_SRD_LANE_POLARITY_SET_ID,
  PARAM_TMD_SRD_LANE_POLARITY_SET_SRD_LANE_POLARITY_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_LANE_POLARITY_SET_SRD_LANE_POLARITY_SET_DIRECTION_NDX_ID,
  PARAM_TMD_SRD_LANE_POLARITY_SET_SRD_LANE_POLARITY_SET_IS_SWAP_POLARITY_ID,
  PARAM_TMD_SRD_LANE_POLARITY_GET_SRD_LANE_POLARITY_GET_ID,
  PARAM_TMD_SRD_LANE_POLARITY_GET_SRD_LANE_POLARITY_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_LANE_POWER_STATE_SET_SRD_LANE_POWER_STATE_SET_ID,
  PARAM_TMD_SRD_LANE_POWER_STATE_SET_SRD_LANE_POWER_STATE_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_LANE_POWER_STATE_SET_SRD_LANE_POWER_STATE_SET_DIRECTION_NDX_ID,
  PARAM_TMD_SRD_LANE_POWER_STATE_SET_SRD_LANE_POWER_STATE_SET_STATE_ID,
  PARAM_TMD_SRD_LANE_POWER_STATE_GET_SRD_LANE_POWER_STATE_GET_ID,
  PARAM_TMD_SRD_LANE_POWER_STATE_GET_SRD_LANE_POWER_STATE_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_STAR_SET_SRD_STAR_SET_ID,
  PARAM_TMD_SRD_STAR_SET_SRD_STAR_SET_STAR_NDX_ID,
  PARAM_TMD_SRD_STAR_SET_SRD_STAR_SET_INFO_QRTT_INDEX_ID,
  PARAM_TMD_SRD_STAR_SET_SRD_STAR_SET_INFO_QRTT_MAX_EXPECTED_LANE_RATE_ID,
  PARAM_TMD_SRD_STAR_SET_SRD_STAR_SET_INFO_QRTT_IS_ACTIVE_ID,
  PARAM_TMD_SRD_STAR_GET_SRD_STAR_GET_ID,
  PARAM_TMD_SRD_STAR_GET_SRD_STAR_GET_STAR_NDX_ID,
  PARAM_TMD_SRD_QRTT_RESET_SRD_QRTT_RESET_ID,
  PARAM_TMD_SRD_QRTT_RESET_SRD_QRTT_RESET_QRTT_NDX_ID,
  PARAM_TMD_SRD_QRTT_RESET_SRD_QRTT_RESET_IS_ACTIVE_ID,
  PARAM_TMD_SRD_QRTT_SET_SRD_QRTT_SET_ID,
  PARAM_TMD_SRD_QRTT_SET_SRD_QRTT_SET_QRTT_NDX_ID,
  PARAM_TMD_SRD_QRTT_SET_SRD_QRTT_SET_INFO_MAX_EXPECTED_LANE_RATE_ID,
  PARAM_TMD_SRD_QRTT_SET_SRD_QRTT_SET_INFO_IS_ACTIVE_ID,
  PARAM_TMD_SRD_QRTT_GET_SRD_QRTT_GET_ID,
  PARAM_TMD_SRD_QRTT_GET_SRD_QRTT_GET_QRTT_NDX_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_INDEX_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_IS_SWAP_POLARITY_RX_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_IS_SWAP_POLARITY_TX_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_POWER_STATE_CONF_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_RX_PHYS_CONF_INTERN_G1CNT_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_RX_PHYS_CONF_INTERN_TLTH_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_RX_PHYS_CONF_INTERN_DFELTH_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_RX_PHYS_CONF_INTERN_Z1CNT_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_RX_PHYS_CONF_INTERN_ZCNT_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_MODE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_MEDIA_TYPE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_ATTEN_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_EXPLCT_SWING_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_EXPLCT_POST_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_EXPLCT_PRE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_INTERN_POST_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_INTERN_PRE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_INTERN_MAIN_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_TX_PHYS_CONF_CONF_INTERN_AMP_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_RATE_CONF_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_LANE_CONF_ENABLE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_STAR_CONF_INDEX_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_STAR_CONF_CONF_QRTT_INDEX_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_STAR_CONF_CONF_QRTT_MAX_EXPECTED_LANE_RATE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_STAR_CONF_CONF_QRTT_IS_ACTIVE_ID,
  PARAM_TMD_SRD_ALL_SET_SRD_ALL_SET_INFO_STAR_CONF_ENABLE_ID,
  PARAM_TMD_SRD_ALL_GET_SRD_ALL_GET_ID,
  PARAM_TMD_SRD_AUTO_EQUALIZE_SRD_AUTO_EQUALIZE_ID,
  PARAM_TMD_SRD_AUTO_EQUALIZE_SRD_AUTO_EQUALIZE_LANE_NDX_ID,
  PARAM_TMD_SRD_AUTO_EQUALIZE_SRD_AUTO_EQUALIZE_MODE_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_INFO_G1CNT_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_INFO_TLTH_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_INFO_DFELTH_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_INFO_Z1CNT_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_SET_SRD_RX_PHYS_PARAMS_SET_INFO_ZCNT_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_GET_SRD_RX_PHYS_PARAMS_GET_ID,
  PARAM_TMD_SRD_RX_PHYS_PARAMS_GET_SRD_RX_PHYS_PARAMS_GET_LANE_NDX_ID,
  PARAM_TMD_API_SERDES_ID,
  PARAM_TMD_SRD_REG_WRITE_SRD_REG_WRITE_ID,
  PARAM_TMD_SRD_REG_WRITE_SRD_REG_WRITE_ENTITY_ID,
  PARAM_TMD_SRD_REG_WRITE_SRD_REG_WRITE_ENTITY_NDX_ID,
  PARAM_TMD_SRD_REG_WRITE_SRD_REG_WRITE_REG_OFFSET_ID,
  PARAM_TMD_SRD_REG_WRITE_SRD_REG_WRITE_REG_ELEMENT_ID,
  PARAM_TMD_SRD_REG_WRITE_SRD_REG_WRITE_VAL_ID,
  PARAM_TMD_SRD_REG_READ_SRD_REG_READ_ID,
  PARAM_TMD_SRD_REG_READ_SRD_REG_READ_ENTITY_ID,
  PARAM_TMD_SRD_REG_READ_SRD_REG_READ_ENTITY_NDX_ID,
  PARAM_TMD_SRD_REG_READ_SRD_REG_READ_REG_OFFSET_ID,
  PARAM_TMD_SRD_REG_READ_SRD_REG_READ_REG_ELEMENT_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_ENTITY_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_ENTITY_NDX_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_FLD_LSB_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_FLD_MSB_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_FLD_ADDR_OFFSET_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_FLD_ADDR_ELEMENT_ID,
  PARAM_TMD_SRD_FLD_WRITE_SRD_FLD_WRITE_VAL_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_ENTITY_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_ENTITY_NDX_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_FLD_LSB_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_FLD_MSB_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_FLD_ADDR_OFFSET_ID,
  PARAM_TMD_SRD_FLD_READ_SRD_FLD_READ_FLD_ADDR_ELEMENT_ID,
  PARAM_TMD_SRD_LINK_RX_EYE_MONITOR_SRD_LINK_RX_EYE_MONITOR_ID,
  PARAM_TMD_SRD_LINK_RX_EYE_MONITOR_SRD_LINK_RX_EYE_MONITOR_LANE_NDX_ID,
  PARAM_TMD_SRD_LINK_RX_EYE_MONITOR_SRD_LINK_RX_EYE_MONITOR_EQUALIZER_MODE_ID,
  PARAM_TMD_SRD_LANE_LOOPBACK_MODE_SET_SRD_LANE_LOOPBACK_MODE_SET_ID,
  PARAM_TMD_SRD_LANE_LOOPBACK_MODE_SET_SRD_LANE_LOOPBACK_MODE_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_LANE_LOOPBACK_MODE_SET_SRD_LANE_LOOPBACK_MODE_SET_LOOPBACK_MODE_ID,
  PARAM_TMD_SRD_LANE_LOOPBACK_MODE_GET_SRD_LANE_LOOPBACK_MODE_GET_ID,
  PARAM_TMD_SRD_LANE_LOOPBACK_MODE_GET_SRD_LANE_LOOPBACK_MODE_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_PRBS_MODE_SET_SRD_PRBS_MODE_SET_ID,
  PARAM_TMD_SRD_PRBS_MODE_SET_SRD_PRBS_MODE_SET_LANE_NDX_ID,
  PARAM_TMD_SRD_PRBS_MODE_SET_SRD_PRBS_MODE_SET_DIRECTION_NDX_ID,
  PARAM_TMD_SRD_PRBS_MODE_SET_SRD_PRBS_MODE_SET_MODE_ID,
  PARAM_TMD_SRD_PRBS_MODE_GET_SRD_PRBS_MODE_GET_ID,
  PARAM_TMD_SRD_PRBS_MODE_GET_SRD_PRBS_MODE_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_PRBS_START_SRD_PRBS_START_ID,
  PARAM_TMD_SRD_PRBS_START_SRD_PRBS_START_LANE_NDX_ID,
  PARAM_TMD_SRD_PRBS_START_SRD_PRBS_START_DIRECTION_NDX_ID,
  PARAM_TMD_SRD_PRBS_STOP_SRD_PRBS_STOP_ID,
  PARAM_TMD_SRD_PRBS_STOP_SRD_PRBS_STOP_LANE_NDX_ID,
  PARAM_TMD_SRD_PRBS_STOP_SRD_PRBS_STOP_DIRECTION_NDX_ID,
  PARAM_TMD_SRD_PRBS_GET_AND_CLEAR_STAT_SRD_PRBS_GET_AND_CLEAR_STAT_ID,
  PARAM_TMD_SRD_PRBS_GET_AND_CLEAR_STAT_SRD_PRBS_GET_AND_CLEAR_STAT_LANE_NDX_ID,
  PARAM_TMD_SRD_LANE_STATUS_GET_SRD_LANE_STATUS_GET_ID,
  PARAM_TMD_SRD_LANE_STATUS_GET_SRD_LANE_STATUS_GET_LANE_NDX_ID,
  PARAM_TMD_SRD_QRTT_STATUS_GET_SRD_QRTT_STATUS_GET_ID,
  PARAM_TMD_SRD_QRTT_STATUS_GET_SRD_QRTT_STATUS_GET_QRTT_ID_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_EYE_SCAN_RUN_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_EYE_SCAN_RUN_INFO_RESOLUTION_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_EYE_SCAN_RUN_INFO_PRBS_DURATION_MIN_SEC_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_EYE_SCAN_RUN_INFO_LANE_NDX_INDEX_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_EYE_SCAN_RUN_INFO_LANE_NDX_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_EYE_SCAN_RUN_INFO_NOF_LANE_NDX_ENTRIES_ID,
  PARAM_TMD_SRD_EYE_SCAN_RUN_SRD_USE_LINK_CRC_NO_PRBS_ID,
  PARAM_TMD_SRD_SCIF_ENABLE_SET_SRD_SCIF_ENABLE_SET_ID,
  PARAM_TMD_SRD_SCIF_ENABLE_SET_SRD_SCIF_ENABLE_SET_IS_ENABLED_ID,
  PARAM_TMD_SRD_SCIF_ENABLE_GET_SRD_SCIF_ENABLE_GET_ID,
  PARAM_TMD_SRD_RELOCK_SRD_RELOCK_ID,
  PARAM_TMD_SRD_RELOCK_SRD_RELOCK_LANE_NDX_ID,
  PARAM_TMD_API_SERDES_UTILS_ID,
  ...
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_INDEX_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_IS_SENDING_TRAFFIC_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_IS_PHY_CONNECT_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_IS_CONNECTED_EXPECTED_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_FAR_LINK_ID_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_FAR_DEV_TYPE_ID,
  PARAM_TMD_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_TOPOLOGY_STATUS_CONNECTIVITY_PRINT_CONNECTIVITY_MAP_LINK_INFO_FAR_DEVICE_ID_ID,
  ...
  PARAM_TMD_FC_INGR_GEN_VSQ_VIA_NIF_SET_FC_INGR_GEN_VSQ_VIA_NIF_SET_ID,
  PARAM_TMD_FC_INGR_GEN_VSQ_VIA_NIF_SET_FC_INGR_GEN_VSQ_VIA_NIF_SET_NIF_NDX_ID,
  PARAM_TMD_FC_INGR_GEN_VSQ_VIA_NIF_SET_FC_INGR_GEN_VSQ_VIA_NIF_SET_INFO_CB_ENABLE_STATE_ID,
  PARAM_TMD_FC_INGR_GEN_VSQ_VIA_NIF_SET_FC_INGR_GEN_VSQ_VIA_NIF_SET_INFO_LL_ENABLE_STATE_ID,
  PARAM_TMD_FC_INGR_GEN_VSQ_VIA_NIF_GET_FC_INGR_GEN_VSQ_VIA_NIF_GET_ID,
  PARAM_TMD_FC_INGR_GEN_VSQ_VIA_NIF_GET_FC_INGR_GEN_VSQ_VIA_NIF_GET_NIF_NDX_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_HP_VIA_NIF_SET_FC_INGR_GEN_GLB_HP_VIA_NIF_SET_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_HP_VIA_NIF_SET_FC_INGR_GEN_GLB_HP_VIA_NIF_SET_FC_MODE_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_HP_VIA_NIF_GET_FC_INGR_GEN_GLB_HP_VIA_NIF_GET_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_NIF_NDX_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_CLS_NDX_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_INFO_CLASS_AND_BELOW_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_SET_INFO_ENABLE_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_GET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_GET_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_GET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_GET_NIF_NDX_ID,
  PARAM_TMD_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_GET_FC_INGR_GEN_GLB_LP_VIA_NIF_CB_GET_CLS_NDX_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_SET_FC_INGR_GEN_OOB_SET_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_SET_FC_INGR_GEN_OOB_SET_OOB_CONF_CAL_REPS_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_SET_FC_INGR_GEN_OOB_SET_OOB_CONF_CAL_LEN_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_SET_FC_INGR_GEN_OOB_SET_OOB_CONF_ENABLE_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_SET_FC_INGR_GEN_OOB_SET_CAL_BUFF_ID_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_SET_FC_INGR_GEN_OOB_SET_CAL_BUFF_SOURCE_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_GET_FC_INGR_GEN_OOB_GET_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_CAL_BUILD_FC_INGR_GEN_OOB_CAL_BUILD_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_CAL_BUILD_FC_INGR_GEN_OOB_CAL_BUILD_CAL_BUFF_INPUT_WEIGHT_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_CAL_BUILD_FC_INGR_GEN_OOB_CAL_BUILD_CAL_BUFF_INPUT_CONF_ID_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_CAL_BUILD_FC_INGR_GEN_OOB_CAL_BUILD_CAL_BUFF_INPUT_CONF_SOURCE_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_CAL_BUILD_FC_INGR_GEN_OOB_CAL_BUILD_NOF_ENTRIES_ID,
  PARAM_TMD_FC_INGR_GEN_OOB_CAL_BUILD_FC_INGR_GEN_OOB_CAL_BUILD_MAX_CAL_SIZE_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_OOB_NDX_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_OOB_CONF_CAL_REPS_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_OOB_CONF_CAL_LEN_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_OOB_CONF_ENABLE_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_CAL_BUFF_ID_ID,
  PARAM_TMD_FC_EGR_REC_OOB_SET_FC_EGR_REC_OOB_SET_CAL_BUFF_DESTINATION_ID,
  PARAM_TMD_FC_EGR_REC_OOB_GET_FC_EGR_REC_OOB_GET_ID,
  PARAM_TMD_FC_EGR_REC_OOB_GET_FC_EGR_REC_OOB_GET_OOB_NDX_ID,
  PARAM_TMD_FC_EGR_REC_OOB_CAL_BUILD_FC_EGR_REC_OOB_CAL_BUILD_ID,
  PARAM_TMD_FC_EGR_REC_OOB_CAL_BUILD_FC_EGR_REC_OOB_CAL_BUILD_CAL_BUFF_INPUT_WEIGHT_ID,
  PARAM_TMD_FC_EGR_REC_OOB_CAL_BUILD_FC_EGR_REC_OOB_CAL_BUILD_CAL_BUFF_INPUT_CONF_ID_ID,
  PARAM_TMD_FC_EGR_REC_OOB_CAL_BUILD_FC_EGR_REC_OOB_CAL_BUILD_CAL_BUFF_INPUT_CONF_DESTINATION_ID,
  PARAM_TMD_FC_EGR_REC_OOB_CAL_BUILD_FC_EGR_REC_OOB_CAL_BUILD_NOF_ENTRIES_ID,
  PARAM_TMD_FC_EGR_REC_OOB_CAL_BUILD_FC_EGR_REC_OOB_CAL_BUILD_MAX_CAL_SIZE_ID,
  PARAM_TMD_FC_RCY_VSQ_OFP_SET_FC_RCY_VSQ_OFP_SET_ID,
  PARAM_TMD_FC_RCY_VSQ_OFP_SET_FC_RCY_VSQ_OFP_SET_CC_NDX_ID,
  PARAM_TMD_FC_RCY_VSQ_OFP_SET_FC_RCY_VSQ_OFP_SET_INFO_OFP_ID_ID,
  PARAM_TMD_FC_RCY_VSQ_OFP_SET_FC_RCY_VSQ_OFP_SET_INFO_HANDLER_ID,
  PARAM_TMD_FC_RCY_VSQ_OFP_GET_FC_RCY_VSQ_OFP_GET_ID,
  PARAM_TMD_FC_RCY_VSQ_OFP_GET_FC_RCY_VSQ_OFP_GET_CC_NDX_ID,
  PARAM_TMD_FC_RCY_GLB_OFP_HR_SET_FC_RCY_GLB_OFP_HR_SET_ID,
  PARAM_TMD_FC_RCY_GLB_OFP_HR_SET_FC_RCY_GLB_OFP_HR_SET_OFP_NDX_ID,
  PARAM_TMD_FC_RCY_GLB_OFP_HR_SET_FC_RCY_GLB_OFP_HR_SET_FC_MODE_ID,
  PARAM_TMD_FC_RCY_GLB_OFP_HR_GET_FC_RCY_GLB_OFP_HR_GET_ID,
  PARAM_TMD_FC_RCY_GLB_OFP_HR_GET_FC_RCY_GLB_OFP_HR_GET_OFP_NDX_ID,
  PARAM_TMD_FC_RCY_HR_ENABLE_SET_FC_RCY_HR_ENABLE_SET_ID,
  PARAM_TMD_FC_RCY_HR_ENABLE_SET_FC_RCY_HR_ENABLE_SET_ENABLE_ID,
  PARAM_TMD_FC_RCY_HR_ENABLE_GET_FC_RCY_HR_ENABLE_GET_ID,
  PARAM_TMD_API_FLOW_CONTROL_ID,
  PARAM_TMD_IHP_PORT_SET_IHP_PORT_SET_ID,
  PARAM_TMD_IHP_PORT_SET_IHP_PORT_SET_PORT_NDX_ID,
  PARAM_TMD_IHP_PORT_SET_IHP_PORT_SET_INFO_STRIP_FROM_SOP_BYTES_ID,
  PARAM_TMD_IHP_PORT_SET_IHP_PORT_SET_INFO_SOP2HEADER_OFFSET_BYTES_ID,
  PARAM_TMD_IHP_PORT_GET_IHP_PORT_GET_ID,
  PARAM_TMD_IHP_PORT_GET_IHP_PORT_GET_PORT_NDX_ID,
  PARAM_TMD_IHP_STAG_HDR_DATA_SET_IHP_STAG_FIELD_SET_ID,
  PARAM_TMD_IHP_STAG_HDR_DATA_SET_IHP_STAG_FIELD_SET_INFO_LENGTH_4BITS_ID,
  PARAM_TMD_IHP_STAG_HDR_DATA_SET_IHP_STAG_FIELD_SET_INFO_OFFSET_4BITS_ID,
  PARAM_TMD_IHP_STAG_HDR_DATA_SET_IHP_STAG_FIELD_SET_INFO_BASE_HEADER_ID,
  PARAM_TMD_IHP_STAG_HDR_DATA_GET_IHP_STAG_FIELD_GET_ID,
  PARAM_TMD_IHP_TMLAG_HUSH_FIELD_SET_IHP_TMLAG_HUSH_FIELD_SET_ID,
  PARAM_TMD_IHP_TMLAG_HUSH_FIELD_SET_IHP_TMLAG_HUSH_FIELD_SET_INFO_LENGTH_4BITS_ID,
  PARAM_TMD_IHP_TMLAG_HUSH_FIELD_SET_IHP_TMLAG_HUSH_FIELD_SET_INFO_OFFSET_4BITS_ID,
  PARAM_TMD_IHP_TMLAG_HUSH_FIELD_SET_IHP_TMLAG_HUSH_FIELD_SET_INFO_BASE_HEADER_ID,
  PARAM_TMD_IHP_TMLAG_HUSH_FIELD_GET_IHP_TMLAG_HUSH_FIELD_GET_ID,
  PARAM_TMD_API_INGRESS_HEADER_PARSING_ID,
  ...
  PARAM_TMD_INTERRUPT_HANDLER_INTERRUPT_HANDLER_ID,
  PARAM_TMD_API_INTERRUPTS_ID,
  PARAM_TMD_STAT_COUNTER_GET_STAT_COUNTER_GET_ID,
  PARAM_TMD_STAT_COUNTER_GET_STAT_COUNTER_GET_COUNTER_TYPE_ID,
  PARAM_TMD_STAT_ALL_COUNTERS_GET_STAT_ALL_COUNTERS_GET_ID,
  PARAM_TMD_STAT_ALL_COUNTERS_GET_STAT_ALL_COUNTERS_GET_FLAVOR_ID,
  PARAM_TMD_API_STATISTICS_ID,
  ...
  PARAM_TMD_PACKET_SEND_SEND_PACKET_PAYLOAD_INDEX_ID,
  PARAM_TMD_PACKET_SEND_SEND_PACKET_PAYLOAD_ID,
  ...
  PARAM_TMD_SR_DATA_CELL_SEND_SEND_ID,
  PARAM_TMD_SR_DATA_CELL_SEND_SEND_SR_DATA_CELL_ID,
  PARAM_TMD_SR_DATA_CELL_RECV_RECV_ID,
  PARAM_TMD_CTRLL_CELL_SEND_SEND_ID,
  PARAM_TMD_CTRLL_CELL_SEND_SEND_CONTROL_CELL_ID,
  PARAM_TMD_API_CELL_ID,
  PARAM_TMD_SSR_GET_BUFF_SIZE_GET_BUFF_SIZE_ID,
  PARAM_TMD_SSR_TO_BUFF_TO_BUFF_ID,
  PARAM_TMD_SSR_TO_BUFF_TO_BUFF_BUFF_BYTE_SIZE_ID,
  PARAM_TMD_SSR_FROM_BUFF_FROM_BUFF_ID,
  PARAM_TMD_SSR_FROM_BUFF_FROM_BUFF_STORE_BUFF_ID,
  PARAM_TMD_SSR_FROM_BUFF_FROM_BUFF_BUFF_BYTE_SIZE_ID,
  PARAM_TMD_REGISTER_CALLBACK_FUNCTION_REGISTER_CALLBACK_FUNCTION_ID,
  PARAM_TMD_REGISTER_CALLBACK_FUNCTION_REGISTER_CALLBACK_FUNCTION_FUNCTION_NDX_ID,
  PARAM_TMD_REGISTER_CALLBACK_FUNCTION_REGISTER_CALLBACK_FUNCTION_USER_CALLBACK_STRUCTURE_ID,
  PARAM_TMD_REGISTER_CALLBACK_FUNCTION_REGISTER_CALLBACK_FUNCTION_CALLBACK_ID_ID,
  PARAM_TMD_UNREGISTER_CALLBACK_FUNCTION_UNREGISTER_CALLBACK_FUNCTION_ID,
  PARAM_TMD_UNREGISTER_CALLBACK_FUNCTION_UNREGISTER_CALLBACK_FUNCTION_DRIVER_CALLBACK_ID_ID,
  PARAM_TMD_UNREGISTER_ALL_CALLBACK_FUNCTIONS_UNREGISTER_ALL_CALLBACK_FUNCTIONS_ID,
  PARAM_TMD_API_SSR_ID,
  PARAM_TMD_READ_FLD_READ_FLD_ID,
  PARAM_TMD_READ_FLD_READ_FLD_FIELD_LSB_ID,
  PARAM_TMD_READ_FLD_READ_FLD_FIELD_MSB_ID,
  PARAM_TMD_READ_FLD_READ_FLD_FIELD_ADDR_STEP_ID,
  PARAM_TMD_READ_FLD_READ_FLD_FIELD_ADDR_BASE_ID,
  PARAM_TMD_READ_FLD_READ_FLD_INSTANCE_IDX_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_FIELD_LSB_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_FIELD_MSB_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_FIELD_ADDR_STEP_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_FIELD_ADDR_BASE_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_INSTANCE_IDX_ID,
  PARAM_TMD_WRITE_FLD_WRITE_FLD_VAL_ID,
  PARAM_TMD_READ_REG_READ_REG_ID,
  PARAM_TMD_READ_REG_READ_REG_REG_STEP_ID,
  PARAM_TMD_READ_REG_READ_REG_REG_BASE_ID,
  PARAM_TMD_READ_REG_READ_REG_INSTANCE_IDX_ID,
  PARAM_TMD_WRITE_REG_WRITE_REG_ID,
  PARAM_TMD_WRITE_REG_WRITE_REG_REG_STEP_ID,
  PARAM_TMD_WRITE_REG_WRITE_REG_REG_BASE_ID,
  PARAM_TMD_WRITE_REG_WRITE_REG_INSTANCE_IDX_ID,
  ...
  PARAM_TMD_API_TBL_ACCESS_ID,
  PARAM_TMD_UTILS_SET_DEFAULT_DEVICE_ID_DEVICE_ID_ID,
  PARAM_TMD_MGMT_OPERATION_MODE_SET_OPERATION_MODE_SET_OP_MODE_IS_COMBO_NIF_INDEX_ID,
  PARAM_TMD_SYS_PHYS_TO_LOCAL_PORT_MAP_SET_SYS_PHYS_TO_LOCAL_PORT_MAP_SET_MAPPED_DEVICE_ID_ID,
  PARAM_TMD_SYS_PHYS_TO_LOCAL_PORT_MAP_SET_SYS_PHYS_TO_LOCAL_PORT_MAP_SET_DEVICE_LOCAL_PORT_ID_ID,
  PARAM_TMD_NIF_PAUSE_FRAME_SRC_ADDR_SET_PAUSE_FRAME_SRC_ADDR_SET_MAC_ADDR_INDEX_ID,
  PARAM_TMD_IPQ_QUEUE_INTEDIGITATED_MODE_SET_IPQ_QUEUE_INTEDIGITATED_MODE_SET_K_QUEUE_NDX_ID,
  PARAM_TMD_IPQ_QUEUE_INTEDIGITATED_MODE_SET_IPQ_QUEUE_INTEDIGITATED_MODE_SET_IS_INTERDIGITATED_ID,
  PARAM_TMD_IPQ_QUEUE_INTEDIGITATED_MODE_GET_IPQ_QUEUE_INTEDIGITATED_MODE_GET_K_QUEUE_NDX_ID,
  PARAM_TMD_ITM_CATEGORY_RNGS_SET_ITM_CATEGORY_RNGS_SET_INFO_CATEGORY_ID,
  ...
  PARAM_TMD_SCH_IF_SHAPER_RATE_SET_SCH_DEVICE_IF_RATE_SET_IF_NDX_ID,
  PARAM_TMD_SCH_IF_SHAPER_RATE_SET_SCH_DEVICE_IF_RATE_SET_IF_RATE_ID,
  PARAM_TMD_SCH_IF_SHAPER_RATE_GET_SCH_DEVICE_IF_RATE_GET_IF_NDX_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_EG_PORT_EGRESS_RATE_ID,
  PARAM_TMD_AQFM_ALL_PORTS_OPEN_AQFM_ALL_PORTS_OPEN_P_INFO_EG_PORT_SCHEDULER_RATE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_EG_PORT_EGRESS_RATE_ID,
  PARAM_TMD_AQFM_PORT_OPEN_AQFM_PORT_OPEN_PORT_INFO_EG_PORT_SCHEDULER_RATE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_EG_PORT_EGRESS_RATE_ID,
  PARAM_TMD_AQFM_PORT_UPDATE_AQFM_PORT_UPDATE_P_PORT_INFO_EG_PORT_SCHEDULER_RATE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_INFO_ITEM_CLASS_INDEX_ID,
  PARAM_TMD_AQFM_AGG_PORT_AGGS_UPDATE_AQFM_AGG_PORT_AGGS_UPDATE_AGGS_INFO_ITEM_CLASS_INDEX_ID,
  ...
  PARAM_TMD_MGMT_HW_WAIT_FOR_INIT_HW_WAIT_FOR_INIT_ID,
  PARAM_TMD_IPQ_QUEUE_INTEDIGITATED_MODE_SET_IPQ_QUEUE_INTEDIGITATED_MODE_SET_ID,
  PARAM_TMD_IPQ_QUEUE_INTEDIGITATED_MODE_GET_IPQ_QUEUE_INTEDIGITATED_MODE_GET_ID,
  ...
  PARAM_TMD_SCH_IF_SHAPER_RATE_SET_SCH_DEVICE_IF_RATE_SET_ID,
  PARAM_TMD_SCH_IF_SHAPER_RATE_GET_SCH_DEVICE_IF_RATE_GET_ID,
  PARAM_TMD_SCH_PRINT_FLOW_AND_UP_ID,
  PARAM_TMD_API_DEFAULT_DEVICE_ID,
  PARAM_TMD_MGMT_INIT_SEQUENCE_PHASE1_INIT_SEQUENCE_PHASE1_HW_ADJUST_NIF_FAT_PIPE_ENABLE_STRUCT_ID,
  PARAM_TMD_MGMT_HW_INTERFACES_SET_HW_INTERFACES_SET_HW_ADJUST_NIF_FAT_PIPE_STRUCT_ENABLE_ID,
  PARAM_TMD_OFP_RATES_SET_SET_SHAPER_EGQ_SHAPER_MAX_BURST_ID,
  PARAM_TMD_OFP_RATES_SET_SET_SHAPER_EGQ_SHAPER_BURST_UPDATE_MODE_ID,
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_SHAPER_EGQ_SHAPER_MAX_BURST_ID,
  PARAM_TMD_OFP_RATES_UPDATE_UPDATE_SHAPER_EGQ_SHAPER_BURST_UPDATE_MODE_ID,
  PARAM_TMD_OFP_RATES_MAL_SHAPER_SET_MAL_SHAPER_SET_SHAPER_EGQ_SHAPER_MAX_BURST_ID,
  PARAM_TMD_OFP_RATES_MAL_SHAPER_SET_MAL_SHAPER_SET_SHAPER_EGQ_SHAPER_BURST_UPDATE_MODE_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_AGG_BASE_ID_FQ_MAX_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_AGG_BASE_ID_FQ_MIN_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_AGG_BASE_ID_CL_MAX_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_AGG_BASE_ID_CL_MIN_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_AGG_BASE_ID_HR_MAX_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_AGG_BASE_ID_HR_MIN_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_NOF_TRAFFIC_CLASSES_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_RCY_PORT_ID_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_NOF_CPU_PORTS_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_MAX_NOF_PORTS_PER_FAP_ID,
  PARAM_TMD_AQFM_ALL_AGGREGATES_OPEN_AQFM_ALL_AGGREGATES_OPEN_P_SYS_INFO_MAX_NOF_FAPS_IN_SYSTEM_ID,
  PARAM_TMD_API_DEBUG_ID,
  PARAM_TMD_DIAG_ID,
  PARAM_TMD_DIAG_DRAM_WRITE_DIAG_DRAM_WRITE_ID,
  PARAM_TMD_DIAG_DRAM_WRITE_DIAG_DRAM_WRITE_DRAM_NDX_ID,
  PARAM_TMD_DIAG_DRAM_WRITE_DIAG_DRAM_WRITE_INFO_IS_INFINITE_NOF_ACTIONS_ID,
  PARAM_TMD_DIAG_DRAM_WRITE_DIAG_DRAM_WRITE_INFO_IS_DATA_SIZE_BITS_256_NOT_32_ID,
  PARAM_TMD_DIAG_DRAM_WRITE_DIAG_DRAM_WRITE_INFO_ADDRESS_ID,
  PARAM_TMD_DIAG_DRAM_WRITE_DIAG_DRAM_WRITE_BUFFER_ID,
  PARAM_TMD_DIAG_DRAM_READ_AND_COMPARE_DIAG_DRAM_READ_AND_COMPARE_ID,
  PARAM_TMD_DIAG_DRAM_READ_AND_COMPARE_DIAG_DRAM_READ_AND_COMPARE_DRAM_NDX_ID,
  PARAM_TMD_DIAG_DRAM_READ_AND_COMPARE_DIAG_DRAM_READ_AND_COMPARE_INFO_IS_INFINITE_NOF_ACTIONS_ID,
  PARAM_TMD_DIAG_DRAM_READ_AND_COMPARE_DIAG_DRAM_READ_AND_COMPARE_INFO_IS_DATA_SIZE_BITS_256_NOT_32_ID,
  PARAM_TMD_DIAG_DRAM_READ_AND_COMPARE_DIAG_DRAM_READ_AND_COMPARE_INFO_ADDRESS_ID,
  PARAM_TMD_DIAG_DRAM_READ_AND_COMPARE_DIAG_DRAM_READ_AND_COMPARE_BUFF_EXPECTED_ID,
  PARAM_TMD_DIAG_GET_ALL_COUNTERS_GET_ID,
  PARAM_TMD_DIAG_GET_ALL_COUNTERS_LEVEL_ID,
  PARAM_TMD_DIAG_GET_ALL_COUNTERS_SHORT_ID,
  PARAM_TMD_DIAG_GET_ALL_COUNTERS_PRINT_ZERO_ID,
  PARAM_TMD_DIAG_GET_ALL_COUNTERS_SAMPLING_PERIOD_ID,
  PARAM_TMD_DIAG_GET_ALL_COUNTERS_BLOCK_ID,
  PARAM_TMD_DIAG_GET_COUNTER_ID,
  PARAM_TMD_DIAG_GET_COUNTER_ID_COUNTER_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_DATA_PATERN_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_ADDRESS_MODE_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_DATA_MODE_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_END_ADDR_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_START_ADDR_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_NOF_CMNDS_WRITE_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_TEST_INFO_NOF_CMNDS_READ_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_START_QDR_BIST_TEST_START_READ_OFFST_ID,
  PARAM_TMD_DIAG_QDR_BIST_TEST_RESULT_GET_QDR_BIST_TEST_RESULT_GET_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_DRAM_NDX_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_DATA_PATERN_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_DATA_MODE_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_END_ADDR_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_START_ADDR_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_READS_PER_CYCLE_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_WRITES_PER_CYCLE_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_START_DRAM_BIST_TEST_START_TEST_INFO_NOF_CMNDS_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_RESULT_GET_DRAM_BIST_TEST_RESULT_GET_ID,
  PARAM_TMD_DIAG_DRAM_BIST_TEST_RESULT_GET_DRAM_BIST_TEST_RESULT_GET_DRAM_NDX_ID,
  PARAM_TMD_DIAG_DLL_STATUS_GET_DIAG_DLL_STATUS_GET_ID,
  PARAM_TMD_DIAG_DLL_STATUS_GET_DIAG_DLL_STATUS_GET_DRAM_NDX_ID,
  PARAM_TMD_DIAG_DLL_STATUS_GET_DIAG_DLL_STATUS_GET_DLL_NDX_ID,
  PARAM_TMD_DIAG_DRAM_STATUS_GET_DIAG_DRAM_STATUS_GET_ID,
  PARAM_TMD_DIAG_DRAM_STATUS_GET_DIAG_DRAM_STATUS_GET_DRAM_NDX_ID,
  PARAM_TMD_DIAG_DRAM_DIAGNOSTIC_GET_DIAG_DRAM_DIAGNOSTIC_GET_ID,
  PARAM_TMD_DIAG_DRAM_DIAGNOSTIC_GET_DIAG_DRAM_DIAGNOSTIC_GET_DRAM_NDX_ID,
  PARAM_TMD_DIAG_EGQ_RESOURCES_GET_ID,
  PARAM_TMD_NIF_COUNTER_GET_STAT_COUNTER_GET_ID,
  PARAM_TMD_NIF_COUNTER_GET_STAT_COUNTER_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_COUNTER_GET_STAT_COUNTER_GET_PORT_NDX_ID,
  PARAM_TMD_NIF_COUNTER_GET_STAT_COUNTER_GET_COUNTER_TYPE_ID,
  PARAM_TMD_NIF_ALL_COUNTERS_GET_STAT_ALL_COUNTERS_GET_ID,
  PARAM_TMD_NIF_ALL_COUNTERS_GET_STAT_ALL_COUNTERS_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_ALL_COUNTERS_GET_STAT_ALL_COUNTERS_GET_PORT_NDX_ID,
  PARAM_TMD_NIF_LINK_STATUS_GET_STAT_LINK_STATUS_GET_ID,
  PARAM_TMD_NIF_LINK_STATUS_GET_STAT_LINK_STATUS_GET_MAL_NDX_ID,
  PARAM_TMD_NIF_LINK_STATUS_GET_STAT_LINK_STATUS_GET_PORT_NDX_ID,
  PARAM_TMD_PP_API_NIF_ID,
  PARAM_TMD_SRD_UTILS_IPU_MEM_LOAD_ID,
  PARAM_TMD_SRD_UTILS_IPU_MEM_LOAD_STAR_ID,
  PARAM_TMD_DIAG_LBG_CONF_SET_ID,
  PARAM_TMD_DIAG_LBG_CONF_SET_PORTS_ID,
  PARAM_TMD_DIAG_LBG_SEND_SEND_PACKET_PAYLOAD_BYTE_SIZE_ID,
  PARAM_TMD_DIAG_LBG_SEND_SEND_PACKET_PAYLOAD_0_ID,
  PARAM_TMD_DIAG_LBG_TRAFFIC_SEND_ID,
  PARAM_TMD_DIAG_LBG_TRAFFIC_SEND_PACKET_SIZE_ID,
  PARAM_TMD_DIAG_LBG_TRAFFIC_SEND_NOF_PACKETS_ID,
  PARAM_TMD_DIAG_LBG_GET_RES_ID,
  PARAM_TMD_DIAG_LBG_CLOSE_ID,
  PARAM_TMD_DIAG_IPT_RATE_GET_ID,
  PARAM_TMD_IWRITE_ID,
  PARAM_TMD_READ_ID,
  PARAM_TMD_IREAD_ID,
  ...
  PARAM_TMD_API_ATM_ID,
  PARAM_TMD_ATM_TEST_ALL_ID,
  PARAM_TMD_FC_TMD_FC_EGR_REC_OOB_STAT_GET_ID,
  PARAM_TMD_FC_TMD_FC_EGR_REC_OOB_STAT_OOB_NDX_GET_ID,
  ...
  PARAM_TMD_STAT_IFP_CNT_SELECT_SET_STAT_IFP_CNT_SELECT_SET_ID,
  PARAM_TMD_STAT_IFP_CNT_SELECT_SET_STAT_IFP_CNT_SELECT_SET_INFO_IFP_ID_INDEX_ID,
  PARAM_TMD_STAT_IFP_CNT_SELECT_SET_STAT_IFP_CNT_SELECT_SET_INFO_IFP_ID_ID,
  PARAM_TMD_STAT_IFP_CNT_SELECT_GET_STAT_IFP_CNT_SELECT_GET_ID,
  PARAM_TMD_STAT_VOQ_CNT_SELECT_SET_STAT_VOQ_CNT_SELECT_SET_ID,
  PARAM_TMD_STAT_VOQ_CNT_SELECT_SET_STAT_VOQ_CNT_SELECT_SET_INFO_ENABLE_ALSO_MASK_ID,
  PARAM_TMD_STAT_VOQ_CNT_SELECT_SET_STAT_VOQ_CNT_SELECT_SET_INFO_VOQ_ID_ID,
  PARAM_TMD_STAT_VOQ_CNT_SELECT_GET_STAT_VOQ_CNT_SELECT_GET_ID,
  PARAM_TMD_STAT_VSQ_CNT_SELECT_SET_STAT_VSQ_CNT_SELECT_SET_ID,
  PARAM_TMD_STAT_VSQ_CNT_SELECT_SET_STAT_VSQ_CNT_SELECT_SET_INFO_ENABLE_ALSO_MASK_ID,
  PARAM_TMD_STAT_VSQ_CNT_SELECT_SET_STAT_VSQ_CNT_SELECT_SET_INFO_VSQ_IN_GRP_ID_ID,
  PARAM_TMD_STAT_VSQ_CNT_SELECT_SET_STAT_VSQ_CNT_SELECT_SET_INFO_VSQ_GRP_ID_ID,
  PARAM_TMD_STAT_VSQ_CNT_SELECT_GET_STAT_VSQ_CNT_SELECT_GET_ID,

  /*
   *  Must be the last
   */
  PARAM_TMD_API_LAST = PARAM_TMD_API_END_RANGE_ID
}PARAM_TMD_API_IDS;
...
/* } __UI_PURE_DEFI_TMD_API_INCLUDED__*/
#endif
