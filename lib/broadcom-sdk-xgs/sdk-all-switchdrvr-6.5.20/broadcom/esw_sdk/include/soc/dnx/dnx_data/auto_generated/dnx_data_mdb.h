...
/**
 * \brief returns define data of nof_rows_in_rpb
 * Module - 'mdb', Submodule - 'kaps', data - 'nof_rows_in_rpb'
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_rows_in_rpb - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of nof_rows_in_small_ads
 * Module - 'mdb', Submodule - 'kaps', data - 'nof_rows_in_small_ads'
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_rows_in_small_ads - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of nof_rows_in_rpb
     */
    dnx_data_mdb_kaps_nof_rows_in_rpb_get_f nof_rows_in_rpb_get;
    /**
     * returns define data of nof_rows_in_small_ads
     */
