...
/**
 * \brief returns define data of port_uc_flow_control_min_divider
 * Module - 'tune', Submodule - 'ecgm', data - 'port_uc_flow_control_min_divider'
 * divider factor for uc flow control minimum calculation per port and queue
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     port_uc_flow_control_min_divider - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
