...
int dnx_pemladrv_init(int unit, int restore_after_reset, int use_file, const char *rel_file_path, const char *vmem_definition_file_name /* in case of null, PEM_DEFAULT_DB_MEMORY_MAP_FILE is taken */);
