...
/**
 * implemented by: example_dynamic_array_zero_size_set
 */
...
/**
 * implemented by: example_dynamic_array_zero_size_get
 */
typedef int (*example_dynamic_array_zero_size_get_cb)(
    int unit, uint32 dynamic_array_zero_size_idx_0, uint32 *dynamic_array_zero_size);

/**
 * implemented by: example_dynamic_array_zero_size_alloc
 */
typedef int (*example_dynamic_array_zero_size_alloc_cb)(
    int unit, uint32 nof_instances_to_alloc_0);

/**
 * implemented by: example_dynamic_array_zero_size_free
 */
...
/**
 * implemented by: example_mutex_test_is_created
 */
...
/**
 * implemented by: example_default_value_tree_array_dnxdata_array_dynamic_array_dynamic_dynamic_alloc
 */
...
/**
 * implemented by: example_default_value_tree_array_dnxdata_array_dynamic_array_dynamic_dynamic_my_variable_set
 */
...
/**
 * implemented by: example_default_value_tree_array_dnxdata_array_dynamic_array_dynamic_dynamic_my_variable_get
 */
...
/**
 * implemented by: example_default_value_tree_array_dnxdata_array_pointer_array_dynamic_dynamic_alloc
 */
...
/**
 * implemented by: example_default_value_tree_array_dnxdata_array_pointer_array_dynamic_dynamic_my_variable_set
 */
...
/**
 * implemented by: example_default_value_tree_array_dnxdata_array_pointer_array_dynamic_dynamic_my_variable_get
 */
...
/**
 * implemented by: example_htb_delete_all
 */
...
/**
 * implemented by: example_htb_arr_delete_all
 */
...
/**
 * implemented by: example_index_htb_delete_all
 */
...
/**
 * implemented by: example_large_DS_examples_large_htb_delete_all
 */
...
/**
 * implemented by: example_large_DS_examples_large_index_htb_delete_all
 */
...
/**
 * implemented by: example_buffer_array_memcmp
 */
...
/**
 * implemented by: example_bitmap_array_bit_range_write
 */
...
/**
 * implemented by: example_bitmap_array_bit_range_and
 */
...
/**
 * implemented by: example_bitmap_array_bit_range_test
 */
typedef int (*example_bitmap_array_bit_range_test_cb)(
    int unit, uint32 bitmap_array_idx_0, uint32 _first, uint32 _count, uint8 *result);

/**
 * implemented by: example_bitmap_array_bit_range_eq
 */
...
/**
 * implemented by: example_bitmap_array_bit_range_count
 */
...
/**
 * This structure holds the access functions for the variable dynamic_array_zero_size
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable sem_test
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for array_dynamic_dynamic
     */
...
/**
 * This structure holds the access functions for the variable bt
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable pretty_print_example
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable buffer_array
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable bitmap_array
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for dynamic_array_zero_size
     */
    ...
    /**
     * Access struct for pretty_print_example
     */
    example_pretty_print_example_cbs pretty_print_example;
    /**
     * Access struct for buffer_array
     */
    example_buffer_array_cbs buffer_array;
    /**
     * Access struct for bitmap_array
     */
