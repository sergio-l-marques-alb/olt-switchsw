...
/**
 * implemented by: switch_db_l3mcastl2_fwd_type_set
 */
typedef int (*switch_db_l3mcastl2_fwd_type_set_cb)(
    int unit, uint8 l3mcastl2_fwd_type);

/**
 * implemented by: switch_db_l3mcastl2_fwd_type_get
 */
...
/**
 * This structure holds the access functions for the variable l3mcastl2_fwd_type
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for l3mcastl2_fwd_type
     */
