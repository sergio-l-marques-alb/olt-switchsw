...
/**
 * \brief Current Next Protocol ETHERNET_OVER_ETHERNET\n 
 */
#define DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_ETHERNET_OVER_ETHERNET (0x1234)
/**
 * \brief Current Next Protocol ETHERNET_OVER_IP\n 
 */
...
/**
 * \brief Current Next Protocol GTPU_OVER_UDP\n 
 */
...
/**
 * \brief Learn format index for PCC State\n 
 */
...
/**
 * \brief Next protocol after UDP is seamless BFD\n 
 */
...
typedef enum
{
    ...
    /** Contexts of Dequeue Command Queues  */
    DBAL_FIELD_TYPE_DEF_DQCQ_CONTEXT,
    /** Subcontexts of Dequeue Command Queues  */
    ...
    /** 
     * eei format for pop and multi mpls swap with remark profile
     * 
     */
    ...
    /** 
     * Field on FHEI ETPS entry, used to configure the ARR prefix of those fields
     * 
     */
    ...
    /** HBMC index, used as key field to TDU tables  */
    ...
    /** Hash action selector  */
    DBAL_FIELD_TYPE_DEF_HASH_ACTION,
    /** 
     * Header types which support symmetrical/non-symmetrical hashing configuration
     * 
     */
    ...
    /** HBMC TDU index, used as key field to many TDU tables  */
    ...
    /** Hierarchical LM by MD Level Disable  */
    ...
    /** 
     * Enable interrupts when limit is reached.
     * 
     */
    ...
    /** Const 0 buffer for aligning KBP results  */
    ...
    /** Additional entry data to be used in PMF  */
    ...
    /** Encodes first hit index numeric value for chosen subset of ranges  */
    ...
    /** Learn info only for source port ARR inclusion  */
    ...
    /** 
     * MACSEC General Direction indication. For
     * configuratins where it is useful to configure Egress side
     * separately from the Ingress side
     */
    ...
    /** Tagged Validate Frames permit policy  */
    ...
    /** 
     * Event is generated when limit is reached.
     * 
     */
    ...
    /** MPLS pop information or mpls swap label  */
    ...
    /** which network qos input do we use.  */
    ...
    /** Header Ext length in SRv6 base header  */
    ...
    /** Indication by how much to break to entry to increas the number of effective entries. Only relevant for atomic read modify write.  */
    ...
    /** Indication on which interface to perform state table read.  */
    DBAL_FIELD_TYPE_DEF_STATE_TABLE_IF_READ,
    /** Indication on which interface to perform state table read-modify-write.  */
    DBAL_FIELD_TYPE_DEF_STATE_TABLE_IF_RMW,
    /** Indication on which interface to perform state table write.  */
    DBAL_FIELD_TYPE_DEF_STATE_TABLE_IF_WRITE,
    /** Indication where to take the state table key for  */
    ...
    /** 
     * The index of the VIP ECMP group
     * 
     */
    ...
    /** Virtual wire carrying FWD1 VIP ECMP calculated MEMBER_REFERENCE  */
    DBAL_FIELD_TYPE_DEF_VW_MEMBER_REFERENCE,
    /** Virtual wire carrying PCC State table hit status  */
    DBAL_FIELD_TYPE_DEF_VW_PCC_HIT,
    /** Virtual wire carrying FWD1 VIP_ID result  */
    DBAL_FIELD_TYPE_DEF_VW_VIP_ID,
    /** Virtual wire indicating that FWD1 result is valid VIP_ID  */
