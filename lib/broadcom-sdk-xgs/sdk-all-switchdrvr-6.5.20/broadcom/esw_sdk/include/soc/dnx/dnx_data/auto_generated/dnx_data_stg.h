 ...
 */
/**
 * \brief Init default data structure - dnx_data_if_stg
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_STG - STG:
 * {
 */
/**
 * \brief Interface for stg stg data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of nof_topology_ids
     */
...
/*
 * MODULE INTERFACE DNX_DATA_IF_STG:
 * {
 */
/**
 * \brief Interface for stg data
 */
typedef struct
{
    /**
     * Interface for stg stg data
     */
