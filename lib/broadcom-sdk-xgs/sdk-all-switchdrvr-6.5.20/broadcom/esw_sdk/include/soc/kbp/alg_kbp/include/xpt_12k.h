/*
 **************************************************************************************
 Copyright 2009-2020 Broadcom Corporation
...
typedef struct kbp_xpt_operations_t {
   ...
   /**
    * Same as kbp_xpt_get_request, but it takes smt_no as an additional argument.
    *
    * @param self Pointer to valid transport layer handle.
    * @param o_reason Legacy reason code for older transport implementations.
    *
   ...
   kbp_xpt_rqt *(*kbp_xpt_get_request_smt) (void *self, uint32_t smt_no, NlmReasonCode *o_reason);
    ...
    /**
     * This is same as kbp_xpt_service_requests, but it takes smt_no as an additional argument.
     *
     * @param self Pointer to valid transport layer handle.
     * @param o_reason Legacy reason code for older transport implementations.
     */
