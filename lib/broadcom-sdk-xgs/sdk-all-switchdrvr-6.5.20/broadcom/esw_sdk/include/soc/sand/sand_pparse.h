...
struct pparse_db_entry_s
{
    ...
    pparse_post_processor_cb_t post_processing_cb;
    int override;
    int port_skip;  /** if set, pparse would take into account when parsing a signal with this object, port skip may occur */
} ;
...
/**
 * \brief
 *   Checks the existence of PTCH_2 on the incoming pocket, according to the available signals.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
...
/**
 * \brief
 *   Checks the existence of PTCH_1 on the incoming pocket, according to the available signals.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
...
/**
 * \brief
 *   Checks the existence of ITMH on the incoming pocket, according to the available signals.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
...
/**
 * \brief
 *  Parse IPv6 AH Extension header
 */
shr_error_e
