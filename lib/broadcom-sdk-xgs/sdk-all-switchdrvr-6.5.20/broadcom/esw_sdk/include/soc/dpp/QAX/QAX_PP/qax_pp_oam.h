...
/* Constant profile ID used for setting 
 * OAMP_MEP_PROFILE[profile].UDP_SRC_PORT_CHECK_DIS = 0/1 */
...
/**
 * Enable/Disable the UDP source port check in OAMP.
 *
...
/*The function sets the mep_pe_profile in case the gpoup is maid_48
  The value of mep_pe_profile depends on the features(double pointer or egress injection)
