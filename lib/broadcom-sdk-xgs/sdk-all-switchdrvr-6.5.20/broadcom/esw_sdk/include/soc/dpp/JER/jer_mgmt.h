...
/* drop thresholds per priority in FDA fabric fifos */
...
/* this struct is used to override and restore thresholds when disabling and enabling traffic in soft reset process */
...
/*********************************************************************
* NAME:
*     jer_mgmt_enable_traffic_set / jer_mgmt_enable_traffic_get
* TYPE:
*   PROC
* DATE:
*   Nov 16 2014
...
/*********************************************************************
* NAME:
*     jer_mgmt_enable_traffic_advanced_set / jer_mgmt_enable_traffic_advanced_get
* TYPE:
*   PROC
* DATE:
*   May 21 2017
...
*     Enable / Disable the device from receiving and
*     transmitting traffic,
*     and configure additional customized configurations via the enable_traffic_config struct.
*     This function is to be called:
*     - directly in case additional customized configurations are needed.
*     - from jer_mgmt_enable_traffic_set/get - no additional configurations- in this case enable_traffic_config struct is NULL.
* INPUT:
*  SOC_SAND_IN      int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN/OUT  jer_mgmt_enable_traffic_config_t   *enable_traffic_config -
*     Set/get additional configurations related to enabling traffic.
*     if NULL- the function will disregard this struct.
*  SOC_SAND_IN/OUT  uint8                               enable -
*     SOC_SAND_IN uint8 enable
* REMARKS:
*     None.
...
/*********************************************************************
* NAME:
*     jer_mgmt_enable_traffic_set_unsafe / jer_mgmt_enable_traffic_get_unsafe
* TYPE:
*   PROC
* DATE:
*   Nov 16 2014
