 ...
 *   SOC_SAND_IN  uint8                    is_ilm -
 *     Indicate for Infered LM
 *   SOC_SAND_IN  uint8                    timestamp_format -
 *     Indicate the timestamp_format
 * REMARKS:
 *   None.
 * RETURNS:
