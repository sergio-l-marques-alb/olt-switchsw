 ...
 *   PROC
 * FUNCTION:
 *   Add IPv6 compressed Source IP entry to the routing table.
 * INPUT:
 *   SOC_SAND_IN  int                           unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPC_FRWRD_IPV6_MC_ROUTE_KEY         *route_key -
 ...
 *   SOC_SAND_OUT SOC_SAND_SUCCESS_FAILURE                *success -
 *     Whether the operation succeeds. Add operation may fail
 *     if there is no place in the LPM.
 * REMARKS:
 * RETURNS:
 *   OK or ERROR indication.
*********************************************************************/
 ...
 *   PROC
 * FUNCTION:
 *   Gets the IPv6 compress Source IP associated with the given route key.
 * INPUT:
 *   SOC_SAND_IN  int                           unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPC_FRWRD_IPV6_MC_ROUTE_KEY         *route_key -
 ...
 *   PROC
 * FUNCTION:
 *   Remove IPv6 compress Source IP entry.
 * INPUT:
 *   SOC_SAND_IN  int                           unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPC_FRWRD_IPV6_MC_ROUTE_KEY         *route_key -
