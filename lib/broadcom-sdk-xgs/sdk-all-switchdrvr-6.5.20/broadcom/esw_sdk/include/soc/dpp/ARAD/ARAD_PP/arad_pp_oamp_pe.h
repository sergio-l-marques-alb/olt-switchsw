...
/* Following is definition for MEP_PE_PROFILE bits offset incase not Egress Injection or CCM Counting features*/
...
typedef enum
{
    ...
    ARAD_PP_OAMP_PE_PROGS_ETH_TLV_ON_SERVER,  /*Eth-TLV on server MEP.  AKA Port/interface status TLV bug fix for OAMP server */
    ARAD_PP_OAMP_PE_PROGS_BFD_ECHO,
    ARAD_PP_OAMP_PE_PROGS_BFD_UDP_CHECKSUM, /* Arad+ only */
    ARAD_PP_OAMP_PE_PROGS_UP_MEP_MAC, /* up-MEP mac LSB restrictions */
    ...
    ARAD_PP_OAMP_PE_PROGS_UP_MEP_UDH_MAID_48,/* Jericho and QAX for UP MEP(with maid_48) once UDH is on(actually default program is used)*/
    ARAD_PP_OAMP_PE_PROGS_UDH_PUNT_JER, /* Jericho only for Punt/Events packets with UDH*/
    ARAD_PP_OAMP_PE_PROGS_MHOP_SHOP_BFD, /* Jericho only */
    ARAD_PP_OAMP_PE_PROGS_SEAMLESS_BFD,/*Jericho and QAX*/
    ARAD_PP_OAMP_PE_PROGS_DPORT_AND_MYDISCR_UPDATE_BFD, /* Jericho and QAX */
    ARAD_PP_OAMP_PE_PROGS_CHANGE_DPORT_TO_SHOP_BFD, /* Jericho and QAX */
    ARAD_PP_OAMP_PE_PROGS_MICRO_BFD, /* Jericho only */
    ARAD_PP_OAMP_PE_PROGS_BFD_PWE_BOS_FIX, /* Jericho only */
    ARAD_PP_OAMP_PE_PROGS_RFC_6374_PWE_BOS_FIX, /* Jericho only */
    ARAD_PP_OAMP_PE_PROGS_MAID_48, /* Jericho and QAX */
    ARAD_PP_OAMP_PE_PROGS_LMM_DMM_FLEXIBLE_DA_QAX,/*Used for LMM/DMM packets*/
    ARAD_PP_OAMP_PE_PROGS_SLM_MAID_48,/*QAX only*/
    ...
    ARAD_PP_OAMP_PE_PROGS_SLM_MAID_11, /*QAX only*/
    ARAD_PP_OAMP_PE_PROGS_SLM_POINTER, /*QAX only*/
    ...
    ARAD_PP_OAMP_PE_PROGS_LMR_DMR_EGR_INJ, /*QAX only used for Egress Injection */
   ...
   /*The programs takes CCM over PWE/MPLS packets and adds a EEI header with a pointer to an additional encap pointer.
    ...
    ARAD_PP_OAMP_PE_PROGS_JUMBO_DM_TLV, /* Jumbo DM TLV*/
    ARAD_PP_OAMP_PE_PROGS_JUMBO_DM_TLV_11B_MAID, /* Jumbo DM TLV + 11B_MAID*/
    ARAD_PP_OAMP_PE_PROGS_JUMBO_DM_TLV_48B_MAID, /* Jumbo DM TLV + 48B_MAID*/
    ARAD_PP_OAMP_PE_PROGS_MPLS_TP_VCCV, /* MPLS TP vccv type*/
 ...
 *   PROC
 * FUNCTION:
 *   Set src_port for seamless bfd to pe_const.
 * INPUT:
 *   SOC_SAND_IN  int                   unit -
 ...
 *   PROC
 * FUNCTION:
 *   Get the src_port from pe_const for seamless bfd.
 * INPUT:
 *   SOC_SAND_IN  int                   unit -
 *   SOC_SAND_IN  uint32                *src_port -
 * REMARKS:
