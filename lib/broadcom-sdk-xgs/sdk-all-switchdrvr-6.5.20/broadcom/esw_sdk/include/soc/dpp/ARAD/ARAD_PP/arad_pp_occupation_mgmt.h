...
typedef enum {
    ...
    /*IP disable on LIF - used in JER/QAX-A0*/
    SOC_OCC_MGMT_INLIF_APP_IP_DISABLE,
    /*IPv4 disable on LIF - used in JER/QAX-A0*/
    SOC_OCC_MGMT_INLIF_APP_IPV4_DISABLE,
    /*IPv6 disable on LIF - used in JER/QAX-A0*/
    SOC_OCC_MGMT_INLIF_APP_IPV6_DISABLE,
    /* BUM over VPLS (logical interface same filter skipping port check) - used in Arad+, Jericho */
...
typedef enum {
    ...
    /* MIM_ENCAP - used in Jericho and above */
    ...
    /* ELI addition @ non-BoS location by PRGE - used in Jericho only */
    ...
    /*Outlif profile for IPv4 Tunnel TOR*/
    SOC_OCC_MGMT_OUTLIF_APP_IPV4_TUNNEL_TOR,
    /*Outlif profile for IPv6 Tunnel TOR*/
    SOC_OCC_MGMT_OUTLIF_APP_IPV6_TUNNEL_TOR,
    /* Outlif profile for PPPoE encapsulation */
    SOC_OCC_MGMT_OUTLIF_APP_PPPOE_ENCAP,
	/* Outlif profile for L2TP encapsulation */
	SOC_OCC_MGMT_OUTLIF_APP_L2TP_ENCAP,
    /* Outlif profile for IPv6 encapsulation */
