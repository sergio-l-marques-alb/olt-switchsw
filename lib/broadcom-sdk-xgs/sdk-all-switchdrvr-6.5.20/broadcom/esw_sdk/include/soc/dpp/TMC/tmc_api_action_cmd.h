...
/*Invalid counter for snoop/mirror destination create*/
...
typedef struct
{
  ...
  */
  ...
  uint8 ext_stat_id_update; /* indicate if the ext_stat_ids should be updated */
  int ext_stat_id[2]; /* ext_stat_id to support statistic interface for mirror packets. */
