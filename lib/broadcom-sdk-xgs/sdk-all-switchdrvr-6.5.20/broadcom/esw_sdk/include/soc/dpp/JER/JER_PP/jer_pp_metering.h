...
* FUNCTION:
*     get the mef_10_3_enable global configuration field 
* INPUT:
*   int                         unit				- Identifier of the device to access
*   int * 			arg                            - output of the enable field
* RETURNS:
*   OK or ERROR indication.
* REMARKS:
*********************************************************************/
...
* FUNCTION:
*     set the mef_10_3_enable global configuration field 
* INPUT:
*   int                         unit				- Identifier of the device to access
*   int * 			arg                            - input of the enable flag
* RETURNS:
*   OK or ERROR indication.
* REMARKS:
*********************************************************************/
