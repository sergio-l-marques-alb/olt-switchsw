...
typedef enum
{
  ...
  /*
   *  Calendar-based Flow Control Mode: COE OOB and E2E for QAX only
   */
  SOC_TMC_FC_CAL_MODE_IHB_OOB = 3,
  /*
   *  Calendar-based Flow Control Mode: COE inband and E2E for QAX only
   */
...
typedef struct
{
  ...
  /*
   *  If TRUE, Specifies FC.triggered by Headroom Resouce.
   */
  uint32 is_headroom;

  /*
   *  If TRUE, Ignore Pools.
   */
  uint32 is_mask_pool;
