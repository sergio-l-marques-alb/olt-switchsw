...
/* Custom Macro - But we can assign it constant number because we have enough for TM ports(using upper part of custom macros) */
...
/* Callback type indicating whether line in parser configuration will be activated */
...
typedef struct
{
    ...
    int             nof_leafs;
    /*
     * Size may be either FULL(64) or SMALL(16)
     */
    int             size;
    /*
     * Address is initialized on jer_parser_int, all above are really const
     */
    int             address;
} dpp_segment_t;
