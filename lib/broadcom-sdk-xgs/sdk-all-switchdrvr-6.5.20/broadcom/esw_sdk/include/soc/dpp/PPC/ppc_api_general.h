...
/* OAM upmep trap codes: FTMH header : need to be 4 consecutive user-header traps */
...
/*Using SOC_PPC_TRAP_CODE_USER_DEFINED_22 which is not being used as of now */
