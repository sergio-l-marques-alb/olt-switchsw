...
{
    soc_dnxf_multicast_table_mode_64k = 0,      /* 8x64K x (192 bit) mode, 8 parallel accesses to the multicast table
                                                 * can be handled */
    soc_dnxf_multicast_table_mode_128k = 1,     /* 4x128Kx (192 bit) mode, 4 parallel accesses to the multicast table
                                                 * can be handled */
    soc_dnxf_multicast_table_mode_128k_half = 2,        /* 8x128Kx (96 bit ) mode, 8 parallel accesses to the multicast 
                                                         * table can be handled */
    soc_dnxf_multicast_table_mode_256k = 3,     /* 2x256Kx (192 bit) mode, 2 parallel accesses to the multicast table
                                                 * can be handled */
    soc_dnxf_multicast_table_mode_256k_half = 4,        /* 4x256Kx (96 bit) mode, 4 parallel accesses to the multicast
                                                         * table can be handled */
    soc_dnxf_multicast_table_mode_512k_half = 5 /* 2x512Kx (96 bit) mode, 2 parallel accesses to the multicast table
                                                 * can be handled */
