...
#ifndef _SHR_SW_STATE_DPP_SOC_ARAD_TM_MODPORT2SYSPORT_DIAGNOSTIC_H_
#define _SHR_SW_STATE_DPP_SOC_ARAD_TM_MODPORT2SYSPORT_DIAGNOSTIC_H_
...
/* implemented by: sw_state_dpp_soc_arad_tm_modport2sysport_dump */
typedef int (*sw_state_dpp_soc_arad_tm_modport2sysport_dump_cb)(
...
int sw_state_dpp_soc_arad_tm_modport2sysport_diagnostic_cb_init(int unit);

#endif /* BCM_WARM_BOOT_API_TEST */

#endif /* _SHR_SW_STATE_DPP_SOC_ARAD_TM_MODPORT2SYSPORT_DIAGNOSTIC_H_ */
