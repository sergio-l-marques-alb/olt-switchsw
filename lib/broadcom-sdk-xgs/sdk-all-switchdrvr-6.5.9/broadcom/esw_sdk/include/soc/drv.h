 ...
 */
#define SOC_DRV_PORT_NAME_MAX (11)
...
#define SOC_MAX_NUM_PM_BLKS 12
#define PM_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_PM_BLKS)) ? SOC_INFO(unit).pm_block[instance] : (-1))
...
typedef struct {
    ...
    int             nof_pmqs;
        ...
        int             mdb_arm_block;
        int             pm_block[SOC_MAX_NUM_PM_BLKS];
        int             fdtl_block;
        int             eci_block;
