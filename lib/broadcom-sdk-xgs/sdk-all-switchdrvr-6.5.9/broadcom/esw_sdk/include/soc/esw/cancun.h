...
#define CANCUN_VERSION_LEN_MAX      (20)
...
*/
#define CANCUN_VERSION_OFFSET_PREFIX    (28)
#define CANCUN_VERSION_OFFSET_MAJOR     (24)
#define CANCUN_VERSION_OFFSET_MINOR     (16)
#define CANCUN_VERSION_OFFSET_BUILD     (8)
#define CANCUN_VERSION_OFFSET_CANCUN    (0)
...
#define SOC_CANCUN_PSEUDO_REGS_BLOCK_BYTE_SIZE   (0x100 * 50)
