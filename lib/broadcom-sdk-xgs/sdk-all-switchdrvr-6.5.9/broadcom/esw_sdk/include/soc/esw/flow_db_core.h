...
#define SOC_FLOW_DB_FLOW_TBL_MAP(_u_)            (SOC_FLOW_MAP(_u_)->flow_tbl_lyt)
#define SOC_FLOW_DB_NUM_FLOW(_u_)                (SOC_FLOW_DB_FLOW_TBL_MAP(_u_)->num_entries)

#define SOC_FLOW_DB_FLOW_OP_TBL_MAP(_u_)         (SOC_FLOW_MAP(_u_)->flow_option_tbl_lyt)
#define SOC_FLOW_DB_NUM_FLOW_OP(_u_)             (SOC_FLOW_DB_FLOW_OP_TBL_MAP(_u_)->num_entries)

#define SOC_FLOW_DB_FFO_TPL_TBL_MAP(_u_)         (SOC_FLOW_MAP(_u_)->ffo_tuple_tbl_lyt)
#define SOC_FLOW_DB_NUM_FFO_TPL(_u_)             (SOC_FLOW_DB_FFO_TPL_TBL_MAP(_u_)->num_entries)

#define SOC_FLOW_DB_VIEW_TBL_MAP(_u_)            (SOC_FLOW_MAP(_u_)->view_tbl_lyt)
...
#define SOC_FLOW_DB_FLOW_LG_FL_TBL_MAP(_u_)      (SOC_FLOW_MAP(_u_)->lg_field_tbl_lyt)
...
typedef struct soc_flow_db_flow_rec_s {
    char name[SOC_FLOW_DB_MAX_FLOW_NAME]; /* flow string */
    uint32 flow_handle;
...
typedef struct soc_flow_db_flow_option_rec_s {
    ...
    char name[SOC_FLOW_DB_MAX_FLOW_OPTION_NAME];
    uint32 option_id;
...
typedef struct soc_flow_db_view_rec_s {
    ...
    char mem_name[SOC_FLOW_DB_MAX_MEM_NAME];
    uint32 width;
...
typedef struct soc_flow_db_field_rec_s {
    ...
    char name[SOC_FLOW_DB_MAX_FIELD_NAME];
