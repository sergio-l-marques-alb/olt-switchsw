...
extern void     cmicx_pktdma_desc_endian_set(int unit, int cmc, int channel);
extern void     cmicx_pktdma_ep_to_cpu_hdr_endian_set(int unit, int cmc, int channel);
extern void     cmicx_pktdma_data_endian_set(int unit, int cmc, int channel);
extern uint32   cmicx_pktdma_header_size_get(int unit);
extern uint32   cmicx_pktdma_cos_ctrl_rx0_get(int unit, int cmc, int channel);
extern uint32   cmicx_pktdma_cos_ctrl_rx1_get(int unit, int cmc, int channel);
extern uint32   cmicx_pktdma_cos_ctrl_rx0_reg_addr_get(int unit, int cmc, int channel);
extern uint32   cmicx_pktdma_cos_ctrl_rx1_reg_addr_get(int unit, int cmc, int channel);
extern uint32   cmicx_pktdma_cos_ctrl_queue_id_get(int unit, int cmc, int channel, int queue);
extern sal_vaddr_t cmicx_pktdma_desc_addr_get(int unit, int cmc, int channel);
