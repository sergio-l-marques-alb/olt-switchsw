...
typedef enum bcm_field_header_format_e {
    ...
    bcmFieldHeaderFormatCount = 41      /* Always Last. Not a usable value. */
...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyCount = 693          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionEsmSearchKeySrcMac = 490, /* This action sets ESM search key to
                                           ...
                                           Lookup */
    bcmFieldActionMacSecDecrypt = 491,  /* This action adds MACSEC Decrypt OLP
                                           header in Egress  Pipe. This action
                                           does not modify packet in Egress
                                           Pipe. */
    bcmFieldActionMacSecEncrypt = 492,  /* This action only adds MACSEC Encrypt
                                           OLP header in Egress Pipe. */
    bcmFieldActionMacSecSubPortNumAdd = 493, /* This action assigns MACSEC Subport
                                           number to be used by MACSEC engine
                                           for Security Association lookup */
    bcmFieldActionMacSecPktTypeSet = 494, /* This action assigns a MACSEC packet
                                           type to be used in MACSEC block.
                                           MACSEC packet type is defined by
                                           bcm_field_macsec_pkt_type_t. */
    bcmFieldActionLatencyFlowId = 495,  /* Update Latency-Flow-Id in OAM-TS
                                           HEADER; param0: New Latency-Flow-Id
                                           value. */
    bcmFieldActionMacSecRedirectIpmc = 496, /* This action redirects multicast
                                           MACSEC packets to MACSEC engine and
                                           also adds OLP header in Egress
                                           Pipeline. */
    bcmFieldActionCount = 497           /* Always Last. Not a usable value. */
} bcm_field_action_t;
