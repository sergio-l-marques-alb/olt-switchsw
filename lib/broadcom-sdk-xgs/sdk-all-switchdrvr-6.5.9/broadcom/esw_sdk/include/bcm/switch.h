...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchHashUseFlowSelVpTrunk = 1082, /* Enable/Disable flow based hashing for
                                           VP Trunk. */
    bcmSwitchHashUseFlowSelTrunkResilientHash = 1083, /* Enable/Disable flow based hashing for
                                           Trunk RH. */
    bcmSwitchMeterMef10dot3Enable = 1084, /* Enable meter mef 10.3 mode. */
    bcmSwitchForwardLookupNotFoundTrap = 1085, /* Set foward lookup not found Trap ID. */
    bcmSwitchEtherTypeCustom1 = 1086,   /* Set Custom_1 Ethernet type. */
    bcmSwitchEtherTypeCustom2 = 1087,   /* Set Custom_2 Ethernet type. */
    bcmSwitch__Count = 1088             /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_mpls_next_protocol_e {
    ...
    bcmSwitchMplsNextProtocolControlWord = 4, /* Speculate CW protocol aftre the MPLS
                                           stack. */
    bcmSwitchMplsNextProtocolCount = 5  /* Should be last element in enum. */
