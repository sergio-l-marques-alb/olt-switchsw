...
#define BCM_TSN_WB_SCACHE_PART_AUTO_LEARN                (4)
#define BCM_TSN_WB_SCACHE_PART_PRP_FORWARDING            (5)
#define BCM_TSN_WB_SCACHE_PART_MIN  (BCM_TSN_WB_SCACHE_PART_EGR_MTU)
#define BCM_TSN_WB_SCACHE_PART_MAX  (BCM_TSN_WB_SCACHE_PART_PRP_FORWARDING)
#else
#define BCM_TSN_WB_SCACHE_PART_MIN  (BCM_TSN_WB_SCACHE_PART_EGR_MTU)
#define BCM_TSN_WB_SCACHE_PART_MAX  (BCM_TSN_WB_SCACHE_PART_TSN_STAT_PORTCNT)
 ...
 * This is the handle provied by chip-specific algorithm as the seqnum slice
 * used for a flow.
 */
