...
typedef struct bcm_async_req_s {
	...
	/* bcm_module_name has a non int return type */
		...
		} trunk_local_attributes_get;
		struct {
			int unit;
			bcm_trunk_t tid;
			uint32 flags;
			bcm_trunk_local_attributes_t * local_attributes;
		} trunk_local_attributes_set;
		struct {
			int unit;
			bcm_trunk_t tid;
			bcm_vlan_t vid;
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_TRUNK_ID_SET,
	BCM_ASYNC_ENTRY_TRUNK_INIT,
	BCM_ASYNC_ENTRY_TRUNK_LOCAL_ATTRIBUTES_GET,
	BCM_ASYNC_ENTRY_TRUNK_LOCAL_ATTRIBUTES_SET,
