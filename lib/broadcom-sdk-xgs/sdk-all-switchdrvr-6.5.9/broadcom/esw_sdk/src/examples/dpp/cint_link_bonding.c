                   ...
                   bcm_modem_t modem_id)
{
  ...
  printf("args <unit=%d>, <lbgLif=%d>,<lbg_type=%d>,<vlan=%d>,<modem_id=%d>,\n",
         unit, lbgLif,lbg_type,vlan,modem_id);
...
int lbg_mdm_map_cfg(int unit, bcm_lbg_t lbg_id, bcm_modem_t modem_id,
  ...
  printf("args <unit=%d>, <lbg_id=%d>,<modem_id=%d>,<direction=%d>\n",
         unit, lbg_id,modem_id,direction);
...
{
    bcm_mac_t dst_mac_modems[6] = {{0x00, 0x00, 0x00, 0x00, 0x00, 0x33},
...
int lb_tx_sched_set(int unit, bcm_lbg_t lbg_id) {
    uint32 flags = 0;
    int lbg_count = 1;
    bcm_lb_lbg_weight_t lbg_weights[lbg_count];
    lbg_weights[0].lbg_id = lbg_id;
    lbg_weights[0].lbg_weight = 1;
    print "configure lbg scheduler:bcm_lb_tx_sched_set.";
    print bcm_lb_tx_sched_set(unit, flags, lbg_count, lbg_weights);
}
