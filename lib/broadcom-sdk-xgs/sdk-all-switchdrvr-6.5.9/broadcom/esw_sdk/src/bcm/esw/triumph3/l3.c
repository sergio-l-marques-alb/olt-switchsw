        ...
        bcm_l3_egress_t *l3_egress) 
{
    ...
    */
    ...
    if (soc_feature(unit, soc_feature_generic_dest)) {
        ...
        bcm_td3_riot_l3_nh_dest_set(unit, l3_egress, &ing_nh);
    } else
#endif
    {
        /* Set module id. */
    ...
    */
    ...
    if (soc_feature(unit, soc_feature_flex_flow) &&
        ...
        return _bcm_td3_l3_flex_nh_add(unit, nh_index, l3_egress, (uint32 *)&egr_nh, 1);
    }
#endif
    ...
    if (BCMI_RIOT_IS_ENABLED(unit) &&
        ...
        if (SOC_IS_TRIDENT3(unit)) {
            if (bcmi_td3_l3_nh_assoc_ol_ul_link_is_required(unit, vp_nh_index)) {
                soc_mem_field32_set(unit, EGR_L3_NEXT_HOPm, &egr_nh,
                ...
                BCM_IF_ERROR_RETURN(
                    bcmi_td3_l3_nh_assoc_ol_ul_link_sw_add(unit, nh_index,
                    vp_nh_index));
            } else {
                soc_mem_field32_set(unit, EGR_L3_NEXT_HOPm, &egr_nh,
                    L3MC__NEXT_PTR_TYPEf, BCMI_TD3_L3_NH_EGR_NEXT_PTR_TYPE_DVP);
                soc_mem_field32_set(unit, EGR_L3_NEXT_HOPm, &egr_nh,
                    L3MC__NEXT_PTRf, vp);
            }
