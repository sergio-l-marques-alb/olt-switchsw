                        ...
                        uint8 *profile_index)
{
    ...
    *profile_index = 0;
    ...
    if (SOC_IS_TRIDENT2X(unit) || SOC_IS_TOMAHAWKX(unit) || SOC_IS_TRIDENT3X(unit)) {
        ...
        /* Set URPF. */
        value = (iif->flags &
            BCM_VLAN_L3_URPF_DEFAULT_ROUTE_CHECK_DISABLE) ? 0 : 1;
        soc_mem_field32_set(unit, L3_IIF_PROFILEm, &l3_iif_profile, 
                                ...
                                iif_entry_t *hw_copy)
{
    ...
    if (soc_mem_field_valid(unit, L3_IIFm, IPMC_L3_IIFf)) {
        ...
        if (mode) {
            if(!SOC_MEM_FIELD32_VALUE_FIT(unit, L3_IIFm, IPMC_L3_IIFf,
                        iif->ipmc_intf_id)) {
                return (BCM_E_PARAM);
            }
        }else {
                             ...
                             _bcm_l3_cfg_t *l3cfg)
{
    ...
    } else if (!(SOC_IS_METROLITE(unit)) && soc_mem_field_valid(unit, mem, L3_IIFf)) {
