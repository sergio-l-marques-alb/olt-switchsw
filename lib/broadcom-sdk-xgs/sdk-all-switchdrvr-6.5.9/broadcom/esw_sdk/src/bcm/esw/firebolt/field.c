                            ...
                            _field_stage_id_t stage_id, int tcam_idx)
{
    ...
    if (SOC_IS_TRIDENT2(unit) || SOC_IS_TITAN2(unit) || SOC_IS_TD2P_TT2P(unit)) {
...
{
    static uint8  e[100]; /* Buffer to zero TCAM & Policy entry.*/
    static uint8  p[_FP_MAX_ENTRY_WIDTH][100]; /* For policies  */
