...
CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         ...
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         uint32_t, uint32_t, ts_am_norm_mode, 0, 0);
...
static cint_function_pointer_t __cint_function_pointers[8];
...
__cint_fpointer__phymod_ext_acc_f(void* acc_data)
{
    ...
    cint_interpreter_callback(__cint_function_pointers+5, 1, 1, &acc_data, &returnval);
    return returnval;
}
...
__cint_fpointer__phymod_firmware_loader_f(const phymod_core_access_t* core, uint32_t length, const uint8_t* data)
{
    ...
    cint_interpreter_callback(__cint_function_pointers+6, 3, 1, &core, &length, &data, &returnval);
    return returnval;
}
...
static cint_enum_map_t __cint_enum_map__phymod_dispatch_type_t[] =
{
    ...
    { "phymodDispatchTypePhymodNull", phymodDispatchTypePhymodNull },
