...
diag_sand_mem_list_dynamic(
    ...
    void *en)
{
#ifdef FIXME_DNX_LEGACY /* SDK-117365 */
...
#if defined (BCM_SAND_SUPPORT) && !(defined (BCM_DFE_SUPPORT) || defined (BCM_DPP_SUPPORT))
/**
    ...
    tr7_dbase_t * tr7_ptr)
{
    ...
    if (SOC_IS_JERICHO_2_A0(unit))
    {
        ...
        switch (mem)
        {
            ...
            case IPS_FCR_PREF_FIFOm:
            case OAMP_RXB_INPUT_DECISION_FIFOm:
            case OAMP_RXP_LOCAL_MEP_PART_1_FIFOm:
            case OAMP_RXP_LOCAL_MEP_PART_2_FIFOm:
            case OAMP_RXP_MDB_MEP_PART_1_PART_2_FIFOm:
            case OAMP_RXP_MDB_MEP_PART_3_PART_4_FIFOm:
            case OAMP_RXP_TEMP_PARSER_DATA_FIFOm:
            case OAMP_TXO_LENGTH_FIFOm:
            ...
            case OLP_DSPG_EVR_EVENT_FIFOm:
            case OLP_DSPR_DMT_EVENT_FIFOm:
