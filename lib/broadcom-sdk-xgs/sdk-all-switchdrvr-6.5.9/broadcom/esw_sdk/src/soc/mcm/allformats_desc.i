 ...
 */
    ...
    /* DEQ_CCP_INFO_BUS          */ "Position and description of bits in DEQ to CCP INFO bus",
    ...
    /* EP_TO_CPU_HDR_CHARIOT     */ "Egress Pipeline to CMIC/CPU HDR format",
    ...
    /* EXT_TCAM_RSP_WDATA_C3     */ "TCAM RESPONSE FORMAT",
    ...
    /* FD_EB_INTF_BUS            */ "Position and description of bits in FDM to EB interface signals",
    /* FF_EB_INTF_BUS            */ "Position and description of bits in FFM to EB interface signals",
    ...
    /* MPB_HG2_EXT_FORMAT        */ "HG2_EXT FORMAT in MMU Passthru Bus (carried from Ip to EP thru MMU).",
