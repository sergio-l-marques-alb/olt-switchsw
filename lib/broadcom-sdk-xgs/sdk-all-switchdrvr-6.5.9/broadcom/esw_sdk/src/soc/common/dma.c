...
#if defined(BCM_XGS_FABRIC_SUPPORT) || defined(BCM_XGS3_SWITCH_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_PETRA_SUPPORT) || defined(BCM_CALADAN3_SUPPORT)
void
