...
static int jer_parser_udp(int unit)
{
    ...
    ihp_parser_custom_macro_parameters_tbl_data.cstm_comparator_mask   = (1 << ARAD_PARSER_CUSTOM_MACRO_PROTO_11) |
                                                                         (1 << ARAD_PARSER_CUSTOM_MACRO_PROTO_12); /* compare to PTP entries 11 and 12 */
    ihp_parser_custom_macro_parameters_tbl_data.cstm_condition_select  = 0;
    ihp_parser_custom_macro_parameters_tbl_data.cstm_shift_sel         = 0;
...
static dpp_leaf_t ETH_leafs[] =
{
  ...
  {{{(DPP_PARSER_ETH_NEXT_PROTOCOL_MinM << 2), 3}},
          DPP_MACRO_ETH,        DPP_SEGMENT_FIN,            DPP_PFC_ETH_ETH,            DPP_PLC_PP},
  {{{(DPP_PARSER_ETH_NEXT_PROTOCOL_MinM << 2) + 3, 1}},
          DPP_MACRO_ETH,        DPP_SEGMENT_MinM,           DPP_PFC_ETH,                DPP_PLC_PP,         jer_parser_minm},
  {{{0, 64}},
          DPP_MACRO_NA,         DPP_SEGMENT_END,            DPP_PFC_ETH,                DPP_PLC_PP}
};
...
{
  {DPP_SEGMENT_FIN,            "FIN"},
  {DPP_SEGMENT_BASE,           "Base",           Base_leafs,            NOF_LEAFS(Base_leafs)           , JER_SEGMENT_FULL_SIZE},
  {DPP_SEGMENT_TM,             "TM",             TM_leafs,              NOF_LEAFS(TM_leafs)             , JER_SEGMENT_HALF_SIZE},
