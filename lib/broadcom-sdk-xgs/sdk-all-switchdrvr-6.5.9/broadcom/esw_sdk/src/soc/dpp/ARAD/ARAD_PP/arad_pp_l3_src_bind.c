    ...
    )
{
    ...
    else
    {
        ...
        qual_vals[1].is_valid.arr[0]= 0x3ffff;/*18 bit*/
    }
    ...
    )
{
    ...
    else
    {
        ...
        qual_vals[0].is_valid.arr[0]= 0x3ffff;/*18 bit*/
    }
    ...
    )
{
    ...
    qual_vals[2].is_valid.arr[0]= SOC_SAND_U32_MAX;/* 18 bits is in_lif */
    tcam_payload[0] = 1;
    ...
    )
{
    ...
    qual_vals[2].type= SOC_PPC_FP_QUAL_IRPP_IN_LIF;
    qual_vals[2].val.arr[0]= src_bind_info->lif_ndx;
    qual_vals[2].is_valid.arr[0]= 0x3FFFF;/* 18 bits is in_lif */
