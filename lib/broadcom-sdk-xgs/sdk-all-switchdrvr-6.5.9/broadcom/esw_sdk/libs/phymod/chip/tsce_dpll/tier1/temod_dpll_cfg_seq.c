...
int temod2pll_autoneg_remote_ability_get(PHYMOD_ST* pc, temod2pll_an_ability_t *an_ability_st)
{
  ...
  data = (((an_x4_pg2.v[0] >> 10) & 0x1) << 0) |
         ...
         (((an_x4_pg3.v[0] >> TEMOD2PLL_CL73_ABILITY_2P5G_POSITION) & 0x1) << TEMOD2PLL_CL73_2p5GBASE_X) |
         (((an_x4_pg3.v[0] >> TEMOD2PLL_CL73_ABILITY_5G_POSITION) & 0x1) << TEMOD2PLL_CL73_5GBASE_KR1);
