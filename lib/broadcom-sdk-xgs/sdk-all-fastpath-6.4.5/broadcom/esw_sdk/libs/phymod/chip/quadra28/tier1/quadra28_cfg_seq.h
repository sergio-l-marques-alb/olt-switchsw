...
int _quadra28_phy_reset_set(const phymod_access_t *access,  const phymod_phy_reset_t* reset);

int _quadra28_phy_reset_get(const phymod_access_t *access,  phymod_phy_reset_t* reset);
...
int _quadra28_phy_cl72_get(const phymod_access_t* phy, uint32_t* cl72_en);

int _quadra28_phy_cl72_status_get(const phymod_access_t* phy, phymod_cl72_status_t* status);
