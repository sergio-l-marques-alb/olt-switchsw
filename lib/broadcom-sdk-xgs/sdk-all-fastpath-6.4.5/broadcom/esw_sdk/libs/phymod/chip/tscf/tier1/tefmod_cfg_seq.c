...
int tefmod_set_an_port_mode(PHYMOD_ST* pc, int num_of_lanes, int starting_lane, int single_port)    /* SET_AN_PORT_MODE */
{
 ...
 /*  rdata = MAIN0_SETUPr_PORT_MODE_SELf_GET(reg_setup); */
  ...
  tefmod_get_plldiv(pc,&current_plldiv);
  if(current_plldiv == 0x7)
...
/* need to figure out what's the starting lane */
  ...
  if(CL93N72_IT_BASE_R_PMD_CTLr_CL93N72_IEEE_TRAINING_ENABLEf_GET(CL93N72_IEEE_TX_CL93N72IT_BASE_R_PMD_CONTROLr_reg) != cl72_enable) {
...
int tefmod_FEC_control(PHYMOD_ST* pc, int fec_en, int fec_dis, int cl74or91)
{
  ...
  if((fec_en &(TEFMOD_CL91_RX_EN_DIS||TEFMOD_CL91_IND_ONLY_EN_DIS||TEFMOD_CL91_COR_ONLY_EN_DIS))
   ||(fec_dis&(TEFMOD_CL91_RX_EN_DIS||TEFMOD_CL91_IND_ONLY_EN_DIS||TEFMOD_CL91_COR_ONLY_EN_DIS))) {
...
int tefmod_FEC_get(PHYMOD_ST* pc, int *fec_en, int *cl74or91) {
  TX_X1_T_CL91_FECr_t TX_X1_CONTROL0_T_CL91_FECr_reg;
  RX_X1_CL91_CFGr_t RX_X1_CONTROL0_CL91_CONFIGr_reg;
  ...
  *cl74or91 = 0;
  ...
  if(TX_X1_T_CL91_FECr_TX_CL91_FEC_ENf_GET(TX_X1_CONTROL0_T_CL91_FECr_reg)) {
    *fec_en |= TEFMOD_CL91_TX_EN_DIS;
  }
  if(RX_X1_CL91_CFGr_RX_CL91_FEC_ENf_GET(RX_X1_CONTROL0_CL91_CONFIGr_reg)) {
    *fec_en |= TEFMOD_CL91_RX_EN_DIS;
  }
  if(RX_X1_CL91_CFGr_FEC_BYP_IND_ENf_GET(RX_X1_CONTROL0_CL91_CONFIGr_reg)) {
    *fec_en |= TEFMOD_CL91_IND_ONLY_EN_DIS;
  }
  if(RX_X1_CL91_CFGr_FEC_BYP_CORR_ENf_GET(RX_X1_CONTROL0_CL91_CONFIGr_reg)) {
    *fec_en |= TEFMOD_CL91_COR_ONLY_EN_DIS;
  }

  if(TX_X4_MISCr_FEC_ENABLEf_GET(TX_X4_CONTROL0_MISCr_reg)) {
    *fec_en |= TEFMOD_CL74_TX_EN_DIS;
  }
  if(RX_X4_PCS_CTL0r_FEC_ENABLEf_GET(RX_X4_CONTROL0_PCS_CONTROL_0r_reg)) {
    *fec_en |= TEFMOD_CL74_RX_EN_DIS;
  }
  *cl74or91 = MAIN0_LN_SWPr_SPEED_100G_FEC_SELf_GET(MAIN0_LANE_SWAPr_reg);
...
int tefmod_rx_squelch_set(PHYMOD_ST *pc, int enable)
{
  ...
  if(enable){
     ...
     PHYMOD_IF_ERR_RETURN(tefmod_rx_lane_control_set(pc, 0));
  } else {
