...
_bcm_dpp_wb_cosq_restore_gbl_state(int unit)
{
    ...
    BCM_DPP_ASSYMETRIC_CORES_ITER(BCM_CORE_ALL, core) {
        ...
        if ( (ucast_qid_start >= 0) && (ucast_qid_end > 0) && (ucast_qid_end > ucast_qid_start) ) {
            ...
            rc = _bcm_dpp_am_cosq_process_queue_region(unit, core, DPP_DEVICE_COSQ_QUEUE_REGION_UNICAST, queue_region_config);
            BCMDNX_IF_ERR_EXIT(rc);
        }
        ...
        if ( !((mcast_queue_range.start == 0) && (mcast_queue_range.end == 0))  &&
            ...
            rc = _bcm_dpp_am_cosq_process_queue_region(unit, core, DPP_DEVICE_COSQ_QUEUE_REGION_MULTICAST, queue_region_config);
            BCMDNX_IF_ERR_EXIT(rc);
        }
        ...
        if (isp_info.enable) {
            ...
            rc = _bcm_dpp_am_cosq_process_queue_region(unit, core, DPP_DEVICE_COSQ_QUEUE_REGION_ISQ, queue_region_config);
            BCMDNX_IF_ERR_EXIT(rc);
        }
