...
int _bcm_common_init(int unit)
{
    ...
    if (SOC_MEM_IS_VALID(unit, MPLS_STATION_TCAMm)) {
        ...
        if (soc_feature(unit, soc_feature_riot)) {
            ...
            /* L3 flags */
            soc_mem_field32_set(unit, MY_STATION_TCAM_2m,
            ...
            soc_mem_field32_set(unit, MY_STATION_TCAM_2m,
                                &info->my_station2_tunnel_mask,
                                MPLS_TERMINATION_ALLOWEDf, 1);
            if (soc_mem_field_valid(unit, MY_STATION_TCAM_2m, 
                                    TRILL_TERMINATION_ALLOWEDf)) {
                soc_mem_field32_set(unit, MY_STATION_TCAM_2m,
                                &info->my_station2_tunnel_mask,
                                TRILL_TERMINATION_ALLOWEDf, 1);
                                ...
                                my_station_tcam_entry_t *entry)
{
    ...
    l2caddr->src_port = 
        _BCM_TRX_MYSTA_FIELD32_MEMACC_GET(unit, memacc_list, entry, ING_PORT_NUMf);
    l2caddr->src_port_mask = 
        _BCM_TRX_MYSTA_FIELD32_MEMACC_GET(unit, memacc_list, entry, ING_PORT_NUM_MASKf);
                              ...
                              bcm_l2_cache_addr_t *l2caddr)
{
    ...
    _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, entry, VALIDf, 1);
    ...
    _BCM_TRX_MYSTA_MAC_ADDR_MEMACC_SET(unit, memacc_list, entry, MAC_ADDR_MASKf,
                         l2caddr->mac_mask);
    _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, entry, ING_PORT_NUMf,
                        l2caddr->src_port);
    _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, entry, ING_PORT_NUM_MASKf,
                        l2caddr->src_port_mask);
                          ...
                          int *entry_index, int *alt_index)
{
    ...
    _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, &entry0, VALIDf, 1);
    ...
    if (alt_index != NULL) {
        ...
        _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, &entry2, VALIDf, 1);
    }
                             ...
                             int *result_index)
{
    ...
    _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, &mask0, VALIDf, 1);
                           ...
                           bcm_port_t port, int tunnel_term)
{
    ...
    if (port != -1) {
        if (soc_mem_field_valid(unit, mem, SOURCE_FIELDf))
        {
            ...
            _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, entry, SOURCE_FIELDf,
                                port);
            port_mask = (1 << soc_mem_field_length(unit, mem,
                                                   SOURCE_FIELDf)) - 1;
            _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, entry, SOURCE_FIELD_MASKf,
                            port_mask);   
        } else {
            _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, entry, ING_PORT_NUMf,
                                port);
...
bcm_td_metro_myStation_delete_all(int unit)
{
    ...
    _BCM_TRX_MYSTA_FIELD32_MEMACC_SET(unit, memacc_list, &valid_mask, VALIDf, 1);
