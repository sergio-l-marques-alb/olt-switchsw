...
/*
 * Function:
 *      _bcm_xgs5_port_addressable_local_get
 * Description:
 ...
 */
STATIC int
_bcm_xgs5_port_addressable_local_get(int unit,
    ...
    
{
    ...
    /* Check that port is within valid port range */
                            ...
                            bcm_gport_t port, bcm_port_resource_t *resource)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_port_addressable_local_get(unit,
                                              port, &lport1));
    BCM_IF_ERROR_RETURN
        (_bcm_xgs5_port_addressable_local_get(unit,
    ...
    return bcmi_xgs5_port_resource_multi_set(unit, 1, resource);
}
