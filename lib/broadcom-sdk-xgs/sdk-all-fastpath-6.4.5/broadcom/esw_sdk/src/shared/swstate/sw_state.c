...
STATIC int shr_sw_state_nof_allocations = 0;

int shr_sw_state_nof_allocations_get(void) {
    return shr_sw_state_nof_allocations;
}
...
#if AGGRESSIVE_ALLOC_DEBUG_TESTING
    int shr_sw_state_free_location = -1;
#endif /* AGGRESSIVE_ALLOC_DEBUG_TESTING */
...
#if AGGRESSIVE_ALLOC_DEBUG_TESTING
            if(shr_sw_state_free_location == -1) {
                shr_sw_state_free_location = indx;
                --shr_sw_state_nof_allocations;
            }
#endif /* AGGRESSIVE_ALLOC_DEBUG_TESTING */
