...
system_vlan_port_create(
    ...
    if (encoding) {
        rv = system_vlan_port_to_vlan_port_id(unit, vp , &gport_encoding);
        if (rv != BCM_E_NONE){
            printf("Error, system_vlan_port_to_vlan_port_id\n"); 
            print rv;
            return rv;
        }
    }
...
int system_vlan_port_mp_example(int unit1, int port1, int second_port1, int unit2, int port2){
    ...
    uint32 v1 = 10;
    bcm_gport_t gport1=5000;
    uint32 v2 = 30;
    bcm_gport_t gport2=5000;
    bcm_gport_t second_gport1=5001;
...
int system_vlan_port_p2p_example(int unit1, int port1, int unit2, int port2){
    int rv = BCM_E_NONE;
    uint32 v1 = 102;
    bcm_gport_t gport1=7000;
    uint32 v2 = 201;
    bcm_gport_t gport2=7000;
    bcm_l2_gport_forward_info_t forward_info;
...
int system_protected_vlan_port_example(int unit1, int port1, int unit2, int port2,int port3, int is_mp){
    ...
    int base = 0;
    /* on unit2 */
    bcm_gport_t gport2_lif_a =5000+base;
    bcm_gport_t gport2_lif_b =5001+base;
    /* on unit1 */
    ...
    uint32 v3 = 30;
    /* on unit1 */
    bcm_gport_t gport1_lif =5000+base;
