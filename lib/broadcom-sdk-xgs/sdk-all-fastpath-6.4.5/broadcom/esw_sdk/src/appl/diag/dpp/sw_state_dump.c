...
void SOC_TMC_CNT_MODE_STATISTICS_SW_DUMP_PRINT(void* element, char* variableName); 
...
void ARAD_PP_OAM_MY_MAC_LSB_SW_DUMP_PRINT(void* element, char* variableName); 
void ARAD_PP_OAM_MY_MAC_LSB_REF_COUNT_SW_DUMP_PRINT(void* element, char* variableName); 
...
void ARAD_PP_MAC_LIMIT_PER_TUNNEL_INFO_SW_DUMP_PRINT(void* element, char* variableName); 
...
void bcm_dpp_cosq_config_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES);
   arraySizes_SW_DUMP[1]=DPP_DEVICE_FMQ_CLASS_PORTS; 
   printArray(arraySizes_SW_DUMP, 0, 2, variableNameWithPath, (void**) elt->fmq_class_ports, bcm_gport_t_SW_DUMP_PRINT, 0, sizeof(bcm_gport_t)); 

   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".isq_port"); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) &(elt->isq_port), bcm_gport_t_SW_DUMP_PRINT, 0, sizeof(bcm_gport_t)); 
   ...
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->default_se, INT_SW_DUMP_PRINT, 0, sizeof(elt->default_se[0])); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".default_se_flow"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->default_se_flow, INT_SW_DUMP_PRINT, 0, sizeof(elt->default_se_flow[0])); 
   ...
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->connector_hd, bcm_dpp_cosq_list_hd_t_SW_DUMP_PRINT, 0, sizeof(bcm_dpp_cosq_list_hd_t)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".se_hd"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->se_hd, bcm_dpp_cosq_list_hd_t_SW_DUMP_PRINT, 0, sizeof(bcm_dpp_cosq_list_hd_t)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".flow_hd"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->flow_hd, bcm_dpp_cosq_list_hd_t_SW_DUMP_PRINT, 0, sizeof(bcm_dpp_cosq_list_hd_t)); 
   ...
   bcm_fabric_vsq_category_mode_t_SW_DUMP_PRINT((void*) &(elt->ingress[0].vsq_category_mode), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".ucast_qid_start"); 
   INT_SW_DUMP_PRINT((void*) &(elt->ingress[0].ucast_qid_start), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".ucast_qid_end"); 
   INT_SW_DUMP_PRINT((void*) &(elt->ingress[0].ucast_qid_end), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void SOC_TMC_CNT_COUNTERS_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".mode_statistics"); 
   SOC_TMC_CNT_MODE_STATISTICS_SW_DUMP_PRINT((void*) &(elt->mode_statistics), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void bcm_dpp_state_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath,  "sw_state.dpp.bcm.trill[0]"); 
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.bcm.trill) { 
      bcm_dpp_trill_state_t_SW_DUMP_PRINT((void*) sw_state[0]->dpp.bcm.trill, variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void bcm_dpp_wb_alloc_info_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   arraySizes_SW_DUMP[0]= dpp_am_res_count; 
...
void bcm_dpp_wb_cosq_info_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->max_conns, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".conn_off"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->conn_off, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".max_ses"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->max_ses, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".se_off"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->se_off, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".max_flows"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->max_flows, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".flow_off"); 
   arraySizes_SW_DUMP[0]=SOC_DPP_DEFS_MAX(NOF_CORES); 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->flow_off, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
...
void ARAD_PP_SW_DB_DEVICE_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->oam_my_mac_lsb) { 
      ARAD_PP_OAM_MY_MAC_LSB_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->oam_my_mac_lsb), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->llp_filter) { 
      ARAD_PP_SW_DB_LLP_FILTER_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->llp_filter), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->llp_vid_assign) { 
      ARAD_PP_SW_DB_LLP_VID_ASSIGN_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->llp_vid_assign), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->pon_double_lookup) { 
      ARAD_PON_DOUBLE_LOOKUP_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->pon_double_lookup), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->ilm_info) { 
      ARAD_PP_ILM_INFO_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->ilm_info), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->fwd_mact) { 
      ARAD_PP_FWD_MACT_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->fwd_mact), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->lif_cos) { 
      ARAD_PP_SW_DB_LIF_COS_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->lif_cos), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->lif_table) { 
      ARAD_PP_SW_DB_LIF_TABLE_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->lif_table), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->fec) { 
      ARAD_PP_FEC_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->fec), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->diag) { 
      ARAD_PP_SW_DB_DIAG_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->diag), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->lag) { 
      ARAD_PP_LAG_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->lag), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->vrrp_info) { 
      ARAD_PP_SW_DB_VRRP_INFO_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->vrrp_info), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->mac_limit_info) { 
      ARAD_PP_MAC_LIMIT_PER_TUNNEL_INFO_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->mac_limit_info), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   /* check the pointer is not null */ 
   if (sw_state[0]->dpp.soc.arad.pp->header_data) { 
      ARAD_PP_HEADER_DATA_SW_DUMP_PRINT((void*) &(*sw_state[0]->dpp.soc.arad.pp->header_data), variableNameWithPath); 
   } else { 
       sal_fprintf(output_file, "%s: null \n ", variableNameWithPath); 
   } 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void ARAD_PP_OAM_MY_MAC_LSB_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   ARAD_PP_OAM_MY_MAC_LSB *elt = ((ARAD_PP_OAM_MY_MAC_LSB*) element); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".ref_count"); 
   ARAD_PP_OAM_MY_MAC_LSB_REF_COUNT_SW_DUMP_PRINT((void*) &(elt->ref_count), variableNameWithPath); 
} 
void ARAD_PP_OAM_MY_MAC_LSB_REF_COUNT_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
   ARAD_PP_OAM_MY_MAC_LSB_REF_COUNT *elt = ((ARAD_PP_OAM_MY_MAC_LSB_REF_COUNT*) element); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".ref_count"); 
   arraySizes_SW_DUMP[0]=ARAD_PP_OAM_MY_MAC_LSB_REF_COUNT_NUM; 
...
void ARAD_PP_SW_DB_LLP_TRAP_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->l3_protocols_multi_set[0]), variableNameWithPath); 
} 
void SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
...
void ARAD_PP_SW_DB_LLP_MIRROR_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->mirror_profile_multi_set[0]), variableNameWithPath); 
} 
void ARAD_PP_SW_DB_LLP_VID_ASSIGN_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
...
void ARAD_PP_SW_DB_EG_ENCAP_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->prog_data[0]), variableNameWithPath); 
} 
void ARAD_PP_SW_DB_LLP_COS_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->ether_type_multi_set[0]), variableNameWithPath); 
} 
void ARAD_PP_SW_DB_ETH_POLICER_MTR_PROFILE_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->eth_meter_profile_multi_set[0]), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".global_meter_profile_multi_set"); 
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->global_meter_profile_multi_set[0]), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void ARAD_PP_SW_DB_L2_LIF_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->vlan_compression_range_multi_set[0]), variableNameWithPath); 
} 
void ARAD_PP_SW_DB_L2_LIF_AC_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   ...
   SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT((void*) &(elt->ac_key_map_multi_set[0]), variableNameWithPath); 
} 
void ARAD_PP_SW_DB_VRRP_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
...
void ARAD_PP_MAC_LIMIT_PER_TUNNEL_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
   ARAD_PP_MAC_LIMIT_PER_TUNNEL_INFO *elt = ((ARAD_PP_MAC_LIMIT_PER_TUNNEL_INFO*) element); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void ARAD_SW_DB_DEVICE_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   ARAD_SW_DB_OP_MODE_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->op_mode), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".lag"); 
   ...
   arraySizes_SW_DUMP[0]=SOC_TMC_ITM_NOF_QT_NDXS; 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->q_type_ref_count, uint8_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   ...
   ARAD_SW_DB_TCAM_MGMT_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->tcam_mgmt), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) sw_state[0]->dpp.soc.arad.tm->pmf, ARAD_PMF_SW_DUMP_PRINT, 0, sizeof(ARAD_PMF)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   ARAD_SW_DB_TM_SW_DUMP_PRINT((void*) &(sw_state[0]->dpp.soc.arad.tm->tm_info[0]), "sw_state[0]->dpp.soc.arad.tm->tm_info[0]"); 
} 
void ARAD_SW_DB_OP_MODE_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
...
void ARAD_SW_DB_DEV_EGR_PORTS_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) sw_state[0]->dpp.soc.arad.tm->arad_egr_ports->port_reserved_reassembly_context, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
...
void ARAD_SW_DB_TCAM_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_HASH_TABLE_INFO_SW_DUMP_PRINT((void*) &(elt->entry_id_to_location[0]), variableNameWithPath); 
} 
void ARAD_TCAM_SORTED_LIST_RESTORE_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
...
void ARAD_SW_DB_VTT_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_HASH_TABLE_INFO_SW_DUMP_PRINT((void*) &(elt->isem_key_to_entry_id[0]), variableNameWithPath); 
} 
void ARAD_SW_DB_VSI_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
...
void ARAD_SW_DB_FRWRD_IP_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SOC_SAND_HASH_TABLE_INFO_SW_DUMP_PRINT((void*) &(elt->route_key_to_entry_id[0]), variableNameWithPath); 
}  
void ARAD_PMF_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int arraySizes_SW_DUMP[4]; 
...
void arad_wb_db_info_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   INT_SW_DUMP_PRINT((void*) &(elt->size), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".port_priority_cal_num"); 
   uint32_SW_DUMP_PRINT((void*) &(elt->port_priority_cal_num), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".port_priority_cal_off"); 
   uint32_SW_DUMP_PRINT((void*) &(elt->port_priority_cal_off), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".tcg_cal_num"); 
   uint32_SW_DUMP_PRINT((void*) &(elt->tcg_cal_num), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".tcg_cal_off"); 
   uint32_SW_DUMP_PRINT((void*) &(elt->tcg_cal_off), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".q_type_ref_count_num"); 
   uint32_SW_DUMP_PRINT((void*) &(elt->q_type_ref_count_num), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".q_type_ref_count_off"); 
   uint32_SW_DUMP_PRINT((void*) &(elt->q_type_ref_count_off), variableNameWithPath); 
...
void sw_state_dump(char *file_name) { 
  ...
  printArray(arraySizes_SW_DUMP, 0, 1, "_bcm_bfd_endpoint_list", (void**) _bcm_bfd_endpoint_list, endpoint_list_t_SW_DUMP_PRINT, 0, sizeof(endpoint_list_t)); 
   ...
   if(SOC_DPP_CONFIG(0)->arad->init.pp_enable)
   {
       l2_data_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.l2), "sw_state.dpp.bcm.l2[0]");
       arraySizes_SW_DUMP[0]=BCM_LOCAL_UNITS_MAX;
       ...
       bcm_dpp_l3_info_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.l3), "sw_state.dpp.bcm.l3[0]");
       _bcm_petra_mirror_unit_data_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.mirror), "sw_state.dpp.bcm.mirror[0]");
   }
   arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS; 
   ...
   {
       arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS;
       _dpp_policer_state_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.policer), "sw_state.dpp.bcm.policer[0]");
   }
   bcm_dpp_port_config_t_SW_DUMP_PRINT((void*) &(sw_state[0]->dpp.bcm.port->dpp_port_config), "sw_state[0]->dpp.bcm.port->dpp_port_config"); 
   arraySizes_SW_DUMP[0]=SOC_MAX_NUM_DEVICES; 
...
/*   arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS; 
   ...
   if(SOC_DPP_CONFIG(0)->arad->init.pp_enable)
   {
       bcm_stg_info_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.stg), "sw_state.dpp.bcm.stg[0]");
   }
   ...
   trunk_state_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.trunk), "sw_state.dpp.bcm.trunk[0]");
   }
   ...
   if(SOC_DPP_CONFIG(0)->arad->init.pp_enable)
   {
   _bcm_dpp_vlan_unit_state_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.vlan), "sw_state.dpp.bcm.vlan[0]");
   _bcm_dpp_vswitch_bookkeeping_t_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.bcm.vswitch), "sw_state.dpp.bcm.vswitch[0]");
   }
#ifdef BCM_WARM_BOOT_SUPPORT 
   arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS; 
   ...
   arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS; 
   arraySizes_SW_DUMP[1]=SOC_PPD_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_IDS; 
   ...
   arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS; 
   arraySizes_SW_DUMP[1]=SOC_PPD_MAX_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS; 
