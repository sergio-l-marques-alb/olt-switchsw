/* $Id: ui_ppd_api_frwrd_trill.c,v 1.7 Broadcom SDK $
  ...
  )
{
  uint32
    ret;
  SOC_PPD_TRILL_MC_MASKED_FIELDS
    prm_masked_fields;
  ...
  SOC_PPD_TRILL_MC_MASKED_FIELDS_clear(&prm_masked_fields);
  ...
  )
{
  ...
  SOC_PPD_TRILL_MC_MASKED_FIELDS_print(&prm_masked_fields);
  ...
  )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_TRILL_MC_ROUTE_KEY_clear(&prm_trill_mc_key);
...
{   
  ...
  SOC_PPD_TRILL_ADJ_INFO_clear(&prm_mac_auth_info);
...
{   
  ...
  SOC_PPD_TRILL_ADJ_INFO_print(&prm_mac_auth_info);
...
{   
  uint32 
    ret;   
  SOC_PPD_FRWRD_TRILL_GLOBAL_INFO   
    prm_glbl_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_TRILL_GLOBAL_INFO_clear(&prm_glbl_info);
...
{   
  ...
  SOC_PPD_FRWRD_TRILL_GLOBAL_INFO_print(&prm_glbl_info);
