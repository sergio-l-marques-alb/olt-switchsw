/*
 * $Id: fe3200_drv.c,v 1.1.2.1 Broadcom SDK $
 *
...
soc_fe3200_reset_cmic_iproc_regs(int unit) 
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_dcmn_cmic_sbus_timeout_set(unit, SOC_DFE_CONFIG(unit).core_clock_speed /*KHz*/, SOC_CONTROL(unit)->schanTimeout));
...
#define _SOC_FE3200_DRV_MULTIPLIER_MAX_LINK_SCORE                   (120)
    ...
    */
    ...
    for(total_links = 1 ; total_links <= _SOC_FE3200_DRV_MULTIPLIER_TABLE_MAX_LINKS ; total_links++) {
        ...
        for(active_links = 1 ; active_links <= total_links ; active_links++) {
            score = (_SOC_FE3200_DRV_MULTIPLIER_MAX_LINK_SCORE * active_links) / total_links;
...
soc_fe3200_set_fmac_config(int unit)
{
    ...
    if (SOC_DFE_IS_FE13(unit))
    {
       PBMP_SFI_ITER(unit, link)
       {
           SOCDNX_IF_ERR_EXIT(MBCM_DFE_DRIVER_CALL(unit,mbcm_dfe_fabric_link_device_mode_get,(unit, link, 0/*tx*/, &link_mode)));
    ...
    for(i=0; i<nof_links_in_mac; i++) {
        SOCDNX_IF_ERR_EXIT(READ_FMAC_FMAL_TX_GENERAL_CONFIGURATIONr(unit, REG_PORT_ANY, i, &reg_val32));
...
soc_fe3200_set_fsrd_config(int unit)
{
    ...
    if (SOC_DFE_IS_FE13_ASYMMETRIC(unit) || SOC_DFE_IS_FE2(unit))
    {
        ...
        {
            SOCDNX_IF_ERR_EXIT(READ_FSRD_SRD_QUAD_CTRLr(unit, 8, 2, &reg_val32)); /* 8*3 + 2 */
        ...
        {
            SOCDNX_IF_ERR_EXIT(READ_FSRD_SRD_QUAD_CTRLr(unit, 11, 2, &reg_val32)); /* 11*3 + 2 */
            soc_reg_field_set(unit, FSRD_SRD_QUAD_CTRLr, &reg_val32, SRD_QUAD_N_LCREF_ENf, 0);
...
soc_fe3200_set_rtp_config(int unit)
{
    ...
    core_clock_speed = SOC_DFE_CONFIG(unit).core_clock_speed;
     ...
     /*RTPWP CALC*/
    wp_at_core_clock_steps = ((SOC_DFE_IMP_DEFS_GET(unit, rtp_reachabilty_watchdog_rate)/ 1000)/*micro sec*/ * core_clock_speed /*KHz*/) / 1000 /*convert micro sec to mili */;
    rtpwp = wp_at_core_clock_steps/4096;
    rtpwp = (rtpwp * 4096 < wp_at_core_clock_steps) ? rtpwp+1 : rtpwp; /*ceiling*/

    SOCDNX_IF_ERR_EXIT(READ_RTP_REACHABILITY_MESSAGE_PROCESSOR_CONFIGURATIONr(unit, &reg_val32));
    soc_reg_field_set(unit, RTP_REACHABILITY_MESSAGE_PROCESSOR_CONFIGURATIONr, &reg_val32, RTPWPf, rtpwp);
    SOCDNX_IF_ERR_EXIT(WRITE_RTP_REACHABILITY_MESSAGE_PROCESSOR_CONFIGURATIONr(unit, reg_val32));
...
soc_fe3200_set_dcm_config(int unit)
{
    ...
    for (i=0 ; i < SOC_DFE_MAX_NOF_PIPES; i++) /* iterate over all possible pipes*/
    {
       

        /* init fifo size threshold*/
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_size_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.fifo_size[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_size_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.fifo_size[i]));
        ...
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_almost_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], -1 /*both almost full thresholds*/, 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.almost_full_threshold[i]));

        /* set bcmFabricLinkMidPrio[0-3]Drop*/

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio0Drop, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_0_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio0Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_0_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio1Drop, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_1_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio1Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_1_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio2Drop, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_2_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio2Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_2_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio3Drop, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_3_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio3Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.prio_3_threshold[i]));

        /* set bcmFabricLinkMidGciLvl[1-3]FC */

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_gci_threshold_set(unit, bcmFabricLinkMidGciLvl1FC, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.gci_low_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_gci_threshold_set(unit, bcmFabricLinkMidGciLvl1FC, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.gci_low_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_gci_threshold_set(unit, bcmFabricLinkMidGciLvl2FC, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.gci_med_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_gci_threshold_set(unit, bcmFabricLinkMidGciLvl2FC, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.gci_med_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_gci_threshold_set(unit, bcmFabricLinkMidGciLvl3FC, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.gci_high_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_gci_threshold_set(unit, bcmFabricLinkMidGciLvl3FC, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.gci_high_threshold[i]));

        /* set bcmFabricLinkMidRciLvl[1-3]FC */

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_rci_threshold_set(unit, bcmFabricLinkMidRciLvl1FC, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.rci_low_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_rci_threshold_set(unit, bcmFabricLinkMidRciLvl1FC, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.rci_low_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_rci_threshold_set(unit, bcmFabricLinkMidRciLvl2FC, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.rci_med_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_rci_threshold_set(unit, bcmFabricLinkMidRciLvl2FC, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.rci_med_threshold[i]));

        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_rci_threshold_set(unit, bcmFabricLinkMidRciLvl3FC, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.rci_high_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_rci_threshold_set(unit, bcmFabricLinkMidRciLvl3FC, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.rci_high_threshold[i]));

        /* set DCM Full thresholds */
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.full_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.full_threshold[i]));
    ...
    if (SOC_DFE_IS_FE13(unit) && SOC_DFE_CONFIG(unit).fabric_local_routing_enable)
    {
        ...
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 0 /*dcm_instance*/, 0/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 0 /*dcm_instance*/, 1/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 1 /*dcm_instance*/, 0/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 1 /*dcm_instance*/, 1/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 2 /*dcm_instance*/, 2/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 2 /*dcm_instance*/, 3/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 3 /*dcm_instance*/, 2/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_type_set(unit, 3 /*dcm_instance*/, 3/*fifo_index*/, soc_dfe_fabric_link_fifo_type_index_1));

        for (i=0 ; i < SOC_DFE_MAX_NOF_PIPES; i++) /* iterate over all possible pipes*/
        {
            /*Adjust thresholds for local switching*/
            /*fifo size*/
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_fifo_size_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, dcm_thresholds_default_values.local_switch_fifo_size[i]));
            ...
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_almost_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 
             ...
             /* set bcmFabricLinkMidPrio[0-3]Drop*/
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio0Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, SOC_FE3200_DCM_MAX_THRESHOLD));
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio1Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, SOC_FE3200_DCM_MAX_THRESHOLD));
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio2Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, SOC_FE3200_DCM_MAX_THRESHOLD));
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_prio_drop_threshold_set(unit, bcmFabricLinkMidPrio3Drop, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, SOC_FE3200_DCM_MAX_THRESHOLD));

            /* set DCM Full thresholds */
            SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_mid_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1 /*is_fe1*/, 1/*is_fe3*/, SOC_FE3200_DCM_MAX_THRESHOLD));
        }
...
soc_fe3200_set_dcl_config(int unit)
{
    ...
    for (i=0; i < 3; i++)
    {
        ...
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_tx_fifo_size_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1, 1, dcl_thresholds_default_values.fifo_size[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_tx_fifo_size_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1, 1, dcl_thresholds_default_values.fifo_size[i]));
        ...
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_tx_almost_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_0, pipes[i], 1, 1, dcl_thresholds_default_values.almost_full_threshold[i]));
        SOCDNX_IF_ERR_EXIT(soc_fe3200_fabric_flow_control_tx_almost_full_threshold_set(unit, soc_dfe_fabric_link_fifo_type_index_1, pipes[i], 1, 1, dcl_thresholds_default_values.almost_full_threshold[i]));
...
soc_fe3200_reset_device(int unit)
{
    ...
    /* blocks reset*/
    rc = soc_fe3200_drv_blocks_reset(unit, 0 /*full reset*/ , NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
soc_fe3200_drv_pll_config_set(int unit)
{
    ...
    SOCDNX_IF_ERR_EXIT(READ_ECI_POWERUP_CONFIGr(unit, &reg32_val));
 ...
 * Parameters:
 *      unit  -                     (IN)     Unit number.
 *      soft_reset_mode_flags -     (IN)     SOC_DCMN_RESET_ACTION_IN_RESET, SOC_DCMN_RESET_ACTION_OUT_RESET, SOC_DCMN_RESET_ACTION_INOUT_RESET
 * Returns:
 *      SOC_E_NONE     No Error  
...
soc_fe3200_drv_test_reg_filter(int unit, soc_reg_t reg, int *is_filtered)
{
    ...
    *is_filtered = 0;
    ...
    switch (reg) 
    {
       ...
       case CCS_INDIRECT_COMMANDr:
       case DCH_INDIRECT_COMMANDr:
       case DCL_INDIRECT_COMMANDr:
       case DCMC_INDIRECT_COMMANDr:
       case OCCG_INDIRECT_COMMANDr:
       ...
       case CCS_INDIRECT_COMMAND_ADDRESSr:
       case CCS_INDIRECT_COMMAND_WR_DATAr:
       case CCS_RESERVED_PCMI_0_Tr:
       case CCS_RESERVED_PCMI_1_Tr:
       case CCS_RESERVED_PCMI_2_Tr:	       	
       case CCS_RESERVED_PCMI_3_Tr:	
       case CCS_RESERVED_PCMI_4_Tr:
       case DCH_INDIRECT_COMMAND_ADDRESSr:
       case DCH_INDIRECT_COMMAND_WR_DATAr:
       case DCH_RESERVED_PCMI_0_Tr:
       case DCH_RESERVED_PCMI_1_Tr:
       case DCH_RESERVED_PCMI_3_Tr:
       case DCL_RESERVED_PCMI_2_Tr:
       case DCL_RESERVED_PCMI_3_Tr:
       case DCL_RESERVED_PCMI_4_Tr:
       case DCMC_INDIRECT_COMMAND_ADDRESSr:
       case DCMC_INDIRECT_COMMAND_WR_DATAr:
       case DCMC_RESERVED_PCMI_0_Tr:
       case DCMC_RESERVED_PCMI_1_Tr:
       case DCMC_RESERVED_PCMI_2_Tr:
       case DCMC_RESERVED_PCMI_3_Tr:
       case DCMC_RESERVED_PCMI_4_Tr:	
       case DCM_INDIRECT_COMMANDr:
       case DCM_INDIRECT_COMMAND_ADDRESSr:
       case DCM_INDIRECT_COMMAND_WR_DATAr:
       case DCM_RESERVED_PCMI_3_Tr:
       ...
       case OCCG_INDIRECT_COMMAND_ADDRESSr:
       case OCCG_INDIRECT_COMMAND_WR_DATAr:
       case OCCG_RESERVED_PCMI_0_Tr:	
       case OCCG_RESERVED_PCMI_1_Tr:
       case OCCG_RESERVED_PCMI_2_Tr:
       case OCCG_RESERVED_PCMI_3_Tr:
       case OCCG_RESERVED_PCMI_4_Tr:
...
soc_fe3200_drv_test_brdc_blk_filter(int unit, soc_reg_t reg, int *is_filtered)
{
    ...
    *is_filtered = 0;
    ...
    {   
        ...
        case BRDC_FMAC_AC_ERROR_INITIATION_DATAr:
        case BRDC_FMAC_AC_INDIRECT_COMMANDr:
        case BRDC_FMAC_AC_INDIRECT_COMMAND_WR_DATAr:
        case BRDC_FMAC_AC_INDIRECT_COMMAND_ADDRESSr:
        case BRDC_FMAC_AC_RESERVED_PCMI_0_Tr:
        case BRDC_FMAC_AC_RESERVED_PCMI_1_Tr:
        case BRDC_FMAC_AC_RESERVED_PCMI_2_Tr:
        case BRDC_FMAC_AC_RESERVED_PCMI_3_Tr:
        case BRDC_FMAC_AC_RESERVED_PCMI_4_Tr:
        /*FMAC_BD*/
        ...
        case BRDC_FMAC_BD_ERROR_INITIATION_DATAr:
        case BRDC_FMAC_BD_INDIRECT_COMMANDr:
        case BRDC_FMAC_BD_INDIRECT_COMMAND_WR_DATAr:
        case BRDC_FMAC_BD_INDIRECT_COMMAND_ADDRESSr:
        case BRDC_FMAC_BD_RESERVED_PCMI_0_Tr:
        case BRDC_FMAC_BD_RESERVED_PCMI_1_Tr:
        case BRDC_FMAC_BD_RESERVED_PCMI_2_Tr:
        case BRDC_FMAC_BD_RESERVED_PCMI_3_Tr:
        case BRDC_FMAC_BD_RESERVED_PCMI_4_Tr:
        /*FSRD*/
        ...
        case BRDC_FSRD_RESERVED_PCMI_3_Tr:
        ...
        case BRDC_DCH_INDIRECT_COMMANDr:
        case BRDC_DCH_INDIRECT_COMMAND_ADDRESSr:
        case BRDC_DCH_INDIRECT_COMMAND_WR_DATAr:
        case BRDC_DCH_RESERVED_PCMI_0_Tr:
        case BRDC_DCH_RESERVED_PCMI_1_Tr:
        case BRDC_DCH_RESERVED_PCMI_2_Tr:
        case BRDC_DCH_RESERVED_PCMI_3_Tr:
        ...
        case BRDC_DCM_INDIRECT_COMMANDr:
        case BRDC_DCM_INDIRECT_COMMAND_ADDRESSr:
        case BRDC_DCM_INDIRECT_COMMAND_WR_DATAr:
        case BRDC_DCM_RESERVED_PCMI_0_Tr:
        case BRDC_DCM_RESERVED_PCMI_1_Tr:
        case BRDC_DCM_RESERVED_PCMI_2_Tr:
        case BRDC_DCM_RESERVED_PCMI_3_Tr:
        ...
        case BRDC_DCL_RESERVED_PCMI_2_Tr:
        case BRDC_DCL_RESERVED_PCMI_3_Tr:
        case BRDC_DCL_RESERVED_PCMI_4_Tr:
        ...
        case BRDC_CCS_INDIRECT_COMMANDr:
        case BRDC_CCS_INDIRECT_COMMAND_ADDRESSr:
        case BRDC_CCS_INDIRECT_COMMAND_WR_DATAr:
        case BRDC_CCS_RESERVED_PCMI_0_Tr:
        case BRDC_CCS_RESERVED_PCMI_1_Tr:
        case BRDC_CCS_RESERVED_PCMI_2_Tr:
        case BRDC_CCS_RESERVED_PCMI_3_Tr:
        case BRDC_CCS_RESERVED_PCMI_4_Tr:
                *is_filtered = 1;
                break;
        default:
            break;
...
soc_fe3200_drv_fe13_graceful_shutdown_set(int unit, soc_pbmp_t active_links, soc_pbmp_t unisolated_links, int shutdown) 
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_fe3200_drv_graceful_shutdown_set(unit, active_links, shutdown, unisolated_links, 1 /*param not relevant for fe13 isolate*/));
...
soc_fe3200_drv_fe13_isolate_set(int unit, soc_pbmp_t unisolated_links_pbmp, int isolate) 
{
    ...
    if (isolate)
    {
        ...
        rv = READ_RTP_RESERVED_10r(unit, &reg32);
        SOCDNX_IF_ERR_EXIT(rv);
        soc_reg_field_set(unit, RTP_RESERVED_10r, &reg32, FIELD_0_7f, 0x1);
        rv = WRITE_RTP_RESERVED_10r(unit, reg32);
        SOCDNX_IF_ERR_EXIT(rv);
