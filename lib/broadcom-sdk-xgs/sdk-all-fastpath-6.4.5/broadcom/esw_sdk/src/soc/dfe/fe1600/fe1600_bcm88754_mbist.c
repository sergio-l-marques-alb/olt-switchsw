/* $Id: fe1600_bcm88754_mbist.c,v 1.1 Broadcom SDK $
...
/*********************************************************************
*     Perform an mbist check on FE1600.
...
int soc_bist_all_fe1600_bcm88754(const int unit, const int skip_errors)
{
    ...
    /* initialize MBIST */
    SOCDNX_IF_ERR_EXIT(soc_dcmn_mbist_init(unit, &ovdat_mbist_device, &dynamic));

    /* run the generated tests */
    DCMN_MBIST_TEST_SCRIPT(non_wl_membistpv_pass_fail_pll_driven_noclks_120514_no_pcu, ovdat_mbist_device);
/*    DCMN_MBIST_TEST_SCRIPT(non_wl_membistpv_pass_fail_pll_driven_noclks_120514_no_pcu_2); */
...
exit:
     soc_dcmn_mbist_deinit(unit, &ovdat_mbist_device, &dynamic);
