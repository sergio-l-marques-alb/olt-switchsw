...
int portmod_ext_phy_attach(int unit, int phy, const phymod_core_access_t* ext_phy_access, const uint32 first_phy_lane) {
    int i = 0, nof_pms = 0;
    ...
    for( i = 0 ; i < nof_pms ; i++){
        _SOC_IF_ERR_EXIT(portmod_ext_phy_attach_to_pm(unit, pms_info[i], ext_phy_access, first_phy_lane));
    }
    SOC_FUNC_RETURN;
exit:
