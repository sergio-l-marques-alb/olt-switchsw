...
#include "sbTypes.h"
#include "sbZfC2PrCcTcamConfigEntryFirst.hx"
...
sbZfC2PrCcTcamConfigEntryFirst_Pack(sbZfC2PrCcTcamConfigEntryFirst_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PRCCTCAMCONFIGENTRYFIRST_SIZE_IN_BYTES;
  ...
  /* Pack Member: m_uMaskReserved */
  (pToData)[27] |= ((pFrom)->m_uMaskReserved & 0x07) <<5;
  (pToData)[28] |= ((pFrom)->m_uMaskReserved >> 3) & 0x3f;

  /* Pack Member: m_uMaskPort */
  (pToData)[27] |= ((pFrom)->m_uMaskPort & 0x1f);
  ...
  (pToData)[0] |= ((pFrom)->m_uReserved & 0x01) <<7;
  (pToData)[1] |= ((pFrom)->m_uReserved >> 1) &0xFF;

  /* Pack Member: m_uPort */
  (pToData)[0] |= ((pFrom)->m_uPort & 0x1f) <<2;

  /* Pack Member: m_uValid */
  (pToData)[0] |= ((pFrom)->m_uValid & 0x03);

  return SB_ZF_C2PRCCTCAMCONFIGENTRYFIRST_SIZE_IN_BYTES;
}
...
sbZfC2PrCcTcamConfigEntryFirst_Unpack(sbZfC2PrCcTcamConfigEntryFirst_t *pToStruct,
  ...
  (pToStruct)->m_uMask0_31 =  (uint32)  ((pFromData)[49] >> 6) & 0x03;
  (pToStruct)->m_uMask0_31 |=  (uint32)  (pFromData)[50] << 2;
  (pToStruct)->m_uMask0_31 |=  (uint32)  (pFromData)[51] << 10;
  (pToStruct)->m_uMask0_31 |=  (uint32)  (pFromData)[52] << 18;
  (pToStruct)->m_uMask0_31 |=  (uint32)  ((pFromData)[53] & 0x3f) << 26;

  /* Unpack Member: m_uMask32_63 */
  (pToStruct)->m_uMask32_63 =  (uint32)  ((pFromData)[45] >> 6) & 0x03;
  (pToStruct)->m_uMask32_63 |=  (uint32)  (pFromData)[46] << 2;
  (pToStruct)->m_uMask32_63 |=  (uint32)  (pFromData)[47] << 10;
  (pToStruct)->m_uMask32_63 |=  (uint32)  (pFromData)[48] << 18;
  (pToStruct)->m_uMask32_63 |=  (uint32)  ((pFromData)[49] & 0x3f) << 26;

  /* Unpack Member: m_uMask64_95 */
  (pToStruct)->m_uMask64_95 =  (uint32)  ((pFromData)[41] >> 6) & 0x03;
  (pToStruct)->m_uMask64_95 |=  (uint32)  (pFromData)[42] << 2;
  (pToStruct)->m_uMask64_95 |=  (uint32)  (pFromData)[43] << 10;
  (pToStruct)->m_uMask64_95 |=  (uint32)  (pFromData)[44] << 18;
  (pToStruct)->m_uMask64_95 |=  (uint32)  ((pFromData)[45] & 0x3f) << 26;

  /* Unpack Member: m_uMask96_127 */
  (pToStruct)->m_uMask96_127 =  (uint32)  ((pFromData)[37] >> 6) & 0x03;
  (pToStruct)->m_uMask96_127 |=  (uint32)  (pFromData)[38] << 2;
  (pToStruct)->m_uMask96_127 |=  (uint32)  (pFromData)[39] << 10;
  (pToStruct)->m_uMask96_127 |=  (uint32)  (pFromData)[40] << 18;
  (pToStruct)->m_uMask96_127 |=  (uint32)  ((pFromData)[41] & 0x3f) << 26;

  /* Unpack Member: m_uMask128_159 */
  (pToStruct)->m_uMask128_159 =  (uint32)  ((pFromData)[33] >> 6) & 0x03;
  (pToStruct)->m_uMask128_159 |=  (uint32)  (pFromData)[34] << 2;
  (pToStruct)->m_uMask128_159 |=  (uint32)  (pFromData)[35] << 10;
  (pToStruct)->m_uMask128_159 |=  (uint32)  (pFromData)[36] << 18;
  (pToStruct)->m_uMask128_159 |=  (uint32)  ((pFromData)[37] & 0x3f) << 26;

  /* Unpack Member: m_uMask160_191 */
  (pToStruct)->m_uMask160_191 =  (uint32)  ((pFromData)[29] >> 6) & 0x03;
  (pToStruct)->m_uMask160_191 |=  (uint32)  (pFromData)[30] << 2;
  (pToStruct)->m_uMask160_191 |=  (uint32)  (pFromData)[31] << 10;
  (pToStruct)->m_uMask160_191 |=  (uint32)  (pFromData)[32] << 18;
  (pToStruct)->m_uMask160_191 |=  (uint32)  ((pFromData)[33] & 0x3f) << 26;

  /* Unpack Member: m_uMask192_199 */
  (pToStruct)->m_uMask192_199 =  (uint32)  ((pFromData)[28] >> 6) & 0x03;
  (pToStruct)->m_uMask192_199 |=  (uint32)  ((pFromData)[29] & 0x3f) << 2;

  /* Unpack Member: m_uMaskReserved */
  (pToStruct)->m_uMaskReserved =  (uint32)  ((pFromData)[27] >> 5) & 0x07;
  (pToStruct)->m_uMaskReserved |=  (uint32)  ((pFromData)[28] & 0x3f) << 3;

  /* Unpack Member: m_uMaskPort */
  (pToStruct)->m_uMaskPort =  (uint32)  ((pFromData)[27] ) & 0x1f;

  /* Unpack Member: m_uPacket0_31 */
  (pToStruct)->m_uPacket0_31 =  (uint32)  (pFromData)[23] ;
  (pToStruct)->m_uPacket0_31 |=  (uint32)  (pFromData)[24] << 8;
  (pToStruct)->m_uPacket0_31 |=  (uint32)  (pFromData)[25] << 16;
  (pToStruct)->m_uPacket0_31 |=  (uint32)  (pFromData)[26] << 24;

  /* Unpack Member: m_uPacket32_63 */
  (pToStruct)->m_uPacket32_63 =  (uint32)  (pFromData)[19] ;
  (pToStruct)->m_uPacket32_63 |=  (uint32)  (pFromData)[20] << 8;
  (pToStruct)->m_uPacket32_63 |=  (uint32)  (pFromData)[21] << 16;
  (pToStruct)->m_uPacket32_63 |=  (uint32)  (pFromData)[22] << 24;

  /* Unpack Member: m_uPacket64_95 */
  (pToStruct)->m_uPacket64_95 =  (uint32)  (pFromData)[15] ;
  (pToStruct)->m_uPacket64_95 |=  (uint32)  (pFromData)[16] << 8;
  (pToStruct)->m_uPacket64_95 |=  (uint32)  (pFromData)[17] << 16;
  (pToStruct)->m_uPacket64_95 |=  (uint32)  (pFromData)[18] << 24;

  /* Unpack Member: m_uPacket96_127 */
  (pToStruct)->m_uPacket96_127 =  (uint32)  (pFromData)[11] ;
  (pToStruct)->m_uPacket96_127 |=  (uint32)  (pFromData)[12] << 8;
  (pToStruct)->m_uPacket96_127 |=  (uint32)  (pFromData)[13] << 16;
  (pToStruct)->m_uPacket96_127 |=  (uint32)  (pFromData)[14] << 24;

  /* Unpack Member: m_uPacket128_159 */
  (pToStruct)->m_uPacket128_159 =  (uint32)  (pFromData)[7] ;
  (pToStruct)->m_uPacket128_159 |=  (uint32)  (pFromData)[8] << 8;
  (pToStruct)->m_uPacket128_159 |=  (uint32)  (pFromData)[9] << 16;
  (pToStruct)->m_uPacket128_159 |=  (uint32)  (pFromData)[10] << 24;

  /* Unpack Member: m_uPacket160_191 */
  (pToStruct)->m_uPacket160_191 =  (uint32)  (pFromData)[3] ;
  (pToStruct)->m_uPacket160_191 |=  (uint32)  (pFromData)[4] << 8;
  (pToStruct)->m_uPacket160_191 |=  (uint32)  (pFromData)[5] << 16;
  (pToStruct)->m_uPacket160_191 |=  (uint32)  (pFromData)[6] << 24;

  /* Unpack Member: m_uPacket192_199 */
  (pToStruct)->m_uPacket192_199 =  (uint32)  (pFromData)[2] ;

  /* Unpack Member: m_uReserved */
  (pToStruct)->m_uReserved =  (uint32)  ((pFromData)[0] >> 7) & 0x01;
  (pToStruct)->m_uReserved |=  (uint32)  (pFromData)[1] << 1;

  /* Unpack Member: m_uPort */
  (pToStruct)->m_uPort =  (uint32)  ((pFromData)[0] >> 2) & 0x1f;
...
sbZfC2PrCcTcamConfigEntryFirst_InitInstance(sbZfC2PrCcTcamConfigEntryFirst_t *pFrame) {
  ...
  pFrame->m_uMaskReserved =  (unsigned int)  0;
  pFrame->m_uMaskPort =  (unsigned int)  0;
