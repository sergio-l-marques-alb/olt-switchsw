/*
 * $Id: sbZfCaPbCounterEntryConsole.c,v 1.3 Broadcom SDK $
...
#include "sbZfCaPbCounterEntryConsole.hx"



/* Print members in struct */
void
sbZfCaPbCounterEntry_Print(sbZfCaPbCounterEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data23=0x%08x"), (unsigned int)  pFromStruct->m_uData23));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data20=0x%08x"), (unsigned int)  pFromStruct->m_uData20));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data17=0x%08x"), (unsigned int)  pFromStruct->m_uData17));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data14=0x%08x"), (unsigned int)  pFromStruct->m_uData14));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data11=0x%08x"), (unsigned int)  pFromStruct->m_uData11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data8=0x%08x"), (unsigned int)  pFromStruct->m_uData8));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data5=0x%08x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbCounterEntry:: data2=0x%08x"), (unsigned int)  pFromStruct->m_uData2));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfCaPbCounterEntry_SPrint(sbZfCaPbCounterEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data23=0x%08x", (unsigned int)  pFromStruct->m_uData23);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data20=0x%08x", (unsigned int)  pFromStruct->m_uData20);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data17=0x%08x", (unsigned int)  pFromStruct->m_uData17);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data14=0x%08x", (unsigned int)  pFromStruct->m_uData14);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data11=0x%08x", (unsigned int)  pFromStruct->m_uData11);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data8=0x%08x", (unsigned int)  pFromStruct->m_uData8);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data5=0x%08x", (unsigned int)  pFromStruct->m_uData5);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbCounterEntry:: data2=0x%08x", (unsigned int)  pFromStruct->m_uData2);
...
int
sbZfCaPbCounterEntry_Validate(sbZfCaPbCounterEntry_t *pZf) {
...
int
sbZfCaPbCounterEntry_SetField(sbZfCaPbCounterEntry_t *s, char* name, int value) {
