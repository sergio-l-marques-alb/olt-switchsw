 ...
 */
    ...
    /* EDB_EEDB_MAP_TO_PROTECTION_PTR */ "Specify per bank (one of 22 lower banks) if it supports protection pointer functionality. Maps each bank to where it's protection pointer is located & holds enable for this feature for the specified bank.",
    ...
    /* EGQ_FQSM                  */ "FQSM  - DB'S per Interface Memory.",
    ...
    /* EGQ_PMF_PROGRAM_SELECTION_CAM */ "Value: 150'h0 Mask: 150'h0",
    ...
    /* EGQ_PQSMAX                */ "PQSM-MAX  - maximum unicast and multicast DB's per OTM-Port Memory.",
    ...
    /* EGQ_QDCT_TABLE            */ "PD's thresholds per queue table. The index to this table is CGM-PORT-PROFILE(4),Egress-Tc(3). The result is set of thresholds corresponding to per queue resources.",
    ...
    /* EGQ_QQSM                  */ "QQSM  - DB'S per Queue Memory.",
    ...
    /* EPNI_LINK_LAYER_OR_ARP_NEW_FORMAT */ "Encapsulation-Stack Link Layer or New ARP Format",
    ...
    /* EPNI_TRILL_FORMAT_FULL_ENTRY */ "Encapsulation-Stack TRILL Full Entry Format",
    /* EPNI_TRILL_FORMAT_HALF_ENTRY */ "Encapsulation-Stack TRILL Half Entry Format",
    ...
    /* KAPS_TCM                  */ "The R5's TCM. The host may DMA read and write this memory.",
    ...
    /* MMU_WRED_CONFIG_PIPE0     */ "WRED Config Memory for Unicast Queue, PortSP and service Pool.\nThe range:\n329 ~   0: Unicast Queue\n461 ~ 330: Port Service Pool (port 0 to 32)\n           Address = 330 + {PORTID[5:0], SPID[1:0]} per PIPE\n           Each Port's service pool is addressed by Address[1:0] of this memory address.\n465 ~ 462: Global Service Pool\n      462: Global Service Pool 0\n      463: Global Service Pool 1\n      464: Global Service Pool 2\n      465: Global Service Pool 3\nECN_MARKING_EN, LOGICAL_Q_TRACK_ENABLE, QG_E ...",
    /* MMU_WRED_CONFIG_PIPE1     */ "WRED Config Memory for Unicast Queue, PortSP and service Pool.\nThe range:\n329 ~   0: Unicast Queue\n461 ~ 330: Port Service Pool (port 0 to 32)\n           Address = 330 + {PORTID[5:0], SPID[1:0]} per PIPE\n           Each Port's service pool is addressed by Address[1:0] of this memory address.\n465 ~ 462: Global Service Pool\n      462: Global Service Pool 0\n      463: Global Service Pool 1\n      464: Global Service Pool 2\n      465: Global Service Pool 3\nECN_MARKING_EN, LOGICAL_Q_TRACK_ENABLE, QG_E ...",
    /* MMU_WRED_CONFIG_PIPE2     */ "WRED Config Memory for Unicast Queue, PortSP and service Pool.\nThe range:\n329 ~   0: Unicast Queue\n461 ~ 330: Port Service Pool (port 0 to 32)\n           Address = 330 + {PORTID[5:0], SPID[1:0]} per PIPE\n           Each Port's service pool is addressed by Address[1:0] of this memory address.\n465 ~ 462: Global Service Pool\n      462: Global Service Pool 0\n      463: Global Service Pool 1\n      464: Global Service Pool 2\n      465: Global Service Pool 3\nECN_MARKING_EN, LOGICAL_Q_TRACK_ENABLE, QG_E ...",
    /* MMU_WRED_CONFIG_PIPE3     */ "WRED Config Memory for Unicast Queue, PortSP and service Pool.\nThe range:\n329 ~   0: Unicast Queue\n461 ~ 330: Port Service Pool (port 0 to 32)\n           Address = 330 + {PORTID[5:0], SPID[1:0]} per PIPE\n           Each Port's service pool is addressed by Address[1:0] of this memory address.\n465 ~ 462: Global Service Pool\n      462: Global Service Pool 0\n      463: Global Service Pool 1\n      464: Global Service Pool 2\n      465: Global Service Pool 3\nECN_MARKING_EN, LOGICAL_Q_TRACK_ENABLE, QG_E ...",
    ...
    /* MRPS_MCDA_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDA - Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* MRPS_MCDB_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDB- Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* MTRPS_EM_MCDA_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDA - Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* MTRPS_EM_MCDB_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDB- Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* PPDB_B_LIF_TABLE_AC_2_EEI */ "This is the format of a P2P AC that is connected to a PWE.",
    ...
    /* SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_0 */ "Each of the 32 ChNIFs maintain two calendars. Passive and Active. In total there are 64 calendars (32 Channelized Interfaces x 2 Calendars). 4 interfaces has 1k calendar length and 28 has 256 entries calendar. The length of each calendar is configured using the variables CALALen and CALBLen for each of the 32 Channelized NIFs. Each calendar entry specifies one Port-Scheduler. A Port-Scheduler with n occurrences in the calendar is awarded n CALxLen of its interface rate. At a single point in time ...",
    ...
    /* SER_RESULT_EXPECTED_0     */ "Expected ECC. In parity mode, it's not updated. Valid only if SER_RESULT_CTL.ERROR_0_VAL is set",
    /* SER_RESULT_EXPECTED_1     */ "Expected ECC. In parity mode, it's not updated. Valid only if SER_RESULT_CTL.ERROR_1_VAL is set",
