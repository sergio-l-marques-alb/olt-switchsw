...
enum tdm_td2_port_speed {TDM_TD2_SPEED_0=0, TDM_TD2_SPEED_10M=10, TDM_TD2_SPEED_20M=20, TDM_TD2_SPEED_25M=25, TDM_TD2_SPEED_33M=33, TDM_TD2_SPEED_40M=40, TDM_TD2_SPEED_50M=50, TDM_TD2_SPEED_100M=100, TDM_TD2_SPEED_100M_FX=101, TDM_TD2_SPEED_120M=120,TDM_TD2_SPEED_400M=400, TDM_TD2_SPEED_1G=1000, TDM_TD2_SPEED_1G_FX=1001, TDM_TD2_SPEED_1p2G=1200, TDM_TD2_SPEED_2G=2000, TDM_TD2_SPEED_2p5G=2500, TDM_TD2_SPEED_4G=4000, TDM_TD2_SPEED_5G=5000, TDM_TD2_SPEED_7p5G=7500, TDM_TD2_SPEED_10G=10000, TDM_TD2_SPEED_10G_DUAL=10001, TDM_TD2_SPEED_10G_XAUI=10002, TDM_TD2_SPEED_12G=12000, TDM_TD2_SPEED_12p5G=12500, TDM_TD2_SPEED_13G=13000, TDM_TD2_SPEED_15G=15000, TDM_TD2_SPEED_16G=16000, TDM_TD2_SPEED_20G=20000, TDM_TD2_SPEED_21G=21000, TDM_TD2_SPEED_21G_DUAL=21010, TDM_TD2_SPEED_24G=24000, TDM_TD2_SPEED_25G=25000, TDM_TD2_SPEED_30G=30000, TDM_TD2_SPEED_40G=40000, TDM_TD2_SPEED_42G=40005, TDM_TD2_SPEED_50G=50000,TDM_TD2_SPEED_75G=75000, TDM_TD2_SPEED_82G=82000, TDM_TD2_SPEED_100G=100000, TDM_TD2_SPEED_120G=120000, TDM_TD2_SPEED_126G=126000};
	...
	for (i=1; i<(TDM_TD2_NUM_EXT_PORTS-1); i+=4) {
		...
		if (((i-1)/4==3) && wc_array[(i-1)/4][0]==TDM_TD2_MGM_TOKEN) {
			...
			if (speed[i] <= TDM_TD2_SPEED_42G || port_state_array[i-1]==0) {
				...
				if (speed[i] == TDM_TD2_SPEED_100G && port_state_array[i+10] != 3) {
					wc_array[(i-1)/4][0] = i;
					wc_array[(i-1)/4][1] = i;
					wc_array[(i-1)/4][2] = i;
					wc_array[(i-1)/4][3] = i;
				...
				else if (speed[i] == TDM_TD2_SPEED_100G || speed[i] == TDM_TD2_SPEED_120G) {
					wc_array[(i-1)/4][0] = i;	
					wc_array[(i-1)/4][1] = i;
					wc_array[(i-1)/4][2] = i;
					wc_array[(i-1)/4][3] = i;
 ...
 **/
static
void print_port(int wc_array[TDM_TD2_NUM_WC][4]) 
{
	int i,j;
		...
		if (pgw_buffer[j] != TDM_TD2_NUM_EXT_PORTS && pgw_buffer[j] != TDM_TD2_OVS_TOKEN && port_state_map[pgw_buffer[j]-1] == 1) {
				 ...
				 port_state_map[pgw_buffer[j]+3] != 3)
			{
				...
				for (m=0; m<y3; m++) if (pgw40[m] == pgw_buffer[j]) y3--;
				 ...
				 port_state_map[pgw_buffer[j]+10] != 3) || speed[pgw_buffer[j]]==TDM_TD2_SPEED_100G)
			{
				...
				for (m=0; m<y4; m++) if (pgw100[m] == pgw_buffer[j]) y4--;
				 ...
				 port_state_map[pgw_buffer[j]+3] == 3 &&
				 port_state_map[pgw_buffer[j]+8] == 3 &&
				 port_state_map[pgw_buffer[j]+10] == 3) && speed[pgw_buffer[j]]==TDM_TD2_SPEED_120G)
			{
	...
	if (y2 > 0) {
		...
		for (v=0; v<yy; v++) {
			...
			for (w=v; w<v+(2*s2); w+=s2) {
				if (mmu[w] == TDM_TD2_NUM_EXT_PORTS) x++; if (x==2) {
					yy=v;
					break;
				}
			}
