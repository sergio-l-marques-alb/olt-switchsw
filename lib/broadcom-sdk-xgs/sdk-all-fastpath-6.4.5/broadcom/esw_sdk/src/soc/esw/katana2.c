...
{ 
    ...
    uint32 lanes_pg25_27[3][4] = {{25, 35, 36, 37}, 
                                  {26, 38, 39, 40}, 
                                  {27, 32, 33, 34}}; 
    ...
    for (port = 1; port < COUNTOF(_kt2_l1_port_mx_lane_map); port++) { 
        ...
        if ((port >= 25) && (port <=27)) { 
            uint32 base=port-25; 
            for (i = 0; i < 4; i++) { 
                 _kt2_l1_port_mx_lane_map[lanes_pg25_27[base][i]].recovered_clock_select =
                                             (lanes_pg25_27[base][lane[i]]-1); 
            } 
        } else { 
              for (i =0 ; i < 4; i++) {
                  ...
                  /* coverity[overrun-local : FALSE] */
                 _kt2_l1_port_mx_lane_map[port+i].recovered_clock_select = 
                                                           (port/4)*4 + lane[i];
