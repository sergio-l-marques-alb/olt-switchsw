...
tdm_td2p_vbs_wrapper( tdm_mod_t *_tdm )
{
	...
	if ( (tdm_td2p_check_ethernet(_tdm)) && (higig_mgmt==BOOL_FALSE)){
		...
		switch (clk) {
			...
			case 609: lr_idx_limit=(LEN_608MHZ_HG-acc); break; /* 608.333MHz (150+10)*2.65G */
			case 518: lr_idx_limit=(LEN_517MHZ_HG-acc); break; /* 517.857MHz (128+ 8)*2.65G */
			case 415: lr_idx_limit=(LEN_415MHZ_HG-acc); break; /* 415.625MHz ( 96+10)*2.65G */
			default : break;
		}
	}
