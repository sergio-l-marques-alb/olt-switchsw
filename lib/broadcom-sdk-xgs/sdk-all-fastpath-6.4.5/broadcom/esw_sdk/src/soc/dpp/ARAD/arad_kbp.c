...
ARAD_KBP_LTR_SINGLE_SEARCH ipv4_mc_extended_search = 
       {4, {{"VRF", 2, KBP_KEY_FIELD_TERNARY}, {"IN-RIF", 2, KBP_KEY_FIELD_TERNARY}, {"MC-GROUP", 4, KBP_KEY_FIELD_TERNARY}, {"SIP", 4, KBP_KEY_FIELD_TERNARY}}} ;
    ...
    ARAD_KBP_LTR_CONFIG
        Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 11: Shared IPv4 LSR Shared for IP */
            {
                ...
                0x3, /* parallel_srches_bmp */
                {ARAD_KBP_FRWRD_TBL_ID_LSR_IP_SHARED_FOR_IP, ARAD_KBP_FRWRD_TBL_ID_INRIF_MAPPING, ARAD_KBP_FRWRD_TBL_ID_DUMMY_2, ARAD_KBP_FRWRD_TBL_ID_DUMMY_3}, /* tbl_id's*/
                {ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_ACL, ARAD_KBP_NOF_DB_TYPES, ARAD_KBP_NOF_DB_TYPES}, /* Search Types*/ 
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
            ...
            /* DB 12: IPv4 LSR Shared for IP with RPF*/
            {
                ...
                {ARAD_KBP_FRWRD_TBL_ID_LSR_IP_SHARED_FOR_IP, ARAD_KBP_FRWRD_TBL_ID_IPV4_UC_RPF_1, ARAD_KBP_FRWRD_TBL_ID_INRIF_MAPPING, ARAD_KBP_FRWRD_TBL_ID_DUMMY_3}, /* tbl_id's*/
                {ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_ACL ,ARAD_KBP_NOF_DB_TYPES}, /* Search Types*/ 
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
                {3, {{"HOLE", 3, KBP_KEY_FIELD_HOLE},{"VRF", 2, KBP_KEY_FIELD_TERNARY},{"DIP", 4, KBP_KEY_FIELD_TERNARY}}},
                {2, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}}},
                ...
                /* master key */
                {4, {{"VRF", 2, KBP_KEY_FIELD_PREFIX},{"SIP", 4, KBP_KEY_FIELD_PREFIX},{"DIP", 4, KBP_KEY_FIELD_PREFIX},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}},
                NULL, /* ARAD_KBP_INSTRUCTION */
                NULL, /* ARAD_KBP_KEY */
            },  
    ...
    arad_kbp_lut_data_t
        Arad_plus_kbp_gtm_lut_info_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
                        ...
                        /* DB 15 : p2p extended */
            {
                ...
                0x0, /* key_w_cpd_gt_80 */
                0x0, /* copy_data_cfg */
                ARAD_KBP_LUT_AD_TRANSFER_15B, /* result0_idx_ad_cfg */
                ARAD_KBP_LUT_TRANSFER_AD_ONLY, /* result0_idx_or_ad */
                ARAD_KBP_LUT_AD_TRANSFER_1B, /* result1_idx_ad_cfg */
                ARAD_KBP_LUT_TRANSFER_INDX_ONLY, /* result1_idx_or_ad */
                ARAD_KBP_LUT_AD_TRANSFER_1B, /* result2_idx_ad_cfg */
    ...
    arad_kbp_frwd_ltr_db_t
        Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 12 : shared IPv4 UC + RPF PROGRAM */
            {
                ...
                /* Result Data Length for each of 4 lookups */
                {ARAD_KBP_LUT_AD_TRANSFER_11B, ARAD_KBP_LUT_AD_TRANSFER_2B, ARAD_KBP_LUT_AD_TRANSFER_2B, 0x0},
                /* Result Data Format */
                {NLM_ARAD_INDEX_AND_128B_AD, NLM_ARAD_INDEX_AND_32B_AD, NLM_ARAD_INDEX_AND_32B_AD, NLM_ARAD_NO_INDEX_NO_AD},
                /* Result Total Length */
                (1 + ARAD_KBP_LUT_AD_TRANSFER_11B + ARAD_KBP_LUT_AD_TRANSFER_2B + ARAD_KBP_LUT_AD_TRANSFER_2B) 
            },
            ...
            /* DB 15 : p2p extended */
            {
                ...
                /* Result Data Length for each of 4 lookups */
                {ARAD_KBP_LUT_AD_TRANSFER_15B, 0x0, 0x0, 0x0},
                /* Result Data Format */
                {NLM_ARAD_INDEX_AND_128B_AD, NLM_ARAD_NO_INDEX_NO_AD, NLM_ARAD_NO_INDEX_NO_AD, NLM_ARAD_NO_INDEX_NO_AD},
                /* Result Total Length */
                (1 + ARAD_KBP_LUT_AD_TRANSFER_15B) 
            },
...
static
    ARAD_KBP_GTM_OPCODE_CONFIG_INFO
        Arad_plus_kbp_gtm_opcode_config_info_static[ARAD_KBP_FRWRD_DB_NOF_TYPES] = {
            ...
            /* DB 12 : shared IPv4 UC + RPF PROGRAM */
            {
                (12 - 1), /* TX Data Size (12 bytes, minus 1) */
                1, /* TX Data Type (REQUEST) */
                (1 + 11 + 4 - 1), /* RX Data Size (1 (action) + 11 (First Result) + 4 + (Second result) - 1 (minus 1)  */
                3 /* RX Data Type (REPLY) */
            },
            ...
            /* DB 15 : extended P2P PROGRAM */
            {
                (2 - 1), /* TX Data Size (10 bytes, minus 1) */
                1, /* TX Data Type (REQUEST) */
                (1 + 15 - 1), /* RX Data Size (1 (action) + 11 (First Result) - 1 (minus 1)  */
                3 /* RX Data Type (REPLY) */
            },
    ...
    )
{
    ...
    if (SOC_IS_ARADPLUS(unit) && (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "ext_rpf_fwd_parallel", 0) == 0)){
		...
		if (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "ext_ipv4_mc_flexible_fwd_table", 0)) {
			...
			Arad_plus_kbp_gtm_lut_info_static[ARAD_KBP_FRWRD_TBL_ID_IPV4_MC].result2_idx_ad_cfg = ARAD_KBP_LUT_AD_TRANSFER_7B;
			Arad_plus_kbp_gtm_lut_info_static[ARAD_KBP_FRWRD_TBL_ID_IPV4_MC].result2_idx_or_ad = ARAD_KBP_LUT_TRANSFER_AD_ONLY ; 

			Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_TBL_ID_IPV4_MC].res_data_len[2] = ARAD_KBP_LUT_AD_TRANSFER_7B;
			Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_TBL_ID_IPV4_MC].res_format[2] = NLM_ARAD_INDEX_AND_32B_AD;
			Arad_plus_kbp_gtm_ltr_info_static[ARAD_KBP_FRWRD_TBL_ID_IPV4_MC].res_total_data_len = 1 + ARAD_KBP_LUT_AD_TRANSFER_15B;
    ...
    kbp_reset_f kbp_reset)
{
    ...
    SOC_DPP_CONFIG(unit)->arad->init.elk.kbp_mdio_id = kbp_mdio_id;
...
{
    uint32 res = SOC_SAND_OK;
    KBP_TRY(kbp_device_set_property(AradAppData[unit]->device_p, KBP_DEVICE_PRE_CLEAR_ABS, 1)); 
    ...
    ARAD_INIT_ELK *elk_ptr)
{
    ...
    if (res != 0 && elk->kbp_recover_enable) {            
        res = arad_kbp_recover_run_recovery_sequence(unit, elk->kbp_mdio_id, elk->kbp_recover_iter);
    }
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
