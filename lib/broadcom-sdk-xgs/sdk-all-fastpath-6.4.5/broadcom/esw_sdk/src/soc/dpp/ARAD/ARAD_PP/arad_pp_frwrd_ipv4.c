...
#define ARAD_PP_FRWRD_IPV4_TYPE_MAX                              (ARAD_PP_NOF_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPES-1)
  ...
  Arad_pp_procedure_desc_element_frwrd_ipv4[] =
{
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_GLBL_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_VRF_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_MEM_STATUS_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_MEM_STATUS_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_IPV4_MEM_STATUS_GET_VERIFY),
  ...
  Arad_pp_error_desc_element_frwrd_ipv4[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_IPV4_MC_HOST_TABLE_RESOURCES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ARAD_PP_FRWRD_IP_CACHE_MODE_OUT_OF_RANGE_ERR,
    "ARAD_PP_FRWRD_IP_CACHE_MODE_OUT_OF_RANGE_ERR",
    "The parameter 'mc_table_resouces' is out of range. \n\r "
    "The range is: 0 - ARAD_PP_NOF_FRWRD_IP_CACHE_MODES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "set vrf_ndx = ARAD_PP_FRWRD_IP_ALL_VRFS_ID\n\r",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "ARAD_PP_FRWRD_IPV4_OPERATION_NOT_SUPPORTED_ON_VRF_ERR",
    "operation is not supported on single VRF, use ARAD_PP_FRWRD_IP_ALL_VRFS_ID \n\r",
    SOC_SAND_SVR_ERR,
    FALSE
  },
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_def_action_get(
      ...
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION          *def_action
    );
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_def_action_set(
      ...
      SOC_SAND_IN uint32                                      vrf_ndx,
      SOC_SAND_IN uint8                                     is_mcast,
      SOC_SAND_IN ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION          *def_action
    );
  ...
  )
{
  uint32
    res = SOC_SAND_OK,
    vrf;
  ARAD_PP_FRWRD_IPV4_GLBL_INFO
    glbl_info;
  ARAD_PP_FRWRD_IPV4_VRF_INFO
    vrf_info;
  uint32
    nof_vrfs;
#ifndef PLISIM
  ...
  */
  ...
  ARAD_PP_FRWRD_IPV4_GLBL_INFO_clear(&glbl_info);
  glbl_info.mc_table_resouces = ARAD_PP_FRWRD_IPV4_MC_HOST_TABLE_RESOURCE_TCAM_ONLY;
  glbl_info.uc_table_resouces = ARAD_PP_FRWRD_IPV4_HOST_TABLE_RESOURCE_LPM_ONLY;
  glbl_info.router_info.uc_default_action.type = ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC;
  glbl_info.router_info.uc_default_action.value.route_val = 0;
  glbl_info.router_info.mc_default_action.type = ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC;
  ...
  ARAD_PP_FRWRD_IPV4_VRF_INFO_clear(&vrf_info);
  vrf_info.use_dflt_non_vrf_routing = FALSE;
  vrf_info.router_info.uc_default_action.type = ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC;
  vrf_info.router_info.uc_default_action.value.route_val = 0;
  vrf_info.router_info.mc_default_action.type = ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC;
  vrf_info.router_info.mc_default_action.value.route_val = 0;

  res = arad_pp_sw_db_ipv4_nof_vrfs_get(
          unit,
          &nof_vrfs
        );
...
STATIC
  uint32
    arad_pp_frwrd_fec_to_em_dest(
      SOC_SAND_IN int              unit,
      SOC_SAND_IN ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO      *routing_info,
...
uint32
    arad_pp_frwrd_ipv4_sand_dest_to_fwd_decision(
      ...
      SOC_SAND_OUT ARAD_PP_FRWRD_DECISION_INFO *em_dest
    )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);

  ARAD_PP_FRWRD_DECISION_INFO_clear(em_dest);
...
uint32
    arad_pp_frwrd_em_dest_to_fec(
      ...
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO *route_info
    )
{
  uint32
  ...
  if(payload->flags & ARAD_PP_LEM_ACCESS_ASD_EEI)
  {
    flags |= ARAD_PP_FWD_DECISION_PARSE_EEI;
  }
  if(payload->flags & ARAD_PP_LEM_ACCESS_ASD_OUTLIF)
  {
    ...
    )
{
  ...
  if (em_dest.type == ARAD_PP_FRWRD_DECISION_TYPE_FEC)
  {
    dest_id->dest_type = SOC_SAND_PP_DEST_FEC;
    dest_id->dest_val = em_dest.dest_id;
  }
  else if (em_dest.type == ARAD_PP_FRWRD_DECISION_TYPE_MC)
  {
...
STATIC
  void
    arad_pp_frwrd_ipv4_host_lem_request_key_parse(
      ...
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_HOST_KEY *host_key
    )
{
    ...
    )
{
  ...
  if (routing_info->native_vsi != 0) {
      ...
      payload->flags = ARAD_PP_LEM_ACCESS_ASD_FORMAT_3B;
      /* set native vsi */
      payload->native_vsi = routing_info->native_vsi;
  }
  /* additional info has outlif */
  else if(routing_info->frwrd_decision.additional_info.outlif.type != ARAD_PP_OUTLIF_ENCODE_TYPE_NONE) {
      payload->flags = ARAD_PP_LEM_ACCESS_ASD_OUTLIF;
  }
  /* additional info has eei */
  else if(routing_info->frwrd_decision.additional_info.eei.type != ARAD_PP_EEI_TYPE_EMPTY) {
...
STATIC
  void
    arad_pp_frwrd_ipmc_rp_lem_request_key_build(
       SOC_SAND_IN int                       unit,
      SOC_SAND_IN ARAD_PP_FRWRD_IP_MC_RP_INFO   *rp_info,
      SOC_SAND_OUT ARAD_PP_LEM_ACCESS_KEY       *key
    )
{
...
STATIC
  void
    arad_pp_frwrd_ipmc_rp_lem_request_key_parse(
      SOC_SAND_IN ARAD_PP_LEM_ACCESS_KEY *key,
      SOC_SAND_OUT ARAD_PP_FRWRD_IP_MC_RP_INFO *rp_info
    )
{
    ...
    )
{
  ...
  {
    case ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_ACTION_PROFILE:
      em_dest.type = ARAD_PP_FRWRD_DECISION_TYPE_TRAP;
      ...
      break;
    case ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC:
      em_dest.type = ARAD_PP_FRWRD_DECISION_TYPE_FEC;
  ...
  em_dest.additional_info.eei.type = ARAD_PP_EEI_TYPE_EMPTY;
  em_dest.additional_info.outlif.type = ARAD_PP_OUTLIF_ENCODE_TYPE_NONE;
  ...
  if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
	  ...
	  */
      ...
      payload = (dest + (1 << 19)) << (SOC_SAND_NOF_BITS_IN_UINT32 - JER_KAPS_AD_WIDTH_IN_BITS); /* Default route has 1 in msb */
    ...
    )
{
  ...
  if (JER_KAPS_ENABLE(unit)) {
      ...
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
      dest = ((payload >> (SOC_SAND_NOF_BITS_IN_UINT32 - JER_KAPS_AD_WIDTH_IN_BITS)) & ~(1 << 19));
  }
  else 
  ...
  res = arad_pp_fwd_decision_in_buffer_parse(unit, ARAD_PP_FRWRD_DECISION_APPLICATION_TYPE_DFLT, dest, 0, ARAD_PP_FWD_DECISION_PARSE_EEI|ARAD_PP_FWD_DECISION_PARSE_DEST, &em_dest);
  SOC_SAND_CHECK_FUNC_RESULT(res, 15, exit);

  switch(em_dest.type)
  {
    case ARAD_PP_FRWRD_DECISION_TYPE_TRAP:
      def_action->type =  ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_ACTION_PROFILE;
    ...
    case ARAD_PP_FRWRD_DECISION_TYPE_FEC:
      def_action->type = ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPE_FEC;
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_em_dest_to_tcam_action(
      SOC_SAND_IN int                                     unit,
      SOC_SAND_IN uint32                                     dest_val,
    ...
    )
{
  ...
  ARAD_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_pp_frwrd_ipv4_em_dest_to_tcam_action()",0,0);
}

STATIC
  uint32
    arad_pp_frwrd_ipv4_tcam_action_to_em_dest(
      SOC_SAND_IN int                                     unit,
      SOC_SAND_IN ARAD_TCAM_ACTION                           *action,
      SOC_SAND_OUT uint32                                    *dest_val
    )
{
    ...
    )
{
  ...
  /* Encode Key into buffer according to the following format:
   *  
   * {In-RIF(11:0) in 75:64, DIP-address(63:32) in 63:32, SIP-address(31:0) in 31:0} 
   *  
   */
  ...
  /* Set Key Mask */
  lcl_mask = (route_key->group == 0) ? 0 : SOC_SAND_BITS_MASK(27, 0);
  ARAD_PP_FRWRD_IP_TCAM_LEM_KEY_ENCODE(unit, frwrd_table_id, 1, lcl_mask, mask);

  /* Param 2  - In-RIF */
  ARAD_PP_FRWRD_IP_TCAM_LEM_KEY_ENCODE(unit, frwrd_table_id, 2, route_key->inrif, data);
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_mc_kbp_key_mask_decode(
      ...
      SOC_SAND_IN  ARAD_PP_LEM_ACCESS_KEY       *data,
      SOC_SAND_IN  ARAD_PP_LEM_ACCESS_KEY       *mask,
      SOC_SAND_OUT  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY  *route_key
    )
{
  uint32
    bit_ndx;
  ...
  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY_clear(route_key);
  ...
  /* Param 2  - In-RIF */
  ARAD_PP_FRWRD_IP_TCAM_LEM_KEY_DECODE(unit, frwrd_table_id, 2, &route_key->inrif, data, mask);
    ...
    )
{
    ...
    DBAL_QUAL_VAL_ENCODE_IPV4_DIP(&qual_vals[1], route_key->ip_address, route_key->prefix_len);

    payload = (fec_id + (1 << 17)) << (32 - JER_KAPS_AD_WIDTH_IN_BITS); /* FEC encoding in PP destination */

    res = jer_pp_kaps_db_enabled(unit, vrf_ndx);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);

    res = arad_pp_dbal_entry_add(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KAPS, qual_vals, 0/*priority*/,  &payload, success);
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
    ...
    )
{
    ...
    res = arad_pp_dbal_entry_delete(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KAPS, qual_vals, &success);
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
      ...
      )
{
    ...
    res = arad_pp_dbal_entry_get(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KAPS, qual_vals, &payload, 0/*priority*/, NULL/*hit_bit*/, found);
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);

    if (*found) {
        res = jer_pp_kaps_payload_to_uc_fec_id(unit, payload, fec_id);
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_add(
      SOC_SAND_IN  int                               unit,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY      *route_key,
    ...
    )
{
    ...
    if (route_key->group != 0) {/*allowing default route for the VRF for ipv4mc*/
        DBAL_QUAL_VAL_ENCODE_IPV4_DIP(&qual_vals[1], route_key->group, SOC_SAND_PP_IPV4_ADDRESS_NOF_BITS);
    }else {
        DBAL_QUAL_VAL_ENCODE_IPV4_DIP(&qual_vals[1], route_key->group, 0);
        dest_val = 1 << 19;
    }
    DBAL_QUAL_VAL_ENCODE_IPV4_SIP(&qual_vals[2], route_key->source.ip_address, route_key->source.prefix_len);
    DBAL_QUAL_VAL_ENCODE_IN_RIF(&qual_vals[3], route_key->inrif);
    ...
    res = arad_pp_dbal_entry_add(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4MC_KAPS, qual_vals, 0/*priority*/,  &payload, success);
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_remove(
      SOC_SAND_IN  int                               unit,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY   *route_key
    )
{
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_remove()",0,0);

}

STATIC
  uint32
    arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_get(
      SOC_SAND_IN  int                               unit,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY      *route_key,
    ...
    )
{
    ...
    res = arad_pp_dbal_entry_get(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4MC_KAPS, qual_vals, &payload, 0/*priority*/, NULL/*hit_bit*/, found);
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_pp_frwrd_ipv4_mc_rpf_kaps_route_get()",0,0);
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_uc_rpf_kbp_route_get(
      ...
      SOC_SAND_IN  uint32                               vrf_ndx,
      SOC_SAND_IN  SOC_SAND_PP_IPV4_SUBNET              *route_key,
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO   *routing_info,
      SOC_SAND_OUT uint8                                *found
    )
{
  uint32
...
STATIC
 uint32
  arad_pp_frwrd_ipv4_kbp_route_get_block_unsafe(
    ...
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY        *route_keys_mc,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO     *route_infos_uc,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO       *route_infos_mc,
...
STATIC
 uint32
  arad_pp_frwrd_ipv4_kaps_dbal_route_get_block(
    SOC_SAND_IN  int                                 unit,
  ...
  )
{
  ...
  for(indx = 0; indx < nof_entries_lcl; ++indx)
  {
      ...
      for (i = 0; i < SOC_PPC_FP_NOF_QUALS_PER_DB_MAX; i++) {
          ...
          if (frwrd_table_id == SOC_DPP_DBAL_SW_TABLE_ID_IPV4MC_KAPS) {
              ...
              if (qual_type == SOC_PPC_FP_QUAL_HDR_FWD_IPV4_DIP) {
                  ...
                  route_keys_mc[route_ndx].group = qual_vals_array[indx * SOC_PPC_FP_NOF_QUALS_PER_DB_MAX + i].val.arr[0] | (15 << 28);
              }
      ...
      if (frwrd_table_id == SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KAPS) {
          res = jer_pp_kaps_payload_to_uc_fec_id(unit, payload[indx], &route_infos_uc[route_ndx].fec_id);
          SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);
      }

      if(routes_location)
      {
          routes_location[route_ndx] = ARAD_PP_FRWRD_IP_ROUTE_LOCATION_LPM;
      }
      if(routes_status)
      {
...
exit:
  ...
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_frwrd_ipv4_kaps_dbal_route_get_block()", 0, 0);
}
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_lpm_route_add(
      ...
      SOC_SAND_IN  ARAD_PP_FRWRD_IP_ROUTE_LOCATION                 hw_target_type,
      SOC_SAND_OUT SOC_SAND_SUCCESS_FAILURE                          *success
    )
{
    ...
    )
{
  ...
  res = arad_pp_sw_db_ipv4_default_fec_get(
          unit,
          &default_fec
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  res = arad_pp_sw_db_ipv4_cache_mode_for_ip_type_get(
          unit,
          ARAD_PP_FRWRD_IP_CACHE_MODE_IPV4_UC_LPM,
          &pending_op
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 5, exit);
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_lpm_route_get(
      ...
      SOC_SAND_OUT uint32                                      *fec_id,
      SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_STATUS         *pending_type,
      SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_LOCATION          *hw_target,
      SOC_SAND_OUT uint8                                     *found
    )
{
  ARAD_PP_IPV4_LPM_MNGR_INFO
    ...
    )
{
  ...
  if(ARAD_KBP_ENABLE_IPV4_UC || ARAD_KBP_ENABLE_IPV4_MPLS_EXTENDED || JER_KAPS_ENABLE(unit))
  {
    uint32
      read_index = 0;

    /* Initialize read_keys_mask */
    route_infos_uc = soc_sand_os_malloc_any_size(sizeof(ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO) * block_range->entries_to_act,"route_infos_uc");
    if (!route_infos_uc)
    {
      SOC_SAND_SET_ERROR_CODE(SOC_SAND_MALLOC_FAIL, 42, exit);
    }
    res = soc_sand_os_memset(route_infos_uc, 0x0, sizeof(ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO) * block_range->entries_to_act);
    SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);

    if (JER_KAPS_ENABLE(unit)) {
        res = arad_pp_frwrd_ipv4_kaps_dbal_route_get_block(
                unit,
...
STATIC
  uint32
    arad_pp_frwrd_ipv4_lem_route_get(
      SOC_SAND_IN  int                                     unit,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_HOST_KEY                     *host_key,
      SOC_SAND_OUT  ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO             *routing_info,
      SOC_SAND_OUT uint8                                     *found,
    ...
    )
{
  ...
  *accessed = FALSE;
  ...
  if (payload.flags & ARAD_PP_LEM_ACCESS_ENTRY_ACCESSED) {
    *accessed = TRUE;
  }
  ...
  )
{
  ...
  if(ARAD_KBP_ENABLE_IPV4_UC || ARAD_KBP_ENABLE_IPV4_MPLS_EXTENDED) 
  {
      ...
      ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO_clear(&routing_info);
  ...
  if (SOC_IS_JERICHO(unit)) {
      ...
      for (db_ndx = 0; db_ndx < 2; db_ndx ++) {
              key.type = db_ndx? ARAD_IP_TCAM_ENTRY_TYPE_IPV4_UC_1: ARAD_IP_TCAM_ENTRY_TYPE_IPV4_UC_0;
              key.key.ipv4_mc.source = *route_key;
              key.key.ipv4_mc.inrif = vrf_ndx; /* Usage override */
              action.value[0] = fec_id + (1 << 17); /* FEC encoding in PP destination */
              /* Special case for the default route: set the MSB bit */
              if (key.key.ipv4_mc.source.prefix_len == 0) {
                  action.value[0] |= (1 << 19);
              }
  ...
  } else 
  {
      res = arad_pp_frwrd_ipv4_lpm_route_add(
              ...
              fec_id,
              is_pending_op,
              ARAD_PP_FRWRD_IP_ROUTE_LOCATION_LPM,
              success
            );
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  if (SOC_IS_JERICHO(unit)) {
      ...
      key.type = ARAD_IP_TCAM_ENTRY_TYPE_IPV4_UC_0;
      key.key.ipv4_mc.source = *route_key;
      key.key.ipv4_mc.inrif = vrf_ndx; /* Usage override */
      ...
      {
          *fec_id = 0;
          SHR_BITCOPY_RANGE(fec_id, 0, &action.value[0], 0, 17);
          *pending_type = SOC_PPC_FRWRD_IP_ROUTE_STATUS_COMMITED;
          *location = SOC_PPC_FRWRD_IP_ROUTE_LOCATION_TCAM;
      }
  } else 
...
{
  uint32
    vrf_used_bmp[ARAD_PP_SW_IPV4_VRF_BITMAP_SIZE];
  uint32
    tmp,
    indx;
  uint32
  ...
  res = arad_pp_sw_db_ipv4_cache_modified_bitmap_get(
          unit,
          vrf_used_bmp
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  /* status of all VRFs*/
  if (vrf_ndx == ARAD_PP_FRWRD_IP_ALL_VRFS_ID)
  {
    for (indx = 0 ; indx < ARAD_PP_SW_IPV4_VRF_BITMAP_SIZE; ++indx)
    {
...
STATIC
  void
    arad_pp_frwrd_global_ipv4mc_lem_request_key_parse(
      SOC_SAND_IN  ARAD_PP_LEM_ACCESS_KEY               *key,
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY      *route_keys
    )
{
    ...
    )
{
  ...
  if(em_dest.additional_info.outlif.type != ARAD_PP_OUTLIF_ENCODE_TYPE_NONE) {
    payload->flags = ARAD_PP_LEM_ACCESS_ASD_OUTLIF;
  }
  else if(em_dest.additional_info.eei.type != ARAD_PP_EEI_TYPE_EMPTY) {
    payload->flags = ARAD_PP_LEM_ACCESS_ASD_EEI;
  }
  else{
    payload->flags = ARAD_PP_LEM_ACCESS_ASD_NONE;
...
STATIC
  uint32
    arad_pp_frwrd_global_ipv4mc_lem_route_add(
      SOC_SAND_IN  int                                          unit,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY             *route_key,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO            *routing_info,
      SOC_SAND_OUT SOC_SAND_SUCCESS_FAILURE                    *success
    )
...
STATIC
  uint32
    arad_pp_frwrd_global_ipv4mc_lem_route_get(
      SOC_SAND_IN  int                                        unit,
      SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY           *route_key,
      SOC_SAND_OUT  ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO         *routing_info,
      SOC_SAND_OUT uint8                                     *found,
      SOC_SAND_OUT uint8                                     *accessed
    )
{
...
STATIC
  uint32
    arad_pp_frwrd_global_ipv4mc_lem_get_block_unsafe(
      ...
      SOC_SAND_INOUT ARAD_PP_IP_ROUTING_TABLE_RANGE          *block_range_key,
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY           *route_keys,
      SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO          *routes_info,
      SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_STATUS             *routes_status,
      SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_LOCATION           *routes_location,
      SOC_SAND_OUT    uint32                                 *nof_entries
  )
  ...
  *nof_entries = 0;
  ...
  for (read_index = 0; read_index < *nof_entries; ++read_index)
  {
    if ((read_keys[read_index].type == ARAD_PP_LEM_ACCESS_KEY_TYPE_GLOBAL_IPV4_MC))
    {
      ...
      routes_status[valid_index] = ARAD_PP_FRWRD_IP_ROUTE_STATUS_COMMITED;

      if(read_vals[read_index].flags & ARAD_PP_LEM_ACCESS_ENTRY_ACCESSED){
        routes_status[valid_index] |= ARAD_PP_FRWRD_IP_ROUTE_STATUS_ACCESSED;
      }
      routes_location[valid_index] = ARAD_PP_FRWRD_IP_ROUTE_LOCATION_HOST;
  ...
  )
{
  ...
  cache = (uint8)(route_types & ARAD_PP_FRWRD_IP_CACHE_MODE_IPV4_UC_LPM);
  ...
  if (!cache)
  {
    ARAD_PP_CLEAR(vrf_used_bmp,uint32,ARAD_PP_SW_IPV4_VRF_BITMAP_SIZE);
    res = arad_pp_sw_db_ipv4_cache_modified_bitmap_set(
            unit,
            vrf_used_bmp
          );
    SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
  ...
  res = arad_pp_sw_db_ipv4_cache_mode_set(unit,route_types);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  if (vrf_ndx != ARAD_PP_FRWRD_IP_ALL_VRFS_ID)
  {
    SOC_SAND_ERR_IF_ABOVE_NOF(vrf_ndx, SOC_DPP_DEFS_GET(unit, nof_vrfs), ARAD_PP_VRF_ID_OUT_OF_RANGE_ERR, 10, exit);
  }
  ...
  )
{
  ...
  res = arad_pp_sw_db_ipv4_cache_mode_get(unit,route_types);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  if (all_permitted && vrf_ndx == ARAD_PP_FRWRD_IP_ALL_VRFS_ID)
  {
    goto exit;
  }
  ...
  if (vrf_ndx >= nof_vrfs)
  {
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_VRF_ID_OUT_OF_RANGE_ERR,101,exit);
  }
...
uint32
  arad_pp_frwrd_ipv4_glbl_info_set_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_GLBL_INFO                *glbl_info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_GLBL_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_GLBL_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_GLBL_INFO, glbl_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_GLBL_INFO_GET_VERIFY);
...
uint32
  arad_pp_frwrd_ipv4_glbl_info_get_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_GLBL_INFO                *glbl_info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_GLBL_INFO_GET_UNSAFE);
...
uint32
  arad_pp_frwrd_ipv4_uc_route_add_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY             *route_key,
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY, route_key, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(fec_id, SOC_DPP_DEFS_GET(unit, nof_fecs), ARAD_PP_FEC_ID_OUT_OF_RANGE_ERR, 20, exit);
...
uint32
  arad_pp_frwrd_ipv4_uc_route_get_block_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_INOUT ARAD_PP_IP_ROUTING_TABLE_RANGE              *block_range,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY             *route_keys,
  ...
  )
{
  ...
  SOC_SAND_CHECK_NULL_INPUT(nof_entries);
    ...
    {
      ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY_clear(&route_keys[i]);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_IP_ROUTING_TABLE_RANGE, block_range, 10, exit);
  ...
  )
{
  ...
  res = ARAD_PP_FRWRD_IPV4_HOST_KEY_verify(unit, host_key);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  res = ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO_verify(unit, routing_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  uint32
    res = SOC_SAND_OK;
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
  ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY 
      route_key;
#endif
  ...
  if(ARAD_KBP_ENABLE_IPV4_UC || ARAD_KBP_ENABLE_IPV4_MPLS_EXTENDED)
  {
      ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY_clear(&route_key);
...
#endif
  {
      ...
      fld_val = (flags & ARAD_PP_FRWRD_IP_HOST_CLEAR_ON_GET)? 0x1:0x2;
      ...
      *location = ARAD_PP_FRWRD_IP_ROUTE_LOCATION_HOST;
  }
...
uint32
  arad_pp_frwrd_ipv4_host_get_block_unsafe(
    ...
    SOC_SAND_IN  uint32                                  flags,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_HOST_KEY             *host_keys,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO      *routes_info,
    SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_STATUS           *routes_status,
    SOC_SAND_OUT uint32                                  *nof_entries
  )
{
...
#endif /* defined(INCLUDE_KBP) && !defined(BCM_88030) */
  {
      ...
      *nof_entries = 0;
      ...
      if(flags & ARAD_PP_FRWRD_IP_HOST_GET_ACCESSED_ONLY){
          access_only |= ARAD_PP_FRWRD_LEM_GET_BLOCK_ACCESSED_ONLY;
      }

      if(flags & ARAD_PP_FRWRD_IP_HOST_CLEAR_ON_GET){
  ...
  )
{
  ...
  if (!(SOC_DPP_CONFIG(unit)->l3.ipmc_vpn_lookup_enable) &&
      ...
      res = arad_pp_frwrd_global_ipv4mc_lem_route_add(unit, 
                                                      route_key,
                                                      route_info,
                                                      success);
      SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
    ...
    {
        res = arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_add(
                  unit,
                  route_key,
                  route_info,
                  success);
...
#endif
    {
        key.type = ARAD_IP_TCAM_ENTRY_TYPE_IPV4_MC;
        ...
        res = arad_pp_frwrd_ipv4_em_dest_to_tcam_action(
                unit,
                dest_val,
                &action
              );
  ...
  )
{
  ...
  res = ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY_verify(unit, route_key);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  res = ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO_verify(unit, route_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  ...
  )
{
  ...
  if (!(SOC_DPP_CONFIG(unit)->l3.ipmc_vpn_lookup_enable) &&
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  3,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, PPDB_B_LARGE_EM_DIAGNOSTICS_ACCESSED_MODEr, REG_PORT_ANY, 0, LARGE_EM_DIAGNOSTICS_ACCESSED_MODEf, &old_fld_val));
      /* clear hit indication if reuquired */
      fld_val = (exact_match & ARAD_PP_FRWRD_IP_CLEAR_ON_GET)? 0x1:0x2;
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  5,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, PPDB_B_LARGE_EM_DIAGNOSTICS_ACCESSED_MODEr, REG_PORT_ANY, 0, LARGE_EM_DIAGNOSTICS_ACCESSED_MODEf,  fld_val));
    ...
    {
      res = arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_get(
                  unit,
                  route_key,
                  route_info,
                  found);
...
#endif
    {
        ...
        if (*found)
        {
  		...
  		/* COVERITY */
  		/* The varible action in initialized by calling to uninit_use_in_call */
  		/* coverity[uninit_use_in_call:FALSE] */
          res = arad_pp_frwrd_ipv4_tcam_action_to_em_dest(
                  unit,
                  &action,
                  &dest_val            
                );
  ...
  )
{
  ...
  else if (JER_KAPS_ENABLE(unit))
  {
...
#endif
    {
      ...
      ARAD_ALLOC_ANY_SIZE(keys,ARAD_PP_IP_TCAM_ENTRY_KEY,block_range_key->entries_to_act,"keys frwrd_ipv4_mc_route_get_block");
      ARAD_ALLOC_ANY_SIZE(dest_vals,uint32,block_range_key->entries_to_act,"dest_vals frwrd_ipv4_mc_route_get_block");
      ARAD_ALLOC_ANY_SIZE(actions,ARAD_TCAM_ACTION,block_range_key->entries_to_act,"actions frwrd_ipv4_mc_route_get_block");

      for(indx = 0; indx < block_range_key->entries_to_act; ++indx)
      {
        keys[indx].type = ARAD_IP_TCAM_ENTRY_TYPE_IPV4_MC;
...
exit:
  if(keys != NULL)
  {
    ARAD_FREE_ANY_SIZE(keys);
  }
  if(dest_vals != NULL)
  {
    ARAD_FREE_ANY_SIZE(dest_vals);
  }
  if(actions != NULL)
  {
  ...
  )
{
  ...
  if (!(SOC_DPP_CONFIG(unit)->l3.ipmc_vpn_lookup_enable) &&
    ...
    *success = SOC_SAND_SUCCESS;
    ...
    {
        res = arad_pp_frwrd_ipv4_mc_rpf_kaps_dbal_route_remove(
                  unit,
                  route_key);
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
        *success = SOC_SAND_SUCCESS; 
  ...
  )
{
  ...
  ARAD_PP_LEM_ACCESS_KEY            key_mask;
  uint32                            access_only=0;
  ARAD_PP_FRWRD_IP_MC_RP_INFO   rp_key, rp_mask;
  ARAD_PP_LEM_ACCESS_KEY            *read_keys=NULL;
  ARAD_PP_LEM_ACCESS_PAYLOAD        *read_vals=NULL;
  ...
  *nof_entries = 0;
  ...
  ARAD_PP_FRWRD_IP_MC_RP_INFO_clear(&rp_key);
  ARAD_PP_FRWRD_IP_MC_RP_INFO_clear(&rp_mask);
...
uint32
  arad_pp_frwrd_ipv4_vrf_info_set_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_VRF_ID                              vrf_ndx,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_VRF_INFO                 *vrf_info
  )
{
  uint32
    res = SOC_SAND_OK;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_VRF_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_VRF_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_NOF(vrf_ndx, SOC_DPP_DEFS_GET(unit, nof_vrfs), ARAD_PP_VRF_ID_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_VRF_INFO, vrf_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_VRF_INFO_GET_VERIFY);
...
uint32
  arad_pp_frwrd_ipv4_vrf_info_get_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_VRF_ID                              vrf_ndx,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_VRF_INFO                 *vrf_info
  )
{
  uint32
    res = SOC_SAND_OK;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_VRF_INFO_GET_UNSAFE);
...
uint32
  arad_pp_frwrd_ipv4_vrf_route_add_unsafe(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  ARAD_PP_VRF_ID                              vrf_ndx,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY            *route_key,
    SOC_SAND_IN  ARAD_PP_FEC_ID                              fec_id,
    SOC_SAND_OUT SOC_SAND_SUCCESS_FAILURE                      *success
  )
{
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY, route_key, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(fec_id, SOC_DPP_DEFS_GET(unit, nof_fecs), ARAD_PP_FEC_ID_OUT_OF_RANGE_ERR, 30, exit);
...
uint32
  arad_pp_frwrd_ipv4_vrf_route_get_block_unsafe(
    ...
    SOC_SAND_IN  ARAD_PP_VRF_ID                              vrf_ndx,
    SOC_SAND_INOUT ARAD_PP_IP_ROUTING_TABLE_RANGE              *block_range_key,
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY            *route_keys,
    SOC_SAND_OUT ARAD_PP_FEC_ID                              *fec_ids,
    SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_STATUS               *routes_status,
    SOC_SAND_OUT ARAD_PP_FRWRD_IP_ROUTE_LOCATION             *routes_location,
    SOC_SAND_OUT uint32                                  *nof_entries
  )
{
  ...
  SOC_SAND_CHECK_NULL_INPUT(nof_entries);
    ...
    for(i = 0; i < *nof_entries; i++)
    {
      ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY_clear(&route_keys[i]);
      soc_sand_os_memcpy(&(route_keys[i].subnet), &(subnets[i]), sizeof(SOC_SAND_PP_IPV4_SUBNET));
    }
...
#endif
  {
      if(!(flags & ARAD_PP_FRWRD_IP_HOST_ONLY)) {
          if (SOC_IS_JERICHO(unit)) {
              uint32 db_ndx;
              ARAD_PP_IP_TCAM_ENTRY_KEY
                key;
      ...
      if(!(flags & ARAD_PP_FRWRD_IP_LPM_ONLY)) {
...
uint32
  arad_pp_frwrd_ipv4_mem_status_get_unsafe(
    ...
    SOC_SAND_OUT ARAD_PP_FRWRD_IPV4_MEM_STATUS      *mem_status
  )
{
  ARAD_PP_IPV4_LPM_MNGR_INFO
    lpm_mngr;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_MEM_STATUS_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(mem_status);

  ARAD_PP_FRWRD_IPV4_MEM_STATUS_clear(mem_status);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_IPV4_MEM_STATUS_GET_VERIFY);
...
uint32
  arad_pp_frwrd_ipv4_mem_defrage_unsafe(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  uint32                         mem_ndx,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MEM_DEFRAG_INFO *defrag_info
  )
{
  ARAD_PP_IPV4_LPM_MNGR_INFO
    lpm_mngr;
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_OUT_OF_RANGE(mem_ndx, ARAD_PP_FRWRD_IPV4_MEM_NDX_MIN, ARAD_PP_FRWRD_IPV4_MEM_NDX_MAX, ARAD_PP_FRWRD_IPV4_MEM_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_MEM_DEFRAG_INFO, defrag_info, 20, exit);
...
uint32
  ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_VAL_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_VAL *info
  )
{
  uint32
    res = SOC_SAND_OK;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_VAL_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION *info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_VAL, &(info->value), 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_ROUTER_INFO_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_ROUTER_INFO *info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION, &(info->uc_default_action), 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_ROUTER_DEFAULT_ACTION, &(info->mc_default_action), 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_ROUTER_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_VRF_INFO_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_VRF_INFO *info
  )
{
  uint32
    res = SOC_SAND_OK;
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_IPV4_ROUTER_INFO, &(info->router_info), 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_VRF_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_GLBL_INFO_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_GLBL_INFO *info
  )
{
  uint32
    res = SOC_SAND_OK;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_GLBL_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_UC_ROUTE_KEY_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY_verify(
    SOC_SAND_IN  int                             unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(info->inrif, SOC_DPP_CONFIG(unit)->l3.nof_rifs, ARAD_PP_RIF_ID_OUT_OF_RANGE_ERR, 12, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_MC_ROUTE_KEY_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_VPN_ROUTE_KEY_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_HOST_KEY_verify(
    SOC_SAND_IN  int                         unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_HOST_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);
  SOC_SAND_CHECK_NULL_INPUT(info);

  SOC_SAND_ERR_IF_ABOVE_NOF(info->vrf_ndx, SOC_DPP_DEFS_GET(unit, nof_vrfs), ARAD_PP_VRF_ID_OUT_OF_RANGE_ERR, 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_HOST_KEY_verify()",info->vrf_ndx,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO_verify(
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_HOST_ROUTE_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO_verify(
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_MC_ROUTE_INFO_verify()",0,0);
}


uint32
  ARAD_PP_FRWRD_IPV4_MEM_DEFRAG_INFO_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_IPV4_MEM_DEFRAG_INFO *info
  )
{
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_IPV4_MEM_DEFRAG_INFO_verify()",0,0);
}
