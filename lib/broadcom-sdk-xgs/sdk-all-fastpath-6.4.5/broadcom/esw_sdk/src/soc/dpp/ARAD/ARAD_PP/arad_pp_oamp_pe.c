...
uint32 _arad_pp_oamp_pe_write_inst_default_add_udh(SOC_SAND_IN int);
...
STATIC uint32 _arad_pp_oamp_pe_programs_usage_init(SOC_SAND_IN  int  unit) {
    ...
    if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
        ...
        programs[unit][ARAD_PP_OAMP_PE_PROGS_DEFAULT].instruction_func = (user_header_size != 0)? _arad_pp_oamp_pe_write_inst_default_add_udh : _arad_pp_oamp_pe_write_inst_default;
...
void _arad_pp_oamp_pe_mep_pe_init(SOC_SAND_IN uint32 unit) {
    programs[unit][ARAD_PP_OAMP_PE_PROGS_DEFAULT].mep_pe_profile = 3; /* Ignored*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER].mep_pe_profile = 1; 
    programs[unit][ARAD_PP_OAMP_PE_PROGS_1DM].mep_pe_profile = 2;/* Ignored*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_ETH_TLV_ON_SERVER].mep_pe_profile = 9;
    programs[unit][ARAD_PP_OAMP_PE_PROGS_BFD_ECHO].mep_pe_profile = 0xf;  /* Ignored*/
    ...
    programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMTS_DOWN_MEP].mep_pe_profile = 0x8; /*must be the same as DOWN_MEP_TLV_FIX */
    ...
    programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_EXTERNAL].mep_pe_profile = 0x3;
}
...
STATIC uint32 _arad_pp_oamp_pe_write_to_tcam_arad(SOC_SAND_IN int unit) {
    ...
    SET_OAMP_PE_TCAM_MEP_PE_PROFILE(prog_tcam_entries[tcam_ind].mask, 0x0); /* MEP PE profile selection based */
    ...
    SET_OAMP_PE_TCAM_MEP_PROFILE(prog_tcam_entries[tcam_ind].key,0xf );
    SET_OAMP_PE_TCAM_MEP_PROFILE(prog_tcam_entries[tcam_ind].mask,0xf );
    SET_OAMP_PE_TCAM_MEP_PE_PROFILE_KEY(prog_tcam_entries,tcam_ind, ARAD_PP_OAMP_PE_PROGS_MAID_EXTERNAL);
    SET_OAMP_PE_TCAM_MEP_PE_PROFILE(prog_tcam_entries[tcam_ind].mask, 0); /* MEP PE profile based selection*/
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].key, 2);
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask,0 );/* Select only CCMs*/
    prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_EXTERNAL].prog_used;
    prog_tcam_entries[tcam_ind].valid  =programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_EXTERNAL].instruction_func != NULL;
    LOG_VERBOSE(BSL_LS_SOC_OAM,
                (BSL_META_U(unit,
                            "external MAID: Inserting into tcam entry with dat =%d, key=%x\n"), prog_tcam_entries[tcam_ind].dat, prog_tcam_entries[tcam_ind].key)); 
    ++tcam_ind;
...
uint32 _arad_pp_oamp_pe_write_inst_default_add_udh(SOC_SAND_IN int unit) {
    uint32 res;
    soc_reg_above_64_val_t reg_data, reg_field;
...
BFD single hop programm.
	If MEP_DB.Entry.IP-TTL-TOS-Profile==0xf the UDP destination port should be changed, UDP.Dest-Port to 3784 (taken from 16 MSB of programm variable) 
...
/*  #1 Put the address for the jump in case of ttl-tos-profile equal to 4'hf to TmpReg2 */
	SOC_REG_ABOVE_64_CLEAR(reg_data);
	SOC_REG_ABOVE_64_CLEAR(reg_field);
	SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
	SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
	...
	SET_OAMP_PE_CMP2_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_NEVER);
	SET_OAMP_PE_INST_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_INST_SRC_NXT_JMP);
	SET_OAMP_PE_INST_CONST_BITS(reg_field, (fst_inst_addr + 11));
	soc_OAMP_PE_PROGRAMm_field_set(unit, reg_data, PROG_DATAf, reg_field);
	SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
								 WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL, last_program_pointer[unit]++, reg_data));
...
/*  #4 if TmpReg1 is equal to 0xf, jump to value in TmpReg2  */
	SOC_REG_ABOVE_64_CLEAR(reg_data);
	SOC_REG_ABOVE_64_CLEAR(reg_field);
	SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
	SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_TMP_REG1);
...
/*  #7 copy byte 39, 40 (original UDP destination port)  to buffer */
	SOC_REG_ABOVE_64_CLEAR(reg_data);
	SOC_REG_ABOVE_64_CLEAR(reg_field);
	SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
	SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
...
/*  #8 jump to common part - checksum update and copy rest of the packet */
	SOC_REG_ABOVE_64_CLEAR(reg_data);
	SOC_REG_ABOVE_64_CLEAR(reg_field);
	SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
	SET_OAMP_PE_OP3_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP3_SEL_ALU_OUT);
	...
	SET_OAMP_PE_CMP2_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_ALWAYS);
	SET_OAMP_PE_INST_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_INST_SRC_NXT_JMP);
	SET_OAMP_PE_INST_CONST_BITS(reg_field, (fst_inst_addr + 12));
	soc_OAMP_PE_PROGRAMm_field_set(unit, reg_data, PROG_DATAf, reg_field);
	SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
								 WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL, last_program_pointer[unit]++, reg_data));
...
/*  #14 copy the rest of the packet */
	SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
								 WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL, last_program_pointer[unit]++, reg_default_instr));
...
uint32 _arad_pp_oamp_pe_bfd_ipv4_single_hop_add_udh(SOC_SAND_IN int unit) {
    ...
    BFD single hop programm.
        ...
        If MEP_DB.Entry.IP-TTL-TOS-Profile==7 the UDP destination port should be changed, UDP.Dest-Port to 3784 (taken from 16 MSB of programm variable)
        and UDP checksum of 16'h0 , both at constant position.
        The IP-TTL-TOS profile comes in pkt_var2[3:0]
        The incoming packet structure is as follows: PTCH(2), ITMH(4), ITMH-EXT(3),PPH(7), IPV4(20), UDP(8), BFD
        IP header offset is
    ...
    */
    ...
    /*  #1 Clear all bits of PktVar2 except the lower 4, put the result in TmpReg1  */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_REG2);
    SET_OAMP_PE_OP2_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
    ...
    /*  #2 Put the address for the jump in case of ttl-tos-profile equal to 4'h7 to TmpReg2  */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
    ...
    SET_OAMP_PE_CMP2_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_NEVER);
    SET_OAMP_PE_INST_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_INST_SRC_NXT_JMP);
    SET_OAMP_PE_INST_CONST_BITS(reg_field, (fst_inst_addr + 19));
    soc_OAMP_PE_PROGRAMm_field_set(unit, reg_data, PROG_DATAf, reg_field);
    SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
                  WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL,last_program_pointer[unit]++ , reg_data));


    /*  #3 Copy 4 bytes - system headers (PTCH(2), ITMH(2 of 4), put instruction const to TmpReg3 - should be UDH size (0-8) with 1'b0  */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
    ...
    /*  #4 Copy 4 bytes - system headers - ITMH (next 2 of 4), ITMH-EXT (first 2 of 3) */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
...
/*  #5 Copy 2 bytes - system headers ITMH-EXT (last 1 of 3), PPH (1 bytes of 7), */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 0);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
    ...
    /*  #6 Copy byte from TmpReg3 to buffer (should be the new PPH.Offset)
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 0);
    ...
    /*  #7 Copy 1 byte - system headers  PPH (byte 3 bytes of 7),
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    ...
    /*  #8 copy 4 bytes - the rest of the PPH
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    ...
    /*  #9 push first part of zero bytes of UDH
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 0);
    ...
    /*  #10 push next part of zero bytes of UDH
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 0);
    ...
    /*  #11 Copy the rest 20 bytes of the headers, till byte 36
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    ...
    /*  #13 if TmpReg1 is equal to 7, jump to value in TmpReg2
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, 0Xb);
    ...
    SET_OAMP_PE_BUFF_SIZE_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_BUFF_SIZE_SRC_VLD_B);
    SET_OAMP_PE_INST_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_INST_SRC_NXT_JMP);
    SET_OAMP_PE_INST_CONST_BITS(reg_field, 0Xf);  /*  The value for testing  of 0X0?
     */
    soc_OAMP_PE_PROGRAMm_field_set(unit, reg_data, PROG_DATAf, reg_field);
    SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
                  WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL,last_program_pointer[unit]++ , reg_data));
    ...
    /*  #16 copy byte 39, 40 (original UDP destination port)  to buffer
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    ...
    /*  #17 jump to common part - checksum update and copy rest of the packet
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
    ...
    /*  #20 write the two byte of destination port from prog. variable
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    ...
    /*  #22 put 16'h0 to buffer (UDP checksum invalid)
     */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 0);
    ...
    /*  #23 copy the rest of the packet
     */
    SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
                  WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL,last_program_pointer[unit]++ , reg_default_instr));
...
uint32 arad_pp_oamp_pe_unsafe(SOC_SAND_IN int unit) {
    ...
    CONST static soc_reg_above_64_val_t lfem_values[ARAD_PP_OAMP_PE_MAX_LFEM]= {
        ...
        /*LFEM 1*/ {0x82082082, 0x8208208, 0x208203CE}, /*Used by the default + UDH program */
