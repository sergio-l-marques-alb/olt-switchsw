   ...
   SOC_SAND_OUT SOC_TMC_CNT_MODE_EG_TYPE*   eg_type) 
{
    ...
    if (command_id == 0) {
        field_value = soc_IHB_PMF_PROGRAM_COUNTERSm_field32_get(unit, tbl_data_above_64, COUNTER_BASE_Af);
    } else if (command_id == 1){
        field_value = soc_IHB_PMF_PROGRAM_COUNTERSm_field32_get(unit, tbl_data_above_64, COUNTER_BASE_Bf);
    } else {
