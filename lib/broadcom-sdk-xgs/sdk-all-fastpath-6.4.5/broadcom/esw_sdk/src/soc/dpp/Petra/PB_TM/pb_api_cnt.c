/* $Id: pb_api_cnt.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_TM/src/soc_pb_api_cnt.c
*
* MODULE PREFIX:  pb
*
* FILE DESCRIPTION:
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_COUNTERS_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_cnt_counters_set_verify(
          unit,
          processor_ndx,
          info
        );
  ...
  res = soc_pb_cnt_counters_set_unsafe(
          unit,
          processor_ndx,
          info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_counters_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_COUNTERS_GET);
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_counters_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_STATUS_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(proc_status);

  res = soc_pb_cnt_status_get_verify(
          unit,
          processor_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_cnt_status_get_unsafe(
          unit,
          processor_ndx,
          proc_status
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_status_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_ALGORITHMIC_READ);
  ...
  res = soc_pb_cnt_algorithmic_read_unsafe(
          unit,
          processor_ndx,
          result_arr
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_algorithmic_read()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_DIRECT_READ);
  ...
  res = soc_pb_cnt_direct_read_unsafe(
          unit,
          processor_ndx,
          counter_ndx,
          read_rslt
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_direct_read()", 0, counter_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_Q2CNT_ID);
  ...
  res = soc_pb_cnt_q2cnt_id_unsafe(
          unit,
          processor_ndx,
          queue_ndx,
          counter_ndx
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_q2cnt_id()", queue_ndx, *counter_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_CNT2Q_ID);
  ...
  res = soc_pb_cnt_cnt2q_id_unsafe(
          unit,
          processor_ndx,
          counter_ndx,
          queue_ndx
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_cnt2q_id()", counter_ndx, *queue_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_METER_HDR_COMPENSATION_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_cnt_meter_hdr_compensation_set_verify(
          unit,
          port_ndx,
          hdr_compensation
        );
  ...
  res = soc_pb_cnt_meter_hdr_compensation_set_unsafe(
          unit,
          port_ndx,
          hdr_compensation
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_meter_hdr_compensation_set()", port_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_CNT_METER_HDR_COMPENSATION_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(hdr_compensation);

  res = soc_pb_cnt_meter_hdr_compensation_get_verify(
          unit,
          port_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_cnt_meter_hdr_compensation_get_unsafe(
          unit,
          port_ndx,
          hdr_compensation
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_cnt_meter_hdr_compensation_get()", port_ndx, 0);
}
