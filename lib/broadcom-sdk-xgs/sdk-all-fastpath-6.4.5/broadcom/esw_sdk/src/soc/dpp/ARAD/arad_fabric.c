  ...
  )
{
    ...
    {  
        ...
        *tx_field = soc_reg_field_get(unit, FMAC_RECEIVE_RESET_REGISTERr, reg_val, FMAC_TX_RST_Nf);
        ...
        /* RTP */
        SOCDNX_IF_ERR_EXIT(READ_RTP_ALLOWED_LINKSr(unit, &reg_64val));
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_RTP_ALLOWED_LINKSr(unit,  reg_64val));
   ...
   SOC_SAND_IN  int                                 unit)
{
          ...
          port_index++)
    {
        ...
        rv = MBCM_DPP_SOC_DRIVER_CALL(unit, mbcm_dpp_port_enable_get, (unit, port_index, &enable));
        SOCDNX_IF_ERR_EXIT(rv);
        if (!enable) {
            /*port is disabled*/
            continue;
...
soc_error_t 
arad_fabric_prbs_polynomial_set(int unit, soc_port_t port, portmod_prbs_mode_t mode, int value)
{
    int rv;
    SOCDNX_INIT_FUNC_DEFS;
...
soc_error_t 
arad_fabric_prbs_polynomial_get(int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value)
{
    int rv;
    SOCDNX_INIT_FUNC_DEFS;
