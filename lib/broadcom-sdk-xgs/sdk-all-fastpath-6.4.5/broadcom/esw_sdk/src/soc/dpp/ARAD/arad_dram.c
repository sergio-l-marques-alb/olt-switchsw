    ...
    )
{
    ...
    if(SOC_IS_JERICHO(unit)) {
        ...
        SOC_SAND_SOC_IF_ERROR_RETURN(res, 10, exit, soc_reg_field32_modify(unit, MMU_ENABLE_DYNAMIC_MEMORY_ACCESSr, REG_PORT_ANY, ENABLE_DYNAMIC_MEMORY_ACCESSf, 1));       
    }
    ...
    if(SOC_IS_JERICHO(unit)) {
        ...
        SOC_SAND_SOC_IF_ERROR_RETURN(res, 90, exit, soc_reg_field32_modify(unit, MMU_ENABLE_DYNAMIC_MEMORY_ACCESSr, REG_PORT_ANY, ENABLE_DYNAMIC_MEMORY_ACCESSf, 0));
    }
