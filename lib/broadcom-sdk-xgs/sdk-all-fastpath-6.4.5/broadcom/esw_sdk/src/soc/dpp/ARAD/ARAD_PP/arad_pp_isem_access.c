  ...
  )
{
      ...
      vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VD_DESIGNATED_VID_TRILL].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_DESIGNATED_VID_TRILL].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VD_DESIGNATED_VID_TRILL;
      ...
      vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VD_OUTER_TRILL].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTERVID_TRILL].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_TRILL;
      ...
      vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VD_INITIALVID_TRILL].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INITIALVID_TRILL].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_TRILL;
      ...
      vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VD_OUTER_INNER_TRILL].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTER_INNER_VID_TRILL].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_TRILL;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_IPV4_OUTER_VID_AFTER_RECYCLE].prog_used != -1)
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_IPV4_VDxOUTERVID_AFTER_RCY].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID_AFTER_RCY;
    prog_indx++; /* adding 2 program selections in one call */
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_IPV4_INITIAL_VID_AFTER_RECYCLE].prog_used != -1)
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_IPV4_VDxINITIALVID_AFTER_RCY].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID_AFTER_RCY;
    prog_indx++; /* adding 2 program selections in one call */
  }  
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_IPV4_OUTER_VID].prog_used != -1)
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_IPV4_VDxOUTERVID].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_IPV4_INITIAL_VID].prog_used != -1)
  {
      ...
      vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_IPV4_VDxINITIALVID].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VDxOUTERVID_L1_L2ELI].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INITIALVID_L1_L2ELI].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1_L2ELI;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VDxINITIALVID_L1_L2ELI].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTERVID_L1_L2ELI].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1_L2ELI;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_INDX_VD_OUTERVID_L3].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_VDxOUTERVID_L3].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L3;
    prog_indx++; /* adding 2 program selections in one call */
  }
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_INDX_VD_INITIALVID_L3].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_VDxINITIALVID_L3].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L3;
    prog_indx++; /* adding 2 program selections in one call */
  }
  /* MPLS context RIF logic } */
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_INDX_VD_OUTERVID_L1].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_VDxOUTERVID_L1].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L1;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_INDX_VD_INITIALVID_L1].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_VDxINITIALVID_L1].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L1;
    prog_indx++; /* adding 2 program selections in one call */
  }
  /* MPLS Defaults Indexed } */  
  ...
  )
{
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2].prog_used != -1)
  {
    ...
    /*arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2].prog_used);*/

    if (prog_soc_prop->mpls_tp_mac_address) 
      prog_indx++;
      /*arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,1,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2].prog_used);*/

    if (prog_soc_prop->port_raw_mpls) 
        prog_indx++;
        /*arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2].prog_used);*/
  }
  ...
  else
  {
      ...
      if (!prog_soc_prop.port_vlan_pcp_lookup && !prog_soc_prop.match_port_vlan_critiria_64K && !prog_soc_prop.custom_feature_vt_tst1)
      {
          ...
          if (!prog_soc_prop.trill_mode && prog_soc_prop.mpls_1_database == ARAD_PP_ISEM_ACCESS_ID_ISEM_B)
          {
              ...
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_TRILL].prog_used[unit] = (last_vt_program_id - 1);
              if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled) {
                  SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_VD_OUTER_TRILL);
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_TRILL].prog_used[unit] = (last_vt_program_id - 1);
              }
          }
      }
      ...
      if ((!prog_soc_prop.port_vlan_pcp_lookup) && (!prog_soc_prop.match_port_vlan_critiria_64K) && (!prog_soc_prop.custom_feature_vt_tst1))
      {
          if (!prog_soc_prop.mpls_use_in_rif)
          {
              if (prog_soc_prop.eli_enable)
              {
                  ...
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1_L2ELI].prog_used[unit] = (last_vt_program_id - 1);
                  if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
                  {
                      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_VDxOUTERVID_L1_L2ELI);
                      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1_L2ELI].prog_used[unit] = (last_vt_program_id - 1);
                  }
              }
          }
          ...
          else if (prog_soc_prop.mpls_index && (!prog_soc_prop.mpls_use_in_rif))
          {
              ...
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L1].prog_used[unit] = (last_vt_program_id - 1);
              if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
              {
                  SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_INDX_VD_OUTERVID_L1);
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L1].prog_used[unit] = (last_vt_program_id - 1);
              }
              if (prog_soc_prop.fast_reroute_labels_enable)
              {
                  /* FRR */
          ...
          else
          {
              ...
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L3].prog_used[unit] = (last_vt_program_id - 1);
              if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
              {
                  SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_INDX_VD_OUTERVID_L3);
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L3].prog_used[unit] = (last_vt_program_id - 1);
              }
              if (prog_soc_prop.fast_reroute_labels_enable)
              {
                  /* FRR */
      ...
      if (prog_soc_prop.trill_mode)
      {
          ...
          if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
          {
              if (!prog_soc_prop.trill_disable_designated_vlan_check && prog_soc_prop.designated_vlan_inlif_enable) {
                  ...
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VD_DESIGNATED_VID_TRILL].prog_used[unit] = (last_vt_program_id - 1);
              }
              SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_VD_OUTER_TRILL);
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_TRILL].prog_used[unit] = (last_vt_program_id - 1);
          }
          SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_VD_OUTER_INNER_TRILL);
          vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_TRILL].prog_used[unit] = (last_vt_program_id - 1);
      }
      ...
      if (SOC_DPP_CONFIG(unit)->pp.ip_lif_dummy_id) {
          ...
          vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID_AFTER_RCY].prog_used[unit] = (last_vt_program_id - 1);
          if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
          {
              SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_IPV4_OUTER_VID_AFTER_RECYCLE);
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID_AFTER_RCY].prog_used[unit] = (last_vt_program_id - 1);
          }
      }
      ...
      if (prog_soc_prop.ipv4_term_enable) {
          ...
          vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID].prog_used[unit] = (last_vt_program_id - 1);
          if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
          {
              SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_IPV4_OUTER_VID);
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID].prog_used[unit] = (last_vt_program_id - 1);
          }
      }
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0            = ARAD_PP_CE_NATIVE_VLAN_VSI;       /* SOC_PPC_FP_QUAL_NATIVE_INNER_VLAN_VSI */
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst0            = ARAD_PP_CE_SIP_IPV4_HDR2_HEADER;  
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2            = ARAD_PP_CE_GRE_8B_CRKS_BITS_CE16; /*SOC_PPC_FP_QUAL_GRE_CRKS*/
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst2            = ARAD_PP_CE_GRE_8B_KEY_31_8_BITS_CE32;/*SOC_PPC_FP_QUAL_GRE_FLAG_VER_PRTCL*/
  ...
  )
{
  ...
  if (SOC_DPP_CONFIG(unit)->pp.test1 == 1 ){     
      ihp_vtt2nd_key_construction_tbl_data.key_32b_inst0        = ARAD_PP_CE_ETH_HEADER_ISID_16_LSB; }
  else {
