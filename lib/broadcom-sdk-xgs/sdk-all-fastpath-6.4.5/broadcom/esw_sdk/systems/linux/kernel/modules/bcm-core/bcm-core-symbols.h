...
EXPORT_SYMBOL(format_uint64);
EXPORT_SYMBOL(parse_uint64);
#endif
...
EXPORT_SYMBOL(_bcm_dpp_gport_to_global_lif);
...
EXPORT_SYMBOL(var_get);
EXPORT_SYMBOL(var_set_integer);
EXPORT_SYMBOL(var_unset);
EXPORT_SYMBOL(parse_arg_eq);
EXPORT_SYMBOL(parse_arg_eq_done);
EXPORT_SYMBOL(parse_table_add);
EXPORT_SYMBOL(parse_table_init);
#include <appl/diag/shell.h>
EXPORT_SYMBOL(sh_check_attached);
#include <sal/appl/sal.h>
EXPORT_SYMBOL(sal_strcasecmp);
EXPORT_SYMBOL(bcm_port_name);
