...
typedef enum arad_fast_regs_type_e
{
    ...
    ARAD_FAST_REG_TYPE_LAST_NOT_JERICHO,/* Last without Jericho*/

    ARAD_FAST_REG_IHP_KAPS_IBC_RESPONSE_WORD = ARAD_FAST_REG_TYPE_LAST_NOT_JERICHO,
...
typedef enum arad_fast_field_type_e
{
    ...
    ARAD_FAST_FIELD_TYPE_LAST_NOT_JERICHO,/* Last without Jericho*/


    ARAD_FAST_FIELD_IHP_KAPS_IBC_COMMAND_WORD_BLKID = ARAD_FAST_FIELD_TYPE_LAST_NOT_JERICHO,
