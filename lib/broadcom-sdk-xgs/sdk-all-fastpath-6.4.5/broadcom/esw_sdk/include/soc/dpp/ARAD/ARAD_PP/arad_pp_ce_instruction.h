...
/* $Id: arad_pp_ce_instruction.h,v 1.22 Broadcom SDK $
...
#define ARAD_PP_CE_ETH_HEADER_OUTER_PCP        arad_pp_ce_instruction_composer(4,ARAD_PP_CE_HEADER_1,100,ARAD_PP_CE_IS_CE16);
...
/*#define ARAD_PP_CE_ETH_HEADER_WITH_BTAG_ISID arad_pp_ce_instruction_composer(24,ARAD_PP_CE_HEADER_1,144,ARAD_PP_CE_IS_CE32); */
#define ARAD_PP_CE_ETH_HEADER_ISID arad_pp_ce_instruction_composer(24,ARAD_PP_CE_HEADER_2,-32,ARAD_PP_CE_IS_CE32);
/*#define ARAD_PP_CE_ETH_HEADER_WITHOUT_BTAG_ISID arad_pp_ce_instruction_composer(24,ARAD_PP_CE_HEADER_1,112,ARAD_PP_CE_IS_CE32); */
...
#define ARAD_PP_CE_VXLAN_VNI_BITS_CE32 arad_pp_ce_instruction_composer(24,ARAD_PP_CE_HEADER_3,-40,ARAD_PP_CE_IS_CE32); /* VXLAN is at the end of 2nd header */
...
/* Ethertype */
#define ARAD_PP_CE_ETH_HEADER_ETH_TYPE_NO_TAGS_16   arad_pp_ce_instruction_composer(16,ARAD_PP_CE_HEADER_1,96,ARAD_PP_CE_IS_CE16);
#define ARAD_PP_CE_ETH_HEADER_ETH_TYPE_NO_TAGS_32   arad_pp_ce_instruction_composer(16,ARAD_PP_CE_HEADER_1,80,ARAD_PP_CE_IS_CE32);
#define ARAD_PP_CE_ETH_HEADER_ETH_TYPE_ONE_TAG_16   arad_pp_ce_instruction_composer(16,ARAD_PP_CE_HEADER_1,128,ARAD_PP_CE_IS_CE16);
#define ARAD_PP_CE_ETH_HEADER_ETH_TYPE_ONE_TAG_32   arad_pp_ce_instruction_composer(16,ARAD_PP_CE_HEADER_1,112,ARAD_PP_CE_IS_CE32);
#define ARAD_PP_CE_ETH_HEADER_ETH_TYPE_TWO_TAGS_16  arad_pp_ce_instruction_composer(16,ARAD_PP_CE_HEADER_1,160,ARAD_PP_CE_IS_CE16);
#define ARAD_PP_CE_ETH_HEADER_ETH_TYPE_TWO_TAGS_32  arad_pp_ce_instruction_composer(16,ARAD_PP_CE_HEADER_1,144,ARAD_PP_CE_IS_CE32);

/* LLID */
#define ARAD_PP_CE_TK_PON_LLID_16 arad_pp_ce_instruction_composer(11,ARAD_PP_CE_HEADER_1,-16,ARAD_PP_CE_IS_CE16);    
#define ARAD_PP_CE_TK_PON_LLID_32 arad_pp_ce_instruction_composer(11,ARAD_PP_CE_HEADER_1,-32,ARAD_PP_CE_IS_CE32);    
