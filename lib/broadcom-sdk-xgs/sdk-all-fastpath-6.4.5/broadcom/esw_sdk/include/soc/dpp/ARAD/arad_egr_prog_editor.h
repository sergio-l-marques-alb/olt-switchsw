...
/* Even instruction entry for a program */
#define _ARAD_EGR_PROG_EDITOR_PROG_ENTRY_EVEN(program_id) \
    _ARAD_EGR_PROG_EDITOR_PTR_TO_BRANCH_ENTRY_EVEN(programs[unit][program_id].program_pointer)

/* Odd instruction entry for a program */
#define _ARAD_EGR_PROG_EDITOR_PROG_ENTRY_ODD(program_id) \
    _ARAD_EGR_PROG_EDITOR_PTR_TO_BRANCH_ENTRY_ODD(programs[unit][program_id].program_pointer)
...
typedef enum
{
    ...
    ARAD_EGR_PROG_EDITOR_LFEM_ZERO_BIT8, /* Data[15:0] & ~(0x100) - Clear BOS of MPLS label[15:0]*/
