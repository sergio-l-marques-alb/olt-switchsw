...
const char* arad_pp_dbal_key_id_to_string(uint8 key_id);
...
uint32 arad_pp_dbal_kbp_buffer_to_entry_key(int unit, const SOC_DPP_DBAL_TABLE_INFO *dbal_table, uint32 table_size_in_bytes, uint32 prefix_len, uint8 *data_bytes,
