...
typedef struct {
    ...
    dpp_rep_data_t *egr_port_outlif_reps;
    dpp_rep_data_t *egr_outlif_reps;
    dpp_rep_data_t *egr_bitmap_reps;
...
#define DPP_MC_NO_2ND_CUD 0xffffffff /* There is no 2nd CUD */
