...
#define ARAD_FABRIC_ALDWP_MIN                   (0x6)
...
soc_error_t arad_fabric_prbs_polynomial_set(int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
soc_error_t arad_fabric_prbs_polynomial_get(int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
