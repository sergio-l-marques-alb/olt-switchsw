...
int 
portmod_port_legacy_phy_control_set(int unit, int port, soc_phy_control_t control, uint32_t value);
int 
portmod_port_legacy_phy_control_get(int unit, int port, soc_phy_control_t control, uint32_t* value);
int 
