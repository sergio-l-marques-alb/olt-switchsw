...
int pm4x25_port_pfc_config_get(int unit, int port, pm_info_t pm_info, const portmod_pfc_config_t* pfc_cfg);
...
int pm4x25_ext_phy_attach_to_pm(int unit, pm_info_t pm_info, const phymod_core_access_t* ext_phy_access, uint32 first_phy_lane);
