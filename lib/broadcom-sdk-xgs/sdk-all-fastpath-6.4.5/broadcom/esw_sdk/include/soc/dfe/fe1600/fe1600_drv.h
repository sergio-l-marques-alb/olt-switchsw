/*
 * $Id: fe1600_drv.h,v 1.12 Broadcom SDK $
 *
...
/* MBIST for all FE1600 memories, excepct for ones that ASIC designeres selected to exclude */
...
#ifdef BCM_88750_B0
/*Enables fe1600_b0 hw bug fixes*/
int soc_fe1600_bo_hw_bug_fixes_enable(int unit, int enable);
#endif

/*Reduced Fe1600 - power consumption*/
int soc_fe1600_reduced_support_set(int unit);

#ifdef BCM_88754_A0
/*
 * BCM88754 includes Async fifo interface. 
 * This function configures\reterive async fifo confgiuration using this interface.  
 */
