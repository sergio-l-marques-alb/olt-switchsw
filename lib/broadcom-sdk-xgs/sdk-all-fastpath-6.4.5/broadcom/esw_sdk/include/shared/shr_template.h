 ...
 * 
 *      If WITH_ID is set and the template specified in *template is not yet allocated,
 *      this will allocate it and set its data to the specified data. 
 * 
 *      If WITH_ID is set but IGNORE_DATA is not, and the specified template in *template is
