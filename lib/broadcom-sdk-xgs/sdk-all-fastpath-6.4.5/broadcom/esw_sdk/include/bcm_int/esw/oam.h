...
struct _bcm_oam_hash_data_s {
    ...
    uint32          mpls_lm_dm_int_flag; /* InternaL FLAG FOR MPLS_LM_DM  */
    uint32          mpls_lm_dm_uc_session_id; /* Session Id on UC for this EP */
#endif
    bcm_oam_vccv_type_t vccv_type;          /* VCCV pseudowire type          */
    bcm_vpn_t           vpn;
...
struct _bcm_oam_control_s {
 ...
 /* No of endpoints using OAM key2 */
    ...
    int                         eth_lm_dm_pm_event_thread_kill;/* Signal Event thread exit */
    int                         mpls_lm_dm_pm_event_thread_kill;/* Signal Event thread exit */
