...
#ifndef _BCM_COMMON_PKT_H
#define _BCM_COMMON_PKT_H
...
#include <bcm/debug.h>
/* Dump a DNX packet. */
extern void bcm_dnx_pkt_dump(
    bcm_pkt_t *pkt);

/* Dump ptch1 Header. */
extern void bcm_pkt_dnx_ptch1_dump(
    bcm_pkt_dnx_ptch1_t *ptch1);

/* Dump ptch2 Header. */
extern void bcm_pkt_dnx_ptch2_dump(
...
/* Dump pph eei extension. */
extern void bcm_pkt_dnx_pph_eei_extension_dump(
    bcm_pkt_dnx_pph_eei_extension_t *ext);

/* Dump pph learn extension. */
extern void bcm_pkt_dnx_pph_learn_extension_dump(
    bcm_pkt_dnx_pph_learn_extension_t *ext);

/* Dump pph fhei bridge extension. */
extern void bcm_pkt_dnx_pph_fhei_bridge_extension_dump(
    bcm_pkt_dnx_pph_fhei_bridge_extension_t *ext);

/* Dump pph fhei trap extension. */
extern void bcm_pkt_dnx_pph_fhei_trap_extension_dump(
    bcm_pkt_dnx_pph_fhei_trap_extension_t *ext);

/* Dump pph fhei ip extension. */
extern void bcm_pkt_dnx_pph_fhei_ip_extension_dump(
    bcm_pkt_dnx_pph_fhei_ip_extension_t *ext);
/* Dump pph fhei mpls extension. */
extern void bcm_pkt_dnx_pph_fhei_mpls_extension_dump(
    bcm_pkt_dnx_pph_fhei_mpls_extension_t *ext);

/* Dump pph fhei trill extension. */
extern void bcm_pkt_dnx_pph_fhei_trill_extension_dump(
    bcm_pkt_dnx_pph_fhei_trill_extension_t *ext);

/* Dump pph fhei extension. */
extern void bcm_pkt_dnx_pph_fhei_extension_dump(
    bcm_pkt_dnx_pph_fhei_extension_t *ext);

/* Dump a DNX pph header. */
extern void bcm_pkt_dnx_pph_dump(
