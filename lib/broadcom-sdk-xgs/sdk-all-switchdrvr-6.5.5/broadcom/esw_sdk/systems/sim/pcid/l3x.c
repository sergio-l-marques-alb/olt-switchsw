                               ...
                               int *do_first_fit)
{
    ...
    if (SOC_IS_TOMAHAWK(pcid_info->unit) || SOC_IS_APACHE(unit)) {
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(pcid_info->unit)) {
        soc_tomahawk_hash_bank_info_get(pcid_info->unit, L3_ENTRY_ONLYm,
                                             bank, entries_per_bank,
                                             entries_per_row,
                                             entries_per_bucket,
                                             bank_base, bucket_offset);
