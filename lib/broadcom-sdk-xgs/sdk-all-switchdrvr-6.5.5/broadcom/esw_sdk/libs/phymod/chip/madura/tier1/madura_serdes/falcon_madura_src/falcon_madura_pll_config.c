...
err_code_t falcon_furia_madura_configure_pll( const phymod_access_t *pa, enum falcon_furia_madura_pll_enum pll_cfg) {
    uint8_t reset_state;
  ...
  /* Restore defaults, needed for non-register reset cases */
    /* wrc_falcon_furia_madura_pll_mode(0x7);            */
    /* wrc_falcon_furia_madura_ams_pll_vco2_15g(0x0);    */
    /* wrc_falcon_furia_madura_ams_pll_force_kvh_bw(0);  */
    /* wrc_falcon_furia_madura_ams_pll_kvh_force(0);     */
    /* wrc_falcon_furia_madura_ams_pll_vco_indicator(0); */
    ESTM(reset_state = rdc_falcon_madura_core_dp_reset_state());
    if(reset_state < 7) {
        USR_PRINTF(("ERROR: falcon_furia_madura_configure_pll( pa, ..) called without core_dp_s_rstb=0\n"));
  ...
  switch (pll_cfg) {
    ...
    case FALCON_FURIA_pll_div_80x :
      ...
      wrc_falcon_furia_madura_pll_mode(0x02);
      wrc_falcon_furia_madura_ams_pll_vco2_15g(0x1);
      break;

    case FALCON_FURIA_pll_div_96x :
      /* pll_ mode<4:0> = 10000, VCO = 15.0G, Refclk = 156.25MHz  */
      wrc_falcon_furia_madura_pll_mode(0x10);
      wrc_falcon_furia_madura_ams_pll_vco2_15g(0x1);
      break;
    ...
    case FALCON_FURIA_pll_div_160x :
      ...
      wrc_falcon_furia_madura_pll_mode(0x06);
      wrc_falcon_furia_madura_ams_pll_vco2_15g(0x0);
      break;
    ...
    case FALCON_FURIA_pll_div_160x_refc174 :
      ...
      wrc_falcon_furia_madura_pll_mode(0x6);
      wrc_falcon_furia_madura_ams_pll_force_kvh_bw(1);
      wrc_falcon_furia_madura_ams_pll_kvh_force(0);
      wrc_falcon_furia_madura_ams_pll_vco_indicator(1);
      break;
...
} /* falcon_furia_madura_configure_pll */

/* Get PLL mode */
err_code_t falcon_furia_madura_get_pll_mode(const phymod_access_t *pa, uint8_t *fal_pll_mode) {

  ESTM(*fal_pll_mode = rdc_falcon_furia_madura_pll_mode());
