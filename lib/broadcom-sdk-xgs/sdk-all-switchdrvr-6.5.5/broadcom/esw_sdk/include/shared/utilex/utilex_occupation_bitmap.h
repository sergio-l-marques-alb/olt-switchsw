...
*   UTILEX_IN  int                               unit -
*     Identifier of the device to access.
*   UTILEX_OUT  UTILEX_OCC_BM_PTR              bit_map -
...
uint32
  utilex_occ_bm_get_ptr_from_handle(
    UTILEX_IN  int                          unit,
    UTILEX_IN  UTILEX_OCC_BM_PTR          bit_map,
    UTILEX_OUT UTILEX_OCC_BM_T            **bit_map_ptr_ptr
  ) ;
...
*   UTILEX_IN  int                               unit -
*     Identifier of the device to access.
*  UTILEX_IN  UTILEX_OCC_BM_INIT_INFO          info -
...
*   UTILEX_IN  UTILEX_OCC_BM_PTR bit_map -
*     The bitmap to perform the get operation at.
*   UTILEX_IN   uint32             start -
*     start bit of the range
*   UTILEX_IN   uint32             end -
*     end bit of the range
*   UTILEX_IN   uint8              forward -
...
*   UTILEX_IN  int                   unit -
*     Identifier of the device to access.
*  UTILEX_INOUT  UTILEX_OCC_BM_PTR bit_map -
*     The bitmap to perform the set operation at.
*  UTILEX_IN  uint32                 place -
*     bit to start the setting from
*  UTILEX_IN  uint8                  occupied -
...
void
  utilex_SAND_OCC_BM_INIT_INFO_clear(
    UTILEX_INOUT UTILEX_OCC_BM_INIT_INFO *info
  );
...
uint32
  utilex_occ_bm_get_buffer_size(
    UTILEX_IN  int                          unit,
    UTILEX_IN  UTILEX_OCC_BM_PTR          bit_map,
    UTILEX_OUT  uint32                      *buffer_size_p
  ) ;
uint32
  utilex_occ_bm_get_support_cache(
    UTILEX_IN  int                          unit,
    UTILEX_IN  UTILEX_OCC_BM_PTR          bit_map,
    UTILEX_OUT  uint8                       *support_cache_p
  ) ;
/*
 ...
 */
uint32
   utilex_occ_bm_get_illegal_bitmap_handle(void) ;
/*********************************************************************
* NAME:
