...
#define SW_STATE_DPP_SOC_ARAD_TM_EGR_PROG_EDITOR_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_ARAD_TM_EGR_PROG_EDITOR_TM_PROFILES_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_SOC_ARAD_TM_EGR_PROG_EDITOR_PROGRAMS_LAYOUT_NOF_MAX_LAYOUT_NODES) 
