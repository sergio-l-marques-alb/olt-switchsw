...
#define SOC_APACHE_NUM_EL_SHARED                         8
#define SOC_APACHE_NUM_EL_ALPM                           4
#define SOC_APACHE_NUM_EL_VLAN_XLATE                     4
#define SOC_APACHE_NUM_EL_EGR_VLAN_XLATE                 4
#define SOC_APACHE_NUM_EL_ING_L3_NEXT_HOP                8
#define SOC_APACHE_NUM_EL_L3_IPMC                        4
#define SOC_APACHE_NUM_EL_L2MC                           4

#define SOC_APACHE_RAM_OFFSET_L2_BANK                 4096
#define SOC_APACHE_RAM_OFFSET_L2_SHARED_BANK          8192
...
#define SOC_APACHE_NUM_ENTRIES_PER_L2_BANK           16384
#define SOC_APACHE_NUM_ENTRIES_L2_BANK               32768
#define SOC_APACHE_NUM_ENTRIES_L3_BANK               16384
...
extern int soc_apache_port_asf_para_set(int unit, soc_port_t port, int speed,
                                     int enable);
extern int soc_apache_port_speed_update(int unit, soc_port_t port,
                                          int speed);
