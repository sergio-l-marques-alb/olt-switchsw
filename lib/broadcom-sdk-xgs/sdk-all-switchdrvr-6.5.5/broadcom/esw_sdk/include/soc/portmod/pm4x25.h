...
/*Get PM phys.*/
int pm4x25_pm_phys_get(int unit, pm_info_t pm_info, soc_pbmp_t* phys);
...
/*get port auto negotiation local ability*/
int pm4x25_port_ability_advert_set(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);
int pm4x25_port_ability_advert_get(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);

/*Port ability remote Adv get*/
int pm4x25_port_ability_remote_get(int unit, int port, pm_info_t pm_info, portmod_port_ability_t* ability);
...
/*set modid field.*/
int pm4x25_port_mode_set(int unit, int port, pm_info_t pm_info, portmod_port_mode_info_t* mode);
