...
int soc_qax_port_prd_drop_count_get(int unit, soc_port_t port, uint32 *count);
int soc_qax_nif_sku_restrictions(int unit, bcm_pbmp_t phy_pbmp, bcm_port_if_t interface, uint32 interface_id, uint32 is_kbp);
