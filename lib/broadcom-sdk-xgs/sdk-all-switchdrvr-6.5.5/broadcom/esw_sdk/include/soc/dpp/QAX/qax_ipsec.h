 ...
 * MACROS
 * */
#define SOC_QAX_IPSEC_ID_IN_RANGE_CHECK(id)     if (((id) < (0)) || ((id) > (BCM_IPSEC_MAX_NUM_OF_SA))) /*SOC_SAND_ERR_IF_OUT_OF_RANGE*/ return SOC_E_LIMIT;
...
typedef enum soc_qax_ipsec_program_type_e {
    ...
    Ipsec_Program_Type_Count                     = 5       /* Should Always be last */
...
/* Correlated names for the bcm_ipsec_algo_type_e */
...
/* Correlated names for the bcm_ipsec_auth_type_e */
...
/* Correlated names for the bcm_ipsec_direction_e */
