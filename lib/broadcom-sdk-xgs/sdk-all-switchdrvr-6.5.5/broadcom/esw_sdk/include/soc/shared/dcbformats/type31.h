/*
 * $Id: type31.h,v 1.1.6.2 Broadcom SDK $
 ...
 *
 * File:        soc/shared/dcbformats/type31.h
 * Purpose:     Define dma control block (DCB) format for a type31 DCB
 *              used by the 53400 (Greyhound)
 *
 *              This file is shared between the SDK and the embedded applications.
 */

#ifndef _SOC_SHARED_DCBFORMATS_TYPE31_H
#define _SOC_SHARED_DCBFORMATS_TYPE31_H
...
typedef struct {
...
#endif  /* LE_HOST */
        uint32  reason_hi;              /* T31.2: CPU opcode (hi bits) */
        uint32  reason;                 /* T31.3: CPU opcode (low bits) */
#ifdef  LE_HOST
    union {                             /* T31.4 */
        struct {
            uint32  :16,                /* Reserved */
    ...
    union {                             /* T31.4 */
        ...
        uint32  mh0;                    /* T31.6: Module Header word 0 */
        uint32  mh1;                    /* T31.7: Module Header word 1 */
        uint32  mh2;                    /* T31.8: Module Header word 2 */
        uint32  mh3;                    /* T31.9: Module Header word 3 */
#ifdef  LE_HOST
                                        /* T31.10 */
        uint32  inner_pri:3,            /* Inner priority */
                regen_crc:1,            /* Packet modified and needs new CRC */
                repl_nhi:12,            /* Replication or Next Hop index */
                :5,                     /* reserved.*/
                shaping_cos_sel:2,      /* */                    
