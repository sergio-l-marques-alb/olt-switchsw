...
#define _DPP_CRPS_COMPENSATION_PROFILES_SIZE (16)
#define _DPP_STAT_INTERFACE_COMPENSATION_PROFILES_SIZE (16)
...
int _bcm_dpp_am_template_l2_trap_rm_exchange(int unit, int flag, int port, int mac_lsb, bcm_dpp_user_defined_traps_t* data, int *old_template, int *is_last, int *template,int *is_allocated);
