...
#define BCM_FIELD_WB_DEFAULT_VERSION            BCM_FIELD_WB_VERSION_1_20
#endif 
...
typedef struct _field_entry_wb_info_s {
    ...
    bcm_gport_t                       ingress_mirror;              /* Ingress Mirror Gport */
    bcm_gport_t                       egress_mirror;               /* Egress Mirror Gport */
...
typedef enum _bcmFieldActionNoParam_e {
    ...
    _bcmFieldActionNoParamCount  /* 41 */
