...
#define RH_OPT_MAX_PATHS(u) 16384
...
#define RH_ECMP_MEMBER_TBL_MAX(u)    16384
...
_field_th_em_entries_free_get(int unit, _field_group_t *fg,
                                        int *free_count);
extern int
_field_th_em_validate_view(int unit, uint16 key_size,
                                  _field_group_t *fg);
extern int
...
extern int bcm_th_ecmp_rh_set_intf_arr(int unit, int intf_count,
                                       ...
                                       int group_size,
                                       int max_paths);
extern int bcm_th_ecmp_rh_multipath_get(int unit, int ecmp_group_idx, int intf_size,
...
extern int bcm_th_ecmp_lb_mode_reset(int unit,
                                     bcm_if_t mpintf);
extern void bcm_th_ecmp_group_rh_set(int unit, int ecmp_group_idx, int enable);
extern int bcm_th_ecmp_group_is_rh(int unit, int ecmp_group_idx);
extern int bcm_th_l3_egress_ecmp_rh_shared_copy(int unit, int old_ecmp_group,
                                                int new_ecmp_group);
