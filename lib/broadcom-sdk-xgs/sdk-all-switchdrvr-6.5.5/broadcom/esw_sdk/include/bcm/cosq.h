...
#define BCM_COSQ_GPORT_SIZE_DRAM_BOUND      0x0020     /* DRAM bound
                                                          configuration */
#define BCM_COSQ_GPORT_SIZE_SRC_VSQ_POOL1   0x0040     /* Configure the pool-1
                                                          source VSQ, else
                                                          configure the pool-0
                                                          source VSQ. */
#define BCM_COSQ_GPORT_SIZE_RECOVERY_FAILURE 0x0080     /* Configure recovery
                                                          failure settings */
#define BCM_COSQ_GPORT_SIZE_RECOVERY        0x0100     /* Configure recovery
                                                          settings */
#define BCM_COSQ_GPORT_SIZE_GLOBAL          0x0200     /* Configure global
                                                          settings */
#define BCM_COSQ_GPORT_SIZE_PACKET_DESC     0x0400     /* Configure packet
                                                          description */
...
typedef struct bcm_cosq_ingress_drop_control_frame_config_s {
    ...
    uint32 ether_type_code;         /* Eth type to recognize as Control Plane
                                       packet */
    uint64 ether_type_code_mask;    /* Eth type code mask */
