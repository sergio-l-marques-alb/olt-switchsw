...
#define BCM_FIELD_PKT_RES_MPLSMCKNOWN   0x1e       /* Known MPLS Multicast
                                                      packet */
#define BCM_FIELD_PKT_RES_LAST          (BCM_FIELD_PKT_RES_MPLSMCKNOWN) /* Must be >= highest valid
                                                      BCM_FIELD_PKT_RES_* */
...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyCount = 609          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_AppType_e {
    ...
    bcmFieldAppTypeCount = 36           /* Always Last. Not a usable value. */
} bcm_field_AppType_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionGpRedirectPrioIntNew = 412, /* Internal priority for Redirected
                                           Green packets */
    bcmFieldActionUntaggedPacketPrioirtyNew = 413, /* set input priority for untagged
    ...
    bcmFieldActionCount = 442           /* Always Last. Not a usable value. */
} bcm_field_action_t;
 ...
 */
typedef enum bcm_field_action_width_e {
