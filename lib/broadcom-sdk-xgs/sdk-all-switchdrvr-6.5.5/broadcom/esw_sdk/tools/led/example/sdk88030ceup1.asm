; $Id: sdk88030ceup1.asm,v 1.1 Broadcom SDK $
...
;
;
; This is a dummy LED program for the BCM88030 100G reference system: LEDProc1
;
; In 100G+LEDProc1:
; There are also LEDs for Host GE ports; GE17 and GE18, one for link and one for link&activity
...
;     Bit (1):  Link + Activity 
;
; Total bits for ports = 4bits for Host GE ports = 4 bits.
;
;
