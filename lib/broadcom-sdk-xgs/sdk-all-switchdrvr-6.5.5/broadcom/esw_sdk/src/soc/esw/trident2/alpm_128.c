...
static int _soc_alpm_128_update_bpm_len(int u, int new_tcam_index, int bpm_len)
{
    ...
    index1 = SOC_ALPM_128_ADDR_LWR(u, new_tcam_index);
    index2 = SOC_ALPM_128_ADDR_UPR(u, new_tcam_index);
                    ...
                    int tcam_index)  /* return key location */
{
    ...
    if (split) {
        ...
        (void) _soc_alpm_128_lpm_ent_key_init(u, pivot, length, vrf, v6,
                              &lpm_entry, 0, 0);
        ...
        ALPM_TCAM_PIVOT(u, SOC_ALPM_128_ADDR_LWR(u, new_tcam_index) << 1) =
                        pivot_pyld;
        PIVOT_TCAM_INDEX(pivot_pyld) = 
                                SOC_ALPM_128_ADDR_LWR(u, new_tcam_index) << 1;
                          ...
                          uint32 op, int src_default, int src_discard)
{
    ...
    rv = _soc_alpm_128_write_pivot_aux(u, src_index, index, entry);
