/*
 * $Id: phy82864.c,v 1.1.2.25 Broadcom SDK $
...
phy82864_speed_get(int unit, soc_port_t port, int *speed)
{
    ...
    /*mem for phy82864_device_cfg_aux_mode_t */
    interface_config.device_aux_modes = sal_alloc(sizeof(phy82864_device_cfg_aux_mode_t), "phy82864_device_cfg_aux_mode");
    if (interface_config.device_aux_modes == NULL) {
        return SOC_E_MEMORY;
    }
    sal_memset(interface_config.device_aux_modes, 0 , sizeof(phy82864_device_cfg_aux_mode_t));
...
_phy_82864_init_pass1(int unit, soc_port_t port)
{
    ...
    if (DEVID(pc) == MADURA_ID_82864) { 
        ...
        sal_strncpy (dev_name, "BCM82864", sal_strlen("BCM82864"));
    } else {
        /* coverity[secure_coding] */
        sal_strncpy (dev_name, "Madura", sal_strlen("Madura"));
    }
...
STATIC int
phy_82864_sdk_poly_to_phymod_poly(uint32 sdk_poly, uint32 *phymod_poly){
    switch(sdk_poly){
