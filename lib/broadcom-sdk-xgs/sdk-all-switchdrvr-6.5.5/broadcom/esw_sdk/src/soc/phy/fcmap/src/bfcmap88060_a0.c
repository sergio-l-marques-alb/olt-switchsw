...
#ifdef BE_HOST
        x_bfcmap_port_cfg.tx_buffer_to_buffer_credits = BCMSWAP32(pCfg->tx_buffer_to_buffer_credits);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.rx_buffer_to_buffer_credits = BCMSWAP32(pCfg->rx_buffer_to_buffer_credits);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.max_frame_length            = BCMSWAP32(pCfg->max_frame_length);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.bb_sc_n = BCMSWAP32(pCfg->bb_sc_n);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.r_t_tov = BCMSWAP32(pCfg->r_t_tov);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.interrupt_enable = BCMSWAP32(pCfg->interrupt_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.src_fcmap_prefix = BCMSWAP32(pCfg->src_fcmap_prefix);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.dst_fcmap_prefix = BCMSWAP32(pCfg->dst_fcmap_prefix);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.vlan_tag = BCMSWAP32(pCfg->vlan_tag);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.vft_tag = BCMSWAP32(pCfg->vft_tag);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.ingress_mapper_bypass = BCMSWAP32(pCfg->ingress_mapper_bypass);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_mapper_bypass = BCMSWAP32(pCfg->egress_mapper_bypass);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_hopCnt_dec_enable = BCMSWAP32(pCfg->egress_hopCnt_dec_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.use_tts_pcs_16G = BCMSWAP32(pCfg->use_tts_pcs_16G);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.training_enable_16G = BCMSWAP32(pCfg->training_enable_16G);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.training_enable_32G = BCMSWAP32(pCfg->training_enable_32G);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.fec_enable_16G = BCMSWAP32(pCfg->fec_enable_16G);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.fec_enable_32G = BCMSWAP32(pCfg->fec_enable_32G);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.ingress_fcs_crrpt_eof_enable = BCMSWAP32(pCfg->ingress_fcs_crrpt_eof_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.ingress_vlantag_presence_enable = BCMSWAP32(pCfg->ingress_vlantag_presence_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_pass_ctrl_frame_enable = BCMSWAP32(pCfg->egress_pass_ctrl_frame_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_pass_pfc_frame_enable = BCMSWAP32(pCfg->egress_pass_pfc_frame_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_pass_pause_frame_enable = BCMSWAP32(pCfg->egress_pass_pause_frame_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_fcoe_version_chk_disable = BCMSWAP32(pCfg->egress_fcoe_version_chk_disable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_default_cos_value = BCMSWAP32(pCfg->egress_default_cos_value);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_use_ip_cos_map = BCMSWAP32(pCfg->egress_use_ip_cos_map);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.ingress_hopcnt_dec_enable = BCMSWAP32(pCfg->ingress_hopcnt_dec_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.scrambling_enable_mask  = BCMSWAP32(pCfg->scrambling_enable_mask);
        x_bfcmap_port_cfg.scrambling_enable_value = BCMSWAP32(pCfg->scrambling_enable_value);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_pause_enable = BCMSWAP32(pCfg->egress_pause_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.egress_pfc_enable = BCMSWAP32(pCfg->egress_pfc_enable);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.stat_interval = BCMSWAP32(pCfg->stat_interval);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.action_mask = BCMSWAP32(x_bfcmap_port_cfg.action_mask);
        x_bfcmap_port_cfg.action_mask2 = BCMSWAP32(x_bfcmap_port_cfg.action_mask2);
#endif
...
bfcmap88060_port_config_selective_get(bfcmap_port_ctrl_t *mpc, 
                                      bfcmap_port_config_t *pCfg)
{
    uint32  mask1, mask2, scramb_en_mask;
    uint32 xmodtxbuff[XMOD_BUFFER_MAX_LEN/4];
...
#ifdef BE_HOST
    mask1 = BCMSWAP32(mask1);
    mask2 = BCMSWAP32(mask2);
    scramb_en_mask = BCMSWAP32(scramb_en_mask);
#endif
...
#ifdef BE_HOST
        pCfg->tx_buffer_to_buffer_credits = BCMSWAP32(x_bfcmap_port_cfg.tx_buffer_to_buffer_credits);
#else
...
#ifdef BE_HOST
        pCfg->rx_buffer_to_buffer_credits = BCMSWAP32(x_bfcmap_port_cfg.rx_buffer_to_buffer_credits);
#else
...
#ifdef BE_HOST
        pCfg->max_frame_length = BCMSWAP32(x_bfcmap_port_cfg.max_frame_length);
#else
...
#ifdef BE_HOST
        pCfg->bb_sc_n = BCMSWAP32(x_bfcmap_port_cfg.bb_sc_n);
#else
...
#ifdef BE_HOST
        pCfg->r_t_tov = BCMSWAP32(x_bfcmap_port_cfg.r_t_tov);
#else
...
#ifdef BE_HOST
        pCfg->interrupt_enable = BCMSWAP32(x_bfcmap_port_cfg.interrupt_enable);
#else
...
#ifdef BE_HOST
        pCfg->src_fcmap_prefix = BCMSWAP32(x_bfcmap_port_cfg.src_fcmap_prefix);
#else
...
#ifdef BE_HOST
        pCfg->dst_fcmap_prefix = BCMSWAP32(x_bfcmap_port_cfg.dst_fcmap_prefix);
#else
...
#ifdef BE_HOST
        pCfg->vlan_tag = BCMSWAP32(x_bfcmap_port_cfg.vlan_tag);
#else
...
#ifdef BE_HOST
        pCfg->vft_tag = BCMSWAP32(x_bfcmap_port_cfg.vft_tag);
#else
...
#ifdef BE_HOST
        pCfg->ingress_mapper_bypass = BCMSWAP32(x_bfcmap_port_cfg.ingress_mapper_bypass);
#else
...
#ifdef BE_HOST
        pCfg->egress_mapper_bypass = BCMSWAP32(x_bfcmap_port_cfg.egress_mapper_bypass);
#else
...
#ifdef BE_HOST
        pCfg->egress_hopCnt_dec_enable = BCMSWAP32(x_bfcmap_port_cfg.egress_hopCnt_dec_enable);
#else
...
#ifdef BE_HOST
        pCfg->use_tts_pcs_16G = BCMSWAP32(x_bfcmap_port_cfg.use_tts_pcs_16G);
#else
...
#ifdef BE_HOST
        pCfg->training_enable_16G = BCMSWAP32(x_bfcmap_port_cfg.training_enable_16G);
#else
...
#ifdef BE_HOST
        pCfg->training_enable_32G = BCMSWAP32(x_bfcmap_port_cfg.training_enable_32G);
#else
...
#ifdef BE_HOST
        pCfg->fec_enable_16G = BCMSWAP32(x_bfcmap_port_cfg.fec_enable_16G);
#else
...
#ifdef BE_HOST
        pCfg->fec_enable_32G = BCMSWAP32(x_bfcmap_port_cfg.fec_enable_32G);
#else
...
#ifdef BE_HOST
        pCfg->ingress_fcs_crrpt_eof_enable = BCMSWAP32(x_bfcmap_port_cfg.ingress_fcs_crrpt_eof_enable);
#else
...
#ifdef BE_HOST
        pCfg->ingress_vlantag_presence_enable = BCMSWAP32(x_bfcmap_port_cfg.ingress_vlantag_presence_enable);
#else
...
#ifdef BE_HOST
        pCfg->egress_pass_ctrl_frame_enable = BCMSWAP32(x_bfcmap_port_cfg.egress_pass_ctrl_frame_enable);
#else
...
#ifdef BE_HOST
        pCfg->egress_pass_pfc_frame_enable = BCMSWAP32(x_bfcmap_port_cfg.egress_pass_pfc_frame_enable);
#else
...
#ifdef BE_HOST
        pCfg->egress_pass_pause_frame_enable = BCMSWAP32(x_bfcmap_port_cfg.egress_pass_pause_frame_enable);
#else
...
#ifdef BE_HOST
        pCfg->egress_fcoe_version_chk_disable = BCMSWAP32(x_bfcmap_port_cfg.egress_fcoe_version_chk_disable);
#else
...
#ifdef BE_HOST
        pCfg->egress_default_cos_value = BCMSWAP32(x_bfcmap_port_cfg.egress_default_cos_value);
#else
...
#ifdef BE_HOST
        pCfg->egress_use_ip_cos_map = BCMSWAP32(x_bfcmap_port_cfg.egress_use_ip_cos_map);
#else
...
#ifdef BE_HOST
        pCfg->ingress_hopcnt_dec_enable = BCMSWAP32(x_bfcmap_port_cfg.ingress_hopcnt_dec_enable);
#else
...
#ifdef BE_HOST
        pCfg->scrambling_enable_value = BCMSWAP32(x_bfcmap_port_cfg.scrambling_enable_value);
#else
...
#ifdef BE_HOST
        pCfg->egress_pause_enable = BCMSWAP32(x_bfcmap_port_cfg.egress_pause_enable);
#else
...
#ifdef BE_HOST
        pCfg->egress_pfc_enable = BCMSWAP32(x_bfcmap_port_cfg.egress_pfc_enable);
#else
...
#ifdef BE_HOST
        pCfg->stat_interval = BCMSWAP32(x_bfcmap_port_cfg.stat_interval);
#else
...
#ifdef BE_HOST
    x_port_cfg.speed = BCMSWAP32(fcmap_port_cfg->speed);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_ability.port_ability_speed = BCMSWAP32(ability_mask->port_ability_speed);
#else
...
#ifdef BE_HOST
        ability_mask->port_ability_speed = BCMSWAP32(x_bfcmap_port_ability.port_ability_speed);
#else
...
bfcmap88060_port_private_data_set(bfcmap_port_ctrl_t *mpc, buint8_t *data, int len)
{
...
#ifndef BE_HOST
    payload->fc_inb_signature.sign = BCMSWAP16(payload->fc_inb_signature.sign);
#endif
    ...
    while (tlv_count) {
#ifndef BE_HOST
        pl_ptr->tlv.pld_type = BCMSWAP16(pl_ptr->tlv.pld_type);
        pl_ptr->tlv.pld_len = BCMSWAP16(pl_ptr->tlv.pld_len);
#endif
...
#ifdef BE_HOST
    x_vlan.vlan_vid  = BCMSWAP16(vlan->vlan_vid);
    x_vlan.vsan_vfid = BCMSWAP16(vlan->vsan_vfid);
#else
...
#ifdef BE_HOST
    x_tx_vlan.vlan_vid  = BCMSWAP16(vlan->vlan_vid);
    x_tx_vlan.vsan_vfid = BCMSWAP16(vlan->vsan_vfid);
#else
...
#ifdef BE_HOST
        vlan->vlan_vid  = BCMSWAP16(x_rx_vlan.vlan_vid);
        vlan->vsan_vfid = BCMSWAP16(x_rx_vlan.vsan_vfid);
#else
