                ...
                case 0:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC0f, &temp));
                    break;
                case 1:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC1f, &temp));
                    break;
                case 2:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC2f, &temp));
                    break;
                case 3:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC3f, &temp));
                    break;
                case 4:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC4f, &temp));
                    break;
                case 5:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC5f, &temp));
                    break;
                case 6:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC6f, &temp));
                    break;
                case 7:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV0_TC7f, &temp));
                    break;
                default :
                    return SOC_E_PARAM;
                    break;
            ...
            */
            switch(pri_old) {
                case 0:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC0f, &temp));
                    break;
                case 1:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC1f, &temp));
                    break;
                case 2:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC2f, &temp));
                    break;
                case 3:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC3f, &temp));
                    break;
                case 4:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC4f, &temp));
                    break;
                case 5:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC5f, &temp));
                    break;
                case 6:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC6f, &temp));
                    break;
                case 7:
                    SOC_IF_ERROR_RETURN(
                        soc_PN_EGRESS_PKT_TC2PCP_MAPr_field_set(unit, 
                            (void *)&reg_value64, PCP_FOR_RV1_TC7f, &temp));
                    break;
                default :
                    return SOC_E_PARAM;
                    break;
