...
dcmn_feature_cb_t  core_freq_720_feature_range[] = {
    {
        DCMN_CORE_FREQ_720_FEATURE,
        dcmn_range_cb,  /*  cb function*/
...
int jer_nif_24_48_devices[] =
    {
        BCM88686_DEVICE_ID,
        INVALID_DEV_ID
    }; /* DCMN_JER_NIF_24_48_FEATURE*/

int jer_nif_44_16_devices[] =
    {
        BCM88682_DEVICE_ID,
        INVALID_DEV_ID
    }; /* DCMN_JER_NIF_44_16_FEATURE*/

int jer_nif_48_4_devices[] =
    {
        BCM88683_DEVICE_ID,
        INVALID_DEV_ID
    }; /* DCMN_JER_NIF_48_4_FEATURE*/

int jer_nif_40_4_devices[] =
    {
        BCM88385_DEVICE_ID,
        INVALID_DEV_ID
    }; /* DCMN_JER_NIF_40_4_FEATURE*/
...
int jer_ilkn_2_ports_devices[] =
    {
        BCM88385_DEVICE_ID,
        INVALID_DEV_ID
    }; /* DCMN_JER_2_ILKN_PORTS_FEATURE*/
...
int   *device_features_map[DCMN_NUM_OF_FEATURES] = {
    ...
    jer_nif_24_48_devices,
    jer_nif_44_16_devices,
    jer_nif_48_4_devices,
    jer_nif_40_4_devices,
    jer_nif_12_32_devices,
    qax_nif_10_32_devices,
    qax_nif_12_24_devices,
    jer_ilkn_4_ports_devices,
    jer_ilkn_2_ports_devices,
