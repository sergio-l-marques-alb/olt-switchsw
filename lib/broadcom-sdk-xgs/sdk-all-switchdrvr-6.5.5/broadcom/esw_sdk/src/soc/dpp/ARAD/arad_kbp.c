    ...
    ARAD_KBP_TABLE_CONFIG
        Arad_kbp_table_config_info_static[ARAD_KBP_FRWRD_IP_NOF_TABLES_ARAD] = {
            ...
            {   
				...
				{ /* entry_key_parsing */
					2, 
					{{"VRF", 2, KBP_KEY_FIELD_PREFIX},{"DIP", 4, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
            ...
            {   
				...
				{/* entry_key_parsing */
					2, 
					{{"VRF", 2, KBP_KEY_FIELD_PREFIX},{"SIP", 4, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            }, 
            ...
            {   
				...
				{/* entry_key_parsing */
					4, 
					{{"VRF", 2, KBP_KEY_FIELD_PREFIX},{"DIP", 4, KBP_KEY_FIELD_PREFIX},{"SIP", 4, KBP_KEY_FIELD_PREFIX},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
            ...
            {   
				...
				{/* entry_key_parsing */
					2, 
					{{"VRF", 2, KBP_KEY_FIELD_PREFIX},{"SIP", 16, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
            ...
            {   
				...
				{/* entry_key_parsing */
					4, 
					{{"VRF", 2, KBP_KEY_FIELD_PREFIX},{"DIP", 16, KBP_KEY_FIELD_PREFIX},{"SIP", 16, KBP_KEY_FIELD_PREFIX},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
    ...
    ARAD_KBP_LTR_CONFIG
        Arad_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_NOF_TYPE_ARAD] = {
            ...
            /* DB 2: IPv4 MC with RPF */
            {
                ...
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
				{4, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 4, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}},
                {2, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}}}
                },
                /* master key */
                {4, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}, {"DIP", 4, KBP_KEY_FIELD_PREFIX}}},
                NULL, /* ARAD_KBP_INSTRUCTION */
                NULL, /* ARAD_KBP_KEY */
            }, 
            ...
            /* DB 5: IPv6 MC with RPF */
            {
                ...
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
					{4, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"DIP", 16, KBP_KEY_FIELD_PREFIX}, {"SIP", 16, KBP_KEY_FIELD_PREFIX},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}},
                    {2, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 16, KBP_KEY_FIELD_PREFIX}}}
                },
                /* master key */
                {4, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 16, KBP_KEY_FIELD_PREFIX}, {"DIP", 16, KBP_KEY_FIELD_PREFIX}}},
                NULL, /* ARAD_KBP_INSTRUCTION */
                NULL, /* ARAD_KBP_KEY */
            }, 
...
static int Arad_arad_plus_kbp_default_result_sizes_static[ARAD_KBP_MAX_NUM_OF_PARALLEL_SEARCHES] 	= {
...
static int Arad_arad_plus_kbp_default_result_formats_static[ARAD_KBP_MAX_NUM_OF_PARALLEL_SEARCHES] 	= {
    ...
    ARAD_KBP_TABLE_CONFIG
        Arad_plus_kbp_table_config_info_static[ARAD_KBP_FRWRD_IP_NOF_TABLES_ARAD_PLUS] = {
			...
			/* TABLE 15 (IPV4_DC) */ 
            {
				...
				{/* entry_key_parsing */
					2, 
					{{"VRF_8B", 1, KBP_KEY_FIELD_PREFIX},{"DIP", 4, KBP_KEY_FIELD_PREFIX}}
				},
				ARAD_KBP_FRWRD_IP_NOF_TABLES /* Clone table ID */
            },
    ...
    ARAD_KBP_LTR_CONFIG
        Arad_plus_kbp_ltr_config_static[ARAD_KBP_FRWRD_DB_NOF_TYPE_ARAD_PLUS] = {
            ...
            /* DB 2: IPv4 MC with RPF */
            {
                ...
                {ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING, ARAD_KBP_DB_TYPE_FORWARDING}, /* Search Types*/ 
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
                {4, {{"VRF", 2, KBP_KEY_FIELD_EM}, {"DIP", 4, KBP_KEY_FIELD_EM}, {"SIP", 4, KBP_KEY_FIELD_EM},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}},
                {1, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}}}, /* Dummy lookup - can be overwritten by ACL */
                {2, {{"VRF", 2, KBP_KEY_FIELD_EM}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}}}
                },
                /* master key */
                {4, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}, {"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}, {"SIP", 4, KBP_KEY_FIELD_PREFIX}, {"DIP", 4, KBP_KEY_FIELD_PREFIX}}},
            ...
            /* DB 6: IPv6 MC with RPF */
            {
                ...
                NlmFALSE, /* is_cmp3_search */
                { /* ltr searches */
                    {4, {{"VRF", 2, KBP_KEY_FIELD_EM}, {"DIP", 16, KBP_KEY_FIELD_EM}, {"SIP", 16, KBP_KEY_FIELD_EM},{"IN-RIF", 2, KBP_KEY_FIELD_PREFIX}}},
                    {1, {{"VRF", 2, KBP_KEY_FIELD_PREFIX}}}, /* Dummy lookup - can be overwritten by ACL */
                    {2, {{"VRF", 2, KBP_KEY_FIELD_EM}, {"SIP", 16, KBP_KEY_FIELD_PREFIX}}}
                },
                /* master key */
			...
			/* DB 10: IPV4_DC */
            {
                ...
                /* master key */
                {3, {{"VRF_8B", 1, KBP_KEY_FIELD_PREFIX},{"SIP", 4, KBP_KEY_FIELD_PREFIX},{"DIP", 4, KBP_KEY_FIELD_PREFIX}}},
                NULL, /* ARAD_KBP_INSTRUCTION */
                NULL, /* ARAD_KBP_KEY */
            },
	...
	arad_kbp_init_static_tables(int unit)
{
	...
	{
        /* enable dummy forwarding table for now*/
	...
	arad_kbp_set_all_db_by_ltr(int unit, int ltr_ndx)
{
	...
	if (SOC_IS_JERICHO(unit)) {
		...
		result_size = Arad_arad_plus_kbp_default_result_sizes_static;
		result_format = Arad_arad_plus_kbp_default_result_formats_static;
	}
    ...
    )
{
    ...
    for (pgm_ndx = pgm_ndx_min; pgm_ndx < pgm_ndx_max; ++pgm_ndx)
    {
        ...
        if (ARAD_KBP_ENABLE_IPV4_DC && (search_id == 5)) {
    ...
    )
{
          ...
          idx++) 
    {
        ...
        if(advanced == 0 && idx == ARAD_KBP_FRWRD_LTR_DUMMY_FRWRD)
            continue;
        if (ltr_config_info.valid) 
        {
            LOG_CLI((BSL_META_U(unit,
    ...
    )
{
    ...
    if (kbp_file != NULL) {
        kbp_device_print_html(AradAppData[unit]->device_p[core], kbp_file);
        fclose(kbp_file);
    }
}
   ...
   int core)
{
    ...
    if(!SAL_BOOT_PLISIM){
        KBP_TRY(kbp_device_init(AradAppData[unit]->dalloc_p[core],
                            KBP_DEVICE_12K, 
                            flags, 
    ...
    if (SOC_IS_ARADPLUS_AND_BELOW(unit)){
        KBP_TRY(kbp_device_set_property(AradAppData[unit]->device_p[core], KBP_DEVICE_PROP_INST_LATENCY, 1));
    }

    if ((core > 0)) {
        KBP_TRY(kbp_device_set_property(AradAppData[unit]->device_p[0], 
    ...
    if (ARAD_KBP_IS_CR_MODE(unit) == 1) {
        ...
        if(core == 0) {
            ...
            if (SOC_WARM_BOOT(unit)){
                KBP_TRY(kbp_device_set_property(AradAppData[unit]->device_p[core], KBP_DEVICE_PROP_CRASH_RECOVERY, 0, nv_mem_ptr, ARAD_KBP_NV_MEMORY_SIZE));
                KBP_TRY(kbp_device_restore_state(AradAppData[unit]->device_p[core], NULL, NULL, NULL));
            } else {
                KBP_TRY(kbp_device_set_property(AradAppData[unit]->device_p[core], KBP_DEVICE_PROP_CRASH_RECOVERY, 1, nv_mem_ptr, ARAD_KBP_NV_MEMORY_SIZE));
            }
        }
    } else
#endif
    ...
    )
{
    ...
    KBP_TRY(default_allocator_create(&AradAppData[unit]->dalloc_p[core]));
    ...
    )
{
   ...
   /* destroy kbp_dm , was created in arad_kbp_deinit_nlm_dev_mgr() */
    kbp_device_destroy(AradAppData[unit]->device_p[core]);
    ...
    )
{
	...
	KBP_TRY(kbp_device_set_property(AradAppData[unit]->device_p[core], KBP_DEVICE_PRE_CLEAR_ABS, 1)); 
    KBP_TRY(kbp_device_lock(AradAppData[unit]->device_p[core]));
    return res;
}
    ...
    )
{
    ...
    if (!SOC_WARM_BOOT(unit)) {
        /*Master key Creation*/
        KBP_TRY(kbp_key_init(AradAppData[unit]->device_p[core], &ltr_config_info.master_key));
    ...
    )
{
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        KBP_TRY(kbp_instruction_refresh_handle(AradAppData[unit]->device_p[core], ltr_handles_info.inst_p, &ltr_handles_info.inst_p));
    ...
    )
{
    ...
    if (!SOC_WARM_BOOT(unit)) {
       ...
       LOG_VERBOSE(BSL_LS_SOC_TCAM,
        ...
        KBP_TRY(kbp_key_init(AradAppData[unit]->device_p[core], 
...
*/
        ...
        KBP_TRY(kbp_db_refresh_handle(AradAppData[unit]->device_p[core], db_handles_info.db_p, &db_handles_info.db_p));
        KBP_TRY(kbp_ad_db_refresh_handle(AradAppData[unit]->device_p[core], db_handles_info.ad_db_p, &db_handles_info.ad_db_p));
    ...
    ARAD_INIT_ELK *elk)
{
    ...
    for (tbl_idx = 0; tbl_idx < ARAD_KBP_MAX_NUM_OF_TABLES; tbl_idx++) 
    {
        ...
        if (is_valid && tbl_idx != ARAD_KBP_FRWRD_TBL_ID_DUMMY_FRWRD) 
        {
    ...
    /* Check if KBP tables are initialized and add a dummy table if there are no FWD tables*/
    if(nof_tbls_init == 0) {
        /* Init ARAD_KBP_FRWRD_TBL_ID_DUMMY_FRWRD*/
        res = arad_kbp_table_init(
                unit, 
                0, 
        ...
        /* Disable ARAD_KBP_FRWRD_TBL_ID_DUMMY_FRWRD and its LTR*/
        res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_table_config_info.valid.set(unit, ARAD_KBP_FRWRD_TBL_ID_DUMMY_FRWRD, FALSE);
        SOC_SAND_CHECK_FUNC_RESULT(res, 200, exit);
        res = sw_state_access[unit].dpp.soc.arad.tm.kbp_info.Arad_kbp_ltr_config.valid.set(unit, ARAD_KBP_FRWRD_DB_TYPE_DUMMY_FRWRD, FALSE);
        SOC_SAND_CHECK_FUNC_RESULT(res, 500+ARAD_KBP_FRWRD_LTR_DUMMY_FRWRD, exit);
    }
   ...
   uint8 is_start)
{
    ...
    if (AradAppData[unit]->device_p[core] != NULL) {
        if (is_start) {
            KBP_TRY(kbp_device_start_transaction(AradAppData[unit]->device_p[core]));
        } else { 
            KBP_TRY(kbp_device_end_transaction(AradAppData[unit]->device_p[core]));
        }
    }
    return 0;
}
...
uint8 arad_kbp_cr_query_restore_status(int unit)
{
    ...
    if(AradAppData[unit]->device_p[core] != NULL){
        KBP_TRY(kbp_device_query_restore_status(AradAppData[unit]->device_p[core], &res_status));
    }
...
uint32 arad_kbp_cr_clear_restore_status(int unit)
{
    ...
    if(AradAppData[unit]->device_p[core] != NULL){
        KBP_TRY(kbp_device_clear_restore_status(AradAppData[unit]->device_p[core]));
    }
    return 0;
}
    ...
    for (core = 0; core < iter_count; core++) {
        ...
        if(!SAL_BOOT_PLISIM){
            ...
            if (res != 0 && elk->kbp_recover_enable) {
                res = arad_kbp_recover_run_recovery_sequence(unit, core, elk->kbp_mdio_id[core], elk->kbp_recover_iter, 1);
            }
            SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
        }    
        ...
        if (!SOC_WARM_BOOT(unit)) {
           ...
           if (res != 0 && elk->kbp_recover_enable) {
               res = arad_kbp_recover_run_recovery_sequence(unit, core, elk->kbp_mdio_id[core], elk->kbp_recover_iter, 2);
           }
           SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
        }
       ...
       LOG_ERROR(BSL_LS_SOC_TCAM,
        ...
        for (core = 0; core < iter_count; core++) {
            if (AradAppData[unit]->dalloc_p[core] != NULL) {
                KBP_TRY(default_allocator_destroy(AradAppData[unit]->dalloc_p[core]));
            }
        }
...
/* Do not perform sync in CR mode */
...
#endif
    {
        ...
        KBP_TRY(kbp_device_save_state(AradAppData[unit]->device_p[core], warmboot_data->kbp_file_read , warmboot_data->kbp_file_write, warmboot_data->kbp_file_fp));
    }
	...
	if (SOC_IS_JERICHO(unit)) {
		...
		*/
		...
		/* part 1 of the result is 89b in jericho,so:
			...
			2. comtinue as usual, byte by byte
		*/
		signal_nof_32bits = (signal_nof_bits+31)/32;
		signal_byte_ptr = (uint8*)&signal_value[signal_nof_32bits-1];
