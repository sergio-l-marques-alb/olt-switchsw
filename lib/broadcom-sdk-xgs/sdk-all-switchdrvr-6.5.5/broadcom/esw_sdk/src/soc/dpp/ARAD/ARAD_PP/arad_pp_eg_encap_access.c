  ...
  )
{
  ...
  if (soc_mem_field_valid(unit, mem, TRILL_0_ENTRY_FORMATf)) {
    soc_mem_field32_set(unit, mem, data, TRILL_0_ENTRY_FORMATf, TRUE);
  }
  if (soc_mem_field_valid(unit, mem, TRILL_1_ENTRY_FORMATf)) {
    soc_mem_field32_set(unit, mem, data, TRILL_1_ENTRY_FORMATf, TRUE);
  }
