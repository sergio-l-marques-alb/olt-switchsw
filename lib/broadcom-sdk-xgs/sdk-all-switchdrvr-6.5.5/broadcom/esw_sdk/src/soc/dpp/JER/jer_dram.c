...
int soc_jer_dram_recovery_init(int unit)
{
    ...
    /* set the following for each DP: 
       ...
       No       bit 1 - Mask BDB protect test
       ...
       No       bit 10 - Mask reject test based on free dynamic space
       No       bit 11 - Mask reject test based on occupied BDs
       No       bit 12 - Mask reject test based on free BDBs
       No       bit 13 - Mask reject test based on free DBs
       No       bit 14 - Mask reject test based on queue Max size - Words/Buffers/BDs
    ...
    */
    soc_reg_above_64_field32_set(unit, IQM_DRAM_ELIGIBLE_RJCT_MASKr, reg_above_64_val, DRAM_ELIGIBLE_RJCT_MASK_DP_0f, 0x40);
    soc_reg_above_64_field32_set(unit, IQM_DRAM_ELIGIBLE_RJCT_MASKr, reg_above_64_val, DRAM_ELIGIBLE_RJCT_MASK_DP_1f, 0x40);
    soc_reg_above_64_field32_set(unit, IQM_DRAM_ELIGIBLE_RJCT_MASKr, reg_above_64_val, DRAM_ELIGIBLE_RJCT_MASK_DP_2f, 0x40);
    soc_reg_above_64_field32_set(unit, IQM_DRAM_ELIGIBLE_RJCT_MASKr, reg_above_64_val, DRAM_ELIGIBLE_RJCT_MASK_DP_3f, 0x40);
