 ...
 */
    ...
    #define KBP_SCHAN_JER_OPCODE_64_IHB_WRITE            (SOC_IS_JERICHO_PLUS(unit) ? \
    ...
    #define KBP_SCHAN_JER_OPCODE_32_IHB_WRITE            (SOC_IS_JERICHO_PLUS(unit) ? \
    ...
    #define KBP_SCHAN_JER_OPCODE_IHB_ROP_READ            (SOC_IS_JERICHO_PLUS(unit) ? \
