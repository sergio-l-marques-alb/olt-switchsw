...
uint32 soc_qax_stat_if_report_info_set(int unit, int nof_sif_ports, ARAD_INIT_STAT_IF *stat_if)
{
    ...
    switch (stat_if->stat_if_info[0].mode)
    {
        ...
        case SOC_TMC_STAT_IF_REPORT_MODE_BILLING_INGRESS:
            ...
            soc_reg_field_set(unit, CGM_ST_PORT_SETTINGSr, &reg_val, ST_PORT_RPRT_SIZEf, 0);                      
        ...
        case SOC_TMC_STAT_IF_REPORT_QSIZE:
            ...
            /* set report size */
            soc_reg_field_set(unit, CGM_ST_PORT_SETTINGSr, &reg_val, ST_PORT_RPRT_SIZEf, stat_if->stat_if_info[0].report_size);
    ...
    {    
        ...
        soc_mem_field32_set(unit, CGM_STAT_CPMm, &mem_val, HDR_DELTAf, 0x2);
