...
int jer_event_drc_phy_cdr_above_th_handler(int unit, int block_instance, uint32 en_interrupt, char* msg)
{
    ...
    SOCDNX_IF_ERR_EXIT( dcmn_interrupt_print_info(unit, block_instance, en_interrupt, 0, DCMN_INT_CORR_ACT_SOFT_RESET, msg));
...
STATIC dcmn_intr_action_t jer_intr_action[] =
{
    ...
    {jer_event_drc_phy_cdr_above_th_handler, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_0, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_1, DCMN_INT_CORR_ACT_SHADOW},
    {jer_special_handling_recur_2, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_recur_3, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_4, DCMN_INT_CORR_ACT_SHADOW},
    {jer_special_handling_recur_5, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_recur_6, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_7, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_8, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_9, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_10, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_11, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_recur_12, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_13, DCMN_INT_CORR_ACT_SOFT_RESET},
    {jer_special_handling_normal_14, DCMN_INT_CORR_ACT_SOFT_RESET},
