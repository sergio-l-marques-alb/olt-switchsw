...
int jer_pp_kbp_sdk_ver_test(int unit)
{
    ...
    const char* kbp_sdk_ver_arr[] =       {"KBP SDK 1.3.11", "KBP SDK 1.4.4", "KBP SDK 1.4.6"};
    const uint32 sw_sdk_ver_arr_6_5[]  = {0x65100000, 0x65300000, 0x65400000};
    const uint32 sw_sdk_ver_arr_6_4[]  = {0x64700000, 0x64b00000, 0x64b00000};
