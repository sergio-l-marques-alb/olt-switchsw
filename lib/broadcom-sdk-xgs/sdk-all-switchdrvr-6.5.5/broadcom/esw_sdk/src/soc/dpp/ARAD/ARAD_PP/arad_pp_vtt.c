...
void arad_pp_dbal_sw_db_mpls_port_indexed_sem_property_set       (int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 vid_type            ); 
...
/* MPLS DB's start */                                                                                                                                                                                                       
    ...
    { {0}, "VTT MPLS LABEL port SEM B"                 , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_PORT_L1_L1IDX_SEM_B                           , arad_pp_dbal_sw_db_mpls_port_indexed_sem_property_set        , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B          , MPLS_LABEL_0          },
    { {0}, "VTT MPLS LABEL port SEM A"                 , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_PORT_L2_L1IDX_SEM_A                           , arad_pp_dbal_sw_db_mpls_port_indexed_sem_property_set        , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A          , MPLS_LABEL_1          },
    { {0}, "VTT MPLS LABEL port SEM B"                 , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_PORT_L3_L1IDX_SEM_B                           , arad_pp_dbal_sw_db_mpls_port_indexed_sem_property_set        , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B          , MPLS_LABEL_2          },
    ...
    { {0}, "VTT MPLS COUPLING L3 L4 TCAM"              , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_COUPLING_L3_L4_TCAM                           , arad_pp_dbal_sw_db_mpls_frr_coupling_tcam_property_set       , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM           , (MPLS_LABEL_2 << 2) | INITIAL_VID },
...
/* 8*/    {ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_L1L2                                        , arad_pp_dbal_vt_program_vid_l1_l2_property_set                               , {-1}    , INITIAL_VID     },
/* 9*/    {ARAD_PP_DBAL_VT_PROG_VD_OUTERVID_L1L2                                          , arad_pp_dbal_vt_program_vid_l1_l2_property_set                               , {-1}    , INITIAL_VID     },
...
/*28*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_MPLS_PORT_L1                                    , arad_pp_dbal_vt_program_mpls_port_termination_property_set                     , {-1}    , MPLS_LABEL_0    },
...
/*33*/    {ARAD_PP_DBAL_VT_PROG_EVB_UN_C_TAG                                              , arad_pp_dbal_vt_program_evb_property_set                                      , {-1}    , OUTER_VID       },
/*34*/    {ARAD_PP_DBAL_VT_PROG_EVB_S_TAG                                                 , arad_pp_dbal_vt_program_evb_property_set                                      , {-1}    , OUTER_INNER_VID },
/*35*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_PRIORITY_INITIAL_VID                           , arad_pp_dbal_vt_program_double_tag_priority_property_set                      , {-1}    , 0               },
/*36*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxINITIALVID_AFTER_RCY                              , arad_pp_dbal_vt_program_ipv4_vdxinitial_recycle_property_set                 , {-1}    , 0               },
/*37*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxOUTERVID_AFTER_RCY                                , arad_pp_dbal_vt_program_ipv4_vdxouter_recycle_property_set                   , {-1}    , 0               },
/*38*/    {ARAD_PP_DBAL_VT_PROG_SINGLE_TAG_5_TUPPLE_QINQ                                  , arad_pp_dbal_vt_program_single_tag_5tupple_qinq_property_set                 , {-1}    , 0               },
/*39*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_5_TUPPLE_QINQ                                  , arad_pp_dbal_vt_program_double_tag_5tupple_qinq_property_set                 , {-1}    , 0               },
/*40*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_TST1                                             , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*41*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_TST1                                              , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*42*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_TST1                                           , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },


/*43*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_VRRP                                             , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*44*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_VRRP                                              , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*45*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_VRRP                                           , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },


/*46*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_EXP_NULL_TST1                                    , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_UNTAGGED   },
/*47*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_EXP_NULL_TST1                                     , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_ONE_TAG    },
/*48*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_EXP_NULL_TST1                                  , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_DOUBLE_TAG },
/*49*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_PCP_1_TST2                                    , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set                    , {-1}    , TPID1           },
/*50*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_PCP_2_TST2                                    , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set                    , {-1}    , TPID2           },
/*51*/    {ARAD_PP_DBAL_VT_PROG_OUTER_PCP_1_TST2                                          , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                          , {-1}    , TPID1           },
/*52*/    {ARAD_PP_DBAL_VT_PROG_OUTER_PCP_2_TST2                                          , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                          , {-1}    , TPID2           },
/*53*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_1_TST2                                        , arad_pp_dbal_vt_program_outer_inner_tst2_property_set                        , {-1}    , TPID1           },
/*54*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_2_TST2                                        , arad_pp_dbal_vt_program_outer_inner_tst2_property_set                        , {-1}    , TPID2           },
/*55*/    {ARAD_PP_DBAL_VT_PROG_OUTER_1_TST2                                              , arad_pp_dbal_vt_program_outer_tst2_property_set                              , {-1}    , TPID1           },
/*56*/    {ARAD_PP_DBAL_VT_PROG_OUTER_2_TST2                                              , arad_pp_dbal_vt_program_outer_tst2_property_set                              , {-1}    , TPID2           },
/*57*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_TST2                                             , arad_pp_dbal_vt_program_untagged_tst2_property_set                           , {-1}    , 0               },
/*58*/    {ARAD_PP_DBAL_VT_PROG_VT_TEST2                                                  , arad_pp_dbal_vt_program_test2_property_set                                   , {-1}    , 0               },
/*59*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE                                               , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , OUTER_VID       },
/*60*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE_UT                                            , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , INITIAL_VID     },
/*61*/    {ARAD_PP_DBAL_VT_PROG_VT_CUSTOM_PP_PORT_TUNNEL                                  , arad_pp_dbal_vt_program_custom_pp_port_tunnel_property_set                   , {-1}    , 0               },
/*62*/    {ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_VLAN_DOMAIN_L1                              , arad_pp_dbal_vt_program_vlan_domain_mpls_property_set                        , {-1}    , 0               },
/*63*/    {ARAD_PP_DBAL_VT_PROG_PON_UNTAGGED                                              , arad_pp_dbal_vt_program_pon_untagged_property_set                            , {-1}    , 0               },
/*64*/    {ARAD_PP_DBAL_VT_PROG_PON_ONE_TAG                                               , arad_pp_dbal_vt_program_pon_one_tag_property_set                             , {-1}    , 0               },
/*65*/    {ARAD_PP_DBAL_VT_PROG_PON_TWO_TAGS                                              , arad_pp_dbal_vt_program_pon_two_tags_property_set                            , {-1}    , 0               },
/*66*/    {ARAD_PP_DBAL_VT_PROG_PON_TWO_TAGS_VS_TUNNEL_ID                                 , arad_pp_dbal_vt_program_pon_two_tags_vs_tunnel_id_property_set               , {-1}    , 0               }
};
...
/* 7*/    {ARAD_PP_DBAL_TT_PROG_COUPLING_L3_L4                , arad_pp_dbal_tt_program_coupling_l3_l4_property_set                 , {-1}    , 0                    },
/* 8*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L1                 , arad_pp_dbal_tt_program_indexed_mpls_l1_l1_property_set             , {-1}    , 0                    },
/* 9*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L1_GAL             , arad_pp_dbal_tt_program_indexed_mpls_l1_l1_property_set             , {-1}    , 1                    },
/*10*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L2                 , arad_pp_dbal_tt_program_indexed_mpls_l1_l2_property_set             , {-1}    , 0                    },
/*11*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L2_GAL             , arad_pp_dbal_tt_program_indexed_mpls_l1_l2_property_set             , {-1}    , 1                    },
/*12*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L2_L2                 , arad_pp_dbal_tt_program_indexed_mpls_l2_l2_property_set             , {-1}    , 0                    },
/*13*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L2_L3_GAL             , arad_pp_dbal_tt_program_indexed_mpls_l2_l3_gal_property_set         , {-1}    , 0                    },
/*14*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L2_L3_ELI             , arad_pp_dbal_tt_program_indexed_mpls_l2_l3_eli_property_set         , {-1}    , 0                    },
/*15*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L2_INRIF           , arad_pp_dbal_tt_program_l1_l2_inrif_property_set                    , {-1}    , 0                    },
/*16*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L2ELI_INRIF        , arad_pp_dbal_tt_program_l1_l2eli_inrif_property_set                 , {-1}    , 0                    },
/*17*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_L2_L3ELI_INRIF     , arad_pp_dbal_tt_program_l1_l2_l3eli_inrif_property_set              , {-1}    , 0                    },
/*18*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L3_L2                 , arad_pp_dbal_tt_program_indexed_mpls_l3_l2_property_set             , {-1}    , 0                    },
/*19*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_MPLS_PORT_L3_L2        , arad_pp_dbal_tt_program_mpls_port_termination_property_set         , {-1}    , 0                    }, 
/*20*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L3_L4                 , arad_pp_dbal_tt_program_indexed_mpls_l3_l4_property_set             , {-1}    , 0                    },
/*21*/    {ARAD_PP_DBAL_TT_PROG_ARP                           , arad_pp_dbal_tt_program_arp_property_set                            , {-1}    , 0                    },
/*22*/    {ARAD_PP_DBAL_TT_PROG_BRIDGE_STAR                   , arad_pp_dbal_tt_program_bridge_property_set                         , {-1}    , 0                    },
/*23*/    {ARAD_PP_DBAL_TT_PROG_TT_UNKNOWN_L3                 , arad_pp_dbal_tt_program_uknown_l3_property_set                      , {-1}    , 0                    },
/*24*/    {ARAD_PP_DBAL_TT_PROG_TRILL_ONE_TAG                 , arad_pp_dbal_tt_program_trill_property_set                          , {-1}    , TRILL_ONE_TAG        },
/*25*/    {ARAD_PP_DBAL_TT_PROG_TRILL_TWO_TAGS                , arad_pp_dbal_tt_program_trill_property_set                          , {-1}    , TRILL_TWO_TAG        },
/*26*/    {ARAD_PP_DBAL_TT_PROG_TRILL_TRAP                    , arad_pp_dbal_tt_program_trill_trap_property_set                     , {-1}    , 0                    },
/*27*/    {ARAD_PP_DBAL_TT_PROG_FC_WITH_VFT                   , arad_pp_dbal_tt_program_fc_with_vft_property_set                    , {-1}    , VSAN_INIT            },
/*28*/    {ARAD_PP_DBAL_TT_PROG_FC                            , arad_pp_dbal_tt_program_fc_property_set                             , {-1}    , VSAN_INIT            },
/*29*/    {ARAD_PP_DBAL_TT_PROG_MIM_MC                        , arad_pp_dbal_tt_program_mac_in_mac_property_set                     , {-1}    , MAC_IN_MAC_MC        },
/*30*/    {ARAD_PP_DBAL_TT_PROG_MIM_WITH_BTAG                 , arad_pp_dbal_tt_program_mac_in_mac_property_set                     , {-1}    , MAC_IN_MAC_WITH_BTAG },
/*31*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER                   , arad_pp_dbal_tt_program_ipv4_router_property_set                    , {-1}    , 0                    },
/*32*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_PWE_GRE_DIP_FOUND , arad_pp_dbal_tt_program_ipv4_router_pwe_gre_dip_found_property_set  , {-1}    , 0                    },
/*33*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_DIP_FOUND         , arad_pp_dbal_tt_program_ipv4_router_dip_found_property_set          , {-1}    , 0                    },
/*34*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_UC_DIP_NOT_FOUND  , arad_pp_dbal_tt_program_ipv4_router_uc_dip_not_found_property_set   , {-1}    , 0                    },
/*35*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_MC_DIP_NOT_FOUND  , arad_pp_dbal_tt_program_ipv4_router_mc_dip_not_found_property_set   , {-1}    , 0                    },
/*36*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_COMPATIBLE_MC     , arad_pp_dbal_tt_program_ipv4_router_compatible_mc_property_set      , {-1}    , 0                    },
/*37*/    {ARAD_PP_DBAL_TT_PROG_IPV6_ROUTER                   , arad_pp_dbal_tt_program_ipv6_router_property_set                    , {-1}    , 0                    },
/*38*/    {ARAD_PP_DBAL_TT_PROG_DIPV6_COMPRESSED              , arad_pp_dbal_tt_program_dipv6_compressed_property_set               , {-1}    , 0                    },
/*39*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK_IP_MC    , arad_pp_dbal_tt_program_extender_untag_check_set                    , {-1}    , EXTENDER_IP_MC       },
/*40*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK_IP_UC    , arad_pp_dbal_tt_program_extender_untag_check_set                    , {-1}    , EXTENDER_IP_UC       },
/*41*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK          , arad_pp_dbal_tt_program_extender_untag_check_set                    , {-1}    , EXTENDER_ETH         },
/*42*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_DIP_SIP_VRF       , arad_pp_dbal_tt_program_ipv4_router_dip_sip_vrf_property_set        , {-1}    , 0                    },
/*43*/    {ARAD_PP_DBAL_TT_PROG_IPV4_FOR_EXPLICIT_NULL        , arad_pp_dbal_tt_program_ipv4_for_explicit_mpls_property_set         , {-1}    , 0                    },
/*44*/    {ARAD_PP_DBAL_TT_PROG_TUNNEL_TWO_EXPLICIT_NULL      , arad_pp_dbal_tt_program_tunnel_two_explicit_mpls_property_set       , {-1}    , 0                    },
/*45*/    {ARAD_PP_DBAL_TT_PROG_TUNNEL_THREE_EXPLICIT_NULL    , arad_pp_dbal_tt_program_tunnel_three_explicit_mpls_property_set     , {-1}    , 0                    },
/*46*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP_MC             , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , EXTENDER_IP_MC       },
/*47*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP_UC             , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , EXTENDER_IP_UC       },
/*48*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB                   , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , EXTENDER_ETH         },
/*49*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_GAL_ONLY           , arad_pp_dbal_tt_program_indexed_mpls_l1_gal_only_property_set       , {-1}    , 0                    },
/*50*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L2_GAL_ONLY           , arad_pp_dbal_tt_program_indexed_mpls_l2_gal_only_property_set       , {-1}    , 0                    },
/*51*/    {ARAD_PP_DBAL_TT_PROG_VLAN_DOMAIN_L1,                    arad_pp_dbal_tt_program_vlan_domain_mpls_property_set                        , {-1}    , 0               }
 ...
 *                                                                                                 |                                                       |          |                           */
        ...
        {ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INDEXED_MPLS_PORT_L1                                    , arad_pp_dbal_vt_cam_mpls_port_termination_set          , {-1}, {ARAD_PP_DBAL_VT_PROG_INVALID}, 0                                    },
...
void arad_pp_dbal_sw_db_mpls_port_indexed_sem_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY *sw_db_property, uint32 mpls_indexed) {
    int index = 0;
    int nof_qualifiers = 1;
    sw_db_property->nof_qulifiers = nof_qualifiers;
...
{
    sw_db_property->qual_info[0].qual_type     = SOC_PPC_FP_QUAL_VLAN_DOMAIN ;
    sw_db_property->qual_info[0].qual_nof_bits = SOC_IS_QAX(unit) ? 4 : 3;
...
void arad_pp_dbal_vt_program_double_tag_5tupple_qinq_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[2][5] = SOC_IS_JERICHO(unit) ? 0:0;
...
void arad_pp_dbal_tt_program_mpls_port_termination_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    uint32 database_l3,namespace_l3;
    program_property->nof_keys = 2;
    program_property->vtt_table_index[0]  = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_PORT_L2_L1IDX_SEM_A);
    program_property->vtt_table_index[1]  = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_PORT_L3_L1IDX_SEM_B);
...
int32 arad_pp_dbal_vt_cam_mpls_port_termination_set(int unit, ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int line, uint32 unused) {
    ...
    prog_selection->in_pp_port_vt_profile =  (SOC_PPC_PORT_DEFINED_VT_PORT_TERMINATION_MPLS);
...
int32 arad_pp_dbal_tt_cam_mpls_port_l3_l2_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int line, uint32 unused) {
    /* program selcted based on port and mpls qualifier */
    prog_selection->in_pp_port_tt_profile =  (SOC_PPC_PORT_DEFINED_TT_PROFILE_PORT_TERMINATION_MPLS);
...
int32 arad_pp_dbal_tt_cam_bridge_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 bridge_cause)
{
    if(next_line == 0){
        ...
        if(SOC_IS_JERICHO(unit) && g_prog_soc_prop[unit].oam_enable)
            return 1;
        return -1;
    }
...
{
    prog_selection->enable_routing_mask = 1;
    prog_selection->parser_leaf_context = ARAD_PMF_PGM_SEL_PARSER_PROFILE_FCOE_VFT;

    if(vft_stat == NO_VFT)
    {
        prog_selection->parser_leaf_context_mask    = (0x1);
        prog_selection->packet_format_code          = ARAD_PARSER_PKT_HDR_STK_TYPE_FC_ENCAP_ETH;
    ...
    {
        prog_selection->parser_leaf_context_mask    = (0x0);
        prog_selection->packet_format_code          = ARAD_PARSER_PKT_HDR_STK_TYPE_FC_STD_ETH;
