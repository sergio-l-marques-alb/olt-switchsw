...
#define DPP_MC_ING_DESTINATION_FLD_TYPE_TM_FLOW (SOC_IS_JERICHO(unit)?JER_MC_ING_DESTINATION_FLD_TYPE_TM_FLOW:ARAD_MC_ING_DESTINATION_FLD_TYPE_TM_FLOW)
#define DPP_MC_ING_DESTINATION_FLD_TYPE_PORT (SOC_IS_JERICHO(unit)?JER_MC_ING_DESTINATION_FLD_TYPE_SYSPORT:ARAD_MC_ING_DESTINATION_FLD_TYPE_PORT)
#define DPP_MC_ING_DESTINATION_FLD_TYPE_LAG (SOC_IS_JERICHO(unit)?JER_MC_ING_DESTINATION_FLD_TYPE_LAG:ARAD_MC_ING_DESTINATION_FLD_TYPE_PORT)
...
int test_bcm_mc_arad_delete_egress_replications(int unit)
{
    ...
    int max_nof_ingr_groups_in_mcdb = (DPP_LAST_MCDB_ENTRY(dpp_get_mcds(unit)) + 1) / (SOC_IS_JERICHO(unit) ? 4 : 2); 
    BCMDNX_INIT_FUNC_DEFS;
    ...
    if (SOC_IS_JERICHO(unit)) { /* delete the CUD to port mapping */
        for (i = 0 ; i < 12; ++i) {
