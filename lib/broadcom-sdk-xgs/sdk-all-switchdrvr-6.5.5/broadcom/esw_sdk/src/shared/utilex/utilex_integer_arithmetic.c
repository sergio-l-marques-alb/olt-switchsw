  ...
  uint32 * exp)
{
  ...
  uint32
    bin_serach_beg,
    bin_serach_end, bin_serach_num_elements, bin_serach_mid, bin_serach_low_val, bin_serach_high_val, exp_man, res, tmp;
  ...
  uint32 silent)
{
  ...
  for (max_val_i = 100; max_val_i < 4000; max_val_i += 100)
  {
    for (abs_val_denominator_i = 1; abs_val_denominator_i < 60; abs_val_denominator_i++)
    {
      ...
      {
        utilex_abs_val_to_mnt_binary_fraction_exp(abs_val_numerator_i, abs_val_denominator_i, 5, 3, max_val_i, &mnt,
                                                  &exp);
        utilex_mnt_binary_fraction_exp_to_abs_val(5, 3, max_val_i, mnt, exp, &exact_abs_val_numerator_i,
            ...
            (exact_abs_val_numerator_i * 110 / exact_abs_val_denominator_i))
        {
          ...
          {
            if ((abs_val_numerator_i * 100 / abs_val_denominator_i) > (max_val_i * 110 / abs_val_denominator_i))
            {
              continue;
            }
          }
