  ...
  )      
{
      ...
      case SOC_PPC_FEC_TYPE_TUNNELING_EEI_MPLS_COMMAND:
  {
    ...
    if (!((fec_entry->app_info.out_rif >= BCM_VLAN_DEFAULT) && (fec_entry->app_info.out_rif < SOC_DPP_CONFIG(unit)->l3.nof_rifs))) { /* must be RIF index */
    ...
    bcm_l3_source_bind_t *info)
{
    ...
    SOC_PPC_LIF_ENTRY_INFO lif_entry_info;
    _bcm_dpp_gport_hw_resources gport_hw_resources;
    uint32 flags = _BCM_DPP_GPORT_HW_RESOURCES_LOCAL_LIF_INGRESS | _BCM_DPP_GPORT_HW_RESOURCES_STRICT_CHECK;
