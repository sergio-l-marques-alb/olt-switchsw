                                             ...
                                             /* in */int nni_port)
{
    ...
    result = bcm_field_presel_create_id(unit, psset_id_router_over_ac);
    if (BCM_E_NONE != result) 
    {
        printf("Error in bcm_field_presel_create_id\n");
        auxRes = bcm_field_presel_destroy(unit, psset_id_router_over_ac);
        return result;
    }
  
    result = bcm_field_qualify_Stage(unit, psset_id_router_over_ac | BCM_FIELD_QUALIFY_PRESEL, bcmFieldStageIngress);
    if (BCM_E_NONE != result)
    {
    ...
    result = bcm_field_qualify_InPorts(unit, psset_id_router_over_ac | BCM_FIELD_QUALIFY_PRESEL, pbm, pbm_mask);
    if (BCM_E_NONE != result)
    {
     ...
     */
    /*result = bcm_field_qualify_IpType(unit, psset_id_router_over_ac | BCM_FIELD_QUALIFY_PRESEL,  bcmFieldIpTypeIpv4Any);
    if (BCM_E_NONE != result)
    {
        printf("Error in bcm_field_qualify_EtherType\n");
        auxRes = bcm_field_qualify_IpType(unit, psset_id_router_over_ac);
        return result;
    }*/

    /* IP host hit */
    result = bcm_field_qualify_L2DestHit(unit, psset_id_router_over_ac | BCM_FIELD_QUALIFY_PRESEL, 0x1, 0x1);
    if (BCM_E_NONE != result)
    {
    ...
    BCM_FIELD_PRESEL_ADD(psset_router_over_ac, psset_id_router_over_ac);
...
int field_group_router_over_ac_pselect_teardown(/* in */int unit)
{
    ...
    result = bcm_field_presel_destroy(unit, psset_id_router_over_ac);
    if (BCM_E_NONE != result) {
