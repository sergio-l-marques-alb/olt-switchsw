...
int vswitch_cross_connect_p2p_multi_device_vpws_tagged_add(int unit, int nof_vlans) {
    ...
    port_match.match_vlan = nof_vlans > 1 ? vswitch_vpls_tagged_info.outer_vlan : vswitch_vpls_tagged_info.vlan;
    port_match.match_inner_vlan = nof_vlans > 1 ? vswitch_vpls_tagged_info.vlan : 0;
