/* $Id: cint_pon_application.c,v 1.6 Broadcom SDK $
...
int pon_service_init(int unit, bcm_port_t port_pon, bcm_port_t port_nni)
{
   ...
   /* PON lif lkup services*/
    if(soc_property_suffix_num_get(unit,-1,spn_CUSTOM_FEATURE,"pon_lif_lkup",0)){
        ...
        pon_lif_lkup_service_info[index].tunnel_id  = 1000;
    ...
    pon_1_1_service_info[index].tunnel_id  = 1000;
    ...
    pon_1_1_service_info[index].tunnel_id  = 1001;
    ...
    /* PON Port 5 Tunnel-ID 1002 PCP 2 CVLAN 40 <-CrossConnect-> NNI Port 129 CVLAN 400*/
    index++;
    pon_1_1_service_info[index].service_mode = otag_to_otag2;
    pon_1_1_service_info[index].tunnel_id  = 1002;
    ...
    index++;
    pon_1_1_service_info[index].service_mode = o_i_tag_to_o2_i_tag;
    pon_1_1_service_info[index].tunnel_id  = 1003;
    ...
    index++;
    pon_1_1_service_info[index].service_mode = otag_to_otag2;
    pon_1_1_service_info[index].tunnel_id    = 1004;
    ...
    index++;
    pon_1_1_service_info[index].service_mode = o_i_tag_to_o2_i_tag;
    pon_1_1_service_info[index].tunnel_id    = 1005;
    ...
    pon_1_1_service_info[index].tunnel_id    = 1006;
    ...
    index++;
    pon_1_1_service_info[index].service_mode = otag_to_otag2;
    pon_1_1_service_info[index].tunnel_id    = 1007;
    ...
    index++;
    pon_1_1_service_info[index].service_mode = o_i_tag_to_o2_i_tag;
    pon_1_1_service_info[index].tunnel_id    = 1008;
    ...
    if (is_advanced_vlan_translation_mode) {
        ...
        pon_1_1_service_info[index].tunnel_id  = 1009;
    ...
    pon_tls_service_info.tunnel_id    = 1000;
    ...
    pon_3tag_manipulation_service_info.tunnel_id = 1000;
...
int pon_1_1_service(int unit)
{
    ...
    for (index = 0; index < nof_1_1_services; index++)
    {
        ...
        /* Create NNI LIF */
        rv = nni_lif_create(unit, nni_port, nni_lif_type, is_with_id, down_ovlan, down_ivlan, &nni_gport, &encap_id);
        if (rv != BCM_E_NONE) {
