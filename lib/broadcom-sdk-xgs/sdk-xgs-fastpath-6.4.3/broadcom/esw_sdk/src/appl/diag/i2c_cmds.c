 ...
 */
#define TD2P_MAX_ADJUST 0x8  /* TD2 board vlatage starts from 0.85V */
...
dac_params[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    {{0,"Core",-1,1,0,0,ADP4000_MIN_DACVAL,ADP4000_MAX_DACVAL+TD2P_MAX_ADJUST,ADP4000_MID_DACVAL,1},
     {1,"Analog",-1,1,0,0,ADP4000_ANLG_MIN_DACVAL,ADP4000_MAX_DACVAL+TD2P_MAX_ADJUST,ADP4000_MID_DACVAL,1},
...
bb_greyhound_get_board_type(int unit)
{
    ...
    if (board_name != NULL) {
        ...
        cli_out("Please define board_name in config.bcm, supported "
                "board names are BCM953406K, BCM953411K, and BCM953416K.\n");
    }
    return board_type;
}
