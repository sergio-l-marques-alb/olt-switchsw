...
typedef int FILE;
#define TDM_VERBOSE0(a) LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META("%s"),a))
#define TDM_VERBOSE(_frmt,a) LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(_frmt),a))
...
/*  No variadic macros */
	...
	#define TDM_ERROR8(a,b,c,d,e,f,g,h,i) LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h,i)) 
	#define TDM_ERROR7(a,b,c,d,e,f,g,h)   LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h))
	#define TDM_ERROR6(a,b,c,d,e,f,g) 	  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g))
	#define TDM_ERROR5(a,b,c,d,e,f) 	  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f))
	#define TDM_ERROR4(a,b,c,d,e) 		  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e))
	#define TDM_ERROR3(a,b,c,d) 		  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d))
	#define TDM_ERROR2(a,b,c) 			  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b,c))
	#define TDM_ERROR1(a,b) 			  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a),b))
	#define TDM_ERROR0(a) 				  LOG_BSL_ERROR(BSL_LS_SOC_TDM, (BSL_META(a)))
	#define TDM_WARN6(a,b,c,d,e,f,g) LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g))
	#define TDM_WARN5(a,b,c,d,e,f)   LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f))
	#define TDM_WARN4(a,b,c,d,e)     LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e))
	#define TDM_WARN3(a,b,c,d)       LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d))
	#define TDM_WARN2(a,b,c)         LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META(a),b,c))
	#define TDM_WARN1(a,b)           LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META(a),b))
	#define TDM_WARN0(a)             LOG_BSL_WARN(BSL_LS_SOC_TDM, (BSL_META("%s"),a))
	#define TDM_VERBOSE9(a,b,c,d,e,f,g,h,i,j) LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h,i,j))
	#define TDM_VERBOSE8(a,b,c,d,e,f,g,h,i)   LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h,i))
	#define TDM_VERBOSE7(a,b,c,d,e,f,g,h)     LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h))
	#define TDM_VERBOSE6(a,b,c,d,e,f,g)       LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g))
	#define TDM_VERBOSE5(a,b,c,d,e,f)         LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f))
	#define TDM_VERBOSE4(a,b,c,d,e)           LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e))
	#define TDM_VERBOSE3(a,b,c,d)             LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d))
	#define TDM_VERBOSE2(a,b,c)               LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c))
	#define TDM_VERBOSE1(a,b)                 LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b))
	#define TDM_BIG_BAR TDM_VERBOSE0(("TDM: #################################################################################################################################\n"));
	#define TDM_SML_BAR TDM_VERBOSE0(("TDM: ---------------------------------------------------------------------------------------------------------------------------------\n"));
	#define TDM_PRINT8(a,b,c,d,e,f,g,h,i) LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h,i))
	#define TDM_PRINT7(a,b,c,d,e,f,g,h)   LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g,h))
	#define TDM_PRINT6(a,b,c,d,e,f,g)     LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f,g))
	#define TDM_PRINT5(a,b,c,d,e,f)       LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e,f))
	#define TDM_PRINT4(a,b,c,d,e)         LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d,e))
	#define TDM_PRINT3(a,b,c,d)           LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c,d))
	#define TDM_PRINT2(a,b,c)             LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b,c))
	#define TDM_PRINT1(a,b)               LOG_BSL_VERBOSE(BSL_LS_SOC_TDM, (BSL_META(a),b))
