...
#define SOC_TD2_COSQ_NUM_CPU_L0_NODES(unit)       \
    (SOC_IS_TRIDENT2PLUS(unit) ? _TD2PLUS_COSQ_NUM_CPU_L0_NODES : _TD2_COSQ_NUM_CPU_L0_NODES)
#define SOC_TD2_COSQ_CPU_RESERVED_L0_NUM(unit)    \
    (SOC_IS_TRIDENT2PLUS(unit) ? 0 : _TD2_COSQ_NUM_CPU_L0_NODES)

#define SOC_TD2_COSQ_CPU_RESERVED_L0_BASE(unit)   \
    (SOC_IS_TRIDENT2PLUS(unit) ? 259 : 261)
...
soc_td2_init_invalid_pointers(int unit)
{
    ...
    if (_td2_invalid_ptr[unit][SOC_TD2_NODE_LVL_L0] > 52) {
