...
LOG_BSL_INFO(BSL_LS_SOC_PHY,(BSL_META_U(unit, 
...
;if((l7[0]&0x0800)){LOG_BSL_INFO(BSL_LS_SOC_PHY,(BSL_META_U(unit, 
...
LOG_BSL_INFO(BSL_LS_SOC_PHY, (BSL_META_U(unit,"u=%d p=%d ERROR_ACD_NO_NEW_RESULT\n"),
...
LOG_BSL_WARN(BSL_LS_SOC_PHY, (BSL_META_U(unit,
