...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyCount = 423          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionOam = 359,            /* It comprises several fields that are
                                           ...
                                           OAM-Stamp-Offset */
    bcmFieldActionCount = 360           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
typedef enum bcm_field_fabric_header_e {
    ...
    bcmFieldFabricHeaderTrafficManagementUcast = 1, /* Unicast Traffic Management fabric
                                           header */
    bcmFieldFabricHeaderTrafficManagementMcast = 2, /* Multiicast Traffic Management fabric
                                           header */
    ...
    bcmFieldFabricHeaderCount = 6       /* Always Last. Not a usable value. */
...
/* Set match criteria for bcmFieldQualifyEthernetOamSrcPortLmStatPoolId. */
extern int bcm_field_qualify_EthernetOamSrcPortLmStatPoolId(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyEthernetOamSrcPortLmStatPoolId. */
extern int bcm_field_qualify_EthernetOamSrcPortLmStatPoolId_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);

/* Set match criteria for bcmFieldQualifyEthernetOamVxlt1LmStatPoolId. */
extern int bcm_field_qualify_EthernetOamVxlt1LmStatPoolId(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyEthernetOamVxlt1LmStatPoolId. */
extern int bcm_field_qualify_EthernetOamVxlt1LmStatPoolId_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);

/* Set match criteria for bcmFieldQualifyEthernetOamVxlt2LmStatPoolId. */
extern int bcm_field_qualify_EthernetOamVxlt2LmStatPoolId(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyEthernetOamVxlt2LmStatPoolId. */
extern int bcm_field_qualify_EthernetOamVxlt2LmStatPoolId_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);

/* Set match criteria for bcmFieldQualifyEthernetOamSourceVPLmStatPoolId. */
extern int bcm_field_qualify_EthernetOamSourceVPLmStatPoolId(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyEthernetOamSourceVPLmStatPoolId. */
extern int bcm_field_qualify_EthernetOamSourceVPLmStatPoolId_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
extern int bcm_field_qualify_EthernetOamClassVxlt1(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
extern int bcm_field_qualify_EthernetOamClassVxlt1_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
extern int bcm_field_qualify_EthernetOamClassVxlt2(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
extern int bcm_field_qualify_EthernetOamClassVxlt2_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);

/* Set match criteria for bcmFieldQualifyEthernetOamClassSourceVP. */
extern int bcm_field_qualify_EthernetOamClassSourceVP(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyEthernetOamClassSourceVP. */
extern int bcm_field_qualify_EthernetOamClassSourceVP_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);

/* Set match criteria for bcmFieldQualifyEthernetOamClassVFI. */
extern int bcm_field_qualify_EthernetOamClassVFI(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyEthernetOamClassVFI. */
extern int bcm_field_qualify_EthernetOamClassVFI_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* Set match criteria for bcmFieldQualifyMplsOamMplsLmStatPoolId. */
extern int bcm_field_qualify_MplsOamMplsLmStatPoolId(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);

/* Get match criteria for bcmFieldQualifyMplsOamMplsLmStatPoolId. */
extern int bcm_field_qualify_MplsOamMplsLmStatPoolId_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
extern int bcm_field_qualify_MplsOamClassMpls(
    int unit, 
    bcm_field_entry_t entry, 
    uint16 data, 
    uint16 mask);
...
extern int bcm_field_qualify_MplsOamClassMpls_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint16 *data, 
    uint16 *mask);
