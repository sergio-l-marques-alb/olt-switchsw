...
#define LOG_BSL_FATAL(ls_, stuff_)      BSL_LOG(ls_|BSL_FATAL, stuff_)
#define LOG_BSL_ERROR(ls_, stuff_)      BSL_LOG(ls_|BSL_ERROR, stuff_)
#define LOG_BSL_WARN(ls_, stuff_)       BSL_LOG(ls_|BSL_WARN, stuff_)
#define LOG_BSL_INFO(ls_, stuff_)       BSL_LOG(ls_|BSL_INFO, stuff_)
#define LOG_BSL_VERBOSE(ls_, stuff_)    BSL_LOG(ls_|BSL_VERBOSE, stuff_)
#define LOG_BSL_DEBUG(ls_, stuff_)      BSL_LOG(ls_|BSL_DEBUG, stuff_)
...
#define LOG_BSL_CHECK(packed_meta_)     bsl_fast_check(packed_meta_)
