...
typedef struct bcm_async_req_s {
	...
	union {
		...
		struct {
			...
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamClassSourceVP;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamClassSourceVP_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamClassVFI;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamClassVFI_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamClassVxlt1;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamClassVxlt1_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamClassVxlt2;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamClassVxlt2_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
		...
		struct {
			...
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamSourceVPLmStatPoolId;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamSourceVPLmStatPoolId_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamSrcPortLmStatPoolId;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamSrcPortLmStatPoolId_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
		...
		struct {
			...
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamVxlt1LmStatPoolId;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamVxlt1LmStatPoolId_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
			uint8 mask;
		} field_qualify_EthernetOamVxlt2LmStatPoolId;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_EthernetOamVxlt2LmStatPoolId_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
		...
		struct {
			...
			uint16 data;
			uint16 mask;
		} field_qualify_MplsOamClassMpls;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint16 * data;
			uint16 * mask;
		} field_qualify_MplsOamClassMpls_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
		...
		struct {
			...
			uint8 data;
			uint8 mask;
		} field_qualify_MplsOamMplsLmStatPoolId;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 * data;
			uint8 * mask;
		} field_qualify_MplsOamMplsLmStatPoolId_get;
		struct {
			int unit;
			bcm_field_entry_t entry;
			uint8 data;
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSSOURCEVP,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSSOURCEVP_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSVFI,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSVFI_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSVXLT1,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSVXLT1_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSVXLT2,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMCLASSVXLT2_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMSOURCEVPLMSTATPOOLID,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMSOURCEVPLMSTATPOOLID_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMSRCPORTLMSTATPOOLID,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMSRCPORTLMSTATPOOLID_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMTXPKTUPMEP,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMTXPKTUPMEP_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMVXLT1LMSTATPOOLID,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMVXLT1LMSTATPOOLID_GET,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMVXLT2LMSTATPOOLID,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_ETHERNETOAMVXLT2LMSTATPOOLID_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_MPLSOAMCLASSMPLS,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_MPLSOAMCLASSMPLS_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_MPLSOAMMPLSLMSTATPOOLID,
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_MPLSOAMMPLSLMSTATPOOLID_GET,
