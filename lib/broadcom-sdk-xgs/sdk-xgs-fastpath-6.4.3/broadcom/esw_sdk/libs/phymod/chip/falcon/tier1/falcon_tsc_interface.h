 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: falcon_tsc_interface.h 754 2014-10-29 22:29:05Z kirand $   *
 *                                                                                 *
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_tsc_display_core_state_legend(void);
 ...
 * @param param selects the parameter to read based on falcon_tsc_tx_afe_settings_enum
