...
int _get_no_of_pcs_lane(PHYMOD_ST* pc)
{
  ...
  switch(port_type) {
    ...
    case TEMOD_MULTI_PORT:      return 1; break;
    /* coverity[dead_error_begin] */
    case TEMOD_TRI1_PORT:       return ((port_num==2) ? 2:1); break;
    /* coverity[dead_error_begin] */
    case TEMOD_TRI2_PORT:       return ((port_num==0) ? 2:1); break;
    /* coverity[dead_error_begin] */
    case TEMOD_DXGXS:           return 2; break;
    /* coverity[dead_error_begin] */
    case TEMOD_SINGLE_PORT:     return 4; break;
    /* coverity[dead_error_begin] */
    default:                    return 0;
  }
  return 0;
