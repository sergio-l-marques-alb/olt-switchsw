 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: falcon_furia_debug_functions.h 661 2014-08-14 23:20:49Z kirand $ *
 *                                                                                       *
 ...
 */ 
uint8_t    falcon_furia_rdbl_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */ 
uint16_t   falcon_furia_rdwl_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */ 
int8_t     falcon_furia_rdbls_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */ 
int16_t    falcon_furia_rdwls_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */ 
uint8_t    falcon_furia_rdbc_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */ 
uint16_t   falcon_furia_rdwc_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */ 
int8_t     falcon_furia_rdbcs_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */ 
int16_t    falcon_furia_rdwcs_uc_var(err_code_t *err_code, uint8_t addr);
...
err_code_t falcon_furia_rdblk_uc_ram(uint8_t *mem, uint16_t addr, uint16_t cnt);
