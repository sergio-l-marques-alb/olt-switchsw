                                    ...
                                    void *entry)
{
    ...
    addr = soc_reg_addr_get(unit, reg, REG_PORT_ANY, 0, FALSE, &block, &acc_type);
    soc_internal_extended_read_reg(pcid_info, block, acc_type, addr, rval);
                                      ...
                                      int *bank_inc, int *do_first_fit)
{
    ...
    addr = soc_reg_addr_get(unit, ISS_BANK_CONFIGr, REG_PORT_ANY, 0, FALSE, &block,
                            &acc_type);
    soc_internal_extended_read_reg(pcid_info, block, acc_type, addr, rval);
