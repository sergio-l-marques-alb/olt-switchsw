...
extern int soc_tomahawk2_idb_wr_port_ca_sop(int unit,
       int pipe_num, int pm_num, int subp, int speed);
...
extern int soc_tomahawk2_idb_cpu_ca_in_reset(int unit, int pipe_num);

extern int soc_tomahawk2_idb_lpbk_ca_in_reset(int unit, int pipe_num);
...
extern int soc_tomahawk2_idb_ca_cpu_poll_buffer_empty(
       int unit, int pipe_num);


extern int soc_tomahawk2_idb_ca_lpbk_poll_buffer_empty(
       int unit, int pipe_num);
