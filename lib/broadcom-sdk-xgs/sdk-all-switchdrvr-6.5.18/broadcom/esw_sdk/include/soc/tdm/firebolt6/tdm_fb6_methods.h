...
LINKER_DECL int  tdm_fb6_parse_acc_idb(tdm_mod_t *_tdm, int cal_id);
LINKER_DECL int  tdm_fb6_parse_acc_mmu(tdm_mod_t *_tdm, int cal_id);
LINKER_DECL int  tdm_fb6_parse_ancl(tdm_mod_t *_tdm, int cal_id);
LINKER_DECL int  tdm_fb6_parse_tdm_tbl(tdm_mod_t *_tdm);
LINKER_DECL int tdm_fb6_parse_tdm_cal_idb_mmu(tdm_mod_t *_tdm, int cal_id, int param_mgmt_size, int param_lpbk, int param_fae, int param_idle1, int param_null, int param_clk_freq, int param_cal_len, int param_token_ancl, int param_dummy);
