...
#define SOC_IS_DNX(unit)                ((SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_JERICHO2) || (SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_J2C) || (SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_Q2A) || (SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_J2P))
#define SOC_IS_DNX_TYPE(dev_type)       (SOC_IS_JERICHO2_TYPE(dev_type) || SOC_IS_J2C_TYPE(dev_type) || SOC_IS_J2P_TYPE(dev_type) || SOC_IS_Q2A_TYPE(dev_type))
...
#define SOC_IS_J2C_A0(unit)             (SOC_INFO(unit).driver_type == SOC_CHIP_BCM88800_A0)
#define SOC_IS_J2C_A1(unit)             (SOC_INFO(unit).driver_type == SOC_CHIP_BCM88800_A1)
...
#define SOC_IS_Q2A_TYPE(dev_type)       (((dev_type) & DNXC_DEVID_FAMILY_MASK) == BCM88480_DEVICE_ID)
#define SOC_IS_Q2A_B0(unit)             (SOC_INFO(unit).driver_type == SOC_CHIP_BCM88480_B0)
...
#define HRC_BLOCK(unit) (SOC_INFO(unit).hrc_block)
...
typedef struct mos_msg_ll_node64_s {
    ll_element_t  msg_q;        /*LL linkage*/
    mos_msg64_data_t  msg_data;   /*Msg Data*/
}mos_msg64_ll_node_t;
