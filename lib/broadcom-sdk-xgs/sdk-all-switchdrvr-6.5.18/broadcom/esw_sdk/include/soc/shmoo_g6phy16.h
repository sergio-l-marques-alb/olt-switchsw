/*
 * $Id: shmoo_g6phy16.h,v 1.1.2.19 Broadcom SDK $
...
#define SHMOO_G6PHY16_CALIB_ANY_EDGE                010
...
/* Initial UI Shifts */
#define SHMOO_G6PHY16_GDDR6_INIT_CK_UI_SHIFT        1
...
typedef struct g6phy16_training_bist_err_cnt_s {
    ...
    /** per controller logic to verify that number of bist commands made sense */
    uint32 bist_global_sanity_error_occurred;
