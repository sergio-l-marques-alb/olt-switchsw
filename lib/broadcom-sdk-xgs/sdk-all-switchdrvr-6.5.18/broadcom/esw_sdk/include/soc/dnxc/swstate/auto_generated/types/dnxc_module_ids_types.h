...
typedef enum {
     ...
     */
    DNX_MIRROR_MODULE_ID = 44,
    /**
     * multicast module id
     */
    MULTICAST_MODULE_ID = 45,
    /**
     * phantom_queues module id
     */
    PHANTOM_QUEUES_MODULE_ID = 46,
    /**
     * port_tpid module id
     */
    PORT_TPID_MODULE_ID = 47,
    /**
     * dnx_sch_alloc_mngr module id
     */
    DNX_SCH_ALLOC_MNGR_MODULE_ID = 48,
    /**
     * vlan module id
     */
    VLAN_MODULE_ID = 49,
     ...
     */
    DNX_ALGO_FIELD_ACTION_MODULE_ID = 50,
    /**
     * dnx_algo_lane_map module id
     */
    DNX_ALGO_LANE_MAP_MODULE_ID = 51,
    /**
     * algo_lif module id
     */
    ALGO_LIF_MODULE_ID = 52,
    /**
     * dnx_algo_synce module id
     */
    DNX_ALGO_SYNCE_MODULE_ID = 53,
    /**
     * dnx_cosq_ingress module id
     */
    DNX_COSQ_INGRESS_MODULE_ID = 54,
    /**
     * dbal module id
     */
    DBAL_MODULE_ID = 55,
     ...
     */
    DNX_BIER_DB_MODULE_ID = 56,
    /**
     * dnx_egr_db module id
     */
    DNX_EGR_DB_MODULE_ID = 57,
    /**
     * dnx_fifodma module id
     */
    DNX_FIFODMA_MODULE_ID = 58,
    /**
     * dnx_ire_packet_generator module id
     */
    DNX_IRE_PACKET_GENERATOR_MODULE_ID = 59,
    /**
     * dnx_ofp_rate module id
     */
    DNX_OFP_RATE_MODULE_ID = 60,
    /**
     * dnx_rx module id
     */
    DNX_RX_MODULE_ID = 61,
     ...
     */
    DNX_TIME_SW_STATE_MODULE_ID = 62,
    /**
     * dnx_dram module id
     */
    DNX_DRAM_MODULE_ID = 63,
    /**
     * dnx_ecgm module id
     */
    DNX_ECGM_MODULE_ID = 64,
    /**
     * example module id
     */
    EXAMPLE_MODULE_ID = 65,
    /**
     * dnx_fabric module id
     */
    DNX_FABRIC_MODULE_ID = 66,
    /**
     * dnx_field module id
     */
    DNX_FIELD_MODULE_ID = 67,
    /**
     * dnx_field_actions module id
     */
    DNX_FIELD_ACTIONS_MODULE_ID = 68,
    /**
     * dnx_field_apptype module id
     */
    DNX_FIELD_APPTYPE_MODULE_ID = 69,
    /**
     * dnx_field_context module id
     */
    DNX_FIELD_CONTEXT_MODULE_ID = 70,
    /**
     * dnx_field_group module id
     */
    DNX_FIELD_GROUP_MODULE_ID = 71,
    /**
     * dnx_field_key module id
     */
    DNX_FIELD_KEY_MODULE_ID = 72,
    /**
     * dnx_field_qualifier module id
     */
    DNX_FIELD_QUALIFIER_MODULE_ID = 73,
    /**
     * dnx_field_range module id
     */
    DNX_FIELD_RANGE_MODULE_ID = 74,
    /**
     * dnx_field_tcam_access module id
     */
    DNX_FIELD_TCAM_ACCESS_MODULE_ID = 75,
    /**
     * dnx_field_tcam_access_mapper module id
     */
    DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID = 76,
    /**
     * dnx_field_tcam_access_profile module id
     */
    DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID = 77,
    /**
     * dnx_field_tcam_bank module id
     */
    DNX_FIELD_TCAM_BANK_MODULE_ID = 78,
    /**
     * dnx_field_tcam_cache module id
     */
    DNX_FIELD_TCAM_CACHE_MODULE_ID = 79,
    /**
     * dnx_field_tcam_location module id
     */
    DNX_FIELD_TCAM_LOCATION_MODULE_ID = 80,
    /**
     * dnx_field_tcam_manager module id
     */
    DNX_FIELD_TCAM_MANAGER_MODULE_ID = 81,
    /**
     * dnx_field_tcam_prefix module id
     */
    DNX_FIELD_TCAM_PREFIX_MODULE_ID = 82,
    /**
     * flush module id
     */
    FLUSH_MODULE_ID = 83,
     ...
     */
    DNX_HARD_RESET_MODULE_ID = 84,
    /**
     * interrupt module id
     */
    INTERRUPT_MODULE_ID = 85,
    /**
     * dnx_ipq module id
     */
    DNX_IPQ_MODULE_ID = 86,
    /**
     * dnx_iqs module id
     */
    DNX_IQS_MODULE_ID = 87,
    /**
     * kbp module id
     */
    KBP_MODULE_ID = 88,
    /**
     * kbp_common module id
     */
    KBP_COMMON_MODULE_ID = 89,
    /**
     * kbp_fwd_tcam_access_mapper module id
     */
    KBP_FWD_TCAM_ACCESS_MAPPER_MODULE_ID = 90,
    /**
     * l2 module id
     */
    L2_MODULE_ID = 91,
     ...
     */
    DNX_PORT_IMB_MODULE_ID = 96,
    /**
     * reflector module id
     */
    REFLECTOR_MODULE_ID = 97,
    /**
     * dnx_sch_config module id
     */
    DNX_SCH_CONFIG_MODULE_ID = 98,
    /**
     * dnx_scheduler module id
     */
    DNX_SCHEDULER_MODULE_ID = 99,
    /**
     * srv6 module id
     */
    SRV6_MODULE_ID = 100,
     ...
     */
    DNX_STK_SYS_MODULE_ID = 102,
    /**
     * switch module id
     */
    SWITCH_MODULE_ID = 103,
    /**
     * trunk module id
     */
    TRUNK_MODULE_ID = 104,
     ...
     */
    DNX_SW_STATE_DEFRAGMENTED_CHUNK_MODULE_ID = 105,
    /**
     * dnx_sw_state_hash_table module id
     */
    DNX_SW_STATE_HASH_TABLE_MODULE_ID = 106,
    /**
     * dnx_sw_state_sorted_list module id
     */
    DNX_SW_STATE_SORTED_LIST_MODULE_ID = 107,
    /**
     * dnxc module id
     */
    DNXC_MODULE_ID = 108,
     ...
     */
    MULTITHREAD_ANALYZER_MODULE_ID = 109,
    /**
     * wb_engine module id
     */
    WB_ENGINE_MODULE_ID = 110,
    /**
     * dnxf module id
     */
    DNXF_MODULE_ID = 111,
