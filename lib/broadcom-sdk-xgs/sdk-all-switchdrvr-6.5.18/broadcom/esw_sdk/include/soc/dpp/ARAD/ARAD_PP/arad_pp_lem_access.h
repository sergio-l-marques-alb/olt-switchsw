...
#define ARAD_PP_LEM_ACCESS_KEY_PREFIX_FOR_IPV6_64_IN_LEM_MIN            0x10 /* prefix value is 10xxx, 8 static prefix, from 16 to 23 */
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_IPV6_64_IN_LEM      (32) /* part 1 of IPV6 DIP HIGH 32 bits */
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IPV6_64_IN_LEM      (32) /* part 2 of IPV6 DIP HIGH 32 bits */
#define ARAD_PP_LEM_ACCESS_KEY_PARAM2_IN_BITS_FOR_IPV6_64_IN_LEM      (14) /* VRF 14 bits*/
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_PPPOE_ANTI_SPOOFING   (16) /* Session ID */
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_PPPOE_ANTI_SPOOFING   (18) /* Session ID */
...
typedef enum
{
  ...
  /*
   *  IPv4/6 IP Source Specific Multicast
   */
