...
/* Maximal Number of FEM programs */
...
#define SOC_PPC_FP_DATABASE_INFO_FLAGS_WITH_CYCLE       (1 << 13) /* using cycle */

#define SOC_PPC_FP_DATABASE_INFO_FLAGS_ELK_RANGE        (1 << 14) /* using Range check in KAPS */

#define SOC_PPC_FP_DATABASE_INFO_FLAGS_WITH_CE_ID       (1 << 15) /* using ce id  */

#define BCM_FIELD_ENTRY_INVALID                         (-1)

#define SOC_PPC_FP_MAX_SELECT_LINE                      (0x30)   /* Max select line */
/* } */
/*************
 * MACROS    *
 *************/
...
typedef enum
{
  ...
  /*
   *  L4-Src-Port for ELK range(16b)
   */
  SOC_PPC_FP_QUAL_HDR_ELK_RANGE_IPV4_SRC_PORT,
  /*
   *  L4-Dest-Port for ELK range(16b)
   */
  ...
  /*
   ...
   /*
    *  MPLS Experimental Use 5 (3b)
    */
   SOC_PPC_FP_QUAL_HDR_MPLS_EXP5,
   /*
    *  MPLS Time-To-Live 5 (8b)
    */
   SOC_PPC_FP_QUAL_HDR_MPLS_TTL5,
   /*
    *  MPLS Bottom-of-Stack 5 (32b)
    */
  ...
  /* 
   * PLC (parser_leaf_context) qualifier and  preselector (4b) 
   * May either be an extension of PFC (packet_format_code)
   * or stand alone
   * See
   *   SOC_PPC_FP_QUAL_IRPP_PKT_HDR_TYPE
   */
  
  SOC_PPC_FP_QUAL_IRPP_PARSER_LEAF_CONTEXT,   /* 81 */
  /*
  ...
  *  See SOC_PPC_FP_QUAL_HDR_USER_DEF_0.
  */
  SOC_PPC_FP_QUAL_HDR_USER_DEF_LAST = SOC_PPC_FP_QUAL_HDR_USER_DEF_0 + 255,  /* = 116 + 255 = 372 */
    /*
     *  Source-IP MSBs.
     */
  ...
  /* ptc_key_gen_var */
  SOC_PPC_FP_QUAL_IRPP_PTC_KEY_GEN_VAR, /* 200 */
  ...
  SOC_PPC_FP_QUAL_HDR_BFD_PPH_FWD_CODE, /* 210 */
  ...
  SOC_PPC_FP_QUAL_HDR_STACKING_EXT_AFTER_DSP_EXT_PETRA,
    ...
    SOC_PPC_FP_QUAL_HDR_VLAN_TAG_CFI, /* 220 */
    ...
    SOC_PPC_FP_QUAL_HDR_INNER_2ND_VLAN_TAG_ID, /* 230 */
    ...
    SOC_PPC_FP_QUAL_HEADER_OFFSET0,   /* 240 */
    ...
    SOC_PPC_FP_QUAL_PACKET_FORMAT_QUALIFIER1_ENCAPSULATION, /* 250 */
    ...
    SOC_PPC_FP_QUAL_PACKET_FORMAT_QUALIFIER3, /* 260 */
    ...
    SOC_PPC_FP_QUAL_VLAN_EDIT_CMD_VID2, /* 270 */
    ...
    SOC_PPC_FP_QUAL_EGRESS_LEARN_ENABLE, /* 280 */
    ...
    SOC_PPC_FP_QUAL_ELK_LOOKUP_RESULT_0,/* res_0 to res_7 has to be in this order and without qualifiers in between */
    SOC_PPC_FP_QUAL_ELK_LOOKUP_RESULT_1,
    SOC_PPC_FP_QUAL_ELK_LOOKUP_RESULT_2, /* 300 */
    ...
    SOC_PPC_FP_QUAL_VT_LOOKUP0_FOUND, /* 330 */
    ...
    SOC_PPC_FP_QUAL_ARP_TARGET_IP4, /* 350 */
  ...
  SOC_PPC_FP_QUAL_HDR_MH_TC10, /* 360 */
  ...
  SOC_PPC_FP_QUAL_ERPP_LEARN_EXT, /* 370 */
  ...
  SOC_PPC_FP_QUAL_ERPP_FORMAT_CODE, /* 400 */
  ...
  SOC_PPC_FP_QUAL_ERPP_NWK_RCRD_ETH_OUTER_TPID,
    ...
    SOC_PPC_FP_QUAL_ERPP_NWK_RCRD_ETH_OUTER_TAG_ID, /* 440 */
  ...
  SOC_PPC_FP_QUAL_ERPP_NWK_RCRD_IPV6_LOOPBACK_SRC_OR_DST, /* 480 */
  ...
  SOC_PPC_FP_QUAL_ERPP_NWK_RCRD_TRILL_MULTI_DESTINATION, /* 490 */
  ...
  SOC_PPC_FP_QUAL_EXTENSION_HEADER_TYPE,
    ...
    SOC_PPC_FP_QUAL_SERVICE_TYPE,                /*500 */
     ...
     */
    SOC_PPC_FP_QUAL_KEY_AFTER_HASHING, /* 520 */
    ...
    SOC_PPC_FP_QUAL_IRPP_RPF_NATIVE_VSI,  /* 530 */
    ...
    SOC_PPC_FP_QUAL_MPLS_OAM_ACH  ,       /* 540 */
    ...
    SOC_PPC_FP_QUAL_OAM_MD_LEVEL,
  	...
  	SOC_PPC_FP_QUAL_MY_DISCR_IPV4,   /* 550 */
    ...
    SOC_PPC_FP_QUAL_VLAN_DOMAIN                           ,   /* 570 */
    ...
    SOC_PPC_FP_QUAL_KEY3_INNER_VID                        ,  /* 620 */
    ...
    SOC_PPC_FP_QUAL_KEY0_OUTER_VID_VALID                  , /* 650 */
   ...
   */
   ...
   /*
   * 2nd VLAN Tag Id (12b) of the default Ethernet Header. The
   *  default Ethernet Header is the forwarding Header (if
   *  Ethernet), otherwise the outermost Ethernet Header.
   */
   ...
   */
    ...
    */
    ...
    SOC_PPC_FP_QUAL_IRPP_PRESEL_PROFILE2,    /* 670 */
     ...
     */
    SOC_PPC_FP_QUAL_OUT_LIF_RANGE,             /* 678 */
    /*
     *  PPPOE SESSION ID. 
     */
    ...
    /*
     * SLB preselector of NEXT_PROTOCOL of FWD header plus one
     */
...
typedef struct
{
  ...
  uint32 pgm_bmp; /* Bitmap of program-ids which the current field group will be pointing to. */
...
typedef struct
{
  ...
  /*
   * If True, keep old location for removed entry
   */
  uint8 is_keep_location;

  /*
   * Large direct lookup key
   * This is used to return large direct lookup key.
   *
   */
  uint32 large_direct_lookup_key;

  /*
   * Large direct lookup mask
   * This is used to return large direct lookup mask.
   *
   */
...
/* flag if preselector is with program ID */
...
typedef struct
{
  ...
  /*
   *  Action-Value will be taken according to the shift of the input
   *  Range: 0 - 31.
   */
  ...
  /*
   * FES Polarity, if value is 0, FES is valid only if valid bit is 0.
   */
  uint32 polarity;
...
/*
 * header_info is only used for header packet
 * For internal, please ignore header_info.
 * msb, lsb is from software CE datebase.
 * For header packet, qual_lsb and qual_type info
 * is from sw ce database.
 * For internal, qual_lsb and qual_type info is from hw.
 */
typedef struct
{
  SOC_SAND_MAGIC_NUM_VAR
 /*
  * TURE is packet header info;
  * FALSE is internal info.
  */
  uint8                      is_header;

  /*
   * The qualifier is found or not.
   */
  uint8                      qual_found;
  ...
  /*
   * This is a bitmap of pmf key.
   * This is an KEY_A, KEY_B, KEY_C, KEY_D bitmap.
   */
  uint32                     keys_valid;

  /*
   *  The CE used number of bits(Contain lost bits)
   *
   */
  uint32                     nof_bits;
  ...
  /*
   * The offset in this CE.
   */
  uint32 ce_offset;

  /*
   * If is_header is true, base is equal to sub-header index;
   * If is_header is false, base means LSB or MSB buffer for HW configuration only.
   * If is_header is false, this only valid for Jericho and above. If it is ARAD, it is always 0.
   */
  uint32 base;
} SOC_PPC_FP_CE_INFO;
