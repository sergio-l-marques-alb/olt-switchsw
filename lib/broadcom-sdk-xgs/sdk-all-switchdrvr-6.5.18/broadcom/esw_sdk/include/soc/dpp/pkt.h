...
typedef enum soc_pkt_dnx_ase_type_e {
    socPktDnxAseTypeNone = 0,           /* Ase type is None */
    socPktDnxAseTypeTrajectoryTrace = 1,/* Ase type is Trajectory trace */
    socPktDnxAseTypeErspan = 2          /* Ase type is ERSPAN */
...
typedef struct soc_pkt_dnx_ase_info_s {
    soc_pkt_dnx_erspan_info_t ersapn_info; /* ERSPAN header information */
} soc_pkt_dnx_ase_info_t;

/* ftmh application specific extension. */
typedef struct soc_pkt_dnx_ftmh_ase_extension_s {
    uint8 valid;                        /* Set if the extension is present */
    soc_pkt_dnx_ase_type_t ase_type;    /* Application Specific Extension type */
    soc_pkt_dnx_ase_info_t ase_info;    /* Application Specific Extension
                                           information */
...
typedef struct  {
    ...
    soc_pkt_dnx_ftmh_ase_extension_t ase_ext; /* FTMH ASE extension */
    soc_pkt_dnx_ftmh_flow_id_extension_t flow_id_ext; /* FTMH FLow-ID Extension */
} soc_pkt_dnx_ftmh_t;
