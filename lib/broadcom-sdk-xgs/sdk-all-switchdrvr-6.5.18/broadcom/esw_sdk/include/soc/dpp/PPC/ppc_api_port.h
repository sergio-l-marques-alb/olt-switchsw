...
/*
  ...
  /*
     *  Port support generalized recycle header 0
     */
  SOC_PPC_PORT_DEFINED_VT_PROFILE_GENERALIZED_RCH0 = 9,
  /*
     *  Port support generalized recycle header 1
     */
  SOC_PPC_PORT_DEFINED_VT_PROFILE_GENERALIZED_RCH1 = 10,

  /*
   *  Port support PP port based port termination for IPv6 Cascade
   */

  SOC_PPC_PORT_DEFINED_VT_PORT_TERMINATION_CASCADE = 16,
  
  /*
   *  Port support PP port based port termination for 3mtse plus frr
   */
...
/*
  ...
  SOC_PPC_PORT_DEFINED_TT_PROFILE_PORT_TERMINATION = 6,
   ...
   /*
   *  Port support generalized recycle header.
   *  All pacets received on this port are expected to have the IPvXoRCH format
   */
   
  SOC_PPC_PORT_DEFINED_TT_PROFILE_GENERALIZED_RCH = 7,

  /*
   *  Port support PP port based port termination for 2mtse plus frr
