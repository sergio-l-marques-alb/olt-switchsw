 ...
 *   PROC
 * FUNCTION:
 *   Gets an entry from a TCAM database
 * INPUT:
 *   SOC_SAND_IN  int               unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  uint32               tcam_db_id -
 ...
 *   SOC_SAND_IN  uint8                is_single_bank -
 *     The TCAM is single bank TCAM or not.
 *   SOC_SAND_OUT  ARAD_TCAM_ENTRY           *entry -
 *     The derived entry's data.
 *   SOC_SAND_OU ARAD_TCAM_ACTION          action -
 *     The action associated with the entry derived.
 * REMARKS:
 *   None.
 * RETURNS:
 *   OK or ERROR indication.
