...
/*********************************************************************
* NAME:
*     soc_jer_fabric_fgl_egress_config_set / get
* FUNCTION:
*     set/get FGL egress configuration- egress drop threshold,
*     egress almost full threshold, egress FTMH mode, egress packet CRC,
*     egress packet CRC discard.
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN/OUT   soc_fabric_fgl_egress_config_t    fgl_egress_config -
*     FGL egress config
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_fgl_ingress_config_set / get
* FUNCTION:
*     set/get FGL ingress configuration - TDM min size and TDM max size.
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN/OUT   soc_fabric_fgl_ingress_config_t    fgl_ingress_config -
*     FGL ingress config
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_fgl_loopback_config_set / get
* FUNCTION:
*     set/get FGL loopback configuration- egress to ingress loopback,
*     ingress to egress loopback, egress to ingress loopback mode,
*     egress to ingress loopback control.
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN/OUT   soc_fabric_fgl_loopback_config_t    fgl_loopback_config -
*     FGL loopback config
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_fgl_ingress_tdm_context_drop_set / get
* FUNCTION:
*     set/get FGL ingress TDM context drop
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN/OUT   soc_fabric_fgl_ingress_tdm_context_drop_t    tdm_context_drop -
*     FGL ingress TDM context drop config
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
*   None. 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_egr_mc_mapping_mode_set / get
* FUNCTION:
*     set/get Fabric egress multicast mapping mode
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN/OUT   int    egr_mc_mapping_mode -
*     Fabric egress multicast mapping mode
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
*   None. 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_eci_tdm_config_table_set / get
* FUNCTION:
*     set/get Fabric ECI TDM configuration table
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  uint32                                 index -
*     Index of the entry in table.
*  SOC_SAND_IN/OUT   soc_fabric_eci_egr_tdm_config_t    eci_egr_tdm_config -
*     Fabric ECI TDM configuration
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
*   None. 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_eci_egr_port_map_table_set / get
* FUNCTION:
*     set/get Fabric ECI egress port mapping table
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  uint32                                 index -
*     Index of the entry in table.
*  SOC_SAND_IN/OUT   soc_fabric_eci_egr_port_map_t    egr_port_map -
*     Fabric ECI egress port mapping value
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
*   None. 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_eci_egr_mct_table_set / get
* FUNCTION:
*     set/get Fabric ECI egress multicast table
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  uint32                                 index -
*     Index of the entry in table.
*  SOC_SAND_IN/OUT   soc_fabric_eci_egr_mct_t    eci_egr_mct -
*     Fabric ECI egress multicast value
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
*   None. 
...
/*********************************************************************
* NAME:
*     soc_jer_fabric_eci_egr_mct_mapping_table_set / get
* FUNCTION:
*     set/get Fabric ECI egress multicast mapping table
* INPUT:
*  SOC_SAND_IN  int                                 unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  uint32                                 index -
*     Index of the entry in table.
*  SOC_SAND_IN/OUT   soc_fabric_eci_egr_mct_mapping_t    eci_egr_mct_mapping -
*     Fabric ECI egress multicast mapping configuration
* RETURNS:
*   OK or ERROR indication.
* REMARKS: 
*   None. 
