...
#define SOC_DPP_DSCP_PRESERVE_OUTLIF_SEL_MASK 0x3F
  ...
  */
  ...
  uint8 qux_slm_lm_mode; /* Whether QUX operates in SLM/LM mode. It can operate only in either one due to LM HW bug */
  uint8 qux_dm_1588_counting_enable; /* Whether counting should be enabled for 1588 DMM/DMR pkts or not. Its a global property due to LM HW bug */
  uint8 qux_dm_ntp_counting_enable; /* Whether counting should be enabled for NTP DMM/DMR pkts or not. Its a global property due to LM HW bug */
  uint8 qux_ccm_counting_enable; /* Whether counting should be enabled for CCM pkts(excluding dual ended LM) or not. Its a global property due to LM HW bug */
  uint8 qux_lb_counting_enable; /* Whether counting should be enabled for LBM/LBR pkts or not. Its a global property due to LM HW bug */
