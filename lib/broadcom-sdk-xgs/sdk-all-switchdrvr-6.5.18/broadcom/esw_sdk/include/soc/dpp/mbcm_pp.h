...
/* BFD OAMP UDP src port check enable/disable */
typedef soc_error_t (*mbcm_pp_bfd_oamp_udp_src_port_check_enable_f)(SOC_SAND_IN int, SOC_SAND_IN uint8);

/* Set/Get UDP DST port in the RX BFD packet for Seamless BFD feature */
 typedef  uint32
...
/* Set/Get UDP src port for Seamless BFD TX packets */
typedef uint32
