...
typedef long kbp_time_t;  /**< data type for time related functions */
...
#define KBP_CAST_PTR_TO_U32(x) ((uint32_t) (uintptr_t) x) /**< Macro to typecast a pointer to 32 bit integer */
#define KBP_CAST_U32_TO_PTR(x)    (void*) ((uintptr_t) x) /**< Macro to typecast a 32 bit integer to pointer */


#define kbp_assert(cond, msg) ((void) ((cond) || kbp_assert_detail((msg), __FILE__, __LINE__))) /**< Macro to assert under given condition and print given message along with details including file name and line number */
#define kbp_sassert(cond)     ((void) ((cond) || kbp_assert_detail((" "), __FILE__, __LINE__))) /**< Macro to assert under given condition and print details including file name and line number */
#define kbp_assert_(b, m)     (kbp_identity(b) ? 0 : kbp_assert_detail(m, __FILE__, __LINE__)), /**< Macro to assert depending on value of arg 'b' */
...
#else
#define kbp_concat_2(a, b)      a##b              /**< Concatenate two strings */
#define kbp_concat_3(a, b, c)   a##b##c           /**< Concatenate three strings */
#endif
 ...
 * of suffix are returned. It's the responsibility
