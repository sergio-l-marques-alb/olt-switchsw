...
#define SOC_BLOCK_DPP_NAMES_INITIALIZER { \
    ...
    {SOC_BLK_MSS, 0, "MSS"},\
    {SOC_BLK_HRC, 0, "HRC"},\
    {SOC_BLK_MACSECD, 0, "MACSECD"},\
    {SOC_BLK_MACSECS, 0, "MACSECS"},\
    {SOC_BLK_NONE,       0,  ""      }}
