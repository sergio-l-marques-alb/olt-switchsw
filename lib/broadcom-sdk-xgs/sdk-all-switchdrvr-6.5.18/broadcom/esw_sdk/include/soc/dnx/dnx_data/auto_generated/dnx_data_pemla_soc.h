 ...
 */
/**
 * \brief Init default data structure - dnx_data_if_pemla_soc
 * 
 * \param [in] unit - Unit #
 * 
 * \return
 ...
 * Module - 'pemla_soc', Submodule - 'soc', data - 'JR1_MODE'
 ...
 * Module - 'pemla_soc', Submodule - 'soc', data - 'JR2_MODE'
 ...
 * Module - 'pemla_soc', Submodule - 'soc', data - 'system_headers_mode'
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_PEMLA_SOC - SOC:
 * {
 */
/**
 * \brief Interface for pemla_soc soc data
 */
typedef struct
{
    /**
...
/*
 * MODULE INTERFACE DNX_DATA_IF_PEMLA_SOC:
 * {
 */
/**
 * \brief Interface for pemla_soc data
 */
typedef struct
{
    /**
     * Interface for pemla_soc soc data
     */
