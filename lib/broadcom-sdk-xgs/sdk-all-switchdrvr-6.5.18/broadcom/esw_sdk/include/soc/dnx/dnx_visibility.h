...
#define DNX_VISIBILITY_BLOCK_MAX_NOF_LINES         64
...
typedef struct
{
    ...
    int line_size;
    /*
     * Number of maximum size fields in signal data array
     */
    int data_nof;
    /*
     * Pointer to the signal cash data
     */
    char *sig_cash_p[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
    /*
...
typedef struct
{
     ...
     * Cache status - FALSE - need to fetch from HW, TRUE we may read from cache
     */
    int ing_sig_cash_status[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
    int eg_sig_cash_status[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
