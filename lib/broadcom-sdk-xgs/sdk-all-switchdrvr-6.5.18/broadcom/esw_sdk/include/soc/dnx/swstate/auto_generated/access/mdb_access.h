...
/**
 * implemented by: mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_set
 */
typedef int (*mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_set_cb)(
    int unit, uint32 local_lifs_idx_0, uint32 local_lifs_idx_1, int local_lifs);

/**
 * implemented by: mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_get
 */
typedef int (*mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_get_cb)(
    int unit, uint32 local_lifs_idx_0, uint32 local_lifs_idx_1, int *local_lifs);

/**
 * implemented by: mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_alloc
 */
typedef int (*mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_alloc_cb)(
    int unit, uint32 local_lifs_idx_0, uint32 nof_instances_to_alloc_1);

/**
 * implemented by: mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_set
 */
typedef int (*mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_set_cb)(
    int unit, uint32 global_lif_destination_idx_0, int global_lif_destination);

/**
 * implemented by: mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_get
 */
typedef int (*mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_get_cb)(
    int unit, uint32 global_lif_destination_idx_0, int *global_lif_destination);
 ...
 */
typedef struct {
    mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_set_cb set;
    mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_get_cb get;
    mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_alloc_cb alloc;
} mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_cbs;

/**
 * This structure holds the access functions for the variable global_lif_destination
 */
typedef struct {
    mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_set_cb set;
    mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_get_cb get;
} mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_cbs;

/**
 * This structure holds the access functions for the variable eedb_bank_traffic_lock_workaround_t
 */
typedef struct {
    /**
     * Access struct for local_lifs
     */
    mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_cbs local_lifs;
    /**
     * Access struct for global_lif_destination
     */
    mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_cbs global_lif_destination;
} mdb_db_infos_eedb_bank_traffic_lock_workaround_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for eedb_bank_traffic_lock_workaround
     */
    mdb_db_infos_eedb_bank_traffic_lock_workaround_cbs eedb_bank_traffic_lock_workaround;
    /**
