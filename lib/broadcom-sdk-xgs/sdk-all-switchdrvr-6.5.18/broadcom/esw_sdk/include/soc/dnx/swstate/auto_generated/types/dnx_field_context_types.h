...
/**
 * Enum for the available hash actions that can be set/performed
 */
typedef enum {
    /**
     * Invalid value
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_INVALID = -1,
    /**
     * No Hash action to be performed
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_FIRST = 0x0,
    /**
     * No Hash action to be performed
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_NONE = DNX_FIELD_CONTEXT_HASH_ACTION_FIRST,
    /**
     * Hash action replace CRC
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_REPLACE_CRC16 = 0x1,
    /**
     * Hash action augment CRC
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_AUGMENT_CRC16 = 0x2,
    /**
     * Hash action augment key J
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_AUGMENT_KEY_J = 0x3,
    /**
     * Nof hash action elements
     */
    DNX_FIELD_CONTEXT_HASH_ACTION_NOF
} dnx_field_context_hash_action_e;

/**
 * Enum for the available CRC Select values that can be set/performed
 */
typedef enum {
    /**
     * Invalid value
     */
    DNX_FIELD_CRC_SELECT_INVALID = -1,
    /**
     * First (indexer)
     */
    DNX_FIELD_CRC_SELECT_FIRST = 0x0,
    /**
     * CRC16 with polynomial 0x10039
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X10039 = DNX_FIELD_CRC_SELECT_FIRST,
    /**
     * CRC16 with polynomial 0x100d7
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X100d7 = 0x1,
    /**
     * CRC16 with polynomial 0x1015d
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X1015d = 0x2,
    /**
     * CRC16 with polynomial 0x10939
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X10939 = 0x3,
    /**
     * CRC16 with polynomial 0x109e7
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X109e7 = 0x4,
    /**
     * CRC16 with polynomial 0x10ac5
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X10ac5 = 0x5,
    /**
     * CRC16 with polynomial 0x1203d
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X1203d = 0x6,
    /**
     * CRC16 with polynomial 0x12105
     */
    DNX_FIELD_CRC_SELECT_CRC16_0X12105 = 0x7,
    /**
     * Nof CRC Select elements
     */
    DNX_FIELD_CRC_SELECT_NOF
} dnx_field_crc_select_e;
...
typedef struct {
    ...
    /**
     * Whether the key for hasing was set
     */
    uint8 is_set;
    /**
     * State Table key id
