...
typedef enum {
     ...
     */
    DNX_FIELD_TCAM_BANK_MODE_RESTRICTED_DT = 3,
    /**
     * Number of TCAM bank modes
     */
    DNX_FIELD_TCAM_BANK_MODE_COUNT = 4
