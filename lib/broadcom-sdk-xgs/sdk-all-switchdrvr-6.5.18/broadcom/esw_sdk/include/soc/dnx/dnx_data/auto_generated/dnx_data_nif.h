 ...
 */
typedef uint32(
    *dnx_data_nif_global_max_nif_rate_per_core_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_nif_global_nof_nif_ports_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of max_nif_rate_per_core
     */
    dnx_data_nif_global_max_nif_rate_per_core_get_f max_nif_rate_per_core_get;
    /**
     * returns define data of nof_nif_ports
     */
    dnx_data_nif_global_nof_nif_ports_get_f nof_nif_ports_get;
    /**
...
/**
 * \brief Holds values of submodule ilkn table fec_units
 * Table info:
...
typedef struct
{
     ...
     * Base FEC unit Id
     */
    uint32 base_fec_unit;
} dnx_data_nif_ilkn_fec_units_t;
 ...
 */
typedef uint32(
    *dnx_data_nif_ilkn_is_56G_speed_supported_get_f) (
    int unit);
 ...
 *   * None
 */
typedef const dnx_data_nif_ilkn_fec_units_t *(
    *dnx_data_nif_ilkn_fec_units_get_f) (
    int unit,
    int base_lane);
...
typedef struct
{
    ...
    /**
     * returns define data of is_56G_speed_supported
     */
    dnx_data_nif_ilkn_is_56G_speed_supported_get_f is_56G_speed_supported_get;
    /**
    ...
    /**
     * get table fec_units entry 
     */
    dnx_data_nif_ilkn_fec_units_get_f fec_units_get;
    /**
     * get general info table about table (for example key size)fec_units info
     */
    dnxc_data_table_info_get_f fec_units_info_get;
...
typedef enum
{
    ...
    /**
     * Indicates if the rx port mode should be configured.
     */
 ...
 */
typedef uint32(
    *dnx_data_nif_eth_average_ipg_in_bits_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of average_ipg_in_bits
     */
    dnx_data_nif_eth_average_ipg_in_bits_get_f average_ipg_in_bits_get;
    /**
...
/**
 * \brief Holds values of submodule flexe table mac_tx_threshold_table
 * Table info:
...
typedef struct
{
    ...
    uint32 speed;
    /**
     * TX threshold for tiny_mac
     */
    uint32 tx_thr;
} dnx_data_nif_flexe_mac_tx_threshold_table_t;
 ...
 *   * None
 */
typedef const dnx_data_nif_flexe_mac_tx_threshold_table_t *(
    *dnx_data_nif_flexe_mac_tx_threshold_table_get_f) (
    int unit,
    int idx);
...
typedef struct
{
    ...
    dnxc_data_table_info_get_f start_tx_threshold_table_info_get;
    /**
     * get table mac_tx_threshold_table entry 
     */
    dnx_data_nif_flexe_mac_tx_threshold_table_get_f mac_tx_threshold_table_get;
    /**
     * get general info table about table (for example key size)mac_tx_threshold_table info
     */
    dnxc_data_table_info_get_f mac_tx_threshold_table_info_get;
    /**
...
{
    /**
     * The dynamic transitions to/from PM configuration 0122 should be disabled ,(HWJERICHO2C-1264).
     */
    dnx_data_nif_hw_workarounds_pm_mode_0122_invalid,

    /**
     * Must be last one!
     */
    _dnx_data_nif_hw_workarounds_feature_nof
} dnx_data_nif_hw_workarounds_feature_e;
 ...
 */
typedef int(
    *dnx_data_nif_hw_workarounds_feature_get_f) (
    int unit,
    dnx_data_nif_hw_workarounds_feature_e feature);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_NIF - HW_WORKAROUNDS:
 * {
 */
/**
 * \brief Interface for nif hw_workarounds data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_nif_hw_workarounds_feature_get_f feature_get;
} dnx_data_if_nif_hw_workarounds_t;
...
typedef struct
{
    ...
    /**
     * Interface for nif hw_workarounds data
     */
    dnx_data_if_nif_hw_workarounds_t hw_workarounds;
} dnx_data_if_nif_t;
