 ...
 *   * None
 */
int dnx_data_qos_hw_bug_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_qos_hw_bug_define_phb_rm_ffc_bits_width,

    /**
     * Must be last one!
     */
    _dnx_data_qos_hw_bug_define_nof
} dnx_data_qos_hw_bug_define_e;
 ...
 *   * None
 */
uint32 dnx_data_qos_hw_bug_phb_rm_ffc_bits_width_get(
    int unit);
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_qos_hw_bug_table_nof
} dnx_data_qos_hw_bug_table_e;
