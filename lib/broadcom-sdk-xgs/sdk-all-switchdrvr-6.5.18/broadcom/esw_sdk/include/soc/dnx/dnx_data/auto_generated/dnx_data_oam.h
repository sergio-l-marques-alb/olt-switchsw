...
{
    /**
     * HW bug: oam_offset is not used - JR2_A0 only!  Works for B0 and up
     */
    dnx_data_oam_hw_bug_oam_offset_supported,
    /**
     * HW bug: oam statistics is not used - JR2_A0 only!  Works for B0 and up
     */
    dnx_data_oam_hw_bug_oam_statistics_supported,
    /**
     * HW bug: there needs to be a configuration per OAM-Sub-Type to either use the calculated lm_read_index, or set it to NULL. - JR2_A0 only!
     */
    ...
    /**
     * HW bug: OAMP transmission rate is not accurate on JR2_A0 device
     */
    dnx_data_oam_hw_bug_oamp_tx_rate_limitation,
    /**
     * HW bug: OAMP RMEP ID is not stamped on protection packets - JR2_A0 only! Works for B0 and up
     */
    dnx_data_oam_hw_bug_oamp_protection_rmep_id_limitation,
    /**
     * HW bug: OAMP reply with wrong vlan fields. Works for J2P and above
     */
    dnx_data_oam_hw_bug_oamp_generic_response_supported,
    /**
     * HW bug: OAMP TXM cannot support all banks - JR2 only! Applcable for Q2A aswell, because of low frequency
     */
    dnx_data_oam_hw_bug_oamp_txm_bank_limitation,
