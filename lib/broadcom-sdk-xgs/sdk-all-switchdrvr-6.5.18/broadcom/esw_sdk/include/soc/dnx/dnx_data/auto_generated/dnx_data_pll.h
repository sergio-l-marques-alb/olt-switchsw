...
/**
 * \brief Holds values of submodule pll3 table nif_pll
 * Table info:
...
typedef struct
{
     ...
     */
    int out_freq;
} dnx_data_pll_pll3_nif_pll_t;

/**
 * \brief Holds values of submodule pll3 table fabric_pll
 * Table info:
...
typedef struct
{
     ...
     */
    int out_freq;
} dnx_data_pll_pll3_fabric_pll_t;
 ...
 * 
 * \return
 *     nif_pll - returns the relevant entry values grouped in struct - see dnx_data_pll_pll3_nif_pll_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef const dnx_data_pll_pll3_nif_pll_t *(
    *dnx_data_pll_pll3_nif_pll_get_f) (
    int unit,
    int pll_index);
 ...
 * 
 * \return
 *     fabric_pll - returns the relevant entry values grouped in struct - see dnx_data_pll_pll3_fabric_pll_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef const dnx_data_pll_pll3_fabric_pll_t *(
    *dnx_data_pll_pll3_fabric_pll_get_f) (
    int unit,
    int pll_index);
...
typedef struct
{
     ...
     */
    dnx_data_pll_pll3_nif_pll_get_f nif_pll_get;
    /**
     ...
     */
    dnx_data_pll_pll3_fabric_pll_get_f fabric_pll_get;
    /**
