...
typedef enum
{
     ...
     */
    dnx_data_l2_hw_bug_age_out_and_refresh_profile_selection,
    /**
     * Age machine stops working after flush runs
     */
    dnx_data_l2_hw_bug_age_machine_pause_after_flush,
    /**
     * Age state of l2 entries is not updated
     */
    dnx_data_l2_hw_bug_age_state_not_updated,
    /**
     * AppDB ID is wrongly taken from the 4 MSBs like in Jericho
     */
    dnx_data_l2_hw_bug_appdb_id_for_olp,
    /**
     * Parser Ethernet qualifier is_mc is set correctly
     */
    dnx_data_l2_hw_bug_eth_qual_is_mc,
    /**
     * Destination of BC packets should be the same as unknown-MC packets
     */
    dnx_data_l2_hw_bug_bc_same_as_unknown_mc,
    /**
     * Bug in ecc calculation in the MACT
     */
    dnx_data_l2_hw_bug_fid_mgmt_ecc_error,
    /**
     * No interrupt is raised for fid limit cross
     */
    dnx_data_l2_hw_bug_wrong_limit_interrupt_handling,
    /**
     * Transplant event is created instead of refresh event
     */
    dnx_data_l2_hw_bug_transplant_instead_of_refresh,
    /**
     * Static mac entries age out and deleted
     */
    dnx_data_l2_hw_bug_static_mac_age_out,
    /**
     * For limit check the vmv is taken from the wrong side of the mdb entry
     */
    dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location,
    /**
     * L2 limit causes supression of events related to existing entries (eg transplant/refresh)
     */
    dnx_data_l2_hw_bug_learn_limit,
    /**
     * Counters are not updated correctly in limit per LIF mode. Delete from host fails to update the correct counter (HWJERICHO2-2023)
     */
    dnx_data_l2_hw_bug_limit_per_lif_counters,
    /**
     * LEL generates learn events with INSERT command instead of LEARN (HWJERICHO2-2617)
     */
    dnx_data_l2_hw_bug_learn_events_wrong_command,

    /**
     * Must be last one!
     */
    _dnx_data_l2_hw_bug_feature_nof
} dnx_data_l2_hw_bug_feature_e;
 ...
 */
typedef int(
    *dnx_data_l2_hw_bug_feature_get_f) (
    int unit,
    dnx_data_l2_hw_bug_feature_e feature);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_L2 - HW_BUG:
 * {
 */
/**
 * \brief Interface for l2 hw_bug data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_l2_hw_bug_feature_get_f feature_get;
} dnx_data_if_l2_hw_bug_t;
...
typedef struct
{
    ...
    /**
     * Interface for l2 hw_bug data
     */
    dnx_data_if_l2_hw_bug_t hw_bug;
    /**
