...
/*
 * SUBMODULE  - HW_BUG:
 * Bugs related to system header construction
 * {
 */
/*
 * Table value structure
...
typedef enum
{
     ...
     */
    dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei,
    /**
     * If set, FAI[0] indicates forwarding lookup result, else FAI[0] is not for unknown address
     */
    dnx_data_headers_hw_bug_unknown_address,

    /**
     * Must be last one!
     */
    _dnx_data_headers_hw_bug_feature_nof
} dnx_data_headers_hw_bug_feature_e;
 ...
 */
typedef int(
    *dnx_data_headers_hw_bug_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_headers_hw_bug_fhei_mpls_swap_remark_profile_size_get_f) (
    int unit);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - HW_BUG:
 * {
 */
/**
 * \brief Interface for headers hw_bug data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_headers_hw_bug_feature_get_f feature_get;
    /**
     * returns define data of fhei_mpls_swap_remark_profile_size
     */
    dnx_data_headers_hw_bug_fhei_mpls_swap_remark_profile_size_get_f fhei_mpls_swap_remark_profile_size_get;
} dnx_data_if_headers_hw_bug_t;
...
typedef struct
{
    ...
    /**
     * Interface for headers hw_bug data
     */
    dnx_data_if_headers_hw_bug_t hw_bug;
