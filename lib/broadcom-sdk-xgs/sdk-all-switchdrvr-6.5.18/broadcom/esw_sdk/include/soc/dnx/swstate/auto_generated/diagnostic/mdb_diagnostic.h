...
typedef enum {
    ...
    MDB_DB_INFOS_EEDB_BANK_TRAFFIC_LOCK_WORKAROUND_INFO,
...
int mdb_db_infos_mdb_cluster_infos_macro_a_cluster_cache_dump(
    int unit, int macro_a_cluster_cache_idx_0, int macro_a_cluster_cache_idx_1, int macro_a_cluster_cache_idx_2, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_mdb_cluster_infos_macro_b_cluster_cache_dump(
    int unit, int macro_b_cluster_cache_idx_0, int macro_b_cluster_cache_idx_1, int macro_b_cluster_cache_idx_2, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_mdb_cluster_infos_eedb_banks_cache_dump(
    int unit, int eedb_banks_cache_idx_0, int eedb_banks_cache_idx_1, int eedb_banks_cache_idx_2, dnx_sw_state_dump_filters_t filters);
...
int mdb_db_infos_eedb_bank_traffic_lock_workaround_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_eedb_bank_traffic_lock_workaround_local_lifs_dump(
    int unit, int local_lifs_idx_0, int local_lifs_idx_1, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_eedb_bank_traffic_lock_workaround_global_lif_destination_dump(
