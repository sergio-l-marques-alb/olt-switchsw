 ...
 */
typedef uint32(
    *dnx_data_lif_global_lif_wa_null_lif_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of wa_null_lif
     */
    dnx_data_lif_global_lif_wa_null_lif_get_f wa_null_lif_get;
    /**
 ...
 */
typedef uint32(
    *dnx_data_lif_out_lif_nof_outlifs_in_eedb_banks_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of nof_outlifs_in_eedb_banks
     */
    dnx_data_lif_out_lif_nof_outlifs_in_eedb_banks_get_f nof_outlifs_in_eedb_banks_get;
    /**
...
typedef enum
{
     ...
     */
    dnx_data_lif_hw_bug_iop_mode_outlif_selection,
    /**
     * IOP mode incorrect lif profile key selection for orientation
     */
    dnx_data_lif_hw_bug_iop_mode_orientation_selection,

    /**
     * Must be last one!
     */
    _dnx_data_lif_hw_bug_feature_nof
} dnx_data_lif_hw_bug_feature_e;
 ...
 */
typedef int(
    *dnx_data_lif_hw_bug_feature_get_f) (
    int unit,
    dnx_data_lif_hw_bug_feature_e feature);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_LIF - HW_BUG:
 * {
 */
/**
 * \brief Interface for lif hw_bug data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_lif_hw_bug_feature_get_f feature_get;
} dnx_data_if_lif_hw_bug_t;
...
typedef struct
{
    ...
    /**
     * Interface for lif hw_bug data
     */
    dnx_data_if_lif_hw_bug_t hw_bug;
} dnx_data_if_lif_t;
