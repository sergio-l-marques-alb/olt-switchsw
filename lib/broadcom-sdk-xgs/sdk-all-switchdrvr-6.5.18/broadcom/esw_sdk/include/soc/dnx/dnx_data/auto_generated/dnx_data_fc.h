...
/**
 * \brief returns define data of nof_supported_vlan_ids
 * Module - 'fc', Submodule - 'coe', data - 'nof_supported_vlan_ids'
 * Number of supported VLAN IDs in PP COE flow control
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_supported_vlan_ids - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of nof_supported_vlan_ids
     */
