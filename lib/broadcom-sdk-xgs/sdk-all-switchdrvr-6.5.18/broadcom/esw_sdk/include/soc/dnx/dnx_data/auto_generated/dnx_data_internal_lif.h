...
typedef enum
{
    ...
    dnx_data_lif_global_lif_define_wa_null_lif,
...
/**
 * \brief returns define data of wa_null_lif
 * Module - 'lif', Submodule - 'global_lif', data - 'wa_null_lif'
 * ERPP GLEM trap requires NULL LIF to be added to GLEM by default.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     wa_null_lif - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_lif_global_lif_wa_null_lif_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks,
...
/**
 * \brief returns define data of nof_outlifs_in_eedb_banks
 * Module - 'lif', Submodule - 'out_lif', data - 'nof_outlifs_in_eedb_banks'
 * The estimated number of entries that are stored in eedb banks.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_outlifs_in_eedb_banks - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_lif_out_lif_nof_outlifs_in_eedb_banks_get(
    int unit);
 ...
 *   * None
 */
int dnx_data_lif_hw_bug_feature_get(
    int unit,
    dnx_data_lif_hw_bug_feature_e feature);
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_lif_hw_bug_define_nof
} dnx_data_lif_hw_bug_define_e;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_lif_hw_bug_table_nof
} dnx_data_lif_hw_bug_table_e;
