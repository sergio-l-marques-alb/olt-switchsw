...
typedef enum
{
    ...
    dnx_data_pll_pll3_table_nif_pll,
    dnx_data_pll_pll3_table_fabric_pll,
 ...
 *   * None
 */
const dnx_data_pll_pll3_nif_pll_t * dnx_data_pll_pll3_nif_pll_get(
    int unit,
    int pll_index);
 ...
 *   * None
 */
const dnx_data_pll_pll3_fabric_pll_t * dnx_data_pll_pll3_fabric_pll_get(
    int unit,
    int pll_index);
 ...
 *   * None
 */
shr_error_e dnx_data_pll_pll3_nif_pll_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
 ...
 *   * None
 */
shr_error_e dnx_data_pll_pll3_fabric_pll_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
 ...
 *   * None
 */
const dnxc_data_table_info_t * dnx_data_pll_pll3_nif_pll_info_get(
    int unit);
 ...
 *   * None
 */
const dnxc_data_table_info_t * dnx_data_pll_pll3_fabric_pll_info_get(
    int unit);
