...
typedef enum
{
    ...
    dnx_data_debug_submodule_hw_bug,
 ...
 *   * None
 */
int dnx_data_debug_hw_bug_feature_get(
    int unit,
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_debug_hw_bug_define_nof
} dnx_data_debug_hw_bug_define_e;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_debug_hw_bug_table_nof
} dnx_data_debug_hw_bug_table_e;
