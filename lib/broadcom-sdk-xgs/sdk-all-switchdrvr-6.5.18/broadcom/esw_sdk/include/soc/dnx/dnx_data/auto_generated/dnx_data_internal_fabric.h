...
typedef enum
{
    ...
    dnx_data_fabric_cgm_define_egress_drop_low_prio_mc_th_clocks_resolution,
 ...
 *   * None
 */
uint32 dnx_data_fabric_cgm_egress_drop_low_prio_mc_th_clocks_resolution_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_fabric_dbal_define_mesh_topology_status_2_id1_bits_nof,
 ...
 *   * None
 */
uint32 dnx_data_fabric_dbal_mesh_topology_status_2_id1_bits_nof_get(
    int unit);
