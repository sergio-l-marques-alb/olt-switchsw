...
typedef enum
{
     ...
     */
    dnx_data_debug_hw_bug_no_hit_bit_on_mdb_access,
    /**
     * If set, indicates that need to run a specific flow that fix bug in VT3-PEM
     */
    dnx_data_debug_hw_bug_pem_vt_init_fix,
    /**
     * If set, indicates that IParser signals are valid
     */
    dnx_data_debug_hw_bug_iparser_signals_valid,
    /**
     * If set, indicates that fwd_action_* signals from LBP stage are valid
     */
    dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid,

    /**
     * Must be last one!
     */
    _dnx_data_debug_hw_bug_feature_nof
} dnx_data_debug_hw_bug_feature_e;
 ...
 */
typedef int(
    *dnx_data_debug_hw_bug_feature_get_f) (
    int unit,
    dnx_data_debug_hw_bug_feature_e feature);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_DEBUG - HW_BUG:
 * {
 */
/**
 * \brief Interface for debug hw_bug data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_debug_hw_bug_feature_get_f feature_get;
} dnx_data_if_debug_hw_bug_t;
...
typedef struct
{
    ...
    /**
     * Interface for debug hw_bug data
     */
    dnx_data_if_debug_hw_bug_t hw_bug;
    /**
