...
/**
 * \brief returns define data of egress_drop_low_prio_mc_th_clocks_resolution
 * Module - 'fabric', Submodule - 'cgm', data - 'egress_drop_low_prio_mc_th_clocks_resolution'
 * Clocks resolution in HW
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     egress_drop_low_prio_mc_th_clocks_resolution - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_fabric_cgm_egress_drop_low_prio_mc_th_clocks_resolution_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of egress_drop_low_prio_mc_th_clocks_resolution
     */
    dnx_data_fabric_cgm_egress_drop_low_prio_mc_th_clocks_resolution_get_f egress_drop_low_prio_mc_th_clocks_resolution_get;
    /**
...
/**
 * \brief returns define data of mesh_topology_status_2_id1_bits_nof
 * Module - 'fabric', Submodule - 'dbal', data - 'mesh_topology_status_2_id1_bits_nof'
 * number of bits in mesh topology status 2 id1
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     mesh_topology_status_2_id1_bits_nof - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_fabric_dbal_mesh_topology_status_2_id1_bits_nof_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of mesh_topology_status_2_id1_bits_nof
     */
    dnx_data_fabric_dbal_mesh_topology_status_2_id1_bits_nof_get_f mesh_topology_status_2_id1_bits_nof_get;
    /**
 ...
 * 
 * \param [in] unit - unit #
 * \param [in] pdq_priority - PDQ priority (0=HP, 1=LP)
