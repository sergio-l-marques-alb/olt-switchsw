 ...
 */
typedef uint32(
    *dnx_data_dev_init_cmc_pci_cmc_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_dev_init_cmc_pci_cmcs_num_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of pci_cmc
     */
    dnx_data_dev_init_cmc_pci_cmc_get_f pci_cmc_get;
    /**
     * returns numeric data of pci_cmcs_num
     */
    dnx_data_dev_init_cmc_pci_cmcs_num_get_f pci_cmcs_num_get;
