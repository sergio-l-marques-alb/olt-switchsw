...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_tunnel_general_feature_nof
} dnx_data_tunnel_general_feature_e;
 ...
 */
typedef int(
    *dnx_data_tunnel_general_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_tunnel_general_esem_cmd_arr_prefix_gre_any_ipv4_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_tunnel_general_esem_cmd_arr_prefix_vxlan_gpe_get_f) (
    int unit);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_TUNNEL - GENERAL:
 * {
 */
/**
 * \brief Interface for tunnel general data
 */
typedef struct
{
    /**
     ...
     */
    dnx_data_tunnel_general_feature_get_f feature_get;
    /**
     * returns define data of esem_cmd_arr_prefix_gre_any_ipv4
     */
    dnx_data_tunnel_general_esem_cmd_arr_prefix_gre_any_ipv4_get_f esem_cmd_arr_prefix_gre_any_ipv4_get;
    /**
     * returns define data of esem_cmd_arr_prefix_vxlan_gpe
     */
    dnx_data_tunnel_general_esem_cmd_arr_prefix_vxlan_gpe_get_f esem_cmd_arr_prefix_vxlan_gpe_get;
} dnx_data_if_tunnel_general_t;
...
{
    /**
     * Interface for tunnel general data
     */
    dnx_data_if_tunnel_general_t general;
    /**
