...
typedef struct
{
    ...
    int is_kbp;
    /**
     * true iff it is cross connect port
     */
    int is_cross_connect;
    /**
     * true iff it is FlexE physical port
     */
    int is_flexe_phy;
    /**
...
typedef struct
{
    ...
    /**
     * returns numeric data of nof_tm_ports
     */
    dnx_data_port_general_nof_tm_ports_get_f nof_tm_ports_get;
    /**
     * returns numeric data of nof_tm_ports_per_fap_id
     */
