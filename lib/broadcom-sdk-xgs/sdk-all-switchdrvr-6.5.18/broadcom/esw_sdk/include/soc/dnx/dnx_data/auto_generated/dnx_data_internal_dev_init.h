...
typedef enum
{
    dnx_data_dev_init_cmc_define_pci_cmc,
    dnx_data_dev_init_cmc_define_pci_cmcs_num,
...
/* Get Data */
/**
 * \brief returns numeric data of pci_cmc
 * Module - 'dev_init', Submodule - 'cmc', data - 'pci_cmc'
 * CMC in CMICx used by the PCI Host
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     pci_cmc - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_dev_init_cmc_pci_cmc_get(
    int unit);

/**
 * \brief returns numeric data of pci_cmcs_num
 * Module - 'dev_init', Submodule - 'cmc', data - 'pci_cmcs_num'
 * Number of CMCs used by the PCI Host
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     pci_cmcs_num - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_dev_init_cmc_pci_cmcs_num_get(
    int unit);
