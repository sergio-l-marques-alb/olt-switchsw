...
extern int soc_cmic_uc_msg_send_receive(int unit, int uC, mos_msg_data_t *send,
                                        ...
                                        sal_usecs_t timeout);
#ifdef BCM_CMICX_SUPPORT
extern int soc_cmic_uc_msg64_send(int unit, int uC, mos_msg64_data_t *msg,
                                sal_usecs_t timeout);
extern int soc_cmic_uc_msg64_receive(int unit, int uC, uint8 mclass,
                                   mos_msg64_data_t *msg, int timeout);
extern int soc_cmic_uc_msg64_send_receive(int unit, int uC, mos_msg64_data_t *send,
                                        mos_msg64_data_t *reply,
                                        sal_usecs_t timeout);
#endif
