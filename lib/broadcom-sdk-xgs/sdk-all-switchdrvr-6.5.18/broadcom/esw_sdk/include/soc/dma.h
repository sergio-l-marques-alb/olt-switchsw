...
extern int cmicx_pcie_hotswap_handling(int unit, uint32 flags);

/* flags for cmicx_pcie_hotswap_handling() */
#define CMICX_PCIE_HOTSWAP_HANDLING_FLAG_DONOT_ABORT 1 /* Do not abort DMA operations, as they were already aborted */
#define CMICX_PCIE_HOTSWAP_HANDLING_FLAG_DONOT_DISABLE_INTERRUPTS 2 /* Do not disable PAXB interrupts */
