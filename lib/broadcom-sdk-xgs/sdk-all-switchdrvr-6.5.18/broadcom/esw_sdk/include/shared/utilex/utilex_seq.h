...
typedef struct
{
    ...
    /**
     * Amount of time each failed step took
     */
    int fail_time[UTILEX_SEQ_NOF_FAILED_STEPS];
    ...
    int fail_step_id[UTILEX_SEQ_NOF_FAILED_STEPS];
    /**
     * Time thresholds of the failed steps
     */
    int fail_step_thresh[UTILEX_SEQ_NOF_FAILED_STEPS];
