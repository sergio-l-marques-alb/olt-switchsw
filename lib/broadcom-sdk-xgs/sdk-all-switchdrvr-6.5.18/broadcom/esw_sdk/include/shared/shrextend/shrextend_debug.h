...
#define LOG_DEBUG_EX(_log_module,_format_string, _p1,_p2,_p3,_p4)  \
  LOG_DEBUG(_log_module,                                               \
    (BSL_META_U(_func_unit,":%d,%s(),"),__LINE__,__FUNCTION__)) ;      \
  LOG_DEBUG(_log_module,                                               \
    (BSL_META_U(_func_unit,_format_string),_p1,_p2,_p3,_p4))
/**
...
#define SHR_FUNC_INIT_VARS(_unit)    \
  ...
  DNXC_MTA(dnxc_multithread_analyzer_declare_api_in_play(_unit, __FUNCTION__, MTA_FLAG_SHR_INIT_FUNC, TRUE));
...
#define SHR_FUNC_EXIT                                                 \
  DNXC_MTA(dnxc_multithread_analyzer_declare_api_in_play(_func_unit, __FUNCTION__, MTA_FLAG_SHR_INIT_FUNC, FALSE)); \
  return _func_rv
