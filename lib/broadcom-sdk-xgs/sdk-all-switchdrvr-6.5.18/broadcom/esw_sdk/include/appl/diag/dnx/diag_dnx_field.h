 ...
 *************/
/*
 * Local definition for this procedure: Number of columns assigned to 'key identifiers' ('key id' and 'key name')
 * Specific for dnx_field_diag_display_key_occupation() and dnx_field_diag_display_key_occupation_partial()
 */
#define NUM_KEY_IDENTIFIER_CELLS 2
...
/**
 * \brief
 * Enum for option requiring all 'range types'
 */
extern sh_sand_enum_t Field_range_type_enum_table[];
 ...
 *  for specified field group type and stage.
 ...
 *     See dnx_field_diag_display_key_occupation_partial() for printing of cells only!
 *   * Output of this procedure is keys occupation as stored on SW state.
 * \see
 *   * dnx_field_diag_display_key_occupation_partial()
 */
shr_error_e dnx_field_diag_display_key_occupation(
    int unit,
 ...
 *     See dnx_field_diag_display_key_occupation() for printing full table!
 *   * Output of this procedure is keys occupation as stored on SW state.
 * \see
 *   * dnx_field_diag_display_key_occupation()
 */
shr_error_e dnx_field_diag_display_key_occupation_partial(
    int unit,
    dnx_field_stage_e field_stage,
    dnx_field_context_t context_id,
 ...
 *   * dnx_field_diag_display_key_occupation_partial()
 */
shr_error_e dnx_field_diag_display_bit_range_occupation_partial(
    int unit,
    dnx_field_stage_e field_stage,
    dnx_field_context_t context_id,
    uint8 *add_new_stage_p,
