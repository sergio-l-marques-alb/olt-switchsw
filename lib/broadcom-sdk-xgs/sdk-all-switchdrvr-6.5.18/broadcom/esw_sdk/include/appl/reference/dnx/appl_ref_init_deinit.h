...
typedef enum
{
    ...
    /**
     * MDB EM FALSE HIT WA application
     */
    ...
    /**
     * IPMC INLIF  WA enable application
     */
    APPL_DNX_STEP_FP_WA_IPMC_INLIF,
    /**
     ...
     */
    APPL_DNX_STEP_FP_WA_LEARN_AND_LIMIT,
    /**
     * J1 MPLS PHP application
     */
    APPL_DNX_STEP_FP_WA_J1_PHP,
    /**
