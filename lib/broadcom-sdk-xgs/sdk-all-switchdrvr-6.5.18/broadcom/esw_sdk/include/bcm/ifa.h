...
/* Maximum number of queues supported by IFA-LEAP Eapp. */
#define BCM_IFA_LEAP_MAX_NUM_QUEUE  0x200      

/* 
 * Macro for bcm_ifa_leap_config_info _t flag to indicate usage of
 * QUEUE_ID, INT_PRI and CLASS_ID.
 */
#define BCM_IFA_LEAP_QUEUE_ID_INT_PRI       0x1        
#define BCM_IFA_LEAP_QUEUE_ID_INT_PRI_CLASS_ID 0x2        

/* IFA-LEAP Configuration information. */
typedef struct bcm_ifa_leap_config_s {
    uint8 flag;                         /* Indicate usage of queue_id, int_pri
                                           and class_id. */
    uint16 num_gports;                  /* Number of gports to be monitor by
                                           IFA-LEAP App. */
    uint8 class_id[BCM_IFA_LEAP_MAX_NUM_QUEUE]; /* Array of Class_ID assicated with
                                           Queue ID. */
    uint16 int_pri[BCM_IFA_LEAP_MAX_NUM_QUEUE]; /* Array of INT_PRI assicated with Queue
                                           ID. */
    bcm_gport_t gport_list[BCM_IFA_LEAP_MAX_NUM_QUEUE]; /* Array of gports that are being
                                           monitored by IFA-LEAP App. */
} bcm_ifa_leap_config_t;

/* Initialize ifa leap config structure. */
extern void bcm_ifa_leap_config_t_init(
    bcm_ifa_leap_config_t *config_info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set IFA-LEAP Configuration. */
extern int bcm_ifa_leap_config_set(
    int unit, 
    bcm_ifa_leap_config_t *config_data);

/* Get IFA-LEAP Configuration. */
extern int bcm_ifa_leap_config_get(
    int unit, 
    bcm_ifa_leap_config_t *config_data);
