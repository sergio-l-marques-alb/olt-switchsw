...
typedef enum bcm_flexdigest_match_e {
    ...
    bcmFlexDigestMatchCount = 73        /* Always last. Not a usable value. */
...
#define BCM_FLEXDIGEST_FIELD_OUTER_UDF_ONE_BYTE_2 135        /* The outer UDF one byte
                                                          container 2. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_0 136        /* The inner UDF two
                                                          bytes container 0. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_1 137        /* The inner UDF two
                                                          bytes container 1. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_2 138        /* The inner UDF two
                                                          bytes container 2. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_3 139        /* The inner UDF two
                                                          bytes container 3. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_4 140        /* The inner UDF two
                                                          bytes container 4. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_5 141        /* The inner UDF two
                                                          bytes container 5. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_6 142        /* The inner UDF two
                                                          bytes container 6. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_7 143        /* The inner UDF two
                                                          bytes container 7. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_8 144        /* The inner UDF two
                                                          bytes container 8. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_TWO_BYTE_9 145        /* The inner UDF two
                                                          bytes container 9. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_ONE_BYTE_0 146        /* The inner UDF one byte
                                                          container 0. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_ONE_BYTE_1 147        /* The inner UDF one byte
                                                          container 1. */
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_ONE_BYTE_2 148        /* The inner UDF one byte
                                                          container 2. */
