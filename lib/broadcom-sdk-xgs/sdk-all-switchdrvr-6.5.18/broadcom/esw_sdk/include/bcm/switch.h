...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchEcmpDynamicHashBitCountSelect = 1326, /* To specify the number of bits
                                           ...
                                           function */
    bcmSwitchIoamE2EType = 1327,        /* IOAM E2E Type. */
    ...
    bcmSwitchIoamNameSpaceId = 1329,    /* Value of NAMESPACE_ID field in IOAM
                                           payload to match. */
    bcmSwitchIoamProtocol = 1330,       /* Protocol value to identify IOAM
                                           header. */
    bcmSwitchIoamE2EProtocol = 1331,    /* Protocol value to identify IOAM E2E
                                           header. */
    ...
    bcmSwitchL2ApplCallbackSuppress = 1335, /* BCM56980 Enable/Disable suppression
                                           of application ca
                                           llbacks for L2 entries added/deleted
                                           through
                                           bcm_l2_addr_add/bcm_l2_addr_delete
                                           APIs. This feature is disabled by
                                           default */
    bcmSwitch__Count = 1336             /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_hash_bank_e {
    ...
    bcmSwitchHashBankCount = 24 /* Must Be Last. Not A Valid Hash Bank. */
...
/* ISSU upgrade done. */
extern int bcm_switch_issu_upgrade_done(
);
...
typedef enum bcm_switch_l3_tunnel_e {
    ...
    bcmSwitchL3TunnelCount = 2  /* Count */
...
typedef struct bcm_switch_appl_signature_info_s {
    ...
    uint16 l4protocol_port_mask;        /* L4 Protocol port mask */
