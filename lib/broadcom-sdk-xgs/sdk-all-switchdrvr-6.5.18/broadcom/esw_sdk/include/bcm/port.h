...
typedef enum bcm_port_control_e {
    ...
    bcmPortControlLinkFaultRemoteClear = 407, /* Clear the sticky remote_fault_status
                                           bit. */
    bcmPortControlIngressSampleProfile = 408, /* Ingress sample profile id. */
    bcmPortControlPFCFromLLFCEnable = 409, /* Enable/disable LLFC RMC threshold to
                                           generate PFC on the specified port. */
    bcmPortControlFirstHeaderSizeAfterInjected = 410, /* Used to configure the size of the
                                           first header to skip after injected. */
    bcmPortControlFlexeDoubleNbTdmSlotEnable = 411 /* Control the number of slots for FlexE
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_PORT_PON_TUNNEL_UNTAGGED = 47, /*  Mod/port/trunk + PON Tunnel Value +
                                           untagged packets. */
    BCM_PORT_MATCH_COUNT = 48           /* Must be last */
} bcm_port_match_t;
