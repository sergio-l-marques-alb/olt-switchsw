...
typedef enum bcm_trunk_dlb_stat_e {
    bcmTrunkDlbStatFailPackets = 0,     /* Number of packets whose trunk member
                                           can't be resolved through the DLB
                                           mechanism. Packet forwarding will be
                                           based on static trunk resolution when
                                           DLB fails. */
...
/* Set the DLB statistic based on the trunk Id. */
...
/* Get the DLB statistic based on the trunk Id. */
...
/* Get the DLB statistic from the trunk Id with sync mode. */
