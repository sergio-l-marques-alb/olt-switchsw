...
typedef enum bcm_oam_control_type_e {
    ...
    bcmOamControlEnableNextReceivedSlr = 28, /* When set, LM session should not be
                                           ...
                                           entries. */
    bcmOamControlMplsLmQueryControlCode = 29, /* When set, RFC6374 LM PDU will be
                                           configured */
    bcmOamControlMplsLmResponderControlCode = 30, /* When set, RFC6374 LM response PDU
                                           will be configured */
    bcmOamControlMplsDmQueryControlCode = 31, /* When set, RFC6374 DM PDU will be
                                           configured */
    bcmOamControlMplsDmResponderControlCode = 32, /* When set, RFC6374 DM response PDU
                                           will be configured */
    bcmOAMControlCount = 33             /* Always Last. Not a usable value. */
