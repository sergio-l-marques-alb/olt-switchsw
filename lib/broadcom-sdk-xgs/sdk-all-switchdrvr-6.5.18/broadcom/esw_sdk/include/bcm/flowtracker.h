...
typedef enum bcm_flowtracker_timestamp_source_e {
    ...
    bcmFlowtrackerTimestampSourceCheckEvent4 = 13, /* Timestamp captured when event4
                                           happened in checker */
    bcmFlowtrackerTimestampSourceCount = 14 /* Always Last. Not a usable value */
...
typedef enum bcm_flowtracker_export_element_type_e {
    ...
    bcmFlowtrackerExportElementTypeCount = 104 
...
typedef enum bcm_flowtracker_tracking_param_type_e {
    ...
    bcmFlowtrackerTrackingParamTypeCount = 87 
...
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_CLOSED_SYNACK (1 << 1)   /* State Transition for
                                                          TCP from CLOSED on TCP
                                                          Flag SYN+ACK. */
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_SYNWAIT_RST (1 << 2)   /* State Transition for
                                                          TCP from SYNWAIT on
                                                          TCP Flag RST. */
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_SYNWAIT_ACK (1 << 3)   /* State Transition for
                                                          TCP from SYNWAIT on
                                                          TCP Flag ACK. */
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_SYNWAIT_SYNACK (1 << 4)   /* State Transition for
                                                          TCP from SYNWAIT on
                                                          TCP Flag SYN+ACK. */
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_ESTABLISHED_RST (1 << 5)   /* State Transition for
                                                          TCP from ESTABLISHED
                                                          on TCP Flag RST. */
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_ESTABLISHED_FIN (1 << 6)   /* State Transition for
                                                          TCP from ESTABLISHED
                                                          on TCP Flag SYN. */
#define BCM_FLOWTRACKER_STATE_TRANSITION_TCP_CLOSEWAIT_FINACK (1 << 7)   /* State Transition for
                                                          TCP from CLOSEWAIT on
                                                          TCP Flag FIN+ACK. */
...
/* Set a flow check delay information structure. */
...
typedef enum bcm_flowtracker_group_control_type_e {
    ...
    bcmFlowtrackerGroupControlCount = 5 /* Total Count of Group controls. */
...
typedef enum bcm_flowtracker_cpu_notification_e {
    ...
    bcmFlowtrackerCpuNotificationTableFull = 2, /* Notification will be sent to CPU when
...
/* Set flow group's cou notifications. */
extern int bcm_flowtracker_group_cpu_notification_set(
    int unit, 
    bcm_flowtracker_group_t id, 
    bcm_flowtracker_cpu_notification_info_t *info);

/* Get flow group's cou notifications. */
...
typedef enum bcm_flowtracker_group_action_e {
    ...
    bcmFlowtrackerGroupActionCount = 10 /* Always Last. Not a usable value. */
