...
#define BCMI_FT_GROUP_MAX_TS_TYPE                   7
...
extern
bcmi_ft_group_ts_t
        bcmi_ft_group_ts_info[BCMI_FT_GROUP_MAX_TS_TYPE];

#define BCMI_FT_GROUP_TS_PARAM(trig)  \
            (bcmi_ft_group_ts_info[trig].ts_param)

#define BCMI_FT_GROUP_TS_TRIGEER_BIT_SEL(trig)  \
            (bcmi_ft_group_ts_info[trig].ts_trigger_bit_sel)

#define BCMI_FT_GROUP_TS_TRIGEER_SOURCE(trig)  \
            (bcmi_ft_group_ts_info[trig].ts_src)
...
typedef struct bcmi_ft_data_engine_info_s {
    ...
    /* Offset from end in expended form */
