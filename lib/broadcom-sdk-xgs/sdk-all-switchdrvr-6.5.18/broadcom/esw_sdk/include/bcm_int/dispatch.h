...
typedef struct {
	...
	int (*field_range_type_config_get)(int,uint32,bcm_field_context_t,bcm_field_range_config_t,bcm_field_range_qual_info_t *);
	int (*field_range_type_config_set)(int,uint32,bcm_field_context_t,bcm_field_range_config_t,bcm_field_range_qual_info_t *);
	...
	int (*flowtracker_group_cpu_notification_get)(int,bcm_flowtracker_group_t,bcm_flowtracker_cpu_notification_info_t *);
	int (*flowtracker_group_cpu_notification_set)(int,bcm_flowtracker_group_t,bcm_flowtracker_cpu_notification_info_t *);
...
#ifdef	INCLUDE_GDPLL
	int (*gdpll_cb_register)(int,int,bcm_gdpll_cb,void *);
	int (*gdpll_cb_unregister)(int,int);
...
#endif	/* INCLUDE_I2C */
	int (*ifa_collector_attach)(int,bcm_collector_t,int);
	int (*ifa_collector_attach_get)(int,bcm_collector_t *,int *);
	int (*ifa_collector_detach)(int);
	...
	int (*ifa_detach)(int);
	int (*ifa_init)(int);
	int (*ifa_leap_config_get)(int,bcm_ifa_leap_config_t *);
	int (*ifa_leap_config_set)(int,bcm_ifa_leap_config_t *);
	...
	int (*l3_egress_flexctr_obj_val_get)(int,bcm_if_t,uint32 *);
	int (*l3_egress_flexctr_obj_val_set)(int,bcm_if_t,uint32);
	...
	int (*srv6_terminator_next_protocol_add)(int,bcm_srv6_terminator_next_protocol_mapping_t *);
	int (*srv6_terminator_next_protocol_delete)(int,bcm_srv6_terminator_next_protocol_mapping_t *);
	int (*srv6_terminator_next_protocol_get)(int,bcm_srv6_terminator_next_protocol_mapping_t *);
	/* bcm_srv6_terminator_next_protocol_mapping_t_init not dispatchable */
	int (*srv6_terminator_next_protocol_traverse)(int,bcm_srv6_terminator_next_protocol_traverse_info_t,bcm_srv6_terminator_next_protocol_traverse_cb,void *);
