...
typedef struct {
    ...
    /**
     * Profile data for skipping first header size on ETH ports
     */
    dnx_algo_template_t eth_ports_first_header_size_profile_data;
    /**
     * Profile data for skipping first header size on PTCH1 ports
     */
    dnx_algo_template_t ptch1_ports_first_header_size_profile_data;
    /**
     * Profile data for skipping first header size on PTCH2 ports
     */
    dnx_algo_template_t ptch2_ports_first_header_size_profile_data;
    /**
     * Profile data for skipping first header size after injected header on PTCH1 ports
     */
    dnx_algo_template_t ptch1_ports_first_header_size_after_injected_profile_data;
    /**
