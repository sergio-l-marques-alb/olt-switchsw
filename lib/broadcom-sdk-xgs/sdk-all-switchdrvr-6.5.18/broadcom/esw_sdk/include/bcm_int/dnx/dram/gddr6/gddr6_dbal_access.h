...
/**
 * \brief - cadt configure
 *
 * \param [in] unit - unit number
 * \param [in] dram_index - dram index
 * \param [in] cadt_bist_conf - command address training bist configuration
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_gddr6_dbal_access_training_cadt_config_set(
    int unit,
    uint32 dram_index,
    dnx_gddr6_training_cadt_bist_configuration * cadt_bist_conf);
