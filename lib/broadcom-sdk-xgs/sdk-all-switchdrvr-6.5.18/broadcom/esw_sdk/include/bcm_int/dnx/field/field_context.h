...
typedef struct
{
    ...
    dnx_field_context_hash_config_t hash_config;
 ...
 *   * None
 */
shr_error_e dnx_field_context_ipmf1_sw_info_t_init(
    int unit,
...
/**
* \brief
*  Set context hashing information  of a Field context
* \param [in] unit       - Device ID
* \param [in] context_id - Field Context ID
* \param [in] context_hashing_info_p  - Field Hashing info (see dnx_field_context_types.h)
* \return
*   shr_error_e - Error Type
* \remark
*   * The mode can be one of the following: Hashing/Compare
...
*   * None
*/
shr_error_e dnx_field_context_hashing_info_set(
    int unit,
    dnx_field_context_t context_id,
...
*   * the hash_info_p->hash_config.action_key, must be specified. Otherwise no info will be returned.
* \see
*   * None
*/
