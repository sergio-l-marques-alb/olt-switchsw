...
typedef enum {
    ...
    INSTRU_EVENTOR_INFO_RX_BUFFER0_OFFSET_INFO,
    INSTRU_EVENTOR_INFO_RX_BUFFER1_OFFSET_INFO,
    INSTRU_EVENTOR_INFO_RX_BUFFER_SIZE_INFO,
...
int instru_eventor_info_rx_buffer0_offset_dump(
    int unit, int rx_buffer0_offset_idx_0, dnx_sw_state_dump_filters_t filters);

int instru_eventor_info_rx_buffer1_offset_dump(
    int unit, int rx_buffer1_offset_idx_0, dnx_sw_state_dump_filters_t filters);

int instru_eventor_info_rx_buffer_size_dump(
    int unit, int rx_buffer_size_idx_0, dnx_sw_state_dump_filters_t filters);
