...
/**
 * \brief
 *  This function compares two qualifiers for KBP to check if they can be shared.
 *
 * \param [in] unit                  - Device Id
 * \param [in] dnx_qual_1            - First qualifier
 * \param [in] qual_attach_info_1_p  - First qualifier's attach info
 * \param [in] dnx_qual_2            - Second qualifier
 * \param [in] qual_attach_info_2_p  - Second qualifier's attach info
 * \param [out] shareable_p          - Whether or not the qualifiers can be shared.
 *
 * \return
 *   shr_error_e -   Error Type
 * \remark
