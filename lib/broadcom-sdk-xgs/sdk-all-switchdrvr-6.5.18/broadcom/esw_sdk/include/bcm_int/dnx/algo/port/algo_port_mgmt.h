...
#define  DNX_ALGO_PORT_FIRST_HEADER_SIZE_ETH_PROFILE "Profile for ETH ports for skipping first header size"
#define  DNX_ALGO_PORT_FIRST_HEADER_SIZE_PTCH1_PROFILE "Profile for PTCH1 ports for skipping first header size"
#define  DNX_ALGO_PORT_FIRST_HEADER_SIZE_PTCH2_PROFILE "Profile for PTCH2 ports for skipping first header size"
#define DNX_ALGO_PORT_FIRST_HEADER_SIZE_AFTER_PTCH1_PROFILE "Profile for PTCH1 ports for skipping first header size after injected"
/**
...
/**
 * \brief 
 * Info required for template manager`s profiles
 */
typedef struct
{
    /**
     * First header size to skip
     */
    uint32 first_header_size_to_skip;
} dnx_algo_port_first_header_size_t;
...
/**
 * \brief - Printing callback for first header size template for ETH ports
 *
 * \param [in] unit - Relevant unit
 ...
 *   * None
 */
void dnx_algo_port_db_first_header_size_eth_ports_print_cb(
    int unit,
    const void *data);

/**
 * \brief - Printing callback for first header size template for PTCH1 ports
 *
 * \param [in] unit - Relevant unit
 * \param [in] data - Pointer to template profile data
 * \return
 ...
 *   * None
 */
void dnx_algo_port_db_first_header_size_ptch1_ports_print_cb(
    int unit,
    const void *data);

/**
 * \brief - Printing callback for first header size template for PTCH2 ports
 *
 * \param [in] unit - Relevant unit
 * \param [in] data - Pointer to template profile data
 * \return
 ...
 *   * None
 */
void dnx_algo_port_db_first_header_size_ptch2_ports_print_cb(
    int unit,
    const void *data);
