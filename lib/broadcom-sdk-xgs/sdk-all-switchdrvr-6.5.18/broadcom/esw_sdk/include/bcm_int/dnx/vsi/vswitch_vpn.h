 ...
 *      [in] flags - DNX_ALGO_RES_ALLOCATE_xxx \n
 *      [in] type - see dnx_vsi_type_e \n
 *      [in,out] vsi - VSI is not allocated, use this VSI; otherwise allocate a new one \n
 *      [out] *replaced - indicate if used by other type. \n
 * \return
 ...
 *      [in] type - see dnx_vsi_type_e, only support for following type \n
 *          _bcmDnxVsiTypeMpls: used for MPSL VPN \n
 *          _bcmDnxVsiTypeVswitch \n
 *          _bcmDnxVsiTypeL2gre \n
 *          _bcmDnxVsiTypeMim \n
 *          _bcmDnxVsiTypeVxlan \n
 *      [out] *is_used - usage of this type on the VSI. 
 * \return
 *      \retval Zero in case of NO ERROR.
 *      \retval Negative in case of an error, see \ref shr_error_e.
 * \remark
 ...
 *          _bcmDnxVsiTypeMim \n
 *          _bcmDnxVsiTypeVxlan \n
 *      [out] *used - indicate if used by other type service. 
 * \return
 *      \retval Zero in case of NO ERROR.
 *      \retval Negative in case of an error, see \ref shr_error_e.
 * \remark
