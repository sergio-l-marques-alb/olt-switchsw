...
/**
 * implemented by: instru_eventor_info_rx_buffer0_offset_set
 */
typedef int (*instru_eventor_info_rx_buffer0_offset_set_cb)(
    int unit, uint32 rx_buffer0_offset_idx_0, uint32 rx_buffer0_offset);

/**
 * implemented by: instru_eventor_info_rx_buffer0_offset_get
 */
typedef int (*instru_eventor_info_rx_buffer0_offset_get_cb)(
    int unit, uint32 rx_buffer0_offset_idx_0, uint32 *rx_buffer0_offset);

/**
 * implemented by: instru_eventor_info_rx_buffer0_offset_alloc
 */
typedef int (*instru_eventor_info_rx_buffer0_offset_alloc_cb)(
    int unit);

/**
 * implemented by: instru_eventor_info_rx_buffer1_offset_set
 */
typedef int (*instru_eventor_info_rx_buffer1_offset_set_cb)(
    int unit, uint32 rx_buffer1_offset_idx_0, uint32 rx_buffer1_offset);

/**
 * implemented by: instru_eventor_info_rx_buffer1_offset_get
 */
typedef int (*instru_eventor_info_rx_buffer1_offset_get_cb)(
    int unit, uint32 rx_buffer1_offset_idx_0, uint32 *rx_buffer1_offset);

/**
 * implemented by: instru_eventor_info_rx_buffer1_offset_alloc
 */
typedef int (*instru_eventor_info_rx_buffer1_offset_alloc_cb)(
    int unit);

/**
 * implemented by: instru_eventor_info_rx_buffer_size_set
 */
typedef int (*instru_eventor_info_rx_buffer_size_set_cb)(
    int unit, uint32 rx_buffer_size_idx_0, uint32 rx_buffer_size);

/**
 * implemented by: instru_eventor_info_rx_buffer_size_get
 */
typedef int (*instru_eventor_info_rx_buffer_size_get_cb)(
    int unit, uint32 rx_buffer_size_idx_0, uint32 *rx_buffer_size);

/**
 * implemented by: instru_eventor_info_rx_buffer_size_alloc
 */
typedef int (*instru_eventor_info_rx_buffer_size_alloc_cb)(
    int unit);
...
/**
 * This structure holds the access functions for the variable rx_buffer0_offset
 */
typedef struct {
    instru_eventor_info_rx_buffer0_offset_set_cb set;
    instru_eventor_info_rx_buffer0_offset_get_cb get;
    instru_eventor_info_rx_buffer0_offset_alloc_cb alloc;
} instru_eventor_info_rx_buffer0_offset_cbs;

/**
 * This structure holds the access functions for the variable rx_buffer1_offset
 */
typedef struct {
    instru_eventor_info_rx_buffer1_offset_set_cb set;
    instru_eventor_info_rx_buffer1_offset_get_cb get;
    instru_eventor_info_rx_buffer1_offset_alloc_cb alloc;
} instru_eventor_info_rx_buffer1_offset_cbs;

/**
 * This structure holds the access functions for the variable rx_buffer_size
 */
typedef struct {
    instru_eventor_info_rx_buffer_size_set_cb set;
    instru_eventor_info_rx_buffer_size_get_cb get;
    instru_eventor_info_rx_buffer_size_alloc_cb alloc;
} instru_eventor_info_rx_buffer_size_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for rx_buffer0_offset
     */
    instru_eventor_info_rx_buffer0_offset_cbs rx_buffer0_offset;
    /**
     * Access struct for rx_buffer1_offset
     */
    instru_eventor_info_rx_buffer1_offset_cbs rx_buffer1_offset;
    /**
     * Access struct for rx_buffer_size
     */
    instru_eventor_info_rx_buffer_size_cbs rx_buffer_size;
