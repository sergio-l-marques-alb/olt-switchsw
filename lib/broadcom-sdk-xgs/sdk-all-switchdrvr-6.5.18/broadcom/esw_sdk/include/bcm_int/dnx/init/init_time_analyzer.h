...
typedef enum
{
    ...
    DNX_INIT_TIME_ANALYSER_DBAL_L_INIT_ADD_FIELD,
    DNX_INIT_TIME_ANALYSER_DBAL_L_INIT_ADD_ACCESS_FIELD,
    ...
    DNX_INIT_TIME_ANALYSER_DBAL_L_INIT_ADD_TABLE_MAP_HL_PARSE,
...
#define DNX_INIT_TIME_ANALYZER_OPS_INIT {\
        ...
        {DNX_INIT_TIME_ANALYSER_DBAL_L_INIT_ADD_FIELD, "DBAL ADD FIELD TO TABLE", DNX_INIT_TIME_ANALYZER_DBAL_INIT_EN},\
        {DNX_INIT_TIME_ANALYSER_DBAL_L_INIT_ADD_ACCESS_FIELD, "DBAL ADD ACCESS TO FIELD", DNX_INIT_TIME_ANALYZER_DBAL_INIT_EN},\
        ...
        {DNX_INIT_TIME_ANALYSER_DBAL_L_INIT_ADD_TABLE_MAP_HL_PARSE, "DBAL ADD TABLE MAP HL PARSE INIT", DNX_INIT_TIME_ANALYZER_DBAL_INIT_EN},\
