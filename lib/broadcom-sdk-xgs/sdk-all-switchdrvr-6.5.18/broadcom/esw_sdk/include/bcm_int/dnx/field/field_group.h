...
shr_error_e dnx_field_group_kbp_segment_indices(
    ...
    uint8 seg_index_on_master_by_qual[DNX_KBP_MAX_NOF_SEGMENTS_PER_LOOKUP]);
...
/**
* \brief
*  Check if the given FWD segment is a zero_padding segment.
* \param [in] unit               - Device ID
...
*   * None
*/
shr_error_e dnx_field_group_kbp_acl_segment_is_zero_padding(
    int unit,
...
*   * None
*/
shr_error_e dnx_field_group_kbp_segment_exist(
    int unit,
    dbal_enum_value_field_kbp_fwd_opcode_e opcode_id,
    dnx_field_group_t fg_id,
    int force_same_qual,
