...
typedef enum
{
    ...
    DNX_FIELD_IPMF1_QUAL_L4OPS_ENCODED,
...
#define DNX_FIELD_KBP_OPCODE_ITERATOR_IN_USE_CONTINUE(_opcode_id) \
        { \
            uint8 _fwd_nof_contexts; \
            kbp_mngr_fwd_acl_context_mapping_t \
                _fwd_acl_ctx_mapping[DNX_DATA_MAX_FIELD_KBP_MAX_FWD_CONTEXT_NUM_FOR_ONE_APPTYPE]; \
            SHR_IF_ERR_EXIT(kbp_mngr_opcode_to_contexts_get \
                            (unit, _opcode_id, &_fwd_nof_contexts, _fwd_acl_ctx_mapping)); \
            if (_fwd_nof_contexts <= 0) \
            { \
                continue; \
            } \
        }
...
/**
* \brief
*  Maps CRC Select Action to DNX CRC Select ENUMS
* \param [in] unit                - Device Id.
* \param [in] bcm_crc_select     - BCM CRC Select Enum.
* \param [out] dnx_crc_select_p  - DNX CRC Select Enum.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_map_crc_select_bcm_to_dnx(
    int unit,
...
/**
* \brief
*  Maps DNX CRC Select to BCM CRC Select ENUMS
* \param [in] unit                - Device Id.
* \param [in] dnx_crc_select  - DNX CRC Select Enum.
...
*   * None
*/
shr_error_e dnx_field_map_crc_select_dnx_to_bcm(
    int unit,
...
/**
* \brief
*  Maps BCM configurable type to DNX configurable type.
* \param [in] unit -
*  Device Id
* \param [in] bcm_range_config_type -
*  BCM range configurable type
* \param [out] dnx_range_config_type_p -
*  The mapped DNX range configurable type
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_map_range_config_type_bcm_to_dnx(
    int unit,
