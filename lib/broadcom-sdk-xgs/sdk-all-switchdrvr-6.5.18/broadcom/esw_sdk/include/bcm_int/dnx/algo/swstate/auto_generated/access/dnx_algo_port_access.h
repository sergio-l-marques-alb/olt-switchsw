...
/**
 * implemented by: dnx_algo_port_db_eth_ports_first_header_size_profile_data_set
 */
typedef int (*dnx_algo_port_db_eth_ports_first_header_size_profile_data_set_cb)(
    int unit, dnx_algo_template_t eth_ports_first_header_size_profile_data);

/**
 * implemented by: dnx_algo_port_db_eth_ports_first_header_size_profile_data_get
 */
typedef int (*dnx_algo_port_db_eth_ports_first_header_size_profile_data_get_cb)(
    int unit, dnx_algo_template_t *eth_ports_first_header_size_profile_data);

/**
 * implemented by: dnx_algo_port_db_eth_ports_first_header_size_profile_data_create
 */
typedef int (*dnx_algo_port_db_eth_ports_first_header_size_profile_data_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: dnx_algo_port_db_eth_ports_first_header_size_profile_data_exchange
 */
typedef int (*dnx_algo_port_db_eth_ports_first_header_size_profile_data_exchange_cb)(
...
/**
 * implemented by: dnx_algo_port_db_eth_ports_first_header_size_profile_data_profile_data_get
 */
typedef int (*dnx_algo_port_db_eth_ports_first_header_size_profile_data_profile_data_get_cb)(
    int unit, int profile, int *ref_count, uint32 *profile_data);

/**
 * implemented by: dnx_algo_port_db_eth_ports_first_header_size_profile_data_profile_get
 */
typedef int (*dnx_algo_port_db_eth_ports_first_header_size_profile_data_profile_get_cb)(
    int unit, const uint32 *profile_data, int *profile);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_set
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_set_cb)(
    int unit, dnx_algo_template_t ptch1_ports_first_header_size_profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_get
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_get_cb)(
    int unit, dnx_algo_template_t *ptch1_ports_first_header_size_profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_create
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_exchange
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_exchange_cb)(
    int unit, uint32 flags, const uint32 *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_profile_data_get
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_profile_data_get_cb)(
    int unit, int profile, int *ref_count, uint32 *profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_profile_get
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_profile_get_cb)(
    int unit, const uint32 *profile_data, int *profile);

/**
 * implemented by: dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_set
 */
typedef int (*dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_set_cb)(
    int unit, dnx_algo_template_t ptch2_ports_first_header_size_profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_get
 */
typedef int (*dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_get_cb)(
    int unit, dnx_algo_template_t *ptch2_ports_first_header_size_profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_create
 */
typedef int (*dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_exchange
 */
typedef int (*dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_exchange_cb)(
    int unit, uint32 flags, const uint32 *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_profile_data_get
 */
typedef int (*dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_profile_data_get_cb)(
    int unit, int profile, int *ref_count, uint32 *profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_profile_get
 */
typedef int (*dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_profile_get_cb)(
    int unit, const uint32 *profile_data, int *profile);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_set
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_set_cb)(
    int unit, dnx_algo_template_t ptch1_ports_first_header_size_after_injected_profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_get
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_get_cb)(
    int unit, dnx_algo_template_t *ptch1_ports_first_header_size_after_injected_profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_create
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_exchange
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_exchange_cb)(
    int unit, uint32 flags, const uint32 *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_profile_data_get
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_profile_data_get_cb)(
    int unit, int profile, int *ref_count, uint32 *profile_data);

/**
 * implemented by: dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_profile_get
 */
typedef int (*dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_profile_get_cb)(
    int unit, const uint32 *profile_data, int *profile);
...
/**
 * This structure holds the access functions for the variable eth_ports_first_header_size_profile_data
 */
typedef struct {
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_set_cb set;
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_get_cb get;
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_create_cb create;
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_exchange_cb exchange;
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_profile_data_get_cb profile_data_get;
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_profile_get_cb profile_get;
} dnx_algo_port_db_eth_ports_first_header_size_profile_data_cbs;

/**
 * This structure holds the access functions for the variable ptch1_ports_first_header_size_profile_data
 */
typedef struct {
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_set_cb set;
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_get_cb get;
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_create_cb create;
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_exchange_cb exchange;
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_profile_data_get_cb profile_data_get;
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_profile_get_cb profile_get;
} dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_cbs;

/**
 * This structure holds the access functions for the variable ptch2_ports_first_header_size_profile_data
 */
typedef struct {
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_set_cb set;
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_get_cb get;
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_create_cb create;
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_exchange_cb exchange;
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_profile_data_get_cb profile_data_get;
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_profile_get_cb profile_get;
} dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_cbs;

/**
 * This structure holds the access functions for the variable ptch1_ports_first_header_size_after_injected_profile_data
 */
typedef struct {
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_set_cb set;
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_get_cb get;
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_create_cb create;
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_exchange_cb exchange;
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_profile_data_get_cb profile_data_get;
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_profile_get_cb profile_get;
} dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for eth_ports_first_header_size_profile_data
     */
    dnx_algo_port_db_eth_ports_first_header_size_profile_data_cbs eth_ports_first_header_size_profile_data;
    /**
     * Access struct for ptch1_ports_first_header_size_profile_data
     */
    dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_cbs ptch1_ports_first_header_size_profile_data;
    /**
     * Access struct for ptch2_ports_first_header_size_profile_data
     */
    dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_cbs ptch2_ports_first_header_size_profile_data;
    /**
     * Access struct for ptch1_ports_first_header_size_after_injected_profile_data
     */
    dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_cbs ptch1_ports_first_header_size_after_injected_profile_data;
    /**
