...
/**
 * implemented by: dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_set
 */
typedef int (*dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_set_cb)(
    int unit, int is_fmq_allocated);

/**
 * implemented by: dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_get
 */
typedef int (*dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_get_cb)(
    int unit, int *is_fmq_allocated);
...
typedef int (*dnx_ipq_alloc_mngr_db_tc_voq_flow_map_set_cb)(
    int unit, dnx_algo_template_t tc_voq_flow_map);
...
/**
 * This structure holds the access functions for the variable is_fmq_allocated
 */
typedef struct {
    dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_set_cb set;
    dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_get_cb get;
} dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for is_fmq_allocated
     */
    dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_cbs is_fmq_allocated;
    /**
