...
typedef enum {
    ...
    DNX_ALGO_PORT_DB_ETH_PORTS_FIRST_HEADER_SIZE_PROFILE_DATA_INFO,
    DNX_ALGO_PORT_DB_PTCH1_PORTS_FIRST_HEADER_SIZE_PROFILE_DATA_INFO,
    DNX_ALGO_PORT_DB_PTCH2_PORTS_FIRST_HEADER_SIZE_PROFILE_DATA_INFO,
    DNX_ALGO_PORT_DB_PTCH1_PORTS_FIRST_HEADER_SIZE_AFTER_INJECTED_PROFILE_DATA_INFO,
...
int dnx_algo_port_db_eth_ports_first_header_size_profile_data_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_port_db_ptch1_ports_first_header_size_profile_data_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_port_db_ptch2_ports_first_header_size_profile_data_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_port_db_ptch1_ports_first_header_size_after_injected_profile_data_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
