...
/**
 * Number of keys which are available for stage IPMF1 (See dnx_field_stage_e). This enum is based on
 * dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF1(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF1)->nof_keys_alloc)

/**
 * Number of keys which are available for stage IPMF2 (See dnx_field_stage_e). This enum is based on
 * dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF2(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF2)->nof_keys_alloc)

/**
 * Number of keys which are available for stage IPMF3 (See dnx_field_stage_e). This enum is based on
 * dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF3(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF3)->nof_keys_alloc)

/**
 * Number of keys which are available for stage EPMF (See dnx_field_stage_e). This enum is based on
 * dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_EPMF(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_EPMF)->nof_keys_alloc)

/**
 * Number of keys which are available for stage IPMF1 (See dnx_field_stage_e) for field groups
 * of TCAM type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF1_FOR_TCAM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF1)->nof_keys_alloc_for_tcam)

/**
 * Number of keys which are available for stage IPMF1 (See dnx_field_stage_e) for field groups
 * of EXEM type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF1_FOR_EXEM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF1)->nof_keys_alloc_for_exem)

/**
 * Number of keys which are available for stage IPMF1 (See dnx_field_stage_e) for field groups
 * of Direct Table MDB type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF1_FOR_MDB_DT(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF1)->nof_keys_alloc_for_mdb_dt)

/**
 * Number of keys which are available for stage IPMF2 (See dnx_field_stage_e) for field groups
 * of TCAM type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF2_FOR_TCAM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF2)->nof_keys_alloc_for_tcam)
 ...
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF2_FOR_EXEM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF2)->nof_keys_alloc_for_exem)

/**
 * Number of keys which are available for stage IPMF2 (See dnx_field_stage_e) for field groups
 * of DIRECT EXTRACTION type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF2_FOR_DIR_EXT(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF2)->nof_keys_alloc_for_dir_ext)
 ...
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF2_FOR_MDB_DT(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF2)->nof_keys_alloc_for_mdb_dt)

/**
 * Number of keys which are available for stage IPMF3 (See dnx_field_stage_e) for field groups
 * of TCAM type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF3_FOR_TCAM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF3)->nof_keys_alloc_for_tcam)
 ...
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF3_FOR_EXEM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF3)->nof_keys_alloc_for_exem)
 ...
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF3_FOR_DIR_EXT(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF3)->nof_keys_alloc_for_dir_ext)
 ...
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_IPMF3_FOR_MDB_DT(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_IPMF3)->nof_keys_alloc_for_mdb_dt)

/**
 * Number of keys which are available for stage EPMF (See dnx_field_stage_e) for field groups
 * of TCAM type (See dnx_field_group_type_e).
 * This enum is based on dbal_enum_value_field_field_key_e.
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_EPMF_FOR_TCAM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_EPMF)->nof_keys_alloc_for_tcam)
 ...
 * It is assumed that key names are assigned sequentially on dbal_enum_value_field_field_key_e!
 */
#define DNX_FIELD_KEY_NOF_FOR_EPMF_FOR_EXEM(_unit) (dnx_data_field.stage.stage_info_get(_unit, DNX_FIELD_STAGE_EPMF)->nof_keys_alloc_for_exem)
...
typedef struct {
    ...
    /**
     * Indicates whether keys are allocated from 'first_available_key' and up or down. In other
     * words, it indicates whether 'first_available_key' is the smallest of the pool of available
     * key or the largest.
     */
    uint8 availability_going_up;
    /**
     * Indicates whether half-keys are allocated starting from LSB and up only. In other
     * words, if a single half-key is required then it may only be allocated at key_occupation[1],
     * key_occupation[3], key_occupation[5], etc. Another example, if a full single key is required
     * then it may only be allocated at (key_occupation[1],key_occupation[0]) and not, say, at
     * (key_occupation[2],key_occupation[1])
     */
    uint8 availability_odd_only;
    /**
