...
typedef enum
{
     ...
     * Invalid Param. 
     */
    DNX_FIELD_RANGE_CONFIG_INVALID = -1,
    /*
     * First param 
     */
    DNX_FIELD_RANGE_CONFIG_FIRST = 0,
    /*
     * First user-defined range 
     */
    DNX_FIELD_RANGE_CONFIG_USERDEFINED1 = DNX_FIELD_RANGE_CONFIG_FIRST,
    /*
     * Second user-defined range 
     */
    DNX_FIELD_RANGE_CONFIG_USERDEFINED2 = 1,
    /*
     * Always last. Not a usable value. 
     */
    DNX_FIELD_RANGE_CONFIG_COUNT = 2
} dnx_field_range_config_e;
...
* \param [in] unit           - Device ID
* \param [in] flags          - TBD
* \param [in] dnx_range_type - Type (FFC) to configure
...
shr_error_e dnx_field_range_ffc_config_set(
    int unit,
    uint32 flags,
    dnx_field_range_config_e dnx_range_type,
