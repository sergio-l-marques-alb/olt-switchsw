 ...
 * However, we allow up to 400 bits to account for several IPv6 scenarios.
 */
#define DNX_KBP_MAX_KEY_LENGTH_IN_BITS_LOSSLESS 360
#define DNX_KBP_MAX_KEY_LENGTH_IN_BITS          400
...
#define DNX_KBP_MAX_NOF_SEGMENTS_PER_MASTER_KEY 20 /** Arbitrary size size, increased from the actually available 15 */
...
#define DNX_KBP_FIELD_OMMITTED_FROM_OPTIMIZED_RESULT(_field_id_) \
    (((_field_id_ == DBAL_FIELD_KBP_FORWARD_PMF_GENERIC_DATA) || (_field_id_ == DBAL_FIELD_RESULT_TYPE)) ? 1 : 0)
