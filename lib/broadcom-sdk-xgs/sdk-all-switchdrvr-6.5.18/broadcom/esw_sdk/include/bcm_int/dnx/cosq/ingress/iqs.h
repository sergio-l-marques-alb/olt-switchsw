...
/**
 * \brief - Set DQCQ priority maximal LOW priority. 
 * DQCQ priorities are monotronic.
 *
 * \param [in] unit - unit index
 * \param [in] max_low_priority - the maximum LOW priority.
 *
 * \return
 *   shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_iqs_max_low_priority_set(
    int unit,
    uint32 max_low_priority);

/**
 * \brief - Get DQCQ priority maximal LOW priority indication.
 * DQCQ priorities are monotronic , and set to either HIGH or LOW priority.
 *
 * \param [in] unit - unit index
 * \param [out] max_low_priority - maximal LOW priority
 *
 * \return
 *   shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_iqs_max_low_priority_get(
    int unit,
    uint32 *max_low_priority);
