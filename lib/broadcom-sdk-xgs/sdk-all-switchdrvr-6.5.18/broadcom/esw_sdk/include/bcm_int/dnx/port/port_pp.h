...
shr_error_e dnx_port_pp_vtt_cs_profile_set(
    int unit,
    bcm_port_t port,
    dbal_enum_value_field_ptc_profile_vtt1_e vtt1_cs_profile,
    dbal_enum_value_field_ptc_profile_vtt2_e vtt2_cs_profile,
    dbal_enum_value_field_ptc_profile_vtt3_e vtt3_cs_profile,
    dbal_enum_value_field_ptc_profile_vtt4_e vtt4_cs_profile);
/**
 * \brief
...
/**
 * \brief - Helper Function for setting port/lif layer protocols
 *
 * \param [in] unit - Relevant unit
 ...
 *   * None
 */
shr_error_e dnx_port_lif_layer_protocol_dbal_key_value_set(
    int unit,
