...
/*********************************************************************************
 *********************************************************************************
 *  File Name  :  merlin7_pcieg3_functions.h
...
#ifndef MERLIN7_PCIEG3_API_FUNCTIONS_H
#define MERLIN7_PCIEG3_API_FUNCTIONS_H
    ...
    do  { \
        ...
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return merlin7_pcieg3_error_report(sa__, *(__ERR)); \
        }\
        (void)srds_err_code; \
    }   while(0)
