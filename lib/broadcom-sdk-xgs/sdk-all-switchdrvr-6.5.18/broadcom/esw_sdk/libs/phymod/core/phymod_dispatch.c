...
extern __phymod__dispatch__t__ phymod_blackhawk7_v1l8p2_driver;
#endif
...
#ifdef PHYMOD_BLACKHAWK7_V1L8P2_SUPPORT
    &phymod_blackhawk7_v1l8p2_driver,
#endif
#ifdef PHYMOD_TSCBH_GEN2_SUPPORT
...
int phymod_phy_pll_reconfig(const phymod_phy_access_t* phy, uint8_t pll_index, uint32_t pll_div)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_pll_reconfig) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_pll_reconfig(phy, pll_index, pll_div);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_ecc_intr_enable_set(const phymod_phy_access_t* phy, phymod_interrupt_type_t ecc_error_intr, uint32_t enable)
{
    ...
    if(PHYMOD_E_OK != phymod_interrupt_type_t_validate(ecc_error_intr)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("ecc_error_intr validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_ecc_intr_enable_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_ecc_intr_enable_set(phy, ecc_error_intr, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_ecc_intr_enable_get(const phymod_phy_access_t* phy, phymod_interrupt_type_t ecc_error_intr, uint32_t* enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_ecc_intr_enable_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_ecc_intr_enable_get(phy, ecc_error_intr, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
