...
typedef int (*__dispatch__phymod_phy_ecc_intr_enable_set_f)(const phymod_phy_access_t* phy, phymod_interrupt_type_t ecc_error_intr, uint32_t enable);
typedef int (*__dispatch__phymod_phy_ecc_intr_enable_get_f)(const phymod_phy_access_t* phy, phymod_interrupt_type_t ecc_error_intr, uint32_t* enable);
...
typedef struct __phymod__dispatch__s__ {
    ...
    __dispatch__phymod_phy_ecc_intr_enable_set_f                                     f_phymod_phy_ecc_intr_enable_set;
    __dispatch__phymod_phy_ecc_intr_enable_get_f                                     f_phymod_phy_ecc_intr_enable_get;
