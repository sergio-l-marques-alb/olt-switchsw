...
int tscbh_phy_ecc_intr_enable_set(const phymod_phy_access_t* phy, phymod_interrupt_type_t ecc_error_intr, uint32_t enable);
int tscbh_phy_ecc_intr_enable_get(const phymod_phy_access_t* phy, phymod_interrupt_type_t ecc_error_intr, uint32_t* enable);
