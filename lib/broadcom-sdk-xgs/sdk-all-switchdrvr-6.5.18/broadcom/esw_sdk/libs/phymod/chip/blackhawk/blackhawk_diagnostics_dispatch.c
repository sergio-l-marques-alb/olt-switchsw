...
__phymod_diagnostics__dispatch__t__ phymod_diagnostics_blackhawk_diagnostics_driver = {

    blackhawk_phy_rx_slicer_position_set,
    blackhawk_phy_rx_slicer_position_get,
    blackhawk_phy_rx_slicer_position_max_get,
    ...
    blackhawk_core_diagnostics_get,
    blackhawk_phy_diagnostics_get,
