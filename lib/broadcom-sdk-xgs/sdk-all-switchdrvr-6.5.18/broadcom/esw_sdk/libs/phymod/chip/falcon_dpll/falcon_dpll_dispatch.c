...
__phymod__dispatch__t__ phymod_falcon_dpll_driver = {

    NULL, /* phymod_core_identify */
    NULL, /* phymod_core_info_get */
    ...
    falcon_dpll_phy_tx_set,
    falcon_dpll_phy_tx_get,
    ...
    falcon_dpll_phy_txpi_config_set,
    falcon_dpll_phy_txpi_config_get,
    ...
    falcon_dpll_phy_tx_lane_control_set,
    falcon_dpll_phy_tx_lane_control_get,
    falcon_dpll_phy_rx_lane_control_set,
    falcon_dpll_phy_rx_lane_control_get,
    ...
    NULL, /* phymod_core_init */
    NULL, /* phymod_phy_pll_multiplier_get */
    NULL, /* phymod_phy_init */
    ...
    NULL, /* phymod_phy_reg_read */
    NULL, /* phymod_phy_reg_write */
