...
#include "../../eagle/tier1/eagle_tsc_fields.h"
#include "../../eagle/tier1/eagle_tsc_dependencies.h"
#include "../../eagle/tier1/eagle_tsc_field_access.h"
  ...
  #define TEMOD_DBG_IN_FUNC_INFO(pc) \
    PHYMOD_VDBG(TEMOD_DBG_FUNC,pc,("%-22s: Adr:%08x Ln:%02d\n", __func__, (unsigned int)pc->addr, (int)pc->lane_mask))
...
/*SPD_10G_X2          16*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_40,  1, 0,  0},
...
static eagle_sc_pmd_entry_st eagle_sc_pmd_entry_125M_refclk[] = {

/*SPD_10M              0*/ { 1, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_10M              1*/ { 1, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_100M             2*/ { 1, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_1000M            3*/ { 1, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_1G_CX1           4*/ { 1, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_1G_KX1           5*/ { 1, TEMOD_PMA_OS_MODE_8_25, TEMOD_PLL_MODE_DIV_82P5,  0, 0,  1},
/*SPD_2p5G             6*/ { 1, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_5G_X1            7*/ { 1, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_50,  1, 0,  0},
/*SPD_10G_CX4          8*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_50,  0, 0,  0},
/*SPD_10G_KX4          9*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_50,  0, 0,  0},
/*SPD_10G_X4          10*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_13G_X4          11*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_ILLEGAL,  0, 0,  1},
/*SPD_15G_X4          12*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_ILLEGAL,  0, 0,  1},
/*SPD_16G_X4          13*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_80,  0, 0,  1},
/*SPD_20G_CX4         14*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_10G_CX2         15*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_50,  0, 0,  1},
/*SPD_10G_X2          16*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_50,  1, 0,  1},
/*SPD_20G_X4          17*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_50,  1, 0,  1},
/*SPD_10p5G_X2        18*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_21G_X4          19*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_12p7G_X2        20*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_25p45G_X4       21*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_15p75G_X2       22*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_31p5G_X4        23*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_31p5G_KR4       24*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_ILLEGAL,  1, 0,  0},
/*SPD_20G_CX2         25*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_20G_X2          26*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_40G_X4          27*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_10G_KR1         28*/ { 0, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_10p6_X1         29*/ { 0, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_87P5,  1, 0,  0},
/*SPD_20G_KR2         30*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_20G_CR2         31*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_21G_X2          32*/ { 2, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_87P5,  1, 0,  0},
/*SPD_40G_KR4         33*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_40G_CR4         34*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_42G_X4          35*/ { 4, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_87P5,  1, 0,  0},
/*SPD_100G_CR10       36*/ {10, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_107G_CR10       37*/ {10, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_87P5,  1, 0,  0},
/*SPD_120G_X12        38*/ {12, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_82P5,  1, 0,  0},
/*SPD_127G_X12        39*/ {12, TEMOD_PMA_OS_MODE_1,  TEMOD_PLL_MODE_DIV_87P5,  1, 0,  0},
/*SPD_ILLEGAL         40*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_ILLEGAL         41*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_ILLEGAL         42*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_ILLEGAL         43*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
...
/*SPD_ILLEGAL         47*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_ILLEGAL         48*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_5G_KR1          49*/ { 0, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_82P5,  0, 0,  0},
/*SPD_10p5G_X4        50*/ { 4, TEMOD_PMA_OS_MODE_2,  TEMOD_PLL_MODE_DIV_42,  0, 0,  0},
/*SPD_ILLEGAL         51*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_ILLEGAL         52*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_40,  0, 0,  0},
/*SPD_10M_10p3125     53*/ { 1, TEMOD_PMA_OS_MODE_8_25, TEMOD_PLL_MODE_DIV_82P5,  0, 0,  0},
/*SPD_100M_10p3125    54*/ { 1, TEMOD_PMA_OS_MODE_8_25, TEMOD_PLL_MODE_DIV_82P5,  0, 0,  0},
/*SPD_1000M_10p3125   55*/ { 1, TEMOD_PMA_OS_MODE_8_25, TEMOD_PLL_MODE_DIV_82P5,  0, 0,  0},
/*SPD_2p5G_X1_10p3125 56*/ { 1, TEMOD_PMA_OS_MODE_3_3,TEMOD_PLL_MODE_DIV_82P5,  0, 0,  0},
/*SPD_ILLEGAL         57*/ { 0, TEMOD_PMA_OS_MODE_5,  TEMOD_PLL_MODE_DIV_50,  0, 0,  0}
...
@returns PHYMOD_E_NONE if no errors. PHYMOD_E_FAIL else.
@details This function reads RX-PMD PMD_LOCK bit to get the locked status of
...
int temod_pmd_lock_get(PHYMOD_ST* pc, uint32_t* lockStatus)
{
  ...
  pc_copy = pc;
  pc_copy->port_type = TEMOD_MULTI_PORT;
  lane_mask = 0;
  switch(pc->port_type) {
    case TEMOD_MULTI_PORT:   lane_mask = 0x1 << pc->this_lane;  break;
    case TEMOD_TRI1_PORT:    if(pc->this_lane == 3) lane_mask = 0xc;
                              else lane_mask = 0x1 << pc->this_lane;
                              break;
    case TEMOD_TRI2_PORT:    if(pc->this_lane == 0) lane_mask = 0x3;
                              else lane_mask = 0x1 << pc->this_lane;
                              break;
    case TEMOD_DXGXS:        if(pc->this_lane == 0) lane_mask = 0x3;
                              else lane_mask = 0xc;
                              break;
...
This does not start autonegotiation. That is done in #temod_autoneg_control
*/
int temod_cl48_lfrfli_init(PHYMOD_ST* pc)               /* AUTONEG timer set*/
{
...
@param   pc handle to current TSCE context (#PHYMOD_ST)
@param   an_ability_st handle to current abilities struct #temod_an_ability_t
@returns PHYMOD_E_NONE if no errors. PHYMOD_E_FAIL else.
 ...
 /* if((an_ability_st->cl37_adv.an_type ==  TEMOD_AN_MODE_CL37) || ( an_ability_st->cl37_adv.an_type ==  TEMOD_AN_MODE_CL37BAM) || 
     (an_ability_st->cl37_adv.an_type ==  TEMOD_AN_MODE_SGMII) )  */ {
      ...
      /*if((an_ability_st->cl37_adv.an_type ==  TEMOD_AN_MODE_CL37BAM)) */{ 
         ...
         /******* CL37 Bam AN_X4_ABILITIES_local_device_over1g_abilities_1 setting********/
         if(an_ability_st->cl37_adv.an_fec == TEMOD_FEC_CL74_SUPRTD_REQSTD) {
  ...
  /*if((an_ability_st->cl73_adv.an_type ==  TEMOD_AN_MODE_CL73) || ( an_ability_st->cl73_adv.an_type ==  TEMOD_AN_MODE_CL73BAM)) */  {
      ...
      if (an_ability_st->cl73_adv.an_fec == TEMOD_FEC_CL74_SUPRTD_REQSTD) {
          AN_X4_LOC_DEV_CL73_BASE_ABIL0r_FECf_SET(reg_cl73_base_abilities, 0x3);
      } else if (an_ability_st->cl73_adv.an_fec == TEMOD_FEC_SUPRTD_NOT_REQSTD) {
...
int temod_autoneg_local_ability_get(PHYMOD_ST* pc, temod_an_ability_t *an_ability_st)
{
  ...
  if (AN_X4_LOC_DEV_OVER1G_ABIL1r_FECf_GET(reg_over1g_abilities1)) {
      an_ability_st->cl37_adv.an_fec = TEMOD_FEC_CL74_SUPRTD_REQSTD;
  } else {
      an_ability_st->cl37_adv.an_fec = TEMOD_FEC_SUPRTD_NOT_REQSTD;
  }
  ...
  if (an_fec == 0x3) {
      an_ability_st->cl73_adv.an_fec = TEMOD_FEC_CL74_SUPRTD_REQSTD;
  } else if (an_fec == 0x1) {
      an_ability_st->cl73_adv.an_fec = TEMOD_FEC_SUPRTD_NOT_REQSTD;
  } else {
      an_ability_st->cl73_adv.an_fec = TEMOD_FEC_NOT_SUPRTD;
  }
...
int temod_autoneg_remote_ability_get(PHYMOD_ST* pc, temod_an_ability_t *an_ability_st)
{
  ...
  data <<= TEMOD_CL37_BAM_12GBASE_X4;
  data |= (AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_12P5G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_12p5GBASE_X4);
 
  /* data: get BAM_10GBASE_X2_CX4, BAM_10GBASE_X2_CX4 and BAM_10p5GBASE_X2 */
  data |= (AN_X4_LP_MP1024_UP4r_SPEED_ABILITY_10P5G_X2f_GET(an_x4_up4) << TEMOD_CL37_BAM_BAM_10p5GBASE_X2);
  data |= (AN_X4_LP_MP1024_UP4r_SPEED_ABILITY_10G_CX2f_GET(an_x4_up4) << TEMOD_CL37_BAM_10GBASE_X2_CX4);
  data |= (AN_X4_LP_MP1024_UP4r_SPEED_ABILITY_10G_X2f_GET(an_x4_up4) << TEMOD_CL37_BAM_10GBASE_X2);

  /* data: get BAM_12p7GBASE_X2 */
  data |= (AN_X4_LP_MP1024_UP4r_SPEED_ABILITY_12P7G_X2f_GET(an_x4_up4) << TEMOD_CL37_BAM_12p7GBASE_X2);

  /* data: get BAM_10GBASE_X4_CX4,BAM_10GBASE_X4,BAM_6GBASE_X4,BAM_5GBASE_X4 and BAM_2P5GBASE_X1 */
  data |= AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_2P5G_X1f_GET(an_x4_up1) << TEMOD_CL37_BAM_2p5GBASE_X;
  data |= AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_5G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_5GBASE_X4;
  data |= AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_6G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_6GBASE_X4;
  data |= AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_10G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_10GBASE_X4;
  data |= AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_10G_CX4f_GET(an_x4_up1) << TEMOD_CL37_BAM_10GBASE_X4_CX4;
  an_ability_st->cl37_adv.an_bam_speed = data;

  /* data - get   BAM_13GBASE_X4, BAM_15GBASE_X4,   BAM_16GBASE_X4 and   BAM_20GBASE_CX4 */
  data = AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_13G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_13GBASE_X4;
  data |= (AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_15G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_15GBASE_X4);
  data |= (AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_16G_X4f_GET(an_x4_up1) << TEMOD_CL37_BAM_16GBASE_X4);
  data |= (AN_X4_LP_MP1024_UP1r_SPEED_ABILITY_20G_CX4f_GET(an_x4_up1) << TEMOD_CL37_BAM_20GBASE_X4_CX4);
  an_ability_st->cl37_adv.an_bam_speed1 = data;
  
  /* data -    BAM_15p75GBASE_X2 ,   BAM_20GBASE_X2*/
  data = AN_X4_LP_MP1024_UP4r_SPEED_ABILITY_15P75G_X2f_GET(an_x4_up4) << TEMOD_CL37_BAM_15p75GBASE_X2;
  data |= (AN_X4_LP_MP1024_UP4r_SPEED_ABILITY_20G_CX2f_GET(an_x4_up4) << TEMOD_CL37_BAM_20GBASE_X2);
  an_ability_st->cl37_adv.an_bam_speed1 |= data;
  
  /* data -       -  21G-X4 ,   25.45G-X4,  31.5G-X4,   32.7G, 40G-X4 */
  data = AN_X4_LP_MP1024_UP3r_SPEED_ABILITY_21G_X4f_GET(an_x4_up3) << TEMOD_CL37_BAM_21GBASE_X4;
  data |= (AN_X4_LP_MP1024_UP3r_SPEED_ABILITY_25P45G_X4f_GET(an_x4_up3) << TEMOD_CL37_BAM_25p455GBASE_X4);
  data |= (AN_X4_LP_MP1024_UP3r_SPEED_ABILITY_31P5G_X4f_GET(an_x4_up3) << TEMOD_CL37_BAM_31p5GBASE_X4);
  data |= (AN_X4_LP_MP1024_UP3r_SPEED_ABILITY_32P7Gf_GET(an_x4_up3) << TEMOD_CL37_BAM_32p7GBASE_X4);
  data |= (AN_X4_LP_MP1024_UP3r_SPEED_ABILITY_40G_X4f_GET(an_x4_up3) << TEMOD_CL37_BAM_40GBASE_X4);
  an_ability_st->cl37_adv.an_bam_speed1 |= data;
  ...
  if (data & (1<<1)) {
     an_ability_st->cl73_adv.an_bam_speed |= (1 << TEMOD_CL73_BAM_20GBASE_KR2);
  } else {
     user_code |= data;
  ...
  if (data & (1<<0)){
      an_ability_st->cl73_adv.an_bam_speed |= (1<< TEMOD_CL73_BAM_20GBASE_CR2);
  }

  data = AN_X4_LP_BASE_PAGE2r_SPEED_100G_CR10f_GET(an_x4_pg2) << TEMOD_CL73_100GBASE_CR10;
  data |= AN_X4_LP_BASE_PAGE2r_SPEED_40G_CR4f_GET(an_x4_pg2) << TEMOD_CL73_40GBASE_CR4;
  data |= AN_X4_LP_BASE_PAGE2r_SPEED_40G_KR4f_GET(an_x4_pg2) << TEMOD_CL73_40GBASE_KR4;
  data |= AN_X4_LP_BASE_PAGE2r_SPEED_10G_KR_ABILITYf_GET(an_x4_pg2) << TEMOD_CL73_10GBASE_KR;
  data |= AN_X4_LP_BASE_PAGE2r_SPEED_10G_KX4_ABILITYf_GET(an_x4_pg2) << TEMOD_CL73_10GBASE_KX4;
  data |= AN_X4_LP_BASE_PAGE2r_SPEED_1G_KX_ABILITYf_GET(an_x4_pg2) << TEMOD_CL73_1000BASE_KX;
  ...
  if (AN_X4_LP_MP1024_UP3r_CL74_FEC_ABILITYf_GET(an_x4_up3)) {
      an_ability_st->cl37_adv.an_fec = TEMOD_FEC_CL74_SUPRTD_REQSTD;
  } else {
      an_ability_st->cl37_adv.an_fec = TEMOD_FEC_SUPRTD_NOT_REQSTD;
  }
  ...
  an_fec = (AN_X4_LP_BASE_PAGE3r_LP_BASE_PAGE3_PAGE_DATAf_GET(an_x4_pg3) >> 14) & 0x3;
  if (an_fec == 0x3) {
      an_ability_st->cl73_adv.an_fec = TEMOD_FEC_CL74_SUPRTD_REQSTD;
  } else if (an_fec == 0x1) {
      an_ability_st->cl73_adv.an_fec = TEMOD_FEC_SUPRTD_NOT_REQSTD;
...
\li TEMOD_AN_MODE_CL73
\li TEMOD_AN_MODE_CL73_BAM
\li TEMOD_AN_MODE_HPAM
*/
...
#endif
#ifdef _SDK_TEMOD_
int temod_autoneg_restart(PHYMOD_ST* pc, temod_an_control_t *an_control)
{   
    AN_X4_ENSr_t reg_an_enb;
  ...
  switch (an_control->an_type) {
    ...
    if(an_control->enable){
     ...
     /*0x9254 AN_X1_TIMERS_cl73_error*/ 
      ...
      if((an_control->an_property_type & TEMOD_AN_PROPERTY_ENABLE_SGMII_TO_CL37_AUTO)||sgmii_to_cl37)
...
int temod_get_plldiv(PHYMOD_ST *pc,  uint32_t *pll_div)
{
  ...
  *pll_div = PLL_CAL_CTL7r_PLL_MODEf_GET(reg_ctl7);
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("temod_get_pll_div: reg=0x%"PRIx32"\n", *pll_div));

  return PHYMOD_E_NONE;
}

int temod_pll_config_set(const phymod_access_t *pa, temod_pll_mode_type  pll_mode, phymod_ref_clk_t ref_clk)
{
  enum eagle_tsc_pll_enum pll_cfg;

  switch (pll_mode) {

  case TEMOD_PLL_MODE_DIV_72:
    pll_cfg = EAGLE_TSC_pll_div_72x;
    break;
  case TEMOD_PLL_MODE_DIV_40:
    pll_cfg = EAGLE_TSC_pll_div_40x;
    break;
  case TEMOD_PLL_MODE_DIV_42:
    pll_cfg = EAGLE_TSC_pll_div_42x;
    break;
  case TEMOD_PLL_MODE_DIV_50:
    pll_cfg = EAGLE_TSC_pll_div_50x;
    break;
  case TEMOD_PLL_MODE_DIV_52:
    pll_cfg = EAGLE_TSC_pll_div_52x;
    break;
  case TEMOD_PLL_MODE_DIV_60:
    pll_cfg = EAGLE_TSC_pll_div_60x;
    break;
  case TEMOD_PLL_MODE_DIV_64:
    pll_cfg = EAGLE_TSC_pll_div_64x;
    break;
  case TEMOD_PLL_MODE_DIV_66:
    pll_cfg = EAGLE_TSC_pll_div_66x;
    break;
  case TEMOD_PLL_MODE_DIV_68:
    pll_cfg = EAGLE_TSC_pll_div_68x;
    break;
  case TEMOD_PLL_MODE_DIV_70:
    pll_cfg = EAGLE_TSC_pll_div_70x;
    break;
  case TEMOD_PLL_MODE_DIV_80:
    if (ref_clk == phymodRefClk125Mhz) {
        pll_cfg = EAGLE_TSC_pll_div_80x_refc125;
    } else {
        pll_cfg = EAGLE_TSC_pll_div_80x;
    }
    break;
  case TEMOD_PLL_MODE_DIV_82P5:
    pll_cfg = EAGLE_TSC_pll_div_82p5x;
    break;
  case TEMOD_PLL_MODE_DIV_87P5:
    pll_cfg = EAGLE_TSC_pll_div_87p5x;
    break;
  case TEMOD_PLL_MODE_DIV_92:
    pll_cfg = EAGLE_TSC_pll_div_92x;
    break;
  case TEMOD_PLL_MODE_DIV_100:
    pll_cfg = EAGLE_TSC_pll_div_100x;
    break;
  default: 
    pll_cfg = EAGLE_TSC_pll_div_66x;
    break;
  ...
  eagle_tsc_configure_pll(pa, pll_cfg);
...
int temod_pll_config_get(const phymod_access_t *pa, temod_pll_mode_type  *pll_mode)
{
  err_code_t __err = 0;
  uint32_t fracn_sel;
  uint8_t fracn_ndiv;
 ...
 /* pll_vco_div2=rdc_ams_pll_vco_div2(); */
  ...
  if(fracn_sel == 1) {
     switch(fracn_ndiv) {
       case 0x52: *pll_mode = TEMOD_PLL_MODE_DIV_82P5;
                  break;
       case 0x57: *pll_mode = TEMOD_PLL_MODE_DIV_87P5;
                  break;
#if 0
       ...
       case 0xc7: *pll_mode = EAGLE_TSC_pll_div_199p04x;
                  break;
#endif
       default: return PHYMOD_E_CONFIG;

    }
  } else {
     switch(pll_div){
       case 0x1: *pll_mode = TEMOD_PLL_MODE_DIV_72;
                 break;
       case 0xc: *pll_mode = TEMOD_PLL_MODE_DIV_70;
                 break;
       case 0xa: *pll_mode = TEMOD_PLL_MODE_DIV_66;
                 break;
       case 0x9: *pll_mode = TEMOD_PLL_MODE_DIV_64;
                 break;
       case 0x8: *pll_mode = TEMOD_PLL_MODE_DIV_60;
                 break;
       case 0x6: *pll_mode = TEMOD_PLL_MODE_DIV_52;
                 break;
       case 0x3: *pll_mode = TEMOD_PLL_MODE_DIV_42;
                 break;
       case 0x2: *pll_mode = TEMOD_PLL_MODE_DIV_40;
                 break;
       case 0xf: *pll_mode = TEMOD_PLL_MODE_DIV_100;
                 break;
       case 0xe: *pll_mode = TEMOD_PLL_MODE_DIV_92;
                 break;
       case 0xb: *pll_mode = TEMOD_PLL_MODE_DIV_68;
                 break;
       case 0x5: *pll_mode = TEMOD_PLL_MODE_DIV_50;
                 break;
       /*case 0x0: *pll_mode = TEMOD_PLL_MODE_DIV_46;
                 break; */
       case 0xd: *pll_mode = TEMOD_PLL_MODE_DIV_80;
                 break;
...
*/
int temod_set_an_port_mode(PHYMOD_ST* pc, int enable, int nl_encoded, int starting_lane, int single_port)    /* SET_AN_PORT_MODE */
{
  uint16_t rdata;
  ...
  TEMOD_DBG_IN_FUNC_INFO(pc);
  TEMOD_DBG_IN_FUNC_VIN_INFO(pc,("nl_encoded: %d, starting_lane: %d, single_port: %d\n", nl_encoded, starting_lane, single_port));
...
#ifdef _SDK_TEMOD_
int temod_refclk_set(PHYMOD_ST* pc, phymod_ref_clk_t ref_clock) 
{
    MAIN0_SETUPr_t  reg_setup;
...
int temod_cl37_high_vco_set(PHYMOD_ST* pc, int value)
{
  MAIN0_SETUPr_t  reg_setup;
...
It selects the encode type based on the speed of the port.
*/
int temod_encode_set(PHYMOD_ST* pc, temod_spd_intfc_type spd_intf, uint16_t enable)
{
  uint16_t  hg2_message_invalid_code_enable, hg2_codec, hg2_en ;
  TX_X4_ENC0r_t    reg_encode;
...
int temod_hg_enable_get(PHYMOD_ST* pc, int *enable)
{
  TX_X4_ENC0r_t    reg_encode;
...
int temod_encode_mode_get(PHYMOD_ST* pc, temod_encoder_type_t *mode)
{
  ...
  *mode = SC_X4_RSLVD0r_ENCODEMODEf_GET(reg_resolved);
...
int temod_decode_set(PHYMOD_ST* pc, temod_spd_intfc_type spd_intf, uint16_t enable)
{
  uint16_t hg2_message_ivalid_code_enable, hg2_en, hg2_codec;
  RX_X4_DEC_CTL0r_t    reg_decode_ctrl;
...
*/
int temod_tx_lane_control_set(PHYMOD_ST* pc, tx_lane_disable_type_t tx_dis_type)         /* TX_LANE_CONTROL */
{
  TX_X4_MISCr_t    reg_misc_ctrl;

  TEMOD_DBG_IN_FUNC_INFO(pc);
  TX_X4_MISCr_CLR(reg_misc_ctrl);
  TEMOD_DBG_IN_FUNC_VIN_INFO(pc,("tx_dis_type: %d", tx_dis_type));

  switch(tx_dis_type) {
    case TEMOD_TX_LANE_RESET: 
      ...
      PHYMOD_IF_ERR_RETURN (MODIFY_TX_X4_MISCr(pc, reg_misc_ctrl));
    break;
    case TEMOD_TX_LANE_TRAFFIC_ENABLE: 
      TX_X4_MISCr_ENABLE_TX_LANEf_SET(reg_misc_ctrl, 1);
      PHYMOD_IF_ERR_RETURN (MODIFY_TX_X4_MISCr(pc, reg_misc_ctrl));
    break;
    case TEMOD_TX_LANE_TRAFFIC_DISABLE: 
      TX_X4_MISCr_ENABLE_TX_LANEf_SET(reg_misc_ctrl, 0);
      PHYMOD_IF_ERR_RETURN (MODIFY_TX_X4_MISCr(pc, reg_misc_ctrl));
    break;
    case TEMOD_TX_LANE_RESET_TRAFFIC_ENABLE: 
      TX_X4_MISCr_RSTB_TX_LANEf_SET(reg_misc_ctrl, 1);
      PHYMOD_IF_ERR_RETURN (MODIFY_TX_X4_MISCr(pc, reg_misc_ctrl));
      TX_X4_MISCr_CLR(reg_misc_ctrl);
      TX_X4_MISCr_ENABLE_TX_LANEf_SET(reg_misc_ctrl, 1);
      PHYMOD_IF_ERR_RETURN (MODIFY_TX_X4_MISCr(pc, reg_misc_ctrl));
    break;
    case TEMOD_TX_LANE_RESET_TRAFFIC_DISABLE: 
      TX_X4_MISCr_RSTB_TX_LANEf_SET(reg_misc_ctrl, 0);
      PHYMOD_IF_ERR_RETURN (MODIFY_TX_X4_MISCr(pc, reg_misc_ctrl));
      TX_X4_MISCr_CLR(reg_misc_ctrl);
      TX_X4_MISCr_ENABLE_TX_LANEf_SET(reg_misc_ctrl, 0);
...
*/
int temod_tx_lane_control_get(PHYMOD_ST* pc, int *reset, int *enable)         /* TX_LANE_CONTROL_GET */
{
  TX_X4_MISCr_t    reg_misc_ctrl;
...
int temod_revid_read(PHYMOD_ST* pc, uint32_t *revid)              /* REVID_READ */
{
  ...
  *revid=_temod_getRevDetails(pc);
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("revid: %"PRIx32"", *revid));
  return PHYMOD_E_NONE;
}
...
int temod_init_pcs(PHYMOD_ST* pc)              /* INIT_PCS */
{
  ...
  temod_rx_lane_control_set(pc, 1);
  temod_tx_lane_control_set(pc, TEMOD_TX_LANE_RESET_TRAFFIC_ENABLE);         /* TX_LANE_CONTROL */
...
*/
int temod_set_spd_intf(PHYMOD_ST *pc, temod_spd_intfc_type spd_intf, int no_trig)
{
...
int temod_get_pcs_link_status(PHYMOD_ST* pc, uint32_t *link)
{
  ...
  *link = RX_X4_PCS_LIVE_STSr_LINK_STATUSf_GET(reg_pcs_live_sts);
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("pcs_live_stats_link: %d", (int)*link));
...
clock on the receive line.
*/
int temod_get_pcs_latched_link_status(PHYMOD_ST* pc, uint32_t *link)
{
  RX_X4_PCS_LIVE_STSr_t   reg_pcs_live_sts;
  ...
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("pcs_latched_stats_link: %d LL=%0d", (int)*link, latched_val));
...
*/
int temod_mld_am_timers_set(PHYMOD_ST* pc) /*MLD_AM_TIMERS_SET */
{
  TX_X2_MLD_SWP_CNTr_t reg_mld_swap_cnt;
...
*/
int temod_plldiv_lkup_get(PHYMOD_ST* pc, temod_spd_intfc_type spd_intf, phymod_ref_clk_t ref_clk,  uint32_t *plldiv, uint16_t *speed_vec)
{
  int speed_id;

  get_mapped_speed(spd_intf, &speed_id);
  if (ref_clk == phymodRefClk125Mhz) {
    *plldiv = eagle_sc_pmd_entry_125M_refclk[speed_id].pll_mode;
  } else {
...
int temod_osmode_lkup_get(PHYMOD_ST* pc, temod_spd_intfc_type spd_intf, uint32_t *osmode)
{
  ...
  *osmode = eagle_sc_pmd_entry[speed_id].t_pma_os_mode; 
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("osmode: %d", (int)*osmode));
...
int temod_osdfe_on_lkup_get(PHYMOD_ST* pc, temod_spd_intfc_type spd_intf, uint32_t* osdfe_on)
{
  ...
  *osdfe_on = eagle_sc_pmd_entry[speed_id].osdfe_on;
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("osdfe_on: %d", (int)*osdfe_on));
...
*/
int temod_scrambling_dis_lkup_get(PHYMOD_ST* pc, temod_spd_intfc_type spd_intf, uint32_t* scrambling_dis)
{
  int speed_id;

  get_mapped_speed(spd_intf, &speed_id);
  *scrambling_dis = eagle_sc_pmd_entry[speed_id].scrambling_dis;
  TEMOD_DBG_IN_FUNC_VOUT_INFO(pc,("scrambling_dis: %d", (int)*scrambling_dis));
...
*/
int temod_pcs_ilkn_mode_set(PHYMOD_ST* pc)              /* INIT_PCS_ILKN */
{
  SC_X4_BYPASSr_t reg_sc_bypass;
...
*/
int temod_pcs_ilkn_chk(PHYMOD_ST* pc, int *ilkn_set)              /* INIT_PCS_ILKN */
{
...
@details Per lane PMD ln_rst and ln_dp_rst by writing to PMD_X4_CONTROL in pcs space
*/
int temod_pmd_x4_reset_get(PHYMOD_ST* pc, int *is_in_reset)              /* PMD_X4_RESET */
{
  PMD_X4_CTLr_t reg_pmd_x4_ctrl;
...
*/
int temod_pmd_osmode_get(PHYMOD_ST* pc, int *os_mode)   /* INIT_PMD */
{
  CKRST_OSR_MODE_CTLr_t    reg_osr_mode;
...
int temod_override_clear(PHYMOD_ST* pc, override_type_t or_type)
{
...
@details The cntl encoding is as follows.
          ...
          SCR_MODE_OEN
*/
int temod_override_get(PHYMOD_ST* pc, override_type_t or_type, uint16_t *or_en,  uint16_t *or_val)   /* OVERRIDE_GET */
{
  SC_X4_FLD_OVRR_EN0_TYPEr_t reg_or_en0;
  SC_X4_FLD_OVRR_EN1_TYPEr_t reg_or_en1;
  CL72_LNK_CTLr_t reg_cl72_link_ctrl;
  ...
  case TEMOD_OVERRIDE_FEC_EN :
       TX_X4_MISCr_CLR(reg_misc_or_val);
       READ_TX_X4_MISCr(pc,&reg_misc_or_val);
  ...
  case TEMOD_OVERRIDE_DESKEW_MODE:
       RX_X4_PCS_CTL0r_CLR(reg_pcs_or_val);
       READ_RX_X4_PCS_CTL0r(pc,&reg_pcs_or_val);
  ...
  case TEMOD_OVERRIDE_CHKEND_EN:
       RX_X2_MISC0r_CLR(reg_misc0_or_val);
       READ_RX_X2_MISC0r(pc,&reg_misc0_or_val);
  ...
  case TEMOD_OVERRIDE_BLKSYNC_MODE:
       RX_X4_DEC_CTL0r_CLR(reg_dec_or_val);
       READ_RX_X4_DEC_CTL0r(pc, &reg_dec_or_val);
  ...
  case TEMOD_OVERRIDE_REORDER_EN :
       RX_X4_CL36_RX0r_CLR(reg_cl36_or_val);
       READ_RX_X4_CL36_RX0r(pc,&reg_cl36_or_val);
  ...
  case TEMOD_OVERRIDE_ENCODE_MODE:
       TX_X4_ENC0r_CLR(reg_encode_or_val);
       READ_TX_X4_ENC0r(pc,&reg_encode_or_val);
...
*/
int temod_credit_override_set(PHYMOD_ST* pc, credit_type_t credit_type, uint16_t userCredit)   /* CREDIT_OVERRIDE_SET */
{
...
*/
int temod_credit_override_get(PHYMOD_ST* pc, credit_type_t credit_type, uint16_t *userCredit_en, uint16_t *userCredit)
{
  SC_X4_FLD_OVRR_EN1_TYPEr_t    reg_enable_type;
  TX_X4_CRED0r_t          reg_credit0;
  TX_X4_CRED1r_t          reg_credit1;
...
int temod_clause72_control(PHYMOD_ST* pc, uint32_t cl_72_en)                /* CLAUSE_72_CONTROL */
{
  ...
  for (i = (num_lane-1); i >= 0; i--) {
    ...
    if (cl_72_en & TEMOD_CL72_CONTROL_MASK ) {
  ...
  pa_copy.lane_mask = 0x1 << start_lane;
  if(!(cl_72_en & TEMOD_CL72_CONTROL_NO_TRIGER)) {
      PHYMOD_IF_ERR_RETURN(temod_speed_id_get(pc, &speed_id));
      temod_disable_get(&pa_copy,&enable);
      /*If it`s 100G,always trigger speed change*/
      if((enable == 0x1) || (speed_id >= 0x24 && speed_id <= 0x27)) {
          PHYMOD_IF_ERR_RETURN (temod_trigger_speed_change(&pa_copy));
      }
  }
...
int temod_pmd_override_control(PHYMOD_ST* pc, int cntl, int value)           /* PMD_OVERRIDE_CONTROL */
{
  ...
  if(cntl & 0x8000) {  /*  ln_dp_h_rstb_oen */
    PMD_X4_OVRRr_LN_DP_H_RSTB_OENf_SET(reg_ovr,(value & 0x0080) >> 7);
  }
  ...
  if(cntl & 0x1000) {  /*  osr_mode_oen */
    PMD_X4_OVRRr_OSR_MODE_OENf_SET (reg_ovr, (value & 0x0010) >> 4);
  }
...
int temod_tx_squelch_set(PHYMOD_ST *pc, int enable)
{
  ...
  READ_TXFIR_MISC_CTL1r(pc, &tx_misc_ctl);
...
*/
int temod_st_control_field_get (PHYMOD_ST* pc,uint16_t st_entry_no, override_type_t  st_control_field, uint16_t *st_field_value){
...
@details Gets the field of the Soft Table
*/
int temod_st_credit_field_get (PHYMOD_ST* pc,uint16_t st_entry_no, credit_type_t credit_type, uint16_t* st_field_value){
...
*/
int temod_an_ncl72_inhibit_timer_set(PHYMOD_ST* pc, uint16_t value)
{
  AN_X1_LNK_FAIL_INHBT_TMR_NOT_CL72r_t reg_inhibit_not_timer;
...
@details an_ncl72_inhibit timer Set
*/
int temod_an_ncl72_inhibit_timer_get(PHYMOD_ST* pc, uint16_t *value)
{
  AN_X1_LNK_FAIL_INHBT_TMR_NOT_CL72r_t reg_inhibit_not_timer;
...
*/
int temod_cl74_chng_default (PHYMOD_ST* pc)
{
...
int temod_an_oui_set(PHYMOD_ST* pc, temod_an_oui_t oui) {
...
int temod_an_oui_get(PHYMOD_ST* pc, temod_an_oui_t* oui) {
...
int temod_fec_correctable_counter_get(PHYMOD_ST* pc, uint32_t* count)
{
    RX_X4_FEC_CORRBLKSLr_t countl;
    RX_X4_FEC_CORRBLKSHr_t counth;
    RX_X4_T12_FEC_CORRBLKSLr_t count12l;
    RX_X4_T12_FEC_CORRBLKSHr_t count12h;
    uint32_t count_vl1 = 0, count_vl2 = 0;

    /* Per lane based counter */
    /* 1 physical lane can map to 2 virtual lane */
    PHYMOD_IF_ERR_RETURN (READ_RX_X4_FEC_CORRBLKSLr(pc, &countl));
    PHYMOD_IF_ERR_RETURN (READ_RX_X4_FEC_CORRBLKSHr(pc, &counth));
    count_vl1 = (RX_X4_FEC_CORRBLKSHr_GET(counth) << 16) | (RX_X4_FEC_CORRBLKSLr_GET(countl) & 0xffff);

    PHYMOD_IF_ERR_RETURN (READ_RX_X4_T12_FEC_CORRBLKSLr(pc, &count12l));
    PHYMOD_IF_ERR_RETURN (READ_RX_X4_T12_FEC_CORRBLKSHr(pc, &count12h));
    count_vl2 = (RX_X4_T12_FEC_CORRBLKSHr_GET(count12h) << 16) | (RX_X4_T12_FEC_CORRBLKSLr_GET(count12l) & 0xffff);

    /* Check overflow */
    /* If count_vl1 + count_vl2 > 0xffffffff, will casue overflow, return 0xffffffff */
    if (count_vl2 > 0xffffffff - count_vl1) {
        *count = 0xffffffff;
    } else {
        *count = count_vl1 + count_vl2;
    }

    return PHYMOD_E_NONE;
}

int temod_fec_uncorrectable_counter_get(PHYMOD_ST* pc, uint32_t* count)
{
    RX_X4_FEC_UNCORRBLKSLr_t countl;
    RX_X4_FEC_UNCORRBLKSHr_t counth;
    RX_X4_T12_FEC_UNCORRBLKSLr_t count12l;
    RX_X4_T12_FEC_UNCORRBLKSHr_t count12h;
    uint32_t count_vl1 = 0, count_vl2 = 0;

    /* Per lane based counter */
    /* 1 physical lane can map to 2 virtual lane */
    PHYMOD_IF_ERR_RETURN(READ_RX_X4_FEC_UNCORRBLKSLr(pc, &countl));
    PHYMOD_IF_ERR_RETURN(READ_RX_X4_FEC_UNCORRBLKSHr(pc, &counth));
    count_vl1 = (RX_X4_FEC_UNCORRBLKSHr_GET(counth) << 16) | (RX_X4_FEC_UNCORRBLKSLr_GET(countl) & 0xffff);

    PHYMOD_IF_ERR_RETURN(READ_RX_X4_T12_FEC_UNCORRBLKSLr(pc, &count12l));
    PHYMOD_IF_ERR_RETURN(READ_RX_X4_T12_FEC_UNCORRBLKSHr(pc, &count12h));
    count_vl2 = (RX_X4_T12_FEC_UNCORRBLKSHr_GET(count12h) << 16) | (RX_X4_T12_FEC_UNCORRBLKSLr_GET(count12l) & 0xffff);
...
int temod_bip_error_counter_get(PHYMOD_ST* pc, uint32_t* count)
{
    RX_X4_BERCNTr_t bercnt;

    PHYMOD_IF_ERR_RETURN (READ_RX_X4_BERCNTr(pc, &bercnt));
    *count = RX_X4_BERCNTr_BIP_ERROR_COUNT_PER_LANEf_GET(bercnt);

    return PHYMOD_E_NONE;
}

/* The number of times BER_BAD_SH state is entered for cl49. */
int temod_cl49_ber_counter_get(PHYMOD_ST* pc, uint32_t* count)
{
    RX_X4_BERCNTr_t bercnt;

    PHYMOD_IF_ERR_RETURN (READ_RX_X4_BERCNTr(pc, &bercnt));
    *count = RX_X4_BERCNTr_BER_COUNT_PER_LNf_GET(bercnt);

    return PHYMOD_E_NONE;
}

/* The number of times BER_BAD_SH state is entered for cl82. */
int temod_cl82_ber_counter_get(PHYMOD_ST* pc, uint32_t* count)
{
    RX_X4_BERCNTr_t count_lo;
    CL82_BER_HO_STSr_t count_ho;

    PHYMOD_IF_ERR_RETURN (READ_RX_X4_BERCNTr(pc, &count_lo));
    PHYMOD_IF_ERR_RETURN (READ_CL82_BER_HO_STSr(pc, &count_ho));

    *count = (CL82_BER_HO_STSr_BER_HOf_GET(count_ho) << 8) | (RX_X4_BERCNTr_BER_COUNT_PER_LNf_GET(count_lo));

    return PHYMOD_E_NONE;
}

int temod_hg2_codec_set(PHYMOD_ST* pc, temod_hg2_codec_t hg2_codec)
{
...
int temod_hg2_codec_get(PHYMOD_ST* pc, temod_hg2_codec_t* hg2_codec)
{
  TX_X4_ENC0r_t  TX_X4_ENC0_reg;
  ...
  if (TX_X4_ENC0r_HG2_ENABLEf_GET(TX_X4_ENC0_reg)) {
    if (TX_X4_ENC0r_HG2_CODECf_GET(TX_X4_ENC0_reg)) {
        *hg2_codec = TEMOD_HG2_CODEC_ON_8BYTE_IPG;
    } else {
        *hg2_codec = TEMOD_HG2_CODEC_ON_9BYTE_IPG;
    }
  } else {
        *hg2_codec = TEMOD_HG2_CODEC_OFF;
  }
  return PHYMOD_E_NONE;
}

int temod_sgmii_master_set(PHYMOD_ST* pc, int master)
{
  AN_X4_LOC_DEV_CL37_BASE_ABILr_t    reg_cl37_base_abilities;

  AN_X4_LOC_DEV_CL37_BASE_ABILr_CLR(reg_cl37_base_abilities);
  AN_X4_LOC_DEV_CL37_BASE_ABILr_SGMII_MASTER_MODEf_SET(reg_cl37_base_abilities, master);
...
int temod_sgmii_master_get(PHYMOD_ST* pc, int* master)
{
  AN_X4_LOC_DEV_CL37_BASE_ABILr_t    reg_cl37_base_abilities;

  PHYMOD_IF_ERR_RETURN (READ_AN_X4_LOC_DEV_CL37_BASE_ABILr(pc, &reg_cl37_base_abilities));
  *master = AN_X4_LOC_DEV_CL37_BASE_ABILr_SGMII_MASTER_MODEf_GET(reg_cl37_base_abilities);

  return PHYMOD_E_NONE;
}

STATIC
int _temod_rx_phy_lane_get(PHYMOD_ST *pc, int rx_logical_lane, int* rx_phy_lane)
{
    ...
    switch (rx_logical_lane) {
        case 0:
            *rx_phy_lane = MAIN0_LN_SWPr_LOG0_TO_PHY_LNSWAP_SELf_GET(reg_lane_swap);
            break;
        case 1:
            *rx_phy_lane = MAIN0_LN_SWPr_LOG1_TO_PHY_LNSWAP_SELf_GET(reg_lane_swap);
            break;
        case 2:
            *rx_phy_lane = MAIN0_LN_SWPr_LOG2_TO_PHY_LNSWAP_SELf_GET(reg_lane_swap);
            break;
        case 3:
            *rx_phy_lane = MAIN0_LN_SWPr_LOG3_TO_PHY_LNSWAP_SELf_GET(reg_lane_swap);
            break;
        default:
...
int temod_synce_mode_set(PHYMOD_ST *pc, int mode)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (_temod_rx_phy_lane_get(pc, start_lane, &phy_lane));
...
int temod_synce_mode_get(PHYMOD_ST *pc, int *mode)
{
    int start_lane = 0, num_lane = 0, phy_lane = 0;
    MAIN0_SYNCE_CTLr_t reg_main0_synce_ctl;
