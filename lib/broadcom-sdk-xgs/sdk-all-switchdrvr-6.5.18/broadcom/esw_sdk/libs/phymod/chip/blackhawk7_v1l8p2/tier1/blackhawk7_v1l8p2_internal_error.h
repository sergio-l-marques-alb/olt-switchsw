 ...
 */
#define blackhawk7_v1l8p2_error_report(sa__, err_code) \
        blackhawk7_v1l8p2_INTERNAL_print_err_msg_and_triage_info(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
/**@}*/
/* Prints error code, containing function, file and line number */
#define blackhawk7_v1l8p2_error(sa__, err_code) \
        blackhawk7_v1l8p2_INTERNAL_print_err_msg(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
 ...
 * @return Error Code
 */
err_code_t blackhawk7_v1l8p2_INTERNAL_print_err_msg(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 * @return Error Code
 */
err_code_t blackhawk7_v1l8p2_INTERNAL_print_err_msg_and_triage_info(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
