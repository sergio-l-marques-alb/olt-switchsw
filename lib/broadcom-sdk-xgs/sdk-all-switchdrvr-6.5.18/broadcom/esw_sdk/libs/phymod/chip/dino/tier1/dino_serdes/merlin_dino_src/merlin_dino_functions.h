/****************************************************************************
 * File Name  :  merlin_dino_functions.h
 * Created On :  29/04/2013
 * Created By :  Kiran Divakar
 * Description:  Header file with API functions for Serdes IPs
 * Revision   :  $Id: merlin_dino_functions.h 1282 2015-12-04 12:20:52Z eroes $
 *
...
#ifndef MERLIN_DINO_API_FUNCTIONS_H
#define MERLIN_DINO_API_FUNCTIONS_H
...
/**
 * This build includes register access macros for the MERLIN/DINO core.
 */
#include "merlin_dino_fields.h"
...
/** Base of core variable block, MERLIN M0 variant. */
#define CORE_VAR_RAM_BASE (0x400)
/** Base of lane variable block, MERLIN M0 variant. */
#define LANE_VAR_RAM_BASE (0x440)
/** Size of lane variable block, MERLIN M0 variant. */
#define LANE_VAR_RAM_SIZE (0xA0)
