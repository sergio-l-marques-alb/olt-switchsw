...
__phymod__dispatch__t__ phymod_blackhawk7_v1l8p1_driver = {

    blackhawk7_v1l8p1_core_identify,
    blackhawk7_v1l8p1_core_info_get,
    blackhawk7_v1l8p1_core_lane_map_set,
    blackhawk7_v1l8p1_core_lane_map_get,
    blackhawk7_v1l8p1_core_reset_set,
    blackhawk7_v1l8p1_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    blackhawk7_v1l8p1_phy_firmware_lane_config_set,
    blackhawk7_v1l8p1_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    blackhawk7_v1l8p1_phy_rx_restart,
    blackhawk7_v1l8p1_phy_polarity_set,
    blackhawk7_v1l8p1_phy_polarity_get,
    blackhawk7_v1l8p1_phy_tx_set,
    blackhawk7_v1l8p1_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    blackhawk7_v1l8p1_phy_media_type_tx_get,
    ...
    blackhawk7_v1l8p1_phy_rx_adaptation_resume,
    ...
    blackhawk7_v1l8p1_phy_tx_lane_control_set,
    blackhawk7_v1l8p1_phy_tx_lane_control_get,
    blackhawk7_v1l8p1_phy_rx_lane_control_set,
    blackhawk7_v1l8p1_phy_rx_lane_control_get,
    ...
    blackhawk7_v1l8p1_phy_cl72_set,
    blackhawk7_v1l8p1_phy_cl72_get,
    blackhawk7_v1l8p1_phy_cl72_status_get,
    ...
    blackhawk7_v1l8p1_core_init,
    blackhawk7_v1l8p1_phy_pll_multiplier_get,
    blackhawk7_v1l8p1_phy_init,
    blackhawk7_v1l8p1_phy_loopback_set,
    blackhawk7_v1l8p1_phy_loopback_get,
    blackhawk7_v1l8p1_phy_rx_pmd_locked_get,
    blackhawk7_v1l8p1_phy_rx_signal_detect_get,
    ...
    blackhawk7_v1l8p1_phy_reg_read,
    blackhawk7_v1l8p1_phy_reg_write,
    ...
    blackhawk7_v1l8p1_phy_eye_margin_est_get,
    ...
    blackhawk7_v1l8p1_phy_speed_config_set,
    blackhawk7_v1l8p1_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    blackhawk7_v1l8p1_phy_tx_taps_default_get,
    blackhawk7_v1l8p1_phy_lane_config_default_get,
    blackhawk7_v1l8p1_phy_firmware_load_info_get,
    ...
    blackhawk7_v1l8p1_phy_tx_pam4_precoder_enable_set,
    blackhawk7_v1l8p1_phy_tx_pam4_precoder_enable_get,
    blackhawk7_v1l8p1_phy_tx_phase_lock_set,
    NULL, /* phymod_phy_pll_reconfig */
    blackhawk7_v1l8p1_phy_pll_pwrdn,
    ...
    blackhawk7_v1l8p1_phy_channel_loss_hint_set,
    blackhawk7_v1l8p1_phy_channel_loss_hint_get,
    ...
    blackhawk7_v1l8p1_phy_pmd_info_init,
