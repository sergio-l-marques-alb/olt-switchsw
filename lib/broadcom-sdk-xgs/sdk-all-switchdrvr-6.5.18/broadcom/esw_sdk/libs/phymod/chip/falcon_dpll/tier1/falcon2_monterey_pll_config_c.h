/**************************************************************************************
**************************************************************************************
*  File Name     :  falcon2_monterey_pll_config.c                                    *
*  Created On    :  02/24/2015                                                       *
*  Created By    :  Kiran Divakar                                                    *
*  Description   :  Falcon2 MONTEREY PLL Configuration API                                *
*  Revision      :  $Id: falcon2_monterey_pll_config.c 1560 2017-07-17 23:46:38Z kirand $  *
*                                                                                    *
...
/** @file
 * Falcon2_MONTEREY Repeater PLL Configuration
 */
...
err_code_t falcon2_monterey_configure_pll (const phymod_access_t *pa, enum falcon2_monterey_pll_enum pll_cfg){
#ifndef ATE_LOG
	uint8_t reset_state;
	...
	if (reset_state < 7) {
		EFUN_PRINTF(("ERROR: falcon2_monterey_configure_pll (pa, ..) called for PLL %u without core_dp_s_rstb=0\n", (unsigned)falcon2_monterey_get_pll(pa)));
	...
	/*  Integer Mode  */
	/******************/
	case FALCON2_MONTEREY_pll_div_80x:
	...
	case FALCON2_MONTEREY_pll_div_128x_vco2:
		...
		EFUN(wrc_ams_pll_vco_indicator(   0));
		break;
	case FALCON2_MONTEREY_pll_div_132x:
		/* pll_ mode<4:0> = 00100 , VCO = 20.625  G, Refclk = 156.25     MHz */
		EFUN(wrc_pll_mode(0x04));
		EFUN(wrc_ams_pll_vco2_15g( 0x0));
		break;
	case FALCON2_MONTEREY_pll_div_132x_refc212:
	...
	case FALCON2_MONTEREY_pll_div_160x:
		...
		EFUN(wrc_ams_pll_vco2_15g( 0x0));
		break;
	case FALCON2_MONTEREY_pll_div_160x_vco2:
		...
		EFUN(wrc_ams_pll_vco_indicator(   0));
		break;
	case FALCON2_MONTEREY_pll_div_160x_refc174:
		...
		EFUN(wrc_ams_pll_vco_indicator(   1));
		break;
	case FALCON2_MONTEREY_pll_div_165x:
		/* pll_ mode<4:0> = 00111, VCO = 25.78125G, Refclk = 156.25      MHz */
		EFUN(wrc_pll_mode(0x07));
		EFUN(wrc_ams_pll_vco2_15g( 0x0));
		break;
	case FALCON2_MONTEREY_pll_div_165x_refc125:
		...
		EFUN(wrc_ams_pll_vco_indicator(   0));
		break;
	case FALCON2_MONTEREY_pll_div_165x_refc122:
		/* pll_ mode<4:0> = 00111, VCO = 20.2752 G, Refclk = 122.88      MHz */
		EFUN(wrc_pll_mode(0x07));
		EFUN(wrc_ams_pll_vco2_15g( 0x1));
		EFUN(wrc_ams_pll_force_kvh_bw(   0));
		EFUN(wrc_ams_pll_kvh_force(   0));
		break;
	case FALCON2_MONTEREY_pll_div_168x:
		/* pll_ mode<4:0> = 01000, VCO = 26.25   G, Refclk = 156.25      MHz */
		EFUN(wrc_pll_mode(0x08));
		EFUN(wrc_ams_pll_vco2_15g( 0x0));
		break;
	case FALCON2_MONTEREY_pll_div_175x:
		/* pll_ mode<4:0> = 01010, VCO = 27.34375G, Refclk = 156.25      MHz */
		EFUN(wrc_pll_mode(0x0A));
		EFUN(wrc_ams_pll_vco2_15g( 0x0));
		break;
	case FALCON2_MONTEREY_pll_div_180x:
		/* pll_ mode<4:0> = 01011 , VCO = 28.125  G, Refclk = 156.25     MHz */
		EFUN(wrc_pll_mode(0x0B));
		EFUN(wrc_ams_pll_vco2_15g( 0x0));
		break;
	case FALCON2_MONTEREY_pll_div_180x_refc125:
...
}   /* falcon2_monterey_configure_pll */
