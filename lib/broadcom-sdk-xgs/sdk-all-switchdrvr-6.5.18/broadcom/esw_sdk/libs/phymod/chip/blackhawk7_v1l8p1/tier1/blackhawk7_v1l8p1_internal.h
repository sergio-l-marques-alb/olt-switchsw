...
/** @file blackhawk7_v1l8p1_internal.h
...
#ifndef BLACKHAWK7_V1L8P1_API_INTERNAL_H
#define BLACKHAWK7_V1L8P1_API_INTERNAL_H
...
/*--------------------------*/
enum blackhawk7_v1l8p1_rx_pam_mode_enum {
    NRZ,
    PAM4_NR,
    PAM4_ER
};
...
/*---------------------------------------*/
enum blackhawk7_v1l8p1_prbs_chk_timer_selection_enum {
    USE_HW_TIMERS = 0,
    USE_SW_TIMERS = 1
};
...
typedef struct {
  ...
  uint16_t link_time;
  /** OSR Mode */
  blackhawk7_v1l8p1_osr_mode_st osr_mode;
  /** Signal Detect */
  uint8_t sig_det;
  ...
  uint8_t soc_neg;
} blackhawk7_v1l8p1_lane_state_st;
...
typedef struct {
  ...
  /** PLL Divider value.  (Same encoding as enum #blackhawk7_v1l8p1_pll_div_enum.) */
  uint32_t pll_div;
  /** PLL Lock */
  uint8_t  pll_lock;
  /** PLL Lock Change*/
  ...
  uint8_t core_status;
} blackhawk7_v1l8p1_core_state_st;
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_num_bits_per_ms(srds_access_t *sa__, uint32_t *num_bits_per_ms);
 ...
 * @return Serdes Info pointer
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_display_BER(srds_access_t *sa__, uint16_t time_ms);
 ...
 * @return Serdes Info pointer
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_BER_string(srds_access_t *sa__, uint16_t time_ms, char *string);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_BER_data(srds_access_t *sa__, uint16_t time_ms, struct ber_data_st *ber_data, enum blackhawk7_v1l8p1_prbs_chk_timer_selection_enum timer_sel);

/** Check CDR lost lock.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param cdrlcklost is set if CDR loses lock
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_prbs_chk_cdr_lock_lost(srds_access_t *sa__, uint8_t *cdrlcklost);
 ...
 * @param prbs_chk_hw_timer_ctrl is a struct to hold timer mode and timeout value that needs to be programmed to corresponding registers
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_prbs_timeout_count_from_time(uint16_t time_ms, uint16_t * time_ms_adjusted, struct prbs_chk_hw_timer_ctrl_st * const prbs_chk_hw_timer_ctrl);

/** Function to add delay to account for hardware synchronization
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_hw_timer_sync_delay(srds_access_t *sa__);
 ...
 * @return Serdes Info pointer
 */
srds_info_t *blackhawk7_v1l8p1_INTERNAL_get_blackhawk7_v1l8p1_info_ptr(srds_access_t *sa__);

/** Get Serdes Info pointer and initialize it if signature doesn't match 
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Serdes Info pointer
 */
srds_info_t *blackhawk7_v1l8p1_INTERNAL_get_blackhawk7_v1l8p1_info_ptr_with_check(srds_access_t *sa__);

/** Checks to see if the stored ucode_version in blackhawk7_v1l8p1_info is matching with the current thread ucode
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if ucode_version does not match or uC rdvariable caused issues (else returns ERR_CODE_NONE)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_match_ucode_from_info(srds_access_t *sa__);

/** Verify the internal blackhawk7_v1l8p1_info.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *blackhawk7_v1l8p1_info_ptr Info_table to be verified
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_verify_blackhawk7_v1l8p1_info(srds_access_t *sa__, srds_info_t const *blackhawk7_v1l8p1_info_ptr);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_check_uc_lane_stopped(srds_access_t *sa__);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_calc_patt_gen_mode_sel(srds_access_t *sa__, uint8_t *mode_sel, uint8_t *zero_pad_len, uint8_t patt_length);
#endif /*SMALL_FOOTPRINT */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_uc_core_config(srds_access_t *sa__, struct blackhawk7_v1l8p1_uc_core_config_st struct_val);

/*---------------------*/
/*  PLL Configuration  */
/*---------------------*/

/** Return whether the fraction portion of a #blackhawk7_v1l8p1_pll_div_enum value is nonzero. */
#define SRDS_INTERNAL_IS_PLL_DIV_FRACTIONAL(div_) (((uint32_t)(div_) & 0xFFFFF000UL) != 0)

/** Extract the integer portion of a #blackhawk7_v1l8p1_pll_div_enum value. */
#define SRDS_INTERNAL_GET_PLL_DIV_INTEGER(div_) (((uint32_t)(div_)) & 0x00000FFFUL)

/** Extract the fraction portion of a #blackhawk7_v1l8p1_pll_div_enum value.
...
/** Compose a value in the same format as a #blackhawk7_v1l8p1_pll_div_enum value.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param refclk Reference clock frequency (enumerated), or BLACKHAWK7_V1L8P1_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param *refclk_freq_hz Resultant reference clock frequency, in Hz.
 * @param *srds_div Divider value (enumerated), or BLACKHAWK7_V1L8P1_PLL_DIV_UNKNOWN to auto-compute.
 *             The final divider value will be filled in if BLACKHAWK7_V1L8P1_PLL_DIV_UNKNOWN.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_resolve_pll_parameters(srds_access_t *sa__,
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
extern err_code_t blackhawk7_v1l8p1_INTERNAL_read_pll_div(srds_access_t *sa__, uint32_t *srds_div);

/** Convert the PLL_DIV to actual PLL divider value and display
 * as part of blackhawk7_v1l8p1_display_core_state_line()
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param srds_div Divider value, in the same encoding as enum #blackhawk7_v1l8p1_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_display_pll_to_divider(srds_access_t *sa__, uint32_t srds_div);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_vco_from_refclk_div(srds_access_t *sa__, uint32_t refclk_freq_hz, enum blackhawk7_v1l8p1_pll_div_enum srds_div, uint32_t *vco_freq_khz, enum blackhawk7_v1l8p1_pll_option_enum pll_option);
 ...
 * @param range_250 determines the range 0 = +/-150mV, 1 = +/-250mV (ignored for OSPREY7)
 * @param slicer_sel slicer for which ladder threshold needs to be calculated. (Required for OSPREY7, unused (can be zero) for all other IPs)
 * @param *nlmv_val updated with claculated ladder threshold voltage(mV)
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_ladder_setting_to_mV(srds_access_t *sa__, int16_t ctrl, uint8_t range_250, afe_override_slicer_sel_t slicer_sel, int16_t *nlmv_val);
 ...
 * @return value of a * b
 */
uint32_t blackhawk7_v1l8p1_INTERNAL_mult_with_overflow_check(uint32_t a, uint32_t b, uint8_t *of);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_pam4_to_bin(srds_access_t *sa__, char var, char bin[]);
 ...
 * @return Error Code generated by invalid hex variable (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_compute_bin(srds_access_t *sa__, char var, char bin[]);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_compute_hex(srds_access_t *sa__, char bin[], uint8_t *hex);
 ...
 * @param *err_code_p pointer to err_code variable which will be returned.
  */
uint8_t blackhawk7_v1l8p1_INTERNAL_stop_micro(srds_access_t *sa__, uint8_t graceful, err_code_t *err_code_p);
/*-----------------------------------*/
...
} blackhawk7_v1l8p1_INTERNAL_event_log_dump_state_t;

/** Callback function for dumping event log, intended to be called by blackhawk7_v1l8p1_INTERNAL_read_event_log_with_callback.
 *  It must also be called once after, with a byte count of 0, to finish printing.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *arg is a blackhawk7_v1l8p1_INTERNAL_event_log_dump_state_t pointer for holding state.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_event_log_dump_callback(srds_access_t *sa__, void *arg, uint8_t byte_count, uint16_t data);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_read_event_log_with_callback(srds_access_t *sa__,
                                                        uint8_t micro_num,
 ...
 * @return Unsigned 8-bit number
 */
uint8_t blackhawk7_v1l8p1_INTERNAL_seconds_to_displayformat(uint32_t seconds, uint8_t *hrs, uint8_t *mins, uint8_t *secs);
 ...
 */
float8_t blackhawk7_v1l8p1_INTERNAL_int32_to_float8(uint32_t input);
#endif
 ...
 */
uint32_t blackhawk7_v1l8p1_INTERNAL_float12_to_uint32(uint8_t input, uint8_t multi);
...
/*-----------------------------*/
/** Read current blackhawk7_v1l8p1 core status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current blackhawk7_v1l8p1 core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_read_core_state(srds_access_t *sa__, blackhawk7_v1l8p1_core_state_st *istate);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_display_core_state_no_newline(srds_access_t *sa__);

/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current blackhawk7_v1l8p1 lane status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current blackhawk7_v1l8p1 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_read_lane_state(srds_access_t *sa__, blackhawk7_v1l8p1_lane_state_st *istate);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_osr_mode(srds_access_t *sa__, blackhawk7_v1l8p1_osr_mode_st *mode);
#endif /* SMALL_FOOTPRINT */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_pam_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_rx_pam_mode_enum *pmode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_decode_br_os_mode(srds_access_t *sa__, uint8_t *br_pd_en);
#endif /* SMALL_FOOTPRINT */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *sig_det Current blackhawk7_v1l8p1 lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current blackhawk7_v1l8p1 lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_sigdet_status(srds_access_t *sa__, uint8_t *sig_det, uint8_t *sig_det_chg);

#ifndef SMALL_FOOTPRINT
/** Read current PMD Lock and PMD Lock change status of a lane.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_lock Current blackhawk7_v1l8p1 lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current blackhawk7_v1l8p1 lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_pmd_lock_status(srds_access_t *sa__, uint8_t *pmd_lock, uint8_t *pmd_lock_chg);

/** Read current PLL Lock and PLL Lock change status of a core.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pll_lock Current blackhawk7_v1l8p1 lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current blackhawk7_v1l8p1 lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_pll_lock_status(srds_access_t *sa__, uint8_t *pll_lock, uint8_t *pll_lock_chg);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_display_lane_state_no_newline(srds_access_t *sa__);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_eye_margin_est(srds_access_t *sa__, uint16_t *left_eye_mUI, uint16_t *right_eye_mUI, uint16_t  *upper_eye_mV, uint16_t *lower_eye_mV);
 ...
 */
uint16_t blackhawk7_v1l8p1_INTERNAL_eye_to_mV(srds_access_t *sa__, uint8_t var, uint8_t ladder_range);
 ...
 * @return Eye opening in mV
 */
uint16_t blackhawk7_v1l8p1_INTERNAL_eye_to_mUI(srds_access_t *sa__, uint8_t var);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_pam_eye_margin_est(srds_access_t *sa__, eye_margin_t *eye_margin);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_display_pam_eye_margin_est(srds_access_t *sa__);

/** Serdes Core ClockGate.
 * Along with blackhawk7_v1l8p1_core_clkgate(), all lanes should also be clock gated using blackhawk7_v1l8p1_lane_clkgate() to complete a Core Clockgate
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param enable Enable clockgate (1 = Enable clokgate; 0 = Disable clockgate)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_core_clkgate(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_lane_clkgate(srds_access_t *sa__, uint8_t enable);
...
/** Set function for PF.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param val PF value to be set
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_pf_main(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_pf_main(srds_access_t *sa__, uint8_t *val);

/** Set function for PF2.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param val PF2 value to be set
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_pf2(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_pf2(srds_access_t *sa__, uint8_t *val);

/** Set function for PF3.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param val  PF3 value to be set
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_pf3(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_pf3(srds_access_t *sa__, uint8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_vga(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_vga(srds_access_t *sa__, uint8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe1(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe1(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe2(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe2(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe3(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe3(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe4(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe4(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe5(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe5(srds_access_t *sa__, int8_t *val);

/* Set/Get DFE tap values */
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe6(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe6(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe7(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe7(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe8(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe8(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe9(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe9(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe10(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe10(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe11(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe11(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe12(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe12(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe13(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe13(srds_access_t *sa__, int8_t *val);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe14(srds_access_t *sa__, int8_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe14(srds_access_t *sa__, int8_t *val);

/*--------------------*/
/*  Get/Set BWR Regs  */
/*--------------------*/
err_code_t blackhawk7_v1l8p1_INTERNAL_get_bwr(srds_access_t *sa__, uint8_t *vga1_bwr, uint8_t *vga2_bwr, uint8_t *eq1_bwr, uint8_t *eq2_bwr);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_bwr(srds_access_t *sa__, uint8_t vga1_bwr, uint8_t vga2_bwr, uint8_t eq1_bwr, uint8_t eq2_bwr, uint8_t vga_dis_ind);
#endif /* SMALL_FOOTPRINT */

/*----------------------*/
/*  Get/Set TXFIR Taps  */
/*----------------------*/
err_code_t blackhawk7_v1l8p1_INTERNAL_load_txfir_taps(srds_access_t *sa__);
err_code_t blackhawk7_v1l8p1_INTERNAL_set_tx_tap(srds_access_t *sa__, uint8_t tap_num, int16_t val);
err_code_t blackhawk7_v1l8p1_INTERNAL_get_tx_tap(srds_access_t *sa__, uint8_t tap_num, int16_t *val);
 ...
 * @param txfir the 6 TXFIR tap values (-168 to +168 when in PAM4 mode, otherwise -127 to +127)
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_validate_full_txfir_cfg(srds_access_t *sa__, enum blackhawk7_v1l8p1_txfir_tap_enable_enum enable_taps, blackhawk7_v1l8p1_txfir_st *txfir);

/** Writes Serdes TXFIR tap settings.
 * Returns failcodes if TXFIR settings are invalid
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param enable_taps Enable TXFIR TAPs based on #blackhawk7_v1l8p1_txfir_tap_enable_enum
 * @param txfir the 6 TXFIR tap values (-168 to +168 when in PAM4 mode, otherwise -63 to +63)
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_apply_full_txfir_cfg(srds_access_t *sa__, enum blackhawk7_v1l8p1_txfir_tap_enable_enum enable_taps, blackhawk7_v1l8p1_txfir_st *txfir);


/* Lane Config Struct */
err_code_t blackhawk7_v1l8p1_INTERNAL_update_uc_lane_config_st(struct blackhawk7_v1l8p1_uc_lane_config_st *st);
err_code_t blackhawk7_v1l8p1_INTERNAL_update_uc_lane_config_word(struct blackhawk7_v1l8p1_uc_lane_config_st *st);

/* Lane User Control Disable Startup Function Struct */
err_code_t blackhawk7_v1l8p1_INTERNAL_update_usr_ctrl_disable_functions_st(struct blackhawk7_v1l8p1_usr_ctrl_disable_functions_st *st);
err_code_t blackhawk7_v1l8p1_INTERNAL_update_usr_ctrl_disable_functions_byte(struct blackhawk7_v1l8p1_usr_ctrl_disable_functions_st *st);

/* Lane User Control Disable Startup DFE Function Struct */
err_code_t blackhawk7_v1l8p1_INTERNAL_update_usr_ctrl_disable_dfe_functions_st(struct blackhawk7_v1l8p1_usr_ctrl_disable_dfe_functions_st *st);
err_code_t blackhawk7_v1l8p1_INTERNAL_update_usr_ctrl_disable_dfe_functions_byte(struct blackhawk7_v1l8p1_usr_ctrl_disable_dfe_functions_st *st);

/* Core Config Struct */
err_code_t blackhawk7_v1l8p1_INTERNAL_update_uc_core_config_st(struct  blackhawk7_v1l8p1_uc_core_config_st *st);
err_code_t blackhawk7_v1l8p1_INTERNAL_update_uc_core_config_word(struct  blackhawk7_v1l8p1_uc_core_config_st *st);

#ifndef SMALL_FOOTPRINT
uint8_t blackhawk7_v1l8p1_INTERNAL_rdb_uc_var(srds_access_t *sa__, err_code_t *err_code_p, uint16_t addr);
uint16_t blackhawk7_v1l8p1_INTERNAL_rdw_uc_var(srds_access_t *sa__, err_code_t *err_code_p, uint16_t addr);
err_code_t blackhawk7_v1l8p1_INTERNAL_wrb_uc_var(srds_access_t *sa__, uint16_t addr, uint8_t wr_val);
err_code_t blackhawk7_v1l8p1_INTERNAL_wrw_uc_var(srds_access_t *sa__, uint16_t addr, uint16_t wr_val);
#endif /* SMALL_FOOTPRINT */
...
err_code_t blackhawk7_v1l8p1_INTERNAL_print_uc_dsc_error(srds_access_t *sa__, enum srds_pmd_uc_cmd_enum cmd);

/** Polls lane variable "usr_diag_status" to verify data is available in uC diag buffer.
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in blackhawk7_v1l8p1_internal.c.
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_poll_diag_done(srds_access_t *sa__, uint16_t *status, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_poll_uc_dsc_ready_for_cmd_equals_1(srds_access_t *sa__, uint32_t timeout_ms, enum srds_pmd_uc_cmd_enum cmd);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_poll_dsc_state_equals_uc_tune(srds_access_t *sa__, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_poll_micro_ra_initdone(srds_access_t *sa__, uint32_t timeout_ms);

/** Utility to figure out if running platform is big endian.
 * @return value of 1 if big endian else 0
 */
uint8_t blackhawk7_v1l8p1_INTERNAL_is_big_endian(void);
/*--------------------------------*/
/*  RAM Block Read with Callback  */
/*--------------------------------*/

/* Utilities to account for endianness when reading from uc RAM */
#define get_endian_offset(addr) (blackhawk7_v1l8p1_INTERNAL_is_big_endian() ? \
                                (\
...
typedef struct {
    uint8_t *mem_ptr;
} blackhawk7_v1l8p1_INTERNAL_rdblk_callback_arg_t;

/** Callback function for reading uc RAM memory by blackhawk7_v1l8p1_INTERNAL_rdblk_uc_generic_ram().
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *arg is a blackhawk7_v1l8p1_INTERNAL_rdblk_callback_arg_t pointer for holding state.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_callback(srds_access_t *sa__, void *arg, uint8_t byte_count, uint16_t data);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_uc_generic_ram(srds_access_t *sa__,
                                                uint32_t block_addr,
                                                uint16_t block_size,
 ...
 *         indefinitely, until cnt bytes total are read.
 *  In other words, this is the same as blackhawk7_v1l8p1_INTERNAL_rdblk_uc_generic_ram(), but reading in descending address order.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param block_addr Address of RAM block to be read.
 *                   For program RAM, the upper 16 bits are 0x0000.  Otherwise, the upper 16 bits are 0x2000.
 * @param block_size Length of RAM block to read.
 ...
 * @return Error Code generated by API or the callback (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_uc_generic_ram_descending(srds_access_t *sa__,
                                                           uint32_t block_addr,
                                                           uint16_t block_size,
                                                           uint16_t start_offset,
                                                           uint16_t cnt,
 ...
 * @return Micro index
 */
uint8_t blackhawk7_v1l8p1_INTERNAL_grp_idx_from_lane(uint8_t lane);


/** Extract the refclk frequency in Hz, based on a blackhawk7_v1l8p1_pll_refclk_enum value. */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_refclk_in_hz(srds_access_t *sa__, enum blackhawk7_v1l8p1_pll_refclk_enum refclk, uint32_t *refclk_in_hz);

/** Retrieve LMS threshold value. */
err_code_t blackhawk7_v1l8p1_INTERNAL_get_lms_thresh_bin(srds_access_t *sa__, int8_t *lms_thresh_bin);
#ifndef SMALL_FOOTPRINT
/**Polls for the dbgfb idx lock
 ** @param sa__ is an opaque state vector passed through to device access functions.
 ** @param timeout_ms polling timeout value in ms  .
 **/
err_code_t blackhawk7_v1l8p1_INTERNAL_poll_dbgfb_idx_lock(srds_access_t *sa__, uint8_t timeout_ms);
/** Reads dbgfb counters.
 ** @param sa__ is an opaque state vector passed through to device access functions.
 ** @param *dbgfb_cfg pointer to dbgfb_cfg_st 
 ** @return Error Code generated by API (ERR_CODE_NONE if no errors)
 **/
err_code_t blackhawk7_v1l8p1_get_dbgfb_summary(srds_access_t *sa__, dbgfb_cfg_st *dbgfb_cfg); 
 ...
 ** @return Error Code generated by API (ERR_CODE_NONE if no errors)
 **/
err_code_t blackhawk7_v1l8p1_collect_dbgfb_stats(srds_access_t *sa__, uint32_t time_in_us, dbgfb_stats_st *dbgfb_stats); 
#endif /* SMALL_FOOTPRINT */


/** Reads the slicer calibration error values
 ** @param sa__ is an opaque state vector passed through to device access functions.
 ** @param *lms_err lms calibration error value
 ** @param *phase_err phase calibration error value
 ** @param *data_err data calibration error value
 ** @param *max_data_err max data calibration error value
 ** @return Error Code generated by API (ERR_CODE_NONE if no errors)
 **/
err_code_t blackhawk7_v1l8p1_INTERNAL_read_cal_error(srds_access_t *sa__, int8_t *lms_err, int8_t *phase_err, int8_t *data_err, int8_t *max_data_err);
 ...
 ** @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_display_info_table(srds_access_t *sa__);

#ifndef SMALL_FOOTPRINT
/** Enable breakpoint
 ** Enables a breakpoint at the given breakpoint param value.
 ** Note: Call before releasing ln_dp_s_rstb.
 ** @param sa__ is an opaque state vector passed through to device access functions.
 ** @param breakpoint index of breakpoint to enable
 ** @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_en_breakpoint(srds_access_t *sa__, uint8_t breakpoint);
 ...
 ** @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_goto_breakpoint(srds_access_t *sa__, uint8_t breakpoint);
 ...
 ** @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_rd_breakpoint(srds_access_t *sa__);
 ...
 ** @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_dis_breakpoint(srds_access_t *sa__);
#endif /* SMALL_FOOTPRINT */
