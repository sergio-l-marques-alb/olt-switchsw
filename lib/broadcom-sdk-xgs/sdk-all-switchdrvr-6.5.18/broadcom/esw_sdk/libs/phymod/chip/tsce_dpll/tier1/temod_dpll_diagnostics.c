/*----------------------------------------------------------------------
 * $Id: temod_diagnostics.c,v 1.2 Broadcom SDK $
...
int temod2pll_diag_link(PHYMOD_ST *pc);
int temod2pll_diag_st(PHYMOD_ST *pc, int resolved_speed);
...
int temod2pll_diag_field_or(PHYMOD_ST *pc)
{
  ...
  PHYMOD_DEBUG_ERROR(("| NUM LANES: 0x%x | FEC ENA  : 0x%X |                                            |\n",
	...
	/* e2s_temod2pll_os_mode_type[RX_X4_PMA_CTL0r_OS_MODEf_GET(os_or)]+6)); */
  ...
  PHYMOD_DEBUG_ERROR(("| 64B66DECR: 0x%x | CHKEND   : 0x%X | %-43s|\n",
	...
	e2s_temod2pll_scr_mode[TX_X4_MISCr_SCR_MODEf_GET(tx_misc_or)]+6));
  ...
  PHYMOD_DEBUG_ERROR(("| FECENABL : 0x%x | REORDER  : 0x%X | %-43s|\n",
	...
	e2s_temod2pll_encode_mode[TX_X4_ENC0r_ENCODEMODEf_GET(encode_or)]+6));
  ...
  PHYMOD_DEBUG_ERROR(("| CL36ENA  : 0x%x | SGMIISPD : 0x%X | %-43s|\n",
    ...
    e2s_temod2pll_descrambler_mode[RX_X4_PCS_CTL0r_DESCRAMBLERMODEf_GET(rx_x4_pcs_ctrl_or)]+6));

  PHYMOD_DEBUG_ERROR(("| CLKCNT0  : 0x%x | CLKCNT1  : 0x%X | %-43s|\n",
         TX_X4_CRED0r_CLOCKCNT0f_GET(crd_or),
         TX_X4_CRED1r_CLOCKCNT1f_GET(crd1_or),
   e2s_temod2pll_decoder_mode[RX_X4_PCS_CTL0r_DECODERMODEf_GET(rx_x4_pcs_ctrl_or)]+6));
  ...
  PHYMOD_DEBUG_ERROR(("| LP CNT0  : 0x%x | LP CNT1  : 0x%X | %-43s|\n",
    ...
    e2s_temod2pll_deskew_mode[RX_X4_PCS_CTL0r_DESKEWMODEf_GET(rx_x4_pcs_ctrl_or)]+6));
  ...
  PHYMOD_DEBUG_ERROR(("| MACCRDGEN: 0x%x | REPLCNT  : 0x%X | %-43s|\n",
    ...
    e2s_temod2pll_descrambler2_mode[RX_X4_PCS_CTL0r_DESC2_MODEf_GET(rx_x4_pcs_ctrl_or)]+6));
  ...
  PHYMOD_DEBUG_ERROR(("| PCSCRDENA: 0x%x | CLK CNT  : 0x%X | %-43s|\n",
	...
	e2s_temod2pll_byte_del_mode[RX_X4_PCS_CTL0r_CL36BYTEDELETEMODEf_GET(rx_x4_pcs_ctrl_or)]+6));


  PHYMOD_DEBUG_ERROR(("| PCSCRDGEN: 0x%x |                | %-43s|\n",
         TX_X4_PCS_CREDGENCNTr_PCS_CREDITGENCNTf_GET(pcs_cgc_or),
	e2s_temod2pll_blocksync_mode[RX_X4_DEC_CTL0r_BLOCK_SYNC_MODEf_GET(blk_sync_or)]+6));
...
**/
int temod2pll_diag_pmd_pcs_lane_cfg(PHYMOD_ST *pc, int lane)
{
  return PHYMOD_E_NONE;
} /* temod2pll_diag_pmd_pcs_lane_cfg */
...
**/
int temod2pll_diag_speed(PHYMOD_ST *pc)
{
  ...
  temod2pll_diag_st(pc, SC_X4_RSLVD_SPDr_SPEEDf_GET(sc_final_resolved_speed));
  temod2pll_diag_field_or(pc);
  ...
  PHYMOD_DEBUG_ERROR(("| SPD CHG VLD  %d    |     OS MODE %-6s | DESCR MODE %-6s| SGMII SPD : %04d |\n",
     ...
     e2s_temod2pll_os_mode_type[CKRST_OSR_MODE_CTLr_OSR_MODE_FRC_VALf_GET(reg_osr_mode)]+18,
     e2s_temod2pll_descrambler_mode[SC_X4_RSLVD1r_DESCRAMBLERMODEf_GET(sc_final_resolved_1)]+20,
  ...
  PHYMOD_DEBUG_ERROR(("| SPD CHG DONE %d    |    SCR MODE %-6s |DECODE MODE %-6s|  CLK CNT0 : %04d |\n",
     ...
     e2s_temod2pll_scr_mode[SC_X4_RSLVD0r_SCR_MODEf_GET(sc_final_resolved_0)]+15,
     e2s_temod2pll_decoder_mode[SC_X4_RSLVD1r_DECODERMODEf_GET(sc_final_resolved_1)]+19,
  ...
  PHYMOD_DEBUG_ERROR(("| SPD RESOLVED %04d |    ENC MODE %-6s |DESKEW MODE %-6s|  CLK CNT1 : %04d |\n",
     ...
     e2s_temod2pll_encode_mode[SC_X4_RSLVD0r_ENCODEMODEf_GET(sc_final_resolved_0)]+18,
     e2s_temod2pll_deskew_mode[SC_X4_RSLVD1r_DESKEWMODEf_GET(sc_final_resolved_1)]+20,
  ...
  PHYMOD_DEBUG_ERROR(("| #LN RESOLVED %04d |BLKSYNC MODE %-6s |DESCR2 MODE %-6s|   LP CNT0 : %04d |\n",
     ...
     e2s_temod2pll_blocksync_mode[SC_X4_RSLVD2r_BLOCK_SYNC_MODEf_GET(sc_final_resolved_2)]+21,
     e2s_temod2pll_descrambler2_mode[SC_X4_RSLVD1r_DESC2_MODEf_GET(sc_final_resolved_1)]+17,
  ...
  PHYMOD_DEBUG_ERROR(("| PLL DIV      %04d |   CL72  ENA : %02d   |  BYTE  DEL %-6s|   LP CNT1 : %04d |\n",
     ...
     e2s_temod2pll_byte_del_mode[SC_X4_RSLVD1r_CL36BYTEDELETEMODEf_GET(sc_final_resolved_1)]+28,
...
*/
int temod2pll_diag_autoneg_abilities(PHYMOD_ST *pc)
{
  AN_X4_ENSr_t                      an_ena;
...
#if 0
  AN_X4_LOC_DEV_CL73_BASE_ABIL2r_t  cl73_base_2;
#endif
...
#if 0
  READ_AN_X4_LOC_DEV_CL73_BASE_ABIL2r (pc, &cl73_base_2);
#endif  
...
#if 0
  PHYMOD_DEBUG_ERROR(("|                                       | 2p5Gbase-x  : %d | 5GBASE KR   : %d    |\n",
       AN_X4_LOC_DEV_CL73_BASE_ABIL2r_BASE_2P5G_ENf_GET(cl73_base_2),
       AN_X4_LOC_DEV_CL73_BASE_ABIL2r_BASE_5P0G_ENf_GET(cl73_base_2)));
#endif
...
int tempd2pll_an_hcd_spd_get (uint16_t spd, char *mystr, int len)
{
  char *an_spd = "UNDEF";
...
*/
int temod2pll_diag_autoneg(PHYMOD_ST *pc)
{
  ...
  tempd2pll_an_hcd_spd_get (AN_X4_AN_ABIL_RESOLUTION_STSr_AN_HCD_SPEEDf_GET(an_hcd_status), an_spd, sizeof(an_spd));
  ...
  temod2pll_diag_autoneg_abilities(pc);
  PHYMOD_DEBUG_ERROR(("+-------------------+--------------------+-----------------+-------------------+\n"));
...
int temod2pll_diag_topology(PHYMOD_ST *pc)
{
  ...
  PHYMOD_DEBUG_ERROR(("| PCSLCL LPBK: %c%c%c%c | PCS LANE SWAP L2P : %d%d%d%d | TX POLARITY : %d | PORT NUM : %d|\n", 
	...
	(pcs_lcl_lb & 2) ? 'Y':'N',
	(pcs_lcl_lb & 1) ? 'Y':'N',
        MAIN0_LN_SWPr_LOG3_TO_PHY_RX_LNSWAP_SELf_GET(pcs_lane_swap),
        MAIN0_LN_SWPr_LOG2_TO_PHY_RX_LNSWAP_SELf_GET(pcs_lane_swap),
        MAIN0_LN_SWPr_LOG1_TO_PHY_RX_LNSWAP_SELf_GET(pcs_lane_swap),
        MAIN0_LN_SWPr_LOG0_TO_PHY_RX_LNSWAP_SELf_GET(pcs_lane_swap),
...
*/
int temod2pll_diag_general(PHYMOD_ST *pc)
{
  temod2pll_diag_topology(pc);
  temod2pll_diag_link(pc);
  temod2pll_diag_autoneg(pc);
  temod2pll_diag_speed(pc);
...
*/
int temod2pll_diag_internal_tfc(PHYMOD_ST *pc)
{
...
{                                                                                                                          \
  ...
  PHYMOD_DEBUG_ERROR(("| %-20s | SGMII SPD : %04d            |                         |\n",                               \
        e2s_temod2pll_descrambler_mode[SC_X1_SPD_##ovr##_1r_DESCRAMBLERMODEf_GET(sc_st##_1)]+6,                                \
        SC_X1_SPD_##ovr##_3r_SGMII_SPD_SWITCHf_GET(sc_st##_3)));                                                           \
                                                                                                                           \
  PHYMOD_DEBUG_ERROR(("| %-20s | %-28s|  CLK CNT0 : %04d        |\n",                                                     \
        e2s_temod2pll_scr_mode[SC_X1_SPD_##ovr##_0r_SCR_MODEf_GET(sc_st##_0)]+6,                                               \
        e2s_temod2pll_decoder_mode[SC_X1_SPD_##ovr##_1r_DECODERMODEf_GET(sc_st##_1)]+6,                                        \
        SC_X1_SPD_##ovr##_3r_CLOCKCNT0f_GET(sc_st##_3)));                                                                  \
                                                                                                                           \
  PHYMOD_DEBUG_ERROR(("| %-20s | %-28s|  CLK CNT1 : %04d        |\n",                                                     \
        e2s_temod2pll_encode_mode[SC_X1_SPD_##ovr##_0r_ENCODEMODEf_GET(sc_st##_0)]+6,                                          \
        e2s_temod2pll_deskew_mode[SC_X1_SPD_##ovr##_1r_DESKEWMODEf_GET(sc_st##_1)]+6,                                          \
        SC_X1_SPD_##ovr##_4r_CLOCKCNT1f_GET(sc_st##_4)));                                                                  \
			                                                                                                               \
  PHYMOD_DEBUG_ERROR(("| %-20s | %-28s|   LP CNT0 : %04d        |\n",                                                     \
        e2s_temod2pll_blocksync_mode[SC_X1_SPD_##ovr##_2r_BLOCK_SYNC_MODEf_GET(sc_st##_2)]+6,                                  \
        e2s_temod2pll_descrambler2_mode[SC_X1_SPD_##ovr##_1r_DESC2_MODEf_GET(sc_st##_1)]+6,                                    \
  ...
  PHYMOD_DEBUG_ERROR(("|   CL72  ENA : %02d     | %-28s|   LP CNT1 : %04d        |\n",                                     \
        ...
        e2s_temod2pll_byte_del_mode[SC_X1_SPD_##ovr##_1r_CL36BYTEDELETEMODEf_GET(sc_st##_1)]+6,                                \
...
*/
int temod2pll_diag_an_timers(PHYMOD_ST* pc)
{
...
*/
int temod2pll_diag_state(PHYMOD_ST* pc)
{
...
@details  Misc debug
*/
int temod2pll_diag_debug(PHYMOD_ST* pc)
{
  return PHYMOD_E_NONE;
}

int temod2pll_diag_g_rd_ram(PHYMOD_ST *pc, int mode, int lane)
{
  return PHYMOD_E_NONE;
}

int temod2pll_diag_g_rd_uC(PHYMOD_ST *pc, int lane)
{
  return PHYMOD_E_NONE;
}

int temod2pll_diag_g_info(PHYMOD_ST *pc)
{
  return PHYMOD_E_NONE;
}

int temod2pll_diag_ieee(PHYMOD_ST *pc)
{
  return PHYMOD_E_NONE;
}
...
*/
int temod2pll_diag(PHYMOD_ST *pc, temod2pll_diag_type diag_type)
{
  int rv;
  rv = PHYMOD_E_NONE;

  PHYMOD_DEBUG_ERROR(("+------------------------------------------------------------------------------+\n"));
  if(diag_type & TEMOD2PLL_DIAG_GENERAL)    rv |= temod2pll_diag_general(pc);
  if(diag_type & TEMOD2PLL_DIAG_TOPOLOGY)   rv |= temod2pll_diag_topology(pc);
  if(diag_type & TEMOD2PLL_DIAG_LINK)       rv |= temod2pll_diag_link(pc);
  if(diag_type & TEMOD2PLL_DIAG_SPEED)      rv |= temod2pll_diag_speed(pc);
  if(diag_type & TEMOD2PLL_DIAG_ANEG)       rv |= temod2pll_diag_autoneg(pc);
  if(diag_type & TEMOD2PLL_DIAG_TFC)        rv |= temod2pll_diag_internal_tfc(pc);
  if(diag_type & TEMOD2PLL_DIAG_AN_TIMERS)  rv |= temod2pll_diag_an_timers(pc);
  if(diag_type & TEMOD2PLL_DIAG_STATE)      rv |= temod2pll_diag_state(pc);
  if(diag_type & TEMOD2PLL_DIAG_DEBUG)      rv |= temod2pll_diag_debug(pc);
  return rv;
}

/*!
*/
int temod2pll_diag_disp(PHYMOD_ST *pc, const char* cmd_str)
{
    temod2pll_diag_type type;
 
    if (!cmd_str) 
        type = TEMOD2PLL_DIAG_GENERAL;
    else if (!PHYMOD_STRCMP(cmd_str, "topo"))
        type = TEMOD2PLL_DIAG_TOPOLOGY;
    else if (!PHYMOD_STRCMP(cmd_str, "link"))
        type = TEMOD2PLL_DIAG_LINK;
    else if (!PHYMOD_STRCMP(cmd_str, "speed"))
        type = TEMOD2PLL_DIAG_SPEED;
    else if (!PHYMOD_STRCMP(cmd_str, "aneg"))
        type = TEMOD2PLL_DIAG_ANEG;
    else if (!PHYMOD_STRCMP(cmd_str, "tfc"))
        type = TEMOD2PLL_DIAG_TFC;
    else if (!PHYMOD_STRCMP(cmd_str, "antimers"))
        type = TEMOD2PLL_DIAG_AN_TIMERS;
    else if (!PHYMOD_STRCMP(cmd_str, "state"))
        type = TEMOD2PLL_DIAG_STATE;
    else if (!PHYMOD_STRCMP(cmd_str, "debug"))
        type = TEMOD2PLL_DIAG_DEBUG;
    else
        type = TEMOD2PLL_DIAG_GENERAL;

    return (temod2pll_diag(pc, type));
}
