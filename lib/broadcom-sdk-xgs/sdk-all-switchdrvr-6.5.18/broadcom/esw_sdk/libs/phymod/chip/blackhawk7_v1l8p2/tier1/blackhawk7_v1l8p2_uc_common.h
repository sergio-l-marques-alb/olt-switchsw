...
/** @file blackhawk7_v1l8p2_uc_common.h
 * Defines and Enumerations shared by Blackhawk IP Specific API and Microcode
 */

#ifndef BLACKHAWK7_V1L8P2_API_UC_COMMON_H
#define BLACKHAWK7_V1L8P2_API_UC_COMMON_H
...
#define OSR_MODE_SUPPORTS_EYE_TESTS(mode) ((mode) < BLACKHAWK7_V1L8P2_OSX16P5)
