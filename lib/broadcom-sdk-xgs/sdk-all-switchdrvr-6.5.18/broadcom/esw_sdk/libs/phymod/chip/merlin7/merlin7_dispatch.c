...
__phymod__dispatch__t__ phymod_merlin7_driver = {

    merlin7_core_identify,
    merlin7_core_info_get,
    merlin7_core_lane_map_set,
    merlin7_core_lane_map_get,
    merlin7_core_reset_set,
    merlin7_core_reset_get,
    merlin7_core_firmware_info_get,
    ...
    merlin7_core_pll_sequencer_restart,
    merlin7_core_wait_event,
    merlin7_phy_rx_restart,
    merlin7_phy_polarity_set,
    merlin7_phy_polarity_get,
    merlin7_phy_tx_set,
    merlin7_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    merlin7_phy_media_type_tx_get,
    merlin7_phy_tx_override_set,
    merlin7_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    merlin7_phy_rx_set,
    merlin7_phy_rx_get,
    NULL, /* phymod_phy_rx_adaptation_resume */
    merlin7_phy_reset_set,
    merlin7_phy_reset_get,
    merlin7_phy_power_set,
    merlin7_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    merlin7_phy_tx_lane_control_set,
    merlin7_phy_tx_lane_control_get,
    merlin7_phy_rx_lane_control_set,
    merlin7_phy_rx_lane_control_get,
    ...
    merlin7_phy_interface_config_set,
    merlin7_phy_interface_config_get,
    merlin7_phy_cl72_set,
    merlin7_phy_cl72_get,
    merlin7_phy_cl72_status_get,
    ...
    merlin7_phy_init,
    merlin7_phy_loopback_set,
    merlin7_phy_loopback_get,
    merlin7_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_signal_detect_get */
    merlin7_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    merlin7_phy_reg_read,
    merlin7_phy_reg_write,
