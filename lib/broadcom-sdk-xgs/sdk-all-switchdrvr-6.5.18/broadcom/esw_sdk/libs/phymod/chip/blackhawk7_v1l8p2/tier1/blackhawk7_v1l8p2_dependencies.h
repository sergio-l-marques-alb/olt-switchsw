...
/** @file blackhawk7_v1l8p2_dependencies.h
...
#ifndef BLACKHAWK7_V1L8P2_API_DEPENDENCIES_H
#define BLACKHAWK7_V1L8P2_API_DEPENDENCIES_H
 ...
 */
err_code_t blackhawk7_v1l8p2_pmd_rdt_reg(srds_access_t *sa__, uint16_t address, uint16_t *val);
 ...
 */
err_code_t blackhawk7_v1l8p2_pmd_wr_reg(srds_access_t *sa__, uint16_t address, uint16_t val);

/** Masked Register Write to the currently selected Serdes IP core/lane.
 * If using Serdes MDIO controller to access the registers, implement this function using blackhawk7_v1l8p2_pmd_mdio_mwr_reg(..)
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function
 *
 *    blackhawk7_v1l8p2_pmd_wr_reg(addr, ((blackhawk7_v1l8p2_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p2_pmd_mwr_reg(srds_access_t *sa__, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t val);
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p2_pmd_wr_pram(srds_access_t *sa__, uint8_t val);
 ...
 */
err_code_t blackhawk7_v1l8p2_delay_ns(srds_access_t *sa__, uint16_t delay_ns);
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p2_delay_us(srds_access_t *sa__, uint32_t delay_us);
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p2_delay_ms(srds_access_t *sa__, uint32_t delay_ms);

/** Return the address of current selected Serdes IP Core.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return the IP level address of the current core.
 */
uint8_t blackhawk7_v1l8p2_get_core(srds_access_t *sa__);
 ...
 */
uint8_t blackhawk7_v1l8p2_get_lane(srds_access_t *sa__);

#define blackhawk7_v1l8p2_get_physical_lane blackhawk7_v1l8p2_get_lane
 ...
 */
err_code_t blackhawk7_v1l8p2_set_lane(srds_access_t *sa__, uint8_t lane_index);

#define blackhawk7_v1l8p2_set_physical_lane blackhawk7_v1l8p2_set_lane
 ...
 */
uint8_t blackhawk7_v1l8p2_get_pll_idx(srds_access_t *sa__);
 ...
 * @return Any error code generated during execution; ERR_CODE NONE otherwise.
 */
err_code_t blackhawk7_v1l8p2_set_pll_idx(srds_access_t *sa__, uint8_t pll_index);
 ...
 */
uint8_t blackhawk7_v1l8p2_get_micro_idx(srds_access_t *sa__);
 ...
 * @return Any error code generated during execution; ERR_CODE NONE otherwise.
 */
err_code_t blackhawk7_v1l8p2_set_micro_idx(srds_access_t *sa__, uint8_t micro_index);

#if defined(SERDES_EXTERNAL_INFO_TABLE_EN)
/** Returns address of blackhawk7_v1l8p2 info table stored in upper level software.
 * @param sa__ is an opaque state vector passed through to device access functions.
 */
srds_info_t *blackhawk7_v1l8p2_get_info_table_address(srds_access_t *sa__);
#endif

uint16_t blackhawk7_v1l8p2_pmd_rd_reg(srds_access_t *sa__, uint16_t address);
#endif
