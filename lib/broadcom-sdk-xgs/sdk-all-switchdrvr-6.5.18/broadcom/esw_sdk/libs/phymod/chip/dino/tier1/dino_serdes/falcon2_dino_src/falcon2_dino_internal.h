 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: falcon2_dino_internal.h 1341 2016-02-05 20:06:55Z kirand $ *
 *                                                                                *
...
/** @file falcon2_dino_internal.h
 * Internal API functions
 */

#ifndef FALCON2_DINO_API_INTERNAL_H
#define FALCON2_DINO_API_INTERNAL_H
...
typedef struct {
       ...
       uint8_t core_status;
} falcon2_dino_core_state_st;

#ifdef DINO_EXCLUDE_STATIC_FUNCTION_DECLARATIONS
/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current falcon2_dino lane status.
 * @param *istate Current falcon2_dino lane status read back and populated by the API
 ...
 * as part of falcon2_dino_display_core_state_line()
 ...
 */
SDK_STATIC float8_t falcon2_dino_int32_to_float8(uint32_t input);
#endif
...
/*-----------------------------*/
/** Read current falcon2_dino core status.
 * @param *istate Current falcon2_dino core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pll_lock Current falcon2_dino lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current falcon2_dino lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pmd_lock Current falcon2_dino lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current falcon2_dino lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *sig_det Current falcon2_dino lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current falcon2_dino lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _falcon2_dino_get_osr_mode( const phymod_access_t *pa, falcon2_dino_osr_mode_st *mode);
 ...
 * Along with falcon2_dino_core_clkgate(), all lanes should also be clock gated using falcon2_dino_lane_clkgate() to complete a Core Clockgate
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in falcon2_dino_functions.c.
 *
...
#endif /* DINO_EXCLUDE_STATIC_FUNCTION_DECLARATIONS */
#endif
