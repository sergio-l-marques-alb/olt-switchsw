...
#define OSR_MODE_SUPPORTS_EYE_TESTS(mode) (((mode) <= BLACKHAWK7_V1L8P2_OSX4) || ((mode) == BLACKHAWK7_V1L8P2_OSX2P5))

/** CDR mode Enum **/
enum blackhawk7_v1l8p2_cdr_mode_enum {
  BLACKHAWK7_V1L8P2_CDR_MODE_OS_ALL_EDGES             = 0,
  BLACKHAWK7_V1L8P2_CDR_MODE_OS_PATTERN               = 1,
  BLACKHAWK7_V1L8P2_CDR_MODE_OS_PATTERN_ENHANCED      = 2,
  BLACKHAWK7_V1L8P2_CDR_MODE_BR_PATTERN               = 3,
  BLACKHAWK7_V1L8P2_CDR_MODE_PAM4_NR_OS_PATTERN       = 4,
  BLACKHAWK7_V1L8P2_CDR_MODE_PAM4_NR_BR_PATTERN       = 5,
  BLACKHAWK7_V1L8P2_CDR_MODE_PAM4_ER_DFE_DATA_PATTERN = 6,
  BLACKHAWK7_V1L8P2_CDR_MODE_PAM4_ER_PATTERN          = 7
};

/** Lane User Control Clause93/72 Force Value **/
enum blackhawk7_v1l8p2_cl93n72_frc_val_enum {
  BLACKHAWK7_V1L8P2_CL93N72_FORCE_OS  = 0,
  BLACKHAWK7_V1L8P2_CL93N72_FORCE_BR  = 1
};
