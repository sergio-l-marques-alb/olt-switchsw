...
/** @file merlin7_tsc_dependencies.h
...
#ifndef MERLIN7_TSC_API_DEPENDENCIES_H
#define MERLIN7_TSC_API_DEPENDENCIES_H
...
#define merlin7_tsc_get_physical_lane merlin7_tsc_get_lane
...
#define merlin7_tsc_set_physical_lane merlin7_tsc_set_lane
 ...
 */
uint8_t merlin7_tsc_get_pll_idx(srds_access_t *sa__);
 ...
 * @return Any error code generated during execution; ERR_CODE NONE otherwise.
 */
err_code_t merlin7_tsc_set_pll_idx(srds_access_t *sa__, uint8_t pll_index);
 ...
 */
uint8_t merlin7_tsc_get_micro_idx(srds_access_t *sa__);
 ...
 * @return Any error code generated during execution; ERR_CODE NONE otherwise.
 */
err_code_t merlin7_tsc_set_micro_idx(srds_access_t *sa__, uint8_t micro_index);


#if defined(SERDES_EXTERNAL_INFO_TABLE_EN)
/** Returns address of merlin7_tsc info table stored in upper level software.
 * @param sa__ is an opaque state vector passed through to device access functions.
 */
