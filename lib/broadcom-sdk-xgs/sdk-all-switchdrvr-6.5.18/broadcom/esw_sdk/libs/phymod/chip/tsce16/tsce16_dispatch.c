...
__phymod__dispatch__t__ phymod_tsce16_driver = {
    ...
    tsce16_phy_fec_enable_set,
    tsce16_phy_fec_enable_get,
    ...
    tsce16_phy_synce_clk_ctrl_set,
    tsce16_phy_synce_clk_ctrl_get,
    NULL, /* phymod_phy_pcs_enable_set */
    tsce16_phy_rx_ppm_get,
