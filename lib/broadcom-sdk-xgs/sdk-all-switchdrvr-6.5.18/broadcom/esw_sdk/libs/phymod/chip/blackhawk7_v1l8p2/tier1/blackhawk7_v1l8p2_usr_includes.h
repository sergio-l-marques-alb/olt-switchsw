...
/**************************************************************************************
 *  File Name     :  blackhawk7_v1l8p2_usr_includes.h                                        *
...
/** @file blackhawk7_v1l8p2_usr_includes.h
...
#ifndef BLACKHAWK7_V1L8P2_API_USR_INCLUDES_H
#define BLACKHAWK7_V1L8P2_API_USR_INCLUDES_H
...
#endif
#define USR_DELAY_MS(stuff) blackhawk7_v1l8p2_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) blackhawk7_v1l8p2_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) blackhawk7_v1l8p2_delay_ns(sa__,stuff)
