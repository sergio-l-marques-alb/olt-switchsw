...
/** Parameterized diagnostic function which access to all blackhawk7_v1l8p1 control and status bits
 * This function is required to be implemented by upper level software to enable blackhawk7_v1l8p1 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/*---------------------*/
   ...
   * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
   */
  err_code_t blackhawk7_v1l8p1_display_cl72_status(srds_access_t *sa__);
#else
