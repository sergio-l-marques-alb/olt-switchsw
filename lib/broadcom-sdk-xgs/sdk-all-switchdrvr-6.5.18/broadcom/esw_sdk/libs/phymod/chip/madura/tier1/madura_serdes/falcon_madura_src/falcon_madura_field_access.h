/**************************************************************************************
 **************************************************************************************
 *  File Name     :  falcon_furia_field_access.h                                        *
 *  Created On    :  29/04/2013                                                       *
 *  Created By    :  Kiran Divakar                                                    *
 *  Description   :  Serdes IP Register and Field access APIs                         *
 *  Revision      :  $Id: falcon_furia_field_access.h 754 2014-10-29 22:29:05Z kirand $ *
 *                                                                                    *
...
/** @file falcon_furia_field_access.h
 * Registers and field access
 */

#ifndef FALCON_FURIA_API_FIELD_ACCESS_H
#define FALCON_FURIA_API_FIELD_ACCESS_H
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _falcon_furia_madura_pmd_rdt_field_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _falcon_furia_madura_pmd_rdt_field_signed_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
