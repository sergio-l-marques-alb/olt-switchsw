...
#include <phymod/chip/eagle_dpll.h>

__phymod__dispatch__t__ phymod_tsce_dpll_driver = {

    tsce_dpll_core_identify,
    tsce_dpll_core_info_get,
    tsce_dpll_core_lane_map_set,
    tsce_dpll_core_lane_map_get,
    tsce_dpll_core_reset_set,
    tsce_dpll_core_reset_get,
    tsce_dpll_core_firmware_info_get,
    tsce_dpll_phy_firmware_core_config_set,
    tsce_dpll_phy_firmware_core_config_get,
    tsce_dpll_phy_firmware_lane_config_set,
    tsce_dpll_phy_firmware_lane_config_get,
    tsce_dpll_core_pll_sequencer_restart,
    tsce_dpll_core_wait_event,
    tsce_dpll_phy_rx_restart,
    tsce_dpll_phy_polarity_set,
    tsce_dpll_phy_polarity_get,
    tsce_dpll_phy_tx_set,
    tsce_dpll_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    eagle_dpll_phy_media_type_tx_get,
    tsce_dpll_phy_tx_override_set,
    tsce_dpll_phy_tx_override_get,
    tsce_dpll_phy_txpi_config_set,
    tsce_dpll_phy_txpi_config_get,
    tsce_dpll_phy_rx_set,
    tsce_dpll_phy_rx_get,
    tsce_dpll_phy_rx_adaptation_resume,
    tsce_dpll_phy_reset_set,
    tsce_dpll_phy_reset_get,
    tsce_dpll_phy_power_set,
    tsce_dpll_phy_power_get,
    tsce_dpll_phy_hg2_codec_control_set,
    tsce_dpll_phy_hg2_codec_control_get,
    tsce_dpll_phy_tx_lane_control_set,
    tsce_dpll_phy_tx_lane_control_get,
    tsce_dpll_phy_rx_lane_control_set,
    tsce_dpll_phy_rx_lane_control_get,
    tsce_dpll_phy_fec_enable_set,
    tsce_dpll_phy_fec_enable_get,
    ...
    tsce_dpll_phy_autoneg_oui_set,
    tsce_dpll_phy_autoneg_oui_get,
    tsce_dpll_phy_eee_set,
    tsce_dpll_phy_eee_get,
    tsce_dpll_phy_interface_config_set,
    tsce_dpll_phy_interface_config_get,
    tsce_dpll_phy_cl72_set,
    tsce_dpll_phy_cl72_get,
    tsce_dpll_phy_cl72_status_get,
    tsce_dpll_phy_autoneg_ability_set,
    tsce_dpll_phy_autoneg_ability_get,
    tsce_dpll_phy_autoneg_remote_ability_get,
    tsce_dpll_phy_autoneg_set,
    tsce_dpll_phy_autoneg_get,
    tsce_dpll_phy_autoneg_restart_set,
    tsce_dpll_phy_autoneg_status_get,
    tsce_dpll_core_init,
    tsce_dpll_phy_pll_multiplier_get,
    tsce_dpll_phy_init,
    tsce_dpll_phy_loopback_set,
    tsce_dpll_phy_loopback_get,
    tsce_dpll_phy_rx_pmd_locked_get,
    tsce_dpll_phy_rx_signal_detect_get,
    tsce_dpll_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    tsce_dpll_phy_reg_read,
    tsce_dpll_phy_reg_write,
    ...
    tsce_dpll_timesync_enable_set,
    tsce_dpll_timesync_enable_get,
    ...
    tsce_dpll_timesync_offset_set,
    tsce_dpll_timesync_adjust_set,
    ...
    tsce_dpll_phy_eye_margin_est_get,
    ...
    tsce_dpll_phy_bond_in_pwrdn_override,
    ...
    tsce_dpll_phy_ref_clk_get,
    NULL, /* phymod_phy_ecc_intr_enable_set */
    NULL, /* phymod_phy_ecc_intr_enable_get */
