...
***********************************************************************************
*                                                                                 *
*  Revision    :  $Id: phy8806x_tsc_interface.h 1337 2016-02-04 00:15:32Z kirand $   *
*                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/phy8806x_tsc/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * phy8806x_tsc_interface.h - provides the primary functionality.
 *
 * phy8806x_tsc_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file phy8806x_tsc_interface.h
 * Main interface functions provided to IP User
 */

#ifndef PHY8806X_TSC_API_INTERFACE_H
#define PHY8806X_TSC_API_INTERFACE_H
...
struct phy8806x_tsc_uc_lane_config_field_st {
...
struct phy8806x_tsc_uc_core_config_field_st {
	uint8_t vco_rate;
...
/** Lane Config Struct */
struct  phy8806x_tsc_uc_lane_config_st {
	struct phy8806x_tsc_uc_lane_config_field_st field;
	uint16_t word;
};

/** Core Config Struct */
struct  phy8806x_tsc_uc_core_config_st {
	struct phy8806x_tsc_uc_core_config_field_st field;
	uint16_t word;
	int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct phy8806x_tsc_eyescan_options_st {
 ...
 */
err_code_t phy8806x_tsc_version (const phymod_access_t *pa, uint32_t *api_version);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_set_uc_core_config (const phymod_access_t *pa, struct phy8806x_tsc_uc_core_config_st struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_get_uc_core_config (const phymod_access_t *pa, struct phy8806x_tsc_uc_core_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_core_config (const phymod_access_t *pa);

/** Display current Core state. Read and displays core status variables and fields.
 * @param pa phymod_access_t struct
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_core_state (const phymod_access_t *pa);

/** Column definition header for phy8806x_tsc_display_core_state() API output.
 * To be called before phy8806x_tsc_display_core_state_line() API.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_core_state_hdr (const phymod_access_t *pa);

/** Display current Core state in single line. Read and displays core status variables and fields.
 * Call phy8806x_tsc_display_core_state_hdr() API before and phy8806x_tsc_display_core_state_legend() after
 * calling this API to get a formatted core state display with legend.
 * @param pa phymod_access_t struct
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_core_state_line (const phymod_access_t *pa);

/** Detailed description of each column in phy8806x_tsc_display_core_state_line() API output.
 * To be called after phy8806x_tsc_display_core_state_line() API to display the legends.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_core_state_legend (const phymod_access_t *pa);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_force_die_temperature (const phymod_access_t *pa, int16_t die_temp);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_read_die_temperature (const phymod_access_t *pa, int16_t *die_temp);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_read_die_temperature_double (const phymod_access_t *pa, USR_DOUBLE *die_temp);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_ucode_crc_verify (const phymod_access_t *pa, uint16_t ucode_len, uint16_t expected_crc_value);
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [phy8806x_tsc_ucode_crc_verify()] and verifying the CRC value [phy8806x_tsc_start_ucode_crc_calc()].
 * @param pa phymod_access_t struct
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_start_ucode_crc_calc (const phymod_access_t *pa, uint16_t ucode_len);

/** To check the expected CRC against the CRC calulated by the micro.
 * NOTE: No uC commands should be executed between starting the CRC calculation [phy8806x_tsc_ucode_crc_verify()] and verifying the CRC value [phy8806x_tsc_start_ucode_crc_calc()].
 * @param pa phymod_access_t struct
 * @param expected_crc_value Expected CRC value of the microcode
 * @param timeout_ms Time interval in milliseconds inside which the previous command (calculate CRC) should be completed
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_check_ucode_crc (const phymod_access_t *pa, uint16_t expected_crc_value, uint32_t timeout_ms);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_init_pram_for_uc_load (const phymod_access_t *pa, uint16_t ucode_len);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_finish_pram_load (const phymod_access_t *pa);
 ...
 * Note: phy8806x_tsc_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 * @param pa phymod_access_t struct
 ...
 * Note: User also needs to configure all lanes through phy8806x_tsc_lane_config_for_iddq()
 ...
 * Along with phy8806x_tsc_core_pwrdn(), all lanes powerdowns should also be issued using
 * phy8806x_tsc_lane_pwrdn() to complete a Core Powerdown.
 * @param pa phymod_access_t struct
 ...
 * If using MDIO interface to access the registers, use this API to implement phy8806x_tsc_pmd_mwr_reg().
 * @param pa phymod_access_t struct
 ...
 */
err_code_t phy8806x_tsc_pmd_mdio_mwr_reg (const phymod_access_t *pa, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_set_uc_lane_cfg (const phymod_access_t *pa, struct phy8806x_tsc_uc_lane_config_st struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_get_uc_lane_cfg (const phymod_access_t *pa, struct phy8806x_tsc_uc_lane_config_st *struct_val);
 ...
 */
err_code_t phy8806x_tsc_display_eye_scan (const phymod_access_t *pa);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_lowber_eye (const phymod_access_t *pa, const struct phy8806x_tsc_eyescan_options_st eyescan_options, uint32_t *buffer);

/** Measure Passive Eye Scan based on eyescan_options provided and return data in buffer.
 * It relies on the accuracy of phy8806x_tsc_delay_us() function. \n\n
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_meas_lowber_eye (const phymod_access_t *pa, const struct phy8806x_tsc_eyescan_options_st eyescan_options, uint32_t *buffer);

/** Start uC controller eye scan Function.
 * Eye scan function provides a stripe of data at a time either vertical or horizontal.
 * This function only initiates the processor actions.  User must use phy8806x_tsc_read_eye_scan_stripe() function
 * to get the data from uC.
 * @param pa phymod_access_t struct
 * @param direction specifies either EYE_SCAN_VERTICAL or EYE_SCAN_HORIZ striping
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_meas_eye_scan_start (const phymod_access_t *pa, uint8_t direction);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_read_eye_scan_stripe (const phymod_access_t *pa, uint32_t *buffer, uint16_t *status);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_eye_scan_stripe (const phymod_access_t *pa, int8_t y, uint32_t *buffer);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_eye_scan_header (const phymod_access_t *pa, int8_t i);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_eye_scan_footer (const phymod_access_t *pa, int8_t i);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_read_eye_scan_status (const phymod_access_t *pa, uint16_t *status);

/** Restores uC after running diagnostic eye scans.
 * @param pa phymod_access_t struct
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_meas_eye_scan_done (const phymod_access_t *pa);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_start_ber_scan_test (const phymod_access_t *pa, uint8_t ber_scan_mode, uint8_t timer_control, uint8_t max_error_control);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_read_ber_scan_data (const phymod_access_t *pa, uint32_t *errors, uint32_t *timer_values, uint8_t *cnt, uint32_t timeout);
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_ber_scan_data (const phymod_access_t *pa, USR_DOUBLE rate, uint8_t ber_scan_mode, uint32_t *total_errs, uint32_t *total_time, uint8_t max_offset);
 ...
 * phy8806x_tsc_start_ber_scan_test(), phy8806x_tsc_read_ber_scan_data(), phy8806x_tsc_display_ber_scan_data().
 *
 * @param pa phymod_access_t struct
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_eye_margin_proj (const phymod_access_t *pa, USR_DOUBLE rate, uint8_t ber_scan_mode, uint8_t timer_control, uint8_t max_error_control);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_get_eye_margin_est (const phymod_access_t *pa, int *left_eye_mUI, int *right_eye_mUI, int *upper_eye_mV, int *lower_eye_mV);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_lane_config (const phymod_access_t *pa);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_lane_debug_status (const phymod_access_t *pa);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_lane_state (const phymod_access_t *pa);

/** Column definition header for phy8806x_tsc display state.
 * To be called before phy8806x_tsc_display_lane_state() function.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_lane_state_hdr (const phymod_access_t *pa);

/** Detailed explanation of each column in phy8806x_tsc display state.
 * To be called after phy8806x_tsc_display_lane_state() function to display the legends.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_lane_state_legend (const phymod_access_t *pa);
 ...
 * This function is required to be implemented by upper level software to enable phy8806x_tsc support.
 * @param pa phymod_access_t struct
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_diag_data (const phymod_access_t *pa, uint16_t diag_level);

#ifdef TDT_CHARACTERIZATION
/** Parameterized diagnostic function which access to all phy8806x_tsc control and status bits
 * This function is required to be implemented by upper level software to enable phy8806x_tsc support.
 * @param pa phymod_access_t struct
 ...
 */
#endif
err_code_t phy8806x_tsc_diag_access (const phymod_access_t *pa, enum srds_diag_access_enum type, uint16_t addr, uint16_t data, uint16_t param);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_stop_rx_adaptation (const phymod_access_t *pa, uint8_t enable);

/** Request to stop RX Adaptation on a Lane.
 * Control will be returned immediately before adaptaion is completely stopped.
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the phy8806x_tsc_stop_rx_adaptation() API.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_request_stop_rx_adaptation (const phymod_access_t *pa);
 ...
 * Note: The patt_length input to the function should be the value sent to the phy8806x_tsc_config_shared_tx_pattern() function
 * @param pa phymod_access_t struct
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in phy8806x_tsc_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Once the PRBS generator is configured, to enable PRBS use the phy8806x_tsc_tx_prbs_en() API.
 * @param pa phymod_access_t struct
 ...
 * Once the PRBS checker is configured, use the phy8806x_tsc_rx_prbs_en() API to enable the checker.
 * @param pa phymod_access_t struct
 ...
 * Note: User needs to configure all lanes through phy8806x_tsc_lane_config_for_iddq() and also call phy8806x_tsc_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * If you want loop timing use phy8806x_tsc_rmt_lpbk()
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_tx_ull_config (const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_rx_ull_config (const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_tx_rptr_mode_timing (const phymod_access_t *pa, uint8_t enable);

/** RX setup for Repeater Mode timing
 * This function should be called prior to phy8806x_tsc_rptr_mode_timing();
 * @param pa phymod_access_t struct
 * @param enable Enable/Disable (1 = Enable; 0 = Disable)
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_rx_rptr_mode_timing (const phymod_access_t *pa, uint8_t enable);
...
/** Configures FC TTS for speed negotiation on TX lane.
 * Returns failcodes for invalid configurations or configuration failure.
 * @param pa phymod_access_t struct
 * @param tx_pll_sel  Selection of the PLL0 or PLL1 as clock source for the tx lane
 *                      0 - Select PLL0 as clock for tx_ lane
 *                      1 - Select PLL1 as clock for tx_ lane
 * @param pa phymod_access_t struct
 * @param tx_osr_mode TX oversample(OS) mode
 *                      0 - OSR1
 *                      1 - OSR2
 *                      2 - OSR4
 * @param pa phymod_access_t struct
 * @param tx_fctts_update_page Contains correction information from the local receiver
 *                             to the link partner transmit equalizer
 * @param pa phymod_access_t struct
 * @param tx_fctts_status_page Local device's transmit status page
 * @return Error Code generated by invalid configuration (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_config_tx_fctts (const phymod_access_t *pa, uint16_t tx_pll_sel, uint16_t tx_osr_mode, uint16_t tx_fctts_update_page, uint16_t tx_fctts_status_page);

/** Configures FC TTS for speed negotiation on RX lane.
 * Returns failcodes for invalid configurations or configuration failure.
 * @param pa phymod_access_t struct
 * @param rx_pll_sel  Selection of the PLL0 or PLL1 as clock source for the rx lane
 *                      0 - Select PLL0 as clock for rx lane
 *                      1 - Select PLL1 as clock for rx lane
 * @param pa phymod_access_t struct
 * @param rx_osr_mode  RX oversample(OS) mode
 *                      0 - OSR1
 *                      1 - OSR2
 *                      2 - OSR4
 * @param pa phymod_access_t struct
 * @param rx_fctts_sync_count_chkval Specify the number of consective valid frame markers
 *                                   to be detected to assert sync_test_pass, from 0 to 2047
 * @param pa phymod_access_t struct
 * @param rx_fctts_ext_marker_chk_en Enable/disable extended marker check when detecting
 *                                   32GFC/16GFC TTS frames
 *                                     1 - check for 32GFC format extended marker
 *                                     2 - check for 16GFC format extended marker
 *                                     0,3 - check for normal standard marker
 * @param pa phymod_access_t struct
 * @return Error Code generated by invalid configuration (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_config_rx_fctts (const phymod_access_t *pa, uint16_t rx_pll_sel, uint16_t rx_osr_mode, uint16_t rx_fctts_sync_count_chkval, uint16_t rx_fctts_ext_marker_chk_en);

/**Transitioning from TTS for FC speed negotiation to TTS for FC training.
 * Returns failcodes if transition fails.
 * @param pa phymod_access_t struct
 * @param xmt_update_page Contains correction information from the local receiver
 *                        to the link partner transmit equalizer
 * @param pa phymod_access_t struct
 * @param xmt_status_page Local device's transmit status page
 * @param tts_prbs_sel    Specify the type of traffic to be sent after FC training is complete
 *                          0 - send TTS after FC training is complete
 *                          1 - send PRBS after FC training is complete
 * @param pa phymod_access_t struct
 * @return Error Code generated by transition failure (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_fctts_sn_to_trn (const phymod_access_t *pa, uint16_t xmt_update_page, uint16_t xmt_status_page, uint8_t tts_prbs_sel);
