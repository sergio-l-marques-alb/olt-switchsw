...
#include "blackhawk7_v1l8p2_decode_print.h"
...
err_code_t blackhawk7_v1l8p2_decode_uc_sts_ext(srds_access_t *sa__, uint16_t bits) {
    if(bits & (0x01 << 0)) {
...
err_code_t blackhawk7_v1l8p2_decode_uc_sts(srds_access_t *sa__, uint8_t bits) {
    if(bits & (0x01 << 0)) {
