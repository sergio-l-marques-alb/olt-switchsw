 ...
 * (https://broadcom.box.com/v/merlin16-common-16nm)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * merlin16_interface.h - provides the primary functionality.
 *
 * merlin16_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file merlin16_interface.h
 * Main interface functions provided to IP User
 */

#ifndef MERLIN16_API_INTERFACE_H
#define MERLIN16_API_INTERFACE_H

#include "merlin16_access.h"
#include "merlin16_config.h"
#include "merlin16_debug_functions.h"
#include "merlin16_diag.h"
#include "merlin16_prbs.h"
#include "merlin16_pwr_mgt.h"
