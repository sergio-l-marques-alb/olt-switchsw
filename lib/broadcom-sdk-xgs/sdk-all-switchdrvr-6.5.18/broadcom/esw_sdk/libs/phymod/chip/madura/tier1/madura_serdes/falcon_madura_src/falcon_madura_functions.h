...
/* RAM access */
#include "falcon_madura_api_uc_vars_rdwr_defns.h"

/* Reg access */


      #include "falcon_madura_fields.h"
...
typedef struct {
    ...
    uint8_t tx_rx;
}falcon_furia_madura_osr_mode_define_st;
...
typedef struct {
       ...
       uint16_t link_time;
       /** OSR Mode */
       falcon_furia_madura_osr_mode_define_st osr_mode;
       /** Signal Detect */
       uint8_t sig_det;
       /** PMD RX Lock */
       uint8_t rx_lock;
       ...
       uint8_t br_pd_en;
} falcon_furia_madura_lane_state_define_st;
