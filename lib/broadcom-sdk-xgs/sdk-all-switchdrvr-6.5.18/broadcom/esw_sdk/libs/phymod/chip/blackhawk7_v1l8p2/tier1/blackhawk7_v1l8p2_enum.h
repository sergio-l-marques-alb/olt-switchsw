...
enum blackhawk7_v1l8p2_pll_refclk_enum {
    ...
    BLACKHAWK7_V1L8P2_PLL_REFCLK_245P76MHZ      = (int)0x01901800, /* 245.76 MHz      */
    BLACKHAWK7_V1L8P2_PLL_REFCLK_250MHZ         = (int)0x001000FA, /* 250 MHz         */
    ...
    BLACKHAWK7_V1L8P2_PLL_REFCLK_166P015625MHZ  = (int)0x64040D99, /* 166.015625 MHz */
    ...
    BLACKHAWK7_V1L8P2_PLL_REFCLK_311P04MHZ      = (int)0x01901E60, /* 311.04 MHz      */
...
enum blackhawk7_v1l8p2_pll_div_enum {
    ...
    BLACKHAWK7_V1L8P2_PLL_DIV_74P25      = (int)0x4000004A, /* Divide by 74.25      */
    ...
    BLACKHAWK7_V1L8P2_PLL_DIV_90P75      = (int)0xC000005A, /* Divide by 90.75      */
    ...
    BLACKHAWK7_V1L8P2_PLL_DIV_54         = (int)0x00000036, /* Divide by 54         */
    BLACKHAWK7_V1L8P2_PLL_DIV_108        = (int)0x0000006C, /* Divide by 108        */
...
enum blackhawk7_v1l8p2_tx_afe_settings_enum {
    BLACKHAWK7_V1L8P2_TX_AFE_TAP0,
    BLACKHAWK7_V1L8P2_TX_AFE_TAP1,
    BLACKHAWK7_V1L8P2_TX_AFE_TAP2,
    BLACKHAWK7_V1L8P2_TX_AFE_TAP3,
    BLACKHAWK7_V1L8P2_TX_AFE_TAP4,
    BLACKHAWK7_V1L8P2_TX_AFE_TAP5
};

/** TXFIR Tap Enable Enum */
enum blackhawk7_v1l8p2_txfir_tap_enable_enum {
    BLACKHAWK7_V1L8P2_NRZ_LP_3TAP  = 0,
    BLACKHAWK7_V1L8P2_NRZ_6TAP     = 1,
    BLACKHAWK7_V1L8P2_PAM4_LP_3TAP = 2,
    BLACKHAWK7_V1L8P2_PAM4_6TAP    = 3
};

#define BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_MASK 0xF

/** PLL Configuration Options Enum */
enum blackhawk7_v1l8p2_pll_option_enum {
    BLACKHAWK7_V1L8P2_PLL_OPTION_NONE              =  0,
    BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_DOUBLER_EN =  1,
    BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_DIV2_EN    =  2,
    BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_DIV4_EN    =  3,
    BLACKHAWK7_V1L8P2_PLL_OPTION_POWERDOWN         =  4,
    BLACKHAWK7_V1L8P2_PLL_OPTION_DISABLE_VERIFY    = 16
};


#endif /*#define BLACKHAWK7_V1L8P2_API_ENUM_H*/
#ifdef __cplusplus
}
#endif
