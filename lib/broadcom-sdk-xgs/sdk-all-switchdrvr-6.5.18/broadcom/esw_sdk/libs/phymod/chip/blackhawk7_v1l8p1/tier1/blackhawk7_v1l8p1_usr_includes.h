...
#endif
#define USR_DELAY_MS(stuff) blackhawk7_v1l8p1_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) blackhawk7_v1l8p1_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) blackhawk7_v1l8p1_delay_ns(sa__,stuff)
