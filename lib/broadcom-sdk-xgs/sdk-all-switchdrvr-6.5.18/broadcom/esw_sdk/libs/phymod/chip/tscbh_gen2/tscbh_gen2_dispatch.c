...
__phymod__dispatch__t__ phymod_tscbh_gen2_driver = {

    tscbh_gen2_core_identify,
    tscbh_gen2_core_info_get,
    tscbh_gen2_core_lane_map_set,
    tscbh_gen2_core_lane_map_get,
    tscbh_gen2_core_reset_set,
    tscbh_gen2_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    tscbh_gen2_phy_firmware_lane_config_set,
    tscbh_gen2_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    tscbh_gen2_phy_rx_restart,
    tscbh_gen2_phy_polarity_set,
    tscbh_gen2_phy_polarity_get,
    tscbh_gen2_phy_tx_set,
    tscbh_gen2_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    tscbh_gen2_phy_media_type_tx_get,
    tscbh_gen2_phy_tx_override_set,
    tscbh_gen2_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    blackhawk7_v1l8p2_phy_rx_set,
    blackhawk7_v1l8p2_phy_rx_get,
    blackhawk7_v1l8p2_phy_rx_adaptation_resume,
    tscbh_gen2_phy_reset_set,
    tscbh_gen2_phy_reset_get,
    tscbh_gen2_phy_power_set,
    tscbh_gen2_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    tscbh_gen2_phy_tx_lane_control_set,
    tscbh_gen2_phy_tx_lane_control_get,
    tscbh_gen2_phy_rx_lane_control_set,
    tscbh_gen2_phy_rx_lane_control_get,
    ...
    tscbh_gen2_phy_cl72_set,
    tscbh_gen2_phy_cl72_get,
    tscbh_gen2_phy_cl72_status_get,
    NULL, /* phymod_phy_autoneg_ability_set */
    NULL, /* phymod_phy_autoneg_ability_get */
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    tscbh_gen2_phy_autoneg_set,
    tscbh_gen2_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    tscbh_gen2_phy_autoneg_status_get,
    tscbh_gen2_core_init,
    tscbh_gen2_phy_pll_multiplier_get,
    tscbh_gen2_phy_init,
    tscbh_gen2_phy_loopback_set,
    tscbh_gen2_phy_loopback_get,
    tscbh_gen2_phy_rx_pmd_locked_get,
    tscbh_gen2_phy_rx_signal_detect_get,
    ...
    tscbh_gen2_timesync_enable_set,
    tscbh_gen2_timesync_enable_get,
    ...
    tscbh_gen2_timesync_adjust_set,
    ...
    tscbh_gen2_port_enable_set,
    tscbh_gen2_port_enable_get,
    blackhawk7_v1l8p2_phy_eye_margin_est_get,
    ...
    tscbh_gen2_phy_speed_config_set,
    tscbh_gen2_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    tscbh_gen2_phy_tx_taps_default_get,
    tscbh_gen2_phy_lane_config_default_get,
    tscbh_gen2_phy_firmware_load_info_get,
    tscbh_gen2_phy_autoneg_advert_ability_set,
    tscbh_gen2_phy_autoneg_advert_ability_get,
    tscbh_gen2_phy_autoneg_remote_advert_ability_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    tscbh_gen2_phy_tx_pam4_precoder_enable_set,
    tscbh_gen2_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_set */
    tscbh_gen2_phy_pll_reconfig,
    blackhawk7_v1l8p2_phy_pll_pwrdn,
    NULL, /* phymod_phy_linkdown_transmit_set */
    NULL, /* phymod_phy_linkdown_transmit_get */
    tscbh_gen2_phy_synce_clk_ctrl_set,
    tscbh_gen2_phy_synce_clk_ctrl_get,
    tscbh_gen2_phy_pcs_enable_set,
    tscbh_gen2_phy_rx_ppm_get,
    blackhawk7_v1l8p2_phy_channel_loss_hint_set,
    blackhawk7_v1l8p2_phy_channel_loss_hint_get,
    tscbh_intr_handler,
    tscbh_gen2_timesync_tx_info_get,
    NULL, /* phymod_phy_master_set */
    NULL, /* phymod_phy_master_get */
    tscbh_phy_pcs_lane_swap_adjust,
    tscbh_gen2_phy_load_speed_id_entry,
    tscbh_phy_pmd_override_enable_set,
    NULL, /* phymod_phy_duplex_set */
    NULL, /* phymod_phy_duplex_get */
    blackhawk7_v1l8p2_phy_pmd_info_init,
    tscbh_gen2_phy_pll_powerdown_get,
    ...
    tscbh_gen2_phy_autoneg_speed_id_table_reload,
    ...
    tscbh_phy_ecc_intr_enable_set,
    tscbh_phy_ecc_intr_enable_get,
