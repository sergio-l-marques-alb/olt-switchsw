...
{
    PHYMOD_IF_ERR_RETURN(tefmod16_gen3_tx_rx_polarity_set(&phy->access, polarity->tx_polarity, polarity->rx_polarity));
...
{
    PHYMOD_IF_ERR_RETURN(tefmod16_gen3_tx_rx_polarity_get(&phy->access, &polarity->tx_polarity, &polarity->rx_polarity));
 ...
 * 17. clear cl91 ECC
 * 18. Enable FEC error bypass indication
 * 19. Release core DP soft reset
 */
STATIC
int _tscf16_gen3_core_init_pass2(const phymod_core_access_t* core, const phymod_core_init_config_t* init_config, const phymod_core_status_t* core_status)
{
    ...
    /* 18. Enable FEC error bypass indication */
    PHYMOD_IF_ERR_RETURN
        (tefmod16_gen3_fec_byp_ind_set(&core_copy.access, 1));

    /* 19. Release core DP soft reset */
    PHYMOD_IF_ERR_RETURN
        (falcon16_v1l4p1_core_dp_reset(&core_copy.access, 0));

    /* 20. Enable control for clk4sync to generate fclk, used by timesync */
    PHYMOD_IF_ERR_RETURN
...
int tscf16_gen3_phy_init(const phymod_phy_access_t* phy, const phymod_phy_init_config_t* init_config)
{
    ...
    for (i = 0; i < num_lane; i++) {
        ...
        PHYMOD_IF_ERR_RETURN(tscf16_gen3_phy_polarity_set(&pm_phy_copy, &tmp_pol));
    }
