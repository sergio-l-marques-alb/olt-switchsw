 ...
 *  Revision      :  $Id: falcon_furia_pll_config.c 1017 2015-04-24 22:07:57Z kirand $ *
 *                                                                                    *
...
err_code_t falcon_furia_configure_pll( const phymod_access_t *pa, enum falcon_furia_pll_enum pll_cfg) {
 ...
 /* Use core_s_rstb to re-initialize all registers to default before calling this function. */
    ...
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: falcon_furia_configure_pll( pa, ..) called without core_dp_s_rstb=0\n"));
    ...
    case FALCON_FURIA_pll_div_120x :
     /* pll_ mode<4:0> = 10001, VCO = 18.75   G, Refclk = 156.25      MHz */
        ...
        EFUN(wrc_ams_pll_vco2_15g     ( 0x1));
        break;
    case FALCON_FURIA_pll_div_120x_refc125 :
    ...
    case FALCON_FURIA_pll_div_132x :
     /* pll_ mode<4:0> = 00100 , VCO = 20.625  G, Refclk = 156.25     MHz */
        ...
        EFUN(wrc_ams_pll_vco2_15g     ( 0x0));
        break;
    case FALCON_FURIA_pll_div_132x_refc212 :
    ...
    case FALCON_FURIA_pll_div_165x :
     /* pll_ mode<4:0> = 00111, VCO = 25.78125G, Refclk = 156.25      MHz */
        ...
        EFUN(wrc_ams_pll_vco2_15g     ( 0x0));
        break;
    case FALCON_FURIA_pll_div_165x_refc125 :
    ...
    case FALCON_FURIA_pll_div_180x :
     /* pll_ mode<4:0> = 01011 , VCO = 28.125  G, Refclk = 156.25     MHz */
        ...
        EFUN(wrc_ams_pll_vco2_15g     ( 0x0));
        break;
    case FALCON_FURIA_pll_div_180x_refc125 :
