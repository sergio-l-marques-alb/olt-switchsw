...
extern err_code_t blackhawk7_v1l8p2_core_pwrdn(srds_access_t *sa__, enum srds_core_pwrdn_mode_enum mode); 

static err_code_t _blackhawk7_v1l8p2_restore_pll_defaults(srds_access_t *sa__);
...
static err_code_t _blackhawk7_v1l8p2_restore_pll_defaults(srds_access_t *sa__) {
    ...
    EFUN(wrc_ams_pll_swind_clkchnl_2(0x0));
    EFUN(wrc_ams_pll_cap_clkchnl(0x0));
    EFUN(wrc_ams_pll_cap_clkchnl_2(0xE));
    EFUN(wrc_ams_pll_i_clkchnl(0x2));
    EFUN(wrc_ams_pll_i_clkchnl_2(0x6));
    EFUN(wrc_ams_pll_cm_clkchnl(0x5));
    EFUN(wrc_ams_pll_cm_clkchnl_2(0x7));
...
err_code_t blackhawk7_v1l8p2_INTERNAL_configure_pll(srds_access_t *sa__,
    ...
    enum blackhawk7_v1l8p2_pll_option_enum pll_opt;

    pll_opt = (enum blackhawk7_v1l8p2_pll_option_enum)(pll_option & BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_MASK);
    if (pll_opt == BLACKHAWK7_V1L8P2_PLL_OPTION_POWERDOWN) {
        UNUSED(refclk_freq_hz);
        EFUN(blackhawk7_v1l8p2_core_pwrdn(sa__, PWRDN));
        return (ERR_CODE_NONE);
    }

#ifdef SMALL_FOOTPRINT
    EFUN(blackhawk7_v1l8p2_INTERNAL_get_refclk_in_hz(sa__, refclk, &refclk_freq_hz));
#else
    EFUN(blackhawk7_v1l8p2_INTERNAL_resolve_pll_parameters(sa__, refclk, &refclk_freq_hz, &srds_div, &vco_freq_khz, pll_option));
#endif

    /* Use this to restore defaults if reprogramming the PLL under dp-reset (typically Auto-Neg FW) */
    EFUN(_blackhawk7_v1l8p2_restore_pll_defaults(sa__));

    {
        ...
        if(reset_state < 7) {
            EFUN_PRINTF(("ERROR: blackhawk7_v1l8p2_configure_pll(..) called without core_dp_s_rstb=0\n"));
            return (blackhawk7_v1l8p2_error(sa__, ERR_CODE_CORE_DP_NOT_RESET));
        }
    }
    /* Clear PLL powerdown */
    EFUN(blackhawk7_v1l8p2_core_pwrdn(sa__, PWR_ON));
...

    {
       ...
       if (ams_vco_settings_en) {
           uint8_t  swind_clkchnl = 0, cap_clkchnl   = 0, i_clkchnl  = 2, cm_clkchnl = 5;
           uint8_t  cm_clkchnl_2  = 7, i_lb_en_div2  = 0, ictrl_div2 = 1;
           uint8_t  cal_clkchnl_1 = 0, cal_clkchnl_2 = 0;
           uint8_t  pll_idx, lane, orig_lane;

           ESTM(pll_idx = blackhawk7_v1l8p2_get_pll_idx(sa__));
           ESTM(orig_lane = blackhawk7_v1l8p2_get_lane(sa__));

           if (pll_idx == 0) {
               if (vco_freq_khz > 30000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  0; i_clkchnl  = 2;  cm_clkchnl = 5;
                    cm_clkchnl_2  = 7; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 0;  cal_clkchnl_2 = 0;
               }
               else if (vco_freq_khz >= 28000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  0; i_clkchnl  = 2;  cm_clkchnl = 5;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 4;  cal_clkchnl_2 = 10;
               }
               else if (vco_freq_khz >= 26000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  2; i_clkchnl  = 2;  cm_clkchnl = 5;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 2;  cal_clkchnl_2 = 10;
               }
               else if (vco_freq_khz >= 24000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  6; i_clkchnl  = 2;  cm_clkchnl = 5;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 1;  cal_clkchnl_2 = 8;
               }
               else if (vco_freq_khz >= 22000000) {
                    swind_clkchnl = 0; cap_clkchnl   = 12; i_clkchnl  = 2;  cm_clkchnl = 5;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 0;  cal_clkchnl_1 = 1;  cal_clkchnl_2 = 8;
               }
               else if (vco_freq_khz >= 20500000) {
                    swind_clkchnl = 0; cap_clkchnl   = 15; i_clkchnl  = 1;  cm_clkchnl = 4;
                    cm_clkchnl_2  = 1; i_lb_en_div2  =  0; ictrl_div2 = 0;  cal_clkchnl_1 = 1;  cal_clkchnl_2 = 8;
               }
               else if (vco_freq_khz >= 19000000) {
                    swind_clkchnl = 1; cap_clkchnl   =  0; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 1;  cal_clkchnl_1 = 2;  cal_clkchnl_2 = 4;
               }
               else if (vco_freq_khz >= 17000000) {
                    swind_clkchnl = 1; cap_clkchnl   =  5; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 1;  cal_clkchnl_1 = 0;  cal_clkchnl_2 = 6;
               }
               else if (vco_freq_khz >= 15000000) {
                    swind_clkchnl = 1; cap_clkchnl   = 13; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 0;  cal_clkchnl_1 = 0;  cal_clkchnl_2 = 6;
               }
               /* Physical TX lane 2 - PLL0 */
               ESTM(lane = rdc_tx_lane_addr_2());
               EFUN(blackhawk7_v1l8p2_set_lane(sa__, lane));
               EFUN(wr_ams_tx_cal_clkchnl_qp(cal_clkchnl_1));
               EFUN(wr_ams_tx_cal_clkchnl_qn(cal_clkchnl_1));

               /* Physical TX lane 4 - PLL0 */
               ESTM(lane = rdc_tx_lane_addr_4());
               EFUN(blackhawk7_v1l8p2_set_lane(sa__, lane));
               EFUN(wr_ams_tx_cal_clkchnl_qp(cal_clkchnl_2));
               EFUN(wr_ams_tx_cal_clkchnl_qn(cal_clkchnl_2));
           }
           else {
               if (vco_freq_khz > 30000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  0; i_clkchnl  = 2;  cm_clkchnl = 5;
                    ...
                    swind_clkchnl = 0; cap_clkchnl   =  0; i_clkchnl  = 3;  cm_clkchnl = 4;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 2;  cal_clkchnl_2 = 12;
               }
               else if (vco_freq_khz >= 26000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  4; i_clkchnl  = 3;  cm_clkchnl = 4;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 1;  cal_clkchnl_2 = 10;
               }
               else if (vco_freq_khz >= 24000000) {
                    swind_clkchnl = 0; cap_clkchnl   =  9; i_clkchnl  = 3;  cm_clkchnl = 4;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 1;  cal_clkchnl_1 = 0;  cal_clkchnl_2 = 10;
               }
               else if (vco_freq_khz >= 22000000) {
                    swind_clkchnl = 0; cap_clkchnl   = 15; i_clkchnl  = 3;  cm_clkchnl = 4;
                    cm_clkchnl_2  = 2; i_lb_en_div2  =  0; ictrl_div2 = 0;  cal_clkchnl_1 = 0;  cal_clkchnl_2 = 12;
               }
               else if (vco_freq_khz >= 20500000) {
                    swind_clkchnl = 1; cap_clkchnl   =  0; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 1;  cal_clkchnl_1 = 0;  cal_clkchnl_2 = 2;
               }
               else if (vco_freq_khz >= 19000000) {
                    swind_clkchnl = 1; cap_clkchnl   =  0; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 1;  cal_clkchnl_1 = 3;  cal_clkchnl_2 = 6;
               }
               else if (vco_freq_khz >= 17000000) {
                    swind_clkchnl = 1; cap_clkchnl   =  6; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 0;  cal_clkchnl_1 = 2;  cal_clkchnl_2 = 6;
               }
               else if (vco_freq_khz >= 15000000) {
                    swind_clkchnl = 1; cap_clkchnl   = 13; i_clkchnl  = 6;  cm_clkchnl = 1;
                    cm_clkchnl_2  = 0; i_lb_en_div2  =  1; ictrl_div2 = 0;  cal_clkchnl_1 = 1;  cal_clkchnl_2 = 6;
               }
               /* Physical TX lane 5 - PLL1 */
               ESTM(lane = rdc_tx_lane_addr_5());
               EFUN(blackhawk7_v1l8p2_set_lane(sa__, lane));
               EFUN(wr_ams_tx_cal_clkchnl_qp(cal_clkchnl_1));
               EFUN(wr_ams_tx_cal_clkchnl_qn(cal_clkchnl_1));

               /* Physical TX lane 1 - PLL1 */
               ESTM(lane = rdc_tx_lane_addr_1());
               EFUN(blackhawk7_v1l8p2_set_lane(sa__, lane));
               EFUN(wr_ams_tx_cal_clkchnl_qp(cal_clkchnl_2));
               EFUN(wr_ams_tx_cal_clkchnl_qn(cal_clkchnl_2));
           }
           EFUN(blackhawk7_v1l8p2_set_lane(sa__, orig_lane));
           EFUN(wrc_ams_pll_swind_clkchnl(swind_clkchnl));
           EFUN(wrc_ams_pll_swind_clkchnl_2(swind_clkchnl));
           EFUN(wrc_ams_pll_cap_clkchnl(cap_clkchnl));
           EFUN(wrc_ams_pll_cap_clkchnl_2(cap_clkchnl));
           EFUN(wrc_ams_pll_i_clkchnl(i_clkchnl));
           EFUN(wrc_ams_pll_i_clkchnl_2(i_clkchnl));
           EFUN(wrc_ams_pll_cm_clkchnl(cm_clkchnl));
           EFUN(wrc_ams_pll_cm_clkchnl_2(cm_clkchnl_2));
...

    {
        ...
        if (pll_fracn_ndiv_int != (pll_fracn_ndiv_int & ((1 << pll_fracn_ndiv_int_bits)-1))) {
            ...
            return (blackhawk7_v1l8p2_error(sa__, ERR_CODE_PLL_DIV_INVALID));
        }

        if ((pll_fracn_ndiv_int < 16) || (pll_fracn_ndiv_int > 510)) {
            return (blackhawk7_v1l8p2_error(sa__, ERR_CODE_INVALID_PLL_CFG));
        }
        ...
        EFUN(wrc_ams_pll_i_en_extra(7));
        {
            ...
            else if (refclk_freq_hz == 312500000 || refclk_freq_hz == 311040000) {  /* REFCLKs 312.5MHz and 311.04MHz */
                rtl_div_en = 2;
            }
    ...
    if (pll_opt == BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_DOUBLER_EN) {
        EFUN(wrc_ams_pll_refclk_freq2x_en(0x1));
    } else if (pll_opt == BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_DIV2_EN) {
        EFUN(wrc_ams_pll_refdiv2(1));
        EFUN(wrc_ams_pll_div4_2_sel(1));
    } else if (pll_opt == BLACKHAWK7_V1L8P2_PLL_OPTION_REFCLK_DIV4_EN) {
...

    {
        ...
        ESTM(pll_idx = blackhawk7_v1l8p2_get_pll_idx(sa__));
        EFUN(blackhawk7_v1l8p2_set_pll_idx(sa__, ((pll_idx == 0) ? 1 : 0)));
    ...
    return (ERR_CODE_NONE);
} /* blackhawk7_v1l8p2_configure_pll */
