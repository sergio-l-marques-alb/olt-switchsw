    ...
    flexe_drv_serdes_rate_mode_e serdes_rate)
{
    ...
    switch (rate)
    {
        case FLEXE_DRV_PORT_SPEED_50G:
            ...
            FLEXE_RX_MAP_TABLE_SET(&reg_val, bcm_port, (SHR_BITDCL *) & flexe_port);
        ...
        case FLEXE_DRV_PORT_SPEED_400G:
            /*
             * Maps BCM port to FlexE port (FlexE port = BCM port) .
             * bcm_port and flexe_port must all be 0.
             */
            SHR_IF_ERR_EXIT(READ_FSCL_RX_MAP_TABLEr(unit, &reg_val));
            FLEXE_RX_MAP_TABLE_SET(&reg_val, bcm_port, (SHR_BITDCL *) & flexe_port);
            SHR_IF_ERR_EXIT(WRITE_FSCL_RX_MAP_TABLEr(unit, reg_val));
...
#ifdef FLEXE_DRV_IF_ADAPTER_DESTROY_PORT_MAPPING
    /*
     * Point to invalid port
     */
    val = FLEXE_INVALID_PORT_ID;

    FLEXE_RX_MAP_TABLE_SET(&reg_val, bcm_port, &val);
    SHR_IF_ERR_EXIT(WRITE_FSCL_RX_MAP_TABLEr(unit, reg_val));
#endif
    ...
    int speed)
{
    ...
    switch (rate)
    {
        case FLEXE_DRV_PORT_SPEED_50G:
            /*
             * Map BCM port to FlexE port
             */
            SHR_IF_ERR_EXIT(READ_FSCL_TX_MAP_TABLEr(unit, &reg_val));
            FLEXE_TX_MAP_TABLE_SET(&reg_val, bcm_port, (SHR_BITDCL *) & flexe_port);
...
#ifdef FLEXE_DRV_IF_ADAPTER_DESTROY_PORT_MAPPING
    /*
     * Map BCM port to invalid FlexE port
     */
    val = FLEXE_INVALID_PORT_ID;
    FLEXE_RX_MAP_TABLE_SET(&reg_val, bcm_port, &val);
    ...
    int bypass_channel)
{
    ...
    else
    {
         ...
         */
        SHR_IF_ERR_EXIT(READ_FSCL_TX_MODE_CFGr(unit, &reg_val));
        is_bypass = soc_reg_field_get(unit, FSCL_FLEXE_TX_MODE_CFGr, reg_val, IS_BYPASSf);
...
/**
 * \brief
 *   Init FlexE MUX when FlexE MUX works in local clock mode. This is a test mode. In this mode,
 *   the credits of FlexE MUX are generated by the local 833M clock instead of from BCM port.
 *
 *
 * [in] unit - unit ID
  *
    ...
    int unit)
{
    ...
    /*
     * env_mode == 1, Credits are generated by the local 833M clock
     */
    if (env_mode)
    {
        first_lphy = 1;
        ...
        /*
         * Two RR4 schuduler schedules lphy 7/6/5/4, 3/2/1/0 respectively
         */
    ...
    int channel)
{
     ...
     */
    for (index = pcs_num; index < pcs_num + num_lphys; ++index)
    {
     ...
     */
    SHR_IF_ERR_EXIT(READ_FSCL_PCS_CHID_CFGr(unit, flexe_port / FLEXE_CORE_NOF_INSTANCES_DIV2, &pcs_chid_cfg));
    FLEXE_MUX_PCS_CHID_CFG_SET(&pcs_chid_cfg, flexe_port % FLEXE_CORE_NOF_INSTANCES_DIV2, (SHR_BITDCL *) & channel);
    SHR_IF_ERR_EXIT(WRITE_FSCL_PCS_CHID_CFGr(unit, flexe_port / FLEXE_CORE_NOF_INSTANCES_DIV2, pcs_chid_cfg));
    ...
    int calendar_sel)
{
    ...
    SHR_BIT_ITER(channel_map, FLEXE_CORE_NOF_CHANNELS, channel)
    {
        ...
        {
            /*
             * Restore channel belong to FlexE
             */
            SHR_IF_ERR_EXIT(READ_FSCL_CH_BELONG_FLEXEr(unit, reg_val_above_64));
            FLEXE_MUX_CHANNEL_BELONG_FLEXE_SET(reg_val_above_64, channel, &min_lphy);
            SHR_IF_ERR_EXIT(WRITE_FSCL_CH_BELONG_FLEXEr(unit, reg_val_above_64));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(soc_flexe_std_sar_cellsize_mode_set(unit, FLEXE_DRV_SAR_CELLSIZE_29B));
 ...
 */
shr_error_e
soc_flexe_std_sar_cellsize_mode_set(
    int unit,
    flexe_drv_sar_cellsize_mode_e mode)
{
    ...
    /*
     * Cellsize mode for TX
     */
    SHR_IF_ERR_EXIT(READ_FSCL_SAR_TX_GLB_CFGr(unit, &reg_val));
    soc_reg_field_set(unit, FSCL_SAR_TX_GLB_CFGr, &reg_val, B_66_SIZE_29Bf,
                      (mode == FLEXE_DRV_SAR_CELLSIZE_28B) ? 0 : 1);
    SHR_IF_ERR_EXIT(WRITE_FSCL_SAR_TX_GLB_CFGr(unit, reg_val));

    /*
     * Cellsize mode for RX
     */
    SHR_IF_ERR_EXIT(READ_FSCL_SAR_RX_GLB_CFGr(unit, &reg_val));
    soc_reg_field_set(unit, FSCL_SAR_RX_GLB_CFGr, &reg_val, B_66_SIZE_29Bf,
                      (mode == FLEXE_DRV_SAR_CELLSIZE_28B) ? 0 : 1);
    SHR_IF_ERR_EXIT(WRITE_FSCL_SAR_RX_GLB_CFGr(unit, reg_val));
 ...
 */
shr_error_e
soc_flexe_std_mux_group_c_cfg_set(
    int unit,
    SHR_BITDCL instance_bitmap[_SHR_BITDCLSIZE(FLEXE_CORE_NOF_INSTANCES)],
    int c_bit)
{
    ...
    {
        /* coverity[ptr_arith:FALSE] */
        SHR_BITCOPY_RANGE(&reg_val, 0, instance_bitmap, 0, FLEXE_CORE_NOF_INSTANCES);
    }
    else
    {
        /* coverity[ptr_arith:FALSE] */
        SHR_BITREMOVE_RANGE(&reg_val, instance_bitmap, 0, FLEXE_CORE_NOF_INSTANCES, &reg_val);
    ...
    int speed)
{
    ...
    {
        /*
         * Restore mode/cphy2/en_sel/group_cfg
         */
        ...
        /*
         * Clear FlexE enable, lphy in the range of 0~7
         */
        /* coverity[ptr_arith:FALSE] */
    ...
    int calendar_sel)
{
    ...
    /*
     * Add channel mapping in rate adapter
     */
...
#ifdef FLEXE_DRV_ALLOC_TIMESLOT_IN_RATE_ADAPTER
    /*
     * Remove channel mapping in rate adapter
     */
    ...
    int enable)
{
    ...
    {
        /*
         * Add channel mapping in rate adapter if enabled
         */
        SHR_IF_ERR_EXIT(soc_flexe_std_mux_rateadp_channel_add(unit, channel, tsmap));
    }
    else
    {
        /*
         * Remove channel mapping in rate adapter if enabled
         */
        SHR_IF_ERR_EXIT(soc_flexe_std_mux_rateadp_channel_del(unit, channel, tsmap));
    }
#endif
    ...
    int instance)
{
    ...
    soc_reg64_field32_set(unit, FSCL_RESERVED_INS_CFGr, &reg_val64, SC_INSf, 1);
    ...
    int cal_id)
{
    ...
    {
        /* coverity[ptr_arith:FALSE] */
        SHR_BITOR_RANGE(&reg_val, instance_bitmap, 0, FLEXE_CORE_NOF_INSTANCES, &reg_val);
    }
    ...
    int *cal_id)
{
    ...
    {
        SHR_IF_ERR_EXIT(READ_FSCL_C_CFGr(unit, &reg_val));
        *cal_id = SHR_BITGET(&reg_val, instance) ? 1 : 0;
    }
    else if (flags == SOC_PORT_FLEXE_RX)
    {
        SHR_IF_ERR_EXIT(READ_FSCL_CC_RX_VALUEr(unit, instance, &reg_val));
