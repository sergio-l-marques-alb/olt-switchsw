...
#
# FLEXE default make rules. These can optionally be overridden by
# letting FLEXE_MAKE_RULES point to a different rules file.
#

ifdef FLEXE_MAKE_RULES

include $(FLEXE_MAKE_RULES)
