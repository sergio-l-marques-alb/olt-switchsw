 ...
 *
 * Functions:
 *      bcm_petra_ptp_acceptable_master_add
 *      bcm_petra_ptp_acceptable_master_enabled_get
 *      bcm_petra_ptp_acceptable_master_enabled_set
 *      bcm_petra_ptp_acceptable_master_list
 *      bcm_petra_ptp_acceptable_master_remove
 *      bcm_petra_ptp_acceptable_master_table_clear
 *      bcm_petra_ptp_acceptable_master_table_size_get
 *      bcm_petra_ptp_cb_register
 *      bcm_petra_ptp_cb_unregister
 *      bcm_petra_ptp_clock_accuracy_get
 *      bcm_petra_ptp_clock_accuracy_set
 *      bcm_petra_ptp_clock_max_steps_removed_get
 *      bcm_petra_ptp_clock_max_steps_removed_set
 *      bcm_petra_ptp_clock_create
 *      bcm_petra_ptp_clock_current_dataset_get
 *      bcm_petra_ptp_clock_default_dataset_get
 *      bcm_petra_ptp_clock_domain_get
 *      bcm_petra_ptp_clock_domain_set
 *      bcm_petra_ptp_clock_get
 *      bcm_petra_ptp_clock_parent_dataset_get
 *      bcm_petra_ptp_clock_port_announce_receipt_timeout_get
 *      bcm_petra_ptp_clock_port_announce_receipt_timeout_set
 *      bcm_petra_ptp_clock_port_configure
 *      bcm_petra_ptp_clock_port_dataset_get
 *      bcm_petra_ptp_clock_port_delay_mechanism_get
 *      bcm_petra_ptp_clock_port_delay_mechanism_set
 *      bcm_petra_ptp_clock_port_disable
 *      bcm_petra_ptp_clock_port_enable
 *      bcm_petra_ptp_clock_port_identity_get
 *      bcm_petra_ptp_clock_port_info_get
 *      bcm_petra_ptp_clock_port_latency_get
 *      bcm_petra_ptp_clock_port_latency_set
 *      bcm_petra_ptp_clock_port_log_announce_interval_get
 *      bcm_petra_ptp_clock_port_log_announce_interval_set
 *      bcm_petra_ptp_clock_port_log_min_delay_req_interval_get
 *      bcm_petra_ptp_clock_port_log_min_delay_req_interval_set
 *      bcm_petra_ptp_clock_port_log_min_pdelay_req_interval_get
 *      bcm_petra_ptp_clock_port_log_min_pdelay_req_interval_set
 *      bcm_petra_ptp_clock_port_log_sync_interval_get
 *      bcm_petra_ptp_clock_port_log_sync_interval_set
 *      bcm_petra_ptp_clock_port_mac_get
 *      bcm_petra_ptp_clock_port_protocol_get
 *      bcm_petra_ptp_clock_port_type_get
 *      bcm_petra_ptp_clock_port_version_number_get
 *      bcm_petra_ptp_clock_priority1_get
 *      bcm_petra_ptp_clock_priority1_set
 *      bcm_petra_ptp_clock_priority2_get
 *      bcm_petra_ptp_clock_priority2_set
 *      bcm_petra_ptp_clock_slaveonly_get
 *      bcm_petra_ptp_clock_slaveonly_set
 *      bcm_petra_ptp_clock_time_get
 *      bcm_petra_ptp_clock_time_properties_get
 *      bcm_petra_ptp_clock_time_set
 *      bcm_petra_ptp_clock_timescale_get
 *      bcm_petra_ptp_clock_timescale_set
 *      bcm_petra_ptp_clock_traceability_get
 *      bcm_petra_ptp_clock_traceability_set
 *      bcm_petra_ptp_clock_user_description_set
 *      bcm_petra_ptp_clock_utc_get
 *      bcm_petra_ptp_clock_utc_set
 *      bcm_petra_ptp_ctdev_alarm_callback_register
 *      bcm_petra_ptp_ctdev_alarm_callback_unregister
 *      bcm_petra_ptp_ctdev_alpha_get
 *      bcm_petra_ptp_ctdev_alpha_set
 *      bcm_petra_ptp_ctdev_enable_get
 *      bcm_petra_ptp_ctdev_enable_set
 *      bcm_petra_ptp_ctdev_verbose_get
 *      bcm_petra_ptp_ctdev_verbose_set
 *      bcm_petra_ptp_detach
 *      bcm_petra_ptp_foreign_master_dataset_get
 *      bcm_petra_ptp_lock
 *      bcm_petra_ptp_unlock
 *      bcm_petra_ptp_init
 *      bcm_petra_ptp_input_channel_precedence_mode_set
 *      bcm_petra_ptp_input_channel_switching_mode_set
 *      bcm_petra_ptp_input_channels_get
 *      bcm_petra_ptp_input_channels_set
 *      bcm_petra_ptp_modular_enable_get
 *      bcm_petra_ptp_modular_enable_set
 *      bcm_petra_ptp_modular_phyts_get
 *      bcm_petra_ptp_modular_phyts_set
 *      bcm_petra_ptp_modular_portbitmap_get
 *      bcm_petra_ptp_modular_portbitmap_set
 *      bcm_petra_ptp_modular_verbose_get
 *      bcm_petra_ptp_modular_verbose_set
 *      bcm_petra_ptp_packet_counters_get
 *      bcm_petra_ptp_peer_dataset_get
 *      bcm_petra_ptp_primary_domain_get
 *      bcm_petra_ptp_primary_domain_set
 *      bcm_petra_ptp_servo_configuration_get
 *      bcm_petra_ptp_servo_configuration_set
 *      bcm_petra_ptp_servo_status_get
 *      bcm_petra_ptp_servo_threshold_get
 *      bcm_petra_ptp_servo_threshold_set
 *      bcm_petra_ptp_signal_output_get
 *      bcm_petra_ptp_signal_output_remove
 *      bcm_petra_ptp_signal_output_set
 *      bcm_petra_ptp_signaled_unicast_master_add
 *      bcm_petra_ptp_signaled_unicast_master_remove
 *      bcm_petra_ptp_signaled_unicast_slave_list
 *      bcm_petra_ptp_signaled_unicast_slave_table_clear
 *      bcm_petra_ptp_signaling_arbiter_register
 *      bcm_petra_ptp_signaling_arbiter_unregister
 *      bcm_petra_ptp_stack_create
 *      bcm_petra_ptp_static_unicast_master_add
 *      bcm_petra_ptp_static_unicast_master_list
 *      bcm_petra_ptp_static_unicast_master_table_clear
 *      bcm_petra_ptp_static_unicast_master_table_size_get
 *      bcm_petra_ptp_static_unicast_slave_add
 *      bcm_petra_ptp_static_unicast_slave_list
 *      bcm_petra_ptp_static_unicast_slave_remove
 *      bcm_petra_ptp_static_unicast_slave_table_clear
 *      bcm_petra_ptp_sync_phy
 *      bcm_petra_ptp_telecom_g8265_init
 *      bcm_petra_ptp_telecom_g8265_network_option_get
 *      bcm_petra_ptp_telecom_g8265_network_option_set
 *      bcm_petra_ptp_telecom_g8265_packet_master_add
 *      bcm_petra_ptp_telecom_g8265_packet_master_best_get
 *      bcm_petra_ptp_telecom_g8265_packet_master_get
 *      bcm_petra_ptp_telecom_g8265_packet_master_list
 *      bcm_petra_ptp_telecom_g8265_packet_master_lockout_set
 *      bcm_petra_ptp_telecom_g8265_packet_master_non_reversion_set
 *      bcm_petra_ptp_telecom_g8265_packet_master_priority_override
 *      bcm_petra_ptp_telecom_g8265_packet_master_priority_set
 *      bcm_petra_ptp_telecom_g8265_packet_master_remove
 *      bcm_petra_ptp_telecom_g8265_packet_master_wait_duration_set
 *      bcm_petra_ptp_telecom_g8265_pktstats_thresholds_get
 *      bcm_petra_ptp_telecom_g8265_pktstats_thresholds_set
 *      bcm_petra_ptp_telecom_g8265_quality_level_set
 *      bcm_petra_ptp_telecom_g8265_receipt_timeout_get
 *      bcm_petra_ptp_telecom_g8265_receipt_timeout_set
 *      bcm_petra_ptp_telecom_g8265_shutdown
 *      bcm_petra_ptp_time_format_set
 *      bcm_petra_ptp_timesource_input_status_get
 *      bcm_petra_ptp_tod_input_sources_get
 *      bcm_petra_ptp_tod_input_sources_set
 *      bcm_petra_ptp_tod_output_get
 *      bcm_petra_ptp_tod_output_remove
 *      bcm_petra_ptp_tod_output_set
 *      bcm_petra_ptp_transparent_clock_default_dataset_get
 *      bcm_petra_ptp_transparent_clock_port_dataset_get
 *      bcm_petra_ptp_unicast_request_duration_get
 *      bcm_petra_ptp_unicast_request_duration_max_get
 *      bcm_petra_ptp_unicast_request_duration_max_set
 *      bcm_petra_ptp_unicast_request_duration_min_get
 *      bcm_petra_ptp_unicast_request_duration_min_set
 *      bcm_petra_ptp_unicast_request_duration_set
 *      bcm_petra_ptp_clock_peer_age_timer_set
 *      bcm_petra_ptp_clock_peer_age_timer_get
 *      bcm_petra_tdpll_input_clock_ql_change_callback_register
 *      bcm_petra_tdpll_input_clock_ql_change_callback_unregister
 */
...
#define _ERR_MSG_MODULE_NAME BSL_BCM_PTP
...
int bcm_petra_ptp_dnx_systemhdr_info_send( int unit);
 ...
 * Notes:
 */
int bcm_petra_ptp_clock_max_steps_removed_set
(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
...
/*
 * Function:
 *      bcm_petra_ptp_clock_local_priority_get
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_clock_local_priority_set
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_pkt_flags_override_get
 * Purpose:
 *      Get slave peer aging time for PTP clock
 * Parameters:
 *      unit - Unit number
...
/*
 * Function:
 *      bcm_petra_ptp_pkt_flags_override_set
 * Purpose:
 *      Set slave peer aging time for PTP clock
 * Parameters:
 *      unit - Unit number
    ...
    int unit)
{
    ...
    {
        _bcm_dpp_am_template_ptp_port_profile_deinit(unit, SOC_PPC_PTP_IN_PP_PORT_PROFILE_0);
    }
    ...
    int unit)
{
    ...
    SOC_PPC_PTP_PORT_INFO default_port_profile;
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        /* HW initialization */
        soc_sand_rv = soc_ppd_ptp_init(soc_sand_dev_id);
        BCM_SAND_IF_ERR_EXIT(soc_sand_rv);

        SOC_PPC_PTP_PORT_INFO_clear(&default_port_profile);

        default_port_profile.ptp_enabled = 0;

        /* init AM DB to match HW - all ports are 1588 diabled by default */
        rc = _bcm_dpp_am_template_ptp_port_profile_init(unit, SOC_PPC_PTP_IN_PP_PORT_PROFILE_0, &default_port_profile);
        BCMDNX_IF_ERR_EXIT(rc);
       

        /* adding internally used 1588 drop trap */
        SOC_PPC_TRAP_FRWRD_ACTION_PROFILE_INFO_clear(&profile_info);
             
        
        soc_sand_rv = soc_ppd_trap_frwrd_profile_info_get(soc_sand_dev_id, SOC_PPC_TRAP_CODE_1588_PACKET_1, &profile_info); 
        BCM_SAND_IF_ERR_EXIT(soc_sand_rv);
        

        profile_info.bitmap_mask = SOC_PPC_TRAP_ACTION_PROFILE_OVERWRITE_DEST;

        SOC_PPD_FRWRD_DECISION_DROP_SET(soc_sand_dev_id, &(profile_info.dest_info.frwrd_dest), soc_sand_rv);
        BCM_SAND_IF_ERR_EXIT(soc_sand_rv);

        profile_info.dest_info.add_vsi = FALSE;

        profile_info.strength = 7;        

        soc_sand_rv = soc_ppd_trap_frwrd_profile_info_set(soc_sand_dev_id, 
                                                          SOC_PPC_TRAP_CODE_1588_PACKET_0 + SOC_PPC_PTP_ACTION_FIELD_ACTION_INDEX_DROP, 
...
/*
 * Function:
 *      bcm_petra_ptp_synce_output_get
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_synce_output_set
 * Purpose:
...
int
bcm_petra_ptp_clock_port_drop_counters_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    uint32 clock_port,
...
int
bcm_petra_ptp_clock_port_drop_counters_enable_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    uint32 clock_port,
...
/*
 * Function:
 *      bcm_petra_ptp_packet_counters_clear
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_phase_offset_set
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_phase_offset_get
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_cosq_port_send, it's a internal funtion
 * Purpose:
 ...
 */
int
bcm_petra_ptp_cosq_port_send(int unit)
{
    ...
    ptp_cosq_port = soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "ptp_cosq_port", 0);
    if (!ptp_cosq_port) {
        BCMDNX_ERR_EXIT_MSG(BCM_E_RESOURCE,
                                (_BSL_BCM_MSG("Error: ptp get cosq port failed. \n")));
    }
    ...
    rc = soc_cmic_uc_msg_send(unit, 1, &start_msg, timeout_usec);
    if (BCM_FAILURE(rc)) {
        BCMDNX_ERR_EXIT_MSG(BCM_E_FAIL,
                                (_BSL_BCM_MSG("Error: call soc_cmic_uc_msg_send failed, errcode is %d. \n"), rc));
    }
...
/*
 * Function:
 *     bcm_petra_ptp_custom_ftmh_header_config_send
 * Purpose:
 *     Functioin to send custom_ftmh_header mode enable flag
 * Parameters:
 *      unit - (IN) Unit number.
 * Returns:
 *      BCM_E_xxx
 ...
 */
int
bcm_petra_ptp_custom_ftmh_header_config_send(int unit)
{
   mos_msg_data_t start_msg;
   int rc;
   int timeout_usec=1900000;
   int custom_ftmh_header_mode_en = 0; 

   /*check soc_property*/
   BCMDNX_INIT_FUNC_DEFS;
   custom_ftmh_header_mode_en = soc_property_get(unit , "custom_feature_add_ftmh_header",0);
   
   start_msg.s.mclass = MOS_MSG_CLASS_1588;
   start_msg.s.subclass = MOS_MSG_SUBCLASS_DNX_CUSTOM_FTMH_HEADER_EN;
   start_msg.s.len = 0;
   start_msg.s.data = bcm_htonl(custom_ftmh_header_mode_en);
    ...
    bcm_ptp_stack_info_t *ptp_info)
{
    ...
    rc = bcm_petra_ptp_dnx_systemhdr_info_send(unit);
    BCMDNX_IF_ERR_EXIT(rc);

    rc = bcm_petra_ptp_custom_ftmh_header_config_send(unit);
    BCMDNX_IF_ERR_EXIT(rc);

    rc = bcm_petra_ptp_cosq_port_send(unit);
    BCMDNX_IF_ERR_EXIT(rc);
...
/*
 * Function:
 *      bcm_petra_ptp_static_unicast_master_remove
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_bs_time_info_get
 * Purpose:
 *      Instruct TOP to send a PHY Sync pulse, and mark the time that the PHYs are now synced to.
 * Parameters:
 *      unit - Unit number
...
/*
 * Function:
 *      bcm_petra_tdpll_esmc_essm_code_set()
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_tdpll_esmc_essm_code_get()
 * Purpose:
 ...
 */
int
bcm_petra_tdpll_input_clock_callback_register(
    int unit,
    int stack_id,
 ...
 */
int
bcm_petra_tdpll_input_clock_callback_unregister(
    int unit,
    int stack_id,
    bcm_tdpll_callback_type_t type)
{
...
/*
 * Function:
 *      bcm_petra_tdpll_output_clock_create()
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_clock_quality_get
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_clock_quality_set
 * Purpose:
...
/*
 * Function:
 *      bcm_petra_ptp_g8275p1_traceability_info_clock_class_map
 * Purpose:
...
int bcm_petra_ptp_clock_bmca_override_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    uint32 flags,
...
int bcm_petra_ptp_clock_bmca_override_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    uint32 *flags,
 ...
 * feature.
 */
int bcm_petra_ptp_clock_apts_enable_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int *enable)
 ...
 * feature.
 */
int bcm_petra_ptp_clock_apts_enable_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int enable)
 ...
 * sources.
 */
int bcm_petra_ptp_clock_apts_source_prio_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int *num_sources,
 ...
 * sources.
 */
int bcm_petra_ptp_clock_apts_source_prio_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int num_sources,
 ...
 */
int bcm_petra_ptp_clock_apts_mode_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
 ...
 * is available or not.
 */
int bcm_petra_ptp_clock_apts_source_enable_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
 ...
 * is available or not.
 */
int bcm_petra_ptp_clock_apts_source_enable_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    bcm_ptp_clock_apts_source_t source,
...
/*
 * Function:
 *      bcm_petra_ptp_external_phy_synchronize()
 * Purpose:
...
int 
bcm_petra_tdpll_event_callback_register(
    int unit, 
    int ptp_id, 
...
int 
bcm_petra_tdpll_event_callback_unregister(
    int unit, 
    int ptp_id)
{
    int rv;
 ...
 */
int bcm_petra_ptp_clock_apts_gps_offset_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int offset_nsec)
 ...
 * in the GPS receiver path
 */
int bcm_petra_ptp_clock_apts_gps_offset_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int *offset_nsec)
...
/*
 * Function:
 *      _bcm_petra_ptp_dnx_syshdr_infomation_send, it's a internal funtion
 * Purpose:
 ...
 */
int
bcm_petra_ptp_dnx_systemhdr_info_send(
    int unit)
{
    mos_msg_data_t start_msg;
    int timeout_usec = 1900000;
    ...
    start_msg.s.mclass = MOS_MSG_CLASS_1588;
    start_msg.s.subclass = MOS_MSG_SUBCLASS_DNX_SYSHDR_UDHHDR_LEN;
    start_msg.s.len = 0;
    start_msg.s.data = bcm_htonl(user_header_size);

    _rv = soc_cmic_uc_msg_send(unit, 1, &start_msg, timeout_usec);
    if (BCM_FAILURE(_rv)) {
        BCMDNX_ERR_EXIT_MSG(BCM_E_FAIL,
                                (_BSL_BCM_MSG("Error: call soc_cmic_uc_msg_send failed, errcode is %d. \n"), _rv));
