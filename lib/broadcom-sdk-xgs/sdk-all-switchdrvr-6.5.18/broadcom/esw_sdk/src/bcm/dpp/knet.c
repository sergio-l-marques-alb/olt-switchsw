...
bcm_petra_knet_netif_create(int unit, bcm_knet_netif_t *netif)
{
    ...
    switch (netif->type)
    {
        ...
        case BCM_KNET_NETIF_T_TX_META_DATA:
            BCMDNX_ERR_EXIT_MSG(BCM_E_PARAM, (_BSL_BCM_MSG("KNET: Unsupported netif type BCM_KNET_NETIF_T_TX_META_DATA\n")));
        default:;
    ...
    {
        BCMDNX_ERR_EXIT_MSG(BCM_E_PARAM, (_BSL_BCM_MSG("KNET: Unsupported RCPU encapsulation\n")));
    }
