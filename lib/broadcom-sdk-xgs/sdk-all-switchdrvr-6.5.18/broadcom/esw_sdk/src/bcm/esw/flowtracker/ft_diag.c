        ...
        uint8 *ft_data)
{
    ...
    if (flowcheck_id) {
        ...
        LOG_CLI((BSL_META_U(unit, " (%s, %s)"), plist[element], alist[action]));
    } else {
...
#endif
        ts_type = bcmi_ft_group_get_ts_type(unit, gid, ts_data_fields[0]);
...
#endif
        ts_type = bcmi_ft_group_get_ts_type(unit, gid, ts_data_fields[1]);
...
#endif
        ts_type = bcmi_ft_group_get_ts_type(unit, gid, ts_data_fields[2]);
...
#endif
        ts_type = bcmi_ft_group_get_ts_type(unit, gid, ts_data_fields[3]);
