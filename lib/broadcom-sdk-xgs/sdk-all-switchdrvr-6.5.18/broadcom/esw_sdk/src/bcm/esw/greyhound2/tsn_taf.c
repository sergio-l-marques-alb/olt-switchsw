...
#define BCMI_FL_TSN_TAF_GATE_NUM (64)
...
_tsn_taf_gate_num(int unit)
{
    if (SOC_IS_FIRELIGHT(unit)){
        return BCMI_FL_TSN_TAF_GATE_NUM;
    }
    return BCMI_TSN_TAF_GATE_NUM;
}
...
{
    if (SOC_IS_FIRELIGHT(unit)){
        return ((BCMI_FL_TSN_TAF_GATE_NUM + TAF_INTERRUPT_SUB_FIELD_WIDTH - 1)
