 ...
 */
int
bcmi_fb6_clport_update(int unit,
                            soc_port_schedule_state_t *port_schedule_state)
{
    soc_info_t *si = &SOC_INFO(unit);
    ...
    uint32 rval;
    static soc_field_t port_fields[FIREBOLT6_PORTS_PER_PBLK] = {
        PORT0f, PORT1f, PORT2f, PORT3f
    };
    static const int mode_encodings[SOC_FB6_PORT_RATIO_COUNT] = {
        4, 3, 3, 3, 2, 2, 1, 1, 0
    };
...
*/
    ...
    /* BCMI Driver init */
    sal_memset(&bcmi_fb6_port_drv, 0, sizeof(bcmi_fb6_port_drv));
