...
STATIC int
_bcm_td3_cosq_egr_queue_set(int unit, bcm_gport_t gport, bcm_cos_queue_t cosq,
                            bcm_cosq_control_t type, int arg)
{
    bcm_port_t local_port;
    int pipe, startq;
    ...
    if (!post_update &&
        ...
        SOC_IF_ERROR_RETURN(
            soc_td3_mmu_config_shared_buf_recalc(unit, 2 /* egr */, -1,
    ...
    if (type == bcmCosqControlIngressPortPGMinLimitBytes) {
        ...
        if ((arg / granularity) > cur_val) {
            ...
            * Increase the Min Value for given resource */             
            ...
            SOC_IF_ERROR_RETURN(
                soc_td3_mmu_config_shared_buf_recalc(unit, 1 /* ing */,
                                                     ing_shd_size - delta,
                                                     -1, -1, 1));

            /* the value may be changed by soc_td3_mmu_config_res_limits_update
                               ...
                               bcm_cosq_gport_discard_t *discard)
{
    ...
    for (i = 0; i < numq; i++) {
        BCM_IF_ERROR_RETURN
            (_bcm_td3_cosq_wred_set(unit, gport, cosq + i, discard->flags,
                              ...
                              bcm_cosq_control_t type, int arg)
{
    ...
    if (type == bcmCosqControlEgressUCQueueGroupMinLimitBytes) {
        ...
        SOC_IF_ERROR_RETURN(soc_td3_mmu_config_shared_buf_recalc(
