        ...
        switch(node->level) {
            case SOC_HR4_NODE_LVL_L0:
                if(IS_CPU_PORT(unit, local_port)){
                    ...
                    *cosq = node->hw_index - (_HR4_BASE_L0QUEUE + (mmu_port * _HR4_NUML0_NODES));
                }
                break;
            case SOC_HR4_NODE_LVL_L1:
                if(IS_CPU_PORT(unit, local_port)){
                    ...
                    *cosq = node->hw_index - (_HR4_BASE_L1QUEUE + (mmu_port * _HR4_NUML1_NODES));
                }
                break;
            case SOC_HR4_NODE_LVL_L2:
                if(IS_CPU_PORT(unit, local_port)){
                    ...
                    *cosq = node->hw_index - (_HR4_BASE_L2QUEUE + (mmu_port * _HR4_NUML2_NODES));
                }
                break;
            default:
                return BCM_E_PARAM;
...
int
_bcm_hr4_port_enqueue_get(int unit, bcm_port_t gport,
                          int *enable)
{
    bcm_port_t local_port = -1;
