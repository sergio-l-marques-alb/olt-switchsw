...
STATIC int
bcmi_ftv3_alu_kmap_opr_result_get(int unit,
                ...
                uint32 *bit_sel_array)
{
    ...
    if (check_0_opr != -1) {
        if (check_0_opr == 7) {
            opr_output_arr[BCMI_FT_ALU_KMAP_BIT_SEL_CHECK0_RES] = 0;
        } else {
            opr_output_arr[BCMI_FT_ALU_KMAP_BIT_SEL_CHECK0_RES] = 1;
        }
    }
    ...
    if (check_1_opr != -1) {
        if (check_1_opr == 7) {
            opr_output_arr[BCMI_FT_ALU_KMAP_BIT_SEL_CHECK1_RES] = 0;
        } else {
            opr_output_arr[BCMI_FT_ALU_KMAP_BIT_SEL_CHECK1_RES] = 1;
        }
    }
    ...
    if (soc_feature(unit, soc_feature_flex_flowtracker_ver_3)) {
        BCM_IF_ERROR_RETURN(
                bcmi_ftv3_alu_kmap_opr_result_get(unit, fc_info, opr_output_arr));
    }
#endif
                                         ...
                                         uint32 *alu_fmt)
{
    ...
    if (alu_info->flowchecker_id > 0) {
        ...
        rv = bcmi_ft_element_alu_action_get
                        (unit, alu_info->element_type1, &alu_action);
        BCM_IF_ERROR_RETURN(rv);
    ...
    BCM_IF_ERROR_RETURN
       (bcmi_ft_alu_hw_action_get(unit, element, alu_action, &hw_action));
                              ...
                              int *indexes)
{
    ...
    if (soc_feature(unit, soc_feature_flex_flowtracker_ver_2)) {
        BCM_IF_ERROR_RETURN(
            bcmi_ftv2_group_alu32_mask_clear(unit, alu_load_type,
                        mem, new_index));
    }
#endif
                              ...
                              int *indexes)
{
    ...
    if (soc_feature(unit, soc_feature_flex_flowtracker_ver_2)) {
        BCM_IF_ERROR_RETURN(
          bcmi_ftv2_group_alu16_mask_clear(unit, mem, new_index));
    }
#endif
                                ...
                                uint32 *alu32_specific_ctrlfmt)
{
    ...
    if ((alu_info->element_type1 ==
        ...
        if (alu_info->element_type1 ==
            ...
            ts_dst = bcmFlowtrackerTimestampSourceIngress;
            ...
            ts_dst = BCMI_FT_GROUP_TS_TRIGEER_SOURCE(trig);
        ...
        BCM_IF_ERROR_RETURN
            (bcmi_ftv2_alu_hw_timestamp_get(unit, id,
                                            ts_src, &hw_src_ts));
...
/*
 * Function:
 *   bcmi_ftv3_alu_kmap_opr_result_get
 * Purpose:
    ...
    int set)
{
    ...
    if (info->flowchecker_id > 0) {
        ...
        bcmi_ft_alu_load_mem_index_get(unit, index,
                alu_load_type, &new_index, NULL, NULL);
