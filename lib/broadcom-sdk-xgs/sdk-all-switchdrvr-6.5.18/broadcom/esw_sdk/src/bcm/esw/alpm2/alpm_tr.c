...
#define ALPMRES_OP_CNT(u)       (ALPMRES(u)->op_cnt)
...
typedef struct _alpm_res_log_s {
    ...
    int op_cnt;     /* operation (add/delete) cnt */
...
const char *alpm_route_grp_name[] = {
    "IPv4 UC Route (Private) ",
    "IPv4 UC Route (Global)  ",
    "IPv4 UC Route (Override)",
    "IPv6 UC Route (Private) ",
    "IPv6 UC Route (Global)  ",
    "IPv6 UC Route (Override)",
    NULL,
};

const char *alpm_route_comb_name[] = {
    "IPv4 UC Route (Private+Global)",
    "IPv4 UC Route (Private+Global)",
    "IPv4 UC Route (Override)      ",
    "IPv6 UC Route (Private+Global)",
    "IPv6 UC Route (Private+Global)",
    "IPv6 UC Route (Override)      ",
    NULL,
};
...
bcm_esw_alpm_trace_log(int u, int is_del, _bcm_defip_cfg_t *cfg, int nh_idx, int rc)
{
    ...
    if (ALPMRES(u) && ALPMRES_EN(u) && ((ALPMRES_OP_CNT(u)++ % ALPM_RES_LOG_OPS) == 0)) {
