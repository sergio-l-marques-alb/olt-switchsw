    ...
    bcm_compat6516_tunnel_initiator_t *tunnel)
{
    ...
    if (NULL != tunnel) {
        /* Create from heap to avoid the stack to bloat */
        new_info = (bcm_compat6517_tunnel_initiator_t*)
            sal_alloc(sizeof(bcm_tunnel_initiator_t), "New tunnel initiator");
        if (NULL == new_info) {
            return BCM_E_MEMORY;
        }
...
{
    int rv;
    bcm_vlan_control_vlan_t *new_ctrl = NULL;

    if (NULL != control) {
        /* Create from heap to avoid the stack to bloat */
        new_ctrl = (bcm_vlan_control_vlan_t *)
            sal_alloc(sizeof(bcm_vlan_control_vlan_t), "New vlan ctrl");
        if (NULL == new_ctrl) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_selective_get(unit, vlan,
    ...
    bcm_compat6516_vlan_control_vlan_t *control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_selective_set(unit, vlan,
                                             valid_fields, new_ctrl);
    ...
    bcm_compat6516_vlan_control_vlan_t *control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_get(unit, vlan, new_ctrl);
    ...
    bcm_compat6516_vlan_control_vlan_t control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_set(unit, vlan, *new_ctrl);
