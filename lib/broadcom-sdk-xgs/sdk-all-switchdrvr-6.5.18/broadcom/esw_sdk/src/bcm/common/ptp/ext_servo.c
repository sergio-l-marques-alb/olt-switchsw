...
#if 0
void register_cb( T_pdvThresholdExceededCallback pdv_cb, T_losmStateChangedCallback loState_cb) {
    
    _bcm_ptp_cb_func.userPdvThresholdExceededCallback = pdv_cb;
    _bcm_ptp_cb_func.userLosmStateChangedCallback = loState_cb;
    ...
    bcm_ptp_osc_type_t             osc_type)
{
  ...
  configParam.externalConfig.referenceTrackerType                    = E_srvAdaptiveTimeReferenceTracker;
