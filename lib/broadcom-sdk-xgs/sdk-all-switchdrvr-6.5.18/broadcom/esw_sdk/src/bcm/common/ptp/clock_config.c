...
void _bcm_ptp_apts_update_current_mode()
{
    int i;
    ...
    bcm_ptp_clock_apts_source_t *priority_list)
{
    ...
    sal_memcpy(priority_list, g_apts_usr_cfgd_priority_list,
            BCM_PTP_CLOCK_APTS_MAX_FREQ_SOURCES*sizeof(bcm_ptp_clock_apts_source_t));
    *num_sources = BCM_PTP_CLOCK_APTS_MAX_FREQ_SOURCES;
    return rv;
}
