    ...
    uint8 tcam_index)
{
    ...
    is_maid48 = _SHR_IS_FLAG_SET(group_info.flags, BCM_OAM_GROUP_FLEXIBLE_MAID_48_BYTE);
    is_mip = DNX_OAM_DISSECT_IS_ENDPOINT_MIP(endpoint_info);
    is_up = DNX_OAM_DISSECT_IS_ENDPOINT_UPMEP(endpoint_info);
    ...
    sw_endpoint_info.extra_data_length = DNX_OAM_CCM_ENDPOINT_EXTRA_DATA_LENGHT_CALC(is_maid48);
    ...
    uint8 prefix)
{
    ...
    /*
     * For Egress side in Jr2_A0, Hw bug crushes the device in case of counter_if=INVALID_COUNTER_IF
     ...
     * B0,J2C: INVALID_COUNTER_IF both for ingress and egress. oam_force_interface_for_meps_without_counter_get = 0
     */
            ...
            (DNX_OAM_PROFILE_VALID_GET(endpoint_info->acc_profile_id) == 1))
        {
            ...
            SHR_IF_ERR_EXIT(dnx_oam_acc_mep_add
                            (unit, _SHR_CORE_ALL,
                             ...
                             oam_lif, endpoint_info->level, classifier_ep_id,
