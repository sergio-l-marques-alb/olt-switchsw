    ...
    int arg)
{
    ...
    if (_SHR_IS_FLAG_SET(flags, BCM_QOS_MAP_IPV4) && _SHR_IS_FLAG_SET(flags, BCM_QOS_MAP_IPV6))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Can only set one of explicit null labe for IPv4 or IPv6\n");
    }
 ...
 */
int
bcm_dnx_qos_map_opcode_get_by_id(
    int unit,
    uint32 flags,
    int profile_id,
    int *map_id)
    ...
    int arg)
{
    ...
    switch (type)
    {
        case bcmQosControlMplsIngressSwapRemarkProfile:
        {
            SHR_IF_ERR_EXIT(dnx_qos_ingress_control_mpls_swap_remark_profile_set(unit, arg));
            break;
        }
    ...
    int *arg)
{
    ...
    switch (type)
    {
        case bcmQosControlMplsIngressSwapRemarkProfile:
        {
            SHR_IF_ERR_EXIT(dnx_qos_ingress_control_mpls_swap_remark_profile_get(unit, arg));
            break;
        }
