...
const __imb__dispatch__t__ imb_imb_feu_driver = {
    ...
    NULL,       /* imb_port_loopback_set */
    NULL,       /* imb_port_loopback_get */
    ...
    NULL,       /* imb_port_speed_config_set */
    NULL,       /* imb_port_speed_config_get */
