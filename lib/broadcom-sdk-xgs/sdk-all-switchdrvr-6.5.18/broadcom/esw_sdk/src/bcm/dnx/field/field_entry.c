    ...
    uint32 *data_p)
{
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                    (unit, entry_handle_id, DBAL_FIELD_STATE_TABLE_DATA, INST_SINGLE, data_p));
    ...
    uint32 *entry_handle_p)
{
    ...
    if (flags && fg_type != DNX_FIELD_GROUP_TYPE_TCAM)
    {
    ...
    uint32 *entry_handle_p)
{
    ...
    else
    {
        ...
        *entry_handle_p = DNX_FIELD_TCAM_DT_ENTRY(key, fg_id, entry_info_p->core);
        ...
        SHR_IF_ERR_EXIT(dnx_field_tcam_handler_entry_location_alloc(unit, entry_info_p->core, tcam_handler_id, &entry));
    }
    ...
    uint32 *entry_handle_p)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL, "External TCAM (KBP) access_id larger than %d bits (%x).\r\n",
