...
dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_dump(int  unit,  int  keys_availability_stage_info_idx_0,  int  keys_availability_group_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_dump(unit, keys_availability_stage_info_idx_0, keys_availability_group_info_idx_0, filters));
    SHR_IF_ERR_EXIT(dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_dump(unit, keys_availability_stage_info_idx_0, keys_availability_group_info_idx_0, filters));
 ...
 */
int
dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_dump(int  unit,  int  keys_availability_stage_info_idx_0,  int  keys_availability_group_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = keys_availability_stage_info_idx_0, I0 = keys_availability_stage_info_idx_0 + 1;
    int i1 = keys_availability_group_info_idx_0, I1 = keys_availability_group_info_idx_0 + 1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_algo_field_key_alloc keys_availability keys_availability_stage_info keys_availability_group_info availability_going_up") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_algo_field_key_alloc keys_availability keys_availability_stage_info keys_availability_group_info availability_going_up\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
 ...
 */
int
dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_dump(int  unit,  int  keys_availability_stage_info_idx_0,  int  keys_availability_group_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = keys_availability_stage_info_idx_0, I0 = keys_availability_stage_info_idx_0 + 1;
    int i1 = keys_availability_group_info_idx_0, I1 = keys_availability_group_info_idx_0 + 1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_algo_field_key_alloc keys_availability keys_availability_stage_info keys_availability_group_info availability_odd_only") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_algo_field_key_alloc keys_availability keys_availability_stage_info keys_availability_group_info availability_odd_only\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
