    ...
    int unit)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PHB_PROPAGATION_STRENGTH, INST_SINGLE, 1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RM_PROPAGATION_STRENGTH, INST_SINGLE, 1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN_PROPAGATION_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TTL_PROPAGATION_STRENGTH, INST_SINGLE, 1);
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(algo_port_pp_db.esem_default_result_profile.allocate_single
                    (unit, DNX_ALGO_RES_ALLOCATE_WITH_ID, NULL, &esem_handle));
...
bcm_dnx_mpls_vpn_id_destroy(
    ...
    bcm_vpn_t vpn)
{
    int vpn_id, new_in_lif_profile, old_vsi_profile, result_type;
    uint8 is_vsi_used;
    uint32 entry_handle_id;
    ...
    if (!is_vsi_used)
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_VSI, vpn_id);
