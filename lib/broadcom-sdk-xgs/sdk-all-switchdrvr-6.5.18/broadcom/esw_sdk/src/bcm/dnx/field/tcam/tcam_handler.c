        ...
        if (core == DNX_FIELD_TCAM_CORE_ALL || core == core_iter)
        {
            if (!fg_params.direct_table)
            {
                ...
                if (!found)
                {
                    ...
                    SHR_IF_ERR_EXIT(dnx_field_tcam_location_find
                                    (unit, core_iter, handler_id, entry, &location, &found));
                    if (!found)
                    {
             ...
             */
            SHR_IF_ERR_EXIT(dnx_field_tcam_location_alloc
                            (unit, core_iter, handler_id, entry, &location, fg_params.direct_table));
