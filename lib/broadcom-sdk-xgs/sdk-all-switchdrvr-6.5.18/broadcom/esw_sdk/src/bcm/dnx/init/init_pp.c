...
#define PD_RESULT_TYPE_NOT_FOUND (DBAL_ENUM_FVAL_DIRECT_EXTRACTION_PD_RESULT_TYPE_RESULT_NOT_FOUND)
#define PD_RESULT_TYPE_FOUND     (DBAL_ENUM_FVAL_DIRECT_EXTRACTION_PD_RESULT_TYPE_RESULT_FOUND)
...
static const egress_per_fwd_code_config_table_t egress_per_fwd_code_config_table_map[] = {
   ...
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    ...
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 0},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV4_UC_R0, 1, 0, 1, 0, 0, 0, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 0},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV4_UC_R1, 1, 0, 1, 0, 0, 0, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 0},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV4_MC_R0, 1, 0, 0, 1, 0, 0, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 0},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV4_MC_R1, 1, 0, 0, 1, 0, 0, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 0},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV6_UC_R0, 1, 0, 0, 0, 1, 0, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 1},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV6_UC_R1, 1, 0, 0, 0, 1, 0, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 1},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV6_MC_R0, 1, 0, 0, 0, 0, 1, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 1},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
    {IPV6_MC_R1, 1, 0, 0, 0, 0, 1, 0,
    /**     STP Enable,   VLAN_MEMBERSHIP_ENABLE,   ACCEPTABLE_FRAME_TYPE_ENABLE,   SPLIT_HORIZON_ENABLE, LEARN_ENABLE,     CONTEXT_IS_PP,          IPV4_OR_IPV6 */
     0, 0, 0, 0, 0, 1, 1},
   /**      Forward Code,     Termination Forward Code Enable,  Ethernet FWD Code Enable,   IPv4_UC,   IPv4_MC,   IPv6_UC,       IPv6_MC,       MPLS */
...
/**  Current Protocol Type,                              Next Protocol Namespace,                                             Current Next Protocol*/
    ...
    {DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_MPLS_UA, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_ETHERTYPE,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_MPLS_UA_OVER_ETHERNET},
    ...
    {DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_ERSPAN, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_ETHERTYPE,
    ...
    {DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_MPLS_UA, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_IP_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_MPLS_OVER_IP},
    ...
    {DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_MPLS_UA, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_MPLS_BOS,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_MPLS_BOS},
    ...
    {DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_VXLAN_GPE_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_ETHERNET},
    {DBAL_ENUM_FVAL_LAYER_TYPES_IPV4, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_VXLAN_GPE_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_MPLS},
    {DBAL_ENUM_FVAL_LAYER_TYPES_IPV6, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_VXLAN_GPE_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_IPV6},
    {DBAL_ENUM_FVAL_LAYER_TYPES_MPLS, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_VXLAN_GPE_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_MPLS_OVER_VXLAN},
    {DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UA, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_VXLAN_GPE_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_MPLS_OVER_VXLAN},
    {DBAL_ENUM_FVAL_LAYER_TYPES_IPV4, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_PPP_NEXT_PROTOCOL,
     DBAL_DEFINE_CURRENT_NEXT_PROTOCOL_IPV4_OVER_PPPOE},
    {DBAL_ENUM_FVAL_LAYER_TYPES_IPV6, DBAL_ENUM_FVAL_ETPP_NEXT_PROTOCOL_NAMESPACE_PPP_NEXT_PROTOCOL,
...
static const per_layer_protocol_t per_layer_protocol[] = {
    ...
    {DBAL_ENUM_FVAL_LAYER_TYPES_MPLS, FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,
     FALSE,
     FALSE, FALSE, FALSE},
    {DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UNTERM, FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE,
     FALSE,
     FALSE,
     FALSE, FALSE, FALSE},
    {DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UA, FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE,
     FALSE,
     FALSE, FALSE, FALSE, FALSE},
...
static const erpp_filter_per_fwd_context_t erpp_filter_per_fwd_context_map[] = {
    ...
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV4_UC_R0, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV4_UC_R1, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV4_MC_R0, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV4_MC_R1, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV6_UC_R0, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV6_UC_R1, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {IPV6_MC_R0, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE},
    {IPV6_MC_R1, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    ...
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    {TM, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE,
    /** SPLIT_HORIZON, GLEM_PP_TRAP, GLEM_NON_PP_TRAP, TTL_SCOPING, TTL_ZERO, TTL_ONE, MTU_VIOLATION, IPV4_FILTERS, IPV6_FILTERS, LAYER_4_FILTERS*/
     FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},
    /** Forwarding Context, TDM_DISCARD, RQP_DISCARD, INVALID_OTM, DSS_STACKING, LAG_MULTICAST, EXCLUDE_SRC, SAME_INTERFACE, UNACCEPTABLE_FRAME_TYPE, UNKNOWN_DA*/
    ...
    int unit)
{
    ...
    {
        /*
         * Enable termination for fwd code TM in interop mode
         */
        termination_enable = egress_per_fwd_code_config_table_map[entry].termination_enable;
        if (system_headers_mode == SYSTEM_HEADERS_MODE_JERICHO_MODE)
        {
            if (egress_per_fwd_code_config_table_map[entry].forward_code == TM)
            {
                termination_enable = 1;
            }
        }
    ...
    int unit)
{
    ...
    if (dnx_data_field.init.wa_jr1_ipmc_inlif_get(unit) == 1)
    {
        for (entry = 0; entry < nof_entries; entry++)
        {
            /*
     ...
     * ROO WA is not needed.
     */
    roo_wa_enable = dnx_data_field.init.wa_roo_get(unit);
    if (!roo_wa_enable)
    {
        /*
    ...
    int unit)
{
    ...
    if (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO2_MODE
        && dnx_data_dev_init.general.feature_get(unit, dnx_data_dev_init_general_network_header_termination))
    {
    ...
    uint32 fodo_mask_profile)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_DIRECT_EXTRACTION_PD_RESULT_TYPE, pd_result_type);
    ...
    int cw)
{
     ...
     */
    header = ADDITIONAL_HEADERS_CW_EL_ELI_PWE;
    /*
     * Write to EGRESS_ADDITIONAL_HEADERS_MAP_TABLE table
     */
    ...
    header = ADDITIONAL_HEADERS_CW_FL_PWE;
    /*
     * Write to EGRESS_ADDITIONAL_HEADERS_MAP_TABLE table
     */
    COMPILER_64_SET(work_reg_64, 0, protocol_specific_information_add_header);
    ...
    header = ADDITIONAL_HEADERS_CW_ESI_EVPN;
    /*
     * Write to EGRESS_ADDITIONAL_HEADERS_MAP_TABLE table
     */
    COMPILER_64_SET(work_reg_64, 0, protocol_specific_information_add_header);
    ...
    header = ADDITIONAL_HEADERS_CW_PWE;
    /*
     * Write to EGRESS_ADDITIONAL_HEADERS_MAP_TABLE table
     */
    COMPILER_64_SET(work_reg_64, 0, protocol_specific_information_add_header);
    SHR_IF_ERR_EXIT(egress_additional_headers_map_tables_configuration
                    (unit, additional_headers_map[header].additional_headers_profile,
                     ...
                     additional_headers_map[header].additional_headers_packet_size_enable_add_header_2,
                     additional_headers_map[header].additional_headers_packet_size_add_header_2,
                     work_reg_64, additional_headers_map[header].protocol_specific_information_add_header_2_type));
    ...
    int unit)
{
    ...
    for (ii = 0; ii < nof_ctx_to_config; ii++)
    {
        ...
        /*
         * before and after values differ only when WA second_stage parser is enabled
         */
    ...
    int unit)
{
    ...
    flp_threshold = dnx_data_elk.general.flp_full_treshold_get(unit);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FLP_FULL_THRESHOLD, INST_SINGLE, flp_threshold);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int unit)
{
    ...
    dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_IS_CONTEXT_L3_LIF, DBAL_RANGE_ALL,
                                     DBAL_RANGE_ALL);
    dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_PTC_PROFILE_VTT2, DBAL_RANGE_ALL,
                                     DBAL_RANGE_ALL);
    ...
    int unit)
{
...

    {
        ...
        data[0] = 0xffffffff;
        data[1] = 0xffffffff;
        SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, ETPPC_CFG_TERMINATION_FWD_CODE_ENr, REG_PORT_ANY, 0, data));
    }
    ...
    int unit)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LAYER_QUALIFIER_PREVIOUSLAYER, layer_qualifier);
...
/** \brief
 * configure ECOLogic for SRV6 egress node.
 ...
 */
static shr_error_e
ingress_ecologic_srv6_egress_tunnel_init(
    int unit)
{
    uint32 access_id;
    uint32 entry_handle_id;
     ...
     * DBAL_FIELD_ECOL_CONTEXT_ID field   */
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_ECOL_CONTEXT_ID, DBAL_ENUM_FVAL_ECOL_CONTEXT_ID_SRV6_EGRESS_NODE, &access_id));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(ingress_ecologic_srv6_egress_tunnel_init(unit));
    ...
    int unit)
{
    ...
    if (dnx_data_mdb.hw_bug.feature_get(unit, dnx_data_mdb_hw_bug_em_compare_init) && (!SAL_BOOT_PLISIM))
    {
        soc_reg_above_64_val_t data;
        bcm_core_t core;
        ...
        SHR_IF_ERR_EXIT(bcm_dnx_switch_control_set(unit, bcmSwitchExactMatchInit, 1));
        /*
