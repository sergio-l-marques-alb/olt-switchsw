 ...
 */
#define DNX_QOS_CONTROL_SUPPORTED_FLAGS    (BCM_QOS_MAP_IPV4 | BCM_QOS_MAP_IPV6 )
 ...
 * should supply a W.A for those cases. 
 * Write to QOS Hardware: 
 ...
 *   * None
 */
shr_error_e dnx_qos_ingress_control_mpls_swap_remark_profile_set(
    int unit,
    int egr_map);
/**
 * \brief 
 ...
 *   * None
 */
shr_error_e dnx_qos_ingress_control_mpls_swap_remark_profile_get(
    int unit,
    int *egr_map);
