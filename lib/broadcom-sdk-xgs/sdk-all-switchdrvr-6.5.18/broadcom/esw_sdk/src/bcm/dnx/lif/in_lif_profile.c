    ...
    int *eth_rif_profile_egress_reserved_start_bit)
{
        ...
        && (dnx_data_qos.qos.routing_dscp_preserve_mode_get(unit) == 1))
    {
        *eth_rif_profile_used_bits_mask = (1 << (NOF_ETH_RIF_PROFILE_BITS - ETH_RIF_PROFILE_PMF_RESERVED_NOF_BITS -
        ...
        if (dnx_data_lif.hw_bug.feature_get(unit, dnx_data_lif_hw_bug_iop_mode_orientation_selection))
        {
    ...
    int *egress_in_lif_profile)
{
    ...
    /**Convert to egress profile in JR1 system header mode, in case orientation is indexed by jr1 inlif profile*/
              ...
              DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
             && dnx_data_lif.hw_bug.feature_get(unit, dnx_data_lif_hw_bug_iop_mode_orientation_selection))
    {
    ...
    int *in_lif_orientation)
{
    ...
    else if (preserve_dscp_mode)
    {
        ...
        *in_lif_orientation = 0;
        ...
        (*egress_in_lif_profile_info).ive_inner_qos_dp_profile = 0;
        (*egress_in_lif_profile_info).ive_outer_qos_dp_profile = 0;
        (*egress_in_lif_profile_info).preserve_dscp_mode = egress_in_lif_profile;
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    int *in_lif_orientation)
{
    ...
    *in_lif_orientation = egress_in_lif_profile_info->in_lif_orientation;
    ...
    else if (dnx_data_qos.qos.routing_dscp_preserve_mode_get(unit) == 1)
    {
        (*egress_in_lif_profile_info).ive_inner_qos_dp_profile = 0;
        (*egress_in_lif_profile_info).ive_outer_qos_dp_profile = 0;
        (*egress_in_lif_profile_info).preserve_dscp_mode = egress_in_lif_profile & 1;
        (*egress_in_lif_profile_info).lif_same_interface_mode = 0;
    ...
    int *eth_rif_orientation)
{
    ...
    if ((preserve_dscp_mode == 1) && (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE))
    {
        ...
        *eth_rif_orientation = 0;
        ...
        (*egress_in_lif_profile_info).ive_inner_qos_dp_profile = 0;
        (*egress_in_lif_profile_info).ive_outer_qos_dp_profile = 0;
        (*egress_in_lif_profile_info).preserve_dscp_mode = egress_eth_rif_profile;
    }
    else
    {
    ...
    int intf_type)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VSI_PROFILE_L2_V4_MC_FWD_TYPE, INST_SINGLE,
                                 fwd_type_sel);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VSI_PROFILE_L2_V6_MC_FWD_TYPE, INST_SINGLE,
                                 fwd_type_sel);
    ...
    uint32 *l3_ingress_flags)
{
    ...
    *l3_ingress_flags = 0;
    ...
    if (in_lif_profile_template_data.lif_type == RIF)
    {
        ...
        if (in_lif_profile_template_data.l2_v4_mc_fwd_type == DBAL_ENUM_FVAL_VSI_PROFILE_L2_V4_MC_FWD_TYPE_IPV4MC)
        {
    ...
    in_lif_profile_info_t * in_lif_profile_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_in_lif_profile_routing_enablers_vector_assign
                    (unit, routing_enablers_vector, in_lif_profile_info, BCM_L3_INGRESS_ROUTE_DISABLE_IP4_UCAST,
                     (DBAL_ENUM_FVAL_LAYER_TYPES_IPV4 * NOF_ROUTING_ENABLE_TYPE + ROUTING_ENABLE_UC)));

    SHR_IF_ERR_EXIT(dnx_in_lif_profile_routing_enablers_vector_assign
                    (unit, routing_enablers_vector, in_lif_profile_info, BCM_L3_INGRESS_ROUTE_DISABLE_IP4_MCAST,
                     (DBAL_ENUM_FVAL_LAYER_TYPES_IPV4 * NOF_ROUTING_ENABLE_TYPE + ROUTING_ENABLE_MC)));

    SHR_IF_ERR_EXIT(dnx_in_lif_profile_routing_enablers_vector_assign
                    (unit, routing_enablers_vector, in_lif_profile_info, BCM_L3_INGRESS_ROUTE_DISABLE_IP6_UCAST,
                     (DBAL_ENUM_FVAL_LAYER_TYPES_IPV6 * NOF_ROUTING_ENABLE_TYPE + ROUTING_ENABLE_UC)));

    SHR_IF_ERR_EXIT(dnx_in_lif_profile_routing_enablers_vector_assign
                    (unit, routing_enablers_vector, in_lif_profile_info, BCM_L3_INGRESS_ROUTE_DISABLE_IP6_MCAST,
                     (DBAL_ENUM_FVAL_LAYER_TYPES_IPV6 * NOF_ROUTING_ENABLE_TYPE + ROUTING_ENABLE_MC)));

    SHR_IF_ERR_EXIT(dnx_in_lif_profile_routing_enablers_vector_assign
                    (unit, routing_enablers_vector, in_lif_profile_info, BCM_L3_INGRESS_ROUTE_DISABLE_MPLS,
                     (DBAL_ENUM_FVAL_LAYER_TYPES_MPLS * NOF_ROUTING_ENABLE_TYPE + ROUTING_ENABLE_UC)));
    ...
    in_lif_intf_type_e intf_type)
{
    ...
    if (*is_first)
    {
        /** Write port profile and disabled protocols values to LOAD_BALANCING_USE_LAYER_RECORD table */
        dnx_port_lif_layer_protocol_dbal_key_value_set(unit, entry_handle_id, DBAL_FIELD_LAYER_PROTOCOL,
                                                       in_lif_profile_info->ingress_fields.lb_per_lif_flags);
    ...
    in_lif_intf_type_e intf_type)
{
    ...
    dnx_in_lif_profile_routing_enablers_restore_flag(unit, enablers_vector_template_data, &flags,
                                                     ...
                                                     (DBAL_ENUM_FVAL_LAYER_TYPES_IPV4 * NOF_ROUTING_ENABLE_TYPE +
                                                      ROUTING_ENABLE_UC));
    dnx_in_lif_profile_routing_enablers_restore_flag(unit, enablers_vector_template_data, &flags,
    ...
    dnx_in_lif_profile_routing_enablers_restore_flag(unit, enablers_vector_template_data, &flags,
                                                     ...
                                                     (DBAL_ENUM_FVAL_LAYER_TYPES_IPV6 * NOF_ROUTING_ENABLE_TYPE +
                                                      ROUTING_ENABLE_UC));
    dnx_in_lif_profile_routing_enablers_restore_flag(unit, enablers_vector_template_data, &flags,
    ...
    dnx_in_lif_profile_routing_enablers_restore_flag(unit, enablers_vector_template_data, &flags,
                                                     ...
                                                     (DBAL_ENUM_FVAL_LAYER_TYPES_MPLS * NOF_ROUTING_ENABLE_TYPE +
                                                      ROUTING_ENABLE_UC));
    ...
    dnx_in_lif_lb_profile_enablers_vector_restore_flag(unit, lif_lb_profile_enablers_vector, &lif_lb_profile_flags,
                                                       BCM_HASH_LAYER_UDP_DISABLE, DBAL_ENUM_FVAL_LAYER_TYPES_UDP);
    dnx_in_lif_lb_profile_enablers_vector_restore_flag(unit, lif_lb_profile_enablers_vector, &lif_lb_profile_flags,
                                                       BCM_HASH_LAYER_TCP_DISABLE, DBAL_ENUM_FVAL_LAYER_TYPES_TCP);
    dnx_in_lif_lb_profile_enablers_vector_restore_flag(unit, lif_lb_profile_enablers_vector, &lif_lb_profile_flags,
                                                       BCM_HASH_LAYER_MPLS_DISABLE,
                                                       DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UNTERM);
    dnx_in_lif_lb_profile_enablers_vector_restore_flag(unit, lif_lb_profile_enablers_vector, &lif_lb_profile_flags,
                                                       BCM_HASH_LAYER_IPV6_DISABLE, DBAL_ENUM_FVAL_LAYER_TYPES_IPV6);
    dnx_in_lif_lb_profile_enablers_vector_restore_flag(unit, lif_lb_profile_enablers_vector, &lif_lb_profile_flags,
                                                       BCM_HASH_LAYER_IPV4_DISABLE, DBAL_ENUM_FVAL_LAYER_TYPES_IPV4);
    dnx_in_lif_lb_profile_enablers_vector_restore_flag(unit, lif_lb_profile_enablers_vector, &lif_lb_profile_flags,
