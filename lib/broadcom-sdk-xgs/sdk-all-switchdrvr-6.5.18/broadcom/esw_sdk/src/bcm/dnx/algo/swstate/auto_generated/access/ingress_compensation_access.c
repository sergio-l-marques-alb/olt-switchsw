 ...
 */
int
dnx_ingress_compensation_db_compensation_set(int unit, dnx_algo_template_t compensation)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_get(int unit, dnx_algo_template_t *compensation)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_create(int unit, dnx_algo_template_create_data_t * data, void *extra_arguments)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_exchange(int unit, uint32 flags, const int *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_replace_data(int unit, int profile, const int *new_profile_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_profile_data_get(int unit, int profile, int *ref_count, int *profile_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_profile_get(int unit, const int *profile_data, int *profile)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_get_next(int unit, int *current_profile)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_dump_info_get(int unit, dnx_algo_template_dump_data_t * info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
