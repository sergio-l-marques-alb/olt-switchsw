...
#define DNX_PTP_MPLS_TERM        (DBAL_ENUM_FVAL_LAYER_TYPES_MPLS & DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UA)
    ...
    uint32 *ret_mask)
{
    ...
    switch (type)
    {
        ...
        case DNX_PTP_MPLS_TERM:
            mask = DBAL_ENUM_FVAL_LAYER_TYPES_MPLS ^ DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UA;
    ...
    int value)
{
    ...
    for (port_idx = 0; port_idx < gport_info.internal_port_pp_info.nof_pp_ports; port_idx++)
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_PORT,
    ...
    int *value)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_PORT, gport_info.internal_port_pp_info.pp_port[0]);
    /** get the delay value */
