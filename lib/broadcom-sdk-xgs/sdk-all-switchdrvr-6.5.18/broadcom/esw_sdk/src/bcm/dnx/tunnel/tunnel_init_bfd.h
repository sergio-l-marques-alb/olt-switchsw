...
/**
 * \brief
 * Indicate weather tunnel type is for BFD SIP
 *
 ...
 *   \param [out] is_bfd_sip_wa - returned value to
 *          indicate if the tunnel is for BFD
 */
void dnx_tunnel_initiator_is_bfd_sip_wa(
    int unit,
 ...
 */
shr_error_e dnx_tunnel_initiator_bfd_sip_wa_table_get(
    int unit,
 ...
 *
 * \remark
 *   * Clears BFD SIP WA entry.
 */
shr_error_e dnx_tunnel_initiator_bfd_sip_wa_clear(
    int unit,
    int global_outlif,
    int local_outlif);
/**
 ...
 *
 *   \param [in] unit - Relevant unit.
 *   \param [in] tunnel - A pointer to the struct that holds information BFD SIP workaround entry,
