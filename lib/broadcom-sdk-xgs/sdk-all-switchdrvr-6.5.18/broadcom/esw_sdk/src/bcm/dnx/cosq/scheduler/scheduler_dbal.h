...
/**
 *
 * \brief -Function to set the credit delete mechanism configurations to a special values to overcome a HW bug.
 * Please make sure this fix is needed for future devices.
 *
 * \param [in] unit - relevant unit
 *
 * \ note - ERRATA - HW bug Jira - HWJERICHO2-2480 CL/Dual-HR wfq inaccuracy
 *
 * \return shr_error_e
 */
