    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CCM_INTERVAL, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_ccm_interval = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ITMH_TC_DP_PROFILE, INST_SINGLE, &value);
    entry_values->itmh_tc_dp_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MDL, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_mdl = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MAID, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_maid = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ICC_MAP_INDEX, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_icc_index = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_ID, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_mep_id = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_RDI_FROM_SCANNER, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_RDI_FROM_SCANNER);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_RDI_FROM_PACKET, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_RDI_FROM_PACKET);
    if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_IS_UPMEP))
    {
        /** For up-MEP, there is a reason for a "port core" field */
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_PP_PORT, INST_SINGLE, &value);
        entry_values->unified_port_access.ccm_eth_up_mep_port.pp_port = value;
        if (dnx_data_oam.oamp.core_nof_bits_get(unit) > 0)
        {
            dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_PORT_CORE, INST_SINGLE, &value);
            entry_values->unified_port_access.ccm_eth_up_mep_port.port_core = value;
        }
    }
    else
    {
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LOCAL_PORT_2_SYSTEM_PORT_PROFILE,
                                            INST_SINGLE, &value);
        ...
        if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_EGRESS_INJECTION))
        {
            ...
            if (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
            {
                dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_VSI_JR1, INST_SINGLE, &value);
                entry_values->exclusive.oam_only.vsi = value;
                dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_GLOB_OUT_LIF_JR1, INST_SINGLE,
                                                    &value);
            ...
            {
                dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_VSI, INST_SINGLE, &value);
                entry_values->exclusive.oam_only.vsi = value;
                dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_GLOB_OUT_LIF, INST_SINGLE,
                                                    &value);
                entry_values->fec_id_or_glob_out_lif = value;
    ...
    if (!UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_UP_MEP_SERVER) &&
        !(UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_EGRESS_INJECTION) &&
          (system_headers_mode != DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)))
    {
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_COUNTER_BASE, INST_SINGLE, &value);
        entry_values->counter_ptr = value;
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_COUNTER_INTERFACE, INST_SINGLE, &value);
        entry_values->counter_interface = value;
    }
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_INNER_TPID_INDEX, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_inner_tpid_index = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_INNER_VID, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_inner_vid = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_INNER_DEI_PCP, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_inner_dei_pcp = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_OUTER_TPID_INDEX, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_outer_tpid_index = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_OUTER_VID, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_outer_vid = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_OUTER_DEI_PCP, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_outer_dei_pcp = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_NOF_VLAN_TAGS, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_nof_vlan_tags = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_UP_PTCH_OPAQUE_PT_ATTR_PROFILE, INST_SINGLE,
                                        &value);
    entry_values->exclusive.oam_only.oam_prt_qualifier_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_PORT_STATUS_TLV_EN, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_PORT_TLV_EN);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_PORT_STATUS_TLV_VAL, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_PORT_TLV_VAL);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_INTERFACE_STATUS_TLV_CODE, INST_SINGLE,
                                        &value);
    entry_values->exclusive.oam_only.oam_interface_status_tlv_code = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PROFILE, INST_SINGLE, &value);
    entry_values->mep_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LMM_DA_LSB_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_lmm_da_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE, &value);
    entry_values->mep_pe_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SA_MAC_LSB, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_sa_mac_lsb = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SA_GEN_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_sa_mac_msb_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_EXTRA_DATA_PTR, INST_SINGLE, &value);
    entry_values->extra_data_ptr = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_FLEX_LM_DM_PTR, INST_SINGLE, &value);
    entry_values->flex_lm_dm_ptr = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_DA_UC_MC_TYPE, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_MC_UC_SEL);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CRPS_CORE_SELECT, INST_SINGLE, &value);
    entry_values->crps_core_select = value;
    if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_UP_MEP_SERVER))
    {
        /** Field mapped to "reserved" relevant only to UP-MEP in server mode */
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SERVER_DESTINATION, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ITMH_TC_DP_PROFILE, INST_SINGLE, &value);
    entry_values->itmh_tc_dp_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SYSTEM_PORT, INST_SINGLE, &value);
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_RDI_FROM_PACKET, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_RDI_FROM_PACKET);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_FEC_ID_OR_GLOB_OUT_LIF, INST_SINGLE,
                                        &entry_values->fec_id_or_glob_out_lif);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL, INST_SINGLE,
                                        &entry_values->mpls_pwe.label);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MPLS_PUSH_PROFILE, INST_SINGLE, &value);
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE, &value);
    entry_values->mep_pe_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LOCAL_PORT_TO_OAMP_PE, INST_SINGLE, &value);
    entry_values->unified_port_access.port_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_EXTRA_DATA_PTR, INST_SINGLE, &value);
    entry_values->extra_data_ptr = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_FLEX_LM_DM_PTR, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_ID, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_mep_id = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SIGNAL_DEGRADATION, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_TX_RATE_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_tx_rate = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ITMH_TC_DP_PROFILE, INST_SINGLE, &value);
    entry_values->itmh_tc_dp_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LOCAL_PORT_2_SYSTEM_PORT_PROFILE, INST_SINGLE,
                                        &value);
    entry_values->unified_port_access.port_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_YOUR_DISC, INST_SINGLE,
                                        &entry_values->exclusive.bfd_only.bfd_your_disc);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_SRC_IP_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_src_ip_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_DETECT_MULT, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_detect_mult = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MIN_TX_INTERVAL_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_min_tx_interval_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MIN_RX_INTERVAL_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_min_rx_interval_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_FEC_ID_OR_GLOB_OUT_LIF, INST_SINGLE,
                                        &entry_values->fec_id_or_glob_out_lif);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_DIAG_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_diag_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_TUNNEL_MPLS_ENABLE, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_BFD_TUNNEL_MPLS_ENABLE);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_FLAGS_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_flags_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_STATE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_sta = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE, &value);
    entry_values->mep_pe_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PROFILE, INST_SINGLE, &value);
    entry_values->mep_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_IPV4_DIP, INST_SINGLE,
                                        &entry_values->exclusive.bfd_only.bfd_ipv4_dip);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_IP_SUBNET_LEN, INST_SINGLE, &value);
    entry_values->ip_subnet_len = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_EXTRA_DATA_PTR, INST_SINGLE, &value);
    entry_values->extra_data_ptr = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_FLEX_LM_DM_PTR, INST_SINGLE, &value);
    entry_values->flex_lm_dm_ptr = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MICRO_BFD, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_MICRO_BFD);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CRPS_CORE_SELECT, INST_SINGLE, &value);
    entry_values->crps_core_select = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SET_DISCR_MSB, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_SRC_IP_PROFILE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_src_ip_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_IP_TTL_TOS_PROFILE, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_STATE, INST_SINGLE, &value);
    entry_values->exclusive.bfd_only.bfd_sta = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ACH, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_ACH);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_GAL, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_GAL);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ROUTER_ALERT, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_ROUTER_ALERT);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE, &value);
    entry_values->mep_pe_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PROFILE, INST_SINGLE, &value);
    entry_values->mep_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ACH_SEL, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_MY_TX, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.lm_my_tx);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_MY_RX, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.lm_my_rx);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_PEER_TX, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.lm_peer_tx);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_PEER_RX, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.lm_peer_rx);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LAST_ENTRY, INST_SINGLE, &flag);
    UTILEX_SET_BIT(entry_values->flags, flag, OAMP_MEP_LAST_ENTRY);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_CNTRS_VALID, INST_SINGLE, &flag);
    UTILEX_SET_BIT(entry_values->flags, flag, OAMP_MEP_LM_CNTRS_VALID);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEASURE_NEXT_RECEIVED_SLR, INST_SINGLE,
                                        &flag);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LAST_LM_FAR, INST_SINGLE, &value);
    entry_values->exclusive.lm_dm.last_lm_far = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LAST_LM_NEAR, INST_SINGLE, &value);
    entry_values->exclusive.lm_dm.last_lm_near = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ACC_LM_FAR, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.acc_lm_far);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ACC_LM_NEAR, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.acc_lm_near);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MAX_LM_FAR, INST_SINGLE, &value);
    entry_values->exclusive.lm_dm.max_lm_far = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MAX_LM_NEAR, INST_SINGLE, &value);
    entry_values->exclusive.lm_dm.max_lm_near = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LAST_ENTRY, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_LAST_DELAY_ONE_WAY, INST_SINGLE,
                                           value_array8);
    sal_memcpy(entry_values->exclusive.lm_dm.last_delay_one_way, value_array8, ONE_WAY_DELAY_SIZE);
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_MAX_DELAY_ONE_WAY, INST_SINGLE,
                                           value_array8);
    sal_memcpy(entry_values->exclusive.lm_dm.max_delay_one_way, value_array8, ONE_WAY_DELAY_SIZE);
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_MIN_DELAY_ONE_WAY, INST_SINGLE,
                                           value_array8);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_LAST_DELAY, INST_SINGLE, value_array8);
    sal_memcpy(entry_values->exclusive.lm_dm.last_delay, value_array8, TWO_WAY_DELAY_SIZE);
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_MAX_DELAY, INST_SINGLE, value_array8);
    sal_memcpy(entry_values->exclusive.lm_dm.max_delay, value_array8, TWO_WAY_DELAY_SIZE);
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_MIN_DELAY, INST_SINGLE, value_array8);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get field values   */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_EXT_DATA_LENGTH, INST_SINGLE, &value);
    entry_values->exclusive.extra_data.extra_data_len = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_OPCODES_TO_PREPEND, INST_SINGLE, &value);
    entry_values->exclusive.extra_data.opcode_bmp = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CHECK_CRC_VALUE_1, INST_SINGLE, &value);
    entry_values->exclusive.extra_data.crc_val1 = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CHECK_CRC_VALUE_2, INST_SINGLE, &value);
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get MEP type */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_OFFLOADED_MEP_TYPE_SUFFIX, INST_SINGLE,
                                        &value);
    switch (value)
    {
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_ENABLE, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_LM_ENABLE);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_DM_ENABLE, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_DM_ENABLE);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_STAT_ENABLE, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_LM_STAT_ENABLE);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_DM_STAT_ENABLE, INST_SINGLE, &value);
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_PEER_RX, INST_SINGLE,
                                        &entry_values->exclusive.lm_dm.lm_peer_rx);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LM_CNTRS_VALID, INST_SINGLE, &value);
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE, &value);
    entry_values->mep_pe_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_PART_2_PTR, INST_SINGLE, &value);
    entry_values->flex_lm_dm_ptr = value;
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get MEP type */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SHORT_OAM_ENTRY_MEP_TYPE_SUFFIX, INST_SINGLE,
                                        &value);
    switch (value)
    {
    ...
    uint32 entry_handle_id)
{
    ...
    /** Get MEP type */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_SHORT_BFD_ENTRY_MEP_TYPE_SUFFIX, INST_SINGLE,
                                        &value);
    switch (value)
    {
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LOCAL_PORT_2_SYSTEM_PORT_PROFILE, INST_SINGLE,
                                        &value);
    entry_values->unified_port_access.port_profile = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_YOUR_DISC_LSB, INST_SINGLE,
                                        &entry_values->exclusive.bfd_only.bfd_your_disc);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE, &value);
    entry_values->mep_pe_profile = value;
    ...
    dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    /** Read format   */
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_RESULT_TYPE, INST_SINGLE, &resulting_format);
    ...
    switch (resulting_format)
    {
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_ETH_OAM_UP_MEP_SERVER:
            ...
            dnx_oam_oamp_mep_db_eth_oam_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_Y1731_MPLSTP:
            dnx_oam_oamp_mep_db_mplstp_oam_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_Y1731_PWE:
            dnx_oam_oamp_mep_db_pwe_oam_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_IPV4_ONE_HOP:
            dnx_oam_oamp_mep_db_bfd_one_hop_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_IPV4_MULTI_HOP:
            dnx_oam_oamp_mep_db_bfd_multi_hop_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_MPLS:
            dnx_oam_oamp_mep_db_bfd_mpls_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_PWE:
            dnx_oam_oamp_mep_db_bfd_pwe_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_DB:
            dnx_oam_oamp_mep_db_lm_db_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_STAT:
            dnx_oam_oamp_mep_db_lm_stat_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_DM_STAT_TWO_WAY:
            dnx_oam_oamp_mep_db_dm_stat_two_way_get(unit, entry_id, entry_values, entry_handle_id);
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_EXTRA_DATA_HEADER:
            dnx_oam_oamp_mep_db_extra_data_header_get(unit, entry_id, entry_values, entry_handle_id);
            break;
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_DM_STAT_ONE_WAY:
            dnx_oam_oamp_mep_db_dm_stat_one_way_get(unit, entry_id, entry_values, entry_handle_id);
            break;
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_DM_OFFLOADED_PART_1:
            ...
            dnx_oam_oamp_mep_db_lm_dm_offloaded_part_1_get(unit, entry_id, entry_values, entry_handle_id);
            break;
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_MEP_ID, INST_SINGLE, &value);
    entry_values->exclusive.oam_only.oam_mep_id = value;
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_UP_1_DOWN_0, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_IS_UPMEP);
    if (value == TRUE)
    {
        /** Endpoint is CCM ethernet up-MEP */
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_LOCAL_PORT_TO_OAMP_PE, INST_SINGLE,
                                            &value);
    ...
    uint32 entry_handle_id)
{
    ...
    if (dnx_data_oam.oamp.modified_mep_db_structure_get(unit) == 1)
    {
        ...
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CCM_INTERVAL_LSB, INST_SINGLE, &value);
        entry_values->exclusive.oam_only.oam_ccm_interval =
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_IPV4_DIP, INST_SINGLE,
                                        &entry_values->exclusive.bfd_only.bfd_ipv4_dip);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_YOUR_DISC_MSB, INST_SINGLE,
                                        &entry_values->exclusive.bfd_only.bfd_your_disc);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_BFD_TUNNEL_MPLS_ENABLE, INST_SINGLE, &value);
    UTILEX_SET_BIT(entry_values->flags, value, OAMP_MEP_BFD_TUNNEL_MPLS_ENABLE);
    dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_CRPS_CORE_SELECT, INST_SINGLE, &value);
    ...
    {
        /** Only the LSB of the value is read here */
        dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_TX_RATE_LSB, INST_SINGLE, &value);
        entry_values->exclusive.bfd_only.bfd_tx_rate =
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_value_field_arr8_get(unit, entry_handle_id, DBAL_FIELD_VALUE, INST_SINGLE, value_array8);
