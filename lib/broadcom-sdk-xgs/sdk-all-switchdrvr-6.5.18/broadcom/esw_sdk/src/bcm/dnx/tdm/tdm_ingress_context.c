...
#define DNX_TDM_INGRESS_CONTEXT_CREATE_SUPPORTED_FLAGS \
             (BCM_TDM_INGRESS_CONTEXT_USE_ALL_FABRIC_LINKS | BCM_TDM_INGRESS_CONTEXT_WITH_ID | BCM_TDM_INGRESS_CONTEXT_REPLACE)
    ...
    bcm_tdm_ingress_context_t * ingress_context)
{
    ...
    if (dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_is_supported))
    {
        ...
        if (flags & BCM_TDM_INGRESS_CONTEXT_USE_ALL_FABRIC_LINKS)
        {
            /*
             * If BCM_TDM_INGRESS_CONTEXT_USE_ALL_FABRIC_LINKS bit is set then override input contents
