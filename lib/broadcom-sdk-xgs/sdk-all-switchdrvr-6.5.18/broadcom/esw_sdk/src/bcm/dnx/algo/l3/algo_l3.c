 ...
 */
#define ALGO_L3_VRRP_NOF_EXEM_TYPES        (6)
    ...
    int unit)
{
    ...
    for (int idx = 0; idx < dnx_data_l3.ecmp.max_nof_fec_ecmp_tables_get(unit); idx++)
    {
        SHR_IF_ERR_EXIT(ecmp_db_info.ecmp_fec_members_table.alloc(unit, idx, L3_ECMP_CONSISTENT_TABLE_MAX_NOF_ENTRIES));
    }
