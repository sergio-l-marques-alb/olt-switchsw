    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        ...
        */
        ...
        /**
         * mep_id save to reg1 , using FEM and shift to get mep_id/16
         * mep_id do shift to get gen mem (mep_id /4/16 ) and store in TMP_REG4 the memory offset where tlv length is resides, reg4 use for gen mem access
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        /** tmp_reg2=0x1 used to extract the is_echo flag from tmp_reg3 */
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_AND(TMP_REG2, TMP_REG3, INST_VAR, ALWAYS, ZERO, TMP_REG2), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_BFD_IPV6_JR1_NO_ECHO], NEVER_NEVER, NXT_JMP));
            ...
            INSTR(CE1_NOP, CE2_NOP, ALU_AND(NS_8, INST_VAR, ALU_OUT, ALWAYS, ALWAYS, TMP_REG4), CMN(NONE, NONE, 0x1, NEVER_NEVER, LOP_NXT));
        ...
        INSTR_LABEL(CE1_NOP, CE2_NOP, ALU_AND(TMP_REG4, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG3), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_BFD_IPV6_JR1_END], NEVER_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_BFD_IPV6_JR1_ECHO);
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_AND(TMP_REG2, TMP_REG2, INST_VAR, ALWAYS, ZERO, TMP_REG3), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_BFD_IPV6_END], NEVER_NEVER, NXT_JMP));
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        /** drop 40B */
        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN(READ, NONE, 10, NEVER_NEVER, LOP_CST));
        /** copy system headers till the MPLS header(PTCH(2B)+ITMH(5B)+EXT(3B)+PPH(12B)+UDH(1B)+ first byte of MPLS)*/
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, NONE, INST_CONST, CONCATENATE), CE2_COPY(TMP_REG3, DEFAULT, NONE, 2B),
            ALU_NOP, CMN(NONE, NONE, 1, ALWAYS_NEVER, NXT_JMP));
...
dnx_oamp_mep_pe_profile_s mep_pe_profiles_local[DBAL_NOF_ENUM_MEP_PE_PROFILE_SW_VALUES] = {
    ...
    {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_DISCR_MSB_1,                    0,              0,              0,              0,              0,          1,   5},
    {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_IPV6,                           50,             0,              0,              0,              0,          1,   6},
    {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_IPV6_MPLS,                      27,             0,              0,              0,              0,          1,   8},
    ...
    oamp_pe_tcam_config_s tcam_config[DBAL_NOF_ENUM_OAMP_PE_PROG_TCAM_ENUM_VALUES])
{
    ...
    */
    oamp_pe_tcam_config_s tcam_config_local[DBAL_NOF_ENUM_OAMP_PE_PROG_TCAM_ENUM_VALUES] = {
        ...
        {DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_BFD_DISCR_MSB_1,                             oamp_pe_bfd_discr_msb_1_program,                      1,     DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_BFD_DISCR_MSB_1,                       0,                                       OAMP_PE_TCAM_KEY_MEP_GENERATED, 0x0,           {{{DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_MHOP}, {0xF}, {0}, {0x7F}, {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_DISCR_MSB_1},                     {0x0},  {DBAL_ENUM_FVAL_MSG_TYPE_OTHER},            {0x0}}},DNX_OAMP_PE_NOT_SET},
