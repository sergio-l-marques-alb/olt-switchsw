    ...
    bcm_mpls_tunnel_switch_t * info)
{
             ...
             || (result_type == DBAL_RESULT_TYPE_MPLS_FWD_FWD_DEST_EEI_STAT))
    {
        ...
        {
            dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EEI_MPLS_SWAP_COMMAND, INST_SINGLE,
        ...
        {
            SHR_IF_ERR_EXIT(dnx_mpls_tunnel_create_push_entry_from_eei(unit, &(info->egress_label), FALSE, FALSE,
                                                                       _SHR_IS_FLAG_SET(info->flags,
