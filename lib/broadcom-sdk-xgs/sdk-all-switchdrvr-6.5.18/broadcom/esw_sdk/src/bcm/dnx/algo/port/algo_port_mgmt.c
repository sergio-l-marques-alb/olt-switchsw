...
#define DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES 2
...
dnx_algo_port_db_first_header_size_init_templates(
    int unit)
{
    dnx_algo_template_create_data_t eth_ports_profile_data, ptch1_ports_profile_data, ptch2_ports_profile_data;
    dnx_algo_template_create_data_t ptch1_after_injected_profile_data;
    dnx_algo_port_first_header_size_t port_first_header_size_data;
    ...
    sal_memset(&port_first_header_size_data, 0, sizeof(dnx_algo_port_first_header_size_t));
    port_first_header_size_data.first_header_size_to_skip = 0;
    /** Create template for ETH ports */
    sal_memset(&eth_ports_profile_data, 0, sizeof(dnx_algo_template_create_data_t));
    eth_ports_profile_data.flags = DNX_ALGO_TEMPLATE_CREATE_USE_DEFAULT_PROFILE;
    eth_ports_profile_data.first_profile =
        UTILEX_MIN(DBAL_ENUM_FVAL_PORT_TERMINATION_PTC_PROFILE_ETH_UD1,
                   DBAL_ENUM_FVAL_PORT_TERMINATION_PTC_PROFILE_ETH_UD2);
    /** Using additional profile as dummy profile*/
    eth_ports_profile_data.nof_profiles = DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES + 1;
    eth_ports_profile_data.max_references = nof_references;
    eth_ports_profile_data.default_profile =
        eth_ports_profile_data.first_profile + DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES;
    eth_ports_profile_data.data_size = sizeof(dnx_algo_port_first_header_size_t);
    eth_ports_profile_data.default_data = &port_first_header_size_data;
    sal_strncpy(eth_ports_profile_data.name, DNX_ALGO_PORT_FIRST_HEADER_SIZE_ETH_PROFILE,
                DNX_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);

    SHR_IF_ERR_EXIT(dnx_algo_port_db.
                    eth_ports_first_header_size_profile_data.create(unit, &eth_ports_profile_data, NULL));

    /** Create template for PTCH1 ports */
    sal_memset(&ptch1_ports_profile_data, 0, sizeof(dnx_algo_template_create_data_t));
    ptch1_ports_profile_data.flags = DNX_ALGO_TEMPLATE_CREATE_USE_DEFAULT_PROFILE;
    ptch1_ports_profile_data.first_profile = DBAL_ENUM_FVAL_PORT_TERMINATION_PTC_PROFILE_PTCH1_UD1;
    /** Using additional profile as dummy profile included in DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES*/
    ptch1_ports_profile_data.nof_profiles = DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES;
    ptch1_ports_profile_data.max_references = nof_references;
    ptch1_ports_profile_data.default_profile = ptch1_ports_profile_data.first_profile + 1;
    ptch1_ports_profile_data.data_size = sizeof(dnx_algo_port_first_header_size_t);
    ptch1_ports_profile_data.default_data = &port_first_header_size_data;
    sal_strncpy(ptch1_ports_profile_data.name, DNX_ALGO_PORT_FIRST_HEADER_SIZE_PTCH1_PROFILE,
                DNX_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);

    SHR_IF_ERR_EXIT(dnx_algo_port_db.
                    ptch1_ports_first_header_size_profile_data.create(unit, &ptch1_ports_profile_data, NULL));

    /** Create template for PTCH1 ports for skipping first header size after injected header */
    sal_memset(&ptch1_after_injected_profile_data, 0, sizeof(dnx_algo_template_create_data_t));
    ptch1_after_injected_profile_data.flags = DNX_ALGO_TEMPLATE_CREATE_USE_DEFAULT_PROFILE;
    ptch1_after_injected_profile_data.first_profile =
        DBAL_ENUM_FVAL_PORT_TERMINATION_PTC_PROFILE_PTCH1_UD1_AFTER_INJECTED;
    /** Using additional profile as dummy profile*/
    ptch1_after_injected_profile_data.nof_profiles = DNX_PORT_MAX_FIRST_HEADER_SIZE_AFTER_INJECTED_PROFILES + 1;
    ptch1_after_injected_profile_data.max_references = nof_references;
    ptch1_after_injected_profile_data.default_profile =
        ptch1_after_injected_profile_data.first_profile + DNX_PORT_MAX_FIRST_HEADER_SIZE_AFTER_INJECTED_PROFILES;
    ptch1_after_injected_profile_data.data_size = sizeof(dnx_algo_port_first_header_size_t);
    ptch1_after_injected_profile_data.default_data = &port_first_header_size_data;
    sal_strncpy(ptch1_after_injected_profile_data.name, DNX_ALGO_PORT_FIRST_HEADER_SIZE_AFTER_PTCH1_PROFILE,
                DNX_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);

    SHR_IF_ERR_EXIT(dnx_algo_port_db.ptch1_ports_first_header_size_after_injected_profile_data.create(unit,
                                                                                                      &ptch1_after_injected_profile_data,
                                                                                                      NULL));

    /** Create template for PTCH2 ports */
    sal_memset(&ptch2_ports_profile_data, 0, sizeof(dnx_algo_template_create_data_t));
    ptch2_ports_profile_data.flags = DNX_ALGO_TEMPLATE_CREATE_USE_DEFAULT_PROFILE;
    ptch2_ports_profile_data.first_profile =
        UTILEX_MIN(DBAL_ENUM_FVAL_PORT_TERMINATION_PTC_PROFILE_PTCH2_UD1,
                   DBAL_ENUM_FVAL_PORT_TERMINATION_PTC_PROFILE_PTCH2_UD2);
    /** Using additional profile as dummy profile*/
    ptch2_ports_profile_data.nof_profiles = DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES + 1;
    ptch2_ports_profile_data.max_references = nof_references;
    ptch2_ports_profile_data.default_profile =
        ptch2_ports_profile_data.first_profile + DNX_PORT_MAX_FIRST_HEADER_SIZE_PROFILES;
    ptch2_ports_profile_data.data_size = sizeof(dnx_algo_port_first_header_size_t);
    ptch2_ports_profile_data.default_data = &port_first_header_size_data;
    sal_strncpy(ptch2_ports_profile_data.name, DNX_ALGO_PORT_FIRST_HEADER_SIZE_PTCH2_PROFILE,
                DNX_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);

    SHR_IF_ERR_EXIT(dnx_algo_port_db.
                    ptch2_ports_first_header_size_profile_data.create(unit, &ptch2_ports_profile_data, NULL));
    ...
    dnx_algo_port_if_add_t * info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_port_soc_info_add
                    (unit, logical_port, is_master_port, port_info, info->phys, DNX_ALGO_PORT_TDM_MODE_NONE));
    ...
    dnx_algo_port_special_interface_add_t * info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_port_is_master_get(unit, logical_port, &is_master_port));
    SHR_IF_ERR_EXIT(dnx_algo_port_soc_info_add
                    (unit, logical_port, is_master_port, port_info, dummy_pbmp, DNX_ALGO_PORT_TDM_MODE_NONE));
    ...
    bcm_port_t logical_port)
{
    ...
    if (state != DNX_ALGO_PORT_STATE_INVALID)
    {
        ...
        if (DNX_ALGO_PORT_TYPE_IS_FLEXE(unit, port_info, TRUE, FALSE))
        {
             ...
             */
            if ((oam_channel != client_channel) && (ptp_channel != client_channel))
            {
    ...
    int channel_id)
{
    ...
    else if (DNX_ALGO_PORT_TYPE_IS_TM(unit, port_info))
    {
        /** Get handle to TM DB */
        SHR_IF_ERR_EXIT(dnx_algo_port_db.logical.tm_handle.get(unit, logical_port, &tm_handle));
        DNX_ALGO_PORT_2D_HANDLE_VERIFY(tm_handle);
