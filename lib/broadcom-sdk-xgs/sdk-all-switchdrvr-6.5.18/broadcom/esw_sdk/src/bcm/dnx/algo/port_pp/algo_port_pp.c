    ...
    const void *data)
{
    ...
    for (index = 0; index < ESEM_ACCESS_IF_COUNT; index++)
    {
        if (esem_cmd_data->esem[index].valid == TRUE)
        {
            ...
            SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "esem access id", esem_access_id, NULL,
                                           "%d");
            SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "app db id", app_db_id, NULL, "%d");
            SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "designated offset", esem_offset, NULL,
                                           "%d");
            SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "default result profile",
