    ...
    bcm_oam_profile_t * profile_index)
{
    ...
    legal_flags |=
        ...
        BCM_OAM_PROFILE_LM_TYPE_NONE | BCM_OAM_PROFILE_TYPE_SECTION;
    ...
    if (DNX_OAM_PROFILE_IS_LIF_DB_ASSOCIATED(profile_type))
    {
        ...
        switch (mp_type)
        {
            ...
            case DBAL_ENUM_FVAL_MP_TYPE_ACTIVE_MATCH_HIGH:
                ...
                SHR_IF_ERR_EXIT(dnx_oam_sw_db_lm_mode_get
                                (unit, profile_index, is_ingress, is_acc, &lm_type, &is_section));
