    ...
    dbal_tables_e * table_id)
{
    ...
    {
        dbal_tables_e tables_id[] = { DBAL_TABLE_NIF_CDU_MIB_COUNTERS_RX, DBAL_TABLE_NIF_CDU_MIB_COUNTERS_TX };
    ...
    else if (ethu_info.imb_type == imbDispatchTypeImb_clu)
    {
        dbal_tables_e tables_id[] =
            { DBAL_TABLE_NIF_CLU_MIB_COUNTERS_COMMON_RX, DBAL_TABLE_NIF_CLU_MIB_COUNTERS_COMMON_TX,
    ...
    uint64 *val)
{
    ...
    /** since CLMAC access on cmodel doesn't work on some devices, return always 0 for cmodel */
