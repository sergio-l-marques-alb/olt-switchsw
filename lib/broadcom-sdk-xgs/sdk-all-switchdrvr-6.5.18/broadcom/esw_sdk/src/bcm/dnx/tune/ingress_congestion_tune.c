    ...
    int *dram_bound_th)
{
    ...
    *dram_bound_th = 0;
    ...
    {
        *dram_bound_th = 150 * 1024;
    }
    else if (rate <= 300)
    {
        *dram_bound_th = 280 * 1024;
    }
    else if (rate <= 400)
    {
        *dram_bound_th = 300 * 1024;
    }
    else
    /** rate > 400G */
    {
    ...
    int *dram_bound_recovery_th)
{
    ...
    *dram_bound_recovery_th = 0;
    ...
    if (rate <= 50)
    {
         ...
         * SLOW
         */
        *dram_bound_recovery_th = (13 * dram_bound_th) / 30;
    }
    else if (rate <= 200)
    {
        /*
    ...
    /** rate > 400G */
    {
         ...
         * EXTREAME
         */
        *dram_bound_recovery_th = (13 * dram_bound_th) / 15;
    }
    ...
    bcm_cosq_rate_class_create_info_t * create_info)
{
    ...
    /** DRAM Recovery fail thr = 1.5 * DRAM bound thr */
    dram_recovery_fail_th = 15 * dram_bound_bytes_th / 10;
    sal_memset(&dram_bound_threshold, 0, sizeof(dram_bound_threshold));
