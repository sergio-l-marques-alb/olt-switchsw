/** \file oamp_pe_infra.c
 * $Id$
 *
 * OAMP PE infrastructure procedures for DNX.
 *
 */
/*
    ...
    dbal_enum_value_field_inst_src_e next_inst)
{
    ...
    /** decode feadback fifo read/write actions */
    switch (fdbk_fifo)
    {
    ...
    /** decode wether to allow output buffer and whether EOP needs to be set */
    switch (buff_eop)
    {
...
*   \param [in] entry_handle_id  -  entry handler in OAMP_PE_PROGRAMS_TCAM.
* \return
*   shr_error_e
*/
static shr_error_e
    ...
    int prog_index)
{
    ...
    /** set key based on the packet type defined */
    ...
    /** save tcam {id, name} to SW state fo rdiagnostics */
