    ...
    int unit)
{
    ...
    vmv_from_wrong_location = dnx_data_l2.hw_bug.feature_get(unit, dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location);
    ...
    {
        /** HWJERICHO2-2302 VMV to entry format index HW WA */
        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_L2_LEARN_FORMAT_INDEX_FROM_VMV, &entry_handle_id));
    ...
    int unit)
{
    ...
    if (vmv_from_wrong_location)
    {
        /** HWJERICHO2-2302 FID WA for HW bug in the LEL  */
