    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(instru.eventor_info.rx_buffer0_offset.alloc(unit));
    SHR_IF_ERR_EXIT(instru.eventor_info.rx_buffer1_offset.alloc(unit));
    SHR_IF_ERR_EXIT(instru.eventor_info.rx_buffer_size.alloc(unit));
