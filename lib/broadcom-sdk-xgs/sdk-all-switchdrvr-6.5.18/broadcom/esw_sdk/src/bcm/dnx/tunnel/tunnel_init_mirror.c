    ...
    uint32 *local_outlif)
{
    ...
    SHR_IF_ERR_EXIT(dnx_port_esem_command_add
                    (unit, DBAL_ENUM_FVAL_ESEM_APP_DB_ID_SSP_NAMESPACE, ESEM_ACCESS_TYPE_PORT_SA,
    ...
    SHR_IF_ERR_EXIT(dnx_port_esem_cmd_exchange(unit, tunnel_gport,
                                               DNX_PORT_ESEM_CMD_ALLOCATE | DNX_PORT_ESEM_CMD_RANGE_0_63, 0,
                                               &esem_accesses,
