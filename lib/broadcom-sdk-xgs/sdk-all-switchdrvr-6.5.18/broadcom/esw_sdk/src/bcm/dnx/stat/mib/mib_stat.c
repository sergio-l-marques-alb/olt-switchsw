...
/**
 * \brief - padding size definition for snmpIfInOctets WA.
 */
    ...
    int unit)
{
    ...
    int counter_id;
    int allocated_not_stored = FALSE;
    ...
    /** indicate memory was allocated but not stored yet */
    allocated_not_stored = TRUE;
