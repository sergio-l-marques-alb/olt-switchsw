...
typedef enum
{
    DNX_SCHEDULER_ALLOCATORS_INTERFACE_TAG_REGULAR = 0,
    DNX_SCHEDULER_ALLOCATORS_INTERFACE_TAG_BIG,
    DNX_SCHEDULER_ALLOCATORS_INTERFACE_TAG_NON_CHANNELIZED,
    DNX_SCHEDULER_ALLOCATORS_INTERFACE_TAG_MAX = DNX_SCHEDULER_ALLOCATORS_INTERFACE_TAG_NON_CHANNELIZED
} dnx_scheduler_allocators_interface_tag_t;
