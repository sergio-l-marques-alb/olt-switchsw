 ...
 */
shr_error_e
dnx_field_map_crc_select_bcm_to_dnx(
    int unit,
    bcm_field_crc_select_t bcm_crc_select,
    dnx_field_crc_select_e * dnx_crc_select_p)
{

    SHR_FUNC_INIT_VARS(unit);

    SHR_NULL_CHECK(dnx_crc_select_p, _SHR_E_PARAM, "dnx_crc_select_p");
    switch (bcm_crc_select)
    {
        case bcmFieldCrcSelectCrc16P0x10039:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X10039;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x100d7:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X100d7;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x1015d:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X1015d;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x10939:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X10939;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x109e7:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X109e7;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x10ac5:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X10ac5;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x1203d:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X1203d;
            break;
        }
        case bcmFieldCrcSelectCrc16P0x12105:
        {
            *dnx_crc_select_p = DNX_FIELD_CRC_SELECT_CRC16_0X12105;
            break;
        }
        default:
        {
 ...
 */
shr_error_e
dnx_field_map_crc_select_dnx_to_bcm(
    int unit,
    dnx_field_crc_select_e dnx_crc_select,
    bcm_field_crc_select_t * bcm_crc_select_p)
{
    ...
    switch (dnx_crc_select)
    {
        case DNX_FIELD_CRC_SELECT_CRC16_0X10039:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x10039;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X100d7:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x100d7;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X1015d:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x1015d;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X10939:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x10939;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X109e7:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x109e7;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X10ac5:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x10ac5;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X1203d:
        {
            *bcm_crc_select_p = bcmFieldCrcSelectCrc16P0x1203d;
            break;
        }
        case DNX_FIELD_CRC_SELECT_CRC16_0X12105:
        {
        ...
        {
            SHR_ERR_EXIT(_SHR_E_NOT_FOUND, "Invalid CRC Select type: %d. Valid values from: %d to %d . \n",
                         dnx_crc_select, DNX_FIELD_CRC_SELECT_FIRST, (DNX_FIELD_CRC_SELECT_NOF - 1));
            break;
        }
    }
...
shr_error_e
dnx_field_map_range_config_type_bcm_to_dnx(
    int unit,
    bcm_field_range_config_t bcm_range_config_type,
    dnx_field_range_config_e * dnx_range_config_type_p)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_NULL_CHECK(dnx_range_config_type_p, _SHR_E_PARAM, "dnx_range_type_p");

    switch (bcm_range_config_type)
    {
        case bcmFieldRangeConfigUserDefined1:
        {
            (*dnx_range_config_type_p) = DNX_FIELD_RANGE_CONFIG_USERDEFINED1;
            break;
        }
        case bcmFieldRangeConfigUserDefined2:
        {
            (*dnx_range_config_type_p) = DNX_FIELD_RANGE_CONFIG_USERDEFINED2;
            break;
        }
        default:
        {
            SHR_ERR_EXIT(_SHR_E_NOT_FOUND, "Invalid Range Config Type:%d\n", bcm_range_config_type);
        }
    }
exit:
    SHR_FUNC_EXIT;
    ...
    dbal_enum_value_field_kbp_fwd_opcode_e * opcode_id_p)
{
    ...
    {
        if (dnx_field_static_apptype_map[app_type].opcode_id == DBAL_ENUM_FVAL_KBP_FWD_OPCODE_INVALID)
        {
            SHR_SET_CURRENT_ERR(_SHR_E_NOT_FOUND);
            SHR_EXIT();
        }
        /*
         * Verify that the opcode is used FWD contexts.
         */
        {
            ...
            dbal_enum_value_field_kbp_fwd_opcode_e opcode_id = dnx_field_static_apptype_map[app_type].opcode_id;
        ...
        else
        {
            ...
            else
            {
                ...
                SHR_IF_ERR_EXIT(kbp_mngr_opcode_to_contexts_get
                                (unit, opcode_id, &fwd_nof_contexts, fwd_acl_ctx_mapping));
                if (fwd_nof_contexts <= 0)
                {
                ...
                {
                    SHR_ERR_EXIT(_SHR_E_INTERNAL, "Predefined apptype \"%s\" (%d) is "
                                 "mapped and used but was not found.\n",
                                 dnx_field_bcm_apptype_text(app_type), app_type);
                }
            }
        }
    ...
    bcm_field_AppType_t * app_type_p)
{
    ...
    if (opcode_id > (sizeof(dnx_field_static_opcode_info) / sizeof(dnx_field_static_opcode_info[0])))
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_field_apptype_sw.info.opcode_id.get(unit, app_type_index, &opcode_id_uint8));
    ...
    uint32 *cs_profile_id_p)
{
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_apptype_sw.info.profile_id.get(unit, relative_dyn_apptype, &profile_id_uint8));
    ...
    bcm_field_AppType_t * app_type_p)
{
    ...
    if (found == FALSE)
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_field_apptype_sw.info.profile_id.get(unit, app_type_index, &cs_profile_id_get_uint8));
