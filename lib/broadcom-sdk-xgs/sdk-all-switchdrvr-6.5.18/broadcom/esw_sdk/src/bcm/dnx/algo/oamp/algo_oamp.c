 ...
 *
 * THIS IS NOT SHOWN IN DIAGRAM BELOW, BUT
 * In case of short entries bank NOT all addresses could be allocated.
 * dnx_oam_mep_db_highest_index_get function calculate the highest address in short bank which can be allocated.
 * From this address in bank the entries are skipped
 *
 * UMC threshold = 8K
    ...
    const void *data)
{
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "rdi_gen_method", profile->rdi_gen_method, NULL,
                                   "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "dmm_rate", profile->dmm_rate, NULL, "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "lmm_rate", profile->lmm_rate, NULL, "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "opcode_0_rate", profile->opcode_0_rate, NULL,
                                   "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "opcode_1_rate", profile->opcode_1_rate, NULL,
                                   "%d");
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "ccm_count", profile->ccm_count, NULL, "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "dmm_count", profile->dmm_count, NULL, "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "lmm_count", profile->lmm_count, NULL, "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "opcode_0_count", profile->opcode_0_count, NULL,
                                   "%d");
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "opcode_1_count", profile->opcode_1_count, NULL,
                                   "%d");
