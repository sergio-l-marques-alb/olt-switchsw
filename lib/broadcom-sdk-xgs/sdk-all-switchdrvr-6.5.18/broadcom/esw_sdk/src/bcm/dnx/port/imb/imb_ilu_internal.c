    ...
    uint8 *is_extended_memory_used)
{
    ...
    *is_extended_memory_used = ((ilkn_access_info.port_in_core == 0) && (nof_segments == 4)) ? TRUE : FALSE;
    ...
    int flush)
{
     ...
     * Set value fields
     */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FLUSH, INST_SINGLE, flush);
