    ...
    bcm_port_t port)
{
    ...
    if (port == BCM_PORT_INVALID)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_stif_mgmt_source_mapping_get(unit, 0, source, &local_port, &instance_id, &core_id));
...
*/
static shr_error_e
bcm_dnx_stat_stif_ingress_record_format_element_mask_size_get(
    int unit,
...
*/
static shr_error_e
bcm_dnx_stat_stif_ingress_record_format_elements_object_order_verify(
    int unit,
    int nof_elements,
    bcm_stat_stif_record_format_element_t * record_format_elements)
{
    ...
    for (element_id = 0; element_id < nof_elements - 1; element_id++)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_dnx_stat_stif_ingress_record_format_element_mask_size_get
    ...
    bcm_stat_stif_record_format_element_t * record_format_elements)
{
    ...
    if (flags == BCM_STAT_INGRESS)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_dnx_stat_stif_ingress_record_format_elements_object_order_verify
