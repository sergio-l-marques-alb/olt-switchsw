    ...
    bcm_mirror_destination_t * mirror_dest)
{
    ...
    int action_profile_id, i, profile;
    ...
    int action_profile_id)
{
    ...
    /** set profile to sw */
    SHR_IF_ERR_EXIT(dnx_mirror_db.mirror_on_drop_profile.set(unit, action_profile_id));
    ...
    bcm_gport_t mirror_dest_id)
{
    ...
    if (profile == action_profile_id)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_mirror_db.mirror_on_drop_profile.set(unit, DNX_MIRROR_ON_DROP_INVALID_PROFILE));
    }
