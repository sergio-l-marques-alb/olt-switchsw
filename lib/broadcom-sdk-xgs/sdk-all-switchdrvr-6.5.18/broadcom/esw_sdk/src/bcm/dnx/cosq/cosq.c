    ...
    switch (type)
    {
        ...
        case bcmCosqControlIngressPortDropPortProfileMap:
            SHR_ERR_EXIT(_SHR_E_UNAVAIL, "Control type %d is not supported for core gport, only for local port.", type)
                break;
        case bcmCosqControlIngressMaxLowPriority:
    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmCosqLowRateVoqConnectorFactor:
            ...
            break;
        case bcmCosqControlIngressMaxLowPriority:
            SHR_IF_ERR_EXIT(dnx_iqs_max_low_priority_set(unit, arg));
            break;
    ...
    int *arg)
{
    ...
    switch (type)
    {
        ...
        case bcmCosqControlIngressMaxLowPriority:
            SHR_IF_ERR_EXIT(dnx_iqs_max_low_priority_get(unit, (uint32 *) arg));
            break;
        default:
        {
            break;
    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmCosqControlShaperPacketMode:
        {
             ...
             * verify cosq
             */
            SHR_IF_ERR_EXIT(dnx_egr_queuing_packet_mode_set(unit, logical_port, arg));
            break;
        }
        default:
        {
    ...
    int *arg_p)
{
    ...
    switch (type)
    {
        ...
        case bcmCosqControlShaperPacketMode:
        {
            SHR_IF_ERR_EXIT(dnx_egr_queuing_packet_mode_get(unit, logical_port, arg_p));
            break;
        }
        default:
        {
    ...
    int is_set)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_cosq_control_validate_latency_based_admission(unit, type));
        /** Verify cosq param */
 ...
 *  - type - bcmCosqControlIngressMaxLowPriority
 *  - arg - the maximal LOW priority
 *
    ...
    int force_core_all)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_db.base_queues.num_cos.get(unit, queue_quad, &sw_state_num_cos));
    if (sw_state_num_cos <= 0)
    {
    ...
    SHR_IF_ERR_EXIT(dnx_cosq_ipq_queue_is_allocated(unit, base_queue, &is_allocated));
    if (!is_allocated)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Queue %d is not allocated", base_queue);
    }
