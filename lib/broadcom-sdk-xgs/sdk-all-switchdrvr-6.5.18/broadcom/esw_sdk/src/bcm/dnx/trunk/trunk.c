...
/** create_cb                           | destroy_cb                            | add_cb                        | delete_cb              */
    {NULL,                                NULL,                          dnx_trunk_egress_pp_port_update,         NULL}
};
/* } */
/* *INDENT-ON* */
...
shr_error_e
bcm_dnx_trunk_flow_agg_group_set(
    int unit,
    uint32 flags,
...
shr_error_e
bcm_dnx_trunk_flow_agg_group_get(
    int unit,
    uint32 flags,
    bcm_flow_agg_info_t * flow_agg_info)
{
    ...
    int *egress_trunk_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_trunk_egress_create(unit, trunk_id, egress_trunk_id, &is_first));
...
shr_error_e static
bcm_dnx_trunk_spa_to_system_phys_port_map_get_verify(
    int unit,
    uint32 flags,
    ...
    bcm_gport_t * gport)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_trunk_spa_to_system_phys_port_map_get_verify
                          (unit, flags, system_port_aggregate, gport));
