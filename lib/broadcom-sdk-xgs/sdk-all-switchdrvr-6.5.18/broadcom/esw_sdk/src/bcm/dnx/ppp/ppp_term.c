 ...
 */
int
bcm_dnx_ppp_term_spoofing_check_add_verify(
    int unit,
 ...
 */
int
bcm_dnx_ppp_term_spoofing_check_delete_verify(
    int unit,
    bcm_ppp_term_spoofing_check_t * info)
{
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
int
bcm_dnx_ppp_term_spoofing_check_traverse_verify(
    int unit,
    ...
    bcm_ppp_term_spoofing_check_t * info)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_ppp_term_spoofing_check_add_verify(unit, info));
    ...
    bcm_ppp_term_spoofing_check_t * info)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_ppp_term_spoofing_check_delete_verify(unit, info));
    ...
    void *user_data)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_ppp_term_spoofing_check_traverse_verify(unit, additional_info, cb, user_data));
