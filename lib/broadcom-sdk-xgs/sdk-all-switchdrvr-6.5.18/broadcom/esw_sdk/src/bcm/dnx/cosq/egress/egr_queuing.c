    ...
    uint32 *kbits_sec_speed_p)
{
    ...
    if (internal_rate != 0)
    {
        SHR_IF_ERR_EXIT(dnx_ofp_rates_calculate_rate_from_credits
                        (unit, 1, 1, 1, DNX_EGQ_UNITS_VAL_IN_BITS_INTF_RECYCLE, &internal_rate));
    }
    ...
    bcm_port_t logical_port)
{
    ...
    }
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_egr_queuing_packet_mode_set(unit, logical_port, packet_mode));
    }
 ...
 */
shr_error_e
dnx_egr_queuing_packet_mode_set(
    int unit,
    bcm_port_t logical_port,
    int arg)
{
    ...
    do
    {
        ...
        if (logical_port_i != DNX_ALGO_PORT_INVALID)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_port_priorities_nof_get(unit, logical_port_i, &num_priorities));
            /*
             * OTM port attributes - shaper mode, shaper index
             */
            dbal_table_id = DBAL_TABLE_EGQ_SHAPING_OTM_ATTRIBUTES;
            SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, dbal_table_id, 2, 1,
                                             /*
                                              * Keys
                                              */
 ...
 */
shr_error_e
dnx_egr_queuing_packet_mode_get(
    int unit,
    bcm_port_t logical_port,
    int *arg)
{
    ...
    int count_place)
{
    ...
    dbal_tables_field_max_value_get(unit, DBAL_TABLE_EGQ_EPNI_COUNTER, DBAL_FIELD_MIRR_PRIO_MASK, 0,
                                    0, 0, &mirror_pri_mask);
    switch (count_by)
    {
        case DNX_EGQ_COUTNER_FILTER_BY_QP:
