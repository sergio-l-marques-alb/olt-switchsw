    ...
    dnx_mpls_termination_profile_t * term_profile_info)
{
    ...
    if (_SHR_IS_FLAG_SET(l2vpn->flags, DNX_MPLS_L2VPN_FLAG_INGRESS_IML))
    {
    ...
    dnx_algo_gpm_forward_info_t * forward_info)
{
             ...
             (DNX_MPLS_LABEL_IN_RANGE(unit, mpls_port->egress_label.label)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_mpls_tunnel_create_push_entry_from_eei(unit, &(mpls_port->egress_label), TRUE,
