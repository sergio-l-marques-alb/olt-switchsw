 ...
 *
 */
#define DNX_OAM_SET_LMM_OFFSET(mep_type, num_vlan_tags, is_piggy_back, value) \
    do {\
 ...
 */
#define DNX_OAM_SET_LMR_OFFSET(mep_type, num_vlan_tags, is_piggy_back, value) \
    do {\
        DNX_OAM_SET_LMM_OFFSET(mep_type, num_vlan_tags, is_piggy_back, value);\
        value += 8;\
    }while (0)

/* DMM offset is same as LMM offset */
#define DNX_OAM_SET_DMM_OFFSET(mep_type, num_vlan_tags, value) \
    DNX_OAM_SET_LMM_OFFSET(mep_type, num_vlan_tags, 0, value)
