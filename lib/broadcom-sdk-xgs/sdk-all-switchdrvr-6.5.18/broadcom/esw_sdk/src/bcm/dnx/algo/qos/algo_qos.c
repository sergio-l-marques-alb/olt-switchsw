    ...
    const void *data)
{
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "NETWORK_QOS_PIPE",
                                   template_data->network_qos_pipe, "NETWORK_QOS_PIPE", NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "NETWORK_QOS_PIPE_MAPPED",
                                   template_data->network_qos_pipe_mapped, "NETWORK_QOS_PIPE_MAPPED", NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "DP_PIPE_MAPPED",
    ...
    const void *data)
{
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "PHB", template_data->phb, "PHB", NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "REMARK", template_data->remark, "REMARK", NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "ECN", template_data->ecn, "ECN", NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "TTL", template_data->ttl, "TTL", NULL);
    ...
    int unit)
{
    ...
    propagation_profile_data.ecn = DNX_QOS_PROPAGATION_TYPE_PIPE;
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos.capacity.get(unit, DBAL_PHYSICAL_TABLE_INLIF_1, &template_data.max_references));
    SHR_IF_ERR_EXIT(mdb_db_infos.capacity.get(unit, DBAL_PHYSICAL_TABLE_INLIF_2, &max_dpc_reference));
