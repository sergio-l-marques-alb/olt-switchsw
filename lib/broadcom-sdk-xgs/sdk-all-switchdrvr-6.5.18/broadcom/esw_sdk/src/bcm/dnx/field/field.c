...
*/
static int
bcm_dnx_field_group_add_verify(
    int unit,
    uint32 flags,
    ...
    bcm_field_group_t * fg_id)
{
    ...
    if ((unsupported_flags = (flags & ~(BCM_FIELD_FLAG_MSB_RESULT_ALIGN | BCM_FIELD_FLAG_WITH_ID |
                                        BCM_FIELD_FLAG_EXTERNAL_COUNTERS))))
    {
    ...
    bcm_field_group_t * fg_id)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_group_add_verify(unit, flags, fg_info, fg_id));
 ...
 */
static int
bcm_dnx_field_context_create_verify(
    int unit,
    uint32 flags,
    ...
    bcm_field_context_t * context_id)
{
    ...
    else
    {
        ...
        if (flags & BCM_FIELD_FLAG_WITH_ID)
        {
            SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_create_verify(unit, flags, stage, context_info, context_id));
    ...
    bcm_field_context_info_t * context_info)
{
    ...
    {
        SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_create_verify(unit, 0, stage, context_info, &context_id));
 ...
 */
static int
bcm_dnx_field_context_destroy_verify(
    int unit,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id)
{
    ...
    bcm_field_context_t context_id)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_destroy_verify(unit, stage, context_id));
 ...
 */
static int
bcm_dnx_field_group_context_attach_verify(
    int unit,
    uint32 flags,
    bcm_field_group_t fg_id,
    bcm_field_context_t context_id,
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_group_context_attach_verify(unit, flags, fg_id, context_id, attach_info));
    ...
    bcm_field_entry_t * entry_handle)
{
    ...
    switch (fg_type)
    {
        ...
        case DNX_FIELD_GROUP_TYPE_KBP:
        {
            if (flags & BCM_FIELD_FLAG_UPDATE)
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "UPDATE flag is not supported for external TCAM lookup entries. "
                             "Flags 0x%X, fg_id %d.\n", flags, fg_id);
            }
            if (flags & BCM_FIELD_FLAG_WITH_ID)
            {
 ...
 */
static int
bcm_dnx_field_context_hash_create_verify(
    int unit,
    uint32 flags,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id,
    ...
    bcm_field_context_hash_info_t * hash_info)
{
    ...
    /** Validate input parameters */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_hash_create_verify(unit, flags, stage, context_id, hash_info));
    ...
    if (hash_info->hash_config.crc_select != bcmFieldCrcSelectInvalid)
    {
        SHR_IF_ERR_EXIT(dnx_field_map_crc_select_bcm_to_dnx(unit,
                                                            hash_info->hash_config.crc_select,
                                                            &(dnx_hash_info.hash_config.crc_select)));
    }
    else
    {
        dnx_hash_info.hash_config.crc_select = DNX_FIELD_CRC_SELECT_INVALID;
    }
 ...
 */
static int
bcm_dnx_field_context_hash_info_get_verify(
    int unit,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id,
    bcm_field_context_hash_info_t * hash_info)
    ...
    bcm_field_context_hash_info_t * hash_info)
{
    ...
    /** Validate input parameters */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_hash_info_get_verify(unit, stage, context_id, hash_info));
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_crc_select_dnx_to_bcm(unit,
                                                        dnx_hash_info.hash_config.crc_select,
                                                        &(hash_info->hash_config.crc_select)));
 ...
 */
static int
bcm_dnx_field_context_hash_destroy_verify(
    int unit,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id)
{
    ...
    bcm_field_context_t context_id)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_hash_destroy_verify(unit, stage, context_id));
 ...
 */
static int
bcm_dnx_field_context_compare_create_verify(
    int unit,
    uint32 flags,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id,
    ...
    bcm_field_context_compare_info_t * cmp_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_compare_create_verify
                          (unit, flags, stage, context_id, pair_id, cmp_info));
 ...
 */
static int
bcm_dnx_field_context_compare_info_get_verify(
    int unit,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id,
    uint32 pair_id,
    ...
    bcm_field_context_compare_info_t * cmp_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_compare_info_get_verify(unit, stage, context_id, pair_id, cmp_info));
 ...
 */
static int
bcm_dnx_field_context_compare_destroy_verify(
    int unit,
    bcm_field_stage_t stage,
    bcm_field_context_t context_id,
    uint32 pair_id)
    ...
    uint32 pair_id)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_compare_destroy_verify(unit, stage, context_id, pair_id));
 ...
 */
static int
bcm_dnx_field_ace_format_add_verify(
    int unit,
    uint32 flags,
    ...
    bcm_field_ace_format_t * ace_format_id)
{
    ...
    /** Validate input parameters. */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_ace_format_add_verify(unit, flags, ace_format_info, ace_format_id));
 ...
 */
static int
bcm_dnx_field_ace_format_info_get_verify(
    int unit,
    bcm_field_ace_format_t ace_format_id,
    bcm_field_ace_format_info_t * ace_format_info)
{
    ...
    bcm_field_ace_format_info_t * ace_format_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_ace_format_info_get_verify(unit, ace_format_id, ace_format_info));
...
*/
static int
bcm_dnx_field_ace_format_delete_verify(
    int unit,
    bcm_field_ace_format_t ace_format_id)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    bcm_field_ace_format_t ace_format_id)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_ace_format_delete_verify(unit, ace_format_id));
 ...
 */
static int
bcm_dnx_field_ace_entry_add_verify(
    int unit,
    uint32 flags,
    bcm_field_ace_format_t ace_format_id,
    ...
    uint32 *entry_handle)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_ace_entry_add_verify(unit, flags, ace_format_id, entry_info, entry_handle));
 ...
 */
static int
bcm_dnx_field_context_param_set_verify(
    int unit,
    uint32 flags,
    bcm_field_stage_t bcm_stage,
    bcm_field_context_t context_id,
    ...
    bcm_field_context_param_info_t * context_params)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_context_param_set_verify(unit, flags, bcm_stage, context_id, context_params));
 ...
 */
static int
bcm_dnx_field_fem_action_add_verify(
    int unit,
    uint32 flags,
    bcm_field_group_t fg_id,
    ...
    bcm_field_fem_action_info_t * fem_action_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_fem_action_add_verify(unit, flags, fg_id, action_priority, fem_action_info));
 ...
 */
static int
bcm_dnx_field_fem_action_info_get_verify(
    int unit,
    bcm_field_group_t fg_id,
    bcm_field_action_priority_t action_priority,
    bcm_field_fem_action_info_t * fem_action_info)
    ...
    bcm_field_fem_action_info_t * fem_action_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_fem_action_info_get_verify(unit, fg_id, action_priority, fem_action_info));
    SHR_ALLOC(fem_condition_entry_p, sizeof(*fem_condition_entry_p) * dnx_data_field.stage.stage_info_get(unit,
                                                                                                          DNX_FIELD_STAGE_IPMF1)->nof_fem_condition,
              "fem_condition_entry_p", "%s%s%s", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC(fem_action_entry_p,
                     ...
                     bit_in_fem_action < DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_BITS_IN_FEM_ACTION; bit_in_fem_action++)
                {
                        ...
                        DNX_FIELD_FEM_BIT_FORMAT_INVALID)
                    {
                        ...
                        SHR_IF_ERR_EXIT(dnx_field_map_fem_ext_output_src_type_dnx_to_bcm(unit,
                                                                                         fem_action_entry_p->fem_bit_info
 ...
 */
static int
bcm_dnx_field_efes_action_add_verify(
    int unit,
    uint32 flags,
    bcm_field_group_t fg_id,
    bcm_field_context_t context_id,
    ...
    bcm_field_efes_action_info_t * efes_action_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_efes_action_add_verify
...
*/
static int
bcm_dnx_field_presel_set_verify(
    int unit,
    uint32 flags,
    ...
    bcm_field_presel_entry_data_t * entry_data)
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_presel_set_verify(unit, flags, entry_id, entry_data));
 ...
 * \param [in] flags -
 *  Currently not in use!
 * \param [in] range_type_enum -
 *  Range Type (FFC) to config
 * \return
 *  int - Error Type, in sense of bcm_error_t, same as
 *  shr_error_t
 * \remark
 ...
 */
static int
bcm_dnx_field_range_type_config_verify(
    int unit,
    uint32 flags,
    bcm_field_range_config_t range_type_enum)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    if (range_type_enum < bcmFieldRangeConfigFirst && range_type_enum >= bcmFieldRangeConfigCount)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Range Type %d not supported, supported values are between [%d,%d]", range_type_enum,
                     bcmFieldRangeConfigFirst, bcmFieldRangeConfigCount - 1);
    }
 ...
 * \param [in] unit                 - Device ID
 * \param [in] flags                - TBD
 * \param [in] context_id           - Context ID to configure the FFC for (not supported on J2P)
 * \param [in] range_type_enum      - Range Type (FFC) to configure
 * \param [in] range_qualifier_info - Qualifier info to set the FFC with
 *
 * \return
 *  int - Error Type, in sense of bcm_error_t, same as
 *  shr_error_t
    ...
    bcm_field_range_qual_info_t * range_qualifier_info)
{
    ...
    /** Validate input parameters */
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_range_type_config_verify(unit, flags, range_type_enum));
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_range_config_type_bcm_to_dnx(unit, range_type_enum, &dnx_range_type));

    /** Call DNX-level API */
    SHR_IF_ERR_EXIT(dnx_field_range_ffc_config_set(unit, dnx_flags, dnx_range_type, &dnx_qual_info));
 ...
 * \param [in] unit                  - Device ID
 * \param [in] flags                 - TBD
 * \param [in] context_id            - Context ID to get the FFC configuration for (not supported on J2P)
 * \param [in] range_type_enum       - Range Type (FFC) to configure
    ...
    bcm_field_range_qual_info_t * range_qualifier_info)
{
    ...
    SHR_ERR_EXIT(_SHR_E_UNAVAIL, "Function bcm_field_user_def_range_type_config is not implemented\n");
 ...
 */
static int
bcm_dnx_field_name_to_id_verify(
    int unit,
    uint32 flags,
    ...
    uint32 ids[BCM_FIELD_NAME_TO_ID_MAX_IDS])
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Only contexts reuqire stage as input. Provided stage \"%s\" (%d).\n",
    ...
    uint32 ids[BCM_FIELD_NAME_TO_ID_MAX_IDS])
{
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_field_name_to_id_verify(unit, flags, name_to_id_info, nof_ids, ids));
