...
#define DNX_ALGO_ECGM_UNICAST_PD_THRESHOLDS_TEMPLATE_PRINT(uc_thresholds_struct) {\
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "PD flow control", "", NULL, NULL);\
...
#define DNX_ALGO_ECGM_UNICAST_DB_THRESHOLDS_TEMPLATE_PRINT(uc_thresholds_struct) {\
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "DB flow control", "", NULL, NULL);\
