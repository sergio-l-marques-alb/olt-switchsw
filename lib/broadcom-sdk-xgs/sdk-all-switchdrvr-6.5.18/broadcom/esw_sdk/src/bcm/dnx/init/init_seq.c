    ...
    int *dynamic_flags)
{
    ...
    if (dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_is_supported) && !soc_is(unit, J2P_DEVICE))
    {
        *dynamic_flags = 0;
    }
    else
    ...
    int *dynamic_flags)
{
    ...
    if (dnx_data_fabric.links.nof_links_get(unit) && !soc_is(unit, J2P_DEVICE))
    {
        *dynamic_flags = 0;
    }
    else
...
static const  dnx_init_step_t dnx_init_deinit_field_seq[] = {
  ...
  {DNX_INIT_STEP_FLD_MAPPING,     "FP Mapping",  dnx_field_map_init,             dnx_field_map_deinit,           NULL,             0,                            NULL},
...
static const  dnx_init_step_t dnx_init_deinit_common_seq[] = {
  ...
  {DNX_INIT_STEP_AUX_ACCESS,      "Signals&Aux",     shr_access_device_init,       shr_access_device_deinit,       NULL,             DISABLE_WB_CHECK | TIME_PER_DEV,    NULL},
  {DNX_INIT_STEP_RX,              "RX",              dnx_rx_init,                  dnx_rx_deinit,                  NULL,             JOIN,                               NULL},
...
static const  dnx_init_step_t dnx_init_deinit_tm_seq[] = {
  ...
  {DNX_INIT_STEP_DRAM,                          "Dram",                 dnx_dram_init,                  dnx_dram_deinit,            j2p_skip,       WB_SKIP | TIME_PER_DEV,     NULL},
  {DNX_INIT_STEP_DRAM_BUFFERS,                  "Dram Buffers",         dnx_dram_buffers_init,          NULL,                       j2p_skip,       WB_SKIP,                    NULL},
  ...
  {DNX_INIT_STEP_STIF_MODULE,                   "Stif",                 dnx_stif_init,                  NULL,                       j2p_skip,       WB_SKIP,                    NULL},
  {DNX_INIT_STEP_TRUNK_MODULE,                  "Trunk",                dnx_trunk_init,                 NULL,                       NULL,           WB_SKIP | TIME_PER_DEV,     NULL},
  {DNX_INIT_STEP_PORT_MODULE,                   "PORT",                 dnx_port_init,                  dnx_port_deinit,            NULL,           DISABLE_WB_CHECK,           NULL},
  ...
  {DNX_INIT_STEP_FABRIC_TRANSMIT_MODULE,        "Fabric transmit",      dnx_fabric_transmit_init,       NULL,                       j2p_skip,       WB_SKIP,                    NULL},
  ...
  {DNX_INIT_STEP_PFC_DEADLOCK_MODULE,           "PFC Deadlock",         dnx_pfc_deadlock_init,          dnx_pfc_deadlock_deinit,    j2p_skip,       0,                          NULL},
...
static const dnx_init_step_t dnx_init_deinit_pp_seq[] = {
  ...
  {DNX_INIT_STEP_PP_GENERAL,            "General",                dnx_general_pp_init,                      NULL,                                 NULL,            WB_SKIP | TIME_PER_DEV,  NULL},
...
static const  dnx_init_step_t dnx_init_deinit_access_seq[] = {
  /*STEP_ID,                      STEP_NAME,                    STEP_INIT,                              STEP_DEINIT,                            FLAG_CB             STEP_FLAGS                               SUB_STEP_LIST_PTR */
  {DNX_INIT_STEP_IPROC,           "IRPOC/PAXB",                 dnx_drv_soc_dnx_iproc_config,           NULL,                                   NULL,               ACCESS,                                          NULL},
...
static const  dnx_init_step_t dnx_init_deinit_dbal_seq[] = {
  /*STEP_ID,                         STEP_NAME,     STEP_INIT,                    STEP_DEINIT,                       FLAG_CB             STEP_FLAGS              SUB_STEP_LIST_PTR */
  {DNX_INIT_STEP_DBAL_GENERAL,       "General",      dbal_init,                  dbal_deinit,                        NULL,               ACCESS,                 NULL},
  ...
  {DNX_INIT_STEP_DBAL_ACCESS_MDB,    "MDB Access",   dnx_dbal_mdb_init,          dnx_dbal_mdb_deinit,                NULL,               TIME_PER_DEV,           NULL},
  {DNX_INIT_STEP_DBAL_ACCESS_SW,     "SW Access",    dnx_dbal_sw_access_init,    dnx_dbal_sw_access_deinit,          NULL,               WB_SKIP | TIME_PER_DEV, NULL},
...
static const dnx_init_step_t dnx_init_deinit_appl_properties_seq[] = {
  ...
  {DNX_INIT_STEP_DYN_PORT_ADD,           "Adding ports",                dnx_port_init_port_add,             NULL,                    NULL,              ACCESS_PORT | TIME_PER_DEV,   NULL},
  ...
  {DNX_INIT_STEP_MEM_MASK,               "Configure mem monitor mask",  soc_dnxc_ser_init,                  NULL,                    j2p_skip,          WB_SKIP,                      NULL},
  {DNX_INIT_STEP_LAST_STEP,              "Last Step",                   NULL,                               NULL,                    NULL,              0,                            NULL}
};
...
static const  dnx_init_step_t dnx_init_deinit_pre_soft_init_seq[] = {
  /*STEP_ID,                          STEP_NAME,            STEP_INIT,                                  STEP_DEINIT,                  FLAG_CB           STEP_FLAGS                              SUB_STEP_LIST_PTR */
  {DNX_INIT_STEP_PLL,                 "PLL",                soc_dnx_pll_init,                           NULL,                         j2p_skip,         ACCESS | STANDALONE_EN | WB_SKIP,       NULL},
  ...
  {DNX_INIT_STEP_DRAM_BLOCKS_ENABLE,  "DRAM blocks enable", dnx_dram_blocks_enable_set,                 NULL,                         NULL,             ACCESS,                                 NULL},
  ...
  {DNX_INIT_STEP_PEM_SEQ_INIT,        "PEM sequence",       dnx_init_pem_sequence_flow,                 NULL,                         pem_wa_skip_no_verbose,  WB_SKIP,                         NULL},
...
static const  dnx_init_step_t dnx_init_deinit_thread_seq[] = {
    /*          STEP_ID,                                                STEP_NAME,                                      STEP_INIT,                                          STEP_DEINIT,                                    FLAG_CB             STEP_FLAGS          SUB_STEP_LIST_PTR */
    {DNX_INIT_STEP_TEMPERATURE_MONITOR,         "Dram Temperature Monitor",     dnx_hbmc_temp_monitor_init,           dnx_hbmc_temp_monitor_deinit,         j2p_skip,           0,                  NULL},
    {DNX_INIT_STEP_CRPS_EVICTION,               "CRPS Eviction",                dnx_crps_eviction_init,               dnx_crps_eviction_deinit,             0,                  0,                  NULL},
    {DNX_INIT_STEP_MIB_THREAD,                  "Mib thread",                   dnx_init_mib_thread_start,            dnx_init_mib_thread_stop,             j2p_skip,           0,                  NULL},
...
const dnx_init_step_t dnx_init_deinit_seq[] = {
  ...
  {DNX_INIT_MDB,                      "MDB",                  dnx_mdb_init,                         dnx_mdb_deinit,                     NULL,               PARALLEL | TIME_PER_DEV,                    NULL},
  {DNX_INIT_STEP_ALGO,                "Algo",                 NULL,                                 NULL,                               NULL,               PARALLEL | ACCESS_PORT | TIME_PER_DEV,      dnx_init_deinit_algo_seq},
