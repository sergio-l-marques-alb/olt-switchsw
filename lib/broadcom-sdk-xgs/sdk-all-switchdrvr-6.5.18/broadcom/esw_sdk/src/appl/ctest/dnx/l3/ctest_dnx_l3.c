    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Offsets.0", &signal_values[0], 1, NULL,
                         return_value, 0), "Test failed , layer_offsets.0 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Offsets.1", &signal_values[1], 1, NULL,
                         return_value, 0), "Test failed , layer_offsets.1 \n.");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Offsets.2", &signal_values[2], 1, NULL,
                         return_value, 0), "Test failed , layer_offsets.2 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Protocols.0",
                         (uint32 *) &eth_layer_protocol, 1, NULL, return_value, 0),
                        "Test failed , Layer_Protocols.0 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Protocols.1",
                         (uint32 *) &ipv4_layer_protocol, 1, NULL, return_value, 0),
                        "Test failed , Layer_Protocols.1 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Qualifiers.0", &signal_values[3], 1, NULL,
                         return_value, 0), "Test failed , Layer_Qualifiers.0 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Layer_Qualifiers.1", &signal_values[4], 1, NULL,
                         return_value, 0), "Test failed , Layer_Qualifiers.1 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT5", "", "In_Port", &mapping_info.pp_port, 1, NULL,
                         return_value, 0), "Test failed , In_Port \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "LLR", "", "Incoming_Tag_Exist", &signal_values[5], 1, NULL,
                         return_value, 0), "Test failed , Incoming_Tag_Exist \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "LLR", "", "Vlan_Domain", (uint32 *) &in_port, 1, NULL,
                         return_value, 0), "Test failed , Vlan_Domain \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Fwd_Domain_ID.type", (uint32 *) &type_vrf, 1,
                         NULL, return_value, 0), "Test failed , Fwd_Domain_ID.type \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Fwd_Domain_ID.value", (uint32 *) &vrf, 1, NULL,
                         return_value, 0), "Test failed , Fwd_Domain_ID.value \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Incoming_Tag_Structure", &signal_values[6], 1,
                         NULL, return_value, 0), "Test failed , Incoming_Tag_Structure \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "VTT1", "", "Fwd_Layer_Index", &signal_values[7], 1, NULL,
                         return_value, 0), "Test failed , Fwd_Layer_Index \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "FWD1", "", "Fwd_Domain_ID.type", (uint32 *) &type_vrf, 1,
                         NULL, return_value, 0), "Test failed , Fwd_Domain_ID.type \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "FWD1", "", "Fwd_Domain_ID.value", (uint32 *) &vrf, 1, NULL,
                         return_value, 0), "Test failed , Fwd_Domain_ID.value \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "FWD1", "", "Fwd_Layer_Index", &signal_values[8], 1, NULL,
                         return_value, 0), "Test failed , Fwd_Layer_Index \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "LBP", "", "TM_Cmd.Fwd_Action_Dst", (uint32 *) &intf_port, 1,
                         NULL, return_value, 0), "Test failed , TM_Cmd.Fwd_Action_Dst \n");
    ...
    if (system_headers_mode != DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
    {
        ...
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ERPP", "Fabric", "", "FTMH_PP_DSP", &masked_out_port, 1, NULL,
                             return_value, 0), "Test failed , FTMH_PP_DSP \n");
    }
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "FER", "", "All_Out_LIFs.0", &out_intf, 1, NULL,
                         return_value, 0), "Test failed , All_Out_LIFs.0 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "LBP", "", "Fwd_Action_Dst.type",
                         (uint32 *) &physical_port_type, 1, NULL, return_value, 0),
                        "Test failed , Fwd_Action_Dst.type \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "LBP", "", "Fwd_Action_Dst.value", (uint32 *) &out_port, 1,
                         NULL, return_value, 0), "Test failed , Fwd_Action_Dst.value \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "LBP", "", "Bytes_To_Remove", &signal_values[9], 1, NULL,
                         return_value, 0), "Test failed , Bytes_To_Remove \n");
    if (system_headers_mode != DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
    {
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ETPP", "", "ETParser",
                             "FTMH_Multicast_ID_or_MC_REP_IDX_or_OutLIF_0", &out_intf, 1, NULL, return_value, 0),
                            "Test failed , FTMH_Multicast_ID_or_MC_REP_IDX_or_OutLIF_0 \n");
    }
    else
    {
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ETPP", "ETParser", "", "CUD_Out_LIF_or_MCDB_Ptr", &out_intf, 1,
                             NULL, return_value, 0), "Test failed , CUD_Out_LIF_or_MCDB_Ptr \n");
    }
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "PRP2", "", "Fabric_or_Egress_MC", &signal_values[10], 1,
                         NULL, return_value, 0), "Test failed , Fabric_or_Egress_MC \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "PRP2", "", "fall2bridge_indication", &signal_values[11], 1,
                         NULL, return_value, 0), "Test failed , fall2bridge_indication \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "PRP2", "", "Fwd_Code", (uint32 *) &forward_code_ipv4, 1,
                         NULL, return_value, 0), "Test failed , Fwd_Code \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "PRP2", "", "EPP_Layer_Qualifiers.0", &signal_values[12], 1,
                         NULL, return_value, 0), "Test failed , EPP_Layer_Qualifiers \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "PRP2", "", "EPP_Layer_Qualifiers.1", &signal_values[13], 1,
                         NULL, return_value, 0), "Test failed , EPP_Layer_Qualifiers.1 \n");
    ...
    if (system_headers_mode != DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
    {
        ...
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ETPP", "PRP2", "", "EPP_Layer_Protocols.1",
                             (uint32 *) &ipv4_layer_protocol, 1, NULL, return_value, 0),
                            "Test failed , EPP_Layer_Protocols.1 \n");
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ETPP", "PRP2", "", "EPP_Layer_Offsets.0", &signal_values[14], 1,
                             NULL, return_value, 0), "Test failed , EPP_Layer_Offsets.0 \n");
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ETPP", "PRP2", "", "EPP_Layer_Offsets.1",
    ...
    else
    {
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            ...
                            "Test failed , EPP_Layer_Protocols.0 \n");
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "ETPP", "PRP2", "", "EPP_Layer_Offsets.0", &after_eth_offset, 1,
                             NULL, return_value, 0), "Test failed , EPP_Layer_Offsets.0 \n");
    }
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Term", "", "VSDS.My_Mac_Prefix_1", &signal_values[15], 1,
                         NULL, return_value, 0), "Test failed , My_Mac_Prefix_1 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Term", "", "VSDS.My_Mac_LSBs_1", &signal_values[16], 1, NULL,
                         return_value, 0), "Test failed , VSDS.My_Mac_LSBs_1 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "FWD", "", "Dst_IP", &dip_exp, 1, NULL, return_value, 0),
                        "Test failed , Dst_IP \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
    ...
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "FWD", "", "Fwd_Bytes_to_Add", &signal_values[17], 1, NULL,
                         return_value, 0), "Test failed , Fwd_Bytes_to_Add \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "FWD2", "IPMF1", "Fwd_Action_Dst",
                         (uint32 *) &fwd_destination, 1, NULL, return_value, 0), "Test failed , Fwd_Action_Dst \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "IRPP", "IPMF1", "FER", "Fwd_Action_Dst", (uint32 *) &fwd_destination,
                         1, NULL, return_value, 0), "Test failed , Fwd_Action_Dst \n");
    if (system_headers_mode != DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
    {
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "IRPP", "FER", "", "All_Out_LIFs.1", &signal_values[18], 1, NULL,
                             return_value, 0), "Test failed , All_Out_LIFs.1 \n");
    }
    else
    {
        SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                            (unit, mapping_info.core, "IRPP", "FER", "", "EEI", &signal_values[19], 1, NULL,
                             return_value, 0), "Test failed , EEI \n");
    }
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Term", "", "ETPS_Valid.1", &signal_values[20], 1, NULL,
                         return_value, 0), "Test failed , ETPS_Valid.1 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Term", "", "ETPS_Valid.2", &signal_values[21], 1, NULL,
                         return_value, 0), "Test failed , ETPS_Valid.2 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Term", "", "ETPS_Valid.3", &signal_values[22], 1, NULL,
                         return_value, 0), "Test failed , ETPS_Valid.3 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Term", "", "ETPS_Valid.4", &signal_values[23], 1, NULL,
                         return_value, 0), "Test failed , ETPS_Valid.4 \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Enc5", "", "Enc_Bytes_to_Add", &signal_values[24], 1, NULL,
                         return_value, 0), "Test failed , Enc_Bytes_to_Add \n");
    SHR_CLI_EXIT_IF_ERR(sand_signal_verify
                        (unit, mapping_info.core, "ETPP", "Enc5", "", "Fwd_Action_Profile", &signal_values[25], 1, NULL,
                         return_value, 0), "Test failed , Fwd_Action_Profile \n");
...
sh_sand_cmd_t dnx_l3_test_cmds[] = {
    {"Performance", NULL, dnx_l3_performance_cmds, NULL, &sh_dnx_l3_performance_man}
    ,
    {"fec", NULL, dnx_l3_fec_test_cmds, NULL, &sh_dnx_l3_fec_man}
    ,
    {"ecmp", NULL, dnx_ecmp_test_cmds, NULL, &sh_dnx_l3_ecmp_man}
    ,
    {"rif", NULL, dnx_l3_ing_intf_test_cmds, NULL, &sh_dnx_l3_ing_intf_man}
    ,
    {"arp", NULL, dnx_l3_arp_test_cmds, NULL, &sh_dnx_l3_arp_man}
    ,
    {"route_basic", sh_dnx_l3_ip_route_basic_cmd, NULL, NULL, &sh_dnx_l3_ip_route_basic_man}
    ,
    {NULL}
};
