    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (sal_strcasecmp(test_type, CTEST_DNX_RX_TRAPS_PROG_OPTION_TEST_POSITIVE) == 0)
    {
        SHR_IF_ERR_EXIT(appl_dnx_rx_trap_prog_pos(unit));
    }
    else if (sal_strcasecmp(test_type, CTEST_DNX_RX_TRAPS_PROG_OPTION_TEST_NEGATIVE) == 0)
    {
