    ...
    sh_sand_control_t * sand_control)
{
    ...
    bcm_rx_trap_svtag_key_t_init(&svtag_trap_key);
    svtag_trap_key.pkt_type = bcmbcmSvtagPktTypeKayMgmt;
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (sal_strcasecmp(test_type, CTEST_DNX_RX_TRAPS_SVTAG_TEST_TYPE_POSITIVE) == 0)
    {
    ...
    else if (sal_strcasecmp(test_type, CTEST_DNX_RX_TRAPS_SVTAG_TEST_TYPE_NEGATIVE) == 0)
    {
    ...
    else if (sal_strcasecmp(test_type, CTEST_DNX_RX_TRAPS_SVTAG_TEST_TYPE_EXHAUSTIVE) == 0)
    {
