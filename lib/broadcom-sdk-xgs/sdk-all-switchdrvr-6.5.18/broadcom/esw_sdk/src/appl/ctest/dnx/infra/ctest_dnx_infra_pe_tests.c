    ...
    sh_sand_control_t * sand_control)
{
     ...
     */
    SHR_CLI_EXIT_IF_ERR(periodic_event_stop(my_handler, 0), "Test FAIL. Failed to stop periodic event\n");
     ...
     * destroy 
     */
    SHR_CLI_EXIT_IF_ERR(periodic_event_destroy(&my_handler), "Test FAIL. Failed to destroy periodic event\n");
