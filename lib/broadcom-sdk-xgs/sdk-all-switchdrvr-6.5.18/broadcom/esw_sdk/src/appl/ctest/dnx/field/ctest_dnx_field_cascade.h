...
#ifndef DIAG_DNX_FIELD_CASCADE_H_INCLUDED
/*
 * {
 */
#define DIAG_DNX_FIELD_CASCADE_H_INCLUDED
 ...
 */
extern sh_sand_option_t dnx_field_cascade_options[];

/**
 * \brief
 *   man for 'CaScaDe' command
 */
extern sh_sand_man_t sh_dnx_field_cascade_man;
/**
 * \brief
 *   Options list for 'CaScaDe' tests to run on regression, precommit, ...
 */
extern sh_sand_invoke_t sh_dnx_field_cascade_tests[];
 ...
 *   shr_error_e
 */
shr_error_e sh_dnx_field_cascade_cmd(
    int unit,
    args_t * args,
