    ...
    void **node)
{
    ...
    if (is_capacity)
    {
        /** There is no CPU measures for capacity */
        cpu_node = test_node;
    }
    else
    {
        cpu_node = dbx_xml_child_get_first(test_node, cpu_name);
        if (cpu_node == NULL)
        {
            SHR_ERR_EXIT(_SHR_E_NOT_FOUND, "Cannot find %s node in file: %s\n",
    ...
    ip_node = dbx_xml_child_get_first(cpu_node, ip_name);
    if (ip_node == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_NOT_FOUND, "Cannot find %s node in file: %s\n",
...
static sh_sand_cmd_t dnx_kbp_fwd_capacity_cmds[] = {
    {"IPv4", dnx_kbp_fwd_capacity_ipv4_cmd, NULL, dnx_kbp_fwd_capacity_cmd_options, &dnx_kbp_fwd_capacity_ipv4_man, NULL, dnx_kbp_fwd_capacity_ipv4_tests},
    {"IPv6", dnx_kbp_fwd_capacity_ipv6_cmd, NULL, dnx_kbp_fwd_capacity_cmd_options, &dnx_kbp_fwd_capacity_ipv6_man, NULL, dnx_kbp_fwd_capacity_ipv6_tests},
    {NULL}
};

/* *INDENT-ON* */

extern shr_error_e diag_dbal_test_logical_table(
    int unit,
...
sh_sand_cmd_t dnx_kbp_fwd_cmds[] = {
    {"Capacity", NULL, dnx_kbp_fwd_capacity_cmds, dnx_kbp_fwd_capacity_options, &dnx_kbp_fwd_capacity_man, NULL, dnx_kbp_fwd_capacity_tests},
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(kbp_mngr_opcode_master_key_segments_add
                    (unit, opcode_id, lookup_info.nof_segments, master_key_segments));
    SHR_IF_ERR_EXIT(kbp_mngr_opcode_lookup_add(unit, opcode_id, &lookup_info));
    ...
    void **node)
{
    ...
    acl_node = dbx_xml_child_get_first(cpu_node, "ACL");
    if (acl_node == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_NOT_FOUND, "Cannot find %s node in file: %s\n",
...
sh_sand_cmd_t dnx_kbp_acl_cmds[] = {
    {"TeST", dnx_kbp_acl_kbp_mngr_cmd, NULL, dnx_kbp_acl_kbp_mngr_cmd_options, &dnx_kbp_acl_kbp_mngr_man, NULL, dnx_kbp_acl_kbp_mngr_tests},
    {"PERFormance", dnx_kbp_acl_performance_cmd, NULL, dnx_kbp_acl_performance_options, &dnx_kbp_acl_performance_man, NULL, dnx_kbp_acl_performance_tests},
    {"Capacity", dnx_kbp_acl_capacity_cmd, NULL, dnx_kbp_acl_capacity_options, &dnx_kbp_acl_capacity_man, NULL, dnx_kbp_acl_capacity_tests},
    {NULL}
};
...
sh_sand_cmd_t dnx_kbp_combo_cmds[] = {
    {"Test", dnx_kbp_combo_test_cmd, NULL, dnx_kbp_combo_test_options, &dnx_kbp_combo_test_man, NULL},
    {"Info", dnx_kbp_combo_info_cmd, NULL, dnx_kbp_combo_info_options, &dnx_kbp_combo_info_man, NULL},
    {NULL}
};
...
sh_sand_cmd_t dnx_kbp_test_cmds[] = {
    {"ACL", NULL, dnx_kbp_acl_cmds, dnx_kbp_acl_options, &dnx_kbp_acl_man, NULL, dnx_kbp_acl_tests},
    {"CoMBo", NULL, dnx_kbp_combo_cmds, dnx_kbp_combo_options, &dnx_kbp_combo_man, NULL, dnx_kbp_combo_tests},
    ...
    {"STIF", NULL, sh_dnx_kbp_stif_test_cmds, NULL, &dnx_kbp_stif_man},
    {NULL}
};
/* *INDENT-ON* */
