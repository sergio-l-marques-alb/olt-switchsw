...
/** W.A. API for distinguishing between SLK and Intel-GTS */
static uint8
...
static shr_error_e
dnx_l3_performance_expected_performance_measurements_get(
    int unit,
    uint8 is_host,
    uint8 is_ipmc,
    uint8 is_ipv6,
    ...
    uint8 *layer_id)
{
    ...
    if (*is_tcam && *is_em)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Invalid combination of parameters - TCAM and EM\n");
    }
    ...
    if (dnx_kbp_device_enabled(unit))
    {
            ...
            (!is_ipv6 && dnx_data_elk.application.feature_get(unit, dnx_data_elk_application_ipv4)))
        {
            ...
            *is_external = TRUE;
            ...
            {
                /** Perform measurements validation only on OP2 */
                *do_validation = FALSE;
            }
        }
        else
    ...
    SHR_IF_ERR_EXIT(dnx_l3_performance_validation_check_for_device(unit, do_validation));
    /** Only BCM and DBAL layer testing is supported at the moment */
    SHR_IF_ERR_EXIT(dnx_l3_performance_layer_parameters_update(unit, layer, layer_id, do_validation));
    ...
    int run_time[3][100])
{
    ...
    char *select_table_name = NULL;
    char fwd_name[2][DBAL_MAX_STRING_LENGTH] =
        { "KBP_IPV4_UNICAST_PRIVATE_LPM_FORWARD", "KBP_IPV6_UNICAST_PRIVATE_LPM_FORWARD" };
    char rpf_name[2][DBAL_MAX_STRING_LENGTH] =
        { "KBP_IPV4_UNICAST_PRIVATE_LPM_RPF", "KBP_IPV6_UNICAST_PRIVATE_LPM_RPF" };
    char ipmc_name[2][DBAL_MAX_STRING_LENGTH] =
        { "KBP_IPV4_MULTICAST_TCAM_FORWARD", "KBP_IPV6_MULTICAST_TCAM_FORWARD" };
    ...
    if (is_ipmc)
    {
        select_table_name = ipmc_name[is_ipv6];
    ...
    {
        select_table_name = fwd_name[is_ipv6];
    ...
    {
        select_table_name = rpf_name[is_ipv6];
    ...
    SHR_IF_ERR_EXIT(kbp_mngr_db_id_by_name_get(unit, select_table_name, &db_id));
    ...
    uint8 is_ipv6)
{
    ...
    uint8 is_random = FALSE,
        is_external = FALSE,
        do_validation = FALSE, is_public = FALSE, is_rpf = FALSE, is_tcam = FALSE, is_em = FALSE, layer_id = 0;
    int run_time[3][100];
    int rate[3] = { 0, 0, 0 };
    ...
    if (do_validation)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_l3_performance_expected_performance_measurements_get
                        (unit, is_host, is_ipmc, is_ipv6, is_external, is_rpf, is_tcam, is_em,
...
static sh_sand_cmd_t dnx_l3_performance_host_cmds[] = {
    {"IPv4", dnx_l3_performance_host_ipv4_cmd, NULL, dnx_l3_performance_cmd_options, &dnx_l3_performance_host_ipv4_man, NULL, dnx_l3_performance_host_tests},
    {"IPv6", dnx_l3_performance_host_ipv6_cmd, NULL, dnx_l3_performance_cmd_options, &dnx_l3_performance_host_ipv6_man, NULL, dnx_l3_performance_host_tests},
    {NULL}
};
...
static sh_sand_cmd_t dnx_l3_performance_route_cmds[] = {
    {"IPv4", dnx_l3_performance_route_ipv4_cmd, NULL, dnx_l3_performance_cmd_options, &dnx_l3_performance_route_ipv4_man, NULL, dnx_l3_performance_route_tests},
    {"IPv6", dnx_l3_performance_route_ipv6_cmd, NULL, dnx_l3_performance_cmd_options, &dnx_l3_performance_route_ipv6_man, NULL, dnx_l3_performance_route_tests},
    {NULL}
};
...
static sh_sand_cmd_t dnx_l3_performance_ipmc_cmds[] = {
    {"IPv4", dnx_l3_performance_ipmc_ipv4_cmd, NULL, dnx_l3_performance_cmd_options, &dnx_l3_performance_ipmc_ipv4_man, NULL, dnx_l3_performance_ipmc_tests},
    {"IPv6", dnx_l3_performance_ipmc_ipv6_cmd, NULL, dnx_l3_performance_cmd_options, &dnx_l3_performance_ipmc_ipv6_man, NULL, dnx_l3_performance_ipmc_tests},
    {NULL}
};
...
sh_sand_cmd_t dnx_l3_performance_cmds[] = {
    {"Host", NULL, dnx_l3_performance_host_cmds, NULL, &dnx_l3_performance_host_man, NULL, NULL},
    {"Route", NULL, dnx_l3_performance_route_cmds, NULL, &dnx_l3_performance_route_man, NULL, NULL},
    {"IPMC", NULL, dnx_l3_performance_ipmc_cmds, NULL, &dnx_l3_performance_ipmc_man, NULL, NULL},
    {NULL}
};
