    ...
    bcm_field_context_info_t * context_info_p)
{
    ...
    else
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ...
                    __FUNCTION__, __LINE__, opcode_type, EMPTY);
    ...
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, fg_info_p, fg_id_p));
    ...
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, fg_info_p, fg_id_shared_p));
    ...
    dnx_field_context_apptype_info_t * apptype_info_p)
{
    ...
    if (opcode_type == 0)
    {
         ...
         * Cast. 
         */
        *context_id_p = DBAL_ENUM_FVAL_KBP_FWD_OPCODE_NOP;
    ...
    sal_strncpy_s((char *) fg_info_p->name, "external", sizeof(fg_info_p->name));
    fg_info_p->fg_type = DNX_FIELD_GROUP_TYPE_KBP;
    ...
    SHR_IF_ERR_EXIT(dnx_field_entry_kbp_add(unit, *fg_id_p, entry_info_p, entry_id_p));
    ...
    bcm_field_context_info_t * context_info_p)
{
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_info_get: Unexpected data returned. nof_quals expected %d received %d. <<<< \n %s%s",
                    fg_info_p->nof_quals, fg_info_get.nof_quals, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    for (qual_iter = 0; qual_iter < fg_info_get.nof_quals; qual_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_info_get: Unexpected data returned. qual_types expected %d received %d. <<<< \n %s%s",
                        fg_info_p->qual_types[qual_iter], fg_info_get.qual_types[qual_iter], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_info_get: Unexpected data returned. nof_actions expected %d received %d. <<<< \n %s%s",
                    fg_info_p->nof_actions, fg_info_get.nof_actions, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    for (action_iter = 0; action_iter < fg_info_get.nof_actions; action_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_info_get: Unexpected data returned. action types expected %d received %d. <<<< \n %s%s",
                        fg_info_p->action_types[action_iter], fg_info_get.action_types[action_iter], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_info_get: Unexpected data returned. stage expected %d received %d. <<<< \n %s%s",
                    fg_info_p->stage, fg_info_get.stage, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_info_get: Unexpected data returned. fg_type expected %d received %d. <<<< \n %s%s",
                    fg_info_p->fg_type, fg_info_get.fg_type, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. nof_quals expected %d received %d. <<<< \n %s%s",
                    attach_info_p->key_info.nof_quals, attach_info_get.key_info.nof_quals, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    for (qual_iter = 0; qual_iter < attach_info_get.key_info.nof_quals; qual_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. qual_types expected %d received %d. <<<< \n %s%s",
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. input_type expected %d received %d. <<<< \n %s%s",
                        attach_info_p->key_info.qual_info[qual_iter].input_type,
                        attach_info_get.key_info.qual_info[qual_iter].input_type, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. input_arg expected %d received %d. <<<< \n %s%s",
                        attach_info_p->key_info.qual_info[qual_iter].input_arg,
                        attach_info_get.key_info.qual_info[qual_iter].input_arg, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        if (attach_info_get.key_info.qual_info[qual_iter].offset != attach_info_p->key_info.qual_info[qual_iter].offset)
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. offset expected %d received %d. <<<< \n %s%s",
                        attach_info_p->key_info.qual_info[qual_iter].offset,
                        attach_info_get.key_info.qual_info[qual_iter].offset, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. nof_actions expected %d received %d. <<<< \n %s%s",
                    attach_info_p->payload_info.nof_actions, attach_info_get.payload_info.nof_actions, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    for (action_iter = 0; action_iter < attach_info_get.payload_info.nof_actions; action_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. action types expected %d received %d. <<<< \n %s%s",
                        attach_info_p->payload_info.action_types[action_iter],
                        attach_info_get.payload_info.action_types[action_iter], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. action priority expected %d received %d. <<<< \n %s%s",
                        attach_info_p->payload_info.action_info[action_iter].priority,
                        attach_info_get.payload_info.action_info[action_iter].priority, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. payload_id expected %d received %d. <<<< \n %s%s",
                    attach_info_p->payload_info.payload_id, attach_info_get.payload_info.payload_id, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_group_context_info_get: Unexpected data returned. payload_offset expected %d received %d. <<<< \n %s%s",
                    attach_info_p->payload_info.payload_offset, attach_info_get.payload_info.payload_offset, EMPTY,
                    EMPTY);
        return BCM_E_FAIL;
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. nof_entry_quals expected %d received %d. <<<< \n %s%s",
                    entry_info_p->nof_entry_quals, entry_info_get.nof_entry_quals, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    for (qual_iter = 0; qual_iter < entry_info_get.nof_entry_quals; qual_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. qual_types expected %d received %d. <<<< \n %s%s",
                        entry_info_p->entry_qual[qual_iter].type, entry_info_get.entry_qual[qual_iter].type, EMPTY,
                        EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. qual_value expected %d received %d. <<<< \n %s%s",
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. qual_mask expected %d received %d. <<<< \n %s%s",
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. nof_entry_actions expected %d received %d. <<<< \n %s%s",
                    entry_info_p->nof_entry_actions, entry_info_get.nof_entry_actions, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    for (action_iter = 0; action_iter < entry_info_get.nof_entry_actions; action_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. action_types expected %d received %d. <<<< \n %s%s",
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_entry_info_get: Unexpected data returned. action_value expected %d received %d. <<<< \n %s%s",
                        entry_info_p->entry_action[action_iter].value[0],
                        entry_info_get.entry_action[action_iter].value[0], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_context_info_get: Unexpected data returned. cascaded_from expected %d received %d. <<<< \n %s%s",
                    context_info_p->cascaded_from, context_info_get.cascaded_from, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    if (opcode_type == 1)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_context_info_get: Unexpected data returned. context name expected %s received %s. <<<< \n %s%s",
                        context_info_p->name, context_info_get.name, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    dnx_field_context_apptype_info_t * apptype_info_p)
{
    ...
    for (qual_iter = 0; fg_info_get.group_basic_info.dnx_quals[qual_iter] == DNX_FIELD_QUAL_TYPE_INVALID; qual_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_get: Unexpected data returned. qual_types expected %d received %d. <<<< \n %s%s",
                        fg_info_p->dnx_quals[qual_iter], fg_info_get.group_basic_info.dnx_quals[qual_iter], EMPTY,
                        EMPTY);
            return BCM_E_FAIL;
        }
    }
         ...
         action_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_get: Unexpected data returned. action types expected %d received %d. <<<< \n %s%s",
                        fg_info_p->dnx_actions[action_iter],
                        fg_info_get.group_basic_info.dnx_actions[action_iter], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: dnx_field_group_get: Unexpected data returned. stage expected %d received %d. <<<< \n %s%s",
                    fg_info_p->field_stage, fg_info_get.group_basic_info.field_stage, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: dnx_field_group_get: Unexpected data returned. fg_type expected %d received %d. <<<< \n %s%s",
                    fg_info_p->fg_type, fg_info_get.group_basic_info.fg_type, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
         ...
         qual_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. qual_types expected %d received %d. <<<< \n %s%s",
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. input_type expected %d received %d. <<<< \n %s%s",
                        attach_info_p->qual_info[qual_iter].input_type,
                        attach_info_get.attach_basic_info.qual_info[qual_iter].input_type, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. input_arg expected %d received %d. <<<< \n %s%s",
                        attach_info_p->qual_info[qual_iter].input_arg,
                        attach_info_get.attach_basic_info.qual_info[qual_iter].input_arg, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        if (attach_info_get.attach_basic_info.qual_info[qual_iter].offset != attach_info_p->qual_info[qual_iter].offset)
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. offset expected %d received %d. <<<< \n %s%s",
                        attach_info_p->qual_info[qual_iter].offset,
                        attach_info_get.attach_basic_info.qual_info[qual_iter].offset, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
         ...
         action_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. action types expected %d received %d. <<<< \n %s%s",
                        attach_info_p->dnx_actions[action_iter],
                        attach_info_get.attach_basic_info.dnx_actions[action_iter], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. payload_id expected %d received %d. <<<< \n %s%s",
                    attach_info_p->payload_id, attach_info_get.attach_basic_info.payload_id, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: dnx_field_group_context_get: Unexpected data returned. payload_offset expected %d received %d. <<<< \n %s%s",
                    attach_info_p->payload_offset, attach_info_get.attach_basic_info.payload_offset, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }

    LOG_INFO_EX(BSL_LOG_MODULE, "Step 5: Get the entry info. \n %s%s%s%s", EMPTY, EMPTY, EMPTY, EMPTY);
    SHR_IF_ERR_EXIT(dnx_field_entry_t_init(unit, &entry_info_get));
    SHR_IF_ERR_EXIT(dnx_field_entry_kbp_get(unit, fg_id, entry_id, &entry_info_get));
         ...
         qual_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_entry_kbp_get: Unexpected data returned. qual_types expected %d received %d. <<<< \n %s%s",
                        entry_info_p->key_info.qual_info[qual_iter].dnx_qual,
                        entry_info_get.key_info.qual_info[qual_iter].dnx_qual, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_entry_kbp_get: Unexpected data returned. qual_value expected %d received %d. <<<< \n %s%s",
                        entry_info_p->key_info.qual_info[qual_iter].qual_value[0],
                        entry_info_get.key_info.qual_info[qual_iter].qual_value[0], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_entry_kbp_get: Unexpected data returned. qual_mask expected %d received %d. <<<< \n %s%s",
                        entry_info_p->key_info.qual_info[qual_iter].qual_mask[0],
                        entry_info_get.key_info.qual_info[qual_iter].qual_mask[0], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
         ...
         action_iter++)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_entry_kbp_get: Unexpected data returned. action_types expected %d received %d. <<<< \n %s%s",
                        entry_info_p->payload_info.action_info[action_iter].dnx_action,
                        entry_info_get.payload_info.action_info[action_iter].dnx_action, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: dnx_field_entry_kbp_get: Unexpected data returned. action_value expected %d received %d. <<<< \n %s%s",
                        entry_info_p->payload_info.action_info[action_iter].action_value[0],
                        entry_info_get.payload_info.action_info[action_iter].action_value[0], EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
    ...
    {
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ">>>> ERROR: bcm_field_context_info_get: Unexpected data returned. base_static_apptype expected %d received %d. <<<< \n %s%s",
                    apptype_info_p->base_static_apptype, apptype_info_get.base_static_apptype, EMPTY, EMPTY);
        return BCM_E_FAIL;
    }
    ...
    if (opcode_type == 1)
    {
        ...
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ">>>> ERROR: bcm_field_context_info_get: Unexpected data returned. apptype name expected %s received %s. <<<< \n %s%s",
                        apptype_info_p->name, apptype_info_get.name, EMPTY, EMPTY);
            return BCM_E_FAIL;
        }
    }
