    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (global_parameters.sematic_scale_validation)
    {
        LOG_CLI((BSL_META("The c-model has mdb limitation, aborting the run..\n")));
        SHR_FUNC_EXIT;
    }
#endif
    ...
    if (dnx_data_oam.hw_bug.feature_get(unit, dnx_data_oam_hw_bug_oamp_scanner_limitation))
    {
...
/** Don't test the timing on C-model */
#if !defined(ADAPTER_SERVER_MODE)
    /**
