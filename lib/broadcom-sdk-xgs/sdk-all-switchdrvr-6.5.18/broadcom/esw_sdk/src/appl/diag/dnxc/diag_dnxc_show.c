...
#define DIAG_DNXC_DNX_SHOW_COUNTERS_SHARED_EXAMPLES  "full port=xe13\n" \
                                                     ...
                                                     "full z port=xe13\n" \
                                                     "full chg port=xe\n"
#define DIAG_DNXC_FABRIC_SHOW_COUNTERS_SHARED_EXAMPLES   "f port=fabric5-fabric10\n"
    ...
    int voltage)
{
    soc_reg_t pvt_control[] = { ECI_PVT_MON_A_CONTROL_REGr, ECI_PVT_MON_B_CONTROL_REGr, ECI_PVT_MON_C_CONTROL_REGr,
        ECI_PVT_MON_D_CONTROL_REGr, ECI_PVT_MON_E_CONTROL_REGr
    };
    int ii;
    uint64 controlVal;
    uint32 val = 0;
    ...
    sh_sand_control_t * sand_control)
{
    ...
    soc_reg_t pvt_data[] = { ECI_PVT_MON_A_THERMAL_DATAr, ECI_PVT_MON_B_THERMAL_DATAr, ECI_PVT_MON_C_THERMAL_DATAr,
        ECI_PVT_MON_D_THERMAL_DATAr, ECI_PVT_MON_E_THERMAL_DATAr
    };
    soc_field_t pvt_current[] = { THERMAL_DATA_Af, THERMAL_DATA_Bf, THERMAL_DATA_Cf, THERMAL_DATA_Df, THERMAL_DATA_Ef };
    soc_field_t pvt_peak[] = { PEAK_THERMAL_DATA_Af, PEAK_THERMAL_DATA_Bf, PEAK_THERMAL_DATA_Cf, PEAK_THERMAL_DATA_Df,
        PEAK_THERMAL_DATA_Ef
    };
    uint32 data;
    uint32 remainder[3];
...
sh_sand_cmd_t sh_dnxc_show_cmds[] = {
    ...
    {"VOLTage",   cmd_dnxc_show_voltage,  NULL,    NULL,                       &dnxc_show_voltage_man,  NULL, NULL, SH_CMD_NO_XML_VERIFY},
    {NULL}
};
