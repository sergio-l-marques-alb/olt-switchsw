/*
 * $Id: trident2_loadbalance.c Broadcom SDK $
 * $Copyright: (c) 2019 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    trident2_loadbalance.c
...
/* "loadbalance" feature's diag command list only for Trident2 */
char * techsupport_loadbalance_trident2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "loadbalance" feature's software dump command list only for Trident2 */
char * techsupport_loadbalance_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "loadbalance" feature for Trident2 chipset. */
static soc_mem_t techsupport_loadbalance_trident2_memory_table_list[] = {
 ...
 * "loadbalance" feature for Trident2 chipset. */
techsupport_reg_t techsupport_loadbalance_trident2_reg_list[] = {
 ...
 * "loadbalance" feature for Trident2 chipset. */
techsupport_data_t techsupport_loadbalance_trident2_data = {
    techsupport_loadbalance_diag_cmdlist,
    techsupport_loadbalance_trident2_reg_list,
    techsupport_loadbalance_trident2_memory_table_list,
    techsupport_loadbalance_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_loadbalance_sw_dump_cmdlist,
    techsupport_loadbalance_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
