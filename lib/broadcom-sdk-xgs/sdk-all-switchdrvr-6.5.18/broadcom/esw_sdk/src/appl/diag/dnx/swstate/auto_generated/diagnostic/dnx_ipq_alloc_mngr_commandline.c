...
sh_sand_cmd_t sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_cmds[] = {
    ...
    {"is_fmq_allocated", NULL, sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_cmds, NULL, &dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_man},
...
sh_sand_cmd_t sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_cmds[] = {
    {"dump", sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_dump_cmd, NULL, dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_dump_options, &dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_dump_man},
    {"size_get", sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_cmd, NULL, dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_options, &dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_diagnostic_operation_counters_cmd, NULL, dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_diagnostic_operation_counters_options, &dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_man = {
    cmd_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_desc[] = "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated commands";


shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_dump(unit, filters));
...
sh_sand_option_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated dump []\n",
    "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated dump nocontent=false typefilter="" namefilter="" ",
};


shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    uint32 size = 0;
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~FMQ~IS_FMQ_ALLOCATED~", sizeof(((dnx_ipq_alloc_mngr_db_t*)sw_state_roots_array[unit][DNX_IPQ_ALLOC_MNGR_MODULE_ID])->fmq.is_fmq_allocated));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated size_get",
    "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated size_get",
};


shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{

    SHR_FUNC_INIT_VARS(unit);


    dnx_sw_state_diagnostic_operation_counters_print(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~FMQ~IS_FMQ_ALLOCATED~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated diagnostic_operation_counters",
    "dnx_ipq_alloc_mngr_db fmq is_fmq_allocated diagnostic_operation_counters",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_tc_voq_flow_map_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_alloc_mngr_db_tc_voq_flow_map_dump(unit, filters));
...
sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_tc_voq_flow_map_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_ipq_alloc_mngr_db tc_voq_flow_map dump []\n",
    "dnx_ipq_alloc_mngr_db tc_voq_flow_map dump nocontent=false typefilter="" namefilter="" ",
};
