...
CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         phymod_phy_ecc_intr_enable_get,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_interrupt_type_t, phymod_interrupt_type_t, ecc_error_intr, 0, 0,
                         uint32_t*, uint32_t, enable, 1, 0);

CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         phymod_phy_ecc_intr_enable_set,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_interrupt_type_t, phymod_interrupt_type_t, ecc_error_intr, 0, 0,
                         uint32_t, uint32_t, enable, 0, 0);
...
static cint_function_t __cint_functions[] =
{
    ...
    CINT_FWRAPPER_ENTRY(phymod_phy_ecc_intr_enable_get),
    CINT_FWRAPPER_ENTRY(phymod_phy_ecc_intr_enable_set),
