/*
 * $Id: tomahawk2_loadbalance.c Broadcom SDK $
 * $Copyright: (c) 2019 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    tomahawk2_loadbalance.c
...
char * techsupport_loadbalance_tomahawk2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "loadbalance" feature's software dump command list only for Tomahawk */
char * techsupport_loadbalance_tomahawk2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
...
static soc_mem_t techsupport_loadbalance_tomahawk2_memory_table_list[] = {
 ...
 * "loadbalance" feature for Tomahawk chipset. */
techsupport_reg_t techsupport_loadbalance_tomahawk2_reg_list[] = {
 ...
 * "loadbalance" feature for Tomahawk chipset. */
techsupport_data_t techsupport_loadbalance_tomahawk2_data = {
    techsupport_loadbalance_diag_cmdlist,
    techsupport_loadbalance_tomahawk2_reg_list,
    techsupport_loadbalance_tomahawk2_memory_table_list,
    techsupport_loadbalance_tomahawk2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_loadbalance_sw_dump_cmdlist,
    techsupport_loadbalance_tomahawk2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
