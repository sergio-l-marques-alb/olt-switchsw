...
static cint_parameter_desc_t __cint_sdk_typedefs[] = 
    {
        ...
        { "int", "xflowMacsecCryptoAes256GcmIntegrityOnly", 0, 0 },
        { "int", "xflowMacsecCryptoAes256Gcm", 0, 0 },
        { "int", "xflowMacsecCryptoAes256GcmXpnIntegrityOnly", 0, 0 },
        { "int", "xflowMacsecCryptoAes256GcmXpn", 0, 0 },
        ...
        { "int", "xflow_macsec_tag_validate_t", 0, 0 },
        { "uint32", "xflow_macsec_secure_chan_id_t", 0, 0 },
        ...
        { "uint32", "xflow_macsec_subport_id_t", 0, 0 },
        ...
        { "int", "xflow_macsec_flow_frame_type_t", 0, 0 },
        { "int", "xflow_macsec_secure_chan_vxlansec_hdr_t", 0, 0 },
        { "int", "xflow_macsec_secure_chan_vxlansec_pkt_type_t", 0, 0 },
#endif
#ifdef CPRIMOD_SUPPORT
...
#ifdef INCLUDE_XFLOW_MACSEC
static void*
__cint_maddr_xflow_macsec_port_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_port_info_t *s = (xflow_macsec_port_info_t*) p;

    switch(mnum)
        {
        case 0: rv = &(s->enable); break;
        case 1: rv = &(s->encrypt_port_offset); break;
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_port_info_t[] =
{
        { "uint8", "enable", 0, 0 },
        { "uint8", "encrypt_port_offset", 0, 0 },
        { "uint64", "value", 0, 0 },
        { NULL }
};
...
__cint_maddr_xflow_macsec_secure_chan_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 5: rv = &(s->vxlansec_hdr_update); break;
        case 6: rv = &(s->first_auth_range_offset_start); break;
        case 7: rv = &(s->first_auth_range_offset_end); break;
        case 8: rv = &(s->an_control); break;
        case 9: rv = &(s->tci); break;
        case 10: rv = &(s->sectag_offset); break;
        case 11: rv = &(s->mtu_sel); break;
        case 12: rv = &(s->mtu); break;
        case 13: rv = &(s->sectag_etype_sel); break;
        case 14: rv = &(s->dest_port); break;
        case 15: rv = &(s->vxlansec_pkt_type); break;
        case 16: rv = &(s->sci_mask); break;
        case 17: rv = &(s->replay_protect_window_size); break;
        case 18: rv = &(s->policy_id); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_secure_chan_info_t[] =
{
        ...
        { "uint32", "flags", 0, 0 },
        { "xflow_macsec_secure_chan_vxlansec_hdr_t", "vxlansec_hdr_update", 0, 0 },
        ...
        { "bcm_port_t", "dest_port", 0, 0 },
        { "xflow_macsec_secure_chan_vxlansec_pkt_type_t", "vxlansec_pkt_type", 0, 0 },
        { "uint64", "sci_mask", 0, 0 },
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_crypto_aes128_gcm_t[] =
{
 ...
 static void*
__cint_maddr_xflow_macsec_crypto_aes256_gcm_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_crypto_aes256_gcm_t *s = (xflow_macsec_crypto_aes256_gcm_t *) p;
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_crypto_aes256_gcm_t[] =
{
        { "uint8", "key", 0, 32 },
        { NULL }
};
...
__cint_maddr_xflow_macsec_secure_assoc_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
        ...
        case 8: rv = &(s->aes_256); break;
        case 9: rv = &(s->enable); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_secure_assoc_info_t[] =
{
        ...
        { "uint32", "ssci", 0, 0 },
        { "uint32", "flags", 0, 0 },
        { "xflow_macsec_crypto_aes256_gcm_t", "aes_256", 0, 0 },
        { "uint8", "enable", 0, 0 },
        { NULL }
};
...
__cint_maddr_xflow_macsec_policy_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
        ...
        case 1: rv = &(s->sci); break;
        case 2: rv = &(s->mtu_sel); break;
        case 3: rv = &(s->etype_sel); break;
        case 4: rv = &(s->mtu); break;
        case 5: rv = &(s->sectag_offset); break;
        case 6: rv = &(s->tag_validate); break;
        case 7: rv = &(s->inner_l2_offset); break;
        case 8: rv = &(s->port); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_policy_info_t[] =
{
        ...
        { "uint32", "mtu", 0, 0 },
        { "uint32", "sectag_offset", 0, 0 },
        { "xflow_macsec_tag_validate_t", "tag_validate", 0, 0 },
        { "uint32", "inner_l2_offset", 0, 0 },
        { "bcm_port_t", "port", 0, 0 },
        { NULL }
};
...
__cint_maddr_xflow_macsec_flow_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    {
        case 0: rv = &(s->flags); break;
        case 1: rv = &(s->policy_id); break;
        case 2: rv = &(s->set_management_pkt); break;
        case 3: rv = &(s->udf); break;
        case 4: rv = &(s->udf_mask); break;
        case 5: rv = &(s->pkt_type); break;
        case 6: rv = &(s->tpid); break;
        case 7: rv = &(s->tpid_mask); break;
        case 8: rv = &(s->vlan_mpls_tag_status); break;
        case 9: rv = &(s->etype_sel); break;
        case 10: rv = &(s->src_port); break;
        case 11: rv = &(s->src_port_mask); break;
        case 12: rv = &(s->src_mac); break;
        case 13: rv = &(s->src_mac_mask); break;
        case 14: rv = &(s->dst_mac); break;
        case 15: rv = &(s->dst_mac_mask); break;
        case 16: rv = &(s->vlan_tag_mpls_label_flags); break;
        case 17: rv = &(s->frame_type); break;
        case 18: rv = &(s->src_pbm); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_flow_info_t[] =
{
        ...
        { "uint32", "vlan_tag_mpls_label_flags", 0, 0 },
        { "xflow_macsec_flow_frame_type_t", "frame_type", 0, 0 },
        { "bcm_pbmp_t", "src_pbm", 0, 0 },
        { NULL }
};
...
__cint_maddr_xflow_macsec_flow_udf_param_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 5: rv = &(s->third_vlan); break;
        case 6: rv = &(s->third_vlan_priority); break;
        case 7: rv = &(s->fourth_vlan); break;
        case 8: rv = &(s->fourth_vlan_priority); break;
        case 9: rv = &(s->protocol_id); break;
        case 10: rv = &(s->sip_addr); break;
        case 11: rv = &(s->dip_addr); break;
        case 12: rv = &(s->source_port); break;
        case 13: rv = &(s->dest_port); break;
        case 14: rv = &(s->outer_src_mac); break;
        case 15: rv = &(s->outer_dst_mac); break;
        case 16: rv = &(s->inner_src_mac); break;
        case 17: rv = &(s->inner_dst_mac); break;
        case 18: rv = &(s->inner_first_vlan); break;
        case 19: rv = &(s->inner_first_vlan_priority); break;
        case 20: rv = &(s->inner_second_vlan); break;
        case 21: rv = &(s->inner_second_vlan_priority); break;
        case 22: rv = &(s->bbtag_vid_pcp); break;
        case 23: rv = &(s->itag_pcp_isid); break;
        case 24: rv = &(s->etag_tci); break;
        case 25: rv = &(s->first_mpls); break;
        case 26: rv = &(s->second_mpls); break;
        case 27: rv = &(s->third_mpls); break;
        case 28: rv = &(s->fourth_mpls); break;
        case 29: rv = &(s->payload); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_flow_udf_param_t[] =
{
    ...
    { "bcm_vlan_t", "third_vlan", 0, 0 },
    { "uint8", "third_vlan_priority", 0, 0 },
    { "bcm_vlan_t", "fourth_vlan", 0, 0 },
    { "uint8", "fourth_vlan_priority", 0, 0 },
    { "uint8", "protocol_id", 0, 0 },
    { "bcm_ipv4_ipv6_addr_t", "sip_addr", 0, 0 },
    { "bcm_ipv4_ipv6_addr_t", "dip_addr", 0, 0 },
    { "uint32", "source_port", 0, 0 },
    { "uint32", "dest_port", 0, 0 },
    { "bcm_mac_t", "outer_src_mac", 0, 0 },
    { "bcm_mac_t", "outer_dst_mac", 0, 0 },
    { "bcm_mac_t", "inner_src_mac", 0, 0 },
    { "bcm_mac_t", "inner_dst_mac", 0, 0 },
    { "bcm_vlan_t", "inner_first_vlan", 0, 0 },
    { "uint8", "inner_first_vlan_priority", 0, 0 },
    { "bcm_vlan_t", "inner_second_vlan", 0, 0 },
    { "uint8", "inner_second_vlan_priority", 0, 0 },
    { "uint8", "bbtag_vid_pcp", 0, 2 },
    { "uint8", "itag_pcp_isid", 0, 4 },
    { "uint8", "etag_tci", 0, 0 },
    { "xflow_macsec_flow_info_mpls_t", "first_mpls", 0, 0 },
    { "xflow_macsec_flow_info_mpls_t", "second_mpls", 0, 0 },
    { "xflow_macsec_flow_info_mpls_t", "third_mpls", 0, 0 },
    { "xflow_macsec_flow_info_mpls_t", "fourth_mpls", 0, 0 },
    { "uint8", "payload", 0, 64 },
    { NULL }
};
...
cint_struct_type_t __cint_sdk_structures[] = 
    {
...
#ifdef INCLUDE_XFLOW_MACSEC
        {
            ...
            sizeof(xflow_macsec_port_info_t),
            __cint_struct_members_xflow_macsec_port_info_t,
            __cint_maddr_xflow_macsec_port_info_t
        },
        {
        ...
        },
        {
            ...
            sizeof(xflow_macsec_crypto_aes256_gcm_t),
            __cint_struct_members_xflow_macsec_crypto_aes256_gcm_t,
            __cint_maddr_xflow_macsec_crypto_aes256_gcm_t
        },
        {
