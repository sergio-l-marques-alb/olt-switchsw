/*
 * $Id: trident2_mmu.c Broadcom SDK $
...
/* "mmu" feature's diag command list valid for Trident2 */
char * techsupport_mmu_trident2_diag_cmdlist[] = {
     NULL /* Must be the last element in this structure */
 };

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "MMU" feature's software dump command list valid for Trident2 */
char * techsupport_mmu_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
#endif /* BCM_SW_STATE_DUMP_DISABLE */

/* Structure that maintains memory list for
 * "mmu" feature for Trident2 chipset. */
static soc_mem_t techsupport_mmu_trident2_memory_table_list[] = {
    CPU_COS_MAPm,
    PORT_COS_MAPm,
    ...
    THDI_PORT_PG_CNTRS_SH1_Xm,
    THDI_PORT_PG_CNTRS_SH1_Ym,
    THDI_PORT_PG_CNTRS_SH2_Xm,
    THDI_PORT_PG_CNTRS_SH2_Ym,
    THDI_PORT_PG_CONFIG0_Xm,
    THDI_PORT_PG_CONFIG0_Ym,
    THDI_PORT_PG_CONFIG1_Xm,
    THDI_PORT_PG_CONFIG1_Ym,
    THDI_PORT_PG_CONFIG2_Xm,
    THDI_PORT_PG_CONFIG2_Ym,
    THDI_PORT_PG_CONFIG_Xm,
    THDI_PORT_PG_CONFIG_Ym,
    THDI_PORT_SP_CNTRS_RT_Xm,
    THDI_PORT_SP_CNTRS_RT_Ym,
    THDI_PORT_SP_CNTRS_SH_Xm,
    THDI_PORT_SP_CNTRS_SH_Ym,
    THDI_PORT_SP_CONFIG0_Xm,
    THDI_PORT_SP_CONFIG0_Ym,
    THDI_PORT_SP_CONFIG1_Xm,
    THDI_PORT_SP_CONFIG1_Ym,
    THDI_PORT_SP_CONFIG2_Xm,
    THDI_PORT_SP_CONFIG2_Ym,
 ...
 * "mmu" feature for Trident2 chipset. */
techsupport_reg_t techsupport_mmu_trident2_reg_list[] = {
    ...
    {INTFO_CONGST_STr, register_type_global},
    {PORT_PFC_CFG3r, register_type_global},
    {PRIORITY_CONTROLr, register_type_global},
    {CMAC_PFC_CTRLr, register_type_global},
    {CMAC_PFC_DAr, register_type_global},
    {CMAC_PFC_OPCODEr, register_type_global},
    {CMAC_PFC_TYPEr, register_type_global},
    {INVALIDr, register_type_global } /* Must be the last element in this structure */
};

/* Structure that maintains  diag cmdlist, reg_list, mem_list  for
 * "mmu" feature for Trident2 chipset. */
techsupport_data_t techsupport_mmu_trident2_data = {
    techsupport_mmu_diag_cmdlist,
    techsupport_mmu_trident2_reg_list,
    techsupport_mmu_trident2_memory_table_list,
    techsupport_mmu_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_mmu_sw_dump_cmdlist,
   techsupport_mmu_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
