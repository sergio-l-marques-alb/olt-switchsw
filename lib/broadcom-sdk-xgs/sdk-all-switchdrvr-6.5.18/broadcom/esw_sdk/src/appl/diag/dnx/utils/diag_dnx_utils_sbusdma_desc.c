...
sh_sand_cmd_t sh_dnx_utils_sbusdma_desc_cmds[] = {
    ...
    *               *                           * CMD                     *                                *                            *
    *************************************************************************************************************************************/
    {"ENAble", cmd_sbusdma_desc_enable_set, NULL, dnx_sbusdma_desc_enable_options, &dnx_sbusdma_desc_enable_man}
    ,
    {"STATS", cmd_sbusdma_desc_stats_print, NULL, dnx_sbusdma_desc_stats_options, &dnx_sbusdma_desc_stats_man}
    ,
    {NULL}
};
