    ...
    int *estimated_nof_entries)
{
    ...
    if (table->access_method == DBAL_ACCESS_METHOD_KBP)
    {
        ...
        sal_strncpy_s(table_name, table->table_name, sizeof(table_name));

        SHR_IF_ERR_EXIT(kbp_mngr_db_id_by_name_get(unit, table_name, &db_id));
    ...
    else if (DBAL_TABLE_IS_NONE_DIRECT(table))
    {
        ...
        {
            SHR_IF_ERR_EXIT(mdb_get_capacity_estimate(unit, table->physical_db_id[0], table->key_size,
                                                      table->multi_res_info[result_type].entry_payload_size,
...
static sh_sand_option_t diag_dbal_table_indication_options[] = {
    {"TaBLe", SAL_FIELD_TYPE_STR, "dbal table name", ""},
    {"INDiCation", SAL_FIELD_TYPE_ENUM, "the table inidcation to update", "EMPTY",
     (void *) sand_dbal_table_indications_enum_table},
    {"Value", SAL_FIELD_TYPE_BOOL, "the value related to the inidcation to update", "false"},
    {NULL}
};
...
sh_sand_cmd_t diag_dbal_table_cmds[] = {
   ...
   **********************************************************************************************************/
    ...
    {"INDication", diag_dbal_table_indication, NULL, diag_dbal_table_indication_options,
     &diag_dbal_table_indication_man},
    {NULL}
};
