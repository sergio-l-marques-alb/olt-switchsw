    ...
    dbal_tables_e table_id)
{
    switch (table_id)
    {
        ...
        case DBAL_TABLE_LIF_TABLE_MANAGER_VALID_FIELDS_PER_SBC_IN_LIF_TABLE:
        case DBAL_TABLE_LIF_TABLE_MANAGER_VALID_FIELDS_PER_DPC_IN_LIF_TABLE:
            return 1;
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (print_type == DBAL_FIELD_PRINT_TYPE_STRUCT)
    {
    ...
    sh_sand_control_t * sand_control)
{
    ...
    PRT_TITLE_SET("HW elements in DBAL Group %s", group_name);
