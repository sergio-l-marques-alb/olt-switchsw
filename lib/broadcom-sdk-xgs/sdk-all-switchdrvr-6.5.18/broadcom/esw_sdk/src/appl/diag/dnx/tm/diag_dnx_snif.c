                ...
                DNXCMN_CORES_ITER(unit, core, core_id)
                {
                        ...
                        && (cmd_id < (int) dnx_data_snif.egress.mirror_snoop_nof_profiles_get(unit)))
                    {
                        ...
                        if (type == DNX_SNIF_TYPE_SNOOP)
                        {
                             ...
                             */
                            dbal_entry_key_field32_set(unit, entry_handle_id_snoop_str, DBAL_FIELD_SNIF_COMMAND_ID,
                                                       cmd_id);
                            dbal_value_field32_request(unit, entry_handle_id_snoop_str, DBAL_FIELD_STRENGTH,
