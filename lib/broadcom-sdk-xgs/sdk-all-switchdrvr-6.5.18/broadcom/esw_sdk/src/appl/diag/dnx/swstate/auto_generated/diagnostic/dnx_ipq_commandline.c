...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_db_base_queues_dump(unit, base_queues_idx_0, filters));
...
sh_sand_man_t dnx_swstate_dnx_ipq_base_queues_dump_man = {
    ...
    "dnx_ipq_db base_queues dump base_queues_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
sh_sand_man_t dnx_swstate_dnx_ipq_base_queues_num_cos_dump_man = {
    ...
    "dnx_ipq_db base_queues num_cos dump base_queues_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_num_cos_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_db_info[unit], dnx_ipq_db_layout_str, DNX_IPQ_DB_INFO_NOF_ENTRIES, "DNX_IPQ_DB~BASE_QUEUES~NUM_COS~", sizeof(((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues[0].num_cos));
    dnx_sw_state_size_print(size);
...
sh_sand_man_t dnx_swstate_dnx_ipq_base_queues_sys_port_ref_counter_dump_man = {
    ...
    "dnx_ipq_db base_queues sys_port_ref_counter dump base_queues_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_sys_port_ref_counter_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_db_info[unit], dnx_ipq_db_layout_str, DNX_IPQ_DB_INFO_NOF_ENTRIES, "DNX_IPQ_DB~BASE_QUEUES~SYS_PORT_REF_COUNTER~", sizeof(((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues[0].sys_port_ref_counter));
    dnx_sw_state_size_print(size);
