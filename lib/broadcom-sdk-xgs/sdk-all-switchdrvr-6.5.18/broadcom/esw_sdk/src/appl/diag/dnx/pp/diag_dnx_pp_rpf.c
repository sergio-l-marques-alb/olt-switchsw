    ...
    bcm_instru_vis_signal_result_t * signal_result_stack)
{
    ...
    bcm_instru_vis_signal_key_t signal_key_stack[5];
    ...
    sh_sand_control_t * sand_control)
{
    ...
    bcm_instru_vis_signal_result_t signal_result_stack[5];
    ...
    for (hier_id = 0; hier_id < nof_hierarchies; hier_id++)
    {
        ...
        if (is_allocated == 1)
        {
            SHR_IF_ERR_EXIT(algo_l3_fec_hierarchy_stage_map_get(unit, BCM_L3_ITF_VAL_GET(rpf_destination), &hierarchy));
