...
sh_sand_cmd_t dnx_diag_flexe_group_cmds[] = {
     ...
     */
    {"CReate",    dnx_diag_flexe_group_create_cmd,      NULL, dnx_diag_flexe_group_create_options,     &dnx_diag_flexe_group_create_man},
    {"Add",       dnx_diag_flexe_group_add_phy_cmd,     NULL, dnx_diag_flexe_group_add_phy_options,    &dnx_diag_flexe_group_add_phy_man},
    {"ReMoVe",    dnx_diag_flexe_group_remove_phy_cmd,  NULL, dnx_diag_flexe_group_remove_phy_options, &dnx_diag_flexe_group_remove_phy_man},
    {"CaLenDAR",  dnx_diag_flexe_group_calendar_cmd,    NULL, dnx_diag_flexe_group_calendar_options,   &dnx_diag_flexe_group_calendar_man},
    {"DuMP",      dnx_diag_flexe_group_dump_cmd,        NULL, dnx_diag_flexe_group_dump_options,       &dnx_diag_flexe_group_dump_man},
    {"DeSTRoY",   dnx_diag_flexe_group_destroy_cmd,     NULL, dnx_diag_flexe_group_destroy_options,    &dnx_diag_flexe_group_destroy_man},
    {NULL}
};
...
sh_sand_cmd_t dnx_diag_flexe_client_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage 
     */
    {"Add",    dnx_diag_flexe_client_add_cmd,    NULL, dnx_diag_flexe_client_add_options,      &dnx_diag_flexe_client_add_man},
    {"Set",    dnx_diag_flexe_client_set_cmd,    NULL, dnx_diag_flexe_client_timeslot_options, &dnx_diag_flexe_client_timeslot_man},
    {"DuMP",   dnx_diag_flexe_client_dump_cmd,   NULL, dnx_diag_flexe_client_dump_options,     &dnx_diag_flexe_client_dump_man},
    {"DeLeTe", dnx_diag_flexe_client_delete_cmd, NULL, dnx_diag_flexe_client_delete_options,   &dnx_diag_flexe_client_delete_man},
    {NULL}
};
...
sh_sand_cmd_t dnx_diag_flexe_flow_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage 
     */
    {"Add",   dnx_diag_flexe_flow_add_cmd,    NULL, dnx_diag_flexe_flow_add_options,   &dnx_diag_flexe_flow_add_man},
    {"DuMP",  dnx_diag_flexe_flow_dump_cmd,   NULL, dnx_diag_flexe_flow_dump_options,  &dnx_diag_flexe_flow_dump_man},
    {"CLear", dnx_diag_flexe_flow_clear_cmd,  NULL, dnx_diag_flexe_flow_clear_options, &dnx_diag_flexe_flow_clear_man},
    {NULL}
};
...
sh_sand_cmd_t dnx_diag_flexe_overhead_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage 
     */
    {"Set",  dnx_diag_flexe_overhead_set_cmd,  NULL, dnx_diag_flexe_overhead_set_options,  &dnx_diag_flexe_overhead_set_man},
    {"DuMP", dnx_diag_flexe_overhead_dump_cmd, NULL, dnx_diag_flexe_overhead_dump_options, &dnx_diag_flexe_overhead_dump_man},
    {NULL}
};
...
sh_sand_cmd_t dnx_diag_flexe_core_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage 
     */
    {"DeBuG",  dnx_diag_flexe_core_debug_cmd,  NULL, dnx_diag_flexe_core_debug_options, &dnx_diag_flexe_core_debug_man},
    {"read",   dnx_diag_flexe_core_read_cmd,   NULL, dnx_diag_flexe_core_read_options,  &dnx_diag_flexe_core_read_man},
    {"write",  dnx_diag_flexe_core_write_cmd,  NULL, dnx_diag_flexe_core_write_options, &dnx_diag_flexe_core_write_man},
    {"Dump",   dnx_diag_flexe_core_dump_cmd,   NULL, dnx_diag_flexe_core_dump_options,  &dnx_diag_flexe_core_dump_man},
    {"LIST",   dnx_diag_flexe_core_list_cmd,   NULL, dnx_diag_flexe_core_list_options,  &dnx_diag_flexe_core_list_man},
    {"TeST",   dnx_diag_flexe_core_test_cmd,   NULL, dnx_diag_flexe_core_test_options,  &dnx_diag_flexe_core_test_man},
    ...
    sh_sand_control_t * sand_control)
{
    ...
    flexe_acc_mode = diag_flexe_reg_mem_access_mode_get();
    flexe_driver = dnx_data_dev_init.general.flexe_core_drv_select_get(unit);
    PRT_TITLE_SET("FlexE mode=%s, reg/ram access mode=%d, driver: %s", str_flexe_mode[flexe_mode],
                   flexe_acc_mode, flexe_driver? "STD" : "DBG");
    ...
    sh_sand_control_t * sand_control)
{
    ...
    */
    ...
    /* coverity[ptr_arith:FALSE] */
    SHR_BIT_ITER(&grp_active_bmp, FLEXE_CORE_NOF_PORTS, group)
    {
                ...
                for(instance=0; instance<FLEXE_CORE_NOF_INSTANCES; ++instance)
                {
                    ...
                    if (SHR_BITGET(&grp_instances, instance))
                    {
                        ...
                        case 2:
                            ...
                            */
                            /* coverity[ptr_arith:FALSE] */
                            FLEXE_RX_LF_SEL_GET(&lf_sel, instance, &val);
                        ...
                        case 3:
                            ...
                            */
                            /* coverity[ptr_arith:FALSE] */
                            FLEXE_DEMUX_GROUP_INFO_GET(&flexegroup_info, instance, &min_instance);
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (lphy=0; lphy<FLEXE_CORE_NOF_LPHYS; ++lphy)
    {
        ...
        if (reorder_sel < FLEXE_CORE_NOF_INSTANCES)
        {
            PRT_CELL_SET("%d.0", reorder_sel);
        }
        else if (reorder_sel < (FLEXE_CORE_NOF_INSTANCES << 1))
        {
            PRT_CELL_SET("%d.1", reorder_sel-FLEXE_CORE_NOF_INSTANCES);
        }
        else
        {
            PRT_CELL_SET("");
    ...
    {
        /* coverity[incompatible_cast:FALSE] */
        FLEXE_DEMUX_GROUP_CFG_GET(&group_cfg, lphy, &min_lphy);

        if (min_lphy < FLEXE_CORE_NOF_LPHYS)
        {
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (ii=0; ii<COUNTOF(row_desc); ++ii)
    {
        ...
        for (lphy=0; lphy<FLEXE_CORE_NOF_LPHYS; ++lphy)
        {
            ...
            case 1:
                /* coverity[ptr_arith:FALSE] */
                FLEXE_MUX_MODE_GET(&flexe_mode, lphy, &val);
                PRT_CELL_SET("%d", val);
                break;
            case 2:
                /* coverity[ptr_arith:FALSE] */
                ...
                if (val == FLEXE_MUX_MODE_100G_2ND_PHY)
                {
                    val = 0;

                    for (jj=0; jj<FLEXE_CORE_NOF_LPHYS; ++jj)
                    {
                        /* coverity[ptr_arith:FALSE] */
                        FLEXE_MUX_CPHY2_CFG_GET(&cphy2_cfg, jj, &val);
            ...
            case 3:
                /* coverity[ptr_arith:FALSE] */
                FLEXE_MUX_EN_SEL_CFG(&en_sel_cfg, lphy, &val);
                PRT_CELL_SET("%d", val);
                break;
            case 4:
                /* coverity[ptr_arith:FALSE] */
                FLEXE_MUX_GROUP_CFG_GET(&flexe_group_cfg, lphy, &val);
                PRT_CELL_SET("%d", val);
                break;
            default:
                break;
    ...
    {
        /* coverity[ptr_arith:FALSE] */
        FLEXE_MUX_INST_SEL_CFG_GET(&inst_sel_cfg, ii, &val);
        PRT_CELL_SET("%d", val);
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    {
        /* coverity[ptr_arith:FALSE] */
        FLEXE_RX_MAP_TABLE_GET(&reg_val, ii, (SHR_BITDCL *) & val);

        if (val != FLEXE_INVALID_PORT_ID)
        {
            PRT_CELL_SET("%d", val);
        }
        else
    ...
    for (ii=0; ii<FLEXE_CORE_NOF_LPHYS/2; ++ii)
    {
        /* coverity[ptr_arith:FALSE] */
    ...
    {
        /* coverity[ptr_arith:FALSE] */
        FLEXE_TX_MAP_TABLE_GET(&reg_val, ii, (SHR_BITDCL *) & val);
...
sh_sand_cmd_t dnx_diag_flexe_dump_oh_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage
     */
    {"INFo",   dnx_diag_flexe_dump_oh_info_cmd,   NULL, dnx_diag_flexe_dump_oh_info_options,   &dnx_diag_flexe_dump_oh_info_man},
    {"ALarM",  dnx_diag_flexe_dump_oh_alm_cmd,    NULL, dnx_diag_flexe_dump_oh_alm_options,    &dnx_diag_flexe_dump_oh_alm_man},
    {"PhyMaP", dnx_diag_flexe_dump_oh_phymap_cmd, NULL, dnx_diag_flexe_dump_oh_phymap_options, &dnx_diag_flexe_dump_oh_phymap_man},
    ...
    sh_sand_control_t * sand_control)
{
    ...
    uint32 chproperty = 0;
    uint32 timeslots[FLEXE_CORE_NOF_SUBCALS] = { 0 };
    int ram_addr[FLEXE_CORE_NOF_SUBCALS];
    uint32 rownum;
    ...
    for (calendar_sel=FLEXE_DRV_CALENDAR_SEL_A; calendar_sel<FLEXE_DRV_CALENDAR_COUNT; ++calendar_sel)
    {
        cli_out("Calendar %d:\n\n", calendar_sel);
        ...
        for(ii=0; ii<FLEXE_CORE_NOF_TIMESLOTS; ++ii)
        {
            /*
             * Configure calendar, map timeslot to channel
             */
            FLEXE_DEMUX_CALENDAR_CFG_GET(calendar_cfg, ii, &val);
        ...
        FLEXE_DEMUX_CHANNEL_OWN_TSGROUP_GET(own_tsgroup, channel, &channel_own_tsgroup);
        ...
        SHR_BIT_ITER(tsmap, FLEXE_CORE_NOF_TIMESLOTS, ii)
        {
            PRT_CELL_SET("%d", ii);
        }
        ...
        if ((tsnum >= FLEXE_CORE_NOF_TIMESLOTS)
            || (blk_cnt >= FLEXE_CORE_NOF_SUBCALS)
            || (cycle_cnt >= FLEXE_CORE_NOF_TIMESLOTS))
        {
            continue;
        }
        ...
        for (ii=0; ii<FLEXE_CORE_NOF_SUBCALS; ++ii)
        {
            PRT_COLUMN_ADD("%d", ii);
        }
        ...
        for (blk = 0; blk <= blk_cnt; ++blk)
        {
            for (cycle = 0; cycle <= cycle_cnt; ++cycle)
            {
                ...
                SHR_IF_ERR_EXIT(soc_custom_mem_array_read(unit,
                                                           ...
                                                           0,
                                                           FSCL_BLOCK(unit),
                                                           channel * FLEXE_CORE_NOF_TIMESLOTS + blk * (cycle_cnt+1) + cycle,
                                                           rdrule));
                ...
                for (col = 0; col < FLEXE_CORE_NOF_SUBCALS; ++col)
                {
                    ...
                    /* coverity[ptr_arith:FALSE] */
                    FLEXE_DEMUX_RDRULE_GET(rdrule, rownum, &timeslot_plus_1);
                    ...
                    */
                    ...
                    SHR_IF_ERR_EXIT(soc_custom_mem_array_read(unit,
                                                               wcfgram_mem,
                                                               FLEXE_DEMUX_TS_TO_WR_TBL_ID(timeslots[col]),
                                                               FSCL_BLOCK(unit),
                                                               FLEXE_DEMUX_TS_TO_WR_TBL_INDEX_BASE(timeslots[col]) +
                                                               subcal, &rownum));
...
dnx_diag_flexe_dump_channel_mux_cmd(
    ...
    sh_sand_control_t * sand_control)
{
    SHR_BITDCL hw_tsmap_msi[_SHR_BITDCLSIZE(FLEXE_CORE_NOF_TIMESLOTS)];
    SHR_BITDCL tsmap_msi[_SHR_BITDCLSIZE(FLEXE_CORE_NOF_TIMESLOTS)];
    uint32 timeslots[FLEXE_CORE_NOF_SUBCALS];
    int ram_addr[FLEXE_CORE_NOF_SUBCALS];
    ...
    for (calendar_sel=FLEXE_DRV_CALENDAR_SEL_A; calendar_sel<FLEXE_DRV_CALENDAR_COUNT; ++calendar_sel)
    {
        ...
        SHR_BITCLR_RANGE(hw_tsmap_msi, 0, FLEXE_CORE_NOF_TIMESLOTS);
        SHR_BITCLR_RANGE(tsmap_msi, 0, FLEXE_CORE_NOF_TIMESLOTS);
        ...
        for (ii=0; ii<FLEXE_CORE_NOF_TIMESLOTS; ++ii)
        {
             ...
             */
            FLEXE_OP_A_OR_B(calendar_sel, READ_FSCL_FLEXE_MSI_CFGr, READ_FSCL_FLEXE_MSI_CFG_Br, unit, ii % 20,
                            &msi_cfg);
            FLEXE_MUX_MSI_CFG_GET(&msi_cfg, ii, (SHR_BITDCL *) & val);
        ...
        SHR_BIT_ITER(hw_tsmap_msi, FLEXE_CORE_NOF_TIMESLOTS, ts)
        {
            /*
        ...
        is_100g = (mux_mode == FLEXE_MUX_MODE_50G) ? 0 : 1;

        SHR_BIT_ITER(hw_tsmap_msi, FLEXE_CORE_NOF_TIMESLOTS, ii)
        {
            ts = soc_flexe_mux_timeslot_convert(ii, is_100g);
        ...
        lphy = 0;
        FLEXE_MUX_CHANNEL_BELONG_FLEXE_GET(reg_val_above_64, channel, &lphy);
        ...
        SHR_BIT_ITER(tsmap_msi, FLEXE_CORE_NOF_TIMESLOTS, ts)
        {
            PRT_CELL_SET("%d", ts);
        }
        ...
        SHR_BIT_ITER(tsmap_msi, FLEXE_CORE_NOF_TIMESLOTS, ii)
        {
            ts = soc_flexe_mux_timeslot_convert(ii, is_100g);
        ...
        FLEXE_MUX_TSNUM_CFG_GET(&reg_val, channel, (SHR_BITDCL *) & val);
        ...
        FLEXE_MUX_CYCLE_CFG_GET(&reg_val, channel, (SHR_BITDCL *) & cycle_cnt);
        ...
        FLEXE_MUX_BLK_CFG_GET(reg_val_above_64, channel, (SHR_BITDCL *) & blk_cnt);
        ...
        for (blk = 0; blk <= blk_cnt; ++blk)
        {
            for (cycle = 0; cycle <= cycle_cnt; ++cycle)
            {
                ...
                for (col = 0; col < FLEXE_CORE_NOF_SUBCALS; ++col)
                {
                    ...
                    FLEXE_DEMUX_RDRULE_GET(wr_cfg, rownum, &timeslots[col]);
                ...
                for (col = 0; col < FLEXE_CORE_NOF_SUBCALS; ++col)
                {
                    PRT_CELL_SET("%d", soc_flexe_mux_timeslot_convert(timeslots[col], is_100g));
                }
...
sh_sand_cmd_t dnx_diag_flexe_dump_channel_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage
     */
    {"ALarM",    dnx_diag_flexe_dump_channel_alm_cmd,      NULL, dnx_diag_flexe_dump_channel_alm_options,     &dnx_diag_flexe_dump_channel_alm_man},
    {"COUnter",  dnx_diag_flexe_dump_channel_counter_cmd,  NULL, dnx_diag_flexe_dump_channel_counter_options, &dnx_diag_flexe_dump_channel_counter_man},
    {"DeMuX",    dnx_diag_flexe_dump_channel_demux_cmd,    NULL, dnx_diag_flexe_dump_channel_demux_options,   &dnx_diag_flexe_dump_channel_demux_man},
    {"MUX",      dnx_diag_flexe_dump_channel_mux_cmd,      NULL, dnx_diag_flexe_dump_channel_mux_options,     &dnx_diag_flexe_dump_channel_mux_man},
    ...
    sh_sand_control_t * sand_control)
{
    ...
    int nof_channels[] = {FLEXE_CORE_NOF_CHANNELS, FLEXE_SAR_NOF_TIMESLOTS, FLEXE_CORE_MAX_NOF_CHANNELS};
    int channel_end[] =
        {
            FLEXE_CORE_NOF_CHANNELS,
            FLEXE_CORE_NOF_CHANNELS+FLEXE_SAR_NOF_TIMESLOTS,
            FLEXE_CORE_NOF_CHANNELS+FLEXE_SAR_NOF_TIMESLOTS+FLEXE_CORE_MAX_NOF_CHANNELS
        };
    ...
    for (table=0; table<COUNTOF(titles); ++table)
    {
        ...
        for (row=0; row<nof_channels[table]; ++row)
        {
            ...
            if (data != 0xFFFFFF)
            {
                ...
                for (ii=0; ii<FLEXE_66BSWITCH_NOF_SUBSYS; ++ii)
                {
                    for (jj=0; jj<FLEXE_66BSWITCH_NOF_SUBSYS; ++jj)
                    {
                        /* coverity[ptr_arith:FALSE] */
                    ...
                    if (jj >= FLEXE_66BSWITCH_NOF_SUBSYS)
                    {
                        PRT_CELL_SET("");
                    }
                }
...
sh_sand_cmd_t dnx_diag_flexe_dump_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage
     */
    {"GRouP",    dnx_diag_flexe_dump_group_cmd,      NULL, dnx_diag_flexe_dump_group_options,     &dnx_diag_flexe_dump_group_man},
    {"DeMuX",    dnx_diag_flexe_dump_demux_cmd,      NULL, dnx_diag_flexe_dump_demux_options,     &dnx_diag_flexe_dump_demux_man},
    {"MUX",      dnx_diag_flexe_dump_mux_cmd,        NULL, dnx_diag_flexe_dump_mux_options,       &dnx_diag_flexe_dump_mux_man},
    {"Port",     dnx_diag_flexe_dump_port_cmd,       NULL, dnx_diag_flexe_dump_port_options,      &dnx_diag_flexe_dump_port_man},
    {"OverHead", NULL,    dnx_diag_flexe_dump_oh_cmds,          NULL,                             &dnx_diag_flexe_dump_oh_man},
    {"CHaNnel",  NULL,    dnx_diag_flexe_dump_channel_cmds,     NULL,                             &dnx_diag_flexe_dump_channel_man},
    {"SW",       dnx_diag_flexe_dump_sw_cmd,         NULL, dnx_diag_flexe_dump_sw_options,        &dnx_diag_flexe_dump_sw_man},
...
sh_sand_cmd_t sh_dnx_diag_flexe_cmds[] = {
     ...
     * Name | Leaf Action | Junction Array | Options for Leaf | Usage 
     */
    {"INFo",     dnx_diag_flexe_info_cmd,    NULL, dnx_diag_flexe_info_options,  &dnx_diag_flexe_info_man},
    {"counter",  dnx_diag_flexe_counter_cmd, NULL, dnx_diag_flexe_counter_options, &dnx_diag_flexe_counter_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_enable},
    {"GRouP",    NULL, dnx_diag_flexe_group_cmds,     NULL, &dnx_diag_flexe_group_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_enable},
    {"CLIENT",   NULL, dnx_diag_flexe_client_cmds,    NULL, &dnx_diag_flexe_client_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_enable},
    {"FLOW",     NULL, dnx_diag_flexe_flow_cmds,      NULL, &dnx_diag_flexe_flow_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_enable},
    {"OverHead", NULL, dnx_diag_flexe_overhead_cmds,  NULL, &dnx_diag_flexe_overhead_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_enable},
    {"CORE",     NULL, dnx_diag_flexe_core_cmds,      NULL, &dnx_diag_flexe_core_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_core_available},
    {"DuMP",     NULL, dnx_diag_flexe_dump_cmds,      NULL, &dnx_diag_flexe_dump_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_cmd_is_flexe_enable},
