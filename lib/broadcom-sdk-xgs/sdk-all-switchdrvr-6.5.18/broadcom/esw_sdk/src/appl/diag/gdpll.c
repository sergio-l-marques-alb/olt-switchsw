...
void dump_chan_param(bcm_gdpll_chan_t *pGdpllChan)
{
    ...
    cli_out("phase_error_thres0  : %d\n",pGdpllChan->chan_dpll_config.phase_error_thres0);
    cli_out("phase_error_thres1  : %d\n",pGdpllChan->chan_dpll_config.phase_error_thres1);
    cli_out("holdover_filter_coeff    : %d\n",pGdpllChan->chan_dpll_config.holdover_filter_coeff);
