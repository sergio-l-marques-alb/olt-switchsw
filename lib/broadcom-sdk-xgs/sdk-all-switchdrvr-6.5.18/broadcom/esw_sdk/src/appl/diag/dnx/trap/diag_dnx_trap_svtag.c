    ...
    int unit)
{
    ...
    int err_code = 0xAA, err_code_profile = 3;
    int trap_id;
    ...
    svtag_trap_key.pkt_type = bcmbcmSvtagPktTypeNonKayMgmt;
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (flag_idx = 0; flag_idx < 2; flag_idx++)
    {
        ...
        for (pkt_type_idx = 0; pkt_type_idx <= bcmbcmSvtagPktTypeKayMgmt; pkt_type_idx++)
        {
