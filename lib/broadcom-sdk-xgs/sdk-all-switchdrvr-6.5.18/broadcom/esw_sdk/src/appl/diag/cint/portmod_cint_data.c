...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    CINT_FWRAPPER_ENTRY(portmod_cpri_port_interrupt_process),
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    CINT_FWRAPPER_ENTRY(portmod_cpri_port_ecc_interrupt_status_get),
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
...
static int
__cint_fpointer__portmod_ilkn_port_fec_units_set_callback_f(int unit, int port, int fec_enable, int fec_bypass_valid, int fec_bypass_enable)
{
    int returnval;

    cint_interpreter_callback(__cint_function_pointers+2, 5, 1, &unit, &port, &fec_enable, &fec_bypass_valid, &fec_bypass_enable, &returnval);
    return returnval;
}
...
__cint_maddr__portmod_ilkn_os_create_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 6: rv = &(s->ilkn_port_lane_map_get);break;
        case 7: rv = &(s->ilkn_pm_lane_map_get);break;
        case 8: rv = &(s->ilkn_port_fec_units_set);break;
        case 9: rv = &(s->ilkn_block_index);break;
        case 10: rv = &(s->fec_disable_by_bypass);break;
        default: rv = NULL; break;
    }
    return rv;
}
