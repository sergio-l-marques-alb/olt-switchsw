...
static sh_sand_cmd_t sh_dnx_commands[] = {
  /* Name         | Leaf Action          | Junction Array Pointer | Options for Leaf         | Usage */
...
#endif
    {"AllocationManager", NULL,            sh_dnx_allocation_mngr_cmds,       NULL,            &sh_dnx_allocation_mngr_man , NULL, NULL, CTEST_PRECOMMIT},
    ...
    {"FLexE",       NULL,                  sh_dnx_diag_flexe_cmds,  NULL,                      &sh_dnx_diag_flexe_man  , NULL, NULL, CTEST_POSTCOMMIT|SH_CMD_CONDITIONAL, sh_cmd_is_flexe_available},
    ...
    {"mdb",         NULL,                  sh_dnx_mdb_cmds,         NULL,                      &sh_dnx_mdb_man         , NULL, NULL, CTEST_PRECOMMIT | SH_CMD_NO_XML_VERIFY},
    ...
    {"warmboot",    NULL,                  sh_dnxc_warmboot_cmds,   NULL,                      &sh_dnxc_warmboot_man   , NULL, NULL, CTEST_PRECOMMIT, NULL, NULL, NULL, "", NULL, NULL, "FL_WARMBOOT"},
#endif
#ifdef INCLUDE_CTEST
