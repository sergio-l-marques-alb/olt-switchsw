    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (qual_action_iter = 0; qual_action_iter < max_num_qual_actions; qual_action_iter++)
    {
        ...
        else
        {
            ...
            {
                /**
                 * Skip 4 cells (Qualifier, Size, Qual Ranged, Qual Size on Key) about qualifier info if no more valid qualifiers were found,
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(kbp_mngr_db_id_by_name_get(unit, dbal_logical_table_to_string(unit, dbal_table_id), &db_id));
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (DIAG_DNX_FIELD_GROUP_NOF_CORES == 1)
    {
        bank_ids_string[0][sal_strlen(bank_ids_string[0]) - 2] = '\0';
        PRT_CELL_SET("core_0: %s\ncore_1: N/A", bank_ids_string[0]);
    }
    else
    {
        bank_ids_string[0][sal_strlen(bank_ids_string[0]) - 2] = '\0';
        bank_ids_string[1][sal_strlen(bank_ids_string[1]) - 2] = '\0';
