/*
 * $Id: trident2_cos.c Broadcom SDK $
...
/* "cos" feature's diag command list valid only for Trident2 */
char * techsupport_cos_trident2_diag_cmdlist[] = {
     "lls",
     "hsp",
...
/* "cos" feature's software dump command list valid only for Trident2 */
char * techsupport_cos_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "cos" feature for Trident2 chipset. */
static soc_mem_t techsupport_cos_trident2_memory_table_list[] = {
    CPU_TS_MAPm,
 ...
 * "cos" feature for Trident2 chipset. */
techsupport_reg_t techsupport_cos_trident2_reg_list[] = {
 ...
 * "cos" feature for Trident2 chipset. */
techsupport_data_t techsupport_cos_trident2_data = {
    techsupport_cos_diag_cmdlist,
    techsupport_cos_trident2_reg_list,
    techsupport_cos_trident2_memory_table_list,
    techsupport_cos_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_cos_sw_dump_cmdlist,
    techsupport_cos_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
