/** \file appl_ref_eedb_access_wa_init.c
 * $Id$
 *
...
static shr_error_e
dnx_eedb_access_wa_build_packet(
    int unit,
    uint32 in_port_0,
    uint32 in_port_1,
    uint32 dest_port,
    ...
    int unit)
{
     ...
     */
    SHR_IF_ERR_EXIT(mdb_db_infos.eedb_bank_traffic_lock_workaround.global_lif_destination.get(unit, 0, &out_lif_0));
    SHR_IF_ERR_EXIT(mdb_db_infos.eedb_bank_traffic_lock_workaround.global_lif_destination.get(unit, 1, &out_lif_1));
    ...
    SHR_IF_ERR_EXIT(dnx_eedb_access_wa_build_packet(unit, port_core_0, port_core_1, port_core_0,
...
/** see appl_ref_eedb_access_wa_init.h*/
shr_error_e
appl_dnx_eedb_access_wa_cb(
    int unit,
    int *dynamic_flags)
{
