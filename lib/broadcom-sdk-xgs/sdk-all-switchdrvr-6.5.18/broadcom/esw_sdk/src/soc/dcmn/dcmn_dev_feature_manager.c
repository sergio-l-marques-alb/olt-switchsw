...
dcmn_feature_cb_t  one_ext_ram_feature_range[] = {
    {
        ...
        dcmn_range_cb,  /*  cb function*/
        sizeof(range_0_1)/sizeof(dcmn_range_t), /*num of ranges*/
        range_0_1
    },
    {
        DCMN_INVALID_FEATURE,
...
dcmn_feature_cb_t  core_freq_325_feature_range[] = {
    {
        ...
        dcmn_range_cb,  /*  cb function*/
        sizeof(range_0_325000)/sizeof(dcmn_range_t), /*num of ranges*/
        range_0_325000
    },
    {
        DCMN_INVALID_FEATURE,
...
dcmn_feature_cb_t  core_freq_175_feature_range[] = {
    {
        ...
        dcmn_range_cb,  /*  cb function*/
        sizeof(range_0_175000)/sizeof(dcmn_range_t), /*num of ranges*/
        range_0_175000
    },
    {
        DCMN_INVALID_FEATURE,
...
int qax_caui4_3_ports_devices[] =
    {
        BCM88474H_DEVICE_ID,
        INVALID_DEV_ID
    }; /* DCMN_QAX_2_CAUI4_PORTS_FEATURE*/
