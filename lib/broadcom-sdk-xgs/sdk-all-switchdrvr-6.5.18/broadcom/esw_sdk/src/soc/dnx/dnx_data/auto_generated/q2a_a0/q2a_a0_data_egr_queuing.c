 ...
 */
static shr_error_e
q2a_a0_dnx_data_egr_queuing_common_max_val_slow_port_speed_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_egr_queuing;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_egr_queuing_common_max_val_mux_calendar_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_egr_queuing;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_egr_queuing_common_max_val_slow_port_speed_set;
    data_index = dnx_data_egr_queuing_common_max_val_define_mux_calendar_resolution;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_egr_queuing_common_max_val_mux_calendar_resolution_set;
