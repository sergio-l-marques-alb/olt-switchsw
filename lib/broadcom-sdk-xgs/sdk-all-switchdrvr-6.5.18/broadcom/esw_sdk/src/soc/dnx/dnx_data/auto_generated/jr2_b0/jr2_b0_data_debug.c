 ...
 */
static shr_error_e
jr2_b0_dnx_data_debug_hw_bug_pem_vt_init_fix_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b0_dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
    ...
    int unit)
{
    ...
    feature->set = jr2_b0_dnx_data_debug_hw_bug_pem_vt_init_fix_set;
    data_index = dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid_set;
