 ...
 */
static shr_error_e
jr2_a0_dnx_data_debug_hw_bug_no_hit_bit_on_mdb_access_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_a0_dnx_data_debug_hw_bug_pem_vt_init_fix_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_debug_hw_bug_iparser_signals_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
    ...
    int unit)
{
    ...
    feature->set = jr2_a0_dnx_data_debug_hw_bug_no_hit_bit_on_mdb_access_set;
    data_index = dnx_data_debug_hw_bug_pem_vt_init_fix;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_debug_hw_bug_pem_vt_init_fix_set;
    data_index = dnx_data_debug_hw_bug_iparser_signals_valid;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_debug_hw_bug_iparser_signals_valid_set;
    data_index = dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_debug_hw_bug_fwd_action_signals_from_lbp_valid_set;
