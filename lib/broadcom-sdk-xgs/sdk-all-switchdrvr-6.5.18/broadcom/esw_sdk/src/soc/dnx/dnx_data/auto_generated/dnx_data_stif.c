    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_stif_config_stif_enable].labels[0] = "j2p_notrev";
    ...
    submodule_data->features[dnx_data_stif_config_stif_report_mc_single_copy].labels[0] = "j2p_notrev";
    ...
    submodule_data->features[dnx_data_stif_config_mixing_ports_limitation].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_stif_config_define_sram_buffers_resolution].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_sram_pdbs_resolution].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_dram_bdb_resolution].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_packet_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_scrubber_queue_min].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_scrubber_queue_max].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_scrubber_rate_min].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_scrubber_rate_max].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_report_mode].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_report_size_ingress].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_report_size_egress].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_stif_idle_report].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_config_define_nof_valid_sources].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_stif_config_table_scrubber_buffers].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_stif_config_table_selective_report_range].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_stif_port_define_max_nof_instances].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_port_define_stif_ethu_select_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_port_define_stif_lane_mapping_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_stif_port_table_ethu_id_stif_valid].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_stif_report_etpp_core_in_portmetadata].doc = "set WA - etpp has no variable indication for core id and needs to be set in portmetadata[0]";
    submodule_data->features[dnx_data_stif_report_etpp_core_in_portmetadata].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_stif_report_define_qsize_idle_report_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_qsize_idle_report_period].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_qsize_idle_report_period_invalid].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_qsize_scrubber_report_cycles_unit].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_max_thresholds_per_buffer].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_incoming_tc].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_record_two_msb].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_nof_source_types].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_stat_id_max_count].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_stat_object_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_format_element_packet_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_format_msb_opcode_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_format_etpp_metadata_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_opsize_use_one_type_mask].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_opsize_use_two_types_mask].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_opsize_use_three_types_mask].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_report_define_billing_opsize_use_four_types_mask].labels[0] = "j2p_notrev";
    /* Set data type flag */
    submodule_data->defines[dnx_data_stif_report_define_billing_opsize_use_four_types_mask].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_stif_report_define_billing_enq_ing_size_wa_shift].name = "billing_enq_ing_size_wa_shift";
    submodule_data->defines[dnx_data_stif_report_define_billing_enq_ing_size_wa_shift].doc = "billing record ingress enqueu size=96. need to reduce wa_shift value from each element sgift value";
    submodule_data->defines[dnx_data_stif_report_define_billing_enq_ing_size_wa_shift].labels[0] = "j2p_notrev";
    /* Set data type flag */
    submodule_data->defines[dnx_data_stif_report_define_billing_enq_ing_size_wa_shift].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->tables[dnx_data_stif_report_table_etpp_metadata].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_stif_report_table_report_size].labels[0] = "j2p_notrev";
...
uint32
dnx_data_stif_report_billing_enq_ing_size_wa_shift_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_stif, dnx_data_stif_submodule_report, dnx_data_stif_report_define_billing_enq_ing_size_wa_shift);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_stif_flow_control_instance_0_must_be_on].doc = "due to HW bug once instance 0 is off flow control will also be off - WA is to keep instance 0 on even if not in use ";
    submodule_data->features[dnx_data_stif_flow_control_instance_0_must_be_on].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_etpp_pipe_length].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_etpp_deq_size_of_fifo].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_cgm_pipe_length].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_cgm_size_of_fifo].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_billing_level_sampling].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_fc_disable_value].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_billing_etpp_flow_control_high].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_billing_etpp_flow_control_low].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_billing_cgm_flow_control_high].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_billing_cgm_flow_control_low].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_qsize_cgm_flow_control_high].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_stif_flow_control_define_qsize_cgm_flow_control_low].labels[0] = "j2p_notrev";
    /* Set data type flag */
