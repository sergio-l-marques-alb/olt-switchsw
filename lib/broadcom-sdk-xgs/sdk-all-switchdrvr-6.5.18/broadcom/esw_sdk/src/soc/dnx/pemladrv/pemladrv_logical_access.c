...
VersionInfo* dnx_get_version(int unit, int print_to_cout){
  ...
  dnx_init_phy_mem_t_from_chunk_mapper(block_id0, pem_reg00_address_val, 0, 32, 0, 0, 0, &spare_reg00);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id0, pem_reg01_address_val, 0, 32, 0, 0, 0, &spare_reg01);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id0, pem_reg02_address_val, 0, 32, 0, 0, 0, &spare_reg02);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id0, pem_reg03_address_val, 0, 32, 0, 0, 0, &spare_reg03);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id1, pem_reg10_address_val, 0, 32, 0, 0, 0, &spare_reg10);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id1, pem_reg11_address_val, 0, 32, 0, 0, 0, &spare_reg11);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id1, pem_reg12_address_val, 0, 32, 0, 0, 0, &spare_reg12);
  dnx_init_phy_mem_t_from_chunk_mapper(block_id1, pem_reg13_address_val, 0, 32, 0, 0, 0, &spare_reg13);
    ...
    unsigned int *virtual_db_data_arr)
{
  ...
  for (chunk_matrix_col_index = 0; chunk_matrix_col_index < nof_chunk_cols; ++chunk_matrix_col_index) {
    ...
    dnx_init_phy_mem_t_from_chunk_mapper(chunk_mapper->mem_block_id, chunk_mapper->phy_mem_addr, physical_row_index, chunk_mapper->phy_mem_width, 0, is_egress, is_mem, phy_mem);
    ...
    unsigned int *virtual_db_data_arr)
{
  ...
  for (chunk_matrix_col_index = 0; chunk_matrix_col_index < nof_chunk_cols; ++chunk_matrix_col_index) {
    ...
    if(do_read) {
      ...
      chunk_mapper           = db_chunk_mapper_matrix[0].db_chunk_mapper[chunk_matrix_row_index][chunk_matrix_col_index];
      physical_row_index     = dnx_calculate_physical_row_index_from_chunk_mapper(chunk_mapper, virtual_row_index);
      dnx_init_phy_mem_t_from_chunk_mapper(chunk_mapper->mem_block_id, chunk_mapper->phy_mem_addr, physical_row_index, chunk_mapper->phy_mem_width, 0, is_ingress, is_mem, phy_mem);
...
#if defined(PROJECT_J2_A0) || defined(SOC_IS_JERICHO2_A0) || defined(PROJECT_J2) || defined(SOC_IS_JERICHO2) || defined(PROJECT_J2P) || defined(SOC_IS_J2P)
