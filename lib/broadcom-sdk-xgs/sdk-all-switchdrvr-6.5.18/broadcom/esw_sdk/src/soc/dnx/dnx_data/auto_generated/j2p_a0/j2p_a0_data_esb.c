 ...
 */
static shr_error_e
j2p_a0_dnx_data_esb_general_nof_ilkn_tdm_queues_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_esb_general_slow_port_dedicated_queue_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_esb_general_nof_ilkn_tdm_queues_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_esb_general_slow_port_dedicated_queue_set;
