 ...
 * Module - 'pll', Submodule - 'pll3', table - 'nif_pll'
 ...
 */
static shr_error_e
jr2_a0_dnx_data_pll_pll3_nif_pll_set(
    int unit)
{
    int pll_index_index;
    dnx_data_pll_pll3_nif_pll_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll3;
    int table_index = dnx_data_pll_pll3_table_nif_pll;
    SHR_FUNC_INIT_VARS(unit);
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_pll_pll3_nif_pll_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_pll_pll3_table_nif_pll");

    /* Store Default Values */
    default_data = (dnx_data_pll_pll3_nif_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    {
        data = (dnx_data_pll_pll3_nif_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, pll_index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    /*
    ...
    DNXC_DATA_ALLOC(table->values[0].property.mapping, dnxc_data_property_map_t, table->values[0].property.nof_mapping, "dnx_data_pll_pll3_nif_pll_t property mapping");
    ...
    DNXC_DATA_ALLOC(table->values[1].property.mapping, dnxc_data_property_map_t, table->values[1].property.nof_mapping, "dnx_data_pll_pll3_nif_pll_t property mapping");
 ...
 * Module - 'pll', Submodule - 'pll3', table - 'fabric_pll'
 ...
 */
static shr_error_e
jr2_a0_dnx_data_pll_pll3_fabric_pll_set(
    int unit)
{
    int pll_index_index;
    dnx_data_pll_pll3_fabric_pll_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll3;
    int table_index = dnx_data_pll_pll3_table_fabric_pll;
    SHR_FUNC_INIT_VARS(unit);
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_pll_pll3_fabric_pll_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_pll_pll3_table_fabric_pll");

    /* Store Default Values */
    default_data = (dnx_data_pll_pll3_fabric_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->in_freq = DNX_SERDES_REF_CLOCK_312_5;
    default_data->out_freq = DNX_SERDES_REF_CLOCK_312_5;
    /* Set Default Values */
    for (pll_index_index = 0; pll_index_index < table->keys[0].size; pll_index_index++)
    {
        data = (dnx_data_pll_pll3_fabric_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, pll_index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    /*
     * Value Property - in_freq
    ...
    table->values[0].property.suffix = "in";
    table->values[0].property.nof_mapping = 3;
    DNXC_DATA_ALLOC(table->values[0].property.mapping, dnxc_data_property_map_t, table->values[0].property.nof_mapping, "dnx_data_pll_pll3_fabric_pll_t property mapping");
    ...
    table->values[1].property.suffix = "out";
    table->values[1].property.nof_mapping = 4;
    DNXC_DATA_ALLOC(table->values[1].property.mapping, dnxc_data_property_map_t, table->values[1].property.nof_mapping, "dnx_data_pll_pll3_fabric_pll_t property mapping");
    ...
    int unit)
{
    ...
    data_index = dnx_data_pll_pll3_table_nif_pll;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_pll_pll3_nif_pll_set;
    data_index = dnx_data_pll_pll3_table_fabric_pll;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_pll_pll3_fabric_pll_set;
    /*
