/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_tcam_access_mapper_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_field_tcam_access_mapper_sw
...
/*
 *
 * dump function for the variable key_2_entry_id_hash
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_field_tcam_access_mapper_sw_key_2_entry_id_hash_dump(int  unit,  int  key_2_entry_id_hash_idx_0,  int  key_2_entry_id_hash_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    int i1 = key_2_entry_id_hash_idx_1, I1 = key_2_entry_id_hash_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
