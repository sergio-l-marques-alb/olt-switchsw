 ...
 */
static shr_error_e
j2c_a0_dnx_data_nif_global_max_nif_rate_per_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 4096000000;

    /* Set value */
    define->data = 4096000000;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_nif_global_nof_nif_ports_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
/**
 * \brief device level function which set define is_56G_speed_supported
 * define info:
 ...
 */
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_is_56G_speed_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int define_index = dnx_data_nif_ilkn_define_is_56G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_global_max_nif_rate_per_core_set;
    data_index = dnx_data_nif_global_define_nof_nif_ports;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_global_nof_nif_ports_set;
    ...
    data_index = dnx_data_nif_ilkn_define_is_56G_speed_supported;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_ilkn_is_56G_speed_supported_set;
