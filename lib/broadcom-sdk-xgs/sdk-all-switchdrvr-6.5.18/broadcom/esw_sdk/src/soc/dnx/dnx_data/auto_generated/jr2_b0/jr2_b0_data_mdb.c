 ...
 */
static shr_error_e
jr2_b0_dnx_data_mdb_hw_bug_step_table_supports_mix_ar_algo_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_mdb_hw_bug_eedb_bank_traffic_lock_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_mdb_hw_bug_em_dfg_ovf_cam_disabled_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_mdb_hw_bug_em_mact_transplant_no_reply_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_mdb_hw_bug_em_mact_use_refresh_on_insert_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_mdb_hw_bug_em_sbus_interface_shutdown_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_mdb_hw_bug_step_table_supports_mix_ar_algo_set;
    data_index = dnx_data_mdb_hw_bug_eedb_bank_traffic_lock;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_mdb_hw_bug_eedb_bank_traffic_lock_set;
    data_index = dnx_data_mdb_hw_bug_em_dfg_ovf_cam_disabled;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_mdb_hw_bug_em_dfg_ovf_cam_disabled_set;
    data_index = dnx_data_mdb_hw_bug_em_mact_transplant_no_reply;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_mdb_hw_bug_em_mact_transplant_no_reply_set;
    data_index = dnx_data_mdb_hw_bug_em_mact_use_refresh_on_insert;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_mdb_hw_bug_em_mact_use_refresh_on_insert_set;
    data_index = dnx_data_mdb_hw_bug_em_sbus_interface_shutdown;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_mdb_hw_bug_em_sbus_interface_shutdown_set;
