    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_oam_general_define_oam_force_interface_for_meps_without_counter].doc = "HW Bug - Egress doesnt support counter_if 3 as invalid. JR2_A0 only!";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_mep_db_da_is_mc_for_short_entries_support].doc = "DA_is_MC bug in A0 is fixed";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_mep_db_version_limitation].doc = "HW bug: MEP type field for all short entries is read from sub-index 0. JR2_A0 only!";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_oamp_mep_db_threshold_version_limitation].doc = "HW bug: oamp_mep_db_threshold could be set to 0 or 64k. JR2_A0 only!";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_rmep_db_non_zero_lifetime_units_limitation].doc = "HW bug: OAMP_RMEP_DB lifetime units cannot be set to non-zero value. JR2_A0 only!";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_crc_calculation_supported].doc = "HW bug: CRC calculation fails - JR2_A0 only!  Works for B0 and up";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_punt_packet_pph_ttl_supported].doc = "HW bug: punt packet pph's ttl calculation is wrong - JR2_A0 only!  Works for B0 and up";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_lmm_dmm_supported].doc = "HW bug: oamp lmm and dmm don't work - JR2_A0 only!  Works for B0 and up";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "OAM-related HW bugs";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_oam_hw_bug_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data oam hw_bug features");

    submodule_data->features[dnx_data_oam_hw_bug_oam_offset_supported].name = "oam_offset_supported";
    submodule_data->features[dnx_data_oam_hw_bug_oam_offset_supported].doc = "HW bug: oam_offset is not used - JR2_A0 only!  Works for B0 and up";
    submodule_data->features[dnx_data_oam_hw_bug_oam_offset_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_oam_statistics_supported].name = "oam_statistics_supported";
    submodule_data->features[dnx_data_oam_hw_bug_oam_statistics_supported].doc = "HW bug: oam statistics is not used - JR2_A0 only!  Works for B0 and up";
    submodule_data->features[dnx_data_oam_hw_bug_oam_statistics_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_lm_read_index_limitation].name = "lm_read_index_limitation";
    submodule_data->features[dnx_data_oam_hw_bug_lm_read_index_limitation].doc = "HW bug: there needs to be a configuration per OAM-Sub-Type to either use the calculated lm_read_index, or set it to NULL. - JR2_A0 only!";
    submodule_data->features[dnx_data_oam_hw_bug_lm_read_index_limitation].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_oamp_scanner_limitation].name = "oamp_scanner_limitation";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_scanner_limitation].doc = "RMEP is unreliable in A0 device";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_scanner_limitation].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_oamp_tx_rate_limitation].name = "oamp_tx_rate_limitation";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_tx_rate_limitation].doc = "HW bug: OAMP transmission rate is not accurate on JR2_A0 device";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_tx_rate_limitation].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_oamp_protection_rmep_id_limitation].name = "oamp_protection_rmep_id_limitation";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_protection_rmep_id_limitation].doc = "HW bug: OAMP RMEP ID is not stamped on protection packets - JR2_A0 only! Works for B0 and up";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_protection_rmep_id_limitation].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_oamp_generic_response_supported].name = "oamp_generic_response_supported";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_generic_response_supported].doc = "HW bug: OAMP reply with wrong vlan fields. Works for J2P and above";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_generic_response_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_hw_bug_oamp_txm_bank_limitation].name = "oamp_txm_bank_limitation";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_txm_bank_limitation].doc = "HW bug: OAMP TXM cannot support all banks - JR2 only! Applcable for Q2A aswell, because of low frequency";
    submodule_data->features[dnx_data_oam_hw_bug_oamp_txm_bank_limitation].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_oam_hw_bug_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data oam hw_bug defines");

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_oam_hw_bug_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data oam hw_bug tables");
 ...
 */
int
dnx_data_oam_hw_bug_feature_get(
    int unit,
    dnx_data_oam_hw_bug_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_hw_bug, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_oam_hw_bug_init(unit, &module_data->submodules[dnx_data_oam_submodule_hw_bug]));
    /*
