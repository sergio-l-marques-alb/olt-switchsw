    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l2_hw_bug_bc_same_as_unknown_mc].name = "bc_same_as_unknown_mc";
    submodule_data->features[dnx_data_l2_hw_bug_bc_same_as_unknown_mc].doc = "Destination of BC packets should be the same as unknown-MC packets";
    submodule_data->features[dnx_data_l2_hw_bug_bc_same_as_unknown_mc].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->features[dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location].name = "vmv_for_limit_in_wrong_location";
    submodule_data->features[dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location].doc = "For limit check the vmv is taken from the wrong side of the mdb entry";
    submodule_data->features[dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_l2_hw_bug_learn_limit].name = "learn_limit";
    submodule_data->features[dnx_data_l2_hw_bug_learn_limit].doc = "L2 limit causes supression of events related to existing entries (eg transplant/refresh)";
    submodule_data->features[dnx_data_l2_hw_bug_learn_limit].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_l2_hw_bug_limit_per_lif_counters].name = "limit_per_lif_counters";
    submodule_data->features[dnx_data_l2_hw_bug_limit_per_lif_counters].doc = "Counters are not updated correctly in limit per LIF mode. Delete from host fails to update the correct counter (HWJERICHO2-2023)";
    submodule_data->features[dnx_data_l2_hw_bug_limit_per_lif_counters].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_l2_hw_bug_learn_events_wrong_command].name = "learn_events_wrong_command";
    submodule_data->features[dnx_data_l2_hw_bug_learn_events_wrong_command].doc = "LEL generates learn events with INSERT command instead of LEARN (HWJERICHO2-2617)";
    submodule_data->features[dnx_data_l2_hw_bug_learn_events_wrong_command].flags |= DNXC_DATA_F_FEATURE;
