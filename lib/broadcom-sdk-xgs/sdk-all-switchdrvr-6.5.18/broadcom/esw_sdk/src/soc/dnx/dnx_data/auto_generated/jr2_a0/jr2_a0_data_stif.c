...
/**
 * \brief device level function which set define billing_enq_ing_size_wa_shift
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_stif_report_billing_enq_ing_size_wa_shift_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stif;
    int submodule_index = dnx_data_stif_submodule_report;
    int define_index = dnx_data_stif_report_define_billing_enq_ing_size_wa_shift;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_stif_report_define_billing_enq_ing_size_wa_shift;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_stif_report_billing_enq_ing_size_wa_shift_set;
