 ...
 */
static shr_error_e
q2a_a0_dnx_data_dram_gddr6_dynamic_calibration_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_gddr6;
    int feature_index = dnx_data_dram_gddr6_dynamic_calibration;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_dram_gddr6_dynamic_calibration;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_dram_gddr6_dynamic_calibration_set;
