    ...
    int unit)
{
    ...
    default_data->overflow_field = INVALIDf;
...
/**
 * \brief device level function which set values for table drop_reason
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_drop_reason_set(
    int unit)
{
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_graphical_diag_drop_reason_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_graphical_diag_table_drop_reason");
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_graphical_diag_drop_reason_set;
