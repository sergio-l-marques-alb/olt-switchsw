 ...
 */
/**
 * \brief device level function which map key to table indeximb_type_info
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_imb_imb_type_info_key_map(
    int unit,
    int key0_val,
    int key1_val,
    int *key0_index,
...
/**
 * \brief device level function which maps table index to key imb_type_info
 * Module - 'port', Submodule - 'imb', table - 'imb_type_info'
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_imb_imb_type_info_key_reverse_map(
    int unit,
    int key0_index,
    int key1_index,
    int *key0_val,
    int *key1_val)
{
    ...
    {
        case 0:
            *key0_val = imbDispatchTypeImb_cdu;
            break;
        case 1:
            *key0_val = imbDispatchTypeImb_clu;
            break;
        default:
            *key0_val = -1;
            break;
    ...
    int unit)
{
    ...
    table->key_map = jr2_a0_dnx_data_port_imb_imb_type_info_key_map;
    table->key_map_reverse = jr2_a0_dnx_data_port_imb_imb_type_info_key_reverse_map;
    /*
     * Set Values - Entries
     */
