 ...
 */
static shr_error_e
j2c_a0_dnx_data_sch_flow_nof_regions_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_sch_flow_nof_connectors_only_regions_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_sch_flow_reserved_hr_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_sch_hw_workarounds_dlm_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_sch_flow_nof_regions_set;
    data_index = dnx_data_sch_flow_define_nof_connectors_only_regions;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_sch_flow_nof_connectors_only_regions_set;
    data_index = dnx_data_sch_flow_define_reserved_hr;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_sch_flow_reserved_hr_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_sch_hw_workarounds_dlm_set;
