    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_bier_params_is_supported].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_bier_params_define_bitstring_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_bfr_entry_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_bank_entries].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_bundle_nof_banks].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_bundle_nof_banks_net].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_egress_only].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_nof_egr_table_copies].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_ingress_bfr_pos_msb_start].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_bier_params_define_nof_bfr_entries].labels[0] = "j2p_notrev";
    /* Set data type flag */
