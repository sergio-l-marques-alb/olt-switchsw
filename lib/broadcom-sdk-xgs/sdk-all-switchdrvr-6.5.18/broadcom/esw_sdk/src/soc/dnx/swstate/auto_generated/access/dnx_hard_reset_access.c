/** \file dnx/swstate/auto_generated/access/dnx_hard_reset_access.c
 *
...
/*
 *
 * is_init function for the variable dnx_hard_reset_db
...
/*
 *
 * init function for the variable dnx_hard_reset_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
