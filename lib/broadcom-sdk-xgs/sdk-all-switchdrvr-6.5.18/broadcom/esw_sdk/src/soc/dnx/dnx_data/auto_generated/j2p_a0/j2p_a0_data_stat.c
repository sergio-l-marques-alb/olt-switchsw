 ...
 */
static shr_error_e
j2p_a0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set;
