    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dev_init_cmc_define_pci_cmc].name = "pci_cmc";
    submodule_data->defines[dnx_data_dev_init_cmc_define_pci_cmc].doc = "CMC in CMICx used by the PCI Host";
    /* Set data type flag */
    submodule_data->defines[dnx_data_dev_init_cmc_define_pci_cmc].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_dev_init_cmc_define_pci_cmcs_num].name = "pci_cmcs_num";
    submodule_data->defines[dnx_data_dev_init_cmc_define_pci_cmcs_num].doc = "Number of CMCs used by the PCI Host";
    /* Set data type flag */
    submodule_data->defines[dnx_data_dev_init_cmc_define_pci_cmcs_num].flags |= DNXC_DATA_F_NUMERIC;
 ...
 */
uint32
dnx_data_dev_init_cmc_pci_cmc_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_cmc, dnx_data_dev_init_cmc_define_pci_cmc);
}

uint32
dnx_data_dev_init_cmc_pci_cmcs_num_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_cmc, dnx_data_dev_init_cmc_define_pci_cmcs_num);
}
