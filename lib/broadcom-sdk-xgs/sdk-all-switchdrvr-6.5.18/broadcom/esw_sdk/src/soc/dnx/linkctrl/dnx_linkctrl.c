...
{
    soc_port_t port;
    soc_pbmp_t channels, pbm_all_channels;
    SHR_FUNC_INIT_VARS(unit);
    ...
    /*
     * Consider channalized port
     */
    SOC_PBMP_CLEAR(pbm_all_channels);
    SOC_PBMP_ITER(*hw_link, port)
    {
        /*
         * Get all channels
         */
        ...
        BCM_PBMP_OR(pbm_all_channels, channels);
    }
    /*
     * Update channalized port's link status
     */
    BCM_PBMP_OR(*hw_link, pbm_all_channels);
