/** \file jr2_b0_data_pemla_soc.c
 * 
 * DEVICE DATA - PEMLA_SOC
 * 
 * Device Data
 ...
 */
/**
 * \brief device level function which set define JR1_MODE
 * define info:
 ...
 */
static shr_error_e
jr2_b0_dnx_data_pemla_soc_soc_JR1_MODE_set(
    int unit)
{
...
/**
 * \brief device level function which set define JR2_MODE
 * define info:
 ...
 */
static shr_error_e
jr2_b0_dnx_data_pemla_soc_soc_JR2_MODE_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pemla_soc;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_pemla_soc_soc_system_headers_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pemla_soc;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_pemla_soc_soc_JR1_MODE_set;
    data_index = dnx_data_pemla_soc_soc_define_JR2_MODE;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_pemla_soc_soc_JR2_MODE_set;
    data_index = dnx_data_pemla_soc_soc_define_system_headers_mode;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_pemla_soc_soc_system_headers_mode_set;
