...
/**
 * \brief device level function which set define nof_keys_alloc_for_mdb_dt
 * define info:
...
/**
 * \brief device level function which set define fes_instruction_size
 * define info:
...
/**
 * \brief device level function which set define fes_pgm_id_offset
 * define info:
...
/**
 * \brief device level function which set numeric nof_fes_used_by_sdk
 * numeric info:
    ...
    int unit)
{
    ...
    table->values[72].default_val = "-1";
    table->values[73].default_val = "FALSE";
...
/**
 * \brief device level function which set define max_payload_size_per_opcode
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_tcam_hit_indication_entries_per_byte_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_group_id_fec_wa_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
/**
 * \brief device level function which set define default_j1_learning_2ndpass_context
 * define info:
...
/**
 * \brief device level function which set define default_j1_itmh_pph_oamp_presel_id_ipmf1
 * define info:
...
/**
 * \brief device level function which set define default_j1_learn_wa_presel_id_1st_pass_ipmf1
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_j1_learn_wa_presel_id_1st_pass_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_1st_pass_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define default_j1_learn_wa_presel_id_2nd_pass_ipmf1
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_j1_learn_wa_presel_id_2nd_pass_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_2nd_pass_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define default_oam_roo_ipv4_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_oam_roo_ipv6_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_oam_w_o_roo_no_rif_ipv4_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_oam_w_o_roo_no_rif_ipv6_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_oam_w_o_roo_with_rif_ipv4_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_oam_w_o_roo_with_rif_ipv6_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_j1_ipv4_mc_in_lif_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_j1_ipv6_mc_in_lif_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_j1_php_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_j1_swap_presel_id_ipmf3
 * define info:
...
/**
 * \brief device level function which set define default_j1_same_port_wa_presel_id_epmf
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_j1_same_port_wa_presel_id_epmf_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_j1_same_port_wa_presel_id_epmf;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define default_learn_limit_wa_presel_id_epmf
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_learn_limit_wa_presel_id_epmf_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_learn_limit_wa_presel_id_epmf;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define vw_1st
 * define info:
...
/**
 * \brief device level function which set define vw_nof
 * define info:
 ...
 */
/**
 * \brief device level function which set define signals_nof
 * define info:
...
/**
 * \brief device level function which set define actions_per_signal_nof
 * define info:
...
/**
 * \brief device level function which set define general_data_user_general_containers_size
 * define info:
...
/**
 * \brief device level function which set define ipmf1_general_data_index
 * define info:
 ...
 */
/**
 * \brief device level function which set values for table signal_mapping
    ...
    int unit)
{
    ...
    table->values[4].default_val = "0";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_virtual_wire_signal_mapping_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_field_virtual_wire_table_signal_mapping");
...
/**
 * \brief device level function which set numeric pmf_map_stage
 * numeric info:
...
/**
 * \brief device level function which set define action_size_small
 * define info:
...
/**
 * \brief device level function which set define action_size_mid
 * define info:
...
/**
 * \brief device level function which set define action_size_large
 * define info:
...
/**
 * \brief device level function which set define ipmf1_key_select
 * define info:
...
/**
 * \brief device level function which set define ipmf2_key_select
 * define info:
...
/**
 * \brief device level function which set define ipmf3_key_select
 * define info:
...
/**
 * \brief device level function which set numeric field_class_id_total_size
 * numeric info:
 * J1 Mode UDH retlated size
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric pph_learn_ext_disable
 * numeric info:
...
/**
 * \brief device level function which set define fes_shift_offset
 * define info:
...
/**
 * \brief device level function which set define fes_invalid_bits_offset
 * define info:
...
/**
 * \brief device level function which set define fes_type_offset
 * define info:
...
/**
 * \brief device level function which set define fes_ace_action_offset
 * define info:
...
/**
 * \brief device level function which set define fes_chosen_mask_offset
 * define info:
...
/**
 * \brief device level function which set define layer_record_size
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_fec_dest_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_l4_trap_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_oam_layer_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_oam_stat_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_flow_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_roo_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_jr1_ipmc_inlif_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_j1_same_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_j1_learning_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_learn_limit_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
/**
 * \brief device level function which set define wa_j1_php
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_init_wa_j1_php_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_init;
    int define_index = dnx_data_field_init_define_wa_j1_php;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_field_features_ecc_wa_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_ecc_wa_enable;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define congestion_info
 * define info:
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tcam_hit_indication_entries_per_byte_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_group_id_fec_wa_set;
    ...
    data_index = dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_1st_pass_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_j1_learn_wa_presel_id_1st_pass_ipmf1_set;
    data_index = dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_2nd_pass_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_j1_learn_wa_presel_id_2nd_pass_ipmf1_set;
    ...
    data_index = dnx_data_field_preselector_define_default_j1_same_port_wa_presel_id_epmf;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_j1_same_port_wa_presel_id_epmf_set;
    data_index = dnx_data_field_preselector_define_default_learn_limit_wa_presel_id_epmf;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_learn_limit_wa_presel_id_epmf_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_fec_dest_set;
    data_index = dnx_data_field_init_define_wa_l4_trap;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_l4_trap_set;
    data_index = dnx_data_field_init_define_wa_oam_layer_index;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_oam_layer_index_set;
    data_index = dnx_data_field_init_define_wa_oam_stat;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_oam_stat_set;
    data_index = dnx_data_field_init_define_wa_flow_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_flow_id_set;
    data_index = dnx_data_field_init_define_wa_roo;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_roo_set;
    data_index = dnx_data_field_init_define_wa_jr1_ipmc_inlif;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_jr1_ipmc_inlif_set;
    data_index = dnx_data_field_init_define_wa_j1_same_port;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_j1_same_port_set;
    data_index = dnx_data_field_init_define_wa_j1_learning;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_j1_learning_set;
    data_index = dnx_data_field_init_define_wa_learn_limit;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_learn_limit_set;
    data_index = dnx_data_field_init_define_wa_j1_php;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_init_wa_j1_php_set;
     ...
     * Attach defines: 
     */
    data_index = dnx_data_field_features_define_ecc_wa_enable;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_ecc_wa_enable_set;
