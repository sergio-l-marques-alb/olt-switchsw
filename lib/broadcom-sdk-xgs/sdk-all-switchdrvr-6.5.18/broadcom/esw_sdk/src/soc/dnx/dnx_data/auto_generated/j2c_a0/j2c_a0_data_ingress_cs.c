 ...
 */
static shr_error_e
j2c_a0_dnx_data_ingress_cs_hw_workarounds_disable_ecc_fix_en_before_read_write_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = j2c_a0_dnx_data_ingress_cs_hw_workarounds_disable_ecc_fix_en_before_read_write_set;
