 ...
 */
static shr_error_e
j2c_a0_dnx_data_pll_pll3_nif_pll_set(
    int unit)
{
    int pll_index_index;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_pll_pll3_fabric_pll_set(
    int unit)
{
    int pll_index_index;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_pll_pll3_nif_pll_set;
    data_index = dnx_data_pll_pll3_table_fabric_pll;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_pll_pll3_fabric_pll_set;
    /*
