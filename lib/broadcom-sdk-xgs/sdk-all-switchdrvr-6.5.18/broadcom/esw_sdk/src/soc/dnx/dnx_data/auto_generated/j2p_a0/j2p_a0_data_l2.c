 ...
 */
static shr_error_e
j2p_a0_dnx_data_l2_hw_bug_age_state_not_updated_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_l2_hw_bug_eth_qual_is_mc_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_l2_hw_bug_learn_events_wrong_command_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_l2_hw_bug_age_state_not_updated_set;
    data_index = dnx_data_l2_hw_bug_eth_qual_is_mc;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_l2_hw_bug_eth_qual_is_mc_set;
    data_index = dnx_data_l2_hw_bug_learn_events_wrong_command;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_l2_hw_bug_learn_events_wrong_command_set;
