 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_general_ivl_feature_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_age_out_and_refresh_profile_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_age_machine_pause_after_flush_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_age_state_not_updated_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_appdb_id_for_olp_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_eth_qual_is_mc_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_bc_same_as_unknown_mc_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_fid_mgmt_ecc_error_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_wrong_limit_interrupt_handling_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_transplant_instead_of_refresh_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_static_mac_age_out_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_learn_limit_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_limit_per_lif_counters_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
    int submodule_index = dnx_data_l2_submodule_hw_bug;
    int feature_index = dnx_data_l2_hw_bug_limit_per_lif_counters;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l2_hw_bug_learn_events_wrong_command_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_general_ivl_feature_support_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_age_out_and_refresh_profile_selection_set;
    data_index = dnx_data_l2_hw_bug_age_machine_pause_after_flush;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_age_machine_pause_after_flush_set;
    data_index = dnx_data_l2_hw_bug_age_state_not_updated;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_age_state_not_updated_set;
    data_index = dnx_data_l2_hw_bug_appdb_id_for_olp;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_appdb_id_for_olp_set;
    data_index = dnx_data_l2_hw_bug_eth_qual_is_mc;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_eth_qual_is_mc_set;
    data_index = dnx_data_l2_hw_bug_bc_same_as_unknown_mc;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_bc_same_as_unknown_mc_set;
    data_index = dnx_data_l2_hw_bug_fid_mgmt_ecc_error;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_fid_mgmt_ecc_error_set;
    data_index = dnx_data_l2_hw_bug_wrong_limit_interrupt_handling;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_wrong_limit_interrupt_handling_set;
    data_index = dnx_data_l2_hw_bug_transplant_instead_of_refresh;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_transplant_instead_of_refresh_set;
    data_index = dnx_data_l2_hw_bug_static_mac_age_out;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_static_mac_age_out_set;
    data_index = dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_vmv_for_limit_in_wrong_location_set;
    data_index = dnx_data_l2_hw_bug_learn_limit;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_learn_limit_set;
    data_index = dnx_data_l2_hw_bug_limit_per_lif_counters;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_limit_per_lif_counters_set;
    data_index = dnx_data_l2_hw_bug_learn_events_wrong_command;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_hw_bug_learn_events_wrong_command_set;
