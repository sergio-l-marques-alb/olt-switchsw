/** \file dbal_init_cb_tables_hard_logic_pp_port_hl_pp_port_pp.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    /** size is calculated by the Autocoder  */
    uint32 result_size__vtt2_ptc_cs_profile = 0;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PTC, key_value__ptc);
    /** size of PTC_ROUTING_ENABLE_PROFILE_VTT1 field  */
    result_size__ptc_routing_enable_profile_vtt1 += dnx_data_aod_sizes.AOD.sizes_get(unit, 114)->value;
    /** size of VTT2_PTC_CS_PROFILE field  */
    result_size__vtt2_ptc_cs_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 110)->value;
    *offset = key_value__ptc%128*(result_size__ptc_routing_enable_profile_vtt1+result_size__vtt2_ptc_cs_profile)+result_size__vtt2_ptc_cs_profile;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    /** size of VTT2_PTC_CS_PROFILE field  */
    result_size__vtt2_ptc_cs_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 110)->value;
    *offset = key_value__ptc*(result_size__ptc_routing_enable_profile_vtt1+result_size__vtt2_ptc_cs_profile)+result_size__vtt2_ptc_cs_profile;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    /** size of VTT2_PTC_CS_PROFILE field  */
    result_size__vtt2_ptc_cs_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 110)->value;
    *offset = key_value__ptc%4*(result_size__ptc_routing_enable_profile_vtt1+result_size__vtt2_ptc_cs_profile)+result_size__vtt2_ptc_cs_profile;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    /** size of VTT2_PTC_CS_PROFILE field  */
    result_size__vtt2_ptc_cs_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 110)->value;
    *offset = key_value__ptc%128*(result_size__ptc_routing_enable_profile_vtt1+result_size__vtt2_ptc_cs_profile);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    /** size of VTT2_PTC_CS_PROFILE field  */
    result_size__vtt2_ptc_cs_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 110)->value;
    *offset = key_value__ptc*(result_size__ptc_routing_enable_profile_vtt1+result_size__vtt2_ptc_cs_profile);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    /** size of VTT2_PTC_CS_PROFILE field  */
    result_size__vtt2_ptc_cs_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 110)->value;
    *offset = key_value__ptc%4*(result_size__ptc_routing_enable_profile_vtt1+result_size__vtt2_ptc_cs_profile);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
