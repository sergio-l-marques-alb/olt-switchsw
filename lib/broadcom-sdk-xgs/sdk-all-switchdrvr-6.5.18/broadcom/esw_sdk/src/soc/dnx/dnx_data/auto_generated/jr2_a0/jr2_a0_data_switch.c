...
/**
 * \brief device level function which set define mpls_stack_split_hashing
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_mpls_stack_split_hashing_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int define_index = dnx_data_switch_load_balancing_define_mpls_stack_split_hashing;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_switch_hw_bug_mpls_labels_included_in_hash_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_hw_bug;
    int feature_index = dnx_data_switch_hw_bug_mpls_labels_included_in_hash;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_switch_load_balancing_define_mpls_stack_split_hashing;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_mpls_stack_split_hashing_set;
     ...
     */
    submodule_index = dnx_data_switch_submodule_hw_bug;
    submodule = &module->submodules[submodule_index];
     ...
     * Attach features: 
     */
    data_index = dnx_data_switch_hw_bug_mpls_labels_included_in_hash;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_hw_bug_mpls_labels_included_in_hash_set;
