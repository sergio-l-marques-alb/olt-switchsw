    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_multicast_params_define_max_ing_mc_groups].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_max_egr_mc_groups].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_nof_ing_mc_bitmaps].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_nof_egr_mc_bitmaps].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_mcdb_allocation_method].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_nof_mcdb_entries_bits].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_mcdb_block_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_multicast_params_define_nof_mcdb_entries].labels[0] = "j2p_notrev";
    /* Set data type flag */
