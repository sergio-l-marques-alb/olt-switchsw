    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_elk_general_define_max_ports].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_general_define_rop_fifo_depth].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_general_define_flp_full_treshold].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_general_define_max_lane_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_general_define_egw_max_opcode].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_general_define_device_type].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_elk_application_ipv4].labels[0] = "j2p_notrev";
    ...
    submodule_data->features[dnx_data_elk_application_ipv6].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_optimized_result].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_split_rpf].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_thread_safety].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv4_large_mc_enable].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv6_large_mc_enable].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv4_mc_hash_table_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv6_mc_hash_table_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv4_mc_table_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv6_mc_table_size].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_elk_connectivity_blackhole].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_elk_connectivity_define_connect_mode].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_connectivity_define_mdio_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_ilkn_reverse].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_topology].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_kbp_serdes_tx_taps].labels[0] = "j2p_notrev";
    ...
    /* Keys */
    submodule_data->tables[dnx_data_elk_connectivity_table_kbp_serdes_tx_taps].nof_keys = 0;
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_kbp_lane_serdes_tx_taps].labels[0] = "j2p_notrev";
    ...
    int value_index)
{
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_elk, dnx_data_elk_submodule_connectivity, dnx_data_elk_connectivity_table_kbp_serdes_tx_taps);
    data = (const dnx_data_elk_connectivity_kbp_serdes_tx_taps_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, 0, 0);
    switch (value_index)
    {
        case 0:
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_elk_recovery_define_enable].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_elk_recovery_define_iteration].labels[0] = "j2p_notrev";
    /* Set data type flag */
