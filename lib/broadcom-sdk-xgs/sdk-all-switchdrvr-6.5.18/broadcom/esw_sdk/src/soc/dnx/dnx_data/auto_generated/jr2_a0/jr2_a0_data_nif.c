 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_global_max_nif_rate_per_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 2457600000;

    /* Set value */
    define->data = 2457600000;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_global_nof_nif_ports_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = dnx_data_nif.ilkn.ilkn_rx_hrf_nof_get(unit) / dnx_data_nif.ilkn.ilkn_unit_if_nof_get(unit);

    /* Set value */
    define->data = dnx_data_nif.ilkn.ilkn_rx_hrf_nof_get(unit) / dnx_data_nif.ilkn.ilkn_unit_if_nof_get(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_56G_speed_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    data->pm_dispatch_type = portmodDispatchTypePm8x50;
    data->fec_type = bcmPortPhyFecRs544;
    data->is_valid = dnx_data_nif.ilkn.is_56G_speed_supported_get(unit) > 0 ? TRUE : FALSE;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_eth_average_ipg_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    data->fec_type = bcmPortPhyFecNone;
    data->dispatch_type = portmodDispatchTypePm8x50;
    data->is_valid = dnx_data_nif.phys.pm8x50_gen_get(unit) > 1 ? TRUE : FALSE;
    ...
    data->fec_type = bcmPortPhyFecRs544_2xN;
    data->dispatch_type = portmodDispatchTypePm8x50;
    data->is_valid = dnx_data_nif.eth.is_400G_supported_get(unit) == 1 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 42, 0);
    data->speed = 400000;
    data->nof_lanes = 8;
    data->fec_type = bcmPortPhyFecRs272_2xN;
    data->dispatch_type = portmodDispatchTypePm8x50;
    data->is_valid = dnx_data_nif.phys.pm8x50_gen_get(unit) > 1 ? TRUE : FALSE  && dnx_data_nif.eth.is_400G_supported_get(unit) == 1 ? TRUE : FALSE ;
    ...
    int unit)
{
    ...
    data->fec_type = bcmPortPhyFecNone;
    data->medium = BCM_PORT_MEDIUM_BACKPLANE;
    data->channel = bcmPortPhyChannelLong;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    ...
    data->fec_type = bcmPortPhyFecNone;
    data->medium = BCM_PORT_MEDIUM_BACKPLANE;
    data->channel = bcmPortPhyChannelShort;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    ...
    data->medium = BCM_PORT_MEDIUM_COPPER;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 28, 0);
    data->an_mode = bcmPortAnModeCL73BAM;
    data->speed = 40000;
    data->nof_lanes = 2;
    data->fec_type = bcmPortPhyFecNone;
    data->medium = BCM_PORT_MEDIUM_BACKPLANE;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 29, 0);
    data->an_mode = bcmPortAnModeCL73BAM;
    data->speed = 40000;
    data->nof_lanes = 2;
    data->fec_type = bcmPortPhyFecNone;
    data->medium = BCM_PORT_MEDIUM_COPPER;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 30, 0);
    data->an_mode = bcmPortAnModeCL73BAM;
    data->speed = 50000;
    data->nof_lanes = 2;
    data->fec_type = bcmPortPhyFecNone;
    data->medium = BCM_PORT_MEDIUM_BACKPLANE;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 31, 0);
    data->an_mode = bcmPortAnModeCL73BAM;
    data->speed = 50000;
    data->nof_lanes = 2;
    data->fec_type = bcmPortPhyFecNone;
    data->medium = BCM_PORT_MEDIUM_COPPER;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 32, 0);
    data->an_mode = bcmPortAnModeCL73BAM;
    data->speed = 50000;
    data->nof_lanes = 2;
    data->fec_type = bcmPortPhyFecRsFec;
    data->medium = BCM_PORT_MEDIUM_BACKPLANE;
    data->is_valid = dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    data = (dnx_data_nif_eth_supported_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 33, 0);
    data->an_mode = bcmPortAnModeCL73BAM;
    data->speed = 50000;
    data->nof_lanes = 2;
    data->fec_type = bcmPortPhyFecRsFec;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_hw_workarounds_pm_mode_0122_invalid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_global_max_nif_rate_per_core_set;
    data_index = dnx_data_nif_global_define_nof_nif_ports;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_global_nof_nif_ports_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_is_56G_speed_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_average_ipg_in_bits_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_hw_workarounds_pm_mode_0122_invalid_set;
