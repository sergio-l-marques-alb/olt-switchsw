/** \file dbal_init_cb_tables_hard_logic_pp_init_hl_pp_init_egress.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    /** sizes of OUTLIF_0_DECISION + OUTLIF_1_DECISION + OUTLIF_2_DECISION + OUTLIF_3_DECISION fields  */
...
uint32 * offset)
{
    ...
    /** sizes of OUTLIF_0_DECISION + OUTLIF_1_DECISION + OUTLIF_2_DECISION + OUTLIF_3_DECISION fields  */
    full_result_size += 1 + 2 + 2 + 2;
    /** size of OUTLIF_0_DECISION field  */
...
uint32 * offset)
{
    ...
    /** size of OUTLIF_0_DECISION field  */
    result_size__outlif_0_decision += 1;
    /** size of OUTLIF_1_DECISION field  */
...
uint32 * offset)
{
    ...
    /** size of OUTLIF_1_DECISION field  */
    result_size__outlif_1_decision += 2;
    /** size of OUTLIF_2_DECISION field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_FULL_KEY_VALUE(unit, eh, full_key_value);
    /** sizes of INLIF_DECISION_0 + INLIF_DECISION_1 fields  */
...
uint32 * offset)
{
    ...
    /** sizes of INLIF_DECISION_0 + INLIF_DECISION_1 fields  */
    full_result_size += 1 + 1;
    /** size of INLIF_DECISION_0 field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_FULL_KEY_VALUE(unit, eh, full_key_value);
    /** size of FWD_PLUS_1_REMARK_INGRESS_PROFILE field  */
