 ...
 */
static shr_error_e
jr2_a0_dnx_data_dram_hbm_channel_broadcast_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_dram_hbm_hbc_physical_last_in_chain_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_hbm_channel_broadcast_id_set;
    data_index = dnx_data_dram_hbm_define_hbc_physical_last_in_chain;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_hbm_hbc_physical_last_in_chain_set;
