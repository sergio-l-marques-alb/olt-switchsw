/** \file dnx/swstate/auto_generated/diagnostic/dnx_egr_db_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_egr_db
...
/*
 *
 * dump function for the variable ps
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable allocation_bmap
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_egr_db_ps_allocation_bmap_dump(int  unit,  int  allocation_bmap_idx_0,  int  allocation_bmap_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    int i1 = allocation_bmap_idx_1, I1 = allocation_bmap_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
/*
 *
 * dump function for the variable prio_mode
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_egr_db_ps_prio_mode_dump(int  unit,  int  prio_mode_idx_0,  int  prio_mode_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    int i1 = prio_mode_idx_1, I1 = prio_mode_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
/*
 *
 * dump function for the variable if_idx
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_egr_db_ps_if_idx_dump(int  unit,  int  if_idx_idx_0,  int  if_idx_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    int i1 = if_idx_idx_1, I1 = if_idx_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
/*
 *
 * dump function for the variable interface_occ
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_egr_db_interface_occ_dump(int  unit,  int  interface_occ_idx_0,  int  interface_occ_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    int i1 = interface_occ_idx_1, I1 = interface_occ_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
/*
 *
 * dump function for the variable total_egr_if_credits
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
