/** \file dbal_init_cb_tables_hard_logic_pp_mpls_hl_pp_mpls.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    /** size of MPLS_SPECIAL_LABEL_PROFILE field  */
    full_result_size += dnx_data_aod_sizes.AOD.sizes_get(unit, 86)->value;
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_FULL_KEY_VALUE(unit, eh, full_key_value);
    /** sizes of LABELS_TO_TERMINATE + BEFORE_TUNNEL + AFTER_TUNNEL + PHB_COMPARE_STRENGTH + RM_COMPARE_STRENGTH + ECN_COMPARE_STRENGTH + TTL_COMPARE_STRENGTH + PHB_PROPAGATION_STRENGTH + RM_PROPAGATION_STRENGTH + ECN_PROPAGATION_STRENGTH + TTL_PROPAGATION_STRENGTH + QOS_MAPPING_PROFILE + ECN_MAPPING_PROFILE + FORCE_NEXT_PARSER_CONTEXT_ENABLE + FORCE_NEXT_PARSER_CONTEXT_VALUE + FORCE_HAS_CW + FORCE_IS_OAM + CHECK_BOS + EXPECTED_BOS + CHECK_TTL + EXPECTED_TTL fields  */
...
shr_error_e
mpls_special_label_profile_attributes_before_tunnel_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
...
shr_error_e
mpls_special_label_profile_attributes_after_tunnel_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
...
shr_error_e
mpls_special_label_profile_attributes_rm_compare_strength_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
...
shr_error_e
mpls_special_label_profile_attributes_rm_propagation_strength_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
...
shr_error_e
mpls_special_label_profile_attributes_force_next_parser_context_enable_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
...
shr_error_e
mpls_special_label_profile_attributes_force_next_parser_context_value_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
...
uint32 * offset)
{
    ...
    uint32 instance_idx;
    SHR_FUNC_INIT_VARS(unit);
    /** size of FHEI_POP_TTL_MODEL field  */
...
uint32 * offset)
{
    ...
    uint32 instance_idx;
    SHR_FUNC_INIT_VARS(unit);
    /** size of FHEI_POP_QOS_MODEL field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_INSTANCE_IDX(unit, current_mapped_field_id, instance_idx);
    *offset = instance_idx*dnx_data_headers.hw_bug.fhei_mpls_swap_remark_profile_size_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
shr_error_e
mpls_label_range_properties_ingress_mpls_range_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
