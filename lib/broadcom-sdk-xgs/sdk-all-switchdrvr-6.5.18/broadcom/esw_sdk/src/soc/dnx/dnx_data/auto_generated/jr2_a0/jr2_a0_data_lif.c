 ...
 */
static shr_error_e
jr2_a0_dnx_data_lif_global_lif_wa_null_lif_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
/**
 * \brief device level function which set define nof_outlifs_in_eedb_banks
 * define info:
 * The estimated number of entries that are stored in eedb banks.
 * 
 * \param [in] unit - Unit #
 * 
 * \return
 ...
 */
static shr_error_e
jr2_a0_dnx_data_lif_out_lif_nof_outlifs_in_eedb_banks_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_out_lif;
    int define_index = dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = dnx_data_mdb.dh.nof_rows_in_eedb_bank_get(unit)*dnx_data_mdb.eedb.nof_eedb_banks_get(unit)*2;

    /* Set value */
    define->data = dnx_data_mdb.dh.nof_rows_in_eedb_bank_get(unit)*dnx_data_mdb.eedb.nof_eedb_banks_get(unit)*2;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_lif_hw_bug_iop_mode_outlif_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_lif_hw_bug_iop_mode_orientation_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_lif_global_lif_wa_null_lif_set;
    ...
    data_index = dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_lif_out_lif_nof_outlifs_in_eedb_banks_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_lif_hw_bug_iop_mode_outlif_selection_set;
    data_index = dnx_data_lif_hw_bug_iop_mode_orientation_selection;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_lif_hw_bug_iop_mode_orientation_selection_set;
