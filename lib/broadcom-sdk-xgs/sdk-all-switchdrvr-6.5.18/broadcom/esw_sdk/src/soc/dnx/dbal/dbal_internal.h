 ...
 */
shr_error_e dbal_init_internal(
    int unit);
/**
...
/**
 * \brief Function return the field index in table (the the fields array) according to input parameters.
...
uint8 dbal_logical_table_is_out_lif_allocator_eedb(
    CONST dbal_logical_table_t * table);
uint8 dbal_logical_table_is_out_lif_or_rif_allocator_eedb(
    CONST dbal_logical_table_t * table);
...
/**
 * \brief
 * Load the dbal pre compiled xmls, first parse and dispatch to relevant cb
 */
shr_error_e dbal_dynamic_updates_pre_compiled(
    int unit,
    dbal_dynamic_xml_add_f dbal_dynamic_xml_add);
...
/**
 * \brief - Calculate the arr prefix size and arr prefix value
 *        for the field.
 * arr prefix: value that will be used to complete the value of
 * the field.
 * 
 * \param [in] unit - unit id
 * \param [out] arr_prefix_size - arr prefix size for the field
 * \param [out] arr_prefix_value - arr prefix value for the
 *        field
 ...
 *   * None
 */
shr_error_e dbal_field_arr_prefix_calculate(
    int unit,
