...
/**
 * \brief device level function which set define max_nif_rate_per_core
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_nif_global_max_nif_rate_per_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_global;
    int define_index = dnx_data_nif_global_define_max_nif_rate_per_core;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 1740800000;

    /* Set value */
    define->data = 1740800000;
...
/**
 * \brief device level function which set define nof_nif_ports
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_nif_global_nof_nif_ports_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_global;
    int define_index = dnx_data_nif_global_define_nof_nif_ports;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
     ...
     * Set key sizes
     */
    table->keys[0].size = dnx_data_nif.global.nof_nif_ports_get(unit);
    table->info_get.key_size[0] = dnx_data_nif.global.nof_nif_ports_get(unit);
 ...
 */
static shr_error_e
q2a_a0_dnx_data_nif_ilkn_fabric_pms_set(
    int unit)
{
    int pm_id_index;
...
/**
 * \brief device level function which set define average_ipg_in_bits
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_nif_eth_average_ipg_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_average_ipg_in_bits;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set values for table mac_tx_threshold_table
 ...
 */
static shr_error_e
q2a_a0_dnx_data_nif_flexe_mac_tx_threshold_table_set(
    int unit)
{
    int idx_index;
    dnx_data_nif_flexe_mac_tx_threshold_table_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_flexe;
    int table_index = dnx_data_nif_flexe_table_mac_tx_threshold_table;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->values[1].default_val = "0";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_flexe_mac_tx_threshold_table_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_nif_flexe_table_mac_tx_threshold_table");

    /* Store Default Values */
    default_data = (dnx_data_nif_flexe_mac_tx_threshold_table_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->speed = 0;
    default_data->tx_thr = 0;
    /* Set Default Values */
    for (idx_index = 0; idx_index < table->keys[0].size; idx_index++)
    {
        data = (dnx_data_nif_flexe_mac_tx_threshold_table_t *) dnxc_data_mgmt_table_data_get(unit, table, idx_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    /*
     * Set Values - Entries
     */
    data = (dnx_data_nif_flexe_mac_tx_threshold_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    data->speed = 50000;
    data->tx_thr = 4;
    data = (dnx_data_nif_flexe_mac_tx_threshold_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
    data->speed = 100000;
    data->tx_thr = 5;
    data = (dnx_data_nif_flexe_mac_tx_threshold_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
    data->speed = 200000;
    data->tx_thr = 6;
    data = (dnx_data_nif_flexe_mac_tx_threshold_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
    data->speed = 400000;
    data->tx_thr = 7;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_nif_hw_workarounds_pm_mode_0122_invalid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_global_define_max_nif_rate_per_core;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_global_max_nif_rate_per_core_set;
    data_index = dnx_data_nif_global_define_nof_nif_ports;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_global_nof_nif_ports_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_nif_ilkn_fabric_pms_set;
    ...
    data_index = dnx_data_nif_eth_define_average_ipg_in_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_eth_average_ipg_in_bits_set;
    ...
    data_index = dnx_data_nif_flexe_table_mac_tx_threshold_table;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_nif_flexe_mac_tx_threshold_table_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_nif_hw_workarounds_pm_mode_0122_invalid_set;
