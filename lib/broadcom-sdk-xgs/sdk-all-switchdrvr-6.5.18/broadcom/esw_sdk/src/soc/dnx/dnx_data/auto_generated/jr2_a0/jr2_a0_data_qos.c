 ...
 */
static shr_error_e
jr2_a0_dnx_data_qos_hw_bug_egress_remark_or_keep_enabler_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_qos_hw_bug_fwd_eve_pcp_diff_encap_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_qos_hw_bug_phb_rm_ffc_extend_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_qos_hw_bug_phb_rm_ffc_bits_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_qos;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_qos_hw_bug_phb_rm_ffc_bits_width_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_hw_bug_egress_remark_or_keep_enabler_set;
    data_index = dnx_data_qos_hw_bug_fwd_eve_pcp_diff_encap;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_hw_bug_fwd_eve_pcp_diff_encap_set;
    data_index = dnx_data_qos_hw_bug_phb_rm_ffc_extend;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_hw_bug_phb_rm_ffc_extend_set;
