/** \file dbal_init_cb_tables_hard_logic_tm_hl_tm_esb_definition.c
 * Logical DB enums \n 
...
shr_error_e
esb_per_queue_config_null_entryoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__esp_q_num;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ESP_Q_NUM, key_value__esp_q_num);
    *offset = key_value__esp_q_num;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
