 ...
 */
static shr_error_e
q2a_a0_dnx_data_l3_fec_max_default_fec_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_l3_rif_nof_rifs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_l3_hw_bug_fec_hit_bit_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_l3_hw_bug_fer_fec_granularity_double_size_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_l3_fec_max_default_fec_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_l3_rif_nof_rifs_set;
    ...
    feature->set = q2a_a0_dnx_data_l3_hw_bug_fec_hit_bit_set;
    data_index = dnx_data_l3_hw_bug_fer_fec_granularity_double_size;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_l3_hw_bug_fer_fec_granularity_double_size_set;
