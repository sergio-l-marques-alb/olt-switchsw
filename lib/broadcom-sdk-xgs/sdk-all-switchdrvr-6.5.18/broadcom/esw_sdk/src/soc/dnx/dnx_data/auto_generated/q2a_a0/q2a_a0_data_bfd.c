 ...
 */
static shr_error_e
q2a_a0_dnx_data_bfd_hw_bug_detect_multiplier_limitation_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_bfd_hw_bug_detect_multiplier_limitation_set;
