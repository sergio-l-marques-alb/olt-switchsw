 ...
 */
static shr_error_e
jr2_a0_dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_hw_bug;
    int feature_index = dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_headers_hw_bug_unknown_address_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_headers_hw_bug_fhei_mpls_swap_remark_profile_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_hw_bug;
    int define_index = dnx_data_headers_hw_bug_define_fhei_mpls_swap_remark_profile_size;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
     ...
     * Attach defines: 
     */
    data_index = dnx_data_headers_hw_bug_define_fhei_mpls_swap_remark_profile_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_hw_bug_fhei_mpls_swap_remark_profile_size_set;

    /*
     * Attach features: 
     */
    data_index = dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei_set;
    data_index = dnx_data_headers_hw_bug_unknown_address;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_headers_hw_bug_unknown_address_set;
