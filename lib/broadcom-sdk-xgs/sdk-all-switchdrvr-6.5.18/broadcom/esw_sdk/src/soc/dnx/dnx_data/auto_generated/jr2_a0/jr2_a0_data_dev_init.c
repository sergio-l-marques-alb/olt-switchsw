    ...
    int unit)
{
    ...
    data->value = 142800;
    data = (dnx_data_dev_init_time_appl_step_thresh_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_FP_WA_OAM_INDEX, 0);
    data->value = 154800;
    ...
    data->value = 224400;
    data = (dnx_data_dev_init_time_appl_step_thresh_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_FP_WA_APPS, 0);
    data->value = 225600;
...
/**
 * \brief device level function which set numeric reset_mode
 * numeric info:
    ...
    int unit)
{
     ...
     * Set key sizes
     */
    table->keys[0].size = 219;
    table->info_get.key_size[0] = 219;
 ...
 */
/**
 * \brief device level function which set numeric pci_cmc
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_dev_init_cmc_pci_cmc_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_cmc;
    int define_index = dnx_data_dev_init_cmc_define_pci_cmc;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = spn_PCI_CMC;
    define->property.doc = 
        "\n"
...
/**
 * \brief device level function which set numeric pci_cmcs_num
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_dev_init_cmc_pci_cmcs_num_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_cmc;
    int define_index = dnx_data_dev_init_cmc_define_pci_cmcs_num;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
     ...
     * Attach defines: 
     */
    data_index = dnx_data_dev_init_cmc_define_pci_cmc;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_cmc_pci_cmc_set;
    data_index = dnx_data_dev_init_cmc_define_pci_cmcs_num;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_cmc_pci_cmcs_num_set;
