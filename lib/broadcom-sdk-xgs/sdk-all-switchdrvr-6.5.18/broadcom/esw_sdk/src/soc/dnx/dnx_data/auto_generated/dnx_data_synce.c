/** \file dnx_data_synce.c
 * 
 * MODULE DEVICE DATA - SYNCE
 * 
 * Device Data
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_synce_general_synce_no_sdm_mode].labels[0] = "j2p_notrev";
    ...
    submodule_data->features[dnx_data_synce_general_synce_nmg_chain_select].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_plls].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_nif_div_min].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_nif_div_max].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_fabric_div_min].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_fabric_div_max].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_clk_blocks].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_fabric_clk_blocks].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_synce_general_define_output_clk_mode].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_synce_general_table_cfg].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_synce_general_table_nmg_chain_map].labels[0] = "j2p_notrev";
