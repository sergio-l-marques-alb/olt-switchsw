/** \file dnx_data_switch.c
 * 
 * MODULE DEVICE DATA - SWITCH
 * 
 * Device Data
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_mpls_stack_split_hashing].name = "mpls_stack_split_hashing";
    submodule_data->defines[dnx_data_switch_load_balancing_define_mpls_stack_split_hashing].doc = "Indicate whether the MPLS stacks are split in two - terminated and non-terminated.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_switch_load_balancing_define_mpls_stack_split_hashing].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_switch_load_balancing_mpls_stack_split_hashing_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_switch, dnx_data_switch_submodule_load_balancing, dnx_data_switch_load_balancing_define_mpls_stack_split_hashing);
}

/*
 * load_balancing tables
 */
/* Table Get */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "switch related hw bug";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_switch_hw_bug_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data switch hw_bug features");

    submodule_data->features[dnx_data_switch_hw_bug_mpls_labels_included_in_hash].name = "mpls_labels_included_in_hash";
    submodule_data->features[dnx_data_switch_hw_bug_mpls_labels_included_in_hash].doc = "mpls labels content doesn't participate in the build of the LB keys.";
    submodule_data->features[dnx_data_switch_hw_bug_mpls_labels_included_in_hash].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_switch_hw_bug_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data switch hw_bug defines");

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_switch_hw_bug_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data switch hw_bug tables");
 ...
 */
int
dnx_data_switch_hw_bug_feature_get(
    int unit,
    dnx_data_switch_hw_bug_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_switch, dnx_data_switch_submodule_hw_bug, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_switch_hw_bug_init(unit, &module_data->submodules[dnx_data_switch_submodule_hw_bug]));
    /*
