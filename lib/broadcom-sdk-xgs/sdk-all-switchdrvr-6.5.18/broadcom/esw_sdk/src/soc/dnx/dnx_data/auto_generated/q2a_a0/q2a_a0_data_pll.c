 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_general_bs_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll1_ts_phase_initial_hi_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll1_ts_refclk_source_internal_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll1_ts_phase_initial_lo_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll1_ts_phase_initial_hi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll1_ts_nof_bits_hi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
/**
 * \brief device level function which set numeric nif_pll1_id
 * numeric info:
...
/**
 * \brief device level function which set numeric flexe_pll1_id
 * numeric info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll3_nif_pll_set(
    int unit)
{
    int pll_index_index;
     ...
     * Set Values - Entries
     */
    data = (dnx_data_pll_pll3_nif_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
 ...
 */
static shr_error_e
q2a_a0_dnx_data_pll_pll3_fabric_pll_set(
    int unit)
{
    int pll_index_index;
     ...
     * Set Values - Entries
     */
    data = (dnx_data_pll_pll3_fabric_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    data->in_freq = DNX_SERDES_REF_CLOCK_156_25;
    data->out_freq = DNX_SERDES_REF_CLOCK_156_25;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_pll_general_bs_enable_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_ts_phase_initial_lo_set;
    data_index = dnx_data_pll_pll1_define_ts_phase_initial_hi;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_ts_phase_initial_hi_set;
    data_index = dnx_data_pll_pll1_define_ts_nof_bits_hi;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_ts_nof_bits_hi_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_pll_pll1_ts_phase_initial_hi_config_set;
    data_index = dnx_data_pll_pll1_ts_refclk_source_internal;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_pll_pll1_ts_refclk_source_internal_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_pll_pll3_nif_pll_set;
    data_index = dnx_data_pll_pll3_table_fabric_pll;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_pll_pll3_fabric_pll_set;
    /*
