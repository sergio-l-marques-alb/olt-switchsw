    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lif_global_lif_define_wa_null_lif].name = "wa_null_lif";
    submodule_data->defines[dnx_data_lif_global_lif_define_wa_null_lif].doc = "ERPP GLEM trap requires NULL LIF to be added to GLEM by default.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_lif_global_lif_define_wa_null_lif].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_lif_global_lif_wa_null_lif_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_global_lif, dnx_data_lif_global_lif_define_wa_null_lif);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks].name = "nof_outlifs_in_eedb_banks";
    submodule_data->defines[dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks].doc = "The estimated number of entries that are stored in eedb banks.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_lif_out_lif_nof_outlifs_in_eedb_banks_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_out_lif, dnx_data_lif_out_lif_define_nof_outlifs_in_eedb_banks);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "lif hw bugs";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_lif_hw_bug_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data lif hw_bug features");

    submodule_data->features[dnx_data_lif_hw_bug_iop_mode_outlif_selection].name = "iop_mode_outlif_selection";
    submodule_data->features[dnx_data_lif_hw_bug_iop_mode_outlif_selection].doc = "IOP mode incorrect outlif selection";
    submodule_data->features[dnx_data_lif_hw_bug_iop_mode_outlif_selection].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_lif_hw_bug_iop_mode_orientation_selection].name = "iop_mode_orientation_selection";
    submodule_data->features[dnx_data_lif_hw_bug_iop_mode_orientation_selection].doc = "IOP mode incorrect lif profile key selection for orientation";
    submodule_data->features[dnx_data_lif_hw_bug_iop_mode_orientation_selection].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_lif_hw_bug_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data lif hw_bug defines");

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_lif_hw_bug_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data lif hw_bug tables");
 ...
 */
int
dnx_data_lif_hw_bug_feature_get(
    int unit,
    dnx_data_lif_hw_bug_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_hw_bug, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_lif_hw_bug_init(unit, &module_data->submodules[dnx_data_lif_submodule_hw_bug]));
    /*
