 ...
 */
static shr_error_e
j2p_a0_dnx_data_l3_ecmp_group_size_nof_bits_set(
    int unit)
{
 ...
 */
static shr_error_e
j2p_a0_dnx_data_l3_hw_bug_ipv6_mc_compatible_dmac_set(
    int unit)
{
 ...
 */
static shr_error_e
j2p_a0_dnx_data_l3_hw_bug_fec_hit_bit_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_l3_hw_bug_mc_bridge_fallback_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_hw_bug;
    int feature_index = dnx_data_l3_hw_bug_mc_bridge_fallback;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_l3_ecmp_group_size_nof_bits_set;
    ...
    feature->set = j2p_a0_dnx_data_l3_hw_bug_ipv6_mc_compatible_dmac_set;
    data_index = dnx_data_l3_hw_bug_fec_hit_bit;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_l3_hw_bug_fec_hit_bit_set;
    data_index = dnx_data_l3_hw_bug_mc_bridge_fallback;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_l3_hw_bug_mc_bridge_fallback_set;
