...
extern shr_error_e jr2_a0_data_lane_map_attach(
    int unit);
extern shr_error_e j2c_a0_data_lane_map_attach(
    int unit);
extern shr_error_e q2a_a0_data_lane_map_attach(
    int unit);
/*
 * SUBMODULE - NIF:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_lane_map_nif_table_mapping].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lane_map_fabric_define_resolution].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_lane_map_fabric_table_mapping].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_lane_map_ilkn_table_remapping].labels[0] = "j2p_notrev";
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_lane_map_attach(unit));
        SHR_IF_ERR_EXIT(j2c_a0_data_lane_map_attach(unit));
    }
    else
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_lane_map_attach(unit));
        SHR_IF_ERR_EXIT(q2a_a0_data_lane_map_attach(unit));
    }
    else
