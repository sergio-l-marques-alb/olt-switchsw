...
/**
 * \brief device level function which set define max_etpp_counting_profile_value
 * define info:
...
/**
 * \brief device level function which set define max_etpp_metering_profile_value
 * define info:
...
/**
 * \brief device level function which set define etpp_enc_stat_cmd_is_reversed
 * define info:
...
/**
 * \brief device level function which set define etpp_egress_vsi_always_pushed
 * define info:
...
/**
 * \brief device level function which set define irpp_start_profile_value
 * define info:
...
/**
 * \brief device level function which set define erpp_start_profile_value
 * define info:
...
/**
 * \brief device level function which set define etpp_start_profile_value
 * define info:
...
/**
 * \brief device level function which set define etpp_counting_start_profile_value
 * define info:
...
/**
 * \brief device level function which set define etpp_metering_start_profile_value
 * define info:
 ...
 */
/**
 * \brief device level function which set values for table ovf_info
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_stat_diag_counter_ovf_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_stat_diag_counter_table_ovf_info");
 ...
 */
/**
 * \brief device level function which set values for table group_drop_reason_index
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_stat_drop_reasons_group_drop_reason_index_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_stat_drop_reasons_table_group_drop_reason_index");
...
/**
 * \brief device level function which set values for table drop_reason_index
    ...
    int unit)
{
    ...
    table->values[0].default_val = "-1";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_stat_drop_reasons_drop_reason_index_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_stat_drop_reasons_table_drop_reason_index");
...
/**
 * \brief device level function which set values for table drop_reasons_groups
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_stat_drop_reasons_drop_reasons_groups_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_stat_drop_reasons_table_drop_reasons_groups");
