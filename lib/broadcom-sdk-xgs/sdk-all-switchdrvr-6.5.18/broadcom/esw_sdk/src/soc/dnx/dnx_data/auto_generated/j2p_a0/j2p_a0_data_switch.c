 ...
 */
static shr_error_e
j2p_a0_dnx_data_switch_load_balancing_mpls_stack_split_hashing_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_switch_hw_bug_mpls_labels_included_in_hash_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_switch_load_balancing_mpls_stack_split_hashing_set;
    ...
    feature->set = j2p_a0_dnx_data_switch_hw_bug_mpls_labels_included_in_hash_set;
