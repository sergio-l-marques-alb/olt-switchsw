    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_pll_general_ts_freq_lock].labels[0] = "j2p_notrev";
    ...
    submodule_data->features[dnx_data_pll_general_bs_enable].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_pll_pll1_ts_phase_initial_hi_config].labels[0] = "j2p_notrev";
    ...
    submodule_data->features[dnx_data_pll_pll1_ts_refclk_source_internal].labels[0] = "j2p_notrev";
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_nof_pll1].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_ts_phase_initial_lo].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_ts_phase_initial_hi].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_ts_nof_bits_hi].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_ts_pll1_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_bs_pll1_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_fab_pll1_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_nif_pll1_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll1_define_flexe_pll1_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_pll_pll1_table_config].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_nof_pll3].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_vco_clock].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_kp].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_ki].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_en_ctrl].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_en_ctrl_byp].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_route_ctr_byp].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_ref_clock_125].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_ref_clock_156_25].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_ref_clock_312_5].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_nif0_pll3_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_nif1_pll3_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_mas0_pll3_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll3_define_mas1_pll3_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_pll_pll3_table_config].labels[0] = "j2p_notrev";
     ...
     * Table - nif_pll
     */
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].name = "nif_pll";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].doc = "NIF PLL reference and output frequencies";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].labels[0] = "j2p_notrev";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].size_of_values = sizeof(dnx_data_pll_pll3_nif_pll_t);
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].entry_get = dnx_data_pll_pll3_nif_pll_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].nof_keys = 1;
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].keys[0].name = "pll_index";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].keys[0].doc = "Index of NIF PLL (0 or 1)";

    /* Values */
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values, dnxc_data_value_t, submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].nof_values, "_dnx_data_pll_pll3_table_nif_pll table values");
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[0].name = "in_freq";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[0].type = "int";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[0].doc = "Reference clock frequency for the NIF SerDeses";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[0].offset = UTILEX_OFFSETOF(dnx_data_pll_pll3_nif_pll_t, in_freq);
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[1].name = "out_freq";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[1].type = "int";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[1].doc = "Output clock frequency for the NIF SerDeses";
    submodule_data->tables[dnx_data_pll_pll3_table_nif_pll].values[1].offset = UTILEX_OFFSETOF(dnx_data_pll_pll3_nif_pll_t, out_freq);

    /*
     * Table - fabric_pll
     */
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].name = "fabric_pll";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].doc = "Fabric PLL reference and output frequencies";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].labels[0] = "j2p_notrev";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].size_of_values = sizeof(dnx_data_pll_pll3_fabric_pll_t);
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].entry_get = dnx_data_pll_pll3_fabric_pll_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].nof_keys = 1;
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].keys[0].name = "pll_index";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].keys[0].doc = "Index of Fabric PLL (0 or 1)";

    /* Values */
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values, dnxc_data_value_t, submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].nof_values, "_dnx_data_pll_pll3_table_fabric_pll table values");
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[0].name = "in_freq";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[0].type = "int";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[0].doc = "Output clock frequency for the Fabric SerDeses";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[0].offset = UTILEX_OFFSETOF(dnx_data_pll_pll3_fabric_pll_t, in_freq);
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[1].name = "out_freq";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[1].type = "int";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[1].doc = "Output clock frequency for the Fabric SerDeses";
    submodule_data->tables[dnx_data_pll_pll3_table_fabric_pll].values[1].offset = UTILEX_OFFSETOF(dnx_data_pll_pll3_fabric_pll_t, out_freq);
...
const dnx_data_pll_pll3_nif_pll_t *
dnx_data_pll_pll3_nif_pll_get(
    int unit,
    int pll_index)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_pll3, dnx_data_pll_pll3_table_nif_pll);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, pll_index, 0);
    return (const dnx_data_pll_pll3_nif_pll_t *) data;

}

const dnx_data_pll_pll3_fabric_pll_t *
dnx_data_pll_pll3_fabric_pll_get(
    int unit,
    int pll_index)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_pll3, dnx_data_pll_pll3_table_fabric_pll);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, pll_index, 0);
    return (const dnx_data_pll_pll3_fabric_pll_t *) data;
...
shr_error_e
dnx_data_pll_pll3_nif_pll_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_pll_pll3_nif_pll_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_pll3, dnx_data_pll_pll3_table_nif_pll);
    data = (const dnx_data_pll_pll3_nif_pll_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
shr_error_e
dnx_data_pll_pll3_fabric_pll_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_pll_pll3_fabric_pll_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_pll3, dnx_data_pll_pll3_table_fabric_pll);
    data = (const dnx_data_pll_pll3_fabric_pll_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->in_freq);
...
const dnxc_data_table_info_t *
dnx_data_pll_pll3_nif_pll_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_pll3, dnx_data_pll_pll3_table_nif_pll);

}

const dnxc_data_table_info_t *
dnx_data_pll_pll3_fabric_pll_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_pll3, dnx_data_pll_pll3_table_fabric_pll);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_nof_pll4].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_ts_pll4_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_bs_pll4_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_nif_pll4_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_fab_pll4_id].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].labels[0] = "j2p_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_pll_synce_pll_present].labels[0] = "j2p_notrev";
