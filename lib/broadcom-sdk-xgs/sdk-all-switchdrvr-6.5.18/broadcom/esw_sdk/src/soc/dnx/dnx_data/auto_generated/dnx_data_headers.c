/** \file dnx_data_headers.c
 * 
 * MODULE DEVICE DATA - HEADERS
 * 
 * Device Data
...
/*
 * fhei_trap_sniff_legacy features
 */
int
...
/*
 * fhei_trap_sniff_legacy defines
 */
uint32
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "Bugs related to system header construction";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_headers_hw_bug_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data headers hw_bug features");

    submodule_data->features[dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei].name = "fhei_mpls_cmd_from_eei";
    submodule_data->features[dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei].doc = "If set, means MPLS command in FHEI is from EEI[23:20], else configured globally";
    submodule_data->features[dnx_data_headers_hw_bug_fhei_mpls_cmd_from_eei].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_headers_hw_bug_unknown_address].name = "unknown_address";
    submodule_data->features[dnx_data_headers_hw_bug_unknown_address].doc = "If set, FAI[0] indicates forwarding lookup result, else FAI[0] is not for unknown address";
    submodule_data->features[dnx_data_headers_hw_bug_unknown_address].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_headers_hw_bug_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data headers hw_bug defines");

    submodule_data->defines[dnx_data_headers_hw_bug_define_fhei_mpls_swap_remark_profile_size].name = "fhei_mpls_swap_remark_profile_size";
    submodule_data->defines[dnx_data_headers_hw_bug_define_fhei_mpls_swap_remark_profile_size].doc = "Size of remark_profile mapped from mpls swap command";
    /* Set data type flag */
    submodule_data->defines[dnx_data_headers_hw_bug_define_fhei_mpls_swap_remark_profile_size].flags |= DNXC_DATA_F_DEFINE;

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_headers_hw_bug_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data headers hw_bug tables");
 ...
 */
int
dnx_data_headers_hw_bug_feature_get(
    int unit,
    dnx_data_headers_hw_bug_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_headers, dnx_data_headers_submodule_hw_bug, feature);
}
 ...
 */
uint32
dnx_data_headers_hw_bug_fhei_mpls_swap_remark_profile_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_headers, dnx_data_headers_submodule_hw_bug, dnx_data_headers_hw_bug_define_fhei_mpls_swap_remark_profile_size);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_headers_hw_bug_init(unit, &module_data->submodules[dnx_data_headers_submodule_hw_bug]));
    /*
