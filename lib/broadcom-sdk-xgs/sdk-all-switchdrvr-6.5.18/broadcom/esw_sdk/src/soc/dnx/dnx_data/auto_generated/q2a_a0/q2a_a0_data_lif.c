 ...
 */
static shr_error_e
q2a_a0_dnx_data_lif_global_lif_wa_null_lif_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_lif_hw_bug_iop_mode_orientation_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_lif_global_lif_wa_null_lif_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_lif_hw_bug_iop_mode_orientation_selection_set;
