/** \file dbal_init_cb_tables_hard_logic_pp_kleap_hl_pp_kleap_fwd12.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    /** size of FWD12_FFC_INSTRUCTION field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_FWD12_KBR_ID, key_value__fwd12_kbr_id);
    /** size of PD_STRENGTH_WIDTH field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_FWD12_KBR_ID, key_value__fwd12_kbr_id);
    /** size of PD_CONST_STRENGTH field  */
