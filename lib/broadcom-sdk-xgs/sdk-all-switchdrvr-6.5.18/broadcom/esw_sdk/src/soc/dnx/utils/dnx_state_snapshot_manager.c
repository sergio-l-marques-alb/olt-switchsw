...
dnx_state_snapshot_manager_is_on(
    int unit)
{
    return dnx_err_recovery_common_is_on(unit, DNXC_ROLLBACK_JOURNAL_TYPE_COMPARISON)
    ...
    int unit)
{
    ...
    dnx_err_recovery_common_flag_clear(unit, DNXC_ROLLBACK_JOURNAL_TYPE_COMPARISON,
    ...
    dnx_err_recovery_common_flag_set(unit, DNXC_ROLLBACK_JOURNAL_TYPE_COMPARISON,
...
dnx_state_comparison_print_journal(
    int unit,
    dnxc_rollback_journal_subtype_e type)
{
    SHR_FUNC_INIT_VARS(unit);
