    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_stat_drop_reasons_define_nof_drop_reasons].labels[0] = "j2p_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_group_drop_reason_index].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reason_index].labels[0] = "j2p_notrev";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reasons_groups].labels[0] = "j2p_notrev";
