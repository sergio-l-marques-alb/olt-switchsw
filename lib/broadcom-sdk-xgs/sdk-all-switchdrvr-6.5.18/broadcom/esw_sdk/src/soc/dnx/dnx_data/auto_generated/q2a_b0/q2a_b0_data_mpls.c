 ...
 */
static shr_error_e
q2a_b0_dnx_data_mpls_general_mpls_term_1_or_2_labels_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_b0_dnx_data_mpls_general_mpls_special_label_encap_handling_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_b0_dnx_data_mpls_general_mpls_second_stage_parser_handling_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mpls;
    ...
    int unit)
{
    ...
    define->set = q2a_b0_dnx_data_mpls_general_mpls_special_label_encap_handling_set;
    data_index = dnx_data_mpls_general_define_mpls_second_stage_parser_handling;
    define = &submodule->defines[data_index];
    define->set = q2a_b0_dnx_data_mpls_general_mpls_second_stage_parser_handling_set;
    ...
    feature->set = q2a_b0_dnx_data_mpls_general_mpls_term_1_or_2_labels_set;
