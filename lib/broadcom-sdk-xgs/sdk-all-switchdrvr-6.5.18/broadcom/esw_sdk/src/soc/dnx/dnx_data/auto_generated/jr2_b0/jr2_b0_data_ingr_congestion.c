/** \file jr2_b0_data_ingr_congestion.c
 * 
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_info_soft_dram_block_supported_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_info_latency_based_admission_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_vsq_size_watermark_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_dbal_admission_test_nof_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_dbal_admission_bits_mapping_set(
    int unit)
{
    int rjct_bit_index;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_mirror_on_drop_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_mirror_on_drop_nof_groups_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_mirror_on_drop_aging_clocks_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
 ...
 */
shr_error_e
jr2_b0_data_ingr_congestion_attach(
    int unit)
{
    ...
    feature->set = jr2_b0_dnx_data_ingr_congestion_info_soft_dram_block_supported_set;
    data_index = dnx_data_ingr_congestion_info_latency_based_admission;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_ingr_congestion_info_latency_based_admission_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_ingr_congestion_vsq_size_watermark_support_set;
    ...
    define->set = jr2_b0_dnx_data_ingr_congestion_dbal_admission_test_nof_set;
    ...
    table->set = jr2_b0_dnx_data_ingr_congestion_dbal_admission_bits_mapping_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_ingr_congestion_mirror_on_drop_nof_groups_set;
    data_index = dnx_data_ingr_congestion_mirror_on_drop_define_aging_clocks_resolution;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_ingr_congestion_mirror_on_drop_aging_clocks_resolution_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_ingr_congestion_mirror_on_drop_is_supported_set;
