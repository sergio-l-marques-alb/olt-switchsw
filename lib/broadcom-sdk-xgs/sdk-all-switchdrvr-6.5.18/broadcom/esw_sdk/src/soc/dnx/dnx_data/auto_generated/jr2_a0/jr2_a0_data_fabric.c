 ...
 */
static shr_error_e
jr2_a0_dnx_data_fabric_general_is_supported_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_a0_dnx_data_fabric_dbal_mesh_topology_status_2_id1_bits_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    ...
    int unit)
{
    ...
    feature->set = jr2_a0_dnx_data_fabric_general_is_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_dbal_mesh_topology_status_2_id1_bits_nof_set;
