    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Values */
    submodule_data->tables[dnx_data_field_stage_table_stage_info].nof_values = 78;
    ...
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].name = "default_strength";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].doc = "Default value for PMF strength";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, default_strength);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].name = "pbus_header_length";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].doc = "Number of bits reserved in Ingress PBUS for header";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, pbus_header_length);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].name = "nof_layer_records";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].doc = "Number of layer records taken from the parser.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_layer_records);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].name = "layer_record_size";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].doc = "Number of bits in each layer record.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, layer_record_size);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].name = "nof_compare_pairs_in_compare_mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].doc = "Number compare pairs in compare mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_compare_pairs_in_compare_mode);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].name = "nof_compare_keys_in_compare_mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].doc = "Number compare keys in compare mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_compare_keys_in_compare_mode);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].name = "compare_key_size";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].doc = "Size of the compare key in the system";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, compare_key_size);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].name = "nof_l4_ops_ranges_legacy";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].doc = "Number of ranges for L4 Ops legacy";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_l4_ops_ranges_legacy);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].name = "nof_ext_l4_ops_ranges";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].doc = "Number of ranges for Extended L4 Ops";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_ext_l4_ops_ranges);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].name = "nof_pkt_hdr_ranges";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].doc = "Number of ranges for PKT HDR";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_pkt_hdr_ranges);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].name = "nof_out_lif_ranges";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].doc = "Number of ranges for Out Lif";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_out_lif_ranges);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].name = "fes_key_select_for_zero_bit";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].doc = "The key select used for obtaining an always zero bit for input to FES (for example, using a zero padded bit).";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fes_key_select_for_zero_bit);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].name = "fes_shift_for_zero_bit";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].doc = "The shift used for obtaining an always zero bit for input to FES (for example, using a zero padded bit).";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fes_shift_for_zero_bit);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].name = "uses_small_exem";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].doc = "Indicated if the stage can perform a SEXEM lookup.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, uses_small_exem);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[74].name = "uses_large_exem";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[74].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[74].doc = "Indicated if the stage can perform a LEXEM lookup.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[74].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, uses_large_exem);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[75].name = "cmp_selection";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[75].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[75].doc = "Compare selection for both keys of 2nd compare, See the CMP_SELECTION field in IPPC_PMF_GENERAL register for additional information";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[75].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, cmp_selection);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[76].name = "nof_bits_main_pbus";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[76].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[76].doc = "Number of bits in the main PBUS of the stage (the one used by METADATA qualifiers). Only iPMF2 uses the iPMF1 PBUs as it's main PBUS.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[76].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_main_pbus);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[77].name = "nof_bits_native_pbus";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[77].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[77].doc = "Number of bits in the native PBUS of the stage, if it is different from the main PBUS. Only iPMF2 has a separate native PBUS.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[77].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_native_pbus);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_context_define_default_j1_learning_2ndpass_context].doc = "Default Context Id for 2nd pass of J1 Learning WA";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_1st_pass_ipmf1].name = "default_j1_learn_wa_presel_id_1st_pass_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_1st_pass_ipmf1].doc = "Default Presel in iPMF1 Learn WA 1st Pass";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_1st_pass_ipmf1].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_2nd_pass_ipmf1].name = "default_j1_learn_wa_presel_id_2nd_pass_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_2nd_pass_ipmf1].doc = "Default Presel in iPMF1 Learn WA 2nd Pass";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_2nd_pass_ipmf1].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_same_port_wa_presel_id_epmf].name = "default_j1_same_port_wa_presel_id_epmf";
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_same_port_wa_presel_id_epmf].doc = "Default Presel in ePMF Same port WA";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_same_port_wa_presel_id_epmf].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_preselector_define_default_learn_limit_wa_presel_id_epmf].name = "default_learn_limit_wa_presel_id_epmf";
    submodule_data->defines[dnx_data_field_preselector_define_default_learn_limit_wa_presel_id_epmf].doc = "Default Presel in ePMF Learn WA";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_preselector_define_default_learn_limit_wa_presel_id_epmf].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_preselector_default_j1_learn_wa_presel_id_1st_pass_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_1st_pass_ipmf1);
}

uint32
dnx_data_field_preselector_default_j1_learn_wa_presel_id_2nd_pass_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_default_j1_learn_wa_presel_id_2nd_pass_ipmf1);
}
...
uint32
dnx_data_field_preselector_default_j1_same_port_wa_presel_id_epmf_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_default_j1_same_port_wa_presel_id_epmf);
}

uint32
dnx_data_field_preselector_default_learn_limit_wa_presel_id_epmf_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_default_learn_limit_wa_presel_id_epmf);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_init_define_wa_jr1_ipmc_inlif].name = "wa_jr1_ipmc_inlif";
    submodule_data->defines[dnx_data_field_init_define_wa_jr1_ipmc_inlif].doc = "APP WA for IPMC In LIF";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_jr1_ipmc_inlif].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_init_define_wa_learn_limit].name = "wa_learn_limit";
    submodule_data->defines[dnx_data_field_init_define_wa_learn_limit].doc = "APP WA for Learn Limit";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_learn_limit].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_j1_php].name = "wa_j1_php";
    submodule_data->defines[dnx_data_field_init_define_wa_j1_php].doc = "APP WA for J1 MPLS PHP";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_j1_php].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_init_wa_jr1_ipmc_inlif_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_jr1_ipmc_inlif);
}
...
uint32
dnx_data_field_init_wa_learn_limit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_learn_limit);
}

uint32
dnx_data_field_init_wa_j1_php_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_j1_php);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_features_define_ecc_wa_enable].name = "ecc_wa_enable";
    submodule_data->defines[dnx_data_field_features_define_ecc_wa_enable].doc = "ECC is calculated per whole entry on each entry write, therefore, when writing half-entries\n                      wrong ECC values is being calculated, this workaround enables read-modify-write of the whole\n                      entry instead of writing half-entries to have correct ECC calculated on each write.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_features_define_ecc_wa_enable].flags |= DNXC_DATA_F_DEFINE;
 ...
 */
uint32
dnx_data_field_features_ecc_wa_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_features, dnx_data_field_features_define_ecc_wa_enable);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_signal_sizes_define_dual_queue_size].doc = "Dual queue added by HWJERICHO2C-55 and increased in size in HWJERICHO2P-127. Not supported in J2, but we still configure a value because the DBAL field needs a size.";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_signal_sizes_define_packet_header_size].doc = "packet_header_size. Changed in HWJERICHO2P-384.";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_signal_sizes_define_ecn].doc = "ECN signal. Changed in HWJERICHO2C-565.";
    /* Set data type flag */
