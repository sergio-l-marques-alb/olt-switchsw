    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_bfd_general_configurable_single_hop_tos].doc = "HW bug: single-hop TOS is not configurable - JR2_A0 only!  Works for B0 and up";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "BFD-related HW bugs";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_bfd_hw_bug_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data bfd hw_bug features");

    submodule_data->features[dnx_data_bfd_hw_bug_detect_multiplier_limitation].name = "detect_multiplier_limitation";
    submodule_data->features[dnx_data_bfd_hw_bug_detect_multiplier_limitation].doc = "HW bug: detect_multiplier is not calculated - JR2_A0 only!  Works for B0 and up";
    submodule_data->features[dnx_data_bfd_hw_bug_detect_multiplier_limitation].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_bfd_hw_bug_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data bfd hw_bug defines");

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_bfd_hw_bug_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data bfd hw_bug tables");
 ...
 */
int
dnx_data_bfd_hw_bug_feature_get(
    int unit,
    dnx_data_bfd_hw_bug_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_bfd, dnx_data_bfd_submodule_hw_bug, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_bfd_hw_bug_init(unit, &module_data->submodules[dnx_data_bfd_submodule_hw_bug]));
    /*
