...
/**
 * \brief device level function which set define wa_null_lif
 * define info:
 ...
 */
static shr_error_e
j2p_a0_dnx_data_lif_global_lif_wa_null_lif_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_global_lif;
    int define_index = dnx_data_lif_global_lif_define_wa_null_lif;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
j2p_a0_dnx_data_lif_hw_bug_iop_mode_outlif_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_hw_bug;
    int feature_index = dnx_data_lif_hw_bug_iop_mode_outlif_selection;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
j2p_a0_dnx_data_lif_hw_bug_iop_mode_orientation_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_hw_bug;
    int feature_index = dnx_data_lif_hw_bug_iop_mode_orientation_selection;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_lif_global_lif_define_wa_null_lif;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_global_lif_wa_null_lif_set;
     ...
     */
    submodule_index = dnx_data_lif_submodule_hw_bug;
    submodule = &module->submodules[submodule_index];
     ...
     * Attach features: 
     */
    data_index = dnx_data_lif_hw_bug_iop_mode_outlif_selection;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_lif_hw_bug_iop_mode_outlif_selection_set;
    data_index = dnx_data_lif_hw_bug_iop_mode_orientation_selection;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_lif_hw_bug_iop_mode_orientation_selection_set;
