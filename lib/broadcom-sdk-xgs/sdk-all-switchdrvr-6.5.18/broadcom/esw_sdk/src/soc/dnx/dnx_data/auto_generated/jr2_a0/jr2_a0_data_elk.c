 ...
 */
/**
 * \brief device level function which set numeric optimized_result
 * numeric info:
...
/**
 * \brief device level function which set numeric split_rpf
 * numeric info:
...
/**
 * \brief device level function which set numeric thread_safety
 * numeric info:
    ...
    int unit)
{
    ...
    define->property.method = dnxc_data_property_method_suffix_enable;
    define->property.method_str = "suffix_enable";
    define->property.suffix = "kbp_thread_safety_enable";
...
/**
 * \brief device level function which set numeric ipv4_large_mc_enable
 * numeric info:
...
/**
 * \brief device level function which set numeric ipv6_large_mc_enable
 * numeric info:
...
/**
 * \brief device level function which set numeric ipv4_mc_hash_table_size
 * numeric info:
...
/**
 * \brief device level function which set numeric ipv6_mc_hash_table_size
 * numeric info:
...
/**
 * \brief device level function which set numeric ipv4_mc_table_size
 * numeric info:
    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = (dnx_data_elk.application.ipv4_large_mc_enable_get(unit) * 31744) + 1024;

    /* Set value */
    define->data = (dnx_data_elk.application.ipv4_large_mc_enable_get(unit) * 31744) + 1024;
...
/**
 * \brief device level function which set numeric ipv6_mc_table_size
 * numeric info:
    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = (dnx_data_elk.application.ipv6_large_mc_enable_get(unit) * 31744) + 1024;

    /* Set value */
    define->data = (dnx_data_elk.application.ipv6_large_mc_enable_get(unit) * 31744) + 1024;
 ...
 */
/**
 * \brief device level function which map key to table indexdb_property
...
/**
 * \brief device level function which maps table index to key db_property
 * Module - 'elk', Submodule - 'application', table - 'db_property'
...
/**
 * \brief device level function which set values for table db_property
 * Module - 'elk', Submodule - 'application', table - 'db_property'
 * DB properties
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_elk_application_db_property_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_elk_application_table_db_property");
    ...
    data->initial_optimized_capacity = 32768;
    data->xl_db = 1;
    data->locality = 0;
    data->zero_size_ad = 0;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_elk_connectivity_mdio_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_elk;
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_elk_connectivity_kbp_serdes_tx_taps_t, (1 + 1 /* to store default value */ ), "data of dnx_data_elk_connectivity_table_kbp_serdes_tx_taps");
    ...
    /* Set Default Values */
    data = (dnx_data_elk_connectivity_kbp_serdes_tx_taps_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    sal_memcpy(data, default_data, table->size_of_values);
    /*
     * Property
     */
    ...
    data = (dnx_data_elk_connectivity_kbp_serdes_tx_taps_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    SHR_IF_ERR_EXIT(dnx_data_property_elk_connectivity_kbp_serdes_tx_taps_read(unit, data));
    /* Set data flags as property */
    table->flags |= (DNXC_DATA_F_PROPERTY);
...
/**
 * \brief device level function which set values for table kbp_lane_serdes_tx_taps
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_elk_connectivity_kbp_lane_serdes_tx_taps_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_elk_connectivity_table_kbp_lane_serdes_tx_taps");
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_elk_connectivity_mdio_id_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_elk_connectivity_blackhole_set;
