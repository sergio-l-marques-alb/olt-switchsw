    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = spn_RIF_ID_MAX;
    define->property.doc = 
        "\n"
        "Default: 4096\n"
        "\n"
    ...
    define->property.range_max = dnx_data_l3.rif.max_nof_rifs_get(unit)-1;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_ecmp_members_table_size_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_ecmp_first_valid_ecmp_group_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
/**
 * \brief device level function which set define max_nof_fec_ecmp_tables
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_ecmp_max_nof_fec_ecmp_tables_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_ecmp;
    int define_index = dnx_data_l3_ecmp_define_max_nof_fec_ecmp_tables;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_hw_bug_ipv6_mc_compatible_dmac_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_hw_bug_fec_hit_bit_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_hw_bug_fer_fec_granularity_double_size_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_hw_bug;
    int feature_index = dnx_data_l3_hw_bug_fer_fec_granularity_double_size;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_l3_hw_bug_mc_bridge_fallback_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l3_ecmp_members_table_size_in_bits_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l3_ecmp_first_valid_ecmp_group_id_set;
    data_index = dnx_data_l3_ecmp_define_nof_ecmp;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l3_ecmp_nof_ecmp_set;
    data_index = dnx_data_l3_ecmp_define_max_nof_fec_ecmp_tables;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l3_ecmp_max_nof_fec_ecmp_tables_set;
    ...
    feature->set = jr2_a0_dnx_data_l3_hw_bug_ipv6_mc_compatible_dmac_set;
    data_index = dnx_data_l3_hw_bug_fec_hit_bit;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_hw_bug_fec_hit_bit_set;
    data_index = dnx_data_l3_hw_bug_fer_fec_granularity_double_size;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_hw_bug_fer_fec_granularity_double_size_set;
    data_index = dnx_data_l3_hw_bug_mc_bridge_fallback;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_hw_bug_mc_bridge_fallback_set;
