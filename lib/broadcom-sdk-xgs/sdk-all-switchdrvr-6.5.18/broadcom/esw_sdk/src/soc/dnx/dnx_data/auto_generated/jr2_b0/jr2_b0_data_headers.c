 ...
 */
static shr_error_e
jr2_b0_dnx_data_headers_hw_bug_unknown_address_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_hw_bug;
    int feature_index = dnx_data_headers_hw_bug_unknown_address;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
     ...
     */
    submodule_index = dnx_data_headers_submodule_hw_bug;
    submodule = &module->submodules[submodule_index];
     ...
     * Attach features: 
     */
    data_index = dnx_data_headers_hw_bug_unknown_address;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_headers_hw_bug_unknown_address_set;
