 ...
 */
static shr_error_e
jr2_a0_dnx_data_trap_erpp_ip_4_6_l4_traps_enabled_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_erpp;
    int feature_index = dnx_data_trap_erpp_ip_4_6_l4_traps_enabled;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_trap_erpp_ip_4_6_l4_traps_enabled;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_erpp_ip_4_6_l4_traps_enabled_set;
