...
uint32 * offset)
{
    ...
    /** size of PDQ_SRAM_FC_TH_SELECT field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PRIORITY, key_value__priority);
    /** size of PDQ_MIXS_FC_TH_SELECT field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PRIORITY, key_value__priority);
    /** size of PDQ_MIXD_FC_TH_SELECT field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PRIORITY, key_value__priority);
    /** size of PDQ_MIX_MIXS_FC_TH_SELECT field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PRIORITY, key_value__priority);
    /** size of PDQ_MIX_MIXD_FC_TH_SELECT field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PRIORITY, key_value__priority);
    /** size of PDQ_SRAM_TO_DRAM_FC_TH_SELECT field  */
