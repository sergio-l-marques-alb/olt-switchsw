 ...
 */
static shr_error_e
q2a_a0_dnx_data_snif_egress_probability_sample_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = q2a_a0_dnx_data_snif_egress_probability_sample_set;
