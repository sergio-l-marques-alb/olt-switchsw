...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, cur_table_param, table_entry, DBAL_TABLE_SRV6_GLOBAL_CONFIGURATION /* table id*/, TRUE /* is valid*/, &is_valid /* is valid value*/, "SRV6_GLOBAL_CONFIGURATION" /* table name*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    /** interface results  */
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_field(unit, db_field, DBAL_FIELD_SRV6_EXTENSION_HEADER_TYPE /* field id*/, TRUE /* Valid*/, 0 /* Size*/, 0 /* Offset*/, DBAL_DB_INVALID /* MaxValue*/, 0 /* MinValue*/, NULL /* ConstValue*/, 1 /* NofInstance*/, DBAL_PERMISSION_ALL /* Permission*/, FALSE /* ReverseOrder*/, DBAL_FIELD_TYPE_DEF_IPV6_EXTENSION_HEADER_TYPE /* Type*/));
        result_field_counter++;
        db_field = &cur_table_param->results_set[result_type_counter].result_fields[result_field_counter];
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_field(unit, db_field, DBAL_FIELD_IPV6_ETHERTYPE /* field id*/, TRUE /* Valid*/, 0 /* Size*/, 0 /* Offset*/, DBAL_DB_INVALID /* MaxValue*/, 0 /* MinValue*/, NULL /* ConstValue*/, 1 /* NofInstance*/, DBAL_PERMISSION_ALL /* Permission*/, FALSE /* ReverseOrder*/, DBAL_FIELD_TYPE_DEF_ETHERTYPE /* Type*/));
        result_field_counter++;
        db_field = &cur_table_param->results_set[result_type_counter].result_fields[result_field_counter];
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_field(unit, db_field, DBAL_FIELD_SRV6_MIN_PACKET_SIZE /* field id*/, TRUE /* Valid*/, 8 /* Size*/, 0 /* Offset*/, DBAL_DB_INVALID /* MaxValue*/, 0 /* MinValue*/, NULL /* ConstValue*/, 1 /* NofInstance*/, DBAL_PERMISSION_ALL /* Permission*/, FALSE /* ReverseOrder*/, DBAL_FIELD_TYPE_DEF_UINT /* Type*/));
        result_field_counter++;
