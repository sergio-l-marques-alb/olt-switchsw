    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "qos related HW update";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_qos_hw_bug_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data qos hw_bug features");

    submodule_data->features[dnx_data_qos_hw_bug_egress_remark_or_keep_enabler].name = "egress_remark_or_keep_enabler";
    submodule_data->features[dnx_data_qos_hw_bug_egress_remark_or_keep_enabler].doc = "enabler map table for remarking egress forward header";
    submodule_data->features[dnx_data_qos_hw_bug_egress_remark_or_keep_enabler].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_hw_bug_fwd_eve_pcp_diff_encap].name = "fwd_eve_pcp_diff_encap";
    submodule_data->features[dnx_data_qos_hw_bug_fwd_eve_pcp_diff_encap].doc = "eve pcp source at fwd stage is different with encap stage";
    submodule_data->features[dnx_data_qos_hw_bug_fwd_eve_pcp_diff_encap].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_hw_bug_phb_rm_ffc_extend].name = "phb_rm_ffc_extend";
    submodule_data->features[dnx_data_qos_hw_bug_phb_rm_ffc_extend].doc = "phb and remark FFCs extend 1 bit each for field_size and key_offset";
    submodule_data->features[dnx_data_qos_hw_bug_phb_rm_ffc_extend].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_qos_hw_bug_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data qos hw_bug defines");

    submodule_data->defines[dnx_data_qos_hw_bug_define_phb_rm_ffc_bits_width].name = "phb_rm_ffc_bits_width";
    submodule_data->defines[dnx_data_qos_hw_bug_define_phb_rm_ffc_bits_width].doc = "phb and remark ffc bits width";
    /* Set data type flag */
    submodule_data->defines[dnx_data_qos_hw_bug_define_phb_rm_ffc_bits_width].flags |= DNXC_DATA_F_DEFINE;

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_qos_hw_bug_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data qos hw_bug tables");
 ...
 */
int
dnx_data_qos_hw_bug_feature_get(
    int unit,
    dnx_data_qos_hw_bug_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_qos, dnx_data_qos_submodule_hw_bug, feature);
}
 ...
 */
uint32
dnx_data_qos_hw_bug_phb_rm_ffc_bits_width_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_qos, dnx_data_qos_submodule_hw_bug, dnx_data_qos_hw_bug_define_phb_rm_ffc_bits_width);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_qos_hw_bug_init(unit, &module_data->submodules[dnx_data_qos_submodule_hw_bug]));
    /*
