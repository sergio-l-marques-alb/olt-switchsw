...
uint32 * offset)
{
    ...
    /** size of LINK_RCI_THRESHOLD field  */
    result_size__link_rci_threshold += dnx_data_fabric.dbal.link_rci_threshold_bits_nof_get(unit);
    *offset = key_value__pipe*result_size__link_rci_threshold*dnx_data_fabric.pipes.max_nof_pipes_get(unit)+key_value__level*result_size__link_rci_threshold;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    {
        /** size of EGRESS_RCI_THRESHOLD field  */
        result_size__egress_rci_threshold += 12;
    }
    *offset = key_value__pipe*result_size__egress_rci_threshold*dnx_data_fabric.pipes.max_nof_pipes_get(unit)+key_value__level*result_size__egress_rci_threshold;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    if (dnx_data_device.general.feature_get(unit, dnx_data_device_general_multi_core))
    {
        /** size of TOTAL_EGRESS_RCI_THRESHOLD field  */
        result_size__total_egress_rci_threshold += 14;
    }
    *offset = key_value__pipe*result_size__total_egress_rci_threshold*dnx_data_fabric.pipes.max_nof_pipes_get(unit)+key_value__level*result_size__total_egress_rci_threshold;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_LEVEL, key_value__level);
    /** size of LOCAL_RCI_THRESHOLD field  */
...
uint32 * offset)
{
    ...
    if (dnx_data_device.general.feature_get(unit, dnx_data_device_general_multi_core))
    {
        /** size of TOTAL_LOCAL_RCI_THRESHOLD field  */
...
uint32 * offset)
{
    ...
    if (dnx_data_device.general.feature_get(unit, dnx_data_device_general_multi_core))
    {
        /** size of EGRESS_RCI_SCORE field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_LEVEL, key_value__level);
    /** size of DEVICE_THRESHOLD field  */
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PIPE, key_value__pipe);
    /** size of THRESHOLD field  */
    result_size__threshold += dnx_data_fabric.dbal.cgm_egress_fifo_base_address_bits_nof_get(unit);
    *offset = result_size__threshold*key_value__pipe;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
