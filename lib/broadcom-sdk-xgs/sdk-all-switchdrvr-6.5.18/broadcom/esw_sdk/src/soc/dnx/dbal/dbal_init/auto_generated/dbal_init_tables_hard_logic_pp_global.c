...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_pp_global_hl_ipp_debug_regs_init(unit, cur_table_param, table_info));
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_pp_global_hl_pp_debug_init(unit, cur_table_param, table_info));
