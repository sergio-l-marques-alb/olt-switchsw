 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_key_part_dump(int  unit,  int  fg_info_idx_0,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fg_info_idx_0, I0 = fg_info_idx_0 + 1;
    int i1 = context_info_idx_0, I1 = context_info_idx_0 + 1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.typefilter, "dnx_field_key_part_type_e") != TRUE)
    {
         SHR_EXIT();
    }

    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_group fg_info context_info key_id key_part") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_group fg_info context_info key_id key_part\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
 ...
 */
int
dnx_field_group_sw_kbp_info_master_key_info_segment_info_qual_idx_dump(int  unit,  int  kbp_info_idx_0,  int  segment_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
