...
#if defined(BCM_TRIDENT3_SUPPORT) || defined(BCM_TOMAHAWK2_SUPPORT) || defined(BCM_TOMAHAWK3_SUPPORT) || defined(BCM_FIREBOLT6_SUPPORT)
        ...
        if (tbl_ctrl && desc_handle) {
            ...
            LOG_INFO(BSL_LS_SOC_COMMON,
                     (BSL_META_U(unit,
                      ...
                      unit, ti,
                      tbl_desc[ti].mor_dma && (soc->pstats_flags & (_TD3_MMU_PSTATS_MOR_EN | _TH2_MMU_PSTATS_MOR_EN | _HX5_MMU_PSTATS_MOR_EN
                                               | _FB6_MMU_PSTATS_MOR_EN)) ? "MOR" : "Non-MOR",
