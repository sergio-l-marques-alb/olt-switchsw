...
static const soc_hx5_ep_core_cfg_t
    soc_hx5_ep_core_cfg_tbl[] = {
    /* L2_lat & L3_lat not used in hx5
	 * speed   ep2mmu  ep2_mmu_max    L2_lat      L3 lat       full_lat
     * LR  3:2 2:1   LR  3:2 2:1   LR  3:2 2:1
     */
    {    -1,  0, 0,  0,  0  ,  0,  0,{ 7, 14, 14}, { 7, 14, 14}, { 7, 14, 14} },   /* SAF     */
    { 10000, 11, 12, 11, 12 , 11, 12,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* 10GE    */
    { 11000, 11, 12, 11, 12 , 11, 12,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* HG[11]  */
    { 20000, 21, 22, 21, 21 , 21, 22,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* 20GE    */
    { 21000, 21, 22, 21, 21 , 21, 22,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* HG[21]  */
    { 25000, 16, 12, 16, 12 , 23, 24,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* 25GE    */
    { 27000, 16, 12, 16, 12 , 23, 24,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* HG[27]  */
    { 40000, 41, 42, 41, 40 , 40, 42,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* 40GE    */
    { 42000, 41, 42, 41, 40 , 40, 42,{7, 14, 14}, {7, 14, 14}, {7, 14, 14} },   /* HG[42]  */
    { 50000, 26, 19, 26, 19 , 39, 40,{9, 15, 15}, {9, 15, 15}, {9, 15, 15} },   /* 50GE    */
    { 53000, 26, 19, 26, 19 , 39, 40,{9, 15, 15}, {9, 15, 15}, {9, 15, 15} },   /* HG[53]  */
    {100000, 41, 35, 41, 35 , 45, 40,{9, 15, 15}, {9, 15, 15}, {9, 15, 15} },   /* 100GE   */
    {1000,   4,  4,  4,  4  , 4,  4,{9, 15, 15}, {9, 15, 15}, {9, 15, 15} },   /* 100GE   */
    {106000, 41, 35, 41, 35 , 45, 40,{9, 15, 15}, {9, 15, 15}, {9, 15, 15} }    /* HG[106] */
};


/*! @fn int soc_helix5_ep_flexport_get_max_ovs_ratio(int unit,
 ...
 */
int
soc_helix5_ep_flexport_get_max_ovs_ratio(
    ...
    int *old_max_ovs_ratio, int *new_max_ovs_ratio)
{
    ...
    for (pipe = 0; pipe < HELIX5_PIPES_PER_DEV; pipe++) {
...
/*! @fn int soc_helix5_ep_get_ep2mmu_credit(int unit, 
 ...
 */
int
soc_helix5_ep_get_ep2mmu_credit(
    int unit, soc_port_schedule_state_t *port_schedule_state, int logical_port)
{
    ...
    soc_helix5_ep_flexport_get_max_ovs_ratio(unit,
                                                port_schedule_state,
                                                &old_max_ovs_ratio,
                                                &new_max_ovs_ratio);
    ...
    ct_class = soc_helix5_get_ct_class(speed);
    physical_port =
  ...
  *      return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_max_freq;
  *  } else {
  *      return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit;
  *  }
  */
         if(new_max_ovs_ratio <= 10 && physical_port < 49) /* line rate & eagle */
          return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_pmq_lr;
         else if(new_max_ovs_ratio > 10 && physical_port < 49) /* line rate & eagle */
          return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_pmq_os;
         else if(new_max_ovs_ratio <= 10 && physical_port < 65) /* line rate & eagle */
          return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_egl_lr;
         else if(new_max_ovs_ratio > 10 && physical_port < 65) /* line rate & eagle */
          return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_egl_os;
         else if(new_max_ovs_ratio <= 10 ) /* OS & eagle */
          return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_fl_lr;
         else
          return soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_fl_os;

    	
}


/*! @fn int soc_helix5_ep_get_ct_xmit_start_cnt(int ct_class, int latency_mode,
 *              int ovs_ratio)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct 
 *         variable
 ...
 */
int
soc_helix5_ep_get_ct_xmit_start_cnt(int ct_class, int latency_mode,
                                       int ovs_ratio)
{
    int xmit_cnt;
    ...
    case 0:
        if (ovs_ratio <= 10) {     /* LR */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_full_latency.
                line_rate;
    ...
    case 1:
        if (ovs_ratio <= 10) {     /* LR */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_l3_latency.line_rate;
        } else if (ovs_ratio <= 15) {     /* OVS 1.61 */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_l3_latency.
                oversub_3_2;
        } else {     /* OVS 2:1 */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_l3_latency.
    ...
    case 2:
        if (ovs_ratio <= 10) {     /* LR */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_l2_latency.line_rate;
        } else if (ovs_ratio <= 15) {     /* OVS 1.61 */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_l2_latency.
                oversub_3_2;
        } else {     /* OVS 2:1 */
            xmit_cnt =
                soc_hx5_ep_core_cfg_tbl[ct_class].xmit_cnt_l2_latency.
...
/*! @fn int soc_helix5_ep_get_xmit_start_count(int unit,
 *              soc_port_schedule_state_t *port_schedule_state,
 ...
 */
int
soc_helix5_ep_get_xmit_start_count(
    int  unit, soc_port_schedule_state_t *port_schedule_state,
    int  logical_port, int *xmit_start_cnt)
{
   ...
   /* int saf_xmit_start_cnt, dst_ct_xmit_start_cnt; */
    ...
    cookie = port_schedule_state->cookie;
    speed = cookie->exact_out_log_port_speed[logical_port];
    dst_ct_class = soc_helix5_get_ct_class(speed);
    physical_port = 
            port_schedule_state->out_port_map.port_l2p_mapping[logical_port];
   ...
   /* latency_mode = port_schedule_state->cutthru_prop.switch_bypass_mode; */
     ...
     * saf_xmit_start_cnt = soc_helix5_ep_get_ct_xmit_start_cnt(
     * dst_ct_xmit_start_cnt = soc_helix5_ep_get_ct_xmit_start_cnt(
    ...
    for (src_ct_class=0; src_ct_class < 13; src_ct_class++) {
        if (src_ct_class < dst_ct_class) {
         ...
         if(new_max_ovs_ratio <= 10 && physical_port < 65) /* line rate & eagle */
	   xmit_start_cnt[src_ct_class] = 7 ; 
         else if(new_max_ovs_ratio > 10 && physical_port < 65) /* line rate & eagle */
	   xmit_start_cnt[src_ct_class] = 14 ;
         else if(new_max_ovs_ratio <= 10 ) 
	   xmit_start_cnt[src_ct_class] = 9;
         else 
	   xmit_start_cnt[src_ct_class] = 15 ;
...
/*! @fn int soc_helix5_ep_flexport_sft_rst_pm_intf(int unit,
 ...
 */
int
soc_helix5_ep_flexport_sft_rst_pm_intf(
    int unit, soc_port_schedule_state_t *port_schedule_state, int rst_on)
{
    ...
    uint32 pm_rst_values[HELIX5_PIPES_PER_DEV][HELIX5_PBLKS_PER_PIPE];

    uint64 rval64;
    soc_reg_t reg;
    static const soc_reg_t edb_sft_rst_regs[HELIX5_PIPES_PER_DEV] = {
        EGR_PORT_BUFFER_SFT_RESET_0_PIPE0r
    };


    /* pipe_map indicates which pipe has flexing ports */
    _soc_hx5_tdm_get_pipe_map(unit, port_schedule_state, &pipe_map);
    ...
    if (1 == rst_on) {
        for (i = 0; i < port_schedule_state->nport; i++) {
            ...
            pipe = logical_port / HELIX5_DEV_PORTS_PER_PIPE;
           ...
           /* pm_num = (physical_port - 1) / HELIX5_PORTS_PER_PBLK; device pm_num*/
	    pm_num = soc_helix5_get_pm_from_phy_pnum(physical_port - 1);
          /*  pm_indx = (pm_num % HELIX5_PBLKS_PER_PIPE); */
            /* pm_indx is pipe local PM indx and swapped for odd pipes */
            /* pm_indx = ((pipe % 2) == 0) ? pm_indx : (HELIX5_PBLKS_PER_PIPE-1 - pm_indx); */
	     pm_indx = pm_num ;

            subport = (physical_port - 1) % HELIX5_PORTS_PER_PBLK;
            switch (subport) {
            case 0:
            case 1:
                if (num_lanes == 4) {
        ...
        for (pipe = 0; pipe < HELIX5_PIPES_PER_DEV; pipe++) {
            for (pm_indx = 0; pm_indx < HELIX5_PBLKS_PER_PIPE; pm_indx++) {
...
/*! @fn int soc_helix5_ep_flexport_sft_rst_ports(int unit,
 *              soc_port_schedule_state_t *port_schedule_state)
 *  @param unit Chip unit number.
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state, int rst_on)
{
	 ...
	 */
	if(physical_port < 49){
	    inst = ((physical_port - 1) / 16 | SOC_REG_ADDR_INSTANCE_MASK);
...
/*! @fn int soc_helix5_ep_enable_disable(int unit,
 *              soc_port_schedule_state_t *port_schedule_state,
 ...
 */
int
soc_helix5_ep_enable_disable(int                        unit,
                                soc_port_schedule_state_t *port_schedule_state,
                                int                        logical_port,
                                int                        down_or_up)
{
...
/*! @fn int soc_helix5_ep_set_egr_mmu_credit(int unit,
 *              soc_port_schedule_state_t *port_schedule_state
 *              int logical_port, int down_or_up)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct 
 ...
 */
int
soc_helix5_ep_set_egr_mmu_credit(
    int unit, soc_port_schedule_state_t *port_schedule_state,
    int logical_port, int down_or_up)
{
    uint32 entry[SOC_MAX_MEM_WORDS];
    ...
    if (0 == down_or_up ) { /* port down */
        ...
        memfld = soc_helix5_ep_get_ep2mmu_credit(unit, port_schedule_state,
                                                    logical_port);
        physical_port =
            port_schedule_state->out_port_map.port_l2p_mapping[logical_port];
    }
...
/*! @fn int soc_helix5_ep_set_dev_to_phy(int unit,
 *              soc_port_schedule_state_t *port_schedule_state
 *              int logical_port, int down_or_up)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 ...
 */
int
soc_helix5_ep_set_dev_to_phy(int                        unit,
                                soc_port_schedule_state_t *port_schedule_state,
                                int                        logical_port,
                                int                        down_or_up)
{
...
/*! @fn int soc_helix5_ep_set_edb_1dbg_b(int unit,
 *              soc_port_schedule_state_t *port_schedule_state
 *              int logical_port, int down_or_up)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
...
/*
*int
*soc_helix5_ep_set_edb_1dbg_b(int                        unit,
*                                soc_port_schedule_state_t *port_schedule_state,
*                                int                        logical_port,
*                                int                        down_or_up)
*{
...
/*! @fn int soc_helix5_ep_flexport_extra_holding_set(int unit,
 ...
 */
int
soc_helix5_ep_flexport_extra_holding_set(
    int unit, soc_port_schedule_state_t *port_schedule_state,
    int cell_counts)
{
    int pipe;
    ...
    uint32 pipe_map;
    soc_reg_t reg;
    static const soc_reg_t extr_hold_regs[HELIX5_PIPES_PER_DEV] = {
...
/*! @fn int soc_helix5_ep_flexport_xmit_cnt_set(int unit,
 *              soc_port_schedule_state_t *port_schedule_state, int logical_port)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
 ...
 */
int
soc_helix5_ep_flexport_xmit_cnt_set(
    int unit, soc_port_schedule_state_t *port_schedule_state, int logical_port)
{
    soc_mem_t mem;
    ...
    static const soc_mem_t ep_xmit_cnt_mems[HELIX5_PIPES_PER_DEV] = {
    ...
    soc_helix5_ep_get_xmit_start_count(unit, port_schedule_state,
                                          logical_port,
                                          xmit_start_cnt);
    for (class = 0; class < 13; class++) {
        sal_memset(entry, 0, sizeof(uint32) *
                   soc_mem_entry_words(unit, EGR_XMIT_START_COUNT_PIPE0m));
        mem_index = (logical_port % HELIX5_DEV_PORTS_PER_PIPE) * 16 + class;
...
/*! @fn int soc_helix5_ep_flexport_xmit_cnt_set_all_ports(int unit,
 *              soc_port_schedule_state_t *port_schedule_state)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
 ...
 */
int
soc_helix5_ep_flexport_xmit_cnt_set_all_ports(
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    int old_max_ovs_ratio, new_max_ovs_ratio;
    ...
    if (new_max_ovs_ratio != old_max_ovs_ratio) {
        for (logical_port = 0; logical_port < HELIX5_DEV_PORTS_PER_DEV;
             logical_port++) {
            if (port_schedule_state->out_port_map.log_port_speed[logical_port]
                 > 0 )
                soc_helix5_ep_flexport_xmit_cnt_set(unit,
                                                       port_schedule_state,
                                                       logical_port);
        }
...
/*! @fn int soc_helix5_ep_flexport_ct_class_set(int unit,
 *              soc_port_schedule_state_t *port_schedule_state, int logical_port)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
 ...
 *      SOC_E_*
 * int
 * soc_helix5_ep_flexport_ct_class_set(
    int unit, soc_port_schedule_state_t *port_schedule_state, int logical_port)
 * {
 *  soc_mem_t mem;
 *  uint32 memfld;
 ...
 *  cookie = port_schedule_state->cookie;
 *  speed  = cookie->exact_out_log_port_speed[logical_port];
 *  memfld = soc_helix5_get_ct_class(speed);
...
/*! @fn int soc_helix5_ep_flexport_drain_port(int unit,
 *              soc_port_schedule_state_t *port_schedule_state, int logical_port)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
 ...
 */
int
soc_helix5_ep_flexport_drain_port(
    int unit, soc_port_schedule_state_t *port_schedule_state, int logical_port)
{
    int pipe;
    ...
    static const soc_reg_t misc_ctrl_regs[HELIX5_PIPES_PER_DEV] = {
...
/*! @fn int soc_helix5_flex_ep_port_down(int unit,
 *              soc_port_schedule_state_t *port_schedule_state)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
 *  @brief Helper function to follow EDB port down sequence for flexport operation.
 *         Follows the sequence specified in document "hx5_uA_flexport.pdf",
 *         Section 6.6.1.1
 *         Two main parts:
 ...
 */
int
soc_helix5_flex_ep_port_down(int                        unit,
                                soc_port_schedule_state_t *port_schedule_state)
{
    ...
    for (i = 0; i < port_schedule_state->nport; i++) {
        if (port_schedule_state->resource[i].physical_port == -1) {
            logical_port = port_schedule_state->resource[i].logical_port;
            SOC_IF_ERROR_RETURN(soc_helix5_ep_flexport_drain_port(unit,
    ...
    for (i = 0; i < port_schedule_state->nport; i++) {
        ...
        if (-1 == physical_port) { /* that is, port DOWN */
            ...
            soc_helix5_ep_enable_disable(unit, port_schedule_state,
                                            logical_port,
                                            down_or_up);
        }
    }
    ...
    rst_on = 1;
    SOC_IF_ERROR_RETURN(soc_helix5_ep_flexport_sft_rst_ports(unit,
                                                                port_schedule_state,
                                                                rst_on));
...
/*! @fn int soc_helix5_flex_ep_reconfigure_remove(int unit,
 *              soc_port_schedule_state_t *port_schedule_state)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    ...
    for (i = 0; i < port_schedule_state->nport; i++) {
        ...
        if (-1 == physical_port) { /* that is, port DOWN */
             ...
             * EGR_DEVICE_TO_PHYSICAL_PORT_NUMBER_MAPPINGr
             */
            soc_helix5_ep_set_dev_to_phy(unit, port_schedule_state,
                                            logical_port,
                                            down_or_up);
            /* Reset EP2MMU credits to 0 : write EGR_MMU_CELL_CREDITm */
            soc_helix5_ep_set_egr_mmu_credit(unit, port_schedule_state,
                                                logical_port,
                                                down_or_up);
            /* Reset edb_1dbg_b : write EDB_1DBG_Bm */

          /* soc_helix5_ep_set_edb_1dbg_b(unit, port_schedule_state,
           *                                 logical_port,
           *                                 down_or_up);
           */                                 
        }
    ...
    SOC_IF_ERROR_RETURN(soc_helix5_ep_flexport_extra_holding_set(unit,
                            port_schedule_state, 8)); /* 8 as per hx5 Chip Uarch Delta Spec */

    return SOC_E_NONE;
}


/*! @fn int soc_helix5_flex_ep_reconfigure_add(int unit,
 *              soc_port_schedule_state_t *port_schedule_state)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    ...
    for (i = 0; i < port_schedule_state->nport; i++) {
	    ...
	    /* Configure CT_class for added port : write EGR_IP_CUT_THRU_CLASSm 
             * soc_helix5_ep_flexport_ct_class_set(unit, port_schedule_state,
             *                                      logical_port);
             */
	}
    }
     ...
     * write EGR_XMIT_START_COUNT_PIPE0/1m
     */
    SOC_IF_ERROR_RETURN(soc_helix5_ep_flexport_xmit_cnt_set_all_ports(unit,
                            port_schedule_state));
...
/*! @fn int soc_helix5_flex_ep_port_up(int unit,
 *              soc_port_schedule_state_t *port_schedule_state)
 *  @param unit Chip unit number.
 *  @param port_schedule_state Pointer to a soc_port_schedule_state_t struct
 *         variable
 ...
 */
int
soc_helix5_flex_ep_port_up(int                        unit,
                              soc_port_schedule_state_t *port_schedule_state)
{
    int i, rst_on, down_or_up;
    int logical_port, physical_port;
...
/*! @fn int soc_helix5_tdm_calculate_ovs(int unit,
 *              soc_port_schedule_state_t *port_schedule_state,
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    ...
    for (ovs_ratio = 2; ovs_ratio < 4; ovs_ratio++) {
        ...
        for (ct_class=0; ct_class < 13; ct_class++) {
            LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                     ...
                     ct_class, soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_fl_lr,
                     soc_hx5_ep_core_cfg_tbl[ct_class].egr_mmu_credit_fl_os));
            for (lat=2; lat>=0; lat--) {
                xmit_cnt = soc_helix5_ep_get_ct_xmit_start_cnt(ct_class, lat,
                                                                  5*ovs_ratio);
    ...
    for (port = 1; port < SOC_MAX_NUM_PORTS; port++) {
        if (port_schedule_state->out_port_map.log_port_speed[port] > 0 ) {
            ep2mmu_cred = soc_helix5_ep_get_ep2mmu_credit(
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    ...
    LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                        "soc_helix5_ep_flexport_remove_ports_shim(): "
                        "calling soc_helix5_flex_start")));
    SOC_IF_ERROR_RETURN(soc_helix5_flex_start(unit, port_schedule_state));
    LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                        "soc_helix5_ep_flexport_remove_ports_shim(): "
                        "calling soc_helix5_tdm_calculation_flexport")));
    SOC_IF_ERROR_RETURN(soc_helix5_tdm_calculation_flexport(unit,
                                                               port_schedule_state));
    LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                        "soc_helix5_ep_flexport_remove_ports_shim(): "
                        "calling soc_helix5_flex_ep_port_down")));
    SOC_IF_ERROR_RETURN(soc_helix5_flex_ep_port_down(unit,
                                                        port_schedule_state));
    LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                        "soc_helix5_ep_flexport_remove_ports_shim(): "
                        "calling soc_helix5_ep_flexport_reconfigure_remove")));
    SOC_IF_ERROR_RETURN(soc_helix5_flex_ep_reconfigure_remove(unit,
                            port_schedule_state));
...
/* Comment out these functions from soc_helix5_ep_flexport_add_ports function
 * 1. soc_helix5_ep_flexport_ct_class_set
 * 2. soc_helix5_ep_flexport_xmit_cnt_set_all_ports
 * 3. soc_helix5_ep_enable_disable
 */
int
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                        "soc_helix5_ep_flexport_add_ports_shim(): "
                        "calling soc_helix5_ep_flexport_reconfigure_add")));
    SOC_IF_ERROR_RETURN(soc_helix5_flex_ep_reconfigure_add(unit,
                                                              port_schedule_state));
    LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit,
                        "soc_helix5_ep_flexport_add_ports_shim(): "
                        "calling soc_helix5_ep_flexport_add_ports")));
    SOC_IF_ERROR_RETURN(soc_helix5_flex_ep_port_up(unit, port_schedule_state));
