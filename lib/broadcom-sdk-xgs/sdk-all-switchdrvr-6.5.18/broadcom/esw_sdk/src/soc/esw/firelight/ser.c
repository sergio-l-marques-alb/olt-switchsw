...
STATIC
void soc_fl_lp_intr_handler(int unit, void *data)
{
    sal_dpc(soc_fl_lp_intr_dpc,
                INT_TO_PTR(unit), data, NULL, NULL, NULL);
}

/*
 * Function:
 *      soc_fl_lp_intr_register
 * Purpose:
 ...
 */
void
soc_fl_lp_intr_register(int unit)
{
    soc_cmic_intr_handler_t handle;

    handle.num = CHIP_INTR_LOW_PRIORITY;
    handle.intr_fn = soc_fl_lp_intr_handler;
