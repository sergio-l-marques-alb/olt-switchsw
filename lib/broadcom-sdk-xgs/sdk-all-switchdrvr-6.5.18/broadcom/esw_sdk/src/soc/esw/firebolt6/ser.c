...
typedef struct _soc_fb6_ser_mmu_intr_info_s {
    soc_reg_t   int_statf;
    int         mmu_base_index;
    int         ser_info_index;
} _soc_fb6_ser_mmu_intr_info_t;
...
typedef struct _soc_fb6_tmp_ser_info_s {
    soc_reg_t           enable_reg;
    soc_field_t         enable_field;
    uint32              value;
} _soc_fb6_tmp_ser_info_t;

typedef struct _soc_fb6_hash_table_ser_info_s {
    soc_mem_t       mem;
    soc_field_t     enable_field;
} _soc_fb6_hash_table_ser_info_t;
