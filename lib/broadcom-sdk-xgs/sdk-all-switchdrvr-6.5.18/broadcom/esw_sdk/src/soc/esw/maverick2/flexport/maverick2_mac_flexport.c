...
/*! @file maverick2_mac_flexport.c
 *  @brief MAC flex for Maverick2.
 *  Details are shown below.
 */

int
soc_maverick2_flex_mac_rx_port_down(
...
int
soc_maverick2_flex_mac_tx_port_down(
    int unit, soc_port_schedule_state_t *port_schedule_state)
{
    int i;
    uint64 rval64;
...
int
soc_maverick2_flex_mac_port_up(int                        unit,
                               soc_port_schedule_state_t *port_schedule_state)
{
	...
	int speed_mode;
	int hdr_mode;
    static const int clport_mode_values[SOC_MV2_PORT_RATIO_COUNT] = {
        4, 3, 3, 3, 2, 2, 1, 1, 0
    };


	LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit, "START soc_maverick2_flex_mac_port_up\n")));
    /*Disable TSC lanes: */
	...
	LOG_DEBUG(BSL_LS_SOC_PORT, (BSL_META_U(unit, "END soc_maverick2_flex_mac_port_up\n")));
    return SOC_E_NONE;
}
