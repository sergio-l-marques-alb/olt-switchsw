...
**/
int
tdm_fb6_parse_acc_idb(tdm_mod_t *_tdm, int cal_id)
{
...
int param_dummy = 0;
    ...
    switch (param_clk_freq) {
       case FB6_CLK_4730_1118: param_mgmt_size = 16; param_lpbk=4; param_fae = 4; param_null = 8; param_dummy = 57; break;
       case FB6_CLK_4731_1012: param_mgmt_size = 8;  param_lpbk=3; param_fae = 3; param_null = 8; param_dummy = 1;  break;
       case FB6_CLK_4720_1012: param_mgmt_size = 8;  param_lpbk=3; param_fae = 3; param_null = 8; param_dummy = 1;  break;
       case FB6_CLK_4721_1012: param_mgmt_size = 24;  param_lpbk=3; param_fae = 3; param_null = 8;param_dummy = 0;  break;
    ...
    tdm_fb6_parse_tdm_cal_idb_mmu(_tdm, cal_id, param_mgmt_size, param_lpbk, param_fae, param_idle1, param_null, param_clk_freq, param_cal_len, param_token_ancl, param_dummy);
    return PASS;
}
...
**/
int
tdm_fb6_parse_acc_mmu(tdm_mod_t *_tdm, int cal_id)
{
    int param_token_ancl, param_cal_id, param_cal_len;
...
int param_dummy = 0;
   ...
   switch (param_clk_freq) {
       case FB6_CLK_4730_1118: param_mgmt_size = 16; param_lpbk=4; param_fae = 0; param_null = 9; param_dummy = 61;  break;
       case FB6_CLK_4731_1012: param_mgmt_size = 12; param_lpbk=3; param_fae = 0; param_null = 9; param_dummy = 0; break;
       case FB6_CLK_4720_1012: param_mgmt_size = 12; param_lpbk=3; param_fae = 0; param_null = 9; param_dummy = 0;   break;
       case FB6_CLK_4721_1012: param_mgmt_size = 24;  param_lpbk=3; param_fae = 0; param_null = 9;param_dummy = 3;  break;
...
tdm_fb6_parse_ancl(tdm_mod_t *_tdm, int cal_id)
{
 ...
 /*   } */
    ...
    if (idb_en == 1) {
        if (tdm_fb6_parse_acc_idb(_tdm, cal_id) != PASS) {
            TDM_ERROR1("Failed in ANCL allocation, cal_id %0d\n", cal_id);
            result = FAIL;
        }
    } else if (mmu_en == 1) {
        if (tdm_fb6_parse_acc_mmu(_tdm, cal_id) != PASS) {
            TDM_ERROR1("Failed in ANCL allocation, cal_id %0d\n", cal_id);
            result = FAIL;
        }
    }
...
**/
int tdm_fb6_parse_tdm_cal_idb_mmu(tdm_mod_t *_tdm, int cal_id, int param_mgmt_size, int param_lpbk, int param_fae, int param_idle1, int param_null, int param_clk_freq, int param_cal_len, int param_token_ancl, int param_dummy)
{
    int param_cal_id;
    int token_cnt;
    ...
    TDM_PRINT1("IDB_MMU::mgmt1_credits %d \n",  mgmt1_credits);
    switch (param_clk_freq) {
       case FB6_CLK_4701_1250: mgmt1_credits = param_mgmt_size/2; mgmt2_credits=param_mgmt_size/2; mgmt3_credits= 0; mgmt4_credits=0; break;
       case FB6_CLK_4702_1250: mgmt1_credits = param_mgmt_size/2; mgmt2_credits=param_mgmt_size/2; mgmt3_credits= 0; mgmt4_credits=0; break;
       case FB6_CLK_4703_1250: mgmt1_credits = param_mgmt_size/2; mgmt2_credits=param_mgmt_size/2; mgmt3_credits= 0; mgmt4_credits=0; break;
       case FB6_CLK_4721_1012: mgmt1_credits = param_mgmt_size/2; mgmt3_credits=param_mgmt_size/2; mgmt2_credits= 0; mgmt4_credits=0;
                               break;
      default:  break;
    ...
    if(param_clk_freq == FB6_CLK_4730_1118) {
    ...
    if (param_cal_main != NULL && param_cal_len > 0) {
        ...
        switch(token_cnt) {
            ...
            case 1 : TDM_PRINT4("Case M2 mgmt2_en %0d mgmt2_credits %d skip_lpbk %d prev_val_mgmt %d\n", mgmt2_en, mgmt2_credits, skip_lpbk, prev_val_mgmt);
                     if(!mgmt1_en) {
                     if(mgmt2_credits>0) {
                          if((j-prev_val_mgmt2 < mgmt_same_spacing) || (j-prev_val_mgmt1 <4) || (j-prev_val_mgmt3<4) || (j-prev_val_mgmt4<4)) {
                          token_cnt=4;
                          if(mgmt1_en==0)
                          mgmt2_en=1;
                        }
            ...
            case 2 : TDM_PRINT4("Case M3 mgmt3_en %0d mgmt3_credits %d skip_lpbk %d prev_val_mgmt %d\n", mgmt3_en, mgmt3_credits, skip_lpbk, prev_val_mgmt);
                     if(!mgmt2_en) {
                     if(mgmt3_credits>0) {
                      if((j-prev_val_mgmt3 < mgmt_same_spacing) || (j-prev_val_mgmt1 <4) || (j-prev_val_mgmt2<4) || (j-prev_val_mgmt4<4)) {
                        token_cnt=4;
            ...
            case 3 : TDM_PRINT4("Case M4 mgmt4_en %0d mgmt4_credits %d skip_lpbk %d prev_val_mgmt %d \n", mgmt4_en, mgmt4_credits, skip_lpbk, prev_val_mgmt);
                     if(!mgmt3_en) {
                     if(mgmt4_credits>0) {
                      if((j-prev_val_mgmt4 < mgmt_same_spacing) || (j-prev_val_mgmt1 <4) || (j-prev_val_mgmt2<4) || (j-prev_val_mgmt3<4)) {
                        token_cnt=4;
