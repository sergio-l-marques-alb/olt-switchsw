...
static const soc_fb6_ep_core_cfg_t
     ...
     */
    {    -1,  0, 0,  0,  0  ,  0,  0,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* SAF     */
    { 10000, 11, 12, 11, 12 , 6, 7,  {7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 10GE    */
    { 11000, 11, 12, 11, 12 , 6, 7,  {7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* HG[11]  */
    { 20000, 21, 22, 21, 21 , 10, 11,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 20GE    */
    { 21000, 21, 22, 21, 21 , 10, 11,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* HG[21]  */
    { 25000, 16, 12, 16, 12 , 12, 13,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 25GE    */
    { 27000, 16, 12, 16, 12 , 12, 13,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* HG[27]  */
    { 40000, 41, 42, 41, 40 , 19, 20,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 40GE    */
    { 42000, 41, 42, 41, 40 , 19, 20,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* HG[42]  */
    { 50000, 26, 19, 26, 19 , 23, 24,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 50GE    */
    { 53000, 26, 19, 26, 19 , 23, 24,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* HG[53]  */
    {100000, 41, 35, 41, 35 , 45, 46,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 100GE   */
    {1000,   4,  4,  4,  4  , 2,  4, {7, 19, 19}, {7, 19, 19}, {7, 19, 19} },   /* 100GE   */
    {106000, 41, 35, 41, 35 , 45, 46,{7, 19, 19}, {7, 19, 19}, {7, 19, 19} }    /* HG[106] */
};
    ...
    int unit, soc_port_schedule_state_t *port_schedule_state, int logical_port)
{
    ...
    for (class = 0; class < 1; class++) {
        ...
        mem_index = (logical_port % 68) * 1 + class;
