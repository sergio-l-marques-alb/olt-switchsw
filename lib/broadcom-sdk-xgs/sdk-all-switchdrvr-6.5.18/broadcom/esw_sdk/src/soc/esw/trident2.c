...
soc_td2_mem_log_content_skip(int unit, soc_mem_t mem)
{
    int skip = FALSE;
    switch(mem) {
        case ES_PIPE0_LLS_PORT_MEMA_CONFIGm:
        case ES_PIPE0_LLS_PORT_MEMB_CONFIGm:
        case ES_PIPE1_LLS_PORT_MEMA_CONFIGm:
        case ES_PIPE1_LLS_PORT_MEMB_CONFIGm:
        case ES_PIPE0_LLS_L0_PARENTm:
        case ES_PIPE0_LLS_L0_MEMA_CONFIGm:
        case ES_PIPE0_LLS_L0_MEMB_CONFIGm:
        case ES_PIPE0_LLS_L0_CHILD_WEIGHT_CFGm:
        case ES_PIPE1_LLS_L0_PARENTm:
        case ES_PIPE1_LLS_L0_MEMA_CONFIGm:
        case ES_PIPE1_LLS_L0_MEMB_CONFIGm:
        case ES_PIPE1_LLS_L0_CHILD_WEIGHT_CFGm:
        case ES_PIPE0_LLS_L1_PARENTm:
        case ES_PIPE0_LLS_L1_MEMA_CONFIGm:
        case ES_PIPE0_LLS_L1_MEMB_CONFIGm:
        case ES_PIPE0_LLS_L1_CHILD_WEIGHT_CFGm:
        case ES_PIPE1_LLS_L1_PARENTm:
        case ES_PIPE1_LLS_L1_MEMA_CONFIGm:
        case ES_PIPE1_LLS_L1_MEMB_CONFIGm:
        case ES_PIPE1_LLS_L1_CHILD_WEIGHT_CFGm:
        case ES_PIPE0_LLS_L2_PARENTm:
        case ES_PIPE0_LLS_L2_CHILD_WEIGHT_CFGm:
        case ES_PIPE1_LLS_L2_PARENTm:
        case ES_PIPE1_LLS_L2_CHILD_WEIGHT_CFGm:
        case ES_PIPE0_TDM_TABLE_0m:
        case ES_PIPE0_TDM_TABLE_1m:
        case ES_PIPE1_TDM_TABLE_0m:
        case ES_PIPE1_TDM_TABLE_1m:
#ifdef BCM_TRIDENT2PLUS_SUPPORT
            if (SOC_IS_TD2P_TT2P(unit)) {
                /*
                * Skip populating content for the MMU memories
                * which share same parity control bit(PARITY_ENr.ES_PARITY_ENf)
                */
                skip = TRUE;
            }
#endif
