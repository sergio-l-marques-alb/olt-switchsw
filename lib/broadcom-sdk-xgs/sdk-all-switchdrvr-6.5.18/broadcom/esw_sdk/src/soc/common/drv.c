...
static soc_led_driver_t cmicx_led_driver = {
    .soc_led_uc_num_get = soc_cmicx_led_uc_num_get,
    .soc_led_fw_load = soc_cmicx_led_fw_load,
    .soc_led_fw_start_get = soc_cmicx_led_fw_start_get,
    .soc_led_fw_start_set = soc_cmicx_led_fw_start_set,
    .soc_led_control_data_write = soc_cmicx_led_control_data_write,
    .soc_led_control_data_read = soc_cmicx_led_control_data_read,
    .soc_led_port_to_uc_port_get = soc_cmicx_led_port_to_uc_port_get,
    .soc_led_port_to_uc_port_set = soc_cmicx_led_port_to_uc_port_set,
};
#endif
