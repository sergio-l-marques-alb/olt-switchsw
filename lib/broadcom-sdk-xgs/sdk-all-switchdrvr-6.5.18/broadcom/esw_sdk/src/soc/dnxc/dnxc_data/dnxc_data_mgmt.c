...
/*
 * \brief - dnx data access verifications.
 */
static shr_error_e
...
#ifdef BCM_DNX_SUPPORT
/*
 * This function is used to determine wether the port is active.
 * It is used to optimize runtime, as we can skip reading the soc prop
 * in case the port is inactive
 * it relies on the fact that ucode_port is the first table to be loaded
 * and is already loaded when this function is being called
 */
static int
    ...
    uint8 skip_check)
{
    ...
    {
        /** Do nothing - in case of Ramon - will be fixed by SDK-170515 */
        return TRUE;
    }

    if (skip_check)
    {
        /** Do nothing - in case we have skip_check flag.*/
        return TRUE;
    }
    ...
    dnxc_data_value_set_f set_func)
{
    ...
    {
        /** Do nothing - device data wasn't loaded yet and is not in process */
    }
    else if ((state_flags & DNXC_DATA_STATE_F_DEV_DATA_DONE) == 0)
    {
        /** in case data wasn't loaded yet - load it first */
        ...
        for (module_index = 0; module_index < unit_data->nof_modules; module_index++)
        {
            ...
            for (submodule_index = 0; submodule_index < module->nof_submodules; submodule_index++)
            {
                ...
                for (table_index = 0; table_index < submodule->nof_tables; table_index++)
                {
                    ...
                    {
                        /*
                         * Free table value properties mapping
                         */
    ...
    int unit)
{
        ...
        for (module_index = 0; module_index < _dnxc_data[unit].nof_modules; module_index++)
        {
            ...
            for (submodule_index = 0; submodule_index < module->nof_submodules; submodule_index++)
            {
                ...
                for (data_index = 0; data_index < submodule->nof_defines; data_index++)
                {
                    ...
                    /*
                     * Filter unsupported defines and numeric defines (will be set separately)
                     */
    ...
    /** verify the provided DNX data belongs to device */
    ...
    void *value)
{
    ...
    switch (property->method)
    {
        case dnxc_data_property_method_enable:
        {
            ...
            /*
             * Enable method - see 'dnxc_data_property_method_enable' for details 
             */
            /*
             * read
             */
        ...
        case dnxc_data_property_method_port_enable:
        {
            ...
            /*
             * Port enable method - see 'dnxc_data_property_method_port_enable' for details 
             */

            /*
             * In order to save time, skip soc property read if port is not active
             */
        ...
        case dnxc_data_property_method_suffix_enable:
        {
            value_uint32 = (uint32 *) value;
            /*
             * Suffix enable method - see 'dnxc_data_property_method_suffix_enable' for details 
             */
        ...
        case dnxc_data_property_method_range:
        {
            value_uint32 = (uint32 *) value;
            /*
             * Range method - see 'dnxc_data_property_method_range' for details 
             */
        ...
        case dnxc_data_property_method_range_signed:
        {
            value_int = (int *) value;
            /*
             * Range method - see 'dnxc_data_property_method_range_signed' for details
             */
        ...
        case dnxc_data_property_method_port_range:
        {
            value_uint32 = (uint32 *) value;
            /*
             * Port range method - see 'dnxc_data_property_method_port_range' for details 
             */
        ...
        case dnxc_data_property_method_port_range_signed:
        {
            value_int = (int *) value;
            /*
             * Port range method - see 'dnxc_data_property_method_port_range_signed' for details
             */
        ...
        {
            /*
             * Suffix range method - see 'dnxc_data_property_method_suffix_range' for details 
             */
            value_uint32 = (uint32 *) value;
        ...
        {
            /*
             * Suffix range method - see 'dnxc_data_property_method_port_suffix_range_signed' for details
             */
            value_int = (int *) value;
            range_min_int = (int) property->range_min;
            range_max_int = (int) property->range_max;
        ...
        {
            /*
             * Direct map method - see 'dnxc_data_property_method_direct_map' for details 
             */
            value_uint32 = (uint32 *) value;
            ...
            else
            {
                 ...
                 * if found - set value according to map entry
                 * otherwise  - throw an error 
                 */
                for (value_index = 0; value_index < property->nof_mapping; value_index++)
                {
                    /** if the mapping was changed to invalid in dynamic DNX data (SKUs), then skip it */
        ...
        {
            /*
             * Port direct map method - see 'dnxc_data_property_method_port_direct_map' for details 
             */
            value_uint32 = (uint32 *) value;
        ...
        {
            /*
             * Suffix direct map method - see 'dnxc_data_property_method_suffix_direct_map' for details 
             */
            value_uint32 = (uint32 *) value;
        ...
        case dnxc_data_property_method_port_str:
        {
            ...
            /*
             * Read str with suffix and key (if exist)
             */
        case dnxc_data_property_method_suffix_str:
        {
            ...
            /*
             * Read str with suffix and key (port)
             */
