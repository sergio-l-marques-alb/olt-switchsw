                              ...
                              soc_port_ability_t *ability)
{
    ...
    if ((PHYMOD_AN_CAP_25G_KRS1_GET(reg73_ability) && !PHYMOD_AN_CAP_25G_KR1_GET(reg73_ability)) ||
        (PHYMOD_AN_CAP_25G_CRS1_GET(reg73_ability) && !PHYMOD_AN_CAP_25G_CR1_GET(reg73_ability))) {
