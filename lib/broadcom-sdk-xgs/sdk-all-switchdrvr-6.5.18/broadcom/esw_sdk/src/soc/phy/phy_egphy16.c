...
#ifdef EGPHY16_RDB_READ_ENABLED
/*
 * Function:
...
#endif /* EGPHY16_RDB_READ_ENABLED */
...
_phy56275_ieee_compliance_setup(int unit, phy_ctrl_t *pc)
{
    ...
    /* PLL_NDIV_2 : ndiv_integer, doubler on*/
    SOC_IF_ERROR_RETURN
        (phy_egphy16_rdb_reg_write(unit, pc, 0x1c4, 0x0050));
    /* PLL_MANUAL_CONFIG : pdiv=15 : doubler enable,increase Kp,Ki */
    SOC_IF_ERROR_RETURN
        (phy_egphy16_rdb_reg_write(unit, pc, 0x1ce, 0x13df));
    ...
    /* PLLREF_REFERENCE: reference frequency*/
    SOC_IF_ERROR_RETURN
        (phy_egphy16_rdb_reg_write(unit, pc, 0x1c3, 0x4019));
    /* PLL_CONTROLS_2: Enable init_bypass mode*/
    SOC_IF_ERROR_RETURN
        (phy_egphy16_rdb_reg_write(unit, pc, 0x1cb, 0x0002));
    /* PLL_CONTROLS: Bypass code*/
    SOC_IF_ERROR_RETURN
        (phy_egphy16_rdb_reg_write(unit, pc, 0x1cc, 0x8c02));
     ...
     * config override, disable dco offset
     */
    SOC_IF_ERROR_RETURN
        (phy_egphy16_rdb_reg_write(unit, pc, 0x1cd, 0xa010));
