...
int pm8x50_fabric_pm_speed_config_validate(int unit, int pm_id, pm_info_t pm_info, const portmod_pbmp_t* ports, int flag, portmod_pm_vco_setting_t* vco_setting)
{
    ...
    uint32 ports_count;
    int pll_index, end_pll, begin_pll, required_pll_index, updated_pll_index;
    ...
    PM8X50_FABRIC_PLLS_ITER(begin_pll, end_pll, required_pll_index)
    {
        ...
        {
            PM8X50_FABRIC_PLLS_ITER(begin_pll, end_pll, updated_pll_index)
            {
            ...
            if (updated_pll_index < begin_pll)
            {
