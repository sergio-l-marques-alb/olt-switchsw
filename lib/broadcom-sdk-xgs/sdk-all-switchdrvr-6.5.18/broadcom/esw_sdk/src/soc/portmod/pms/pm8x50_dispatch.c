...
__portmod__dispatch__t__ portmod_pm8x50_driver = {

    pm8x50_port_speed_ability_local_get,
    pm8x50_pm_interface_type_is_supported,
    pm8x50_pm_init,
    pm8x50_pm_destroy,
    pm8x50_port_attach,
    NULL, /* portmod_default_bus_update */
    NULL, /* portmod_pm_bypass_set */
    pm8x50_pm_core_info_get,
    NULL, /* portmod_pm_aggregated_update */
    pm8x50_pm_phys_get,
    pm8x50_port_detach,
    pm8x50_port_replace,
    pm8x50_port_enable_set,
    pm8x50_port_enable_get,
    ...
    pm8x50_port_cl72_set,
    pm8x50_port_cl72_get,
    pm8x50_port_cl72_status_get,
    pm8x50_port_loopback_set,
    pm8x50_port_loopback_get,
    ...
    pm8x50_port_rx_mac_enable_set,
    pm8x50_port_rx_mac_enable_get,
    pm8x50_port_tx_mac_enable_set,
    pm8x50_port_tx_mac_enable_get,
    NULL, /* portmod_port_ability_local_get */
    pm8x50_port_autoneg_set,
    pm8x50_port_autoneg_get,
    pm8x50_port_autoneg_status_get,
    pm8x50_port_link_get,
    pm8x50_port_link_latch_down_get,
    pm8x50_port_phy_link_up_event,
    pm8x50_port_phy_link_down_event,
    pm8x50_port_prbs_config_set,
    pm8x50_port_prbs_config_get,
    pm8x50_port_prbs_enable_set,
    pm8x50_port_prbs_enable_get,
    pm8x50_port_prbs_status_get,
    pm8x50_port_nof_lanes_get,
    ...
    pm8x50_port_firmware_mode_set,
    pm8x50_port_firmware_mode_get,
    pm8x50_port_runt_threshold_set,
    pm8x50_port_runt_threshold_get,
    pm8x50_port_max_packet_size_set,
    pm8x50_port_max_packet_size_get,
    pm8x50_port_pad_size_set,
    pm8x50_port_pad_size_get,
    pm8x50_port_tx_mac_sa_set,
    pm8x50_port_tx_mac_sa_get,
    pm8x50_port_rx_mac_sa_set,
    pm8x50_port_rx_mac_sa_get,
    pm8x50_port_tx_average_ipg_set,
    pm8x50_port_tx_average_ipg_get,
    NULL, /* portmod_port_tx_preamble_length_set */
    NULL, /* portmod_port_tx_preamble_length_get */
    pm8x50_port_local_fault_control_set,
    pm8x50_port_local_fault_control_get,
    pm8x50_port_remote_fault_control_set,
    pm8x50_port_remote_fault_control_get,
    pm8x50_port_local_fault_status_get,
    pm8x50_port_remote_fault_status_get,
    pm8x50_port_local_fault_status_clear,
    pm8x50_port_remote_fault_status_clear,
    pm8x50_port_pause_control_set,
    pm8x50_port_pause_control_get,
    pm8x50_port_pfc_control_set,
    pm8x50_port_pfc_control_get,
    NULL, /* portmod_port_llfc_control_set */
    NULL, /* portmod_port_llfc_control_get */
    pm8x50_port_update,
    pm8x50_port_core_access_get,
    pm8x50_port_phy_lane_access_get,
    pm8x50_pm_phy_lane_access_get,
    pm8x50_port_duplex_set,
    pm8x50_port_duplex_get,
    pm8x50_port_phy_reg_read,
    pm8x50_port_phy_reg_write,
    pm8x50_port_reset_set,
    pm8x50_port_reset_get,
    NULL, /* portmod_port_adv_remote_get */
    NULL, /* portmod_port_drv_name */
    pm8x50_port_drv_name_get,
    pm8x50_port_fec_enable_set,
    pm8x50_port_fec_enable_get,
    pm8x50_port_ability_advert_set,
    pm8x50_port_ability_advert_get,
    pm8x50_port_ability_remote_get,
    pm8x50_port_frame_spacing_stretch_set,
    pm8x50_port_frame_spacing_stretch_get,
    pm8x50_port_diag_fifo_status_get,
    pm8x50_port_rx_control_set,
    pm8x50_port_rx_control_get,
    pm8x50_port_pfc_config_set,
    pm8x50_port_pfc_config_get,
    pm8x50_port_eee_set,
    pm8x50_port_eee_get,
    pm8x50_port_eee_clock_set,
    pm8x50_port_eee_clock_get,
    pm8x50_port_vlan_tag_set,
    pm8x50_port_vlan_tag_get,
    pm8x50_port_modid_set,
    pm8x50_port_led_chain_config,
    pm8x50_port_clear_rx_lss_status_set,
    pm8x50_port_clear_rx_lss_status_get,
    pm8x50_xphy_lane_attach_to_pm,
    pm8x50_xphy_lane_detach_from_pm,
    NULL, /* portmod_ext_phy_lane_attach_to_pm */
    NULL, /* portmod_ext_phy_lane_detach_from_pm */
    pm8x50_port_lag_failover_status_toggle,
    pm8x50_port_lag_failover_loopback_set,
    pm8x50_port_lag_failover_loopback_get,
    pm8x50_port_mode_set,
    pm8x50_port_mode_get,
    pm8x50_port_encap_set,
    pm8x50_port_encap_get,
    pm8x50_port_higig_mode_set,
    pm8x50_port_higig_mode_get,
    pm8x50_port_higig2_mode_set,
    pm8x50_port_higig2_mode_get,
    pm8x50_port_config_port_type_set,
    pm8x50_port_config_port_type_get,
    pm8x50_port_trunk_hwfailover_config_set,
    pm8x50_port_trunk_hwfailover_config_get,
    pm8x50_port_trunk_hwfailover_status_get,
    pm8x50_port_diag_ctrl,
    pm8x50_port_ref_clk_get,
    pm8x50_port_lag_failover_disable,
    pm8x50_port_lag_remove_failover_lpbk_set,
    pm8x50_port_lag_remove_failover_lpbk_get,
    pm8x50_port_cntmaxsize_set,
    pm8x50_port_cntmaxsize_get,
    NULL, /* portmod_port_multi_get */
    pm8x50_port_drain_cell_get,
    pm8x50_port_drain_cell_stop,
    pm8x50_port_drain_cell_start,
    pm8x50_port_drain_cells_rx_enable,
    pm8x50_port_egress_queue_drain_rx_en,
    pm8x50_port_mac_ctrl_set,
    pm8x50_port_txfifo_cell_cnt_get,
    pm8x50_port_egress_queue_drain_get,
    pm8x50_port_mac_reset_set,
    pm8x50_port_mac_reset_get,
    pm8x50_port_soft_reset_toggle,
    pm8x50_port_mac_reset_check,
    pm8x50_port_core_num_get,
    pm8x50_port_e2ecc_hdr_set,
    pm8x50_port_e2ecc_hdr_get,
    pm8x50_port_e2e_enable_set,
    pm8x50_port_e2e_enable_get,
    NULL, /* portmod_port_fallback_lane_get */
    pm8x50_port_speed_get,
    NULL, /* portmod_pm_tsc_refclock_set */
    NULL, /* portmod_pm_tsc_refclock_get */
    pm8x50_port_discard_set,
    pm8x50_port_soft_reset_set,
    pm8x50_port_tx_down,
    NULL, /* portmod_port_logical_lane_order_set */
    NULL, /* portmod_port_logical_lane_order_get */
    pm8x50_port_pgw_reconfig,
    pm8x50_port_notify,
    pm8x50_port_control_phy_timesync_set,
    pm8x50_port_control_phy_timesync_get,
    pm8x50_port_timesync_config_set,
    pm8x50_port_timesync_config_get,
    pm8x50_port_timesync_enable_set,
    pm8x50_port_timesync_enable_get,
    pm8x50_port_timesync_nco_addend_set,
    pm8x50_port_timesync_nco_addend_get,
    pm8x50_port_timesync_framesync_mode_set,
    pm8x50_port_timesync_framesync_mode_get,
    pm8x50_port_timesync_local_time_set,
    pm8x50_port_timesync_local_time_get,
    pm8x50_port_timesync_load_ctrl_set,
    pm8x50_port_timesync_load_ctrl_get,
    pm8x50_port_timesync_tx_timestamp_offset_set,
    pm8x50_port_timesync_tx_timestamp_offset_get,
    pm8x50_port_timesync_rx_timestamp_offset_set,
    pm8x50_port_timesync_rx_timestamp_offset_get,
    ...
    pm8x50_port_interrupt_enable_set,
    pm8x50_port_interrupt_enable_get,
    pm8x50_port_interrupt_get,
    pm8x50_port_interrupts_get,
    pm8x50_port_check_legacy_phy,
    pm8x50_port_failover_mode_set,
    pm8x50_port_failover_mode_get,
    pm8x50_port_mac_rsv_mask_set,
    NULL, /* portmod_port_mib_reset_toggle */
    pm8x50_port_warmboot_db_restore,
    pm8x50_port_flow_control_set,
    pm8x50_port_update_dynamic_state,
    pm8x50_port_phy_op_mode_get,
    pm8x50_port_lane_map_set,
    pm8x50_port_lane_map_get,
    ...
    pm8x50_core_add,
    pm8x50_pm_serdes_core_init,
    pm8x50_pm_is_initialized,
    pm8x50_port_speed_config_validate,
    pm8x50_pm_enable,
    pm8x50_pm_logical_pbmp_get,
    pm8x50_pm_vco_reconfig,
    pm8x50_port_speed_config_set,
    pm8x50_port_speed_config_get,
    ...
    pm8x50_pm_speed_config_validate,
    pm8x50_pm_vcos_get,
    NULL, /* portmod_pm_specific_vcos_get */
    pm8x50_port_autoneg_ability_advert_set,
    pm8x50_port_autoneg_ability_advert_get,
    pm8x50_port_autoneg_ability_remote_get,
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    NULL, /* portmod_cpri_port_interrupt_process */
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    ...
    pm8x50_port_tx_set,
    pm8x50_port_tx_get,
    pm8x50_port_synce_clk_ctrl_set,
    pm8x50_port_synce_clk_ctrl_get,
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    NULL, /* portmod_cpri_port_ecc_interrupt_status_get */
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
    pm8x50_pm_interrupt_process,
    pm8x50_pm_core_num_get,
    pm8x50_port_rlm_config_set,
    pm8x50_port_rlm_config_get,
    pm8x50_port_rlm_status_get,
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
    pm8x50_port_pcs_lane_map_reconfig,
};
