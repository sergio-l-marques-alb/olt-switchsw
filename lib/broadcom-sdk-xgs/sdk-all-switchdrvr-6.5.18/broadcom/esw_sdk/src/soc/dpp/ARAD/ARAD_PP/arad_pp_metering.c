  ...
  )
{
  ...
  if (bw_profile_info->is_sharing_enabled) {
      ...
      else 
      {
          ...
          if ((bw_profile_info->max_cir != SOC_PPC_BW_PROFILE_IR_MAX_UNLIMITED) && (bw_profile_info->max_cir != 0)) { /* not max cir unlimited or 0 */
              res = soc_sand_break_complex_to_mnt_exp_round_down_2(
          ...
          if ((bw_profile_info->max_eir != SOC_PPC_BW_PROFILE_IR_MAX_UNLIMITED) && (bw_profile_info->max_eir != 0)) { /* not max eir unlimited */
              res = soc_sand_break_complex_to_mnt_exp_round_down_2(
