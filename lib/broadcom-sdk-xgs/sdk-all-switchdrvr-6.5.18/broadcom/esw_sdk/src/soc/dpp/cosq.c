  ...
  )
{
    ...
    if (SOC_IS_QAX(unit)) {
        ...
        /*
         * QAX guaranteed management is done internally in SOC units (words vs. bytes).
         * Thus when returning total resource amount, the number needs to be converted back to 
         * user units.
         */
