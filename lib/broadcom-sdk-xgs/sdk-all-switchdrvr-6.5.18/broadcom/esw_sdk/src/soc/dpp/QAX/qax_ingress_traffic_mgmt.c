  ...
  )
{
    ...
    res = WRITE_CGM_FIFO_SIZESr(unit, data); 
    SOCDNX_IF_ERR_EXIT(res);
        ...
        SOC_SAND_IN  ARAD_ITM_SYS_RED_GLOB_RCS_INFO *info)
{
    ...
    SOCDNX_IF_ERR_EXIT(READ_CGM_SYSTEM_RED_RANGE_FR_RSRC_THr(unit, data_above_64));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_CGM_SYSTEM_RED_RANGE_FR_RSRC_THr(unit, data_above_64));

    SOCDNX_IF_ERR_EXIT(READ_CGM_SYSTEM_RED_QSIZE_FR_RSRC_THr(unit, &data64));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_CGM_SYSTEM_RED_QSIZE_FR_RSRC_THr(unit, data64));
