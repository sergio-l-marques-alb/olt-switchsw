  ...
  )
{
    ...
    {
        SOCDNX_IF_ERR_EXIT(READ_ECGM_CONGESTION_MANAGEMENT_MULTICAST_RESERVED_RESOURCESr_REG64(unit, &reg_64));
        if ((threshold_type == soc_dpp_cosq_threshold_packet_descriptors) || (threshold_type == soc_dpp_cosq_threshold_available_packet_descriptors))
        {
            switch (drop_type)
            {
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_ECGM_CONGESTION_MANAGEMENT_MULTICAST_RESERVED_RESOURCESr_REG64(unit, reg_64));
    }
    else /* specific TC */
    {
