...
int soc_dpp_drc_combo28_shmoo_init_ddr4(int unit, int drc_ndx)
{
    ...
    /** MR3 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 3, drc_info->mr[3]));
    sal_usleep(1);
    /** MR6 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 6, drc_info->mr[6]));
    sal_usleep(1);
    /** MR5 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 5, drc_info->mr[5]));
    sal_usleep(1);
    /** MR4 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 4, drc_info->mr[4]));
    sal_usleep(1);
    /** MR2 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 2, drc_info->mr[2]));
    sal_usleep(1);
    /** MR1 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 1, drc_info->mr[1]));
    sal_usleep(1);
    /** MR0 */
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_load_mrs(unit, drc_ndx, 0, drc_info->mr[0]));
    sal_usleep(1);
