...
/* $Id: arad_scheduler_flow_converts.c,v 1.8 Broadcom SDK $
  ...
  )
{
  ...
  /*
   * SP_ENHANCED: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP_ENCHANCED,
  ...
  /*
   * SP1: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP1, and the se operates
  ...
  /*
   * SP2: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP2, and the se operates
   *      in one of the following configurations:
   *      1. Mode 1 (the WFQ mode is don't care)
   *      2. Mode 2 and discrete WFQ mode
   *                   Or
   *      CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP4, and the se operates
  ...
  /*
   * SP3: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP3, and the se operates
  ...
  /*
   * SP4: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP4, and the se operates
   *      in Mode 1 (the WFQ mode is don't care)
   */
  else if (
    (ARAD_SCH_SUB_FLOW_COS_CL_SP4 == internal_sub_flow->cos) &&
  ...
  /*
   * SP1_WFQ1: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP1, and the se operates
   *           in one of the following configurations:
  ...
  /*
   * SP1_WFQ2: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP2, and the se operates
   *           in one of the following configurations:
   *           1. Mode 3 and discrete WFQ mode
   *           2. Mode 5 and discrete WFQ mode
   */
  ...
  /*
   * SP1_WFQ3: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP3, and the se operates
   *           in one of the following configurations:
   *           1. Mode 3 and discrete WFQ mode
   *           2. Mode 5 and discrete WFQ mode
   */
  ...
  /*
   * SP1_WFQ4: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP4, and the se operates
  ...
  /*
   * SP2_WFQ1: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP2, and the se operates
  ...
  /*
   * SP2_WFQ2: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP3, and the se operates
   *           in Mode 4 and discrete WFQ mode
   */
  else if (
    (ARAD_SCH_SUB_FLOW_COS_CL_SP3 == internal_sub_flow->cos) &&
  ...
  /*
   * SP2_WFQ3: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP4, and the se operates
   *           in Mode 4 and discrete WFQ mode
   */
  else if (
    (ARAD_SCH_SUB_FLOW_COS_CL_SP4 == internal_sub_flow->cos) &&
  ...
  /*
   * SP3_WFQ1: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP3, and the se operates
  ...
  /*
   * SP3_WFQ2: CoS is ARAD_SCH_SUB_FLOW_COS_CL_SP4, and the se operates
   *           in Mode 2 and discrete WFQ mode
   */
  else if (
    (ARAD_SCH_SUB_FLOW_COS_CL_SP4 == internal_sub_flow->cos) &&
