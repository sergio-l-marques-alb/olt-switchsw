...
CONST soc_dpp_defines_t soc_dpp_defines_flair= {
    ...
    SOC_DPP_NOF_SRAM_PDS_FLAIR,
    SOC_DPP_NOF_DRAM_BDS_FLAIR,
    ...
    SOC_DPP_OAMP_NUMBER_OF_SD_SF_DB_1_FLAIR,
    ...
    SOC_DPP_FIELD_LARGE_DIRECT_LU_KEY_MIN_LENGTH_FLAIR,
    SOC_DPP_FIELD_LARGE_DIRECT_LU_KEY_MAX_LENGTH_FLAIR,
