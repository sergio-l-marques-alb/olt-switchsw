...
/*This function must be called while holding jer_sbusdma_desc_timeout_mutex*/
...
uint32 jer_sbusdma_desc_add_reg(int unit, soc_reg_t reg, int instance, uint32 array_index, void *entry_data){
    ...
    SOCDNX_IF_ERR_EXIT(jer_sbusdma_desc_add_mem_reg(unit, INVALIDm, reg, array_index, instance, 0/*offset*/, entry_data));
