...
{
    _SHR_PACK_U32(buf, msg->export_threshold);
    ...
    _SHR_PACK_U8(buf, msg->drop_weight);
    _SHR_PACK_U8(buf, msg->rx_weight);
...
shr_ft_qcm_msg_ctrl_flow_view_cfg_unpack(uint8* buf,
                                         shr_ft_qcm_msg_ctrl_flow_view_t *msg)
{
    _SHR_UNPACK_U32(buf, msg->export_threshold);
    ...
    _SHR_UNPACK_U8(buf, msg->drop_weight);
    _SHR_UNPACK_U8(buf, msg->rx_weight);
