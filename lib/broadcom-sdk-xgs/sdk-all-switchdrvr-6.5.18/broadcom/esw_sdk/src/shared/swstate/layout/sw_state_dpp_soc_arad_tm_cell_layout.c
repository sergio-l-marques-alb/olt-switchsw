...
int sw_state_dpp_soc_arad_tm_cell_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   ARAD_CELL* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(ARAD_CELL),"ARAD_CELL"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "cell",             /* name */         
                                   sizeof(ARAD_CELL),    /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   "ARAD_CELL",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_tm_cell_current_cell_ident_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   ...
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->current_cell_ident)) - (( uint8*) dummy_struct); 
