 ...
 *            assign DSCP to outer VxLAN IP header.
 *
 * Usage    : BCM.0> cint ipv4_riot_AtoN_DscpAssign.c
 *
 * config   : config_td3_flex_riot.bcm
 *
 * Log file : ipv4_riot_AtoN_DscpAssign_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *   SMAC 00::22:22:22              |                      +--------------------+   |
 *            +---+          VLAN-10|                      |00::bb:bb           +---+
 *   Host(acc)|   +-----------------+      Trident-3       |DSCP:0x0          00::aa:aa
 *            +---+    ingress_port |                      |                  DSCP : 0x10(16)
 *   DSCP : 0x0                     |                      |
 *                                  |                      |
 *                                  |                      |
 *                                  +----------------------+
...
data[0010]: 0800 4540 0068 0000 0000 3f11 3f26 0a0a
...
data[0070]: 0000 0000 0000 0000 0000 365c d145
*/
