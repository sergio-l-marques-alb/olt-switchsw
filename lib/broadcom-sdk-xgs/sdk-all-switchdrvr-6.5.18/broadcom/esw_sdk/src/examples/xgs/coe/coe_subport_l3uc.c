...
printf(" Creating the Entry\n");
    ...
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagSignature, 0x11, 0);
    print bcm_field_entry_install(unit,entry);
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagPayloadOffset, 0xE8, 0);
    print bcm_field_entry_install(unit,entry);
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagPrio, 0, 0);
    print bcm_field_entry_install(unit,entry);
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagSubportNum, 10, 0);
    print bcm_field_entry_install(unit,entry);
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagEnable, 0, 1);
