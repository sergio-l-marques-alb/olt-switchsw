...
config_efp(int unit)
{
    ...
    print bcm_field_entry_install(unit,entry);
/*
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagPktType, bcmFieldMacSecPktTypeControlPkt, 0);
    print bcm_field_entry_install(unit,entry);
*/
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagSubportNum, 10, 0);
    print bcm_field_entry_install(unit,entry);
    print bcm_field_action_add(unit, entry, bcmFieldActionSubportSvtagEnable, 0, 0);
