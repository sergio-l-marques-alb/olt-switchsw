 ...
 *
 *  Should recieve 2 packets: forward copy + snoop copy. ToD timestamp is on the tail edit header in the snooped copy.
...
/*
 * In case mpls_2puls1_on_vpn_label is 1, test mpls_2plus1 on vpn label. 
 * In case mpls_2puls1_on_vpn_label is 0, test mpls_2plus2 on vpn label. 
 *
 */
int mpls_2plus1_on_vpn_label = 0;
        ...
        int unit)
{
   ...
   rv = cint_field_alternate_marking_ingress_node_entry_add(unit,&entry_handle);
   if (rv != BCM_E_NONE)
   {
