    ...
    int add_to_flooding)
{
    ...
    /**
     * JR2 bug: outlif profile used for split horizon filter was taken from ETPS[0](L2-FODO),
     * rather than expected EES[0](IP-TUNNEL).(L2-FODO entry was created in vxlan VPN creation.)
     * This is a WA for updating outlif-profile in L2-FODO
     */
    ...
    int unit)
{
    ...
    rv = multicast__add_multicast_entry(unit, mc_id, &port, &mc_ext_id, 1, 0);
    if (rv != BCM_E_NONE)
    {
