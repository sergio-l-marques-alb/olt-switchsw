/*
 * $Id: cint_dnx_oam_y1731_over_pwe_protection.c, Exp $
 $Copyright: (c) 2019 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_oam_y1731_over_pwe_protection.c
 *
...
/*
 * Ignore Failover Set. Only supported by J2C, Q2A, J2P and above.
 */
int
    ...
    int is_mep_with_id)
{
    ...
    rv = set_counter_resource(unit, lm_pwe_port, counter_if, &lm_counter_base_id_pwe_pri);
    BCM_IF_ERROR_RETURN(rv);
    rv = set_counter_resource(unit, lm_pwe_port, counter_if, &lm_counter_base_id_pwe_bp);
    BCM_IF_ERROR_RETURN(rv);
    ...
    int is_mep_with_id)
{
    ...
    rv = set_counter_resource(unit, lm_pwe_port, counter_if, &lm_counter_base_id_mpls_pri);
    BCM_IF_ERROR_RETURN(rv);
    rv = set_counter_resource(unit, lm_pwe_port, counter_if, &lm_counter_base_id_mpls_bp);
    BCM_IF_ERROR_RETURN(rv);
    ...
    int is_mep_with_id)
{
    ...
    rv = set_counter_resource(unit, lm_pwe_port, counter_if, &lm_counter_base_id_section_pri);
    BCM_IF_ERROR_RETURN(rv);
    rv = set_counter_resource(unit, lm_pwe_port, counter_if, &lm_counter_base_id_section_bp);
    BCM_IF_ERROR_RETURN(rv);
