/*
 * $Id: cint_stat_pp_vpls.c,v 1.15 2018/08/07 12:47:34 Huili Zhang Exp $
 $Copyright: (c) 2019 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_vpls.c Purpose: Statistic configuration for vpls (pwe in/out lif, mpls in/out lif).
 */
