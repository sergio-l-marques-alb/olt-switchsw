...
int cint_field_stat_sampling_by_inport(int unit, bcm_field_context_t context_id, bcm_field_stage_t stage,int stat_sampling_code, int stat_sampling_qualifier, int port)
{
    bcm_field_group_info_t fg_info;
    bcm_field_group_attach_info_t attach_info;
    bcm_field_context_info_t context_info;
