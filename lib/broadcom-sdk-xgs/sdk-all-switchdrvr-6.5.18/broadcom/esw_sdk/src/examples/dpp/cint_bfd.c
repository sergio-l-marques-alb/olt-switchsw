...
int sbfd_reflector_endpoint_create(int unit, bcm_ip_t src_ip, uint32 local_min_tx, bcm_bfd_state_t local_state)
{
    ...
    bfd_endpoint_info.type = bcmBFDTunnelTypeUdp; /* Will support both SBFDoIPV4 and SBFDoMPLS*/
