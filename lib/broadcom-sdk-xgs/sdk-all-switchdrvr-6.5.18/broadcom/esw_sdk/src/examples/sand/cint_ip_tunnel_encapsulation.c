/*
 * $Id: cint_ip_tunnel_encapsulation.c,v 1.15 Broadcom SDK $
 $Copyright: (c) 2019 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_ip_tunnel_encapsulation.c Purpose: Various examples for IPTunnels.
 */
 ...
 *
 *  Packet walk:
 *  1)  Packet arrives at the incoming access_port (200).
 *  2)  AC In-LIF is resolved from In-PP-Port and VLAN (VD, VID) in VTT1.
 *  3)  VSI is resolved from AC In-LIF.forawarding-domain.
 *  4)  ETH-RIF equal to VSI is enabled for routing.
 *  5)  ETH is terminated.
 *  6)  Forwarding destination is resolved from MPLS->FEC lookup in LEM.
 *  7)  FEC is resolved as Outlif, Destination port and Global Out-EthRIF.
 *  8)  The GRE4oIPv4 tunnel headers are encapsulated in Encap-1.
 *  9)  The LL ETH is encapsulated in Encap-5 from the ARP entry.
 *  10) Outgoing packet of the egress pipeline is MPLSoGRE4oIPv4oETH.
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *  4)  ETH-RIF equal to VSI is enabled for routing.
 *  5)  ETH is terminated.
 *  6)  Forwarding destination is resolved from {DIP, VRF} lookup in LPM.
 *  7)  FEC is resolved as Outlif, Destination port and Global Out-EthRIF.
 *  8)  The GRE4oIPv4 tunnel headers are encapsulated in Encap-1.
 *  9)  The LL ETH is encapsulated in Encap-5 from the ARP entry.
 *  10) Outgoing packet of the egress pipeline is Ipv6oGRE4oIPv4oETH.
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *  8)  The GRE4oIPv4 tunnel headers are encapsulated in Encap-1.
 *  9)  The LL ETH is encapsulated in Encap-5 from the ARP entry.
 *  10) Outgoing packet of the egress pipeline is MPLSoGRE8oIPv4oETH.
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *  6)  Forwarding destination is resolved from {DIP, VRF} lookup in LPM.
 *  7)  FEC is resolved as Outlif, Destination port and Global Out-EthRIF.
 *  8)  The GRE8oIPv4 tunnel headers are encapsulated in Encap-1.
 *  9)  The LL ETH is encapsulated in Encap-5 from the ARP entry.
 *  10) Outgoing packet of the egress pipeline is IpvXoGRE8oIPv4oETH.
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *
 *  Packet walk:
 *  1)  Packet arrives at the incoming port (201).
 *  2)  AC In-LIF is resolved from In-PP-Port and VLAN (VD, VID) in VTT1.
 *  3)  VSI is resolved from AC In-LIF.forawarding-domain.
 *  4)  ETH-RIF equal to VSI is enabled for routing.
 *  5)  ETH is terminated.
 *  6)  Forwarding destination is resolved from {DIP, VRF} lookup in LPM.
 *  7)  FEC is resolved as Outlif, Destination port and Global Out-EthRIF.
 *  8)  The MPLsoGRE4oIPv4 tunnel headers are encapsulated in Encap-1.
 *  9)  The LL ETH is encapsulated in Encap-5 from the ARP entry.
 *  10) Outgoing packet of the egress pipeline is IpvXoGRE4oMPLSoIPv4oETH.
 */
