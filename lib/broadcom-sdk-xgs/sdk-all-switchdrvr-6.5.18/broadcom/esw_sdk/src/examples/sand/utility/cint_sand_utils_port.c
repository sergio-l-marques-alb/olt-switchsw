                             ...
                             int hp_pcp, int high_priority, uint32 tpid, uint32 header)
{
    ...
    */
    ...
    } else if ((info.device == 0x8680 && header == 3) || (info.device == 0x8690 && header == 3) || (info.device == 0x8480 && header == 3) || (info.device == 0x8800 && header == 3)) {
    ...
    } else if ((info.device == 0x8680 && header == 4) || (info.device == 0x8690 && header == 4) || (info.device == 0x8480 && header == 4) || (info.device == 0x8800 && header == 4)) {
