/*
 * $Id: cint_ip_tunnel_encap_basic.c,v 1.15 Broadcom SDK $
 $Copyright: (c) 2019 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_ip_tunnel_encap_basic.c Purpose: Various examples for IPTunnels.
 */
 ...
 *  7) Get the forwarding destination from a {DIP, VRF}->FEC lookup in LPM
 *  8) Forwarding resolution is a FEC which points to the Out-Lif.
 *  9) The GRE4oIPv4 tunnel headers are encapsulated in Encap-1.
 *  10) The LL ETH is encapsulated in Encap-5 from the ARP entry.
 */
