    ...
    int ecmp_id)
{
    ...
    */
    ...
    for (iter = 0; iter < NOF_OF_MEMBERS_ECMP_TP_GROUPS; iter++)
    {
        ...
        {
            /*
             * Currently in C-model consecutive even and odd LIF entries get the even entry payload.
             * This allocation is a WA to create odd LIF entries but don't use them so we can be sure what is the ARP payload
