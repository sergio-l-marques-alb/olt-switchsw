...
/* $Id: cint_sand_tdm_example.c,v 1.7 Broadcom SDK $
    ...
    int *ingress_context_id_p)
{
     ...
     * other sources).
     */
    flags = BCM_TDM_INGRESS_CONTEXT_USE_ALL_FABRIC_LINKS;
    type_as_int = type;
    if (detailed_dnx_print)
    {
    ...
    int mc_port2)
{
    ...
    if (detailed_dnx_print)
    {
        printf("\r\n %s(): ENTER. src_port %d dst_port mc_group_id %d %d num_in_mcast_group %d\r\n", proc_name, local_port_id, dest_gport, mc_group_id, num_in_mcast_group);
    }
    /*
