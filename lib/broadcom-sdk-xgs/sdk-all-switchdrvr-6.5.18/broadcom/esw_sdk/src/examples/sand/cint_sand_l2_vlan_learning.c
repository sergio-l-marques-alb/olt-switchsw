...
l2_vlan_learning_run(int unit, int port_1, int port_2){
    ...
    if (is_jericho2) 
    {
        aging_profiles_bug = *(dnxc_data_get(unit, "l2", "hw_bug", "age_out_and_refresh_profile_selection", NULL)); 
    }
...
bcm_field_group_t j1_wa_2ndpass_group_id = 0;

int
l2_learning_field_j1_wa_2ndpass_destination_set(int unit, int destination){
    ...
    j1_wa_2ndpass_group_id = fg_id;

    /*
     * Attach the FG to context
     */
    context_id = *(dnxc_data_get(0,  "field", "context", "default_j1_learning_2ndpass_context", NULL));
    bcm_field_group_attach_info_t_init(&attach_info);
    attach_info.key_info.nof_quals = fg_info.nof_quals;
    attach_info.payload_info.nof_actions = fg_info.nof_actions;
    attach_info.payload_info.action_types[0] = fg_info.action_types[0];
    /*
     * Priority 10 used to override the priority of the default WA application
     */
...
int
l2_learning_field_j1_wa_2ndpass_destination_reset(int unit){

    int rv;
    bcm_field_action_t action_id;
    bcm_field_action_t action_type = bcmFieldActionRedirect;
    bcm_field_group_t fg_id = j1_wa_2ndpass_group_id;
    bcm_field_context_t context_id = 0;
    bcm_field_action_info_t action_info;
    bcm_field_action_info_t action_info_get_size;
    bcm_field_group_info_t fg_info;
