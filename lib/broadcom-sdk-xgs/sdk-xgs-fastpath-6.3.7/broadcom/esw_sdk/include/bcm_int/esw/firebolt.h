/*
 * $Id: firebolt.h 1.325.2.1 Broadcom SDK $
...
typedef struct _bcm_l3_ecmp_info_s {
    ...
    int ecmp_flags[BCM_L3_MAX_ECMP_GROUPS];              /* ECMP group flags. */
} _bcm_l3_ecmp_info_t;
...
/* ECMP group flags */
#define BCM_XGS3_L3_ECMP_GROUP_FLAGS(_u_, _id_)  \
           BCM_XGS3_L3_TBL(_u_, ecmp_info).ecmp_flags[_id_]
...
extern int _bcm_xgs3_egress_l3_intf_id_alloc(int unit, int *id);
...
extern int _bcm_field_fb_stat_hw_mode_to_bmap(int unit, uint8 mode, 
