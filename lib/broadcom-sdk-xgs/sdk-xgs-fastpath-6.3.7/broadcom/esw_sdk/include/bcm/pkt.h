/*
 * $Id: 84b95352d0435f686be18eaeb18ae17b454fa42a $
 * 
...
typedef enum bcm_pkt_stk_forward_e {
    ...
    BCM_PKT_STK_FORWARD_BROADCAST,      /* Stacking header packet forwarding
                                           option: Broadcast. */
    BCM_PKT_STK_FORWARD_MPLS,           /* Stacking header packet forwarding
                                           option: MPLS. */
    BCM_PKT_STK_FORWARD_TRILL,          /* Stacking header packet forwarding
                                           option: TRILL. */
    BCM_PKT_STK_FORWARD_FCOE,           /* Stacking header packet forwarding
                                           option: FCoE. */
    BCM_PKT_STK_FORWARD_SNOOP,          /* Stacking header packet forwarding
                                           option: Snoop. */
    BCM_PKT_STK_FORWARD_TRAFFIC_MANAGEMENT, /* Stacking header packet forwarding
