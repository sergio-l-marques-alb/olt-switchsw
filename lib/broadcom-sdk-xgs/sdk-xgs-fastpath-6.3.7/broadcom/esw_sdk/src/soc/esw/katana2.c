...
static uint32 *bcm56450_tdm[]={
               ...
               kt2_tdm_A2_56450_12,              /*56248 Cfg=12:IntCfg=43 */
...
static bcm56450_tdm_info_t bcm56450_tdm_info[]={
	       ...
	       {205, 88, 8, 11},                     /*56450 Cfg=4:IntCfg=4 */
               ...
               {205, 108, 12, 9},                    /*56248 Cfg=10:IntCfg=41 */
               {205, 108, 12, 9},                    /*56248 Cfg=11:IntCfg=42 */
               {205, 108, 12, 9},                    /*56248 Cfg=12:IntCfg=43 */
               {205, 108, 12, 9},                    /*56248 Cfg=13:IntCfg=44 */
               {205, 108, 12, 9},                    /*56248 Cfg=14:IntCfg=45 */
               {205, 108, 12, 9},                    /*56248 Cfg=15:IntCfg=46 */
...
_soc_katana2_mmu_tdm_init(int unit)
{
    ...
    case BCM56458_DEVICE_ID:
         ...
         case BCM56455_DEVICE_ID_OFFSET_CFG + 2:
                soc_cm_print("kt2_tdm_C_56455_2 \n");
                sal_memcpy(arr,
                          &kt2_tdm_56455C_ref[0], sizeof(kt2_tdm_56455C_ref));
         ...
         case BCM56248_DEVICE_ID_OFFSET_CFG + 16:
                soc_cm_print("kt2_tdm_A3_56450_16 \n");
                sal_memcpy(arr,
    ...
    *  2 instances one each for evlan and ehcpm stages of epipe */
    ...
    if (SOC_REG_IS_VALID(unit, FP_CAM_CONTROL_TM_13_THRU_0r)) {
        ...
        soc_reg_field_set(unit, FP_CAM_CONTROL_TM_13_THRU_0r,
                          &rval, ALL_TCAMS_TM_13_0f, 0x30);
        soc_reg_field_set(unit, FP_CAM_CONTROL_TM_13_THRU_0r,
                          &rval, ALL_GLOBAL_MASK_TCAMS_TM_13_0f, 0x30);
...
/* #ifdef BROADCOM_SVK  */
   ...
   if (auto_polarity_flip) {
       if (soc_mem_config_set) {
           ...
           soc_cm_print("=====================================\n");
           soc_cm_print("soc_mem_config_set() NULL so cannot set"
