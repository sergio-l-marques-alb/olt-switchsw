...
STATIC
int _qsgmii_prbs_poly_phymod_to_eagle(phymod_prbs_poly_t phymod_poly, enum srds_prbs_polynomial_enum *eagle_poly)
{
    switch(phymod_poly){
...
STATIC
int _qsgmii_prbs_poly_tsce_to_phymod(eagle_prbs_polynomial_type_t tsce_poly, phymod_prbs_poly_t *phymod_poly)
{
    switch(tsce_poly){
...
int qsgmiie_phy_prbs_config_set(const phymod_phy_access_t* phy,  uint32_t flags, const phymod_prbs_t* prbs)
{
    ...
    PHYMOD_IF_ERR_RETURN(_qsgmii_prbs_poly_phymod_to_eagle(prbs->poly, &eagle_poly));
...
int qsgmiie_phy_prbs_config_get(const phymod_phy_access_t* phy, uint32_t flags, phymod_prbs_t* prbs)
{
    ...
    if (PHYMOD_PRBS_DIRECTION_TX_GET(flags)) {
        ...
        PHYMOD_IF_ERR_RETURN(_qsgmii_prbs_poly_tsce_to_phymod(tsce_poly, &config_tmp.poly));
