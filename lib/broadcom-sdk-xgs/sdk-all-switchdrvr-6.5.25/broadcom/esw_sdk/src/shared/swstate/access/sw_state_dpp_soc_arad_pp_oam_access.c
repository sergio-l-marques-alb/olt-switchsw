...
#if defined(BCM_PETRA_SUPPORT)
/* AUTO-GENERATED - DO NOT MODIFY */
int sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_set(int unit, uint32 lb_tst_up_trap_used_cnt){
    SW_STATE_INIT_FUNC_DEFS;
    SHR_SW_STATE_VERIFY( sw_state_access[unit].dpp.soc.arad.pp.oam.lb_tst_up_trap_used_cnt.verify( unit));
    SHR_SW_STATE_SET(
        unit,
        sw_state[unit]->dpp.soc.arad.pp->oam->lb_tst_up_trap_used_cnt,
        lb_tst_up_trap_used_cnt,
        uint32,
        SW_STATE_IS_WB_CHECK | SW_STATE_ALLOW_AUTOSYNC,
        "sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_set");
    SW_STATE_FUNC_RETURN;
}
...
#if defined(BCM_PETRA_SUPPORT)
/* AUTO-GENERATED - DO NOT MODIFY */
int sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_get(int unit, uint32 *lb_tst_up_trap_used_cnt){
    SW_STATE_INIT_FUNC_DEFS;
    SHR_SW_STATE_VERIFY( sw_state_access[unit].dpp.soc.arad.pp.oam.lb_tst_up_trap_used_cnt.verify( unit));
    *lb_tst_up_trap_used_cnt = sw_state[unit]->dpp.soc.arad.pp->oam->lb_tst_up_trap_used_cnt;
    SW_STATE_FUNC_RETURN;
}
...
#if defined(BCM_PETRA_SUPPORT)
/* AUTO-GENERATED - DO NOT MODIFY */
int sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_verify(int unit){
    SW_STATE_INIT_FUNC_DEFS;
    _rv = sw_state_access[unit].dpp.soc.arad.pp.oam.verify( unit);
    _SOC_IF_ERR_EXIT(_rv);
    SW_STATE_FUNC_RETURN;
...
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
    sw_state_access[unit].dpp.soc.arad.pp.oam.lb_tst_up_trap_used_cnt.set = sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_set;
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
    sw_state_access[unit].dpp.soc.arad.pp.oam.lb_tst_up_trap_used_cnt.get = sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_get;
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
    sw_state_access[unit].dpp.soc.arad.pp.oam.lb_tst_up_trap_used_cnt.verify = sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_verify;
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
    return _SHR_E_NONE;
}
