    ...
    dbal_entry_action_flags_e flags)
{
     ...
     *  default entry is all zeros, if is_default_non_standard we need to update the payload to the non standard values.
     *  to is_default_non_standard we prefer just getting the entry from the HW anyway. */
