 ...
 */
static shr_error_e
j2x_a0_dnx_data_dev_init_time_init_total_thresh_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dev_init_time_appl_init_total_thresh_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dev_init_time_step_thresh_set(
    int unit)
{
    int step_id_index;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dev_init_time_appl_step_thresh_set(
    int unit)
{
    int step_id_index;
    ...
    int unit)
{
     ...
     * Set key sizes
     */
    table->keys[0].size = 67;
    table->info_get.key_size[0] = 67;
...
/**
 * \brief device level function which set values for table emul_ext_init_path
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dev_init_mem_emul_ext_init_path_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dev_init_mem_table_emul_ext_init_path");
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dev_init_general_egress_estimated_bta_btr_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
/**
 * \brief device level function which set numeric heat_up
 * numeric info:
 * boot for heat-up
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define prp_pem_context_selection_mask_offset
 * define info:
...
/**
 * \brief device level function which set define prp_context_selection_result_offset
 * define info:
    ...
    int unit)
{
     ...
     * Set key sizes
     */
    table->keys[0].size = 124;
    table->info_get.key_size[0] = 124;
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_dev_init_time_init_total_thresh_set;
    data_index = dnx_data_dev_init_time_define_appl_init_total_thresh;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_dev_init_time_appl_init_total_thresh_set;
    ...
    table->set = j2x_a0_dnx_data_dev_init_time_step_thresh_set;
    data_index = dnx_data_dev_init_time_table_appl_step_thresh;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_dev_init_time_appl_step_thresh_set;
    /*
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_dev_init_general_egress_estimated_bta_btr_config_set;
