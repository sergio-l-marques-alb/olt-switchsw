/** \file j2p_a0_data_field_map.c
 * 
 * DEVICE DATA - FIELD_MAP
 * 
 * Device Data
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_field_map_action_params_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_field_map_action_table_params");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_map_qual_params_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_field_map_qual_table_params");
    ...
    if (DNX_FIELD_STAGE_EPMF < table->keys[0].size && DNX_FIELD_QUAL_FWD_STRENGTH < table->keys[1].size)
    {
        data = (dnx_data_field_map_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_EPMF, DNX_FIELD_QUAL_FWD_STRENGTH);
        data->offset = 1441;
        data->size = 3;
    }
...
/**
 * \brief device level function which set values for table special_metadata_qual
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_map_qual_special_metadata_qual_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_field_map_qual_table_special_metadata_qual");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_map_qual_layer_record_info_ingress_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_field_map_qual_table_layer_record_info_ingress");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_map_qual_layer_record_info_egress_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_field_map_qual_table_layer_record_info_egress");
