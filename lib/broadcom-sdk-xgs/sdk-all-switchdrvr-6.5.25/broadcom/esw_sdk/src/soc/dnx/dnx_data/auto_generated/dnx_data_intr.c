/** \file dnx_data_intr.c
 * 
 * MODULE DEVICE DATA - INTR
 * 
 * Device Data
...
#ifdef BCM_DNX2_SUPPORT
/*{*/
extern shr_error_e j2x_a0_data_intr_attach(
    int unit);
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_intr_general_define_nof_interrupts].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_mode].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_priority].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_delay].labels[0] = "j2x_notrev";
    /* Set data type flag */
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_delay].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_intr_general_define_epni_ebd_interrupt_assert_enable].name = "epni_ebd_interrupt_assert_enable";
    submodule_data->defines[dnx_data_intr_general_define_epni_ebd_interrupt_assert_enable].doc = "enable assert when epni ebd interrupt is rasied";
    submodule_data->defines[dnx_data_intr_general_define_epni_ebd_interrupt_assert_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    submodule_data->defines[dnx_data_intr_general_define_epni_ebd_interrupt_assert_enable].flags |= DNXC_DATA_F_NUMERIC;
    ...
    submodule_data->defines[dnx_data_intr_general_define_table_dma_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_tdma_timeout_usec].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_tdma_intr_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_tslam_dma_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_tslam_timeout_usec].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_tslam_intr_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_schan_timeout_usec].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_schan_intr_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_miim_timeout_usec].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_miim_intr_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_sbus_dma_interval].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_sbus_dma_intr_enable].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_intr_general_define_mem_clear_chunk_size].labels[0] = "j2x_notrev";
    /* Set data type flag */
    submodule_data->defines[dnx_data_intr_general_define_mem_clear_chunk_size].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_intr_general_define_ser_event_generate_support].name = "ser_event_generate_support";
    submodule_data->defines[dnx_data_intr_general_define_ser_event_generate_support].doc = "If support ser interrupt event.";
    submodule_data->defines[dnx_data_intr_general_define_ser_event_generate_support].labels[0] = "j2x_notrev";
    /* Set data type flag */
    submodule_data->defines[dnx_data_intr_general_define_ser_event_generate_support].flags |= DNXC_DATA_F_NUMERIC;
    ...
    submodule_data->tables[dnx_data_intr_general_table_active_on_init].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_on_init].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_print_on_init].labels[0] = "j2x_notrev";
    ...
    /*
     * Table - block_intr_field_mapping
     */
    ...
    submodule_data->tables[dnx_data_intr_general_table_block_intr_field_mapping].labels[0] = "j2x_notrev";
    ...
    /*
     * Table - skip_clear_on_init
     */
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].name = "skip_clear_on_init";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].doc = "interrupts skipped clear on init sequence";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].labels[0] = "j2x_notrev";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].size_of_values = sizeof(dnx_data_intr_general_skip_clear_on_init_t);
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].entry_get = dnx_data_intr_general_skip_clear_on_init_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].keys[0].name = "offset";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].keys[0].doc = "skip clear interrupt offset";

    /* Values */
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].nof_values, "_dnx_data_intr_general_table_skip_clear_on_init table values");
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].values[0].name = "intr";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].values[0].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].values[0].doc = "interrupt ident";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_general_skip_clear_on_init_t, intr);

    /*
     * Table - force_unmask_on_init
     */
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].name = "force_unmask_on_init";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].doc = "interrupts unmasked on init sequence";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].labels[0] = "j2x_notrev";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].size_of_values = sizeof(dnx_data_intr_general_force_unmask_on_init_t);
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].entry_get = dnx_data_intr_general_force_unmask_on_init_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].keys[0].name = "offset";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].keys[0].doc = "unmasked interrupt offset";

    /* Values */
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].nof_values, "_dnx_data_intr_general_table_force_unmask_on_init table values");
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].values[0].name = "intr";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].values[0].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].values[0].doc = "interrupt ident";
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_general_force_unmask_on_init_t, intr);

    /*
     * Table - skip_clear_on_regress
     */
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].name = "skip_clear_on_regress";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].doc = "interrupts skipped clear test on regress";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].labels[0] = "j2x_notrev";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].size_of_values = sizeof(dnx_data_intr_general_skip_clear_on_regress_t);
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].entry_get = dnx_data_intr_general_skip_clear_on_regress_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].keys[0].name = "offset";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].keys[0].doc = "unmasked interrupt offset";

    /* Values */
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].nof_values, "_dnx_data_intr_general_table_skip_clear_on_regress table values");
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].values[0].name = "intr";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].values[0].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].values[0].doc = "interrupt ident";
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_general_skip_clear_on_regress_t, intr);
...
uint32
dnx_data_intr_general_epni_ebd_interrupt_assert_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_define_epni_ebd_interrupt_assert_enable);
}
...
uint32
dnx_data_intr_general_ser_event_generate_support_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_define_ser_event_generate_support);
}
...
const dnx_data_intr_general_skip_clear_on_init_t *
dnx_data_intr_general_skip_clear_on_init_get(
    int unit,
    int offset)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_skip_clear_on_init);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, offset, 0);
    return (const dnx_data_intr_general_skip_clear_on_init_t *) data;

}

const dnx_data_intr_general_force_unmask_on_init_t *
dnx_data_intr_general_force_unmask_on_init_get(
    int unit,
    int offset)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_force_unmask_on_init);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, offset, 0);
    return (const dnx_data_intr_general_force_unmask_on_init_t *) data;

}

const dnx_data_intr_general_skip_clear_on_regress_t *
dnx_data_intr_general_skip_clear_on_regress_get(
    int unit,
    int offset)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_skip_clear_on_regress);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, offset, 0);
    return (const dnx_data_intr_general_skip_clear_on_regress_t *) data;
...
shr_error_e
dnx_data_intr_general_skip_clear_on_init_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_general_skip_clear_on_init_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_skip_clear_on_init);
    data = (const dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->intr);
...
shr_error_e
dnx_data_intr_general_force_unmask_on_init_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_general_force_unmask_on_init_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_force_unmask_on_init);
    data = (const dnx_data_intr_general_force_unmask_on_init_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->intr);
...
shr_error_e
dnx_data_intr_general_skip_clear_on_regress_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_general_skip_clear_on_regress_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_skip_clear_on_regress);
    data = (const dnx_data_intr_general_skip_clear_on_regress_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->intr);
...
const dnxc_data_table_info_t *
dnx_data_intr_general_skip_clear_on_init_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_skip_clear_on_init);

}

const dnxc_data_table_info_t *
dnx_data_intr_general_force_unmask_on_init_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_force_unmask_on_init);

}

const dnxc_data_table_info_t *
dnx_data_intr_general_skip_clear_on_regress_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_skip_clear_on_regress);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_intr_ser_define_tcam_protection_issue].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mem_mask].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_intr_exception].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_static_mem].labels[0] = "j2x_notrev";
     ...
     * Table - dynamic_mem
     */
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].name = "dynamic_mem";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].doc = "dynamic memory";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].labels[0] = "j2x_notrev";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].size_of_values = sizeof(dnx_data_intr_ser_dynamic_mem_t);
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].entry_get = dnx_data_intr_ser_dynamic_mem_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].keys[0].name = "index";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].keys[0].doc = "dynamic memory index";

    /* Values */
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].nof_values, "_dnx_data_intr_ser_table_dynamic_mem table values");
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].values[0].name = "mem";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].values[0].type = "soc_mem_t";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].values[0].doc = "dynamic memory";
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_dynamic_mem_t, mem);
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mdb_mem_map].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_kaps_tcam_scan].labels[0] = "j2x_notrev";
     ...
     * Table - severity_mem
     */
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].name = "severity_mem";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].doc = "severity memory";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].labels[0] = "j2x_notrev";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].size_of_values = sizeof(dnx_data_intr_ser_severity_mem_t);
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].entry_get = dnx_data_intr_ser_severity_mem_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].keys[0].name = "index";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].keys[0].doc = "severity memory index";

    /* Values */
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_ser_table_severity_mem].nof_values, "_dnx_data_intr_ser_table_severity_mem table values");
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[0].name = "mem";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[0].type = "soc_mem_t";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[0].doc = "memory name";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_severity_mem_t, mem);
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[1].name = "severity";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[1].type = "int";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[1].doc = "memory severity";
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[1].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_severity_mem_t, severity);
...
const dnx_data_intr_ser_dynamic_mem_t *
dnx_data_intr_ser_dynamic_mem_get(
    int unit,
    int index)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_dynamic_mem);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_intr_ser_dynamic_mem_t *) data;
...
const dnx_data_intr_ser_severity_mem_t *
dnx_data_intr_ser_severity_mem_get(
    int unit,
    int index)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_severity_mem);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_intr_ser_severity_mem_t *) data;
...
shr_error_e
dnx_data_intr_ser_dynamic_mem_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_ser_dynamic_mem_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_dynamic_mem);
    data = (const dnx_data_intr_ser_dynamic_mem_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->mem);
...
shr_error_e
dnx_data_intr_ser_severity_mem_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_ser_severity_mem_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_severity_mem);
    data = (const dnx_data_intr_ser_severity_mem_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->mem);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->severity);
            break;
    }
...
const dnxc_data_table_info_t *
dnx_data_intr_ser_dynamic_mem_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_dynamic_mem);
...
const dnxc_data_table_info_t *
dnx_data_intr_ser_severity_mem_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_severity_mem);
...
/*{*/
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_intr_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_intr_attach(unit));
    }
    else
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
