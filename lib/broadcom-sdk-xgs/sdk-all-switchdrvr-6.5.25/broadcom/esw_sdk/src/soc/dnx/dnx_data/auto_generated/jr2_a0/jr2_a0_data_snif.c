...
/**
 * \brief device level function which set define snoop_nof_profiles
 * define info:
...
/**
 * \brief device level function which set define prob_nof_bits
 * define info:
...
/**
 * \brief device level function which set define crop_size_granularity
 * define info:
