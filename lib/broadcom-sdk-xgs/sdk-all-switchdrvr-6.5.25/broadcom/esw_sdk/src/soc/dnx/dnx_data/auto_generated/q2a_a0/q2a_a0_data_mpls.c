 ...
 */
static shr_error_e
q2a_a0_dnx_data_mpls_general_mpls_term_1_or_2_labels_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_mpls_general_mpls_ioam_d_flag_stamping_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mpls;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_mpls_general_enc2_implicit_null_w_ahp_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mpls;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_mpls_general_mpls_special_label_encap_handling_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_mpls_general_mpls_second_stage_parser_handling_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mpls;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_mpls_general_gach_with_flow_label_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mpls;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_mpls_general_mpls_special_label_encap_handling_set;
    data_index = dnx_data_mpls_general_define_mpls_second_stage_parser_handling;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mpls_general_mpls_second_stage_parser_handling_set;
    data_index = dnx_data_mpls_general_define_gach_with_flow_label_supported;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mpls_general_gach_with_flow_label_supported_set;
    ...
    feature->set = q2a_a0_dnx_data_mpls_general_mpls_term_1_or_2_labels_set;
    data_index = dnx_data_mpls_general_mpls_ioam_d_flag_stamping;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_mpls_general_mpls_ioam_d_flag_stamping_set;
    data_index = dnx_data_mpls_general_enc2_implicit_null_w_ahp_supported;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_mpls_general_enc2_implicit_null_w_ahp_supported_set;
