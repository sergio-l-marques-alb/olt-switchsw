...
/**
 * \brief device level function which set values for table connectivity_options
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_ilkn_connectivity_options_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_nif_ilkn_table_connectivity_options");
