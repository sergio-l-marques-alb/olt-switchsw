    ...
    dbal_entry_handle_t * entry_handle)
{
    ...
    /*
     * Once we support full entries when half entries are supported,
     * update is_half_entry according to the table, and bring back the code based on is_half_entry.
     */
...
/**
 * \brief
 * This API get the result part of the entry from the HW.
 * The result part is mapped to a single memory in the HW as HL field.
 */
shr_error_e
...
/**
 * \brief
 * This API sets the result part of the entry to the HW.
 * The result part is mapped to a single memory in the HW as HL field.
 */
shr_error_e
