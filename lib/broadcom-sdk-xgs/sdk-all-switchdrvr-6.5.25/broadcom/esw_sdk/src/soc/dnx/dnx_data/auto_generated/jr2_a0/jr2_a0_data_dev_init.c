 ...
 */
/**
 * \brief device level function which set values for table clock_power_down
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dev_init_general_clock_power_down_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dev_init_general_table_clock_power_down");
 ...
 */
/**
 * \brief device level function which set numeric rx_pool_nof_pkts
 * numeric info:
