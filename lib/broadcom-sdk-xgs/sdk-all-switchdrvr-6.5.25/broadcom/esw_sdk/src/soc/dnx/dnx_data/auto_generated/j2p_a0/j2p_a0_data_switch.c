 ...
 */
/**
 * \brief device level function which set define device_enum
 * define info:
...
/**
 * \brief device level function which set numeric svtag_physical_db
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
    ...
    int unit)
{
     ...
     */
    /*
     * Attach submodule: load_balancing_sim
     */
