...
#ifdef BCM_DNX2_SUPPORT
/*{*/
extern shr_error_e j2x_a0_data_qos_attach(
    int unit);
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_qos_feature_seperate_tc_dp].name = "seperate_tc_dp";
    submodule_data->features[dnx_data_qos_feature_seperate_tc_dp].doc = "if tc and dp are seperated in hardware logic";
    submodule_data->features[dnx_data_qos_feature_seperate_tc_dp].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_initial_qos_selection].name = "initial_qos_selection";
    submodule_data->features[dnx_data_qos_feature_initial_qos_selection].doc = "support egress initial qos select";
    submodule_data->features[dnx_data_qos_feature_initial_qos_selection].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_fwd_remark_keep_ecn].name = "fwd_remark_keep_ecn";
    submodule_data->features[dnx_data_qos_feature_fwd_remark_keep_ecn].doc = "keep ECN bit in forwarding layer qos remark";
    submodule_data->features[dnx_data_qos_feature_fwd_remark_keep_ecn].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_ingress_explicit_qos_remark].name = "ingress_explicit_qos_remark";
    submodule_data->features[dnx_data_qos_feature_ingress_explicit_qos_remark].doc = "support INgress eXplicit QoS remarking";
    submodule_data->features[dnx_data_qos_feature_ingress_explicit_qos_remark].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_ingress_ttl_uniform_small].name = "ingress_ttl_uniform_small";
    submodule_data->features[dnx_data_qos_feature_ingress_ttl_uniform_small].doc = "if fwd ttl is small than inheritance, then use fwd ttl";
    submodule_data->features[dnx_data_qos_feature_ingress_ttl_uniform_small].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_bit_map_index].name = "fwd_plus_1_bit_map_index";
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_bit_map_index].doc = "forward plus1 remark use bit map index";
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_bit_map_index].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_remark_mpls].name = "fwd_plus_1_remark_mpls";
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_remark_mpls].doc = "forward plus1 remark support mpls";
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_remark_mpls].flags |= DNXC_DATA_F_FEATURE;
...
/*{*/
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_qos_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_qos_attach(unit));
    }
    else
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
