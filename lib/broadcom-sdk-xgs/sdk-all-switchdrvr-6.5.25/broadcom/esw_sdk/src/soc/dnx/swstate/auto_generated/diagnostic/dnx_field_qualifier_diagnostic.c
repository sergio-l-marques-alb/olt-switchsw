/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_qualifier_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_field_qual_sw_db
...
dnx_field_qual_sw_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_qual_sw_db_predefined_dump(unit, -1, filters));
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_qual_flags_e_get_name(((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->info[i0].flags));
...
/*
 *
 * dump function for the variable predefined
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_field_qual_sw_db_predefined_dump(int  unit,  int  predefined_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_qual_sw_db_predefined_field_id_dump(unit, predefined_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_field_qual_sw_db_predefined_field_id_dump(int  unit,  int  predefined_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = predefined_idx_0, I0 = predefined_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_qualifier predefined field_id") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_qualifier predefined field_id\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_qual_sw_db/predefined/field_id.txt",
            "dnx_field_qual_sw_db[%d]->","((dnx_field_qual_sw_db_t*)sw_state_roots_array[%d][DNX_FIELD_QUALIFIER_MODULE_ID])->","predefined[].field_id: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->predefined
                , sizeof(*((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->predefined), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF)
        {
            LOG_CLI((BSL_META("dnx_field_qual_sw_db[]->((dnx_field_qual_sw_db_t*)sw_state_roots_array[][DNX_FIELD_QUALIFIER_MODULE_ID])->predefined[].field_id: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                unit,
                ((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->predefined[i0].field_id,
                "dnx_field_qual_sw_db[%d]->","((dnx_field_qual_sw_db_t*)sw_state_roots_array[%d][DNX_FIELD_QUALIFIER_MODULE_ID])->","predefined[%s%d].field_id: ", s0, i0);
...
const char* dnx_field_qual_sw_db_layout_str[DNX_FIELD_QUAL_SW_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIELD_QUAL_SW_DB~PREDEFINED~",
    "DNX_FIELD_QUAL_SW_DB~PREDEFINED~FIELD_ID~",
};
