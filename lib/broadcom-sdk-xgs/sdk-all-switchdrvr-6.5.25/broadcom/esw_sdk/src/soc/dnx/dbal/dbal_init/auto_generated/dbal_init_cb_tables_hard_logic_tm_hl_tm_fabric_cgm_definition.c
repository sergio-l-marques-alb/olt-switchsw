/** \file dbal_init_cb_tables_hard_logic_tm_hl_tm_fabric_cgm_definition.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    *offset = dnx_data_fabric.dbal.cgm_llfc_ingress_ipt_ctx_mapping_bits_nof_get(unit)*key_value__fabric_subcontext_id+key_value__fabric_pipe_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_INSTANCE_IDX(unit, current_mapped_field_id, instance_idx);
    *offset = instance_idx%(dnx_data_fabric.links.nof_links_get(unit)/dnx_data_device.general.nof_cores_get(unit))+((instance_idx/24)*dnx_data_fabric.dbal.fdr_links_offset_get(unit));
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__zone;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ZONE, key_value__zone);
    *offset = key_value__zone*(dnx_data_fabric.dbal.adaptive_shaper_threshold_bits_nof_get(unit));
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ZONE, key_value__zone);
    *offset = key_value__zone*(dnx_data_fabric.dbal.adaptive_shaper_factor_bits_nof_get(unit));
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ZONE, key_value__zone);
    *offset = (key_value__zone-1)*(2*dnx_data_fabric.dbal.adaptive_shaper_factor_bits_nof_get(unit));
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ZONE, key_value__zone);
    *offset = key_value__zone*(2*dnx_data_fabric.dbal.adaptive_shaper_factor_bits_nof_get(unit));
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
