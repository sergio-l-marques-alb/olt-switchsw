...
/**
 * \brief device level function which set define oam_nof_counter_interfaces
 * define info:
...
/**
 * \brief device level function which set define oam_sub_type_v2
 * define info:
...
/**
 * \brief device level function which set define oam_nof_server_device_profile
 * define info:
...
/**
 * \brief device level function which set define oam_app_id_init
 * define info:
...
/**
 * \brief device level function which set define protection_packet_max_header_size
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define protection_packet_max_len_size
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define max_number_of_events
 * define info:
...
/**
 * \brief device level function which set define nof_generic_memory_entries
 * define info:
...
/**
 * \brief device level function which set numeric oamp_fifo_dma_event_thread_priority
 * numeric info:
...
/**
 * \brief device level function which set numeric lm_dm_per_priority_enable
 * numeric info:
