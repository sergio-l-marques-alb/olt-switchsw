/** \file dbal_init_tables_sw_state_pp_l3_sw_pp_l3_ecmp_vip.c
 * Logical DB enums \n 
...
shr_error_e
_dbal_init_tables_sw_state_pp_l3_sw_pp_l3_ecmp_vip_ecmp_vip_config_sw_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_ECMP_VIP_CONFIG_SW;
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECMP_VIP_CONFIG_SW, is_valid, "ECMP_VIP_CONFIG_SW", DBAL_ACCESS_METHOD_SW_STATE));
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_ECMP_VIP_CONFIG_SW, is_standard_1, is_compatible_with_all_images));
    }
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_ECMP_VIP_CONFIG_SW, table_info));
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
dbal_init_tables_sw_state_pp_l3_sw_pp_l3_ecmp_vip_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(_dbal_init_tables_sw_state_pp_l3_sw_pp_l3_ecmp_vip_ecmp_vip_config_sw_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
