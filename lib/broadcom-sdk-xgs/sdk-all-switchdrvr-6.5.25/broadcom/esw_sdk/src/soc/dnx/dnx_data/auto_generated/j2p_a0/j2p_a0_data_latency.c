 ...
 */
static shr_error_e
j2p_a0_dnx_data_latency_features_probabilistic_legacy_mechanism_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_latency_features_egress_ecn_probabilistic_mechanism_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_latency_features_ingress_ecn_probabilistic_mechanism_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_latency_features_drop_probabilistic_mechanism_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
 ...
 */
static shr_error_e
j2p_a0_dnx_data_latency_features_coupled_mode_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
 ...
 */
/**
 * \brief device level function which set define reject_flow_profile_value
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define cgm_extended_profiles_enable_value
 * define info:
...
/**
 * \brief device level function which set define max_supported_profile
 * define info:
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_latency_features_probabilistic_legacy_mechanism_support_set;
    data_index = dnx_data_latency_features_egress_ecn_probabilistic_mechanism_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_latency_features_egress_ecn_probabilistic_mechanism_support_set;
    data_index = dnx_data_latency_features_ingress_ecn_probabilistic_mechanism_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_latency_features_ingress_ecn_probabilistic_mechanism_support_set;
    data_index = dnx_data_latency_features_drop_probabilistic_mechanism_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_latency_features_drop_probabilistic_mechanism_support_set;
    data_index = dnx_data_latency_features_coupled_mode_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_latency_features_coupled_mode_support_set;
     ...
     */
    /*
     * Attach submodule: based_admission
     */
