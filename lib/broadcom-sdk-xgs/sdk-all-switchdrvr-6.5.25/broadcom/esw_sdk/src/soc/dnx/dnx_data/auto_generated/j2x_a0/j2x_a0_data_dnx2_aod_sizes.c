/** \file j2x_a0_data_dnx2_aod_sizes.c
 * 
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dnx2_aod_sizes_AOD_ETPP_TRAP_CONTEXT_PORT_PROFILE_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dnx2_aod_sizes_AOD_TDM_TRAP_CANDIDATE_HEADER_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dnx2_aod_sizes;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_dnx2_aod_sizes_AOD_TDM_TRAP_CANDIDATE_HEADER___PP_DSP_AG_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dnx2_aod_sizes;
 ...
 */
shr_error_e
j2x_a0_data_dnx2_aod_sizes_attach(
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_dnx2_aod_sizes_AOD_ETPP_TRAP_CONTEXT_PORT_PROFILE_set;
    data_index = dnx_data_dnx2_aod_sizes_AOD_define_TDM_TRAP_CANDIDATE_HEADER;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_dnx2_aod_sizes_AOD_TDM_TRAP_CANDIDATE_HEADER_set;
    data_index = dnx_data_dnx2_aod_sizes_AOD_define_TDM_TRAP_CANDIDATE_HEADER___PP_DSP_AG;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_dnx2_aod_sizes_AOD_TDM_TRAP_CANDIDATE_HEADER___PP_DSP_AG_set;
