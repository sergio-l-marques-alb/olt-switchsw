 ...
 */
static shr_error_e
j2p_a2_dnx_data_snif_egress_egress_mirror_mode_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int feature_index = dnx_data_snif_egress_egress_mirror_mode;
    ...
    int unit)
{
     ...
     * Attach features: 
     */
    data_index = dnx_data_snif_egress_egress_mirror_mode;
    feature = &submodule->features[data_index];
    feature->set = j2p_a2_dnx_data_snif_egress_egress_mirror_mode_set;
