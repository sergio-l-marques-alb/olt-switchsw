 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_advanced_ipt_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_profile_size_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_metadata_bitmap_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_metadata_edit_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_node_id_padding_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_telemetry_queue_occ_check_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_telemetry_queue_occ_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_profile_info_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ipt_metadata_set(
    int unit)
{
    int flag_id_index;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_ifa_max_lenght_check_for_ifa2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_eventor_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
 ...
 */
/**
 * \brief device level function which set define is_rx_en
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_eventor_is_rx_en_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_eventor;
    int define_index = dnx_data_instru_eventor_define_is_rx_en;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
/**
 * \brief device level function which set define synced_trigger_version
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_synced_triggers_synced_trigger_version_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_triggers;
    int define_index = dnx_data_instru_synced_triggers_define_synced_trigger_version;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
/**
 * \brief device level function which set define period_adjusted_to_ns_through_time_ratio
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_period_adjusted_to_ns_through_time_ratio_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_period_adjusted_to_ns_through_time_ratio;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_interval_period_size_hw_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
/**
 * \brief device level function which set define cgm_max_nof_intervals
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_cgm_max_nof_intervals_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_cgm_max_nof_intervals;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define nif_max_nof_intervals
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_nif_max_nof_intervals_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_nif_max_nof_intervals;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
/**
 * \brief device level function which set values for table counters_info
 ...
 */
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_counters_info_set(
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_instru_synced_counters_counters_info_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_instru_synced_counters_table_counters_info");
    ...
    if (21 < table->keys[0].size && bcmInstruSyncedCountersTypeIcgm < table->keys[1].size)
    {
        data = (dnx_data_instru_synced_counters_counters_info_t *) dnxc_data_mgmt_table_data_get(unit, table, 21, bcmInstruSyncedCountersTypeIcgm);
        data->valid = TRUE;
        data->bcm_counter_type = bcmInstruSyncedCountersIcgmTypeDramEnqueuePackets;
        data->dbal_field = DBAL_FIELD_SYNCED_COUNTERS_DRAM_ENQUEUE_PACKETS;
    }
    if (22 < table->keys[0].size && bcmInstruSyncedCountersTypeIcgm < table->keys[1].size)
    {
        data = (dnx_data_instru_synced_counters_counters_info_t *) dnxc_data_mgmt_table_data_get(unit, table, 22, bcmInstruSyncedCountersTypeIcgm);
        data->valid = TRUE;
        data->bcm_counter_type = bcmInstruSyncedCountersIcgmTypeDramEnqueueBytes;
        data->dbal_field = DBAL_FIELD_SYNCED_COUNTERS_DRAM_ENQUEUE_BYTES;
    }
    if (23 < table->keys[0].size && bcmInstruSyncedCountersTypeIcgm < table->keys[1].size)
    {
        data = (dnx_data_instru_synced_counters_counters_info_t *) dnxc_data_mgmt_table_data_get(unit, table, 23, bcmInstruSyncedCountersTypeIcgm);
        data->valid = TRUE;
        data->bcm_counter_type = bcmInstruSyncedCountersIcgmTypeDramDequeuePackets;
        data->dbal_field = DBAL_FIELD_SYNCED_COUNTERS_DRAM_DEQUEUE_PACKETS;
    }
    if (24 < table->keys[0].size && bcmInstruSyncedCountersTypeIcgm < table->keys[1].size)
    {
        data = (dnx_data_instru_synced_counters_counters_info_t *) dnxc_data_mgmt_table_data_get(unit, table, 24, bcmInstruSyncedCountersTypeIcgm);
        data->valid = TRUE;
        data->bcm_counter_type = bcmInstruSyncedCountersIcgmTypeDramDequeueBytes;
        data->dbal_field = DBAL_FIELD_SYNCED_COUNTERS_DRAM_DEQUEUE_BYTES;
    }
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_instru_ipt_profile_size_set;
    data_index = dnx_data_instru_ipt_define_metadata_bitmap_size;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ipt_metadata_bitmap_size_set;
    data_index = dnx_data_instru_ipt_define_metadata_edit_size;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ipt_metadata_edit_size_set;
    data_index = dnx_data_instru_ipt_define_node_id_padding_size;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ipt_node_id_padding_size_set;
    data_index = dnx_data_instru_ipt_define_telemetry_queue_occ_check;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ipt_telemetry_queue_occ_check_set;
    data_index = dnx_data_instru_ipt_define_telemetry_queue_occ_max;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ipt_telemetry_queue_occ_max_set;
    ...
    feature->set = j2x_a0_dnx_data_instru_ipt_advanced_ipt_set;
    ...
    table->set = j2x_a0_dnx_data_instru_ipt_profile_info_set;
    data_index = dnx_data_instru_ipt_table_metadata;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_instru_ipt_metadata_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ifa_max_lenght_check_for_ifa2_set;
     ...
     * Attach defines: 
     */
    data_index = dnx_data_instru_eventor_define_is_rx_en;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_eventor_is_rx_en_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_instru_eventor_is_supported_set;

    /*
     * Attach tables: 
     */
    /*
     * Attach submodule: synced_triggers
     */
    submodule_index = dnx_data_instru_submodule_synced_triggers;
    submodule = &module->submodules[submodule_index];

    /*
     * Attach defines: 
     */
    data_index = dnx_data_instru_synced_triggers_define_synced_trigger_version;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_triggers_synced_trigger_version_set;
     ...
     * Attach defines: 
     */
    data_index = dnx_data_instru_synced_counters_define_period_adjusted_to_ns_through_time_ratio;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_period_adjusted_to_ns_through_time_ratio_set;
    data_index = dnx_data_instru_synced_counters_define_interval_period_size_hw;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_interval_period_size_hw_set;
    data_index = dnx_data_instru_synced_counters_define_cgm_max_nof_intervals;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_cgm_max_nof_intervals_set;
    data_index = dnx_data_instru_synced_counters_define_nif_max_nof_intervals;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_nif_max_nof_intervals_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_instru_synced_counters_counters_info_set;
