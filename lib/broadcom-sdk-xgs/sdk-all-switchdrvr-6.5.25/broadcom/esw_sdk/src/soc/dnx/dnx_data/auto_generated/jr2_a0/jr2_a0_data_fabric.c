 ...
 */
/**
 * \brief device level function which map key to table indexdefault_fec
...
/**
 * \brief device level function which maps table index to key default_fec
 * Module - 'fabric', Submodule - 'links', table - 'default_fec'
 * Mapping indices to keys - relevant in table map mode
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set values for table default_fec
 * Module - 'fabric', Submodule - 'links', table - 'default_fec'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_links_default_fec_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_fabric_links_table_default_fec");
...
/**
 * \brief device level function which set values for table supported_fec_controls
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_links_supported_fec_controls_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_fabric_links_table_supported_fec_controls");
...
/**
 * \brief device level function which set define max_vsc_format_size
 * define info:
 ...
 */
/**
 * \brief device level function which set values for table supported_pcp_modes
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_cell_supported_pcp_modes_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_fabric_cell_table_supported_pcp_modes");
...
/**
 * \brief device level function which set define max_nof_dtqs
 * define info:
 * Max number of DTQs
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define cgm_egress_dynamic_wfq_th_bits_nof
 * define info:
...
/**
 * \brief device level function which set define fdr_links_offset
 * define info:
...
/**
 * \brief device level function which set values for table dtq_to_pdq_fc_mapping
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_fabric_transmit_table_dtq_to_pdq_fc_mapping");
 ...
 */
/**
 * \brief device level function which set define minimum_system_ref_clk
 * define info:
...
/**
 * \brief device level function which set define soft_reset_with_fabric_max_exec_time
 * define info:
