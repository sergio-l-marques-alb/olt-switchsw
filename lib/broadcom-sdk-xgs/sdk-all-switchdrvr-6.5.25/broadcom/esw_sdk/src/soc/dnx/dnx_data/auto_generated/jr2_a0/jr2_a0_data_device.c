...
/**
 * \brief device level function which set define max_nof_layer_protocols
 * define info:
...
/**
 * \brief device level function which set numeric max_mpps
 * numeric info:
...
/**
 * \brief device level function which set values for table ctest_full_file_indentifier
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_device_general_ctest_full_file_indentifier_t, (1 + 1 /* to store default value */ ), "data of dnx_data_device_general_table_ctest_full_file_indentifier");
