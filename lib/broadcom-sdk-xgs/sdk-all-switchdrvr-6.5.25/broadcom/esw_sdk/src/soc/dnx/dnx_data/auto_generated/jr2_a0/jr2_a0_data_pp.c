 ...
 */
/**
 * \brief device level function which set define is_vtt5_supported
 * define info:
...
/**
 * \brief device level function which set numeric ingress_packet_header_size
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
 ...
 */
/**
 * \brief device level function which set values for table from_signal_str
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_pp_debug_from_signal_str_t, (1 + 1 /* to store default value */ ), "data of dnx_data_pp_debug_table_from_signal_str");
