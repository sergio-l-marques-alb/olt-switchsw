    ...
    int unit)
{
     ...
     * Set key sizes
     */
    table->keys[0].size = 347;
    table->info_get.key_size[0] = 347;
...
/**
 * \brief device level function which set values for table skip_clear_on_regress
 * Module - 'intr', Submodule - 'general', table - 'skip_clear_on_regress'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_intr_general_skip_clear_on_regress_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_intr_general_table_skip_clear_on_regress");
...
/**
 * \brief device level function which set values for table dynamic_mem
 * Module - 'intr', Submodule - 'ser', table - 'dynamic_mem'
 * dynamic memory
 * The function set relevant table structure in _dnx_data
 * 
 * \param [in] unit - Unit #
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_intr_ser_dynamic_mem_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_intr_ser_table_dynamic_mem");
