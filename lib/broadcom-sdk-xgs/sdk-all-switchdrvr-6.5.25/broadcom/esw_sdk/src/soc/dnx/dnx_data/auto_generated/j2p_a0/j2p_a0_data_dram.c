...
/**
 * \brief device level function which set numeric driver_strength
 * numeric info:
...
/**
 * \brief device level function which set numeric t_rdlat_offset
 * numeric info:
...
/**
 * \brief device level function which set define wds_size
 * define info:
...
/**
 * \brief device level function which set numeric read_data_enable_delay
 * numeric info:
...
/**
 * \brief device level function which set numeric read_data_enable_length
 * numeric info:
...
/**
 * \brief device level function which set numeric supported_dram_bitmap
 * numeric info:
...
/**
 * \brief device level function which set numeric dram_bitmap_internal
 * numeric info:
...
/**
 * \brief device level function which set values for table write_leaky_bucket_increment_th
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_dram_block_write_leaky_bucket_increment_th_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_dram_block_table_write_leaky_bucket_increment_th");
...
/**
 * \brief device level function which set define hbm_write_latency_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_rd_data_en_delay_nof_bits
 * define info:
 ...
 */
/**
 * \brief device level function which set define nof_hbm_spare_data_results
 * define info:
...
/**
 * \brief device level function which set define sbus_clock_divider
 * define info:
...
/**
 * \brief device level function which set define snap_state_init_done
 * define info:
 ...
 */
/**
 * \brief device level function which set values for table rom
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_firmware_rom_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_firmware_table_rom");
...
/**
 * \brief device level function which set values for table operation_status
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_firmware_operation_status_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dram_firmware_table_operation_status");
...
/**
 * \brief device level function which set values for table operation_result_error_code
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_firmware_operation_result_error_code_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_firmware_table_operation_result_error_code");
...
/**
 * \brief device level function which set values for table operation_result_last_operation
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_firmware_operation_result_last_operation_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_firmware_table_operation_result_last_operation");
 ...
 */
/**
 * \brief device level function which set values for table pll
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_apd_phy_pll_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dram_apd_phy_table_pll");
