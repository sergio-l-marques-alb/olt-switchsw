 ...
 *
 * Purpose:    Implement CallBacks function for J2P interrupts.
 */
    ...
    char *special_msg)
{
    ...
    switch (en_interrupt)
    {
        ...
        case J2P_INT_MSS_MACSEC_MACSEC_INTERRUPT_REGISTER:
            sal_snprintf(special_msg, DNXC_INTERRUPT_SPECIAL_MSG_SIZE - 1, "%s", msg);
            action = DNXC_INT_CORR_ACT_MSS_MACSEC_SA_EXPIRY;
            break;
        case J2P_INT_MSD_MACSEC_MACSEC_INTERRUPT_REGISTER:
            sal_snprintf(special_msg, DNXC_INTERRUPT_SPECIAL_MSG_SIZE - 1, "%s", msg);
            action = DNXC_INT_CORR_ACT_MSD_MACSEC_SA_EXPIRY;
            break;
        case J2P_INT_EPNI_ETPP_TOTAL_INC_ABOVE_TH_WITH_EBD_INT:
            sal_snprintf(special_msg, DNXC_INTERRUPT_SPECIAL_MSG_SIZE - 1, "%s", msg);
            action = DNXC_INT_CORR_ACT_EPNI_TOTAL_INC_ABOVE_TH_WITH_EBD;
            break;
        case J2P_INT_EPNI_ETPP_EBD_ERR_INT:
            sal_snprintf(special_msg, DNXC_INTERRUPT_SPECIAL_MSG_SIZE - 1, "%s", msg);
            action = DNXC_INT_CORR_ACT_EPNI_EBD_ERR_INT;
            break;
        case J2P_INT_ILE_ILKN_RX_PORT_0_STATUS_CHANGE_INT:
        case J2P_INT_ILE_ILKN_RX_PORT_1_STATUS_CHANGE_INT:
            action = DNXC_INT_CORR_ACT_ILKN_RX_PORT_STATUS_CHANGE;
            break;
        case J2P_INT_EPNI_ETPP_INC_ABOVE_TH_INT:
        case J2P_INT_EPNI_ETPP_TOTAL_INC_ABOVE_TH_INT:
        case J2P_INT_EPNI_ETPP_TOTAL_DEC_ABOVE_TH_INT:
        case J2P_INT_EPNI_ETPP_TAIL_ABOVE_INC_INT:
        case J2P_INT_EPNI_ETPP_PKT_INC_ABOVE_MAX_PKT_SIZE_INT:
        case J2P_INT_EPNI_ETPP_TOTAL_DEC_ABOVE_PKT_SIZE_INT:
        case J2P_INT_EPNI_ALIGNER_TRANSMIT_SIZE_ABOVE_TH_INT:
            sal_snprintf(special_msg, DNXC_INTERRUPT_SPECIAL_MSG_SIZE - 1, "%s", msg);
    ...
    char *msg)
{
     ...
     * print info
     */
    rc = dnxc_interrupt_print_info(unit, block_instance, en_jer_interrupt, 1, DNXC_INT_CORR_ACT_NONE, NULL);
    SHR_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /** CDB has the same logic for ETHU IDs as CDU */
    switch (en_interrupt)
    {
        case J2P_INT_CDB_PFC_DEADLOCK_BREAKING_MECHANISM_INT:
            is_cdu = TRUE;
...
STATIC int
j2p_ilkn_link_status_change_handling(
    int unit,
    int block_instance,
    uint32 en_interrupt,
    char *msg)
...
STATIC int
j2p_egress_edit_adelta_edelta_int_handle(
    int unit,
    int block_instance,
    uint32 en_interrupt,
    char *msg)
...
static int
j2p_intr_clear_MactLelaFidExceedLimit(
    int unit,
    int block_instance,
    int en_interrupt)
{
...
static int
j2p_intr_clear_MactLelbFidExceedLimit(
    int unit,
    int block_instance,
    int en_interrupt)
{
...
static int
j2p_intr_clear_MactMngmntReqFidExceedLimitAllowed(
    int unit,
    int block_instance,
    int en_interrupt)
{
    ...
    char *msg)
{
    ...
    switch (en_interrupt)
    {
        case J2P_INT_KAPS_TECC_A_0_1B_ERROR:
            is_ecc_2bits = 0;
            is_rpb_a = 1;
            index = 0;
            break;
        case J2P_INT_KAPS_TECC_A_0_2B_ERROR:
            is_ecc_2bits = 1;
            is_rpb_a = 1;
            index = 0;
            break;
        case J2P_INT_KAPS_TECC_B_0_1B_ERROR:
            is_ecc_2bits = 0;
            is_rpb_a = 0;
            index = 0;
            break;
        case J2P_INT_KAPS_TECC_B_0_2B_ERROR:
            is_ecc_2bits = 1;
            is_rpb_a = 0;
            index = 0;
            break;
        case J2P_INT_KAPS_TECC_A_1_1B_ERROR:
            is_ecc_2bits = 0;
            is_rpb_a = 1;
            index = 1;
            break;
        case J2P_INT_KAPS_TECC_A_1_2B_ERROR:
            is_ecc_2bits = 1;
            is_rpb_a = 1;
            index = 1;
            break;
        case J2P_INT_KAPS_TECC_B_1_1B_ERROR:
            is_ecc_2bits = 0;
            is_rpb_a = 0;
            index = 1;
            break;
        case J2P_INT_KAPS_TECC_B_1_2B_ERROR:
            is_ecc_2bits = 1;
            is_rpb_a = 0;
            index = 1;
            break;
...
static int
j2p_intr_clear_MactMngmntReqFidExceedLimit(
    int unit,
    int block_instance,
    int en_interrupt)
{
    ...
    int unit)
{
     ...
     */
    dnxc_intr_add_handler_ext(unit, J2P_INT_BDM_FPC_0_FREE_ERROR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_BDM_FPC_1_FREE_ERROR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_BDM_FPC_2_FREE_ERROR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_BDM_FPC_3_FREE_ERROR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_DRAM_BOUND_RECOVERY_STATUS_ERR_INT, 0, 0, j2p_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VOQ_STATE_INTERNAL_CACHE_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_WORDS_GRNTD_OC_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_WORDS_SHRD_OC_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_SRAM_BUFFERS_GRNTD_OC_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_SRAM_BUFFERS_SHRD_OC_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_SRAM_WORDS_GRNTD_OC_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_SRAM_WORDS_SHRD_OC_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_SRAM_PDS_GRNTD_OC_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_VOQ_OC_ERR_VOQ_SRAM_PDS_SHRD_OC_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_PB_VSQ_OC_ERR_PB_VSQ_WORDS_SHRD_POOL_1_OC_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_PB_VSQ_OC_ERR_PB_VSQ_WORDS_HDRM_OC_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_PB_VSQ_OC_ERR_PB_VSQ_SRAM_BUFFERS_HDRM_EXT_POOL_0_OC_ERR_INT, 0,
                              0, j2p_soft_reset, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_TOTAL_PB_VSQ_OC_ERR_PB_VSQ_SRAM_PDS_HDRM_EXT_POOL_1_OC_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VOQ_CTR_ERR_VOQ_CTR_ERR_WORDS_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VOQ_CTR_ERR_VOQ_CTR_ERR_SRAM_WORDS_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VOQ_CTR_ERR_VOQ_CTR_ERR_SRAM_BUFFERS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VOQ_CTR_ERR_VOQ_CTR_ERR_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQA_WORDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQA_SRAM_BUFFERS_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQA_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQB_WORDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQB_SRAM_BUFFERS_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQB_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQC_WORDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQC_SRAM_BUFFERS_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQC_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQD_WORDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQD_SRAM_BUFFERS_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_QB_VSQ_CTR_ERR_VSQD_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_PB_VSQ_CTR_ERR_VSQE_WORDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_PB_VSQ_CTR_ERR_VSQE_SRAM_BUFFERS_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_PB_VSQ_CTR_ERR_VSQE_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_PB_VSQ_CTR_ERR_VSQF_WORDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_PB_VSQ_CTR_ERR_VSQF_SRAM_BUFFERS_ERR_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_VSQ_CTR_ERR_PB_VSQ_CTR_ERR_VSQF_SRAM_PDS_ERR_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_LOW_PRIORITY_PB_VSQ_WORDS_POOL_1_FC_LP_INT, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_DEQ_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_DEQ_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_DEQ_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_DEQ_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_2_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_2_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_3_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_3_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_4_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_4_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_5_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_ENQ_FIFO_5_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_2_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_2_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_3_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_3_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_4_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_4_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_5_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_5_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_6_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_6_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_7_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_7_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_8_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_8_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_9_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_TAR_FIFO_9_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_DCTR_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_CGM_FIFO_ERR_DCTR_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_EXT_MEM_ERR_PKUP_LAST_BUFF_CRC_ERR_INT, 0, 0, j2p_none, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_RX_CFIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_RX_CFIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKP_OUT_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BEC_PTR_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BEC_PTR_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BEC_WAIT_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BEC_WAIT_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BDBC_RESULT_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BDBC_RESULT_FIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BDBC_SUB_REQ_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BDBC_SUB_REQ_FIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BEC_ENQ_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_BEC_ENQ_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_DBDF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_DBDF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKP_RX_CFIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKP_RX_CFIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKP_RX_DFIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKP_RX_DFIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_WCF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_WCF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_BDBC_PEND_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_BDBC_PEND_FIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_END_OF_BUFFER_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_END_OF_BUFFER_FIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_QUARANTINE_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_QUARANTINE_FIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_RX_DFIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_RX_DFIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_RX_METADATA_FIF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_FIFO_PKUP_RX_METADATA_FIF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_ERR_NEGATIVE_DELTA, 0, 0, j2p_special_handling, j2p_none,
                              "Error is due to wrong configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_FIFO_BYPASS_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_FIFO_BYPASS_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_FIFO_WDF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_FIFO_WDF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_FIFO_WDF_CPYDAT_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_ITE_FIFO_WDF_CPYDAT_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_BDBC_TX_FIF_OVF, 0, 0, j2p_soft_reset, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DDP_BDBC_RX_SUB_REQ_FIF_OVF, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_HEAD_UPDT_IN_LAST_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_HEAD_UPDT_IN_EMPTY_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_DEQ_CMD_TO_EMPTY_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_ALLOCATED_BDM_BDB_RANGE_ERR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_ALLOCATED_WHEN_BDB_FIFO_EMPTY_ERR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_TX_FIFO_ERR_TX_BD_FIFO_OVF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_TX_FIFO_ERR_TX_BD_FIFO_UNF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_TX_FIFO_ERR_TX_BB_FIFO_OVF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_TX_FIFO_ERR_TX_BB_FIFO_UNF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_ENQ_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_ENQ_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_2_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_2_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_3_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_3_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_4_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_4_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_5_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_5_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_6_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_6_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_7_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_7_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_8_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_DEQ_FIFO_8_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_BDM_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_BDM_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_BDM_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_DQM_FIFO_ERR_BDM_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_CORE_PLL_LOSS_REFCLK, 0, 0, j2p_hard_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_FAB_LOCKED_LOST, 0, 0, j2p_hard_reset, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_FAB_LOSS_REFCLK, 0, 0, j2p_hard_reset, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_MISC_PLL_1_LOCKED_LOST, 0, 0, j2p_hard_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_MISC_PLL_1_LOSS_REFCLK, 0, 0, j2p_hard_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_NIF_LOCKED_LOST, 0, 0, j2p_hard_reset, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_NIF_LOSS_REFCLK, 0, 0, j2p_hard_reset, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_MISC_PLL_3_LOCKED_LOST, 0, 0, j2p_hard_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ECI_MISC_PLL_3_LOSS_REFCLK, 0, 0, j2p_hard_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_EPNI_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_EPRE_LMM_OVF_INT, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_EPRE_HPM_OVF_INT, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_EPRE_RCYM_OVF_INT, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_ERPP_ERPP_DISCARD_2_DISCARD_INT, 0, 0, j2p_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ESB_EMPTY_BUFF_ALLOC_INT, 0, 0, j2p_special_handling, j2p_soft_init,
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_PORT_MTU_TRAP_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_STP_TRAP_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_MEMBERSHIP_TRAP_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_TRAP_ORIGINAL_FTMH_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_TRAP_BYPASS_FIFO_ALMOST_FULL_INT, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_ENCAPSULATION_2_DATA_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_ENCAPSULATION_3_DATA_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_ENCAPSULATION_4_DATA_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPB_ETPPB_ENCAPSULATION_5_DATA_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPPC_BIER_BIT_MASK_FIFO_ALMOST_FULL_INT, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPPC_BIER_BIT_MASK_FIFO_FULL_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPPC_ENCAPSULATION_1_DATA_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_TERM_PIPE_FIFO_1_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_VSD_RESULT_FIFO_ALMOST_FULL_INT, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_ESEM_1_RESULT_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_ESEM_2_RESULT_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_EXEM_RESULT_FIFO_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_OEM_RESULT_FIFO_ALMOST_FULL_INT, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_TERM_PIPE_FIFO_2_ALMOST_FULL_INT, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_CRPS_RESULT_FIFO_FULL_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_MRPS_RESULT_FIFO_FULL_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_TERM_SPLIT_HORIZON_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_PROTECTION_TRAP_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_LATENCY_TRAP_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_ACTION_TRAP_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ETPPC_ETPP_TERM_PORT_RATE_INT, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_INVALID_DESTINATION_VALID, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_NIF_PHYSICAL_ERR_0, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_SEQ_RX_BIGER_SEQ_EXP_AND_SMALLER_SEQ_TX_0, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_SEQ_RX_SMALLER_SEQ_EXP_OR_BIGGER_EQ_SEQ_TX_0, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_FLP_FIFO_FULL_0, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_FLP_LOOKUP_TIMEOUT_0, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_NIF_RX_FIFO_OVF_0, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_LOOKUP_REPLY_OVF_0, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_BAD_CHANNEL_NUM_0, 0, 0, j2p_special_handling, NULL,
                              "check if SER on memories, either Jericho/OP2, or link. If so, action");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_INFO_REPLY_OVF_0, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_BAD_LKP_TYPE_0, 0, 0, j2p_reprogram_resource, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_NIF_TX_FIFO_FULL_0, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_RX_BROKEN_RECORD_0, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_INFO_REPLY_VALID_0, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_INFO_REPLY_ERR_0, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_LOOKUP_REPLY_VALID_0, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_LOOKUP_REPLY_ERR_0, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_NIF_PHYSICAL_ERR_1, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_SEQ_RX_BIGER_SEQ_EXP_AND_SMALLER_SEQ_TX_1, 0, 0, j2p_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_SEQ_RX_SMALLER_SEQ_EXP_OR_BIGGER_EQ_SEQ_TX_1, 0, 0,
                              j2p_special_handling, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_FLP_FIFO_FULL_1, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_FLP_LOOKUP_TIMEOUT_1, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_NIF_RX_FIFO_OVF_1, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_LOOKUP_REPLY_OVF_1, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_BAD_CHANNEL_NUM_1, 0, 0, j2p_special_handling, NULL,
                              "check if SER on memories, either Jericho/OP2, or link. If so, action");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_INFO_REPLY_OVF_1, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_BAD_LKP_TYPE_1, 0, 0, j2p_reprogram_resource, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_NIF_TX_FIFO_FULL_1, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_RX_BROKEN_RECORD_1, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_INFO_REPLY_VALID_1, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_INFO_REPLY_ERR_1, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_LOOKUP_REPLY_VALID_1, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPD_CPU_LOOKUP_REPLY_ERR_1, 0, 0, j2p_special_handling, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPPF_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_SQM_DQCQ_ERR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_DQM_DQCQ_ERR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_CRDT_FLOW_ID_ERR_INT, 0, 0, j2p_reprogram_resource, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_QDESC_0_INTERNAL_CACHE_ERROR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_QDESC_1_INTERNAL_CACHE_ERROR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_SQM_DQCQ_INTERNAL_CACHE_ERROR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_ACTIVE_QUEUE_COUNT_ERR_ACTIVE_QUEUE_COUNT_OVF_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_ACTIVE_QUEUE_COUNT_ERR_ACTIVE_QUEUE_COUNT_UNF_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_ACTIVE_QUEUE_COUNT_ERR_DQM_ACTIVE_QUEUE_COUNT_D_UNF_INT, 0, 0,
                              j2p_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_CRDT_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_CRDT_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_CRDT_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_CRDT_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_FMS_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_FMS_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_FSMRQ_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPS_FIFO_ERR_FSMRQ_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RRF_OVERSIZE, 0, 0, j2p_none, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_CRDT_OVERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_CRDT_OVERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_CRDT_OVERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERSIZE, 0, 0, j2p_none, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_DQCF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_DQCF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_DQCF_OVERSIZE, 0, 0, j2p_none, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_D_BLF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_D_BLF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_PBF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_PBF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_PBF_OVERSIZE, 0, 0, j2p_none, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_DQCF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_DQCF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_DQCF_OVERSIZE, 0, 0, j2p_none, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_D_BLF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_D_BLF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_D_BLF_MISCONFIG, 0, 0, j2p_none, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_PBF_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_PBF_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_ERROR_S_2D_PBF_OVERSIZE, 0, 0, j2p_special_handling, j2p_none,
                              "Configuration error");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_COMP_CNT_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_COMP_CNT_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_SCS_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_OVERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_OVERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_OVERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_OVERFLOW_3, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_UNDERFLOW_0, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_UNDERFLOW_1, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_UNDERFLOW_2, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_EOB_FIFO_UNDERFLOW_3, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_DRAM_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_FIFO_RDF_DRAM_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IPT_ITE_FIFO_WDF_CPYDAT_UNDERFLOW, 0, 0, j2p_none, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_PDQ_SEQ_NUM_INTERNAL_CACHE_ERROR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_QM_RPRT_FIFO_OVF, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_BTX_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_BTX_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_BTX_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_BTX_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_QMRP_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_QMRP_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_QSTATE_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_IQM_FIFO_ERR_QSTATE_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_ERROR_LEARN_REQUEST_OVER_STRONGER, 0, 0, j2p_none,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_WARNING_LEARN_OVER_EXISTING, 0, 0, j2p_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_ERROR_DELETE_NON_EXIST, 0, 0, j2p_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_ERROR_TRANSPLANT_REQUEST_OVER_STRONGER, 0, 0,
                              j2p_none, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_ERROR_REFRESH_REQUEST_OVER_STRONGER, 0, 0, j2p_none,
                              NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCB_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_ERROR_FREE_INT, 0, 0, j2p_soft_reset, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_ERROR_FBM_0_BUFF_STAT_OVF_INT, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_ERROR_FBM_1_BUFF_STAT_OVF_INT, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_ERROR_OCBM_BUFF_STAT_OVF_INT, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_FBC_BANK_ERROR_FBC_BANK_31, 0, 0, j2p_special_handling, j2p_none,
                              "Ingress soft init");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_RSUT_WR_RXI_CTRL_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_RSUT_WR_RXI_CTRL_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_0_RD_2D_FREE_FIFO_OVERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_0_RD_2D_FREE_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_0_DEL_FREE_FIFO_OVERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_0_DEL_FREE_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_1_RD_2D_FREE_FIFO_OVERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_1_RD_2D_FREE_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_1_DEL_FREE_FIFO_OVERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_FBM_RING_1_DEL_FREE_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_OCBM_OCBM_FIFO_RRM_RING_0_S_2F_RD_REQ_ADDR_FIFO_OVERFLOW, 0, 0,
                              j2p_soft_reset, j2p_none, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_OLP_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_PDM_FREE_ERROR, 0, 0, j2p_soft_reset, NULL, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_REASSEMBLY_REASSEMBLY_ERROR_PACKET_REJECT, 0, 0, j2p_none, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_OVERFLOW_0, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_OVERFLOW_1, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_OVERFLOW_2, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_UNDERFLOW_0, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_UNDERFLOW_1, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_UNDERFLOW_2, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_OVERFLOW_0, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_OVERFLOW_1, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_UNDERFLOW_0, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_UNDERFLOW_1, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_PSF_CTRL_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_PSF_CTRL_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_PSF_DATA_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_PSF_DATA_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_WBR_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_WBR_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2_F_TCF_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2_F_TCF_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2_D_TCF_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_S_2_D_TCF_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_F_REL_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_F_REL_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_F_FREE_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_F_FREE_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_D_REL_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_D_REL_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_D_FREE_FIFO_OVERFLOW, 0, 0, j2p_soft_reset, j2p_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SPB_FIFO_ERROR_BRC_S_2_D_FREE_FIFO_UNDERFLOW, 0, 0, j2p_soft_reset,
                              j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_HEAD_UPDT_IN_LAST_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_HEAD_UPDT_IN_EMPTY_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_DEQ_CMD_TO_EMPTY_ERR_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_QDM_INTERNAL_CACHE_ERROR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_ALLOCATED_PDM_PDB_RANGE_ERR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_ALLOCATED_WHEN_PDB_FIFO_EMPTY_ERR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_RELEASED_WHEN_PDB_FIFO_FULL_ERR, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_ECC_ECC_2B_ERR_INT, 0, 0, j2p_intr_ecc_2b_handler,
                              j2p_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_DRAM_TX_PD_FIFO_OVF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_DRAM_TX_PD_FIFO_UNF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_DRAM_TX_BUNDLE_FIFO_OVF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_DRAM_TX_BUNDLE_FIFO_UNF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_FABRIC_TX_PD_FIFO_OVF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_FABRIC_TX_PD_FIFO_UNF_INT, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_FABRIC_TX_BUNDLE_FIFO_OVF_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_TX_FIFO_ERR_TO_FABRIC_TX_BUNDLE_FIFO_UNF_INT, 0, 0, j2p_soft_reset,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_2_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_2_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_3_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_3_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_4_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_4_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_5_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_5_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_6_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_6_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_7_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_7_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_8_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_DEQ_FIFO_8_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_PDM_FIFO_0_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_PDM_FIFO_0_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_PDM_FIFO_1_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_PDM_FIFO_1_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_PDM_FIFO_2_OVF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_SQM_FIFO_ERR_PDM_FIFO_2_UNF, 0, 0, j2p_soft_reset, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_MSD_MACSEC_MACSEC_INTERRUPT_REGISTER, 0, 0, j2p_macsec_interrupt_handling,
                              NULL, "MACSEC interrupt detected");
    ...
    dnxc_intr_add_handler_ext(unit, J2P_INT_HBC_ECC_ECC_2B_ERR_INT, 0, 0, j2p_special_handling, j2p_none,
                              "HBC ECC 2bit error");
    /** Tcam ECC error */
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_A_0_1B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_A_0_2B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_B_0_1B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_B_0_2B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_A_1_1B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_A_1_2B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_B_1_1B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");
    dnxc_intr_add_handler_ext(unit, J2P_INT_KAPS_TECC_B_1_2B_ERROR, 0, 0, j2p_intr_kaps_tecc_handler, j2p_none,
                              "Kaps TECC");

    /** update clear function */
    dnxc_intr_add_clear_func(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_LELA_FID_EXCEED_LIMIT,
                             j2p_intr_clear_MactLelaFidExceedLimit);
    dnxc_intr_add_clear_func(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_LELB_FID_EXCEED_LIMIT,
                             j2p_intr_clear_MactLelbFidExceedLimit);
    dnxc_intr_add_clear_func(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_MNGMNT_REQ_FID_EXCEED_LIMIT_ALLOWED,
                             j2p_intr_clear_MactMngmntReqFidExceedLimitAllowed);
    dnxc_intr_add_clear_func(unit, J2P_INT_MACT_LARGE_EM_LARGE_EM_MNGMNT_REQ_FID_EXCEED_LIMIT,
                             j2p_intr_clear_MactMngmntReqFidExceedLimit);

    dnxc_intr_add_handler_ext(unit, J2P_INT_EPNI_ETPP_TOTAL_INC_ABOVE_TH_WITH_EBD_INT, 0, 0,
                              j2p_egress_edit_adelta_edelta_int_handle, NULL,
                              "Egress Detected: (Actual editing size Delta - Estimated editing size Delta) > 64B");

    dnxc_intr_add_handler_ext(unit, J2P_INT_EPNI_ETPP_EBD_ERR_INT, 0, 0, j2p_egress_edit_adelta_edelta_int_handle, NULL,
                              "Egress Detected: (Actual editing size Delta - Estimated editing size Delta) < 0B");

    dnxc_intr_add_handler_ext(unit, J2P_INT_ILE_ILKN_RX_PORT_0_STATUS_CHANGE_INT, 0, 0,
                              j2p_ilkn_link_status_change_handling, j2p_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2P_INT_ILE_ILKN_RX_PORT_1_STATUS_CHANGE_INT, 0, 0,
                              j2p_ilkn_link_status_change_handling, j2p_none, "Check Configuration");
