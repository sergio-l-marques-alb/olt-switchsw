 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_general_global_tcg_strict_priority_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
...
/**
 * \brief device level function which set numeric assigned_credit_worth_multiplier
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_ps_assigned_credit_worth_multiplier_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_ps;
    int define_index = dnx_data_sch_ps_define_assigned_credit_worth_multiplier;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set numeric virtual_flow_mapped_queue
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_flow_virtual_flow_mapped_queue_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_virtual_flow_mapped_queue;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define max_calendar_size
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_interface_max_calendar_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_interface;
    int define_index = dnx_data_sch_interface_define_max_calendar_size;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_dbal_priority_propagation_if_group_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = (dnx_data_sch.interface.nof_sch_interfaces_get(unit)-1)/8;

    /* Set value */
    define->data = (dnx_data_sch.interface.nof_sch_interfaces_get(unit)-1)/8;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_dbal_max_sch_interfaces_with_fc_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_sch_dbal_priority_propagation_if_group_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = utilex_log2_round_up(dnx_data_sch.interface.nof_sch_interfaces_get(unit)/8);

    /* Set value */
    define->data = utilex_log2_round_up(dnx_data_sch.interface.nof_sch_interfaces_get(unit)/8);
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_sch_general_global_tcg_strict_priority_set;
    ...
    data_index = dnx_data_sch_ps_define_assigned_credit_worth_multiplier;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_ps_assigned_credit_worth_multiplier_set;
    ...
    data_index = dnx_data_sch_flow_define_virtual_flow_mapped_queue;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_flow_virtual_flow_mapped_queue_set;
    ...
    data_index = dnx_data_sch_interface_define_max_calendar_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_interface_max_calendar_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_dbal_priority_propagation_if_group_max_set;
    data_index = dnx_data_sch_dbal_define_max_sch_interfaces_with_fc;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_dbal_max_sch_interfaces_with_fc_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_dbal_priority_propagation_if_group_nof_bits_set;
