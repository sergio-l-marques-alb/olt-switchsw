    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, UDH_MAP_TYPE_TO_LENGHT_0f));
            ...
            }
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, UDH_MAP_TYPE_TO_LENGHT_1f));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, UDH_MAP_TYPE_TO_LENGHT_2f));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, UDH_MAP_TYPE_TO_LENGHT_3f));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, FTMH_LB_KEY_EXT_ENf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, FTMH_STACKING_EXT_ENABLEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_ECI_FAP_GLOBAL_SYS_HEADER_CFG);
                }
            }
        }
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, USER_HEADER_ENABLEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_ECI_FAP_GLOBAL_SYS_HEADER_CFG);
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, PPH_BASE_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, OUT_LIF_X_1_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->inst_idx = 1;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, OUT_LIF_X_2_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->inst_idx = 2;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, OUT_LIF_X_3_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, IN_LIF_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, NETWORK_OFFSETf));
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, J_MODE_NETWORK_OFFSETf));
                        DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_EGRESS_JERICHO_COMPATIBLE_REGISTERS);
                    }
                }
                {
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDr, J_MODE_NETWORK_OFFSET_FOR_SYSTEM_HEADERSf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_EGRESS_JERICHO_COMPATIBLE_REGISTERS);
                }
            }
        }
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_PPH_VSI_SOURCEr, INVALIDf));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_PPH_FHEI_FWD_SIZEr, INVALIDf));
