    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_CS_INLIF_PROFILE_MAP_0r, INVALIDf));
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_CS_INLIF_PROFILE_MAP_1r, INVALIDf));
                    access_params->data_offset.formula_cb = in_lif_profile_table_cs_in_lif_flp_to_flp_profile_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDm, CFG_INLIF_DP_PROFILE_MAPf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDm, DA_NOT_FOUND_DESTINATION_PROFILEf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_OAM_IN_LIF_PROFILE_MAPr, INVALIDf));
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_IN_LIF_PROFILE_MAPr, INVALIDf));
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_JR_2_TO_JR_IN_LIF_PROFILE_MAPr, INVALIDf));
                        access_params->data_offset.formula_cb = in_lif_profile_table_jr_mode_in_lif_profile_dataoffset_0_cb;
                    }
                }
            }
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_LIF_MC_BRIDGE_FALLBACK_ALLOWr, INVALIDf));
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_IN_LIF_ORIENTATION_MAPr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_IN_LIF_LB_PROFILE_MAPr, INVALIDf));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPA_ROUTING_PROFILE_TABLEm, INVALIDf));
                    {
                        access_params->array_offset.formula_int = 3;
                    }
            ...
            }
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPF_ROUTING_PROFILE_TABLEm, INVALIDf));
                    access_params->entry_offset.formula_cb = vsi_profile_table_routing_enablers_profile_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = vsi_profile_table_routing_enablers_profile_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDm, FWD_DOMAIN_CS_PROFILEf));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, INVALIDm, INLIF_PROFILEf));
