 ...
 */
static shr_error_e
j2c_a0_dnx_data_fc_general_ilkn_inband_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_fc_general_nof_bits_in_pfc_status_select_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_fc_coe_nof_supported_chan_ids_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_fc_coe_nof_coe_ptc_mask_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_fc_coe_nof_coe_ptc_left_shift_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_fc_general_nof_bits_in_pfc_status_select_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_fc_general_ilkn_inband_support_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_fc_coe_nof_supported_chan_ids_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_fc_coe_nof_coe_ptc_mask_width_set;
    data_index = dnx_data_fc_coe_define_nof_coe_ptc_left_shift_width;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_fc_coe_nof_coe_ptc_left_shift_width_set;
