/** \file dnx_data_ingr_congestion.c
 * 
 * MODULE DEVICE DATA - INGR_CONGESTION
 * 
 * Device Data
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ingr_congestion_info_wred_c1_high_precision_supported].doc = "High precision C1 WRED parameter supported";
    ...
    submodule_data->features[dnx_data_ingr_congestion_info_wred_continuous_probabilty_supported].doc = "Continuous drop probabilty function supported";
    ...
    submodule_data->defines[dnx_data_ingr_congestion_info_define_max_jumbo_packet_size].doc = "Maximum size of jumbo packet";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_info_define_max_total_bytes].doc = "Maximal total bytes resources";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_info_define_nof_active_drams].doc = "Number of active drams. Used to calculate total bytes resources available in device";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_info_define_total_bytes].doc = "total bytes resources according to available DRAM";
    /* Set data type flag */
    ...
    /*
     * Table - dp_free_res_presentage_drop
     */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ingr_congestion_vsq_colorless_guaranteed_support].doc = "VSQE/VSQF guaranteed resources are NOT allocated per color";
    ...
    submodule_data->defines[dnx_data_ingr_congestion_vsq_define_oversubscription_bubble_width].doc = "Bubble width (in cycles) required for VSQ occupancy memory read";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /*
     * Table - dp_global_sram_buffer_drop
     */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ingr_congestion_dbal_fabric_and_dram_separate_dequeue_pkt_counters].doc = "Indicates if separate counters for packet dequeue to fabric and packet dequeue to DRAM is supported";
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_buffer_per_pool_nof_bits].doc = "Number of bits SRAM Buffers per pool";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_pds_per_pool_nof_bits].doc = "Number of bits SRAM PDs per pool";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_compensation_delta_nof_bits].doc = "Number of bits for header delta";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_buffer_size_voq_occupancy_nof_bits].doc = "Number of bits for SRAM buffer size for CGM_VOQ_OCCUPANCY dbal";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_size_in_words_sram_voq_occupancy_nof_bits].doc = "Number of bits for SRAM words size for CGM_VOQ_OCCUPANCY dbal";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_pds_size_occupancy_nof_bits].doc = "Number of bits for SRAM pd size for CGM_VOQ_OCCUPANCY and VSQ_GROUP_OCCUPANCY dbal";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_buffer_size_vsq_occupancy_nof_bits].doc = "Number of bits for SRAM buffer size for VSQ_GROUP_OCCUPANCY dbal";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_size_in_words_occupancy_nof_bits].doc = "Number of bits for VOQ combined Words size for CGM_VOQ_OCCUPANCY dbal";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_dram_bounds_sram_words_th_nof_bits].doc = "Number of bits for SRAM words threshold";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_buffers_vsq_th_nof_bits].doc = "Number of bits for VSQ SRAM buffer threshold";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_dbal_define_sram_vsq_pds_th_nof_bits].doc = "Number of bits for VSQ PDS threshold";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_ingr_congestion_sram_buffer_define_nof_drop_profiles].doc = "number of profiles, used for drop logic";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_ingr_congestion_sram_buffer_define_nof_drop_profiles_bits].doc = "number of bits in drop profile";
    /* Set data type flag */
