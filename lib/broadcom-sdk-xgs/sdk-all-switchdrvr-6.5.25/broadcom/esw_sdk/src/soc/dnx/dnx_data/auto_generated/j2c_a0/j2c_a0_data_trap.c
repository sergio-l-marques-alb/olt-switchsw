 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_ndp_trap_en_set(
    int unit)
{
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_trap_in_lif_profile_mapping_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_ipv6_mapped_dest_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_mpls_termination_fail_over_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_header_size_err_blocking_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_l4_trap_res_before_l3_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_comp_mc_before_routing_traps_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_soft_mem_err_over_dest_err_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_eth_default_proc_fix_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_fwd_domain_mode_trap_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_sa_equals_zero_trap_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_ingress_protocol_traps_lif_profile_starting_offset_set(
    int unit)
{
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_erpp_unknown_da_trap_en_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_erpp_glem_not_found_trap_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_register_name_changes_out_lif_mcdb_ptr_signal_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_register_name_changes_added_n_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_register_name_changes_per_pp_port_change_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_trap_register_name_changes_visibility_signal_0_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_trap_ingress_protocol_traps_lif_profile_starting_offset_set;
    ...
    feature->set = j2c_a0_dnx_data_trap_ingress_ndp_trap_en_set;
    data_index = dnx_data_trap_ingress_trap_in_lif_profile_mapping;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_trap_in_lif_profile_mapping_set;
    data_index = dnx_data_trap_ingress_ipv6_mapped_dest;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_ipv6_mapped_dest_set;
    data_index = dnx_data_trap_ingress_mpls_termination_fail_over;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_mpls_termination_fail_over_set;
    data_index = dnx_data_trap_ingress_header_size_err_blocking;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_header_size_err_blocking_set;
    data_index = dnx_data_trap_ingress_l4_trap_res_before_l3;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_l4_trap_res_before_l3_set;
    data_index = dnx_data_trap_ingress_comp_mc_before_routing_traps;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_comp_mc_before_routing_traps_set;
    data_index = dnx_data_trap_ingress_soft_mem_err_over_dest_err;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_soft_mem_err_over_dest_err_set;
    data_index = dnx_data_trap_ingress_eth_default_proc_fix;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_eth_default_proc_fix_set;
    data_index = dnx_data_trap_ingress_fwd_domain_mode_trap;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_fwd_domain_mode_trap_set;
    data_index = dnx_data_trap_ingress_sa_equals_zero_trap;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_ingress_sa_equals_zero_trap_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_erpp_unknown_da_trap_en_set;
    data_index = dnx_data_trap_erpp_glem_not_found_trap;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trap_erpp_glem_not_found_trap_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trap_register_name_changes_out_lif_mcdb_ptr_signal_set;
    data_index = dnx_data_trap_register_name_changes_define_added_n;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trap_register_name_changes_added_n_set;
    data_index = dnx_data_trap_register_name_changes_define_per_pp_port_change;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trap_register_name_changes_per_pp_port_change_set;
    data_index = dnx_data_trap_register_name_changes_define_visibility_signal_0;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trap_register_name_changes_visibility_signal_0_set;
