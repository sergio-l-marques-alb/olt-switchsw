 ...
 */
/**
 * \brief device level function which set define utilization_api_nof_dbs
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define max_nof_db_clusters
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define nof_fec_macro_types
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set values for table mdb_fec_macro_types_info
    ...
    int unit)
{
    ...
    table->values[0].default_val = "MDB_NOF_MACRO_TYPES";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_dh_mdb_fec_macro_types_info_t, (1 + 1 /* to store default value */ ), "data of dnx_data_mdb_dh_table_mdb_fec_macro_types_info");
...
/**
 * \brief device level function which set numeric adapter_mapping_crps_id
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set values for table fec_physical_dbs_alloc_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_pdbs_fec_physical_dbs_alloc_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_pdbs_table_fec_physical_dbs_alloc_info");
...
/**
 * \brief device level function which set define scan_bank_participate_in_cuckoo_partial_support
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define defrag_interrupt_support
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define glem_bypass_option_support
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set numeric my_mac_ippa_em_dbal_id
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set numeric my_mac_ippf_em_dbal_id
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set numeric mact_dbal_id
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
 ...
 */
/**
 * \brief device level function which set values for table em_utilization_api_db_translation
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_em_utilization_api_db_translation_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_em_table_em_utilization_api_db_translation");
...
/**
 * \brief device level function which set values for table em_interrupt
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_em_interrupt_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_em_table_em_interrupt");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_filter_rules_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_em_table_filter_rules");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_data_rules_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_em_table_data_rules");
...
/**
 * \brief device level function which set define nof_fec_dbs
 * define info:
 * The NOF of FEC DBs
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric fec_allocation_base_macro_type
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
 ...
 */
/**
 * \brief device level function which set values for table direct_utilization_api_db_translation
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_direct_direct_utilization_api_db_translation_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_direct_table_direct_utilization_api_db_translation");
...
/**
 * \brief device level function which set values for table mdb_direct_mdb_phy_tables_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_direct_mdb_direct_mdb_phy_tables_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_direct_table_mdb_direct_mdb_phy_tables_info");
...
/**
 * \brief device level function which set values for table phase_ll_bucket_enable
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_eedb_phase_ll_bucket_enable_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_eedb_table_phase_ll_bucket_enable");
...
/**
 * \brief device level function which set define direct_byte_width
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define nof_app_ids
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set numeric small_kaps_ad_size_e
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_kaps_big_bb_blk_id_mapping_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_kaps_table_big_bb_blk_id_mapping");
...
/**
 * \brief device level function which set values for table db_supported_ad_sizes
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_kaps_db_supported_ad_sizes_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_kaps_table_db_supported_ad_sizes");
...
/**
 * \brief device level function which set values for table db_access_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_kaps_db_access_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_kaps_table_db_access_info");
...
/**
 * \brief device level function which set values for table kaps_lookup_result
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_kaps_kaps_lookup_result_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_mdb_kaps_table_kaps_lookup_result");
