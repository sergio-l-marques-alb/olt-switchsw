 ...
 */
static shr_error_e
j2c_a0_dnx_data_bfd_general_configurable_single_hop_tos_set(
    int unit)
{
 ...
 */
static shr_error_e
j2c_a0_dnx_data_bfd_general_extended_sip_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_bfd_general_vxlan_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
 ...
 */
/**
 * \brief device level function which set define bfd_over_php_oam_tcam_oam_offset
 * define info:
 ...
 */
static shr_error_e
j2c_a0_dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_bfd;
    int submodule_index = dnx_data_bfd_submodule_general;
    int define_index = dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = 0x1c;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_bfd_feature_detect_multiplier_limitation_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_bfd_feature_ptch_oam_offset_limitation_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
    ...
    int unit)
{
     ...
     * Attach defines: 
     */
    data_index = dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_set;
    ...
    feature->set = j2c_a0_dnx_data_bfd_general_configurable_single_hop_tos_set;
    data_index = dnx_data_bfd_general_extended_sip_support;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_bfd_general_extended_sip_support_set;
    data_index = dnx_data_bfd_general_vxlan_support;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_bfd_general_vxlan_support_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_bfd_feature_detect_multiplier_limitation_set;
    data_index = dnx_data_bfd_feature_ptch_oam_offset_limitation;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_bfd_feature_ptch_oam_offset_limitation_set;
