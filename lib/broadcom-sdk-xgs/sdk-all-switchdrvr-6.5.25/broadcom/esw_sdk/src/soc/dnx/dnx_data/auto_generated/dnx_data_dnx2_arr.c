    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix].name = "IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix";
    submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix].doc = "prefix of format IRPP_IN_LIF_FORMATS at index 1";
    /* Set data type flag */
    submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix_get(
    int unit)
{
    /* Access is enabled through DNX2 devices family only */
    if (!soc_is(unit, DNX2_DEVICE))
    {
        dnxc_data_mgmt_inaccessible_data_get(unit, "IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix", "DNX2");
    }
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dnx2_arr, dnx_data_dnx2_arr_submodule_prefix, dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix);
}
