...
#ifdef BCM_DNX2_SUPPORT
/*{*/
extern shr_error_e j2x_a0_data_bfd_attach(
    int unit);
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_support].name = "bfd_over_php_support";
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_support].doc = "BFD identification for BFD over PHP is supported on - J2CP only!";
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_bfd_general_bfd_over_php_tcam_support].name = "bfd_over_php_tcam_support";
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_tcam_support].doc = "BFD identification for BFD over PHP by OAM TCAM is supported";
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_tcam_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset].name = "bfd_over_php_oam_tcam_oam_offset";
    submodule_data->defines[dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset].doc = "OAM_OFFSET value in OAM TCAM entry for classifying BFD over PHP packet";
    /* Set data type flag */
    submodule_data->defines[dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_bfd_general_define_bfd_echo_support_in_parser].name = "bfd_echo_support_in_parser";
    submodule_data->defines[dnx_data_bfd_general_define_bfd_echo_support_in_parser].doc = "Whether BFD_ECHO destination port is supported in parser";
    /* Set data type flag */
    submodule_data->defines[dnx_data_bfd_general_define_bfd_echo_support_in_parser].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_bfd, dnx_data_bfd_submodule_general, dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset);
}

uint32
dnx_data_bfd_general_bfd_echo_support_in_parser_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_bfd, dnx_data_bfd_submodule_general, dnx_data_bfd_general_define_bfd_echo_support_in_parser);
}
...
/*{*/
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_bfd_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_bfd_attach(unit));
    }
    else
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
