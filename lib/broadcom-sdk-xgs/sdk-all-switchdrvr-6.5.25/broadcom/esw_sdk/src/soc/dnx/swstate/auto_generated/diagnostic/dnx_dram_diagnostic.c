...
dnx_dram_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_dram_db_temperature_monitoring_last_read_dump(unit, -1, filters));
...
/*
 *
 * dump function for the variable is_initialized
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
dnx_dram_db_sync_manager_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_dram_db_sync_manager_firmware_mutex_dump(unit, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
/*
 *
 * dump function for the variable firmware_mutex
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_dram_db_sync_manager_firmware_mutex_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_dram sync_manager firmware_mutex") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_dram sync_manager firmware_mutex\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_dram_db/sync_manager/firmware_mutex.txt",
            "dnx_dram_db[%d]->","((dnx_dram_db_t*)sw_state_roots_array[%d][DNX_DRAM_MODULE_ID])->","sync_manager.firmware_mutex: ");
...
/*
 *
 * dump function for the variable power_on
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable dynamic_calibration_enabled
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable dynamic_calibration_was_enabled_after_dram_tune
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
dnx_dram_db_temperature_monitoring_thread_state_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        DNX_SW_STATE_PRINT_ENUM(
            unit,
            dnx_dram_temperature_monitoring_state_e_get_name(((dnx_dram_db_t*)sw_state_roots_array[unit][DNX_DRAM_MODULE_ID])->temperature_monitoring_thread_state));
...
/*
 *
 * dump function for the variable temperature_monitoring_last_read
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_dram_db_temperature_monitoring_last_read_dump(int  unit,  int  temperature_monitoring_last_read_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
...
/*
 *
 * dump function for the variable gddr6_vendor_info
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable manufacturer_vendor_code
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable revision_id
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable internal_wck
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable wck_granularity
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable wck_frequency
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable vddq_off
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
const char* dnx_dram_db_layout_str[DNX_DRAM_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_DRAM_DB~SYNC_MANAGER~FIRMWARE_MUTEX~",
    ...
    "DNX_DRAM_DB~TEMPERATURE_MONITORING_LAST_READ~",
