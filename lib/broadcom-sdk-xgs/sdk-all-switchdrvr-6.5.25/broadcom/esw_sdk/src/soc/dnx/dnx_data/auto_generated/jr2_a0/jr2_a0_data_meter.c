...
/**
 * \brief device level function which set numeric nof_single_buckets_per_entry
 * numeric info:
 * Number of single bucket meters in one engine entry
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set numeric nof_dual_buckets_per_entry
 * numeric info:
 * Number of dual buckets meters in one engine entry
 * 
 * \param [in] unit - Unit #
 * 
 * \return
