 ...
 */
static shr_error_e
jr2_b0_dnx_data_adapter_general_oamp_ms_id_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b0_dnx_data_adapter_general_Injection_set(
    int unit)
{
    ...
    /* Info - default values */
    table->values[0].default_val = "PRSR_JR2_B0";
    ...
    default_data->Injected_packet_name = "PRSR_JR2_B0";
    /* Set Default Values */
 ...
 */
static shr_error_e
jr2_b0_dnx_data_adapter_reg_mem_access_cmic_block_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_adapter_reg_mem_access_iproc_block_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_adapter_general_oamp_ms_id_set;
    ...
    table->set = jr2_b0_dnx_data_adapter_general_Injection_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_adapter_reg_mem_access_cmic_block_index_set;
    data_index = dnx_data_adapter_reg_mem_access_define_iproc_block_index;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_adapter_reg_mem_access_iproc_block_index_set;
