/** \file j2c_a1_data_ingr_congestion.c
 * 
 ...
 */
static shr_error_e
j2c_a1_dnx_data_ingr_congestion_config_inband_telemetry_ftmh_extension_eco_fix_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
    int submodule_index = dnx_data_ingr_congestion_submodule_config;
    int feature_index = dnx_data_ingr_congestion_config_inband_telemetry_ftmh_extension_eco_fix;
 ...
 */
shr_error_e
j2c_a1_data_ingr_congestion_attach(
    int unit)
{
     ...
     * Attach features: 
     */
    data_index = dnx_data_ingr_congestion_config_inband_telemetry_ftmh_extension_eco_fix;
    feature = &submodule->features[data_index];
    feature->set = j2c_a1_dnx_data_ingr_congestion_config_inband_telemetry_ftmh_extension_eco_fix_set;
