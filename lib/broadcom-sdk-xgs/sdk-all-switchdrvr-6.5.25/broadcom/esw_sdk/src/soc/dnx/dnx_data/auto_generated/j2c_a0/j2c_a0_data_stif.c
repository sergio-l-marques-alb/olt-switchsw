 ...
 */
/**
 * \brief device level function which set values for table supported_modes
 * Module - 'stif', Submodule - 'regression', table - 'supported_modes'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_stif_regression_supported_modes_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_stif_regression_table_supported_modes");
