    ...
    int unit)
{
    ...
    /* Set default value */
    define->default_data = (dnx_data_trunk.egress_trunk.nof_lb_keys_per_profile_get(unit) == 128 ) ? 256 : 128;

    /* Set value */
    define->data = (dnx_data_trunk.egress_trunk.nof_lb_keys_per_profile_get(unit) == 128 ) ? 256 : 128;
    ...
    int unit)
{
    ...
    define->property.doc = 
        "\n"
        "Set the number of Load Balancing keys for Egress trunks. Valid values: 128, 256\n"
        "\n"
    ;
...
/**
 * \brief device level function which set numeric size_mode
 * numeric info:
 ...
 */
/**
 * \brief device level function which set numeric nof_flow_aggs
 * numeric info:
