    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_tdm_params_rqp_tdm_bypass_enable].name = "rqp_tdm_bypass_enable";
    submodule_data->features[dnx_data_tdm_params_rqp_tdm_bypass_enable].doc = "An additional configuration to enable TDM cells from FDT (TDM bypas) to do bypass in RQP exists";
    submodule_data->features[dnx_data_tdm_params_rqp_tdm_bypass_enable].flags |= DNXC_DATA_F_FEATURE;
