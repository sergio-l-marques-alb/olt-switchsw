...
/**
 * \brief device level function which set define three_intf_glem
 * define info:
...
/**
 * \brief device level function which set numeric global_lif_tag_nof_bta_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric global_lif_intf_max_val
 * numeric info:
...
/**
 * \brief device level function which set numeric global_lif_tag_nof_intf_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric global_lif_group_max_val
 * numeric info:
...
/**
 * \brief device level function which set numeric global_lif_tag_nof_group_bits
 * numeric info:
...
/**
 * \brief device level function which set define algo_flow_inlif_bank_size
 * define info:
...
/**
 * \brief device level function which set define nof_routing_enable_profiles
 * define info:
...
/**
 * \brief device level function which set numeric in_lif_profile_egress_reserved_start_bit
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_in_lif_profile_allocate_orientation_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_in_lif_profile_allocate_policer_inner_dp_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_in_lif_profile_allocate_policer_outer_dp_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_in_lif_profile_allocate_same_interface_mode_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_in_lif_egress_reserved_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric eth_rif_profile_egress_reserved_nof_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric eth_rif_profile_egress_reserved_start_bit
 * numeric info:
...
/**
 * \brief device level function which set numeric in_lif_profile_native_indexed_mode_start_bit
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_in_lif_profile_allocate_indexed_mode_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric global_bier_outlif_bta_sop
 * numeric info:
