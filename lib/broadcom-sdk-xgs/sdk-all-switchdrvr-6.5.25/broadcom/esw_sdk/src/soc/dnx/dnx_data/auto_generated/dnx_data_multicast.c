    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_multicast_params_mcdb_dest_encoding_in_entry].name = "mcdb_dest_encoding_in_entry";
    submodule_data->features[dnx_data_multicast_params_mcdb_dest_encoding_in_entry].doc = "The destination is written in the MCDB entry with the encoding.";
    submodule_data->features[dnx_data_multicast_params_mcdb_dest_encoding_in_entry].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_multicast_params_mcdb_nested_groups_support].name = "mcdb_nested_groups_support";
    submodule_data->features[dnx_data_multicast_params_mcdb_nested_groups_support].doc = "Support nested groups - the destination can be the MC ID of another group.";
    submodule_data->features[dnx_data_multicast_params_mcdb_nested_groups_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_multicast_mcdb_hash_table_define_max_key_size_in_words].doc = "Size of key for MCDB entry ID hash table in words(32 bits).";
    /* Set data type flag */
