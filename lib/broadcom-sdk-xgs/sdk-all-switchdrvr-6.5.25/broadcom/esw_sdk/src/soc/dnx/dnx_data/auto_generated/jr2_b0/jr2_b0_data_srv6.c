 ...
 */
static shr_error_e
jr2_b0_dnx_data_srv6_encapsulation_is_t_insert_support_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = jr2_b0_dnx_data_srv6_encapsulation_is_t_insert_support_set;
