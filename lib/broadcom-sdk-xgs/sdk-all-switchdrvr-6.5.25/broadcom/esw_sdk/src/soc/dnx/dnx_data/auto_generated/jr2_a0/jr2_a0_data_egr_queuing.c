...
/**
 * \brief device level function which set define nof_egr_olp_interfaces
 * define info:
...
/**
 * \brief device level function which set numeric egress_bubble_delay
 * numeric info:
...
/**
 * \brief device level function which set values for table fqp_dbf_additional_latency
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_egr_queuing_params_fqp_dbf_additional_latency_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_egr_queuing_params_table_fqp_dbf_additional_latency");
