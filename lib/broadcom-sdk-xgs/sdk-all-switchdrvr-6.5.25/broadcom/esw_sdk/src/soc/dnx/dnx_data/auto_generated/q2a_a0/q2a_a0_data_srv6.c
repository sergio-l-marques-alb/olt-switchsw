 ...
 */
static shr_error_e
q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_psp_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usp_1pass_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_srv6_encapsulation_is_t_insert_support_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_srv6_encapsulation_max_nof_encap_sids_main_pass_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_srv6_encapsulation_nof_encap_sids_extended_pass_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_psp_set;
    data_index = dnx_data_srv6_termination_define_max_nof_terminated_sids_usp;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usp_set;
    data_index = dnx_data_srv6_termination_define_max_nof_terminated_sids_usp_1pass;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usp_1pass_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_srv6_encapsulation_max_nof_encap_sids_main_pass_set;
    data_index = dnx_data_srv6_encapsulation_define_nof_encap_sids_extended_pass;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_srv6_encapsulation_nof_encap_sids_extended_pass_set;
    ...
    feature->set = q2a_a0_dnx_data_srv6_encapsulation_is_t_insert_support_set;
