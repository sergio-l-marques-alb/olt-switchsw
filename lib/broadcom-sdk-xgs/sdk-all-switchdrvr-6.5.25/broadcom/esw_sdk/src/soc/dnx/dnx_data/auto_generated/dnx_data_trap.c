    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trap_etpp_oam_traps_support].name = "oam_traps_support";
    submodule_data->features[dnx_data_trap_etpp_oam_traps_support].doc = "Indicate if OAM traps are supported";
    submodule_data->features[dnx_data_trap_etpp_oam_traps_support].flags |= DNXC_DATA_F_FEATURE;
...
/*
 * register_name_changes features
 */
int
