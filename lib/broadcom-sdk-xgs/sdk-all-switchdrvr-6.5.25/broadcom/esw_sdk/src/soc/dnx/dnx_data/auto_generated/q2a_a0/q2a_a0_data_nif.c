...
/**
 * \brief device level function which set define sar_jitter_tolerance_max_level
 * define info:
...
/**
 * \brief device level function which set define mac_pad_size
 * define info:
...
/**
 * \brief device level function which set values for table sar_jitter_fifo_levels
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_flexe_sar_jitter_fifo_levels_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_nif_flexe_table_sar_jitter_fifo_levels");
