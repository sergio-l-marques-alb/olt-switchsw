    ...
    dnx_data_fabric_pipes_map_t * map)
{
    ...
    /*
     * Single pipe - validate that there are no mappings to pipes other than 0
     */
    else
    {
        /*
         * fabric_pipe_map should be either not configured or set to 0 in Single pipe mode
         */
        ...
        {
            /*
             * fabric_pipe_map_uc/mc should be either not configured or both set to 0 in Single pipe mode
             */
    ...
    dnx_data_port_static_add_ucode_port_t * ucode_port)
{
    ...
    if (propval)
    {
        ...
        /*
         * Read OUT TM port. TM port is the default value
         */
    ...
    dnx_data_elk_connectivity_topology_t * topology)
{
    ...
    if (dnx_data_elk.general.feature_get(unit, dnx_data_elk_general_is_egw_support_rr))
    {
        ...
        {
            /*
             * Must attach two kbp ports in the same dnx core.
             */
...
{
    /**
     * quartet type name (string)
     */
    char *name;
    /**
     * Matching quartet type define
     */
...
/**
 * \brief
 * Required info per quartet type
 */
static dnx_data_property_quartet_type_info_t quartet_type_info[] = {
    ...
    {NULL, DNX_SCH_FLOW_QUARTET_TYPE_INVALID}   /* last */
};
    ...
    dnx_data_sch_flow_quartet_type_t * quartet_type)
{
    ...
    {
        /*
         * Devices supporting flexible flow quartet
         */
        ...
        if (region >= dnx_data_sch.flow.nof_connectors_only_regions_get(unit))
        {
            ...
            if (propval)
            {
                ...
                /** Make sure that type found */
                if (quartet_type_info[idx].name == NULL /* not found */ )
                {
                    SHR_ERR_EXIT(_SHR_E_CONFIG, "Invalid quartet configuration (\"%s\")\n", propval);
                }
            }

            /** Make sure the other regions in group and not defined (only the base region can be defined) */
    ...
    {
        /*
         * Non-flexible flow quartet devices
         */
