...
/**
 * \brief device level function which set numeric ck_termination
 * numeric info:
...
/**
 * \brief device level function which set numeric wck_granularity
 * numeric info:
...
/**
 * \brief device level function which set numeric ref_clk_bitmap
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table gddr6_average_read_inflights_leaky_bucket_config_params
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params");
