    ...
    int unit)
{
    ...
    if (dnx_mib_counter_nif_rx_stats_drop_events_sch_low < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_ILKN < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_drop_events_sch_low, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_ILKN);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
    if (dnx_mib_counter_nif_rx_stats_drop_events_sch_high < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_ILKN < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_drop_events_sch_high, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_ILKN);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
