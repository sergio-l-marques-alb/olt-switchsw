/** \file dnx/swstate/auto_generated/diagnostic/dnx_visibility_diagnostic.c
 *
...
/*
 *
 * dump function for the variable visibility_info_db
...
/*
 *
 * dump function for the variable visib_mode
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
