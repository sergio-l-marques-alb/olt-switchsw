 ...
 */
/**
 * \brief device level function which set define core_flow_control_percentage_ratio
 * define info:
...
/**
 * \brief device level function which set define port_queue_uc_flow_control_min_thresh
 * define info:
...
/**
 * \brief device level function which set numeric fmq_max_rate
 * numeric info:
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_tune_iqs_bw_level_rate_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_tune_iqs_table_bw_level_rate");
 ...
 */
/**
 * \brief device level function which set define cgm_llfc_pipe_th
 * define info:
...
/**
 * \brief device level function which set define cgm_drop_fabric_class_th
 * define info:
