 ...
 */
static shr_error_e
j2c_a0_dnx_data_ptp_general_has_trap_code_offset_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = j2c_a0_dnx_data_ptp_general_has_trap_code_offset_set;
