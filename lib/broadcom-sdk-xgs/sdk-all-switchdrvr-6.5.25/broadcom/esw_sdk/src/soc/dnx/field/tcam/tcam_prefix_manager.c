 ...
 * \param [in] core_id      - Core ID to check if the given prefix_value is free to be used on (Must be specified)
 ...
 * \param [in] core_id - Core ID to allocate prefix on  (Must be specified)
 ...
 * \param [in] core_id - Core ID to free prefix on (Must be specified)
 *
 * \return
 *  \retval _SHR_E_NONE - success
 */
 ...
 * \param [in] core_id     - Core ID to check whether any free prefixes exists on (Must be specified)
