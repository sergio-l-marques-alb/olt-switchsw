...
/**
 * \brief device level function which set define max_kbp_instance
 * define info:
 * Max KBP device
 * 
 * \param [in] unit - Unit #
 ...
 */
/**
 * \brief device level function which set define large_mc_mode1
 * define info:
 * ipv4/ipv6 large multicast mode 1
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define large_mc_mode2
 * define info:
 * ipv4/ipv6 large multicast mode 2
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define large_mc_mode3
 * define info:
 * ipv4/ipv6 large multicast mode 3
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set numeric blackhole
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table mdio
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_elk_connectivity_mdio_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_elk_connectivity_table_mdio");
