/** \file dbal_init_cb_tables_hard_logic_tm_hl_tm_synce_definition.c
 * Logical DB enums \n 
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__lane_id;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_LANE_ID, key_value__lane_id);
    *offset = key_value__lane_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
