 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_internal_header_visibilty_mode_global_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_system_headers_jr_mode_ftmh_oam_ts_right_shift_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_otmh_otmh_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_pph_pph_vsi_selection_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_general_fwd_header_offset_calc_with_egress_pars_idx_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_feature_fhei_mpls_cmd_from_eei_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_feature_unknown_address_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_headers_feature_fhei_mpls_swap_remark_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    ...
    int unit)
{
    ...
    feature->set = j2x_a0_dnx_data_headers_internal_header_visibilty_mode_global_set;
    ...
    define->set = j2x_a0_dnx_data_headers_system_headers_jr_mode_ftmh_oam_ts_right_shift_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_headers_otmh_otmh_enable_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_headers_pph_pph_vsi_selection_size_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_headers_general_fwd_header_offset_calc_with_egress_pars_idx_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_headers_feature_fhei_mpls_swap_remark_size_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_headers_feature_fhei_mpls_cmd_from_eei_set;
    data_index = dnx_data_headers_feature_unknown_address;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_headers_feature_unknown_address_set;
