 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_add_remove_queues_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_esb;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_flexe_l1_dest_dedicated_queue_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_esb;
    int submodule_index = dnx_data_esb_submodule_general;
    int feature_index = dnx_data_esb_general_flexe_l1_dest_dedicated_queue_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    /* Set default value */
    define->default_data = dnx_data_esb.general.nof_nif_eth_queues_get(unit)+dnx_data_esb.general.nof_nif_ilkn_queues_get(unit)+dnx_data_esb.general.nof_ilkn_tdm_or_lp_queues_get(unit)+dnx_data_esb.general.nof_special_queues_get(unit)+dnx_data_nif.flexe.nof_clients_get(unit)+dnx_data_esb.general.nof_reserved_queues_get(unit);

    /* Set value */
    define->data = dnx_data_esb.general.nof_nif_eth_queues_get(unit)+dnx_data_esb.general.nof_nif_ilkn_queues_get(unit)+dnx_data_esb.general.nof_ilkn_tdm_or_lp_queues_get(unit)+dnx_data_esb.general.nof_special_queues_get(unit)+dnx_data_nif.flexe.nof_clients_get(unit)+dnx_data_esb.general.nof_reserved_queues_get(unit);
...
/**
 * \brief device level function which set define nof_eth_lp_queues
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_nof_eth_lp_queues_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define nof_ilkn_tdm_or_lp_queues
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_nof_ilkn_tdm_or_lp_queues_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define flexe_queue_id_base
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_flexe_queue_id_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define ilkn_queue_id_base
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_ilkn_queue_id_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define ilkn_tdm_or_lp_queue_id_base
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_ilkn_tdm_or_lp_queue_id_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define eth_lp_queue_id_base
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_general_eth_lp_queue_id_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define credit_size_bits
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_dbal_credit_size_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
/**
 * \brief device level function which set define txi_irdy_thresh_size
 * define info:
 ...
 */
static shr_error_e
q2a_a0_dnx_data_esb_dbal_txi_irdy_thresh_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_nof_eth_lp_queues_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_nof_ilkn_tdm_or_lp_queues_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_flexe_queue_id_base_set;
    data_index = dnx_data_esb_general_define_ilkn_queue_id_base;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_ilkn_queue_id_base_set;
    data_index = dnx_data_esb_general_define_ilkn_tdm_or_lp_queue_id_base;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_ilkn_tdm_or_lp_queue_id_base_set;
    data_index = dnx_data_esb_general_define_eth_lp_queue_id_base;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_eth_lp_queue_id_base_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_esb_general_add_remove_queues_support_set;
    ...
    data_index = dnx_data_esb_general_flexe_l1_dest_dedicated_queue_support;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_esb_general_flexe_l1_dest_dedicated_queue_support_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_dbal_credit_size_bits_set;
    data_index = dnx_data_esb_dbal_define_txi_irdy_thresh_size;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_dbal_txi_irdy_thresh_size_set;
