 ...
 */
static shr_error_e
q2a_a0_dnx_data_instru_ipt_telemetry_queue_occ_check_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_instru_ipt_telemetry_queue_occ_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_instru_eventor_is_periodic_events_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_eventor;
    int feature_index = dnx_data_instru_eventor_is_periodic_events_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
q2a_a0_dnx_data_instru_synced_triggers_synced_trigger_version_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_instru_ipt_telemetry_queue_occ_check_set;
    data_index = dnx_data_instru_ipt_define_telemetry_queue_occ_max;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_instru_ipt_telemetry_queue_occ_max_set;
    ...
    data_index = dnx_data_instru_eventor_is_periodic_events_supported;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_instru_eventor_is_periodic_events_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_instru_synced_triggers_synced_trigger_version_set;
