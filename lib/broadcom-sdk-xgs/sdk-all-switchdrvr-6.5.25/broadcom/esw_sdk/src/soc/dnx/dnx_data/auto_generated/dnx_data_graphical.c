/** \file dnx_data_graphical.c
 * 
 * MODULE DEVICE DATA - GRAPHICAL
 * 
 * Device Data
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_graphical_diag_define_num_of_rows].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_graphical_diag_define_num_of_index].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_graphical_diag_define_num_of_block_entries].labels[0] = "j2x_notrev";
    /* Set data type flag */
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].values[3].name = "mapping";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].values[3].type = "dnx_diag_graphical_block_mapping_e";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].values[3].doc = "mapping of blocks per core";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].values[3].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_blocks_left_t, mapping);
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].values[3].name = "mapping";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].values[3].type = "dnx_diag_graphical_block_mapping_e";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].values[3].doc = "mapping of blocks per core";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].values[3].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_blocks_right_t, mapping);
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_counters].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_drop_reason].labels[0] = "j2x_notrev";
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->mapping);
            break;
    }
