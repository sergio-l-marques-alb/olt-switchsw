/** \file dnx_data_kleap_stage_info.c
 * 
 * MODULE DEVICE DATA - KLEAP_STAGE_INFO
 * 
 * Device Data
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /*
     * Table - info_per_stage_per_sub_stage
     */
