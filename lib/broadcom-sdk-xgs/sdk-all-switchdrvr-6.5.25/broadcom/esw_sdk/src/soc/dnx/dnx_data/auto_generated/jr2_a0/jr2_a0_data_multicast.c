 ...
 */
static shr_error_e
jr2_a0_dnx_data_multicast_params_mcdb_dest_encoding_in_entry_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_multicast;
    int submodule_index = dnx_data_multicast_submodule_params;
    int feature_index = dnx_data_multicast_params_mcdb_dest_encoding_in_entry;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_multicast_params_mcdb_nested_groups_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_multicast;
    int submodule_index = dnx_data_multicast_submodule_params;
    int feature_index = dnx_data_multicast_params_mcdb_nested_groups_support;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set numeric ingr_dest_bits
 * numeric info:
 ...
 */
/**
 * \brief device level function which set define max_key_size_in_words
 * define info:
    ...
    int unit)
{
     ...
     * Attach features: 
     */
    data_index = dnx_data_multicast_params_mcdb_dest_encoding_in_entry;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_multicast_params_mcdb_dest_encoding_in_entry_set;
    data_index = dnx_data_multicast_params_mcdb_nested_groups_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_multicast_params_mcdb_nested_groups_support_set;

    /*
     * Attach tables: 
     */
    /*
     * Attach submodule: mcdb_hash_table
     */
