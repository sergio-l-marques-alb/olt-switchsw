    ...
    int unit)
{
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = dnx_data_nif.phys.max_phys_in_core_get(unit) + 4;

    /* Set value */
    define->data = dnx_data_nif.phys.max_phys_in_core_get(unit) + 4;
...
/**
 * \brief device level function which set define map_value_size_in_bits
 * define info:
 * For DBAL - size in bits of the Map value field of the calendar.
 * 
 * \param [in] unit - Unit #
 * 
 * \return
 ...
 */
static shr_error_e
jr2_a0_dnx_data_fc_coe_map_value_size_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fc_coe_map_value_size_in_bits_set;
