...
/**
 * \brief device level function which set values for table block_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_debug_mem_block_map_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_debug_mem_table_block_map");
    ...
    {
        data = (dnx_data_debug_mem_block_map_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_ENUM_FVAL_PP_ASIC_BLOCK_REGISTER, 0);
        data->block_id = 10;
    }
    if (DBAL_ENUM_FVAL_PP_ASIC_BLOCK_TABLE < table->keys[0].size)
    {
        data = (dnx_data_debug_mem_block_map_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_ENUM_FVAL_PP_ASIC_BLOCK_TABLE, 0);
        data->block_id = 11;
    }
    if (DBAL_ENUM_FVAL_PP_ASIC_BLOCK_TO_ENGINE < table->keys[0].size)
    {
        data = (dnx_data_debug_mem_block_map_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_ENUM_FVAL_PP_ASIC_BLOCK_TO_ENGINE, 0);
        data->block_id = 12;
    }
    if (DBAL_ENUM_FVAL_PP_ASIC_BLOCK_FROM_ENGINE < table->keys[0].size)
    {
        data = (dnx_data_debug_mem_block_map_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_ENUM_FVAL_PP_ASIC_BLOCK_FROM_ENGINE, 0);
        data->block_id = 13;
    }
...
/**
 * \brief device level function which set values for table mem_array
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_debug_mem_mem_array_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_debug_mem_table_mem_array");
...
/**
 * \brief device level function which set define has_etpp_visibility_enabler
 * define info:
...
/**
 * \brief device level function which set define has_periodic_visibility
 * define info:
...
/**
 * \brief device level function which set define pmf_debug_signals
 * define info:
...
/**
 * \brief device level function which set define fer_debug_signals
 * define info:
...
/**
 * \brief device level function which set define ees_data_device_debug_signals
 * define info:
