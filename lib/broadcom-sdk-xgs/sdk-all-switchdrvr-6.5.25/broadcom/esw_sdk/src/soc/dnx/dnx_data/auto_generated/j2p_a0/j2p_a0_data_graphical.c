/** \file j2p_a0_data_graphical.c
 * 
 * DEVICE DATA - GRAPHICAL
 * 
 * Device Data
 ...
 */
/**
 * \brief device level function which set define num_of_rows
 * define info:
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_num_of_rows_set(
    int unit)
{
...
/**
 * \brief device level function which set define num_of_index
 * define info:
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_num_of_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
/**
 * \brief device level function which set define num_of_block_entries
 * define info:
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_num_of_block_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
 ...
 */
/**
 * \brief device level function which set values for table blocks_left
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_blocks_left_set(
    int unit)
{
    int row_index;
    int index_index;
    ...
    table->values[3].default_val = "dnx_block_mapping_core_to_block_idx";
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_graphical_diag_blocks_left_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_graphical_diag_table_blocks_left");
    ...
    default_data->mapping = dnx_block_mapping_core_to_block_idx;
    /* Set Default Values */
    ...
    if (3 < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->name = "FDT";
        data->valid = 1;
        data->mapping = dnx_block_mapping_core_to_numel_idx;
    }
...
/**
 * \brief device level function which set values for table blocks_right
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_blocks_right_set(
    int unit)
{
    int row_index;
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_graphical_diag_blocks_right_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_graphical_diag_table_blocks_right");
...
/**
 * \brief device level function which set values for table counters
 ...
 */
static shr_error_e
j2p_a0_dnx_data_graphical_diag_counters_set(
    int unit)
{
    int block_index;
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_graphical_diag_counters_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_graphical_diag_table_counters");
    ...
    if (dnx_graphical_nif_rx < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->regs[0] = CDB_RX_NUM_TOTAL_DROPPED_EOPSr;
        data->regs[1] = CDBM_RX_NUM_TOTAL_DROPPED_EOPSr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (dnx_graphical_nif_rx < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = CDB_RX_TOTAL_PKT_COUNTERr;
        data->regs[1] = CDBM_RX_TOTAL_PKT_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (dnx_graphical_nif_rx < table->keys[0].size && 2 < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = CDB_RX_TOTAL_BYTE_COUNTERr;
        data->regs[1] = CDBM_RX_TOTAL_BYTE_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (dnx_graphical_ire < table->keys[0].size && 9 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_ire, 9);
        data->name = "IN_MACSEC_ERR_PKTS";
        data->short_name = "MACSEC_ERR_PKTS";
        data->regs[0] = IRE_NIF_MACSEC_ERR_PACKET_COUNTERr;
        data->flds[0] = NIF_MACSEC_ERR_PACKET_COUNTERf;
        data->doc = "Number of packets (EOPs) with macsec error indication received from NIF";
    }
    ...
    if (dnx_graphical_cgm < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->regs[0] = CGM_GLBL_RJCT_CTRr;
    ...
    if (dnx_graphical_cgm < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->regs[0] = CGM_VOQ_SRAM_DEL_CTRr;
    ...
    if (dnx_graphical_cgm < table->keys[0].size && 2 < table->keys[1].size)
    {
        ...
        data->regs[0] = CGM_VOQ_SRAM_DEQ_CTRr;
    ...
    if (dnx_graphical_cgm < table->keys[0].size && 4 < table->keys[1].size)
    {
        ...
        data->regs[0] = CGM_VOQ_SRAM_ENQ_CTRr;
    ...
    if (dnx_graphical_cgm < table->keys[0].size && 6 < table->keys[1].size)
    {
        ...
        data->regs[0] = CGM_VOQ_DRAM_DEL_CTRr;
    ...
    if (dnx_graphical_cgm < table->keys[0].size && 7 < table->keys[1].size)
    {
        ...
        data->regs[0] = CGM_VOQ_DRAM_DEQ_CTRr;
    ...
    if (dnx_graphical_rqp < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->name = "CDC_FABRIC_PACKET_CNT";
        data->short_name = "CDC_FAB_PKTS";
        data->regs[0] = RQP_CELL_DECODER_DEBUG_COUNTERSr;
        data->flds[0] = CDC_FABRIC_PACKET_CNTf;
        data->doc = "Counts the number of fabric packets reach the cell decoder";
    }
    if (dnx_graphical_rqp < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->name = "CDC_IPT_PACKET_CNT";
        data->short_name = "CDC_IPT_PKTS";
        data->regs[0] = RQP_CELL_DECODER_DEBUG_COUNTERSr;
        data->flds[0] = CDC_IPT_PACKET_CNTf;
        data->doc = "Counts the number of fabric packets reach the cell decoder";
    }
    if (dnx_graphical_rqp < table->keys[0].size && 2 < table->keys[1].size)
    {
        ...
        data->name = "CDC_MC_MESH_PACKET_CNT";
        data->short_name = "CDC_MESH_PKTS";
        data->regs[0] = RQP_CELL_DECODER_DEBUG_COUNTERSr;
        data->flds[0] = CDC_MC_MESH_PACKET_CNTf;
        data->doc = "Counts the number of multicast MESH packets reach the cell decoder";
    }
    ...
    if (dnx_graphical_epni < table->keys[0].size && 4 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_epni, 4);
        data->name = "FRWD_DISC_CNT(ETPP Marked Drops)";
        data->short_name = "FRWD_DISC_CNT";
        data->regs[0] = EPNI_EPNI_FRWD_DISC_CNTr;
        data->flds[0] = EPNI_FRWD_DISC_CNTf;
        data->doc = "Counts forwarded discarded transaction.";
    }
    if (dnx_graphical_nif_tx < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->short_name = "TTL_PKTS";
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = CDB_TX_TOTAL_PKT_COUNTERr;
        data->regs[1] = CDBM_TX_TOTAL_PKT_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (dnx_graphical_nif_tx < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->short_name = "TTL_BYTS";
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = CDB_TX_TOTAL_BYTE_COUNTERr;
        data->regs[1] = CDBM_TX_TOTAL_BYTE_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (dnx_graphical_nif_tx < table->keys[0].size && 2 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_nif_tx, 2);
        data->name = "TX_TOTAL_ERR_PACKTS";
        data->short_name = "TTL_ERR_PKTS";
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = CDB_TX_TOTAL_PKT_WITH_ERR_COUNTERr;
        data->regs[1] = CDBM_TX_TOTAL_BYTE_WITH_ERR_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = TX_TOTAL_PKT_WITH_ERR_COUNTERf;
        data->flds[1] = TX_TOTAL_PKT_WITH_ERR_COUNTERf;
        data->fld_num = 2;
        data->doc = "Counter for total packets sent from EGQ to NIF With An Error";
    }
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_graphical_diag_num_of_rows_set;
    data_index = dnx_data_graphical_diag_define_num_of_index;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_graphical_diag_num_of_index_set;
    data_index = dnx_data_graphical_diag_define_num_of_block_entries;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_graphical_diag_num_of_block_entries_set;
    ...
    table->set = j2p_a0_dnx_data_graphical_diag_blocks_left_set;
    data_index = dnx_data_graphical_diag_table_blocks_right;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_graphical_diag_blocks_right_set;
    data_index = dnx_data_graphical_diag_table_counters;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_graphical_diag_counters_set;
