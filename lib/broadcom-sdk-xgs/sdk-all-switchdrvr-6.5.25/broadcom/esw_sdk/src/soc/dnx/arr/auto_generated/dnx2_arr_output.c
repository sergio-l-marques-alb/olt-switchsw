...
#include <soc/dnx/arr/auto_generated/dnx2_arr_output.h>
#include <bcm/types.h>
#include <bcm/init.h>
    ...
    int unit)
{
...

    {
        ...
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.AGE_PROFILE_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_MACT_AGE_PROFILE_ARR_CFG_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.MACT_AGE_PROFILE_ARR_CFG_get(unit, index);
            if(table->valid)
            {
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_1_ARR_ToS_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_ENC_1_ARR_0_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_ENC_1_ARR_0_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_2_ARR_ToS_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_2_ARR_0_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_2_ARR_0_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_3_ARR_ToS_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_3_ARR_0_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_3_ARR_0_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_4_ARR_ToS_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_4_ARR_0_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_4_ARR_0_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_5_ARR_ToS_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_5_ARR_0_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_5_ARR_0_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_ENC_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_ENC_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_2_ARR_1_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_2_ARR_1_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_3_ARR_1_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_3_ARR_1_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_4_ARR_1_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_4_ARR_1_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPB_ENC_5_ARR_1_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPB_ENC_5_ARR_1_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_ENCAP_ARR_ToS_plus_2_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_ENC_1_ARR_1_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_ENC_1_ARR_1_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_FWD_ARR_ToS_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_FORWARDING_FORMAT_CONFIGURATION_TABLE_0_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_FORWARDING_FORMAT_CONFIGURATION_TABLE_0_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_FWD_ARR_ToS_plus_1_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_FORWARDING_FORMAT_CONFIGURATION_TABLE_1_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_FORWARDING_FORMAT_CONFIGURATION_TABLE_1_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_Preprocessing_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPA_PRP_EES_ARR_CONFIGURATION_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPA_PRP_EES_ARR_CONFIGURATION_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_Preprocessing_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPA_PRP_EES_ARR_CONFIGURATION___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPA_PRP_EES_ARR_CONFIGURATION___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPA_PRP_EES_ARR_CONFIGURATION___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPA_PRP_EES_ARR_CONFIGURATION___array_get(unit, 2, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPA_PRP_EES_ARR_CONFIGURATION___array_get(unit, 3, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_Termination_1_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_TERM_ETPS_ARR_1_CONFIGURATION_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_Termination_1_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 2, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 3, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 4, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 5, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 6, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 7, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_1_CONFIGURATION___array_get(unit, 8, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ETPP_Termination_2_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_ETPPC_TERM_ETPS_ARR_2_CONFIGURATION_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ETPPC_TERM_ETPS_ARR_2_CONFIGURATION_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IPPB_ACCEPTED_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPB_ACCEPTED_ARR_FORMAT_CONFIG_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPB_ACCEPTED_ARR_FORMAT_CONFIG_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IPPB_EXPECTED_ACCEPTED_STRENGTH_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_MACT_MRQ_ARR_CFG_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.MACT_MRQ_ARR_CFG_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IPPB_EXPECTED_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPB_EXPECTED_ARR_FORMAT_CONFIG_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPB_EXPECTED_ARR_FORMAT_CONFIG_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_FEC_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 2, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 3, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 4, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 5, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_FEC_FORMAT_CONFIGURATION_TABLE___array_get(unit, 6, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_FWD1_FWD_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLE___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLE___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLE___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_FWD1_RPF_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPB_FLP_RPF_FORMAT_CONFIGURATION_TABLE___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPB_FLP_RPF_FORMAT_CONFIGURATION_TABLE___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPB_FLP_RPF_FORMAT_CONFIGURATION_TABLE___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_SUPER_FEC_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_get(unit, 2, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_get(unit, 3, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_get(unit, 4, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_SUPER_ARR_FORMAT_CONFIGURATION_TABLE___array_get(unit, 5, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_VSI_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPA_VSI_FORMAT_CONFIGURATION_TABLE_1_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPA_VSI_FORMAT_CONFIGURATION_TABLE_1_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_VSI_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPF_VSI_FORMAT_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPF_VSI_FORMAT_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_VTT_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPA_VTT_FORMAT_CONFIGURATION_TABLE___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPA_VTT_FORMAT_CONFIGURATION_TABLE___array_get(unit, 3, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPA_VTT_FORMAT_CONFIGURATION_TABLE___array_get(unit, 4, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IRPP_VTT_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPF_VTT_FORMAT_CONFIGURATION_TABLE___array_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPF_VTT_FORMAT_CONFIGURATION_TABLE___array_get(unit, 0, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPF_VTT_FORMAT_CONFIGURATION_TABLE___array_get(unit, 1, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPF_VTT_FORMAT_CONFIGURATION_TABLE___array_get(unit, 2, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ITPP_MACT_LEARN_JR1_TRANSLATE_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_IPPD_LEARN_ARR_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.IPPD_LEARN_ARR_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.ITPP_MACT_LEARN_JR1_TRANSLATE_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_OLP_LEARN_ARR_CONFIGURATION_TABLE_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.OLP_LEARN_ARR_CONFIGURATION_TABLE_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.PPMC_ERPP_ARR_get(unit);
        const dnx_data_dnx2_arr_formats_ERPP_EGRESS_MCDB_FORMAT_CFG_t* table;

        for(index = 0; index < max_nof_entries; index++)
        {
            table = dnx_data_dnx2_arr.formats.ERPP_EGRESS_MCDB_FORMAT_CFG_get(unit, index);
            if(table->valid)
            {
                SOC_REG_ABOVE_64_CLEAR(data);
...

    {
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPvX_TUNNEL_ESEM_Command_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_Always_Last_Layer_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_PWE_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_EEI_W_OUTLIF_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_OUTLIF_ETH_RIF_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_EEI_W_POP_Command_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_EEI_W_SWAP_Command_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_MC_RPF_MODE_MC_RPF_MODE_EXPLICIT_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPD_SUPER_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_SUPER_ENTRY_FORMAT___prefix_Empty_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b11_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0001_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0010_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0011_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0100_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0101_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b01111_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b11_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0001_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0010_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0011_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0100_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0101_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b01111_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Parser_Context_Eth_B1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_B1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Free_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_VRF_VSI_Not_Found_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Forward_Domain_Assignment_Mode_LIF_or_VLAN_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Forward_Domain_VRF_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_NEXT_LAYER_NETWORK_DOMAIN_TNIorVNI_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_NEXT_LAYER_NETWORK_DOMAIN_PWE_WO_SD_TAGS_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_OPTIMIZED_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_VSI_P2P_MSBS_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_QoS_Profile_short_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Learn_info_destination_port_encoding_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_W_Learning_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Parser_Context_Eth_B1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_B1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Service_Type_P2P_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Free_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_VRF_VSI_Not_Found_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Forward_Domain_Assignment_Mode_LIF_or_VLAN_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Forward_Domain_VRF_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_NEXT_LAYER_NETWORK_DOMAIN_TNIorVNI_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_NEXT_LAYER_NETWORK_DOMAIN_PWE_WO_SD_TAGS_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_OPTIMIZED_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_VSI_P2P_MSBS_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_QoS_Profile_short_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_Learn_info_destination_port_encoding_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_VSI_Profile_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Dest_MC_ID_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Dest_FEC_Port_Trap_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Topology_ID_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_QOS_Profile_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_My_Mac_Prefix_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_VSI_Stat_Obj_Cmd_Prefix_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Empty_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_VSI_Profile_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Dest_MC_ID_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Dest_FEC_Port_Trap_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_Topology_ID_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_QOS_Profile_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_My_Mac_Prefix_Prefix_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_VSI_Stat_Obj_Cmd_Prefix_get(unit));
