/** \file dnx/swstate/auto_generated/diagnostic/sat_diagnostic.c
 *
...
/*
 *
 * dump function for the variable sat_pkt_header_info
...
/*
 *
 * dump function for the variable pkt_header_base
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
