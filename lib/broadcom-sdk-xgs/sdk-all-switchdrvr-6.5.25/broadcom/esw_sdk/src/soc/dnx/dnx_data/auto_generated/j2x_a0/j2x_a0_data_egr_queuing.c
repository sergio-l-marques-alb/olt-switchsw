/** \file j2x_a0_data_egr_queuing.c
 * 
 ...
 */
static shr_error_e
j2x_a0_dnx_data_egr_queuing_params_fqp_enhanced_attribuites_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
    int submodule_index = dnx_data_egr_queuing_submodule_params;
    int feature_index = dnx_data_egr_queuing_params_fqp_enhanced_attribuites;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
j2x_a0_dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
    int submodule_index = dnx_data_egr_queuing_submodule_params;
    int feature_index = dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define nof_egr_rcy_interfaces
 * define info:
...
/**
 * \brief device level function which set define nif_cal_len_pqp
 * define info:
...
/**
 * \brief device level function which set define nif_cal_len_fqp
 * define info:
...
/**
 * \brief device level function which set define egr_if_flexe_base
 * define info:
 * base dedicated flexe interfaces at egq
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define nof_dedicated_flexe_interfaces
 * define info:
 * nof dedicate flexe interfaces at egq
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define egr_if_nif_alloc_start
 * define info:
 * start range for nif interface allocation
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define egr_if_nif_alloc_end
 * define info:
 * end range for nif interface allocation
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define egr_if_ilkn_alloc_start
 * define info:
 * start range for ilkn interface allocation
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/**
 * \brief device level function which set define egr_if_ilkn_alloc_end
 * define info:
 * end range for ilkn interface allocation
 * 
 * \param [in] unit - Unit #
 * 
 * \return
    ...
    int unit)
{
    ...
    data_index = dnx_data_egr_queuing_params_fqp_enhanced_attribuites;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_egr_queuing_params_fqp_enhanced_attribuites_set;
    ...
    data_index = dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled_set;
