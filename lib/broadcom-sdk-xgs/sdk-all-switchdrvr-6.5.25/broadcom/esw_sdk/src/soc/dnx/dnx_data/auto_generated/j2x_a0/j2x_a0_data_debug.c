 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_mem_params_set(
    int unit)
{
    int block_index;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_feature_no_hit_bit_on_mdb_access_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_feature_pem_vt_init_fix_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_feature_iparser_signals_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_feature_fwd_action_signals_from_lbp_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_feature_esem_result_signals_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_kleap_fwd1_gen_data_size_set(
    int unit)
{
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_kleap_fwd2_gen_data_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_general_global_visibility_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
...
/**
 * \brief device level function which set define etpp_eop_and_sop_dec_above_threshold
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_general_etpp_eop_and_sop_dec_above_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
...
/**
 * \brief device level function which set define egress_port_mc_visibility
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_general_egress_port_mc_visibility_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
...
/**
 * \brief device level function which set define lbp_debug_signals_register_based
 * define info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_general_lbp_debug_signals_register_based_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
...
/**
 * \brief device level function which set numeric mem_array_index
 * numeric info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_general_mem_array_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
 ...
 */
/**
 * \brief device level function which set numeric extension_header
 * numeric info:
 ...
 */
static shr_error_e
j2x_a0_dnx_data_debug_nif_extension_header_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
    ...
    int unit)
{
    ...
    table->set = j2x_a0_dnx_data_debug_mem_params_set;
    /*
    ...
    feature->set = j2x_a0_dnx_data_debug_feature_no_hit_bit_on_mdb_access_set;
    data_index = dnx_data_debug_feature_pem_vt_init_fix;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_debug_feature_pem_vt_init_fix_set;
    data_index = dnx_data_debug_feature_iparser_signals_valid;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_debug_feature_iparser_signals_valid_set;
    data_index = dnx_data_debug_feature_fwd_action_signals_from_lbp_valid;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_debug_feature_fwd_action_signals_from_lbp_valid_set;
    data_index = dnx_data_debug_feature_esem_result_signals_valid;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_debug_feature_esem_result_signals_valid_set;
    ...
    define->set = j2x_a0_dnx_data_debug_kleap_fwd1_gen_data_size_set;
    data_index = dnx_data_debug_kleap_define_fwd2_gen_data_size;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_kleap_fwd2_gen_data_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_general_global_visibility_set;
    data_index = dnx_data_debug_general_define_etpp_eop_and_sop_dec_above_threshold;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_general_etpp_eop_and_sop_dec_above_threshold_set;
    data_index = dnx_data_debug_general_define_egress_port_mc_visibility;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_general_egress_port_mc_visibility_set;
    data_index = dnx_data_debug_general_define_lbp_debug_signals_register_based;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_general_lbp_debug_signals_register_based_set;
    data_index = dnx_data_debug_general_define_mem_array_index;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_general_mem_array_index_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_debug_nif_extension_header_set;
