...
/**
 * \brief device level function which set numeric intr_oamp_pending_event
 * numeric info:
...
/**
 * \brief device level function which set numeric intr_oamp_stat_pending_event
 * numeric info:
