 ...
 */
static shr_error_e
j2c_a0_dnx_data_crps_expansion_source_type_set(
    int unit)
{
    int source_index;
    ...
    {
        data = (dnx_data_crps_expansion_source_type_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceIngressTransmitPp, bcmStatExpansionTypeSystemMultiCast);
        data->offset = 11;
        data->nof_bits = 1;
    }
    ...
    {
        data = (dnx_data_crps_expansion_source_type_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceIngressVoq, bcmStatExpansionTypeTmLastCopy);
        data->offset = 9;
        data->nof_bits = 1;
    }
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_crps_expansion_source_type_set;
