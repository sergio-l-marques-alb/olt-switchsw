...
/**
 * \brief device level function which set define max_core_access_per_port
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_global_nof_nif_units_per_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = dnx_data_nif.eth.ethu_nof_per_core_get(unit) + dnx_data_nif.ilkn.ilkn_unit_nof_get(unit) + dnx_data_nif.flexe.feu_nof_get(unit);

    /* Set value */
    define->data = dnx_data_nif.eth.ethu_nof_per_core_get(unit) + dnx_data_nif.ilkn.ilkn_unit_nof_get(unit) + dnx_data_nif.flexe.feu_nof_get(unit);
    ...
    int unit)
{
    ...
    define->property.doc = 
        ...
        "By default the start TX threshold will be configured according to the port rate.\n"
        "The threshold value can be overriden by setting custom_feature_start_tx_threshold SoC property.\n"
        "custom_feature_start_tx_threshold sets the threshold value for all the ports in the device.\n"
        "\n"
    ;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_global_l1_only_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_phys_max_phys_in_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
/**
 * \brief device level function which set define is_pam4_speed_supported
 * define info:
    ...
    int unit)
{
    ...
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_nif_phys_nof_phys_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->nof_phys = 48;
        data->first_phy = 48;
    }
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_elk_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_ilkn_over_fabric_only_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_legacy_lane_format_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_nif_56G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_fabric_56G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_10p3G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_10p3G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_12p5G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_12p5G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_20p6G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_25p7G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_25p7G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_27p3G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_27p3G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_28p1G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_53p1G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_53p1G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_is_56p2G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_is_56p2G_speed_supported;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define nof_lanes_per_fec_unit
 * define info:
...
/**
 * \brief device level function which set define nof_rx_hrf_per_port
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_burst_max_range_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_burst_min_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_burst_short_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_burst_min_range_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
/**
 * \brief device level function which set numeric max_nof_ifs
 * numeric info:
...
/**
 * \brief device level function which set numeric max_nof_elk_ifs
 * numeric info:
...
/**
 * \brief device level function which set numeric link_stable_wait
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_link_stable_wait_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int define_index = dnx_data_nif_ilkn_define_link_stable_wait;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.method = dnxc_data_property_method_suffix_range;
    define->property.method_str = "suffix_range";
    define->property.suffix = "ilkn_link_stable_wait";
    define->property.range_min = 0;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_ilkn_interleaved_error_drop_single_context_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_10p3G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (1 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm4x25;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_12p5G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (2 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm4x25;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_20p6G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (3 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm4x25;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (4 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm4x25;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25p7G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (5 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm4x25;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_27p3G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (6 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm4x25;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_28p1G_speed_supported) && dnx_data_nif.eth.clu_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (7 < table->keys[0].size)
    {
    ...
    if (8 < table->keys[0].size)
    {
        ...
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_10p3G_speed_supported) && !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (9 < table->keys[0].size)
    {
    ...
    if (10 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_12p5G_speed_supported) && !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (11 < table->keys[0].size)
    {
    ...
    if (12 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_20p6G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    ...
    if (14 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    ...
    if (16 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25p7G_speed_supported) && !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    ...
    if (18 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_27p3G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    ...
    if (20 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_28p1G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (21 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.phys.is_pam4_speed_supported_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_53p1G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (22 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.phys.is_pam4_speed_supported_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_nif_56G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (23 < table->keys[0].size)
    {
        ...
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_10p3G_speed_supported);
    }
    if (24 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_10p3G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (25 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_12p5G_speed_supported);
    }
    if (26 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_12p5G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (27 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_20p6G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (28 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_20p6G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (29 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (30 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (31 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25p7G_speed_supported);
    }
    if (32 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25p7G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (33 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_27p3G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (34 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_27p3G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (35 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_28p1G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (36 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_28p1G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (37 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_53p1G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (38 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_fabric_56G_speed_supported) > 0 ? TRUE : FALSE;
    }
    ...
    int unit)
{
    ...
    table->values[1].default_val = "DATA(nif, ilkn, burst_short)";
    table->values[2].default_val = "DATA(nif, ilkn, burst_min)";
    ...
    default_data->burst_short = dnx_data_nif.ilkn.burst_short_get(unit);
    default_data->burst_min = dnx_data_nif.ilkn.burst_min_get(unit);
    ...
    table->values[0].property.range_max = dnx_data_nif.ilkn.burst_max_range_max_get(unit);
    /*
    ...
    table->values[1].property.range_min = dnx_data_nif.ilkn.burst_short_get(unit);
    ...
    table->values[2].property.range_min = dnx_data_nif.ilkn.burst_min_get(unit);
    table->values[2].property.range_max = dnx_data_nif.ilkn.burst_min_range_max_get(unit);
    /*
...
/**
 * \brief device level function which set values for table fabric_lanes_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_ilkn_fabric_lanes_map_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_nif_ilkn_table_fabric_lanes_map");
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_eth_pm8x50_clk_repeater_disable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int feature_index = dnx_data_nif_eth_pm8x50_clk_repeater_disable;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define nbu_nof
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_eth_nbu_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nbu_nof;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define total_nof_ethu_pms_in_device
 * define info:
...
/**
 * \brief device level function which set define nof_cdu_lanes_in_pm
 * define info:
...
/**
 * \brief device level function which set define nof_clu_lanes_in_pm
 * define info:
...
/**
 * \brief device level function which set define nof_cdu_pms
 * define info:
...
/**
 * \brief device level function which set define nof_clu_pms
 * define info:
...
/**
 * \brief device level function which set define ethu_nof
 * define info:
...
/**
 * \brief device level function which set define ethu_nof_per_core
 * define info:
...
/**
 * \brief device level function which set define clu_nof_per_core
 * define info:
...
/**
 * \brief device level function which set define nof_lanes_in_clu
 * define info:
...
/**
 * \brief device level function which set define max_nof_lanes_in_ethu
 * define info:
...
/**
 * \brief device level function which set define total_nof_cdu_lanes_in_device
 * define info:
...
/**
 * \brief device level function which set define cdu_mac_mode_config_nof
 * define info:
...
/**
 * \brief device level function which set define mac_mode_config_lanes_nof
 * define info:
...
/**
 * \brief device level function which set define ethu_logical_fifo_nof
 * define info:
...
/**
 * \brief device level function which set define is_400G_supported
 * define info:
...
/**
 * \brief device level function which set values for table supported_clu_an_abilities
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_eth_supported_clu_an_abilities_set(
    int unit)
{
    int idx_index;
    dnx_data_nif_eth_supported_clu_an_abilities_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int table_index = dnx_data_nif_eth_table_supported_clu_an_abilities;
    SHR_FUNC_INIT_VARS(unit);
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_supported_clu_an_abilities_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_nif_eth_table_supported_clu_an_abilities");

    /* Store Default Values */
    default_data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    for (idx_index = 0; idx_index < table->keys[0].size; idx_index++)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, idx_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    /*
     * Set Values - Entries
    ...
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    ...
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 10000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
    ...
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (18 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 18, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (19 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 19, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (20 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 20, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (21 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 21, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (22 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 22, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 40000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (23 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 23, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 40000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (24 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 24, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (25 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 25, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (26 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 26, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (27 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 27, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecRsFec;
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_prd_tcam_key_offset_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
/**
 * \brief device level function which set define ether_type_code_max
 * define info:
...
/**
 * \brief device level function which set define ether_type_max
 * define info:
...
/**
 * \brief device level function which set define hrf_threshold_max
 * define info:
...
/**
 * \brief device level function which set define mpls_special_label_max
 * define info:
...
/**
 * \brief device level function which set define flex_key_offset_key_max
 * define info:
...
/**
 * \brief device level function which set define flex_key_offset_result_max
 * define info:
...
/**
 * \brief device level function which set define tpid_max
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_prd_nof_ofr_port_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
/**
 * \brief device level function which set define rmc_fifo_2_threshold_resolution
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_prd_rmc_fifo_2_threshold_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_prd;
    int define_index = dnx_data_nif_prd_define_rmc_fifo_2_threshold_resolution;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set values for table port_profile_map
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_prd_port_profile_map_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_nif_prd_table_port_profile_map");
    ...
    {
        data = (dnx_data_nif_prd_port_profile_map_t *) dnxc_data_mgmt_table_data_get(unit, table, imbDispatchTypeImb_cdu_shr, 0);
        data->is_supported = TRUE;
        data->nof_profiles = dnx_data_nif.prd.nof_ofr_port_profiles_get(unit);
    }
 ...
 */
/**
 * \brief device level function which set define rate_per_ethu_bit
 * define info:
...
/**
 * \brief device level function which set define rate_per_ilu_bit
 * define info:
...
/**
 * \brief device level function which set define rate_per_cdu_rmc_bit
 * define info:
...
/**
 * \brief device level function which set define rate_per_clu_rmc_bit
 * define info:
...
/**
 * \brief device level function which set define nof_weight_bits
 * define info:
...
/**
 * \brief device level function which set define tx_credits_bits
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_nif_features_txpi_supported_in_pm8x50_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_global_nof_nif_units_per_core_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_global_l1_only_mode_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_phys_max_phys_in_core_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_phys_nof_phys_per_core_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_burst_max_range_max_set;
    data_index = dnx_data_nif_ilkn_define_burst_min;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_burst_min_set;
    data_index = dnx_data_nif_ilkn_define_burst_short;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_burst_short_set;
    data_index = dnx_data_nif_ilkn_define_burst_min_range_max;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_burst_min_range_max_set;
    ...
    data_index = dnx_data_nif_ilkn_define_link_stable_wait;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_link_stable_wait_set;
    data_index = dnx_data_nif_ilkn_define_interleaved_error_drop_single_context;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_ilkn_interleaved_error_drop_single_context_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_elk_supported_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_ilkn_over_fabric_only_set;
    data_index = dnx_data_nif_ilkn_legacy_lane_format;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_legacy_lane_format_set;
    data_index = dnx_data_nif_ilkn_is_nif_56G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_nif_56G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_fabric_56G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_fabric_56G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_10p3G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_10p3G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_12p5G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_12p5G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_20p6G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_20p6G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_25G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_25G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_25p7G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_25p7G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_27p3G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_27p3G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_28p1G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_28p1G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_53p1G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_53p1G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_56p2G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_ilkn_is_56p2G_speed_supported_set;
    ...
    data_index = dnx_data_nif_eth_define_nbu_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nbu_nof_set;
    ...
    data_index = dnx_data_nif_eth_pm8x50_clk_repeater_disable;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_eth_pm8x50_clk_repeater_disable_set;
    ...
    data_index = dnx_data_nif_eth_table_supported_clu_an_abilities;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_supported_clu_an_abilities_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_prd_tcam_key_offset_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_prd_nof_ofr_port_profiles_set;
    data_index = dnx_data_nif_prd_define_rmc_fifo_2_threshold_resolution;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_prd_rmc_fifo_2_threshold_resolution_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_features_txpi_supported_in_pm8x50_set;
