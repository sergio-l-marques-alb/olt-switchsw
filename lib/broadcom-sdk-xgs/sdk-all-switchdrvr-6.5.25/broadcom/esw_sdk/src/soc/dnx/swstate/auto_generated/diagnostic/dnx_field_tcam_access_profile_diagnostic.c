/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_tcam_access_profile_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_field_tcam_access_profile_sw
...
/*
 *
 * dump function for the variable access_profiles
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_field_tcam_access_profile_sw_access_profiles_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw_access_profiles_bank_ids_bmp_dump(unit, access_profiles_idx_0, -1, filters));
...
/*
 *
 * dump function for the variable occupied
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_key_length_type_e_get_name(((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].key_size));
...
dnx_field_tcam_access_profile_sw_access_profiles_action_size_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_action_length_type_e_get_name(((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].action_size));
...
/*
 *
 * dump function for the variable bank_ids_bmp
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_field_tcam_access_profile_sw_access_profiles_bank_ids_bmp_dump(int  unit,  int  access_profiles_idx_0,  int  bank_ids_bmp_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = access_profiles_idx_0, I0 = access_profiles_idx_0 + 1;
    int i1 = bank_ids_bmp_idx_0, I1 = bank_ids_bmp_idx_0 + 1, org_i1 = bank_ids_bmp_idx_0;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
        ...
        for(; i0 < I0; i0++) {
            ...
            if (i1 == -1) {
                ...
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp
                    , sizeof(*((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp), I1, &s1) ? I1 - 1 : 0;
            }

            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_profile_sw[]->((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[].bank_ids_bmp[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_field_tcam_access_profile_sw[%d]->","((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[%d][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->","access_profiles[%s%d].bank_ids_bmp[%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint16(
                    unit,
                    &((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp[i1]);
...
/*
 *
 * dump function for the variable is_direct
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
...
/*
 *
 * dump function for the variable handler_id
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
