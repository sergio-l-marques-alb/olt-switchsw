...
/**
 * \brief device level function which set define first_etpp_user_configurable_profile
 * define info:
...
/**
 * \brief device level function which set define nof_mtu_trap_action_profiles
 * define info:
...
/**
 * \brief device level function which set define nof_mtu_map_table_entries
 * define info:
