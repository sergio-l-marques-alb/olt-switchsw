 ...
 */
static shr_error_e
q2a_a0_dnx_data_lif_out_lif_global_lif_allocation_estimated_encap_size_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_lif_out_lif_global_lif_allocation_estimated_encap_size_enable_set;
