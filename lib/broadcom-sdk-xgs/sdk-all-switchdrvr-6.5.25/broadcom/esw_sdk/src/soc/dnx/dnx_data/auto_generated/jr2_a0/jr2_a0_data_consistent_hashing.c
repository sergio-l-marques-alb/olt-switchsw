/** \file jr2_a0_data_consistent_hashing.c
 * 
 * DEVICE DATA - CONSISTENT_HASHING
 * 
 * Device Data
 ...
 */
/**
 * \brief device level function which set define max_nof_entries_in_calendar
 * define info:
