 ...
 */
static shr_error_e
j2c_a0_dnx_data_pp_PEM_clock_power_down_set(
    int unit)
{
 ...
 */
static shr_error_e
j2c_a0_dnx_data_pp_PEM_nof_pem_bits_set(
    int unit)
{
 ...
 */
static shr_error_e
j2c_a0_dnx_data_pp_debug_packet_header_data_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pp;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_pp_debug_ptc_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pp;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_pp_debug_valid_bytes_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pp;
 ...
 */
static shr_error_e
j2c_a0_dnx_data_pp_debug_time_stamp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pp;
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_pp_PEM_nof_pem_bits_set;
    ...
    feature->set = j2c_a0_dnx_data_pp_PEM_clock_power_down_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_pp_debug_packet_header_data_set;
    data_index = dnx_data_pp_debug_define_ptc_size;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_pp_debug_ptc_size_set;
    data_index = dnx_data_pp_debug_define_valid_bytes;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_pp_debug_valid_bytes_set;
    data_index = dnx_data_pp_debug_define_time_stamp;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_pp_debug_time_stamp_set;
