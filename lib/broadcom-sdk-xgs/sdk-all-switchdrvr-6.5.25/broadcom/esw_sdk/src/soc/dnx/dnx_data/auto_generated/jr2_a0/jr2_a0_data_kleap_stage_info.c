/** \file jr2_a0_data_kleap_stage_info.c
 * 
 * DEVICE DATA - KLEAP_STAGE_INFO
 * 
 * Device Data
 ...
 */
/**
 * \brief device level function which set numeric nof_kleap_stages
 * numeric info:
 * 
 * \param [in] unit - Unit #
 * 
 ...
 */
/**
 * \brief device level function which set values for table info_per_stage
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_kleap_stage_info_kleap_stage_info_info_per_stage_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_kleap_stage_info_kleap_stage_info_table_info_per_stage");
...
/**
 * \brief device level function which set values for table info_per_stage_per_kbr
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_kleap_stage_info_kleap_stage_info_info_per_stage_per_kbr_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_kleap_stage_info_kleap_stage_info_table_info_per_stage_per_kbr");
...
/**
 * \brief device level function which set values for table info_per_stage_per_pd
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_kleap_stage_info_kleap_stage_info_info_per_stage_per_pd_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_kleap_stage_info_kleap_stage_info_table_info_per_stage_per_pd");
...
/**
 * \brief device level function which set values for table info_per_stage_per_sub_stage
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_kleap_stage_info_kleap_stage_info_info_per_stage_per_sub_stage_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_kleap_stage_info_kleap_stage_info_table_info_per_stage_per_sub_stage");
    ...
    int unit)
{
    ...
    /*
     * Attach submodule: kleap_stage_info
     */
