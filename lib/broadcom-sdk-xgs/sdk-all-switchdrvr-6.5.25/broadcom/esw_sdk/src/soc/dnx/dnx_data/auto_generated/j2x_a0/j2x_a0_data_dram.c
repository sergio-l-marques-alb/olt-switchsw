...
/**
 * \brief device level function which set values for table dll_and_qc_conf_vals_per_freq_range
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_dll_and_qc_conf_vals_per_freq_range_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range");
