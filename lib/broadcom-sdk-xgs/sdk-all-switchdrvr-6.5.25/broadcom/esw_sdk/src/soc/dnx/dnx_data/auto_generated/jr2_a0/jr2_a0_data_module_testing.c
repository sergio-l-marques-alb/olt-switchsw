 ...
 */
/**
 * \brief device level function which set define standard_define
 * define info:
...
/*{*/
/**
 * \brief device level function which set define define_family_dnx2
 * define info:
...
#endif /*BCM_DNX2_SUPPORT*/
/**
 * \brief device level function which set numeric standard_numeric
 * numeric info:
...
/*{*/
/**
 * \brief device level function which set numeric num_family_dnx2
 * numeric info:
...
/*{*/
/**
 * \brief device level function which set numeric num_property_family_dnx2
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table standard_table
 * Module - 'module_testing', Submodule - 'standard_submodule', table - 'standard_table'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_module_testing_standard_submodule_standard_table_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_module_testing_standard_submodule_table_standard_table");
...
/*{*/
/**
 * \brief device level function which set values for table table_family_dnx2
 * Module - 'module_testing', Submodule - 'standard_submodule', table - 'table_family_dnx2'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_module_testing_standard_submodule_table_family_dnx2_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_module_testing_standard_submodule_table_table_family_dnx2");
 ...
 */
/**
 * \brief device level function which set define dnx2_submodule_define
 * define info:
...
/**
 * \brief device level function which set numeric dnx2_submodule_numeric
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table dnx2_submodule_table
 * Module - 'module_testing', Submodule - 'submodule_family_dnx2', table - 'dnx2_submodule_table'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_module_testing_submodule_family_dnx2_dnx2_submodule_table_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_module_testing_submodule_family_dnx2_table_dnx2_submodule_table");
...
/*{*/
/**
 * \brief device level function which set define define_flags
 * define info:
...
/*{*/
/**
 * \brief device level function which set numeric numeric_flags
 * numeric info:
...
/*{*/
/**
 * \brief device level function which set values for table table_flags
 * Module - 'module_testing', Submodule - 'compileflags_submodule_standard', table - 'table_flags'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_module_testing_compileflags_submodule_standard_table_flags_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_module_testing_compileflags_submodule_standard_table_table_flags");
 ...
 */
/**
 * \brief device level function which set define define_no_flags
 * define info:
...
#endif /*BCM_WARM_BOOT_SUPPORT*/
/**
 * \brief device level function which set numeric numeric_no_flags
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table table_no_flags
 * Module - 'module_testing', Submodule - 'compileflags_submodule_flags', table - 'table_no_flags'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags");
...
/**
 * \brief device level function which set values for table table_flags
 * Module - 'module_testing', Submodule - 'compileflags_submodule_flags', table - 'table_flags'
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_module_testing_compileflags_submodule_flags_table_flags_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_module_testing_compileflags_submodule_flags_table_table_flags");
    ...
    int unit)
{
    ...
    /*
     * Attach submodule: standard_submodule
     */
...
/*{*/
    /*
     * Attach submodule: submodule_family_dnx2
     */
...
#endif /*BCM_DNX2_SUPPORT*/
    /*
     * Attach submodule: compileflags_submodule_standard
     */
...
/*{*/
    /*
     * Attach submodule: compileflags_submodule_flags
     */
