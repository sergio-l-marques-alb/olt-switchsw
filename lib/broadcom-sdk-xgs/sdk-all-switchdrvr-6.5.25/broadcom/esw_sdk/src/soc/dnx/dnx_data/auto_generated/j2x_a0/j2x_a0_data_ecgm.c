 ...
 */
static shr_error_e
j2x_a0_dnx_data_ecgm_port_resources_profile_management_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = j2x_a0_dnx_data_ecgm_port_resources_profile_management_set;
