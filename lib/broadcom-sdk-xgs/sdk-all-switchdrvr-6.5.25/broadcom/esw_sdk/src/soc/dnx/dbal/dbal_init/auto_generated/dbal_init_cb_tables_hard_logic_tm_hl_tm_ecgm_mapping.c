...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ECGM_QUEUE_OFFSET, key_value__ecgm_queue_offset);
    *offset = key_value__base_q_pair+key_value__ecgm_queue_offset;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_BASE_Q_PAIR, key_value__base_q_pair);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ECGM_QUEUE_OFFSET, key_value__ecgm_queue_offset);
    *offset = key_value__base_q_pair+key_value__ecgm_queue_offset-(dnx_data_egr_queuing.params.nof_q_pairs_get(unit)/2);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
