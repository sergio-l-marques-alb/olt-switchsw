...
/**
 * \brief device level function which set define vsi_outrif_offset
 * define info:
...
/**
 * \brief device level function which set define vsi_outrif_bits
 * define info:
...
/**
 * \brief device level function which set define data_type0_size
 * define info:
...
/**
 * \brief device level function which set define data_type1_size
 * define info:
...
/**
 * \brief device level function which set define data_type2_size
 * define info:
...
/**
 * \brief device level function which set define data_type3_size
 * define info:
 ...
 */
/**
 * \brief device level function which set numeric otmh_outlif_ext_mode
 * numeric info:
...
/**
 * \brief device level function which set numeric otmh_src_ext_enable
 * numeric info:
    ...
    int unit)
{
     ...
     */
    /*
     * Attach submodule: layer_records
     */
