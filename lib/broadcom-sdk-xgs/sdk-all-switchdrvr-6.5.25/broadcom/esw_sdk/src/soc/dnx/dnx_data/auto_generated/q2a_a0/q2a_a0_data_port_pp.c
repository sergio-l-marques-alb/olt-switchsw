 ...
 */
static shr_error_e
q2a_a0_dnx_data_port_pp_general_split_horizon_per_port_outlif_profile_support_set(
    int unit)
{
 ...
 */
static shr_error_e
q2a_a0_dnx_data_port_pp_general_sit_inner_eth_additional_tag_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_port_pp_general_sit_inner_eth_additional_tag_set;
    ...
    feature->set = q2a_a0_dnx_data_port_pp_general_split_horizon_per_port_outlif_profile_support_set;
