...
/**
 * \brief device level function which set values for table cable_swap_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_port_static_add_cable_swap_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_port_static_add_table_cable_swap_info");
...
/**
 * \brief device level function which set values for table flr_config
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_port_static_add_flr_config_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_port_static_add_table_flr_config");
...
/**
 * \brief device level function which set values for table timestamp_phy_init
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_port_static_add_timestamp_phy_init_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_port_static_add_table_timestamp_phy_init");
    ...
    /*
     * Value Property - timestamp_enable
     */
    ...
    table->values[0].property.method_str = "port_enable";
    /*
     * Value Property - one_step_enable
     */
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_general_is_nrz_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_port;
    int submodule_index = dnx_data_port_submodule_general;
    int feature_index = dnx_data_port_general_is_nrz_supported;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define prt_ibch1_explicit_offset_en
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_general_prt_ibch1_explicit_offset_en_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
    int submodule_index = dnx_data_port_submodule_general;
    int define_index = dnx_data_port_general_define_prt_ibch1_explicit_offset_en;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set numeric nof_in_tm_ports
 * numeric info:
...
/**
 * \brief device level function which set numeric prt_configuration_ptch2_ibch1_default_index
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_general_prt_configuration_ptch2_ibch1_default_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
    int submodule_index = dnx_data_port_submodule_general;
    int define_index = dnx_data_port_general_define_prt_configuration_ptch2_ibch1_default_index;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set numeric prt_configuration_ptch1_ibch1_default_index
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_general_prt_configuration_ptch1_ibch1_default_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
    int submodule_index = dnx_data_port_submodule_general;
    int define_index = dnx_data_port_general_define_prt_configuration_ptch1_ibch1_default_index;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set numeric prt_configuration_eth_ibch1_default_index
 * numeric info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_port_general_prt_configuration_eth_ibch1_default_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
    int submodule_index = dnx_data_port_submodule_general;
    int define_index = dnx_data_port_general_define_prt_configuration_eth_ibch1_default_index;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_port_general_define_prt_ibch1_explicit_offset_en;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_general_prt_ibch1_explicit_offset_en_set;
    ...
    data_index = dnx_data_port_general_define_prt_configuration_ptch2_ibch1_default_index;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_general_prt_configuration_ptch2_ibch1_default_index_set;
    data_index = dnx_data_port_general_define_prt_configuration_ptch1_ibch1_default_index;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_general_prt_configuration_ptch1_ibch1_default_index_set;
    data_index = dnx_data_port_general_define_prt_configuration_eth_ibch1_default_index;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_general_prt_configuration_eth_ibch1_default_index_set;
    ...
    data_index = dnx_data_port_general_is_nrz_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_port_general_is_nrz_supported_set;
