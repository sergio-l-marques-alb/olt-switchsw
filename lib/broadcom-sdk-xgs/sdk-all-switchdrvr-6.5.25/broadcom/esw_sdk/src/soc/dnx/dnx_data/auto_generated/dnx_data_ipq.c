...
#ifdef BCM_DNX2_SUPPORT
/*{*/
extern shr_error_e j2x_a0_data_ipq_attach(
    int unit);
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ipq_queues_invalid_queue_support].name = "invalid_queue_support";
    submodule_data->features[dnx_data_ipq_queues_invalid_queue_support].doc = "indicate if invalid queue is supported";
    submodule_data->features[dnx_data_ipq_queues_invalid_queue_support].flags |= DNXC_DATA_F_FEATURE;
...
/*{*/
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_ipq_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_ipq_attach(unit));
    }
    else
/*}*/
#endif /*BCM_DNX2_SUPPORT*/
