    ...
    int unit)
{
    ...
    if (SOC_IS_DNX(unit))
    {
        ...
        /*
         * Enable KAPs TCAM ECC protect scan
         */
    ...
    int enable)
{
    ...
    /*
     * Retrieve the first TCAM scan cfg register only as a template, when writing iterate on all registers 
     */
    ...
    {
        /*
         * set kaps tcam scan cfg value
         */
        kaps_tcam_scan = dnx_data_intr.ser.kaps_tcam_scan_get(unit);

        /*
         * scan machine pause
         * do not pause for correctable TCAM entries
         */
        ...
        /*
         * scan action: invalidate for uncorrectable; correct for correctable
         */
        ...
        /*
         * Set the on and paused values in swstate for quick enable/disable during runtime
         */
    ...
    {
        /*
         * Retrieve the kaps tcam scan cfg value from swstate
         */
        if (enable == TRUE)
        {
    ...
    /*
     * Every KAPS pair has its own separate TCAM scan cfg register 
     */
    for (kaps_pair_iter = 0; kaps_pair_iter < kaps_pair_num; kaps_pair_iter++)
    {
        ...
        /*
         * write the cfg value to register
         */
...
/**
 * \brief
 *  Update the memory severity which was marked wrongly by ASIC
 *
 * \param [in] unit - unit
 *
 * \return
