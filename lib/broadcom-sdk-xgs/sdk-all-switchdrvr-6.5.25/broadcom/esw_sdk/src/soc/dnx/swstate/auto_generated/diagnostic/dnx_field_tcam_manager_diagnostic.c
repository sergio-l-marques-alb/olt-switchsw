/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_tcam_manager_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_field_tcam_manager_sw
...
/*
 *
 * dump function for the variable tcam_handlers
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_tcam_handler_mode_e_get_name(((dnx_field_tcam_manager_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_MANAGER_MODULE_ID])->tcam_handlers[i0].mode));
...
dnx_field_tcam_manager_sw_tcam_handlers_state_dump(int  unit,  int  tcam_handlers_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_tcam_handler_state_e_get_name(((dnx_field_tcam_manager_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_MANAGER_MODULE_ID])->tcam_handlers[i0].state));
