...
/**
 * \brief device level function which set numeric swap_core_index_zero_with_core_index
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table clear_on_read_mems
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_adapter_reg_mem_access_clear_on_read_mems_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_adapter_reg_mem_access_table_clear_on_read_mems");
...
/**
 * \brief device level function which set values for table clear_on_read_regs
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_adapter_reg_mem_access_clear_on_read_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_adapter_reg_mem_access_table_clear_on_read_regs");
