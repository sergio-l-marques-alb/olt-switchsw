    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_port_pp_general_split_horizon_per_port_outlif_profile_support].doc = "Indicate if split horizon per port outlif profile is supported";
    ...
    submodule_data->features[dnx_data_port_pp_general_prt_tcam_is_direct_access].doc = "Indicates if prt tcam is working in direct access";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "port pp filters";
    /*
     * Features
     */
    ...
    submodule_data->features[dnx_data_port_pp_filters_acceptable_frame_type_filter_support].doc = "Indicate if acceptable frame type filter per pp port is supported";
    ...
    submodule_data->features[dnx_data_port_pp_filters_dss_stacking_filter_support].doc = "Indicate if dss stacking filter per pp port is supported";
    ...
    submodule_data->features[dnx_data_port_pp_filters_lag_egress_multicast_filter_support].doc = "Indicate if LAG Egress multicast filtering per pp port is supported";
    ...
    submodule_data->features[dnx_data_port_pp_filters_exclude_source_filter_support].doc = "Indicate if exclude source filter per pp port is supported";
    ...
    submodule_data->features[dnx_data_port_pp_filters_ipv6_hop_by_hop_filter_support].doc = "Indicate if IPv6 hop by hop filter per pp port is supported";
    ...
    submodule_data->features[dnx_data_port_pp_filters_glem_filter_support].doc = "Indicate if GLEM filter per pp port is supported";
    ...
    submodule_data->features[dnx_data_port_pp_filters_rqp_discard_and_invalid_otm_filters_support].doc = "Indicate if RQP discard and Invalid OTM filters per PP DSP are supported";
