    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_mpls_general_evpn_no_tpid_supported].name = "evpn_no_tpid_supported";
    submodule_data->features[dnx_data_mpls_general_evpn_no_tpid_supported].doc = "Indicates if EVPN supports BCM_MPLS_EGRESS_LABEL_FLAGS2_NO_TPID_CLASS flag";
    submodule_data->features[dnx_data_mpls_general_evpn_no_tpid_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_mpls_general_mpls_egress_pointed_supported].name = "mpls_egress_pointed_supported";
    submodule_data->features[dnx_data_mpls_general_mpls_egress_pointed_supported].doc = "Indicates if EVPN supports BCM_MPLS_EGRESS_LABEL_VIRTUAL_EGRESS_POINTED flag";
    submodule_data->features[dnx_data_mpls_general_mpls_egress_pointed_supported].flags |= DNXC_DATA_F_FEATURE;
