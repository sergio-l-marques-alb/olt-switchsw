...
__portmod__dispatch__t__ portmod_pm8x100_gen2_driver = {

    NULL, /* portmod_port_speed_ability_local_get */
    NULL, /* portmod_pm_interface_type_is_supported */
    NULL, /* portmod_pm_init */
    NULL, /* portmod_pm_destroy */
    pm8x100_gen2_port_attach,
    ...
    NULL, /* portmod_port_detach */
    NULL, /* portmod_port_callback_unregister */
    NULL, /* portmod_port_replace */
    NULL, /* portmod_port_enable_set */
    NULL, /* portmod_port_enable_get */
    ...
    NULL, /* portmod_port_loopback_set */
    NULL, /* portmod_port_loopback_get */
    ...
    NULL, /* portmod_port_core_access_get */
    NULL, /* portmod_port_phy_lane_access_get */
    NULL, /* portmod_pm_phy_lane_access_get */
    NULL, /* portmod_port_duplex_set */
    ...
    NULL, /* portmod_port_faults_status_get */
