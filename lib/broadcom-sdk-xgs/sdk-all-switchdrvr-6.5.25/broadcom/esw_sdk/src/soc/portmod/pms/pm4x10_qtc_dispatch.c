...
__portmod__dispatch__t__ portmod_pm4x10_qtc_driver = {

    NULL, /* portmod_port_speed_ability_local_get */
    pm4x10_qtc_pm_interface_type_is_supported,
    pm4x10_qtc_pm_init,
    pm4x10_qtc_pm_destroy,
    pm4x10_qtc_port_attach,
    NULL, /* portmod_default_bus_update */
    pm4x10_qtc_pm_bypass_set,
    pm4x10_qtc_pm_core_info_get,
    NULL, /* portmod_pm_aggregated_update */
    pm4x10_qtc_pm_phys_get,
    pm4x10_qtc_port_detach,
    NULL, /* portmod_port_callback_unregister */
    pm4x10_qtc_port_replace,
    pm4x10_qtc_port_enable_set,
    pm4x10_qtc_port_enable_get,
    NULL, /* portmod_port_cdr_lock_get */
    NULL, /* portmod_port_electrical_idle_enable_set */
    pm4x10_qtc_port_interface_config_set,
    pm4x10_qtc_port_interface_config_get,
    pm4x10_qtc_port_default_interface_get,
    pm4x10_qtc_port_interface_check,
    NULL, /* portmod_port_encoding_set */
    NULL, /* portmod_port_encoding_get */
    pm4x10_qtc_port_cl72_set,
    pm4x10_qtc_port_cl72_get,
    pm4x10_qtc_port_cl72_status_get,
    pm4x10_qtc_port_loopback_set,
    pm4x10_qtc_port_loopback_get,
    ...
    pm4x10_qtc_port_rx_mac_enable_set,
    pm4x10_qtc_port_rx_mac_enable_get,
    pm4x10_qtc_port_tx_mac_enable_set,
    pm4x10_qtc_port_tx_mac_enable_get,
    pm4x10_qtc_port_ability_local_get,
    pm4x10_qtc_port_autoneg_set,
    pm4x10_qtc_port_autoneg_get,
    pm4x10_qtc_port_autoneg_status_get,
    pm4x10_qtc_port_link_get,
    pm4x10_qtc_port_link_latch_down_get,
    pm4x10_qtc_port_phy_link_up_event,
    pm4x10_qtc_port_phy_link_down_event,
    pm4x10_qtc_port_prbs_config_set,
    pm4x10_qtc_port_prbs_config_get,
    pm4x10_qtc_port_prbs_enable_set,
    pm4x10_qtc_port_prbs_enable_get,
    pm4x10_qtc_port_prbs_status_get,
    pm4x10_qtc_port_nof_lanes_get,
    ...
    pm4x10_qtc_port_firmware_mode_set,
    pm4x10_qtc_port_firmware_mode_get,
    pm4x10_qtc_port_runt_threshold_set,
    pm4x10_qtc_port_runt_threshold_get,
    NULL, /* portmod_port_tx_threshold_set */
    NULL, /* portmod_port_tx_threshold_get */
    pm4x10_qtc_port_max_packet_size_set,
    pm4x10_qtc_port_max_packet_size_get,
    pm4x10_qtc_port_pad_size_set,
    pm4x10_qtc_port_pad_size_get,
    pm4x10_qtc_port_tx_mac_sa_set,
    pm4x10_qtc_port_tx_mac_sa_get,
    pm4x10_qtc_port_rx_mac_sa_set,
    pm4x10_qtc_port_rx_mac_sa_get,
    pm4x10_qtc_port_tx_average_ipg_set,
    pm4x10_qtc_port_tx_average_ipg_get,
    NULL, /* portmod_port_tx_preamble_length_set */
    NULL, /* portmod_port_tx_preamble_length_get */
    pm4x10_qtc_port_local_fault_control_set,
    pm4x10_qtc_port_local_fault_control_get,
    pm4x10_qtc_port_remote_fault_control_set,
    pm4x10_qtc_port_remote_fault_control_get,
    pm4x10_qtc_port_local_fault_status_get,
    pm4x10_qtc_port_remote_fault_status_get,
    pm4x10_qtc_port_local_fault_status_clear,
    pm4x10_qtc_port_remote_fault_status_clear,
    NULL, /* portmod_port_local_fault_reasons_get */
    pm4x10_qtc_port_pause_control_set,
    pm4x10_qtc_port_pause_control_get,
    pm4x10_qtc_port_pfc_control_set,
    pm4x10_qtc_port_pfc_control_get,
    pm4x10_qtc_port_llfc_control_set,
    pm4x10_qtc_port_llfc_control_get,
    pm4x10_qtc_port_update,
    pm4x10_qtc_port_core_access_get,
    pm4x10_qtc_port_phy_lane_access_get,
    NULL, /* portmod_pm_phy_lane_access_get */
    pm4x10_qtc_port_duplex_set,
    pm4x10_qtc_port_duplex_get,
    pm4x10_qtc_port_phy_reg_read,
    pm4x10_qtc_port_phy_reg_write,
    pm4x10_qtc_port_reset_set,
    pm4x10_qtc_port_reset_get,
    pm4x10_qtc_port_adv_remote_get,
    NULL, /* portmod_port_drv_name */
    pm4x10_qtc_port_drv_name_get,
    NULL, /* portmod_port_fec_enable_set */
    NULL, /* portmod_port_fec_enable_get */
    pm4x10_qtc_port_ability_advert_set,
    pm4x10_qtc_port_ability_advert_get,
    pm4x10_qtc_port_ability_remote_get,
    pm4x10_qtc_port_frame_spacing_stretch_set,
    pm4x10_qtc_port_frame_spacing_stretch_get,
    pm4x10_qtc_port_diag_fifo_status_get,
    pm4x10_qtc_port_rx_control_set,
    pm4x10_qtc_port_rx_control_get,
    pm4x10_qtc_port_pfc_config_set,
    pm4x10_qtc_port_pfc_config_get,
    pm4x10_qtc_port_eee_set,
    pm4x10_qtc_port_eee_get,
    pm4x10_qtc_port_eee_clock_set,
    pm4x10_qtc_port_eee_clock_get,
    pm4x10_qtc_port_vlan_tag_set,
    pm4x10_qtc_port_vlan_tag_get,
    pm4x10_qtc_port_modid_set,
    NULL, /* portmod_port_led_chain_config */
    pm4x10_qtc_port_clear_rx_lss_status_set,
    pm4x10_qtc_port_clear_rx_lss_status_get,
    pm4x10_qtc_xphy_lane_attach_to_pm,
    pm4x10_qtc_xphy_lane_detach_from_pm,
    NULL, /* portmod_ext_phy_lane_attach_to_pm */
    NULL, /* portmod_ext_phy_lane_detach_from_pm */
    pm4x10_qtc_port_lag_failover_status_toggle,
    pm4x10_qtc_port_lag_failover_loopback_set,
    pm4x10_qtc_port_lag_failover_loopback_get,
    pm4x10_qtc_port_mode_set,
    pm4x10_qtc_port_mode_get,
    pm4x10_qtc_port_encap_set,
    pm4x10_qtc_port_encap_get,
    pm4x10_qtc_port_higig_mode_set,
    pm4x10_qtc_port_higig_mode_get,
    pm4x10_qtc_port_higig2_mode_set,
    pm4x10_qtc_port_higig2_mode_get,
    pm4x10_qtc_port_config_port_type_set,
    pm4x10_qtc_port_config_port_type_get,
    pm4x10_qtc_port_trunk_hwfailover_config_set,
    pm4x10_qtc_port_trunk_hwfailover_config_get,
    pm4x10_qtc_port_trunk_hwfailover_status_get,
    pm4x10_qtc_port_diag_ctrl,
    pm4x10_qtc_port_ref_clk_get,
    pm4x10_qtc_port_lag_failover_disable,
    pm4x10_qtc_port_lag_remove_failover_lpbk_set,
    pm4x10_qtc_port_lag_remove_failover_lpbk_get,
    pm4x10_qtc_port_cntmaxsize_set,
    pm4x10_qtc_port_cntmaxsize_get,
    pm4x10_qtc_port_multi_get,
    pm4x10_qtc_port_drain_cell_get,
    pm4x10_qtc_port_drain_cell_stop,
    pm4x10_qtc_port_drain_cell_start,
    pm4x10_qtc_port_drain_cells_rx_enable,
    pm4x10_qtc_port_egress_queue_drain_rx_en,
    pm4x10_qtc_port_mac_ctrl_set,
    pm4x10_qtc_port_txfifo_cell_cnt_get,
    pm4x10_qtc_port_egress_queue_drain_get,
    pm4x10_qtc_port_mac_reset_set,
    pm4x10_qtc_port_mac_reset_get,
    pm4x10_qtc_port_soft_reset_toggle,
    NULL, /* portmod_port_soft_reset */
    pm4x10_qtc_port_mac_reset_check,
    pm4x10_qtc_port_core_num_get,
    pm4x10_qtc_port_e2ecc_hdr_set,
    pm4x10_qtc_port_e2ecc_hdr_get,
    pm4x10_qtc_port_e2e_enable_set,
    pm4x10_qtc_port_e2e_enable_get,
    pm4x10_qtc_port_fallback_lane_get,
    pm4x10_qtc_port_speed_get,
    NULL, /* portmod_pm_tsc_refclock_set */
    NULL, /* portmod_pm_tsc_refclock_get */
    pm4x10_qtc_port_discard_set,
    pm4x10_qtc_port_soft_reset_set,
    pm4x10_qtc_port_tx_down,
    NULL, /* portmod_port_logical_lane_order_set */
    NULL, /* portmod_port_logical_lane_order_get */
    pm4x10_qtc_port_pgw_reconfig,
    pm4x10_qtc_port_notify,
    pm4x10_qtc_port_control_phy_timesync_set,
    pm4x10_qtc_port_control_phy_timesync_get,
    pm4x10_qtc_port_timesync_config_set,
    pm4x10_qtc_port_timesync_config_get,
    pm4x10_qtc_port_timesync_enable_set,
    pm4x10_qtc_port_timesync_enable_get,
    pm4x10_qtc_port_timesync_nco_addend_set,
    pm4x10_qtc_port_timesync_nco_addend_get,
    pm4x10_qtc_port_timesync_framesync_mode_set,
    pm4x10_qtc_port_timesync_framesync_mode_get,
    pm4x10_qtc_port_timesync_local_time_set,
    pm4x10_qtc_port_timesync_local_time_get,
    pm4x10_qtc_port_timesync_load_ctrl_set,
    pm4x10_qtc_port_timesync_load_ctrl_get,
    pm4x10_qtc_port_timesync_tx_timestamp_offset_set,
    pm4x10_qtc_port_timesync_tx_timestamp_offset_get,
    pm4x10_qtc_port_timesync_rx_timestamp_offset_set,
    pm4x10_qtc_port_timesync_rx_timestamp_offset_get,
    NULL, /* portmod_port_timestamp_adjust_set */
    NULL, /* portmod_port_timestamp_adjust_get */
    pm4x10_qtc_port_phy_intr_enable_set,
    pm4x10_qtc_port_phy_intr_enable_get,
    pm4x10_qtc_port_phy_intr_status_get,
    pm4x10_qtc_port_phy_intr_status_clear,
    pm4x10_qtc_port_phy_timesync_do_sync,
    pm4x10_qtc_port_timesync_capture_timestamp_get,
    pm4x10_qtc_port_timesync_heartbeat_timestamp_get,
    pm4x10_qtc_port_edc_config_set,
    pm4x10_qtc_port_edc_config_get,
    pm4x10_qtc_port_interrupt_enable_set,
    pm4x10_qtc_port_interrupt_enable_get,
    pm4x10_qtc_port_interrupt_get,
    pm4x10_qtc_port_interrupts_get,
    pm4x10_qtc_port_check_legacy_phy,
    pm4x10_qtc_port_failover_mode_set,
    pm4x10_qtc_port_failover_mode_get,
    pm4x10_qtc_port_mac_rsv_mask_set,
    pm4x10_qtc_port_mib_reset_toggle,
    pm4x10_qtc_port_warmboot_db_restore,
    pm4x10_qtc_port_flow_control_set,
    pm4x10_qtc_port_update_dynamic_state,
    pm4x10_qtc_port_phy_op_mode_get,
    pm4x10_qtc_port_lane_map_set,
    pm4x10_qtc_port_lane_map_get,
    pm4x10_qtc_port_polarity_set,
    pm4x10_qtc_port_polarity_get,
    pm4x10_qtc_port_medium_config_set,
    pm4x10_qtc_port_medium_config_get,
    pm4x10_qtc_port_medium_get,
    pm4x10_qtc_pm_is_in_pm12x10,
    NULL, /* portmod_slow_read_rate_set */
    pm4x10_qtc_port_pll_div_get,
    pm4x10_qtc_port_master_set,
    pm4x10_qtc_port_master_get,
    pm4x10_qtc_preemption_control_set,
    pm4x10_qtc_preemption_control_get,
    pm4x10_qtc_preemption_tx_status_get,
    pm4x10_qtc_preemption_verify_status_get,
    NULL, /* portmod_preemption_force_rx_eop_mode_set */
    NULL, /* portmod_preemption_force_rx_eop_mode_get */
    pm4x10_qtc_preemption_rx_timeout_set,
    pm4x10_qtc_preemption_rx_timeout_get,
    pm4x10_qtc_port_lane_count_get,
    pm4x10_qtc_port_timesync_tx_info_get,
    pm4x10_qtc_port_lane_mask_get,
    ...
    pm4x10_qtc_port_mac_timestamp_enable_set,
    pm4x10_qtc_port_mac_timestamp_enable_get,
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
    pm4x10_qtc_port_txpi_override_set,
    pm4x10_qtc_port_txpi_override_get,
    pm4x10_qtc_port_txpi_sdm_data_get,
    ...
    pm4x10_qtc_port_synce_clk_ctrl_set,
    pm4x10_qtc_port_synce_clk_ctrl_get,
#ifdef CPRIMOD_SUPPORT
    ...
    pm4x10_qtc_port_pcs_fsm_check,
    NULL, /* portmod_port_txpi_rxcdr_clk_get */
    pm4x10_qtc_egr_1588_timestamp_config_set,
    pm4x10_qtc_egr_1588_timestamp_config_get,
#ifdef CPRIMOD_SUPPORT
    ...
    pm4x10_qtc_port_fec_error_inject_set,
    pm4x10_qtc_port_fec_error_inject_get,
#ifdef CPRIMOD_SUPPORT
    ...
    pm4x10_qtc_port_faults_status_get,
    NULL, /* portmod_port_flr_config_set */
    NULL, /* portmod_port_flr_config_get */
    NULL, /* portmod_port_pmd_rx_lock_status_get */
    NULL, /* portmod_port_link_recovery_enable_set */
    NULL, /* portmod_port_link_recovery_enable_get */
    NULL, /* portmod_fec_degraded_ser_set */
    NULL, /* portmod_fec_degraded_ser_get */
    NULL, /* portmod_fec_degraded_ser_status_get */
};
