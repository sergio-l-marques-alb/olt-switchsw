    ...
    SW_STATE_HASH_TABLE_KEY * const key)
{
    ...
    {
        /*
         * Copy 'ptr_size' bits from 'hash_table->next + ptr_size * entry_offset' buffer into
    ...
    /*
     * Copy 'ptr_size' bits from 'null_ptr' (tmp_buf buffer) into 'hash_table->next'
    ...
    uint8 *first)
{
    ...
    *prev_entry = hash_val;
    ...
    /*
     * Copy 'ptr_size' bits from 'hash_table->lists_head' buffer at offset     * 'hash_val * ptr_size' into 'ptr_long' buffer.
     */
    *ptr_long = 0;
    ...
    if (*ptr_long == null_ptr)
    {
        if (get_first_empty)
        {
            ...
            else
            {
                ...
                /*
                 * Copy 'ptr_size' bits from 'ptr_long' buffer into 'SW_STATE_HASH_TABLE_ACCESS_DATA.lists_head'
    ...
    while (*ptr_long != null_ptr)
    {
         ...
         * '*ptr_long * key_size' into 'tmp_shr_bitdcl_buf' buffer.
         */
        ...
        *first = FALSE;
         ...
         */
        /*
         * Copy 'ptr_size' bits from 'hash_table->next' buffer at offset
         * '*ptr_long * ptr_size' into 'tmp_shr_bitdcl_buf' buffer.
         */
        sal_memset(tmp_shr_bitdcl_buf, 0, tmp_buf_size);
    ...
    *found = FALSE;
    if (get_first_empty)
    {
        ...
        else
        {
            ...
            /*
             * Copy 'ptr_size' bits from 'tmp_shr_bitdcl_buf' buffer into 'hash_table->next'
    ...
    sw_state_htbl_t hash_table)
{
    ...
    {
        /*
         * Copy 'ptr_size' bits from 'hash_table->lists_head' buffer at offset
         * 'indx * ptr_size' into 'ptr_long'.
         */
        *ptr_long = 0;
        ...
        while (*ptr_long != null_ptr)
        {
            ...
            /*
             * Copy 'ptr_size' bits from 'hash_table->next' buffer at offset
             * 'ptr_long * ptr_size' into 'ptr_long' buffer.
             */
            ptr_long_tmp[0] = 0;
    ...
    uint32 *num_active_ptr)
{
    ...
    {
        /*
         * Copy 'ptr_size' bits from 'SW_STATE_HASH_TABLE_ACCESS_DATA.lists_head' buffer at offset
        ...
        while (*tmp_buf_ptr != null_ptr)
        {
             ...
             */
            /*
             * Copy 'ptr_size' bits from 'SW_STATE_HASH_TABLE_ACCESS_DATA.next' buffer at offset
