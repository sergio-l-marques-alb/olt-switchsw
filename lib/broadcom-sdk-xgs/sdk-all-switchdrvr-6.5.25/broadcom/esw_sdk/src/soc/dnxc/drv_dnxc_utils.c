...
#endif /* BCM_DNX_SUPPORT */
/*
 * Wrapper procedures for soc_flags_get and soc_flags_set.
 * Added for files that do not include drv.h
 * {
 */
/*
...
/**
 * \brief
 *   Save MRs before calling soc_dnx_soft_init, and restore them after
 *   the call.
 *   Serves as common function for dnx_drv_soc_dnx_soft_init and
