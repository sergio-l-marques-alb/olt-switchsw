    ...
    int unit)
{
    ...
    /** release after interrupt handler deinit, make sure no interrupt event handling */
    ...
    int unit)
{
    ...
    /** allocate space for active interrupts */
    ...
    /*
     * disable devices interrupt (even in WB mode).
     */
    ...
    /*
     * unmask all interrupts in cmic (even in WB mode).
     */
...
* Purpose:
*      Get if Enable/Disable interrupts at top level
* Parameters:
*      unit                  - (IN)  Device number
...
/*
* Function:
*      soc_dnxc_interrupt_event_start
* Purpose:
*      start an INTR EVENT thread
* Parameters:
*      unit                    - (IN)  Device number
*
* Returns:
    ...
    int unit)
{
    ...
    interrupt_event_config_info.thread_priority = 50; /** TO BE DO, change to soc properity */
    ...
    int unit)
{
    ...
    {
        /*
         * SHR_IF_ERR_EXIT(flow_control_db.pfc_deadlock_recovery.event_handle.get(unit, &interrupt_event_handler));
         */
...
* Purpose:
*      trigger INTR_EVT thread an event to handle
* Parameters:
*      unit                    - (IN)  Device number
*      data                   - (IN)  User data
*
...
* Purpose:
*       Clear all interrupts and counter/error
* Parameters:
*       unit                    - (IN)  Device number
*
* Returns:
    ...
    int unit)
{
    ...
    for (reg = 0; reg < NUM_SOC_REG; reg++)
    {
        ...
        /*
         * clear this counter in all blocks
         */
