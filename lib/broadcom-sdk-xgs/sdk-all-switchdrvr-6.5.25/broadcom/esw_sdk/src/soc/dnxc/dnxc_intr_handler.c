    ...
    void *userdata)
{
    ...
    {
         /** mask interrupt which marked as force mask flag or storm interrupt */
...
exit:
    ...
    /*
     * In case of failure _func_rv can't be _SHR_E_NONE, and hence, after the check of SOC_FAILURE(_func_rv) the
    ...
    uint32 *data_entry)
{
    ...
    {
        /*
         * for dnx device, some array memory index not started with 0
         */
