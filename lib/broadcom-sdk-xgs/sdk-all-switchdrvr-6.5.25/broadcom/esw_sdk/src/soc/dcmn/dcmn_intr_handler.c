...
/* handle EDB.EsemInterruptOne.EsemErrorTableCoherency interrupt, perform Hard Reset and log counter */
...
/* handle EDB.GlemInterruptOne.GlemErrorTableCoherency interrupt, perform Hard Reset and log counter */
