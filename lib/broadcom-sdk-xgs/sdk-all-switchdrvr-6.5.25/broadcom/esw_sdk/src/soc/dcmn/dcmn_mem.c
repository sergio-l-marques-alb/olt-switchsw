                           ...
                           unsigned operation) /* operation should be 1 for read and 0 for write */
{
    ...
    uint32
        /*
         * We set here a dimension of '2', rather than '1', just because, otherwise,
         * Coverity complains (later on when invoking dcmn_reg_access_with_block())
         * that there is no space for the case of 64 bits registers.
         * Actually, one element of 32 bits is sufficient here.
         */
        data32[2],
        address,
        indirect_size,
