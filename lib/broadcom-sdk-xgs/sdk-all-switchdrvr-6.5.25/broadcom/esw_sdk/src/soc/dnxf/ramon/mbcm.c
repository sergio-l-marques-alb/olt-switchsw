...
mbcm_dnxf_functions_t mbcm_ramon_driver = {
    ...
    NULL,       /* mbcm_dnxf_fabric_links_llfc_type_set */
    NULL,       /* mbcm_dnxf_fabric_links_llfc_type_get */
    ...
    NULL,       /* mbcm_dnxf_drv_block_valid_get */
    ...
    soc_ramon_init_link_mapping,        /* mbcm_dnxf_init_link_mapping */
    NULL,       /* mbcm_dnxf_port_cable_swap_set */
    NULL,       /* mbcm_dnxf_fabric_link_cell_format_set */
    NULL,       /* mbcm_dnxf_fabric_link_cell_format_get */
    NULL,       /* mbcm_dnxf_fabric_links_source_map_indication_set */
    NULL,       /* mbcm_dnxf_fabric_links_source_map_indication_get */
    soc_ramon_drv_supported_lanes_get,  /* mbcm_dnxf_drv_supported_lanes_get */
    NULL        /* mbcm_dnxf_fabric_links_fmac_symb_error_get */
};
