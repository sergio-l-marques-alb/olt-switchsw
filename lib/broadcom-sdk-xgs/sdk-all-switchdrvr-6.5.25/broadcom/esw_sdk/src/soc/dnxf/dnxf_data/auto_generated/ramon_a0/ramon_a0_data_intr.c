    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_skip_clear_on_regress_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_intr_general_table_skip_clear_on_regress");
