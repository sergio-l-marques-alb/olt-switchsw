    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_supported_interfaces_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_general_table_supported_interfaces");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_default_fec_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_general_table_default_fec");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_supported_fec_controls_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_general_table_supported_fec_controls");
