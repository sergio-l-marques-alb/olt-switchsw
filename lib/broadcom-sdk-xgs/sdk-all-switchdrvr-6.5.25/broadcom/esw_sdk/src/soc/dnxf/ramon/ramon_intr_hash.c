...
/* Command-line: /tools/oss/packages/x86_64-centos7/gperf/default/bin/gperf -L ANSI-C -t -N ramon_int_in_word_set -H ramon_int_hash /tmp/RAMON.gperf  */
/* Computed positions: -k'11-12,15-19,21-24,30,34,41,$' */
