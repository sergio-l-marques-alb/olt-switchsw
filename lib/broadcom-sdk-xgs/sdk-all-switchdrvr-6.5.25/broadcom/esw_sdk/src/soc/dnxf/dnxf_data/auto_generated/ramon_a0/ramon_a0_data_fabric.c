...
/**
 * \brief device level function which set define local_route_pipe_index
 * define info:
...
/**
 * \brief device level function which set define reduced_rx_resources
 * define info:
...
/**
 * \brief device level function which set define max_wfq_weight_value
 * define info:
 * Maxmium WFQ value
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric llfc_type_default
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table cell_match_filter_reg_mask
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_fabric_cell_cell_match_filter_reg_mask_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_fabric_cell_table_cell_match_filter_reg_mask");
...
/**
 * \brief device level function which set define all_reachable_fap_group_size
 * define info:
...
/**
 * \brief device level function which set define all_reachable_max_nof_ignore_faps
 * define info:
