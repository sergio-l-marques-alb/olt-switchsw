...
/**
 * \brief device level function which set define adapter_lib_ver
 * define info:
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_general_ctest_full_file_indentifier_t, (1 + 1 /* to store default value */ ), "data of dnxf_data_device_general_table_ctest_full_file_indentifier");
...
/**
 * \brief device level function which set define nof_links_in_rtp
 * define info:
...
/**
 * \brief device level function which set values for table dch_instances_to_device_stage
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_blocks_dch_instances_to_device_stage_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_device_blocks_table_dch_instances_to_device_stage");
...
/**
 * \brief device level function which set numeric active_core
 * numeric info:
