    ...
    soc_port_t * links)
{
    ...
    for (ii = 0; ii < links_count; ii++)
    {
        ...
        /*
         * Following funtction translates the logical link number to sections of 24 inner_links * block ID Example_1:
         * Link 8 will be translated to blk_id=0 and inner_link=8 Example_2: Link 191 will be translated to blk_id=8
         * and inner_link=24 Example_3: Link 24 will be translated to blk_id=1 and inner_link=0 
         */
