        ...
        switch (stat)
        {
            ...
            case bcmFabricStatDeviceGlobalDrop:
                ...
                for (block_idx = 0; block_idx < nof_lcm_blocks; block_idx++)
                {
                     ...
                     * LCM_ADMIT_DROP_CNT 
                     */
                    SHR_IF_ERR_EXIT(READ_LCM_ADMIT_DROP_CNTr(unit, block_idx, 0 /* first instance */ , &reg_val));
                    count = soc_reg64_field32_get(unit, LCM_ADMIT_DROP_CNTr, reg_val, ADMIT_DROP_REPLICATION_CNT_Nf);
                    COMPILER_64_ADD_64(*value, count);
                    SHR_IF_ERR_EXIT(READ_LCM_ADMIT_DROP_CNTr(unit, block_idx, 1 /* second instance */ , &reg_val));
                    count = soc_reg64_field32_get(unit, LCM_ADMIT_DROP_CNTr, reg_val, ADMIT_DROP_REPLICATION_CNT_Nf);
                    COMPILER_64_ADD_64(*value, count);

                    /*
                     * LCM_ADMIT_DROP_CPU_CNT 
                     */
                    ...
                    {
                        /*
                         * LCM_DTL_DROPPED_IP_PR_P_0_CNT - Pipe 0 
                         */
                        ...
                        /*
                         * LCM_DTL_DROPPED_IP_PR_P_1_CNT - Pipe 1
                         */
                        ...
                        /*
                         * LCM_DTL_DROPPED_IP_PR_P_2_CNT - Pipe 2 
                         */
                        ...
                        /*
                         * LCM_DTL_LCLRT_DROPPED_IP_PR_P_0_CNT - Pipe 0 
                         */
                        ...
                        /*
                         * LCM_DTL_LCLRT_DROPPED_IP_PR_P_1_CNT - Pipe 1 
                         */
                        ...
                        /*
                         * LCM_DTL_LCLRT_DROPPED_IP_PR_P_2_CNT - Pipe 2 
                         */
                    ...
                    {
                        /*
                         * LCM_DTL_LCLRT_DROPPED_SRC_P_CNT 
                         */
    ...
    else if (_SHR_FABRIC_STAT_INDEX_IS_LINK_PIPE(index))
    {
        switch (stat)
        {
            case bcmFabricStatQueueLinkPipeCurrOccupancyBytes:
                ...
                /*
                 * Verify if link and pipe is in range. 
                 */
                ...
                /*
                 * Set link in QRH block to be read
                 */
                ...
                /*
                 * Transform occypancy into bytes
                 */
