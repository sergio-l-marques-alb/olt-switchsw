/**
 * \file ramon_fabric_system_upgrade.c $Id$ Ramon System Upgrade Configuration.
 */
...
/**
 * \brief
 *   System upgrade phase 1 init.
 * \param [in] unit         - The unit number.
 * \param [in] master_id    - The system upgrade master id
 * \return
 *   See \ref shr_error_e
 */
shr_error_e
