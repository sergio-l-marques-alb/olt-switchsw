    ...
    int unit)
{
    ...
    /* Set default value */
    define->default_data = 14505578;

    /* Set value */
    define->data = 14505578;
 ...
 */
/**
 * \brief device level function which set numeric warmboot_backoff_rate
 * numeric info:
...
/**
 * \brief device level function which set numeric nof_guaranteed_reboots
 * numeric info:
