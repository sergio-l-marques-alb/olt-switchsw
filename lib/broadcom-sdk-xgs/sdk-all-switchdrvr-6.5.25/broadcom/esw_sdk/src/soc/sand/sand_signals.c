    ...
    signal_output_t **signal_output_p)
{
    ...
    /*
     * Check if the signal is not in the N/A restricted list for specific devices, stages, etc due to an issue of some sort
     */
    ...
    signal_output_t **signal_output_p)
{
...
#ifdef ADAPTER_SERVER_MODE
    /*
     * If Adapter and feom stage is Fabric, read signal from ERParser
     */
    {
    ...
    /*
     * If Adapter (dou to design constrains) the from-to chain is IPMF1->IPMF2->FER and no IPMF1->FER
     */
