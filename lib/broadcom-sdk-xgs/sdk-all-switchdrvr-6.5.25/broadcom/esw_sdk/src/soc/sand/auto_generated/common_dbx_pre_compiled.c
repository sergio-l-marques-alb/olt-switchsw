...
\n\
        ...
        <object name=\"IPvX_Demux\" size=\"480\" structure=\"IPvX_Dem";

const char *NetworkHeadersObjects_3="ux\">\n\
        ...
        <object name=\"BFD_SEAMLESS\" size=\"192\" structure=\"BFD\">\n\
    ...
    <next-headers>\n\
        <next-header-options name=\"ETH_Next_Prot";

const char *NetworkHeadersObjects_4="ocol\">\n\
...
const char *NetworkHeadersObjects_5="        <next-header-options name=\"PPP_Next_Protocol\">\n\
...
const char *NetworkStructures_5="   <field name=\"Control_Field\" bits=\"256:263\"/>\n\
        ...
        <structure name=\"L2TP_Base\" size=\"48\" order=\"msb\">\n\
            ...
            <field name=\"P\" bits=\"7:7\"/>\n\
            <field name=\"Reserved\" bits=\"8:11\"/>\n\
            <field name=\"Ver\" bits=\"12:";

const char *NetworkStructures_6="15\"/>\n\
        ...
        <structure name=\"L2TP\" size=\"128\" expansion=\"Dynamic\" order=\"msb\">\n\
            ...
            <option expansion=\"L2TP_L\"    L=\"1\" S=\"0\" O=\"0\" trim=\"MS\" />\n\
...
const char *NetworkStructures_7=" name=\"OAM_Opcode\" size=\"8\">\n\
        ...
        <signal name=\"PPP_Next_Header\" size=\"16\">\n\
...
const char *UnsupportedDebugSignals_3="l_Info\">\n\
    ...
    <signal block=\"ETPP\" from=\"FWD\" name=\"Dst_IP\">\n\
        <device chip=\"BCM88830_A0\" adapter=\"1\"/>\n\
    </signal>\n\
    <signal block=\"ETPP\" from=\"FWD\" name=\"Dst_IP\">\n\
        <device chip=\"BCM88830_A0\"/>\n\
    </signal>\n\
    <signal block=\"ETPP\" from=\"FWD\" name=\"Fwd_Bytes_to_Add\">\n\
        <device chip=\"BCM88830_A0\" adapter=\"1\"/>\n\
    </signal>\n\
    <signal block=\"ETPP\" from=\"FWD\" name=\"Fwd_Bytes_to_Add\">\n\
        <device chip=\"BCM88830_A0\"/>\n\
    </signal>\n\
    <signal block=\"ETPP\" from=\"FWD\" name=\"VLAN_Membership_Entry_0\">\n\
  ";

const char *UnsupportedDebugSignals_4="      <device chip=\"BCM88830_A0\" adapter=\"1\"/>\n\
    </signal>\n\
    <signal block=\"ETPP\" from=\"FWD\" name=\"VLAN_Membership_Entry_0\">\n\
        <device chip=\"BCM88830_A0\"/>\n\
    </signal>\n\
    ...
    long int * size_p)
{
    ...
    *size_p = 0;
    ...
    if(!sal_strncmp("UnsupportedDebugSignals.xml", filePath, RHFILE_MAX_SIZE))
    {
        ...
        _internal_size_p += sal_strnlen(UnsupportedDebugSignals_4, COMMON_COMMON_PRE_COMPILED_STRING_MAX_SIZE);
        ...
        *size_p = _internal_size_p;
        ...
        offset += sal_strnlen(UnsupportedDebugSignals_3, COMMON_COMMON_PRE_COMPILED_STRING_MAX_SIZE);
        sal_strncpy(file_buf + offset, UnsupportedDebugSignals_4, sal_strnlen(UnsupportedDebugSignals_4, COMMON_COMMON_PRE_COMPILED_STRING_MAX_SIZE));
