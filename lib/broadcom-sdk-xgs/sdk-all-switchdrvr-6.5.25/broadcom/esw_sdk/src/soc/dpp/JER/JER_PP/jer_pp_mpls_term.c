...
soc_error_t soc_jer_pp_mpls_termination_spacial_labels_init(int unit) {
    ...
    /** the last bit is used as MplsEnableTSE0Phb, if set, MPLS TES0 use PHB ECO fix is enabled, else disabled*/
    /** if PHB eco fix is enabled, TSE0 cos profile is 6'hFE*/
