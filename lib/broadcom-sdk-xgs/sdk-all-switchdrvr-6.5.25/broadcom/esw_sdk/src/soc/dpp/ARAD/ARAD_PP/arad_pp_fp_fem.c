  ...
  )
{
    ...
    *found = 0;
    ...
    /*
     * Put trap action in cycle 1 to give other acions a chance to update before
     * forward strength is updated by trap action.
     */
...
)
{
    ...
    *idx = -1;
    ...
    /**invalid_next located in the last one*/
    if ((*idx == -1) 
...
)
{
    ...
    if (idx_invalid_next > idx_free) {
        ...
        /**move invalid_next to the idx_free */
        ...
        /**chunk{idx_free+1, idx_invalid_next-1} move one step to make sure idx_free+1 is free */
        ...
        /**should update idx_invalid_next and idx_free outside. */
        ARAD_PP_DO_NOTHING_AND_EXIT;
    }
        ...
        if (is_for_fem) {
              ...
              && (fem_free_min_ndx == nof_fem_fes_per_group))
          {
                ...
                (fes_info[fes_id_indx].action_type != SOC_PPC_FP_ACTION_TYPE_INVALID_NEXT))
            {
                ...
                /*
                 * Set trap action as the highest priority
                 * to give other acions a chance to update before
                 * forward strength is updated by trap action.
                 */
