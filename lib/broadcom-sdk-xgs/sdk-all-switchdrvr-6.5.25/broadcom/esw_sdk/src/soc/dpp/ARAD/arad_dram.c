    ...
    )
{
   ...
   /* Set logical mode */
    ...
    /* The indirect address of QAX is set by this register MMU_DRAM_INDIRECT_ADDRESS.MMU DRAM_INDIRECT_ADDRESS 
        and not the same as it was in Jericho*/
    if (SOC_IS_QAX(unit))
    {
