...
CONST mbcm_dpp_functions_t mbcm_arad_driver = {
    ...
    NULL, /*        mbcm_dpp_port_control_ecn_enable_set;*/
    NULL, /*        mbcm_dpp_port_control_ecn_enable_get;*/
    ...
    NULL, /*  mbcm_dpp_flow_profile_property_get*/
    NULL, /*  mbcm_dpp_flow_profile_property_get*/
    ...
    NULL, /*mbcm_dpp_egr_prog_editor_pp_profile_set*/
    NULL, /*mbcm_dpp_egr_prog_editor_pp_profile_get*/
    ...
    NULL, /* mbcm_dpp_port_ilkn_bypass_interface_rx_enable_get */
    ...
    NULL,        /* mbcm_dpp_port_timestamp_adjust_set */
    NULL,        /* mbcm_dpp_port_timestamp_adjust_get */
    NULL,        /* mbcm_dpp_port_master_set */
    NULL,        /* mbcm_dpp_port_master_get */
    NULL,        /* mbcm_dpp_queue_flush_set */
    NULL,        /* mbcm_dpp_sysport_ingress_queue_map_enable_set */
    NULL,        /* mbcm_dpp_sysport_ingress_queue_map_enable_get */
