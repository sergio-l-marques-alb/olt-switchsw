...
CONST mbcm_dpp_functions_t mbcm_jericho_driver = {
    ...
    soc_jer_port_control_ecn_enable_set,
    soc_jer_port_control_ecn_enable_get,
    ...
    jer_itm_vsq_fc_default_get, /* mbcm_dpp_itm_vsq_fc_default_get */
    ...
    soc_jer_egr_flow_profile_property_set,
    soc_jer_egr_flow_profile_property_get,
    ...
    arad_egr_prog_editor_pp_profile_get,
    ...
    NULL,        /* mbcm_dpp_lb_lbg_packet_config_set*/
    NULL,        /* mbcm_dpp_lb_lbg_packet_config_get*/
    NULL,        /* mbcm_dpp_lb_ing_lbg_stat_get*/
    arad_pon_port_enable_set,
    arad_pon_port_enable_get,
    NULL,        /* mbcm_dpp_lb_port_speed_validate */
    NULL,        /* mbcm_dpp_lb_port_speed_set*/
    NULL,        /* mbcm_dpp_lb_port_speed_get*/
    ...
    NULL,        /* mbcm_dpp_sram_drop_threshold_set */
    NULL,        /* mbcm_dpp_sram_drop_threshold_get */
    NULL,        /* mbcm_dpp_sram_drop_reassembly_context_profile_map_set */
    NULL,        /* mbcm_dpp_sram_drop_reassembly_context_profile_map_get */
    NULL,        /* mbcm_dpp_sram_drop_profile_priority_map_set */
    NULL,        /* mbcm_dpp_sram_drop_profile_priority_map_get */
    NULL,        /* mbcm_dpp_lb_is_control_port_get */
    NULL,        /* mbcm_dpp_lb_ing_control_packet_identification_config_set */
    NULL,        /* mbcm_dpp_lb_ing_control_packet_identification_config_get */
};
