...
/* Function to send cpu command for ddr4 dram */
...
/* Function to issue ddr4 zqcl command by SW */
static int soc_dpp_drc_combo28_ddr4_zqcl(int unit, int drc_ndx)
{
    ...
    /** only CS0 */
    cs_n  = 2;
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_cpu_command(unit, drc_ndx, cpu_addr, 0/*bank*/, cs_n, 0/*we_n*/, 1/*cas_n*/, 1/*ras_n*/));
    /** waiting zqcl complete */
    sal_usleep(15);
    /** for CS1 */
    cs_n  = 1;
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_cpu_command(unit, drc_ndx, cpu_addr, 0/*bank*/, cs_n, 0/*we_n*/, 1/*cas_n*/, 1/*ras_n*/));
...
/* Function to issue ddr4 pre-charge-all */
static int soc_dpp_drc_combo28_ddr4_precharge_all(int unit, int drc_ndx)
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_cpu_command(unit, drc_ndx, cpu_addr, 0/*bank*/, 0/*cs_n*/, 0/*we_n*/, 1/*cas_n*/, 0/*ras_n*/));

exit:
    SOCDNX_FUNC_RETURN;
}

/* Function to load MRs for ddr4 */
static int soc_dpp_drc_combo28_ddr4_load_mrs(int unit, int drc_ndx, uint32 mr_index, uint32 mrs_opcode)
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_cpu_command(unit, drc_ndx, cpu_addr, bank, 0/*cs_n*/, 0/*we_n*/, 0/*cas_n*/, 0/*ras_n*/));

exit:
    SOCDNX_FUNC_RETURN;
}
/* Function to auto-refresh ddr4 dram */
static int soc_dpp_drc_combo28_ddr4_auto_refresh(int unit, int drc_ndx)
{
    SOCDNX_INIT_FUNC_DEFS;
    SOCDNX_IF_ERR_EXIT(soc_dpp_drc_combo28_ddr4_cpu_command(unit, drc_ndx, 0/*cpu_addr*/, 0/*bank*/, 0/*cs_n*/, 1/*we_n*/, 0/*cas_n*/, 0/*ras_n*/));
...
/*
 * Function:
 *      soc_dpp_drc_combo28_shmoo_init_ddr4     
 * Purpose:
 *      init ddr4 dram
 * Parameters:
 *      unit                        - Device Number
...
int soc_dpp_drc_combo28_shmoo_init_ddr4(int unit, int drc_ndx)
{
    ...
    /* update the registers with all the values we've just set */ 
    SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, DRC_CPU_COMMANDSl[drc_ndx], REG_PORT_ANY, 0, reg_above_64));
    /** constant value just for ODT CKE and RES    */
