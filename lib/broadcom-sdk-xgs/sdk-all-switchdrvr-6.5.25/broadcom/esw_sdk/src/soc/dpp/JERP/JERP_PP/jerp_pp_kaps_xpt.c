/* $Id: jerp_pp_kaps_xpt.c, Broadcom SDK Exp $
...
/*
 * This function translates from KAPS block numbers to HW block number
                                       ...
                                       uint16_t source_mask, uint8_t rotate_right, uint8_t perform_clear)
{
    ...
    if (desc_dma_enabled == 0) {
         ...
         * therefore no need for polling. Also assume the KAPS issues correct hitbit machine commands.
         */
