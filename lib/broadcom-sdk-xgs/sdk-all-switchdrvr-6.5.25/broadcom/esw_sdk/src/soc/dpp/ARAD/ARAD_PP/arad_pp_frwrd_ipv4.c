      ...
      )
{
    ...
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
#endif /* BCM_88675_A0 */
    /* coverity[overrun-buffer-val:FALSE] kaps payload is guaranteed to be smaller than 4 bytes */
...
{
    uint32 *payload;
    /*use the biggest buffer to support all types DB*/
  ...
  )
{
...
#endif
  {
      ...
      /* recover the configuration before the error exist */
