...
#define BASE_QUEUE 0x17ff0 /* first queue to use for others */
#define NOF_QUEUES_TO_BLOCK 13 /* number of queues to use for others */
#define NOF_PACKETS_PER_QUEUE 32
#define NUM_OF_REP (NOF_QUEUES_TO_BLOCK * NOF_PACKETS_PER_QUEUE)
#define TEMP_MC_ID 9000 /* multicast ID used temporarily in others */
