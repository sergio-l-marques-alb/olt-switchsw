...
/* 1588 over UDP */
#define I1588oU1    (ARAD_PARSER_CUSTOM_MACRO_PROTO_10 + 1)     /* 10 1010b */
#define I1588oU2    (ARAD_PARSER_CUSTOM_MACRO_PROTO_11 + 1)     /* 11 1011b */
#define I1588oU     ((I1588oU1)&(I1588oU2))                     /* 10 1010b */
#define I1588oU_MSK ((I1588oU1)^(I1588oU2))                     /*   1 0001b */
   ...
   int ieee_1588_identification_cam[ARAD_PP_1588_IDENTIFICATION_CAM_TABLE_ENTRIES_NUM][9] =
       ...
       /* valid  q1       q2       q3       q4       q5     fwd_header   encup    1588_carry_header                                   */
        {{1,     I1588oE, NONE   , NONE   , NONE   , NONE   , 1,         ENC_ETH, 1 }, /*  0 1588oE               switched            */
         ...
         {1,     MPLS   , ANY    , IP     , UDP    , I1588oU, 1,         ENC_UDP, 5 }, /*  6 1588oUDPoIPoEoMPLSoE switched            */
         {1,     MPLS   , ANY    , IP     , UDP    , I1588oU, 2,         ENC_UDP, 5 }, /*  7 1588oUDPoIPoEoMPLSoE MPLS routed         */
         {1,     MPLS   , ANY    , IP     , UDP    , I1588oU, 3,         ENC_UDP, 5 }, /*  8 1588oUDPoIPoEoMPLSoE MPLS terminated     */
    ...
    for(i = 0; i < ARAD_PP_1588_IDENTIFICATION_CAM_TABLE_ENTRIES_NUM; i++) {
        ...
        /* mask=I1588oU_MSK(0001b), accepts QQQXb values (Q - bit value of qualifier, X - any bit, 0 or 1) */
...
/*********************************************************************
 *    Verify valid input to arad_pp_ptp_port_set_unsafe()
*     Details: in the H file. (search for prototype)
*********************************************************************/
uint32
