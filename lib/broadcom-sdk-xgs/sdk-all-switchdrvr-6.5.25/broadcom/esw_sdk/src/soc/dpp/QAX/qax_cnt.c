...
/***********************************************************************************************************************
 * Function:
 *      qax_stat_counter_filter_group_get
 * Purpose:
 *      returns whether a filter group is active on a counter command
 * Parameters:
 *      unit -  unit number
 *      command_id - counter pointer A(0) or B(1)
 *      filter_group - 0~7
 *      is_active - returns whether this filter group is active on the counter command
 * Returns:
 *      SOC_E_XXX
 ***********************************************************************************************************************/
...
/***********************************************************************************************************************
 * Function:
 *      qax_stat_counter_filter_group_set
 * Purpose:
 *      Configures whether a filter group should be active on a counter command
 * Parameters:
 *      unit -  unit number
 *      command_id - counter pointer A(0) or B(1)
 *      filter_group - filter group 0~7
 *      is_active - wheter a filter group is active on this counter command
 * Returns:
 *      SOC_E_XXX
 ***********************************************************************************************************************/
...
/***********************************************************************************************************************
 * Function:
 *      qax_stat_group_drop_reasons_get
 * Purpose:
 *      returns a bitmap of those drop reasons which are active on a filter group
 * Parameters:
 *      unit -  unit number
 *      filter_group - filter group 0~7
 *      drop_reasons_mask - QAX supports 45 drop reasons (bits 0~44)
 * Returns:
 *      SOC_E_XXX
 ***********************************************************************************************************************/
 ...
 *      qax_stat_group_drop_reasons_get
 * Purpose:
 *      Configures the drop reasons which are active on a filter group
 * Parameters:
 *      unit -  unit number
 *      filter_group - filter group 0~7
 *      drop_reasons_mask - QAX supports 45 drop reasons (bits 0~44)
