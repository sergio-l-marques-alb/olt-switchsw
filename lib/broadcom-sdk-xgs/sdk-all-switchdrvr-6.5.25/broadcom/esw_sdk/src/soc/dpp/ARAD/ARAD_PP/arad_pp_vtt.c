...
/*
   valid BM|    Name                                 |            Global sw db enum                                                  |      Pointer to 'vtt_table_property_set' function             |           Memory Type                         |  Additional Info */
    ...
    { {0}, "VTT VDxOUTER_INITIAL_VID SEM B"            , SOC_DPP_DBAL_SW_TABLE_ID_VDxOUTER_INITIAL_VID_SEM_B                         , arad_pp_dbal_sw_db_vdxvid_sem_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B          , OUTER_INITIAL_VID     }, /* initial vlan id   |outer   vlan id | '1'(2 bits) | vlan domain */
...
/* MPLS DB's start */                                                                                                                                                                                                       
    ...
    { {0}, "VTT VDxINNERVID SEM A"                     , SOC_DPP_DBAL_SW_TABLE_ID_VDxINNERVID_SEM_A                                  , arad_pp_dbal_sw_db_vdxvid_sem_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A          , INNER_VID             }, /* inner   vlan id | '1'(1 bit)  | '0'(1 bit) | vlan domain */
    { {0}, "VTT VDxINNERVID SEM B"                     , SOC_DPP_DBAL_SW_TABLE_ID_VDxINNERVID_SEM_B                                  , arad_pp_dbal_sw_db_vdxvid_sem_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B          , INNER_VID             }, /* inner   vlan id | '1'(1 bit)  | '0'(1 bit) | vlan domain */
    { {0}, "VTT VDxOUTER_INNER_PCP_VID SEM A"          , SOC_DPP_DBAL_SW_TABLE_ID_VDxOUTER_INNER_PCP_VID_SEM_A                       , arad_pp_dbal_sw_db_vdxvid_sem_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A          , OUTER_INNER_VID_PCP   }, /* inner vlan id   |outer   vlan id | '1'(2 bits) | vlan domain */
    { {0}, "VTT VDxOUTER_INNER_PCP_VID SEM B"          , SOC_DPP_DBAL_SW_TABLE_ID_VDxOUTER_INNER_PCP_VID_SEM_B                       , arad_pp_dbal_sw_db_vdxvid_sem_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B          , OUTER_INNER_VID_PCP   }, /* inner vlan id   |outer   vlan id | '1'(2 bits) | vlan domain */
...
/* MPLS DB's finish */                                                                                                                                                                                                      
    ...
    { {0}, "VTT L2TP"                                  , SOC_DPP_DBAL_SW_TABLE_ID_L2TP_ISEM_A                                 , arad_pp_dbal_sw_db_l2tp_property_set                     , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A          , DUMMY_FOR_EXPLICIT_NULL_TYPE            }, /* L2TP */
    { {0}, "VTT PPPOE"                                 , SOC_DPP_DBAL_SW_TABLE_ID_PPPOE_ISEM_A                                , arad_pp_dbal_sw_db_pppoe_property_set                    , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A          , DUMMY_FOR_EXPLICIT_NULL_TYPE            }, /* PPPOE */
...
/*37*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_INITIAL_VID                                    , arad_pp_dbal_vt_program_double_tag_property_set                              , {-1}    , OUTER_INITIAL_VID},
/*38*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxINITIALVID_AFTER_RCY                              , arad_pp_dbal_vt_program_ipv4_vdxinitial_recycle_property_set                 , {-1}    , 0               },
/*39*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxOUTERVID_AFTER_RCY                                , arad_pp_dbal_vt_program_ipv4_vdxouter_recycle_property_set                   , {-1}    , 0               },
/*40*/    {ARAD_PP_DBAL_VT_PROG_SINGLE_TAG_5_TUPPLE_QINQ                                  , arad_pp_dbal_vt_program_single_tag_5tupple_qinq_property_set                 , {-1}    , 0               },
/*41*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_5_TUPPLE_QINQ                                  , arad_pp_dbal_vt_program_double_tag_5tupple_qinq_property_set                 , {-1}    , 0               },
/*42*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_TST1                                             , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*43*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_TST1                                              , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*44*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_TST1                                           , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },


/*45*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_VRRP                                             , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*46*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_VRRP                                              , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*47*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_VRRP                                           , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },


/*48*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_EXP_NULL_TST1                                    , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_UNTAGGED   },
/*49*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_EXP_NULL_TST1                                     , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_ONE_TAG    },
/*50*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_EXP_NULL_TST1                                  , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_DOUBLE_TAG },
/*51*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_PCP_1_TST2                                    , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set                    , {-1}    , TPID1           },
/*52*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_PCP_2_TST2                                    , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set                    , {-1}    , TPID2           },
/*53*/    {ARAD_PP_DBAL_VT_PROG_OUTER_PCP_1_TST2                                          , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                          , {-1}    , TPID1           },
/*54*/    {ARAD_PP_DBAL_VT_PROG_OUTER_PCP_2_TST2                                          , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                          , {-1}    , TPID2           },
/*55*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_1_TST2                                        , arad_pp_dbal_vt_program_outer_inner_tst2_property_set                        , {-1}    , TPID1           },
/*56*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_2_TST2                                        , arad_pp_dbal_vt_program_outer_inner_tst2_property_set                        , {-1}    , TPID2           },
/*57*/    {ARAD_PP_DBAL_VT_PROG_OUTER_1_TST2                                              , arad_pp_dbal_vt_program_outer_tst2_property_set                              , {-1}    , TPID1           },
/*58*/    {ARAD_PP_DBAL_VT_PROG_OUTER_2_TST2                                              , arad_pp_dbal_vt_program_outer_tst2_property_set                              , {-1}    , TPID2           },
/*59*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_TST2                                             , arad_pp_dbal_vt_program_untagged_tst2_property_set                           , {-1}    , 0               },
/*60*/    {ARAD_PP_DBAL_VT_PROG_VT_TEST2                                                  , arad_pp_dbal_vt_program_test2_property_set                                   , {-1}    , 0               },
/*61*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE                                               , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , OUTER_VID       },
/*62*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE_UT                                            , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , INITIAL_VID     },
/*63*/    {ARAD_PP_DBAL_VT_PROG_VT_CUSTOM_PP_PORT_TUNNEL                                  , arad_pp_dbal_vt_program_custom_pp_port_tunnel_property_set                   , {-1}    , 0               },
/*64*/    {ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_VLAN_DOMAIN_MPLS_L1                         , arad_pp_dbal_vt_program_vlan_domain_mpls_property_set                        , {-1}    , 0               },
/*65*/    {ARAD_PP_DBAL_VT_PROG_PON_UNTAGGED                                              , arad_pp_dbal_vt_program_pon_untagged_property_set                            , {-1}    , 0               },
/*66*/    {ARAD_PP_DBAL_VT_PROG_PON_ONE_TAG                                               , arad_pp_dbal_vt_program_pon_one_tag_property_set                             , {-1}    , 0               },
/*67*/    {ARAD_PP_DBAL_VT_PROG_PON_TWO_TAGS                                              , arad_pp_dbal_vt_program_pon_two_tags_property_set                            , {-1}    , 0               },
/*68*/    {ARAD_PP_DBAL_VT_PROG_PON_TWO_TAGS_VS_TUNNEL_ID                                 , arad_pp_dbal_vt_program_pon_two_tags_vs_tunnel_id_property_set               , {-1}    , 0               },
/*69*/    {ARAD_PP_DBAL_VT_PROG_SECTION_OAM_ONE_TAG                                       , arad_pp_dbal_vt_program_section_oam_one_tag_property_set                     , {-1}    , 0               },
/*70*/    {ARAD_PP_DBAL_VT_PROG_SECTION_OAM_TWO_TAGS                                      , arad_pp_dbal_vt_program_section_oam_two_tags_property_set                    , {-1}    , 0               },
/*71*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxINITIALVID_MPLS4_L1L2                          , arad_pp_dbal_vt_program_indexed_vdxinitialvid_mpls4_l1l2_property_set        , {-1}    , 0               },
/*72*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxOUTERVID_MPLS4_L1L2                            , arad_pp_dbal_vt_program_indexed_vdxoutervid_mpls4_l1l2_property_set          , {-1}    , 0               },
/*73*/    {ARAD_PP_DBAL_VT_PROG_IPV6_VDxINITIALVID                                        , arad_pp_dbal_vt_program_ipv6_vdxinitial_property_set                         , {-1}    , 0               },
/*74*/    {ARAD_PP_DBAL_VT_PROG_IPV6_VDxOUTERVID                                          , arad_pp_dbal_vt_program_ipv6_vdxouter_property_set                           , {-1}    , 0               },
/*75*/	   {ARAD_PP_DBAL_VT_PROG_IPV6_VDxINITIALVID_AFTER_RECYCLE                          , arad_pp_dbal_vt_program_ipv6_vdxinitial_property_set                         , {-1}    , 1               },
/*76*/	   {ARAD_PP_DBAL_VT_PROG_IPV6_VDxOUTERVID_AFTER_RECYCLE                            , arad_pp_dbal_vt_program_ipv6_vdxouter_property_set                           , {-1}    , 1               },
/*77*/    {ARAD_PP_DBAL_VT_PROG_GENERALIZED_RCH0                                          , arad_pp_dbal_vt_program_generalized_rch_property_set                         , {-1}    , 1               },
/*78*/    {ARAD_PP_DBAL_VT_PROG_GENERALIZED_RCH1                                          , arad_pp_dbal_vt_program_generalized_rch_property_set                         , {-1}    , 0               },
/*79*/	  {ARAD_PP_DBAL_VT_PROG_3MTSE_PLUS_FRR_VDxINITIALVID_L2_L1                        , arad_pp_dbal_vt_program_3mtse_plus_frr_vdxinitialvid_l2l1_property_set       , {-1}    , 0               },
/*80*/	  {ARAD_PP_DBAL_VT_PROG_3MTSE_PLUS_FRR_VDxOUTERVID_L2_L1                          , arad_pp_dbal_vt_program_3mtse_plus_frr_vdxOuterVid_l2l1_property_set         , {-1}    , 0               },
/*81*/	  {ARAD_PP_DBAL_VT_PROG_3MTSE_PLUS_FRR_VDxINITIALVID_L2_L4B_L5GAL                 , arad_pp_dbal_vt_program_3mtse_plus_frr_vdxinitialvid_l2_l4b_l5g_property_set , {-1}    , 0               },
/*82*/	  {ARAD_PP_DBAL_VT_PROG_3MTSE_PLUS_FRR_VDxOUTERVID_L2_L4B_L5GAL                   , arad_pp_dbal_vt_program_3mtse_plus_frr_vdxOuterVid_l2_l4b_l5g_property_set   , {-1}    , 0               },
/*83*/	  {ARAD_PP_DBAL_VT_PROG_2MTSE_PLUS_FRR_VDxINITIALVID_FRR                          , arad_pp_dbal_vt_program_2mtse_plus_frr_vid_frr_property_set                  , {-1}    , INITIAL_VID     },
/*84*/	  {ARAD_PP_DBAL_VT_PROG_2MTSE_PLUS_FRR_VDxOUTERVID_FRR                            , arad_pp_dbal_vt_program_2mtse_plus_frr_vid_frr_property_set                  , {-1}    , OUTER_VID       },
/*85*/	  {ARAD_PP_DBAL_VT_PROG_2MTSE_PLUS_FRR_VDxOUTER_INNER_VID_FRR                     , arad_pp_dbal_vt_program_2mtse_plus_frr_vid_frr_property_set                  , {-1}    , OUTER_INNER_VID },
/*86*/	  {ARAD_PP_DBAL_VT_PROG_2MTSE_PLUS_FRR_VDxOUTER_INNER_PCP_VID_FRR                 , arad_pp_dbal_vt_program_2mtse_plus_frr_vid_frr_property_set                  , {-1}    , OUTER_INNER_VID_PCP }
...
/*52*/    {ARAD_PP_DBAL_TT_PROG_VLAN_DOMAIN_MPLS_L2           , arad_pp_dbal_tt_program_vlan_domain_mpls_property_set               , {-1}    , 0                    },
/*53*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L2_L3          , arad_pp_dbal_tt_program_index_as_order_l2_l3_property_set           , {-1}    , 0                    },
/*54*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L2_L2          , arad_pp_dbal_tt_program_index_as_order_l2_l2_property_set           , {-1}    , 0                    },
/*55*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L1_L2          , arad_pp_dbal_tt_program_index_as_order_l1_l2_property_set           , {-1}    , 0                    },
/*56*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L1_L1          , arad_pp_dbal_tt_program_index_as_order_l1_l1_property_set           , {-1}    , 0                    },
/*57*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_NOP            , arad_pp_dbal_tt_program_index_as_order_nop_property_set             , {-1}    , 0                    },
/*58*/    {ARAD_PP_DBAL_TT_PROG_INDEX_MPLS4_L3_L4             , arad_pp_dbal_tt_program_indexed_mpls_l3_l2_property_set             , {-1}    , 1                    },
/*59*/    {ARAD_PP_DBAL_TT_PROG_INDEX_MPLS4_NOP               , arad_pp_dbal_tt_program_mpls4_nop_property_set                      , {-1}    , 1                    },
/*60*/    {ARAD_PP_DBAL_TT_PROG_IP_DISABLE_ON_LIF             , arad_pp_dbal_tt_program_ip_disable_on_lif_property_set              , {-1}    , 0                    },
/*61*/    {ARAD_PP_DBAL_TT_PROG_IPV4_DISABLE_ON_LIF           , arad_pp_dbal_tt_program_ip_disable_on_lif_property_set              , {-1}    , 0                    },
/*62*/    {ARAD_PP_DBAL_TT_PROG_IPV6_DISABLE_ON_LIF           , arad_pp_dbal_tt_program_ip_disable_on_lif_property_set              , {-1}    , 0                    },
/*63*/    {ARAD_PP_DBAL_TT_PROG_IPV6_ROUTER_COMP_DEST_FOUND   , arad_pp_dbal_tt_program_ipv6_router_comp_dest_found_property_set    , {-1}    , 0                    },
/*64*/    {ARAD_PP_DBAL_TT_PROG_IPV6_ROUTER_AFTER_RECYCLE     , arad_pp_dbal_tt_program_ipv6_router_property_set                    , {-1}    , 1                    },
/*65*/    {ARAD_PP_DBAL_TT_PROG_PPPOE                         , arad_pp_dbal_tt_program_pppoe_property_set                          , {-1}    , 0                    },
/*66*/	  {ARAD_PP_DBAL_TT_PROG_L2TP						  , arad_pp_dbal_tt_program_l2tp_property_set							, {-1}	  , 1					 },
/*67*/    {ARAD_PP_DBAL_TT_PROG_GENERALIZED_RCH_MPLS          , arad_pp_dbal_tt_program_generalized_rch_property_mpls_set           , {-1}    , 0                    },
/*68*/    {ARAD_PP_DBAL_TT_PROG_MYMAC_IP_DISABLED_TRAP        , arad_pp_dbal_tt_program_mymac_ip_disable_trap_property_set          , {-1}    , 0                    },
/*69*/    {ARAD_PP_DBAL_TT_PROG_3MTSE_PLUS_FRR_L1_L1          , arad_pp_dbal_tt_program_3mtse_plus_frr_property_set                 , {-1}    , VTT_3MTSE_FRR_L1_L1      },
/*70*/    {ARAD_PP_DBAL_TT_PROG_3MTSE_PLUS_FRR_TFL_L3_L3      , arad_pp_dbal_tt_program_3mtse_plus_frr_property_set                 , {-1}    , VTT_3MTSE_FRR_L3_L3      },
/*71*/    {ARAD_PP_DBAL_TT_PROG_3MTSE_PLUS_FRR_L3_L1          , arad_pp_dbal_tt_program_3mtse_plus_frr_property_set                 , {-1}    , VTT_3MTSE_FRR_L3_L1      },
/*72*/    {ARAD_PP_DBAL_TT_PROG_3MTSE_PLUS_FRR_TFL_L4_L3      , arad_pp_dbal_tt_program_3mtse_plus_frr_property_set                 , {-1}    , VTT_3MTSE_FRR_L4_L3      },
/*73*/    {ARAD_PP_DBAL_TT_PROG_3MTSE_PLUS_FRR_L1             , arad_pp_dbal_tt_program_3mtse_plus_frr_property_set                 , {-1}    , VTT_3MTSE_FRR_L1         },
/*74*/    {ARAD_PP_DBAL_TT_PROG_3MTSE_PLUS_FRR_L2_L1          , arad_pp_dbal_tt_program_3mtse_plus_frr_property_set                 , {-1}    , VTT_3MTSE_FRR_L2_L1      },
/*75*/    {ARAD_PP_DBAL_TT_PROG_2MTSE_PLUS_FRR_L1_L1          , arad_pp_dbal_tt_program_2mtse_plus_frr_property_set                 , {-1}    , VTT_2MTSE_FRR_L1_L1      },
/*76*/    {ARAD_PP_DBAL_TT_PROG_2MTSE_PLUS_FRR_L2_L2          , arad_pp_dbal_tt_program_2mtse_plus_frr_property_set                 , {-1}    , VTT_2MTSE_FRR_L2_L2      },
/*77*/    {ARAD_PP_DBAL_TT_PROG_2MTSE_PLUS_FRR_L2_L1          , arad_pp_dbal_tt_program_2mtse_plus_frr_property_set                 , {-1}    , VTT_2MTSE_FRR_L2_L1      },
/*78*/    {ARAD_PP_DBAL_TT_PROG_2MTSE_PLUS_FRR_L3_L2          , arad_pp_dbal_tt_program_2mtse_plus_frr_property_set                 , {-1}    , VTT_2MTSE_FRR_L3_L2      },
/*79*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_DIP_FOUND_IPMC_RCY, arad_pp_dbal_tt_program_ipv4_router_dip_found_property_set          , {-1}    , 1                        },
/*80*/    {ARAD_PP_DBAL_TT_PROG_MC_PPPOE                      , arad_pp_dbal_tt_program_mc_pppoe_property_set                       , {-1}    , 0                        }
...
void arad_pp_dbal_vt_program_pon_untagged_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    if (g_prog_soc_prop[unit].tls_db_enable)
    {
        ...
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = 1; /* 16 bits tunnel ID */
        program_property->nof_keys++;
    }
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = 1; /* 16 bits tunnel ID */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][2] = 0; /* 16 bits ethernet type */
    program_property->nof_keys++;
...
void arad_pp_dbal_vt_program_pon_one_tag_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = SOC_IS_JERICHO(unit) ? 10 : 6; /* 16 bits tunnel ID */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][2] = 1; /* 16 bits outer_vid */
    program_property->nof_keys++;
    ...
    if (!soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "gpon_application_enable", 0)) {
        ...
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = SOC_IS_JERICHO(unit) ? 10 : 6; /* 16 bits tunnel ID */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][2] = 2; /* 32 bits ethernet type */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][3] = 1; /* 16 bits outer_vid */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][4] = 0; /* 16 bits outer_pcp */
        program_property->nof_keys++;
    }
...
void arad_pp_dbal_vt_program_pon_two_tags_vs_tunnel_id_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    if(soc_property_suffix_num_get(unit,-1,spn_CUSTOM_FEATURE,"pon_lif_lkup",0))
    {
        ...
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = SOC_IS_JERICHO(unit) ? 10 : 6; /* 16 bits tunnel ID */
        program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][2] = 2; /* 32 bits outer_vid */
        program_property->nof_keys++;
    }
    else
    {
        if (!g_prog_soc_prop[unit].custom_pon_enable)
        {
            ...
            program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = SOC_IS_JERICHO(unit) ? 10 : 6; /* 16 bits tunnel ID */
            program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][2] = 2; /* 32 bits outer_vid */
            program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][3] = 0; /* 16 bits inner_vid */
            program_property->nof_keys++;
        }
    }
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][1] = SOC_IS_JERICHO(unit) ? 10 : 6; /* 16 bits tunnel ID */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][2] = 3; /* 32 bits ethernet type */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][3] = 2; /* 32 bits outer_vid */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][4] = 1; /* 16 bits outer_pcp  */
    program_property->qual_to_ce_info.qualifier_to_ce_id[program_property->nof_keys][5] = 0; /* 16 bits inner_vid */
    program_property->nof_keys++;
...
void arad_pp_dbal_vt_program_3mtse_plus_frr_vdxinitialvid_l2l1_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 mpls_label )
{
    ...
    if (SOC_DPP_CONFIG(unit)->pp.mpls_termination_database_mode == 20) {
        ...
        program_property->pd_bitmap_0          = (0x10);  /* ISA */
        program_property->pd_bitmap_1          = (0x8);  /* ISB */
   }
    if (SOC_DPP_CONFIG(unit)->pp.mpls_termination_database_mode == 21) {
        ...
        program_property->pd_bitmap_0          = (0x08);  /* ISB */
        program_property->pd_bitmap_1          = (0x10);  /* ISA */}
...
void arad_pp_dbal_vt_program_3mtse_plus_frr_vdxOuterVid_l2l1_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 mpls_label )
{
    ...
    if (SOC_DPP_CONFIG(unit)->pp.mpls_termination_database_mode == 21) {
       	program_property->vtt_table_index[0]   = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_VDxOUTERVID_SEM_B);
      	program_property->vtt_table_index[1]   = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L2_L12IDX_SEM_A);
        program_property->pd_bitmap_0          = (0x8);  /* ISB */
        program_property->pd_bitmap_1          = (0x10);  /* ISA */
    }
...
void arad_pp_dbal_vt_program_3mtse_plus_frr_vdxinitialvid_l2_l4b_l5g_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 mpls_label )
{
    ...
    if (SOC_DPP_CONFIG(unit)->pp.mpls_termination_database_mode == 21) {
    	...
    	program_property->vtt_table_index[0]   = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_VDxINITIALVID_SEM_B);
        program_property->vtt_table_index[1]   = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L2_L12IDX_SEM_A);
        program_property->pd_bitmap_0          = (0x8);  /* ISA */
        program_property->pd_bitmap_1          = (0x10);  /* ISB */
    }
...
void arad_pp_dbal_tt_program_l2tp_property_set (int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->processing_code    = ARAD_PP_ISEM_ACCESS_PROCESSING_CODE_TYPE_IP;/*CUSTOM_2; UNKNOWN_L3; IP;*/
...
int32 arad_pp_dbal_tt_cam_l2tp_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
	/* L2TP packets will have PFC=ARAD_PARSER_PFC_IPV4_ETH, PLC=ARAD_PARSER_PLC_PP_L4 & PFQ=0x80 from parser stage */
	prog_selection->packet_format_code		= ARAD_PARSER_PFC_IPV4_ETH;
	prog_selection->packet_format_code_mask = ARAD_PARSER_PFC_MATCH_ONE;
...
int32 arad_pp_dbal_tt_cam_3mtse_plus_frr_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 vtt_3mtse_plus_frr_type)
{
    ...
    switch(vtt_3mtse_plus_frr_type)
    {
        ...
        case VTT_3MTSE_PLUS_FRR_M3_PLUS_ELI_IML_SEM_HIT:
            prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS3_ETH; /* 3 labels */
            prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
            prog_selection->in_pp_port_tt_profile          =  (SOC_PPC_PORT_DEFINED_TT_PROFILE_DEFAULT);
            prog_selection->in_pp_port_tt_profile_mask     = (0x0);
            prog_selection->vt_processing_profile          = ARAD_PP_IHP_VTT_VT_PROCESSING_PROFILE_3MTSE_PLUS_FRR_TCAM;
    ...
    prog_selection->ptc_tt_profile_mask        = (0x0);
    prog_selection->my_mac                     = (0x1);
    prog_selection->my_mac_mask                = (0x0); /*change from 0 */
    prog_selection->enable_routing             = (0x1);
    prog_selection->enable_routing_mask        = (0x0);
    return -1;
