...
int soc_jer_dram_recovery_init(int unit)
{
    ...
    Yes means that the test is NOT masked
    No        bit 0 - Mask reject test based ib Cfg-DP-Level-Rjct-Th
    Yes       bit 1 - Mask BDB protect test
    No        bit 2 - Mask Q-Num-Overflow reject test
    No        bit 3 - Mask ISP-Duplicate reject test
    No        bit 4 - Mask MC-Error reject test
    No        bit 5 - Mask Resource-Error reject test
    No        bit 6 - Mask Q-Not-Valid reject test
    No        bit 7 - Mask Dram-Reject test
    ...
    Yes       bit 17 - Mask reject test based on VOQ Fair-Adaptive dynamic threshold
    ...
    No        bit 21 - Mask reject test based on VSQ max size reject
