...
STATIC int arad_nif_recover_ire_config_set(int unit, soc_pbmp_t* pbmp, int enable, arad_nif_recover_data_restore_t* data)
{
    ...
    SOCDNX_IF_ERR_EXIT(soc_reg32_get(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, &reg_val));
    if (enable) {
    ...
    SOCDNX_IF_ERR_EXIT(soc_reg32_set(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, reg_val));
