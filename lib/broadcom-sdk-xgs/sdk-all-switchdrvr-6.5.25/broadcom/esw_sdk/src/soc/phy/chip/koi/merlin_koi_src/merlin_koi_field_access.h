/**************************************************************************************
 **************************************************************************************
 *  File Name     :  merlin_koi_field_access.h                                        *
 *  Created On    :  29/04/2013                                                       *
 *  Created By    :  Kiran Divakar                                                    *
 *  Description   :  Serdes IP Register and Field access APIs                         *
 *  Revision      :  $Id: merlin_koi_field_access.h 924 2015-02-24 18:08:11Z eroes $ *
 *                                                                                    *
...
/** @file merlin_koi_field_access.h
 * Registers and field access
 */

#ifndef MERLIN_KOI_API_FIELD_ACCESS_H
#define MERLIN_KOI_API_FIELD_ACCESS_H
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_koi_pmd_rdt_field_byte(uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_koi_pmd_rdt_field_signed_byte(uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
