...
#define SOC_FE3200_FABRIC_LINKS_VSC128_MAX_CELL_SIZE        (128 /*data*/ + 8 /*header*/ + 1 /*CRC*/)
#define SOC_FE3200_FABRIC_LINKS_VSC256_MAX_CELL_SIZE        (256 /*data*/ + 16 /*header*/ + 1/*CRC*/)
#define SOC_FE3200_FABRIC_LINKS_ALDWP_MIN                   (0x2)

/*
 * Function:
 *      soc_fe3200_fabric_links_llf_control_source_set
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_links_llf_control_source_get
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_links_isolate_set
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_links_bmp_isolate_set
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_links_isolate_get
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_links_aldwp_config
 * Purpose:
    ...
    SOC_PBMP_ITER(pbmp, port_index)
    {
        ...
        switch (cell_type)
        {
            case soc_dfe_fabric_link_cell_size_VSC128:
                ...
                {
                    max_cell_size = 2 * SOC_FE3200_FABRIC_LINKS_VSC128_MAX_CELL_SIZE; /*2 cells are merged*/
                } else {
...
/*
 * Function:
 *      soc_fe3200_fabric_links_aldwp_init
 * Purpose:
...
soc_fe3200_fabric_links_aldwp_init(int unit)
{
    ...
    {
        rv = soc_fe3200_fabric_links_aldwp_config(unit, dch_instance *  nof_links_in_dcq/*First link in dch*/);
        SOCDNX_IF_ERR_EXIT(rv);
    }
...
/*
 * Function:
 *      soc_fe3200_fabric_links_validate_link
 * Purpose:
