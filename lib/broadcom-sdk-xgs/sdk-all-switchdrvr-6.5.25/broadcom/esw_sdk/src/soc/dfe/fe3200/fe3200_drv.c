...
soc_fe3200_set_mesh_topology_config(int unit) {
    ...
    if (SOC_DFE_IS_FE13(unit))
    {
        ...
        /* Workaround for fe3200 - consider change for next genration device*/
...

    {
        ...
        /*
         * Temp solution required in order to allow asic validation - should be removed after jericho 1588 implmentation
         */
        ...
        /*
         * Set to 0xc for now, need to verify correct value
         */
...
_soc_fe3200_drv_fabric_load_balancing_set(int unit, soc_dfe_load_balancing_mode_t load_balancing)
{
    ...
    {
        /*
         * Disable the feature of using simple load balancing at FE1 when inactive
         * links are up to a configured max.
         * This feature (up to configured max link down) takes one FE1 link down
         * for each FE3 inactive link, thus it shouldn't be enabled on asymmetric
         * mode, nor it should be enabled when we don't apply load balancing.
         */
...
soc_fe3200_reset_tables(int unit)
{
    ...
    /*RTP_MULTI_TB*/
    /**
     * In the loop later bellow not all entries are filled for the RTP_MULTI_TB.
     * If mbist is disabled this might cause an ECC interrupt to pop and force device reset.
     * Clear the table to make sure that this won't happened
     */
    SOC_REG_ABOVE_64_CLEAR(data);
...
soc_fe3200_drv_test_mem_filter(int unit, soc_mem_t mem, int *is_filtered)
{
    ...
    *is_filtered = 0;
    ...
    switch(mem) 
    {
        ...
        /*
         * Should be marked as Write only
         */
