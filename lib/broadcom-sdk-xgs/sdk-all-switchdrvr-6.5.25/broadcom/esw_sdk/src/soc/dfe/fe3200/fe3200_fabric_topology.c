...
/*
 * Function:
 *      soc_fe3200_fabric_topology_repeater_destination_set
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_topology_repeater_destination_get
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_link_topology_set
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_link_topology_get
 * Purpose:
...
/*
 * Function:
 *      soc_fe3200_fabric_topology_rmgr_set
 * Purpose:
...
soc_fe3200_fabric_topology_isolate_set(int unit, soc_dcmn_isolation_status_t val)
{
    ...
    if(soc_dcmn_isolation_status_active == val) {
        ...
        /*
         * The unicast tables are updated from the RTP maintenance table.
         * The table is divided to lines, and each line has a 'dirty bit'
         * that tells if this line has been changed.
         *
         * Since we disabled the update for 30ms, the maintenance table might have
         * been changed, but the unicast table don't. Now that we enabled back the
         * update they won't match, so we set all dirty bits to force the unicast
         * tables to update.
         *
         * The update is triggered upon changing the dirty bit from 0 to 1.
         * The bit won't reset automatically, so we return it manually to
         * it's previous state after the triggering.
         */
...
/*
 * Function:
 *      soc_fe3200_fabric_topology_isolate_get
 * Purpose:
