...
_hu_freeze_abort:
    ...
    case SOC_CHIP_BCM56070:
#endif /* BCM_FIRELIGHT_SUPPORT */
        {
            ...
            if (!err_flag && qgroup_entry_count) {
            ...
            if (!err_flag) {
                /* No error ever happened. Return the buffer. */
                *setting = buffer;
            } else {
                /* Error ever happened. Free the buffer. */
                if (buffer) {
                    sal_free(buffer);
                }
            }
    ...
    case SOC_CHIP_BCM56270:
        if (!(SAL_BOOT_SIMULATION || SAL_BOOT_BCMSIM
            ...
            if (enable == 0) {
                 ...
                 *****************************************************
                 */
                /* Synchronize linkscan thread with cosq APIs
                 * to avoid deadlocks */
...
#ifdef BCM_GREYHOUND2_SUPPORT
    case SOC_CHIP_BCM53570:
        SOC_IF_ERROR_RETURN(soc_gh2_port_eee_timers_setup(unit, port, speed));
        break;
#endif /* BCM_GREYHOUND2_SUPPORT */
    default :
        break;
...
#ifdef BCM_GREYHOUND2_SUPPORT
    case SOC_CHIP_BCM53570:
        SOC_IF_ERROR_RETURN(soc_gh2_port_eee_init(unit, port));
        SOC_IF_ERROR_RETURN(soc_gh2_port_eee_timers_setup(unit, port, speed));
        break;
#endif /* BCM_GREYHOUND2_SUPPORT */
