...
_soc_trident3_ser_mmu_mem_remap(_soc_ser_correct_info_t *spci)
{
    ...
    case MMU_MTRO_L2_MEM_A_PIPE0m:
    case MMU_MTRO_L2_MEM_B_PIPE0m:
        spci->mem = MMU_MTRO_L2_MEM_PIPE0m; break;
    case MMU_MTRO_L3_MEM_A_PIPE0m:
    case MMU_MTRO_L3_MEM_B_PIPE0m:
        spci->mem = MMU_MTRO_L3_MEM_PIPE0m; break;
