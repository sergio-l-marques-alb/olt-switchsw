            ...
            for (table = 0; info[table].error_field != INVALIDf; table++) {
                ...
                case _SOC_PARITY_INFO_TYPE_GENERIC:
                    ...
                    soc_event_generate(unit, SOC_SWITCH_EVENT_PARITY_ERROR,
                                       SOC_SWITCH_EVENT_DATA_ERROR_PARITY,
                                       0, minfo);
                    switch (info[table].enable_field) {
                        case START_BY_START_ERR_ENf:
                            ...
                            field = START_BY_START_ERRf;
                            break;
                        case DEQ0_CELLCRC_ERR_ENf:
                            field = DEQ0_CELLCRC_ERRf;
                            break;
                        case CFAP_MEM_FAIL_ENf:
                            field = CFAP_MEM_FAILf;
                            break;
                        case DEQ0_NOT_IP_ERR_ENf:
                            field = DEQ0_NOT_IP_ERRf;
                            break;
                        case MEM1_IPMC_TBL_PAR_ERR_ENf:
                            field = MEM1_IPMC_TBL_PAR_ERRf;
                            break;
                        case PFAP_MEM_FAIL_ENf:
                            field = PFAP_MEM_FAILf;
                            break;
                        default:
                            break;
                    }

                    /* Clear the field error indication */
                    if (field != INVALIDf) {
                        SOC_IF_ERROR_RETURN
