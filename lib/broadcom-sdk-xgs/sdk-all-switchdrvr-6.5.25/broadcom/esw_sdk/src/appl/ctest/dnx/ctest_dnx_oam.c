 ...
 */
#define GEN_VALUE_DELTA 0xCB

/** OAM group ID: number of bits, and bit mask */
#define OAM_GROUP_ID_NOF_BITS 15
#define OAM_GROUP_ID_MASK SAL_UPTO_BIT(OAM_GROUP_ID_NOF_BITS)

/** OAM endpoint ID: number of bits, and bit mask */
#define OAM_ENDPOINT_ID_NOF_BITS 16
#define OAM_ENDPOINT_ID_MASK SAL_UPTO_BIT(OAM_ENDPOINT_ID_NOF_BITS)

/** Bit for deciding - up-MEP or down-MEP */
#define UP_MEP_MASK SAL_BIT(0)

/** Bit for deciding - PP injection or Tx injection */
#define PP_INJECTION_MASK SAL_BIT(1)

/** VLAN: number of bits, and bit mask */
#define VLAN_NOF_BITS 8
#define VLAN_MASK SAL_UPTO_BIT(VLAN_NOF_BITS)

/** TTL: number of bits, and bit mask */
#define DNX_OAM_NOF_TTL_BITS 8
#define DNX_OAM_MAX_TTL SAL_UPTO_BIT(DNX_OAM_NOF_TTL_BITS)

/** MPLS/PWE label - number of bits, and maximum value */
#define DNX_OAM_NOF_MPLS_LABEL_BITS 20
#define DNX_OAM_MAX_MPLS_LABEL SAL_UPTO_BIT(DNX_OAM_NOF_MPLS_LABEL_BITS)

/** EXP: number of bits, and maximum value */
#define DNX_OAM_NOF_EXP_BITS 3
#define DNX_OAM_MAX_EXP SAL_UPTO_BIT(DNX_OAM_NOF_EXP_BITS)

/** Bit for deciding - ICC group or 48B MAID group? */
#define MAID48_MASK SAL_BIT(2)

/** OAM name: number of bits, and bit mask */
#define OAM_NAME_NOF_BITS 14
#define OAM_NAME_MASK SAL_UPTO_BIT(OAM_NAME_NOF_BITS)

/** RMEP name: number of bits, and bit mask */
#define OAM_RMEP_NAME_NOF_BITS 13
#define OAM_RMEP_NAME_MASK SAL_UPTO_BIT(OAM_RMEP_NAME_NOF_BITS)

/** MD level: number of bits, and bit mask */
#define OAM_LEVEL_NOF_BITS 3
#define OAM_LEVEL_MASK SAL_UPTO_BIT(OAM_LEVEL_NOF_BITS)

/** CCM period: number of bits, and maximum value */
#define DNX_OAM_NOF_CCM_PERIOD_BITS 10
#define DNX_OAM_MAX_CCM_PERIOD SAL_UPTO_BIT(DNX_OAM_NOF_CCM_PERIOD_BITS)

/** intf_id: LSB of gen_value determines FEC or out-LIF */
#define FEC_OR_OUT_LIF_BIT SAL_BIT(0)
#define ITF_ID_SHIFT 1

/** Bit for deciding - set intf_id or not */
#define INTF_ID_MASK SAL_BIT(0)

/** Number of VLANs - 0, 1, or 2 */
#define NOF_VALS_NOF_VLANS 3

/** TPID: number of bits, and bit mask */
#define TPID_NOF_BITS 16
#define TPID_MASK SAL_UPTO_BIT(TPID_NOF_BITS)

/** int_pri: number of bits, and bit mask */
#define INT_PRI_NOF_BITS 5
#define INT_PRI_MASK SAL_UPTO_BIT(INT_PRI_NOF_BITS)

/** pkt_pri: number of bits, and bit mask */
#define PKT_PRI_NOF_BITS 4
#define PKT_PRI_MASK SAL_UPTO_BIT(PKT_PRI_NOF_BITS)

/* Bit for deciding - RDI: 0 or 1? */
#define RDI_ON_LOC_FLAG SAL_BIT(1)

/** loc_clear_threshold: number of bits, and bit mask */
#define LOC_CLR_THRESH_NOF_BITS 2
#define LOC_CLR_THRESH_MASK SAL_UPTO_BIT(LOC_CLR_THRESH_NOF_BITS)

/** Lifetime: number of bits, and bit mask */
#define LIFETIME_NOF_BITS 10
#define LIFETIME_MASK SAL_UPTO_BIT(LIFETIME_NOF_BITS)

/** Punt good packet period: number of bits, and bit mask */
#define PUNT_GOOD_PERIOD_NOF_BITS 8
#define PUNT_GOOD_PERIOD_MASK SAL_UPTO_BIT(PUNT_GOOD_PERIOD_NOF_BITS)

/** Minimum allowed length for DM TLV */
#define TLV_MIN_LEN 4

/** Range of values used for length of DM TLV */
#define TLV_LEN_RANGE 252

/* Number of possible values for TLV port state */
#define TLV_NOF_PORT_STATES 3

/* Number of possible values for TLV interface state */
#define TLV_NOF_INTERFACE_STATES 8

/** MPLS label: number of bits, and maximum value */
#define MPLS_LABEL_NOF_BITS 20
#define MPLS_LABEL_MASK SAL_UPTO_BIT(MPLS_LABEL_NOF_BITS)
...
typedef struct
{
    ...
    /*
     * Group ID for the ICC group 
     */
    bcm_oam_group_t reg_group_id;

    /*
     * Group ID for the 48B MAID group 
     */
    bcm_oam_group_t maid48_group_id;
    ...
    /*
     * interface ID for mpls_out_gport 
     */
    bcm_if_t mpls_out_gport;
     ...
     * ACC profiles 
     */
    bcm_oam_profile_t ingress_acc_profile_id;
    bcm_oam_profile_t egress_acc_profile_id;

    /*
     * Limited number of profiles - not enough for each endpoint 
     */
    uint8 punt_good_packet_period;
} diag_dnx_oam_semantic_test_struct;

/** Ports used for ethernet endpoints */
const uint8 ports[] = {
    13,
    14,
    15,
