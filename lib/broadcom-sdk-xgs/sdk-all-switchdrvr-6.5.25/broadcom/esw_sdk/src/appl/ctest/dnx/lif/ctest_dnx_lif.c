...
shr_error_e ctest_dnx_global_lif_tag_test(
    int unit,
    args_t * args,
    sh_sand_control_t * sand_control);
...
extern sh_sand_man_t dnx_global_lif_tag_semantic_test_man;
...
sh_sand_cmd_t dnx_lif_test_cmds[] = {
    ...
    *************************************************************************************************************************************/
    ...
    {"global_lif_semantic", ctest_dnx_global_lif_basic_test, NULL, NULL, &dnx_global_lif_semantic_test_man, NULL, NULL,
     CTEST_POSTCOMMIT}
    ,
    {"global_lif_tag", ctest_dnx_global_lif_tag_test, NULL, NULL, &dnx_global_lif_tag_semantic_test_man, NULL, NULL,
     CTEST_POSTCOMMIT}
    ,
