    ...
    int *nof_ent_added)
{
    ...
    if (!sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_IPMC_IP6, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    {
        is_ipv6 = 1;
    }
    ...
    int *nof_ent_added)
{
    ...
    if (!sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_HOST_IP6, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    {
        is_ipv6 = 1;
    }
    ...
    int *nof_ent_added)
{
    ...
    if ((!sal_strncmp
         (result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP4_RPF, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
         || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_RPF,
                         SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)) && !split_rpf)
    {
    ...
    if ((!sal_strncmp
         (result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP4_FWD, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
         || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_FWD,
                         SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)) && split_rpf)
    {
        fwd_flags2 = BCM_L3_FLAGS2_FWD_ONLY;
    }

    if (!sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_FWD, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_RPF,
    ...
    if (is_ipv6)
    {
        ...
        if (!sal_strncmp
            (result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_RPF, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
        {
            /*
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (index = 0; index < max_result_types; index++)
    {
        ...
        if (!sal_strncmp
            (result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP4_FWD, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
            || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP4_RPF,
                            SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
            || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_FWD,
                            SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
            || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ROUTE_IP6_RPF,
         ...
         */
        if (!sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_HOST_IP4, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
            || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_HOST_IP6,
                            SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
        {
         ...
         */
        if (!sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_IPMC_IP4, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
            || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_IPMC_IP6,
                            SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
        {
    ...
    for (index = 0; index < max_result_types; index++)
    {
        ...
        for (ent_opcode = 0; ent_opcode < 4; ent_opcode++)
        {
             ...
             */
            if (!sal_strncmp
                (result_type, CTEST_DNX_KBP_RESULT_TYPE_HOST_IP4, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
                || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_HOST_IP6,
                                SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
            {
             ...
             */
            if (!sal_strncmp
                (result_type, CTEST_DNX_KBP_RESULT_TYPE_IPMC_IP4, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
                || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_IPMC_IP6,
                                SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
            {
...
sh_sand_invoke_t dnx_kbp_multi_result_types_capacity_fwd_tests[] = {
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S0, CTEST_DNX_KBP_SCENARIO "=Scenario0", CTEST_POSTCOMMIT}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S1, CTEST_DNX_KBP_SCENARIO "=Scenario1", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S2, CTEST_DNX_KBP_SCENARIO "=Scenario2", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S3, CTEST_DNX_KBP_SCENARIO "=Scenario3", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S4, CTEST_DNX_KBP_SCENARIO "=Scenario4", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S5, CTEST_DNX_KBP_SCENARIO "=Scenario5", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S6, CTEST_DNX_KBP_SCENARIO "=Scenario6", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S7, CTEST_DNX_KBP_SCENARIO "=Scenario7", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S8, CTEST_DNX_KBP_SCENARIO "=Scenario8", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S9, CTEST_DNX_KBP_SCENARIO "=Scenario9", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S10, CTEST_DNX_KBP_SCENARIO "=Scenario10", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S11, CTEST_DNX_KBP_SCENARIO "=Scenario11", CTEST_WEEKEND}
    ,
    /*
     * Fail to re-add the deleted IPMC entries(see won't fix JIRA SDK-210028). Keep it here for further usage
     * {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FWD_S12, CTEST_DNX_KBP_SCENARIO "=Scenario12 " CTEST_DNX_KBP_MULTI_RST_TYPE_READD "=YES"} ,
     */
    {NULL}
};
    ...
    bcm_field_group_t * fg_id)
{
    ...
    if (!sal_strncmp
        (result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY80_ACT32, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY80_ACT64,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY80_ACT128,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    {
        key_size = 80;
    }
    if (!sal_strncmp
        (result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY160_ACT32, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY160_ACT64,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY160_ACT128,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    {
        key_size = 160;
    }
    if (!sal_strncmp
        (result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY320_ACT32, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY320_ACT64,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY320_ACT128,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    {
        key_size = 320;
    }
    ...
    if (!sal_strncmp
        (result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY80_ACT128, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY160_ACT128,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY320_ACT128,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    ...
    if (!sal_strncmp
        (result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY80_ACT64, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY160_ACT64,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY320_ACT64,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    ...
    if (!sal_strncmp
        (result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY80_ACT32, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY160_ACT32,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)
        || !sal_strncmp(result_type, CTEST_DNX_KBP_RESULT_TYPE_ACL_KEY320_ACT32,
                        SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
    {
        res_length = 32;
    }
    ...
    /** Do not perform testing on 360b key(see won't fix JIRA SDK-189916) */
...
sh_sand_invoke_t dnx_kbp_multi_result_types_capacity_acl_tests[] = {
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S0, CTEST_DNX_KBP_SCENARIO "=Scenario0", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S1, CTEST_DNX_KBP_SCENARIO "=Scenario1", CTEST_POSTCOMMIT}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S2, CTEST_DNX_KBP_SCENARIO "=Scenario2", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S3, CTEST_DNX_KBP_SCENARIO "=Scenario3", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S4, CTEST_DNX_KBP_SCENARIO "=Scenario4", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S5, CTEST_DNX_KBP_SCENARIO "=Scenario5", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_ACL_S6, CTEST_DNX_KBP_SCENARIO "=Scenario6", CTEST_WEEKEND}
    ,
    {NULL}
};
...
sh_sand_invoke_t dnx_kbp_multi_result_types_capacity_fwd_acl_tests[] = {
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FwdACL_S0, CTEST_DNX_KBP_SCENARIO "=Scenario0", CTEST_POSTCOMMIT}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FwdACL_S1, CTEST_DNX_KBP_SCENARIO "=Scenario1", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FwdACL_S2, CTEST_DNX_KBP_SCENARIO "=Scenario2", CTEST_WEEKEND}
    ,
    {CTEST_DNX_KBP_MULTI_RST_TYPE_CAP_TEST_FwdACL_S3, CTEST_DNX_KBP_SCENARIO "=Scenario3", CTEST_WEEKEND}
    ,
    {NULL}
};
