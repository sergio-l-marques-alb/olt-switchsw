    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, 0, &fg_info, &fg_id_1));
    sal_strncpy_s((char *) fg_info.name, "fg_name_2", sizeof(fg_info.name));
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, 0, &fg_info, &fg_id_2));
     ...
     */
    {
        ...
        DNX_FIELD_STAGE_ITERATOR(dnx_field_stage_it, field_map_stage_info)
        {
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (sal_strncasecmp(vw_test_type_name, TEST_TYPE_STAGE_MAP, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
    ...
    else if (sal_strncasecmp(vw_test_type_name, TEST_TYPE_NAME_MAP, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
