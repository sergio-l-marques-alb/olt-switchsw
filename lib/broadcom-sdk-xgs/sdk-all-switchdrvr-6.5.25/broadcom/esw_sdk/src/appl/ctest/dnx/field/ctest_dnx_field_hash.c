    ...
    dnx_field_context_hash_info_t * set_hash_info_p)
{
    ...
    hash_get_info.hash_config[0].action_key = DBAL_ENUM_FVAL_FIELD_HASH_LB_KEY_ADDITIONAL_LB;
    ...
    if (set_hash_info_p->hash_config[0].hash_action != hash_get_info.hash_config[0].hash_action)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "set_hash_info_p hash_action (0x%08X) is not the same as hash_get_info hash_action (0x%08X)\r\n",
                     set_hash_info_p->hash_config[0].hash_action, hash_get_info.hash_config[0].hash_action);
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    else if (test_type == 1)
    {
        ...
        */
        ...
        hash_info.hash_config[0].action_key = DBAL_ENUM_FVAL_FIELD_HASH_LB_KEY_ADDITIONAL_LB;
        hash_info.hash_config[0].hash_action = DBAL_ENUM_FVAL_HASH_ACTION_REPLACE_CRC;
