    ...
    int unit)
{
    ...
    sal_memset(&replace_profile_data, 0, sizeof(replace_profile_data));
     ...
     */
    /*
     * The old_profile is not equal to the nof_profiles
     */
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    sal_memset(&profile_data, 0, sizeof(profile_data));
    sal_memset(&allocate_profile_data, 0, sizeof(allocate_profile_data));
