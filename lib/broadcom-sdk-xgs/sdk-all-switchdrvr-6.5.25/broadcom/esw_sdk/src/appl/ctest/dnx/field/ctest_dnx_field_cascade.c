...
#define DIAG_CASCADE_IPMF1_QUAL_DP            (DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_QUAL_DP))
#define DIAG_CASCADE_IPMF1_ACTION_CONTAINER   (DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_ACTION_GENERAL_DATA3))

/** Qualifier and action type configured for iPMF2*/
#define DIAG_CASCADE_IPMF2_QUAL_CONTAINER_1   (DNX_QUAL(DNX_FIELD_QUAL_CLASS_META2, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_QUAL_KEY_F_INITIAL))
...
#define DIAG_CASCADE_IPMF2_ACTION_DP          (DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_ACTION_DST_DATA))

/** Qualifier and action type configured for iPMF3*/
#define DIAG_CASCADE_IPMF3_QUAL_CONTAINER     (DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_QUAL_GENERAL_DATA_PMF_CONTAINER))
#define DIAG_CASCADE_IPMF3_ACTION_DP          (DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_ACTION_DP))
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if ((sal_strncasecmp
         (cascade_test_type_name, TEST_TYPE_CASC_IPMF1_IPMF2, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
        ||
        (sal_strncasecmp
         (cascade_test_type_name, TEST_TYPE_CASC_IPMF1_IPMF2_SHARE, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0))
    {
        ...
        SHR_IF_ERR_EXIT(appl_dnx_cascade_ipmf1_ipmf2_fes_compare
                        (unit, context_ipmf1, context_ipmf2,
                         (sal_strncasecmp
                          (cascade_test_type_name, TEST_TYPE_CASC_IPMF1_IPMF2_SHARE,
        ...
        if (field_cascade_test_clean)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_field_qual_destroy(unit, udq_bcm_id));
             ...
             (cascade_test_type_name, TEST_TYPE_CASC_IPMF1_IPMF3, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
