 ...
 * \remark
 *   Currently, it will be executed only for regression.
 */
...
static bcm_field_action_t
    Ctest_dnx_field_user_actions_action_array_raw[CTEST_DNX_FIELD_USER_ACTIONS_NOF_STAGES] = {
/**
 * IPMF1/2
 */
...
static bcm_field_action_t
    Ctest_dnx_field_user_actions_action_array_non_raw[CTEST_DNX_FIELD_USER_ACTIONS_NOF_STAGES] = {
/**
 * IPMF1/2
 */
    bcmFieldActionSnoop,
...
ctest_dnx_field_user_actions_compare(
    ...
    bcm_field_action_t bcm_action_pre_raw,
    dnx_field_action_in_info_t * set_action_info_p)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_user_action_get(unit, bcm_action_id, &get_action_info));
     /**
    ...
    if (get_action_info.bcm_action != bcm_action_pre_raw)
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL,
                     "dnx_field_action_get: Unexpected data returned.\n"
    ...
    bcm_field_action_info_t * set_action_info_p)
{
    ...
    if (get_action_info.action_type != bcm_action_pre_raw)
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL,
                     "dnx_field_action_get: Unexpected data returned.\n"
    ...
    dnx_field_action_in_info_t * action_info_p)
{
    ...
    int rv;
    bcm_field_action_t bcm_base_action_raw;
    bcm_field_action_t bcm_base_action_non_raw;
    SHR_FUNC_INIT_VARS(unit);
         ...
         action_indx++)
    {
        ...
        {
            bcm_base_action_raw = bcmFieldActionVoid;
            bcm_base_action_non_raw = bcmFieldActionVoid;
        }
        else
        {
            bcm_base_action_raw = Ctest_dnx_field_user_actions_action_array_raw[field_stage];
            bcm_base_action_non_raw = Ctest_dnx_field_user_actions_action_array_non_raw[field_stage];
        }
        ...
        SHR_IF_ERR_EXIT(ctest_dnx_field_user_actions_compare(unit, bcm_action_id, bcm_base_action_raw, action_info_p));
         /**
          * Print the action
          */
        ...
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ...
                    __LINE__, dnx_field_stage_e_get_name(field_stage), dnx_action_id);
        rv = dnx_field_user_action_get(unit, bcm_action_id, action_info_p);
    ...
    bcm_field_action_info_t * action_info_p)
{
         ...
         action_indx++)
    {
        ...
        {
            bcm_base_action_raw = Ctest_dnx_field_user_actions_action_array_raw[dnx_field_stage];
            bcm_base_action_non_raw = Ctest_dnx_field_user_actions_action_array_non_raw[dnx_field_stage];
        }
        if (action_indx == CTEST_DNX_FIELD_USER_ACTIONS_POSITIVE_TEST_WITH_ID)
        {
        ...
        SHR_IF_ERR_EXIT(ctest_dnx_field_user_actions_compare_bcm
                        (unit, bcm_action_id, bcm_base_action_raw, action_info_p));
        /**
        ...
        if (action_indx != CTEST_DNX_FIELD_USER_ACTIONS_POSITIVE_TEST_VOID)
        {
            ...
            SHR_IF_ERR_EXIT(bcm_field_action_value_map
                            (unit, bcm_field_stage, bcm_base_action_non_raw, bcm_value, hw_value));
    ...
    _shr_error_t * expected_error_p)
{
         ...
         negative_case_iterator < CTEST_DNX_FIELD_USER_ACTIONS_NOF; negative_case_iterator++)
    {
        ...
        negative_test_actions = Ctest_dnx_field_user_actions_action_array_non_raw[field_stage];
        user_action_size = CTEST_DNX_FIELD_USER_ACTIONS_USER_ACTION_SIZE;
        user_create_action_flags = 0;
        rv = BCM_E_NONE;
    ...
    _shr_error_t * expected_error_p)
{
         ...
         negative_case_iterator < CTEST_DNX_FIELD_USER_ACTIONS_NOF - 1; negative_case_iterator++)
    {
        ...
        negative_test_actions = Ctest_dnx_field_user_actions_action_array_non_raw[dnx_field_stage];
        user_action_size = CTEST_DNX_FIELD_USER_ACTIONS_USER_ACTION_SIZE;
        user_create_action_flags = 0;
        rv = BCM_E_NONE;
        LOG_INFO_EX(BSL_LOG_MODULE, "%s(), line %d, Stage: %s NEGATIVE TESTING! CASE: %d \r\n",
        ...
        */
        ...
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Negative test case: %d has failed! expected rv=%d result rv=%d\r\n",
                         negative_case_iterator, expected_error_p[negative_case_iterator - 1], rv);
        }
    }

    /*
     * Create two actions with the same name
     */
    {
        shr_error_e rv;
        bcm_field_action_t bcm_action_id_1;
        bcm_field_action_t bcm_action_id_2;
        char name[] = "Identical_name";
        bcm_field_action_info_t action_info;

        bcm_field_action_info_t_init(&action_info);
        action_info.stage = bcm_field_stage;
        ...
        SHR_IF_ERR_EXIT(bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_1));
        bcm_field_action_info_t_init(&action_info);
        action_info.stage = bcm_field_stage;
        ...
        action_info.prefix_size = 0;
        sal_strncpy_s((char *) (action_info.name), name, sizeof(action_info.name));
        rv = bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_2);
        if (rv != _SHR_E_EXISTS)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected error %d, but received %d when creating two actions with identical names.\r\n",
                         _SHR_E_EXISTS, rv);
        }
        SHR_IF_ERR_EXIT(bcm_field_action_destroy(unit, bcm_action_id_1));
    }
    /*
     * Create two actions with the same name except for a different case.
     */
    {
        shr_error_e rv;
        bcm_field_action_t bcm_action_id_1;
        ...
        action_info.size = 3;
        action_info.prefix_size = 0;
        sal_strncpy_s((char *) (action_info.name), name_1, sizeof(action_info.name));
        SHR_IF_ERR_EXIT(bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_1));
        bcm_field_action_info_t_init(&action_info);
        action_info.stage = bcm_field_stage;
        action_info.action_type = bcmFieldActionDropPrecedence;
        action_info.size = 2;
        action_info.prefix_size = 0;
        sal_strncpy_s((char *) (action_info.name), name_2, sizeof(action_info.name));
        rv = bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_2);
        if (rv != _SHR_E_EXISTS)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
    ...
    /*
     * Create an action with a name identical to a predefined defined name.
     */
    {
        shr_error_e rv;
        bcm_field_action_t bcm_action_id_1;
        bcm_field_action_info_t action_info;
        bcm_field_action_info_t predef_action_info_get;

        SHR_IF_ERR_EXIT(bcm_field_action_info_get
                        (unit, bcmFieldActionSnoop, bcmFieldStageIngressPMF1, &predef_action_info_get));
        ...
        action_info.size = 3;
        action_info.prefix_size = 0;
        sal_strncpy_s((char *) (action_info.name), (char *) (predef_action_info_get.name), sizeof(action_info.name));
        rv = bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_1);
        if (rv != _SHR_E_EXISTS)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected error %d, but received %d when creating an action with the name of a "
                         "predefines one.\r\n", _SHR_E_EXISTS, rv);
        }
    }
    /*
     * Create two actions with the same name with full size (without NULL)
     */
    {
        shr_error_e rv;
        bcm_field_action_t bcm_action_id_1;
        ...
        action_info.size = 3;
        action_info.prefix_size = 0;
        for (char_index = 0; char_index < sizeof(action_info.name); char_index++)
        {
            action_info.name[char_index] = 'a';
        }
        SHR_IF_ERR_EXIT(bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_1));
        bcm_field_action_info_t_init(&action_info);
        action_info.stage = bcm_field_stage;
        ...
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected error %d, but received %d when creating two actions with identical names at full size.\r\n",
                         _SHR_E_EXISTS, rv);
        }
        SHR_IF_ERR_EXIT(bcm_field_action_destroy(unit, bcm_action_id_1));
    }
    /*
     * Create two actions with the same name until the last character. Fails becasue last charachter isn't copied.
     */
    {
        shr_error_e rv;
        bcm_field_action_t bcm_action_id_1;
        bcm_field_action_t bcm_action_id_2;
        bcm_field_action_info_t action_info;
        bcm_field_action_info_t action_info_get_1;
        int char_index;
        ...
        action_info.name[sizeof(action_info.name) - 1] = 'b';
        rv = bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_2);
        if (rv != _SHR_E_EXISTS)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected error %d, but received %d when creating two actions with identical names at full size minus one.\r\n",
                         _SHR_E_EXISTS, rv);
        }
        SHR_IF_ERR_EXIT(bcm_field_action_info_get(unit, bcm_action_id_1, bcm_field_stage, &action_info_get_1));
        if (action_info_get_1.name[sizeof(action_info.name) - 2] != 'a')
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected character before last to be %d, but is %d.\r\n",
                         'a', action_info_get_1.name[sizeof(action_info.name) - 2]);
        }
        if (action_info_get_1.name[sizeof(action_info.name) - 1] != '\0')
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected last character to be %d (NULL), but is %d.\r\n",
                         '\0', action_info_get_1.name[sizeof(action_info.name) - 1]);
        }
        SHR_IF_ERR_EXIT(bcm_field_action_destroy(unit, bcm_action_id_1));
    }
    /*
     * Create two actions with the same name until one before last character.
     */
    {
        bcm_field_action_t bcm_action_id_1;
        bcm_field_action_t bcm_action_id_2;
        bcm_field_action_info_t action_info;
        bcm_field_action_info_t action_info_get_1;
        bcm_field_action_info_t action_info_get_2;
        int char_index;
        ...
        action_info.name[sizeof(action_info.name) - 2] = 'b';
        action_info.name[sizeof(action_info.name) - 1] = 'c';
        SHR_IF_ERR_EXIT(bcm_field_action_create(unit, 0, &action_info, &bcm_action_id_2));
        SHR_IF_ERR_EXIT(bcm_field_action_info_get(unit, bcm_action_id_1, bcm_field_stage, &action_info_get_1));
        if (action_info_get_1.name[sizeof(action_info.name) - 3] != 'a')
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
        ...
        SHR_IF_ERR_EXIT(bcm_field_action_info_get(unit, bcm_action_id_2, bcm_field_stage, &action_info_get_2));
        if (action_info_get_2.name[sizeof(action_info.name) - 3] != 'a')
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected 2 character before last to be %d, but is %d.\r\n",
                         'a', action_info_get_2.name[sizeof(action_info.name) - 2]);
        }
        if (action_info_get_2.name[sizeof(action_info.name) - 2] != 'b')
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected character before last to be %d, but is %d.\r\n",
                         'a', action_info_get_2.name[sizeof(action_info.name) - 2]);
        }
        if (action_info_get_2.name[sizeof(action_info.name) - 1] != '\0')
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
                         "Expected last character to be %d (NULL), but is %d.\r\n",
                         '\0', action_info_get_2.name[sizeof(action_info.name) - 1]);
        }
        SHR_IF_ERR_EXIT(bcm_field_action_destroy(unit, bcm_action_id_1));
        SHR_IF_ERR_EXIT(bcm_field_action_destroy(unit, bcm_action_id_2));
    }
