    ...
    sh_sand_control_t * sand_control)
{
    ...
    else
    {
         ...
         */
        if (sal_strncasecmp(types_table_val->strval, "dnxf data", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
        {
            LOG_ERROR(BSL_LOG_MODULE,
...
static sh_sand_man_t dnxf_data_test_support_man = {
    .brief = "Test DNX Data behavior on unsupported features"
};

static sh_sand_man_t dnxf_data_test_types_man = {
    .brief = "Test DNX Data different types support"
};

static sh_sand_man_t dnxf_data_test_property_man = {
    .brief = "Test DNX Data behavior on different properties"
};
