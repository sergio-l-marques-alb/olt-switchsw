...
sh_sand_invoke_t sh_dnxc_infra_init_parallel_tests[] = {
    {"",        "",         CTEST_POSTCOMMIT * CTEST_SKIPPABLE},
    {"partial", "partial",  CTEST_POSTCOMMIT * CTEST_SKIPPABLE},
    {"mgmt",    "mgmt",     SH_CMD_SKIP_EXEC * CTEST_SKIPPABLE},
    {NULL}
};
        ...
        utilex_seq_step_t ** step_list)
{
    ...
    {
        /** Convert dnxf list to utilex list */
...
sh_sand_invoke_t sh_dnxc_infra_init_step_name_verify_test[] = {
    {"all_steps",   "",  CTEST_POSTCOMMIT * CTEST_SKIPPABLE},
    {NULL}
};
...
/**
 *  \brief - Write step time to regression DB for arrakis stats module
 *   */
static shr_error_e
diag_dnxc_infra_save_time_in_arrakis_db(
    int unit,
    int test_time)
{
...
#ifdef BCM_DNX_SUPPORT
    /** Save in regression DB for Arrakis stats module*/
    SHR_IF_ERR_EXIT(arrakis_stat_family_init(unit, &stat_family, "INIT"));
    SHR_IF_ERR_EXIT(arrakis_stat_family_int_fill(unit, &stat_family, "Duration(us)", test_time));
    ...
    utilex_seq_t seq)
{
    ...
    SHR_CLI_EXIT_IF_ERR(utilex_seq_time_test_run(unit, &seq, first_step_id, step_nof_iterations, &test_info_fail,
                                                 &test_info_success, debug_flag, coefficient, diag_dnxc_infra_save_time_in_arrakis_db),
...
sh_sand_cmd_t dnxc_infra_init_test_cmds[] = {
    {"ERRor_RECovery", diag_dnxc_infra_init_error_recovery_test_cmd, NULL,
     ...
     NULL, NULL, CTEST_POSTCOMMIT * CTEST_SKIPPABLE, diag_dnxc_infra_init_error_recovery_tests_creation},

    {"TIME", diag_dnxc_infra_init_time_test_cmd, NULL,
    diag_dnxc_infra_init_test_options, &diag_dnxc_infra_init_time_test_man,
    NULL, NULL, CTEST_POSTCOMMIT * CTEST_SKIPPABLE * CTEST_ADAPTER_UNSUPPORTED, diag_dnxc_infra_init_time_tests_creation},

    {"APPL_TIME", diag_dnxc_infra_appl_init_time_test_cmd, NULL,
    diag_dnxc_infra_init_test_options, &diag_dnxc_infra_init_time_test_man,
    NULL, NULL, CTEST_POSTCOMMIT * CTEST_SKIPPABLE * CTEST_ADAPTER_UNSUPPORTED, diag_dnxc_infra_appl_time_tests_creation},
    ...
    {"PaRaLLel", sh_dnxc_infra_init_parallel_test_cmd, NULL,
     ...
     NULL, sh_dnxc_infra_init_parallel_tests, CTEST_POSTCOMMIT * CTEST_SKIPPABLE},
