    ...
    sh_sand_control_t * sand_control)
{
    ...
    /** capacity for adapter is configured to 1000
     * Several global LIF is used for OAM trap
     */
    nof_entries = 990;
#endif
    ...
    sal_printf("Adding L3 ARP entries...\n");
    ...
    sal_printf("Clearing the L3 ARP table\n");
    bcm_l3_egress_t_init(&arp_entry);
    ...
    sal_printf("AVERAGE time for bcm_l3_egress_create - %u us, expected approximately %d us\n",
               (total_time[0] / nof_entries), average_time[0]);
    sal_printf("AVERAGE time for bcm_l3_egress_destroy - %u us, expected approximately %d us\n",
