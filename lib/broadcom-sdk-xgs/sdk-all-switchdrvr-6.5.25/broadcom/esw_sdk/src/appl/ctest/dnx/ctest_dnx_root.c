...
extern sh_sand_cmd_t dnx_sec_test_cmds[];
extern sh_sand_cmd_t dnx_lif_test_cmds[];
extern sh_sand_cmd_t dnx_ipfix_test_cmds[];
...
extern sh_sand_cmd_t dnx_qos_test_cmds[];
...
extern sh_sand_cmd_t dnx_mrps_test_cmds[];
...
extern sh_sand_cmd_t dnx_arrakis_stats_cmds[];
...
sh_sand_cmd_t sh_dnx_ctest_commands[] = {
   /* Name           | Leaf Action | Junction Array Pointer   | Option list for leaf | Man page         | Dynamic Option CB   */
    ...
    {"apt",            NULL,                dnx_apt_cmds, .label="apt"},
    {"arrakis",        NULL,                dnx_arrakis_stats_cmds},
    ...
    {"ipfix",          NULL,                dnx_ipfix_test_cmds},
    ...
    {"INFRAstructure", NULL,                dnx_infra_test_cmds, .label="INFRAstructure"},
    {"srv6",           NULL,                dnx_srv6_test_cmds},
    {"flow",           NULL,                dnx_flow_test_cmds},
    {"dbal",           NULL,                dnx_dbal_test_cmds, .label="dbal"}, /* Must be the last before NULL */
