...
#define DNX_ALGO_CHM_UNIT_TEST_7 "chm unit testing seven"
    ...
    sh_sand_control_t * sand_control)
{
     ...
     */
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, 1, 1, DNX_ALGO_CHM_UNIT_TEST_1, &cbs, &chm_handle));
        /** 2. destroy */
     ...
     */
    {
        ...
        /** 1. create  */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, 1, 1, DNX_ALGO_CHM_UNIT_TEST_2, &cbs, &chm_handle));
        /** 2. allocate */
        dummy_hw_unique_id_to_profile_table[0] = 0;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 0, 0, DNX_CHM_UNITTEST_0, 1, 0, 2, 2, NULL, NULL, NULL));
                                                                                /** 8 entries in table */
        dummy_hw_unique_id_to_profile_table[1] = 1;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 1, 0, DNX_CHM_UNITTEST_1, 1, 0, 5, 5, NULL, NULL, NULL));
                                                                                /** 16 entries in table */
        dummy_hw_unique_id_to_profile_table[2] = 2;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 2, 0, DNX_CHM_UNITTEST_2, 1, 0, 6, 6, NULL, NULL, NULL));
                                                                                /** 32 entries in table */
        dummy_hw_unique_id_to_profile_table[3] = 3;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 3, 0, DNX_CHM_UNITTEST_3, 1, 0, 8, 8, NULL, NULL, NULL));
                                                                                /** 64 entries in table */
        dummy_hw_unique_id_to_profile_table[4] = 4;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 4, 0, DNX_CHM_UNITTEST_4, 1, 0, 20, 20, NULL, NULL, NULL));
                                                                                  /** 128 entries in table */
        dummy_hw_unique_id_to_profile_table[5] = 5;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 5, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 30, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[6] = 6;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 6, 0, DNX_CHM_UNITTEST_5, 1, 0, 31, 31, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[7] = 7;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 7, 0, DNX_CHM_UNITTEST_5, 1, 0, 32, 32, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[8] = 8;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 8, 0, DNX_CHM_UNITTEST_5, 1, 0, 33, 33, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[9] = 9;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 9, 0, DNX_CHM_UNITTEST_5, 1, 0, 34, 34, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[10] = 10;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 10, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 35, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[11] = 11;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 11, 0, DNX_CHM_UNITTEST_5, 1, 0, 36, 36, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[12] = 12;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 12, 0, DNX_CHM_UNITTEST_5, 1, 0, 37, 37, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[13] = 13;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 13, 0, DNX_CHM_UNITTEST_5, 1, 0, 38, 38, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[14] = 14;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 14, 0, DNX_CHM_UNITTEST_5, 1, 0, 39, 39, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[15] = 15;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 15, 0, DNX_CHM_UNITTEST_5, 1, 0, 40, 40, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[16] = 16;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 16, 0, DNX_CHM_UNITTEST_5, 1, 0, 41, 41, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[17] = 17;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 17, 0, DNX_CHM_UNITTEST_5, 1, 0, 42, 42, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 18, 0, DNX_CHM_UNITTEST_5, 1, 0, 43, 43, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[19] = 19;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 19, 0, DNX_CHM_UNITTEST_5, 1, 0, 44, 44, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        /** 3,4. try to allocate when full - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, 0, DNX_CHM_UNITTEST_5, 1, 0, 45,
                                                               45, NULL, NULL, NULL);
                                                                                  /** 256 entries in table */
        if (rv == _SHR_E_NONE)
        {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 20, 0, DNX_CHM_UNITTEST_5, 1, 0, 38, 38, NULL, NULL, NULL));
     ...
     */
    {
        ...
        /** 0.create */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, 1, 1, DNX_ALGO_CHM_UNIT_TEST_3, &cbs, &chm_handle));
        /** 1.try illigeal allocation - current > max - expect failure */
        dummy_hw_unique_id_to_profile_table[0] = 0;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 0, 0, DNX_CHM_UNITTEST_0, 1, 0, 2, 4,
                                                               NULL, NULL, NULL);
                                                                               /** 8 entries in table */
        if (rv == _SHR_E_NONE)
        {
        ...
        dummy_hw_unique_id_to_profile_table[0] = 0;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 0, 0, DNX_CHM_UNITTEST_0, 1, 0, 4, 2, NULL, NULL, NULL));
                                                                                /** 8 entries in table */
        /** 3.alloc partial profile with specific members */
        dummy_hw_unique_id_to_profile_table[1] = 1;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 1, 0, DNX_CHM_UNITTEST_1, 1, 0, 5, 3, specific_member_array_0, NULL, NULL));
                                                    /** 16 entries in table */
        ...
        dummy_hw_unique_id_to_profile_table[6] = 6;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 6, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 25, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[7] = 7;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 7, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 25, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[8] = 8;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 8, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 25, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[9] = 9;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 9, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 22, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[10] = 10;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 10, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[11] = 11;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 11, 0, DNX_CHM_UNITTEST_5, 1, 0, 30, 28, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[12] = 12;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 12, 0, DNX_CHM_UNITTEST_5, 1, 0, 37, 30, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[13] = 13;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 13, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 30, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[14] = 14;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 14, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 32, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[15] = 15;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 15, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[16] = 16;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 16, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[17] = 17;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 17, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 18, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[19] = 19;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 19, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 3, specific_member_array_0, NULL,
                         NULL));
                                                       /** 256 entries in table */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, 0, DNX_CHM_UNITTEST_5, 1, 0, 45,
                                                               45, NULL, NULL, NULL);
        ...
        /** 5.allocate partial that similar to partial that was already allocated - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, 0, DNX_CHM_UNITTEST_5, 1, 0, 35,
                                                               22, NULL, NULL, NULL);
                                                                                  /** 256 entries in table */
        if (rv == _SHR_E_NONE)
        {
        ...
        /** 6.allocate partial with specific members similar to partial that was already allocated - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, 0, DNX_CHM_UNITTEST_5, 1, 0, 35, 3,
     ...
     */
    {
        ...
        /** 1.create  */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, 1, 1, DNX_ALGO_CHM_UNIT_TEST_4, &cbs, &chm_handle));
        /** 2.add full member till full   */
        dummy_hw_unique_id_to_profile_table[0] = 0;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 0, 0, DNX_CHM_UNITTEST_0, 1, 0, 2, 2, NULL, NULL, NULL));
        ...
        dummy_hw_unique_id_to_profile_table[20] = 20;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 20, 0, DNX_CHM_UNITTEST_5, 1, 0, 40, 40, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        /** 6.remove member from profile */
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 21, 0, DNX_CHM_UNITTEST_5, 1, 0, 40, 40, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        /** 10.free all */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 20, DNX_CHM_UNITTEST_5));
     ...
     */
    {
        ...
        /** create  */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, 1, 1, DNX_ALGO_CHM_UNIT_TEST_5, &cbs, &chm_handle));
        ...
        for (int i = 0; i < nof_iterations; ++i)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                            (unit, chm_handle, unique_id, 0, profile_type, 1, 0, max_nof_members_in_profile,
     ...
     */
    {
        ...
        /** create  */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, 1, 1, DNX_ALGO_CHM_UNIT_TEST_6, &cbs, &chm_handle));
        ...
        dummy_hw_unique_id_to_profile_table[1] = 1;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 1, 0, DNX_CHM_UNITTEST_0, 1, 0, 2, 2, NULL, NULL, NULL));
        /** 8 entries, 0 new ones (total 8 / 4096) */
        dummy_hw_unique_id_to_profile_table[2] = 2;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 2, 0, DNX_CHM_UNITTEST_0, 1, 0, 2, 2, NULL, NULL, NULL));
        /** 8 entries, 8 new ones (total 16 / 4096) */
        dummy_hw_unique_id_to_profile_table[3] = 3;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 3, 0, DNX_CHM_UNITTEST_0, 1, 0, 2, 1, NULL, NULL, NULL));
        /** 16 entries, 16 new ones (total 32 / 4096) */
        dummy_hw_unique_id_to_profile_table[4] = 4;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 4, 0, DNX_CHM_UNITTEST_0, 2, 0, 2, 2, NULL, NULL, NULL));
        /** 16 entries, 16 new ones (total 48 / 4096) */
        dummy_hw_unique_id_to_profile_table[5] = 5;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 5, 0, DNX_CHM_UNITTEST_0, 2, 0, 2, 1, NULL, NULL, NULL));
        /** attempt to add an invalid amount */
        dummy_hw_unique_id_to_profile_table[6] = 6;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 6, 0, DNX_CHM_UNITTEST_0, 3, 1, 4, 4,
                                                               NULL, NULL, NULL);
        if (rv == _SHR_E_NONE)
        {
        ...
        dummy_hw_unique_id_to_profile_table[6] = 6;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 6, 0, DNX_CHM_UNITTEST_0, 4, 2, 2, 1, NULL, NULL, NULL));
        /** 64 entries, 64 new ones (total 144 / 4096) */
        dummy_hw_unique_id_to_profile_table[7] = 7;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 7, 0, DNX_CHM_UNITTEST_0, 8, 5, 2, 1, NULL, NULL, NULL));
        /** 64 entries, 64 new ones (total 208 / 4096) */
        dummy_hw_unique_id_to_profile_table[8] = 8;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 8, 0, DNX_CHM_UNITTEST_3, 1, 0, 30, 30, NULL, NULL, NULL));
        /** 64 entries, 0 new ones (total 208 / 4096) */
        dummy_hw_unique_id_to_profile_table[9] = 9;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 9, 0, DNX_CHM_UNITTEST_3, 1, 0, 30, 30, NULL, NULL, NULL));
        /** 64 entries, 0 new ones (total 208 / 4096) */
        dummy_hw_unique_id_to_profile_table[10] = 10;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 10, 0, DNX_CHM_UNITTEST_3, 1, 0, 30, 30, NULL, NULL, NULL));
        /** 64 entries, 64 new ones (total 272 / 4096) */
        dummy_hw_unique_id_to_profile_table[11] = 11;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 11, 0, DNX_CHM_UNITTEST_3, 1, 0, 30, 29, NULL, NULL, NULL));
        /** 128 entries, 128 new ones (total 400 / 4096) */
        dummy_hw_unique_id_to_profile_table[12] = 12;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 12, 0, DNX_CHM_UNITTEST_3, 2, 1, 30, 30, NULL, NULL, NULL));
        /** attempt to add an invalid amount */
        dummy_hw_unique_id_to_profile_table[13] = 13;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 13, 0, DNX_CHM_UNITTEST_3, 3, 1, 30,
                                                               30, NULL, NULL, NULL);
        if (rv == _SHR_E_NONE)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL,
        ...
        dummy_hw_unique_id_to_profile_table[13] = 13;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 13, 0, DNX_CHM_UNITTEST_3, 4, 1, 30, 30, NULL, NULL, NULL));
        /** 1024 entries, 1024 new ones (total 1680 / 4096) */
        dummy_hw_unique_id_to_profile_table[14] = 14;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 14, 0, DNX_CHM_UNITTEST_5, 4, 2, 50, 45, NULL, NULL, NULL));
        /** 2048 entries, 2048 new ones (total 3728 / 4096) */
        dummy_hw_unique_id_to_profile_table[15] = 15;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 15, 0, DNX_CHM_UNITTEST_5, 8, 6, 50, 45, NULL, NULL, NULL));
        /** 256 entries, 256 new ones (total 3984 / 4096) */
        dummy_hw_unique_id_to_profile_table[16] = 16;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 16, 0, DNX_CHM_UNITTEST_5, 1, 0, 50, 50, NULL, NULL, NULL));
        /** 256 entries, 0 new ones (total 3984 / 4096) */
        dummy_hw_unique_id_to_profile_table[17] = 17;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 17, 0, DNX_CHM_UNITTEST_5, 1, 0, 50, 50, NULL, NULL, NULL));
        /** 128 entries, 128  new ones - expect failure */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 18, 0, DNX_CHM_UNITTEST_4, 1, 0, 30,
                                                               30, NULL, NULL, NULL);
        if (rv == _SHR_E_NONE)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL, "Attempt to allocated when full, was expecting failure but received success\n");
        ...
        /** 128 entries, 128  new ones - expect failure */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 18, 0, DNX_CHM_UNITTEST_2, 4, 2, 30,
                                                               30, NULL, NULL, NULL);
        if (rv == _SHR_E_NONE)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL, "Attempt to allocated when full, was expecting failure but received success\n");
        ...
        /** 128 entries, 128  new ones - expect failure */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 18, 0, DNX_CHM_UNITTEST_3, 2, 1, 30,
                                                               30, NULL, NULL, NULL);
        if (rv == _SHR_E_NONE)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL, "Attempt to allocated when full, was expecting failure but received success\n");
        ...
        dummy_hw_unique_id_to_profile_table[18] = 18;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 18, 0, DNX_CHM_UNITTEST_2, 4, 2, 30, 30, NULL, NULL, NULL));
        /** free all */
    ...
    /*
     * Test 7 - allocation with multiple hierarchies
     * 1. create chm instance with multiple (3) hierarchies
     * 2. allocate in hierarchy 1 in a fragmented way
     * 3. allocate in hierarchy 2 to force defrag and make sure you're able to allocate
     * 4. free all
     * 5. destroy
     */
    {
        const uint32 nof_hierarchies = 3;
        const uint32 nof_banks = 8;
        DNX_ROLLBACK_JOURNAL_START(unit);

        dnx_chm_unit_test_dummy_hw_reset();
        /** create  */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_create
                        (unit, nof_resources_to_manage, nof_hierarchies, nof_banks, DNX_ALGO_CHM_UNIT_TEST_7, &cbs,
                         &chm_handle));

        /** allocate in hierarchy 1 in a fragmented way - allocate 16 unique profiles of size 32(256 entries) and release only odd profiles */
        /** allocate all */
        for (int unique_id = 0; unique_id < 16; ++unique_id)
        {
            dummy_hw_unique_id_to_profile_table[unique_id] = unique_id;
            SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                            (unit, chm_handle, unique_id, 1, DNX_CHM_UNITTEST_5, 1, 0, 50, 49, NULL, NULL, NULL));
        }
        /** free to create fragmentation */
        for (int unique_id = 1; unique_id < 16; unique_id += 2)
        {
            SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free
                            (unit, chm_handle, unique_id, DNX_CHM_UNITTEST_5));
        }

        /** allocate in hierarchy 0 to force defrag and make sure you're able to allocate */
        dummy_hw_unique_id_to_profile_table[16] = 16;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 16, 0, DNX_CHM_UNITTEST_5, 1, 0, 50, 49, NULL, NULL, NULL));
        /** allocate in hierarchy 2 to force defrag and make sure you're able to allocate */
        dummy_hw_unique_id_to_profile_table[17] = 17;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 17, 2, DNX_CHM_UNITTEST_5, 1, 0, 50, 49, NULL, NULL, NULL));

        /** free all */
        for (int unique_id = 0; unique_id < 16; unique_id += 2)
        {
            SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free
                            (unit, chm_handle, unique_id, DNX_CHM_UNITTEST_5));
        }
