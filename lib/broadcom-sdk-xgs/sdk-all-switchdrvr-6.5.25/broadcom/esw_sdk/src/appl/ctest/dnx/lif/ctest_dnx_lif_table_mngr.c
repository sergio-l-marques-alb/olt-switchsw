...
static lif_table_mngr_inlif_unit_test_cases_t in_lif_table_case[] = {
     ...
     * UNSET_ACTION_IGNORE - DBAL_FIELD_VLAN_EDIT_PROFILE, UNSET_ACTION_SET_TO_DEFAULT - DBAL_FIELD_PROPAGATION_PROFILE
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, NO_SPECIAL_FLAGS},
     {4,
      {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_FODO_ASSIGNMENT_MODE,
       DBAL_FIELD_LEARN_INFO_NO_LIF_EXT_SYM_LIF_EXT},
      {1, 4, DBAL_ENUM_FVAL_FORWARD_DOMAIN_ASSIGNMENT_MODE_ENUM_FORWARD_DOMAIN_FROM_LOOKUP, 1},
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, NO_SPECIAL_FLAGS},
     {4,
      {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
       DBAL_FIELD_LEARN_INFO_NO_LIF_BASIC_SYM_LIF_BASIC},
      {1, 4, DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_BASIC_SVL, 100},
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, NO_SPECIAL_FLAGS},
     {4,
      {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
       DBAL_FIELD_LEARN_INFO_NO_LIF_BASIC_SYM_LIF_BASIC},
      {1, 4, DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_OPTIMIZED_SVL, 100},
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P}, DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P}},
     ...
     */
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_PROPAGATION_PROFILE},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 1}, DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P}},
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_PROPAGATION_PROFILE},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 5},
     ...
     * P2P result type with mandatory fields and a field with No-ARR value in range
     * (LIF_GERNERIC_DATA_0) for this result type but also in range for a larger result type 
     * with a larger LIF_GERNERIC_DATA_0 field.
     * Selected result type: The minimal size P2P result type that has the above field in any size
     */
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_LIF_GENERIC_DATA_0},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 79},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC2EEI_WITH_PROTECTION}},

    /*
     * P2P result type with mandatory fields and a field with No-ARR value out of range
     * (LIF_GERNERIC_DATA_0) for this result type but in range for the P2P-Large-Generic-Data result type.
     * Selected result type: The minimal size P2P result type that has the above field in a large enough size
     */
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_LIF_GENERIC_DATA_0},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 279},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P_LARGE_GENERIC_DATA}},

    /*
     * Steps 14-15 - Result types affected by a value of an ENUM field with an ARR Prefix other than '0' and a const value (8)
     * P2P result type with mandatory fields and a field (LEARN_PAYLOAD_CONTEXT) that is supplied with the expected const value (8)
     * Selected result type: The minimal size P2P result type that has the above field in any size
     */
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P,
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_NO_LIF_BASIC},
      RESULT_TYPE_INVALID}},
};
...
static lif_table_mngr_inlif_child_field_test_cases_t inlif_child_field_test_case[] = {
     ...
     */
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE}, {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P},
    ...
    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_DESTINATION}, {1, 13}, DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {DBAL_FIELD_FODO, DBAL_FIELD_VRF, DBAL_FIELD_VSI, DBAL_FIELD_FODO, 5}},
     ...
     */
    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {1, {DBAL_FIELD_GLOB_IN_LIF}, {1}, DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_3},
     {DBAL_FIELD_FODO, DBAL_FIELD_VRF, DBAL_FIELD_VSI, DBAL_FIELD_VRF, 9}},
...
static lif_table_mngr_outlif_unit_test_cases_t out_lif_table_case[] = {
     ...
     * Selected result type: The minimal size result type is DBAL_RESULT_TYPE_EEDB_OUT_AC_ETPS_AC_STAT_PROTECTION
     */
    {{DBAL_TABLE_EEDB_OUT_AC, NO_SPECIAL_FLAGS}, DNX_ALGO_LOCAL_OUTLIF_LOGICAL_PHASE_8,
     {1, {DBAL_FIELD_EGRESS_LAST_LAYER},
      {TRUE}, DBAL_RESULT_TYPE_EEDB_OUT_AC_ETPS_AC_STAT_PROTECTION}},
     ...
     */
    {{DBAL_TABLE_EEDB_ARP, DNX_ALGO_LIF_TABLE_SPECIFIC_ARP_VLAN_TRANSLATION}, DNX_ALGO_LOCAL_OUTLIF_LOGICAL_PHASE_8,
...
static lif_table_mngr_inlif_replace_test_cases_t in_lif_table_replace_case[] = {
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, NO_SPECIAL_FLAGS},
     {4,
      {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_IN_LIF_PROFILE, DBAL_FIELD_LEARN_INFO_NO_LIF_EXT_SYM_LIF_EXT},
    ...
    {{DBAL_TABLE_IN_LIF_FORMAT_EVPN, NO_SPECIAL_FLAGS},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_SERVICE_TYPE},
      {1, 5, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P},
      DBAL_RESULT_TYPE_IN_LIF_FORMAT_EVPN_IN_LIF_EVPN_EVI_P2P_NO_LEARNING},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_SERVICE_TYPE},
      {1, 5, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2MP}, RESULT_TYPE_INVALID}},
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, NO_SPECIAL_FLAGS},
     {4,
      {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
       DBAL_FIELD_LEARN_INFO_NO_LIF_BASIC_SYM_LIF_BASIC},
      {1, 4, DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_BASIC_SVL, 50},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_MP},
     {4,
      {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VSI, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
       DBAL_FIELD_LEARN_INFO_NO_LIF_BASIC_SYM_LIF_BASIC},
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_PROPAGATION_PROFILE},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 1},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_PROPAGATION_PROFILE},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 5},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC2EEI_WITH_PROTECTION}},
     ...
     */
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {4, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_GLOB_OUT_LIF, DBAL_FIELD_LIF_GENERIC_DATA_0},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 10, 79},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P_LARGE},
     {4, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_GLOB_OUT_LIF, DBAL_FIELD_LIF_GENERIC_DATA_0},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 10, 279},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P_LARGE_GENERIC_DATA}},
...
static lif_table_mngr_inlif_child_field_replace_test_cases_t in_lif_child_field_replace_case[] = {
    ...
    {{DBAL_TABLE_IN_AC_INFO_DB, DNX_ALGO_LIF_TABLE_SPECIFIC_AC_INGRESS_NON_NATIVE_P2P},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE, DBAL_FIELD_DESTINATION},
      {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P, 13},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_SERVICE_TYPE}, {1, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P},
      DBAL_RESULT_TYPE_IN_AC_INFO_DB_IN_LIF_AC_P2P},
    ...
    /*
     * Steps 13-15 - Table with only Parent field (FODO) not in all result types, replace allowed
     * set_action: SET_ACTION_USE_VALUE
     * unset_action: UNSET_ACTION_SET_TO_DEFAULT
     * value_replace_valid: TRUE
     * field_existance_replace_valid: TRUE
     * Tested operations: 
     *   1. Change value for a result type with a Parent field (FODO) to a different value
     *   2. Change value for a result type with a Parent field (FODO) to a different result-type with no Parent or Child fields
     *   3. Change value for a result type with no Parent or Child fields to a different result-type with a Parent field (FODO)
     */
    ...
    /*
     * Step 2-8 - Table with both Parent (FODO) & Child (VRF) 
     * set_action: SET_ACTION_USE_VALUE
     * unset_action: UNSET_ACTION_IGNORE
     * value_replace_valid: TRUE
     * field_existance_replace_valid: TRUE
     * Tested operations: 
     *   1. Change value for a result type with a Parent field on the same result type
     *   2. Change value for a result type with a Parent field to a different result-type with a Child field
     *   3. Change value for a result type with a Parent field to a different result-type with a Parent field of a smaller size
     *   4. Change value for a result type with a Parent field to a different result-type with a Parent field of a larger size
     *   5. Change value for a result type with a Parent field to a different result-type with a Child field of a larger size
     *   6. Change value for a result type with a Child field to a different result-type with a Parent field
     *   7. Change value for a result type with a Child field to a different result-type with a Parent field of a smaller size
     *   Note: FODO in IN_LIF_IPVX_2 has an ARR-Prefix that forces it to be in the range 1024-1027 and only as a VSI subfield
     *         (VSI has '0' encoding). This requires to set VSI as the main subfield when expecting IN_LIF_IPVX_2 and also
     *         as the field on the result-type.
     */
    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_DESTINATION, DBAL_FIELD_FODO}, {20, 13, 50},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_DESTINATION}, {30, 14},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {DBAL_FIELD_FODO, DBAL_FIELD_VRF, DBAL_FIELD_VSI, DBAL_FIELD_FODO, 60}},

    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE, DBAL_FIELD_FODO}, {1000, 1, 2048},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {1, {DBAL_FIELD_GLOB_IN_LIF}, {100}, DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_3},
     {DBAL_FIELD_FODO, DBAL_FIELD_VRF, DBAL_FIELD_VSI, DBAL_FIELD_VRF, 2049}},

    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE, DBAL_FIELD_FODO}, {96, 1, 1028},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE}, {97, 1},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_2},
     {DBAL_FIELD_FODO, DBAL_FIELD_VSI, DBAL_FIELD_VRF, DBAL_FIELD_VSI, 1027}},

    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {3, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE, DBAL_FIELD_FODO}, {99, 1, 1024},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_2},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE}, {99, 0},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {DBAL_FIELD_FODO, DBAL_FIELD_VSI, DBAL_FIELD_VRF, DBAL_FIELD_FODO, 1023}},

    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_FODO}, {1099, 1024},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_2},
     {1, {DBAL_FIELD_GLOB_IN_LIF}, {99, 0}, DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_3},
     {DBAL_FIELD_FODO, DBAL_FIELD_VRF, DBAL_FIELD_VSI, DBAL_FIELD_VRF, 1023}},

    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_VRF}, {501, 77},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_3},
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE}, {506, 1},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1},
     {DBAL_FIELD_FODO, DBAL_FIELD_VRF, DBAL_FIELD_VSI, DBAL_FIELD_FODO, 88}},
    ...
    {{DBAL_TABLE_IN_LIF_IPvX_TUNNELS, NO_SPECIAL_FLAGS},
     ...
     {2, {DBAL_FIELD_GLOB_IN_LIF, DBAL_FIELD_LEARN_ENABLE}, {506, 1},
      DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_2},
     {DBAL_FIELD_FODO, DBAL_FIELD_VSI, DBAL_FIELD_VRF, DBAL_FIELD_VSI, 1025}},
};
...
static lif_table_mngr_outlif_replace_test_cases_t out_lif_table_replace_case[] = {
     ...
     * Step 0 - Replace to a field that exists only on a different result type
     */
    {{DBAL_TABLE_EEDB_MPLS_TUNNEL, NO_SPECIAL_FLAGS}, DNX_ALGO_LOCAL_OUTLIF_LOGICAL_PHASE_3,
...
{
    uint32 num_of_fields, field_idx, ret_field_val[DBAL_FIELD_ARRAY_MAX_SIZE_IN_WORDS],
        expected_value[DBAL_FIELD_ARRAY_MAX_SIZE_IN_WORDS] = { 0 };
    ...
    for (field_idx = 0; field_idx < num_of_fields; field_idx++)
    {
        ...
        {
            expected_value[0] = expected_info->field_val[field_idx];
        }
        else
        {
         ...
         */
        if (ret_field_val[0] != expected_value[0])
        {
            SHR_EXIT_WITH_LOG(_SHR_E_FAIL,
                              "FAILURE: Wrong value retrieved for field %s, expected - %d, got - %d\n",
                              dbal_field_to_string(unit, field_id), expected_value[0], ret_field_val[0]);
        }
    }

    sal_printf("Compared entry successful\n");
exit:
    DBAL_FUNC_FREE_VARS;
    SHR_FUNC_EXIT;
}
    ...
    int is_delete)
{
    ...
    bsl_severity_t original_severity_lif;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    ...
    if (!is_replace)
    {
        SHR_IF_ERR_EXIT(dnx_algo_global_lif_allocation_allocate
                        (unit, LIF_MNGR_L2_GPORT_GLOBAL_LIF, DNX_ALGO_LIF_INGRESS, NULL, global_lif));
    }
    ...
    if (is_replace)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_lif_mapping_global_to_local_get(unit,
                                                                 DNX_ALGO_LIF_INGRESS, *global_lif,
                                                                 &local_lif_payload));
        local_lif_id = local_lif_payload.local_lifs_array.local_lifs[0];
    }
    lif_info.global_lif = *global_lif;
    lif_info.table_specific_flags = test_case_info->table_specific_flags;

    /*
     * Call the LIF-Table-Mngr API. Silence the errors for the Nagative testing cases.
     */
    SHR_GET_SEVERITY_FOR_MODULE_SPECIFIC(BSL_LS_BCMDNX_LIF, original_severity_lif);
    ...
    rv = dnx_lif_table_mngr_allocate_local_inlif_and_set_hw(unit, _SHR_CORE_ALL, entry_handle_id, &local_lif_id,
                                                            &lif_info);
    SHR_SET_SEVERITY_FOR_MODULE_SPECIFIC(BSL_LS_BCMDNX_LIF, original_severity_lif);
    ...
    if (SHR_SUCCESS(rv))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_lif_mngr_inlif_sw_info_table_id_and_result_type_get
                        (unit, local_lif_id, _SHR_CORE_ALL, phy_table_id, &dbal_table_id, &dbal_result_type));
        sal_printf("dbal_result_type - %d, expected_result_type - %d\n", dbal_result_type,
    ...
    else
    {
        ...
        sal_printf("In-LIF Table manager set fields ended with no result type - as expected\n");
    }
 ...
 *         holds the specific entry configuration - field IDs,
 *         field values, expected result type
 *  \param [in] logical_phase - The Out-LIF phase that is
    ...
    int is_delete)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_global_lif_allocation_allocate
                        (unit, LIF_MNGR_L2_GPORT_GLOBAL_LIF, DNX_ALGO_LIF_EGRESS, NULL, global_lif));
    }
    ...
    if (is_replace)
    {
        ...
        lif_info.flags |= LIF_TABLE_MNGR_LIF_INFO_REPLACE;
        lif_info.flags |= LIF_TABLE_MNGR_LIF_INFO_OUTLIF_REPLACE_ALLOW_LL_MISMATCH;

        SHR_IF_ERR_EXIT(dnx_algo_lif_mapping_global_to_local_get(unit,
                                                                 DNX_ALGO_LIF_EGRESS, *global_lif, &local_lif_payload));
        local_lif_id = local_lif_payload.local_lifs_array.local_lifs[0];
    }
    lif_info.global_lif = *global_lif;
    lif_info.table_specific_flags = test_case_info->table_specific_flags;
    lif_info.logical_phase = logical_phase;
    ...
    else
    {
        ...
        sal_printf("Out-LIF Table manager set fields eneded with no result type - as expected\n");
    }
    ...
    int is_delete)
{
    ...
    if (is_field_in_superset[set_field_idx])
    {
        ...
        for (get_field_idx = 0; get_field_idx < CHILD_TEST_NOF_GET_STEPS; get_field_idx++)
        {
            ...
            {
                sal_printf("Skip a step that retrieves field %s (Field unsupprted by the LIF-Table-Mngr)\n",
                           dbal_field_to_string(unit, field_id[get_field_idx]));
    ...
    {
        sal_printf("Skip a step that sets field %s (Field undefined in the superset result)\n",
                   dbal_field_to_string(unit, field_id[set_field_idx]));
        if (is_replace)
        {
            skipped_step_delete = TRUE;
    ...
    if (skipped_step_delete)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_lif_table_mngr_inlif_info_clear(unit,
                                                            _SHR_CORE_ALL,
                                                            local_lif_payload.local_lifs_array.local_lifs[0],
        ...
        if (test_case_info->dbal_table_id == DBAL_TABLE_IN_AC_INFO_DB)
        {
            ...
            dbal_entry_key_field32_set(unit, sw_db_entry_handle_id, DBAL_FIELD_LOCAL_LIF,
                                       local_lif_payload.local_lifs_array.local_lifs[0]);
            dbal_entry_value_field32_set(unit, sw_db_entry_handle_id, DBAL_FIELD_RESULT_TYPE, INST_SINGLE,
                                         DBAL_RESULT_TYPE_LOCAL_SBC_IN_LIF_MATCH_INFO_SW_MATCH_AC_VLAN_PORT_PORT);
            SHR_IF_ERR_EXIT(dbal_entry_clear(unit, sw_db_entry_handle_id, DBAL_COMMIT));
    ...
    int set_field_step)
{
     ...
     */
    sal_memset(step_rv, RETURN_VALUE_NOT_INITIALIZED, sizeof(step_rv));
     ...
     * Silence the errors for the Nagative testing case when a child field isn't 
     * supported as such by the LIF-Table-Mngr attributes 
     */
    SHR_GET_SEVERITY_FOR_MODULE_SPECIFIC(BSL_LS_BCMDNX_LIF, original_severity_lif);
    SHR_SET_SEVERITY_FOR_MODULE_SPECIFIC(BSL_LS_BCMDNX_LIF, bslSeverityFatal);
    ...
    {
        if ((int) (step_rv[step_idx]) == RETURN_VALUE_NOT_INITIALIZED)
        {
            sal_printf("STEP [%d] SKIPPED\n", step_idx + 1);
        }
        else if (step_rv[step_idx])
        {
            sal_printf("STEP [%d] FAILED (Set - %s, Get - %s), rv - %d\n", step_idx + 1,
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (test_case = 0; test_case < num_of_test_cases; test_case++)
    {
        ...
        sal_printf("In-LIF Test case #%d PASSED!\n", test_case);
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (test_case = 0; test_case < num_of_test_cases; test_case++)
    {
        ...
        sal_printf("Out-LIF Test case #%d PASSED!\n", test_case);
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (test_case = 0; test_case < num_of_test_cases; test_case++)
    {
        ...
        sal_printf("In-LIF REPLACE Test case #%d PASSED!\n", test_case);
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (test_case = 0; test_case < num_of_test_cases; test_case++)
    {
        ...
        sal_printf("In-LIF parent-child Replace Test case #%d PASSED!\n", test_case);
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (test_case = 0; test_case < num_of_test_cases; test_case++)
    {
        ...
        sal_printf("Out-LIF REPLACE Test case #%d PASSED!\n", test_case);
    }
