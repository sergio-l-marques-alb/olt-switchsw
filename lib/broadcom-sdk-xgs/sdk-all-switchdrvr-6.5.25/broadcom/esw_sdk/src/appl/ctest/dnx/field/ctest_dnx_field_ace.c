...
/**
 * The default value to context input parameter.
 */
#define DNX_CTEST_ACE_CONTEXT_DEFAULT_STRING "-1"
#define DNX_CTEST_ACE_CONTEXT_DEFAULT_VALUE (-1)

/**
 * The Presel IDs to use.
 */
#define DNX_CTEST_ACE_IPMF1_PRESEL_ID (50)
#define DNX_CTEST_ACE_EPMF_PRESEL_ID (50)
...
sh_sand_invoke_t Sh_dnx_field_ace_tests[] = {
    ...
    ,
    {"DNX_ace_for_format_entry_add",         "type=format context=20 count=25",             CTEST_POSTCOMMIT}
    ,
    {"DNX_ace_for_format_entry_add_traffic", "type=format context=20 traffic=yes count=1",  CTEST_POSTCOMMIT}
    ,
    {NULL}
};
/**
...
sh_sand_option_t Sh_dnx_field_ace_options[] = {
    ...
    {DNX_CTEST_ACE_OPTION_TEST_CONTEXT,    SAL_FIELD_TYPE_UINT32,  "The context ID for iPMF1 and ePMF",          DNX_CTEST_ACE_CONTEXT_DEFAULT_STRING},
    ...
    int ace_test_clean)
{
    ...
    if (ace_test_context == DNX_CTEST_ACE_CONTEXT_DEFAULT_VALUE)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Context must be provided.\r\n");
    }
    ...
    p_id.presel_id = DNX_CTEST_ACE_EPMF_PRESEL_ID;
    p_id.stage = DNX_FIELD_STAGE_EPMF;
    SHR_IF_ERR_EXIT(dnx_field_presel_set(unit, 0, &p_id, &p_data));
    ...
    ace_format_info_2.dnx_actions[0] =
        DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_TC);
    ace_format_flags = 0;
    ...
    ace_format_info.dnx_actions[0] =
        DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_PPH_TTL);
    ace_format_info.dnx_actions[1] =
        DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_PP_DSP);
    ace_format_info.dnx_actions[2] =
        DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_ACE_STAMP_VALUE);
    ace_format_flags = 0;
    ...
    fg_info.dnx_quals[0] = DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_EPMF, DNX_FIELD_QUAL_FTMH_CNI);
    fg_info.dnx_actions[0] =
        DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_EPMF, DNX_FIELD_ACTION_CUD_OUTLIF_OR_MCDB_PTR);
    ...
    attach_info.dnx_quals[0] = DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_EPMF, DNX_FIELD_QUAL_FTMH_CNI);
    ...
    tcam_entry_info.key_info.qual_info[0].dnx_qual =
        DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_EPMF, DNX_FIELD_QUAL_FTMH_CNI);
    ...
    if (ace_test_update)
    {
        ...
        ace_entry_flags = DNX_FIELD_ENTRY_ACE_ADD_FLAG_UPDATE;
        SHR_IF_ERR_EXIT(dnx_field_ace_entry_add(unit, ace_entry_flags, ace_id, &payload_info_in, &ace_entry_key));
    ...
    int unit)
{
     ...
     */
    action_type1 = DNX_FIELD_DNX_ACTION_PARAM_GET(DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_TC, id);
    action_type2 = DNX_FIELD_DNX_ACTION_PARAM_GET(DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_DP, id);
    action_type3 = DNX_FIELD_DNX_ACTION_PARAM_GET(DNX_FIELD_STAGE_ACE, DNX_FIELD_ACTION_TM_ACTION_TYPE, id);
    ace_id = 7;
    valid_bits = 1;
    shift = 2;
    type = 0;
    ...
    sh_sand_control_t * sand_control)
{
     ...
     */
    if (sal_strncasecmp(ace_test_type_name, TEST_TYPE_FORMAT, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
        LOG_INFO_EX(BSL_LOG_MODULE, "%s(), line %d, Tesing 'ACE format'. %s%s\r\n", __func__, __LINE__, EMPTY, EMPTY);
        ...
        LOG_INFO_EX(BSL_LOG_MODULE, "%s(), line %d, Option %s. Testing 'ACE format' returned 'success' flag.%s\r\n",
                    __func__, __LINE__, ace_test_type_name, EMPTY);
    }
    else if (sal_strncasecmp(ace_test_type_name, TEST_TYPE_FES_CFG, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
