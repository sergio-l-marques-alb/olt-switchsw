...
#define CTEST_INSTRU_INT_IPMF1_ACTION_TAIL_EDIT_PROFILE   (DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_ACTION_END_OF_PACKET_EDITING))
...
#define CTEST_INSTRU_INT_IPMF3_QUAL_TAIL_EDIT_PROFILE        (DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_QUAL_END_OF_PACKET_EDITING))
#define CTEST_INSTRU_INT_IPMF3_ACTION_INT_COMMAND        (DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_ACTION_INT_DATA))
...
/*Create FLow Id*/
static shr_error_e
ctest_dnx_field_flow_id_ipmf1_init(
    int unit,
    bcm_field_context_t context_id)
{
    ...
    sal_strncpy_s((char *) (action_info.name), "ipmf1_flow_valid_bit", sizeof(action_info.name));
    ...
    sal_strncpy_s((char *) (fg_info.name), "ipmf1_flow_id", sizeof(fg_info.name));

    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, 0, &fg_info, &fg_flow_id));
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (sal_strncasecmp(int_test_type, TEST_TYPE_INT_NONE, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
    ...
    /**Enable Flow id*/
    SHR_IF_ERR_EXIT(ctest_dnx_field_flow_id_ipmf1_init(unit, context_ipmf1));
    ...
    if (sal_strncasecmp(int_test_type, TEST_TYPE_INT_INTERMEDIATE, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
        SHR_IF_ERR_EXIT(ctest_dnx_field_instru_int_ipmf1_entry_add(unit, 2, fg_id_ipmf1, &entry_handle_ipmf1));
    }
    else if (sal_strncasecmp(int_test_type, TEST_TYPE_INT_FIRST, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
        SHR_IF_ERR_EXIT(ctest_dnx_field_instru_int_ipmf1_entry_add(unit, 4, fg_id_ipmf1, &entry_handle_ipmf1));
    }
    else if (sal_strncasecmp(int_test_type, TEST_TYPE_INT_LAST, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
    {
