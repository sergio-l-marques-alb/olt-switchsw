...
#define DBAL_TABLE_EXAMPLE_MACT_MACRO DBAL_TABLE_EMPTY

#define DBAL_TABLE_IPV4_FORWARD_MACRO DBAL_TABLE_EMPTY
...
/**     test name                       test enum                    test flags              test callback         */
    ...
    {"partial_access",              PARTIAL_ACCESS,               CTEST_PRECOMMIT, dnx_dbal_ut_partial_access,               UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_PEMLA_PARSERETH, DBAL_TABLE_EXAMPLE_SW_SUB_FIELD, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"sub_field",                   SUB_FIELD,                    CTEST_PRECOMMIT, dnx_dbal_ut_parent_field_mapping,         UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_SUB_FIELD, DBAL_UT_FILL_TABLE_FOR_1}},
    ...
    {"rt_access",                   RT_ACCESS,                    CTEST_PRECOMMIT, dnx_dbal_ut_rt_access,                    UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_RESULT_TYPE, DBAL_UT_FILL_TABLE_FOR_1}},
    ...
    {"superset_res_type",           SUPERSET_RES_TYPE,            CTEST_PRECOMMIT, dnx_dbal_ut_superset_res_type,            UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_RESULT_TYPE, DBAL_TABLE_IN_LIF_IPvX_TUNNELS, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"range_of_entries_set",        RANGE_OF_ENTRIES_SET,         CTEST_PRECOMMIT, dnx_dbal_ut_range_of_entries_set,         UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EGRESS_VLAN_EDIT_COMMAND_MAPPING, DBAL_TABLE_EXAMPLE_SW_RANGE, DBAL_TABLE_FIELD_INGRESS_HEADER_PROFILE, DBAL_UT_FILL_TABLE_FOR_3}},
    {"range_entries_clear",         RANGE_OF_ENTRIES_CLEAR,       CTEST_PRECOMMIT, dnx_dbal_ut_range_of_entries_clear,       UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EGRESS_VLAN_EDIT_COMMAND_MAPPING, DBAL_TABLE_EXAMPLE_SW_RANGE, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"update_handle_with_buffers",  UPDATE_HANDLE_WITH_BUFFERS,   CTEST_PRECOMMIT, dnx_dbal_ut_update_handle_with_buffers,   UT_ALL_DEVICES       , {DBAL_TABLE_FWD_MACT, DBAL_TABLE_FWD_MACT_IVL, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"dpc_core_any",                DPC_CORE_ANY,                 CTEST_PRECOMMIT, dnx_dbal_ut_core_any_dpc,                 UT_DUAL_CORE_DEVICES | UT_QUAD_READY, {DBAL_TABLE_INGRESS_PORT_STP, DBAL_TABLE_EXAMPLE_SW_DIRECT, DBAL_UT_FILL_TABLE_FOR_2}},
    {"dpc_core_all",                DPC_CORE_ALL,                 CTEST_PRECOMMIT, dnx_dbal_ut_core_all_dpc,                 UT_DUAL_CORE_DEVICES | UT_QUAD_READY, {DBAL_TABLE_INGRESS_PTC_PORT, DBAL_TABLE_INGRESS_PP_RECYCLE_COMMAND, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"both_cores",                  BOTH_CORES,                   CTEST_PRECOMMIT, dnx_dbal_ut_both_cores,                   UT_DUAL_CORE_DEVICES | UT_QUAD_READY, {DBAL_TABLE_INGRESS_ETHERNET_OAM_OPCODE_MAP, DBAL_TABLE_IN_LIF_PROFILE_TABLE, DBAL_UT_FILL_TABLE_FOR_2}},
    {"mac_encoding",                MAC_ENCODING,                 CTEST_PRECOMMIT, dnx_dbal_ut_mac_encoding,                 UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_EM, DBAL_UT_FILL_TABLE_FOR_1}},
    ...
    {"iterator_with_key_rules",     ITERATOR_WITH_KEY_RULES,      CTEST_PRECOMMIT, dnx_dbal_ut_iterator_with_key_rules,      UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_FOR_HL_MULTIPLE_RESULT, DBAL_TABLE_IPV4_UNICAST_PRIVATE_LPM_FORWARD, DBAL_TABLE_EXAMPLE_SW_EM_LONG_KEY, DBAL_TABLE_IPV4_FORWARD_MACRO, DBAL_UT_FILL_TABLE_FOR_4}},
    {"iterator_with_value_rules",   ITERATOR_WITH_VALUE_RULES,    CTEST_PRECOMMIT, dnx_dbal_ut_iterator_with_value_rules,    UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_FOR_HL_MULTIPLE_RESULT, DBAL_TABLE_IPV4_UNICAST_PRIVATE_HOST, DBAL_TABLE_EXAMPLE_SW_LONG_RES, DBAL_UT_FILL_TABLE_FOR_3}},
    {"iterator_with_rules_actions", ITERATOR_WITH_RULES_ACTIONS,  CTEST_PRECOMMIT, dnx_dbal_ut_iterator_with_rules_actions,  UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_FOR_HL_MULTIPLE_RESULT, DBAL_UT_FILL_TABLE_FOR_1}},
    {"iterator_multiple_rt",        ITERATOR_MULTIPLE_RT,         CTEST_PRECOMMIT, dnx_dbal_ut_iterator_mul_result,          UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_FOR_HL_MULTIPLE_RESULT, DBAL_TABLE_L2_GPORT_TO_FORWARDING_SW_INFO, DBAL_TABLE_EXAMPLE_SW_MUL_RESULT, DBAL_TABLE_ESEM_FORWARD_DOMAIN_MAPPING_PER_INTERFACE_NAMESPACE_DB, DBAL_TABLE_ING_VSI_INFO_DB, DBAL_UT_FILL_TABLE_FOR_5}},
    ...
    {"iterator_age_rule",           ITERATOR_AGE_RULE,            CTEST_PRECOMMIT, dnx_dbal_ut_iterator_age_rule,            UT_ALL_DEVICES       , {DBAL_TABLE_FWD_MACT, DBAL_TABLE_FWD_MACT_IVL, DBAL_UT_FILL_TABLE_FOR_2}},
    {"iterator_hitbit_retrieved",   ITERATOR_HIT_BIT_RETRIEVED,   CTEST_POSTCOMMIT, dnx_dbal_ut_iterator_hitbit_retrieved,   UT_ALL_DEVICES       , {DBAL_TABLE_MPLS_TERMINATION_SINGLE_LABEL_DB, DBAL_UT_FILL_TABLE_FOR_1}},
    {"iterator_hitbit_over_tables", ITERATOR_HIT_BIT_OVER_TABLES, CTEST_POSTCOMMIT, dnx_dbal_ut_iterator_hitbit_over_tables, UT_ALL_DEVICES       , {DBAL_TABLE_IPV6_TT_MP_EM_16, DBAL_TABLE_SRV6_TERMINATED_LIF, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"err_code_non_direct",         ERR_CODE_NON_DIRECT,          CTEST_PRECOMMIT, dnx_dbal_ut_non_direct_error_codes,       UT_ALL_DEVICES       , {DBAL_TABLE_BRIDGE_IPV4_MULTICAST_SOURCE_SPECIFIC_IVL, DBAL_TABLE_BFD_ENDPOINT_SW_INFO, DBAL_UT_FILL_TABLE_FOR_3}},
    ...
    {"hl_tcam",                     HL_TCAM,                      CTEST_PRECOMMIT, dnx_dbal_ut_hl_tcam,                      UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_HL_TCAM, DBAL_TABLE_EXAMPLE_HL_TCAM_DATA_OFFSET, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"entries_counter",             ENTRIES_COUNTER,              CTEST_PRECOMMIT, dnx_dbal_ut_entries_counter,              UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_EM, DBAL_TABLE_EXAMPLE_SW_DIRECT, DBAL_TABLE_EXAMPLE_HL_TCAM, DBAL_TABLE_TCAM_CS_EPMF, DBAL_UT_FILL_TABLE_FOR_4}},
    ...
    {"read_only_field",             READONLY_FIELD,               CTEST_PRECOMMIT, dnx_dbal_ut_readonly_field,               UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_NIF_DEBUG_SIGNALS, DBAL_UT_FILL_TABLE_FOR_1}},
    {"write_only_field",            WRITEONLY_FIELD,              CTEST_PRECOMMIT, dnx_dbal_ut_read_not_readable_field,      UT_ALL_DEVICES       , {DBAL_TABLE_MDB_33_LEM, DBAL_UT_FILL_TABLE_FOR_1}},
    ...
    {"arr_prefix",                  ARR_PREFIX,                   CTEST_PRECOMMIT, dnx_dbal_ut_arr_prefix,                   UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_TABLE_CONST_VALUES, DBAL_UT_FILL_TABLE_FOR_1}},
    {"struct_arr_prefix",           STRUCT_ARR_PREFIX,            CTEST_PRECOMMIT, dnx_dbal_ut_struct_arr_prefix,            UT_ALL_DEVICES       , {DBAL_UT_NO_TABLE}},
    {"mact_iterator",               MACT_ITERATOR,                CTEST_POSTCOMMIT, dnx_dbal_ut_mact_iterator,               UT_ALL_DEVICES       , {DBAL_TABLE_FWD_MACT, DBAL_TABLE_FWD_MACT_IVL, DBAL_TABLE_EXAMPLE_MACT_MACRO, DBAL_UT_FILL_TABLE_FOR_3}},
    {"mact_iterator_key_only",      MACT_ITERATOR_KEY_ONLY,       CTEST_POSTCOMMIT, dnx_dbal_ut_mact_iterator_key_rule_only, UT_ALL_DEVICES       , {DBAL_TABLE_FWD_MACT, DBAL_TABLE_EXAMPLE_MACT_MACRO, DBAL_UT_FILL_TABLE_FOR_2}},
    {"mact_iterator_key_and_dest",  MACT_ITERATOR_KEY_DEST_ONLY,  CTEST_POSTCOMMIT, dnx_dbal_ut_mact_iterator_key_and_dest,  UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_FWD_MACT, DBAL_TABLE_EXAMPLE_MACT_MACRO, DBAL_UT_FILL_TABLE_FOR_2}},
    {"iterator_rules_actions_mact", ITERATOR_RULES_ACTIONS_MACT,  CTEST_PRECOMMIT, dnx_dbal_ut_iterator_rules_actions_mact,  UT_ALL_DEVICES       , {DBAL_TABLE_FWD_MACT, DBAL_TABLE_FWD_MACT_IVL, DBAL_TABLE_EXAMPLE_MACT_MACRO, DBAL_UT_FILL_TABLE_FOR_3}},
    {"iterator_update_get_mact",  ITERATOR_RULES_ACTIONS_GET_MACT,CTEST_PRECOMMIT, dnx_dbal_ut_iterator_update_get_mact,     UT_ALL_DEVICES       , {DBAL_TABLE_FWD_MACT, DBAL_TABLE_FWD_MACT_IVL, DBAL_TABLE_EXAMPLE_MACT_MACRO, DBAL_UT_FILL_TABLE_FOR_3}},
    ...
    {"none_direct_mode",            NONE_DIRECT_MODE,             CTEST_PRECOMMIT, dnx_dbal_ut_none_direct_mode,             UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_SUB_FIELD, DBAL_TABLE_IPV4_UNICAST_PRIVATE_LPM_FORWARD, DBAL_UT_FILL_TABLE_FOR_3}},
    {"table_protection",            TABLE_PROTECTION,             CTEST_PRECOMMIT, dnx_dbal_ut_table_protection_validate,    UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_SW_SUB_FIELD, DBAL_UT_FILL_TABLE_FOR_2}},
    ...
    {"commit_hw_only",              COMMIT_HW_ONLY,               CTEST_PRECOMMIT, dnx_dbal_ut_commit_hw_only,               UT_ALL_DEVICES       , {DBAL_TABLE_L2_FORWARD_UNKNOWN_DA_PROFILE, DBAL_TABLE_IPV4_UNICAST_PRIVATE_HOST, DBAL_TABLE_IN_AC_INFO_DB, DBAL_TABLE_FWD_MACT, DBAL_UT_FILL_TABLE_FOR_4}},
    {"non_aligned_data_mask",       NON_ALIGNED_DATA_MASK,        CTEST_PRECOMMIT, dnx_dbal_ut_non_aligned_data_mask_validation, UT_ALL_DEVICES   , {DBAL_TABLE_IPV6_VRF_DB_TCAM, DBAL_UT_FILL_TABLE_FOR_1}},
    {"asym_table",                  ASYMMETRIC_TABLE,             CTEST_PRECOMMIT, dnx_dbal_ut_asymmetric_table,             UT_ALL_DEVICES | UT_QUAD_READY, {DBAL_TABLE_EXAMPLE_TABLE_WITH_ASYMMETRIC_MAPPING, DBAL_UT_FILL_TABLE_FOR_1}},
    {"multi_core_iter",             MULTI_CORE_ITER,              CTEST_PRECOMMIT, dnx_dbal_ut_multi_core_iterator,          UT_DUAL_CORE_DEVICES | UT_QUAD_READY, {DBAL_TABLE_INNER_ETHERNET_VLAN_CLASSIFICATION_LIF_SCOPED_VLAN_0_VLANS, DBAL_UT_FILL_TABLE_FOR_1}},
};
    ...
    dnx_dbal_ltt_input_t * ltt_input)
{
     ...
     */
    if (!dbal_maturity_level_is_high(table->maturity_level)
...
static uint8
dbal_logical_er_test_should_run(
    int unit,
    CONST dbal_logical_table_t * table)
{
    ...
    {
        if (DBAL_LABEL_MACSEC_IP == table->table_labels[label_idx])
        {
            return 0;
        }
    }
    ...
    dbal_ltt_flags_e test_specific_flags)
{
    ...
    for (ii = iter_start_pos; ii < iter_end_pos; ii++)
    {
        ...
        if (dbal_convert_to_basic_maturity_level(table->maturity_level) == DBAL_MATURITY_LOW)
        {
            continue;
        }
                 ...
                 || _SHR_IS_FLAG_SET(ltt_input.flags, LTT_FLAGS_SNAPSHOT_NEGATIVE))
        {
            ...
            curr_res =
                ((_SHR_E_NONE == err_rec_test_ltt_res)
                 && dbal_logical_er_test_should_run(unit, table)) ? ctest_dbal_table_test_run(unit,
                                                                                              ii,
                                                                                              &ltt_input) : _SHR_E_NONE;
        }
        else
        {
    ...
    dbal_entries_array_t * entries_array)
{
    ...
    for (field_iter = table->nof_key_fields - 1; field_iter >= 0; field_iter--)
    {
        ...
        {
            /** field that is bigger than 32bit, will use it to inc, so there is enough entries... */
        ...
        if (possible_nof_entries != UTILEX_U32_MAX)
        {
            ...
            {
                /** overflow.. reached to the desired nof entries, no need more calculations */
                possible_nof_entries = UTILEX_U32_MAX;
            }
            else
            {
    ...
    {
        /** reached to the desired nof entries, no need more calculations */
    ...
    {
        uint8 is_illegal_value_for_field = 1;
        for (field_iter = table->nof_key_fields - 1; field_iter >= 0; field_iter--)
        {
...
/** run the performance tests according input parameters. this tests doesn't handle  */
static shr_error_e
            ...
            if (table->multi_res_info[0].results_info[field_iter].permission != DBAL_PERMISSION_READONLY)
            {
                if (table->multi_res_info[0].results_info[field_iter].arr_prefix_size == 0)
                {
                    ...
                    dbal_entry_value_field_arr32_set(unit, entry_handle,
                                                     ...
                                                     table->multi_res_info[0].results_info[field_iter].inst_idx,
                                                     &(entries_array.result_fields[field_iter]));
                    utilex_ll_timer_stop(timers_group, timer_idx[KEY_FIELD_SET]);
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        dbal_entry_value_field_predefine_value_set(unit, entry_handle,
                                                                   ...
                                                                   results_info[field_iter].field_id,
                                                                   table->multi_res_info[0].
                                                                   results_info[field_iter].inst_idx,
        ...
        for (field_iter = 0; field_iter < table->multi_res_info[0].nof_result_fields; field_iter++)
        {
                ...
                (table->multi_res_info[0].results_info[field_iter].permission != DBAL_PERMISSION_WRITEONLY))
            {
                ...
                SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get(unit, entry_handle,
                                                                    ...
                                                                    results_info[field_iter].field_id,
                                                                    table->multi_res_info[0].
                                                                    results_info[field_iter].inst_idx, &field_val));
 ...
 *  ctest_dnx_dbal_performance_test that has timers for each field set and entry commit.
 */
shr_error_e
    ...
    int *entries_per_sec)
{
    ...
    if ((nof_entries_to_prepare != 1) && (nof_entries > estimated_nof_entries))
    {
        ...
        {
            LOG_CLI((BSL_META
                     ("estimated table capacity is smaller than the nof entries, using estimated capacity %d\n"),
                     estimated_nof_entries));
            nof_entries = estimated_nof_entries;
        }
    }
    ...
    LOG_CLI((BSL_META
             ("Test started table %s %d entries (%d result fields) waiting for HW %d\n"),
             table->table_name, nof_entries, table->multi_res_info[0].nof_result_fields, wait_for_hw));
    utilex_ll_timer_set("entry commit ", timers_group, timer_idx[ENTRY_COMMIT]);
    ...
    for (entry_iter = 0; entry_iter < nof_entries; entry_iter++)
    {
        ...
        for (field_iter = 0; field_iter < table->nof_key_fields; field_iter++)
        {
            if (table->keys_info[field_iter].field_id == DBAL_FIELD_IPV6)
            {
                uint32 mask[4] = { 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, };   /* default mask all care, if
                                                                                         * user want to change need to
                                                                                         * start changing from mask[3] */
                dbal_entry_key_field_arr32_masked_set(unit, entry_handle, table->keys_info[field_iter].field_id,
                                                      &(entries_array.key_fields[entry_array_id][field_iter]), mask);
            }
            else
            {
                dbal_entry_key_field_arr32_set(unit, entry_handle,
    ...
    if (!wait_for_hw)
    {
        ...
        if (dnx_sbusdma_desc_is_enabled(unit, SBUSDMA_DESC_MODULE_ENABLE_MDB_LEM) == TRUE)
        {
            dnx_sbusdma_desc_wait_done(unit);
        }
        /** clearing the entries at the end of the test */
        SHR_IF_ERR_EXIT(dbal_table_clear(unit, table_id));
    }
 ...
 * parameter and nof entries (optional, default 4k) and perform commit get table clear. prints at the end of the test the
 * times.
 */
static shr_error_e
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (mode > 2)
    {
        SHR_ERR_EXIT(_SHR_E_NONE, "illegal value for mode should be 0/1/2 \n");
    }
    ...
    if (table_id == DBAL_TABLE_EMPTY)
    {
        ...
        if ((access_method == DBAL_ACCESS_METHOD_MDB) || (access_method == DBAL_NOF_ACCESS_METHODS))
        {
            ...
            {
                /** running over list of validated tables, don't allow tests to fail */
    ...
    else
    {
        if (mode == 0)
        {
            SHR_IF_ERR_EXIT(ctest_dnx_dbal_performance_one_counter_test
                            (unit, table_id, nof_entries, mode, &entries_per_sec));
        }
        else
        {
            SHR_IF_ERR_EXIT(ctest_dnx_dbal_performance_test
    ...
    int nof_entries)
{
    ...
    if (!is_table_active)
    {
        LOG_CLI((BSL_META("table is not active, test is skipped\n")));
        SHR_EXIT();
    }
    SHR_IF_ERR_EXIT(dbal_tables_table_get(unit, table_id, &table));
    ...
    for (field_iter = 0; field_iter < table->multi_res_info[0].nof_result_fields; field_iter++)
    {
        ...
        uint8 inst_idx = table->multi_res_info[0].results_info[field_iter].inst_idx;
        if (curr_field_id == DBAL_FIELD_RESULT_TYPE)
        {
            dbal_entry_value_field32_set(unit, entry_handle, curr_field_id, inst_idx, 0);
        }
        else
        {
            ...
            if (table->multi_res_info[0].results_info[field_iter].arr_prefix_size != 0)
            {
                dbal_entry_value_field_predefine_value_set(unit, entry_handle, curr_field_id,
                                                           inst_idx, DBAL_PREDEF_VAL_MIN_VALUE);
            }
            else
            {
                if (table->multi_res_info[0].results_info[field_iter].max_value < field_value)
                ...
                dbal_entry_value_field32_set(unit, entry_handle, curr_field_id, inst_idx, field_value);
            }
        }
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (!ISEMPTY(table_name))
    {
        if (sal_strncmp(table_name, dbal_ut_empty_table, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) != 0)
        {
            if (dbal_logical_table_string_to_id_no_error(unit, table_name, &table_id) == _SHR_E_NOT_FOUND)
            {
                SHR_IF_ERR_EXIT(dbal_print_table_names(unit, table_name));
    ...
    rhlist_t * test_list)
{
    ...
    int include_unsupported_flag = FALSE;
    ...
    for (test_idx = 0; test_idx < nof_tests; test_idx++)
    {
        for (table_idx = 0; table_idx < DBAL_MAX_NUM_OF_TABLES_PER_TEST; table_idx++)
        {
            ...
            if (dnx_dbal_ut_all_tests[test_idx].table_ids[table_idx] != DBAL_TABLE_EMPTY)
            {
                ...
                /*
                 * If the table name is not empty and we are deliberately including adapter unsupported tests,
                 * don't skip even if maturity level is low, instead add CTEST_ADAPTER_UNSUPPORTED flag (see below)
                 */
                include_unsupported_flag = test_list->include_unsupported && table->table_name[0] != 0;
                if (!dbal_maturity_level_is_high(table->maturity_level) && !include_unsupported_flag)
                {
            ...
            if (include_unsupported_flag)
                utilex_prime_flag_set(&ut_flags, CTEST_ADAPTER_UNSUPPORTED);
    ...
    rhlist_t * test_list)
{
    ...
    for (table_id = 0; table_id < DBAL_NOF_TABLES; table_id++)
    {
        ...
        /*
         * Writing to the below two tables may cause HW issues - Every time you an ID and enable=TRUE 
         * is written in one of these tables, it is in fact loading/removing queues from ESB.
         * This can cause HW interrupts during the testing and other issues after that. Even if the 
         * original value is restored to the table this will not restore the correct ESB behavior.
         */
        if ((table_id == DBAL_TABLE_ESB_ADD_QUEUE) || (table_id == DBAL_TABLE_ESB_REMOVE_QUEUE))
        {
            continue;
        }
        ...
        SHR_IF_ERR_EXIT(dbal_tables_table_get(unit, table_id, &table));
        {
            /*
             * If the table name is not empty and we are deliberately including adapter unsupported tests,
             * don't skip even if maturity level is low or table has no readable field,
             * instead add CTEST_ADAPTER_UNSUPPORTED flag (see below)
             */
            include_unsupported_flag = test_list->include_unsupported && table->table_name[0] != 0;
            if (!dbal_maturity_level_is_high(table->maturity_level) && !include_unsupported_flag)
            {
        ...
        if (!dbal_ltt_is_readable_result_field(unit, table) && !include_unsupported_flag)
        {
            continue;
        }
    ...
    rhlist_t * test_list)
{
    ...
    for (table_id = 0; table_id < DBAL_NOF_TABLES; table_id++)
    {
        ...
        if (dnx_dbal_journal_should_create_test(unit, table_id) || include_unsupported_flag)
        {
            /*
    ...
    rhlist_t * test_list)
{
    ...
    for (table_id = 0; table_id < DBAL_NOF_TABLES; table_id++)
    {
        ...
        if (table_id == DBAL_TABLE_INGRESS_OAM_LIF_DB)
        {
            continue;
        }
...
sh_sand_cmd_t dnx_dbal_test_cmds[] = {
    {"Ltt",              cmd_dnx_dbal_ctest_ltt,      NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_ltt_test_creation},
    {"Ltt_Full",         cmd_dnx_dbal_ctest_ltt_full, NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_ltt_full_test_creation},
    {"skip_shadow_Ltt",  cmd_dnx_dbal_ctest_ltt_skip_shadow,      NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE * CTEST_ADAPTER_UNSUPPORTED, cmd_dbal_dyn_ltt_skip_shadow_test_creation},
    {"Ut",               cmd_dnx_dbal_ut,             NULL, dnx_dbal_ut_options,   &dnx_dbal_ut_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_ut_test_creation},
    {"ERRor_RECovery",   cmd_dnx_dbal_ctest_err,      NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_error_recovery_test_creation},
    {"SNAPSHOT_MaNaGeR", cmd_dnx_dbal_ctest_snapshot, NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_snapshot_manager_test_creation},
    {"Capacity",         cmd_dnx_dbal_capacity,       NULL, dnx_dbal_capacity_options, &dnx_dbal_capacity_man, NULL, NULL, CTEST_POSTCOMMIT * CTEST_SKIPPABLE, NULL},
    {"Performance",      cmd_dnx_dbal_performance,    NULL, dnx_dbal_performance_options, &dnx_dbal_performance_man, NULL, NULL, CTEST_POSTCOMMIT * CTEST_SKIPPABLE, NULL},
    /** following MDB config tests must be last in this list */
    {"Ltt_mdb_cfg",      cmd_dnx_dbal_ctest_ltt,      NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_ltt_mdb_cfg_test_creation},
    {"Ltt_Full_mdb_cfg", cmd_dnx_dbal_ctest_ltt_full, NULL, dnx_dbal_test_options, &dnx_dbal_test_man, NULL, NULL, CTEST_PASS * CTEST_SKIPPABLE, cmd_dbal_dyn_ltt_full_mdb_cfg_test_creation},
    {NULL}
};
/* *INDENT-ON* */
