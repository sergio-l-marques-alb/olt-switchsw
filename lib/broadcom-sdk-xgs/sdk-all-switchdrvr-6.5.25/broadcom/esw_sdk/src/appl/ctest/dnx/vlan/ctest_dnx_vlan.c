...
extern sh_sand_cmd_t dnx_vlan_port_test_cmds[];
...
static sh_sand_man_t dnx_vlan_port_test_man = {
    /** Brief */
    "test of vlan port related APIs",
    /** Full */
    "vlan  port performance tests",
    /** Synopsis   */
    "ctest vlan port"
};
...
sh_sand_cmd_t dnx_vlan_test_cmds[] = {
    {"semantic", diag_dnx_vlan_semantic_test_cmd, NULL, NULL, &diag_dnx_vlan_sem_test_man, NULL, NULL,
     CTEST_POSTCOMMIT},
    {"vlan_port", NULL, dnx_vlan_port_test_cmds, NULL, &dnx_vlan_port_test_man, NULL, NULL,
     CTEST_POSTCOMMIT},
    {NULL}
};
