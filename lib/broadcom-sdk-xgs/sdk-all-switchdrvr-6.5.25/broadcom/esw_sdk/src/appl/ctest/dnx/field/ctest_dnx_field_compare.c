    ...
    sh_sand_control_t * sand_control)
{
    ...
    else if (test_type == 1)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_context_compare_pair_info_t_init(unit, &compare_pair));
        ...
        fg_info_in.dnx_actions[0] =
            DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_ACTION_DP);

        fg_info_in.dnx_quals[0] =
            DNX_QUAL(DNX_FIELD_QUAL_CLASS_META2, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_QUAL_CMP_KEY_0_DECODED);
        
        fg_info_in.dnx_quals[1] =
            DNX_QUAL(DNX_FIELD_QUAL_CLASS_META2, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_QUAL_PMF1_TCAM_ACTION_2);
        fg_info_in.dnx_quals[2] = DNX_QUAL(DNX_FIELD_QUAL_CLASS_META2, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_QUAL_TRJ_HASH);
        ...
        SHR_IF_ERR_EXIT(dnx_field_presel_entry_id_t_init(unit, &presel_entry_id));
