...
extern void tgp_gen_random_l2_pkt(uint8*, uint32, uint8 mac_da[NUM_BYTES_MAC_ADDR], uint8 mac_sa[NUM_BYTES_MAC_ADDR],
                                  uint16, uint16);
extern void tgp_gen_random_ip_pkt(uint8, uint8*, uint32, uint8 mac_da[NUM_BYTES_MAC_ADDR], uint8 mac_sa[NUM_BYTES_MAC_ADDR],
