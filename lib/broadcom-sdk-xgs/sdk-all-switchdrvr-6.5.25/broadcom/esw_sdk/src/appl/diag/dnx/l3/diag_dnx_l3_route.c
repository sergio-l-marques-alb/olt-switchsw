    ...
    int unit)
{
    ...
    if (dnx_data_elk.application.feature_get(unit, dnx_data_elk_application_ipv4)
        || dnx_data_l3.fec.feature_get(unit, dnx_data_l3_fec_separate_fwd_rpf_dbs))
    {
...
static sh_sand_option_t dnx_l3_route_add_common_options[] = {
...
static sh_sand_option_t dnx_l3_route_add_options[] = {
    {.inherited_options = dnx_l3_route_add_common_options},
...
static sh_sand_option_t dnx_l3_route_delete_common_options[] = {
    {"vrf", SAL_FIELD_TYPE_UINT32, "VRF", "0"},
...
static sh_sand_option_t dnx_l3_route_delete_options[] = {
    {.inherited_options = dnx_l3_route_delete_common_options},
    {"kbp_fwd", SAL_FIELD_TYPE_BOOL, "Flag. If set, indicates KBP forwarding route entry", "FALSE"},
    {"kbp_rpf", SAL_FIELD_TYPE_BOOL, "Flag. If set, indicates KBP RPF route entry", "FALSE"},
    {NULL}
};

static sh_sand_option_t dnx_l3_route_get_common_options[] = {
    {"vrf", SAL_FIELD_TYPE_UINT32, "VRF", "0"},
    {"mask", SAL_FIELD_TYPE_IP4, "IPv4 mask", "0.0.0.0"},
    {"IP", SAL_FIELD_TYPE_IP4, "IPv4 address", "0.0.0.0"},
    {"IP6", SAL_FIELD_TYPE_IP6, "IPv6 address", "0000:0000:0000:0000:0000:0000:0000:0000"},
...
static sh_sand_option_t dnx_l3_route_get_options[] = {
    {.inherited_options = dnx_l3_route_get_common_options},
    {"kbp_fwd", SAL_FIELD_TYPE_BOOL, "Flag. If set, indicates KBP forwarding route entry", "FALSE"},
    {"kbp_rpf", SAL_FIELD_TYPE_BOOL, "Flag. If set, indicates KBP RPF route entry", "FALSE"},
    {NULL}
};
    ...
    sh_sand_control_t * sand_control)
{
    ...
    {
        SH_SAND_GET_BOOL("kbp_fwd", fwd);
        SH_SAND_GET_BOOL("kbp_rpf", rpf);
    }
    ...
    else if ((ip6_present && !ip_present) || (v6_flag == TRUE))
    {
        ...
        if (dnx_data_elk.application.feature_get(unit, dnx_data_elk_application_ipv6)
            || dnx_data_l3.fec.feature_get(unit, dnx_data_l3_fec_separate_fwd_rpf_dbs))
        {
            route_entry.l3a_flags2 |= (fwd == TRUE) ? BCM_L3_FLAGS2_FWD_ONLY :
                (rpf == TRUE) ? BCM_L3_FLAGS2_RPF_ONLY : 0;
        }
    }
    else
    {
...
static shr_error_e
sh_cmd_are_kbp_entries_supported(
    int unit,
    rhlist_t * test_list)
{
    SHR_FUNC_INIT_VARS(unit);
...
sh_sand_cmd_t sh_dnx_l3_route_cmds[] = {
     ...
     */
    {"add", sh_dnx_l3_route_add_cmd, NULL, dnx_l3_route_add_options, &dnx_l3_route_add_man, NULL, NULL,
     SH_CMD_CONDITIONAL, sh_cmd_are_kbp_entries_supported}
    ,
    {"update", sh_dnx_l3_route_update_cmd, NULL, dnx_l3_route_add_options, &dnx_l3_route_update_man, NULL, NULL,
     SH_CMD_CONDITIONAL, sh_cmd_are_kbp_entries_supported}
    ,
    {"get", sh_dnx_l3_route_get_cmd, NULL, dnx_l3_route_get_options, &dnx_l3_route_get_man, NULL, NULL,
     SH_CMD_CONDITIONAL, sh_cmd_are_kbp_entries_supported}
    ,
    {"delete", sh_dnx_l3_route_delete_cmd, NULL, dnx_l3_route_delete_options, &dnx_l3_route_delete_man, NULL, NULL,
     SH_CMD_CONDITIONAL, sh_cmd_are_kbp_entries_supported}
    ,
    {NULL}
};
