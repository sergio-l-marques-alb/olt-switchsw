...
static int __macro__bcm_plp_base_t_autoneg_ability_get (char *chip_name, bcm_plp_access_t phy_info, bcm_plp_base_t_ability_t *ability) {
    return PLP_CALL((chip_name),  __base_t_autoneg_ability_get, ((phy_info), (ability)));
}
...
static int __macro__bcm_plp_base_t_autoneg_get (char *chip_name, bcm_plp_access_t phy_info, int* enable, int* done) {
    return PLP_CALL((chip_name),  __base_t_autoneg_get, ((phy_info), (enable), (done)));
}
