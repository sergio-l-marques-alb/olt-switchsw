/*
 * $Id: cint_sdk_atomics.c,v 1.27.88.1 Broadcom SDK $
 * 
...
static cint_parameter_desc_t __cint_sdk_typedefs[] = 
    {
        ...
        { "int", "_shr_rx_config_field_t", 0, 0 },
        { "int", "_shr_tx_config_field_t", 0, 0 },
#endif
        { NULL }, 
    }; 
...
cint_ast_t*
__BCM_RX_PKT_TRACE_REASON_ITER_HANDLER(const char* name, cint_ast_t* arguments, cint_ast_t* statements)
{
    cint_ast_t* _for;
    cint_ast_t* _if;
    cint_ast_t* _condition;
     ...
     */
    if(cint_ast_count(arguments) != 2) {
        cint_ast_error(arguments, CINT_E_BAD_AST,
                        "wrong number of arguments to %s()"
                        " -- expected 2, recieved %d",
                        name, cint_ast_count(arguments));
        return NULL;
    }
    arg1 = arguments->next;
     ...
     * This returns the following code tree:
     *
     * for(arg1 = bcmPktTraceEventIngressCmlFlags;
     *     arg1 < bcmPktTraceEventCount; arg1++)
     *          if(BCM_RX_PKT_TRACE_REASON_GET(arg0, arg1))
     *              [statements]
     *
     * to simulate BCM_RX_PKT_TRACE_REASON_ITER()
     *
     */

    /* Function call "BCM_RX_PKT_TRACE_REASON_GET(arg0, arg1)" */
    _condition = cint_ast_function(
                cint_ast_identifier("BCM_RX_PKT_TRACE_REASON_GET"), arguments);

    /* if(BCM_RX_PKT_TRACE_REASON_GET(arg0,arg1)) { statements } */
    _if = cint_ast_if(_condition, statements, 0);

    /* for(arg1 = bcmPktTraceEventIngressCmlFlags;
     *     arg1 < bcmPktTraceEventCount; arg1++) (condition)
     */
    _for = cint_ast_for(
                /* arg1 = bcmPktTraceEventIngressCmlFlags */
                cint_ast_operator(cintOpAssign,
                                  arg1,
                                  cint_ast_integer(
                                    bcmPktTraceEventIngressCmlFlags)),
                /* arg1 < bcmPktTraceEventCount */
                cint_ast_operator(cintOpLessThan,
                                  arg1,
                                  cint_ast_integer(bcmPktTraceEventCount)),
...
cint_ast_t*
__BCM_PKT_DROP_REASON_ITER_HANDLER(const char* name,
                                   cint_ast_t* arguments,
                                   cint_ast_t* statements)
{
    cint_ast_t* _for;
    cint_ast_t* _if;
    cint_ast_t* _condition;
     ...
     * This returns the following code tree:
     *
     * for(arg1 = bcmPktDropReasonEgressVlanTranslateMiss;
     *     arg1 < bcmPktDropReasonCount; arg1++)
     *          if(BCM_PKT_DROP_REASON_GET(arg0, arg1))
     *              [statements]
     *
     * to simulate BCM_PKT_DROP_REASON_ITER()
     *
     */

    /* Function call "BCM_PKT_DROP_REASON_GET(arg0, arg1)" */
    _condition = cint_ast_function(
                    cint_ast_identifier("BCM_PKT_DROP_REASON_GET"), arguments);

    /* if(BCM_PKT_DROP_REASON_GET(arg0,arg1)) { statements } */
    _if = cint_ast_if(_condition, statements, 0);

    /* for(arg1 = bcmPktDropReasonEgressVlanTranslateMiss;
     *     arg1 < bcmPktDropReasonCount; arg1++) (condition)
     */
    _for = cint_ast_for(
                /* arg1 = bcmPktTraceEventIngressCmlFlags */
                cint_ast_operator(cintOpAssign,
                                  arg1,
                                  cint_ast_integer(
                                    bcmPktDropReasonEgressVlanTranslateMiss)),
                /* arg1 < bcmPktDropReasonCount */
                cint_ast_operator(cintOpLessThan,
                                  arg1,
                                  cint_ast_integer(bcmPktDropReasonCount)),
...
static cint_custom_iterator_t __sdk_custom_iterators[] = 
    {
        ...
        { "BCM_RX_PKT_TRACE_REASON_ITER",
                                    __BCM_RX_PKT_TRACE_REASON_ITER_HANDLER },
        { "BCM_PKT_DROP_REASON_ITER", __BCM_PKT_DROP_REASON_ITER_HANDLER },
        { NULL }
    }; 
