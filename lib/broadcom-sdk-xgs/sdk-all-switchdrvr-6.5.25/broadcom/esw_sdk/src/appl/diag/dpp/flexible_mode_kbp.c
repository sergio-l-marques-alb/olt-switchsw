...
int flexible_mode_ref_app(int unit, bcm_switch_concat_header_t concat_header, uint8 verbosity_level, uint8 tap_init)
{
    ...
    struct kbp_db *kbp_db_em = NULL;                                    /* kbp em db */
    struct kbp_db *kbp_db_ternary = NULL;                               /* kbp ternary db */
    struct kbp_db *kbp_db_ternary_l2 = NULL;                            /* kbp ternary db */
    struct kbp_ad_db *ad_db_em = NULL;                                  /* kbp ad em db */
    struct kbp_ad_db *ad_db_ternary = NULL;                             /* kbp ad ternary db */
    struct kbp_ad_db *ad_db_ternary_l2 = NULL;                          /* kbp ad ternary db */
    bcm_switch_kbp_apptype_info_t *apptype_info = NULL;                 /* app type info */
