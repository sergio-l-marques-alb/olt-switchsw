    ...
    int* bde_unit)
{
    ...
    if (nof_values > 0) {
        ...
        for (i = 0; i < nof_values;) {
            ...
            units[unit] = UNIT_RESERVED; /* mark the unit as reserved */
            /** the inde i is increamented twice in the scope of this for loop.
             * prior to this for loop it is verified that nof of values is even.
             * both conditions together assure that we will not have out-of-bounds read */
