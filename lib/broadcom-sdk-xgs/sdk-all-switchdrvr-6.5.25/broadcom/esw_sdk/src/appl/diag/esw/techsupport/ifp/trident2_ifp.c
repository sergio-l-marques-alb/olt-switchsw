/*
 * $Id: trident2_ifp.c Broadcom SDK $
...
char * techsupport_ifp_trident2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "ifp" feature's software dump command list */
char * techsupport_ifp_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
#endif /* BCM_SW_STATE_DUMP_DISABLE */

/* Structure that maintains memory list for
 * "ifp" feature for Trident2 chipset. */
static soc_mem_t techsupport_ifp_trident2_memory_table_list[] = {
    PORT_TABm,
    LPORT_TABm,
 ...
 * "ifp" feature for Trident2 chipset. */
techsupport_reg_t techsupport_ifp_trident2_reg_list[] = {
 ...
 * "ifp" feature for Trident2 chipset. */
techsupport_data_t techsupport_ifp_trident2_data = {
    techsupport_ifp_diag_cmdlist,
    techsupport_ifp_trident2_reg_list,
    techsupport_ifp_trident2_memory_table_list,
    techsupport_ifp_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_ifp_sw_dump_cmdlist,
    techsupport_ifp_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
