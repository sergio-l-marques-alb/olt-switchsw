/*
 * $Id: saber2_l3uc.c Broadcom SDK $
 * $Copyright: (c) 2021 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    saber2_l3uc.c
 * Purpose: Maintains all the debug information for l3uc
 *          feature for saber2.
*/
...
/* "l3uc" feature's diag command list valid only for Saber2 */
char * techsupport_l3uc_saber2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "l3uc" feature's software dump command list valid only for Saber2 */
char * techsupport_l3uc_saber2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "l3uc" feature for Saber2 chipset. */
static soc_mem_t techsupport_l3uc_saber2_memory_table_list[] = {
 ...
 * "l3uc" feature for Saber2 chipset. */
techsupport_reg_t techsupport_l3uc_saber2_reg_list[] = {
 ...
 * "l3uc" feature for Saber2 chipset. */
techsupport_data_t techsupport_l3uc_saber2_data = {
    techsupport_l3uc_diag_cmdlist,
    techsupport_l3uc_saber2_reg_list,
    techsupport_l3uc_saber2_memory_table_list,
    techsupport_l3uc_saber2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_l3uc_sw_dump_cmdlist,
    techsupport_l3uc_saber2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
