...
*   * None
*/
shr_error_e appl_dnx_field_bier_init(
    int unit);
...
/**
 * \brief
 *   This function creates a application for field module, that disables the two counters using stat profile actions.
 * \param [in] unit - The unit number.
 *
 * \return
 *   Error code (as per 'shr_error_e').
 ...
 *   shr_error_e
 */
shr_error_e appl_dnx_field_disable_erpp_counters_init(
    int unit);
...
/**
 * \brief
 *   This functions determines if the app should be skipped, DISABLE_ERPP_COUNTERS App
 * \param [in] unit - The unit number.
 * \param [out] dynamic_flags - indicate if the application should be skipped or not
 * \return
 *   Error code (as per 'shr_error_e').
 ...
 *   shr_error_e
 */
shr_error_e appl_dnx_field_disable_erpp_counters_cb(
    int unit,
    int *dynamic_flags);
