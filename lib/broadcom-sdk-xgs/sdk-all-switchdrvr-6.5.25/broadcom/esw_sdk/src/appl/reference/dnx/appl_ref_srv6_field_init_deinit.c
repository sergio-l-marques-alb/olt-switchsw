    ...
    field_srv6_endpoint_psp_info_t * appl_ref_field_srv6_endpoint_psp_ext_cut_info)
{
    ...
    SHR_IF_ERR_EXIT(bcm_field_qualifier_create
                    (unit, 0, &qual_info, &appl_ref_field_srv6_endpoint_psp_info->udh_type_qual));
    ...
    fg_info.qual_types[3] = appl_ref_field_srv6_endpoint_psp_info->udh_type_qual;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set
                    (unit, appl_ref_field_srv6_egress_usp_info.ipmf1_context_id,
                     dnx_data_field.preselector.srv6_egress_usp_presel_id_ipmf1_get(unit), 0));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set
                    (unit, appl_ref_field_srv6_endpoint_usp_ext_cut_info.ipmf1_context_id,
                     dnx_data_field.preselector.srv6_endpoint_usp_extended_cut_presel_id_ipmf1_get(unit), 1));
