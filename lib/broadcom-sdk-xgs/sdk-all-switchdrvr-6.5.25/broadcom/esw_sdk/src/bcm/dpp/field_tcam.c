    ...
    else
    {
        if (SOC_IS_QUX(unit)) {
            switch (bank_sram_id)
            {
                case 16:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_16m;
                    break;
                }
                case 17:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_17m;
                    break;
                }
                case 18:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_18m;
                    break;
                }
                case 19:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_19m;
                    break;
                }
                case 20:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_20m;
                    break;
                }
                case 21:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_21m;
                    break;
                }
                case 22:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_22m;
                    break;
                }
                case 23:
                {
                    mem = PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_23m;
                    break;
                }
                default:
                {
    ...
    ARAD_TCAM_LOCATION entry_abs_location)
{
    ...
    CONST static soc_mem_t mem_array_qux[9] = {
        PPDB_A_TCAM_ACTION_HIT_INDICATIONm,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_16m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_17m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_18m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_19m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_20m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_21m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_22m,
        PPDB_A_TCAM_ACTION_HIT_INDICATION_SMALL_23m
    };
    ...
    for (mem_index = 0; mem_index < nof_tcam_hit_indication_memories; mem_index++)
    {
        ...
        if (entry_abs_location.entry == BCM_FIELD_ENTRY_INVALID)
        {
            mem = SOC_IS_QUX(unit) ? mem_array_qux[mem_index] : mem_array[mem_index];
        }
