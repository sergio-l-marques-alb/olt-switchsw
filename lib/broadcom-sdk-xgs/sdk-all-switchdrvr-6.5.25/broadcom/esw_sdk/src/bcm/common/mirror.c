...
bcm_mirror_destination_t_init(bcm_mirror_destination_t *mirror_dest)
{
    if (NULL != mirror_dest) {
        ...
        for (admit_profile = 0; admit_profile < BCM_MIRROR_ADMIT_PROFILES_NOF; admit_profile++) {
            mirror_dest->drop_group_bmp_array[admit_profile] = BCM_MIRROR_DROP_GROUP_BMP_ALL;
        }
