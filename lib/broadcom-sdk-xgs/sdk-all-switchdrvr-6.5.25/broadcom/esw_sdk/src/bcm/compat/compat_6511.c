 ...
 */
STATIC void
_bcm_compat6511out_mirror_destination_t(bcm_compat6522_mirror_destination_t *from,
                                         ...
                                         *mirror_dest)
{
    ...
    if (NULL != mirror_dest) {
        ...
        new_mirror_dest = (bcm_compat6522_mirror_destination_t *)
            sal_alloc(sizeof(bcm_compat6522_mirror_destination_t), "New Mirror Dst Entry");
