    ...
    bcm_compat6517_l3_ecmp_member_t *ecmp_member_array)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_l3_ecmp_create(unit, options, ecmp_info, ecmp_member_count,
                            new_member_array);
    ...
    int *ecmp_member_count)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_l3_ecmp_get(unit, ecmp_info, ecmp_member_size, new_member_array,
                         ecmp_member_count);
    ...
    bcm_compat6521_l3_egress_ecmp_t *ecmp_info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_l3_ecmp_find(unit, ecmp_member_count, new_member_array, ecmp_info);
...
STATIC void
_bcm_compat6517out_port_config_t(
    bcm_compat6523_port_config_t *from,
...
{
    int rv;
    bcm_compat6523_port_config_t *new_config = NULL;

    if (NULL != config) {
        /* Create from heap to avoid the stack to bloat */
        new_config = sal_alloc(sizeof(bcm_compat6523_port_config_t), "New config");
        if (NULL == new_config) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_port_config_get(unit, new_config);
    if (NULL != new_config) {
        /* Transform the entry from the new format to old one */
...
{
    int rv = BCM_E_NONE;
    bcm_compat6522_mirror_destination_t *new_mirror_dest = NULL;

    if (mirror_dest != NULL) {
        new_mirror_dest = (bcm_compat6522_mirror_destination_t *)
                     sal_alloc(sizeof(bcm_compat6522_mirror_destination_t),
                     "New mirror_dest");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6522_mirror_destination_create(unit, new_mirror_dest);
    ...
    bcm_compat6517_mirror_destination_t *mirror_dest)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6522_mirror_destination_get(unit, mirror_dest_id, new_mirror_dest);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_mirror_header_info_t *new_mirror_header_info = NULL;

    if (mirror_header_info != NULL) {
        new_mirror_header_info = (bcm_compat6521_mirror_header_info_t *)
                     sal_alloc(sizeof(bcm_compat6521_mirror_header_info_t),
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_mirror_header_info_set(unit, flags, mirror_dest_id, new_mirror_header_info);
    ...
    bcm_compat6517_mirror_header_info_t *mirror_header_info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_mirror_header_info_get(unit, mirror_dest_id, flags, new_mirror_header_info);
...
{
    int rv = 0;
    bcm_compat6520_tunnel_terminator_t *new_info = NULL;

    if (info != NULL) {
        new_info = (bcm_compat6520_tunnel_terminator_t*)
           sal_alloc(sizeof(bcm_compat6520_tunnel_terminator_t), "New tunnel terminator info");
        if (new_info == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    rv = bcm_compat6520_l2gre_tunnel_terminator_create(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_l2gre_tunnel_terminator_get(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_l2gre_tunnel_terminator_update(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_vxlan_tunnel_terminator_create(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_vxlan_tunnel_terminator_get(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_vxlan_tunnel_terminator_update(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_tunnel_terminator_add(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_tunnel_terminator_delete(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_tunnel_terminator_create(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_tunnel_terminator_get(unit, new_info);
        ...
        bcm_compat6517_tunnel_terminator_t *info)
{
    ...
    rv = bcm_compat6520_tunnel_terminator_update(unit, new_info);
...
{
    COMPILER_64_COPY(to->start_timer_usecs, from->start_timer_usecs);
    to->export_param.export_threshold = COMPILER_64_LO(
                                            from->export_param.export_threshold);
