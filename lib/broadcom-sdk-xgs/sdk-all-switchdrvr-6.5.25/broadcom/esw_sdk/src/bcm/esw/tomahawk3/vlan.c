...
_bcm_th3_vlan_pbmp_profile_init(int unit) {
    ...
    bcm_pbmp_t pbmp;
    void *entry_mask[1];
    port_bitmap_profile_entry_t pbmp_profile_mask;
    ...
    sal_memset(&pbmp_profile_mask, 0xFF, sizeof(port_bitmap_profile_entry_t));
    soc_mem_field32_set(unit, mem, &pbmp_profile_mask, ECCPf, 0);
    entry_mask[0] = &pbmp_profile_mask;

    SOC_IF_ERROR_CLEAN_RETURN(
        soc_profile_mem_index_create(unit, &mem, &entry_dwords,
                                        NULL, NULL, entry_mask,
                                        1, vlan_pbmp_profile[unit]),
...
_bcm_th3_vlan_action_profile_init(int unit)
{
    ...
    ing_vlan_tag_action_profile_entry_t ing_profile_mask;
    egr_vlan_tag_action_profile_entry_t egr_profile_entry;
    egr_vlan_tag_action_profile_entry_t egr_profile_mask;
    uint32 rval;
    soc_mem_t mem;
    int temp_index;
    int entry_idxmax;
    ...
    sal_memset(&ing_profile_mask, 0xff, sizeof(ing_profile_mask));
    entry_mask[0] = &ing_profile_mask;
    soc_mem_field32_set(unit, mem, entry_mask[0], ECCPf, 0);
    if (SOC_FAILURE(
            soc_profile_mem_index_create(unit, &mem, &entry_words,
                                     &entry_idxmin, &entry_idxmax, entry_mask,
                                     1, ing_action_profile[unit]))) {
    ...
    sal_memset(&egr_profile_mask, 0xff, sizeof(egr_profile_mask));
    entry_mask[0] = &egr_profile_mask;
    soc_mem_field32_set(unit, mem, entry_mask[0], ECCPf, 0);
    if (SOC_FAILURE(soc_profile_mem_index_create(unit, &mem, &entry_words,
                                                 NULL, NULL, entry_mask, 1,
