                                        ...
                                        soc_mem_t mem, soc_field_t field, uint32 value)
{
    ...
    fp_hg_classid_select_entry_t fp_hg_ent;
    ifp_i2e_classid_select_entry_t ifp_ent;
    ifp_hg_classid_select_entry_t ifp_hg_ent;
    void *entries[2];
...
_bcm_td2p_port_control_egress_class_select_set(int unit, bcm_port_t port, uint32 value)
{
    ...
    mem = SOC_IS_TRIDENT3X(unit) ? IFP_I2E_CLASSID_SELECTm : FP_I2E_CLASSID_SELECTm;
    BCM_IF_ERROR_RETURN
...
_bcm_td2p_port_control_higig_class_select_set(int unit, bcm_port_t port, uint32 value)
{
    ...
    mem = SOC_IS_TRIDENT3X(unit) ? IFP_HG_CLASSID_SELECTm : FP_HG_CLASSID_SELECTm;
    BCM_IF_ERROR_RETURN
        (_bcm_td2p_port_control_class_select_set(unit, port, table_id, mem, field, value));
