...
_bcm_hr4_cosq_cleanup(int unit)
{
    ...
    if (soc_feature(unit, soc_feature_pfc_deadlock)) {
        (void)_bcm_hr4_pfc_deadlock_deinit(unit);
    }
        ...
        int *weight, int mc, int setget)
{
    ...
    switch(level) {
        ...
        case SOC_HR4_NODE_LVL_L3:
            ...
            if(mc == 1) {
                index += SOC_HR4_NUM_MAX_UC_QUEUES_PER_PIPE;
            }
            break;
        default:
        return BCM_E_PARAM;
        ...
        if (BCM_GPORT_IS_SCHEDULER(gport)) {
            ...
            if (IS_CPU_PORT(unit, local_port)) {
                ...
                if (BCM_GPORT_IS_MCAST_QUEUE_GROUP(gport)) {
                     index =  node->hw_index + SOC_HR4_NUM_MAX_UC_QUEUES_PER_PIPE;
                }
            }
        } else {
            return BCM_E_PARAM;
                               ...
                               bcm_cosq_gport_discard_t *discard)
{
    ...
    cell_field_max = HR4_WRED_CELL_FIELD_MAX;
...
/*
 * Function: _bcm_hr4_cosq_egr_queue_color_limit_mode_set
 * Purpose: Set color limit mode per queue to static (0) or
 *          dynamic (1)
*/

STATIC int
_bcm_hr4_cosq_egr_queue_color_limit_mode_set(int unit, bcm_gport_t gport,
                                             bcm_cos_queue_t cosq,
                                             bcm_cosq_control_t type,
                                             int arg)
{
...
/*
 * Function: _bcm_hr4_cosq_egr_queue_color_limit_set
...
STATIC int
_bcm_hr4_cosq_egr_queue_color_limit_set(int unit, bcm_gport_t gport,
                                        bcm_cos_queue_t cosq,
                                        bcm_cosq_control_t type,
                                        int arg)
{
                        ...
                        bcm_cosq_control_t type, int arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlEgressMCQueueColorLimitDynamicEnable:
            return _bcm_hr4_cosq_egr_queue_color_limit_mode_set(unit, gport, cosq,
                                                              type, arg);
        ...
        case bcmCosqControlEgressMCQueueYellowLimit:
            return _bcm_hr4_cosq_egr_queue_color_limit_set(unit, gport, cosq,
                                                         type, arg);
...
/*
 * Function: _bcm_hr4_cosq_egr_queue_color_limit_mode_get
 * Purpose: Get color limit mode per queue.
 * Returns: 0 (static) or 1 (dynamic)
*/
STATIC int
_bcm_hr4_cosq_egr_queue_color_limit_mode_get(int unit, bcm_gport_t gport,
                                             bcm_cos_queue_t cosq,
                                             bcm_cosq_control_t type,
                                             int* arg)
{
...
/*
 * Function: _bcm_hr4_cosq_egr_queue_color_limit_get
...
STATIC int
_bcm_hr4_cosq_egr_queue_color_limit_get(int unit, bcm_gport_t gport,
                                        bcm_cos_queue_t cosq,
                                        bcm_cosq_control_t type,
                                        int* arg)
{
                        ...
                        bcm_cosq_control_t type, int *arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlEgressUCQueueColorLimitDynamicEnable:
        case bcmCosqControlEgressMCQueueColorLimitDynamicEnable:
            return _bcm_hr4_cosq_egr_queue_color_limit_mode_get(unit, gport, cosq,
                                                       type, arg);
        case bcmCosqControlEgressUCQueueRedLimit:
        case bcmCosqControlEgressUCQueueYellowLimit:
        case bcmCosqControlEgressMCQueueRedLimit:
        case bcmCosqControlEgressMCQueueYellowLimit:
        return _bcm_hr4_cosq_egr_queue_color_limit_get(unit, gport, cosq, type,
                                                       arg);
        default:
            break;
    }
...
bcm_hr4_cosq_init(int unit)
{
    ...
    for (ii = 0; ii < HR4_WRED_PROFILE_NUM; ii++) {
        soc_mem_field32_set(unit, wred_mems[ii], entries[ii],
                            MIN_THDf, HR4_WRED_CELL_FIELD_MAX);
        soc_mem_field32_set(unit, wred_mems[ii], entries[ii],
                            MAX_THDf, HR4_WRED_CELL_FIELD_MAX);
    }
