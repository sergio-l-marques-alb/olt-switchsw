                           ...
                           )
{
    ...
    _field_scache_stage_hdr_save(fc, start_char,1);
                                    ...
                                    )
{
    ...
    if (fc->l2warm) {
        rv = _field_scache_stage_hdr_chk(fc, _FIELD_IFP_DATA_START, 1);
        if (BCM_FAILURE(rv)) {
            return (rv);
        }
    }
                               ...
                               _field_stage_t *stage_fc)
{
    ...
    if (fc->l2warm) {
        rv = _field_scache_stage_hdr_chk(fc, _FIELD_VFP_DATA_START, 1);
        if (BCM_FAILURE(rv)) {
            return (rv);
        }
    }
