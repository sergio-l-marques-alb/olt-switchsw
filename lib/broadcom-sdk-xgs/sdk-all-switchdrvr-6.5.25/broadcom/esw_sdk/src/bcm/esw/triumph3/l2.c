...
_bcm_tr3_l2_replace_data_mask_setup(int unit, _soc_tr3_l2_replace_t *rep)
{
    ...
    if (!(rep->flags & BCM_L2_REPLACE_IGNORE_PENDING)) {
        soc_mem_field32_set(unit, L2_ENTRY_1m, &rep->match_mask1, L2__PENDINGf, 1);
        if (rep->flags & BCM_L2_REPLACE_PENDING) {
            soc_mem_field32_set(unit, L2_ENTRY_1m, &rep->match_data1, L2__PENDINGf, 1);
        }
    }
    ...
    if (!(rep->flags & BCM_L2_REPLACE_IGNORE_PENDING)) {
        ...
        if (rep->flags & BCM_L2_REPLACE_PENDING) {
            soc_mem_field32_set(unit, L2_ENTRY_2m, &rep->match_data2, L2__PENDINGf, 1);
        }
    }
    ...
    if (!(rep->flags & BCM_L2_REPLACE_IGNORE_PENDING)) {
        soc_mem_field32_set(unit, EXT_L2_ENTRY_1m, &rep->ext_match_mask1, PENDINGf, 1);
        if (rep->flags & BCM_L2_REPLACE_PENDING) {
            soc_mem_field32_set(unit, EXT_L2_ENTRY_1m, &rep->ext_match_data1,
                                PENDINGf, 1);
        }
    ...
    if (!(rep->flags & BCM_L2_REPLACE_IGNORE_PENDING)) {
        soc_mem_field32_set(unit, EXT_L2_ENTRY_2m, &rep->ext_match_mask2, PENDINGf, 1);
        if (rep->flags & BCM_L2_REPLACE_PENDING) {
            soc_mem_field32_set(unit, EXT_L2_ENTRY_2m, &rep->ext_match_data2, PENDINGf, 1);
        }
    }
