...
bcmi_td2_bfd_init(int unit)
{
    ...
    if (bfd_feature_enable & BFD_MHOP_FEATURE_ENABLE) {
        ...
        BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg32_udp_portctrl_init(unit, BFD_UDP_PORTM_HOPf, BFD_UDP_MULTI_HOP_DEST_PORT));
        ...
        BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg32_udp_portctrl_init(unit, BFD_UDP_PORTM_HOPf, MICRO_BFD_DEST_PORT));
        ...
        BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg32_udp_portctrl_init(unit, BFD_UDP_PORTM_HOPf, BFD_ECHO_DEST_PORT));
        ...
        BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg32_rx_udp_portctrl_deinit(unit));
        ...
        if (bfd_feature_enable & BFD_ECHO_FEATURE_ENABLE) {
            if(!(bfd_feature_enable & BFD_MHOP_FEATURE_ENABLE)) {
                /* Set UDP Dest port for Echo BFD session */
                BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg64_udp_portctrl_init(unit, BFD_UDP_PORTM_HOPf, BFD_ECHO_DEST_PORT));

            } else if(!(bfd_feature_enable & BFD_MICRO_FEATURE_ENABLE)) {
                BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg64_udp_portctrl_init(unit, BFD_UDP_PORT_LAGf, BFD_ECHO_DEST_PORT));
            }
            ...
            /* Clear HW default values of BFD_RX_UDP_CONTROL register */
            BCM_IF_ERROR_RETURN(_bcmi_bfd_hw_reg64_rx_udp_portctrl_deinit(unit));
