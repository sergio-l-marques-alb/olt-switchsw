...
mbcm_functions_t mbcm_trident_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_td_cosq_port_bandwidth_set,
    bcm_td_cosq_port_bandwidth_get,
    bcm_td_cosq_discard_set,
    bcm_td_cosq_discard_get,
...
typedef int bcm_esw_trident_mbcm_not_empty; /* Make ISO compilers happy. */
