...
mbcm_functions_t mbcm_firebolt6_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_fb6_cosq_discard_set,
    bcm_fb6_cosq_discard_get,
...
#else  /* BCM_HELIX5_SUPPORT */
int bcm_esw_firebolt6_mbcm_not_empty;
