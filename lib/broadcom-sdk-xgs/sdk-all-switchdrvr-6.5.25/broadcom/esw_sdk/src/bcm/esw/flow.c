...
/*
 * Function:
 *      bcm_esw_flow_tunnel_srv6_srh_add
 * Purpose:
 *   Parameters:
 *      unit        - (IN)  Unit ID.
 *
 */
int bcm_esw_flow_tunnel_srv6_srh_add(
    int unit,
    uint32 options,
    ...
    bcm_ip6_t *sid_list)
{
    ...
    if (soc_feature(unit,soc_feature_flex_flow)) {
        return bcmi_esw_flow_tunnel_srv6_srh_add(unit, options, info, nofs, sid_list);
    } else
...
/*
 * Function:
 *      bcm_esw_flow_tunnel_srv6_srh_delete
 * Purpose:
 *   Parameters:
 *      unit        - (IN)  Unit ID.
 *
 */
int bcm_esw_flow_tunnel_srv6_srh_delete(
    int unit,
    bcm_gport_t tunnel_id)
{
#if defined(BCM_TRIDENT3_SUPPORT)
    if (soc_feature(unit,soc_feature_flex_flow)) {
        return bcmi_esw_flow_tunnel_srv6_srh_delete(unit, tunnel_id);
    } else
#endif /* defined(BCM_TRIDENT3_SUPPORT) */
    {
         return BCM_E_UNAVAIL;
...
/*
 * Function:
 *      bcm_esw_flow_tunnel_srv6_srh_get
 * Purpose:
 *   Parameters:
 *      unit        - (IN)  Unit ID.
 *
 */
int bcm_esw_flow_tunnel_srv6_srh_get(
    int unit,
    bcm_flow_tunnel_srv6_srh_t *info,
    int max_nofs,
    bcm_ip6_t *sid_list,
...
#if defined(BCM_TRIDENT3_SUPPORT)
    if (soc_feature(unit,soc_feature_flex_flow)) {
        return bcmi_esw_flow_tunnel_srv6_srh_get(unit, info, max_nofs, sid_list, count);
    } else
#endif /* defined(BCM_TRIDENT3_SUPPORT) */
    {
         return BCM_E_UNAVAIL;
...
/*
 * Function:
 *      bcm_esw_flow_tunnel_srv6_srh_traverse
 * Purpose:
 *   Parameters:
 *      unit        - (IN)  Unit ID.
 *
 */
int bcm_esw_flow_tunnel_srv6_srh_traverse(
    int unit,
...
#if defined(BCM_TRIDENT3_SUPPORT)
    if (soc_feature(unit,soc_feature_flex_flow)) {
        return bcmi_esw_flow_tunnel_srv6_srh_traverse(unit, cb, user_data);
    } else
#endif /* defined(BCM_TRIDENT3_SUPPORT) */
    {
         return BCM_E_UNAVAIL;
...
/*
 * Function:
 *      bcm_esw_flow_tunnel_srv6_srh_delete_all
 * Purpose:
 *   Parameters:
 *      unit        - (IN)  Unit ID.
 *
 */
int bcm_esw_flow_tunnel_srv6_srh_delete_all(
    int unit)
{
#if defined(BCM_TRIDENT3_SUPPORT)
    if (soc_feature(unit,soc_feature_flex_flow)) {
        return bcmi_esw_flow_tunnel_srv6_srh_delete_all(unit);
    } else
#endif /* defined(BCM_TRIDENT3_SUPPORT) */
    {
         return BCM_E_UNAVAIL;
...
/*
 * Function:
 *      _bcmi_esw_flex_match_dip_sip_get
 * Purpose:
 *      Get the configured match dip/set state.
 * Parameters:
 *      unit  - (IN) SOC unit number.
...
_bcmi_esw_flex_match_dip_sip_based_svp_get(int unit, int *value)
{
    ...
    BCM_IF_ERROR_RETURN(READ_ING_FLEX_CONFIGr(unit, &rval));
    *value = soc_reg_field_get(unit, ING_FLEX_CONFIGr, rval,
                     VXLAN_IPV4_FLEX_PER_TUNNEL_SVP_ENABLEf);
    return BCM_E_NONE;
...
/*
 * Function:
 *      _bcmi_esw_flex_match_dip_sip_set
 * Purpose:
 *      Set the configured match dip/set state.
 * Parameters:
 *      unit  - (IN) SOC unit number.
...
_bcmi_esw_flex_match_dip_sip_based_svp_set(int unit, int value)
{
    ...
    soc_reg_field_set(unit, ING_FLEX_CONFIGr, &rval,
              VXLAN_IPV4_FLEX_PER_TUNNEL_SVP_ENABLEf, value);
    BCM_IF_ERROR_RETURN(WRITE_ING_FLEX_CONFIGr(unit, rval));
    return BCM_E_NONE;
}
