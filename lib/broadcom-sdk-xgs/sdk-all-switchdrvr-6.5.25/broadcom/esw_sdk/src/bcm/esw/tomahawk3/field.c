...
_field_th3_presel_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    uint8 cpu_tx_dest_type_offset = 0;
    uint8 cpu_tx_flow_type_offset = 0;
    uint8 cpu_pkt_prof_ctrl_offset = 0;
    uint8 drop_offset = 0;
    ...
    if (stage_fc->stage_id == _BCM_FIELD_STAGE_EXACTMATCH) {
        ...
        cpu_tx_dest_type_offset = 34;
        cpu_tx_flow_type_offset = 38;
        cpu_pkt_prof_ctrl_offset = 32;
        drop_offset = 33;
        cpu_tx_offset = 34;
        fwd_type_offset = 42;
        ...
        mixed_src_class_offset = 0;
        em_lt_id_offset = 32;
        cpu_tx_dest_type_offset = 36;
        cpu_tx_flow_type_offset = 40;
        cpu_pkt_prof_ctrl_offset = 44;
        cpu_tx_offset = 36;
        drop_offset = 47;
        pkt_res_offset = 48;
        fwd_type_offset = 54;
    ...
    _FP_PRESEL_QUAL_ADD(unit, stage_fc, bcmFieldQualifyCpuTxDestType,
        0, _bcmFieldSliceSelDisable, 0, _bcmFieldQualifierTypePresel,
        cpu_tx_dest_type_offset, 4);
    _FP_PRESEL_QUAL_ADD(unit, stage_fc, bcmFieldQualifyCpuTxFlowType,
        0, _bcmFieldSliceSelDisable, 0, _bcmFieldQualifierTypePresel,
        cpu_tx_flow_type_offset, 2);
    _FP_PRESEL_QUAL_ADD(unit, stage_fc, bcmFieldQualifyCpuVisibilityPacket,
        0, _bcmFieldSliceSelDisable, 0, _bcmFieldQualifierTypePresel,
...
_bcm_field_th3_common_actions_init(int unit, _field_stage_t *stage_fc)
{
    ...
    uint32 counter_offset = 0;          /* Offset of COUNTER_SET. */
    ...
    if (stage_fc->stage_id == _BCM_FIELD_STAGE_INGRESS) {
        ...
        counter_offset         = 63; /* REDIRECT_SET(38b) +
                                      * CHANGE_CPU_COS_SET(8b)
                                      * COUNTER_SET(25b) */
    ...
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionGpStatGroup,
                                 0, _FieldActionCounterSet, offset + 19, 2, -1);
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionRpStatGroup,
                                 0, _FieldActionCounterSet, offset + 21, 2, -1);
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionYpStatGroup,
                                 0, _FieldActionCounterSet, offset + 23, 2, -1);
...
_bcm_field_th3_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData7, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 1, 16, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData6, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 2, 32, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData5, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 3, 48, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData4, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 4, 64, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 5, 80, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 6, 96, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData1, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 7, 112, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData0, qual_flags);

    /* UDF2 Qualifiers. */
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 0, 0, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData15, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 1, 16, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData14, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 2, 32, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData13, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 3, 48, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData12, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 4, 64, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData11, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 5, 80, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData10, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 6, 96, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData9, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 7, 112, 16);
    BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_UDF, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyData8, qual_flags);
    ...
    if (soc_feature(unit, soc_feature_fp_ltid_match_all_parts) &&
        ...
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyPreLogicalTableId1, qual_flags);

        BCMI_KEYGEN_QUAL_CFG_INIT(unit);
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 12, 96, 4);
        BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_LTID, 2);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyPreLogicalTableId2, qual_flags);
    }

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 12, 103, 1);
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyExactMatchGroupClassIdLookup0, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_LTID,
        0, 124, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db,
        (bcm_field_qualify_t)_bcmFieldQualifyPreLogicalTableId, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, (bcm_field_qualify_t)_bcmFieldQualifyExactMatchHitStatusLookup0, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(2,
        BCMI_KEYGEN_EXT_SECTION_EM_FIRST_LOOKUP_CLASSID_BITS_8_11, 4, 92, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, (bcm_field_qualify_t)_bcmFieldQualifyExactMatchActionClassIdLookup0, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyL2SrcStatic, qual_flags);
                                          ...
                                          bcm_field_IpType_t *type)
{
    ...
    } else if ((0x8 == hw_data) && (0x8 == hw_mask)) {
                                   ...
                                   _field_action_t *fa)
{
    ...
    if (fa->egress_pbmp == NULL) {
        return (BCM_E_PARAM);
    }

    max_field_val = (1 << soc_mem_field_length(unit,
                        profile_mem, ELEPHANT_PKT_ONLYf)) - 1 ;

    if ((fa->elephant_pkts_only) > max_field_val) {
        return (BCM_E_PARAM);
    }
...
_bcm_field_th3_internal_em_group_create(int unit,
    ...
    rv = _bcm_field_presel_qualify_set(unit, id | BCM_FIELD_QUALIFY_PRESEL,
                                       (bcm_field_qualify_t)_bcmFieldQualifyCpuTxCtrl,
                                       &data32, &mask32);
 ...
 */
int
_field_th3_lt_mem_get(int unit, _field_group_t *fg, soc_mem_t *lt_tcam_mem) {
...
/*
 * Function:
 *     _field_th3_wb_keygen_profiles_mem_get
 * Purpose:
 ...
 */
STATIC int
_field_th3_wb_keygen_profiles_mem_get(int unit, _field_stage_t *stage_fc,
...
STATIC int
_field_th3_keygen_profile1_entry_pack_get(int unit,
            ...
            ifp_key_gen_program_profile_entry_t *prof1_entry)
{
    ...
    for (idx = 0; idx < 16; idx++) {
        fg->ext_codes[part].l2_e4_sel[idx] =
          soc_mem_field32_get(unit, mem, prof1_entry, l2_4_sel[idx]);
    }

    /* Set 16bit extractor selcode values. */
    for (idx = 0; idx < 7; idx++) {
        fg->ext_codes[part].l2_e2_sel[idx] =
             soc_mem_field32_get(unit, mem, prof1_entry, l2_2_sel[idx]);
    }

    /* Set 4bit extractor selcode values. */
    for (idx = 0; idx < 2; idx++) {
        fg->ext_codes[part].l2_e1_sel[idx] =
             soc_mem_field32_get(unit, mem, prof1_entry, l2_1_sel[idx]);
    }
 ...
 */
int
_field_th3_keygen_em_profile_entry_pack_get(int unit,
              _field_stage_t *stage_fc,
              _field_group_t *fg, int part, soc_mem_t mem,
              exact_match_key_gen_program_profile_entry_t *prof_entry)
{
    ...
    for (idx = 0; idx < 16; idx++) {
        fg->ext_codes[part].l2_e4_sel[idx] =
              soc_mem_field32_get(unit, mem, prof_entry, l2_4_sel[idx]);
    }

    /* Set 4bit extractor selcode values. */
    for (idx = 0; idx < 5; idx++) {
        fg->ext_codes[part].l2_e2_sel[idx] =
              soc_mem_field32_get(unit, mem, prof_entry, l2_2_sel[idx]);
    }

    /* Set 2bit extractor selcode values. */
    for (idx = 0; idx < 2; idx++) {
        fg->ext_codes[part].l2_e1_sel[idx] =
             soc_mem_field32_get(unit, mem, prof_entry, l2_1_sel[idx]);
    }
...
/*
 * Function:
 *     _bcm_field_th3_group_update_ext_codes_from_keygen_profiles
 * Purpose:
 ...
 */
int
_bcm_field_th3_group_update_ext_codes_from_keygen_profiles(int unit,
                                                _field_group_t *fg,
                                                int part_index,
                                                uint32 key_gen_prof_idx)
{
    ...
    if (stage_fc->stage_id == _BCM_FIELD_STAGE_INGRESS) {
        ...
        BCM_IF_ERROR_RETURN(_field_th3_wb_keygen_profiles_mem_get(unit,
                                stage_fc, fg, mem, COUNTOF(mem)));
        ifp_prof1_entry = sal_alloc(
                             sizeof(ifp_key_gen_program_profile_entry_t),
                             "ifp_key_gen_profile1_mem");
        if (ifp_prof1_entry == NULL) {
            return BCM_E_MEMORY;
        }
        ifp_prof2_entry = sal_alloc(
                              sizeof(ifp_key_gen_program_profile2_entry_t),
        ...
        if (SOC_SUCCESS(rv)) {
            ...
            rv = _field_th3_keygen_profile1_entry_pack_get(unit,
                     stage_fc, fg, part_index, mem[0], ifp_prof1_entry);
        }
        sal_free(ifp_prof1_entry);
        ...
        BCM_IF_ERROR_RETURN(_field_th3_wb_keygen_profiles_mem_get(unit,
                                stage_fc, fg, mem, COUNTOF(mem)));
        em_prof_entry = sal_alloc(
                           sizeof(exact_match_key_gen_program_profile_entry_t),
                           "em_key_gen_profile1_mem");
        if (em_prof_entry == NULL) {
            return BCM_E_MEMORY;
        }
        em_prof_mask_entry = sal_alloc(
                                 sizeof(exact_match_key_gen_mask_entry_t),
        ...
        if (SOC_SUCCESS(rv)) {
            ...
            rv = _field_th3_keygen_em_profile_entry_pack_get(unit,
                     stage_fc, fg, part_index, mem[0], em_prof_entry);
        }
        sal_free(em_prof_entry);
...
STATIC int
_bcm_field_th3_update_missing_ext_codes_from_lt_table(int unit,
                                      _field_group_t *fg,
                                      int part,
    ...
    if (SOC_IS_TOMAHAWK3(unit)) {
	    fg->ext_codes[part].udf_sel =
           soc_mem_field32_get(unit, lt_data_mem, data,
              UDF_SELf);

        fg->ext_codes[part].dst_cont_a_sel =
           soc_mem_field32_get(unit, lt_data_mem, data,
              DST_CONTAINER_0_SELf);
        fg->ext_codes[part].dst_cont_b_sel =
                  soc_mem_field32_get(unit, lt_data_mem, data,
              DST_CONTAINER_1_SELf);
        fg->ext_codes[part].udf_sel =
           soc_mem_field32_get(unit, lt_data_mem, data,
              UDF_SELf);
...
int _field_recover_th3_missing_extractor_codes(int unit)
{
    ...
    int idx2 = 0;
    int idx = 0;
    _bcm_field_group_qual_t *q_arr = NULL;
    ...
    while (fg != NULL) {
        if ((fg->stage_id == _BCM_FIELD_STAGE_INGRESS) ||
            ...
            BCM_IF_ERROR_RETURN(_field_stage_control_get(unit,
                                                          fg->stage_id,
                                                           &stage_fc));
            BCM_IF_ERROR_RETURN(_field_th3_lt_mem_get(unit, fg, &lt_tcam_mem));
            if ( (fg->lt_entry_arr != NULL ) &&
                ...
                for (i= 0; i<parts_cnt; i++) {
                    ...
                    rv = _bcm_field_th3_update_missing_ext_codes_from_lt_table(
                             unit, fg, i, lt_tcam_mem, ent);
                    if (BCM_FAILURE(rv)) {
                        return rv;
                    }
                    ...
                    rv =
                    _bcm_field_th3_group_update_ext_codes_from_keygen_profiles(
                         unit, fg, i, fg->ext_codes[i].keygen_index);
                    if (BCM_FAILURE(rv)) {
                        return rv;
                    }
                }
                ...
                qual_info_count = 0;
                BCM_IF_ERROR_CLEANUP(_field_th_group_qual_info_get(unit,
                                         stage_fc,fg, qset_req,
                ...
                keygen_cfg.ext_cfg_db =
                    stage_fc->ext_cfg_db_arr[keygen_ext_mode];
                keygen_cfg.mode = keygen_mode;
                keygen_cfg.num_parts = part_count;

                size = sizeof(bcmi_keygen_qual_offset_info_t) * part_count;
                _FP_XGS3_ALLOC(keygen_oper.qual_offset_info,
                           size,"keygen qual offset");
                ...
                for (part = 0; part < part_count; part++) {
                    keygen_oper.qual_offset_info[part].size =
                        fg->qual_arr[0][part].size;
                    size = ((sizeof(bcm_field_qualify_t)) *
                       (fg->qual_arr[0][part].size));
                    _FP_XGS3_ALLOC(keygen_oper.qual_offset_info[part].qid_arr,
                               size, "keygen qid array");
                    if (keygen_oper.qual_offset_info[part].qid_arr == NULL) {
                        rv = BCM_E_MEMORY;
                        goto cleanup;
                    }
                    size = ((sizeof(bcmi_keygen_qual_offset_t)) *
                        (fg->qual_arr[0][part].size));
                    _FP_XGS3_ALLOC(keygen_oper.qual_offset_info[part].\
                                   offset_arr, size, "keygen offset info");
                    if ( keygen_oper.qual_offset_info[part].offset_arr ==
                         NULL) {
                        rv = BCM_E_MEMORY;
                        goto cleanup;
                    }
                    for (idx1 = 0; idx1 < fg->qual_arr[0][part].size; idx1++) {
                        keygen_oper.qual_offset_info[part].qid_arr[idx1] =
                            fg->qual_arr[0][part].qid_arr[idx1];
                        keygen_oper.qual_offset_info[part].\
                            offset_arr[idx1].num_offsets =
                                fg->qual_arr[0][part].offset_arr[idx1].\
                                num_offsets;
                        for (idx2 = 0;
                             idx2 < fg->qual_arr[0][part].\
                                    offset_arr[idx1].num_offsets;
                             idx2++) {
                            keygen_oper.qual_offset_info[part].\
                                offset_arr[idx1].offset[idx2] =
                                    fg->qual_arr[0][part].\
                                    offset_arr[idx1].offset[idx2];
                            keygen_oper.qual_offset_info[part].\
                                offset_arr[idx1].width[idx2] =
                                    fg->qual_arr[0][part].\
                                    offset_arr[idx1].width[idx2];
                        }
                    }
                }
                BCM_IF_ERROR_CLEANUP(_field_th_keygen_ext_ctrl_info_get(unit,
                                  fg, &keygen_cfg));
                BCM_IF_ERROR_CLEANUP(bcmi_keygen_ext_codes_regenerate(unit,
                                 part_count, &keygen_cfg, &keygen_oper));
                for (part = 0; part < part_count; part++) {
                    for (idx = 7; idx < 10; idx++) {
                        fg->ext_codes[part].l1_e16_sel[idx] = -1;
                    }

                    /* Set 4bit extractor selcode values. */
                    for (idx = 8; idx < 10; idx++) {
                        fg->ext_codes[part].l1_e4_sel[idx] = -1;
                    }

                    /* Set 2bit extractor selcode values. */
                    for (idx = 0; idx < 16; idx++) {
                        fg->ext_codes[part].l2_e4_sel[idx] =  -1;
                    }

                   /* Set 16bit extractor selcode values. */
                    for (idx = 0; idx < 7; idx++) {
                        fg->ext_codes[part].l2_e2_sel[idx] = -1;
                    }

                    /* Set 4bit extractor selcode values. */
                    for (idx = 0; idx < 2; idx++) {
                        fg->ext_codes[part].l2_e1_sel[idx] =  -1;
                    }
                    
                    q_arr = &(fg->qual_arr[_FP_ENTRY_TYPE_DEFAULT][part]);
                    fg->ext_codes[part].udf_sel = -1;

                    for (idx = 0; (q_arr && (idx < q_arr->size)); idx++) {
                        if ((q_arr->qid_arr[idx] == _bcmFieldQualifyData0) || 
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData1) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData2) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData3) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData4) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData5) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData6) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData7) ) {
                            fg->ext_codes[part].udf_sel = 0;
                        } else if (
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData8) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData9) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData10) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData11) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData12) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData13) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData14) ||
                            (q_arr->qid_arr[idx] == _bcmFieldQualifyData15) ) {
                            fg->ext_codes[part].udf_sel = 1;
                        }
                    }

                    if (fg->ext_codes[part].dst_cont_a_sel == 0) {
                        fg->ext_codes[part].dst_cont_a_sel = -1;
                    }
                    if (fg->ext_codes[part].dst_cont_b_sel == 0) {
                        fg->ext_codes[part].dst_cont_b_sel = -1;
                    }
                    if (fg->ext_codes[part].ipbm_present != -1) {
                        fg->ext_codes[part].ipbm_source = 0;
                    } else {
                        fg->ext_codes[part].ipbm_source = -1;
                    }
                }
                BCM_IF_ERROR_CLEANUP(_field_th_group_keygen_oper_insert(unit,
                                 fg, &keygen_oper));
                 if (keygen_oper.qual_offset_info) {
                    for (part = 0; part < part_count; part++) {
                        if (keygen_oper.qual_offset_info[part].qid_arr) {
                            sal_free(keygen_oper.qual_offset_info[part].\
                                     qid_arr);
                            keygen_oper.qual_offset_info[part].qid_arr =\
                                NULL;
                        }
                        if (keygen_oper.qual_offset_info[part].offset_arr) {
                            sal_free(keygen_oper.qual_offset_info[part].\
                                     offset_arr);
                            keygen_oper.qual_offset_info[part].offset_arr =\
                                NULL;
                        }
                    }
                    sal_free(keygen_oper.qual_offset_info);
...
cleanup:
    ...
    if (keygen_oper.qual_offset_info) {
        for (part = 0; part < part_count; part++) {
            if (keygen_oper.qual_offset_info[part].qid_arr) {
                sal_free(keygen_oper.qual_offset_info[part].qid_arr);
                keygen_oper.qual_offset_info[part].qid_arr = NULL;
            }
            if (keygen_oper.qual_offset_info[part].offset_arr) {
                sal_free(keygen_oper.qual_offset_info[part].offset_arr);
