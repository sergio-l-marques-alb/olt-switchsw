...
#define OAMP_SCAN_INTERVAL_uS(unit) (dnx_data_oam.oamp.feature_get(unit, dnx_data_oam_oamp_oamp_v2) == 1 ? 3333 : 1670)
/** Interval in miliseconds for endpoint period */
#define OAMP_PERIOD_INTERVAL_mS(unit) (dnx_data_oam.oamp.feature_get(unit, dnx_data_oam_oamp_oamp_v2) == 1 ? 333 : 167)
