    ...
    int probability[BCM_FABRIC_NUM_OF_RCI_LEVELS])
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_fabric_rci_biasing_probability_set_verify(unit, flags, probability_info, probability));
    ...
    int probability[BCM_FABRIC_NUM_OF_RCI_LEVELS])
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_fabric_rci_biasing_probability_param_verify(unit, flags, probability_info, probability));
