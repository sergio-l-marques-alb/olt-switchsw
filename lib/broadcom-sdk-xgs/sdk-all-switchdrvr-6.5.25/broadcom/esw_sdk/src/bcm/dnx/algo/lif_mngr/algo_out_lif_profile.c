    ...
    int unit)
{
    ...
    extra_info.resource_create_info.max_tag_value = 3;
    ...
    tag_info.tag = DNX_ALGO_OUT_LIF_TAG_PORT_PROFILE;
    tag_info.force_tag = FALSE;
    tag_info.element = 44;
    ...
    exchange_tag_info.resource_alloc_info.tag = DNX_ALGO_OUT_LIF_TAG_PORT_PROFILE;
