    ...
    bcm_tunnel_initiator_t * tunnel)
{
    ...
    BCM_L3_ITF_SET(intf->l3a_intf_id, BCM_L3_ITF_TYPE_LIF, _SHR_GPORT_FLOW_LIF_ID_GET(flow_handle_info.flow_id));
    ...
    bcm_tunnel_initiator_t * tunnel)
{
    ...
    BCM_L3_ITF_LIF_TO_GPORT_FLOW_LIF(flow_handle_info.flow_id, tunnel->tunnel_id);
