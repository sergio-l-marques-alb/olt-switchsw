 ...
 */
int
imb_ilu_internal_ofr_rx_counter_reset_set(
    int unit,
    uint32 ilkn_id,
    int is_tdm,
    uint32 in_reset)
...
int
imb_ilu_internal_ofr_rx_is_high_priority_config_set(
    int unit,
    uint32 ilkn_id,
...
int
imb_ilu_internal_ofr_rx_is_high_priority_config_get(
    int unit,
    uint32 ilkn_id,
    uint32 *is_priority_high)
{
     ...
     * set value fields
     */
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_IS_ILKN_HIGH, INST_SINGLE, is_priority_high);
...
int
imb_ilu_internal_ofr_rx_sched_request_enable_set(
    int unit,
    uint32 ilkn_id,
    dbal_enum_value_field_nif_sch_priority_e dbal_sch_prio,
    uint32 is_enable)
...
int
imb_ilu_internal_ofr_rx_sched_request_enable_get(
    int unit,
    uint32 ilkn_id,
    dbal_enum_value_field_nif_sch_priority_e dbal_sch_prio,
    uint32 *is_enabled)
