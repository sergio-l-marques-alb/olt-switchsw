    ...
    bcm_cosq_rate_class_create_info_t * create_info)
{
    bcm_gport_t gport;
    int dp, is_ocb_only;
    int dram_bound_bytes_th, dram_recovery_fail_th;
    ...
    int unit)
{
    ...
    bcm_cosq_resource_amounts_t total_bytes_params[2] = { {0} };
    bcm_cosq_resource_amounts_t ocb_buffers_params[2] = { {0} };
    bcm_cosq_resource_amounts_t ocb_pds_params[2] = { {0} };
