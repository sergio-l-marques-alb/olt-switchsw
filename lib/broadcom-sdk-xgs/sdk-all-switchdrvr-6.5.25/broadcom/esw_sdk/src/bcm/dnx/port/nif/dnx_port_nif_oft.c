    ...
    bcm_port_t logical_port)
{
    ...
    /*
     * Taking out of reset all counters and the port itself
     */
    SHR_IF_ERR_EXIT(dnx_port_oft_reset_counters_and_port_set(unit, logical_port, IMB_COMMON_IN_RESET));
    ...
    bcm_port_t logical_port)
{
    ...
    /*
     * Reset all counters and the port itself
     */
    SHR_IF_ERR_EXIT(dnx_port_oft_reset_counters_and_port_set(unit, logical_port, IMB_COMMON_IN_RESET));
    ...
    int enable)
{
    ...
    /*
     * Reset / taking out of reset all counters and the port itself
     */
    in_reset = (enable) ? IMB_COMMON_OUT_OF_RESET : IMB_COMMON_IN_RESET;
    SHR_IF_ERR_EXIT(dnx_port_oft_reset_counters_and_port_set(unit, logical_port, in_reset));
