...
/**
* \brief - Init for global pobability threshold for phantom queues feature
*          Will be set to max value, making the probability 100%:
*          if  (nif_port_is_congested == 1) & Cfg_Phantom_Queues_Enable 
*          & (Phantom_queues_LFSR < Cfg_Phantom_queues_probability_threshold) -> ftmh_cni = 1
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_phantom_queues_dbal_global_prob_thresh_init(
    uint32 unit);
