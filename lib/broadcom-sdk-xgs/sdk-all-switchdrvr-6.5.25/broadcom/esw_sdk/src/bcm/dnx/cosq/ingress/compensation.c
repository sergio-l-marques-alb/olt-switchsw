    ...
    int delta)
{
    ...
    SHR_IF_ERR_EXIT(dnx_cosq_ingress_compensation_delta_hw_set(unit, core_id,
                                                               ...
                                                               DBAL_FIELD_IN_CGM_PORT, pp_port, delta));
...
*/
static shr_error_e
dnx_cosq_ingress_compensation_scheduler_enable_hw_set(
    int unit,
    ...
    int enable)
{
    ...
    /** Setting value fields */
    dbal_entry_value_field32_set(unit, entry_handle_id, field_id, INST_SINGLE, enable);
...
*/
static shr_error_e
dnx_cosq_ingress_compensation_scheduler_enable_hw_get(
    int unit,
    dbal_fields_e field_id,
    int *enable)
{
    ...
    /** Setting pointers value to receive the fields */
    dbal_value_field32_request(unit, entry_handle_id, field_id, INST_SINGLE, (uint32 *) enable);
...
*/
shr_error_e
dnx_cosq_ingress_compensation_scheduler_enable_set_verify(
    int unit,
    int enable)
{
    SHR_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_cosq_ingress_compensation_control_type_to_dbal_field(
    int unit,
    ...
    dbal_fields_e * field_id)
{
    ...
    switch (type)
    {
        case bcmCosqControlSourcePortSchedCompensationEnable:
            *field_id = DBAL_FIELD_IN_PORT_ENABLE;
            break;
        case bcmCosqControlHeaderTruncateSchedCompensationEnable:
            *field_id = DBAL_FIELD_TRUNCATE_ENABLE;
            break;
        default:
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "Wrong control type=%d.\n", type);
        }
    }
exit:
    SHR_FUNC_EXIT;
...
*/
shr_error_e
dnx_cosq_ingress_compensation_scheduler_enable_set(
    int unit,
    bcm_cosq_control_t type,
    int enable)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_compensation_scheduler_enable_set_verify(unit, enable));

    SHR_IF_ERR_EXIT(dnx_cosq_ingress_compensation_control_type_to_dbal_field(unit, type, &field_id));

    SHR_IF_ERR_EXIT(dnx_cosq_ingress_compensation_scheduler_enable_hw_set(unit, field_id, enable));
...
*/
shr_error_e
dnx_cosq_ingress_compensation_scheduler_enable_get(
    int unit,
    bcm_cosq_control_t type,
    int *enable)
{
    ...
    SHR_IF_ERR_EXIT(dnx_cosq_ingress_compensation_scheduler_enable_hw_get(unit, field_id, enable));
    ...
    int delta)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_gport_pkt_size_adjust_set_verify(unit, adjust_info, delta));
    ...
    int *delta)
{
    ...
    /** Verify adjust_info */
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_gport_pkt_size_adjust_info_verify(unit, adjust_info));
