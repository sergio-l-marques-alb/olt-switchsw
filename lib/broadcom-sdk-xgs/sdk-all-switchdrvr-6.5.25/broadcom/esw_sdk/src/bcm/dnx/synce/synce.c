    ...
    bcm_port_t port)
{
    ...
    /*
     * For ethl1 and flexphy, the base offset is 64
     */
    if (DNX_ALGO_PORT_TYPE_IS_NIF_ETH_L1(unit, port_info) || DNX_ALGO_PORT_TYPE_IS_FLEXE_PHY(unit, port_info))
    {
        phy_lane += DNX_NANO_SYNC_LANE_FRAMER_BASE;
        swapped_lane += DNX_NANO_SYNC_LANE_FRAMER_BASE;
    }
    else
    {
    ...
    uint32 *enable)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL, "Unkonwn valid lane select %d!\n", valid_sel);
    }
...
static int
dnx_nif_synce_ref_clk_nif_clk_enable_set(
    int unit,
    int core,
    int is_mgu,
    int synce_index,
    ...
    soc_dnxc_init_serdes_ref_clock_t ref_clock_out)
{
    ...
    {
        /*
         * Select the lane in CDU CLU,NBU,MGU
         */
    ...
    {
        SHR_IF_ERR_EXIT(dnx_nif_synce_ref_clk_nif_clk_enable_set(unit, core_id, is_mgu, synce_index, port));
    }
    /*
     * Enable synce
     */
    ...
    if (!dnx_data_synce.general.feature_get(unit, dnx_data_synce_general_synce_in_nanosync))
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_nif_synce_squelch_enable_set(unit, core_id, is_mgu, synce_index, 0));
    }
    ...
    {
        SHR_IF_ERR_EXIT(dnx_nif_synce_squelch_enable_set(unit, core_id, is_mgu, synce_index, 1));
    }
