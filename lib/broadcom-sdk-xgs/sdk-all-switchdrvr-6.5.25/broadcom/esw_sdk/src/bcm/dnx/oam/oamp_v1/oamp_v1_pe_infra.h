...
typedef enum
{
    ...
    DNX_OAMP_PE_FEM_UP_MEP_DM_TOD_OFFSET,
    DNX_OAMP_PE_FEM_DOWN_EGRESS_INJ_VSI,
    DNX_OAMP_PE_FEM_DOWN_EGRESS_INJ_NTWK_QOS,
    /** MUST BE LAST */
...
typedef enum
{
    ...
    DNX_OAMP_PE_INST_LABEL_BFD_VCCV_CHECKSUM,
    DNX_OAMP_PE_INST_LABEL_BFD_VCCV_CHECKSUM_ADDTIONAL,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_2B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_3B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_4B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_END,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1DM_PE_PROF_COMP_BRANCH,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1DM_BRANCH,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1DM_1B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1DM_2B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1DM_3B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_1DM_4B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_MAID48_1B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_MAID48_2B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_MAID48_3B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_MAID48_4B,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_MAID48_END,
    DNX_OAMP_PE_INST_LABEL_UP_MEP_DM_TOD_SKIP_CORE_1,
    DNX_OAMP_PE_INST_LABEL_UP_MEP_DM_TOD_CORE_1,
    DNX_OAMP_PE_INST_LABEL_UP_MEP_DM_TOD_UNTAG,
    DNX_OAMP_PE_INST_LABEL_UP_MEP_DM_TOD_ONE_TAG,
    DNX_OAMP_PE_INST_LABEL_UP_MEP_DM_DMM_OFFSET,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_PE_PROF_COMP_BRANCH,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_BRANCH,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_PE_PROF_COMP_RSP_BRANCH,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_RSP_BRANCH,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_MPLS_COPY,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_UP_COPY,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_MPLS_COPY_RSP,
    DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_UP_COPY_RSP,
    DNX_OAMP_PE_INST_LABEL_JR1_ADD_UDH_SYSTEM_HEADER_HANDLING,
    DNX_OAMP_PE_INST_LABEL_JR1_ADD_UDH_OTSH_EXIST,
    DNX_OAMP_PE_INST_LABEL_JR1_ADD_UDH_MAID48_HANDLING,
    DNX_OAMP_PE_INST_LABEL_BFD_LOCAL_DISCR,
    DNX_OAMP_PE_INST_LABEL_BFD_LOCAL_DISCR_NO_MSB_1,
    DNX_OAMP_PE_INST_LABEL_BFD_LOCAL_DISCR_REST,
    DNX_OAMP_PE_INST_LABEL_BFD_DEFAULT_LOOP_COPY_PDU,
    DNX_OAMP_PE_INST_LABEL_DOWN_MEP_INJ_IVEC_DELETE_ONE_VLAN_TAG,
    DNX_OAMP_PE_INST_LABEL_DOWN_MEP_INJ_IVEC_DELETE_TWO_VLAN_TAGS,
    DNX_OAMP_PE_INST_LABEL_DOWN_MEP_INJ_IVEC_CALCULATION_OVER,
...
typedef enum
{
    ...
    DNX_OAMP_PE_FUNC_DM_JUMBO_TLV_RSP,
    DNX_OAMP_PE_FUNC_SINGLE_HOP_RANDOM_DIP,
    DNX_OAMP_PE_FUNC_VCCV_TYPE_BFD,
    DNX_OAMP_PE_FUNC_ADDITIONAL_GAL_SPECIAL_LABEL,
    DNX_OAMP_PE_FUNC_ADDITIONAL_GAL_SPECIAL_LABEL_MAID48,
    DNX_OAMP_PE_FUNC_UP_MEP_DM_TOD,
    DNX_OAMP_PE_FUNC_LOCAL_DISCR,
    DNX_OAMP_PE_FUNC_VCCV_TYPE_FIXED_DIP_BFD,
    /** MUST BE LAST */
...
{
    /*
     * result type for oamp_mep_db table 
     */
    dbal_result_type_t mep_type[1];
    uint32 type_mask[1];
    /** not used */
