    ...
    bcm_mpls_port_t * mpls_port)
{
    ...
    /** verifications that are made in the flow module, are skipped here if flow_in_use feature is active */
    if (!dnx_data_flow.mpls_port.feature_get(unit, dnx_data_flow_mpls_port_flow_in_use))
    {
