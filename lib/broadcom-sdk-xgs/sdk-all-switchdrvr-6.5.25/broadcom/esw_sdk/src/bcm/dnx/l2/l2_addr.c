            ...
            switch (result_type)
            {
                ...
                case DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_DEST_STAT:
                    *flags = L2_ADDR_FWD_MACT_RESULT_DEST_STAT;
                    break;
                case DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_DOUBLE_OUTLIF:
                    *flags = L2_ADDR_FWD_MACT_RESULT_DOUBLE_OUTLIF;
                    break;
        ...
        case DBAL_TABLE_FWD_MACT_IVL:
            switch (result_type)
            {
                ...
                case DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_DEST_STAT:
                    *flags = L2_ADDR_FWD_MACT_RESULT_DEST_STAT;
                    break;
                case DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_DOUBLE_OUTLIF:
                    *flags = L2_ADDR_FWD_MACT_RESULT_DOUBLE_OUTLIF;
                    break;
    ...
    bcm_l2_addr_t * l2addr)
{
    ...
    if (separate_fwd_lrn_mact)
    {
        ...
        if (!(_SHR_IS_FLAG_SET(l2addr->flags2, BCM_L2_FLAGS2_MESH)))
        {
    ...
    bcm_l2_addr_t * l2addr)
{
    ...
    if ((!age_state_not_updated) && (_SHR_IS_FLAG_SET(l2addr->flags2, BCM_L2_FLAGS2_AGE_GET)))
    {
        ...
        SHR_IF_ERR_EXIT(dbal_entry_attribute_request(unit, entry_handle_id, DBAL_ENTRY_ATTR_AGE, &age_state));
    }

    if (_SHR_IS_FLAG_SET(l2addr->flags2, BCM_L2_FLAGS2_HIT_GET))
    {
        /** Request the hit_bit of the l2 entry */
        SHR_IF_ERR_EXIT(dbal_entry_attribute_request(unit, entry_handle_id, DBAL_ENTRY_ATTR_HIT_GET, &hit_bit));
    }
