...
exit:
  ...
  /**
  * \brief
  * get the header length for the packet header template .
  * \par
  * \param [in] unit  -Relevant unit.
  * \param [in] header_template  - header profile.
  * \param [out] length  -length of the header for this profile.
  * \retval
  *   * Zero if no error was detected
  *   * Negative if error was detected. See \ref
  * shr_error_e
...
/**
* \brief
* allocate pkt header from pkt_header_mem
* \par
* \param [in] unit-  Relevant unit.
* \param [in] nof_dwords-  number of dwords to allocate.
* \param [out] pkt_header_base  - pointed to the start of the allocated mem.
* \retval
*   * Zero if no error was detected
*   * Negative if error was detected. See \ref
*     shr_error_e
...
* \par
* \param [in] unit-  Relevant unit.
* \param [in] nof_dwords-  number of dwords to free.
* \param [in] pkt_header_base  - pointed to the start of the allocated mem to be freed.
* \retval
*   * Zero if no error was detected
*   * Negative if error was detected. See \ref
*     shr_error_e
