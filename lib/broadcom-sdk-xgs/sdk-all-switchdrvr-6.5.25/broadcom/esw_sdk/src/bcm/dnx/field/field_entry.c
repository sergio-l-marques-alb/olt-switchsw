...
*/
static shr_error_e
dnx_field_entry_kbp_add_verify(
    int unit,
    uint32 flags,
    dnx_field_group_t fg_id,
    dnx_field_entry_t * entry_info_p,
    uint32 *entry_handle_p)
{
    ...
    if (flags & DNX_FIELD_ENTRY_GROUP_ADD_FLAG_WITH_ID)
    {
         ...
         * Create clean entry
         */
        clean_entry_handle = DNX_FIELD_ENTRY_TCAM_EXTERNAL(access_id);
        /*
         * Compare given handle to the clean one
         */
        if (clean_entry_handle != *entry_handle_p)
    ...
    uint32 *entry_handle_p)
{
    ...
    /** Verify the input.*/
    SHR_INVOKE_VERIFY_DNXC(dnx_field_entry_kbp_add_verify(unit, 0, fg_id, entry_info_p, entry_handle_p));
    ...
    dnx_field_entry_t * entry_info_p)
{
     ...
     */
    SHR_IF_ERR_EXIT(dnx_field_entry_quals_actions_type_get(unit, fg_id, entry_info_p));
    SHR_IF_ERR_EXIT(dnx_field_entry_kbp_hw_get
