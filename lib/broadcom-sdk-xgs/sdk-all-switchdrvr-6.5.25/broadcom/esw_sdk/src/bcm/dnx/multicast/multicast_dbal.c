 ...
 */
shr_error_e
dnx_multicast_entry_prev_ptr_get(
    int unit,
    uint32 entry_id,
    uint32 *prev_entry_id)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_MCDB_LINK_LIST_PTR, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MCDB_INDEX, entry_id);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_PREV_PTR, INST_SINGLE, prev_entry_id);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
shr_error_e
dnx_multicast_sar_group_channel_set(
    int unit,
    bcm_core_t core_id,
    bcm_multicast_t group,
    uint32 channel_id)
 ...
 */
shr_error_e
dnx_multicast_sar_group_channel_get(
    int unit,
    bcm_core_t core_id,
    bcm_multicast_t group,
    uint32 *channel_id)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core_id);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_GROUP_ID, group);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_SAR_CHANNEL, INST_SINGLE, channel_id);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
