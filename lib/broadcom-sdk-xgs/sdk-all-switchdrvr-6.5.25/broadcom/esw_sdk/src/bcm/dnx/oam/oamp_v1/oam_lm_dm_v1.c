...
typedef struct _dnx_oam_loss_delay_oamp_hw_write_data_s
{
    ...
    /*
     * Dual-ended DM indication (always one-way)
     */
    uint8 is_1dm;
    /*
    ...
    /*
     * indicate one-way DM for both dual-ended and single-ended
     */
    uint8 is_1way_dm;
    ...
    uint32 entry_idx)
{
    ...
    if (update)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_get(unit, mep_db_idx, &mep_db_entry));
    ...
    uint32 *tx_rate_profile)
{
    ...
    dnx_bfd_oamp_v1_temp_mep_db_data_t *mep_hw_write_data = NULL;
    uint8 write_hw = FALSE, tx_rate_write_delete = FALSE;
    uint32 old_tx_profile;
    SHR_FUNC_INIT_VARS(unit);

    SHR_ALLOC_SET_ZERO(mep_hw_write_data, sizeof(dnx_bfd_oamp_v1_temp_mep_db_data_t),
    ...
    {
        tx_rate_data.tx_period = BCM_OAMP_SW_ENTRY_INFO_PERIOD_TO_MEP_DB_SCAN_RATE(unit, period);
    }
    ...
    if (is_update)
    {
        ...
        SHR_IF_ERR_EXIT(algo_bfd_db.
                        bfd_oamp_v1_tx_rate.profile_data_get(unit, old_tx_profile, &dummy, &tx_rate_data_old));
        ...
        if (tx_rate_data.tx_period != tx_rate_data_old.tx_period)
        {
            ...
            SHR_IF_ERR_EXIT(algo_bfd_db.bfd_oamp_v1_tx_rate.free_single(unit, old_tx_profile, &tx_rate_write_delete));
    ...
    uint16 extra_data_index)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_v1_ccm_endpoint_extra_data_get(unit, &extra_data));
    ...
    int *priority)
{
    ...
    if (dnx_data_oam.feature.feature_get(unit, dnx_data_oam_feature_slr_scan_mashine_support)
        && is_mesure_next_slr_enabled)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "Measurement next SLR timer is not supported on this device. Supported value is 0.\n");

    }

    if ((ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_Q_ENTRY) && is_mesure_next_slr_enabled)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
    ...
    dnx_oam_loss_delay_oamp_hw_write_data_t * hw_write_data)
{
    ...
    if (loss_ptr->measurement_period == 0
        || !(dnx_data_oam.feature.feature_get(unit, dnx_data_oam_feature_slr_scan_mashine_support)))
    {
    ...
    else
    {
        ...
        slm_measurement_hw_number_of_scans =
            BCM_OAMP_SW_ENTRY_INFO_PERIOD_TO_MEP_DB_SCAN_RATE(unit, loss_ptr->measurement_period);
    }
    ...
    rv = algo_oam_db.slm_oamp_measurement_period.allocate_single
        (unit, 0, (int *) &slm_measurement_hw_number_of_scans, NULL, &measurement_profile_index, &write_hw);
    if (rv == _SHR_E_RESOURCE)
    {
        /** Resource error means no match - display error message */
    ...
    uint8 is_egress_inj)
{
    ...
    mep_profile_data->lmm_offset =
        dnx_oam_oamp_v1_lm_dm_set_offset(unit, ccm_mep_db_entry, mep_profile_data->piggy_back_lm, 0 /** LM type */ ,
                                         0 /** LMM */ ,
    ...
    if (ccm_mep_db_entry->mep_type != DBAL_ENUM_FVAL_OAMP_MEP_TYPE_RFC_6374)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc(unit, loss_ptr->id, is_jumbo_tlv_config, (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_Q_ENTRY), ccm_mep_db_entry->ccm_interval, 0  /** don't
                                                                                                                                                                                             * care
                                                                                                                                                                                             * for
                                                                                                                                                                                             * opcodes
                                                                                                                                                                                             * other
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc_rfc_6374_lm_dm
                        (unit, loss_ptr->id, loss_ptr->period, OAMP_MEP_TX_OPCODE_LMM, mep_profile_data));
    ...
    uint8 is_egress_inj)
{
    ...
    if (ccm_mep_db_entry->mep_type != DBAL_ENUM_FVAL_OAMP_MEP_TYPE_RFC_6374)
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc(unit, is_jumbo_tlv_dm ? endpoint_id : 0 /* dont care for * *
                                                                                                 * opcodes other than *
                                                                                                 * * * CCM */ ,
    ...
    {
        SHR_IF_ERR_EXIT(algo_bfd_db.bfd_oamp_v1_tx_rate.profile_data_get(unit, mep_profile_data->lmm_rate, &dummy,
                                                                         &tx_rate_data));
        /** Check if there is no BFD endpoint */
        SHR_IF_ERR_EXIT(dnx_oam_mpls_lm_dm_without_bfd_endpoint
                        (unit, endpoint_id, &is_mpls_lm_dm_without_bfd_endpoint));
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc_rfc_6374_lm_dm(unit, endpoint_id, 0 /** free the pase */ ,
                                                                       OAMP_MEP_TX_OPCODE_LMM, mep_profile_data));
    }
exit:
    SHR_FUNC_EXIT;
    ...
    uint32 lm_stat_entry_idx)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, entry[entry_id]));
    }
    ...
    uint32 lm_stat_entry_idx)
{
    ...
    else        /* Self contained */
    {
        ...
        else
        {
            ...
            if (!(loss_ptr->flags & BCM_OAM_LOSS_STATISTICS_EXTENDED) && lm_stat_exists)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, entry[0]));
            }
        }
    }
    ...
    for (entry_id = 0; entry_id < num_entries; entry_id++)
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_alloc(unit,
    ...
    const dnx_oam_loss_delay_oamp_hw_write_data_t * hw_write_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_lm_endpoint_set(unit, hw_write_data->ccm_oam_id, &lm_mep_db_write_data));
    ...
    const uint8 entry_exists)
{
    ...
    dbal_enum_value_field_ccm_interval_e tmp_ccm_interval;
    SHR_FUNC_INIT_VARS(unit);
    ...
    else
    {
        if (*ccm_mep_id != 0)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_oamp_v1_local_accelerated_endpoint_fill_id(unit, endpoint_info, NULL, 0));
    ...
    if (mep_profile_data->piggy_back_lm)
    {
        tmp_ccm_interval = ccm_mep_db_entry->ccm_interval;
        ccm_mep_db_entry->ccm_interval = DBAL_ENUM_FVAL_CCM_INTERVAL_NO_TX;
        ccm_mep_db_entry->flags |= DNX_OAMP_OAM_CCM_MEP_UPDATE;
        SHR_IF_ERR_EXIT(dnx_oamp_mep_db_ccm_endpoint_set(unit, mep_id, ccm_mep_db_entry));
        ccm_mep_db_entry->flags &= ~DNX_OAMP_OAM_CCM_MEP_UPDATE;
        ccm_mep_db_entry->ccm_interval = tmp_ccm_interval;
        ...
        sw_endpoint_info.duplicated_mep_id = *ccm_mep_id;
        SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_set(unit, mep_id, &sw_endpoint_info, TRUE));
        SHR_IF_ERR_EXIT(dnx_oam_sw_db_lmep_to_rmep_traverse_list
                        (unit, mep_id, dnx_oam_lmep_rmep_index_db_add_traverse_callback));
    }
    else
    {
        ccm_mep_db_entry->ccm_interval = DBAL_ENUM_FVAL_CCM_INTERVAL_NO_TX;
    ...
    if (!entry_exists)
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_rfc_6374_endpoint_set(unit, *ccm_mep_id, ccm_mep_db_entry, TRUE, FALSE));
        }
    ...
    bcm_oam_loss_t * loss_ptr)
{
    ...
    uint8 dm_exists = 0, lm_exists = 0, lm_stat_exists = 0, flexibe_da_enabled = 0, temp_dm_exists =
        0, rfc_6374_exists = 0;
    uint8 lm_dm_exists = 0, is_egress_injection = FALSE;
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_get(unit, mep_id, &sw_endpoint_info));
    is_egress_injection =
        _SHR_IS_FLAG_SET(sw_endpoint_info.sw_state_flags,
                         DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DOWN_EGRESS_INJECTION);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get(unit, loss_ptr->id, is_egress_injection, ccm_mep_db_entry));
    mpls_pwe_mep = DNX_OAM_MEP_TYPE_IS_MPLS_TP_OR_PWE(ccm_mep_db_entry->mep_type);
    offloaded = (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_LM_DM_OFFLOADED) ? 1 : 0;
     ...
     */
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_dm_endpoint_get(unit, loss_ptr->id, dm_mep_db_entry, &dm_exists));
    ...
    if ((loss_ptr->pkt_pri_bitmap != 0xff) && (loss_ptr->pkt_pri_bitmap != 0))
    {
        ...
        if (lm_dm_exists)
        {
            SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_dm_endpoint_get(unit, loss_ptr_id, dm_mep_db_entry, &dm_exists));
    ...
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_msb_profile_set(unit,
    ...
    */
    ...
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_lsb_profile_set(unit,
    ...
    bcm_oam_loss_t * loss_ptr)
{
    ...
    uint8 mpls_pwe_mep = 0, is_egress_injection = FALSE;
    int counter = 0;
    int dummy = 0;
    dnx_bfd_tx_period_t tx_rate_data;
    SHR_FUNC_INIT_VARS(unit);
        ...
        && !DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
    {
        ...
        DNX_OAM_GET_PRIORITY_FROM_BITMAP(loss_ptr->pkt_pri_bitmap, priority)
            SHR_IF_ERR_EXIT(dnx_oamp_v1_lm_with_priority_session_map_get
                            (unit, loss_ptr->id, priority, &session_oam_id));

        loss_ptr->id = session_oam_id;
        loss_ptr->pm_id = session_oam_id;
    }
     ...
     */
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_lm_endpoint_get(unit, loss_ptr->id, loss_params, &lm_exists, &lm_stat_exists));
    if (!lm_exists)
    {
        SHR_ERR_EXIT(_SHR_E_NOT_FOUND, "Error: Loss is not enabled on this endpoint.\n");
    }
    ...
    if (curr_mep_profile_data->slm_lm)
    {
        ...
        {
            loss_ptr->measurement_period =
                BCM_OAMP_MEP_DB_SCAN_RATE_TO_SW_ENTRY_PERIOD(unit, loss_ptr->measurement_period);
        }
    ...
    if (DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
    {
        SHR_IF_ERR_EXIT(algo_bfd_db.bfd_oamp_v1_tx_rate.profile_data_get(unit, curr_mep_profile_data->lmm_rate, &dummy,
                                                                         &tx_rate_data));
        tx_rate_data.tx_period ? loss_ptr->period =
            BCM_OAMP_MEP_DB_SCAN_RATE_TO_SW_ENTRY_PERIOD(unit, tx_rate_data.tx_period) : 0;
    }
    else
    {
...
{
    dnx_oam_endpoint_info_t sw_endpoint_info;
    dnx_oam_oamp_ccm_endpoint_t *ccm_mep_db_entry_o = NULL;
    dnx_oam_oamp_ccm_endpoint_t *ccm_mep_db_entry = NULL;
    dnx_oam_oamp_endpoint_lm_params_t *loss_params = NULL;
    dnx_oam_oamp_endpoint_dm_params_t *dm_mep_db_entry = NULL;
    dnx_oam_mep_profile_t *curr_mep_profile_data = NULL;
    ...
    uint8 piggy_back_lm = 0;
    int priority = 0;
    uint8 is_last_entry = FALSE, is_egress_injection = FALSE;
    int lmm_rate = 0;
    ...
    SHR_ALLOC_SET_ZERO(hw_write_info, sizeof(dnx_oam_loss_delay_oamp_hw_write_data_t),
                       "Structure for HW WRITE Info", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC_SET_ZERO(ccm_mep_db_entry_o, sizeof(dnx_oam_oamp_ccm_endpoint_t),
                       "Structure for original CCM MEP DB entry", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC_SET_ZERO(ccm_mep_db_entry, sizeof(dnx_oam_oamp_ccm_endpoint_t),
                       "Structure for CCM MEP DB entry", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC_SET_ZERO(dm_mep_db_entry, sizeof(dnx_oam_oamp_endpoint_dm_params_t),
                       "Structure for DM MEP DB entry", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    /** Keep lmm_rate before clear loss params */
    lmm_rate = curr_mep_profile_data->lmm_rate;
    ...
    else
    {
        ...
        if (!dm_exists)
        {
            ...
            if (last_reference)
            {
                SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_profile_clear(unit, ccm_mep_db_entry->mep_profile));
            }
        }
        else
        {
        ...
        if (mpls_pwe_mep)
        {
            if (!dm_exists)
            {
                ...
                {
                /** Set profile parameters */
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mpls_pwe_exp_ttl_profile_clear(unit, push_profile));
                }
            }
     ...
     */
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_lm_endpoint_clear
    ...
    if (DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
    {
        ...
        if (tx_rate_write_delete)
        {
            SHR_IF_ERR_EXIT(dnx_oam_oamp_lm_dm_tx_rate_clear(unit, lmm_rate));
        }
    }
    else
    {
    ...
    if ((loss_ptr->pkt_pri_bitmap != 0xff) && (loss_ptr->pkt_pri_bitmap != 0))
    {
        if (piggy_back_lm)
        {
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get
                            (unit, mep_id, is_egress_injection, ccm_mep_db_entry_o));
            ccm_mep_db_entry_o->ccm_interval = ccm_mep_db_entry->ccm_interval;
            ccm_mep_db_entry_o->flags |= DNX_OAMP_OAM_CCM_MEP_UPDATE;
            SHR_IF_ERR_EXIT(dnx_oamp_mep_db_ccm_endpoint_set(unit, mep_id, ccm_mep_db_entry_o));
            sw_endpoint_info.duplicated_mep_id = loss_ptr->id;
            SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_set(unit, mep_id, &sw_endpoint_info, TRUE));
            SHR_IF_ERR_EXIT(dnx_oam_sw_db_lmep_to_rmep_traverse_list
                            (unit, mep_id, dnx_oam_lmep_rmep_index_db_remove_traverse_callback));
        }
        if (!dm_exists)
        {
            SHR_IF_ERR_EXIT(dnx_oamp_mep_db_ccm_endpoint_clear(unit, loss_ptr->id, extra_data_entries_on_mdb));

            SHR_IF_ERR_EXIT(dnx_oamp_v1_lm_with_priority_session_map_clear(unit, mep_id, priority));

            SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, loss_ptr->id));
    ...
    uint8 *priority)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Delay measurement is not supported when timeSync PLL is disabled.");
    }
     ...
     */
    correct_flags |=
        BCM_OAM_DELAY_ONE_WAY_STATS | BCM_OAM_DELAY_ONE_WAY | BCM_OAM_DELAY_UPDATE | BCM_OAM_DELAY_WITH_ID |
        BCM_OAM_DELAY_REPORT_MODE;
    ...
    if ((ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_LM_DM_OFFLOADED) &&
        ((delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY) || (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY_STATS)))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Error: one-way DM is not supported on OFFLOADED endpoints\n");
    }
    ...
    if ((delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY) && (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY_STATS))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "1DM can't support with single-ended one-way DM");
    }
    ...
    uint8 is_rfc_6374_lsp_type)
{
    ...
    mep_profile_data->dm_measurement_type =
        (((delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY)
          || (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY_STATS)) ?
    ...
    if (ccm_mep_db_entry->mep_type != DBAL_ENUM_FVAL_OAMP_MEP_TYPE_RFC_6374)
    {
        ...
        /** dont care for opcodes other than CCM */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc
                        (unit, delay_ptr->id, is_jumbo_tlv_dm, (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_Q_ENTRY),
                         ccm_mep_db_entry->ccm_interval, 0, OAMP_MEP_TX_OPCODE_DMM, mep_profile_data));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_lmm_dmm_rate_to_rfc6374_rate
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc_rfc_6374_lm_dm
                        (unit, delay_ptr->id, delay_ptr->period, OAMP_MEP_TX_OPCODE_DMM, mep_profile_data));
/* } */
    }
exit:
    SHR_FUNC_EXIT;
    ...
    dnx_oam_mep_profile_t * mep_profile_data)
{
    ...
    {
        /** dont care for opcodes other than CCM */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc(unit, is_jumbo_tlv_dm ? endpoint_id : 0,
                                                        is_jumbo_tlv_dm,
                                                        (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_Q_ENTRY),
                                                        ccm_mep_db_entry->ccm_interval, 0, OAMP_MEP_TX_OPCODE_DMM,
                                                        mep_profile_data));
    }
    else
    {
        SHR_IF_ERR_EXIT(algo_bfd_db.bfd_oamp_v1_tx_rate.profile_data_get(unit, mep_profile_data->dmm_rate, &dummy,
                                                                         &tx_rate_data));
        /** Check if there is no BFD endpoint */
        SHR_IF_ERR_EXIT(dnx_oam_mpls_lm_dm_without_bfd_endpoint
                        (unit, endpoint_id, &is_mpls_lm_dm_without_bfd_endpoint));
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc_rfc_6374_lm_dm(unit, endpoint_id, 0 /** free the phase */ ,
    ...
    dnx_oam_loss_delay_oamp_hw_write_data_t * hw_write_data)
{
    ...
    hw_write_data->is_1way_dm = (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY_STATS) ? 1 :
        (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY) ? 1 : 0;
    if (dnx_data_oam.feature.feature_get(unit, dnx_data_oam_feature_up_mep_tod_recycle_enable))
    {
        ...
        /** 0 maybe a valid port, but can't be recycle port for up mep*/
    ...
    else if ((ccm_mep_db_entry->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM)
             && (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_IS_UPMEP) && is_valid_recyle_port)
    {
        if (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_48B_MAID)
        {
            SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                            (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_UP_MEP_DM_TOD_CCM_MAID_48, &mep_pe_profile_dm));
        }
        else
        {
            SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                            (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_UP_MEP_DM_TOD, &mep_pe_profile_dm));
        }
        hw_write_data->mep_pe_profile = (uint8) mep_pe_profile_dm;
    }
    else
    ...
    const dnx_oam_loss_delay_oamp_hw_write_data_t * hw_write_data)
{
    ...
    dm_mep_db_write_data.flags |=
        hw_write_data->is_1way_dm ? DNX_OAMP_OAM_DM_MEP_MEASURE_ONE_WAY : DNX_OAMP_OAM_DM_MEP_MEASURE_TWO_WAY;
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_dm_endpoint_set(unit, hw_write_data->ccm_oam_id, &dm_mep_db_write_data));
    ...
    bcm_oam_delay_t * delay_ptr)
{
    ...
    uint32 oam_id = delay_ptr->id;
    uint32 pm_id = delay_ptr->pm_id;
    int priority_index;
    ...
    {
    0};
    uint8 old_oamp_da_lsb_prof = 0, is_egress_injection = FALSE;
    uint8 offloaded = 0, dm_exists = 0, rfc_6374_exists = 0;
    uint32 mep_pe_profile = 0, mep_pe_profile_maid_48 = 0;
    uint32 mep_pe_profile_dm_tod = 0;
    uint32 mep_pe_profile_dm_tod_maid_48 = 0;
    ...
    is_egress_injection =
        _SHR_IS_FLAG_SET(sw_endpoint_info.sw_state_flags,
                         DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DOWN_EGRESS_INJECTION);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get
                    (unit, delay_ptr->id, is_egress_injection, ccm_mep_db_entry));
    if ((ccm_mep_db_entry->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM)
        && (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_IS_UPMEP)
        && (dnx_data_oam.feature.feature_get(unit, dnx_data_oam_feature_up_mep_tod_recycle_enable)))
    {
        if (!dnx_data_oam.oamp.up_mep_tod_recycle_port_core_0_get(unit)
            || !dnx_data_oam.oamp.up_mep_tod_recycle_port_core_1_get(unit))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "Error: please enable soc up_mep_tod_recycle_port for up mep DM tod.\n");
        }
        if ((delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY)
            || (delay_ptr->tlvs[0].tlv_type == bcmOamTlvTypeData) || (flexibe_da_enabled))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "Error: Up MEP DM tod don't support 1DM, Jumbo DM, flexible_da(DM).\n");
        }
    }
    ...
    if (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY)
    {
        if (update)
        {
            ...
            if (DNX_OAM_DISSECT_IS_ENDPOINT_UPMEP(&endpoint_info)
                && (ccm_mep_db_entry->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM)
                && (dnx_data_oam.feature.feature_get(unit, dnx_data_oam_feature_up_mep_tod_recycle_enable)))
            {
                SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                                (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_UP_MEP_DM_TOD_CCM_MAID_48,
                                 &mep_pe_profile_dm_tod_maid_48));
                SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                                (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_UP_MEP_DM_TOD, &mep_pe_profile_dm_tod));
            }
        }
        else
        {
    ...
    if ((delay_ptr->pkt_pri_bitmap != 0xff) && (delay_ptr->pkt_pri_bitmap != 0))
    {
        ...
        if (lm_db_exists)
        {
            ...
            else
            {
                ...
                SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_dm_endpoint_get(unit, delay_ptr->id, dm_mep_db_entry, &dm_exists));
                ccm_mep_db_entry->mep_profile = dm_mep_db_entry->mep_profile;
            }
        }
    }
    ...
    if (delay_ptr->tlvs[0].tlv_type == bcmOamTlvTypeData)
    {
        ...
        sw_endpoint_info.sw_state_flags |= DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_JUMBO_DM_TLV;
        SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_set(unit, oam_id, &sw_endpoint_info, TRUE));

    }

    /*
     * Set software information flag for dual-ended 1DM on the MEP
     */
    if (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY)
    {
        sw_endpoint_info.sw_state_flags |= DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY;
        SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_set(unit, oam_id, &sw_endpoint_info, TRUE));
    }

    /*
     * Set software information flag for single-ended one-way DM on the MEP
     */
    if (delay_ptr->flags & BCM_OAM_DELAY_ONE_WAY_STATS)
    {
        sw_endpoint_info.sw_state_flags |= DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY_STATS;
        SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_set(unit, oam_id, &sw_endpoint_info, TRUE));
    }
    ...
    /*
     * Restore the value of id and pm_id which is modified during delay adding process
     */
    delay_ptr->id = oam_id;
    delay_ptr->pm_id = pm_id;
    ...
    if (hw_write_info->flags & DNX_OAM_LM_DM_OAMP_MEP_PROFILE)
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_profile_set(unit, hw_write_info->oamp_mep_profile,
                                                        DNX_OAM_IS_ENDPOINT_RFC6374(&endpoint_info),
                                                        &(hw_write_info->mep_profile_data)));
    }
    ...
    bcm_oam_delay_t * delay_ptr)
{
    ...
    if ((delay_ptr->pkt_pri_bitmap != 0xff) && (delay_ptr->pkt_pri_bitmap != 0))
    {
        DNX_OAM_GET_PRIORITY_FROM_BITMAP(delay_ptr->pkt_pri_bitmap, priority)
            SHR_IF_ERR_EXIT(dnx_oamp_v1_lm_with_priority_session_map_get
                            (unit, delay_ptr->id, priority, &session_oam_id));

        delay_ptr->id = session_oam_id;
        delay_ptr->pm_id = session_oam_id;
    }
     ...
     */
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_dm_endpoint_get(unit, delay_ptr->id, delay_params, &dm_exists));
    ...
    if (DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
    {
        SHR_IF_ERR_EXIT(algo_bfd_db.bfd_oamp_v1_tx_rate.profile_data_get(unit, curr_mep_profile_data->dmm_rate, &dummy,
                                                                         &tx_rate_data));
    ...
    if (!curr_mep_profile_data->report_mode_dm)
    {
        if (delay_params->flags & DNX_OAMP_OAM_DM_MEP_MEASURE_ONE_WAY)
        {
            /*
             * Dual-ended 1DM
             * MPLS DM is single-ended DM, however which is using flag BCM_OAM_DELAY_ONE_WAY
             * So MPLS DM is filtered from this branch
             */
                ...
                !DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
            {
                delay_ptr->delay.nanoseconds =
                    (delay_params->
                     last_delay_one_way_near_end[0]) | (delay_params->last_delay_one_way_near_end[1] << 8) |
                    (delay_params->last_delay_one_way_near_end[2] << 16) |
                    ((delay_params->last_delay_one_way_near_end[3] & 0x3) << 24);
                COMPILER_64_SET(delay_ptr->delay.seconds, 0,
            ...
            else
            {
                ...
                delay_ptr->delay_max.nanoseconds =
                    (delay_params->max_delay_one_way[0]) | (delay_params->max_delay_one_way[1] << 8) |
                    (delay_params->max_delay_one_way[2] << 16) | ((delay_params->max_delay_one_way[3] & 0x3) << 24);
                COMPILER_64_SET(delay_ptr->delay_max.seconds, 0, ((delay_params->max_delay_one_way[3] & 0x1C) >> 2));

                delay_ptr->delay_min.nanoseconds =
                    (delay_params->min_delay_one_way[0]) | (delay_params->min_delay_one_way[1] << 8) |
                    (delay_params->min_delay_one_way[2] << 16) | ((delay_params->min_delay_one_way[3] & 0x3) << 24);
    ...
    if (sw_endpoint_info.sw_state_flags & DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY_STATS)
    {
        delay_ptr->flags |= BCM_OAM_DELAY_ONE_WAY_STATS;
    }
    delay_ptr->id = oam_id;
    ...
    uint8 extra_data_entries_on_mdb)
{
    ...
    uint8 is_1dm = 0, is_last_entry = 0, tx_rate_write_delete = 0, is_egress_injection = FALSE;
    int dmm_rate = 0;
    ...
    /** Keep dmm_rate before clear by delay params */
    dmm_rate = curr_mep_profile_data->dmm_rate;
     ...
     */
    SHR_IF_ERR_EXIT(dnx_oamp_v1_mep_db_dm_endpoint_clear
    ...
    if (DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
    {
        ...
        if (tx_rate_write_delete)
        {
            SHR_IF_ERR_EXIT(dnx_oam_oamp_lm_dm_tx_rate_clear(unit, dmm_rate));
        }
    }
    ...
    /*
     * clear dual-ended 1DM flag
     */
    if ((sw_endpoint_info.sw_state_flags & DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY))
    {
        sw_endpoint_info.sw_state_flags &= (~DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY);
        SHR_IF_ERR_EXIT(dnx_oam_sw_state_endpoint_info_set(unit, (uint32) mep_id, &sw_endpoint_info, TRUE));
    }

    /*
     * clear single-ended one-way DM flag
     */
    if ((sw_endpoint_info.sw_state_flags & DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY_STATS))
    {
        sw_endpoint_info.sw_state_flags &= (~DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DELAY_ONE_WAY_STATS);
    ...
    if ((delay_ptr->pkt_pri_bitmap != 0xff) && (delay_ptr->pkt_pri_bitmap != 0))
    {
        if (!lm_db_exists)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, delay_ptr->id));
            ...
            if (DNX_OAM_IS_ENDPOINT_RFC6374(&sw_endpoint_info))
            {
                ...
                SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc
        ...
        else
        {
             ...
             * in case dual-ended 1DM delay was deleted
             */
            if (is_1dm)
            {
                SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
...
/*
 * See prototype definition in oam_oamp_v1.h for function description
 */
shr_error_e
dnx_oam_oamp_is_piggyback_lm_get(
    int unit,
    uint32 endpoint_id,
    uint32 *is_piggyback_lm)
{
    dnx_oam_endpoint_info_t sw_endpoint_info;
    dnx_oam_oamp_ccm_endpoint_t ccm_mep_db_entry;
    dnx_oam_mep_profile_t curr_mep_profile_data;
    uint8 is_egress_injection = FALSE;
    int counter = 0;
    ...
    sal_memset(&sw_endpoint_info, 0, sizeof(dnx_oam_endpoint_info_t));
    sal_memset(&ccm_mep_db_entry, 0, sizeof(dnx_oam_oamp_ccm_endpoint_t));
    sal_memset(&curr_mep_profile_data, 0, sizeof(dnx_oam_mep_profile_t));
    ...
    is_egress_injection =
        _SHR_IS_FLAG_SET(sw_endpoint_info.sw_state_flags,
                         DBAL_DEFINE_OAM_ENDPOINT_SW_STATE_FLAGS_DOWN_EGRESS_INJECTION);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get(unit, endpoint_id, is_egress_injection, &ccm_mep_db_entry));
    ...
    *is_piggyback_lm = curr_mep_profile_data.piggy_back_lm;
