    ...
    else
    {
        SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_iter)
        {
            ...
            else
            {
                ...
                /**
                 * Save the temperature is sw_state, so only the hbm temp monitor will use cpu2tap access.
                 * Reading the temperature through the API or Diag will result in reading the last value that
                 * was written into the sw state by the HBM temperature monitor.
                 */
    ...
    void *user_data)
{
    ...
    /*
     * Get current temperature of HBMs and log it
     */
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_iter)
    {
        ...
        /** Get minimum and maximum temperature across all HBMs */
