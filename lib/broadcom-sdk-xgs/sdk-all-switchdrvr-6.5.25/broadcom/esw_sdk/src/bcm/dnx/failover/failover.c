 ...
 * \param [in] flags -
 *                  Supported flags:
 *                  BCM_FAILOVER_FEC - Allocate protection pointer for FEC protection
 *                  Note: This is a shared resource with the extended ECMP that can partly or fully occupy it.
    ...
    bcm_failover_t failover_id)
{
    ...
    if (failover_type == BCM_FAILOVER_TYPE_FEC)
    {
        ...
        else
        {
            ...
            if (nof_elements == 0)
            {
                SHR_IF_ERR_EXIT(dnx_failover_fec_hierarchy_set(unit, protection_ptr, DBAL_ENUM_FVAL_HIERARCHY_LEVEL_HIERARCHY_LEVEL_1   /* default 
                                                                                                                                         * value 
                                                                                                                                         */ ));
            }
        }
