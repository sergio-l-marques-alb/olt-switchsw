    ...
    uint32 tdm_exist)
{
     ...
     */
    if (dnx_data_egr_queuing.params.feature_get(unit, dnx_data_egr_queuing_params_unicast_fifo_depth_not_supported))
    {
        SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, DBAL_TABLE_EGQ_MULTICAST_FIFOS, 1, 11,
                                         ...
                                         (uint32) (dnx_data_egr_queuing.
                                                   params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_MC_HIGH,
                                                                       tdm_exist)->full), GEN_DBAL_FIELD32,
                                         DBAL_FIELD_MC_LOW_FIFO_FULL, INST_SINGLE,
                                         (uint32) (dnx_data_egr_queuing.
                                         ...
                                         (uint32) (dnx_data_egr_queuing.params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_TDM,
                                                                                            tdm_exist)->almost_full),
                                         GEN_DBAL_FIELD32, DBAL_FIELD_UNICAST_FIFO_DISCARD_TH, INST_SINGLE,
                                         (uint32) (dnx_data_egr_queuing.params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_UC,
                                                                                            tdm_exist)->almost_full),
                                         ...
                                         (uint32) (dnx_data_egr_queuing.
                                                   params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_MC_HIGH,
                                                                       tdm_exist)->depth), GEN_DBAL_FIELD32,
                                         DBAL_FIELD_MC_LOW_FIFO_DEPTH, INST_SINGLE,
                                         (uint32) (dnx_data_egr_queuing.
                                                   params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_MC_LOW,
                                                                       tdm_exist)->depth), GEN_DBAL_FIELD_LAST_MARK));
    }
    else
    {
    ...
    int qpair)
{
    ...
    SHR_IF_ERR_EXIT
        (dnx_dbal_gen_set(unit, DBAL_TABLE_FC_RX_CPU_MAP,
                          ...
                          GEN_DBAL_FIELD32, DBAL_FIELD_CORE_ID, core,
                          GEN_DBAL_FIELD32, DBAL_FIELD_EGR_QUEUE, INST_SINGLE, qpair, GEN_DBAL_FIELD_LAST_MARK));
exit:
    SHR_FUNC_EXIT;
}
...
{
    SHR_FUNC_INIT_VARS(unit);
    if (dnx_data_egr_queuing.params.feature_get(unit, dnx_data_egr_queuing_params_cos_map_per_pp_or_tm_selector) == 1)
    {
        SHR_IF_ERR_EXIT(dnx_dbal_gen_get(unit, DBAL_TABLE_EGRESS_PP_PORT, 2, 2,
        /** 2 keys */
                                         GEN_DBAL_FIELD32, DBAL_FIELD_PP_PORT, (uint32) (internal_port),
                                         GEN_DBAL_FIELD32, DBAL_FIELD_CORE_ID, (uint32) core_id,
        /** 2 fields */
                                         GEN_DBAL_FIELD32, DBAL_FIELD_COS_MAP_PROFILE, INST_SINGLE,
                                         (&(egq_ppct_tbl_data->cos_map_profile)),
                                         GEN_DBAL_FIELD32, DBAL_FIELD_COS_MAP_PROFILE_VALID, INST_SINGLE,
                                         (&(egq_ppct_tbl_data->cos_map_profile_valid)), GEN_DBAL_FIELD_LAST_MARK));
    }
    else
    {
    ...
    dnx_egq_ppct_tbl_data_t * egq_ppct_tbl_data)
{
    ...
    if (dnx_data_egr_queuing.params.feature_get(unit, dnx_data_egr_queuing_params_cos_map_per_pp_or_tm_selector) == 1)
    {
        SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, DBAL_TABLE_EGRESS_PP_PORT, 2, 2,
        /** 2 keys */
                                         GEN_DBAL_FIELD32, DBAL_FIELD_PP_PORT, (uint32) (internal_port),
                                         GEN_DBAL_FIELD32, DBAL_FIELD_CORE_ID, (uint32) core_id,
        /** 2 fields */
    ...
    dnx_fqp_profile_params_t * profile_params)
{
    ...
    if (dnx_data_egr_queuing.params.feature_get(unit, dnx_data_egr_queuing_params_if_attributes_profile_exist) == 1)
    {
        ...
        if (dnx_data_egr_queuing.params.feature_get(unit, dnx_data_egr_queuing_params_fqp_enhanced_attribuites) == 1)
        {
            dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TXQ_MAX_BYTES_TH, INST_SINGLE,
                                         profile_params->txq_max_bytes);
            dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MIN_GAP, INST_SINGLE,
                                         profile_params->min_gap);
