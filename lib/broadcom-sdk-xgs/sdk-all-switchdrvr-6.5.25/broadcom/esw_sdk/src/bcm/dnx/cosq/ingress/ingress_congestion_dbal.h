...
typedef struct
{
    ...
    uint32 min_thresh;
    uint32 max_thresh;
    uint32 c1;                  /* this value is c11 for high precision */
    uint32 c12;
    uint32 c13;
    uint32 c2;
    uint32 c3;
    int ignore_packet_size;
    int continuous_probability;
...
/**
 * \brief - clear WRED to HW
 *
 */
shr_error_e dnx_ingress_congestion_dbal_wred_hw_clear(
    int unit,
    dbal_tables_e table_id,
    dnx_ingress_congestion_dbal_wred_key_t * key);
