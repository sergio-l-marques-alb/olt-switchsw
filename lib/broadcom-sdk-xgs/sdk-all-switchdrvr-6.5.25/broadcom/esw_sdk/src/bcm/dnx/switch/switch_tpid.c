    ...
    bcm_switch_tpid_info_t * tpid_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_switch_tpid_add_verify(unit, options, tpid_info));
    ...
    bcm_switch_tpid_info_t * tpid_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_switch_tpid_delete_verify(unit, tpid_info));
    ...
    int unit)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_switch_tpid_delete_all_verify(unit));
    ...
    int *count)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_switch_tpid_get_all_verify(unit, size, tpid_info_array, count));
