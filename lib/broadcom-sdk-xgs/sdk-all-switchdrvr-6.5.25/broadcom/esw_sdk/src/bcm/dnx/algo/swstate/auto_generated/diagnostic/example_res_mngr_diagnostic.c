...
/*
 *
 * dump function for the variable resource_test_prefer_lower_ids
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
algo_res_mngr_db_resource_test_prefer_lower_ids_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example_res_mngr resource_test_prefer_lower_ids") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example_res_mngr resource_test_prefer_lower_ids\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "algo_res_mngr_db/resource_test_prefer_lower_ids.txt",
            "algo_res_mngr_db[%d]->","((example_res_mngr_sw_state_t*)sw_state_roots_array[%d][EXAMPLE_RES_MNGR_MODULE_ID])->","resource_test_prefer_lower_ids: ");
...
const char* algo_res_mngr_db_layout_str[ALGO_RES_MNGR_DB_INFO_NOF_ENTRIES] = {
    ...
    "ALGO_RES_MNGR_DB~RESOURCE_TEST_PREFER_LOWER_IDS~",
};
