...
#include <bcm/ptp.h>
#ifdef    INCLUDE_PTP
#include <bcm_int/dnx/auto_generated/dnx_ptp_dispatch.h>
#endif /* INCLUDE_PTP */
...
#define DNX_PTP_1588_IDENTIFICATION_CAM_TABLE_ENTRIES_NUM (23)
...
#define DNX_PTP_INIT         DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION
#define DNX_PTP_ANY          DBAL_NOF_ENUM_LAYER_TYPES_VALUES
    ...
    uint32 *ret_mask)
{
    ...
    {
        case DNX_PTP_ANY:
            /** force value to be 0 and mask to be all 1 for DNX_PTP_ANY */
            mask = (1 << field_info.field_nof_bits) - 1;
            break;
        case DNX_PTP_MPLS_TERM:
            SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                            (unit, DBAL_FIELD_LAYER_TYPES, DBAL_ENUM_FVAL_LAYER_TYPES_MPLS, &mask));
...
/**
 * \brief
 *   calculate the value based on the type, as configured in identification cam table
 *
 * \param [in] unit - The unit number.
 * \param [in] type - layer_record type
 ...
 */
static int
dnx_ptp_identification_val_calc(
    int unit,
    int type,
    uint32 *ret_val)
{
    ...
    int unit)
{
    ...
    /* *INDENT-OFF* */
     ...
     /*
      * DNX_PTP_ANY can be MPLS/IPv4/IPv6, and so on.
      * Comments below entries list detailed layer protocols array to show scenarioes that current entry covers.
      */
      ...
      * 1588oETH Started
      */
/*0*/ {{DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,      DNX_PTP_INIT,        TRUE ,     0       },   /* 1588oE (switched) */
/*1*/  {DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,      DNX_PTP_ETH ,        TRUE ,     1       },
/*2*/  {DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,      DNX_PTP_ANY ,        TRUE ,     2       },
/*3*/  {DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY,       DNX_PTP_ANY ,        TRUE ,     3       },
     /*{DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, TRUE ,     3       },*/ /* 1588oEoMPLSoE (MPLSoE terminated) */
     /* Unsuported
      *{DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY,       DNX_PTP_ANY ,        TRUE ,     4       },
      *{DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY,       DNX_PTP_ANY ,        TRUE ,     5       },
      *{DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY,       DNX_PTP_ANY ,        TRUE ,     6       },
      */

/*4*/  {DNX_PTP_ETH , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,      DNX_PTP_INIT,        TRUE ,     1       },   /* 1588oEoE (switched) */
/*5*/  {DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,      DNX_PTP_ETH ,        TRUE ,     2       },
/*6*/  {DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,      DNX_PTP_ANY ,        TRUE ,     3       },
     /*{DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, TRUE ,     3       },*/ /* 1588oEoMPLSoE (MPLS routed) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY ,      DNX_PTP_ANY ,        TRUE ,     4       },
      *{DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY ,      DNX_PTP_ANY ,        TRUE ,     5       },
      *{DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY ,      DNX_PTP_ANY ,        TRUE ,     6       },
      */

/*7*/  {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,     2       },
     /*{DNX_PTP_ETH , DNX_PTP_ETH , DNX_PTP_ETH , DNX_PTP_1588,  DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,     2       },*/ /* 1588oEoEoE    (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_ETH , DNX_PTP_1588,  DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,     2       },*/ /* 1588oEoIPv4oE (switched) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_ETH ,        TRUE ,     3       },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,     DNX_PTP_ANY ,        TRUE ,     4       },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY ,     DNX_PTP_ANY ,        TRUE ,     5       },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY ,     DNX_PTP_ANY ,        TRUE ,     6       },
      */

/*8*/  {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,     3       },
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, TRUE ,     3       },*/ /* 1588oEoMPLSoMPLSoE (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_IPV4, DNX_PTP_ETH ,  DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,     3       },*/ /* 1588oEoIPv4oIPv4oE (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_ETH , DNX_PTP_ETH ,  DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,     3       },*/ /* 1588oEoEoIPv4oE    (switched) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_INIT,     DNX_PTP_ETH ,        TRUE ,     4       },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT, DNX_PTP_ETH ,     DNX_PTP_ANY ,        TRUE ,     5       },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_ETH , DNX_PTP_ANY ,     DNX_PTP_ANY ,        TRUE ,     6       },
      */

/*9*/  {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588,  DNX_PTP_INIT,     DNX_PTP_INIT,        TRUE ,    4        },
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, TRUE ,    4        },*/ /* 1588oEoEoMPLSoE    (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_IPV4, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, TRUE ,    4        },*/ /* 1588oEoIPv4oMPLSoE (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, TRUE ,    4        },*/ /* 1588oEoMPLSoMPLSoIPv4oE (switched) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_INIT,     DNX_PTP_ETH ,        TRUE ,    4        },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_1588 , DNX_PTP_ETH ,     DNX_PTP_ANY ,        TRUE ,    4        },
      */
     /* Unsuported
      *{DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH ,  DNX_PTP_1588,     DNX_PTP_INIT,        TRUE ,    5        },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH ,  DNX_PTP_1588,     DNX_PTP_ETH ,        TRUE ,    6        },
      */
     /* Unsuported
      *{DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY ,  DNX_PTP_ETH ,     DNX_PTP_1588 ,       TRUE ,    6        },
      */
     /*
      * 1588oETH End
      */
      ...
      * 1588oUDP Started
      */
/*10*/ {DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     2        },
     /*{DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     2        },*/ /* 1588oUDPoIPv4oE (IPv4 routed) */
     /*{DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     2        },*/ /* 1588oUDPoIPv6oE (IPv6 routed) */
/*11*/ {DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY ,             FALSE,     3        },
     /*{DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_IPV4,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv4oE (IPv4oE terminated) */
     /*{DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_IPV4,             FALSE,     3        },*/ /* 1588oUDPoIPv6oIPv4oE (IPv4oE terminated) */
     /*{DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_IPV6,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv6oE (IPv6oE terminated) */
     /*{DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_IPV6,             FALSE,     3        },*/ /* 1588oUDPoIPv6oIPv6oE (IPv6oE terminated) */
/*12*/ {DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY ,             FALSE,     4        },
     /*{DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, FALSE,     4        },*/ /* 1588oUDPoIPv4oMPLSoE (MPLS terminated) */
     /*{DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, FALSE,     4        },*/ /* 1588oUDPoIPv6oMPLSoE (MPLS terminated) */
/*13*/ {DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY ,             FALSE,     5        },
     /*{DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH,  DNX_PTP_IPV4, DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, FALSE,     5        },*/ /* 1588oUDPoIPv4oMPLSoE (MPLS terminated) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY ,             FALSE,     6        },
      */
/*14*/ {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     2        },
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     2        },*/  /* 1588oUDPoIPv4oE (switched)  */
     /*{DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     2        },*/  /* 1588oUDPoIPv6oE (switched)  */
/*15*/ {DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     3        },
     /*{DNX_PTP_IPV4, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv4oE (IPv4 routed) */
     /*{DNX_PTP_IPV6, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     3        },*/ /* 1588oUDPoIPv6oIPv4oE (IPv4 routed) */
     /*{DNX_PTP_IPV4, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv6oE (IPv6 routed) */
     /*{DNX_PTP_IPV6, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     3        },*/ /* 1588oUDPoIPv6oIPv6oE (IPv6 routed) */
/*16*/ {DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY ,             FALSE,     4        },
     /*{DNX_PTP_MPLS_UNTERM, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, FALSE,     4        },*/ /* 1588oUDPoIPv4oMPLSoE (MPLS routed) */
     /*{DNX_PTP_MPLS_UNTERM, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, FALSE,     4        },*/ /* 1588oUDPoIPv6oMPLSoE (MPLS routed) */
/*17*/ {DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY ,             FALSE,     5        },
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, FALSE,     5        },*/ /* 1588oUDPoIPv4oEoMPLSoE (MPLSoE terminated) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, FALSE,     5        },*/ /* 1588oUDPoIPv6oEoMPLSoE (MPLSoE terminated) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY ,             FALSE,     6        },
      */
/*18*/ {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY,  DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     3        },
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv4oE (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     3        },*/ /* 1588oUDPoIPv6oIPv4oE (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv6oE (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     3        },*/ /* 1588oUDPoIPv4oIPv6oE (switched) */
/*19*/ {DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY,  DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     4        },
/*20*/ {DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY,  DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_ANY ,             FALSE,     5        },
     /*{DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM ,FALSE,     5        },*/ /* 1588oUDPoIPv4oEoMPLSoE (MPLSoE routed) */
     /*{DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH , DNX_PTP_MPLS_TERM ,FALSE,     5        },*/ /* 1588oUDPoIPv6oEoMPLSoE (MPLSoE routed) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY,  DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY ,             FALSE,     6        },
      */
/*21*/ {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     4        },
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, FALSE,     4        },*/ /* 1588oUDPoIPv4oMPLSoE   (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT, FALSE,     4        },*/ /* 1588oUDPoIPv4oMPLSoE   (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     4        },*/ /* 1588oUDPoIPv4oEoIPv4oE (switched  */
     /*{DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     4        },*/ /* 1588oUDPoIPv6oEoIPv6oE (switched  */
     /*{DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     4        },*/ /* 1588oUDPoIPv4oEoIPv6oE (switched  */
     /*{DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_INIT,             FALSE,     4        },*/ /* 1588oUDPoIPv6oEoIPv4oE (switched  */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, DNX_PTP_ETH ,             FALSE,     5        },
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ETH , DNX_PTP_ANY ,             FALSE,     6        },
      */
/*22*/ {DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP, DNX_PTP_1588 , DNX_PTP_INIT,             FALSE,     5        },
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, FALSE,     5        },*/ /* 1588oUDPoIPv4oEoMPLSoE    (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, FALSE,     5        },*/ /* 1588oUDPoIPv6oEoMPLSoE    (switched) */
     /*{DNX_PTP_ETH , DNX_PTP_MPLS_TERM, DNX_PTP_MPLS_UNTERM, DNX_PTP_IPV4, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_INIT, FALSE,     5        },*/ /* 1588oUDPoIPv4oIPv4oMPLSoE (switched) */
     /* Unsuported
      *{DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ETH ,             FALSE,     6        },
      */

     /* Unsuported
      *{DNX_PTP_ETH , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY, DNX_PTP_UDP , DNX_PTP_1588 ,             FALSE,     6        }
      */
      };
     /*
      * 1588oUDP Started
    ...
    if (dnx_data_dev_init.general.feature_get(unit, dnx_data_dev_init_general_application_v1))
    {
        ...
        for (entry_idx = 0; entry_idx < DNX_PTP_1588_IDENTIFICATION_CAM_TABLE_ENTRIES_NUM; entry_idx++)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][0], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_0, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][1], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][1], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_1, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][2], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][2], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_2, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][3], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][3], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_3, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][4], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][4], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_4, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][5], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][5], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_5, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][6], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][6], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_6, val, mask);

            SHR_IF_ERR_EXIT(dnx_ptp_identification_mask_calc(unit, ieee_1588_identification_cam[entry_idx][7], &mask));
            SHR_IF_ERR_EXIT(dnx_ptp_identification_val_calc(unit, ieee_1588_identification_cam[entry_idx][7], &val));
            dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORWARDING_TYPE_7, val, mask);
    ...
    int unit)
{
    ...
    {
        SHR_IF_ERR_EXIT(bcm_dnx_ptp_detach(unit));
    }
#endif /* defined(INCLUDE_PTP) */
    ...
    int use_external_mac)
{
    ...
    if (use_external_mac == TRUE && config_count == TRUE)
    {
        ...
        if (dnx_data_ptp.general.feature_get(unit, dnx_data_ptp_general_has_external_brcm_mac) == TRUE)
        {
...
{
    uint32 entry_handle_id;
    int use_ingress_time_stamp = FALSE;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    ...
    {
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_USE_INGRESS_TIME_STAMP, INST_SINGLE,
                                   (uint32 *) &use_ingress_time_stamp);
    }

    /** Preforming the action */
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));

    if (dnx_data_ptp.general.feature_get(unit, dnx_data_ptp_general_has_external_brcm_mac) == FALSE)
    {
        if (config_count && (use_ingress_time_stamp == FALSE))
        {
            *use_external_mac = TRUE;
        }
    }
    ...
    else
    {
        ...
        for (port_idx = 0; port_idx < gport_info.internal_port_pp_info.nof_pp_ports; port_idx++)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_ptp_tx_timestamp_config_set(unit, gport_info.internal_port_pp_info.core_id[port_idx],
                                                            gport_info.internal_port_pp_info.pp_port[port_idx],
                                                            config_count, use_external_mac));
        }
    }
    ...
    int value)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_ptp_port_delay_set_verify(unit, port, value));
    ...
    uint64 value)
{
    ...
    if (dnx_drv_soc_feature(unit, soc_feature_timesync_support))
    {
        switch (type)
        {
            ...
            {
                if (COMPILER_64_LO(value) >= phymodTimesyncCompensationModeCount)
                {
    ...
    bcm_port_timesync_tx_info_t * tx_info)
{
    ...
    SHR_IF_ERR_EXIT(imb_port_timesync_tx_info_get(unit, port, tx_info));
exit:
    SHR_FUNC_EXIT;
}
...
/*
 * Function:
 *      bcm_petra_ptp_servo_performance_get
 * Purpose:
 ...
 */
int
bcm_dnx_ptp_servo_performance_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    bcm_ptp_servo_performance_t * perf)
{
    ...
    SHR_IF_ERR_EXIT(bcm_common_ptp_servo_performance_get(unit, ptp_id, clock_num, perf));
