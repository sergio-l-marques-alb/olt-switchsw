    ...
    int enable)
{
    ...
    if (enable == TRUE)
    {
        ...
        if (!module_enable_done)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_port_logicals_get(unit, BCM_CORE_ALL, DNX_ALGO_PORT_LOGICALS_TYPE_PP_DSP, 0,
                                                       &port_bm));
            ...
            BCM_PBMP_ITER(port_bm, port)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_algo_port_pp_dsp_allowed_verify(unit, core, pp_dsp, nof_fap_ids));
            }
    ...
    int enable)
{
    ...
    /** verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_module_enable_verify(unit, modid, nports, enable));

    /** Enable/disable Traffic */
    SHR_IF_ERR_EXIT(dnx_stk_sys_traffic_enable_set(unit, enable, FALSE));
    ...
    int *modid_count)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_config_get_all_verify(unit, modid_max, modid_array, modid_count));
    ...
    bcm_stk_modid_config_t * modid)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_nof_verify(unit, 1));
    ...
    bcm_stk_modid_config_t * modid)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_config_add_verify(unit, modid, fap_id_index));
    ...
    for (core = 0; core < nof_cores; core++)
    {
        ...
        {
            /*
             * Configuration for local devices in FCT for MESH mode is needed in order
             ...
             */
            if (dnx_data_fabric.general.connect_mode_get(unit) != DNX_FABRIC_CONNECT_MODE_FE && max_nof_dest > 1)
            {
    ...
    bcm_stk_modid_config_t * modid)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_nof_verify(unit, 0));
    ...
    bcm_port_t gport)
{
    ...
    if (BCM_GPORT_IS_MODPORT(gport))
    {
        ...
        SHR_RANGE_VERIFY(ftmh_pp_dsp, 0, dnx_data_port.general.nof_pp_dsp_per_fap_id_get(unit) - 1, _SHR_E_PARAM,
    ...
    bcm_port_t gport)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_sysport_gport_set_verify(unit, sysport, gport));
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_port_pp_dsp_get(unit, logical_port, &core, (uint32 *) &pp_dsp));
        SHR_IF_ERR_EXIT(dnx_stk_sys_pp_dsp_to_modport_convert(unit, core, pp_dsp, &modid, &ftmh_pp_dsp));
    }
     ...
     */
    {
        ...
        if (is_local) /** local modid */
        {
             ...
             */
            SHR_IF_ERR_EXIT(dnx_stk_sys_modport_to_pp_dsp_convert(unit, modid, ftmh_pp_dsp, &core, &pp_dsp));
            SHR_IF_ERR_EXIT(dnx_algo_port_pp_dsp_to_logical_get(unit, core, pp_dsp, &logical_port));
    ...
    bcm_gport_t * gport)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_sysport_gport_get_verify(unit, sysport, gport));
    ...
    int tm_domain)
{
    ...
    /** Verify modid */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_domain_modid_verify(unit, modid));

    /** Verify tm_domain */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_domain_tm_domain_verify(unit, tm_domain));
    ...
    int tm_domain)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_domain_verify(unit, modid, tm_domain));
    ...
    int *mod_count)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_domain_get_verify(unit, tm_domain, mod_max, mod_array, mod_count));
    ...
    bcm_trunk_t stk_trunk)
{
    ...
    /** Verify stk_trunk */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_trunk_id_verify(unit, stk_trunk));
    ...
    bcm_trunk_t stk_trunk)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_domain_stk_trunk_verify(unit, tm_domain, stk_trunk));
    ...
    int *domain_count)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_modid_domain_get_verify(unit, tm_domain, domain_max, domain_array, domain_count));
    ...
    bcm_module_t max_module)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_module_max_verify(unit, flags));
    ...
    int arg)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_module_control_verify(unit, flags, module));
