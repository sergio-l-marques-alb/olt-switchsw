...
static const char *dnx_qual_name[DNX_FIELD_QUAL_NOF] = {
    "Q_INVALID",
    "Q_ACL_CONTEXT",
    "Q_ACTION_PROFILE_DA_NOT_FOUND_INDEX",
    "Q_ACTION_PROFILE_SA_DROP_INDEX",
    "Q_ACTION_PROFILE_SA_NOT_FOUND_INDEX",
    "Q_AC_IN_LIF_WIDE_DATA",
    "Q_AC_IN_LIF_WIDE_DATA_EXTENDED",
    "Q_ADMT_PROFILE",
    "Q_ALGO_LPM_RESULT_1",
    "Q_ALGO_LPM_RESULT_2",
    "Q_ALL_ONES",
    "Q_ALT_CONTEXT",
    "Q_APPLICATION_SPECIFIC_EXT",
    "Q_BIER_BFR_EXT",
    "Q_BIER_STR_OFFSET",
    "Q_BIER_STR_SIZE",
    "Q_BTC_MINUS_BTK",
    ...
    "Q_CMP_KEY_0_DECODED",
    "Q_CMP_KEY_1_DECODED",
    "Q_CMP_KEY_TCAM_0_DECODED",
    "Q_CMP_KEY_TCAM_1_DECODED",
    "Q_CONGESTION_INFO",
    "Q_CONTEXT",
    "Q_CONTEXT_KEY_GEN_VAR",
    "Q_CORE_ID",
    "Q_CPU_TRAP_CODE_PROFILE",
    "Q_CUD_OUTLIF_OR_MCDB_PTR",
    "Q_DISCARD",
    "Q_DP",
    "Q_DST_SYS_PORT",
    "Q_DUAL_UEUE",
    ...
    "Q_ECN",
    "Q_EEI",
    "Q_EGRESS_LEARN_ENABLE",
    "Q_EGRESS_PARSING_INDEX",
    "Q_ELEPHANT_LEARN_NEEDED",
    "Q_ELEPHANT_TRAP_INFO",
    "Q_ELK_LKP_HIT_0",
    "Q_ELK_LKP_HIT_1",
    "Q_ELK_LKP_HIT_2",
    "Q_ELK_LKP_HIT_3",
    ...
    "Q_ELK_LKP_HIT_6",
    "Q_ELK_LKP_HIT_7",
    "Q_EXTERNAL_RESULT_BUFFER_PART_0",
    "Q_EXTERNAL_RESULT_BUFFER_PART_1",
    "Q_ENABLE_PP_INJECT",
    "Q_ENCODER0",
    "Q_ENCODER1",
    "Q_ENCODER2",
    "Q_ENCODER3",
    "Q_END_OF_PACKET_EDITING",
    "Q_EPMF_CONTEXT_LFSR_1",
    "Q_EPMF_CONTEXT_LFSR_2",
    "Q_EPMF_CONTEXT_VAR",
    "Q_ESTIMATED_BTR",
    "Q_ETHER_TYPE_CODE",
    "Q_ETH_TAG_FORMAT",
    "Q_EXT_STATISTICS_ATR_0",
    "Q_EXT_STATISTICS_ATR_1",
    "Q_EXT_STATISTICS_ATR_2",
    "Q_EXT_STATISTICS_ATR_3",
    "Q_EXT_STATISTICS_ID_0",
    "Q_EXT_STATISTICS_ID_1",
    "Q_EXT_STATISTICS_ID_2",
    "Q_EXT_STATISTICS_ID_3",
    "Q_EXT_STATISTICS_VALID",
    "Q_FABRIC_OR_EGRESS_MC",
    "Q_FAI_DO_NOT_DEC_TTL",
    "Q_FER_STAGE_0_IN_DST",
    "Q_FER_STAGE_1_IN_DST",
    "Q_FER_STAGE_2_IN_DST",
    "Q_FER_STAGE_0_IN_DST_IS_MINE",
    "Q_FER_STAGE_1_IN_DST_IS_MINE",
    "Q_FER_STAGE_2_IN_DST_IS_MINE",
    "Q_FER_STAGE_0_RESOLVED_FEC_PTR",
    "Q_FER_STAGE_1_RESOLVED_FEC_PTR",
    "Q_FER_STAGE_2_RESOLVED_FEC_PTR",
    "Q_FER_STAGE_0_RESOLVED_FEC_VALID",
    "Q_FER_STAGE_1_RESOLVED_FEC_VALID",
    "Q_FER_STAGE_2_RESOLVED_FEC_VALID",
    "Q_USER_HEADER_1_EXT",
    "Q_USER_HEADER_2_EXT",
    "Q_FER_STATISTICS_OBJ",
    "Q_FHEI_EXT",
    "Q_FLOW_ID_EXT",
    "Q_FLP_STATISTICS_ATR_0",
    "Q_FLP_STATISTICS_ATR_1",
    "Q_FLP_STATISTICS_ATR_2",
    "Q_FLP_STATISTICS_ATR_3",
    "Q_FLP_STATISTICS_ATR_4",
    "Q_FLP_STATISTICS_ATR_5",
    "Q_FLP_STATISTICS_ID_0",
    "Q_FLP_STATISTICS_ID_1",
    "Q_FLP_STATISTICS_ID_2",
    "Q_FLP_STATISTICS_ID_3",
    "Q_FLP_STATISTICS_ID_4",
    "Q_FLP_STATISTICS_ID_5",
    "Q_FTMH_APPLICATION_SPECIFIC_EXT_PRESENT",
    "Q_FTMH_AQM_PROFILE",
    "Q_FTMH_BIER_BFR_EXT_PRESENT",
    "Q_FTMH_CNI",
    "Q_FTMH_DP",
    "Q_FTMH_ECN_ENABLE",
    "Q_FTMH_FLOW_ID_EXT_PRESENT",
    "Q_FTMH_MCID_OR_OUTLIF_0_OR_MCDB_PTR",
    "Q_FTMH_PACKET_SIZE",
    "Q_FTMH_PPH_PRESENT",
    "Q_FTMH_RESERVED",
    "Q_FTMH_SRC_SYS_PORT",
    "Q_FTMH_TC",
    "Q_FTMH_TM_ACTION_IS_MC",
    "Q_FTMH_TM_ACTION_TYPE",
    "Q_FTMH_TM_DESTINATION_EXT_PRESENT",
    "Q_FTMH_TM_PROFILE",
    "Q_FTMH_TSH_EXT_PRESENT",
    "Q_FTMH_VISIBILITY",
    "Q_FWD1_PRIORITY_DECODER_FWD_FOUND",
    "Q_FWD1_PRIORITY_DECODER_FWD_PROFILE",
    "Q_FWD1_PRIORITY_DECODER_FWD_RESULT",
    "Q_FWD1_PRIORITY_DECODER_FWD_STRENGTH",
    "Q_FWD1_PRIORITY_DECODER_RPF_FOUND",
    "Q_FWD1_PRIORITY_DECODER_RPF_PROFILE",
    "Q_FWD1_PRIORITY_DECODER_RPF_RESULT",
    "Q_FWD1_PRIORITY_DECODER_RPF_STRENGTH",
    "Q_FWD_ACTION_CPU_TRAP_CODE",
    "Q_FWD_ACTION_CPU_TRAP_UAL",
    "Q_FWD_ACTION_DESTINATION",
    "Q_FWD_ACTION_DP",
    "Q_FWD_ACTION_DP_METER_COMMAND",
    "Q_FWD_ACTION_PROFILE_INDEX",
    "Q_FWD_ACTION_STRENGTH",
    "Q_FWD_ACTION_TC",
    "Q_FWD_CONTEXT",
    "Q_FWD_DOMAIN",
    "Q_FWD_DOMAIN_PROFILE",
    "Q_FWD_KAPSB_IF0_ERR",
    "Q_FWD_KAPSB_IF0_FOUND",
    "Q_FWD_KAPSB_IF0_PAYLOAD",
    "Q_FWD_KAPSB_IF1_ERR",
    "Q_FWD_KAPSB_IF1_FOUND",
    "Q_FWD_KAPSB_IF1_PAYLOAD",
    "Q_FWD_KAPSC_IF0_ERR",
    "Q_FWD_KAPSC_IF0_FOUND",
    "Q_FWD_KAPSC_IF0_PAYLOAD",
    "Q_FWD_KAPSC_IF1_ERR",
    "Q_FWD_KAPSC_IF1_FOUND",
    "Q_FWD_KAPSC_IF1_PAYLOAD",
    "Q_FWD_LAYER_ADDITIONAL_INFO",
    "Q_FWD_LAYER_INDEX",
    "Q_FWD_OPAQUE_FIELD",
    "Q_FWD_PAYLOAD",
    "Q_FWD_PLUS1_REMARK_PROFILE",
    "Q_TYPE_FWD_REMARK_OR_KEEP",
    "Q_FWD_STAT_ATTRIBUTE_OBJ",
    "Q_FWD_STAT_ATTRIBUTE_OBJ_CMD",
    "Q_FWD_STRENGTH",
    "Q_GENERAL_DATA",
    "Q_GENERAL_DATA_0",
    "Q_GENERAL_DATA_1",
    ...
    "Q_GLOB_VOQ_AGG_ADDR",
    "Q_IEEE1588_COMMAND",
    "Q_IEEE1588_COMPENSATE_TIME_STAMP",
    "Q_IEEE1588_ENCAPSULATION",
    "Q_IEEE1588_HEADER_OFFSET",
    "Q_INCOMING_TAG_STRUCTURE",
    "Q_INGRESS_LEARN_ENABLE",
    "Q_INGRESS_PROTOCOL_TRAP_IN_LIF_PROFILE",
    "Q_IN_LIF_PROFILE_0",
    "Q_IN_LIF_PROFILE_1",
    "Q_IN_LIF_PROFILE_PMF_UAL_0",
    "Q_IN_LIF_UNKNOWN_DA_PROFILE",
    "Q_IN_PORT",
    "Q_IN_PORT_KEY_GEN_VAR",
    "Q_IN_PORT_MAPPED_PP_PORT",
    "Q_IN_TTL",
    "Q_IPV4_CHECKSUM_ERROR",
    "Q_IPV4_DIP_ZERO_ERROR",
    "Q_IPV4_HEADER_LENGTH_ERROR",
    "Q_IPV4_OPTIONS_ERROR",
    "Q_IPV4_SIP_EQUAL_DIP_ERROR",
    "Q_IPV4_SIP_IS_MC_ERROR",
    "Q_IPV4_TOTAL_LENGTH_ERROR",
    "Q_IPV4_VERSION_ERROR",
    "Q_IP_MC_ELIGIBLE",
    "Q_IP_MC_SHOULD_BE_BRIDGED",
    "Q_IP_TUNNEL_IN_LIF_WIDE_DATA",
    "Q_IS_IN_LIF_VALID_FOR_LM",
    "Q_IS_TDM",
    "Q_ITPP_DELTA",
    "Q_IVE_BYTES_TO_ADD",
    "Q_IVE_BYTES_TO_REMOVE",
    "Q_KEY_F_INITIAL",
    "Q_KEY_G_INITIAL",
    "Q_KEY_H_INITIAL",
    "Q_KEY_I_INITIAL",
    ...
    "Q_LAG_LB_KEY",
    "Q_LATENCY_FLOW_ID",
    "Q_LATENCY_FLOW_ID_VALID",
    "Q_LB_KEY",
    "Q_LEARN_DATA",
    "Q_LEARN_EXPECTED_WON",
    "Q_LEARN_EXT",
    "Q_LEARN_EXT_DATA",
    "Q_LEARN_EXT_SRC_MAC",
    "Q_LEARN_EXT_VLAN",
    ...
    "Q_LFSR_2",
    "Q_LIF_EXT",
    "Q_LIF_OAM_TRAP_PROFILE",
    "Q_LPM_A1_FOUND",
    "Q_LPM_A1_LENGTH",
    "Q_LPM_A2_FOUND",
    "Q_LPM_A2_LENGTH",
    "Q_LOCAL_OUT_LIF",
    "Q_MACT_ENTRY_GROUPING",
    "Q_MDL",
    "Q_MEM_SOFT_ERR",
    "Q_MIRROR_CODE",
    "Q_MIRROR_UALIFIER",
    ...
    "Q_MY_CFM_MAC",
    "Q_NASID",
    "Q_NATIVE_AC_IN_LIF_WIDE_DATA",
    "Q_NAUID",
    "Q_NOF_VALID_LM_LIFS",
    "Q_NOF_VALID_PACKET_BYTES",
    "Q_NWK_KEY",
    "Q_NWK_LB_KEY",
    "Q_NWK_OS",
    "Q_OAM_ID",
    ...
    "Q_OAM_OPCODE",
    "Q_OAM_STAMP_OFFSET",
    "Q_OAM_STATISTICS_OBJ_0",
    "Q_OAM_STATISTICS_OBJ_1",
    "Q_OAM_STATISTICS_OBJ_2",
    "Q_OAM_SUB_TYPE",
    "Q_OAM_UP_MEP",
    "Q_OAM_YOUR_DISCR",
    "Q_OUT_LIF_PROFILE",
    ...
    "Q_OUT_LIF_PROFILE_2",
    "Q_OUT_LIF_PROFILE_3",
    "Q_OUT_LIF_PROFILE_LFSR_1_IN_RANGE",
    "Q_OUT_LIF_PROFILE_LFSR_2_IN_RANGE",
    "Q_OUT_LIF_PROFILE_PMF_UAL_0",
    "Q_OUT_LIF_PROFILE_PMF_UAL_1",
    "Q_OUT_LIF_PROFILE_PMF_UAL_2",
    "Q_OUT_LIF_PROFILE_PMF_UAL_3",
    "Q_OUT_PP_PORT",
    "Q_OUT_PP_PORT_LFSR_1_IN_RANGE",
    "Q_OUT_PP_PORT_LFSR_2_IN_RANGE",
    "Q_OUT_TM_PORT",
    "Q_PACKET_HEADER_SIZE",
    "Q_PACKET_HEADER_SIZE_RANGE",
    "Q_PACKET_IS_APPLET",
    "Q_PACKET_IS_BFD",
    "Q_PACKET_IS_BIER",
    "Q_PACKET_IS_COMPATIBLE_MC",
    "Q_PACKET_IS_IEEE1588",
    "Q_PACKET_IS_OAM",
    "Q_PER_PORT_TABLE_DATA",
    "Q_PMF1_DIRECT_ACTION",
    "Q_PMF1_EXEM_ACTION",
    "Q_PMF1_TCAM_ACTION_0",
    "Q_PMF1_TCAM_ACTION_1",
    "Q_PMF1_TCAM_ACTION_2",
    "Q_PMF1_TCAM_ACTION_3",
    "Q_PMF_ETH_RIF_PROFILE",
    "Q_PPH_END_OF_PACKET_EDITING",
    "Q_PPH_FHEI_SIZE",
    "Q_PPH_FWD_DOMAIN",
    "Q_PPH_FWD_LAYER_ADDITIONAL_INFO",
    "Q_PPH_FWD_LAYER_INDEX",
    "Q_PPH_FWD_STRENGTH",
    "Q_PPH_IN_LIF",
    "Q_PPH_IN_LIF_PROFILE",
    "Q_PPH_LEARN_EXT_PRESENT",
    "Q_PPH_LIF_EXT_TYPE",
    "Q_PPH_NWK_OS",
    "Q_PPH_PARSING_START_OFFSET",
    "Q_PPH_PARSING_START_TYPE",
    "Q_PPH_RESERVED",
    "Q_PPH_TTL",
    "Q_PPH_TYPE",
    "Q_PPH_VALUE1",
    ...
    "Q_PP_DSP",
    "Q_PP_PORT",
    "Q_PP_PORT_PMF_GENERAL_DATA",
    "Q_PP_PORT_PMF_PROFILE",
    "Q_PROGRAM_INDEX",
    "Q_PRT_UALIFIER",
    "Q_PTC",
    "Q_PTC_KEY_GEN_VAR",
    "Q_PWE_IN_LIF_WIDE_DATA",
    "Q_RPF_DEFAULT_ROUTE_FOUND",
    "Q_RPF_DST",
    "Q_RPF_DST_VALID",
    "Q_RPF_ECMP_GROUP",
    "Q_RPF_ECMP_MODE",
    ...
    "Q_RPF_OUT_LIF",
    "Q_RPF_ROUTE_VALID",
    "Q_SAVED_CONTEXT_PROFILE",
    "Q_SLB_KEY",
    "Q_SLB_LEARN_NEEDED",
    "Q_SLB_PAYLOAD",
    "Q_SLLB_MEMBER_REFERENCE",
    "Q_SNOOP_ACTION_PROFILE_INDEX",
    "Q_SNOOP_CODE",
    "Q_SNOOP_UALIFIER",
    "Q_SNOOP_STRENGTH",
    "Q_SOCST",
    ...
    "Q_SRC_SYS_PORT",
    "Q_STACKING_EXT",
    "Q_STACKING_ROUTE_HISTORY_BITMAP",
    "Q_STATE_ADDRESS",
    "Q_STATE_DATA",
    "Q_STATE_DATA_WRITE",
    "Q_STATISTICAL_SAMPLING_CODE",
    "Q_STATISTICAL_SAMPLING_UALIFIER",
    "Q_STATISTICS_ATR_0",
    "Q_STATISTICS_ATR_1",
    "Q_STATISTICS_ATR_2",
    "Q_STATISTICS_ATR_3",
    ...
    "Q_STATISTICS_ID_10",
    "Q_STATISTICS_ID_11",
    "Q_STATISTICS_META_DATA",
    "Q_STATISTICS_OBJECT10",
    "Q_STATISTICS_OBJ_0",
    "Q_STATISTICS_OBJ_1",
    "Q_STATISTICS_OBJ_2",
    "Q_STATISTICS_OBJ_3",
    ...
    "Q_STATISTICS_OBJ_11",
    "Q_STATISTICS_OBJ_12",
    "Q_STAT_OBJ_LM_READ_INDEX",
    "Q_ST_VSQ_PTR",
    "Q_SYSTEM_HEADERS_SIZE",
    "Q_SYSTEM_HEADER_PROFILE_INDEX",
    "Q_TC",
    "Q_TC_MAP_PROFILE",
    "Q_TM_DESTINATION_EXT",
    "Q_TM_FLOW_ATR",
    "Q_TM_FLOW_ID",
    "Q_TM_PORT_PMF_PROFILE",
    "Q_TM_PROFILE",
    "Q_TRACE_PACKET",
    "Q_TRJ_HASH",
    "Q_TSH_EXT",
    "Q_UDH_BASE_ENTRY_PUSH_PROFILE",
    "Q_UDH_BASE_PRP_CS_VAR",
    "Q_UNKNOWN_ADDRESS",
    "Q_UPDATED_TPIDS_PACKET_DATA",
    "Q_USER_HEADERS_TYPE",
    "Q_USER_HEADER_1",
    "Q_USER_HEADER_1_TYPE",
    "Q_USER_HEADER_2",
    "Q_USER_HEADER_2_TYPE",
    "Q_USER_HEADER_3",
    "Q_USER_HEADER_3_TYPE",
    "Q_USER_HEADER_4",
    "Q_USER_HEADER_4_TYPE",
    "Q_VID_VALID",
    "Q_VISIBILITY",
    "Q_VISIBILITY_CLEAR",
    "Q_VLAN_EDIT_CMD",
    "Q_VLAN_EDIT_CMD_INDEX",
    "Q_VLAN_EDIT_DEI_1",
    "Q_VLAN_EDIT_DEI_2",
    "Q_VLAN_EDIT_PCP_1",
    "Q_VLAN_EDIT_PCP_2",
    "Q_VLAN_EDIT_PCP_DEI_1",
    "Q_VLAN_EDIT_PCP_DEI_2",
    "Q_VLAN_EDIT_VID_1",
    "Q_VLAN_EDIT_VID_2",
    "Q_VRF_VALUE",
    "Q_VSI_UNKNOWN_DA_DESTINATION",
    "Q_VTT_OAM_LIF_0",
    "Q_VTT_OAM_LIF_0_VALID",
    "Q_VTT_OAM_LIF_1",
    "Q_VTT_OAM_LIF_1_VALID",
    "Q_VTT_OAM_LIF_2",
    "Q_VTT_OAM_LIF_2_VALID",
    "Q_VTT_OAM_PCP_0",
    "Q_VTT_OAM_PCP_1",
    "Q_VTT_OAM_PCP_2",
    "Q_VW_MEMBER_REFERENCE",
    "Q_VW_PCC_HIT",
    "Q_VW_VIP_ID",
    "Q_VW_VIP_VALID",
    "Q_WEAK_TM_PROFILE",
...
{                                                                                                                \
    ...
    {                                                                                                            \
        SHR_ERR_EXIT(_SHR_E_PARAM, "Qualifier class:%s id: qual:%s size (%d) must be between %d and %d\n",    \
                    dnx_field_qual_class_text(qual_class),dnx_qual_name[qual_id],                             \
    ...
    switch (dnx_qual_class)
    {
        ...
        case DNX_FIELD_QUAL_CLASS_META2:
        {
            ...
            else
            {
                 ...
                 */
                int qual_part_ndx;
                int nof_parts = dnx_data_field_map.qual.special_metadata_qual_get(unit, stage, dnx_qual_id)->nof_parts;
                int total_size = 0;
                if (nof_parts <= 0)
                {
    ...
    int unit)
{
    ...
    for (i_id = DNX_FIELD_HEADER_QUAL_FIRST; i_id < DNX_FIELD_HEADER_QUAL_NOF; i_id++)
    {
        ...
        DNX_FIELD_QUAL_SIZE_VERIFY(DNX_FIELD_QUAL_CLASS_HEADER, i_id, header_qual_info.size);
    }
    /*
    ...
    for (i_id = DNX_FIELD_QUAL_FIRST; i_id < DNX_FIELD_QUAL_NOF; i_id++)
    {
        ...
        {
            sal_strncpy_s(field_name, dnx_qual_name[i_id], DBAL_MAX_STRING_LENGTH);
                        ...
                        if (dnx_data_field_map.qual.params_get(unit, dnx_stage, meta_qual)->offset > -1)
                        {
                            ...
                            if (size <= 0)
                            {
                                ...
                                if (meta_qual != DNX_FIELD_QUAL_IN_LIF_PROFILE_0 &&
                                    ...
                                    meta_qual != DNX_FIELD_QUAL_IN_LIF_PROFILE_PMF_QUAL_0 &&
