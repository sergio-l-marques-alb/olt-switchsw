...
* \param [in] base_qpair_or_port_profile - base_qpair or port profile id
...
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] base_qpair_or_port_profile - base qpair or port profile id 0-15
* \param [in] queue_offset - queue offset (traffic class) 0-7
...
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] out_tm_port_or_portprofile - otm_port or port profile id 0-15
...
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] base_qpair_or_port_profile - base_qpair or port profile id 0-15
...
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] tm_port_or_port_profile - tm_port or port profile id 0-15
...
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] base_qpair_or_port_profile - base_q_pair or port profile id 0-15
* \param [in] queue_offset - queue offset 0-7
