...
#ifdef BCM_DNX2_SUPPORT
extern __imb__dispatch__t__ imb_imb_cdu_shr_driver;
#endif
...
int
imb_nbu_create_info_t_validate(
    int unit,
    const imb_nbu_create_info_t * imb_nbu_create_info)
{
    SHR_FUNC_INIT_VARS(unit);
    if (imb_nbu_create_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "NULL parameter");
    }
...
int
imb_nbu_create_info_t_init(
    int unit,
    imb_nbu_create_info_t * imb_nbu_create_info)
{
    SHR_FUNC_INIT_VARS(unit);

    if (imb_nbu_create_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "imb_nbu_create_info NULL parameter");
    }
    sal_memset(imb_nbu_create_info, 0, sizeof(imb_nbu_create_info_t));
    imb_nbu_create_info->user_acc = NULL;
...
int
imb_mgu_create_info_t_validate(
    int unit,
    const imb_mgu_create_info_t * imb_mgu_create_info)
{
    SHR_FUNC_INIT_VARS(unit);
    if (imb_mgu_create_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "NULL parameter");
    }
...
int
imb_mgu_create_info_t_init(
    int unit,
    imb_mgu_create_info_t * imb_mgu_create_info)
{
    SHR_FUNC_INIT_VARS(unit);

    if (imb_mgu_create_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "imb_mgu_create_info NULL parameter");
    }
    sal_memset(imb_mgu_create_info, 0, sizeof(imb_mgu_create_info_t));
    imb_mgu_create_info->user_acc = NULL;
    ...
    int link)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_link_up_mac_update_post)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_link_up_mac_update_post(unit, port, link);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_link_up_mac_update_post isn't implemented for driver type");
    }
    ...
    int *remote_fault)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_faults_status_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_faults_status_get(unit, port, local_fault, remote_fault);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_faults_status_get isn't implemented for driver type");
    }
    ...
    int start_tx_thr)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_tx_start_thr_set(unit, port, speed, start_tx_thr);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    int *start_tx_thr)
{
    ...
    if (start_tx_thr == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "start_tx_thr NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_tx_start_thr_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_tx_start_thr_get(unit, port, start_tx_thr);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_tx_start_thr_get isn't implemented for driver type");
    }
    ...
    int lane_order_size)
{
    ...
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_port_logical_lane_order_set(unit, port, ilkn_lane, lane_order,
                                                                           lane_order_size);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    ...
    uint32 enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_pfc_force_enable_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_pfc_force_enable_set(unit, port, pfc, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_pfc_force_enable_set isn't implemented for driver type");
    }
    ...
    uint32 enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_pfc_mask_on_link_fail_enable_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_pfc_mask_on_link_fail_enable_set(unit, imb_info, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_pfc_mask_on_link_fail_enable_set isn't implemented for driver type");
    }
    ...
    uint8 is_continuous)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_synced_counters_config_set)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_instru_synced_counters_config_set(unit, imb_id, nof_intervals,
                                                                                 is_continuous);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_synced_counters_config_set isn't implemented for driver type");
    }
...
int
imb_instru_sunced_counters_config_get(
    int unit,
    int imb_id,
    uint8 *nof_intervals,
    uint8 *is_continuous)
{
    ...
    if (nof_intervals == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "nof_intervals NULL parameter");
    }
    if (is_continuous == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "is_continuous NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_sunced_counters_config_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_instru_sunced_counters_config_get(unit, imb_id, nof_intervals,
                                                                                 is_continuous);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_sunced_counters_config_get isn't implemented for driver type");
    }
    ...
    uint32 *nof_writes)
{
    ...
    if (last_write == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "last_write NULL parameter");
    }
    if (nof_writes == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "nof_writes NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_synced_counters_last_write_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_instru_synced_counters_last_write_get(unit, port, last_write,
                                                                                     nof_writes);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_synced_counters_last_write_get isn't implemented for driver type");
    }
    ...
    uint64 *counter_values)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "counter_values NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_synced_counters_per_record_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_instru_synced_counters_per_record_get(unit, port, record_index,
                                                                                     nof_counters, dbal_fields,
                                                                                     counter_values);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_synced_counters_per_record_get isn't implemented for driver type");
    }
    ...
    int bring_back_up)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_instru_counters_reset(unit, imb_id, bring_back_up);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    const imb_create_info_t * imb_info)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_traffic_counters_reset)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_instru_traffic_counters_reset(unit, imb_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_traffic_counters_reset isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_instru_traffic_counters_reset)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_instru_traffic_counters_reset(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_instru_traffic_counters_reset isn't implemented for driver type");
    }
    ...
    const imb_create_info_t * imb_info)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_pfc_deadlock_counters_reset)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_instru_pfc_deadlock_counters_reset(unit, imb_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_pfc_deadlock_counters_reset isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_instru_pfc_deadlock_counters_reset)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_instru_pfc_deadlock_counters_reset(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_instru_pfc_deadlock_counters_reset isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_rx_buffers_restart)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_rx_buffers_restart(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_rx_buffers_restart isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_portmod_soft_reset_lock)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_portmod_soft_reset_lock(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_portmod_soft_reset_lock isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_portmod_soft_reset_unlock)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_portmod_soft_reset_unlock(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_portmod_soft_reset_unlock isn't implemented for driver type");
    }
    ...
    int enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_link_fault_force_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_link_fault_force_set(unit, port, type, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_link_fault_force_set isn't implemented for driver type");
    }
    ...
    int *enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_link_fault_force_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_link_fault_force_get(unit, port, type, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_link_fault_force_get isn't implemented for driver type");
    }
    ...
    int fec_enable)
{
     ...
     * Dispatch 
     */
    SHR_IF_ERR_EXIT(imbm.imb_type.get(unit, ilkn_core, &__type__));
    if (__type__ >= imbDispatchTypeCount)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Driver is out of range");
    }

    if (NULL != __imb__dispatch__[__type__]->f_imb_fec_global_enable_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_fec_global_enable_set(unit, ilkn_core, fec_enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_fec_global_enable_set isn't implemented for driver type");
    }
    ...
    bcm_port_timesync_tx_info_t * tx_info)
{
    ...
    if (tx_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "tx_info NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_timesync_tx_info_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_timesync_tx_info_get(unit, port, tx_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_timesync_tx_info_get isn't implemented for driver type");
    }
    ...
    const portmod_port_add_info_t * port_info)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_portmod_port_add)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_portmod_port_add(unit, port, port_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_portmod_port_add isn't implemented for driver type");
    }
