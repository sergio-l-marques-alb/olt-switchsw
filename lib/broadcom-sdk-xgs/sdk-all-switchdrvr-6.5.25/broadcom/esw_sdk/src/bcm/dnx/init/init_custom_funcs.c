    ...
    uint32 *entry_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get_dispatch(unit, DNX_FIELD_STAGE_ACE, &field_map_stage_info));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, field_map_stage_info.action_field_id, action_type, &hw_value));
