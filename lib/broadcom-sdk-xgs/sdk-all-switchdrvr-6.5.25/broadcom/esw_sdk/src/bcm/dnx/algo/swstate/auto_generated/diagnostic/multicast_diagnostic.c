...
/*
 *
 * dump function for the variable group_is_sar
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
multicast_db_group_is_sar_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "multicast group_is_sar") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate multicast group_is_sar\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "multicast_db/group_is_sar.txt",
            "multicast_db[%d]->","((multicast_sw_state_t*)sw_state_roots_array[%d][MULTICAST_MODULE_ID])->","group_is_sar: ");
...
/*
 *
 * dump function for the variable key_2_mcdb_id_hash
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
multicast_db_key_2_mcdb_id_hash_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "multicast key_2_mcdb_id_hash") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate multicast key_2_mcdb_id_hash\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "multicast_db/key_2_mcdb_id_hash.txt",
            "multicast_db[%d]->","((multicast_sw_state_t*)sw_state_roots_array[%d][MULTICAST_MODULE_ID])->","key_2_mcdb_id_hash: ");
...
const char* multicast_db_layout_str[MULTICAST_DB_INFO_NOF_ENTRIES] = {
    ...
    "MULTICAST_DB~GROUP_IS_SAR~",
    "MULTICAST_DB~KEY_2_MCDB_ID_HASH~",
};
