    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(ccu_cfg_rx_ptp_en_set(unit, CCU_RX_PTP_L2_UNI_EN, 1));
    SHR_IF_ERR_EXIT(ccu_cfg_tx_ccu_en_set(unit, CCU_TX_PTP_L2_UNI_EN, 1));
    ...
    int logical_phy_id)
{
    ...
    nof_instance = flexe_dbg_nof_instances_get(unit, speed);
    ...
    int *logical_phy_id)
{
    ...
    SHR_IF_ERR_EXIT(flexe_dbg_instance_id_to_logical_phy_id_get(unit, speed, instance_id, logical_phy_id));
exit:
    SHR_FUNC_EXIT;
}
