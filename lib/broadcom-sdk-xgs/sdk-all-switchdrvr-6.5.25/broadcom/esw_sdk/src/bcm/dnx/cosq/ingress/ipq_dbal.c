    ...
    uint32 voq_offset)
{
    ...
    /*
     * Feature tc_profile_from_tm_command won't be implemented 
     * Here we set all the entries to the same value
     */
    ...
    uint32 *voq_offset)
{
    ...
    /*
     * All the entries are the same this is why here we set the key to the first entry
     */
    if (dnx_data_ipq.queues.feature_get(unit, dnx_data_ipq_queues_tc_profile_from_tm_command))
    {
