...
static const dnx_field_action_name_t dnx_action_name[DNX_FIELD_ACTION_NOF] = {
    ...
    [DNX_FIELD_ACTION_ACE_STAT_LM_READ] = {"A_ACE_STAT_LM_READ"},
    ...
    dnx_field_map_action_info_t * dnx_action_info_p)
{
    ...
    switch (dnx_action_class)
    {
        ...
        case DNX_FIELD_ACTION_CLASS_SW:
        {
            ...
            dnx_action_info_p->field_id = sw_action_info.field_id;
...
shr_error_e
dnx_field_action_map_t_init(
    int unit,
    dnx_field_action_map_t * action_map_info_p)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_NULL_CHECK(action_map_info_p, _SHR_E_PARAM, "action_map_info_p");

    sal_memset(action_map_info_p, 0x0, sizeof(*action_map_info_p));

    action_map_info_p->dnx_action = DNX_FIELD_ACTION_ID_INVALID;
    action_map_info_p->flags = 0;
    action_map_info_p->conversion_cb = NULL;
    ...
    int *dnx_action_nof_p)
{
     ...
     */
    if ((dnx_action_list = sal_alloc(DNX_FIELD_ACTION_NOF * sizeof(dnx_field_action_t), "act_list")) == NULL)
    {
    ...
    int unit)
{
     ...
     */
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_field_map_sw_action_info_get_dispatch(unit, i_info, &sw_action_info));
            if (sw_action_info.field_id == DBAL_FIELD_EMPTY)
            {
