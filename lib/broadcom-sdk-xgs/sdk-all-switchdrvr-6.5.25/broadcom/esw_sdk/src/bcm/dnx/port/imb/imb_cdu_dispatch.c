...
const __imb__dispatch__t__ imb_imb_cdu_driver = {
    ...
    imb_ethu_port_pfc_force_enable_set,
    ...
    imb_ethu_pfc_mask_on_link_fail_enable_set,
    imb_ethu_port_fec_speed_validate,
    NULL,       /* imb_inband_ilkn_fc_init */
    NULL,       /* imb_calendar_set */
    NULL,       /* imb_port_fifo_resource_set */
    NULL,       /* imb_post_init */
    imb_ethu_instru_synced_counters_config_set,
    NULL,       /* imb_instru_sunced_counters_config_get */
    imb_ethu_instru_synced_counters_last_write_get,
    imb_ethu_instru_synced_counters_per_record_get,
    imb_ethu_instru_counters_reset,
    imb_ethu_instru_traffic_counters_reset,
    imb_ethu_port_instru_traffic_counters_reset,
    imb_ethu_instru_pfc_deadlock_counters_reset,
    imb_ethu_port_instru_pfc_deadlock_counters_reset,
    ...
    imb_cdu_portmod_soft_reset_lock,
    imb_cdu_portmod_soft_reset_unlock,
    NULL,       /* imb_port_link_fault_force_set */
    NULL,       /* imb_port_link_fault_force_get */
    NULL,       /* imb_fec_global_enable_set */
    imb_ethu_port_timesync_tx_info_get,
    imb_cdu_portmod_port_add,
};
