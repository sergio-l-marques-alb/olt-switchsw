...
typedef struct
{
    ...
    /*
     * old mep profile id, which is used in case of deleting old profile 
     */
    uint8 mep_profile_id_old;
    uint8 cluster_mep_profile;
    uint8 seamless_bfd;
    uint8 mpls_lm_dm;
    uint8 mpls_lm_dm_only_profile_write;
    uint8 cluster_profile_delete;
    /*
     * old cluster profile id, which is used in case of deleting old profile 
     */
    uint8 cluster_profile_id_old;
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_verify_params_after_mep_id_calc(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info);
/**
...
/**
 * \brief - Helper function find if the EP is also used for MPLS LM DM.
 *
 * \param [in] unit - Number of hardware unit used.
 * \param [in] endpoint - ID of BFD endpoint to retrieve
 * \param [out] is_mpls_lm_dm - return true if the EP is MPLS LM DM
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_get_endpoint_is_mpls_lm_dm_type(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_init_flags_profile(
    int unit);
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_init_diag_profile(
    int unit);
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_init_tx_rate_profile(
    int unit);
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_init_router_alert(
    int unit);

/**
 * \brief - This function get cluster info
 *
 * \param [in] unit - Number of hardware unit used.
 * \param [in] endpoint_id - ID of endpoint
 * \param [in] bfd_period_cluster - Tx period group.
 * \param [out] cluster_profile_exists - if Tx period group exists.
 * \param [out] cluster_period - bfd period of cluster.
 * \param [out] cluster_scan_rate - scan rate of cluster.
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_existing_cluster_info_get(
    int unit,
    int endpoint_id,
