...
/**
 * \brief - ReSet Rx scheduler in OFR
 *
 * \param [in] unit - chip unit id.
 * \param [in] ilkn_core_id - ilkn_core_id
 * \param [in] is_priority_high - is priority to be set to high
 * 0 => out-of-reset
 * 1 => in-reset
 *
 * \return
 ...
 *   * None
 */
int imb_ilu_internal_ofr_rx_low_high_priority_config(
    int unit,
    uint32 ilkn_core_id,
 ...
 *   * None
 */
int imb_ilu_port_nmg_sch_config_hw_init(
    int unit,
    uint32 ilkn_core_id);
 ...
 *   * None
 */
int imb_ilu_port_nmg_sch_config_hw_set(
    int unit,
    uint32 ilkn_core_id,
    uint32 ilkn_port_id,
 ...
 *   * None
 */
int imb_ilu_port_nmg_sch_config_hw_get(
    int unit,
    uint32 ilkn_core_id,
    uint32 ilkn_port_id,
...
/**
 * \brief - Enable queue for specified priority for specific port in OFR Scheduler
 *
 * see .h file
 */
int imb_ilu_internal_ofr_rx_sched_request_enable_set(
    int unit,
    uint32 ilkn_id,
...
/**
 * \brief - Configure the ILU port in the specified OFR Scheduler
 *
 * see .h file
 */
int imb_ilu_internal_ofr_rx_sched_request_enable_get(
    int unit,
    uint32 ilkn_id,
    dbal_enum_value_field_nif_sch_priority_e dbal_sch_prio,
    uint32 *is_enabled);
...
/**
 * \brief - ReSet Rx Scheduler ILKN counter in OFR
 *
 * \param [in] unit - chip unit id.
 * \param [in] ilkn_id - ilkn_id
 * \param [in] is_tdm - is port tdm or l1
 * \param [in] in_reset - is into reset or out of reset
 * 0 => out-of-reset
 * 1 => in-reset
 *
 * \return
 ...
 *   * None
 */
int imb_ilu_internal_ofr_rx_counter_reset_set(
    int unit,
    uint32 ilkn_id,
    int is_tdm,
    uint32 in_reset);
 ...
 *   * None
 */
int imb_ilu_internal_ofr_rx_is_high_priority_config_set(
    int unit,
    uint32 ilkn_id,
    uint32 is_priority_high);

/**
 * \brief - Check if the data queue of ILU port is high or low priority
 *
 * \param [in] unit - chip unit id.
 * \param [in] ilkn_id - ilkn_interface_id
 * \param [out] is_priority_high - value to set
 *
 * \return
 *   int - see _SHR_E*
 *
 ...
 *   * None
 */
int imb_ilu_internal_ofr_rx_is_high_priority_config_get(
    int unit,
    uint32 ilkn_id,
    uint32 *is_priority_high);
