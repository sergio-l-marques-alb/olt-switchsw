...
/** \file init_pp_common.c
 * $Id$
 *
 * Contain functinality that identical between device families
 */
/*
    ...
    int unit)
{
    ...
    /** Configure DBAL_TABLE_EGRESS_EXCLUDE_SOURCE according to all possible values for forwarding strength in order to enable exclude source filter */
