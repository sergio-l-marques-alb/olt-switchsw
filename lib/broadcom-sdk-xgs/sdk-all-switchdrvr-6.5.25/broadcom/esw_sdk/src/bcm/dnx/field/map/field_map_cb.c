    ...
    uint32 *dnx_data)
{
    ...
    dbal_enum_value_field_eth_qualifier_type_e dnx_l2_format;
    ...
    switch (bcm_l2_format)
    {
        case bcmFieldL2FormatEthII:
            dnx_l2_format = DBAL_ENUM_FVAL_ETH_QUALIFIER_TYPE_ETH2;
            break;
        case bcmFieldL2FormatSnap:
            dnx_l2_format = DBAL_ENUM_FVAL_ETH_QUALIFIER_TYPE_ETH1SNAP;
            break;
        case bcmFieldL2FormatLlc:
            dnx_l2_format = DBAL_ENUM_FVAL_ETH_QUALIFIER_TYPE_ETH1OSI;
            break;
        case bcmFieldL2FormatAny:
            dnx_l2_format = DBAL_ENUM_FVAL_ETH_QUALIFIER_TYPE_OTHER;
            break;
        default:
    ...
    *(dbal_enum_value_field_eth_qualifier_type_e *) dnx_data = dnx_l2_format;
    ...
    uint32 *dnx_data)
{
    ...
    dbal_enum_value_field_ipv6_additional_header_e dnx_additional_header;
    ...
    switch (bcm_additional_header)
    {
        case bcmFieldIp6AdditionalHeaderNotAvailable:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_NOT_AVAILABLE;
            break;
        case bcmFieldIp6AdditionalHeaderGre4:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_GRE4;
            break;
        case bcmFieldIp6AdditionalHeaderGre8:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_GRE8;
            break;
        case bcmFieldIp6AdditionalHeaderGre12:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_GRE12;
            break;
        case bcmFieldIp6AdditionalHeaderUdp:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_UDP;
            break;
        case bcmFieldIp6AdditionalHeaderL2tpv3:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_L2TPV3;
            break;
        case bcmFieldIp6AdditionalHeaderVxlan:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_VXLAN;
            break;
        case bcmFieldIp6AdditionalHeaderVxlanGpe:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_VXLAN_GPE;
            break;
        case bcmFieldIp6AdditionalHeaderEspUdp:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_ESP_UDP;
            break;
        case bcmFieldIp6AdditionalHeaderSrv6:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_SRV6;
            break;
        case bcmFieldIp6AdditionalHeaderSrv6Sl0:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_SRV6_SL_0;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionHopByHop:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_HOP_BY_HOP;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionFragment:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_FRAGMENT;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionEsp:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_ESP;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionAuth:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_AUTH;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionDestination:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_DO;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionMobility:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_MOBILITY;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionHostProtocol:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_HIP;
            break;
        case bcmFieldIp6AdditionalHeaderExtensionShim6:
            dnx_additional_header = DBAL_ENUM_FVAL_IPV6_ADDITIONAL_HEADER_IPV6_EH_SHIM6;
            break;
        default:
    ...
    *(dbal_enum_value_field_ipv6_additional_header_e *) dnx_data = dnx_additional_header;
    ...
    uint32 *dnx_data)
{
    ...
    switch (bcm_start_type_type)
    {
        ...
        case bcmFieldLayerTypeSrv6EndpointPsp:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_SRV6_ENDPOINT_PSP;
            break;
        case bcmFieldLayerTypeSrv6UspExtPsp:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_SRV6_RCH_USP_PSP_AND_PSP_EXT;
            break;
        ...
        case bcmFieldLayerTypeRch:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_RCH_EXTENDED_ENCAP;
            break;
        case bcmFieldLayerTypeEthEnd:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_DUMMY_ETHERNET;
            break;
        case bcmFieldLayerTypeMplsEnd:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_MPLS_DUMMY;
            break;
        case bcmFieldLayerTypeBierMpls:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_IN_BIER_BASE_EG_BIER_MPLS;
            break;
        case bcmFieldLayerTypeBierTi:
            dnx_layer_type = DBAL_ENUM_FVAL_PARSING_START_TYPE_ENCODING_BIER_NON_MPLS;
            break;
        default:
