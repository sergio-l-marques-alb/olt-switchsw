 ...
 */
shr_error_e
dnx_phantom_queues_dbal_global_prob_thresh_init(
    uint32 unit)
{
    uint32 entry_handle_id;
    uint32 max_thresh = 0;
    ...
    SHR_IF_ERR_EXIT(dbal_fields_predefine_value_get
                    (unit, entry_handle_id, DBAL_FIELD_PROB_THRESH, FALSE, DBAL_PREDEF_VAL_MAX_VALUE, &max_thresh));

    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PROB_THRESH, INST_SINGLE, max_thresh);
