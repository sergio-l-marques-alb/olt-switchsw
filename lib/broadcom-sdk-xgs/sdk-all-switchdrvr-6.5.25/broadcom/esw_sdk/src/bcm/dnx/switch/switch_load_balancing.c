...
/*
 * The Layer_Type_Mask when including terminated L2 into LB calcuation.
 */
#define SWITCH_LB_FORCE_L2_LAYER_TYPE_MASK  0
/*
 * The Layer_Qualifier when including terminated L2 into LB calcuation.
 */
#define SWITCH_LB_FORCE_L2_LAYER_QULIFIER   0
/*
 * The Layer_Qualifier_Mask when including terminated L2 into LB calcuation. Layer_Qualifier is ignored
 */
#define SWITCH_LB_FORCE_L2_LAYER_QULIFIER_MASK  0xffff
/*
 * The Access ID to Force LB Layer cam, only entry 0 is used currently
 */
...
/**
 * \brief
 *  set the PP port seed for the load balancing key generation.
 *   *
 *  \param [in] unit - Relevant unit.
 *  \param [in] pp_port  - pp_port
 *  \param [in] core_id  - core id
 *  \param [in] arg  - seed value
 * \return
 *   Error indication according to shr_error_e enum
 *
 * \remark
    ...
    dnx_switch_lb_mpls_identification_t * mpls_identification_p)
{
    ...
    /*
     * Set the array 32-bits field - 'MPLS_BIT_IDENTIFIER'
     */
    ...
    uint32 valid)
{
    ...
    /** Key field set, Result field set*/
    ...
    /** Perform entry action with access id */
