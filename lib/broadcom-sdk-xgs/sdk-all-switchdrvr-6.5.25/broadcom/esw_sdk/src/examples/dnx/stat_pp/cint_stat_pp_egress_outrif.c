/*
 * $Id: cint_stat_pp_egress_outrif.c,v 1.15 2018/05/28 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_egress_outrif.c Purpose: Statistics examples for SDK egress APIs using an IPV4 application.
 */
