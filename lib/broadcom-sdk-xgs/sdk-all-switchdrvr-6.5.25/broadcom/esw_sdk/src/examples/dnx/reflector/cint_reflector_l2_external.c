 ...
 *   * None
 */
bcm_field_group_t fg_id_for_l2_external_reflector =0;
bcm_field_group_t fg_id2_for_l2_external_reflector =0;
int g_reflector_id = 0;
    ...
    bcm_field_group_info_t * fg_info)
{
    ...
    rv = bcm_field_group_add(unit, 0, fg_info, pmf1_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_group_add failed - Map SSP to TRAP\n");
        return rv;
    }
    fg_id_for_l2_external_reflector = *pmf1_fg_id;
    ...
    fg_id2_for_l2_external_reflector = fg_id;
