 ...
 * Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_vswitch_vpls_gre.c  Purpose: Examples for VPLSoGRE.
 */
    ...
    int provider_port)
{
     ...
     * Configure fec entry 
     */
    rv = l3__egress_only_fec__create(unit, ac_port.encap_fec_id, 0, cint_ip_tunnel_basic_info.tunnel_if, pwe_port.port, mpls_tunnel_in_eei?BCM_L3_ENCAP_SPACE_OPTIMIZED:0,0);
    if (rv != BCM_E_NONE)
    {
