...
int vxlan_roo_mc_add_native_mc(int unit)
{
    ...
    rv = add_ipv6_ipmc(unit, g_vxlan_roo_mc.native_mc_dip6, g_vxlan_roo_mc.native_mc_dip6_mask, sip, sip,
                       0, cint_vxlan_roo_basic_info.access_eth_vrf, 0, 0, g_vxlan_roo_mc.native_ipmc, 0, 0);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_ipv6_ipmc(unit, g_vxlan_roo_mc.native_mc_dip6, g_vxlan_roo_mc.native_mc_dip6_mask, sip, sip,
                       0, cint_vxlan_roo_basic_info.core_overlay_eth_vrf, 0, 0, g_vxlan_roo_mc.native_ipmc, 0, 0);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in add_ipv6_ipmc\n");
        return rv;
...
int vxlan_roo_mc_add_overlay_mc(int unit, int is_leaf_node)
{
    ...
    rv = add_ipv6_ipmc(unit, g_vxlan_roo_mc.overlay_mc_dip6, g_vxlan_roo_mc.overlay_mc_dip6_mask, sip, sip,
                       0, cint_vxlan_roo_basic_info.core_overlay_eth_vrf, 0, 0, g_vxlan_roo_mc.overlay_ipmc, 0, 0);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in add_ipv6_ipmc\n");
        return rv;
    ...
    int provider_port2)
{
     ...
     */
    rv = vxlan_tunnel_terminator_create(unit, is_ipv6, &term_tunnel_id);
    if (rv != BCM_E_NONE)
    {
     ...
     */
    rv = vxlan_tunnel_initiator_create(unit, is_ipv6, cint_vxlan_roo_basic_info.core_overlay_arp_id, &(cint_vxlan_roo_basic_info.core_overlay_encap_tunnel_intf), &encap_tunnel_id);
    if (rv != BCM_E_NONE)
    {
