/*
 * $Id: cint_stat_pp_vpbr.c, Aleksandar Moraliev Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_vpbr.c Purpose: Statistics examples for SDK ingress APIs using an IPV4/6 VPBR application.
 */
