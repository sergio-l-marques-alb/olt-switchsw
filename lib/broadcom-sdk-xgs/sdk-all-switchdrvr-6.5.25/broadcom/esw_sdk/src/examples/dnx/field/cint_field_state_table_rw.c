...
bcm_field_entry_t cint_field_state_table_rw_entry_handle = BCM_FIELD_ID_INVALID;
...
*/
int field_state_table_rw_main(int unit, bcm_field_presel_t presel_id, bcm_field_layer_type_t fwd_layer, int core_id)
{
    ...
    int rv = BCM_E_NONE;
    if(!field_state_table_is_supported(unit))
    {
    ...
    rv = bcm_field_entry_add(unit, 0, cint_field_state_table_rw_fg_state_table_id, &entry_info, &cint_field_state_table_rw_entry_handle);
    if (rv != BCM_E_NONE)
    {
...
int field_state_table_rw_destroy(int unit, bcm_field_presel_t presel_id)
{
    ...
    rv = bcm_field_entry_delete(unit, cint_field_state_table_rw_fg_state_table_id, NULL, cint_field_state_table_rw_entry_handle);
    if (rv != BCM_E_NONE)
    {
