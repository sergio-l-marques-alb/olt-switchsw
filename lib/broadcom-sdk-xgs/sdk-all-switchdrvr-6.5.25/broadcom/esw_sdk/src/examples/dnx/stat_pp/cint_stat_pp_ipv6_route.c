/*
 * $Id: cint_stat_pp_ipv6_route.c,v 1.15 2018/09/13 12:47:34 Huili Zhang Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_ipv6_route.c Purpose: Statistics examples for SDK ingress APIs using an ipv6 application.
 */
    ...
    int out_port)
{
    ...
    if ((!sand_utils_is_jr2_system_header_mode(unit)) && (fec_3_statistics_config.pp_profile == 0)) {
