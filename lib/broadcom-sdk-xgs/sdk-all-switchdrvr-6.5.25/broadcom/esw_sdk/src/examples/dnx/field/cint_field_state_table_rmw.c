...
bcm_field_entry_t cint_field_state_table_rmw_entry_handle = BCM_FIELD_ID_INVALID;


int field_state_table_rmw_is_supported(int unit)
{
    int is_rmw_supported = *(dnxc_data_get(unit, "field", "features", "state_table_atomic_rmw", NULL));
    int is_st_supported = field_state_table_is_supported(unit);
    if(is_rmw_supported && is_st_supported)
    {
        return 1;
    }
    else
...
* \remark
*/
int field_state_table_rmw_main(int unit, bcm_field_presel_t presel_id, bcm_field_layer_type_t fwd_layer, int core_id)
{
    ...
    if(!field_state_table_rmw_is_supported(unit))
    {
        printf("State table feature not supported...\r\n");
    ...
    rv = bcm_field_entry_add(unit, 0, cint_field_state_table_rmw_fg_state_table_id, &entry_info, &cint_field_state_table_rmw_entry_handle);
    if (rv != BCM_E_NONE)
    {
...
int field_state_table_rmw_destroy(int unit, bcm_field_presel_t presel_id)
{
    ...
    rv = bcm_field_entry_delete(unit, cint_field_state_table_rmw_fg_state_table_id, NULL, cint_field_state_table_rmw_entry_handle);
    if (rv != BCM_E_NONE)
    {
