/*
 * $Id: cint_dnx_oam_eth_over_srv6.c, Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_oam_eth_over_srv6.c Purpose: basic examples of upmep injection enters Srv6 tunnel.
 */
    ...
    int nof_sids)
{
    ...
    BCM_FORWARD_ENCAP_ID_VAL_SET(gports.encap2, BCM_FORWARD_ENCAP_ID_TYPE_OUTLIF, BCM_FORWARD_ENCAP_ID_OUTLIF_USAGE_GENERAL, cint_srv6_tunnel_info.tunnel_arp_id[INGRESS]);
