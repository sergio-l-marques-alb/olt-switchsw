    ...
    crps_itm_config_database_t create_db)
{
    ...
    int command_id = 0;
    bcm_stat_counter_format_type_t format_type = bcmStatCounterFormatPackets;
    ...
    {
        rv = crps_itm_voq_data_base_create(unit, core_id, database_id, format_type, start_object_stat_id, end_object_stat_id, nof_engines, engine_id);
        if (rv != BCM_E_NONE)
        {
