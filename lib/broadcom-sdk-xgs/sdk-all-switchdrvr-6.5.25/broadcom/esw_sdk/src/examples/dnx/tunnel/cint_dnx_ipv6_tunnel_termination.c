 ...
 * $Id: cint_dnx_ipv6_tunnel_termination.c,v 1.00 Broadcom SDK $
 ...
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_ipv6_tunnel_termination.c Purpose: Various examples for IPv6 Tunnels.
 */
    ...
    int unit, int provider_port, int access_port)
{
    ...
    rv = ipv6_tunnel_termination_generic(unit, provider_port, access_port, 0, bcmIPv6TerminationForwardTypeIPv6, bcmTunnelTypeIpAnyIn6);
    if (rv != BCM_E_NONE)
    {
