/*
 * $Id: cint_vpls_statistics.c,v 1.15 2018/03/07 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_vpls_statistics.c Purpose: Statistic configuration for vpls (pwe port, pwe lif, ac).
 */
