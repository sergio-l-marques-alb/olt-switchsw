    ...
    bcm_field_context_t epmf_context_id)
{
    ...
    rv = cint_reflector_l3_internal_fp_create(unit, epmf_context_id, reflector_encap_id, rcy_encap_id,
    ...
    rv = cint_reflector_l3_internal_fp_entry_add(unit, fg_id, &fg_info, in_port, mapping_info.tm_port, tm_rcy_port, ace_entry_handle);
    if (rv != BCM_E_NONE)
    {
