/*
 * $Id: cint_dnx_vpls_gre.c,v 1.15 Broadcom SDK $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_vpls_gre.c Purpose: configure egress PWE pointing to GRE. 
 */
