...
int cint_field_evpn_ingress_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    */
    ...
    dnx_evpn_field_info.ing_fg.fg_info.action_with_valid_bit[act_idx] = feature_mpls_term_till_bos ? TRUE: FALSE;
    act_idx++;
...
int cint_field_evpn_egress_context_create(int unit, bcm_field_context_t *context_id_p)
{
    ...
    if (!*dnxc_data_get(unit, "flow", "mpls", "egress_flow_in_use", NULL)) {
