 ...
 *            copy ingress packet DSCP to outer VxLAN IP header.
 *
 * Usage    : BCM.0> cint ipv4_riot_AtoN_DscpPacket.c
 *
 * config   : config_td3_flex_riot.bcm
 *
 * Log file : ipv4_riot_AtoN_DscpPacket_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *   SMAC 00::22:22:22              |                      +--------------------+   |
 *            +---+          VLAN-10|                      |00::bb:bb           +---+
 *   Host(acc)|   +-----------------+      Trident-3       |DSCP:63           00::aa:aa
 *            +---+    ingress_port |                      |                  DSCP : 63
 *   DSCP : 63                      |                      |
 *                                  |                      |
 *                                  |                      |
 *                                  +----------------------+
...
data[0010]: 0800 45fc 0068 0000 0000 3f11 3e6a 0a0a
...
data[0070]: 0000 0000 0000 0000 0000 c947 4eab
*/
                    ...
                    bcm_gport_t net_flow_port, bcm_flow_handle_t flow_handle)
{
    ...
    tiinfo.ttl = 0x3f;
    tiinfo.dscp_sel = bcmTunnelDscpPacket;
