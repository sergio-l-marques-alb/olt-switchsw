...
/*
 * Feature  : FB6(56470) Vxlan Bridging , IPv4 network to access tunnel termination flow, add a new tag to the payload while egressing on access port
 *
 * Usage    : BCM.0> cint ipv4_NtoA_SDtag_Add.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : ipv4_NtoA_SDtag_Add_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
