...
/*
 * Feature  : TD3(56870) Vxlan Bridging , IPv4 access to network tunnel initiation Flow, delete sd tag in payload while egressing on network port
 *
 * Usage    : BCM.0> ipv4_AtoN_SDtag_Delete.c
 *
 * config   : BCM56275_A1-BRIDGE-FLEXFLOW.bcm 
 *
 * Log file : ipv4_AtoN_SDtag_Delete_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
