...
// Start with all free. TODO make it per unit variable.
...
uint32 ChunksBitmapAllocate(int unit, int WidthInBytes /* Always mult of 2 */)
{
    ...
    // TODO some lock mechanism start
    while( bmp )
    {
                        ...
                        uint8 *data /* IN */, uint8 *mask /* IN */)
{
    ...
    // TODO it should be replaced with the proper resolution type;
