 ...
 *                                  with distribution based on payload (inner) packet's L3 fields
 *
 * Usage    : BCM.0> cint vxlan_v4_net_to_acc_trunk_inner_l3.c
 *
 * config   : BCM56275_A1-BRIDGE-FLEXFLOW.bcm
 *
 * Log file : vxlan_v4_net_to_acc_trunk_inner_l3_log.txt
 *
 * Test Topology :
 *
...
Decap-case: packet sent from (network) to (access)
  ...
  ###[ IP ]###
                 version= 4
                 proto= udp
                    src= 2.2.2.1, 2.2.2.4, 2.2.2.5, 2.2.2.7, 2.2.2.20 <== 5 packets' only changing contents
                    dst= 1.1.1.1
  ###[ UDP ]###

Ingress Hex Packets (network):
======
tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=
...
Header Info
  ...
  ###[ IP ]###
        version= 4
        proto= udp
        src= 2.2.2.1, 2.2.2.4, 2.2.2.5, 2.2.2.7, 2.2.2.20 <== 5 packets' contents
        dst= 1.1.1.1
  ###[ UDP ]###
          sport= 53
          dport= 54
...
data[0060]: 7374 2345 9543 

Egress packet#2 -
data[0000]: {00000000bbbb} {00000000aaaa} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0204 0101 0101 0035 0035 003c 32f6 7465
data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0060]: 7374 9e56 45ad 

Egress packet#3 -
data[0000]: {00000000bbbb} {00000000aaaa} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0205 0101 0101 0035 0035 003c 32f6 7465
data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0060]: 7374 7804 af2d 
...
verify(int unit)
{
    ...
    snprintf(pkt_data[0],512,"%s","");

    snprintf(pkt_data[1],512,"%s","");

    snprintf(pkt_data[2],512,"%s","");

    snprintf(pkt_data[3],512,"%s","");

    snprintf(pkt_data[4],512,"%s","");
