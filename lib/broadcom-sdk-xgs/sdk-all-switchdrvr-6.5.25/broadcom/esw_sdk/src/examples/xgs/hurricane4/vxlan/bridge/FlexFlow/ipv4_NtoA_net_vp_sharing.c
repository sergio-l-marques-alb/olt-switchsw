...
/*
 * Feature  : Vxlan Bridging,IPv4 network to access tunnel termination flow on a shared network vp
 *
 * Usage    : BCM.0> cint ipv4_NtoA_net_vp_sharing.c
 *
 * config   : BCM56277_A1-PORT-FLEXFLOW.bcm
 *
 * Log file : ipv4_NtoA_net_vp_sharing_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 *                                  |                      |   VLAN-22        Underlay-NextHop
 *   SMAC 00::bb:bb                 |                      | ingress_port       +---+
 *   DMAC 00::aa:aa                 |                      +--------------------+   |
 *            +---+          VLAN-21|vfi     vnid          |00::22:22           +---+
 *   Host(acc)|   +-----------------+0x7010  0x12345       |                    00::02
 *            +---+    egress_port_1|                      |
 *                                  |                      |
 *                                  |      Hurricane-4     |
 *   SMAC 00::00:dd                 |                      |
...
Input Hex (network):
======


Output (access):
=======
Packet[2]: data[0000]: {00000000bbbb} {00000000aaaa} 8100 0015
Packet[2]: data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
Packet[2]: data[0020]: 0202 0101 0101 0035 0035 003c 32f6 7465
Packet[2]: data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
Packet[2]: data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
Packet[2]: data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
Packet[2]: data[0060]: 7374 48b4 da19

Input Hex (network):


Output (access):
Packet[4]: data[0000]: {0000000000dd} {00000000cccc} 8100 0017
Packet[4]: data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
Packet[4]: data[0020]: 0202 0101 0101 0035 0035 003c 32f6 7465
...
Packet[4]: data[0060]: 7374 5674 c657
*/
...
verify(int unit)
{
    ...
    snprintf(str, 1184, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");

    printf("\nSending known unicast packet to ingress_port network side:%d\n", ingress_port);
    snprintf(str, 1184, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");
...
config_vxlan_ipv4_vtep(int unit)
{
    ...
    rv = vxlan_system_config(unit, &vxlan_cfg_1);
    if (BCM_FAILURE(rv)) {
    ...
    /*create net_flow_port with vxlan_cfg_1*/
    rv = config_vxlan_network(unit, &vxlan_cfg_1, &vxlan_net, &net_flow_port, 0, flow_handle);
    if (BCM_FAILURE(rv)) {
        printf("\nError in network config: %s.\n", bcm_errmsg(rv));
        return rv;
    }
    /*create net_flow_port with vxlan_cfg_2*/
    rv = config_vxlan_network(unit, &vxlan_cfg_2, &vxlan_net, &net_flow_port, 1, flow_handle);
    if (BCM_FAILURE(rv)) {
        printf("\nError in network config: %s.\n", bcm_errmsg(rv));
        return rv;
    }

    rv = config_vxlan_tunnel(unit, &vxlan_cfg_1, &vxlan_net, net_flow_port, flow_handle);
    if (BCM_FAILURE(rv)) {
    ...
    rv = add_to_l2_table(unit, "00:00:00:00:bb:bb", vxlan_cfg_1.vxlan_vpn, acc_flow_port_1);
    if (BCM_FAILURE(rv)) {
    ...
    rv = add_to_l2_table(unit, "00:00:00:00:00:dd", vxlan_cfg_2.vxlan_vpn, acc_flow_port_2);
    if (BCM_FAILURE(rv)) {
        printf("\nError in l2 entry config: %s.\n", bcm_errmsg(rv));
        return rv;
    }
