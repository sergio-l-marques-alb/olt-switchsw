...
/*
 * Feature  : FB6(56470) Vxlan Bridging , IPv4 access to network tunnel initiation Flow with outer/inner vlan as a flow match criteria(BCM_FLOW_MATCH_CRITERIA_PORT_VLAN_STACKED)
 *
