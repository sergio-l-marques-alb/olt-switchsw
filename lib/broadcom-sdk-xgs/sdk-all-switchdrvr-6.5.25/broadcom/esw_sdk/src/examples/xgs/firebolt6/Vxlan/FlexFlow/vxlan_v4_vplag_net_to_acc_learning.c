...
/*
 * Feature  : Vxlan Bridging , IPv4 network to access VP LAG (LAG of virtual access ports) unicast Flow - L2 learning on VPLAG
 *
 * Usage    : BCM.0> cint vxlan_v4_vplag_net_to_acc_learning.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : vxlan_v4_vplag_net_to_acc_learning_log.txt
 *
 * Test Topology :
 *                             NETWORK       +---------------------++       ACCESS
 *        Underlay+NextHop                  +                      |
 *                    +---+          VLAN=22|                      |
 *    Payload         |   +-----------------+                      |
 *    MAC = 00::aa:a1 +---+  ingress_port[0]|                      |
 *                                          |                      |
 *                                          |                      |
 *                    +---+                 |                      |
 *    Payload         |   +-----------------+                      |
 *    MAC = 00::aa:a2 +---+  ingress_port[1]|                      |  VLAN=21                      +---+
 *                                          |                      +-------------------------------+   | Host(acc)
 *                                          |     Firebolt-6       |egress_port                    +---+
 *                    +---+                 |                      |                            MAC 00::bb:bb
 *    Payload         |   +-----------------+                      |
 *    MAC = 00::aa:a3 +---+  ingress_port[2]|                      |
 *                                          |                      |
 *                                          |                      |
 *                    +---+                 |                      |
 *    Payload         |   +-----------------+                      |
 *    MAC = 00::aa:a4 +---+  ingress_port[3]|                      |
 *                                          |                      |
 *                                          |                      |
 *                    +---+                 |                      |
 *    Payload         |   +-----------------+                      |
 *    MAC = 00::aa:a5 +---+  ingress_port[4]+----------------------+
 *
 *                           VPLAG
 *
 * Summary:
...
NETWORK-TO-ACCESS:-
Decap-case: packets sent from ingress_port(network) to egress_port(access)

Ingress Packets: (No. of packets = 5)
======

  ###[ Ethernet ]###
    dst= 00:00:00:00:22:22, 00:00:00:00:22:23, 00:00:00:00:22:24, 00:00:00:00:22:25, 00:00:00:00:22:26
    src= 00:00:00:00:00:02, 00:00:00:00:00:03, 00:00:00:00:00:04, 00:00:00:00:00:05, 00:00:00:00:00:06
    type= 0x8100
  ###[ 802.1Q ]###
     vlan= 22
     type= 0x800
  ...
  ###[ Ethernet ]###
                 ...
                 src= 00:00:00:00:aa:a2, 00:00:00:00:aa:a3, 00:00:00:00:aa:a4, 00:00:00:00:aa:a5, 00:00:00:00:aa:a6
                 type= 0x800
  ###[ IP ]###
                 version= 4
                 proto= udp
                    src= 2.2.2.1, 2.2.2.2, 2.2.2.6, 2.2.2.7, 2.2.2.20
                    dst= 1.1.1.1
  ###[ UDP ]###

Ingress Hex Packets (network):
======
tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=
...
Egress packet#1 -
data[0000]: {00000000bbbb} {00000000aaa2} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0201 0101 0101 0035 0035 003c 32f6 7465
...
data[0060]: 7374 44b5 2b2c

Egress packet#2 -
data[0000]: {00000000bbbb} {00000000aaa3} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0202 0101 0101 0035 0035 003c 32f6 7465
data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0060]: 7374 5b78 99db

Egress packet#3 -
data[0000]: {00000000bbbb} {00000000aaa4} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0206 0101 0101 0035 0035 003c 32f6 7465
data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0060]: 7374 ce80 b242

Egress packet#4 -
data[0000]: {00000000bbbb} {00000000aaa5} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0207 0101 0101 0035 0035 003c 32f6 7465
data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0060]: 7374 5cee a56f

Egress packet#5 -
data[0000]: {00000000bbbb} {00000000aaa6} 8100 0015
data[0010]: 0800 4500 0050 0001 0000 4011 7497 0202
data[0020]: 0214 0101 0101 0035 0035 003c 32f6 7465
data[0030]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0040]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0050]: 7374 7465 7374 7465 7374 7465 7374 7465
data[0060]: 7374 c75e 047b
*/
...
bcm_port_t ingress_port[NO_OF_VPLAG_MEMBERS];
bcm_port_t egress_port;
bcm_gport_t ingress_phy_gport[NO_OF_VPLAG_MEMBERS];
...
struct rtag7_cfg_t {
    ...
    int block_n_offset_a;           /*Block (A0 or A1) and offset to be used for VP LAG*/
    ...
    int block_n_offset_b;           /*Block (B0 or B1) and offset to be used for VP LAG*/
 ...
 */
    bcm_error_t
multi_ingress_port_setup(int unit, bcm_port_t *port)
{
    bcm_field_qset_t qset;
    bcm_field_group_t group;
    bcm_field_entry_t entry;
    ...
    for(i=0; i<NO_OF_VPLAG_MEMBERS; i++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, port[i], BCM_PORT_DISCARD_NONE));
    }
    BCM_FIELD_QSET_INIT(qset);
    BCM_FIELD_QSET_ADD(qset, bcmFieldQualifyInPort);
...
test_setup(int unit)
{
    ...
    egress_port = port_list[NO_OF_VPLAG_MEMBERS];

    for(i=0; i < NO_OF_VPLAG_MEMBERS; i++)
    {
        if (BCM_E_NONE !=bcm_port_gport_get(unit, ingress_port[i], &(ingress_phy_gport[i]))){
    ...
    if (BCM_E_NONE != multi_ingress_port_setup(unit, ingress_port)) {
...
verify(int unit)
{
    ...
    snprintf(pkt_data[0],512,"%s","");

    snprintf(pkt_data[1],512,"%s","");

    snprintf(pkt_data[2],512,"%s","");

    snprintf(pkt_data[3],512,"%s","");

    snprintf(pkt_data[4],512,"%s","");
    ...
    for(i=0; i<sizeof(pkt_data)/512; i++)
    {
        ...
        snprintf(str, 512, "tx 1 pbm=%d data=0x%s; sleep quiet 1", ingress_port[i],pkt_data[i]);
        bshell(unit, str);
        bshell(unit, "show c");
    }
...
config_vxlan_network(int unit, vxlan_cfg_t *vxlan_cfg, vxlan_net_cfg_t *vxlan_net, bcm_gport_t *net_flow_port, bcm_flow_handle_t flow_handle)
{
    ...
    /*end:sdtag*/
    rv = bcm_flow_encap_get(unit,&einfo,0,NULL);
...
config_rtag7(int unit,rtag7_cfg_t *rtag7_cfg)
{
    ...
    if(rtag7_cfg->block_select == 1) /*Execute B block related settings*/
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_switch_control_set(unit, bcmSwitchECMPVxlanHashOffset,rtag7_cfg->block_n_offset_b));
...
config_vxlan_ipv4_vtep(int unit)
{
    ...
    rtag7_cfg_t rtag7_cfg = {
        ...
        0,              /*VxLAN Inner/Outer select. 0='Inner', 1='Outer'*/
    ...
    vxlan_net_cfg_t vxlan_net[NO_OF_VPLAG_MEMBERS] = { /*Parameters of all Network ports that port VPLAG */
        {
            ingress_phy_gport[0], /* Egress port */
            22, /* vlan */
        ...
        {
            ingress_phy_gport[1], /* Egress port */
            22, /* vlan */
        ...
        {
            ingress_phy_gport[2], /* Egress port */
            22, /* vlan */
        ...
        {
            ingress_phy_gport[3], /* Egress port */
            22, /* vlan */
        ...
        {
            ingress_phy_gport[4], /* Egress port */
            22, /* vlan */
    ...
    printf("Network-to-Access: Add payload-dest-mac Address => Network-VPLAG.\n");
