...
/*
 * Feature  : TD3(56870) Vxlan Bridging ,  Network to access  known & unknown multicast Flow
 *
 *
 * Usage    : BCM.0> cint ipv6_NtoA_MC.c
 *
 * config   : config_td3_flex.bcm
 *
 * Log file : ipv6_NtoA_MC_log.txt
 * TODO
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 * Cint example to demonstrate VxLAN Bridging configuration for Multicast ingressing on V6 tunnel Network port
...
packet sent from ingress_port(network) to multiple egress port(access)
...
Ingress Hex Packet:
tx 1 pbm=1 data=
747465737474657374746573747465737474657374
...
Packet Dump
data[0000]: {01005e010101} {00000000cccc} 8100 0015
...
verify(int unit)
{
	...
	snprintf(str, 512, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
	bshell(unit, str);
	bshell(unit, "show c");
	/* dump l2 table to see if SA learned againt SVP */
	bshell(unit, "l2 show");
	printf("\nSending unknown multicast packet to ingress_port network side:%d\n", ingress_port);
	snprintf(str, 512, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
	bshell(unit, str);
	bshell(unit, "show c");
	/* dump l2 table to see if SA learned againt SVP */
	bshell(unit, "l2 show");
