...
verify(int unit)
{
    ...
    if(value != PHY_ID_MSB_REG_VAL) {
        printf("C45 port register read did not return expected val, exiting\n");
    ...
    printf("dev_addr:%x, reg_addr:%x, value:%x\n\n", dev_addr, reg_addr, value);
    if(value != PHY_ID_MSB_REG_VAL) {
        printf("C45 mdio addr register read did not return expected val, exiting\n");
        printf("value:%x, expected value:%x\n", value, PHY_ID_MSB_REG_VAL);
        return rv;
    }
    ...
    if(value != DIS_REMOTE_FAULT_BIT) {
        printf("C45 port register write/read did not return expected val, exiting\n");
        printf("value:%x, expected value:%x\n", value, DIS_REMOTE_FAULT_BIT);
        return rv;
    }
    ...
    printf("dev_addr:%x, reg_addr:%x, value:%x\n\n", dev_addr, reg_addr, value);
    if(value != DIS_REMOTE_FAULT_BIT) {
        printf("C45 mdio addr register write/read did not return expected val, exiting\n");
        printf("value:%x, expected value:%x\n", value, DIS_REMOTE_FAULT_BIT);
        return rv;
    }
    ...
    if(value != PHY_ID_MSB_REG_VAL) {
        printf("C22 port register read did not return expected val, exiting\n");
        printf("value:%x, expected value:%x\n", value, PHY_ID_MSB_REG_VAL);
        return rv;
    }
    ...
    printf("reg_addr:%x, value:%x\n\n", reg_addr, value);
    if(value != PHY_ID_MSB_REG_VAL) {
        printf("C22 BCM_PORT_PHY_INTERNAL read did not return expected val, exiting\n");
        printf("value:%x, expected value:%x\n", value, PHY_ID_MSB_REG_VAL);
        return rv;
    }
