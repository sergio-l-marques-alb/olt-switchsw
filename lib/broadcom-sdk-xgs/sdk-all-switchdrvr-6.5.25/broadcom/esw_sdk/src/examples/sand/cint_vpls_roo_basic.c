/*
 * $Id: cint_vpls_mp_basic.c, Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_vpls_mp_basic.c Purpose: basic example for VPLS. 
 */
    ...
    int core_port)
{
    ...
    if (is_device_or_above(unit, JERICHO2))
    {
        ...
        cint_vpls_roo_basic_info.core_native_fec_id += 10;
    ...
    int core_port)
{
    ...
    if (is_device_or_above(unit, JERICHO2))
    {
         ...
         * Set In-Port vmpi
         */
        rv = bcm_port_class_set(unit,core_port,bcmPortClassMplsForwardIngress,cint_vpls_roo_basic_info.vmpi);
        if (rv != BCM_E_NONE)
        {
