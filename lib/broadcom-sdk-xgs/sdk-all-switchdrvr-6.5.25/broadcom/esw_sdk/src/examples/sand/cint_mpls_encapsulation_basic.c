/*
 * $Id: cint_mpls_basic.c,v 1.15 Broadcom SDK $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_mpls_encapsulation_basic.c Purpose: Various examples for MPLS/VPLS.
 */
    ...
    int unit)
{
    ...
    if (is_device_or_above(unit, JERICHO2)) 
    {
         ...
         * Set In-Port vmpi
         */
        rv = bcm_port_class_set(unit,cint_mpls_encapsulation_basic_info.in_port,bcmPortClassMplsForwardIngress,cint_mpls_encapsulation_basic_info.vmpi);;
        if (rv != BCM_E_NONE)
        {
