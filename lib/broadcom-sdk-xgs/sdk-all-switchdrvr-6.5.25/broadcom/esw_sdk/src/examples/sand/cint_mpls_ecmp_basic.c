/*
 * $Id: cint_mpls_ecmp_basic.c,v 1.15 2017/07/03 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2021 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_mpls_ecmp_basic.c Purpose: Various examples for MPLS.
 */
   ...
   int out_port)
{
     ...
     */
    rc = l3__ecmp_create(unit, cint_mpls_ecmp_basic_info.ecmp_intf, MEMBERS_IN_ECMP_GROUP, cint_mpls_ecmp_basic_info.fec_ids, BCM_L3_WITH_ID, BCM_L3_ECMP_DYNAMIC_MODE_DISABLED,&ecmp,0);
    if (rc != BCM_E_NONE)
    {
