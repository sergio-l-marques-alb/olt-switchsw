...
/* $Id: cint_sand_multi_device_vxlan_roo.c,v 1.0 2018/05/16 08:05:38 Jingli Guo $
...
int multi_dev_vxlan_roo_vxlan_port_add(
    int unit,
    int core_port,
    int tunnel_term_id,
    bcm_gport_t *vxlan_port_id)
{
    ...
    vxlan_port_add.vpn = cint_vxlan_roo_info.vpn_id;
    vxlan_port_add.in_port = core_port;
    vxlan_port_add.in_tunnel = tunnel_term_id;
    BCM_L3_ITF_SET(vxlan_port_add.egress_if, BCM_L3_ITF_TYPE_FEC, cint_vxlan_roo_info.core_overlay_fec_id); 
    vxlan_port_add.flags = 0;
    vxlan_port_add.network_group_id = cint_vxlan_roo_info.vxlan_network_group_id;
    vxlan_port_add.out_tunnel_if = cint_vxlan_roo_info.core_overlay_encap_tunnel_intf;
    ...
    int access_side_sys_port)
{
     ...
     *    So call this first.
     */
    rv = sand_utils_vxlan_open_vpn(core_side_unit, cint_vxlan_roo_info.vpn_id, 0, cint_vxlan_roo_info.vni);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, sand_utils_vxlan_open_vpn, vpn=%d, \n", proc_name, cint_vxlan_roo_info.vpn_id);
        return rv;
    }
    ...
    int access_side_sys_port)
{
     ...
     */
    rv = multi_dev_vxlan_roo_vxlan_port_add(core_side_unit, core_side_sys_port, cint_vxlan_roo_info.vxlan_tunnel_if, &vxlan_port_id);
    if (rv != BCM_E_NONE) 
    {
