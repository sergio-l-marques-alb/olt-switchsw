...
int port_gpon_config(int unit, bcm_port_t port_gpon, uint8 num_gpon_channels)
{
    ...
    if (ptc_size > 5) {
        total_gpon_channels = 2;
    }
    printf("Entering port_gpon_config: port_gpon %d num_gpon_channels %d\n", port_gpon, num_gpon_channels);
    
    if (num_gpon_channels > total_gpon_channels) {
        printf("\nThe number of channels must be <= %d\n", total_gpon_channels);
        return BCM_E_PARAM;
    }
    ...
    for (channel = 0; channel < num_gpon_channels; channel++) {
        ...
        if (channel != 3) {
            ...
            bcm_vlan_control_port_set(unit, gpon_pp_port[channel], bcmVlanPortIgnoreInnerPktTag, 1);
        }
...
int gpon_service_init(int unit, bcm_port_t port_pon, int num_channels, bcm_port_t port_nni)
{
    ...
    gpon_1_1_service_info[index].tunnel_id  = 1000;
    ...
    /* PON Port 5 Tunnel-ID 1001 CVLAN 30 <-CrossConnect-> NNI Port 129 CVLAN 300*/
    index++;
    gpon_1_1_service_info[index].gpon_pp_port = gpon_pp_port[1];
    gpon_1_1_service_info[index].nni_port = port_nni;
    gpon_1_1_service_info[index].service_mode = otag_to_otag2;
    gpon_1_1_service_info[index].tunnel_id  = 1001;
    gpon_1_1_service_info[index].up_lif_type = match_otag;
    gpon_1_1_service_info[index].up_ovlan   = 30;
    gpon_1_1_service_info[index].down_lif_type = match_otag;
    gpon_1_1_service_info[index].down_ovlan = 300;

    /* PON Port 5 Tunnel-ID 1002 CVLAN 40 CVLAN 41 <-CrossConnect-> NNI Port 129 SVLAN 400 CVLAN 410*/
    index++;
    gpon_1_1_service_info[index].gpon_pp_port = gpon_pp_port[2];
    gpon_1_1_service_info[index].nni_port = port_nni;
    gpon_1_1_service_info[index].service_mode = o_i_tag_to_o2_i2_tag;
    gpon_1_1_service_info[index].tunnel_id  = 1002;
    ...
    /* PON Port 5 Tunnel-ID 1003 CVLAN 50 <-CrossConnect-> NNI Port 129 SVLAN 500*/
    index++;
    gpon_1_1_service_info[index].gpon_pp_port = gpon_pp_port[3];
    gpon_1_1_service_info[index].nni_port = port_nni;
    gpon_1_1_service_info[index].service_mode = o_i_tag_to_o2_i_tag;
    gpon_1_1_service_info[index].tunnel_id  = 1003;
    gpon_1_1_service_info[index].up_lif_type = match_otag;
    gpon_1_1_service_info[index].up_ovlan   = 50;
    gpon_1_1_service_info[index].down_lif_type = match_otag;
    gpon_1_1_service_info[index].down_ovlan = 500;

    /* PON Port 5 Tunnel-ID 1003 CVLAN 50 CVLAN 51 <-CrossConnect-> NNI Port 129 SVLAN 500 CVLAN 510*/
    index++;
    gpon_1_1_service_info[index].gpon_pp_port = gpon_pp_port[3];
    gpon_1_1_service_info[index].nni_port = port_nni;
    gpon_1_1_service_info[index].service_mode = o_i_tag_to_o2_i2_tag;
    ...
    gpon_1_1_service_info[index].up_lif_type = match_t_o_i_tag;
    gpon_1_1_service_info[index].up_ovlan   = 50;
    gpon_1_1_service_info[index].up_ivlan   = 51;
    gpon_1_1_service_info[index].down_lif_type = match_o_i_tag;
    gpon_1_1_service_info[index].down_ovlan = 500;
    gpon_1_1_service_info[index].down_ivlan = 510;    
