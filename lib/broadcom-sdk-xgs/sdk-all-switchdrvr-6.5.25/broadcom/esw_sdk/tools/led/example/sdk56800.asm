;
; $Id: sdk56800.asm,v 1.9 Broadcom SDK $
;
; $Copyright: (c) 2021 Broadcom.
; Broadcom Proprietary and Confidential. All rights reserved.$
; 
;
; This is the default program for the (20 port) BCM56800 SDKs.
; To start it, use the following commands from BCM:
;
;       led load sdk56800.hex
;       led auto on
;       led start
;
...
; 56800_a0 when the port is in XAUI mode. The counter DMA task reports the
; activities of Higig/Xe ports in bit 1-3 of RAM byte (0x94 + portnum). Bit 
; 1 indicates that the link activity is high. Bit 2 indicates that the link 
; activity is medium. Bit 3 indicates that the link activity is low. If all 
; three bits are clear, the link activity is either very low or no activity
; at all.  See counter DMA task in $SDK/src/soc/counter.c
;
...
;       Amber: activity high (blinking interval at ~1/8 sec)
;       Amber: activity medium (blinking interval at ~1/4 sec)
;       Amber: activity low (blinking interval at ~1/2 sec)
;
