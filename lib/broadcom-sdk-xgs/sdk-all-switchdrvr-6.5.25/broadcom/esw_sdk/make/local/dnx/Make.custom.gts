FEATURE_LIST := CINT CPU_I2C MEM_SCAN EDITLINE BCM_SAL_PROFILE CUSTOMER TEST INTR APIMODE CTEST
...
# {
    ...
    CFLAGS += -O1
    LINK_STATIC := 0
    EXTRA_USER_CFLAGS += -fsanitize=memory -fPIE -fno-omit-frame-pointer -fno-optimize-sibling-calls -fsanitize-memory-track-origins -fsanitize-memory-use-after-dtor
    EXTRA_USER_LDFLAGS += -fsanitize=memory -fPIE -pie -fno-omit-frame-pointer -fno-optimize-sibling-calls -fsanitize-memory-track-origins -fsanitize-memory-use-after-dtor
# }
endif
  #
