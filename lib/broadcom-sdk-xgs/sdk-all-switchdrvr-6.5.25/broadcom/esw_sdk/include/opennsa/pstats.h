...
typedef enum bcm_pstats_session_element_type_e {
    bcmPStatsSessionDevice = 0,         /* PSTATS session element type for
                                           device level tracking counter */
    bcmPStatsSessionUnicastQueue = 1,   /* PSTATS session element type for
                                           unicast queue */
    bcmPStatsSessionIngPool = 2,        /* Per ingress pool PSTATS session
                                           element type */
    bcmPStatsSessionEgrPool = 3,        /* Per egress pool PSTATS session
                                           element type */
    bcmPStatsSessionMulticastQueue = 4, /* PSTATS session element type for
                                           multicast queue */
    bcmPStatsSessionEgrMulticastPool = 5, /* Per egress pool PSTATS session
                                           element type for multicast */
    bcmPStatsSessionIngPortPool = 6,    /* Per ingress port pool PSTATS session
                                           element type */
    bcmPStatsSessionPriGroupShared = 7, /* Per shared priority group PSTATS
                                           session element type */
    bcmPStatsSessionPriGroupHeadroom = 8, /* Per priority group headroom PSTATS
                                           session element type */
    bcmPStatsSessionHeadroomPool = 9,   /* PSTATS session element type for
                                           headroom pool usage count */
    bcmPStatsSessionEgrPortPoolSharedUnicast = 10, /* Per port pool unicast PSTATS session
                                           element type */
    bcmPStatsSessionEgrPortPoolSharedMulticast = 11, /* Per port pool multicast PSTATS
                                           Session element type */
    bcmPStatsSessionRqeQueue = 12,      /* PSTATS session element type for RQE
                                           queue */
    bcmPStatsSessionRqePool = 13,       /* PSTATS session element type for RQE
                                           pool */
    bcmPStatsSessionTypeCount = 14      /* Max value defined for this enum */
