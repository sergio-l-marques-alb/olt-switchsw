...
typedef enum bcm_flow_match_criteria_e {
    ...
    BCM_FLOW_MATCH_CRITERIA_SIP_DIP = 15, /* Match source and destination IP
                                           addresses */
    BCM_FLOW_MATCH_CRITERIA_COUNT = 16  /* Must be last. */
...
#define BCM_FLOW_TERMINATOR_ELEMENT_VSI_VALID (1 << 10)  
#define BCM_FLOW_TERMINATOR_ELEMENT_L2_INGRESS_INFO_VALID (1 << 11)  
#define BCM_FLOW_TERMINATOR_ELEMENT_FAILOVER_ID_VALID (1 << 12)  
#define BCM_FLOW_TERMINATOR_ELEMENT_FAILOVER_STATE_VALID (1 << 13)  
#define BCM_FLOW_TERMINATOR_ELEMENT_CLASS_ID_VALID (1 << 14)  
#define BCM_FLOW_TERMINATOR_ELEMENT_FIELD_CLASS_ID_VALID (1 << 15)  
#define BCM_FLOW_TERMINATOR_ELEMENT_L2_LEARN_INFO_VALID (1 << 16)  
#define BCM_FLOW_TERMINATOR_ELEMENT_LEARN_ENABLE_VALID (1 << 17)  
#define BCM_FLOW_TERMINATOR_ELEMENT_TPID_CLASS_ID_VALID (1 << 18)  
#endif
...
#define BCM_FLOW_INITIATOR_ELEMENT_DSCP_VALID (1 << 8)   
#define BCM_FLOW_INITIATOR_ELEMENT_TTL_VALID (1 << 9)   
#define BCM_FLOW_INITIATOR_ELEMENT_EXP_VALID (1 << 10)  
#define BCM_FLOW_INITIATOR_ELEMENT_PKT_PRI_CFI_VALID (1 << 11)  
#define BCM_FLOW_INITIATOR_ELEMENT_L2_EGRESS_INFO_VALID (1 << 12)  
#define BCM_FLOW_INITIATOR_ELEMENT_FAILOVER_ID_VALID (1 << 13)  
#define BCM_FLOW_INITIATOR_ELEMENT_FAILOVER_STATE_VALID (1 << 14)  
#define BCM_FLOW_INITIATOR_ELEMENT_TPID_CLASS_ID_VALID (1 << 15)  
#endif

#if defined(INCLUDE_L3)
/* Flow Termination info elements (for valid, clear bitmaps). */
#define BCM_FLOW_TERMINATOR_INFO_BUD_VALID  (1 << 0)   
#endif

/* L2 learn info flags. */
#define BCM_FLOW_L2_LEARN_INFO_NOT_OPTIMIZED (1 << 0)   /* Select a Non-Optimized
...
typedef enum bcm_flow_failover_state_e {
    bcmbcmFlowFailoverStatePrimary = 0, 
    bcmbcmFlowFailoverStateSecondary = 1, 
    bcmbcmFlowFailoverStateCount = 2 
