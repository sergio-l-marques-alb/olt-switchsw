...
#define BCM_POLICER_LARGE_BUCKET_MODE       0x00200000 /*  if set, force policer
                                                          to use large bucket
                                                          mode */
#define BCM_POLICER_WITH_SHARED_POOL_ID     0x00400000 /* Indicates that this
                                                          Policer needs to be
                                                          allocated from the
                                                          given shared meter
                                                          pool id. */
...
typedef enum bcm_policer_pool_num_e {
    ...
    bcmPolicerPoolAny = 4,  /* Any Policer pool. */
    bcmPolicerPoolCount = 5 /* Always Last. Not a usable value. */
...
#define BCM_POLICER_PKT_LEN_INGRESS     0x00000001 
#define BCM_POLICER_PKT_LEN_EGRESS      0x00000002 
#define BCM_POLICER_PKT_LEN_TRUNCATE    0x00000004 
#define BCM_POLICER_PKT_LEN_ADD         0x00000008 
