...
#define PTP_SDK_VERSION   PTP_SDK_BASE_VERSION         | \
                            ...
                            (ENABLE  << PTP_SYNC_DRESP_RECEIPT_TO) |\
                            (ENABLE  << PTP_REMOTE_PORT_NUMBER)
...
#define PTP_SYNC_DRESP_RECEIPT_TO           10 /* Support for configurable timeouts for sync and DR*/
#define PTP_REMOTE_PORT_NUMBER              11 /* Support for Remote Port number */
