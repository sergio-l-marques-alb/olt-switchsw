...
#define BCM_IPMC_WB_VERSION_1_0     SOC_SCACHE_VERSION(1,0)
#define BCM_IPMC_WB_VERSION_1_1     SOC_SCACHE_VERSION(1,1)
#define BCM_IPMC_WB_VERSION_1_2     SOC_SCACHE_VERSION(1,2)
#define BCM_IPMC_WB_VERSION_1_3     SOC_SCACHE_VERSION(1,3)
#define BCM_IPMC_WB_VERSION_1_4     SOC_SCACHE_VERSION(1,4)
#define BCM_IPMC_WB_VERSION_1_5     SOC_SCACHE_VERSION(1,5)
#define BCM_IPMC_WB_VERSION_1_6     SOC_SCACHE_VERSION(1,6)
#define BCM_IPMC_WB_VERSION_1_7     SOC_SCACHE_VERSION(1,7)
#define BCM_IPMC_WB_DEFAULT_VERSION BCM_IPMC_WB_VERSION_1_7
#endif
...
typedef struct _bcm_esw_ipmc_l3entry_info_s
{
    ...
    int    age_notified;        /*
                                 * 1: aged out event sent.
                                 * 0: aged out event not sent or canceled.
                                 */
...
typedef struct _bcm_esw_ipmc_s
{
    ...
    bcm_ipmc_age_cb_t ipmc_age_cb;
    void              *ipmc_age_cb_data;
    sal_sem_t         ipmc_age_sync;
    char              ipmc_age_name[20]; /* IPMC aging task name */
    VOL sal_thread_t  ipmc_age_pid; /* IPMC aging thread ID */
    VOL sal_usecs_t   ipmc_age_interval; /* interval between aging passes */
} _bcm_esw_ipmc_t;
...
/* Max value is 2147 sec. sem_take() takes usec
 * integer vlaue. Max integer vlaue that can be adjusted in 31 bit is
 * 0x7FFFFFFF which approximates to (2147 * 1000000) usec.
 */
#define _IPMC_MAX_AGE_INTERVAL  (2147)
#define _USEC_IN_ONESEC    (1000000)
