...
/*! Data is not present at boundary. Valid when ALU is used
 *  to track data
 */
#define BCMI_FT_ALU_LOAD_DATA_AT_SHIFT_BITS               (1 << 8)
/*************************************************************
...
typedef struct bcmi_ft_alu_hash_info_s {
    ...
    /* Source timestamp */
    bcm_flowtracker_timestamp_source_t src_ts;
...
#if defined(BCM_FLOWTRACKER_V3_SUPPORT)
extern int
bcmi_ftv3_alu_load_mem_config_init(int unit, bcm_flowtracker_cfg_t *cfg);
