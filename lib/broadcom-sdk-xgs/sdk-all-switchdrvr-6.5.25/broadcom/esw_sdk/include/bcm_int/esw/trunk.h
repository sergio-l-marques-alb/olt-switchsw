...
/* The structure specifies the information for update nonucast trunk block mask */
typedef struct _esw_trunk_bm_info_s {
    int         *localport_array;
    int         localport_count;
    SHR_BITDCL  *my_modid_bmap;
    uint32      member_count;
} _esw_trunk_bm_info_t;
...
#define TRUNK_BLOCK_MASK_TYPE_COUNT 4
...
#if defined(BCM_TOMAHAWK3_SUPPORT)
extern void _bcm_th3_trunk_sw_dump(int unit);
#endif /* BCM_TOMAHAWK3_SUPPORT */
