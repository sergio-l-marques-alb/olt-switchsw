...
#define BCM_TD3_L3UC_SNAT_KEY_TYPE(_u_) \
    (SOC_IS_FIREBOLT6(_u_) ? (25) : (22))
#define BCM_TD3_L3UC_DNAT_KEY_TYPE(_u_) \
    (SOC_IS_FIREBOLT6(_u_) ? (27) : (24))
#define BCM_TD3_L3MC_NAT_KEY_TYPE(_u_) \
    (SOC_IS_FIREBOLT6(_u_) ? (26) : (23))

#define BCM_L3_NAT_DATA_TYPE(_u_) \
    ((SOC_IS_HELIX5(_u_)) ? (22) :\
    (SOC_IS_FIREBOLT6(_u_) ? (26) : (21)))
