...
typedef struct bfd_sdk_msg_ctrl_discard_stat_get_s {
    ...
    uint32 bfd_mpls_fm_len_err;
    uint32 bfd_mpls_fm_type_err;
    uint32 bfd_echo_ipv4_mismatch;
    uint32 bfd_echo_ipv6_mismatch;
    uint32 bfd_ip_hdr_ver_err;
    uint32 bfd_mpls_no_label;
    uint32 bfd_gal_additional_label_miss;
    uint32 bfd_unknown_ach_type;
    uint32 bfd_vxlan_i_flag_err;
    uint32 bfd_ip_ttl_err;
    uint32 bfd_unsupported_echo_encap_err;
    uint32 bfd_unsupported_ethertype_err;
    uint32 bfd_ether_type_len_err;
    uint32 bfd_offset_err;
    uint32 bfd_malformed_pkt_err;
    uint32 bfd_malformed_ipv4_pkt_err;
    uint32 bfd_malformed_ipv6_pkt_err;
    uint32 bfd_malformed_mpls_pkt_err;
    uint32 bfd_sess_id_config_err;
    uint32 bfd_session_not_enabled;
    uint32 bfd_your_disc_zero;
    uint32 bfd_your_disc_mismatch;
    uint32 bfd_my_disc_mismatch;
    uint32 bfd_pkts_discarded_admin_down;
    uint32 bfd_echo_your_disc_zero;
    uint32 bfd_echo_your_disc_err;
    uint32 bfd_mpls_fm_sess_mismatch;
    uint32 bfd_non_cc_cv_err;
...
typedef struct bfd_sdk_msg_ctrl_l3iif_vrf_map_s {
    uint32 l3_iif;
    uint32 vrf_id;
} bfd_sdk_msg_ctrl_l3iif_vrf_map_t;
...
#endif
    bfd_sdk_msg_ctrl_l3iif_vrf_map_t l3iif_vrf_map;
} bfd_sdk_msg_ctrl_t;
