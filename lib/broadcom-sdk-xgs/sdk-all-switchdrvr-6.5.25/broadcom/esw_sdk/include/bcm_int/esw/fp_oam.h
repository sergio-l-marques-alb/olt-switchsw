...
typedef struct _bcm_fp_oam_control_s {
    ...
    int                        eth_oam_init;        /* Indicates ETh-OAM is initialized. */
    uint32                     eth_oam_group_count; /* Number of ETH-OAM groups. */
    uint32                     eth_oam_ep_count;    /* Number of ETH-OAM endpoints. */
...
typedef enum bcm_fp_oam_wb_sequence_e {
    ...
    bcmFpOamWbSequenceEthOamInitStatus = 2,
    bcmFpOamWbSequenceEthOamCfg        = 3,
    bcmFpOamWbSequenceCount
