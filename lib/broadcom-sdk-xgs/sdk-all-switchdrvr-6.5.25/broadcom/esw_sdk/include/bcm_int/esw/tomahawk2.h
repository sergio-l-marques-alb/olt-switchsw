...
extern int bcm_th2_l3_ecmp_dlb_dgm_member_add(int unit,
                                              ...
                                              bcm_l3_ecmp_member_t *ecmp_member_array,
                                              int *ecmp_member_count);
extern int bcm_td3_l3_ecmp_dlb_port_add(int unit,
                             bcm_if_t ecmp_group_id,
                             bcm_trunk_t tid,
                             bcm_port_t port);

extern int bcm_td3_l3_ecmp_dlb_port_delete(int unit,
                             bcm_if_t ecmp_group_id,
                             bcm_trunk_t tid,
                             bcm_port_t port);
...
extern int bcm_th2_ecmp_dlb_member_sync(int unit, uint8 **scache_ptr, int offset);
extern int bcm_th2_ecmp_dlb_member_scache_recover(int unit, uint8 **scache_ptr, int offset);
extern int bcm_th2_ecmp_dlb_sync(int unit, uint8 **scache_ptr, int offset);
extern int bcm_th2_ecmp_dlb_scache_recover(int unit, uint8 **scache_ptr, int offset);
