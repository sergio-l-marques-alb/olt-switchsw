...
extern int bcm_tr_ipmc_age_start(int unit, int interval);
extern int bcm_tr_ipmc_age_stop(int unit);
...
extern int bcmi_td3_dvp_vc_swap_entry_index_alloc(int unit,
                egr_mpls_vc_and_swap_label_table_entry_t *vc_entry,
                egr_dvp_attribute_entry_t *dvp_entry,
                int cmp,
                int *index);
extern int bcmi_td3_dvp_vc_swap_entry_index_free(int unit,
                egr_dvp_attribute_entry_t *dvp_entry,
                int cmp,
                int index);
