...
#define BCM_FLEX_STAT_TD3X1_RSVD_IFP_POOL_MIN    4
#define BCM_FLEX_STAT_TD3X1_RSVD_IFP_POOL_MAX    9
...
#define FLEX_COUNTER_TD3X1_DEFAULT_IFP_POLICY_TABLE_POOL_NUMBER            4
#endif
...
typedef struct bcm_stat_flex_counter_id_related_info_old_s {
    uint16 mode;
    uint8  pool;
    uint8  used;
    uint32 base_idx;
    uint16 object;
    uint16 group;
}bcm_stat_flex_counter_id_related_info_old_t;
...
extern bcm_error_t _bcm_esw_stat_flex_done(int unit);
...
extern bcm_error_t _bcm_esw_xflow_macsec_stat_flex_pool_enable_set(
        int           unit,
        uint8         pool_id,
        uint8         enable);
#endif
