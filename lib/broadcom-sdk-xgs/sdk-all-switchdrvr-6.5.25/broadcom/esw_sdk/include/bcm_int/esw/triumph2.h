...
extern int bcm_hr4_multicast_remap_xflow_macsec_set(int unit, bcm_multicast_t from, int enable);
extern int bcm_hr4_multicast_remap_xflow_macsec_get(int unit, bcm_multicast_t from, int *enable);
#endif
