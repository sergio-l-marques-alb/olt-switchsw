...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_set
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_get
 */
typedef int (*algo_l3_db_source_address_table_allocation_source_address_table_get_cb)(
    int unit, dnx_algo_template_t *source_address_table);

/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_create
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_allocate_single
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_free_single
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_exchange
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_profile_data_get
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_profile_get
 */
...
/**
 * implemented by: algo_l3_db_source_address_table_allocation_source_address_table_get_next
 */
...
/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_set
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_set_cb)(
    int unit, dnx_algo_res_t intf_rif_res_mngr);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_get
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_get_cb)(
    int unit, dnx_algo_res_t *intf_rif_res_mngr);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_create
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_create_cb)(
    int unit, dnx_algo_res_create_data_t * data, void *extra_arguments);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_allocate_single
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_allocate_single_cb)(
    int unit, uint32 flags, void *extra_arguments, int *element);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_free_single
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_free_single_cb)(
    int unit, int element, void *extra_arguments);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_is_allocated
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_is_allocated_cb)(
    int unit, int element, uint8 *is_allocated);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_nof_free_elements_get
 */
typedef int (*algo_l3_db_rif_alloc_intf_rif_res_mngr_nof_free_elements_get_cb)(
    int unit, int *nof_free_elements);

/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_nof_allocated_elements_in_range_get
 */
...
/**
 * implemented by: algo_l3_db_fec_db_info_fec_db_set
 */
typedef int (*algo_l3_db_fec_db_info_fec_db_set_cb)(
    int unit, uint32 direction, uint32 hierarhy, mdb_physical_table_e fec_db);

/**
 * implemented by: algo_l3_db_fec_db_info_fec_db_get
 */
typedef int (*algo_l3_db_fec_db_info_fec_db_get_cb)(
    int unit, uint32 direction, uint32 hierarhy, mdb_physical_table_e *fec_db);

/**
 * implemented by: algo_l3_db_fec_db_info_fec_db_alloc
 */
typedef int (*algo_l3_db_fec_db_info_fec_db_alloc_cb)(
    int unit);

/**
 * implemented by: algo_l3_db_fec_db_info_fecz_alloc
 */
typedef int (*algo_l3_db_fec_db_info_fecz_alloc_cb)(
    int unit, uint32 nof_instances_to_alloc_0);

/**
 * implemented by: algo_l3_db_fec_db_info_fecz_hierarchy_set
 */
typedef int (*algo_l3_db_fec_db_info_fecz_hierarchy_set_cb)(
    int unit, uint32 fecz_idx_0, uint8 hierarchy);

/**
 * implemented by: algo_l3_db_fec_db_info_fecz_hierarchy_get
 */
typedef int (*algo_l3_db_fec_db_info_fecz_hierarchy_get_cb)(
    int unit, uint32 fecz_idx_0, uint8 *hierarchy);

/**
 * implemented by: algo_l3_db_fec_db_info_fecz_direction_set
 */
typedef int (*algo_l3_db_fec_db_info_fecz_direction_set_cb)(
    int unit, uint32 fecz_idx_0, uint8 direction);

/**
 * implemented by: algo_l3_db_fec_db_info_fecz_direction_get
 */
typedef int (*algo_l3_db_fec_db_info_fecz_direction_get_cb)(
    int unit, uint32 fecz_idx_0, uint8 *direction);

/**
 * implemented by: algo_l3_db_out_rif_result_type_info_set
 */
...
/**
 * implemented by: algo_l3_db_out_rif_result_type_info_get
 */
typedef int (*algo_l3_db_out_rif_result_type_info_get_cb)(
    int unit, uint32 out_rif_result_type_info_idx_0, int *out_rif_result_type_info);

/**
 * implemented by: algo_l3_db_out_rif_result_type_info_alloc
 */
...
/**
 * This structure holds the access functions for the variable source_address_table
 */
typedef struct {
...
typedef struct {
    /**
     * Access struct for source_address_table
     */
...
/**
 * This structure holds the access functions for the variable database_enable
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable l3_vrrp_t
 */
typedef struct {
    /**
     * Access struct for database_enable
     */
...
/**
 * This structure holds the access functions for the variable intf_rif_res_mngr
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for intf_rif_res_mngr
     */
...
/**
 * This structure holds the access functions for the variable fec_db
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable hierarchy
 */
typedef struct {
    algo_l3_db_fec_db_info_fecz_hierarchy_set_cb set;
    algo_l3_db_fec_db_info_fecz_hierarchy_get_cb get;
} algo_l3_db_fec_db_info_fecz_hierarchy_cbs;

/**
 * This structure holds the access functions for the variable direction
 */
typedef struct {
    algo_l3_db_fec_db_info_fecz_direction_set_cb set;
    algo_l3_db_fec_db_info_fecz_direction_get_cb get;
} algo_l3_db_fec_db_info_fecz_direction_cbs;

/**
 * This structure holds the access functions for the variable l3_fec_usage_t
 */
typedef struct {
    algo_l3_db_fec_db_info_fecz_alloc_cb alloc;
    /**
     * Access struct for hierarchy
     */
    algo_l3_db_fec_db_info_fecz_hierarchy_cbs hierarchy;
    /**
     * Access struct for direction
     */
    algo_l3_db_fec_db_info_fecz_direction_cbs direction;
} algo_l3_db_fec_db_info_fecz_cbs;

/**
 * This structure holds the access functions for the variable l3_fec_t
 */
typedef struct {
    /**
     * Access struct for fec_db
     */
    algo_l3_db_fec_db_info_fec_db_cbs fec_db;
    /**
     * Access struct for fecz
     */
    algo_l3_db_fec_db_info_fecz_cbs fecz;
} algo_l3_db_fec_db_info_cbs;

/**
 * This structure holds the access functions for the variable out_rif_result_type_info
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for fec_db_info
     */
    algo_l3_db_fec_db_info_cbs fec_db_info;
    /**
     * Access struct for out_rif_result_type_info
     */
