...
/**
 * \brief - check buffer index is valid for device and number of enabled DRAMs
 *
 * \param [in] unit - unit number
 * \param [in] global_buffer_index - buffer number (global means index is not relative to bank)
 * \param [in] enabled_drams_bitmap - dram bitmap for which buffer index validity should be checked
 *
 * \return
 *   shr_error_e
 *
