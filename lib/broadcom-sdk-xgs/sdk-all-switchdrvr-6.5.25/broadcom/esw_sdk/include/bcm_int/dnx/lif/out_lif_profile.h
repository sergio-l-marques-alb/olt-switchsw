...
/**
 * Specify default ETPP Port out_lif profile
 */
#define DNX_OUT_LIF_PROFILE_DEFAULT_PORT_PROFILE (44)
/**
 * Specify default ETPP MPLS out_lif profile
 */
#define DNX_OUT_LIF_PROFILE_DEFAULT_MPLS_PROFILE (52)
/**
...
/**
 * Used for smart template manager to indicate to keep default MPLS profile
 */
#define DNX_OUT_LIF_PROFILE_KEEP_DEFAULT_MPLS_PROFILE 2
/**
 * Used for smart template manager to indicate to keep default Port profile
 */
#define DNX_OUT_LIF_PROFILE_KEEP_DEFAULT_PORT_PROFILE 3
