...
/**
 * \brief - get the number of enabled drams in current configuration
 *
 * \param [in] unit - unit number
 * \param [out] nof_drams - returned number of drams enabled in current configuration
 * \return
 *   shr_error_e
 *
 * \remark
...
/**
 * \brief - Initial configurations for Dram.
 *  Configurations that should be done after configuring the dram PLL,
 *  but before the soft init step.
 *
 * \param [in] unit - unit number
 * \return
 *   shr_error_e
