...
/**
 * implemented by: lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_create
 */
typedef int (*lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_create_cb)(
    int unit, sw_state_htbl_init_info_t *init_info);

/**
 * implemented by: lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_find
 */
typedef int (*lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_find_cb)(
    int unit, const int *key, local_lif_info_t *value, uint8 *found);

/**
 * implemented by: lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_insert
 */
typedef int (*lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_insert_cb)(
    int unit, const int *key, const local_lif_info_t *value, uint8 *success);

/**
 * implemented by: lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_get_next
 */
typedef int (*lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_get_next_cb)(
    int unit, SW_STATE_HASH_TABLE_ITER *iter, const int *key, const local_lif_info_t *value);

/**
 * implemented by: lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_clear
 */
typedef int (*lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_clear_cb)(
    int unit);

/**
 * implemented by: lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_delete
 */
typedef int (*lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_delete_cb)(
    int unit, const int *key);
...
/**
 * implemented by: lif_table_mngr_db_flow_ingress_virtual_gport_id_set
 */
typedef int (*lif_table_mngr_db_flow_ingress_virtual_gport_id_set_cb)(
    int unit, dnx_algo_res_t flow_ingress_virtual_gport_id);

/**
 * implemented by: lif_table_mngr_db_flow_ingress_virtual_gport_id_get
 */
typedef int (*lif_table_mngr_db_flow_ingress_virtual_gport_id_get_cb)(
    int unit, dnx_algo_res_t *flow_ingress_virtual_gport_id);

/**
 * implemented by: lif_table_mngr_db_flow_ingress_virtual_gport_id_create
 */
typedef int (*lif_table_mngr_db_flow_ingress_virtual_gport_id_create_cb)(
    int unit, dnx_algo_res_create_data_t * data, void *extra_arguments);

/**
 * implemented by: lif_table_mngr_db_flow_ingress_virtual_gport_id_allocate_single
 */
typedef int (*lif_table_mngr_db_flow_ingress_virtual_gport_id_allocate_single_cb)(
    int unit, uint32 flags, void *extra_arguments, int *element);

/**
 * implemented by: lif_table_mngr_db_flow_ingress_virtual_gport_id_free_single
 */
typedef int (*lif_table_mngr_db_flow_ingress_virtual_gport_id_free_single_cb)(
    int unit, int element, void *extra_arguments);

/**
 * implemented by: lif_table_mngr_db_flow_ingress_virtual_gport_id_is_allocated
 */
typedef int (*lif_table_mngr_db_flow_ingress_virtual_gport_id_is_allocated_cb)(
    int unit, int element, uint8 *is_allocated);
 ...
 */
typedef struct {
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_create_cb create;
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_find_cb find;
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_insert_cb insert;
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_get_next_cb get_next;
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_clear_cb clear;
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_delete_cb delete;
} lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_cbs;
 ...
 */
typedef struct {
    lif_table_mngr_db_flow_ingress_virtual_gport_id_set_cb set;
    lif_table_mngr_db_flow_ingress_virtual_gport_id_get_cb get;
    lif_table_mngr_db_flow_ingress_virtual_gport_id_create_cb create;
    lif_table_mngr_db_flow_ingress_virtual_gport_id_allocate_single_cb allocate_single;
    lif_table_mngr_db_flow_ingress_virtual_gport_id_free_single_cb free_single;
    lif_table_mngr_db_flow_ingress_virtual_gport_id_is_allocated_cb is_allocated;
} lif_table_mngr_db_flow_ingress_virtual_gport_id_cbs;
...
typedef struct {
     ...
     */
    lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_cbs valid_fields_per_no_local_lif_egress_htb;
#ifdef BCM_DNX2_SUPPORT
    /**
     ...
     */
    lif_table_mngr_db_flow_ingress_virtual_gport_id_cbs flow_ingress_virtual_gport_id;
