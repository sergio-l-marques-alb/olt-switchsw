...
typedef struct
{
    ...
    /*
     *String represent the name of relevant advanced algorithm. If we did not have any, "DNX_ALGO_TEMPLATE_ADVANCED_ALGORITHM_BASIC.".
     */
    char advanced_algo_name[DNX_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH];
