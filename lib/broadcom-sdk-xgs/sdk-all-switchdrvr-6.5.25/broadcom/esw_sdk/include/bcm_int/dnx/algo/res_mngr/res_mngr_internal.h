...
#define DNX_ALGO_RES_MNGR_FREE_SINGLE(module_id, algo_res, element, extra_arguments)\
        SHR_IF_ERR_EXIT(dnx_algo_res_free(unit, module_id, algo_res, element, extra_arguments))

#define DNX_ALGO_RES_MNGR_FREE_SEVERAL(module_id, algo_res, nof_elements, element, extra_arguments)\
        SHR_IF_ERR_EXIT(dnx_algo_res_free_several(unit, module_id, algo_res, nof_elements, element, extra_arguments))
...
#define DNX_ALGO_RES_MNGR_PRINT(module_id, algo_res)\
