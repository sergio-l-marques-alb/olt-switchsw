...
shr_error_e flexe_std_oam_rdi_insert_set(
    int unit,
    int client_channel,
    uint32 enable);
shr_error_e flexe_std_oam_rdi_insert_get(
    int unit,
    int client_channel,
    uint32 *enable);
...
shr_error_e flexe_std_1588_pkt_header_set(
    int unit,
    uint32 flags,
    uint32 val);
shr_error_e flexe_std_1588_pkt_header_get(
    int unit,
    uint32 flags,
    uint32 *val);

/*Set/get Flexe oh/oam packet mac*/
shr_error_e flexe_std_oh_oam_pkt_mac_set(
    int unit,
    uint32 flags,
    uint32 val);
shr_error_e flexe_std_oh_oam_pkt_mac_get(
    int unit,
    uint32 flags,
    uint32 *val);

/*Enable/disable FlexE BAS OAM to external processor*/
shr_error_e flexe_std_bas_oam_to_ext_processor_set(
    int unit,
    int enable);
shr_error_e flexe_std_bas_oam_to_ext_processor_get(
    int unit,
    int *enable);

/*Get 1588 2-step tx timestamp for FlexE phy*/
shr_error_e flexe_std_ptp_2step_tx_info_get(
    int unit,
    int flexe_core_port,
    uint32 *valid,
    uint64 *timestamp);
...
shr_error_e flexe_std_sar_jitter_fifo_level_set(
    int unit,
    int client_channel,
    const flexe_core_sar_jitter_fifo_level_t * fifo_level);
shr_error_e flexe_std_sar_jitter_fifo_level_get(
    int unit,
    int client_channel,
