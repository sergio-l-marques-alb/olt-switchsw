 ...
 *  None
 */
shr_error_e dnx_port_esem_cmd_data_hw_set(
    int unit,
    int esem_cmd,
    dnx_esem_cmd_data_t esem_cmd_data);
 ...
 * \param [in] max_nof_access - maximum number of esem accesses in the access type.
 *             A value of DNX_PORT_ESEM_NOF_ACCESS means to get all possible accesses.
