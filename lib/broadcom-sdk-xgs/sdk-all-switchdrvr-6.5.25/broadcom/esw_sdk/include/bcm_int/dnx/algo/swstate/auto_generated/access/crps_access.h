...
/**
 * implemented by: dnx_crps_db_database_set_set
 */
...
/**
 * implemented by: dnx_crps_db_database_set_get
 */
...
/**
 * implemented by: dnx_crps_db_database_set_size_set
 */
...
/**
 * implemented by: dnx_crps_db_database_set_size_get
 */
typedef int (*dnx_crps_db_database_set_size_get_cb)(
    int unit, uint32 database_idx_0, uint32 database_idx_1, uint32 set_idx_0, int *size);

/**
 * implemented by: dnx_crps_db_database_set_start_set
 */
...
/**
 * implemented by: dnx_crps_db_database_set_start_get
 */
typedef int (*dnx_crps_db_database_set_start_get_cb)(
    int unit, uint32 database_idx_0, uint32 database_idx_1, uint32 set_idx_0, uint32 *start);

/**
 * implemented by: dnx_crps_db_database_set_end_set
 */
...
/**
 * implemented by: dnx_crps_db_database_set_end_get
 */
...
/**
 * This structure holds the access functions for the variable dnx_set_config_t
 */
typedef struct {
