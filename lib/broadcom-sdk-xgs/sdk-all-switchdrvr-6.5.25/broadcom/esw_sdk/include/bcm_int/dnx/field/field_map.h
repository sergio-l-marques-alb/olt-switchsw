...
typedef enum
{
    ...
    DNX_FIELD_QUAL_IN_LIF_PROFILE_PMF_QUAL_0,
    ...
    DNX_FIELD_QUAL_MKX_FOUND_0,
    DNX_FIELD_QUAL_MKX_FOUND_1,
    DNX_FIELD_QUAL_MKX_FOUND_2,
    DNX_FIELD_QUAL_MKX_FOUND_3,
...
typedef struct
{
     ...
     */
    const dnx_field_layer_record_qual_info_t *layer_qual_info;
    /*
...
#define DNX_FIELD_STAGE_ITERATOR(stage, field_map_stage_info)                           \
        for(stage = DNX_FIELD_STAGE_FIRST; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get_dispatch(unit, stage, &field_map_stage_info) == _SHR_E_NONE && field_map_stage_info.pp_stage != DNX_PP_STAGE_INVALID)

#define DNX_FIELD_STAGE_CS_QUAL_ITERATOR(stage, field_map_stage_info)                   \
        for(stage = DNX_FIELD_STAGE_FIRST; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get_dispatch(unit, stage, &field_map_stage_info) == _SHR_E_NONE && field_map_stage_info.cs_qual_map != NULL)

#define DNX_FIELD_STAGE_QUAL_ITERATOR(stage, field_map_stage_info)                      \
        for(stage = DNX_FIELD_STAGE_FIRST; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get_dispatch(unit, stage, &field_map_stage_info) == _SHR_E_NONE && field_map_stage_info.meta_qual_map != NULL)

#define DNX_FIELD_STAGE_LAYER_QUAL_ITERATOR(stage, field_map_stage_info)                \
        for(stage = DNX_FIELD_STAGE_FIRST; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get_dispatch(unit, stage, &field_map_stage_info) == _SHR_E_NONE && field_map_stage_info.layer_qual_info != NULL)
...
{ \
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get_dispatch(unit, stage, &_field_map_stage_info));     \
...
#define DNX_FIELD_STATIC_ACTION_VERIFY(stage, action_id)                                    \
{ \
    dnx_field_map_stage_info_t _field_map_stage_info;                                       \
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get_dispatch(unit, stage, &_field_map_stage_info));     \
    if((action_id < 0) || (action_id >= _field_map_stage_info.static_action_nof))           \
    {                                                                                       \
        SHR_ERR_EXIT(_SHR_E_PARAM, "Static action id:%d is out of range for stage:%s\n",    \
 ...
 * \param [out] qual_map_entry_p - place to assign pointer of bcm qual entry
 * \return
 *   \retval _SHR_E_NONE      - On success
 *   \retval _SHR_E_NOT_FOUND - When there is no support for such bcm qualifier
...
shr_error_e dnx_field_action_description_get_dispatch(
    int unit,
    bcm_field_action_t bcm_action,
...
/**
* \brief        Get the FWD and ACL contexts used by an Apptype
* \param [in] unit     - Device Id
...
*   * None
*/
shr_error_e dnx_field_map_port_profile_type_get_dispatch(
    int unit,
...
*   * None
*/
shr_error_e dnx_field_map_port_profile_info_get_dispatch(
    int unit,
    bcm_port_class_t bcm_port_class,
...
*   bcm_error_e
*/
shr_error_e dnx_field_map_stage_info_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
...
/**
* \brief
* Get field map meta qual info per stage
*
* \param [in] unit              - Device id
* \param [in] stage             - Stage id
* \param [in] bcm_qual          - BCM qual
* \param [out] meta_qual_info_p - Pointer to field map qual info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_meta_qual_map_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
    bcm_field_qualify_t bcm_qual,
...
/**
* \brief
* Get field map cs qual info per stage
*
* \param [in] unit              - Device id
* \param [in] stage             - Stage id
* \param [in] bcm_qual          - BCM qual
* \param [out] cs_qual_map_p    - Pointer to field cs qual map.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_cs_qual_map_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
    bcm_field_qualify_t bcm_qual,
...
/**
* \brief
* Get field map later_record qual info per stage
*
* \param [in] unit              - Device id
* \param [in] stage             - Stage id
* \param [in] qual_id           - Qual id
* \param [out] layer_record_qual_info_p - Pointer to field map qual info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_layer_record_qual_info_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
...
/**
* \brief
* Get field map range legacy
*
* \param [in] unit            - Device id
* \param [in] app_db          - App db
* \param [out] pp_app_map_p   - Pointer to pp app map.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_pp_app_map_get_dispatch(
    int unit,
...
/**
* \brief
* Get field map header qual info
*
* \param [in] unit                 - Device id
* \param [in] qual_id              - Qual id
* \param [out] header_qual_info_p  - Pointer to header qual info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_header_qual_info_get_dispatch(
    int unit,
    dnx_field_qual_id_t qual_id,
...
/**
* \brief
* Get field map sw qual info
*
* \param [in] unit             - Device id
* \param [in] qual_id          - Qual id
* \param [out] sw_qual_info_p  - Pointer to sw qual info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_sw_qual_info_get_dispatch(
    int unit,
    dnx_field_qual_id_t qual_id,
...
/**
* \brief
* Get field map sw action info
*
* \param [in] unit               - Device id
* \param [in] action_id          - Action id
* \param [out] sw_action_info_p  - Pointer to sw action info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_sw_action_info_get_dispatch(
    int unit,
...
/**
* \brief
* Get field map global qual
*
* \param [in] unit                - Device id
* \param [in] bcm_qual            - BCM qual
* \param [out] global_qual_map_p  - Pointer to global qual map.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_global_qual_map_get_dispatch(
    int unit,
    bcm_field_qualify_t bcm_qual,
...
/**
* \brief
* Get field map global action
*
* \param [in] unit                   - Device id
* \param [in] bcm_action             - BCM action
* \param [out] global_action_info_p  - Pointer to global action info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_global_action_map_get_dispatch(
    int unit,
    bcm_field_action_t bcm_action,
 ...
 *   bcm_error_e
 */
shr_error_e dnx_field_map_static_opcode_to_apptype_get_dispatch(
    int unit,
 ...
 *   bcm_error_e
 */
shr_error_e dnx_field_map_static_opcode_to_cs_profile_get_dispatch(
    int unit,
    uint32 static_opcode_id,
    uint32 *cs_profile_p);
 ...
 *   bcm_error_e
 */
shr_error_e dnx_field_map_standard_1_predefined_apptype_to_opcode_get_dispatch(
    int unit,
    bcm_field_AppType_t apptype,
