...
#define SPD_SCAN_F_LINK                 0x4 /**<  Link Change.           */
#define SPD_SCAN_F_SEMA                 0x8 /**<  Semaphore Set.         */

#define SPD_SCAN_F_INIT_SET(flags)      ((flags) |= SPD_SCAN_F_INIT)
#define SPD_SCAN_F_ENABLE_SET(flags)    ((flags) |= SPD_SCAN_F_ENABLE)
#define SPD_SCAN_F_LINK_SET(flags)      ((flags) |= SPD_SCAN_F_LINK)
#define SPD_SCAN_F_SEMA_SET(flags)      ((flags) |= SPD_SCAN_F_SEMA)

#define SPD_SCAN_F_INIT_CLR(flags)      ((flags) &= ~SPD_SCAN_F_INIT)
#define SPD_SCAN_F_ENABLE_CLR(flags)    ((flags) &= ~SPD_SCAN_F_ENABLE)
#define SPD_SCAN_F_LINK_CLR(flags)      ((flags) &= ~SPD_SCAN_F_LINK)
#define SPD_SCAN_F_SEMA_CLR(flags)      ((flags) &= ~SPD_SCAN_F_SEMA)

#define SPD_SCAN_F_INIT_GET(flags)      ((flags) & SPD_SCAN_F_INIT ? 1 : 0)
#define SPD_SCAN_F_ENABLE_GET(flags)    ((flags) & SPD_SCAN_F_ENABLE? 1 : 0)
#define SPD_SCAN_F_LINK_GET(flags)      ((flags) & SPD_SCAN_F_LINK? 1 : 0)
#define SPD_SCAN_F_SEMA_GET(flags)      ((flags) & SPD_SCAN_F_SEMA? 1 : 0)
