...
typedef struct bcm_compat6519_port_flexe_oh_alarm_s {
...
} bcm_compat6519_port_flexe_oh_alarm_t;

/* Get overhead alarms. */
extern int bcm_compat6519_port_flexe_oh_alarm_get(
    int unit, 
    bcm_gport_t gport, 
    uint32 flags, 
    bcm_compat6519_port_flexe_oh_alarm_t *alarms);
