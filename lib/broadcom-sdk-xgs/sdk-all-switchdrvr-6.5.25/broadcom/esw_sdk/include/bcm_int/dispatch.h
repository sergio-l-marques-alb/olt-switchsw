...
typedef struct {
	...
	int (*cosq_aqm_profile_create)(int,int,bcm_gport_t *);
	...
	int (*cosq_detach)(int);
	int (*cosq_device_info_get)(int,bcm_cosq_device_info_t *);
	...
	int (*cosq_global_voq_get)(int,uint32,bcm_port_t,bcm_cosq_global_voq_info_t *,uint32 *);
	/* bcm_cosq_global_voq_info_t_init not dispatchable */
	int (*cosq_global_voq_set)(int,uint32,bcm_port_t,bcm_cosq_global_voq_info_t *,uint32 *);
	...
	int (*cosq_port_schedq_mapping_get)(int,bcm_port_t,int,bcm_cosq_mapping_t *,int *);
	int (*cosq_port_schedq_mapping_set)(int,bcm_port_t,int,bcm_cosq_mapping_t *);
	...
	int (*cpri_detach)(int);
	int (*cpri_encap_control_queue_tag_to_flow_id_map_get)(int,int,uint32,uint32 *);
	...
	int (*cpri_port_frame_config_get)(int,bcm_port_t,bcm_cpri_port_frame_config_t *);
	...
	int (*cpri_port_rsvd4_cm_fast_eth_config_get)(int,int,bcm_rsvd4_fast_eth_config_info_t *);
	...
	int (*cpri_port_rsvd4_rx_bfn_sync_config_get)(int,bcm_gport_t,uint16 *,uint64 *);
	...
	int (*cpri_port_rsvd4_rx_control_flow_get)(int,int,int,bcm_rsvd4_control_flow_config_t *);
	...
	int (*cpri_port_rsvd4_tx_cm_hdr_config_entry_get)(int,int,int,bcm_rsvd4_tx_cm_hdr_entry_t *);
	int (*cpri_port_rsvd4_tx_cm_hdr_config_entry_set)(int,int,int,bcm_rsvd4_tx_cm_hdr_entry_t *);
	int (*cpri_port_rsvd4_tx_cm_hdr_lkup_entry_get)(int,int,int,int *);
	...
	int (*cpri_port_rsvd4_tx_cm_tunnel_crc_config_get)(int,int,bcm_rsvd4_cm_tunnel_crc_option_t *);
	...
	int (*cpri_port_rsvd4_tx_control_flow_get)(int,int,int,bcm_rsvd4_tx_control_flow_config_t *);
	...
	int (*cpri_port_rsvd4_tx_control_flow_group_member_get)(int,int,bcm_rsvd4_control_group_id_t,bcm_rsvd4_priority_t,bcm_rsvd4_tx_control_flow_group_config_t *);
	int (*cpri_port_rsvd4_tx_control_flow_group_member_get_all)(int,int,bcm_rsvd4_control_group_id_t,bcm_rsvd4_control_group_entry_t *);
	...
	int (*cpri_port_rx_8b10b_descrambler_enable_get)(int,bcm_gport_t,int *);
	int (*cpri_port_rx_8b10b_descrambler_enable_set)(int,bcm_gport_t,int);
	...
	int (*cpri_port_rx_tag_config_get)(int,int,bcm_cpri_control_tag_config_t *);
	...
	int (*cpri_port_tx_8b10b_scrambler_enable_get)(int,bcm_gport_t,int *);
	int (*cpri_port_tx_8b10b_scrambler_enable_set)(int,bcm_gport_t,int);
	int (*cpri_port_tx_8b10b_scrambler_seed_get)(int,bcm_gport_t,uint32 *);
	int (*cpri_port_tx_8b10b_scrambler_seed_set)(int,bcm_gport_t,uint32);
	...
	int (*cpri_port_tx_frame_tgen_config_get)(int,bcm_gport_t,int *,bcm_cpri_tx_frame_tgen_config_t *);
	...
	int (*ecn_map_profile_get)(int,bcm_ecn_map_profile_t *);
	int (*ecn_map_profile_set)(int,bcm_ecn_map_profile_t *);
	...
	int (*extender_forward_stat_attach)(int,bcm_extender_forward_t *,uint32);
	int (*extender_forward_stat_detach)(int,bcm_extender_forward_t *);
	int (*extender_forward_stat_id_get)(int,bcm_extender_forward_t *,uint32 *);
	...
	int (*fabric_system_upgrade_phase1_get)(int,int,int *,bcm_fabric_system_upgrade_target_t *);
	int (*fabric_system_upgrade_phase1_set)(int,int,int,bcm_fabric_system_upgrade_target_t);
	int (*fabric_system_upgrade_phase2_trig)(int,int);
	int (*fabric_system_upgrade_phase3_get)(int,int,bcm_fabric_system_upgrade_status_t *);
	...
	int (*fabric_wfd_profile_get)(int,uint32,int,int,bcm_fabric_wfd_link_config_t *,int *);
	int (*fabric_wfd_profile_set)(int,uint32,int,int,bcm_fabric_wfd_link_config_t *);
#ifdef	INCLUDE_L3
	...
	int (*field_action_container_info_get)(int,bcm_field_stage_t,bcm_field_action_t,uint8,uint32,uint32,uint16 *,uint16 *,uint8 *,uint8 *);
	...
	int (*field_control_config_get)(int,bcm_field_control_t,bcm_field_control_config_t *);
	int (*field_control_config_set)(int,bcm_field_control_t,bcm_field_control_config_t *);
	...
	int (*field_entry_policer_extended_attach)(int,bcm_field_entry_t,bcm_field_policer_config_t *);
	int (*field_entry_policer_extended_detach)(int,bcm_field_entry_t,bcm_field_policer_config_t *);
	...
	int (*field_group_cache)(int,uint32,bcm_field_group_t,bcm_field_group_cache_mode_t);
	...
	int (*field_hints_multi_get)(int,bcm_field_hintid_t,bcm_field_hint_type_t,int,bcm_field_hint_t *,int *);
	int (*field_init)(int);
	...
	int (*field_qualify_BfdVerFlags)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_BfdVerFlags_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	...
	int (*field_qualify_CpuTxDestType)(int,bcm_field_entry_t,bcm_field_cpu_tx_dest_type_t);
	int (*field_qualify_CpuTxDestType_get)(int,bcm_field_entry_t,bcm_field_cpu_tx_dest_type_t *);
	int (*field_qualify_CpuTxFlowType)(int,bcm_field_entry_t,bcm_field_cpu_tx_flow_type_t);
	int (*field_qualify_CpuTxFlowType_get)(int,bcm_field_entry_t,bcm_field_cpu_tx_flow_type_t *);
	...
	int (*field_qualify_DropReasonIngressCopy)(int,bcm_field_entry_t,bcm_field_drop_reason_t);
	int (*field_qualify_DropReasonIngressCopy_get)(int,bcm_field_entry_t,bcm_field_drop_reason_t *);
	...
	int (*field_qualify_EgrForwardingEditStatus)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EgrForwardingEditStatus_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EgrNextHopUnderlay)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EgrNextHopUnderlay_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_EtagAction)(int,bcm_field_entry_t,bcm_field_etag_action_t);
	int (*field_qualify_EtagAction_get)(int,bcm_field_entry_t,bcm_field_etag_action_t *);
	int (*field_qualify_EtagAddReplaceControl)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EtagAddReplaceControl_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EtagDei)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EtagDei_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EtagPcp)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EtagPcp_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EtagReserved1)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_EtagReserved1_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_EtagSvid)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_EtagSvid_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_EtagVid)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_EtagVid_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	...
	int (*field_qualify_FirstDropReasonIngressCopy)(int,bcm_field_entry_t,bcm_field_drop_reason_t);
	int (*field_qualify_FirstDropReasonIngressCopy_get)(int,bcm_field_entry_t,bcm_field_drop_reason_t *);
	...
	int (*field_qualify_ForwardIpType)(int,bcm_field_entry_t,bcm_field_ForwardIpType_t);
	int (*field_qualify_ForwardIpType_get)(int,bcm_field_entry_t,bcm_field_ForwardIpType_t *);
	...
	int (*field_qualify_ForwardingInnerVlan)(int,bcm_field_entry_t,bcm_vlan_t,bcm_vlan_t);
	int (*field_qualify_ForwardingInnerVlan_get)(int,bcm_field_entry_t,bcm_vlan_t *,bcm_vlan_t *);
	...
	int (*field_qualify_ForwardingOuterVlan)(int,bcm_field_entry_t,bcm_vlan_t,bcm_vlan_t);
	...
	int (*field_qualify_ForwardingOuterVlan_get)(int,bcm_field_entry_t,bcm_vlan_t *,bcm_vlan_t *);
	...
	int (*field_qualify_ForwardingTos)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_ForwardingTos_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_ForwardingTrafficClass)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_ForwardingTrafficClass_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_IfaCurrentLengthValid)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_IfaCurrentLengthValid_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_IfaHopLimitReached)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_IfaHopLimitReached_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_IfaMaxLengthValid)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_IfaMaxLengthValid_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_IngressL2InterfaceVfi)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_IngressL2InterfaceVfi_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	...
	int (*field_qualify_Ip4HdrLength)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_Ip4HdrLength_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	...
	int (*field_qualify_L3EgrIntfEfpCtrlId)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_L3EgrIntfEfpCtrlIdOverlay)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_L3EgrIntfEfpCtrlIdOverlay_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_L3EgrIntfEfpCtrlId_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_L3HdrErrorCheck)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_L3HdrErrorCheck_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_L3IPv4OptionsPkt)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_L3IPv4OptionsPkt_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_L3TtlErrorCheck)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_L3TtlErrorCheck_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_LoopbackCustomSubtype)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_LoopbackCustomSubtype_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_MirrorEncapCtrlType)(int,bcm_field_entry_t,bcm_field_mirror_encap_ctrl_type_t);
	int (*field_qualify_MirrorEncapCtrlType_get)(int,bcm_field_entry_t,bcm_field_mirror_encap_ctrl_type_t *);
	int (*field_qualify_MirrorEncapId)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_MirrorEncapId_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_MplsEsiLabel0to15)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_MplsEsiLabel0to15_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_MplsEsiLabel16to31)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_MplsEsiLabel16to31_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	...
	int (*field_qualify_OverlayL3Routable)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_OverlayL3Routable_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_OverlayOpaqueTag)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_OverlayOpaqueTag_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	int (*field_qualify_OverlayOuterTpid)(int,bcm_field_entry_t,uint16);
	int (*field_qualify_OverlayOuterTpid_get)(int,bcm_field_entry_t,uint16 *);
	...
	int (*field_qualify_PreserveTtl)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_PreserveTtl_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_ProtocolPktMiscCtrl)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_ProtocolPktMiscCtrl_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_RecircleHdrOpaqueControls)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_RecircleHdrOpaqueControls_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*field_qualify_SRv6ArgsLabel0to15)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_SRv6ArgsLabel0to15_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_SRv6ArgsLabel16to31)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_SRv6ArgsLabel16to31_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_SRv6EsiLabel0to15)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_SRv6EsiLabel0to15_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_SRv6EsiLabel16to31)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_SRv6EsiLabel16to31_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	...
	int (*field_qualify_StormCtrlMeterEnable)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_StormCtrlMeterEnable_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_TunnelEgressFlowEncap)(int,bcm_field_entry_t,bcm_field_tunnel_egress_flow_encap_t);
	int (*field_qualify_TunnelEgressFlowEncap_get)(int,bcm_field_entry_t,bcm_field_tunnel_egress_flow_encap_t *);
	...
	int (*field_tcam_bank_status_get)(int,bcm_core_t,uint32,bcm_field_tcam_bank_status_info_t *);
	...
	int (*flexctr_block_create)(int,bcm_flexctr_block_t *,uint32 *);
	int (*flexctr_block_destroy)(int,uint32);
	int (*flexctr_block_get)(int,uint32,bcm_flexctr_block_t *);
	/* bcm_flexctr_block_t_init not dispatchable */
	int (*flexctr_block_traverse)(int,bcm_flexctr_block_traverse_cb,void *);
	...
	int (*flexctr_object_info_get)(int,bcm_flexctr_object_t,bcm_flexctr_object_info_t *);
	...
	int (*flexctr_pool_counter_id_multi_get)(int,bcm_flexctr_pool_info_t *,int,uint32 *,int *);
	...
	int (*flexctr_resource_count_get)(int,bcm_flexctr_resource_type_t,int *);
	int (*flexctr_resource_count_set)(int,bcm_flexctr_resource_type_t,int);
	...
	int (*flow_encap_stat_detach)(int,bcm_flow_encap_config_t *,uint32,bcm_flow_logical_field_t *);
	...
	int (*flow_es_filter_stat_detach)(int,bcm_gport_t);
	int (*flow_es_filter_stat_id_get)(int,bcm_gport_t,uint32 *);
	int (*flow_handle_control_get)(int,bcm_flow_handle_t,bcm_flow_handle_control_t,uint32 *);
	int (*flow_handle_control_set)(int,bcm_flow_handle_t,bcm_flow_handle_control_t,uint32);
	...
	int (*flow_match_stat_detach)(int,bcm_flow_match_config_t *,uint32,bcm_flow_logical_field_t *);
	...
	int (*flow_port_stat_detach)(int,bcm_gport_t);
	int (*flow_port_stat_detach_with_id)(int,bcm_gport_t,uint32);
	...
	int (*flow_tunnel_initiator_flexctr_object_get)(int,bcm_gport_t,uint32 *);
	...
	int (*flow_tunnel_initiator_stat_detach)(int,bcm_gport_t);
	...
	int (*flow_tunnel_srv6_srh_add)(int,uint32,bcm_flow_tunnel_srv6_srh_t *,int,bcm_ip6_t *);
	int (*flow_tunnel_srv6_srh_delete)(int,bcm_gport_t);
	int (*flow_tunnel_srv6_srh_delete_all)(int);
	int (*flow_tunnel_srv6_srh_get)(int,bcm_flow_tunnel_srv6_srh_t *,int,bcm_ip6_t *,int *);
	/* bcm_flow_tunnel_srv6_srh_t_init not dispatchable */
	int (*flow_tunnel_srv6_srh_traverse)(int,bcm_flow_tunnel_srv6_srh_traverse_cb,void *);
	...
	int (*flow_tunnel_terminator_stat_detach)(int,bcm_flow_tunnel_terminator_t *,uint32,bcm_flow_logical_field_t *);
	...
	int (*flow_vpn_stat_detach)(int,bcm_vpn_t);
	int (*flow_vpn_stat_detach_with_id)(int,bcm_vpn_t,uint32);
	...
	int (*flowtracker_cfg_get)(int,bcm_flowtracker_cfg_t *);
	int (*flowtracker_cfg_init)(int,bcm_flowtracker_cfg_t *);
	...
	int (*flowtracker_flexctr_action_info_get)(int,bcm_flowtracker_flexctr_action_info_t *);
	/* bcm_flowtracker_flow_key_t_init not dispatchable */
	int (*flowtracker_flow_learn_fail_count_get)(int,int,uint32 *);
	int (*flowtracker_flow_learn_fail_notify_register)(int,bcm_flowtracker_flow_learn_fail_notify_cb,void *);
	int (*flowtracker_flow_learn_fail_notify_unregister)(int);
	int (*flowtracker_flow_learn_notify_config_get)(int,int,bcm_flowtracker_flow_learn_notify_config_t *);
	int (*flowtracker_flow_learn_notify_config_set)(int,int,bcm_flowtracker_flow_learn_notify_config_t *);
	int (*flowtracker_flow_learn_notify_register)(int,bcm_flowtracker_flow_learn_notify_cb,void *);
	int (*flowtracker_flow_learn_notify_unregister)(int);
	...
	int (*flowtracker_tracking_param_type_info_get)(int,bcm_flowtracker_group_type_t,bcm_flowtracker_tracking_param_type_t,bcm_flowtracker_tracking_param_type_info_t *);
	...
	int (*instru_eventor_generate_periodic_get)(int,uint32,bcm_instru_eventor_periodic_source_t *,bcm_instru_eventor_periodic_config_t *);
	int (*instru_eventor_generate_periodic_set)(int,uint32,bcm_instru_eventor_periodic_source_t *,bcm_instru_eventor_periodic_config_t *);
	...
	int (*instru_ipfix_encap_create)(int,bcm_instru_ipfix_encap_info_t *);
	int (*instru_ipfix_encap_delete)(int,bcm_instru_ipfix_encap_info_t *);
	int (*instru_ipfix_encap_get)(int,bcm_instru_ipfix_encap_info_t *);
	int (*instru_ipfix_encap_traverse)(int,bcm_instru_ipfix_encap_traverse_cb,void *);
	int (*instru_ipfix_interface_add)(int,bcm_instru_ipfix_interface_info_t *);
	int (*instru_ipfix_interface_get)(int,bcm_instru_ipfix_interface_info_t *);
	int (*instru_ipfix_interface_remove)(int,bcm_instru_ipfix_interface_info_t *);
	int (*instru_ipfix_interface_traverse)(int,bcm_instru_ipfix_interface_traverse_info_t *,bcm_instru_ipfix_interface_traverse_cb,void *);
	...
	int (*instru_synced_trigger_config_get)(int,uint32,bcm_instru_synced_trigger_source_type_t,bcm_instru_synced_trigger_config_t *);
	int (*instru_synced_trigger_config_set)(int,uint32,bcm_instru_synced_trigger_source_type_t,bcm_instru_synced_trigger_config_t *);
	int (*instru_synced_trigger_time_of_day_get)(int,uint32,uint64 *);
	int (*instru_synced_triggers_enable_get)(int,uint32,uint32,bcm_instru_synced_trigger_source_type_t *,uint32 *);
	int (*instru_synced_triggers_enable_set)(int,uint32,uint32,bcm_instru_synced_trigger_source_type_t *,uint32 *);
	...
	int (*ipmc_age_cb_register)(int,bcm_ipmc_age_cb_t,void *);
	int (*ipmc_age_cb_unregister)(int,bcm_ipmc_age_cb_t,void *);
	int (*ipmc_age_timer_get)(int,int *);
	int (*ipmc_age_timer_set)(int,int);
	...
	int (*l2_learn_drop_event_enable_get)(int,bcm_l2_learn_drop_event_t,int *);
	int (*l2_learn_drop_event_enable_get_all)(int,int,bcm_l2_learn_drop_event_t *,int *);
	int (*l2_learn_drop_event_enable_set)(int,bcm_l2_learn_drop_event_t,int);
	...
	int (*l2_mac_move_mon_cb_register)(int,bcm_l2_mac_move_mon_cb_t,void *);
	int (*l2_mac_move_mon_cb_unregister)(int,bcm_l2_mac_move_mon_cb_t,void *);
	int (*l2_mac_move_mon_config_get)(int,bcm_l2_mac_move_mon_params_t *);
	int (*l2_mac_move_mon_config_set)(int,bcm_l2_mac_move_mon_params_t *);
	int (*l2_mac_move_mon_enable_get)(int,uint32 *);
	int (*l2_mac_move_mon_enable_set)(int,uint32);
	int (*l2_mac_move_mon_init)(int);
	/* bcm_l2_mac_move_mon_params_t_init not dispatchable */
	int (*l2_mac_move_mon_stop)(int);
	...
	int (*l2_station_info_get)(int,bcm_l2_station_info_t *);
	...
	int (*l3_ecmp_dlb_trigger_reassignment)(int,bcm_if_t,bcm_port_t,int);
	int (*l3_ecmp_dlb_trunk_port_add)(int,bcm_if_t,bcm_trunk_t,bcm_port_t);
	int (*l3_ecmp_dlb_trunk_port_delete)(int,bcm_if_t,bcm_trunk_t,bcm_port_t);
	...
	int (*l3_egress_ecmp_user_profile_create)(int,bcm_l3_egress_ecmp_t *,int,bcm_if_t *);
	int (*l3_egress_ecmp_user_profile_destroy)(int,bcm_l3_egress_ecmp_t *);
	int (*l3_egress_ecmp_user_profile_get)(int,bcm_l3_egress_ecmp_t *,int,bcm_if_t *,int *);
	...
	int (*l3_egress_id_flexctr_object_get)(int,bcm_if_t,bcm_flexctr_direction_t,uint32 *);
	...
	int (*l3_host_flexctr_object_get)(int,bcm_l3_host_t *,uint32 *);
	int (*l3_host_flexctr_object_set)(int,bcm_l3_host_t *,uint32);
	...
	int (*l3_intf_flexctr_object_get)(int,bcm_if_t,bcm_flexctr_direction_t,uint32 *);
	...
	int (*l3_mtu_adjustment_profile_create)(int,uint32,bcm_l3_mtu_adjustment_profile_t *);
	int (*l3_mtu_adjustment_profile_destroy)(int,int);
	int (*l3_mtu_adjustment_profile_get)(int,bcm_l3_mtu_adjustment_profile_t *);
	...
	int (*mirror_encap_info_get)(int,bcm_mirror_encap_instance_t *,bcm_mirror_encap_info_t *);
	...
	int (*mirror_sample_stat_get)(int,int,bcm_mirror_sample_stat_type_t,uint64 *);
	int (*mirror_sample_stat_set)(int,int,bcm_mirror_sample_stat_type_t,uint64);
	int (*mirror_sample_stat_sync_get)(int,int,bcm_mirror_sample_stat_type_t,uint64 *);
	...
	int (*mpls_tunnel_initiator_flexctr_object_get)(int,bcm_if_t,uint32 *);
	...
	int (*multicast_bfr_id_add)(int,bcm_multicast_t,uint32,int,uint32 *,bcm_multicast_replication_t *);
	int (*multicast_bfr_id_delete)(int,bcm_multicast_t,uint32,int,uint32 *,bcm_multicast_replication_t *);
	int (*multicast_bfr_id_get)(int,bcm_multicast_t,uint32,int,uint32 *,bcm_multicast_replication_t *);
	...
	int (*oam_pm_loss_stats_get)(int,int,bcm_oam_pm_stats_t *);
	...
	int (*pktio_rx_rate_limit_get)(int,int *);
	int (*pktio_rx_rate_limit_set)(int,int);
	...
	int (*pktio_sync_rx)(int,uint64,bcm_pktio_pkt_t **,int);
	int (*pktio_sync_rx_start)(int,uint32,uint64 *);
	int (*pktio_sync_rx_stop)(int,uint64);
	...
	int (*pktio_trace_type_get)(int,bcm_pktio_trace_type_t *);
	int (*pktio_trim)(int,bcm_pktio_pkt_t *,uint32);
	int (*pktio_tx)(int,bcm_pktio_pkt_t *);
	int (*pktio_txpmd_stat_attach)(int,uint32);
	int (*pktio_txpmd_stat_detach)(int);
	...
	int (*policer_pkt_len_adjust_profile_delete)(int,uint32,uint32);
	int (*policer_pkt_len_adjust_profile_get)(int,uint32,uint32 *,uint32 *);
	int (*policer_pkt_len_adjust_profile_set)(int,uint32,uint32,uint32);
	...
	int (*port_fast_link_recovery_enable_set)(int,bcm_port_t,int,bcm_port_flr_timeout_t);
	...
	int (*port_force_vlan_config_get)(int,bcm_port_force_vlan_config_t *);
	int (*port_force_vlan_config_set)(int,bcm_port_force_vlan_config_t *);
	...
	int (*port_lane_map_get)(int,bcm_port_t,bcm_port_lane_map_t *);
	int (*port_lane_map_set)(int,bcm_port_t,bcm_port_lane_map_t *);
	...
	int (*port_network_group_add)(int,bcm_gport_t,bcm_port_network_group_direction_t,bcm_port_network_group_t *);
	int (*port_network_group_delete)(int,bcm_gport_t,bcm_port_network_group_direction_t,bcm_port_network_group_t *);
	int (*port_network_group_get_all)(int,bcm_gport_t,bcm_port_network_group_direction_t,int,bcm_port_network_group_t *,int *);
	...
	int (*port_phy_multicast_set)(int,bcm_port_t,uint32,uint32,uint32,uint32);
	...
	int (*port_pmd_rx_lock_status_get)(int,bcm_port_t,bcm_port_pmd_rx_lock_status_t *);
	...
	int (*ptp_clock_apts_input_source_get)(int,bcm_ptp_stack_id_t,int,bcm_ptp_clock_apts_source_t,bcm_ptp_clock_apts_input_source_config_t *);
	int (*ptp_clock_apts_input_source_set)(int,bcm_ptp_stack_id_t,int,bcm_ptp_clock_apts_source_t,bcm_ptp_clock_apts_input_source_config_t *);
	...
	int (*ptp_clock_port_delay_asymmetry_get)(int,bcm_ptp_stack_id_t,int,uint32,int *);
	int (*ptp_clock_port_delay_asymmetry_set)(int,bcm_ptp_stack_id_t,int,uint32,int);
	...
	int (*ptp_clock_port_latency_get)(int,bcm_ptp_stack_id_t,int,uint32,uint32 *,uint32 *);
	...
	int (*ptp_servo_performance_get)(int,bcm_ptp_stack_id_t,int,bcm_ptp_servo_performance_t *);
	...
	int (*range_stage_oper_mode_get)(int,bcm_range_stage_t,bcm_range_oper_mode_t *);
	...
	int (*rx_sync)(int,int,bcm_pkt_t **,int);
	int (*rx_sync_start)(int,uint32,int *);
	int (*rx_sync_stop)(int,int);
	...
	int (*stat_counter_database_eviction_get)(int,uint32,bcm_stat_counter_database_t *,bcm_stat_eviction_t *);
	int (*stat_counter_database_eviction_set)(int,uint32,bcm_stat_counter_database_t *,bcm_stat_eviction_t *);
	...
	int (*switch_egress_drop_event_add)(int,bcm_switch_egress_drop_event_group_t,int,bcm_egress_drop_event_t *);
	int (*switch_egress_drop_event_delete)(int,bcm_switch_egress_drop_event_group_t,int,bcm_egress_drop_event_t *);
	int (*switch_egress_drop_event_group_create)(int,uint32,bcm_switch_egress_drop_event_group_t *);
	int (*switch_egress_drop_event_group_destroy)(int,bcm_switch_egress_drop_event_group_t);
	int (*switch_egress_drop_event_group_get)(int,bcm_switch_egress_drop_event_group_t,int,bcm_egress_drop_event_t *,int *);
	...
	int (*switch_ep_recirc_drop_event_min_get)(int,bcm_pkt_drop_event_t *,int,bcm_pkt_drop_event_t *);
	...
	int (*switch_hash_qualify_udf_class)(int,bcm_hash_entry_t,uint16,uint16);
	int (*switch_hash_qualify_udf_class_get)(int,bcm_hash_entry_t,uint16 *,uint16 *);
	...
	int (*switch_hash_tunnel_hdr_ieu_policy_get)(int,bcm_hash_entry_t,bcm_switch_hash_tunnel_hdr_ieu_policy_t *);
	int (*switch_hash_tunnel_hdr_ieu_policy_set)(int,bcm_hash_entry_t,bcm_switch_hash_tunnel_hdr_ieu_policy_t);
	...
	int (*switch_outlif_profile_group_create)(int,uint32,int *,bcm_switch_outlif_profile_group_t *);
	int (*switch_outlif_profile_group_destroy)(int,int);
	int (*switch_outlif_profile_group_get)(int,uint32,int,bcm_switch_outlif_profile_group_t *);
	...
	int (*switch_stat_event_mon_get)(int,bcm_switch_stat_event_mon_t *);
	int (*switch_stat_event_mon_set)(int,bcm_switch_stat_event_mon_t *);
	...
	int (*switch_svtag_encapsulation_add)(int,bcm_switch_svtag_encapsulation_lookup_info_t *,bcm_switch_svtag_egress_info_t *);
	int (*switch_svtag_encapsulation_delete)(int,bcm_switch_svtag_encapsulation_lookup_info_t *);
	int (*switch_svtag_encapsulation_get)(int,bcm_switch_svtag_encapsulation_lookup_info_t *,bcm_switch_svtag_egress_info_t *);
	int (*switch_svtag_encapsulation_traverse)(int,uint32,bcm_switch_svtag_encapsulation_traverse_cb,void *);
	...
	int (*swith_lt_info_get)(int,bcm_switch_pt_info_t *,int,bcm_switch_lt_info_t *,int *);
	...
	int (*time_timesync_config_profile_create)(int,bcm_time_timesync_config_profile_t *,int *);
	int (*time_timesync_config_profile_destroy)(int,int);
	int (*time_timesync_config_profile_get)(int,int,bcm_time_timesync_config_profile_t *);
	...
	int (*trunk_flow_agg_get)(int,int,int,bcm_flow_agg_info_t *);
	int (*trunk_flow_agg_set)(int,int,int,bcm_flow_agg_info_t *);
	...
	int (*trunk_member_block_get)(int,bcm_trunk_member_block_key_t *,bcm_pbmp_t *);
	int (*trunk_member_block_get_all)(int,bcm_trunk_member_block_key_t *,int,bcm_pbmp_t *,int *);
	/* bcm_trunk_member_block_key_t_init not dispatchable */
	int (*trunk_member_block_set)(int,bcm_trunk_member_block_key_t *,bcm_pbmp_t);
	int (*trunk_member_block_set_all)(int,bcm_trunk_member_block_key_t *,int,bcm_pbmp_t *);
	int (*trunk_member_delete)(int,bcm_trunk_t,bcm_trunk_member_t *);
	int (*trunk_member_delete_all)(int,bcm_trunk_t);
	int (*trunk_member_hash_range_get)(int,uint32,bcm_trunk_t,bcm_gport_t,bcm_trunk_member_range_t *);
	int (*trunk_member_hash_range_set)(int,uint32,bcm_trunk_t,bcm_gport_t,bcm_trunk_member_range_t);
	...
	int (*trunk_multi_set)(int,int,bcm_trunk_multiset_info_t *,int,bcm_trunk_member_t *);
	...
	int (*tunnel_initiator_flexctr_object_get)(int,bcm_if_t,uint32 *);
	...
	int (*tunnel_initiator_stat_attach)(int,bcm_if_t,uint32);
	int (*tunnel_initiator_stat_detach)(int,bcm_if_t);
	int (*tunnel_initiator_stat_id_get)(int,bcm_if_t,uint32 *);
...
#endif	/* INCLUDE_L3 */
	int (*twamp_sender_create)(int,bcm_twamp_sender_info_t *);
	int (*twamp_sender_delay_get)(int,bcm_twamp_sender_t,bcm_twamp_sender_dm_statistics_t *);
	int (*twamp_sender_destroy)(int,bcm_twamp_sender_t);
	/* bcm_twamp_sender_dm_statistics_t_init not dispatchable */
	int (*twamp_sender_get)(int,bcm_twamp_sender_t,bcm_twamp_sender_info_t *);
	/* bcm_twamp_sender_info_t_init not dispatchable */
	/* bcm_twamp_sender_lm_statistics_t_init not dispatchable */
	int (*twamp_sender_loss_get)(int,bcm_twamp_sender_t,bcm_twamp_sender_lm_statistics_t *);
	int (*twamp_sender_traverse)(int,uint32,bcm_twamp_sender_traverse_cb,void *);
	...
	int (*udf_tunnel_flow_based_chunk_arrange_get)(int,bcm_udf_tunnel_flow_type_t,uint32 *);
	int (*udf_tunnel_flow_based_chunk_arrange_set)(int,bcm_udf_tunnel_flow_type_t,uint32);
	int (*udf_tunnel_type_offset_max_get)(int,bcm_udf_tunnel_type_t,uint32 *);
	...
	int (*vlan_cross_connect_control_get)(int,bcm_vlan_t,bcm_vlan_t,bcm_vlan_cross_connect_control_t,int *);
	int (*vlan_cross_connect_control_set)(int,bcm_vlan_t,bcm_vlan_t,bcm_vlan_cross_connect_control_t,int);
	...
	int (*vlan_cross_connect_replace)(int,uint32,bcm_vlan_cross_connect_info_t *,bcm_vlan_cross_connect_info_t *,bcm_vlan_cross_connect_info_t *,bcm_vlan_cross_connect_info_t *);
	...
	int (*vlan_translate_egress_flexctr_extended_attach)(int,bcm_vlan_translate_egress_key_config_t *,bcm_vlan_flexctr_config_t *);
	int (*vlan_translate_egress_flexctr_extended_detach)(int,bcm_vlan_translate_egress_key_config_t *,bcm_vlan_flexctr_config_t *);
	int (*vlan_translate_egress_flexctr_extended_detach_all)(int,bcm_vlan_translate_egress_key_config_t *);
	int (*vlan_translate_egress_flexctr_extended_get)(int,bcm_vlan_translate_egress_key_config_t *,int,bcm_vlan_flexctr_config_t *,int *);
