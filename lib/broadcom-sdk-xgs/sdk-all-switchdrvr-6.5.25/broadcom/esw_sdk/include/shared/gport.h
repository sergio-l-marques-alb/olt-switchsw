/*
 * $Id: gport.h,v 1.71 Broadcom SDK $
 ...
 * GPORT_IS_FLOW_LIF            is the gport a flow lif type?
 ...
 * GPORT_FLOW_LIF_ID_GET        get a flow lif value from a gport
 * GPORT_FLOW_LIF_ID_SET        set a gport flow lif type and value
...
#define _SHR_GPORT_TYPE_FLOW_AGG           50U   /* Flow aggregation gport */
#define _SHR_GPORT_TYPE_FLOW_LIF           51U   /* Flow LIF gport */
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_FLOW_LIF   /* Used for sanity */
                                                /*
                                                 * checks only.  
                                                 */
 /*
...
#define _SHR_GPORT_PROFILE_TYPE_OCB_GLOBAL_DROP 6
#define _SHR_GPORT_PROFILE_TYPE_AQM 7
#define _SHR_GPORT_PROFILE_TYPE_GLOBAL_VOQ_BIN 8
#define _SHR_GPORT_PROFILE_TYPE_GLOBAL_VOQ_TC 9
...
#define _SHR_GPORT_FLOW_AGG_SHIFT                       0
#define _SHR_GPORT_FLOW_AGG_MASK                        0x3ffffff
...
#define _SHR_GPORT_FLOW_LIF_SHIFT                       (0)
#define _SHR_GPORT_FLOW_LIF_MASK                        (0x3FFFFFF)
...
#define _SHR_GPORT_IS_FLOW_AGG(_gport)    \
        ((((_gport) >> _SHR_GPORT_TYPE_SHIFT) & _SHR_GPORT_TYPE_MASK) == _SHR_GPORT_TYPE_FLOW_AGG)

#define _SHR_GPORT_FLOW_AGG_SET(_gport, _flow_agg_id)                              \
        ((_gport) = (_SHR_GPORT_TYPE_FLOW_AGG      << _SHR_GPORT_TYPE_SHIFT)  | \
         (((_flow_agg_id) & _SHR_GPORT_FLOW_AGG_MASK) << _SHR_GPORT_FLOW_AGG_SHIFT))

#define _SHR_GPORT_FLOW_AGG_GET(_gport)   \
        (((_gport) >> _SHR_GPORT_FLOW_AGG_SHIFT) & _SHR_GPORT_FLOW_AGG_MASK)
...
#define _SHR_GPORT_IS_FLOW_LIF(_gport)    \
        (((_gport) >> _SHR_GPORT_TYPE_SHIFT) == _SHR_GPORT_TYPE_TUNNEL)

#define _SHR_GPORT_FLOW_LIF_ID_SET(_gport, _tunnel_id)                       \
        ((_gport) = (_SHR_GPORT_TYPE_TUNNEL   << _SHR_GPORT_TYPE_SHIFT)  | \
         (((_tunnel_id) & _SHR_GPORT_TUNNEL_MASK) << _SHR_GPORT_TUNNEL_SHIFT))

#define _SHR_GPORT_FLOW_LIF_ID_GET(_gport)   \
        (((_gport) >> _SHR_GPORT_TUNNEL_SHIFT) & _SHR_GPORT_TUNNEL_MASK)
...
#define _SHR_GPORT_IS_OCB_GLOBAL_DROP_PROFILE(_gport) \
        (_SHR_GPORT_IS_ANY_PROFILE(_gport) &&        \
        ((((_gport) >> _SHR_GPORT_PROFILE_TYPE_SHIFT) & _SHR_GPORT_PROFILE_TYPE_MASK) == _SHR_GPORT_PROFILE_TYPE_OCB_GLOBAL_DROP))

#define _SHR_GPORT_IS_AQM_PROFILE(_gport) \
        (_SHR_GPORT_IS_ANY_PROFILE(_gport) &&        \
        ((((_gport) >> _SHR_GPORT_PROFILE_TYPE_SHIFT) & _SHR_GPORT_PROFILE_TYPE_MASK) == _SHR_GPORT_PROFILE_TYPE_AQM))

#define _SHR_GPORT_IS_GLOBAL_VOQ_BIN_PROFILE(_gport) \
        (_SHR_GPORT_IS_ANY_PROFILE(_gport) &&        \
        ((((_gport) >> _SHR_GPORT_PROFILE_TYPE_SHIFT) & _SHR_GPORT_PROFILE_TYPE_MASK) == _SHR_GPORT_PROFILE_TYPE_GLOBAL_VOQ_BIN))

#define _SHR_GPORT_IS_GLOBAL_VOQ_TC_PROFILE(_gport) \
        (_SHR_GPORT_IS_ANY_PROFILE(_gport) &&        \
        ((((_gport) >> _SHR_GPORT_PROFILE_TYPE_SHIFT) & _SHR_GPORT_PROFILE_TYPE_MASK) == _SHR_GPORT_PROFILE_TYPE_GLOBAL_VOQ_TC))
...
#define _SHR_GPORT_OCB_GLOBAL_DROP_PROFILE_GET(_gport)   \
        _SHR_GPORT_PROFILE_GET(_gport)

#define _SHR_GPORT_AQM_PROFILE_GET(_gport)   \
        _SHR_GPORT_PROFILE_GET(_gport)

#define _SHR_GPORT_GLOBAL_VOQ_BIN_PROFILE_GET(_gport)   \
        _SHR_GPORT_PROFILE_GET(_gport)

#define _SHR_GPORT_GLOBAL_VOQ_TC_PROFILE_GET(_gport)   \
        _SHR_GPORT_PROFILE_GET(_gport)
...
#define _SHR_GPORT_OCB_GLOBAL_DROP_PROFILE_SET(_gport, _profile)                              \
        ((_gport) = (_SHR_GPORT_TYPE_PROFILE << _SHR_GPORT_TYPE_SHIFT)  |                    \
        (_SHR_GPORT_PROFILE_TYPE_OCB_GLOBAL_DROP << _SHR_GPORT_PROFILE_TYPE_SHIFT) |           \
        (((_profile) & _SHR_GPORT_PROFILE_MASK) << _SHR_GPORT_PROFILE_SHIFT))

#define _SHR_GPORT_AQM_PROFILE_SET(_gport, _profile)                              \
        ((_gport) = (_SHR_GPORT_TYPE_PROFILE << _SHR_GPORT_TYPE_SHIFT)  |                    \
        (_SHR_GPORT_PROFILE_TYPE_AQM << _SHR_GPORT_PROFILE_TYPE_SHIFT) |           \
        (((_profile) & _SHR_GPORT_PROFILE_MASK) << _SHR_GPORT_PROFILE_SHIFT))

#define _SHR_GPORT_GLOBAL_VOQ_BIN_PROFILE_SET(_gport, _profile)                              \
        ((_gport) = (_SHR_GPORT_TYPE_PROFILE << _SHR_GPORT_TYPE_SHIFT)  |                    \
        (_SHR_GPORT_PROFILE_TYPE_GLOBAL_VOQ_BIN << _SHR_GPORT_PROFILE_TYPE_SHIFT) |           \
        (((_profile) & _SHR_GPORT_PROFILE_MASK) << _SHR_GPORT_PROFILE_SHIFT))

#define _SHR_GPORT_GLOBAL_VOQ_TC_PROFILE_SET(_gport, _profile)                              \
        ((_gport) = (_SHR_GPORT_TYPE_PROFILE << _SHR_GPORT_TYPE_SHIFT)  |                    \
        (_SHR_GPORT_PROFILE_TYPE_GLOBAL_VOQ_TC << _SHR_GPORT_PROFILE_TYPE_SHIFT) |           \
        (((_profile) & _SHR_GPORT_PROFILE_MASK) << _SHR_GPORT_PROFILE_SHIFT))
...
#define _SHR_GPORT_SUB_TYPE_IN_LIF                      (1)
#define _SHR_GPORT_SUB_TYPE_OUT_LIF                     (2)
...
/**
 * \brief
 *  Used to hold handles to ingress glifless native logical
 *  interfaces and non-native
 */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NATIVE      (4)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS             (4)
...
/* SUB GPORT VIRTUAL INGRESS NATIVE / Non-Native */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NATIVE_SHIFT    (0)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NATIVE_MASK     (0x3FFFFF)

#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SHIFT           (0)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_MASK            (0x3FFFFF)
...
/* given gport returns whether this is an IN_LIF / OUT_LIF subtype */
#define _SHR_GPORT_SUB_TYPE_IS_IN_LIF(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_IN_LIF)

#define _SHR_GPORT_SUB_TYPE_IS_OUT_LIF(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_OUT_LIF)
...
#define _SHR_GPORT_SUB_TYPE_IS_TRILL_OUTLIF(_gport)             \
 ...
 /*
  * given gport return if the sub-type is Virtual Ingress native / Non-Native
  */
...
#define _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_INGRESS(_gport)             \
     ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS)
...
/* Get GPORT subvalues of subtypes IN_LIF & OUT_LIF */
#define _SHR_GPORT_SUB_TYPE_IN_LIF_VAL_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_IN_LIF) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_LIF_SHIFT) & _SHR_GPORT_SUB_TYPE_LIF_MASK) :-1)

#define _SHR_GPORT_SUB_TYPE_OUT_LIF_VAL_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_OUT_LIF) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_LIF_SHIFT) & _SHR_GPORT_SUB_TYPE_LIF_MASK) :-1)
...
#define _SHR_GPORT_SUB_TYPE_TRILL_OUTLIF_GET(_gport) \
 ...
 /*
  * Get GPORT subvalue of subtype Virtual INGRESS NATIVE / Non-Native
  */
...
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_GET(_gport) \
     ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS) ? \
      (((_gport) >> _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SHIFT) & _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_MASK):-1)
...
/* Get Flow GPORT LIF value with no subtype encoding */
#define _SHR_GPORT_FLOW_LIF_VAL_GET(_gport) \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_LIF_SHIFT) & _SHR_GPORT_SUB_TYPE_LIF_MASK)
#define _SHR_GPORT_FLOW_LIF_EXC_GET(_gport) \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_LIF_EXC_SHIFT) & _SHR_GPORT_SUB_TYPE_LIF_EXC_MASK)
...
/* Set GPORT subvalue and subtype IN_LIF / OUT_LIF */
#define _SHR_GPORT_SUB_TYPE_IN_LIF_SET(_gport, _in_lif_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_IN_LIF << _SHR_GPORT_SUB_TYPE_SHIFT) | \
      (((_in_lif_val) & _SHR_GPORT_SUB_TYPE_LIF_MASK) << _SHR_GPORT_SUB_TYPE_LIF_SHIFT))

#define _SHR_GPORT_SUB_TYPE_OUT_LIF_SET(_gport, _out_lif_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_OUT_LIF << _SHR_GPORT_SUB_TYPE_SHIFT) | \
      (((_out_lif_val) & _SHR_GPORT_SUB_TYPE_LIF_MASK) << _SHR_GPORT_SUB_TYPE_LIF_SHIFT))
...
/* Set GPORT subvalue and subtype Virtual Ingress Native / Non-Native */
...
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SET(_gport, _virtual_val) \
     ((_gport) = (_SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
       (((_virtual_val) & _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_MASK) << _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SHIFT))
...
/* Set GPORT FLOW LIF and subtype LIF without the FLOW type encoding */
#define _SHR_GPORT_FLOW_LIF_SET(_gport, _exc_val, _lif_val) \
         ((_gport) = (((_exc_val) & _SHR_GPORT_SUB_TYPE_LIF_EXC_MASK) << _SHR_GPORT_SUB_TYPE_LIF_EXC_SHIFT) | \
          (((_lif_val) & _SHR_GPORT_SUB_TYPE_LIF_MASK) << _SHR_GPORT_SUB_TYPE_LIF_SHIFT))
...
#define _SHR_L3_ITF_LIF_TO_GPORT_FLOW_LIF(_gport_flow_lif, _l3_itf_lif)         \
    do \
    {                                       \
        if (_SHR_L3_ITF_TYPE_IS_LIF(_l3_itf_lif)) \
        {                                         \
            ...
            {                       \
                int gport_id_dummy; \
                _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_POINTED_SET(gport_id_dummy, _SHR_L3_ITF_SUB_TYPE_VIRTUAL_EGRESS_POINTED_GET(_l3_itf_lif)); \
                _SHR_GPORT_FLOW_LIF_ID_SET(_gport_flow_lif, gport_id_dummy);     \
            }    \
            else if (_SHR_L3_ITF_SUB_TYPE_IS_NOT_ENCODED(_l3_itf_lif))       \
            {    \
                _SHR_GPORT_FLOW_LIF_ID_SET(_gport_flow_lif, _SHR_L3_ITF_VAL_GET(_l3_itf_lif));\
            }    \
            else     \
            {        \
                _gport_flow_lif=_SHR_GPORT_INVALID;\
            }        \
        }        \
        else     \
        {        \
...
#define _SHR_GPORT_FLOW_LIF_TO_L3_ITF_LIF(_l3_itf_lif , _gport_flow_lif)    \
    do \
    { \
        int _gport_flow_lif_val;                   \
        if (_SHR_GPORT_IS_FLOW_LIF(_gport_flow_lif)) \
        {                                        \
            if (_SHR_GPORT_SUB_TYPE_IS_VIRTUAL_EGRESS_POINTED(_gport_flow_lif))         \
            {                        \
                int l3_itf_id_dummy; \
                _SHR_L3_ITF_SUB_TYPE_VIRTUAL_EGRESS_POINTED_SET(l3_itf_id_dummy, _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_POINTED_GET(_gport_flow_lif)); \
                _SHR_L3_ITF_SET(_l3_itf_lif, _SHR_L3_ITF_TYPE_LIF, l3_itf_id_dummy);  \
            }                        \
            else                     \
            {                        \
                _gport_flow_lif_val = _SHR_GPORT_FLOW_LIF_ID_GET(_gport_flow_lif);          \
                _SHR_L3_ITF_SET(_l3_itf_lif, _SHR_L3_ITF_TYPE_LIF, _gport_flow_lif_val);\
            } \
        }     \
        else  \
        {     \
