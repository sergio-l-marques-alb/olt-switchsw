...
#ifndef _SHR_SW_STATE_DPP_SOC_ARAD_TM_Q_TYPE_REF_COUNT_DIAGNOSTIC_H_
#define _SHR_SW_STATE_DPP_SOC_ARAD_TM_Q_TYPE_REF_COUNT_DIAGNOSTIC_H_
...
/* implemented by: sw_state_dpp_soc_arad_tm_q_type_ref_count_dump */
typedef int (*sw_state_dpp_soc_arad_tm_q_type_ref_count_dump_cb)(
...
int sw_state_dpp_soc_arad_tm_q_type_ref_count_diagnostic_cb_init(int unit);

#endif /* BCM_WARM_BOOT_SUPPORT */

#endif /* _SHR_SW_STATE_DPP_SOC_ARAD_TM_Q_TYPE_REF_COUNT_DIAGNOSTIC_H_ */
