...
typedef enum bcm_range_type_e {
    ...
    bcmRangeTypeResidenceTimestamp = 7, /* Check Residence time stamp range. */
    bcmRangeTypeEgressPort = 8,         /* Check Egress port range. */
    bcmRangeTypeIngressPort = 9,        /* Check Ingress port range. */
    bcmRangeTypeCount = 10              /* Always last. Not a usable value. */
} bcm_range_type_t;
...
/* bcm_range_stage_e */
typedef enum bcm_range_stage_e {
    bcmRangeStageIngress = 0,   /* Range Stage Ingress. */
    bcmRangeStageEgress = 1,    /* Range Stage Egress */
    bcmRangeStageCount = 2      /* Always last. Not a usable value. */
} bcm_range_stage_t;

#define BCM_RANGE_STAGE \
{ \
    "Ingress", \
    "Egress", \
    "Count"  \
...
#define BCM_RANGE_CREATE_STAGE_EGRESS   (1 << 1)   

/* ID Base for Stage Ingress Range. */
#define BCM_RANGE_ING_ID_BASE   (0x00000000) 

/* ID Base for Stage Egress Range. */
#define BCM_RANGE_EGR_ID_BASE   (0x01000000) 

/* Mask for stage Ids. */
#define BCM_RANGE_ID_MASK       (0x00FFFFFF) 
...
/* Get Operational mode of Range stage */
extern int bcm_range_stage_oper_mode_get(
    int unit, 
