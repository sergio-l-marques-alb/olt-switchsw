...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchL3McastL2 = 719,           /* Not elegible for routing, IPv4
                                           compatible MC forwarding mode. if set
                                           to 0: Bridge forwarding, if set to 1:
                                           Bridge v4MC forwarding. */
    ...
    bcmSwitchMirrorPsampIpfixVersion = 1223, /* Set packet sampling (PSAMP) IP flow
                                           ...
                                           number. */
    bcmSwitchLlcHeaderControlMode = 1224, /* When set value=1 LLC header control
                                           bits located in 1:0 selected, value=0
                                           bits 7:6 selected. */
    bcmSwitchPcieHotSwapDisable = 1225, /* When set value=1 PCIE hot swap
                                           manager is disabled. To re-enable it,
                                           set value=0. Applicable for CMICX
                                           based devices and Monterey only */
    ...
    bcmSwitchFlowCountStatAttach = 1369, /* Attach the stat counter ID (arg) to
                                           flow count. Counter is detached when
                                           arg is 0. */
    ...
    bcmSwitchEgressFlexCounterPresel = 1446, /* Pre-select to count mirror packets or
                                           ...
                                           counter. */
    bcmSwitchHashUseFlowSelEcmpDynamic = 1447, /* Enable/Disable flow based hashing for
                                           DLB ECMP. */
    bcmSwitchL3IP6McastL2 = 1448,       /* Not elegible for routing, IPv6
                                           compatible MC forwarding mode. if set
                                           to 0: Bridge forwarding, if set to 1:
                                           Bridge v6MC forwarding. */
    bcmSwitchL2LearnLimitCheckStatic = 1449, /* Disable/Enable limit checking for
                                           static entry. */
    bcmSwitchMplsEvpnEntropyEnable = 1450, /* Enable Entropy Label in MPLS EVPN. 0:
                                           disable; 1: enable entropy label; 2:
                                           enable entropy with Control Word. 3:
                                           enable both. Default value is 3. */
    bcmSwitchEgressRawResidenceTimeDelta = 1451, /* Time in nano-second that is added to
                                           residence time to adjust latency. */
    bcmSwitchEgressRawResidenceTimeRightShift = 1452, /* Right shift (in number of bits)
                                           residence time to adjust latency. */
    bcmSwitchL3MplsDefaultNetworkInterface = 1453, /* Specify the default network L3 IIF to
                                           use when L3 MPLS termination lookup
                                           fails */
    bcmSwitchFlowCountPortContextSelect = 1454, /* Specify the source for port context. */
    bcmSwitchFlowCountPortContextHashShift = 1455, /* Specify the right shift amount
                                           applied to the hash value generated
                                           by RTAG7 hash for port context. */
    bcmSwitchFlowCountPortContextHashMask = 1456, /* Specify the mask ORed to the hash
                                           value generated by RTAG7 hash for
                                           port context. */
    bcmSwitchMplsFlowInstructionIndicatorSpecialLabel = 1457, /* Flow Insutruction Indicator Label
                                           value for IFIT */
    bcmSwitchOamAdditionalGalSpecialLabel = 1458, /* Set the value of an additional GAL
                                           (other than 13). Use value 13 to
                                           disable. */
    bcmSwitchIpmcRiotL3InterfaceCheck = 1459, /* Enable to do L2 switching of VXLAN
                                           terminated packets with IPMC payload
                                           and are not associated with an
                                           incoming L3 interface(L3_IIF). */
    bcmSwitchIpv6NextProtocolEthernet = 1460, /* Indicate the next protocol value for
                                           Eth - either 143 or 59. */
    bcmSwitchFlexe1588RxDestMacOui = 1461, /* The upper 3 bytes for matching FlexE
                                           1588 destination MAC from external
                                           processor. */
    bcmSwitchFlexe1588RxDestMacNonOui = 1462, /* The lower 3 bytes for matching FlexE
                                           1588 destination MAC from external
                                           processor. */
    bcmSwitchFlexe1588RxSrcMacOui = 1463, /* The upper 3 bytes for matching FlexE
                                           1588 source MAC from external
                                           processor. */
    bcmSwitchFlexe1588RxSrcMacNonOui = 1464, /* The lower 3 bytes for matching FlexE
                                           1588 source MAC from external
                                           processor. */
    bcmSwitchFlexe1588TxDestMacOui = 1465, /* The upper 3 bytes for FlexE 1588
                                           destination MAC encapsulation to
                                           external processor */
    bcmSwitchFlexe1588TxDestMacNonOui = 1466, /* The lower 3 bytes for FlexE 1588
                                           destination MAC encapsulation to
                                           external processor. */
    bcmSwitchFlexe1588TxSrcMacOui = 1467, /* The upper 3 bytes for FlexE 1588
                                           source MAC encapsulation to external
                                           processor. */
    bcmSwitchFlexe1588TxSrcMacNonOui = 1468, /* The lower 3 bytes for FlexE 1588
                                           source MAC encapsulation to external
                                           processor. */
    bcmSwitchIFA2TruncationHdrLenUpdate = 1469, /* Enable IP header length update for
                                           truncated IFA2 packet. */
    bcmSwitchIFA2OverLAG = 1470,        /* Enable IFA2 over LAG, two-pass model. */
    bcmSwitchMplsLastTermMode = 1471,   /* MPLS last termination mode. */
    bcmSwitchMplsEvpnEnable = 1472,     /* Enable mpls evpn feature. */
    bcmSwitchMplsEvpnEsiFilterEnable = 1473, /* Enable mpls evpn ESI filter. */
    bcmSwitchMplsEvpnVlanAwareModeEnable = 1474, /* Enable mpls evpn vlan aware mode. */
    bcmSwitchExternalTablePropXlDb = 1475, /* XL DB property for external tables. */
    bcmSwitchIngressVlanEditClassNull = 1476, /* Enable/Disable a reserved value to be
                                           a NULL vlan edit class. */
    bcmSwitchFlexeBasOamToExtProcessorEnable = 1477, /* Enable FlexE BAS OAM to external
                                           processor */
    bcmSwitchDbgCntTxSvpRemoveDropSkipEnable = 1478, /* Do not count the dropped packets due
                                           to L2 source port pruning for DLF,
                                           VPLAG, IPMC (L2 copies replication)
                                           for VP flows. So snmpIfOutDiscards
                                           stats counter will also skip those
                                           packets. This feature is disabled by
                                           default. */
    bcmSwitchPointToPointTunnelTermLearnDisable = 1479, /* Disable mac-learning on VPWS
                                           termination flows. */
    bcmSwitchCoePauseOpcode = 1480,     /* Set/get the opcode value for COE
                                           PAUSE flow control. */
    bcmSwitchCoePfcOpcode = 1481,       /* Set/get the opcode value for COE PFC
                                           flow control. */
    bcmSwitchCoeE2eccOpcode = 1482,     /* Set/get the opcode value for COE
                                           E2ECC flow control. */
    bcmSwitchCoeFcEtherType = 1483,     /* Set/get the ether type for COE PAUSE,
                                           PFC and E2ECC flow control packets. */
    bcmSwitchTunnelRouteDisable = 1484, /* Disables Routing for certain Tunnels */
    bcmSwitchControlVxlanDipSipLookupSVPEnable = 1485, /* Enables SVP derivation based on Dip
                                           and Sip during Vxlan tunnel
                                           termination, which is by default
                                           based only on SIP. Note that when
                                           switching between the two methods,
                                           all existing related config need to
                                           be reset */
    bcmSwitchHashField0Bin0Bin3DstPortEnable = 1486, /* Enables DST_PORTID within Hash BIN-0
                                           and BIN-3 of enhanced hash mode 0. */
    bcmSwitchHashField1Bin0Bin3DstPortEnable = 1487, /* Enables DST_PORTID within Hash BIN-0
                                           and BIN-3 of enhanced hash mode 1. */
    bcmSwitchHashField0IPTunnelTerm = 1488, /* Enable selection for IP tunnel
                                           terminated packets in hash mode 0. */
    bcmSwitchHashField1IPTunnelTerm = 1489, /* Enable selection for IP tunnel
                                           terminated packets in hash mode 1. */
    bcmSwitchEcmpFailoverHashOffset = 1490, /* Enhanced hash select for failover
                                           ECMP hashing. */
    bcmSwitchMacroFlowEcmpFailoverHashConcatEnable = 1491, /* Enable hash concatenation in macro
                                           flow based hashing for Failover ECMP. */
    bcmSwitchMacroFlowEcmpFailoverHashMinOffset = 1492, /* Minimum offset value to be used in
                                           macro flow based hashing for Failover
                                           ECMP. */
    bcmSwitchMacroFlowEcmpFailoverHashMaxOffset = 1493, /* Maximum offset value to be used in
                                           macro flow based hashing for Failover
                                           ECMP. */
    bcmSwitchMacroFlowEcmpFailoverHashStrideOffset = 1494, /* Offset increment value to be used in
                                           macro flow based hashing for Failover
                                           ECMP. */
    bcmSwitchHashForceL2Field = 1495,   /* Add terminated L2 into hash
                                           selections */
    bcmSwitchFlexeOhOamPktDestMacOui = 1496, /* The upper 3 bytes for FlexE OH/OAM
                                           packet destination MAC encapsulation
                                           to external processor */
    bcmSwitchFlexeOhOamPktDestMacNonOui = 1497, /* The lower 3 bytes for FlexE OH/OAM
                                           packet destination MAC encapsulation
                                           to external processor. */
    bcmSwitchFlexeOhOamPktSrcMacOui = 1498, /* The upper 3 bytes for FlexE OH/OAM
                                           packet source MAC encapsulation to
                                           external processor. */
    bcmSwitchFlexeOhOamPktSrcMacNonOui = 1499, /* The lower 3 bytes for FlexE OH/OAM
                                           packet source MAC encapsulation to
                                           external processor. */
    bcmSwitchMplsSpecialLabelPerPortTerminateDisable = 1500, /* Per port disable the auto termination
                                           for MPLS special label */
    bcmSwitchTagInputPriSelect = 1501,  /* Select input priority source for
                                           tagged packets. */
    bcmSwitchUntagInputPriSelect = 1502, /* Select input priority source for
                                           untagged packets. */
    bcmSwitchFlexe1588OverEthRxUnicastDestMacOui = 1503, /* The upper 3 bytes to match FlexE 1588
                                           over ETH packet unicast DA from
                                           external processor. */
    bcmSwitchFlexe1588OverEthRxUnicastDestMacNonOui = 1504, /* The lower 3 bytes to match FlexE 1588
                                           over ETH packet unicast DA from
                                           external processor. */
    bcmSwitchFlexe1588OverEthTxUnicastDestMacOui = 1505, /* The upper 3 bytes to match FlexE 1588
                                           over ETH packet unicast DA to
                                           external processor. */
    bcmSwitchFlexe1588OverEthTxUnicastDestMacNonOui = 1506, /* The lower 3 bytes to match FlexE 1588
                                           over ETH packet unicast DA to
                                           external processor. */
    bcmSwitchMacroFlowHashUnderlayMaxOffset = 1507, /* Maximum offset value to be used in
                                           overlay ECMP offset table */
    bcmSwitchMacroFlowHashUnderlayStrideOffset = 1508, /* Offset increment to be used for
                                           populating overlay ECMP offset table. */
    bcmSwitchMacroFlowHashUnderlayMinOffset = 1509, /* Minimum offset value to be used in
                                           overlay ECMP offset table */
    bcmSwitchFlexe1588OverIpv4RxUnicastDestIpHigh = 1510, /* The upper 2 bytes to match FlexE 1588
                                           over Ipv4 packet unicast DIP from
                                           external processor. */
    bcmSwitchFlexe1588OverIpv4RxUnicastDestIpLow = 1511, /* The lower 2 bytes to match FlexE 1588
                                           over Ipv4 packet unicast DIP from
                                           external processor. */
    bcmSwitchFlexe1588OverIpv4TxUnicastDestIpHigh = 1512, /* The upper 2 bytes to match FlexE 1588
                                           over Ipv4 packet unicast DIP to
                                           external processor. */
    bcmSwitchFlexe1588OverIpv4TxUnicastDestIpLow = 1513, /* The lower 2 bytes to match FlexE 1588
                                           over Ipv4 packet unicast DIP to
                                           external processor. */
    bcmSwitchHashIP6Field = 1514,       /* Hash selections for IPv6 headers */
    bcmSwitchIngressFlexCounterCpuTxBypass = 1515, /* Bypass counting CPU TX packets in
                                           ingress flex counter. */
    bcmSwitchL2TunnelPayloadSgppTpidDisable = 1516, /* Requires BROADCOM_PREMIUM license */
    bcmSwitchHashUseFlowSelEcmpFailover = 1517, /* Enable/Disable flow based hashing for
                                           ECMP Failover. */
    bcmSwitchDopTriggerEnable = 1518,   /* Enable DOP trigger for non
                                           CPU-injected packets. */
    bcmSwitchSrv6GsidPrefixBits = 1519, /* Allow support of multiple GSID prefix
                                           sizes */
    bcmSwitchFailoverDownDrop = 1520,   /* Drop the packet if protection status
                                           is down. */
    bcmSwitchFailoverDownToCpu = 1521,  /* Enable copy packets to CPU if
                                           protection status is down. */
    bcmSwitchL3DefaultTrafficClass = 1522, /* Default traffic class value used in
                                           L3 route and Ingress FP/Exact Match
                                           lookup keys */
    bcmSwitchFlexeOamBasBipRecalculationEnable = 1523, /* Enable/disable the recalculation of
                                           BIP in FlexE BAS OAM. */
    bcmSwitchFlexeOamBasPeriodMismatchTriggerLosAlarm = 1524, /* Configure if the FlexE BAS OAM period
                                           mismatch trigger BAS LOS alarm. */
    bcmSwitchIpucRiotL3InterfaceCheck = 1525, /* Enable to do L2 switching of VXLAN
                                           terminated packets with unicast
                                           IPv4/IPv6 payload and are not
                                           associated with an incoming L3
                                           interface(L3_IIF). */
    bcmSwitchEcmpFailoverLevel2RandomSeed = 1526, /* Random seed value for level2
                                           (underlay) two level 1:1 ECMP
                                           failover groups. */
    bcmSwitchSrv6PayloadTpid = 1527,    /* SRv6 payload outer TPID. */
    bcmSwitchSrv6Adapt1MatchPayloadOvidEnable = 1528, /* Match SRv6 payload outer vlan in
                                           adaptation table1. */
    bcmSwitchSrv6Adapt2MatchPayloadOvidEnable = 1529, /* Match SRv6 payload outer vlan in
                                           adaptation table2. */
    bcmSwitchSrv6Adapt1SrhAction = 1530, /* SRv6 with SRH function selection in
                                           adaptation table1. */
    bcmSwitchSrv6Adapt2SrhAction = 1531, /* SRv6 with SRH function selection in
                                           adaptation table2. */
    bcmSwitchSrv6Adapt4SrhAction = 1532, /* SRv6 with SRH function selection in
                                           adaptation table4. */
    bcmSwitchSrv6Adapt1NonSrhAction = 1533, /* SRv6 without SRH function selection
                                           in adaptation table1. */
    bcmSwitchSrv6Adapt2NonSrhAction = 1534, /* SRv6 without SRH function selection
                                           in adaptation table2. */
    bcmSwitchSrv6Adapt4NonSrhAction = 1535, /* SRv6 without SRH function selection
                                           in adaptation table4. */
    bcmSwitchSrv6Adapt1DipPrefix1Len = 1536, /* SRv6 DIP prefix 1 length in
                                           adaptation table1. */
    bcmSwitchSrv6Adapt2DipPrefix1Len = 1537, /* SRv6 DIP prefix 1 length in
                                           adaptation table2. */
    bcmSwitchSrv6Adapt4DipPrefix1Len = 1538, /* SRv6 DIP prefix 1 length in
                                           adaptation table4. */
    bcmSwitchSrv6Adapt1MatchNextHeaderEnable = 1539, /* SRv6 next header match enable in
                                           adaptation table1. */
    bcmSwitchSrv6Adapt2MatchNextHeaderEnable = 1540, /* SRv6 next header match enable in
                                           adaptation table2. */
    bcmSwitchSrv6Adapt4MatchNextHeaderEnable = 1541, /* SRv6 next header match enable in
                                           adaptation table4. */
    bcmSwitchSrv6SidMode = 1542,        /* SRv6 sid mode. */
    bcmSwitchSrv6UsidPrefix1 = 1543,    /* SRv6 micro SID prefix1 length. */
    bcmSwitchSrv6UsidPrefix2 = 1544,    /* SRv6 micro SID prefix2 length. */
    bcmSwitchSrv6GsidPrefix1 = 1545,    /* SRv6 Generalized SID prefix1 length. */
    bcmSwitchSrv6GsidPrefix2 = 1546,    /* SRv6 Generalized SID prefix2 length. */
    bcmSwitchSrv6FunctionSelect1 = 1547, /* SRv6 SID function field size and
                                           offset selection 1. */
    bcmSwitchEcmpMemberTableSize = 1548, /* Read-only, and returns the size of
                                           the ECMP Member Table. */
    bcmSwitchDbgCntTxMcDropSkipEnable = 1549, /* Do not count any multicast packet
                                           drop at the egress. This feature is
                                           disabled by default. */
    bcmSwitchSrv6FunctionSelect2 = 1550, /* SRv6 SID function field size and
                                           offset selection 2. */
    bcmSwitchSrv6EsiFilterEnable = 1551, /* SRv6 enable ESI filter. */
    bcmSwitchSrv6EsiInsertEnable = 1552, /* SRv6 enable ESI insert. */
    bcmSwitchSrv6EsiOffsetSelect = 1553, /* SRv6 ESI offset starting bit select. */
    bcmSwitchSrv6RwUpperBitsDuringSwap = 1554, /* SRv6 RW upper 96 bits during 128bits
                                           swap. */
    bcmSwitchSrv6IngLookupSipAssignSvp = 1555, /* SRv6 looks up SIP and assign SVP at
                                           ingress. */
    bcmSwitchSrv6Adapt1DipPrefix2Len = 1556, /* SRv6 DIP prefix 2 length in
                                           adaptation table1. */
    bcmSwitchSrv6Adapt2DipPrefix2Len = 1557, /* SRv6 DIP prefix 2 length in
                                           adaptation table2. */
    bcmSwitchSrv6Adapt4DipPrefix2Len = 1558, /* SRv6 DIP prefix 2 length in
                                           adaptation table4. */
    bcmSwitchEcmpMode = 1559,           /* Read-only, and returns the ECMP Mode. */
    bcmSwitchOutlifProfileGroupApp = 1560, /* Define OutLIF profile group for a
                                           certain application. */
    bcmSwitchBufUseMode = 1561,         /* Cosq buffer usage mode. Auto: 0,
                                           Manual: 1. In Manual mode, MMU
                                           settings will not be overwritten
                                           during a port speed set (non
                                           flexport). In Auto mode, settings
                                           will default to architecture
                                           specified values. */
    bcmSwitchSynchronousPortClockSourceSet1 = 1562, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Configure master clock to set1. */
    bcmSwitchSynchronousPortClockSourceSet1DivCtrl = 1563, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Selects master clock divide to set1. */
    bcmSwitchSynchronousPortClockSourceBkupSet1 = 1564, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Configure slave clock to set1. */
    bcmSwitchSynchronousPortClockSourceBkupSet1DivCtrl = 1565, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Selects slave clock divide to set1. */
    bcmSwitchEgressUDHBaseFieldCsMap = 1566, /* Map egress UDH base to UDH base CS
                                           var. */
    bcmSwitch__Count = 1567             /* Must be last.  Not a usable value. */
...
#define BCM_SWITCH_CONTROL_STR \
    ...
    "HashUseFlowSelEcmpDynamic", \
    "L3IP6McastL2", \
    "L2LearnLimitCheckStatic", \
    "MplsEvpnEntropyEnable", \
    "EgressRawResidenceTimeDelta", \
    "EgressRawResidenceTimeRightShift", \
    "L3MplsDefaultNetworkInterface", \
    "FlowCountPortContextSelect", \
    "FlowCountPortContextHashShift", \
    "FlowCountPortContextHashMask", \
    "MplsFlowInstructionIndicatorSpecialLabel", \
    "OamAdditionalGalSpecialLabel", \
    "IpmcRiotL3InterfaceCheck", \
    "Ipv6NextProtocolEthernet", \
    "Flexe1588RxDestMacOui", \
    "Flexe1588RxDestMacNonOui", \
    "Flexe1588RxSrcMacOui", \
    "Flexe1588RxSrcMacNonOui", \
    "Flexe1588TxDestMacOui", \
    "Flexe1588TxDestMacNonOui", \
    "Flexe1588TxSrcMacOui", \
    "Flexe1588TxSrcMacNonOui", \
    "IFA2TruncationHdrLenUpdate", \
    "IFA2OverLAG", \
    "MplsLastTermMode", \
    "MplsEvpnEnable", \
    "MplsEvpnEsiFilterEnable", \
    "MplsEvpnVlanAwareModeEnable", \
    "ExternalTablePropXlDb", \
    "IngressVlanEditClassNull", \
    "FlexeBasOamToExtProcessorEnable", \
    "DbgCntTxSvpRemoveDropSkipEnable", \
    "PointToPointTunnelTermLearnDisable", \
    "CoePauseOpcode", \
    "CoePfcOpcode", \
    "CoeE2eccOpcode", \
    "CoeFcEtherType", \
    "TunnelRouteDisable", \
    "ControlVxlanDipSipLookupSVPEnable", \
    "HashField0Bin0Bin3DstPortEnable", \
    "HashField1Bin0Bin3DstPortEnable", \
    "HashField0IPTunnelTerm", \
    "HashField1IPTunnelTerm", \
    "EcmpFailoverHashOffset", \
    "MacroFlowEcmpFailoverHashConcatEnable", \
    "MacroFlowEcmpFailoverHashMinOffset", \
    "MacroFlowEcmpFailoverHashMaxOffset", \
    "MacroFlowEcmpFailoverHashStrideOffset", \
    "HashForceL2Field", \
    "FlexeOhOamPktDestMacOui", \
    "FlexeOhOamPktDestMacNonOui", \
    "FlexeOhOamPktSrcMacOui", \
    "FlexeOhOamPktSrcMacNonOui", \
    "MplsSpecialLabelPerPortTerminateDisable", \
    "TagInputPriSelect", \
    "UntagInputPriSelect", \
    "Flexe1588OverEthRxUnicastDestMacOui", \
    "Flexe1588OverEthRxUnicastDestMacNonOui", \
    "Flexe1588OverEthTxUnicastDestMacOui", \
    "Flexe1588OverEthTxUnicastDestMacNonOui", \
    "MacroFlowHashUnderlayMaxOffset", \
    "MacroFlowHashUnderlayStrideOffset", \
    "MacroFlowHashUnderlayMinOffset", \
    "Flexe1588OverIpv4RxUnicastDestIpHigh", \
    "Flexe1588OverIpv4RxUnicastDestIpLow", \
    "Flexe1588OverIpv4TxUnicastDestIpHigh", \
    "Flexe1588OverIpv4TxUnicastDestIpLow", \
    "HashIP6Field", \
    "IngressFlexCounterCpuTxBypass", \
    "L2TunnelPayloadSgppTpidDisable", \
    "HashUseFlowSelEcmpFailover", \
    "DopTriggerEnable", \
    "Srv6GsidPrefixBits", \
    "FailoverDownDrop", \
    "FailoverDownToCpu", \
    "L3DefaultTrafficClass", \
    "FlexeOamBasBipRecalculationEnable", \
    "FlexeOamBasPeriodMismatchTriggerLosAlarm", \
    "IpucRiotL3InterfaceCheck", \
    "EcmpFailoverLevel2RandomSeed", \
    "Srv6PayloadTpid", \
    "Srv6Adapt1MatchPayloadOvidEnable", \
    "Srv6Adapt2MatchPayloadOvidEnable", \
    "Srv6Adapt1SrhAction", \
    "Srv6Adapt2SrhAction", \
    "Srv6Adapt4SrhAction", \
    "Srv6Adapt1NonSrhAction", \
    "Srv6Adapt2NonSrhAction", \
    "Srv6Adapt4NonSrhAction", \
    "Srv6Adapt1DipPrefix1Len", \
    "Srv6Adapt2DipPrefix1Len", \
    "Srv6Adapt4DipPrefix1Len", \
    "Srv6Adapt1MatchNextHeaderEnable", \
    "Srv6Adapt2MatchNextHeaderEnable", \
    "Srv6Adapt4MatchNextHeaderEnable", \
    "Srv6SidMode", \
    "Srv6UsidPrefix1", \
    "Srv6UsidPrefix2", \
    "Srv6GsidPrefix1", \
    ...
    "Srv6FunctionSelect1", \
    "EcmpMemberTableSize", \
    "DbgCntTxMcDropSkipEnable", \
    "Srv6FunctionSelect2", \
    "Srv6EsiFilterEnable", \
    "Srv6EsiInsertEnable", \
    "Srv6EsiOffsetSelect", \
    "Srv6RwUpperBitsDuringSwap", \
    "Srv6IngLookupSipAssignSvp", \
    "Srv6Adapt1DipPrefix2Len", \
    "Srv6Adapt2DipPrefix2Len", \
    "Srv6Adapt4DipPrefix2Len", \
    "EcmpMode", \
    "OutlifProfileGroupApp", \
    "BufUseMode", \
    "SynchronousPortClockSourceSet1", \
    "SynchronousPortClockSourceSet1DivCtrl", \
    "SynchronousPortClockSourceBkupSet1", \
    "SynchronousPortClockSourceBkupSet1DivCtrl", \
    "EgressUDHBaseFieldCsMap" 

/* SRv6 SRH actions used by bcmSwitchSrv6AdaptxSrhAction. */
#define BCM_SWITCH_SRV6_SRH_ACTION_PSP      (1 << 2)   /* SRv6 SRH PSP action. */
#define BCM_SWITCH_SRV6_SRH_ACTION_TRANSIT  (1 << 1)   /* SRv6 SRH transit
                                                          action. */
#define BCM_SWITCH_SRV6_SRH_ACTION_TERM     (1 << 0)   /* SRv6 SRH termination
                                                          action. */

/* SRv6 DIP prefix length used by SwitchSrv6Adapt1DipPrefixLen. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_32BIT    0          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 32
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_36BIT    1          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 36
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_40BIT    2          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 40
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_44BIT    3          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 44
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_48BIT    4          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 48
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_52BIT    5          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 52
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_56BIT    6          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 56
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_60BIT    7          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 60
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_64BIT    8          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 64
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_68BIT    9          /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 68
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_72BIT    10         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 72
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_76BIT    11         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 76
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_80BIT    12         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 80
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_84BIT    13         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 84
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_88BIT    14         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 88
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_92BIT    15         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 92
                                                          bit. */
#define BCM_SWITCH_SRV6_DIP_PREFIX_96BIT    16         /* SRv6 DIP
                                                          prefix(locator +
                                                          function) length 96
                                                          bit. */

/* SRv6 compressed SID mode used by bcmSwitchSrv6SidMode. */
#define BCM_SWITCH_SRV6_CSID_MODE_NONE  0          /* SRv6 SID is not in
                                                      compressed mode. */
#define BCM_SWITCH_SRV6_CSID_MODE_USID  1          /* SRv6 SID compressed mode
                                                      is micro SID. */
#define BCM_SWITCH_SRV6_CSID_MODE_GSID  2          /* SRv6 SID compressed mode
                                                      is generalized SID. */

/* 
 * SRv6 CSID prefix length used by bcmSwitchSrv6UsidPrefix1/2 and
 * bcmSwitchSrv6GsidPrefix1/2.
 */
#define BCM_SWITCH_SRV6_CSID_INVALID        0          /* SRv6 Compressed SID
                                                          type USID or GSID is
                                                          not valid. */
#define BCM_SWITCH_SRV6_CSID_PREFIX_32BIT   1          /* SRv6 USID or GSID
                                                          prefix length 32 bit. */
#define BCM_SWITCH_SRV6_CSID_PREFIX_48BIT   2          /* SRv6 USID or GSID
                                                          prefix length 48 bit. */
#define BCM_SWITCH_SRV6_CSID_PREFIX_56BIT   3          /* SRv6 USID or GSID
                                                          prefix length 56 bit. */
#define BCM_SWITCH_SRV6_CSID_PREFIX_64BIT   4          /* SRv6 USID or GSID
                                                          prefix length 64 bit. */

/* SRv6 function offset and size used by bcmSwitchSrv6FunctionSelect. */
#define BCM_SWITCH_SRV6_FUNCTION_INVALID    0          /* SRv6 function invalid. */
#define BCM_SWITCH_SRV6_FUNCTION_OFFSET_64_SIZE_16BIT 1          /* SRv6 function offset
                                                          64 and size 16. */
#define BCM_SWITCH_SRV6_FUNCTION_OFFSET_64_SIZE_32BIT 2          /* SRv6 function offset
                                                          64 and size 32. */

/* SRv6 function ESI offset starting bit selection. */
#define BCM_SWITCH_SRV6_FUNCTION_ESI_OFFSET_MSB_96 0          /* SRv6 ESI offset select
                                                          from MSB 96. */
#define BCM_SWITCH_SRV6_FUNCTION_ESI_OFFSET_MSB_112 1          /* SRv6 ESI offset select
                                                          from MSB 112. */
...
/* Switch Control settings for bcmSwitchVxlanEvpnEnable. */
#define BCM_SWITCH_VXLAN_EVPN_RESET_ALL_FLAGS 0          /* Clear all VxLAN EVPN
                                                          Enable flags. */
#define BCM_SWITCH_VXLAN_EVPN_SET_ALL_FLAGS 1          /* Set all VxLAN EVPN
                                                          Enable flags. */
#define BCM_SWITCH_VXLAN_EVPN_SET_BUM_FLAG  2          /* Enables BUM-bit
                                                          setting within VxLAN
                                                          header for BUM packet
                                                          flows. */
#define BCM_SWITCH_VXLAN_EVPN_USE_BUM_FLAG  4          /* Enables ingress BUM
                                                          processing for packets
                                                          received with BUM-bit
                                                          within VxLAN header. */
#define BCM_SWITCH_VXLAN_EVPN_ESI_FILTER_ENABLE 8          /* Enables ESI filtering
                                                          for non-Unicast
                                                          packets. */
...
/* 
 * Enum for Tunnel header IEU (Inner Entropy Used) policy for hash
 * computation.
 */
typedef enum bcm_switch_hash_tunnel_hdr_ieu_policy_e {
    bcmSwitchHashTunnelHdrIeuPolicyUseNone = 0, /* Do not use IEU policy */
    bcmSwitchHashTunnelHdrIeuPolicyUseOuter = 1, /* Indicates, Flow Hash was computed
                                           based on outer header */
    bcmSwitchHashTunnelHdrIeuPolicyUseInner = 2 /* Indicates, Flow Hash was computed
                                           based on inner header */
} bcm_switch_hash_tunnel_hdr_ieu_policy_t;

/* Enum for ECMP mode */
typedef enum bcm_switch_ecmp_mode_e {
    bcmSwitchEcmpModeSingle = 0,        /* Single level ECMP mode */
    bcmSwitchEcmpModeHierarchical = 1   /* Hierarchical ECMP mode */
} bcm_switch_ecmp_mode_t;
...
/* IP Header selection of IP tunnel terminated packet for hashing. */
#define BCM_HASH_IP_TUNNEL_TERM_USE_EITHER  0          /* Either use Outer or
                                                          Inner Header of IP
                                                          tunnel terminated
                                                          packet for hashing. */
#define BCM_HASH_IP_TUNNEL_TERM_USE_INNER   1          /* Use Inner Header
                                                          fields of IP tunnel
                                                          terminated packet for
                                                          hashing. */
#define BCM_HASH_IP_TUNNEL_TERM_USE_OUTER   2          /* Use Outer Header
                                                          fields of IP tunnel
                                                          terminated packet for
                                                          hashing. */
...
#define BCM_SWITCH_PORT_HEADER_TYPE_RAW_WITH_ORIGINAL_SYSTEM_HEADERS (22)       
#define BCM_SWITCH_PORT_HEADER_TYPE_RCH_SRV6_USP_PSP (23)       
#define BCM_SWITCH_PORT_HEADER_TYPE_IBCH1_MODE (24)       
...
typedef enum bcm_switch_hash_table_e {
    ...
    bcmHashTableVlanTranslate2 = 13,    /* VLAN Translate hash table 2. */
    bcmHashTableEgressVlanTranslate2 = 14, /* Egress VLAN Translate hash table 2. */
    bcmHashTable__Num = 15 
...
typedef enum bcm_switch_hash_field_e {
    ...
    bcmSwitchFlexHashField12 = 12,      /* field 12 in flexible hash RAM table,
                                           fed to RTAG7 bin 1 (on 13 bin) or bin
                                           14 (on 25 bin), support only UDF type
                                           field */
    bcmSwitchFlexHashFieldCount = 13,   /* field count (on 13 bin) in flexible
                                           hash RAM table */
    bcmSwitchFlexHashField13 = 13,      /* field 13 in flexible hash RAM table,
                                           fed to RTAG7 bin 15, support only UDF
                                           type field */
    bcmSwitchFlexHashField14 = 14,      /* field 14 in flexible hash RAM table,
                                           fed to RTAG7 bin 16, support only UDF
                                           type field */
    bcmSwitchFlexHashField15 = 15,      /* field 15 in flexible hash RAM table,
                                           fed to RTAG7 bin 17, support only UDF
                                           type field */
    bcmSwitchFlexHashField16 = 16,      /* field 16 in flexible hash RAM table,
                                           fed to RTAG7 bin 18, support only UDF
                                           type field */
    bcmSwitchFlexHashField17 = 17,      /* field 17 in flexible hash RAM table,
                                           fed to RTAG7 bin 19, support only UDF
                                           type field */
    bcmSwitchFlexHashField18 = 18,      /* field 18 in flexible hash RAM table,
                                           fed to RTAG7 bin 20, support only UDF
                                           type field */
    bcmSwitchFlexHashField19 = 19,      /* field 19 in flexible hash RAM table,
                                           fed to RTAG7 bin 21, support only UDF
                                           type field */
    bcmSwitchFlexHashField20 = 20,      /* field 20 in flexible hash RAM table,
                                           fed to RTAG7 bin 22, support only UDF
                                           type field */
    bcmSwitchFlexHashField21 = 21,      /* field 21 in flexible hash RAM table,
                                           fed to RTAG7 bin 23, support only UDF
                                           type field */
    bcmSwitchFlexHashField22 = 22,      /* field 22 in flexible hash RAM table,
                                           fed to RTAG7 bin 24, support only UDF
                                           type field */
    bcmSwitchFlexHashField23 = 23,      /* field 23 in flexible hash RAM table,
                                           fed to RTAG7 bin 25, support only UDF
                                           type field */
    bcmSwitchFlexHashField24 = 24,      /* field 24 in flexible hash RAM table,
                                           fed to RTAG7 bin 1, support only UDF
                                           type field */
    bcmSwitchFlexHashExtFieldCount = 25 /* field count (on 25 bin) in flexible
                                           hash RAM table */
...
/* Set tunnel header IEU policy for lb hash. */
extern int bcm_switch_hash_tunnel_hdr_ieu_policy_set(
    int unit, 
    bcm_hash_entry_t entry, 
    bcm_switch_hash_tunnel_hdr_ieu_policy_t policy);

/* Get tunnel header IEU policy for lb hash. */
extern int bcm_switch_hash_tunnel_hdr_ieu_policy_get(
    int unit, 
    bcm_hash_entry_t entry, 
    bcm_switch_hash_tunnel_hdr_ieu_policy_t *policy);
...
/* Set a flex hash entry configuration information with udf class. */
extern int bcm_switch_hash_qualify_udf_class(
    int unit, 
    bcm_hash_entry_t entry, 
    uint16 data, 
    uint16 mask);

/* Get a flex hash entry configuration information for udf class. */
extern int bcm_switch_hash_qualify_udf_class_get(
    int unit, 
    bcm_hash_entry_t entry, 
    uint16 *data, 
    uint16 *mask);
...
/* Switch routing disable flags. */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_NONE (0)        /* Do not disable routing */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_IGMP (1 << 0)   /* Disable routing for
                                                          IGMP over tunnel */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_TCP (1 << 1)   /* Disable routing for
                                                          TCP over tunnel */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_UDP (1 << 2)   /* Disable routing for
                                                          UDP over tunnel */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_GRE_KEEP_ALIVE (1 << 3)   /* Disable routing for
                                                          GRE_KEEP_ALIVE over
                                                          tunnel */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_ICMP (1 << 4)   /* Disable routing for
                                                          GRE_KEEP_ALIVE over
                                                          tunnel */
#define BCM_SWITCH_TUNNEL_ROUTE_DISABLE_UNKNOWN (1 << 5)   /* Disable routing for
                                                          Unknown layer type
                                                          over tunnel */
...
#define BCM_HASH_NON_SYMMETRICAL            BCM_HASH_FIELD_DSTMOD /* Non symmetrical
                                                          hashing. */
...
#define BCM_HASH_FIELD_IP4DST_LO            0x00000100 /* IPv4 destination
                                                          address lower 16 bits. */
#define BCM_HASH_FIELD_IP4DST_HI            0x00000200 /* IPv4 destination
                                                          address upper 16 bits. */
#define BCM_HASH_FIELD_IP4SRC_LO            0x00000400 /* IPv4 source address
                                                          lower 16 bits. */
#define BCM_HASH_FIELD_IP4SRC_HI            0x00000800 /* IPv4 source address
                                                          upper 16 bits. */
#define BCM_HASH_FIELD_IPV4_ADDRESS         (BCM_HASH_FIELD_IP4DST_LO | BCM_HASH_FIELD_IP4DST_HI | BCM_HASH_FIELD_IP4SRC_LO | BCM_HASH_FIELD_IP4SRC_HI) /* The entire IPv4
                                                          address field
                                                          including the source
                                                          and the destination
                                                          addresses. */
#define BCM_HASH_FIELD_IP6DST_LO            0x00001000 /* IPv6 collapsed
                                                          destination address
                                                          lower 16 bits. */
#define BCM_HASH_FIELD_IP6DST_HI            0x00002000 /* IPv6 collapsed
                                                          destination address
                                                          upper 16 bits. */
...
#define BCM_HASH_FIELD_IP6SRC_HI            0x00008000 /* IPv6 collapsed source
                                                          address upper 16 bits. */
#define BCM_HASH_FIELD_IPV6_ADDRESS         (BCM_HASH_FIELD_IP6DST_LO | BCM_HASH_FIELD_IP6DST_HI | BCM_HASH_FIELD_IP6SRC_LO | BCM_HASH_FIELD_IP6SRC_HI) /* The entire IPv6
                                                          address field
                                                          including the source
                                                          and the destination
                                                          addresses. */
#define BCM_HASH_FIELD_FLOWLABEL_LO         BCM_HASH_FIELD_DSTMOD /* IPv6 flow label lower
                                                          16 bits. */
#define BCM_HASH_FIELD_FLOWLABEL_HI         BCM_HASH_FIELD_DSTPORT /* IPv6 flow label upper
                                                          4 bits. */
...
#define BCM_HASH_FIELD_MACDA_LO             0x00040000 /* MAC destination
                                                          address lower 16 bits. */
#define BCM_HASH_FIELD_MACDA_MI             0x00080000 /* MAC destination
                                                          address middle 16
                                                          bits. */
#define BCM_HASH_FIELD_MACDA_HI             0x00100000 /* MAC destination
                                                          address upper 16 bits. */
#define BCM_HASH_FIELD_MACSA_LO             0x00200000 /* MAC source address
                                                          lower 16 bits. */
#define BCM_HASH_FIELD_MACSA_MI             0x00400000 /* MAC source address
                                                          middle 16 bits. */
#define BCM_HASH_FIELD_MACSA_HI             0x00800000 /* MAC source address
                                                          upper 16 bits. */
#define BCM_HASH_FIELD_MAC_ADDRESS          (BCM_HASH_FIELD_MACDA_LO | BCM_HASH_FIELD_MACDA_MI | BCM_HASH_FIELD_MACDA_HI | BCM_HASH_FIELD_MACSA_LO | BCM_HASH_FIELD_MACSA_MI | BCM_HASH_FIELD_MACSA_HI) /* MAC source and
                                                          destination address. */
#define BCM_HASH_FIELD_LOAD_BALANCE         0x01000000 /* Load balance ID -
                                                          HiGig2 only. */
#define BCM_HASH_FIELD_RSVD_LABELS          0x02000000 /* Reserved second label,
                                                          top label. */
...
#define BCM_HASH_EXT_FIELD_SRC_PORT_DST_PORT_UPPER 0x00000001 /* Source port and upper
                                                          8 bits of destination
                                                          port. */
#define BCM_HASH_EXT_FIELD_L4_DST_PORT      0x00000002 /* Layer 4 destination
                                                          port for
                                                          non-fragmented packets
                                                          only. */
#define BCM_HASH_EXT_FIELD_MPLS_3RD_LABEL_15_0 0x00000002 /* 16-bits label 3[15:0]. */
#define BCM_HASH_EXT_FIELD_L4_SRC_PORT      0x00000004 /* Layer 4 source port
                                                          for non-fragmented
                                                          packets only. */
#define BCM_HASH_EXT_FIELD_MPLS_LABELS_19_16 0x00000004 /* 4-bits Label 1[19:16]
                                                          + 4-bits Label
                                                          2[19:16] + 4-bits
                                                          Label 3[19:16]. */
#define BCM_HASH_EXT_FIELD_PROTOCOL_DST_PORT_LOWER 0x00000008 /* Protocol and lower 8
                                                          bits of destination
                                                          port. */
#define BCM_HASH_EXT_FIELD_DST_PORT_LOWER   0x00000008 /* Lower 8-bits of
                                                          destination port ID. */
#define BCM_HASH_EXT_FIELD_FLOW_LABEL_15_0  0x00000010 /* IPv6 flow label. */
#define BCM_HASH_EXT_FIELD_ETHERTYPE        0x00000010 /* Ethertype. */
#define BCM_HASH_EXT_FIELD_VLAN             0x00000020 /* VLAN ID. */
#define BCM_HASH_EXT_FIELD_VLAN_FLOW_LABEL_19_16 0x00000020 /* VLAN_and 4-bits of
                                                          IPv6 flow label
                                                          [19:16]. */
#define BCM_HASH_EXT_FIELD_VRF              0x00000040 /* VRF ID. */
#define BCM_HASH_EXT_FIELD_DST_IP_15_0      0x00000080 /* 16-bits destination
                                                          IP[15:0] for IPv4 and
                                                          IPv6. */
#define BCM_HASH_EXT_MPLS_STACK_5TH_LABEL_19_16 0x00000080 /* 4-bits of label
                                                          5[19:16]. */
#define BCM_HASH_EXT_FIELD_MAC_DA_15_0      0x00000080 /* Lower 16-bits of
                                                          destination MAC
                                                          address. */
#define BCM_HASH_EXT_MPLS_STACK_4TH_LABEL_19_16 0x00000100 /* 4-bits of label
                                                          4[19:16]. */
#define BCM_HASH_EXT_FIELD_DST_IP_31_16     0x00000100 /* 16-bits destination
                                                          IP[31:16] for IPv4 and
                                                          IPv6. */
#define BCM_HASH_EXT_FIELD_MAC_DA_31_16     0x00000100 /* Middle 16-bits of
                                                          destination MAC
                                                          address. */
#define BCM_HASH_EXT_MPLS_STACK_5TH_LABEL_15_0 0x00000200 /* 16-bits of label
                                                          5[15:0]. */
#define BCM_HASH_EXT_FIELD_MAC_DA_47_32     0x00000200 /* Upper 16-bits of
                                                          destination MAC
                                                          address. */
#define BCM_HASH_EXT_FIELD_DST_IP_47_32     0x00000200 /* 16-bits of destination
                                                          IP[47:32] for IPv6. */
#define BCM_HASH_EXT_MPLS_STACK_4TH_LABEL_15_0 0x00000400 /* 16-bits of label
                                                          4[15:0]. */
#define BCM_HASH_EXT_FIELD_DST_IP_63_48     0x00000400 /* 16-bits of destination
                                                          IP[63:48] for IPv6. */
#define BCM_HASH_EXT_FIELD_SRC_IP_15_0      0x00000800 /* 16-bits source
                                                          IP[15:0] for IPv4 and
                                                          IPv6. */
#define BCM_HASH_EXT_FIELD_MAC_SA_15_0      0x00000800 /* Lower 16-bits of
                                                          source MAC address. */
#define BCM_HASH_EXT_FIELD_SRC_IP_31_16     0x00001000 /* 16-bits source
                                                          IP[31:16] for IPv4 and
                                                          IPv6. */
#define BCM_HASH_EXT_FIELD_MAC_SA_31_16     0x00001000 /* Middle 16-bits of
                                                          source MAC address. */
#define BCM_HASH_EXT_FIELD_MAC_SA_47_32     0x00002000 /* Upper 16-bits of
                                                          source MAC address. */
#define BCM_HASH_EXT_FIELD_SRC_IP_47_32     0x00002000 /* 16-bits of source
                                                          IP[47:32] for IPv6. */
#define BCM_HASH_EXT_FIELD_SRC_IP_63_48     0x00004000 /* 16-bits of source
                                                          IP[63:48] for IPv6. */
#define BCM_HASH_EXT_FIELD_IP4_ADDRESS      (BCM_HASH_EXT_FIELD_DST_IP_15_0 | BCM_HASH_EXT_FIELD_DST_IP_31_16 | BCM_HASH_EXT_FIELD_SRC_IP_15_0 | BCM_HASH_EXT_FIELD_SRC_IP_31_16) /* The entire IPv4
                                                          address field
                                                          including the source
                                                          and the destination
                                                          addresses. */
#define BCM_HASH_EXT_FIELD_GRE_KEY_LOWER    0x00008000 /* Lower 16-bits of GRE
                                                          Key. */
#define BCM_HASH_EXT_FIELD_MPLS_2ND_LABEL_15_0 0x00008000 /* Label 2[15:0]. */
#define BCM_HASH_EXT_FIELD_SRC_IP6_ADDRESS  (BCM_HASH_EXT_FIELD_SRC_IP_15_0 | BCM_HASH_EXT_FIELD_SRC_IP_31_16 | BCM_HASH_EXT_FIELD_SRC_IP_47_32 | BCM_HASH_EXT_FIELD_SRC_IP_63_48) /* The IPv6 source
                                                          address. */
#define BCM_HASH_EXT_FIELD_DST_IP6_ADDRESS  (BCM_HASH_EXT_FIELD_DST_IP_15_0 | BCM_HASH_EXT_FIELD_DST_IP_31_16 | BCM_HASH_EXT_FIELD_DST_IP_47_32 | BCM_HASH_EXT_FIELD_DST_IP_63_48) /* The IPv6 destination
                                                          address. */
#define BCM_HASH_EXT_FIELD_IP6_ADDRESS      (BCM_HASH_EXT_FIELD_DST_IP6_ADDRESS | BCM_HASH_EXT_FIELD_SRC_IP6_ADDRESS) /* The entire IPv6
                                                          address field
                                                          including the source
                                                          and the destination
                                                          addresses. */
#define BCM_HASH_EXT_FIELD_GRE_KEY_UPPER    0x00010000 /* Upper 16-bits of GRE
                                                          Key. */
#define BCM_HASH_EXT_FIELD_MPLS_TOP_LABEL_15_0 0x00010000 /* Label 1[15:0]. */
#define BCM_HASH_EXT_FIELD_UDF_1            0x00020000 /* UDF 1. */
#define BCM_HASH_EXT_FIELD_UDF_2            0x00040000 /* UDF 2. */
#define BCM_HASH_EXT_FIELD_UDF_3            0x00080000 /* UDF 3. */
#define BCM_HASH_EXT_FIELD_UDF_4            0x00100000 /* UDF 4. */
#define BCM_HASH_EXT_FIELD_UDF_5            0x00200000 /* UDF 5. */
#define BCM_HASH_EXT_FIELD_UDF_6            0x00400000 /* UDF 6. */
#define BCM_HASH_EXT_FIELD_UDF_7            0x00800000 /* UDF 7. */
#define BCM_HASH_EXT_FIELD_UDF_8            0x01000000 /* UDF 8. */
...
#define BCM_HASH_IP6_COLLAPSE_LSB   0x2        /* Select LSB method to collapse
                                                  ...
                                                  hashing in field selection
                                                  block */
#define BCM_HASH_IP6_COLLAPSE_MSB   0x4        /* Select MSB method to collapse
                                                  IPv6 Addresses for RTAG7
                                                  hashing in field selection
                                                  block */
...
typedef enum bcm_switch_object_e {
    ...
    bcmSwitchObjectL3RouteOverrideV6RouteProjection = 50, /* Projected maximum IPv6 override
                                           (global high) routes in ALPM mode. */
    bcmSwitchObjectL3RouteFortePrivateV4RouteProjection = 51, /* Projected maximum IPv4 private VRF
                                           routes in ALPM mode in FORTE table. */
    bcmSwitchObjectL3RouteForteGlobalV4RouteProjection = 52, /* Projected maximum IPv4 global low
                                           routes in ALPM mode in FORTE table. */
    bcmSwitchObjectL3RouteForteOverrideV4RouteProjection = 53, /* Projected maximum IPv4 override
                                           (global high) routes in ALPM mode in
                                           FORTE table. */
    bcmSwitchObjectL3RouteFortePrivateV6RouteProjection = 54, /* Projected maximum IPv6 private VRF
                                           routes in ALPM mode in FORTE table. */
    bcmSwitchObjectL3RouteForteGlobalV6RouteProjection = 55, /* Projected maximum IPv6 global low
                                           routes in ALPM mode in FORTE table. */
    bcmSwitchObjectL3RouteForteOverrideV6RouteProjection = 56, /* Projected maximum IPv6 override
                                           (global high) routes in ALPM mode in
                                           FORTE table. */
    bcmSwitchObjectL2NarrowEntryMax = 57, /* Maximum number of L2 narrow entries. */
    bcmSwitchObjectOverlayEcmpGroupsUsed = 58, /* Read-only, and returns the size of
                                           the used ECMP Overlay Groups. */
    bcmSwitchObjectOverlayEcmpGroupsMax = 59, /* Read-only, and returns the size of
                                           the max ECMP Overlay Groups. */
    bcmSwitchObjectUnderlayEcmpGroupsUsed = 60, /* Read-only, and returns the size of
                                           the used ECMP Underlay Groups. */
    bcmSwitchObjectUnderlayEcmpGroupsMax = 61, /* Read-only, and returns the size of
                                           the max ECMP Underlay Groups. */
    bcmSwitchObjectOverlayEcmpMembersUsed = 62, /* Read-only, and returns the size of
                                           the used ECMP Overlay Members. */
    bcmSwitchObjectOverlayEcmpMembersMax = 63, /* Read-only, and returns the size of
                                           the max ECMP Overlay Members. */
    bcmSwitchObjectUnderlayEcmpMembersUsed = 64, /* Read-only, and returns the size of
                                           the used ECMP Underlay Members. */
    bcmSwitchObjectUnderlayEcmpMembersMax = 65, /* Read-only, and returns the size of
                                           the max ECMP Underlay Members. */
    bcmSwitchObjectEcmpMembersUsed = 66, /* Read-only, and returns the size of
                                           the used ECMP Members. */
    bcmSwitchObjectEcmpMembersMax = 67, /* Read-only, and returns the size of
                                           the total ECMP Members. */
...
typedef enum bcm_switch_profile_mapping_type_e {
    ...
    bcmCosqPortToOcbGlobalDropProfile = 3 /* local port to ocb global drop profile
                                           mapping */
...
#define BCM_SWITCH_PKT_TRACE_FWD_DST_DVP    0x0020     /* Forward destination
                                                          DVP */
#define BCM_SWITCH_PKT_TRACE_FWD_DST_COPY_TO_CPU 0x0040     /* Copy to CPU */
...
#define BCM_SWITCH_PKT_TRACE_FIELD_STAGE_HIT_ENTRIES_MAX 18         /* Maximum field
                                                          processor entries hit
                                                          per stage. */

/* Packet trace field processor information */
typedef struct bcm_switch_pkt_trace_field_info_s {
    bcm_field_group_t fp_group[BCM_SWITCH_PKT_TRACE_FIELD_STAGE_HIT_ENTRIES_MAX]; /* Field group identifier. */
    bcm_field_entry_t fp_entry[BCM_SWITCH_PKT_TRACE_FIELD_STAGE_HIT_ENTRIES_MAX]; /* Field entry identifier. */
    uint8 hit_count;                    /* Actual hit entries count per field
                                           processor stage. */
} bcm_switch_pkt_trace_field_info_t;
...
typedef enum bcm_switch_pkt_trace_drop_reason_e {
    ...
    bcmSwitchPktTraceDropReasonPortBitmapZero = 67, /* Packcet dropped due to port bitmap
                                           zero. */
    bcmSwitchPktTraceDropReasonL3NextHopDrop = 68, /* Packcet dropped due to L3 nexthop
                                           drop. */
    bcmSwitchPktTraceDropReasonL3TtlError = 69, /* Packcet dropped due to L3 TTL error. */
    bcmSwitchPktTraceDropReasonMtuCheckFail = 70, /* Packcet dropped due to MTU check
                                           fail. */
    bcmSwitchPktTraceDropReasonL3DstLookupMiss = 71, /* Packcet dropped due to L3 destination
                                           lookup miss failure. */
    bcmSwitchPktTraceDropReasonBfdTermination = 72, /* Packet dropped due to BFD
                                           Termination. */
    bcmSwitchPktTraceDropReasonMplsBfdError = 73, /* Packet dropped due to MPLS or BFD
                                           errors. */
    bcmSwitchPktTraceDropReasonL3HdrError = 74, /* Packet dropped due to L3 Header
                                           error. */
    bcmSwitchPktTraceDropReasonFPChgL2FldsNoRedirect = 75, /* Packet dropped due to IFP change L2
                                           fields no redirect. */
    bcmSwitchPktTraceDropReasonPVlanVidMismatch = 76, /* Packet dropped due to PVLAN VID
                                           mismatch. */
    bcmSwitchPktTraceDropReasonCFIorL3Disable = 77, /* Packets dropped due to CFI or L3
                                           disable. */
    bcmSwitchPktTraceDropReasonEcmpResolutionError = 78, /* Packet dropped due to ECMP resolution
                                           error. */
    bcmSwitchPktTraceDropReasonProtectionData = 79, /* Packet dropped due to protection. */
    bcmSwitchPktTraceDropReasonSrcPortKnockout = 80, /* Packet dropped due to source port
                                           knockout. */
    bcmSwitchPktTraceDropReasonBlockMask = 81, /* Packet dropped due to block masks. */
    bcmSwitchPktTraceDropReasonCount = 82 
} bcm_switch_pkt_trace_drop_reason_t;

#define BCM_SWITCH_PKT_TRACE_RAW_DATA_MAX   112        /* max bytes of
                                                          pkt_trace_info.raw_data */

#define BCM_SWITCH_PKT_TRACE_FIELD_STAGE_MAX 4          /* Maximum packet
                                                          processing pipeline
                                                          stages for field
                                                          processor. */

#define BCM_SWITCH_PKT_TRACE_FIELD_STAGE_INGRESS 0          /* Ingress field
                                                          processor pipeline
                                                          stage. */

#define BCM_SWITCH_PKT_TRACE_FIELD_STAGE_LOOKUP 1          /* Lookup field processor
                                                          pipeline stage. */

#define BCM_SWITCH_PKT_TRACE_FIELD_STAGE_EGRESS 2          /* Egress field processor
                                                          pipeline stage. */

#define BCM_SWITCH_PKT_TRACE_FIELD_STAGE_EXACT_MATCH 3          /* Exact match field
                                                          processor pipeline
                                                          stage. */
...
/* Nibble speculation(IPvX). */
#define BCM_SWITCH_DEFAULT_IPVX_NIBBLE_INDEX 17         /* Used to configure the
                                                          nibbles default
                                                          speculated protocol of
                                                          the IPvX nibbles (4
                                                          and 6). */
...
typedef enum bcm_switch_module_e {
    ...
    bcmModulePortMatch = 2,     /* Port Match module */
    bcmModuleCount = 3          /* Always Last, not a usable value */
} bcm_switch_module_t;
...
/* Source for port context used by bcmSwitchFlowCountPortContextSelect. */
typedef enum bcm_switch_flow_count_port_context_select_e {
    bcmSwitchFlowCountPortContextIngress = 0, /* Port context from ingress port */
    bcmSwitchFlowCountPortContextEgress = 1, /* Port context from egress port */
    bcmSwitchFlowCountPortContextCount = 2 /* Always last */
} bcm_switch_flow_count_port_context_select_t;
...
#define BCM_SWITCH_SER_LOG_HARD_FAULT   0x00000040 /* Hard fault is detected */
...
typedef struct bcm_switch_pt_info_s {
    uint8 name[BCM_MAX_MEM_REG_NAME];   /* PT (physical table) name. */
    int index;                          /* Memory or register index. */
    int port;                           /* Port ID. */
    int pipe;                           /* Pipe num. */
    int instance;                       /* Instance ID (MMU). */
    bcm_switch_block_type_t block_type; /* Block type. */
} bcm_switch_pt_info_t;

/* Logical table information. */
typedef struct bcm_switch_lt_info_s {
    uint8 name[BCM_MAX_LT_NAME];    /* LT (logical table) name. */
} bcm_switch_lt_info_t;

/* Initialize PT information structure. */
extern void bcm_switch_pt_info_t_init(
    bcm_switch_pt_info_t *pt_info);

/* Initialize LT information structure. */
extern void bcm_switch_lt_info_t_init(
    bcm_switch_lt_info_t *lt_info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Get LT information based on PT. */
extern int bcm_swith_lt_info_get(
    int unit, 
    bcm_switch_pt_info_t *pt_info, 
    int array_size, 
    bcm_switch_lt_info_t *lt_info_array, 
    int *count);
...
typedef enum bcm_switch_reflector_type_e {
    ...
    bcmSwitchReflectorL2UcInternalOnePass = 9, /* L2 unicast internal reflector with
                                           one-pass */
    bcmSwitchReflectorL2McInternalOnePass = 10 /* L2 multicast internal reflector with
                                           one-pass */
...
typedef struct bcm_switch_pkt_control_action_s {
    ...
    uint8 my_station_hit;           /* Packet hits my station table. */
    uint8 do_not_learn;             /* Do not learn MAC address. */
    uint8 storm_control_disable;    /* Disable storm control. */
...
typedef struct bcm_switch_pkt_integrity_match_s {
    ...
    uint8 ip_hdr_protocol;              /* Ip hdr protocol matched with outer
                                           header. */
    uint8 ip_hdr_protocol_mask;         /* Ip hdr protocol mask. */
...
/* Monitor flags definitions. */
#define BCM_SWITCH_DROP_EVENT_MON_FLAGS_TRIGGER_DISABLE 0x1        /* Disable trigger drop
                                                          events. */
...
typedef struct bcm_switch_drop_event_mon_s {
    ...
    uint32 actions;                     /* BCM_SWITCH_MON_ACTION_XXX actions
                                           definitions. */
    uint32 flags;                       /* BCM_SWITCH_DROP_EVENT_MON_FLAGS_XXX
                                           flags definitions. */
...
/* Stat event monitor structure. */
typedef struct bcm_switch_stat_event_mon_s {
    bcm_custom_stat_trigger_t stat_event; /* Stat event. */
    uint32 actions;                     /* BCM_SWITCH_MON_ACTION_XXX actions
                                           definitions. */
} bcm_switch_stat_event_mon_t;

/* Initialize a bcm_switch_stat_event_mon_t structure. */
extern void bcm_switch_stat_event_mon_t_init(
    bcm_switch_stat_event_mon_t *monitor);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set a stat event monitor. */
extern int bcm_switch_stat_event_mon_set(
    int unit, 
    bcm_switch_stat_event_mon_t *monitor);

/* Get a stat event monitor. */
extern int bcm_switch_stat_event_mon_get(
    int unit, 
    bcm_switch_stat_event_mon_t *monitor);

#endif /* BCM_HIDE_DISPATCHABLE */

/* Egress drop event group. */
typedef int bcm_switch_egress_drop_event_group_t;

/* Create an egress drop event group with ID */
#define BCM_SWITCH_EGRESS_DROP_EVENT_GROUP_WITH_ID 0x00000001 

#ifndef BCM_HIDE_DISPATCHABLE

/* Create an egress drop event group. */
extern int bcm_switch_egress_drop_event_group_create(
    int unit, 
    uint32 options, 
    bcm_switch_egress_drop_event_group_t *group_id);

/* Destroy an egress drop event group. */
extern int bcm_switch_egress_drop_event_group_destroy(
    int unit, 
    bcm_switch_egress_drop_event_group_t group_id);

/* Add events in an egress drop event group. */
extern int bcm_switch_egress_drop_event_add(
    int unit, 
    bcm_switch_egress_drop_event_group_t group_id, 
    int array_size, 
    bcm_egress_drop_event_t *event_array);

/* Delete events in an egress drop event group. */
extern int bcm_switch_egress_drop_event_delete(
    int unit, 
    bcm_switch_egress_drop_event_group_t group_id, 
    int array_size, 
    bcm_egress_drop_event_t *event_array);

/* Get an egress drop event group. */
extern int bcm_switch_egress_drop_event_group_get(
    int unit, 
    bcm_switch_egress_drop_event_group_t group_id, 
    int array_size, 
    bcm_egress_drop_event_t *event_array, 
...
typedef enum bcm_switch_hash_bank_e {
    ...
    bcmSwitchHashBank32 = 32,   /* Hash bank 32. */
    bcmSwitchHashBank33 = 33,   /* Hash bank 33. */
    bcmSwitchHashBank34 = 34,   /* Hash bank 34. */
    bcmSwitchHashBank35 = 35,   /* Hash bank 35. */
    bcmSwitchHashBank36 = 36,   /* Hash bank 36. */
    bcmSwitchHashBank37 = 37,   /* Hash bank 37. */
    bcmSwitchHashBank38 = 38,   /* Hash bank 38. */
    bcmSwitchHashBank39 = 39,   /* Hash bank 39. */
    bcmSwitchHashBankCount = 40 /* Must Be Last. Not A Valid Hash Bank. */
...
#define BCM_SWITCH_FEC_PROPERTY_FWD         0x8        /* Forwarding FEC. */
#define BCM_SWITCH_FEC_PROPERTY_RPF         0x10       /* RPF FEC. */
...
/* SVTAG encapsulation lookup info structure */
typedef struct bcm_switch_svtag_encapsulation_lookup_info_s {
    bcm_gport_t port;   /* Port used for the entry key generation. */
    bcm_gport_t tunnel; /* Tunnel used for the entry key generation. */
    uint32 flags;       /* BCM_SWITCH_SVTAG_EGRESS_XXX flags. */
} bcm_switch_svtag_encapsulation_lookup_info_t;
...
/* switch SVTAG encapsulation traverse callback signature */
typedef int (*bcm_switch_svtag_encapsulation_traverse_cb)(
    int unit, 
...
/* Adds an SVTAG entry to the EM database. */
extern int bcm_switch_svtag_encapsulation_add(
    int unit, 
    bcm_switch_svtag_encapsulation_lookup_info_t *svtag_lookup_info, 
    bcm_switch_svtag_egress_info_t *svtag_info);

/* Gets an SVTAG entry. */
extern int bcm_switch_svtag_encapsulation_get(
    int unit, 
    bcm_switch_svtag_encapsulation_lookup_info_t *svtag_lookup_info, 
    bcm_switch_svtag_egress_info_t *svtag_info);

/* Delete an SVTAG entry. */
extern int bcm_switch_svtag_encapsulation_delete(
    int unit, 
    bcm_switch_svtag_encapsulation_lookup_info_t *svtag_lookup_info);

/* Traverse through the SVTAG egress entries and run callback. */
extern int bcm_switch_svtag_encapsulation_traverse(
    int unit, 
    uint32 flags, 
...
/* 
 * Selection for bcmSwitchTagInputPriSelect and
 * bcmSwitchUntagInputPriSelect.
 */
#define BCM_SWITCH_INPUT_PRI_SELECT_INT 0          /* Internal priority. */
#define BCM_SWITCH_INPUT_PRI_SELECT_PKT 1          /* Packet priority. */
...
typedef struct bcm_switch_ep_recirc_nih_config_s {
    ...
    int opaque_ctrl_id_c;               /* Opaque control C value. This value
                                           could be modified internally when the
                                           profile is used as the mirror source
                                           by calling
                                           bcm_mirror_source_dest_add. Call
                                           bcm_switch_ep_recirc_profile_get to
                                           get the modified value in this case. */
...
typedef struct bcm_switch_ep_recirc_drop_event_control_s {
    int recirc_en;                      /* Enable for drop event to trigger EP
                                           Recirculate based on the configs of
                                           this structure. */
    bcm_pkt_drop_event_t threshold_event; /* If the highest drop code of a dropped
                                           packet's drop events is larger or
                                           equal to the drop code of the
                                           threshold_event, trigger EP
                                           Recirculate based on the calculated
                                           profile index entry. */
    int profile_id_mask;                /* This mask is used to calculate the EP
                                           Recirculate profile id for the drop
                                           events. Final profile id =
                                           ((ing_profile_id & profile_id_mask) |
                                           profile_id_offset). Where
                                           ing_profile_id is the original id
                                           derived from the ingress pipeline. */
    int profile_id_offset;              /* This offset is used to calculate the
                                           EP Recirculate profile id for the
                                           drop events. See above for how the
                                           final profile id is calculated. */
...
/* 
 * Get the drop event which has minimal drop code among the given drop
 * events.
 */
extern int bcm_switch_ep_recirc_drop_event_min_get(
    int unit, 
    bcm_pkt_drop_event_t *drop_event_array, 
    int array_size, 
    bcm_pkt_drop_event_t *min_drop_event);
...
typedef enum bcm_switch_outlif_profile_app_e {
    bcmSwitchOutlifProfileAppL3Intf = 0, 
    bcmSwitchOutlifProfileAppVlanPort = 1, 
    bcmSwitchOutlifProfileAppMplsTunnel = 2, 
    bcmSwitchOutlifProfileAppMplsPort = 3, 
    bcmSwitchOutlifProfileAppTunnel = 4, 
    bcmSwitchOutlifProfileAppVxlan = 5, 
    bcmSwitchOutlifProfileAppSrv6 = 6, 
    bcmSwitchOutlifProfileAppExtender = 7, 
    bcmSwitchOutlifProfileAppArp = 8, 
    bcmSwitchOutlifProfileApplicationCount = 9 
} bcm_switch_outlif_profile_app_t;

typedef struct bcm_switch_outlif_profile_group_s {
    int size;               /* OutLIF profile group size. */
    int group_namespace;    /* OutLIF profile group namespace. */
} bcm_switch_outlif_profile_group_t;

#ifndef BCM_HIDE_DISPATCHABLE

extern int bcm_switch_outlif_profile_group_create(
    int unit, 
    uint32 flags, 
    int *outlif_profile_group, 
    bcm_switch_outlif_profile_group_t *outlif_profile_group_info);

extern int bcm_switch_outlif_profile_group_get(
    int unit, 
    uint32 flags, 
    int outlif_profile_group, 
    bcm_switch_outlif_profile_group_t *outlif_profile_group_info);

extern int bcm_switch_outlif_profile_group_destroy(
    int unit, 
    int outlif_profile_group);
