...
#define BCM_FLEXDIGEST_FIELD_INNER_UDF_ONE_BYTE_4 152        /* The inner UDF one byte
                                                          container 4. */
#define BCM_FLEXDIGEST_FIELD_ETAG_PCP_DE    153        /* The ETAG PCP/DE. */
#define BCM_FLEXDIGEST_FIELD_ETAG_SVID      154        /* The ETAG source
                                                          extended port VLAN ID. */
#define BCM_FLEXDIGEST_FIELD_ETAG_VID       155        /* The ETAG extended port
                                                          VLAN ID. */
#define BCM_FLEXDIGEST_FIELD_L2GRE_KEY_0_15 156        /* The L2GRE key 0-15
                                                          bits. */
#define BCM_FLEXDIGEST_FIELD_L2GRE_KEY_16_31 157        /* The L2GRE key 16-31
                                                          bits. */
