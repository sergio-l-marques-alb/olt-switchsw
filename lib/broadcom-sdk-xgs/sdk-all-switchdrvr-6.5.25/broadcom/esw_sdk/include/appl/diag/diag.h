...
#if defined(BCM_DFE_SUPPORT) || defined(BCM_PETRA_SUPPORT) || defined(BCM_ESW_SUPPORT) || defined(BCM_LTSW_SUPPORT) || defined(BCM_CTSW_SUPPORT)
/* { */
...
extern int diag_reg_info_get(int unit, char *name, soc_reg_t *reg_id, soc_block_t *block_instance_id, unsigned int  *block_instance_number, unsigned int *array_index);
...
extern int diag_reg_field_only_set(int unit, char *name, reg_val reg_value, char* field_name,
                              reg_val field_value);
extern int diag_mem_info_get(int unit, char *name, soc_mem_t *mem_id, soc_block_t *block_instance_id, unsigned int *block_instance_number, unsigned int *array_index);
