...
{
    /** Invalid time unit */
    DIAG_DNXC_TIME_UNIT_INVALID = -1,
    /** Seconds */
    DIAG_DNXC_TIME_UNIT_SEC = 0,
    /** Mili Seconds */
    DIAG_DNXC_TIME_UNIT_MILISEC = 1,
    /** Micro Seconds */
    DIAG_DNXC_TIME_UNIT_USEC = 2,
    /** Nano Seconds */
    DIAG_DNXC_TIME_UNIT_NSEC = 3
} diag_dnxc_time_unit_e;
 ...
 * \param [in] interval - indicate how long gtimer keeps enabled in timeUnites
