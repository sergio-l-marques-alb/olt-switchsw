...
extern int pci_config_putw(pci_dev_t *, uint32 addr, uint32 data) SAL_ATTR_WEAK;
extern uint32 pci_config_getw(pci_dev_t *, uint32 addr) SAL_ATTR_WEAK;

extern int pci_memory_putw(pci_dev_t *, uint32 addr, uint32 data) SAL_ATTR_WEAK;
extern uint32 pci_memory_getw(pci_dev_t *, uint32 addr) SAL_ATTR_WEAK;

extern int pci_device_iter(int (*rtn)(pci_dev_t *dev,
				   uint16 pciVenID,
				   uint16 pciDevID,
				   uint8 pciRevID)) SAL_ATTR_WEAK;

extern void pci_print_all(void) SAL_ATTR_WEAK;

extern void pci_print_config(pci_dev_t *) SAL_ATTR_WEAK;

extern int pci_int_connect(int intLine, pci_isr_t isr, void *isr_data) SAL_ATTR_WEAK;

#ifdef SINGLE_MODE
extern int local_config_putw(pci_dev_t *dev, uint32 addr, uint32 data) SAL_ATTR_WEAK;
extern uint32 local_config_getw(pci_dev_t *dev, uint32 addr) SAL_ATTR_WEAK;

extern int local_memory_putw(pci_dev_t *dev, uint32 addr, uint32 data) SAL_ATTR_WEAK;
extern uint32 local_memory_getw(pci_dev_t *dev, uint32 addr) SAL_ATTR_WEAK;

extern int local_int_connect(int intLine, pci_isr_t isr, void *isr_data) SAL_ATTR_WEAK;
#endif /* !SINGLE_MODE*/
