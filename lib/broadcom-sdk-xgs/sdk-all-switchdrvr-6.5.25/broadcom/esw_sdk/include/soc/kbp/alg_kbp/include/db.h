...
enum kbp_db_mc_type {
    KBP_DB_MC_TYPE_RESET,  /**< resets to the default values */
    KBP_DB_MC_TYPE1,       /**< fully specified entries */
    KBP_DB_MC_TYPE2,       /**< entries with wild cards */
    KBP_DB_MC_TYPE3,       /**< same as type-2, entires with wild cards */
...
enum kbp_db_properties {
    ...
    KBP_PROP_MC_DB,                   /**< specifies large multicast database */
