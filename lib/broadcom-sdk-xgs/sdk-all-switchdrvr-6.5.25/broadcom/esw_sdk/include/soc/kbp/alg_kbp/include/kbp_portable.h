...
#else
#define KBP_TRACE_IN(format, ...)      /**< SDK API trace functionality for debug purpose : debug print upon entering API */
#define KBP_TRACE_OUT(format, ...)     /**< SDK API trace functionality for debug purpose : debug print before exiting API */
#define KBP_TRACE_PRINT(format, ...)   /**< SDK API trace functionality for debug purpose : debug print of arbitrary data */
#endif
