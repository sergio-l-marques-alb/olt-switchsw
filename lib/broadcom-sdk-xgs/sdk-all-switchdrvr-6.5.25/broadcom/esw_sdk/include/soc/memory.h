...
#define SOC_MEM_FLAG_INIT_ON_READ            0x00000100 /* This is a memory that is initilized on read */
...
typedef struct soc_mem_info_s {
    ...
    int                 dyn_rd_type; /* Read access while traffic is on */
} soc_mem_info_t;
...
#define SOC_MEM_IP6_LOWER_100BIT    9   /* IPv6 address bits [99:0]    */
#define SOC_MEM_IP6_UPPER_28BIT     10  /* IPv6 address bits [127:100] */
