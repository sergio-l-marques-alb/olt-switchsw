...
/* 
 * Macros to set and get the IDs of statistic interfaces for mirrored packets 
 * from the value of field STATISTICS_PTR in memory CGM_TM_CTR_CPM of QAX.
 * The field is 42 bits - id1 is in the first 21 bits and id2 in the second 21 bits.
 */
