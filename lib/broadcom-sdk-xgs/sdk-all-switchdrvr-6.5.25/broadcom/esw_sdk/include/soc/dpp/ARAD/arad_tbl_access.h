...
/* Update TCAM cache after hw move block  */
 ...
 *      arad_set_tcam_cache
 * Purpose:
 *      enable/disable tcam cache shadow
 *
 * Parameters:
 *      unit   - Device unit #
 *      enable - TRUE/FALSE
...
/*
 * Function:
 *      arad_tcam_bank_entry_rewrite_from_shadow
 * Purpose:
 *      rewrite tcam entry from shadow cache
 *
 * Parameters:
 *      unit   - Device unit #
 *      bank   - bank-id for rewrite entry
 *      entry  - entry-id for rewrite entry
 * Returns:
 *      SOC_E_XXX
 */
...
/*
 * Function:
 *      arad_tcam_entry_shadow_info_print
 * Purpose:
 *      dump tcam entry content from HW or from cache shadow
 *
 */
...
/*
 * Function:
 *      arad_tcam_shadow_content_validate
 * Purpose:
 *      compare the content of tcam shadow with tcac hw
 *
 * Parameters:
 *      unit   - Device unit #
 * Returns:
...
/* flush all tcam bank shadow to 0 */
