/* $Id: tmc_api_pmf_low_level_ce.h,v 1.4 Broadcom SDK $
...
typedef enum
{
  ...
  /*
   *  Number of types in SOC_TMC_PMF_CE_SUB_HEADER
   */
...
typedef enum
{
  ...
  /*
   *  Number of types in SOC_TMC_PMF_IRPP_INFO_FIELD
   */
...
/* } __SOC_TMC_API_PMF_LOW_LEVEL_CE_INCLUDED__*/
#endif
