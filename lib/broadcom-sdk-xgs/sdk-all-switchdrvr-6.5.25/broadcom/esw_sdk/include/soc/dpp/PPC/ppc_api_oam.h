...
#define SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_MPLS_TP_CC_CV                0x20000000 /*  Indicate it's MplsTpCcCv*/
...
typedef struct {
    ...
    uint8 is_vccv;    /* indicate if MEP type is VCCV type 1 BFD */
...
typedef struct {
    ...
    bcm_mac_t mac_address;      /* DA MAC address of outgoing LBM/tst */
