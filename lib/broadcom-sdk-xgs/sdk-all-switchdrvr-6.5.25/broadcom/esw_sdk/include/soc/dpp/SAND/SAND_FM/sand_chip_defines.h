 ...
 * Example: SOC_SAND_FAP10M may have FIP, FOP, FAP.
 */
typedef enum
{
  SOC_SAND_DONT_CARE_ENTITY = 0,
  /*
   * FE1 entity configured as FE13.
   */
  SOC_SAND_FE1_ENTITY = 1,
  /*
   * FE2 entity configured as FE2.
   */
  SOC_SAND_FE2_ENTITY = 2,
  /*
   * FE3 entity configured as FE13.
   */
