/* $Id: tmc_api_end2end_scheduler.h,v 1.14 Broadcom SDK $
...
/* 
 * In ARAD: 0-255 are data ports, and port 248 is the ERP port, that enable sending
 * FAP-level scheduled traffic to each FAP, to be egress replicated.
 */
 ...
 *      SOC_TMC_SCH_LOW_FC_NOF_AVAIL_CONFS out of
 ...
 * will be indicated as SOC_TMC_SCH_SE_ID_INVALID or SOC_TMC_SCH_FLOW_ID_INVALID
 ...
 * SOC_TMC_SCH_PORT_LOWEST_HP_HR_CLASS value and above
...
typedef struct
{
   ...
   *  scheduler mode:SOC_TMC_SCH_CL_MODE_1: 4 strict-priority
   *  levels: [SP1, SP2, SP3, SP4] - N/ATMC_SCH_CL_MODE_2: 3
   *  strict-priority levels: [SP1, SP2,
   *  SP3-WFQ(2)]SOC_TMC_SCH_CL_MODE_3: 2 strict-priority
   *  levels: [SP1-WFQ(1:63), SP2] or [SP1
   *  WFQ(3),SP2]SOC_TMC_SCH_CL_MODE_4: 2 strict-priority
   *  levels: [SP1,SP2-WFQ(3)] or [SP1, SP2
   *  WFQ(1:63)]SOC_TMC_SCH_CL_MODE_5: 1 strict-priority level:
...
typedef struct
{
  ...
  /*
   *  Control flag, used by caller of 'mbcm_dpp_sch_flow_set'
   *  (specifically
   *    'arad_sch_flow_set->arad_sch_flow_set_unsafe->arad_sch_flow_subflow_set'
   *    'arad_sch_flow_set->arad_sch_flow_set_unsafe->
   *      arad_sch_flow_subflow_set->arad_sch_SUB_FLOW_to_INTERNAL_SUB_FLOW_convert')
   */
...
typedef struct
{
   ...
   *  Units: Mega-Bit-Sec.
   *  Note!:
   *  Typically, may be set to SOC_TMC_SCH_PORT_MAX_EXPECTED_RATE_AUTO
   ...
   *  Alternatively, SOC_TMC_SCH_PORT_MAX_EXPECTED_RATE_AUTO value may be
   *  set here.
...
/* } __SOC_TMC_API_END2END_SCHEDULER_INCLUDED__*/
#endif
