...
typedef struct soc_arad_sw_state_tm_s{
    ...
    /* Array representing the modport to master lag(first added lag) sysport under hqos mode */
    PARSER_HINT_ARR ARAD_SYSPORT               *modport2master_lagsysport;
...
/*
Set a fap_id x fap_port_id to first LAG sysport setting under hqos mode.
Performs allocation inside the data structure if needed.
*/

uint32 arad_sw_db_modport2master_lagsysport_set(
    SOC_SAND_IN int unit,
    SOC_SAND_IN uint32 fap_id,
    SOC_SAND_IN uint32 fap_port_id,
    SOC_SAND_IN ARAD_SYSPORT sysport
...
/*
Get a fap_id x fap_port_id to master lag sysport setting.
If the mapping does not exist, the value of ARAD_NOF_SYS_PHYS_PORTS is returned
*/
uint32 arad_sw_db_modport2master_lagsysport_get(
    SOC_SAND_IN int unit,
    SOC_SAND_IN uint32 fap_id,
    SOC_SAND_IN uint32 fap_port_id,
    SOC_SAND_OUT ARAD_SYSPORT *sysport
...
/*
Remove a device x port to master lag sysport mapping.
*/
uint32 arad_sw_db_modport2master_lagsysport_remove(
    SOC_SAND_IN int unit,
    SOC_SAND_IN uint32 fap_id,
    SOC_SAND_IN uint32 fap_port_id
  );
