...
#define PROG_FLP_IP6UC_CUSTOM_ROUTE                 0x22 /* Jericho B0 prgrm*/
#define PROG_FLP_VPLSOGRE                           0x22 /* VPLSoGRE, arad+ and below prgrm*/
...
#define PROG_FLP_PPPOE_IPV4COMPMC_WITH_RPF          0x4d /* PPPoE */
#define PROG_FLP_PPPOE_IPV6MC                       0x4e /* PPPoE */
...
/*********************************************************************
* NAME:
 *   arad_pp_flp_update_programs_pem_contex
 * TYPE:
 *   PROC
 * FUNCTION:
 *   Config PEM_Context with Prog_id.
 * INPUT:
 *   SOC_SAND_IN  int                 unit -
 *     Identifier of the device to access.
 *
 * REMARKS:
 *   This function will update flp selection tbl with PROGRAM_DATA
 * RETURNS:
 *   OK or ERROR indication.
*********************************************************************/
