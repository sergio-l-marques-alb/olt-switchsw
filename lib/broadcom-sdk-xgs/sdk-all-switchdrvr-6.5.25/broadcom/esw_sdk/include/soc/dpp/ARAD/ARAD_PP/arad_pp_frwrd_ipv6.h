 ...
 *   PROC
 * FUNCTION:
 *   Add IPv6 MC compress Source IP entry.
 * INPUT:
 *   SOC_SAND_IN  int                             unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPC_FRWRD_IPV6_MC_ROUTE_KEY         *route_key -
 ...
 *   PROC
 * FUNCTION:
 *   Gets the compress Source IP associated with the given key.
 * INPUT:
 *   SOC_SAND_IN  int                             unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPC_FRWRD_IPV6_MC_ROUTE_KEY         *route_key -
 ...
 *     relevant only if found is TRUE.
 *   SOC_SAND_OUT SOC_PPC_FRWRD_IP_ROUTE_LOCATION         *location -
 *     Indicates whether the returned entry exsit in LPM. Relvant only if found is TRUE.
 *     If the entry is not commited yet then this is the location the route
 *     will be inserted into.
 *   SOC_SAND_OUT uint8                             *found -
 *     If TRUE then route_val has valid data.
 * REMARKS:
 ...
 *   PROC
 * FUNCTION:
 *   Remove IPv6 MC compress Source IP entry.
 * INPUT:
 *   SOC_SAND_IN  int                                 unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  SOC_PPC_FRWRD_IPV6_MC_ROUTE_KEY             *route_key -
