...
#define ARAD_PP_IHP_VTT_TT_PROCESSING_PROFILE_L2TP                             (3) /* can't co-exist with FC */
...
typedef enum
{
    ...
    PROG_VT_TM_PROG,
     /* untaged eth: ISA: VD x Initial VLAN */
    PROG_VT_VDxINITIALVID,
    /* single taged eth: ISA: VD x Outer Tag  */
    PROG_VT_VDxOUTERVID,
    ...
    /* ISA: (VD x Initial-VID x Inner-VLAN) */
    ...
    PROG_VT_VD_INITIALVID_VLAN_DOMAIN_MPLS_L1, /*used for vlan domain * mpls L1*/
    /* SECTION OAM ISA : VD(3bits) x Outer-VID x ETH */
    PROG_VT_SECTION_OAM_ONE_TAG,
    /* SECTION OAM ISA : VD(3bits)  x Outer-VID x Inner-VID x ETH*/
    PROG_VT_SECTION_OAM_TWO_TAGS,

    PROG_VT_INDX_VD_MPLS4_INITIALVID_L1L2,
    PROG_VT_INDX_VD_MPLS4_OUTERVID_L1L2,
    /* IPv6 : for DIP IP lookup at VT for (NVGRE | VXLAN | IP-Tunnel-termination) enabled */
    PROG_VT_IPV6_INITIAL_VID,
    /* IPv6 : for DIP IP lookup at VT for (NVGRE | VXLAN | IP-Tunnel-termination) enabled */
    PROG_VT_IPV6_OUTER_VID,
    /* IPv6 : 2nd pass for DIP IP lookup at VT for (NVGRE | VXLAN | IP-Tunnel-termination) enabled */
    PROG_VT_IPV6_INITIAL_VID_AFTER_RECYCLE,
    /* IPv6 : 2nd pass for DIP IP lookup at VT for (NVGRE | VXLAN | IP-Tunnel-termination) enabled */
    PROG_VT_IPV6_OUTER_VID_AFTER_RECYCLE,
    /*Generalized recycle header type 0, key C = SA.PPH[14:0] */
    PROG_VT_GENERALIZED_RCH0,
    /* Generalized recycle header type 1, key C = SA.PPH[31:18] */
    PROG_VT_GENERALIZED_RCH1,
    /* 3MTSE PLUS FRR VDxINITIALVID_L2_L1 */
	PROG_VT_3MTSE_PLUS_FRR_INITIALVID_L2_L1,
	/* 3MTSE PLUS FRR VDxOUTERVID_L2_L1 */
	PROG_VT_3MTSE_PLUS_FRR_OUTERVID_L2_L1,
	/* 3MTSE PLUS FRR VDxINITIALVID_L2_L4B_L5GAL */
	PROG_VT_3MTSE_PLUS_FRR_VDxINITIALVID_L2_L4B_L5GAL,
	/* 3MTSE PLUS FRR VDxOUTERVID_L2_L4B_L5GAL */
	PROG_VT_3MTSE_PLUS_FRR_VDxOUTERVID_L2_L4B_L5GAL,
	/* 2MTSE PLUS_FRR_VDxINITIALVID_FRR */
	PROG_VT_2MTSE_PLUS_FRR_VDxINITIALVID_FRR,
	/* 2MTSE PLUS_FRR_VDxOUTERVID_FRR */
	PROG_VT_2MTSE_PLUS_FRR_VDxOUTERVID_FRR,
	/* 2MTSE PLUS_FRR_VDxOUTER_INNER_VID_FRR */
	PROG_VT_2MTSE_PLUS_FRR_VDxOUTER_INNER_VID_FRR,
	/* 2MTSE PLUS_FRR_VDxOUTER_INNER_PCP_VID_FRR */
...
typedef enum
{
    ...
    /* Two lookups in SEM-A L2 and SEM-B L3 */
    PROG_TT_INDX_AS_ORDER_L2_L3,
    /* Two lookups in SEM-A L2 and SEM-B L2 */
    PROG_TT_INDX_AS_ORDER_L2_L2,
    /* Two lookups in SEM-A L1 and SEM-B L2 */
    PROG_TT_INDX_AS_ORDER_L1_L2,
    /* Two lookups in SEM-A L1 and SEM-B L1 */
    PROG_TT_INDX_AS_ORDER_L1_L1,
    /* 0 lookups in TT*/
    PROG_TT_INDX_AS_ORDER_NOP,
    /* FOR 4 mpls pop, lookup using the L3 and L4*/
    PROG_TT_INDX_MPLS4_L3_L4,
    /* FOR 4 mpls pop, lookup dummy,*/
    ...
    /* Dummy IP-LIF for Explicit NULL */
...
typedef struct
{
  ...
  uint8 ipv6_term_dip_sip_enable; /* 0 - disable, 1 - enable */
  uint8 e_o_ip_enable;
  uint8 vxlan_enable;
  uint8 nvgre_enable;
  ...
  uint8 custom_feature_vrrp_scaling_tcam; /* for Arad+ */
  uint8 vrrp_scaling_tcam; /* for Jericho */
  ...
  uint8 section_oam_enable; /* If set,section_oam is enabled */
