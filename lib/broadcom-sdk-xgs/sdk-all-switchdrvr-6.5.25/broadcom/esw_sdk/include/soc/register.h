/*
 * $Id: register.h,v 1.36 Broadcom SDK $
...
#define SOC_REG_ADDR_INSTANCE_MASK       ((uint32)1<<SOC_REG_ADDR_INSTANCE_BP)
#define SOC_REG_ADDR_SCHAN_ID_MASK       ((uint32)1<<(SOC_REG_ADDR_INSTANCE_BP-1))
#define SOC_REG_ADDR_BLOCK_ID_MASK       ((uint32)1<<(SOC_REG_ADDR_INSTANCE_BP-2))
#define SOC_REG_ADDR_PHY_ACC_MASK        ((uint32)1<<(SOC_REG_ADDR_INSTANCE_BP-3))
