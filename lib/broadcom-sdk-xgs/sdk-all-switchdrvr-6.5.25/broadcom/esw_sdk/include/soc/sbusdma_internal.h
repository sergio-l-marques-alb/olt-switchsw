...
********************************************/
extern int
cmicm_sbusdma_ch_abort(int unit, int cmc, int ch, int timeout);
...
extern soc_sbusdma_desc_drv_t* soc_sbusdma_desc_drv_get(int unit);

/*******************************************
* @function cmicm_sbusdma_event_dpc
...
* @param chan [in] channnel number I/O error happend on
...
********************************************/
extern void
cmicm_sbusdma_event_dpc(void *unit, void *event_id, void *cmc, void *chan,
                        void *p5);
