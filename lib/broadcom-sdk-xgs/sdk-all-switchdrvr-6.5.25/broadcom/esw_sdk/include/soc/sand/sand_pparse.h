 ...
 * \param [out] enabled
 *   Is the incoming pocket containing ETH
 */
...
/**
 * \brief
 *   Checks the existence of FTMH on the incoming pocket, according to the available signals.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
 ...
 *   Current parsed info tree. Ignored.
 * \param [out] enabled
 *   Is the incoming pocket containing FTMH
 */
...
/**
 * \brief
 *   Checks the existence of RCH_SRV6_USP_PSP on the incoming pocket, according to the available signals.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
...
/**
 * \brief
 *   Checks the next protocol after MPLS, according to the available signals.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
