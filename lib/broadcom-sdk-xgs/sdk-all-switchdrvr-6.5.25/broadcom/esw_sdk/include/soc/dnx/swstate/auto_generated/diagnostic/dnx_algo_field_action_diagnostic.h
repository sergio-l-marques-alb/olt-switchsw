/** \file dnx/swstate/auto_generated/diagnostic/dnx_algo_field_action_diagnostic.h
 *
...
int dnx_algo_field_action_sw_fem_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_field_action_sw_fem_is_priority_position_dump(
    int unit, int is_priority_position_idx_0, int is_priority_position_idx_1, dnx_sw_state_dump_filters_t filters);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_ALGO_FIELD_ACTION_DIAGNOSTIC_H__ */
