...
typedef enum
{
    ...
    /**
     * Enables bypass filtering action
     */
    ...
    /**
     * Indicate if tcp fragment offset less than 8 trap is supported
     */
    dnx_data_trap_ingress_tcp_frag_offset_lt8_trap_support,
    /**
     * Indicate if ethernet trap vector needs to be mapped
     */
...
typedef enum
{
    ...
    /**
     * Indicate if visibility trap is supported
     */
    dnx_data_trap_etpp_visibility_trap_support,
    /**
     * Indicate if OAM traps are supported
     */
    dnx_data_trap_etpp_oam_traps_support,
    /**
     * Indicate if mtu trap action profile is indirected to a separate table
     */
    dnx_data_trap_etpp_mtu_trap_action_profile_indirection,
    /**
     * Indicate if mtu mapping from layer type to compressed layer type is supported
     */
...
/**
 * \brief returns define data of first_etpp_user_configurable_profile
 * Module - 'trap', Submodule - 'etpp', data - 'first_etpp_user_configurable_profile'
 * First user configurable profile number
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     first_etpp_user_configurable_profile - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of nof_mtu_trap_action_profiles
 * Module - 'trap', Submodule - 'etpp', data - 'nof_mtu_trap_action_profiles'
 * Number of MTU trap action profiles
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_mtu_trap_action_profiles - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of nof_mtu_map_table_entries
 * Module - 'trap', Submodule - 'etpp', data - 'nof_mtu_map_table_entries'
 * Number of MTU map table entries
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_mtu_map_table_entries - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of first_etpp_user_configurable_profile
     */
    ...
    /**
     * returns define data of nof_mtu_trap_action_profiles
     */
    dnx_data_trap_etpp_nof_mtu_trap_action_profiles_get_f nof_mtu_trap_action_profiles_get;
    /**
     * returns define data of nof_mtu_map_table_entries
     */
...
{
    /**
     * Is Egress divided to ERPP and ETPP stages
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_TRAP - EGRESS:
 * {
 */
/**
 * \brief Interface for trap egress data
 */
typedef struct
{
    /**
...
typedef struct
{
    ...
    /**
     * Interface for trap egress data
     */
