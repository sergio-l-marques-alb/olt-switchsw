...
typedef enum
{
    ...
    /**
     * Is shared NIF architecture used in this device 
     */
    dnx_data_nif_global_is_shared_arch,
    /**
     * Does ilkn ports come after flexe ports
     */
    dnx_data_nif_global_is_ilkn_after_flexe,
    /**
     * Is managment port supported on this device
     */
...
typedef struct
{
    ...
    /**
     * returns define data of nof_nif_units_per_core
     */
    ...
    /**
     * returns numeric data of l1_only_mode
     */
...
/**
 * \brief Holds values of submodule phys table nof_phys_per_core
 * Table info:
...
typedef struct
{
    ...
    /**
     * returns define data of max_phys_in_core
     */
    ...
    /**
     * returns define data of first_mgmt_phy
     */
    dnx_data_nif_phys_first_mgmt_phy_get_f first_mgmt_phy_get;
    /**
     * returns define data of nof_mgmt_phys
     */
    ...
    /**
     * get table nof_phys_per_core entry 
     */
    dnx_data_nif_phys_nof_phys_per_core_get_f nof_phys_per_core_get;
    /**
     * get general info table about table (for example key size)nof_phys_per_core info
     */
...
/**
 * \brief Holds values of submodule ilkn table connectivity_options
 * Table info:
...
{
    /**
     * Does device type support ILKN.
     */
    dnx_data_nif_ilkn_is_supported,
    /**
     * Does device type support data ILKN.
     */
    dnx_data_nif_ilkn_is_ilu_supported,
    /**
     * Does device type support ILKN for external lookup (ELK core might still exist eventhough ELK as a feature is not supported).
     */
    dnx_data_nif_ilkn_is_elk_supported,
    /**
     * Does device type support credits source selector.
     */
    dnx_data_nif_ilkn_credits_selector,
    /**
     * Does device type support over fabric per core selector: nif or fabric.
     */
    ...
    /**
     * Indicates if Ilkn needed to be selected per lane in framer configuration.
     */
    ...
    /**
     * Indicated if device supports ILKN with speed of 10312
     */
    dnx_data_nif_ilkn_is_10p3G_speed_supported,
    /**
     * Indicated if device supports ILKN with speed of 12500
     */
    ...
    /**
     * Indicated if device supports ILKN with speed of 25781
     */
    ...
    /**
     * Indicated if device supports ILKN with speed of 56250
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of link_stable_wait
     */
    dnx_data_nif_ilkn_link_stable_wait_get_f link_stable_wait_get;
    /**
     * returns numeric data of interleaved_error_drop_single_context
     */
    ...
    /**
     * get table connectivity_options entry 
     */
    dnx_data_nif_ilkn_connectivity_options_get_f connectivity_options_get;
    /**
     * get general info table about table (for example key size)connectivity_options info
     */
...
typedef struct
{
    ...
    /**
     * Boolean. Indicate if Fast Link Recovery is supported in the PM
     */
    int flr_support;
...
typedef struct
{
    ...
    int is_valid;
    /**
     * is ptp timestamp is support for current device
     */
    int ptp_support;
...
typedef enum
{
    ...
    /**
     * Indicates if ethu_per_core is managed in dnx data table.
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of nbu_type
     */
    dnx_data_nif_simulator_nbu_type_get_f nbu_type_get;
    /**
     * returns numeric data of mgu_type
     */
...
/**
 * \brief Holds values of submodule flexe table sar_jitter_fifo_levels
 * Table info:
...
{
    /**
     * The low level. If the fifo level is less than this value, SAR will start low fifo adjust
     */
    int low_level;
    /**
     * The high level. If the fifo level is greater than this value, SAR will start high fifo adjust
     */
    int high_level;
...
typedef struct
{
    ...
    /**
     * get table sar_jitter_fifo_levels entry 
     */
    dnx_data_nif_flexe_sar_jitter_fifo_levels_get_f sar_jitter_fifo_levels_get;
    /**
     * get general info table about table (for example key size)sar_jitter_fifo_levels info
     */
...
typedef struct
{
    ...
    /**
     * returns define data of tcam_key_offset_size
     */
    ...
    /**
     * returns define data of nof_ofr_port_profiles
     */
    ...
    /**
     * returns define data of nof_ofr_nif_interfaces
     */
...
typedef enum
{
    ...
    /**
     * Indicate if Tx phase interpolator is supported in PM8x50
     */
...
{
    /**
     * is device type support nif arbiter
     */
    dnx_data_nif_arb_is_supported,
    /**
     * is arbiter used in current configuration
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_NIF - ARB:
 * {
 */
/**
 * \brief Interface for nif arb data
 */
typedef struct
{
    /**
...
{
    /**
     * is device type support nif OFR
     */
    dnx_data_nif_ofr_is_supported,
    /**
     * is OFR used in current configuration
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_NIF - OFR:
 * {
 */
/**
 * \brief Interface for nif ofr data
 */
typedef struct
{
    /**
...
{
    /**
     * is device type support nif OFT
     */
    dnx_data_nif_oft_is_supported,
    /**
     * is OFT used in current configuration
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_NIF - OFT:
 * {
 */
/**
 * \brief Interface for nif oft data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of port_speed_granularity
     */
    dnx_data_nif_oft_port_speed_granularity_get_f port_speed_granularity_get;
    /**
     * returns define data of calendar_speed_granularity
     */
...
typedef struct
{
    ...
    /**
     * Interface for nif arb data
     */
    dnx_data_if_nif_arb_t arb;
    /**
     * Interface for nif ofr data
     */
    dnx_data_if_nif_ofr_t ofr;
    /**
     * Interface for nif oft data
     */
