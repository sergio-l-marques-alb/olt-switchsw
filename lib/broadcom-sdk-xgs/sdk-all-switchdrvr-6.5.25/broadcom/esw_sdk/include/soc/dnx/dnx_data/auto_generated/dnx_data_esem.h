 ...
 */
/**
 * \brief Holds values of submodule access_cmd table esem_cmd_table_map
 * Table info:
...
typedef struct
{
    ...
    /**
     * ESEM CMD profile filed value
     */
    dbal_fields_e esem_cmd;
    /**
     * array of ESEM CMD valid filed value for eache ESEM access
     */
    dbal_fields_e access_valid[DNX_DATA_MAX_ESEM_ACCESS_CMD_NOF_ESEM_ACCESSES];
    /**
     * array of ESEM CMD program filed value for eache ESEM access
     */
    dbal_fields_e access_program[DNX_DATA_MAX_ESEM_ACCESS_CMD_NOF_ESEM_ACCESSES];
    /**
     * array of ESEM CMD designated offset filed value for eache ESEM access
     */
    dbal_fields_e access_designated_offset[DNX_DATA_MAX_ESEM_ACCESS_CMD_NOF_ESEM_ACCESSES];
    /**
     * array of ESEM CMD default result filed value for eache ESEM access
     */
...
{
    /**
     * True if ESEM default_result_profile for AC has two tags
     */
