...
typedef enum
{
    ...
    /**
     * no egress replication in the system, can be set only in devices that don't require ETPP access to MCDB
     */
    ...
    /**
     * bit string is resolved from MCDB
     */
