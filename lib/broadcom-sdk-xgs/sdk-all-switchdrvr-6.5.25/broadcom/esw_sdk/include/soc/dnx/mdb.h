...
#define MDB_CALC_FEC_ID_START_ADDR_OF_BANK_ID(unit, bank_id) ((dnx_data_l3.fec.feature_get(unit, dnx_data_l3_fec_uneven_bank_sizes)) ? MDB_CALC_FEC_ID_START_ADDR_OF_BANK_ID_UNEVEN(unit, bank_id) : MDB_CALC_FEC_ID_START_ADDR_OF_BANK_ID_EVEN(unit, bank_id))
