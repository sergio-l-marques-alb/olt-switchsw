...
/**
 * \brief Holds values of submodule params table fqp_dbf_additional_latency
 * Table info:
...
{
    /**
     * fqp_dbf_additional_latency of the CORE.
     */
    int delay;
...
typedef enum
{
    ...
    /**
     * fqp TXQ_MAX_BYTES_TH MIN_GAP ALLOW_CONS_SEL existance
     */
    ...
    /**
     * If this feature is set, the constant RQP and FQP bubble generation should be disabled
     */
    dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled,
    /**
     * Shapers to be allowed to accumulate credits above max burst when port with negative compensation exist.
     */
    dnx_data_egr_queuing_params_credits_above_max_burst_for_negative_comp,
    /**
     * If this feature is set, the max amount of credits needs to be reduced based on the number of ESB ports allocated
     */
    dnx_data_egr_queuing_params_txq_reduce_max_credits,
    /**
     * If this feature is set, the reserved Egress IF needs to be configured to send FC back to EPS in case of traffic
     */
    dnx_data_egr_queuing_params_reserved_if_fc_config,
    /**
     * If this feature is set, different modes of credit allocation is supported
     */
    dnx_data_egr_queuing_params_credit_init_mode,
    /**
     * If this feature is set, set_selct field is valid
     */
    dnx_data_egr_queuing_params_set_select_needs_to_be_set,
    /**
     * determines whether shared fqp txq configuration exist
     */
    dnx_data_egr_queuing_params_shared_hp_tdm_config_is_supported,
    /**
     * determines whether nif calendars has 64 entries at each entry
     */
    dnx_data_egr_queuing_params_enhanced_nif_calendar,
    /**
     * unicast fifo depth configuration is fixed and not supported
     */
...
typedef struct
{
    ...
    /**
     * returns define data of nof_egr_olp_interfaces
     */
    ...
    /**
     * returns numeric data of egress_bubble_delay
     */
    ...
    /**
     * get table fqp_dbf_additional_latency entry 
     */
    dnx_data_egr_queuing_params_fqp_dbf_additional_latency_get_f fqp_dbf_additional_latency_get;
    /**
     * get general info table about table (for example key size)fqp_dbf_additional_latency info
     */
