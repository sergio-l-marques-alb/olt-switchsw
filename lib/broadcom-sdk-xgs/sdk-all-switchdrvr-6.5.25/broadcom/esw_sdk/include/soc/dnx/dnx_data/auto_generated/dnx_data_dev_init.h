 ...
 */
/**
 * \brief Holds values of submodule general table clock_power_down
 * Table info:
...
{
    /**
     * If set, allow multithreading during device init
     */
    ...
    /**
     * indicates whether the device supports application_v1
     */
    dnx_data_dev_init_general_application_v1,
    /**
     * indicates whether the device supports application_v2
     */
    ...
    /**
     * If needed, every SyncCounter number of clocks a bubble will be inserted to the IHP pipe, to allow database managements and/or CPU indirect access at an assured rate
     */
    dnx_data_dev_init_general_ippe_sync_counter,
    /**
     * support FAI namespace for different protocol
     */
...
typedef struct
{
    ...
    /**
     * get table clock_power_down entry 
     */
    dnx_data_dev_init_general_clock_power_down_get_f clock_power_down_get;
    /**
     * get general info table about table (for example key size)clock_power_down info
     */
...
typedef enum
{
    ...
    /**
     * Enable sw state diagnostics (e.g. size_get)
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_DEV_INIT - RX:
 * {
 */
/**
 * \brief Interface for dev_init rx data
 */
typedef struct
{
    /**
    ...
    /**
     * returns numeric data of rx_pool_nof_pkts
     */
...
typedef struct
{
    ...
    /**
     * Interface for dev_init rx data
     */
