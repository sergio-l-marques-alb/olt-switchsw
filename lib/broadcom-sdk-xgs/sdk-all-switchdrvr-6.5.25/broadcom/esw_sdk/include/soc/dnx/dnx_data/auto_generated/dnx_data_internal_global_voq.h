/** \file dnx_data_internal_global_voq.h
 * 
 ...
 */
#ifndef _DNX_DATA_INTERNAL_GLOBAL_VOQ_H_
/*{*/
#define _DNX_DATA_INTERNAL_GLOBAL_VOQ_H_
/*
 * INCLUDE FILES:
 * {
 */
...
typedef enum
{
    dnx_data_global_voq_submodule_general,
    dnx_data_global_voq_submodule_dbal,

    /**
     * Must be last one!
     */
    _dnx_data_global_voq_submodule_nof
} dnx_data_global_voq_submodule_e;
 ...
 *   * None
 */
int dnx_data_global_voq_general_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_global_voq_general_define_min_refresh_interval,
    dnx_data_global_voq_general_define_tc_profile_nof,
    dnx_data_global_voq_general_define_tc_index_nof,
    dnx_data_global_voq_general_define_bin_profile_nof,
    dnx_data_global_voq_general_define_bin_index_nof,
    dnx_data_global_voq_general_define_max_bin_threshold,
    dnx_data_global_voq_general_define_aggregation_entries_nof,
    dnx_data_global_voq_general_define_mechanisms_nof,

    /**
     * Must be last one!
     */
    _dnx_data_global_voq_general_define_nof
} dnx_data_global_voq_general_define_e;
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_min_refresh_interval_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_tc_profile_nof_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_tc_index_nof_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_bin_profile_nof_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_bin_index_nof_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_max_bin_threshold_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_aggregation_entries_nof_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_general_mechanisms_nof_get(
    int unit);
...
typedef enum
{
    dnx_data_global_voq_general_table_valid_quanta_sizes,

    /**
     * Must be last one!
     */
    _dnx_data_global_voq_general_table_nof
} dnx_data_global_voq_general_table_e;
 ...
 *   * None
 */
const dnx_data_global_voq_general_valid_quanta_sizes_t * dnx_data_global_voq_general_valid_quanta_sizes_get(
    int unit,
    int index);
 ...
 * Module - 'global_voq', Submodule - 'general', table - 'valid_quanta_sizes'
 * supported quanta sizes
 * 
 * \param [in] unit - Unit #
 ...
 *   * None
 */
shr_error_e dnx_data_global_voq_general_valid_quanta_sizes_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
 ...
 *   * None
 */
const dnxc_data_table_info_t * dnx_data_global_voq_general_valid_quanta_sizes_info_get(
    int unit);
 ...
 *   * None
 */
int dnx_data_global_voq_dbal_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_global_voq_dbal_define_quanta_words_shift_nof_bits,
    dnx_data_global_voq_dbal_define_refresh_period_nof_bits,
    dnx_data_global_voq_dbal_define_phase_transition_timeout_nof_bits,
    dnx_data_global_voq_dbal_define_phase_nof_bits,
    dnx_data_global_voq_dbal_define_phase_period_nof_bits,
    dnx_data_global_voq_dbal_define_phase_start_nof_bits,
    dnx_data_global_voq_dbal_define_consecutive_down_nof_bits,
    dnx_data_global_voq_dbal_define_bin_interval_nof_bits,
    dnx_data_global_voq_dbal_define_tc_profile_nof_bits,
    dnx_data_global_voq_dbal_define_tc_index_nof_bits,
    dnx_data_global_voq_dbal_define_bin_profile_nof_bits,
    dnx_data_global_voq_dbal_define_bin_index_nof_bits,
    dnx_data_global_voq_dbal_define_max_bin_threshold_nof_bits,
    dnx_data_global_voq_dbal_define_base_nof_bits,

    /**
     * Must be last one!
     */
    _dnx_data_global_voq_dbal_define_nof
} dnx_data_global_voq_dbal_define_e;
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_quanta_words_shift_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_refresh_period_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_phase_transition_timeout_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_phase_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_phase_period_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_phase_start_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_consecutive_down_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_bin_interval_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_tc_profile_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_tc_index_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_bin_profile_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_bin_index_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_max_bin_threshold_nof_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_global_voq_dbal_base_nof_bits_get(
    int unit);
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_global_voq_dbal_table_nof
} dnx_data_global_voq_dbal_table_e;
 ...
 *   * None
 */
shr_error_e dnx_data_global_voq_init(
    int unit,
 ...
 */
/*}*/
#endif /*_DNX_DATA_INTERNAL_GLOBAL_VOQ_H_*/
/* *INDENT-ON* */
