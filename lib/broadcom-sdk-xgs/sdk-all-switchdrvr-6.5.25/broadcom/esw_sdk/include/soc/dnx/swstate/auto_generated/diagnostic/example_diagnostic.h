/** \file dnx/swstate/auto_generated/diagnostic/example_diagnostic.h
 *
...
#ifndef __DNX_EXAMPLE_DIAGNOSTIC_H__
#define __DNX_EXAMPLE_DIAGNOSTIC_H__
...
int example_bitmap_include_only_example_dump(
    int unit, int bitmap_include_only_example_idx_0, dnx_sw_state_dump_filters_t filters);

int example_bitmap_array_dump(
    int unit, int bitmap_array_idx_0, int bitmap_array_idx_1, dnx_sw_state_dump_filters_t filters);

int example_bitmap_variable_access_dump(
    int unit, int bitmap_variable_access_idx_0, dnx_sw_state_dump_filters_t filters);
...
int example_htb_dump(
    int unit, int htb_idx_0, dnx_sw_state_dump_filters_t filters);
...
int example_large_DS_examples_large_htb_dump(
    int unit, int large_htb_idx_0, dnx_sw_state_dump_filters_t filters);
...
#endif /* __DNX_EXAMPLE_DIAGNOSTIC_H__ */
