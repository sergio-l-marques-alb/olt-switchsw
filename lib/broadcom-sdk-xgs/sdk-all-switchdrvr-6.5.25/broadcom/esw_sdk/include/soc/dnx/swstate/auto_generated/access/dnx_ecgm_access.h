...
/**
 * implemented by: dnx_ecgm_db_port_info_set
 */
typedef int (*dnx_ecgm_db_port_info_set_cb)(
    int unit, uint32 port_info_idx_0, uint32 port_info_idx_1, CONST dnx_ecgm_port_profile_info_t *port_info);

/**
 * implemented by: dnx_ecgm_db_port_info_get
 */
typedef int (*dnx_ecgm_db_port_info_get_cb)(
    int unit, uint32 port_info_idx_0, uint32 port_info_idx_1, CONST dnx_ecgm_port_profile_info_t **port_info);

/**
 * implemented by: dnx_ecgm_db_port_info_alloc
 */
typedef int (*dnx_ecgm_db_port_info_alloc_cb)(
    int unit);
...
/**
 * This structure holds the access functions for the variable port_info
 */
typedef struct {
    dnx_ecgm_db_port_info_set_cb set;
    dnx_ecgm_db_port_info_get_cb get;
    dnx_ecgm_db_port_info_alloc_cb alloc;
} dnx_ecgm_db_port_info_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for port_info
     */
    dnx_ecgm_db_port_info_cbs port_info;
    /**
