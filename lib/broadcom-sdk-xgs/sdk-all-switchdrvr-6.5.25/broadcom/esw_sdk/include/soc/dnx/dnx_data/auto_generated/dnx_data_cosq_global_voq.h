/** \file dnx_data_cosq_global_voq.h
 * 
 ...
 */
#ifndef _DNX_DATA_COSQ_GLOBAL_VOQ_H_
/*{*/
#define _DNX_DATA_COSQ_GLOBAL_VOQ_H_
/*
 * INCLUDE FILES:
 * {
 */
...
#include <soc/dnx/dnx_data/auto_generated/dnx_data_max_cosq_global_voq.h>
/*
 * }
 */
 ...
 */
/**
 * \brief Init default data structure - dnx_data_if_cosq_global_voq
 * 
 * \param [in] unit - Unit #
 * 
 * \return
 ...
 *   * None
 */
shr_error_e dnx_data_if_cosq_global_voq_init(
    int unit);
...
typedef struct
{
     ...
     */
    int is_valid;
} dnx_data_cosq_global_voq_general_valid_quanta_sizes_t;
...
typedef enum
{
     ...
     */
    dnx_data_cosq_global_voq_general_is_global_voq_supported,

    /**
     * Must be last one!
     */
    _dnx_data_cosq_global_voq_general_feature_nof
} dnx_data_cosq_global_voq_general_feature_e;
 ...
 */
typedef int(
    *dnx_data_cosq_global_voq_general_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_general_min_refresh_interval_get_f) (
    int unit);
 ...
 *   * None
 */
typedef const dnx_data_cosq_global_voq_general_valid_quanta_sizes_t *(
    *dnx_data_cosq_global_voq_general_valid_quanta_sizes_get_f) (
    int unit,
    int index);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_COSQ_GLOBAL_VOQ - GENERAL:
 * {
 */
/**
 * \brief Interface for cosq_global_voq general data
 */
typedef struct
{
    /**
     ...
     */
    dnx_data_cosq_global_voq_general_feature_get_f feature_get;
    /**
     * returns define data of min_refresh_interval
     */
    dnx_data_cosq_global_voq_general_min_refresh_interval_get_f min_refresh_interval_get;
    /**
     * get table valid_quanta_sizes entry 
     */
    dnx_data_cosq_global_voq_general_valid_quanta_sizes_get_f valid_quanta_sizes_get;
    /**
...
} dnx_data_if_cosq_global_voq_general_t;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_cosq_global_voq_dbal_feature_nof
} dnx_data_cosq_global_voq_dbal_feature_e;
 ...
 */
typedef int(
    *dnx_data_cosq_global_voq_dbal_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_quanta_words_shift_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_refresh_period_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_phase_transition_timeout_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_phase_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_phase_period_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_phase_start_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_consecutive_down_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_tc_profile_nof_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_tc_index_nof_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_bin_profile_nof_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_bin_index_nof_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_bin_interval_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_base_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_tc_profile_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_tc_index_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_bin_profile_nof_bits_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_cosq_global_voq_dbal_bin_index_nof_bits_get_f) (
    int unit);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_COSQ_GLOBAL_VOQ - DBAL:
 * {
 */
/**
 * \brief Interface for cosq_global_voq dbal data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_cosq_global_voq_dbal_feature_get_f feature_get;
    /**
     * returns define data of quanta_words_shift_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_quanta_words_shift_nof_bits_get_f quanta_words_shift_nof_bits_get;
    /**
     * returns define data of refresh_period_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_refresh_period_nof_bits_get_f refresh_period_nof_bits_get;
    /**
     * returns define data of phase_transition_timeout_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_phase_transition_timeout_nof_bits_get_f phase_transition_timeout_nof_bits_get;
    /**
     * returns define data of phase_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_phase_nof_bits_get_f phase_nof_bits_get;
    /**
     * returns define data of phase_period_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_phase_period_nof_bits_get_f phase_period_nof_bits_get;
    /**
     * returns define data of phase_start_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_phase_start_nof_bits_get_f phase_start_nof_bits_get;
    /**
     * returns define data of consecutive_down_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_consecutive_down_nof_bits_get_f consecutive_down_nof_bits_get;
    /**
     * returns define data of tc_profile_nof
     */
    dnx_data_cosq_global_voq_dbal_tc_profile_nof_get_f tc_profile_nof_get;
    /**
     * returns define data of tc_index_nof
     */
    dnx_data_cosq_global_voq_dbal_tc_index_nof_get_f tc_index_nof_get;
    /**
     * returns define data of bin_profile_nof
     */
    dnx_data_cosq_global_voq_dbal_bin_profile_nof_get_f bin_profile_nof_get;
    /**
     * returns define data of bin_index_nof
     */
    dnx_data_cosq_global_voq_dbal_bin_index_nof_get_f bin_index_nof_get;
    /**
     * returns define data of bin_interval_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_bin_interval_nof_bits_get_f bin_interval_nof_bits_get;
    /**
     * returns define data of base_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_base_nof_bits_get_f base_nof_bits_get;
    /**
     * returns numeric data of tc_profile_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_tc_profile_nof_bits_get_f tc_profile_nof_bits_get;
    /**
     * returns numeric data of tc_index_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_tc_index_nof_bits_get_f tc_index_nof_bits_get;
    /**
     * returns numeric data of bin_profile_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_bin_profile_nof_bits_get_f bin_profile_nof_bits_get;
    /**
     * returns numeric data of bin_index_nof_bits
     */
    dnx_data_cosq_global_voq_dbal_bin_index_nof_bits_get_f bin_index_nof_bits_get;
} dnx_data_if_cosq_global_voq_dbal_t;
...
/*
 * MODULE INTERFACE DNX_DATA_IF_COSQ_GLOBAL_VOQ:
 * {
 */
/**
 * \brief Interface for cosq_global_voq data
 */
typedef struct
{
    /**
     * Interface for cosq_global_voq general data
     */
    dnx_data_if_cosq_global_voq_general_t general;
    /**
     * Interface for cosq_global_voq dbal data
     */
    dnx_data_if_cosq_global_voq_dbal_t dbal;
} dnx_data_if_cosq_global_voq_t;
 ...
 */
extern dnx_data_if_cosq_global_voq_t dnx_data_cosq_global_voq;
/*
 * }
 */
/*}*/
#endif /*_DNX_DATA_COSQ_GLOBAL_VOQ_H_*/
/* *INDENT-ON* */
