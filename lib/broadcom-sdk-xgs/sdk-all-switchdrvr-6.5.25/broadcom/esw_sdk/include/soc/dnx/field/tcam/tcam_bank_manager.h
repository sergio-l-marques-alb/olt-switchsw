 ...
 * \param [in] core_id    - Core id to allocate the bank for
 * \return
 *  \retval _SHR_E_NONE - success
 * \remark
 * SPECIAL INPUT:
 ...
 * \param [in] core_id    - The core ID to check if given handler is on its list (Must be specified)
 ...
 * \param [in] core_id    - The core ID to remove the handler from its list
 * \param [in] found      - The handler exist in given bank ID and core ID
 *
 * \return
 *  \retval _SHR_E_NONE - success
 ...
 * \param [in] core_id    - The core ID of the given bank to allocate (Must be specified).
 *
 * \return
 *  \retval _SHR_E_NONE - success
 * \remark
