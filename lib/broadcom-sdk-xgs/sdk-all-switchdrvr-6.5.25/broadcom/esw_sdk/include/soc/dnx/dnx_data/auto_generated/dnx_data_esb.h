...
typedef enum
{
    ...
    /**
     * Indication if Egress Shared Buffers queues can be added or removed
     */
    ...
    /**
     * Support for dedicated identifier for FlexE L1 Ports queues to agreggate them  in the MUX
     */
    dnx_data_esb_general_flexe_l1_dest_dedicated_queue_support,
    /**
     * Support for graceful calendar switching - having active and non-active calendars for switching of configurations.
     */
    dnx_data_esb_general_graceful_calendar_switching,
    /**
     * Support for per priority mapping of ESB queues to EGQ TXQs.
     */
...
typedef struct
{
    ...
    /**
     * returns define data of nof_eth_lp_queues
     */
    ...
    /**
     * returns define data of nof_ilkn_tdm_or_lp_queues
     */
    ...
    /**
     * returns define data of mux_cal_window_size
     */
...
typedef struct
{
    ...
    /**
     * returns define data of credit_size_bits
     */
    dnx_data_esb_dbal_credit_size_bits_get_f credit_size_bits_get;
    /**
     * returns define data of txi_irdy_thresh_size
     */
