...
typedef struct
{
    ...
    /**
     * returns define data of vsi_outrif_offset
     */
    dnx_data_headers_internal_legacy_vsi_outrif_offset_get_f vsi_outrif_offset_get;
    /**
     * returns define data of vsi_outrif_bits
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of otmh_outlif_ext_mode
     */
    dnx_data_headers_otmh_otmh_outlif_ext_mode_get_f otmh_outlif_ext_mode_get;
    /**
     * returns numeric data of otmh_src_ext_enable
     */
...
{
    /**
     * Whether fragmeneted-non-first qualifier is supported or not, in case it's not, then non-frag-or-first-frag qualifier should be supported instead
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - LAYER_RECORDS:
 * {
 */
/**
 * \brief Interface for headers layer_records data
 */
typedef struct
{
    /**
...
typedef struct
{
    ...
    /**
     * Interface for headers layer_records data
     */
