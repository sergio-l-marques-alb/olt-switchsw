 ...
 * \param [in] core_ids    - The IDs of the cores to search prefix on
 *
 * \return
 ...
 * \param [in] core_id    - The core_id to delete prefix for (Must be specified)
 *
 * \return
 *  \retval _SHR_E_NONE - success
 */
 ...
 * \param [in] core_id      - Core ID to check if the given handler_id's prefix is free to be used on (Must be specified)
