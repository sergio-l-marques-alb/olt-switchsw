...
/**
 * \brief get general info table about table (for example key size)skip_clear_on_regress info
 * interrupts skipped clear test on regress
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     skip_clear_on_regress - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)dynamic_mem info
 * dynamic memory
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dynamic_mem - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
