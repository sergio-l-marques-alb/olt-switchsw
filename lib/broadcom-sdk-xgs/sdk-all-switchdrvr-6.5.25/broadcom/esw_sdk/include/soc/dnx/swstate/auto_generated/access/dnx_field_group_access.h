...
/**
 * implemented by: dnx_field_group_sw_fg_info_context_info_qual_attach_info_base_qual_set
 */
...
/**
 * implemented by: dnx_field_group_sw_fg_info_context_info_qual_attach_info_base_qual_get
 */
...
/**
 * implemented by: dnx_field_group_sw_fg_info_tcam_info_cache_mode_set
 */
...
/**
 * implemented by: dnx_field_group_sw_fg_info_tcam_info_cache_mode_get
 */
typedef int (*dnx_field_group_sw_fg_info_tcam_info_cache_mode_get_cb)(
    int unit, uint32 fg_info_idx_0, dnx_field_group_cache_mode_e *cache_mode);

/**
 * implemented by: dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_set
 */
...
/**
 * implemented by: dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_get
 */
typedef int (*dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_get_cb)(
    int unit, uint32 fg_info_idx_0, int *nof_valid_entries);

/**
 * implemented by: dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_inc
 */
typedef int (*dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_inc_cb)(
    int unit, uint32 fg_info_idx_0, uint32 inc_value);

/**
 * implemented by: dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_dec
 */
...
/**
 * implemented by: dnx_field_group_sw_ace_format_info_use_ppmc_range_set
 */
...
/**
 * implemented by: dnx_field_group_sw_ace_format_info_use_ppmc_range_get
 */
...
/**
 * This structure holds the access functions for the variable base_qual
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable cache_mode
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable nof_valid_entries
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for cache_mode
     */
    dnx_field_group_sw_fg_info_tcam_info_cache_mode_cbs cache_mode;
    /**
     * Access struct for nof_valid_entries
     */
...
/**
 * This structure holds the access functions for the variable use_ppmc_range
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for use_ppmc_range
     */
