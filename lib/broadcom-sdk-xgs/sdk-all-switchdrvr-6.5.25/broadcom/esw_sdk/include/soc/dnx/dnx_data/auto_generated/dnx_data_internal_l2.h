...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)mact_result_type_map info
 * This table maps MACT result types for each table
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     mact_result_type_map - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)scan_data_bases_info info
 * Age scan, and scan cycles lem data bases
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     scan_data_bases_info - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)fwd_mact_info info
 * fwd mact info
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     fwd_mact_info - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)lem_table_map_l2_action info
 * Mapping from logical dbal table to L2 action
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     lem_table_map_l2_action - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)flush_pulse info
 * Flush machine pulse reg maping
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     flush_pulse - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
