...
typedef struct {
     ...
     */
    uint8 context_ids[DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_MAX_FWD_CONTEXT_NUM_FOR_ONE_APPTYPE];
    /**
...
typedef struct {
     ...
     */
    dnx_field_user_apptype_info_t user_def_info[DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_APPTYPE_USER_NOF];
