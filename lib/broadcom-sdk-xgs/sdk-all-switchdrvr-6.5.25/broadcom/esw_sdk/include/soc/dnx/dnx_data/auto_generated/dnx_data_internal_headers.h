...
typedef enum
{
    ...
    dnx_data_headers_submodule_layer_records,
...
typedef enum
{
    ...
    dnx_data_headers_internal_legacy_define_vsi_outrif_offset,
    dnx_data_headers_internal_legacy_define_vsi_outrif_bits,
...
/**
 * \brief returns define data of vsi_outrif_offset
 * Module - 'headers', Submodule - 'internal_legacy', data - 'vsi_outrif_offset'
 * VSI/OutRIF/InRIF offset in internal header, valid in jericho mode only
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     vsi_outrif_offset - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_internal_legacy_vsi_outrif_offset_get(
    int unit);

/**
 * \brief returns define data of vsi_outrif_bits
 * Module - 'headers', Submodule - 'internal_legacy', data - 'vsi_outrif_bits'
 * VSI/OutRIF/InRIF bits in internal header, valid in jericho mode only
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     vsi_outrif_bits - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_internal_legacy_vsi_outrif_bits_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_headers_udh_define_data_type0_size,
    dnx_data_headers_udh_define_data_type1_size,
    dnx_data_headers_udh_define_data_type2_size,
    dnx_data_headers_udh_define_data_type3_size,
    dnx_data_headers_udh_define_data_size,
...
/**
 * \brief returns define data of data_type0_size
 * Module - 'headers', Submodule - 'udh', data - 'data_type0_size'
 * UDH data type0 size in UDH header
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     data_type0_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_udh_data_type0_size_get(
    int unit);

/**
 * \brief returns define data of data_type1_size
 * Module - 'headers', Submodule - 'udh', data - 'data_type1_size'
 * UDH data type1 size in UDH header
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     data_type1_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_udh_data_type1_size_get(
    int unit);

/**
 * \brief returns define data of data_type2_size
 * Module - 'headers', Submodule - 'udh', data - 'data_type2_size'
 * UDH data type2 size in UDH header
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     data_type2_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_udh_data_type2_size_get(
    int unit);

/**
 * \brief returns define data of data_type3_size
 * Module - 'headers', Submodule - 'udh', data - 'data_type3_size'
 * UDH data type3 size in UDH header
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     data_type3_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_udh_data_type3_size_get(
    int unit);

/**
 * \brief returns define data of data_size
 * Module - 'headers', Submodule - 'udh', data - 'data_size'
 * UDH data size bytes
 * 
 * \param [in] unit - unit #
 * 
 ...
 *   * None
 */
uint32 dnx_data_headers_udh_data_size_get(
    int unit);
...
typedef enum
{
    dnx_data_headers_otmh_define_otmh_outlif_ext_mode,
    dnx_data_headers_otmh_define_otmh_src_ext_enable,
...
/* Get Data */
/**
 * \brief returns numeric data of otmh_outlif_ext_mode
 * Module - 'headers', Submodule - 'otmh', data - 'otmh_outlif_ext_mode'
 * Configures outlif extenstion on OTMH
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     otmh_outlif_ext_mode - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_otmh_otmh_outlif_ext_mode_get(
    int unit);

/**
 * \brief returns numeric data of otmh_src_ext_enable
 * Module - 'headers', Submodule - 'otmh', data - 'otmh_src_ext_enable'
 * Enable to add source port extension to OTMH
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     otmh_src_ext_enable - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_headers_otmh_otmh_src_ext_enable_get(
    int unit);
 ...
 *   * None
 */
int dnx_data_headers_layer_records_feature_get(
    int unit,
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_headers_layer_records_define_nof
} dnx_data_headers_layer_records_define_e;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_headers_layer_records_table_nof
} dnx_data_headers_layer_records_table_e;
