...
typedef enum
{
    ...
    /**
     * is tcg mapping hardcoded in HW
     */
    dnx_data_sch_general_tcg_mapping_hardcoded,
    /**
     * is global tcg strict priority supported
     */
    dnx_data_sch_general_global_tcg_strict_priority,
    /**
     * is flow-control supported only on channelized interfaces
     */
    dnx_data_sch_general_fc_on_channelized_if_only,
    /**
     * is priority propagation supported only on channelized interfaces
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of assigned_credit_worth_multiplier
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of virtual_flow_mapped_queue
     */
...
typedef struct
{
    ...
    /**
     * returns define data of max_calendar_size
     */
...
typedef struct
{
    ...
    /**
     * returns define data of priority_propagation_if_group_max
     */
    dnx_data_sch_dbal_priority_propagation_if_group_max_get_f priority_propagation_if_group_max_get;
    /**
     * returns define data of max_sch_interfaces_with_fc
     */
    ...
    /**
     * returns numeric data of priority_propagation_if_group_nof_bits
     */
...
{
    /**
     * Support sending flow control (port/queue level) to multiple based on a context ID
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_SCH - FC:
 * {
 */
/**
 * \brief Interface for sch fc data
 */
typedef struct
{
    /**
