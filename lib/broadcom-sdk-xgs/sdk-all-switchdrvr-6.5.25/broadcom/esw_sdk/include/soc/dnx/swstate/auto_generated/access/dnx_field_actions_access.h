...
/**
 * implemented by: dnx_field_action_sw_db_predefined_set
 */
...
/**
 * implemented by: dnx_field_action_sw_db_predefined_get
 */
...
/**
 * implemented by: dnx_field_action_sw_db_predefined_field_id_set
 */
typedef int (*dnx_field_action_sw_db_predefined_field_id_set_cb)(
    int unit, uint32 predefined_idx_0, dbal_fields_e field_id);

/**
 * implemented by: dnx_field_action_sw_db_predefined_field_id_get
 */
...
/**
 * This structure holds the access functions for the variable dnx_field_predefined_action_info_t
 */
typedef struct {
