...
typedef enum
{
    ...
    /**
     * Indicates if EGW has back pressure bit
     */
...
/**
 * \brief returns define data of large_mc_mode1
 * Module - 'elk', Submodule - 'application', data - 'large_mc_mode1'
 * ipv4/ipv6 large multicast mode 1
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     large_mc_mode1 - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of large_mc_mode2
 * Module - 'elk', Submodule - 'application', data - 'large_mc_mode2'
 * ipv4/ipv6 large multicast mode 2
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     large_mc_mode2 - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of large_mc_mode3
 * Module - 'elk', Submodule - 'application', data - 'large_mc_mode3'
 * ipv4/ipv6 large multicast mode 3
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     large_mc_mode3 - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
