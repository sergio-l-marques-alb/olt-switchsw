...
typedef enum
{
    ...
    dnx_data_ingr_congestion_info_define_max_total_bytes,
    dnx_data_ingr_congestion_info_define_nof_active_drams,
    dnx_data_ingr_congestion_info_define_total_bytes,
...
/**
 * \brief returns numeric data of max_total_bytes
 * Module - 'ingr_congestion', Submodule - 'info', data - 'max_total_bytes'
 * Maximal total bytes resources
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     max_total_bytes - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_ingr_congestion_info_max_total_bytes_get(
    int unit);

/**
 * \brief returns numeric data of nof_active_drams
 * Module - 'ingr_congestion', Submodule - 'info', data - 'nof_active_drams'
 * Number of active drams. Used to calculate total bytes resources available in device
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_active_drams - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_ingr_congestion_info_nof_active_drams_get(
    int unit);

/**
 * \brief returns numeric data of total_bytes
 * Module - 'ingr_congestion', Submodule - 'info', data - 'total_bytes'
 * total bytes resources according to available DRAM
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     total_bytes - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_ingr_congestion_info_total_bytes_get(
    int unit);
