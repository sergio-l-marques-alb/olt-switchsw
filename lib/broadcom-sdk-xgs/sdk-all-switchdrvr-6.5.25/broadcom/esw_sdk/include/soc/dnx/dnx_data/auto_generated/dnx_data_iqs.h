...
typedef enum
{
    ...
    dnx_data_iqs_credit_watchdog_delete_special_mode,
    /**
     * indicate if credit balance is supported
     */
    dnx_data_iqs_credit_credit_balance_support,
    /**
     * indicate if credit profile is unified with rate class profile
     */
    dnx_data_iqs_credit_profile_is_rate_class,
 ...
 */
typedef uint32(
    *dnx_data_iqs_credit_profile_nof_bits_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of nof_profiles
     */
    dnx_data_iqs_credit_nof_profiles_get_f nof_profiles_get;
    /**
     * returns numeric data of profile_nof_bits
     */
    dnx_data_iqs_credit_profile_nof_bits_get_f profile_nof_bits_get;
    /**
...
{
    /**
     * indicate if dequeue params should be configured
     */
    dnx_data_iqs_deq_default_dequeue_params_configuration,
    /**
 ...
 */
typedef uint32(
    *dnx_data_iqs_dbal_credit_worth_nof_bits_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of credit_worth_nof_bits
     */
    dnx_data_iqs_dbal_credit_worth_nof_bits_get_f credit_worth_nof_bits_get;
