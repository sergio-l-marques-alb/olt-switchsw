...
/**
 * \brief returns numeric data of nof_single_buckets_per_entry
 * Module - 'meter', Submodule - 'mem_mgmt', data - 'nof_single_buckets_per_entry'
 * Number of single bucket meters in one engine entry
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_single_buckets_per_entry - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns numeric data of nof_dual_buckets_per_entry
 * Module - 'meter', Submodule - 'mem_mgmt', data - 'nof_dual_buckets_per_entry'
 * Number of dual buckets meters in one engine entry
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_dual_buckets_per_entry - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns numeric data of nof_single_buckets_per_entry
     */
    dnx_data_meter_mem_mgmt_nof_single_buckets_per_entry_get_f nof_single_buckets_per_entry_get;
    /**
     * returns numeric data of nof_dual_buckets_per_entry
     */
