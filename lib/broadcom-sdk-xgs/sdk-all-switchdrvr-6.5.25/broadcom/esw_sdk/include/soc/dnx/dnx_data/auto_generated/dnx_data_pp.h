...
typedef struct
{
    ...
    /**
     * returns define data of is_vtt5_supported
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of ingress_packet_header_size
     */
 ...
 */
/**
 * \brief Holds values of submodule debug table from_signal_str
 * Table info:
...
{
    /**
     * in_port 'from' stage signal
     */
    char *in_port;
    /**
     * ptc 'from' stage signal
     */
    char *ptc;
    /**
     * in_lif 'from' stage signal
     */
    char *in_lif;
    /**
     * fwd_domain 'from' stage signal
     */
    char *fwd_domain;
    /**
     * layers 'from' stage signal
     */
    char *ingress_layers;
    /**
     * ingress_qos 'from' stage signal
     */
    char *ingress_qos;
...
typedef struct
{
    ...
    /**
     * get table from_signal_str entry 
     */
    dnx_data_pp_debug_from_signal_str_get_f from_signal_str_get;
    /**
     * get general info table about table (for example key size)from_signal_str info
     */
