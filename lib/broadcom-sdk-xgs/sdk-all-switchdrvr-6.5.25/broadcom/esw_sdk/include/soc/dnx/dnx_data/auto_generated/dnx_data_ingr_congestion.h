...
typedef enum
{
    ...
    /**
     * High precision C1 WRED parameter supported
     */
    dnx_data_ingr_congestion_info_wred_c1_high_precision_supported,
    /**
     * Continuous drop probabilty function supported
     */
...
typedef enum
{
    ...
    /**
     * VSQE/VSQF guaranteed resources are NOT allocated per color
     */
...
{
    /**
     * Indicates if separate counters for packet dequeue to fabric and packet dequeue to DRAM is supported
     */
