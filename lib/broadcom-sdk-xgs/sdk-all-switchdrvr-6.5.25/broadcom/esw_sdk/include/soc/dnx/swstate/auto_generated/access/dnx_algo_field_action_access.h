...
/**
 * implemented by: dnx_algo_field_action_sw_fem_is_priority_position_get
 */
...
/**
 * This structure holds the access functions for the variable is_priority_position
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable dnx_field_action_fem_priorities_t
 */
typedef struct {
    dnx_algo_field_action_sw_fem_set_cb set;
    dnx_algo_field_action_sw_fem_get_cb get;
    /**
     * Access struct for is_priority_position
     */
