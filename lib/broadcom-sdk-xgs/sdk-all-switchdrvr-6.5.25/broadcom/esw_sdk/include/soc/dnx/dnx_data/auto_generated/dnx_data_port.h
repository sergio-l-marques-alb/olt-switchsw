...
/**
 * \brief Holds values of submodule static_add table flr_config
 * Table info:
...
{
    /**
     * Indicate if FLR firmware is supported.
     */
    int flr_fw_support;
    /**
     * The timeout value for FLR. Value 0 means FLR is not enabled in the port.
     */
    bcm_port_flr_timeout_t timeout;
} dnx_data_port_static_add_flr_config_t;

/**
 * \brief Holds values of submodule static_add table timestamp_phy_init
 * Table info:
...
typedef struct
{
    ...
    /**
     * get table flr_config entry 
     */
    dnx_data_port_static_add_flr_config_get_f flr_config_get;
    /**
     * get general info table about table (for example key size)flr_config info
     */
    dnxc_data_table_info_get_f flr_config_info_get;
    /**
     * get table timestamp_phy_init entry 
     */
    dnx_data_port_static_add_timestamp_phy_init_get_f timestamp_phy_init_get;
    /**
     * get general info table about table (for example key size)timestamp_phy_init info
     */
...
typedef enum
{
    ...
    /**
     * Indicates if device supports port header type RCH_SRV6_USP_PSP
     */
    dnx_data_port_general_is_header_type_rch_srv6_usp_psp_supported,
    /**
     * Indicates if rch header offset is supported
     */
...
typedef struct
{
    ...
    /**
     * returns define data of prt_ibch1_explicit_offset_en
     */
    ...
    /**
     * returns numeric data of nof_in_tm_ports
     */
...
typedef struct
{
    ...
    /**
     * in precoder supported by this IMB type
     */
    uint32 precoder_supported;
    /**
     * MIB counter set for this IMB type
     */
