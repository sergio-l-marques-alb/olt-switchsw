...
{
    /**
     * The destination is written in the MCDB entry with the encoding.
     */
    dnx_data_multicast_params_mcdb_dest_encoding_in_entry,
    /**
     * Support nested groups - the destination can be the MC ID of another group.
     */
...
typedef struct
{
    ...
    /**
     * returns numeric data of ingr_dest_bits
     */
 ...
 * Values related to the MCDB entry ID tash table.
 * {
 */
/*
 * Table value structure
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_MULTICAST - MCDB_HASH_TABLE:
 * {
 */
/**
 * \brief Interface for multicast mcdb_hash_table data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of max_key_size_in_words
     */
...
typedef struct
{
    ...
    /**
     * Interface for multicast mcdb_hash_table data
     */
