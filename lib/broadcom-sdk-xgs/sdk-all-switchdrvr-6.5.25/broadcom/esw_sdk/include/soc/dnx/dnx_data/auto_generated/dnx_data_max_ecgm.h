 ...
 */
#define DNX_DATA_MAX_ECGM_CORE_RESOURCES_NOF_PORT_PROFILES (256)
 ...
 */
#define DNX_DATA_MAX_ECGM_CORE_RESOURCES_MC_RCY_RESERVED_INTERFACE_TH_IDS (0)

/**
 * \brief
 * number of reserved ports drop th ids dedicated to recycle not channelized port
 */
#define DNX_DATA_MAX_ECGM_CORE_RESOURCES_MC_RCY_RESERVED_PORT_TH_IDS (0)
 ...
 */
#define DNX_DATA_MAX_ECGM_POOL_DB_SIZE_UC_POOL_DB_MAX_SIZE (0)

/**
 * \brief
 * Multi-Cast pool data buffer max size for ECGM
 */
#define DNX_DATA_MAX_ECGM_POOL_DB_SIZE_MC_POOL_DB_MAX_SIZE (0)
