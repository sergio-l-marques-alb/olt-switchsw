...
/**
 * \brief
 *  Returns if specific handler id has at least one entry on given bank id
 *
 * \param [in] unit           - Device ID
 * \param [in] core           - Core ID
 * \param [in] handler_id     - ID to the handler which entries are to consider
...
/**
 * \brief
 *  Returns a free line closest to the given location depending on the given direction
 *
 * \param [in] unit       - Device ID
 * \param [in] core       - Core
 * \param [in] location   - Location to find a free line closest to
 * \param [in] direction  - Direction in which to find a free line in
 * \param [out] free_line - The free line closest to the given location
 *
 * \return
 *   \retval _SHR_E_NONE success
 */
