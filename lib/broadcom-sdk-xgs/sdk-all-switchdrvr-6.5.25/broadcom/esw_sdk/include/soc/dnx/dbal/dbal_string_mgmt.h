...
/*
 * Concatenates the field name together with its instance id
 * according to field id and instance index
 */
...
/**
 * \brief
 * translate a string to field ID + instance index.
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] str - \n
 ...
 *    \param [in,out] field_id - \n
 *      pointer to output id
 *    \param [in,out] inst_idx - \n
 *      pointer to field instance index
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
 *    shr_error_e - \n
 ...
 *    \param [in] str - \n
 *      string to translate
 *    \param [in,out] field_types_def_id - \n
 *      pointer to output id
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
...
/**
 * \brief
 * translate a string to physical table ID. If no string found, doesn't print an error.
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] str - \n
 *      string to translate
 *    \param [in,out] phy_table_id - \n
 *      pointer to output id
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
 ...
 *    \param [in] str - \n
 *      string to translate
 *    \param [in,out] field_print_type_id - \n
 *      pointer to output id
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
...
/**
 * \brief
 * Converts hl tcam access type to string.
 * If non valid, a default unknown string is returned
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] hl_access_type - \n
 *      ID to translate
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
...
/**
 * \brief
 * translate logger print type to a string.
 * In case of unknown id, a default unknown string will be returned
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] dbal_logger_print_type - print type id
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
 *    char * - \n
...
/**
 * \brief
 * Translates physical table ID to its name. In case of unknown id, a default unknown string will be returned
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
...
/**
 * \brief
 * Translates physical table ID to its name, with option to return a name without index
 * In case of unknown id, a default unknown string will be returned
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] phy_table_id - \n
 *    \param [in] remove_index - 1 for returning name without index
 *      ID to translate
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
...
/**
 * \brief
 * Removes index at the end of the name
 * Does not do any validation, supposes name has an index at the end
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] phys_table_name - Physical table name to remove index\n
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
 *    char * - new name\n
...
/**
 * \brief
 * translate dbal device state to string. In case of unknown id, a
 * default unknown string will be returned
 *
 *  \par DIRECT INPUT:
 *    \param [in] unit
 *    \param [in] dbal_device_state - \n
 *      state to translate
 *  \par INDIRECT INPUT:
 *    None
 *  \par DIRECT OUTPUT:
