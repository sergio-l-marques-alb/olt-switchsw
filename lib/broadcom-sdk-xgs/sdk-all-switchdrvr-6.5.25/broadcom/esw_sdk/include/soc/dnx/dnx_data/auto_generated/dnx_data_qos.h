...
typedef enum
{
    ...
    /**
     * if tc and dp are seperated in hardware logic
     */
    dnx_data_qos_feature_seperate_tc_dp,
    /**
     * support egress initial qos select
     */
    dnx_data_qos_feature_initial_qos_selection,
    /**
     * keep ECN bit in forwarding layer qos remark
     */
    dnx_data_qos_feature_fwd_remark_keep_ecn,
    /**
     * support INgress eXplicit QoS remarking
     */
    dnx_data_qos_feature_ingress_explicit_qos_remark,
    /**
     * if fwd ttl is small than inheritance, then use fwd ttl
     */
    dnx_data_qos_feature_ingress_ttl_uniform_small,
    /**
     * forward plus1 remark use bit map index
     */
    dnx_data_qos_feature_fwd_plus_1_bit_map_index,
    /**
     * forward plus1 remark support mpls
     */
