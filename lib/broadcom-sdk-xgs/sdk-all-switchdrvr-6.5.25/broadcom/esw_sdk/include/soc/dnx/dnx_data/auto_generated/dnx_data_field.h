...
typedef struct
{
    ...
    /**
     * returns define data of dir_ext_first_key
     */
    dnx_data_field_base_ipmf1_dir_ext_first_key_get_f dir_ext_first_key_get;
    /**
     * returns define data of exem_max_result_size
     */
    ...
    /**
     * returns numeric data of exem_pdb
     */
...
typedef struct
{
    ...
    /**
     * First key used for direct extraction.
     */
    ...
    /**
     * EXEM physical database type in the form of dbal_physical_tables_e.
     */
    int exem_pdb;
 ...
 */
/**
 * \brief Holds values of submodule external_tcam table ffc_to_quad_and_group_map
 * Table info:
...
/**
 * \brief Holds values of submodule external_tcam table epmf_payload_sizes
 * Table info:
...
{
    /**
     * Max size of larger option.
     */
    int payload_large_size;
    /**
     * Max size of smaller option. -1 if not applicable.
     */
    int payload_small_size;
    /**
     * First bit on result buffer.
     */
...
{
    /**
     * Indicates if we have a profile for acl_context
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_FIELD - EXTERNAL_TCAM:
 * {
 */
/**
 * \brief Interface for field external_tcam data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of nof_keys_total
     */
    ...
    /**
     * get table epmf_payload_sizes entry 
     */
    dnx_data_field_external_tcam_epmf_payload_sizes_get_f epmf_payload_sizes_get;
    /**
     * get general info table about table (for example key size)epmf_payload_sizes info
     */
...
typedef enum
{
    ...
    /**
     * Indicates whether moving/adding/deleting 80b entries is traffic safe or not
     */
    dnx_data_field_tcam_tcam_80b_traffic_safe_write,
    /**
     * Indicates whether key-mode is used in TCAM HW or not, key-mode enables mixed-ratio as it allows different key-sized TCAM handlers to share the same bank
     */
...
typedef struct
{
    ...
    /**
     * returns define data of access_hw_mix_ratio_supported
     */
    dnx_data_field_tcam_access_hw_mix_ratio_supported_get_f access_hw_mix_ratio_supported_get;
    /**
     * returns define data of direct_supported
     */
    ...
    /**
     * returns define data of tcam_indirect_command_version
     */
...
typedef struct
{
    ...
    /**
     * returns define data of max_nof_field_ios
     */
...
typedef struct
{
    ...
    /**
     * returns define data of default_ftmh_mc_context
     */
    ...
    /**
     * returns define data of default_itmh_pph_fhei_context
     */
...
typedef struct
{
    ...
    /**
     * returns define data of default_ftmh_mc_presel_id_ipmf1
     */
    ...
    /**
     * returns define data of default_itmh_pph_fhei_presel_id_ipmf1
     */
    ...
    /**
     * returns define data of default_itmh_pph_fhei_vlan_presel_id_ipmf2
     */
    ...
    /**
     * returns define data of default_itmh_pph_lif_presel_id_ipmf2
     */
    dnx_data_field_preselector_default_itmh_pph_lif_presel_id_ipmf2_get_f default_itmh_pph_lif_presel_id_ipmf2_get;
    /**
     * returns define data of default_itmh_pph_fhei_lif_presel_id_ipmf2
     */
    ...
    /**
     * returns define data of srv6_endpoint_psp_extended_cut_presel_id_ipmf2
     */
    ...
    /**
     * returns define data of mpls_bier_presel_id_ipmf1
     */
    ...
    /**
     * returns define data of default_itmh_pph_presel_id_vlan_ipmf3
     */
    ...
    /**
     * returns define data of default_ftmh_mc_presel_id_ipmf3
     */
    ...
    /**
     * returns define data of srv6_psp_ext_to_endpoint_presel_id_ipmf3
     */
    ...
    /**
     * returns define data of mpls_bier_presel_id_ipmf3
     */
...
typedef struct
{
    ...
    /**
     * returns define data of predefined_nof
     */
    ...
    /**
     * returns define data of l4_ops_pbus_size
     */
    ...
    /**
     * returns define data of special_metadata_qual_max_parts
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_FIELD - MDB_DT:
 * {
 */
/**
 * \brief Interface for field mdb_dt data
 */
typedef struct
{
    /**
...
typedef struct
{
    ...
    /**
     * returns define data of ext_supported
     */
...
typedef struct
{
    ...
    /**
     * returns define data of max_result_size_all_stages
     */
...
typedef struct
{
    ...
    /**
     * returns define data of vw_supported
     */
    ...
    /**
     * returns define data of ip_tunnel_in_lif_wide_data_nof_bits
     */
...
typedef struct
{
    ...
    /**
     * returns define data of disable_erpp_counters
     */
    ...
    /**
     * returns define data of ftmh_mc
     */
    dnx_data_field_init_ftmh_mc_get_f ftmh_mc_get;
    /**
     * returns define data of flow_id
     */
...
typedef struct
{
    ...
    /**
     * returns define data of tcam_cs_inlif_profile_supported
     */
    dnx_data_field_features_tcam_cs_inlif_profile_supported_get_f tcam_cs_inlif_profile_supported_get;
    /**
     * returns define data of tcam_cs_is_tcam_direct_access
     */
    ...
    /**
     * returns define data of epmf_inlif_profile_map
     */
    ...
    /**
     * returns define data of epmf_exem_debug_signal_move_zero_padding_from_msb_to_lsb
     */
...
typedef struct
{
    ...
    /**
     * returns define data of epmf_tm_port_cs
     */
...
typedef struct
{
    ...
    /**
     * Interface for field external_tcam data
     */
    ...
    /**
     * Interface for field mdb_dt data
     */
