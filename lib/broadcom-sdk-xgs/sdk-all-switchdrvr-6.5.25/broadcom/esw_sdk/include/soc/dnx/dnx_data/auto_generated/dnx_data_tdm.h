...
typedef enum
{
    ...
    /**
     * self explainatory. may imply we have SAR L1 used for tdm traffic
     */
    dnx_data_tdm_params_is_egress_bypass_supported,
    /**
     * whether sid bigger than 14 bit is supported or not. see define sid_max_size
     */
    dnx_data_tdm_params_is_sid_wide_mode_supported,
    /**
     * indicate if egress bypass feature is enabled or disabled
     */
    dnx_data_tdm_params_egress_bypass_enable,
    /**
     * An additional configuration to enable TDM cells from FDT (TDM bypas) to do bypass in RQP exists
     */
...
typedef struct
{
    ...
    /**
     * returns define data of sid_max_size
     */
