...
typedef enum
{
    ...
    /**
     * Reassembly is not sent directly to CGM (PP port override) but it is mapped to internal port
     */
...
/**
 * \brief returns numeric data of reassembly_timeout
 * Module - 'ingr_reassembly', Submodule - 'context', data - 'reassembly_timeout'
 * value of timeout period for reassembly controller
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     reassembly_timeout - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 ...
 * \param [in] is_mgmt - is management port
 * 
 * \return
...
typedef struct
{
    ...
    /**
     * returns numeric data of reassembly_timeout
     */
