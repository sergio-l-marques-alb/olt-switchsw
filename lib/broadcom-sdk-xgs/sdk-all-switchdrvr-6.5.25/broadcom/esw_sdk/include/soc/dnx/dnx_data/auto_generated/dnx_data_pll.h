...
typedef struct
{
    ...
    /**
     * returns numeric data of ts_ptp_fref
     */
...
typedef struct
{
    ...
    int pdiv;
    /**
     * Enable Np and Nq dividers in fraction mode
     */
    int ndiv_frac_mode;
    /**
     * Np divider of PLL4
...
{
    /**
     * Indication that some of the PLL need to be configured in fractional mode.
     */
