...
/* Get Data */
/**
 * \brief returns define data of is_vtt5_supported
 * Module - 'pp', Submodule - 'stages', data - 'is_vtt5_supported'
 * indicated whether VTT5 stage is supported on device
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     is_vtt5_supported - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns numeric data of ingress_packet_header_size
 * Module - 'pp', Submodule - 'ETPP', data - 'ingress_packet_header_size'
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     ingress_packet_header_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/* Get Data */
/**
 * \brief get table from_signal_str entry 
 * string of the 'from' stage that signals will be taken
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     from_signal_str - returns the relevant entry values grouped in struct - see dnx_data_pp_debug_from_signal_str_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief Get table value as string
 * Module - 'pp', Submodule - 'debug', table - 'from_signal_str'
 * string of the 'from' stage that signals will be taken
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)from_signal_str info
 * string of the 'from' stage that signals will be taken
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     from_signal_str - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
