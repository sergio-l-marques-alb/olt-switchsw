...
/**
 * \brief Holds values of submodule mem table block_map
 * Table info:
...
/**
 * \brief Holds values of submodule mem table mem_array
 * Table info:
...
{
    /**
     * memory internal name, example: IPPA_MEM_F000000m
     */
    int mem1;
    /**
     * memory informative name, example: IPPA_IPPA_DEBUG_UNITm
     */
    int mem2;
...
typedef struct
{
    ...
    /**
     * get table block_map entry 
     */
    dnx_data_debug_mem_block_map_get_f block_map_get;
    /**
     * get general info table about table (for example key size)block_map info
     */
    dnxc_data_table_info_get_f block_map_info_get;
    /**
     * get table mem_array entry 
     */
    dnx_data_debug_mem_mem_array_get_f mem_array_get;
    /**
     * get general info table about table (for example key size)mem_array info
     */
...
typedef enum
{
    ...
    /**
     * If set, indicates that esem result signals are valid
     */
...
typedef struct
{
    ...
    /**
     * returns define data of has_etpp_visibility_enabler
     */
    dnx_data_debug_general_has_etpp_visibility_enabler_get_f has_etpp_visibility_enabler_get;
    /**
     * returns define data of has_periodic_visibility
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_DEBUG - NIF:
 * {
 */
/**
 * \brief Interface for debug nif data
 */
typedef struct
{
    /**
    ...
    /**
     * returns numeric data of extension_header
     */
