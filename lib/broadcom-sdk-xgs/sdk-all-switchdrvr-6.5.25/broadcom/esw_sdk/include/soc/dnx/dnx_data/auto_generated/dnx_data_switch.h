...
{
    /**
     * LB forwarding hashing method
     */
    dnx_data_switch_load_balancing_fwd_hashing_method,
    /**
     * Indicate whether layer record mode selection is enabled
     */
    dnx_data_switch_load_balancing_layer_record_mode_selection,
    /**
     * Indicates whether seed configuration per pp port is enabled
     */
...
/**
 * \brief returns define data of nof_bits_mpls_protocol_identifier
 * Module - 'switch', Submodule - 'load_balancing', data - 'nof_bits_mpls_protocol_identifier'
 * The NOF MPLS bits to using describe MPLS protocol identifier
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_bits_mpls_protocol_identifier - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of seed_configuration_per_pp_port
 * Module - 'switch', Submodule - 'load_balancing', data - 'seed_configuration_per_pp_port'
 * Indicate whether configuration of LB seed per pp port is enabled
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     seed_configuration_per_pp_port - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of nof_bits_mpls_protocol_identifier
     */
    dnx_data_switch_load_balancing_nof_bits_mpls_protocol_identifier_get_f nof_bits_mpls_protocol_identifier_get;
    /**
     * returns define data of seed_configuration_per_pp_port
     */
 ...
 * Definitions related to load balancing simulator.
 * {
 */
/*
 * Table value structure
...
/**
 * \brief returns define data of device_enum
 * Module - 'switch', Submodule - 'load_balancing_sim', data - 'device_enum'
 * The device ID according to cint_load_balancing_sim_device_type_e
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     device_enum - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_SWITCH - LOAD_BALANCING_SIM:
 * {
 */
/**
 * \brief Interface for switch load_balancing_sim data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of device_enum
     */
...
{
    /**
     * indicates that the egress svtag is enabled via specific MACSEC context
     */
...
/**
 * \brief returns define data of svtag_init_valid
 * Module - 'switch', Submodule - 'svtag', data - 'svtag_init_valid'
 * Indicate whether svtag init function is valid
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     svtag_init_valid - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_switch_svtag_svtag_init_valid_get_f) (
    int unit);
...
/**
 * \brief returns numeric data of svtag_physical_db
 * Module - 'switch', Submodule - 'svtag', data - 'svtag_physical_db'
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     svtag_physical_db - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of svtag_init_valid
     */
    dnx_data_switch_svtag_svtag_init_valid_get_f svtag_init_valid_get;
    /**
     * returns numeric data of enable_by_defualt
     */
    dnx_data_switch_svtag_enable_by_defualt_get_f enable_by_defualt_get;
    /**
     * returns numeric data of svtag_physical_db
     */
...
typedef struct
{
    ...
    /**
     * Interface for switch load_balancing_sim data
     */
