...
/** used for nof allocations in none std_1 image, in most of the cases replaces the default behavior of reading
 *  specific table capacity */
...
/*
 * \brief - This function check if a given image (string - image_to_check) is the standard image.
 * \param [in] unit - Device Id
 * \param [in] image_to_check - an image to check
 * \param [out] is_standard - True is image_to_check is the standard image, False otherwise
 * \return
 *   int - Error Type
 * \remark
 *   * None
