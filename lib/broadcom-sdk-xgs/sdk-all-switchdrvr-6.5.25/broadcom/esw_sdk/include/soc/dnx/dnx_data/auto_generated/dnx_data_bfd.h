...
typedef enum
{
    ...
    /**
     * BFD identification for BFD over PHP by OAM TCAM is supported
     */
    dnx_data_bfd_general_bfd_over_php_tcam_support,
 ...
 */
typedef uint32(
    *dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_bfd_general_bfd_echo_support_in_parser_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of bfd_over_php_oam_tcam_oam_offset
     */
    dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_get_f bfd_over_php_oam_tcam_oam_offset_get;
    /**
     * returns define data of bfd_echo_support_in_parser
     */
    dnx_data_bfd_general_bfd_echo_support_in_parser_get_f bfd_echo_support_in_parser_get;
