 ...
 * 
 * \return
 *     cable_swap_info - returns the relevant entry values grouped in struct - see dnx_data_port_static_add_cable_swap_info_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get table flr_config entry 
 ...
 * 
 * \return
 *     flr_config - returns the relevant entry values grouped in struct - see dnx_data_port_static_add_flr_config_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get table timestamp_phy_init entry 
 * timestamp init configuration on serdes
 * 
 * \param [in] unit - unit #
 * \param [in] port - logical port number
 * 
 * \return
 *     timestamp_phy_init - returns the relevant entry values grouped in struct - see dnx_data_port_static_add_timestamp_phy_init_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief Get table value as string
 * Module - 'port', Submodule - 'static_add', table - 'timestamp_phy_init'
 * timestamp init configuration on serdes
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief get general info table about table (for example key size)flr_config info
 * Fast link recovery configuration
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     flr_config - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)timestamp_phy_init info
 * timestamp init configuration on serdes
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     timestamp_phy_init - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef enum
{
    ...
    dnx_data_port_general_define_prt_ibch1_explicit_offset_en,
    ...
    dnx_data_port_general_define_prt_configuration_ptch2_ibch1_default_index,
    dnx_data_port_general_define_prt_configuration_ptch1_ibch1_default_index,
    dnx_data_port_general_define_prt_configuration_eth_ibch1_default_index,
...
/**
 * \brief returns define data of prt_ibch1_explicit_offset_en
 * Module - 'port', Submodule - 'general', data - 'prt_ibch1_explicit_offset_en'
 * if true and when ibch1 exist, sdk will explicit extend the pasrer offset by the size of the ibch1 (3 bytes)
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     prt_ibch1_explicit_offset_en - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_port_general_prt_ibch1_explicit_offset_en_get(
    int unit);
...
/**
 * \brief returns numeric data of nof_in_tm_ports
 * Module - 'port', Submodule - 'general', data - 'nof_in_tm_ports'
 * nof in tm ports per core
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_in_tm_ports - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns numeric data of prt_configuration_ptch2_ibch1_default_index
 * Module - 'port', Submodule - 'general', data - 'prt_configuration_ptch2_ibch1_default_index'
 * index of PTCH2 over IBCH1 default configuration in prt_configuration table
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     prt_configuration_ptch2_ibch1_default_index - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_port_general_prt_configuration_ptch2_ibch1_default_index_get(
    int unit);

/**
 * \brief returns numeric data of prt_configuration_ptch1_ibch1_default_index
 * Module - 'port', Submodule - 'general', data - 'prt_configuration_ptch1_ibch1_default_index'
 * index of PTCH1 over IBCH1 default configuration in prt_configuration table
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     prt_configuration_ptch1_ibch1_default_index - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_port_general_prt_configuration_ptch1_ibch1_default_index_get(
    int unit);

/**
 * \brief returns numeric data of prt_configuration_eth_ibch1_default_index
 * Module - 'port', Submodule - 'general', data - 'prt_configuration_eth_ibch1_default_index'
 * index of ETH over IBCH1 default configuration in prt_configuration table
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     prt_configuration_eth_ibch1_default_index - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_port_general_prt_configuration_eth_ibch1_default_index_get(
    int unit);
