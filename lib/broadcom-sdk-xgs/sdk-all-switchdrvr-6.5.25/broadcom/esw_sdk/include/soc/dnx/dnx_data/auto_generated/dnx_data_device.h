...
typedef enum
{
    ...
    /**
     * Stop on error during SDK access init.
     */
    ...
    /**
     * Indicate if FAI unknown address is supported
     */
    dnx_data_device_general_fai_unknown_address_supported,
    /**
     * Indicate if ITPP cud valid check is supported
     */
    dnx_data_device_general_itpp_cud_valid_check,
    /**
     * indicate if test with massive packets sending is supported 
     */
    dnx_data_device_general_high_traffic_support,
    /**
     * Indicate if IRE negative delta (BTR>BTA) is supported
     */
    dnx_data_device_general_ire_negative_delta_support,
    /**
     * Does IPC block exist
     */
...
typedef struct
{
    ...
    /**
     * returns define data of max_nof_layer_protocols
     */
