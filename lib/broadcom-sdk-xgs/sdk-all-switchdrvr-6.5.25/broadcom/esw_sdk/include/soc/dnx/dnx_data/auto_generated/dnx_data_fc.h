...
typedef enum
{
    ...
    /**
     * Indication that the presented status indication for FC from and to ILU is separate for TDM and non-TDM trafic.
     */
    ...
    /**
     * Additional types (E and F) of NIF RX PFC Bitmap and NIF TX PFC Bitmap supported
     */
    dnx_data_fc_general_nif_pfc_bitmaps_e_f_support,
    /**
     * QMLF thresholds are set separately for dedicated high and low RMCs
     */
...
/**
 * \brief returns define data of map_value_size_in_bits
 * Module - 'fc', Submodule - 'coe', data - 'map_value_size_in_bits'
 * For DBAL - size in bits of the Map value field of the calendar.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     map_value_size_in_bits - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of map_value_size_in_bits
     */
