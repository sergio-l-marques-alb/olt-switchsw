...
/**
 * \brief Holds values of submodule hbm table dll_and_qc_conf_vals_per_freq_range
 * Table info:
...
{
    /**
     * The upper limit where a range ends (2 * freq)
     */
    int freq_x2_range_upper_limit;
    /**
     * The value to write to the SBUS DLL_CONFIG_CLK register
     */
    uint32 dll_config_val;
    /**
     * The value for PHY write to param CONFIG_QC_CK_DELAY
     */
    uint32 qc_ck_delay_config_val;
    /**
     * The value for PHY write to param CONFIG_QC_WR_DELAY
     */
    uint32 qc_wr_delay_config_val;
    /**
     * The value for PHY param CONFIG_QC_RD_DELAY
     */
...
typedef enum
{
    ...
    /**
     * A threshold needs to be set upon the Write Data Storage memory in order to prevent WDS overflow
     */
    ...
    /**
     * Indicates support for the HBM2E standard
     */
    dnx_data_dram_hbm_hbm2e_support,
    /**
     * Support for read-write ordering enforcement
     */
...
typedef struct
{
    ...
    /**
     * get table dll_and_qc_conf_vals_per_freq_range entry 
     */
    dnx_data_dram_hbm_dll_and_qc_conf_vals_per_freq_range_get_f dll_and_qc_conf_vals_per_freq_range_get;
    /**
     * get general info table about table (for example key size)dll_and_qc_conf_vals_per_freq_range info
     */
...
typedef enum
{
    ...
    /**
     * Enable temperature read from external Samsung DRAM
     */
    dnx_data_dram_gddr6_enable_temp_read_samsung,
    /**
     * Enable temperature read from external Micron DRAM
     */
...
typedef struct
{
    ...
    uint32 tras;
    /**
     * tras timing parameter for HBM2E DRAM
     */
    uint32 tras_hbm2e;
    /**
...
typedef struct
{
    ...
    /**
     * returns numeric data of write_latency_hbm2e
     */
    ...
    /**
     * returns numeric data of read_latency_hbm2e
     */
    ...
    /**
     * returns numeric data of supported_dram_bitmap
     */
    dnx_data_dram_general_info_supported_dram_bitmap_get_f supported_dram_bitmap_get;
    /**
     * returns numeric data of dram_bitmap_internal
     */
...
/**
 * \brief Holds values of submodule dram_block table gddr6_average_read_inflights_leaky_bucket_config_params
 * Table info:
...
{
    /**
     * field ID for field in table DBAL_TABLE_GDDR6_TDU_DRAM_BLOCK_AVERAGE_READ_INFLIGHTS_LEAKY_BUCKET_CONFIG
     */
    uint32 dbal_field_id;
    /**
     * value to write to dbal field
     */
    uint32 field_val;
...
typedef struct
{
    ...
    /**
     * get table gddr6_average_read_inflights_leaky_bucket_config_params entry 
     */
    ...
    /**
     * get general info table about table (for example key size)gddr6_average_read_inflights_leaky_bucket_config_params info
     */
...
typedef struct
{
    ...
    uint32 ch1_mdiv;
    /**
     * Enable channels and internal dividers
     */
