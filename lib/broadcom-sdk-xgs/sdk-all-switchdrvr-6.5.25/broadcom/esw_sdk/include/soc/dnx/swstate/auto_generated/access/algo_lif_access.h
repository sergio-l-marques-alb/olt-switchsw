...
/**
 * implemented by: local_outlif_info_logical_phase_info_first_no_ll_bank_set
 */
...
/**
 * implemented by: local_outlif_info_logical_phase_info_first_no_ll_bank_get
 */
typedef int (*local_outlif_info_logical_phase_info_first_no_ll_bank_get_cb)(
    int unit, uint32 logical_phase_info_idx_0, uint32 *first_no_ll_bank);

/**
 * implemented by: local_outlif_info_logical_phase_info_last_no_ll_bank_set
 */
...
/**
 * implemented by: local_outlif_info_logical_phase_info_last_no_ll_bank_get
 */
...
/**
 * This structure holds the access functions for the variable first_no_ll_bank
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable last_no_ll_bank
 */
typedef struct {
