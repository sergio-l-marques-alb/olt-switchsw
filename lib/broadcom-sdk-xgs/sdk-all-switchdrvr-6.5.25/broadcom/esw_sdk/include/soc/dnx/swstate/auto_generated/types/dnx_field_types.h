 ...
 */
#define DNX_FIELD_ACTION_INVALID DNX_ACTION(DNX_FIELD_ACTION_CLASS_INVALID & DNX_ACTION_CLASS_MASK, DNX_FIELD_STAGE_INVALID & DNX_ACTION_STAGE_MASK, 127)
 ...
 */
#define DNX_FIELD_QUAL_TYPE_INVALID DNX_QUAL(DNX_FIELD_QUAL_CLASS_INVALID  & DNX_QUAL_CLASS_MASK, DNX_FIELD_STAGE_INVALID & DNX_QUAL_STAGE_MASK, DNX_FIELD_QUAL_ID_INVALID)
...
/**
 * Number of predefined apptypes. See DNX_KBP_MAX_STATIC_OPCODES_NOF.
 */
#define DNX_FIELD_EXTERNAL_MAX_STATIC_OPCODES_NOF (48)
 ...
 * dnx_field_metadata_qual_e , dnx_field_header_qual_e ...
 */
...
typedef enum {
    ...
    /**
     * External TCAM Field Group is the ACL group in the FLP block (or ePMF). The entries are located in the external TCAM
     */
    DNX_FIELD_GROUP_TYPE_EXTERNAL_TCAM,
    /**
...
typedef enum {
     ...
     * EXEM
     */
    DNX_FIELD_ACTION_LENGTH_TYPE_EXEM = 3,
    /**
     * ACE (PPMC database, A.K.A. MCDB)
     */
    DNX_FIELD_ACTION_LENGTH_TYPE_ACE = 4,
    /**
     * Direct extraction
     */
    DNX_FIELD_ACTION_LENGTH_TYPE_DIR_EXT = 5,
    /**
     * external TCAM field group
     */
    DNX_FIELD_ACTION_LENGTH_TYPE_EXTERNAL_TCAM = 6,
    /**
     * MDB DT field group aciton buffer
     */
    DNX_FIELD_ACTION_LENGTH_TYPE_MDB_DT = 7,
    /**
     ...
     */
    DNX_FIELD_ACTION_LENGTH_TYPE_STATE_TABLE = 9,
    DNX_FIELD_ACTION_LENGTH_TYPE_NOF = 10
...
typedef enum {
    ...
    /**
     * Extracted from field group result from the external stage
     */
    DNX_FIELD_INPUT_TYPE_EXTERNAL = 6,
    /**
...
typedef struct {
    ...
    int offset;
    /**
     * The qualifier to be based upon. used for user defined qualifers that relate to split predefined qualifers.
     */
    dnx_field_qual_t base_qual;
