...
/**
 * implemented by: mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_set
 */
...
/**
 * implemented by: mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_get
 */
...
/**
 * implemented by: mdb_db_infos_db_address_space_bits_set
 */
typedef int (*mdb_db_infos_db_address_space_bits_set_cb)(
    int unit, uint32 db_idx_0, int address_space_bits);

/**
 * implemented by: mdb_db_infos_db_address_space_bits_get
 */
...
/**
 * This structure holds the access functions for the variable bank_size_used_nof_rows
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for bank_size_used_nof_rows
     */
...
/**
 * This structure holds the access functions for the variable address_space_bits
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for address_space_bits
     */
...
/**
 * This structure holds the access functions for the variable fec_db_map
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable l3_fec_db_info_t
 */
typedef struct {
    /**
     * Access struct for fec_db_map
     */
