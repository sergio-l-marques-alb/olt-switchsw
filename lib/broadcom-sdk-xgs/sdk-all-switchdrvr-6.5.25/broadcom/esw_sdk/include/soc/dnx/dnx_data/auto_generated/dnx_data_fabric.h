...
/**
 * \brief Holds values of submodule general table supported_fmac_tx_padding_sizes
 * Table info:
...
{
    /**
     * Supported FMAC Tx Padding sizes
     */
    uint32 size;
...
typedef enum
{
    ...
    /**
     * Does device support retimer functionality.
     */
    dnx_data_fabric_general_retimer_functionality_supported,
    /**
     * Does device supports fabric mirroring
     */
    dnx_data_fabric_general_mirror_supported,
    /**
     * Does device support FMAC TX padding
     */
 ...
 * Module - 'fabric', Submodule - 'general', data - 'fmac_tx_padding_min_port_speed'
 ...
 * 
 * \return
 *     supported_fmac_tx_padding_sizes - returns the relevant entry values grouped in struct - see dnx_data_fabric_general_supported_fmac_tx_padding_sizes_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of fmac_tx_padding_min_port_speed
     */
    ...
    /**
     * get table supported_fmac_tx_padding_sizes entry 
     */
    dnx_data_fabric_general_supported_fmac_tx_padding_sizes_get_f supported_fmac_tx_padding_sizes_get;
    /**
     * get general info table about table (for example key size)supported_fmac_tx_padding_sizes info
     */
...
/**
 * \brief Holds values of submodule links table default_fec
 * Table info:
...
{
    /**
     * default fec type of that speed
     */
    bcm_port_phy_fec_t fec_type;
} dnx_data_fabric_links_default_fec_t;

/**
 * \brief Holds values of submodule links table supported_fec_controls
 * Table info:
...
{
    /**
     * fec type supported by device
     */
    bcm_port_phy_fec_t fec_type;
    /**
     * control type for the corresponding fec
     */
...
typedef enum
{
    ...
    /**
     * Indicates if device support C-LLFC, RXI-TXI.
     */
 ...
 * 
 * \return
 *     default_fec - returns the relevant entry values grouped in struct - see dnx_data_fabric_links_default_fec_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 ...
 * 
 * \return
 *     supported_fec_controls - returns the relevant entry values grouped in struct - see dnx_data_fabric_links_supported_fec_controls_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * get table default_fec entry 
     */
    dnx_data_fabric_links_default_fec_get_f default_fec_get;
    /**
     * get general info table about table (for example key size)default_fec info
     */
    dnxc_data_table_info_get_f default_fec_info_get;
    /**
     * get table supported_fec_controls entry 
     */
    dnx_data_fabric_links_supported_fec_controls_get_f supported_fec_controls_get;
    /**
     * get general info table about table (for example key size)supported_fec_controls info
     */
 ...
 */
/**
 * \brief Holds values of submodule cell table supported_pcp_modes
 * Table info:
 * Shows supported PCP modes.
 */
typedef struct
{
    /**
     * is supported for device
     */
    uint8 supported;
...
typedef enum
{
    ...
    /**
     * PCP couldn't be excluded from cell fromat.
     */
 ...
 * Max cell size in VSC256 configuration. It consist of the 256 payload + max header size
 * 
 * \param [in] unit - unit #
 * 
 * \return
...
/**
 * \brief returns define data of max_vsc_format_size
 * Module - 'fabric', Submodule - 'cell', data - 'max_vsc_format_size'
 * Max VSC cell size supported for the device
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     max_vsc_format_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 ...
 * Number of source routed source instances/buffers. Indicates how many interrupts you have to check to see if there are cells in the FIFOs.
 * 
 * \param [in] unit - unit #
 * 
 * \return
...
/**
 * \brief get table supported_pcp_modes entry 
 * Shows supported PCP modes.
 * 
 * \param [in] unit - unit #
 * \param [in] pcp_mode - PCP mode
 * 
 * \return
 *     supported_pcp_modes - returns the relevant entry values grouped in struct - see dnx_data_fabric_cell_supported_pcp_modes_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of max_vsc_format_size
     */
    ...
    /**
     * get table supported_pcp_modes entry 
     */
    dnx_data_fabric_cell_supported_pcp_modes_get_f supported_pcp_modes_get;
    /**
     * get general info table about table (for example key size)supported_pcp_modes info
     */
...
typedef enum
{
    ...
    /**
     * Can pipes be configured from a global ECI register.
     */
...
{
    /**
     * Shows that TDM config regs and fields are missing
     */
...
/**
 * \brief Holds values of submodule cgm table ingress_dynamic_wfq_configs
 * Table info:
 * Weights and thresholds for ingress dynamic WFQ.
 */
typedef struct
{
    /**
     * Weight when input WFQ leg is not congested
     */
    int normal_weight;
    /**
     * Weight when input WFQ leg is congested
     */
    int congested_weight;
    /**
     * Threshold which switches between normal and congested
     */
    int threshold;
...
typedef enum
{
    ...
    /**
     * Is Dynamic WFQ supported in FDT.
     */
...
/**
 * \brief returns numeric data of llfc_type_default
 * Module - 'fabric', Submodule - 'cgm', data - 'llfc_type_default'
 * Default llfc type mode
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     llfc_type_default - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get table ingress_dynamic_wfq_configs entry 
 * Weights and thresholds for ingress dynamic WFQ.
 * 
 * \param [in] unit - unit #
 * \param [in] wfq_input - WFQ input
 * 
 * \return
 *     ingress_dynamic_wfq_configs - returns the relevant entry values grouped in struct - see dnx_data_fabric_cgm_ingress_dynamic_wfq_configs_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns numeric data of llfc_type_default
     */
    ...
    /**
     * get table ingress_dynamic_wfq_configs entry 
     */
    dnx_data_fabric_cgm_ingress_dynamic_wfq_configs_get_f ingress_dynamic_wfq_configs_get;
    /**
     * get general info table about table (for example key size)ingress_dynamic_wfq_configs info
     */
...
{
    /**
     * If device supports dynamic DTQs allocation
     */
...
/**
 * \brief returns define data of max_nof_dtqs
 * Module - 'fabric', Submodule - 'dtqs', data - 'max_nof_dtqs'
 * Max number of DTQs
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     max_nof_dtqs - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of max_nof_dtqs
     */
...
/**
 * \brief returns define data of cgm_egress_dynamic_wfq_th_bits_nof
 * Module - 'fabric', Submodule - 'dbal', data - 'cgm_egress_dynamic_wfq_th_bits_nof'
 * number of bits for egress dynamic WFQ threshold
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     cgm_egress_dynamic_wfq_th_bits_nof - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of fdr_links_offset
 * Module - 'fabric', Submodule - 'dbal', data - 'fdr_links_offset'
 * offset inside some fdr registers
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     fdr_links_offset - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of cgm_egress_dynamic_wfq_th_bits_nof
     */
    ...
    /**
     * returns define data of fdr_links_offset
     */
...
/**
 * \brief Holds values of submodule transmit table dtq_to_pdq_ocb_thresholds
 * Table info:
 * DTQ to PDQ FC OCB only
 */
typedef struct
{
    /**
     * Set Total threshold for all FCs
     */
    uint32 set_total_th;
    /**
     * Clear threshold for DTQ0 FC
     */
    uint32 mask_dtq_0_th;
    /**
     * Clear threshold for DTQ1 FC
     */
    uint32 mask_dtq_1_th;
    /**
     * Clear threshold for all Local FC
     */
    uint32 mask_local_th;
} dnx_data_fabric_transmit_dtq_to_pdq_ocb_thresholds_t;

/**
 * \brief Holds values of submodule transmit table dtq_to_pdq_non_ocb_thresholds
 * Table info:
 * DTQ to PDQ FC non OCB
 */
typedef struct
{
    /**
    ...
    uint32 set_total_th;
    /**
     * Set threshold for Fabric FCs(DTQ0 + DTQ1)
     */
    uint32 set_total_fabric_th;
    /**
     * Set Total threshold for all local FCs
     */
...
/**
 * \brief Holds values of submodule transmit table dtq_to_pdq_fc_mapping
 * Table info:
 * Determins FC from which DTQ will affect PDQ context
 */
typedef struct
{
    /**
    ...
    uint32 fc;
    /**
     * FC field to configure based on nof_active_dtqs.
     */
...
typedef enum
{
    ...
    /**
     * FC is generated by FDT instead of IPT.
     */
    dnx_data_fabric_transmit_dtq_fc_torwards_pdq,
    /**
     * Indicating if config for local WFQ is available
     */
...
/**
 * \brief get table dtq_to_pdq_ocb_thresholds entry 
 * DTQ to PDQ FC OCB only
 * 
 * \param [in] unit - unit #
 * \param [in] dtq_fc - DTQ FC
 * 
 * \return
 *     dtq_to_pdq_ocb_thresholds - returns the relevant entry values grouped in struct - see dnx_data_fabric_transmit_dtq_to_pdq_ocb_thresholds_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get table dtq_to_pdq_non_ocb_thresholds entry 
 * DTQ to PDQ FC non OCB
 * 
 * \param [in] unit - unit #
 * \param [in] dtq_fc - DTQ FC
 * 
 * \return
 *     dtq_to_pdq_non_ocb_thresholds - returns the relevant entry values grouped in struct - see dnx_data_fabric_transmit_dtq_to_pdq_non_ocb_thresholds_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get table dtq_to_pdq_fc_mapping entry 
 * Determins FC from which DTQ will affect PDQ context
 * 
 * \param [in] unit - unit #
 ...
 * 
 * \return
 *     dtq_to_pdq_fc_mapping - returns the relevant entry values grouped in struct - see dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
{
    /**
     * Denotes whether device supports system upgrade procedure
     */
    dnx_data_fabric_system_upgrade_is_system_upgrade_supported,
    /**
     * Denotes whether the device can serve as the trigger unit of the procedure
     */
 ...
 * defines used in regression tests
 * {
 */
/*
 * Table value structure
...
/**
 * \brief returns define data of minimum_system_ref_clk
 * Module - 'fabric', Submodule - 'regression', data - 'minimum_system_ref_clk'
 * minimum system_ref_clk
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     minimum_system_ref_clk - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of soft_reset_with_fabric_max_exec_time
 * Module - 'fabric', Submodule - 'regression', data - 'soft_reset_with_fabric_max_exec_time'
 * Maximum time for execution of soft reset with fabric in usec.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     soft_reset_with_fabric_max_exec_time - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_FABRIC - REGRESSION:
 * {
 */
/**
 * \brief Interface for fabric regression data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of minimum_system_ref_clk
     */
    dnx_data_fabric_regression_minimum_system_ref_clk_get_f minimum_system_ref_clk_get;
    /**
     * returns define data of soft_reset_with_fabric_max_exec_time
     */
...
typedef struct
{
    ...
    /**
     * Interface for fabric regression data
     */
