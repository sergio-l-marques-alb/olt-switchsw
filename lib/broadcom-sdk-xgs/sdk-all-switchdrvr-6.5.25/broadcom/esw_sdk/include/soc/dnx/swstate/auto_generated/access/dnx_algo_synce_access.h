...
/**
 * implemented by: dnx_algo_synce_db_fabric_synce_status_master_set1_synce_enabled_set
 */
typedef int (*dnx_algo_synce_db_fabric_synce_status_master_set1_synce_enabled_set_cb)(
    int unit, int master_set1_synce_enabled);

/**
 * implemented by: dnx_algo_synce_db_fabric_synce_status_master_set1_synce_enabled_get
 */
typedef int (*dnx_algo_synce_db_fabric_synce_status_master_set1_synce_enabled_get_cb)(
    int unit, int *master_set1_synce_enabled);

/**
 * implemented by: dnx_algo_synce_db_fabric_synce_status_slave_set1_synce_enabled_set
 */
typedef int (*dnx_algo_synce_db_fabric_synce_status_slave_set1_synce_enabled_set_cb)(
    int unit, int slave_set1_synce_enabled);

/**
 * implemented by: dnx_algo_synce_db_fabric_synce_status_slave_set1_synce_enabled_get
 */
