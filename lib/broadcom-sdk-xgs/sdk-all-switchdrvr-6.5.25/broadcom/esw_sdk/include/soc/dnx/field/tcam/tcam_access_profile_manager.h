 ...
 * \param [in] core_id    - The core ID to add to the given database's access profile (Must be specified)
 *
 * \return
 *  \retval _SHR_E_NONE - success
 * \remark
 ...
 * \param [in] core_id    - The core ID to remove from the given database's access profile (Must be specified)
 *
 * \return
 *  \retval _SHR_E_NONE - success
 * \remark
 ...
 *  \param [in] core_id    - The core ID to return the banks bitmap for (Must be specified)
 ...
 * \param [in] core_id    - Core ID that its banks will be returned
