...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)standard_table info
 * standard feature to test family exclusive feature
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     standard_table - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/*{*/
/**
 * \brief get general info table about table (for example key size)table_family_dnx2 info
 * table configured as family exclusive for DNX2 family to test family exclusive feature
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     table_family_dnx2 - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)dnx2_submodule_table info
 * standard table in submodule that is configured as family exclusive of DNX2
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dnx2_submodule_table - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/*{*/
/**
 * \brief get general info table about table (for example key size)table_flags info
 * table configured with a compile flag of macsec
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     table_flags - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)table_no_flags info
 * standard table in submodule that is configured with compile flag of macsec
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     table_no_flags - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
