...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'general', table - 'supported_fmac_tx_padding_sizes'
 * table with all supported FMAC Tx padding sizes
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'links', table - 'default_fec'
 * table with the default FEC type per speed
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'links', table - 'supported_fec_controls'
 * table with supported combinations of FEC type and FEC controls
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'cell', table - 'supported_pcp_modes'
 * Shows supported PCP modes.
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)supported_pcp_modes info
 * Shows supported PCP modes.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     supported_pcp_modes - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'cgm', table - 'ingress_dynamic_wfq_configs'
 * Weights and thresholds for ingress dynamic WFQ.
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief get general info table about table (for example key size)ingress_dynamic_wfq_configs info
 * Weights and thresholds for ingress dynamic WFQ.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     ingress_dynamic_wfq_configs - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'transmit', table - 'dtq_to_pdq_ocb_thresholds'
 * DTQ to PDQ FC OCB only
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'transmit', table - 'dtq_to_pdq_non_ocb_thresholds'
 * DTQ to PDQ FC non OCB
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'transmit', table - 'dtq_to_pdq_fc_mapping'
 * Determins FC from which DTQ will affect PDQ context
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/**
 * \brief get general info table about table (for example key size)dtq_to_pdq_ocb_thresholds info
 * DTQ to PDQ FC OCB only
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dtq_to_pdq_ocb_thresholds - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)dtq_to_pdq_non_ocb_thresholds info
 * DTQ to PDQ FC non OCB
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dtq_to_pdq_non_ocb_thresholds - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief get general info table about table (for example key size)dtq_to_pdq_fc_mapping info
 * Determins FC from which DTQ will affect PDQ context
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dtq_to_pdq_fc_mapping - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
