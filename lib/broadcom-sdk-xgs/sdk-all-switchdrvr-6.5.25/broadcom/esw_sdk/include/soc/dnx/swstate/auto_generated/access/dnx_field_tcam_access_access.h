...
/**
 * implemented by: dnx_field_tcam_access_sw_cache_install_in_progress_set
 */
typedef int (*dnx_field_tcam_access_sw_cache_install_in_progress_set_cb)(
    int unit, uint8 cache_install_in_progress);

/**
 * implemented by: dnx_field_tcam_access_sw_cache_install_in_progress_get
 */
...
/**
 * This structure holds the access functions for the variable cache_install_in_progress
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for cache_install_in_progress
     */
