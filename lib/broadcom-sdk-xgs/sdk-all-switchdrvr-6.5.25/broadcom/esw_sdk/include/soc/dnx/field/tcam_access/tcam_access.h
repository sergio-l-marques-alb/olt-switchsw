 ...
 *
 * \param [in] unit       - unit
 * \param [in] core       - Core ID (Must be specified)
...
/**
 * \brief
 *   Moves one line from the given line_from to line_to addresses
 *
 * \param [in] unit      - Device ID
 * \param [in] core      - Core ID
 * \param [in] app_id    - The app_id (handler_id) that the line to be moved belongs to
 * \param [in] line_from - The address of the line to be copied from
 * \param [in] line_to   - The address that the line should be copied to
 *
 * \return
 *   \retval _SHR_E_NONE success
 *
...
/**
 * \brief
 *   Deletes the line in the given 'line' address
 *
 * \param [in] unit   - Device ID
 * \param [in] core   - Core ID
 * \param [in] app_id - The app_id (handler_id) that the line to be moved belongs to
 * \param [in] line   - Address of the line to delete
 *
 * \return
 *   \retval _SHR_E_NONE success
 *
...
/**
 * \brief
 *   Allocate a new access ID for a TCAM entry.
 *   If given access_id is non-zero, given access id gets allocated, otherwise, a new access ID gets allocated
 *
 * \param [in] unit           - Device ID
 * \param [in, out] access_id - Access ID to allocate, in case access_id=0 as input, a new Access ID gets allocated
 *
 * \return
 *   \retval _SHR_E_NONE success
 *
...
/**
 * \brief
 *   Frees given access ID.
 *
 * \param [in] unit        - Device ID
 * \param [in] access_id   - Access ID to free
 *
 * \return
 *   \retval _SHR_E_NONE success
 *
