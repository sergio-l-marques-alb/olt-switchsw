...
/**
 * implemented by: dnxf_state_lane_map_db_serdes_map_map_size_set
 */
typedef int (*dnxf_state_lane_map_db_serdes_map_map_size_set_cb)(
    int unit, int map_size);

/**
 * implemented by: dnxf_state_lane_map_db_serdes_map_map_size_get
 */
typedef int (*dnxf_state_lane_map_db_serdes_map_map_size_get_cb)(
    int unit, int *map_size);

/**
 * implemented by: dnxf_state_lane_map_db_serdes_map_lane2serdes_set
 */
...
/**
 * implemented by: dnxf_state_lane_map_db_serdes_map_lane2serdes_get
 */
...
/**
 * implemented by: dnxf_state_lane_map_db_serdes_map_serdes2lane_get
 */
...
/**
 * implemented by: dnxf_state_lane_map_db_link_to_fmac_lane_map_get
 */
typedef int (*dnxf_state_lane_map_db_link_to_fmac_lane_map_get_cb)(
    int unit, uint32 link_to_fmac_lane_map_idx_0, int *link_to_fmac_lane_map);

/**
 * implemented by: dnxf_state_lane_map_db_link_to_fmac_lane_map_alloc
 */
...
/**
 * This structure holds the access functions for the variable active_core_bmp
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable soc_dnxf_info_t
 */
typedef struct {
    /**
     * Access struct for active_core_bmp
     */
...
/**
 * This structure holds the access functions for the variable is_enable
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable is_master
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable soc_dnxf_cable_swap_t
 */
typedef struct {
    /**
     * Access struct for is_enable
     */
    dnxf_state_cable_swap_is_enable_cbs is_enable;
    /**
     * Access struct for is_master
     */
...
/**
 * This structure holds the access functions for the variable link_to_fmac_lane_map
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable soc_dnxf_lane_map_db_t
 */
typedef struct {
    /**
     * Access struct for serdes_map
     */
    dnxf_state_lane_map_db_serdes_map_cbs serdes_map;
    /**
     * Access struct for link_to_fmac_lane_map
     */
...
/**
 * This structure holds the access functions for the variable master_set1_synce_enabled
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable slave_set1_synce_enabled
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for master_set1_synce_enabled
     */
    dnxf_state_synce_master_set1_synce_enabled_cbs master_set1_synce_enabled;
    /**
     * Access struct for slave_set1_synce_enabled
     */
