...
shr_error_e soc_ramon_fabric_topology_isolate_set(
    int unit,
...
shr_error_e soc_ramon_fabric_topology_mc_set(
    int unit,
    soc_module_t destination_local_id,
    int links_count,
    soc_port_t * links_array);

shr_error_e soc_ramon_fabric_topology_mc_get(
    int unit,
    soc_module_t destination_local_id,
    int links_count_max,
    int *links_count,
...
shr_error_e soc_ramon_fabric_topology_isolate_get(
    int unit,
    soc_dnxc_isolation_status_t * val);
...
shr_error_e soc_ramon_fabric_topology_lb_get(
    int unit,
    soc_module_t destination_local_id,
    int links_count_max,
    int *links_count,
...
shr_error_e soc_ramon_fabric_topology_repeater_destination_set(
    int unit,
    soc_port_t source,
    soc_port_t destination);

shr_error_e soc_ramon_fabric_topology_repeater_destination_get(
    int unit,
    soc_port_t source,
    soc_port_t * destination);

shr_error_e soc_ramon_fabric_topology_local_route_control_cells_enable_set(
    int unit,
    int enable);
