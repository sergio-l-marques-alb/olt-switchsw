...
typedef struct
{
    ...
    /**
     * The pipe index to use for Unicast Local-Route cells
     */
    int lr_uc_pipe;
    /**
...
{
    /**
     * Indicate the device supports Local-Route using a dedicated pipe for Unicast cells
     */
...
/**
 * \brief returns define data of local_route_pipe_index
 * Module - 'fabric', Submodule - 'pipes', data - 'local_route_pipe_index'
 * The pipe index used for Local Route unicast cells
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     local_route_pipe_index - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of local_route_pipe_index
     */
...
{
    /**
     * Indicates if the multicast egress APIs are still supported.
     */
...
{
    /**
     * Indicates if device have reduced fifo buffers
     */
...
/**
 * \brief returns define data of reduced_rx_resources
 * Module - 'fabric', Submodule - 'fifos', data - 'reduced_rx_resources'
 * Reduced buffer RX FIFO
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     reduced_rx_resources - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of dfl_resources
 * Module - 'fabric', Submodule - 'fifos', data - 'dfl_resources'
 * DFL bank max resources
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dfl_resources - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of reduced_dfl_resources
 * Module - 'fabric', Submodule - 'fifos', data - 'reduced_dfl_resources'
 * DFL bank max resources if SKU with reduced buffers
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     reduced_dfl_resources - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of dfl_bank_wr_threshold_offset
 * Module - 'fabric', Submodule - 'fifos', data - 'dfl_bank_wr_threshold_offset'
 * Offset to the full bank size for the write threshold
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dfl_bank_wr_threshold_offset - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of dfl_bank_admit_threshold_additional_offset
 * Module - 'fabric', Submodule - 'fifos', data - 'dfl_bank_admit_threshold_additional_offset'
 * Additional offset for the admit DFL bank threshold as it has to be lowe than write threshold
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dfl_bank_admit_threshold_additional_offset - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of dfl_bank_wr_threshold_offset
     */
    dnxf_data_fabric_fifos_dfl_bank_wr_threshold_offset_get_f dfl_bank_wr_threshold_offset_get;
    /**
     * returns define data of dfl_bank_admit_threshold_additional_offset
     */
...
{
    /**
     * Indicates if device supports credit based link level flow control
     */
...
/**
 * \brief returns define data of max_wfq_weight_value
 * Module - 'fabric', Submodule - 'congestion', data - 'max_wfq_weight_value'
 * Maxmium WFQ value
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     max_wfq_weight_value - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 ...
 * Module - 'fabric', Submodule - 'congestion', data - 'llfc_type_default'
...
typedef struct
{
    ...
    /**
     * returns define data of max_wfq_weight_value
     */
 ...
 */
/**
 * \brief Holds values of submodule cell table cell_match_filter_reg_mask
 * Table info:
 * register mask for cell filter types
 */
typedef struct
{
    /**
     * starting bit in register
     */
    uint32 start_bit;
    /**
     * bit length of in register
     */
    uint32 bit_length;
    /**
     * mask in register, must be bitwise inverted in code
     */
    uint32 mask;
...
{
    /**
     * PCP couldn't be excluded from cell format
     */
 ...
 * Maximum VSC cell format supported for the device (e.g v256, v512)
 * 
 * \param [in] unit - unit #
 * 
 * \return
...
/**
 * \brief get table cell_match_filter_reg_mask entry 
 * register mask for cell filter types
 * 
 * \param [in] unit - unit #
 * \param [in] filter_type - type of cell filter
 * 
 * \return
 *     cell_match_filter_reg_mask - returns the relevant entry values grouped in struct - see dnxf_data_fabric_cell_cell_match_filter_reg_mask_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * get table cell_match_filter_reg_mask entry 
     */
    dnxf_data_fabric_cell_cell_match_filter_reg_mask_get_f cell_match_filter_reg_mask_get;
    /**
     * get general info table about table (for example key size)cell_match_filter_reg_mask info
     */
...
/**
 * \brief returns define data of all_reachable_fap_group_size
 * Module - 'fabric', Submodule - 'topology', data - 'all_reachable_fap_group_size'
 * Fap group granularity for all-reachable vector.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     all_reachable_fap_group_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
/**
 * \brief returns define data of all_reachable_max_nof_ignore_faps
 * Module - 'fabric', Submodule - 'topology', data - 'all_reachable_max_nof_ignore_faps'
 * Max number of all faps to ignore in the all-reachable vector.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     all_reachable_max_nof_ignore_faps - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef struct
{
    ...
    /**
     * returns define data of all_reachable_fap_group_size
     */
    dnxf_data_fabric_topology_all_reachable_fap_group_size_get_f all_reachable_fap_group_size_get;
    /**
     * returns define data of all_reachable_max_nof_ignore_faps
     */
...
/*
 * SUBMODULE INTERFACE DNXF_DATA_IF_FABRIC - REGRESSION:
 * {
 */
/**
