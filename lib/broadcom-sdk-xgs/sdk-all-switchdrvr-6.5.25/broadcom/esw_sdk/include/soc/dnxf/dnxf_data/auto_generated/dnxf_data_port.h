...
/**
 * \brief Holds values of submodule general table supported_interfaces
 * Table info:
...
/**
 * \brief Holds values of submodule general table default_fec
 * Table info:
...
/**
 * \brief Holds values of submodule general table supported_fec_controls
 * Table info:
...
typedef enum
{
    ...
    /**
     * Indicates if device supports cable swap
     */
    dnxf_data_port_general_is_cable_swap_supported,
    /**
     * Indicates if link up signal source selection is supported
     */
    dnxf_data_port_general_linkup_indication_map_supported,
    /**
     * Indicates if device can be connected to repeater device(FE3200 for example)
     */
...
/**
 * \brief Holds values of submodule static_add table cable_swap_info
 * Table info:
 * Cable swap info
 */
typedef struct
{
    /**
     * Cable swap enable configuration
     */
    int enable;
    /**
     * Cable swap master/slave configuration
     */
    int master;
...
typedef struct
{
    ...
    /**
     * get table cable_swap_info entry 
     */
    dnxf_data_port_static_add_cable_swap_info_get_f cable_swap_info_get;
    /**
     * get general info table about table (for example key size)cable_swap_info info
     */
...
{
    /**
     * Can lanes from FMAL0 connect to phy4-7, and FMAL1 to lanes 0-3
     */
    dnxf_data_port_lane_map_is_quad_swap_supported,
    /**
     * Indicates that the link to FMAC lane mapping is not 1:1
     */
...
/**
 * \brief Holds values of submodule synce table pm_to_ipw_mapping
 * Table info:
...
/**
 * \brief Holds values of submodule synce table ipw_info
 * Table info:
...
typedef struct
{
    ...
    /**
     * get table pm_to_ipw_mapping entry 
     */
    dnxf_data_port_synce_pm_to_ipw_mapping_get_f pm_to_ipw_mapping_get;
    /**
     * get general info table about table (for example key size)pm_to_ipw_mapping info
     */
    dnxc_data_table_info_get_f pm_to_ipw_mapping_info_get;
    /**
     * get table ipw_info entry 
     */
    dnxf_data_port_synce_ipw_info_get_f ipw_info_get;
    /**
     * get general info table about table (for example key size)ipw_info info
     */
 ...
 * data needed for testing and regression
 * {
 */
/*
 * Table value structure
...
{
    /**
     * Is NRZ modulation supported
     */
    dnxf_data_port_regression_is_nrz_supported,
    /**
     * Is setting cell format supported
     */
...
/*
 * SUBMODULE INTERFACE DNXF_DATA_IF_PORT - REGRESSION:
 * {
 */
/**
 * \brief Interface for port regression data
 */
typedef struct
{
    /**
...
typedef struct
{
    ...
    /**
     * Interface for port regression data
     */
