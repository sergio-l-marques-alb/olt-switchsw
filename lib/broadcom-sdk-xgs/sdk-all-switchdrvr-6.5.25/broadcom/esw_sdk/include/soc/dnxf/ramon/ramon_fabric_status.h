...
shr_error_e soc_ramon_fabric_link_status_clear(
    int unit,
    soc_port_t link);

shr_error_e soc_ramon_fabric_link_status_get(
    int unit,
    soc_port_t link_id,
    uint32 *link_status,
    uint32 *errored_token_count);

shr_error_e soc_ramon_fabric_reachability_status_get(
    int unit,
    int moduleid,
    int links_max,
    uint32 *links_array,
...
shr_error_e soc_ramon_fabric_link_connectivity_status_get(
    int unit,
    soc_port_t link_id,
