...
/**
 * Generic fields of the CPU captured VSC256 cell
 */
#define SOC_RAMON_FABRIC_CAPTURED_CELL_COMMON_FORMAT \
    ...
    /** Default values for payload! Payload fields may be changed inside soc_ramon_fabric_cell_parse_table_get */ \
    {soc_dnxc_fabric_cell_field_payload,         NULL,          0,                0,              2048,   "PAYLOAD"}

/**
 * Generic fields of the Source routed VSC256 cell
 */
...
/**
 * Generic fields of the received data VSC256 cell
 */
