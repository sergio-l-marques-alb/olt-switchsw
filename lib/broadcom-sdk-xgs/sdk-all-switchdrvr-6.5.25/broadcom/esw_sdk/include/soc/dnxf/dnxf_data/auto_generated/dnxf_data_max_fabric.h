 ...
 */
#define DNXF_DATA_MAX_FABRIC_FIFOS_DFL_RESOURCES (0)

/**
 * \brief
 * DFL bank max resources if SKU with reduced buffers
 */
#define DNXF_DATA_MAX_FABRIC_FIFOS_REDUCED_DFL_RESOURCES (0)
 ...
 */
#define DNXF_DATA_MAX_FABRIC_FIFOS_DFL_BANK_WR_THRESHOLD_OFFSET (0)

/**
 * \brief
 * Additional offset for the admit DFL bank threshold as it has to be lowe than write threshold
 */
#define DNXF_DATA_MAX_FABRIC_FIFOS_DFL_BANK_ADMIT_THRESHOLD_ADDITIONAL_OFFSET (0)
