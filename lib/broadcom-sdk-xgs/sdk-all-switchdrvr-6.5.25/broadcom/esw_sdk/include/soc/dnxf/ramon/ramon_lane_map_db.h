 ...
 * \param [in] nof_ports -
 *    number of ports represented by the portmacro and size of lane2serdes array
 * \param [out] lane2serdes -
...
#endif /*_SOC_RAMON_LANE_MAP_DB_H_*/
