...
#define SOC_DNXF_DRV_IS_CORE_ZERO_ACTIVE(unit, is_core_zero_active)  \
 ...
 /** Some SKUs have a various cores disabled. Need to avoid accessing those cores */
...
/** Use this macro to validate functions where core_idx is the function argument **/
...
{
    /*
     * We support capturing and accumulating two type of cells at the same time
     * Source Routed and Destination Routed (regular cells simply called captured cells)
     */
