...
/**
 * \brief Get table value as string
 * Module - 'fabric', Submodule - 'cell', table - 'cell_match_filter_reg_mask'
 * register mask for cell filter types
 * 
 * \param [in] unit - Unit #
 * \param [out] buffer - buffer for the value
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)cell_match_filter_reg_mask info
 * register mask for cell filter types
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     cell_match_filter_reg_mask - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
