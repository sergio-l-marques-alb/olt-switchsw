/*
 * $Id: chip.h,v 1.64.18.1 Broadcom SDK $
...
/* J2P */
    ...
    SOC_BLK_BRDC_RTP,
    SOC_BLK_BRDC_MCT,
    SOC_BLK_BRDC_DFL_FBC,
    SOC_BLK_DFL_FBC,
    SOC_BLK_VTMON,
    SOC_BLK_BRDC_CCH_VD0,
    SOC_BLK_BRDC_CCH_VD1,
    SOC_BLK_BRDC_CCML_VD0,
    SOC_BLK_BRDC_CCML_VD1,
    SOC_BLK_BRDC_DCH_VD0,
    SOC_BLK_BRDC_DCH_VD1,
    SOC_BLK_BRDC_DFL_FBC_VD0,
    SOC_BLK_BRDC_DFL_FBC_VD1,
    SOC_BLK_BRDC_DFL_VD0,
    SOC_BLK_BRDC_DFL_VD1,
    SOC_BLK_BRDC_DTL_VD0,
    SOC_BLK_BRDC_DTL_VD1,
    SOC_BLK_BRDC_DTM_VD0,
    SOC_BLK_BRDC_DTM_VD1,
    SOC_BLK_BRDC_FMAC_HIGH,
    SOC_BLK_BRDC_FMAC_LOW,
    SOC_BLK_BRDC_FSRD_HIGH,
    SOC_BLK_BRDC_FSRD_LOW,
    SOC_BLK_BRDC_LCM_VD0,
    SOC_BLK_BRDC_LCM_VD1,
    SOC_BLK_BRDC_QRH_VD0,
    SOC_BLK_BRDC_QRH_VD1,
    SOC_BLK_MESH_TOPOLOGY_WRAP,
    SOC_BLK_DTQ,
    SOC_BLK_NBUTX,
    SOC_BLK_PBU,
    SOC_BLK_QHC,
    ...
    SOC_BLK_HPW,
    SOC_BLK_PHB,
    SOC_BLK_BRDC_FMAC_HIGH_VD0,
    SOC_BLK_BRDC_FMAC_HIGH_VD1,
    SOC_BLK_BRDC_FMAC_LOW_VD0,
    SOC_BLK_BRDC_FMAC_LOW_VD1,
...
#define SOC_BLOCK_DPP_NAMES_INITIALIZER { \
    ...
    {SOC_BLK_FAWT, 0, "FAWT"},\
    {SOC_BLK_FBSW, 0, "FBSW"},\
    {SOC_BLK_FDCRL, 0, "FDCRL"},\
    {SOC_BLK_FDCRS, 0, "FDCRS"},\
    {SOC_BLK_FDMP, 0, "FDMP"},\
    {SOC_BLK_FDMX, 0, "FDMX"},\
    {SOC_BLK_FDMXA, 0, "FDMXA"},\
    {SOC_BLK_FDMXB, 0, "FDMXB"},\
    {SOC_BLK_FDMXC, 0, "FDMXC"},\
    {SOC_BLK_FDMXT, 0, "FDMXT"},\
    {SOC_BLK_FECRL, 0, "FECRL"},\
    {SOC_BLK_FECRS, 0, "FECRS"},\
    {SOC_BLK_FFLXO, 0, "FFLXO"},\
    {SOC_BLK_FFOA, 0, "FFOA"},\
    {SOC_BLK_FFOB, 0, "FFOB"},\
    {SOC_BLK_FGDMP, 0, "FGDMP"},\
    {SOC_BLK_FGMAP, 0, "FGMAP"},\
    {SOC_BLK_FLEXMAC, 0, "FLEXMAC"},\
    {SOC_BLK_FLFR, 0, "FLFR"},\
    {SOC_BLK_FLFT, 0, "FLFT"},\
    {SOC_BLK_FLOTN, 0, "FLOTN"},\
    {SOC_BLK_FMACR, 0, "FMACR"},\
    {SOC_BLK_FMACT, 0, "FMACT"},\
    {SOC_BLK_FMAP, 0, "FMAP"},\
    {SOC_BLK_FMX, 0, "FMX"},\
    {SOC_BLK_FMXA, 0, "FMXA"},\
    {SOC_BLK_FMXBI, 0, "FMXBI"},\
    {SOC_BLK_FMXBJ, 0, "FMXBJ"},\
    {SOC_BLK_FMXC, 0, "FMXC"},\
    {SOC_BLK_FMXT, 0, "FMXT"},\
    {SOC_BLK_FOAM, 0, "FOAM"},\
    {SOC_BLK_FODUO, 0, "FODUO"},\
    {SOC_BLK_FOSW, 0, "FOSW"},\
    {SOC_BLK_FPMR, 0, "FPMR"},\
    {SOC_BLK_FPMT, 0, "FPMT"},\
    {SOC_BLK_FPTPR, 0, "FPTPR"},\
    {SOC_BLK_FPTPT, 0, "FPTPT"},\
    {SOC_BLK_FRA, 0, "FRA"},\
    {SOC_BLK_FRWA, 0, "FRWA"},\
    {SOC_BLK_FRWBC, 0, "FRWBC"},\
    {SOC_BLK_OFR, 0, "OFR"},\
    {SOC_BLK_OFT, 0, "OFT"},\
    {SOC_BLK_BRDC_CCML, 0, "BRDC_CCML"},\
    {SOC_BLK_BRDC_DFL, 0, "BRDC_DFL"},\
    {SOC_BLK_BRDC_DTL, 0, "BRDC_DTL"},\
    {SOC_BLK_CCML, 0, "CCML"},\
    {SOC_BLK_PCU, 0, "PCU"},\
    {SOC_BLK_BRDC_DTM, 0, "BRDC_DTM"},\
    {SOC_BLK_DTM, 0, "DTM"},\
    {SOC_BLK_DFL, 0, "DFL"},\
    {SOC_BLK_DTL, 0, "DTL"},\
    {SOC_BLK_BRDC_RTP, 0, "BRDC_RTP"},\
    {SOC_BLK_BRDC_MCT, 0, "BRDC_MCT"},\
    {SOC_BLK_BRDC_DFL_FBC, 0, "BRDC_DFL_FBC"},\
    {SOC_BLK_DFL_FBC, 0, "DFL_FBC"},\
    {SOC_BLK_VTMON, 0, "VTMON"},\
    {SOC_BLK_BRDC_CCH_VD0, 0, "BRDC_CCH_VD0"},\
    {SOC_BLK_BRDC_CCH_VD1, 0, "BRDC_CCH_VD1"},\
    {SOC_BLK_BRDC_CCML_VD0, 0, "BRDC_CCML_VD0"},\
    {SOC_BLK_BRDC_CCML_VD1, 0, "BRDC_CCML_VD1"},\
    {SOC_BLK_BRDC_DCH_VD0, 0, "BRDC_DCH_VD0"},\
    {SOC_BLK_BRDC_DCH_VD1, 0, "BRDC_DCH_VD1"},\
    {SOC_BLK_BRDC_DFL_FBC_VD0, 0, "BRDC_DFL_FBC_VD0"},\
    {SOC_BLK_BRDC_DFL_FBC_VD1, 0, "BRDC_DFL_FBC_VD1"},\
    {SOC_BLK_BRDC_DFL_VD0, 0, "BRDC_DFL_VD0"},\
    {SOC_BLK_BRDC_DFL_VD1, 0, "BRDC_DFL_VD1"},\
    {SOC_BLK_BRDC_DTL_VD0, 0, "BRDC_DTL_VD0"},\
    {SOC_BLK_BRDC_DTL_VD1, 0, "BRDC_DTL_VD1"},\
    {SOC_BLK_BRDC_DTM_VD0, 0, "BRDC_DTM_VD0"},\
    {SOC_BLK_BRDC_DTM_VD1, 0, "BRDC_DTM_VD1"},\
    {SOC_BLK_BRDC_FMAC_HIGH, 0, "BRDC_FMAC_HIGH"},\
    {SOC_BLK_BRDC_FMAC_LOW, 0, "BRDC_FMAC_LOW"},\
    {SOC_BLK_BRDC_FSRD_HIGH, 0, "BRDC_FSRD_HIGH"},\
    {SOC_BLK_BRDC_FSRD_LOW, 0, "_BRDC_FSRD_LOW"},\
    {SOC_BLK_BRDC_LCM_VD0, 0, "BRDC_LCM_VD0"},\
    {SOC_BLK_BRDC_LCM_VD1, 0, "BRDC_LCM_VD1"},\
    {SOC_BLK_BRDC_QRH_VD0, 0, "BRDC_QRH_VD0"},\
    {SOC_BLK_BRDC_QRH_VD1, 0, "BRDC_QRH_VD1"},\
    {SOC_BLK_MESH_TOPOLOGY_WRAP, 0, "MESH_TOPOLOGY_WRAP"},\
    {SOC_BLK_DTQ, 0, "DTQ"},\
    {SOC_BLK_NBUTX, 0, "NBUTX"},\
    {SOC_BLK_PBU, 0, "PBU"},\
    {SOC_BLK_QHC, 0, "QHC"},\
    {SOC_BLK_FECPB, 0, "FECPB"},\
    {SOC_BLK_FMXBK, 0, "FMXBK"},\
    {SOC_BLK_WB, 0, "WB"},\
    {SOC_BLK_FICPB, 0, "FICPB"},\
    {SOC_BLK_FDMXBJ, 0, "FDMXBJ"},\
    {SOC_BLK_W40, 0, "W40"},\
    {SOC_BLK_FMXAJ, 0, "FMXAJ"},\
    {SOC_BLK_TSN, 0, "TSN"},\
    {SOC_BLK_FMXAI, 0, "FMXAI"},\
    {SOC_BLK_FDMXBI, 0, "FDMXBI"},\
    {SOC_BLK_DC3MAC, 0, "DC3MAC"},\
    {SOC_BLK_DC3PORT, 0, "DC3PORT"},\
    {SOC_BLK_HBW, 0, "HBW"},\
    {SOC_BLK_HPW, 0, "HPW"},\
    {SOC_BLK_PHB, 0, "PHB"},\
    {SOC_BLK_BRDC_FMAC_HIGH_VD0, 0, "BRDC_FMAC_HIGH_VD0"},\
    {SOC_BLK_BRDC_FMAC_HIGH_VD1, 0, "BRDC_FMAC_HIGH_VD1"},\
    {SOC_BLK_BRDC_FMAC_LOW_VD0, 0, "BRDC_FMAC_LOW_VD0"},\
    {SOC_BLK_BRDC_FMAC_LOW_VD1, 0, "BRDC_FMAC_LOW_VD1"},\
    {SOC_BLK_NONE,       0,  ""      }}
