...
int pm8x50_port_tx_threshold_set(int unit, int port, pm_info_t pm_info, int value);
int pm8x50_port_tx_threshold_get(int unit, int port, pm_info_t pm_info, int* value);
...
int pm8x50_port_faults_status_get(int unit, int port, pm_info_t pm_info, portmod_port_fault_status_t* faults);

/*fast link recovery*/
int pm8x50_port_flr_config_set(int unit, int port, pm_info_t pm_info, int enable, portmod_flr_timeout_t timeout_time);
int pm8x50_port_flr_config_get(int unit, int port, pm_info_t pm_info, int* enable, portmod_flr_timeout_t* timeout_time);

/*PMD RX lock status get*/
int pm8x50_port_pmd_rx_lock_status_get(int unit, int port, pm_info_t pm_info, uint32* pmd_lock, uint32* pmd_lock_change);

/*Enable/Disable port link recovery*/
int pm8x50_port_link_recovery_enable_set(int unit, int port, pm_info_t pm_info, int enable);
int pm8x50_port_link_recovery_enable_get(int unit, int port, pm_info_t pm_info, int* enable);
