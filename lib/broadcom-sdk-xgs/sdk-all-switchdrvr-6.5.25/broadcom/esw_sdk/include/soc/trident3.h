...
extern void soc_td3_hg3_feature_update(int unit);
...
extern int soc_td3_ser_single_bit_report_for_bus_buf_get(int unit, int *enable);
...
enum td3_l3_hash_key_type_e {
    ...
    TD3_L3_HASH_KEY_TYPE_SRV6UC = 30,
...
enum td3_vlxlt_hash_key_type_e {
    ...
    TD3_VLXLT_HASH_KEY_TYPE_MPLS_FLEX_SGLP_LABEL = 25,
...
extern int soc_td3_hash_multi_move_depth_validate (int unit, soc_mem_t mem,
                 int depth);
