...
typedef enum dcmn_feature_e {
    ...
    DCMN_JER_NIF_32_0_FEATURE,/*DCMN_<device>_NIF_<num of 25G>_<num of 12.5G>_FEATURE*/
    DCMN_JER_NIF_12_32_FEATURE,/*DCMN_<device>_NIF_<num of 25G>_<num of 12.5G>_FEATURE*/
    DCMN_JER_NIF_36_4_FEATURE,/*DCMN_<device>_NIF_<num of 2.5G>_<num of 10G>_FEATURE*/
    ...
    DCMN_QAX_NIF_8_16_FEATURE,/*DCMN_<device>_NIF_<num of 25G>_<num of 12.5G>_FEATURE*/
    ...
    DCMN_QUX_NIF_12_2_FEATURE,/*DCMN_<device>_NIF_<num of 2.5G>_<num of 10G>_FEATURE*/
    ...
    DCMN_QAX_NO_ILKN_FEATURE,/*Device does not support ILKN interface*/
