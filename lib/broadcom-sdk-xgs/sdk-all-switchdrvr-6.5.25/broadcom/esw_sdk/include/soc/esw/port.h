 ...
 *
 * These match BCMI_XGS5_PORT_RESOURCE_OP_XXX
 *
 ...
 * OP_CHL    - Channelized Flex
 * OP_BUFFER_MANUAL - MMU manual settings, do not overwrite
 */
#define SOC_PORT_RESOURCE_OP_NONE           0
#define SOC_PORT_RESOURCE_OP_REMAP          (1 << 0)
#define SOC_PORT_RESOURCE_OP_LANES          (1 << 1)
#define SOC_PORT_RESOURCE_OP_SPEED          (1 << 2)
#define SOC_PORT_RESOURCE_OP_ENCAP          (1 << 3)
#define SOC_PORT_RESOURCE_OP_ADD            (1 << 4)
#define SOC_PORT_RESOURCE_OP_DEL            (1 << 5)
#define SOC_PORT_RESOURCE_OP_ACTIVE         (1 << 6)
#define SOC_PORT_RESOURCE_OP_ENABLE         (1 << 7)
#define SOC_PORT_RESOURCE_OP_CALENDAR       (1 << 8)
#define SOC_PORT_RESOURCE_OP_ENCAP_FLEX     (1 << 9)
#define SOC_PORT_RESOURCE_OP_CHL            (1 << 10)
#define SOC_PORT_RESOURCE_OP_BUFFER_MANUAL  (1 << 11)
