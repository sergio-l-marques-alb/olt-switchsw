...
typedef enum soc_dfe_multicast_table_mode_e{
    soc_dfe_multicast_table_mode_64k    = 0, /*8x64  mode, 8 parallel accesses to the multicast table can be handled, 4(parallel access)x64(mc id)x144(bits per id) for fe3200*/
