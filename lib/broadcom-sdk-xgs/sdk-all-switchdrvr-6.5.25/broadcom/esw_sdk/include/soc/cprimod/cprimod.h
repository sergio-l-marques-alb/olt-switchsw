 ...
 * cprimod_deinit
 *
 * @brief  DeInitialize cprimod by clean up.  
 *
 * @param [in]  unit            - unit id
 */
 ...
 */
int cprimod_encap_header_config_get(int unit, int port, uint32 queue_num, cprimod_cpri_roe_frame_format_t frame_format, cprimod_encap_header_config_t* config_info);
...
/*! 
 * cprimod_tx_framer_tgen_enable_set
 *
 * @brief   Set/Get Tx Framer Tgen Enable/Disable.   
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  enable          - TGEN enable/disable.
 */
int cprimod_tx_framer_tgen_enable_set(int unit, int port, uint32 enable);
/*! 
 * cprimod_tx_framer_tgen_enable_get
 *
 * @brief   Set/Get Tx Framer Tgen Enable/Disable.   
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [out]  enable          - TGEN enable/disable.
 */
int cprimod_tx_framer_tgen_enable_get(int unit, int port, uint32* enable);
...
/*! 
 * cprimod_header_compare_entry_for_flow_get
 *
 * @brief  Header Compare Entry Delete by Flow ID only.   
 *
 * @param [in]  unit            - unit id
 ...
 * @param [in]  flow_id         - Flow ID.
 * @param [in]  flow_type       - Flow Type Data or Ctrl.
 * @param [out]  compare_entry   - Header Compare Entry.
 */
int cprimod_header_compare_entry_for_flow_get(int unit, int port, uint8 flow_id, cprimod_flow_type_t flow_type, cprimod_header_compare_entry_t* compare_entry);
...
typedef _shr_rx_config_field_t cprimod_rx_config_field_t;

#define CPRIMOD_RX_CONFIG_8B10B_ALLOW_SEED_CHANGE _shrRxConfig8b10bAllowSeedChange
#define CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_HW_CONTROL _shrRxConfig8b10bDescrHw
#define CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_EN _shrRxConfig8b10bDescrEn
#define CPRIMOD_RX_CONFIG_LINK_ACQ_SW_MODE _shrRxConfiglinkAcqSwMode
#define CPRIMOD_RX_CONFIG_64B66B_LOS_OPTION _shrRxConfig64b66bLosOption
#define CPRIMOD_RX_CONFIG_8B10B_FORCE_COMMA_ALIGN_EN _shrRxConfig8b10bForceCommaAlignEn
#define CPRIMOD_RX_CONFIG_64B66B_BER_WINDOW_LIMIT _shrRxConfig64b66bBerWindowLimit
#define CPRIMOD_RX_CONFIG_64B66B_BER_LIMIT _shrRxConfig64b66bBerLimit
#define CPRIMOD_RX_CONFIG_TEST_MODE _shrRxConfigtestMode
#define CPRIMOD_RX_CONFIG_64B66B_INVALID_SYNC_HEADER_CNT _shrRxConfig64b66bInvalidShCnt
#define CPRIMOD_RX_CONFIG_64B66B_VALID_SYNC_HEADER_CNT _shrRxConfig64b66bValidShCnt
#define CPRIMOD_RX_CONFIG_COUNT _shrRxConfigCount
...
typedef _shr_tx_config_field_t cprimod_tx_config_field_t;

#define CPRIMOD_TX_CONFIG_AGNOSTIC_MODE _shrTxConfigagnosticMode
#define CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_VAL _shrTxConfigtxpmdDisableOverrideVal
#define CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_EN _shrTxConfigtxpmdDisableOverrideEn
#define CPRIMOD_TX_CONFIG_SCRAMBLER_BYPASS _shrTxConfigscrambleBypass
#define CPRIMOD_TX_CONFIG_SCRAMBLER_SEED_8B10B  _shrTxConfigseed8b10b
#define CPRIMOD_TX_CONFIG_CWA_SCRABMLER_EN_8B10B _shrTxConfigcwaScrEn8b10b
#define CPRIMOD_TX_CONFIG_COUNT _shrTxConfigCount
 ...
 */
int cprimod_rx_tag_config_get(int unit, int port, uint32* default_tag, uint32* no_match_tag);
...
typedef _shr_rsvd4_control_group_entry_t cprimod_rsvd4_control_group_entry_t;
...
/*! 
 * cprimod_rsvd4_tx_control_flow_group_member_get
 *
 * @brief  Get member from the Tx Control Flow Group..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  group_id        - Group Number 0 or 1. 
 ...
 */
int cprimod_rsvd4_tx_control_flow_group_member_get(int unit, int port, uint32 group_id, uint32 priority, uint32* queue_num, cprimod_control_msg_proc_type_t* proc_type);

/*! 
 * cprimod_rsvd4_tx_control_flow_group_member_get_all
 *
 * @brief  Get Group member information from  the Tx Control Flow Group..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  group_id        - Group Number 0 or 1. 
 * @param [out]  group_config    - Processing Type. 
 */
int cprimod_rsvd4_tx_control_flow_group_member_get_all(int unit, int port, uint32 group_id, cprimod_rsvd4_control_group_entry_t* group_config);
...
/*! 
 * cprimod_rsvd4_tx_single_tunnel_message_config_get
 *
 * @brief  Setting RSVD4 Single Raw Control Message Configuration..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [out]  crc_option      - CRC option. 
 */
int cprimod_rsvd4_tx_single_tunnel_message_config_get(int unit, int port, cprimod_cpri_crc_option_t* crc_option);
 ...
 *
 * @brief  Set/Get Fast Ethernet configuration..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
...
/*! 
 * cprimod_rsvd4_fast_eth_config_get
 *
 * @brief  Set/Get Fast Ethernet configuration..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [out]  config_info     - Fast Eth Configuration. 
 */
int cprimod_rsvd4_fast_eth_config_get(int unit, int port, cprimod_cpri_fast_eth_config_t* config_info);
...
/*! 
 * cprimod_cpri_port_clock_disable_set
 *
 * @brief  Set CPRI port CLK disable value active 1.  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  rst             - active 1 - Disable the clock
 */
int cprimod_cpri_port_clock_disable_set(int unit, int port, int rst);
...
/*! 
 * cprimod_cpri_port_lane_map_get
 *
 * @brief function to get board lane swap.  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 ...
 */
int cprimod_cpri_port_lane_map_get(int unit, int port, uint32 flags, phymod_lane_map_t* lane_map);
