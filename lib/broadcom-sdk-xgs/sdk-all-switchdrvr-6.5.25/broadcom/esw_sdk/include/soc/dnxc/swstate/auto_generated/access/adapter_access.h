/** \file dnxc/swstate/auto_generated/access/adapter_access.h
 *
...
/**
 * implemented by: adapter_context_db_params_adapter_sdk_interface_fd_get
 */
typedef int (*adapter_context_db_params_adapter_sdk_interface_fd_get_cb)(
    int unit, uint32 params_idx_0, int *adapter_sdk_interface_fd);

/**
 * implemented by: adapter_context_db_params_adapter_external_events_fd_set
 */
...
/**
 * implemented by: adapter_context_db_params_adapter_external_events_fd_get
 */
typedef int (*adapter_context_db_params_adapter_external_events_fd_get_cb)(
    int unit, uint32 params_idx_0, int *adapter_external_events_fd);

/**
 * implemented by: adapter_context_db_params_adapter_external_events_port_set
 */
...
/**
 * implemented by: adapter_context_db_params_adapter_external_events_port_get
 */
typedef int (*adapter_context_db_params_adapter_external_events_port_get_cb)(
    int unit, uint32 params_idx_0, uint32 *adapter_external_events_port);

/**
 * implemented by: adapter_context_db_params_adapter_server_address_set
 */
...
/**
 * This structure holds the access functions for the variable dnxc_adapter_context_params_t
 */
typedef struct {
    /**
