...
/* SET MAX NUMBER OF MESH_TOPOLOGY BLOCKS*/
#define SOC_DNXC_MAX_NOF_MESH_TOPOLOGY 1
#ifdef BCM_DNXF_SUPPORT
#if SOC_DNXC_MAX_NOF_MESH_TOPOLOGY < DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_MESH_TOPOLOGY
#undef SOC_DNXC_MAX_NOF_MESH_TOPOLOGY
#define SOC_DNXC_MAX_NOF_MESH_TOPOLOGY DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_MESH_TOPOLOGY
#endif
#endif
/* SET MAX NUMBER OF MESH_TOPOLOGY BLOCKS - end */
