...
/**
* implemented by: dnxc_sw_state_calc_pointer
*/
typedef uint8 *(
...
/**
* implemented by: dnxc_sw_state_calc_dpointer
*/
typedef uint8 **(
...
/**
* implemented by: dnxc_sw_state_calc_offset
*/
typedef sal_vaddr_t(
...
/**
* implemented by: dnxc_sw_state_calc_offset_from_dptr
*/
typedef sal_vaddr_t(
...
/**
 * implemented by: dnxc_sw_state_plain_module_size_update
 */
typedef void (
    *dnxc_sw_state_module_size_update_cb) (
    int unit,
    uint32 module_id,
    uint32 size,
    uint32 flags);
...
/**
* implemented by: dnxc_sw_state_plain_module_size_get_cb
*/
typedef uint32 (
    *dnxc_sw_state_module_size_get_cb) (
    int unit,
    uint32 module_id);
...
typedef struct
{
    ...
    dnxc_sw_state_module_size_update_cb module_size_update;
    dnxc_sw_state_module_size_get_cb module_size_get;
