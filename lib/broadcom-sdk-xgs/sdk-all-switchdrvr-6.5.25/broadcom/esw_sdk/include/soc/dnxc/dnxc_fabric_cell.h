 ...
 * {
 */
#define DNXC_VSC512_DESTINATION_ROUTED_CELL_PAYLOAD_SIZE_BYTES        (512)
...
typedef struct soc_dnxc_fabric_route_s
{
    ...
    _shr_fabric_device_type_t dest_device_type; /* dest_device_type */
