...
/**
 * Structure at the root of each hash table, containing the table (lists_head),
...
typedef struct
{
    ...
    SHR_BITDCL *next;
    /**
     * The size of one pointer in bits.
     */
    uint32 ptr_size;
 ...
 *   \param [out] data - Pointer. This procedure loads pointed memory by the 'data' found ...
 *   \param [out] data_indx -
