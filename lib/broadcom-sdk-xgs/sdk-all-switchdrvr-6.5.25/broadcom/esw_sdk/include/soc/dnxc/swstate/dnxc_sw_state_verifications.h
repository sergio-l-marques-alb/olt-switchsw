...
/*
 * The MAX_SIZE_DIFFERENCE define is used as deviation during swstate memory is optimization verify.
 */
#define DNX_SW_STATE_DOUBLE_DYNAMIC_ARRAY_MAX_SIZE_DEVIATION 1000
/*
 * Check if the 2D dynamic arrays are not using more memory than they have to.
 */
