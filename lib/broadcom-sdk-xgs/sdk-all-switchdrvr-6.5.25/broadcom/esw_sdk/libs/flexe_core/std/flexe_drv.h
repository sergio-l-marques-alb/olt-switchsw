 ...
 * [in] unit - unit ID
 * [in] channel - FlexE channel ID
 * [in] global_ts_mask - global timeslot bitmap. Each enabled bit represents a timeslot for 5G.
 *              Maximum 80 bits (400G).
 * [in] global_ts_array - HW global timeslot array. Each enabled bit represents a timeslot for 5G.
 *              Maximum 80 bits (400G).
 * [in] calendar_sel - Which calendar to remove this channel from
...
/**
 * \brief
 *   Set SC bit for a FlexE instance.
 *
 *
 * [in] unit - unit ID
 * [in] instance - FlexE instance ID (0~7)
 * [in] sync_config - sychronization config
 *
 * \return
 *   \retval Non-zero in case of an error
 *   \retval Zero in case of NO ERROR
 ...
 * [in] instance - FlexE instance ID (0~7)
 * [in] flags - 1: RX; 2: TX
 * [out] sync_config - sychronization config
 *
 * \return
 *   \retval Non-zero in case of an error
 *   \retval Zero in case of NO ERROR
...
/**
 * \brief
 *   Set active calendar for a number of FlexE lphys.
 *
 *
 * [in] unit - unit ID
 * [in] lphy_bitmap - bitmap of FlexE lphys to be set
 * [in] cal_id - Calendar ID
 *
 * \return
 *   \retval Non-zero in case of an error
...
/**
 * \brief
 *   Get FlexE group deskew alarms.
 *
 *
 * [in] unit - unit ID
 * [in] group_index - group index
 * [out] alarm - alarm status
 *
 * \return
 *   \retval Non-zero in case of an error
 *   \retval Zero in case of NO ERROR
 ...
 *
 */
shr_error_e soc_flexe_std_oh_deskew_alarm_get(
    int unit,
    int group_index,
    uint8 *alarm);
...
/**
 * \brief
 *   Get OAM RDI insert enable for a FlexE client.
 *
 *
 * [in] unit - unit ID
 * [in] client_channel - FlexE client ID
 ...
 *
 */
shr_error_e soc_flexe_std_oam_rdi_insert_get(
    int unit,
    int client_channel,
    uint32 *enable);
/**
 * \brief
 *   Configure OAM rdi insert for a FlexE client.
 *
 *
 * [in] unit - unit ID
 * [in] client_channel - FlexE client ID
 ...
 *
 */
shr_error_e soc_flexe_std_oam_rdi_insert_set(
    int unit,
    int client_channel,
    uint32 enable);
 ...
 */
shr_error_e soc_flexe_std_1588_rx_dest_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE 1588 Rx dest MAC
 */
shr_error_e soc_flexe_std_1588_rx_dest_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE 1588 Rx source MAC
 */
shr_error_e soc_flexe_std_1588_rx_src_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE 1588 Rx source MAC
 */
shr_error_e soc_flexe_std_1588_rx_src_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE 1588 Tx dest MAC
 */
shr_error_e soc_flexe_std_1588_tx_dest_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE 1588 Tx dest MAC
 */
shr_error_e soc_flexe_std_1588_tx_dest_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE 1588 Tx source MAC
 */
shr_error_e soc_flexe_std_1588_tx_src_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE 1588 Tx source MAC
 */
shr_error_e soc_flexe_std_1588_tx_src_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Enable/disable flexe bas oam to external processor
 */
shr_error_e soc_flexe_std_bas_oam_to_ext_processor_set(
    int unit,
    int enable);
/*
 * \brief - Get flexe bas oam to external processor enable status
 */
shr_error_e soc_flexe_std_bas_oam_to_ext_processor_get(
    int unit,
    int *enable);
/*
 * \brief - Configure FlexE mux logical PHYs
 */
shr_error_e soc_flexe_std_mux_lphy_config_set(
    int unit,
    int flexe_core_port,
    uint8 lphys[FLEXE_CORE_NOF_LPHYS],
    int speed,
 ...
 */
shr_error_e soc_flexe_std_oh_oam_dest_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE OH/OAM dest MAC
 */
shr_error_e soc_flexe_std_oh_oam_dest_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE OH/OAM src MAC
 */
shr_error_e soc_flexe_std_oh_oam_src_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE OH/OAM src MAC
 */
shr_error_e soc_flexe_std_oh_oam_src_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE 1588 over ETH RX unicast DA
 */
shr_error_e soc_flexe_std_1588_over_eth_rx_uni_dest_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE 1588 over ETH RX unicast DA
 */
shr_error_e soc_flexe_std_1588_over_eth_rx_uni_dest_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE 1588 over ETH TX unicast DA
 */
shr_error_e soc_flexe_std_1588_over_eth_tx_uni_dest_mac_set(
    int unit,
    uint64 val);
/*
 * \brief - Get FlexE 1588 over ETH TX unicast DA
 */
shr_error_e soc_flexe_std_1588_over_eth_tx_uni_dest_mac_get(
    int unit,
    uint64 *val);
/*
 * \brief - Set FlexE 1588 over IPv4 Rx unicast DIP
 */
shr_error_e soc_flexe_std_1588_over_ipv4_rx_uni_dip_set(
    int unit,
    uint32 val);
/*
 * \brief - Set FlexE 1588 over IPv4 Tx unicast DIP
 */
shr_error_e soc_flexe_std_1588_over_ipv4_tx_uni_dip_set(
    int unit,
    uint32 val);
/*
 * \brief - Get FlexE 1588 over IPv4 Rx unicast DIP
 */
shr_error_e soc_flexe_std_1588_over_ipv4_rx_uni_dip_get(
    int unit,
    uint32 *val);
/*
 * \brief - Get FlexE 1588 over IPv4 Tx unicast DIP
 */
shr_error_e soc_flexe_std_1588_over_ipv4_tx_uni_dip_get(
    int unit,
    uint32 *val);
 ...
 */
shr_error_e soc_flexe_std_sar_jitter_fifo_level_set(
    int unit,
    int client_channel,
 ...
 * \brief - configure the SAR jitter tolerance level
 */
shr_error_e soc_flexe_std_sar_jitter_fifo_level_get(
    int unit,
    int client_channel,
 ...
 */
shr_error_e soc_flexe_oam_bas_bip_recal_enable_set(
    int unit,
    int val);
/*
 * \brief - Get bas OAM recalculation enable status
 */
shr_error_e soc_flexe_oam_bas_bip_recal_enable_get(
    int unit,
    int *val);
/*
 * \brief - Configure if Bas OAM period mismatch trigger Los ALM.
 */
shr_error_e soc_flexe_oam_bas_period_mismatch_trigger_los_alarm_set(
    int unit,
    int val);
/*
 * \brief - Get if Bas OAM period mismatch trigger Los ALM.
 */
shr_error_e soc_flexe_oam_bas_period_mismatch_trigger_los_alarm_get(
    int unit,
    int *val);
