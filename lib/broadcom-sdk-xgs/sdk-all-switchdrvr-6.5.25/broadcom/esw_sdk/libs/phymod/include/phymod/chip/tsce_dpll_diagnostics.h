...
#ifndef _TSCE_DPLL_DIAGNOSTICS_H__H_
#define _TSCE_DPLL_DIAGNOSTICS_H__H_
...
/*Set\get pattern state*/
int tsce_dpll_phy_pattern_enable_set(const phymod_phy_access_t* phy, uint32_t enable, const phymod_pattern_t* pattern);
...
int tsce_dpll_phy_fec_error_inject_set(const phymod_phy_access_t* phy, uint16_t error_control_map, phymod_fec_error_mask_t bit_error_mask);
int tsce_dpll_phy_fec_error_inject_get(const phymod_phy_access_t* phy, uint16_t* error_control_map, phymod_fec_error_mask_t* bit_error_mask);

#endif /*_TSCE_DPLL_DIAGNOSTICS_H_*/
