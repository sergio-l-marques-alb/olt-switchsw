...
#ifndef _TSCF16_H__H_
#define _TSCF16_H__H_
...
int tscf16_phy_interface_config_get(const phymod_phy_access_t* phy, uint32_t flags, phymod_ref_clk_t ref_clock, phymod_phy_inf_config_t* config);
...
/*Set\Get autoneg*/
int tscf16_phy_autoneg_ability_set(const phymod_phy_access_t* phy, const phymod_autoneg_ability_t* an_ability_set_type);
...
int tscf16_phy_rx_signal_detect_get(const phymod_phy_access_t* phy, uint32_t* rx_signal_detect);
...
int tscf16_phy_sw_an_advert_set(const phymod_phy_access_t* phy, const phymod_autoneg_ability_t* an_ability_set_type, phymod_sw_an_ctxt_t* an_ctxt);
...
int tscf16_phy_synce_clk_ctrl_set(const phymod_phy_access_t* phy, phymod_synce_clk_ctrl_t cfg);
int tscf16_phy_synce_clk_ctrl_get(const phymod_phy_access_t* phy, phymod_synce_clk_ctrl_t* cfg);

/*Get rx ppm*/
int tscf16_phy_rx_ppm_get(const phymod_phy_access_t* phy, int16_t* rx_ppm);

/*Set or get fec bypass indication. Valid for RS-FEC.*/
int tscf16_phy_fec_bypass_indication_set(const phymod_phy_access_t* phy, uint32_t enable);
int tscf16_phy_fec_bypass_indication_get(const phymod_phy_access_t* phy, uint32_t* enable);
