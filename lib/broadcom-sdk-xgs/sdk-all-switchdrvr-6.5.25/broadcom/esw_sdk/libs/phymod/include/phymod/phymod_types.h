...
#define PHYMOD_SYMB_COMPILE_ERROR (1 << 99)
#else
#define PHYMOD_SYMB_COMPILE_ERROR 0
#endif
...
#define __F_ENCODE(v,o,w) \
        ( ((v & __F_MASK(w)) == v) ? /* Value fits in width */ ( (uint32_t)(v) << o ) : /* Value does not fit -- compile time error */ PHYMOD_SYMB_COMPILE_ERROR)
