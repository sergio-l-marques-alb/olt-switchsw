...
typedef int (*__dispatch__phymod_port_pause_addr_set_f)(const phymod_phy_access_t* phy, phymod_pause_addr_t addr);
typedef int (*__dispatch__phymod_port_pause_addr_get_f)(const phymod_phy_access_t* phy, phymod_pause_addr_t* addr);
...
typedef int (*__dispatch__phymod_phy_rx_pmd_lock_status_get_f)(const phymod_phy_access_t* phy, uint32_t* rx_pmd_locked, uint32_t* rx_pmd_lock_change);
...
typedef int (*__dispatch__phymod_timesync_offset_get_f)(const phymod_core_access_t* core, uint32_t* ts_offset);
...
typedef int (*__dispatch__phymod_phy_tx_phase_lock_rx_set_f)(const phymod_phy_access_t* phy, uint8_t enable);
typedef int (*__dispatch__phymod_phy_tx_phase_lock_tx_set_f)(const phymod_phy_access_t* phy, uint8_t enable);
...
typedef int (*__dispatch__phymod_phy_serdes_power_set_f)(const phymod_phy_access_t* phy, phymod_power_option_t power_option, phymod_power_mode_t power_mode);
typedef int (*__dispatch__phymod_phy_an_timer_set_f)(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t period);
typedef int (*__dispatch__phymod_phy_an_timer_get_f)(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t* period);
typedef int (*__dispatch__phymod_phy_flr_config_set_f)(const phymod_phy_access_t* phy, uint32_t enable, phymod_phy_flr_timeout_t timeout_time);
typedef int (*__dispatch__phymod_phy_flr_config_get_f)(const phymod_phy_access_t* phy, uint32_t* enable, phymod_phy_flr_timeout_t* timeout_time);
typedef int (*__dispatch__phymod_phy_fec_degraded_ser_set_f)(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_config_t config);
typedef int (*__dispatch__phymod_phy_fec_degraded_ser_get_f)(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_config_t* config);
typedef int (*__dispatch__phymod_phy_fec_degraded_ser_status_get_f)(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_status_t* status);
typedef int (*__dispatch__phymod_phy_am_loss_align_multi_state_get_f)(const phymod_phy_access_t* phy, uint32_t* am_loss_align_multi_state);
...
typedef struct __phymod__dispatch__s__ {
    ...
    __dispatch__phymod_port_pause_addr_set_f                                         f_phymod_port_pause_addr_set;
    __dispatch__phymod_port_pause_addr_get_f                                         f_phymod_port_pause_addr_get;
    ...
    __dispatch__phymod_phy_rx_pmd_lock_status_get_f                                  f_phymod_phy_rx_pmd_lock_status_get;
    ...
    __dispatch__phymod_timesync_offset_get_f                                         f_phymod_timesync_offset_get;
    ...
    __dispatch__phymod_phy_tx_phase_lock_rx_set_f                                    f_phymod_phy_tx_phase_lock_rx_set;
    __dispatch__phymod_phy_tx_phase_lock_tx_set_f                                    f_phymod_phy_tx_phase_lock_tx_set;
    ...
    __dispatch__phymod_phy_serdes_power_set_f                                        f_phymod_phy_serdes_power_set;
    __dispatch__phymod_phy_an_timer_set_f                                            f_phymod_phy_an_timer_set;
    __dispatch__phymod_phy_an_timer_get_f                                            f_phymod_phy_an_timer_get;
    __dispatch__phymod_phy_flr_config_set_f                                          f_phymod_phy_flr_config_set;
    __dispatch__phymod_phy_flr_config_get_f                                          f_phymod_phy_flr_config_get;
    __dispatch__phymod_phy_fec_degraded_ser_set_f                                    f_phymod_phy_fec_degraded_ser_set;
    __dispatch__phymod_phy_fec_degraded_ser_get_f                                    f_phymod_phy_fec_degraded_ser_get;
    __dispatch__phymod_phy_fec_degraded_ser_status_get_f                             f_phymod_phy_fec_degraded_ser_status_get;
    __dispatch__phymod_phy_am_loss_align_multi_state_get_f                           f_phymod_phy_am_loss_align_multi_state_get;
