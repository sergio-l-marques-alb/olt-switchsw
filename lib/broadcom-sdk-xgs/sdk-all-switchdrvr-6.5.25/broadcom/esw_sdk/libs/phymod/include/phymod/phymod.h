...
typedef enum phymod_dispatch_type_e {
    ...
    phymodDispatchTypeTsco_dpll,
#endif /*PHYMOD_TSCO_DPLL_SUPPORT  */
#ifdef PHYMOD_OSPREY7_V2L8P2_SUPPORT
    phymodDispatchTypeOsprey7_v2l8p2,
#endif /*PHYMOD_OSPREY7_V2L8P2_SUPPORT  */
#ifdef PHYMOD_TSCJ_SUPPORT
    phymodDispatchTypeTscj,
#endif /*PHYMOD_TSCJ_SUPPORT  */
#ifdef PHYMOD_JUPITER_SUPPORT
    phymodDispatchTypeJupiter,
    ...
    phymodDispatchTypeBlackhawk7_l2p2,
...
typedef enum phymod_mem_type_e {
    ...
    phymodMemTxLkup1588100G_KR1_2XN,
    phymodMemCount
} phymod_mem_type_t;
...
#define PHYMOD_ACC_F_4_LANE_PORT 0x40 /**< in 4-lane port */
#define PHYMOD_ACC_F_8_LANE_PORT 0x80 /**< in 8-lane port */
...
#define PHYMOD_ACC_F_4_LANE_PORT_SET(access) ((access)->flags |= PHYMOD_ACC_F_4_LANE_PORT)
#define PHYMOD_ACC_F_8_LANE_PORT_SET(access) ((access)->flags |= PHYMOD_ACC_F_8_LANE_PORT)
...
#define PHYMOD_ACC_F_4_LANE_PORT_CLR(access) ((access)->flags &= ~PHYMOD_ACC_F_4_LANE_PORT)
#define PHYMOD_ACC_F_8_LANE_PORT_CLR(access) ((access)->flags &= ~PHYMOD_ACC_F_8_LANE_PORT)
...
#define PHYMOD_ACC_F_4_LANE_PORT_GET(access) ((access)->flags & PHYMOD_ACC_F_4_LANE_PORT ? 1 : 0)
#define PHYMOD_ACC_F_8_LANE_PORT_GET(access) ((access)->flags & PHYMOD_ACC_F_8_LANE_PORT ? 1 : 0)
...
/*! 
 * @brief specify device operation modes 
 */ 
#define PHYMOD_DEVICE_OP_MODE_PCS_BYPASS 0x10000 /**< to set or clear pcs by pass mode */
#define PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT 0x20000 /**< to set or clear flexible pll selection mode */

#define PHYMOD_DEVICE_OP_MODE_PCS_BYPASS_SET(op_mode) (op_mode |= PHYMOD_DEVICE_OP_MODE_PCS_BYPASS)
#define PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT_SET(op_mode) (op_mode |= PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT)

#define PHYMOD_DEVICE_OP_MODE_PCS_BYPASS_CLR(op_mode) (op_mode &= ~PHYMOD_DEVICE_OP_MODE_PCS_BYPASS)
#define PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT_CLR(op_mode) (op_mode &= ~PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT)

#define PHYMOD_DEVICE_OP_MODE_PCS_BYPASS_GET(op_mode) (op_mode & PHYMOD_DEVICE_OP_MODE_PCS_BYPASS ? 1 : 0)
#define PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT_GET(op_mode) (op_mode & PHYMOD_DEVICE_OP_MODE_FLEXIBLE_PLL_SELECT ? 1 : 0)
...
typedef enum phymod_core_version_e {
    ...
    phymodCoreVersionTsco,
    phymodCoreVersionOsprey7_v2l8p1,
    phymodCoreVersionBlackhawk7_l8p2,
    phymodCoreVersionTsco_dpll,
    phymodCoreVersionOsprey7_v2l8p2,
    phymodCoreVersionTscj,
    phymodCoreVersionJupiter,
    phymodCoreVersionTscbhFeGen2,
    phymodCoreVersionBlackhawk7_l2p2,
...
typedef struct phymod_pause_addr_s {
    uint8_t mac[6];
} phymod_pause_addr_t;

/* phymod_pause_addr_t initialization and validation */
int phymod_pause_addr_t_validate(const phymod_pause_addr_t* phymod_pause_addr);
int phymod_pause_addr_t_init(phymod_pause_addr_t* phymod_pause_addr);
...
/*! 
 * phymod_port_pause_addr_set
 *
 * @brief Set port pause address 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  addr            - 
 */
int phymod_port_pause_addr_set(const phymod_phy_access_t* phy, phymod_pause_addr_t addr);
/*! 
 * phymod_port_pause_addr_get
 *
 * @brief Set port pause address 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  addr            - 
 */
int phymod_port_pause_addr_get(const phymod_phy_access_t* phy, phymod_pause_addr_t* addr);
...
#define PHYMOD_CORE_INIT_F_EXECUTE_PASS3 0x10000 /**< core init state pass3 */
#define PHYMOD_CORE_INIT_F_FLR_SUPPORT 0x20000 /**< download the flr support image */
...
#define PHYMOD_CORE_INIT_F_EXECUTE_PASS3_SET(conf) ((conf)->flags |= PHYMOD_CORE_INIT_F_EXECUTE_PASS3)
#define PHYMOD_CORE_INIT_F_FLR_SUPPORT_SET(conf) ((conf)->flags |= PHYMOD_CORE_INIT_F_FLR_SUPPORT)
...
#define PHYMOD_CORE_INIT_F_EXECUTE_PASS3_CLR(conf) ((conf)->flags &= ~PHYMOD_CORE_INIT_F_EXECUTE_PASS3)
#define PHYMOD_CORE_INIT_F_FLR_SUPPORT_CLR(conf) ((conf)->flags &= ~PHYMOD_CORE_INIT_F_FLR_SUPPORT)
...
#define PHYMOD_CORE_INIT_F_EXECUTE_PASS3_GET(conf) ((conf)->flags & PHYMOD_CORE_INIT_F_EXECUTE_PASS3 ? 1 : 0)
#define PHYMOD_CORE_INIT_F_FLR_SUPPORT_GET(conf) ((conf)->flags & PHYMOD_CORE_INIT_F_FLR_SUPPORT ? 1 : 0)
 ...
 *
 * @brief Get rx pmd locked indication. This API will clear the pmd_lock_change indication. 
 *
 * @param [in]  phy             - phy access information
...
/*! 
 * phymod_phy_rx_pmd_lock_status_get
 *
 * @brief Get Lane Bit Map of rx pmd lock and pmd lock change indication.  
 *
 * @param [in]  phy             - phy access information
 * @param [out]  rx_pmd_locked   - lane bmap of rx pmd locked indications
 * @param [out]  rx_pmd_lock_change   - lane bmap of rx pmd locked chanage indications
 */
int phymod_phy_rx_pmd_lock_status_get(const phymod_phy_access_t* phy, uint32_t* rx_pmd_locked, uint32_t* rx_pmd_lock_change);
 ...
 */ 
#define PHYMOD_TIMESYNC_F_SOP 0x1 /**< Enable SOP timestamp mode, ignore MAC_DA bit. If disable, check MAC_DA mode bit. */
#define PHYMOD_TIMESYNC_F_REDUCED_PREAMBLE_MODE 0x2 /**< Port is in reduced preamble mode. */
#define PHYMOD_TIMESYNC_F_MAC_DA 0x4 /**< Enable MAC_DA timestamp mode. Disabled, SFD timestamp mode will be used. */
...
#define PHYMOD_TIMESYNC_F_MAC_DA_SET(flags) (flags |= PHYMOD_TIMESYNC_F_MAC_DA)
...
#define PHYMOD_TIMESYNC_F_MAC_DA_CLR(flags) (flags &= ~PHYMOD_TIMESYNC_F_MAC_DA)
...
#define PHYMOD_TIMESYNC_F_MAC_DA_GET(flags) (flags & PHYMOD_TIMESYNC_F_MAC_DA ? 1 : 0)
...
typedef enum phymod_fec_type_e {
    ...
    phymod_fec_RS276, /**< RS276, using 1xN RS FEC architecture */
    phymod_fec_RS552, /**< RS552, using 1xN RS FEC architecture */
    phymod_fec_Count
} phymod_fec_type_t;
...
/*!
 * @enum phymod_an_timer_e
 * @brief  cl73 an timer  
 */ 
typedef enum phymod_an_timer_e {
    phymodAnTimerNone = 0,
    phymodAnTimerLinkFailInhibitLtPam4,
    phymodAnTimerCount
} phymod_an_timer_t;

#ifdef PHYMOD_DIAG
extern enum_mapping_t phymod_an_timer_t_mapping[];
#endif /*PHYMOD_DIAG*/

/* phymod_an_timer_t validation */
int phymod_an_timer_t_validate(phymod_an_timer_t phymod_an_timer);
/*! 
 * phymod_phy_an_timer_set
 *
 * @brief  set or get the an timer 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  timer_type      - 
 * @param [in]  period          - time period
 */
int phymod_phy_an_timer_set(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t period);
/*! 
 * phymod_phy_an_timer_get
 *
 * @brief  set or get the an timer 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  timer_type      - 
 * @param [out]  period          - time period
 */
int phymod_phy_an_timer_get(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t* period);


/*!
 * @enum phymod_phy_flr_timeout_e
 * @brief flr timeout time 
 */ 
typedef enum phymod_phy_flr_timeout_e {
    phymodFlrTimeoutInvaild = 0, /**< timeout time Invaild */
    phymodFlrTimeout50ms, /**< timeout time 50ms */
    phymodFlrTimeout75ms, /**< timeout time 75ms */
    phymodFlrTimeout100ms, /**< timeout time 100ms */
    phymodFlrTimeout150ms, /**< timeout time 150ms */
    phymodFlrTimeout250ms, /**< timeout time 250ms */
    phymodFlrTimeout500ms, /**< timeout time 500ms */
    phymodFlrTimeoutCount
} phymod_phy_flr_timeout_t;

#ifdef PHYMOD_DIAG
extern enum_mapping_t phymod_phy_flr_timeout_t_mapping[];
#endif /*PHYMOD_DIAG*/

/* phymod_phy_flr_timeout_t validation */
int phymod_phy_flr_timeout_t_validate(phymod_phy_flr_timeout_t phymod_phy_flr_timeout);
/*! 
 * phymod_phy_flr_config_set
 *
 * @brief set/get fast link recovery 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  enable          - 
 * @param [in]  timeout_time    - 
 */
int phymod_phy_flr_config_set(const phymod_phy_access_t* phy, uint32_t enable, phymod_phy_flr_timeout_t timeout_time);
/*! 
 * phymod_phy_flr_config_get
 *
 * @brief set/get fast link recovery 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  enable          - 
 * @param [out]  timeout_time    - 
 */
int phymod_phy_flr_config_get(const phymod_phy_access_t* phy, uint32_t* enable, phymod_phy_flr_timeout_t* timeout_time);


/*!
 * @struct phymod_fec_degraded_ser_config_s
 * @brief FEC Degraded SER Configurations 
 */ 
typedef struct phymod_fec_degraded_ser_config_s {
    uint8_t enable; /**< FEC degrade function enable/disable */
    uint32_t activate_threshold; /**< activate threshold: upper[31:16], lower[15:0] */
    uint32_t deactivate_threshold; /**< deactivate threshold: upper[31:16], lower[15:0] */
    uint32_t interval; /**< interval: upper[31:16], lower[15:0] */
} phymod_fec_degraded_ser_config_t;

/* phymod_fec_degraded_ser_config_t initialization and validation */
int phymod_fec_degraded_ser_config_t_validate(const phymod_fec_degraded_ser_config_t* phymod_fec_degraded_ser_config);
int phymod_fec_degraded_ser_config_t_init(phymod_fec_degraded_ser_config_t* phymod_fec_degraded_ser_config);
 ...
 * @param [in]  config          - 
 */
int phymod_phy_fec_degraded_ser_set(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_config_t config);
/*! 
 ...
 * @param [out]  config          - 
 */
int phymod_phy_fec_degraded_ser_get(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_config_t* config);


/*!
 * @struct phymod_fec_degraded_ser_status_s
 * @brief FEC Degraded SER Status 
 */ 
typedef struct phymod_fec_degraded_ser_status_s {
    uint8_t fec_degraded_ser; /**< FEC Degraded SER */
    uint8_t rx_local_degraded; /**< Local degraded SER received */
    uint8_t rx_remote_degraded; /**< Remote degraded SER received */
    uint8_t rx_am_status_field; /**< Alignment marker status field */
} phymod_fec_degraded_ser_status_t;

/* phymod_fec_degraded_ser_status_t initialization and validation */
int phymod_fec_degraded_ser_status_t_validate(const phymod_fec_degraded_ser_status_t* phymod_fec_degraded_ser_status);
int phymod_fec_degraded_ser_status_t_init(phymod_fec_degraded_ser_status_t* phymod_fec_degraded_ser_status);
 ...
 * @param [out]  status          - 
 */
int phymod_phy_fec_degraded_ser_status_get(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_status_t* status);

/*! 
 * phymod_phy_am_loss_align_multi_state_get
 *
 * @brief  Get am loss of alignment state 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  am_loss_align_multi_state   - AM loss alignment multi register state
 */
int phymod_phy_am_loss_align_multi_state_get(const phymod_phy_access_t* phy, uint32_t* am_loss_align_multi_state);
