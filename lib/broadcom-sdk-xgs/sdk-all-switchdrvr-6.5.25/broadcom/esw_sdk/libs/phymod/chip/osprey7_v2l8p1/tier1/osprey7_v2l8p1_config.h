...
if ((OSPREY7_V2L8P1_REVID_MODEL_DEFAULT != revid || OSPREY7_V2L8P1_REVID2_DEFAULT != revid2) || \
    (OSPREY7_V2L8P1_AFE_IPVERSION_ID_DEFAULT_A0 != ipversion  && OSPREY7_V2L8P1_AFE_IPVERSION_ID_DEFAULT_C0 != ipversion && OSPREY7_V2L8P1_AFE_IPVERSION_ID_DEFAULT_C1 != ipversion)) { \
    EFUN_PRINTF(("ERROR: IP Hardware ID Mismatch. Expected: 0x%08X (A0), 0x%08X (C0), or 0x%08X (C1). Actual: 0x%08X.\n",               \
