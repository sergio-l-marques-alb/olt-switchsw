...
int tscj_phy_fec_cl91_correctable_counter_get(const phymod_phy_access_t* phy, uint32_t* count)
{
...
int tscj_phy_fec_cl91_uncorrectable_counter_get(const phymod_phy_access_t* phy, uint32_t* count)
{
    phymod_phy_access_t phy_copy;
...
int tscj_phy_rsfec_symbol_error_counter_get(const phymod_phy_access_t* phy,
                                             int max_count,
                                             int* actual_count,
...
int tscj_phy_fec_error_inject_set(const phymod_phy_access_t* phy,
                                  ...
                                  phymod_fec_error_mask_t bit_error_mask)
{
    ...
    PHYMOD_IF_ERR_RETURN(tsco_phy_speed_config_get(phy, &speed_config));
...
int tscj_phy_fec_error_inject_get(const phymod_phy_access_t* phy,
                                  uint16_t* error_control_map,
                                  phymod_fec_error_mask_t* bit_error_mask)
{
    uint16_t control_map = 0;
