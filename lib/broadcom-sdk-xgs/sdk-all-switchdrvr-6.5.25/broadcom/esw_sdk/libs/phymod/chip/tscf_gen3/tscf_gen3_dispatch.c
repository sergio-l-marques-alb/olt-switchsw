...
__phymod__dispatch__t__ phymod_tscf_gen3_driver = {

    tscf_gen3_core_identify,
    tscf_gen3_core_info_get,
    tscf_gen3_core_lane_map_set,
    tscf_gen3_core_lane_map_get,
    tscf_gen3_core_reset_set,
    tscf_gen3_core_reset_get,
    tscf_gen3_core_firmware_info_get,
    tscf_gen3_phy_firmware_core_config_set,
    tscf_gen3_phy_firmware_core_config_get,
    tscf_gen3_phy_firmware_lane_config_set,
    tscf_gen3_phy_firmware_lane_config_get,
    tscf_gen3_core_pll_sequencer_restart,
    tscf_gen3_core_wait_event,
    tscf_gen3_phy_rx_restart,
    tscf_gen3_phy_polarity_set,
    tscf_gen3_phy_polarity_get,
    tscf_gen3_phy_tx_set,
    tscf_gen3_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    falcon_dpll_phy_media_type_tx_get,
    tscf_gen3_phy_tx_override_set,
    tscf_gen3_phy_tx_override_get,
    tscf_gen3_phy_txpi_config_set,
    tscf_gen3_phy_txpi_config_get,
    tscf_gen3_phy_rx_set,
    tscf_gen3_phy_rx_get,
    tscf_gen3_phy_rx_adaptation_resume,
    tscf_gen3_phy_reset_set,
    tscf_gen3_phy_reset_get,
    tscf_gen3_phy_power_set,
    tscf_gen3_phy_power_get,
    tscf_gen3_phy_hg2_codec_control_set,
    tscf_gen3_phy_hg2_codec_control_get,
    tscf_gen3_phy_tx_lane_control_set,
    tscf_gen3_phy_tx_lane_control_get,
    tscf_gen3_phy_rx_lane_control_set,
    tscf_gen3_phy_rx_lane_control_get,
    tscf_gen3_phy_fec_enable_set,
    tscf_gen3_phy_fec_enable_get,
    ...
    NULL, /* phymod_port_pause_addr_set */
    NULL, /* phymod_port_pause_addr_get */
    ...
    tscf_gen3_phy_autoneg_oui_set,
    tscf_gen3_phy_autoneg_oui_get,
    tscf_gen3_phy_eee_set,
    tscf_gen3_phy_eee_get,
    tscf_gen3_phy_interface_config_set,
    tscf_gen3_phy_interface_config_get,
    tscf_gen3_phy_cl72_set,
    tscf_gen3_phy_cl72_get,
    tscf_gen3_phy_cl72_status_get,
    tscf_gen3_phy_autoneg_ability_set,
    tscf_gen3_phy_autoneg_ability_get,
    tscf_gen3_phy_autoneg_remote_ability_get,
    tscf_gen3_phy_autoneg_set,
    tscf_gen3_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    tscf_gen3_phy_autoneg_status_get,
    tscf_gen3_core_init,
    tscf_gen3_phy_pll_multiplier_get,
    tscf_gen3_phy_init,
    tscf_gen3_phy_loopback_set,
    tscf_gen3_phy_loopback_get,
    tscf_gen3_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_pmd_lock_status_get */
    NULL, /* phymod_phy_local_fault_info_get */
    tscf_gen3_phy_rx_signal_detect_get,
    tscf_gen3_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    tscf_gen3_phy_pcs_userspeed_set,
    tscf_gen3_phy_pcs_userspeed_get,
    tscf_gen3_phy_reg_read,
    tscf_gen3_phy_reg_write,
    ...
    tscf_gen3_timesync_enable_set,
    tscf_gen3_timesync_enable_get,
    ...
    tscf_gen3_timesync_offset_set,
    tscf_gen3_timesync_offset_get,
    tscf_gen3_timesync_adjust_set,
    ...
    tscf_gen3_phy_eye_margin_est_get,
    NULL, /* phymod_phy_multi_get */
    tscf_gen3_phy_rescal_set,
    tscf_gen3_phy_rescal_get,
    ...
    NULL, /* phymod_phy_tx_phase_lock_tx_set */
    ...
    tscf_gen3_phy_fec_bypass_indication_set,
    tscf_gen3_phy_fec_bypass_indication_get,
    ...
    tscf_gen3_phy_osr_mode_get,
    tscf_gen3_phy_ref_clk_get,
    ...
    NULL, /* phymod_phy_an_timer_set */
    NULL, /* phymod_phy_an_timer_get */
    NULL, /* phymod_phy_flr_config_set */
    NULL, /* phymod_phy_flr_config_get */
    NULL, /* phymod_phy_fec_degraded_ser_set */
    NULL, /* phymod_phy_fec_degraded_ser_get */
    NULL, /* phymod_phy_fec_degraded_ser_status_get */
    NULL, /* phymod_phy_am_loss_align_multi_state_get */
};
