...
__phymod_diagnostics__dispatch__t__ phymod_diagnostics_tsce7_diagnostics_driver = {

    NULL, /* phymod_phy_rx_slicer_position_set */
    NULL, /* phymod_phy_rx_slicer_position_get */
    NULL, /* phymod_phy_rx_slicer_position_max_get */
    merlin7_phy_prbs_config_set,
    merlin7_phy_prbs_config_get,
    merlin7_phy_prbs_enable_set,
    merlin7_phy_prbs_enable_get,
    merlin7_phy_prbs_status_get,
    ...
    tsce7_phy_pmd_info_dump,
    tsce16_phy_pcs_info_dump,
    tsce7_phy_eyescan_run,
