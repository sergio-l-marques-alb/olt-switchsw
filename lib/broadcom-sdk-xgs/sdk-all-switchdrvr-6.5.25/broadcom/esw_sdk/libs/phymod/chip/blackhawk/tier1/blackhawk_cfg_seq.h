...
err_code_t blackhawk_lane_tx_pll_selection_set(phymod_access_t *sa__, uint32_t pll_index);
err_code_t blackhawk_lane_rx_pll_selection_set(phymod_access_t *sa__, uint32_t pll_index);
