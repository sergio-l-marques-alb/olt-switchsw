...
/** osprey7_v2l8p2_collect_custom_fields_osprey7_v2l8p2_detailed_lane_status_st
 ...
 */
err_code_t osprey7_v2l8p2_collect_custom_fields_osprey7_v2l8p2_detailed_lane_status_st(srds_access_t *sa__, osprey7_v2l8p2_detailed_lane_status_st_t *st);

#include "osprey7_v2l8p2_lane_state.h"

/** osprey7_v2l8p2_collect_custom_fields_osprey7_v2l8p2_lane_state_st
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] st struct pointer which will have its custom fields updated
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_collect_custom_fields_osprey7_v2l8p2_lane_state_st(srds_access_t *sa__, osprey7_v2l8p2_lane_state_st_t *st);
