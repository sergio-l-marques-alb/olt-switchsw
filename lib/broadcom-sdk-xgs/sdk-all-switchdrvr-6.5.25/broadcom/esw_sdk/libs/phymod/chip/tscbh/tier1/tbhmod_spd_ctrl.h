 ...
 *               and UM Table access.
 *----------------------------------------------------------------------------*/
#ifndef _TBHMOD_SPD_CTRL_H_
#define _TBHMOD_SPD_CTRL_H_ 
...
/* Function Prototypes */
extern void                 spd_ctrl_unpack_spd_id_tbl_entry(uint32_t *packed_entry, spd_id_tbl_entry_t *entry);
extern void                 spd_ctrl_pack_spd_id_tbl_entry(spd_id_tbl_entry_t *entry, uint32_t *packed_entry);

extern void                 spd_ctrl_unpack_am_tbl_entry(uint32_t *packed_entry, am_tbl_entry_t *entry);
extern void                 spd_ctrl_pack_am_tbl_entry(am_tbl_entry_t *entry, uint32_t *packed_entry);

extern void                 spd_ctrl_unpack_um_tbl_entry(uint32_t *packed_entry, um_tbl_entry_t *entry);
extern void                 spd_ctrl_pack_um_tbl_entry(um_tbl_entry_t *entry, uint32_t *packed_entry);
