...
__phymod__dispatch__t__ phymod_tscbh_gen3_driver = {

    tscbh_gen3_core_identify,
    tscbh_gen3_core_info_get,
    tscbh_gen3_core_lane_map_set,
    tscbh_gen3_core_lane_map_get,
    ...
    tscbh_gen3_phy_firmware_lane_config_set,
    tscbh_gen3_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    tscbh_gen3_phy_polarity_set,
    tscbh_gen3_phy_polarity_get,
    tscbh_gen3_phy_tx_set,
    tscbh_gen3_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    tscbh_gen3_phy_media_type_tx_get,
    blackhawk7_v1l8p1_phy_tx_override_set,
    blackhawk7_v1l8p1_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    blackhawk7_v1l8p1_phy_rx_set,
    blackhawk7_v1l8p1_phy_rx_get,
    ...
    tscbh_gen3_phy_tx_lane_control_set,
    tscbh_gen3_phy_tx_lane_control_get,
    tscbh_gen3_phy_rx_lane_control_set,
    tscbh_gen3_phy_rx_lane_control_get,
    NULL, /* phymod_phy_fec_enable_set */
    NULL, /* phymod_phy_fec_enable_get */
    tscbh_gen3_phy_fec_override_set,
    tscbh_gen3_phy_fec_override_get,
    ...
    tscbh_gen3_phy_cl72_set,
    tscbh_gen3_phy_cl72_get,
    tscbh_gen3_phy_cl72_status_get,
    NULL, /* phymod_phy_autoneg_ability_set */
    NULL, /* phymod_phy_autoneg_ability_get */
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    tscbh_gen3_phy_autoneg_set,
    tscbh_gen3_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    tscbh_gen3_phy_autoneg_status_get,
    tscbh_gen3_core_init,
    tscbh_gen3_phy_pll_multiplier_get,
    tscbh_gen3_phy_init,
    tscbh_gen3_phy_loopback_set,
    tscbh_gen3_phy_loopback_get,
    tscbh_gen3_phy_rx_pmd_locked_get,
    blackhawk7_v1l8p1_phy_rx_pmd_lock_status_get,
    NULL, /* phymod_phy_local_fault_info_get */
    tscbh_gen3_phy_rx_signal_detect_get,
    tscbh_gen3_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    tscbh_gen3_phy_reg_read,
    tscbh_gen3_phy_reg_write,
    ...
    tscbh_gen3_timesync_enable_set,
    tscbh_gen3_timesync_enable_get,
    ...
    tscbh_timesync_offset_get,
    tscbh_gen3_timesync_adjust_set,
    ...
    tscbh_gen3_port_enable_set,
    tscbh_gen3_port_enable_get,
    ...
    tscbh_gen3_phy_speed_config_set,
    tscbh_gen3_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    tscbh_gen3_phy_tx_taps_default_get,
    tscbh_gen3_phy_lane_config_default_get,
    tscbh_gen3_phy_firmware_load_info_get,
    tscbh_gen3_phy_autoneg_advert_ability_set,
    tscbh_gen3_phy_autoneg_advert_ability_get,
    tscbh_gen3_phy_autoneg_remote_advert_ability_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    tscbh_gen3_phy_tx_pam4_precoder_enable_set,
    tscbh_gen3_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_rx_set */
    NULL, /* phymod_phy_tx_phase_lock_tx_set */
    tscbh_gen3_phy_pll_reconfig,
    NULL, /* phymod_phy_pll_pwrdn */
    NULL, /* phymod_phy_linkdown_transmit_set */
    NULL, /* phymod_phy_linkdown_transmit_get */
    tscbh_gen3_phy_synce_clk_ctrl_set,
    tscbh_gen3_phy_synce_clk_ctrl_get,
    tscbh_gen3_phy_pcs_enable_set,
    tscbh_gen3_phy_rx_ppm_get,
    NULL, /* phymod_phy_channel_loss_hint_set */
    NULL, /* phymod_phy_channel_loss_hint_get */
    tscbh_gen3_intr_handler,
    tscbh_gen3_timesync_tx_info_get,
    NULL, /* phymod_phy_master_set */
    NULL, /* phymod_phy_master_get */
    tscbh_gen3_phy_pcs_lane_swap_adjust,
    tscbh_gen3_phy_load_speed_id_entry,
    tscbh_gen3_phy_pmd_override_enable_set,
    NULL, /* phymod_phy_duplex_set */
    NULL, /* phymod_phy_duplex_get */
    NULL, /* phymod_phy_pmd_info_init */
    tscbh_gen3_phy_pll_powerdown_get,
    NULL, /* phymod_phy_pmd_info_size_get */
    tscbh_gen3_phy_fec_bypass_indication_set,
    tscbh_gen3_phy_fec_bypass_indication_get,
    NULL, /* phymod_phy_fec_corruption_period_set */
    NULL, /* phymod_phy_fec_corruption_period_get */
    tscbh_gen3_phy_codec_mode_set,
    tscbh_gen3_phy_codec_mode_get,
    tscbh_gen3_phy_autoneg_speed_id_table_reload,
    tscbh_gen3_phy_rs_fec_rxp_get,
    NULL, /* phymod_phy_pcs_tx_fsm_check */
    NULL, /* phymod_phy_pcs_reset */
    NULL, /* phymod_phy_osr_mode_get */
    NULL, /* phymod_phy_ref_clk_get */
    tscbh_gen3_phy_interrupt_enable_set,
    tscbh_gen3_phy_interrupt_enable_get,
    ...
    tscbh_gen3_phy_serdes_power_set,
    tscbh_gen3_phy_an_timer_set,
    tscbh_gen3_phy_an_timer_get,
