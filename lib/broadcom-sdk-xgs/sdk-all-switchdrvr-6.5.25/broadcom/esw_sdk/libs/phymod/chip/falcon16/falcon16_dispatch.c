...
__phymod__dispatch__t__ phymod_falcon16_driver = {

    falcon16_core_identify,
    falcon16_core_info_get,
    falcon16_core_lane_map_set,
    falcon16_core_lane_map_get,
    falcon16_core_reset_set,
    falcon16_core_reset_get,
    falcon16_core_firmware_info_get,
    falcon16_phy_firmware_core_config_set,
    falcon16_phy_firmware_core_config_get,
    falcon16_phy_firmware_lane_config_set,
    falcon16_phy_firmware_lane_config_get,
    falcon16_core_pll_sequencer_restart,
    falcon16_core_wait_event,
    falcon16_phy_rx_restart,
    falcon16_phy_polarity_set,
    falcon16_phy_polarity_get,
    falcon16_phy_tx_set,
    falcon16_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    falcon16_phy_media_type_tx_get,
    falcon16_phy_tx_override_set,
    falcon16_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    falcon16_phy_rx_set,
    falcon16_phy_rx_get,
    NULL, /* phymod_phy_rx_adaptation_resume */
    falcon16_phy_reset_set,
    falcon16_phy_reset_get,
    falcon16_phy_power_set,
    falcon16_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    falcon16_phy_tx_lane_control_set,
    falcon16_phy_tx_lane_control_get,
    falcon16_phy_rx_lane_control_set,
    falcon16_phy_rx_lane_control_get,
    ...
    falcon16_phy_interface_config_set,
    falcon16_phy_interface_config_get,
    falcon16_phy_cl72_set,
    falcon16_phy_cl72_get,
    falcon16_phy_cl72_status_get,
    falcon16_phy_autoneg_ability_set,
    falcon16_phy_autoneg_ability_get,
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    falcon16_phy_autoneg_set,
    falcon16_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    falcon16_phy_autoneg_status_get,
    falcon16_core_init,
    NULL, /* phymod_phy_pll_multiplier_get */
    falcon16_phy_init,
    falcon16_phy_loopback_set,
    falcon16_phy_loopback_get,
    falcon16_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_pmd_lock_status_get */
    NULL, /* phymod_phy_local_fault_info_get */
    falcon16_phy_rx_signal_detect_get,
    falcon16_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    falcon16_phy_reg_read,
    falcon16_phy_reg_write,
