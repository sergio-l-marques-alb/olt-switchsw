 ...
 *----------------------------------------------------------------------
 *  Description: define enumerators and qmod16_st
 *----------------------------------------------------------------------*/

#ifndef _qmod16_DEFINES_H_
#define _qmod16_DEFINES_H_
...
typedef struct {
  ...
  qmod16_lane_select   lane_select; 
  ...
  /*! see doc. on qmod16_spd_intfc_type */
  qmod16_spd_intfc_type spd_intf; 
  /*! Serial Bus protocol or PCB */
  qmod16_regacc_type     regacc_type; 
  /*! combo or independent */
  qmod16_port_type     port_type; 
...
/* function table */
typedef int (*tier1FuncTable)(qmod16_st* c);

#endif  /*  _qmod16_DEFINES_H_ */
