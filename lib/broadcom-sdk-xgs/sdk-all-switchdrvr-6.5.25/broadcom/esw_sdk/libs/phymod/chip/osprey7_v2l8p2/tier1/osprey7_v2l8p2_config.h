...
#ifndef OSPREY7_V2L8P2_API_CONFIG_H
#define OSPREY7_V2L8P2_API_CONFIG_H
...
if (!(((OSPREY7_V2L8P2_REVID_MODEL_DEFAULT == revid) && (OSPREY7_V2L8P2_REVID2_DEFAULT == revid2) && ((OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_A0 == ipversion) || (OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_B0 == ipversion))) || \
      ((OSPREY7_V2L8P2_REVID_MODEL_DEFAULT == revid) && ((OSPREY7_V2L8P2_REVID2_DEFAULT == revid2) || (OSPREY7_V2L8P2_REVID2_DEFAULT_C1_2 == revid2)) && (OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_C1 == ipversion)))) { \
    EFUN_PRINTF(("ERROR: IP Hardware ID Mismatch. Expected: 0x%08X (A0), 0x%08X (B0), 0x%08X (C1), or 0x%08X (C1_2). Actual: 0x%08X.\n",               \
                (uint32_t)((OSPREY7_V2L8P2_REVID_MODEL_DEFAULT << 16) | (OSPREY7_V2L8P2_REVID2_DEFAULT << 8) | (OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_A0)),              \
                (uint32_t)((OSPREY7_V2L8P2_REVID_MODEL_DEFAULT << 16) | (OSPREY7_V2L8P2_REVID2_DEFAULT << 8) | (OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_B0)),              \
                (uint32_t)((OSPREY7_V2L8P2_REVID_MODEL_DEFAULT << 16) | (OSPREY7_V2L8P2_REVID2_DEFAULT << 8) | (OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_C1)),              \
                (uint32_t)((OSPREY7_V2L8P2_REVID_MODEL_DEFAULT << 16) | (OSPREY7_V2L8P2_REVID2_DEFAULT_C1_2 << 8) | (OSPREY7_V2L8P2_AFE_IPVERSION_ID_DEFAULT_C1)),         \
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t osprey7_v2l8p2_get_uc_core_config(srds_access_t *sa__, struct osprey7_v2l8p2_uc_core_config_st *struct_val);
/*------------------------------------------------*/
 ...
 * Note: osprey7_v2l8p2_ucode_load_init() must be called before the first call to osprey7_v2l8p2_ucode_load_write(),
 * and osprey7_v2l8p2_ucode_load_close() must be called after the last call to osprey7_v2l8p2_ucode_load_write().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Ends Microcode loading state. Call after the last osprey7_v2l8p2_ucode_load_write().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] pram indicates if the microcode is loaded through the PRAM interface (1 = yes; 0 = no )
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: Micro should be loaded only after issuing a osprey7_v2l8p2_uc_reset(1) followed by asserting and de-asserting
 * core_s_reset. Information table should be intialized with osprey7_v2l8p2_init_osprey7_v2l8p2_info after microcode load.
 ...
 * NOTE: Information table should be intialized with osprey7_v2l8p2_init_osprey7_v2l8p2_info after microcode load.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Dummy function to maintain compatibility with BHK7 APIs [calls osprey7_v2l8p2_uc_reset(..) internally].
 ...
 * Issues osprey7_v2l8p2_uc_reset followed by osprey7_v2l8p2 core reset (core_s_rstb) after selecting com_clk as micro_clk.
...
/** Initialize the osprey7_v2l8p2_info for the uC.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    ...
    EFUN(osprey7_v2l8p2_map_lanes(sa__, 2, tx_lane_map, rx_lane_map));
 * @endcode
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
#define osprey7_v2l8p2_configure_pll_refclk_div_vco osprey7_v2l8p2_INTERNAL_configure_pll

#ifndef SMALL_FOOTPRINT
/** PLL Powerdown.
 *
 * Powers down the selected PLL. To power up the PLL, reconfigure the PLL by using
 * one of the "osprey7_v2l8p2_configure_pll_" APIs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    EFUN(osprey7_v2l8p2_core_dp_reset(sa__, 1));
    EFUN(osprey7_v2l8p2_configure_pll_refclk_div(sa__, OSPREY7_V2L8P2_PLL_REFCLK_156P25MHZ, OSPREY7_V2L8P2_PLL_DIV_170));
 ...
 * @code
    EFUN(osprey7_v2l8p2_core_dp_reset(sa__, 1));
    EFUN(osprey7_v2l8p2_configure_pll_refclk_vco(sa__, OSPREY7_V2L8P2_PLL_REFCLK_156P25MHZ, 25000000));
    EFUN(osprey7_v2l8p2_core_dp_reset(sa__, 0));
 * @endcode
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    EFUN(osprey7_v2l8p2_core_dp_reset(sa__, 1));
    EFUN(osprey7_v2l8p2_configure_pll_refclk_vco(sa__, OSPREY7_V2L8P2_PLL_DIV_170, 25000000));
    EFUN(osprey7_v2l8p2_core_dp_reset(sa__, 0));
 * @endcode
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * Note: This API should be used only during configuration under dp_reset (osprey7_v2l8p2_ln_dp_reset()).
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] mode An enable/disable option from the enum osprey7_v2l8p2_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * Note: This API should be used only during configuration under dp reset (osprey7_v2l8p2_ln_dp_reset()).
 *       When enabling one mode, this API will disable the other mode.
 * Note: ER-CDR Mode does not apply to 7nm Serdes cores
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] mode An enable/disable option from the enum osprey7_v2l8p2_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_get_uc_lane_cfg(srds_access_t *sa__, struct osprey7_v2l8p2_uc_lane_config_st *struct_val);
#endif /* SMALL_FOOTPRINT */
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through osprey7_v2l8p2_set_osr_mode(),
 *       osprey7_v2l8p2_set_tx_osr_mode(), or osprey7_v2l8p2_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through osprey7_v2l8p2_set_osr_mode()
 *        or osprey7_v2l8p2_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through osprey7_v2l8p2_set_osr_mode()
 *        or osprey7_v2l8p2_set_tx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite the osprey7_v2l8p2_set_use_osr_mode_pins_only() setting if it was previously set.
 ...
 * Note: This API returns the control status, not the actual hardware status. Use osprey7_v2l8p2_INTERNAL_get_osr_mode()
...
/** Set the RX osr mode.
 * Note: Calling this API will overwrite the osprey7_v2l8p2_set_use_rx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Set the TX osr mode.
 * Note: Calling this API will overwrite the osprey7_v2l8p2_set_use_tx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] param selects the parameter to write based on #osprey7_v2l8p2_tx_afe_settings_enum.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] param selects the parameter to read based on #osprey7_v2l8p2_tx_afe_settings_enum.
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the osprey7_v2l8p2_stop_rx_adaptation() API.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
