 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: eagle2_tsc2pll_debug_functions.h 1543 2017-04-07 20:52:44Z kirand $ *
 *                                                                                       *
...
/** @file eagle2_tsc2pll_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef EAGLE2_TSC2PLL_DEBUG_FUNCTIONS_H
#define EAGLE2_TSC2PLL_DEBUG_FUNCTIONS_H
...
struct eagle2_tsc2pll_usr_ctrl_func_st {
...
struct eagle2_tsc2pll_usr_ctrl_dfe_func_st {
...
struct eagle2_tsc2pll_usr_ctrl_disable_functions_st {
  struct eagle2_tsc2pll_usr_ctrl_func_st field;
  uint8_t  byte;
};

/** Lane User Control Disable DFE Function Struct */
struct eagle2_tsc2pll_usr_ctrl_disable_dfe_functions_st {
  struct eagle2_tsc2pll_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
 ...
 */
err_code_t eagle2_tsc2pll_isolate_ctrl_pins (const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_isolate_lane_ctrl_pins (const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_isolate_core_ctrl_pins (const phymod_access_t *pa, uint8_t enable);
...
/** Displays Eye Density Data measured with eagle2_tsc2pll_meas_eye_density_data().
 *
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param buffer_size must provide buffer_size which is returned from eagle2_tsc2pll_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: Stop the microcode [use eagle2_tsc2pll_stop_rx_adaptation()] before using this API
 ...
 */
err_code_t eagle2_tsc2pll_tx_pi_jitt_gen (const phymod_access_t *pa, uint8_t enable, int16_t freq_override_val, enum srds_tx_pi_freq_jit_gen_enum jit_type, uint8_t tx_pi_jit_freq_idx, uint8_t tx_pi_jit_amp);
 ...
 */
uint8_t eagle2_tsc2pll_rdbl_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t eagle2_tsc2pll_rdwl_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t eagle2_tsc2pll_rdbls_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t eagle2_tsc2pll_rdwls_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t eagle2_tsc2pll_rdbc_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t eagle2_tsc2pll_rdwc_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t eagle2_tsc2pll_rdbcs_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t eagle2_tsc2pll_rdwcs_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 */
err_code_t eagle2_tsc2pll_apply_txfir_cfg (const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2, int8_t post3);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_wrw_uc_ram (const phymod_access_t *pa, uint16_t addr, uint16_t wr_val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_wrb_uc_ram (const phymod_access_t *pa, uint16_t addr, uint8_t wr_val);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t eagle2_tsc2pll_rdw_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t eagle2_tsc2pll_rdb_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_wrws_uc_ram (const phymod_access_t *pa, uint16_t addr, int16_t wr_val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_wrbs_uc_ram (const phymod_access_t *pa, uint16_t addr, int8_t wr_val);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t eagle2_tsc2pll_rdws_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t eagle2_tsc2pll_rdbs_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle2_tsc2pll_rdblk_uc_ram (const phymod_access_t *pa, uint8_t *mem, uint16_t addr, uint16_t cnt);
