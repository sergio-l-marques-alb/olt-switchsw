...
int _tbhmod_flexe_pcs_vco_to_ui(uint32_t vco, int os_mode, int pam4)
{
    ...
    switch (vco) {
        ...
        case TBHMOD_VCO_25P00G:
            if (os_mode == 1) {
                ui_value = TBHMOD_FLEXE_UI_25P00G_NRZ_OSX2; /* 2/25.00 = 0.08. make 32 bit 0.08. * 2^32 = 343597383 = 0x147ae147 */
            } else {
                ui_value = TBHMOD_FLEXE_UI_25P00G_NRZ_OSX1; /* 1/25.00 = 0.04. make 32 bit 0.04. * 2^32 = 171798691 = 0xa3d70a3 */
            }
            break;
        default:
