/*----------------------------------------------------------------------
 * $Id: tefmod_gen3_sc_lkup_table.h, $
...
extern int tefmod_gen3_vl_bml_get(int speed, uint16_t *vl, uint16_t *bml);
...
extern int tefmod_gen3_mapped_frac_ns_get(int dual_pll, int speed, uint16_t *frac_ns);
...
extern int tefmod_gen3_no_pmd_txrx_fixed_latency_get(int speed, uint16_t *tx_fixed_int, uint16_t *tx_fixed_frac, uint16_t *rx_fixed_int, uint16_t *rx_fixed_frac);
