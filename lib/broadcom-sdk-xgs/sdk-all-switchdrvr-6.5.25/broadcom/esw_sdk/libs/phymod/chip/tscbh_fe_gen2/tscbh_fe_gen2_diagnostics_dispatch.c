...
#include <phymod/chip/tscbh_fe_gen2_diagnostics.h>

#include <phymod/chip/blackhawk7_l2p2_diagnostics.h>
#include <phymod/chip/tscbh_diagnostics.h>

__phymod_diagnostics__dispatch__t__ phymod_diagnostics_tscbh_fe_gen2_diagnostics_driver = {
    ...
    tscbh_fe_gen2_phy_fec_error_inject_set,
    tscbh_fe_gen2_phy_fec_error_inject_get,
};
