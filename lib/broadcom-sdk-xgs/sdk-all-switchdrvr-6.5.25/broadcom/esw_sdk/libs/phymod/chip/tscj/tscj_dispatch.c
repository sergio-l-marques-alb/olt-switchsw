...
__phymod__dispatch__t__ phymod_tscj_driver = {

    tscj_core_identify,
    tscj_core_info_get,
    tscj_core_lane_map_set,
    tscj_core_lane_map_get,
    ...
    tscj_phy_firmware_lane_config_set,
    tscj_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    tscj_phy_polarity_set,
    tscj_phy_polarity_get,
    tscj_phy_tx_set,
    tscj_phy_tx_get,
    ...
    tscj_phy_tx_lane_control_set,
    tscj_phy_tx_lane_control_get,
    tscj_phy_rx_lane_control_set,
    tscj_phy_rx_lane_control_get,
    NULL, /* phymod_phy_fec_enable_set */
    NULL, /* phymod_phy_fec_enable_get */
    tscj_phy_fec_override_set,
    tscj_phy_fec_override_get,
    ...
    tscj_timesync_enable_set,
    tscj_timesync_enable_get,
    ...
    tscj_timesync_offset_set,
    tscj_timesync_offset_get,
    tscj_timesync_adjust_set,
    ...
    tscj_port_enable_set,
    tscj_port_enable_get,
    ...
    tscj_phy_speed_config_set,
    tscj_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    tscj_phy_tx_taps_default_get,
    tscj_phy_lane_config_default_get,
    tscj_phy_firmware_load_info_get,
    tscj_phy_autoneg_advert_ability_set,
    tscj_phy_autoneg_advert_ability_get,
    tscj_phy_autoneg_remote_advert_ability_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    tscj_phy_tx_pam4_precoder_enable_set,
    tscj_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_rx_set */
    NULL, /* phymod_phy_tx_phase_lock_tx_set */
    tscj_phy_pll_reconfig,
    NULL, /* phymod_phy_pll_pwrdn */
    NULL, /* phymod_phy_linkdown_transmit_set */
    NULL, /* phymod_phy_linkdown_transmit_get */
    tscj_phy_synce_clk_ctrl_set,
    tscj_phy_synce_clk_ctrl_get,
    tscj_phy_pcs_enable_set,
    jupiter_phy_rx_ppm_get,
    NULL, /* phymod_phy_channel_loss_hint_set */
    NULL, /* phymod_phy_channel_loss_hint_get */
    tscj_intr_handler,
    tscj_timesync_tx_info_get,
    NULL, /* phymod_phy_master_set */
    NULL, /* phymod_phy_master_get */
    tscj_phy_pcs_lane_swap_adjust,
    tscj_phy_load_speed_id_entry,
    tscj_phy_pmd_override_enable_set,
    ...
    tscj_phy_fec_bypass_indication_set,
    tscj_phy_fec_bypass_indication_get,
    NULL, /* phymod_phy_fec_corruption_period_set */
    NULL, /* phymod_phy_fec_corruption_period_get */
    tscj_phy_codec_mode_set,
    tscj_phy_codec_mode_get,
    tscj_phy_autoneg_speed_id_table_reload,
    tscj_phy_rs_fec_rxp_get,
    NULL, /* phymod_phy_pcs_tx_fsm_check */
    NULL, /* phymod_phy_pcs_reset */
    NULL, /* phymod_phy_osr_mode_get */
    NULL, /* phymod_phy_ref_clk_get */
    tscj_phy_interrupt_enable_set,
    tscj_phy_interrupt_enable_get,
