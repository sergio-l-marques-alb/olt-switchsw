...
#ifndef OSPREY7_V2L8P2_API_COMMON_H
#define OSPREY7_V2L8P2_API_COMMON_H
 ...
 *
 */
typedef struct osprey7_v2l8p2_txfir {
  int16_t tap[TXFIR_ST_NUM_TAPS];
} osprey7_v2l8p2_txfir_st;
 ...
 *
 */
typedef struct osprey7_v2l8p2_dbgfb_stats_s {
...
} osprey7_v2l8p2_dbgfb_data_st;

/*! Debug feedback data
 *
 */
typedef struct osprey7_v2l8p2_dbgfb_data_s {
    uint32_t time_in_us;
    osprey7_v2l8p2_dbgfb_data_st data;
    uint8_t pam4es_en;
    uint8_t temp[3];
} osprey7_v2l8p2_dbgfb_stats_st;
