 ...
 *
 */
typedef struct blackhawk7_v1l8p1_txfir {
  int16_t tap[6];
} blackhawk7_v1l8p1_txfir_st;
 ...
 *
 */
typedef struct blackhawk7_v1l8p1_dbgfb_stats_s {
        int32_t  data1[_X_][_Y_];
        uint32_t data2[_X_][_Y_];
        uint32_t data3[_X_][_Y_];
        int32_t  data4[_X_][_Y_];
} blackhawk7_v1l8p1_dbgfb_data_st;
/*! Debug feedback data
 *
 */
typedef struct blackhawk7_v1l8p1_dbgfb_data_s {
    uint32_t time_in_us;
    blackhawk7_v1l8p1_dbgfb_data_st data;
    uint8_t pam4es_en;
    uint8_t temp[3];
} blackhawk7_v1l8p1_dbgfb_stats_st;
