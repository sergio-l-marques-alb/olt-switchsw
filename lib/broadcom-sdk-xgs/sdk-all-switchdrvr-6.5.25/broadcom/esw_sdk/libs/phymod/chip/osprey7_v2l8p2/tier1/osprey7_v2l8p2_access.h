...
#ifndef OSPREY7_V2L8P2_API_ACCESS_H
#define OSPREY7_V2L8P2_API_ACCESS_H
 ...
 */
uint8_t osprey7_v2l8p2_rdbl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t osprey7_v2l8p2_rdwl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t osprey7_v2l8p2_rdbls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t osprey7_v2l8p2_rdwls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM.
 */
uint8_t osprey7_v2l8p2_rdblp_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM.
 */
uint16_t osprey7_v2l8p2_rdwlp_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
...
/** Unsigned Double Word Write of a uC RAM Lane Static/Persistent variable.
 * Write access through Micro Register Interface for PMD IPs; through Serdes FW DSC Command Interface for external micro IPs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr Address of RAM lane static/persistent variable to be written.
 * @param[in] wr_val 32bit unsigned value to be written to RAM variable.
 ...
 * @return 8bit signed value read from uC RAM.
 */
int8_t osprey7_v2l8p2_rdblps_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM.
 */
int16_t osprey7_v2l8p2_rdwlps_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
...
/** Signed Double Word Write of a uC RAM Lane Static/Persistent variable.
 * Write access through Micro Register Interface for PMD IPs; through Serdes FW DSC Command Interface for external micro IPs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr Address of RAM lane static/persistent variable to be written.
 * @param[in] wr_val 32bit signed value to be written to RAM variable.
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t osprey7_v2l8p2_rdbuc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t osprey7_v2l8p2_rdwuc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t osprey7_v2l8p2_rdbucs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t osprey7_v2l8p2_rdwucs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t osprey7_v2l8p2_rdbc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t osprey7_v2l8p2_rdwc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t osprey7_v2l8p2_rdbcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t osprey7_v2l8p2_rdwcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 */
uint32_t osprey7_v2l8p2_rd_long_uc_prog_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t osprey7_v2l8p2_wr_long_uc_ram(srds_access_t *sa__, uint32_t addr, uint32_t wr_val);
 ...
 */
uint32_t osprey7_v2l8p2_rd_long_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t osprey7_v2l8p2_rdw_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t osprey7_v2l8p2_rdb_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t osprey7_v2l8p2_rdws_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t osprey7_v2l8p2_rdbs_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
