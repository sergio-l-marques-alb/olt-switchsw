...
#include "blackhawk7_v1l8p1/tier2/blackhawk7_v1l8p1_ucode.h"
...
#define TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4     0x6
#define TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4     0x7
...
int _tscbh_gen3_core_firmware_load(const phymod_core_access_t* core, const phymod_core_init_config_t* init_config)
{
    ...
    blackhawk_ucode = blackhawk7_v1l8p1_ucode_get();
    blackhawk_ucode_len = BLACKHAWK7_V1L8P1_UCODE_IMAGE_SIZE;
...
STATIC int
_tscbh_gen3_phy_lane_swap_validate(const phymod_phy_access_t* phy)
{
    int i;
    ...
    PHYMOD_IF_ERR_RETURN
        (tscbh_gen3_core_lane_map_get(&core, &lane_map));
                                   ...
                                   phymod_phy_pll_state_t* new_pll_state)
{
    ...
    int port_enable;
    uint32_t *tscbh_gen3_spd_id_entry_26;
    uint32_t *tscbh_gen3_spd_id_entry_25;
    uint32_t *tscbh_gen3_spd_id_entry_20;


    tscbh_gen3_spd_id_entry_26 = tscbh_gen3_spd_id_entry_26_get();
    tscbh_gen3_spd_id_entry_25 = tscbh_gen3_spd_id_entry_25_get();
    tscbh_gen3_spd_id_entry_20 = tscbh_gen3_spd_id_entry_20_get();
    ...
    *new_pll_state = *old_pll_state;
    ...
    if ((tvco_pll_div == (uint32_t) TBHMOD_GEN3_PLL_MODE_DIV_170) || (tvco_pll_div == (uint32_t) TBHMOD_GEN3_PLL_MODE_DIV_85))  {
        ...
        PHYMOD_IF_ERR_RETURN
            (phymod_mem_write(&pm_phy_copy.access, phymodMemSpeedIdTable, TSCBH_GEN3_FORCED_SPEED_ID_OFFSET + start_lane,
                              (tscbh_gen3_spd_id_entry_26 + mapped_speed_id * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        ...
        PHYMOD_IF_ERR_RETURN
            (phymod_mem_write(&pm_phy_copy.access, phymodMemSpeedIdTable, TSCBH_GEN3_FORCED_SPEED_ID_OFFSET + start_lane,
                              (tscbh_gen3_spd_id_entry_25 + mapped_speed_id * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
    } else {
        /* then load 20G TVCO speed id entry */
        PHYMOD_IF_ERR_RETURN
            (phymod_mem_write(&pm_phy_copy.access, phymodMemSpeedIdTable, TSCBH_GEN3_FORCED_SPEED_ID_OFFSET + start_lane,
                              (tscbh_gen3_spd_id_entry_20 + mapped_speed_id * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
    }
...
int tscbh_gen3_phy_speed_config_get(const phymod_phy_access_t* phy, phymod_phy_speed_config_t* speed_config)
{
    ...
    if (!PHYMOD_DEVICE_OP_MODE_PCS_BYPASS_GET(phy->device_op_mode)) {
        ...
        if (an_en && an_done) {
            ...
            if ((speed_id == TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4) ||
                (speed_id == TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4)) {
                PHYMOD_IF_ERR_RETURN
                    (tbhmod_gen3_fec_align_status_get(&phy_copy.access, &fec_align_live));
                if (!fec_align_live) {
...
int tscbh_gen3_phy_loopback_set(const phymod_phy_access_t* phy, phymod_loopback_mode_t loopback, uint32_t enable)
{
    ...
    if (enable && (num_lane != TSCBH_GEN3_NOF_LANES_IN_CORE)) {
        if (_tscbh_gen3_phy_lane_swap_validate(phy)) {
...
int _tscbh_gen3_core_init_pass1(const phymod_core_access_t* core, const phymod_core_init_config_t* init_config, const phymod_core_status_t* core_status)
{
    ...
    uint32_t *tscbh_gen3_am_table_entry;
    uint32_t *tscbh_gen3_um_table_entry;
    uint32_t *tscbh_gen3_speed_priority_mapping_table;

    tscbh_gen3_am_table_entry = tscbh_gen3_am_table_entry_get();
    tscbh_gen3_um_table_entry = tscbh_gen3_um_table_entry_get();
    tscbh_gen3_speed_priority_mapping_table = tscbh_gen3_speed_priority_mapping_table_get();
    ...
    ucode.ucode_size = BLACKHAWK7_V1L8P1_UCODE_IMAGE_SIZE;
    blackhawk7_ucode_len = BLACKHAWK7_V1L8P1_UCODE_IMAGE_SIZE;
    blackhawk7_ucode = blackhawk7_v1l8p1_ucode_get();
    ...
    for (i = 0; i < am_table_load_size; i++) {
        PHYMOD_IF_ERR_RETURN
            (phymod_mem_write(&core_copy.access, phymodMemAMTable, i,
                              (tscbh_gen3_am_table_entry + i * TSCBH_GEN3_AM_ENTRY_SIZE)));
    }

    for (i = 0; i < um_table_load_size; i++) {
        PHYMOD_IF_ERR_RETURN
            (phymod_mem_write(&core_copy.access, phymodMemUMTable, i,
                              (tscbh_gen3_um_table_entry + i * TSCBH_GEN3_UM_ENTRY_SIZE)));
    }
    ...
    PHYMOD_IF_ERR_RETURN
        (phymod_mem_write(&core_copy.access, phymodMemSpeedPriorityMapTable, 0,
                          tscbh_gen3_speed_priority_mapping_table));
...
int _tscbh_gen3_core_init_pass2(const phymod_core_access_t* core, const phymod_core_init_config_t* init_config, const phymod_core_status_t* core_status)
{
        ...
        for (i = 0; i < speed_id_load_size; i++) {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&core_copy.access, phymodMemSpeedIdTable, i,
                                  (tscbh_gen3_spd_id_entry_26 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        }
    } else if (tvco_rate == TBHMOD_GEN3_VCO_25G) {
        for (i = 0; i < speed_id_load_size; i++) {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&core_copy.access, phymodMemSpeedIdTable, i,
                                  (tscbh_gen3_spd_id_entry_25 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        }
    } else if (tvco_rate == TBHMOD_GEN3_VCO_20G) {
        for (i = 0; i < speed_id_load_size; i++) {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&core_copy.access, phymodMemSpeedIdTable, i,
                                  (tscbh_gen3_spd_id_entry_20 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        }
    }
    ...
    if (init_config->firmware_load_method != phymodFirmwareLoadMethodNone) {
        ...
        ucode.stack_size = BLACKHAWK7_V1L8P1_UCODE_STACK_SIZE;
        ucode.ucode_size = BLACKHAWK7_V1L8P1_UCODE_IMAGE_SIZE;
        ucode.crc_value  = BLACKHAWK7_V1L8P1_UCODE_IMAGE_CRC;
...
int tscbh_gen3_phy_init(const phymod_phy_access_t* phy, const phymod_phy_init_config_t* init_config)
{
    ...
    if (num_lane != 8) {
        /* This SW WAR is requird for lane0 on MPP0 */
        if (!PHYMOD_PHY_INIT_F_SW_WAR_100G_2LANE_MPP0_IS_DONE_GET(init_config)) {
        ...
        /* This SW WAR is requird for lane4 on MPP1 */
        if (!PHYMOD_PHY_INIT_F_SW_WAR_100G_2LANE_MPP1_IS_DONE_GET(init_config)) {
                                         ...
                                         phymod_phy_pll_state_t* new_pll_adv_state)
{
    ...
    phymod_phy_access_t phy_copy;
    tbhmod_gen3_refclk_t ref_clk;
    uint32_t request_pll_div[3], tvco_pll_div = 0, pll_lock, cnt;
    ...
    if (request_pll_div[0] != tvco_pll_div) {
...
int tscbh_gen3_phy_autoneg_set(const phymod_phy_access_t* phy, const phymod_autoneg_control_t* an)
{
    ...
    if (an->enable) {
        ...
        for (i = 0; i < num_lane; i++) {
            ...
            phy_copy.access.lane_mask = 0x1 << (i + start_lane);
            PHYMOD_IF_ERR_RETURN
                (blackhawk7_v1l8p1_tx_pam4_precoder_enable_set(&phy_copy.access, 0));
        }
    }
                                ...
                                phymod_ref_clk_t ref_clk1)
{
    ...
    if (tvco_rate == TBHMOD_GEN3_VCO_26G) {
        for (i = 0; i < speed_id_load_size; i++) {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&pm_phy_copy.access, phymodMemSpeedIdTable, i,
                                  (tscbh_gen3_spd_id_entry_26 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        }
    } else if (tvco_rate == TBHMOD_GEN3_VCO_25G) {
        for (i = 0; i < speed_id_load_size; i++) {
...
int tscbh_gen3_timesync_adjust_set(const phymod_phy_access_t* phy, uint32_t flags, uint32_t ts_am_norm_mode)
{
    ...
    tbhmod_gen3_ts_table_entry ts_update_table;
    uint32_t psll_entry[TBHMOD_GEN3_TS_TABLE_SIZE * TBHMOD_GEN3_TS_PSLL_BASED_ENTRY_SIZE];
    ...
    tbhmod_gen3_ts_table_entry* tbhmod_gen3_ts_table_tx_sop;
    tbhmod_gen3_ts_table_entry* tbhmod_gen3_ts_table_rx_sop;
    tbhmod_gen3_ts_table_entry* tbhmod_gen3_ts_table_tx_sfd;
    tbhmod_gen3_ts_table_entry* tbhmod_gen3_ts_table_rx_sfd;

    tbhmod_gen3_ts_table_tx_sop = tbhmod_gen3_ts_table_tx_sop_get();
    tbhmod_gen3_ts_table_rx_sop = tbhmod_gen3_ts_table_rx_sop_get();
    tbhmod_gen3_ts_table_tx_sfd = tbhmod_gen3_ts_table_tx_sfd_get();
    tbhmod_gen3_ts_table_rx_sfd = tbhmod_gen3_ts_table_rx_sfd_get();
    ...
    if (PHYMOD_TIMESYNC_F_SOP_GET(flags)) {
        ts_offset = TSCBH_GEN3_TS_OFFSET_SOP;
    } else {
        if (PHYMOD_TIMESYNC_F_MAC_DA_GET(flags)) {
            ts_offset = TSCBH_GEN3_TS_OFFSET_MAC_DA;
        } else {
            ts_offset = TSCBH_GEN3_TS_OFFSET_SFD;
            ts_use_sfd_table = 1;
        }
    }
    ...
    if ((PHYMOD_TIMESYNC_F_REDUCED_PREAMBLE_MODE_GET(flags)) &&
        (ts_offset != TSCBH_GEN3_TS_OFFSET_SOP)){
        ts_offset -= TSCBH_GEN3_TS_RPM_OFFSET;
    }
    ...
    psll_entry_size = ts_table_size * TBHMOD_GEN3_TS_PSLL_BASED_ENTRY_SIZE;

    /* 1.6 Find the 1588 table. */
    if (ts_use_sfd_table) {
        ts_tx_entry = tbhmod_gen3_ts_table_tx_sfd + ts_table_index;
        ts_rx_entry = tbhmod_gen3_ts_table_rx_sfd + ts_table_index;
    } else {
        ts_tx_entry = tbhmod_gen3_ts_table_tx_sop + ts_table_index;
        ts_rx_entry = tbhmod_gen3_ts_table_rx_sop + ts_table_index;
    }
    ...
    /* 3. Load 1588 RX table. */
    /* 3.1 Translate RX table to psuedo logical lane (PSLL) based array. */
    for (i = 0; i < (int)ts_table_size; i++) {
        PHYMOD_IF_ERR_RETURN
            (tbhmod_gen3_tbl_entry_to_psll_entry_map(&(*ts_rx_entry)[i][0], &psll_entry[i * TBHMOD_GEN3_TS_PSLL_BASED_ENTRY_SIZE]));
    }
    /* 3.2 Add PM offset to each PSLL. */
    PHYMOD_IF_ERR_RETURN
        (tbhmod_gen3_ts_offset_rx_set(&phy_copy.access, psll_entry_size, psll_entry));
    /* 3.3 Translate PSLL based array back to 1588 table format. */
    for (i = 0; i < (int)ts_table_size; i++) {
        PHYMOD_IF_ERR_RETURN
            (tbhmod_gen3_psll_entry_to_tbl_entry_map(&psll_entry[i * TBHMOD_GEN3_TS_PSLL_BASED_ENTRY_SIZE], &ts_update_table[i][0]));
    }
    ...
    phy_copy.access.lane_mask = 0x1 << start_lane;
    PHYMOD_IF_ERR_RETURN
        (tbhmod_gen3_pcs_ts_config(&phy_copy.access, ts_offset));
...
int tscbh_gen3_phy_load_speed_id_entry(const phymod_phy_access_t* phy, uint32_t speed, uint32_t num_lane, phymod_fec_type_t fec_type)
{
    ...
    if (((int) tvco_pll_div == TBHMOD_GEN3_PLL_MODE_DIV_170) || ((int) tvco_pll_div == TBHMOD_GEN3_PLL_MODE_DIV_85))  {
        /* then load 26G TVCO speed id entry */
        PHYMOD_IF_ERR_RETURN
            (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, TSCBH_GEN3_FORCED_SPEED_ID_OFFSET + start_lane,
                               (tscbh_gen3_spd_id_entry_26 + mapped_speed_id * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE) ));
...
int tscbh_gen3_timesync_tx_info_get(const phymod_phy_access_t* phy, phymod_ts_fifo_status_t* ts_tx_info)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (tbhmod_gen3_1588_ts_valid_get(&phy_copy.access, &ts_valid));
...
int tscbh_gen3_phy_autoneg_speed_id_table_reload(const phymod_phy_access_t* phy, uint32_t gsh_header_enable)
{
    ...
    uint32_t* tscbh_gen3_spd_id_entry_25;
    uint32_t* tscbh_gen3_spd_id_entry_20;
    uint32_t* tscbh_gen3_spd_id_entry_26_gsh;
    uint32_t* tscbh_gen3_spd_id_entry_25_gsh;
    uint32_t* tscbh_gen3_spd_id_entry_20_gsh;
    uint32_t* tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25;

    tscbh_gen3_spd_id_entry_26 = tscbh_gen3_spd_id_entry_26_get();
    tscbh_gen3_spd_id_entry_25 = tscbh_gen3_spd_id_entry_25_get();
    tscbh_gen3_spd_id_entry_20 = tscbh_gen3_spd_id_entry_20_get();
    tscbh_gen3_spd_id_entry_26_gsh = tscbh_gen3_spd_id_entry_26_gsh_get();
    tscbh_gen3_spd_id_entry_25_gsh = tscbh_gen3_spd_id_entry_25_gsh_get();
    tscbh_gen3_spd_id_entry_20_gsh = tscbh_gen3_spd_id_entry_20_gsh_get();
    tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25 = tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25_get();
    ...
    /* first set the lane mask to be 0x1 */
    phy_copy.access.lane_mask = 1 << 0;
    PHYMOD_IF_ERR_RETURN(tbhmod_gen3_fec_override_get(&phy_copy.access, &an_fec_override_enable));
    ...
    if (((int) tvco_pll_div == TBHMOD_GEN3_PLL_MODE_DIV_170) || ((int) tvco_pll_div == TBHMOD_GEN3_PLL_MODE_DIV_85))  {
            ...
            if (gsh_header_enable) {
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, i,
                                      (tscbh_gen3_spd_id_entry_26_gsh + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
            } else {
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, i,
                                      (tscbh_gen3_spd_id_entry_26 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        ...
        for (i = 0; i < TSCBH_GEN3_AUTONEG_SPEED_ID_COUNT; i++) {
            if (gsh_header_enable) {
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, i,
                                      (tscbh_gen3_spd_id_entry_25_gsh + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
            } else {
                if (an_fec_override_enable &&
                    (i == TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4 ||
                     i == TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4)) {
                    ...
                    PHYMOD_IF_ERR_RETURN
                        (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                          i, tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25));
                } else {
                    PHYMOD_IF_ERR_RETURN
                        (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, i,
                                          (tscbh_gen3_spd_id_entry_25 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        ...
        for (i = 0; i < TSCBH_GEN3_AUTONEG_SPEED_ID_COUNT; i++) {
            if (gsh_header_enable) {
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, i,
                                      (tscbh_gen3_spd_id_entry_20_gsh + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
            } else {
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable, i,
                                      (tscbh_gen3_spd_id_entry_20 + i * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
                                 ...
                                 phymod_synce_clk_ctrl_t cfg)
{
    ...
    PHYMOD_IF_ERR_RETURN
         (tbhmod_gen3_synce_mode_set(&phy_copy.access, cfg.stg0_mode, cfg.stg1_mode));
    ...
    if ((cfg.stg0_mode == 0x2) && (cfg.stg1_mode == 0x0)) {
        /* first get the OSR the port is current using */
        PHYMOD_IF_ERR_RETURN
            (blackhawk7_v1l8p1_osr_mode_get(&phy_copy.access, &osr_mode));
        ...
        phy_copy.access.lane_mask = 0x1;
        PHYMOD_IF_ERR_RETURN
            (blackhawk7_v1l8p1_INTERNAL_read_pll_div(&phy_copy.access, (uint32_t *)&pll_div));

        /* next based on the VCO value and osr mode, set the SDM value properly */
        /* first check 26G VCO */
        if ((pll_div == TBHMOD_GEN3_PLL_MODE_DIV_170) || (pll_div == TBHMOD_GEN3_PLL_MODE_DIV_85))  {
            sdm_val = TSCBH_GEN3_SYNCE_SDM_DIVISOR_26G_VCO;
        } else if ((pll_div == TBHMOD_GEN3_PLL_MODE_DIV_165) || (pll_div == TBHMOD_GEN3_PLL_MODE_DIV_82P5)) {
            sdm_val = TSCBH_GEN3_SYNCE_SDM_DIVISOR_25GP78125_VCO;
        } else if ((pll_div == TBHMOD_GEN3_PLL_MODE_DIV_132) || (pll_div == TBHMOD_GEN3_PLL_MODE_DIV_66)) {
            sdm_val = TSCBH_GEN3_SYNCE_SDM_DIVISOR_20G_VCO;
        } else if ((pll_div == TBHMOD_GEN3_PLL_MODE_DIV_160) || (pll_div == TBHMOD_GEN3_PLL_MODE_DIV_80)) {
            sdm_val = TSCBH_GEN3_SYNCE_SDM_DIVISOR_25G_VCO;
        } else {
        ...
        PHYMOD_MEMCPY(&phy_copy, phy, sizeof(phy_copy));
        PHYMOD_IF_ERR_RETURN
            (tbhmod_gen3_synce_clk_ctrl_set(&phy_copy.access, sdm_val));
	}
                                 ...
                                 phymod_synce_clk_ctrl_t *cfg)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (tbhmod_gen3_synce_mode_get(&phy_copy.access, &(cfg->stg0_mode), &(cfg->stg1_mode)));

    PHYMOD_IF_ERR_RETURN
        (tbhmod_gen3_synce_clk_ctrl_get(&phy_copy.access, &(cfg->sdm_val)));
            ...
            if (intr_status.is_2b_err || intr_status.is_1b_err) {
                ...
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemAMTable, index,
                                      (tscbh_gen3_am_table_entry + index * TSCBH_GEN3_AM_ENTRY_SIZE)));
                *is_handled = 1;
            }
            break;
            ...
            if (intr_status.is_2b_err || intr_status.is_1b_err) {
                ...
                PHYMOD_IF_ERR_RETURN
                    (phymod_mem_write(&phy_copy.access, phymodMemUMTable, index,
                                      (tscbh_gen3_um_table_entry + index * TSCBH_GEN3_UM_ENTRY_SIZE)));
                *is_handled = 1;
            }
            break;
 ...
 * for this purpose
 */
int tscbh_gen3_phy_fec_override_set(const phymod_phy_access_t* phy, uint32_t enable)
{
    phymod_phy_access_t phy_copy;
    uint32_t tvco_pll_div;
    uint32_t* tscbh_gen3_spd_id_entry_25;
    ...
    if ((enable ==  0) || (enable == 1)) {
         PHYMOD_IF_ERR_RETURN(tbhmod_gen3_fec_override_set(&phy_copy.access, enable));
    } else {
    ...
    /* first set the lane mask to be 0x1 */
    phy_copy.access.lane_mask = 1 << 0;
    if ((tvco_pll_div == (uint32_t)TBHMOD_GEN3_PLL_MODE_DIV_165) || (tvco_pll_div == (uint32_t)TBHMOD_GEN3_PLL_MODE_DIV_82P5)) {
        if (enable) {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4,
                                  tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25));
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4,
                                  tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25));
        } else {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4,
                                  (tscbh_gen3_spd_id_entry_25 + TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4 * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4,
                                  (tscbh_gen3_spd_id_entry_25 + TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4 * TSCBH_GEN3_SPEED_ID_ENTRY_SIZE)));
        }
    }
    return PHYMOD_E_NONE;
}

int tscbh_gen3_phy_fec_override_get(const phymod_phy_access_t* phy, uint32_t* enable)
{
    phymod_phy_access_t phy_copy;

    PHYMOD_MEMCPY(&phy_copy, phy, sizeof(phy_copy));
    phy_copy.access.lane_mask = 1;
    PHYMOD_IF_ERR_RETURN(tbhmod_gen3_fec_override_get(&phy_copy.access, enable));
...
static
int _tscbh_gen3_phy_power_mode_map(phymod_power_mode_t power_mode, enum srds_core_pwrdn_mode_enum *pwrdn_mode)
{
    switch (power_mode) {
...
int tscbh_gen3_phy_serdes_power_set(const phymod_phy_access_t* phy, phymod_power_option_t power_option, phymod_power_mode_t power_mode)
{
    phymod_phy_access_t phy_copy;
    int start_lane, num_lane, i;
    ...
    PHYMOD_IF_ERR_RETURN
        (_tscbh_gen3_phy_power_mode_map(power_mode, &pwrdn_mode));
    switch (power_option) {
        case phymodSerdesOptionLane:
            for( i = 0; i < num_lane; i++) {
                ...
                phy_copy.access.lane_mask = 1 << (start_lane + i);
                PHYMOD_IF_ERR_RETURN
                    (blackhawk7_v1l8p1_lane_pwrdn(&phy_copy.access, pwrdn_mode));
            }
            PHYMOD_IF_ERR_RETURN
                (blackhawk7_v1l8p1_lane_soft_reset(&phy_copy.access, 0));
            break;
        case phymodSerdesOptionCore:
            phy_copy.access.lane_mask = 0x1;
            PHYMOD_IF_ERR_RETURN
                (blackhawk7_v1l8p1_core_pwrdn(&phy_copy.access, pwrdn_mode));
            ...
            if (power_mode == phymodSerdesPWRDN_DEEP) {
                ...
                for (i = 0; i < TSCBH_GEN3_NOF_LANES_IN_CORE; i++) {
                    ...
                    PHYMOD_IF_ERR_RETURN
                        (blackhawk7_v1l8p1_lane_pll_selection_set(&phy_copy.access,
        ...
        case phymodSerdesOptionAll:
            PHYMOD_IF_ERR_RETURN
                (blackhawk7_v1l8p1_pwrdn_all(&phy_copy.access, pwrdn_mode));
            break;
        default:
            PHYMOD_RETURN_WITH_ERR(PHYMOD_E_UNAVAIL,
...
int tscbh_gen3_phy_an_timer_set(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t period)
{
    ...
    switch (timer_type) {
        case phymodAnTimerLinkFailInhibitLtPam4:
            ...
            PHYMOD_IF_ERR_RETURN
                (tbhmod_gen3_an_link_fail_inhibit_timer_set(&phy_copy.access,
                                                            TBHMOD_GEN3_AN_FAIL_INHIBIT_TIMER_LT_PAM4,
                                                       period));
            phy_copy.access.lane_mask = 0x1 << 4;
            PHYMOD_IF_ERR_RETURN
                (tbhmod_gen3_an_link_fail_inhibit_timer_set(&phy_copy.access,
...
int tscbh_gen3_phy_an_timer_get(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t* period)
{
    phymod_core_access_t  phy_copy;
    ...
    switch (timer_type) {
        case phymodAnTimerLinkFailInhibitLtPam4:
            PHYMOD_IF_ERR_RETURN
                (tbhmod_gen3_an_link_fail_inhibit_timer_get(&phy_copy.access,
                                                            TBHMOD_GEN3_AN_FAIL_INHIBIT_TIMER_LT_PAM4,
                                                       period));
            break;
        default:
