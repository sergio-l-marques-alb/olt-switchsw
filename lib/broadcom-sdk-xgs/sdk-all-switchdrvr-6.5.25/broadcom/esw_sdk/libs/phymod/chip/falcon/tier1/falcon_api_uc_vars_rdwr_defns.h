...
#define rdv_usr_ctrl_fast_link_recovery_byte()                       falcon_tsc_rdbl_uc_var(pa, __ERR, 0x2)
#define wrv_usr_ctrl_fast_link_recovery_byte(wr_val)                 falcon_tsc_wrbl_uc_var(pa, 0x2, wr_val)
...
#define rdv_usr_flr_enhanced()                                       falcon_tsc_rdbl_uc_var(pa, __ERR,0x12b)
#define wrv_usr_flr_enhanced(wr_val)                                 falcon_tsc_wrbl_uc_var(pa, 0x12b,wr_val)
