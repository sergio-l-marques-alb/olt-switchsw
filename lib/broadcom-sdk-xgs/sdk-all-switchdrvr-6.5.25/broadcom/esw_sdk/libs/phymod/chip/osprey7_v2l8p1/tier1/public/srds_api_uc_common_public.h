...
enum srds_pmd_uc_diag_cmd_enum {
  ...
  SRDS_CMD_UC_DIAG_ADC_ENOB        = 9
};


/** DIAG ADC ENOB status macros **/
enum srds_pmd_uc_diag_enob_status_enum {
  SRDS_DIAG_ENOB_NO_ERROR                = 0,
  SRDS_DIAG_ENOB_UNUSED                  = 1,
  SRDS_DIAG_ENOB_PTOTAL_NSAMPLES_OVFL    = 2,
  SRDS_DIAG_ENOB_PNOISE_CALC_ERR         = 3,
  SRDS_DIAG_ENOB_PSIGNAL_SQR_OVFL        = 4,
  SRDS_DIAG_ENOB_CAPMEM_CAPTURE_ERR      = 5,
  SRDS_DIAG_ENOB_PNOISE_SCALE_OVFL       = 6,
  SRDS_DIAG_ENOB_STATUS_MAX              = 0x0f
};
...
#define INFO_TABLE_OFFS_LANE_STATIC_MEM_PTR     (0x74)   /* Only used in Osprey uCode. */
#define INFO_TABLE_OFFS_LANE_STATIC_MEM_SIZE    (0x78)   /* Only used in Osprey uCode. */
