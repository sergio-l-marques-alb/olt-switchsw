...
#define OSPREY7_V2L8P2_LANE_TIMER_SHIFT (5)

/* Please note that when adding entries here you should update the #defines in the osprey7_v2l8p2_common.h */
...
/** OSR_MODES Enum */
enum osprey7_v2l8p2_osr_mode_enum {
  ...
  OSPREY7_V2L8P2_OSX1      = 0,
  OSPREY7_V2L8P2_OSX2      = 1,
  OSPREY7_V2L8P2_OSX4      = 2,
  OSPREY7_V2L8P2_OSX5      = 3,
  OSPREY7_V2L8P2_OSX8      = 9,
  OSPREY7_V2L8P2_OSX16     = 18,
  OSPREY7_V2L8P2_OSX32     = 26,
  OSPREY7_V2L8P2_OSX64     = 34,
  OSPREY7_V2L8P2_OSX33     = 17,
  OSPREY7_V2L8P2_OSX41P25  = 25,
  OSPREY7_V2L8P2_OSX42P5   = 33,
  OSPREY7_V2L8P2_OSR_UNINITIALIZED = 0x3f  
};
...
#define INIT_OSR_ASSOC_TABLE                                                                    \
        {{OSPREY7_V2L8P2_OSX1, 1000}, {OSPREY7_V2L8P2_OSX2, 2000}, {OSPREY7_V2L8P2_OSX4, 4000},          \
         {OSPREY7_V2L8P2_OSX5, 5000}, {OSPREY7_V2L8P2_OSX8, 8000}, {OSPREY7_V2L8P2_OSX16, 16000},        \
         {OSPREY7_V2L8P2_OSX32, 32000}, {OSPREY7_V2L8P2_OSX33, 33000}, {OSPREY7_V2L8P2_OSX41P25, 41250}, \
         {OSPREY7_V2L8P2_OSX42P5, 42500}, {OSPREY7_V2L8P2_OSX64, 64000}}

#define INIT_OSR_MODE_ENUM {OSPREY7_V2L8P2_OSX1, OSPREY7_V2L8P2_OSX2, OSPREY7_V2L8P2_OSX4, \
                            OSPREY7_V2L8P2_OSX5, OSPREY7_V2L8P2_OSX8, OSPREY7_V2L8P2_OSX16, \
                            OSPREY7_V2L8P2_OSX32, OSPREY7_V2L8P2_OSX33, OSPREY7_V2L8P2_OSX41P25, \
                            OSPREY7_V2L8P2_OSX42P5, OSPREY7_V2L8P2_OSX64, 0xff}
...
#define OSR_MODE_SUPPORTS_EYE_TESTS(mode) ((mode) < OSPREY7_V2L8P2_OSX16)

/** CDR mode Enum **/
enum osprey7_v2l8p2_cdr_mode_enum {
  OSPREY7_V2L8P2_CDR_MODE_OS_ALL_EDGES             = 0,
  OSPREY7_V2L8P2_CDR_MODE_OS_PATTERN               = 1,
  OSPREY7_V2L8P2_CDR_MODE_OS_PATTERN_ENHANCED      = 2,
  OSPREY7_V2L8P2_CDR_MODE_BR_PATTERN               = 3,
  OSPREY7_V2L8P2_CDR_MODE_PAM4_NR_OS_PATTERN       = 4,
  OSPREY7_V2L8P2_CDR_MODE_PAM4_NR_BR_PATTERN       = 5,
  OSPREY7_V2L8P2_CDR_MODE_PAM4_ER_DFE_DATA_PATTERN = 6,
  OSPREY7_V2L8P2_CDR_MODE_PAM4_ER_PATTERN          = 7
};

/** Lane User Control Clause93/72 Force Value **/
enum osprey7_v2l8p2_cl93n72_frc_val_enum {
  OSPREY7_V2L8P2_CL93N72_FORCE_OS  = 0,
  OSPREY7_V2L8P2_CL93N72_FORCE_BR  = 1
};
