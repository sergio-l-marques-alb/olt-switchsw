/****************************************************************************
 * File Name  :  merlin_quadra28_functions.h
 * Created On :  29/04/2013
 * Created By :  Kiran Divakar
 * Description:  Header file with API functions for Serdes IPs
 * Revision   :  $Id: merlin_quadra28_functions.h 944 2015-03-05 22:47:30Z eroes $
 *
...
#ifndef MERLIN_QUADRA28_API_FUNCTIONS_H
#define MERLIN_QUADRA28_API_FUNCTIONS_H
 ...
 */
#define _error(err_code) (err_code)
...
/**
 * This build includes register access macros for the MERLIN/QUADRA 28nm core.
 */
 ...
 *
 * The return code of USR_PRINTF() is suppressed to confine automated return
 * to failures in implementation logic and to accommodate historical variation
 * in the USR_PRINTF(()) return signature.
 *
