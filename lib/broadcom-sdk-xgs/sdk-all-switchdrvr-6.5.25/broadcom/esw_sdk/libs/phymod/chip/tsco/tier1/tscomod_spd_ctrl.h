 ...
 *               and UM Table access.
 *----------------------------------------------------------------------------*/
#ifndef _TSCOMOD_SPD_CTRL_H_
#define _TSCOMOD_SPD_CTRL_H_ 

#include <phymod/phymod.h>
#include "tscomod_spd_ctrl_defines.h"
...
typedef struct {
    ...
    uint8_t  um_pad;
    uint8_t  cm_control;
} tscomod_um_tbl_entry_t;


/* Function Prototypes */
extern void                 tscomod_spd_ctrl_unpack_spd_id_tbl_entry(uint32_t *packed_entry, tscomod_spd_id_tbl_entry_t *entry);
extern void                 tscomod_spd_ctrl_pack_spd_id_tbl_entry(tscomod_spd_id_tbl_entry_t *entry, uint32_t *packed_entry);

extern void                 tscomod_spd_ctrl_unpack_am_tbl_entry(uint32_t *packed_entry, tscomod_am_tbl_entry_t *entry);
extern void                 tscomod_spd_ctrl_pack_am_tbl_entry(tscomod_am_tbl_entry_t *entry, uint32_t *packed_entry);

extern void                 tscomod_spd_ctrl_unpack_um_tbl_entry(uint32_t *packed_entry, tscomod_um_tbl_entry_t *entry);
extern void                 tscomod_spd_ctrl_pack_um_tbl_entry(tscomod_um_tbl_entry_t *entry, uint32_t *packed_entry);
