...
/* Please note that when adding entries here you should update the #defines in the falcon16_v1l4p1_common.h */
...
/** OSR_MODES Enum */
enum falcon16_v1l4p1_osr_mode_enum {
  /* If the enumerations change, then consider updating OSR_MODE_SUPPORTS_EYE_TESTS(). */
  FALCON16_V1L4P1_OSX1      = 0,
  FALCON16_V1L4P1_OSX2      = 1,
  FALCON16_V1L4P1_OSX4      = 2,
  FALCON16_V1L4P1_OSX21P25  = 4,
  FALCON16_V1L4P1_OSX8      = 5,
  FALCON16_V1L4P1_OSX20     = 7,
  FALCON16_V1L4P1_OSX16P5   = 8,
  FALCON16_V1L4P1_OSX16     = 9,
  FALCON16_V1L4P1_OSX8P25   = 11,
  FALCON16_V1L4P1_OSX20P625 = 12,
  FALCON16_V1L4P1_OSX32     = 13,
  FALCON16_V1L4P1_OSX6P6    = 15,
  FALCON16_V1L4P1_OSX2P5    = 16     /* Analog 2p5 OSR Mode */
};

/** Return true if an OSR mode supports eye tests. **/
#define OSR_MODE_SUPPORTS_EYE_TESTS(mode) (((mode) <= FALCON16_V1L4P1_OSX4) || ((mode) == FALCON16_V1L4P1_OSX2P5))

/** CDR mode Enum **/
enum falcon16_v1l4p1_cdr_mode_enum {
  FALCON16_V1L4P1_CDR_MODE_OS_ALL_EDGES         = 0,
  FALCON16_V1L4P1_CDR_MODE_OS_PATTERN           = 1,
  FALCON16_V1L4P1_CDR_MODE_OS_PATTERN_ENHANCED  = 2,
  FALCON16_V1L4P1_CDR_MODE_BR_PATTERN           = 3
};

/** Lane User Control Clause93/72 Force Value **/
enum falcon16_v1l4p1_cl93n72_frc_val_enum {
  FALCON16_V1L4P1_CL93N72_FORCE_OS  = 0,
  FALCON16_V1L4P1_CL93N72_FORCE_BR  = 1
};

/** FLR Timeout Time Enum
 *  Please change flr_timeout_time_ary in process_pmd_lane.c to match any changes here.
 */
enum falcon16_v1l4p1_flr_timeout_enum {
  FALCON16_V1L4P1_FLR_TIMEOUT_50MS  = 0,
  FALCON16_V1L4P1_FLR_TIMEOUT_75MS  = 1,
  FALCON16_V1L4P1_FLR_TIMEOUT_100MS = 2,
  FALCON16_V1L4P1_FLR_TIMEOUT_150MS = 3
};
