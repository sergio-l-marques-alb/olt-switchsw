...
__phymod__dispatch__t__ phymod_osprey7_v2l8p1_driver = {

    osprey7_v2l8p1_core_identify,
    osprey7_v2l8p1_core_info_get,
    osprey7_v2l8p1_core_lane_map_set,
    osprey7_v2l8p1_core_lane_map_get,
    osprey7_v2l8p1_core_reset_set,
    osprey7_v2l8p1_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    osprey7_v2l8p1_phy_firmware_lane_config_set,
    osprey7_v2l8p1_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    osprey7_v2l8p1_phy_rx_restart,
    osprey7_v2l8p1_phy_polarity_set,
    osprey7_v2l8p1_phy_polarity_get,
    osprey7_v2l8p1_phy_tx_set,
    osprey7_v2l8p1_phy_tx_get,
    ...
    osprey7_v2l8p1_phy_rx_adaptation_resume,
    ...
    osprey7_v2l8p1_phy_tx_lane_control_set,
    osprey7_v2l8p1_phy_tx_lane_control_get,
    osprey7_v2l8p1_phy_rx_lane_control_set,
    osprey7_v2l8p1_phy_rx_lane_control_get,
    ...
    osprey7_v2l8p1_phy_cl72_set,
    osprey7_v2l8p1_phy_cl72_get,
    osprey7_v2l8p1_phy_cl72_status_get,
    ...
    osprey7_v2l8p1_core_init,
    osprey7_v2l8p1_phy_pll_multiplier_get,
    osprey7_v2l8p1_phy_init,
    osprey7_v2l8p1_phy_loopback_set,
    osprey7_v2l8p1_phy_loopback_get,
    osprey7_v2l8p1_phy_rx_pmd_locked_get,
    osprey7_v2l8p1_phy_rx_pmd_lock_status_get,
    ...
    osprey7_v2l8p1_phy_reg_read,
    osprey7_v2l8p1_phy_reg_write,
    ...
    osprey7_v2l8p1_phy_eye_margin_est_get,
    ...
    osprey7_v2l8p1_phy_speed_config_set,
    osprey7_v2l8p1_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    NULL, /* phymod_phy_tx_taps_default_get */
    NULL, /* phymod_phy_lane_config_default_get */
    osprey7_v2l8p1_phy_firmware_load_info_get,
    ...
    osprey7_v2l8p1_phy_tx_pam4_precoder_enable_set,
    osprey7_v2l8p1_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_rx_set */
    NULL, /* phymod_phy_tx_phase_lock_tx_set */
    NULL, /* phymod_phy_pll_reconfig */
    osprey7_v2l8p1_phy_pll_pwrdn,
    ...
    osprey7_v2l8p1_phy_channel_loss_hint_set,
    osprey7_v2l8p1_phy_channel_loss_hint_get,
    ...
    osprey7_v2l8p1_phy_pmd_info_init,
