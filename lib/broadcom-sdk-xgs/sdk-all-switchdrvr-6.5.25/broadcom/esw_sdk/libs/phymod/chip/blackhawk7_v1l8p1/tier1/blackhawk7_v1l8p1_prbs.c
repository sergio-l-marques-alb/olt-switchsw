...
err_code_t blackhawk7_v1l8p1_get_prbs_chk_hw_timer_ctrl(srds_access_t *sa__, struct blackhawk7_v1l8p1_prbs_chk_hw_timer_ctrl_st * const prbs_chk_hw_timer_ctrl_bak) {
    INIT_SRDS_ERR_CODE
...
err_code_t blackhawk7_v1l8p1_set_prbs_chk_hw_timer_ctrl(srds_access_t *sa__, struct blackhawk7_v1l8p1_prbs_chk_hw_timer_ctrl_st const * const prbs_chk_hw_timer_ctrl_bak) {
    INIT_SRDS_ERR_CODE
...
err_code_t blackhawk7_v1l8p1_config_prbs_chk_hw_timer(srds_access_t *sa__, uint16_t time_ms, uint16_t *time_ms_adjusted) {
    INIT_SRDS_ERR_CODE
    struct blackhawk7_v1l8p1_prbs_chk_hw_timer_ctrl_st prbs_chk_hw_timer_ctrl;
    ENULL_MEMSET(&prbs_chk_hw_timer_ctrl, 0, sizeof(struct blackhawk7_v1l8p1_prbs_chk_hw_timer_ctrl_st));
...
err_code_t blackhawk7_v1l8p1_config_BER_HW_mode(srds_access_t *sa__, uint16_t time_ms, struct blackhawk7_v1l8p1_ber_data_st *ber_data, struct blackhawk7_v1l8p1_prbs_chk_hw_timer_ctrl_st *prbs_chk_hw_timer_ctrl) {
    INIT_SRDS_ERR_CODE
    uint8_t lcklost = 0;
    uint32_t err_cnt= 0;
    uint8_t clk_gate = 0;
...
err_code_t blackhawk7_v1l8p1_get_BER_data_HW_mode(srds_access_t *sa__, struct blackhawk7_v1l8p1_ber_data_st *ber_data, struct blackhawk7_v1l8p1_prbs_chk_hw_timer_ctrl_st *prbs_chk_hw_timer_ctrl) {
    INIT_SRDS_ERR_CODE
    uint8_t lcklost = 0;
    uint32_t err_cnt= 0;
