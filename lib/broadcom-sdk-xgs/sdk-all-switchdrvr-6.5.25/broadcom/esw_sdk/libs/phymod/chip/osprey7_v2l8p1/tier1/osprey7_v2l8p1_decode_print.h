...
#ifndef OSPREY7_V2L8P1_API_DECODE_PRINT_H
#define OSPREY7_V2L8P1_API_DECODE_PRINT_H
 ...
 */
extern err_code_t osprey7_v2l8p1_decode_uc_sts_ext(srds_access_t *sa__, uint16_t bits, char *buf, size_t buf_size, const char * const prepended_text);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
extern err_code_t osprey7_v2l8p1_decode_uc_sts(srds_access_t *sa__, uint8_t bits, char *buf, size_t buf_size, const char * const prepended_text);

/** Print Decoded core_sts bits.
 * Can be used to decode core_sts.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] bits The bits that have been set and should be decoded for core_sts.
 * @param[out] buf The input buffer that will get populated with the decoded bits.
 * @param[in] buf_size The size of the input buffer in bytes.
 * @param[in] prepended_text A string that will get prepended to each decode line.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
extern err_code_t osprey7_v2l8p1_decode_core_sts(srds_access_t *sa__, uint8_t bits, char *buf, size_t buf_size, const char * const prepended_text);
