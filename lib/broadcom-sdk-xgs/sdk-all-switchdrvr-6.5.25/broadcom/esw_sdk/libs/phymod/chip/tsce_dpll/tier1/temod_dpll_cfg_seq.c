...
int temod2pll_1588_ts_offset_get(PHYMOD_ST* pc, uint32_t *ts_offset)
{
    MAIN0_TS_TMR_OFFSr_t reg_ts_offset_ctrl;
    MAIN0_TS_TMR_OFFSr_CLR(reg_ts_offset_ctrl);
    ...
    /* set ts_offset */
    PHYMOD_IF_ERR_RETURN(READ_MAIN0_TS_TMR_OFFSr(pc, &reg_ts_offset_ctrl));
    *ts_offset = MAIN0_TS_TMR_OFFSr_U_TS_OFFSETf_GET(reg_ts_offset_ctrl);
...
int temod2pll_1588_rx_deskew_set(PHYMOD_ST* pc, phymod_timesync_compensation_mode_t timesync_am_norm_mode)
{
    ...
    /* To aviod coverity issue OVERRUN in info_adet/info_slip_cnt/... */
    if (num_lane > 4) {
...
int temod2pll_port_start_lane_get(PHYMOD_ST *pc,
    ...
    if (num_of_lane > 1) {
        ...
        *port_num_lane = num_of_lane;
        ...
        switch (port_mode_sel_reg) {
            case TEMOD2PLL_PORT_MODE_SINGLE:
                /*single mode*/
                *port_starting_lane = 0;
                *port_num_lane = 4;
                break;
            case TEMOD2PLL_PORT_MODE_DUAL:
                /*dual mode*/
                if (start_lane < 2) {
                    *port_starting_lane = 0;
                    *port_num_lane = 2;
                ...
                break;
            case TEMOD2PLL_PORT_MODE_TR1:
                /*tr1 mode, lane 2,3 aggregated  */
                if (start_lane < 2) {
                    *port_starting_lane = start_lane;
                    *port_num_lane = 1;
                } else {
                ...
                break;
            case TEMOD2PLL_PORT_MODE_TR2:
                /*tr2 mode, lane 0,1 aggregated  */
                if (start_lane < 2) {
                    *port_starting_lane = 0;
                    *port_num_lane = 2;
                } else {
