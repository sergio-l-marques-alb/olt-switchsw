...
**********************************************************************************
*                                                                                *
*  Revision    :  $Id: phy8806x_tsc_internal.h 1010 2015-04-15 22:02:27Z kirand $ *
*                                                                                *
...
/** @file phy8806x_tsc_internal.h
 * Internal API functions
 */

#ifndef PHY8806X_TSC_API_INTERNAL_H
#define PHY8806X_TSC_API_INTERNAL_H

#define SDK_STATIC static


#include "phy8806x_tsc_functions.h"
...
#include "phy8806x_tsc_debug_functions.h"
 ...
 * as part of phy8806x_tsc_display_core_state_line()
 * @param pa phymod_access_t struct
...
/*-----------------------------*/
/** Read current phy8806x_tsc core status.
 * @param pa phymod_access_t struct
 * @param *istate Current phy8806x_tsc core status read back and populated by the API
...
/*-----------------------------*/
/** Read current phy8806x_tsc lane status.
 * @param pa phymod_access_t struct
 * @param *istate Current phy8806x_tsc lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param pa phymod_access_t struct
 * @param *pll_lock Current phy8806x_tsc lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current phy8806x_tsc lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param pa phymod_access_t struct
 * @param *pmd_lock Current phy8806x_tsc lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current phy8806x_tsc lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param pa phymod_access_t struct
 * @param *sig_det Current phy8806x_tsc lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current phy8806x_tsc lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _phy8806x_tsc_get_osr_mode (const phymod_access_t *pa, phy8806x_tsc_osr_mode_st *mode);
 ...
 * Along with phy8806x_tsc_core_clkgate(), all lanes should also be clock gated using phy8806x_tsc_lane_clkgate() to complete a Core Clockgate
 * @param pa phymod_access_t struct
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in phy8806x_tsc_functions.c.
 *
 * @param pa phymod_access_t struct
 ...
 */
err_code_t phy8806x_tsc_poll_diag_eye_data (const phymod_access_t *pa, uint32_t *data, uint16_t *status, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_poll_diag_done (const phymod_access_t *pa, uint16_t *status, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_poll_uc_dsc_ready_for_cmd_equals_1 (const phymod_access_t *pa, uint32_t timeout_ms);
 ...
 * phy8806x_tsc_functions.c.
 * @param pa phymod_access_t struct
 * @param timeout_ms Maximum time interval in milliseconds for which the polling is done
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_poll_dsc_state_equals_uc_tune (const phymod_access_t *pa, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_poll_st_afe_tx_fifo_resetb_equals_1 (const phymod_access_t *pa, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_poll_micro_ra_initdone (const phymod_access_t *pa, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_poll_fctts_sn_to_trn_req (const phymod_access_t *pa, uint32_t timeout_ms);
