...
***********************************************************************************
*                                                                                 *
*  Revision    :  $Id: falcon_tsc_interface.h 1565 2017-08-18 23:22:09Z kirand $   *
*                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/falcon_tsc/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
...
/** Column definition header for falcon_tsc_display_core_state() API output.
 * To be called before falcon_tsc_display_core_state_line() API.
 * @param pa phymod_access_t struct
 ...
 * Call falcon_tsc_display_core_state_hdr() API before and falcon_tsc_display_core_state_legend() after
...
/** Detailed description of each column in falcon_tsc_display_core_state_line() API output.
 * To be called after falcon_tsc_display_core_state_line() API to display the legends.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * \n Note: Micro should be loaded only after issuing a falcon_tsc_uc_reset(1) followed by asserting and de-asserting
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [falcon_tsc_ucode_crc_verify()] and verifying the CRC value [falcon_tsc_start_ucode_crc_calc()].
 * @param pa phymod_access_t struct
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [falcon_tsc_ucode_crc_verify()] and verifying the CRC value [falcon_tsc_start_ucode_crc_calc()].
 * @param pa phymod_access_t struct
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_map_lanes (const phymod_access_t *pa, uint8_t num_lanes, uint8_t const *tx_lane_map, uint8_t const *rx_lane_map);
 ...
 * Note: falcon_tsc_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 * @param pa phymod_access_t struct
 ...
 * Note: User also needs to configure all lanes through falcon_tsc_lane_config_for_iddq()
 ...
 * Along with falcon_tsc_core_pwrdn(), all lanes powerdowns should also be issued using
 * falcon_tsc_lane_pwrdn() to complete a Core Powerdown.
 * @param pa phymod_access_t struct
 * @param mode based on enum #srds_core_pwrdn_mode_enum select from ON, CORE, DEEP power down modes
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_core_pwrdn (const phymod_access_t *pa, enum srds_core_pwrdn_mode_enum mode);
 ...
 * If using MDIO interface to access the registers, use this API to implement falcon_tsc_pmd_mwr_reg().
 * @param pa phymod_access_t struct
 ...
 */
err_code_t falcon_tsc_write_tx_afe (const phymod_access_t *pa, enum srds_tx_afe_settings_enum param, int8_t val);
 ...
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_read_tx_afe (const phymod_access_t *pa, enum srds_tx_afe_settings_enum param, int8_t *val);
 ...
 * It relies on the accuracy of falcon_tsc_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use falcon_tsc_read_eye_scan_stripe() function
 ...
 * \n Note: Call functions falcon_tsc_display_lane_state_hdr() before and falcon_tsc_display_lane_state_legend() after
 ...
 * This function is required to be implemented by upper level software to enable falcon_tsc support.
 * @param pa phymod_access_t struct
...
/** Parameterized diagnostic function which access to all falcon_tsc control and status bits
 * This function is required to be implemented by upper level software to enable falcon_tsc support.
 * @param pa phymod_access_t struct
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_configure_fast_link_recovery(const phymod_access_t *pa, uint8_t enable, uint8_t enable_timeout, enum falcon_tsc_flr_timeout_enum timeout_time, uint8_t enable_2ms_yield, uint8_t filter_count);
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the falcon_tsc_stop_rx_adaptation() API.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_write_rx_afe (const phymod_access_t *pa, enum srds_rx_afe_settings_enum param, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_read_rx_afe (const phymod_access_t *pa, enum srds_rx_afe_settings_enum param, int8_t *val);
 ...
 * Once the PRBS generator is configured, to enable PRBS use the falcon_tsc_tx_prbs_en() API.
 * @param pa phymod_access_t struct
 * @param prbs_poly_mode PRBS generator mode select (selects required PRBS polynomial)
 * @param prbs_inv PRBS invert enable
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_config_tx_prbs (const phymod_access_t *pa, enum srds_prbs_polynomial_enum prbs_poly_mode, uint8_t prbs_inv);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_get_tx_prbs_config (const phymod_access_t *pa, enum srds_prbs_polynomial_enum *prbs_poly_mode, uint8_t *prbs_inv);
 ...
 * Once the PRBS checker is configured, use the falcon_tsc_rx_prbs_en() API to enable the checker.
 * @param pa phymod_access_t struct
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_config_rx_prbs (const phymod_access_t *pa, enum srds_prbs_polynomial_enum prbs_poly_mode, enum srds_prbs_checker_mode_enum prbs_checker_mode, uint8_t prbs_inv);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_get_rx_prbs_config (const phymod_access_t *pa, enum srds_prbs_polynomial_enum *prbs_poly_mode, enum srds_prbs_checker_mode_enum *prbs_checker_mode, uint8_t *prbs_inv);
 ...
 * Note: User needs to configure all lanes through falcon_tsc_lane_config_for_iddq() and also call falcon_tsc_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_tsc_lane_pwrdn (const phymod_access_t *pa, enum srds_core_pwrdn_mode_enum mode);
