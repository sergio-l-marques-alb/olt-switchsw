...
__phymod_diagnostics__dispatch__t__ phymod_diagnostics_tsce16_diagnostics_driver = {
    ...
    tsce16_phy_fec_error_inject_set,
    tsce16_phy_fec_error_inject_get,
};
