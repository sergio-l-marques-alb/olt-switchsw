...
__phymod__dispatch__t__ phymod_tsce7_driver = {

    tsce7_core_identify,
    tsce7_core_info_get,
    tsce7_core_lane_map_set,
    tsce7_core_lane_map_get,
    NULL, /* phymod_core_reset_set */
    NULL, /* phymod_core_reset_get */
    NULL, /* phymod_core_firmware_info_get */
    tsce7_phy_firmware_core_config_set,
    tsce7_phy_firmware_core_config_get,
    tsce7_phy_firmware_lane_config_set,
    tsce7_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    tsce7_phy_polarity_set,
    tsce7_phy_polarity_get,
    tsce7_phy_tx_set,
    tsce7_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    merlin7_phy_media_type_tx_get,
    ...
    tsce7_phy_tx_lane_control_set,
    tsce7_phy_tx_lane_control_get,
    tsce7_phy_rx_lane_control_set,
    tsce7_phy_rx_lane_control_get,
    tsce7_phy_fec_enable_set,
    tsce7_phy_fec_enable_get,
    ...
    tsce7_phy_eee_set,
    tsce7_phy_eee_get,
    tsce7_phy_interface_config_set,
    tsce7_phy_interface_config_get,
    tsce7_phy_cl72_set,
    tsce7_phy_cl72_get,
    tsce7_phy_cl72_status_get,
    tsce7_phy_autoneg_ability_set,
    tsce7_phy_autoneg_ability_get,
    tsce7_phy_autoneg_remote_ability_get,
    tsce7_phy_autoneg_set,
    tsce7_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    NULL, /* phymod_phy_autoneg_status_get */
    tsce7_core_init,
    tsce7_phy_pll_multiplier_get,
    tsce7_phy_init,
    tsce7_phy_loopback_set,
    tsce7_phy_loopback_get,
    tsce7_phy_rx_pmd_locked_get,
    merlin7_phy_rx_pmd_lock_status_get,
    NULL, /* phymod_phy_local_fault_info_get */
    NULL, /* phymod_phy_rx_signal_detect_get */
    tsce7_phy_link_status_get,
    ...
    tsce7_phy_synce_clk_ctrl_set,
    tsce7_phy_synce_clk_ctrl_get,
    NULL, /* phymod_phy_pcs_enable_set */
    tsce7_phy_rx_ppm_get,
