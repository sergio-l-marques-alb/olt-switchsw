...
typedef enum {
    TEMOD2PLL_PORT_MODE_QUAD  = 0,    /* quad port mode.  */
    TEMOD2PLL_PORT_MODE_TR1,          /* lanes 2,3 aggregated   */
    TEMOD2PLL_PORT_MODE_TR2,          /* lanes 1,0 aggregated   */
    TEMOD2PLL_PORT_MODE_DUAL,         /* dual port mode.  */
    TEMOD2PLL_PORT_MODE_SINGLE,       /* single port mode. */
    TEMOD2PLL_PORT_MODE_COUNT
} temod2pll_port_mode_type;
...
extern int temod2pll_1588_ts_offset_get(PHYMOD_ST* pc, uint32_t *ts_offset);
...
extern int temod2pll_fec_error_inject_get(PHYMOD_ST *pc,
                                          uint16_t* error_control_map,
                                          temod2pll_fec_error_mask_t* bit_error_mask);
extern int temod2pll_port_start_lane_get(PHYMOD_ST *pc,
