...
err_code_t osprey7_v2l8p1_get_force_lane_cdr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_force_cdr_mode_enum *mode) {
    ...
    if(os_mode && br_mode) {
        return osprey7_v2l8p1_error(sa__, ERR_CODE_INVALID_MODE);
    }

    if(os_mode) {
        *mode = OSPREY7_V2L8P1_OSCDR_FORCE_ENABLE;
    }
    else if(br_mode) {
        *mode = OSPREY7_V2L8P1_BRCDR_FORCE_ENABLE;
    }
    else {
        *mode = OSPREY7_V2L8P1_CDR_FORCE_DISABLE;
    }
    return ERR_CODE_NONE;
}
...
err_code_t osprey7_v2l8p1_force_lane_cdr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_force_cdr_mode_enum mode) {
    ...
    switch(mode) {
        case OSPREY7_V2L8P1_OSCDR_FORCE_ENABLE:
            ESTM(misc_ctrl = rdv_usr_misc_ctrl_word());
            EFUN(wrv_usr_misc_ctrl_word(misc_ctrl | (0x1 << SRDS_FORCE_OSCDR_BIT))); /*  (force_os_on) */
            EFUN(osprey7_v2l8p1_force_lane_cdr_mode(sa__, OSPREY7_V2L8P1_BRCDR_FORCE_DISABLE));
            break;
        case OSPREY7_V2L8P1_OSCDR_FORCE_DISABLE:
            ESTM(misc_ctrl = rdv_usr_misc_ctrl_word());
            EFUN(wrv_usr_misc_ctrl_word(misc_ctrl & (uint16_t)~(0x1 << SRDS_FORCE_OSCDR_BIT)));
            break;
        case OSPREY7_V2L8P1_BRCDR_FORCE_ENABLE:
            EFUN(wr_lane_uc_config_force_brdfe_en(0x1));
            EFUN(osprey7_v2l8p1_force_lane_cdr_mode(sa__, OSPREY7_V2L8P1_OSCDR_FORCE_DISABLE));
            break;
        case OSPREY7_V2L8P1_BRCDR_FORCE_DISABLE:
            EFUN(wr_lane_uc_config_force_brdfe_en(0x0));
            break;
        case OSPREY7_V2L8P1_CDR_FORCE_DISABLE:
            EFUN(osprey7_v2l8p1_force_lane_cdr_mode(sa__, OSPREY7_V2L8P1_OSCDR_FORCE_DISABLE));
            EFUN(osprey7_v2l8p1_force_lane_cdr_mode(sa__, OSPREY7_V2L8P1_BRCDR_FORCE_DISABLE));
            break;
        default:
...
err_code_t osprey7_v2l8p1_set_use_osr_mode_pins_only(srds_access_t *sa__, uint8_t use_pins_only) {
    ...
    EFUN(osprey7_v2l8p1_set_use_tx_osr_mode_pins_only(sa__, use_pins_only));
    EFUN(osprey7_v2l8p1_set_use_rx_osr_mode_pins_only(sa__, use_pins_only));
...
err_code_t osprey7_v2l8p1_get_use_osr_mode_pins_only(srds_access_t *sa__, uint8_t *tx_use_pins_only, uint8_t *rx_use_pins_only) {
    ...
    EFUN(osprey7_v2l8p1_get_use_tx_osr_mode_pins_only(sa__, tx_use_pins_only));
    EFUN(osprey7_v2l8p1_get_use_rx_osr_mode_pins_only(sa__, rx_use_pins_only));
...
err_code_t osprey7_v2l8p1_set_use_rx_osr_mode_pins_only(srds_access_t *sa__, uint8_t rx_use_pins_only) {
    ...
    EFUN(wrv_usr_rx_osr_ctrl_byte((uint8_t)((rx_use_pins_only << 7) | OSPREY7_V2L8P1_OSR_UNINITIALIZED)));
...
err_code_t osprey7_v2l8p1_set_use_tx_osr_mode_pins_only(srds_access_t *sa__, uint8_t tx_use_pins_only) {
    ...
    EFUN(wrv_usr_tx_osr_ctrl_byte((uint8_t)((tx_use_pins_only << 7) | OSPREY7_V2L8P1_OSR_UNINITIALIZED)));
...
err_code_t osprey7_v2l8p1_set_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum osr_mode) {
    ...
    EFUN(osprey7_v2l8p1_set_tx_osr_mode(sa__, osr_mode));
    EFUN(osprey7_v2l8p1_set_rx_osr_mode(sa__, osr_mode));
...
err_code_t osprey7_v2l8p1_get_rx_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum *rx_osr_mode) {
    ...
    ESTM(*rx_osr_mode = (enum osprey7_v2l8p1_osr_mode_enum)(rdv_usr_rx_osr_ctrl_byte() & 0x3F));
...
err_code_t osprey7_v2l8p1_get_tx_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum *tx_osr_mode) {
    ...
    ESTM(*tx_osr_mode = (enum osprey7_v2l8p1_osr_mode_enum)(rdv_usr_tx_osr_ctrl_byte() & 0x3F));
    return(ERR_CODE_NONE);
}
...
err_code_t osprey7_v2l8p1_write_rx_afe(srds_access_t *sa__, enum srds_rx_afe_settings_enum param, int8_t val) {
  /* Assumes the micro is not actively tuning */
    ...
    case RX_AFE_FGA:
      return(osprey7_v2l8p1_INTERNAL_set_rx_fga(sa__, (uint8_t)val));
...
err_code_t osprey7_v2l8p1_read_rx_afe(srds_access_t *sa__, enum srds_rx_afe_settings_enum param, int8_t *val) {
    ...
    case RX_AFE_VGA:
      ...
      break;
    case RX_AFE_FGA:
        EFUN(osprey7_v2l8p1_INTERNAL_get_rx_fga(sa__, &rd_val));
        *val = (int8_t)rd_val;
      break;
    case RX_AFE_DFE1:
...
err_code_t osprey7_v2l8p1_apply_txfir_cfg(srds_access_t *sa__, enum osprey7_v2l8p1_txfir_tap_enable_enum enable_taps, int16_t pre3, int16_t pre2, int16_t pre1, int16_t main, int16_t post1, int16_t post2) {
    ...
    osprey7_v2l8p1_txfir_st txfir;
#if !defined(SMALL_FOOTPRINT) 
    struct osprey7_v2l8p1_event_st api_event;
#endif
    ...
    EFUN(osprey7_v2l8p1_log_api_event(sa__, api_event));
#endif
...
err_code_t osprey7_v2l8p1_core_reset(srds_access_t *sa__, ucode_info_t ucode_info) {
    INIT_SRDS_ERR_CODE
    uint8_t i, num_lanes;
    uint8_t orig_pll = osprey7_v2l8p1_acc_get_pll_idx(sa__);
    uint8_t orig_lane = osprey7_v2l8p1_acc_get_lane(sa__);
    uint8_t ams_tx_version_id;
    ESTM(ams_tx_version_id = rd_ams_tx_version_id());
    ...
    for(i = 0; i < num_lanes; i++) {
        EFUN(osprey7_v2l8p1_acc_set_lane(sa__, i));
        EFUN(osprey7_v2l8p1_ln_dp_reset(sa__, 1));
    }
    EFUN(USR_DELAY_US(1));
    for (i = 0; i < NUM_PLLS; i++) {
        EFUN(osprey7_v2l8p1_acc_set_pll_idx(sa__, i));
    ...
    EFUN(osprey7_v2l8p1_acc_set_lane(sa__, orig_lane));
    EFUN(osprey7_v2l8p1_acc_set_pll_idx(sa__, orig_pll));
    return (ERR_CODE_NONE);
}
...
err_code_t osprey7_v2l8p1_init_osprey7_v2l8p1_info(srds_access_t *sa__) {
    ...
    osprey7_v2l8p1_info_ptr->signature = SRDS_INFO_SIGNATURE;
    osprey7_v2l8p1_info_ptr->info_table_version = info_table_version;
    {
        uint8_t afe_version;
        ESTM(afe_version = rd_ams_tx_version_id());
        osprey7_v2l8p1_info_ptr->silicon_version = afe_version;
    }
#ifdef PHYMOD_SUPPORT
    }
#endif
...
err_code_t osprey7_v2l8p1_configure_53P125G_pll_refclk(srds_access_t *sa__,
                                        enum osprey7_v2l8p1_pll_refclk_enum refclk) {
    return osprey7_v2l8p1_INTERNAL_configure_53P125_pll(sa__, refclk, OSPREY7_V2L8P1_PLL_DIV_UNKNOWN, OSPREY7_V2L8P1_PLL_OPTION_NONE);
}

err_code_t osprey7_v2l8p1_configure_53P125G_pll_div(srds_access_t *sa__,
                                        enum osprey7_v2l8p1_pll_div_enum srds_div) {
    return osprey7_v2l8p1_INTERNAL_configure_53P125_pll(sa__, OSPREY7_V2L8P1_PLL_REFCLK_UNKNOWN, srds_div, OSPREY7_V2L8P1_PLL_OPTION_NONE);
}

err_code_t osprey7_v2l8p1_configure_53P125G_lb_pll_refclk(srds_access_t *sa__,
                                        enum osprey7_v2l8p1_pll_refclk_enum refclk) {
    return osprey7_v2l8p1_INTERNAL_configure_lb_53P125_pll(sa__, refclk, OSPREY7_V2L8P1_PLL_DIV_UNKNOWN, OSPREY7_V2L8P1_PLL_OPTION_NONE);
}

err_code_t osprey7_v2l8p1_configure_53P125G_lb_pll_div(srds_access_t *sa__,
                                        enum osprey7_v2l8p1_pll_div_enum srds_div) {
    return osprey7_v2l8p1_INTERNAL_configure_lb_53P125_pll(sa__, OSPREY7_V2L8P1_PLL_REFCLK_UNKNOWN, srds_div, OSPREY7_V2L8P1_PLL_OPTION_NONE);
}

err_code_t osprey7_v2l8p1_configure_53P125G_hb_pll_div(srds_access_t *sa__,
                                        enum osprey7_v2l8p1_pll_div_enum srds_div) {
    return osprey7_v2l8p1_INTERNAL_force_hb_53P125_pll(sa__);
}
...
err_code_t osprey7_v2l8p1_pll_lb_range_check(srds_access_t *sa__, uint8_t *pll_out_range) {
    ...
    return osprey7_v2l8p1_INTERNAL_pll_lb_range_check(sa__, pll_out_range);
}
...
err_code_t osprey7_v2l8p1_pll_hb_range_check(srds_access_t *sa__, uint8_t *pll_out_range) {
    ...
    return osprey7_v2l8p1_INTERNAL_pll_hb_range_check(sa__, pll_out_range);
}
