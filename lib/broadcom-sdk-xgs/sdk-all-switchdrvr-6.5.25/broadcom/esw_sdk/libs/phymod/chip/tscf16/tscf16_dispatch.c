...
__phymod__dispatch__t__ phymod_tscf16_driver = {
    ...
    tscf16_phy_tx_set,
    tscf16_phy_tx_get,
    tscf16_phy_training_tx_fir_post_set,
    tscf16_phy_training_tx_fir_post_get,
    ...
    tscf16_phy_fec_override_set,
    tscf16_phy_fec_override_get,
    ...
    tscf16_phy_rx_signal_detect_get,
    ...
    tscf16_phy_eye_margin_est_get,
    NULL, /* phymod_phy_multi_get */
    tscf16_phy_rescal_set,
    tscf16_phy_rescal_get,
    tscf16_phy_sw_an_control_status_get,
    tscf16_phy_sw_an_base_page_exchange_handler,
    tscf16_phy_sw_an_lp_page_rdy_handler,
    tscf16_phy_sw_an_advert_set,
    tscf16_phy_sw_autoneg_enable,
    ...
    tscf16_phy_synce_clk_ctrl_set,
    tscf16_phy_synce_clk_ctrl_get,
    NULL, /* phymod_phy_pcs_enable_set */
    tscf16_phy_rx_ppm_get,
    ...
    tscf16_phy_fec_bypass_indication_set,
    tscf16_phy_fec_bypass_indication_get,
