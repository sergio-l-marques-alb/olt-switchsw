...
int blackhawk_phy_tx_pattern_set(const phymod_phy_access_t* phy, phymod_phy_tx_pattern_t tx_pattern)
{
    phymod_phy_access_t phy_copy;
    ...
    switch (tx_pattern) {
        case phymodPhyTxPatternOff:
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_jp03b_pattern(&phy_copy.access, 0));
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_linearity_pattern(&phy_copy.access, 0));
            break;
        case phymodPhyTxPatternPAM4_JP03B:
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_linearity_pattern(&phy_copy.access, 0));
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_jp03b_pattern(&phy_copy.access, 1));
            break;
        case phymodPhyTxPatternPAM4_Linear:
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_jp03b_pattern(&phy_copy.access, 0));
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_linearity_pattern(&phy_copy.access, 1));
            break;
        case phymodPhyTxPatternCustom:
            custom_pattern.pattern = pattern_word;
            PHYMOD_IF_ERR_RETURN
                (blackhawk_phy_pattern_config_get(&phy_copy, &custom_pattern));
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_jp03b_pattern(&phy_copy.access, 0));
            PHYMOD_IF_ERR_RETURN
                (blackhawk_tsc_config_tx_linearity_pattern(&phy_copy.access, 0));
            PHYMOD_IF_ERR_RETURN
                (blackhawk_phy_pattern_enable_set(&phy_copy, 1, &custom_pattern));
            break;
        default:
...
int blackhawk_phy_tx_pattern_get(const phymod_phy_access_t* phy, phymod_phy_tx_pattern_t* tx_pattern)
{
    phymod_phy_access_t phy_copy;
    ...
    PHYMOD_MEMCPY(&phy_copy, phy, sizeof(phy_copy));
    PHYMOD_IF_ERR_RETURN
        (blackhawk_tsc_pam4_tx_pattern_enable_get(&phy_copy.access,
    ...
    PHYMOD_IF_ERR_RETURN
        (blackhawk_tsc_pam4_tx_pattern_enable_get(&phy_copy.access,
                                                    ...
                                                    &linear_enable));
    PHYMOD_IF_ERR_RETURN
        (blackhawk_tsc_tx_shared_patt_gen_en_get(&phy_copy.access,
                                                   &pattern_gen_enable));
    /*
...
{
    struct blackhawk_tsc_ber_data_st ber_data_local;
    int start_lane, num_lane;
    phymod_phy_access_t phy_copy;
...
int blackhawk_phy_linkcat(const phymod_phy_access_t* phy,
