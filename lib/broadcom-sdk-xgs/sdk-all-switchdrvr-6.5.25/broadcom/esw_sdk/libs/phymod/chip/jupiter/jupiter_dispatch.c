...
__phymod__dispatch__t__ phymod_jupiter_driver = {

    jupiter_core_identify,
    jupiter_core_info_get,
    jupiter_core_lane_map_set,
    jupiter_core_lane_map_get,
    jupiter_core_reset_set,
    jupiter_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    jupiter_phy_firmware_lane_config_set,
    jupiter_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    jupiter_phy_rx_restart,
    jupiter_phy_polarity_set,
    jupiter_phy_polarity_get,
    jupiter_phy_tx_set,
    jupiter_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    NULL, /* phymod_phy_media_type_tx_get */
    jupiter_phy_tx_override_set,
    jupiter_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    jupiter_phy_rx_set,
    jupiter_phy_rx_get,
    jupiter_phy_rx_adaptation_resume,
    ...
    jupiter_phy_tx_lane_control_set,
    jupiter_phy_tx_lane_control_get,
    jupiter_phy_rx_lane_control_set,
    jupiter_phy_rx_lane_control_get,
    ...
    jupiter_phy_cl72_set,
    jupiter_phy_cl72_get,
    jupiter_phy_cl72_status_get,
    ...
    jupiter_core_init,
    jupiter_phy_pll_multiplier_get,
    jupiter_phy_init,
    jupiter_phy_loopback_set,
    jupiter_phy_loopback_get,
    jupiter_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_pmd_lock_status_get */
    NULL, /* phymod_phy_local_fault_info_get */
    jupiter_phy_rx_signal_detect_get,
    ...
    jupiter_phy_reg_read,
    jupiter_phy_reg_write,
    ...
    jupiter_phy_eye_margin_est_get,
    ...
    jupiter_phy_rx_ppm_get,
    jupiter_phy_channel_loss_hint_set,
    jupiter_phy_channel_loss_hint_get,
    ...
    jupiter_phy_pmd_info_init,
    jupiter_phy_pll_powerdown_get,
