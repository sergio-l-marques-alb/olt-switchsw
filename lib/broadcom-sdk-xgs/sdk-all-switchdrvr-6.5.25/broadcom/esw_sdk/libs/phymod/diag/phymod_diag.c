...
#include <phymod/chip/bcmi_blackhawk7_v1l8p1_xgxs_sym.h>
#endif
#ifdef PHYMOD_TSCO_DPLL_SUPPORT
#include <phymod/chip/bcmi_tsco_dpll_xgxs_sym.h>
#endif /*PHYMOD_TSCO_DPLL_SUPPORT*/
#ifdef PHYMOD_TSCJ_SUPPORT
#include <phymod/chip/bcmi_tscj_xgxs_sym.h>
#endif /*PHYMOD_TSCJ_SUPPORT*/
#ifdef PHYMOD_TSCBH_FE_GEN2_SUPPORT
#include <phymod/chip/bcmi_tscbh_fe_gen2_xgxs_sym.h>
#endif /*PHYMOD_TSCBH_FE_GEN2_SUPPORT*/
...
int phymod_diag_symbols_table_get(phymod_phy_access_t *phy, phymod_symbols_t **symbols)
{
    ...
    case phymodDispatchTypeTsco_dpll:
        *symbols = &bcmi_tsco_dpll_xgxs_symbols;
        break;
#endif /*PHYMOD_TSCO_DPLL_SUPPORT  */
#ifdef PHYMOD_TSCJ_SUPPORT
    case phymodDispatchTypeTscj:
        *symbols = &bcmi_tscj_xgxs_symbols;
        break;
#endif /*PHYMOD_TSCJ_SUPPORT  */
#ifdef PHYMOD_TSCBH_FE_GEN2_SUPPORT
    case phymodDispatchTypeTscbh_fe_gen2:
        *symbols = &bcmi_tscbh_fe_gen2_xgxs_symbols;
        break;
#endif /*PHYMOD_TSCBH_FE_GEN2_SUPPORT  */
    default:
    ...
    )   
{
    ...
    for (idx = 0; idx < num_phys; idx++) {
        ...
        if(eyescan_options && line_rates) {
            eyescan_options->linerate_in_khz = line_rates[idx] * 1000;
