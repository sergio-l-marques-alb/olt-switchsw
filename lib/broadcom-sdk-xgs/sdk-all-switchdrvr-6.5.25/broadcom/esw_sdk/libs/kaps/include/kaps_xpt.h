...
{
    uint32_t match_flag; /**< Indicates whether hit or miss */
    uint8_t ad_value[KAPS_MAX_AD_WIDTH_8];  /**< The associated data value of the matching entry*/
    uint32_t match_len; /**< Length of the best match */
    uint32_t ad_width_1; /**< Width of the AD in bits */
    uint32_t is_bdata; /**< Indicates if the match was obtained from BDATA*/
};
