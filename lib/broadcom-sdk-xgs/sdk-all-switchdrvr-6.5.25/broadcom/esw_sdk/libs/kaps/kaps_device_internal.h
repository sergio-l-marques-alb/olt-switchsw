...
#include "kaps_internal_errors.h"
...
/**
  * @brief Format Number of the TCAM Entry indicating the layout of the TCAM bits
  */
enum kaps_tcam_format 
    {
        KAPS_TCAM_FORMAT_1,
        KAPS_TCAM_FORMAT_2,
        KAPS_TCAM_FORMAT_3
...
/**
 * @brief Transport Layer version 
 */
enum kaps_xpt_version
{
    KAPS_XPT_VERSION_1,
    KAPS_XPT_VERSION_2
};
...
typedef struct kaps_prefix_log_record_t
{
    uint8_t operation;
    uint8_t db_id;
    uint8_t pfx_len;
    uint8_t pfx_data[20];
    uint8_t pfx_ad[KAPS_MAX_AD_WIDTH_8];
} kaps_prefix_log_record;
 ...
 */
    struct kaps_device
    {
        ...
        struct kaps_shadow_device *kaps_shadow; /**< Kaps specific shadow device */
        ...
        struct kaps_xpt *xpt;                          /**< Pointer to the transport layer (FPGA, simxpt or blackhole) */
        ...
        enum kaps_xpt_version xpt_version;  /**< XPT version*/
        ...
        uint16_t num_ab[KAPS_HW_MAX_NUM_DB_GROUPS]; /**< Number of ABs  for each DB group */
        ...
        enum kaps_tcam_format tcam_format;
        ...
        kaps_prefix_log_record *pfx_log_records;
