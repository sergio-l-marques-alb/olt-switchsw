...
#define KAPS_STRICT_LMPSOFAR_INDEX        ((uint32_t) 0x1FFFFFFF)
...
extern kaps_pfx_bundle *kaps_pfx_bundle_create(
    kaps_nlm_allocator *alloc,       /* What factory does this bundle belong to? */
...
extern void kaps_pfx_bundle_destroy(
