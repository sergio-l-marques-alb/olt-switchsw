    ...
    *db_destroy) (
    ...
    struct kaps_db_common_info
    {
        ...
        int32_t uda_mb;               /**< Mb of UDA used for AD/alg node of databases,
                                           for printing only */
        int32_t total_bb_size_in_bits;/**< Size in bits of all the the BBs allocated to the database*/
 ...
 */
    ...
    struct kaps_db
    {
        ...
        uint32_t rpb_id;              /**< The Root Pivot Block number mapped to this database*/
        uint32_t db_group_id;         /**< Which group the database belongs to*/
