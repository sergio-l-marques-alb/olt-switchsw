...
#define KAPS_MAX_NUM_PFX_IN_BUFFER (4 * 1024)
...
typedef struct kaps_ipt_brick_scratchpad
{
    ...
    uint32_t m_prefixLens[KAPS_HW_MAX_LPUS_PER_LPM_DB * KAPS_MAX_PFX_PER_BKT_ARRAY_SIZE];
    uint32_t m_numPfx;
...
typedef struct kaps_trie_global
{
    ...
    kaps_pfx_bundle *m_tempBrickArray[KAPS_MAX_NUM_PFX_IN_BUFFER];
    kaps_pfx_bundle *m_bricksPfxBuffer[KAPS_MAX_NUM_PFX_IN_BUFFER];
    kaps_rpm *m_rpm_p;
    ...
    uint32_t m_pfxLocationsToClear[KAPS_MAX_TMAX_VAL];
