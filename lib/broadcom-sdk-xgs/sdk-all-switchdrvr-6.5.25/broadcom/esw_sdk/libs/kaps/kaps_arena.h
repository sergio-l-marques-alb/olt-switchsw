...
#ifndef INCLUDED_KAPS_ARENA_H
#define INCLUDED_KAPS_ARENA_H
...
*/
NlmErrNum_t kaps_arena_activate_arena(
    kaps_nlm_allocator * alloc_p,
    NlmReasonCode * o_reason_p);
...
*/
NlmErrNum_t kaps_arena_deactivate_arena(
    kaps_nlm_allocator * alloc_p);

/*
Allocate space from the Arena memory if the Arena is active
*/
void *kaps_arena_allocate(
    kaps_nlm_allocator * alloc_p,
    uint32_t size);
...
*/
int32_t kaps_arena_free_if_arena_memory(
    kaps_nlm_allocator * alloc_p,
    void *ptr);
