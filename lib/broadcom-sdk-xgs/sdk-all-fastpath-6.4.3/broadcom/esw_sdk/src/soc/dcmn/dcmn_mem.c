  ...
  )
{
    ...
    if (SOC_DPP_CONFIG(unit)->emulation_system && (mem_size > 256) && soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "no_backdoor", 0) != 1) {  
        int array_mem_idx;
        ...
        /* No exception */
        if (exception_idx == nof_exceptions) {
