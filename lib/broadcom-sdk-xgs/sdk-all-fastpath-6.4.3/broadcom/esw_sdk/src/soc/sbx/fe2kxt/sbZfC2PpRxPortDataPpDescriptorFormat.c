...
sbZfC2PpRxPortDataPpDescriptorFormat_Unpack(sbZfC2PpRxPortDataPpDescriptorFormat_t *pToStruct,
  ...
  (pToStruct)->m_uRxPortMask_57_50 =  (uint32)  ((pFromData)[14] >> 2) & 0x3f;
  (pToStruct)->m_uRxPortMask_57_50 |=  (uint32)  ((pFromData)[15] & 0x03) << 6;

  /* Unpack Member: m_uRxPortMask_49_32 */
  (pToStruct)->m_uRxPortMask_49_32 =  (uint32)  (pFromData)[12] ;
  (pToStruct)->m_uRxPortMask_49_32 |=  (uint32)  (pFromData)[13] << 8;
  (pToStruct)->m_uRxPortMask_49_32 |=  (uint32)  ((pFromData)[14] & 0x03) << 16;

  /* Unpack Member: m_uRxPortMask_31_0 */
  (pToStruct)->m_uRxPortMask_31_0 =  (uint32)  (pFromData)[8] ;
  (pToStruct)->m_uRxPortMask_31_0 |=  (uint32)  (pFromData)[9] << 8;
  (pToStruct)->m_uRxPortMask_31_0 |=  (uint32)  (pFromData)[10] << 16;
  (pToStruct)->m_uRxPortMask_31_0 |=  (uint32)  (pFromData)[11] << 24;

  /* Unpack Member: m_uPad */
  (pToStruct)->m_uPad =  (uint32)  ((pFromData)[7] >> 2) & 0x3f;

  /* Unpack Member: m_uRxPortData_57_50 */
  (pToStruct)->m_uRxPortData_57_50 =  (uint32)  ((pFromData)[6] >> 2) & 0x3f;
  (pToStruct)->m_uRxPortData_57_50 |=  (uint32)  ((pFromData)[7] & 0x03) << 6;

  /* Unpack Member: m_uRxPortData_49_32 */
  (pToStruct)->m_uRxPortData_49_32 =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uRxPortData_49_32 |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->m_uRxPortData_49_32 |=  (uint32)  ((pFromData)[6] & 0x03) << 16;

  /* Unpack Member: m_uRxPortData_31_0 */
  (pToStruct)->m_uRxPortData_31_0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uRxPortData_31_0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uRxPortData_31_0 |=  (uint32)  (pFromData)[2] << 16;
  (pToStruct)->m_uRxPortData_31_0 |=  (uint32)  (pFromData)[3] << 24;
