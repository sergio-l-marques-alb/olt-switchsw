...
sbZfC2PrPortStateEntry_Print(sbZfC2PrPortStateEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrPortStateEntry:: reserve=0x%02x"), (unsigned int)  pFromStruct->m_nReserved));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrPortStateEntry:: npages=0x%02x"), (unsigned int)  pFromStruct->m_nNumPages));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrPortStateEntry:: drop=0x%01x"), (unsigned int)  pFromStruct->m_bDropPkt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2PrPortStateEntry_SPrint(sbZfC2PrPortStateEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
