...
sbZfC2PrTagInfo_Print(sbZfC2PrTagInfo_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrTagInfo:: active=0x%01x"), (unsigned int)  pFromStruct->m_bActive));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrTagInfo:: lines=0x%01x"), (unsigned int)  pFromStruct->m_nLineCount));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2PrTagInfo_SPrint(sbZfC2PrTagInfo_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
