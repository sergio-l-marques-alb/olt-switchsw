...
static void create_program_pvv2e(int unit, soc_sbx_g3p1_tmu_table_manager_t *tm) {   
      ...
      table_desc = &(tm->tables[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID]);
...
int soc_sbx_g3p1_pvv2e_index_check(int unit, uint32 *vindex, int ivrf, int iport, int iovid, int iivid )
{
...
int soc_sbx_g3p1_pvv2e_table_size_get(int unit)
{
    int s, num_entries;
    soc_sbx_g3p1_state_t *fe =
        (soc_sbx_g3p1_state_t *) SOC_SBX_CONTROL(unit)->drv;
    soc_sbx_g3p1_tmu_table_manager_t *tm = fe->tmu_mgr;
    soc_sbx_g3p1_tmu_table_desc_t *td = &tm->tables[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID];
...
int soc_sbx_g3p1_pvv2e_table_size_set(int unit, int size)
{
    int s, num_entries;
    soc_sbx_g3p1_state_t *fe =
        (soc_sbx_g3p1_state_t *) SOC_SBX_CONTROL(unit)->drv;
...
static int soc_sbx_g3p1_pvv2e_index_unpack(int unit, int *vindex, int *nivrf, int *niport, int *niovid, int *niivid)
{
...
int soc_sbx_g3p1_pvv2e_first(int unit, int *nivrf, int *niport, int *niovid, int *niivid, int *ninetmask_num_bits)
{
    int rv;
    uint32 key[32];
    uint32 key_length;
    ...
    *ninetmask_num_bits = key_length - 16;
    return soc_sbx_g3p1_pvv2e_index_unpack(unit, (int *)key,nivrf, niport, niovid, niivid);
}

/* get next entry for pvv2e */
int soc_sbx_g3p1_pvv2e_next(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits, int *nivrf, int *niport, int *niovid, int *niivid, int *ninetmask_num_bits)
{
    int rv;
    uint32 key[32];
    uint32 next_key[32];
    ...
    rv = soc_sbx_g3p1_pvv2e_index_check(unit, key, ivrf, iport, iovid, iivid);
    if (rv) {
        return rv;
    }
    ...
    *ninetmask_num_bits = key_length - 16;
    return soc_sbx_g3p1_pvv2e_index_unpack(unit, (int *)next_key, nivrf, niport, niovid, niivid);
}

/* entry set accessor implementation for pvv2e */
int soc_sbx_g3p1_pvv2e_set(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits, soc_sbx_g3p1_pvv2e_t *e)
{
    int s;
    uint32 key[32];
    ...
    s = soc_sbx_g3p1_pvv2e_index_check(unit, key, ivrf, iport, iovid, iivid);
    if (s) {
        return s;
    }
    ...
    if (SAL_BOOT_BCMSIM) {
       return soc_sbx_g3p1_pvv2e_add_ext_sim(unit, ivrf, iport, iovid, iivid, e);   
    }
...
int soc_sbx_g3p1_pvv2e_get(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits, soc_sbx_g3p1_pvv2e_t *e)
{
    int s;
    uint32 key[32];   
    uint32 epacked[BITS2WORDS(SOC_SBX_TMU_DM_494b_SIZE)];     
    ...
    if (SAL_BOOT_BCMSIM) {
        return soc_sbx_g3p1_pvv2e_get_ext_sim(unit, ivrf, iport, iovid, iivid,  e);
    }
...
int soc_sbx_g3p1_pvv2e_lpm_raw_get(int unit, int ivrf, int iport, int iovid, int iivid, int *nivrf, int *niport, int *niovid, int *niivid, int *onetmask_num_bits, unsigned char *obuf, int *osize)
{
    int s;
    ...
    s = soc_sbx_g3p1_pvv2e_index_unpack(unit, (int *)key, nivrf, niport, niovid, niivid);
    if (s) {
        return s;
    } 
...
int soc_sbx_g3p1_pvv2e_lpm_get(int unit, int ivrf, int iport, int iovid, int iivid, int *nivrf, int *niport, int *niovid, int *niivid, int *onetmask_num_bits, soc_sbx_g3p1_pvv2e_t *e)
{
    int s;
    uint32 epacked[BITS2WORDS(SOC_SBX_TMU_DM_494b_SIZE)];
    int size = 0;
    s = soc_sbx_g3p1_pvv2e_lpm_raw_get(unit, ivrf, iport, iovid, iivid, nivrf, niport, niovid, niivid, onetmask_num_bits, (unsigned char *)epacked, (int *)size);
    if (s) {
        return s;
    }
    
    s = soc_sbx_g3p1_pvv2e_unpack(unit, e, (unsigned char *)epacked, size);
    
    return s; 
}

int soc_sbx_g3p1_pvv2e_delete(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits) 
{
    int s;
    uint32 key[32];   
    uint32 epacked[BITS2WORDS(SOC_SBX_TMU_DM_494b_SIZE)];   
    ...
    if (SAL_BOOT_BCMSIM) {
        return soc_sbx_g3p1_pvv2e_delete_ext_sim(unit, ivrf, iport, iovid, iivid);
    }
...
int soc_sbx_g3p1_pvv2e_remove(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits)
{
    return soc_sbx_g3p1_pvv2e_delete(unit, ivrf, iport, iovid, iivid, inetmask_num_bits);
}

/* 
 * Raw entry set accessor implementation for pvv2e
 */
int soc_sbx_g3p1_pvv2e_raw_set(int unit, uint32 * key, int key_length, uint32 *payload)
{
    int s;
    taps_arg_t arg;
    soc_sbx_g3p1_state_t *fe =
...
*/
int soc_sbx_g3p1_pvv2e_data_set(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits, unsigned char *buf, unsigned char size)
{
    int s;
    ...
    s = soc_sbx_g3p1_pvv2e_set(unit, ivrf, iport, iovid, iivid, inetmask_num_bits, &entry);
...
*/
int soc_sbx_g3p1_pvv2e_data_get(int unit, int ivrf, int iport, int iovid, int iivid, int inetmask_num_bits, unsigned char *buf, unsigned char size)
{
    int s;
    soc_sbx_g3p1_pvv2e_t entry;

    soc_sbx_g3p1_pvv2e_t_init(&entry);
    s = soc_sbx_g3p1_pvv2e_get(unit, ivrf, iport, iovid, iivid, inetmask_num_bits, &entry);
    if (s) {
        return s;
    }
...
static int create_table_pvv2e(int unit, soc_sbx_g3p1_tmu_table_manager_t *tm) {
    ...
    tm->tables[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].type = SOC_SBX_G3P1_TMU_TAPS_TABLE_TYPE;
    ...
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].nindexes = 4 + 1;
    ...
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[0].name = "vpws";


    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[1].name = "stpstate";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[2].name = "vlan";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[3].name = "lpi";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[4].name = "hit";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[5].name = "keeporstrip";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[6].name = "replace";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[7].name = "vid";
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].fields[8].name = "vidop";
    ...
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].indexes[0].name = "vrf"; 
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].indexes[1].name = "port"; 
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].indexes[2].name = "ovid"; 
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].indexes[3].name = "ivid"; 
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].indexes[4].name = "netmask"; 
        
    for (j = 0; j < tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].nindexes - 1; j++) {
        rv = soc_sbx_g3p1_ucode_get(unit,
                        soc_sbx_g3p1_sym,
                        128,
    ...
    tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].indexes[j].range = 256;
