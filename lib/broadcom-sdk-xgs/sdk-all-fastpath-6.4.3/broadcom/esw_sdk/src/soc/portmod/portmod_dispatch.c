...
int portmod_txdrv_inxs_t_validate(int unit, portmod_txdrv_inxs_t portmod_txdrv_inxs)
{
    ...
    SOC_INIT_FUNC_DEFS;
    if(portmod_txdrv_inxs >= portmod_TXDRV_Count) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
int portmod_port_config_t_init(int unit, portmod_port_config_t* portmod_port_config)
{
    ...
    if(portmod_port_config == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_port_config NULL parameter"));
    }
...
int portmod_port_phy_reg_read(int unit, int port, int flags, int* value)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_reg_read) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_reg_read(unit, port, pm_info, flags, value);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_phy_reg_write(int unit, int port, int flags, int value)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_reg_write) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_reg_write(unit, port, pm_info, flags, value);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_adv_local_set(int unit, int port, int val)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_adv_local_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_adv_local_set(unit, port, pm_info, val);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_adv_local_set isn't implemented for driver type"));
    }
...
int portmod_port_adv_local_get(int unit, int port, int* val)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_adv_local_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_adv_local_get(unit, port, pm_info, val);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_adv_local_get isn't implemented for driver type"));
    }
...
int portmod_port_ability_adv_set(int unit, int port, const portmod_port_ability_t* ability)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_ability_adv_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_ability_adv_set(unit, port, pm_info, ability);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_ability_adv_set isn't implemented for driver type"));
    }
...
int portmod_port_ability_adv_get(int unit, int port, const portmod_port_ability_t* ability)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_ability_adv_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_ability_adv_get(unit, port, pm_info, ability);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_ability_adv_get isn't implemented for driver type"));
    }
...
int portmod_port_ability_adv_remote_get(int unit, int port, const portmod_port_ability_t* ability)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_ability_adv_remote_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_ability_adv_remote_get(unit, port, pm_info, ability);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_ability_adv_remote_get isn't implemented for driver type"));
    }
