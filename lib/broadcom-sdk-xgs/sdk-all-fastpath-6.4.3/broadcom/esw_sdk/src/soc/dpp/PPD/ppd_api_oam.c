  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_init,(unit, init_trap_info_oam, init_trap_info_bfd, is_bfd));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_init_print,(unit, init_trap_info_oam, init_trap_info_bfd, is_bfd));
  ...
  )
{
  ...
  SOC_SAND_CHECK_NULL_INPUT(profile_data);
  /*SOC_SAND_CHECK_NULL_INPUT(cpu_trap_code_to_mirror_profile_map); can be null if BFD */

  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_classifier_oam1_entries_insert_default_profile,
								(unit, profile_data, classifier_mep_entry, cpu_trap_code_to_mirror_profile_map, is_bfd));
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PPD_OAM_CLASSIFIER_OAM1_2_ENTRIES_INSERT_ACCORDING_TO_PROFILE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(classifier_mep_entry);
  SOC_SAND_CHECK_NULL_INPUT(profile_data);
  /* Do not check profile_data_acc - NULL value is valid */
  /*SOC_SAND_CHECK_NULL_INPUT(profile_data_acc);*/
  SOC_SAND_CHECK_NULL_INPUT(cpu_trap_code_to_mirror_profile_map);

  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_classifier_oam1_2_entries_insert_according_to_profile,
								(unit, is_server,classifier_mep_entry, profile_data, profile_data_acc, cpu_trap_code_to_mirror_profile_map));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_classifier_oam1_2_entries_insert_according_to_profile,
					 (unit, classifier_mep_entry, profile_data, profile_data_acc, cpu_trap_code_to_mirror_profile_map));
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_oam_classifier_oam1_2_entries_insert_according_to_profile()", 0, 0);
}
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_mep_db_entry_delete,(unit, mep_index, deallocate_icc_ndx, is_last_mep));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_bfd_my_bfd_dip_ipv4_set,(unit, dip_index, dip));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_bfd_my_bfd_dip_ipv4_set,(unit, dip_index, dip));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_bfd_my_bfd_dip_ipv4_get,(unit, dip_index, dip));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_bfd_my_bfd_dip_ipv4_get,(unit, dip_index, dip));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_event_fifo_read,(unit, rmeb_db_ndx, event_id, valid, rmep_state));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_event_fifo_read,(unit, rmeb_db_ndx, event_id, valid, rmep_state));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_error_trap_id_and_destination_set,(unit, trap_type, trap_id, dest_system_port));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_oamp_error_trap_id_and_destination_set,(unit, trap_type, trap_id, dest_system_port));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_error_trap_id_and_destination_get,(unit, trap_type, trap_id, dest_system_port));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_oamp_error_trap_id_and_destination_get,(unit, trap_type, trap_id, dest_system_port));
  ...
  )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_lm_dm_remove,(unit, endpoint_id,is_lm,num_removed , removed_index));
...
/*********************************************************************
*     Get/Set/Remove loopback
*     Details: in the H file.
**********************************************************************/

uint32 
    soc_ppd_oam_oamp_loopback_set(
       SOC_SAND_IN  int                                                    unit,
       SOC_SAND_IN uint32                                                     endpoint_id,
       ...
       )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_loopback_set,(unit, endpoint_id,tx_period,mac_address,is_added));
      ...
      )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_loopback_get,(unit, rx_packet_count,tx_packet_count,discard_count,fifo_count));
...
uint32 
    soc_ppd_oam_oamp_loopback_get_period(
       SOC_SAND_IN  int                                                  unit,
       ...
       )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_oamp_loopback_get_period,(unit, period));
       ...
       )
{
    ...
    SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_register_dma_event_handler_callback,(unit, event_handler_cb));
