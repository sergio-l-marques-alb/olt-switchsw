...
arad_pp_mymac_vrid_mymac_map_set_to_all_vsi(int unit, int cam_index, int enable){
    ...
    rv = soc_mem_read_range(unit, IHP_VRID_MY_MAC_MAPm, MEM_BLOCK_ANY, 0, nof_lines - 1 /*Index of the last line is nof - 1 */, alloced_mem);
    SOCDNX_SAND_IF_ERR_EXIT(rv);
    ...
    /* 4. Write back to HW. */
    rv = soc_mem_write_range(unit, IHP_VRID_MY_MAC_MAPm, MEM_BLOCK_ANY, 0, nof_lines - 1 /*Index of the last line is nof - 1 */, alloced_mem);
    SOCDNX_SAND_IF_ERR_EXIT(rv);
