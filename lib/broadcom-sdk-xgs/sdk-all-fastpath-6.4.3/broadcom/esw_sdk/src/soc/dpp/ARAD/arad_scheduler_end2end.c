...
#endif
{
 ...
 res = arad_fill_table_with_entry(unit, SCH_PIR_SHAPERS_STATIC_TABEL_PSSTm, MEM_BLOCK_ANY, &entry);
 SOC_SAND_CHECK_FUNC_RESULT(res, 100, exit);

 res = arad_fill_table_with_entry(unit, SCH_CIR_SHAPERS_STATIC_TABEL_CSSTm, MEM_BLOCK_ANY, &entry);
