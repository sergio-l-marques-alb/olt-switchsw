  ...
  )
{
  ...
  ARAD_PP_EPNI_LLVP_TABLE_TBL_DATA
    epni_llvp_tbl;
  uint32
    entry_offset, parser_leaf_context_index, parser_leaf_context;
  uint8
      is_outer_ctag,
      is_inner_ctag,
      is_outer_stag;
  ...
  for (parser_leaf_context_index = 0; parser_leaf_context_index < ARAD_PMF_PGM_SEL_PARSER_NOF_PROFILE_PP; parser_leaf_context_index++) 
  {
    if (parser_leaf_context_index == 0)
    {
        parser_leaf_context = ARAD_PMF_PGM_SEL_PARSER_PROFILE_PP;
    }
    else /* index = 1 */
    {
        parser_leaf_context = ARAD_PMF_PGM_SEL_PARSER_PROFILE_PP_L4;
    }
