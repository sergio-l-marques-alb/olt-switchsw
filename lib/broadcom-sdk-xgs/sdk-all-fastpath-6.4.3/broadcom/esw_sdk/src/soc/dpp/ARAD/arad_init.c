...
if (SOC_DPP_CONFIG(unit)->emulation_system == 0) {
  ...
  if (SOC_DPP_CONFIG(unit)->emulation_system == 0) {
      ...
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
      res = arad_fill_table_with_entry(unit, (SOC_IS_JERICHO(unit) ? IPS_CREDIT_BALANCE_BASED_THRESHOLDS_TABLEm : IPS_CRBALTHm), MEM_BLOCK_ANY, table_entry);
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
      res = arad_fill_table_with_entry(unit, (SOC_IS_JERICHO(unit) ? IPS_CREDIT_WATCHDOG_THRESHOLDS_TABLEm : IPS_CRWDTHm), MEM_BLOCK_ANY, table_entry);
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
      res = arad_fill_table_with_entry(unit, (SOC_IS_JERICHO(unit) ? IPS_EMPTY_QUEUE_CREDIT_BALANCE_TABLEm : IPS_EMPTYQCRBALm), MEM_BLOCK_ANY, table_entry);
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
      res = arad_fill_table_with_entry(unit, (SOC_IS_JERICHO(unit)? IPS_FLOW_ID_LOOKUP_TABLEm : IPS_FLWIDm), MEM_BLOCK_ANY, table_entry);
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
  ...
  errnum += 10;
  SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
  res = arad_fill_table_with_entry(unit, (SOC_IS_JERICHO(unit) ? IPS_QUEUE_SIZE_BASED_THRESHOLDS_TABLEm : IPS_QSZTHm), MEM_BLOCK_ANY, table_entry);
  errnum += 10;
  SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
  res = arad_fill_table_with_entry(unit, (SOC_IS_JERICHO(unit)? IPS_QUEUE_TYPE_LOOKUP_TABLEm : IPS_QTYPEm), MEM_BLOCK_ANY, table_entry);
  errnum += 10;
  SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
  ...
  if (SOC_DPP_CONFIG(unit)->emulation_system == 0) {
      ...
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
      res = arad_fill_table_with_entry(unit, SCH_FC_MAP_FCMm, MEM_BLOCK_ANY, table_entry);
      errnum += 10;
      SOC_SAND_CHECK_FUNC_RESULT(res, errnum, exit);
