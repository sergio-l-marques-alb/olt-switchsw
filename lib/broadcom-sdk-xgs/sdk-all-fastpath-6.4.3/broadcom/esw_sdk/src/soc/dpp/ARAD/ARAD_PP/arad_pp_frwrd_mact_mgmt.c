...
#define ARAD_PP_FRWRD_MACT_TRAP_TYPE_NDX_MAX                (ARAD_PP_NOF_FRWRD_MACT_TRAP_TYPES-1)
#define ARAD_PP_FRWRD_MACT_PORT_PROFILE_NDX_MAX             (3)
#define ARAD_PP_FRWRD_MACT_EVENT_TYPE_MAX                   ((1 << (SOC_PPC_NOF_FRWRD_MACT_EVENT_TYPES-1))-1)
#define ARAD_PP_FRWRD_MACT_HEADER_TYPE_MAX                  (ARAD_PP_NOF_FRWRD_MACT_MSG_HDR_TYPES) /* nof headers is ok, indicate if to overwrite the header setting */
#define ARAD_PP_FRWRD_MACT_TYPE_MAX                         (ARAD_PP_NOF_FRWRD_MACT_EVENT_PATH_TYPES-1)
#define ARAD_PP_FRWRD_MACT_LEARNING_MODE_MAX                (ARAD_PP_NOF_FRWRD_MACT_LEARNING_MODES-1)
#define ARAD_PP_FRWRD_MACT_SHADOW_MODE_MAX                  (ARAD_PP_NOF_FRWRD_MACT_SHADOW_MODES-1)
#define ARAD_PP_FRWRD_MACT_ACTION_WHEN_EXCEED_MAX           (ARAD_PP_NOF_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPES-1)
...
#define ARAD_PP_FRWRD_MACT_TIME_SEC_MAX                               (687)

#define ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_NOF_IS_LAGS                          (2)

#define ARAD_PP_FRWRD_MACT_16_CLOCKS_RESOLUTION                            (16)
#define ARAD_PP_FRWRD_MACT_AGE_CONF_PTR_FOR_MAC                       (0x1)
#define ARAD_PP_FRWRD_MACT_AGE_NOF_BITS                               (4)
...
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_EVENT_LEN        18
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_NUM_OF_EVENTS    8

#define ARAD_PP_FRWRD_MACT_LEARN_MSG_MAX_LEN         ((ARAD_PP_FRWRD_MACT_LEARN_MSG_EVENT_LEN) * ARAD_PP_FRWRD_MACT_LEARN_MSG_NUM_OF_EVENTS + ARAD_PP_FRWRD_MACT_ETHERNET_TYPE_SIZE) 

#define ARAD_PP_FRWRD_MACT_LEARN_MSG_VALID_INDEX    0
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_VALID_LEN      1
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_TYPE_INDEX     1
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_TYPE_LEN       3
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_1_INDEX      19 
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_1_LEN        10
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_2_INDEX      29 
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_2_LEN        32
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_3_INDEX      61 
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_3_LEN        32
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_1_INDEX      97
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_1_LEN        32
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_2_INDEX      129
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_2_LEN        10
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_3_INDEX      139
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_3_LEN        1
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_MFF_IS_KEY_INDEX   15
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_MFF_IS_KEY_LEN     1
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_LAG_INDEX          5
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_LAG_LEN            10
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_IS_LAG_INDEX          4
#define ARAD_PP_FRWRD_MACT_LEARN_MSG_IS_LAG_LEN            1
...
#define  SOC_DPP_FRWRD_MACT_LIMIT_MAPPED_RANGE_SIZE(unit)   (1 << (SOC_DPP_IMP_DEFS_GET(unit, mact_lif_base_length) - 1))
...
#define ARAD_PP_FRWRD_MACT_NOF_PROGS_FOR_APP                (3)
...
{
  int32 app_type;
  int32 flp_progs[ARAD_PP_FRWRD_MACT_NOF_PROGS_FOR_APP];
    ...
    Arad_pp_procedure_desc_element_frwrd_mact_mgmt[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_ONE_PASS_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_ONE_PASS_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_PORT_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET_UNSAFE),
   ...
   */
   ...
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_OLP_MSG_SET),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSGS_OLP_MSG_GET),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_VERIFY),
   ...
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSG_CONF_GET),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSG_PARSE),
   SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_FRWRD_MACT_LEARN_MSG_PARSE_UNSAFE),
    ...
    Arad_pp_error_desc_element_frwrd_mact_mgmt[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_TRAP_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_EVENT_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_MSG_HDR_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_EVENT_PATH_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_LEARNING_MODES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_SHADOW_MODES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
...
/* 
 * mapping application types to FLP programs.
...
static const ARAD_PP_FRWRD_MACT_APP_TO_FLP_PROGS app_to_flp_prog_map[ARAD_PP_FRWRD_MACT_NOF_ROUTED_LEARNING_APPS] = 
  /* 
   * application                         FLP program #1                               FLP program #2                               FLP program #3
   */
{ 
  {SOC_PPC_FRWRD_MACT_L3_LEARN_IPV4_UC, {ARAD_PP_FLP_KEY_PROGRAM_IPV4UC_WITH_DEFAULT, ARAD_PP_FLP_KEY_PROGRAM_IPV4UC_WITH_RPF,     ARAD_PP_FLP_KEY_PROGRAM_IPV4UC}},
  {SOC_PPC_FRWRD_MACT_L3_LEARN_IPV4_MC, {ARAD_PP_FLP_KEY_PROGRAM_IPV4COMPMC_WITH_RPF, ARAD_PP_FLP_MAP_PROG_NOT_SET,                ARAD_PP_FLP_MAP_PROG_NOT_SET  }},  
  {SOC_PPC_FRWRD_MACT_L3_LEARN_IPV6_UC, {ARAD_PP_FLP_KEY_PROGRAM_IPV6UC,              ARAD_PP_FLP_MAP_PROG_NOT_SET,                ARAD_PP_FLP_MAP_PROG_NOT_SET  }},
  {SOC_PPC_FRWRD_MACT_L3_LEARN_IPV6_MC, {ARAD_PP_FLP_KEY_PROGRAM_IPV6MC,              ARAD_PP_FLP_MAP_PROG_NOT_SET,                ARAD_PP_FLP_MAP_PROG_NOT_SET  }},
  {SOC_PPC_FRWRD_MACT_L3_LEARN_MPLS,    {ARAD_PP_FLP_KEY_PROGRAM_LSR,                 ARAD_PP_FLP_MAP_PROG_NOT_SET,                ARAD_PP_FLP_MAP_PROG_NOT_SET  }}, 
};
...
STATIC uint32
  arad_pp_frwrd_mact_event_type_to_event_val(
    SOC_SAND_IN  ARAD_PP_FRWRD_MACT_EVENT_TYPE                     event_type_ndx
  )
{

  switch(event_type_ndx)
  {
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT:
    return 0;
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN:
    return 3;
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT:
    return 6;
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_REFRESH:
    return 2;
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_ACK:
    return 5;
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_REQ_FAIL:
    return 7;
  case ARAD_PP_FRWRD_MACT_EVENT_TYPE_RETRIEVE:/* retrieve encoding as defrae in event */
      return 4;
  default:
    return 1;
  }
  ...
  )
{
    ...
    res = arad_pp_sw_db_is_petra_a_compatible_get(unit, &is_petra_a_compatible);
    ...
    )
{
   ...
   */
  res = arad_pp_sw_db_learning_mode_get(unit, &learning_mode);
  ...
  if (is_age_resolution_low)
  {
    ...
    {
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_INGRESS_DISTRIBUTED:
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_DISTRIBUTED:
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_INGRESS_CENTRALIZED:
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_CENTRALIZED:
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_INDEPENDENT:
      *max_age = 2; /* Difference between age 3 and 1 */
      break;

    default:
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR, 10, exit);
    }
  }
  else
  {
    ...
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_INGRESS_CENTRALIZED:
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_CENTRALIZED:
      if(soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "centralized_owned", 0) == 0) 
      {
    ...
    )
{
  ...
  else
  {
    ...
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_CENTRALIZED:
      /*
       *    if centralized owned mode: At 2 aged-out if is-mine, at 0 aged-out if is-mine
       *    if not centralized owned mode: at 0 aged-out.
       */
      is_centralized_owned = (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "centralized_owned", 0) == 1);
      for (age_ndx = 0; age_ndx < ARAD_PP_FRWRD_MACT_ENTRY_NOF_AGES; ++age_ndx)
      {
        for (is_owned = 0; is_owned < ARAD_PP_FRWRD_MACT_ENTRY_NOF_IS_OWNED; ++is_owned)
        {
          /* 
           * In case of PON MAC limit enabled, Create aging out envent to ARM.
           */
          if ((age_ndx == 0) && 
              (SOC_MAC_LIMIT_PER_TUNNEL_ENABLE_GET(unit) || (!(is_centralized_owned))))
          {
            /* LCOV_EXCL_START */
            default_conf->age_action[age_ndx][is_owned].deleted = FALSE;
            default_conf->age_action[age_ndx][is_owned].aged_out = TRUE;
          ...
          else if ((age_ndx == 0) || ((age_ndx == 2) && (is_centralized_owned)))
          {
            default_conf->age_action[age_ndx][is_owned].deleted = FALSE;
    ...
    )
{
   ...
   */
  entry_offset = aging_cfg_ptr << ARAD_PP_FRWRD_MACT_AGE_NOF_BITS;
    ...
    )
{
   ...
   *  the MAC dynamic configuration
   */
  entry_offset = ARAD_PP_FRWRD_MACT_AGE_CONF_PTR_FOR_MAC << ARAD_PP_FRWRD_MACT_AGE_NOF_BITS;
  ...
  )
{
   ...
   */
  res = arad_pp_sw_db_authentication_enable_set(
    unit,
   ...
   */
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 75, exit, MBCM_DPP_DRIVER_CALL(unit, mbcm_dpp_mgmt_system_fap_id_get, (unit, &fap_id)));
  ...
  )
{
  ...
  if (SOC_IS_ARADPLUS(unit)) {
      ...
      if (ARAD_PP_FRWRD_MACT_LEARN_LIMIT_MODE == ARAD_PP_FRWRD_MACT_LEARN_LIMIT_TYPE_LIF) {
      ...
      if (ARAD_PP_FRWRD_MACT_LEARN_LIMIT_MODE == ARAD_PP_FRWRD_MACT_LEARN_LIMIT_TYPE_LIF) {
          ...
          SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  20,  exit, ARAD_REG_ACCESS_ERR,READ_PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr(unit, &lif_limit_reg_value));

          /* Set an entry number to be used for packets with no OutLif - The last table entry will be used in this case */
          soc_reg64_field32_set(unit, PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr, &lif_limit_reg_value,
                                 LARGE_EM_INVALID_LIF_CNTR_PTRf, ARAD_PP_FRWRD_MACT_LIMIT_RANGE_END_MAX);

          /* Set the HW LIF Ranges for Arad+ */
          soc_reg64_field32_set(unit, PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr, &lif_limit_reg_value,
          ...
          SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  30,  exit, ARAD_REG_ACCESS_ERR,WRITE_PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr(unit, lif_limit_reg_value));
          ...
          for (lif_range_ix = 0; lif_range_ix < ARAD_PP_MAX_NOF_MACT_LIMIT_LIF_RANGES; lif_range_ix++) {
              ...
              /* Set the bit manipulation fields according to the SOC property selected ranges */
              /* If it's the range that was configured in the SOC properties for the first range mapping
                 Remove the 2 MSBs to map a range to the first mapped range */
              if ((lif_range_ix * ARAD_PP_FRWRD_MACT_LIMIT_RANGE_MAP_SIZE) == ARAD_PP_FRWRD_MACT_LEARN_LIF_RANGE_BASE(0)) {
                  field_zero_msbs[0] = 0x2;
                  field_shift_right[0] = 0x0;
                  field_lif_base[0] = 0x0;
              /* If it's the range that was configured in the SOC properties for the second range mapping
                 Remove the 2 MSBs and add the mapped range size t get the start of the second mapped range */
              } else if ((lif_range_ix * ARAD_PP_FRWRD_MACT_LIMIT_RANGE_MAP_SIZE) ==  ARAD_PP_FRWRD_MACT_LEARN_LIF_RANGE_BASE(1)) {
                  field_zero_msbs[0] = 0x2;
                  field_shift_right[0] = 0x0;
                  field_lif_base[0] = SOC_DPP_FRWRD_MACT_LIMIT_MAPPED_RANGE_SIZE(unit);
              /* If it's this range wasn't configured in the SOC properties for range mapping - return the Invalid counter
                 ny reseting the mapped value before adding the explicit inavlid entry value */
              } else {
              ...
              SHR_BITCOPY_RANGE(tmp_lif_ptr_range_map_reg_value, lif_range_ix * 25, lif_ptr_range_map_reg_value, 0, 25);
          }
  ...
  )
{
    ...
    for (field_idx = 0; field_idx < nof_exact_match_tables; field_idx++) {
        reg_field_ref = SOC_IS_JERICHO(unit)? exact_match_hash_encryption_enable_ref_jericho[field_idx]: exact_match_hash_encryption_enable_ref[field_idx];
  ...
  )
{
  uint32
    fld_val, slb_prefix,
    res = SOC_SAND_OK;
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO
    mac_limit_glbl_info;
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_INFO
    limit_info;
  ...
  */
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_clear(&mac_limit_glbl_info);
  mac_limit_glbl_info.static_may_exceed = TRUE;
  mac_limit_glbl_info.cpu_may_exceed = TRUE;
   ...
   */
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_INFO_clear(&limit_info);
...
STATIC uint32
  arad_pp_frwrd_mact_is_ingress_learning_get(
        SOC_SAND_IN  int                      unit,
        SOC_SAND_IN  ARAD_PP_FRWRD_MACT_LEARNING_MODE learning_mode,
      ...
      )
{
  ...
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR, 140, exit);
  }
  ...
  )
{
  ...
  if (SOC_IS_ARADPLUS(unit)) {    
    ...
    res = arad_pp_frwrd_mact_arad_plus_sa_lookup_mapping_init_unsafe(unit,(is_ingress_learning && !opport));
  ...
  )
{
  ...
  authentication_enable = (lookup_type == ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_SA_AUTH);
  ...
  if (SOC_IS_ARADPLUS(unit) && soc_property_get(unit, spn_RESILIENT_HASH_ENABLE, 0)) {
    ...
    SOC_SAND_VERIFY(ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_SLB_LOOKUP == lookup_type);
    slb_enabled = 1;
  }
#endif /* BCM_88660_A0 */
  ...
  case ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_SLB_LOOKUP:
      ...
      break;
#endif /* BCM_88660_A0 */
  case ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_MIM: /* Not supported by ARAD */
  default:
     SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_MGMT_TYPE_OUT_OF_RANGE_ERR, 170, exit); 
  }
  res = arad_pp_sw_db_authentication_enable_set(unit, authentication_enable);
...
{
  ARAD_PP_FRWRD_MACT_LOOKUP_TYPE
    sa_lookup_type;
  uint32
    reg_val,    
    dsp_generation_en,
  ...
  uint32
    ...
    age_key_ndx,
    last_age_key_ndx;
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY
    event_key,
    event_key_no_mac;
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO
    handle_info,
    handle_info_no_mac;
  ARAD_PP_IHB_PINFO_FLP_TBL_DATA
    tbl_data;
  ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE
    msg_type[ARAD_PP_FRWRD_MACT_NOF_FIFOS];
  ARAD_PP_FRWRD_MACT_EVENT_TYPE
    event_type_ndx;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(oper_mode_info);

  
  ARAD_PP_FRWRD_MACT_AGING_EVENT_TABLE_clear(&default_conf);
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_clear(&event_key);
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_clear(&event_key_no_mac);
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_clear(&handle_info);
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_clear(&handle_info_no_mac);
  ...
  res = arad_pp_sw_db_learning_mode_set(unit,learning_mode);
  SOC_SAND_CHECK_FUNC_RESULT(res, 2, exit);
  pph_petra_a_compatible = oper_mode_info->soc_petra_a_compatible;
  res = arad_pp_sw_db_is_petra_a_compatible_set(unit,pph_petra_a_compatible);
  ...
  if (pph_petra_a_compatible == TRUE)
  {
    ...
    case ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_INDEPENDENT:
    default:
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR, 30, exit);
    }
  }
  else
  {
    ...
    if ((SOC_IS_ARAD_B0_AND_ABOVE(unit)) && 
        ...
        (
         (ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_DISTRIBUTED == learning_mode)||
         (ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_CENTRALIZED == learning_mode)||
         (ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_INDEPENDENT == learning_mode))
        )
    {
        uint32
            field,
    ...
    default:
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR, 40, exit);
    }
  }
  ...
  if (SOC_IS_ARADPLUS(unit)) {
       ...
       * Fixes Plus-IBF9 
       */
      if ((oper_mode_info->learn_msgs_info.type == ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_DIRECT_ACCESS) &&
          (is_centralized == TRUE)) {
          fld_val = 0x2;
      }
  }
  ...
  for (reg_ndx = 0; reg_ndx < ARAD_PP_MACT_DSP_ENGINE_CONFIGURATION_REG_NOF_REGS; ++reg_ndx)
  {
    ...
    {
    case ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_MSG_SINGLE:
      dsp_generation_en = 0x1;
      dsp_nof_cmds = ARAD_PP_FRWRD_MACT_DSP_NOF_DSP_MSGS_IN_OLP_MSG_SINGLE;
      dsp_delay = 0x20;
      break;

    case ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_MSG_AGGR:
      dsp_generation_en = 0x1;
      dsp_nof_cmds = ARAD_PP_FRWRD_MACT_DSP_NOF_DSP_MSGS_IN_OLP_MSG_AGGR;
      dsp_delay = 0x3F;
      break;

    case ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_DIRECT_ACCESS:
    default:
    ...
    if ((oper_mode_info->learn_msgs_info.info.header_type != ARAD_PP_NOF_FRWRD_MACT_MSG_HDR_TYPES) && (reg_ndx == ARAD_PP_FRWRD_MACT_FIFO_LEARNING))
    {
    ...
    /* set header if header is valid, no matter if it's generated or not */
    else if ((oper_mode_info->shadow_msgs_info.info.header_type != ARAD_PP_NOF_FRWRD_MACT_MSG_HDR_TYPES)  && (reg_ndx == ARAD_PP_FRWRD_MACT_FIFO_SHADOW))
    {
      /*
  ...
  res = arad_pp_sw_db_authentication_enable_get(unit, &authentication_enable);
  SOC_SAND_CHECK_FUNC_RESULT(res, 168, exit);

  if (authentication_enable) 
  {
      sa_lookup_type = ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_SA_AUTH;
  }
  else {
      sa_lookup_type = ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_SA_LOOKUP;
  }

#ifdef BCM_88660_A0
  if (SOC_IS_ARADPLUS(unit) && soc_property_get(unit, spn_RESILIENT_HASH_ENABLE, 0)) {
    sa_lookup_type = ARAD_PP_FRWRD_MACT_LOOKUP_TYPE_SLB_LOOKUP;
  }
#endif /* BCM_88660_A0 */
  ...
  for (handle_profile_ndx = 0; handle_profile_ndx < 1; ++handle_profile_ndx)
  {
    ...
    for (is_lag_ndx = 0; is_lag_ndx < ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_NOF_IS_LAGS; ++is_lag_ndx)
    {
      ...
      if (is_centralized == TRUE)
      {
         ...
         */
        event_key.event_type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT + ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN
          + ARAD_PP_FRWRD_MACT_EVENT_TYPE_REQ_FAIL + ARAD_PP_FRWRD_MACT_EVENT_TYPE_ACK + ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT;
      ...
      else if (is_egr_independent == TRUE)
      {
        ...
        if (is_lag_ndx)
        {
          event_key.event_type += ARAD_PP_FRWRD_MACT_EVENT_TYPE_REFRESH + ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT;
        }
      ...
      else /* Distributed mode */
      {
         ...
         */
        event_key.event_type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT + ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN
          + ARAD_PP_FRWRD_MACT_EVENT_TYPE_REFRESH + ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT;
        handle_info.self_learning = FALSE;
        handle_info.send_to_learning_fifo = TRUE;
        handle_info.send_to_shadow_fifo = FALSE;
        res = arad_pp_frwrd_mact_event_handle_info_set_unsafe(
  ...
  for (handle_profile_ndx = 0; handle_profile_ndx < 1; ++handle_profile_ndx)
  {
    ...
    {
      event_key.is_lag = SOC_SAND_NUM2BOOL(is_lag_ndx);
      for (event_type_ndx = 0; event_type_ndx < ARAD_PP_NOF_FRWRD_MACT_EVENT_TYPES; ++event_type_ndx)
      {
          event_key.event_type = SOC_SAND_BIT(event_type_ndx);
        if ((event_key.event_type == ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT)
           ||(event_key.event_type == ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT)
           ||(event_key.event_type == ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN)
           )
        {
           ...
           *  in the arp mode
           */
          if ((oper_mode_info->shadow_mode == ARAD_PP_FRWRD_MACT_SHADOW_MODE_NONE)
              || ((oper_mode_info->shadow_mode == ARAD_PP_FRWRD_MACT_SHADOW_MODE_LAG) && (is_lag_ndx == 0)))
          {
            handle_info.send_to_shadow_fifo = FALSE;
          }
          else
          ...
          if ((event_key.event_type == ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN)
            && (oper_mode_info->shadow_mode == ARAD_PP_FRWRD_MACT_SHADOW_MODE_ARP))
          {
            handle_info.send_to_shadow_fifo = FALSE;
          }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO, oper_mode_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(oper_mode_info);

  ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_clear(oper_mode_info);
   ...
   */
  res = arad_pp_sw_db_learning_mode_get(unit, &oper_mode_info->learning_mode);
  SOC_SAND_CHECK_FUNC_RESULT(res, 3, exit);

  res = arad_pp_sw_db_is_petra_a_compatible_get(unit, &(oper_mode_info->soc_petra_a_compatible));
  SOC_SAND_CHECK_FUNC_RESULT(res, 5, exit);
  ...
  for (reg_ndx = 0; reg_ndx < ARAD_PP_MACT_DSP_ENGINE_CONFIGURATION_REG_NOF_REGS; ++reg_ndx)
  {
    ...
    {
      msg_type[reg_ndx] = ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_DIRECT_ACCESS;
    }
    else
    {
      switch(dsp_nof_cmds)
      ...
      case ARAD_PP_FRWRD_MACT_DSP_NOF_DSP_MSGS_IN_OLP_MSG_SINGLE - 1:
        msg_type[reg_ndx] = ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_MSG_SINGLE;
        break;

      case ARAD_PP_FRWRD_MACT_DSP_NOF_DSP_MSGS_IN_OLP_MSG_AGGR - 1:
        msg_type[reg_ndx] = ARAD_PP_FRWRD_MACT_EVENT_PATH_TYPE_MSG_AGGR;
        break;
  ...
  /*
   *    Get the learn message configuration: always get distibution info will set to nof_headers if not set.
   */
  ...
  /*
   *    Get the shadow message configuration: always get distibution info will set to nof_headers if not set.
   */
  ...
  for (handle_profile_ndx = 0; handle_profile_ndx < 1; ++handle_profile_ndx)
  {
    ...
    for (is_lag_ndx = 0; is_lag_ndx < ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_NOF_IS_LAGS; ++is_lag_ndx)
    {
      ...
      for (event_type_ndx = 0; event_type_ndx < ARAD_PP_NOF_FRWRD_MACT_EVENT_TYPES; ++event_type_ndx)
      {
        if ((event_type_ndx == ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT)
          ||(event_type_ndx == ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT)
          ||(event_type_ndx == ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN)
          )
        {
          ...
          else if (event_type_ndx == ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN)
          {
            if ((handle_info.send_to_shadow_fifo == FALSE) && ((is_lag_ndx == TRUE)))
            {
  ...
  {
    oper_mode_info->shadow_mode = ARAD_PP_FRWRD_MACT_SHADOW_MODE_NONE;
  }
           ...
           &&  is_shadow_learned_always_false)
  {
    oper_mode_info->shadow_mode = ARAD_PP_FRWRD_MACT_SHADOW_MODE_ARP;
            ...
            && is_shadow_learned_not_lag_always_false)
  {
    oper_mode_info->shadow_mode = ARAD_PP_FRWRD_MACT_SHADOW_MODE_LAG;
  }
  else if (is_shadow_always_false_for_other_events
            && is_shadow_aged_out_transplant_always_true
            && is_shadow_learned_always_true)
  {
    oper_mode_info->shadow_mode = ARAD_PP_FRWRD_MACT_SHADOW_MODE_ALL;
  }
  else
  {
    /*
     ...
     */
    oper_mode_info->shadow_mode = ARAD_PP_NOF_FRWRD_MACT_SHADOW_MODES;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_AGING_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_AGING_INFO_SET_VERIFY);

  res = ARAD_PP_FRWRD_MACT_AGING_INFO_verify(unit, aging_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_AGING_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(aging_info);

  ARAD_PP_FRWRD_MACT_AGING_INFO_clear(aging_info);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET_UNSAFE);
  SOC_SAND_CHECK_NULL_INPUT(aging_info);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE, aging_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(aging_info);
  ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_clear(aging_info);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(fid, SOC_DPP_DEFS_GET(unit, nof_fids), ARAD_PP_FID_OUT_OF_RANGE_ERR, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET_UNSAFE);
   ...
   */
  fld_val = SOC_SAND_BOOL2NUM(limit_info->glbl_limit != ARAD_PP_FRWRD_MACT_NO_GLOBAL_LIMIT);
   ...
   *    set global limt
   */
  if(limit_info->glbl_limit == ARAD_PP_FRWRD_MACT_NO_GLOBAL_LIMIT) {
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET_VERIFY);

  res = ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_verify(unit, limit_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(limit_info);

  ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_clear(limit_info);
  ...
  if(fld_val == 0)
  {
    limit_info->glbl_limit = ARAD_PP_FRWRD_MACT_NO_GLOBAL_LIMIT;
  }
  else
  {
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_MAC_LIMIT_PER_TUNNEL_INFO_SET_UNSAFE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = arad_pp_sw_db_mac_limit_per_tunnel_set(unit, port, tunnel_id, mac_limit);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_MAC_LIMIT_PER_TUNNEL_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;
  
  SOC_SAND_CHECK_NULL_INPUT(mac_limit);
  
  res = arad_pp_sw_db_mac_limit_per_tunnel_get(unit, port, tunnel_id, mac_limit);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  {
  case ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_NONE:
    tbl_data.interrupt_en = FALSE;
    tbl_data.message_en = FALSE;
    break;

  case ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_INTERRUPT:
    tbl_data.interrupt_en = TRUE;
    tbl_data.message_en = FALSE;
    break;

  case ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_MSG:
    tbl_data.interrupt_en = FALSE;
    tbl_data.message_en = TRUE;
    break;
  
  case ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_EVENT:
  default:
  ...
  )
{
  ...
  res = ARAD_PP_FRWRD_MACT_MAC_LIMIT_INFO_verify(unit, limit_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  {
    limit_info->action_when_exceed = ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_INTERRUPT;
  }
  else if (tbl_data.message_en == TRUE)
  {
    limit_info->action_when_exceed = ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_MSG;
  }
  else
  {
    limit_info->action_when_exceed = ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_NONE;
  }
  ...
  )
{
  ...
  ARAD_PP_FRWRD_MACT_EVENT_BUFFER_clear(event_buf);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET_UNSAFE);
  ...
  */
  for (event_type_ndx = 0; event_type_ndx < ARAD_PP_NOF_FRWRD_MACT_EVENT_TYPES; ++event_type_ndx)
  {
    if (SOC_SAND_GET_BIT(event_key->event_type, event_type_ndx) == 0x1)
    {
      ...
      SHR_BITCOPY_RANGE(entry_val, entry_indx*(SOC_DPP_IMP_DEFS_GET(unit, dsp_event_route_entry_nof_bits)), &build_val, 0, 3);
    ...
    )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY, event_key, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO, handle_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET_UNSAFE);
  ...
  */
  for (event_type_ndx = 0; event_type_ndx < ARAD_PP_NOF_FRWRD_MACT_EVENT_TYPES; ++event_type_ndx)
  {
    if (SOC_SAND_GET_BIT(event_key->event_type, event_type_ndx) == 0x1)
    {
      ...
      build_val = 0;
      SHR_BITCOPY_RANGE(&build_val,0, entry_val, entry_indx*(SOC_DPP_IMP_DEFS_GET(unit, dsp_event_route_entry_nof_bits)), 3);
    ...
    )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_LEARN_MSGS_OLP_MSG_SET);
  ...
  if(distribution_info->header_type == ARAD_PP_NOF_FRWRD_MACT_MSG_HDR_TYPES ||
		num_olp_tm_ports == 0){
      goto exit; /* nothing to configure */
  }

    if (distribution_info->olp_receive_header_type != ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_RAW &&
        distribution_info->olp_receive_header_type != ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_RAW) {
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(distribution_fifo, ARAD_PP_FRWRD_MACT_NOF_FIFOS-1, ARAD_PP_FRWRD_MACT_FIFO_OUT_OF_RANGE_ERR, 5, exit);
    ...
    case ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_RAW:
        to_skip = 0;
        break;

    case ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_RAW:
        to_skip = ARAD_PP_FRWRD_MACT_ETHERNET_HEADER_SIZE -ARAD_PP_FRWRD_MACT_ETHERNET_TYPE_SIZE;
        break;

    case ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_OTMH:
        to_skip = otmh_size;
        break;

    case ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_OTMH:
  ...
  * learning message.
  */
  if (distribution_info->header_type != ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_ITMH)
  {
    ...
    )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_LEARN_MSGS_OLP_MSG_GET);

  SOC_SAND_CHECK_NULL_INPUT(distribution_info);
  ARAD_PP_FRWRD_MACT_MSG_DISTR_INFO_clear(distribution_info);
    ...
    */
    ...
    {
        distribution_info->header_type = ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_RAW;
    }
    else if (header_size == itmh_header_size + ARAD_PP_FRWRD_MACT_ETHERNET_TYPE_SIZE)
    {
        distribution_info->header_type = ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ITMH;
    }
    else if (header_size == ARAD_PP_FRWRD_MACT_ETHERNET_HEADER_SIZE + itmh_header_size)
    {
        distribution_info->header_type = ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_ITMH;
    }
    ...
    {
    case 0:
        distribution_info->olp_receive_header_type = ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_RAW;
        break;
    ...
    case ARAD_PP_FRWRD_MACT_ETHERNET_HEADER_SIZE - ARAD_PP_FRWRD_MACT_ETHERNET_TYPE_SIZE + ARAD_PP_FRWRD_MACT_OTMH_HEADER_SIZE + 3:
        distribution_info->olp_receive_header_type = ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_OTMH;
        break;
    ...
    case ARAD_PP_FRWRD_MACT_OTMH_HEADER_SIZE + 3:
        distribution_info->olp_receive_header_type = ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_OTMH;
        break;
    }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_MSG_DISTR_INFO, distribution_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_UNSAFE);
  ...
  )
{
  ...
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_RANGE_MAP_INFO_clear(map_info);
  ...
  SHR_BITCOPY_RANGE(tmp_lif_ptr_range_map_values, 0, reg_data, range_num * 25, 25);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(range_num, ARAD_PP_MAX_NOF_MACT_LIMIT_LIF_RANGES, ARAD_PP_GENERAL_VAL_OUT_OF_RANGE_ERR, 10, exit);
  ...
  )
{
  ...
  /* Reset the output data structure */
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_MAPPING_INFO_clear(map_info);

  /* Read the register data from the HW */
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  10,  exit, ARAD_REG_ACCESS_ERR, READ_PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr(unit, &limit_reg));

  /* Get the Invalid limit mapping default entry field from the read data */
  soc_sand_os_memset(&field_val, 0x0, sizeof(field_val));
  field_val = soc_reg64_field32_get(unit, PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr, limit_reg,  LARGE_EM_INVALID_LIF_CNTR_PTRf);
  ...
  soc_sand_os_memset(&field_val, 0x0, sizeof(field_val));
  field_val = soc_reg64_field32_get(unit, PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr, limit_reg,  LARGE_EM_LIF_RANGE_0f);
  soc_sand_os_memcpy(&(map_info->range_end[0]), &field_val, sizeof(map_info->range_end[0]));

  soc_sand_os_memset(&field_val, 0x0, sizeof(field_val));
  field_val = soc_reg64_field32_get(unit, PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr, limit_reg,  LARGE_EM_LIF_RANGE_1f);
  soc_sand_os_memcpy(&(map_info->range_end[1]), &field_val, sizeof(map_info->range_end[1]));

  soc_sand_os_memset(&field_val, 0x0, sizeof(field_val));
  field_val = soc_reg64_field32_get(unit, PPDB_B_LARGE_EM_COUNTER_DB_CNTR_PTR_CONFIGURATIONr, limit_reg,  LARGE_EM_LIF_RANGE_2f);
    ...
    )
{
  ...
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_MAPPING_INFO
    map_info;
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_RANGE_MAP_INFO
    map_range_info;
  int8
    selected_range;
  ...
  res = arad_pp_frwrd_mact_mac_limit_mapping_info_get(
          unit,
          &map_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = arad_pp_frwrd_mact_mac_limit_range_map_info_get(
          unit,
          selected_range,
          &map_range_info
        );
  ...
  *limit_tbl_idx = mapped_val;
  ...
  zero_msbs_mask = 0x0000FFFF >> map_range_info.zero_msbs;
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_PORT_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_PORT_INFO_SET_VERIFY);

  SOC_SAND_ERR_IF_ABOVE_MAX(local_port_ndx, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_PORT_INFO, port_info, 20, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_PORT_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_PORT_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(port_info);

  ARAD_PP_FRWRD_MACT_PORT_INFO_clear(port_info);
  ...
  )
{
  ...
  {
  case ARAD_PP_FRWRD_MACT_TRAP_TYPE_SA_DROP:
  ...
  case ARAD_PP_FRWRD_MACT_TRAP_TYPE_SA_UNKNOWN:
    switch(port_profile_ndx)
    {
    case 0:
  ...
  case ARAD_PP_FRWRD_MACT_TRAP_TYPE_DA_UNKNOWN:
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_TRAP_TYPE_NDX_OUT_OF_RANGE_ERR, 80, exit);
  }
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(trap_type_ndx, ARAD_PP_FRWRD_MACT_TRAP_TYPE_NDX_MAX, ARAD_PP_FRWRD_MACT_TRAP_TYPE_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ...
  if (trap_type_ndx == ARAD_PP_FRWRD_MACT_TRAP_TYPE_DA_UNKNOWN &&
      (action_profile->trap_code != (ARAD_PP_TRAP_CODE)(ARAD_PP_TRAP_CODE_DA_NOT_FOUND_0 + port_profile_ndx)))
  {
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_ACTION_TRAP_CODE_LSB_INVALID_ERR, 40, exit);
  }

  if (trap_type_ndx == ARAD_PP_FRWRD_MACT_TRAP_TYPE_SA_UNKNOWN &&
    (action_profile->trap_code != (ARAD_PP_TRAP_CODE)(ARAD_PP_TRAP_CODE_SA_NOT_FOUND_0 + port_profile_ndx)))
  {
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_ACTION_TRAP_CODE_LSB_INVALID_ERR, 50, exit);
  }

  if (trap_type_ndx == ARAD_PP_FRWRD_MACT_TRAP_TYPE_SA_DROP &&
    (action_profile->trap_code != (ARAD_PP_TRAP_CODE)(ARAD_PP_TRAP_CODE_SA_DROP_0 + port_profile_ndx)))
  {
  ...
  )
{
  ...
  if (trap_type_ndx == ARAD_PP_FRWRD_MACT_TRAP_TYPE_DA_UNKNOWN)
  {
      action_profile->trap_code = ARAD_PP_TRAP_CODE_DA_NOT_FOUND_0 + port_profile_ndx;
  }

  if (trap_type_ndx == ARAD_PP_FRWRD_MACT_TRAP_TYPE_SA_UNKNOWN)
  {
    action_profile->trap_code = ARAD_PP_TRAP_CODE_SA_NOT_FOUND_0 + port_profile_ndx;
  }

  if (trap_type_ndx == ARAD_PP_FRWRD_MACT_TRAP_TYPE_SA_DROP)
  {
    action_profile->trap_code = ARAD_PP_TRAP_CODE_SA_DROP_0 + port_profile_ndx;
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO, info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(info);

  ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_clear(info);
  ...
  )
{
  ...
  case ARAD_PP_LEM_ACCESS_CMD_DELETE:
    mact_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT;
    break;

  case ARAD_PP_LEM_ACCESS_CMD_LEARN:
    mact_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN;
    break;

  case ARAD_PP_LEM_ACCESS_CMD_TRANSPLANT:
    mact_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT;
    break;

  case ARAD_PP_LEM_ACCESS_CMD_REFRESH:
    mact_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_REFRESH;
    break;

  case ARAD_PP_LEM_ACCESS_CMD_ACK:
    mact_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_ACK;
    break;

  case ARAD_PP_LEM_ACCESS_CMD_ERROR:
    mact_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_REQ_FAIL;
    break;
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_EVENT_BUFFER, event_buf, 10, exit);
  ...
  )
{
  uint32
    res = SOC_SAND_OK;
  ARAD_PP_FRWRD_MACT_MSG_DISTR_INFO
    distr_info;
  ARAD_PP_TRAP_PACKET_INFO
    pkt_info;
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
  if (distr_info.header_type == ARAD_PP_FRWRD_MACT_MSG_HDR_TYPE_ETH_O_ITMH)
  {
    ...
    )
{
  uint32
    ...
    fld_val;
  uint8
    msg_buffer[ARAD_PP_FRWRD_MACT_LEARN_MSG_MAX_LEN],
    *buff;
  ARAD_PP_FRWRD_MACT_EVENT_INFO
    *c_event;
  uint32
    skipped_events = 0;
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FRWRD_MACT_LEARN_MSG_PARSE_UNSAFE);
  SOC_SAND_CHECK_NULL_INPUT(learn_msg);
  SOC_SAND_CHECK_NULL_INPUT(learn_msg_conf);
  SOC_SAND_CHECK_NULL_INPUT(learn_events);

  ARAD_PP_FRWRD_MACT_LEARN_MSG_PARSE_INFO_clear(learn_events);
  ...
  {
    if(learn_msg->msg_len - skip_bytes > ARAD_PP_FRWRD_MACT_LEARN_MSG_MAX_LEN)
    {
  ...
  {
    offset += (event_index * ARAD_PP_FRWRD_MACT_LEARN_MSG_EVENT_LEN);
    ...
    res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
            buff,
            ARAD_PP_FRWRD_MACT_LEARN_MSG_VALID_INDEX,
            ARAD_PP_FRWRD_MACT_LEARN_MSG_VALID_LEN,
            &fld_val
          );
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
    if(fld_val != 1)
    ...
    res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
            buff,
            ARAD_PP_FRWRD_MACT_LEARN_MSG_TYPE_INDEX,
            ARAD_PP_FRWRD_MACT_LEARN_MSG_TYPE_LEN,
            &fld_val
          );
    SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);
    switch (fld_val)
    {
      case ARAD_PP_LEM_ACCESS_CMD_DELETE:
        c_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_AGED_OUT;
        break;

      case ARAD_PP_LEM_ACCESS_CMD_LEARN:
        c_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_LEARN;
        break;

      case ARAD_PP_LEM_ACCESS_CMD_TRANSPLANT:
        c_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_TRANSPLANT;
        break;

      case ARAD_PP_LEM_ACCESS_CMD_REFRESH:
        c_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_REFRESH;
        break;

      case ARAD_PP_LEM_ACCESS_CMD_ACK:
        c_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_ACK;
        break;

      case ARAD_PP_LEM_ACCESS_CMD_ERROR:
        c_event->type = ARAD_PP_FRWRD_MACT_EVENT_TYPE_REQ_FAIL;
        break;
    ...
    res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
      buff,
      ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_1_INDEX,
      ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_1_LEN,
      &fld_val
      );
    SOC_SAND_CHECK_FUNC_RESULT(res, 130, exit);
    SHR_BITCOPY_RANGE(lem_payload_data,ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_2_LEN,&fld_val,0,ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_1_LEN);

    res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
      buff,
      ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_2_INDEX,
      ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_2_LEN,
      &fld_val
      );
    SOC_SAND_CHECK_FUNC_RESULT(res, 130, exit);
    ...
    res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
      buff,
      ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_3_INDEX,
      ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_3_LEN,
      &fld_val
      );
    SOC_SAND_CHECK_FUNC_RESULT(res, 130, exit);

    lem_payload_data[1] |= fld_val << ARAD_PP_FRWRD_MACT_LEARN_MSG_ASD_2_LEN;
    ...
    res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
            buff,
            ARAD_PP_FRWRD_MACT_LEARN_MSG_MFF_IS_KEY_INDEX,
            ARAD_PP_FRWRD_MACT_LEARN_MSG_MFF_IS_KEY_LEN,
            &fld_val
          );
    SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
    ...
    if(fld_val == 1)
    {
        res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
                buff,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_1_INDEX,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_1_LEN,
                &fld_val
              );
        SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
        ...
        res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
                buff,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_2_INDEX,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_2_LEN,
                &fld_val
              );
        SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
        ...
        res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
                buff,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_3_INDEX,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_KEY_3_LEN,
                &fld_val
              );
        SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
    ...
    /* Lag */
    if(c_event->type != ARAD_PP_FRWRD_MACT_EVENT_TYPE_ACK)
    {

        res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
                buff,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_IS_LAG_INDEX,
                ARAD_PP_FRWRD_MACT_LEARN_MSG_IS_LAG_LEN,
                &fld_val
              );
        SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
      ...
      if(fld_val) { /* get lag id if valid */
            res = soc_sand_bitsteam_u8_ms_byte_first_get_field(
                      buff,
                      ARAD_PP_FRWRD_MACT_LEARN_MSG_LAG_INDEX,
                      ARAD_PP_FRWRD_MACT_LEARN_MSG_LAG_LEN,
                      &fld_val
                    );
            SOC_SAND_CHECK_FUNC_RESULT(res, 50, exit);
            c_event->lag.id = fld_val;
    ...
    )
{
  ...
  res = arad_pp_sw_db_mim_initialized_set(unit, mim_initialized);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  res = arad_pp_sw_db_mim_initialized_get(unit, mim_initialized);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  for (app_idx = 0; app_idx < ARAD_PP_FRWRD_MACT_NOF_ROUTED_LEARNING_APPS; app_idx++) {
    ...
    for (prog_idx = 0; prog_idx < ARAD_PP_FRWRD_MACT_NOF_PROGS_FOR_APP; prog_idx++) {
      if (app_to_flp_prog_map[app_idx].flp_progs[prog_idx] != ARAD_PP_FLP_MAP_PROG_NOT_SET) {
        /* If ipmc_vpn_lookup_enable  == 0, use Global-IPMC to replace IPMC per VRF */
        if (!(SOC_DPP_CONFIG(unit)->l3.ipmc_vpn_lookup_enable) && 
             app_to_flp_prog_map[app_idx].app_type == SOC_PPC_FRWRD_MACT_L3_LEARN_IPV4_MC) {
          prog_id = ARAD_PP_FLP_KEY_PROGRAM_GLOBAL_IPV4COMPMC_WITH_RPF;
        } else {
          prog_id = app_to_flp_prog_map[app_idx].flp_progs[prog_idx];
        }
  ...
  )
{
  ...
  for (app_idx = 0; app_idx < ARAD_PP_FRWRD_MACT_NOF_ROUTED_LEARNING_APPS; app_idx++) {
     ...
     */
    if (app_to_flp_prog_map[app_idx].flp_progs[0] != ARAD_PP_FLP_MAP_PROG_NOT_SET) {
      /* If ipmc_vpn_lookup_enable  == 0, use Global-IPMC to replace IPMC per VRF */
      if (!(SOC_DPP_CONFIG(unit)->l3.ipmc_vpn_lookup_enable) && 
           app_to_flp_prog_map[app_idx].app_type == SOC_PPC_FRWRD_MACT_L3_LEARN_IPV4_MC) {
        prog_id = ARAD_PP_FLP_KEY_PROGRAM_GLOBAL_IPV4COMPMC_WITH_RPF;
      } else {
        prog_id = app_to_flp_prog_map[app_idx].flp_progs[0];
      }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  max_time = ARAD_PP_FRWRD_MACT_TIME_SEC_MAX * (ARAD_DFLT_TICKS_PER_SEC / (1000*1000)) / ticks_per_microsec;

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_TIME, &(info->aging_time), 11, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->aging_time.sec, max_time, ARAD_PP_FRWRD_MACT_MGMT_SEC_OUT_OF_RANGE_ERR, 12, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_AGING_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->event_type, ARAD_PP_FRWRD_MACT_EVENT_TYPE_MAX, ARAD_PP_FRWRD_MACT_EVENT_TYPE_OUT_OF_RANGE_ERR, 10, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_verify()",0,0);
}
uint32
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_MSG_DISTR_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_MSG_DISTR_INFO, &(info->info), 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_EVENT_PROCESSING_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->learning_mode, ARAD_PP_FRWRD_MACT_LEARNING_MODE_MAX, ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_EVENT_PROCESSING_INFO, &(info->learn_msgs_info), 12, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->shadow_mode, ARAD_PP_FRWRD_MACT_SHADOW_MODE_MAX, ARAD_PP_FRWRD_MACT_SHADOW_MODE_OUT_OF_RANGE_ERR, 13, exit);
  if (info->shadow_mode != ARAD_PP_FRWRD_MACT_SHADOW_MODE_NONE)
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_EVENT_PROCESSING_INFO, &(info->shadow_msgs_info), 14, exit);
  }

  if ((info->learning_mode == ARAD_PP_FRWRD_MACT_LEARNING_MODE_EGRESS_INDEPENDENT) && (info->soc_petra_a_compatible == TRUE))
  {
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR, 20, exit);
  }

  SOC_SAND_MAGIC_NUM_VERIFY(info);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_verify()",0,0);
}
uint32
  ...
  )
{
  ...
  if (info->action_when_exceed == ARAD_PP_FRWRD_MACT_LIMIT_EXCEED_NOTIFY_TYPE_EVENT)
  {
  ...
  SOC_SAND_MAGIC_NUM_VERIFY(info);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_MAC_LIMIT_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(info->fid_allowed, SOC_DPP_DEFS_GET(unit, nof_fids), ARAD_PP_FID_OUT_OF_RANGE_ERR, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  if (info->fid_base)
  {
    SOC_SAND_ERR_IF_ABOVE_MAX(info->fid_base, 0, ARAD_PP_FID_OUT_OF_RANGE_ERR, 13, exit);
  }
  ...
  if(info->glbl_limit != ARAD_PP_FRWRD_MACT_NO_GLOBAL_LIMIT) {
    /* 0 is used for unlimited global lems */
    SOC_SAND_ERR_IF_OUT_OF_RANGE(info->glbl_limit, 1, DPP_PP_LEM_NOF_ENTRIES(unit) - 1, ARAD_PP_FRWRD_MACT_GLBL_LIMIT_OUT_OF_RANGE_ERR, 21, exit);
  }

  SOC_SAND_MAGIC_NUM_VERIFY(info);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_verify()",0,0);
}

#ifdef BCM_88660_A0
uint32
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_RANGE_MAP_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_MAC_LIMIT_RANGE_MAP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_MAPPING_INFO_verify(
    SOC_SAND_IN  int                                       unit,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_PORT_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_EVENT_LAG_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 11, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_ENTRY_VALUE, &(info->value), 12, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_FRWRD_MACT_EVENT_LAG_INFO, &(info->lag), 13, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_EVENT_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  for (ind = 0; ind < ARAD_PP_FRWRD_MACT_EVENT_BUFF_MAX_SIZE; ++ind)
  {
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_MACT_EVENT_BUFFER_verify()",0,0);
}
