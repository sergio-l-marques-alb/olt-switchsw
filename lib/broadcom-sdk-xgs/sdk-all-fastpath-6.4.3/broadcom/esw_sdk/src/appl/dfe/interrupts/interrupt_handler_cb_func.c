    ...
    unit)
{
    ...
    interrupt_add_interrupt_handler(unit,         FE1600_INT_RTP_ECC_2BERRINT,     0,     0, fe1600_interrupt_handle_rtp_ecc_2berrint , NULL);
    interrupt_add_interrupt_handler(unit,         FE1600_INT_RTP_PARITYERRINT,     0,     0, fe1600_interrupt_handle_rtp_parityerrint , NULL);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_NONE, NULL);
    _SOC_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_NONE, NULL, NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, FE1600_INT_CORR_ACT_NONE, NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_ALL_REACHABLE_FIX, special_msg);
    _SOC_IF_ERR_EXIT(rc);
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_ALL_REACHABLE_FIX, &integrity_vec, NULL);
    _SOC_IF_ERR_EXIT(rc);
exit:
    SOC_FUNC_RETURN;
}
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_NONE, special_msg);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_FORCE, NULL);
    _SOC_IF_ERR_EXIT(rc);



    /* corrective action */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_FORCE, NULL, NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_HARD_RESET, NULL);
    _SOC_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_HARD_RESET, NULL, NULL);
    _SOC_IF_ERR_EXIT(rc);
...
{
    int rc;
    fe1600_int_corr_act_type corrective_action ;
    /* message for syslog */
    char special_msg[FE1600_INTERRUPT_SPECIAL_MSG_SIZE];
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, corrective_action,special_msg );
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, FE1600_INT_CORR_ACT_HARD_RESET, special_msg);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_NONE, p_message);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, corrective_action, special_msg);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    corrective_action = FE1600_INT_CORR_ACT_NONE;
    param1 = NULL;
    ...
    if(FE1600_INT_CORR_ACT_MC_RTP_CORRECT == corrective_action) {
        param1 = (void*)(&mc_rtp_table_correct_info);
    }
    else if (FE1600_INT_CORR_ACT_UC_RTP_CORRECT == corrective_action) {
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, FE1600_INT_CORR_ACT_PRINT, special_msg);
    _SOC_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_PRINT, NULL, NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, FE1600_INT_CORR_ACT_HARD_RESET, NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_HARD_RESET, special_msg);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* corrective action */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_NONE, special_msg, NULL);
    _SOC_IF_ERR_EXIT(rc);
...
int
fe1600_interrupt_handle_rtp_ecc_2berrint(
    int unit,
    int block_instance,
    fe1600_interrupt_type en_fe1600_interrupt,
    char *msg)
{
    ...
    if(FE1600_INT_CORR_ACT_MC_RTP_CORRECT == corrective_action) {
        ...
        param1 = (void*)(&unicast_index);
    } else if (FE1600_INT_CORR_ACT_SHADOW == corrective_action) {
...
int
fe1600_interrupt_handle_rtp_parityerrint(
    int unit,
    int block_instance,
    fe1600_interrupt_type en_fe1600_interrupt,
    char *msg)
    ...
    char *msg)
{
    ...
    /* corrective actions */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_NONE, (void*)array_links ,NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, FE1600_INT_CORR_ACT_SHUTDOWN_LINKS, special_msg);
    _SOC_IF_ERR_EXIT(rc);

    /* corrective actions */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_SHUTDOWN_LINKS, (void*)array_links ,NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* corrective actions */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg,FE1600_INT_CORR_ACT_SHUTDOWN_LINKS,array_links,NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_RX_LOS_HANDLE, special_msg);
    _SOC_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = fe1600_interrupt_handles_corrective_action(unit, block_instance, en_fe1600_interrupt, msg, FE1600_INT_CORR_ACT_RX_LOS_HANDLE, &link, NULL);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 1, FE1600_INT_CORR_ACT_NONE, special_msg);
    _SOC_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = fe1600_interrupt_print_info(unit, block_instance, en_fe1600_interrupt, 0, FE1600_INT_CORR_ACT_RX_LOS_HANDLE, NULL);
    _SOC_IF_ERR_EXIT(rc);
