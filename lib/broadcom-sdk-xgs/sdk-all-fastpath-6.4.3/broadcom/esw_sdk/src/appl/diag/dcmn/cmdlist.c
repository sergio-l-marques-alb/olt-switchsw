...
cmd_t bcm_dpp_cmd_list[] = {
    ...
    {"arad",      cmd_dpp_arad_card,           cmd_dpp_arad_card_usage,
     "Arad card specific commands" },
#endif
    ...
    {"gfa_bi",      cmd_dpp_gfa_bi,           cmd_dpp_gfa_bi_usage,
...
#ifdef BCM_PETRAB_SUPPORT
    {"sweep",       cmd_dpp_sweep,            cmd_dpp_sweep_usage,
     "Sweep commands" },
#endif /* BCM_DPP_SUPPORT */
