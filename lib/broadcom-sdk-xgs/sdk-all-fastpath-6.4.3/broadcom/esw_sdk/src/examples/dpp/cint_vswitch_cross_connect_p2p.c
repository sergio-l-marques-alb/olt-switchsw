...
/* When set to 1, this variable enables bcmSwitchMplsPipeTunnelLabelExpSet mode via calling
  ...
  uint8 vswitch_cc_p2p_pipe_mode_exp_set = 0; 
  ...
  int mpls_pipe_mode_exp_set(int unit) {
    ...
    if (vswitch_cc_p2p_pipe_mode_exp_set) {
        rv = bcm_switch_control_set(unit, bcmSwitchMplsPipeTunnelLabelExpSet, vswitch_cc_p2p_pipe_mode_exp_set);
    }
