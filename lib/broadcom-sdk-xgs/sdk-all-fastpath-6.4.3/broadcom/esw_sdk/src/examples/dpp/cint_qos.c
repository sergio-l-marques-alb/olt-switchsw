/*
 * $Id: cint_qos.c,v 1.5 Broadcom SDK $
...
int is_arad(int unit, int *yesno)
{
    bcm_info_t info;
...
qos_map_mpls_egress_profile(int unit)
{
    ...
    rv = bcm_qos_map_create(unit, BCM_QOS_MAP_EGRESS, &mpls_eg_map_id);
