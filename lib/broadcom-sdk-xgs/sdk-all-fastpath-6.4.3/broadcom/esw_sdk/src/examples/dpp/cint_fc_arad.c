/* $Id: cint_fc_arad.c,v 1.8 Broadcom SDK $
...
/* Creates a Retransmit Entry           */
/* in the ILKN-OOB Generation Calendar  */
int setRetransmitGeneration(int unit, int is_oob, int local_port, int ilkn_interface, int calendar_index)
{
  bcm_error_t rv = BCM_E_NONE;
  bcm_cosq_fc_endpoint_t source, target;
  bcm_cosq_vsq_info_t vsq_info;
...
int setRetransmitReception(int unit, int is_oob, int local_port, int ilkn_interface, int calendar_index)
{
  bcm_error_t rv = BCM_E_NONE;
  bcm_cosq_fc_endpoint_t source, target;
  bcm_gport_t ilkn_gport;
