...
int C3_DEFAULT_E2E_SCHED_FLAGS = (BCM_COSQ_GPORT_SCHEDULER | BCM_COSQ_GPORT_SCHEDULER_HR_DUAL_WFQ);
...
int e2e_wfq_init(int unit)
{
    ...
    e2e_wfq_margin_cl_init(10, 75);
    e2e_wfq_margin_fq_init(10, 775);
    e2e_wfq_margin_voq_conn_init(10, 775);
...
int e2e_wfq_start_run(int unit, int port, int mode)
{
    ...
    system_port = port;
    BCM_GPORT_MODPORT_SET(dest_gport, my_modid, port);
    ...
    flags = C3_CONN_FLAGS | default_flags;
    rv = bcm_cosq_gport_add(unit, src_gport, num_cos, 
                flags, &g_e2e_wfq_gports.gport_ucast_voq_connector_group0);
    ...
    flags = C3_CONN_FLAGS | default_flags;
    rv = bcm_cosq_gport_add(unit, src_gport, num_cos, 
                flags, &g_e2e_wfq_gports.gport_ucast_voq_connector_group1);
