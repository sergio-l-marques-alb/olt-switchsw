...
typedef struct {
	...
	int (*field_qualify_EthernetOamClassSourceVP)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamClassSourceVP_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EthernetOamClassVFI)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamClassVFI_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EthernetOamClassVxlt1)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamClassVxlt1_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EthernetOamClassVxlt2)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamClassVxlt2_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_EthernetOamSourceVPLmStatPoolId)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamSourceVPLmStatPoolId_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EthernetOamSrcPortLmStatPoolId)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamSrcPortLmStatPoolId_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_EthernetOamVxlt1LmStatPoolId)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamVxlt1LmStatPoolId_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_EthernetOamVxlt2LmStatPoolId)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_EthernetOamVxlt2LmStatPoolId_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*field_qualify_MplsOamClassMpls)(int,bcm_field_entry_t,uint16,uint16);
	int (*field_qualify_MplsOamClassMpls_get)(int,bcm_field_entry_t,uint16 *,uint16 *);
	int (*field_qualify_MplsOamControlPktType)(int,bcm_field_entry_t,bcm_field_MplsOam_Control_pktType_t,bcm_field_MplsOam_Control_pktType_t);
	int (*field_qualify_MplsOamControlPktType_get)(int,bcm_field_entry_t,bcm_field_MplsOam_Control_pktType_t *,bcm_field_MplsOam_Control_pktType_t *);
	...
	int (*field_qualify_MplsOamMplsLmStatPoolId)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_MplsOamMplsLmStatPoolId_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
