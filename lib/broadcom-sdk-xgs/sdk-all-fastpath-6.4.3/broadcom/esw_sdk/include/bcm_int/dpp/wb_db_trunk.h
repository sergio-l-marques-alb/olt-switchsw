/*
 * $Id: wb_db_trunk.h,v 1.3 Broadcom SDK $
 ...
 *
 * File:        wb_db_trunk.h
 * Purpose:     WarmBoot - Level 2 support (TRUNK Module)
 */

#ifndef _BCM_DPP_WB_DB_TRUNK_H_
#define _BCM_DPP_WB_DB_TRUNK_H_

#include <bcm_int/dpp/trunk.h>

typedef struct trunk_wb_cntl_s {
    bcm_dpp_trunk_private_t    *t_info;
} trunk_wb_cntl_t;

typedef trunk_wb_cntl_t trunk_cntl_t;

extern trunk_wb_cntl_t bcm_wb_trunk_control[BCM_MAX_NUM_UNITS];
