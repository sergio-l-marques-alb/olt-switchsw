...
typedef uint32 (*mbcm_dpp_egr_queuing_dev_set_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN SOC_TMC_EGR_QUEUING_DEV_TH    *info
  );
typedef uint32 (*mbcm_dpp_egr_queuing_dev_get_f) (
    SOC_SAND_IN     int    unit,
    SOC_SAND_OUT SOC_TMC_EGR_QUEUING_DEV_TH    *info
  );
typedef uint32 (*mbcm_dpp_egr_queuing_mc_cos_map_set_f)(
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    uint32    tc_ndx,
    SOC_SAND_IN    uint32    dp_ndx,
...
typedef uint32 (*mbcm_dpp_egr_queuing_if_fc_set_f)(
    SOC_SAND_IN     int    unit,
...
typedef uint32 (*mbcm_dpp_egr_queuing_if_fc_uc_set_f)(
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    uint32    uc_if_profile_ndx,
    SOC_SAND_IN ARAD_EGR_QUEUING_IF_UC_FC    *info
  );
typedef uint32 (*mbcm_dpp_egr_queuing_if_fc_uc_get_f)(
    SOC_SAND_IN     int    unit,
    SOC_SAND_IN     uint32    uc_if_profile_ndx,
    SOC_SAND_OUT ARAD_EGR_QUEUING_IF_UC_FC    *info
  );
typedef uint32 (*mbcm_dpp_egr_queuing_if_fc_mc_set_f)(
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    uint32    mc_if_profile_ndx,
    SOC_SAND_IN uint32    pd_th
  );
typedef uint32 (*mbcm_dpp_egr_queuing_if_fc_mc_get_f)(
    SOC_SAND_IN     int    unit,
    SOC_SAND_IN     uint32    mc_if_profile_ndx,
...
typedef uint32 (*mbcm_dpp_fabric_pcp_dest_mode_config_set_f) (
    SOC_SAND_IN int                             unit,
    SOC_SAND_IN uint32                              flags,
    SOC_SAND_IN uint32                                  modid,
    SOC_SAND_IN uint32                                  pcp_mode
  );
typedef uint32 (*mbcm_dpp_fabric_pcp_dest_mode_config_get_f) (
    SOC_SAND_IN int                             unit,
    SOC_SAND_IN uint32                              flags,
    SOC_SAND_IN uint32                                  modid,
...
typedef uint32 (*mbcm_dpp_fabric_priority_set_f) ( 
    SOC_SAND_IN  int                              unit, 
...
typedef uint32 (*mbcm_dpp_fabric_priority_get_f) ( 
    SOC_SAND_IN  int                              unit, 
    SOC_SAND_IN  uint32                              tc, 
    SOC_SAND_IN  uint32                              dp,
    SOC_SAND_IN  uint32                              flags,
...
typedef uint32 (*mbcm_dpp_fabric_cosq_control_backward_flow_control_set_f) (
    SOC_SAND_IN int                                   unit,
...
typedef uint32 (*mbcm_dpp_fabric_cosq_control_backward_flow_control_get_f) (
    SOC_SAND_IN int                                   unit,
    SOC_SAND_IN soc_gport_t                           port,
...
typedef uint32 (*mbcm_dpp_fabric_egress_core_cosq_gport_sched_set_f) (
    SOC_SAND_IN  int                                unit,
...
typedef uint32 (*mbcm_dpp_fabric_egress_core_cosq_gport_sched_get_f) (
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  int                                pipe,
...
typedef uint32 (*mbcm_dpp_fabric_cosq_gport_rci_threshold_set_f) (
    SOC_SAND_IN  int                    unit,
...
typedef uint32 (*mbcm_dpp_fabric_cosq_gport_rci_threshold_get_f) (
    SOC_SAND_IN  int                    unit,
...
typedef uint32 (*mbcm_dpp_fabric_cosq_gport_priority_drop_threshold_set_f) (
    SOC_SAND_IN  int                                    unit,
    SOC_SAND_IN  soc_gport_t                            gport,
...
typedef uint32 (*mbcm_dpp_fabric_cosq_gport_priority_drop_threshold_get_f) (
    SOC_SAND_IN  int                                    unit,
    SOC_SAND_IN  soc_gport_t                            gport,
...
typedef uint32 (*mbcm_dpp_fabric_multicast_set_f) (
    SOC_SAND_IN  int                                    unit,
...
typedef uint32 (*mbcm_dpp_fabric_sync_e_enable_set_f) (
    SOC_SAND_IN  int                                unit, 
    SOC_SAND_IN  int                                is_master, 
...
typedef uint32 (*mbcm_dpp_itm_committed_q_size_set_f) ( 
    SOC_SAND_IN  int                  unit, 
...
typedef uint32 (*mbcm_dpp_itm_committed_q_size_get_f) ( 
    SOC_SAND_IN  int                  unit, 
    SOC_SAND_IN  uint32                  rt_cls4_ndx, 
    SOC_SAND_OUT SOC_TMC_ITM_GUARANTEED_INFO *exact_info 
  ); 
...
typedef uint32 (*mbcm_dpp_port_control_low_latency_set_f) (
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  uint32                     link_ndx,
    SOC_SAND_IN  uint32                     value
 );
typedef uint32 (*mbcm_dpp_port_control_fec_error_detect_set_f) (
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  uint32                     link_ndx,
    SOC_SAND_IN  uint32                     value
 );
typedef uint32 (*mbcm_dpp_port_control_low_latency_get_f) (
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  uint32                     link_ndx,
    SOC_SAND_OUT  int                        *value
 );
typedef uint32 (*mbcm_dpp_port_control_fec_error_detect_get_f) (
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  uint32                     link_ndx,
    SOC_SAND_OUT  int                        *value
 );
...
typedef uint32 (*mbcm_dpp_egr_ofp_fc_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_EGR_Q_PRIO          prio_ndx, 
...
typedef uint32 (*mbcm_dpp_egr_ofp_fc_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_EGR_Q_PRIO          prio_ndx, 
    SOC_SAND_IN  SOC_TMC_EGR_PORT_THRESH_TYPE ofp_type_ndx, 
...
typedef uint32 (*mbcm_dpp_sch_slow_max_rates_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_SCH_SLOW_RATE      *slow_max_rates, 
    SOC_SAND_OUT SOC_TMC_SCH_SLOW_RATE      *exact_slow_max_rates 
  ); 
typedef uint32 (*mbcm_dpp_sch_slow_max_rates_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_OUT SOC_TMC_SCH_SLOW_RATE      *slow_max_rates 
  ); 
...
typedef uint32 (*mbcm_dpp_mgmt_max_pckt_size_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  uint32                      port_ndx,
    SOC_SAND_IN  SOC_TMC_MGMT_PCKT_SIZE_CONF_MODE conf_mode_ndx,
    SOC_SAND_IN  uint32                       max_size
  );
 
typedef uint32 (*mbcm_dpp_mgmt_max_pckt_size_get_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  uint32                      port_ndx,
    SOC_SAND_IN  SOC_TMC_MGMT_PCKT_SIZE_CONF_MODE conf_mode_ndx,
...
/* fabric */ 
typedef uint32 (*mbcm_dpp_fabric_srd_qrtt_reset_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_fabric_aldwp_config_f) ( 
    SOC_SAND_IN  int                 unit
  );
...
typedef uint32 (*mbcm_dpp_ipq_explicit_mapping_mode_info_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_IPQ_EXPLICIT_MAPPING_MODE_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_ipq_explicit_mapping_mode_info_get_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_ipq_traffic_class_multicast_priority_map_set_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 traffic_class,
    SOC_SAND_IN  uint8                  enable
  );
typedef uint32 (*mbcm_dpp_ipq_traffic_class_multicast_priority_map_get_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32                 traffic_class,
    SOC_SAND_OUT uint8                  *enable
  );
...
typedef uint32 (*mbcm_dpp_cosq_gport_sched_set_f) (
    SOC_SAND_IN  int                                unit,
    SOC_SAND_IN  int                                pipe,
    SOC_SAND_IN  int                                weight,
...
typedef uint32 (*mbcm_dpp_cosq_gport_sched_get_f) (
    SOC_SAND_IN   int                                unit,
    SOC_SAND_IN   int                                pipe,
    SOC_SAND_OUT  int*                               weight,
    SOC_SAND_IN   soc_dpp_cosq_gport_fabric_pipe_t   fabric_pipe_type
...
typedef uint32 (*mbcm_dpp_itm_glob_rcs_drop_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_GLOB_RCS_DROP_TH *info, 
    SOC_SAND_OUT SOC_TMC_ITM_GLOB_RCS_DROP_TH *exact_info 
  ); 
typedef uint32 (*mbcm_dpp_itm_glob_rcs_drop_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_OUT SOC_TMC_ITM_GLOB_RCS_DROP_TH *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_category_rngs_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_CATEGORY_RNGS *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_category_rngs_get_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_itm_init_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_itm_wred_exp_wq_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                  exp_wq 
  ); 
typedef uint32 (*mbcm_dpp_itm_wred_exp_wq_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_OUT  uint32                  *exp_wq 
  ); 
typedef uint32 (*mbcm_dpp_itm_wred_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_wred_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
    SOC_SAND_OUT SOC_TMC_ITM_WRED_QT_DP_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_tail_drop_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_tail_drop_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_vsq_qt_rt_cls_set_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_itm_vsq_qt_rt_cls_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_NDX         vsq_in_group_ndx, 
    SOC_SAND_OUT uint32                 *vsq_rt_cls 
  ); 
typedef uint32 (*mbcm_dpp_itm_vsq_fc_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_vsq_fc_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_OUT SOC_TMC_ITM_VSQ_FC_INFO     *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_vsq_tail_drop_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_vsq_tail_drop_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_vsq_tail_drop_default_get_f) (
    SOC_SAND_IN  int                 unit,
    SOC_SAND_OUT SOC_TMC_ITM_VSQ_TAIL_DROP_INFO *vsq_max_size_default_info
  );
typedef uint32 (*mbcm_dpp_itm_vsq_wred_gen_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_WRED_GEN_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_vsq_wred_gen_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_OUT SOC_TMC_ITM_VSQ_WRED_GEN_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_vsq_wred_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_vsq_wred_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP       vsq_group_ndx, 
    SOC_SAND_IN  uint32                 vsq_rt_cls_ndx, 
    SOC_SAND_IN  uint32                 drop_precedence_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_sys_red_queue_size_boundaries_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  SOC_TMC_ITM_SYS_RED_QT_INFO *info, 
    SOC_SAND_OUT SOC_TMC_ITM_SYS_RED_QT_INFO *exact_info 
  ); 
typedef uint32 (*mbcm_dpp_itm_sys_red_queue_size_boundaries_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_OUT SOC_TMC_ITM_SYS_RED_QT_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_sys_red_q_based_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                 sys_red_dp_ndx, 
    SOC_SAND_IN  SOC_TMC_ITM_SYS_RED_QT_DP_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_sys_red_q_based_get_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  uint32                 rt_cls_ndx, 
    SOC_SAND_IN  uint32                 sys_red_dp_ndx, 
...
typedef uint32 (*mbcm_dpp_itm_sys_red_glob_rcs_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_ITM_SYS_RED_GLOB_RCS_INFO *info 
  ); 
typedef uint32 (*mbcm_dpp_itm_sys_red_glob_rcs_get_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_itm_dyn_total_thresh_set_f) (
    SOC_SAND_IN int   unit,
...
typedef uint32 (*mbcm_dpp_fc_gen_cal_get_f) (
    SOC_SAND_IN  int                      unit,
...
typedef uint32 (*mbcm_dpp_fc_gen_cal_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_FC_CAL_MODE                 cal_mode_ndx,
    SOC_SAND_IN  SOC_TMC_FC_OOB_ID                   if_ndx,
...
typedef uint32 (*mbcm_dpp_fc_gen_inbnd_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_PETRA_INTERFACE_ID             nif_ndx,
    SOC_SAND_IN  SOC_TMC_FC_GEN_INBND_INFO           *info
  );
typedef uint32 (*mbcm_dpp_fc_gen_inbnd_get_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_PETRA_INTERFACE_ID             nif_ndx,
...
typedef uint32 (*mbcm_dpp_fc_rec_cal_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_FC_CAL_MODE                 cal_mode_ndx,
    SOC_SAND_IN  SOC_TMC_FC_OOB_ID                   if_ndx,
    SOC_SAND_IN  SOC_TMC_FC_CAL_IF_INFO              *cal_conf,
...
typedef uint32 (*mbcm_dpp_fc_rec_cal_get_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_FC_CAL_MODE                 cal_mode_ndx,
    SOC_SAND_IN  SOC_TMC_FC_OOB_ID                   if_ndx,
    SOC_SAND_OUT  SOC_TMC_FC_CAL_IF_INFO              *cal_conf,
...
typedef uint32 (*mbcm_dpp_fc_rec_inbnd_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_PETRA_INTERFACE_ID             nif_ndx,
    SOC_SAND_IN  SOC_TMC_FC_REC_INBND_INFO           *info
  );
typedef uint32 (*mbcm_dpp_fc_rec_inbnd_get_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_PETRA_INTERFACE_ID             nif_ndx,
    SOC_SAND_OUT SOC_TMC_FC_REC_INBND_INFO           *info
  );

typedef uint32 (*mbcm_dpp_fc_pfc_generic_bitmap_set_f) (
    SOC_SAND_IN   int   unit,
    SOC_SAND_IN   uint32    bitmap_index,
    SOC_SAND_IN  SOC_TMC_FC_PFC_GENERIC_BITMAP    *pfc_bitmap
  );
typedef uint32 (*mbcm_dpp_fc_pfc_generic_bitmap_get_f) (
    SOC_SAND_IN   int   unit,
    SOC_SAND_IN   uint32    bitmap_index,
    SOC_SAND_OUT  SOC_TMC_FC_PFC_GENERIC_BITMAP    *pfc_bitmap
  );

typedef uint32 (*mbcm_dpp_fc_port_fifo_threshold_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_INTERFACE_ID     nif_ndx,
    SOC_SAND_IN  SOC_TMC_FC_PORT_FIFO_TH     *info
  );
typedef uint32 (*mbcm_dpp_fc_port_fifo_threshold_get_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_INTERFACE_ID     nif_ndx,
...
typedef uint32 (*mbcm_dpp_mult_eg_group_set_f) (
    SOC_SAND_IN  int         unit,
    SOC_SAND_IN  ARAD_MULT_ID   multicast_id_ndx,    /* the group mcid */
...
typedef uint32 (*mbcm_dpp_mult_eg_get_group_f) ( 
    SOC_SAND_IN  int              unit,
    SOC_SAND_IN  ARAD_MULT_ID        group_mcid,           /* group id */
...
typedef uint32 (*mbcm_dpp_mult_eg_bitmap_group_create_f) (  /* create an egress multicast bitmap group */
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  SOC_TMC_MULT_ID     multicast_id_ndx
  ); 
...
typedef uint32 (*mbcm_dpp_mult_fabric_credit_source_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  SOC_TMC_MULT_FABRIC_INFO    *info, 
    SOC_SAND_OUT SOC_TMC_MULT_FABRIC_INFO    *exact_info 
  ); 
typedef uint32 (*mbcm_dpp_mult_fabric_credit_source_get_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_port_to_interface_map_set_f) ( 
    SOC_SAND_IN  int                 unit, 
    SOC_SAND_IN  int                    core, 
    SOC_SAND_IN  uint32                 port_ndx, 
    SOC_SAND_IN  SOC_TMC_PORT_DIRECTION      direction_ndx, 
...
typedef uint32 (*mbcm_dpp_ports_lag_sys_port_info_get_f) ( 
    SOC_SAND_IN  int                     unit, 
    SOC_SAND_IN  uint32                     sys_port, 
    SOC_SAND_OUT SOC_TMC_PORT_LAG_SYS_PORT_INFO *port_lag_info_incoming 
  ); 
...
typedef uint32 (*mbcm_dpp_port_rx_enable_get_f) (
    SOC_SAND_IN int unit, 
    SOC_SAND_IN uint32  local_port,
    int* enable
  );

typedef uint32 (*mbcm_dpp_port_rx_enable_set_f) (
    SOC_SAND_IN int unit, 
    SOC_SAND_IN uint32  local_port,
    int enable
  );
...
/* mgmt */ 
typedef uint32 (*mbcm_dpp_mgmt_credit_worth_set_f) ( 
    SOC_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dpp_nif_loopback_set_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_INTERFACE_ID             nif_ndx,
    SOC_SAND_IN  uint8                      enable
  );
typedef uint32 (*mbcm_dpp_nif_loopback_get_f) (
    SOC_SAND_IN  int                      unit,
    SOC_SAND_IN  SOC_TMC_INTERFACE_ID             nif_ndx,
    SOC_SAND_OUT uint8                      *enable
  ); 
...
typedef uint32 (*mbcm_dpp_itm_dp_discard_set_f) (
    SOC_SAND_IN int                   unit,
    SOC_SAND_IN  uint32                  discard_dp
  );
 
typedef uint32 (*mbcm_dpp_itm_dp_discard_get_f) (
    SOC_SAND_IN  int                  unit,
...
typedef uint32(*mbcm_dpp_ofp_rates_single_port_max_burst_set_f) (
    SOC_SAND_IN  int                    unit,
    SOC_SAND_IN  int                    core,
    SOC_SAND_IN  uint32                 tm_port,
    SOC_SAND_IN  uint32                 max_burst
  );
typedef uint32 (*mbcm_dpp_ofp_rates_single_port_max_burst_get_f) (
    SOC_SAND_IN  int                    unit,
    SOC_SAND_IN  int                    core,
    SOC_SAND_IN  uint32                 tm_port,
...
typedef int (*mbcm_dpp_drv_allocate_tm_port_in_range_and_recycle_channel_f)(
    int unit, int max_port, 
    int *tm_port, 
    uint32 *channel
  );
...
typedef uint32 (* mbcm_dpp_port_to_dynamic_interface_map_set_f)(
    SOC_SAND_IN  int                        unit,
	SOC_SAND_IN  int                        core_id,
    SOC_SAND_IN  uint32                     port_ndx,
    SOC_SAND_IN  ARAD_PORT_DIRECTION        direction_ndx,
...
typedef uint32 (* mbcm_dpp_port_to_dynamic_interface_unmap_set_f)(
    SOC_SAND_IN  int                    unit,
    SOC_SAND_IN  int                    core_id,
    SOC_SAND_IN  uint32                 tm_port,
    SOC_SAND_IN  SOC_TMC_PORT_DIRECTION    direction_ndx
...
typedef int (* mbcm_fc_pfc_mapping_set_f)(
    SOC_SAND_IN int  unit,
...
typedef int (* mbcm_fc_pfc_mapping_get_f)(
    SOC_SAND_IN int  unit,
    SOC_SAND_IN uint32                       nif_id,
    SOC_SAND_IN uint32                       src_pfc_ndx,
...
typedef struct mbcm_dpp_functions_s {
    ...
    /* fabric functions */ 
    mbcm_dpp_fabric_srd_qrtt_reset_f              mbcm_dpp_fabric_srd_qrtt_reset; 
    ...
    mbcm_dpp_fabric_sync_e_enable_set_f           mbcm_dpp_fabric_sync_e_enable_set;
    ...
    mbcm_dpp_mult_eg_group_open_f                 mbcm_dpp_mult_eg_group_open;   /* Petra only */
    mbcm_dpp_mult_eg_group_update_f               mbcm_dpp_mult_eg_group_update; /* Petra only */
    mbcm_dpp_mult_eg_group_set_f                  mbcm_dpp_mult_eg_group_set;    /* Arad */
    ...
    mbcm_dpp_mult_ing_group_get_f                 mbcm_dpp_mult_ing_group_get;  /* Petra version */
    mbcm_dpp_mult_ing_get_group_f                 mbcm_dpp_mult_ing_get_group;  /* Arad version */
    /* ofp_rates functions */ 
    /* mbcm_dpp_ofp_rates_set_f                      mbcm_dpp_ofp_rates_set; 
    mbcm_dpp_ofp_rates_get_f                      mbcm_dpp_ofp_rates_get; 
    mbcm_dpp_ofp_all_ofp_rates_get_f              mbcm_dpp_ofp_all_ofp_rates_get; 
    mbcm_dpp_ofp_rates_single_port_set_f          mbcm_dpp_ofp_rates_single_port_set; 
    mbcm_dpp_ofp_rates_single_port_get_f          mbcm_dpp_ofp_rates_single_port_get; 
    mbcm_dpp_ofp_rates_mal_shaper_set_f           mbcm_dpp_ofp_rates_mal_shaper_set; 
    mbcm_dpp_ofp_rates_mal_shaper_get_f           mbcm_dpp_ofp_rates_mal_shaper_get;  */
    /*mbcm_dpp_ofp_rates_egq_calendar_validate_f    mbcm_dpp_ofp_rates_egq_calendar_validate; */
    /* mbcm_dpp_ofp_rates_update_device_set_f        mbcm_dpp_ofp_rates_update_device_set; 
    mbcm_dpp_ofp_rates_update_device_get_f        mbcm_dpp_ofp_rates_update_device_get;  */
    /* packet functions */ 
    ...
    mbcm_dpp_ports_lag_sys_port_info_get_f        mbcm_dpp_ports_lag_sys_port_info_get; 
    ...
    /* nif functions */ 
    mbcm_dpp_nif_loopback_set_f                   mbcm_dpp_nif_loopback_set; 
    mbcm_dpp_nif_loopback_get_f                   mbcm_dpp_nif_loopback_get; 
    ...
    mbcm_dpp_fc_rec_inbnd_set_f                   mbcm_dpp_fc_rec_inbnd_set;
    mbcm_dpp_fc_rec_inbnd_get_f                   mbcm_dpp_fc_rec_inbnd_get;
    ...
    /* mbcm_dpp_ofp_rates_port_priority_shaper_set_f mbcm_dpp_ofp_rates_port_priority_shaper_set;
    mbcm_dpp_ofp_rates_port_priority_shaper_get_f mbcm_dpp_ofp_rates_port_priority_shaper_get;
    mbcm_dpp_ofp_rates_tcg_shaper_set_f           mbcm_dpp_ofp_rates_tcg_shaper_set;
    mbcm_dpp_ofp_rates_tcg_shaper_get_f           mbcm_dpp_ofp_rates_tcg_shaper_get; */
    ...
    mbcm_dpp_itm_vsq_index_fc_group2global_f         mbcm_dpp_itm_vsq_index_fc_group2global;

    mbcm_dpp_drv_allocate_tm_port_in_range_and_recycle_channel_f mbcm_dpp_drv_allocate_tm_port_in_range_and_recycle_channel;
    ...
    mbcm_dpp_port_to_dynamic_interface_map_set_f                        mbcm_dpp_port_to_dynamic_interface_map_set;
    mbcm_dpp_port_to_dynamic_interface_unmap_set_f                      mbcm_dpp_port_to_dynamic_interface_unmap_set;                                                            
...
extern CONST mbcm_dpp_functions_t *mbcm_dpp_driver[BCM_MAX_NUM_UNITS]; /* USE _CALL MACRO FOR DISPATCH */
...
#define MBCM_DPP_DRIVER_CALL(unit, function, args) (((unit < BCM_MAX_NUM_UNITS) && mbcm_dpp_driver[unit] && mbcm_dpp_driver[unit]->function)?mbcm_dpp_driver[unit]->function args:SOC_SAND_ERR)
...
/* The argumnet should be in parentheses and to include the unit, i.e. (unit, arg1, arg2, ...) */
#define MBCM_DPP_SOC_DRIVER_CALL(unit, function, args) (((unit < BCM_MAX_NUM_UNITS) && mbcm_dpp_driver[unit] && mbcm_dpp_driver[unit]->function)?mbcm_dpp_driver[unit]->function args: SOC_E_UNAVAIL)
