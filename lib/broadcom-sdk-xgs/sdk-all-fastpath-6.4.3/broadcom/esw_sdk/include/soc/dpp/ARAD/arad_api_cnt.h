...
#define ARAD_CNT_NOF_PROCESSOR_IDS                           SOC_TMC_CNT_NOF_PROCESSOR_IDS_ARAD
typedef SOC_TMC_CNT_PROCESSOR_ID                               ARAD_CNT_PROCESSOR_ID;

#define ARAD_CNT_MODE_ING_NO_COLOR                           SOC_TMC_CNT_MODE_ING_NO_COLOR
#define ARAD_CNT_MODE_ING_COLOR_RES_LOW                      SOC_TMC_CNT_MODE_ING_COLOR_RES_LOW
#define ARAD_CNT_MODE_ING_COLOR_RES_HI                       SOC_TMC_CNT_MODE_ING_COLOR_RES_HI
#define ARAD_CNT_MODE_ING_COLOR_ENQ_HI                       SOC_TMC_CNT_MODE_ING_COLOR_RES_ENQ_HI
#define ARAD_CNT_NOF_MODE_INGS                               SOC_TMC_CNT_NOF_MODE_INGS_ARAD
#define ARAD_CNT_MODE_ING_FWD_NO_COLOR                       SOC_TMC_CNT_MODE_ING_FWD_NO_COLOR
#define ARAD_CNT_MODE_ING_DROP_NO_COLOR                      SOC_TMC_CNT_MODE_ING_DROP_NO_COLOR
#define ARAD_CNT_MODE_ING_ALL_NO_COLOR                       SOC_TMC_CNT_MODE_ING_ALL_NO_COLOR
#define ARAD_CNT_MODE_ING_CONFIGURABLE_OFFSETS               SOC_TMC_CNT_MODE_ING_CONFIGURABLE_OFFSETS
typedef SOC_TMC_CNT_MODE_ING                                   ARAD_CNT_MODE_ING;
...
#define ARAD_CNT_MODE_ING_FWD_SIMPLE_COLOR                  SOC_TMC_CNT_MODE_ING_FWD_SIMPLE_COLOR
#define ARAD_CNT_MODE_ING_DROP_SIMPLE_COLOR                 SOC_TMC_CNT_MODE_ING_DROP_SIMPLE_COLOR
...
#define ARAD_CNT_SRC_TYPE_ING_PP_MSB                         SOC_TMC_CNT_SRC_TYPE_ING_PP_MSB
#define ARAD_CNT_SRC_TYPE_ING_PP_2_LSB                       SOC_TMC_CNT_SRC_TYPE_ING_PP_2_LSB
#define ARAD_CNT_SRC_TYPE_ING_PP_2_MSB                       SOC_TMC_CNT_SRC_TYPE_ING_PP_2_MSB
#define ARAD_CNT_SRC_TYPE_EG_PP_MSB                          SOC_TMC_CNT_SRC_TYPE_EGR_PP_MSB 
#define ARAD_CNT_SRC_TYPE_OAM_ING_A                          SOC_TMC_CNT_SRC_TYPE_OAM_ING_A
#define ARAD_CNT_SRC_TYPE_OAM_ING_B                          SOC_TMC_CNT_SRC_TYPE_OAM_ING_B
#define ARAD_CNT_SRC_TYPE_OAM_ING_C                          SOC_TMC_CNT_SRC_TYPE_OAM_ING_C
#define ARAD_CNT_SRC_TYPE_OAM_ING_D                          SOC_TMC_CNT_SRC_TYPE_OAM_ING_D
#define ARAD_CNT_SRC_TYPE_EPNI_A                           SOC_TMC_CNT_SRC_TYPE_EPNI_A
#define ARAD_CNT_SRC_TYPE_EPNI_B                           SOC_TMC_CNT_SRC_TYPE_EPNI_B
#define ARAD_CNT_SRC_TYPE_EPNI_C                           SOC_TMC_CNT_SRC_TYPE_EPNI_C
#define ARAD_CNT_SRC_TYPE_EPNI_D                           SOC_TMC_CNT_SRC_TYPE_EPNI_D
