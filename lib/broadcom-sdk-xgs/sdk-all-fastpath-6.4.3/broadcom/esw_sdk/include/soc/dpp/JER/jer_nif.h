...
int soc_jer_portmod_port_enable_set(int unit, soc_port_t port, int enable);
...
int soc_jer_qsgmii_offsets_add(int unit, soc_pbmp_t* pbmp, soc_pbmp_t* new_pbmp);
int soc_jer_qsgmii_offsets_remove(int unit, soc_pbmp_t* pbmp, soc_pbmp_t* new_pbmp);
