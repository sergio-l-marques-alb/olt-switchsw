...
#define SOC_TMC_ITM_NOF_VSQS 356
...
#define SOC_TMC_ITM_VSQ_QT_RT_CLS_MAX  15
...
typedef enum
{
   ...
   */
  SOC_TMC_ITM_VSQ_GROUPA_SZE=4,
  /*
   *  32: Category & Traffic Class VSQs
   *      4 categories * 8 Traffic Classes
   */
  SOC_TMC_ITM_VSQ_GROUPB_SZE=32,
  /*
   *  64: 32 Category2/3 & Connection Class VSQs.
   *  (2 Category2/3 * 32 Connection Class)
   */
  SOC_TMC_ITM_VSQ_GROUPC_SZE=64,
  /*
   *  256: Statistics VSQs
   */
  SOC_TMC_ITM_VSQ_GROUPD_SZE=256,
  /*
  *  32: LLFCs
  */
  SOC_TMC_ITM_VSQ_GROUPE_SZE=32,
  /*
  *  256: PFCs
  */
  SOC_TMC_ITM_VSQ_GROUPF_SZE=256,
  /*
   *  Must be the last value
   */
  SOC_TMC_ITM_VSQ_GROUP_SIZE_LAST
}SOC_TMC_ITM_VSQ_GROUP_SIZE;
...
typedef enum
{
   ...
   */
  SOC_TMC_ITM_VSQ_NDX_MIN=0,
  /*
   *  ITM-VSQ last index = sum of group sizes:Value 355.
   */
  SOC_TMC_ITM_VSQ_NDX_MAX_PETRA=(SOC_TMC_ITM_VSQ_GROUPA_SZE+SOC_TMC_ITM_VSQ_GROUPB_SZE+SOC_TMC_ITM_VSQ_GROUPC_SZE+SOC_TMC_ITM_VSQ_GROUPD_SZE-1),
  /*
   *  Must be the last value
   */
  SOC_TMC_ITM_VSQ_NDX_RNG_LAST_PETRA,
  SOC_TMC_ITM_VSQ_NDX_MAX_ARAD=(SOC_TMC_ITM_VSQ_GROUPA_SZE+SOC_TMC_ITM_VSQ_GROUPB_SZE+SOC_TMC_ITM_VSQ_GROUPC_SZE+SOC_TMC_ITM_VSQ_GROUPD_SZE +SOC_TMC_ITM_VSQ_GROUPE_SZE +SOC_TMC_ITM_VSQ_GROUPF_SZE -1),
  /*
  *  Must be the last value
  */
  SOC_TMC_ITM_VSQ_NDX_RNG_LAST_ARAD
}SOC_TMC_ITM_VSQ_NDX_RNG;
...
typedef struct
{
  SOC_SAND_MAGIC_NUM_VAR
  /*
   *  Indicator:1 - enable WRED test0 - disable test (always
   *  accept)
   */
  uint8 wred_en;
  /*
...
typedef struct
{
   ...
   */
  uint32 bds_rang_vals[SOC_TMC_ITM_SYS_RED_BUFFS_RNGS];
