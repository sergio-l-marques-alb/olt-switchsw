 ...
 *  */
    ...
    #define FUNC_RESULT_SOC_PRINT(f_res) _bsl_error(_ERR_MSG_MODULE_NAME, unit, " %s\n", soc_errmsg(f_res)); 
    #define SOC_SAND_SOC_ERR(stuff)   _bsl_error(_ERR_MSG_MODULE_NAME, BSL_UNIT_UNKNOWN, " %s\n", soc_errmsg(f_res));
...
/* 
 * When  _ERR_MSG_MODULE_NAME is defined (presuimably in module SOCDNX)
