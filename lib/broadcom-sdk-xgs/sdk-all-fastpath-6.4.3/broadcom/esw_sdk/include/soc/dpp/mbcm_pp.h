...
typedef int (*mbcm_pp_bfd_ipv4_1_hop_lem_entry_add_f)
(int,  int, int);

typedef int (*mbcm_pp_bfd_ipv4_1_hop_lem_entry_remove_f)
(int,  int);
...
typedef struct mbcm_pp_functions_s {
	...
	mbcm_pp_bfd_ipv4_1_hop_lem_entry_add_f 		mbcm_pp_bfd_ipv4_1_hop_lem_entry_add;
	mbcm_pp_bfd_ipv4_1_hop_lem_entry_remove_f 		mbcm_pp_bfd_ipv4_1_hop_lem_entry_remove;
