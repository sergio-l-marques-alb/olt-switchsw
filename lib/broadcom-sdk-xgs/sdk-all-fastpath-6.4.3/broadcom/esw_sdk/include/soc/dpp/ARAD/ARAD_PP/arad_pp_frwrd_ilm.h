...
typedef enum
{
   ...
   */
  ARAD_PP_FRWRD_ILM_GLBL_INFO_SET = ARAD_PP_PROC_DESC_BASE_FRWRD_ILM_FIRST,
  ARAD_PP_FRWRD_ILM_GLBL_INFO_SET_PRINT,
  ARAD_PP_FRWRD_ILM_GLBL_INFO_SET_UNSAFE,
  ARAD_PP_FRWRD_ILM_GLBL_INFO_SET_VERIFY,
  ARAD_PP_FRWRD_ILM_GLBL_INFO_GET,
  ARAD_PP_FRWRD_ILM_GLBL_INFO_GET_PRINT,
