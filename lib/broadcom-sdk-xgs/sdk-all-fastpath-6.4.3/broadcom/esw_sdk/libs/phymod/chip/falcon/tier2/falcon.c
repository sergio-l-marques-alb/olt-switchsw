...
int falcon_phy_tx_lane_control_set(const phymod_phy_access_t* phy, uint32_t enable)
{
    ...
    /* Not supported */
    PHYMOD_DEBUG_ERROR(("This function is NOT SUPPORTED!! (falcon_phy_tx_lane_control_set) \n"));
...
int falcon_phy_reset_set(const phymod_phy_access_t* phy, const phymod_phy_reset_t* reset)
{
    ...
    switch (reset->rx) {
          case phymodResetDirectionIn:
              PHYMOD_IF_ERR_RETURN(falcon_force_rx_set_rst(&phy->access, 0x1));
          break;
          case phymodResetDirectionOut:
              PHYMOD_IF_ERR_RETURN(falcon_force_rx_set_rst(&phy->access, 0x0));
          break;
    ...
    switch (reset->tx) {
          case phymodResetDirectionIn:
              PHYMOD_IF_ERR_RETURN(falcon_force_tx_set_rst(&phy->access, 0x1));
          break;
          case phymodResetDirectionOut:
              PHYMOD_IF_ERR_RETURN(falcon_force_tx_set_rst(&phy->access, 0x0));
          break;
          case phymodResetDirectionInOut:
              PHYMOD_IF_ERR_RETURN(falcon_force_tx_set_rst(&phy->access, 0x1));
              PHYMOD_USLEEP(10);
...
int falcon_phy_reset_get(const phymod_phy_access_t* phy, phymod_phy_reset_t* reset)
{
    ...
    uint32_t rst;
    PHYMOD_IF_ERR_RETURN(falcon_force_tx_get_rst(&phy->access, &rst));    
    if(rst == 0) {
       reset->tx = phymodResetDirectionOut;
    } else {
       reset->tx = phymodResetDirectionIn;
    }
    PHYMOD_IF_ERR_RETURN(falcon_force_rx_get_rst(&phy->access, &rst));    
    if(rst == 0) {
                                    ...
                                    const phymod_phy_inf_config_t* config)
{
    ...
    if(config->ref_clock == phymodRefClk156Mhz) {
        switch (config->data_rate) {
          case 6250 :   /* speed 6.25G     */
            new_pll_div = 0x6; new_os_mode = 3; vco_rate = 25000;
            break;

          case 10312:   /* speed 10.3125G  */
            new_pll_div = 0x4; new_os_mode = 2; vco_rate = 20625;
            break;

          case 10937:   /* speed 10.9375G  */
            new_pll_div = 0x5; new_os_mode = 2; vco_rate = 21875;
            break;
          ...
          case 25781:   /* speed 25.78125G */
            new_pll_div = 0x7; new_os_mode = 1; vco_rate = 25781;
            break;
        ...
        switch (config->data_rate) {
          ...
          case 5750:   /* speed 5.75G     */
            new_pll_div = 0xc; new_os_mode = 3; vco_rate = 23000;
            break;

          case 6250:   /* speed 6.25G     */
            new_pll_div = 0xd; new_os_mode = 3; vco_rate = 25000;
            break;

          case 10312:   /* speed 10.3125G  */
            new_pll_div = 0x7; new_os_mode = 2; vco_rate = 20625;
            break;

          case 11250:   /* speed 11.25G    */
            new_pll_div = 0xb; new_os_mode = 2; vco_rate = 22500;
            break;
    ...
    */
    ...
    PHYMOD_IF_ERR_RETURN
        (falcon_osr_mode_set(&phy->access, new_os_mode));
