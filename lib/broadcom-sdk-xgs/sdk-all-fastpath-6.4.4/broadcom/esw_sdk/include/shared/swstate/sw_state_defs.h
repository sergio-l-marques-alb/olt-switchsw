 ...
 *       sw state.
 *       if we look at the sw state as a tree, then the root lies at soc_sw_state_t,
 ...
 *  
 */
#ifndef _SOC_SW_STATE_DEFS_H
#define _SOC_SW_STATE_DEFS_H
...
typedef struct soc_sw_state_s {
    soc_dpp_sw_state_t  dpp;
} soc_sw_state_t;

extern soc_sw_state_t *sw_state[BCM_MAX_NUM_UNITS];

#endif /* _SOC_SW_STATE_DEFS_H */
