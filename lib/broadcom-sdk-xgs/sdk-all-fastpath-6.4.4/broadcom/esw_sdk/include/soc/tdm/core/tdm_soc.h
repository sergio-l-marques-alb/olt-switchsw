...
enum port_state_e {
	PORT_STATE__DISABLED=0,
	PORT_STATE__LINERATE=1,
	PORT_STATE__OVERSUB=2,
	PORT_STATE__COMBINE=3,
	PORT_STATE__LINERATE_EN=4,
	PORT_STATE__OVERSUB_EN=5,	
	PORT_STATE__LINERATE_HG=6,
	PORT_STATE__OVERSUB_HG=7,
	PORT_STATE__MANAGEMENT=6,
	PORT_STATE__MUTABLE=10,
	PORT_STATE__CARDINAL=11
};
