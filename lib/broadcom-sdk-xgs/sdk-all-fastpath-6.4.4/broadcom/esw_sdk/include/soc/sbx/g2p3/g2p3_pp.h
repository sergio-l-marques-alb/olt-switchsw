...
/*
 * $Id: g2p3_pp.h,v 1.24 Broadcom SDK $
 *
...
typedef uint32 soc_sbx_g2p3_pp_lsmid_t;
typedef uint32 soc_sbx_g2p3_pp_l2cptunnelid_t;
typedef uint32 soc_sbx_g2p3_pp_tunnel_id_t;
typedef uint32 soc_sbx_g2p3_pp_tcp_filter_id_t;
typedef uint32 soc_sbx_g2p3_pp_udp_filter_id_t;
