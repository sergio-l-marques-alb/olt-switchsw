/* $Id: arad_pp_api_mpls_term.h,v 1.6 Broadcom SDK $
...
#ifndef __ARAD_PP_API_MPLS_TERM_INCLUDED__
/* { */
#define __ARAD_PP_API_MPLS_TERM_INCLUDED__
...
#define  ARAD_PP_MPLS_TERM_NOF_RESERVED_LABELS (SOC_PPC_MPLS_TERM_NOF_RESERVED_LABELS)

/*     Maximum number of terminated                    */
#define  ARAD_PP_MPLS_TERM_MAX_NOF_TERM_LABELS (SOC_PPC_MPLS_TERM_MAX_NOF_TERM_LABELS)
...
#define ARAD_PP_MPLS_TERM_MODEL_PIPE                       SOC_PPC_MPLS_TERM_MODEL_PIPE
#define ARAD_PP_MPLS_TERM_MODEL_UNIFORM                    SOC_PPC_MPLS_TERM_MODEL_UNIFORM
#define ARAD_PP_NOF_MPLS_TERM_MODEL_TYPES                  SOC_PPC_NOF_MPLS_TERM_MODEL_TYPES
#define ARAD_PP_MPLS_TERM_PROCESSING_TYPE_MAX              (ARAD_PP_NOF_MPLS_TERM_MODEL_TYPES-1)
typedef SOC_PPC_MPLS_TERM_MODEL_TYPE                           ARAD_PP_MPLS_TERM_MODEL_TYPE;

#define ARAD_PP_MPLS_TERM_KEY_TYPE_LABEL                   SOC_PPC_MPLS_TERM_KEY_TYPE_LABEL
#define ARAD_PP_MPLS_TERM_KEY_TYPE_LABEL_RIF               SOC_PPC_MPLS_TERM_KEY_TYPE_LABEL_RIF
#define ARAD_PP_NOF_MPLS_TERM_KEY_TYPES                    SOC_PPC_NOF_MPLS_TERM_KEY_TYPES
typedef SOC_PPC_MPLS_TERM_KEY_TYPE                             ARAD_PP_MPLS_TERM_KEY_TYPE;

typedef SOC_PPC_MPLS_TERM_LABEL_RANGE                          ARAD_PP_MPLS_TERM_LABEL_RANGE;
typedef SOC_PPC_MPLS_TERM_LKUP_INFO                            ARAD_PP_MPLS_TERM_LKUP_INFO;
typedef SOC_PPC_MPLS_TERM_INFO                                 ARAD_PP_MPLS_TERM_INFO;
typedef SOC_PPC_MPLS_TERM_LABEL_RANGE_INFO                     ARAD_PP_MPLS_TERM_LABEL_RANGE_INFO;
typedef SOC_PPC_MPLS_TERM_RESERVED_LABEL_INFO                  ARAD_PP_MPLS_TERM_RESERVED_LABEL_INFO;
typedef SOC_PPC_MPLS_TERM_RESERVED_LABELS_GLBL_INFO            ARAD_PP_MPLS_TERM_RESERVED_LABELS_GLBL_INFO;
typedef SOC_PPC_MPLS_TERM_COS_INFO                             ARAD_PP_MPLS_TERM_COS_INFO;
typedef SOC_PPC_MPLS_TERM_LABEL_COS_KEY                        ARAD_PP_MPLS_TERM_LABEL_COS_KEY;
typedef SOC_PPC_MPLS_TERM_LABEL_COS_VAL                        ARAD_PP_MPLS_TERM_LABEL_COS_VAL;
typedef SOC_PPC_MPLS_TERM_PROFILE_INFO                         ARAD_PP_MPLS_TERM_PROFILE_INFO;
...
#define ARAD_PP_MPLS_TERM_RESERVED_LABEL_ELI               SOC_PPC_MPLS_TERM_RESERVED_LABEL_ELI
#define ARAD_PP_MPLS_TERM_RESERVED_LABEL_GAL               SOC_PPC_MPLS_TERM_RESERVED_LABEL_GAL
#define ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV4_EXP          SOC_PPC_MPLS_TERM_RESERVED_LABEL_IPV4_EXP
#define ARAD_PP_MPLS_TERM_RESERVED_LABEL_IPV6_EXP          SOC_PPC_MPLS_TERM_RESERVED_LABEL_IPV6_EXP
 ...
 *     "arad_pp_mpls_term_lkup_info_set" API.
 *     Refer to "arad_pp_mpls_term_lkup_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_mpls_term_label_range_set" API.
 *     Refer to "arad_pp_mpls_term_label_range_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_mpls_term_range_terminated_label_set" API.
 *     Refer to "arad_pp_mpls_term_range_terminated_label_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_mpls_term_reserved_labels_global_info_set" API.
 *     Refer to
 *     "arad_pp_mpls_term_reserved_labels_global_info_set" API
 *     for details.
*********************************************************************/
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_mpls_term_reserved_label_info_set" API.
 *     Refer to "arad_pp_mpls_term_reserved_label_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_mpls_term_cos_info_set" API.
 *     Refer to "arad_pp_mpls_term_cos_info_set" API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_mpls_term_label_to_cos_info_set" API.
 *     Refer to "arad_pp_mpls_term_label_to_cos_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __ARAD_PP_API_MPLS_TERM_INCLUDED__*/
#endif
