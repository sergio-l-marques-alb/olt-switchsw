...
/* $Id: arad_pp_api_frwrd_trill.h,v 1.9 Broadcom SDK $
...
#ifndef __ARAD_PP_API_FRWRD_TRILL_INCLUDED__
/* { */
#define __ARAD_PP_API_FRWRD_TRILL_INCLUDED__
 ...
 *     Adjacent NickName.                                      */
#define  ARAD_PP_TRILL_MC_IGNORE_FIELD (SOC_PPC_TRILL_MC_IGNORE_FIELD)

/*     Use to accept SA from all source system ports in
 *     soc_ppd_frwrd_trill_ adj _info_set ()                       */
#define  ARAD_PP_TRILL_ACCEPT_ALL_PORTS (SOC_PPC_TRILL_ACCEPT_ALL_PORTS)
...
typedef SOC_PPC_TRILL_MC_MASKED_FIELDS                         ARAD_PP_TRILL_MC_MASKED_FIELDS;
typedef SOC_PPC_TRILL_MC_ROUTE_KEY                             ARAD_PP_TRILL_MC_ROUTE_KEY;
typedef SOC_PPC_TRILL_ADJ_INFO                                 ARAD_PP_TRILL_ADJ_INFO;
typedef SOC_PPC_FRWRD_TRILL_GLOBAL_INFO                        ARAD_PP_FRWRD_TRILL_GLOBAL_INFO;
 ...
 *     "arad_pp_frwrd_trill_multicast_key_mask_set" API.
 *     Refer to "arad_pp_frwrd_trill_multicast_key_mask_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_frwrd_trill_adj_info_set" API.
 *     Refer to "arad_pp_frwrd_trill_adj_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
 *     Gets the configuration set by the
 *     "arad_pp_frwrd_trill_global_info_set" API.
 *     Refer to "arad_pp_frwrd_trill_global_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __ARAD_PP_API_FRWRD_TRILL_INCLUDED__*/
#endif
