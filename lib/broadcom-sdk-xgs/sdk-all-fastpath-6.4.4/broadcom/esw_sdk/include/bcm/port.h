...
#define BCM_PORT_IF_SR2         _SHR_PORT_IF_SR2 
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_PORT_EXTENDED_PORT_VID_VLAN = 27, /* Mod/port/trunk + Extender port VID +
                                           VLAN */
    BCM_PORT_MATCH_COUNT = 28           /* Must be last */
} bcm_port_match_t;
