...
int eagle_phy_pattern_config_set(const phymod_phy_access_t* phy, const phymod_pattern_t* pattern)
{
    ...
    /* Not supported */
    PHYMOD_DEBUG_ERROR(("eagle_phy_pattern_config_set function is NOT SUPPORTED!!\n"));
...
int eagle_phy_pattern_config_get(const phymod_phy_access_t* phy, phymod_pattern_t* pattern)
{
    ...
    /* Not supported */
    PHYMOD_DEBUG_ERROR(("eagle_phy_pattern_config_get function is NOT SUPPORTED!!\n"));
...
int eagle_phy_pattern_enable_set(const phymod_phy_access_t* phy, uint32_t enable)
{
    ...
    /* Not supported */
    PHYMOD_DEBUG_ERROR(("eagle_phy_pattern_enable_set function is NOT SUPPORTED!!\n"));
...
int eagle_phy_pattern_enable_get(const phymod_phy_access_t* phy, uint32_t* enable)
{
    ...
    /* Not supported */
    PHYMOD_DEBUG_ERROR(("eagle_phy_pattern_enable_get function is NOT SUPPORTED!!\n"));
