...
int _eagle_pll_multiplier_get(enum eagle_tsc_pll_enum pll_div, uint32_t *pll_multiplier)
{
    switch (pll_div) {
...
int _eagle_actual_osr_get(int osr_mode, int* actual_os)
{
    switch(osr_mode) {
        case 1: *actual_os = 1; break;
        case 2: *actual_os = 2; break;
        case 3: *actual_os = 3; break;
        /* case 4: *actual_os = 3.3; break; */
        case 5: *actual_os = 4; break;
        case 6: *actual_os = 5; break;
        /* case 7: *actual_os = 7.5; break; */
        case 8: *actual_os = 8; break;
        /* case 9: *actual_os = 8.25; break; */
        case 10: *actual_os = 10; break;
        default:
...
int eagle_phy_interface_config_set(const phymod_phy_access_t* phy, uint32_t flags, const phymod_phy_inf_config_t* config)
{
    ...
    firmware_lane_config.DfeOn = 0; /* CHECK */
    ...
    if(config->ref_clock == phymodRefClk156Mhz) {
        switch (config->data_rate) {
          case 5750 :   /* speed 5.75G ; fracn pll= 73.6    */
            new_pll_div = EAGLE_TSC_pll_div_73p6x; new_os_mode = 2; vco_rate = 11500; /* vco_rate = 24 */
            break;

          case 6250:   /* speed 6.25G: pll_div=40  */
            new_pll_div = EAGLE_TSC_pll_div_40x;  new_os_mode = 1; vco_rate = 6250; /* vco_rate= 3 */
            break;

          case 10312:   /* speed 10.3G; pll_div = 66  */
            new_pll_div = EAGLE_TSC_pll_div_66x; new_os_mode = 1; vco_rate = 103125; /* vco_rate = 19 */
            firmware_lane_config.DfeOn = 1;
            break;

          case 11500:   /* speed 11.5G ; fracn pll= 73.6    */
            new_pll_div = EAGLE_TSC_pll_div_73p6x; new_os_mode = 1; vco_rate = 11500; /* vco_rate = 24 */
            break;

          case 12500:   /* speed 11.5G ; pll_div = 80    */
            new_pll_div = EAGLE_TSC_pll_div_80x; new_os_mode = 1; vco_rate = 12500; /* vco_rate =  */
            break;

          default:
            PHYMOD_RETURN_WITH_ERR(PHYMOD_E_CONFIG,
            (_PHYMOD_MSG("Unsupported speed :: %d :: at ref clk :: %d"),
          ...
          case 5750 :   /* speed 5.75G ; fracn pll= 46    */
            new_pll_div = EAGLE_TSC_pll_div_46x; new_os_mode = 1; vco_rate =5750; /* vco_rate =  */
            break;

          case 6250:   /* speed 6.25G: pll_div=50  */
            new_pll_div = EAGLE_TSC_pll_div_50x;  new_os_mode = 1; vco_rate = 6250; /* vco_rate= 3 */
            break;

          case 10300:   /* speed 10.3G; pll_div = 82.5  */
            new_pll_div = EAGLE_TSC_pll_div_82p5x; new_os_mode = 1; vco_rate = 10312; /* vco_rate = 19 */
            firmware_lane_config.DfeOn = 1;
            break;

          case 11500:   /* speed 11.5G ; fracn pll= 92    */
            new_pll_div = EAGLE_TSC_pll_div_92x; new_os_mode = 1; vco_rate = 11500; /* vco_rate = 24 */
            break;
      ...
      PHYMOD_RETURN_WITH_ERR(PHYMOD_E_CONFIG,
      (_PHYMOD_MSG("Unsupported ref clk :: %d"), config->ref_clock));
    }
...
*/
    ...
    */
    for (i = 0; i < num_lane; i++) {
        ...
        PHYMOD_IF_ERR_RETURN
             (eagle_phy_firmware_lane_config_set(&pm_phy_copy, firmware_lane_config));
    }
...
*/
    ...
    PHYMOD_IF_ERR_RETURN(_eagle_actual_osr_get(osr_mode, &actual_osr));
