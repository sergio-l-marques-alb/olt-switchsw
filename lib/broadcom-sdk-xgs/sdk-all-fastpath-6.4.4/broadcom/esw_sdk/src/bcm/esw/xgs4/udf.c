...
bcmi_xgs4_udf_wb_scache_size_get(int unit, int *req_scache_size)
{
    if (BCM_WB_DEFAULT_VERSION == BCM_WB_VERSION_1_0) {
        return bcmi_xgs4_udf_wb_scache_size_get_1_0(unit, req_scache_size);
    }
...
bcmi_xgs4_udf_wb_sync(int unit)
{
    ...
    return bcmi_xgs4_udf_wb_sync_1_0(unit, &scache_ptr);
}
...
bcmi_xgs4_udf_reinit(int unit)
{
    ...
    if (recovered_ver == BCM_WB_VERSION_1_0) {
        return bcmi_xgs4_udf_wb_reinit_1_0(unit, &scache_ptr);
    }
 ...
 *      options         (IN) See bcm_xgs4_udf_HASH_ADD_O_xxx
