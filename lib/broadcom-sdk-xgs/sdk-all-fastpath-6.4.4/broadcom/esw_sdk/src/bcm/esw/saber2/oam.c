...
/* Pool 1 (index 0) has 2K entries compared to 1K entries
   in Pool 2 and Pool 3 (indexes 1 and 2). Hence counter
   allocation will be done twice from pool 1 (index 0) and
   once from pools 2 and 3 (indexes 1 and 2) for each cycle
   Ratio 2: 1: 1
 */
int  pool_allocation_array[4] = {0, 0, 1, 2}; 
int _bcm_sb2_oam_last_allocated_counter_pool_arr_index = 3;
...
#define BCM_OAM_BHH_GET_UKERNEL_EP(ep) \
        (ep - _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET)
...
#define BCM_OAM_BHH_VALIDATE_EP(_ep_) \
            do {                                                       \
                if (((_ep_) < _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET) ||         \
                    ((_ep_) >= (_BCM_OAM_BHH_SB2_ENDPOINT_OFFSET           \
...
STATIC int
_bcm_sb2_oam_bhh_session_hw_delete(int unit, _bcm_oam_hash_data_t *h_data_p);
STATIC int
...
STATIC mep_ctr_info_t sb2_mep_ctr_info[] = {     
...
int _bcm_sb2_oam_get_new_ctr_pool_id(int *arr_index)  
{
    int last_arr_index = _bcm_sb2_oam_last_allocated_counter_pool_arr_index;
    *arr_index = last_arr_index + 1;
    return pool_allocation_array[(last_arr_index + 1) % 4]; 
}
                                        ...
                                        bcm_vlan_t inner_vlan, int *key_type)
{
    if((type == bcmOAMEndpointTypeMplsLmDmSectionPort) ||
       (type == bcmOAMEndpointTypeBhhSection)) {
        *key_type = _BCM_OAM_DOMAIN_MPLS_SECTION;
    } else if(
           (type == bcmOAMEndpointTypeMplsLmDmSectionInnervlan) ||
           (type == bcmOAMEndpointTypeBhhSectionInnervlan)) {
        *key_type = _BCM_OAM_DOMAIN_MPLS_SECTION_CVLAN;
    } else if(
           (type == bcmOAMEndpointTypeMplsLmDmSectionOuterVlan) ||
           (type == bcmOAMEndpointTypeBhhSectionOuterVlan)) {
        *key_type = _BCM_OAM_DOMAIN_MPLS_SECTION_SVLAN;
    } else if(
      ...
      (type == bcmOAMEndpointTypeBHHMPLSVccv)) {
        *key_type = _BCM_OAM_DOMAIN_MPLS_LMDM_PW;
    } else if(
      (type == bcmOAMEndpointTypeMplsLmDmLsp) ||
      (type == bcmOAMEndpointTypeBHHMPLS)) {
        *key_type = _BCM_OAM_DOMAIN_ING_MPLS_LMDM_LSP;
                                           ...
                                           uint32 opcode)
{
    ...
    switch(opcode) {
        case _BCM_OAM_OPCODE_TYPE_CCM:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_CCM;
            break;
        case _BCM_OAM_OPCODE_TYPE_LBR:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_LBR;
            break;
        case _BCM_OAM_OPCODE_TYPE_LBM:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_LBM;
            break;
        case _BCM_OAM_OPCODE_TYPE_LTR:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_LTR;
            break;
        case _BCM_OAM_OPCODE_TYPE_LTM:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_LTM;
            break;

        case _BCM_OAM_OPCODE_TYPE_LMM: 
        case _BCM_OAM_OPCODE_TYPE_1DM:
        case _BCM_OAM_OPCODE_TYPE_DMM:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_OTHER_1;
            break;
        case _BCM_OAM_OPCODE_TYPE_LMR:
        case _BCM_OAM_OPCODE_TYPE_DMR:
            return _BCM_SB2_OPCODE_GROUP_ETH_OAM_OTHER_2;
            break;
    } 
...
_bcm_sb2_oam_lookup_interface_priorities_init (int unit)
{
    ...
    uint32 intf0_select = 0;
    uint32 intf1_select = 1;
    uint32 intf2_select = 2;
    uint32 intf3_select = 3;
    uint32 intf4_select = 4;
    uint32 intf5_select = 5;
    uint32 intf6_select = 6;
    uint32 intf7_select = 7;
    uint32 intf8_select = 8;
    uint32 intf9_select = 9;

    /* Default intf selection values for Egress */
    uint32 egr_intf0_select = 9;
    uint32 egr_intf1_select = 8;
    uint32 egr_intf2_select = 7;
    uint32 egr_intf3_select = 6;
    uint32 egr_intf4_select = 5;
    uint32 egr_intf5_select = 4;
    uint32 egr_intf6_select = 3;
    uint32 egr_intf7_select = 2;
    uint32 egr_intf8_select = 1;
    uint32 egr_intf9_select = 0;
...
_bcm_sb2_oam_mpls_oam_ach_type_config_init(int unit)
{
    ...
    _bcm_sb2_mpls_oam_ach_type_config_entry_t entry_info[]= {
        /* Valid, 
           ...
           protocol_type
         */
        {1, 0x8902, 0, -1, 0, 0}, /* BHH OAM */
        {1, 0x000A, 1, bcmOamMplsLmDmOpcodeTypeLm, 0, 1}, /* MPLS LM */
        {1, 0x000B, 1, bcmOamMplsLmDmOpcodeTypeIlm, 0, 1}, /* MPLS ILM */ 
        {1, 0x000C, 1, bcmOamMplsLmDmOpcodeTypeDm, 0, 1}, /* MPLS DM */
        {1, 0x000D, 1, bcmOamMplsLmDmOpcodeTypeLmPlusDm, 0, 1}, /* MPLS LM + DM */
        {1, 0x000E, 1, bcmOamMplsLmDmOpcodeTypeIlmPlusDm, 0, 1}, /* MPLS ILM + DM */
                                         ...
                                         void *mp_group_key_p)
{
    ...
    if ((MPLS_LM_DM_SECTION_ENDPOINT_TYPE(h_data_p)) ||
        ...
        if ((h_data_p->type == bcmOAMEndpointTypeMplsLmDmSectionPort) ||
            ...
            values[0] = _BCM_OAM_DOMAIN_MPLS_SECTION;
            ...
            values[0] = _BCM_OAM_DOMAIN_MPLS_SECTION_CVLAN;
            ...
            values[0] = _BCM_OAM_DOMAIN_MPLS_SECTION_SVLAN;
            ...
            values[0] = _BCM_OAM_DOMAIN_MPLS_SECTION_S_PLUS_CVLAN;
        ...
        fields[0] = KEY_TYPEf;
        if (is_egress) {
            values[0] = _BCM_OAM_DOMAIN_EGR_MPLS_LMDM_LSP;
            ...
            values[0] = _BCM_OAM_DOMAIN_ING_MPLS_LMDM_LSP;
        ...
        fields[0] = KEY_TYPEf;
        values[0] = _BCM_OAM_DOMAIN_MPLS_LMDM_PW;
    ...
    if (!BHH_EP_TYPE(h_data_p)) {
        ...
        if (h_data_p->flags & BCM_OAM_ENDPOINT_PBB_TE) {
            ...
            if (bcm_tr_mpls_port_independent_range(unit, h_data_p->label, 
                ...
                /* SGLP contains generic logical port. */
                soc_MP_GROUPm_field32_set
                    (unit, mp_group_key_p, GLPf, 0xFFFF);
                
            }

            /* Set incoming MPLS Label */
            soc_MP_GROUPm_field32_set
                (unit, mp_group_key_p, MPLS_LABELf, h_data_p->label);
...
_bcm_sb2_oam_profile_tables_init(int unit, _bcm_oam_control_t *oc)
{
    ...
    ing_service_pri_map_0_entry_t pri_ent[BCM_OAM_INTPRI_MAX]; /* ing profile */
                                                             /* entry */
    egr_service_pri_map_0_entry_t egr_pri_ent[BCM_OAM_INTPRI_MAX]; /*egr profile*/
                                                             /* entry */
    bcm_module_t         modid;
    uint32      dglp = 0;
    ...
    entry_words = (sizeof(ing_service_pri_map_0_entry_t) / sizeof(uint32));
    ...
    if (BCM_FAILURE(rv)) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                  (BSL_META_U(unit,
                              "OAM(unit %d) Error: service map profile - Failed.\n"),
                   unit));
        return (rv);
    }
    if (!SOC_WARM_BOOT(unit)) {
        ...
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "OAM(unit %d) Error: service map init - Failed.\n"),
                       unit));
            return (rv);
        }
    }
    ...
    entry_words = (sizeof(egr_service_pri_map_0_entry_t) / sizeof(uint32));

    mem = EGR_SERVICE_PRI_MAP_0m;
    rv = soc_profile_mem_create(unit, &mem, &entry_words, 1,
                                &oc->egr_service_pri_map);
    if (BCM_FAILURE(rv)) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                  (BSL_META_U(unit,
                              "OAM(unit %d) Error: Egr service map profile - Failed.\n"),
                   unit));
        return (rv);
    }
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "OAM(unit %d) Error: Egress service map init - Failed.\n"),
                       unit));
            return (rv);
        }
    }
                         ...
                         int *pool_id) 
{
    ...
    if ((1 == ctr1_valid) && (1 == ctr2_valid)) {
        ...
        *pool_id = _bcm_sb2_oam_get_new_ctr_pool_id(&new_arr_index);
        ...
        /* Update the last allocated counter pool */
        _bcm_sb2_oam_last_allocated_counter_pool_arr_index = new_arr_index;
        *ctr_field_id = 0;
        ctr1_valid = 1;
...
/*
 * Function:
 *     _bcm_sb2_oam_service_pri_profile_add
 * Purpose:
 ...
 */
int
_bcm_sb2_oam_service_pri_profile_add(int unit, int egr, 
                                     bcm_oam_endpoint_info_t *endpoint_info,
                                  ...
                                  bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if (BCM_SUCCESS
        ...
        rv = _bcm_sb2_oam_service_pri_profile_add(unit, 0, ep_info_p,
                                                  &profile_index);
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM, \
                      (BSL_META_U(unit, \
        ...
        soc_MP_GROUPm_field32_set(unit, &mp_group_entry,
                     sb2_mep_ctr_info[ctr_field_id].ctr_profile, profile_index);
    ...
    if (BCM_SUCCESS(_bcm_sb2_oam_find_egr_lmep(unit, hash_data,
        ...
        /* Create SERVICE_PRI_MAP profile */
        rv = _bcm_sb2_oam_service_pri_profile_add(unit, 1, ep_info_p,
                                                  &profile_index);
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                ...
                                bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if ((tag_type == _BCM_OAM_DOMAIN_SVLAN) || 
        (tag_type == _BCM_OAM_DOMAIN_S_PLUS_CVLAN) ||
        (tag_type == _BCM_OAM_DOMAIN_MPLS_SECTION_SVLAN) ||
        (tag_type == _BCM_OAM_DOMAIN_MPLS_SECTION_S_PLUS_CVLAN)) { 
    ...
    if ((tag_type == _BCM_OAM_DOMAIN_CVLAN) || 
        /* C or S+C */
        (tag_type == _BCM_OAM_DOMAIN_S_PLUS_CVLAN)||
        (tag_type == _BCM_OAM_DOMAIN_MPLS_SECTION_CVLAN) ||
        (tag_type == _BCM_OAM_DOMAIN_MPLS_SECTION_S_PLUS_CVLAN)) { 
        rv = _bcm_sb2_tpid_entry_add(unit, 
     ...
     */
        ...
        if (h_data_p->is_remote) {
            ...
            */
            ...
            rv =  _bcm_sb2_oam_bhh_session_hw_delete(unit, h_data_p);
            if (BCM_FAILURE(rv) && rv != BCM_E_NOT_FOUND) {
                LOG_ERROR(BSL_LS_BCM_OAM,
                          (BSL_META_U(unit,
                                      "OAM(unit %d) Error: bhh_session_hw_delete failled " 
                                       "(EP=%d) - %s.\n"), unit, ep_id, bcm_errmsg(rv)));
                return (rv);
            }
...
/*
 * Function:
 *     _bcm_sb2_oam_macda_prefix_check_set
 * Purpose:
 ...
 */
STATIC int
_bcm_sb2_oam_macda_prefix_check_set(int unit)
{
    bcm_pbmp_t ports;
    bcm_port_t port;
    uint64 rval;
...
bcm_sb2_oam_init(int unit)
{
 ...
 if (soc_feature(unit, soc_feature_eth_lm_dm)) {
    ...
    rv = shr_idxres_list_reserve(oc->mep_pool, _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET,
                _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET + oc->bhh_endpoint_count - 1);
...
#endif
    {
        ...
        rv = _bcm_sb2_oam_macda_prefix_check_set(unit); 
        if (BCM_FAILURE(rv)) {
            _bcm_sb2_oam_control_free(unit, oc);
            return (rv);
        }
...
int
_bcm_sb2_oam_mpls_pw_egr_dvp_downmep_enable(int unit, _bcm_oam_hash_data_t *hash_data)
{
...
int 
_bcm_sb2_oam_mpls_lsp_mpls_table_downmep_enable(int unit, _bcm_oam_hash_data_t *hash_data)
{
#if defined(INCLUDE_L3)
    mpls_entry_entry_t mpls_entry;
    int rv = BCM_E_NONE;
...
int 
_bcm_sb2_oam_mpls_pw_svp_table_downmep_enable(int unit, _bcm_oam_hash_data_t *hash_data)
{
#if defined(INCLUDE_L3)
    mpls_entry_entry_t mpls_entry;
    int rv = BCM_E_NONE;
...
bcm_sb2_oam_endpoint_create(int unit, bcm_oam_endpoint_info_t *endpoint_info)
{
...
#if defined(INCLUDE_ETH_LM_DM)
    memcpy(hash_data->mac_sa, endpoint_info->src_mac_address, sizeof(bcm_mac_t));
#endif
    ...
    if (1 == remote) {
        ...
        if (MPLS_LM_DM_LSP_ENDPOINT_TYPE(endpoint_info)) {
             ...
             */
            rv = _bcm_sb2_oam_mpls_pw_egr_dvp_downmep_enable(unit, hash_data);
            if (BCM_FAILURE(rv)) {
                LOG_ERROR(BSL_LS_BCM_OAM,
                        (BSL_META_U(unit,
                                    "OAM(unit %d) Error: EGR_L3_NEXT_HOP table update failed (EP=%d) - %s.\n"),
                         ...
                         bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if (h_data_p->pri_map_index != _BCM_OAM_INVALID_INDEX) {
        ...
        for (i = 0; i < BCM_OAM_INTPRI_MAX ; i++) {
            if (SOC_MEM_FIELD_VALID(unit, ING_SERVICE_PRI_MAP_0m, OFFSET_VALIDf)) {
                soc_mem_field32_set(unit, ING_SERVICE_PRI_MAP_0m, &mem_entries[i],
                                    OFFSET_VALIDf, 0);
                                           ...
                                           bcm_oam_action_type_t action)
{
    switch(action) {
        ...
        case  bcmOAMActionL2StationHitProcessInInernalOamEngine:
        case  bcmOAMActionL2StationMissProcessInInternalOamEngine:
        case  bcmOAMActionLowMdlProcessInInernalOamEngine:
 ...
 */
STATIC int
_bcm_sb2_oam_bhh_fp_set(int unit, _bcm_oam_hash_data_t *hash_data, uint32 nhi,
                        bcm_oam_endpoint_info_t *endpoint_info)
{
    int rv = BCM_E_NONE;
#ifdef SABER2_DEBUG
    ...
    if(hash_data->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) {
        ...
        if (BCM_FAILURE(rv)) {
            ...
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "BHH(unit %d) Error: lm counter idx alloc failed - %s.\n"),
                       unit, bcm_errmsg(rv)));
            return (rv);
        }
        ...
        soc_mem_lock(unit, ING_SERVICE_PRI_MAP_0m);
        entries[0] = &mem_entries;
        ...
        soc_mem_unlock(unit, ING_SERVICE_PRI_MAP_0m);
 ...
 */
STATIC int
_bcm_sb2_oam_bhh_encap_hw_set(int unit, _bcm_oam_hash_data_t *h_data_p,
                         bcm_module_t module_id, bcm_port_t port_id,
                         int is_local, bcm_oam_endpoint_info_t *endpoint_info)
{
    int rv = BCM_E_NONE;
#if defined(BCM_SABER2_SUPPORT) && defined(BCM_MPLS_SUPPORT)
    bcm_l3_egress_t l3_egress;
    int ingress_if;
    int i;
    int num_entries;
    ...
    int mpls_index = 0;
    int nhi = 0;
#endif /* BCM_SABER2_SUPPORT &&  BCM_MPLS_SUPPORT */
    ...
    case bcmOAMEndpointTypeBHHMPLSVccv:
        ...
        soc_MPLS_ENTRYm_field32_set(unit, &mpls_entry, MPLS__MPLS_OAM_DOWNMEP_ENABLEf, 1);
    ...
    {
        rv = _bcm_sb2_oam_bhh_fp_set(unit, h_data_p, nhi, endpoint_info);
    }
                                ...
                                _eth_l2_header_t *l2)
{
    ...
    memcpy(l2->src_mac, h_data_p->mac_sa, sizeof(bcm_mac_t));
...
STATIC int
_bcm_sb2_oam_olp_l2_header_get(int unit,
								int cpu_dglp,
                                _olp_l2_header_t *l2)
{
    uint16			tpid;
    ...
    memset(l2, 0, sizeof(_olp_l2_header_t));
    sal_memset(&lmep_entry, 0, sizeof(lmep_entry_t));
...
STATIC uint8 *
_bcm_sb2_oam_bhh_l2_header_pack(uint8 *buffer, _l2_header_t *l2)
{
    uint32  tmp;
    int     i;
...
STATIC uint8 *
_bcm_sb2_oam_olp_l2_header_pack(uint8 *buffer, _olp_l2_header_t *l2)
{
    ...
    /* Vlan tpid */
    _ETH_LM_DM_ENCAP_PACK_U16(buffer, l2->tpid);
	
	/* Vlan Id */
	_ETH_LM_DM_ENCAP_PACK_U16(buffer, l2->vlan);
	
	/* Ethertype */
	_ETH_LM_DM_ENCAP_PACK_U16(buffer, l2->etherType);
                            ...
                            uint32 *encap_length)
{
    ...
    cur_ptr = _bcm_sb2_oam_bhh_l2_header_pack(cur_ptr, &l2);
						 ...
						 uint32 *olp_l2_encap_length)
{
    ...
    olp_l2_encap = encap_data + *eth_l2_encap_length;
                         ...
                         uint8  mep_type)
{
    ...
    if (!(flags & BCM_OAM_LOSS_SLM)) { 
        ...
        SOC_OLP_TX_OAM_OFFSET(&olp_tx_hdr) = (sizeof( _eth_l2_header_t) + 
                                ...
                                _bcm_oam_hash_key_t  *hash_key)
{
    ...
    if (endpoint_info->flags & BCM_OAM_ENDPOINT_WITH_ID) {
        if((endpoint_info->id < _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET) ||
           (endpoint_info->id >= (_BCM_OAM_BHH_SB2_ENDPOINT_OFFSET 
                                  + oc->bhh_endpoint_count))) {
            return (BCM_E_PARAM);
        }
    }
    ...
    if((is_remote) && (endpoint_info->local_id < 
                       _BCM_OAM_BHH_SB2_ENDPOINT_OFFSET)) {
        return (BCM_E_PARAM);
    }
    ...
    */
    ...
    if (is_remote) {
        ...
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "OAM(unit %d) Error: reading EGR_L3_NEXT_HOP,"
                                  "for EP=%d %s.\n"), unit, endpoint_info->id, bcm_errmsg(rv)));
            _bcm_sb2_oam_endpoint_cleanup(unit, 0, *hash_key, hash_data);
            return (rv);
        }
        soc_mem_field32_set(unit, EGR_L3_NEXT_HOPm, &egr_nh_entry, MPLS__MPLS_OAM_DOWNMEP_ENABLEf, 1); 
        rv = soc_mem_write(unit, EGR_L3_NEXT_HOPm, MEM_BLOCK_ALL, 
                egr_nh_index, &egr_nh_entry);
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "OAM(unit %d) Error: writing EGR_L3_NEXT_HOP,"
                                  "for EP=%d %s.\n"), unit, endpoint_info->id, bcm_errmsg(rv)));
            _bcm_sb2_oam_endpoint_cleanup(unit, 0, *hash_key, hash_data);
            return (rv);
        }
        ...
        if (!is_replace || (endpoint_info->flags & BCM_BHH_ENDPOINT_ENCAP_SET)) {
            rv = _bcm_sb2_oam_bhh_encap_hw_set(unit, hash_data, module_id,
...
_bcm_sb2_oam_eth_lm_dm_hw_init(int unit)
{
    ...
    _BCM_OAM_LOCK(oc);
    /* 
     * Get COSQ for ETH_LM_DM
     */
     min_cosq = 0;
     for (i = 0; i < SOC_CMCS_NUM(unit); i++) {
         num_cosq = NUM_CPU_ARM_COSQ(unit, i);
         if (i == oc->eth_lm_dm_uc_num + 1) {
             break;
         }
         min_cosq += num_cosq;
     }
     ...
     if(max_cosq < min_cosq) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                  (BSL_META_U(unit,
                              "ETH_LM_DM(unit %d) Error: "
                              "No ETH_LM_DM COS Queue available from uC%d - %s\n"),
                               unit, oc->eth_lm_dm_uc_num, bcm_errmsg(BCM_E_CONFIG)));
        _BCM_OAM_UNLOCK(oc);
         return (BCM_E_CONFIG);
     }
    ...
    if (oc->eth_lm_dm_cpu_cosq != ETH_LM_DM_COSQ_INVALID) {
        if ((oc->eth_lm_dm_cpu_cosq < min_cosq) ||
            (oc->eth_lm_dm_cpu_cosq > max_cosq)) {
            _BCM_OAM_UNLOCK(oc);
            return (BCM_E_CONFIG);
        }
        min_cosq = max_cosq = oc->eth_lm_dm_cpu_cosq;
    }
     ...
     */
#if 0    
    chan_id = (BCM_RX_CHANNELS * (SOC_ARM_CMC(unit, oc->eth_lm_dm_uc_num))) +
        oc->eth_lm_dm_rx_channel;
#else

    chan_id = BCM_SB2_ETH_LM_DM_RX_GLOBAL_CHANNEL;
    min_cosq = NUM_CPU_ARM_COSQ(unit, 0) + NUM_CPU_ARM_COSQ(unit, 1) - 1 +
                                            (NUM_CPU_ARM_COSQ(unit, 2)/2);
    max_cosq = min_cosq + 1;
#endif
    for (i = max_cosq; i >= min_cosq; i--) {
        rv = _bcm_common_rx_queue_channel_set(unit, i, chan_id);
        if(BCM_SUCCESS(rv)) {
            oc->eth_lm_dm_cpu_cosq = i;
            break;
        }
    }
 ...
 */
 STATIC int
_bcm_sb2_oam_bhh_fp_delete(int unit, _bcm_oam_hash_data_t *h_data_p)
{
    int rv = BCM_E_NONE;
#ifdef SABER2_DEBUG
    _bcm_oam_control_t *oc;
...
/*
 * Function:
 *      _bcm_sb2_oam_bhh_session_hw_delete
 * Purpose:
...
_bcm_sb2_oam_bhh_session_hw_delete(int unit, _bcm_oam_hash_data_t *h_data_p)
{
        ...
        if (BCM_SUCCESS(rv)) {
            if ((soc_MPLS_ENTRYm_field32_get(unit, &mpls_entry, VALIDf) == 0x1)) 
            {
                ...
                if (BCM_FAILURE(rv)) {
                    LOG_ERROR(BSL_LS_BCM_OAM,
                              (BSL_META_U(unit,
                                          "OAM(unit %d) Error: %s MPLS_ENTRY write failed - "
    ...
    if((h_data_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) ||
        (h_data_p->flags & BCM_OAM_ENDPOINT_DELAY_MEASUREMENT))
    {
        rv = _bcm_sb2_oam_bhh_fp_delete(unit, h_data_p);
    }
...
#endif /* (INCLUDE_BHH || INCLUDE_ETH_LM_DM ) */
