                                       ...
                                       /* in */ int same_interface_filter_basic_mode) 
{
  ...
  if (same_interface_filter_basic_mode) {
    ...
    result = bcm_field_qualify_IngressVPortBridgeDisable(unit, presel_id | BCM_FIELD_QUALIFY_PRESEL, 0x1, 0x1);
    if (BCM_E_NONE != result) {
    ...
    result = bcm_field_qualify_InterfaceClassVPort(unit, presel_id | BCM_FIELD_QUALIFY_PRESEL, 0x1, 0x1);
    if (BCM_E_NONE != result) {
