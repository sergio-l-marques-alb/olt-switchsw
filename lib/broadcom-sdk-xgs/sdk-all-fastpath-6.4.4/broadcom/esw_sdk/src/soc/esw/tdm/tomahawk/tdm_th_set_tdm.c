...
static int tdm_th_scheduler_2d(FILE *file, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int port_state_map[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_buffer[64], int os_buffer[64], int lr_idx_limit, int tdm_tbl[256], int bucket1[_TH_OS_GROUP_LEN], int bucket2[_TH_OS_GROUP_LEN], int bucket3[_TH_OS_GROUP_LEN], int bucket4[_TH_OS_GROUP_LEN], int bucket5[_TH_OS_GROUP_LEN], int bucket6[_TH_OS_GROUP_LEN], int bucket7[_TH_OS_GROUP_LEN], int bucket8[_TH_OS_GROUP_LEN], int pipe, unsigned char accessories, unsigned char higig_mgmt);
...
static int tdm_th_scheduler_map_search_x(unsigned char **map, int idx);
...
static int tdm_th_scheduler_nodal_slice(unsigned char **map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt, int direction);
static int tdm_th_scheduler_nodal_slice_lr(unsigned char **map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt, int direction, int curr_cnt);
static int tdm_th_scheduler_nodal_transmute_lr(unsigned char **map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt);
...
static int tdm_th_scheduler_vector_diff(unsigned char **map, int bw, int lim, int x, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1]);
...
static int tdm_th_scheduler_wrap(FILE *file, int bw, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int portmap[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int pipe_start, int pipe_end, 
					   int idb_tdm_tbl[256], 
...
static void tdm_th_tsc_port_transcription(int wc_array[NUM_TSC][4], enum port_speed_e speed[_TH_NUM_EXT_PORTS], int port_state_array[_TH_NUM_EXT_PORTS]);
static int tdm_th_check_ethernet(int port, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1]);
static void tdm_th_parse_tdm_tbl(FILE *file, int mgmt_bw, int tdm_tbl[256], int tdm_ovs_a[_TH_OS_GROUP_LEN], int tdm_ovs_b[_TH_OS_GROUP_LEN], int tdm_ovs_c[_TH_OS_GROUP_LEN], int tdm_ovs_d[_TH_OS_GROUP_LEN], int tdm_ovs_e[_TH_OS_GROUP_LEN], int tdm_ovs_f[_TH_OS_GROUP_LEN], int tdm_ovs_g[_TH_OS_GROUP_LEN], int tdm_ovs_h[_TH_OS_GROUP_LEN], int block, int pipe);
static void tdm_th_print_tsc(FILE *file, int wc_array[NUM_TSC][4]);
static int tdm_th_abs(int num);
static int tdm_th_fac(int num_signed);
static int tdm_th_pow(int num, int pow);
static int tdm_th_sqrt(int input_signed);
...
**/
int tdm_th_fac(int num_signed) {
	int i, product, num;
	num = tdm_th_abs(num_signed);
	product=num;
...
**/
int tdm_th_pow(int num, int pow) {
	int i, product=num;
...
**/
int tdm_th_sqrt(int input_signed) {
	int n, d=0, s=1, approx, input;
	input = tdm_th_abs(input_signed);
	 ...
	 */
	do {
		d=(input-tdm_th_pow(s,2));
		if (d<0) {
			--s;
			break;
		}
		if ( ((1000*tdm_th_abs(d))/tdm_th_pow(s,2)) <= ((1000*tdm_th_abs(d+1))/tdm_th_pow((s+1),2)) ) {
			break;
		}
		s++;
	} while(s<input);
	...
	if (d<(2*s)) {
		for (n=1; n<3; n++) {
			approx+=((tdm_th_pow(-1,n)*tdm_th_fac(2*n)*tdm_th_pow(d,n))/(tdm_th_pow(tdm_th_fac(n),2)*tdm_th_pow(4,n)*tdm_th_pow(s,((2*n)-1))*(1-2*n)));
		}
	}
...
**/
int tdm_th_scheduler_2d(FILE *file, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int port_state_map[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_buffer[64], int os_buffer[64], int lr_idx_limit, int tdm_tbl[256], int bucket1[_TH_OS_GROUP_LEN], int bucket2[_TH_OS_GROUP_LEN], int bucket3[_TH_OS_GROUP_LEN], int bucket4[_TH_OS_GROUP_LEN], int bucket5[_TH_OS_GROUP_LEN], int bucket6[_TH_OS_GROUP_LEN], int bucket7[_TH_OS_GROUP_LEN], int bucket8[_TH_OS_GROUP_LEN], int pipe, unsigned char accessories, unsigned char higig_mgmt)
{
	/* Values */
...
int TDM_scheduler_map_distance_x(unsigned char **map, int limit, unsigned int idx1, unsigned int idx2) 
{
	...
	#ifdef _CMATH
		dist = sqrt(((tdm_th_abs(idx2-idx1))*(tdm_th_abs(idx2-idx1)))+((tdm_th_abs(b-a))*(tdm_th_abs(b-a))));
	#else
		dist = tdm_th_sqrt(((tdm_th_abs(idx2-idx1))*(tdm_th_abs(idx2-idx1)))+((tdm_th_abs(b-a))*(tdm_th_abs(b-a))));
	#endif
...
**/
int tdm_th_scheduler_nodal_transmute_lr(unsigned char **map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt)
{
...
**/
int tdm_th_scheduler_nodal_slice(unsigned char **map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt, int direction)
{
...
**/
int tdm_th_scheduler_nodal_slice_lr(unsigned char **map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt, int direction, int curr_cnt)
{
...
**/
int TDM_scheduler_nodal_transmute(unsigned char **vector_map, int freq, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int lr_idx_limit, int row, int col, int lr_vec_cnt)
{
	int node_transmuted, node=BLANK;
	
	if (vector_map[col][row]!=_TH_NUM_EXT_PORTS) {
		node_transmuted = BOOL_FALSE;
		/* if (tdm_th_scheduler_fit_singular_cnt(vector_map,(row-1))>0 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row+1))==0 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row+2))==0) { */
		if (tdm_th_scheduler_fit_singular_cnt(vector_map,(row+1))==0 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row+2))==0) {
		...
		/* else if (row>1 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row+1))>0 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row-1))==0 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row-2))==0) { */
		else if (row>1 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row-1))==0 && tdm_th_scheduler_fit_singular_cnt(vector_map,(row-2))==0) {
			vector_map[col][row-1]=vector_map[col][row];
			vector_map[col][row]=_TH_NUM_EXT_PORTS;
			node_transmuted = BOOL_TRUE;
			#ifdef _SET_TDM_DEV
		...
		if (node_transmuted == BOOL_TRUE) {
			node = row;
			if (tdm_th_scheduler_vector_diff(vector_map,freq,lr_idx_limit,col,speed,tsc,traffic)!=PASS || tdm_th_scheduler_fit_prox(vector_map,lr_idx_limit,VEC_MAP_WID,col,tsc)!=PASS) {
...
int TDM_scheduler_fit_distal_pos1(unsigned char **map, int lim, int node_x, int lr_slot_cnt) {
	...
	for (j=0; j<lim; j++) {
		if ((v>((lim/lr_slot_cnt)+1))) {
			...
			for (i=0; i<v; i++) {
				if (tdm_th_scheduler_map_search_x(map,(j-i))==OVSB_TOKEN) {
					n=(j-i);
					break;
				}
			}
			if ((tdm_th_scheduler_map_search_x(map,n)!=_TH_NUM_EXT_PORTS)) {
				break;
			}
		}
		if ((tdm_th_scheduler_map_search_x(map,j)==OVSB_TOKEN||tdm_th_scheduler_map_search_x(map,j)==_TH_NUM_EXT_PORTS) &&
			(tdm_th_scheduler_map_search_x(map,(j+1))==OVSB_TOKEN||tdm_th_scheduler_map_search_x(map,(j+1))==_TH_NUM_EXT_PORTS)) {
			v++;
		}
		else {
			v=0;
...
*** This only matters if oversub is enabled, to increase performance of oversub arbiter ***
**/
int TDM_scheduler_fit_distal_pos2(unsigned char **map, int lim, int node_x, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int os_param_spd) {
	int j, n=0, prox1d=0, prox2d=0, prox3d=0, prox1u=0, prox2u=0, prox3u=0;
	unsigned char ovs_no_clump_idx=1;
	
	/*if (1) {*/
		if (tdm_th_scheduler_map_find_x(map,lim,(n+1),0)!=_TH_NUM_EXT_PORTS) {
			if (tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n+1),0),0)!=_TH_NUM_EXT_PORTS) {
				prox1d=tdm_th_which_tsc(map[tdm_th_scheduler_map_find_x(map,lim,(n+1),0)][tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n+1),0),0)],tsc);
			}
			else {
		...
		if (tdm_th_scheduler_map_find_x(map,lim,(n+2),0)!=_TH_NUM_EXT_PORTS) {
			if (tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n+2),0),0)!=_TH_NUM_EXT_PORTS) {
				prox2d=tdm_th_which_tsc(map[tdm_th_scheduler_map_find_x(map,lim,(n+2),0)][tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n+2),0),0)],tsc);
			}
			else {
		...
		if (tdm_th_scheduler_map_find_x(map,lim,(n+3),0)!=_TH_NUM_EXT_PORTS) {
			if (tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n+3),0),0)!=_TH_NUM_EXT_PORTS) {
				prox3d=tdm_th_which_tsc(map[tdm_th_scheduler_map_find_x(map,lim,(n+3),0)][tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n+3),0),0)],tsc);
			}
			else {
		...
		if (tdm_th_scheduler_map_find_x(map,lim,(n-1),0)!=_TH_NUM_EXT_PORTS) {
			if (tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n-1),0),0)!=_TH_NUM_EXT_PORTS) {
				prox1u=tdm_th_which_tsc(map[tdm_th_scheduler_map_find_x(map,lim,(n-1),0)][tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n-1),0),0)],tsc);
			}
			else {
		...
		if (tdm_th_scheduler_map_find_x(map,lim,(n-2),0)!=_TH_NUM_EXT_PORTS) {
			if (tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n-2),0),0)!=_TH_NUM_EXT_PORTS) {
				prox2u=tdm_th_which_tsc(map[tdm_th_scheduler_map_find_x(map,lim,(n-2),0)][tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n-2),0),0)],tsc);
			}
			else {
		...
		if (tdm_th_scheduler_map_find_x(map,lim,(n-3),0)!=_TH_NUM_EXT_PORTS) {
			if (tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n-3),0),0)!=_TH_NUM_EXT_PORTS) {
				prox3u=tdm_th_which_tsc(map[tdm_th_scheduler_map_find_x(map,lim,(n-3),0)][tdm_th_scheduler_map_find_y(map,lim,tdm_th_scheduler_map_find_x(map,lim,(n-3),0),0)],tsc);
			}
			else {
		...
		for (j=1; j<VEC_MAP_WID; j++) {
			if (tdm_th_scheduler_map_find_y(map,lim,j,0)!=_TH_NUM_EXT_PORTS) {
				/* Only one type of 25G vector per core bandwidth */
				if (((speed[map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)]])/1000)==25) {
					if ((((speed[map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)]])/1000)==os_param_spd) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox1d) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox2d) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox3d) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox1u) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox2u) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox3u)) {
							ovs_no_clump_idx=j;
							break;
					}
				}
				/* Byproduct of vector labeling scheme */
					...
					if ((((speed[map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)]])/10000)==(os_param_spd/10)) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox1d) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox2d) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox3d) &&
						(tdm_th_which_tsc(map[j][tdm_th_scheduler_map_find_y(map,lim,j,0)],tsc)!=prox1u) &&
...
int check_mode(unsigned char port, int tsc[NUM_TSC][4])
{
	...
	for (i=0; i<4; i++) {
		if (tsc[tdm_th_which_tsc(port,tsc)][i]!=_TH_NUM_EXT_PORTS) {
			j++;
		}
	}
...
{
	int i, j, tmp=_TH_NUM_EXT_PORTS, cnt=1, tsc_arr[4], tsc_inst=tdm_th_which_tsc(port,tsc);
...
**/
int tdm_th_check_ethernet(int port, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1]) {
...
**/
int check_spd(unsigned char **map, int lim, int x_pos, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1])
{
	...
	switch(k) {
		case 4: if (tdm_th_check_ethernet(map[x_pos][y_pos], speed, tsc, traffic)) {param_spd = 10;} else {param_spd = 11;} break;
		case 8: if (tdm_th_check_ethernet(map[x_pos][y_pos], speed, tsc, traffic)) {param_spd = 20;} else {param_spd = 21;} break;
		case 10: if (tdm_th_check_ethernet(map[x_pos][y_pos], speed, tsc, traffic)) {param_spd = 25;} else {param_spd = 27;} break;
		case 16: if (tdm_th_check_ethernet(map[x_pos][y_pos], speed, tsc, traffic)) {param_spd = 40;} else {param_spd = 42;} break;
		case 20: if (tdm_th_check_ethernet(map[x_pos][y_pos], speed, tsc, traffic)) {param_spd = 50;} else {param_spd = 53;} break;
		case 39: param_spd = 107; break;
		case 40: if (tdm_th_check_ethernet(map[x_pos][y_pos], speed, tsc, traffic)) {param_spd = 100;} else {param_spd = 106;} break;
	}
...
int TDM_scheduler_table_scan(FILE *file, unsigned short yy, unsigned short spacing, int limit, int speed, unsigned char stack[64], unsigned short stack_pointer, int tsc[NUM_TSC][4], int tdm_tbl[256]) 
{
	...
	do {
		...
		if (yy>=3 && yy<252) {
			LOG_VERBOSE(BSL_LS_SOC_TDM,
                        (BSL_META("[%0d] | (%0d)(%0d)(%0d)[[%0d]](%0d)(%0d)(%0d)\n"),
                         tdm_th_which_tsc(stack[stack_pointer],tsc), tdm_th_which_tsc(tdm_tbl[yy-3],tsc),tdm_th_which_tsc(tdm_tbl[yy-2],tsc),tdm_th_which_tsc(tdm_tbl[yy-1],tsc),tdm_th_which_tsc(tdm_tbl[yy],tsc),tdm_th_which_tsc(tdm_tbl[yy+1],tsc),tdm_th_which_tsc(tdm_tbl[yy+2],tsc),tdm_th_which_tsc(tdm_tbl[yy+3],tsc)));		
		}
		if ((tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy],tsc)) ||
			 (tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy-1],tsc)) ||
			 (tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy-2],tsc)) ||
			 (tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy-3],tsc)) ||
			 (tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy+1],tsc)) ||
			 (tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy+2],tsc)) ||
			 (tdm_th_which_tsc(stack[stack_pointer],tsc)==tdm_th_which_tsc(tdm_tbl[yy+3],tsc))) {
			prox_chk=FAIL;
		...
		vec_cnt=0;
		for (j=yy; j<yy+(tdm_th_scheduler_slots(speed)*spacing); j+=spacing) {
			if (tdm_tbl[j]==_TH_NUM_EXT_PORTS) {
				vec_cnt++;
			}
		}
		if (vec_cnt!=tdm_th_scheduler_slots(speed) || prox_chk==FAIL) {
			yy++;
		}
		if ((yy+(spacing*(tdm_th_scheduler_slots(speed)-1))) >= limit) {
			TDM_SML_BAR
			LOG_VERBOSE(BSL_LS_SOC_TDM,
	...
	} while (yy<256 && (vec_cnt!=tdm_th_scheduler_slots(speed) || prox_chk==FAIL) && ((--timeout)>0));
...
**/
int tdm_th_scheduler_map_search_x(unsigned char **map, int idx) 
{
	int i, id;
...
int TDM_scheduler_fit_prox_node_partial(unsigned char **map, int node_y, int wid, int node_x, int tsc[NUM_TSC][4]) {
	...
	TOKEN_CHECK(map[node_x][node_y]) {
		/* Check proximate TSC violation */
		for (v=0; v<wid; v++) {
			if ((tdm_th_which_tsc(map[node_x][node_y],tsc)==tdm_th_which_tsc(map[v][node_y+1],tsc)) ||
				(tdm_th_which_tsc(map[node_x][node_y],tsc)==tdm_th_which_tsc(map[v][node_y+2],tsc)) ||
				(tdm_th_which_tsc(map[node_x][node_y],tsc)==tdm_th_which_tsc(map[v][node_y+3],tsc))) 
				{
					check=FAIL;
				}
		}			
...
**/
int tdm_th_scheduler_vector_diff(unsigned char **map, int bw, int lim, int x, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1]) {
	...
	*/
	...
	switch(k) {
		case 4: if (tdm_th_check_ethernet(map[x][y], speed, tsc, traffic)) {spd = 10;} else {spd = 11;} break;
		case 8: if (tdm_th_check_ethernet(map[x][y], speed, tsc, traffic)) {spd = 20;} else {spd = 21;} break;
		case 10: if (tdm_th_check_ethernet(map[x][y], speed, tsc, traffic)) {spd = 25;} else {spd = 27;} break;
		case 16: if (tdm_th_check_ethernet(map[x][y], speed, tsc, traffic)) {spd = 40;} else {spd = 42;} break;
		case 20: if (tdm_th_check_ethernet(map[x][y], speed, tsc, traffic)) {spd = 50;} else {spd = 53;} break;
		case 39: spd = 107; break;
		case 40: if (tdm_th_check_ethernet(map[x][y], speed, tsc, traffic)) {spd = 100;} else {spd = 106;} break;
	}
	*/
...
**/
void tdm_th_tsc_port_transcription(int wc_array[NUM_TSC][4], enum port_speed_e speed[_TH_NUM_EXT_PORTS], int port_state_array[_TH_NUM_EXT_PORTS])
{
...
**/
void TDM_scheduler_parse_pipe(FILE *file, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int portmap[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int pipe_start, int pipe_end)
{
	int iter, iter2;
...
**/
int tdm_th_scheduler_wrap(FILE *file, int bw, enum port_speed_e speed[_TH_NUM_EXT_PORTS], int portmap[_TH_NUM_EXT_PORTS], int tsc[NUM_TSC][4], int traffic[NUM_TSC+1], int pipe_start, int pipe_end, 
					   int idb_tdm_tbl[256], 
					   int idb_tdm_ovs_a[_TH_OS_GROUP_LEN], int idb_tdm_ovs_b[_TH_OS_GROUP_LEN], int idb_tdm_ovs_c[_TH_OS_GROUP_LEN], int idb_tdm_ovs_d[_TH_OS_GROUP_LEN], 
					   int idb_tdm_ovs_e[_TH_OS_GROUP_LEN], int idb_tdm_ovs_f[_TH_OS_GROUP_LEN], int idb_tdm_ovs_g[_TH_OS_GROUP_LEN], int idb_tdm_ovs_h[_TH_OS_GROUP_LEN], 
					   int mmu_tdm_tbl[256], 
...
**/
int tdm_th_set_tdm_tbl(th_tdm_globals_t *tdm_globals, th_tdm_pipes_t *tdm_pipe_tables)
{
...
/**
@name: tdm_th_set_tdm_tbl_tdm56
@param:

SV interfaced entry point for hard coded TDM 56.
 **/
int tdm_th_set_tdm_tbl_tdm56(enum port_speed_e speed[_TH_NUM_EXT_PORTS], int tdm_bw,
