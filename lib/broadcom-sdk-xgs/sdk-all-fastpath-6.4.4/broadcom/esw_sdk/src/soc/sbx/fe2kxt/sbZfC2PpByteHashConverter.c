...
sbZfC2PpByteHashConverter_Unpack(sbZfC2PpByteHashConverter_t *pToStruct,
  ...
  (pToStruct)->m_uHashByteBit39 =  (uint8)  ((pFromData)[4] >> 7) & 0x01;

  /* Unpack Member: m_uHashByteBit38 */
  (pToStruct)->m_uHashByteBit38 =  (uint8)  ((pFromData)[4] >> 6) & 0x01;

  /* Unpack Member: m_uHashByteBit37 */
  (pToStruct)->m_uHashByteBit37 =  (uint8)  ((pFromData)[4] >> 5) & 0x01;

  /* Unpack Member: m_uHashByteBit36 */
  (pToStruct)->m_uHashByteBit36 =  (uint8)  ((pFromData)[4] >> 4) & 0x01;

  /* Unpack Member: m_uHashByteBit35 */
  (pToStruct)->m_uHashByteBit35 =  (uint8)  ((pFromData)[4] >> 3) & 0x01;

  /* Unpack Member: m_uHashByteBit34 */
  (pToStruct)->m_uHashByteBit34 =  (uint8)  ((pFromData)[4] >> 2) & 0x01;

  /* Unpack Member: m_uHashByteBit33 */
  (pToStruct)->m_uHashByteBit33 =  (uint8)  ((pFromData)[4] >> 1) & 0x01;

  /* Unpack Member: m_uHashByteBit32 */
  (pToStruct)->m_uHashByteBit32 =  (uint8)  ((pFromData)[4] ) & 0x01;

  /* Unpack Member: m_uHashByteBit31 */
  (pToStruct)->m_uHashByteBit31 =  (uint8)  ((pFromData)[3] >> 7) & 0x01;

  /* Unpack Member: m_uHashByteBit30 */
  (pToStruct)->m_uHashByteBit30 =  (uint8)  ((pFromData)[3] >> 6) & 0x01;

  /* Unpack Member: m_uHashByteBit29 */
  (pToStruct)->m_uHashByteBit29 =  (uint8)  ((pFromData)[3] >> 5) & 0x01;

  /* Unpack Member: m_uHashByteBit28 */
  (pToStruct)->m_uHashByteBit28 =  (uint8)  ((pFromData)[3] >> 4) & 0x01;

  /* Unpack Member: m_uHashByteBit27 */
  (pToStruct)->m_uHashByteBit27 =  (uint8)  ((pFromData)[3] >> 3) & 0x01;

  /* Unpack Member: m_uHashByteBit26 */
  (pToStruct)->m_uHashByteBit26 =  (uint8)  ((pFromData)[3] >> 2) & 0x01;

  /* Unpack Member: m_uHashByteBit25 */
  (pToStruct)->m_uHashByteBit25 =  (uint8)  ((pFromData)[3] >> 1) & 0x01;

  /* Unpack Member: m_uHashByteBit24 */
  (pToStruct)->m_uHashByteBit24 =  (uint8)  ((pFromData)[3] ) & 0x01;

  /* Unpack Member: m_uHashByteBit23 */
  (pToStruct)->m_uHashByteBit23 =  (uint8)  ((pFromData)[2] >> 7) & 0x01;

  /* Unpack Member: m_uHashByteBit22 */
  (pToStruct)->m_uHashByteBit22 =  (uint8)  ((pFromData)[2] >> 6) & 0x01;

  /* Unpack Member: m_uHashByteBit21 */
  (pToStruct)->m_uHashByteBit21 =  (uint8)  ((pFromData)[2] >> 5) & 0x01;

  /* Unpack Member: m_uHashByteBit20 */
  (pToStruct)->m_uHashByteBit20 =  (uint8)  ((pFromData)[2] >> 4) & 0x01;

  /* Unpack Member: m_uHashByteBit19 */
  (pToStruct)->m_uHashByteBit19 =  (uint8)  ((pFromData)[2] >> 3) & 0x01;

  /* Unpack Member: m_uHashByteBit18 */
  (pToStruct)->m_uHashByteBit18 =  (uint8)  ((pFromData)[2] >> 2) & 0x01;

  /* Unpack Member: m_uHashByteBit17 */
  (pToStruct)->m_uHashByteBit17 =  (uint8)  ((pFromData)[2] >> 1) & 0x01;

  /* Unpack Member: m_uHashByteBit16 */
  (pToStruct)->m_uHashByteBit16 =  (uint8)  ((pFromData)[2] ) & 0x01;

  /* Unpack Member: m_uHashByteBit15 */
  (pToStruct)->m_uHashByteBit15 =  (uint8)  ((pFromData)[1] >> 7) & 0x01;

  /* Unpack Member: m_uHashByteBit14 */
  (pToStruct)->m_uHashByteBit14 =  (uint8)  ((pFromData)[1] >> 6) & 0x01;

  /* Unpack Member: m_uHashByteBit13 */
  (pToStruct)->m_uHashByteBit13 =  (uint8)  ((pFromData)[1] >> 5) & 0x01;

  /* Unpack Member: m_uHashByteBit12 */
  (pToStruct)->m_uHashByteBit12 =  (uint8)  ((pFromData)[1] >> 4) & 0x01;

  /* Unpack Member: m_uHashByteBit11 */
  (pToStruct)->m_uHashByteBit11 =  (uint8)  ((pFromData)[1] >> 3) & 0x01;

  /* Unpack Member: m_uHashByteBit10 */
  (pToStruct)->m_uHashByteBit10 =  (uint8)  ((pFromData)[1] >> 2) & 0x01;

  /* Unpack Member: m_uHashByteBit9 */
  (pToStruct)->m_uHashByteBit9 =  (uint8)  ((pFromData)[1] >> 1) & 0x01;

  /* Unpack Member: m_uHashByteBit8 */
  (pToStruct)->m_uHashByteBit8 =  (uint8)  ((pFromData)[1] ) & 0x01;

  /* Unpack Member: m_uHashByteBit7 */
  (pToStruct)->m_uHashByteBit7 =  (uint8)  ((pFromData)[0] >> 7) & 0x01;

  /* Unpack Member: m_uHashByteBit6 */
  (pToStruct)->m_uHashByteBit6 =  (uint8)  ((pFromData)[0] >> 6) & 0x01;

  /* Unpack Member: m_uHashByteBit5 */
  (pToStruct)->m_uHashByteBit5 =  (uint8)  ((pFromData)[0] >> 5) & 0x01;

  /* Unpack Member: m_uHashByteBit4 */
  (pToStruct)->m_uHashByteBit4 =  (uint8)  ((pFromData)[0] >> 4) & 0x01;

  /* Unpack Member: m_uHashByteBit3 */
  (pToStruct)->m_uHashByteBit3 =  (uint8)  ((pFromData)[0] >> 3) & 0x01;

  /* Unpack Member: m_uHashByteBit2 */
  (pToStruct)->m_uHashByteBit2 =  (uint8)  ((pFromData)[0] >> 2) & 0x01;

  /* Unpack Member: m_uHashByteBit1 */
  (pToStruct)->m_uHashByteBit1 =  (uint8)  ((pFromData)[0] >> 1) & 0x01;

  /* Unpack Member: m_uHashByteBit0 */
  (pToStruct)->m_uHashByteBit0 =  (uint8)  ((pFromData)[0] ) & 0x01;
