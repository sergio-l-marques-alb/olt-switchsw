...
#include "sbTypes.h"
#include "sbZfC2MmNarrowPortMemorySegmentConfigData.hx"
...
sbZfC2MmNarrowPortMemorySegmentConfigData_Pack(sbZfC2MmNarrowPortMemorySegmentConfigData_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMNARROWPORTMEMORYSEGMENTCONFIGDATA_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMNARROWPORTMEMORYSEGMENTCONFIGDATA_SIZE_IN_BYTES;
}
...
sbZfC2MmNarrowPortMemorySegmentConfigData_Unpack(sbZfC2MmNarrowPortMemorySegmentConfigData_t *pToStruct,
  ...
  (pToStruct)->m_uResv0 =  (uint32)  ((pFromData)[7] >> 1) & 0x7f;

  /* Unpack Member: m_uWriteAccess */
  (pToStruct)->m_uWriteAccess =  (uint32)  ((pFromData)[6] >> 6) & 0x03;
  (pToStruct)->m_uWriteAccess |=  (uint32)  ((pFromData)[7] & 0x01) << 2;

  /* Unpack Member: m_uReadAccess */
  (pToStruct)->m_uReadAccess =  (uint32)  ((pFromData)[6] >> 3) & 0x07;

  /* Unpack Member: m_uDataIntegrity */
  (pToStruct)->m_uDataIntegrity =  (uint32)  ((pFromData)[6] ) & 0x07;

  /* Unpack Member: m_uTrapNullPointer */
  (pToStruct)->m_uTrapNullPointer =  (uint32)  ((pFromData)[5] >> 7) & 0x01;

  /* Unpack Member: m_uWrap */
  (pToStruct)->m_uWrap =  (uint32)  ((pFromData)[5] >> 6) & 0x01;

  /* Unpack Member: m_uLimitMask */
  (pToStruct)->m_uLimitMask =  (uint32)  ((pFromData)[2] >> 7) & 0x01;
  (pToStruct)->m_uLimitMask |=  (uint32)  (pFromData)[3] << 1;
  (pToStruct)->m_uLimitMask |=  (uint32)  (pFromData)[4] << 9;
  (pToStruct)->m_uLimitMask |=  (uint32)  ((pFromData)[5] & 0x3f) << 17;

  /* Unpack Member: m_uBaseAddress */
  (pToStruct)->m_uBaseAddress =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uBaseAddress |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uBaseAddress |=  (uint32)  ((pFromData)[2] & 0x7f) << 16;
