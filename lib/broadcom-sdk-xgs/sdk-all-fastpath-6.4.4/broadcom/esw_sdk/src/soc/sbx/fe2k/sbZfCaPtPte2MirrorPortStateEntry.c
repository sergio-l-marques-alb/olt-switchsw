/*
 * $Id: sbZfCaPtPte2MirrorPortStateEntry.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaPtPte2MirrorPortStateEntry.hx"
...
sbZfCaPtPte2MirrorPortStateEntry_Pack(sbZfCaPtPte2MirrorPortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE2MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE2MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
}
