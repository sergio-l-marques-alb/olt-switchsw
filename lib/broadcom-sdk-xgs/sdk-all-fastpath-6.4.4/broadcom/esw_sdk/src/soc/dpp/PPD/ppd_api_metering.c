  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_meters_group_info_set,(unit, mtr_group_ndx, mtr_group_info));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_meters_group_info_set_print,(unit,mtr_group_ndx,mtr_group_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_meters_group_info_get,(unit, mtr_group_ndx, mtr_group_info));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_meters_group_info_get_print,(unit,mtr_group_ndx));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_bw_profile_add,(unit, mtr_group_ndx, bw_profile_ndx, bw_profile_info, exact_bw_profile_info, success));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_bw_profile_add_print,(unit,mtr_group_ndx,bw_profile_ndx,bw_profile_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_bw_profile_get,(unit, mtr_group_ndx, bw_profile_ndx, bw_profile_info));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_bw_profile_get_print,(unit,mtr_group_ndx,bw_profile_ndx));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_bw_profile_remove,(unit, mtr_group_ndx, bw_profile_ndx));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_bw_profile_remove_print,(unit,mtr_group_ndx,bw_profile_ndx));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_meter_ins_to_bw_profile_map_set,(unit, meter_ins_ndx, bw_profile_id));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_meter_ins_to_bw_profile_map_set_print,(unit,meter_ins_ndx,bw_profile_id));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(mtr_meter_ins_to_bw_profile_map_get,(unit, meter_ins_ndx, bw_profile_id));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_mtr_meter_ins_to_bw_profile_map_get_print,(unit,meter_ins_ndx));
