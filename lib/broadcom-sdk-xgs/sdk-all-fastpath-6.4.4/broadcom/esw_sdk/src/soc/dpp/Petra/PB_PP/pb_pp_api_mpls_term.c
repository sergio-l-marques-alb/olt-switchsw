/* $Id: pb_pp_api_mpls_term.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_mpls_term.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_LKUP_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(lkup_info);

  res = soc_pb_pp_mpls_term_lkup_info_set_verify(
          unit,
          lkup_info
        );
  ...
  res = soc_pb_pp_mpls_term_lkup_info_set_unsafe(
          unit,
          lkup_info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_lkup_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_LKUP_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(lkup_info);

  res = soc_pb_pp_mpls_term_lkup_info_get_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_lkup_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_LABEL_RANGE_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(label_range_info);

  res = soc_pb_pp_mpls_term_label_range_set_verify(
          unit,
          range_ndx,
          label_range_info
        );
  ...
  res = soc_pb_pp_mpls_term_label_range_set_unsafe(
          unit,
          range_ndx,
          label_range_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_label_range_set()", range_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_LABEL_RANGE_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(label_range_info);

  res = soc_pb_pp_mpls_term_label_range_get_verify(
          unit,
          range_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_label_range_get_unsafe(
          unit,
          range_ndx,
          label_range_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_label_range_get()", range_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_RANGE_TERMINATED_LABEL_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_mpls_term_range_terminated_label_set_verify(
          unit,
          label_ndx,
          is_terminated_label
        );
  ...
  res = soc_pb_pp_mpls_term_range_terminated_label_set_unsafe(
          unit,
          label_ndx,
          is_terminated_label
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_range_terminated_label_set()", label_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_RANGE_TERMINATED_LABEL_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(is_terminated_label);

  res = soc_pb_pp_mpls_term_range_terminated_label_get_verify(
          unit,
          label_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_range_terminated_label_get_unsafe(
          unit,
          label_ndx,
          is_terminated_label
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_range_terminated_label_get()", label_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_RESERVED_LABELS_GLOBAL_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(reserved_labels_info);

  res = soc_pb_pp_mpls_term_reserved_labels_global_info_set_verify(
          unit,
  ...
  res = soc_pb_pp_mpls_term_reserved_labels_global_info_set_unsafe(
          unit,
          reserved_labels_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_reserved_labels_global_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_RESERVED_LABELS_GLOBAL_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(reserved_labels_info);

  res = soc_pb_pp_mpls_term_reserved_labels_global_info_get_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_reserved_labels_global_info_get_unsafe(
          unit,
          reserved_labels_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_reserved_labels_global_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_RESERVED_LABEL_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(label_info);

  res = soc_pb_pp_mpls_term_reserved_label_info_set_verify(
          unit,
          label_ndx,
          label_info
        );
  ...
  res = soc_pb_pp_mpls_term_reserved_label_info_set_unsafe(
          unit,
          label_ndx,
          label_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_reserved_label_info_set()", label_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_RESERVED_LABEL_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(label_info);

  res = soc_pb_pp_mpls_term_reserved_label_info_get_verify(
          unit,
          label_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_reserved_label_info_get_unsafe(
          unit,
          label_ndx,
          label_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_reserved_label_info_get()", label_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_ENCOUNTERED_ENTRIES_GET_BLOCK);
  ...
  res = soc_pb_pp_mpls_term_encountered_entries_get_block_verify(
          unit,
          first_label_ndx,
  ...
  res = soc_pb_pp_mpls_term_encountered_entries_get_block_unsafe(
          unit,
          first_label_ndx,
          nof_encountered_labels,
          encountered_labels,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_encountered_entries_get_block()", first_label_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_COS_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(term_cos_info);

  res = soc_pb_pp_mpls_term_cos_info_set_verify(
          unit,
          term_cos_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_cos_info_set_unsafe(
          unit,
          term_cos_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_cos_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_COS_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(term_cos_info);

  res = soc_pb_pp_mpls_term_cos_info_get_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_cos_info_get_unsafe(
          unit,
          term_cos_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_cos_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_LABEL_TO_COS_INFO_SET);
  ...
  res = soc_pb_pp_mpls_term_label_to_cos_info_set_verify(
          unit,
          cos_key,
          cos_val
        );
  ...
  res = soc_pb_pp_mpls_term_label_to_cos_info_set_unsafe(
          unit,
          cos_key,
          cos_val
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_label_to_cos_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_MPLS_TERM_LABEL_TO_COS_INFO_GET);
  ...
  res = soc_pb_pp_mpls_term_label_to_cos_info_get_verify(
          unit,
          cos_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_mpls_term_label_to_cos_info_get_unsafe(
          unit,
          cos_key,
          cos_val
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_mpls_term_label_to_cos_info_get()", 0, 0);
}
