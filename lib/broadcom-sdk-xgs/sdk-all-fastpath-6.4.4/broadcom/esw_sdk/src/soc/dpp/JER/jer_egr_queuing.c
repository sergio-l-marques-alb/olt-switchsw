...
soc_jer_nrdy_th_set(int unit)
{
    ...
    data = 0;
    nrdy_th = 230; /* JER_EGQ_TXI_TH_ID_RCY */
    soc_reg_field_set(unit, EGQ_NRDY_TH_6_8r, &data, NRDY_TH_6f, nrdy_th);
    nrdy_th = 128; /* JER_EGQ_TXI_TH_ID_150GB */
    soc_reg_field_set(unit, EGQ_NRDY_TH_6_8r, &data, NRDY_TH_7f, nrdy_th);
    nrdy_th = 256; /* JER_EGQ_TXI_TH_ID_300GB */
    soc_reg_field_set(unit, EGQ_NRDY_TH_6_8r, &data, NRDY_TH_8f, nrdy_th);
    SOCDNX_IF_ERR_EXIT(WRITE_EGQ_NRDY_TH_6_8r(unit, REG_PORT_ANY, data));

    data = 0;
    nrdy_th = 256; /* JER_EGQ_TXI_TH_ID_600GB */
    soc_reg_field_set(unit, EGQ_NRDY_TH_9_11r, &data, NRDY_TH_9f, nrdy_th);
    nrdy_th = 96;  /* JER_EGQ_TXI_TH_ID_25GB */
    soc_reg_field_set(unit, EGQ_NRDY_TH_9_11r, &data, NRDY_TH_10f, nrdy_th);
    nrdy_th = 0;   /* JER_EGQ_TXI_TH_ID_OFF */
    soc_reg_field_set(unit, EGQ_NRDY_TH_9_11r, &data, NRDY_TH_11f, nrdy_th);
    SOCDNX_IF_ERR_EXIT(WRITE_EGQ_NRDY_TH_9_11r(unit, REG_PORT_ANY, data));
