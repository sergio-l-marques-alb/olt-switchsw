...
int twamp_example(int unit, int in_vlan, int in_sysport, int in_vlan2, int in_sysport2) {
    ...
    rv = bcm_rx_trap_set(0, trap_id, &config);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
    }
