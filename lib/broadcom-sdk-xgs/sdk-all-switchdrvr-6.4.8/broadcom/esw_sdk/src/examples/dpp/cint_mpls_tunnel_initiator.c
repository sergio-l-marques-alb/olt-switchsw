...
int mpls_egress_tunnel_replace_label(int unit) 
{
    ...
    rv =  bcm_mpls_tunnel_initiator_get(0, mpls_tunnel_initiator_info_1.ingress_intf_for_replace, 2, &label_array, &label_count_temp);
    if (rv != BCM_E_NONE) {
        printf("Error, in bcm_mpls_tunnel_initiator_create\n");
        print rv;
        return rv;
    ...
    rv = bcm_mpls_tunnel_initiator_create(0, 0, 2, &label_array);
    if (rv != BCM_E_NONE) {
        printf("Error, in bcm_mpls_tunnel_initiator_create\n");
        print rv;
        return rv;
