 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: merlin_koi_debug_functions.h 1103 2015-08-14 16:57:21Z kirand $ *
 *                                                                                       *
...
struct merlin_koi_usr_ctrl_dfe_func_st {
...
struct merlin_koi_usr_ctrl_disable_functions_st {
  struct merlin_koi_usr_ctrl_func_st field;
  uint8_t  byte;
};

/** Lane User Control Disable DFE Function Struct */
struct merlin_koi_usr_ctrl_disable_dfe_functions_st {
  struct merlin_koi_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
...
/** Displays Eye Density Data measured with merlin_koi_meas_eye_density_data().
 *
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param buffer_size must provide buffer_size which is returned from merlin_koi_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: Stop the microcode [use merlin_koi_stop_rx_adaptation()] before using this API
 ...
 */
uint8_t merlin_koi_rdbl_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t merlin_koi_rdwl_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t merlin_koi_rdbls_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t merlin_koi_rdwls_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin_koi_rdbc_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin_koi_rdwc_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin_koi_rdbcs_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin_koi_rdwcs_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin_koi_rdw_uc_ram(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin_koi_rdb_uc_ram(err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin_koi_rdws_uc_ram(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin_koi_rdbs_uc_ram(err_code_t *err_code, uint16_t addr);
