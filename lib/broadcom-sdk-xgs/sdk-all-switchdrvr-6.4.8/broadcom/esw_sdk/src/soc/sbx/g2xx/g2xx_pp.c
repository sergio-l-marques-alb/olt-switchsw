/*
 * $Id: g2xx_pp.c,v 1.8 Broadcom SDK $
 *
...
static sbStatus_t
soc_sbx_g2xx_pp_rule_enable_set(int unit, uint32  uValid, int uCamId, int uEntry);

static sbStatus_t
soc_sbx_g2xx_pp_rule_enable_get(int unit, uint32 *uValid, int uCamId, int uEntry);
...
sbStatus_t
soc_sbx_g2xx_pp_v4mc_str_sel_match_set(int unit, uint32 uValid)
{
...
sbStatus_t
soc_sbx_g2xx_pp_v4mc_str_sel_match_get(int unit, uint32* uValid)
{
    int uCamId = SB_G2XX_FE_PP_RULE_S0_ETH_IPMULTICAST_CAM_ID;
    int uEntry = SB_G2XX_FE_PP_RULE_S0_ETH_IPMULTICAST_ENTRY;
...
sbStatus_t
soc_sbx_g2xx_pp_v4uc_str_sel_match_set(int unit, uint32 uValid)
{
    sbStatus_t rv;
...
sbStatus_t
soc_sbx_g2xx_pp_v4uc_str_sel_match_get(int unit, uint32* uValid)
{
    int uCamId = SB_G2XX_FE_PP_RULE_S7_L4_NO_HASH_ROUTE_CAM_ID;
    int uEntry = SB_G2XX_FE_PP_RULE_S7_L4_NO_HASH_ROUTE_ENTRY;
...
soc_sbx_g2xx_pp_hw_init(int unit, sbFeInitAsyncCallback_f_t cb, void *id)
{
  ...
  LOG_INFO(BSL_LS_SOC_COMMON,
           (BSL_META_U(unit,
                       "%s: Calling soc_sbx_g2xx_pp_hash_templates_init\n"), FUNCTION_NAME()));
  if( SB_OK != (status = soc_sbx_g2xx_pp_hash_templates_init(pFe)) ) {
    LOG_INFO(BSL_LS_SOC_COMMON,
             (BSL_META_U(unit,
                         "error: soc_sbx_g2xx_pp_hash_templates_init\n")));
    cb(id, status);
    return status;
  }
  ...
  LOG_INFO(BSL_LS_SOC_COMMON,
           (BSL_META_U(unit,
                       "%s: Calling soc_sbx_g2xx_pp_rule_encode\n"), FUNCTION_NAME()));
  if( SB_OK != (status = soc_sbx_g2xx_pp_rule_encode(unit)) ) {
    LOG_INFO(BSL_LS_SOC_COMMON,
             (BSL_META_U(unit,
                         "error: soc_sbx_g2xx_pp_rule_encode\n")));
    cb(id, status);
    return status;
  }
  ...
  LOG_INFO(BSL_LS_SOC_COMMON,
           (BSL_META_U(unit,
                       "%s: Calling soc_sbx_g2xx_pp_cam_default_init\n"), FUNCTION_NAME()));
  if( SB_OK != (status = soc_sbx_g2xx_pp_cam_default_init(unit)) ) {
    LOG_INFO(BSL_LS_SOC_COMMON,
             (BSL_META_U(unit,
                         "error: soc_sbx_g2xx_pp_cam_default_init\n")));
    cb(id, status);
    return status;
  }
...
soc_sbx_g2xx_pp_hash_templates_init(soc_sbx_g2xx_state_t *pFe)
{
  ...
  uint32 uRtHdrOffset =  SOC_SBX_G2XX_ERH_LEN(pFe);
  soc_sbx_g2xx_pp_rule_mgr_t *pPpParams  = pFe->pPpMgr;


  /* SB_G2XX_FE_PP_RTHDR_ETH_HASH_TEMPLATE */
  COMPILER_64_ZERO(uuMask);
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+0)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+1)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+2)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+3)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+4)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+5)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+6)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+7)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+8)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+9)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+10) ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,uRtHdrOffset+11) ;
  ...
  COMPILER_64_ZERO(uuMask);
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,1)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,2)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,3)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,4)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,5)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,6)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,7)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,8)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,9)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,10) ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,11) ;
  ...
  COMPILER_64_ZERO(uuMask);
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_PROTOCOL_BYTE_OFFSET)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_DA_BYTE_OFFSET)    ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_DA_BYTE_OFFSET+1)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_DA_BYTE_OFFSET+2)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_DA_BYTE_OFFSET+3)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_SA_BYTE_OFFSET)    ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_SA_BYTE_OFFSET+1)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_SA_BYTE_OFFSET+2)  ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,SB_G2XX_FE_IPV4_SA_BYTE_OFFSET+3) ;
  ...
  COMPILER_64_ZERO(uuMask);
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0)   ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0+1) ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,2)   ;
  SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,2+1);
  ...
  /* uuMask = SB_G2XX_FE_PP_BIT_HASH_MASK_GEN(uuMask,SB_G2XX_FE_VID_BIT_OFFSET); */
  uTemplateIndex = 0;
...
soc_sbx_g2xx_pp_hash_templates_recover(soc_sbx_g2xx_state_t *pFe)
{
    ...
    SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0)   ;
    SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0+1) ;
    SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0+2) ;
    SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0+3) ;
    SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0+4) ;
    SB_G2XX_FE_PP_BYTE_HASH_MASK_GEN(uuMask,0+5);
                     ...
                     sbG2XXFePpRamEntry_t *pRamEntry)
{
  ...
  sbG2XXFePpCamEntry_Pack(unit, pCamEntry, (uint8*)uCfgBuffer);
  sbG2XXFePpRamEntry_Pack(unit, pRamEntry, (uint8*)uCfgRamBuffer);
                     ...
                     sbG2XXFePpRamEntry_t *pRamEntry)
{
  ...
  sbG2XXFePpCamEntry_Unpack(unit, pCamEntry, (uint8 *) &uCfgBuffer[0]);
  sbG2XXFePpRamEntry_Unpack(unit, pRamEntry, (uint8 *) &uCfgRamBuffer[0]);
  return SB_OK;
}
