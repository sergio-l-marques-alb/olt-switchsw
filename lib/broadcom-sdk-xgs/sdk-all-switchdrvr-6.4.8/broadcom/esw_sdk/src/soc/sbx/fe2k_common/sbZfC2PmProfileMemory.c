...
sbZfC2PmProfileMemory_Unpack(sbZfC2PmProfileMemory_t *pToStruct,
  ...
  (pToStruct)->uProfType =  (uint32)  ((pFromData)[2] >> 2) & 0x01;

  /* Unpack Member: uOamProfType */
  (pToStruct)->uOamProfType =  (uint32)  ((pFromData)[2] ) & 0x03;

  /* Unpack Member: uResv0 */
  (pToStruct)->uResv0 =  (uint32)  (pFromData)[3] ;

  /* Unpack Member: uResv1 */
  (pToStruct)->uResv1 =  (uint32)  (pFromData)[7] ;
  (pToStruct)->uResv1 |=  (uint32)  (pFromData)[6] << 8;
  (pToStruct)->uResv1 |=  (uint32)  (pFromData)[5] << 16;
  (pToStruct)->uResv1 |=  (uint32)  (pFromData)[4] << 24;

  /* Unpack Member: uResv2 */
  (pToStruct)->uResv2 =  (uint32)  (pFromData)[11] ;
  (pToStruct)->uResv2 |=  (uint32)  (pFromData)[10] << 8;
  (pToStruct)->uResv2 |=  (uint32)  (pFromData)[9] << 16;
  (pToStruct)->uResv2 |=  (uint32)  (pFromData)[8] << 24;
...
uint32 sbZfC2PmProfileMemory_Pack32(sbZfC2PmProfileMemory_t *pFrom, 
                                    ...
                                    uint32 nMaxToDataIndex)
{
  uint8 uBuffer[SB_ZF_C2_PM_PROFMEMORY_SIZE_IN_WORDS*4];
  uint32 uIndex =0;
  uint32 *pBuffer = NULL;
  uint32 uNumberOfWords = SB_ZF_C2_PM_PROFMEMORY_SIZE_IN_WORDS;
                                          ...
                                          uint32 nMaxToDataIndex)
{
  ...
  uint32 uBuffer[SB_ZF_C2_PM_PROFMEMORY_SIZE_IN_WORDS*4];
  uint32 uNumberOfWords = SB_ZF_C2_PM_PROFMEMORY_SIZE_IN_WORDS;
  uint32 uIndex =0;
  ...
  sbZfC2PmProfileMemory_Unpack(pToData , (uint8 *) &uBuffer[0], SB_ZF_C2_PM_PROFMEMORY_SIZE_IN_BYTES);
  return uNumberOfWords;
}
