...
/*
 * $Id: fe2000_spi.c,v 1.9 Broadcom SDK $
 ...
 *
 *****************************************************************************/
void hwFe2000Spi4TxForceTrainingOn(sbhandle userDeviceHandle, uint32 spi_ul)
{
    uint32 reg;
...
void hwFe2000Spi4TxForceTrainingOff(sbhandle userDeviceHandle, uint32 spi_ul)
{
    uint32 reg;
...
uint32 hwFe2000Spi4RxStatus(sbhandle userDeviceHandle, uint32 spi_ul)
{
    uint32 reg, rxsync;
 ...
 *
 *****************************************************************************/
uint32 hwFe2000Spi4TxStatus(sbhandle userDeviceHandle, uint32 spi_ul)
{
...
void hwFe2000Spi4RxEnable(sbhandle userDeviceHandle, uint32 enable_ul, uint32 spi_ul)
{
    uint32 sr_cfg0;
...
void hwFe2000Spi4TxEnable(sbhandle userDeviceHandle, uint32 enable_ul, uint32 spi_ul)
{
   uint32 reg, st_cfg1;
 ...
 *
 *****************************************************************************/
uint32 hwFe2000Spi4RxStatusNoDebounce(sbhandle userDeviceHandle, uint32 spi_ul)
{
    uint32 sr_status, sr_error, rxsync;
