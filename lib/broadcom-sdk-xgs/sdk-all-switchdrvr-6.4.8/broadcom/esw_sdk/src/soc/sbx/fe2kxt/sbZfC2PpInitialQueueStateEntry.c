...
sbZfC2PpInitialQueueStateEntry_Unpack(sbZfC2PpInitialQueueStateEntry_t *pToStruct,
  ...
  (pToStruct)->m_uEnetSmacMcast =  (uint32)  ((pFromData)[17] >> 5) & 0x01;

  /* Unpack Member: m_uEnetVlan0Eq3FF */
  (pToStruct)->m_uEnetVlan0Eq3FF =  (uint32)  ((pFromData)[17] >> 4) & 0x01;

  /* Unpack Member: m_uEnetVlan0EqZero */
  (pToStruct)->m_uEnetVlan0EqZero =  (uint32)  ((pFromData)[17] >> 3) & 0x01;

  /* Unpack Member: m_uSyncSPortLt1024 */
  (pToStruct)->m_uSyncSPortLt1024 =  (uint32)  ((pFromData)[17] >> 2) & 0x01;

  /* Unpack Member: m_uUnkMpls0Lbl */
  (pToStruct)->m_uUnkMpls0Lbl =  (uint32)  ((pFromData)[17] >> 1) & 0x01;

  /* Unpack Member: m_uUnkMpls1Lbl */
  (pToStruct)->m_uUnkMpls1Lbl =  (uint32)  ((pFromData)[17] ) & 0x01;

  /* Unpack Member: m_uUnkMpls2Lbl */
  (pToStruct)->m_uUnkMpls2Lbl =  (uint32)  ((pFromData)[16] >> 7) & 0x01;

  /* Unpack Member: m_uEnetVlan2EqZero */
  (pToStruct)->m_uEnetVlan2EqZero =  (uint32)  ((pFromData)[16] >> 6) & 0x01;

  /* Unpack Member: m_uEnetVlan2Eq3FF */
  (pToStruct)->m_uEnetVlan2Eq3FF =  (uint32)  ((pFromData)[16] >> 5) & 0x01;

  /* Unpack Member: m_uIpv6SaOrDaMatch */
  (pToStruct)->m_uIpv6SaOrDaMatch =  (uint32)  ((pFromData)[16] >> 4) & 0x01;

  /* Unpack Member: m_uIpv6SaOrDaLpbk */
  (pToStruct)->m_uIpv6SaOrDaLpbk =  (uint32)  ((pFromData)[16] >> 3) & 0x01;

  /* Unpack Member: m_uIpv4SaOrDaMatch */
  (pToStruct)->m_uIpv4SaOrDaMatch =  (uint32)  ((pFromData)[16] >> 2) & 0x01;

  /* Unpack Member: m_uIpv4SaOrDaMartian */
  (pToStruct)->m_uIpv4SaOrDaMartian =  (uint32)  ((pFromData)[16] >> 1) & 0x01;

  /* Unpack Member: m_uUdpSpEqDp */
  (pToStruct)->m_uUdpSpEqDp =  (uint32)  ((pFromData)[16] ) & 0x01;

  /* Unpack Member: m_uTcpTinyFrag */
  (pToStruct)->m_uTcpTinyFrag =  (uint32)  ((pFromData)[15] >> 7) & 0x01;

  /* Unpack Member: m_uTcpSynFin */
  (pToStruct)->m_uTcpSynFin =  (uint32)  ((pFromData)[15] >> 6) & 0x01;

  /* Unpack Member: m_uTcpXmasScan */
  (pToStruct)->m_uTcpXmasScan =  (uint32)  ((pFromData)[15] >> 5) & 0x01;

  /* Unpack Member: m_uTcpNullScan */
  (pToStruct)->m_uTcpNullScan =  (uint32)  ((pFromData)[15] >> 4) & 0x01;

  /* Unpack Member: m_uTcpSpEqDp */
  (pToStruct)->m_uTcpSpEqDp =  (uint32)  ((pFromData)[15] >> 3) & 0x01;

  /* Unpack Member: m_uEnetTypeValue */
  (pToStruct)->m_uEnetTypeValue =  (uint32)  ((pFromData)[15] >> 2) & 0x01;

  /* Unpack Member: m_uEnetMacEqZero */
  (pToStruct)->m_uEnetMacEqZero =  (uint32)  ((pFromData)[15] >> 1) & 0x01;

  /* Unpack Member: m_uInvPppAddrCtrl */
  (pToStruct)->m_uInvPppAddrCtrl =  (uint32)  ((pFromData)[15] ) & 0x01;

  /* Unpack Member: m_uInvPppPid */
  (pToStruct)->m_uInvPppPid =  (uint32)  ((pFromData)[14] >> 7) & 0x01;

  /* Unpack Member: m_uEnetVlan1EqZero */
  (pToStruct)->m_uEnetVlan1EqZero =  (uint32)  ((pFromData)[14] >> 6) & 0x01;

  /* Unpack Member: m_uEnetVlan1Eq3FF */
  (pToStruct)->m_uEnetVlan1Eq3FF =  (uint32)  ((pFromData)[14] >> 5) & 0x01;

  /* Unpack Member: m_uEnetSmacEqDmac */
  (pToStruct)->m_uEnetSmacEqDmac =  (uint32)  ((pFromData)[14] >> 4) & 0x01;

  /* Unpack Member: m_uInvGreRes0 */
  (pToStruct)->m_uInvGreRes0 =  (uint32)  ((pFromData)[14] >> 3) & 0x01;

  /* Unpack Member: m_uIpv4SaOrDaLpbk */
  (pToStruct)->m_uIpv4SaOrDaLpbk =  (uint32)  ((pFromData)[14] >> 2) & 0x01;

  /* Unpack Member: m_uIpv4RuntPkt */
  (pToStruct)->m_uIpv4RuntPkt =  (uint32)  ((pFromData)[14] >> 1) & 0x01;

  /* Unpack Member: m_uIpv4Options */
  (pToStruct)->m_uIpv4Options =  (uint32)  ((pFromData)[14] ) & 0x01;

  /* Unpack Member: m_uInvIpv4Checksum */
  (pToStruct)->m_uInvIpv4Checksum =  (uint32)  ((pFromData)[13] >> 7) & 0x01;

  /* Unpack Member: m_uInvIpv4Version */
  (pToStruct)->m_uInvIpv4Version =  (uint32)  ((pFromData)[13] >> 6) & 0x01;

  /* Unpack Member: m_uInvIpv4RuntHdr */
  (pToStruct)->m_uInvIpv4RuntHdr =  (uint32)  ((pFromData)[13] >> 5) & 0x01;

  /* Unpack Member: m_uIpv4LenError */
  (pToStruct)->m_uIpv4LenError =  (uint32)  ((pFromData)[13] >> 4) & 0x01;

  /* Unpack Member: m_uIpv4PktLenErr */
  (pToStruct)->m_uIpv4PktLenErr =  (uint32)  ((pFromData)[13] >> 3) & 0x01;

  /* Unpack Member: m_uIpv4InvSa */
  (pToStruct)->m_uIpv4InvSa =  (uint32)  ((pFromData)[13] >> 2) & 0x01;

  /* Unpack Member: m_uIpv4InvDa */
  (pToStruct)->m_uIpv4InvDa =  (uint32)  ((pFromData)[13] >> 1) & 0x01;

  /* Unpack Member: m_uIpv4SaEqDa */
  (pToStruct)->m_uIpv4SaEqDa =  (uint32)  ((pFromData)[13] ) & 0x01;

  /* Unpack Member: m_uIpv6RuntPkt */
  (pToStruct)->m_uIpv6RuntPkt =  (uint32)  ((pFromData)[12] >> 7) & 0x01;

  /* Unpack Member: m_uInvIpv6Ver */
  (pToStruct)->m_uInvIpv6Ver =  (uint32)  ((pFromData)[12] >> 6) & 0x01;

  /* Unpack Member: m_uIpv6PktLenErr */
  (pToStruct)->m_uIpv6PktLenErr =  (uint32)  ((pFromData)[12] >> 5) & 0x01;

  /* Unpack Member: m_uIpv6InvSa */
  (pToStruct)->m_uIpv6InvSa =  (uint32)  ((pFromData)[12] >> 4) & 0x01;

  /* Unpack Member: m_uIpv6InvDa */
  (pToStruct)->m_uIpv6InvDa =  (uint32)  ((pFromData)[12] >> 3) & 0x01;

  /* Unpack Member: m_uIpv6SaEqDa */
  (pToStruct)->m_uIpv6SaEqDa =  (uint32)  ((pFromData)[12] >> 2) & 0x01;

  /* Unpack Member: m_uQueueHash */
  (pToStruct)->m_uQueueHash =  (uint32)  ((pFromData)[8] >> 2) & 0x3f;
  (pToStruct)->m_uQueueHash |=  (uint32)  (pFromData)[9] << 6;
  (pToStruct)->m_uQueueHash |=  (uint32)  (pFromData)[10] << 14;
  (pToStruct)->m_uQueueHash |=  (uint32)  (pFromData)[11] << 22;
  (pToStruct)->m_uQueueHash |=  (uint32)  ((pFromData)[12] & 0x03) << 30;
