...
sbZfC2PrCcCamRamLastEntry_Unpack(sbZfC2PrCcCamRamLastEntry_t *pToStruct,
  ...
  (pToStruct)->m_uDEPort31 =  (uint32)  ((pFromData)[9] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort30 */
  (pToStruct)->m_uDEPort30 =  (uint32)  ((pFromData)[9] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort29 */
  (pToStruct)->m_uDEPort29 =  (uint32)  ((pFromData)[8] >> 7) & 0x01;
  (pToStruct)->m_uDEPort29 |=  (uint32)  ((pFromData)[9] & 0x01) << 1;

  /* Unpack Member: m_uDEPort28 */
  (pToStruct)->m_uDEPort28 =  (uint32)  ((pFromData)[8] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort27 */
  (pToStruct)->m_uDEPort27 =  (uint32)  ((pFromData)[8] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort26 */
  (pToStruct)->m_uDEPort26 =  (uint32)  ((pFromData)[8] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort25 */
  (pToStruct)->m_uDEPort25 =  (uint32)  ((pFromData)[7] >> 7) & 0x01;
  (pToStruct)->m_uDEPort25 |=  (uint32)  ((pFromData)[8] & 0x01) << 1;

  /* Unpack Member: m_uDEPort24 */
  (pToStruct)->m_uDEPort24 =  (uint32)  ((pFromData)[7] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort23 */
  (pToStruct)->m_uDEPort23 =  (uint32)  ((pFromData)[7] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort22 */
  (pToStruct)->m_uDEPort22 =  (uint32)  ((pFromData)[7] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort21 */
  (pToStruct)->m_uDEPort21 =  (uint32)  ((pFromData)[6] >> 7) & 0x01;
  (pToStruct)->m_uDEPort21 |=  (uint32)  ((pFromData)[7] & 0x01) << 1;

  /* Unpack Member: m_uDEPort20 */
  (pToStruct)->m_uDEPort20 =  (uint32)  ((pFromData)[6] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort19 */
  (pToStruct)->m_uDEPort19 =  (uint32)  ((pFromData)[6] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort18 */
  (pToStruct)->m_uDEPort18 =  (uint32)  ((pFromData)[6] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort17 */
  (pToStruct)->m_uDEPort17 =  (uint32)  ((pFromData)[5] >> 7) & 0x01;
  (pToStruct)->m_uDEPort17 |=  (uint32)  ((pFromData)[6] & 0x01) << 1;

  /* Unpack Member: m_uDEPort16 */
  (pToStruct)->m_uDEPort16 =  (uint32)  ((pFromData)[5] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort15 */
  (pToStruct)->m_uDEPort15 =  (uint32)  ((pFromData)[5] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort14 */
  (pToStruct)->m_uDEPort14 =  (uint32)  ((pFromData)[5] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort13 */
  (pToStruct)->m_uDEPort13 =  (uint32)  ((pFromData)[4] >> 7) & 0x01;
  (pToStruct)->m_uDEPort13 |=  (uint32)  ((pFromData)[5] & 0x01) << 1;

  /* Unpack Member: m_uDEPort12 */
  (pToStruct)->m_uDEPort12 =  (uint32)  ((pFromData)[4] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort11 */
  (pToStruct)->m_uDEPort11 =  (uint32)  ((pFromData)[4] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort10 */
  (pToStruct)->m_uDEPort10 =  (uint32)  ((pFromData)[4] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort9 */
  (pToStruct)->m_uDEPort9 =  (uint32)  ((pFromData)[3] >> 7) & 0x01;
  (pToStruct)->m_uDEPort9 |=  (uint32)  ((pFromData)[4] & 0x01) << 1;

  /* Unpack Member: m_uDEPort8 */
  (pToStruct)->m_uDEPort8 =  (uint32)  ((pFromData)[3] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort7 */
  (pToStruct)->m_uDEPort7 =  (uint32)  ((pFromData)[3] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort6 */
  (pToStruct)->m_uDEPort6 =  (uint32)  ((pFromData)[3] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort5 */
  (pToStruct)->m_uDEPort5 =  (uint32)  ((pFromData)[2] >> 7) & 0x01;
  (pToStruct)->m_uDEPort5 |=  (uint32)  ((pFromData)[3] & 0x01) << 1;

  /* Unpack Member: m_uDEPort4 */
  (pToStruct)->m_uDEPort4 =  (uint32)  ((pFromData)[2] >> 5) & 0x03;

  /* Unpack Member: m_uDEPort3 */
  (pToStruct)->m_uDEPort3 =  (uint32)  ((pFromData)[2] >> 3) & 0x03;

  /* Unpack Member: m_uDEPort2 */
  (pToStruct)->m_uDEPort2 =  (uint32)  ((pFromData)[2] >> 1) & 0x03;

  /* Unpack Member: m_uDEPort1 */
  (pToStruct)->m_uDEPort1 =  (uint32)  ((pFromData)[1] >> 7) & 0x01;
  (pToStruct)->m_uDEPort1 |=  (uint32)  ((pFromData)[2] & 0x01) << 1;

  /* Unpack Member: m_uDEPort0 */
  (pToStruct)->m_uDEPort0 =  (uint32)  ((pFromData)[1] >> 5) & 0x03;

  /* Unpack Member: m_uDrop */
  (pToStruct)->m_uDrop =  (uint8)  ((pFromData)[1] >> 4) & 0x01;

  /* Unpack Member: m_uQueueAction */
  (pToStruct)->m_uQueueAction =  (uint32)  ((pFromData)[1] >> 2) & 0x03;

  /* Unpack Member: m_uQueue */
  (pToStruct)->m_uQueue =  (uint32)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_uQueue |=  (uint32)  ((pFromData)[1] & 0x03) << 6;
