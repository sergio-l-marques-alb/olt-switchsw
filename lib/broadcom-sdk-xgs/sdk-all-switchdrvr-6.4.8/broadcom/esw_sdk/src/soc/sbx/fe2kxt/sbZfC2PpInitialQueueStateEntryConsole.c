...
sbZfC2PpInitialQueueStateEntry_Print(sbZfC2PpInitialQueueStateEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: enetsmacmcast=0x%01x"), (unsigned int)  pFromStruct->m_uEnetSmacMcast));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" enetvlan0eq3ff=0x%01x"), (unsigned int)  pFromStruct->m_uEnetVlan0Eq3FF));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: enetvlan0eqzero=0x%01x"), (unsigned int)  pFromStruct->m_uEnetVlan0EqZero));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" syncsportlt1024=0x%01x"), (unsigned int)  pFromStruct->m_uSyncSPortLt1024));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: unkmpls0lbl=0x%01x"), (unsigned int)  pFromStruct->m_uUnkMpls0Lbl));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" unkmpls1lbl=0x%01x"), (unsigned int)  pFromStruct->m_uUnkMpls1Lbl));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: unkmpls2lbl=0x%01x"), (unsigned int)  pFromStruct->m_uUnkMpls2Lbl));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" enetvlan2eqzero=0x%01x"), (unsigned int)  pFromStruct->m_uEnetVlan2EqZero));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: enetvlan2eq3ff=0x%01x"), (unsigned int)  pFromStruct->m_uEnetVlan2Eq3FF));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv6saordamatch=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6SaOrDaMatch));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv6saordalpbk=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6SaOrDaLpbk));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv4saordamatch=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4SaOrDaMatch));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv4saordamartian=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4SaOrDaMartian));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" udpspeqdp=0x%01x"), (unsigned int)  pFromStruct->m_uUdpSpEqDp));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: tcptinyfrag=0x%01x"), (unsigned int)  pFromStruct->m_uTcpTinyFrag));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" tcpsynfin=0x%01x"), (unsigned int)  pFromStruct->m_uTcpSynFin));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" tcpxmasscan=0x%01x"), (unsigned int)  pFromStruct->m_uTcpXmasScan));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: tcpnullscan=0x%01x"), (unsigned int)  pFromStruct->m_uTcpNullScan));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" tcpspeqdp=0x%01x"), (unsigned int)  pFromStruct->m_uTcpSpEqDp));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: enettypevalue=0x%01x"), (unsigned int)  pFromStruct->m_uEnetTypeValue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" enetmaceqzero=0x%01x"), (unsigned int)  pFromStruct->m_uEnetMacEqZero));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: invpppaddrctrl=0x%01x"), (unsigned int)  pFromStruct->m_uInvPppAddrCtrl));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" invppppid=0x%01x"), (unsigned int)  pFromStruct->m_uInvPppPid));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: enetvlan1eqzero=0x%01x"), (unsigned int)  pFromStruct->m_uEnetVlan1EqZero));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" enetvlan1eq3ff=0x%01x"), (unsigned int)  pFromStruct->m_uEnetVlan1Eq3FF));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: enetsmaceqdmac=0x%01x"), (unsigned int)  pFromStruct->m_uEnetSmacEqDmac));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" invgreres0=0x%01x"), (unsigned int)  pFromStruct->m_uInvGreRes0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv4saordalpbk=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4SaOrDaLpbk));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv4runtpkt=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4RuntPkt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv4options=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4Options));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" invipv4checksum=0x%01x"), (unsigned int)  pFromStruct->m_uInvIpv4Checksum));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: invipv4version=0x%01x"), (unsigned int)  pFromStruct->m_uInvIpv4Version));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" invipv4runthdr=0x%01x"), (unsigned int)  pFromStruct->m_uInvIpv4RuntHdr));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv4lenerror=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4LenError));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv4pktlenerr=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4PktLenErr));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv4invsa=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4InvSa));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv4invda=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4InvDa));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv4saeqda=0x%01x"), (unsigned int)  pFromStruct->m_uIpv4SaEqDa));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv6runtpkt=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6RuntPkt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" invipv6ver=0x%01x"), (unsigned int)  pFromStruct->m_uInvIpv6Ver));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv6pktlenerr=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6PktLenErr));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv6invsa=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6InvSa));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" ipv6invda=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6InvDa));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: ipv6saeqda=0x%01x"), (unsigned int)  pFromStruct->m_uIpv6SaEqDa));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" queuehash=0x%08x"), (unsigned int)  pFromStruct->m_uQueueHash));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: headershift=0x%02x"), (unsigned int)  pFromStruct->m_uHeaderShift));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" headertype=0x%01x"), (unsigned int)  pFromStruct->m_uHeaderType));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpInitialQueueStateEntry:: variable=0x%08x"), (unsigned int)  pFromStruct->m_uVariable));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2PpInitialQueueStateEntry_SPrint(sbZfC2PpInitialQueueStateEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
