/*
 * $Id: sbZfFe2000RcSbPattern.c,v 1.4 Broadcom SDK $
...
sbZfFe2000RcSbPattern_Unpack(sbZfFe2000RcSbPattern_t *pToStruct,
  ...
  (pToStruct)->uPattern3 =  (uint32)  (pFromData)[12] ;
  (pToStruct)->uPattern3 |=  (uint32)  (pFromData)[13] << 8;
  (pToStruct)->uPattern3 |=  (uint32)  (pFromData)[14] << 16;
  (pToStruct)->uPattern3 |=  (uint32)  (pFromData)[15] << 24;

  /* Unpack Member: uPattern2 */
  (pToStruct)->uPattern2 =  (uint32)  (pFromData)[8] ;
  (pToStruct)->uPattern2 |=  (uint32)  (pFromData)[9] << 8;
  (pToStruct)->uPattern2 |=  (uint32)  (pFromData)[10] << 16;
  (pToStruct)->uPattern2 |=  (uint32)  (pFromData)[11] << 24;

  /* Unpack Member: uPattern1 */
  (pToStruct)->uPattern1 =  (uint32)  (pFromData)[4] ;
  (pToStruct)->uPattern1 |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->uPattern1 |=  (uint32)  (pFromData)[6] << 16;
  (pToStruct)->uPattern1 |=  (uint32)  (pFromData)[7] << 24;

  /* Unpack Member: uPattern0 */
  (pToStruct)->uPattern0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->uPattern0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->uPattern0 |=  (uint32)  (pFromData)[2] << 16;
  (pToStruct)->uPattern0 |=  (uint32)  (pFromData)[3] << 24;
...
void sbZfFe2000RcSbSetRuleBit( sbZfFe2000RcSbPattern_t *pFrame, 
                               ...
                               uint32 uValue)
{
  uint32 uPatternBlock = uRuleId/32;
  uint32 uBitId        = uRuleId%32;
...
uint32 sbZfFe2000RcSbPatternIsNull( sbZfFe2000RcSbPattern_t *pFrameBase,
                                      uint32 uRuleId,
                                      uint32 uInstCount)
{
