...
_pm_intr_enable_set (const phymod_phy_access_t* phy_acc, int chain_length, uint32 value)
{
    ...
    PM_ITER_ALL_PHYS(rv, phy_idx) {
        ...
        /* enable */
        SOC_IF_ERROR_RETURN(phymod_phy_intr_enable_set(pm_phy, value, 1));

        /* disable */
        SOC_IF_ERROR_RETURN(phymod_phy_intr_enable_set(pm_phy, value ^ 0xFFFFFFFF, 0));
    }
    return(PHYMOD_E_NONE);
}
...
_pm_intr_status_get (const phymod_phy_access_t* phy_acc, int chain_length, uint32 *value)
{
    ...
    PM_ITER_ALL_PHYS(rv, phy_idx) {
        ...
        SOC_IF_ERROR_RETURN(phymod_phy_intr_status_get(pm_phy, 0xFFFFFFFF, value));
    }
    return(PHYMOD_E_NONE);
}
...
_pm_intr_enable_get (const phymod_phy_access_t* phy_acc, int chain_length, uint32 *value)
{
    ...
    PM_ITER_ALL_PHYS(rv, phy_idx) {
        ...
        SOC_IF_ERROR_RETURN(phymod_phy_intr_enable_get(pm_phy, 0xFFFFFFFF, value));
    }
    return(PHYMOD_E_NONE);
}
