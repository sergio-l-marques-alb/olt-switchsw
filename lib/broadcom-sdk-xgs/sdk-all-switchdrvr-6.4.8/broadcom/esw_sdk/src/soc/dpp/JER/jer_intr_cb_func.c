...
int jer_event_drc_phy_cdr_above_th_handler(int unit, int block_instance, uint32 en_interrupt, char* msg)
{
    ...
    SOCDNX_IF_ERR_EXIT( jer_interrupt_print_info(unit, block_instance, en_interrupt, 0, JER_INT_CORR_ACT_SOFT_RESET, msg));
...
void jer_interrupt_cb_init(int unit)
{
    ...
    dcmn_intr_add_handler_ext(unit, JER_INT_CGM_ECC_PARITY_ERR_INT, 0,0,jer_none,NULL,"JER_INT_CGM_ECC_PARITY_ERR_INT");
    dcmn_intr_add_handler_ext(unit, JER_INT_CGM_ECC_ECC_1B_ERR_INT, 1000,100,jer_scrub_shadow_write,jer_special_handling_recur_3,"if memory was not cached, ignore.");
    dcmn_intr_add_handler_ext(unit, JER_INT_CGM_ECC_ECC_2B_ERR_INT, 1000,100,jer_special_handling_normal_4,jer_special_handling_recur_5,"identify the memory according to the field Ecc 2bErrAddr in reg Ecc_2b_Err_Cnt. according to the memory severity, either init device (or core), fix line , ignore or perform action that applies for the specific memory.");
    ...
    dcmn_intr_add_handler_ext(unit, JER_INT_MESH_TOPOLOGY_ECC_PARITY_ERR_INT, 0,0,jer_none,NULL,"JER_INT_MESH_TOPOLOGY_ECC_PARITY_ERR_INT");
    dcmn_intr_add_handler_ext(unit, JER_INT_MESH_TOPOLOGY_ECC_ECC_1B_ERR_INT, 0,0,jer_none,NULL,"JER_INT_MESH_TOPOLOGY_ECC_ECC_1B_ERR_INT");
    dcmn_intr_add_handler_ext(unit, JER_INT_MESH_TOPOLOGY_ECC_ECC_2B_ERR_INT, 0,0,jer_none,NULL,"JER_INT_MESH_TOPOLOGY_ECC_ECC_2B_ERR_INT");
