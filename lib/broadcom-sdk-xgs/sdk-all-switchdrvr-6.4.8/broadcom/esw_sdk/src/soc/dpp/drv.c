...
/* } */
    ...
    if (SOC_WARM_BOOT(unit)) {
            rv = shr_sw_state_init(unit, 0x0, socSwStateDataBlockRestoreAndOveride);
            SOCDNX_IF_ERR_RETURN(rv);
    }
    else{
            rv = shr_sw_state_init(unit, 0x0, socSwStateDataBlockRegularInit);
            SOCDNX_IF_ERR_RETURN(rv);
    }
