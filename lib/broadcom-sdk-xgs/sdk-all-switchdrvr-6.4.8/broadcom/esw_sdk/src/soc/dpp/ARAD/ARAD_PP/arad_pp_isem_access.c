...
#define ARAD_PP_ISEM_ACCESS_KEY_MPLS_EVPN_LABEL_LSB                   2
#define ARAD_PP_ISEM_ACCESS_KEY_MPLS_EVPN_LABEL_MSB                   21
...
#define ARAD_PP_ISEM_ACCESS_KEY_MPLS_EVPN_LABEL_BOS_MSB               (1)
...
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_VALID_MSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_VALID_LSB(unit) + 1)
...
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_DIP_MASK_LSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_VALID_MSB(unit) + 1)
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_DIP_MASK_MSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_DIP_MASK_LSB(unit) + 7)
...
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_SIP_MASK_MSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_SIP_MASK_LSB(unit) + 7)
...
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_MASK_MSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_MASK_LSB(unit) + 4)
...
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_VALID_MASK_MSB(unit)      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_VALID_MASK_LSB(unit) + 1)
...
/*tcam_db_id write location used for TCAM sw db*/
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_LSB      (155)
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_MSB      (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_LSB + 4)
#define ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_NOF_BITS (ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_MSB - ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_LSB + 1)
...
#define ARAD_PP_ISEM_ACCESS_16B_INST_FID_BITS_8                                      (SOC_IS_JERICHO(unit)? 0x89E8: 0x85E8)
...
#define ARAD_PP_ISEM_ACCESS_16B_INST_INITIAL_VSI_12_BIT                                            (SOC_IS_JERICHO(unit)?(0xb9E8):(0xb5e8))
...
#define ARAD_PP_ISEM_ACCESS_16B_INST_P6_IN_PORT_KEY_GEN_VAR_D_13_BITS                                            (0xce88)
...
#define ARAD_PP_ISEM_16B_INST_ARAD_FC_WITH_VFT_VFT_ID           arad_pp_ce_instruction_composer(13,2,16,ARAD_PP_CE_IS_CE16);
  ...
  )
{
  ...
  /* in case of OAM statistics per mep SEM-A and SEM-B in the VT stage lookup are used
   to classify what is the Ethernet header format (untagged, single tag or double tag)*/
  ...
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst1 = 0x3fd0; /*Opaque-PT-Attributes*/
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst0 = 0x3010; /*ITMH.PPH-Type*/
  ...
  ihp_vtt1st_key_construction_tbl_data.isb_or_mask          = ARAD_PP_ISEM_ACCESS_BFD_STAT_VT_PREFIX;
  
  ihp_vtt1st_key_construction_tbl_data.isa_and_mask         = (0x0);
  ihp_vtt1st_key_construction_tbl_data.isa_or_mask          = ARAD_PP_ISEM_ACCESS_OAM_STAT_VT_PREFIX; 

  ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_bitmap  =  (0x10); /* Only ISA is relevant */
  ihp_vtt1st_key_construction_tbl_data.vlan_translation_1_pd_bitmap = (0x8); /* Only ISB is relevant */
  ...
  )
{
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_TEST2].prog_used != -1) 
  {
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_EXTENDER_PE].prog_used != -1) 
  {
    SET_VT_PROGRAM_SELECTION(prog_indx);
   ...
   * }
   */
  if ((SOC_DPP_CONFIG(unit)->pp.oam_statistics == 1 ) && (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_TM_PROG].prog_used != -1))
   {
...
/*Oam statastics - Oam up mep packets*/
STATIC
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_oam_stat_prog_set(
     int unit,
     uint32 prog_indx, 
     uint32 prog_sel
   )
{
  ...
  prog_selection_2nd_cam_tbl.isa_lookup_found_mask = (0);
...
/*Oam statastics - BFD packets*/
STATIC
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_bfd_stat_prog_set(
     int unit,
     uint32 prog_indx, /* ARAD_PP_ISEM_ACCESS_PROG_TM_RULE_NUM */
     uint32 prog_sel
   )
{
  ...
  prog_selection_2nd_cam_tbl.isb_lookup_found_mask = (0);
...
{
    uint32 res, i;
    ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA prog_selection_2nd_cam_tbl;
    ...
    for (i = 0; i < DPP_PP_ISEM_PROG_SEL_1ST_CAM_DEF_OFFSET(unit); i++){
        ...
        res = arad_pp_ihp_isem_2nd_program_selection_cam_tbl_get_unsafe(unit, i, &prog_selection_2nd_cam_tbl);
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

        if((prog_selection_2nd_cam_tbl.llvp_prog_sel == tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_FC_WITH_VFT_PROG].prog_used) || (prog_selection_2nd_cam_tbl.llvp_prog_sel == tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_FC_PROG].prog_used)){
          
          prog_selection_2nd_cam_tbl.valid = enable;
                    
          res = arad_pp_ihp_isem_2nd_program_selection_cam_tbl_set_unsafe(unit, i, &prog_selection_2nd_cam_tbl);
          SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
        }    
    }
   ...
   )
{
  ...
  if (soc_property_get(unit, spn_FCOE_NPV_BRIDGE_MODE, 0)) {
    ...
    prog_selection_2nd_cam_tbl.in_pp_port_tt_profile      = ARAD_PP_PORT_DEFINED_TT_PROFILE_FCOE_N_PORT;
    ...
    prog_selection_2nd_cam_tbl.packet_format_code_mask    = 0;
    prog_selection_2nd_cam_tbl.llvp_prog_sel              = prog_sel;
    prog_selection_2nd_cam_tbl.valid                      = (0x0); /* enabled by switch control */
...
/* Set two lines for mldp programm selection*/
STATIC
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_mldp_overlay_after_recycle_prog_set(
     int unit,
     uint32 nof_mpls_labels,
     uint32 prog_indx, /* ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_OVERLAY_AFTER_RECYCLE_RULE_NUM */
     uint32 prog_sel
   )
{
  uint32
  ...
  prog_selection_2nd_cam_tbl.packet_format_code               = (nof_mpls_labels == 1) ? 0x5 : 0x6 ;/*IHP_PFC_PART_MPLS1 : IHP_PFC_PART_MPLS2*/
  ...
  )
{
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG].prog_used != -1) {
	  res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_bfd_stat_prog_set(unit,prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG, exit);
  }

  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG].prog_used != -1) {
	  SET_TT_PROGRAM_SELECTION(prog_indx);
	  res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_oam_stat_prog_set(unit,prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG, exit);
  }
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_EXTENDER_UNTAG_CHECK].prog_used != -1) 
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_mldp_overlay_after_recycle_prog_set(unit,1, prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE, exit);

    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_mldp_overlay_after_recycle_prog_set(unit,2, prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE, exit);
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L3].prog_used != -1)
  {
    ...
    if (prog_soc_prop->mpls_tp_mac_address) 
      prog_indx++;
      /*arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l3_set(unit,prog_indx,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L3].prog_used);*/
  }
  ...
  if (SOC_IS_ARADPLUS_AND_BELOW(unit) && tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_IPV4_ROUTER_PWE_GRE_DIP_FOUND_PROG].prog_used != -1) 
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_IPV4_ROUTER_DIP_SIP_VRF_PROG].prog_used != -1) 
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_BRIDGE_STAR_2ND_PROG].prog_used != -1 && ipmc_second_pass_caused_by_rpf_fail(unit) ) 
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_ip_router_compatiblemc_2nd_prog_set(unit,prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_BRIDGE_STAR_2ND_PROG].prog_used,prog_soc_prop->ipv4mc_bidir_enable,1);
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG].prog_used != -1) 
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  if(SOC_DPP_CONFIG(unit)->pp.custom_feature_vt_tst2)
  {
      ...
      if (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "EoE_test2_enable", 0)) {
          SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_TEST2); 
  ...
  else
  {
      ...
      {
          SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_EXTENDER_PE);
  ...
  /*OAM statistics*/
  if (SOC_DPP_CONFIG(unit)->pp.oam_statistics == 1 ){
	  SET_TT_PROGRAM_ID(ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG);
	  SET_TT_PROGRAM_ID(ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG);
  }
  ...
  if (prog_soc_prop.compression_ip6_enable) {
    SET_TT_PROGRAM_ID(ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG);
  ...
  if (prog_soc_prop.ipv4_term_dip_sip_enable == 3) {
      SET_TT_PROGRAM_ID(ARAD_PP_ISEM_ACCESS_PROG_TT_IPV4_ROUTER_DIP_SIP_VRF_PROG); 
 ...
 /* Mac-in-MAC */
  ...
  if (SOC_DPP_CONFIG(unit)->pp.mldp_support) {
       SET_TT_PROGRAM_ID(ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE);

   }

  /* Port extender */
  if (SOC_DPP_CONFIG(unit)->extender.port_extender_init_status) {
       SET_TT_PROGRAM_ID(ARAD_PP_ISEM_ACCESS_PROG_TT_EXTENDER_UNTAG_CHECK);
  ...
  )
{
  ...
  if(soc_property_suffix_num_get(unit,-1,spn_CUSTOM_FEATURE,"pon_lif_lkup",0)) {
      ...
      ihp_vtt1st_key_construction_tbl_data.isa_lookup_enable    = 0x1;  /* Enable ISA lkup */
      ihp_vtt1st_key_construction_tbl_data.isb_and_mask         = 0x0;
      ihp_vtt1st_key_construction_tbl_data.isb_or_mask          =  ARAD_PP_ISEM_ACCESS_PON_TLS_PREFIX; 
  }else{
      ihp_vtt1st_key_construction_tbl_data.isa_and_mask         =  (custom_pon_enable ? 0x0:0x3); /* pon prefix is actually 2 bits and not 4 */
  ...
  if (SOC_IS_ARADPLUS(unit)) {
     ...
     if(soc_property_suffix_num_get(unit,-1,spn_CUSTOM_FEATURE,"pon_lif_lkup",0)){/*TCAM > ISA > ISB when define "custom_feature_pon_lif_lkup" */
          ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_tcam_strength = 3;
          ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_isa_strength = 2;
          ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_isb_strength = 1;
     }else if (tls_in_tcam_enable) {
          ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_tcam_strength = 1;
          ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_isa_strength = custom_pon_enable ? 2 : 3;
          ihp_vtt1st_key_construction_tbl_data.vlan_translation_0_pd_isb_strength = custom_pon_enable ? 3 : 2;
      } else {
...
/*oam statistics - up map packets 
  iSEM-A and SEM-B in the TT stage lookup are used
  to classify what is the Ethernet header format (untagged, single tag or double tag)*/
STATIC
uint32
  arad_pp_vtt_2nd_lookup_program_tt_oam_stat_prog_set(
    int unit
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG].prog_used;
  ...
  ihp_vtt2nd_key_construction_tbl_data.isa_lookup_enable = (0x1); /* Enable ISA lkup */
  ihp_vtt2nd_key_construction_tbl_data.isb_lookup_enable = (0x1); /* Enable ISB lkup */
  ihp_vtt2nd_key_construction_tbl_data.tcam_db_profile   = (0x3F);

  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst0 = 0x7900; /*16bit afeter DA */
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst1 = 0x7940; /*16 bit after DA+4Bytes*/
  ihp_vtt2nd_key_construction_tbl_data.isa_key_valids_1 = 0x4; /*0100*/
  ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1 = 0x8; /*1000*/

  ihp_vtt2nd_key_construction_tbl_data.isa_and_mask         = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isa_or_mask          = ARAD_PP_ISEM_ACCESS_OAM_STAT_TT_PREFIX; 
  ihp_vtt2nd_key_construction_tbl_data.isb_and_mask         = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isb_or_mask          = ARAD_PP_ISEM_ACCESS_OAM_STAT_TT_PREFIX; 

  ihp_vtt2nd_key_construction_tbl_data.termination_0_pd_bitmap = (0x10); /* Only ISA is relevant */
  ihp_vtt2nd_key_construction_tbl_data.termination_1_pd_bitmap = (0x8); /* Only ISB is relevant */
...
/*oam statistics - BFD packets 
  iSEM-A and SEM-B in the TT stage lookup are used
  to classify what is the packet format*/
STATIC
uint32
  arad_pp_vtt_2nd_lookup_program_tt_bfd_stat_prog_set(
    int unit
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0 = 0x3100; /*pph fwd code */
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1 = 0x3250; /*4 bit after Label*/
  ihp_vtt2nd_key_construction_tbl_data.isa_key_valids_1 = 0x1; 
  ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1 = 0x2; 

  ihp_vtt2nd_key_construction_tbl_data.isa_and_mask         = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isa_or_mask          = ARAD_PP_ISEM_ACCESS_BFD_STAT_TT_ISA_PREFIX; 
  ihp_vtt2nd_key_construction_tbl_data.isb_and_mask         = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isb_or_mask          = ARAD_PP_ISEM_ACCESS_BFD_STAT_TT_ISB_PREFIX; 
...
uint32
  arad_pp_vtt_2nd_lookup_program_tt_fc_prog_set(
    int unit, uint32 is_vsan_from_vsi
  )
{
  uint32
    res; 
  ...
  if (!is_vsan_from_vsi/*VSAN from VFT*/){
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0 = (ARAD_PP_ISEM_ACCESS_16B_INST_PP_PORT_KEY_VAR_X_LSBS(13));/*no vft use port default VFT value */
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1 = ARAD_PP_ISEM_ACCESS_16B_INST_FC_D_ID_8_MSB; /*FC_D_ID[23:16] */
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1  = (0x3); /* take only port default VFT*/
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_2  = (0x0);
  } else {/*VSAN from VSI */
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0 = ARAD_PP_ISEM_ACCESS_16B_INST_INITIAL_VSI_12_BIT;/*VSI*/
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1 = ARAD_PP_ISEM_ACCESS_16B_INST_1_ZEROS; /* adding one bit zero to the vsi*/
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2 = ARAD_PP_ISEM_ACCESS_16B_INST_FC_D_ID_8_MSB; /*FC_D_ID[23:16] */
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1  = (0x3);/* take VSI + 1 bit zero*/
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_2  = (0x1);
  }
  ...
  )
{
  ...
  /*TT0 - L2 in ISB */  
  if (!is_vsan_from_vsi){/* VSAN from VFT */
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0 = ARAD_PP_ISEM_16B_INST_ARAD_FC_WITH_VFT_VFT_ID;/*VFT*/
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1 = ARAD_PP_ISEM_ACCESS_16B_INST_FC_WITH_VFT_D_ID_8_MSB; /*FC_D_ID[23:16] */
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1  = (0x3);
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_2  = (0x0);
  } else {/*VSAN from VSI */
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0 = ARAD_PP_ISEM_ACCESS_16B_INST_INITIAL_VSI_12_BIT;/*VSI*/      
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1 = ARAD_PP_ISEM_ACCESS_16B_INST_1_ZEROS;/* adding one bit zero to the vsi*/
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2 = ARAD_PP_ISEM_ACCESS_16B_INST_FC_WITH_VFT_D_ID_8_MSB; /*FC_D_ID[23:16] */
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1  = (0x3);
      ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_2  = (0x1);
  }
...
uint32
  arad_pp_vtt_fcf_vsan_mode_update(
    uint32 unit, uint32 is_vsan_from_vsi
  )
{
  uint32 res; 
  ...
  res = arad_pp_vtt_2nd_lookup_program_tt_fc_prog_set(unit, is_vsan_from_vsi);
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);

  res = arad_pp_vtt_2nd_lookup_program_tt_fc_with_vft_prog_set(unit, is_vsan_from_vsi);
  SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_vtt_fcf_vsan_mode_update()", unit, is_vsan_from_vsi);
}
...
STATIC
uint32
  arad_pp_vtt_2nd_lookup_program_tt_mldp_overlay_set(
    int unit
  )
{
  uint32
    res;
  int
    prog_indx = tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  /* ISA label1
     ISB label2
   */
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst0            = ARAD_PP_ISEM_ACCESS_32B_INST_X_ONES(21);
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst1            = ARAD_PP_CE_MPLS_1_BOS_32;
  ihp_vtt2nd_key_construction_tbl_data.isa_key_valids_1         = (0xc);
  ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_1         = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2            = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isb_key_valids_2         = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isa_and_mask             = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isa_or_mask              = ARAD_PP_ISEM_ACCESS_MPLS_UNINDEXED_PREFIX;
  ihp_vtt2nd_key_construction_tbl_data.isa_lookup_enable        = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isb_and_mask             = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.isb_or_mask              = (0x0);
  ...
  ihp_vtt2nd_key_construction_tbl_data.result_to_use_1          = (0);
  ihp_vtt2nd_key_construction_tbl_data.result_to_use_2          = (0);
  ihp_vtt2nd_key_construction_tbl_data.second_stage_parsing     = 1;
  ihp_vtt2nd_key_construction_tbl_data.processing_profile       = ARAD_PP_IHP_VTT_TT_PROCESSING_PROFILE_NONE;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_vtt_2nd_lookup_program_tt_mldp_overlay_set()", 0, 0);
  ...
  )
{
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG].prog_used != -1)
  {
    res = arad_pp_vtt_2nd_lookup_program_tt_bfd_stat_prog_set(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG, exit);
  }

  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG].prog_used != -1)
  {
    res = arad_pp_vtt_2nd_lookup_program_tt_oam_stat_prog_set(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG, exit);
  }

  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_FC_WITH_VFT_PROG].prog_used != -1)
  {
    res = arad_pp_vtt_2nd_lookup_program_tt_fc_with_vft_prog_set(unit, 0);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_FC_WITH_VFT_PROG, exit);
  }

  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_FC_PROG].prog_used != -1)
  {
    res = arad_pp_vtt_2nd_lookup_program_tt_fc_prog_set(unit, 0);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_FC_PROG, exit);
  }

  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE].prog_used != -1)
  {
    res = arad_pp_vtt_2nd_lookup_program_tt_mldp_overlay_set(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE, exit);
  }
  ...
  )
{
  ...
  if (SOC_DPP_CONFIG(unit)->pp.ingress_full_mymac_1)
  {
      ...
      tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_SRC_PORT_DA_DB_PROFILE;
  ...
  if(custom_feature_vt_tst2)
  {
      ...
      tcam_access_info.min_banks                           = ARAD_PP_ISEM_ACCESS_TCAM_DEF_MIN_BANKS;
      tcam_access_info.prefix_size                         = ARAD_PP_ISEM_ACCESS_TCAM_DEF_PREFIX_SIZE;
      tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_TST2_PROFILE;
  ...
  else
  {
      ...
      if (SOC_DPP_CONFIG(unit)->pp.test2) {
          ...
          tcam_access_info.min_banks                           = ARAD_PP_ISEM_ACCESS_TCAM_DEF_MIN_BANKS;
          tcam_access_info.prefix_size                         = ARAD_PP_ISEM_ACCESS_TCAM_DEF_PREFIX_SIZE;
          tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_TEST2_PROFILE;
      ...
      if (ipv4_term_dip_sip_enable) /* Enabled when Required IPV4 Tunnel Termination by SIP & DIP */
      {
          ...
          if (ipv4_term_dip_sip_enable == 3) 
          {
              ...
              tcam_access_info.min_banks                           = ARAD_PP_ISEM_ACCESS_TCAM_DEF_MIN_BANKS;
              tcam_access_info.prefix_size                         = ARAD_PP_ISEM_ACCESS_TCAM_DEF_PREFIX_SIZE;
              tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_DIP_SIP_VRF_PROFILE;
  ...
  if (compression_ip6_enable) {
      ...
      tcam_access_info.min_banks                           = ARAD_PP_ISEM_ACCESS_TCAM_DEF_MIN_BANKS;
      tcam_access_info.prefix_size                         = ARAD_PP_ISEM_ACCESS_TCAM_DEF_PREFIX_SIZE;
      tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_TT_DIP_COMPRESSION_DB_PROFILE;
  ...
  if (spoof_ipv6_enable && compression_spoof_ip6_enable) {
      ...
      tcam_access_info.min_banks                           = ARAD_PP_ISEM_ACCESS_TCAM_DEF_MIN_BANKS;
      tcam_access_info.prefix_size                         = ARAD_PP_ISEM_ACCESS_TCAM_DEF_PREFIX_SIZE;
      tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_TT_IPV6_SPOOF_COMPRESSION;
...
#define  prog_soc_prop     (&(g_prog_soc_prop[unit]))
    ...
    if (SOC_DPP_CONFIG(unit)->pp.ipv4_tunnel_term_bitmap_enable & SOC_DPP_IP_TUNNEL_TERM_DB_DIP_SIP_NEXT_PROTOCOL) {
        ...
        prog_soc_prop->ipv4_term_dip_sip_enable = 3; /* IPV4 Next protocol is enabled */
    }
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  *is_duplicate_entry = 0;
	  ...
	  for (core = 0; core < SOC_DPP_DEFS_GET(unit, nof_cores); core++) {
          for (port_i = 0; port_i < ARAD_PP_NOF_PORTS; ++port_i)
          {
            ...
            {        
              ...
              pon_double_lookup_enable = ARAD_PP_PON_DOUBLE_LOOKUP_PORT_GET(port_i);
              break;
            }
          }
      }
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_MPLS_L1_IN_RIF_ELI:
      found = TRUE;
      if(isem_key->key_info.mpls.flags == ARAD_PP_MPLS_TERM_FLAG_DUMMY_LABEL)
      {
          tables_access_ids[0] = ARAD_PP_ISEM_ACCESS_ID_ISEM_A;
      }else{
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  if (table_access_id != ARAD_PP_ISEM_ACCESS_ID_TCAM) {
      ...
      prefix = arad_pp_isem_access_tcam_db_id_get(
                   isem_key->key_type
               );
      SOC_SAND_CHECK_FUNC_RESULT(res, 21, exit);

      res = soc_sand_bitstream_set_any_field(&prefix, ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_LSB, ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_NOF_BITS, buffer);
      ...
      if (isem_key->key_info.mpls.flags & ARAD_PP_MPLS_TERM_FLAG_DUMMY_LABEL){
          ...
          if (prog_soc_prop.evpn_enable) {
            ...
            if (prog_soc_prop.evpn_enable)
            {
                ...
                if (isem_key->key_info.mpls.flags & ARAD_PP_MPLS_TERM_FLAG_EVPN_IML) {
    ...
    arad_pp_isem_access_tcam_db_id_get(SOC_SAND_IN ARAD_PP_ISEM_ACCESS_KEY_TYPE key_type)
{
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_TST2_TCAM:
    ...
    break;
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_DUMMY:
    tcam_db_id = ARAD_TCAM_DB_ID_INVALID;
    break;
...
{
  uint32
    long_stream[ARAD_PP_ISEM_ACCESS_TCAM_KEY_LEN_LONGS];
  uint32
    res;
  ...
  res = SOC_SAND_OK; sal_memset(long_stream, 0x0, sizeof(uint32) * ARAD_PP_ISEM_ACCESS_TCAM_KEY_LEN_LONGS);
  SOC_SAND_CHECK_FUNC_RESULT(res,  20, exit);
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_IP_TUNNEL_SIP_DIP_VRF: 
      ...
      soc_sand_bitstream_set_bit_range(entry->mask, 
                                       ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_DIP_LSB, 
                                       ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_DIP_LSB + isem_key->key_info.ip_tunnel.dip_prefix_len-1); 
      /* set SIP mask */
      soc_sand_bitstream_set_bit_range(entry->mask, 
                                       ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_SIP_LSB, 
                                       ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_SIP_LSB + isem_key->key_info.ip_tunnel.sip_prefix_len-1); 
      /* set VRF mask */
      soc_sand_bitstream_set_bit_range(entry->mask, 
                                       ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_LSB, 
                                       ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_DIP_SIP_VRF_TCAM_VRF_LSB + isem_key->key_info.ip_tunnel.vrf_prefix_len-1); 
  ...
  )
{
    ...
    if(entry_exists)
    {
        ...
        if(found)
        {
            ...
            res = soc_sand_bitstream_get_any_field(entry.value, ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_LSB, ARAD_PP_ISEM_ACCESS_KEY_IP_TUNNEL_TCAM_DB_ID_NOF_BITS, &prefix);
            SOC_SAND_CHECK_FUNC_RESULT(res,  20, exit);
...
#if SOC_DPP_IS_EM_HW_ENABLE
    if (! ((SOC_IS_DONE_INIT(unit)) && (BCM_UNIT_DO_HW_READ_WRITE(unit))))        /* Skip the read if HW LOG is activated. It doesn't reflect the 'ready' state anyway because all the read/writes are postponed if HwLog is activated */
    {
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  10,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, tmp_reg_name, block_port_id, 0, tmp_fld_name, &temp));
      if (temp)
      {
      ...
      SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  19,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, tmp_reg_name, block_port_id, 0, tmp_fld_name,  temp));
       ...
       tmp_reg_name = SOC_IS_QAX(unit) ? PPDB_A_ISEM_MANAGEMENT_UNIT_FAILUREr :
  ...
  )
{
    ...
    case ARAD_PP_ISEM_ACCESS_PROG_VT_EVB_UN_C_TAG:
        ...
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_EXTENDER_PE:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_EXTENDER_PE";
        break;
    ...
    case ARAD_PP_ISEM_ACCESS_PROG_VT_VD_SINGLE_TAG_EXPLICIT_NULL:
        ...
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_1_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_1_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_2_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_2_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_1_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_1_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_2_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_2_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_1_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_1_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_2_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_2_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_1_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_1_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_2_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_2_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_UNTAGGED_TST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_UNTAGGED_TST2";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_VT_TEST2:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_VT_TEST2";
        break;
    default:
  ...
  )
{
    ...
    case ARAD_PP_ISEM_ACCESS_PROG_TT_TM_PROG:
        ...
        break;
	case ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG";
        break;
	case ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG";
        break;
    ...
    case ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3_GAL:
        ...
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG:
      prog_name = "ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG";
      break;
    case ARAD_PP_ISEM_ACCESS_PROG_TT_EXTENDER_UNTAG_CHECK:
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_TT_EXTENDER_UNTAG_CHECK";
        break;
    case ARAD_PP_ISEM_ACCESS_PROG_TT_IPV4_ROUTER_DIP_SIP_VRF_PROG: 
        prog_name = "ARAD_PP_ISEM_ACCESS_PROG_TT_IPV4_ROUTER_DIP_SIP_VRF_PROG"; 
        break; 
    default:
        prog_name = "Unknown program";
    }
