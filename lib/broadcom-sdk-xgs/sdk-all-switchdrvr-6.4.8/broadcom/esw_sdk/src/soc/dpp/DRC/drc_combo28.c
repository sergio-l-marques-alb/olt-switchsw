...
int soc_dpp_drc_combo28_info_config(int unit, soc_dpp_drc_combo28_info_t *drc_info) 
{
    ...
    first_word = SOC_PBMP_WORD_GET(drc_info->dram_bitmap, 0);
...
int soc_dpp_drc_combo28_cdr_monitor_enable_set(int unit, int drc_ndx, int switch_on)
{
    ...
    switch_on = switch_on ? 1 : 0;
    SOCDNX_IF_ERR_EXIT( soc_reg_field32_modify(unit, DRC_PERIODIC_PHY_CDR_MONITOR_CFGr[drc_ndx], REG_PORT_ANY, PHY_CDR_MONITOR_ENf, switch_on));
