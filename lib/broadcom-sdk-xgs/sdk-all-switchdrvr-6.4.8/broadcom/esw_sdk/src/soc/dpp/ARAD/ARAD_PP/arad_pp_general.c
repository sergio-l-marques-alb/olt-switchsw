...
/* $Id: arad_pp_general.c,v 1.48 Broadcom SDK $
...
#define ARAD_PP_FRWRD_DECISION_INFO_TYPE_MAX                     (ARAD_PP_NOF_FRWRD_DECISION_TYPES-1)
 ...
 *  differences in encoding between Arad and Jericho for MC, FEC and Sys-port
 */
...
#define ARAD_PP_EEI_POP_TPID_PROFILE_NOF_BITS                (2)
#define ARAD_PP_EEI_POP_MODEL_NOF_BITS                       (1)
#define ARAD_PP_EEI_POP_CW_NOF_BITS                          (1)
#define ARAD_PP_EEI_POP_UPPER_LAYER_NOF_BITS                 (4)

#define ARAD_PP_EEI_PUSH_CMD_NOF_BITS                        (4)


#define ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_MSB                   (SOC_IS_JERICHO(unit)?2:0)
#define ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_LSB                   (16)
#define ARAD_PP_EEI_ENCAP_PTR_NOF_BITS                       (ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_LSB+ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_MSB)
...
typedef enum
{
  ...
  /*
   *  Number of types in ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE
   */
  ...
  Arad_pp_procedure_desc_element_general[] =
{
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PKT_HDR_TYPE_TO_INTERANL_VAL_MAP),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_PKT_HDR_INTERANL_VAL_TO_TYPE_MAP),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_NEXT_PRTCL_TYPE_TO_INTERANL_VAL_MAP),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_NEXT_PRTCL_INTERANL_VAL_TO_TYPE_MAP),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_NEXT_PRTCL_TYPE_ALLOCATE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_NEXT_PRTCL_TYPE_DEALLOCATE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_NEXT_PRTCL_TYPE_FIND),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_L2_NEXT_PRTCL_TYPE_FROM_INTERNAL_FIND),
  ...
  Arad_pp_error_desc_element_general[] =
{
   ...
   */
  {
    ARAD_PP_TM_PORT_OUT_OF_RANGE_ERR,
    "ARAD_PP_TM_PORT_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_TM_PORT' is out of range. \n\r "
  ...
  },
  {
    ...
    "ARAD_PP_PORT_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_PORT' is out of range. \n\r "
    "The range is: 0 - No_max.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "ARAD_PP_FID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_FID' is out of range. \n\r "
  ...
  },
  {
    ...
    "ARAD_PP_VSI_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_VSI_ID' is out of range. \n\r "
    "The range is: 0 - 16*1024-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  ...
  },
  {
    ...
    "ARAD_PP_SYS_VSI_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_SYS_VSI_ID' is out of range. \n\r "
  ...
  },
  {
    ...
    "ARAD_PP_FEC_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_FEC_ID' is out of range. \n\r "
  ...
  },
  {
    ...
    "ARAD_PP_VRF_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_VRF_ID' is out of range. \n\r "
    "The range is: 1 - 255.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "ARAD_PP_AC_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_AC_ID' is out of range. \n\r "
    "The range is: 0 - 16*1024-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "ARAD_PP_RIF_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_RIF_ID' is out of range. \n\r "
  ...
  },
  {
    ...
    "ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_LIF_ID' is out of range. \n\r "
    "The range is: 0 - 64*1024-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "ARAD_PP_MP_LEVEL_OUT_OF_RANGE_ERR",
    "The parameter of type 'ARAD_PP_MP_LEVEL' is out of range. \n\r "
    "The range is: 0 - No_max.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_OUTLIF_ENCODE_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_MPLS_COMMAND_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 to ARAD_PP_NOF_EEI_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "ARAD_PP_GENERAL_FRWRD_TYPE_OUT_OF_RANGE_ERR",
    "'' is out of range. \n\r "
    "The range is: 0 to ARAD_PP_NOF_FRWRD_DECISION_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "ARAD_PP_FRWRD_DEFAULT_ACTIION_TYPE_OUT_OF_RANGE_ERR",
    "'' is out of range. \n\r "
    "The range is: 0 to ARAD_PP_NOF_FRWRD_IPV4_ROUTER_DEFAULT_ACTION_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    )
{
  ...
  *is_outlif = 0;
  ...
  if(fwd_decision_type == ARAD_PP_FRWRD_DECISION_TYPE_MC || fwd_decision_type == ARAD_PP_FRWRD_DECISION_TYPE_FEC)
  {
    *is_eei = TRUE;
  }
  else
...
STATIC uint32
  arad_pp_fwd_decision_dest_prefix_find(
    ...
    SOC_SAND_IN  ARAD_PP_DEST_ENCODE_TYPE    encode_type,
    SOC_SAND_IN  ARAD_PP_FRWRD_DECISION_TYPE fwd_decision_type,
    ...
    )
{
  ...
  switch(fwd_decision_type)
  {
     ...
     *  Single port / LAG
     */
    case ARAD_PP_FRWRD_DECISION_TYPE_UC_PORT:
    case ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG: 
     ...
     *  Explicit flow.
     */
  case ARAD_PP_FRWRD_DECISION_TYPE_UC_FLOW:
     ...
     */
  case ARAD_PP_FRWRD_DECISION_TYPE_MC:
     ...
     *  FEC Destination.
     */
  case ARAD_PP_FRWRD_DECISION_TYPE_FEC:
   ...
   /*
     ...
     *  The id must be null.
     */
  case ARAD_PP_FRWRD_DECISION_TYPE_TRAP:
     ...
     *  The id must be null.
     */
  case ARAD_PP_FRWRD_DECISION_TYPE_DROP:
...
/* map application to encoding */
STATIC uint32
  arad_pp_fwd_decision_encode_type_get(
    SOC_SAND_IN  ARAD_PP_FRWRD_DECISION_APPLICATION_TYPE appl_type,
    SOC_SAND_OUT  ARAD_PP_DEST_ENCODE_TYPE     *encode_type
  )
{
  ...
  *encode_type = ARAD_PP_DEST_ENCODE_TYPE_19_BITS;

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fwd_decision_encode_type_get()", 0, 0);
}


/* given buffer return decision type */
STATIC uint32
  arad_pp_fwd_decision_eei_type_find(
      SOC_SAND_IN  int                        unit,
      SOC_SAND_IN  ARAD_PP_DEST_ENCODE_TYPE     encode_type,
      SOC_SAND_IN  uint32                     eei_buffer,
      SOC_SAND_OUT ARAD_PP_EEI_TYPE             *eei_type
  )
{
  uint32
    buffer_size,
  ...
  if(eei_buffer == 0)
  {
    *eei_type = ARAD_PP_EEI_TYPE_EMPTY;
    goto exit;
  }

  buffer_size = ARAD_PP_EEI_NOF_BITS;

  /* get 4 msbs: eei identifier */
  ...
  if(buffer_4_msb <= ARAD_PP_EEI_IDENTIFIER_SWAP_VAL)
  {
    *eei_type = ARAD_PP_EEI_TYPE_MPLS;
  }
  else if(buffer_4_msb == ARAD_PP_EEI_IDENTIFIER_TRILL_VAL)
  {
    *eei_type = ARAD_PP_EEI_TYPE_TRILL;
  }
  else if(buffer_4_msb == ARAD_PP_EEI_IDENTIFIER_ENCAP_VAL)
  {
    *eei_type = ARAD_PP_EEI_TYPE_OUTLIF;
  }
  else
  {
      /* for jericho, eei identifier can be 2 MSBs:
       * EEI encoding = {EEI identifier[23:22], OutLif MSB[21:20], HI[19:16], out_lif[15:0]} 
       * In case of ROO: eei identifier is 11 MactFormat3EeiBits[2:1]. 
       */
      if (SOC_IS_JERICHO(unit)) 
      {
          uint32 buffer_2_msb = 0; 
          /* try to get 2 msbs as eei identifier. */
          res = soc_sand_bitstream_get_any_field(
                  &(eei_buffer),
                  buffer_size - 2,
                  2,
          ...
          if (buffer_2_msb == ARAD_PP_EEI_IDENTIFIER_ENCAP_VAL_2_MSBS) 
          {
              *eei_type = ARAD_PP_EEI_TYPE_OUTLIF;
          }
          else 
...
/* given buffer return decision type */
/* is_learn = 1 if the parsing is of learn event */
STATIC uint32
  arad_pp_fwd_decision_dest_type_find(
      ...
      SOC_SAND_OUT ARAD_PP_FRWRD_DECISION_TYPE  *decision_type
  )
{
  uint32
    buffer_size,
  ...
  case  ARAD_PP_DEST_ENCODED_PREFIX_TYPE_1111:
    decision_type_lcl = ARAD_PP_FRWRD_DECISION_TYPE_UC_FLOW;
  break;

  case  ARAD_PP_DEST_ENCODED_PREFIX_TYPE_1010:
  case  ARAD_PP_DEST_ENCODED_PREFIX_TYPE_1011:
    decision_type_lcl = ARAD_PP_FRWRD_DECISION_TYPE_MC;
  break;
  ...
  case  ARAD_PP_DEST_ENCODED_PREFIX_TYPE_1001:
      if (SOC_IS_JERICHO(unit) && (is_learn==0)) {
          ...
          decision_type_lcl = ARAD_PP_FRWRD_DECISION_TYPE_UC_PORT; 
      }
    /* ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG, will be set according to sys-port parsing */
  break;

  case  ARAD_PP_DEST_ENCODED_PREFIX_TYPE_0100:
    decision_type_lcl = ARAD_PP_FRWRD_DECISION_TYPE_FEC;
    break;
  ...
  case  ARAD_PP_DEST_ENCODED_PREFIX_TYPE_0000:
      decision_type_lcl = ARAD_PP_FRWRD_DECISION_TYPE_TRAP;
  break;
  default:
  ...
  )
{
   ...
   */
  ARAD_PP_FRWRD_DECISION_INFO_verify(fwd_decision);

  res = arad_pp_fwd_decision_encode_type_get(
          appl_type,
          &encode_type
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 5, exit);

  res = ARAD_PP_FRWRD_DECISION_INFO_with_encode_type_verify(
          unit,
          appl_type,
          fwd_decision
        );
  ...
  case ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG:
      ...
      res = arad_ports_logical_sys_id_build(
                unit,
                fwd_decision->type == ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG /* is lag*/,
                fwd_decision->dest_id, /* lag group */
                0,   /* lag member*/
                fwd_decision->dest_id, /* port- id*/
                &sys_port_id
             );
  ...
  /* now set additional info, Outlif */
  switch(fwd_decision->additional_info.outlif.type)
  {
    case ARAD_PP_OUTLIF_ENCODE_TYPE_RAW:
    case ARAD_PP_OUTLIF_ENCODE_TYPE_RAW_INVALID:
    case SOC_PPC_OUTLIF_ENCODE_TYPE_EEP:
      asd_buffer_lcl = fwd_decision->additional_info.outlif.val;
      break;
    case ARAD_PP_OUTLIF_ENCODE_TYPE_NONE:
      break;
    default:
      /* verify outlif is raw or none */
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_DEST_OUTLIF_TYPE_OUT_OF_RANGE_ERR, 30, exit);
  }

  /* test both outlif and eei are not defined */
  if (fwd_decision->additional_info.outlif.type != ARAD_PP_OUTLIF_ENCODE_TYPE_NONE 
  ...
  /* now set additional info, EEI */
  if (fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_RAW)
  {
      /* value already formated, just use it.*/
      asd_buffer_lcl = fwd_decision->additional_info.eei.val.raw;
  }
  else if (fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_TRILL)
  {
    eei_type = ARAD_PP_EEI_IDENTIFIER_TRILL_VAL;
  ...
  else if(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_MPLS) /* MPLS */
  {
    if(fwd_decision->additional_info.eei.val.mpls_command.command == ARAD_PP_MPLS_COMMAND_TYPE_PUSH)
    {
      /*push: push-profile + label*/

      /* EEI type equal to push profile */
    ...
    else if(fwd_decision->additional_info.eei.val.mpls_command.command == ARAD_PP_MPLS_COMMAND_TYPE_SWAP)
    {
      /* swap: label */
      eei_type = ARAD_PP_EEI_IDENTIFIER_SWAP_VAL;
      /* set label */
      res = soc_sand_bitstream_set_any_field(
              &(fwd_decision->additional_info.eei.val.mpls_command.label),
              0,
    ...
    else if(fwd_decision->additional_info.eei.val.mpls_command.command == ARAD_PP_MPLS_COMMAND_TYPE_POP)
    {
      eei_type = ARAD_PP_EEI_IDENTIFIER_POP_VAL;  /*push: push-profile + label*/
      ...
      res = soc_sand_bitstream_set_any_field(
              &(temp),
              temp_lsb,
              ARAD_PP_EEI_POP_UPPER_LAYER_NOF_BITS,
              &(asd_buffer_lcl)
            );
      SOC_SAND_CHECK_FUNC_RESULT(res, 72, exit);
      temp_lsb += ARAD_PP_EEI_POP_UPPER_LAYER_NOF_BITS;
      ...
      res = soc_sand_bitstream_set_any_field(
              &(temp),
              temp_lsb,
              ARAD_PP_EEI_POP_CW_NOF_BITS,
              &(asd_buffer_lcl)
            );
      SOC_SAND_CHECK_FUNC_RESULT(res, 72, exit);
      temp_lsb += ARAD_PP_EEI_POP_CW_NOF_BITS;
      ...
      res = soc_sand_bitstream_set_any_field(
              &(temp),
              temp_lsb,
              ARAD_PP_EEI_POP_MODEL_NOF_BITS,
              &(asd_buffer_lcl)
            );
      SOC_SAND_CHECK_FUNC_RESULT(res, 72, exit);
      temp_lsb += ARAD_PP_EEI_POP_MODEL_NOF_BITS;
      ...
      res = soc_sand_bitstream_set_any_field(
              &(temp),
              temp_lsb,
              ARAD_PP_EEI_POP_TPID_PROFILE_NOF_BITS,
              &(asd_buffer_lcl)
            );
      SOC_SAND_CHECK_FUNC_RESULT(res, 72, exit);
      temp_lsb += ARAD_PP_EEI_POP_MODEL_NOF_BITS;
  ...
  else if(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_OUTLIF) /* outlif */
  {
    /*outlif:outlif (encap ptr)*/
    eei_type = SOC_IS_JERICHO(unit)?ARAD_PP_EEI_IDENTIFIER_ENCAP_VAL_2_MSBS:ARAD_PP_EEI_IDENTIFIER_ENCAP_VAL;

    /* set outlif - MSB and LSB */
    res = soc_sand_bitstream_set_any_field(
            &(fwd_decision->additional_info.eei.val.outlif),
            0,
            ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_LSB,
            &(asd_buffer_lcl)
          );    
    SOC_SAND_CHECK_FUNC_RESULT(res, 73, exit);

    if (SOC_IS_JERICHO(unit)) {
        temp = fwd_decision->additional_info.eei.val.outlif >> ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_LSB;
        res = soc_sand_bitstream_set_any_field(
                &(temp),
                ARAD_PP_EEI_BIT_POSITION_OUTLIF_MSB,
                ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_MSB,
                &(asd_buffer_lcl)
              );    
        SOC_SAND_CHECK_FUNC_RESULT(res, 73, exit);
    }
  }
  else if(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_MIM) /* outlif */
  {
    asd_buffer_lcl =fwd_decision->additional_info.eei.val.isid;
  }

  if(fwd_decision->additional_info.eei.type != ARAD_PP_EEI_TYPE_EMPTY && fwd_decision->additional_info.eei.type != ARAD_PP_EEI_TYPE_MIM
     && fwd_decision->additional_info.eei.type != ARAD_PP_NOF_EEI_TYPES && fwd_decision->additional_info.eei.type != ARAD_PP_EEI_TYPE_RAW)
  {
    uint32 start_bit, length;

    start_bit = (SOC_IS_JERICHO(unit)&&(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_OUTLIF))?
        ARAD_PP_ASD_BIT_POSITION_IDENTIFIER_OUTLIF:ARAD_PP_ASD_BIT_POSITION_IDENTIFIER;
    length = (SOC_IS_JERICHO(unit)&&(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_OUTLIF))?
  ...
  )
{
  ...
  /* 
   * For TM set high bit, to do it in regular parsing in Arad 
   * in Jericho, same encoding for Flow, Multicast, and System-Port 
   * (except Ingress Multicast) 
   */
  if(appl_type == ARAD_PP_FRWRD_DECISION_APPLICATION_TYPE_TM) {
  ...
  if(flags & (ARAD_PP_FWD_DECISION_PARSE_LEGACY | ARAD_PP_FWD_DECISION_PARSE_DEST)) {
      ...
      case ARAD_PP_FRWRD_DECISION_TYPE_DROP:
        ...
        SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);
        break;
      case ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG:/* port and lag same case */
      case ARAD_PP_FRWRD_DECISION_TYPE_UC_PORT:
         res = soc_sand_bitstream_get_any_field(
                  &(dest_buffer_lcl),
                  0,
                  param_id_length,
                  &(fwd_decision->dest_id) /* sys-port id, need more parsing*/
                );
        SOC_SAND_CHECK_FUNC_RESULT(res, 42, exit);
  ...
  if(flags & ARAD_PP_FWD_DECISION_PARSE_LEGACY) {
      /* get additional info */
      /* determine of additional info is outlif or EEI*/
      res = arad_pp_fwd_decision_additional_info_type_get(appl_type,decision_type, &is_eei, &is_outlif);
      SOC_SAND_CHECK_FUNC_RESULT(res, 65, exit);
  }

  if(is_outlif == 1 || flags & ARAD_PP_FWD_DECISION_PARSE_OULTIF)
  {
  ...
  else if (flags & ARAD_PP_FWD_DECISION_PARSE_OULTIF_INVALID) {
      fwd_decision->additional_info.outlif.val = asd_buffer;
      fwd_decision->additional_info.outlif.type = ARAD_PP_OUTLIF_ENCODE_TYPE_RAW_INVALID;
  }
  else {
      fwd_decision->additional_info.outlif.type = ARAD_PP_OUTLIF_ENCODE_TYPE_NONE;
  }
  ...
  if(is_eei == 1 || flags & ARAD_PP_FWD_DECISION_PARSE_EEI)
  {
    ...
    else if(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_MPLS) /* MPLS */
    {
      ...
      res = soc_sand_bitstream_get_any_field(
              &(asd_buffer_lcl),
              buffer_size - ARAD_PP_EEI_PUSH_CMD_NOF_BITS,
              ARAD_PP_EEI_PUSH_CMD_NOF_BITS,
              &(mpls_cmd_type)
            );
      SOC_SAND_CHECK_FUNC_RESULT(res, 100, exit);

      /* push */
      if(mpls_cmd_type < ARAD_PP_EEI_IDENTIFIER_POP_VAL)
      {
        /*push: push-profile + label*/
        fwd_decision->additional_info.eei.val.mpls_command.command = ARAD_PP_MPLS_COMMAND_TYPE_PUSH;
      ...
      else if(mpls_cmd_type == ARAD_PP_EEI_IDENTIFIER_SWAP_VAL)
      {
        /* swap: label */
        fwd_decision->additional_info.eei.val.mpls_command.command = ARAD_PP_MPLS_COMMAND_TYPE_SWAP;
        /* get label */
        res = soc_sand_bitstream_get_any_field(
                &(asd_buffer_lcl),
                0,
      ...
      /* pop */
      else if(mpls_cmd_type == ARAD_PP_EEI_IDENTIFIER_POP_VAL)
      {
        fwd_decision->additional_info.eei.val.mpls_command.command = ARAD_PP_MPLS_COMMAND_TYPE_POP;
    ...
    else if(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_OUTLIF) /* outlif */
    {
      ...
      SOC_SAND_CHECK_FUNC_RESULT(res, 170, exit);
      fwd_decision->additional_info.eei.val.outlif |= temp << ARAD_PP_EEI_ENCAP_PTR_NOF_BITS_LSB;

    }
    else if(fwd_decision->additional_info.eei.type == ARAD_PP_EEI_TYPE_MIM) 
    {
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(ARAD_PP_PKT_HDR_TYPE_TO_INTERANL_VAL_MAP);

  SOC_SAND_CHECK_NULL_INPUT(internal_val);
  switch(pkt_hdr_type)
  {
  case ARAD_PP_PKT_HDR_STK_TYPE_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_ETH_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV4_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV6_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_MPLS1_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS1_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_MPLS2_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS2_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_MPLS3_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS3_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_ETH_TRILL_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_TRILL_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_ETH_MPLS1_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_MPLS1_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_ETH_MPLS2_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_MPLS2_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_ETH_MPLS3_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_MPLS3_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV4_IPV4_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_IPV4_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV4_MPLS1_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS1_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV4_MPLS2_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS2_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV4_MPLS3_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS3_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV6_IPV4_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_IPV4_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH;
  break;
  case ARAD_PP_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH:
    *internal_val = ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH;
  break;
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_PKT_HDR_TYPE_NOT_SUPPORTED_ERR, 100, exit);
}exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_pkt_hdr_type_to_interanl_val_map()", 0, 0);
}
  ...
  )
{
  ...
  switch(internal_val)
  {
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV4_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_IPV4_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH_IPV4_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV6_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_FC_ENCAP_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_FC_ENCAP_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS1_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_MPLS1_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS2_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_MPLS2_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS3_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_MPLS3_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_FC_STD_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_FC_STD_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_TRILL_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH_TRILL_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_MPLS1_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH_MPLS1_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_MPLS2_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH_MPLS2_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_ETH_MPLS3_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_ETH_MPLS3_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_IPV4_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV4_IPV4_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS1_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV4_MPLS1_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS2_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV4_MPLS2_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS3_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV4_MPLS3_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_IPV4_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV6_IPV4_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH;
  break;
  case ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH:
    *pkt_hdr_type = ARAD_PP_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH;
  break;
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_PKT_HDR_TYPE_NOT_SUPPORTED_ERR, 100, exit);
  }
  ...
  *found = TRUE;
  ...
  switch(internal_val)
  {
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_MAC_IN_MAC:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_MAC_IN_MAC;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_TRILL:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_TRILL;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_IPV4:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_IPV4;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_IPV6:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_IPV6;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_ARP:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_ARP;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_CFM:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_CFM;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_MPLS:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_MPLS;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_FC:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_FC_ETH;
    break;
    case ARAD_PP_INTERNAL_L2_NEXT_PRTCL_TYPE_OTHER:
      *l2_next_prtcl_type = ARAD_PP_L2_NEXT_PRTCL_TYPE_OTHER;
    break;
    default:
      *found = FALSE;
    break;;
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_NEXT_PRTCL_TYPE_FIND);
  ...
  )
{
  ...
  ARAD_PP_IHP_PARSER_ETH_PROTOCOLS_TBL_DATA
    tbl_data;
  ARAD_PP_L2_NEXT_PRTCL_TYPE
    l2_next_prtcl_type_enum;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_NEXT_PRTCL_TYPE_FROM_INTERNAL_FIND);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_NEXT_PRTCL_TYPE_ALLOCATE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_L2_NEXT_PRTCL_TYPE_DEALLOCATE);
...
{ 
  ...
  { 
    /* If allocate successfully, just deallocate */
...
#define ARAD_PP_L3_PRTCL_TO_NDX_CASE(prtcl_suffix) \
  case (ARAD_PP_L3_NEXT_PRTCL_TYPE_##prtcl_suffix): \
...
#define ARAD_PP_L3_NDX_TO_PRTCL_CASE(prtcl_suffix) \
  ...
  *prtcl_type = ARAD_PP_L3_NEXT_PRTCL_TYPE_##prtcl_suffix; \
  break;
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_ACTION_PROFILE, &(info->action_profile), 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_TRAP_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_NOF_OUTLIF_ENCODE_TYPES, ARAD_PP_GENERAL_TYPE_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->val, ARAD_PP_GENERAL_VAL_MAX, ARAD_PP_GENERAL_VAL_OUT_OF_RANGE_ERR, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_OUTLIF_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MPLS_COMMAND_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_NOF_EEI_TYPES, ARAD_PP_GENERAL_EEI_TYPE_OUT_OF_RANGE_ERR, 10, exit);

  if (info->type == ARAD_PP_EEI_TYPE_TRILL)
  {
    ARAD_PP_STRUCT_VERIFY(SOC_SAND_PP_TRILL_DEST, &(info->val.trill_dest), 20, exit);
  }
  else if (info->type == ARAD_PP_EEI_TYPE_MPLS)
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_MPLS_COMMAND, &(info->val.mpls_command), 21, exit);
  }

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EEI_verify()",0,0);
}
  ...
  )
{
  ...
  case ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG:
  case ARAD_PP_FRWRD_DECISION_TYPE_UC_PORT:
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_OUTLIF, &(info->outlif), 11, exit);
    break;

  case ARAD_PP_FRWRD_DECISION_TYPE_MC:
  case ARAD_PP_FRWRD_DECISION_TYPE_FEC:
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_EEI, &(info->eei), 10, exit);
    break;

  case ARAD_PP_FRWRD_DECISION_TYPE_TRAP:
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_TRAP_INFO, &(info->trap_info), 12, exit);
    break;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_DECISION_TYPE_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->type, ARAD_PP_FRWRD_DECISION_INFO_TYPE_MAX, ARAD_PP_GENERAL_FRWRD_TYPE_OUT_OF_RANGE_ERR, 10, exit);

  res = ARAD_PP_FRWRD_DECISION_TYPE_INFO_verify(
          info->type,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_DECISION_INFO_verify()",0,0);
}
  ...
  )
{
  uint32
    res = SOC_SAND_OK;
  ARAD_PP_DEST_ENCODE_TYPE    encode_type;
  ...
  case ARAD_PP_FRWRD_DECISION_TYPE_FEC:
    ...
    case ARAD_PP_DEST_ENCODE_TYPE_19_BITS:
      ...
      break;
    default:
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_DEST_ENCODE_TYPE_OUT_OF_RANGE_ERR, 50, exit);
    }
  ...
  case ARAD_PP_FRWRD_DECISION_TYPE_UC_LAG:
    ...
    default:
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_FRWRD_DEST_ENCODE_TYPE_OUT_OF_RANGE_ERR, 90, exit);
    }
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->additional_info.trap_info.action_profile.trap_code, ARAD_PP_NOF_TRAP_CODES-1, ARAD_PP_FRWRD_DEST_TRAP_CODE_OUT_OF_RANGE_ERR, 120, exit);
   ...
   */
    ...
    case ARAD_PP_OUTLIF_ENCODE_TYPE_NONE:
      ...
      break;
    case ARAD_PP_OUTLIF_ENCODE_TYPE_EEP:
      SOC_SAND_ERR_IF_ABOVE_MAX(info->additional_info.outlif.val, SOC_DPP_DEFS_GET(unit, nof_out_lifs)-1, ARAD_PP_FRWRD_DEST_OUTLIF_VAL_OUT_OF_RANGE_ERR, 46, exit);
      break;

    case ARAD_PP_OUTLIF_ENCODE_TYPE_RAW:
    case ARAD_PP_OUTLIF_ENCODE_TYPE_RAW_INVALID:
      SOC_SAND_ERR_IF_ABOVE_MAX(info->additional_info.outlif.val, SOC_DPP_DEFS_GET(unit, nof_global_lifs)-1, ARAD_PP_FRWRD_DEST_OUTLIF_VAL_OUT_OF_RANGE_ERR, 46, exit);
      break;
 ...
 */
  ...
  {
  case ARAD_PP_EEI_TYPE_EMPTY:
    break;

  case ARAD_PP_EEI_TYPE_TRILL:
  ...
  case ARAD_PP_EEI_TYPE_MPLS:
      switch(info->additional_info.eei.val.mpls_command.command)
      {
        case ARAD_PP_MPLS_COMMAND_TYPE_PUSH:
        case ARAD_PP_MPLS_COMMAND_TYPE_POP:
        case ARAD_PP_MPLS_COMMAND_TYPE_SWAP:
          break;
        default:
    ...
    SOC_SAND_ERR_IF_ABOVE_MAX(info->additional_info.eei.val.mpls_command.tpid_profile, (1<<ARAD_PP_EEI_POP_TPID_PROFILE_NOF_BITS)-1, ARAD_PP_FRWRD_DEST_MPLS_TPID_PROFILE_OUT_OF_RANGE_ERR, 79, exit);
    if(info->additional_info.eei.val.mpls_command.command == ARAD_PP_MPLS_COMMAND_TYPE_POP) {
      SOC_SAND_ERR_IF_ABOVE_MAX(info->additional_info.eei.val.mpls_command.pop_next_header, ARAD_PP_NOF_PKT_FRWRD_TYPES-1, ARAD_PP_FRWRD_DEST_MPLS_POP_NEXT_HEADER_OUT_OF_RANGE_ERR, 80, exit);
    }
    
  break;

  case ARAD_PP_EEI_TYPE_OUTLIF:
  ...
  case ARAD_PP_EEI_TYPE_MIM:
        ...
        break;
  case ARAD_PP_EEI_TYPE_RAW: /* check not out of EEI size */
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_FRWRD_DECISION_INFO_with_encode_type_verify()",0,0);
}
uint32
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->trap_code, ARAD_PP_NOF_TRAP_CODES-1, ARAD_PP_ACTION_TRAP_CODE_LSB_OUT_OF_RANGE_ERR, 30, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_ACTION_PROFILE_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_TPID_PROFILE_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->port, ARAD_PP_PORT_MAX, ARAD_PP_PORT_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->vsi, ARAD_PP_VSI_ID_MAX, ARAD_PP_VSI_ID_OUT_OF_RANGE_ERR, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_PEP_KEY_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_OUT_OF_RANGE(info->type, ARAD_PP_IP_ROUTING_TABLE_ITER_TYPE_IP_PREFIX_ORDERED, ARAD_PP_IP_ROUTING_TABLE_ITER_TYPE_PREFIX_IP_ORDERED, ARAD_PP_IP_ITER_TYPE_OUT_OF_RANGE_ERR, 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_IP_ROUTING_TABLE_ITER_verify()",0,0);
}
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_IP_ROUTING_TABLE_ITER, &(info->start), 10, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_IP_ROUTING_TABLE_RANGE_verify()",0,0);
}
...
/* nof bits for ip tunnel lif.learn info */
...
/* nof bits for ac mp lif.learn info */
...
uint32
    arad_pp_fwd_decision_to_learn_buffer(
        ...
        SOC_SAND_IN  ARAD_PP_LIF_ENTRY_TYPE         lif_entry_type,
    ...
    *additional_info = 0;
    ...
    if (dest_id == 0) {
        *learn_buffer = 0; 
        ...
        /* if fec learn data, then lif.learn info MSB is set */
        if (fwd_decision_type == ARAD_PP_FRWRD_DECISION_TYPE_FEC) {
            /* set MSB, depends on type of LIF: */

            /* set ip tunnel lif MSB */
            if (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_IP_TUNNEL_RIF) {  
                *learn_buffer = (1<<ARAD_PP_IP_TUNNEL_LIF_LEARN_BUFFER_MSB(unit)) | dest_id; 
            }
            /* set ac mp lif MSB */
            else if ((lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_AC) || (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_EXTENDER)) { 
        ...
        /* if flow uc learn data, then MSB is not set */
        else if (fwd_decision_type == ARAD_PP_FRWRD_DECISION_TYPE_UC_FLOW) {
            /* static lsbs are truncated, depends on type LIF */
            if (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_IP_TUNNEL_RIF) {  
                *learn_buffer = (dest_id >> SOC_DPP_DEFS_GET(unit, ip_tunnel_lif_uc_flow_learn_data_static_lsbs)); 
            }
            else if (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_AC) { 
...
/* mask for ac mp lif learn data: nof bit in ac mp lif learn data - MSB.
   REMINDER: MSB indicate type of learning: FEC or UC FLOW */
#define ARAD_PP_AC_MP_LIF_LEARN_BUFFER_MASK(unit)  ((1 << (SOC_DPP_DEFS_GET(unit, ac_mp_lif_learn_data_nof_bits) -1)) -1)
/* A value for ARAD device */
#define ARAD_PP_AC_MP_LIF_LEARN_BUFFER_MASK_ARAD  ((1 << (SOC_DPP_AC_MP_LIF_LEARN_DATA_NOF_BITS_ARAD -1)) -1)
/* mask for ip tunnel lif learn data: nof bits in ip tunnel lif learn data - MSB */
        ...
        )
{
    ...
    /* set dest id */
        ...
        /* for ac mp lif */
        if ((lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_AC) || (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_EXTENDER)) {
            /* MSB is set, FEC learn data for ac mp lif */
            ...
            /* MSB is not set, UC flow learn data for ac mp lif */
            else {
        ...
        /* for ip tunnel lif */
        else if (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_IP_TUNNEL_RIF) {
            /* MSB is set, FEC learn data for ip tunnel lif */
            ...
            /* MSB is not set, UC flow learn data for ip tunnel lif */
            else {
...
uint32
    arad_pp_fwd_decision_from_learn_buffer_arad_format(
        SOC_SAND_IN  int                       unit,
        SOC_SAND_IN  uint32                       learn_buffer,
        SOC_SAND_IN  ARAD_PP_LIF_ENTRY_TYPE         lif_entry_type,
        SOC_SAND_OUT ARAD_PP_FRWRD_DECISION_INFO *fwd_decision
        )
{
    ...
    /* set dest id */
        ...
        if ((lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_AC) || (lif_entry_type == ARAD_PP_LIF_ENTRY_TYPE_EXTENDER)) {
            /* MSB is set, FEC learn data for ac mp lif */
            if (learn_buffer >> SOC_DPP_FEC_NOF_BITS_ARAD == 4) {
                fwd_decision->dest_id = (learn_buffer & ARAD_PP_AC_MP_LIF_LEARN_BUFFER_MASK_ARAD);
                fwd_decision->type = ARAD_PP_FRWRD_DECISION_TYPE_FEC;
            }
            /* MSB is not set, UC flow learn data for ac mp lif */
            else {
                fwd_decision->dest_id = ((learn_buffer & ARAD_PP_AC_MP_LIF_LEARN_BUFFER_MASK_ARAD) << SOC_DPP_AC_MP_LIF_UC_FLOW_LEARN_DATA_STATIC_LSBS_ARAD);
                fwd_decision->type = ARAD_PP_FRWRD_DECISION_TYPE_UC_FLOW;
            }
        }
        /* for ip tunnel lif */
            ...
            /* MSB is set, FEC learn data for ip tunnel lif */
            if (learn_buffer >> ARAD_PP_IP_TUNNEL_LIF_LEARN_BUFFER_MSB_ARAD == 1) {
                fwd_decision->dest_id = (learn_buffer & ARAD_PP_IP_TUNNEL_LIF_LEARN_BUFFER_MASK_ARAD);
                fwd_decision->type = ARAD_PP_FRWRD_DECISION_TYPE_FEC;
            } 
            /* MSB is not set, UC flow learn data for ip tunnel lif */
            else {
                fwd_decision->dest_id = ((learn_buffer & ARAD_PP_IP_TUNNEL_LIF_LEARN_BUFFER_MASK_ARAD) << SOC_DPP_IP_TUNNEL_LIF_UC_FLOW_LEARN_DATA_STATIC_LSBS_ARAD);
                fwd_decision->type = ARAD_PP_FRWRD_DECISION_TYPE_UC_FLOW;
            }
        }
    }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fwd_decision_from_learn_buffer_arad_only()",0,0);
}
...
arad_pp_init_orientation_maps(int unit){ 
    int res;
    uint32
        sh_mask = 0, /* split horizon mask in profile; orientation bit is 1, other profile bits are 0 */
    ...
    /* 
     * IHB_IN_LIF_ORIENTATION_MAP
     * We treat this 64b register as a 2-bit wide table of 32 entries.
     * each entry maps {inlif.profile(4b) || inlif.is_hub(1b)} to a 2b orientation.
     */
    
    /* get the split horizon relevant bits of the profile */
    ...
    for(entry = 0; entry < 32; entry++){
        /*
         * entry is a 5 bit number. 4 bits are "profile bits" and the remaining bit is "is_hub". 
         * from the 4 profile bits, we are only interested if the dedicated orientation bit of the profile is on or off. 
         * the mapping is taking "profile orientation bit" and "is_hub" bit and returns a 2-bit orientation.
         */
        uint32 profile_bit = ((entry >> 1) & sh_mask) ? 1 : 0; /* is the orientation bit of the profile on or off */
        uint32 is_hub = entry & 1;
        /* for each entry, we maintain "1-1 mapping": orientation = (profile_bit | is_hub) */
        uint64 on_mask;
        if (entry < 16) {
    ...
    /* 
     * EPNI_CFG_MAP_OUTLIF_PROFILE_TO_ORIENTATION
     * We treat this 128b register as a 2-bit wide table of 64 entries.
     * each entry maps {outlif.profile(6b/3b)} to a 2b orientation.
     */
    ...
    /* split the (possibly) 2b mask into two 1b masks */
    ...
    for(entry = 0; entry < 64; entry++){
        /* we only care if the dedicated orientation bits of the profile are on or off */
        uint32
            profile_bit_lo = (entry & sh_mask_lo) ? 1 : 0, 
            profile_bit_hi = (entry & sh_mask_hi) ? 1 : 0;
                
        /* maintain 1-1 mapping: orientation = profile_bit(s) */
...
int arad_pp_fwd_decision_learn_buffer_bist(int unit) {
    ...
    ARAD_PP_FRWRD_DECISION_TYPE fwd_decision_types[2] = 
        {ARAD_PP_FRWRD_DECISION_TYPE_UC_FLOW, ARAD_PP_FRWRD_DECISION_TYPE_FEC};
    ARAD_PP_LIF_ENTRY_TYPE      lif_entry_types[2] = 
        {ARAD_PP_LIF_ENTRY_TYPE_AC, ARAD_PP_LIF_ENTRY_TYPE_IP_TUNNEL_RIF};
    ...
    ARAD_PP_FRWRD_DECISION_INFO fwd_decision; 
    ...
    for (iteration = 0; iteration < 1000; iteration++) {
        /* set fwd decision from random learn buffer
         * get learn buffer from fwd decision 
           compare original learn buffer with returned learn buffer */
        for (lif_entry_types_index = 0; lif_entry_types_index < 2; lif_entry_types_index++) {
            for (fwd_decision_types_index = 0; fwd_decision_types_index < 2; fwd_decision_types_index++) {
                ...
                /* set the learn buffer */
                learn_buffer = 0; 
                if (lif_entry_types[lif_entry_types_index] == ARAD_PP_LIF_ENTRY_TYPE_AC) {
                    /* set learn buffer according to learn buffer size, don't set the MSB */
                    learn_buffer = soc_sand_rand_int(&soc_sand_rand) & ARAD_PP_AC_MP_LIF_LEARN_BUFFER_MASK(unit); 
                    /* set the MSB */
                    if (fwd_decision_types[fwd_decision_types_index] == ARAD_PP_FRWRD_DECISION_TYPE_FEC) {
                        /* set 1 at the MSB */
                ...
                } else if (lif_entry_types[lif_entry_types_index] == ARAD_PP_LIF_ENTRY_TYPE_IP_TUNNEL_RIF) {
                ...
                /* compare lif.learn_info field. check "data part" and msb */
                if (lif_entry_types[lif_entry_types_index] == ARAD_PP_LIF_ENTRY_TYPE_AC) {
