  ...
  )
{
  ...
  for (indx = 0 ; indx < SOC_PETRA_ITM_SYS_RED_BUFFS_RNGS-1 ; ++indx)
  {
    ...
    SOC_PETRA_FLD_SET(regs->iqm.free_bdb_range_values_reg.fr_bdb_rng_val[indx], info->values.bds_rng_vals[indx], 7,exit);
  }

   /*
    * Configure Last (BDs) Value
    */
  SOC_PETRA_FLD_SET(regs->iqm.free_bdb_range_values_reg.fr_bdb_rng_val[indx], info->values.bds_rng_vals[indx], 8,exit);
  ...
  )
{
  ...
  {
    SOC_SAND_ERR_IF_ABOVE_MAX(
      info->values.bds_rng_vals[index], SOC_PETRA_ITM_SYS_RED_GLOB_RCS_VALS_RNG_VALS_MAX,
  ...
  )
{
  ...
  for (indx = 0 ; indx < SOC_PETRA_ITM_SYS_RED_BUFFS_RNGS-1 ; ++indx)
  {
    ...
    SOC_PETRA_FLD_GET(regs->iqm.free_bdb_range_values_reg.fr_bdb_rng_val[indx], info->values.bds_rng_vals[indx], 24, exit);
  }

   /*
    * READ Last (BDs) Value
    */
  SOC_PETRA_FLD_GET(regs->iqm.free_bdb_range_values_reg.fr_bdb_rng_val[indx], info->values.bds_rng_vals[indx], 26, exit);
