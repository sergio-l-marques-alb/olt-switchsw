  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_RECEIVED_PACKET_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_PARSING_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_TERMINATION_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_FRWRD_LPM_LKUP_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_FRWRD_LKUP_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_TRAPS_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_FRWRD_DECISION_TRACE_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_LEARNING_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_ING_VLAN_EDIT_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_PKT_ASSOCIATED_TM_INFO_GET, core_id);
  ...
  )
{
  ...
  if (cur_eep_type != ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_AC) {
    ...
    if (tmp) {
      ...
      ARAD_PP_DIAG_FLD_READ(&fld,core_id,ARAD_EPNI_ID,11,0,15,0,5);
      /* Out-AC */
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_DB_LIF_LKUP_INFO_GET, core_id);
  ...
  )
{
  ...
  SOC_CHECK_DIAG_LAST_PACKET_VALIDITY(ARAD_PP_DIAG_DB_LEM_LKUP_INFO_GET, core_id);
  ...
  ) 
{
  ...
  arad_pp_diag_encap_info_get_unsafe(unit, core_id, &encap_info);
