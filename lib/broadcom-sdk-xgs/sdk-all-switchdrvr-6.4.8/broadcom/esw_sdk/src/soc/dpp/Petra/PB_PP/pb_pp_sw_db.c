  ...
  )
{
  ...
  sal_memset(&multi_set_info,0,sizeof(multi_set_info)) ;
  multi_set_info.get_entry_fun = soc_pb_sw_db_buffer_get_entry;
  multi_set_info.set_entry_fun = soc_pb_sw_db_buffer_set_entry;
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_LLP_TRAP_NOF_UD_L3_PROTOCOLS;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  Soc_pb_pp_sw_db.device[unit]->llp_trap->l3_protocols_multi_set = multi_set ;
  /* llp_trap->l3_protocols_multi_set } */
  ...
  )
{
  ...
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_LLP_MIRROR_NOF_VID_MIRROR_INDICES;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  /* will not work (petra code changed, wont work but will compile) */
  res = soc_sand_multi_set_create(
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  Soc_pb_pp_sw_db.device[unit]->llp_mirror->mirror_profile_multi_set = multi_set ;
  /* llp_mirror->mirror_profile_multi_set } */
  ...
  )
{
  ...
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_EG_MIRROR_NOF_VID_MIRROR_INDICES;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  /* will not work (petra code changed, wont work but will compile) */
  res = soc_sand_multi_set_create(
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  Soc_pb_pp_sw_db.device[unit]->eg_mirror->mirror_profile_multi_set = multi_set ;
exit:
  ...
  )
{
  ...
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_LLP_TRAP_NOF_UD_ETHER_TYPE;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  /* will not work (petra code changed, wont work but will compile) */
  res = soc_sand_multi_set_create(
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit) ;
  Soc_pb_pp_sw_db.device[unit]->llp_cos->ether_type_multi_set = multi_set ;
  /* llp_cos->cos_profile_multi_set } */
  ...
  )
{
  ...
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_SW_DB_MULTI_SET_ETH_POLICER_PROFILE_METER_PROFILE_NOF_MEMBER;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  /* will not work (petra code changed, wont work but will compile) */
  res = soc_sand_multi_set_create(
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  Soc_pb_pp_sw_db.device[unit]->eth_policer_mtr_profile->eth_meter_profile_multi_set = multi_set ;
  ...
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_SW_DB_MULTI_SET_ETH_POLICER_GLOBAL_METER_PROFILE_NOF_MEMBER;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  /* will not work (petra code changed, wont work but will compile) */
  res = soc_sand_multi_set_create(
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
  Soc_pb_pp_sw_db.device[unit]->eth_policer_mtr_profile->global_meter_profile_multi_set = multi_set ;
exit:
  ...
  )
{
  ...
  multi_set_info.max_duplications = SOC_SAND_U32_MAX - 1;
  multi_set_info.member_size = sizeof(uint32);
  multi_set_info.nof_members = SOC_PB_PP_SW_DB_MULTI_SET_VLAN_COMPRESSION_RANGE_NOF_MEMBER;
  multi_set_info.sec_handle = 0;
  multi_set_info.prime_handle = unit;
  /* will not work (petra code changed, wont work but will compile) */
  res = soc_sand_multi_set_create(
  ...
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  Soc_pb_pp_sw_db.device[unit]->l2_lif->vlan_compression_range_multi_set = multi_set ;
exit:
  ...
  )
{
  ...
  for (key_ndx = 0; key_ndx <= SOC_PB_PMF_LOW_LEVEL_PMF_KEY_MAX; ++key_ndx)
  {
    ...
    {
      Soc_pb_pp_sw_db.device[unit]->fp->ce_instr[key_ndx][instr_ndx] = BCM_FIELD_ENTRY_INVALID;
    }
  }
