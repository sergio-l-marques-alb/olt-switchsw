...
CONST mbcm_dpp_functions_t mbcm_petrab_driver = {
    ...
    soc_pb_cnt_q2cnt_id, 
    soc_pb_cnt_cnt2q_id, 
    NULL, /* mbcm_dpp_cnt_lif_counting_set */
    NULL, /* mbcm_dpp_cnt_lif_counting_get */
    NULL, /* mbcm_dpp_cnt_lif_counting_range_set */
    NULL, /* mbcm_dpp_cnt_lif_counting_range_get */
    NULL, /* mbcm_dpp_cnt_base_val_set */
    NULL, /*epni_regs_set*/
    ...
    NULL, /* mbcm_dpp_stat_counter_length_get */
    ...
    NULL, /* soc_petra_itm_vsq_pg_tc_profile_mapping_set */
    NULL, /* soc_petra_itm_vsq_pg_tc_profile_mapping_get */
    NULL, /* soc_petra_itm_vsq_pg_tc_profile_set         */
    NULL, /* soc_petra_itm_vsq_pg_tc_profile_get         */
    NULL, /* soc_petra_itm_vsq_pg_prm_set                */
    NULL, /* soc_petra_itm_vsq_pg_prm_get                */
    NULL, /* soc_petra_itm_src_vsqs_mapping_set          */
    NULL, /* soc_petra_itm_src_vsqs_mapping_set          */
    NULL, /* soc_petra_itm_vsq_src_port_get              */
    NULL, /* soc_petra_itm_vsq_pg_mapping_get            */
    NULL, /* soc_petra_itm_vsq_pg_ocb_set                */
    NULL, /* soc_petra_itm_vsq_pg_ocb_get                */
    NULL, /* mbcm_itm_queue_is_ocb_only_get              */
    ...
    NULL, /* mbcm_dpp_itm_vsq_src_reserve_set,      */
    NULL, /* mbcm_dpp_itm_vsq_src_reserve_get,      */
    NULL, /* mbcm_dpp_itm_resource_allocation_set,  */
    NULL, /* mbcm_dpp_itm_resource_allocation_get,  */
    NULL, /* mbcm_dpp_itm_dyn_total_thresh_set */
    NULL, /* mbcm_dpp_itm_congestion_statistics_get */
    NULL, /* mbcm_dpp_ingress_drop_status */
    ...
    NULL, /*mbcm_dpp_ports_mirrored_channel_and_context_map*/
  ...
  NULL, /*mbcm_dpp_mgmt_change_all_faps_credit_worth_unsafe*/
    ...
    NULL, /* mbcm_dpp_port_link_up_mac_update */
    ...
    NULL, /*mbcm_dpp_egr_queuing_init_thresholds*/
    ...
    NULL,  /*mbcm_dpp_drv_allocate_rcy_port */
    ...
    NULL, /* mbcm_dppr_port_autoneg_set */
    NULL, /* mbcm_dppr_port_autoneg_get */
    NULL, /* mbcm_dppr_port_ability_local_get */
    NULL, /* mbcm_dpp_port_ability_remote_get */
    NULL, /* mbcm_dpp_port_ability_advert_set */
    NULL, /* mbcm_dpp_port_ability_advert_get */
    NULL, /* mbcm_dpp_port_mdix_set */
    NULL, /* mbcm_dpp_port_mdix_get */
    NULL, /* mbcm_dpp_port_mdix_status_get */
    NULL, /* mbcm_dppr_port_duplex_set */
    NULL, /* portmod_port_duplex_get */
    NULL, /* mbcm_dpp_port_nif_quad_to_core_validate */
    NULL, /* mbcm_dpp_port_close_path*/
    NULL, /* mbcm_dpp_port_nif_nof_lanes_get */
    ...
    NULL, /*mbcm_dpp_ports_logical_sys_id_parse*/
    NULL,  /* mbcm_dpp_fc_vsq_index_group2global */
    NULL, /*mbcm_dpp_stat_oversize_set*/
    NULL, /*mbcm_dpp_stat_oversize_get*/
    NULL,  /* mbcm_dpp_fc_status_info_get */
    NULL,  /*mbcm_dpp_stat_counter_filter_set*/
    NULL,  /*mbcm_dpp_stat_counter_filter_get*/	
    NULL, /* mbcm_dpp_fc_pfc_generic_bitmap_valid_update */
    NULL, /* mbcm_dpp_fc_pfc_generic_bitmap_used_update */
    NULL, /* mbcm_dpp_qsgmii_offsets_add */
    NULL, /* mbcm_dpp_qsgmii_offsets_add_pbmp */
    NULL, /* mbcm_dpp_qsgmii_offsets_remove */
	NULL  /* mbcm_dpp_qsgmii_offsets_remove_pbmp */
};
