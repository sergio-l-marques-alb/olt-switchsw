    ...
    )
{
    ...
    do {
        ...
        res = arad_pp_dbal_kbp_buffer_to_entry_key(unit, dbal_table, JER_KAPS_KEY_BUFFER_NOF_BYTES, kpb_e_info.data,qual_vals_array + (*nof_entries)*SOC_PPC_FP_NOF_QUALS_PER_DB_MAX);
                                         ...
                                         SOC_SAND_OUT SOC_DPP_DBAL_SW_TABLE_IDS *table_id)
{
    ...
    case JER_KAPS_IP_FWD_PUBLIC_IPV6_UC_TBL_ID:
        *table_id = SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_KAPS;
        break;
    ...
    case JER_KAPS_IP_FWD_PUBLIC_IPV6_MC_TBL_ID:
        *table_id = SOC_DPP_DBAL_SW_TABLE_ID_IPV6MC_KAPS;
        break;
