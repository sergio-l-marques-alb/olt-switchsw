...
/*
 *  Function : drv_lotus_port_pri_mapop_set
 *
 *  Purpose :
 ...
 */
int 
drv_lotus_port_pri_mapop_set(int unit, int port, int op_type, 
...
/*
 *  Function : drv_lotus_port_pri_mapop_get
 *
 *  Purpose :
 ...
 */
int 
drv_lotus_port_pri_mapop_get(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 *pri_new, uint32 *cfi_new)
{
    uint32  temp;
    uint64  reg_value64;
...
int 
drv_lotus_port_cross_connect_set(int unit,uint32 port,soc_pbmp_t bmp)
{
    int rv = SOC_E_NONE;
    uint32 reg_value = 0;
    uint32 temp = 0;
    ...
    LOG_INFO(BSL_LS_SOC_PORT,
             (BSL_META_U(unit,
                         "drv_lotus_port_cross_connect_set: unit=%d port = %d, bmp=%x\n"),
...
int 
drv_lotus_port_cross_connect_get(int unit,uint32 port,soc_pbmp_t *bmp)
{
    int rv = SOC_E_NONE;
    uint32 reg_value = 0;
    uint32 temp = 0;
    ...
    LOG_INFO(BSL_LS_SOC_PORT,
             (BSL_META_U(unit,
                         "drv_lotus_port_cross_connect_get: unit=%d port = %d\n"),
              unit, port));
