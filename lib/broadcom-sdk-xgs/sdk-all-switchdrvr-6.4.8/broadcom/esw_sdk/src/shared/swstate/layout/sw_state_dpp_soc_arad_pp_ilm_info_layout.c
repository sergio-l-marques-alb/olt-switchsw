...
int sw_state_dpp_soc_arad_pp_ilm_info_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   ARAD_PP_ILM_INFO* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(ARAD_PP_ILM_INFO),"ARAD_PP_ILM_INFO"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "ilm_info",             /* name */         
                                   sizeof(ARAD_PP_ILM_INFO),             /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   0,                 /* array size 0 */ 
                                   0));                  /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_pp_ilm_info_mask_inrif_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   ...
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->mask_inrif)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 

   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_pp_ilm_info_mask_port_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->mask_port)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
