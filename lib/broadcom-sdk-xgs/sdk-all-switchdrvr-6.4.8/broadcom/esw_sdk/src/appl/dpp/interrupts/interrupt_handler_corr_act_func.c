            ...
            SOC_PBMP_ITER(port_bm, port_i){
                ...
                if(interface == SOC_PORT_IF_ILKN) {
                    ...
                    if (((addrf >= 0x120c00) && (ilkn_num == offset)) || ((addrf < 0x120c00) && (num_of_lanes > ilkn_lane))) {
                        *p_corrective_action = ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC;
                        rc = SOC_E_NONE;
                        SOC_EXIT;       
                    }
                }
    ...
    char* msg)
{
    ...
    if (dpp_tbl_is_dynamic(unit, ecc_1b_correct_info_p->mem)) {
    ...
    void *param2)
{
    ...
    case ARAD_INT_CORR_ACT_IHP_EM_SOFT_RECOVERY:
    case ARAD_INT_CORR_ACT_IHB_EM_SOFT_RECOVERY:
    case ARAD_INT_CORR_ACT_EPNI_EM_SOFT_RECOVERY:
    case ARAD_INT_CORR_ACT_OAMP_EM_SOFT_RECOVERY:
    ...
    char *special_msg)
{
    ...
    switch(corr_act) {
        ...
        case ARAD_INT_CORR_ACT_IPS_QDESC:
            ...
            break;
        case ARAD_INT_CORR_ACT_IHP_EM_SOFT_RECOVERY:
            sal_sprintf(cur_corr_act_msg, "IHP EM soft recovery");
            break;
        case ARAD_INT_CORR_ACT_IHB_EM_SOFT_RECOVERY:
             sal_sprintf(cur_corr_act_msg, "IHB EM soft recovery");
             break;
        case ARAD_INT_CORR_ACT_EPNI_EM_SOFT_RECOVERY:
            sal_sprintf(cur_corr_act_msg, "EPNI EM soft recovery");
            break;
        case ARAD_INT_CORR_ACT_OAMP_EM_SOFT_RECOVERY:
            sal_sprintf(cur_corr_act_msg, "OAMP EM soft recovery");
            break; 		
        default:
