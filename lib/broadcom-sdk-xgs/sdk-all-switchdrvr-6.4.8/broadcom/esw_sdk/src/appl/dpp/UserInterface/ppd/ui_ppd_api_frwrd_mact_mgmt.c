  ...
  )
{
    uint32
    ret;
  SOC_PPD_FRWRD_MACT_LOOKUP_TYPE
  ...
  )
{
  uint32
    ret;
  SOC_PPD_FRWRD_MACT_OPER_MODE_INFO
    prm_oper_mode_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_MACT_OPER_MODE_INFO_clear(&prm_oper_mode_info);
  ...
  )
{
  ...
  SOC_PPD_FRWRD_MACT_OPER_MODE_INFO_print(&prm_oper_mode_info);
  ...
  )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_MACT_AGING_INFO_clear(&prm_aging_info);
  ...
  SOC_PPD_FRWRD_MACT_AGING_INFO_print(&prm_aging_info);
...
{   
  uint32 
    ret;   
  SOC_PPD_FRWRD_MACT_AGING_EVENTS_HANDLE   
    prm_aging_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_MACT_AGING_EVENTS_HANDLE_clear(&prm_aging_info);
...
{   
  ...
  SOC_PPD_FRWRD_MACT_AGING_EVENTS_HANDLE_print(&prm_aging_info);
  ...
  )
{
  uint32
    ret;
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_GLBL_INFO
    prm_limit_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_clear(&prm_limit_info);
  ...
  )
{
  ...
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_print(&prm_limit_info);
  ...
  )
{
  ...
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_INFO   
    prm_limit_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_INFO_clear(&prm_limit_info);
  ...
  )
{
  ...
  send_string_to_screen("--> limit_info:", TRUE);
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_INFO_print(&prm_limit_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_MACT_EVENT_BUFFER_clear(&prm_event_buf);
  SOC_PPD_FRWRD_MACT_EVENT_INFO_clear(&prm_mact_event);
  ...
  SOC_PPD_FRWRD_MACT_EVENT_BUFFER_print(&prm_event_buf);
  if (prm_event_buf.buff_len != 0) {
	  SOC_PPD_FRWRD_MACT_EVENT_INFO_print(&prm_mact_event);
  }
...
{   
  uint32 
    ret;   
  SOC_PPD_FRWRD_MACT_EVENT_HANDLE_KEY   
    prm_event_key;
  SOC_PPD_FRWRD_MACT_EVENT_HANDLE_INFO   
    prm_handle_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_MACT_EVENT_HANDLE_KEY_clear(&prm_event_key);
  SOC_PPD_FRWRD_MACT_EVENT_HANDLE_INFO_clear(&prm_handle_info);
...
{   
  ...
  SOC_PPD_FRWRD_MACT_EVENT_HANDLE_INFO_print(&prm_handle_info);
...
{   
  ...
  SOC_PPD_FRWRD_MACT_MSG_DISTR_INFO   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_MACT_MSG_DISTR_INFO_clear(&prm_distribution_info);
...
{   
  ...
  SOC_PPD_FRWRD_MACT_MSG_DISTR_INFO_print(&prm_distribution_info);
...
{   
  uint32 
    ret;   
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO   
    prm_exceed_info;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_clear(&prm_exceed_info);
  ...
  SOC_PPD_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_print(&prm_exceed_info);
  ...
  )
{
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_MACT_PORT_INFO_clear(&prm_port_info);
  ...
  )
{
  ...
  SOC_PPD_FRWRD_MACT_PORT_INFO_print(&prm_port_info);
  ...
  )
{
  uint32
    ret;
  SOC_PPD_FRWRD_MACT_IP_COMPATIBLE_MC_INFO
    prm_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_clear(&prm_info);
  ...
  SOC_PPD_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_print(&prm_info);
