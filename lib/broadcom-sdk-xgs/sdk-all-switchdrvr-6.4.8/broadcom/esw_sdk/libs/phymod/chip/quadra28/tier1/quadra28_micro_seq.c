...
*
5 *
5 * $Copyright: Copyright 2015 Broadcom Corporation.
...
int quadra28_bcast_disable(const phymod_core_access_t* core)
{
    BCMI_QUADRA28_PMD_CONTROLr_t pmd_ctrl;

    PHYMOD_MEMSET(&pmd_ctrl, 0, sizeof(BCMI_QUADRA28_PMD_CONTROLr_t));
    PHYMOD_IF_ERR_RETURN(
        BCMI_QUADRA28_READ_PMD_CONTROLr(&core->access, &pmd_ctrl));
    BCMI_QUADRA28_PMD_CONTROLr_RESETf_SET(pmd_ctrl, 1);
    PHYMOD_IF_ERR_RETURN(
        BCMI_QUADRA28_WRITE_PMD_CONTROLr(&core->access, pmd_ctrl));
