...
STATIC
int _qtce_os_mode_phymod_to_qtce(phymod_osr_mode_t phymod_os_mode, temod_os_mode_type *tsce_os_mode)
{
...
STATIC
int _qtce_os_mode_qtce_to_phymod(temod_os_mode_type tsce_os_mode, phymod_osr_mode_t *phymod_os_mode)
{
    switch(tsce_os_mode){
