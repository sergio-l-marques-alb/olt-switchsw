 ...
 *  Revision      :  $Id: falcon2_madura_internal.c 1112 2015-08-25 18:12:02Z jgaither $ *
 *                                                                                 *
...
#else
    /*
    DISP_LN_VARS( "Link Time (ms)",link_time/10.0,"%12d");
    */
#endif
...
SDK_STATIC err_code_t _falcon2_madura_get_osr_mode(const phymod_access_t *pa, falcon2_madura_osr_mode_st *imode) {
  ...
  ESTM(mode.tx_rx = rd_falcon2_madura_osr_mode());
...
/*SDK_STATIC */err_code_t _falcon2_madura_read_lane_state(const phymod_access_t *pa, falcon2_madura_lane_state_st *istate) {
  ...
  ESTM(state.reset_state = rd_falcon2_madura_lane_dp_reset_state());
