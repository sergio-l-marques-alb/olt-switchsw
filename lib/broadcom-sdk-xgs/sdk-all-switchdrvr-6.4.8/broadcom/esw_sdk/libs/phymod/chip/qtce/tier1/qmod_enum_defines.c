...
char* e2s_sc_mode_type [CNT_sc_mode_type] = {
  "QMOD_SC_MODE_HT_WITH_BASIC_OVERRIDE" ,
  "QMOD_SC_MODE_HT_OVERRIDE" ,
  "QMOD_SC_MODE_ST" ,
  "QMOD_SC_MODE_ST_OVERRIDE" ,
  "QMOD_SC_MODE_AN_CL37" ,
  "QMOD_SC_MODE_AN_CL73" ,
  "QMOD_SC_MODE_BYPASS" ,
  "QMOD_SC_MODE_ILLEGAL" 
}; /* e2s_sc_mode_type */
...
char* e2s_an_property_enable [CNT_an_property_enable] = {
  "QMOD_AN_PROPERTY_ENABLE_NONE" ,
  "QMOD_AN_PROPERTY_ENABLE_SGMII_MASTER_MODE" ,
  "QMOD_AN_PROPERTY_ENABLE_AN_PD_TO_CL37" ,
  "QMOD_AN_PROPERTY_ENABLE_SGMII_TO_CL37_AUTO" ,
  "QMOD_AN_PROPERTY_ENABLE_CL37_BAM_to_SGMII_AUTO" ,
  "QMOD_AN_PROPERTY_ENABLE_HPAM_TO_CL73_AUTO" ,
  "QMOD_AN_PROPERTY_ENABLE_CL73_BAM_TO_HPAM_AUTO" ,
  "QMOD_AN_PROPERTY_ENABLE_ILLEGAL" 
}; /* e2s_an_property_enable */

char* e2s_credit_type_t [CNT_credit_type_t] = {
  "QMOD_CREDIT_RESET" ,
  "QMOD_CREDIT_TABLE" ,
  "QMOD_CREDIT_CLOCK_COUNT_0" ,
  "QMOD_CREDIT_CLOCK_COUNT_1" ,
  "QMOD_CREDIT_LOOP_COUNT_0" ,
  "QMOD_CREDIT_LOOP_COUNT_1" ,
  "QMOD_CREDIT_MAC" ,
  "QMOD_CREDIT_PCS_CLOCK_COUNT_0" ,
  "QMOD_CREDIT_PCS_GEN_COUNT" ,
  "QMOD_CREDIT_EN" ,
  "QMOD_CREDIT_PCS_REPCNT" ,
  "QMOD_CREDIT_SGMII_SPD" ,
  "QMOD_CREDIT_ILLEGAL" 
}; /* e2s_credit_type_t */

char* e2s_override_type_t [CNT_override_type_t] = {
  "QMOD_OVERRIDE_RESET" ,
  "QMOD_OVERRIDE_QSGMII_EN" ,
  "QMOD_OVERRIDE_CL36BYTEDEL_MODE" ,
  "QMOD_OVERRIDE_OS_MODE" ,
  "QMOD_OVERRIDE_CREDIT_EN" ,
  "QMOD_OVERRIDE_CLKCNT0" ,
  "QMOD_OVERRIDE_CLKCNT1" ,
  "QMOD_OVERRIDE_LOOPCNT0" ,
  "QMOD_OVERRIDE_LOOPCNT1" ,
  "QMOD_OVERRIDE_MAC_CREDITGENCNT" ,
  "QMOD_OVERRIDE_REPLICATIONCNT" ,
  "QMOD_OVERRIDE_PCS_CREDITEN" ,
  "QMOD_OVERRIDE_PCS_CLOCKCNT0" ,
  "QMOD_OVERRIDE_PCS_CREDITGENCNT" ,
  "QMOD_OVERRIDE_ALL" 
}; /* e2s_override_type_t */
