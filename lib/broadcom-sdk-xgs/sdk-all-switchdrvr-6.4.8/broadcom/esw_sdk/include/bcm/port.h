...
#define BCM_PORT_WIDE_DATA_STRENGTH_SET(_data, _strength)  \
	  COMPILER_64_SET(_data,( (_strength ) ? ( COMPILER_64_HI(_data) | (1 << (BCM_PORT_WIDE_DATA_WIDTH -32))) :  (COMPILER_64_HI(_data) & ~( 1 << (BCM_PORT_WIDE_DATA_WIDTH -32)))) ,COMPILER_64_LO(_data)) 

#define BCM_PORT_WIDE_DATA_STRENGTH_GET(_data)  \
    (COMPILER_64_HI(_data)  >> (BCM_PORT_WIDE_DATA_WIDTH -32) ) 
...
#define BCM_PORT_ABILITY_PAUSE_ASYMM        _SHR_PA_PAUSE_ASYMM /* The following is used
                                                          ...
                                                          different than
                                                          PAUSE_RX. */
#define BCM_PORT_ABILITY_FEC                _SHR_PA_FEC /* FEC ability support. */
#define BCM_PORT_ABILITY_FEC_REQUEST        _SHR_PA_FEC_REQUEST /* FEC ability request. */
...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassFieldIngressDevicePort = 18, /* virtual port instance of device port
                                           in IFP IPBM key */
    bcmPortClassCount = 19              /* Last enum value. */
} bcm_port_class_t;
...
typedef enum bcm_port_control_e {
    ...
    bcmPortControlExternalBufferEnable = 307, /* Enable/disable the MMU External
                                           Buffer on the port */
    bcmPortControlReserved308 = 308,    /* Reserved. */
    bcmPortControlReserved309 = 309,    /* Reserved. */
    bcmPortControlReserved310 = 310,    /* Reserved. */
    ...
    bcmPortControl1588P2PDelay = 316,   /* Update path delay in 1588 p2p dealy
                                           mechanism. */
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_COUNT = 32           /* Must be last */
} bcm_port_match_t;
