...
/*
 * $Id: g2p3_soc_cls.h,v 1.23 Broadcom SDK $
 *
 ...
 **/
int 
soc_sbx_g2p3_ifp_max_rule_capacity_get(uint32 unit,
                                       uint32 *pRuleCount);

int 
soc_sbx_g2p3_efp_max_rule_capacity_get(uint32 unit,
                                       uint32 *pRuleCount);
int 
soc_sbx_g2p3_ifp_v6_max_rule_capacity_get(uint32 unit,
                                       uint32 *pRuleCount);

int 
soc_sbx_g2p3_efp_v6_max_rule_capacity_get(uint32 unit,
                                       uint32 *pRuleCount);
...
int
soc_sbx_g2p3_ifp_handle_head_get(uint32 unit,
                       soc_sbx_g2p3_ifp_handle_t *handle);
int
soc_sbx_g2p3_efp_handle_head_get(uint32 unit,
                       soc_sbx_g2p3_efp_handle_t *handle);
int
soc_sbx_g2p3_ifp_v6_handle_head_get(uint32 unit,
                       soc_sbx_g2p3_ifp_v6_handle_t *handle);
int
soc_sbx_g2p3_efp_v6_handle_head_get(uint32 unit,
                       soc_sbx_g2p3_efp_v6_handle_t *handle);
int
soc_sbx_g2p3_ifp_handle_tail_get(uint32 unit,
                       soc_sbx_g2p3_ifp_handle_t *handle);
int
soc_sbx_g2p3_efp_handle_tail_get(uint32 unit,
                       soc_sbx_g2p3_efp_handle_t *handle);

/* mostly similar to iterator functions */
int
soc_sbx_g2p3_ifp_handle_prev_get(uint32 unit,
		       soc_sbx_g2p3_ifp_handle_t  currentHandle,
                       soc_sbx_g2p3_ifp_handle_t *handle);
int
soc_sbx_g2p3_efp_handle_prev_get(uint32 unit,
		       soc_sbx_g2p3_efp_handle_t   currentHandle,
                       soc_sbx_g2p3_efp_handle_t *handle);
int
soc_sbx_g2p3_ifp_handle_next_get(uint32 unit,
		       soc_sbx_g2p3_ifp_handle_t  currentHandle,
                       soc_sbx_g2p3_ifp_handle_t *handle);
int
soc_sbx_g2p3_efp_handle_next_get(uint32 unit,
		       soc_sbx_g2p3_efp_handle_t   currentHandle,
                       soc_sbx_g2p3_efp_handle_t *handle);
int
soc_sbx_g2p3_ifp_v6_handle_next_get(uint32 unit,
		       soc_sbx_g2p3_ifp_v6_handle_t  currentHandle,
                       soc_sbx_g2p3_ifp_v6_handle_t *handle);
int
soc_sbx_g2p3_efp_v6_handle_next_get(uint32 unit,
 ...
 **/
int 
soc_sbx_g2p3_ifp_handle_update(uint32 unit,
                       soc_sbx_g2p3_ifp_handle_t handle,
                       soc_sbx_g2p3_ifp_t *pRule);
int 
soc_sbx_g2p3_efp_handle_update(uint32 unit,
                       soc_sbx_g2p3_efp_handle_t handle,
                       soc_sbx_g2p3_efp_t *pRule);
int 
soc_sbx_g2p3_ifp_v6_handle_update(uint32 unit,
                       soc_sbx_g2p3_ifp_v6_handle_t handle,
                       soc_sbx_g2p3_ifp_v6_t *pRule);
int 
soc_sbx_g2p3_efp_v6_handle_update(uint32 unit,
                       soc_sbx_g2p3_efp_v6_handle_t handle,
                       soc_sbx_g2p3_efp_v6_t *pRule);
 ...
 **/
int 
soc_sbx_g2p3_ifp_handle_remove(uint32 unit,
                       soc_sbx_g2p3_ifp_handle_t handle); 
int 
soc_sbx_g2p3_efp_handle_remove(uint32 unit,
                       soc_sbx_g2p3_efp_handle_t handle); 
int 
soc_sbx_g2p3_ifp_v6_handle_remove(uint32 unit,
                       soc_sbx_g2p3_ifp_v6_handle_t handle); 
int 
soc_sbx_g2p3_efp_v6_handle_remove(uint32 unit,
                       soc_sbx_g2p3_efp_v6_handle_t handle); 
 ...
 **/
int
soc_sbx_g2p3_ifp_counter_read(uint32 unit,
                        soc_sbx_g2p3_ifp_handle_t pHandle,
                        soc_sbx_g2p3_counter_value_t   *pCount,
                        uint8 bClear);
int
soc_sbx_g2p3_efp_counter_read(uint32 unit,
                        soc_sbx_g2p3_efp_handle_t pHandle,
                        soc_sbx_g2p3_counter_value_t   *pCount,
                        uint8 bClear);
int
soc_sbx_g2p3_ifp_v6_counter_read(uint32 unit,
                        soc_sbx_g2p3_ifp_v6_handle_t pHandle,
                        soc_sbx_g2p3_counter_value_t   *pCount,
                        uint8 bClear);
int
soc_sbx_g2p3_efp_v6_counter_read(uint32 unit,
                        soc_sbx_g2p3_efp_v6_handle_t pHandle,
                        soc_sbx_g2p3_counter_value_t   *pCount,
                        uint8 bClear);
 ...
 **/
int
soc_sbx_g2p3_ifp_clear_all(uint32 unit);
int
soc_sbx_g2p3_efp_clear_all(uint32 unit);
int
soc_sbx_g2p3_ifp_v6_clear_all(uint32 unit);
int
soc_sbx_g2p3_efp_v6_clear_all(uint32 unit);
