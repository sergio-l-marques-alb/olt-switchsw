...
typedef struct
{
  ...
  int rcy_single_context_port[SOC_DPP_DEFS_MAX(NOF_CORES)][SOC_DPP_DEFS_MAX(NOF_INTERLAKEN_PORTS)];
  uint32 rcy_reassembly_ctxt[SOC_DPP_DEFS_MAX(NOF_CORES)][SOC_DPP_DEFS_MAX(NOF_INTERLAKEN_PORTS)];
  int rcy_channel_ilkn_offset[SOC_DPP_DEFS_MAX(NOF_CORES)][SOC_DPP_MAX_NOF_CHANNELS];
