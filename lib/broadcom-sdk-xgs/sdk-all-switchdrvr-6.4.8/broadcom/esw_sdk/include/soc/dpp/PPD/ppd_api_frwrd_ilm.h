...
typedef SOC_PPC_FRWRD_ILM_GLBL_KEY_INFO                        SOC_PPD_FRWRD_ILM_GLBL_KEY_INFO;
typedef SOC_PPC_FRWRD_ILM_GLBL_ELSP_INFO                       SOC_PPD_FRWRD_ILM_GLBL_ELSP_INFO;
typedef SOC_PPC_FRWRD_ILM_KEY                                  SOC_PPD_FRWRD_ILM_KEY;
typedef SOC_PPC_FRWRD_ILM_GLBL_INFO                            SOC_PPD_FRWRD_ILM_GLBL_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_frwrd_ilm_get_procs_ptr(void);
void
