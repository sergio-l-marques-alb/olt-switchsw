...
/* implemented by: sw_state_dpp_bcm_ipmc_get_size */
typedef int (*sw_state_dpp_bcm_ipmc_get_size_cb)(
...
/* implemented by: sw_state_dpp_bcm_ipmc_init_get_size */
typedef int (*sw_state_dpp_bcm_ipmc_init_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_bcm_ipmc_init_cbs_s {
    ...
    sw_state_dpp_bcm_ipmc_init_get_size_cb get_size;
...
typedef struct sw_state_dpp_bcm_ipmc_cbs_s {
    ...
    sw_state_dpp_bcm_ipmc_get_size_cb get_size;
