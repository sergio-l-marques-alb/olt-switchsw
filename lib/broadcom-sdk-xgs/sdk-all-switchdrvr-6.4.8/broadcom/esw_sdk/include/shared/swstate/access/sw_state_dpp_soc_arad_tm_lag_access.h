...
/* implemented by: sw_state_dpp_soc_arad_tm_lag_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_lag_get_size_cb)(
...
typedef int (*sw_state_dpp_soc_arad_tm_lag_in_use_verify_cb)(
    int _unit, int in_use_idx);

/* implemented by: sw_state_dpp_soc_arad_tm_lag_in_use_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_lag_in_use_get_size_cb)(
    int _unit, int in_use_idx,int *ret_size);
...
typedef int (*sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_verify_cb)(
    int _unit, int local_to_reassembly_context_idx);

/* implemented by: sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_get_size_cb)(
    int _unit, int local_to_reassembly_context_idx,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_tm_lag_in_use_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_lag_in_use_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_lag_local_to_reassembly_context_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_tm_lag_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_lag_get_size_cb get_size;
