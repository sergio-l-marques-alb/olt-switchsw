...
bool cmicx_schan_update(cmicx_schan_data_t *schan_data);
...
bool cmic_schan_sbus_command_complete(reg_t *sbus_command,reg_t *sbus_command_ack,int expected_resp_words,int *num_words_in_command);
