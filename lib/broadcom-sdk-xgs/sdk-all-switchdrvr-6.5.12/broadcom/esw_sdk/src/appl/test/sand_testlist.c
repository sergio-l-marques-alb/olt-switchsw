...
TEST(5,   "BIST",                     TSEL | TS_DPP | TS_DFE | TS_DNXF, bist_test_init,          bist_test_done, bist_test,        1,   "ALL")
...
#endif
#if defined(BCM_DFE_SUPPORT) || defined (BCM_PETRA_SUPPORT)
TEST(71,  "Table DMA",                TSEL | TS_DPP | TS_DFE | TS_DNXF | TS_DNX, td_test_init,            td_test_done,           td_test_test,           1,      0)
#endif
