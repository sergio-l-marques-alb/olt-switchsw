...
#if (defined(BCM_XGS3_SWITCH_SUPPORT) || defined(BCM_SBX_SUPPORT) || defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT) || defined(BCM_DNX_SUPPORT)) && defined(BCM_WARM_BOOT_SUPPORT)
static char *
...
#ifdef BCM_WARM_BOOT_SUPPORT
#if (defined(BCM_XGS3_SWITCH_SUPPORT) || defined(BCM_SBX_SUPPORT) || defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT) || defined(BCM_DNX_SUPPORT))
        else if (!sal_strcasecmp(c, "storage")) {
            appl_warmboot_storage_requirements(u);
        }
#endif /* (BCM_XGS3_SWITCH_SUPPORT || BCM_SBX_SUPPORT || BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT) || defined(BCM_DNX_SUPPORT)*/
...
#endif
#if defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT) || defined(BCM_DNX_SUPPORT)
