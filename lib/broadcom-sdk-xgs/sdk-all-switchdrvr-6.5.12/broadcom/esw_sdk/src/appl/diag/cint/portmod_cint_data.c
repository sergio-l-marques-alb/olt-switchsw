...
CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         ...
                         int, int, unit, 0, 0,
                         portmod_dispatch_type_t, portmod_dispatch_type_t, pm_type, 0, 0,
                         portmod_pm_capability_t*, portmod_pm_capability_t, pm_cap, 1, 0);
...
static cint_function_t __cint_functions[] =
{
    ...
    CINT_FWRAPPER_ENTRY(portmod_pm_capability_get),
    CINT_FWRAPPER_ENTRY(portmod_pm_vcos_get),
    CINT_FWRAPPER_ENTRY(portmod_pm_core_init),
    CINT_FWRAPPER_ENTRY(portmod_pm_is_core_initialized),
...
__cint_maddr__portmod_port_init_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 34: rv = &(s->port_mode_aux_info);break;
        case 35: rv = &(s->port_ts_adjust);break;
        case 36: rv = &(s->txpi_mode);break;
        case 37: rv = &(s->txpi_sdm_scheme);break;
        case 38: rv = &(s->roe_stuffing_bit);break;
        case 39: rv = &(s->roe_reserved_bit);break;
        case 40: rv = &(s->cpm_core_mode);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__portmod_speed_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    {
        case 0: rv = &(s->speed);break;
        case 1: rv = &(s->fec);break;
        case 2: rv = &(s->link_training);break;
        case 3: rv = &(s->lane_config);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__portmod_pm_vco_setting_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 2: rv = &(s->tvco);break;
        case 3: rv = &(s->ovco);break;
        case 4: rv = &(s->is_tvco_new);break;
        case 5: rv = &(s->is_ovco_new);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static cint_parameter_desc_t __cint_struct_members__portmod_cpri_rx_vsd_config_info_t[] = 
{
    {"uint32", "schan_start", 0, 0},
    {"uint32", "schan_size", 0, 0},
    {"portmod_cpri_control_schan_num_bytes_t", "schan_bytes", 0, 0},
    {"uint32", "schan_steps", 0, 0},
    {"portmod_cpri_control_flow_num_bytes_t", "flow_bytes", 0, 0},
    {"uint32", "queue_num", 0, 0},
...
static cint_constants_t __cint_constants[] =
{
    ...
    { "PORTMOD_VCO_20G", PORTMOD_VCO_20G },
    { "PORTMOD_VCO_25G", PORTMOD_VCO_25G },
    { "PORTMOD_VCO_26G", PORTMOD_VCO_26G },
...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    { "PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_1", PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_1 },
    { "PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_2", PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_2 },
    { "PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_4", PORTMOD_CPRI_CONTROL_SCHAN_NUM_BYTES_4 },
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_hdlc_fcs_size_t", "portmod_cpri_hdlc_fcs_size_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_hdlc_filling_flag_pattern_t", "portmod_cpri_hdlc_filling_flag_pattern_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_hdlc_flag_size_t", "portmod_cpri_hdlc_num_flag_bytes_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_hdlc_crc_mode_t", "portmod_cpri_crc_mode_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_hdlc_crc_init_val_t", "portmod_cpri_hdlc_crc_init_val_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_control_schan_num_bytes_t", "portmod_cpri_control_schan_num_bytes_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
    {"_shr_control_flow_num_bytes_t", "portmod_cpri_control_flow_num_bytes_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
    {"_shr_control_msg_proc_type_t", "portmod_control_msg_proc_type_t" , 0 , 0},
#ifdef CPRIMOD_SUPPORT
    {"_shr_fast_eth_config_t", "portmod_cpri_fast_eth_config_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
    {"_shr_sync_count_cycle_t", "portmod_sync_count_cycle_t" , 0 , 0},
    {"_shr_tag_gen_entry_t", "portmod_tag_gen_entry_t" , 0 , 0},
#ifdef CPRIMOD_SUPPORT
    {"_shr_cpri_crc_option_t", "portmod_cpri_crc_option_t" , 0 , 0},
#endif /* CPRIMOD_SUPPORT */
    { NULL }
};
