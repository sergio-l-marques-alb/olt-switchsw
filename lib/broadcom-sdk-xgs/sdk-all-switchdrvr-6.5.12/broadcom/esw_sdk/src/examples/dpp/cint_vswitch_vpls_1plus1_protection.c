...
int vswitch_vpls_ac_1plus1_run(int unit, int acP, int pweP){
    ...
    egress_mc = 1;
    rv = multicast__open_mc_group(unit, &ingress_protection_group_id, BCM_MULTICAST_TYPE_L2);
    if (rv != BCM_E_NONE) {
...
int vswitch_vpls_ac_1plus1_add_access_port(int unit)
{
    ...
    print bcm_port_learn_set(0,vlan_port_1.vlan_port_id,BCM_PORT_LEARN_ARL|BCM_PORT_LEARN_FWD);
    print bcm_port_learn_set(0,vlan_port_2.vlan_port_id,BCM_PORT_LEARN_ARL|BCM_PORT_LEARN_FWD);
