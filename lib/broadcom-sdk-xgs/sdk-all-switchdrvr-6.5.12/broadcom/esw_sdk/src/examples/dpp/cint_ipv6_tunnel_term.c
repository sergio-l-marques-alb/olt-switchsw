...
int ipv6_tunnel_term_3_tunnels(int unit, int in_port, int out_port){
    int rv;
    bcm_if_t eg_intf_ids[2]; /* to include egress router interfaces */
    ...
    /*** build tunnel terminations ***/
    rv = ipv6_tunnel_term_build_3_tunnels(unit,in_port,out_port,eg_intf_ids,in_tunnel_gports, &ll_encap_id); 
    if (rv != BCM_E_NONE) {
        printf("Error, ipv6_tunnel_term_build_3_tunnels, in_port=%d, \n", in_port);
    }

    /*** add routes to egress interfaces ***/
    rv = ipv6_tunnel_term_add_routes(unit,eg_intf_ids, ll_encap_id);
    if (rv != BCM_E_NONE) {
        printf("Error, ipv6_tunnel_term_add_routes, eg_intf_ids=0x%08x,%0x%08x \n", eg_intf_ids[0],eg_intf_ids[1]);
    }
...
/* It configures IP4In6 ,IP6In6 and IPAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_ip4_ip6_ipany_in6 (int unit, int in_port, int out_port) {
    ip6_tunnel_term_glbl_info.tunnel_type_1 = bcmTunnelTypeIp4In6;
    ip6_tunnel_term_glbl_info.tunnel_type_2 = bcmTunnelTypeIp6In6;
    ip6_tunnel_term_glbl_info.tunnel_type_3 = bcmTunnelTypeIpAnyIn6;
    ip6_tunnel_term_glbl_info.cascade_1 = 0;
    ip6_tunnel_term_glbl_info.cascade_2 = 0;
    ip6_tunnel_term_glbl_info.cascade_3 = 0;
    return ipv6_tunnel_term_3_tunnels(unit, in_port, out_port);
}

/* It configures cascade IP4In6 ,IP6In6 and IPAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_cascade_ip4_ip6_ipany_in6 (int unit, int in_port, int out_port) {
    ip6_tunnel_term_glbl_info.tunnel_type_1 = bcmTunnelTypeIp4In6;
    ip6_tunnel_term_glbl_info.tunnel_type_2 = bcmTunnelTypeIp6In6;
    ip6_tunnel_term_glbl_info.tunnel_type_3 = bcmTunnelTypeIpAnyIn6;
    ip6_tunnel_term_glbl_info.cascade_1 = 1;
    ip6_tunnel_term_glbl_info.cascade_2 = 1;
    ip6_tunnel_term_glbl_info.cascade_3 = 1;    
    return ipv6_tunnel_term_3_tunnels(unit, in_port, out_port);
}

/* It configures Gre4In6 ,Gre6In6 and GreAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_gre4_gre6_greany_in6 (int unit, int in_port, int out_port) {
    ip6_tunnel_term_glbl_info.tunnel_type_1 = bcmTunnelTypeGre4In6;
    ip6_tunnel_term_glbl_info.tunnel_type_2 = bcmTunnelTypeGre6In6;
    ip6_tunnel_term_glbl_info.tunnel_type_3 = bcmTunnelTypeGreAnyIn6;
    ip6_tunnel_term_glbl_info.cascade_1 = 0;
    ip6_tunnel_term_glbl_info.cascade_2 = 0;
    ip6_tunnel_term_glbl_info.cascade_3 = 0;
    return ipv6_tunnel_term_3_tunnels(unit, in_port, out_port);
...
/* It configures cascade IP4In6 ,IP6In6 and IPAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_cascade_gre4_gre6_greany_in6 (int unit, int in_port, int out_port) {
    ip6_tunnel_term_glbl_info.tunnel_type_1 = bcmTunnelTypeGre4In6;
    ip6_tunnel_term_glbl_info.tunnel_type_2 = bcmTunnelTypeGre6In6;
    ip6_tunnel_term_glbl_info.tunnel_type_3 = bcmTunnelTypeGreAnyIn6;
    ip6_tunnel_term_glbl_info.cascade_1 = 1;
...
/* It configures IP4In6 ,IP6In6 and IPAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_ip4_ip6_ipany_in6_subnet (int unit, int in_port, int out_port) {
    bcm_ip6_t dip_mask = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t dip_mask2 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t dip_mask3 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    ip6_tunnel_term_glbl_info.cascade_2 = 0;
    ip6_tunnel_term_glbl_info.cascade_3 = 0;
    sal_memcpy(ip6_tunnel_term_glbl_info.dip_mask, dip_mask, 16);
    sal_memcpy(ip6_tunnel_term_glbl_info.dip_mask2, dip_mask2, 16);
    sal_memcpy(ip6_tunnel_term_glbl_info.dip_mask3, dip_mask3, 16);
    return ipv6_tunnel_term_3_tunnels(unit, in_port, out_port);
}

/* It configures cascade IP4In6 ,IP6In6 and IPAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_cascade_ip4_ip6_ipany_in6_subnet  (int unit, int in_port, int out_port) {
    bcm_ip6_t sip_mask = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t sip_mask2 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t sip_mask3 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    ip6_tunnel_term_glbl_info.cascade_2 = 1;
    ip6_tunnel_term_glbl_info.cascade_3 = 1;        
    sal_memcpy(ip6_tunnel_term_glbl_info.sip_mask, sip_mask, 16);
    sal_memcpy(ip6_tunnel_term_glbl_info.sip_mask2, sip_mask2, 16);
    sal_memcpy(ip6_tunnel_term_glbl_info.sip_mask3, sip_mask3, 16);
    return ipv6_tunnel_term_3_tunnels(unit, in_port, out_port);
}

/* It configures Gre4In6 ,Gre6In6 and GreAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_gre4_gre6_greany_in6_subnet  (int unit, int in_port, int out_port) {
    bcm_ip6_t dip_mask = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t dip_mask2 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t dip_mask3 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
/* It configures cascade IP4In6 ,IP6In6 and IPAnyIn6 tunnels in the TCAM */
int ipv6_tunnel_term_cascade_gre4_gre6_greany_in6_subnet  (int unit, int in_port, int out_port) {
    bcm_ip6_t sip_mask = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t sip_mask2 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    bcm_ip6_t sip_mask3 = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
int ipv6_tunnel_term_cascade_gre_subnet  (int unit, int in_port, int out_port, int is_cascade, int is_gre, int is_subnet) {
    if (!is_subnet ) {
        if (!is_gre) {
            if (!is_cascade) {
                return ipv6_tunnel_term_ip4_ip6_ipany_in6(unit, in_port, out_port);
            } else {
                return ipv6_tunnel_term_cascade_ip4_ip6_ipany_in6(unit, in_port, out_port);
            }
        } else {
            if (!is_cascade) {
                return ipv6_tunnel_term_gre4_gre6_greany_in6(unit, in_port, out_port);
            } else {
                return ipv6_tunnel_term_cascade_gre4_gre6_greany_in6(unit, in_port, out_port);
            }
        }
    } else {
        if (!is_gre) {
            if (!is_cascade) {
                return ipv6_tunnel_term_ip4_ip6_ipany_in6_subnet(unit, in_port, out_port);
            } else {
                return ipv6_tunnel_term_cascade_ip4_ip6_ipany_in6_subnet(unit, in_port, out_port);
            }
        } else {
            if (!is_cascade) {
                return ipv6_tunnel_term_gre4_gre6_greany_in6_subnet(unit, in_port, out_port);
            } else {
                return ipv6_tunnel_term_cascade_gre4_gre6_greany_in6_subnet(unit, in_port, out_port);
            }
        }
    }
}
