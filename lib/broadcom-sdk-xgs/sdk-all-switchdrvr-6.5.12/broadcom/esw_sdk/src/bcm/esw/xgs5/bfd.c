...
static uint32 _bfd_sdk_warmboot_version [][4] = {
...
bcmi_xgs5_bfd_match_id(int unit, bfd_info_t *bfd_info)
{
     ...
     *
     */
    soc_cancun_ceh_obj_field_get(unit, "MATCH_ID", "Z0_MATCH_ID", &ceh_info);
    zone_width[0] = ceh_info.width;
    soc_cancun_ceh_obj_field_get(unit, "MATCH_ID", "Z1_MATCH_ID", &ceh_info);
    zone_width[1] = ceh_info.width;
    soc_cancun_ceh_obj_field_get(unit, "MATCH_ID", "Z2_MATCH_ID", &ceh_info);
    zone_width[2] = ceh_info.width;
    soc_cancun_ceh_obj_field_get(unit, "MATCH_ID", "Z3_MATCH_ID", &ceh_info);
    zone_width[3] = ceh_info.width;
    soc_cancun_ceh_obj_field_get(unit, "MATCH_ID", "Z4_MATCH_ID", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z1_MATCH_ID", "OTAG", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z1_MATCH_ID", "OTAG_ITAG", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "IPV4", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "IPV6", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "GRE", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "IPINGRE", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "IPINIP", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "UDP", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "BFD", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z4_MATCH_ID", "IPV4", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z4_MATCH_ID", "IPV6", &ceh_info);
    ...
    /* Outer GRE value = 3  offset = 2 width = 5 */
    soc_cancun_ceh_obj_field_get(unit, "Z4_MATCH_ID", "GRE", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z4_MATCH_ID", "UDP", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z4_MATCH_ID", "BFD", &ceh_info);
    ...
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "MPLS", &ceh_info);
     ...
     * MPLS LABEL DETIALS
     */
    soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID", "MPLS_1_LABEL_WITH_CW", &ceh_info);
