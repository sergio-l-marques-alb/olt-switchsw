 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: eagle_phy_1_interface.h 1490 2016-08-11 22:26:06Z cvazquez $   *
 *                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/eagle_phy_1/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * eagle_phy_1_interface.h - provides the primary functionality.
 *
 * eagle_phy_1_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file eagle_phy_1_interface.h
 * Main interface functions provided to IP User
 */

#ifndef EAGLE_PHY_1_API_INTERFACE_H
#define EAGLE_PHY_1_API_INTERFACE_H
...
struct eagle_phy_1_uc_lane_config_field_st {
...
struct eagle_phy_1_uc_core_config_field_st {
...
/** Lane Config Struct */
struct  eagle_phy_1_uc_lane_config_st {
  struct eagle_phy_1_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  eagle_phy_1_uc_core_config_st {
  struct eagle_phy_1_uc_core_config_field_st field;
  uint16_t word;
  int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct eagle_phy_1_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_1_get_uc_core_config(struct eagle_phy_1_uc_core_config_st *struct_val);
...
/** Column definition header for eagle_phy_1_display_core_state() API output.
 * To be called before eagle_phy_1_display_core_state_line() API.
 ...
 * Call eagle_phy_1_display_core_state_hdr() API before and eagle_phy_1_display_core_state_legend() after
 * calling this API to get a formatted core state display with legend.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_1_display_core_state_line(void);

/** Detailed description of each column in eagle_phy_1_display_core_state_line() API output.
 * To be called after eagle_phy_1_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * \n Note: Micro should be loaded only after issuing a eagle_phy_1_uc_reset(1) followed by asserting and de-asserting
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [eagle_phy_1_ucode_crc_verify()] and verifying the CRC value [eagle_phy_1_start_ucode_crc_calc()].
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [eagle_phy_1_ucode_crc_verify()] and verifying the CRC value [eagle_phy_1_start_ucode_crc_calc()].
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * Note: eagle_phy_1_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 * Note: User also needs to configure all lanes through eagle_phy_1_lane_config_for_iddq()
 ...
 * Along with eagle_phy_1_core_pwrdn(), all lanes powerdowns should also be issued using
 * eagle_phy_1_lane_pwrdn() to complete a Core Powerdown.
 ...
 * If using MDIO interface to access the registers, use this API to implement eagle_phy_1_pmd_mwr_reg().
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_1_get_uc_lane_cfg(struct eagle_phy_1_uc_lane_config_st *struct_val);
 ...
 * It relies on the accuracy of eagle_phy_1_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use eagle_phy_1_read_eye_scan_stripe() function
 ...
 * eagle_phy_1_start_ber_scan_test(), eagle_phy_1_read_ber_scan_data(), eagle_phy_1_display_ber_scan_data().
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * \n Note: Call functions eagle_phy_1_display_lane_state_hdr() before and eagle_phy_1_display_lane_state_legend() after
 * to get a formatted lane state display with legend
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_1_display_lane_state(void);

/** Column definition header for eagle_phy_1 display state.
 * To be called before eagle_phy_1_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_1_display_lane_state_hdr(void);

/** Detailed explanation of each column in eagle_phy_1 display state.
 * To be called after eagle_phy_1_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable eagle_phy_1 support.
...
/** Parameterized diagnostic function which access to all eagle_phy_1 control and status bits
 * This function is required to be implemented by upper level software to enable eagle_phy_1 support.
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the eagle_phy_1_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: The patt_length input to the function should be the value sent to the eagle_phy_1_config_shared_tx_pattern() function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in eagle_phy_1_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Once the PRBS generator is configured, to enable PRBS use the eagle_phy_1_tx_prbs_en() API.
 ...
 * Once the PRBS checker is configured, use the eagle_phy_1_rx_prbs_en() API to enable the checker.
 ...
 * Note: User needs to configure all lanes through eagle_phy_1_lane_config_for_iddq() and also call eagle_phy_1_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
