    ...
    uint32 limit, uint32 burst_size)
{
    ...
    LOG_INFO(BSL_LS_SOC_PORT, \
             (BSL_META("_drv_nsp_port_erc_set: \
    ...
    uint32 limit, uint32 burst_size)
{
    ...
    LOG_INFO(BSL_LS_SOC_PORT, \
             (BSL_META("_drv_nsp_port_erc_per_queue_set: \
    ...
    uint32 *limit, uint32 *burst_size)
{
    ...
    *flags = 0;
    ...
    LOG_INFO(BSL_LS_SOC_PORT, \
             (BSL_META("_drv_nsp_port_erc_get: \
    ...
    uint8 queue_n, uint32 *flags, uint32 *limit, uint32 *burst_size)
{
    ...
    *flags = 0;
    ...
    LOG_INFO(BSL_LS_SOC_PORT, \
             (BSL_META("_drv_nsp_port_erc_per_queue_get: \
                       unit = %d, port = %d, limit = %dK, burst size = %dKB\n"), 
              unit, port, *limit, *burst_size));
