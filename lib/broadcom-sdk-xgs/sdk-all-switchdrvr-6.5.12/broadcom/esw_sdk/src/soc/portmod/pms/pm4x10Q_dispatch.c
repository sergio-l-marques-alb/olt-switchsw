...
__portmod__dispatch__t__ portmod_pm4x10Q_driver = {
    ...
    pm4x10Q_port_ability_local_get,
    ...
    pm4x10Q_port_phy_link_down_event,
    ...
    pm4x10Q_port_local_fault_control_set,
    pm4x10Q_port_local_fault_control_get,
    pm4x10Q_port_remote_fault_control_set,
    pm4x10Q_port_remote_fault_control_get,
    ...
    pm4x10Q_port_ability_advert_set,
    pm4x10Q_port_ability_advert_get,
    ...
    pm4x10Q_port_drain_cell_get,
    pm4x10Q_port_drain_cell_stop,
    pm4x10Q_port_drain_cell_start,
    pm4x10Q_port_drain_cells_rx_enable,
    NULL, /* portmod_port_egress_queue_drain_rx_en */
    NULL, /* portmod_port_mac_ctrl_set */
    pm4x10Q_port_txfifo_cell_cnt_get,
    NULL, /* portmod_port_egress_queue_drain_get */
    NULL, /* portmod_port_mac_reset_set */
    NULL, /* portmod_port_soft_reset_toggle */
    pm4x10Q_port_mac_reset_check,
    pm4x10Q_port_core_num_get,
    ...
    pm4x10Q_port_discard_set,
    pm4x10Q_port_soft_reset_set,
    pm4x10Q_port_tx_down,
