...
/*A10*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A10. ZQ calibration\n")));
        ...
        SOC_IF_ERROR_RETURN( soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_FLD_PTERMf, dq_pterm));
        ...
        SOC_IF_ERROR_RETURN( soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_DQ_BYTE0_DQS_IO_CONFIGr, &data, SOC_PHY_FLD_PTERMf, dq_pterm));
