    ...
    SOC_SAND_IN  uint8                  *result)
{
    ...
    } else if(SOC_DPP_CONFIG(unit)->arad->init.elk.tcam_dev_type == ARAD_NIF_ELK_TCAM_DEV_TYPE_BCM52311) {
        max_nof_device_searches = 8; /* MAX number of searches for Optimus Prime */
    } else {
