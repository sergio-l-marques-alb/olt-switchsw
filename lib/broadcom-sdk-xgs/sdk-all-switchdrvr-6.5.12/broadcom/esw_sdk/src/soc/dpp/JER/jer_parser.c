...
static dpp_macro_t macros[] =
{
 /* SW Macro              String        HW Macro          TM Flag */
   ...
   {DPP_MACRO_UDP_PTP,    "UDP_PTP",    JER_MACRO_NA,     FALSE},
...
static int jer_parser_udp_ptp(int unit)
{
    ARAD_PP_IHP_PARSER_CUSTOM_MACRO_PARAMETERS_TBL_DATA ihp_parser_custom_macro_parameters_tbl_data;
    ARAD_PP_IHP_PARSER_CUSTOM_MACRO_PROTOCOLS_TBL_DATA  ihp_parser_custom_macro_protocols_tbl_data;
    uint32                                              custom_macro;
    ...
    DPP_LEAF_CB_GATE(DPP_CB_UDP_PTP);
    ...
    SOCDNX_IF_ERR_EXIT(jer_parser_macro_sel_allocate(unit, DPP_MACRO_UDP_PTP, &custom_macro));
    ...
    ihp_parser_custom_macro_parameters_tbl_data.cstm_mask_right        = 0;           /* mask last bit of dest_port */
    ihp_parser_custom_macro_parameters_tbl_data.cstm_comparator_mode   = 1;           /* Compare 16 lsb of selected data to 16 lsb of comparator values */
...
static dpp_leaf_t IPv4_leafs[] =
{
  ...
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
          DPP_MACRO_UDP_PTP,DPP_SEGMENT_FIN,                DPP_PFC_IPV4_ETH,           DPP_PLC_PP_L4,      jer_parser_udp_ptp},
  /* Default UDP Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
...
static dpp_leaf_t IPv6_leafs[] =
{
  ...
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
          DPP_MACRO_UDP_PTP,    DPP_SEGMENT_FIN,            DPP_PFC_IPV6_ETH,           DPP_PLC_PP_L4,      jer_parser_udp_ptp},
  /* Basic UDP Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
...
static dpp_leaf_t IPv4oMPLS1_leafs[] =
{
  ...
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
        DPP_MACRO_UDP_PTP,      DPP_SEGMENT_FIN,            DPP_PFC_MPLS1_ETH,          DPP_PLC_L4_IPv4isH3,      jer_parser_udp_ptp},
  /* Basic UDP Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
...
static dpp_leaf_t IPv6oMPLS1_leafs[] =
{
  ...
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
        DPP_MACRO_UDP_PTP,      DPP_SEGMENT_FIN,            DPP_PFC_MPLS1_ETH,          DPP_PLC_L4_IPv6isH3,      jer_parser_udp_ptp},
  /* Basic UDP Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
...
static dpp_leaf_t IPv6oMPLS2_leafs[] =
{
  ...
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
          DPP_MACRO_UDP,        DPP_SEGMENT_FIN,            DPP_PFC_MPLS2_ETH,          DPP_PLC_L4_IPv6isH3,      jer_parser_udp_ptp},
  /* Basic UDP Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
...
static dpp_leaf_t IPv6oMPLS3_leafs[] =
{
  ...
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
          DPP_MACRO_UDP,        DPP_SEGMENT_FIN,            DPP_PFC_MPLS3_ETH,          DPP_PLC_L4_IPv6isH3,      jer_parser_udp_ptp},
  /* Basic UDP Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_UDP << 1) + JER_IP_MC, 2}},
