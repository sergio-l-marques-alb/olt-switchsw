    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_port_general_define_fw_load_verify].doc = "Firmware load verification method.";
    /* Set data type flag */
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->size);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->speed);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->link_training);
            break;
        case 2:
            sal_sprintf(buffer, "%d", data->fec_type);
            break;
        case 3:
            sal_sprintf(buffer, "%d", data->tx_polarity);
            break;
        case 4:
            sal_sprintf(buffer, "%d", data->rx_polarity);
            break;
        case 5:
            sal_sprintf(buffer, "%d", data->connected_to_repeater);
            break;
        case 6:
            sal_sprintf(buffer, "%d", data->tx_pam4_precoder);
            break;
        case 7:
            sal_sprintf(buffer, "%d", data->lp_tx_precoder);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->dfe);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->media_type);
            break;
        case 2:
            sal_sprintf(buffer, "%d", data->unreliable_los);
            break;
        case 3:
            sal_sprintf(buffer, "%d", data->cl72_auto_polarity_enable);
            break;
        case 4:
            sal_sprintf(buffer, "%d", data->cl72_restart_timeout_enable);
            break;
        case 5:
            sal_sprintf(buffer, "%d", data->channel_mode);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->pre2);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->pre);
            break;
        case 2:
            sal_sprintf(buffer, "%d", data->main);
            break;
        case 3:
            sal_sprintf(buffer, "%d", data->post);
            break;
        case 4:
            sal_sprintf(buffer, "%d", data->post2);
            break;
        case 5:
            sal_sprintf(buffer, "%d", data->post3);
            break;
        case 6:
            sal_sprintf(buffer, "%d", data->tx_tap_mode);
            break;
        case 7:
            sal_sprintf(buffer, "%d", data->signalling_mode);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->quad_enable);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->serdes_rx_id);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->serdes_tx_id);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->fabric_ref_clk_in);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->fabric_ref_clk_out);
            break;
    }
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        case 0:
            ...
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->valid);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->source_clock_port);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->source_clock_divider);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->connected_link);
            break;
    }
