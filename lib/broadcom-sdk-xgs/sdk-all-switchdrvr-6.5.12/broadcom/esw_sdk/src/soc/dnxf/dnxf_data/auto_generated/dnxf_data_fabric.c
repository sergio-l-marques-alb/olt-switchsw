    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_fabric_general_define_local_routing_enable].name = "local_routing_enable";
    submodule_data->defines[dnxf_data_fabric_general_define_local_routing_enable].doc = "Enables unicast local routing from FE1 to FE3.";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_fabric_general_define_local_routing_enable].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnxf_data_fabric_general_local_routing_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_general, dnxf_data_fabric_general_define_local_routing_enable);
}
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sal_sprintf(buffer, "%s", data->name == NULL ? "" : data->name);
            break;
        case 3:
            sal_sprintf(buffer, "%d", data->type);
            break;
        case 4:
            sal_sprintf(buffer, "%d", data->min_hp_mc);
            break;
    }
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%d", data->nof_pipes);
            break;
        case 1:
            DNXC_DATA_MGMT_ARR_STR(buffer, DNXF_DATA_MAX_FABRIC_CONGESTION_NOF_THRESHOLD_PRIORITIES, data->uc);
            break;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].keys[0].name = "threhold_id";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[1].type = "diag_threshold_group_options_t";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[2].type = "diag_threshold_stage_options_t";
    ...
    int threhold_id)
{
    ...
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, threhold_id, 0);
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%s", data->threshold_str == NULL ? "" : data->threshold_str);
            break;
        case 1:
            sal_sprintf(buffer, "%d", data->threshold_group);
            break;
        case 2:
            sal_sprintf(buffer, "%d", data->threshold_stage);
            break;
        case 3:
            sal_sprintf(buffer, "%d", data->index_type);
            break;
        case 4:
            sal_sprintf(buffer, "%d", data->supported_flags);
            break;
        case 5:
            sal_sprintf(buffer, "%d", data->is_tx);
            break;
        case 6:
            sal_sprintf(buffer, "%d", data->th_validity_bmp);
            break;
        case 7:
            sal_sprintf(buffer, "%d", data->is_to_be_displayed);
            break;
    }
