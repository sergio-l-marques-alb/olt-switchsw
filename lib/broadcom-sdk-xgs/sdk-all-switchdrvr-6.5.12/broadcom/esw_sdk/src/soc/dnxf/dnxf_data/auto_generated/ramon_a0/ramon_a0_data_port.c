    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "fabric_mac_bucket_fill_rate";
    define->property.doc = 
        "\n"
        "Mac bucket fill rate.\n"
    ...
    int unit)
{
    ...
    /* Property */
    define->property.name = "bcm_stat_interval";
    define->property.doc = 
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "counter_thread_pri";
    define->property.doc = 
        "\n"
    ...
    int unit)
{
    ...
    define->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    define->property.name = "bcm_stat_sync_timeout";
    define->property.doc = 
        "\n"
    ...
    int unit)
{
     ...
     */
    table->values[0].property.name = "port_init_speed";
    ...
    table->values[0].property.mapping[7].name = "41875";
    table->values[0].property.mapping[7].val = 41875;
    table->values[0].property.mapping[8].name = "45000";
    table->values[0].property.mapping[8].val = 45000;
    table->values[0].property.mapping[9].name = "50000";
    table->values[0].property.mapping[9].val = 50000;
    table->values[0].property.mapping[10].name = "51562";
    table->values[0].property.mapping[10].val = 51562;
    table->values[0].property.mapping[11].name = "53125";
    table->values[0].property.mapping[11].val = 53125;
    for (port_index = 0; port_index < table->keys[0].size; port_index++)
    {
        data = (dnxf_data_port_static_add_port_info_t *) dnxc_data_mgmt_table_data_get(unit, table, port_index, 0);
     ...
     */
    table->values[1].property.name = "port_init_cl72";
     ...
     */
    table->values[2].property.name = "port_fec";
     ...
     */
    table->values[3].property.name = "phy_tx_polarity_flip";
     ...
     */
    table->values[4].property.name = "phy_rx_polarity_flip";
     ...
     */
    table->values[5].property.name = "repeater_link_enable";
     ...
     */
    table->values[6].property.name = "port_tx_pam4_precoder";
     ...
     */
    table->values[7].property.name = "port_lp_tx_precoder";
    ...
    int unit)
{
     ...
     * Property
     */
    table->property.name = "serdes_lane_config";
    table->property.doc =
        "\n"
        "1. serdes_lane_config_dfe\n"
        "DFE filter\n"
    ...
    {
        data = (dnxf_data_port_static_add_serdes_lane_config_t *) dnxc_data_mgmt_table_data_get(unit, table, port_index, 0);
        SHR_IF_ERR_EXIT(dnxf_data_property_port_static_add_serdes_lane_config_read(unit, port_index, data));
    }
    /* Set data flags as property */
    table->flags |= (DNXC_DATA_F_PROPERTY);
    ...
    int unit)
{
     ...
     */
    table->values[0].property.name = "serdes_fabric_clk_freq";
    table->values[0].property.doc =
        "\n"
     ...
     */
    table->values[1].property.name = "serdes_fabric_clk_freq";
    table->values[1].property.doc =
        "\n"
    ...
    table->values[1].property.nof_mapping = 2;
    ...
    table->values[1].property.mapping[0].name = "3";
    table->values[1].property.mapping[0].val = soc_dnxc_init_serdes_ref_clock_312_5;
    table->values[1].property.mapping[1].name = "bypass";
    table->values[1].property.mapping[1].val = soc_dnxc_init_serdes_ref_clock_bypass;
    for (pll_index = 0; pll_index < table->keys[0].size; pll_index++)
    {
        data = (dnxf_data_port_pll_info_t *) dnxc_data_mgmt_table_data_get(unit, table, pll_index, 0);
    ...
    int unit)
{
     ...
     */
    table->values[0].property.name = "sync_eth_clk_to_port_id_clk";
    table->values[0].property.doc =
        "\n"
     ...
     */
    table->values[1].property.name = "sync_eth_clk_divider";
    table->values[1].property.doc =
        "\n"
