/*
 * $Id: sbZfFabBm9600InaEsetPriEntryConsole.c,v 1.3 Broadcom SDK $
...
sbZfFabBm9600InaEsetPriEntry_Print(sbZfFabBm9600InaEsetPriEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_15=0x%01x"), (unsigned int)  pFromStruct->m_uPri_15));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: nextpri_14=0x%01x"), (unsigned int)  pFromStruct->m_uNextpri_14));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_12=0x%01x"), (unsigned int)  pFromStruct->m_uPri_12));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: nextpri_11=0x%01x"), (unsigned int)  pFromStruct->m_uNextpri_11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_9=0x%01x"), (unsigned int)  pFromStruct->m_uPri_9));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_7=0x%01x"), (unsigned int)  pFromStruct->m_uPri_7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_5=0x%01x"), (unsigned int)  pFromStruct->m_uPri_5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_3=0x%01x"), (unsigned int)  pFromStruct->m_uPri_3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("FabBm9600InaEsetPriEntry:: pri_1=0x%01x"), (unsigned int)  pFromStruct->m_uPri_1));
  LOG_WARN(BSL_LS_SOC_COMMON,
