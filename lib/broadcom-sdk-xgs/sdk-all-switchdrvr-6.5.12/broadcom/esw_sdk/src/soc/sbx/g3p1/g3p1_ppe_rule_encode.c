/*
 * 
 * $Id: ppe_c.stg,v 1.28 Broadcom SDK $
 * $Copyright: (c) 2017 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * g3p1_ppe_rule_encode.c: Guadalupe3k V1.0 PPE rule encoding functions
 *
...
soc_sbx_g3p1_ppe_hash_t       *hentry;
soc_sbx_g3p1_ppe_rule_t       *rule;
soc_sbx_caladan3_ppe_sqdm_t    *sqdm;

soc_sbx_g3p1_ppe_rule_t global_rule_struct;
...
int soc_sbx_g3p1_ppe_init(int unit) {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hVLAN_PRI_hentry =
        { 
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hETH_MAC_hentry =
        { 
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hETH_DMAC_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            5,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hETH_SMAC_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            6,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hETH_DMAC_IPV4_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            7,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hVLAN_VID_TWO_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            8,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hVLAN_VID_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            9,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hVLAN_VID_C_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            10,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hIPV4_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            11,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hIPV4_DA_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            12,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hIPV4_SA_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            13,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hIPV6_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            14,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hIPV6_DA_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            15,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hIPV6_SA_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            16,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hL4_PORT_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            17,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hL4_DPORT_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            18,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_hash_t hL4_SPORT_hentry =
        { 
            SOC_SBX_CALADAN3_PPE_HASH_TYPE_BYTE,
            19,
            {
     ...
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS0_MPLS_HDR_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 0;  /* cam_id_first */
        rule_struct->cam_id_last  = 0;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS0_MPLS_HDR_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
            rule_struct->tcam.state[0] = 0x0;
            rule_struct->tcam.state[1] = 0x1d;
            rule_struct->tcam.state[2] = 0x0;
            rule_struct->tcam.state_mask[0] = 0x0;
            rule_struct->tcam.state_mask[1] = 0xff;
            rule_struct->tcam.state_mask[2] = 0x0;
        ...
        /* action */
            ...
            rule_struct->camram.var_len_hdr.shift_bytes = 0;  /* shift_bytes */
            rule_struct->camram.state[0] = 0x0;
            rule_struct->camram.state[1] = 0x1d;
            rule_struct->camram.state[2] = 0x0;
            rule_struct->camram.state_mask[0] = 0x0;
            rule_struct->camram.state_mask[1] = 0xff;
            rule_struct->camram.state_mask[2] = 0x0;
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS3_MPLS_HDR_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 3;  /* cam_id_first */
        rule_struct->cam_id_last  = 3;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS3_MPLS_HDR_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS4_HDR_MPLS1_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 4;  /* cam_id_first */
        rule_struct->cam_id_last  = 4;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS4_HDR_MPLS1_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS4_HDR_MPLS2_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 4;  /* cam_id_first */
        rule_struct->cam_id_last  = 4;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS4_HDR_MPLS2_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS4_HDR_MPLS3_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 4;  /* cam_id_first */
        rule_struct->cam_id_last  = 4;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS4_HDR_MPLS3_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS6_MPLS_GAL_ACH_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS6_MPLS_GAL_ACH_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
        ...
        /* action */
            ...
            rule_struct->camram.var_len_hdr.shift_bytes = 0;  /* shift_bytes */
            rule_struct->camram.state[0] = 0x0;
            rule_struct->camram.state[1] = 0x29;
            rule_struct->camram.state[2] = 0x0;
            rule_struct->camram.state_mask[0] = 0x0;
            rule_struct->camram.state_mask[1] = 0xff;
            rule_struct->camram.state_mask[2] = 0x0;
            rule_struct->camram.variable = 0x10000;   /* variable */
            rule_struct->camram.variable_mask = 0x10000;   /* variable_mask */
            rule_struct->camram.stream = 0;  /* stream */
            rule_struct->camram.stream_mask = 0;  /* stream_mask */
            rule_struct->camram.keep_timestamp = 0;  /* keep_timestamp */
            rule_struct->camram.keep_procreg = 0;  /* keep_procreg */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS7_MPLS_BFD_CC_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 7;  /* cam_id_first */
        rule_struct->cam_id_last  = 7;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS7_MPLS_BFD_CC_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
            rule_struct->tcam.state[0] = 0x0;
            rule_struct->tcam.state[1] = 0x29;
            rule_struct->tcam.state[2] = 0x0;
            rule_struct->tcam.state_mask[0] = 0x0;
            rule_struct->tcam.state_mask[1] = 0xff;
            rule_struct->tcam.state_mask[2] = 0x0;
        ...
        /* action */
            rule_struct->camram.hdr_type = 39;  /* hdr_type */
            rule_struct->camram.shift = 0;  /* shift */
            rule_struct->camram.var_len_hdr.units = 0;  /* units */
            rule_struct->camram.var_len_hdr.mask = 6;  /* mask */
            rule_struct->camram.var_len_hdr.shift_bits = 0;  /* shift_bits */
            rule_struct->camram.var_len_hdr.shift_bytes = 3;  /* shift_bytes */
            rule_struct->camram.state[0] = 0x0;
            rule_struct->camram.state[1] = 0x2a;
            rule_struct->camram.state[2] = 0x0;
            rule_struct->camram.state_mask[0] = 0x0;
            rule_struct->camram.state_mask[1] = 0xff;
            rule_struct->camram.state_mask[2] = 0x0;
            rule_struct->camram.variable = 0x8000;   /* variable */
            rule_struct->camram.variable_mask = 0x8000;   /* variable_mask */
            rule_struct->camram.stream = 0;  /* stream */
            rule_struct->camram.stream_mask = 0;  /* stream_mask */
            rule_struct->camram.keep_timestamp = 0;  /* keep_timestamp */
            rule_struct->camram.keep_procreg = 0;  /* keep_procreg */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS7_MPLS_BFD_CV_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 7;  /* cam_id_first */
        rule_struct->cam_id_last  = 7;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS7_MPLS_BFD_CV_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
        ...
        /* action */
            ...
            rule_struct->camram.var_len_hdr.shift_bytes = 3;  /* shift_bytes */
            rule_struct->camram.state[0] = 0x0;
            rule_struct->camram.state[1] = 0x2b;
            rule_struct->camram.state[2] = 0x0;
            rule_struct->camram.state_mask[0] = 0x0;
            rule_struct->camram.state_mask[1] = 0xff;
            rule_struct->camram.state_mask[2] = 0x0;
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS8_BFD_CC_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 8;  /* cam_id_first */
        rule_struct->cam_id_last  = 8;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS8_BFD_CC_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
            rule_struct->tcam.state[0] = 0x0;
            rule_struct->tcam.state[1] = 0x2a;
            rule_struct->tcam.state[2] = 0x0;
            rule_struct->tcam.state_mask[0] = 0x0;
            rule_struct->tcam.state_mask[1] = 0xff;
            rule_struct->tcam.state_mask[2] = 0x0;
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS8_BFD_CV_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 8;  /* cam_id_first */
        rule_struct->cam_id_last  = 8;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS8_BFD_CV_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
            rule_struct->tcam.state[0] = 0x0;
            rule_struct->tcam.state[1] = 0x2b;
            rule_struct->tcam.state[2] = 0x0;
            rule_struct->tcam.state_mask[0] = 0x0;
            rule_struct->tcam.state_mask[1] = 0xff;
            rule_struct->tcam.state_mask[2] = 0x0;
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_MPLS_ARAD_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 0;  /* cam_id_first */
        rule_struct->cam_id_last  = 0;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_MPLS_ARAD_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
        ...
        /* action */
            ...
            rule_struct->camram.var_len_hdr.shift_bytes = 0;  /* shift_bytes */
            rule_struct->camram.state[0] = 0x0;
            rule_struct->camram.state[1] = 0x89;
            rule_struct->camram.state[2] = 0x0;
            rule_struct->camram.state_mask[0] = 0x0;
            rule_struct->camram.state_mask[1] = 0xff;
            rule_struct->camram.state_mask[2] = 0x0;
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_MPLS_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 0;  /* cam_id_first */
        rule_struct->cam_id_last  = 0;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_MPLS_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_MC_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 0;  /* cam_id_first */
        rule_struct->cam_id_last  = 0;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_MC_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
        ...
        /* action */
            ...
            rule_struct->camram.state_mask[1] = 0xff;
            rule_struct->camram.state_mask[2] = 0x0;
            rule_struct->camram.variable = 0x10;   /* variable */
            rule_struct->camram.variable_mask = 0x10;   /* variable_mask */
            rule_struct->camram.stream = 0;  /* stream */
            rule_struct->camram.stream_mask = 0;  /* stream_mask */
            rule_struct->camram.keep_timestamp = 0;  /* keep_timestamp */
            rule_struct->camram.keep_procreg = 0;  /* keep_procreg */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS1_EGR_OAMUPMAC_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 1;  /* cam_id_first */
        rule_struct->cam_id_last  = 1;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS1_EGR_OAMUPMAC_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS1_EGR_MPLS_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 1;  /* cam_id_first */
        rule_struct->cam_id_last  = 1;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS1_EGR_MPLS_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
            rule_struct->tcam.state[0] = 0x0;
            rule_struct->tcam.state[1] = 0x89;
            rule_struct->tcam.state[2] = 0x0;
            rule_struct->tcam.state_mask[0] = 0x0;
            rule_struct->tcam.state_mask[1] = 0xff;
            rule_struct->tcam.state_mask[2] = 0x0;
    ...
    /*
     * PPE Cam Rule for
     *   SOC_CALADAN3_PPE_RULE_rS2_EGR_MPLS_ENTRY 
     */
    {
        soc_sbx_g3p1_ppe_rule_t  *rule_struct = &global_rule_struct; 
        sal_memset(rule_struct, 0, sizeof(soc_sbx_g3p1_ppe_rule_t));
        ...
        rule_struct->cam_id_first = 2;  /* cam_id_first */
        rule_struct->cam_id_last  = 2;  /* cam_id_last */
        rule_struct->rule_id     = SOC_CALADAN3_PPE_RULE_rS2_EGR_MPLS_ENTRY;  /* rule_id */
        rule_struct->rule_enable = 1;      /* rule_enable */
        /* filter */
            rule_struct->tcam.property = 0;  /* property */
            rule_struct->tcam.property_mask = 0;  /* property_mask */
