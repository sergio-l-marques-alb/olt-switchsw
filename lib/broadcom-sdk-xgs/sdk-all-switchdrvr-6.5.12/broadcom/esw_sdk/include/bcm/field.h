...
typedef enum bcm_field_header_format_e {
    ...
    bcmFieldHeaderFormatIp6Ip6 = 43,    /* IPv6 over IPv6 packet (headers = L2,
                                           IPv6, IPv6) */
    bcmFieldHeaderFormatCount = 44      /* Always Last. Not a usable value. */
...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyInnerIp6PktTrafficClass = 758, /* Qualifies for Traffic Class protocol
                                           field in Inner IPv6 header. */
    bcmFieldQualifyCount = 759          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_stage_e {
    ...
    bcmFieldStageCount = 14             /* Always Last. Not a usable value. */
} bcm_field_stage_t;
...
typedef enum bcm_field_ForwardingType_e {
    ...
    bcmFieldForwardingTypeCount = 24    /* Always Last. Not a usable value. */
...
typedef enum bcm_field_AppType_e {
    ...
    bcmFieldAppTypeIp4UcastRpfPublic = 39, /* IPv4 Unicast Public Routing (coupled
                                           to the RPF lookup). */
    bcmFieldAppTypeCount = 40           /* Always Last. Not a usable value. */
} bcm_field_AppType_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionErspan3HdrVlanCosPktCopy = 506, /* This action is to copy the incoming
                                           ...
                                           ERSPAN3 header. */
    bcmFieldActionErspan3HdrSgtAdd = 507, /* This action is to add the SGT
    ...
    bcmFieldActionCount = 515           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
typedef enum bcm_field_control_e {
    ...
    bcmFieldControlCount = 32           /* Always last. Not a usable value. */
} bcm_field_control_t;
...
typedef struct bcm_field_group_config_s {
    ...
    uint32 nof_programs;                /* Number of programs in the array. */
    bcm_field_context_t *program_ids;   /* Array of program-ids which the
...
typedef enum bcm_field_sys_hdr_type_e {
    ...
    bcmFieldSysHdrLastCount = 20        /* Always Last. Not a usable value. */
...
typedef struct bcm_field_presel_entry_id_s {
    uint32 presel_id;           /* ID of the preselector entry. */
...
typedef struct bcm_field_presel_entry_data_s {
    uint8 entry_valid;                  /* If set, the whole preselection entry
                                           is set as valid. */
    bcm_field_context_t program_id;     /* ID of the PMF program. */
    uint32 nof_qualifiers;              /* Number of used qualifiers for CS. */
    bcm_field_presel_qualify_data_t *qual_data; /* Array of data of the used qualifiers. */
...
typedef enum bcm_field_group_type_e {
    ...
    bcmFieldGroupTypeDirectExtraction = 3, /* Direct extraction (instead of TCAM)
                                           group. */
    bcmFieldGroupTypeHashing = 4,       /* Hash function group - no entries are
                                           expected. */
    bcmFieldGroupTypeExactMatch = 5,    /* Exact match group - partial masking
                                           is not supported. */
    bcmFieldGroupTypeStateTable = 6,    /* State Table group. */
    bcmFieldGrouptypeCount = 7          /* Always last. Not a usable value. */
...
typedef struct bcm_field_group_info_s {
    ...
    int nof_quals;                      /* Number of valid qualifiers in the
                                           Field Group. */
    bcm_field_qualify_t *qual_types;    /* BCM level qualifier look at
    ...
    int nof_actions;                    /* Number of valid actions in the action
                                           set of field group. */
    bcm_field_action_t *action_types;   /* The list of actions to be applied to
