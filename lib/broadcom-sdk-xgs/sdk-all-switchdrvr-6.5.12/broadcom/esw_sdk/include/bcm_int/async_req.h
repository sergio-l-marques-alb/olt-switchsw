...
typedef struct bcm_async_req_s {
	...
	union {
		...
		struct {
			...
			bcm_gport_t port;
			int enable;
		} cpri_port_axc_agnostic_mode_enable_set;
		struct {
			int unit;
			bcm_gport_t port;
			bcm_cpri_agnostic_config_t * config;
		} cpri_port_axc_agnostic_mode_set;
		struct {
			int unit;
			int port;
		...
		struct {
			...
			bcm_gport_t port;
			int queue_num;
		} cpri_port_encap_clear;
		struct {
			int unit;
			bcm_gport_t port;
		} cpri_port_encap_clear_all;
		struct {
			int unit;
			bcm_gport_t port;
			int queue_num;
		...
		struct {
			...
			bcm_gport_t port;
			int index;
		} cpri_port_encap_roe_ordering_info_clear;
		struct {
			int unit;
			bcm_gport_t port;
			int index;
		...
		} cpri_port_rsvd4_rx_control_config_set;
		struct {
			int unit;
			int port;
			int control_flow_id;
		...
		} cpri_port_rsvd4_rx_tag_gen_entry_add;
		struct {
			int unit;
			int port;
			int index;
			bcm_cpri_tag_gen_entry_t * config;
		} cpri_port_rsvd4_rx_tag_gen_entry_delete;
		struct {
			int unit;
			bcm_gport_t port;
			int index;
		...
		} cpri_port_rx_cw_l1_signal_info_get;
		struct {
			int unit;
			int port;
			uint32 signal_map;
		...
		} cpri_port_rx_cw_vsd_ctrl_flow_config_get;
		struct {
			int unit;
			int port;
			uint16 group_id;
			bcm_cpri_rx_vsd_flow_info_t * config;
		} cpri_port_rx_cw_vsd_ctrl_flow_config_set;
		struct {
			int unit;
			int port;
			uint8 vsd_raw_id;
		...
		struct {
			...
			int port;
			uint8 enable;
		} cpri_port_rx_fec_descramble_bypass_set;
		struct {
			int unit;
			int port;
			uint8 enable;
		} cpri_port_rx_fec_enable_set;
		struct {
			int unit;
			int port;
			uint8 enable;
		} cpri_port_rx_fec_soft_reset_set;
		struct {
			int unit;
			int port;
			bcm_cpri_fec_tick_config_t * config;
		} cpri_port_rx_fec_tick_set;
		struct {
			int unit;
			int port;
			bcm_cpri_fec_timestamp_config_t * config;
		} cpri_port_rx_fec_timestamp_config_set;
		struct {
			int unit;
			bcm_gport_t port;
		...
		} cpri_port_tx_cw_vsd_ctrl_flow_config_set;
		struct {
			int unit;
			int port;
		...
		struct {
			...
			bcm_gport_t port;
			int enable;
		} cpri_port_tx_frame_tgen_enable;
		struct {
			int unit;
			bcm_gport_t port;
			bcm_cpri_port_type_t * port_type;
	...
	/* bcm_module_name has a non int return type */
		...
		} multicast_encap_extension_add;
		struct {
			int unit;
			uint32 flags;
			bcm_if_t encap_id;
		} multicast_encap_extension_delete;
		struct {
			int unit;
		...
		} stat_counter_engine_enable_get;
		struct {
			int unit;
			uint32 flags;
			bcm_stat_engine_t * engine;
			bcm_stat_engine_enable_t * enable;
		} stat_counter_engine_enable_set;
		struct {
			int unit;
			uint32 flags;
			bcm_stat_engine_t * engine;
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_AXC_AGNOSTIC_MODE_ENABLE_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_AXC_AGNOSTIC_MODE_SET,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_ENCAP_CLEAR,
	BCM_ASYNC_ENTRY_CPRI_PORT_ENCAP_CLEAR_ALL,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_ENCAP_ROE_ORDERING_INFO_CLEAR,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_RSVD4_RX_CONTROL_CONFIG_SET,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_RSVD4_RX_TAG_GEN_ENTRY_ADD,
	BCM_ASYNC_ENTRY_CPRI_PORT_RSVD4_RX_TAG_GEN_ENTRY_DELETE,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_CW_L1_SIGNAL_INFO_GET,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_CW_VSD_CTRL_FLOW_CONFIG_GET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_CW_VSD_CTRL_FLOW_CONFIG_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_CW_VSD_RAW_CONFIG_GET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_CW_VSD_RAW_CONFIG_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_FEC_DESCRAMBLE_BYPASS_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_FEC_ENABLE_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_FEC_SOFT_RESET_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_FEC_TICK_SET,
	BCM_ASYNC_ENTRY_CPRI_PORT_RX_FEC_TIMESTAMP_CONFIG_SET,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_STAGE_ACTIVATE,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_TX_CW_L1_CONFIG_SET,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_TX_CW_VSD_CTRL_FLOW_CONFIG_SET,
	...
	BCM_ASYNC_ENTRY_CPRI_PORT_TX_FRAME_TGEN_ENABLE,
	BCM_ASYNC_ENTRY_CPRI_PORT_TX_SPEED_GET,
	BCM_ASYNC_ENTRY_CPRI_PORT_TX_SPEED_SET,
	BCM_ASYNC_ENTRY_CPRI_RX_TAG_CONFIG_SET,
	...
	BCM_ASYNC_ENTRY_MULTICAST_ENCAP_EXTENSION_ADD,
	BCM_ASYNC_ENTRY_MULTICAST_ENCAP_EXTENSION_DELETE,
	...
	BCM_ASYNC_ENTRY_PORT_ILKN_LANE_ID_MAP_GET,
	BCM_ASYNC_ENTRY_PORT_ILKN_LANE_ID_MAP_SET,
	...
	BCM_ASYNC_ENTRY_STAT_COUNTER_ENGINE_ENABLE_GET,
	BCM_ASYNC_ENTRY_STAT_COUNTER_ENGINE_ENABLE_SET,
	...
	BCM_ASYNC_ENTRY_XFLOW_MACSEC_SUBPORT_NUM_GET,
