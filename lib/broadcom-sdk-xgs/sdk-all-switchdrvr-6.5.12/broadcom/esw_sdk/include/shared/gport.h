...
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_FLOW_PORT   /* Used for sanity */
                                                /*
                                                 * checks only.  
                                                 */
 /*
...
#define _SHR_COSQ_GPORT_RCY_SET(_gport)                                 \
        ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |         \
...
#define _SHR_COSQ_GPORT_RCY_MIRR_SET(_gport)                                 \
        ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |         \
...
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM                (4)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT (5)

/**
 * \brief
 *  Used to hold logical gports that are actually handles to data stored in SW.
 */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL                     6
...
#define _SHR_GPORT_SUB_TYPE_VLAN_TRANSLATION_MASK             _SHR_GPORT_SUB_TYPE_LIF_MASK
...
/* SUB GPORT VIRTUAL ESEM */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_SHIFT             (0)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_MASK       (0x3FFFFF)

/* SUB GPORT VIRTUAL EGRESS_PORT_DEFAULT */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_SHIFT      (0)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_MASK    (0xFF)

/* SUB GPORT VIRTUAL */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_SHIFT               0
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_MASK        ((1<<(_SHR_GPORT_SUB_TYPE_SHIFT))-1)
...
#define _SHR_GPORT_SUB_TYPE_IS_VLAN_TRANSLATION(_gport)             \
...
/* given gport return if this is Virtual ESEM subtype */
#define _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_ESEM(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM)

/* given gport return if this is Virtual Egress Port Default subtype */
#define _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_EGRESS_PORT_DEFAULT(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT)

/* given gport return if the sub-type is Virtual */
#define _SHR_GPORT_SUB_TYPE_IS_VIRTUAL(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_VIRTUAL)
...
#define _SHR_GPORT_SUB_TYPE_VLAN_TRANSLATION_GET(_gport) \
...
/* Get GPORT subvalue of subtype Virtual ESEM */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_SHIFT) & _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_MASK):-1)

/* Get GPORT subvalue of subtype Virtual Egress Port Default */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_SHIFT) & _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_MASK):-1)

/* Get GPORT value of subtype Virtual */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_VIRTUAL) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_VIRTUAL_SHIFT) & _SHR_GPORT_SUB_TYPE_VIRTUAL_MASK):-1)
...
#define _SHR_GPORT_SUB_TYPE_VLAN_TRANSLATION_SET(_gport, _vlan_translation_val) \
...
/* Set GPORT subvalue and subtype Virtual ESEM */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_SET(_gport, _virtual_esem_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
      (((_virtual_esem_val) & _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_MASK) << _SHR_GPORT_SUB_TYPE_VIRTUAL_ESEM_SHIFT))

/* Set GPORT subvalue and subtype Virtual Egress Port Default */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_SET(_gport, _virtual_egress_port_default_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
      (((_virtual_egress_port_default_val) & _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_MASK) << _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_PORT_DEFAULT_SHIFT))

/* Set GPORT subvalue and subtype Virtual ESEM */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_SET(_gport, _virtual_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_VIRTUAL << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
      (((_virtual_val) & _SHR_GPORT_SUB_TYPE_VIRTUAL_MASK) << _SHR_GPORT_SUB_TYPE_VIRTUAL_SHIFT))
...
#define _SHR_GPORT_TUNNEL_TO_L3_ITF_LIF(_l3_itf_lif , _gport_tunnel)    \
   do { \
      ...
      if (_SHR_GPORT_IS_TUNNEL(_gport_tunnel)) {   \
         __gport_tunnel_val = _SHR_GPORT_TUNNEL_ID_GET(_gport_tunnel); \
