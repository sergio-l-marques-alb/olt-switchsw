...
typedef struct soc_dnxf_queues_dch_info_s {    /*A Links 0-7, B Links 8-15, C Links 16-23*/
...
typedef struct soc_dnxf_queues_dch_s{
    soc_dnxf_queues_dch_info_t    nof_dch[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_DCH];     /*for each DCH, save the above info*/     
...
shr_error_e soc_dnxf_diag_temperature_monitor_get(int unit, int temperature_max, soc_switch_temperature_monitor_t *temperature_array, int *temperature_count);
