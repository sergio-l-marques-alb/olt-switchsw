/*
 * $Id: sw_state_hash_table.h,v 1.5 Broadcom SDK
 * $
...
/********** HASH TABLE MACROS ****************/
/**********************************************/
#define SW_STATE_HTB_CREATE(module_id, htb, init_info, key_type, value_type, is_index) \
    SHR_IF_ERR_EXIT(sw_state_hash_table_create(unit, module_id, &htb, init_info, sizeof(key_type), sizeof(value_type), is_index))
...
#define SW_STATE_HTB_PRINT(module_id, htb) \
    SHR_IF_ERR_EXIT(sw_state_htb_print(unit, htb))

#define SW_STATE_HTB_DEFAULT_PRINT(unit, htb) \
    sw_state_htb_print(unit, *(htb))
