 ...
 * It is used to decide the size of L3_ECMP memories that are available for first ECMP lookup. Internally, the size rounds up to multiple of 4096.
 */
...
/*
 * enable flow tracker embedded app
