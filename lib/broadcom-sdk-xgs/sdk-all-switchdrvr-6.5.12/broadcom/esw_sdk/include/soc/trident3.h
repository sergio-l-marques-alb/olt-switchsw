/*
 * $Id: trident3.h,v 1.1.10.3 Broadcom SDK $
...
#define _TD3_TDM_SPEED_CLASS_MAX                4
...
extern uint32   soc_td3_exact_match_bank_entry_hash(int unit, int bank,
                                                   uint32 *entry);
extern uint32   soc_td3_mpls_hash(int unit, int bank, int hash_offset, int use_lsb,
                                  int key_nbits, void *base_entry, uint8 *key1, uint8 *key2);
extern int      soc_td3_mpls_base_entry_to_key(int unit, int bank, void *entry,
                                              uint8 *key);
extern uint32   soc_td3_mpls_entry_hash(int unit, int bank, int hash_offset,
                                        int use_lsb, uint32 *entry);
extern uint32   soc_td3_mpls_bank_entry_hash(int unit, int bank, uint32 *entry);
