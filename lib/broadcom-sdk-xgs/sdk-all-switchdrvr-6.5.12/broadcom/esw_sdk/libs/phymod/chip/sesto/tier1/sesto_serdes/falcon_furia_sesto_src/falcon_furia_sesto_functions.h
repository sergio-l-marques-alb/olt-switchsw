/***********************************************************************************
 ***********************************************************************************
 *  File Name     :  falcon_furia_functions.h                                        *
 *  Created On    :  29/04/2013                                                    *
 *  Created By    :  Kiran Divakar                                                 *
 *  Description   :  Header file with API functions for Serdes IPs                 *
 *  Revision      :  $Id: falcon_furia_functions.h 844 2015-01-12 20:58:16Z kirand $ *
 *                                                                                 *
...
/** @file falcon_furia_functions.h
 * Protoypes of all API functions for engineering use 
 */

#ifndef FALCON_FURIA_API_FUNCTIONS_H
#define FALCON_FURIA_API_FUNCTIONS_H
...
/* RAM access */
#include "falcon_sesto_api_uc_vars_rdwr_defns.h"

/* Reg access */


      #include "falcon_furia_sesto_fields.h"


#define FALCON_FURIA_DIAG_MAX_SAMPLES (64)
...
typedef struct {
    ...
    uint8_t tx_rx;
}falcon_furia_sesto_osr_mode_define_st;
...
typedef struct {
       ...
       uint16_t link_time;
       /** OSR Mode */
       falcon_furia_sesto_osr_mode_define_st osr_mode;
       /** Signal Detect */
       uint8_t sig_det;
       /** PMD RX Lock */
       uint8_t rx_lock;
       ...
       uint8_t br_pd_en;
} falcon_furia_sesto_lane_state_define_st;
