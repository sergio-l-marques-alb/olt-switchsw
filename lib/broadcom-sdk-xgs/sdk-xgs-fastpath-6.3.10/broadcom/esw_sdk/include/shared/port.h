...
typedef enum _shr_port_phy_control_e {
    ...
    _SHR_PORT_PHY_CONTROL_MICRO_ALIVE,
    _SHR_PORT_PHY_CONTROL_MOD_AUTO_DETECT_ENABLE,
    _SHR_PORT_PHY_CONTROL_DIGITAL_TEMP,
    _SHR_PORT_PHY_CONTROL_ANALOG_TEMP,
...
typedef enum _shr_port_pcs_e {
    _SHR_PORT_PCS_8B9BLFEC,
	_SHR_PORT_PCS_8B10B,
	_SHR_PORT_PCS_64B66BFEC,
	_SHR_PORT_PCS_64B66BBEC,
	_SHR_PORT_PCS_64B66B
} _shr_port_pcs_t;
