/*
 * $Id: triumph3.h,v 1.84.2.2 Broadcom SDK $
...
extern void soc_tr3_ser_fail(int unit);
...
extern int soc_tr3_hsp_set_sched_config(int unit, soc_port_t port,
                                        soc_tr3_sched_mode_e mode);
extern int soc_tr3_hsp_get_sched_config(int unit, soc_port_t port,
                                        soc_tr3_sched_mode_e *mode);
