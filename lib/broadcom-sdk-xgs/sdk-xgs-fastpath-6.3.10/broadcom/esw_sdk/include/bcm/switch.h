...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchL3RoutedLearn,             /* enable L2 learning for routed
                                           packets. */
    bcmSwitchSubportPktTagEthertype,    /* Set ethertype field in LLTAG */
    bcmSwitchSubportPktTagToCpu,        /* LLTAG present to CPU */
    bcmSwitchNonSubportPktTagToCpu,     /* LLTAG not present to CPU */
    bcmSwitchHashL2GreKeyMask0,         /* Set the mask which is AND-ed with
                                           hash L2GRE key before hash generation
                                           for hash A */
    bcmSwitchHashL2GreKeyMask1,         /* Set the mask which is AND-ed with
                                           hash L2GRE key before hash generation
                                           for hash B */
    bcmSwitchL3Max128BV6Entries,        /* Max number of Number of 128B LPM
                                           entries. */
    bcmSwitchEEEQueueThresholdProfile0, /* Set EEE BB mode queue depth threshold
                                           Profile 0 */
    bcmSwitchEEEQueueThresholdProfile1, /* Set EEE BB mode queue depth threshold
                                           Profile 1 */
    bcmSwitchEEEQueueThresholdProfile2, /* Set EEE BB mode queue depth threshold
                                           Profile 2 */
    bcmSwitchEEEQueueThresholdProfile3, /* Set EEE BB mode queue depth threshold
                                           Profile 3 */
    bcmSwitchEEEPacketLatencyProfile0,  /* Set EEE BB mode packet max latency
                                           Profile 0 */
    bcmSwitchEEEPacketLatencyProfile1,  /* Set EEE BB mode packet max latency
                                           Profile 1 */
    bcmSwitchEEEPacketLatencyProfile2,  /* Set EEE BB mode packet max latency
                                           Profile 2 */
    bcmSwitchEEEPacketLatencyProfile3,  /* Set EEE BB mode packet max latency
                                           Profile 3 */
    bcmSwitchDosAttackV6MinFragEnable,  /* Enable Min pkt size check for
                                           fragmented IPv6. */
    bcmSwitchDosAttackV6MinFragSize,    /* Min pkt size for fragmented IPv6
                                           check. */
    bcmSwitchMirrorUnicastCosq,         /* Unicast mirror COS. */
    bcmSwitchMirrorMulticastCosq,       /* Multicast mirror COS. */
    bcmSwitchMcQueueSchedMode,          /* Schedule mode select for multicast
                                           queues. */
    bcmSwitchReserved872 = 872,         /* Reserved. */
    bcmSwitchReserved873 = 873,         /* Reserved. */
    ...
    bcmSwitchReserved881 = 881,         /* Reserved. */
    bcmSwitchReserved882 = 882,         /* Reserved. */
    bcmSwitchReserved883 = 883,         /* Reserved. */
    bcmSwitchReserved884 = 884,         /* Reserved. */
    bcmSwitchReserved885 = 885,         /* Reserved. */
    ...
    bcmSwitchMplsPipeTunnelLabelExpSet = 889, /* If set, MPLS pipe modes is supported
                                           ...
                                           label. Default is 0. */
    bcmSwitchReserved890 = 890,         /* Reserved. */
    ...
    bcmSwitchHashIPSecSelect1 = 901,    /* Set hash control to select outer
                                           L4_SRC/DST_PORT or IPSec SPI for hash
                                           block B. */
    bcmSwitchTimesyncEgressTimestampingMode = 902, /* Selects 32bit or 48bit timestamping
                                           mode for 1588 packets. */
    bcmSwitchSynchronousPortClockSourceValid = 903, /* Returns whether synchronous clock can
                                           be sucessfully recovered from the
                                           port, configured via 
                                           bcmSwitchSynchronousPortClockSource */
    bcmSwitchSynchronousPortClockSourceBkupValid = 904, /* Returns whether synchronous clock is
                                           successfully recovered from the back
                                           up port, configured via 
                                           bcmSwitchSynchronousPortClockSourceBkup */
    bcmSwitchRemoteProtectionEnable = 905, /* Set the Protection Status bit in
                                           HiGig Header */
    bcmSwitchReserved906 = 906,         /* RESERVED */
    bcmSwitchReserved907 = 907,         /* RESERVED */
    bcmSwitchReserved908 = 908,         /* RESERVED */
    bcmSwitchReserved909 = 909,         /* RESERVED */
    bcmSwitchReserved910 = 910,         /* RESERVED */
    bcmSwitchReserved911 = 911,         /* RESERVED */
    ...
    bcmSwitchMacroFlowHashUseMSB = 914, /* If enable, use MSB for Macroflow
                                           based hashing */
    bcmSwitch__Count = 915              /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_l2_location_e {
    bcmSwitchL2LocInternal, /* L2 addresses will be learnt on Internal TCAM */
    bcmSwitchL2LocExternal, /* L2 addresses will be learnt on External TCAM */
    bcmSwitchL2LocIntAndExt /* L2 addresses are learnt either on internal or
                               external Tcam */
...
typedef enum bcm_switch_hash_field_e {
    bcmSwitchFlexHashField0,    /* field 0 in flexible hash RAM table */
    bcmSwitchFlexHashField1,    /* field 1 in flexible hash RAM table */
    bcmSwitchFlexHashFieldCount /* field count in flexible hash RAM table */
...
typedef enum bcm_switch_control_mc_queue_config_mode_e {
    bcmSwitchMcUcPairGroupMode, /* Each MC queue is paired with one UC queue */
    bcmSwitchAllMcGroupMode     /* All MC queues are grouped together */
} bcm_switch_control_mc_queue_config_mode_t;

/* Global TPID type. */
typedef enum bcm_switch_tpid_type_e {
    bcmTpidTypeOuter,   /* Global Outer TPID */
    bcmTpidTypeInner,   /* Global Inner TPID */
    bcmTpidTypeVntag,   /* Global TPID for Vntag */
    bcmTpidTypeEtag     /* Global TPID for Etag */
