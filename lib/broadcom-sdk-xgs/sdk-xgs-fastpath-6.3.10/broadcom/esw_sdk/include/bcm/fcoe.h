...
#define BCM_FCOE_VSAN_CONFIG_NORMALIZED_ZONE_CHECK 0x00000001 /* Normalized zone check */
...
typedef enum bcm_fcoe_zone_action_e {
    ...
    bcmFcoeZoneActionCopyToCpu, /* Copy-to-CPU packets matching the zone check */
    bcmFcoeZoneActionRedirect   /* redirect port to given port */
...
typedef enum bcm_fcoe_fc_header_type_e {
    bcmFcoeFcHeaderTypeNone,    /* No header */
    bcmFcoeFcHeaderTypeStd,     /* Standard header */
    bcmFcoeFcHeaderTypeEncap,   /* Encapsulated header */
    bcmFcoeFcHeaderTypeVft,     /* VFT header */
    bcmFcoeFcHeaderTypeIfr,     /* IFR Header */
    bcmFcoeFcHeaderTypeUnknown, /* Unknown Header */
    bcmFcoeFcHeaderTypeCount 
...
typedef enum bcm_fcoe_vsan_stat_e {
    bcmFcoeVsanInPackets,   /* Packets that ingress on fcoe vsan */
    bcmFcoeVsanInBytes      /* Bytes that ingress on fcoe vsan */
...
typedef enum bcm_fcoe_route_stat_e {
    bcmFcoeRouteInPackets,  /* Packets that ingress on fcoe route */
    bcmFcoeRouteInBytes     /* Bytes that ingress on fcoe route */
...
typedef enum bcm_fcoe_intf_vsan_id_source_e {
    bcmFcoeIntfVsanSet,         /* Get VSAN ID from table entry */
    bcmFcoeIntfVsanInternal,    /* Get VSAN ID from internal VSAN ID */
    bcmFcoeIntfVsanInnerVlan,   /* Get VSAN ID from internal ITAG */
    bcmFcoeIntfVsanOuterVlan    /* Get VSAN ID from internal OVID */
} bcm_fcoe_intf_vsan_id_source_t;

/* FCOE Interface VSAN Priority source */
typedef enum bcm_fcoe_intf_vsan_pri_source_e {
    bcmFcoeIntfVsanPriSet,      /* Use VSAN PRI from table entry */
    bcmFcoeIntfVsanPriInternal, /* Get VSAN PRI from internal VSAN PRI */
    bcmFcoeIntfVsanPriRemark    /* Get VSAN PRI from internal PRI */
...
typedef enum bcm_fcoe_vsan_action_e {
    bcmFcoeVsanActionNone,      /* Do not modify */
    bcmFcoeVsanActionInnerVlan, /* Use Inner Vlan's value */
    bcmFcoeVsanActionOuterVlan, /* Use Outer Vlan's value */
    bcmFcoeVsanActionReplace,   /* Replace with specified value */
    bcmFcoeVsanActionDelete,    /* Delete */
    bcmFcoeVsanActionInternal,  /* Replace with Internal value */
    bcmFcoeVsanActionCount 
