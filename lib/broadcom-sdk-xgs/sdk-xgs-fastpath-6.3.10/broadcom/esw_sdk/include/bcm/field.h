...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyMirrorEgressDisabled = 338, /*  Reserved. */
    bcmFieldQualifyBypassSrcMacFilter = 339, /*  Reserved. */
    bcmFieldQualifyRxTrapCodeForSnoop = 340, /*  Reserved. */
    bcmFieldQualifyIpmcStarGroupValue = 341, /*  Reserved. */
    bcmFieldQualifyNativeVSwitch = 342, /*  Reserved. */
    bcmFieldQualifyNativeVSwitchValid = 343, /*  Reserved. */
    bcmFieldQualifyTrillIVersion = 344, /*  Reserved. */
    bcmFieldQualifyTrillIngressRbridge = 345, /*  Reserved. */
    bcmFieldQualifyTrillMultiDestination = 346, /*  Reserved. */
    bcmFieldQualifyTrillOpLength = 347, /*  Reserved. */
    bcmFieldQualifyTrillHopCount = 348, /*  Reserved. */
    bcmFieldQualifyTrillPayload = 349,  /*  Reserved. */
    bcmFieldQualifyMplsForwardingLabelPayload = 350, /*  Reserved. */
    bcmFieldQualifyIncomingIpIfClass = 351, /*  Reserved. */
    bcmFieldQualifyL2GreProtocolType = 352, /*  Reserved. */
    bcmFieldQualifyL2GreVsid = 353,     /*  Reserved. */
    bcmFieldQualifyL2GreFlowId = 354,   /*  Reserved. */
    bcmFieldQualifyMimVlanPri = 355,    /*  Reserved. */
    bcmFieldQualifyMimVlanCfi = 356,    /*  Reserved. */
    bcmFieldQualifyFhei = 357,          /*  DNX FHEI header field. */
    bcmFieldQualifyFheiSize = 358,      /*  DNX FHEI header size in bytes. */
    bcmFieldQualifyEthernetOamHeaderBits0_31 = 359, /*  Reserved */
    bcmFieldQualifyEthernetOamHeaderBits32_63 = 360, /*  Reserved */
    bcmFieldQualifyEthernetOamDstClassL2 = 361, /*  Reserved */
    bcmFieldQualifyEthernetOamTxPktUPMEP = 362, /*  Reserved */
    bcmFieldQualifyEthernetOamSrcPortLmStatPoolId = 363, /*  Reserved */
    bcmFieldQualifyEthernetOamVxlt1LmStatPoolId = 364, /*  Reserved */
    bcmFieldQualifyEthernetOamVxlt2LmStatPoolId = 365, /*  Reserved */
    bcmFieldQualifyEthernetOamSourceVPLmStatPoolId = 366, /*  Reserved */
    bcmFieldQualifyEthernetOamInterfaceClassPort = 367, /*  Reserved */
    bcmFieldQualifyEthernetOamClassVxlt1 = 368, /*  Reserved */
    bcmFieldQualifyEthernetOamClassVxlt2 = 369, /*  Reserved */
    bcmFieldQualifyEthernetOamClassSourceVP = 370, /*  Reserved */
    bcmFieldQualifyEthernetOamClassVFI = 371, /*  Reserved */
    bcmFieldQualifyMplsOamHeaderBits0_31 = 372, /*  Reserved */
    bcmFieldQualifyMplsOamHeaderBits32_63 = 373, /*  Reserved */
    bcmFieldQualifyMplsOamGALLabelOnly = 374, /*  Reserved */
    bcmFieldQualifyMplsOamLmStatPoolId = 375, /*  Reserved */
    bcmFieldQualifyMplsOamGALExposed = 376, /*  Reserved */
    bcmFieldQualifyMplsOamACH = 377,    /*  Reserved */
    bcmFieldQualifyMplsOamControlPktType = 378, /*  Reserved */
    bcmFieldQualifyMplsOamClassMpls = 379, /*  Reserved */
    bcmFieldQualifyOamHeaderBits0_31 = 380, /*  Reserved */
    bcmFieldQualifyOamHeaderBits32_63 = 381, /*  Reserved */
    bcmFieldQualifyOamEgressClassVxlt = 382, /*  Reserved */
    bcmFieldQualifyOamEgressClassPort = 383, /*  Reserved */
    bcmFieldQualifyUdf = 384,           /*  Qualify UDF selected data. */
    bcmFieldQualifyOuterVlanActionRange = 385, /*  Reserved */
    bcmFieldQualifyInnerVlanActionRange = 386, /*  Reserved */
    bcmFieldQualifyIngressInterfaceClassVPort = 387, /*  Class Id assigned for packet based
                                           on Ingress GPort */
    bcmFieldQualifySrcVlanGport = 388,  /* Qualify Source Vlan Gport */
    bcmFieldQualifyDstVlanGport = 389,  /* Qualify Destination Vlan Gport */
    bcmFieldQualifyOamType = 390,       /*  Reserved. */
    ...
    bcmFieldQualifyCount = 421          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionOam,                  /* It comprises several fields that are
