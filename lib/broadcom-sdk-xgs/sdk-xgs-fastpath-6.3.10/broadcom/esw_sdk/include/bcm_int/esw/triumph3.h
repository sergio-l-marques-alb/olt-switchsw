/*
 * $Id: triumph3.h,v 1.120 Broadcom SDK $
...
extern int bcm_tr3_l2gre_match_vpnid_entry_reset(int unit, uint32 vpnid);
...
extern int bcm_tr3_l2gre_trunk_member_delete(int unit, bcm_trunk_t trunk_id, 
                                             int trunk_member_count, bcm_port_t *trunk_member_array); 
extern int bcm_tr3_l2gre_port_learn_set(int unit, bcm_gport_t l2gre_port_id, uint32 flags);
extern int bcm_tr3_l2gre_port_learn_get(int unit, bcm_gport_t l2gre_port_id, uint32 *flags);
