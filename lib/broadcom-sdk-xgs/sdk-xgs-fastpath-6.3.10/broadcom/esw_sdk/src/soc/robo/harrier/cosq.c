    ...
    uint32 mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_mode_set: \
    ...
    uint32 *mode)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_mode_get: \
...
drv_harrier_queue_count_set(int unit, uint32 port_type, uint8 count)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_count_set: \
...
drv_harrier_queue_count_get(int unit, uint32 port_type, uint8 *count)
{
    ...
    *count = (num_q + 1);
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_count_get: \
        unit %d, port type = %d, queue count = %d\n", unit, port_type, *count);
    ...
    soc_pbmp_t bmp, uint8 queue, uint32 weight)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_WRR_weight_set: \
    ...
    uint32 port, uint8 queue, uint32 *weight)
{
    ...
    *weight = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_WRR_weight_get: \
    ...
    uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_prio_set: \
    ...
    uint8 *queue_n)
{
    ...
    *queue_n = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_prio_get: \
        unit %d, port = %d, priority = %d, queue = %d\n", 
        unit, port, prio, *queue_n);
...
drv_harrier_queue_dfsv_set(int unit, uint8 code_point, uint8 queue_n)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_dfsv_set: \
...
drv_harrier_queue_dfsv_get(int unit, uint8 code_point, uint8 *queue_n)
{
    ...
    *queue_n = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_dfsv_get: \
        unit %d, dscp value = %d, queue = %d\n", unit, code_point, *queue_n);
    ...
    uint32 mapping_type, uint8 state)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_mapping_type_set: \
    ...
    uint32 mapping_type, uint8 *state)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_mapping_type_get: \
...
drv_harrier_queue_rx_reason_set(int unit, uint8 reason, uint32 queue)
{
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_rx_reason_set: \
...
drv_harrier_queue_rx_reason_get(int unit, uint8 reason, uint32 *queue)
{
    ...
    *queue = temp;
    ...
    soc_cm_debug(DK_VERBOSE, "drv_harrier_queue_rx_reason_get: \
        unit %d, reason = %d, *queue = %d\n", unit, reason, *queue);
