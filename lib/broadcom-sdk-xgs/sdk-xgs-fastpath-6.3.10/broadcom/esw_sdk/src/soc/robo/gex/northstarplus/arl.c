        ...
        uint32 type, int value)
{
    ...
    soc_cm_debug(DK_ARL, "%s,%d: port=%d,type=%d,value=%d\n",
        ...
        */
        ...
        if ((temp & _NSP_LEARN_LIMIT_PBMP_ALL) & (1 << port)) {
            ...
            if (sys_counter >= limit) {
                soc_cm_debug(DK_ARL, "%s,%d,rach System Learn LIMIT!!\n",
            ...
            if (port_counter >= limit) {
                soc_cm_debug(DK_ARL, "%s,%d,rach Port %d Learn LIMIT!!\n",
        ...
        uint32 type, int *value)
{
    ...
    soc_cm_debug(DK_ARL, "%s,%d: port=%d,type=%d\n",
