/*
 * $Id: phyctrl.c,v 1.148.12.6 Broadcom SDK $
...
soc_phyctrl_software_deinit(int unit)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_software_deinit: unit %d\n", unit);
...
soc_phyctrl_software_init(int unit)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_software_init: unit %d\n", unit);
...
soc_phyctrl_software_port_init(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_software_port_init: "
                         "unit %d, port %d\n", unit, port);
    ...
    PHYCTRL_DEBUG((DK_PHY | DK_VERBOSE, 
                 "soc_phyctrl_software_port_init Unit %d Port %d\n",
                      unit, port));
...
soc_phyctrl_drv_name_get(int unit, soc_port_t port, char *name, int len)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_drv_name_get: "
...
soc_phyctrl_probe(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_probe: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_init(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_init: "
                         "unit %d, port %d\n", unit, port);
   ...
   if (SOC_IS_KATANA2(unit)) {
       ...
       if ((port == KT2_OLP_PORT) &&  (SOC_INFO(unit).olp_port)) {
            soc_phyctrl_auto_negotiate_set(unit, port, 0);
    ...
    if (switchmacsec_attached) {
        ...
        if (!SOC_SUCCESS(rv)) {
            soc_cm_debug(DK_ERR, 
                    "%s: Switch-MACSEC Init failed!u=%d p=%d rv=%d\n", 
...
soc_phyctrl_reset(int unit, soc_port_t port, void *user_arg)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_reset: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_drv_name(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_drv_name: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_link_get(int unit, soc_port_t port, int *link)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_link_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_linkfault_get(int unit, soc_port_t port, int *fault)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_linkfault_get: "
                         "unit %d, port %d\n", unit, port);
    ...
    *fault = FALSE;
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN, "soc_phyctrl_linkfault_get failed %d\n", rv));
    }
...
soc_phyctrl_enable_set(int unit, soc_port_t port, int enable)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_enable_set: "
    ...
    if (SOC_FAILURE(rv1) || SOC_FAILURE(rv2)) {
        PHYCTRL_DEBUG((DK_WARN, 
                      "soc_phyctrl_enable_set: u=%d p=%d e=%d rv1=%d rv2=%d\n",
...
soc_phyctrl_enable_get(int unit, soc_port_t port, int *enable)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_enable_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_duplex_set(int unit, soc_port_t port, int duplex)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_duplex_set: "
...
soc_phyctrl_duplex_get(int unit, soc_port_t port, int *duplex)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_duplex_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_speed_set(int unit, soc_port_t port, int speed)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_speed_set: "
...
soc_phyctrl_speed_get(int unit, soc_port_t port, int *speed)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_speed_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_master_set(int unit, soc_port_t port, int master)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_master_set: "
...
soc_phyctrl_master_get(int unit, soc_port_t port, int *master)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_master_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_auto_negotiate_set(int unit, soc_port_t port, int an)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_auto_negotiate_set: "
                         "unit %d, port %d, an %d\n", unit, port, an);
                                        ...
                                        int phy_lane, int sys_side, int an)
{
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
            "soc_phyctrl_redirect_auto_negotiate_set failed: u=%d p=%d an=%d rv=%d\n",
                         unit, port, an, rv));
    }
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
                    "soc_phyctrl_redirect_auto_negotiate_set: u=%d p=%d an=%d rv=%d\n", 
                     unit, port, an, rv));
    }
...
soc_phyctrl_auto_negotiate_get(int unit, soc_port_t port, int *an, int *an_done)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_auto_negotiate_get: "
                         "unit %d, port %d\n", 
                 unit, port);
                                        ...
                                        int *an_done)
{
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
            "soc_phyctrl_redirect_control_get failed: u=%d p=%d c=%d rv=%d\n",
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN, 
                       "soc_phyctrl_redirect_auto_negotiate_get failed %d\n", 
                       rv));
    }
...
soc_phyctrl_adv_local_set(int unit, soc_port_t port, soc_port_mode_t mode)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_adv_local_set: "
...
soc_phyctrl_adv_local_get(int unit, soc_port_t port, soc_port_mode_t *mode)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_adv_local_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_adv_remote_get(int unit, soc_port_t port, soc_port_mode_t *mode)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_adv_remote_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_loopback_set(int unit, soc_port_t port, int enable, int serdes_linkup_wait)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_loopback_set: "
                         "unit %d, port %d, enable %d\n", unit, port, enable);
                                  ...
                                  int serdes_linkup_wait)
{
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
            "soc_phyctrl_redirect_control_set failed: u=%d p=%d c=%d rv=%d\n",
             unit, port, phy_ctrl, rv));
    }
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN, 
                      "soc_phyctrl_redirect_loopback_set: u=%d p=%d l=%d rv=%d\n",
                      unit, port, enable, rv));
    }
                                  ...
                                  int serdes_linkup_wait, uint32 en_int_phy)
{
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
                      "soc_phyctrl_loopback_extended_set: u=%d p=%d l=%d rv=%d\n",
                      unit, port, enable, rv));
    }
...
soc_phyctrl_loopback_get(int unit, soc_port_t port, int *enable)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_loopback_get: "
                         "unit %d, port %d\n", unit, port);
                                  ...
                                  int phy_lane, int sys_side, int *enable)
{
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
            "soc_phyctrl_redirect_loopback_get failed: u=%d p=%d c=%d rv=%d\n",
                         unit, port, phy_ctrl, rv));
    }
    ...
    INT_MCU_UNLOCK(unit);
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN, "soc_phyctrl_redirect_loopback_get failed %d\n", rv));
    }
    return rv;
}
...
soc_phyctrl_interface_set(int unit, soc_port_t port, soc_port_if_t pif)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_interface_set: "
                         "unit %d, port %d, pif %d\n", unit, port, pif);
...
soc_phyctrl_interface_get(int unit, soc_port_t port, soc_port_if_t *pif)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_interface_get: "
                         "unit %d, port %d\n", unit, port);
                         ...
                         phy_driver_t *pd, soc_port_mode_t *mode)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phy_ability_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_ability_get(int unit, soc_port_t port, soc_port_mode_t *mode)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_ability_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_linkup_evt(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_linkup_evt: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_linkdn_evt(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_linkdn_evt: "
                         "unit %d, port %d\n", unit, port);
                 ...
                 uint32 dev_addr, uint32 offset, int max_size, uint8 *data, int *actual_size)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_port_phy_multi_get: "
                         "unit=%d, port=%d\n", unit, port);
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN, 
                      "soc_phyctrl_port_phy_multi_get: u=%d p=%d rv=%d\n",
                      unit, port, rv));
    }
    return rv;
}
...
soc_phyctrl_mdix_set(int unit, soc_port_t port, soc_port_mdix_t mdix)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_mdix_set: "
...
soc_phyctrl_mdix_get(int unit, soc_port_t port, soc_port_mdix_t *mdix)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_mdix_get: "
                         "unit %d, port %d\n", unit, port);
                        ...
                        soc_port_mdix_status_t *status)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_mdix_status_get: "
                         "unit %d, port %d\n", unit, port);
                          ...
                          soc_phy_config_t *cfg)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_medium_config_set: "
                          ...
                          soc_phy_config_t *cfg)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_medium_config_get: "
                         "unit %d, port %d, medium %d\n", 
                 unit, port, medium);
...
soc_phyctrl_medium_get(int unit, soc_port_t port, soc_port_medium_t *medium)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_medium_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_cable_diag(int unit, soc_port_t port, soc_port_cable_diag_t *status)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_cable_diag: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_link_change(int unit, soc_port_t port, int *link)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_link_change: "
                         "unit %d, port %d\n", unit, port);
                    ...
                    soc_phy_control_t phy_ctrl, uint32 value)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_control_set: "
                    ...
                    soc_phy_control_t phy_ctrl, uint32 *value)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_control_get: "
                                 ...
                                 soc_phy_control_t phy_ctrl,  uint32 *value)
{
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
            "soc_phyctrl_control_get failed : u=%d p=%d c=%d rv=%d\n",
                         unit, port, phy_ctrl, rv));
    }
    return rv;
}
                 ...
                 uint32 addr, uint32 *data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_reg_read: "
                      ...
                      uint32 addr, uint32 data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_reg_write: "
                             ...
                             soc_phy_control_t phy_ctrl, uint32 value)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_lane_conrol_set: "
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
                 "soc_phyctrl_lane_control_set: u=%d p=%d l=%d c=%d rv=%d\n",
                             ...
                             soc_phy_control_t phy_ctrl, uint32 *value)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_lane_control_get: "
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
                "soc_phyctrl_lane_control_get: u=%d p=%d l=%d c=%d rv=%d\n",
                       unit, port, lane, phy_ctrl, rv));
    }
    return rv;
}
                          ...
                          uint32 flags, uint32 addr, uint32 *data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_lane_reg_read: "
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
                "soc_phyctrl_lane_reg_read: u=%d p=%d l=%d f=x0%08x addr=0x%08x rv=%d\n",
                           ...
                           uint32 flags, uint32 addr, uint32 data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_lane_reg_write: "
    ...
    if (SOC_FAILURE(rv)) {
        PHYCTRL_DEBUG((DK_WARN,
                "soc_phyctrl_lane_reg_write: u=%d p=%d l=%d f=x0%08x addr=0x%08x rv=%d\n",
                       unit, port, lane, flags, addr, rv));
    }
                   ...
                   uint32 addr, uint32 data, uint32 mask)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_reg_modify: "
                            ...
                            soc_port_ability_t * ability)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_ability_advert_get: "
                         "unit %d, port %d\n", unit, port);
                            ...
                            soc_port_ability_t * ability)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_ability_advert_set: "
                         "unit %d, port %d\n", unit, port);
                                   ...
                                   soc_port_ability_t * ability)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_ability_remote_get: "
                         "unit %d, port %d\n", unit, port);
                         ...
                         phy_driver_t *pd, soc_port_ability_t *ability)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phy_ability_local_get: "
                         "unit %d, port %d\n", unit, port);
                             ...
                             soc_port_ability_t *ability)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_ability_local_get: "
                         "unit %d, port %d\n", unit, port);
                   ...
                   int offset, uint8 *array, int len)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_firmare_set: "
...
{ 
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_diag_ctrl: "
...
soc_phyctrl_primary_set(int unit, soc_port_t port, soc_port_t primary)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_primary_set: "
...
soc_phyctrl_primary_get(int unit, soc_port_t port, soc_port_t *primary)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_primary_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phyctrl_offset_set(int unit, soc_port_t port, int offset)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_offset_set: "
...
soc_phyctrl_offset_get(int unit, soc_port_t port, soc_port_t *offset)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_offset_get: "
                         "unit %d, port %d\n", unit, port);
...
soc_phy_primary_and_offset_get(int unit, soc_port_t port, soc_port_t *primary_port, int *offset) 
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phy_primary_and_offset_get: "
                         "unit %d, port %d\n", unit, port);
...

{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_toplvl_reg_read: "
...

{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_toplvl_reg_write: "
...
soc_phyctrl_detach(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_detach: "
                         "unit %d, port %d\n", unit, port);
...
_soc_phyctrl_bcst_init(int unit, pbmp_t pbmp,char *dev_name,int bus_num,int ctrl,int ext_bus)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_bcst_init: "
...
_soc_phyctrl_ucode_bcst(int unit, pbmp_t pbmp, int ext_bus)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_ucode_bcst: "
...
soc_phyctrl_mdio_ucode_bcst(int unit, pbmp_t pbmp)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_mdio_ucode_bcst: "
...
soc_phyctrl_pbm_probe_init(int unit, pbmp_t pbmp, pbmp_t *okay_pbmp)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_pbm_probe_init: "
                         "unit %d, pbmp %s,\n", 
                 unit, SOC_PBMP_FMT(pbmp, pfmt));
...
soc_phyctrl_event_string(soc_phy_event_t event)
{
     ...
     soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_event_string: "
                         "event %d\n", event);
                   ...
                   soc_phy_event_t event, uint32 data)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_notify: "
...
{
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_cmic_rate_param_get: "
                         "unit %d\n", unit);
...
{
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_cmic_rate_param_set: "
...
_soc_phyctrl_dump(phy_ctrl_t *pc)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_dump\n");
...
soc_phyctrl_port_dump(int unit, soc_port_t port)
{
    ...
    soc_cm_debug((DK_PHY | DK_VERBOSE), "entered soc_phyctrl_port_dump: "
                         "unit %d, port %d\n", unit, port);
