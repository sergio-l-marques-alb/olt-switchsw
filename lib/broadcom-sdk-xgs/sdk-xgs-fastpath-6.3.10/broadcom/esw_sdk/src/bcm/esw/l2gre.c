 ...
 *
 */
int   _bcm_esw_l2gre_stat_counter_get(
                            int                 unit,
                            int             sync_mode,
                            bcm_gport_t         port,
                            bcm_vpn_t           vpn,
 ...
 *
 */
int   bcm_esw_l2gre_stat_counter_set(
                            int                 unit, 
                            bcm_gport_t         port,
                            bcm_vpn_t           vpn,
                            bcm_l2gre_stat_t    stat, 
 ...
 *
 */
int   bcm_esw_l2gre_stat_multi_get(
                            int                 unit, 
                            bcm_gport_t         port,
                            bcm_vpn_t           vpn,
                            int                 nstat, 
 ...
 *
 */
int   bcm_esw_l2gre_stat_multi_get32(
                            int                 unit, 
                            bcm_gport_t         port,
                            bcm_vpn_t           vpn,
                            int                 nstat, 
 ...
 *
 */
int  bcm_esw_l2gre_stat_multi_set(
                            int                 unit, 
                            bcm_gport_t         port,
                            bcm_vpn_t           vpn,
                            int                 nstat, 
...
int   bcm_esw_l2gre_stat_multi_set32(
                            int                 unit, 
                            bcm_gport_t         port,
                            bcm_vpn_t           vpn,
                            int                 nstat, 
