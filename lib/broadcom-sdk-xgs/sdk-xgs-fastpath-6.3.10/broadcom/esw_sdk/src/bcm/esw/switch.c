/*
 * $Id: switch.c,v 1.682.2.12 Broadcom SDK $
...
defined(BCM_TRIDENT_SUPPORT)
    ...
    { bcmSwitchTrillRpfFailDrop, TD | TR3 | HX4 | TD2,
        ...
        NULL, soc_feature_trill},
    { bcmSwitchIngParseL2TunnelTermDipSipSelect, TD | TR3 | HX4 | TD2 | KT | KT2,
        ING_L2_TUNNEL_PARSE_CONTROLr, IFP_L2_TUNNEL_PAYLOAD_FIELD_SELf ,
        NULL, 0},
    { bcmSwitchIngParseL3L4IPv4, TD | TR3 | HX4 | TD2 | KT | KT2,
        ING_L2_TUNNEL_PARSE_CONTROLr, IGMP_ENABLEf ,
        NULL, 0},
    { bcmSwitchIngParseL3L4IPv6, TD | TR3 | HX4 | TD2 | KT | KT2,
    ...
    { bcmSwitchMplsReservedEntropyLabelDrop, TR3 | HX4,
        ...
        _bool_invert, 0},
    { bcmSwitchRemoteProtectionTrust, TR3 | HX4 | TD2 | KT2,
...
#if defined(BCM_TRIDENT_SUPPORT)
    { bcmSwitchHashField0Ip6FlowLabel, TD | TR3 | HX4 | TD2,
       RTAG7_HASH_CONTROL_2r, ENABLE_FLOW_LABEL_IPV6_Af,
        NULL, 0},
    { bcmSwitchHashField1Ip6FlowLabel, TD | TR3 | HX4 | TD2,
       RTAG7_HASH_CONTROL_2r, ENABLE_FLOW_LABEL_IPV6_Bf,
        NULL, 0},
    { bcmSwitchMacroFlowHashUseMSB, TD | TR3 | HX4 | TD2,
    ...
    { bcmSwitchHashHg2PktFieldsEnable, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, TREAT_PPD2_AS_KNOWN_PPDf,
        NULL, 0},
    { bcmSwitchHashField0OverlayCntagRpidEnable, TD | TR3 | HX4 | KT | TD2,
    ...
    { bcmSwitchMimPayloadTpidEnable, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, MIM_PAYLOAD_TPID_ENABLEf,
        NULL, soc_feature_mim},
    { bcmSwitchHashMimUseTunnelHeader0, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, DISABLE_HASH_MIM_INNER_L2_Af,
        NULL, soc_feature_mim},
    { bcmSwitchHashMimUseTunnelHeader1, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, DISABLE_HASH_MIM_INNER_L2_Bf,
        NULL, soc_feature_mim},
    { bcmSwitchHashField1OverlayCntagRpidEnable, TD | TR3 | HX4 | KT | TD2,
       RTAG7_HASH_CONTROL_2r, ENABLE_BIN_12_OVERLAY_Bf,
        NULL, 0},
    { bcmSwitchHashUseFlowSelTrunkUc , TR3 | HX4 | KT2 | TD2,
       RTAG7_HASH_SELr, USE_FLOW_SEL_TRUNK_UCf,
        NULL, 0},
    { bcmSwitchHashUseFlowSelEcmp, TR3 | HX4 | KT2 | TD2,
       RTAG7_HASH_SELr, USE_FLOW_SEL_ECMPf,
        NULL, 0}
#endif
...
_bcm_switch_subportpkttag_ethertype_get(int unit, int *ethertype)
{
    ...
    defined(BCM_KATANA_SUPPORT) || defined(BCM_HURRICANE2_SUPPORT) || \
    defined(BCM_KATANA2_SUPPORT)
...
} _L1_port_mux_lane_map_t;

_L1_port_mux_lane_map_t _kt2_L1_port_mux_lane_map[] = {
...
_bcm_switch_sync_port_select_set(int unit, uint32 val)
{
    ...
    if (SOC_IS_HURRICANE(unit) || SOC_IS_ENDURO(unit)) {
      ...
      BCM_IF_ERROR_RETURN(
        ...
        if ((val > (COUNTOF(_kt2_L1_port_mux_lane_map) - 1)) ||
        ...
        soc_reg_field_set(unit, TOP_MISC_CONTROL_0r, &rval,
                        L1_CLK0_RECOVERY_MUX_SELf, 
                        _kt2_L1_port_mux_lane_map[val].recovered_clock_select);
        BCM_IF_ERROR_RETURN(
            WRITE_TOP_MISC_CONTROL_0r(unit, rval));
        /* For KT2 B0, need to set lane num for clk recovery for wc ports */
        if((_kt2_L1_port_mux_lane_map[val].unicore_or_warpcore) && 
            ...
            soc_reg_field_set(unit, TOP_MISC_CONTROL_3r, &rval,
              (_kt2_L1_port_mux_lane_map[val].unicore_or_warpcore == 1)
              ? L1_WC0_RECOVERY_CLK0_MUX_SELf : L1_WC1_RECOVERY_CLK0_MUX_SELf,
              _kt2_L1_port_mux_lane_map[val].lane_num);
            BCM_IF_ERROR_RETURN(
    ...
    if (SOC_IS_ENDURO(unit) || SOC_IS_HURRICANE(unit)) {
      ...
      if (type) { /* primary (1) */
         port = soc_reg_field_get(unit, TOP_MISC_CONTROL_0r, rval,
                                  L1_CLK0_RECOVERY_MUX_SELf);
         *val = _kt2_L1_port_mux_lane_map[port + 1].port;
      } else { /* backup (0) */
         port = soc_reg_field_get(unit, TOP_MISC_CONTROL_0r, rval,
                                     L1_CLK1_RECOVERY_MUX_SELf);
         *val = _kt2_L1_port_mux_lane_map[port + 1].port;
                           ...
                           int arg)
{
 ...
 return BCM_E_NONE;
    ...
    defined(BCM_KATANA2_SUPPORT)
                if (SOC_IS_ENDURO(unit) || SOC_IS_HURRICANE(unit) || 
                    SOC_IS_KATANA(unit) || SOC_IS_HURRICANE2(unit) ||
                    SOC_IS_KATANA2(unit)) {
    ...
    defined(BCM_KATANA2_SUPPORT)
                if (SOC_IS_ENDURO(unit) || SOC_IS_HURRICANE(unit)) {
                    return _bcm_switch_sync_port_select_set(unit, (uint32)arg);
                } else if (SOC_IS_KATANA(unit) || SOC_IS_HURRICANE2(unit) || 
                    SOC_IS_KATANA2(unit)) {
                           ...
                           int *arg)
{
 ...
 return BCM_E_NONE;
    ...
    defined(BCM_KATANA_SUPPORT) || defined(BCM_KATANA2_SUPPORT)
                    if (SOC_IS_ENDURO(unit) || SOC_IS_HURRICANEX(unit)  || \
                        SOC_IS_KATANA(unit) ||  SOC_IS_KATANA2(unit)) {
