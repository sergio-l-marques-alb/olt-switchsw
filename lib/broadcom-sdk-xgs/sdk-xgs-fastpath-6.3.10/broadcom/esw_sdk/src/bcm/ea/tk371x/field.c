...
{
	FP_VVERB(("FP: _bcm_tk371x_field_control_get(%d)\n", unit));
...
_bcm_tk371x_field_action_name(bcm_field_action_t action)
{
    ...
    FP_VVERB(("FP: _bcm_tk371x_field_action_name\n"));
...
{
	FP_VVERB(("FP: _bcm_tk371x_field_control_free(unit=%d)\n", unit));
    _field_control = NULL;
    if (NULL == fc) {
        return (BCM_E_NONE);
    }
...
_bcm_tk371x_field_range_get(int unit, bcm_field_range_t rid,
	...
	FP_VVERB(("FP: _bcm_tk371x_field_entry_get(unit=%d)\n", unit));
    fr = fc->ranges;
    while (fr != NULL){
    	if (fr->rid == rid){
    		*range_p = fr;
               ...
               bcm_field_qualify_t qual, _bcm_tk371x_field_entry_t **entry_p)
{
	...
	FP_VVERB(("FP: _bcm_tk371x_field_entry_qual_get(unit=%d)\n", unit));
    FIELD_IS_INIT(unit);
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    found = FALSE;
    fg = fc->groups;
    ...
    while (fg != NULL){
    	...
    	while (fe != NULL){
    		if (fe->entry_id == eid){
    		    ...
    		    FP_VVERB(("FP: Has found(eid=%d, qset=%d)\n", eid, qual));
    			*entry_p = fe;
    			return BCM_E_NONE;
    		}
    		fe = fe->next;
...
_bcm_tk371x_field_entry_group_id_get(int unit, bcm_field_entry_t eid, bcm_field_group_t *gid)
{
	...
	FP_VVERB(("FP: _bcm_tk371x_field_entry_group_id_get(unit=%d)\n", unit));
    FIELD_IS_INIT(unit);
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    fg = fc->groups;
    while (fg != NULL){
...
_bcm_tk371x_field_entry_qualify_update(
	...
	FP_VVERB(("FP: _bcm_tk371x_field_entry_qualify_update(unit=%d)\n", unit));
    if (fc == NULL){
    	return BCM_E_INIT;
    }
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
...
bcm_tk371x_field_entry_destroy_all(int unit)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_destroy_all(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    bcm_field_group_t group)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_group_destroy(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
...
_bcm_tk371x_field_group_get(int unit, bcm_field_group_t gid)
{
	...
	FP_VVERB(("FP: _bcm_tk371x_field_group_get(unit=%d)\n", unit));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    fg = fc->groups;
    while (fg != NULL){
    	if (fg->group_id == gid){
...
_bcm_tk371x_field_group_id_generate(int unit, bcm_field_group_t *group)
{
	...
	FP_VVERB(("FP: _bcm_tk371x_field_group_id_generate(unit=%d)\n", unit));
...
_bcm_tk371x_field_bcmActionToRuleAction_update(
	...
	FP_VVERB(("FP: _bcm_tk371x_field_bcmActionToRuleAction_update(unit=%d)\n", unit));
	...
	for (i = 0; i < _TK371X_MAX_ACTIONS; i++){
		if (act[i] == _FP_ACTION_INVALID_VAL){
			FP_VVERB(("FP:act[%d] =  _FP_ACTION_INVALID_VAL\n", i));
			break;
		}else{
...
#ifdef BROADCOM_DEBUG
		FP_VVERB(("1:\n"));
		FP_VVERB(("(uint16)fe->bcm_action->param0=%d\n", (uint16)fe->bcm_action->param0));
		FP_VVERB(("(uint16)fe->bcm_action->next->param0=%d\n", (uint16)fe->bcm_action->next->param0));
#endif		
		...
		_bcm_tk371x_field_action_t *fa)
{
	...
	FP_VVERB(("FP: _bcm_tk371x_field_action_insert(unit=%d)\n", unit));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    uint32 param1)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_action_add(unit=%d)\n", unit));
	switch (action){
		...
		_bcm_tk371x_field_action_t *fa)
{
	...
	FP_VVERB(("FP: Enter _bcm_tk371x_field_action_delete\n"));
	if (fe == NULL){
		return BCM_E_NONE;
	}
	fa_act = NULL;
	    ...
	    uint32 param1)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_action_delete(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	switch (action){
    ...
    FP_VVERB(("FP: _bcm_tk371x_field_entry_get find entry id = %d\n", fe->entry_id));
	    ...
	    uint32 *param1)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_action_get(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	switch (action){
...
bcm_tk371x_field_action_remove(
	    ...
	    bcm_field_action_t action)
{
	FP_VVERB(("FP: bcm_tk371x_field_action_remove(unit=%d)\n", unit));
	    ...
	    bcm_field_entry_t entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_action_remove_all(unit=%d)\n", unit));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    rv = _bcm_tk371x_field_entry_get(unit, entry, &entry_P);
    if (rv != BCM_E_NONE){
    	return rv;
...
bcm_tk371x_field_detach(int unit)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_detach(unit=%d)\n", unit));
	    ...
	    bcm_field_entry_t *dst_entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_copy(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	    ...
	    bcm_field_entry_t dst_entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_copy_id(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    bcm_field_entry_t *entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_create(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	f_ent_src = NULL;
	    ...
	    bcm_field_entry_t entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_create_id(unit=%d)\n", unit));
    f_ent_src = NULL;
	if (fc == NULL){
		return BCM_E_INIT;
	}
	    ...
	    bcm_field_entry_t entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_destroy(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    bcm_field_entry_t entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_dump(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    ...
    FP_SHOW(("Group ID :%d, Entry ID: %d\n", gid, entry));
    FP_SHOW(("TEK Rule Information:\n"));
    FP_SHOW(("linkid : %02X\n", entry_P->linkid));
    FP_SHOW(("ObjType: %02X\n", entry_P->objType));
    FP_SHOW(("index: %02X\n", entry_P->index));
    FP_SHOW(("volatiles : %02X\n", entry_P->volatiles));
    FP_SHOW(("pri : %02X\n", entry_P->pri));
    FP_SHOW(("soc_action: %02X\n", entry_P->soc_action));
    FP_SHOW(("Tk Rule Parameters:\n"));
    FP_SHOW(("vid_cos : %04X\n", entry_P->rule_para.vid_cos));
    FP_SHOW(("Teknovus conditions List:\n"));
    conds_P = entry_P->conds;
    while (conds_P != NULL){
    	FP_SHOW(("qaulify[%d]=%02X\n", i, conds_P->qual_id));
    	FP_SHOW(("qset[%d]=%02X\n", i, conds_P->qset));
    	FP_SHOW(("value[%d]=%02X", i, conds_P->common.value[0]));
    	for (j = 1; j < 8; j++){
    		FP_SHOW(("value[%d]=%02X", j, conds_P->common.value[j]));
    	}
    	FP_SHOW(("\n"));
    	FP_SHOW(("match[%d]=%02X\n", i, conds_P->match));
    	conds_P = conds_P->next;
    ...
    FP_SHOW(("BCM Actions List:\n"));
    act_P = entry_P->bcm_action;
    while (act_P != NULL){
    	FP_SHOW(("action[%d]=%02X\n", i, act_P->action));
    	FP_SHOW(("param0[%d]=%08X\n", i, act_P->param0));
    	FP_SHOW(("param1[%d]=%08X\n", i, act_P->param1));
    	act_P = act_P->next;
    }
    if ((entry_P->flags & _TK371X_ENTRY_FLAG_INSTALLED)
    		&& (entry_P->flags & _TK371X_ENTRY_FLAG_NOT_EMPTY)){
		FP_SHOW(("BCM Rule Backup Information:\n"));
		FP_SHOW(("LogicalPortIndex.index=%02X\n", entry_P->backup->index.index));
		FP_SHOW(("LogicalPortIndex.objType=%02X\n", entry_P->backup->index.objType));
		FP_SHOW(("TkPortRuleInfo.actuion=%02X\n", entry_P->backup->info.action));
		FP_SHOW(("TkPortRuleInfo.param.vid_cos=%04X\n", entry_P->backup->info.param.vid_cos));
		FP_SHOW(("TkPortRuleInfo.priority=%02X\n", entry_P->backup->info.priority));
		FP_SHOW(("TkPortRuleInfo.volatiles=%02X\n", entry_P->backup->info.volatiles));
		FP_SHOW(("TkPortRuleInfo.ruleCondition.conditionCount=%d\n",
				entry_P->backup->info.ruleCondition.conditionCount));
		for (i = 0; i < entry_P->backup->info.ruleCondition.conditionCount; i++){
			FP_SHOW(("TkPortRuleInfo.ruleCondition.conditionList[%d].field=%02X\n",
					i, entry_P->backup->info.ruleCondition.conditionList[i].field));
			FP_SHOW(("TkPortRuleInfo.ruleCondition.conditionList[%d].operator=%02X\n",
					i, entry_P->backup->info.ruleCondition.conditionList[i].operator));
			FP_SHOW(("TkPortRuleInfo.ruleCondition.conditionList[%d].comon.value", i));
			for (j = 0; j < 8; j++){
				FP_SHOW(("[%d]=%02X",
    ...
    FP_SHOW(("Show derivative rules:\n"));
    if (entry_P->derivative != NULL){
    	if (entry_P->derivative->rule1 != NULL){
			FP_SHOW(("BCM derivative Rule One Information:\n"));
		...
		if (entry_P->derivative->rule2 != NULL){
			FP_SHOW(("BCM derivative Rule Two Information:\n"));
	    ...
	    bcm_field_entry_t entry)
{
...
#ifdef BROADCOM_DEBUG
	int j = 0;
	FP_VVERB(("FP: bcm_tk371x_field_entry_install(unit=%d)\n", unit));
#endif
	if (fc == NULL){
		return BCM_E_INIT;
	}
    ...
    FP_VVERB(("pathId=%d\n", unit));
    FP_VVERB(("LinkId=%d\n", 0));
    FP_VVERB(("LogicalPortIndex.index=%02X\n", index.index));
    FP_VVERB(("LogicalPortIndex.objType=%02X\n", index.objType));
    FP_VVERB(("TkPortRuleInfo.actuion=%02X\n", rule_info.action));
    FP_VVERB(("TkPortRuleInfo.param.vid_cos=%04X\n", rule_info.param.vid_cos));
    FP_VVERB(("TkPortRuleInfo.priority=%02X\n", rule_info.priority));
    FP_VVERB(("TkPortRuleInfo.volatiles=%02X\n", rule_info.volatiles));
    FP_VVERB(("TkPortRuleInfo.ruleCondition.conditionCount=%d\n",
    					rule_info.ruleCondition.conditionCount));
    for (i = 0; i < rule_info.ruleCondition.conditionCount; i++){
    	FP_VVERB(("TkPortRuleInfo.ruleCondition.conditionList[%d].field=%02X\n",
    			i, rule_info.ruleCondition.conditionList[i].field));
    	FP_VVERB(("TkPortRuleInfo.ruleCondition.conditionList[%d].operator=%02X\n",
    			i, rule_info.ruleCondition.conditionList[i].operator));
    	FP_VVERB(("TkPortRuleInfo.ruleCondition.conditionList[%d].comon.value", i));
    	for (j = 0; j < 8; j++){
    		FP_VVERB(("[%d]=%02X",
    ...
    FP_VVERB(("Call TkExtOamPortRuleAdd: rv=%d\n", rv));
    if (OK == rv){
		entry_P->flags |= _TK371X_ENTRY_FLAG_INSTALLED;
	    ...
	    int *entry_count)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_multi_get(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    int *prio)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_prio_get(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    int prio)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_prio_set(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    bcm_field_entry_t entry)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_entry_reinstall(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    bcm_field_entry_t entry)
{
    ...
    int i;
	int j = 0;
	FP_VVERB(("FP: bcm_tk371x_field_entry_remove(unit=%d)\n", unit));
#endif
	if (fc == NULL){
		return BCM_E_INIT;
	}
	    ...
	    bcm_field_group_t *group)
{
    ...
    FP_VVERB(("FP: bcm_tk371x_field_group_create(unit=%d)\n", unit));
    FIELD_IS_INIT(unit);
	    ...
	    bcm_field_group_t group)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_group_dump(unit=%d)\n", unit));
	if (fc == NULL){
		return BCM_E_INIT;
	}
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    ...
    while (fg != NULL){
    	if (fg->group_id == group){
			...
			FP_SHOW(("group id:%d, entry number are %d\n", fg->group_id, e_count));
			return BCM_E_NONE;
    	}
    	fg = fg->next;
    }
	    ...
	    bcm_field_group_status_t *status)
{
	...
	FP_VVERB(("BEGIN bcm_tk371x_field_group_status_get(unit=%d, group=%d)\n", unit, group));
	if (fc == NULL){
		return BCM_E_INIT;
	}
    if (status == NULL){
...
{
	FP_VVERB(("BEGIN bcm_tk371x_field_group_status_t_init\n"));
	if (fgroup != NULL){
	    ...
	    void *user_data)
{
    ...
    FP_VVERB(("BEGIN bcm_tk371x_field_group_status_get(unit=%d)\n", unit));
...
bcm_tk371x_field_init(int unit)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_init(unit=%d)\n", unit));
    /* Make sure the Unit can support this module. */
    if (!BCM_TK371X_UNIT_VALID(unit)) {
        return BCM_E_UNIT;
    }
	    ...
	    bcm_field_udf_t udf_id)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_qset_add_udf(unit=%d)\n", unit));
    FIELD_IS_INIT(unit);
...
{
	FP_VVERB(("FP: bcm_tk371x_field_qset_t_init\n"));
	if (qset != NULL){
...
bcm_tk371x_field_qset_udf_get(
	    ...
	    int *udf_count)
{
	FP_VVERB(("FP: bcm_tk371x_field_qset_udf_get(unit=%d)\n", unit));
	return BCM_E_UNAVAIL;
}
	    ...
	    bcm_field_qualify_t qual_id)
{
	...
	FP_VVERB(("BEGIN bcm_tk371x_field_qualifier_delete(unit=%d, entry=%d qual_id=%d)\n",
    						unit, entry, qual_id));
    FIELD_IS_INIT(unit);
    /* Get unit FP control structure. */
    BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    uint8 mask)
{
	...
	FP_VVERB(("(unit=%d,entry=%08X,data=%02X,mask=%02X)\n",
                unit,
                entry,
                data,
                mask));
	    ...
	    uint8 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp(unit=%d,entry=%08X)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_ip6_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp6High (unit=%d,entry=%08X)\n", unit, entry));
	    ...
	    bcm_ip6_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp6High_get (unit=%d,entry=%08X)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_ip6_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp6Low (unit=%d,entry=%08X)\n", unit, entry));
	    ...
	    bcm_ip6_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp6Low_get (unit=%d,entry=%08X)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_ip6_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp6_get (unit=%d,entry=%08X)\n", unit, entry));
	    ...
	    bcm_ip_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstIp_get (unit=%d,entry=%08X)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_mac_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstMac (unit=%d,entry=%08X)\n", unit, entry));
	match = _bcm_ea_field_operator_cond((uint8*)&data[0], (uint8*)&mask[0], len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
	    ...
	    bcm_mac_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_DstMac_get (unit=%d,entry=%08X)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    uint16 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_EtherType (unit=%d,entry=%08X)\n", unit, entry));
	match = _bcm_ea_field_operator_cond((uint8*)&data, (uint8*)&mask, len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
	    ...
	    uint16 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_EtherType_get (unit=%d,entry=%08X)\n", unit, entry));
    FIELD_IS_INIT(unit);
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
...
_bcm_tk371x_field_port_info_update(
	...
	FP_VVERB(("_bcm_tk371x_field_port_info_update\n"));
	    ...
	    bcm_port_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_InPort(%d,%d,%d%d)\n", unit, entry, data, mask));
    if (0 == SOC_PORT_VALID(unit, data)){
		FP_ERR(("FP Error: the port index is more then the max port number.\n"));
		return BCM_E_PARAM;
	}
	    ...
	    bcm_port_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_InPort_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	rv = _bcm_tk371x_field_entry_get(unit, entry, &fe);
	if (rv != BCM_E_NONE){
		return rv;
...
bcm_tk371x_field_qualify_InPorts(
	    ...
	    bcm_pbmp_t mask)
{
	FP_VVERB(("bcm_tk371x_field_qualify_InPorts(%d,%d)\n", unit, entry));
	return BCM_E_UNAVAIL;
}
...
bcm_tk371x_field_qualify_InPorts_get(
	    ...
	    bcm_pbmp_t *mask)
{
	FP_VVERB(("bcm_tk371x_field_qualify_InPorts_get(%d,%d)\n", unit, entry));
	return BCM_E_UNAVAIL;
}
	    ...
	    uint32 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_Ip6FlowLabel(%d,%d)\n", unit, entry));
	match = _bcm_ea_field_operator_cond((uint8*)&data, (uint8*)&mask, len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
	    ...
	    uint32 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_Ip6FlowLabel_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    uint8 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_Ip6NextHeader(%d,%d)\n", unit, entry));
	FP_VVERB(("(%d,%08X,%016X,%016X)\n",
                unit,
                entry,
                data,
                mask));
	    ...
	    uint8 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_Ip6NextHeader_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    uint8 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_Ip6TrafficClass(%d,%d)\n", unit, entry));
	match = _bcm_ea_field_operator_cond(&data, &mask, len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
	    ...
	    uint8 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_Ip6TrafficClass_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    uint8 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_IpProtocol(%d,%d)\n", unit, entry));
	match = _bcm_ea_field_operator_cond(&data, &mask, len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
...
{
	FP_VVERB(("bcm_tk371x_field_qualify_IpProtocolCommon(%d,%d)\n", unit, entry));
	return BCM_E_UNAVAIL;
}
...
bcm_tk371x_field_qualify_IpProtocolCommon_get(
	    ...
	    bcm_field_IpProtocolCommon_t *protocol)
{
	FP_VVERB(("bcm_tk371x_field_qualify_IpProtocolCommon_get(%d,%d)\n", unit, entry));
	return BCM_E_UNAVAIL;
}
	    ...
	    uint8 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_IpProtocol_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
...
{
	FP_VVERB(("bcm_tk371x_field_qualify_IpType(%d,%d)\n", unit, entry));
	return BCM_E_UNAVAIL;
}
...
bcm_tk371x_field_qualify_IpType_get(
	    ...
	    bcm_field_IpType_t *type)
{
	FP_VVERB(("bcm_tk371x_field_qualify_IpType_get(%d,%d)\n", unit, entry));
	return BCM_E_UNAVAIL;
}
	    ...
	    bcm_l4_port_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_L4DstPort(%d,%d)\n", unit, entry));
	match = _bcm_ea_field_operator_cond((uint8*)&data, (uint8*)&mask, len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
	    ...
	    bcm_l4_port_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_L4DstPort_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_l4_port_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_L4SrcPort(%d,%08X,%08X,%08X)\n",
                unit,
                entry,
                data,
                mask));
	    ...
	    bcm_l4_port_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_L4SrcPort_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_vlan_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_OuterVlanId(%d,%08X,%08X,%08X)\n",
                unit,
                entry,
                data,
                mask));
	    ...
	    bcm_vlan_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_OuterVlanId_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    uint8 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_OuterVlanPri(%d,%08X,%016X,%016X)\n",
                unit,
                entry,
                data,
                mask));
	    ...
	    uint8 *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_OuterVlanPri_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    int invert)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_RangeCheck(%d,%d)\n", unit, entry));
    if (fc == NULL){
    	return BCM_E_INIT;
    }
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	    ...
	    int *count)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_RangeCheck_get(%d,%d)\n", unit, entry));
    if (fc == NULL){
    	return BCM_E_INIT;
    }
    if (max_count != 1){
	    ...
	    bcm_ip_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcIp(%d,%08X,%08X,%08X)\n",
                unit,
                entry,
                data,
                mask));
	    ...
	    bcm_ip6_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcIp6High_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_ip6_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcIp6Low(%d,%d)\n", unit, entry));
	match = _bcm_ea_field_operator_cond((uint8*)data, (uint8*)mask, len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	}
	    ...
	    bcm_ip6_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcIp6Low_get(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	while (fe_cond != NULL){
	    ...
	    bcm_ip6_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcIp6_get(%d,%d)\n", unit, entry));
	    ...
	    bcm_mac_t mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcMac(%d,%d)\n", unit, entry));
    FIELD_IS_INIT(unit);
	match = _bcm_ea_field_operator_cond((uint8*)&data[0], (uint8*)&mask[0], len);
	if (match == (uint8)_BCM_TK371X_FIELD_MATCH_ERROR) {
		return BCM_E_PARAM;
	    ...
	    bcm_mac_t *mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_SrcMac_get(%d,%d)\n", unit, entry));
    FIELD_IS_INIT(unit);
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	fe_cond = fe->conds;
	    ...
	    bcm_field_entry_t entry)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_clear(%d,%d)\n", unit, entry));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, entry, &fe));
	/* destory all conditions */
	cond = fe->conds;
	    ...
	    bcm_l4_port_t max)
{
    ...
    FP_VVERB(("BEGIN bcm_tk371x_field_range_create(unit=%d, range->0x%x,", unit, *range));
	    ...
	    bcm_l4_port_t max)
{
    ...
    FP_VVERB(("BEGIN bcm_tk371x_field_range_create_id(unit=%d, range=%d, ", unit,
              range));
    FP_VVERB(("flags=0x%08x, min=0x%x, max=0x%x)\n", flags, min, max));
    /* Range type sanity check. */
    BCM_IF_ERROR_RETURN(_bcm_tk371x_field_range_flags_check(unit, flags));
	    ...
	    bcm_field_range_t range)
{
    ...
    FP_VVERB(("bcm_tk371x_field_range_destroy(%d,%d)\n", unit, range));
    if (fc == NULL){
    	return BCM_E_INIT;
    }
    fr = NULL;
	    ...
	    bcm_l4_port_t *max)
{
	...
	FP_VVERB(("bcm_tk371x_field_range_get(%d,%d)\n", unit, range));
    if (fc == NULL){
    	return BCM_E_INIT;
    }
    fr = fc->ranges;
	    ...
	    const char *pfx)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_show(unit=%d)\n", unit));
    if (fc == NULL){
    	return BCM_E_INIT;
    }
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
    ...
    while (fg != NULL){
    	...
    	FP_SHOW(("group %d entries are %d\n", fg->group_id, e_count));
    	fg = fg->next;
    	g_count++;
    }
    FP_SHOW(("group numbers are  %d\n", g_count));
    FP_SHOW(("Show Ranges:\n"));
    fr = fc->ranges;
    while (fr != NULL){
    	FP_SHOW(("Range ID=%d\n", fr->rid));
    	...
    	m_count = 0;
    	while (tk_match != NULL){
    		FP_SHOW(("match field=%d\n", tk_match->field));
    		FP_SHOW(("match value=%d\n", tk_match->value));
    		FP_SHOW(("match = %d\n", tk_match->match));
    		tk_match = tk_match->next;
    		m_count++;
    	}
    	FP_SHOW(("match number are %d\n", m_count));
    	fr = fr->next;
    	r_count++;
    }
    FP_SHOW(("Range numbers are %d\n", r_count));
...
bcm_tk371x_field_qualify_SrcIpEqualDstIp_get(
		...
		uint32 *flags)
{
	FP_VVERB(("FP: bcm_tk371x_field_qualify_SrcIpEqualDstIp_get(unit=%d)\n", unit));
	return BCM_E_UNAVAIL;
}
...
bcm_tk371x_field_qualify_SrcIpEqualDstIp(
		...
		uint32 flags)
{
	FP_VVERB(("FP: bcm_tk371x_field_qualify_SrcIpEqualDstIp(unit=%d)\n", unit));
	return BCM_E_UNAVAIL;
}
...
{
	FP_VVERB(("FP: bcm_tk371x_field_group_create_mode_id(unit=%d)\n", unit));
	return BCM_E_UNAVAIL;
}
...
bcm_tk371x_field_group_create_mode(
		...
		bcm_field_group_t *group)
{
	FP_VVERB(("FP: bcm_tk371x_field_group_create_mode(unit=%d)\n", unit));
	return BCM_E_UNAVAIL;
}
		...
		bcm_ip_t *dstip)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_qualify_SrcIp_get(unit=%d)\n", unit));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
		...
		bcm_field_entry_t eid, uint8 data,uint8 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_VlanFormat(unit=%d,entry=%08X,data=%02X,mask=%02X)\n",
                unit,
                eid,
                data,
                mask));
		...
		bcm_field_entry_t eid, uint8 *data,uint8 *mask)
{
	...
	FP_VVERB(("FP: bcm_tk371x_field_qualify_VlanFormat_get(unit=%d)\n", unit));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_control_get(unit, fc));
	BCM_IF_ERROR_RETURN(_bcm_tk371x_field_entry_get(unit, eid, &fe));
	fe_cond = fe->conds;
	dflag = vflag = 0;
		...
		bcm_field_entry_t entry, uint16 data, uint16 mask)
{
	...
	FP_VVERB(("bcm_tk371x_field_qualify_LlidValue"
