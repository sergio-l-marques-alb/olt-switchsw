/*
 * $Id: phy8481.c 1.233.2.3 Broadcom SDK $
        ...
        if (phy_mdi_pair_map) {
            ...
            value = ((phy_mdi_pair_map & (0x3<<12)) >> 6) | ((phy_mdi_pair_map & (0x3<<8)) >> 4) | 
...
#endif
                {
                    ...
                    SOC_IF_ERROR_RETURN
                        (MODIFY_PHY8481_TOPLVL1_REG(unit, pc, 0x4005, (1U << 1), (1U << 1)));
                    sal_udelay(35000);
                }
        }
                     ...
                     soc_phy_control_t type, uint32 value)
{
    ...
    case SOC_PHY_CONTROL_DRIVER_CURRENT:
        ...
        /* Register bank = 0x0  offset = 0x5 value */
        SOC_IF_ERROR_RETURN(
            _phy84834_xfi_m_reg_get(unit, pc, 0x0, 0x5, &tmp));
        ...
        /* Register bank = 0x0  offset = 0x5 value */
        SOC_IF_ERROR_RETURN(
            _phy84834_xfi_m_reg_set(unit, pc, 0x0, 0x5, tmp));
        break;
                     ...
                     soc_phy_control_t type, uint32 *value)
{
    ...
    case SOC_PHY_CONTROL_DRIVER_CURRENT:
        /* Register bank = 0x0  offset = 0x5 value */
        SOC_IF_ERROR_RETURN(
            _phy84834_xfi_m_reg_get(unit, pc, 0x0, 0x5, &data));
