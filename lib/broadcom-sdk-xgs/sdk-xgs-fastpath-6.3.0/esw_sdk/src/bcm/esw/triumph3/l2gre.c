/*
 * $Id: l2gre.c 1.37.8.1 Broadcom SDK $
 *
...
_bcm_tr3_l2gre_bud_loopback_enable(int unit)
{
   ...
   soc_LPORT_TABm_field32_set(unit, &lport_profile, L2GRE_TERMINATION_ALLOWEDf, 0x1);   
   soc_LPORT_TABm_field32_set(unit, &lport_profile, V4IPMC_ENABLEf, 0x1);
   soc_LPORT_TABm_field32_set(unit, &lport_profile, L2GRE_VPNID_LOOKUP_KEY_TYPEf, 0x1);
...
_bcm_tr3_l2gre_bud_loopback_disable(int unit)
{
   ...
   soc_LPORT_TABm_field32_set(unit, &lport_profile, PORT_TYPEf, 0x0);
   soc_LPORT_TABm_field32_set(unit, &lport_profile, L2GRE_TERMINATION_ALLOWEDf, 0x0);   
   soc_LPORT_TABm_field32_set(unit, &lport_profile, V4IPMC_ENABLEf, 0x0);
   soc_LPORT_TABm_field32_set(unit, &lport_profile, L2GRE_VPNID_LOOKUP_KEY_TYPEf, 0x0);
   rv = soc_mem_write(unit, LPORT_TABm,
                        MEM_BLOCK_ALL, 0, &lport_profile);
   return rv;
}
