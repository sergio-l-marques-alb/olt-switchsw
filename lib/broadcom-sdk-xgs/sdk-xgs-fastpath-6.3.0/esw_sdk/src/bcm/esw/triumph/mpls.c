/*
 * $Id: mpls.c 1.539.2.3 Broadcom SDK $
                       ...
                       int action, int *vc_swap_index)
{
    ...
    memset(alloc_flags,0,num_chunks+1);
                      ...
                      bcm_mpls_port_t *mpls_port)
{
    ...
    if (SOC_IS_KATANA2(unit)) {
        split_horizon_port_flag = soc_SOURCE_VPm_field32_get(unit, &svp, NETWORK_GROUPf);
    } else {
