    ...
    */
    if (soc_feature(unit, soc_feature_mac_learn_limit)) {
        ...
        if (SOC_IS_HARRIER(unit)){
            limit.limit = soc_robo_mem_index_max(unit, L2_ARLm);
        } else {
            limit.limit = soc_robo_mem_index_max(unit, L2_ARLm) + 1;
        }
...
bcm_robo_l2_learn_limit_set(int unit, bcm_l2_learn_limit_t *limit)
{
    ...
    if (SOC_IS_HARRIER(unit)) {
        ...
        temp = soc_robo_mem_index_max(unit, L2_ARLm) + 1;
    }
...
_bcm_robo_l2_traverse(int unit, _bcm_robo_l2_traverse_t *trav_st)
{
    ...
    rv = _bcm_robo_l2_traverse_mem(unit, L2_ARLm, NULL, trav_st, FALSE, 0);
        ...
        bcm_l2_traverse_cb trav_fn, void *user_data)
{
    ...
    rv = _bcm_robo_l2_traverse_mem(unit, L2_ARLm, &int_match_addr, 
