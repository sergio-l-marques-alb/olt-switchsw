/*
* $Id: set_tdm.c 1.18 Broadcom SDK $
...
**/
int TDM_scheduler(int wc_array[NUM_WC][4], enum port_speed speed[NUM_EXT_PORTS], int *cur_idx, int *pgw_tdm_idx, int *ovs_tdm_idx, int subp, int pgw_tdm_tbl[32], int ovs_tdm_tbl[32], int upperlimit, int iter1, int bw, int port_state_map[128], int iter3, int stop1, int swap_array[32], int *z, int subport)
{
 ...
 **/
int write_mmu_tdm_tbl(int pgw0[32], int pgw1[32], int ovs0[32], int ovs1[32], int mmu[256], int bucket1[16], int bucket2[16], int bucket3[16], int bucket4[16], int x_pipe, int port_state_map[128], int tsc[NUM_WC][4], int bw, enum port_speed speed[NUM_EXT_PORTS])
{
	long int clk;
...
**/
int TDM_scheduler_wrap(int wc_array[NUM_WC][4], enum port_speed speed[NUM_EXT_PORTS], int pgw_tdm_tbl[32], int ovs_tdm_tbl[32], int pgw_num, int bw, int port_state_map[128], int iter2, int stop) 
{
 ...
 **/
void chk_tdm_tbl( enum port_speed speed[NUM_EXT_PORTS], int core_bw,
