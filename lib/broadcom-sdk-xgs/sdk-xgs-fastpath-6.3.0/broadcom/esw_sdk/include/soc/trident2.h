/*
 * $Id: trident2.h 1.33 Broadcom SDK $
...
#define SOC_TD2_RAM_OFFSET_L3_DEFIP_ALPM_RAW       2048
#define SOC_TD2_RAM_OFFSET_L3_DEFIP_ALPM_IPV6_128  4096
#define SOC_TD2_RAM_OFFSET_L3_DEFIP_ALPM_IPV6_64_1 3072
#define SOC_TD2_RAM_OFFSET_L3_DEFIP_ALPM_IPV4      6144
#define SOC_TD2_RAM_OFFSET_L3_DEFIP_ALPM_IPV4_1    4096
...
extern int soc_trident2_port_config_init(int unit, uint16 dev_id);
extern int soc_trident2_chip_reset(int unit);
extern int soc_trident2_tsc_reset(int unit);
extern int soc_trident2_port_lanes_set(int unit, soc_port_t port_base,
...
extern int soc_trident2_port_lanes_get(int unit, soc_port_t port_base,
                                       int *cur_lanes);
extern int soc_trident2_show_temperature_monitor(int unit);
...
enum td2_l3_hash_key_type_e {
    ...
    TD2_L3_HASH_KEY_TYPE_LMEP = 6,
    TD2_L3_HASH_KEY_TYPE_RMEP = 7,
    TD2_L3_HASH_KEY_TYPE_TRILL = 8,
    TD2_L3_HASH_KEY_TYPE_LMEP_SVID_CVID = 9,
    TD2_L3_HASH_KEY_TYPE_RMEP_SVID_CVID = 10,
    /* 11 is not used */
...
extern uint32 _soc_trident2_piped_mem_index(int unit, soc_port_t port,
                                 soc_mem_t mem, int arr_sz, int arr_off);

#define SOC_TD2_MMU_PIPED_MEM_INDEX(u,p,m,asz,off) \
                    _soc_trident2_piped_mem_index((u),(p),(m),(asz),(off))
