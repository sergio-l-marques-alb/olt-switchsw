/*
 * $Id: 39706bd1eb336ae83fdd780552e5446c487c5eef $
 * 
...
typedef enum bcm_pkt_timestamp_mode_e {
    BCM_PKT_TIMESTAMP_MODE_NONE,    /* No Timestamp */
    BCM_PKT_TIMESTAMP_MODE_PTP,     /* Timestamp mode - PTP. */
    BCM_PKT_TIMESTAMP_MODE_NTP,     /* Timestamp mode - NTP. */
    BCM_PKT_TIMESTAMP_MODE_NUM      /* Max value - Not to be used */
} bcm_pkt_timestamp_mode_t;

/* OAM LM counter options. */
typedef enum bcm_pkt_oam_lm_counter_mode_e {
    BCM_PKT_OAM_LM_COUNTER_MODE_NONE,   /* No LM counter operation */
    BCM_PKT_OAM_LM_COUNTER_MODE_INCREMENT, /* Increment LM counter. */
    BCM_PKT_OAM_LM_COUNTER_MODE_SAMPLE, /* Sample LM counter. */
    BCM_PKT_OAM_LM_COUNTER_MODE_NUM     /* Max value - Not to be used */
...
#define BCM_PKT_F2_TIMESTAMP_MODE       0x8        /* OAM DM time stamp type -
                                                      see
                                                      bcm_pkt_timestamp_mode_t
                                                      element, No-op by default */
#define BCM_PKT_F2_SAMPLE_RDI           0x10       /* OAM - Sample RDI bit. */
#define BCM_PKT_F2_MA_PTR               0x20       /* OAM - MA Pointer . */
#define BCM_PKT_F2_MEP_TYPE_UPMEP       0x40       /* OAM - MEP type - UP/DOWN */
#define BCM_PKT_F2_LM_COUNTER_INDEX_2   0x80       /* OAM -Second LM counter
                                                      index. */
#define BCM_PKT_F2_COUNTER_MODE_1       0x100      /* OAM - Counter 1 mode - Use
                                                      specified counter actions,
                                                      no-op by default */
#define BCM_PKT_F2_COUNTER_MODE_2       0x200      /* OAM - Counter 2 mode - Use
                                                      specified counter actions,
                                                      no-op by default */
