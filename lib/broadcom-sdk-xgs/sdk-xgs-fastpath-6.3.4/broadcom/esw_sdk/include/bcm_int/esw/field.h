/*
 * $Id: field.h 1.402.2.5 Broadcom SDK $
...
/* User-Defined Field (UDF) Miscellaneous Flags */
#define _BCM_FIELD_USER_F_NO_ENCAP_STACK (0 << 13)
#define _BCM_FIELD_USER_F_ENCAP_STACK (1 << 13)
