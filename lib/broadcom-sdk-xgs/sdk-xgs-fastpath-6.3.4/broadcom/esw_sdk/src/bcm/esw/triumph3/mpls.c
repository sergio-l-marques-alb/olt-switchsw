...
int bcm_tr3_mpls_label_stat_get(
    int              unit, 
    bcm_mpls_label_t label, 
    bcm_gport_t      port,
    bcm_mpls_stat_t  stat, 
    uint64           *val)
{
   ...
   if (BCM_GPORT_IS_MPLS_PORT(port)) {
        ...
        BCM_IF_ERROR_RETURN(bcm_tr3_mpls_port_stat_counter_get(
        ...
        BCM_IF_ERROR_RETURN(bcm_tr3_mpls_label_stat_counter_get(
...
int bcm_tr3_mpls_label_stat_get32(
    int              unit, 
    bcm_mpls_label_t label, 
    bcm_gport_t      port, 
    bcm_mpls_stat_t  stat, 
