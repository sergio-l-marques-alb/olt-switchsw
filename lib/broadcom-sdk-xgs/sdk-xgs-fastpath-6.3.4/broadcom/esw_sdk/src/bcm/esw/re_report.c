        ...
        *pdir = dir;
        ...
        if (FT_EXPORT_FIFOm == mem) {
            ...
            soc_mem_field64_get(unit, mem, entry, L2_PKT_CNT_Rf,
                                &data->packet_count_to_client);
            soc_mem_field64_get(unit, mem, entry, L2_BYTE_CNT_Rf,
                                &data->byte_count_to_client);
            /*
            soc_mem_field64_get(unit, mem, entry, L4_PKT_CNTf,
                                &data->packet_count);
            soc_mem_field64_get(unit, mem, entry, L4_BYTE_CNTf,
                                &data->byte_count);
            */
