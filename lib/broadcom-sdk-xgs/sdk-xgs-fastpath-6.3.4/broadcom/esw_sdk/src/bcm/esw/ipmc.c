/*
 * $Id: ipmc.c 1.149.4.3 Broadcom SDK $
...
{
#if defined(BCM_KATANA2_SUPPORT)
    int is_local_subport = 0, my_modid, pp_port;
 ...
 *
 */
bcm_error_t bcm_esw_ipmc_stat_counter_get(
            int unit,
            bcm_ipmc_addr_t *info,
...
#if defined(BCM_TRIDENT2_SUPPORT)
    if (SOC_IS_TD2_TT2(unit)) { 
        return _bcm_td2_ipmc_stat_counter_get(unit, info, stat, 
