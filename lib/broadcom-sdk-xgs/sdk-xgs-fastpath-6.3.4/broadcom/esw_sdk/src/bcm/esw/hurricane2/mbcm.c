...
mbcm_functions_t mbcm_hurricane2_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_hu_cosq_discard_set,
    bcm_hu_cosq_discard_get,
    bcm_hu_cosq_discard_port_set,
    bcm_hu_cosq_discard_port_get,
...
#else  /* BCM_HURRICANE2_SUPPORT */
int bcm_esw_hurricane2_mbcm_not_empty;
