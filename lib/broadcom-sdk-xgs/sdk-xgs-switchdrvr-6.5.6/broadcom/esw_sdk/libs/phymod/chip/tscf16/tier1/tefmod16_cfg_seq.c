...
int tefmod16_autoneg_set(PHYMOD_ST* pc, tefmod16_an_adv_ability_t *cl73_adv)
{
  ...
  if((cl73_adv->an_base_speed  >> TEFMOD16_CL73_25GBASE_KR1 ) & 1) {
    ...
    AN_X4_LD_BASE_ABIL3r_BASE_25G_KR1_SELf_SET(AN_X4_LD_BASE_ABIL3r_reg, 9);
  }     
  if((cl73_adv->an_base_speed  >> TEFMOD16_CL73_25GBASE_CR1 ) & 1) {
    ...
    /* IEEE bit location for KR1/Cr1 is 9 */ 
    AN_X4_LD_BASE_ABIL3r_BASE_25G_CR1_SELf_SET(AN_X4_LD_BASE_ABIL3r_reg, 9);
  }     
  if((cl73_adv->an_base_speed  >> TEFMOD16_CL73_25GBASE_KRS1 ) & 1) {
    ...
    AN_X4_LD_BASE_ABIL4r_BASE_25G_KRS1_SELf_SET(AN_X4_LD_BASE_ABIL4r_reg, 10);
  }     
  if((cl73_adv->an_base_speed  >> TEFMOD16_CL73_25GBASE_CRS1 ) & 1) {
     ...
     AN_X4_LD_BASE_ABIL4r_BASE_25G_CRS1_SELf_SET(AN_X4_LD_BASE_ABIL4r_reg, 10);
  }     
  MODIFY_AN_X4_LD_BASE_ABIL3r(pc, AN_X4_LD_BASE_ABIL3r_reg);
  MODIFY_AN_X4_LD_BASE_ABIL4r(pc, AN_X4_LD_BASE_ABIL4r_reg);
  ...
  if ((cl73_adv->an_bam_speed) || (cl73_adv->an_bam_speed1)) {
    ...
    if (cl73_adv->an_fec & TEFMOD16_FEC_CL91_SUPRTD_REQSTD) {
     ...
     MODIFY_AN_X4_LD_UP1_ABIL1r(pc, AN_X4_ABILITIES_LD_UP1_ABILITIES_1r_reg);
  }
