...
/** @file merlin16_tsc_access.h
 * Implementation of API uC access functions
 */

#ifndef MERLIN16_TSC_API_ACCESS_H
#define MERLIN16_TSC_API_ACCESS_H
 ...
 */
uint8_t merlin16_tsc_rdbl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t merlin16_tsc_rdwl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t merlin16_tsc_rdbls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t merlin16_tsc_rdwls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin16_tsc_rdbc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin16_tsc_rdwc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin16_tsc_rdbcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin16_tsc_rdwcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 */
uint32_t merlin16_tsc_rd_long_uc_prog_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_wr_long_uc_ram(srds_access_t *sa__, uint16_t addr, uint32_t wr_val);
 ...
 */
uint32_t merlin16_tsc_rd_long_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin16_tsc_rdw_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin16_tsc_rdb_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin16_tsc_rdws_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin16_tsc_rdbs_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
