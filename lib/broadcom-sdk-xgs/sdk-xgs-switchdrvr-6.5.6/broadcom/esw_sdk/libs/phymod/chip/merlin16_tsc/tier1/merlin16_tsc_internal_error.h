...
/** @file merlin16_tsc_internal_error.h
 * Internal API error functions
 */

#ifndef MERLIN16_TSC_API_INTERNAL_ERROR_H
#define MERLIN16_TSC_API_INTERNAL_ERROR_H
 ...
 */
#define _error(err_code) merlin16_tsc_INTERNAL_print_err_msg(err_code)
 ...
 * @return Error Code
 */
err_code_t merlin16_tsc_INTERNAL_print_err_msg(uint16_t err_code);
 ...
 */
char* merlin16_tsc_INTERNAL_e2s_err_code(err_code_t err_code);
