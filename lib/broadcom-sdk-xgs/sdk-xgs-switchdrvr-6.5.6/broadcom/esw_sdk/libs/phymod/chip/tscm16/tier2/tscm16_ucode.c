...
#define MERLIN16_TSC_UCODE_IMAGE_VERSION "D101_0C"  /* matches the version number from microcode */
#define MERLIN16_TSC_UCODE_IMAGE_SIZE    31368
#define MERLIN16_TSC_UCODE_IMAGE_CRC     0x2C25

unsigned short tscm16_ucode_ver = 0xD101;
unsigned short tscm16_ucode_crc = MERLIN16_TSC_UCODE_IMAGE_CRC; 
unsigned short tscm16_ucode_len = MERLIN16_TSC_UCODE_IMAGE_SIZE; 

unsigned char tscm16_ucode[] = {
