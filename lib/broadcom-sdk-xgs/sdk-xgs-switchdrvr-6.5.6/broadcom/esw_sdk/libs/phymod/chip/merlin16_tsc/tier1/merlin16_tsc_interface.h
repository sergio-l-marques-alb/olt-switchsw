 ...
 * (http://ingbu.broadcom.com/hsip/merlin16_tsc/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * merlin16_tsc_interface.h - provides the primary functionality.
 *
 * merlin16_tsc_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file merlin16_tsc_interface.h
 * Main interface functions provided to IP User
 */

#ifndef MERLIN16_TSC_API_INTERFACE_H
#define MERLIN16_TSC_API_INTERFACE_H
