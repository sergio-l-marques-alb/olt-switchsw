...
/** @file merlin16_tsc_internal.h
 * Internal API functions
 */

#ifndef MERLIN16_TSC_API_INTERNAL_H
#define MERLIN16_TSC_API_INTERNAL_H
...
typedef struct {
  ...
  /** PLL Divider value.  (Same encoding as enum merlin16_tsc_pll_div_enum.) */
  uint32_t pll_div;
  /** PLL Lock */
  uint8_t  pll_lock;
...
merlin16_tsc_info_t *merlin16_tsc_INTERNAL_get_merlin16_tsc_info_ptr(void);

/** Verify the internal merlin16_tsc_info.
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_verify_merlin16_tsc_info(merlin16_tsc_info_t const *test_info);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_afe_hw_version(srds_access_t *sa__, uint8_t *afe_hw_version);
 ...
 */
err_code_t merlin16_tsc_INTERNAL_check_uc_lane_stopped(srds_access_t *sa__);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_calc_patt_gen_mode_sel(uint8_t *mode_sel, uint8_t *zero_pad_len, uint8_t patt_length);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_uc_core_config(srds_access_t *sa__, struct merlin16_tsc_uc_core_config_st struct_val);

/*---------------------*/
/*  PLL Configuration  */
/*---------------------*/

/** Return whether the fraction portion of a merlin16_tsc_pll_div_enum value is nonzero. */
#define SRDS_INTERNAL_IS_PLL_DIV_FRACTIONAL(div_) (((uint32_t)(div_) & 0xFFFFF000UL) != 0)

/** Extract the integer portion of a merlin16_tsc_pll_div_enum value. */
#define SRDS_INTERNAL_GET_PLL_DIV_INTEGER(div_) (((uint32_t)(div_)) & 0x00000FFFUL)

/** Extract the fraction portion of a merlin16_tsc_pll_div_enum value.
...
/** Compose a value in the same format as a merlin16_tsc_pll_div_enum value.
 ...
 * @param refclk Reference clock frequency (enumerated), or MERLIN16_TSC_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param *refclk_freq_hz Resultant reference clock frequency, in Hz.
 * @param *div Divider value (enumerated), or MERLIN16_TSC_PLL_DIV_UNKNOWN to auto-compute.
 *             The final divider value will be filled in if MERLIN16_TSC_PLL_DIV_UNKNOWN.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_resolve_pll_parameters(enum merlin16_tsc_pll_refclk_enum refclk,
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *div Divider value, in the same encoding as enum merlin16_tsc_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
 ...
 * as part of merlin16_tsc_display_core_state_line()
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param div Divider value, in the same encoding as enum merlin16_tsc_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_display_pll_to_divider(srds_access_t *sa__, uint32_t div);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
  */
err_code_t merlin16_tsc_INTERNAL_trnsum_clear_and_enable(srds_access_t *sa__);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_move_clkp1_offset(srds_access_t *sa__, int8_t delta);
 ...
 */
int16_t merlin16_tsc_INTERNAL_ladder_setting_to_mV(srds_access_t *sa__, int8_t ctrl, uint8_t range_250);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_p1_threshold(srds_access_t *sa__, int8_t threshold);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_p1_threshold(srds_access_t *sa__, int8_t *val);
 ...
 * @return value of a * b
 */
uint32_t merlin16_tsc_INTERNAL_mult_with_overflow_check(uint32_t a, uint32_t b, uint8_t *of);
 ...
 */
err_code_t merlin16_tsc_INTERNAL_compute_bin(char var, char bin[]);
 ...
 */
err_code_t merlin16_tsc_INTERNAL_compute_hex(char bin[], uint8_t *hex);
...
} merlin16_tsc_INTERNAL_event_log_dump_state_t;

/** Callback function for dumping event log, intended to be called by merlin16_tsc_INTERNAL_read_event_log_with_callback.
 *  It must also be called once after, with a byte count of 0, to finish printing.
 * @param *arg is a merlin16_tsc_INTERNAL_event_log_dump_state_t pointer for holding state.
 ...
 */
err_code_t merlin16_tsc_INTERNAL_event_log_dump_callback(void *arg, uint8_t byte_count, uint16_t data);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_read_event_log_with_callback(srds_access_t *sa__,
                                                        uint8_t micro_num,
 ...
 */
uint32_t merlin16_tsc_INTERNAL_float8_to_int32(float8_t input);
 ...
 */
float8_t merlin16_tsc_INTERNAL_int32_to_float8(uint32_t input);
#endif
 ...
 * @return Usigned 32bit number
 */
uint32_t merlin16_tsc_INTERNAL_float12_to_uint32(uint8_t byte, uint8_t multi);
 ...
 */
uint8_t merlin16_tsc_INTERNAL_uint32_to_float12(uint32_t input, uint8_t *multi);
#endif

/*-----------------------------*/
/*  Read / Display Core state  */
/*-----------------------------*/
/** Read current merlin16_tsc core status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin16_tsc core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_read_core_state(srds_access_t *sa__, merlin16_tsc_core_state_st *istate);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_display_core_state_no_newline(srds_access_t *sa__);

/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current merlin16_tsc lane status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin16_tsc lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_read_lane_state(srds_access_t *sa__, merlin16_tsc_lane_state_st *istate);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_osr_mode(srds_access_t *sa__, merlin16_tsc_osr_mode_st *mode);
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_lock Current merlin16_tsc lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current merlin16_tsc lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_pmd_lock_status(srds_access_t *sa__, uint8_t *pmd_lock, uint8_t *pmd_lock_chg);

/** Read current Signal_detect and Signal_detect change status of a lane.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *sig_det Current merlin16_tsc lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current merlin16_tsc lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_sigdet_status(srds_access_t *sa__, uint8_t *sig_det, uint8_t *sig_det_chg);

/** Read current PLL Lock and PLL Lock change status of a core.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pll_lock Current merlin16_tsc lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current merlin16_tsc lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_pll_lock_status(srds_access_t *sa__, uint8_t *pll_lock, uint8_t *pll_lock_chg);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_display_lane_state_no_newline(srds_access_t *sa__);
 ...
 */
uint16_t merlin16_tsc_INTERNAL_eye_to_mV(srds_access_t *sa__, uint8_t var, uint8_t ladder_range);
 ...
 * @return Eye opening in mV
 */
uint16_t merlin16_tsc_INTERNAL_eye_to_mUI(srds_access_t *sa__, uint8_t var);


/** Serdes Core ClockGate.
 * Along with merlin16_tsc_core_clkgate(), all lanes should also be clock gated using merlin16_tsc_lane_clkgate() to complete a Core Clockgate
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param enable Enable clockgate (1 = Enable clokgate; 0 = Disable clockgate)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_core_clkgate(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_lane_clkgate(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_pf_main(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_pf_main(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_pf2(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_pf2(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_vga(srds_access_t *sa__, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_vga(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_dfe1(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_dfe1(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_dfe2(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_dfe2(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_dfe3(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_dfe3(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_dfe4(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_dfe4(srds_access_t *sa__, int8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_set_rx_dfe5(srds_access_t *sa__, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_get_rx_dfe5(srds_access_t *sa__, int8_t *val);


/* Set/Get TX Tap values */
err_code_t merlin16_tsc_INTERNAL_get_tx_pre(srds_access_t *sa__, int8_t *val);
err_code_t merlin16_tsc_INTERNAL_get_tx_main(srds_access_t *sa__, int8_t *val);
err_code_t merlin16_tsc_INTERNAL_get_tx_post1(srds_access_t *sa__, int8_t *val);
err_code_t merlin16_tsc_INTERNAL_get_tx_post2(srds_access_t *sa__, int8_t *val);

/* Lane Config Struct */
err_code_t merlin16_tsc_INTERNAL_update_uc_lane_config_st(struct merlin16_tsc_uc_lane_config_st *st);
err_code_t merlin16_tsc_INTERNAL_update_uc_lane_config_word(struct merlin16_tsc_uc_lane_config_st *st);

/* Lane User Control Disable Startup Function Struct */
err_code_t merlin16_tsc_INTERNAL_update_usr_ctrl_disable_functions_st(struct merlin16_tsc_usr_ctrl_disable_functions_st *st);
err_code_t merlin16_tsc_INTERNAL_update_usr_ctrl_disable_functions_byte(struct merlin16_tsc_usr_ctrl_disable_functions_st *st);

/* Lane User Control Disable Startup DFE Function Struct */
err_code_t merlin16_tsc_INTERNAL_update_usr_ctrl_disable_dfe_functions_st(struct merlin16_tsc_usr_ctrl_disable_dfe_functions_st *st);
err_code_t merlin16_tsc_INTERNAL_update_usr_ctrl_disable_dfe_functions_byte(struct merlin16_tsc_usr_ctrl_disable_dfe_functions_st *st);

/* Core Config Struct */
err_code_t merlin16_tsc_INTERNAL_update_uc_core_config_st(struct  merlin16_tsc_uc_core_config_st *st);
err_code_t merlin16_tsc_INTERNAL_update_uc_core_config_word(struct  merlin16_tsc_uc_core_config_st *st);

uint8_t merlin16_tsc_INTERNAL_rdb_uc_var(srds_access_t *sa__, err_code_t *err_code_p, uint16_t addr);
uint16_t merlin16_tsc_INTERNAL_rdw_uc_var(srds_access_t *sa__, err_code_t *err_code_p, uint16_t addr);
err_code_t merlin16_tsc_INTERNAL_wrb_uc_var(srds_access_t *sa__, uint16_t addr, uint8_t wr_val);
err_code_t merlin16_tsc_INTERNAL_wrw_uc_var(srds_access_t *sa__, uint16_t addr, uint16_t wr_val);

/*--------------------------*/
/*  Register field polling  */
/*--------------------------*/

err_code_t merlin16_tsc_INTERNAL_print_uc_dsc_error(srds_access_t *sa__, enum srds_pmd_uc_cmd_enum cmd);

/** Polls lane variable "usr_diag_status" to verify data is available in uC diag buffer.
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin16_tsc_internal.c.
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 */
err_code_t merlin16_tsc_INTERNAL_poll_diag_done(srds_access_t *sa__, uint16_t *status, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_poll_uc_dsc_ready_for_cmd_equals_1(srds_access_t *sa__, uint32_t timeout_ms, enum srds_pmd_uc_cmd_enum cmd);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_poll_dsc_state_equals_uc_tune(srds_access_t *sa__, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_poll_st_afe_tx_fifo_resetb_equals_1(srds_access_t *sa__, uint32_t timeout_ms);
 ...
 * @return Error code generated by polling function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_poll_micro_ra_initdone(srds_access_t *sa__, uint32_t timeout_ms);
...
static const int merlin16_tsc_endian_const = 1;
#define is_big_endian() ((*(char*)&merlin16_tsc_endian_const) == 0)
...
typedef struct {
    uint8_t *mem_ptr;
} merlin16_tsc_INTERNAL_rdblk_callback_arg_t;

/** Callback function for reading uc RAM memory by merlin16_tsc_INTERNAL_rdblk_uc_generic_ram().
 * @param *arg is a merlin16_tsc_INTERNAL_rdblk_callback_arg_t pointer for holding state.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_rdblk_callback(void *arg, uint8_t byte_count, uint16_t data);
 ...
 */
err_code_t merlin16_tsc_INTERNAL_rdblk_uc_generic_ram(srds_access_t *sa__,
                                                uint32_t block_addr,
                                                uint16_t block_size,
 ...
 *         indefinitely, until cnt bytes total are read.
 *  In other words, this is the same as merlin16_tsc_INTERNAL_rdblk_uc_generic_ram(), but reading in descending address order.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param block_addr Address of RAM block to be read.
 *                   For program RAM, the upper 16 bits are 0x0000.  Otherwise, the upper 16 bits are 0x2000.
 * @param block_size Length of RAM block to read.
 ...
 * @return Error Code generated by API or the callback (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_tsc_INTERNAL_rdblk_uc_generic_ram_descending(srds_access_t *sa__,
                                                           uint32_t block_addr,
                                                           uint16_t block_size,
                                                           uint16_t start_offset,
                                                           uint16_t cnt,
