...
err_code_t falcon16_tsc_map_lanes(srds_access_t *sa__, uint8_t num_lanes, uint8_t const *tx_lane_map, uint8_t const *rx_lane_map) {
     ...
     */
    wrc_tx_lane_addr_0(*(tx_lane_map++)); wrc_rx_lane_addr_0(*(rx_lane_map++));
#if defined(wrc_tx_lane_addr_1)
    if (num_lanes > 1) { wrc_tx_lane_addr_1(*(tx_lane_map++)); wrc_rx_lane_addr_1(*(rx_lane_map++)); }
#if defined(wrc_tx_lane_addr_2)
    if (num_lanes > 2) { wrc_tx_lane_addr_2(*(tx_lane_map++)); wrc_rx_lane_addr_2(*(rx_lane_map++)); }
#if defined(wrc_tx_lane_addr_3)
    if (num_lanes > 3) { wrc_tx_lane_addr_3(*(tx_lane_map++)); wrc_rx_lane_addr_3(*(rx_lane_map++)); }
#if defined(wrc_tx_lane_addr_4)
    if (num_lanes > 4) { wrc_tx_lane_addr_4(*(tx_lane_map++)); wrc_rx_lane_addr_4(*(rx_lane_map++)); }
#if defined(wrc_tx_lane_addr_5)
    if (num_lanes > 5) { wrc_tx_lane_addr_5(*(tx_lane_map++)); wrc_rx_lane_addr_5(*(rx_lane_map++)); }
#if defined(wrc_tx_lane_addr_6)
    if (num_lanes > 6) { wrc_tx_lane_addr_6(*(tx_lane_map++)); wrc_rx_lane_addr_6(*(rx_lane_map++)); }
#if defined(wrc_tx_lane_addr_7)
    if (num_lanes > 7) { wrc_tx_lane_addr_7(*(tx_lane_map++)); wrc_rx_lane_addr_7(*(rx_lane_map++)); }
#endif
#endif
#endif
#endif
