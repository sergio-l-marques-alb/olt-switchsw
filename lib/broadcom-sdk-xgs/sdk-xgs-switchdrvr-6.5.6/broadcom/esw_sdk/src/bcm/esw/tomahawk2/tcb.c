                                 ...
                                 bcm_cosq_buffer_id_t buffer_id, int enable)
{
    ...
    if (-1 == buffer_id) {
        ...
        field = _bcm_th2_cosq_tcb_freeze_fields[buffer_id];
                                ...
                                int num, bcm_cosq_tcb_buffer_t *record_entries)
{
    ...
    uint8 *tcb_md_buf = NULL;
    int i, j, idx, wrapped;
    int dgpp, src_port, qnum, depth;
    bcm_port_t local_port, phy_port;
    ...
    if (wrapped) {
        ...
        for (i = idx + 1, j = 0; j < num; i++, j++) {
            ...
            phy_port = si->port_m2p_mapping[src_port];
                                 ...
                                 int num, bcm_cosq_tcb_event_t *record_entries)
{
    ...
    bcm_port_t local_port, phy_port;
    bcm_cos_queue_t cosq;
    int dgpp, src_port, qnum, drop_reason = 0, drop_vector, depth;
    soc_info_t *si;
    ...
    SOC_IF_ERROR_RETURN(soc_mem_read_range(unit, mem, MEM_BLOCK_ANY, 0, num,
                                           tcb_evt_buf));
