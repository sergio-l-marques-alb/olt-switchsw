...
mbcm_functions_t mbcm_conqueror_driver = {
    /*  L2 functions */
    ...
    bcm_sc_cosq_port_bandwidth_set,
    bcm_sc_cosq_port_bandwidth_get,
    bcm_sc_cosq_discard_set,
    bcm_sc_cosq_discard_get,
    bcm_sc_cosq_discard_port_set,
    bcm_sc_cosq_discard_port_get,
