...
l2mc_fp_change_vlan_redirect(int unit, bcm_vlan_t old_vlan, bcm_vlan_t new_vlan,
    ...
    (void) soc_mem_read(unit, L2MCm, COPYNO_ALL, l2mc_index, l2mc_entry.entry_data);
    ...
    (void) soc_mem_write(unit, L2MCm, COPYNO_ALL, l2mc_index, l2mc_entry.entry_data);
...
l2mc_chk_port_rate(int unit)
{
    ...
    rate_calc->tolerance_lr = RATE_TOLERANCE_LR_PARAM_DEFAULT;
    rate_calc->tolerance_os = RATE_TOLERANCE_OV_PARAM_DEFAULT;
