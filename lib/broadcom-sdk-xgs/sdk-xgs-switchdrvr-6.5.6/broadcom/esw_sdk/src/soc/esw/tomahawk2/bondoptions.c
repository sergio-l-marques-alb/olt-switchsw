...
soc_tomahawk2_bond_info_init(int unit)
{
    ...
    int feature_enables[][3] = {
        ...
        {609, 0, socBondInfoFeatureNoCutThru     },  /* CUT_THRU_DISABLE     */
        ...
        {696, 1, socBondInfoFeatureNoPktStats    },  /* PKT_STATS_ENABLE     */
        {697, 1, socBondInfoFeatureNoTrafficCaptureBuffer},  /* TCB_ENABLE     */
