...
#ifdef INCLUDE_PLP_IMACSEC
#define IMACSEC_MDIO_ADDR_GET(id) ((id & 0xff)<<0)
extern void _bcm_plp_seahawks_register_mdio_primitives(
...
_phy_bcm54280_init(int unit, soc_port_t port)
{
    ...
    imacsec_des = (bcm_plp_base_t_sec_phy_access_t *)(((char *)pc->driver_data + pc->size) - sizeof(bcm_plp_base_t_sec_phy_access_t));
    ...
    _bcm_plp_seahawks_register_mdio_primitives(
                         ...
                         int copper_enable)
{
    ...
    phy_bcm542xx_direct_reg_write(unit, pc,
                                  PHY_BCM542XX_DSP_TAP10_REG_OFFSET,
                                  0x011B);
    /* Disable Super Isolate for 54292/54291/54182/54185/54192/54195/54282/54285 */
    if ( PHY_IS_BCM54292(pc) || PHY_IS_BCM54182(pc) || PHY_IS_BCM54192(pc) || PHY_IS_BCM54282(pc) || PHY_IS_BCM54285(pc) ) {
        /* only 54291/292/182/185 have Super Isolate enabled by default */
        phy_bcm542xx_direct_reg_modify(unit, pc,
