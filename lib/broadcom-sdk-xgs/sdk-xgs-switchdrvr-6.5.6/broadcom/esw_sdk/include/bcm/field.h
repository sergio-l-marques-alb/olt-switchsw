...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQaulifyPreselId = 619,      /* Program selection value in 2nd Pass
                                           ...
                                           preselector-id. */
    bcmFieldQualifyCount = 620          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionDynamicTrunkAllEnable = 448, /* Force packets to use DLB when matched
                                           by IFP rules, even though the Group
                                           Table indicates hash-based load
                                           balancing is to be used. */
    bcmFieldActionDynamicEcmpCancel = bcmFieldActionEcmpLoadBalanceCancel, /* Same as
                                           bcmFieldActionEcmpLoadBalanceCancel. */
    bcmFieldActionDynamicTrunkAllCancel = 449, /* Force packets to use hash-based load
    ...
    bcmFieldActionCount = 466           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
{ \
    ...
    "MplsLabel1ExpNew", \
    "DynamicEcmpEnable", \
    "DynamicTrunkAllEnable", \
    "DynamicTrunkAllCancel", \
    "Dgm", \
    "DgmThreshold", \
    "DgmBias", \
    "DgmCost", \
