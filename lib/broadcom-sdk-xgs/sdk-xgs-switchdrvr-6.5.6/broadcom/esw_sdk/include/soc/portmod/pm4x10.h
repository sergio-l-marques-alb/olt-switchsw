...
int pm4x10_port_fec_enable_set(int unit, int port, pm_info_t pm_info, uint32_t enable);
int pm4x10_port_fec_enable_get(int unit, int port, pm_info_t pm_info, uint32_t* enable);
...
/*get pll multiplier*/
int pm4x10_port_pll_div_get(int unit, int port, const portmod_port_resources_t* port_resource, uint32_t* pll_div);
