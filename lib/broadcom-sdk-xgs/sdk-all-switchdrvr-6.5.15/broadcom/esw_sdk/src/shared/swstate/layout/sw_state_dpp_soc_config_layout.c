...
int sw_state_dpp_soc_config_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   soc_dpp_soc_config_t* dummy_struct; 
#endif /* (defined(BCM_PETRA_SUPPORT)) */ 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(soc_dpp_soc_config_t),"soc_dpp_soc_config_t"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "config",             /* name */         
                                   sizeof(soc_dpp_soc_config_t),    /* size of the element's type*/          
                                   0,                 /* nof pointers */ 
                                   "soc_dpp_soc_config_t",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
...
#if defined(BCM_PETRA_SUPPORT)
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_config_autosync_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   ...
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->autosync)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
#endif /* defined(BCM_PETRA_SUPPORT)*/ 

#if defined(BCM_PETRA_SUPPORT)
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_config_version_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->version)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
#endif /* defined(BCM_PETRA_SUPPORT)*/ 

#if defined(BCM_PETRA_SUPPORT)
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_config_nested_api_counter_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->nested_api_counter)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   ...
                                   0,                 /* nof pointers */ 
                                   "char",              /* param type */
                                   DPP_SOC_CONFIG_VERSION_LENGTH_MAX,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
