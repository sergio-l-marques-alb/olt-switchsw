...
int sw_state_dpp_soc_arad_pp_oam_my_mac_lsb_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   ARAD_PP_OAM_MY_MAC_LSB* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(ARAD_PP_OAM_MY_MAC_LSB),"ARAD_PP_OAM_MY_MAC_LSB"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "oam_my_mac_lsb",             /* name */         
                                   sizeof(ARAD_PP_OAM_MY_MAC_LSB),    /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   "ARAD_PP_OAM_MY_MAC_LSB",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_pp_oam_my_mac_lsb_ref_count_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
