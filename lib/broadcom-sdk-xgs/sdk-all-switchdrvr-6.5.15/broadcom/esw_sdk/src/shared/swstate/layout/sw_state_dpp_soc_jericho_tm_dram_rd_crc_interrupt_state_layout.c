...
int sw_state_dpp_soc_jericho_tm_dram_rd_crc_interrupt_state_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "dram_rd_crc_interrupt_state",             /* name */         
