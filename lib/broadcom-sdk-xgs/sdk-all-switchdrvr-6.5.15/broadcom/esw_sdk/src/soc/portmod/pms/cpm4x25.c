...
int cpm4x25_cpri_port_tx_frame_tgen_next_hfn_get(int unit, int port, pm_info_t pm_info, uint32* hfn)
{
    ...
    _SOC_IF_ERR_EXIT
        (cprimod_tx_framer_tgen_next_hfn_get(unit, port, hfn));
...
int cpm4x25_cpri_port_tx_frame_tgen_next_bfn_get(int unit, int port, pm_info_t pm_info, uint32* bfn)
{
    ...
    _SOC_IF_ERR_EXIT
        (cprimod_tx_framer_tgen_next_bfn_get(unit, port, bfn));
exit:
    SOC_FUNC_RETURN;
...
int cpm4x25_cpri_port_tx_vsd_flow_get(int unit, int port, pm_info_t pm_info, uint32 group_id, portmod_cpri_tx_vsd_flow_info_t* flow_info)
{
    ...
    _SOC_IF_ERR_EXIT
        (cprimod_cpri_port_tx_vsd_ctrl_flow_get(unit, port, group_id, flow_info));
...
int cpm4x25_cpri_port_tx_cw_sync_info_set(int unit, int port, pm_info_t pm_info, const uint32 hyper_frame_num, const uint32 radio_frame_num)
{
    ...
    _SOC_IF_ERR_EXIT
        (cprimod_tx_framer_tgen_next_hfn_set(unit,port, hyper_frame_num));
    _SOC_IF_ERR_EXIT
        (cprimod_tx_framer_tgen_next_bfn_set(unit,port, radio_frame_num));
...
int cpm4x25_cpri_port_tx_cw_sync_info_get(int unit, int port, pm_info_t pm_info, uint32* hyper_frame_num, uint32* radio_frame_num)
{
    ...
    _SOC_IF_ERR_EXIT
        (cprimod_tx_framer_tgen_next_hfn_get(unit,port,hyper_frame_num));
    _SOC_IF_ERR_EXIT
        (cprimod_tx_framer_tgen_next_bfn_get(unit,port,radio_frame_num));
...
{
    SOC_INIT_FUNC_DEFS;
    _SOC_IF_ERR_EXIT(cprimod_fast_clk_bit_time_period_set(unit, port, speed));
                                              ...
                                              const portmod_cpri_rx_agnostic_config_info_t* config_info)
{
  ...
  /*
    ...
    if (config_info->hyper_frame_offset == 0) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Agnostic Mode - Syncing on Hyper Frame Number 0 is not supported in this release.\n"));
    }
                                              ...
                                              portmod_cpri_rx_agnostic_config_info_t* config_info)
{
    ...
    _SOC_IF_ERR_EXIT
        (cprimod_encap_presentation_time_enable_get(unit, port, enable));
   ...
   /*
    ...
    if (enable ) {
       ...
       /*
        ...
        _SOC_IF_ERR_EXIT
            (cprimod_port_tx_interface_config_set(unit, port, &phy_access, &interface_config));
    }
                                                ...
                                                const portmod_cpri_rx_tunnel_mode_config_t* config_info)
{
     ...
     */
    _SOC_IF_ERR_EXIT
        (cprimod_cpri_port_rx_tunnel_mode_set(unit, port, enable, roe_payload_size));
...
int cpm4x25_cpri_port_rx_tunnel_mode_config_get(int unit, int port, pm_info_t pm_info, int* enable, portmod_cpri_rx_tunnel_mode_config_t* config_info)
{
    ...
    if (pcs_tunnel_mode_enable) {
         ...
         */
        *enable = TRUE;
        config_info->payload_size = roe_payload_size/8;
