...
const soc_dnxf_cgm_threshold_to_reg_binding_t ramon_soc_cgm_threshold_to_register_table[] = {
    /*threshold_type,                              th_handle_case               nof_registers_to_write_to    reg_description_ptr                */
    ...
    {_SHR_FABRIC_SHARED_DROP_CLASS_TH,             soc_dnxf_cgm_reg_structure_1,      2,                  LCM_DFL_PIPE_CLASS_SHARED_ADMIT_TH_METHOD_X_description }, /*X means it includes both method 1 and method 2*/
    ...
    {_SHR_FABRIC_TX_TAG_DROP_CLASS_TH,             soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_ADMIT_XLR_TAG_TH_PROFILE_description            }, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_DROP_CLASS_TH,            soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_ADMIT_XLR_FRAG_TH_PROFILE_description           }, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_TAG_GCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_GCI_TAG_TH_XLR_PROFILE_description              }, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_GCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_GCI_FRAG_TH_XLR_PROFILE_description             }, /*XLR means it includes both LR and NLR*/
    ...
    {_SHR_FABRIC_SHARED_GCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_GCI_TH_METHOD_X_description                     }, /*X means it includes both method 1 and method 2*/
    ...
    {_SHR_FABRIC_TX_TAG_RCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_RCI_TAG_TH_XLR_PROFILE_description              }, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_RCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_RCI_FRAG_TH_XLR_PROFILE_description             }, /*XLR means it includes both LR and NLR*/
    ...
    {_SHR_FABRIC_SHARED_RCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_RCI_TH_METHOD_X_description                     }, /*X means it includes both method 1 and method 2*/
    ...
    {_SHR_FABRIC_SHARED_FC_PIPE_TH,                soc_dnxf_cgm_reg_structure_1,      2,                  LCM_DFL_FC_TH_METHOD_X_description                      }, /*X means it includes both method 1 and method 2*/
    {_SHR_FABRIC_TX_TAG_FC_PIPE_TH,                soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_TAG_TH_XLR_PROFILE_description                  }, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_FC_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_FRAG_TH_XLR_PROFILE_description                 }, /*XLR means it includes both LR and NLR*/
    ...
    {_SHR_FABRIC_RX_FRAG_DROP_PIPE_TH,             soc_dnxf_cgm_reg_structure_2,      1,                  DCH_LINK_LEVEL_FLOW_CONTROL_description                 },/* DCH Thresholds*/ /*This is a special case*/
    {_SHR_FABRIC_RX_MC_LOW_PRIO_DROP_PIPE_TH,      soc_dnxf_cgm_reg_structure_2,      1,                  DCH_LINK_LEVEL_FLOW_CONTROL_LOW_PRIO_CELLS_description  }, /* DCH Thresholds*/ /*This is a special case*/
    {_SHR_FABRIC_RX_FRAG_GCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_3,      1,                  DCH_LOCAL_GCI_TYPE_0_P_1_P_description                  },
    {_SHR_FABRIC_RX_LLFCFC_PIPE_TH,                soc_dnxf_cgm_reg_structure_4,      1,                  DCH_LINK_LEVEL_FLOW_CONTROL_P_X_description             },/*P_X means it includes all pipes*/
