...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_modid_local_map_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_modid_group_map_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_modid_modid_to_group_map_dump(unit, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_modid_group_map_raw_dump(unit, group_map_idx_0, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnxf_state_mc_dump(int  unit)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_state_mc_id_map_dump(unit, -1));
 ...
 */
int
dnxf_state_mc_nof_mc_groups_created_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_lb_group_to_first_link_dump(unit, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_port_cl72_conf_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_port_phy_lane_config_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_port_is_connected_to_repeater_dump(unit, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_intr_flags_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_intr_storm_timed_count_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_intr_storm_timed_period_dump(unit, -1));
...
dnxf_state_lane_map_db_dump(int  unit)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_state_lane_map_db_lane2serdes_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnxf_state_lane_map_db_serdes2lane_dump(unit, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnxf_state_synce_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnxf_state_synce_master_synce_enabled_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnxf_state_synce_slave_synce_enabled_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
