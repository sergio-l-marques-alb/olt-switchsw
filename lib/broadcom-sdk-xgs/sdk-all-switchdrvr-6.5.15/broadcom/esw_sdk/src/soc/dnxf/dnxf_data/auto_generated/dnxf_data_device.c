    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_general_define_emulation_system].name = "emulation_system";
    submodule_data->defines[dnxf_data_device_general_define_emulation_system].doc = "Checking if the device is ran on emulation.";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_general_define_emulation_system].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnxf_data_device_general_emulation_system_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_general, dnxf_data_device_general_define_emulation_system);
}
