    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_active_on_init_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_intr_general_table_active_on_init");
    ...
    int unit)
{
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_disable_on_init_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_intr_general_table_disable_on_init");
    ...
    int unit)
{
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_disable_print_on_init_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_intr_general_table_disable_print_on_init");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_ser_mem_mask_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_intr_ser_table_mem_mask");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_ser_xor_mem_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_intr_ser_table_xor_mem");
