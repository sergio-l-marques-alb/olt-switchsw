 ...
 */
static shr_error_e
ramon_a0_dnxf_data_device_general_emulation_system_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_general;
    int define_index = dnxf_data_device_general_define_emulation_system;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnxf_data_device_general_define_emulation_system;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_general_emulation_system_set;
