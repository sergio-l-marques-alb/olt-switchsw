    ...
    int unit)
{
    ...
    define->property.doc = 
        "\n"
        "Firmware load verification method\n"
        "The eight bit of the property value enables firmware CRC calculation\n"
        "\n"
    ;
    define->property.method = dnxc_data_property_method_custom;
    define->property.method_str = "custom";
    ...
    int unit)
{
    ...
    table->values[0].property.doc =
        ...
        "Valid values are 0=125Mhz, 1=156.25Mhz, 3=312.5 MHz.\n"
        "\n"
    ;
    ...
    table->values[0].property.mapping[0].val = soc_dnxc_init_serdes_ref_clock_125;
    table->values[0].property.mapping[1].name = "1";
    table->values[0].property.mapping[1].val = soc_dnxc_init_serdes_ref_clock_156_25;
    table->values[0].property.mapping[2].name = "3";
    table->values[0].property.mapping[2].val = soc_dnxc_init_serdes_ref_clock_312_5;
    ...
    table->values[1].property.doc =
        ...
        "Valid value are 3=312.5 MHz or 'bypass'=PLL bypassed(input ref clock == output ref clock)\n"
        "\n"
    ;
