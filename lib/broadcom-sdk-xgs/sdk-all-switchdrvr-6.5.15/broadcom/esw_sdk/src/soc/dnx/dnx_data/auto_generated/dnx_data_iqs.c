 ...
 */
extern shr_error_e jer2_a0_data_iqs_attach(
    int unit);
/*
 * SUBMODULE - CREDIT:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_max_credit_balance_resolution].name = "max_credit_balance_resolution";
    submodule_data->defines[dnx_data_iqs_credit_define_max_credit_balance_resolution].doc = "highest resolution in bytes units";
    /* Set data type flag */
    submodule_data->defines[dnx_data_iqs_credit_define_max_credit_balance_resolution].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_slow_level_resolution].name = "slow_level_resolution";
    submodule_data->defines[dnx_data_iqs_credit_define_slow_level_resolution].doc = "resolution of credit request slow levels in bytes";
    /* Set data type flag */
    submodule_data->defines[dnx_data_iqs_credit_define_slow_level_resolution].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_credit_resolution_up_th].name = "credit_resolution_up_th";
    submodule_data->defines[dnx_data_iqs_credit_define_credit_resolution_up_th].doc = "[KB]. ]threshold over the delayed size (fabric_delay * port rate) to move to the higher credit resolutoin";
    /* Set data type flag */
    submodule_data->defines[dnx_data_iqs_credit_define_credit_resolution_up_th].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fabric_delay].name = "fabric_delay";
    submodule_data->defines[dnx_data_iqs_credit_define_fabric_delay].doc = "[nano-sec] credit ingress to egress delay";
    /* Set data type flag */
    submodule_data->defines[dnx_data_iqs_credit_define_fabric_delay].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_iqs_credit_define_fabric_multicast_delay].name = "fabric_multicast_delay";
    submodule_data->defines[dnx_data_iqs_credit_define_fabric_multicast_delay].doc = "[nano-sec] credit delay for fmqs";
    /* Set data type flag */
    submodule_data->defines[dnx_data_iqs_credit_define_fabric_multicast_delay].flags |= DNXC_DATA_F_NUMERIC;
     ...
     * Table - bw_level_rate
     */
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].name = "bw_level_rate";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].doc = "stores the read weight profiles that should configured to HW";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].size_of_values = sizeof(dnx_data_iqs_credit_bw_level_rate_t);
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].entry_get = dnx_data_iqs_credit_bw_level_rate_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].nof_keys = 1;
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].keys[0].name = "bw_level";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].keys[0].doc = "bandwidth level";

    /* Values */
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values, dnxc_data_value_t, submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].nof_values, "_dnx_data_iqs_credit_table_bw_level_rate table values");
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[0].name = "max";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[0].type = "uint32";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[0].doc = "max rate for bandwidth level";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[0].offset = UTILEX_OFFSETOF(dnx_data_iqs_credit_bw_level_rate_t, max);
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[1].name = "min";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[1].type = "uint32";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[1].doc = "min rate for bandwidth level";
    submodule_data->tables[dnx_data_iqs_credit_table_bw_level_rate].values[1].offset = UTILEX_OFFSETOF(dnx_data_iqs_credit_bw_level_rate_t, min);
...
uint32
dnx_data_iqs_credit_max_credit_balance_resolution_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_define_max_credit_balance_resolution);
}
...
int
dnx_data_iqs_credit_slow_level_resolution_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_define_slow_level_resolution);
}
...
uint32
dnx_data_iqs_credit_credit_resolution_up_th_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_define_credit_resolution_up_th);
}
...
uint32
dnx_data_iqs_credit_fabric_delay_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_define_fabric_delay);
}

uint32
dnx_data_iqs_credit_fabric_multicast_delay_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_define_fabric_multicast_delay);
}
 ...
 */
/* Table Get */
const dnx_data_iqs_credit_bw_level_rate_t *
dnx_data_iqs_credit_bw_level_rate_get(
    int unit,
    int bw_level)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_table_bw_level_rate);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, bw_level, 0);
    return (const dnx_data_iqs_credit_bw_level_rate_t *) data;

}

/* Get value as str */
shr_error_e
dnx_data_iqs_credit_bw_level_rate_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_iqs_credit_bw_level_rate_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_table_bw_level_rate);
    data = (const dnx_data_iqs_credit_bw_level_rate_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
dnx_data_iqs_credit_bw_level_rate_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_table_bw_level_rate);
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_iqs_attach(unit));
    }
    else
