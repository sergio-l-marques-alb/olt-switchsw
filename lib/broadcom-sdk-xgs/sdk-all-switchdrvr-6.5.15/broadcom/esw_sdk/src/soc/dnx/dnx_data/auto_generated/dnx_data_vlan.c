/** \file dnx_data_vlan.c
 * 
 * MODULE DEVICE DATA - VLAN
 * 
 * Device Data
 ...
 */
extern shr_error_e jer2_a0_data_vlan_attach(
    int unit);
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_vlan_vlan_translate_define_nof_vlan_edit_action_ids].name = "nof_vlan_edit_action_ids";
    submodule_data->defines[dnx_data_vlan_vlan_translate_define_nof_vlan_edit_action_ids].doc = "Number of supported VLAN edit action_ids";
    /* Set data type flag */
    submodule_data->defines[dnx_data_vlan_vlan_translate_define_nof_vlan_edit_action_ids].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_vlan_vlan_translate_nof_vlan_edit_action_ids_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_vlan, dnx_data_vlan_submodule_vlan_translate, dnx_data_vlan_vlan_translate_define_nof_vlan_edit_action_ids);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_vlan_attach(unit));
    }
    else
