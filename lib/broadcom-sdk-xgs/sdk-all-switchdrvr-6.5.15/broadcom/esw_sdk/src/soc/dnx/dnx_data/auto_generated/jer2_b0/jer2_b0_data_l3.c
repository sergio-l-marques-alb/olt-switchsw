 ...
 */
static shr_error_e
jer2_b0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_b0_dnx_data_l3_hw_bug_fec_hit_bit_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = jer2_b0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set;
    ...
    feature->set = jer2_b0_dnx_data_l3_hw_bug_fec_hit_bit_set;
