 ...
 */
static shr_error_e
jer2_b0_dnx_data_meter_diag_rate_measurements_support_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = jer2_b0_dnx_data_meter_diag_rate_measurements_support_set;
