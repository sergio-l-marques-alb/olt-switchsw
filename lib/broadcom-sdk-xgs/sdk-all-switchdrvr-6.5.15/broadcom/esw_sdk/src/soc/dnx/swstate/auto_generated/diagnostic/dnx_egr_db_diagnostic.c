 ...
 */
int
dnx_egr_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_egr_db_ps_dump(unit));
    SHR_IF_ERR_EXIT(dnx_egr_db_interface_occ_dump(unit, -1, -1));
 ...
 */
int
dnx_egr_db_ps_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_egr_db_ps_allocation_bmap_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(dnx_egr_db_ps_prio_mode_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(dnx_egr_db_ps_if_idx_dump(unit, -1, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_egr_db_ps_allocation_bmap_dump(int  unit,  int  allocation_bmap_idx_0,  int  allocation_bmap_idx_1)
{
 ...
 */
int
dnx_egr_db_ps_prio_mode_dump(int  unit,  int  prio_mode_idx_0,  int  prio_mode_idx_1)
{
 ...
 */
int
dnx_egr_db_ps_if_idx_dump(int  unit,  int  if_idx_idx_0,  int  if_idx_idx_1)
{
 ...
 */
int
dnx_egr_db_interface_occ_dump(int  unit,  int  interface_occ_idx_0,  int  interface_occ_idx_1)
{
