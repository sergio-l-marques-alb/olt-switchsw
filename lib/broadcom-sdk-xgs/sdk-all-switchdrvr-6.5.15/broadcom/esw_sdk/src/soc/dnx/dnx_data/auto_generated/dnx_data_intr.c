 ...
 */
extern shr_error_e jer2_a0_data_intr_attach(
    int unit);
extern shr_error_e jer2_b0_data_intr_attach(
    int unit);
/*
 * SUBMODULE - GENERAL:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Values */
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].nof_values = 3;
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_intr_attach(unit));
    }
    else
    if (dnxc_data_mgmt_is_jer2_b0(unit))
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_intr_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_intr_attach(unit));
    }
