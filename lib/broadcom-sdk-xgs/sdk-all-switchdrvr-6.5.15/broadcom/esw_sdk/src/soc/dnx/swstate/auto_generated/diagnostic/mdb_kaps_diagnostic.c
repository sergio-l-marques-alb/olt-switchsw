/** \file dnx/swstate/auto_generated/diagnostic/mdb_kaps_diagnostic.c
 *
...
/*
 *
 * dump function for the variable mdb_kaps_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
mdb_kaps_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(mdb_kaps_db_db_info_dump(unit, -1));
    SHR_IF_ERR_EXIT(mdb_kaps_db_search_instruction_info_dump(unit, -1));
    SHR_IF_ERR_EXIT(mdb_kaps_db_big_kaps_large_bb_mode_dump(unit, -1));
 ...
 */
int
mdb_kaps_db_db_info_dump(int  unit,  int  db_info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(mdb_kaps_db_db_info_db_p_dump(unit, db_info_idx_0));
    SHR_IF_ERR_EXIT(mdb_kaps_db_db_info_ad_db_p_dump(unit, db_info_idx_0));
    SHR_IF_ERR_EXIT(mdb_kaps_db_db_info_hb_db_p_dump(unit, db_info_idx_0));
    SHR_IF_ERR_EXIT(mdb_kaps_db_db_info_is_valid_dump(unit, db_info_idx_0));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
mdb_kaps_db_db_info_db_p_dump(int  unit,  int  db_info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
mdb_kaps_db_db_info_ad_db_p_dump(int  unit,  int  db_info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
...
/*
 *
 * dump function for the variable hb_db_p
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
mdb_kaps_db_db_info_hb_db_p_dump(int  unit,  int  db_info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
mdb_kaps_db_db_info_is_valid_dump(int  unit,  int  db_info_idx_0)
{
...
/*
 *
 * dump function for the variable search_instruction_info
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
mdb_kaps_db_search_instruction_info_dump(int  unit,  int  search_instruction_info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(mdb_kaps_db_search_instruction_info_inst_p_dump(unit, search_instruction_info_idx_0));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
mdb_kaps_db_search_instruction_info_inst_p_dump(int  unit,  int  search_instruction_info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
...
/*
 *
 * dump function for the variable big_kaps_large_bb_mode
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
mdb_kaps_db_big_kaps_large_bb_mode_dump(int  unit,  int  big_kaps_large_bb_mode_idx_0)
{
