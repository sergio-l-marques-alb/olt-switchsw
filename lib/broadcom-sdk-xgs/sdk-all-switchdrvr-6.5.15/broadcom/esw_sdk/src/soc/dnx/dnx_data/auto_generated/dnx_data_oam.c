 ...
 */
extern shr_error_e jer2_a0_data_oam_attach(
    int unit);
extern shr_error_e jer2_b0_data_oam_attach(
    int unit);
/*
 * SUBMODULE - GENERAL:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_port_core_bits].name = "port_core_bits";
    submodule_data->defines[dnx_data_oam_oamp_define_port_core_bits].doc = "Number of bits in PORT CORE dbal field";
    /* Set data type flag */
    submodule_data->defines[dnx_data_oam_oamp_define_port_core_bits].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_oam_oamp_port_core_bits_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_oamp, dnx_data_oam_oamp_define_port_core_bits);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_oam_property_define_oam_multiple_event_count_enable].name = "oam_multiple_event_count_enable";
    submodule_data->defines[dnx_data_oam_property_define_oam_multiple_event_count_enable].doc = "Count multiple occurances of same event which exist in SW event hash table";
    /* Set data type flag */
    submodule_data->defines[dnx_data_oam_property_define_oam_multiple_event_count_enable].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_oam_property_oam_multiple_event_count_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_property, dnx_data_oam_property_define_oam_multiple_event_count_enable);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_oam_hw_bug_oam_offset_supported].doc = "HW bug: oam_offset is not used - JER2_A0 only!  Works for B0 and up";
    ...
    submodule_data->features[dnx_data_oam_hw_bug_lm_read_index_limitation].doc = "HW bug: there needs to be a configuration per OAM-Sub-Type to either use the calculated lm_read_index, or set it to NULL. - JER2_A0 only!";
    ...
    submodule_data->features[dnx_data_oam_hw_bug_oamp_tx_rate_limitation].doc = "HW bug: OAMP transmission rate is not accurate on JER2_A0 device";
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_oam_attach(unit));
    }
    else
    if (dnxc_data_mgmt_is_jer2_b0(unit))
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_oam_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_oam_attach(unit));
    }
