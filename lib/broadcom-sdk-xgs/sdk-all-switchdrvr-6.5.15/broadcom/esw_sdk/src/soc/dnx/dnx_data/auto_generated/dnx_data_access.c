/** \file dnx_data_access.c
 * 
 * MODULE DEVICE DATA - ACCESS
 * 
 * Device Data
 ...
 */
extern shr_error_e jer2_a0_data_access_attach(
    int unit);
/*
 * SUBMODULE - MDIO:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_access_mdio_define_out_delay].name = "out_delay";
    submodule_data->defines[dnx_data_access_mdio_define_out_delay].doc = "number of clock delay between the rising edge of MDC and the starting data of MDIO";
    /* Set data type flag */
    submodule_data->defines[dnx_data_access_mdio_define_out_delay].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_access_mdio_out_delay_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_access, dnx_data_access_submodule_mdio, dnx_data_access_mdio_define_out_delay);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_access_attach(unit));
    }
    else
