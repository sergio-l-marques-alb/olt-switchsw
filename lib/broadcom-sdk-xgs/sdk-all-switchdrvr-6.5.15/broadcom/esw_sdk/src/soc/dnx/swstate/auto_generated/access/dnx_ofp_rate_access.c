 ...
 */
int
dnx_ofp_rate_db_qpair_burst_set(int unit, uint32 qpair_idx_0, uint32 qpair_idx_1, uint32 burst)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_OFP_RATE_MODULE_ID,
        ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->qpair[qpair_idx_0][qpair_idx_1].burst,
        burst,
        uint32,
        0,
        "dnx_ofp_rate_db_qpair_burst_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_OFP_RATE_MODULE_ID,
        &burst,
        "dnx_ofp_rate_db[%d]->qpair[%d][%d].burst",
        unit, qpair_idx_0, qpair_idx_1);
 ...
 */
int
dnx_ofp_rate_db_qpair_burst_get(int unit, uint32 qpair_idx_0, uint32 qpair_idx_1, uint32 *burst)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *burst = ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->qpair[qpair_idx_0][qpair_idx_1].burst;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_ofp_rate_db_tcg_burst_set(int unit, uint32 tcg_idx_0, uint32 tcg_idx_1, uint32 tcg_idx_2, uint32 burst)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_OFP_RATE_MODULE_ID,
        ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->tcg[tcg_idx_0][tcg_idx_1][tcg_idx_2].burst,
        burst,
        uint32,
        0,
        "dnx_ofp_rate_db_tcg_burst_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_OFP_RATE_MODULE_ID,
        &burst,
        "dnx_ofp_rate_db[%d]->tcg[%d][%d][%d].burst",
        unit, tcg_idx_0, tcg_idx_1, tcg_idx_2);
 ...
 */
int
dnx_ofp_rate_db_tcg_burst_get(int unit, uint32 tcg_idx_0, uint32 tcg_idx_1, uint32 tcg_idx_2, uint32 *burst)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *burst = ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->tcg[tcg_idx_0][tcg_idx_1][tcg_idx_2].burst;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
/*
 *
 * set function for the variable shaper_enable
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_ofp_rate_db_shaper_enable_set(int unit, uint32 shaper_enable)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        ...
        uint32,
        0,
        "dnx_ofp_rate_db_shaper_enable_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_OFP_RATE_MODULE_ID,
        &shaper_enable,
        "dnx_ofp_rate_db[%d]->shaper_enable",
        unit);
...
/*
 *
 * get function for the variable shaper_enable
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_ofp_rate_db_shaper_enable_get(int unit, uint32 *shaper_enable)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *shaper_enable = ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->shaper_enable;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
dnx_ofp_rate_db_cbs dnx_ofp_rate_db = 	{
	...
	,
		...
		,
			...
			dnx_ofp_rate_db_qpair_burst_set,
			dnx_ofp_rate_db_qpair_burst_get}
		,
			{
	...
	,
		...
		dnx_ofp_rate_db_shaper_enable_set,
		dnx_ofp_rate_db_shaper_enable_get}
	}
;
