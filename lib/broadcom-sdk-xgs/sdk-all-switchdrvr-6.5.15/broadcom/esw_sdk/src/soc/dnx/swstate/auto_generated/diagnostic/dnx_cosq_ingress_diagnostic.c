/** \file dnx/swstate/auto_generated/diagnostic/dnx_cosq_ingress_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_cosq_ingress_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_cosq_ingress_db_dump(int  unit)
{
...
/*
 *
 * dump function for the variable fixed_priority
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_cosq_ingress_db_fixed_priority_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_cosq_ingress_db_fixed_priority_nif_dump(unit));
    SHR_IF_ERR_EXIT(dnx_cosq_ingress_db_fixed_priority_mirror_dump(unit, -1, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_cosq_ingress_db_fixed_priority_nif_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_cosq_ingress_db_fixed_priority_mirror_dump(int  unit,  int  mirror_idx_0,  int  mirror_idx_1)
{
    int i0 = mirror_idx_0, I0 = mirror_idx_0 + 1;
    int i1 = mirror_idx_1, I1 = mirror_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
