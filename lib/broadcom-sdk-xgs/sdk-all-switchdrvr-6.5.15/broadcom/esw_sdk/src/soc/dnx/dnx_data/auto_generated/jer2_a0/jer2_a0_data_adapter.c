...
#include <src/bcm/dnx/rx/auto_generated/rx_internal_J2a0.h>
/*
 * }
 */
 ...
 */
static shr_error_e
jer2_a0_dnx_data_adapter_tx_loopback_enable_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_adapter_rx_packet_header_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    ...
    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    /* Set default value */
    define->default_data = PACKET_HEADER_SIGNAL_ID_J2A0;

    /* Set value */
    define->data = PACKET_HEADER_SIGNAL_ID_J2A0;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_adapter_reg_mem_access_do_collect_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_adapter_tx_loopback_enable_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_adapter_rx_packet_header_signal_id_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_adapter_reg_mem_access_do_collect_enable_set;
