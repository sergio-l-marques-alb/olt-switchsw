 ...
 */
/**
 * \brief device level function which set define max_mc_replication_id
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_ppmc_param_max_mc_replication_id_set(
    int unit)
{
...
/**
 * \brief device level function which set define min_mc_replication_id
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_ppmc_param_min_mc_replication_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ppmc;
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_ppmc_param_max_mc_replication_id_set;
    data_index = dnx_data_ppmc_param_define_min_mc_replication_id;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_ppmc_param_min_mc_replication_id_set;
