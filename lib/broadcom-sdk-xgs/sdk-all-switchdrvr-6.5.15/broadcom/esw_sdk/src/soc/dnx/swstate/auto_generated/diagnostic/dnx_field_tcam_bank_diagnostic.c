 ...
 */
int
dnx_field_tcam_bank_sw_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_bank_sw_tcam_banks_dump(unit, -1));
 ...
 */
int
dnx_field_tcam_bank_sw_tcam_banks_dump(int  unit,  int  tcam_banks_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_bank_sw_tcam_banks_nof_free_entries_dump(unit, tcam_banks_idx_0, -1, -1));
 ...
 */
int
dnx_field_tcam_bank_sw_tcam_banks_owner_stage_dump(int  unit,  int  tcam_banks_idx_0)
{
 ...
 */
int
dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_dump(int  unit,  int  tcam_banks_idx_0)
{
    int i0 = tcam_banks_idx_0, I0 = tcam_banks_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_tcam_bank_sw_tcam_banks_nof_free_entries_dump(int  unit,  int  tcam_banks_idx_0,  int  nof_free_entries_idx_0,  int  nof_free_entries_idx_1)
{
    int i0 = tcam_banks_idx_0, I0 = tcam_banks_idx_0 + 1;
 ...
 */
int
dnx_field_tcam_bank_sw_tcam_banks_bank_mode_dump(int  unit,  int  tcam_banks_idx_0)
{
    int i0 = tcam_banks_idx_0, I0 = tcam_banks_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
