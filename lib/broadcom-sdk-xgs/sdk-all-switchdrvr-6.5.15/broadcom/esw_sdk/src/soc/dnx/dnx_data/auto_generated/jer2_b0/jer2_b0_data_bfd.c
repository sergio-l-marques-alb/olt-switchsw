 ...
 */
static shr_error_e
jer2_b0_dnx_data_bfd_general_configurable_single_hop_tos_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_b0_dnx_data_bfd_hw_bug_detect_multiplier_limitation_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
    ...
    int unit)
{
    ...
    feature->set = jer2_b0_dnx_data_bfd_general_configurable_single_hop_tos_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jer2_b0_dnx_data_bfd_hw_bug_detect_multiplier_limitation_set;
