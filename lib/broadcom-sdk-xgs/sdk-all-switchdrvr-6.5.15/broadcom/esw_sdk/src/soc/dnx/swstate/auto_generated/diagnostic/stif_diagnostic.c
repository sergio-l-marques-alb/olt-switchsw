/** \file dnx/swstate/auto_generated/diagnostic/stif_diagnostic.c
 *
...
/*
 *
 * dump function for the variable dnx_stif_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_stif_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_stif_db_instance_dump(unit, -1, -1));
 ...
 */
int
dnx_stif_db_instance_dump(int  unit,  int  instance_idx_0,  int  instance_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_stif_db_instance_logical_port_dump(unit, instance_idx_0,instance_idx_1));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
/*
 *
 * dump function for the variable logical_port
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_stif_db_instance_logical_port_dump(int  unit,  int  instance_idx_0,  int  instance_idx_1)
{
    int i0 = instance_idx_0, I0 = instance_idx_0 + 1;
    int i1 = instance_idx_1, I1 = instance_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
