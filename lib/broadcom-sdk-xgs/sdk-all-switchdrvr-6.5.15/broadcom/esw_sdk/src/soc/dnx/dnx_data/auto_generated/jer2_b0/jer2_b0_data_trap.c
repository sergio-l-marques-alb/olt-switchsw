 ...
 */
static shr_error_e
jer2_b0_dnx_data_trap_erpp_unknown_da_trap_en_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_b0_dnx_data_trap_erpp_ipv6_traps_en_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_erpp;
    int feature_index = dnx_data_trap_erpp_ipv6_traps_en;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    feature->set = jer2_b0_dnx_data_trap_erpp_unknown_da_trap_en_set;
    data_index = dnx_data_trap_erpp_ipv6_traps_en;
    feature = &submodule->features[data_index];
    feature->set = jer2_b0_dnx_data_trap_erpp_ipv6_traps_en_set;
