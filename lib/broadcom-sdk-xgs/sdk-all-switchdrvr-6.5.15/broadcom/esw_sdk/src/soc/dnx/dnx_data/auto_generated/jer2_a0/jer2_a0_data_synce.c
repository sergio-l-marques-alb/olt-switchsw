 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_nof_plls_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_nif_div_min_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_nif_div_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_fabric_div_min_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_fabric_div_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_output_clk_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_synce_general_cfg_set(
    int unit)
{
    ...
    table->values[0].property.range_max = SOC_MAX_NUM_PORTS;
    for (synce_index_index = 0; synce_index_index < table->keys[0].size; synce_index_index++)
    {
        data = (dnx_data_synce_general_cfg_t *) dnxc_data_mgmt_table_data_get(unit, table, synce_index_index, 0);
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_synce_general_nof_plls_set;
    data_index = dnx_data_synce_general_define_nif_div_min;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_synce_general_nif_div_min_set;
    data_index = dnx_data_synce_general_define_nif_div_max;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_synce_general_nif_div_max_set;
    data_index = dnx_data_synce_general_define_fabric_div_min;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_synce_general_fabric_div_min_set;
    data_index = dnx_data_synce_general_define_fabric_div_max;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_synce_general_fabric_div_max_set;
    data_index = dnx_data_synce_general_define_output_clk_mode;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_synce_general_output_clk_mode_set;
    ...
    table->set = jer2_a0_dnx_data_synce_general_cfg_set;
