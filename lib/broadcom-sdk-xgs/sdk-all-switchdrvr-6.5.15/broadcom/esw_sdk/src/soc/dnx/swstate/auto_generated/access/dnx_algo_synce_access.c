/** \file dnx/swstate/auto_generated/access/dnx_algo_synce_access.c
 *
...
/*
 *
 * is_init function for the variable dnx_algo_synce_db
...
/*
 *
 * init function for the variable dnx_algo_synce_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
