 ...
 */
int
cosq_config_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(cosq_config_hr_group_bw_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(cosq_config_groups_bw_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(cosq_config_ipf_config_mode_dump(unit));
    SHR_IF_ERR_EXIT(cosq_config_flow_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(cosq_config_connector_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(cosq_config_se_dump(unit, -1, -1));
 ...
 */
int
cosq_config_hr_group_bw_dump(int  unit,  int  hr_group_bw_idx_0,  int  hr_group_bw_idx_1)
{
 ...
 */
int
cosq_config_groups_bw_dump(int  unit,  int  groups_bw_idx_0,  int  groups_bw_idx_1)
{
 ...
 */
int
cosq_config_ipf_config_mode_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
cosq_config_flow_dump(int  unit,  int  flow_idx_0,  int  flow_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
cosq_config_flow_credit_src_dump(int  unit,  int  flow_idx_0,  int  flow_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
cosq_config_flow_credit_src_weight_dump(int  unit,  int  flow_idx_0,  int  flow_idx_1)
{
 ...
 */
int
cosq_config_flow_credit_src_mode_dump(int  unit,  int  flow_idx_0,  int  flow_idx_1)
{
    int i0 = flow_idx_0, I0 = flow_idx_0 + 1;
    int i1 = flow_idx_1, I1 = flow_idx_1 + 1;
    char *s0 = "", *s1 = "";
 ...
 */
int
cosq_config_connector_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
cosq_config_connector_num_cos_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1)
{
 ...
 */
int
cosq_config_connector_connection_valid_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1)
{
    int i0 = connector_idx_0, I0 = connector_idx_0 + 1;
    int i1 = connector_idx_1, I1 = connector_idx_1 + 1;
    char *s0 = "", *s1 = "";
 ...
 */
int
cosq_config_connector_src_modid_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1)
{
    int i0 = connector_idx_0, I0 = connector_idx_0 + 1;
    int i1 = connector_idx_1, I1 = connector_idx_1 + 1;
    char *s0 = "", *s1 = "";
 ...
 */
int
cosq_config_se_dump(int  unit,  int  se_idx_0,  int  se_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
cosq_config_se_child_count_dump(int  unit,  int  se_idx_0,  int  se_idx_1)
{
