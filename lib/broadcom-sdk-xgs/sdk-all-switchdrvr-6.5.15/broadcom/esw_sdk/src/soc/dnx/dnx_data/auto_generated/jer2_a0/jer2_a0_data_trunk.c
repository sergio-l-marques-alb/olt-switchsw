 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_parameters_nof_pools_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_parameters_max_nof_members_in_pool_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_parameters_max_nof_groups_in_pool_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_parameters_spa_pool_shift_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_parameters_spa_type_shift_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_parameters_pool_info_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_psc_multiply_and_divide_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_psc_smooth_division_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_psc_consistant_hashing_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_psc_consistant_hashing_small_group_size_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_psc_smooth_division_max_nof_member_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_psc_smooth_division_entries_per_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
/**
 * \brief device level function which set define nof
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_egress_trunk_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
/**
 * \brief device level function which set define nof_lb_keys_per_profile
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_egress_trunk_nof_lb_keys_per_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
/**
 * \brief device level function which set define invalid_out_port
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_egress_trunk_invalid_out_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
    int submodule_index = dnx_data_trunk_submodule_egress_trunk;
    int define_index = dnx_data_trunk_egress_trunk_define_invalid_out_port;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_graceful_allow_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trunk;
    ...
    feature->flags |= DNXC_DATA_F_SUPPORTED;
    /* Property */
    feature->property.name = spn_GRACEFUL_LAG_MODIFICATION_ENABLE;
    feature->property.doc = 
        "\n"
        "Enable/Disable Graceful Lag Modification:\n"
        "when enabled, lag have 2 different configurations.\n"
        "one current and another stand-by, user configures the\n"
        "stand-by configuration and can trigger a switch between\n"
        "the two.\n"
        "\n"
    ;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_graceful_first_hw_configuration_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_trunk_graceful_second_hw_configuration_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_trunk_parameters_nof_pools_set;
    data_index = dnx_data_trunk_parameters_define_max_nof_members_in_pool;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_parameters_max_nof_members_in_pool_set;
    data_index = dnx_data_trunk_parameters_define_max_nof_groups_in_pool;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_parameters_max_nof_groups_in_pool_set;
    data_index = dnx_data_trunk_parameters_define_spa_pool_shift;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_parameters_spa_pool_shift_set;
    data_index = dnx_data_trunk_parameters_define_spa_type_shift;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_parameters_spa_type_shift_set;
    ...
    table->set = jer2_a0_dnx_data_trunk_parameters_pool_info_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_psc_consistant_hashing_small_group_size_in_bits_set;
    data_index = dnx_data_trunk_psc_define_smooth_division_max_nof_member;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_psc_smooth_division_max_nof_member_set;
    data_index = dnx_data_trunk_psc_define_smooth_division_entries_per_profile;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_psc_smooth_division_entries_per_profile_set;
    ...
    feature->set = jer2_a0_dnx_data_trunk_psc_multiply_and_divide_set;
    data_index = dnx_data_trunk_psc_smooth_division;
    feature = &submodule->features[data_index];
    feature->set = jer2_a0_dnx_data_trunk_psc_smooth_division_set;
    data_index = dnx_data_trunk_psc_consistant_hashing;
    feature = &submodule->features[data_index];
    feature->set = jer2_a0_dnx_data_trunk_psc_consistant_hashing_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_egress_trunk_nof_set;
    data_index = dnx_data_trunk_egress_trunk_define_nof_lb_keys_per_profile;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_egress_trunk_nof_lb_keys_per_profile_set;
    data_index = dnx_data_trunk_egress_trunk_define_invalid_out_port;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_egress_trunk_invalid_out_port_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_graceful_first_hw_configuration_set;
    data_index = dnx_data_trunk_graceful_define_second_hw_configuration;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_trunk_graceful_second_hw_configuration_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jer2_a0_dnx_data_trunk_graceful_allow_set;
