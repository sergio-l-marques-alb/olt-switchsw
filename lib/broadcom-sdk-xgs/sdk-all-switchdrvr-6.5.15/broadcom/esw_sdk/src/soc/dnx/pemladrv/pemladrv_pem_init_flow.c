    ...
    int unit)
{
     ...
     */
    soc_reg_field32_modify(unit, IPPF_REG_03A0r, REG_PORT_ANY, FIELD_17_17f, 1);
    soc_reg_field32_modify(unit, IPPF_REG_03A0r, REG_PORT_ANY, FIELD_16_16f, 0);
    soc_reg_field32_modify(unit, IPPF_REG_0310r, REG_PORT_ANY, FIELD_17_17f, 1);
    soc_reg_field32_modify(unit, IPPF_REG_0310r, REG_PORT_ANY, FIELD_16_16f, 0);
    soc_reg_field32_modify(unit, IPPA_REG_0420r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, IPPB_REG_0300r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, IPPB_REG_0500r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, IPPC_REG_0330r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, IPPD_REG_0400r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPA_REG_0340r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPC_REG_0330r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPC_REG_0320r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPC_REG_0300r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPB_REG_0520r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPB_REG_0300r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPB_REG_0320r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPB_REG_0340r, REG_PORT_ANY, FIELD_16_16f, 1);
    soc_reg_field32_modify(unit, ETPPB_REG_0360r, REG_PORT_ANY, FIELD_16_16f, 1);
    ...
    for (ii = 0; ii < 8; ii++)
    {
        ...
        for (jj = 0; jj < 4; jj++)
        {
            soc_reg_above_64_field32_modify(unit, PEM_MAP_CONFIGr, ii, jj, MAP_N_PE_BYPASSf, 1);
            soc_reg_above_64_field32_modify(unit, PEM_MAP_CONFIGr, ii, jj, MAP_N_INPUT_SELECTf, 2);
            soc_reg_above_64_field32_modify(unit, PEM_ALU_CONFIGr, ii, jj, ALU_N_PE_BYPASSf, 1);
            soc_reg_above_64_field32_modify(unit, PEM_ALU_CONFIGr, ii, jj, ALU_N_INPUT_SELECTf, 2);
            soc_reg_above_64_field32_modify(unit, PEM_CAM_CONFIGr, ii, jj, CAM_N_PE_BYPASSf, 1);
            soc_reg_above_64_field32_modify(unit, PEM_CAM_CONFIGr, ii, jj, CAM_N_INPUT_SELECTf, 2);
            soc_reg_above_64_field32_modify(unit, PEM_PRIO_CONFIGr, ii, jj, PRIO_N_PE_BYPASSf, 1);
            soc_reg_above_64_field32_modify(unit, PEM_PRIO_CONFIGr, ii, jj, PRIO_N_INPUT_SELECTf, 2);
        }
        soc_reg_field32_modify(unit, PEM_REG_0100r, ii, ROUTER_IN_0_INPUT_SELECT_Cf, 0);
        soc_reg_field32_modify(unit, PEM_REG_0100r, ii, ROUTER_IN_3_INPUT_SELECT_Cf, 0);
        soc_reg_field32_modify(unit, PEM_REG_0100r, ii, ROUTER_IN_2_INPUT_SELECT_Cf, 0);
        soc_reg_field32_modify(unit, PEM_REG_0100r, ii, ROUTER_IN_1_INPUT_SELECT_Cf, 0);
    }

    for (ii = 0; ii < 256; ii++)
    {
        soc_mem_field32_modify(unit, IPPE_PINFO_LLRm, ii, CONTEXT_ENABLEf, 1);
        soc_mem_field32_modify(unit, IPPE_PINFO_LLRm, ii, CONTEXT_SELECTIONf, 0);
    }

    for (ii = 0; ii < 128; ii++)
    {
        soc_mem_field32_modify(unit, IPPE_LLRCS_ACTIONm, ii, LLRCS_ACTIONf, 0);
        soc_mem_field32_modify(unit, IPPF_VTACS_ACTIONm, ii, VTACS_ACTIONf, 0);
        soc_mem_field32_modify(unit, IPPF_VTBCS_ACTIONm, ii, VTBCS_ACTIONf, 0);
        soc_mem_field32_modify(unit, IPPF_VTCCS_ACTIONm, ii, VTCCS_ACTIONf, 0);
    }
...
#ifndef ADAPTER_SERVER_MODE
    if (dnx_data_pp.debug.feature_get(unit, dnx_data_pp_debug_pem_vt_init_fix))
    {
        dnx_pemla_init_ire_packet_info_t original_data_before_packet;
