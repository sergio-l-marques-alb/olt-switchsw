 ...
 */
int
dnx_field_tcam_prefix_sw_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_prefix_sw_banks_prefix_dump(unit, -1));
 ...
 */
int
dnx_field_tcam_prefix_sw_banks_prefix_dump(int  unit,  int  banks_prefix_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_prefix_sw_banks_prefix_prefix_handler_map_dump(unit, banks_prefix_idx_0, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_field_tcam_prefix_sw_banks_prefix_prefix_handler_map_dump(int  unit,  int  banks_prefix_idx_0,  int  prefix_handler_map_idx_0)
{
    int i0 = banks_prefix_idx_0, I0 = banks_prefix_idx_0 + 1;
    int i1 = prefix_handler_map_idx_0, I1 = prefix_handler_map_idx_0 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
