/** \file dnx_data_consistent_hashing.c
 * 
 * MODULE DEVICE DATA - CONSISTENT_HASHING
 * 
 * Device Data
 ...
 */
extern shr_error_e jer2_a0_data_consistent_hashing_attach(
    int unit);
/*
 * SUBMODULE - CALENDAR:
 * {
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_consistent_hashing_attach(unit));
    }
    else
