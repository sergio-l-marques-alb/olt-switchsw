 ...
 */
int
dnx_iqs_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_iqs_db_credit_request_profile_dump(unit, -1));
 ...
 */
int
dnx_iqs_db_credit_request_profile_dump(int  unit,  int  credit_request_profile_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_iqs_db_credit_request_profile_valid_dump(int  unit,  int  credit_request_profile_idx_0)
{
 ...
 */
int
dnx_iqs_db_credit_request_profile_thresholds_dump(int  unit,  int  credit_request_profile_idx_0)
{
    int i0 = credit_request_profile_idx_0, I0 = credit_request_profile_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_iqs_db_credit_watchdog_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SHR_IF_ERR_EXIT(dnx_iqs_db_credit_watchdog_delete_th_dump(unit, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_iqs_db_credit_watchdog_queue_min_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnx_iqs_db_credit_watchdog_queue_max_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnx_iqs_db_credit_watchdog_enable_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnx_iqs_db_credit_watchdog_retransmit_th_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnx_iqs_db_credit_watchdog_delete_th_dump(int  unit,  int  delete_th_idx_0)
{
