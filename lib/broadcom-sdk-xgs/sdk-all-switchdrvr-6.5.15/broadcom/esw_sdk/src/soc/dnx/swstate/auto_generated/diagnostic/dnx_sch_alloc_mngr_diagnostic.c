/** \file dnx/swstate/auto_generated/diagnostic/dnx_sch_alloc_mngr_diagnostic.c
 *
 ...
 */
int
sch_alloc_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(sch_alloc_db_sch_flow_alloc_mngr_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(sch_alloc_db_interface_dump(unit, -1));
 ...
 */
int
sch_alloc_db_sch_flow_alloc_mngr_dump(int  unit,  int  sch_flow_alloc_mngr_idx_0,  int  sch_flow_alloc_mngr_idx_1)
{
 ...
 */
int
sch_alloc_db_interface_dump(int  unit,  int  interface_idx_0)
{
 ...
 */
int
sch_alloc_db_cl_class_alloc_mngr_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
