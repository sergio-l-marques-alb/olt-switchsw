 ...
 */
int
dnx_fabric_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_fabric_db_modids_to_group_map_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnx_fabric_db_links_dump(unit, -1));
 ...
 */
int
dnx_fabric_db_modids_to_group_map_dump(int  unit,  int  modids_to_group_map_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_fabric_db_modids_to_group_map_nof_modids_dump(unit, modids_to_group_map_idx_0));
    SHR_IF_ERR_EXIT(dnx_fabric_db_modids_to_group_map_modids_dump(unit, modids_to_group_map_idx_0, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_fabric_db_modids_to_group_map_nof_modids_dump(int  unit,  int  modids_to_group_map_idx_0)
{
 ...
 */
int
dnx_fabric_db_modids_to_group_map_modids_dump(int  unit,  int  modids_to_group_map_idx_0,  int  modids_idx_0)
{
    int i0 = modids_to_group_map_idx_0, I0 = modids_to_group_map_idx_0 + 1;
 ...
 */
int
dnx_fabric_db_links_dump(int  unit,  int  links_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_fabric_db_links_is_link_allowed_dump(int  unit,  int  links_idx_0)
{
