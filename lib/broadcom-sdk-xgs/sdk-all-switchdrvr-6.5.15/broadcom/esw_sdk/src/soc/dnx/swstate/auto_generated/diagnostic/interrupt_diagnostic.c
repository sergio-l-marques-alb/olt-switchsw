 ...
 */
int
intr_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(intr_db_flags_dump(unit, -1));
    SHR_IF_ERR_EXIT(intr_db_storm_timed_count_dump(unit, -1));
    SHR_IF_ERR_EXIT(intr_db_storm_timed_period_dump(unit, -1));
 ...
 */
int
intr_db_flags_dump(int  unit,  int  flags_idx_0)
{
 ...
 */
int
intr_db_storm_timed_count_dump(int  unit,  int  storm_timed_count_idx_0)
{
 ...
 */
int
intr_db_storm_timed_period_dump(int  unit,  int  storm_timed_period_idx_0)
{
 ...
 */
int
intr_db_storm_nominal_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
