...
extern shr_error_e jer2_a0_data_l3_attach(
    int unit);
extern shr_error_e jer2_b0_data_l3_attach(
    int unit);
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_egr_pointed_define_nof_bits_in_egr_pointed_id].flags |= DNXC_DATA_F_DEFINE;
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_egr_pointed_define_nof_egr_pointed_ids].flags |= DNXC_DATA_F_DEFINE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_id_26k_granularity].name = "max_fec_id_26k_granularity";
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_id_26k_granularity].doc = "The maximal FEC ID when using a 26k FEC granularity.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_id_26k_granularity].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_l3_fec_define_max_fec_id_52k_granularity].name = "max_fec_id_52k_granularity";
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_id_52k_granularity].doc = "The maximal FEC ID when using a 52k FEC granularity .";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_id_52k_granularity].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_l3_fec_define_fec_stage_map_size].name = "fec_stage_map_size";
    submodule_data->defines[dnx_data_l3_fec_define_fec_stage_map_size].doc = "The smallest number of FECs which belong to the same hierarchy";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_fec_stage_map_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_l3_fec_define_max_fec_stage_map_size].name = "max_fec_stage_map_size";
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_stage_map_size].doc = "The biggest number of FECs which belong to the same bank";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_max_fec_stage_map_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_l3_fec_define_nof_super_fecs_per_bank].name = "nof_super_fecs_per_bank";
    submodule_data->defines[dnx_data_l3_fec_define_nof_super_fecs_per_bank].doc = "The number of SUPER FEC IDs per resource manager bank.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_nof_super_fecs_per_bank].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_l3_fec_define_fec_row_size].name = "fec_row_size";
    submodule_data->defines[dnx_data_l3_fec_define_fec_row_size].doc = "The number of bits in a single row in the FEC MDB table.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_fec_row_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_l3_fec_define_fec_max_nof_banks].name = "fec_max_nof_banks";
    submodule_data->defines[dnx_data_l3_fec_define_fec_max_nof_banks].doc = "The maximal NOF possible banks in the device (not MDB profile dependent).";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_fec_define_fec_max_nof_banks].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_l3_fec_max_fec_id_26k_granularity_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_max_fec_id_26k_granularity);
}

uint32
dnx_data_l3_fec_max_fec_id_52k_granularity_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_max_fec_id_52k_granularity);
}
...
uint32
dnx_data_l3_fec_fec_stage_map_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_fec_stage_map_size);
}

uint32
dnx_data_l3_fec_max_fec_stage_map_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_max_fec_stage_map_size);
}

uint32
dnx_data_l3_fec_nof_super_fecs_per_bank_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_nof_super_fecs_per_bank);
}
...
uint32
dnx_data_l3_fec_fec_row_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_fec_row_size);
}

uint32
dnx_data_l3_fec_fec_max_nof_banks_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fec, dnx_data_l3_fec_define_fec_max_nof_banks);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_vrrp_define_exem_vrid_ip_tcam_index].name = "exem_vrid_ip_tcam_index";
    submodule_data->defines[dnx_data_l3_vrrp_define_exem_vrid_ip_tcam_index].doc = "TCAM index for EXEM VRRP VRID IPv6 and IPv4 protocols";
    /* Set data type flag */
    submodule_data->defines[dnx_data_l3_vrrp_define_exem_vrid_ip_tcam_index].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_l3_vrrp_exem_vrid_ip_tcam_index_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_vrrp, dnx_data_l3_vrrp_define_exem_vrid_ip_tcam_index);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_l3_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_l3_attach(unit));
    }
