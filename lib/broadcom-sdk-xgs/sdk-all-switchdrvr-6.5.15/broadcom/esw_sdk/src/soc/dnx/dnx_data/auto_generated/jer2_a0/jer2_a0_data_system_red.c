/** \file jer2_a0_data_system_red.c
 * 
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_config_enable_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_nof_red_q_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_system_red;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_max_red_q_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_system_red;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_max_ing_aging_period_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_system_red;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_max_sch_aging_period_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_system_red;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_sch_aging_period_factor_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_system_red;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_max_free_res_thr_range_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_system_red;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_system_red_info_resource_set(
    int unit)
{
    int type_index;
     ...
     * Set Values - Entries
     */
    data = (dnx_data_system_red_info_resource_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_SYSTEM_RED_RESOURCE_PDBS, 0);
    ...
    data->hw_resolution_max = dnx_data_system_red.info.resource_get(unit, DNX_SYSTEM_RED_RESOURCE_PDBS)->max/dnx_data_ingr_congestion.info.threshold_granularity_get(unit);
 ...
 */
shr_error_e
jer2_a0_data_system_red_attach(
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_system_red_config_enable_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_system_red_info_nof_red_q_size_set;
    data_index = dnx_data_system_red_info_define_max_red_q_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_system_red_info_max_red_q_size_set;
    data_index = dnx_data_system_red_info_define_max_ing_aging_period;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_system_red_info_max_ing_aging_period_set;
    data_index = dnx_data_system_red_info_define_max_sch_aging_period;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_system_red_info_max_sch_aging_period_set;
    data_index = dnx_data_system_red_info_define_sch_aging_period_factor;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_system_red_info_sch_aging_period_factor_set;
    data_index = dnx_data_system_red_info_define_max_free_res_thr_range;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_system_red_info_max_free_res_thr_range_set;
    ...
    table->set = jer2_a0_dnx_data_system_red_info_resource_set;
