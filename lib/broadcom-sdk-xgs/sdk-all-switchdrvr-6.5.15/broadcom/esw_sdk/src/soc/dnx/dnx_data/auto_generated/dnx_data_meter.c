/** \file dnx_data_meter.c
 * 
 * MODULE DEVICE DATA - METER
 * 
 * Device Data
 ...
 */
extern shr_error_e jer2_a0_data_meter_attach(
    int unit);
extern shr_error_e jer2_b0_data_meter_attach(
    int unit);
/*
 * SUBMODULE - PROFILE:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_meter_meter_db_refresh_disable_required].doc = "disable refresh mechanism required or not, as workaround to enable access to dynamic MCP extansion table";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_sections_offset].flags |= DNXC_DATA_F_DEFINE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /*
     * Table - ingress_port_delta_value
     */
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_meter_attach(unit));
    }
    else
    if (dnxc_data_mgmt_is_jer2_b0(unit))
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_meter_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_meter_attach(unit));
    }
