 ...
 */
static shr_error_e
jer2_b0_dnx_data_device_general_device_id_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = jer2_b0_dnx_data_device_general_device_id_set;
