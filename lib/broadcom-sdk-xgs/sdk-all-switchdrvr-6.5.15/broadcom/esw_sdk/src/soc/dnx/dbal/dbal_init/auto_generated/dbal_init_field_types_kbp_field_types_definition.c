...
dbal_field_types_basic_info_t * field_types_info)
{
    ...
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_KEY_FIELD_TYPE" /* name*/, "3" /* size*/, EMPTY /* resource name*/, "ENUM" /* print*/);
    /** *********************  */
...
shr_error_e
_dbal_init_field_types_kbp_field_types_definition_kbp_key_segment_init(
int unit,
field_type_db_struct_t * cur_field_type_param,
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_KEY_SEGMENT" /* name*/, "171" /* size*/, EMPTY /* resource name*/, "STRUCTURE" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** struct fields  */
    ...
    sal_strncpy(cur_field_type_param->structs[0].name, "SEGMENT_NAME", sizeof(cur_field_type_param->structs[0].name));
    SHR_IF_ERR_EXIT(dbal_db_parse_dnx_data_indication(unit, &cur_field_type_param->structs[0].length_dnx_data, "160" /* size*/, FALSE, 0, "", ""););
    sal_strncpy(cur_field_type_param->structs[1].name, "SEGMENT_SIZE", sizeof(cur_field_type_param->structs[1].name));
    SHR_IF_ERR_EXIT(dbal_db_parse_dnx_data_indication(unit, &cur_field_type_param->structs[1].length_dnx_data, "8" /* size*/, FALSE, 0, "", ""););
    sal_strncpy(cur_field_type_param->structs[2].name, "SEGMENT_TYPE", sizeof(cur_field_type_param->structs[2].name));
...
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_RESULT_LOCATION" /* name*/, "1" /* size*/, EMPTY /* resource name*/, "UINT32" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** defines  */
...
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_DEVICE_STATUS" /* name*/, "4" /* size*/, EMPTY /* resource name*/, "ENUM" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** enum values  */
...
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_KBR_IDX" /* name*/, "2" /* size*/, EMPTY /* resource name*/, "ENUM" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** enum values  */
...
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_LOOKUP_TYPE" /* name*/, "3" /* size*/, EMPTY /* resource name*/, "ENUM" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** enum values  */
...
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_DEVICE_MODE" /* name*/, "2" /* size*/, EMPTY /* resource name*/, "ENUM" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** enum values  */
...
dbal_field_types_basic_info_t * field_types_info)
{
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, "KBP_OPCODE_ID" /* name*/, "8" /* size*/, EMPTY /* resource name*/, "UINT32" /* print*/);
    /** *********************  */
    /** field type interface  */
    /** *********************  */
    /** no interface  */
...
dbal_field_types_basic_info_t * field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_field_types_kbp_field_types_definition_kbp_key_segment_init(unit, cur_field_type_param, field_types_info));
