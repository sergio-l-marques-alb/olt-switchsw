...
int soc_dnx_device_blocks_reset(int unit, int reset_action)
{
    int disable_hard_reset;
    uint32 reg_val;
    soc_reg_above_64_val_t reg_above_64_val;
#ifdef FINAL_JER2_RESET_SEQUENCE
    soc_field_t field = 0;
#endif
    SHR_FUNC_INIT_VARS(unit);
    ...
    if ((reset_action == SOC_DNX_RESET_ACTION_IN_RESET) || (reset_action == SOC_DNX_RESET_ACTION_INOUT_RESET)) { 
        ...
        /* Sbus Reset*/
        /* IQMT */     
        SHR_IF_ERR_EXIT(READ_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SBUS_RESETr, reg_above_64_val, BLOCKS_SBUS_RESET_21f, 1);
        SHR_IF_ERR_EXIT(WRITE_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        /* IQMs */     
        SHR_IF_ERR_EXIT(READ_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SBUS_RESETr, reg_above_64_val, BLOCKS_SBUS_RESET_19f, 1);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SBUS_RESETr, reg_above_64_val, BLOCKS_SBUS_RESET_20f, 1);
        SHR_IF_ERR_EXIT(WRITE_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        /* all the rest */
        ...
        if (SOC_REG_IS_VALID(unit,ECI_GP_CONTROL_9r)) {
            SHR_IF_ERR_EXIT(READ_ECI_GP_CONTROL_9r(unit, reg_above_64_val));
            soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_9r, reg_above_64_val, PDM_RSTNf, 1);
            SHR_IF_ERR_EXIT(WRITE_ECI_GP_CONTROL_9r(unit, reg_above_64_val));
        }

        /* Take MBU in or out of reset */
        SHR_IF_ERR_EXIT(READ_ECI_ECIC_MISC_RESETr(unit, &reg_val));
    #ifdef FINAL_JER2_RESET_SEQUENCE
        field = TIME_SYNC_RESETf;
        soc_reg_field_set(unit, ECI_ECIC_BLOCKS_RESETr, &reg_val,field , 1);
    #else
        reg_val |= 1;
    #endif
        if (soc_reg_field_valid(unit, ECI_ECIC_MISC_RESETr, TIME_SYNC_RESETf)) {
        ...
        if (disable_hard_reset == 1) {
            ...
            SHR_IF_ERR_EXIT(WRITE_CMIC_TXBUF_IPINTF_INTERFACE_CREDITSr(unit, 0x40));
            SHR_IF_ERR_EXIT(WRITE_CMIC_TXBUF_IPINTF_INTERFACE_CREDITSr(unit, 0x0));

            /* Release all credits of CMIC packet I/F so that it can accept packets */
            SHR_IF_ERR_EXIT(WRITE_CMIC_RXBUF_EPINTF_RELEASE_ALL_CREDITSr(unit, 0x0));
            SHR_IF_ERR_EXIT(WRITE_CMIC_RXBUF_EPINTF_RELEASE_ALL_CREDITSr(unit, 0x1));
            SHR_IF_ERR_EXIT(WRITE_CMIC_RXBUF_EPINTF_RELEASE_ALL_CREDITSr(unit, 0x0));
        }
    }
    ...
    if ((reset_action == SOC_DNX_RESET_ACTION_OUT_RESET) || (reset_action == SOC_DNX_RESET_ACTION_INOUT_RESET)) {
        ...
        /* IQMT */     
        SHR_IF_ERR_EXIT(READ_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SBUS_RESETr, reg_above_64_val, BLOCKS_SBUS_RESET_21f, 0);
        SHR_IF_ERR_EXIT(WRITE_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        /* IQMs */     
        SHR_IF_ERR_EXIT(READ_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SBUS_RESETr, reg_above_64_val, BLOCKS_SBUS_RESET_19f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SBUS_RESETr, reg_above_64_val, BLOCKS_SBUS_RESET_20f, 0);
        SHR_IF_ERR_EXIT(WRITE_ECI_BLOCKS_SBUS_RESETr(unit, reg_above_64_val));
        /* all the rest */
        ...
        #ifdef FINAL_JER2_RESET_SEQUENCE
        field = TIME_SYNC_RESETf;
        soc_reg_field_set(unit, ECI_ECIC_BLOCKS_RESETr, &reg_val,field , 0);
        #else
        reg_val |= 1;
        #endif
        if (soc_reg_field_valid(unit, ECI_ECIC_MISC_RESETr, TIME_SYNC_RESETf)) {
            soc_reg_field_set(unit, ECI_ECIC_MISC_RESETr, &reg_val, TIME_SYNC_RESETf, 0);
        }
        SHR_IF_ERR_EXIT(WRITE_ECI_ECIC_MISC_RESETr(unit, reg_val));
    }
#ifdef JER_2_TO_DO
    ...
    if (is_in_reset == 0x0) {
        ...
        SHR_IF_ERR_EXIT(soc_dnx_reset_blocks_poll_init_finish(unit));
    }
#endif
exit:
    SHR_FUNC_EXIT;
 ...
 */
int dnx_redo_soft_reset_soft_init(int unit, int perform_soft_reset)
{
    ...
    dnx_stk_sys_traffic_enable_get(unit, &data_on);
    bcm_dnx_fabric_control_get(unit, bcmFabricControlCellsEnable, &control_cells_on);
    ...
    SHR_IF_ERR_EXIT(soc_dnx_soft_init(unit));
