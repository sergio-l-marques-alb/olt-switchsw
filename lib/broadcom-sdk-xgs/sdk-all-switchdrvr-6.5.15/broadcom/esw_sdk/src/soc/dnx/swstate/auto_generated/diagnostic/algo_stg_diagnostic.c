/** \file dnx/swstate/auto_generated/diagnostic/algo_stg_diagnostic.c
 *
 ...
 */
int
algo_stg_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(algo_stg_db_stg_id_dump(unit));
 ...
 */
int
algo_stg_db_stg_id_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
