 ...
 */
static shr_error_e
jer2_a0_dnx_data_linkscan_general_error_delay_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_linkscan_general_max_error_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_linkscan;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_linkscan_general_thread_priority_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_linkscan;
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_linkscan_general_error_delay_set;
    data_index = dnx_data_linkscan_general_define_max_error;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_linkscan_general_max_error_set;
    data_index = dnx_data_linkscan_general_define_thread_priority;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_linkscan_general_thread_priority_set;
