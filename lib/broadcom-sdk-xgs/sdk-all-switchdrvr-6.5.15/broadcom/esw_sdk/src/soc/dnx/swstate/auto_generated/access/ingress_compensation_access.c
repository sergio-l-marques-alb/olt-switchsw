/** \file dnx/swstate/auto_generated/access/ingress_compensation_access.c
 *
 ...
 */
int
dnx_ingress_compensation_db_compensation_set(int unit, sw_state_algo_template_t compensation)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_get(int unit, sw_state_algo_template_t *compensation)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *compensation = ((dnx_ingress_compensation_db_t*)sw_state_roots_array[unit][INGRESS_COMPENSATION_MODULE_ID])->compensation;
    DNX_SW_STATE_LOG(
        unit,
 ...
 */
int
dnx_ingress_compensation_db_compensation_create(int unit, sw_state_algo_template_create_data_t * data, void *extra_arguments)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_exchange(int unit, int core_id, uint32 flags, const int *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_replace_data(int unit, int core_id, int profile, const int *new_profile_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_profile_data_get(int unit, int core_id, int profile, int *ref_count, int *profile_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_profile_get(int unit, int core_id, const int *profile_data, int *profile)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_get_next(int unit, int core_id, int *current_profile)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_compensation_db_compensation_dump_info_get(int unit, int core_id, sw_state_algo_template_dump_data_t * info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
