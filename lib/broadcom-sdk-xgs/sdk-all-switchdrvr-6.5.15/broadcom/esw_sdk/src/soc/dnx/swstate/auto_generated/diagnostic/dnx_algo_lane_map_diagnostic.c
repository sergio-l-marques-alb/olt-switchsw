 ...
 */
int
dnx_algo_lane_map_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_algo_lane_map_db_lane_map_dump(unit, -1));
 ...
 */
int
dnx_algo_lane_map_db_lane_map_dump(int  unit,  int  lane_map_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_algo_lane_map_db_lane_map_map_size_dump(unit, lane_map_idx_0));
    SHR_IF_ERR_EXIT(dnx_algo_lane_map_db_lane_map_lane2serdes_dump(unit, lane_map_idx_0, -1));
    SHR_IF_ERR_EXIT(dnx_algo_lane_map_db_lane_map_serdes2lane_dump(unit, lane_map_idx_0, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_algo_lane_map_db_lane_map_map_size_dump(int  unit,  int  lane_map_idx_0)
{
 ...
 */
int
dnx_algo_lane_map_db_lane_map_lane2serdes_dump(int  unit,  int  lane_map_idx_0,  int  lane2serdes_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_algo_lane_map_db_lane_map_lane2serdes_rx_id_dump(int  unit,  int  lane_map_idx_0,  int  lane2serdes_idx_0)
{
    int i0 = lane_map_idx_0, I0 = lane_map_idx_0 + 1;
    int i1 = lane2serdes_idx_0, I1 = lane2serdes_idx_0 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnx_algo_lane_map_db_lane_map_lane2serdes_tx_id_dump(int  unit,  int  lane_map_idx_0,  int  lane2serdes_idx_0)
{
    int i0 = lane_map_idx_0, I0 = lane_map_idx_0 + 1;
    int i1 = lane2serdes_idx_0, I1 = lane2serdes_idx_0 + 1;
    char *s0 = "", *s1 = "";
 ...
 */
int
dnx_algo_lane_map_db_lane_map_serdes2lane_dump(int  unit,  int  lane_map_idx_0,  int  serdes2lane_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_algo_lane_map_db_lane_map_serdes2lane_rx_id_dump(int  unit,  int  lane_map_idx_0,  int  serdes2lane_idx_0)
{
    int i0 = lane_map_idx_0, I0 = lane_map_idx_0 + 1;
    int i1 = serdes2lane_idx_0, I1 = serdes2lane_idx_0 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
dnx_algo_lane_map_db_lane_map_serdes2lane_tx_id_dump(int  unit,  int  lane_map_idx_0,  int  serdes2lane_idx_0)
{
    int i0 = lane_map_idx_0, I0 = lane_map_idx_0 + 1;
    int i1 = serdes2lane_idx_0, I1 = serdes2lane_idx_0 + 1;
    char *s0 = "", *s1 = "";
