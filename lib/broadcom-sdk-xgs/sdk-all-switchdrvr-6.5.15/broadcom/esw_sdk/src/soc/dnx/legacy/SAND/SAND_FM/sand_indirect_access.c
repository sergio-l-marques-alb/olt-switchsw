  ...
  )
{
  ...
  {
  /* Skip verification for BCM: ex = _SHR_E_INTERNAL ;*/
    goto exit ;
  }
  ex =
    dnx_sand_indirect_validate_tables_info(
...
*  DNX_SAND_DIRECT:
*   _SHR_E_INTERNAL  -
*     _SHR_E_NONE -  if legal
*     _SHR_E_INTERNAL - illegal address or size
*  DNX_SAND_INDIRECT:
*REMARKS:
...
*  DNX_SAND_DIRECT:
*   long  -
*     _SHR_E_NONE          - trigger is 0
*     _SHR_E_INTERNAL - timeout occurred
  ...
  )
{
  ...
  SHR_NULL_CHECK(result_ptr, _SHR_E_PARAM, "result_ptr");
  ...
  )
{
  ...
  {
    SHR_ERR_EXIT(_SHR_E_INTERNAL, "SOC_SAND_NULL_USER_CALLBACK_FUNC");
  }
  ...
  )
{
  ...
  SHR_NULL_CHECK(data_ptr, _SHR_E_PARAM, "data_ptr");
