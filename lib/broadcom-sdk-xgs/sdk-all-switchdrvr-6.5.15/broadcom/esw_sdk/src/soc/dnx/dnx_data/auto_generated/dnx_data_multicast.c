 ...
 */
extern shr_error_e jer2_a0_data_multicast_attach(
    int unit);
/*
 * SUBMODULE - PARAMS:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_multicast_params_define_egress_destination_size].name = "egress_destination_size";
    submodule_data->defines[dnx_data_multicast_params_define_egress_destination_size].doc = "egress destination size (depends on nof tm ports)";
    /* Set data type flag */
    submodule_data->defines[dnx_data_multicast_params_define_egress_destination_size].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_multicast_params_define_mcdb_ext_format].name = "mcdb_ext_format";
    submodule_data->defines[dnx_data_multicast_params_define_mcdb_ext_format].doc = "whether extended format to be used";
    /* Set data type flag */
    submodule_data->defines[dnx_data_multicast_params_define_mcdb_ext_format].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_multicast_params_egress_destination_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_multicast, dnx_data_multicast_submodule_params, dnx_data_multicast_params_define_egress_destination_size);
}

uint32
dnx_data_multicast_params_mcdb_ext_format_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_multicast, dnx_data_multicast_submodule_params, dnx_data_multicast_params_define_mcdb_ext_format);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_multicast_attach(unit));
    }
    else
