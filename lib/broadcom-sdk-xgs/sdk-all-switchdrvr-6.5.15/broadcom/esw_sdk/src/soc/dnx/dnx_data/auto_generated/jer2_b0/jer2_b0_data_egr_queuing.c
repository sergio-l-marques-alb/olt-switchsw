/** \file jer2_b0_data_egr_queuing.c
 * 
 ...
 */
static shr_error_e
jer2_b0_dnx_data_egr_queuing_params_conditional_crdt_table_access_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_b0_dnx_data_egr_queuing_params_txq_iready_th_set(
    int unit)
{
 ...
 */
shr_error_e
jer2_b0_data_egr_queuing_attach(
    int unit)
{
    ...
    define->set = jer2_b0_dnx_data_egr_queuing_params_txq_iready_th_set;
    ...
    feature->set = jer2_b0_dnx_data_egr_queuing_params_conditional_crdt_table_access_set;
