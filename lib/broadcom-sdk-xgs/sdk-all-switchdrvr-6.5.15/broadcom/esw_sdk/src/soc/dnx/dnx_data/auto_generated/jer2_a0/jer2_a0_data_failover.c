 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_egress_size_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_ingress_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_fec_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_egr_no_protection_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_ing_no_protection_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_fec_no_protection_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_fec_facility_protection_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_nof_fec_path_select_banks_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_fec_bank_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_in_lif_protection_pointer_nof_msb_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_path_select_in_lif_protection_pointer_nof_lsb_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_failover_facility_accelerated_mode_enable_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_failover_path_select_egress_size_set;
    data_index = dnx_data_failover_path_select_define_ingress_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_ingress_size_set;
    data_index = dnx_data_failover_path_select_define_fec_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_fec_size_set;
    data_index = dnx_data_failover_path_select_define_egr_no_protection;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_egr_no_protection_set;
    data_index = dnx_data_failover_path_select_define_ing_no_protection;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_ing_no_protection_set;
    data_index = dnx_data_failover_path_select_define_fec_no_protection;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_fec_no_protection_set;
    data_index = dnx_data_failover_path_select_define_fec_facility_protection;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_fec_facility_protection_set;
    data_index = dnx_data_failover_path_select_define_nof_fec_path_select_banks;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_nof_fec_path_select_banks_set;
    data_index = dnx_data_failover_path_select_define_fec_bank_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_fec_bank_size_set;
    data_index = dnx_data_failover_path_select_define_in_lif_protection_pointer_nof_msb;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_in_lif_protection_pointer_nof_msb_set;
    data_index = dnx_data_failover_path_select_define_in_lif_protection_pointer_nof_lsb;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_failover_path_select_in_lif_protection_pointer_nof_lsb_set;
    ...
    feature->set = jer2_a0_dnx_data_failover_facility_accelerated_mode_enable_set;
