/** \file dnx/swstate/auto_generated/access/dnx_field_qualifier_access.c
 *
...
/*
 *
 * is_init function for the variable dnx_field_qual_sw_db
...
/*
 *
 * init function for the variable dnx_field_qual_sw_db
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
