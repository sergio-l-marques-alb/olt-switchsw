 ...
 */
int
dnx_field_tcam_manager_sw_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_manager_sw_tcam_handlers_dump(unit, -1));
 ...
 */
int
dnx_field_tcam_manager_sw_tcam_handlers_dump(int  unit,  int  tcam_handlers_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_manager_sw_tcam_handlers_mode_dump(unit, tcam_handlers_idx_0));
    SHR_IF_ERR_EXIT(dnx_field_tcam_manager_sw_tcam_handlers_state_dump(unit, tcam_handlers_idx_0));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_field_tcam_manager_sw_tcam_handlers_mode_dump(int  unit,  int  tcam_handlers_idx_0)
{
 ...
 */
int
dnx_field_tcam_manager_sw_tcam_handlers_state_dump(int  unit,  int  tcam_handlers_idx_0)
{
    int i0 = tcam_handlers_idx_0, I0 = tcam_handlers_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
