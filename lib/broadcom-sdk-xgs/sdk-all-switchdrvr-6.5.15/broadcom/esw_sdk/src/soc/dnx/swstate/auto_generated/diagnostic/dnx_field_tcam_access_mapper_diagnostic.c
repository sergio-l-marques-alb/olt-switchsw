 ...
 */
int
dnx_field_tcam_access_mapper_sw_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_mapper_sw_key_2_entry_id_hash_dump(unit, -1, -1));
 ...
 */
int
dnx_field_tcam_access_mapper_sw_key_2_entry_id_hash_dump(int  unit,  int  key_2_entry_id_hash_idx_0,  int  key_2_entry_id_hash_idx_1)
{
