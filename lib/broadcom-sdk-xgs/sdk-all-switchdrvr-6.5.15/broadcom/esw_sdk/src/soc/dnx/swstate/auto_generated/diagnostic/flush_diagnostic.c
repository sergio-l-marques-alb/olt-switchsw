 ...
 */
int
flush_db_context_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(flush_db_context_nof_valid_rules_dump(unit));
    SHR_IF_ERR_EXIT(flush_db_context_flush_in_bulk_dump(unit));
 ...
 */
int
flush_db_context_nof_valid_rules_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
flush_db_context_flush_in_bulk_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
