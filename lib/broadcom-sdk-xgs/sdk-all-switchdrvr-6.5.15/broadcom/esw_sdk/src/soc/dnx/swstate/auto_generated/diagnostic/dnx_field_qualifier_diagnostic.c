 ...
 */
int
dnx_field_qual_sw_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_qual_sw_db_info_dump(unit, -1));
 ...
 */
int
dnx_field_qual_sw_db_info_dump(int  unit,  int  info_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_qual_sw_db_info_valid_dump(int  unit,  int  info_idx_0)
{
 ...
 */
int
dnx_field_qual_sw_db_info_field_id_dump(int  unit,  int  info_idx_0)
{
    int i0 = info_idx_0, I0 = info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_qual_sw_db_info_size_dump(int  unit,  int  info_idx_0)
{
    int i0 = info_idx_0, I0 = info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_qual_sw_db_info_bcm_id_dump(int  unit,  int  info_idx_0)
{
    int i0 = info_idx_0, I0 = info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_qual_sw_db_info_ref_count_dump(int  unit,  int  info_idx_0)
{
    int i0 = info_idx_0, I0 = info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_qual_sw_db_info_flags_dump(int  unit,  int  info_idx_0)
{
    int i0 = info_idx_0, I0 = info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
