 ...
 */
int
dnx_scheduler_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_scheduler_db_port_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnx_scheduler_db_hr_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(dnx_scheduler_db_interface_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnx_scheduler_db_fmq_dump(unit, -1));
    SHR_IF_ERR_EXIT(dnx_scheduler_db_general_dump(unit, -1));
 ...
 */
int
dnx_scheduler_db_port_dump(int  unit,  int  port_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_scheduler_db_port_rate_dump(int  unit,  int  port_idx_0)
{
 ...
 */
int
dnx_scheduler_db_port_valid_dump(int  unit,  int  port_idx_0)
{
    int i0 = port_idx_0, I0 = port_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_scheduler_db_hr_dump(int  unit,  int  hr_idx_0,  int  hr_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_scheduler_db_hr_is_colored_dump(int  unit,  int  hr_idx_0,  int  hr_idx_1)
{
 ...
 */
int
dnx_scheduler_db_interface_dump(int  unit,  int  interface_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_scheduler_db_interface_modified_dump(unit, interface_idx_0, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_scheduler_db_interface_modified_dump(int  unit,  int  interface_idx_0,  int  modified_idx_0)
{
 ...
 */
int
dnx_scheduler_db_fmq_dump(int  unit,  int  fmq_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_scheduler_db_fmq_reserved_hr_flow_id_dump(unit, fmq_idx_0, -1));
    SHR_IF_ERR_EXIT(dnx_scheduler_db_fmq_nof_reserved_hr_dump(unit, fmq_idx_0));
    SHR_IF_ERR_EXIT(dnx_scheduler_db_fmq_fmq_flow_id_dump(unit, fmq_idx_0, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_scheduler_db_fmq_reserved_hr_flow_id_dump(int  unit,  int  fmq_idx_0,  int  reserved_hr_flow_id_idx_0)
{
 ...
 */
int
dnx_scheduler_db_fmq_nof_reserved_hr_dump(int  unit,  int  fmq_idx_0)
{
    int i0 = fmq_idx_0, I0 = fmq_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_scheduler_db_fmq_fmq_flow_id_dump(int  unit,  int  fmq_idx_0,  int  fmq_flow_id_idx_0)
{
    int i0 = fmq_idx_0, I0 = fmq_idx_0 + 1;
 ...
 */
int
dnx_scheduler_db_general_dump(int  unit,  int  general_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_scheduler_db_general_reserved_erp_hr_flow_id_dump(unit, general_idx_0, -1));
 ...
 */
int
dnx_scheduler_db_general_reserved_erp_hr_flow_id_dump(int  unit,  int  general_idx_0,  int  reserved_erp_hr_flow_id_idx_0)
{
 ...
 */
int
dnx_scheduler_db_general_nof_reserved_erp_hr_dump(int  unit,  int  general_idx_0)
{
    int i0 = general_idx_0, I0 = general_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
