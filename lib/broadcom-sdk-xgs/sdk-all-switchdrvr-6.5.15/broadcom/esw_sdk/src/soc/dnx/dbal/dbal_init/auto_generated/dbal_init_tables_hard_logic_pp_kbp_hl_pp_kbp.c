...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, cur_table_param, "KBP_OPCODE_MAPPING" /* name*/, NULL /* is valid*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    /** maturity level  */
    ...
    /** interface keys  */
    {
        ...
        key_field_counter++;
        db_field = &cur_table_param->key_fields[key_field_counter];
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_field(unit, db_field, "ACL_CONTEXT" /* name*/, NULL /* Valid*/, NULL /* Size*/, NULL /* Offset*/, NULL /* MaxValue*/, NULL /* MinValue*/, NULL /* ConstValue*/, NULL /* NofInstance*/, DBAL_PERMISSION_ALL /* Permission*/, FALSE /* ReverseOrder*/, NULL /* Type*/));
        key_field_counter++;
    ...
    /** interface results  */
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_field(unit, db_field, "KBP_OPCODE_ID" /* name*/, NULL /* Valid*/, NULL /* Size*/, NULL /* Offset*/, NULL /* MaxValue*/, NULL /* MinValue*/, NULL /* ConstValue*/, NULL /* NofInstance*/, DBAL_PERMISSION_ALL /* Permission*/, FALSE /* ReverseOrder*/, NULL /* Type*/));
            ...
            /** set access  */
            {
                /** access with instance index all: loop on all instanceIndex  */
                {
                    ...
                    for (field_instance = 0; field_instance < result_field.nof_instances_dnx_data.int_val; field_instance++)
                    {
                        ...
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, "KBP_OPCODE_ID" /* field name*/, field_instance /* instance index*/, NULL /* field size*/, NULL /* field offset*/, 0 /* is tcam*/, EMPTY /* encode type*/, NULL /* encode value*/));
