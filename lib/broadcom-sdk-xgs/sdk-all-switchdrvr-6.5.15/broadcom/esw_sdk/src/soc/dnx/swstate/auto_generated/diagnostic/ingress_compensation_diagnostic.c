/** \file dnx/swstate/auto_generated/diagnostic/ingress_compensation_diagnostic.c
 *
 ...
 */
int
dnx_ingress_compensation_db_dump(int  unit)
{
 ...
 */
int
dnx_ingress_compensation_db_compensation_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
