...
extern shr_error_e jer2_a0_data_crps_attach(
    int unit);
extern shr_error_e jer2_b0_data_crps_attach(
    int unit);
/*
 * SUBMODULE - ENGINE:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Values */
    submodule_data->tables[dnx_data_crps_expansion_table_itm_types].nof_values = 6;
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_itm_types].values[0].type = "bcm_stat_expansion_types_t[5]";
    ...
    /* Values */
    submodule_data->tables[dnx_data_crps_expansion_table_itpp_types].nof_values = 5;
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_itpp_types].values[0].type = "bcm_stat_expansion_types_t[5]";
    ...
    int value_index)
{
    ...
    {
        case 0:
            DNXC_DATA_MGMT_ARR_STR(buffer, 5, data->valid_types);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->total_nof_bits);
            break;
 ...
 */
static shr_error_e
dnx_data_crps_filter_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "filter";
    submodule_data->doc = "reject filter mask groups";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_crps_filter_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data crps filter features");

    submodule_data->features[dnx_data_crps_filter_latency_drop_is_supported].name = "latency_drop_is_supported";
    submodule_data->features[dnx_data_crps_filter_latency_drop_is_supported].doc = "Is latency drop filter supported?";
    submodule_data->features[dnx_data_crps_filter_latency_drop_is_supported].flags |= DNXC_DATA_F_FEATURE;

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_crps_filter_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data crps filter defines");

    submodule_data->defines[dnx_data_crps_filter_define_nof_drop_reasons].name = "nof_drop_reasons";
    submodule_data->defines[dnx_data_crps_filter_define_nof_drop_reasons].doc = "number of drop reasons";
    /* Set data type flag */
    submodule_data->defines[dnx_data_crps_filter_define_nof_drop_reasons].flags |= DNXC_DATA_F_DEFINE;

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_crps_filter_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data crps filter tables");

    /*
     * Table - drop_reason_groups
     */
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].name = "drop_reason_groups";
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].doc = "filter data - mask and profile_id values per filter group";
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].size_of_values = sizeof(dnx_data_crps_filter_drop_reason_groups_t);
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].entry_get = dnx_data_crps_filter_drop_reason_groups_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].nof_keys = 1;
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].keys[0].name = "name";
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].keys[0].doc = "filter group name";

    /* Values */
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].values, dnxc_data_value_t, submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].nof_values, "_dnx_data_crps_filter_table_drop_reason_groups table values");
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].values[0].name = "mask";
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].values[0].type = "uint64";
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].values[0].doc = "default bitmap value for reject reasons";
    submodule_data->tables[dnx_data_crps_filter_table_drop_reason_groups].values[0].offset = UTILEX_OFFSETOF(dnx_data_crps_filter_drop_reason_groups_t, mask);
 ...
 */
int
dnx_data_crps_filter_feature_get(
    int unit,
    dnx_data_crps_filter_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_filter, feature);
}
 ...
 */
uint32
dnx_data_crps_filter_nof_drop_reasons_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_filter, dnx_data_crps_filter_define_nof_drop_reasons);
}
 ...
 */
/* Table Get */
const dnx_data_crps_filter_drop_reason_groups_t *
dnx_data_crps_filter_drop_reason_groups_get(
    int unit,
    int name)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_filter, dnx_data_crps_filter_table_drop_reason_groups);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, name, 0);
    return (const dnx_data_crps_filter_drop_reason_groups_t *) data;

}

/* Get value as str */
shr_error_e
dnx_data_crps_filter_drop_reason_groups_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_crps_filter_drop_reason_groups_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_filter, dnx_data_crps_filter_table_drop_reason_groups);
    data = (const dnx_data_crps_filter_drop_reason_groups_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "0x%08x 0x%08x", COMPILER_64_LO(data->mask), COMPILER_64_HI(data->mask));
            break;
    }
...
/* Table Info Get */
const dnxc_data_table_info_t *
dnx_data_crps_filter_drop_reason_groups_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_filter, dnx_data_crps_filter_table_drop_reason_groups);
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_crps_filter_init(unit, &module_data->submodules[dnx_data_crps_submodule_filter]));
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_crps_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_crps_attach(unit));
    }
