 ...
 */
extern shr_error_e jer2_a0_data_ingr_reassembly_attach(
    int unit);
extern shr_error_e jer2_b0_data_ingr_reassembly_attach(
    int unit);
/*
 * SUBMODULE - CONTEXT:
 * {
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ingr_reassembly_context_base_addr_for_nif_only].name = "base_addr_for_nif_only";
    submodule_data->features[dnx_data_ingr_reassembly_context_base_addr_for_nif_only].doc = "Base address table is used for NIF ports only";
    submodule_data->features[dnx_data_ingr_reassembly_context_base_addr_for_nif_only].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /*
     * Table - dedicated_tdm_context
     */
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].name = "dedicated_tdm_context";
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].doc = "Is this interface works in dedicated TDM context mode";
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].size_of_values = sizeof(dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t);
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].entry_get = dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_entry_str_get;

    /* Keys */
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].nof_keys = 1;
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].keys[0].name = "ilkn_id";
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].keys[0].doc = "interlaken id";

    /* Values */
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].values, dnxc_data_value_t, submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].nof_values, "_dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context table values");
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].values[0].name = "is_dedicated";
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].values[0].type = "uint32";
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].values[0].doc = "enable/disable dedicated tdm mode";
    submodule_data->tables[dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context].values[0].offset = UTILEX_OFFSETOF(dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t, is_dedicated);
 ...
 */
/* Table Get */
const dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t *
dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_get(
    int unit,
    int ilkn_id)
{
    char *data;
    ...
    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_ingr_reassembly, dnx_data_ingr_reassembly_submodule_ilkn, dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context);
    /* Get data */
    data = dnxc_data_mgmt_table_data_get(unit, table, ilkn_id, 0);
    return (const dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t *) data;

}

/* Get value as str */
shr_error_e
dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t *data;
    SHR_FUNC_INIT_VARS(unit);

    /* Get table */
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_ingr_reassembly, dnx_data_ingr_reassembly_submodule_ilkn, dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context);
    data = (const dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->is_dedicated);
            break;
    }
...
/* Table Info Get */
const dnxc_data_table_info_t *
dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_info_get(
    int unit)
{

    /* Return table info */
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_ingr_reassembly, dnx_data_ingr_reassembly_submodule_ilkn, dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context);
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_ingr_reassembly_attach(unit));
    }
    else
    if (dnxc_data_mgmt_is_jer2_b0(unit))
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_ingr_reassembly_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_ingr_reassembly_attach(unit));
    }
