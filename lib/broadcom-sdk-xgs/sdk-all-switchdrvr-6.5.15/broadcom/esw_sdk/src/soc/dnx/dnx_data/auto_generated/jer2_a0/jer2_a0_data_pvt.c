 ...
 */
static shr_error_e
jer2_a0_dnx_data_pvt_general_nof_pvt_monitors_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_pvt_general_pvt_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pvt;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_pvt_general_pvt_factor_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pvt;
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_pvt_general_nof_pvt_monitors_set;
    data_index = dnx_data_pvt_general_define_pvt_base;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_pvt_general_pvt_base_set;
    data_index = dnx_data_pvt_general_define_pvt_factor;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_pvt_general_pvt_factor_set;
