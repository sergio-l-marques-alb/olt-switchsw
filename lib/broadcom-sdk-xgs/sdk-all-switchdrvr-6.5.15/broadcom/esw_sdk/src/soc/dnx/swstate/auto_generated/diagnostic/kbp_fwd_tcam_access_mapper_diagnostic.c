 ...
 */
int
kbp_fwd_tcam_access_mapper_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(kbp_fwd_tcam_access_mapper_key_2_entry_id_hash_dump(unit, -1));
 ...
 */
int
kbp_fwd_tcam_access_mapper_key_2_entry_id_hash_dump(int  unit,  int  key_2_entry_id_hash_idx_0)
{
