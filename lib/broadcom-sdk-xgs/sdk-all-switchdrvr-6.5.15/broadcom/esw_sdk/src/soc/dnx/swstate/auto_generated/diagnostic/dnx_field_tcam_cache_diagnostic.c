 ...
 */
int
dnx_field_tcam_cache_shadow_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow_tcam_bank_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow_payload_table_dump(unit, -1, -1));
 ...
 */
int
dnx_field_tcam_cache_shadow_tcam_bank_dump(int  unit,  int  tcam_bank_idx_0,  int  tcam_bank_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow_tcam_bank_entry_key_dump(unit, tcam_bank_idx_0,tcam_bank_idx_1, -1, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_field_tcam_cache_shadow_tcam_bank_entry_key_dump(int  unit,  int  tcam_bank_idx_0,  int  tcam_bank_idx_1,  int  entry_key_idx_0,  int  entry_key_idx_1)
{
 ...
 */
int
dnx_field_tcam_cache_shadow_payload_table_dump(int  unit,  int  payload_table_idx_0,  int  payload_table_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow_payload_table_entry_payload_dump(unit, payload_table_idx_0,payload_table_idx_1, -1, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_field_tcam_cache_shadow_payload_table_entry_payload_dump(int  unit,  int  payload_table_idx_0,  int  payload_table_idx_1,  int  entry_payload_idx_0,  int  entry_payload_idx_1)
{
