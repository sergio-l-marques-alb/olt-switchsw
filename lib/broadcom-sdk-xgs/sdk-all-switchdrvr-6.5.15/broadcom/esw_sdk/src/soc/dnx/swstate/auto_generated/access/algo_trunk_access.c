/** \file dnx/swstate/auto_generated/access/algo_trunk_access.c
 *
 ...
 */
int
algo_trunk_db_egress_trunk_set(int unit, sw_state_algo_template_t egress_trunk)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_get(int unit, sw_state_algo_template_t *egress_trunk)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_create(int unit, sw_state_algo_template_create_data_t * data, void *extra_arguments)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_allocate_single(int unit, int core_id, uint32 flags, bcm_trunk_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_free_single(int unit, int core_id, int profile, uint8 *last_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_exchange(int unit, int core_id, uint32 flags, const bcm_trunk_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_profile_data_get(int unit, int core_id, int profile, int *ref_count, bcm_trunk_t *profile_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_trunk_db_egress_trunk_profile_get(int unit, int core_id, const bcm_trunk_t *profile_data, int *profile)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
