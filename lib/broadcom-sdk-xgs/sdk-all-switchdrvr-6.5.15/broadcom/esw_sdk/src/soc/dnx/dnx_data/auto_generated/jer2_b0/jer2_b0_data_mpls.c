 ...
 */
static shr_error_e
jer2_b0_dnx_data_mpls_general_mpls_special_label_encap_handling_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_b0_dnx_data_mpls_general_mpls_control_word_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mpls;
    ...
    int unit)
{
    ...
    define->set = jer2_b0_dnx_data_mpls_general_mpls_special_label_encap_handling_set;
    data_index = dnx_data_mpls_general_define_mpls_control_word_supported;
    define = &submodule->defines[data_index];
    define->set = jer2_b0_dnx_data_mpls_general_mpls_control_word_supported_set;
