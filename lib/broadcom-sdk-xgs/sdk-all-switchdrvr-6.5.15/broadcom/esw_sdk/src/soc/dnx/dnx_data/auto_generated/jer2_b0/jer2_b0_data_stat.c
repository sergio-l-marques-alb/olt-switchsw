 ...
 */
static shr_error_e
jer2_b0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = jer2_b0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set;
