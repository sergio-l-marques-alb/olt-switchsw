 ...
 */
extern shr_error_e jer2_a0_data_trunk_attach(
    int unit);
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[0].name = "max_nof_groups_in_pool";
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[0].type = "uint32";
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[0].doc = "maximal number of groups in this pool";
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_trunk_parameters_pool_info_t, max_nof_groups_in_pool);
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[1].name = "max_nof_members_in_group";
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[1].type = "uint32";
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[1].doc = "maxmimal number of members in a group in this pool";
    submodule_data->tables[dnx_data_trunk_parameters_table_pool_info].values[1].offset = UTILEX_OFFSETOF(dnx_data_trunk_parameters_pool_info_t, max_nof_members_in_group);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_trunk_egress_trunk_define_nof].flags |= DNXC_DATA_F_DEFINE;
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_trunk_egress_trunk_define_nof_lb_keys_per_profile].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_trunk_egress_trunk_define_invalid_out_port].name = "invalid_out_port";
    submodule_data->defines[dnx_data_trunk_egress_trunk_define_invalid_out_port].doc = "invalid out port for egress trunk";
    /* Set data type flag */
    submodule_data->defines[dnx_data_trunk_egress_trunk_define_invalid_out_port].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_trunk_egress_trunk_invalid_out_port_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_trunk, dnx_data_trunk_submodule_egress_trunk, dnx_data_trunk_egress_trunk_define_invalid_out_port);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_trunk_attach(unit));
    }
    else
