    ...
    uint32 *full_field_val)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_struct_field_encode(unit, field_id, field_in_struct_id, field_in_struct_val, full_field_val));
    ...
    int *hw_val)
{
    ...
    for (ii = 0; ii < field_info->nof_enum_values; ii++)
    {
        if ((sal_strcasecmp(full_enum_name, field_info->enum_val_info[ii].name) == 0) && (!field_info->enum_val_info[ii].is_invalid))
        {
    ...
    uint32 entry_handle_id)
{
    ...
    dbal_entry_handle_release_macro(unit, entry_handle_id);
...

{
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_masked_get(unit, entry_handle_id, field_id, field_val, field_mask));
    ...
    uint8 field_mask[DBAL_FIELD_ARRAY_MAX_SIZE_IN_WORDS])
{
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr8_masked_get(unit, entry_handle_id, field_id, field_val, field_mask));
    ...
    rhlist_t ** parsed_info)
{
    ...
    dbal_field_types_defs_e main_field_type;
    ...
    if (is_dbal_field)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_fields_field_type_get(unit, field_id, &main_field_type));
        /** Decode the data and keep the string in 'decoded_data_string' */
        SHR_IF_ERR_EXIT(dbal_field_printable_string_get
                        (unit, field_id, data, NULL, 0, DBAL_FIELD_EMPTY, data_size_bits, decoded_data_string));
