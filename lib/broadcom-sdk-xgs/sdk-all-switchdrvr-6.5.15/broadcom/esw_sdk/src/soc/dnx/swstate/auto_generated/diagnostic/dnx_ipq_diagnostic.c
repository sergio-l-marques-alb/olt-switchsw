 ...
 */
int
dnx_ipq_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_ipq_db_base_queues_dump(unit, -1));
 ...
 */
int
dnx_ipq_db_base_queues_dump(int  unit,  int  base_queues_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ipq_db_base_queues_num_cos_dump(int  unit,  int  base_queues_idx_0)
{
 ...
 */
int
dnx_ipq_db_base_queues_sys_port_ref_counter_dump(int  unit,  int  base_queues_idx_0)
{
    int i0 = base_queues_idx_0, I0 = base_queues_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
