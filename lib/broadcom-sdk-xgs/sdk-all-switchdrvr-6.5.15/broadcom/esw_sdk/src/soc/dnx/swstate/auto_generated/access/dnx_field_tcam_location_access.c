...
dnx_field_tcam_location_sw_tcam_handlers_info_entries_occupation_bitmap_alloc(int unit, uint32 tcam_handlers_info_idx_0)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        dnx_data_device.general.max_nof_cores_get(unit) * sizeof(sw_state_occ_bm_t) / sizeof(*((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[tcam_handlers_info_idx_0].entries_occupation_bitmap));
...
dnx_field_tcam_location_sw_tcam_handlers_info_priorities_range_alloc(int unit, uint32 tcam_handlers_info_idx_0)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit, tcam_handlers_info_idx_0,
        dnx_data_device.general.max_nof_cores_get(unit) * sizeof(sw_state_sorted_ll_t) / sizeof(*((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[tcam_handlers_info_idx_0].priorities_range));
...
dnx_field_tcam_location_sw_tcam_banks_occupation_bitmap_alloc(int unit)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit,
        dnx_data_device.general.max_nof_cores_get(unit) * sizeof(sw_state_occ_bm_t) / sizeof(*((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_banks_occupation_bitmap));
