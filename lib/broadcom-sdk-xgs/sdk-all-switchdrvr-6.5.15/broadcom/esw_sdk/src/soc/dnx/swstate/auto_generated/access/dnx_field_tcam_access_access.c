...
dnx_field_tcam_access_sw_entry_location_hash_alloc(int unit)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit,
        dnx_data_device.general.max_nof_cores_get(unit) * sizeof(sw_state_htbl_t) / sizeof(*((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_location_hash));
