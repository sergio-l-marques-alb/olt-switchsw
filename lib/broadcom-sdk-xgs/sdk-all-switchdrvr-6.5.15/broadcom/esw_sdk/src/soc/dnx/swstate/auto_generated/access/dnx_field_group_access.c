...
dnx_field_group_sw_fg_info_alloc(int unit)
{
    ...
    DNX_SW_STATE_DEFAULT_VALUE_ASSIGN(
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[def_val_idx[0]].context_info[def_val_idx[1]].key_id.key_part,
    ...
    DNX_SW_STATE_DEFAULT_VALUE_LOOP(def_val_idx[1], DNX_FIELD_NUM_2MSB_COMBINATIONS)

    DNX_SW_STATE_DEFAULT_VALUE_LOOP(def_val_idx[2], DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_ACTION_PER_GROUP)

    DNX_SW_STATE_DEFAULT_VALUE_ASSIGN(
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[def_val_idx[0]].actions_payload_info.actions_on_payload_info[def_val_idx[1]][def_val_idx[2]].dnx_action,
 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_key_part_set(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, dnx_field_key_part_type_e key_part)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.key_part,
        key_part,
        dnx_field_key_part_type_e,
        0,
        "dnx_field_group_sw_fg_info_context_info_key_id_key_part_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &key_part,
        "dnx_field_group_sw[%d]->fg_info[%d].context_info[%d].key_id.key_part",
        unit, fg_info_idx_0, context_info_idx_0);
 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_key_part_get(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, dnx_field_key_part_type_e *key_part)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *key_part = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.key_part;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_set(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint8 bit_range_was_aligned)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.bit_range.bit_range_was_aligned,
        bit_range_was_aligned,
        uint8,
        0,
        "dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &bit_range_was_aligned,
        "dnx_field_group_sw[%d]->fg_info[%d].context_info[%d].key_id.bit_range.bit_range_was_aligned",
        unit, fg_info_idx_0, context_info_idx_0);
 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_get(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint8 *bit_range_was_aligned)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *bit_range_was_aligned = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.bit_range.bit_range_was_aligned;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_set(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, int16 bit_range_aligned_offset)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.bit_range.bit_range_aligned_offset,
        bit_range_aligned_offset,
        int16,
        0,
        "dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &bit_range_aligned_offset,
        "dnx_field_group_sw[%d]->fg_info[%d].context_info[%d].key_id.bit_range.bit_range_aligned_offset",
        unit, fg_info_idx_0, context_info_idx_0);
 ...
 */
int
dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_get(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, int16 *bit_range_aligned_offset)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *bit_range_aligned_offset = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.bit_range.bit_range_aligned_offset;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_set(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, CONST dnx_field_action_in_group_info_t *actions_on_payload_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_MEMCPY(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1],
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        actions_on_payload_info,
        "dnx_field_group_sw[%d]->fg_info[%d].actions_payload_info.actions_on_payload_info[%d][%d]",
        unit, fg_info_idx_0, actions_on_payload_info_idx_0, actions_on_payload_info_idx_1);
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_get(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, dnx_field_action_in_group_info_t *actions_on_payload_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *actions_on_payload_info = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dnx_action_set(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, dnx_field_action_t dnx_action)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1].dnx_action,
        dnx_action,
        dnx_field_action_t,
        0,
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &dnx_action,
        "dnx_field_group_sw[%d]->fg_info[%d].actions_payload_info.actions_on_payload_info[%d][%d].dnx_action",
        unit, fg_info_idx_0, actions_on_payload_info_idx_0, actions_on_payload_info_idx_1);
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dnx_action_get(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, dnx_field_action_t *dnx_action)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *dnx_action = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1].dnx_action;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dont_use_valid_bit_set(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, uint8 dont_use_valid_bit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1].dont_use_valid_bit,
        dont_use_valid_bit,
        uint8,
        0,
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &dont_use_valid_bit,
        "dnx_field_group_sw[%d]->fg_info[%d].actions_payload_info.actions_on_payload_info[%d][%d].dont_use_valid_bit",
        unit, fg_info_idx_0, actions_on_payload_info_idx_0, actions_on_payload_info_idx_1);
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dont_use_valid_bit_get(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, uint8 *dont_use_valid_bit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *dont_use_valid_bit = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1].dont_use_valid_bit;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_lsb_set(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, uint8 lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1].lsb,
        lsb,
        uint8,
        0,
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &lsb,
        "dnx_field_group_sw[%d]->fg_info[%d].actions_payload_info.actions_on_payload_info[%d][%d].lsb",
        unit, fg_info_idx_0, actions_on_payload_info_idx_0, actions_on_payload_info_idx_1);
 ...
 */
int
dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_lsb_get(int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, uint8 *lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lsb = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].actions_payload_info.actions_on_payload_info[actions_on_payload_info_idx_0][actions_on_payload_info_idx_1].lsb;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_fg_info_action_size_set(int unit, uint32 fg_info_idx_0, uint32 action_size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].action_size,
        action_size,
        uint32,
        0,
        "dnx_field_group_sw_fg_info_action_size_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &action_size,
        "dnx_field_group_sw[%d]->fg_info[%d].action_size",
        unit, fg_info_idx_0);
 ...
 */
int
dnx_field_group_sw_fg_info_action_size_get(int unit, uint32 fg_info_idx_0, uint32 *action_size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *action_size = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].action_size;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
dnx_field_group_sw_ace_format_info_name_stringncat(int unit, uint32 ace_format_info_idx_0, char *src)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_group_sw_ace_format_info_name_stringncmp(int unit, uint32 ace_format_info_idx_0, char *cmp_string, int *result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_group_sw_ace_format_info_name_stringncpy(int unit, uint32 ace_format_info_idx_0, char *src)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_group_sw_ace_format_info_name_stringlen(int unit, uint32 ace_format_info_idx_0, uint32 *size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_group_sw_ace_format_info_name_stringget(int unit, uint32 ace_format_info_idx_0, char *o_string)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_field_group_sw_kbp_info_master_key_info_segment_info_qual_idx_set(int unit, uint32 kbp_info_idx_0, uint32 segment_info_idx_0, uint32 qual_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->kbp_info[kbp_info_idx_0].master_key_info.segment_info[segment_info_idx_0].qual_idx,
        qual_idx,
        uint32,
        0,
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &qual_idx,
        "dnx_field_group_sw[%d]->kbp_info[%d].master_key_info.segment_info[%d].qual_idx",
        unit, kbp_info_idx_0, segment_info_idx_0);
 ...
 */
int
dnx_field_group_sw_kbp_info_master_key_info_segment_info_qual_idx_get(int unit, uint32 kbp_info_idx_0, uint32 segment_info_idx_0, uint32 *qual_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *qual_idx = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->kbp_info[kbp_info_idx_0].master_key_info.segment_info[segment_info_idx_0].qual_idx;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
dnx_field_group_sw_cbs dnx_field_group_sw = 	{
	...
	dnx_field_group_sw_init,
		...
		,
			...
			,
				...
				,
					...
					dnx_field_group_sw_fg_info_context_info_key_id_key_part_set,
					dnx_field_group_sw_fg_info_context_info_key_id_key_part_get}
				,
					{
					...
					,
						...
						dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_set,
						dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_get}
					,
						{
						
						dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_set,
						dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_get}
					}
				}
			,
				{
		...
		,
			...
			dnx_field_group_sw_fg_info_action_size_set,
			dnx_field_group_sw_fg_info_action_size_get}
		,
			{
	...
	,
		...
		,
			...
			dnx_field_group_sw_ace_format_info_name_stringncat,
			dnx_field_group_sw_ace_format_info_name_stringncmp,
			dnx_field_group_sw_ace_format_info_name_stringncpy,
			dnx_field_group_sw_ace_format_info_name_stringlen,
			dnx_field_group_sw_ace_format_info_name_stringget}
		}
	,
		{
