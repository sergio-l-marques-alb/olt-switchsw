 ...
 */
static shr_error_e
jer2_a0_dnx_data_tunnel_ipv6_nof_terminated_sips_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_tunnel_udp_nof_udp_ports_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tunnel;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_tunnel_udp_first_udp_ports_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tunnel;
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_tunnel_ipv6_nof_terminated_sips_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_tunnel_udp_nof_udp_ports_profiles_set;
    data_index = dnx_data_tunnel_udp_define_first_udp_ports_profile;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_tunnel_udp_first_udp_ports_profile_set;
