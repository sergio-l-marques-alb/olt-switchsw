/** \file dnx/swstate/auto_generated/diagnostic/dnx_ingress_reassembly_diagnostic.c
 *
 ...
 */
int
dnx_ingress_reassembly_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_ingress_reassembly_db_alloc_dump(unit, -1));
 ...
 */
int
dnx_ingress_reassembly_db_alloc_dump(int  unit,  int  alloc_idx_0)
{
 ...
 */
int
dnx_ingress_reassembly_db_rcy_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_ingress_reassembly_db_rcy_reassembly_context_dump(unit, -1, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_ingress_reassembly_db_rcy_reassembly_context_dump(int  unit,  int  reassembly_context_idx_0,  int  reassembly_context_idx_1)
{
    ...
    for(; i0 < I0; i0++) {
        if (i1 == -1) {
            I1 = DNX_DATA_MAX_INGR_REASSEMBLY_PRIORITY_RCY_PRIORITIES_NOF;
        ...
        for(; i1 < I1; i1++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_ingress_reassembly_db[%d]->","((dnx_ingress_reassembly_db_t*)sw_state_roots_array[%d][DNX_INGRESS_REASSEMBLY_MODULE_ID])->","rcy.reassembly_context[%s%d][%s%d]: ", s0, i0, s1, i1);
 ...
 */
int
dnx_ingress_reassembly_db_mirror_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_ingress_reassembly_db_mirror_info_dump(unit, -1, -1, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_ingress_reassembly_db_mirror_info_dump(int  unit,  int  info_idx_0,  int  info_idx_1,  int  info_idx_2)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_ingress_reassembly_db_mirror_info_reassembly_context_dump(int  unit,  int  info_idx_0,  int  info_idx_1,  int  info_idx_2)
{
 ...
 */
int
dnx_ingress_reassembly_db_mirror_info_ref_count_dump(int  unit,  int  info_idx_0,  int  info_idx_1,  int  info_idx_2)
{
    int i0 = info_idx_0, I0 = info_idx_0 + 1;
    int i1 = info_idx_1, I1 = info_idx_1 + 1;
    int i2 = info_idx_2, I2 = info_idx_2 + 1;
