 ...
 */
static shr_error_e
jer2_a0_dnx_data_fifodma_general_nof_fifodma_channels_set(
    int unit)
{
 ...
 */
static shr_error_e
jer2_a0_dnx_data_fifodma_general_min_nof_host_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fifodma;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_fifodma_general_max_nof_host_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fifodma;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_fifodma_general_fifodma_map_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_fifodma_general_nof_fifodma_channels_set;
    data_index = dnx_data_fifodma_general_define_min_nof_host_entries;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_fifodma_general_min_nof_host_entries_set;
    data_index = dnx_data_fifodma_general_define_max_nof_host_entries;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_fifodma_general_max_nof_host_entries_set;
    ...
    table->set = jer2_a0_dnx_data_fifodma_general_fifodma_map_set;
