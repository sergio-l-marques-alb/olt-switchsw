 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_is_supported_set(
    int unit)
{
 ...
 */
/**
 * \brief device level function which set numeric burst_length
 * numeric info:
 * burst length
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_burst_length_set(
    int unit)
{
...
/**
 * \brief device level function which set numeric stop_traffic_temp_threshold
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_stop_traffic_temp_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric restore_traffic_temp_threshold
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_restore_traffic_temp_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric usec_between_temp_samples
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_usec_between_temp_samples_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric power_down_temp_threshold
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_power_down_temp_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric dram_temp_monitor_enable
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_dram_temp_monitor_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set define nof_hbms
 * define info:
 * number of HBMs
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_nof_hbms_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_nof_hbms;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define nof_channels
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_nof_channels_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_nof_channels;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define channel_broadcast_id
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_broadcast_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_channel_broadcast_id;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define mr_mask
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_mr_mask_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_mr_mask;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define nof_mrs
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_nof_mrs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_nof_mrs;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set define phy_address_mask
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_phy_address_mask_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_phy_address_mask;
    SHR_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_hbc_physical_last_in_chain_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
 ...
 */
/**
 * \brief device level function which set values for table mr_defaults
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_mr_defaults_set(
    int unit)
{
    int index_index;
    dnx_data_dram_hbm_mr_defaults_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int table_index = dnx_data_dram_hbm_table_mr_defaults;
    SHR_FUNC_INIT_VARS(unit);
     ...
     * Set key sizes
     */
    table->keys[0].size = dnx_data_dram.hbm.nof_mrs_get(unit);
    table->info_get.key_size[0] = dnx_data_dram.hbm.nof_mrs_get(unit);

    /* Info - default values */
    table->values[0].default_val = "0";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_mr_defaults_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_mr_defaults");

    /* Store Default Values */
    default_data = (dnx_data_dram_hbm_mr_defaults_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->value = 0;
    /* Set Default Values */
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_dram_hbm_mr_defaults_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    /*
     * Set Values - Entries
     */
    data = (dnx_data_dram_hbm_mr_defaults_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
    data->value = 0x70;
    data = (dnx_data_dram_hbm_mr_defaults_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
    data->value = 0xc0;
    data = (dnx_data_dram_hbm_mr_defaults_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
    data->value = 0x3;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_symmetric_regs_set(
    int unit)
{
    int index_index;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_not_symmetric_regs_set(
    int unit)
{
    int index_index;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_controller_symmetric_regs_set(
    int unit)
{
    int index_index;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_controller_not_symmetric_regs_set(
    int unit)
{
    int index_index;
...
/**
 * \brief device level function which set values for table channel_interrupt_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_interrupt_regs_set(
    int unit)
{
    int index_index;
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_channel_interrupt_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_channel_interrupt_regs");
...
/**
 * \brief device level function which set values for table controller_interrupt_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_controller_interrupt_regs_set(
    int unit)
{
    int index_index;
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_controller_interrupt_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_controller_interrupt_regs");
...
/**
 * \brief device level function which set values for table channel_debug_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_debug_regs_set(
    int unit)
{
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_channel_debug_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_channel_debug_regs");
...
/**
 * \brief device level function which set values for table channel_counter_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_counter_regs_set(
    int unit)
{
    int index_index;
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_channel_counter_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_channel_counter_regs");
...
/**
 * \brief device level function which set values for table channel_type_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_channel_type_regs_set(
    int unit)
{
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_channel_type_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_channel_type_regs");
...
/**
 * \brief device level function which set values for table controller_info_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_hbm_controller_info_regs_set(
    int unit)
{
    int index_index;
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_controller_info_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_controller_info_regs");
 ...
 */
/**
 * \brief device level function which set define otp_restore_version
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_otp_restore_version_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_frequency_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric buffer_size
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_buffer_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric command_address_parity
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_command_address_parity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric dq_write_parity
 * numeric info:
 * dq write parity
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_dq_write_parity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric dq_read_parity
 * numeric info:
 * dq read parity
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_dq_read_parity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric dbi_read
 * numeric info:
 * dbi read
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_dbi_read_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric dbi_write
 * numeric info:
 * dbi write
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_dbi_write_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric write_latency
 * numeric info:
 * write latency
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_write_latency_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric read_latency
 * numeric info:
 * read latency
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_read_latency_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric parity_latency
 * numeric info:
 * parity latency
 * 
 * \param [in] unit - Unit #
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_parity_latency_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric actual_parity_latency
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_actual_parity_latency_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set numeric tune_mode_on_init
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_tune_mode_on_init_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_dram_info_set(
    int unit)
{
    ...
    table->values[1].property.range_max = 0x3;
    data = (dnx_data_dram_general_info_dram_info_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
...
/**
 * \brief device level function which set values for table timing_params
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_timing_params_set(
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_general_info_timing_params_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dram_general_info_table_timing_params");
...
/**
 * \brief device level function which set values for table refresh_intervals
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_general_info_refresh_intervals_set(
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_general_info_refresh_intervals_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_general_info_table_refresh_intervals");
 ...
 */
/**
 * \brief device level function which set define matrix_column_size
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_address_translation_matrix_column_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set define physical_address_transaction_size
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_address_translation_physical_address_transaction_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_address_translation_matrix_configuration_set(
    int unit)
{
...
/**
 * \brief device level function which set values for table interrupt_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_address_translation_interrupt_regs_set(
    int unit)
{
    int index_index;
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_address_translation_interrupt_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_address_translation_table_interrupt_regs");
...
/**
 * \brief device level function which set values for table counter_regs
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_address_translation_counter_regs_set(
    int unit)
{
    int index_index;
    ...
    table->values[0].default_val = "INVALIDr";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_address_translation_counter_regs_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_address_translation_table_counter_regs");
 ...
 */
/**
 * \brief device level function which set numeric allowed_errors
 * numeric info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_buffers_allowed_errors_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set define nof_bdbs
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_buffers_nof_bdbs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
/**
 * \brief device level function which set define nof_fpc_banks
 * define info:
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_buffers_nof_fpc_banks_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
 ...
 */
/**
 * \brief device level function which set values for table deleted_buffers_info
 ...
 */
static shr_error_e
jer2_a0_dnx_data_dram_buffers_deleted_buffers_info_set(
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_buffers_deleted_buffers_info_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dram_buffers_table_deleted_buffers_info");
    ...
    sal_memcpy(data, default_data, table->size_of_values);
    /*
     * Value Property - deleted_buffers_file
     */
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_dram_hbm_burst_length_set;
    data_index = dnx_data_dram_hbm_define_stop_traffic_temp_threshold;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_stop_traffic_temp_threshold_set;
    data_index = dnx_data_dram_hbm_define_restore_traffic_temp_threshold;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_restore_traffic_temp_threshold_set;
    data_index = dnx_data_dram_hbm_define_usec_between_temp_samples;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_usec_between_temp_samples_set;
    data_index = dnx_data_dram_hbm_define_power_down_temp_threshold;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_power_down_temp_threshold_set;
    data_index = dnx_data_dram_hbm_define_dram_temp_monitor_enable;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_dram_temp_monitor_enable_set;
    data_index = dnx_data_dram_hbm_define_nof_hbms;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_nof_hbms_set;
    data_index = dnx_data_dram_hbm_define_nof_channels;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_nof_channels_set;
    data_index = dnx_data_dram_hbm_define_channel_broadcast_id;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_channel_broadcast_id_set;
    data_index = dnx_data_dram_hbm_define_mr_mask;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_mr_mask_set;
    data_index = dnx_data_dram_hbm_define_nof_mrs;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_nof_mrs_set;
    data_index = dnx_data_dram_hbm_define_phy_address_mask;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_phy_address_mask_set;
    data_index = dnx_data_dram_hbm_define_hbc_physical_last_in_chain;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_hbm_hbc_physical_last_in_chain_set;
    ...
    feature->set = jer2_a0_dnx_data_dram_hbm_is_supported_set;

    /*
     * Attach tables: 
     */
    data_index = dnx_data_dram_hbm_table_mr_defaults;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_mr_defaults_set;
    data_index = dnx_data_dram_hbm_table_channel_symmetric_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_channel_symmetric_regs_set;
    data_index = dnx_data_dram_hbm_table_channel_not_symmetric_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_channel_not_symmetric_regs_set;
    data_index = dnx_data_dram_hbm_table_controller_symmetric_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_controller_symmetric_regs_set;
    data_index = dnx_data_dram_hbm_table_controller_not_symmetric_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_controller_not_symmetric_regs_set;
    data_index = dnx_data_dram_hbm_table_channel_interrupt_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_channel_interrupt_regs_set;
    data_index = dnx_data_dram_hbm_table_controller_interrupt_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_controller_interrupt_regs_set;
    data_index = dnx_data_dram_hbm_table_channel_debug_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_channel_debug_regs_set;
    data_index = dnx_data_dram_hbm_table_channel_counter_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_channel_counter_regs_set;
    data_index = dnx_data_dram_hbm_table_channel_type_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_channel_type_regs_set;
    data_index = dnx_data_dram_hbm_table_controller_info_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_hbm_controller_info_regs_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_otp_restore_version_set;
    data_index = dnx_data_dram_general_info_define_frequency;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_frequency_set;
    data_index = dnx_data_dram_general_info_define_buffer_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_buffer_size_set;
    data_index = dnx_data_dram_general_info_define_command_address_parity;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_command_address_parity_set;
    data_index = dnx_data_dram_general_info_define_dq_write_parity;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_dq_write_parity_set;
    data_index = dnx_data_dram_general_info_define_dq_read_parity;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_dq_read_parity_set;
    data_index = dnx_data_dram_general_info_define_dbi_read;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_dbi_read_set;
    data_index = dnx_data_dram_general_info_define_dbi_write;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_dbi_write_set;
    data_index = dnx_data_dram_general_info_define_write_latency;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_write_latency_set;
    data_index = dnx_data_dram_general_info_define_read_latency;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_read_latency_set;
    data_index = dnx_data_dram_general_info_define_parity_latency;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_parity_latency_set;
    data_index = dnx_data_dram_general_info_define_actual_parity_latency;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_actual_parity_latency_set;
    data_index = dnx_data_dram_general_info_define_tune_mode_on_init;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_general_info_tune_mode_on_init_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_general_info_dram_info_set;
    data_index = dnx_data_dram_general_info_table_timing_params;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_general_info_timing_params_set;
    data_index = dnx_data_dram_general_info_table_refresh_intervals;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_general_info_refresh_intervals_set;
    /*
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_address_translation_matrix_column_size_set;
    data_index = dnx_data_dram_address_translation_define_physical_address_transaction_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_address_translation_physical_address_transaction_size_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_address_translation_matrix_configuration_set;
    data_index = dnx_data_dram_address_translation_table_interrupt_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_address_translation_interrupt_regs_set;
    data_index = dnx_data_dram_address_translation_table_counter_regs;
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_address_translation_counter_regs_set;
    /*
     * Attach submodule: buffers
     */
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_buffers_allowed_errors_set;
    data_index = dnx_data_dram_buffers_define_nof_bdbs;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_buffers_nof_bdbs_set;
    data_index = dnx_data_dram_buffers_define_nof_fpc_banks;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_dram_buffers_nof_fpc_banks_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jer2_a0_dnx_data_dram_buffers_deleted_buffers_info_set;
