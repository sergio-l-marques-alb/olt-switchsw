...
#include <src/bcm/dnx/rx/auto_generated/rx_internal_J2b0.h>
/*
 * }
 */
 ...
 */
static shr_error_e
jer2_b0_dnx_data_adapter_rx_packet_header_signal_id_set(
    int unit)
{
    ...
    /* Set default value */
    define->default_data = PACKET_HEADER_SIGNAL_ID_J2B0;

    /* Set value */
    define->data = PACKET_HEADER_SIGNAL_ID_J2B0;
    ...
    int unit)
{
    ...
    define->set = jer2_b0_dnx_data_adapter_rx_packet_header_signal_id_set;
