...
dnx_fabric_db_modids_to_group_map_alloc(int unit)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit,
        dnx_data_fabric.mesh.nof_max_dest_get(unit) * sizeof(dnx_fabric_modids_group_map_t) / sizeof(*((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->modids_to_group_map));
...
dnx_fabric_db_modids_to_group_map_modids_alloc(int unit, uint32 modids_to_group_map_idx_0)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit, modids_to_group_map_idx_0,
        dnx_data_device.general.max_nof_cores_get(unit) * sizeof(int) / sizeof(*((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->modids_to_group_map[modids_to_group_map_idx_0].modids));
