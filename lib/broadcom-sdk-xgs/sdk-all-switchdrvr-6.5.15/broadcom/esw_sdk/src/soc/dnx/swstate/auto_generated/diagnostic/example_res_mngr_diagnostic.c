/** \file dnx/swstate/auto_generated/diagnostic/example_res_mngr_diagnostic.c
 *
 ...
 */
int
algo_res_mngr_db_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_input_valid_core_all_dump(unit));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_input_valid_per_core_dump(unit, -1));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_input_valid_indexed_resource_dump(unit, -1));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_input_valid_indexed_resource_per_core_dump(unit, -1, -1));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_per_core_dump(unit, -1));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_invalid_dump(unit));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_indexed_resource_dump(unit, -1));
    SHR_IF_ERR_EXIT(algo_res_mngr_db_resource_test_indexed_resource_per_core_dump(unit, -1, -1));
 ...
 */
int
algo_res_mngr_db_resource_test_input_valid_core_all_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
algo_res_mngr_db_resource_test_input_valid_per_core_dump(int  unit,  int  resource_test_input_valid_per_core_idx_0)
{
 ...
 */
int
algo_res_mngr_db_resource_test_input_valid_indexed_resource_dump(int  unit,  int  resource_test_input_valid_indexed_resource_idx_0)
{
 ...
 */
int
algo_res_mngr_db_resource_test_input_valid_indexed_resource_per_core_dump(int  unit,  int  resource_test_input_valid_indexed_resource_per_core_idx_0,  int  resource_test_input_valid_indexed_resource_per_core_idx_1)
{
    ...
    int i1 = resource_test_input_valid_indexed_resource_per_core_idx_1, I1 = resource_test_input_valid_indexed_resource_per_core_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
algo_res_mngr_db_resource_test_per_core_dump(int  unit,  int  resource_test_per_core_idx_0)
{
 ...
 */
int
algo_res_mngr_db_resource_test_invalid_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
algo_res_mngr_db_resource_test_indexed_resource_dump(int  unit,  int  resource_test_indexed_resource_idx_0)
{
 ...
 */
int
algo_res_mngr_db_resource_test_indexed_resource_per_core_dump(int  unit,  int  resource_test_indexed_resource_per_core_idx_0,  int  resource_test_indexed_resource_per_core_idx_1)
{
    int i0 = resource_test_indexed_resource_per_core_idx_0, I0 = resource_test_indexed_resource_per_core_idx_0 + 1;
    int i1 = resource_test_indexed_resource_per_core_idx_1, I1 = resource_test_indexed_resource_per_core_idx_1 + 1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
algo_res_mngr_db_resource_test_core_all_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
