/** \file jer2_a0_data_consistent_hashing.c
 * 
 ...
 */
static shr_error_e
jer2_a0_dnx_data_consistent_hashing_calendar_max_nof_entries_in_calendar_set(
    int unit)
{
 ...
 */
shr_error_e
jer2_a0_data_consistent_hashing_attach(
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_consistent_hashing_calendar_max_nof_entries_in_calendar_set;
