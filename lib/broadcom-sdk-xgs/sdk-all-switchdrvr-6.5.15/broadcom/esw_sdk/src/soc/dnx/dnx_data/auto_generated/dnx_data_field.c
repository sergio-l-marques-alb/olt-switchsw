 ...
 */
extern shr_error_e jer2_a0_data_field_attach(
    int unit);
extern shr_error_e jer2_b0_data_field_attach(
    int unit);
/*
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_base_ipmf1_define_nof_l4_ops_ranges].name = "nof_l4_ops_ranges";
    submodule_data->defines[dnx_data_field_base_ipmf1_define_nof_l4_ops_ranges].doc = "Number of ranges for L4 Ops. For internal DNX_DATA use only.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_base_ipmf1_define_nof_l4_ops_ranges].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_base_ipmf1_nof_l4_ops_ranges_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_base_ipmf1, dnx_data_field_base_ipmf1_define_nof_l4_ops_ranges);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_base_epmf_define_nof_l4_ops_ranges].name = "nof_l4_ops_ranges";
    submodule_data->defines[dnx_data_field_base_epmf_define_nof_l4_ops_ranges].doc = "Number of ranges for L4 Ops. For internal DNX_DATA use only.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_base_epmf_define_nof_l4_ops_ranges].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_base_epmf_nof_l4_ops_ranges_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_base_epmf, dnx_data_field_base_epmf_define_nof_l4_ops_ranges);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /* Values */
    submodule_data->tables[dnx_data_field_stage_table_stage_info].nof_values = 74;
    ...
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[16].name = "nof_masks_per_fes";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[16].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[16].doc = "Number of masks per FES";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[16].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_masks_per_fes);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[17].name = "nof_fes_id_per_array";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[17].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[17].doc = "Number FESes in each FES array";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[17].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fes_id_per_array);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[18].name = "nof_fes_array";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[18].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[18].doc = "Number of FES arrays";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[18].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fes_array);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[19].name = "nof_fes_instruction_per_context";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[19].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[19].doc = "Number of FES INSTRUCTIONs per context";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[19].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fes_instruction_per_context);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[20].name = "nof_fes_programs";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[20].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[20].doc = "Number of FES programs";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[20].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fes_programs);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[21].name = "nof_prog_per_fes";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[21].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[21].doc = "Number of MS bits instruction programs per FES";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[21].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_prog_per_fes);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[22].name = "program_selection_cam_mask_nof_bits";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[22].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[22].doc = "Number of bits for data or mask in the memory IHB_FLP_PROGRAM_SELECTION_CAM";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[22].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, program_selection_cam_mask_nof_bits);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[23].name = "nof_contexts";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[23].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[23].doc = "Number of Ingress PMF_A programs (contexts)";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[23].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_contexts);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[24].name = "nof_link_profiles";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[24].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[24].doc = "Number of profiles assigned to iPMF1 contexts in order to create links between iPMF1 and iPMF2 contexts";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[24].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_link_profiles);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[25].name = "nof_cs_lines";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[25].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[25].doc = "Number of program selection lines";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[25].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_cs_lines);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[26].name = "nof_actions";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[26].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[26].doc = "Number of actions";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[26].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_actions);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[27].name = "nof_qualifiers";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[27].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[27].doc = "Number of qualifiers";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[27].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_qualifiers);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[28].name = "nof_80B_zones";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[28].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[28].doc = "Number of Ingress PMF 80b dedicated instruction groups";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[28].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_80B_zones);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[29].name = "nof_key_zones";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[29].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[29].doc = "Number of Ingress PMF 80b key zones";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[29].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_key_zones);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[30].name = "nof_key_zone_bits";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[30].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[30].doc = "Number of Ingress PMF 80b key zone bits";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[30].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_key_zone_bits);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[31].name = "nof_bits_in_fes_action";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[31].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[31].doc = "Number of bits on the output of a FES.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[31].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fes_action);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[32].name = "nof_bits_in_fes_key_select";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[32].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[32].doc = "Number of bits on input to FES.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[32].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fes_key_select);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[33].name = "nof_fes_key_selects_on_one_actions_line";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[33].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[33].doc = "Number of 'key select's that can go into one line on actions table.('double key' actions are considered one line)";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[33].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fes_key_selects_on_one_actions_line);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[34].name = "fem_condition_ms_bit_min_value";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[34].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[34].doc = "The minumum legal value to be set in bit select for a FEM.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[34].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fem_condition_ms_bit_min_value);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[35].name = "fem_condition_ms_bit_max_value";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[35].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[35].doc = "The maximum legal value to be set in bit select for a FEM.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[35].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fem_condition_ms_bit_max_value);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[36].name = "nof_bits_in_fem_programs";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[36].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[36].doc = "Number of bit in FEM program representation. This is log2 of the number of fem programs";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[36].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_programs);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[37].name = "nof_fem_programs";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[37].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[37].doc = "Total number FEM programs available.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[37].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fem_programs);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[38].name = "log_nof_bits_in_fem_key_select";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[38].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[38].doc = "Log2 of number of bits on one 'chunk' of input to FEM.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[38].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, log_nof_bits_in_fem_key_select);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[39].name = "nof_bits_in_fem_key_select";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[39].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[39].doc = "Number of bits on one 'chunk' of input to FEM.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[39].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_key_select);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[40].name = "fem_key_select_resolution_in_bits";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[40].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[40].doc = "Number of bits in the 'step' from one 'key select' to the following. See dbal_enum_value_field_field_pmf_a_fem_key_select_e.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[40].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fem_key_select_resolution_in_bits);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[41].name = "log_nof_bits_in_fem_map_data_field";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[41].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[41].doc = "Log2 of number of bits on MAP_DATA field in IPPC_FEM_MAP_INDEX_TABLE (See FIELD_PMF_A_FEM_MAP_INDEX dbal table).";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[41].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, log_nof_bits_in_fem_map_data_field);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[42].name = "nof_bits_in_fem_map_data_field";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[42].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[42].doc = "Number of bits on MAP_DATA field in IPPC_FEM_MAP_INDEX_TABLE (See FIELD_PMF_A_FEM_MAP_INDEX dbal table).";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[42].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_map_data_field);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[43].name = "nof_bits_in_fem_action_fems_2_15";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[43].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[43].doc = "Number of bits on action value in IPPC_FEM_*_24B_MAP_TABLE.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[43].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_action_fems_2_15);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[44].name = "nof_bits_in_fem_action_fems_0_1";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[44].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[44].doc = "Number of bits on action value in IPPC_FEM_*_4B_MAP_TABLE.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[44].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_action_fems_0_1);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[45].name = "nof_bits_in_fem_action";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[45].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[45].doc = "Maximal number of bits on action value in IPPC_FEM_*_*_MAP_TABLE.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[45].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_action);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[46].name = "nof_bits_in_fem_condition";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[46].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[46].doc = "Number of bits on fem condition. This is log2 of the number of conditions that may be assigned to each (fem_id,fem_program) combination.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[46].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_condition);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[47].name = "nof_fem_condition";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[47].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[47].doc = "Total number of fem conditions. This is the number of conditions that may be assigned to each (fem_id,fem_program) combination.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[47].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fem_condition);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[48].name = "nof_bits_in_fem_map_index";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[48].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[48].doc = "Number of bits on fem map index. This represents log2 of the number of actions that may be assigned to each condition.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[48].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_map_index);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[49].name = "nof_fem_map_index";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[49].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[49].doc = "Total number fem map indices. This represents the number of actions that may be assigned to each condition.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[49].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fem_map_index);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[50].name = "nof_bits_in_fem_id";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[50].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[50].doc = "Number of bits on fem identifier. This represents the number of FEMs in the system: No. of FEMs is 2^nof_bits_in_fem_id";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[50].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_in_fem_id);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[51].name = "nof_fem_id";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[51].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[51].doc = "Total number 'FEM id's available.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[51].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fem_id);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].name = "num_fems_with_short_action";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].doc = "Number of FEMs, starting from 'fem_id=0', which have only 4 bits on action value. The rest have 24 bits on action value";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, num_fems_with_short_action);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].name = "num_bits_in_fem_field_select";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].doc = "Number of bits on each of the HW field marked FIELD_SELECT_MAP_*";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, num_bits_in_fem_field_select);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].name = "nof_fem_id_per_array";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].doc = "Number of FEMs in each FEM array";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fem_id_per_array);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].name = "nof_fem_array";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].doc = "Number of FEM arrays";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fem_array);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].name = "nof_fems_per_context";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].doc = "Total number of FEMs on all arrays";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_fems_per_context);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].name = "default_strength";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].doc = "Default value for PMF strength";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, default_strength);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[58].name = "pbus_header_length";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[58].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[58].doc = "Number of bits reserved in Ingress PBUS for header";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[58].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, pbus_header_length);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[59].name = "nof_layer_records";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[59].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[59].doc = "Number of layer records taken from the parser.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[59].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_layer_records);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].name = "layer_record_size";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].doc = "Number of bits in each layer record.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[60].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, layer_record_size);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].name = "nof_compare_pairs_in_compare_mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].doc = "Number compare pairs in compare mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[61].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_compare_pairs_in_compare_mode);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].name = "nof_compare_keys_in_compare_mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].doc = "Number compare keys in compare mode";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[62].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_compare_keys_in_compare_mode);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].name = "compare_key_size";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].doc = "Size of the compare key in the system";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[63].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, compare_key_size);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].name = "nof_l4_ops_ranges";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].doc = "Number of ranges for L4 Ops";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[64].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_l4_ops_ranges);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].name = "nof_pkt_hdr_ranges";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].doc = "Number of ranges for PKT HDR";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[65].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_pkt_hdr_ranges);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].name = "nof_out_lif_ranges";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].doc = "Number of ranges for Out Lif";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[66].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_out_lif_ranges);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].name = "fes_key_select_for_zero_bit";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].doc = "The key select used for obtaining an always zero bit for input to FES (for example, using a zero padded bit).";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[67].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fes_key_select_for_zero_bit);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].name = "fes_shift_for_zero_bit";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].doc = "The shift used for obtaining an always zero bit for input to FES (for example, using a zero padded bit).";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[68].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, fes_shift_for_zero_bit);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].name = "uses_small_exem";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].doc = "Indicated if the stage can perform a SEXEM lookup.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[69].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, uses_small_exem);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].name = "uses_large_exem";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].doc = "Indicated if the stage can perform a LEXEM lookup.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[70].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, uses_large_exem);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].name = "cmp_selection";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].doc = "Compare selection for both keys of 2nd compare, See the CMP_SELECTION field in IPPC_PMF_GENERAL register for additional information";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[71].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, cmp_selection);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].name = "nof_bits_main_pbus";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].doc = "Number of bits in the main PBUS of the stage (the one used by METADATA qualifiers). Only iPMF2 uses the iPMF1 PBUs as it's main PBUS.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[72].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_main_pbus);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].name = "nof_bits_native_pbus";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].doc = "Number of bits in the native PBUS of the stage, if it is different from the main PBUS. Only iPMF2 has a separate native PBUS.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[73].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_native_pbus);
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 63:
            ...
            break;
        case 64:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->nof_l4_ops_ranges);
            break;
        case 65:
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_kbp_define_max_master_key_size].name = "max_master_key_size";
    submodule_data->defines[dnx_data_field_kbp_define_max_master_key_size].doc = "Maximum Master key size";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_kbp_define_max_master_key_size].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_kbp_max_master_key_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_kbp, dnx_data_field_kbp_define_max_master_key_size);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_tcam_define_hit_indication_entries_per_byte].name = "hit_indication_entries_per_byte";
    submodule_data->defines[dnx_data_field_tcam_define_hit_indication_entries_per_byte].doc = "Number of entries in byte, in TCAM and CS TCAM HIT and indication memories.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_tcam_define_hit_indication_entries_per_byte].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_tcam_hit_indication_entries_per_byte_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_tcam, dnx_data_field_tcam_define_hit_indication_entries_per_byte);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_group_define_id_fec_wa].name = "id_fec_wa";
    submodule_data->defines[dnx_data_field_group_define_id_fec_wa].doc = "FEC WA is being used in more then one WA context, hence must be created with_id so that other WA can re-use the FG";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_group_define_id_fec_wa].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_group_id_fec_wa_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_group, dnx_data_field_group_define_id_fec_wa);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 for ITMH Packets";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_itmh_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 for J1 ITMH Packets";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_pph_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for ITMH_PPH Packets";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_pph_presel_id_ipmf3].doc = "Default Presel in iPMF3 Id for ITMH_PPH Packets";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_itmh_pph_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for J1 ITMH_PPH Packets";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_j1_itmh_pph_presel_id_ipmf3].doc = "Default Presel in iPMF3 Id for J1 ITMH_PPH Packets";
    /* Set data type flag */
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_state_table_define_key_size].doc = "Size of the state table key in the system";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_state_table_define_key_size].flags |= DNXC_DATA_F_DEFINE;
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_state_table_define_address_max].flags |= DNXC_DATA_F_DEFINE;
    ...
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_state_table_define_address_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_state_table_define_data_size].name = "data_size";
    submodule_data->defines[dnx_data_field_state_table_define_data_size].doc = "Size of the data field in State Table in bits";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_state_table_define_data_size].flags |= DNXC_DATA_F_DEFINE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_exem_define_small_vmv_size].name = "small_vmv_size";
    submodule_data->defines[dnx_data_field_exem_define_small_vmv_size].doc = "Number of bits used to encode the container size";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_exem_define_small_vmv_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_exem_define_large_vmv_size].name = "large_vmv_size";
    submodule_data->defines[dnx_data_field_exem_define_large_vmv_size].doc = "Number of bits used to encode the container size";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_exem_define_large_vmv_size].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_exem_define_small_max_entry_result_size].name = "small_max_entry_result_size";
    submodule_data->defines[dnx_data_field_exem_define_small_max_entry_result_size].doc = "Small EXEM result (payload) size in bits, including VMV";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_exem_define_small_max_entry_result_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_exem_define_large_max_entry_result_size].name = "large_max_entry_result_size";
    submodule_data->defines[dnx_data_field_exem_define_large_max_entry_result_size].doc = "Large EXEM result (payload) size in bits, including VMV";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_exem_define_large_max_entry_result_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_exem_define_small_max_result_size].name = "small_max_result_size";
    submodule_data->defines[dnx_data_field_exem_define_small_max_result_size].doc = "Small EXEM result (payload) size in bits, not including VMV";
    /* Set data type flag */
    ...
    submodule_data->defines[dnx_data_field_exem_define_large_max_result_size].doc = "Large EXEM result (payload) size in bits, not including VMV";
    /* Set data type flag */
...
uint32
dnx_data_field_exem_small_vmv_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_exem, dnx_data_field_exem_define_small_vmv_size);
}

uint32
dnx_data_field_exem_large_vmv_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_exem, dnx_data_field_exem_define_large_vmv_size);
}
...
uint32
dnx_data_field_exem_small_max_entry_result_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_exem, dnx_data_field_exem_define_small_max_entry_result_size);
}

uint32
dnx_data_field_exem_large_max_entry_result_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_exem, dnx_data_field_exem_define_large_max_entry_result_size);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_common_max_val_define_nof_l4_ops_ranges].name = "nof_l4_ops_ranges";
    submodule_data->defines[dnx_data_field_common_max_val_define_nof_l4_ops_ranges].doc = "Maximal number of ranges for L4 Ops.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_common_max_val_define_nof_l4_ops_ranges].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_common_max_val_nof_l4_ops_ranges_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_common_max_val, dnx_data_field_common_max_val_define_nof_l4_ops_ranges);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_init_define_wa_fec_dest].name = "wa_fec_dest";
    submodule_data->defines[dnx_data_field_init_define_wa_fec_dest].doc = "APP WA for fec destination";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_fec_dest].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_l4_trap].name = "wa_l4_trap";
    submodule_data->defines[dnx_data_field_init_define_wa_l4_trap].doc = "APP WA for L4 Trap";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_l4_trap].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_oam_layer_index].name = "wa_oam_layer_index";
    submodule_data->defines[dnx_data_field_init_define_wa_oam_layer_index].doc = "APP WA for OAM Layer Index";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_oam_layer_index].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_oam_stat].name = "wa_oam_stat";
    submodule_data->defines[dnx_data_field_init_define_wa_oam_stat].doc = "APP WA for OAM Statistics";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_oam_stat].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_flow_id].name = "wa_flow_id";
    submodule_data->defines[dnx_data_field_init_define_wa_flow_id].doc = "APP WA for Flow ID";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_flow_id].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_roo].name = "wa_roo";
    submodule_data->defines[dnx_data_field_init_define_wa_roo].doc = "APP WA for Roo";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_roo].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_j1_same_port].name = "wa_j1_same_port";
    submodule_data->defines[dnx_data_field_init_define_wa_j1_same_port].doc = "APP WA for J1 Same port";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_j1_same_port].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_init_define_wa_j1_learning].name = "wa_j1_learning";
    submodule_data->defines[dnx_data_field_init_define_wa_j1_learning].doc = "APP WA for J1 Learning";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_init_define_wa_j1_learning].flags |= DNXC_DATA_F_DEFINE;
 ...
 */
uint32
dnx_data_field_init_wa_fec_dest_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_fec_dest);
}

uint32
dnx_data_field_init_wa_l4_trap_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_l4_trap);
}

uint32
dnx_data_field_init_wa_oam_layer_index_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_oam_layer_index);
}

uint32
dnx_data_field_init_wa_oam_stat_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_oam_stat);
}

uint32
dnx_data_field_init_wa_flow_id_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_flow_id);
}

uint32
dnx_data_field_init_wa_roo_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_roo);
}

uint32
dnx_data_field_init_wa_j1_same_port_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_j1_same_port);
}

uint32
dnx_data_field_init_wa_j1_learning_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_init, dnx_data_field_init_define_wa_j1_learning);
}
 ...
 */
static shr_error_e
dnx_data_field_hw_workarounds_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);
     ...
     * Features
     */
    submodule_data->nof_features = _dnx_data_field_hw_workarounds_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data field hw_workarounds features");

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_field_hw_workarounds_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data field hw_workarounds defines");

    submodule_data->defines[dnx_data_field_hw_workarounds_define_ecc_wa_enable].name = "ecc_wa_enable";
    submodule_data->defines[dnx_data_field_hw_workarounds_define_ecc_wa_enable].doc = "ECC is calculated per whole entry on each entry write, therefore, when writing half-entries\n                      wrong ECC values is being calculated, this workaround enables read-modify-write of the whole\n                      entry instead of writing half-entries to have correct ECC calculated on each write.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_hw_workarounds_define_ecc_wa_enable].flags |= DNXC_DATA_F_DEFINE;

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_field_hw_workarounds_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data field hw_workarounds tables");
 ...
 */
int
dnx_data_field_hw_workarounds_feature_get(
    int unit,
    dnx_data_field_hw_workarounds_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_hw_workarounds, feature);
}
 ...
 */
uint32
dnx_data_field_hw_workarounds_ecc_wa_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_hw_workarounds, dnx_data_field_hw_workarounds_define_ecc_wa_enable);
}
 ...
 */
static shr_error_e
dnx_data_field_hw_features_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "hw_features";
    submodule_data->doc = "Availability of features in HW";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_field_hw_features_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data field hw_features features");

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_field_hw_features_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data field hw_features defines");

    submodule_data->defines[dnx_data_field_hw_features_define_switch_to_acl_context].name = "switch_to_acl_context";
    submodule_data->defines[dnx_data_field_hw_features_define_switch_to_acl_context].doc = "Allows to swap the acl_context and fwd_context signals after iPMF1/2 using IPPC_PMF_GENERAL.SWITCH_TO_ACL_CONTEXT.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_hw_features_define_switch_to_acl_context].flags |= DNXC_DATA_F_DEFINE;

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_field_hw_features_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data field hw_features tables");
 ...
 */
int
dnx_data_field_hw_features_feature_get(
    int unit,
    dnx_data_field_hw_features_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_hw_features, feature);
}
 ...
 */
uint32
dnx_data_field_hw_features_switch_to_acl_context_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_hw_features, dnx_data_field_hw_features_define_switch_to_acl_context);
}
 ...
 */
static shr_error_e
dnx_data_field_minor_changes_j2_a0_b0_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "minor_changes_j2_a0_b0";
    submodule_data->doc = "Minor changes between jr2_a0 and JR2_b0, for internal DNX_DATA usage only";
    /*
     * Features
     */
    submodule_data->nof_features = _dnx_data_field_minor_changes_j2_a0_b0_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data field minor_changes_j2_a0_b0 features");

    /*
     * Defines
     */
    submodule_data->nof_defines = _dnx_data_field_minor_changes_j2_a0_b0_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data field minor_changes_j2_a0_b0 defines");

    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_lr_eth_is_da_mac_valid].name = "lr_eth_is_da_mac_valid";
    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_lr_eth_is_da_mac_valid].doc = "Whether layer record ETH_IS_DA_MAC works on device (works on JR2_B0 but not on JR2_A0). For internal DNX DATA usage only.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_lr_eth_is_da_mac_valid].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_per_pp_port_pmf_profile_cs_offset].name = "per_pp_port_pmf_profile_cs_offset";
    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_per_pp_port_pmf_profile_cs_offset].doc = "The placement of PMF_PROFILE field within ERPP_PER_PORT_TABLE. Used because DBAL mapping by device didn't work.";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_per_pp_port_pmf_profile_cs_offset].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_tcam_result_flip_eco].name = "tcam_result_flip_eco";
    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_tcam_result_flip_eco].doc = "The TCAM result flip ECO is about flippiing lsb and msb parts of the TCAM-result in order to support 80b result being parsed by ARR";
    /* Set data type flag */
    submodule_data->defines[dnx_data_field_minor_changes_j2_a0_b0_define_tcam_result_flip_eco].flags |= DNXC_DATA_F_DEFINE;

    /*
     * Tables
     */
    submodule_data->nof_tables = _dnx_data_field_minor_changes_j2_a0_b0_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data field minor_changes_j2_a0_b0 tables");
...
/*
 * minor_changes_j2_a0_b0 features
 */
int
dnx_data_field_minor_changes_j2_a0_b0_feature_get(
    int unit,
    dnx_data_field_minor_changes_j2_a0_b0_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_minor_changes_j2_a0_b0, feature);
}

/*
 * minor_changes_j2_a0_b0 defines
 */
uint32
dnx_data_field_minor_changes_j2_a0_b0_lr_eth_is_da_mac_valid_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_minor_changes_j2_a0_b0, dnx_data_field_minor_changes_j2_a0_b0_define_lr_eth_is_da_mac_valid);
}

uint32
dnx_data_field_minor_changes_j2_a0_b0_per_pp_port_pmf_profile_cs_offset_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_minor_changes_j2_a0_b0, dnx_data_field_minor_changes_j2_a0_b0_define_per_pp_port_pmf_profile_cs_offset);
}

uint32
dnx_data_field_minor_changes_j2_a0_b0_tcam_result_flip_eco_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_minor_changes_j2_a0_b0, dnx_data_field_minor_changes_j2_a0_b0_define_tcam_result_flip_eco);
}

/*
 * minor_changes_j2_a0_b0 tables
 */
/* Table Get */
/* Get value as str */
/* Table Info Get */
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_field_hw_workarounds_init(unit, &module_data->submodules[dnx_data_field_submodule_hw_workarounds]));
    SHR_IF_ERR_EXIT(dnx_data_field_hw_features_init(unit, &module_data->submodules[dnx_data_field_submodule_hw_features]));
    SHR_IF_ERR_EXIT(dnx_data_field_minor_changes_j2_a0_b0_init(unit, &module_data->submodules[dnx_data_field_submodule_minor_changes_j2_a0_b0]));
    /*
     * Attach device module
     */
    if (dnxc_data_mgmt_is_jer2_a0(unit))
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_field_attach(unit));
    }
    else
    if (dnxc_data_mgmt_is_jer2_b0(unit))
    {
        SHR_IF_ERR_EXIT(jer2_a0_data_field_attach(unit));
        SHR_IF_ERR_EXIT(jer2_b0_data_field_attach(unit));
    }
