 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_mirror_nof_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_mirror_nof_vlan_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_mirror_default_tagged_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_mirror_untagged_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_prob_max_val_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_crop_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_keep_orig_dest_on_dsp_ext_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_egress_mirror_snoop_nof_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_egress_mirror_nof_vlan_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_egress_mirror_default_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_egress_prob_max_val_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_egress_crop_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_mirror_nof_profiles_set;
    data_index = dnx_data_snif_ingress_define_mirror_nof_vlan_profiles;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_mirror_nof_vlan_profiles_set;
    data_index = dnx_data_snif_ingress_define_mirror_default_tagged_profile;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_mirror_default_tagged_profile_set;
    data_index = dnx_data_snif_ingress_define_mirror_untagged_profiles;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_mirror_untagged_profiles_set;
    data_index = dnx_data_snif_ingress_define_prob_max_val;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_prob_max_val_set;
    data_index = dnx_data_snif_ingress_define_crop_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_crop_size_set;
    data_index = dnx_data_snif_ingress_define_keep_orig_dest_on_dsp_ext;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_ingress_keep_orig_dest_on_dsp_ext_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_egress_mirror_snoop_nof_profiles_set;
    data_index = dnx_data_snif_egress_define_mirror_nof_vlan_profiles;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_egress_mirror_nof_vlan_profiles_set;
    data_index = dnx_data_snif_egress_define_mirror_default_profile;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_egress_mirror_default_profile_set;
    data_index = dnx_data_snif_egress_define_prob_max_val;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_egress_prob_max_val_set;
    data_index = dnx_data_snif_egress_define_crop_size;
    define = &submodule->defines[data_index];
    define->set = jer2_a0_dnx_data_snif_egress_crop_size_set;
