/** \file dnx/swstate/auto_generated/diagnostic/ecmp_diagnostic.c
 *
...
ecmp_db_info_dump(int  unit)
{
    ...
    SHR_IF_ERR_EXIT(ecmp_db_info_ecmp_hierarchy_dump(unit, -1));
    SHR_IF_ERR_EXIT(ecmp_db_info_ecmp_nof_used_elements_per_grain_dump(unit, -1));
 ...
 */
int
ecmp_db_info_members_tbl_addr_profile_link_lists_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
ecmp_db_info_consistent_hashing_manager_handle_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
ecmp_db_info_ecmp_res_manager_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
ecmp_db_info_ecmp_extended_res_manager_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
 ...
 */
int
ecmp_db_info_ecmp_hierarchy_dump(int  unit,  int  ecmp_hierarchy_idx_0)
{
 ...
 */
int
ecmp_db_info_ecmp_nof_used_elements_per_grain_dump(int  unit,  int  ecmp_nof_used_elements_per_grain_idx_0)
{
