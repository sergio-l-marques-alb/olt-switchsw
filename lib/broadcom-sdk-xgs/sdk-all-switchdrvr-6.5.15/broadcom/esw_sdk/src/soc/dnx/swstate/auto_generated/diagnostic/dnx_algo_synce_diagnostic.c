 ...
 */
int
dnx_algo_synce_db_dump(int  unit)
{
 ...
 */
int
dnx_algo_synce_db_fabric_synce_status_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_algo_synce_db_fabric_synce_status_master_synce_enabled_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_algo_synce_db_fabric_synce_status_slave_synce_enabled_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    dnx_sw_state_dump_attach_file(
        unit,
