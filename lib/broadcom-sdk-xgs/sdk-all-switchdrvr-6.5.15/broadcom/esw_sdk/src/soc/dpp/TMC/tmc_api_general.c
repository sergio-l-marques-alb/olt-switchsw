/* $Id: tmc_api_general.c,v 1.11 Broadcom SDK $
 * $Copyright: (c) 2018 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
*/
/******************************************************************
*
* FILENAME:       DuneDriver/tmc/src/soc_tmcapi_general.c
*
  ...
  )
{
  ...
  info->type = SOC_TMC_NOF_DEST_TYPES_ARAD; /* Use Arad NOF since its bigger than Soc_petra */
  info->id = 0;
  SOC_SAND_MAGIC_NUM_SET;
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
