...
static int jer_parser_ipv6_ext(int unit)
{
    ...
    {
        LOG_ERROR(BSL_LS_SOC_PKT,(BSL_META_U(0, "EHoIPv6: protocol 9 is used by bfdoIPvX\n")));
        return SOC_E_NOT_FOUND;
    }
    if (SOC_DPP_CONFIG(unit)->pp.limited_gtp_parsing)
    {
        LOG_ERROR(BSL_LS_SOC_PKT,(BSL_META_U(0, "EHoIPv6: protocol 12 is used by limited GTP parsing\n")));
        return SOC_E_NOT_FOUND;
    }
    ...
    ihp_parser_custom_macro_parameters_tbl_data.augment_previous_stage = 1;           /* Don't advance header qualifier */
...
static dpp_leaf_t IPv6Ext1_leafs[] =
{
  ...
  /* ICMPv6 Parsing */
  {{{(DPP_PARSER_IP_NEXT_PROTOCOL_ICMPv6 << 1), 2},
    {(DPP_PARSER_IP_NEXT_PROTOCOL_ICMPv6 << 1) + JER_IP_MC, 2}},
