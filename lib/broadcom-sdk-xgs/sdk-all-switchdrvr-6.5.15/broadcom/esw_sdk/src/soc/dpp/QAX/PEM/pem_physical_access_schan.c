/*
 * $Id: pem_physical_access_schan.c,v 1.0 2018/02/207  Exp $
...
/*
 * Physical write function for pemla in QUX
 */
...
/*
 * Physical read function for pemla in QUX
 */
