...
/* $Id: arad_pp_lif_ing_vlan_edit.c,v 1.13 Broadcom SDK $
 * $Copyright: (c) 2018 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
*/
/******************************************************************
*
* FILENAME:       DuneDriver/Arad/ARAD_PP/src/arad_pp_lif_ing_vlan_edit.c
*
...
/*Convert dp profile  to/from offset value { */
  ...
  )
{
  ...
  /*for PP only application,IVE command beyond 0x30 is reserved*/
...
/*********************************************************************
*     Set mapping from DP to the PCP and DEI
 *     values to be set in the transmitted packet's tag. 
 *     Details: in the H file. (search for prototype)
*********************************************************************/
...
/* in-lif-dp profile mapping format :
	*
	*	 |outer dp profile 	| inner dp profile 	| outer dp profile | inner dp profile |outer dp profile | inner dp profile |outer dp profile | inner dp profile |
	*	 |	in lif profile ==3				|	in lif profile ==2 			  | 		  in lif profile ==1		   |		  in lif profile ==0		     |
	*
	*
	*/

/*********************************************************************
*     Set mapping from IN-LIF profile to inner DP profile 
 *     Details: in the H file. (search for prototype)
*********************************************************************/
