...
CONST mbcm_pp_functions_t mbcm_pp_arad_driver = {
    ...
    NULL, /*   soc_qax_pp_oam_oamp_1711_pe_profile_update*/
   ...
   /** OAM ----> END */
	...
	arad_pp_frwrd_ip_ipmc_ssm_clear,/*mbcm_pp_ipmc_ssm_entry_clear*/
	...
	NULL, /* 	mbcm_jer_pp_mpls_termination_first_label_bit_map_set*/
	NULL, /*    mbcm_jer_pp_mpls_termination_first_label_bit_map_get, */
	NULL,/* 	mbcm_jer_pp_mpls_termination_first_label_bit_map_init*/
	/*MYMAC*/
    ...
    NULL, /* mbcm_pp_mtr_policer_global_mef_10_3_get*/
    NULL, /* mbcm_pp_mtr_policer_global_mef_10_3_set*/	
    ...
    /*Load Balancing*/
    NULL,                    /* soc_jer_pp_lag_get_load_balancing_diagnostic_signals */
    ...
    NULL, /* mbcm_pp_pppoe_anti_spoofing_add */
    NULL, /* mbcm_pp_pppoe_anti_spoofing_delete */
    NULL, /* mbcm_pp_pppoe_anti_spoofing_get */
    NULL, /* mbcm_pp_eg_qos_ether_dscp_remark_set */
    NULL, /* mbcm_pp_eg_qos_ether_dscp_remark_get */ 
    NULL, /* mbcm_pp_bfd_oamp_udp_src_port_check_enable */
    NULL, /* mbcm_pp_seamless_bfd_rx_dst_port_set */  
    NULL, /* mbcm_pp_seamless_bfd_rx_dst_port_get */
    NULL, /* mbcm_pp_oamp_pe_seamless_bfd_src_port_set */
    NULL  /* mbcm_pp_oamp_pe_seamless_bfd_src_port_get */
};
