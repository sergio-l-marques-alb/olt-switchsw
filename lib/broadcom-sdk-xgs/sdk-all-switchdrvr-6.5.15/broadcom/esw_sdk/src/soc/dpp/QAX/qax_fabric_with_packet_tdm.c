...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_disable_init
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     disable fabric module
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
* REMARKS:
*
*********************************************************************/
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_encoding_set
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     set fabric_with_packet_tdm encoding value
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
*  SOC_SAND_IN  uint32                       properties -
*  SOC_SAND_IN  portmod_port_pcs_t                         encoding  --
* REMARKS:
*
*********************************************************************/
int qax_fabric_with_packet_tdm_encoding_set(int unit, int quad, uint32 properties, portmod_port_pcs_t encoding)
{
    ...
    int fec_err_mark = 0;
    int cig_ignore = 0;
    int fmac_blk_id_masked = quad; /* | SOC_REG_ADDR_SCHAN_ID_MASK;*/
    uint32 reg_val;
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_encoding_get
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     get fabric_with_packet_tdm encoding value
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
*  SOC_SAND_OUT  uint32                       properties -
*  SOC_SAND_OUT  int                         encoding  --
* REMARKS:
*
*********************************************************************/
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_loopback_get
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     get fabric_with_packet_tdm loopback status
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
*  SOC_SAND_IN  portmod_loopback_mode_t                       loopback_type -
*     select loopback type, mac pcs/async fifo/mac out
*  SOC_SAND_OUT  int                         enable  --  loopback enable or disable status
* REMARKS:
*
*********************************************************************/
...
int qax_fabric_with_packet_tdm_loopback_get(int unit, int quad, portmod_loopback_mode_t loopback_type, int* enable)
{
    uint32 reg_val = 0;
    uint32 field[1] = {0};
    uint32 fmac_blk_id_masked = quad /*| SOC_REG_ADDR_SCHAN_ID_MASK*/;
    uint32 phy_index = 0;
    SOCDNX_INIT_FUNC_DEFS;
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_loopback_set
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     set fabric_with_packet_tdm loopback
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
*  SOC_SAND_IN  portmod_loopback_mode_t                       loopback_type -
*     select loopback type, mac pcs/async fifo/mac out
*  SOC_SAND_IN  int                         enable  --  loopback enable or disable
* REMARKS:
*
*********************************************************************/
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_link_get
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     get fabric_with_packet_tdm loopback link status
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
*  SOC_SAND_OUT  int                       link -
*    Get link status
* REMARKS:
*
*********************************************************************/
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_loopback_enable
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     enable fabric_with_packet_tdm loopback
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
*  SOC_SAND_IN  int                         enable -  enable or disable
* REMARKS:
*
*********************************************************************/
...
/*********************************************************************
* NAME:
*     qax_fabric_with_packet_tdm_port_probe
* TYPE:
*   PROC
* DATE:
*   Nov 10 2016
* FUNCTION:
*     probe fabric module, init and enable fabric module
* INPUT:
*  SOC_SAND_IN  int                         unit -
*     Identifier of the device to access.
*  SOC_SAND_IN  int                         quad -
