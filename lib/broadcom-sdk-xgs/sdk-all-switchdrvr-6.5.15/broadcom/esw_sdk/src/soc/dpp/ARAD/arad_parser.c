...
static ARAD_PARSERR_INFO
  Arad_parserr_info_eth[] =
  {
    ...
    {ARAD_PARSER_PROG_IPV6_EXT_1_BASE_START   + 0x0019, ARAD_PARSER_MACRO_SEL_IPV6_EXT_2   , ARAD_PARSER_PROG_FIN          , ARAD_PARSER_PFC_IPV6_ETH      , ARAD_PARSER_PLC_PP},
    ...
    {ARAD_PARSER_PROG_IPV6_EXT_1_BASE_START   + 0x0039, ARAD_PARSER_MACRO_SEL_IPV6_EXT_2   , ARAD_PARSER_PROG_FIN          , ARAD_PARSER_PFC_IPV6_ETH      , ARAD_PARSER_PLC_PP},
  ...
  )
{
  ...
  if (SOC_DPP_CONFIG(unit)->pp.limited_gtp_parsing) {
    ...
    {
        /* Check conflict of Marco Protocol */
        if ((SOC_DPP_CONFIG(unit)->pp.bfd_ipv4_single_hop) || (SOC_DPP_CONFIG(unit)->pp.bfd_ipv6_enable == SOC_DPP_ARAD_BFD_IPV6_SUPPORT_WITH_LEM))
        {
        ...
        */
        ...
        {
            /* Next Header == 0x11 'UDP' Next-Protocol = 0x9 */
            ...
            ihp_parser_custom_macro_parameters_tbl_data.cstm_comparator_mask   = (1 << ARAD_PARSER_CUSTOM_MACRO_PROTO_9) |
                                                                                  (1 << ARAD_PARSER_CUSTOM_MACRO_PROTO_12);
            ihp_parser_custom_macro_parameters_tbl_data.cstm_condition_select  = 0;
            ihp_parser_custom_macro_parameters_tbl_data.cstm_shift_sel         = 0;
            ...
            ihp_parser_custom_macro_parameters_tbl_data.header_qualifier_mask  = 0x780;       /* Update header qualifier */
            res = arad_pp_ihp_parser_custom_macro_parameters_tbl_set_unsafe(
                    unit,
                    custom_macro,
                    &ihp_parser_custom_macro_parameters_tbl_data
            ...
            ihp_parser_custom_macro_parameters_tbl_data.cstm_shift_b           = 8;           /* constant of 8 bytes*/
            ihp_parser_custom_macro_parameters_tbl_data.augment_previous_stage = 1;           /* Don't advance */
