 ...
 */
static shr_error_e
dnxc_generic_state_journal_rollback_dbal_table_destroy(
    int unit,
    uint8 *metadata,
    uint8 *payload,
    char *stamp)
 ...
 */
static inline shr_error_e
dnxc_generic_state_journal_log_dbal_table_destroy_internal(
    int unit,
    dbal_tables_e table_id)
{
    dnxc_generic_state_journal_dbal_table_entry_t entry;
 ...
 */
shr_error_e
dnxc_generic_state_journal_log_dbal_table_destroy(
    int unit,
    dbal_tables_e table_id)
{
    DNXC_GENERIC_STATE_JOURNAL_DEFS;
    ...
    SHR_IF_ERR_EXIT(dnxc_generic_state_journal_log_dbal_table_destroy_internal(unit, table_id));
