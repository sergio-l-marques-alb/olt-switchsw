    ...
    uint32 alloc_flags)
{
    ...
    DNX_SW_STATE_MEMSET(unit, module_id, (*hash_table)->keys, 0, 0x0, max_nof_elements * key_size, 0, "sw_state hash table keys");
    ...
    if (!is_index) {
        ...
        DNX_SW_STATE_MEMSET(unit, module_id, (*hash_table)->data, 0, 0x0, max_nof_elements * data_size, 0, "sw_state hash table data");
    } else {
