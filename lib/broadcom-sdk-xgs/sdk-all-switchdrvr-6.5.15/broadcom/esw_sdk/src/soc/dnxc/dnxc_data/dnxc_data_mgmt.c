    ...
    int unit)
{
    ...
    /*
     * Override with dynamic DNX data
     */
    ...
    int define_index)
{
    ...
    dnxc_data_define_t *define;
#ifdef BCM_DNX_SUPPORT
    DNX_INIT_TIME_ANALYZER_START(unit, DNX_INIT_TIME_ANALYZER_DNX_DATA);
#endif
    /*
     * get define struct
     */
...
#ifdef BCM_DNX_SUPPORT
    DNX_INIT_TIME_ANALYZER_STOP(unit, DNX_INIT_TIME_ANALYZER_DNX_DATA);
#endif
    /*
     * return actual data
     */
