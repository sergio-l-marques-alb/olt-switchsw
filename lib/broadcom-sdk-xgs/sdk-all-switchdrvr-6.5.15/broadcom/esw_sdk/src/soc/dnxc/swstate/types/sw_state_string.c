    ...
    char *dest)
{
    ...
    DNX_SW_STATE_MEMREAD(unit, dest, string, 0, sal_strlen(string), DNXC_SW_STATE_NO_FLAGS, "get the string.");
 ...
 */
shr_error_e
sw_state_string_dummy_empty_function_to_make_compiler_happy(
    int unit)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_FUNC_EXIT;
