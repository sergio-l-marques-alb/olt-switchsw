...
int
soc_dnxc_set_mem_mask(int unit, soc_reg_t reg, soc_field_t field, int all_one)
{
    int rc;
    int inst=0;
    int blk;
...
*/
int
soc_dnxc_interrupts_disable(int unit)
{
...
*      _SHR_E_XXX
*/
int soc_dnxc_interrupts_deinit(int unit)
{
    int ii;
...
*      _SHR_E_XXX
*/
int soc_dnxc_interrupts_init(int unit)
{
...
*/
int
soc_dnxc_interrupt_all_enable_set(int unit, int enable)
{
    SHR_FUNC_INIT_VARS(unit);
