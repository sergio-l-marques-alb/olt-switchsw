 ...
 */
int
sw_state_wb_engine_dump(int  unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(sw_state_wb_engine_buffer_dump(unit, -1, -1));
 ...
 */
int
sw_state_wb_engine_buffer_dump(int  unit,  int  engine_id,  int  buffer_id)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(sw_state_wb_engine_buffer_instance_dump(unit, engine_id,buffer_id, -1));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
sw_state_wb_engine_buffer_instance_dump(int  unit,  int  engine_id,  int  buffer_id,  int  instance_idx_0)
{
