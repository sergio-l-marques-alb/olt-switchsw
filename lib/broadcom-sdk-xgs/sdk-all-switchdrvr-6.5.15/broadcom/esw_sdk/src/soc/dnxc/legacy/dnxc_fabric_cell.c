...
shr_error_e
soc_dnxc_fabric_cell_parser(int unit, soc_dnxc_fabric_cell_entry_t entry, soc_dnxc_fabric_cell_parse_table_t *parse_table, uint32 nof_lines, soc_dnxc_fabric_cell_info_t *cell_info)
{
    int line,
        nof_uint32,
        i,
