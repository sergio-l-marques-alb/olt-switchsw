...
int cprimod_cpri_port_tx_vsd_ctrl_flow_get(int unit, int port, uint32 group_id, cprimod_cpri_tx_vsd_flow_info_t* config_info)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_vsd_ctrl_flow_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_vsd_ctrl_flow_get(unit, port, group_id, config_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_fast_clk_bit_time_period_set(int unit, int port, cprimod_port_speed_t speed)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_fast_clk_bit_time_period_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_fast_clk_bit_time_period_set(unit, port, speed);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
