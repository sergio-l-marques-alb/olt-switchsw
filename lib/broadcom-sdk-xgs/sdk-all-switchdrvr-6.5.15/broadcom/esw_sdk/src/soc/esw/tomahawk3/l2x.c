                        ...
                        void *fn_data)
{
    ...
    /* Note the order of delete and insert below is important, since for station
     * move condition in _soc_th3_learn_cache_entry_process, we delete an entry
     * first and then insert it with the new port info
     */
                         ...
                         int *stn_move)
{
    ...
    *stn_move = FALSE;
    if (result) {
        ...
        *stn_move = (k->port_tgid == port_tgid) ? FALSE : TRUE;
    }
...
soc_th3_l2_learn_thread_stop(int unit)
{
   ...
   if (SAL_BOOT_SIMULATION) {
        /* Allow an extra second on simulation */
        interval = soc->l2x_learn_interval + 1000000;
    } else {
        interval = 10 * 1000000;
    }
