...
#define _SOC_MV2_IPIPE0_CEV_INTR 0x00000001
#define _SOC_MV2_IPIPE0_IDB_INTR 0x00000040
#define _SOC_MV2_IPIPE0_IP_INTR 0x00000080
#define _SOC_MV2_IPIPE0_ISW4_INTR 0x00000100

extern _soc_bus_ser_en_info_t _soc_bcm56770_a0_ip_bus_ser_info[];
extern _soc_buffer_ser_en_info_t _soc_bcm56770_a0_ip_buffer_ser_info[];
extern _soc_bus_ser_en_info_t _soc_bcm56770_a0_ep_bus_ser_info[];
extern _soc_buffer_ser_en_info_t _soc_bcm56770_a0_ep_buffer_ser_info[];

typedef struct _soc_mv2_ser_mmu_intr_info_s {
    soc_reg_t   int_statf;
    int         mmu_base_index;
    int         ser_info_index;
} _soc_mv2_ser_mmu_intr_info_t;

typedef _soc_td3_ser_info_type_t _soc_mv2_ser_info_type_t;

typedef struct _soc_mv2_ser_route_block_s {
    ...
    void                *info;
    uint8               id;
} _soc_mv2_ser_route_block_t;

typedef struct _soc_mv2_tcam_wrapper_info_s {
    soc_mem_t   mem;
    soc_reg_t   enable_reg;
    soc_field_t enable_field;
    soc_field_t parity_field; /* used to sw inject test */
} _soc_mv2_tcam_wrapper_info_t;

typedef _soc_td3_ser_reg_t _soc_mv2_ser_reg_t;

typedef _soc_td3_ser_info_t _soc_mv2_ser_info_t;

typedef struct _soc_mv2_tmp_ser_info_s {
    soc_reg_t           enable_reg;
    soc_field_t         enable_field;
    uint32              value;
} _soc_mv2_tmp_ser_info_t;

typedef struct _soc_mv2_hash_table_ser_info_s {
    soc_mem_t       mem;
    soc_field_t     enable_field;
} _soc_mv2_hash_table_ser_info_t;

static soc_ser_functions_t _mv2_ser_functions;

static soc_field_t _soc_mv2_mmu_xpe_enable_fields[] = {
    AGING_PARITY_ENf,
    TCB_PARITY_ENf,
    THDM_PARITY_ENf,
    ENQX_PARITY_ENf,
...
static soc_field_t _soc_mv2_mmu_sc_enable_fields[] = {
    TDM_PARITY_ENf,
    VBS_PARITY_ENf,
    TOQ_PARITY_ENf,
    INVALIDf
...
static soc_field_t _soc_mv2_mmu_sed_enable_fields[] = {
    MB0_PARITY_ENf,
    MB1_PARITY_ENf,
    ENQS_PARITY_ENf,
    MTRO_PARITY_ENf,
...
static _soc_mv2_ser_info_t _soc_mv2_mmu_ser_info[] = {
    ...
    { _SOC_TD3_PARITY_TYPE_MMU_XPE, NULL, 0,
        ...
        MMU_XCFG_PARITY_ENr, INVALIDf, _soc_mv2_mmu_xpe_enable_fields,
    ...
    { _SOC_TD3_PARITY_TYPE_MMU_SC, NULL, 0,
        ...
        MMU_SCFG_PARITY_ENr, INVALIDf, _soc_mv2_mmu_sc_enable_fields,
    ...
    { _SOC_TD3_PARITY_TYPE_MMU_SED, NULL, 0,
        ...
        MMU_SEDCFG_PARITY_ENr, INVALIDf, _soc_mv2_mmu_sed_enable_fields,
...
static soc_field_t _soc_mv2_mmu_top_int_enable_fields[] = {
    SED_CPU_INT_ENf,
    SC_CPU_INT_ENf,
    XPE_CPU_INT_ENf,
    GLB_CPU_INT_ENf,
...
static soc_field_t _soc_mv2_mmu_top_int_status_fields[] = {
    SED_CPU_INT_STATf,
    SC_CPU_INT_STATf,
    XPE_CPU_INT_STATf,
    GLB_CPU_INT_STATf,
...
static _soc_mv2_ser_info_t _soc_mv2_mmu_top_ser_info[] = {
    { _SOC_TD3_PARITY_TYPE_MMU_SER, _soc_mv2_mmu_ser_info, 0,
        INVALIDf, INVALIDf,
        INVALIDm, "MMU MEM PAR",
        INVALIDr, INVALIDf, NULL,
        MMU_GCFG_ALL_CPU_INT_ENr, INVALIDf,
        _soc_mv2_mmu_top_int_enable_fields,
        MMU_GCFG_ALL_CPU_INT_STATr,
        NULL, INVALIDf, _soc_mv2_mmu_top_int_status_fields,
        INVALIDr, INVALIDf, NULL
    },
    { _SOC_TD3_PARITY_TYPE_NONE } /* table terminator */
};

static _soc_mv2_ser_reg_t _soc_mv2_pm_clp_rx_status_reg[] = {
    { CLPORT_MIB_RSC0_ECC_STATUSr, "CLP MIB RSC0 ECC" },
    { CLPORT_MIB_RSC1_ECC_STATUSr, "CLP MIB RSC1 ECC" },
    { INVALIDr, "INVALIDr"}
};

static _soc_mv2_ser_reg_t _soc_mv2_pm_clp_tx_status_reg[] = {
    { CLPORT_MIB_TSC0_ECC_STATUSr, "CLP MIB TSC0 ECC" },
    { CLPORT_MIB_TSC1_ECC_STATUSr, "CLP MIB TSC1 ECC" },
    { INVALIDr, "INVALIDr"}
};

static _soc_mv2_ser_reg_t _soc_mv2_pm_xlp_rx_status_reg[] = {
    { XLPORT_MIB_RSC0_ECC_STATUSr, "XLP MIB RSC0 ECC" },
    { XLPORT_MIB_RSC1_ECC_STATUSr, "XLP MIB RSC1 ECC" },
    { INVALIDr, "INVALIDr"}
};

static _soc_mv2_ser_reg_t _soc_mv2_pm_xlp_tx_status_reg[] = {
    { XLPORT_MIB_TSC0_ECC_STATUSr, "XLP MIB TSC0 ECC" },
    { XLPORT_MIB_TSC1_ECC_STATUSr, "XLP MIB TSC1 ECC" },
    { INVALIDr, "INVALIDr"}
};

static _soc_mv2_ser_info_t _soc_mv2_pm_clp_ser_info[] = {
    ...
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_mv2_pm_clp_rx_status_reg, INVALIDf, NULL,
    ...
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_mv2_pm_clp_tx_status_reg, INVALIDf, NULL,
        CLPORT_INTR_STATUSr, MIB_TX_MEM_ERRf, NULL
    },
    { _SOC_TD3_PARITY_TYPE_NONE } /* table terminator */
};

static _soc_mv2_ser_info_t _soc_mv2_pm_xlp_ser_info[] = {
    ...
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_mv2_pm_xlp_rx_status_reg, INVALIDf, NULL,
    ...
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_mv2_pm_xlp_tx_status_reg, INVALIDf, NULL,
        XLPORT_INTR_STATUSr, MIB_TX_MEM_ERRf, NULL
    },
    { _SOC_TD3_PARITY_TYPE_NONE } /* table terminator */
};

static _soc_mv2_ser_reg_t _soc_mv2_idb_status_reg[] = {
    ...
    { IDB_OBM17_DATA_ECC_STATUSr, "IDB OBM17 packet data memory" },
    { IDB_OBM18_DATA_ECC_STATUSr, "IDB OBM18 packet data memory" },
    { IDB_OBM19_DATA_ECC_STATUSr, "IDB OBM19 packet data memory" },
    ...
    { IDB_OBM17_CA_ECC_STATUSr, "IDB OBM17 CA packet buffer memory" },
    { IDB_OBM18_CA_ECC_STATUSr, "IDB OBM18 CA packet buffer memory" },
    { IDB_OBM19_CA_ECC_STATUSr, "IDB OBM19 CA packet buffer memory" },
    ...
    { IDB_OBM17_OVERSUB_MON_ECC_STATUSr, "IDB OBM17 oversub Monitoring memory" },
    { IDB_OBM18_OVERSUB_MON_ECC_STATUSr, "IDB OBM18 oversub Monitoring memory" },
    { IDB_OBM19_OVERSUB_MON_ECC_STATUSr, "IDB OBM19 oversub Monitoring memory" },
...
static _soc_mv2_ser_info_t _soc_mv2_idb_ser_info[] = {
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
    ...
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_mv2_idb_status_reg, ECC_ERRf, NULL,
        INVALIDr, INVALIDf, NULL
    },
...
static _soc_mv2_ser_info_t _soc_mv2_isw4_ser_info[] = {
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
...
static _soc_mv2_ser_info_t _soc_mv2_cev_ser_info[] = {
    { _SOC_TD3_PARITY_TYPE_ECC, NULL, 0,
...
static const
_soc_mv2_ser_route_block_t  _soc_mv2_ser_route_blocks[] = {
    { 0, _SOC_MV2_IPIPE0_CEV_INTR, /* CEV_TO_CMIC_INTR */
      SOC_BLK_IPIPE, 0, CENTRAL_CTR_EVICTION_INTR_ENABLEr,
      CENTRAL_CTR_EVICTION_INTR_STATUSr, INVALIDf,
      _soc_mv2_cev_ser_info, 0 },
    ...
    { 0, 0x00000010, /* MMU_TO_CMIC_MEMFAIL_INTR */
      ...
      _soc_mv2_mmu_top_ser_info, 0 },
    { 0, 0x00000020, /* PIPE0_EP_TO_CMIC_PERR_INTR */
      SOC_BLK_EPIPE, 0, EGR_INTR_ENABLEr, EGR_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
      NULL, 0 },
    { 0, _SOC_MV2_IPIPE0_IDB_INTR, /* PIPE0_IDB_TO_CMIC_PERR_INTR */
      SOC_BLK_IPIPE, 0, IP0_INTR_ENABLEr, IP0_INTR_STATUSr, INVALIDf,
      _soc_mv2_idb_ser_info, 0 },
    { 0, _SOC_MV2_IPIPE0_IP_INTR, /* PIPE0_IP_TO_CMIC_PERR_INTR */
      SOC_BLK_IPIPE, 0, INVALIDr, INVALIDr, INVALIDf,
      NULL, 0 },
    { 0, _SOC_MV2_IPIPE0_ISW4_INTR, /* PIPE0_ISW4_TO_CMIC_PERR_INTR */
      SOC_BLK_IPIPE, 0, ISW4_INTR_ENABLEr, ISW4_INTR_STATUSr, INVALIDf,
      _soc_mv2_isw4_ser_info, 0 },
    { 1, 0x00000001, /* PM0_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 0 },
    { 1, 0x00000002, /* PM1_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 1 },
    { 1, 0x00000004, /* PM2_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 2 },
    { 1, 0x00000008, /* PM3_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 3 },
    { 1, 0x00000010, /* PM4_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 4 },
    { 1, 0x00000020, /* PM5_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 5 },
    { 1, 0x00000040, /* PM6_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 6 },
    { 1, 0x00000080, /* PM7_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 7 },
    { 1, 0x00000100, /* PM8_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 8 },
    { 1, 0x00000200, /* PM9_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 9 },
    { 1, 0x00000400, /* PM10_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 10 },
    { 1, 0x00000800, /* PM11_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 11 },
    { 1, 0x00001000, /* PM12_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 12 },
    { 1, 0x00002000, /* PM13_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 13 },
    { 1, 0x00004000, /* PM14_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 14 },
    { 1, 0x00008000, /* PM15_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 15 },
    { 1, 0x00010000, /* PM16_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 16 },
    { 1, 0x00020000, /* PM17_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 17 },
    { 1, 0x00040000, /* PM18_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 18 },
    { 1, 0x00080000, /* PM19_INTR */
      SOC_BLK_CLPORT, 0, CLPORT_INTR_ENABLEr, CLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_clp_ser_info, 19 },
    { 1, 0x00100000, /* PM20_INTR Mgmt Port */
      SOC_BLK_XLPORT, 0, XLPORT_INTR_ENABLEr, XLPORT_INTR_STATUSr, INVALIDf,
      _soc_mv2_pm_xlp_ser_info, 0 },
    { 0 } /* table terminator */
};

static _soc_generic_ser_info_t _soc_mv2_tcam_ser_info[] =
{
...
STATIC soc_error_t
_soc_mv2_ser_tcam_wrapper_enable(int unit, int enable)
{
    return soc_td3_ser_tcam_wrapper_enable(unit, enable);
}

STATIC int
_soc_mv2_ser_enable_info(int unit, int block_info_idx, int inst, int port,
                               soc_reg_t group_reg, uint64 *group_rval,
                               _soc_mv2_ser_info_t *info_list,
...
STATIC int
_soc_mv2_ser_block_enable(int unit, int enable, int type,
...
int
soc_mv2_ser_enable_all(int unit, int enable)
{
    uint8                           rbi;
    uint32                          cmic_bit;
    uint32                          cmic_rval0;
    ...
    uint64                          rval64;
    const _soc_mv2_ser_route_block_t *rb;
    ...
    soc_td3_ip_pipe_fifo_bmask[unit][0] = _SOC_MV2_IPIPE0_IP_INTR;

    SOC_IF_ERROR_RETURN(_soc_mv2_ser_block_enable(unit, enable,
    ...
    SOC_IF_ERROR_RETURN(_soc_mv2_ser_block_enable(unit, enable,
        ...
        (void*) &_soc_bcm56770_a0_ip_bus_ser_info));

    SOC_IF_ERROR_RETURN(_soc_mv2_ser_block_enable(unit, enable,
        _SOC_SER_TYPE_BUS, INVALIDr,
        (void*) &_soc_bcm56770_a0_ep_bus_ser_info));

    SOC_IF_ERROR_RETURN(_soc_mv2_ser_block_enable(unit, enable,
        _SOC_SER_TYPE_BUF, INVALIDr,
        (void*) &_soc_bcm56770_a0_ip_buffer_ser_info));

    SOC_IF_ERROR_RETURN(_soc_mv2_ser_block_enable(unit, enable,
        _SOC_SER_TYPE_BUF, INVALIDr,
        (void*) &_soc_bcm56770_a0_ep_buffer_ser_info));

    /* Loop through each place-and-route block entry to enable legacy
       style SER stuff */
    for (rbi = 0; ; rbi++) {
        rb = &_soc_mv2_ser_route_blocks[rbi];
        ...
        if (rb->info != NULL) {
            SOC_IF_ERROR_RETURN(soc_reg_get(unit, rb->enable_reg,
                                            port, 0, &rval64));
            rv = _soc_mv2_ser_enable_info(unit, block_info_idx, rb->id, port,
    ...
    if (enable) {
        ...
        (void)_soc_mv2_ser_tcam_wrapper_enable(unit, TRUE);
    } else {
        /* MMU disables */
        /* check trident2.c - may have to add some similar code here */
        ...
        (void)soc_ser_tcam_scan_engine_enable(unit, FALSE);
        (void)_soc_mv2_ser_tcam_wrapper_enable(unit, FALSE);
    }
    return SOC_E_NONE;
}

STATIC int
_soc_mv2_ser_process(int unit, int block_info_idx, int inst, int pipe,
                     int port, soc_reg_t group_reg, uint64 group_rval,
                     const _soc_mv2_ser_info_t *info_list,
                     soc_block_t blocktype,
                     char *prefix_str)
{
...
STATIC int
soc_mv2_ser_process_fifo(int unit, soc_block_t blk, int pipe,
...
STATIC int
_soc_mv2_ser_process_all(int unit, int reg_type, int bit)
{
    uint8      rbi;
    int        port;
    uint32     cmic_bit;
    ...
    LOG_VERBOSE(BSL_LS_SOC_SER,
             (BSL_META_U(unit,
                         "unit %d, _soc_mv2_ser_process_all called: reg_type %d, bit %d \n"),
              unit, reg_type, bit));
    ...
    for (rbi = 0; ; rbi++) {
        ...
        if ((rb->blocktype == SOC_BLK_IPIPE || rb->blocktype == SOC_BLK_EPIPE)
             && (rb->cmic_bit != _SOC_MV2_IPIPE0_CEV_INTR)
             && (rb->cmic_bit != _SOC_MV2_IPIPE0_IDB_INTR)
             && (rb->cmic_bit != _SOC_MV2_IPIPE0_ISW4_INTR)) {
            /* New fifo style processing */
            (void)soc_mv2_ser_process_fifo(unit, rb->blocktype, rb->pipe,
                                           prefix_str, 0);
            stat->ser_err_fifo++;
            processed_an_intr = 1;
        } else {
            ...
            processed_an_intr = 1;
            SOC_IF_ERROR_RETURN
                (_soc_mv2_ser_process(unit, block_info_idx, rb->id,
...
void
soc_mv2_ser_error(void *unit_vp, void *d1, void *d2, void *d3,
                       void *d4)
{
    int unit = PTR_TO_INT(unit_vp);

    (void)_soc_mv2_ser_process_all(unit, PTR_TO_INT(d3), PTR_TO_INT(d4));
...
int
soc_mv2_mem_ser_control(int unit, soc_mem_t mem, int copyno, int enable)
{
    if (enable) {
    ...
    if (enable) {
        ...
        SOC_IF_ERROR_RETURN(soc_mv2_ser_enable_all(unit, FALSE));
    }
...
soc_mv2_ser_register(int unit)
{
    ...
    if (!soc_feature(unit, soc_feature_tcam_scan_engine)) {
        ...
        soc_mem_scan_ser_list_register(unit, TRUE, _soc_mv2_tcam_ser_info);
    }
#endif

    memset(&_mv2_ser_functions, 0, sizeof(soc_ser_functions_t));
    _mv2_ser_functions._soc_ser_parity_error_cmicx_intr_f = &soc_mv2_ser_error;
    soc_ser_function_register(unit, &_mv2_ser_functions);
...
int
soc_mv2_ser_lp_mem_info_get(int unit, soc_mem_t mem, int index,
                            soc_mem_t *hash_mem, int *hash_index)
{
    int bank_index, uft_index, uat_index, lp_index = 0, bank;
    int rv = SOC_E_NONE;

    switch(mem) {
        case L2_ENTRY_LPm:
            hash_mem[0] = L2Xm;
            if (index < SOC_MV2_NUM_ENTRIES_L2_LP_BANK * SOC_MV2_NUM_BANKS_L2) {
                ...
                /* index in uft space */
                uft_index = index - (SOC_MV2_NUM_ENTRIES_L2_LP_BANK * SOC_MV2_NUM_BANKS_L2);
                bank = (uft_index / SOC_MV2_NUM_ENTRIES_UFT_LP_BANK);
                bank_index = uft_index % SOC_MV2_NUM_ENTRIES_UFT_LP_BANK;
            ...
            break;
        case L3_ENTRY_LPm:
            if (index < SOC_MV2_NUM_ENTRIES_L3_LP_BANK * SOC_MV2_NUM_BANKS_L3) {
                /* dedicated L3 entries(1W, 2W, 4W)  */
                bank = index / SOC_MV2_NUM_ENTRIES_L3_LP_BANK;
                bank_index = index % SOC_MV2_NUM_ENTRIES_L3_LP_BANK;
                ...
                /* index in uft space */
                uft_index = index - (SOC_MV2_NUM_ENTRIES_L3_LP_BANK * SOC_MV2_NUM_BANKS_L3);
                bank = (uft_index / SOC_MV2_NUM_ENTRIES_UFT_LP_BANK);
                bank_index = uft_index % SOC_MV2_NUM_ENTRIES_UFT_LP_BANK;
                ...
                if (bank_index >= 0 && bank_index < 8192) {
                    /* 1W view - 8K entries per bank */
                    hash_mem[0] = L3_ENTRY_SINGLEm;
                    lp_index = bank_index + (8192 * bank) + 4096;
                } else if (bank_index >= 8192 && bank_index < 12288) {
                    /* 2W view - 4K entries per bank */
                    hash_mem[0] = L3_ENTRY_DOUBLEm;
                    lp_index = (bank_index - 8192) + (4096 * bank) + 2048;
                } else if (bank_index >= 12288 && bank_index < 14336) {
                    /* 4W view - 2K entries per bank */
                    hash_mem[0] = L3_ENTRY_QUADm;
                    lp_index = (bank_index - 12288) + (2048 * bank) + 1024;
                }
            }
            hash_index[0] = lp_index * 4;
            break;
        case EXACT_MATCH_LPm:
            /* UFT mem (1W, 2W, 4W)  */
            bank = index / SOC_MV2_NUM_ENTRIES_UFT_LP_BANK;
            bank_index = index % SOC_MV2_NUM_ENTRIES_UFT_LP_BANK;
        ...
        case VLAN_XLATE_2_LPm:
            if (index < SOC_MV2_NUM_ENTRIES_UAT_16K_LP_BANK * SOC_MV2_NUM_BANKS_UAT_16K) {
                /* IUAT mem(1W, 2W) - 16K banks */
                bank = index / SOC_MV2_NUM_ENTRIES_UAT_16K_LP_BANK;
                bank_index = index % SOC_MV2_NUM_ENTRIES_UAT_16K_LP_BANK;
                ...
                /* IUAT mem(1W, 2W) - 8K banks */

                /* index in 8K IUAT space */
                uat_index = index - (SOC_MV2_NUM_ENTRIES_UAT_16K_LP_BANK * SOC_MV2_NUM_BANKS_UAT_16K);
                bank = (uat_index / SOC_MV2_NUM_ENTRIES_UAT_8K_LP_BANK);
                bank_index = uat_index % SOC_MV2_NUM_ENTRIES_UAT_8K_LP_BANK;
                ...
                if (bank_index >= 0 && bank_index < 2048) {
                    ...
                    lp_index = bank_index + (2048 * bank) + 16384;
                } else if (bank_index >= 2048 && bank_index < 3072) {
                    /* 2W view - 1K entries per bank */
                    switch (mem) {
                        case MPLS_ENTRY_LPm: hash_mem[0] = MPLS_ENTRYm; break;
                    ...
                    lp_index = (bank_index - 2048) + (1024 * bank) + 8192;
                }
            }
            hash_index[0] = lp_index * 4;
            break;
        ...
        case EGR_VLAN_XLATE_2_LPm:
            /* UAT mem (1W, 2W) */
            bank = index / SOC_MV2_NUM_ENTRIES_UAT_8K_LP_BANK;
            bank_index = index % SOC_MV2_NUM_ENTRIES_UAT_8K_LP_BANK;
...
STATIC soc_error_t
_soc_mv2_ser_parity_control_reg_set(int unit, ser_test_data_t *test_data, int enable)
{
    return soc_td3_ser_parity_control_reg_set(unit, test_data, enable);
}

STATIC soc_error_t
_soc_mv2_ser_error_injection_support(int unit, soc_mem_t mem, int pipe_target)
{
   return soc_td3_ser_error_injection_support(unit, mem, pipe_target);
}

STATIC soc_error_t
_ser_mv2_ser_correction_info_get(int unit, ser_correction_info_t *corr_info)
{
 ...
 */
STATIC soc_error_t
soc_mv2_ser_inject_error(int unit, uint32 flags, soc_mem_t mem, int pipe_target,
                        int block, int index)
{
 ...
 */
STATIC soc_error_t
soc_mv2_ser_test_mem(int unit, soc_mem_t mem, _soc_ser_test_t test_type,
                    int cmd)
{
...
STATIC void
soc_mv2_ser_parity_control_check_all(int unit)
{
 ...
 */
STATIC soc_error_t
soc_mv2_ser_test(int unit, _soc_ser_test_t test_type)
{
    soc_mv2_ser_parity_control_check_all(unit);
    return soc_td3_ser_test(unit, test_type);
}

static soc_ser_test_functions_t _soc_mv2_ser_test_fun;

void
soc_mv2_ser_test_register(int unit)
{
    /*Initialize chip-specific functions for SER testing*/
    memset(&_soc_mv2_ser_test_fun, 0, sizeof(soc_ser_test_functions_t));
    _soc_mv2_ser_test_fun.inject_error_f = &soc_mv2_ser_inject_error;
    _soc_mv2_ser_test_fun.test_mem = &soc_mv2_ser_test_mem;
    _soc_mv2_ser_test_fun.test = &soc_mv2_ser_test;
    _soc_mv2_ser_test_fun.parity_control = &_soc_mv2_ser_parity_control_reg_set;
    _soc_mv2_ser_test_fun.injection_support = &_soc_mv2_ser_error_injection_support;
    _soc_mv2_ser_test_fun.correction_info_get = &_ser_mv2_ser_correction_info_get;
    soc_ser_test_functions_register(unit, &_soc_mv2_ser_test_fun);
}
