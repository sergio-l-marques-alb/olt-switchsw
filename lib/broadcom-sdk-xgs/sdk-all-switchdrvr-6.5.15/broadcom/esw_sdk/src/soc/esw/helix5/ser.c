...
typedef struct _soc_hx5_ser_mmu_intr_info_s {
    soc_reg_t   int_statf;
    int         mmu_base_index;
    int         ser_info_index;
} _soc_hx5_ser_mmu_intr_info_t;
...
typedef struct _soc_hx5_tcam_wrapper_info_s {
    soc_mem_t   mem;
    soc_reg_t   enable_reg;
    soc_field_t enable_field;
    soc_field_t parity_field; /* used to sw inject test */
} _soc_hx5_tcam_wrapper_info_t;

typedef _soc_td3_ser_reg_t _soc_hx5_ser_reg_t;

typedef _soc_td3_ser_info_t _soc_hx5_ser_info_t;

typedef struct _soc_hx5_tmp_ser_info_s {
    soc_reg_t           enable_reg;
    soc_field_t         enable_field;
    uint32              value;
} _soc_hx5_tmp_ser_info_t;

typedef struct _soc_hx5_hash_table_ser_info_s {
    soc_mem_t       mem;
    soc_field_t     enable_field;
} _soc_hx5_hash_table_ser_info_t;
...
_soc_hx5_ser_route_block_t  _soc_hx5_ser_route_blocks[] = {
    ...
    { 1, 0x00000400, /* PM_IPROC_INTR */
      SOC_BLK_XLPORT, 0, XLPORT_INTR_ENABLEr, XLPORT_INTR_STATUSr, INVALIDf,
      _soc_hx5_pm_xlp_ser_info, 7 },
#endif
    { 0 } /* table terminator */
};

static _soc_generic_ser_info_t _soc_hx5_tcam_ser_info[] =
{
