...
soc_error_t
soc_maverick2_idb_buf_reset(int unit, soc_port_t port, int reset)
{
    soc_reg_t reg, reg1;
    int port_block_base, phy_port, lane;
    int pipe, obm, obm_usage_count = ~0, ca_empty = 0;
    uint32 rval;
    uint64 rval1, rval2;
    soc_info_t *si = &SOC_INFO(unit);
    ...
    static const soc_reg_t idb_obm_ca_status_regs[] = {
        ...
        IDB_OBM16_CA_HW_STATUSr, IDB_OBM17_CA_HW_STATUSr,
        IDB_OBM18_CA_HW_STATUSr, IDB_OBM19_CA_HW_STATUSr
    };
    static const soc_reg_t obm_ctrl_regs[] = {
        IDB_OBM0_CONTROLr, IDB_OBM1_CONTROLr,
        IDB_OBM2_CONTROLr, IDB_OBM3_CONTROLr,
 ...
 *      NONE
 */
void soc_mv2_subport_init(int unit)
{
