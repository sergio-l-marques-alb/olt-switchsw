...
#if (defined(BCM_PETRA_SUPPORT) || defined(BCM_88750_SUPPORT)) && (defined(LINUX) || defined(UNIX)) && (defined(__DUNE_GTO_BCM_CPU__) || defined(__DUNE_WRX_BCM_CPU__) || defined(__DUNE_SLK_BCM_CPU__))
