...
{   
    ...
    {HBM16_DWORD0_WRITE_MAX_VDL_DATAr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},
    {HBM16_DWORD0_WRITE_MAX_VDL_DATAr   , HBM16_UI_SHIFTf                       , HBMC_SHMOO_OTP_VER_1                      ,   NULL},    
    ...
    {HBM16_DWORD0_READ_MAX_VDL_DQS_Pr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},
    {HBM16_DWORD0_READ_MAX_VDL_DQS_Nr   , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD0_READ_MAX_VDL_DQS_N__FIELDS_ALL"},   
    ...
    {HBM16_DWORD0_LANE_REMAPr           , HBM16_SEL0f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD0_LANE_REMAPr           , HBM16_SEL1f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD0_LANE_REMAPr           , HBM16_SEL2f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD0_LANE_REMAPr           , HBM16_SEL3f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},           
    {HBM16_DWORD0_LATENCY_SHIFTERr      , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD0_LATENCY_SHIFTER__FIELDS_ALL"},  
    {HBM16_DWORD0_DAC_CONFIGr           , HBM16_DAC_DATAf                       , HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1 ,   "DWORD0_DAC_CONFIG__DAC_DATA"}, 
    ...
    {HBM16_DWORD1_WRITE_MAX_VDL_DATAr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},
    {HBM16_DWORD1_WRITE_MAX_VDL_DATAr   , HBM16_UI_SHIFTf                       , HBMC_SHMOO_OTP_VER_1                      ,   NULL},    
    ...
    {HBM16_DWORD1_READ_MAX_VDL_DQS_Pr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},    
    {HBM16_DWORD1_READ_MAX_VDL_DQS_Nr   , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD1_READ_MAX_VDL_DQS_N__FIELDS_ALL"},   
    ...
    {HBM16_DWORD1_LANE_REMAPr           , HBM16_SEL0f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD1_LANE_REMAPr           , HBM16_SEL1f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD1_LANE_REMAPr           , HBM16_SEL2f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD1_LANE_REMAPr           , HBM16_SEL3f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},               
    {HBM16_DWORD1_LATENCY_SHIFTERr      , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD1_LATENCY_SHIFTER__FIELDS_ALL"},  
    {HBM16_DWORD1_DAC_CONFIGr           , HBM16_DAC_DATAf                       , HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1 ,   "DWORD1_DAC_CONFIG__DAC_DATA"}, 
    ...
    {HBM16_DWORD2_WRITE_MAX_VDL_DATAr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},
    {HBM16_DWORD2_WRITE_MAX_VDL_DATAr   , HBM16_UI_SHIFTf                       , HBMC_SHMOO_OTP_VER_1                      ,   NULL},        
    ...
    {HBM16_DWORD2_READ_MAX_VDL_DQS_Pr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},    
    {HBM16_DWORD2_READ_MAX_VDL_DQS_Nr   , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD2_READ_MAX_VDL_DQS_N__FIELDS_ALL"},   
    ...
    {HBM16_DWORD2_LANE_REMAPr           , HBM16_SEL0f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD2_LANE_REMAPr           , HBM16_SEL1f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD2_LANE_REMAPr           , HBM16_SEL2f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD2_LANE_REMAPr           , HBM16_SEL3f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},               
    {HBM16_DWORD2_LATENCY_SHIFTERr      , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD2_LATENCY_SHIFTER__FIELDS_ALL"},  
    {HBM16_DWORD2_DAC_CONFIGr           , HBM16_DAC_DATAf                       , HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1 ,   "DWORD2_DAC_CONFIG__DAC_DATA"}, 
    ...
    {HBM16_DWORD3_WRITE_MAX_VDL_DATAr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},
    {HBM16_DWORD3_WRITE_MAX_VDL_DATAr   , HBM16_UI_SHIFTf                       , HBMC_SHMOO_OTP_VER_1                      ,   NULL},            
    ...
    {HBM16_DWORD3_READ_MAX_VDL_DQS_Pr   , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},        
    {HBM16_DWORD3_READ_MAX_VDL_DQS_Nr   , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD3_READ_MAX_VDL_DQS_N__FIELDS_ALL"},   
    ...
    {HBM16_DWORD3_LANE_REMAPr           , HBM16_SEL0f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD3_LANE_REMAPr           , HBM16_SEL1f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD3_LANE_REMAPr           , HBM16_SEL2f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},       
    {HBM16_DWORD3_LANE_REMAPr           , HBM16_SEL3f                           , HBMC_SHMOO_OTP_VER_1                      ,   NULL},                   
    {HBM16_DWORD3_LATENCY_SHIFTERr      , HBMC_SHMOO_FIELDS_ALL                 , HBMC_SHMOO_LEVEL_2                        ,   "DWORD3_LATENCY_SHIFTER__FIELDS_ALL"},  
    {HBM16_DWORD3_DAC_CONFIGr           , HBM16_DAC_DATAf                       , HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1 ,   "DWORD3_DAC_CONFIG__DAC_DATA"}, 
    ...
    {HBM16_AWORD_WRITE_MAX_VDL_ADDRr    , HBM16_MAX_VDL_STEPf                   , HBMC_SHMOO_OTP_VER_1                      ,   NULL},        
    {HBM16_AWORD_WRITE_MAX_VDL_ADDRr    , HBM16_UI_SHIFTf                       , HBMC_SHMOO_OTP_VER_1                      ,   NULL},            
    ...
    {HBM16_AWORD_LANE_REMAPr            , HBM16_SEL_CAf                         , HBMC_SHMOO_OTP_VER_1                      ,   NULL},
    {HBM16_AWORD_LANE_REMAPr            , HBM16_SEL_RAf                         , HBMC_SHMOO_OTP_VER_1                      ,   NULL},    
    {HBM16_AWORD_DAC_CONFIGr            , HBM16_DAC_DATAf                       , HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1 ,   "AWORD_DAC_CONFIG__DAC_DATA"},
...
{   
    { HBM16_MIDSTACK_DAC_CONFIGr        , HBM16_DAC_DATAf                       , HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1 , "MIDSTACK_DAC_CONFIG__DAC_DATA"},
...
/** check for dwords alignment,
 * return 0 if dwords are aligned
 * return 1 if dwords are NOT aligned */
STATIC int
hbm16_phy_channel_dwords_alignment_check(int unit, int hbm_ndx, int channel)
{
    ...
    /** run bist */
    SOC_IF_ERROR_RETURN(_shmoo_hbm16_hbmc_bist_conf_set(unit, HBMC_SHMOO_CFG_FLAG_FORCE_BIST_CONFIGURATION, hbm_ndx, channel, &biPtr));

    /** read bist error array just to clear the errors */
    SOC_IF_ERROR_RETURN(_shmoo_hbm16_hbmc_bist_err_cnt(unit, 0, hbm_ndx, channel, &be));
...
int
_hbm16_phy_channel_reset(int unit, int hbm_ndx, int channel)
{
    uint32 data;
    int dword_index;
    ...
    if (hbm16_phy_channel_dwords_alignment_check(unit, hbm_ndx, channel))
    {
        for(dword_index = 0; dword_index < SHMOO_HBM16_WORDS_PER_CHANNEL; ++dword_index)
        {
            ...
            if (hbm16_phy_channel_dwords_alignment_check(unit, hbm_ndx, channel) == 0)
            {
                break;
            }
        }
...
_shmoo_hbm16_rd_en_fish(int unit, int hbm_ndx, int channel, hbm16_shmoo_container_t *scPtr)
{
    ...
    {        
        ...
        _hbm16_phy_channel_reset(unit, hbm_ndx, channel);
...
_shmoo_hbm16_addr_ctrl_extended(int unit, int hbm_ndx, int channel, hbm16_shmoo_container_t *scPtr)
{
    ...
    for(x = 0; x < (*scPtr).sizeX; x++)
    {
        ...
        if((*scPtr).result2D[0][x] || (*scPtr).result2D[1][x] || (*scPtr).result2D[2][x] || (*scPtr).result2D[3][x])
        {
            ...
            SOC_IF_ERROR_RETURN(_hbm16_phy_channel_reset(unit, hbm_ndx, channel));
...
_shmoo_hbm16_restore(int unit, int hbm_ndx, int channel, hbmc_shmoo_config_param_t *config_param)
{
    ...
    for (metadata_ndx = 0; metadata_ndx < HBMC_SHMOO_CHANNEL_METADATA_SIZE; metadata_ndx++)
    {
        ...
        if (channel_config_param_metadata[metadata_ndx].level == HBMC_SHMOO_LEVEL_0 && 
            config_param->channel_data[channel][metadata_ndx].valid == FALSE)
        {
            LOG_ERROR(BSL_LS_SOC_DDR,(BSL_META_U(unit,
                                  "field %s is not valid - unable to restore phy tune parameters,"
                                  " try running full tune instead and save tune parameters again\n"), channel_config_param_metadata[metadata_ndx].name ));
            return SOC_E_FAIL;
        }
    ...
    {
        /** if the parameter level is mandatory and cannot be restore ==> error */
        if (channel_config_param_metadata[metadata_ndx].level == HBMC_SHMOO_LEVEL_0 && config_param->midstack_data[metadata_ndx].valid == FALSE)
        {
            LOG_ERROR(BSL_LS_SOC_DDR,(BSL_META_U(unit,
