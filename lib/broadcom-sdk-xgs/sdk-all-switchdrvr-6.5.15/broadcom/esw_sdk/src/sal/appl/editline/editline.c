...
char		*(*rl_complete)() = rl_complete_file;
int		(*rl_list_possib)() = rl_list_possib_file;
...
#if defined(INCLUDE_AUTOCOMPLETE)
      if (c == TAB) {
          Input = (STRING)autocomplete_print((char*)Line, (char*)Prompt);
          TTYflush();
          continue;
      }
#endif
...
int _editline_editline_not_empty;
