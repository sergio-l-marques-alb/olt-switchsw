...
/**
* \brief
* Field App Wa for J1 mode learning
* \param [in] unit        - Device id
* \return
*   int - Error Type
* \remark
...
*   * None
*/
shr_error_e appl_dnx_field_j1_learning_wa_init(
    int unit);
...
/**
 * \brief
 *   This functions determines if the app should be skipped, J1 learning App
 * \param [in] unit - The unit number.
 * \param [out] dynamic_flags - indicate if the application should be skipped or not
 * \return
 *   Error code (as per 'shr_error_e').
 ...
 *   shr_error_e
 */
shr_error_e appl_dnx_field_wa_j1_learning_cb(
    int unit,
    int *dynamic_flags);
/*
 * }
