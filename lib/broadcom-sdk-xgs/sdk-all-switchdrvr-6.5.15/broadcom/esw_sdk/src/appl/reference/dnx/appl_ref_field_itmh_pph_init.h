...
#define TIME_STAMP_QUAL_OFFSET        (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + 0)
...
#define FWD_STR_QUAL_OFFSET           (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 95)
#define TRAP_CODE_FHEI_QUAL_OFFSET    (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + HEADER_4_SIZE + 27)
#define FWD_QUALIFIER_QUAL_OFFSET     (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + HEADER_4_SIZE)
/** Offset of OAM_MEP_OFFSET Qualifier for ASE_OAM Header[43:43] (1b) */
#define OAM_MEP_QUAL_OFFSET           (HEADER_0_SIZE + HEADER_1_SIZE + 4)
/** Offset of OAM_SUB_TYPE Qualifier for ASE_OAM Header[47:44] (4b) */
#define OAM_SUB_TYPE_QUAL_OFFSET      (HEADER_0_SIZE + HEADER_1_SIZE + 0)
/** Offset of OAM_OFFSET Qualifier for ASE_OAM Header[8:1] (8b) */
#define OAM_OFFSET_QUAL_OFFSET        (HEADER_0_SIZE + HEADER_1_SIZE + 39)
...
#define PARSING_OFFSET_QUAL_OFFSET    (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 83)
/** Offset of PARSING_TYPE Qualifier for PPH Header[94:90] (5b) */
#define PARSING_TYPE_QUAL_OFFSET      (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 90)
/** Offset of FHEI_SIZE Qualifier for PPH Header[78:79] (2b) */
#define FHEI_SIZE_QUAL_OFFSET         (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 78)
/** Offset of FHEI_Type Qualifier for FHEI  Header[36:39] (4b) */
#define FHEI_TYPE_QUAL_OFFSET         (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + HEADER_4_SIZE + 36)
/** IPMF3: Offset of :
...
#define TTL_SET_QUAL_OFFSET      (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 69)
/** Offset of IN_LIF_PROFILE Qualifier for PPH Header[20:13] (8b) */
#define IN_LIF_PROFILE_QUAL_OFFSET      (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 13)
/** Offset of FWD_ADDITIONAL_INFO Qualifier for PPH Header[9:6] (4b) */
#define FWD_ADDITIONAL_INFO_QUAL_OFFSET      (HEADER_0_SIZE + HEADER_1_SIZE + HEADER_2_SIZE + HEADER_3_SIZE + 6)
...
/**
 * IPMF3:
 * Length of PARSING_START_OFFSET Action (8b):
 *     - 7 bits taken from PARSING_START_OFFSET field in PPH header[83:89]
 *     - 1 bit for valid, which was being taken from the action resolution after IPMF2,
 *       it was stored in the container.
 */
