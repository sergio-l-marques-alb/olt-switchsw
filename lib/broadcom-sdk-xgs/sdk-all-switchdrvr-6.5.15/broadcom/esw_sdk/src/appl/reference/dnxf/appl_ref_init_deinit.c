...
static const appl_dnxc_init_step_t appl_dnxf_ref_apps_steps[] = {
   /*STEP_ID                         NAME              SUFFIX          INIT_FUNC                        DEINIT_FUNC                    FLAGS_CB  STEP_FLAGS             TIME_THRESH   SUB_LIST*/
    {APPL_DNXF_STEP_DEVICE_PARAMS,   "Device Params",  "params",       appl_dnxf_device_params_init,    NULL,                          NULL,     DEF_PROP_EN,           0,            NULL},
	{APPL_DNXF_LINKS_ISOLATE,        "Links Isolate",  "links_isolate",appl_dnxf_links_isolate_init,    appl_dnxf_links_isolate_deinit,NULL,     DEF_PROP_EN | WB_SKIP, 0,            NULL},
    {APPL_DNXF_STEP_STK_INIT,        "STK Init",       "stk_init",     appl_dnxf_ref_stk_init,          appl_dnxf_ref_stk_deinit,      NULL,     DEF_PROP_EN | WB_SKIP, 0,            NULL},
    {APPL_DNXF_STEP_INTR_INIT,       "Interrupt Init", "intr_init",    appl_dnxc_interrupt_init,        appl_dnxc_interrupt_deinit,    NULL,     DEF_PROP_EN,           0,            NULL},
    {APPL_DNXF_STEP_INIT_DONE,       "Init Done",      "init_done",    appl_dnxf_init_done,             appl_dnxf_deinit_start,        NULL,     0,                     0,            NULL},
    {APPL_DNXF_STEP_LAST_STEP,        NULL,             NULL,          NULL,                            NULL,                          NULL,     0,                     0,            NULL} /* Last step must be all NULLs*/
};
...
static const appl_dnxc_init_step_t appl_dnxf_init_steps[] = {
    /*STEP_ID                   NAME        SUFFIX      INIT_FUNC             DEINIT_FUNC              FLAGS_CB STEP_FLAGS   TIME_THRESH   SUB_LIST*/
    {APPL_DNXF_STEP_SDK,         "SDK",      "",         appl_dnxc_sdk_init,   appl_dnxc_sdk_deinit,   NULL,    STANDALONE,  0,            NULL},
    {APPL_DNXF_STEP_APPS,        "Appls",    "",         NULL,                 NULL,                   NULL,    DEF_PROP_EN, 0,            appl_dnxf_ref_apps_steps},
    {APPL_DNXF_STEP_LAST_STEP,   NULL,       NULL,       NULL,                 NULL,                   NULL,    0,           0,            NULL} /* Last step must be all NULLs*/
};
