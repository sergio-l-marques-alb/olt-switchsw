...
#define J1_ITMH_PPH_NOF_IPMF2_QUALIFIERS        13
...
#define J1_ITMH_PPH_PARSING_OFFSET_QUAL_OFFSET    (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE  + 8)
/** Offset of PARSING_TYPE Qualifier for PPH Header[94:90] (5b) */
#define J1_ITMH_PPH_PARSING_TYPE_QUAL_OFFSET      (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + 4)
/** Offset of FHEI_SIZE Qualifier for PPH Header[2:3] (2b) */
#define J1_ITMH_PPH_FHEI_SIZE_QUAL_OFFSET         (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE  + 2)
/** Offset of FHEI_Type Qualifier for PPH  Header[4:7] (4b) */
#define J1_ITMH_PPH_FHEI_TYPE_QUAL_OFFSET         (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + 4)

/** Offset of OAM_MEP_OFFSET Qualifier for OTSH Header[42:42] (1b) */
#define J1_ITMH_PPH_OAM_MEP_QUAL_OFFSET           (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + 5)
/** Offset of OAM_SUB_TYPE Qualifier for OTSH Header[45:43] (3b) */
#define J1_ITMH_PPH_OAM_SUB_TYPE_QUAL_OFFSET      (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + 2)
/** Offset of OAM_OFFSET Qualifier for OTSH Header[7:0] (8b) */
#define J1_ITMH_PPH_OAM_OFFSET_QUAL_OFFSET        (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + 40)
...
#define J1_ITMH_PPH_TTL_SET_QUAL_OFFSET      (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + J1_ITMH_PPH_HEADER_3_SIZE + 16)
/** Offset of IN_LIF_PROFILE Qualifier FHEI(IP_routed).In-LIF profile [1:0] (2b) */
#define J1_ITMH_PPH_IN_LIF_PROFILE_QUAL_OFFSET      (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + J1_ITMH_PPH_HEADER_3_SIZE )
/** Offset of FWD_ADDITIONAL_INFO Qualifier for PPH Header[4:7] (4b) */
#define J1_ITMH_PPH_FWD_ADDITIONAL_INFO_QUAL_OFFSET      (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE  + 4)
/** Offset of In-LIF Qualifier for PPH Header[38:55] (18b) */
#define J1_ITMH_PPH_IN_LIF_QUAL_OFFSET         (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + 38)
/** Offset of FWD_Domain_INFO Qualifier taken from PPH Header.VSI/In-RIF [22:37] (16b) */
#define J1_ITMH_PPH_FWD_DOMAIN_QUAL_OFFSET     (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + 22)
/** Offset of Network Oos Qualifier from FHEI(IP_routed).In-DSCP [15:8] (8b) */
#define J1_ITMH_PPH_NETWORK_QOS_QUAL_OFFSET  (J1_ITMH_PPH_HEADER_0_SIZE + J1_ITMH_PPH_HEADER_1_SIZE + J1_ITMH_PPH_HEADER_2_SIZE + J1_ITMH_PPH_HEADER_3_SIZE + 8)
/**
 *  Offset of FWD_STRENGTH Qualifier (4b).
 */
#define J1_ITMH_PPH_FWD_STR_QUAL_OFFSET   0
...
#define J1_ITMH_PPH_FWD_STR_QUAL_LENGTH   4
...
#define J1_ITMH_PPH_FWD_STR_ACTION_LENGTH           13
...
#define J1_ITMH_PPH_OAM_SUB_TYPE_QUAL_LENGTH      4
...
/** Length of FWD_LAYER_INDEX Qualifier Constant value of 0x3 (3b) */
