...
static sh_sand_cmd_t sh_dnx_ingress_rate_cmds[] = {
    ...
    {"IPT",       sh_dnx_ingress_ipt_rate_cmd,    NULL,       sh_dnx_ingress_ipt_rate_options,    &sh_dnx_ingress_ipt_rate_man},
    {"SQM",       sh_dnx_ingress_sqm_rate_cmd,    NULL,       sh_dnx_ingress_sqm_rate_options,    &sh_dnx_ingress_sqm_rate_man},
    {"IRE",       sh_dnx_ingress_ire_rate_cmd,    NULL,       sh_dnx_ingress_ire_rate_options,    &sh_dnx_ingress_ire_rate_man},
    {NULL}
};
...
static sh_sand_cmd_t sh_dnx_egress_rate_cmds[] = {
    /*keyword,     action,                        command,    options,                             man                    */
    {"RQP",        sh_dnx_egr_rqp_rate_cmd,        NULL,       sh_dnx_egr_rqp_rate_options,        &sh_dnx_egr_rqp_rate_man},
