...
/**
 * \brief - print the rollback journal
 */
static shr_error_e
sh_dnx_err_rec_rollback_jrnl_print(
    int unit,
    args_t * args,
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_rollback_journal_print_journals(unit));
...
/**
 * \brief - print the comparison journal
 */
static shr_error_e
sh_dnx_err_rec_comparison_jrnl_print(
    int unit,
    args_t * args,
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_state_comparison_print_journals(unit));
...
static sh_sand_man_t sh_dnx_err_rec_rollback_jrnl_print_man = {
    .brief = "Print the contents of the current rollback journal transaction",
    .full = "Print the contents of the current rollback journal transaction."
};
...
static sh_sand_man_t sh_dnx_err_rec_comparison_jrnl_print_man = {
    .brief = "Print the contents of the current comparison journal transaction",
    .full = "Print the contents of the current comparison journal transaction."
};
...
sh_sand_cmd_t sh_dnx_err_rec_transaction_cmds[] = {
   ...
   **********************************************************************************************************/
	...
	{"PRinT", sh_dnx_err_rec_rollback_jrnl_print, NULL, NULL, &sh_dnx_err_rec_rollback_jrnl_print_man},
#ifdef DNX_ERR_RECOVERY_REGRESSION_TESTING
...
sh_sand_cmd_t sh_dnx_err_rec_comparison_cmds[] = {
   ...
   **********************************************************************************************************/
    ...
    {"PRinT", sh_dnx_err_rec_comparison_jrnl_print, NULL, NULL, &sh_dnx_err_rec_comparison_jrnl_print_man},
    {NULL}
};
