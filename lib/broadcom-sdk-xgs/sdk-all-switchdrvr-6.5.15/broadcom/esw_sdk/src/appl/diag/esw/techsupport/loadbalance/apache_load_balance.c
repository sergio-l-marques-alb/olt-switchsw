...
/* "loadbalance" feature's diag command list only for apache */
char * techsupport_loadbalance_apache_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "loadbalance" feature's software dump command list only for apache */
char * techsupport_loadbalance_apache_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "loadbalance" feature for apache chipset. */
static soc_mem_t techsupport_loadbalance_apache_memory_table_list[] = {
 ...
 * "loadbalance" feature for apache chipset. */
techsupport_reg_t techsupport_loadbalance_apache_reg_list[] = {
 ...
 * "loadbalance" feature for apache chipset. */
techsupport_data_t techsupport_loadbalance_apache_data = {
    techsupport_loadbalance_diag_cmdlist,
    techsupport_loadbalance_apache_reg_list,
    techsupport_loadbalance_apache_memory_table_list,
    techsupport_loadbalance_apache_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_loadbalance_sw_dump_cmdlist,
    techsupport_loadbalance_apache_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
