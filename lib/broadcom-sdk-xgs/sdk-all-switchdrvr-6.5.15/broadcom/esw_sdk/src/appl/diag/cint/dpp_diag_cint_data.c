...
#if defined(INCLUDE_INTR) && (defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT))
...
#endif /* defined(INCLUDE_INTR) && (defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT)) */
...
#if defined(INCLUDE_I2C) && (defined (__DUNE_GTO_BCM_CPU__) || defined(__DUNE_WRX_BCM_CPU__) || defined(__DUNE_SLK_BCM_CPU__))
...
#endif /* defined(INCLUDE_LIB_CINT) && defined(BCM_SAND_SUPPORT) */
