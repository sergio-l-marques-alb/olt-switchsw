    ...
    sh_sand_control_t * sand_control)
{
    ...
    char port_type_str[DNX_DIAG_NIF_STATUS_MAX_STRING_LEN];
    ...
    BCM_PBMP_ITER(nif_pbmp, port)
    {
        ...
        {
            sal_sprintf(port_type_str, "ETH %s", if_fmt_speed(speed_str, port_resource.speed));
        }
        else
        {
            sal_sprintf(port_type_str, "ILKN %s", if_fmt_speed(speed_str, port_resource.speed));
        }
        /*
         * Get NIF phys
         */
        ...
        lane_speed = DNX_ALGO_PORT_TYPE_IS_NIF_ILKN(unit, port_type, 1) ? speed : (speed / phy_count);
        ...
        SHR_IF_ERR_EXIT(soc_dnx_nif_synce_enable_get(unit, core, &synce_enable));
        ...
        ref_clk_index = dnx_data_pll.general.nif_pll_cfg_get(unit, pll_index)->out_freq;
        ...
        if (ref_clk_index == DNX_SERDES_REF_CLOCK_BYPASS)
        {
             ...
             */
            ref_clk_index = dnx_data_pll.general.nif_pll_cfg_get(unit, pll_index)->in_freq;
        }
        /*
         * Additional Comments
         */
