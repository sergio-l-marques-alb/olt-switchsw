...
sh_sand_legacy_cmd_t sh_dnx_legacy_commands[] = {
    ...
    },
    {
        ...
        .message = "Command shell name has changed to 'ikleap vis'",
        .substitute = "ikleap vis"
    },
    {
        .command = "DIAG pp kbp last",
        .message = "Command shell name has changed to 'ikleap vis phydb=kbp'",
        .substitute = "ikleap vis phydb=kbp"
    },
    {
    ...
    },
    {
        ...
        .message = "Command shell name has changed to 'ikleap vis stage=vtt<1..5>'"
    },
    {
    ...
    },
    {
        ...
        .message = "Command shell name has changed to 'ekleap vis'",
        .substitute = "ekleap vis"
    },
    {
        .command = "DIAG pp fli",
        .message = "Command shell name has changed to 'ikleap vis stage=fwd<1,2>'"
    },
    {
        .command = "DIAG pp flpm",
        .message = "Command shell name has changed to 'ikleap vis phydb=kaps<1,2>'"
    },
    {
    ...
    },
    {
        ...
        .message = "Command shell name has changed to 'ikleap vis phydb=lem'"
    },
    {
