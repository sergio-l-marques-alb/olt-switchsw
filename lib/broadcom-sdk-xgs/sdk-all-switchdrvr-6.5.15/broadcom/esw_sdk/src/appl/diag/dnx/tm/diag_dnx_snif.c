    ...
    sh_sand_control_t * sand_control)
{
    ...
    uint32 ext_stat_data_valid_ow[2] = { 0, 0 };
    uint32 ext_stat_data_valid[2] = { 0, 0 };
    uint32 ext_stat_data_opcode_ow[2] = { 0, 0 };
    uint32 ext_stat_data_type_id_0[4] = { 0, 0, 0, 0 };
    uint32 ext_stat_data_type_id_1[4] = { 0, 0, 0, 0 };
    uint32 ext_stat_data_ow[2] = { 0, 0 };
    uint32 ext_stat_data_0[4] = { 0, 0, 0, 0 };
    uint32 ext_stat_data_1[4] = { 0, 0, 0, 0 };
    uint32 int_stat_obj_valid_ow[2] = { 0, 0 };
    uint32 int_stat_obj_valid[2] = { 0, 0 };
    uint32 int_stat_obj_id_ow[2] = { 0, 0 };
    uint32 int_stat_obj_id[2] = { 0, 0 };
    uint32 int_stat_obj_type_ow[2] = { 0, 0 };
    uint32 int_stat_obj_type[2] = { 0, 0 };
    uint32 int_stat_obj_meta_data_ow[2] = { 0, 0 };
    uint32 int_stat_obj_meta_data[2] = { 0, 0 };
    uint32 int_stat_obj_is_meter_ow[2] = { 0, 0 };
    uint32 int_stat_obj_is_meter[2] = { 0, 0 };
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_SNIF_EGRESS_SNOOP_STRENGTH_TABLE, &entry_handle_id_snoop_str));
    ...
    for (type = type_start; type <= type_end; type++)
    {
        ...
        for (cmd_id = cmd_id_start; cmd_id <= cmd_id_end; cmd_id++)
        {
            ...
            if (is_allocated == TRUE)
            {
                ...
                PRT_COLUMN_ADD_FLEX(PRT_FLEX_BINARY, "CORE 0");
                PRT_COLUMN_ADD_FLEX(PRT_FLEX_BINARY, "CORE 1");
                ...
                if ((ingr_egr == DNX_SNIF_INGRESS) || (ingr_egr == DNX_SNIF_COUNT))
                {
                    ...
                    dbal_value_field32_request(unit, entry_handle_id_header, DBAL_FIELD_DSP_EXT_DESTINATION_STAMP_EN,
                                               INST_SINGLE, &dsp_ext_destination_stamp_en);
                    ...
                    dbal_value_field32_request(unit, entry_handle_id_header, DBAL_FIELD_SNIFF_APPEND_MODE, INST_SINGLE,
                                               &sniff_append_mode);
                     ...
                     */
                    dbal_entry_key_field32_set(unit, entry_handle_id_new_header, DBAL_FIELD_SNIF_COMMAND_ID, cmd_id);
                    ...
                    dbal_value_field32_request(unit, entry_handle_id_new_header, DBAL_FIELD_HEADER_SIZE, INST_SINGLE,
                                               &header_size);
                    dbal_value_field32_request(unit, entry_handle_id_new_header, DBAL_FIELD_FTMH_STACKING_EXT_OFFSET,
                                               INST_SINGLE, &ftmh_stacking_ext_offset);
                    dbal_value_field32_request(unit, entry_handle_id_new_header, DBAL_FIELD_APPLICATION_EXT_STAMP_EN,
                                               INST_SINGLE, &application_ext_stamp_en);
                    ...
                    dbal_value_field32_request(unit, entry_handle_id_new_header, DBAL_FIELD_APP_EXT_TYPE, INST_SINGLE,
                                               &app_ext_type);
                    ...
                    && (cmd_id < (int) dnx_data_snif.egress.mirror_snoop_nof_profiles_get(unit)))
                {
                    ...
                    if (type == DNX_SNIF_TYPE_SNOOP)
                    {
                         ...
                         */
                        dbal_entry_key_field32_set(unit, entry_handle_id_snoop_str, DBAL_FIELD_SNIF_COMMAND_ID, cmd_id);
                        dbal_value_field32_request(unit, entry_handle_id_snoop_str, DBAL_FIELD_STRENGTH, INST_SINGLE,
                                                   &snoop_strength);
                ...
                /*
                 * Get the information for core 0
                 */
                dbal_entry_key_field32_set(unit, entry_handle_id_count, DBAL_FIELD_CORE_ID, 0);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_VALID_OW, INST_SINGLE,
                                           &ext_stat_data_valid_ow[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_VALID, INST_SINGLE,
                                           &ext_stat_data_valid[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_OPCODE_OW, INST_SINGLE,
                                           &ext_stat_data_opcode_ow[0]);
                ...
                for (i = 0; i < dnx_data_stif.report.stat_id_max_count_get(unit); i++)
                {
                    ...
                    dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_OPCODE, i,
                                               &ext_stat_data_type_id_0[i]);
                }
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_VALID_OW, INST_SINGLE,
                                           &int_stat_obj_valid_ow[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_VALID, INST_SINGLE,
                                           &int_stat_obj_valid[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_ID_OW, INST_SINGLE,
                                           &int_stat_obj_id_ow[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_ID, INST_SINGLE,
                                           &int_stat_obj_id[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_TYPE_OW, INST_SINGLE,
                                           &int_stat_obj_type_ow[0]);
                ...
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_META_DATA_OW,
                                           INST_SINGLE, &int_stat_obj_meta_data_ow[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_META_DATA, INST_SINGLE,
                                           &int_stat_obj_meta_data[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_IS_METER_OW,
                                           INST_SINGLE, &int_stat_obj_is_meter_ow[0]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_IS_METER, INST_SINGLE,
                                           &int_stat_obj_is_meter[0]);
                SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id_count, DBAL_COMMIT));
                /*
                 * Get the information for core 1
                 */
                dbal_entry_key_field32_set(unit, entry_handle_id_count, DBAL_FIELD_CORE_ID, 1);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_VALID_OW, INST_SINGLE,
                                           &ext_stat_data_valid_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_VALID, INST_SINGLE,
                                           &ext_stat_data_valid[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_OPCODE_OW, INST_SINGLE,
                                           &ext_stat_data_opcode_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_OW, INST_SINGLE,
                                           &ext_stat_data_ow[1]);
                for (i = 0; i < dnx_data_stif.report.stat_id_max_count_get(unit); i++)
                {
                    dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_ID, i,
                                               &ext_stat_data_1[i]);
                    dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_EXT_STAT_DATA_OPCODE, i,
                                               &ext_stat_data_type_id_1[i]);
                }
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_VALID_OW, INST_SINGLE,
                                           &int_stat_obj_valid_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_VALID, INST_SINGLE,
                                           &int_stat_obj_valid[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_ID_OW, INST_SINGLE,
                                           &int_stat_obj_id_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_ID, INST_SINGLE,
                                           &int_stat_obj_id[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_TYPE_OW, INST_SINGLE,
                                           &int_stat_obj_type_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_TYPE, INST_SINGLE,
                                           &int_stat_obj_type[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_META_DATA_OW,
                                           INST_SINGLE, &int_stat_obj_meta_data_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_META_DATA, INST_SINGLE,
                                           &int_stat_obj_meta_data[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_IS_METER_OW,
                                           INST_SINGLE, &int_stat_obj_is_meter_ow[1]);
                dbal_value_field32_request(unit, entry_handle_id_count, DBAL_FIELD_INT_STAT_OBJ_IS_METER, INST_SINGLE,
                                           &int_stat_obj_is_meter[1]);
                SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id_count, DBAL_COMMIT));
                ...
                PRT_CELL_SET("0x%x", ext_stat_data_valid_ow[0]);
                PRT_CELL_SET("0x%x", ext_stat_data_valid_ow[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "External Stat Data Valid");
                PRT_CELL_SET("0x%x", ext_stat_data_valid[0]);
                PRT_CELL_SET("0x%x", ext_stat_data_valid[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "External Stat Data Opcode Overwrite");
                PRT_CELL_SET("0x%x", ext_stat_data_opcode_ow[0]);
                PRT_CELL_SET("0x%x", ext_stat_data_opcode_ow[1]);

                for (i = 0; i < dnx_data_stif.report.stat_id_max_count_get(unit); i++)
                {
                    PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                    PRT_CELL_SET("%s%d", "External Stat Data Opcode type id for stat id ", i);
                    PRT_CELL_SET("0x%x", ext_stat_data_type_id_0[i]);
                    PRT_CELL_SET("0x%x", ext_stat_data_type_id_1[i]);
                }

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "External Stat Data Overwrite");
                PRT_CELL_SET("0x%x", ext_stat_data_ow[0]);
                PRT_CELL_SET("0x%x", ext_stat_data_ow[1]);

                for (i = 0; i < dnx_data_stif.report.stat_id_max_count_get(unit); i++)
                {
                    PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                    PRT_CELL_SET("%s%d", "External Stat Data ID ", i);
                    PRT_CELL_SET("0x%x", ext_stat_data_0[i]);
                    PRT_CELL_SET("0x%x", ext_stat_data_1[i]);
                }

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Valid Overwrite");
                PRT_CELL_SET("0x%x", int_stat_obj_valid_ow[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_valid_ow[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Valid");
                PRT_CELL_SET("0x%x", int_stat_obj_valid[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_valid[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object ID Overwrite");
                PRT_CELL_SET("0x%x", int_stat_obj_id_ow[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_id_ow[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object ID");
                PRT_CELL_SET("0x%x", int_stat_obj_id[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_id[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Type Overwrite");
                PRT_CELL_SET("0x%x", int_stat_obj_type_ow[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_type_ow[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Type");
                PRT_CELL_SET("0x%x", int_stat_obj_type[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_type[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Meta Data Overwrite");
                PRT_CELL_SET("0x%x", int_stat_obj_meta_data_ow[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_meta_data_ow[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Meta Data");
                PRT_CELL_SET("0x%x", int_stat_obj_meta_data[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_meta_data[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Is Meter Overwrite");
                PRT_CELL_SET("0x%x", int_stat_obj_is_meter_ow[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_is_meter_ow[1]);

                PRT_ROW_ADD(PRT_ROW_SEP_NONE);
                PRT_CELL_SET("%s", "Internal Stat Object Is Meter");
                PRT_CELL_SET("0x%x", int_stat_obj_is_meter[0]);
                PRT_CELL_SET("0x%x", int_stat_obj_is_meter[1]);
