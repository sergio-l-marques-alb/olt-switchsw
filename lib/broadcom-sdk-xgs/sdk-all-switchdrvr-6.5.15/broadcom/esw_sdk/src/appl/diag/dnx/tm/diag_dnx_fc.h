...
#error "This file is for use by DNX (JR2) family only!"
 ...
 /**
 * \brief - Enumerator of the FC types for Flow Control diagnostic command
 */
typedef enum
{
/** Type is invalid */
