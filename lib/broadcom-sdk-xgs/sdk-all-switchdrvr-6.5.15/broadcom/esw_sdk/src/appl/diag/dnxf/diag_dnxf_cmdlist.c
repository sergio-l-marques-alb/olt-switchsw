...
#include <appl/diag/dnxf/swstate/auto_generated/diagnostic/swstate_commandline.h>
#endif
...
/** diag is for backward compatibility commands only, no new functionality should use it */
    ...
    {"soc",         cmd_dnxc_soc,         NULL,                  NULL,                     &sh_dnxc_soc_man},
#ifdef BCM_WARM_BOOT_SUPPORT
    {"warmboot",    NULL,                 sh_dnxc_warmboot_cmds, NULL,                     &sh_dnxc_warmboot_man},
#endif
#ifdef INCLUDE_CTEST
