    ...
    void *user_data)
{
    ...
    if ((l2addr->flags & BCM_L2_DISCARD_DST) == 0)
    {
        ...
        /** Get the field_info of sub_field_id - it is needed in order to print the type of destination */
        SHR_IF_ERR_EXIT(dbal_fields_field_types_info_get(unit, sub_field_id, &field_info));
