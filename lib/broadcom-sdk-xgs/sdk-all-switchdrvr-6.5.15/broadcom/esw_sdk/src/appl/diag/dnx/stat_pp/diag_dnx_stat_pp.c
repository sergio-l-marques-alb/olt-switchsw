    ...
    prt_control_t * prt_ctr)
{
    ...
    int in_pp_port;
    rhlist_t *flist = NULL;
    signal_output_t *pp_port = NULL;

    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    if ((flist = utilex_rhlist_create("Statistics information", sizeof(signal_output_t), 0)) == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_RESOURCE, "Could not allocate parsed information list to parse the required buffer.\n");
    }

    /** Get pp port */
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "IPMF1", "FER", "In_Port", &flist));
    pp_port = utilex_rhlist_entry_get_last(flist);
    in_pp_port = pp_port->value[0];
    ...
    prt_control_t * prt_ctr)
{
    ...
    int trap_id;
    rhlist_t *flist = NULL;
    signal_output_t *trap_code = NULL;
    ...
    /** Get trap ID */
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "IPMF3", "LBP", "cpu_trap_code", &flist));
    trap_code = utilex_rhlist_entry_get_last(flist);
    trap_id = trap_code->value[0];
    ...
    prt_control_t * prt_ctr)
{
    ...
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "FER", "IPMF3", "Fer_Stats_Obj", &flist));
    stats_ids = utilex_rhlist_entry_get_last(flist);
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "FER", "IPMF3", "Fer_Stats_Obj_Atr", &flist));
    stats_profiles = utilex_rhlist_entry_get_last(flist);
    for (i = 0; i <= 2; i++)
    {
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "FWD2", "IPMF1", "Stats_Objects", &flist));
    stats_ids = utilex_rhlist_entry_get_last(flist);
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "FWD2", "IPMF1", "Stats_Objects_Cmd", &flist));
    stats_profiles = utilex_rhlist_entry_get_last(flist);
 ...
 * \param [in] flist - list control structure
 * \param [in] prt_ctr - print control pointer
 * \return
 *      Standard error handling
 */
    ...
    prt_control_t * prt_ctr)
{
    ...
    PRT_ROW_ADD(PRT_ROW_SEP_NONE);
    /**Stat id i*/
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "TRAP", "CRPS", object_id, &flist));
    stats = utilex_rhlist_entry_get_last(flist);
    PRT_CELL_SET("%s", stats->print_value);
    /**valid indication*/
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_find(unit, core, 0, NULL, "TRAP", "CRPS", object_valid, &flist));
    stats = utilex_rhlist_entry_get_last(flist);
    PRT_CELL_SET("%s", stats->print_value);
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis_gen_stat
                    (unit, core, "Internal_Stats_Obj_0_Valid", "Internal_Stats_Obj_0_ID", flist, prt_ctr));
    SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis_gen_stat
                    (unit, core, "Internal_Stats_Obj_1_Valid", "Internal_Stats_Obj_1_ID", flist, prt_ctr));
    SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis_gen_stat
                    (unit, core, "Internal_Stats_Obj_2_Valid", "Internal_Stats_Obj_2_ID", flist, prt_ctr));
    SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis_gen_stat
                    (unit, core, "Internal_Stats_Obj_3_Valid", "Internal_Stats_Obj_3_ID", flist, prt_ctr));
    SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis_gen_stat
                    (unit, core, "Internal_Stats_Obj_4_Valid", "Internal_Stats_Obj_4_ID", flist, prt_ctr));
    SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis_gen_stat
                    (unit, core, "Internal_Stats_Obj_5_Valid", "Internal_Stats_Obj_5_ID", flist, prt_ctr));
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_ERR_EXIT(_SHR_E_NONE, "stat_pp vis command in not supported on adapter mode\n");
#endif
    ...
    if (!ISEMPTY(block))
    {
        ...
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "invalid input %s, valid inputs: stat_pp vis block=irpp/itpp/erpp/etpp/all\n",
                         block);
        }
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    {
        LOG_CLI((BSL_META("\nDump all stages (currently supported: IRPP, ETPP\n")));
        SHR_IF_ERR_EXIT(dnx_stat_pp_block_dump(unit, "IRPP", DBAL_TABLE_STAT_PP_IRPP_PROFILE_INFO, sand_control));
        SHR_IF_ERR_EXIT(dnx_stat_pp_block_dump(unit, "ETPP", DBAL_TABLE_STAT_PP_ETPP_PROFILE_INFO, sand_control));
    }
...
static sh_sand_option_t dnx_stat_pp_options[] = {
...
/* INDENT-OFF */
/**
 * \brief DNX stat_pp diagnostic pack
 * List of the supported commands, pointer to command function and command usage function.
 */
sh_sand_cmd_t sh_dnx_stat_pp_cmds[] = {
   /***********************************************************************************************
    * CMD_NAME *     CMD_ACTION         * Next       *        Options         *     MAN           *
    *          *                        * Level      *                        *                   *
    *          *                        * CMD        *                        *                   *
    ***********************************************************************************************/
    {"dump", stat_pp_dump_cmd, NULL, dnx_stat_pp_options, &sh_dnx_stat_pp_man},
    {"visibility", stat_pp_vis_cmd, NULL, dnx_stat_pp_options, &sh_dnx_stat_pp_man},
    {NULL}
};
/* INDENT-ON */
