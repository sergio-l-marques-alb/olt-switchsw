...
static sh_sand_man_t Field_ace_format_list_man = {
    ...
    .examples = "format=1-10",
};
static sh_sand_option_t Field_ace_format_list_options[] = {
    {DIAG_DNX_FIELD_OPTION_FORMAT,  SAL_FIELD_TYPE_UINT32, "Lowest-highest ACE Format ID to get its info",       "MIN-MAX",       (void *)Field_ace_format_id_enum_table},
    {NULL}
};
...
static sh_sand_option_t Field_ace_format_info_options[] = {
    {DIAG_DNX_FIELD_OPTION_FORMAT,          SAL_FIELD_TYPE_UINT32, "ACE Format ID to get its info",           NULL   ,(void *)Field_ace_format_id_enum_table},
    {NULL}
};
...
static sh_sand_man_t Field_ace_entry_info_man = {
    ...
    .full = "'ACE Entry info' displays info about a specific ACE Entry and its action info.\r\n"
            "If no 'format' (1-63) and 'entry' (0-0x3fffff) are specified then an error will occur.\r\n"
            "For example 'format=1 entry=0'.",
    .synopsis = "[format=<Should be between 1-63>]"
                "[entry=<Should be between 0-0x3fffff>]",
    .examples = "format=1 entry=0",
};
static sh_sand_option_t Field_ace_entry_info_options[] = {
    {DIAG_DNX_FIELD_OPTION_FORMAT,          SAL_FIELD_TYPE_UINT32, "ACE Format ID to get its entry info",        NULL   ,(void *)Field_ace_format_id_enum_table},
    {DIAG_DNX_FIELD_OPTION_ENTRY,           SAL_FIELD_TYPE_UINT32, "ACE Entry ID to get its info",                        NULL   ,(void *)Field_ace_entry_id_enum_table},
    {NULL}
};
    ...
    sh_sand_control_t * sand_control)
{
    ...
    sal_strncpy(total_fes_mask_string, "--------", sizeof(total_fes_mask_string) - 1);
    sal_strncpy(not_present_fes_mask_string, "--------", sizeof(not_present_fes_mask_string) - 1);
    ...
    for (format_id = format_id_lower; format_id <= format_id_upper; format_id++)
    {
        ...
        sal_strncpy(fes_mask_string, "--------", sizeof(fes_mask_string) - 1);
    ...
    sh_sand_control_t * sand_control)
{
    ...
    {
        LOG_CLI_EX("\r\n" "An error occurred while retrieving entry %d (0x%08X) from ACE format %d.%s\r\n",
                   entry_handle, entry_handle, ace_format_id, EMPTY);
        SHR_EXIT();
    }
