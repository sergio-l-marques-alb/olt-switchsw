...
shr_error_e sh_dnx_swstate_reflector_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    if (is_init) {
        SHR_IF_ERR_EXIT(reflector_sw_db_info_dump(unit));
...
shr_error_e sh_dnx_swstate_reflector_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~");
...
shr_error_e sh_dnx_swstate_reflector_uc_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_reflector_uc_encap_id_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC~ENCAP_ID~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_reflector_uc_is_allocated_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC~IS_ALLOCATED~");
    dnx_sw_state_size_print(size);
