...
#include <appl/diag/dnx/swstate/auto_generated/diagnostic/dnx_ipq_commandline.h>
...
shr_error_e sh_dnx_swstate_dnx_ipq_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    if (is_init) {
        SHR_IF_ERR_EXIT(dnx_ipq_db_dump(unit));
...
shr_error_e sh_dnx_swstate_dnx_ipq_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_db_info[unit], dnx_ipq_db_layout_str, DNX_IPQ_DB_INFO_NOF_ENTRIES, "DNX_IPQ_DB~");
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_db_base_queues_dump(unit, base_queues_idx_0));
...
sh_sand_man_t dnx_swstate_dnx_ipq_base_queues_dump_man = {
    ...
    "dnx_ipq_db base_queues dump [,base_queues_idx_0=<int>]\n",
    "dnx_ipq_db base_queues dump base_queues_idx_0=0",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_db_info[unit], dnx_ipq_db_layout_str, DNX_IPQ_DB_INFO_NOF_ENTRIES, "DNX_IPQ_DB~BASE_QUEUES~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_num_cos_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_db_base_queues_num_cos_dump(unit, base_queues_idx_0));
...
sh_sand_man_t dnx_swstate_dnx_ipq_base_queues_num_cos_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_ipq_db base_queues num_cos dump [,base_queues_idx_0=<int>]\n",
    "dnx_ipq_db base_queues num_cos dump base_queues_idx_0=0",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_num_cos_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_db_info[unit], dnx_ipq_db_layout_str, DNX_IPQ_DB_INFO_NOF_ENTRIES, "DNX_IPQ_DB~BASE_QUEUES~NUM_COS~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_sys_port_ref_counter_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_db_base_queues_sys_port_ref_counter_dump(unit, base_queues_idx_0));
...
sh_sand_man_t dnx_swstate_dnx_ipq_base_queues_sys_port_ref_counter_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_ipq_db base_queues sys_port_ref_counter dump [,base_queues_idx_0=<int>]\n",
    "dnx_ipq_db base_queues sys_port_ref_counter dump base_queues_idx_0=0",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_base_queues_sys_port_ref_counter_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_db_info[unit], dnx_ipq_db_layout_str, DNX_IPQ_DB_INFO_NOF_ENTRIES, "DNX_IPQ_DB~BASE_QUEUES~SYS_PORT_REF_COUNTER~");
    dnx_sw_state_size_print(size);
