/*
 * $Id: trident2_vlan.c Broadcom SDK $
 * $Copyright: (c) 2018 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    trident2_vlan.c
...
/* "vlan" feature's diag command list only for Trident2 */
char * techsupport_vlan_trident2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "vlan" feature's software dump command list only for Trident2 */
char * techsupport_vlan_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "vlan" feature for Trident2 chipset. */
static soc_mem_t techsupport_vlan_trident2_memory_table_list[] = {
 ...
 * "vlan" feature for Trident2 chipset. */
techsupport_reg_t techsupport_vlan_trident2_reg_list[] = {
 ...
 * "vlan" feature for Trident2 chipset. */
techsupport_data_t techsupport_vlan_trident2_data = {
    techsupport_vlan_diag_cmdlist,
    techsupport_vlan_trident2_reg_list,
    techsupport_vlan_trident2_memory_table_list,
    techsupport_vlan_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_vlan_sw_dump_cmdlist,
    techsupport_vlan_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
