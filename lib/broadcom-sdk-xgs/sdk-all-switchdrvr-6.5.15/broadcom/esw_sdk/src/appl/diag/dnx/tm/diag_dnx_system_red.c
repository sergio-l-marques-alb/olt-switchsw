    ...
    sh_sand_control_t * sand_control)
{
    ...
    bcm_cosq_threshold_type_t thr_types[] =
        { bcmCosqThresholdPacketDescriptorBuffers, bcmCosqThresholdOcbDbuffs, bcmCosqThresholdBufferDescriptorBuffers };
    char *thr_names[] = { "PDBs", "OCB Buffers", "DRAM BDBs" };
    ...
    for (thr = DNX_SYSTEM_RED_RESOURCE_PDBS; thr < DNX_SYSTEM_RED_RESOURCE_NOF; ++thr)
    {
