...
#include <appl/diag/dnx/swstate/auto_generated/diagnostic/algo_ecgm_commandline.h>
...
shr_error_e sh_dnx_swstate_algo_ecgm_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    if (is_init) {
        SHR_IF_ERR_EXIT(algo_ecgm_db_dump(unit));
...
shr_error_e sh_dnx_swstate_algo_ecgm_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(algo_ecgm_db_info[unit], algo_ecgm_db_layout_str, ALGO_ECGM_DB_INFO_NOF_ENTRIES, "ALGO_ECGM_DB~");
...
sh_sand_man_t dnx_swstate_algo_ecgm_ecgm_port_profile_dump_man = {
    ...
    "algo_ecgm_db ecgm_port_profile dump []\n",
    "algo_ecgm_db ecgm_port_profile dump",
};
...
shr_error_e sh_dnx_swstate_algo_ecgm_ecgm_port_profile_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(algo_ecgm_db_info[unit], algo_ecgm_db_layout_str, ALGO_ECGM_DB_INFO_NOF_ENTRIES, "ALGO_ECGM_DB~ECGM_PORT_PROFILE~");
    dnx_sw_state_size_print(size);
...
sh_sand_man_t dnx_swstate_algo_ecgm_ecgm_interface_profile_dump_man = {
    "swstate dump",
    "print the variable value",
    "algo_ecgm_db ecgm_interface_profile dump []\n",
    "algo_ecgm_db ecgm_interface_profile dump",
};
...
shr_error_e sh_dnx_swstate_algo_ecgm_ecgm_interface_profile_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(algo_ecgm_db_info[unit], algo_ecgm_db_layout_str, ALGO_ECGM_DB_INFO_NOF_ENTRIES, "ALGO_ECGM_DB~ECGM_INTERFACE_PROFILE~");
    dnx_sw_state_size_print(size);
