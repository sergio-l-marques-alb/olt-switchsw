...
#include <include/appl/diag/sand/diag_sand_utils.h>
...
/** \brief FWD1 general data size, used to find the const values */
#define DIAG_DNX_KLEAP_FWD1_GENERAL_DATA_SIZE       2738

/** \brief FWD2 general data size, used to find the const values */
#define DIAG_DNX_KLEAP_FWD2_GENERAL_DATA_SIZE       3161
