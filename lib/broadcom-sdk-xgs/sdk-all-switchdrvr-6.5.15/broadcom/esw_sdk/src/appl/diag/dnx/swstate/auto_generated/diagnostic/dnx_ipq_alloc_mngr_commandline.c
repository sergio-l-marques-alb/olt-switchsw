...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    if (is_init) {
        SHR_IF_ERR_EXIT(dnx_ipq_alloc_mngr_db_dump(unit));
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~");
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_regions_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ipq_alloc_mngr_db_regions_dump(unit, regions_idx_0));
...
sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_regions_dump_man = {
    ...
    "dnx_ipq_alloc_mngr_db regions dump regions_idx_0=0",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_regions_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~REGIONS~");
    dnx_sw_state_size_print(size);
...
sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_regions_type_dump_man = {
    ...
    "dnx_ipq_alloc_mngr_db regions type dump regions_idx_0=0",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_regions_type_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~REGIONS~TYPE~");
    dnx_sw_state_size_print(size);
...
sh_sand_man_t dnx_swstate_dnx_ipq_alloc_mngr_regions_nof_allocated_queue_quartets_dump_man = {
    ...
    "dnx_ipq_alloc_mngr_db regions nof_allocated_queue_quartets dump regions_idx_0=0",
};
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~FMQ~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_enhance_scheduler_mode_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~FMQ~IS_ENHANCE_SCHEDULER_MODE~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_is_fmq_allocated_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~FMQ~IS_FMQ_ALLOCATED~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_fmq_max_multicast_queue_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~FMQ~MAX_MULTICAST_QUEUE~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_ipq_alloc_mngr_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~IPQ_ALLOC_MNGR~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_tc_voq_flow_map_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~TC_VOQ_FLOW_MAP~");
    dnx_sw_state_size_print(size);
...
shr_error_e sh_dnx_swstate_dnx_ipq_alloc_mngr_tc_sysport_map_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_ipq_alloc_mngr_db_info[unit], dnx_ipq_alloc_mngr_db_layout_str, DNX_IPQ_ALLOC_MNGR_DB_INFO_NOF_ENTRIES, "DNX_IPQ_ALLOC_MNGR_DB~TC_SYSPORT_MAP~");
    dnx_sw_state_size_print(size);
