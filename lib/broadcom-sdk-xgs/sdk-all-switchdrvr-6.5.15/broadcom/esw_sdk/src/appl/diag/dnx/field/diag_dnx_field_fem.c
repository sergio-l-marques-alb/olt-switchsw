...
static sh_sand_option_t Field_fem_info_by_fg_options[] = {
    {DIAG_DNX_FIELD_OPTION_GROUP,          SAL_FIELD_TYPE_UINT32, "Lowest-highest field group to get fem info for",           "MIN-MAX"   ,(void *)Field_group_enum_table},
    {DIAG_DNX_FIELD_OPTION_SEC_GROUP,      SAL_FIELD_TYPE_UINT32, "Lowest-highest secondary field group to get fem info for", "MIN-MAX"   ,(void *)Field_group_enum_table},
    ...
    {DIAG_DNX_FIELD_OPTION_ID,            SAL_FIELD_TYPE_UINT32, "Lowest-highest fem id to get info for",                    "MIN-MAX"   ,(void *)Field_fem_enum_table},
    {NULL}
};
...
static sh_sand_option_t Field_fem_info_by_context_options[] = {
    {DIAG_DNX_FIELD_OPTION_CONTEXT,    SAL_FIELD_TYPE_UINT32, "Lowest-highest context ID to get fem info for",  "CONTEXT_LOWEST-CONTEXT_HIGHEST", (void *)Field_context_enum_table_for_display},
...
static sh_sand_option_t Field_fem_info_conditions_options[] = {
    {DIAG_DNX_FIELD_OPTION_PROGRAM,SAL_FIELD_TYPE_UINT32, "Lowest-highest fem_program to get condition info for",  "FEM_PROGRAM_LOWEST-FEM_PROGRAM_HIGHEST", (void *)Field_fem_program_enum_table_for_display},
    {DIAG_DNX_FIELD_OPTION_VALID,      SAL_FIELD_TYPE_BOOL,   "If TRUE, display non-empty fem blocks only",            "Yes"},
    {DIAG_DNX_FIELD_OPTION_ID,        SAL_FIELD_TYPE_UINT32, "Lowest-highest fem id to get info for",                 "MIN-MAX"   ,(void *)Field_fem_enum_table},
    {NULL}
};
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_fem_is_any_fem_occupied_on_fg(unit, DNX_FIELD_GROUP_INVALID,
