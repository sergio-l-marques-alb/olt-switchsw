...
#define DIAG_CASCADE_IPMF3_QUAL_CONTAINER     (DNX_QUAL(DNX_FIELD_QUAL_CLASS_META, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_IPMF3_QUAL_GENERAL_DATA))
    ...
    dnx_field_presel_t * presel_id_p)
{
    ...
    p_data.qual_data[0].qual_type_dbal_field =
        (stage == DNX_FIELD_STAGE_IPMF2) ? DBAL_FIELD_STATE_TABLE_DATA : DBAL_FIELD_ACL_CONTEXT_PROFILE;
    ...
    bcm_field_qualify_t * bcm_qual_p)
{
     ...
     */
    fg_info_p->dnx_actions[0][0] = DIAG_CASCADE_IPMF2_ACTION_DP;
    ...
    dnx_field_group_info_t * fg_info_p)
{
     ...
     * other entries have been filled in in 'dnx_field_group_info_t_init' above.
     */
    fg_info_p->dnx_actions[0][0] = DIAG_CASCADE_IPMF3_ACTION_DP;
    ...
    dnx_field_group_info_t * fg_info_p)
{
     ...
     */
    fg_info_p->dnx_actions[0][0] = DIAG_CASCADE_IPMF1_ACTION_CONTAINER;
...
{
    dnx_field_presel_t presel_id_ipmf1 = 2, presel_id_ipmf3 = 2;
    dnx_field_presel_t presel_id_ipmf2 = 1;
