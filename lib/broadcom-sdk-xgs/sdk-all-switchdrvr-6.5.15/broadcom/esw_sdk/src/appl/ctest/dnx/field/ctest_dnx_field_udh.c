    ...
    sh_sand_control_t * sand_control)
{
    ...
    else if (test_type == 1)
    {
        ...
        attach_info.dnx_actions[0][1] = fg_info_in.dnx_actions[0][1];

        attach_info.action_info[0][0].priority = BCM_FIELD_ACTION_PRIORITY(0, 10);
        attach_info.action_info[0][1].priority = BCM_FIELD_ACTION_PRIORITY(0, 10);
        ...
        entry_info.payload_info.action_info[1].dnx_action = fg_info_in.dnx_actions[0][1];
