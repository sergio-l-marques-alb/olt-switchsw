    ...
    uint32 nof_mc_ids)
{
    ...
    for (mc_id_index = 0; mc_id_index < nof_mc_ids; ++mc_id_index)
    {
        ...
        bcm_multicast_destroy(unit, mc_id_index);
        rv = sh_process_command(unit, "debug bcmdnx multicast =");
        if (rv != _SHR_E_NONE)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL, "Fail - BCM Shell command failed!");
    ...
    uint32 nof_repl)
{
     ...
     */
    dnx_sand_os_qsort(repl_in, nof_repl, sizeof(bcm_multicast_replication_t), bcm_multicast_replication_t_compare);
    dnx_sand_os_qsort(repl_out, nof_repl, sizeof(bcm_multicast_replication_t), bcm_multicast_replication_t_compare);
    ...
    uint32 nof_mc_ids)
{
     ...
     */
    test_mc_ids_randomize(unit, mc_ids, nof_mc_ids);
    ...
    for (mc_id_index = 0; mc_id_index < nof_mc_ids; ++mc_id_index)
    {
         ...
         */
        SHR_IF_ERR_EXIT(bcm_multicast_create(unit, flags, &mc_ids[mc_id_index]));

        /*
         * Verify that the group is opened and empty
         */
        count = 0;
        SHR_IF_ERR_EXIT(bcm_multicast_get(unit, mc_ids[mc_id_index], flags, 1, &repl_out, &count));
        if (count != 0)
        {
    ...
    uint32 nof_mc_ids)
{
    ...
    for (mc_id_index = 0; mc_id_index < nof_mc_ids; ++mc_id_index)
    {
        ...
        /*
         * In order to randomly chose which API to test (set of get) we use randomly generated a boolean
         */
        ...
        if (set_or_add)
        {
            ...
            for (repl_index = 0; repl_index < nof_repl; repl_index += 3)
            {
                ...
                rv = bcm_multicast_add(unit, mc_ids[mc_id_index], flags, nof_repl_add, (repl_in + repl_index));
                if (rv != _SHR_E_NONE)
                {
                    break;
                }
        ...
        {
            rv = bcm_multicast_set(unit, mc_ids[mc_id_index], flags, nof_repl, repl_in);
        }
        ...
        if (rv == _SHR_E_NONE)
        {
             ...
             */
            count = 0;
            SHR_IF_ERR_EXIT(bcm_multicast_get(unit, mc_ids[mc_id_index], flags, nof_repl, repl_out, &count));
            /*
        ...
        else if (rv == _SHR_E_FULL)
        {
            ...
            if (nof_remaining != 0)
            {
                SHR_IF_ERR_EXIT(bcm_multicast_set(unit, mc_ids[mc_id_index], flags, nof_remaining, repl_in));
                /*
                 * Get group
                 */
                count = 0;
                SHR_IF_ERR_EXIT(bcm_multicast_get(unit, mc_ids[mc_id_index], flags, nof_remaining, repl_out, &count));
                /*
                 * Verify replication count
                 */
    ...
    uint32 nof_mc_ids)
{
    ...
    for (mc_id_index = 0; mc_id_index < nof_mc_ids; ++mc_id_index)
    {
         ...
         */
        SHR_IF_ERR_EXIT(bcm_multicast_delete
    ...
    uint32 nof_mc_ids)
{
    ...
    for (mc_id_index = 0; mc_id_index < nof_mc_ids; ++mc_id_index)
    {
         ...
         * Destroy the group
         */
        SHR_IF_ERR_EXIT(bcm_multicast_destroy(unit, mc_ids[mc_id_index]));
        ...
        rv = bcm_multicast_set(unit, mc_ids[mc_id_index], flags, 1, &repl_in);
    ...
    int is_ing)
{
    ...
    for (iter = 0; iter < 4; iter++)
    {
        ...
        SHR_IF_ERR_EXIT(test_mc_create(unit, flags, mc_ids, nof_mc_ids));
        SHR_IF_ERR_EXIT(test_mc_set_add(unit, flags, &gport, 1, nof_replications, mc_ids, nof_mc_ids));
        ...
        SHR_IF_ERR_EXIT(test_mc_delete_all(unit, flags, nof_replications, mc_ids, nof_mc_ids));
        SHR_IF_ERR_EXIT(test_mc_destroy(unit, flags, mc_ids, nof_mc_ids));
        LOG_CLI((BSL_META("Done. \n")));
        SHR_FREE(mc_ids);
        mc_ids = NULL;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcm_multicast_create(unit, (BCM_MULTICAST_WITH_ID | BCM_MULTICAST_EGRESS_GROUP), &grp_test_ll));
    ...
    for (iter_index = 0; iter_index < iter_size; iter_index++)
    {
        ...
        SHR_IF_ERR_EXIT(test_mc_create(unit, flags, mc_ids, nof_mc_ids));
        SHR_IF_ERR_EXIT(test_mc_set_add(unit, flags, gport, 6, nof_replications, mc_ids, nof_mc_ids));
        LOG_CLI((BSL_META("Done. \n")));
     ...
     * Destroy test groups
     */
    SHR_IF_ERR_EXIT(bcm_multicast_destroy(unit, grp_test_ll));
    SHR_IF_ERR_EXIT(bcm_multicast_destroy(unit, grp_test_bmp));
    ...
    int is_ing)
{
    ...
    if (test_ing == TRUE)
    {
        ...
        SHR_IF_ERR_EXIT(test_mc_create
                        (unit, (BCM_MULTICAST_WITH_ID | BCM_MULTICAST_INGRESS_GROUP), mc_ids, nof_mc_ids));
    ...
    if (test_egr == TRUE)
    {
        for (gport_index = 0; gport_index < nof_replications; gport_index++)
        {
            BCM_GPORT_LOCAL_SET(gport[gport_index], port[gport_index]);
        }
        ...
        SHR_IF_ERR_EXIT(test_mc_create(unit, (BCM_MULTICAST_WITH_ID | BCM_MULTICAST_EGRESS_GROUP), mc_ids, nof_mc_ids));
        ...
        SHR_IF_ERR_EXIT(test_mc_delete_all
                        (unit, (BCM_MULTICAST_WITH_ID | BCM_MULTICAST_EGRESS_GROUP), nof_replications, mc_ids,
                         nof_mc_ids));
        SHR_IF_ERR_EXIT(test_mc_destroy
                        (unit, (BCM_MULTICAST_WITH_ID | BCM_MULTICAST_EGRESS_GROUP), mc_ids, nof_mc_ids));
        LOG_CLI((BSL_META("Done. \n")));
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (sal_strcasecmp(test_type_name, "single") == 0)
    {
        ...
        SHR_IF_ERR_EXIT(sh_dnx_one_replication_per_group(unit, is_ing));
    }
    else if (sal_strcasecmp(test_type_name, "multiple") == 0)
    {
        ...
        SHR_IF_ERR_EXIT(sh_dnx_many_replications_per_group(unit));
    }
    else if (sal_strcasecmp(test_type_name, "full") == 0)
    {
        ...
        SHR_IF_ERR_EXIT(sh_dnx_full_table_delete(unit, is_ing));
    }
    else
    {
