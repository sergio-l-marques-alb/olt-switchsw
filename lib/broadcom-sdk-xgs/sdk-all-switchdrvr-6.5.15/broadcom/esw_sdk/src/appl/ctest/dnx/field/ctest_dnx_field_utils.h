...
typedef struct
{
    ...
    */
    ...
    /*
     *BCM  Actions for the Field Group - we are currently using only one set of actions.
     */
    bcm_field_action_t bcm_actions[DNX_FIELD_NUM_2MSB_COMBINATIONS][CTEST_DNX_FIELD_UTIL_TESTER_NUM_QUALS_ACTIONS];
    /*
     * BCM Action Values
     */
