...
static ctest_dnx_field_efes_action_info_t Ctest_dnx_field_efes_neg_descending_action_info_array[CTEST_DNX_FIELD_EFES_NEGATIVE_DESCENDING_NOF_ACTIONS] = {
    ...
    {"descending_act_3", 0, {PRIORITY_BY_NUM_PRIO, 0, 10, 2}, {0, bcmFieldActionPrioIntNew, 2, 1, 0x1, {0}}}
};

static ctest_dnx_field_efes_action_info_t Ctest_dnx_field_efes_neg_same_act_diff_prio_action_info_array[CTEST_DNX_FIELD_EFES_NEGATIVE_DESCENDING_NOF_ACTIONS] = {
...
static ctest_dnx_field_efes_fg_info_t Ctest_field_efes_negative_descending_fg_info_array[1] = {
/** Field group ID    |   Field group Name     |    Number of tested actions   |    Actions info        */
    {BCM_FIELD_ID_INVALID, "efes_neg_descend", CTEST_DNX_FIELD_EFES_NEGATIVE_DESCENDING_NOF_ACTIONS, Ctest_dnx_field_efes_neg_descending_action_info_array}
};
    ...
    )
{
    ...
    Ctest_field_efes_negative_descending_fg_info_array[0].fg_id = BCM_FIELD_ID_INVALID;
    ...
    ctest_dnx_field_efes_fg_info_t * efes_fg_info)
{
    ...
    if (efes_fg_info->fg_id == BCM_FIELD_ID_INVALID)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &(efes_fg_info->fg_id)));
 ...
 */
static shr_error_e
ctest_dnx_field_efes_negative_descending_actions(
    int unit,
    bcm_field_stage_t field_stage,
    ctest_dnx_field_efes_cs_info_t * efes_cs_info,
    ctest_dnx_field_efes_fg_info_t * efes_fg_info)
    ...
    ctest_dnx_field_efes_fg_info_t * efes_fg_info)
{
    ...
    if (rv == BCM_E_PARAM)
    {
        LOG_INFO_EX(BSL_LOG_MODULE, "NEGATIVE TEST CASE 7 was successful! \r\n %s%s%s%s", EMPTY, EMPTY, EMPTY, EMPTY);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_FAIL, "NEGATIVE TEST CASE 7 failed!\r\n");
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (stage_index = 0; stage_index < CTEST_DNX_FIELD_EFES_NOF_STAGES; stage_index++)
    {
        ...
        SHR_IF_ERR_EXIT(ctest_dnx_field_efes_negative_descending_actions(unit, field_stage,
                                                                         Ctest_dnx_field_efes_cs_info_array,
                                                                         Ctest_field_efes_negative_descending_fg_info_array));

        LOG_INFO_EX(BSL_LOG_MODULE, "\nNEGATIVE CASE 7: EFES \n %s%s%s%s", EMPTY, EMPTY, EMPTY, EMPTY);
