    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (test_i = 0; test_i < nof_tests; test_i++)
    {
        ...
        for (vpn = 0; vpn <= 33; vpn += 33)
        {
            ...
            tunnel_wo_id.flags2 |= (vpn ? 0 : BCM_MPLS_SWITCH2_CROSS_CONNECT);
            ...
            tunnel_w_id.flags2 |= (vpn ? 0 : BCM_MPLS_SWITCH2_CROSS_CONNECT);
            ...
            tunnel_switch_to_delete[1] = &tunnel_w_id;
            {
                ...
                tunnel_buffer.flags2 |= (vpn ? 0 : BCM_MPLS_SWITCH2_CROSS_CONNECT);
    ...
    sh_sand_control_t * sand_control)
{
    ...
    ac.match_vlan = 111;
    ac.egress_vlan = 222;
    ac.flags = BCM_VLAN_PORT_CROSS_CONNECT;
