...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg2_common_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
    ...
    {"ffc_algo_fg2_16", 0, 1, {0}}
};
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg3_common_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
    {"ffc_algo_fg3_1", 0, 1, {0}}, {"ffc_algo_fg3_2", 0, 1, {0}}, {"ffc_algo_fg3_3", 0, 1, {0}}, {"ffc_algo_fg3_4", 0, 1, {0}}, {"ffc_algo_fg3_5", 0, 1, {0}},
    {"ffc_algo_fg3_6", 0, 1, {0}}, {"ffc_algo_fg3_7", 0, 1, {0}}, {"ffc_algo_fg3_8", 0, 1, {0}}, {"ffc_algo_fg3_9", 0, 1, {0}}, {"ffc_algo_fg3_10", 0, 1, {0}},
    {"ffc_algo_fg3_11", 0, 1, {0}}, {"ffc_algo_fg3_12", 0, 1, {0}}, {"ffc_algo_fg3_13", 0, 1, {0}}, {"ffc_algo_fg3_14", 0, 1, {0}}, {"ffc_algo_fg3_15", 0, 1, {0}},
    {"ffc_algo_fg3_16", 0, 1, {0}}
};
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg1_header_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg2_header_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg3_header_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg1_layer_record_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
    {"ffc_algo_fg1_1", 0, 1, {0}}, {"ffc_algo_fg1_2", 0, 1, {1}}, {"ffc_algo_fg1_3", 0, 1, {2}}, {"ffc_algo_fg1_4", 0, 1, {3}}, {"ffc_algo_fg1_5", 0, 1, {4}},
    {"ffc_algo_fg1_6", 0, 1, {5}}, {"ffc_algo_fg1_7", 0, 1, {6}}, {"ffc_algo_fg1_8", 0, 1, {7}}, {"ffc_algo_fg1_9", 0, 1, {8}}, {"ffc_algo_fg1_10", 0, 1, {9}},
    {"ffc_algo_fg1_11", 0, 1, {10}}, {"ffc_algo_fg1_12", 0, 1, {11}}, {"ffc_algo_fg1_13", 0, 1, {12}}, {"ffc_algo_fg1_14", 0, 1, {13}}, {"ffc_algo_fg1_15", 0, 1, {14}},
    {"ffc_algo_fg1_16", 0, 1, {15}}
};
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_fg2_layer_record_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_cmp_hash_1_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_cmp_hash_2_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
...
static ctest_dnx_field_ffc_qual_info_t Ctest_dnx_field_ffc_cmp_hash_3_qual_info_array[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS] = {
 ...
 */
static ctest_dnx_field_ffc_fg_info_t Ctest_dnx_field_ffc_ipmf1_exhaustive_fg_info_array[CTEST_DNX_FIELD_FFC_IPMF1_EXHAUSTIVE_NOF_FGS] = {
/**    Field group ID    |   Field group Name   |  Number of tested qualifiers   |  Qualifier Input Type   |         Qualifiers info        */
    ...
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg3", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_fg3_common_qual_info_array},
};
static ctest_dnx_field_ffc_fg_info_t Ctest_dnx_field_ffc_ipmf23e_exhaustive_fg_info_array[CTEST_DNX_FIELD_FFC_IPMF23E_EXHAUSTIVE_NOF_FGS] = {
/**    Field group ID    |   Field group Name   |  Number of tested qualifiers   |  Qualifier Input Type   |         Qualifiers info        */
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg1", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_fg1_common_qual_info_array},
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg2", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_fg2_common_qual_info_array},
};
...
/**    Field group ID    |   Field group Name   |  Number of tested qualifiers   |  Qualifier Input Type   |         Qualifiers info        */
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg1", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeLayerAbsolute, Ctest_dnx_field_ffc_fg1_header_qual_info_array},
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg2", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeLayerAbsolute, Ctest_dnx_field_ffc_fg2_header_qual_info_array},
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg3", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeLayerAbsolute, Ctest_dnx_field_ffc_fg3_header_qual_info_array},
};
...
/**    Field group ID    |   Field group Name   |  Number of tested qualifiers   |  Qualifier Input Type   |         Qualifiers info        */
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg1", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeLayerRecordsAbsolute, Ctest_dnx_field_ffc_fg1_layer_record_qual_info_array},
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg2", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeLayerRecordsAbsolute, Ctest_dnx_field_ffc_fg2_layer_record_qual_info_array}
};
...
/**    Field group ID    |   Field group Name   |  Number of tested qualifiers   |  Qualifier Input Type   |         Qualifiers info        */
    {DBAL_ENUM_FVAL_FIELD_KEY_F, CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_cmp_hash_1_qual_info_array},
    {DBAL_ENUM_FVAL_FIELD_KEY_G, CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeLayerAbsolute, Ctest_dnx_field_ffc_cmp_hash_2_qual_info_array},
    {DBAL_ENUM_FVAL_FIELD_KEY_H, CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_cmp_hash_3_qual_info_array}
};
static ctest_dnx_field_ffc_fg_info_t Ctest_dnx_field_ffc_delete_readd_fg_info_array[CTEST_DNX_FIELD_FFC_IPMF1_LR_NOF_FGS] = {
/**    Field group ID    |   Field group Name   |  Number of tested qualifiers   |  Qualifier Input Type   |         Qualifiers info        */
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg1", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_fg1_layer_record_qual_info_array},
    {BCM_FIELD_ID_INVALID, "ffc_algo_fg2", CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS, bcmFieldInputTypeMetaData, Ctest_dnx_field_ffc_fg2_layer_record_qual_info_array},
};
    ...
    )
{
     ...
     */
    for (fg_iter = 0; fg_iter < CTEST_DNX_FIELD_FFC_IPMF1_EXHAUSTIVE_NOF_FGS; fg_iter++)
    {
        Ctest_dnx_field_ffc_ipmf1_exhaustive_fg_info_array[fg_iter].fg_id = BCM_FIELD_ID_INVALID;
    }

    for (fg_iter = 0; fg_iter < CTEST_DNX_FIELD_FFC_IPMF23E_EXHAUSTIVE_NOF_FGS; fg_iter++)
    {
        Ctest_dnx_field_ffc_ipmf23e_exhaustive_fg_info_array[fg_iter].fg_id = BCM_FIELD_ID_INVALID;
    }
    ...
    if (is_cmp)
    {
        ...
        for (key_index = 0; key_index < nof_keys; key_index++)
        {
            ...
            for (qual_index = 0; qual_index < ffc_cmp_hash_info[key_index].nof_qualifiers; qual_index++)
            {
                ...
                sal_strncpy_s((char *) qual_info.name, ffc_cmp_hash_info[key_index].ffc_qual_info[qual_index].name, sizeof(qual_info.name));
                SHR_IF_ERR_EXIT(bcm_field_qualifier_create(unit, 0, &qual_info, &(ffc_cmp_hash_info[key_index].ffc_qual_info[qual_index].qual_type)));

                if (key_index == 0)
                {
                    compare_info.first_key_info.qual_types[qual_index] = ffc_cmp_hash_info[key_index].ffc_qual_info[qual_index].qual_type;
                    compare_info.first_key_info.qual_info[qual_index].input_type = ffc_cmp_hash_info[key_index].qual_input_type;
                ...
                else if (key_index == 1)
                {
                    ...
                    compare_info.second_key_info.qual_types[qual_index] = ffc_cmp_hash_info[key_index].ffc_qual_info[qual_index].qual_type;
                    compare_info.second_key_info.qual_info[qual_index].input_type = ffc_cmp_hash_info[key_index].qual_input_type;
                    if (ffc_cmp_hash_info[key_index].qual_input_type == bcmFieldInputTypeLayerAbsolute ||
                        ffc_cmp_hash_info[key_index].qual_input_type == bcmFieldInputTypeLayerRecordsAbsolute)
                    {
            ...
            if (pair_id)
            {
                SHR_IF_ERR_EXIT(bcm_field_context_compare_create(unit, 0, bcmFieldStageIngressPMF1, context_id, pair_id, &compare_info));
                bcm_field_context_compare_info_t_init(&compare_info);
            }
        }
    ...
    else
    {
        ...
        for (key_index = 0; key_index < nof_keys; key_index++)
        {
            ...
            for (qual_index = 0; qual_index < ffc_cmp_hash_info[key_index].nof_qualifiers; qual_index++)
            {
                ...
                hash_info.key_info.qual_types[qual_index] = ffc_cmp_hash_info[key_index].ffc_qual_info[qual_index].qual_type;
    ...
    ctest_dnx_field_ffc_fg_info_t * ffc_fg_info)
{
    ...
    for (qual_index = 0; qual_index < ffc_fg_info->nof_qualifiers; qual_index++)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_field_qualifier_create(unit, 0, &qual_info, &(ffc_fg_info->ffc_qual_info[qual_index].qual_type)));
    ...
    ctest_dnx_field_ffc_cmp_hash_info_t * ffc_cmp_hash_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_key_kbr_ffc_array_hw_get(unit, dnx_field_stage, context_id, ffc_cmp_hash_info->initial_key_id, ffc_id));
    ...
    for (qual_iter = 0; qual_iter < ffc_cmp_hash_info->nof_qualifiers; qual_iter++)
    {
        ...
        if (ffc_id[qual_iter] != ffc_cmp_hash_info->ffc_qual_info[qual_iter].ffc_id_expected[0])
        {
            LOG_INFO_EX(BSL_LOG_MODULE,
                        ...
                        context_id, ffc_cmp_hash_info->ffc_qual_info[qual_iter].ffc_id_expected[0], ffc_id[qual_iter], EMPTY);
            SHR_EXIT();
        }
    }
    ...
    ctest_dnx_field_ffc_fg_info_t * ffc_fg_info)
{
    ...
    for (fg_index = 0; fg_index < nof_fgs; fg_index++)
    {
        ...
        {
            SHR_IF_ERR_EXIT(ctest_dnx_field_ffc_fg_config(unit, field_stage, ffc_cs_info[0].context_id, &ffc_fg_info[fg_index]));
        }
        else
        {
    ...
    ctest_dnx_field_ffc_fg_info_t * ffc_fg_info)
{
    ...
    for (fg_index = 0; fg_index < nof_fgs; fg_index++)
    {
        /** Create a field group and attach it to the created context selection. */
        SHR_IF_ERR_EXIT(ctest_dnx_field_ffc_fg_config(unit, field_stage, ffc_cs_info[0].context_id, &ffc_fg_info[fg_index]));
        SHR_IF_ERR_EXIT(ctest_dnx_field_ffc_compare(unit, field_stage, ffc_cs_info[0].context_id, &ffc_fg_info[fg_index]));
    }
    ...
    ctest_dnx_field_ffc_cmp_hash_info_t * ffc_cmp_hash_info)
{
    ...
    SHR_IF_ERR_EXIT(ctest_dnx_field_ffc_cs_config(unit, field_stage, &ffc_cs_info[0]));
    /** Create a field group and attach it to the created context selection. */
    SHR_IF_ERR_EXIT(ctest_dnx_field_ffc_cmp_hash_config(unit, is_cmp, nof_keys, field_stage, ffc_cs_info[0].context_id, ffc_cmp_hash_info));

    for (key_index = 0; key_index < nof_keys; key_index++)
    {
        SHR_IF_ERR_EXIT(ctest_dnx_field_ffc_cmp_hash_compare(unit, field_stage, ffc_cs_info[0].context_id, &ffc_cmp_hash_info[key_index]));
    }
    ...
    for (key_index = 0; key_index < nof_keys; key_index++)
    {
        for (qual_index = 0; qual_index < ffc_cmp_hash_info[key_index].nof_qualifiers; qual_index++)
        {
            SHR_IF_ERR_EXIT(bcm_field_qualifier_destroy(unit, ffc_cmp_hash_info[key_index].ffc_qual_info[qual_index].qual_type));
    ...
    if (is_cmp)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, ffc_cs_info[0].context_id, 1));
        SHR_IF_ERR_EXIT(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, ffc_cs_info[0].context_id, 2));
    }
    else
    {
        /** Hashing destroy. */
    ...
    ctest_dnx_field_ffc_fg_info_t * ffc_fg_info)
{
    ...
    for (delete_readd_index = 0; delete_readd_index < CTEST_DNX_FIELD_FFC_NOF_DELETE_READD_ITERATIONS; delete_readd_index++)
    {
        /** Create a field group and attach it to the created context selection. */
    ...
    for (stage_index = 0; stage_index < CTEST_DNX_FIELD_FFC_NOF_STAGES; stage_index++)
    {
        switch (stage_index)
        {
            case 0:
            {
                ...
                exhaustive_nof_fgs = CTEST_DNX_FIELD_FFC_IPMF1_EXHAUSTIVE_NOF_FGS;
                Ctest_dnx_field_ffc_ipmf1_exhaustive_fg_info_array[CTEST_DNX_FIELD_FFC_IPMF1_EXHAUSTIVE_NOF_FGS - 1].
                    ffc_qual_info[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS - 1].qual_size = 42;
                exhaustive_fg_info = Ctest_dnx_field_ffc_ipmf1_exhaustive_fg_info_array;
            ...
            case 1:
            {
                ...
                exhaustive_nof_fgs = CTEST_DNX_FIELD_FFC_IPMF23E_EXHAUSTIVE_NOF_FGS;
                Ctest_dnx_field_ffc_ipmf23e_exhaustive_fg_info_array[CTEST_DNX_FIELD_FFC_IPMF23E_EXHAUSTIVE_NOF_FGS - 1].
                    ffc_qual_info[CTEST_DNX_FIELD_FFC_COMMON_NOF_QUALS - 1].qual_size = 42;
                exhaustive_fg_info = Ctest_dnx_field_ffc_ipmf23e_exhaustive_fg_info_array;
                diff_sizes_nof_fgs = CTEST_DNX_FIELD_FFC_DIFF_SIZES_NOF_FGS;
                delete_readd_fg_info = Ctest_dnx_field_ffc_delete_readd_fg_info_array;
                break;
            }
            ...
            case 3:
            {
                ...
                Ctest_dnx_field_ffc_delete_readd_fg_info_array[CTEST_DNX_FIELD_FFC_IPMF1_LR_NOF_FGS - 1].
                    nof_qualifiers = CTEST_DNX_FIELD_FFC_EPMF_DELETE_READD_FG2_NOF_QUALS;
                delete_readd_fg_info = Ctest_dnx_field_ffc_delete_readd_fg_info_array;
                break;
            }
            default:
