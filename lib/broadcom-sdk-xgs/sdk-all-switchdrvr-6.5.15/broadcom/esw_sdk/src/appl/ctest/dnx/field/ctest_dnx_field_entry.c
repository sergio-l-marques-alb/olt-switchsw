...
static bcm_field_qualify_t bcm_qual_array[NUM_STAGES][NUM_QUALS_AND_ACTIONS] =
{
    ...
    {bcmFieldQualifyIntPriority, bcmFieldQualifySrcClassField, bcmFieldQualifyRangeCheck}
};
...
static bcm_field_qualify_t bcm_qual_array2[NUM_STAGES][NUM_QUALS_AND_ACTIONS] =
{
    ...
    {bcmFieldQualifyIntPriority, bcmFieldQualifyDstClassField, bcmFieldQualifyRangeCheck}
};
...
{ {bcmFieldActionPrioIntNew, bcmFieldActionUsePolicerResult, bcmFieldActionVSwitchNew},
{bcmFieldActionPphPresentSet, bcmFieldActionStatId0, bcmFieldActionInVportClass0},
    ...
    uint32 cur_fg_entry)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_entry_tcam_add(unit, fg_id, entry_info, entry_handle));
exit:
    SHR_FUNC_EXIT;
}
    ...
    else if (field_entry_test_type_name == 1)
    {
        for (fg_index = 0; fg_index < NUM_FGS; fg_index++)
        {
            ...
            for (assignment_index = 0; assignment_index < NUM_QUALS_AND_ACTIONS; assignment_index++)
            {
                ...
                dnx_fg_info.dnx_actions[0][assignment_index] =
