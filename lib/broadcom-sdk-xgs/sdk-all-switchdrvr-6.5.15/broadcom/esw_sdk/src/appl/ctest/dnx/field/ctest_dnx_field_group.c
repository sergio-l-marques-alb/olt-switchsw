    ...
    int unit)
{
    ...
    fg_info_in.dnx_actions[0][0] = DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, stage_cfg, DBAL_ENUM_FVAL_IPMF1_ACTION_DP);
    ...
    attach_info.action_info[0][0].priority = BCM_FIELD_ACTION_PRIORITY(0, 8);
    ...
    SHR_IF_ERR_EXIT(dnx_field_entry_tcam_add(unit, grp_id, &entry_info, &entry_handle));
...
/* { */
    ...
    else if (field_group_test_type_name == 1)
    {
        int ii;
        dnx_field_presel_entry_id_t presel_entry_id;
        dnx_field_presel_qual_data_t presel_qual[CTEST_DNX_FIELD_GROUP_NOF_PRESEL];
        dnx_field_presel_entry_data_t presel_data;
            ...
            || (sal_strcasecmp(field_group_test_mode_name, TEST_MODE_FG_MULTI) == 0))
        {
            ...
            presel_qual[0].qual_type_dbal_field = presel_qualifiers_array[field_stage];
            presel_qual[0].qual_value = CTEST_DNX_FIELD_GROUP_QUAL_VALUE;
            presel_qual[0].qual_mask = CTEST_DNX_FIELD_GROUP_QUAL_MASK;
            ...
            sal_memcpy(presel_data.qual_data, presel_qual,
                       CTEST_DNX_FIELD_GROUP_NOF_PRESEL * sizeof(presel_data.qual_data));
            ...
            {
                tcam_fg_util.bcm_actions[0][ii] = bcm_actions_array[field_stage][ii];
