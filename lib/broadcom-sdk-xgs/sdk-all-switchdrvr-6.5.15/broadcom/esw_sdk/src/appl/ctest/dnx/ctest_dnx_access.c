...
sh_sand_cmd_t ctest_dnx_access_memory_defaults_cmds[] = {
    {"mbist", 	ctest_dnx_access_memory_defaults_mbist, NULL, 	NULL, &ctest_dnx_access_memory_defaults_mbist_man, 	NULL, NULL, CTEST_POSTCOMMIT},
    {"dma", 	ctest_dnx_access_memory_defaults_dma, 	NULL, 	NULL, &ctest_dnx_access_memory_defaults_dma_man, 	NULL, NULL, CTEST_POSTCOMMIT},
    {NULL}
};
