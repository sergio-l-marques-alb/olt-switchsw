    ...
    int profile_type)
{
    ...
    SHR_IF_ERR_EXIT(dnx_chm_unittest_calendar_get_cb(unit, old_offset, &calendar));
    SHR_IF_ERR_EXIT(dnx_chm_unittest_calendar_set_cb(unit, new_offset, &calendar));
    ...
    int *performance_number)
{
    ...
    if (action_is_add)
    {
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_member_add
                        (unit, chm_handle, unique_identifyer, member_to_act_on, current_nof_members, NULL));
    }
    else
    {
    ...
    sh_sand_control_t * sand_control)
{
     ...
     */
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 0, DNX_CHM_UNITTEST_0, 2, 2, NULL, NULL, NULL));
                                                                                /** 8 entries in table */
        dummy_hw_unique_id_to_profile_table[1] = 1;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 1, DNX_CHM_UNITTEST_1, 5, 5, NULL, NULL, NULL));
                                                                                /** 16 entries in table */
        dummy_hw_unique_id_to_profile_table[2] = 2;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 2, DNX_CHM_UNITTEST_2, 6, 6, NULL, NULL, NULL));
                                                                                /** 32 entries in table */
        dummy_hw_unique_id_to_profile_table[3] = 3;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 3, DNX_CHM_UNITTEST_3, 8, 8, NULL, NULL, NULL));
                                                                                /** 64 entries in table */
        dummy_hw_unique_id_to_profile_table[4] = 4;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 4, DNX_CHM_UNITTEST_4, 20, 20, NULL, NULL, NULL));
                                                                                  /** 128 entries in table */
        dummy_hw_unique_id_to_profile_table[5] = 5;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 5, DNX_CHM_UNITTEST_5, 30, 30, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[6] = 6;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 6, DNX_CHM_UNITTEST_5, 31, 31, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[7] = 7;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 7, DNX_CHM_UNITTEST_5, 32, 32, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[8] = 8;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 8, DNX_CHM_UNITTEST_5, 33, 33, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[9] = 9;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 9, DNX_CHM_UNITTEST_5, 34, 34, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[10] = 10;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 10, DNX_CHM_UNITTEST_5, 35, 35, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[11] = 11;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 11, DNX_CHM_UNITTEST_5, 36, 36, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[12] = 12;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 12, DNX_CHM_UNITTEST_5, 37, 37, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[13] = 13;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 13, DNX_CHM_UNITTEST_5, 38, 38, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[14] = 14;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 14, DNX_CHM_UNITTEST_5, 39, 39, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[15] = 15;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 15, DNX_CHM_UNITTEST_5, 40, 40, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[16] = 16;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 16, DNX_CHM_UNITTEST_5, 41, 41, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[17] = 17;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 17, DNX_CHM_UNITTEST_5, 42, 42, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 18, DNX_CHM_UNITTEST_5, 43, 43, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[19] = 19;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 19, DNX_CHM_UNITTEST_5, 44, 44, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        /** 3,4. try to allocate when full - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 45, 45, NULL,
                                                               NULL, NULL);
                                                                                  /** 256 entries in table */
        if (rv == _SHR_E_NONE)
        {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 38, 38, NULL, NULL, NULL));
         ...
         *  are not realy freed */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 20));
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 45, 45, NULL,
                                                               NULL, NULL);
                                                                                  /** 256 entries in table */
        if (rv == _SHR_E_NONE)
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 19));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 18));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 17));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 16));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 15));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 14));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 13));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 12));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 11));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 10));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 9));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 8));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 7));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 6));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 5));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 4));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 3));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 2));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 1));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 0));
     ...
     */
    {
        ...
        dummy_hw_unique_id_to_profile_table[0] = 0;
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 0, DNX_CHM_UNITTEST_0, 2, 4, NULL,
                                                               NULL, NULL);
                                                                               /** 8 entries in table */
        if (rv == _SHR_E_NONE)
        {
            SHR_ERR_EXIT(_SHR_E_FAIL, "attampt ileagel allocation, was expecting failure but recieved success\n");
        }
        /** 2.alloc partial profile */
        dummy_hw_unique_id_to_profile_table[0] = 0;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 0, DNX_CHM_UNITTEST_0, 4, 2, NULL, NULL, NULL));
                                                                                /** 8 entries in table */
        /** 3.alloc partial profile with specific members */
        dummy_hw_unique_id_to_profile_table[1] = 1;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 1, DNX_CHM_UNITTEST_1, 5, 3, specific_member_array_0, NULL, NULL));
                                                    /** 16 entries in table */
        ...
        dummy_hw_unique_id_to_profile_table[6] = 6;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 6, DNX_CHM_UNITTEST_5, 30, 25, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[7] = 7;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 7, DNX_CHM_UNITTEST_5, 30, 25, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[8] = 8;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 8, DNX_CHM_UNITTEST_5, 30, 25, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[9] = 9;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 9, DNX_CHM_UNITTEST_5, 30, 22, NULL, NULL, NULL));
                                                                                  /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[10] = 10;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 10, DNX_CHM_UNITTEST_5, 30, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[11] = 11;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 11, DNX_CHM_UNITTEST_5, 30, 28, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[12] = 12;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 12, DNX_CHM_UNITTEST_5, 37, 30, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[13] = 13;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 13, DNX_CHM_UNITTEST_5, 35, 30, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[14] = 14;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 14, DNX_CHM_UNITTEST_5, 35, 32, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[15] = 15;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 15, DNX_CHM_UNITTEST_5, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[16] = 16;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 16, DNX_CHM_UNITTEST_5, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[17] = 17;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 17, DNX_CHM_UNITTEST_5, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[18] = 18;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 18, DNX_CHM_UNITTEST_5, 35, 22, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        dummy_hw_unique_id_to_profile_table[19] = 19;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 19, DNX_CHM_UNITTEST_5, 35, 3, specific_member_array_0, NULL, NULL));
                                                       /** 256 entries in table */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 45, 45, NULL,
                                                               NULL, NULL);
                                                                                  /** 256 entries in table */
        ...
        /** 5.allocate partial that similar to partial that was already allocated - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 35, 22, NULL,
                                                               NULL, NULL);
                                                                                  /** 256 entries in table */
        if (rv == _SHR_E_NONE)
        {
        ...
        /** 6.allocate partial with specific members similar to partial that was already allocated - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_alloc(unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 35, 3,
     ...
     */
    {
        ...
        /** 3.remove member from profile - expect failure */
        rv = dnx_algo_consistent_hashing_manager_profile_member_remove(unit, chm_handle, 15, 12, 40, NULL);
        if (rv == _SHR_E_NONE)
        {
        ...
        dummy_hw_unique_id_to_profile_table[20] = 20;
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 20, DNX_CHM_UNITTEST_5, 40, 40, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        /** 6.remove member from profile */
        ...
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_alloc
                        (unit, chm_handle, 21, DNX_CHM_UNITTEST_5, 40, 40, NULL, NULL, NULL));
                                                                                   /** 256 entries in table */
        /** 10.free all */
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 20));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 21));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 19));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 18));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 17));
        SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, 16));
     ...
     */
    {
        ...
        for (int i = 0; i < nof_iterations; ++i)
        {
            ...
            int members_in_profile[max_nof_members_in_profile];
            int members_not_in_profile[max_nof_members_in_profile];
            int add_actions = 0;
            ...
            for (int j = 0; j < nof_actions; ++j)
            {
                ...
                if (action_is_add)
                {
                    ...
                    member_to_act_on = members_not_in_profile[member_index];
                    /** align management arrays */
                    members_not_in_profile[member_index] =
                        members_not_in_profile[current_nof_members_not_in_profile - 1];
                    members_in_profile[current_nof_members_in_profile] = member_to_act_on;
                }
                else
                {
                    ...
                    member_to_act_on = members_in_profile[member_index];
                    /** align managment arrays */
                    members_in_profile[member_index] = members_in_profile[current_nof_members_in_profile - 1];
                    members_not_in_profile[current_nof_members_not_in_profile] = member_to_act_on;
                }
            ...
            /** free profile */
            SHR_IF_ERR_EXIT(dnx_algo_consistent_hashing_manager_profile_free(unit, chm_handle, unique_id));
