...
sh_sand_cmd_t dnx_rx_trap_test_cmds[] = {
    ...
    {"etpp_oam", sh_dnx_rx_trap_etpp_oam_cmd, NULL, NULL, &sh_dnx_rx_trap_etpp_oam_man, NULL, sh_dnx_rx_trap_etpp_oam_tests},
    ...
    {"erpp", sh_dnx_rx_trap_erpp_cmd, NULL, NULL, &sh_dnx_rx_trap_erpp_man, NULL, sh_dnx_rx_trap_erpp_tests},
    {"etpp", sh_dnx_rx_trap_etpp_cmd, NULL, NULL, &sh_dnx_rx_trap_etpp_man, NULL, sh_dnx_rx_trap_etpp_tests},
    ...
    bcm_rx_trap_config_t * trap_config_p)
{
    ...
    LOG_INFO_EX(BSL_LOG_MODULE, "Created and set bcmRxTrap%s Trap. trap_id=%d \n %s%s",
                dnx_rx_trap_type_map[trap_type].trap_name, *trap_id_p, EMPTY, EMPTY);
    ...
    bcm_gport_t trap_gport)
{
    ...
    LOG_INFO_EX(BSL_LOG_MODULE, "Action profile Set on Trap: bcmRxTrap%s \n %s%s%s",
                dnx_rx_app_trap_type_map[trap_type].trap_name, EMPTY, EMPTY, EMPTY);
    ...
    bcm_gport_t * lif_p)
{
    ...
    BCM_GPORT_SUB_TYPE_LIF_SET(gport_id, 0, 8888);
    BCM_GPORT_MPLS_PORT_ID_SET(mpls_port.mpls_port_id, gport_id);
    mpls_port.egress_label.label = 5000;
