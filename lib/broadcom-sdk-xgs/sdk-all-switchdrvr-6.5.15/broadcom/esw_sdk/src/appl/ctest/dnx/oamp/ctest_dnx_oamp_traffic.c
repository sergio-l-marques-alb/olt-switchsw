...
static int test_oam_rdi_event_counts = 0;
 ...
 *                          EVENT_TYPE_RDI to reset rdi event counters,
    ...
    int *event_index)
{
    ...
    *event_index = diag_dnx_oamp_test_oam_get_event_index(unit, rmep.name);
    ...
    rmep.ccm_period = BCM_OAM_ENDPOINT_CCM_PERIOD_100MS + 3;
    ...
    void *user_data)
{
    ...
    */
    ...
    else if ((event_type == bcmOAMEventEndpointRemote) || (event_type == bcmOAMEventEndpointRemoteUp))
    {
        test_oam_rdi_event_counts++;
        SHR_CLI_EXIT(_SHR_E_FAIL, "RDI Error, mep_index: %d\n", mep_index);
    }
    ...
    int unit)
{
    ...
    SHR_CLI_EXIT_IF_ERR(bcm_oam_event_register(unit, timein_event, diag_dnx_oamp_test_oam_cb, (void *) 3),
    ...
    int expected_value)
{
    ...
    switch (event_type)
    {
        ...
        case EVENT_TYPE_TIMEIN:
            ...
            break;
        case EVENT_TYPE_RDI:
            if (test_oam_rdi_event_counts > expected_value)
            {
                SHR_CLI_EXIT(_SHR_E_FAIL, "Test failed! Unexpected RDI events, expected %d actual %d\n", expected_value,
                             test_oam_rdi_event_counts);
            }
            break;
        default:
    ...
    int expected_value)
{
    ...
    switch (event_type)
    {
        ...
        case EVENT_TYPE_RDI:
            if (test_oam_rdi_event_counts < expected_value)
            {
                SHR_CLI_EXIT(_SHR_E_FAIL, "Test failed! Unexpected RDI events, expected %d expected_value actual %d\n",
                             expected_value, test_oam_rdi_event_counts);
            }
            break;
        default:
            SHR_CLI_EXIT(_SHR_E_FAIL, "Test failed! Not supported event type!\n");
 ...
 */
static shr_error_e
diag_dnx_oamp_test_oam_loopback_on_off(
    int unit,
    bcm_port_t port_1,
    bcm_port_t port_2,
    int action)
 ...
 */
void
diag_dnx_oamp_test_oam_time_calculation(
    diag_dnx_oamp_traffic_test_time_calc_t * time_param)
{
    /**
    ...
    diag_dnx_oamp_traffic_test_general_t * global_parameters)
{
    ...
    */
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_loopback_on_off
    ...
    diag_dnx_oamp_traffic_test_general_t global_parameters)
{
    ...
    if (global_parameters.num_entries > MAX_NUMBER_OF_PAIRS)
    {
        /*
         * Number of endpoint pairs is limited by the throughput of the ports
         */
        SHR_CLI_EXIT(_SHR_E_PARAM, "Test failed! Max number of MEP pairs is 1024. Aborting test.\n");
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    int event_index = 0, index = 0, exp_event_cnt = 0;
    uint32 vlan;
    uint8 level;
    SHR_FUNC_INIT_VARS(unit);
    ...
    */
    for (endpoint = 0; endpoint < global_parameters.num_entries; ++endpoint)
    {
        ...
        */
        ep1.name = diag_dnx_oamp_test_oam_vlan_level__to_name(unit, vlan, level, 0);
        ...
        * Fill custom structure for MEP creation
        */
        ep2.name = diag_dnx_oamp_test_oam_vlan_level__to_name(unit, vlan, level, 1);
        ...
        */
        diag_dnx_oamp_test_oam_time_calculation(&time_parameters);
    }
    ...
    */
    ...
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_non_expected_event_interupts
                        ...
                        "{12}\t Test failed! Unexpected number of timeout events raised!\n");
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_non_expected_event_interupts
                        (unit, EVENT_TYPE_TIMEIN, exp_event_cnt),
                        "{13}\t Test failed! Unexpected number of timein events raised!\n");
    ...
    */
    ...
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_expected_event_interupts(unit, EVENT_TYPE_TIMEOUT, exp_event_cnt),
                        "{15}\t Test failed! Not enough timeout events were raised!\n");
    /**
    * Enable the loop-back to restore the connection.
    */
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_loopback_on_off
                        (unit, global_parameters.port_1, global_parameters.port_2, LOOP_BACK_ENABLE),
                        "{16}\t Test failed! LoopBack disable failed!\n");
    ...
    */
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_expected_event_interupts(unit, EVENT_TYPE_TIMEIN, exp_event_cnt),
                        "{17}\t Test failed! Not enough timein events were raised!\n");
    ...
    */
    for (update = 1; update <= global_parameters.num_updates; ++update)
    {
        ...
        SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_reset_event_counters
                            ...
                            "{18}\t Test failed! Events are not reseted \n");
        /**
        ...
        */
        ...
        SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_expected_event_interupts
                            (unit, EVENT_TYPE_TIMEOUT, exp_event_cnt),
                            "{20}\t Test failed! Unexpected number of timeout events raised!\n");
        /**
        ...
        */
        ...
        SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_expected_event_interupts
                            (unit, EVENT_TYPE_TIMEIN, exp_event_cnt),
                            "{22}\t Test failed! Unexpected number of timein events raised!\n");

        /** Reset all event counter before next validation */
        SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_reset_event_counters
                            (unit, EVENT_TYPE_ALL, global_parameters.num_entries),
                            "{25}\t Test failed! Events are not reseted \n");
        ...
        */
        ...
        SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_check_non_expected_event_interupts
                            (unit, EVENT_TYPE_TIMEIN, exp_event_cnt),
                            "{24}\t Test failed! Unexpected number of timein events raised!\n");
...
exit:
    ...
    SHR_CLI_EXIT_IF_ERR(diag_dnx_oamp_test_oam_loopback_on_off
                        (unit, global_parameters.port_1, global_parameters.port_2, LOOP_BACK_DISABLE),
                        "{25}\t Test failed! LoopBack disable failed!\n");
    ...
    SHR_CLI_EXIT_IF_ERR(bcm_oam_endpoint_destroy_all(unit, global_parameters.group_id),
                        "{26}\t Test failed! bcm_oam_endpoint_destroy_all failed!\n");
...
sh_sand_man_t diag_dnx_oamp_traffic_test_man = {
    ...
    /** Synopsis   */
    "ctest oamp traffic [Port=<value> Port2=<value> Num_ENTries=<value> Num_UPDates=<value> GRouP_Type=<value>]",
    /** Example   */
...
sh_sand_invoke_t diag_dnx_oamp_traffic_tests[] = {
    {"eps_20_oam_update_10", "Port=13 Port2=14 Num_ENTries=1 Num_UPDates=1 GRouP_Type=SHORT MEMory_Type=Self_Self"},
    {NULL}
};
