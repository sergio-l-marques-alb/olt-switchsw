...
#define CTEST_DNX_RX_TRAPS_MTU_OPTION_TEST_TYPE        "type"

#define CTEST_DNX_RX_TRAPS_MTU_OPTION_TEST_TYPE_PORT   "port"
#define CTEST_DNX_RX_TRAPS_MTU_OPTION_TEST_TYPE_LIF   "lif"
#define CTEST_DNX_RX_TRAPS_MTU_OPTION_TEST_TYPE_RIF   "rif"
