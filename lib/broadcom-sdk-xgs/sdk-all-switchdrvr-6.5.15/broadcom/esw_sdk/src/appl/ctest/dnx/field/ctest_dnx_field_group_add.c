    ...
    dnx_field_group_info_t * fg_info_p)
{
    ...
    {
        fg_info_p->dnx_actions[0][assignment_index] =
    ...
    if (test_flag == CTEST_DNX_FIELD_GROUP_ADD_TEST_FLAG_NOT_CREATED_USER_QUAL)
    {
        ...
        fg_info_p->dnx_actions[0][0] = DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, field_stage, actions_p[0]);
    }
    ...
    dnx_field_utils_signal_info_t * sig_info_p)
{
    ...
    rv = sand_signal_verify(unit, sig_info_p->core,
                            ...
                            sig_info_p->from,
                            sig_info_p->to,
                            sig_info_p->sig_name, &(expected_value), sig_info_p->size, NULL, return_value);
    ...
    dnx_field_group_info_t * fg_info_p)
{
    ...
    dnx_field_group_context_flags_e context_flags;
    ...
    if (field_stage == DNX_FIELD_STAGE_IPMF1)
    {
        ...
        fg_info_p->dnx_actions[0][0] = dnx_action;
        fg_info_p->dnx_quals[0] = dnx_qual;
        /**
         * Init the attach_info structure
         */
        context_flags = DNX_FIELD_GROUP_CONTEXT_FLAGS_NONE;
        ...
        attach_info.dnx_actions[0][0] = dnx_action;
        /**
         * Give random mid-range priority, the value can be changed, it will not influence the test
         */
        attach_info.action_info[0][0].priority = BCM_FIELD_ACTION_PRIORITY(0, 6);
        /**
         ...
         * Create an entry
         */
        SHR_IF_ERR_EXIT(dnx_field_entry_tcam_add(unit, *fg_id_p, &entry_info, &entry_handle));
        /**
