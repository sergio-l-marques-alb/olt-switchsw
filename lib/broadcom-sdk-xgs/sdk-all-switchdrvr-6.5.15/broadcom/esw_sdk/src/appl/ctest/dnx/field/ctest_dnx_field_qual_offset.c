...
dnx_field_qual_offset_info_t Qual_offset_info[] =
{
    ...
    {.qual_descriptor = "Testing META   qualifier, IPMF1", .bcm_stage = bcmFieldStageIngressPMF1,
        .bcm_qualifier = bcmFieldQualifyRangeCheck, .expected_offset = 1841},
    {.qual_descriptor = "Testing META   qualifier, EPMF", .bcm_stage = bcmFieldStageEgress,
        .bcm_qualifier = bcmFieldQualifyRangeCheck, .expected_offset = (1214+1167)},
    /*
    ...
    sh_sand_control_t * sand_control)
{
    ...
    int offset;
    const int src_mac_offset = 64;
    const int ttl_offset = 152;
    ...
    else if (qual_offset_test_type == 0)
    {
         ...
         * bcmFieldQualifyRangeCheck,           META, IPMF1
    ...
    else
    {
        ...
        LOG_INFO_EX(BSL_LOG_MODULE,
                    ...
                    __FUNCTION__, __LINE__, qual_offset_test_type, EMPTY);
