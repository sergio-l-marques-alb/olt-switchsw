    ...
    sh_sand_control_t * sand_control)
{
    ...
    else if (test_type == 1)
    {
        ...
        context_id = 6;
        SHR_IF_ERR_EXIT(dnx_field_context_create(unit, flags, DNX_FIELD_STAGE_IPMF1, &dnx_context_mode, &context_id));
        ...
        attach_info.dnx_actions[0][0] = fg_info_in.dnx_actions[0][0];

        attach_info.action_info[0][0].priority = BCM_FIELD_ACTION_PRIORITY(0, 10);
        ...
        entry_info.payload_info.action_info[0].dnx_action = fg_info_in.dnx_actions[0][0];
        entry_info.payload_info.action_info[0].action_value[0] = 2;

        SHR_IF_ERR_EXIT(dnx_field_entry_tcam_add(unit, grp_id, &entry_info, &entry_handle1));
        ...
        SHR_IF_ERR_EXIT(dnx_field_entry_tcam_add(unit, grp_id, &entry_info, &entry_handle2));
