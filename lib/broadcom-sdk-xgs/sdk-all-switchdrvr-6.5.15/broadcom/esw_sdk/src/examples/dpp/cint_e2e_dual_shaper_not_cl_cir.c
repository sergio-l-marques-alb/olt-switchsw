...
printf("5\n");
    ...
    BCM_COSQ_GPORT_SCHED_CIR_CORE_SET(c6_gport_ucast_scheduler_cir[idx], c6_gport_ucast_scheduler[idx], 0);
    BCM_COSQ_GPORT_SCHED_PIR_CORE_SET(c6_gport_ucast_scheduler_pir[idx], c6_gport_ucast_scheduler[idx], 0);
...
printf("9\n");
    ...
    rv = bcm_cosq_gport_add(c6_unit, dest_gport[idx], num_cos, 
