...
int kaps_hitbits_ipv_4_6_uc_mc_fill_entries(int unit, int out_port) {
    return kaps_hitbits_ipv_4_6_uc_mc_fill_entries_with_scale(unit, out_port, 0 /*scale*/);
}

int kaps_hitbits_ipv_4_6_uc_mc_fill_entries_with_scale(int unit, int out_port, int scale) {
    int rc,i;
    bcm_l3_intf_t l3if;
