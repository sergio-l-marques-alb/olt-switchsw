 ...
 * field_state_table_main(unit);
 */

bcm_field_group_t cint_field_app_type_fg_id = 0;
bcm_field_context_t cint_field_app_type_context_id = 0;
bcm_field_entry_t cint_field_app_type_entry_id;
...
*/
int field_app_type_main(int unit, bcm_field_presel_t presel_id, bcm_field_AppType_t app_type)
{
   ...
   printf("Creating context for App_type presel...\r\n");
    ...
    ent_info.priority = 1;
    BCM_GPORT_LOCAL_SET(in_port_gport,201);
