/*
 * $Id: cint_mpls_operations_without_eedb.c, Exp $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_mpls_operations_without_eedb.c
 */
 ...
 * int port1 = 200; 
 * int port2 = 201;
 * rv = mpls_operations_without_eedb_main(unit,port1,port2);
 * print rv; 
 * 
 * 
...
int MPLS_FHEI_FEC_MODE_PHP = 0;
int MPLS_FHEI_FEC_MODE_SWAP = 1;
int MPLS_FHEI_ILM_MODE_PHP = 2;
int MPLS_FHEI_ILM_MODE_SWAP = 3;
int MPLS_FHEI_FEC_MODE_PUSH = 4;
