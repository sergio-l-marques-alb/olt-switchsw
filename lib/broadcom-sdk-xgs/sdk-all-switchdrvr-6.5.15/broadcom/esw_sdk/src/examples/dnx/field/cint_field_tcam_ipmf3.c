...
int field_tcam_ipmf3_main(int unit)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_tcam_ipmf3_fg_id);
    if (rv != BCM_E_NONE)
    {
...
int field_attach_destroy(int unit)
{
    ...
    rv = bcm_field_entry_delete(unit,cint_attach_fg_id,entry_qual_info,cint_tcam_ipmf3_entry_id[0]);
    if (rv != BCM_E_NONE)
    {
