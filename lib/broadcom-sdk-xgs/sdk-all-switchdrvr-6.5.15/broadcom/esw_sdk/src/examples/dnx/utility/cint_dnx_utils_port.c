...
int cint_nif_priority_config_mpls_special_label_config(int unit, int in_port, int scenario_index)
{
    ...
    rv = bcm_port_loopback_set(unit, in_port, BCM_PORT_LOOPBACK_MAC);
    if (rv != BCM_E_NONE) {
...
int cint_nif_priority_config_soft_stage_JER2(int in_port,int lp_pcp,int low_priority,int hp_pcp,int high_priority,uint32 header,
