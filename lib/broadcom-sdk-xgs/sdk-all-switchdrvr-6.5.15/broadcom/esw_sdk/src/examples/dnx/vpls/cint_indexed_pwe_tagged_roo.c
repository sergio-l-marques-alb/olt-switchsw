 ...
 * cint ../../../../src/examples/dnx/cint_indexed_pwe_tagged_roo.c
 * cint
 * int unit = 0; 
 * int rv = 0; 
 * int in_port = 200; 
 * int out_port = 201;
 * rv = indexed_pwe_tagged_roo_main(unit,ac_port,pwe_port);
 * print rv; 
 * 
 * 
    ...
    int port2)
{
    ...
    */
    ...
    vpls_util_entity[1].vpls_ingress[0].flags2 |= BCM_MPLS_PORT2_INGRESS_ONLY | BCM_MPLS_PORT2_INTERFACE_NAMESPACE;
    ...
    vpls_util_entity[1].tpids[0].class_id = 508;
    ...
    vpls_util_entity[0].vlan_edits[0].vlan.criteria = BCM_VLAN_PORT_MATCH_PORT_VLAN;
