 ...
 *              - bcmFieldQualifyIpTunnelType - not tested currently for more info please check the comment in
 *                field_layer_record_ipmf1_qual_ipv4_info_array[] array.
 *          6. IPv6 LR qualifiers:
 *              - bcmFieldQualifyIp6MulticastCompatible
 *              - bcmFieldQualifyIp6FirstAdditionalHeaderExist
 *          7. ITMH LR qualifiers:
...
cint_field_layer_record_qual_info_t field_layer_record_ipmf1_qual_ipv4_info_array[LR_NOF_IPMF1_IPV4_QUALS] = {
  /**  qual_type   |   qual_value   |   qual_mask    |  input_type    |    input_arg  |  qual_offset  */
    ...
    {bcmFieldQualifyIpMulticastCompatible, TRUE, 0x1, {bcmFieldInputTypeLayerRecordsAbsolute, 1, 0}},
