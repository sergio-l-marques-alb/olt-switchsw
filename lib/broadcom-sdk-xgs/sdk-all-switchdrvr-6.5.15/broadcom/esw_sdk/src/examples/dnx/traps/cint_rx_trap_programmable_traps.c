 ...
 * containing only relevant data for ETH forwarded packets
 */
struct cint_rx_trap_programmable_traps_config_eth_fwd_utils {
...
cint_rx_trap_programmable_traps_config_eth_fwd_utils cint_rx_trap_programmable_traps_config_eth = {
...
*/
int
programmable_trap_config_fill_and_set_eth(
    int unit,
    uint8 prog_index,
    cint_rx_trap_programmable_traps_config_eth_fwd_utils * prog_config_eth_fwd,
    bcm_rx_trap_prog_config_t * prog_config)
{
    ...
    prog_config->dest_mac = prog_config_eth_fwd->dest_mac;
    prog_config->dest_mac_nof_bits = prog_config_eth_fwd->dest_mac_nof_bits;
    prog_config->dest_mac_enable = prog_config_eth_fwd->dest_mac_enable;

    prog_config->src_mac = prog_config_eth_fwd->src_mac;
    prog_config->src_mac_nof_bits = prog_config_eth_fwd->src_mac_nof_bits;
    prog_config->src_mac_enable = prog_config_eth_fwd->src_mac_enable;

    prog_config->ether_type = prog_config_eth_fwd->ether_type;
    prog_config->ether_type_enable = prog_config_eth_fwd->ether_type_enable;

    prog_config->sub_type = prog_config_eth_fwd->sub_type;
    prog_config->sub_type_mask = prog_config_eth_fwd->sub_type_mask;
    prog_config->sub_type_enable = prog_config_eth_fwd->sub_type_enable;
    ...
    int *trap_id)
{
    ...
    rv = programmable_trap_config_fill_and_set_eth(unit, cint_rx_trap_programmable_traps_index_eth, &cint_rx_trap_programmable_traps_config_eth, &prog_config);
    if (rv != BCM_E_NONE)
    {
      printf("Error in programmable_trap_config_fill_and_set_eth\n");
      return rv;
    }
