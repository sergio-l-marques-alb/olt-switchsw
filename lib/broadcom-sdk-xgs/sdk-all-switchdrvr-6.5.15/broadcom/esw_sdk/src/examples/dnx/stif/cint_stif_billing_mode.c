 ...
 * 
 * 
 *   - ACL rule to generate PP stat objects
 *  
...
bcm_port_t stif_logical_port_0, stif_logical_port_1;
    ...
    int unit)
{
    ...
    egress_record_format_elements[2].element_type = bcmStatStifRecordElementObj2;
    ...
    egress_record_format_elements[3].element_type = bcmStatStifRecordElementEgressMetaDataMultiCast;
    egress_record_format_elements[3].mask = BCM_STAT_FULL_MASK;
    egress_record_format_elements[4].element_type = bcmStatStifRecordElementEgressMetaDataTrafficClass;
    egress_record_format_elements[4].mask = BCM_STAT_FULL_MASK;
    egress_record_format_elements[5].element_type = bcmStatStifRecordElementOpCode; 
    egress_record_format_elements[5].mask = 0xFF; 
    egress_record_format_elements[6].element_type = bcmStatStifRecordElementPacketSize; 
    egress_record_format_elements[6].mask = BCM_STAT_FULL_MASK;

    nof_elements_egress = 7;
