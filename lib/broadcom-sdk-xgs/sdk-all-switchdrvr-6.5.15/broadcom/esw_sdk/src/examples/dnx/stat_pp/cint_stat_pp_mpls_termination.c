/*
 * $Id: cint_stat_pp_mpls_termination.c,v 1.15 2018/08/29 12:39:34 Roy Vardi Exp $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_mpls_termination.c Purpose: Statistics collection on 4 mpls tunnels.
 */
