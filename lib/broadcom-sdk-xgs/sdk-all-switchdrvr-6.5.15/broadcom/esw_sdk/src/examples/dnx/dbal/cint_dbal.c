    ...
    int unit)
{
    ...
    dnx_dbal_entry_value_field_arr32_set(unit, entry_handle_id, "VLAN_EDIT_VID", inst_id, &set_val[4]);
    ...
    */
    ...
    dnx_dbal_entry_handle_value_field_arr32_get(unit, entry_handle_id, "VLAN_EDIT_VID", inst_id, &get_val[4]);
