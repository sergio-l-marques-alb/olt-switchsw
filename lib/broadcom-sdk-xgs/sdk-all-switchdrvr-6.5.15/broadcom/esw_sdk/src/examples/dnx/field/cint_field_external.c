...
cint;
cint_field_external_main(0);
quit;


cint ../../../../src/examples/dnx/field/cint_field_external.c
cint;
cint_field_external_shared_acl_main(0);
quit;
...
uint32 external_fg_payload_offset = 0x20; /** external context 0 total result size */
uint32 external_fg_payload_offset_2 = 0x50; /** external context 0 total result size + FG1 action size */
