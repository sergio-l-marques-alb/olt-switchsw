/*
 * $Id: cint_dnx_ip_tunnel_termination.c, v 1.15 Broadcom SDK $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_dnx_ip_tunnel_termination.c Purpose: Various examples for IPTunnels in Jericho 2.
 */
...
int nof_tunnel_termination_priorities = 6; 
cint_ip_tunnel_termination_priority_info_s cint_ip_tunnel_termination_priorities_info[6] = {
    ...
    int access_port)
{
    ...
    rv = tunnel_terminator_create(unit, &tunnel_intf);
    if (rv != BCM_E_NONE)
    {
    ...
    int access_port)
{
    ...
    int fec_rpf_strict_v4  = 40962;
    int fec_rpf_strict_v6  = 40963;
    bcm_gport_t gport      = 0;
    l3_ingress_intf ingr_itf;
    bcm_if_t tunnel_intf_v4;
    bcm_if_t tunnel_intf_v6;
    ...
    rv = tunnel_terminator_create(unit, &tunnel_intf_v4);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = tunnel_terminator_create(unit, &tunnel_intf_v6);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv4(unit, cint_ip_tunnel_basic_info.route_dip, provider_vrf_v4,
                       cint_ip_tunnel_basic_info.fec_id, 0, 0);
    if (rv != BCM_E_NONE)
    {
        printf("Error, add_host_ipv4, route_dip \n");
    ...
    rv = add_host_ipv4(unit, route_sip_rpf_hit_rif_miss_v4, provider_vrf_v4,
                       cint_ip_tunnel_basic_info.fec_id, 0, 0);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv4(unit, route_sip_rpf_hit_rif_hit_v4, provider_vrf_v4, fec_rpf_strict_v4, 0,0);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip, provider_vrf_v6,
                       cint_ip_tunnel_basic_info.fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv6(unit, route_sip_rpf_hit_rif_miss_v6, provider_vrf_v6,
                       cint_ip_tunnel_basic_info.fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv6(unit, route_sip_rpf_hit_rif_hit_v6, provider_vrf_v6, fec_rpf_strict_v6);
    if (rv != BCM_E_NONE)
    {
        printf("Error, add_host_ipv6, route_sip_rpf_hit_rif_hit_v6 \n");
        return rv;
    }
    rv = vxlan_network_domain_management_l3_ingress(unit, 5000, provider_vrf_v4);
    if (rv != BCM_E_NONE)
    {
        printf("Error, vxlan_network_domain_management_l3_ingress \n");
        return rv;
    }
    rv = vxlan_network_domain_management_l3_ingress(unit, 5001, provider_vrf_v6);
    if (rv != BCM_E_NONE)
    {
        printf("Error, vxlan_network_domain_management_l3_ingress \n");
        return rv;
    ...
    int provider_vrf_strict)
{
    ...
    rv = tunnel_terminator_create(unit, &tunnel_inlif_intf_id_rpf_loose);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error,tunnel_terminator_create \n", proc_name);
        return rv;
    ...
    rv = tunnel_terminator_create(unit, &tunnel_inlif_intf_id_rpf_strict);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error,tunnel_terminator_create \n", proc_name);
        return rv;
    ...
    int rif)
{
    ...
    /** Create the tunnel termination lookup and the tunnel termination inlif */
    rv = tunnel_terminator_create(unit, &tunnel_inlif_intf_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error,tunnel_terminator_create \n", proc_name);
        return rv;
