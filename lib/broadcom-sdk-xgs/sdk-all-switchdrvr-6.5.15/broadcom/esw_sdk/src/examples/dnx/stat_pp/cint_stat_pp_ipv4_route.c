/*
 * $Id: cint_stat_pp_ipv4_route.c,v 1.15 2018/05/28 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_ipv4_route.c Purpose: Statistics examples for SDK ingress APIs using an IPV4 application.
 */
    ...
    int out_port)
{
    ...
    fec_structure.allocation_flags = BCM_L3_WITH_ID;
    fec_structure.flags2 = BCM_L3_FLAGS2_ECMP_RANGE_OVERLAP;
