 ...
 * cint
 * cint_field_inlif_profile_main(0, context_id, inlif, inlif_profile);
 * cint_field_inlif_profile_desrtoy(0,context_id);
 *
 *
 * example of using inPort qualfier which is encoded as GPORT.
 */
