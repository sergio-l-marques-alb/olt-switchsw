 ...
 * cint
 * cint_field_stat_sampling_main(0, context_id, stat_sampling_cmd, stat_sampling_qualifier);
 * cint_field_stat_sampling_qual_main(0,context_id, stat_sampling_cmd, stat_sampling_qualifier)
 * cint_field_stat_sampling_desrtoy(0,context_id_ipmf1,context_id_ipmf3);
 *
 *
