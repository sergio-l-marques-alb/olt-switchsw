 ...
 *
 */
int cint_field_twamp_presel_set(int unit, bcm_field_presel_t presel_id, bcm_field_context_t context_id) {
    int rv = BCM_E_NONE;
 ...
 * \brief
 *
 *  This function sets all required HW configuration for TWAMP reflector over IPv4 for the 1st pass IPMF1.
 *
 * \param [in] unit - The unit number.
 ...
 *
 */
int cint_field_twamp_reflector_1st_pass_set_ipmf1(int unit, bcm_gport_t gport_trap1, uint32 local_ip_addr, uint32 remote_ip_addr) {
    int i, rv = BCM_E_NONE;
    void *dest_char;
    ...
    ent_info.entry_action[2].value[0] = 1; /* Do not decrement the TTL indication */    
 ...
 * \brief
 *
 *  This function sets all required HW configuration for TWAMP reflector over IPv4 for the 1st pass IPMF2.
 *
 * \param [in] unit - The unit number.
 *
 * \return
...
{   int i, rv = BCM_E_NONE;   
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &twamp_reflector_1st_pass_ipmf2_fg_id);
    if (rv != BCM_E_NONE)
    {
 ...
 * \brief
 *
 *  This function sets all required HW configuration for TWAMP reflector over IPv4 for the 2nd pass IPMF1.
 *
 * \param [in] unit - The unit number.
 * \param [in] local_ip_addr - Local ip address.
 * \param [in] remote_ip_addr - Remote ip address.
 ...
 *
 */
int cint_field_twamp_reflector_2nd_pass_set_ipmf1(int unit, uint32 local_ip_addr, uint32 remote_ip_addr) {
    int i, rv = BCM_E_NONE;
	void *dest_char;
    bcm_field_entry_t ent_id;
    bcm_field_group_info_t fg_info;
...
{   int i, rv = BCM_E_NONE;   
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &twamp_reflector_2nd_pass_ipmf2_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error (%d), in bcm_field_group_add ipmf2_fg\n", rv);
        return rv;
 ...
 *
 */
int cint_field_twamp_reflector_rule(int unit, bcm_gport_t gport_trap1, uint32 local_ip_addr, uint32 remote_ip_addr) {
    int rv = BCM_E_NONE;
    ...
    /* Create presel */
    rv = cint_field_twamp_presel_set(unit, ingress_presel_id, twamp_context_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = cint_field_twamp_reflector_1st_pass_set_ipmf1(unit, gport_trap1, local_ip_addr, remote_ip_addr);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = cint_field_twamp_reflector_2nd_pass_set_ipmf1(unit, local_ip_addr, remote_ip_addr);
    if(rv != BCM_E_NONE)
    {
 ...
 *
 */
int cint_field_twamp_rx_set_ipmf1(int unit, bcm_gport_t gport_trap1, uint32 local_ip_addr, uint32 remote_ip_addr) {
    int i, rv = BCM_E_NONE;
    void *dest_char;
    bcm_field_entry_t ent_id;
    bcm_field_group_info_t fg_info;
...
{   int i, rv = BCM_E_NONE;   
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &twamp_rx_ipmf2_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error (%d), in bcm_field_group_add ipmf2_fg\n", rv);
        return rv;
...
int cint_field_twamp_tx_set_ipmf1(int unit, uint32 local_ip_addr, uint32 remote_ip_addr) {
    ...
    ent_info.nof_entry_actions = fg_info.nof_actions;	
    ent_info.entry_action[0].type = fg_info.action_types[0];
    ent_info.entry_action[0].value[0] = 1; /* Do not decrement the TTL indication */  
...
{   int i, rv = BCM_E_NONE;   
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &twamp_tx_ipmf2_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error (%d), in bcm_field_group_add ipmf2_fg\n", rv);
        return rv;
 ...
 *
 */
int cint_field_twamp_tx_rx_rule(int unit, bcm_gport_t gport_trap1, uint32 local_ip_addr, uint32 remote_ip_addr) {
    int rv = BCM_E_NONE;
    bcm_field_context_info_t context_info;
    bcm_field_presel_t ingress_presel_id = 10;
    ...
    rv = cint_field_twamp_rx_set_ipmf1(unit, gport_trap1, local_ip_addr, remote_ip_addr);
    if(rv != BCM_E_NONE)
    {
