  ...
  * cint
  * cint_field_exem_main(unit, stage, context, action_value);
  * exit;
  *
 ...
 * \param [in] action_value - Value to write to action in the entry.
 * \return
 *   int - Error Type
 * \remark
 *   * None
 ...
 *   * None
 */
 int cint_field_exem_main(int unit, bcm_field_stage_t stage, bcm_field_context_t context_id, int action_value)
 {
