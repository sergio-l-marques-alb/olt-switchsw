    ...
    int unit)
{
    ...
    */
    ...
    rv = bcm_field_context_compare_create(unit, 0, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1, 2, &compare_info);
    if (rv != BCM_E_NONE)
    {
       printf("%s Error (%d), in bcm_field_context_compare_create\n", proc_name, rv);
       return rv;
    ...
    */
     ...
     */
    rv = bcm_field_compare_operand_offset_get(unit, 1, bcmFieldCompareOperandFirstKeyNotBigger, &op_offset1);
    if (rv != BCM_E_NONE)
    {
     ...
     * Give the enum value that you want to be compared.
     */
    rv = bcm_field_compare_operand_offset_get(unit, 2, bcmFieldCompareOperandNotEqual, &op_offset2);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_compare_operand_offset_get\n", proc_name, rv);
        return rv;
    ...
    int unit)
{
     ...
     */
    rv = bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1, 2);
    if (rv != BCM_E_NONE)
    {
