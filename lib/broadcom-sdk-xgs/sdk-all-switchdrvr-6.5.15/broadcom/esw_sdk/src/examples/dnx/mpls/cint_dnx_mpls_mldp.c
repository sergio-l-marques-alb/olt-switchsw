 ...
 * cint ../../src/examples/dnx/cint_dnx_mpls_mldp.c
 * cint
    ...
    int access_out_port)
{
    ...
    rv = bcm_multicast_create(unit, BCM_MULTICAST_WITH_ID|BCM_MULTICAST_TYPE_L3|BCM_MULTICAST_INGRESS_GROUP, &cint_mpls_mldp_info.mldp_mc_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_multicast_create(unit, BCM_MULTICAST_WITH_ID|BCM_MULTICAST_TYPE_L3|BCM_MULTICAST_INGRESS_GROUP, &cint_mpls_mldp_info.ipmc_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error, bcm_multicast_create \n");
        return rv;
    ...
    int unit)
{
     ...
     */
    BCM_MULTICAST_L3_SET(l3_mc_id,cint_mpls_mldp_info.ipmc_id);
    rv = add_ipv4_ipmc(unit, cint_mpls_mldp_info.dip, 0xFFFFFFFF, cint_mpls_mldp_info.sip, 0xFFFFFFFF,
                       cint_mpls_mldp_info.mldp_tunnel_intf, cint_mpls_mldp_info.vrf, l3_mc_id, 0,0);
    if (rv != BCM_E_NONE)
    {
