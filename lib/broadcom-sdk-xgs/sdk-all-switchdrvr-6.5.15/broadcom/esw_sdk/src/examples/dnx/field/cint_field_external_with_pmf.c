...
cint;
cint_field_external_pmf_main(0);
quit;
...
uint32 cint_field_external_pmf_payload_offset = 0x60;
...
bcm_field_entry_t cint_field_external_pmf_entry_id = 0;
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    entry_info.entry_qual[1].value[0] = 0x7fffff02;
    ...
    int unit)
{
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &cint_field_external_pmf_fg_id_ipmf2);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_action_create\n", proc_name, rv);
        return rv;
    ...
    attach_info.key_info.qual_info[1].offset = 248-cint_field_external_pmf_payload_offset-cint_field_external_pmf_payload_size;
...
cint_field_external_pmf_main(int unit)
{
    ...
    rv = cint_field_external_pmf_entry_add(unit, cint_field_external_pmf_fg_id, &fg_info);
    if (rv != BCM_E_NONE)
    {
...
cint_field_external_pmf_destroy(int unit)
{
     ...
     */
    rv = bcm_field_entry_delete(unit, cint_field_external_pmf_fg_id, NULL, cint_field_external_pmf_entry_id);
    if (rv != BCM_E_NONE)
    {
