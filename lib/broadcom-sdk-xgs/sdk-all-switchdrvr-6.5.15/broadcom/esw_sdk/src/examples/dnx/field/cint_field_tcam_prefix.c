 ...
 * The FGs both qualify on the given src_ip_val then the first FG (which we're not supposed to hit) has bad_tc_val
...
int field_tcam_prefix_main(int unit, int src_ip_val, int tc_val, int bad_tc_val)
{
