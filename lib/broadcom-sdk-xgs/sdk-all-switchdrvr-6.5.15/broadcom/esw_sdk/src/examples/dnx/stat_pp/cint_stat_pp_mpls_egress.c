/*
 * $Id: cint_stat_pp_mpls_egress.c,v 1.15 2018/06/17 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_stat_pp_mpls_egress.c Purpose: Statistics examples for SDK egress APIs using an mpls encapsulation.
 */
