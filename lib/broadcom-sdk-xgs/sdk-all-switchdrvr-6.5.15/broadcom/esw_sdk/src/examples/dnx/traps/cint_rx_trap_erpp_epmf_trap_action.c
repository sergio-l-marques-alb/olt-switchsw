    ...
    int counter_1_ptr)
{
    ...
    rv = cint_erpp_pmf_trap_action_trap_create_and_set(unit, tc, dp, dest_p, qos_map_id, snoop_profile, mirror_profile, cud, counter_0_profile, counter_1_profile, counter_0_ptr, counter_1_ptr);
    if(rv != BCM_E_NONE)
    {
