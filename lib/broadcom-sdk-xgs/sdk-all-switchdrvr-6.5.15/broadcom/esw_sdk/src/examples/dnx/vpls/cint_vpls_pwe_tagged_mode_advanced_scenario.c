/*
 * $Id: cint_vpls_pwe_tagged_mode_advanced_scenario.c, Exp $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_vpls_pwe_tagged_mode_advanced_scenario.c Purpose: basic example for VPLS. PWE tagged mode operations
 */
 ...
 * cint ../../../../src/examples/sand/cint_vpls_pwe_tagged_mode_advanced_scenario.c
 * cint ../../../../src/examples/sand/utility/cint_sand_utils_vlan_translate.c
 * cint
 * int unit = 0;
 * int rv = 0;
 * int access_ports = 200, 201,202
 * int core_port = 203;
    ...
    int unit)
{
    ...
    rv = vpls_pwe_tagged_mode_advanced_scenario_in_port_intf(unit,
                                                             ...
                                                             [0],
                                                             cint_vpls_pwe_tagged_mode_advanced_scenario_info.service_vsi
                                                             [0]);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = in_port_intf_set(unit, cint_vpls_pwe_tagged_mode_advanced_scenario_info.access_port[1],
    ...
    rv = in_port_intf_set(unit, cint_vpls_pwe_tagged_mode_advanced_scenario_info.access_port[2],
                                  300);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in_port_intf_set intf_in\n");
    ...
    rv = in_port_intf_set(unit, cint_vpls_pwe_tagged_mode_advanced_scenario_info.access_port[0], ac_intf);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in_port_intf_set intf_in\n");
        return rv;
    ...
    int unit)
{
    ...
    bcm_mpls_port_t_init(&mpls_port);
    mpls_port.flags |= BCM_MPLS_PORT_WITH_ID | BCM_MPLS_PORT_SERVICE_TAGGED | BCM_MPLS_PORT_EGRESS_TUNNEL;
    mpls_port.flags2 |= BCM_MPLS_PORT2_INGRESS_ONLY | BCM_MPLS_PORT2_INTERFACE_NAMESPACE |
