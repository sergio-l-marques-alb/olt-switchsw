 ...
 * cint ../../../../src/examples/sand/cint_vpls_pwe_tagged_mode_basic.c
    ...
    bcm_vpn_t vpn)
{
    ...
    mpls_port.flags2 |= BCM_MPLS_PORT2_INGRESS_ONLY | BCM_MPLS_PORT2_INTERFACE_NAMESPACE | (vpn ? 0 : BCM_MPLS_PORT2_CROSS_CONNECT);
    ...
    int core_port)
{
    ...
    rv = vpls_pwe_tagged_mode_add_network_native_ac(unit, cint_vpls_pwe_tagged_mode_basic_info.service_vsi,
                                                    ...
                                                    cint_vpls_pwe_tagged_mode_basic_info.access_port, 1, FALSE, FALSE);
    if (rv != BCM_E_NONE)
    {
    ...
    int ingress_ac_native_wide_data_enable)
{
    ...
    rv = vpls_pwe_tagged_mode_add_network_native_ac(unit, cint_vpls_pwe_tagged_mode_basic_info.service_vsi,
                                                    ...
                                                    ingress_ac_native_wide_data_enable, FALSE);
    if (rv != BCM_E_NONE)
    {
        printf("Error(%d), in vpls_pwe_tagged_mode_add_network_native_ac\n", rv);
        return rv;
    ...
    int core_port)
{
    ...
    rv = vpls_pwe_tagged_mode_add_network_native_ac(unit, cint_vpls_pwe_tagged_mode_basic_info.service_vsi,
                                                    ...
                                                    cint_vpls_pwe_tagged_mode_basic_info.ingress_canonical_outer_vlan,
                                                    cint_vpls_pwe_tagged_mode_basic_info.ingress_canonical_inner_vlan,
                                                    cint_vpls_pwe_tagged_mode_basic_info.access_port, 1, FALSE, TRUE);
    if (rv != BCM_E_NONE)
    {
        printf("Error(%d), in vpls_pwe_tagged_mode_add_network_native_ac\n", rv);
        return rv;
    ...
    int ingress_ac_native_wide_data_enable)
{
    ...
    rv = vpls_pwe_tagged_mode_add_network_native_ac(unit, cint_vpls_pwe_tagged_mode_basic_info.service_vsi,
                                                    ...
                                                    cint_vpls_pwe_tagged_mode_basic_info.ingress_canonical_inner_vlan,
                                                    cint_vpls_pwe_tagged_mode_basic_info.access_port, 0,
                                                    ingress_ac_native_wide_data_enable, TRUE);
    if (rv != BCM_E_NONE)
    {
        printf("Error(%d), in vpls_pwe_tagged_mode_add_network_native_ac\n", rv);
        return rv;
