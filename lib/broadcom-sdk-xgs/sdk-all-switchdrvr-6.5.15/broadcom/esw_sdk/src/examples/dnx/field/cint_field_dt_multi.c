 ...
 *                  - bcmFieldQualifyInPort - Meta data
...
int Cint_field_dt_multi_fg1_const_qual_value = 0x1;
int Cint_field_dt_multi_fg2_const_qual_value = 0x2;
    ...
    cint_field_dt_multi_fg_info_t * dt_fg_info)
{
    ...
    if (field_stage == bcmFieldStageEgress)
    {
        ...
        fg_info.qual_types[1] = bcmFieldQualifyVlanPri;
    }
    else
    {
