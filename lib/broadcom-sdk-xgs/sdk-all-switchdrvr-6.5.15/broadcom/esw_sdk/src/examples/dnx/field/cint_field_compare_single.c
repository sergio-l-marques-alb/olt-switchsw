 ...
 * cint_reset();                                                          
 * exit; 
 * cint ../../../src/examples/dnx/field/cint_field_compare.c
 * cint
...
bcm_field_action_t Cint_field_compare_action_void;
bcm_field_group_t Cint_field_compare_fg_id_ipmf1;
bcm_field_group_t Cint_field_compare_fg_id_ipmf2;
bcm_field_entry_t Cint_field_compare_ipmf1_entry_id;
/**
 ...
 */
bcm_field_entry_t Cint_field_compare_ipmf2_entry_id_arr[Cint_field_compare_nof_entries] = {
       0,
       0
};
    ...
    bcm_field_context_t * context_id_p)
{
    ...
    */
     ...
     */
    rv = bcm_field_context_compare_create(unit, 0, stage, *context_id_p, 1, &compare_info);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_context_create\n", proc_name, rv);
        return rv;
 ...
 * If it is set to 1 the TCAM B is allocated.
 * If it is set to 2 the TCAM D is allocated.
 *
 *
 * \return
 *  int - Error Type, in sense of bcm_error_t
 ...
 */
int static
cint_field_compare_fg_config_ipmf1(
    int unit,
    bcm_field_context_t * context_id_p,
    int compare_id)
{
    ...
    int rv = BCM_E_NONE;
    proc_name = "cint_field_compare_fg_config_ipmf1";
    /**
    ...
    rv = bcm_field_action_create(unit, 0, &action_info, &Cint_field_compare_action_void);
    if(rv != BCM_E_NONE)
    {
    ...
    fg_info.action_types[0] = Cint_field_compare_action_void;
     ...
     */
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &Cint_field_compare_fg_id_ipmf1);
    if (rv != BCM_E_NONE)
    {
    ...
    attach_info.key_info.qual_types[0] = bcmFieldQualifyL4SrcPort;
    ...
    attach_info.payload_info.action_types[1] = bcmFieldActionPrioIntNew;
    attach_info.payload_info.action_types[0] = Cint_field_compare_action_void;
    /**
     * The compare_id must be equal to the pair ID.
     * If compare_id is equal to 1 we are comparing to the key B result.
     * If compare_id is equal to 2 we are comparing to the key D result.
     */
    attach_info.compare_id = compare_id;
    /**
     * Attach the FG to the context.
     */
    rv = bcm_field_group_context_attach(unit, 0, Cint_field_compare_fg_id_ipmf1, Cint_field_compare_context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
    ...
    entry_info.entry_qual[0].type = bcmFieldQualifyL4SrcPort;
    entry_info.entry_qual[0].value[0] = Cint_field_compare_single_src_qual_value;
    entry_info.entry_qual[0].mask[0] = 0xFFFF;
    entry_info.entry_action[0].type = Cint_field_compare_action_void;
    entry_info.entry_action[0].value[0] = Cint_field_compare_single_tcam0_qual_value;

    /**
     * Add an entry to the FG
     */
    rv = bcm_field_entry_add(unit, 0, Cint_field_compare_fg_id_ipmf1, &entry_info, Cint_field_compare_ipmf1_entry_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_entry_add entry_id(%d)\n", rv, Cint_field_compare_ipmf1_entry_id);
        return rv;
    }
return rv;
}
 ...
 * The bits in the bcmFieldQualifyCompareKeysTcam0 qualifier are how it follows:
 *
 ...
 */
int static
cint_field_compare_fg_config_ipmf2(
    int unit,
    bcm_field_context_t * context_id_p)
{
    bcm_field_group_info_t fg_info;
    ...
    int rv = BCM_E_NONE;
    proc_name = "cint_field_compare_fg_config_ipmf2";
    /**
     * Init the fg_info structure.
     */
    bcm_field_group_info_t_init(&fg_info);
    ...
    fg_info.qual_types[4] = bcmFieldQualifyRangeCheck;
     ...
     * Create FG without ID
     */
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &Cint_field_compare_fg_id_ipmf2);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_group_add\n", proc_name, rv);
        return rv;
    ...
    attach_info.key_info.qual_types[0] = bcmFieldQualifyCompareKeysTcam0;
    ...
    attach_info.key_info.qual_types[4] = bcmFieldQualifyRangeCheck;
     ...
     * Attach the FG to the context.
     */
    rv = bcm_field_group_context_attach(unit, 0, Cint_field_compare_fg_id_ipmf2, Cint_field_compare_context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_group_context_attach\n", proc_name, rv);
        return rv;
    ...
    entry_info.nof_entry_actions = 1;
    entry_info.priority = 1;
    entry_info.entry_qual[0].type = bcmFieldQualifyCompareKeysTcam0;
     ...
     * Add an entry to the FG
     */
    rv = bcm_field_entry_add(unit, 0, Cint_field_compare_fg_id_ipmf2, &entry_info, &Cint_field_compare_ipmf2_entry_id_arr[0]);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_entry_add entry_id(%d)\n", rv, Cint_field_compare_ipmf2_entry_id_arr[0]);
        return rv;
    }
    /**
     ...
     * Add an entry to the FG
     */
    rv = bcm_field_entry_add(unit, 0, Cint_field_compare_fg_id_ipmf2, &entry_info, &Cint_field_compare_ipmf2_entry_id_arr[1]);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_entry_add entry_id(%d)\n", rv, Cint_field_compare_ipmf2_entry_id_arr[1]);
        return rv;
    }
    ...
    int compare_id)
{
    ...
    int rv = BCM_E_NONE;
    proc_name = "cint_field_compare_single_1pair_main";
    /**
    ...
    rv = cint_field_compare_fg_config_ipmf1(unit, Cint_field_compare_context_id, compare_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_compare_fg_config_ipmf1 \n", proc_name, rv);
        return rv;
    }
    /**
     * Create TCAM Fg and Attach it to the context.
    ...
    rv = cint_field_compare_fg_config_ipmf2(unit, Cint_field_compare_context_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_compare_fg_config_ipmf2 \n", proc_name, rv);
        return rv;
    }
    return rv;
    ...
    int unit)
{
    ...
    */
    rv = bcm_field_entry_delete(unit, Cint_field_compare_fg_id_ipmf1, NULL, Cint_field_compare_ipmf1_entry_id);
    if (rv != BCM_E_NONE)
    {
     ...
     * Detach the context
     */
    rv = bcm_field_group_context_detach(unit, Cint_field_compare_fg_id_ipmf1, Cint_field_compare_context_id);
    if (rv != BCM_E_NONE)
    {
     ...
     * Delete the FG
     */
    rv = bcm_field_group_delete(unit, Cint_field_compare_fg_id_ipmf1);
    if (rv != BCM_E_NONE)
    {
    ...
    */
    ...
    {
        rv = bcm_field_entry_delete(unit, Cint_field_compare_fg_id_ipmf2, NULL, Cint_field_compare_ipmf2_entry_id_arr[entry_iterator]);
        if (rv != BCM_E_NONE)
        {
     ...
     * Detach the context
     */
    rv = bcm_field_group_context_detach(unit, Cint_field_compare_fg_id_ipmf2, Cint_field_compare_context_id);
    if (rv != BCM_E_NONE)
    {
     ...
     * Delete the FG
     */
    rv = bcm_field_group_delete(unit, Cint_field_compare_fg_id_ipmf2);
    if (rv != BCM_E_NONE)
    {
     ...
     */
    rv = bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_context_id, 1);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_action_destroy(unit, Cint_field_compare_action_void);
    if (rv != BCM_E_NONE)
    {
