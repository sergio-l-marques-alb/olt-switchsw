    ...
    vlan_translate_tpid_from_packet_s * param)
{
     ...
     */
     ...
     tpid_info.tpid_value = g_vlan_translate_tpid_from_packet.tpid_value.packet_s_tag;
     ...
     tpid_info.tpid_value = g_vlan_translate_tpid_from_packet.tpid_value.packet_c_tag;
     rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
     if (rv != BCM_E_NONE)
     {
         printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     tpid_info.tpid_value = g_vlan_translate_tpid_from_packet.tpid_value.ingress_outer_tpid;
     rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
     if (rv != BCM_E_NONE)
     {
         printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     tpid_info.tpid_value = g_vlan_translate_tpid_from_packet.tpid_value.ingress_inner_tpid ;
     rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
     if (rv != BCM_E_NONE)
     {
         printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     tpid_info.tpid_value = g_vlan_translate_tpid_from_packet.tpid_value.egress_outer_tpid;
     rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
     if (rv != BCM_E_NONE)
     {
         printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     tpid_info.tpid_value = g_vlan_translate_tpid_from_packet.tpid_value.egress_inner_tpid ;
     rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
     if (rv != BCM_E_NONE)
     {
         printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
