    ...
    int unit)
{
    ...
    rv = cint_field_compare_full_offset_get_fg_config(unit, Cint_field_compare_full_offset_get_context_id, 1);
    if (rv != BCM_E_NONE)
    {
    ...
    int unit)
{
    ...
    */
     ...
     */
    rv = bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_full_offset_get_context_id, 1);
    if (rv != BCM_E_NONE)
    {
