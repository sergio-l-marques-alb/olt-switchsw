 ...
 * rv = vxlan_tunnel_termination_tcam(unit, core_port, virtual_machine_port);
 * print rv;
 *
 * Traffic:
 *
...
cint_vxlan_tunnel_basic_info_s cint_vxlan_tunnel_basic_info = {
     ...
     * route DIP
     */
    0xA9000001 /* 172.0.0.1 */ ,
    /*
     * route DIP
     */
    0xA9000002 /* 172.0.0.1 */ ,
    /*
     * route DIP mask
     */
    0xffffffff,
    ...
    int unit)
{
    ...
    if (rv != BCM_E_PARAM)
    {
        printf("Error in bcm_vxlan_vpn_destroy, entry should be created from bcm_vxlan_network_domain_config_add API");
        return BCM_E_PARAM;
    }
