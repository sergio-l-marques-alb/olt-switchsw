 ...
 *  - cint_ip_route_basic.c cint_sand_utils_vpws.c                                                                                                  *
 *  - cint_advanced_vlan_translation_mode.c                                                                                                         * 
 * cint                                                                                                                                             *
 * int unit = 0;                                                                                                                                    *
 * vswitch_cross_connect_p2p_ac_pwe_with_ports__main_config__start_run(int unit, int port1, int port2, int port3, int port4)                        * 
 * To Check AC to AC:                                                                                                                               *
 *      int scenario = 1                                                                                                                            *
    ...
    vswitch_cross_connect_p2p_ac_pwe_s * param)
{
    ...
    cint_pwe_basic_info.mpls_encap_fec_id = 50007;
    cint_pwe_basic_info.pwe_intf_mac_address = sa;
