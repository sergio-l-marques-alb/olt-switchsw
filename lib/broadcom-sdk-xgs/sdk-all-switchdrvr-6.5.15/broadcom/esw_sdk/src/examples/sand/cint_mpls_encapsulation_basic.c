 ...
 * int in_port = 200; 
 * int out_port = 201;
 * rv = mpls_encapsulation_basic_main(unit,in_port,out_port);
 * print rv; 
 * 
 * 
    ...
    int unit)
{
    ...
    ingr_itf.qos_map = cint_mpls_encapsulation_basic_info.ingress_qos_profile;
    ...
    int unit)
{
    ...
    rv = l3__egress_only_fec__create(unit, cint_mpls_encapsulation_basic_info.fec_id_enc,
                                     ...
                                     cint_mpls_encapsulation_basic_info.out_port, 0);
    if (rv != BCM_E_NONE)
    {
