 ...
 * For Details please refer testplan in the following path                                                                                          *
 *      depot2/Jericho2/A0/docs/verification/PP/AV/Bridge_Test_plan.xlsx                                                                            *
 *                                                                                                                                                  *
 *                                                                                                                                                  * 
...
int l2_basic_bridge_run(int unit,  l2_basic_bridge_s *param,int step){
    ...
    if (step == 5) {
        l2_addr.modid = g_l2_basic_bridge.outer_vid;
    }
    ...
    /* Learning enable for steps 12-15 */
    if ((step == 12) || (step == 13)) {
