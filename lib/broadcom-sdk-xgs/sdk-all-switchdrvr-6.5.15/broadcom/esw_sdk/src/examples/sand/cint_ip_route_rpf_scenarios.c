...
int ipv4_mc_example_rpf(int unit, int in_port, int out_port,int nof_dest_ports)
{
    ...
    if (is_device_or_above(unit, JERICHO2)) {
        ...
        mreps[0] = 0;
        mreps[1] = 1;
        rv = bcm_fabric_multicast_set(0, ipmc_index, 0, 2, mreps);
        if (rv != BCM_E_NONE) {
    ...
    replications.encap1 = vlan_r;
    replications.port = out_port;
    rv = bcm_multicast_set(unit, ipmc_index, flags, 1, &replications);
    if (rv != BCM_E_NONE)
    {
    ...
    sand_utils_l3_route_ipv4_s_common_init(unit, 0, &route_ipv4_structure, subnet_l, subnet_l_mask, vrf, 0, 0, fec[eg_itf_index]);
 ...
 * cint ../../src/examples/sand/cint_ip_route_rpf_scenarios.c
 * cint
 * l3_dpp_uc_rpf_config(units_ids,1,bcmL3IngressUrpfLoose); /* Relevant only for DPP, not valid for JR2 */
 * exit;
 *
 * cint
 * example_rpf_ipv6(units_ids,1,1811939528,1811939529,bcmL3IngressUrpfLoose);
 * exit;
 *
 * tx 1 psrc=200 data=0x0000000200010000070001008100000a86dd608000100014060a05000500000000000000000000000123020002000000000000000000000001353344556600a1a2a300b1b2b3500f01f5be350000
 *
 *    Received packets on unit 0 should be:
 *
 * tx 1 psrc=200 data=0x0000000200010000070001008100000a86dd608000100014060a02000200000000000000000000000110020002000000000000000000000001353344556600a1a2a300b1b2b3500f01f5c4480000
 *
 *    Received packets on unit 0 should be:
 *    Source port: 0, Destination port: 0
 *    Data: 
 *
 * tx 1 psrc=200 data=0x0000000200010000070001008100000a86dd608000100014060a01000100000000000000000000000123020002000000000000000000000001353344556600a1a2a300b1b2b3500f01f5c6350000
 *
 *    Received packets on unit 0 should be:
 *    Source port: 0, Destination port: 0
 *    Data: 
 *
 * cint ../../src/examples/dpp/utility/cint_utils_global.c
 * cint ../../src/examples/sand/utility/cint_sand_utils_l3.c
 * cint ../../src/examples/sand/cint_ip_route_basic.c
 ...
 * cint ../../src/examples/sand/cint_ip_route_rpf_scenarios.c
 * cint
 * l3_dpp_uc_rpf_config(units_ids,1,bcmL3IngressUrpfStrict); /* Relevant only for DPP, not valid for JR2 */
 * exit;
 *
 */
int
    ...
    bcm_l3_ingress_urpf_mode_t urpf_mode)
{
    ...
    for (i = 0 ; i < nof_units ; i++){
        ...
        encoded_fec[0] = l3_fec.l3eg_fec_id;
        if(verbose >= 1) {
    ...
    for (i = 0 ; i < nof_units ; i++){
        ...
        encoded_fec[1] = l3_fec.l3eg_fec_id;
        if(verbose >= 1) {
            printf("created FEC-id =0x%08x, \n", encoded_fec[1]);
            printf("next hop mac at encap-id %08x, \n", l3_arp.l3eg_arp_id);
        }
    ...
    /* IPuc add routes/host to Routing table: from L to R*/
    {
        ...
        for (i = 0 ; i < nof_units ; i++){
            ...
            sand_utils_l3_host_ipv6_s_common_init(unit, 0, &host_ipv6_structure, host_r, vrf, 0, 0, encoded_fec[0]);
            ...
            if (is_device_or_above(unit, JERICHO) && !is_device_or_above(unit, JERICHO2) &&
                ...
                sand_utils_l3_route_ipv6_s_common_init(unit, 0, &route_ipv6_structure, host_r, mask_r, vrf, 0, BCM_L3_FLAGS2_SCALE_ROUTE, encoded_fec[0]);
        ...
        for (i = 0 ; i < nof_units ; i++){
            unit = units_ids[i];
            sand_utils_l3_route_ipv6_s_common_init(unit, 0, &route_ipv6_structure, host_r, mask_r, vrf, 0, 0, encoded_fec[0]);
            rv = sand_utils_l3_route_ipv6_add(unit, &route_ipv6_structure);
            if (rv != BCM_E_NONE)
            {
                printf("Error, in function sand_utils_l3_route_ipv6_add, \n");
            ...
            if(verbose >= 1) {
                ...
                printf("---> egress-object=0x%08x, outRIF=0x%08x, port=%d, \n", encoded_fec[0], ing_intf_r, out_sysport);
            }
        }
        ...
        for (i = 0 ; i < nof_units ; i++){
            ...
            sand_utils_l3_host_ipv6_s_common_init(unit, 0, &host_ipv6_structure, host_l, vrf, 0, 0, encoded_fec[1]);
            rv = sand_utils_l3_host_ipv6_add(unit, &host_ipv6_structure);
            if (rv != BCM_E_NONE)
            {
                printf("Error, in function sand_utils_l3_host_ipv6_add, \n");
            ...
            if (is_device_or_above(unit, JERICHO) && !is_device_or_above(unit, JERICHO2) &&
                ((soc_property_get(unit, spn_ENHANCED_FIB_SCALE_PREFIX_LENGTH_IPV6_LONG, 0)) ||
                 (soc_property_get(unit, spn_ENHANCED_FIB_SCALE_PREFIX_LENGTH_IPV6_SHORT, 0)))) {
                sand_utils_l3_route_ipv6_s_common_init(unit, 0, &route_ipv6_structure, host_l, mask_l, vrf, 0, BCM_L3_FLAGS2_SCALE_ROUTE, encoded_fec[1]);
                rv = sand_utils_l3_route_ipv6_add(unit, &route_ipv6_structure);
                if (rv != BCM_E_NONE)
                {
                    printf("Error, in function sand_utils_l3_route_ipv6_add, \n");
            ...
            if(verbose >= 1) {
                ipv6_print(host_l);
                printf("---> egress-object=0x%08x, outRIF=0x%08x, port=%d, vrf=%d\n", encoded_fec[1], ing_intf_l, in_sysport, vrf);
            }
        }
        ...
        for (i = 0 ; i < nof_units ; i++){
            unit = units_ids[i];
            sand_utils_l3_route_ipv6_s_common_init(unit, 0, &route_ipv6_structure, host_l, mask_l, vrf, 0, 0, encoded_fec[1]);
            rv = sand_utils_l3_route_ipv6_add(unit, &route_ipv6_structure);
            if (rv != BCM_E_NONE)
            {
                printf("Error, in function sand_utils_l3_route_ipv6_add, \n");
            ...
            if(verbose >= 1) {
                ...
                printf("---> egress-object=0x%08x, outRIF=0x%08x, port=%d, \n", encoded_fec[1], ing_intf_l, in_sysport);
            }
        }
    }
    return rv;
...
int example_rpf_vrf(int *units_ids, int nof_units, int in_sysport, int out_sysport, bcm_l3_ingress_urpf_mode_t urpf_mode, int vrf){
    ...
    for (i = 0 ; i < nof_units ; i++){
        ...
        if(sysport_is_local == 1) {
            ...
            rv = bcm_vlan_gport_add(unit, vlan_r, in_sysport, 0);
            if (rv != BCM_E_NONE && rv != BCM_E_EXISTS) {
                printf("fail add port(0x%08x) to vlan(%d)\n", out_sysport, vlan_r);
                return rv;
            }
   ...
   for (i = 0 ; i < nof_units ; i++){
      unit = units_ids[i];
      sand_utils_l3_route_ipv4_s_common_init(unit, 0, &route_ipv4_structure, subnet_l, subnet_l_mask, vrf, 0, 0, encoded_fec[unit][1]);
      rv = sand_utils_l3_route_ipv4_add(unit, &route_ipv4_structure);
      if (rv != BCM_E_NONE)
      {
          printf("Error, in function sand_utils_l3_route_ipv4_add, \n");
      ...
      if (L3_rpf_default_fec_enable) {
          ...
          sand_utils_l3_route_ipv4_s_common_init(unit, 0, &route_ipv4_structure, 0, 0, vrf, 0, 0, encoded_fec[unit][1]);
          rv = sand_utils_l3_route_ipv4_add(unit, &route_ipv4_structure);
          if (rv != BCM_E_NONE)
          {
              printf("Error, in function sand_utils_l3_route_ipv4_add, \n");
...
int bcm_l3_ip6_mc_rpf(int unit, int port0, int port1, int port2, int port3) {
    ...
    if (is_device_or_above(unit, JERICHO2)) {
        ipmc_index_offset = soc_property_get(unit, spn_MULTICAST_NOF_EGRESS_BITMAP, 8192);
        ipmc_index_upper_bound = soc_property_get(unit, spn_MULTICAST_INGRESS_GROUP_ID_RANGE_MAX, 65535);
    } else {
