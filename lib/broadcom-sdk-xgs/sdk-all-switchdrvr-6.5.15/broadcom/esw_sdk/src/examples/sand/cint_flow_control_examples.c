 ...
 *
 * 2. Global resource -> OOB generation
 *                10G                            Loopback                1G(10%)
 ...
 *        cint> int priority=0;
 *        cint> int global_thr =0x7f0000;
 *        cint> rv = cint_test_fc_gen_gl_oob_set_example(unit,oob_port_tx,calander_index,priority,global_thr);
...
/* This function configures global VSQ to OOB generation according to threshold
...
*/
int cint_test_fc_gen_gl_oob_set_example(int unit, global_vsq_src_e global_vsq_src, int oob_port,
                                        int oob_calendar_idx, int priority, int global_thr)
{
    int rv = BCM_E_NONE;
    int flags = 0;
    bcm_cosq_fc_endpoint_t fc_trigger;
    ...
    rv = bcm_cosq_fc_path_add(unit, bcmCosqFlowControlGeneration, &fc_trigger, &fc_handler);
    if (rv != BCM_E_NONE) {
        printf("oob fc generation configuration failed(%d) in cint_test_fc_gen_gl_oob_set_example\n", rv);
        return rv;
    }
...
/*    Reset global resource to OOB generation    */
int cint_test_fc_gen_gl_oob_unset_example(int unit, global_vsq_src_e global_vsq_src, int oob_port, int oob_calendar_idx, int priority)
{
    int rv = BCM_E_NONE;
    int flags = 0;
    bcm_cosq_fc_endpoint_t fc_trigger;
    ...
    rv = bcm_cosq_fc_path_delete(unit, bcmCosqFlowControlGeneration, &fc_trigger, &fc_handler);
    if (rv != BCM_E_NONE) {
        printf("oob fc generation configuration failed(%d) in cint_test_fc_gen_gl_oob_unset_example\n", rv);
        return rv;
    }
...
/* set fc reception(an rx slot on OOB) and fc target(interface) */
int cint_test_fc_rcv_oob_intf_set_example(int unit, int target_port, int oob_port, int oob_calendar_idx)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_add(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_oob_intf_set_example\n", rv);
    }

    return rv;
}

/* Unset oob -> interface receive */
int cint_test_fc_rcv_oob_intf_unset_example(int unit, int target_port, int oob_port, int oob_calendar_idx)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_oob_intf_unset_example\n", rv);
    }
...
/* set fc reception(an rx slot on OOB) and fc target(a port) */
int cint_test_fc_rcv_oob_port_set_example(int unit, int target_port, int oob_port, int oob_calendar_idx)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_add(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_oob_port_set_example\n", rv);
    }

    return rv;
}

/* Unset oob -> port receive */
int cint_test_fc_rcv_oob_port_unset_example(int unit, int target_port, int oob_port, int oob_calendar_idx)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_delete(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_oob_port_unset_example\n", rv);
    }

    return rv;
}

/* set fc reception(an rx slot on OOB) and fc target(port + cosq) */
int cint_test_fc_rcv_oob_port_cosq_set_example(int unit, int target_port, int oob_port, int oob_calendar_idx, int target_cosq)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_add(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_oob_port_cosq_set_example\n", rv);
    }

    return rv;
}

/* Unset oob -> port+cosq receive */
int cint_test_fc_rcv_oob_port_cosq_unset_example(int unit, int target_port, int oob_port, int oob_calendar_idx, int target_cosq)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_delete(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_oob_port_cosq_unset_example\n", rv);
    }
...
/*
 * set fc reception(an rx slot on OOB) and fc target(traffic specified by bitmap)
 * flags can be one of below:
 *    BCM_COSQ_FC_INHERIT_UP
 *    BCM_COSQ_FC_INHERIT_DOWN
 *    BCM_COSQ_FC_PORT_OVER_PFC
 */
int cint_test_fc_rcv_oob_bitmap_set_example(int unit, int target_port, int oob_port, int oob_calendar_idx, int target_cosq, int flags)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_add(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_pfc_oob_bitmap_set_example\n", rv);
    }

    return rv;
}

/* Unset oob -> generic bitmap receive */
int cint_test_fc_rcv_oob_bitmap_unset_example(int unit, int target_port, int oob_port, int oob_calendar_idx, int target_cosq, int flags)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
    ...
    rv = bcm_cosq_fc_path_delete(unit, bcmCosqFlowControlReception, &fc_reception, &fc_target);
    if (rv != BCM_E_NONE) {
        printf("oob fc reception configuration failed(%d) in cint_test_fc_rcv_pfc_oob_bitmap_unset_example\n", rv);
    }
