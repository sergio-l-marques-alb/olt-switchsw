...
/* $Id: cint_sand_mpls_check_ver.c,v 1.0 2018/04/10 08:05:38 Jingli Guo $
 ...
 *      BCM> cint src/examples/sand/cint_ip_route_basic.c
 *      BCM> cint src/examples/sand/utility/cint_sand_utils_mpls.c
 *      BCM> cint src/examples/sand/utility/cint_sand_utils_l3.c
 *      BCM> cint src/examples/dnx/utility/cint_dnx_utils_vpls.c
 *      BCM> cint src/examples/sand/cint_sand_mpls_check_ver.c
 *      BCM> cint
 *      cint> print mpls_check_ver_example(0, in_port, out_port);
 * 
