 ...
 struct cint_multi_dev_mpls_lsr_info_s
{
    ...
    int outgoing_label[4];               /* Outgoing mpls label */
    ...
    int out_sys_port)
{
    ...
    if (is_device_or_above(ingress_unit, JERICHO2)) {
       ...
       BCM_L3_ITF_SET(cint_mpls_lsr_info.fec_id_for_eei_push_cmd, BCM_L3_ITF_TYPE_FEC, 0xa000);
       BCM_L3_ITF_SET(cint_mpls_lsr_info.fec_id_for_eei_pointer, BCM_L3_ITF_TYPE_FEC, 0xa001);
       BCM_L3_ITF_SET(cint_mpls_lsr_info.fec_id_for_eei_swap_cmd, BCM_L3_ITF_TYPE_FEC, 0xa002);
    } else {
