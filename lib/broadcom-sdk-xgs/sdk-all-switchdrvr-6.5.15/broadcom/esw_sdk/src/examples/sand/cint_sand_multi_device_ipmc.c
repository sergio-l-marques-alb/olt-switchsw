...
{
    int rv = BCM_E_NONE;
    int create_flags = BCM_MULTICAST_WITH_ID|BCM_MULTICAST_TYPE_L3;
    int ingress_create_flags = BCM_MULTICAST_WITH_ID|BCM_MULTICAST_TYPE_L3;
    int egress_create_flags = BCM_MULTICAST_WITH_ID|BCM_MULTICAST_TYPE_L3;
    int set_flags = 0;
    int mcdb_unit = 0;
    ...
    */
    if (mc_mode == 1) {
        ...
        if (mc_mode == 3) {
            ...
            bcm_fabric_multicast_set(fe_unit, fe_mc_id, 0, 2, dest_fap_id);
        }
        ...
        if (mc_mode == 2) {
            ...
            BCM_MULTICAST_L3_SET(mc_id_idx,mc_group);
    ...
    int out_sys_port)
{
    ...
    rv = add_ipv4_ipmc(ingress_unit, cint_ipmc_route_info.mc_group_ip, 0xFFFFFFFF, cint_ipmc_route_info.host_ip, 0xFFFFFFFF,
                       cint_ipmc_route_info.in_rif, cint_ipmc_route_info.vrf, l3_mc_id, 0, 0);
    if (rv != BCM_E_NONE)
    {
