...
{   
    ...
    if (is_device_or_above(unit, JERICHO2))
    {
        for (tunnel_idx = 0; tunnel_idx < ip_tunnel_basic_info.nof_tunnels; tunnel_idx++)
        {
            ...
            ip_tunnel_basic_info.encap_fec_id[tunnel_idx] += 61000;
            ip_tunnel_basic_info.encap_native_fec_id[tunnel_idx] += 40000;
            ip_tunnel_basic_info.term_fec_id[tunnel_idx] += 40000;
        }
