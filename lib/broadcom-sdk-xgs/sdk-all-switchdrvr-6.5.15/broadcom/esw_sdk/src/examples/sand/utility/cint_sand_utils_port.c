                             ...
                             int hp_pcp, int high_priority, uint32 tpid, uint32 header)
{
    ...
    */
    ...
    } else if ((info.device == 0x8680 && header == 3) || (info.device == 0x8690 && header == 3)) {
    ...
    } else if ((info.device == 0x8680 && header == 4) || (info.device == 0x8690 && header == 4)) {
                             ...
                             uint32 lp_match_key, uint32 hp_match_key, uint32 offset)
{
    ...
    if (!(is_dnx || is_jer_plus)) {
        printf("NIF PRD Soft Stage is supported only for Jer plus or Jer2 and above! \n", rv);
