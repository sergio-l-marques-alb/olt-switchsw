...
{
    int rv;
    int fec = cint_rpf_route_info.fec_id;           /* 32769=32*1024+1*/
    int fec_rpf_loose = fec + 2;       /* 32769=32*1024+3*/
    int fec_rpf_strict = fec + 4;       /* 32769=32*1024+3*/
    int fec_rpf_strict_kaps = fec + 6;  /* 32775=32*1014+7*/
    int fec_rpf_strict_kaps_default_route = fec + 8;  /* 32776=32*1014+9*/
    ...
    int vpbr_enabled)
{
    int rv;
    int fec = cint_rpf_route_info.fec_id;           /* 32769=32*1024+1*/
    int fec_rpf_loose = fec + 2;       /* 32771=32*1024+3*/
    int fec_rpf_strict = fec + 4;       /* 32773=32*1024+3*/
    int fec_rpf_strict_kaps = fec + 6;  /* 32775=32*1014+7*/
    int fec_rpf_strict_kaps_default_route = fec + 8;  /* 32777=32*1014+9*/
    int updated_vrf_loose = vrf_loose;
    int updated_vrf_strict = vrf_strict;
    bcm_gport_t gport = 0;
