...
int l2_pp_lag_property_set (int unit, int trunk_gport) {
    ...
    rv = bcm_instru_gport_control_set(unit, trunk_gport, BCM_INSTRU_CONTROL_FLAG_DIRECTION_EGRESS, bcmInstruGportControlVisEnable, 1);
    if (rv != BCM_E_NONE) {
        printf("Error, in bcm_instru_gport_control_set\n");
        return rv;
    }
    ...
    rv = bcm_instru_gport_control_set(unit, trunk_gport, BCM_INSTRU_CONTROL_FLAG_DIRECTION_EGRESS, bcmInstruGportControlVisForce, 1);
    if (rv != BCM_E_NONE) {
        printf("Error, in bcm_instru_gport_control_set\n");
        return rv;
    }
