 ...
 */
void
l2_basic_bridge_modify_struct_get(
    int unit,
    l2_basic_bridge_s * param)
{

    sal_memcpy(param, &g_l2_basic_bridge.ports, sizeof(g_l2_basic_bridge));
    ...
    int Port_4)
{
    ...
    return l2_basic_bridge_run(unit, &param);
}
    ...
    l2_basic_bridge_s * param)
{
    ...
    rv = l2_basic_bridge_modify_init(unit, param);

    if (rv != BCM_E_NONE)
    {
        printf("Error, in l2_basic_bridge_modify_init\n");
        return rv;
    }
    ...
    {
        rv = bcm_port_class_set(unit, g_l2_basic_bridge.ports[i], bcmPortClassId, g_l2_basic_bridge.ports[i]);
        if (rv != BCM_E_NONE)
        {
            printf("Error, in bcm_port_class_set(port = %d)\n", g_l2_basic_bridge.ports[i]);
            return rv;
        }
    }
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        rv = bcm_port_class_set(unit, g_l2_basic_bridge.ports[i], bcmPortClassVlanMember, g_l2_basic_bridge.ports[i]);
        if (rv != BCM_E_NONE)
        {
            printf("Error, in bcm_port_class_set(port = %d)\n", g_l2_basic_bridge.ports[i]);
            return rv;
    ...
    if (!is_jericho2)
    {
        ...
        rv = bcm_port_control_set(unit, g_l2_basic_bridge.ports[Port_1_untag], flood_type,
                                  g_l2_basic_bridge.unknown_da_profile_destination);
    }
    else
    {
        ...
        BCM_GPORT_MCAST_SET(flood_destination, g_l2_basic_bridge.unknown_da_profile_destination);
        flood_groups.unknown_unicast_group = flood_destination;
        rv = bcm_port_flood_group_set(unit, g_l2_basic_bridge.ports[Port_1_untag], 0, &flood_groups);
    }
    ...
    control.unknown_unicast_group = g_l2_basic_bridge.uuc_mcid;
    control.broadcast_group = g_l2_basic_bridge.uuc_mcid;
    control.unknown_multicast_group = g_l2_basic_bridge.uuc_mcid;
    ...
    g_l2_basic_bridge.uuc_mcid = g_l2_basic_bridge.unknown_da_profile_destination + g_l2_basic_bridge.uuc_mcid;
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        BCM_PBMP_PORT_ADD(pbmp, g_l2_basic_bridge.ports[i]);
    }
    BCM_PBMP_PORT_ADD(untag_pbmp, g_l2_basic_bridge.ports[0]);  /* Port_1 is part of both untag_pbm and pbm. Putting it 
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        rv = bcm_port_untagged_vlan_set(unit, g_l2_basic_bridge.ports[i], g_l2_basic_bridge.outer_vid);
        if (rv != BCM_E_NONE)
        {
    ...
    bcm_gport_t inlif0;
    rv = bcm_vlan_gport_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.ports[0], 0);
    rv = bcm_vlan_gport_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.ports[1], 0);
    rv = bcm_vlan_gport_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.ports[2], 0);
    rv = bcm_vlan_gport_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.ports[3], 0);
...
/* Default Port based InLif creation on Port_1 */
    ...
    vlan_port.port = g_l2_basic_bridge.ports[Port_1_untag];
    ...
    g_l2_basic_bridge.inlif[Port_1_untag][0] = vlan_port.vlan_port_id;
    g_l2_basic_bridge.outlif[Port_1_untag][0] = vlan_port.vlan_port_id;
    ...
    vlan_port.vsi = 0;
    vlan_port.vlan_port_id = inlif0;
    vlan_port.port = g_l2_basic_bridge.ports[Port_2_stag];
    ...
    g_l2_basic_bridge.inlif[Port_2_stag][0] = vlan_port.vlan_port_id;
    g_l2_basic_bridge.outlif[Port_2_stag][0] = vlan_port.vlan_port_id;
...
/* SVLAN_Db based InLif creation on Port_4 */
    ...
    vlan_port.vlan_port_id = inlif0;
    vlan_port.match_vlan = g_l2_basic_bridge.outer_vid;
    vlan_port.port = g_l2_basic_bridge.ports[Port_4_stag];
    ...
    g_l2_basic_bridge.inlif[Port_4_stag][0] = vlan_port.vlan_port_id;
    g_l2_basic_bridge.outlif[Port_4_stag][0] = vlan_port.vlan_port_id;
...
/* S_C_VLAN_Db based InLif creation on Port_3*/
    ...
    vlan_port.vsi = 0;
    vlan_port.vlan_port_id = inlif0;
    vlan_port.port = g_l2_basic_bridge.ports[Port_3_dtag];
    vlan_port.match_vlan = g_l2_basic_bridge.outer_vid;
    ...
    g_l2_basic_bridge.inlif[Port_3_dtag][0] = vlan_port.vlan_port_id;
    g_l2_basic_bridge.outlif[Port_3_dtag][0] = vlan_port.vlan_port_id;
     ...
     */
    /*
     * rv = bcm_vswitch_port_add(unit, g_l2_basic_bridge.vsi,g_l2_basic_bridge.inlif[Port_1_untag][0]); if (rv !=
     * BCM_E_NONE) { printf("Error, in bcm_vswitch_port_add(port = %d)\n", g_l2_basic_bridge.inlif[Port_1_untag][0]);
     * return rv; }
     */
    rv = bcm_vswitch_port_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.inlif[Port_2_stag][0]);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_vswitch_port_add(port = %d)\n", g_l2_basic_bridge.inlif[Port_2_stag][0]);
        return rv;
    }
    rv = bcm_vswitch_port_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.inlif[Port_3_dtag][0]);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_vswitch_port_add(port = %d)\n", g_l2_basic_bridge.inlif[Port_3_dtag][0]);
        return rv;
    }
    rv = bcm_vswitch_port_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.inlif[Port_4_stag][0]);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_vswitch_port_add(port = %d)\n", g_l2_basic_bridge.inlif[Port_4_stag][0]);
        return rv;
    }
    ...
    port_tpid_class.port = g_l2_basic_bridge.ports[Port_1_untag];
    ...
    port_tpid_class.tpid1 = g_l2_basic_bridge.tpids.tpid1;
    port_tpid_class.tpid2 = BCM_PORT_TPID_CLASS_TPID_INVALID;
    port_tpid_class.flags = BCM_PORT_TPID_CLASS_INGRESS_ONLY;
    port_tpid_class.port = g_l2_basic_bridge.ports[Port_4_stag];
    ...
    port_tpid_class.tpid1 = g_l2_basic_bridge.tpids.tpid1;
    port_tpid_class.tpid2 = g_l2_basic_bridge.tpids.tpid0;
    port_tpid_class.flags = BCM_PORT_TPID_CLASS_INGRESS_ONLY;
    port_tpid_class.port = g_l2_basic_bridge.ports[Port_3_dtag];
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.inlif[Port_1_untag][0], /* lif - need the
                                                                                                 * gport, thus use
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.inlif[Port_3_dtag][0],  /* lif - need the
                                                                                                 * gport, thus use
                                                                                                 * inLifList instead of 
                                                                                                 * * * * outLifList */
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.inlif[Port_4_stag][0],  /* lif - need the
                                                                                                 * gport, thus use
                                                                                                 * inLifList instead of 
                                                                                                 * * * * outLifList */
                                                g_l2_basic_bridge.tpids.tpid1,  /* outer_tpid */
...
/*    outlif=(17<<26|2<<22|10005);
    ...
    rv = bcm_multicast_create(unit, flags, &g_l2_basic_bridge.uuc_mcid);
    ...
    rep_array.port = g_l2_basic_bridge.ports[Port_1_untag];
    rep_array.encap1 = (g_l2_basic_bridge.inlif[Port_1_untag][0] & 0xffff);

    rv = bcm_multicast_add(unit, g_l2_basic_bridge.uuc_mcid, flags, 1, &rep_array);
    ...
    rep_array.port = g_l2_basic_bridge.ports[Port_2_stag];
    rep_array.encap1 = (g_l2_basic_bridge.outlif[Port_2_stag][0] & 0x3fffff);
    rv = bcm_multicast_add(unit, g_l2_basic_bridge.uuc_mcid, flags, 1, &rep_array);
    ...
    rep_array.port = g_l2_basic_bridge.ports[Port_3_dtag];
    rep_array.encap1 = (g_l2_basic_bridge.outlif[Port_3_dtag][0] & 0x3fffff);
    ...
    rep_array.port = g_l2_basic_bridge.ports[Port_4_stag];
    rep_array.encap1 = (g_l2_basic_bridge.outlif[Port_4_stag][0] & 0x3fffff);
    ...
    g_l2_basic_bridge.outlif[Port_1_untag][0] = vlan_port.vlan_port_id;
    printf("OutLif create: port=%d, vlan_port_id=0x%08x,\n", vlan_port.port, vlan_port.vlan_port_id);
    rv = bcm_vswitch_port_add(unit, g_l2_basic_bridge.vsi, g_l2_basic_bridge.outlif[Port_1_untag][0]);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_vswitch_port_add(port = %d)\n", g_l2_basic_bridge.outlif[Port_1_untag][0]);
        return rv;
    }
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        ...
        port_tpid_class.port = g_l2_basic_bridge.ports[i];
        port_tpid_class.tag_format_class_id = tag_format_untag;
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.outlif[Port_2_stag][0], /* lif - need the
                                                                                                 * gport, thus use
                                                                                                 * inLifList instead of 
                                                                                                 * * * * outLifList */
                                                g_l2_basic_bridge.tpids.tpid1,  /* outer_tpid */
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.outlif[Port_1_untag][0],        /* lif - need
                                                                                                         * the gport,
                                                                                                         * thus use
                                                                                                         * inLifList
                                                                                                         * instead of
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.outlif[Port_3_dtag][0], /* lif - need the
                                                                                                 * gport, thus use
                                                                                                 * inLifList instead of 
                                                                                                 * * * * outLifList */
                                                g_l2_basic_bridge.tpids.tpid1,  /* outer_tpid */
    ...
    rv = vlan_translate_ive_eve_translation_set(unit, g_l2_basic_bridge.outlif[Port_4_stag][0], /* lif - need the
                                                                                                 * gport, thus use
                                                                                                 * inLifList instead of 
                                                                                                 * * * * outLifList */
                                                g_l2_basic_bridge.tpids.tpid1,  /* outer_tpid */
    ...
    if (!is_jericho2)
    {
        ...
        config.dest_port = g_l2_basic_bridge.ports[Port_1_untag];
        config.encap_id = g_l2_basic_bridge.outlif[Port_1_untag][0];
...
/*
    ...
    rv = bcm_rx_trap_protocol_profile_set(unit, g_l2_basic_bridge.ports[Port_1_untag], &trap_profile);
...
*/
    ...
    protocol_profiles.arp_trap_profile = g_l2_basic_bridge.arp_trap_profile;
    protocol_profiles.l2cp_trap_profile = g_l2_basic_bridge.l2cp_trap_profile;
    rv = bcm_rx_trap_protocol_profiles_set(unit, g_l2_basic_bridge.inlif[Port_1_untag][0], &protocol_profiles);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_rx_trap_protocol_profiles_set(unit,g_l2_basic_bridge.inlif[Port_2_stag][0], &protocol_profiles);
    if (rv != BCM_E_NONE) {
         printf("Error, bcm_rx_trap_protocol_profiles_set : arp and l2cp profiles set per lif\n");
       return rv;
    }
    ...
    /* TRAP call for ARP*/
    rv = l2_basic_bridge_arp_trap_create(unit);
    if (rv != BCM_E_NONE)
    {
        printf("Error, l2_basic_bridge_arp_trap_create for ARP\n");
        return rv;
    }
     ...
     */
    rv = l2_basic_bridge_my_arp_trap_create(unit);
    if (rv != BCM_E_NONE)
    {
        printf("Error, l2_basic_bridge_arp_trap_create for ARP\n");
        return rv;
     ...
     * TRAP call for L2CP
     */
    rv = l2_basic_bridge_l2cp_trap_create(unit);
    if (rv != BCM_E_NONE)
    {
        printf("Error, l2_basic_bridge_l2cp_trap_create for ARP\n");
        return rv;
    }
    ...
    l2_addr.port = g_l2_basic_bridge.ports[Port_2_stag];
     ...
     * Add l2 cache entry to trap BPDU packet -
     ...
     l2_cache.src_port = g_l2_basic_bridge.ports[Port_1_untag];
     l2_cache.mac = g_l2_basic_bridge.bpdu_mac;
...
int
l2_basic_bridge_arp_trap_create(
    int unit)
{
    int rv;
    bcm_rx_trap_config_t config;
     ...
     * ARP trap ID
     */
    rv = bcm_rx_trap_type_create(unit, 0, bcmRxTrapUserDefine, &g_l2_basic_bridge.arp_trap_id);
    printf("trap id generated is ARP %d\n", g_l2_basic_bridge.arp_trap_id);
    if (rv != BCM_E_NONE)
    {
    ...
    config.dest_port = g_l2_basic_bridge.ports[Port_1_untag];
    config.encap_id = g_l2_basic_bridge.outlif[Port_1_untag][0];
    rv = bcm_rx_trap_set(unit, g_l2_basic_bridge.arp_trap_id, &config);
    if (rv != BCM_E_NONE)
    {
    ...
    key.protocol_trap_profile = g_l2_basic_bridge.arp_trap_profile;
    BCM_GPORT_TRAP_SET(trap_gport, g_l2_basic_bridge.arp_trap_id, g_l2_basic_bridge.arp_fwd_strength, 0);
...
int
l2_basic_bridge_my_arp_trap_create(
    int unit)
{
    int rv;
    bcm_rx_trap_config_t config;
     ...
     * ARP trap ID
     */
    rv = bcm_rx_trap_type_create(unit, 0, bcmRxTrapUserDefine, &g_l2_basic_bridge.my_arp_trap_id);
    printf("trap id generated is MY_ARP%d\n", g_l2_basic_bridge.my_arp_trap_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error, bcm_rx_trap_type_create for ARP\n");
        return rv;
    ...
    config.flags = (BCM_RX_TRAP_UPDATE_ENCAP_ID | BCM_RX_TRAP_UPDATE_DEST);
    config.dest_port = g_l2_basic_bridge.ports[Port_2_stag];
    config.encap_id = g_l2_basic_bridge.outlif[Port_2_stag][0];
    rv = bcm_rx_trap_set(unit, g_l2_basic_bridge.my_arp_trap_id, &config);
    if (rv != BCM_E_NONE)
    {
        printf("Error, bcm_rx_trap_set for ARP\n");
        return rv;
    ...
    key.protocol_trap_profile = g_l2_basic_bridge.arp_trap_profile;
    BCM_GPORT_TRAP_SET(trap_gport, g_l2_basic_bridge.my_arp_trap_id, g_l2_basic_bridge.my_arp_fwd_strength, 0);
    rv = bcm_rx_trap_protocol_set(unit, &key, trap_gport);
    if (rv != BCM_E_NONE)
    {
        printf("Error, bcm_rx_trap_protocol_set for ARP\n");
...
int
l2_basic_bridge_arp_traps_destroy(
    int unit)
{
    int rv;
    bcm_rx_trap_protocol_key_t key = { 0 };
    rv = bcm_rx_trap_type_destroy(unit, g_l2_basic_bridge.arp_trap_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_rx_trap_type_destroy(unit, g_l2_basic_bridge.my_arp_trap_id);
    if (rv != BCM_E_NONE)
    {
...
int
l2_basic_bridge_l2cp_trap_create(
    int unit)
{
    int rv;
    bcm_rx_trap_config_t config;
     ...
     * L2CP trap ID
     */
    rv = bcm_rx_trap_type_create(unit, 0, bcmRxTrapUserDefine, &g_l2_basic_bridge.l2cp_trap_id);
    printf("trap id generated is L2CP %d\n", g_l2_basic_bridge.l2cp_trap_id);
    if (rv != BCM_E_NONE)
    {
    ...
    config.dest_port = g_l2_basic_bridge.ports[Port_1_untag];
    config.encap_id = g_l2_basic_bridge.outlif[Port_1_untag][0];
    rv = bcm_rx_trap_set(unit, g_l2_basic_bridge.l2cp_trap_id, &config);
    if (rv != BCM_E_NONE)
    {
    ...
    key.protocol_trap_profile = g_l2_basic_bridge.l2cp_trap_profile;
    BCM_GPORT_TRAP_SET(trap_gport, g_l2_basic_bridge.l2cp_trap_id, g_l2_basic_bridge.l2cp_fwd_strength, 0);
    rv = bcm_rx_trap_protocol_set(unit, &key, trap_gport);
    if (rv != BCM_E_NONE)
    {
        printf("Error, bcm_rx_trap_protocol_set for L2CP\n");
...
/* l2cp trap destroy*/
int
l2_basic_bridge_l2cp_traps_destroy(
    int unit)
{
    int rv;
    bcm_rx_trap_protocol_key_t key = { 0 };
    rv = bcm_rx_trap_type_destroy(unit, g_l2_basic_bridge.l2cp_trap_id);
    if (rv != BCM_E_NONE)
    {
    ...
    int unit)
{
     ...
     * TPID0 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid0;
     ...
     * TPID1 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid1;
    rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     * TPID2 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid2;
    rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     * TPID3 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid3;
    rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     * TPID4 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid4;
    rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     * TPID5 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid5;
    rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
     ...
     * TPID6 
     */
    tpid_info.tpid_value = g_l2_basic_bridge.tpids.tpid6;
    rv = bcm_switch_tpid_add(unit, 0, &tpid_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_switch_tpid_add(tpid_value=0x%04x)\n", tpid_info.tpid_value);
