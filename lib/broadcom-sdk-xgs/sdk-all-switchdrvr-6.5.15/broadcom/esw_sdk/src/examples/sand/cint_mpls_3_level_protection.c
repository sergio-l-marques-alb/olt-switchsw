/*
 * $Id: cint_mpls_3_level_protection.c,v 1.15 2017/09/13 12:47:34 Roy Vardi Exp $
 $Copyright: (c) 2018 Broadcom.
 Broadcom Proprietary and Confidential. All rights reserved.$ File: cint_mpls_3_level_protection.c Purpose: Various examples for MPLS. 
 */
    ...
    int unit)
{
    ...
    ingr_itf.qos_map = cint_mpls_3_level_protection_basic_info.ingress_qos_profile;
