/** \file src/bcm/dnx/cosq/ecgm_profile_mgmt.h
* $Id$
*
...
/**
* \brief - Init function for port handle.
*          initializes port profile HW and SW info for the port.
*          MUST be called at least once for any new port, to enable
*          using the port profile.
*
...
*   shr_error_e
*/
shr_error_e dnx_ecgm_profile_mgmt_port_handle_init(
    int unit,
    bcm_port_t port,
...
/** Interface Profile Functionality { */

/**
* \brief - Init function for interface handle.
*          initializes interface profile HW and SW info for the port.
*          MUST be called at least once for any new port, to enable
*          using the interface profile.
*
* \param [in] unit - device unit number.
* \param [in] port - port number.
...
*   shr_error_e
*/
shr_error_e dnx_ecgm_profile_mgmt_interface_handle_init(
    int unit,
    bcm_port_t port,
