    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_ALGO_RES_TYPE_SAT_GTF_ID, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_ALGO_RES_TYPE_SAT_CTF_ID, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_ALGO_RES_TYPE_SAT_TRAP_ID, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_ALGO_RES_TYPE_SAT_TRAP_DATA, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
