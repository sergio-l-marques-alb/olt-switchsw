    ...
    uint32 system_port)
{
    ...
    SHR_IF_ERR_EXIT(dnx_cosq_ipq_dbal_queue_quartet_to_sys_port_map_range_set(unit, queue_quartet, 1, system_port));
    ...
    uint32 *tc_profile)
{
     ...
     * Get dbal fields
     */
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_TC_PROFILE, INST_SINGLE, tc_profile);
    ...
    uint32 tc_profile)
{
     ...
     * Set dbal fields
     */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TC_PROFILE, INST_SINGLE, tc_profile);
    ...
    uint32 voq_offset)
{
     ...
     * Set TC profile
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_TC_PROFILE, tc_profile);
    /*
     * Set is_flow
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_IS_VOQ_FLOW, is_flow);
    /*
     * Set VOQ offset
     */
 ...
 */
shr_error_e
dnx_cosq_ipq_dbal_fmq_tc_to_voq_offset_map_set(
    int unit,
    uint32 tc,
    uint32 voq_offset)
{
     ...
     * Taking a handle to DBAL table
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_IPQ_FMQ_TRAFFIC_CLASS_TO_VOQ_OFFSET_MAP, &entry_handle_id));
    /*
     * Set TC
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_TC, tc);
 ...
 */
shr_error_e
dnx_cosq_ipq_dbal_fmq_tc_to_voq_offset_map_get(
    int unit,
    uint32 tc,
    uint32 *voq_offset)
{
