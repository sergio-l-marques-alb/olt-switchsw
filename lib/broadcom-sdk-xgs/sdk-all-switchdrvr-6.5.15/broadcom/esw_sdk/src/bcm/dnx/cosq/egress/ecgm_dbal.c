    ...
    uint32 is_queue_disabled)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core_id);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_QUEUE_PAIR, queue_pair);
...
dnx_ecgm_dbal_interface_multicast_thresholds_get(
    uint32 unit,
    uint32 core_id,
    dnx_ecgm_interface_priority_e priority,
    uint32 interface_profile,
    uint32 *pd_drop)
{
    uint32 entry_handle_id;
    ...
    const ecgm_cos_params_t * cos_params)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_SHARED_RESOURCE_ELIGIBILITY_DP, INST_SINGLE,
                                 cos_params->se_dp);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MC_PRIORITY, INST_SINGLE, cos_params->mc_sp);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
exit:
    DBAL_FUNC_FREE_VARS;
    SHR_FUNC_EXIT;
    ...
    const dnx_ecgm_uc_fc_thresholds_t * thresholds)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PD_FLOW_CONTROL_ALPHA, INST_SINGLE,
                                 (thresholds->pd_fc.alpha < 0) ? alpha : thresholds->pd_fc.alpha);
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DB_FLOW_CONTROL_ALPHA, INST_SINGLE,
                                 (thresholds->db_fc.alpha < 0) ? alpha : thresholds->db_fc.alpha);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
exit:
    DBAL_FUNC_FREE_VARS;
    SHR_FUNC_EXIT;
    ...
    const dnx_ecgm_uc_thresholds_t * thresholds)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PD_FLOW_CONTROL_ALPHA, INST_SINGLE,
                                 (thresholds->flow_control.pd_fc.alpha <
                                  0) ? alpha : thresholds->flow_control.pd_fc.alpha);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DB_FLOW_CONTROL_MAX, INST_SINGLE,
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DB_FLOW_CONTROL_ALPHA, INST_SINGLE,
                                 (thresholds->flow_control.db_fc.alpha <
                                  0) ? alpha : thresholds->flow_control.db_fc.alpha);
    ...
    const dnx_ecgm_mc_drop_thresholds_t * thresholds)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PD_DROP_ALPHA, INST_SINGLE,
                                 (thresholds->pd_drop.alpha < 0) ? alpha : thresholds->pd_drop.alpha);
    ...
    int *alpha_int)
{
    ...
    *alpha_int = alpha_uint32 & mask;
    ...
    if (utilex_bitstream_test_bit(&alpha_uint32, alpha_msb))
    {
        *alpha_int *= (-1);
    }
...
shr_error_e
dnx_ecgm_dbal_core_global_resources_statistics_max_clear(
    uint32 unit)
{
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(dbal_table_clear(unit, DBAL_TABLE_ECGM_CORE_GLOBAL_RESOURCES_STATISTICS_MAX));
...
dnx_ecgm_dbal_interface_resources_statistics_current_get(
    ...
    uint32 core_id,
    uint32 is_mc,
    dnx_ecgm_interface_priority_e ecgm_priority,
    uint32 egq_if,
    uint32 *pd,
    uint32 *db)
{
...
shr_error_e
dnx_ecgm_dbal_interface_resources_statistics_max_clear(
    uint32 unit)
{
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_ecgm_dbal_interface_resources_statistics_max_set(
    uint32 unit,
    uint32 core_id,
    uint32 is_mc,
    dnx_ecgm_interface_priority_e ecgm_priority,
    ...
    uint32 db)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PD, INST_SINGLE, pd);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DB, INST_SINGLE, db);
...
shr_error_e
dnx_ecgm_dbal_port_resources_statistics_max_clear(
    uint32 unit)
{
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_ecgm_dbal_queue_resources_statistics_max_clear(
    uint32 unit)
{
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_ecgm_dbal_queue_resources_statistics_max_set(
    uint32 unit,
    uint32 core_id,
    uint32 is_mc,
    uint32 queue_pair,
...
shr_error_e
dnx_ecgm_dbal_service_pool_resources_statistics_max_clear(
    uint32 unit)
{
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(dbal_table_clear(unit, DBAL_TABLE_ECGM_SERVICE_POOL_RESOURCES_STATISTICS_MAX));
...
shr_error_e
dnx_ecgm_dbal_service_pool_tc_resources_statistics_max_clear(
    uint32 unit)
{
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(dbal_table_clear(unit, DBAL_TABLE_ECGM_SERVICE_POOL_TC_RESOURCES_STATISTICS_MAX));
