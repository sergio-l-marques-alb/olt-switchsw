...
static const oam_key_select_egress_table_entry_t oam_key_select_egress_map[] = {
    ...
    {1, 0, 0, 0, EG_OAM_LIF, EG_OAM_LIF_1, EG_OAM_LIF_1, PREFIX_HIGH, PREFIX_MID, PREFIX_LOW, 1},
    {1, 0, 0, 1, EG_OAM_LIF, EG_OAM_LIF_1, EG_OAM_LIF_1, PREFIX_HIGH, PREFIX_MID, PREFIX_LOW, 1},
