...
/**
 * supported flags for qos application types PHB/REMARK ....
 */
#define DNX_QOS_APPLICATIONS_SUPPORTED_FLAGS (BCM_QOS_MAP_PHB | BCM_QOS_MAP_REMARK | BCM_QOS_MAP_ECN |\
...
#define DNX_QOS_EGRESS_APPLICATIONS_SUPPORTED_FLAGS (BCM_QOS_MAP_REMARK | BCM_QOS_MAP_ECN | BCM_QOS_MAP_POLICER |\
                                                     BCM_QOS_MAP_OAM_PCP | BCM_QOS_MAP_MPLS_PHP)
...
#define DNX_QOS_MAP_TYPES_SUPPORTED_FLAGS (BCM_QOS_MAP_L2_OUTER_TAG | BCM_QOS_MAP_L2_INNER_TAG | BCM_QOS_MAP_L2_INNER_TAG | \
                                           ...
                                           BCM_QOS_MAP_MPLS | BCM_QOS_MAP_PORT | BCM_QOS_MAP_MPLS_SECOND)
 ...
 *    \retval Zero in case of NO ERROR
 */
shr_error_e dnx_qos_ingress_ecn_map_add(
    int unit,
    uint32 flags,
    int map_opcode,
    bcm_qos_map_t * map_entry);
...
/**
 * \brief
 * delete Qos INGRESS ECN map entry
 * \par DIRECT INPUT
 * \param [in] unit - Relevant unit.
 * \param [in] flags - Relevant flags
 * \param [in] map_opcode - encoded map opcode for map type and ingress map.
 ...
 *     \retval Zero in case of NO ERROR
 */
shr_error_e dnx_qos_ingress_ecn_map_delete(
    int unit,
    uint32 flags,
    int map_opcode,
    bcm_qos_map_t * map_entry);
 ...
 *    \param [out] map_type - the relevant map type ID.
 *  \return
 *    \retval Negative in case of an error. 
 *    \retval Zero in case of NO ERROR
 */
shr_error_e dnx_qos_get_map_type(
    int unit,
    uint32 flags,
