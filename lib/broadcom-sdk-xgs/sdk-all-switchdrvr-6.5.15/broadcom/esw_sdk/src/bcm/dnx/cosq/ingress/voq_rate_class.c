 ...
 */
int
dnx_voq_rate_class_fadt_tail_drop_get(
    int unit,
    dnx_ingress_congestion_resource_type_e resource,
    uint32 rt_cls,
    uint32 dp,
    ...
    uint32 guaranteed_thresh)
{
    ...
    int nof_keys = 1;
    dnx_cosq_dbal_field_t key[nof_keys];
    ...
    bcm_cosq_gport_size_t * gport_size)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ingress_congestion_db.voq_rate_class.ref_count.get(unit, rate_class, &rate_class_nof_queues));
    ...
    bcm_cosq_gport_size_t * gport_size)
{
     ...
     */
    SHR_IF_ERR_EXIT(dnx_ingress_congestion_shared_res_reject_status_thr_set(unit, res_type, guaranteed_change));
    ...
    bcm_cosq_gport_size_t * gport_size)
{
    ...
    SHR_IF_ERR_EXIT(dnx_voq_rate_class_fadt_tail_drop_get(unit, res_type, rate_class, dp, &fadt_tail_drop));
