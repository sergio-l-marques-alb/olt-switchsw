    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "NETWORK_QOS_PIPE",
                                        template_data->network_qos_pipe, "NETWORK_QOS_PIPE", NULL);

    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "NETWORK_QOS_PIPE_MAPPED",
                                        template_data->network_qos_pipe_mapped, "NETWORK_QOS_PIPE_MAPPED", NULL);

    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "DP_PIPE_MAPPED",
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "PHB", template_data->phb, "PHB", NULL);

    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "REMARK",
                                        template_data->remark, "REMARK", NULL);

    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "ECN", template_data->ecn, "ECN", NULL);

    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "TTL", template_data->ttl, "TTL", NULL);
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_INT, "ttl", *ttl_ptr, NULL, "0d%x");
    ...
    int unit)
{
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_INGRESS_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_INGRESS_OPCODE_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_INGRESS_ECN_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    sal_strncpy(data.name, DNX_QOS_INGRESS_POLICER_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    sal_memset(&data, 0, sizeof(sw_state_algo_res_create_data_t));
    data.first_element = 0;
    sal_strncpy(data.name, DNX_QOS_INGRESS_VLAN_PCP_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_EGRESS_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_EGRESS_OPCODE_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_EGRESS_MPLS_PHP_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_EGRESS_PHP_OPCODE_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_EGRESS_POLICER_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    data.flags = 0;
    sal_strncpy(data.name, DNX_QOS_EGRESS_OAM_PCP_MAP_RESOURCE, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    template_data.max_references = dnx_data_lif.in_lif.nof_sbc_local_in_lifs_get(unit) +
