 ...
 */
#define OAM_EGRESS_PACKET_INJECTED_BITMAP_INIT_VAL     0x10
 ...
 *  OAM-TS. */
#define NUM_OAM_TS_REQ_SUB_TYPES 5
    ...
    int unit)
{
    ...
    /**
     * Initialize configuration bit: JR1 or JR2 for application specific headers,
     * OAM-TS for example, according to soc property
     */
    oamp_tx_format = dnx_data_headers.system_headers.system_headers_mode_get(unit);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TX_JR2_AS_OAM, INST_SINGLE, oamp_tx_format);
    ...
    /**
     * FINME SDK-142479
     * This value is correct for Jericho 2 headers mode.  For Jericho 1 headers mode,
     * a different value should be used.
     */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_UDH_SIZE, INST_SINGLE, DEFAULT_UDH_SIZE);
    ...
    int unit)
{
    ...
    /** load init values */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAM_NTP_TOD_CONFIGURATION, &entry_handle_id));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TIME_FRAC_SEC_LOWER, INST_SINGLE, 0x13576543);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TIME_FRAC_SEC_UPPER, INST_SINGLE, 0x1ffff00);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TIME_FREQ_CONTROL, INST_SINGLE, 0x44b82fa1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ONE_SEC, INST_SINGLE, 1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_UPPER_SEC, INST_SINGLE, 0x0804560);
    ...
    /** disable counting */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_CLEAR(unit, DBAL_TABLE_OAM_1588_TOD_CONFIGURATION, entry_handle_id));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EVENT_MUX_CONTROL, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_COUNT_ENABLE, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LOAD_ENABLE, INST_SINGLE, 0);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TIME_FRAC_SEC_LOWER, INST_SINGLE, 0x13576543);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TIME_FRAC_SEC_UPPER, INST_SINGLE, 0x1ffff00);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TIME_FREQ_CONTROL, INST_SINGLE, 0x10000000);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ONE_SEC, INST_SINGLE, 1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_UPPER_SEC, INST_SINGLE, 0x0804560);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LOAD_ONCE, INST_SINGLE, 1);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_CLEAR(unit, DBAL_TABLE_OAM_TOD_GENERAL_CONFIGURATION, entry_handle_id));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TODW_SELECT_IEEE_1588_TIMER, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TODW_SELECT_NTP_TIMER, INST_SINGLE, 0);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
