...
/** 
 *  we have 32 availiable packet types values and 15 ingress map
 *  types. This table is used to convert 32 packet types values
 *  to the appropriate map type.
 */
const dbal_enum_value_field_ingress_qos_map_type_e dnx_cs_to_map_type[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES] = {
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_DEF_PORT        */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_UNTAGGED,  /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_UNTAGGED    */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_OUTER_TAG, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_ONE_TAG     */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_OUTER_TAG, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_DOUBLE_TAG  */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV4,         /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV4            */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV6,         /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV6            */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_MPLS,         /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_MPLS            */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV4,         /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_IPV4    */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV6,         /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_IPV6    */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_MPLS,         /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_MPLS    */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_RCH,          /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_RCH             */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_11              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_12              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_13              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_14              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_15              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_16              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_17              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_18              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_19              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_20              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_21              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_22              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_23              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_24              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_25              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_26              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_27              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_28              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_29              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_30              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT, /**DBAL_ENUM_FVAL_QOS_PACKET_TYPE_31              */
};
 ...
 */
#define QOS_CS_PROFILE_MASK 0xf
 ...
 * The table is of size: DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES+1, the last enty holds default 
 * value which will be written to unused HW table entries.  
 * the table structure is described below. 
 */ 
CONST qos_context_selection_table_t qos_phb_cs_table_init[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES+1]=
{/********************************************************************************************************************************
  ...
  ********************************************************************************************************************************
  */
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_DEF_PORT */
   31,
  ...
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_UNTAGGED */
   0,
   DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_ETH_UNTAGED_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_ETH_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   , 
  {QOS_UNUSED_FIELD              , QOS_UNUSED_FIELD}                , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_EXPLICIT  , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_ONE_TAG */
   1,
   DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_ETH_ONE_TAG_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_ETH_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   , 
   {QOS_FFC_0_ETH_PCP_DEI_VAL    , QOS_FFC_1_ETH_PCP_DEI_VAL}       , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_DOUBLE_TAG */
   2,
   DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_ETH_TWO_TAG_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    ,  
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_ETH_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   , 
  {QOS_FFC_0_ETH_PCP_DEI_VAL     , QOS_FFC_1_ETH_PCP_DEI_VAL}       , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV4 */
   3,
   DBAL_ENUM_FVAL_LAYER_TYPES_IPV4, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   , 
  {QOS_FFC_0_IPV4_TOS_VAL       , QOS_FFC_1_IPV4_TOS_VAL}         , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV6 */
   4,
   DBAL_ENUM_FVAL_LAYER_TYPES_IPV6, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    ,  
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   ,
  {QOS_FFC_0_IPV6_TOS_VAL        , QOS_FFC_1_IPV6_TOS_VAL}          , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_MPLS */
   5,
   DBAL_ENUM_FVAL_LAYER_TYPES_MPLS, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   ,
  {QOS_FFC_0_MPLS_EXP_VAL        , QOS_FFC_1_MPLS_EXP_VAL}          , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_IPV4 */
   6,
   DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET , DBAL_ENUM_FVAL_LAYER_TYPES_IPV4   , QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_NEXT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_LAYER_TYPE_MASK              , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   , 
  ...
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_IPV6 */
   7,
   DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET , DBAL_ENUM_FVAL_LAYER_TYPES_IPV6   , QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_NEXT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_LAYER_TYPE_MASK              , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   ,
  ...
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_MPLS */
   8,
   DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET , DBAL_ENUM_FVAL_LAYER_TYPES_MPLS   , QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_NEXT_LAYER    ,  
   QOS_LAYER_TYPE_MASK           , QOS_LAYER_TYPE_MASK              , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   ,  
  ...
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_RCH */
   9,
   DBAL_ENUM_FVAL_LAYER_TYPES_RCH , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER    , 
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_CS_PROFILE_MASK   , 
   {QOS_FFC_0_PHB_RCH_VAL        , QOS_FFC_1_PHB_RCH_VAL}       , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},
  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_11 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_12 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_13 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_14 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_15 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_16 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_17 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_18 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_19 */
   UNUSED_CS_ENTRY},    

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_20 */
   UNUSED_CS_ENTRY},    

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_21 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_22 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_23 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_24 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_25 */
   UNUSED_CS_ENTRY},  

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_26 */
   UNUSED_CS_ENTRY},    

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_27 */
   UNUSED_CS_ENTRY},    

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_28 */
   UNUSED_CS_ENTRY},    

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_29 */
   UNUSED_CS_ENTRY},    

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_30 */
   UNUSED_CS_ENTRY},
  
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_31 */
   UNUSED_CS_ENTRY},     

  {/** PACKET_TYPE = DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES, This  index is not part of the ENUM and must be set to UNUSED_CS_ENTRY*/
   UNUSED_CS_ENTRY}, 
};
 ...
 * the table structure is described below. 
 */ 
CONST qos_context_selection_table_t qos_remark_cs_table_init[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES+1]=
{/********************************************************************************************************************************
  *      LAYER TYPE              *      NEXT LAYER TYPE             *  LAYER QUALIFIER    *  NEXT LAYER         * CS PROFILE      
  *                              *                                  *                     *  QUALIFIER          *
  ********************************************************************************************************************************                     
 ...
 * value which will be written to unused HW table entries.  
 * the table structure is described below. */
CONST qos_context_selection_table_t qos_ecn_cs_table_init[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES + 1] = {
 /********************************************************************************************************************************
  *      LAYER TYPE              *      NEXT LAYER TYPE             *  LAYER QUALIFIER    *  NEXT LAYER         * CS PROFILE      
  *                              *                                  *                     *  QUALIFIER          *
  ********************************************************************************************************************************                     
  ...
  */
   ...
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_DEF_PORT */
     ...
     QOS_DEF_PORT_VAL, QOS_DEF_PORT_VAL, QOS_DEF_PORT_VAL, QOS_DEF_PORT_VAL, QOS_DEF_PORT_VAL,
     QOS_DEF_PORT_MASK, QOS_DEF_PORT_MASK, QOS_DEF_PORT_MASK, QOS_DEF_PORT_MASK, QOS_DEF_PORT_MASK,
     {QOS_UNUSED_FIELD /**FFC_0*/ , QOS_UNUSED_FIELD /**FFC_1*/ }, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_EXPLICIT, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},

    {
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_UNTAGGED */
     0,
     DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_ETH_UNTAGED_QUAL, QOS_NO_QUAL,
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_LAYER_TYPE_MASK, QOS_ETH_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_FFC_0_ETH_PCP_DEI_VAL, QOS_FFC_1_ETH_PCP_DEI_VAL}, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_EXPLICIT, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},

    {
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_ONE_TAG */
     1,
     DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_ETH_ONE_TAG_QUAL, QOS_NO_QUAL,
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_LAYER_TYPE_MASK, QOS_ETH_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_FFC_0_ETH_PCP_DEI_VAL, QOS_FFC_1_ETH_PCP_DEI_VAL}, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},

    {
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_DOUBLE_TAG */
     2,
     DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_ETH_TWO_TAG_QUAL, QOS_NO_QUAL,
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_LAYER_TYPE_MASK, QOS_ETH_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_FFC_0_ETH_PCP_DEI_VAL, QOS_FFC_1_ETH_PCP_DEI_VAL}, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},
   ...
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV4 */
     ...
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_NO_LAYER_TYPE_MASK, QOS_NO_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_FFC_0_IPV4_TOS_VAL, QOS_FFC_1_IPV4_TOS_VAL}, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},
   ...
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV6 */
     ...
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_NO_LAYER_TYPE_MASK, QOS_NO_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_FFC_0_IPV6_TOS_VAL, QOS_FFC_1_IPV6_TOS_VAL}, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},
   ...
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_MPLS */
     ...
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_NO_LAYER_TYPE_MASK, QOS_NO_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_UNUSED_FIELD /**FFC_0*/ , QOS_UNUSED_FIELD /**FFC_1*/ }, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},

    {
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_IPV4 */
     6,
     DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_LAYER_TYPES_IPV4, QOS_NO_QUAL, QOS_NO_QUAL,
   ...
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_IPV6 */
     7,
     DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_LAYER_TYPES_IPV6, QOS_NO_QUAL, QOS_NO_QUAL,
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_NEXT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_LAYER_TYPE_MASK, QOS_NO_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_UNUSED_FIELD /**FFC_0*/ , QOS_UNUSED_FIELD /**FFC_1*/ }, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},
   ...
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_ETH_USE_MPLS */
     8,
     DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, DBAL_ENUM_FVAL_LAYER_TYPES_MPLS, QOS_NO_QUAL, QOS_NO_QUAL,
     DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_NEXT_LAYER,
     QOS_LAYER_TYPE_MASK, QOS_LAYER_TYPE_MASK, QOS_NO_QUAL_MASK, QOS_NO_QUAL_MASK, QOS_CS_PROFILE_MASK,
     {QOS_UNUSED_FIELD /**FFC_0*/ , QOS_UNUSED_FIELD /**FFC_1*/ }, DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED, QOS_ECN_INT_MAP_KEY_SIZE, TRUE},

    {
   /** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_10 */
     UNUSED_CS_ENTRY},
 ...
 */ 
CONST qos_context_selection_table_t qos_ttl_cs_table_init[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES+1]=
{/********************************************************************************************************************************
  ...
  */
  ...
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_0 */
     UNUSED_CS_ENTRY},
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_1 */
     UNUSED_CS_ENTRY},
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_2 */
     UNUSED_CS_ENTRY},
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_IPV4 */
   0,
  ...
  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_6 */
      UNUSED_CS_ENTRY},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_7 */
      UNUSED_CS_ENTRY},

  {/** PACKET_TYPE = DBAL_ENUM_FVAL_QOS_PACKET_TYPE_8 */
      UNUSED_CS_ENTRY},
 ...
 *    \param [in] map_type - relevant map type.
...
dnx_qos_build_map_key(
    int unit,
    uint32 flags,
    dbal_enum_value_field_ingress_qos_map_type_e map_type,
    ...
    uint8 *map_key)
{
    ...
    switch (map_type)
    {
        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_UNTAGGED:
            *map_key = ((map_entry->pkt_pri & DNX_QOS_TC_MASK) << DNX_QOS_TC_OFFSET) | (map_entry->pkt_cfi & DNX_QOS_DP_MASK);
            break;
        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_INNER_TAG:
        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_OUTER_TAG:
            *map_key = ((map_entry->pkt_pri & DNX_QOS_PRI_MASK) << DNX_QOS_PRI_OFFSET) | (map_entry->pkt_cfi & DNX_QOS_CFI_MASK);
            break;

        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV4:
            *map_key = map_entry->dscp;
            break;

        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV6:
            /** In IPV6 we use the dscp field to update the tos value */
            *map_key = map_entry->dscp;
            break;

        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_MPLS:
            *map_key = map_entry->exp;
            break;

        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_RCH:
        ...
        default:
            SHR_ERR_EXIT(_SHR_E_PARAM, "Illegal value for map_type [%x]\n", map_type);
            break;
    }
 ...
 *                           to the table
 *    \param [in] packet_type - entry relevant packet type
...
dnx_qos_ingress_tables_init_write_entry(
    ...
    uint32 priority,
    dbal_enum_value_field_qos_packet_type_e packet_type,
    ...
    uint32 qos_init_type)
{
    ...
    if (qos_init_type != DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_TTL)
    {
        ...
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INGRESS_QOS_MAP_TYPE, INST_SINGLE,
                                     dnx_cs_to_map_type[packet_type]);
...
{
    dbal_enum_value_field_qos_packet_type_e packet_type;
    uint8 qos_init_status[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES];
    uint32 valid_entries_cntr = 0;

    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    sal_memset(qos_init_status, 0, DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES);

    for (packet_type = 0; packet_type < DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES; packet_type++)
    {
        uint32 priority = qos_cs_table_init_ptr[packet_type].priority;
        if (priority < QOS_DEF_PORT_PRIORITY)
        {
            ...
            if (qos_init_status[priority] == 0)
            {
                dnx_qos_ingress_tables_init_write_entry(unit, entry_handle_id, priority,
                                                        packet_type, &qos_cs_table_init_ptr[packet_type],
                                                        qos_init_type);
                qos_init_status[priority]++;
            }
            else
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "priority [%d] allready configured", qos_init_status[packet_type]);
            }
        }
    }
     ...
     */
    for (packet_type = 0; packet_type < valid_entries_cntr; packet_type++)
    {
        if (qos_init_status[packet_type] == 0)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "init DB has a HOLE, priority [%d] is not configured", packet_type);
        }
    }
    ...
    dnx_qos_ingress_tables_init_write_entry(unit, entry_handle_id, valid_entries_cntr,
                                            ...
                                            &qos_cs_table_init_ptr[DBAL_ENUM_FVAL_QOS_PACKET_TYPE_DEFAULT_PORT],
                                            qos_init_type);
    valid_entries_cntr++;
     ...
     */
    for (packet_type = valid_entries_cntr; packet_type < DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES; packet_type++)
    {
        dnx_qos_ingress_tables_init_write_entry(unit, entry_handle_id, valid_entries_cntr,
                                                DBAL_ENUM_FVAL_QOS_PACKET_TYPE_DEFAULT_PORT,
                                                &qos_cs_table_init_ptr[DBAL_NOF_ENUM_QOS_PACKET_TYPE_VALUES],
                                                qos_init_type);
        valid_entries_cntr++;
    }
    ...
    dbal_enum_value_field_ingress_qos_map_type_e * map_type)
{
    ...
    if (flags & BCM_QOS_MAP_L2)
    {
        ...
        {
            *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_UNTAGGED;
        }
        else if (flags & BCM_QOS_MAP_L2_INNER_TAG)
        {
            *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_INNER_TAG;
        }
        else if (flags & BCM_QOS_MAP_L2_OUTER_TAG)
        {
            *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_L2_OUTER_TAG;
        }
        else
        {
    ...
    else if (flags & BCM_QOS_MAP_L3)
    {
        ...
        {
            *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV6;
        }
        else if (flags & BCM_QOS_MAP_IPV4)
        {
            *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_IPV4;
        }
        else
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "Illegal value for flags %x\n", flags);
    ...
    {
        *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_MPLS;
    }
    else if (flags & BCM_QOS_MAP_PORT)
    {
        *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_DEFAULT_PORT;
    }
    else if (flags & BCM_QOS_MAP_RCH)
    {
        *map_type = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_TYPE_RCH;
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Illegal value for flags %x\n", flags);
    ...
    int *map_id)
{
    ...
    {
        resource_flags = SW_STATE_ALGO_RES_ALLOCATE_WITH_ID;
    ...
    uint32 opcode)
{
    ...
    SHR_IF_ERR_EXIT(dnx_qos_ingress_map_type_get(unit, flags, &map_type));
    ...
    {
        table_id = DBAL_TABLE_QOS_INGRESS_ECN_PROFILE_TO_INTERNAL_MAP_ID;
        profile_field = DBAL_FIELD_ECN_QOS_PROFILE;
    }
    else
    {
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_INGRESS_QOS_MAP_TYPE, map_type);
    ...
    bcm_qos_map_t * map_entry)
{
    ...
    SHR_IF_ERR_EXIT(dnx_qos_ingress_map_type_get(unit, flags, &map_type));
    SHR_IF_ERR_EXIT(dnx_qos_build_map_key(unit, flags, map_type, map_entry, &map_key));
...
/**
 * \brief 
 * add Qos INGRESS ECN map 
 */
shr_error_e
dnx_qos_ingress_ecn_map_add(
    int unit,
    uint32 flags,
    int map_opcode,
    bcm_qos_map_t * map_entry)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_QOS_INGRESS_ECN_INTERNAL_MAP_ENTRIES, &entry_handle_id));

    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_QOS_INT_MAP_KEY, map_key);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_QOS_INT_MAP_ID, opcode_ndx);

    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN, INST_SINGLE, map_entry->int_pri);
...
/**
 * \brief
 * delete Qos INGRESS ECN map
 *
 * Details: see qos_internal.h
 */
shr_error_e
dnx_qos_ingress_ecn_map_delete(
    int unit,
    uint32 flags,
    int map_opcode,
    bcm_qos_map_t * map_entry)
    ...
    bcm_qos_map_t * map_entry)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_IN_DEI, (map_entry->remark_int_pri & DNX_QOS_CFI_MASK));
    /*
     * set dbal map value
     */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_OUT_DEI, INST_SINGLE, map_entry->pkt_cfi);
    ...
    bcm_qos_map_t * map_entry)
{
    ...
    else if (flags & BCM_QOS_MAP_ECN)
    {
         ...
         *-----------------------
         */
        explicit_opcode = map_entry->int_pri << DNX_QOS_EXPLICIT_ECN_OFFSET;
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "flags [%x] not supported yet\n", flags);
...
/**
 * \brief 
 * set QOS context selection profile of INGRESS profile for PHB/REMARK/ECN,
 * at present, only support two cs profile, USE_CURRENT_LAYER and USE_NEXT_LAYER. 
 */
static shr_error_e
dnx_qos_ingress_cs_profile_map_set(
    ...
    uint32 flags,
    int map_id,
    dbal_enum_value_field_qos_cs_profile_e cs_profile)
{
    uint32 entry_handle_id;
    int table_id;
    ...
    {
        table_id = DBAL_TABLE_QOS_INGRESS_ECN_PROFILE_INFO;
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "flags [%x] not supported yet\n", flags);
    ...
    bcm_qos_map_t * map_entry)
{
    ...
    else if (flags & BCM_QOS_MAP_L3_L2)
    {
        SHR_IF_ERR_EXIT(dnx_qos_ingress_cs_profile_map_set
                        (unit, flags, map_id, DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_NEXT_LAYER));
    }
    ...
    {
        SHR_IF_ERR_EXIT(dnx_qos_ingress_ecn_map_add(unit, flags, map_id, map_entry));
    }
    else
    {
    ...
    bcm_qos_map_t * map_entry)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_qos_ingress_cs_profile_map_set
                        (unit, flags, map_id, DBAL_ENUM_FVAL_QOS_CS_PROFILE_USE_CURRENT_LAYER));
    }
    else if (((flags & BCM_QOS_MAP_L2) && (flags & BCM_QOS_MAP_L2_UNTAGGED)) || (flags & BCM_QOS_MAP_PORT))
    {
        /** use explicit mapping */
    ...
    {
        SHR_IF_ERR_EXIT(dnx_qos_ingress_ecn_map_delete(unit, flags, map_id, map_entry));
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "flags [%x] not supported yet\n", flags);
    ...
    bcm_qos_map_t * map)
{
    ...
    if (flags & (BCM_QOS_MAP_L2_OUTER_TAG | BCM_QOS_MAP_L2_INNER_TAG))
    {
    ...
    int *array_count)
{
    ...
    else if (flags & (BCM_QOS_MAP_PHB | BCM_QOS_MAP_REMARK | BCM_QOS_MAP_ECN))
    {
    ...
    int ing_map)
{
    ...
    if (is_physical_port)
    {
        ...
        for (pp_port_index = 0; pp_port_index < gport_info.internal_port_pp_info.nof_pp_ports; pp_port_index++)
        {
            ...
            else if (DNX_QOS_MAP_IS_ECN(ing_map))
            {
    ...
    else
    {
        ...
        if (DNX_QOS_MAP_IS_PHB(ing_map) && DNX_QOS_MAP_IS_REMARK(ing_map))
        {
            if ((dbal_table_id == DBAL_TABLE_IN_AC_INFO_DB) && (profile_ndx > DNX_QOS_ING_AC_MAX_PROFILE))
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "trying to set too big QOS map ID for AC table, the limit is 6 bits[0x%x]\n",
                             profile_ndx);
            }
            else
            {
    ...
    uint32 flags)
{
    ...
    *ing_map = BCM_DNX_QOS_MAP_INVALID_ID;
    ...
    if (is_physical_port)
    {
        ...
        /** get map value  according map type*/
        if (flags & BCM_QOS_MAP_ECN)
        {
            dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_ECN_MAPPING_PROFILE, INST_SINGLE,
                                                &profile_ndx);
        }
        else
        {
    ...
    else
    {
        ...
        if (flags & BCM_QOS_MAP_ECN)
        {
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                            (unit, entry_handle_id, DBAL_FIELD_ECN_MAPPING_PROFILE, INST_SINGLE, &profile_ndx));
        }
        else if (flags & BCM_QOS_MAP_L2_VLAN_PCP)
        {
    ...
    if (profile_ndx != BCM_DNX_QOS_MAP_INVALID_ID)
    {
        ...
        {
            *ing_map = profile_ndx;
            SHR_IF_ERR_EXIT(algo_qos_db.ingress_qos_ecn.is_allocated(unit, profile_ndx, &is_allocated));
            if (is_allocated)
            {
                /** set map ecn */
                DNX_QOS_ECN_MAP_SET(*ing_map);
            }
            else
            {
    ...
    dnx_qos_propagation_type_e * ttl_propagation_type)
{
    ...
    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.profile_data_get
                    (unit, _SHR_CORE_ALL, propagation_profile, &reference_counter, &propagation_profile_type));
    ...
    uint8 *is_last)
{
    ...
    *is_last = FALSE;
     ...
     */
    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.profile_data_get
                    (unit, _SHR_CORE_ALL, old_propagation_profile, &reference_counter, &propagation_profile_type));
    ...
    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.exchange
                    (unit, _SHR_CORE_ALL, 0, &propagation_profile_type, old_propagation_profile,
    ...
    uint8 *last_reference)
{
    ...
    *last_reference = FALSE;
    ...
    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.profile_data_get
                    (unit, _SHR_CORE_ALL, new_propag_profile, &ref_count, &propagation_profile_type));

    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.exchange
                    (unit, _SHR_CORE_ALL, 0, &propagation_profile_type, propagation_profile,
