...
const __imb__dispatch__t__ imb_imb_ile_driver = {
    ...
    NULL,       /* imb_prd_flex_key_construct_set */
    NULL,       /* imb_prd_flex_key_construct_get */
    ...
    NULL,       /* imb_prd_is_custom_ether_type_get */
    ...
    NULL,       /* imb_phys_get */
    NULL,       /* imb_pms_reset_set */
    NULL,       /* imb_pms_reset_get */
