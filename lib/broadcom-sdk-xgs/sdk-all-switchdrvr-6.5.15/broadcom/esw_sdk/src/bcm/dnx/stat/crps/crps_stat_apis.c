    ...
    DNXCMN_CORES_ITER(unit, engine->core_id, core_idx)
    {
        ...
        switch (control)
        {
            ...
            case bcmStatCounterSequentialSamplingInterval:
                /** check for correct source - Eviction is not allowed for some sources  (I-OAM/E-OAM)  */
...
*   * None
* \remark 
*   can be called only if engine is fully disable (counting and eviction disabled) 
* \see
*   * None
*/
int
