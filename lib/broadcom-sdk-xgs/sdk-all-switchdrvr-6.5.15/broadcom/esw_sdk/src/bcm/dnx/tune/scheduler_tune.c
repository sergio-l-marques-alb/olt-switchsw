    ...
    int unit)
{
    int default_slow_rates[8] = {
        10,   /** level 0 -- rate in GBits per second */
        20,   /** level 1 -- rate in GBits per second */
        40,  /** level 2 -- rate in GBits per second */
        80,  /** level 3 -- rate in GBits per second */
        160,  /** level 4 -- rate in GBits per second */
        240,  /** level 5 -- rate in GBits per second */
        340,  /** level 6 -- rate in GBits per second */
        400   /** level 7 -- rate in GBits per second */
    };
