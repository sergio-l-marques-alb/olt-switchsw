    ...
    bcm_mpls_range_action_t * action_p)
{
    ...
    }
    {
         ...
         */
        int num_labels = 2;
        bcm_mpls_label_t in_labels[num_labels];
        ...
        in_labels[0] = label_low;
        in_labels[1] = label_high;
    ...
    bcm_mpls_label_t label_high)
{
     ...
     */
    SHR_IF_ERR_EXIT(dnx_mpls_range_action_evpn_iml_remove(unit, range_profile));
exit:
    SHR_FUNC_EXIT;
}
