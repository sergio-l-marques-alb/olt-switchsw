    ...
    bcm_tunnel_terminator_t * info)
{
    ...
    /** tunnel_if field is no longer supported, as tunnel LIF no longer points to RIF */
    if (info->tunnel_if != BCM_IF_INVALID)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "bcm_tunnel_term does not support tunnel_if field");
    }
    ...
    /** Verify the udp source and destination port are not supplied as API input*/
    if ((info->udp_src_port != 0) || (info->udp_dst_port != 0))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "UDP Source and Destination port are no longer user input");
    }
...
/**
 * \brief Get result type according to tunnel type.
 */
static shr_error_e
dnx_tunnel_terminator_dbal_result_type_get(
    int unit,
    bcm_tunnel_type_t tunnel_type,
    uint32 *result_type)
{
    ...
    {
        *result_type = DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1;
    }
    else
    {
        *result_type = DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_3;
    }
    SHR_EXIT();
    ...
    bcm_tunnel_type_t * tunnel_type)
{
    ...
    *vrf = vrf_value;
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field_arr32_get
                    (unit, entry_handle_id, DBAL_FIELD_IRPP_CROSS_STAGE_VAR_2, INST_SINGLE, local_inlif));
    ...
    uint32 local_inlif)
{
    ...
    SHR_IF_ERR_EXIT(algo_tunnel_db.tunnel_ipv6_sip_profile.allocate_single
                    (unit, _SHR_CORE_ALL, 0, info->sip6, NULL, &sip_profile_id, &first_reference));
    ...
    uint32 local_inlif)
{
    ...
    if (_SHR_IS_FLAG_SET(info->flags, BCM_TUNNEL_TERM_BUD))
    {
        SHR_IF_ERR_EXIT(dnx_field_entry_access_id_create
                        (unit, core, DBAL_TABLE_IPV6_MP_TT_TCAM_2ND_PASS,
                         _shr_ip6_mask_length(info->dip6_mask), &entry_access_id));
        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_IPV6_MP_TT_TCAM_2ND_PASS, &entry_handle_id));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_field_entry_access_id_create
                        (unit, core, DBAL_TABLE_IPV6_MP_TT_TCAM_BASIC,
                         _shr_ip6_mask_length(info->dip6_mask), &entry_access_id));
    ...
    uint32 *local_inlif)
{
    ...
    SHR_IF_ERR_EXIT(algo_tunnel_db.tunnel_ipv6_sip_profile.profile_get
                    (unit, _SHR_CORE_ALL, info->sip6, &sip_profile_id));
    ...
    bcm_tunnel_terminator_t * info)
{
    ...
    SHR_IF_ERR_EXIT(algo_tunnel_db.
                    tunnel_ipv6_sip_profile.profile_get(unit, _SHR_CORE_ALL, info->sip6, &sip_profile_id));

    SHR_IF_ERR_EXIT(algo_tunnel_db.
                    tunnel_ipv6_sip_profile.free_single(unit, _SHR_CORE_ALL, sip_profile_id, &last_reference));
 ...
 */
static shr_error_e
dnx_tunnel_terminator_in_lif_table_set(
    int unit,
    bcm_tunnel_terminator_t * info,
    ...
    uint32 local_inlif)
{
    ...
    /*
     * get result type according to tunnel type
     */
    SHR_IF_ERR_EXIT(dnx_tunnel_terminator_dbal_result_type_get(unit, info->type, &result_type));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IN_LIF_PROFILE, INST_SINGLE,
                                 (uint32) in_lif_profile);
    /*
     * Set fodo assignment mode only when result type is IN_LIF_IPVX_1
     */
    if (result_type == DBAL_RESULT_TYPE_IN_LIF_IPvX_TUNNELS_IN_LIF_IPVX_1)
    {
 ...
 *   \param [out] global_inlif - Global in-LIF id.
    ...
    uint32 *in_lif_profile)
{
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                    (unit, entry_handle_id, DBAL_FIELD_GLOB_IN_LIF, INST_SINGLE, global_inlif));
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                    (unit, entry_handle_id, DBAL_FIELD_PROPAGATION_PROF, INST_SINGLE, (uint32 *) propagation_prof));
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
...
/**
 * \brief
 * Delete an entry from IP tunnel termination in-LIF table.
 *
 *   \param [in] unit - Relevant unit.
 *   \param [in] local_inlif - The local in-LIF ID whose entry
 *   \param [in] result_type - Result type
 *          should be deleted.
 */
static shr_error_e
dnx_tunnel_terminator_in_lif_table_delete(
    int unit,
    uint32 local_inlif,
    int result_type)
{
    ...
    uint32 *fodo_assignment_mode)
{
     ...
     */
    if ((tunnel_type == bcmTunnelTypeVxlanGpe) || (tunnel_type == bcmTunnelTypeVxlan6Gpe))
    {
        *fodo_assignment_mode = DBAL_ENUM_FVAL_FORWARD_DOMAIN_ASSIGNMENT_MODE_FORWARD_DOMAIN_FROM_LOOKUP;
    }
    else
    {
    ...
    bcm_tunnel_terminator_t * info)
{
    ...
    if (!_SHR_IS_FLAG_SET(info->flags, BCM_TUNNEL_REPLACE))
    {
        ...
        inlif_info.dbal_table_id = DBAL_TABLE_IN_LIF_IPvX_TUNNELS;
        ...
        SHR_IF_ERR_EXIT(dnx_lif_lib_allocate(unit, lif_alloc_flags, &global_lif, &inlif_info, NULL));
        ...
        SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_set
                        (unit, info, propag_profile, fodo_assignment_mode, (uint32) new_in_lif_profile,
                         inlif_info.local_inlif));

        
        SHR_IF_ERR_EXIT(dnx_tunnel_terminator_lookup_add(unit, info, inlif_info.local_inlif));
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_get
                        (unit, gport_hw_resources.local_in_lif, gport_hw_resources.inlif_dbal_result_type,
                         &global_inlif, &propag_profile, &in_lif_profile));
        ...
        SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_set
                        (unit, info, propag_profile, fodo_assignment_mode, in_lif_profile,
    ...
    bcm_tunnel_terminator_t * info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_get
                    (unit, local_inlif, result_type, &global_inlif, &propagation_prof, &in_lif_profile));
    ...
    bcm_tunnel_terminator_t * info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_delete(unit, local_inlif, result_type));
    ...
    /** Delete global and local in LIFs */
    sal_memset(&inlif_info, 0, sizeof(inlif_info));
    inlif_info.dbal_table_id = DBAL_TABLE_IN_LIF_IPvX_TUNNELS;
    inlif_info.dbal_result_type = result_type;
    inlif_info.core_id = _SHR_CORE_ALL;
    inlif_info.local_inlif = local_inlif;
    SHR_IF_ERR_EXIT(dnx_lif_lib_free(unit, global_inlif, &inlif_info, LIF_MNGR_INVALID));
    ...
    for (table = 0; table < nof_tables; table++)
    {
        ...
        while (!is_end)
        {
            ...
            if (dbal_tables[table] == DBAL_TABLE_IPV6_TT_P2P_EM_BASIC)
            {
                ...
                SHR_IF_ERR_EXIT(algo_tunnel_db.
                                tunnel_ipv6_sip_profile.profile_data_get(unit, _SHR_CORE_ALL, sip_profile_id,
                                                                         &ref_count, (void *) &info.sip6));
                SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
                ...
                while (!is_end_ipv6)
                {
                            ...
                            DNX_TUNNEL_TERM_LOCAL_IN_LIF_ENCODING))
                    {
                        ...
                        SHR_IF_ERR_EXIT(dnx_tunnel_terminator_dbal_result_type_get(unit, type, &result_type));
                        /** Get entry from IP tunnel in-LIF table */
                        SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_get
                                        (unit, local_inlif_p2p, result_type, &global_inlif, &propagation_prof,
                                         &in_lif_profile));
                        /** Set tunnel_id */
                        BCM_GPORT_TUNNEL_ID_SET(info.tunnel_id, global_inlif);
                        break;
                     ...
                     || (dbal_tables[table] == DBAL_TABLE_IPV6_MP_TT_TCAM_BASIC))
            {
                ...
                if ((local_inlif & DNX_TUNNEL_TERM_LOCAL_IN_LIF_ENCODING) == DNX_TUNNEL_TERM_LOCAL_IN_LIF_ENCODING)
                {
                    ...
                    /** Get entry from IP tunnel in-LIF table */
                    SHR_IF_ERR_EXIT(dnx_tunnel_terminator_in_lif_table_get
                                    (unit, local_inlif, result_type, &global_inlif, &propagation_prof,
                                     &in_lif_profile));
                    /** Set tunnel_id */
                    BCM_GPORT_TUNNEL_ID_SET(info.tunnel_id, global_inlif);
                }
            ...
            else
            {
                    ...
                    || (dbal_tables[table] == DBAL_TABLE_IPV4_TT_TCAM_2ND_PASS))
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_masked_get
                                    (unit, entry_handle_id, DBAL_FIELD_IPV4_DIP, &info.dip, &info.dip_mask));
                    SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_masked_get
                                    (unit, entry_handle_id, DBAL_FIELD_IPV4_SIP, &info.sip, &info.sip_mask));
                }
                else
                {
                    SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
