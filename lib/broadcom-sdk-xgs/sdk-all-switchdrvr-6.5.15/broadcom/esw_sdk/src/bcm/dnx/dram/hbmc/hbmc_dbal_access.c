...
dnx_hbmc_get_sequential_channel(
    ...
    int channel_in_hbm)
{
    return hbm_index * dnx_data_dram.hbm.nof_channels_get(unit) + channel_in_hbm;
}
    ...
    uint32 data)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                               dnx_hbmc_get_sequential_channel(unit, hbm_index, channel));
    ...
    int enable)
{
    ...
    channels_in_hbm = dnx_data_dram.hbm.nof_channels_get(unit);
    dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                                     dnx_hbmc_get_sequential_channel(unit, hbm_index, 0),
                                     dnx_hbmc_get_sequential_channel(unit, hbm_index, channels_in_hbm - 1));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ENABLE_DYNAMIC_MEMORY_ACCESS, INST_SINGLE,
                                 enable ? 1 : 0);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int unit)
{
    ...
    nof_channels = dnx_data_dram.hbm.nof_channels_get(unit);
    ...
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_index)
    {
        dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                                         dnx_hbmc_get_sequential_channel(unit, hbm_index, 0),
                                         dnx_hbmc_get_sequential_channel(unit, hbm_index, nof_channels - 1));
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    }
    ...
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_index)
    {
        dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL, (hbm_index * nof_channels),
                                         ((hbm_index + 1) * nof_channels - 1));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 0, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 0)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 1, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 1)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 2, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 2)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 3, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 3)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 4, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 4)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 5, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 5)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 6, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 6)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFISB_N, 7, dnx_hbmc_ns_to_clock(unit, dnx_data_dram.general_info.refresh_intervals_get(unit, 7)->trefisb));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 0, dnx_data_dram.general_info.refresh_intervals_get(unit, 0)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 1, dnx_data_dram.general_info.refresh_intervals_get(unit, 1)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 2, dnx_data_dram.general_info.refresh_intervals_get(unit, 2)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 3, dnx_data_dram.general_info.refresh_intervals_get(unit, 3)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 4, dnx_data_dram.general_info.refresh_intervals_get(unit, 4)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 5, dnx_data_dram.general_info.refresh_intervals_get(unit, 5)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 6, dnx_data_dram.general_info.refresh_intervals_get(unit, 6)->trefi);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TREFI_N, 7, dnx_data_dram.general_info.refresh_intervals_get(unit, 7)->trefi);
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_index)
    {
        dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                                         dnx_hbmc_get_sequential_channel(unit, hbm_index, 0),
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TRFC, INST_SINGLE, dnx_data_dram.general_info.timing_params_get(unit)->trfc);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TRFCSB, INST_SINGLE, dnx_data_dram.general_info.timing_params_get(unit)->trfcsb);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TRREFD, INST_SINGLE, dnx_data_dram.general_info.timing_params_get(unit)->trrefd);
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_index)
    {
        dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                                         dnx_hbmc_get_sequential_channel(unit, hbm_index, 0),
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TMRD, INST_SINGLE, dnx_data_dram.general_info.timing_params_get(unit)->tmrd);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBM_TMOD, INST_SINGLE, dnx_data_dram.general_info.timing_params_get(unit)->tmod);
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_index)
    {
        dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                                         dnx_hbmc_get_sequential_channel(unit, hbm_index, 0),
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MAX_READ_INFLIGHTS_DS_N, 0, 256);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MAX_READ_INFLIGHTS_DS_N, 1, 256);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MAX_WRITE_INFLIGHTS_DS_N, 0, 256);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MAX_WRITE_INFLIGHTS_DS_N, 1, 256);
    SHR_BIT_ITER(dram_bitmap, nof_hbms, hbm_index)
    {
        dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                                         dnx_hbmc_get_sequential_channel(unit, hbm_index, 0),
...
{
    int first_channel = dnx_hbmc_get_sequential_channel(unit, hbm_index, 0);
    int last_channel = dnx_hbmc_get_sequential_channel(unit, hbm_index, dnx_data_dram.hbm.nof_channels_get(unit) - 1);
    uint32 entry_handle_id;
    ...
    dbal_entry_key_field32_range_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL, first_channel, last_channel);
    ...
    int channel_index)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_HCC_HBM_MODE_REGISTERS, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL,
                               dnx_hbmc_get_sequential_channel(unit, hbm_index, channel_index));
    ...
    int unit)
{
    ...
    else
    {
        ...
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DATA_SOURCE_ID, 0, 0);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DATA_SOURCE_ID, 1, 1);
    }
    ...
    /** in the dram we have a mechanism which consists of 2 leaky buckets to control when it should be
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 ...
                                 INST_SINGLE, 4000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_ASSERT_THRESHOLD, INST_SINGLE,
                                 16);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_DEASSERT_THRESHOLD, INST_SINGLE,
                                 4);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_INCREMENT_SIZE_0, INST_SINGLE,
                                 1);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_INCREMENT_SIZE_1, INST_SINGLE,
                                 2);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_INCREMENT_SIZE_2, INST_SINGLE,
                                 4);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_FULL_SIZE,
                                 INST_SINGLE, 50);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DECREMENT_THRESHOLD_0,
                                 INST_SINGLE, 0 * 400 * dnx_data_dram.general_info.frequency_get(unit) / 1000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DECREMENT_THRESHOLD_1,
                                 INST_SINGLE, 5 * 400 * dnx_data_dram.general_info.frequency_get(unit) / 1000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DECREMENT_THRESHOLD_2,
                                 INST_SINGLE, 10 * 400 * dnx_data_dram.general_info.frequency_get(unit) / 1000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DECREMENT_SIZE_0, INST_SINGLE,
                                 0);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DECREMENT_SIZE_1, INST_SINGLE,
                                 0);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DECREMENT_SIZE_2, INST_SINGLE,
                                 0);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_RESET_ON_DEASSERT, INST_SINGLE,
                                 1);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_INCREMENT_SIZE_0, INST_SINGLE, 2);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_INCREMENT_SIZE_1, INST_SINGLE, 3);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_INCREMENT_SIZE_2, INST_SINGLE, 4);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_INCREMENT_THRESHOLD_0,
                                 INST_SINGLE, 91 * 400 * 2 * dnx_data_dram.general_info.frequency_get(unit) / 1000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_INCREMENT_THRESHOLD_1,
                                 INST_SINGLE, 93 * 400 * 2 * dnx_data_dram.general_info.frequency_get(unit) / 1000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_INCREMENT_THRESHOLD_2,
                                 INST_SINGLE, 95 * 400 * 2 * dnx_data_dram.general_info.frequency_get(unit) / 1000);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_PLUS_READ_LEAKY_BUCKET_DECREMENT_SIZE, INST_SINGLE, 1);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_ASSERT_THRESHOLD, INST_SINGLE,
                                 0);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_DEASSERT_THRESHOLD, INST_SINGLE,
                                 0);
    dbal_entry_value_field32_set(unit, entry_handle_id,
                                 DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_RESET_ON_DEASSERT, INST_SINGLE,
                                 1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DRAM_BLOCKED_WRITE_MINUS_READ_LEAKY_BUCKET_FULL_SIZE,
                                 INST_SINGLE, 50);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
