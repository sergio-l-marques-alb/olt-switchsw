        ...
        case OAMP_PE_TCAM_KEY_TXO:
            ...
            SHR_IF_ERR_EXIT(dbal_fields_struct_field_encode_masked
                            (unit, DBAL_FIELD_MEP_GENERATED, DBAL_FIELD_MEP_PROFILE,
                             ...
                             &complete_key_val, &complete_key_mask_val));
            SHR_IF_ERR_EXIT(dbal_fields_struct_field_encode_masked
                            (unit, DBAL_FIELD_MEP_GENERATED, DBAL_FIELD_MEP_PE_PROFILE,
                             &tcam_config.key.mep_generated.mep_pe_profile,
                             &tcam_config.key.mep_generated.pe_profile_mask, &complete_key_val,
            ...
            parent_field_id = tcam_config.key_type == OAMP_PE_TCAM_KEY_MEP_GENERATED ? DBAL_FIELD_MEP_GENERATED :
                tcam_config.key_type == OAMP_PE_TCAM_KEY_MEP_RESPONSE ? DBAL_FIELD_MEP_RESPONSE : DBAL_FIELD_TXO_PACKET;

            dbal_entry_key_field32_masked_set(unit, *entry_handle_id, parent_field_id, complete_key_val,
                                              complete_key_mask_val);
            break;
    ...
    dnx_oamp_mep_pe_profile_s mep_pe_profiles[DNX_OAMP_PE_MEP_PE_PROFILE_LAST])
{
    ...
    {
        if (mep_pe_profiles[mep_pe_profile_sw[ii][1]].valid)
        {
            ...
            dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MEP_PE_PROFILE, INST_SINGLE,
                                         mep_pe_profiles[mep_pe_profile_sw[ii][1]].hw_index);
