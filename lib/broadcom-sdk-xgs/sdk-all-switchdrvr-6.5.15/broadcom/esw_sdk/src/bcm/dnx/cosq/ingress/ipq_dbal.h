...
/**
 * \brief - Get mapping from queue quartet to system port.
 *
 * \param [in] unit - chip unit id.
 * \param [in] queue_quartet - queue quartet index.
 * \param [out] system_port - system port mapped to the queue quartet.
 *
 * \return shr_error_e
 */
shr_error_e dnx_cosq_ipq_dbal_queue_quartet_to_sys_port_map_get(
    int unit,
...
/**
 * \brief - Get System port to base VOQ map
 *
 * \param [in] unit - chip unit id.
 * \param [in] system_port - system port to map
 * \param [out] base_voq - voq base  mapped to the system port
 * \param [out] is_valid - is the mapping valid.
 *
 * \return shr_error_e
 */
shr_error_e dnx_cosq_ipq_dbal_system_port_to_voq_base_get(
    int unit,
    uint32 system_port,
    uint32 *base_voq,
    uint32 *is_valid);
 ...
 * \param [in] tc_profile - TC profile (mapped from system port. see dnx_cosq_ipq_dbal_system_port_to_voq_base_tc_profile_set)
 ...
 * \return shr_error_e
 */
shr_error_e dnx_cosq_ipq_dbal_fmq_tc_to_voq_offset_map_set(
    int unit,
    uint32 tc,
    uint32 voq_offset);
 ...
 * \return shr_error_e
 */
shr_error_e dnx_cosq_ipq_dbal_fmq_tc_to_voq_offset_map_get(
    int unit,
    uint32 tc,
    uint32 *voq_offset);
