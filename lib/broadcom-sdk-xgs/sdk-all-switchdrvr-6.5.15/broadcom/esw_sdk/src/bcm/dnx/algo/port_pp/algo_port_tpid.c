...
#include <soc/dnx/swstate/auto_generated/access/port_tpid_access.h>
    ...
    dnx_algo_template_print_t * print_cb_data)
{
     ...
     */
    {
         ...
         */
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "",
        ...
        for (prio_indx = 0; prio_indx < 2; prio_indx++)
        {
            for (outer_tpid_indx = 0; outer_tpid_indx < BCM_DNX_SWITCH_TPID_NUM_OF_GLOBALS; outer_tpid_indx++)
            {
                for (inner_tpid_indx = 0; inner_tpid_indx < BCM_DNX_SWITCH_TPID_NUM_OF_GLOBALS; inner_tpid_indx++)
                {
                    ...
                    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "", "keys = ", NULL, NULL);
                    DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_START();
                    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_INT, "prio_indx", prio_indx,
                                                        "Indicates whether outer tag is priority tag (0) or not (1)",
                                                        NULL);
                    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_INT, "outer_tpid_indx",
                                                        outer_tpid_indx, "Outer TPID index", NULL);
                    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_INT, "inner_tpid_indx",
                                                        inner_tpid_indx, "Inner TPID index", NULL);
                    DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_END();
                    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "data = ", llvp_data_entry,
    ...
    uint32 alloc_flags)
{
    ...
    int tag_struct_range_high[bcmNofTagStructType] =
        { DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_UNTAGGED_2, DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_S_TAG_4,
        DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_C_TAG_8, DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_S_C_TAG_8,
        DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_S_PRIORITY_C_TAG_4
    };
    int tag_struct_range_low[bcmNofTagStructType] =
        { DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_UNTAGGED_1, DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_S_TAG_1,
        DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_C_TAG_1, DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_S_C_TAG_1,
    ...
    res_tag_bitmap_create_info.max_tag_value = bcmNofTagStructType + 1;
    ...
    for (current_tag = 0; current_tag < bcmNofTagStructType; current_tag++)
    {
        SHR_IF_ERR_EXIT(sw_state_resource_tag_bitmap_tag_set
                        (unit, module_id, *res_tag_bitmap, current_tag, TRUE, tag_struct_range_low[current_tag],
                         tag_struct_range_high[current_tag] - tag_struct_range_low[current_tag] + 1));
    }
    ...
    SHR_IF_ERR_EXIT(sw_state_resource_tag_bitmap_tag_set
                    (unit, module_id, *res_tag_bitmap, bcmNofTagStructType, TRUE,
                     DBAL_NOF_ENUM_INCOMING_TAG_STRUCTURE_VALUES,
                     nof_vlan_tag_formats - DBAL_NOF_ENUM_INCOMING_TAG_STRUCTURE_VALUES + 1));
        
    SHR_IF_ERR_EXIT(sw_state_resource_tag_bitmap_tag_set
                    (unit, module_id, *res_tag_bitmap, bcmNofTagStructType, TRUE,
                     DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_C_C_TAG_1, 2));
        
    SHR_IF_ERR_EXIT(sw_state_resource_tag_bitmap_tag_set
                    (unit, module_id, *res_tag_bitmap, bcmNofTagStructType, TRUE,
                     DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_S_S_TAG_1, 2));
...
algo_port_tpid_init(
    int unit)
{
    sw_state_algo_template_create_data_t data_template_mgr;
    sw_state_algo_res_create_data_t data_res_mgr;
     ...
     */
    data_template_mgr.nof_profiles = dnx_data_port_pp.general.nof_ingress_llvp_profiles_get(unit) - 1;
     ...
     */
    data_res_mgr.flags = SW_STATE_ALGO_RES_CREATE_USE_ADVANCED_ALGORITHM;
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    rv = algo_port_tpid_print_ingress(unit, data, print_cb_data);
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    rv = algo_port_tpid_print_egress(unit, data, print_cb_data);
