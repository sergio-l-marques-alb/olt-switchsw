    ...
    uint32 flags)
{
    ...
    if (!(flags & BCM_COSQ_DISCARD_ENABLE))
    {
        ...
        SHR_IF_ERR_EXIT(dbal_table_clear(unit, DBAL_TABLE_METER_EGRESS_DISCARD_ENABLE));
    }
    else
    {
