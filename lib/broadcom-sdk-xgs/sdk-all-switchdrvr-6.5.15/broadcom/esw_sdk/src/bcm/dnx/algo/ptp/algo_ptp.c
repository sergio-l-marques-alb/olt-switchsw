...
#include <soc/dnx/swstate/auto_generated/access/algo_ptp_access.h>
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, NULL, "ptp (1588) port profile info:", NULL,
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "ptp_enabled", profile_info->ptp_enabled, NULL,
                                        "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "flags", profile_info->flags, NULL, "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "pkt_drop", profile_info->pkt_drop, NULL,
                                        "0x%x");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "pkt_tocpu", profile_info->pkt_tocpu, NULL,
                                        "0x%x");
    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_PTP_PORT_TEMPLATE_NAME, SW_STATE_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);
