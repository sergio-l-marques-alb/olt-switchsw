    ...
    int unit)
{
    ...
    /*
     * set the defult standard value of channel type for Y1731 over PWE
     */
    ...
    /*
     *  set the defult channel type value for BFD over PWE
     */
    ...
    /*
     * set the defult channel type value for Y1731 over MPLS TP
     */
