    ...
    dnx_meter_profile_info_t * profile_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_meter_utils_profile_rate_to_res_exp_mnt(unit, cir, &reverse_exponent,
    ...
    dnx_meter_profile_info_t * profile_info)
{
    ...
    /** calc cir */
    SHR_IF_ERR_EXIT(dnx_sand_compute_complex_to_mnt_exp_reverse_exp(rate_mantissa,
                                                                    rate_exp,
                                                                    reverse_exponent,
                                                                    core_clock_freq,
                                                                    DNX_METER_UTILS_MHZ_TO_KBITS_PER_SEC,
                                                                    DNX_METER_UTILS_RATE_MANT_CONST_VAL,
                                                                    TRUE, &profile_info->cir));
    /** calc max_cir. max_cir should be the same as cir, but we get it from HW as is */
    SHR_IF_ERR_EXIT(dnx_sand_compute_complex_to_mnt_exp_reverse_exp(max_rate_mantissa,
                                                                    max_rate_exp,
                                                                    reverse_exponent,
                                                                    core_clock_freq,
                                                                    DNX_METER_UTILS_MHZ_TO_KBITS_PER_SEC,
                                                                    DNX_METER_UTILS_RATE_MANT_CONST_VAL,
                                                                    TRUE, &profile_info->max_cir));
