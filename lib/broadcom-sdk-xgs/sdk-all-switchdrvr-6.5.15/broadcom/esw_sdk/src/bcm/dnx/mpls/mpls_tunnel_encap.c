    ...
    bcm_mpls_egress_label_t * label_array)
{
    ...
    if ((label_array[0].l3_intf_id != 0) && !BCM_L3_ITF_TYPE_IS_LIF(label_array[0].l3_intf_id))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "next outlif pointer RIF is no longer supported, must be LIF type, l3_intf_id=0x%x",
    ...
    /** encap stage */
    if ((label_array[0].encap_access < bcmEncapAccessInvalid) || (label_array[0].encap_access > bcmEncapAccessArp))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "label_array[0].encap_access (%d) is invalid, supported values are %d - %d",
                     label_array[0].encap_access, bcmEncapAccessInvalid, bcmEncapAccessArp);
    }
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "EXP model only support bcmQosEgressModelUniform, bcmQosEgressModelPipeMyNameSpace, bcmQosEgressModelPipeNextNameSpace");
    }
    if ((label_array[0].egress_qos_model.egress_qos != bcmQosEgressModelPipeNextNameSpace) &&
        (label_array[0].egress_qos_model.egress_qos != bcmQosEgressModelPipeMyNameSpace))
    {
    ...
    if (num_labels == DNX_MPLS_TUNNEL_ENCAP_TWO_LABELS)
    {
            ...
            (label_array[0].egress_qos_model.egress_qos == bcmQosEgressModelPipeMyNameSpace))
        {
            ...
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "two labels in mode EXP_SET, but different exp_value."
    ...
    uint32 flags)
{
    if (has_cw)
    {
        ...
        {
            return DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_CWOELOELI_OR_LIF_AHP_GRE4;
        }
        else if (flags & BCM_MPLS_EGRESS_LABEL_ENTROPY_ENABLE)
        {
            /** In PWE EL without ELI is flow label */
            return DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_CWOFL_OR_LIF_AHP_GENEVE;
        }
        else
        {
            return DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_CW_OR_LIF_AHP_GRE12;
        }
    }
    else
    {
        ...
        {
            /** In PWE EL without ELI is flow label */
            return DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_FL_OR_LIF_AHP_GRE8_W_KEY_TNI_FROM_ENTRY_V6;
        }
        else if ((flags & BCM_MPLS_EGRESS_LABEL_ENTROPY_ENABLE)
                 && (flags & BCM_MPLS_EGRESS_LABEL_ENTROPY_INDICATION_ENABLE))
        {
            return DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_VXLAN_OR_LIF_AHP_ELOELI_OR_LIF_AHP_GRE8_W_KEY;
        }
    }

    return DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_NONE;
}
    ...
    uint32 *flags)
{
    ...
    {
        case DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_CWOELOELI_OR_LIF_AHP_GRE4:
            *has_cw = 1;
            *flags |= BCM_MPLS_EGRESS_LABEL_ENTROPY_ENABLE | BCM_MPLS_EGRESS_LABEL_ENTROPY_INDICATION_ENABLE;
            break;
        case DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_CWOFL_OR_LIF_AHP_GENEVE:
            *has_cw = 1;
            *flags |= BCM_MPLS_EGRESS_LABEL_ENTROPY_ENABLE;
            break;
        case DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_CW_OR_LIF_AHP_GRE12:
            *has_cw = 1;
            break;
        case DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_FL_OR_LIF_AHP_GRE8_W_KEY_TNI_FROM_ENTRY_V6:
            *flags |= BCM_MPLS_EGRESS_LABEL_ENTROPY_ENABLE;
            break;
        case DBAL_ENUM_FVAL_LIF_ADDITIONAL_HEADER_PROFILE_LIF_AHP_VXLAN_OR_LIF_AHP_ELOELI_OR_LIF_AHP_GRE8_W_KEY:
            *flags |= BCM_MPLS_EGRESS_LABEL_ENTROPY_ENABLE | BCM_MPLS_EGRESS_LABEL_ENTROPY_INDICATION_ENABLE;
            break;
        default:
            *has_cw = 0;
    ...
    uint8 *qos_pipe_profile_last_reference)
{
    ...
    if (update)
    {
        ...
        if (new_is_pipe && old_is_pipe)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_qos_egress_network_qos_pipe_profile_update(unit, encap_info->label_array[0].exp,
        ...
        else if (new_is_pipe && !old_is_pipe)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_qos_egress_network_qos_pipe_profile_allocate(unit, encap_info->label_array[0].exp,
                                                                             encap_info->label_array[0].exp, 0,
...

        {
            ...
            SHR_IF_ERR_EXIT(algo_qos_db.qos_egress_ttl_pipe_profile.exchange
                            (unit, _SHR_CORE_ALL, alloc_flags, (int *) &encap_info->label_array[0].ttl,
        ...
        else if (encap_info->label_array[0].egress_qos_model.egress_ttl == bcmQosEgressModelPipeMyNameSpace)
        {
            ...
            SHR_IF_ERR_EXIT(algo_qos_db.qos_egress_ttl_pipe_profile.allocate_single
                            (unit, _SHR_CORE_ALL, alloc_flags, (int *) &encap_info->label_array[0].ttl, NULL,
        ...
        else if (encap_info_orig.label_array[0].egress_qos_model.egress_ttl == bcmQosEgressModelPipeMyNameSpace)
        {
            ...
            SHR_IF_ERR_EXIT(algo_qos_db.qos_egress_ttl_pipe_profile.free_single
                            (unit, _SHR_CORE_ALL, encap_info_orig.ttl_pipe_profile, ttl_pipe_profile_last_reference));
        }
    ...
    if (!(encap_info->label_array[0].action == BCM_MPLS_EGRESS_ACTION_PHP) &&
            (encap_info->labels_nof < DNX_MPLS_TUNNEL_ENCAP_TWO_LABELS))
    {
        SHR_IF_ERR_EXIT(dnx_egress_outlif_profile_alloc
                        (unit, network_group_id, out_lif_profile_orig, &(encap_info->out_lif_profile), dbal_table_id, 0));
    }
    ...
    dnx_mpls_encap_t * encap_info)
{
    ...
    SHR_IF_ERR_EXIT(algo_qos_db.qos_egress_ttl_pipe_profile.profile_data_get
                    (unit, _SHR_CORE_ALL, encap_info->ttl_pipe_profile, &reference_counter,
                     (int *) &encap_info->label_array[0].ttl));
    ...
    lif_table_mngr_outlif_info_t * outlif_info)
{
    ...
    /*
     * If not php, MPLS LABEL field is required
     */
    if (!(encap_info->label_array[0].action == BCM_MPLS_EGRESS_ACTION_PHP))
    {
        ...
        else
        {
            ...
            dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL, INST_SINGLE,
                                         encap_info->label_array[1].label);
     ...
     */
    if (encap_info->label_array[0].l3_intf_id != 0)
    {
    ...
    SHR_IF_ERR_EXIT(dnx_qos_egress_model_type_to_model
                    (unit, encap_info->label_array[0].egress_qos_model.egress_qos, &encap_qos_model));
    ...
    if (!(encap_info->label_array[0].action == BCM_MPLS_EGRESS_ACTION_PHP))
    {
        ...
        /*
         * EVPN -
         * IML labels have no AHP, since in case ESI is added, need to get the AHP
         * from the DUAL_HOMING entry.
         */
        if (dbal_table_id != DBAL_TABLE_EEDB_EVPN)
        {
            /** set additional headers profile for special labels */
            ...
            {
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LIF_ADDITIONAL_HEADER_PROFILE,
    ...
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LLVP_PROFILE, INST_SINGLE,
    ...
    if (encap_info->labels_nof == DNX_MPLS_TUNNEL_ENCAP_TWO_LABELS)
    {
        outlif_info->table_specific_flags |= DNX_ALGO_LIF_TABLE_SPECIFIC_MPLS_ENCAP_SECOND_LABEL_EXISTS;
    }
    ...
    dnx_mpls_encap_t * encap_info)
{
    ...
    bcm_qos_egress_model_type_t model_type;
    dbal_tables_e dbal_table_id;
    ...
    if (_SHR_IS_FLAG_SET(outlif_info->table_specific_flags, DNX_ALGO_LIF_TABLE_SPECIFIC_MPLS_ENCAP_SECOND_LABEL_EXISTS))
    {
    ...
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_is_field_exist_on_dbal_handle
                    (unit, entry_handle_id, DBAL_FIELD_TTL_MODE, &is_field_valid));
    ...
    if (is_field_valid == TRUE)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_qos_egress_model_to_model_type(unit, qos_model, &model_type));
        encap_info->label_array[0].egress_qos_model.egress_qos = model_type;
        if (_SHR_IS_FLAG_SET
            (outlif_info->table_specific_flags, DNX_ALGO_LIF_TABLE_SPECIFIC_MPLS_ENCAP_SECOND_LABEL_EXISTS))
        {
            encap_info->label_array[1].egress_qos_model.egress_qos = model_type;
        }

        if ((model_type == bcmQosEgressModelPipeNextNameSpace) || (model_type == bcmQosEgressModelPipeMyNameSpace))
        {
            if (!_SHR_IS_FLAG_SET(outlif_info->table_specific_flags, DNX_ALGO_LIF_TABLE_SPECIFIC_MPLS_ENCAP_PHP))
            {
    ...
    /*
     * EVPN -
     * IML entries do not have AHP by design - so as to get the AHP from DUAL_HOMING
     * entries if they exist in the encapsulation stack.
     */
    if ((dbal_table_id != DBAL_TABLE_EEDB_EVPN)
        && !_SHR_IS_FLAG_SET(outlif_info->table_specific_flags, DNX_ALGO_LIF_TABLE_SPECIFIC_MPLS_ENCAP_PHP))
    {
        /** Get additional headers profile */
        SHR_IF_ERR_EXIT(dnx_lif_table_mngr_is_field_exist_on_dbal_handle
                        (unit, entry_handle_id, DBAL_FIELD_LIF_ADDITIONAL_HEADER_PROFILE, &is_field_valid));
        if (is_field_valid == TRUE)
        {
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
    ...
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_is_field_exist_on_dbal_handle
                    (unit, entry_handle_id, DBAL_FIELD_NEXT_OUTLIF_POINTER, &is_field_valid));
    if (is_field_valid == TRUE)
    {
        SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                        (unit, entry_handle_id, DBAL_FIELD_NEXT_OUTLIF_POINTER, INST_SINGLE, &next_pointer));

        if (next_pointer != DNX_MPLS_CFG_LIF_NULL_VALUE)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_gpm_gport_from_lif(unit,
                    ...
                    _SHR_CORE_ALL, next_pointer, &next_gport));
    ...
    if (is_field_valid == TRUE)
    {
        SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get(unit, entry_handle_id, DBAL_FIELD_OUT_LIF_PROFILE,
                                                            INST_SINGLE, (uint32 *) &encap_info->out_lif_profile));
    }
    ...
    {
        SHR_IF_ERR_EXIT(dnx_lif_table_mngr_is_field_exist_on_dbal_handle
                        (unit, entry_handle_id, DBAL_FIELD_LLVP_PROFILE, &is_field_valid));
        if (is_field_valid == TRUE)
        {
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                            (unit, entry_handle_id, DBAL_FIELD_LLVP_PROFILE, INST_SINGLE,
    ...
    bcm_mpls_port_t * mpls_port)
{
    ...
    SHR_IF_ERR_EXIT(algo_mpls_db.push_profile.profile_data_get(unit, _SHR_CORE_ALL, push_cmd, &ref_count,
                                                               &push_profile_info));
    ...
    uint8 *is_last_push_profile_reference)
{
    ...
    alloc_flags = *push_profile ? SW_STATE_ALGO_TEMPLATE_ALLOCATE_WITH_ID : 0;
    if (is_last_push_profile_reference == NULL)
    {
        SHR_IF_ERR_EXIT(algo_mpls_db.push_profile.allocate_single
                        (unit, _SHR_CORE_ALL, alloc_flags, &push_profile_info, NULL, push_profile,
                         is_first_push_profile_reference));
    }
    else
    {
        SHR_IF_ERR_EXIT(algo_mpls_db.push_profile.exchange
                        (unit, _SHR_CORE_ALL, 0, &push_profile_info, old_push_profile, NULL, push_profile,
    ...
    uint8 *is_last)
{
    ...
    SHR_IF_ERR_EXIT(algo_mpls_db.push_profile.free_single(unit, _SHR_CORE_ALL, push_profile, is_last));
    ...
    int push_profile)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ESEM_COMMAND, INST_SINGLE, 0);
    ...
    dnx_mpls_encap_t * encap_info)
{
    ...
    encap_info->label_array[0].egress_qos_model.egress_qos = model_type;
    if ((model_type == bcmQosEgressModelPipeMyNameSpace) || (model_type == bcmQosEgressModelPipeNextNameSpace))
    {
        uint32 nwk_qos_id;
    ...
    int *push_cmd)
{
    ...
    if (is_replace)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_mpls_push_profile_allocation
                        (unit, push_profile_info, push_cmd, *push_cmd, &is_first_push_profile_reference,
    ...
    if (is_first_push_profile_reference)
    {
        ...
        /** allocate lif, TTL and qos profiles if needed */
        SHR_IF_ERR_EXIT(dnx_mpls_egress_lif_ttl_qos_profiles_sw_allocate
                        (unit, 0, DNX_OUT_LIF_PROFILE_DEFAULT_ORIENTATION, DBAL_TABLE_EEDB_MPLS_TUNNEL,
    ...
    if (is_last_push_profile_reference)
    {
        ...
        if (encap_info.label_array[0].egress_qos_model.egress_ttl == bcmQosEgressModelPipeMyNameSpace)
        {
            SHR_IF_ERR_EXIT(algo_qos_db.
                            qos_egress_ttl_pipe_profile.free_single(unit, _SHR_CORE_ALL, encap_info.ttl_pipe_profile,
    ...
    void *user_data)
{
    ...
    while (!is_end)
    {
        bcm_mpls_egress_label_t label_array[label_max];
        int label_count;
         ...
         */
        SHR_IF_ERR_EXIT(bcm_dnx_mpls_tunnel_initiator_get(unit, intf, label_max, label_array, &label_count));
        SHR_IF_ERR_EXIT((*cb) (unit, label_count, label_array, user_data));
        /*
        ...
        *label_count = encap_info.labels_nof;
            ...
            (encap_info.label_array[0].egress_qos_model.egress_qos == bcmQosEgressModelPipeMyNameSpace))
        {
            ...
            SHR_IF_ERR_EXIT(dnx_qos_egress_network_qos_pipe_profile_attr_get(unit, encap_info.nwk_qos_id,
                                                                             ...
                                                                             &dp_pipe_mapped));
            encap_info.label_array[0].exp = nwk_pipe_mapped;
            if (encap_info.labels_nof > 1)
            {
                encap_info.label_array[1].exp = encap_info.label_array[0].exp;
            }
        }
    ...
    bcm_if_t intf)
{
    ...
    else
    {
        ...
        if (label_array[0].action != BCM_MPLS_EGRESS_ACTION_PHP)
        {
            if (encap_info.label_array[0].egress_qos_model.egress_ttl == bcmQosEgressModelPipeMyNameSpace)
            {
                SHR_IF_ERR_EXIT(algo_qos_db.qos_egress_ttl_pipe_profile.free_single(unit, _SHR_CORE_ALL,
                                                                                    encap_info.ttl_pipe_profile,
                                                                                    &ttl_last_reference));
            }
            if ((encap_info.label_array[0].egress_qos_model.egress_qos == bcmQosEgressModelPipeNextNameSpace) ||
