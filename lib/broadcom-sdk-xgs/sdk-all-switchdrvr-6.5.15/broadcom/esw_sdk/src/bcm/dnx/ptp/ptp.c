...
#define DNX_PTP_1588        (DBAL_ENUM_FVAL_LAYER_TYPES_PTP_EVENT & DBAL_ENUM_FVAL_LAYER_TYPES_PTP_GENERAL)
#define DNX_PTP_MPLS        (DBAL_ENUM_FVAL_LAYER_TYPES_MPLS & DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UA)
    ...
    uint32 *ret_mask)
{
    ...
    switch (type)
    {
        ...
        case DNX_PTP_MPLS:
            ...
            break;
        case DNX_PTP_1588:
            mask = DBAL_ENUM_FVAL_LAYER_TYPES_PTP_EVENT ^ DBAL_ENUM_FVAL_LAYER_TYPES_PTP_GENERAL;
            /** allowed only one bit different between the types. otherwise, other type will be included by the mask */
            if (utilex_bitstream_get_nof_on_bits(&mask, 1) > 1)
            {
                SHR_ERR_EXIT(_SHR_E_INTERNAL, " illegal mask. type ptp_1588 mask=0x%X. \n", mask);
            }
            break;
        default:
            mask = 0;
...
/*0*/ {{DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_MPLS, DNX_PTP_MPLS, TRUE ,     3        },  /* 1588oEoMPLSoE (MPLS terminated)       */
...
/*5*/  {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , TRUE ,     3        },  /* 1588oEoMPLSoMPLSoE (switched)         */
...
/*8*/  {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_ETH , DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , TRUE ,     4        },  /* "my mac"                              */
/*9*/  {DNX_PTP_ANY , DNX_PTP_IPV4, DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , TRUE ,     4        },  /* 1588oEoMPLSoMPLSoIPv4oAny             */
/*10*/ {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_IPV4, DNX_PTP_ETH , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , TRUE ,     4        },  /* 1588oEoIPv4oMPLSoMPLSoAny             */
/*11*/ {DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_MPLS, DNX_PTP_MPLS, FALSE,     4        },  /* 1588oUDPoIPv4oMPLSoE (MPLS terminated) */
...
/*13*/ {DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_MPLS, DNX_PTP_MPLS, FALSE,     4        },  /* 1588oUDPoIPv6oMPLSoE (MPLS terminated) */
...
/*15*/ {DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_MPLS, DNX_PTP_MPLS, FALSE,     5        },  /* 1588oUDPoIPv4oEoMPLSoE (MPLS terminated) */
...
/*17*/ {DNX_PTP_MPLS, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , FALSE,     4        },  /* 1588oUDPoIPv4oMPLSoE (MPLS routed) */
/*18*/ {DNX_PTP_ETH , DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ETH , DNX_PTP_MPLS, DNX_PTP_MPLS, FALSE,     5        },  /* 1588oUDPoIPv6oEoMPLSoE (MPLS terminated) */
...
/*20*/ {DNX_PTP_MPLS, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , DNX_PTP_ANY , FALSE,     4        },  /* 1588oUDPoIPv6oMPLSoE (MPLS routed) */
...
/*24*/ {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , FALSE,     4        },  /* 1588oUDPoIPv4oMPLSoMPLSoE (switched)   */
...
/*26*/ {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_IPV6, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , DNX_PTP_ANY , FALSE,     4        },  /* 1588oUDPoIPv6oMPLSoMPLSoE (switched)   */
/*27*/ {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_ETH , DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , FALSE,     4        },  /* 1588oUDPoIPv4oEoMPLSoE (switched)   */
/*28*/ {DNX_PTP_ANY , DNX_PTP_MPLS, DNX_PTP_MPLS, DNX_PTP_IPV4, DNX_PTP_IPV4, DNX_PTP_UDP , DNX_PTP_1588, DNX_PTP_ANY , FALSE,     4        }}; /* 1588oUDPoIPv4oIPv4oMPLSoE (switched)  */
    ...
    dnx_ptp_port_profile_info_t * profile_info)
{
    ...
    int action_index, update_ts_compensation = FALSE;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
            ...
            for (none_udp_encap = FALSE; none_udp_encap <= TRUE; none_udp_encap++)
            {
                for (is_two_step = FALSE; is_two_step <= TRUE; is_two_step++)
                {
                    ...
                    if (profile_info->ptp_enabled == FALSE)
                    {
                        ...
                        tp_command = DNX_PTP_ACTION_FIELD_ACTION_INDEX_TRAP;
                        action_index = DBAL_ENUM_FVAL_PTP_TP_COMMAND_NO_STAMPING_NO_RECORDING;
    ...
    bcm_port_timesync_config_t * config_array)
{
    ...
    for (port_idx = 0; port_idx < gport_info.internal_port_pp_info.nof_pp_ports; port_idx++)
    {
        ...
        SHR_IF_ERR_EXIT(algo_ptp_db.ptp_port_profile.exchange(unit, _SHR_CORE_ALL, 0, &profile_info, old_profile, NULL,
    ...
    int *array_count)
{
    ...
    for (port_idx = 0; port_idx < gport_info.internal_port_pp_info.nof_pp_ports; port_idx++)
    {
        ...
        SHR_IF_ERR_EXIT(algo_ptp_db.ptp_port_profile.profile_data_get(unit, _SHR_CORE_ALL, profile_id, &ref_count,
                                                                      &profile_info));
    ...
    uint64 value)
{
    ...
    if (soc_feature(unit, soc_feature_timesync_support))
    {
        switch (type)
        {
            ...
            {
                if (value >= phymodTimesyncCompensationModeCount)
                {
