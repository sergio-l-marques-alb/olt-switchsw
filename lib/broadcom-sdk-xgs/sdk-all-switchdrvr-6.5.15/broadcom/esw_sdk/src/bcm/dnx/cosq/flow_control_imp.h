/** \file src/bcm/dnx/cosq/flow_control_imp.h
 * $Id$
 *
...
/** Number of PFC mapping types that can be selected */
  ...
  /**
 * \brief - Enumerator for the type of FC that the FcIndex refers to in the tables fro Calendars(OOB, COE)
 */
typedef enum
{
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_glb_res_h_llfc_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_glb_res_h_l_pfc_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_glb_res_h_l_oob_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_llfc_vsq_oob_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_pfc_vsq_oob_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_vsq_a_d_oob_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_nif_oob_map(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_glb_res_h_llfc_verify(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_glb_res_h_l_pfc_verify(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_glb_res_h_l_oob_verify(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_to_oob_verify(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
 ...
 *   * None
 */
shr_error_e dnx_fc_gen_pfc_vsq_oob_verify(
    int unit,
    int is_delete,
    bcm_cosq_fc_endpoint_t * source,
    bcm_cosq_fc_endpoint_t * target);
