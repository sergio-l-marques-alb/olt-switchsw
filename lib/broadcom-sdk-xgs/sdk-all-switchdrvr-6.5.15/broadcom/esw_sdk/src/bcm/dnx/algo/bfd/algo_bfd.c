    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT8, "trpcd", bfd_action->trap_code, NULL, "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT8, "fwdstrng", bfd_action->forwarding_stregth,
                                        NULL, "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT8, "snpstrn", bfd_action->snoop_strength, NULL,
                                        "%d");
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_IPV6, "destination IP", ip, NULL, NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "minimum", min_max[0], NULL, "0x%08X");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "maximum", min_max[1], NULL, "0x%08X");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
...
dnx_bfd_tx_rate_profile_print_cb(
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    uint16 *tx_rate = (uint16 *) data;
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT16, "tx rate", tx_rate[0], NULL, "0x%04X");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "required interval", req_int[0], NULL,
                                        "0x%08X");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "range start", range_start[0], NULL, "0x%08X");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT8, "Type of Service", tos_ttl->tos, NULL, "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT8, "Time to Live", tos_ttl->ttl, NULL, "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_IPV4, "source IP", ip[0], NULL, NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT16, "source port", sport[0], NULL, "0x%04X");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_INIT_VARIABLES(print_cb_data);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT8, "type of service", tos[0], NULL, "%d");
    DNX_ALGO_TEMPLATE_PRINT_CB_FINISH(print_cb_data);
    return;
}
...
dnx_algo_bfd_init_templates(
    int unit)
{
    sw_state_algo_template_create_data_t bfd_dip_mep_profile_data, bfd_dip_template_data, bfd_your_dis_range_data;
    ...
    sal_memset(&bfd_dip_mep_profile_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    sal_memset(&bfd_dip_template_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    sal_strncpy(bfd_dip_template_data.name, DNX_BFD_TEMPLATE_DIP, SW_STATE_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);

    SHR_IF_ERR_EXIT(algo_bfd_db.bfd_dip.create(unit, &bfd_dip_template_data, NULL));

    /** Create template for BFD discriminator range */
    sal_memset(&bfd_your_dis_range_data, 0, sizeof(sw_state_algo_template_create_data_t));
...
dnx_algo_bfd_oamp_init_templates(
    int unit)
{
    sw_state_algo_template_create_data_t bfd_tx_rate_profile_data, bfd_req_int_profile_data,
        bfd_my_dis_range_start_data;
    sw_state_algo_template_create_data_t bfd_tos_ttl_data, bfd_src_addr_data, bfd_udp_src_port_data,
        bfd_mpls_src_port_data;
    ...
    sal_memset(&bfd_tx_rate_profile_data, 0, sizeof(sw_state_algo_template_create_data_t));
    bfd_tx_rate_profile_data.flags = 0;
    bfd_tx_rate_profile_data.first_profile = 0;
    bfd_tx_rate_profile_data.nof_profiles = 8;
    bfd_tx_rate_profile_data.max_references = nof_references;
    bfd_tx_rate_profile_data.default_profile = 0;
    bfd_tx_rate_profile_data.data_size = sizeof(uint16);
    ...
    sal_memset(&bfd_req_int_profile_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    /** Create template for BFD required intervals  */
    sal_memset(&bfd_my_dis_range_start_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    sal_memset(&bfd_tos_ttl_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    sal_strncpy(bfd_tos_ttl_data.name, DNX_BFD_OAMP_TEMPLATE_TOS_TTL, SW_STATE_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);
    ...
    sal_memset(&bfd_src_addr_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    sal_memset(&bfd_udp_src_port_data, 0, sizeof(sw_state_algo_template_create_data_t));
    ...
    sal_memset(&bfd_mpls_src_port_data, 0, sizeof(sw_state_algo_template_create_data_t));
