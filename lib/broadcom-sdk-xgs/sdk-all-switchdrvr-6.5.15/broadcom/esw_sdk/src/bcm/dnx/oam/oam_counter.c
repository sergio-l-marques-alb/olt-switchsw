...
static const oam_counter_disable_table_table_entry_t oam_counter_disable_map[] = {
   ...
   /** HLM by LIF (2 LIFs), InnerLIF no-LM, outerLIF with LM. We only can get MP_TYPE Above-upper-MEP*/
    {1, 0, 0, PASSIVE_MATCH_HIGH,         OAM_COUNTER_DIS, OAM_COUNTER_EN, OAM_COUNTER_EN},
   /** HLM by LIF (2 LIFs), InnerLIF no-LM, outerLIF with LM. We only can get MP_TYPE Above-upper-MEP*/
    {1, 0, 0, ABOVE_UPPER_MEP,            OAM_COUNTER_DIS, OAM_COUNTER_EN, OAM_COUNTER_EN},
   /** HLM by LIF (2 LIFs), InnerLIF no-LM, outerLIF with LM. We only can get MP_TYPE Above-upper-MEP*/
   ...
   /** HLM by LIF (3 LIFs), InnerLIF no-LM, outerLIF with LM.  We only can get MP_TYPE Above-upper-MEP*/
    {2, 0, 0, PASSIVE_MATCH_HIGH,         OAM_COUNTER_DIS, OAM_COUNTER_EN, OAM_COUNTER_EN},
   /** HLM by LIF (3 LIFs), InnerLIF no-LM, outerLIF with LM. We only can get MP_TYPE Above-upper-MEP*/
   ...
   /** HLM by LIF (2 LIFs), innerLIF data packet */
    {1, 1, 0, PASSIVE_MATCH_HIGH,         OAM_COUNTER_DIS, OAM_COUNTER_EN , OAM_COUNTER_EN},
   /** HLM by LIF (2 LIFs), innerLIF data packet */
   ...
   /** HLM by LIF (3 LIFs), innerLIF data packet */
    {2, 1, 0, PASSIVE_MATCH_HIGH,         OAM_COUNTER_DIS, OAM_COUNTER_EN, OAM_COUNTER_EN},
   /** HLM by LIF (3 LIFs), innerLIF data packet */
