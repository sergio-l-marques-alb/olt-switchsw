    ...
    int is_remote)
{
    ...
    for (i = 0; i < nof_remote_cores; i++)
    {
         ...
         */
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_FLOW_ID, actual_flow_id[i]);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core_id);
...
dnx_sch_flow_shaper_token_count_set(
    ...
    uint32 token_count)
{
    uint32 token_count_entry_handle_id, dyn_access_entry_handle_id;
    uint32 dyn_access_enable;
    int i;
    ...
    /*
     * -- 1. Read SCH_ENABLE_DYN_MEMORY_ACCESS table 
     */

    /** Taking a handle */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_SCH_ENABLE_DYN_MEMORY_ACCESS, &dyn_access_entry_handle_id));

    /** Setting key fields */
    dbal_entry_key_field32_set(unit, dyn_access_entry_handle_id, DBAL_FIELD_CORE_ID, core_id);

    /** Setting pointers value to receive the fields */
    dbal_value_field32_request(unit, dyn_access_entry_handle_id, DBAL_FIELD_ENABLE, INST_SINGLE, &dyn_access_enable);

    /** Performing the action after this call the pointers that we set in field32_request() */
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, dyn_access_entry_handle_id, DBAL_COMMIT));

    /*
     * -- 2. Write TRUE to SCH_ENABLE_DYN_MEMORY_ACCESS table 
     */

    dbal_entry_value_field32_set(unit, dyn_access_entry_handle_id, DBAL_FIELD_ENABLE, INST_SINGLE, 1);

    /** Performing the action */
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, dyn_access_entry_handle_id, DBAL_COMMIT));
    ...
    {
        /** Setting key fields */
        dbal_entry_key_field32_set(unit, token_count_entry_handle_id, DBAL_FIELD_FLOW_ID, flow_id[i]);
        ...
        dbal_entry_value_field32_set(unit, token_count_entry_handle_id, DBAL_FIELD_TOKEN_COUNT, INST_SINGLE,
                                     token_count);
        dbal_entry_value_field32_set(unit, token_count_entry_handle_id, DBAL_FIELD_SLOW_STATUS, INST_SINGLE, 1);

        /** Performing the action */
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, token_count_entry_handle_id, DBAL_COMMIT));
    }
    /*
     * -- 4. restore value of SCH_ENABLE_DYN_MEMORY_ACCESS table 
     */

    dbal_entry_value_field32_set(unit, dyn_access_entry_handle_id, DBAL_FIELD_ENABLE, INST_SINGLE, dyn_access_enable);
    ...
    int flow_id)
{
    ...
    /*
     * Clearing the entry updates max_burst, 
     * so update token count accordingly
     */
    SHR_IF_ERR_EXIT(dnx_sch_flow_shaper_token_count_set(unit, core_id, &flow_id, 1, 0));
    ...
    uint32 *slots)
{
    ...
    for (entry = 0; entry < nof_slots; entry++)
    {
        ...
        /** Setting value fields */
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HR_ID, INST_SINGLE, slots[entry]);
    ...
    uint32 rate)
{
    ...
    /** Taking a handle */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_SCH_IF_SHAPER, &entry_handle_id));
    ...
    uint32 enable)
{
    ...
    /** Taking a handle */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_SCH_ERP_ENABLE, &entry_handle_id));
...
/**
 * \brief -
 * toggle scheduler init - set and clear
 *
 * \param [in] unit -  Unit-ID 
 * \return
 *   See shr_error_e 
    ...
    int unit)
{
    ...
    DBAL_FUNC_INIT_VARS(unit);
     ...
     /** Taking a handle */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_SCH_SCHEDULER_INIT, &entry_handle_id));

    /** First write 1 */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INIT, INST_SINGLE, 1);

    /** Performing the action */
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));

    /** Then write 0 */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INIT, INST_SINGLE, 0);
    ...
    dbal_enum_value_field_flow_slow_status_e * slow_status)
{
    ...
    /** Taking a handle to DBAL table */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_FLOW_SLOW_STATUS, &entry_handle_id));
    ...
    uint32 flow)
{
   ...
   /** Setting value fields */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONUTER_TYPE, INST_SINGLE, counter_type);
    ...
    uint32 *flow)
{
   ...
   /** Setting pointers value to receive the fields */
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_CONUTER_TYPE, INST_SINGLE, counter_type);
