    ...
    dnx_multicast_mcdb_dbal_field_t * entry_val)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NEXT_PTR, INST_SINGLE, entry_val->next_entry_id);
