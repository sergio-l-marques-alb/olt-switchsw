    ...
    int enable)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_enable_set(unit, port, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    uint32 priority)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_prd_map_set(unit, port, map, key, priority);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    uint32 *priority)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_prd_map_get(unit, port, map, key, priority);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    const bcm_cosq_ingress_drop_flex_key_entry_t * flex_key_info)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_prd_flex_key_entry_set(unit, port, key_index, flex_key_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    bcm_cosq_ingress_drop_flex_key_entry_t * flex_key_info)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "flex_key_info NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_prd_flex_key_entry_get(unit, port, key_index, flex_key_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    const bcm_cosq_ingress_drop_flex_key_construct_t * flex_key_config)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_prd_flex_key_construct_set)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_prd_flex_key_construct_set(unit, port, ether_type_code, flex_key_config);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_prd_flex_key_construct_set isn't implemented for driver type");
    }
    ...
    bcm_cosq_ingress_drop_flex_key_construct_t * flex_key_config)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "flex_key_config NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_prd_flex_key_construct_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_prd_flex_key_construct_get(unit, port, ether_type_code, flex_key_config);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_prd_flex_key_construct_get isn't implemented for driver type");
    }
    ...
    uint32 *is_custom_ether_type)
{
    ...
    if (is_custom_ether_type == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "is_custom_ether_type NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_prd_is_custom_ether_type_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_prd_is_custom_ether_type_get(unit, port, ether_type_code,
                                                                            is_custom_ether_type);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_prd_is_custom_ether_type_get isn't implemented for driver type");
    }
    ...
    uint64 *counter_val)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_ilkn_counter_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_ilkn_counter_get(unit, port, counter_type, counter_val);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_ilkn_counter_get isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_ilkn_counter_clear)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_ilkn_counter_clear(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_ilkn_counter_clear isn't implemented for driver type");
    }
    ...
    uint32 in_reset)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_pms_reset_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_pms_reset_set(unit, imb_id, in_reset);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_pms_reset_set isn't implemented for driver type");
    }
    ...
    uint32 *in_reset)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_pms_reset_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_pms_reset_get(unit, imb_id, in_reset);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_pms_reset_get isn't implemented for driver type");
    }
