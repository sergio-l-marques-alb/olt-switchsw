    ...
    uint8 *is_evpn)
{
    ...
    if (info != NULL)
    {
        ...
        {
            /*
             * Non-IML label. Can still be EVPN.
             */
     ...
     */
    SHR_IF_ERR_EXIT(dnx_lif_mngr_inlif_sw_info_table_id_and_result_type_get(unit, *local_in_lif, SOC_CORE_DEFAULT,
                                                                            DBAL_PHYSICAL_TABLE_INLIF_2,
                                                                            &dbal_table_id, &dbal_result_type));
    ...
    dnx_mpls_l2vpn_info_t * l2vpn)
{
    ...
    pmport->egress_label.egress_qos_model.ecn_eligible = eg_label->egress_qos_model.ecn_eligible;
    ...
    bcm_mpls_egress_label_t * eg_label)
{
    ...
    eg_label->egress_qos_model.ecn_eligible = pmport->egress_label.egress_qos_model.ecn_eligible;
    ...
    bcm_mpls_egress_label_t * eg_label)
{
    ...
    allowed_flags =
        ...
        BCM_MPLS_EGRESS_LABEL_REPLACE | BCM_MPLS_EGRESS_LABEL_TTL_DECREMENT
        | BCM_MPLS_EGRESS_LABEL_PROTECTION | BCM_MPLS_EGRESS_LABEL_STAT_ENABLE;
