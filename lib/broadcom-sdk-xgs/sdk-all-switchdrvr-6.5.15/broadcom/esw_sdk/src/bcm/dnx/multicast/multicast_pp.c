...
/*
 * This is -1 in an 18 bit representation which is the NOF bits in Jericho 1 and represent there an invalid LIF.
 */
#define MULTICAST_PP_JR1_INVALID_LIF 0x3FFFF
/*
 * }
 */
 ...
 */
static shr_error_e
bcm_dnx_multicast_encap_extension_create_verify(
    int unit,
    uint32 flags,
    ...
    bcm_if_t * encap_extension_array)
{
    ...
    uint8 idx;
    dnx_field_ace_entry_add_flags_e ace_flags = 0;
    ...
    SHR_INVOKE_VERIFY_DNX(bcm_dnx_multicast_encap_extension_create_verify
    ...
    {
        ace_flags |= DNX_FIELD_ACE_ENTRY_ADD_FLAG_UPDATE;
    }
     ...
     */
    ace_flags |= DNX_FIELD_ACE_ENTRY_ADD_FLAG_WITH_ID;
 ...
 */
static shr_error_e
dnx_multicast_pp_jr1_smae_interface_wa_init(
    int unit)
{
    dnx_field_entry_payload_t payload;
    dnx_field_ace_key_t ace_key = MULTICAST_PP_JR1_INVALID_LIF;
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(dnx_field_ace_entry_add
                    (unit, DNX_FIELD_ACE_ENTRY_ADD_FLAG_WITH_ID, DNX_MULTICAST_PPMC_SINGLE_OUTLIF_ACE_ID, &payload,
                     &ace_key));
    ...
    int unit)
{
     ...
     * 1st action
     */
    action_info.bcm_action = bcmFieldActionOutVport0;
     ...
     * 2nd action
     */
    action_info.bcm_action = bcmFieldActionOutVport1;
     ...
     * 3rd action
     */
    action_info.bcm_action = bcmFieldActionOutVport2;
    ...
    {
        SHR_IF_ERR_EXIT(dnx_multicast_pp_jr1_smae_interface_wa_init(unit));
    }
