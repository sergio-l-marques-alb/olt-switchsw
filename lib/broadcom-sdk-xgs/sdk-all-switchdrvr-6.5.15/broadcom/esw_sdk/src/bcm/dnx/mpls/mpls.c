    ...
    if (_SHR_IS_FLAG_SET(info->flags, BCM_MPLS_SWITCH_LOOKUP_SECOND_LABEL))
    {
        ...
        if (is_iml != FALSE)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         ...
                         in_labels[0], found_labels_low, found_labels_high);
        }
    }
    ...
    bcm_mpls_tunnel_switch_t * info)
{
    ...
    not_supported_flags = (BCM_MPLS_SWITCH_COUNTED | BCM_MPLS_SWITCH_INT_PRI_SET |
                           ...
                           BCM_MPLS_SWITCH_DIRECT_ATTACHED | BCM_MPLS_SWITCH_ENTROPY_ENABLE |
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "BCM_MPLS_SWITCH2_STAT_ENABLE flag (0x%08x) can't be set for NOP action (mpls forwarding). Flags value: 0x%08x",
    ...
    bcm_mpls_vpn_config_t * info)
{
    ...
    if (vpn_id >= dnx_data_l2.vsi.nof_vsis_get(unit))
    {
    ...
    int unit)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_EEI_IDENTIFIER, DBAL_ENUM_FVAL_EEI_IDENTIFIER_PHP);
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_EEI_IDENTIFIER, DBAL_ENUM_FVAL_EEI_IDENTIFIER_SWAP);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CREATE_FHEI_INSTEAD_OF_EEI, INST_SINGLE, TRUE);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FHEI_TYPE, INST_SINGLE,
    ...
    for (nibble_index = 0; nibble_index < 16; nibble_index++)
    {
        switch (nibble_index)
        {
            case MPLS_LSB_NIBBLE_IPV4_EXPLICIT_NULL:
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE,
                                           MPLS_LSB_NIBBLE_IPV4_EXPLICIT_NULL);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_CLEAR);
                ...
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE,
                                           MPLS_LSB_NIBBLE_IPV4_EXPLICIT_NULL);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_SET);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE,
                                             DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_IPV4_EXPLICIT_NULL);
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
            ...
            case MPLS_LSB_NIBBLE_RA:
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE, MPLS_LSB_NIBBLE_RA);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_CLEAR);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE, DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_ROUTER_ALERT);
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));

                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE, MPLS_LSB_NIBBLE_RA);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_SET);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE, DBAL_ENUM_FVAL_FIRST_NIBBLE_INDEX_IPV4);
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
                break;
            case MPLS_LSB_NIBBLE_IPV6_EXPLICIT_NULL:
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE,
                                           MPLS_LSB_NIBBLE_IPV6_EXPLICIT_NULL);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_CLEAR);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE,
            ...
            case MPLS_LSB_NIBBLE_ELI:
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE, MPLS_LSB_NIBBLE_ELI);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_CLEAR);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE, DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_ELI);
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
            ...
            case MPLS_LSB_NIBBLE_OAM_ALERT:
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE,
                                           MPLS_LSB_NIBBLE_OAM_ALERT);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_CLEAR);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE, DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_OAM_ALERT);
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
            ...
            default:
                ...
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_LABEL_NIBBLE, nibble_index);
                dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, MPLS_BIT_CLEAR);
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE,
                                             INST_SINGLE, DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_INVALID_LABEL);
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
/**
* \brief
*  Initialize TERM_MPLS_SPECIAL_LABEL_ATTRIBUTES table with predefined values
*   \param [in] unit         -  Relevant unit.
* \return
*   shr_error_e - Non-zero in case of an error.
*/
static shr_error_e
dnx_mpls_init_term_mpls_special_label_attributes(
    int unit)
{
    uint32 entry_handle_id;
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LABELS_TO_TERMINATE, INST_SINGLE,
                                 TERMINATE_ONE_SPECIAL_LABEL);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BEFORE_TUNNEL, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_AFTER_TUNNEL, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PHB_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RM_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TTL_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PHB_PROPAGATION_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RM_PROPAGATION_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN_PROPAGATION_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TTL_PROPAGATION_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_QOS_MAPPING_PROFILE, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN_MAPPING_PROFILE, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_NEXT_PARSER_CONTEXT_ENABLE, INST_SINGLE,
                                 MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_NEXT_PARSER_CONTEXT_VALUE, INST_SINGLE,
                                 DBAL_ENUM_FVAL_IRPP_2ND_PARSER_PARSER_CONTEXT_IPV4_NOETHB2);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_HAS_CW, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_IS_OAM, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_BOS, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_BOS, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_HAS_CW, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_IS_OAM, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_BOS, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_BOS, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LABELS_TO_TERMINATE, INST_SINGLE,
                                 TERMINATE_TWO_SPECIAL_LABEL);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BEFORE_TUNNEL, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_AFTER_TUNNEL, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PHB_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RM_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN_COMPARE_STRENGTH, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TTL_COMPARE_STRENGTH, INST_SINGLE, 0);
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_NEXT_PARSER_CONTEXT_VALUE, INST_SINGLE,
                                 DBAL_ENUM_FVAL_IRPP_2ND_PARSER_PARSER_CONTEXT_ETH_B1);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_HAS_CW, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_IS_OAM, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_BOS, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_BOS, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_IS_OAM, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_BOS, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_BOS, INST_SINGLE, MPLS_BIT_SET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CHECK_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EXPECTED_TTL, INST_SINGLE, MPLS_BIT_CLEAR);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
/**
* \brief
*  Add a dummy native virtual lif (no global lif, no vsi) to
* DBAL_TABLE_INNER_ETH_VLAN_EDIT_CLASSIFICATION table.
* predefined
*   \param [in] unit         -  Relevant unit.
* \return
*   shr_error_e - Non-zero in case of an error.
*/
static shr_error_e
dnx_mpls_init_add_dummy_native_virtual_lif(
    int unit)
{
    uint32 entry_handle_id;
    lif_mngr_local_inlif_info_t inlif_info;
    uint32 pwe_vlan_domain_miv_value = 0;
    ...
    inlif_info.dbal_result_type = DBAL_RESULT_TYPE_INNER_ETH_VLAN_EDIT_CLASSIFICATION_IN_ETH_VLAN_EDIT_ONLY;
    inlif_info.core_id = _SHR_CORE_ALL;
    ...
    SHR_IF_ERR_EXIT(dbal_tables_field_predefine_value_get(unit,
                                                          ...
                                                          FALSE, DBAL_RESULT_TYPE_IN_LIF_FORMAT_PWE_IN_LIF_PWE_MP, 0,
                                                          DBAL_PREDEF_VAL_MIN_VALUE,
                                                          &pwe_vlan_domain_miv_value));

    /** Insert an ISEM entry pointing to the dummy lif - PWE use vlan_domain min value for PWE*/
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_VLAN_DOMAIN, pwe_vlan_domain_miv_value);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IN_LIF, INST_SINGLE, inlif_info.local_inlif);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    DBAL_HANDLE_FREE(unit, entry_handle_id);

    /** Insert an ISEM entry pointing to the dummy lif - VXLAN uses vlan domain 0 */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC
                    (unit, DBAL_TABLE_INNER_ETHERNET_VLAN_CLASSIFICATION_NETWORK_SCOPED_VLAN_0_VLANS,
                     &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, DBAL_CORE_ALL);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_VLAN_DOMAIN, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IN_LIF, INST_SINGLE, inlif_info.local_inlif);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    DBAL_HANDLE_FREE(unit, entry_handle_id);
    ...
    int unit)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DUAL_HOMING, INST_SINGLE, 0);
    ...
    int unit)
{
    ...
    /** initialize TERM_MPLS_SPECIAL_LABEL_ATTRIBUTES*/
    SHR_IF_ERR_EXIT(dnx_mpls_init_term_mpls_special_label_attributes(unit));
    ...
    if (!(SOC_IS_JERICHO_2_A0(unit) && soc_sand_is_emulation_system(unit) != 0))
    {
        ...
        /** Add a dummy GLifless LIF to VT-E */
        SHR_IF_ERR_EXIT(dnx_mpls_init_add_dummy_native_virtual_lif(unit));
    }
    ...
    uint32 *full_field_val)
{
    ...
    field_in_struct_encoded_val = qos_map_id;
    SHR_IF_ERR_EXIT(dbal_fields_struct_field_encode
                    (unit, DBAL_FIELD_EEI_MPLS_POP_COMMAND, field_in_struct_id, &field_in_struct_encoded_val,
                     full_field_val));
 ...
 *              BCM_MPLS_SWITCH_OUTER_TTL  - used for PHP - set TTL-Model uniform mode (otherwise PIpe)
 *              BCM_MPLS_SWITCH_OUTER_EXP  - used for PHP - set QOS-Model uniform mode (otherwise Pipe)
    ...
    bcm_mpls_tunnel_switch_t * info)
{
    ...
    {
        /** action NOP is of type destination OR destination + outlif, according to egress_if */
    ...
    int unit)
{
    ...
    for (vsi = 0; vsi < dnx_data_l2.vsi.nof_vsis_get(unit); vsi++)
    {
        SHR_IF_ERR_EXIT(dnx_vswitch_vsi_usage_per_type_get(unit, vsi, _bcmDnxVsiTypeMpls, &is_vsi_usage_mpls));
        if (is_vsi_usage_mpls)
        {
            DNX_VPN_ID_SET(vpn, vsi);
            SHR_IF_ERR_EXIT(bcm_dnx_mpls_vpn_id_destroy(unit, vpn));
        }
    }
    ...
    bcm_mpls_vpn_config_t * info)
{
    ...
    _BCM_MULTICAST_GROUP_SET(info->unknown_unicast_group, _BCM_MULTICAST_TYPE_VPLS,
                             _BCM_MULTICAST_ID_GET(vlan_control.unknown_unicast_group));
    _BCM_MULTICAST_GROUP_SET(info->unknown_multicast_group, _BCM_MULTICAST_TYPE_VPLS,
                             _BCM_MULTICAST_ID_GET(vlan_control.unknown_multicast_group));
    _BCM_MULTICAST_GROUP_SET(info->broadcast_group, _BCM_MULTICAST_TYPE_VPLS,
    ...
    void *user_data)
{
    ...
    for (vpn = BCM_VLAN_DEFAULT; vpn < dnx_data_l2.vsi.nof_vsis_get(unit); vpn++)
    {
