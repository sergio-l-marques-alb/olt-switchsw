    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Aging profile",
                                        vsi_profile_info->aging_profile, "Aging profile", NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Forwarding profile",
                                        vsi_profile_info->event_forwarding_profile, "Forwarding profile", NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Limit", vsi_profile_info->limit, "Limit",
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Message enable",
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Ageout", vsi_aging_profile_info->ageout_age,
                                        "Ageout age", NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Delete", vsi_aging_profile_info->delete_age,
                                        "Delete age", NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Refresh", vsi_aging_profile_info->refresh_age,
                                        "Refresh age", NULL);
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Ack",
                                        event_forwarding_profile_info->ack_distribution, "Ack event distribution",
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Delete",
                                        event_forwarding_profile_info->ack_distribution, "Delete event distribution",
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Insert",
                                        event_forwarding_profile_info->ack_distribution, "Insert event distribution",
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Learn",
                                        event_forwarding_profile_info->ack_distribution, "Learn event distribution",
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Refresh",
                                        event_forwarding_profile_info->ack_distribution, "Refresh event distribution",
                                        NULL);
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Transplant",
    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_ALGO_L2_VSI_LEARNING_PROFILE_TEMPLATE, SW_STATE_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);
    ...
    int forwarding_profile)
{
    ...
    SHR_IF_ERR_EXIT(algo_l2_db.event_forwarding_profile.profile_data_get
                    (unit, _SHR_CORE_ALL, forwarding_profile, &ref_count, (void *) &forwarding_profile_info));

    SHR_IF_ERR_EXIT(algo_l2_db.event_forwarding_profile.allocate_single(unit, _SHR_CORE_ALL, alloc_flags,
    ...
    int forwarding_profile)
{
    ...
    SHR_IF_ERR_EXIT(algo_l2_db.
                    event_forwarding_profile.free_single(unit, _SHR_CORE_ALL, forwarding_profile, &last_reference));
    ...
    int aging_profile)
{
    ...
    SHR_IF_ERR_EXIT(algo_l2_db.vsi_aging_profile.profile_data_get
                    (unit, _SHR_CORE_ALL, aging_profile, &ref_count, (void *) &aging_profile_info));

    SHR_IF_ERR_EXIT(algo_l2_db.vsi_aging_profile.allocate_single(unit, _SHR_CORE_ALL, alloc_flags,
    ...
    int aging_profile)
{
    ...
    SHR_IF_ERR_EXIT(algo_l2_db.vsi_aging_profile.free_single(unit, _SHR_CORE_ALL, aging_profile, &last_reference));
    ...
    int unit)
{
    ...
    sal_strncpy(data.name, DNX_ALGO_L2_EVENT_FORWARDING_PROFILE_TEMPLATE,
    ...
    int unit)
{
     ...
     */
    data.max_references = dnx_data_l2.vsi.nof_vsi_learning_profiles_get(unit) + 1;
    sal_strncpy(data.name, DNX_ALGO_L2_VSI_AGING_PROFILE_TEMPLATE, SW_STATE_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);
