    ...
    int element)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_res_simple_bitmap_free(unit, module_id, res_tag_bitmap, element));
    ...
    int element)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_res_simple_bitmap_free_several(unit, module_id, res_tag_bitmap, nof_elements, element));
    ...
    int unit)
{
    ...
    sal_strncpy(create_data.name, DNX_ALGO_FAILOVER_RES_ING_PATH_SELECT, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    sal_strncpy(create_data.name, DNX_ALGO_FAILOVER_RES_EGR_PATH_SELECT, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
    ...
    sal_strncpy(create_data.name, DNX_ALGO_FAILOVER_RES_FEC_PATH_SELECT, SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
