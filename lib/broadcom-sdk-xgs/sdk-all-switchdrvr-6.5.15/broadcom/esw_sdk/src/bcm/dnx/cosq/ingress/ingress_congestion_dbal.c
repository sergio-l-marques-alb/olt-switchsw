    ...
    uint32 rate_class)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ingress_congestion_dbal_voq_info_generic_set(unit, voq, DBAL_FIELD_RATE_CLASS, rate_class));
    ...
    uint32 *rate_class)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ingress_congestion_dbal_voq_info_generic_get(unit, voq, DBAL_FIELD_RATE_CLASS, rate_class));
    ...
    uint32 connection_class)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ingress_congestion_dbal_voq_info_generic_set
                    (unit, voq, DBAL_FIELD_CONNECTION_CLASS, connection_class));
    ...
    uint32 traffic_class)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ingress_congestion_dbal_voq_info_generic_set
                    (unit, voq, DBAL_FIELD_TRAFFIC_CLASS, traffic_class));
