...
#define DNX_MULTICAST_END_OF_LIST_PTR                   0x3ffff
#define DNX_MULTICAST_BMP_NOF_REPLICATIONS              DNX_DATA_MAX_PORT_GENERAL_NOF_TM_PORTS
#define DNX_MULTICAST_BMP_NOF_REPLICATIONS_PER_ENTRY    32
#define DNX_MULTICAST_BMP_NOF_ENTRIES                   (DNX_MULTICAST_BMP_NOF_REPLICATIONS / DNX_MULTICAST_BMP_NOF_REPLICATIONS_PER_ENTRY)
...
#define DNX_MULTICAST_IS_EMPTY_GROUP(entry_val) ((entry_val.format == DBAL_RESULT_TYPE_MCDB_SINGLE_FORMAT && \
...
typedef enum dnx_multicast_entry_iter_action_e
{
    ...
    /*
     * (SW only) returns the number of bitmap entries at count variable.
     */
    DNX_MULTICAST_ENTRY_ITER_BMP_ENTRY_CNT,
