...
#include <soc/dnx/swstate/auto_generated/access/algo_ecgm_access.h>
...
#define DNX_ALGO_ECGM_UNICAST_PD_THRESHOLDS_TEMPLATE_PRINT(uc_thresholds_struct) {\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "PD drop", uc_thresholds_struct.pd_drop, NULL, NULL);\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "PD flow control", "", NULL, NULL);\
...
#define DNX_ALGO_ECGM_UNICAST_DB_THRESHOLDS_TEMPLATE_PRINT(uc_thresholds_struct) {\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "DB drop", uc_thresholds_struct.db_drop, NULL, NULL);\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "DB flow control", "", NULL, NULL);\
...
#define DNX_ALGO_ECGM_MULTICAST_QUEUE_THRESHOLDS_PER_DP_TEMPLATE_PRINT(mc_q_dp_thresholds) {\
    ...
    {\
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "dp", "", NULL, NULL);\
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "dp", dp, NULL, "dp #%d");\
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "DB drop", mc_q_dp_thresholds[dp].db_drop, NULL, NULL); \
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "PD drop", "", NULL, NULL); \
...
#define DNX_ALGO_ECGM_FADT_THRESHOLDS_TEMPLATE_PRINT(fadt_struct) {\
        DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_START();    /* fadt */ \
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "max", fadt_struct.max, NULL, NULL);\
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "min", fadt_struct.min, NULL, NULL);\
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_INT, "alpha", fadt_struct.alpha, NULL, NULL);\
        DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_END();     /* fadt */ \
}
...
#define DNX_ALGO_ECGM_INTERFACE_PRIORITY_THRESHOLDS_TEMPLATE_PRINT(interface_priority) {\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "multicast PD drop", interface_priority.mc_interface_PDs_drop, NULL, NULL);\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "unicast PD flow control", "", NULL, NULL);\
    DNX_ALGO_ECGM_FADT_THRESHOLDS_TEMPLATE_PRINT(interface_priority.uc_fc.pd_fc);\
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "unicast DB flow control", "", NULL, NULL);\
...
dnx_algo_ecgm_port_profile_template_create(
    int unit)
{
    sw_state_algo_template_create_data_t port_profile_template_data;
    ...
    port_profile_template_data.flags = SW_STATE_ALGO_TEMPLATE_CREATE_DUPLICATE_PER_CORE;
    ...
    SHR_IF_ERR_EXIT(algo_ecgm_db.ecgm_port_profile.create(unit, &port_profile_template_data, NULL));
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    if (data)
    {
         ...
         */
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Port Unicast Thresholds", "", NULL, NULL);
        DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_START();  /* unicast port */
        ...
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Queue Unicast Thresholds", "", NULL,
                                            NULL);
        for (queue = 0; queue < DNX_COSQ_NOF_TC; ++queue)
        {
            DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Queue", "", NULL, NULL);
            DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Queue", queue, NULL, NULL);
            DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_START();      /* unicast queue */
            ...
            DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_END();        /* unicast queue */
        }
        DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_END();    /* unicast port */

        /*
         * Port Multicast thresholds 
         */
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Port Multicast thresholds", "", NULL,
                                            NULL);
        DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_START();  /* multicast port */
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "DB drop", profile->multicast_port.db_drop,
                                            NULL, NULL);
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "PD drop", "", NULL, NULL);
        DNX_ALGO_ECGM_FADT_THRESHOLDS_TEMPLATE_PRINT(profile->multicast_port.pd_drop);

        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Queue Multicast Thresholds", "", NULL,
                                            NULL);
        ...
        for (queue = 0; queue < DNX_COSQ_NOF_TC; ++queue)
        {
            DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Queue", "", NULL, NULL);
            DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "Queue", queue, NULL, NULL);
            DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_START();      /* multicast queue */
            DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "PD service pool",
                                                profile->multicast_queue[queue].pd_sp, NULL, NULL);
            DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "PD reserved",
            ...
            DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_END();        /* multicast queue */
        }
        DNX_ALGO_TEMPLATE_PRINT_CB_SUB_STRUCT_END();    /* multicast port */
...
dnx_algo_ecgm_interface_profile_template_create(
    int unit)
{
    sw_state_algo_template_create_data_t interface_profile_template_data;
    SHR_FUNC_INIT_VARS(unit);
    ...
    interface_profile_template_data.flags = SW_STATE_ALGO_TEMPLATE_CREATE_DUPLICATE_PER_CORE;
    sal_strncpy(interface_profile_template_data.name, DNX_ALGO_ECGM_INTERFACE_PROFILE_TEMPLATE,
                SW_STATE_ALGO_TEMPLATE_MNGR_MAX_NAME_LENGTH - 1);

    SHR_IF_ERR_EXIT(algo_ecgm_db.ecgm_interface_profile.create(unit, &interface_profile_template_data, NULL));
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    if (data)
    {
        ...
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "interface thresholds", "", NULL, NULL);

        /*
         * interface High priority 
         */
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "High priority", "", NULL, NULL);
        DNX_ALGO_ECGM_INTERFACE_PRIORITY_THRESHOLDS_TEMPLATE_PRINT(profile->high_priority);

        /*
         * interface Low priority 
         */
        DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_STRING, "Low priority", "", NULL, NULL);
