    ...
    uint32 *internal)
{
    ...
    {
        calc = (credit_worth * UTILEX_NOF_BITS_IN_CHAR) *
            (DNXCMN_CORE_CLOCK_MHZ_GET(unit) * dnx_data_sch.device.drm_resolution_get(unit));
    ...
    if (*internal != 0)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_tables_field_predefine_value_get(unit, DBAL_TABLE_SCH_SHARED_DRM,
