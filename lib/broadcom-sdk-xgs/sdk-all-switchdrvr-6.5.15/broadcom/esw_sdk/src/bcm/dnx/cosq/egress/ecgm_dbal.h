...
/**
* \brief -  Set the maximum number of allocated ECGM resources that have been reached per InterFace.
*
* \param [in] unit - chip unit id
* \param [in] core_id - core id
...
* \param [in] pd - Maximum number of allocated Packet Descriptors. (should be set to 0 after CPU read)
* \param [in] db - Maximum number of allocated Data Buffers. (should be set to 0 after CPU read)
*
* \return
*   shr_error_e
*
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_interface_resources_statistics_max_set(
    uint32 unit,
    uint32 core_id,
    uint32 is_mc,
...
/**
* \brief -  Set the maximum number of allocated ECGM resources that have been reached per Queue.
*
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] is_mc - UC = 0, MC = 1
* \param [in] queue_pair - Queue Pair number
* \param [out] pd - Maximum number of allocated Packet Descriptors. (should be set to 0 after CPU read)
* \param [out] db - Maximum number of allocated Data Buffers. (should be set to 0 after CPU read)
*
* \return
*   shr_error_e
*
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_queue_resources_statistics_max_set(
    uint32 unit,
    uint32 core_id,
    uint32 is_mc,
    uint32 queue_pair,
