 ...
 */
static const dnx_tune_fabric_cgm_control_t dnx_tune_fabric_cgm_control_rci[] = {
    /* *INDENT-OFF* */
    /*
    ...
    {bcmFabricCgmRciHighSeverityMinLinksParam,  -1,                                                                             48,     0x0},
 ...
 */
static const dnx_tune_fabric_cgm_control_t dnx_tune_fabric_cgm_control_llfc_and_drop[] = {
    /* *INDENT-OFF* */
    /*
     * Control Type                   | Control ID                                                                  | Value | Flags
     */
    {bcmFabricCgmLlfcPipeTh,            bcmFabricPipeAll,                                                             248,    0x0},
    {bcmFabricCgmDropFabricClassTh,     BCM_FABRIC_TH_INDEX_CAST_PRIO_SET(bcmFabricCastAll, bcmFabricPriorityAll),    2048,   0x0},
    {bcmFabricCgmDropMeshMcPriorityTh,  bcmFabricPriorityAll,                                                         128,    0x0},
    {bcmFabricCgmFcIngressTh,           -1,                                                                           2,      0x0},
    {-1}
    /* *INDENT-ON* */
};
    ...
    int unit)
{
     ...
     */
    egress_rci_threshold = 1024 / nof_pipes;
    total_egress_rci_threshold = egress_rci_threshold * 4;
    ...
    control_id = BCM_FABRIC_TH_INDEX_PIPE_LEVEL_SET(bcmFabricPipe0, bcmFabricLevelAll);
    value = egress_rci_threshold;
    flags = 0;
    SHR_IF_ERR_EXIT(bcm_dnx_fabric_cgm_control_set(unit, flags, control_type, control_id, value));
    ...
    control_id = BCM_FABRIC_TH_INDEX_PIPE_LEVEL_SET(bcmFabricPipe0, bcmFabricLevelAll);
    value = total_egress_rci_threshold;
    flags = 0;
    SHR_IF_ERR_EXIT(bcm_dnx_fabric_cgm_control_set(unit, flags, control_type, control_id, value));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_tune_fabric_cgm_common_set(unit, dnx_tune_fabric_cgm_control_rci));
