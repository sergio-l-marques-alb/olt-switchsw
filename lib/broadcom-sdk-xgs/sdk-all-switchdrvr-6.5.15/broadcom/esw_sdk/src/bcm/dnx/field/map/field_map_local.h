...
extern const dnx_field_range_map_t range_map[bcmFieldRangeTypeCount][bcmFieldStageCount];
...
extern const dnx_field_static_apptype_map_t dnx_field_static_apptype_map[bcmFieldAppTypeCount];
...
shr_error_e dnx_field_convert_local_gport_to_port(
    int unit,
    int core,
    uint32 *bcm_data,
    uint32 *dnx_data);

/** Similar to dnx_field_convert_local_gport_to_port, only without the core ID ad output.*/
shr_error_e dnx_field_convert_local_gport_to_port_only(
    int unit,
    int core,
    uint32 *bcm_data,
    uint32 *dnx_data);
...
shr_error_e dnx_field_convert_local_out_gport_to_port(
    int unit,
    int core,
    uint32 *bcm_data,
    uint32 *dnx_data);
...
shr_error_e dnx_field_convert_gport_to_lif(
    int unit,
    int core,
    uint32 *bcm_data,
    uint32 *dnx_data);

shr_error_e dnx_field_convert_gport_to_lif_add_valid(
    int unit,
    int core,
    uint32 *bcm_data,
    uint32 *dnx_data);
