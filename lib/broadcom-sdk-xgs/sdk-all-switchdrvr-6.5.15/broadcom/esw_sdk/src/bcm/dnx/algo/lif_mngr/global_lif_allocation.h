 ...
 *     \ref SW_STATE_ALGO_RES_ALLOCATE_WITH_ID and/or \ref DNX_ALGO_GLOBAL_LIF_ALLOCATION_DEALLOCATE_VERIFY
 *   \param [in] direction_flags -
 *     Ingress or egress indication: 
 *     \ref DNX_ALGO_LIF_INGRESS and/or \ref DNX_ALGO_LIF_EGRESS
 *   \param [in] global_lif -
 *       If either \ref DNX_ALGO_GLOBAL_LIF_ALLOCATION_DEALLOCATE_VERIFY or \ref SW_STATE_ALGO_RES_ALLOCATE_WITH_ID
