    ...
    int unit)
{
    ...
    sw_state_algo_template_create_data_t temp_data;
     ...
     */
    {
        ...
        data.flags = 0;
        sal_strncpy(data.name, DNX_ALGO_SNIF_RES_MNGR_INGRESS_PROFILES_MIRROR,
     ...
     */
    {
        ...
        /** Currently sniffing isn't done per core */
        data.flags = 0;
        sal_strncpy(data.name, DNX_ALGO_SNIF_RES_MNGR_INGRESS_PROFILES_SNOOP,
                    SW_STATE_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1);
        /*
         * data.desc = "SNIF - SNIF profiles allocated IDs";
         */
     ...
     */
    {
        temp_data.flags = SW_STATE_ALGO_TEMPLATE_CREATE_DUPLICATE_PER_CORE;
        ...
        SHR_IF_ERR_EXIT(dnx_mirror_db.snif_ingress_vlan_profiles_mirror.create(unit, &temp_data, NULL));
    }
     ...
     */
    {
        ...
        SHR_IF_ERR_EXIT(dnx_mirror_db.snif_egress_vlan_profiles_mirror.create(unit, &temp_data, NULL));
    }
    ...
    dnx_algo_template_print_t * print_cb_data)
{
    ...
    DNX_ALGO_TEMPLATE_PRINT_CB_ADD_LINE(TEMPLATE_MNGR_PRINT_TYPE_UINT32, "VLAN ID", vlan_id, NULL, "%u");
