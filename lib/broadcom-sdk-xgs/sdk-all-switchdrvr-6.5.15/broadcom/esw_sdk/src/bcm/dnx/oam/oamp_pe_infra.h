...
/** all defined MEP_PE profiles */
typedef enum
{
    DNX_OAMP_PE_MEP_PE_PROFILE_DEFAULT,
    DNX_OAMP_PE_MEP_PE_PROFILE_BFD_ECHO,
    DNX_OAMP_PE_MEP_PE_PROFILE_48B_MAID,
    DNX_OAMP_PE_MEP_PE_PROFILE_BFD_DISCR_MSB_1,
    DNX_OAMP_PE_MEP_PE_PROFILE_BFD_IPV6,
    DNX_OAMP_PE_MEP_PE_PROFILE_BFD_IPV6_DISCR_MSB_1,
    DNX_OAMP_PE_MEP_PE_PROFILE_BFD_IPV6_MPLS,
    DNX_OAMP_PE_MEP_PE_PROFILE_RESERVED,
    DNX_OAMP_PE_MEP_PE_PROFILE_DOWN_MEP_INJ_SELF_CONTAINED_MAID_48,
    DNX_OAMP_PE_MEP_PE_PROFILE_DOWN_MEP_INJ_SELF_CONTAINED,
    /** MUST BE LAST */
    DNX_OAMP_PE_MEP_PE_PROFILE_LAST
} dnx_oamp_pe_mep_pe_profiles_e;
...
typedef enum
{
    ...
    DNX_OAMP_PE_INST_LABEL_DISCR_MSB_1_1B,
    DNX_OAMP_PE_INST_LABEL_DISCR_MSB_1_2B,
    DNX_OAMP_PE_INST_LABEL_DISCR_MSB_1_3B,
    DNX_OAMP_PE_INST_LABEL_DISCR_MSB_1,
    DNX_OAMP_PE_INST_LABEL_BFD_IPV6_END,
    DNX_OAMP_PE_INST_LABEL_BFD_IPV6_JR1_END,
    /** MUST BE LAST */
...
typedef struct
{
    dbal_enum_value_result_type_oamp_mep_db_e mep_type;
    uint32 type_mask;
    /** not used */
    uint32 mep_profile;
    uint32 profile_mask;
    uint32 mep_pe_profile;
    uint32 pe_profile_mask;
    dbal_enum_value_field_msg_type_e msg_type;
    uint32 msg_mask;
...
*   \param [in] unit  -  Relevant unit.
*   \param [in] mep_pe_profile_sw  -  mapping of SW MEP-PE profile naming to HW
