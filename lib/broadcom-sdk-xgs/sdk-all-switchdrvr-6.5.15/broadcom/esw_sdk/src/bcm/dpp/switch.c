...
/************************************************************************/
    ...
    case bcmSwitchUnknownIpmcAsMcast:
        if (SOC_IS_JERICHO(unit)) {
            ...
            uint32 programs[] =
                {PROG_FLP_IPV4COMPMC_WITH_RPF, PROG_FLP_GLOBAL_IPV4COMPMC_WITH_RPF, PROG_FLP_BIDIR, PROG_FLP_IPV6MC};
    ...
    case bcmSwitchMplsShortPipe:
        BCMDNX_ERR_EXIT_MSG(SOC_E_PARAM, (_BSL_SOC_MSG("This feature is not supported due to Errata")));
