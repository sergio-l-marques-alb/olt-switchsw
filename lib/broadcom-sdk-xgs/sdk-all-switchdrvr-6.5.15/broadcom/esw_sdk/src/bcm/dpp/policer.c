   ...
   ) 
{
    ...
    if ((dpp_profile_info->disable_eir == FALSE) || (dpp_profile_info->is_coupling_enabled == TRUE) || (pol_cfg.mode == bcmPolicerModeCoupledCascade)) {
   ...
   ) 
{
    ...
    if ((dpp_profile_info->disable_eir == FALSE) || (dpp_profile_info->is_coupling_enabled == TRUE) || 
        ((dpp_profile_info->is_sharing_enabled == TRUE) && (global_sharing == TRUE))) {
