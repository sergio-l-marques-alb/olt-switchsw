...
int 
bcm_dfe_cpri_port_tx_cw_vsd_ctrl_flow_config_get(
    int unit, 
    int port, 
    uint16 group_id, 
...
#if defined(INCLUDE_XFLOW_MACSEC)
int 
bcm_dfe_xflow_macsec_station_mac_addr_get(
    int unit, 
    bcm_mac_t mac_addr)
{
    return BCM_E_UNAVAIL;
...
#if defined(INCLUDE_XFLOW_MACSEC)
int 
bcm_dfe_xflow_macsec_station_mac_addr_set(
    int unit, 
    bcm_mac_t mac_addr)
{
    return BCM_E_UNAVAIL;
