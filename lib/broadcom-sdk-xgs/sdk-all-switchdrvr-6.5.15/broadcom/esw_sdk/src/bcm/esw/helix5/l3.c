/*
 * $Id: l3.c,v 1.0 Broadcom SDK $
 * $Copyright: (c) 2018 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    l3.c
 * Purpose: Helix5 L3 function implementations
 */

#include <shared/bsl.h>

#include <soc/defs.h>
#if defined(INCLUDE_L3) && defined(BCM_HELIX5_SUPPORT)

#include <bcm/debug.h>
#include <bcm/error.h>
/*
 * Function:
 *      _bcm_hx5_ecmp_rh_dynamic_size_encode
 * Purpose:
...
/*
 * Function:
 *      _bcm_hx5_ecmp_rh_dynamic_size_decode
 * Purpose:
...
#endif /* INCLUDE_L3 && BCM_HELIX5_SUPPORT  */
