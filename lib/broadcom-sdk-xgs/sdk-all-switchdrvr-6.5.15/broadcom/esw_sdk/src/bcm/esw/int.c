                           ...
                           int arg)
{
    ...
    if (SOC_IS_TOMAHAWK3(unit)) {
        ...
        switch (type) {
            ...
            case bcmSwitchIntL4DestPort1:
                rv =_bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_0r, UDP_DST_PORT1f, arg);
                if (BCM_SUCCESS(rv)) {
                    rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_0r, UDP_DST_PORT1_ENf, 1);
                }
                break;
            case bcmSwitchIntL4DestPort2:
                rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_0r, UDP_DST_PORT2f, arg);
                if (BCM_SUCCESS(rv)) {
                    rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_0r, UDP_DST_PORT2_ENf, 1);
                }
                break;
            case bcmSwitchIntProbeMarker1:
                rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_1r, PROBE_MARKER1f, (uint32)arg);
                if (BCM_SUCCESS(rv)) {
                    rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_1r, PROBE_MARKER1_ENf, 1);
                }
                break;
            case bcmSwitchIntProbeMarker2:
                rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_2r, PROBE_MARKER2f, (uint32)arg);
                if (BCM_SUCCESS(rv)) {
                    rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_2r, PROBE_MARKER2_ENf, 1);
                }
                break;
            case bcmSwitchIntVersion:
                rv = _bcm_th3_int_reg64_set(unit, INT_DETECT_CONFIG_0r, VERSIONf, arg);
                break;
            case bcmSwitchIntRequestVectorValue:
                rv = _bcm_th3_int_reg64_set(unit, INT_REQUEST_VECTOR_CONFIGr, REQUEST_VECTOR_VALUEf, (uint32)arg);
                break;
            case bcmSwitchIntRequestVectorMask:
                rv = _bcm_th3_int_reg64_set(unit, INT_REQUEST_VECTOR_CONFIGr, REQUEST_VECTOR_MASKf, (uint32)arg);
                break;
            case bcmSwitchIntSwitchId:
