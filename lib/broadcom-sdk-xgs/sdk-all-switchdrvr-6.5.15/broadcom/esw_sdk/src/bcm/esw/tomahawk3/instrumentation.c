                                    ...
                                    bcm_switch_pkt_trace_info_t *pkt_trace_info)
{
    ...
    const format_map_t fmt_map[] = {
        {   VLAN_DROP_VECTORfmt,           (void *)&vlan_dp_v  },
        {   RSEL_DROP_VECTORfmt,           (void *)&rsel_dp_v  },
        {   PKT_PROC_DROP_VECTORfmt,       (void *)&pkt_dp_v   },
        {   TUNNEL_PROC_DROP_VECTORfmt,    (void *)&tl_dp_v    },
        {   DISCARD_PROC_DROP_VECTORfmt,   (void *)&disc_dp_v  },
        {   PRE_COUNTER_UPDATE_VECTORfmt,  (void *)&pre_dp_v   }
    };
