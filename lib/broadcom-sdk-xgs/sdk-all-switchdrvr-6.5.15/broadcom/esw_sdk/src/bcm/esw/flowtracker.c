    ...
    bcm_flowtracker_check_info_t *check_info)
{
    ...
    if (soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) {
        result = bcmi_ft_check_get(unit, check_id, check_info);
    }
...
/* Destroy all the flow checks. */
 int bcm_esw_flowtracker_check_destroy_all(
    int unit)
{
    int result = BCM_E_UNAVAIL;
...
int bcm_esw_flowtracker_check_traverse(
    int unit,
...
int bcm_esw_flowtracker_check_action_info_set(
    int unit,
    bcm_flowtracker_check_t check_id,
...
/* Get action information of flow check. */
 int bcm_esw_flowtracker_check_action_info_get(
    int unit,
    bcm_flowtracker_check_t check_id,
    bcm_flowtracker_check_action_info_t *info)
{
...
int bcm_esw_flowtracker_check_export_info_set(
    int unit,
    bcm_flowtracker_check_t check_id,
...
/* Get export information of flow check. */
 int bcm_esw_flowtracker_check_export_info_get(
    int unit,
    bcm_flowtracker_check_t check_id,
    bcm_flowtracker_check_export_info_t *info)
{
...
int bcm_esw_flowtracker_group_check_add(
    int unit,
...
int bcm_esw_flowtracker_group_check_delete(
    int unit,
    bcm_flowtracker_group_t group_id,
    bcm_flowtracker_check_t check_id)
{
...
int bcm_esw_flowtracker_group_check_get_all(
    int unit,
    bcm_flowtracker_group_t group_id,
    int max_checks,
...
int bcm_esw_flowtracker_group_tracking_params_set(
    int unit,
    bcm_flowtracker_group_t id,
...
int bcm_esw_flowtracker_group_tracking_params_get(
    int unit,
    bcm_flowtracker_group_t id,
    int max_size,
    bcm_flowtracker_tracking_param_info_t *list_of_tracking_params,
...
/*
 * Function:
 *      bcm_esw_flowtracker_group_cpu_notification_get
 * Purpose:
 *      Get CPU notifications on the group
 * Parameters:
 *      unit          - (IN)  BCM device number
 *      id            - (IN)  Flow group Id
 *      info          - (IN)  Cpu notification inforamtion
 * Returns:
 *      BCM_E_XXX   - BCM error code.
 */
int
    ...
    bcm_flowtracker_cpu_notification_info_t *info)
{
    ...
    if (soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) {
        result = bcmi_ft_group_cpu_notification_trigger_get(
                unit, id, info);
    }
    /* Release lock */
    BCM_IF_ERROR_RETURN(bcm_esw_flowtracker_unlock(unit));
...
/*
 * Function:
 *      bcm_esw_flowtracker_group_cpu_notification_set
 * Purpose:
 *      Set CPU notifications on the group
 * Parameters:
 *      unit          - (IN)  BCM device number
 *      id            - (IN)  Flow group Id
 *      info          - (IN)  CPU notification inforamtion
    ...
    bcm_flowtracker_cpu_notification_info_t *info)
{
    ...
    if (soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) {
        result = bcmi_ft_group_cpu_notification_trigger_set(
                unit, id, info);
    }
    /* Release lock */
    BCM_IF_ERROR_RETURN(bcm_esw_flowtracker_unlock(unit));
