/* 
 * $Id: mbcm.c,v 1.1.2.1 Broadcom SDK $
...
mbcm_functions_t mbcm_hurricane3_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_hu_cosq_config_get,
    bcm_hu_cosq_mapping_set,
    bcm_hu_cosq_mapping_get,
    bcm_hu_cosq_port_sched_set,
    bcm_hu_cosq_port_sched_get,
    bcm_hu_cosq_sched_weight_max_get,
    bcm_hu_cosq_port_bandwidth_set,
    bcm_hu_cosq_port_bandwidth_get,
    bcm_gh_cosq_discard_set,
    bcm_gh_cosq_discard_get,
    bcm_gh_cosq_discard_port_set,
    bcm_gh_cosq_discard_port_get,
...
#else  /* BCM_HURRICANE3_SUPPORT */
int bcm_esw_hurricane3_mbcm_not_empty;
