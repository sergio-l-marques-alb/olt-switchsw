 ...
 *
 * Notes:
 *   Needs improvement if amy used extractors are using 4-bit gran.
 */
int
_field_ft_keygen_type_a_filler_extractors_set(
        int unit,
        _field_ft_keygen_type_a_ext_t *extractors)
{
    ...
    int filler_8bit_exts = 0, filler_16bit_exts = 0;
    ...
    if (filler_extractor_required == TRUE) {
        ...
        if (unused_bits != (8 * filler_8bit_exts + 16 * filler_16bit_exts)) {
            return BCM_E_INTERNAL;
        }
