...
_field_wb_hgt_rh_set_recover(int unit, _field_entry_t *f_ent,
                            uint32 *ebuf, _field_action_bmp_t *act_bmp);
int
_field_wb_loopback_profile_set_recover(int unit, _field_entry_t *f_ent,
                            uint32 *ebuf, _field_action_bmp_t *act_bmp);
int
_field_wb_fcoe_vsan_set_recover(int unit, _field_entry_t *f_ent,
                            uint32 *ebuf, _field_action_bmp_t *act_bmp);
int
_field_wb_tx_timestamp_insertion_set_recover(int unit, _field_entry_t *f_ent,
                            uint32 *ebuf, _field_action_bmp_t *act_bmp);
int
_field_wb_rx_timestamp_insertion_set_recover(int unit, _field_entry_t *f_ent,
                            uint32 *ebuf, _field_action_bmp_t *act_bmp);
int
_field_wb_ignore_fcoe_zone_check_set_recover(int unit, _field_entry_t *f_ent,
                            uint32 *ebuf, _field_action_bmp_t *act_bmp);
...
void* _field_wb_action_recovery_func_ptr[_FieldActionSetCount] = {
    ...
    _field_wb_loopback_profile_set_recover, /* _FieldActionLoopbackProfileSet */
    ...
    _field_wb_tx_timestamp_insertion_set_recover, /*_FieldActionTxTimestampInsertionSet */
    _field_wb_rx_timestamp_insertion_set_recover, /*_FieldActionRxTimestampInsertionSet */
    _field_wb_ignore_fcoe_zone_check_set_recover, /*_FieldActionIgnoreFCOEZoneCheckSet */
    ...
    _field_wb_fcoe_vsan_set_recover, /* _FieldActionFcoeVsanSet */
...
#define ACTION_CHECK_SUPPORT_AND_GET(_unit_, _f_ent_, _buf_, _action_, _flags_,  _a_offset_)   \
            do {                                                             \
               int _rv_;                                                     \
               _rv_ = _bcm_field_action_val_get((_unit_), (_f_ent_),         \
                                                   (_buf_), (_action_),      \
                                                   (_flags_), (_a_offset_)); \
               if (BCM_E_UNAVAIL == _rv_) {                                  \
                   continue;                                                 \
               }                                                             \
                              ...
                              _field_action_bmp_t *act_bmp)
{
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (bcmFieldActionAssignOpaqueObject3 == action_arr[action_idx]) {
            if (act_bmp != NULL) {
                if (act_bmp->w == NULL) {
                    continue;
                } else {
...
/*
 * Function:
 *     _field_wb_loopback_profile_set_recover
 * Purpose:
 *      Recover actions that belong to Loopback profile Action Set
 *
 * Parameters:
 *      unit     - (IN) StrataSwitch unit #.
 *      f_ent    - (IN) pointer to entry structure which refers
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (valid) {
            ...
            if (5 == a_offset.value[0]) {
                f_act->param[0] = bcmFieldLoopbackTypeMasquerade;
            }
            f_act->old_index = -1;
            f_act->flags = _FP_ACTION_VALID;
            if (prev_act == NULL) {
...
/*
 * Function:
 *     _field_wb_fcoe_vsan_set_recover
 * Purpose:
 *      Recover actions that belong to FCoE Vsan set
 *
 * Parameters:
 *      unit     - (IN) StrataSwitch unit #.
 *      f_ent    - (IN) pointer to entry structure which refers
                            ...
                            uint32 *ebuf, _field_action_bmp_t *act_bmp)
{
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (valid) {
            f_act = NULL;
            _FP_XGS3_ALLOC(f_act, sizeof(_field_action_t), "FP WB PDD FCoE Vsan Alloc");
            if (f_act == NULL) {
                return BCM_E_MEMORY;
            }
            f_act->action = action_arr[action_idx];
...
/*
 * Function:
 *     _field_wb_tx_timestamp_insertion_set_recover
 * Purpose:
 *      Recover actions that belong to Tx Timestamp insertion set
 *
 * Parameters:
 *      unit     - (IN) StrataSwitch unit #.
 *      f_ent    - (IN) pointer to entry structure which refers
                            ...
                            uint32 *ebuf, _field_action_bmp_t *act_bmp)
{
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (valid) {
            f_act = NULL;
            _FP_XGS3_ALLOC(f_act, sizeof(_field_action_t), "FP WB PDD Tx Timestamp Insertion Alloc");
            if (f_act == NULL) {
                return BCM_E_MEMORY;
            }
            f_act->action = action_arr[action_idx];
...
/*
 * Function:
 *     _field_wb_rx_timestamp_insertion_set_recover
 * Purpose:
 *      Recover actions that belong to Rx TimeStamp Insertion set
 *
 * Parameters:
 *      unit     - (IN) StrataSwitch unit #.
 *      f_ent    - (IN) pointer to entry structure which refers
...
/*
 * Function:
 *     _field_wb_ignore_fcoe_zone_check_set_recover
 * Purpose:
 *      Recover actions that belong to Ignore FCoE Zone Check set
 *
 * Parameters:
 *      unit     - (IN) StrataSwitch unit #.
 *      f_ent    - (IN) pointer to entry structure which refers
                            ...
                            uint32 *ebuf, _field_action_bmp_t *act_bmp)
{
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (valid) {
            f_act = NULL;
            _FP_XGS3_ALLOC(f_act, sizeof(_field_action_t), "FP WB PDD FCoE Zone Check Alloc");
            if (f_act == NULL) {
                return BCM_E_MEMORY;
            }
            f_act->action = action_arr[action_idx];
