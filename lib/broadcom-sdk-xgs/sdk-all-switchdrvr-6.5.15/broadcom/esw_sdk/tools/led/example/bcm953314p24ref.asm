;
; $Id: bcm953314p24ref.asm,v 1.11 Broadcom SDK $
;
; $Copyright: (c) 2018 Broadcom.
; Broadcom Proprietary and Confidential. All rights reserved.$
; 
;
; This is the default program for the (24 port) BCM953314P24REF
; reference board.
; To start it, use the following commands from BCM:
;
;       led load bcm953314p24ref.hex
;       led auto on
;       led start
;
...
act1:
	    ...
	    ;pop 
	    jnc     led_black
        jmp     led_amber         ; No activity

act2:                           ; Both TX and RX active
        ld      b,(TXRX_ALT_COUNT)
        cmp     b,TXRX_ALT_TICKS/2
        jc      led_black        ; Fast alternation of green/amber
        jmp     led_amber
