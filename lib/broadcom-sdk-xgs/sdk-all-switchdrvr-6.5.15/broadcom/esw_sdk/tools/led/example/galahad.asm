;
; $Id: galahad.asm,v 1.6 Broadcom SDK $
;
...
;
;	0:led load galahad.hex
;	0:led auto on
;	1:led load galahad.hex
;	1:led auto on
;	*:led start
;
...
;
; The Galahad has 12 columns of 4 LEDs each as shown below:
;
;            5690 Unit 1              5690 Unit 2
;       -----------------------  -----------------------
;       L01 L03 L05 L07 L09 L11  L01 L03 L05 L07 L09 L11
;       A01 A03 A05 A07 A09 A11  A01 A03 A05 A07 A09 A11
;       L02 L04 L06 L08 L10 L12  L02 L04 L06 L08 L10 L12
;       A02 A04 A06 A08 A10 A12  A02 A04 A06 A08 A10 A12
;
; This program runs on each 5690.  The one running on unit 0 controls
; the first 6 columns, the one running on unit 1 controls the second
; 6 columns.
;
