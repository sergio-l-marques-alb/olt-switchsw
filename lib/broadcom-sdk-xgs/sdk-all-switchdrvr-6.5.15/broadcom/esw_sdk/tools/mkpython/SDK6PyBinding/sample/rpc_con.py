...
client_ip = netaddr.IPAddress(client_ip_addr)
server_ip = netaddr.IPAddress(server_ip_addr)

print(bcm_ctsoc_mem_control(use_heap))
print(bcm_ctsoc_cpudb_create(2))
print(bcm_ctsoc_client_install(2, client_ip.value))
print(bcm_ctsoc_client_install(1, server_ip.value))
