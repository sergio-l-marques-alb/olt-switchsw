...
#ifndef _MADURA_DIAGNOSTICS_H__H_
#define _MADURA_DIAGNOSTICS_H__H_
...
int madura_phy_link_mon_enable_set(const phymod_phy_access_t* phy, phymod_link_monitor_mode_t link_mon_mode, uint32_t enable);
int madura_phy_link_mon_enable_get(const phymod_phy_access_t* phy, phymod_link_monitor_mode_t link_mon_mode, uint32_t* enable);
