...
int tscbh_gen2_phy_tx_override_set(const phymod_phy_access_t* phy, const phymod_tx_override_t* tx_override);
int tscbh_gen2_phy_tx_override_get(const phymod_phy_access_t* phy, phymod_tx_override_t* tx_override);
...
/*Set timesync adjust*/
int tscbh_gen2_timesync_adjust_set(const phymod_phy_access_t* phy, phymod_timesync_compensation_mode_t ts_am_norm_mode);
...
int tscbh_gen2_phy_pll_reconfig(const phymod_phy_access_t* phy, uint8_t pll_index, uint32_t pll_div);
