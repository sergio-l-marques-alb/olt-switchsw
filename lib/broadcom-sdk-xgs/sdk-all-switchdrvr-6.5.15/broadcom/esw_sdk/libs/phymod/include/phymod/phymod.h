...
typedef enum phymod_dispatch_type_e {
    ...
    phymodDispatchTypeBlackhawk7_v1l8p2,
...
typedef struct phymod_firmware_core_config_s {
    ...
    uint32_t osr_2p5_available; /**< OSR2p5 available */
 ...
 *
 * @brief set the tx fir post initial value in uC RAM for link training 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  tx_post         - 
 */
 ...
 */
int phymod_phy_pll_reconfig(const phymod_phy_access_t* phy, uint8_t pll_index, uint32_t pll_div);
