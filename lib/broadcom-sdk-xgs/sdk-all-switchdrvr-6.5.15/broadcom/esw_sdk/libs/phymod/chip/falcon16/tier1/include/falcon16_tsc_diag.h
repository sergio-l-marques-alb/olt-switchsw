...
err_code_t falcon16_tsc_INTERNAL_poll_diag_data(srds_access_t *sa__, falcon16_tsc_info_t *falcon16_tsc_info_ptr, uint16_t *status, uint8_t *diag_rd_ptr, uint8_t byte_count, uint32_t timeout_ms);
