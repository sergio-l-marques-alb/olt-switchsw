 ...
 */
#define merlin16_configure_pll_refclk_div_vco merlin16_INTERNAL_configure_pll 
/** Configure PLL.
 *
 ...
 * @param div Divider value, in the same encoding as enum #merlin16_pll_div_enum.
 * @param *vco_freq_khz VCO output frequency, in kHz, obtained based on reference clock frequency and dic value
 * @param pll_option Select PLL configuration option from enum #merlin16_pll_option_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_get_vco_from_refclk_div(uint32_t refclk_freq_hz, enum merlin16_pll_div_enum div, uint32_t *vco_freq_khz, enum merlin16_pll_option_enum pll_option);
