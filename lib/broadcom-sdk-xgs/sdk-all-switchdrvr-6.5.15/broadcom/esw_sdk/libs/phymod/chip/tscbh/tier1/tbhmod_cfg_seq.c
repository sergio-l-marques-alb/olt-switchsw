...
int tbhmod_autoneg_ability_get(PHYMOD_ST* pc, phymod_autoneg_advert_abilities_t* autoneg_abilities)
{
  ...
  if (AN_X4_CL73_CFGr_MSA_FEC_MAPPINGf_GET(AN_X4_CL73_CFGr_reg)) {
      ...
      if (AN_X4_LD_UP1_ABIL0r_BAM_400G_BRCM_FEC_KR8_CR8f_GET(AN_X4_LD_UP1_ABIL0r_reg)) {
          PHYMOD_IF_ERR_RETURN(
             _an_ability_construct(&(autoneg_abilities->autoneg_abilities[i]),
                                    400000, 8, phymod_fec_RS544_2XN, pause, phymod_channel_long, phymod_AN_MODE_CL73BAM));
          i++;
      }
      if (AN_X4_LD_UP1_ABIL0r_BAM_50G_CR2f_GET(AN_X4_LD_UP1_ABIL0r_reg)
          || AN_X4_LD_UP1_ABIL0r_BAM_50G_KR2f_GET(AN_X4_LD_UP1_ABIL0r_reg)) {
...
int tbhmod_rs_fec_rx_control_0(PHYMOD_ST* pc, int cl91_bypass_indication)
{
  ...
  PHYMOD_DEBUG_ERROR(("%-22s RX_X4_Control0_RS_FEC_rx_control_0 Reg: cl91_bypass_indication=%0x ln=%0x\n", __func__,
            cl91_bypass_indication, pc->lane_mask));
