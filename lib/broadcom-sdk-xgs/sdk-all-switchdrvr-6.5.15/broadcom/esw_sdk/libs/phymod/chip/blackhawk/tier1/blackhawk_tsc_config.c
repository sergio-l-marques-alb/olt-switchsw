...
err_code_t blackhawk_tsc_init_blackhawk_tsc_info(srds_access_t *sa__) {
    ...
    err_code_t err_code = ERR_CODE_NONE;
    blackhawk_tsc_info_t * blackhawk_tsc_info_ptr = blackhawk_tsc_INTERNAL_get_blackhawk_tsc_info_ptr(sa__);
...
err_code_t blackhawk_tsc_firmware_load_none_init_blackhawk_tsc_info(srds_access_t *sa__) {
    blackhawk_tsc_info_t * const blackhawk_tsc_info_ptr = blackhawk_tsc_INTERNAL_get_blackhawk_tsc_info_ptr(sa__);
...
err_code_t blackhawk_tsc_configure_pll_refclk_div(srds_access_t *sa__,
    ...
    return blackhawk_tsc_INTERNAL_configure_pll(sa__, refclk, div, 0, BLACKHAWK_TSC_PLL_OPTION_NONE);
}
...
err_code_t blackhawk_tsc_configure_pll_div_vco(srds_access_t *sa__,
                                        enum blackhawk_tsc_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return blackhawk_tsc_INTERNAL_configure_pll(sa__, BLACKHAWK_TSC_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, BLACKHAWK_TSC_PLL_OPTION_NONE);
}
...
err_code_t blackhawk_tsc_configure_pll_refclk_div_div2refclk(srds_access_t *sa__,
                                           enum blackhawk_tsc_pll_refclk_enum refclk,
                                           enum blackhawk_tsc_pll_div_enum div) {
   return blackhawk_tsc_INTERNAL_configure_pll(sa__, refclk, div, 0, BLACKHAWK_TSC_PLL_OPTION_REFCLK_DIV2_EN);
}
...
err_code_t blackhawk_tsc_configure_pll_div_vco_div2refclk(srds_access_t *sa__,
                                        enum blackhawk_tsc_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return blackhawk_tsc_INTERNAL_configure_pll(sa__, BLACKHAWK_TSC_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, BLACKHAWK_TSC_PLL_OPTION_REFCLK_DIV2_EN);
}
/* following routines divide refclk input by 2 to prevent fracn mode */
err_code_t blackhawk_tsc_configure_pll_refclk_div_div4refclk(srds_access_t *sa__,
                                           enum blackhawk_tsc_pll_refclk_enum refclk,
                                           enum blackhawk_tsc_pll_div_enum div) {
   return blackhawk_tsc_INTERNAL_configure_pll(sa__, refclk, div, 0, BLACKHAWK_TSC_PLL_OPTION_REFCLK_DIV4_EN);
}
...
err_code_t blackhawk_tsc_configure_pll_div_vco_div4refclk(srds_access_t *sa__,
                                        enum blackhawk_tsc_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return blackhawk_tsc_INTERNAL_configure_pll(sa__, BLACKHAWK_TSC_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, BLACKHAWK_TSC_PLL_OPTION_REFCLK_DIV4_EN);
}

err_code_t blackhawk_tsc_configure_pll_refclk_div_refclk_2x(srds_access_t *sa__,
                                           enum blackhawk_tsc_pll_refclk_enum refclk,
                                           enum blackhawk_tsc_pll_div_enum div) {
    return blackhawk_tsc_INTERNAL_configure_pll(sa__, refclk, div, 0, BLACKHAWK_TSC_PLL_OPTION_REFCLK_DOUBLER_EN);
}
...
err_code_t blackhawk_tsc_configure_pll_div_vco_refclk_2x(srds_access_t *sa__,
                                        enum blackhawk_tsc_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return blackhawk_tsc_INTERNAL_configure_pll(sa__, BLACKHAWK_TSC_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, BLACKHAWK_TSC_PLL_OPTION_REFCLK_DOUBLER_EN);
}

err_code_t blackhawk_tsc_get_vco_from_refclk_div(srds_access_t *sa__, uint32_t refclk_freq_hz, enum blackhawk_tsc_pll_div_enum div, uint32_t *vco_freq_khz, enum blackhawk_tsc_pll_option_enum pll_option) {
    EFUN(blackhawk_tsc_INTERNAL_get_vco_from_refclk_div(sa__, refclk_freq_hz, div, vco_freq_khz, pll_option));
    return (ERR_CODE_NONE);
}
