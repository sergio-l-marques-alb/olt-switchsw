...
__phymod__dispatch__t__ phymod_qtce_driver = {

    qtce_core_identify,
    qtce_core_info_get,
    qtce_core_lane_map_set,
    qtce_core_lane_map_get,
    qtce_core_reset_set,
    qtce_core_reset_get,
    qtce_core_firmware_info_get,
    qtce_phy_firmware_core_config_set,
    qtce_phy_firmware_core_config_get,
    qtce_phy_firmware_lane_config_set,
    qtce_phy_firmware_lane_config_get,
    qtce_core_pll_sequencer_restart,
    qtce_core_wait_event,
    qtce_phy_rx_restart,
    qtce_phy_polarity_set,
    qtce_phy_polarity_get,
    qtce_phy_tx_set,
    qtce_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    eagle_phy_media_type_tx_get,
    qtce_phy_tx_override_set,
    qtce_phy_tx_override_get,
    ...
    qtce_phy_tx_lane_control_set,
    qtce_phy_tx_lane_control_get,
    qtce_phy_rx_lane_control_set,
    qtce_phy_rx_lane_control_get,
    qtce_phy_fec_enable_set,
    qtce_phy_fec_enable_get,
    ...
    qtce_phy_eee_set,
    qtce_phy_eee_get,
    qtce_phy_interface_config_set,
    qtce_phy_interface_config_get,
    qtce_phy_cl72_set,
    qtce_phy_cl72_get,
    qtce_phy_cl72_status_get,
    qtce_phy_autoneg_ability_set,
    qtce_phy_autoneg_ability_get,
    qtce_phy_autoneg_remote_ability_get,
    qtce_phy_autoneg_set,
    qtce_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    qtce_phy_autoneg_status_get,
    qtce_core_init,
    qtce_phy_pll_multiplier_get,
    qtce_phy_init,
    qtce_phy_loopback_set,
    qtce_phy_loopback_get,
    qtce_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_signal_detect_get */
    qtce_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    qtce_phy_pcs_userspeed_set,
    qtce_phy_pcs_userspeed_get,
    qtce_phy_reg_read,
    qtce_phy_reg_write,
    ...
    qtce_phy_synce_clk_ctrl_set,
    qtce_phy_synce_clk_ctrl_get,
