 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: falcon_furia_interface.h 970 2015-03-13 21:24:59Z kirand $   *
 *                                                                                 *
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_furia_get_uc_core_config( const phymod_access_t *pa, struct falcon_furia_uc_core_config_st *struct_val);
...
/** Column definition header for falcon_furia_display_core_state() API output.
 * To be called before falcon_furia_display_core_state_line() API.
 ...
 * Call falcon_furia_display_core_state_hdr() API before and falcon_furia_display_core_state_legend() after
...
/** Detailed description of each column in falcon_furia_display_core_state_line() API output.
 * To be called after falcon_furia_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: falcon_furia_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 * Along with falcon_furia_core_pwrdn(), all lanes powerdowns should also be issued using
 * falcon_furia_lane_pwrdn() to complete a Core Powerdown.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_furia_get_uc_lane_cfg( const phymod_access_t *pa, struct falcon_furia_uc_lane_config_st *struct_val);
 ...
 * It relies on the accuracy of falcon_furia_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use falcon_furia_read_eye_scan_stripe() function
 ...
 * \n Note: Call functions falcon_furia_display_lane_state_hdr() before and falcon_furia_display_lane_state_legend() after
 ...
 * This function is required to be implemented by upper level software to enable falcon_furia support.
...
/** Parameterized diagnostic function which access to all falcon_furia control and status bits
 * This function is required to be implemented by upper level software to enable falcon_furia support.
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the falcon_furia_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Once the PRBS generator is configured, to enable PRBS use the falcon_furia_tx_prbs_en() API.
 ...
 * Once the PRBS checker is configured, use the falcon_furia_rx_prbs_en() API to enable the checker.
 ...
 * Note: User needs to configure all lanes through falcon_furia_lane_config_for_iddq() and also call falcon_furia_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * If you want loop timing use falcon_furia_rmt_lpbk()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function should be called prior to falcon_furia_rptr_mode_timing();
 * @param enable Enable/Disable (1 = Enable; 0 = Disable)
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
