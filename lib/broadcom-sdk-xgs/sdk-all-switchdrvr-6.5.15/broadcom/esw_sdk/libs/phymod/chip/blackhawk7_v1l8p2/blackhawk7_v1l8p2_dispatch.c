...
#ifdef PHYMOD_BLACKHAWK7_V1L8P2_SUPPORT

#include <phymod/chip/blackhawk7_v1l8p2.h>


__phymod__dispatch__t__ phymod_blackhawk7_v1l8p2_driver = {

    blackhawk7_v1l8p2_core_identify,
    blackhawk7_v1l8p2_core_info_get,
    blackhawk7_v1l8p2_core_lane_map_set,
    blackhawk7_v1l8p2_core_lane_map_get,
    blackhawk7_v1l8p2_core_reset_set,
    blackhawk7_v1l8p2_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    blackhawk7_v1l8p2_phy_firmware_lane_config_set,
    blackhawk7_v1l8p2_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    blackhawk7_v1l8p2_phy_rx_restart,
    blackhawk7_v1l8p2_phy_polarity_set,
    blackhawk7_v1l8p2_phy_polarity_get,
    blackhawk7_v1l8p2_phy_tx_set,
    blackhawk7_v1l8p2_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    blackhawk7_v1l8p2_phy_media_type_tx_get,
    blackhawk7_v1l8p2_phy_tx_override_set,
    blackhawk7_v1l8p2_phy_tx_override_get,
    ...
    blackhawk7_v1l8p2_phy_tx_lane_control_set,
    blackhawk7_v1l8p2_phy_tx_lane_control_get,
    blackhawk7_v1l8p2_phy_rx_lane_control_set,
    blackhawk7_v1l8p2_phy_rx_lane_control_get,
    ...
    blackhawk7_v1l8p2_phy_cl72_set,
    blackhawk7_v1l8p2_phy_cl72_get,
    blackhawk7_v1l8p2_phy_cl72_status_get,
    ...
    blackhawk7_v1l8p2_core_init,
    blackhawk7_v1l8p2_phy_pll_multiplier_get,
    blackhawk7_v1l8p2_phy_init,
    blackhawk7_v1l8p2_phy_loopback_set,
    blackhawk7_v1l8p2_phy_loopback_get,
    blackhawk7_v1l8p2_phy_rx_pmd_locked_get,
    blackhawk7_v1l8p2_phy_rx_signal_detect_get,
    ...
    blackhawk7_v1l8p2_phy_reg_read,
    blackhawk7_v1l8p2_phy_reg_write,
    ...
    blackhawk7_v1l8p2_phy_speed_config_set,
    blackhawk7_v1l8p2_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    blackhawk7_v1l8p2_phy_tx_taps_default_get,
    blackhawk7_v1l8p2_phy_lane_config_default_get,
    blackhawk7_v1l8p2_phy_firmware_load_info_get,
    ...
    blackhawk7_v1l8p2_phy_tx_pam4_precoder_enable_set,
    blackhawk7_v1l8p2_phy_tx_pam4_precoder_enable_get,
    blackhawk7_v1l8p2_phy_tx_phase_lock_set,
...
#endif /* PHYMOD_BLACKHAWK7_V1L8P2_SUPPORT */
