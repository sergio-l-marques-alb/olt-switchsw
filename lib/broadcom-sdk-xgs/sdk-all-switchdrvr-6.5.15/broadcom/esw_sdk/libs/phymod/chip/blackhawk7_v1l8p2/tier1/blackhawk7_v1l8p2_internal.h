 ...
 * @param *div Divider value (enumerated), or BLACKHAWK7_V1L8P2_PLL_DIV_UNKNOWN to auto-compute.
...
static const int blackhawk7_v1l8p2_endian_const = 1;
#define is_big_endian() ((*(char*)&blackhawk7_v1l8p2_endian_const) == 0)
