 ...
 */
uint32_t blackhawk7_v1l8p2_rd_long_uc_prog_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p2_wr_long_uc_ram(srds_access_t *sa__, uint16_t addr, uint32_t wr_val);
 ...
 */
uint32_t blackhawk7_v1l8p2_rd_long_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t blackhawk7_v1l8p2_rdw_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t blackhawk7_v1l8p2_rdb_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t blackhawk7_v1l8p2_rdws_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t blackhawk7_v1l8p2_rdbs_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
