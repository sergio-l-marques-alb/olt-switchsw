 ...
 */
err_code_t merlin16_pmd_rdt_reg(srds_access_t *sa__, uint16_t address, uint16_t *val)
{
    uint32_t data;
 ...
 */
err_code_t merlin16_pmd_wr_reg(srds_access_t *sa__, uint16_t address, uint16_t val)
{
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pmd_mwr_reg(srds_access_t *sa__, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t val)
{
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pmd_wr_pram(srds_access_t *sa__, uint8_t val)
{
    return ERR_CODE_NONE;
}
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t merlin16_delay_ns(srds_access_t *sa__, uint16_t delay_ns)
{
    uint32_t delay;
    delay = delay_ns / 1000; 
    if(!delay) {
...
#else
err_code_t merlin16_delay_ns(uint16_t delay_ns)
{
    uint32_t delay;
    delay = delay_ns / 1000; 
    if(!delay) {
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t merlin16_delay_us(srds_access_t *sa__, uint32_t delay_us)
{
    PHYMOD_USLEEP(delay_us);
    return 0;
}
#else
err_code_t merlin16_delay_us(uint32_t delay_us)
{
    PHYMOD_USLEEP(delay_us);
    return 0;
}
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t merlin16_delay_ms(srds_access_t *sa__, uint32_t delay_ms)
{
    return 0;
}
#else
err_code_t merlin16_delay_ms(uint32_t delay_ms)
{
    uint32_t delay;
    delay = delay_ms * 1000;
    if (!delay ) {
 ...
 */
uint8_t merlin16_get_core(srds_access_t *sa__)
{
    return 0;
}
 ...
 */
uint8_t merlin16_get_lane(srds_access_t *sa__)
{
 ...
 */
err_code_t merlin16_set_lane(srds_access_t *sa__, uint8_t lane_index)
{
    return ERR_CODE_NONE;
}
