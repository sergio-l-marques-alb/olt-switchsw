...
int eagle_phy_pattern_enable_set(const phymod_phy_access_t* phy, uint32_t enable, phymod_pattern_t* pattern)
{
    PHYMOD_IF_ERR_RETURN
...
int eagle_diagnostics_eye_margin_proj( const phymod_phy_access_t* phy, uint32_t flags,
                                        const phymod_phy_eyescan_options_t* eyescan_options) {
...
int eagle_phy_pmd_info_dump(const phymod_phy_access_t* phy, void *arg)
{
...
int eagle_phy_prbs_config_set(const phymod_phy_access_t* phy, uint32_t flags , phymod_prbs_t* prbs)
{
