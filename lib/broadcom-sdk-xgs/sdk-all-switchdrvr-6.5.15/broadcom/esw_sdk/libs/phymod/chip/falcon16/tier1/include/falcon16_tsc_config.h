 ...
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_tsc_set_an_los_workaround(srds_access_t *sa__, uint8_t an_los_workaround);
#endif

/** Set the osr_2p5_available flag in the core configuration.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param osr_2p5_available The value to set
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_tsc_set_osr_2p5_available(srds_access_t *sa__, uint8_t osr_2p5_available);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_tsc_get_vco_from_refclk_div(srds_access_t *sa__, uint32_t refclk_freq_hz, enum falcon16_tsc_pll_div_enum div, uint32_t *vco_freq_khz, enum falcon16_tsc_pll_option_enum pll_option);
