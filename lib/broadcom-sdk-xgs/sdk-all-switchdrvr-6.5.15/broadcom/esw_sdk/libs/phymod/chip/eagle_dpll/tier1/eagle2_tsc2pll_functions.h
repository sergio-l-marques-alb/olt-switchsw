/****************************************************************************
 * File Name  :  eagle2_tsc2pll_functions.h
 * Created On :  29/04/2013
 * Created By :  Kiran Divakar
 * Description:  Header file with API functions for Serdes IPs
 * Revision   :  $Id: eagle2_tsc2pll_functions.h 1543 2017-04-07 20:52:44Z kirand $
 *
...
#ifndef EAGLE2_TSC2PLL_API_FUNCTIONS_H
#define EAGLE2_TSC2PLL_API_FUNCTIONS_H
...
#include "eagle2_tsc2pll_interface.h"
#include "eagle2_tsc2pll_debug_functions.h"
#include "eagle2_tsc2pll_common.h"
#include "eagle_merlin_api_uc_common.h"
#include "common/srds_api_uc_common.h"

#include "eagle2_tsc2pll_field_access.h"
...
/**
 * This build includes register access macros for EAGLE2 TSC2PLL cores.
 */
#include "eagle2_tsc2pll_fields.h"
...
/**
 * Invoke possibly-remapped 'memcpy()' and, if it returns NULL, force an
 * error return.
 *
 * Ordinarily, standard implementations of 'memcpy' will return NULL only if
 * passed a NULL destination address, and *may already* have overwritten an
 * inappropriate address range before returning:  nevertheless, a specialized
 * implementation could use a NULL return to indicate other failures.  In
 * either case, execution should not be allowed to proceed on NULL return.
 */
#define ENULL_MEMCPY(dest, src, size) ENULL((USR_MEMCPY((dest), (src), (size))))
 ...
 * either case, execution should not be allowed to proceed on NULL return.
 */
#define EPNULL_MEMCPY(dest, src, size) EPNULL((USR_MEMCPY((dest), (src), (size))))
