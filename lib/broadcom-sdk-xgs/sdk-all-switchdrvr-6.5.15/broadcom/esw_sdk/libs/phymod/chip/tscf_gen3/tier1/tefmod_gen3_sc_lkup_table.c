/*----------------------------------------------------------------------
 * $Id: tefmod_gen3_sc_lkup_table.c, $
...
int tefmod_gen3_am_bits_get(int speed, uint32_t *am_bits)
{
...
int tefmod_gen3_no_pmd_txrx_fixed_latency_get(int speed, uint16_t *tx_fixed_int, uint16_t *tx_fixed_frac, uint16_t *rx_fixed_int, uint16_t *rx_fixed_frac)
{
  switch(speed) {
...
int tefmod_gen3_ui_values_get(int speed, uint16_t *ui_msb, uint16_t *ui_lsb)
{
  switch(speed) {
...
int tefmod_gen3_vl_bml_get(int speed, uint16_t *vl, uint16_t *bml)
{
...
int tefmod_gen3_mapped_frac_ns_get(int dual_pll, int speed, uint16_t *frac_ns)
{
  switch(speed) {
     ...
     case sc_x4_control_sc_S_10G_X1           : { *frac_ns =  0x634c ; break; } /* TSC_SPEED_10G_XFI 20.625G VCO */
     case sc_x4_control_sc_S_10G_CR1          : { *frac_ns =  0x634c ; break; } /* TSC_SPEED_10G_XFI 20.625G VCO */
     case sc_x4_control_sc_S_10G_KR1          : { *frac_ns =  0x634c ; break; } /* TSC_SPEED_10G_XFI 20.625G VCO */
     ...
     case sc_x4_control_sc_S_10G_HG2_CR1      : { *frac_ns =  0x5d9f ; break; } /* TSC_SPEED_10P606G_XFI 21.875G VCO */
     case sc_x4_control_sc_S_10G_HG2_KR1      : { *frac_ns =  0x5d9f ; break; } /* TSC_SPEED_10P606G_XFI 21.875G VCO */
     case sc_x4_control_sc_S_10G_HG2_X1       : { *frac_ns =  0x5d9f ; break; } /* TSC_SPEED_10P606G_XFI 21.875G VCO */
  ...
  /* Overrides value for B2B Env if necessary due to fclk driven from higher VCO. */
  if(dual_pll == 1) {
    if(*frac_ns == 0x634c) *frac_ns = 0x4f70 ;
  }

  return PHYMOD_E_NONE;
}

int tefmod_gen3_txrx_fixed_latency_get(int speed, uint16_t *tx_fixed_int, uint16_t *tx_fixed_frac, uint16_t *rx_fixed_int, uint16_t *rx_fixed_frac)
{
  switch(speed) {
    case sc_x4_control_sc_S_CL36_20GVCO   : { *tx_fixed_int = 0x09 ; *tx_fixed_frac = 0x10a ;  *rx_fixed_int = 0xfee ; *rx_fixed_frac = 0x0f7 ; break; } /* TSC_SPEED_1G 20.625G VCO : 16.5 OS */
    case sc_x4_control_sc_S_CL73_20GVCO   : { *tx_fixed_int = 0x09 ; *tx_fixed_frac = 0x10a ;  *rx_fixed_int = 0xfee ; *rx_fixed_frac = 0x0f7 ; break; } /* TSC_SPEED_1G_AN 20.625G VCO : 16.5 OS */

    case sc_x4_control_sc_S_CL36_25GVCO   : { *tx_fixed_int = 0x07 ; *tx_fixed_frac = 0x2d6 ;  *rx_fixed_int = 0xff0 ; *rx_fixed_frac = 0x0d6 ; break; } /* TSC_SPEED_1G 25.78125G VCO : 20.625 OS */
    case sc_x4_control_sc_S_CL73_25GVCO   : { *tx_fixed_int = 0x07 ; *tx_fixed_frac = 0x2d6 ;  *rx_fixed_int = 0xff0 ; *rx_fixed_frac = 0x0d6 ; break; } /* TSC_SPEED_1G_AN 25.78125G VCO : 20.625 OS */


    case sc_x4_control_sc_S_20G_X1        : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x358 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x08d ; break; } /* TSC_SPEED_20G_XFI 20.625G VCO : 1 OS */
    case sc_x4_control_sc_S_20G_CR1       : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x358 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x08d ; break; } /* TSC_SPEED_20G_XFI 20.625G VCO : 1 OS */
    case sc_x4_control_sc_S_20G_KR1       : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x358 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x08d ; break; } /* TSC_SPEED_20G_XFI 20.625G VCO : 1 OS */

    case sc_x4_control_sc_S_40G_X2        : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x358 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x08d ; break; } /* TSC_SPEED_40G_MLD_DXGXS 20.625G VCO : 1 OS */
    case sc_x4_control_sc_S_40G_CR2       : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x358 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x08d ; break; } /* TSC_SPEED_40G_MLD_DXGXS 20.625G VCO : 1 OS */
    case sc_x4_control_sc_S_40G_KR2       : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x358 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x08d ; break; } /* TSC_SPEED_40G_MLD_DXGXS 20.625G VCO : 1 OS */


    case sc_x4_control_sc_S_10G_X1        : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_10G_XFI 20.625G VCO : 2 OS */
    case sc_x4_control_sc_S_10G_CR1       : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_10G_XFI 20.625G VCO : 2 OS */
    case sc_x4_control_sc_S_10G_KR1       : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_10G_XFI 20.625G VCO : 2 OS */

    case sc_x4_control_sc_S_20G_X2        : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_20G_MLD_DXGXS 20.625G VCO : 2 OS */
    case sc_x4_control_sc_S_20G_CR2       : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_20G_MLD_DXGXS 20.625G VCO : 2 OS */
    case sc_x4_control_sc_S_20G_KR2       : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_20G_MLD_DXGXS 20.625G VCO : 2 OS */

    case sc_x4_control_sc_S_40G_X4        : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_40G_MLD 20.625G VCO : 2 OS */
    case sc_x4_control_sc_S_40G_CR4       : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_40G_MLD 20.625G VCO : 2 OS */
    case sc_x4_control_sc_S_40G_KR4       : { *tx_fixed_int = 0x0d ; *tx_fixed_frac = 0x2b0 ;  *rx_fixed_int = 0xff2 ; *rx_fixed_frac = 0x11c ; break; } /* TSC_SPEED_40G_MLD 20.625G VCO : 2 OS */


    case sc_x4_control_sc_S_5G_KR1        : { *tx_fixed_int = 0x1b ; *tx_fixed_frac = 0x161 ;  *rx_fixed_int = 0xfe4 ; *rx_fixed_frac = 0x239 ; break; } /* TSC_SPEED_5G_XFI 20.625G VCO : 4 OS */

    case sc_x4_control_sc_S_20G_HG2_X1    : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x1c8 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x21e ; break; } /* TSC_SPEED_20G_XFI_HG2 21.875G VCO : 1 OS */
    case sc_x4_control_sc_S_20G_HG2_CR1   : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x1c8 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x21e ; break; } /* TSC_SPEED_20G_XFI_HG2 21.875G VCO : 1 OS */
    case sc_x4_control_sc_S_20G_HG2_KR1   : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x1c8 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x21e ; break; } /* TSC_SPEED_20G_XFI_HG2 21.875G VCO : 1 OS */

    case sc_x4_control_sc_S_40G_HG2_X2    : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x1c8 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x21e ; break; } /* TSC_SPEED_42G_HG2_MLD_DXGXS 21.875G VCO : 1 OS */
    case sc_x4_control_sc_S_40G_HG2_CR2   : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x1c8 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x21e ; break; } /* TSC_SPEED_42G_HG2_MLD_DXGXS 21.875G VCO : 1 OS */
    case sc_x4_control_sc_S_40G_HG2_KR2   : { *tx_fixed_int = 0x06 ; *tx_fixed_frac = 0x1c8 ;  *rx_fixed_int = 0xff9 ; *rx_fixed_frac = 0x21e ; break; } /* TSC_SPEED_42G_HG2_MLD_DXGXS 21.875G VCO : 1 OS */


    case sc_x4_control_sc_S_10G_HG2_CR1   : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_10P606G_XFI 21.875G VCO : 2 OS */
    case sc_x4_control_sc_S_10G_HG2_KR1   : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_10P606G_XFI 21.875G VCO : 2 OS */
    case sc_x4_control_sc_S_10G_HG2_X1    : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_10P606G_XFI 21.875G VCO : 2 OS */

    case sc_x4_control_sc_S_20G_HG2_X2    : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_21G_HG2_MLD_DXGXS 21.875G VCO : 2 OS */

    case sc_x4_control_sc_S_40G_HG2_X4    : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_42G_HG2_MLD 21.875G VCO : 2 OS */
    case sc_x4_control_sc_S_40G_HG2_CR4   : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_42G_HG2_MLD 21.875G VCO : 2 OS */
    case sc_x4_control_sc_S_40G_HG2_KR4   : { *tx_fixed_int = 0x0c ; *tx_fixed_frac = 0x390 ;  *rx_fixed_int = 0xff3 ; *rx_fixed_frac = 0x03f ; break; } /* TSC_SPEED_42G_HG2_MLD 21.875G VCO : 2 OS */


    case sc_x4_control_sc_S_25G_X1        : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_XFI 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_CR1       : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_XFI 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_KR1       : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_XFI 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_CR_IEEE   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_CR_IEEE 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_CRS_IEEE  : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_CRS_IEEE 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_KR_IEEE   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_KR_IEEE 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_KRS_IEEE  : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_25G_KRS_IEEE 25.78125G VCO : 1 OS */

    case sc_x4_control_sc_S_50G_X2        : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_50G_MLD_DXGXS 25.78125G VCO */
    case sc_x4_control_sc_S_50G_CR2       : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_50G_MLD_DXGXS or TSC_SPEED_50G_CR2_MSA 25.78125G VCO : 1 OS */
   case sc_x4_control_sc_S_50G_KR2        : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_50G_MLD_DXGXS or TSC_SPEED_50G_KR2_MSA 25.78125G VCO : 1 OS */

    case sc_x4_control_sc_S_100G_X4       : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_100G_MLD 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_100G_CR4      : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_100G_MLD 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_100G_KR4      : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x1e0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x20a ; break; } /* TSC_SPEED_100G_MLD 25.78125G VCO : 1 OS */


    case sc_x4_control_sc_S_50G_X4        : { *tx_fixed_int = 0x0a ; *tx_fixed_frac = 0x3c1 ;  *rx_fixed_int = 0xff5 ; *rx_fixed_frac = 0x017 ; break; } /* TSC_SPEED_50G_MLD 25.78125G VCO : 2 OS */
    case sc_x4_control_sc_S_50G_CR4       : { *tx_fixed_int = 0x0a ; *tx_fixed_frac = 0x3c1 ;  *rx_fixed_int = 0xff5 ; *rx_fixed_frac = 0x017 ; break; } /* TSC_SPEED_50G_MLD 25.78125G VCO : 2 OS */
    case sc_x4_control_sc_S_50G_KR4       : { *tx_fixed_int = 0x0a ; *tx_fixed_frac = 0x3c1 ;  *rx_fixed_int = 0xff5 ; *rx_fixed_frac = 0x017 ; break; } /* TSC_SPEED_50G_MLD 25.78125G VCO : 2 OS */

    case sc_x4_control_sc_S_2P5G_KX1       : { *tx_fixed_int = 0x07 ; *tx_fixed_frac = 0x268 ;  *rx_fixed_int = 0xff6 ; *rx_fixed_frac = 0x2a3 ; break; } /* TSC_SPEED_2P5G 25.78125G VCO : 8.25 OS */


    case sc_x4_control_sc_S_25G_HG2_X1    : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_25G_XFI_HG2 27.34375G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_HG2_CR1   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_25G_XFI_HG2 or TSC_SPEED_25G_CR1_HG2_MSA 27.34375G VCO : 1 OS */
    case sc_x4_control_sc_S_25G_HG2_KR1   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_25G_XFI_HG2 or TSC_SPEED_25G_KR1_HG2_MSA 27.34375G VCO : 1 OS */

    case sc_x4_control_sc_S_50G_HG2_X2    : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_53G_HG2_MLD_DXGXS 27.34375G VCO : 1 OS */
    case sc_x4_control_sc_S_50G_HG2_CR2   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_53G_HG2_MLD_DXGXS or TSC_SPEED_50G_CR2_MSA 25.78125G VCO : 1 OS */
    case sc_x4_control_sc_S_50G_HG2_KR2   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_53G_HG2_MLD_DXGXS or TSC_SPEED_50G_KR2_MSA 25.78125G VCO : 1 OS */

    case sc_x4_control_sc_S_100G_HG2_X4   : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_106G_HG2_MLD 27.34375G VCO : 1 OS */
    case sc_x4_control_sc_S_100G_HG2_CR4  : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_106G_HG2_MLD 27.34375G VCO : 1 OS */
    case sc_x4_control_sc_S_100G_HG2_KR4  : { *tx_fixed_int = 0x05 ; *tx_fixed_frac = 0x0a0 ;  *rx_fixed_int = 0xffa ; *rx_fixed_frac = 0x34b ; break; } /* TSC_SPEED_106G_HG2_MLD 27.34375G VCO : 1 OS */


    case sc_x4_control_sc_S_50G_HG2_X4    : { *tx_fixed_int = 0x0a ; *tx_fixed_frac = 0x141 ;  *rx_fixed_int = 0xff5 ; *rx_fixed_frac = 0x298 ; break; } /* TSC_SPEED_53G_HG2_MLD 27.34375G VCO : 2 OS */
    case sc_x4_control_sc_S_50G_HG2_CR4   : { *tx_fixed_int = 0x0a ; *tx_fixed_frac = 0x141 ;  *rx_fixed_int = 0xff5 ; *rx_fixed_frac = 0x298 ; break; } /* TSC_SPEED_53G_HG2_MLD 27.34375G VCO : 2 OS */
    case sc_x4_control_sc_S_50G_HG2_KR4   : { *tx_fixed_int = 0x0a ; *tx_fixed_frac = 0x141 ;  *rx_fixed_int = 0xff5 ; *rx_fixed_frac = 0x298 ; break; } /* TSC_SPEED_53G_HG2_MLD 27.34375G VCO : 2 OS */
