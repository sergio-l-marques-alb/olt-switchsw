...
/** @file blackhawk7_v1l8p2_diag.h
 * Diagnostic functions provided to IP User
 */

#ifndef BLACKHAWK7_V1L8P2_API_DIAG_H
#define BLACKHAWK7_V1L8P2_API_DIAG_H
...
struct blackhawk7_v1l8p2_eyescan_options_st {
...
/** Column definition header for blackhawk7_v1l8p2_display_core_state() API output.
 * To be called before blackhawk7_v1l8p2_display_core_state_line() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Call blackhawk7_v1l8p2_display_core_state_hdr() API before and blackhawk7_v1l8p2_display_core_state_legend() after
...
/** Detailed description of each column in blackhawk7_v1l8p2_display_core_state_line() API output.
 * To be called after blackhawk7_v1l8p2_display_core_state_line() API to display the legends.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function only initiates the processor actions.  User must use blackhawk7_v1l8p2_read_eye_scan_stripe() function
 ...
 * blackhawk7_v1l8p2_start_ber_scan_test(), blackhawk7_v1l8p2_read_ber_scan_data(), blackhawk7_v1l8p2_display_ber_scan_data().
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 ...
 * \n Note: Call functions blackhawk7_v1l8p2_display_lane_state_hdr() before and blackhawk7_v1l8p2_display_lane_state_legend() after
...
/** Column definition header for blackhawk7_v1l8p2 display state.
 * To be called before blackhawk7_v1l8p2_display_lane_state() function.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p2_display_lane_state_hdr(srds_access_t *sa__);

/** Detailed explanation of each column in blackhawk7_v1l8p2 display state.
 * To be called after blackhawk7_v1l8p2_display_lane_state() function to display the legends.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable blackhawk7_v1l8p2 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Parameterized diagnostic function which access to all blackhawk7_v1l8p2 control and status bits
 * This function is required to be implemented by upper level software to enable blackhawk7_v1l8p2 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
