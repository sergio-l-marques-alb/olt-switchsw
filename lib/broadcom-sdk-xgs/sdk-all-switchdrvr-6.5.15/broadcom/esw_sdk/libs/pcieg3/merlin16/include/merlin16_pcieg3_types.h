...
/** @file merlin16_pcieg3_types.h
 * Common types used by Serdes API functions
 */

#ifndef MERLIN16_PCIEG3_API_TYPES_H
#define MERLIN16_PCIEG3_API_TYPES_H
...
struct merlin16_pcieg3_uc_lane_config_field_st {
...
struct merlin16_pcieg3_uc_core_config_field_st {
...
/** Lane Config Struct */
struct  merlin16_pcieg3_uc_lane_config_st {
  struct merlin16_pcieg3_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  merlin16_pcieg3_uc_core_config_st {
  struct merlin16_pcieg3_uc_core_config_field_st field;
  uint16_t word;
...
struct merlin16_pcieg3_usr_ctrl_func_st {
...
struct merlin16_pcieg3_usr_ctrl_dfe_func_st {
...
struct merlin16_pcieg3_usr_ctrl_disable_functions_st {
  struct merlin16_pcieg3_usr_ctrl_func_st field;
  uint8_t  byte;
};

/** Lane User Control Disable DFE Function Struct */
struct merlin16_pcieg3_usr_ctrl_disable_dfe_functions_st {
  struct merlin16_pcieg3_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
