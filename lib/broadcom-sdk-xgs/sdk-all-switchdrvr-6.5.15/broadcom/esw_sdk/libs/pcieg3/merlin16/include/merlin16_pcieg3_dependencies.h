...
/** @file merlin16_pcieg3_dependencies.h
 * Dependencies to be provided by IP User
 */

#ifndef MERLIN16_PCIEG3_API_DEPENDENCIES_H
#define MERLIN16_PCIEG3_API_DEPENDENCIES_H
 ...
 *
 *    merlin16_pcieg3_pmd_wr_reg(addr, ((merlin16_pcieg3_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
