...
extern int
_bcm_hx5_port_enqueue_set(int unit, bcm_port_t gport, int enable);
extern int
_bcm_hx5_port_enqueue_get(int unit, bcm_port_t gport, int *enable);
...
extern int _bcm_field_hx5_ft_group_hw_alloc(int unit,
            _field_entry_t *f_ent);
...
extern int _field_hx5_ft_keygen_cfg_qual_ext_ctrl_skip(
            int unit,
            bcmi_keygen_cfg_t *keygen_cfg,
            bcm_field_qualify_t skip_qual,
            uint16 *skipped_size);

extern int _field_hx5_ft_keygen_oper_qual_ext_ctrl_apply(
            int unit,
            bcmi_keygen_cfg_t *keygen_cfg,
            bcm_field_qualify_t skip_qual,
            bcmi_keygen_oper_t *keygen_oper);
