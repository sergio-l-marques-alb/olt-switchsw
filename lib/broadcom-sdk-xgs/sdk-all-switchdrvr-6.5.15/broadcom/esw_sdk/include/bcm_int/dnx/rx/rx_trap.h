...
#define DNX_RX_TRAP_NOF_ICMP_PROTOCOL_TRAP_ARGS (32)
...
/**
* My MAC IP/MPLS disable action_profile_idx
*/
#define DNX_RX_TRAP_VTT_MY_MAC_AND_IP_DISABLE_ACTION_PROFILE_IDX    (1)
#define DNX_RX_TRAP_VTT_MY_MAC_AND_MPLS_DISABLE_ACTION_PROFILE_IDX  (2)
...
typedef enum
{
    ...
    */
    DNX_RX_TRAP_CLASS_USER_DEFINED = DNX_RX_TRAP_BLOCK_FIRST,   /* Must be zero since predefined trap_id is used as */
    /**
...
typedef enum
{
    DNX_RX_TRAP_SAME_INTERFACE_CONTEXT_PROFILE_DEFALT = 0,
...
typedef enum
{
    ...
    DNX_RX_TRAP_ETPP_FWD_ACT_NOF_PROFILES = 7
...
typedef enum
{
    ...
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_1 = 3,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_2 = 4,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_3 = 5,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_4 = 6,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_5 = 7,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_6 = 8,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_7 = 9,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_8 = 10,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_9 = 11,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_10 = 12,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_11 = 13,
    DNX_RX_TRAP_FWD_RCY_PROFILE_CONFIGURABLE_12 = 14,
...
/**
* \brief  
*  Set additional configuration of My-ARP/My-NDP protocol trap.
* \par DIRECT INPUT: 
*   \param [in] unit     -  unit id
*   \param [in] protocol_type    -  bcmRxTrapArpMyIp or bcmRxTrapNdpMyIp
...
*   * None
*/
shr_error_e dnx_rx_trap_protocol_my_arp_ndp_set(
    int unit,
...
/**
* \brief  
* Get additional configuration of My-ARP/My-NDP protocol trap.
* \par DIRECT INPUT: 
*   \param [in] unit     -  unit id
*   \param [in] protocol_type    -  bcmRxTrapArpMyIp or bcmRxTrapNdpMyIp
...
*   * None
*/
shr_error_e dnx_rx_trap_protocol_my_arp_ndp_get(
    int unit,
    bcm_rx_trap_t protocol_type,
    dnx_rx_trap_protocol_my_arp_ndp_config_t * config_p);
