...
extern int bcm_dnx_linkscan_mode_set(int unit, bcm_port_t port, int mode);
...
extern int bcm_common_linkscan_trigger_event_get(int unit,
                                                ...
                                                bcm_linkscan_trigger_event_t trigger_event,
                                                int *enable);
extern int dnx_linkscan_init(int unit);
extern int dnx_linkscan_deinit(int unit);
extern int dnx_linkscan_port_init(int unit);
extern int dnx_linkscan_port_remove(int unit);
extern int bcm_common_linkscan_detach(int unit);
