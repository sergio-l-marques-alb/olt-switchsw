...
/**
 * \brief - Verify that we are in VLAN mode
 */
#define DNX_L2_LEARN_MODE_VERIFY_AS_VLAN()                                                                        \
 ...
 * | 6b VMV | Payload type(6b) | 21b Dst | 4b Entry Grouping | 22b OutLif
 */
#define MACT_ENTRY_OUTLIF_OFFSET       (MACT_ENTRY_SIZE - 6 - 6 - 21 - 4 - 22)
#define WA_MACT_ENTRY_OUTLIF_OFFSET    (MACT_ENTRY_OUTLIF_OFFSET - MACT_KEY_SIZE + VMV_SIZE)

/** Default age profile */
#define MACT_DEFAULT_AGE_PROFILE 1

/** The maximum age state of a MACT entry */
#define MACT_MAX_AGE 7
