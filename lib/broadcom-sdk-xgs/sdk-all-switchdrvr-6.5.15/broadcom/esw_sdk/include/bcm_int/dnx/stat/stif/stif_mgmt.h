 ...
 * and the PacketSize)
 */
#define DNX_STIF_INGRESS_MAX_RECORD_ELEMENTS (15)
/**
 * \brief
...
#define DNX_STIF_MGMT_EGRESS_STAT_OBJ_MASK_16_BITS 65535
#define DNX_STIF_MGMT_EGRESS_STAT_OBJ_MASK_18_BITS 262143
#define DNX_STIF_MGMT_EGRESS_STAT_OBJ_SHIFT_16_BITS 16
#define DNX_STIF_MGMT_EGRESS_STAT_OBJ_SHIFT_18_BITS 18
...
* \param [out] elements_array - elements array with shift and
*        masks values
* \return
*   shr_error_e - Error Type
* \remark
