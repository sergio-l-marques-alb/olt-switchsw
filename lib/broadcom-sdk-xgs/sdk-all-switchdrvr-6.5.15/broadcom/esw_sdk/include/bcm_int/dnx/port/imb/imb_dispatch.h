...
typedef int (
    *__dispatch__imb_prd_flex_key_construct_set_f) (
    int unit,
    bcm_port_t port,
    uint32 ether_type_code,
    const bcm_cosq_ingress_drop_flex_key_construct_t * flex_key_config);
typedef int (
    *__dispatch__imb_prd_flex_key_construct_get_f) (
    int unit,
    bcm_port_t port,
    uint32 ether_type_code,
...
typedef int (
    *__dispatch__imb_prd_is_custom_ether_type_get_f) (
    int unit,
    bcm_port_t port,
    uint32 ether_type_code,
...
typedef int (
    *__dispatch__imb_port_ilkn_counter_get_f) (
    int unit,
    bcm_port_t port,
    int counter_type,
    uint64 *counter_val);
typedef int (
    *__dispatch__imb_port_ilkn_counter_clear_f) (
    int unit,
    bcm_port_t port);
typedef int (
...
typedef int (
    *__dispatch__imb_phys_get_f) (
    ...
    bcm_pbmp_t * phys);
typedef int (
    *__dispatch__imb_pms_reset_set_f) (
    int unit,
    int imb_id,
    uint32 in_reset);
typedef int (
    *__dispatch__imb_pms_reset_get_f) (
    int unit,
    int imb_id,
    uint32 *in_reset);
typedef int (
...
typedef struct __imb__dispatch__s__
{
    ...
    __dispatch__imb_prd_flex_key_construct_set_f f_imb_prd_flex_key_construct_set;
    __dispatch__imb_prd_flex_key_construct_get_f f_imb_prd_flex_key_construct_get;
    ...
    __dispatch__imb_prd_is_custom_ether_type_get_f f_imb_prd_is_custom_ether_type_get;
    ...
    __dispatch__imb_port_ilkn_counter_get_f f_imb_port_ilkn_counter_get;
    __dispatch__imb_port_ilkn_counter_clear_f f_imb_port_ilkn_counter_clear;
    ...
    __dispatch__imb_pms_reset_set_f f_imb_pms_reset_set;
    __dispatch__imb_pms_reset_get_f f_imb_pms_reset_get;
