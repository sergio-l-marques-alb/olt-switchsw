...
/** 
 * Callbacks for sw_state_algo_res_create.
 * 
...
*****************************************************/
typedef shr_error_e(
    *dnx_algo_res_simple_bitmap_algorithm_info_set_cb) (
    int unit,
    uint32 module_id,
    sw_state_resource_tag_bitmap_t res_tag_bitmap,
...
*****************************************************/
typedef shr_error_e(
    *dnx_algo_res_simple_bitmap_algorithm_info_get_cb) (
    int unit,
    uint32 module_id,
    sw_state_resource_tag_bitmap_t res_tag_bitmap,
    simple_bitmap_wrap_tag_info_t * algorithm_info);
...
/**
 * \brief Callback struct for sw_state_algo_res_create.
 *
...
typedef struct
{
    ...
    dnx_algo_res_simple_bitmap_algorithm_info_set_cb algorithm_info_set;
    dnx_algo_res_simple_bitmap_algorithm_info_get_cb algorithm_info_get;
} dnx_algo_res_advanced_alogrithm_cb_t;
