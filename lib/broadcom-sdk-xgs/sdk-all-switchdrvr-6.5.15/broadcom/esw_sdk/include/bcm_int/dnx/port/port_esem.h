 ...
 * \param [in] access_type - Access type to esem table.
 * \param [in] esem_default_result_profile - esem default result profile uesd to
 *             allocate new_esem_cmd. DNX_PORT_ESEM_DEFAULT_RESULT_PROFILE_INVALID
 *             means using the previous default result profile.
 ...
 *  by decreasing its referrence counter.
 *
 * \see
 *  None
 */
