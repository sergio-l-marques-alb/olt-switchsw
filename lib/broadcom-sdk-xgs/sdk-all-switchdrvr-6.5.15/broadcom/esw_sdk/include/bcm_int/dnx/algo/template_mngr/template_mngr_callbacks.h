...
*    \param [in] extra_arguments
*      Pointed memory to hold extra arguemnts required for destroying this resource. \n
*      \b As \b input - \n
*       The content of this pointer depends on the algorithm. It's the algorithm's \n
*       responsibility to verify it.
*       If the algorithm doesn't require extra arguemnts, this can be set to NULL.
 ...
 */
/*
 * Sw state template mngr callback implementation, which will replace the old one.
 */
/*
 * {
 */
...
*/
typedef shr_error_e(
    *sw_state_dnx_algo_template_create_cb) (
    int unit,
    uint32 module_id,
...
*/
typedef shr_error_e(
    *sw_state_dnx_algo_template_destroy_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t * multi_set_template,
    void *extra_arguemnts);
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_allocate_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    uint32 flags,
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_exchange_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    uint32 flags,
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_replace_data_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    int profile,
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_profile_data_get_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    int profile,
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_profile_get_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    const void *profile_data,
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_free_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    int profile,
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_clear_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template);
...
*****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_free_all_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    int profile);
 ...
 *****************************************************/
typedef shr_error_e(
    *sw_state_dnx_algo_template_get_next_cb) (
    int unit,
    uint32 module_id,
    sw_state_multi_set_t multi_set_template,
    int *current_profile);
...
typedef struct
{
    sw_state_dnx_algo_template_create_cb create_cb;     /* Mandatory */
    sw_state_dnx_algo_template_allocate_cb allocate_cb; /* Mandatory */
    sw_state_dnx_algo_template_exchange_cb exchange_cb;
    sw_state_dnx_algo_template_profile_data_get_cb profile_data_get_cb; /* Mandatory */
    sw_state_dnx_algo_template_profile_get_cb profile_get_cb;   /* Mandatory */
    sw_state_dnx_algo_template_free_cb free_cb; /* Mandatory */
    sw_state_dnx_algo_template_destroy_cb destroy_cb;   /* Currently not mandatory, but better be implemented. */
    sw_state_dnx_algo_template_replace_data_cb replace_data_cb;
    sw_state_dnx_algo_template_clear_cb clear_cb;
    sw_state_dnx_algo_template_free_all_cb free_all_cb;
    sw_state_dnx_algo_template_get_next_cb get_next_cb;
} sw_state_dnx_algo_template_advanced_alogrithm_cb_t;
