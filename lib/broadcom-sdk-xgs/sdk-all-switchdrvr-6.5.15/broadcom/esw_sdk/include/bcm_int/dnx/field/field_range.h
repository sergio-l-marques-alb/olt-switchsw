 ...
 */
#define DNX_FIELD_RANGE_L4_RANGE_ID_VALID(_unit, _range_id)    \
    (((_range_id) >= DNX_FIELD_RANGE_QUALS_MIN_VAL) && \
     ((_range_id) < dnx_data_field.stage.stage_info_get((_unit), DNX_FIELD_STAGE_IPMF1)->nof_l4_ops_ranges))
/**
...
#define DNX_FIELD_RANGE_L4_RANGE_VALID(range_min_val, range_max_val)  \
    ((range_min_val >= DNX_FIELD_RANGE_QUALS_MIN_VAL) && (range_max_val <= DNX_FIELD_RANGE_L4_OPS_MAX_VAL))
/**
...
#define DNX_FIELD_RANGE_OUT_LIF_RANGE_VALID(range_min_val, range_max_val) \
    ((range_min_val >= DNX_FIELD_RANGE_QUALS_MIN_VAL) && (range_max_val <= DNX_FIELD_RANGE_OUT_LIF_MAX_VAL))
/**
...
#define DNX_FIELD_RANGE_PKT_HDR_RANGE_VALID(range_min_val, range_max_val) \
    ((range_min_val >= DNX_FIELD_RANGE_QUALS_MIN_VAL) && (range_max_val <= DNX_FIELD_RANGE_PKT_HDR_MAX_VAL))
/**
 * } MACROS 
 */
/**
...
typedef enum
{
     ...
     */
    DNX_FIELD_RANGE_TYPE_FIRST = 0x0,
    /**
     ...
     */
    DNX_FIELD_RANGE_TYPE_L4_DST_PORT = 0x1,
    /**
     * Egress Virtual Port (Out Lif) Range Qualifier.
     */
    DNX_FIELD_RANGE_TYPE_OUT_LIF = 0x2,
    /**
     * Packet Header Size Range Qualifier
     */
    DNX_FIELD_RANGE_TYPE_PKT_HDR_SIZE = 0x3,
    /**
     * Always last. Shows how many different ranges we have.
     */
