...
typedef struct imb_pm_resource_config_s
{
    ...
    int *enable_state;
    portmod_speed_config_t port_speed_config[DNX_DATA_MAX_NIF_ETH_CDU_LANES_NOF];
    /** Indicate if the speed is used for pcs bypass port */
    int speed_for_pcs_bypass_port[DNX_DATA_MAX_NIF_ETH_CDU_LANES_NOF];
    portmod_pm_vco_setting_t vco_setting; /** only the output parameters will be valid */
    int port_starting_lane[DNX_DATA_MAX_NIF_ETH_CDU_LANES_NOF];
