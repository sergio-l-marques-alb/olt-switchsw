...
/**
* \brief -  Clear the maximum number of allocated ECGM resources per core. (This function should be called after CPU read)
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_core_global_resources_statistics_max_clear(
    uint32 unit);

/**
* \brief -  Clear the maximum number of allocated ECGM resources per interface. (This function should be called after CPU read)
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_interface_resources_statistics_max_clear(
    uint32 unit);

/**
* \brief -  Clear the maximum number of allocated ECGM resources per Port. (This function should be called after CPU read)
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_port_resources_statistics_max_clear(
    uint32 unit);

/**
* \brief -  Clear the maximum number of allocated ECGM resources per Queue. (This function should be called after CPU read)
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_queue_resources_statistics_max_clear(
    uint32 unit);

/**
* \brief -  Clear the maximum number of allocated ECGM resources per Service Pool. (This function should be called after CPU read)
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_service_pool_resources_statistics_max_clear(
    uint32 unit);

/**
* \brief -  Clear the maximum number of allocated ECGM resources per Service Pool per Traffic Class. (This function should be called after CPU read)
*
* \param [in] unit - chip unit id
*
* \return
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_service_pool_tc_resources_statistics_max_clear(
    uint32 unit);
