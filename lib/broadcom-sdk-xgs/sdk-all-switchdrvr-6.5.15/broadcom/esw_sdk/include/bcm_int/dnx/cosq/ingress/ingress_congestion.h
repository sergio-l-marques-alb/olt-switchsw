...
#include <soc/dnxc/swstate/types/sw_state_template_mngr.h> /** for dnx_algo_template_print_t */
...
shr_error_e dnx_ingress_congestion_vsq_programmable_counter_configuration_set(
 ...
 /**
 * \brief - Function to clear the VSQ programmable counter settings
 *
 ...
 *   * None
 */
shr_error_e dnx_ingress_congestion_vsq_programmable_counter_configuration_clear(
    int unit,
    int core);
 ...
 * \param [in] print_cb_data - additional data
 *
 * \return
 *   shr_error_e
 *
