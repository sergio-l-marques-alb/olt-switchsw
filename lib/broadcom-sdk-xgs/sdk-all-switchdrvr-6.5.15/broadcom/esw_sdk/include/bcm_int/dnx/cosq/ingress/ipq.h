 ...
 *   * None
 */
shr_error_e dnx_cosq_ipq_deinit(
    int unit);
...
*  \see
 *    sw_state_algo_res_simple_bitmap_free
 ...
 *      SW_STATE_ALGO_RES_ALLOCATE_WITH_ID - allocate specific element
