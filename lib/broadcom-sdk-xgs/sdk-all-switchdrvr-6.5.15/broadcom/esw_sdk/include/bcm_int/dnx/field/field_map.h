...
typedef enum
{
    ...
    DNX_FIELD_HEADER_QUAL_VLAN_TAG,
    /*
...
typedef enum
{
    ...
    /*
     * Specific fields in relevant Layer Recird Qualifiers
     */
    ...
    DNX_FIELD_LR_QUAL_IPV6_VALUE_1,
...
/**
 * \brief  Return Name of Action Type, contained by DNX Action
 * \param [in] unit       - Identifier of HW platform.
 * \param [in] dnx_action - Encoded DNX Action
 * \return
 *   \retval dbal field name    - On success
 *   \retval Invalid DNX Action - When DNX Action is not valid
 * \remark
 *  Name is actually Name of enumerator for specific action type, that dnx action refers to
 */
char *dnx_field_dnx_action_type_text(
    int unit,
    dnx_field_action_t dnx_action);
...
/**
 * \brief  Get all available cs fields for given stage
 * \param [in] unit - Identifier of HW platform.
 * \param [in] stage - Stage identifier
...
* \param [out] dnx_hash_action_p  - DNX Hash Action Enum.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_map_hash_action_bcm_to_dnx(
    int unit,
...
/**
* \brief
*  Maps DNX Hash Action to BCM Hash Action ENUMS
* \param [in] unit                - Device Id.
* \param [in] dnx_hash_action  - DNX Hash Action Enum.
...
*   * None
*/
shr_error_e dnx_field_map_hash_action_dnx_to_bcm(
    int unit,
...
* \param [in] unit -
*  Device Id
* \param [in] bcm_range_info -
*  BCM range info
* \param [out] dnx_range_info_p -
*  The mapped DNX range info
* \return
*   shr_error_e - Error Type
* \remark
...
*   * None
*/
shr_error_e dnx_field_map_range_info_bcm_to_dnx(
    int unit,
...
* \param [in] unit -
*  Device Id
* \param [in] dnx_range_info -
*  DNX range info
* \param [out] bcm_range_info_p -
*  The mapped BCM range info
* \return
*   shr_error_e - Error Type
* \remark
...
*   * None
*/
shr_error_e dnx_field_map_range_info_dnx_to_bcm(
    int unit,
...
*  BCM range info.
* \param [in] unit      - Device Id.
* \param [in] bcm_stage - The Field stage.
* \param [in] range_id  - The range_id.
* \param [in] bcm_range_info_p    - The mapped BCM range info.
* \param [out] field_dbal_entry_p - The DBAL info.
* \return
*   shr_error_e - Error Type
* \see
*   * None
*/
shr_error_e dnx_field_map_range_bcm_to_dnx(
    int unit,
    bcm_field_stage_t bcm_stage,
    uint32 range_id,
    bcm_field_range_info_t * bcm_range_info_p,
...
* \param [in] unit     - Device Id
* \param [in] opcode_id - KBP OPCODE ID
* \param [out] cd_profile_id_p - FWD context profile Id
* \return
*   shr_error_e - Error Type
* \remark
* \see
