...
/**
 * \brief - deinit consistent hashing manager
 * 
 * \param [in] unit - unit number
 *   
 * \return
 ...
 *   * None
 */
shr_error_e dnx_algo_consistent_hashing_manager_deinit(
    int unit);
 ...
 *        2 number of resources each. those reasources
 *        represent the HW reasources used. \see
 *        consistent_hashing_manager_nof_resources_per_profile_type_get_cb
 *        for farther explaination.
 ...
 * \param [out] chm_handle - recieved handle for this instance 
 ...
 * \param [in] unique_identifyer - unique identifyer of the 
