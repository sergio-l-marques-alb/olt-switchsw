...
typedef struct
{
    ...
    /**
     * CRC Action which selects weather to keep the input lb-key or to replace it. 
     */
    dnx_field_context_hash_action_e crc_select;
...
* \param [in] unit                - Device ID
* \param [in] flags               - Flags for context creation (WITH_ID)
* \param [in] apptype_info_p      - The structure containing the name of the new apptype and the statix apprtype 
*                                   it cascades from.
