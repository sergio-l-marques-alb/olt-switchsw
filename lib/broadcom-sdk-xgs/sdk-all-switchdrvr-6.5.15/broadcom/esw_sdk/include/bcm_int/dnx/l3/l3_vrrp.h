 ...
 */
#define DNX_L3_VRRP_PROTOCOL_GROUP_MEMBERS_ALL_VALID(target)             \
        *target = 0;                                                     \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION);   \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_IPV4);             \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_IPV6);             \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_ARP);              \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_MPLS);             \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET);         \
        SHR_BITSET(target, DBAL_ENUM_FVAL_LAYER_TYPES_FCOE);
