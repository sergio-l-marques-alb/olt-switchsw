...
#define STAT_PP_METER_COMMAND_ID_INVALID    0
...
/* Macros for overcoming HW bug HWJERICHO2-2541 - Statistics Entries in ETPP Blocks built differently*/
#define STAT_PP_ETPP_SWITCH_PROFILE_MAX_PROFILE 3
