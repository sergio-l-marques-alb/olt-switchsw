...
#define DNX_QOS_EXPLICIT_IDX_L2_NWK_QOS(pcp, cfi) \
...
#define DNX_QOS_EXPLICIT_IDX_L2(pcp, cfi) \
     ((DNX_QOS_EXPLICIT_IDX_FLAG << DNX_QOS_EXPLICIT_IDX_OFFSET) | \
      DNX_QOS_EXPLICIT_IDX_L2_NWK_QOS(pcp,cfi))
 ...
 * \param [in] unit - Relevant unit.
 * \param [in] qos_model_type - egress qos model type
 * \param [out] qos_model - egress qos model
 * \return
 *     \retval Negative in case of an error. 
 *     \retval Zero in case of NO ERROR
 */
shr_error_e dnx_qos_egress_model_type_to_model(
    int unit,
 ...
 * \param [in] unit - Relevant unit.
 * \param [in] qos_model - egress qos model
 * \param [out] qos_model_type - egress qos model type
 * \return
 *     \retval Negative in case of an error. 
 *     \retval Zero in case of NO ERROR
 */
shr_error_e dnx_qos_egress_model_to_model_type(
    int unit,
    dbal_enum_value_field_encap_qos_model_e qos_model,
    bcm_qos_egress_model_type_t * qos_model_type);
