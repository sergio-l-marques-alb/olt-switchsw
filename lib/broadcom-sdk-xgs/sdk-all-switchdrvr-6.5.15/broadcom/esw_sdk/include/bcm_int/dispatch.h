...
typedef struct {
	...
	int (*cpri_port_tx_cw_vsd_ctrl_flow_config_get)(int,int,uint16,bcm_cpri_tx_vsd_flow_info_t *);
	...
	int (*field_tcam_bank_evacuate)(int,uint32,bcm_field_group_t,bcm_field_tcam_bank_evacuate_info_t *);
	...
	int (*instru_vis_mode_get)(int,bcm_vis_mode_t *);
	int (*instru_vis_mode_set)(int,bcm_vis_mode_t);
#ifdef	INCLUDE_INT
	int (*int_detach)(int);
	int (*int_init)(int);
...
#endif	/* INCLUDE_PTP */
	int (*qos_control_get)(int,bcm_qos_control_type_t,int *);
	int (*qos_control_set)(int,bcm_qos_control_type_t,int);
	int (*qos_detach)(int);
	...
	int (*tunnel_terminator_config_traverse)(int,bcm_tunnel_terminator_config_traverse_cb,void *);
	...
	int (*xflow_macsec_control_get)(int,uint32,bcm_xflow_macsec_control_t,uint64 *);
	int (*xflow_macsec_control_set)(int,uint32,bcm_xflow_macsec_control_t,uint64);
	...
	int (*xflow_macsec_mtu_get)(int,int,bcm_xflow_macsec_mtu_t,uint32 *);
	int (*xflow_macsec_mtu_set)(int,int,uint32,bcm_xflow_macsec_mtu_t *);
	int (*xflow_macsec_sectag_etype_get)(int,bcm_xflow_macsec_sectag_ethertype_t,uint32 *);
	int (*xflow_macsec_sectag_etype_set)(int,int,uint32,bcm_xflow_macsec_sectag_ethertype_t *);
	...
	int (*xflow_macsec_secure_chan_info_traverse)(int,uint32,bcm_xflow_macsec_chan_traverse_cb,void *);
	...
	int (*xflow_macsec_station_mac_addr_get)(int,bcm_mac_t);
	int (*xflow_macsec_station_mac_addr_set)(int,bcm_mac_t);
