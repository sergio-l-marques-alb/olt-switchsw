...
typedef struct portmod_pm8x50_fabric_create_info_internal_s{
    ...
    int first_phy_offset;
    int core_index;
    uint32 force_single_pll; /**< only one PLL can be used in this core */
    uint32 bypass_lanes_bitmap[PORTMOD_NOF_WORDS_PER_PM8X50_FABRIC_LANES_BITMAP];
...
typedef struct portmod_os_ilkn_create_info_internal_s{
    ...
    uint32 core_clock_khz;
    portmod_ilkn_core_lane_map_callback_get_f ilkn_core_lane_map_get;
