...
/* Get the CPRI Port interrupt status. */
#ifdef CPRIMOD_SUPPORT
int cpm4x25_cpri_port_interrupt_process(int unit, int port, pm_info_t pm_info);
#endif /* CPRIMOD_SUPPORT */

/* set/get fast clk bit period */
#ifdef CPRIMOD_SUPPORT
int cpm4x25_fast_clk_bit_time_period_set(int unit, int port, pm_info_t pm_info, cprimod_port_speed_t speed);
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
...
#ifdef CPRIMOD_SUPPORT
int cpm4x25_cpri_port_ecc_interrupt_status_get(int unit, int port, pm_info_t pm_info, const portmod_cpri_ecc_intr_info_t* ecc_err_info);
#endif /* CPRIMOD_SUPPORT */
