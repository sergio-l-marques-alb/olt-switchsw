...
/*! 
 * portmod_cpri_port_tx_frame_tgen_next_hfn_set
 *
 * @brief TGEN configuration. 
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  hfn             - HFN number.
 */
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_tx_frame_tgen_next_hfn_set(int unit, int port, uint32 hfn);
#endif /* CPRIMOD_SUPPORT */
/*! 
 * portmod_cpri_port_tx_frame_tgen_next_hfn_get
 *
 * @brief TGEN configuration. 
 *
 * @param [in]  unit            - unit id
 ...
 */
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_tx_frame_tgen_next_hfn_get(int unit, int port, uint32* hfn);
#endif /* CPRIMOD_SUPPORT */

/*! 
 * portmod_cpri_port_tx_frame_tgen_next_bfn_set
 *
 * @brief TGEN configuration. 
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  bfn             - BFN number.
 */
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_tx_frame_tgen_next_bfn_set(int unit, int port, uint32 bfn);
#endif /* CPRIMOD_SUPPORT */
/*! 
 * portmod_cpri_port_tx_frame_tgen_next_bfn_get
 *
 * @brief TGEN configuration. 
 *
 * @param [in]  unit            - unit id
 ...
 */
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_tx_frame_tgen_next_bfn_get(int unit, int port, uint32* bfn);
#endif /* CPRIMOD_SUPPORT */
...
/*! 
 * @brief Flags for PM version. 
 */ 
#define PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM 0x1 /**< PM8X50, revision 0, 16nm */

#define PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM_SET(flags) ((flags) |= PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM)

#define PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM_CLR(flags) ((flags) &= ~PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM)

#define PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM_GET(flags) ((flags) & PORTMOD_PM_VERSION_F_PM8X50_REV0_16NM ? 1 : 0)
 ...
 */
#ifdef CPRIMOD_SUPPORT
int portmod_fast_clk_bit_time_period_set(int unit, int port, cprimod_port_speed_t speed);
#endif /* CPRIMOD_SUPPORT */
/*! 
