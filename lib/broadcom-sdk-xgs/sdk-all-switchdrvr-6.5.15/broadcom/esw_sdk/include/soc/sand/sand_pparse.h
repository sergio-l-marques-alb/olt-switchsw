 ...
 */
#define PPARSE_MAX_DATA_WORDS           DSIG_MAX_SIZE_UINT32
/**
...
/**
 * \brief
 *   Checks the existence of PTCH on the incoming pocket, according to the supplied signal.
 *   DNX ONLY!
 * \param [in] unit
 *   Unit ID
 * \param [in] core
 *   Core ID
 * \param [in] args
 *   list of arguments to the plugin. Expected to contain Block=IRPP from=Stage name
 *   Attribute=PTC attribue name
 * \param [in] pit
