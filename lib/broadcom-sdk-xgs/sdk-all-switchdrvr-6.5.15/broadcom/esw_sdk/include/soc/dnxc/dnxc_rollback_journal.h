...
/**
 * \brief - limit the maximum size of the rollback journal to 50 
 *        MB at init
 */
#if 1
...
/**
 * \brief
 *  Increase or decrease the temporary disablement counter for rollback journal
 r \param [in] unit   - Device Id
