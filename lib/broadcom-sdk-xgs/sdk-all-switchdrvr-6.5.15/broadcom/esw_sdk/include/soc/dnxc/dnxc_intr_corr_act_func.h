 ...
 * FUNCTIONS *
 *************/   
int dnxc_mem_decide_corrective_action(int unit,sand_memory_dc_t type,soc_mem_t mem,int copyno, dnxc_int_corr_act_type *action_type, char* special_msg);
char* dnxc_mem_ser_ecc_action_info_get(int unit, soc_mem_t mem, int isEcc1b);

int
dnxc_xor_mem_info_get(int unit, soc_mem_t mem, dnxc_xor_mem_info *xor_mem_info);
