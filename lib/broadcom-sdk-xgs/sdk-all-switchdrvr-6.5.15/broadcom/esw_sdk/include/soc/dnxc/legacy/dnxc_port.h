...
shr_error_e soc_dnxc_fabric_single_pm_add(int unit, int core, int cores_num, int phy_offset, uint32 bypass_lanes_bitmap, int use_mutex, dnxc_core_address_get_f address_get_func);
shr_error_e soc_dnxc_fabric_pms_add(int unit, int cores_num , int phy_offset,  uint32 bypass_lanes_bitmap, int use_mutex, dnxc_core_address_get_f address_get_func);
...
int soc_dnxc_fabric_broadcast_firmware_loader(int unit, soc_pbmp_t *pbmp);
...
shr_error_e  soc_dnxc_port_disable_and_save_enable_state(int unit, soc_port_t port, int *orig_enabled);
shr_error_e  soc_dnxc_port_restore_enable_state(int unit, soc_port_t port, int orig_enabled);
 ...
 *   * None
 */
shr_error_e dnx_to_phymod_ref_clk(int unit,int ref_clk,phymod_ref_clk_t * phymod_ref_clk);
/* port controls */
...
shr_error_e soc_dnxc_port_prbs_rx_invert_data_set(int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int invert);
shr_error_e soc_dnxc_port_prbs_tx_invert_data_get(int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int *invert);
shr_error_e soc_dnxc_port_prbs_rx_invert_data_get(int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int *invert);
 ...
 *   * None.
 */
shr_error_e soc_dnxc_port_rate_egress_ppt_set(int unit, soc_port_t link, uint32 burst, uint32 nof_tiks);
 ...
 *   * None.
 */
shr_error_e soc_dnxc_port_rate_egress_ppt_get(int unit, soc_port_t link, uint32 *burst, uint32 *nof_tiks);
