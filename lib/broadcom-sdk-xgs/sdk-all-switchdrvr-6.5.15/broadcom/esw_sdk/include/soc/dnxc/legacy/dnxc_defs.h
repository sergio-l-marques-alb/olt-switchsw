...
#define SOC_DNXC_MAX_NOF_PVT_MONITORS 1
#ifdef BCM_DNXF_SUPPORT
#if SOC_DNXC_MAX_NOF_PVT_MONITORS < DNXF_DATA_MAX_DEVICE_GENERAL_NOF_PVT_MONITORS
#undef SOC_DNXC_MAX_NOF_PVT_MONITORS
