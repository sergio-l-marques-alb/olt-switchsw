...
#define _MV2_TDM_SPEED_CLASS_MAX                5
...
#define SOC_MV2_STAT_ING_FLEX_POOL_MAX   20

/* Num of evict memories is 26, 1 is added for reserved mem */
#define SOC_MV2_NUM_EVICT_MEM            27

#define SOC_MV2_ALPM_MAX_BKTS(u)    (SOC_IS_MAVERICK2(u) ? 8192 : 16384)
#define SOC_MV2_ALPM_BKT_MASK(u)    (SOC_IS_MAVERICK2(u) ? 0x1FFF : 0x3FFF)
#define SOC_MV2_ALPM_BKT_OFFFSET                      2048
#define SOC_MV2_ALPM_MODE0_BKT_MASK                   0x38003
#define SOC_MV2_ALPM_MODE1_BKT_MASK                   SOC_MV2_ALPM_MODE0_BKT_MASK >> 1

extern void soc_mv2_subport_init(int unit);
