 ...
 *   PROC
 * FUNCTION:
 *   Add an PPPoE anti-spoofing information entry. Given a key, e.g. (PPPoE sesion ID, LIF_ID)
 * INPUT:
 *   SOC_SAND_IN  int                               unit -
 *     Identifier of the device to access.
 ...
 *   PROC
 * FUNCTION:
 *   Remove an PPPoE anti-spoofing information entry according to the
 *   given Key. Given a key, e.g. (PPPoE sesion ID, LIF_ID)
 * INPUT:
 *   SOC_SAND_IN  int                               unit -
 *     Identifier of the device to access.
 *   SOC_SAND_INOUT  SOC_PPC_IPV6_COMPRESSED_ENTRY    *pppoe_entry -
 *     Describe which entry is removed.
 *   SOC_SAND_OUT SOC_SAND_SUCCESS_FAILURE         *success -
 *     If TRUE, remove the entry from table. Otherwise,
 *     there is a resouce error, e.g. the entry isn't existed.
 ...
 *   PROC
 * FUNCTION:
 *   Get an PPPoE anti-spoofing information entry according to its key. Given a key, e.g. (PPPoE sesion ID, LIF_ID)
 * INPUT:
 *   SOC_SAND_IN  int                               unit -
 *     Identifier of the device to access.
 *   SOC_SAND_INOUT  SOC_PPC_SRC_BIND_PPPOE_ENTRY    *pppoe_entry -
