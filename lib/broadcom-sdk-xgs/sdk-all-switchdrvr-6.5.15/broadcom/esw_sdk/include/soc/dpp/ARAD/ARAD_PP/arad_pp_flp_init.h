...
#define ARAD_PP_FLP_IPV4_MC_SSM_KEY_OR_MASK         0x1a /* prefix value will be cover 12-15 */
...
#define ARAD_PP_FLP_IP6_64_IN_LEM_KEY_OR_MASK       0x25 /* prefix value will be cover 16 -23 */
...
#define PROG_FLP_IPV4MC_BRIDGE_USER_MODE            0X28 /* the IVL flavor of PROG_FLP_IPV4MC_BRIDGE */
#define PROG_FLP_IPV4MC_BRIDGE_USER_MODE_UNTAGGED   0X29 /* the IVL flavor of PROG_FLP_IPV4MC_BRIDGE */
...
#define PROG_FLP_LAST                               (PROG_FLP_MPLS_EXP_NULL_TTL_REJECT)
...
/* macro for supported programs in IPv6 DIP SIP sharing feature, UC programs only*/
...
/*
 * FLP program namespace structure
 */
typedef struct 
{
    SOC_SAND_MAGIC_NUM_VAR
    /*
     * number of program in this namespace
     */
    uint16 count;
    /*
     * program ID store in this namespace, 0xff means empty
     */
...
/* Update FLP not found trap code  */
uint32
 ...
 *     name space id: see ARAD_PP_FLP_PROG_NS
 *   SOC_SAND_OUT uint32              *ns_info -
 *
 * REMARKS:
 *   This function will return namspace info according to ns id
 * RETURNS:
 *   OK or ERROR indication.
*********************************************************************/
uint32 
