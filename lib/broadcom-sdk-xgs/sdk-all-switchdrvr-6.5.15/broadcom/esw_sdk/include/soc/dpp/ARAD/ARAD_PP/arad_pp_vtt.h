...
#define  ARAD_PP_ISEM_ACCESS_VLAN_DOMAIN_MPLS_PREFIX (10) /* ISB - VLAN Domain * mpls l1 TT */
...
/* START of TT Programs */
    ...
    ARAD_PP_DBAL_TT_PROG_INDEX_MPLS4_NOP,/*Only 1st label match, terminate nothing*/
...
typedef enum
{
    VTT_3MTSE_FRR_L1_L1,       /* Order is important */
    VTT_3MTSE_FRR_L3_L3,
    VTT_3MTSE_FRR_L3_L1,
    VTT_3MTSE_FRR_L4_L3,
    VTT_3MTSE_FRR_L1,
...
typedef enum
{
    VTT_2MTSE_FRR_L1_L1,       /* Order is important */
    VTT_2MTSE_FRR_L2_L2,
    VTT_2MTSE_FRR_L2_L1,
    VTT_2MTSE_FRR_L3_L2
