...
typedef enum
{
  ...
  /* 
   *  Identify port as port to force bridge forwarding.
   */
...
typedef enum
{
  ...
  /* 
   *  UDP destination ports 3784/6784 are that identified as BFD packet ,getting dropped.
   */
  ...
  /* 
   *  Identify port as IBC(Inter-board communication) port.
   */
...
typedef enum
{
  ...
  /*
   *   16 groups of 128 for QUX
   */
  SOC_TMC_PORT_LAG_MODE_16_128 = 3,
  /*
   *   8 groups of 256 for QUX
   */
