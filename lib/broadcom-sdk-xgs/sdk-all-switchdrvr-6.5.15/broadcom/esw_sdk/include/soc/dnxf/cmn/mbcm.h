...
typedef shr_error_e (*mbcm_dnxf_fabric_cell_valid_data_in_msb_get_f) (int unit, soc_dnxc_fabric_cell_entry_t entry, int *valid_data_in_msb);
typedef shr_error_e (*mbcm_dnxf_fabric_cell_parse_table_get_f) (int unit, soc_dnxc_fabric_cell_type_t cell_type, int valid_data_in_msb, uint32 max_nof_lines, soc_dnxc_fabric_cell_parse_table_t *parse_table, uint32 *nof_lines);
...
typedef struct mbcm_dnxf_functions_s {
    ...
    mbcm_dnxf_fabric_cell_valid_data_in_msb_get_f                        mbcm_dnxf_fabric_cell_valid_data_in_msb_get;
