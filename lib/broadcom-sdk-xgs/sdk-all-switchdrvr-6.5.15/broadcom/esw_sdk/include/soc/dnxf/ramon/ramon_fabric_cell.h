...
shr_error_e soc_ramon_fabric_cell_parse_table_get(int unit, soc_dnxc_fabric_cell_type_t cell_type, int valid_data_in_msb, uint32 max_nof_lines, soc_dnxc_fabric_cell_parse_table_t *parse_table, uint32 *nof_lines);
shr_error_e soc_ramon_fabric_cell_type_get(int unit, soc_dnxc_fabric_cell_entry_t entry, soc_dnxc_fabric_cell_type_t *cell_type);
shr_error_e soc_ramon_fabric_cell_valid_data_in_msb_get(int unit, soc_dnxc_fabric_cell_entry_t entry, int *valid_data_in_msb);
...
/*******************************
* RAMON CAPTURED SR CELL FORMAT  * 
********************************/

#define SOC_RAMON_FABRIC_CELL_CAPTURED_SRC_FORMAT_NOF_LINES    (12)

#define SOC_RAMON_FABRIC_CELL_CAPTURED_SRC_FORMAT_VALID_DATA_IN_MSB {\
  /*{dest_id,                                       dest_ptr,     dest_start_bit,   src_start_bit, length,  name)*/\
    {soc_dnxc_fabric_cell_dest_id_src_cell_type,    NULL,         0,                2155,           1,      "CELL_TYPE"},\
    {soc_dnxc_fabric_cell_dest_id_src_pipe_id,      NULL,         0,                2141,           3,      "PIPE_ID"},\
    {soc_dnxc_fabric_cell_dest_id_src_src_device,   NULL,         0,                2130,           11,     "SOURCE_DEVICE"},\
    {soc_dnxc_fabric_cell_dest_id_src_src_level,    NULL,         0,                2127,           3,      "SOURCE_LEVEL"},\
    {soc_dnxc_fabric_cell_dest_id_src_dest_level,   NULL,         0,                2124,           3,      "DEST_LEVEL"},\
    {soc_dnxc_fabric_cell_dest_id_src_fip,          NULL,         0,                2118,           6,      "FIP"},\
    {soc_dnxc_fabric_cell_dest_id_src_fe1,          NULL,         0,                2110,           8,      "FE1"},\
    {soc_dnxc_fabric_cell_dest_id_src_fe2,          NULL,         0,                2102,           8,      "FE2"},\
    {soc_dnxc_fabric_cell_dest_id_src_fe3,          NULL,         0,                2094,           8,      "FE3"},\
    {soc_dnxc_fabric_cell_dest_id_src_is_inband,    NULL,         0,                2093,           1,      "IS_INBAND"},\
    {soc_dnxc_fabric_cell_dest_id_src_ack,          NULL,         0,                2092,           1,      "ACK"},\
    {soc_dnxc_fabric_cell_dest_id_src_payload,      NULL,         0,                0,              2048,   "PAYLOAD"}\
    }

#define SOC_RAMON_FABRIC_CELL_CAPTURED_SRC_FORMAT_VALID_DATA_NOT_IN_MSB {\
  /*{dest_id,                                       dest_ptr,     dest_start_bit,   src_start_bit, length,  name)*/\
    {soc_dnxc_fabric_cell_dest_id_src_cell_type,    NULL,         0,                2155,           1,      "CELL_TYPE"},\
    {soc_dnxc_fabric_cell_dest_id_src_pipe_id,      NULL,         0,                2141,           3,      "PIPE_ID"},\
    {soc_dnxc_fabric_cell_dest_id_src_src_device,   NULL,         0,                2130,           11,     "SOURCE_DEVICE"},\
    ...
    {soc_dnxc_fabric_cell_dest_id_src_is_inband,    NULL,         0,                2093,           1,      "IS_INBAND"},\
    {soc_dnxc_fabric_cell_dest_id_src_ack,          NULL,         0,                2092,           1,      "ACK"},\
    {soc_dnxc_fabric_cell_dest_id_src_payload,      NULL,         0,                0,              1024,   "PAYLOAD"}\
    }

#define SOC_RAMON_FABRIC_CELL_CPU_CAPTURED_FORMAT_NOF_LINES (5)
#define SOC_RAMON_FABRIC_CELL_CPU_CAPTURED_FORMAT_VALID_DATA_IN_MSB {\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_size,       NULL,          0,                2157,           8,      "CELL_SIZE"},\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_type,       NULL,          0,                2155,           2,      "CELL_TYPE"},\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_pipe_index, NULL,          0,                2166,           2,      "PIPE_INDEX"},\
    {soc_dnxc_fabric_cell_dest_id_cap_src_device,      NULL,          0,                2123,           11,     "SOURCE_DEVICE"},\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_payload,    NULL,          0,                0,              2048,   "PAYLOAD"},\
    }

#define SOC_RAMON_FABRIC_CELL_CPU_CAPTURED_FORMAT_VALID_DATA_NOT_IN_MSB {\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_size,       NULL,          0,                2157,           8,      "CELL_SIZE"},\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_type,       NULL,          0,                2155,           2,      "CELL_TYPE"},\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_pipe_index, NULL,          0,                2166,           2,      "PIPE_INDEX"},\
    {soc_dnxc_fabric_cell_dest_id_cap_src_device,      NULL,          0,                2123,           11,     "SOURCE_DEVICE"},\
    {soc_dnxc_fabric_cell_dest_id_cap_cell_payload,    NULL,          1024,             0,              1024,   "PAYLOAD"},\
    }
