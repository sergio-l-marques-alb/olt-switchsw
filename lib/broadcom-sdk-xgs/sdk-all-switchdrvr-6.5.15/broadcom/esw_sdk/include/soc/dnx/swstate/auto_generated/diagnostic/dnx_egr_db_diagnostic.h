/** \file dnx/swstate/auto_generated/diagnostic/dnx_egr_db_diagnostic.h
 *
...
int dnx_egr_db_ps_allocation_bmap_dump(
    int unit, int allocation_bmap_idx_0, int allocation_bmap_idx_1);

int dnx_egr_db_ps_prio_mode_dump(
    int unit, int prio_mode_idx_0, int prio_mode_idx_1);

int dnx_egr_db_ps_if_idx_dump(
    int unit, int if_idx_idx_0, int if_idx_idx_1);

int dnx_egr_db_interface_occ_dump(
    int unit, int interface_occ_idx_0, int interface_occ_idx_1);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_EGR_DB_DIAGNOSTIC_H__ */
