/** \file dnx/swstate/auto_generated/diagnostic/dnx_dram_diagnostic.h
 *
...
int dnx_dram_db_vendor_info_dump(
    int unit, int vendor_info_idx_0);
...
int dnx_dram_db_vendor_info_serial_number_dump(
    int unit, int vendor_info_idx_0, int serial_number_idx_0);
...
#endif /* __DNX_DRAM_DIAGNOSTIC_H__ */
