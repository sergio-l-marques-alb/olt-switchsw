...
#ifndef __SOC_DNX_API_STAT_IF_INCLUDED__
/* { */
#define __SOC_DNX_API_STAT_IF_INCLUDED__
...
#define SOC_DNX_STAT_NOF_THRESHOLD_RANGES 15
#define SOC_DNX_STAT_IF_COUNTERS_COMMANDS 2
#define SOC_DNX_STAT_IF_REPORT_SIZE_61b  (SOC_IS_QAX(unit) ? 1 : 0)
#define SOC_DNX_STAT_IF_REPORT_SIZE_64b  (SOC_IS_QAX(unit) ? 0 : 1)
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_IF_PHASE_000=0,
  /*
   *  Statistics data is 90 degrees to the clock
   */
  SOC_DNX_STAT_IF_PHASE_090=1,
  /*
   *  Statistics data is 180 degrees to the clock
   */
  SOC_DNX_STAT_IF_PHASE_180=2,
  /*
   *  Statistics data is 270 degrees to the clock
   */
  SOC_DNX_STAT_IF_PHASE_270=3,
  /*
   *  Number of types in SOC_DNX_STAT_IF_PHASE
   */
  SOC_DNX_STAT_NOF_IF_PHASES = 4
}SOC_DNX_STAT_IF_PHASE;
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_IF_REPORT_MODE_BILLING = 0,
  /*
   *  DNX_SAND_FAP20V-compatible mode is presented: Ingress enqueue and
   *  Ingress dequeue reports
   */
  SOC_DNX_STAT_IF_REPORT_MODE_FAP20V = 1,

    /* Number of modes in Soc_petra */
    SOC_DNX_STAT_NOF_IF_REPORT_MODES_PETRA = 2,

  /* 
   * QSIZE mode
   * Ingress-Enq, Ingress-Deq, Scrubber report
   */
  SOC_DNX_STAT_IF_REPORT_QSIZE = SOC_DNX_STAT_NOF_IF_REPORT_MODES_PETRA,
   ...
   */
  SOC_DNX_STAT_IF_REPORT_MODE_BILLING_QUEUE_NUMBER = 3,

  /* Ingress billing, available in jer2_jer2_jer2_jericho and above*/

  SOC_DNX_STAT_IF_REPORT_MODE_BILLING_INGRESS = 4,
  /*
   *  report mode not configured
   */
  SOC_DNX_STAT_IF_REPORT_MODE_NOT_CONFIGURE = 5,

  /*
   *  Number of statistic report modes.
   */
  SOC_DNX_STAT_NOF_IF_REPORT_MODES = 6
}SOC_DNX_STAT_IF_REPORT_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_SIF_CORE_MODE_DEDICATED,
  /*
   * Both cores with the same interface
   */
  SOC_DNX_SIF_CORE_MODE_COMBINED,

  SOC_SIF_CORE_NOF_MODES
}SOC_DNX_SIF_CORE_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_IF_BILLING_MODE_EGR_Q_NUM = 0,
  /*
   *  Copy-Unique-Data (Out-LIF) presentation in the egress
   *  report.
   */
  SOC_DNX_STAT_IF_BILLING_MODE_CUD = 1,
  /*
   *  Not applicable for Soc_petra-A. Egress statistics according
   *  to the VSI (VLAN).
   */
  SOC_DNX_STAT_IF_BILLING_MODE_VSI_VLAN = 2,
  /*
   *  Not applicable for Soc_petra-A. Both In-LIF and Out-LIF
   *  presentations in the egress report.
   */
  SOC_DNX_STAT_IF_BILLING_MODE_BOTH_LIFS = 3,
  /*
   *  Number of types in SOC_DNX_STAT_IF_BILLING_MODE
   */
  SOC_DNX_STAT_NOF_IF_BILLING_MODES = 4
}SOC_DNX_STAT_IF_BILLING_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_IF_FAP20V_MODE_Q_SIZE = 0,
  /*
   *  Packet size report format.
   */
  SOC_DNX_STAT_IF_FAP20V_MODE_PKT_SIZE = 1,
  /*
   *  Number of types in SOC_DNX_STAT_IF_FAP20V_MODE
   */
  SOC_DNX_STAT_NOF_IF_FAP20V_MODES = 2
}SOC_DNX_STAT_IF_FAP20V_MODE;
...
typedef enum
{
   ...
   *  number.
   */
  SOC_DNX_STAT_IF_MC_MODE_Q_NUM = 0,
  /*
   *  The multicast packets are reported with the Multicast
   *  ID.
   */
  SOC_DNX_STAT_IF_MC_MODE_MC_ID = 1,
  /*
   *  Number of types in SOC_DNX_STAT_IF_MC_MODE
   */
  SOC_DNX_STAT_NOF_IF_MC_MODES = 2
}SOC_DNX_STAT_IF_MC_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_IF_CNM_MODE_DIS = 0,
  /*
   *  The CNM packet statistics are reported.
   */
  SOC_DNX_STAT_IF_CNM_MODE_EN = 1,
  /*
   *  Number of types in SOC_DNX_STAT_IF_CNM_MODE
   */
  SOC_DNX_STAT_NOF_IF_CNM_MODES = 2
}SOC_DNX_STAT_IF_CNM_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_IF_PARITY_MODE_DIS = 0,
  /*
   *  The parity bit/bits errors identification is enabled.
   */
  SOC_DNX_STAT_IF_PARITY_MODE_EN = 1,
  /*
   *  Number of types in SOC_DNX_STAT_IF_PARITY_MODE
   */
  SOC_DNX_STAT_NOF_IF_PARITY_MODES = 2
}SOC_DNX_STAT_IF_PARITY_MODE;
...
typedef enum
{
   ...
   *  reports.
   */
  SOC_DNX_STAT_IF_BIST_EN_MODE_DIS = 0,
  /*
   *  The BIST commands write alternatively two pattern words
   *  in continuous.
   */
  SOC_DNX_STAT_IF_BIST_EN_MODE_PATTERN = 1,
  /*
   *  The BIST commands perform a walking one writing.
   */
  SOC_DNX_STAT_IF_BIST_EN_MODE_WALKING_ONE = 2,
  /*
   *  The BIST patterns are generated under a PRBS mode.
   */
  SOC_DNX_STAT_IF_BIST_EN_MODE_PRBS = 3,
  /*
   *  Number of types in SOC_DNX_STAT_IF_BIST_EN_MODE
   */
  SOC_DNX_STAT_NOF_IF_BIST_EN_MODES = 4
}SOC_DNX_STAT_IF_BIST_EN_MODE;
...
typedef enum
{
  ...
  SOC_DNX_STAT_IF_PKT_SIZE_65B = 0,

  /* Possible packet size (not inculded CRC) are 122B (126B with CRC) */
  /* This constant should not be changed, because it is used for hardware initialization */
  SOC_DNX_STAT_IF_PKT_SIZE_126B = 1,

  /* Possible packet size (not inculded CRC) are 244B (248B with CRC) */
  /* This constant should not be changed, because it is used for hardware initialization */
  SOC_DNX_STAT_IF_PKT_SIZE_248B = 2,

  /* Possible packet size (not inculded CRC) are 488B (492B with CRC) */
  /* This constant should not be changed, because it is used for hardware initialization */
  SOC_DNX_STAT_IF_PKT_SIZE_492B = 3,

    /* This constant should not be changed, because it is used for hardware initialization */
    SOC_DNX_STAT_IF_PKT_SIZE_1024B = 4,

  /* Number of types in SOC_DNX_STAT_IF_PKT_SIZE */
  SOC_DNX_NOF_STAT_IF_PKT_SIZES = 5

}SOC_DNX_STAT_IF_PKT_SIZE;

typedef enum
{
  /* Possible number of statistic reports per packet */
  SOC_DNX_STAT_IF_NOF_REPORTS_8 = 0,

  SOC_DNX_STAT_IF_NOF_REPORTS_16 = 1,

  SOC_DNX_STAT_IF_NOF_REPORTS_32 = 2,

  SOC_DNX_STAT_IF_NOF_REPORTS_64 = 3,

  SOC_DNX_STAT_IF_NOF_REPORTS_128 = 4

}SOC_DNX_STAT_IF_NOF_STAT_REPORTS_PER_PKT;
...
}SOC_DNX_STAT_IF_ETPP_COUNTERS_MODE;
...
typedef struct
{
   ...
   */
  SOC_DNX_STAT_IF_PHASE if_phase;
}SOC_DNX_STAT_IF_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_STAT_IF_BILLING_MODE mode;

} SOC_DNX_STAT_IF_BILLING_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_STAT_IF_FAP20V_MODE mode;
  /*
   ...
   */
  SOC_DNX_STAT_IF_MC_MODE fabric_mc;
  /*
   ...
   *  'PKT_SIZE'.
   */
  SOC_DNX_STAT_IF_MC_MODE ing_mc;
  /*
   ...
   *  is 'PKT_SIZE'.
   */
  SOC_DNX_STAT_IF_CNM_MODE cnm_report;

} SOC_DNX_STAT_IF_FAP20V_INFO;
...
typedef union
{
   ...
   */
  SOC_DNX_STAT_IF_BILLING_INFO billing;
  /*
   *  Fap20v mode configuration
   */
  SOC_DNX_STAT_IF_FAP20V_INFO fap20v;

} SOC_DNX_STAT_IF_REPORT_MODE_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_STAT_IF_REPORT_MODE mode;
   ...
   */
  SOC_DNX_STAT_IF_REPORT_MODE_INFO format;
  /*
  ...
  */ 
  ...
  SOC_DNX_STAT_IF_PKT_SIZE   if_pkt_size ;
  ...
  /* Scrubber bottom queue */  
   ...
   uint32              if_scrubber_buffer_descr_th[SOC_DNX_STAT_NOF_THRESHOLD_RANGES];

   /* Set the Buffer descriptor buffers (BDBs) threshold.
    * Set to -1 to ignore the threshold. Default: -1.
    * Range: 0 - 0x3FFFFF and -1.
    */ 
   uint32              if_scrubber_bdb_th[SOC_DNX_STAT_NOF_THRESHOLD_RANGES];

   /* Set the unicast DRAM buffers threshold.
    * Set to -1 to ignore the threshold. Default: -1.
    * Range: 0 - 0x3FFFFF and -1.
    * not relevant for JER2_QAX */ 
   uint32              if_scrubber_uc_dram_buffer_th[SOC_DNX_STAT_NOF_THRESHOLD_RANGES];
   /* SRAM buffers threshold, relevant for JER2_QAX */
   uint32              if_scrubber_sram_buffers_th[SOC_DNX_STAT_NOF_THRESHOLD_RANGES];   
   /* SRAM packets descriptors buffers threshold, relevant for JER2_QAX */   
   uint32              if_scrubber_sram_pdbs_th[SOC_DNX_STAT_NOF_THRESHOLD_RANGES];      
  ...
  /* if set Enable statistics reports on DeQueue - relevent to Ardon only */
   ...
   SOC_DNX_STAT_IF_NOF_STAT_REPORTS_PER_PKT if_nof_reports_per_packet;
   ...
   SOC_DNX_STAT_IF_ETPP_COUNTERS_MODE if_etpp_counter_mode[SOC_DNX_STAT_IF_COUNTERS_COMMANDS];
} SOC_DNX_STAT_IF_REPORT_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_STAT_IF_BIST_EN_MODE en_mode;
  /*
   *  Pattern parameters. Relevant only if 'en_mode' is set to
   *  'PATTERN'.
   */
  SOC_DNX_STAT_IF_BIST_PATTERN pattern;
  /*
...
void
  SOC_DNX_STAT_IF_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_INFO *info
  );

void
  SOC_DNX_STAT_IF_BILLING_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_BILLING_INFO *info
  );

void
  SOC_DNX_STAT_IF_FAP20V_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_FAP20V_INFO *info
  );

void
  SOC_DNX_STAT_IF_REPORT_MODE_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_REPORT_MODE_INFO *info
  );

void
  SOC_DNX_STAT_IF_REPORT_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_REPORT_INFO *info
  );

void
  SOC_DNX_STAT_IF_BIST_PATTERN_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_BIST_PATTERN *info
  );

void
  SOC_DNX_STAT_IF_BIST_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IF_BIST_INFO *info
  );


const char*
  SOC_DNX_STAT_IF_PHASE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_PHASE enum_val
  );

const char*
  SOC_DNX_STAT_IF_REPORT_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_REPORT_MODE enum_val
  );

const char*
  SOC_DNX_STAT_IF_BILLING_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_BILLING_MODE enum_val
  );

const char*
  SOC_DNX_STAT_IF_FAP20V_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_FAP20V_MODE enum_val
  );

const char*
  SOC_DNX_STAT_IF_MC_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_MC_MODE enum_val
  );

const char*
  SOC_DNX_STAT_IF_CNM_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_CNM_MODE enum_val
  );

const char*
  SOC_DNX_STAT_IF_PARITY_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_PARITY_MODE enum_val
  );

const char*
  SOC_DNX_STAT_IF_BIST_EN_MODE_to_string(
    DNX_SAND_IN  SOC_DNX_STAT_IF_BIST_EN_MODE enum_val
  );

void
  SOC_DNX_STAT_IF_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_INFO *info
  );

void
  SOC_DNX_STAT_IF_BILLING_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_BILLING_INFO *info
  );

void
  SOC_DNX_STAT_IF_FAP20V_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_FAP20V_INFO *info
  );

void
  SOC_DNX_STAT_IF_REPORT_MODE_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_REPORT_MODE_INFO *info
  );

void
  SOC_DNX_STAT_IF_REPORT_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_REPORT_INFO *info
  );

void
  SOC_DNX_STAT_IF_BIST_PATTERN_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_BIST_PATTERN *info
  );

void
  SOC_DNX_STAT_IF_BIST_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IF_BIST_INFO *info
  );
...
/* } __SOC_DNX_API_STAT_IF_INCLUDED__*/
#endif
