...
#ifndef __SOC_DNX_API_DIAGNOSTICS_INCLUDED__
/* { */
#define __SOC_DNX_API_DIAGNOSTICS_INCLUDED__
...
#define SOC_DNX_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_PB                (64)
#define SOC_DNX_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_JER2_ARAD              (128)
#define SOC_DNX_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_MAX               DNX_SAND_MAX(SOC_DNX_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_JER2_ARAD, SOC_DNX_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_PB)

/* $Id$
 * Run QDR BIST till stop/get-result API
 * is called (soc_jer2_jer2_jer2_tmcdiag_qdr_BIST_test_result_get)
 */

/*
 * Run QDR BIST till stop/get-result API
 * is called (soc_jer2_jer2_jer2_tmcdiag_dram_BIST_test_result_get)
 */
 ...
 *  DRAM status
 */
#define SOC_DNX_DIAG_NOF_DDR_TRAIN_SEQS               8
#define SOC_DNX_DIAG_NOF_DLLS_PER_DRAM                4

/*
 * Maximum size of received/sent packets in bytes
 */
#define SOC_DNX_DIAG_LBG_PAYLOAD_BYTE_SIZE         (256)
...
#define  SOC_DNX_DIAG_NOF_SONE_PER_SMS_MAX (8192)

/*     Maximal length (in longs) of the diagnostic chain.      */
#define  SOC_DNX_DIAG_CHAIN_LENGTH_MAX_IN_UINT32S (144)
...
typedef enum
{
  SOC_DNX_DIAG_PKT_HDR_U_TYPE      = 0x8,
  SOC_DNX_DIAG_PKT_HDR_F_TYPE      = 0x9,
  SOC_DNX_DIAG_PKT_HDR_M_TYPE      = 0xA,
  SOC_DNX_DIAG_PKT_HDR_IN_RCY_TYPE = 0xC,

  /*
   * Un-known type.
   * This type do not exist in the device.
   */
  SOC_DNX_DIAG_PKT_HDR_UNKOWN_TYPE = 0xFF

} SOC_DNX_DIAG_ING_PKT_HDR_TYPE;
...
typedef enum
{
   ...
   */
  SOC_DNX_DIAG_QDR_BIST_ADDR_MODE_NORMAL=0,
  /*
   ...
   */
  SOC_DNX_DIAG_QDR_BIST_ADDR_MODE_ADDRESS_SHIFT=1,
  /*
   ...
   *  data mode.
   */
  SOC_DNX_DIAG_QDR_BIST_ADDR_MODE_ADDRESS_TEST=2,

  SOC_DNX_DIAG_NOF_QDR_BIST_ADDR_MODES=3
}SOC_DNX_DIAG_QDR_BIST_ADDR_MODE;
...
typedef enum
{
   ...
   *  words.
   */
  SOC_DNX_DIAG_QDR_BIST_DATA_MODE_NORMAL=0,
  /*
   ...
   */
  SOC_DNX_DIAG_QDR_BIST_DATA_MODE_PATTERN_BIT=1,
  /*
   ...
   */
  SOC_DNX_DIAG_QDR_BIST_DATA_MODE_RANDOM=2,
  /*
   ...
   */
  SOC_DNX_DIAG_QDR_BIST_DATA_MODE_DATA_SHIFT=3,

  SOC_DNX_DIAG_NOF_QDR_BIST_DATA_MODES=4
}SOC_DNX_DIAG_QDR_BIST_DATA_MODE;
...
typedef enum
{
   ...
   *  SOC_DNX_DIAG_QDR_BIST_DATA_MODE. Random mode ignores these
   *  values.
   */
  SOC_DNX_DIAG_BIST_DATA_PATTERN_DIFF=0,
  /*
   ...
   *  values.
   */
  SOC_DNX_DIAG_BIST_DATA_PATTERN_ONE=1,
  /*
   ...
   *  values.
   */
  SOC_DNX_DIAG_BIST_DATA_PATTERN_ZERO=2,
  SOC_DNX_DIAG_NOF_BIST_DATA_PATTERNS=3
}SOC_DNX_DIAG_BIST_DATA_PATTERN;
...
typedef enum
{
   ...
   *  words.
   */
  SOC_DNX_DIAG_DRAM_BIST_DATA_MODE_NORMAL=0,
  /*
   ...
   */
  SOC_DNX_DIAG_DRAM_BIST_DATA_MODE_PATTERN_BIT=1,
  /*
   *  The PRBS will be used to generate the pattern towards
   *  the DRAM.
   */
  SOC_DNX_DIAG_DRAM_DATA_MODE_RANDOM=2,
  SOC_DNX_DIAG_NOF_DRAM_BIST_DATA_MODES =3
}SOC_DNX_DIAG_DRAM_BIST_DATA_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_DIAG_SOFT_ERROR_PATTERN_ONE = 0,
  /*
   *  Fill the data to write by 000... (Bits).
   */
  SOC_DNX_DIAG_SOFT_ERROR_PATTERN_ZERO = 1,
  /*
   *  Fill the data to write by 1010101... (Bits).
   */
  SOC_DNX_DIAG_SOFT_ERROR_PATTERN_DIFF1 = 2,
  /*
   *  Fill the data to write by 0101010... (Bits).
   */
  SOC_DNX_DIAG_SOFT_ERROR_PATTERN_DIFF2 = 3,
  /*
   *  Number of types in SOC_DNX_DIAG_SOFT_ERROR_PATTERN
   */
  SOC_DNX_NOF_DIAG_SOFT_ERROR_PATTERNS = 4
}SOC_DNX_DIAG_SOFT_ERROR_PATTERN;
...
typedef enum
{
   ...
   */
  SOC_DNX_DIAG_SOFT_COUNT_TYPE_FAST = 0,
  /*
   *  The error count is done per SMS, and per SONE.
   */
  SOC_DNX_DIAG_SOFT_COUNT_TYPE_COMPLETE = 1,
  /*
   *  Number of types in SOC_DNX_DIAG_SOFT_COUNT_TYPE
   */
  SOC_DNX_NOF_DIAG_SOFT_COUNT_TYPES = 2
}SOC_DNX_DIAG_SOFT_COUNT_TYPE;
...
typedef struct
{
   ...
   */
  SOC_DNX_DIAG_QDR_BIST_DATA_MODE data_mode;
  /*
   *  The mode to jump between the addresses
   */
  SOC_DNX_DIAG_QDR_BIST_ADDR_MODE address_mode;
  /*
   *  How to build the initial data to write to the memory,
   *  the data_mode may use this data_patern differently.
   */
  SOC_DNX_DIAG_BIST_DATA_PATTERN data_pattern;
}SOC_DNX_DIAG_QDR_BIST_TEST_RUN_INFO;
...
}SOC_DNX_DIAG_QDR_BIST_TEST_RES_INFO;
...
typedef struct
{
   ...
   *  The way to build the test data from the data patterns.
   */
  SOC_DNX_DIAG_DRAM_BIST_DATA_MODE data_mode;
  /*
   *  How to build the initial data to write to the memory,
   *  the data_mode may use this data_pattern differently.
   */
  SOC_DNX_DIAG_BIST_DATA_PATTERN data_pattern;
}SOC_DNX_DIAG_DRAM_BIST_TEST_RUN_INFO;
...
typedef struct
{
   ...
   */
  uint32 reply_err_counter;
}SOC_DNX_DIAG_DRAM_BIST_TEST_RES_INFO;
...
}SOC_DNX_DIAG_DRAM_READ_COMPARE_STATUS;
...
typedef struct
{
   ...
   */
  uint32 dst_prt_id;
}SOC_DNX_DIAG_PACKET_WALKTROUGH;
...
typedef struct
{
   ...
   */
  uint8 data[SOC_DNX_DIAG_LBG_PAYLOAD_BYTE_SIZE];
  /*
   *  Number of bytes in packet
   */
  uint32 data_byte_size;

}SOC_DNX_DIAG_LBG_PACKET_PATTERN;
...
typedef struct
{
  ...
  * to the packet size.
  */
  SOC_DNX_DIAG_LBG_PACKET_PATTERN pattern;
 /*
...
typedef struct
{
  ...
  * Soc_petra counters
  */
  SOC_DNX_STAT_ALL_STATISTIC_COUNTERS counters;
 /*
...
typedef struct
{
  ...
  */
  uint32 ports[SOC_DNX_NOF_FAP_PORTS];
 /*
  *  number of ports
  */
  uint32 nof_ports;
}SOC_DNX_DIAG_LBG_PATH_INFO;
...
typedef struct
{
    ...
    */
    SOC_DNX_DIAG_LBG_PATH_INFO     path;
}SOC_DNX_DIAG_LBG_INFO;
...
typedef struct
{
   ...
   *
   */
  uint32 ddr_training_sequence[SOC_DNX_DIAG_NOF_DDR_TRAIN_SEQS];
  /*
   *  Status of the 4 DLLs.
   */
  SOC_DNX_DIAG_DLL_STATUS_INFO dll_status[SOC_DNX_DIAG_NOF_DLLS_PER_DRAM];
}SOC_DNX_DIAG_DRAM_STATUS_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_DIAG_SOFT_ERROR_PATTERN pattern;
  /*
...
typedef struct
{
   ...
   */
  uint32 diag_chain[SOC_DNX_DIAG_CHAIN_LENGTH_MAX_IN_UINT32S];
  /*
   *  Number of errors per memory types per SMS and per SONE
   *  (for SONE index different from 0).
   */
  SOC_DNX_DIAG_SOFT_ERR_RESULT nof_errs;

} SOC_DNX_DIAG_SOFT_SMS_RESULT;
...
void
  SOC_DNX_DIAG_SOFT_ERR_INFO_clear(
    DNX_SAND_OUT SOC_DNX_DIAG_SOFT_ERR_INFO *info
  );
...
/* } __SOC_DNX_API_DIAGNOSTICS_INCLUDED__*/
#endif
