/** \file dnx/swstate/auto_generated/access/dnx_ipq_alloc_mngr_access.h
 *
...
typedef int (*dnx_ipq_alloc_mngr_db_ipq_alloc_mngr_set_cb)(
    int unit, sw_state_algo_res_t ipq_alloc_mngr);
...
typedef int (*dnx_ipq_alloc_mngr_db_tc_voq_flow_map_set_cb)(
    int unit, sw_state_algo_template_t tc_voq_flow_map);
...
typedef int (*dnx_ipq_alloc_mngr_db_tc_voq_flow_map_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_ipq_tc_map_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_ipq_alloc_mngr_db_tc_voq_flow_map_replace_data_cb)(
    int unit, int core_id, int profile,  const dnx_ipq_tc_map_t *new_profile_data);
...
typedef int (*dnx_ipq_alloc_mngr_db_tc_voq_flow_map_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_ipq_tc_map_t *profile_data);
...
typedef int (*dnx_ipq_alloc_mngr_db_tc_voq_flow_map_profile_get_cb)(
    int unit, int core_id, const dnx_ipq_tc_map_t *profile_data, int *profile);
