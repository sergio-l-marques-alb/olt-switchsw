 ...
 * Module - 'device', Submodule - 'general', data - 'max_nof_cores'
 ...
 */
typedef uint32(
    *dnx_data_device_general_max_nof_cores_get_f) (
    int unit);
...
/**
 * \brief returns numeric data of nof_cores
 ...
 */
typedef uint32(
    *dnx_data_device_general_emulation_system_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of max_nof_cores
     */
    dnx_data_device_general_max_nof_cores_get_f max_nof_cores_get;
    /**
    ...
    /**
     * returns numeric data of nof_cores
     */
     ...
     */
    dnx_data_device_general_emulation_system_get_f emulation_system_get;
    /**
