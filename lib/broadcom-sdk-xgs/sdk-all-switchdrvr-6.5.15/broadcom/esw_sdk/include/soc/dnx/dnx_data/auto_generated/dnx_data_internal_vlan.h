...
typedef enum
{
    ...
    dnx_data_vlan_vlan_translate_define_nof_vlan_edit_action_ids,
...
/**
 * \brief returns define data of nof_vlan_edit_action_ids
 * Module - 'vlan', Submodule - 'vlan_translate', data - 'nof_vlan_edit_action_ids'
 * Number of supported VLAN edit action_ids
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_vlan_edit_action_ids - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_vlan_vlan_translate_nof_vlan_edit_action_ids_get(
    int unit);
