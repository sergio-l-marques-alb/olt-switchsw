...
typedef int (*mbcm_dnx_egr_q_prio_set_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_EGR_Q_PRIO_MAPPING_TYPE    map_type_ndx, 
    DNX_SAND_IN  uint32                             tc_ndx, 
    DNX_SAND_IN  uint32                             dp_ndx, 
    DNX_SAND_IN  uint32                             map_profile_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_Q_PRIORITY             *priority 
  ); 
typedef int (*mbcm_dnx_egr_q_prio_get_f) ( 
    ...
    DNX_SAND_IN  uint32                             dp_ndx, 
    DNX_SAND_IN  uint32                             map_profile_ndx, 
    DNX_SAND_OUT SOC_DNX_EGR_Q_PRIORITY             *priority 
  ); 
...
typedef uint32 (*mbcm_dnx_egr_dsp_pp_to_base_q_pair_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  int                      core,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID         ofp_ndx,
...
typedef uint32 (*mbcm_dnx_egr_dsp_pp_priorities_mode_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID               ofp_ndx,
    DNX_SAND_OUT SOC_DNX_EGR_PORT_PRIORITY_MODE    *priority_mode
  );
...
typedef uint32 (*mbcm_dnx_egr_dsp_pp_shaper_mode_set_f) (
    ...
    DNX_SAND_IN  uint32                      tm_port,
    DNX_SAND_OUT SOC_DNX_EGR_PORT_PRIORITY_MODE shaper_mode
  );
typedef int (*mbcm_dnx_egr_queuing_dev_set_f) (
    DNX_SAND_IN    int    unit,
    DNX_SAND_IN    int    core,
    DNX_SAND_IN SOC_DNX_EGR_QUEUING_DEV_TH    *info
  );
...
typedef uint32 (*mbcm_dnx_egr_queuing_sch_unsch_drop_set_f) (
    ...
    DNX_SAND_IN    SOC_DNX_EGR_QUEUING_DEV_TH *dev_thresh
  );
typedef uint32 (*mbcm_dnx_egr_queuing_sch_unsch_drop_get_f) (
    DNX_SAND_IN    int    unit,
    DNX_SAND_IN    int    core,
    DNX_SAND_IN    int    threshold_type,
    DNX_SAND_OUT   SOC_DNX_EGR_QUEUING_DEV_TH *dev_thresh
  );  
...
typedef int (*mbcm_dnx_egr_queuing_mc_cos_map_set_f)(
    ...
    DNX_SAND_IN    uint32    tc_ndx,
    DNX_SAND_IN    uint32    dp_ndx,
    DNX_SAND_IN dnx_egr_queuing_mc_cos_map_t    *info
  );
typedef int (*mbcm_dnx_egr_queuing_mc_cos_map_get_f)(
    DNX_SAND_IN     int    unit,
    DNX_SAND_IN     int    core,
    DNX_SAND_IN     uint32    tc_ndx,
    DNX_SAND_IN     uint32    dp_ndx,
    DNX_SAND_OUT dnx_egr_queuing_mc_cos_map_t    *info
  );
typedef int (*mbcm_dnx_egr_queuing_if_fc_set_f)(
    DNX_SAND_IN     int    unit,
    DNX_SAND_IN     SOC_DNX_INTERFACE_ID    if_ndx,
    DNX_SAND_IN  SOC_DNX_EGR_QUEUING_IF_FC    *info
  );
...
typedef int (*mbcm_dnx_egr_queuing_if_fc_uc_max_set_f)(
    ...
    DNX_SAND_IN SOC_DNX_EGR_QUEUING_IF_UC_FC    *info
  );
...
typedef int (*mbcm_dnx_egr_queuing_ofp_tcg_set_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  int                      core,
    DNX_SAND_IN  uint32                   tm_port,    
    DNX_SAND_IN  SOC_DNX_EGR_QUEUING_TCG_INFO      *tcg_info
  );

typedef int (*mbcm_dnx_egr_queuing_ofp_tcg_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  int                      core,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID               tm_port,    
    DNX_SAND_OUT SOC_DNX_EGR_QUEUING_TCG_INFO      *tcg_info
  );

typedef int (*mbcm_dnx_egr_queuing_tcg_weight_set_f) (
    DNX_SAND_IN  int                          unit,
    DNX_SAND_IN  int                          core,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID          tm_port,
    DNX_SAND_IN  SOC_DNX_TCG_NDX              tcg_ndx,
    DNX_SAND_IN  SOC_DNX_EGR_TCG_SCH_WFQ      *tcg_weight
  );

typedef int (*mbcm_dnx_egr_queuing_tcg_weight_get_f) (
    DNX_SAND_IN  int                          unit,
    DNX_SAND_IN  int                          core,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID          tm_port,
    DNX_SAND_IN  SOC_DNX_TCG_NDX              tcg_ndx,
    DNX_SAND_OUT SOC_DNX_EGR_TCG_SCH_WFQ      *tcg_weight
  );

typedef int (*mbcm_dnx_egr_queuing_is_high_priority_queue_get_f) (
    DNX_SAND_IN  int     unit,
    DNX_SAND_IN  int     core,
    DNX_SAND_IN  uint32  tm_port,
...
typedef int (*mbcm_dnx_egr_queuing_init_thresholds_f) (
    ...
    DNX_SAND_OUT SOC_DNX_EGR_QUEUING_CGM_INIT_THRESHOLDS* cgm_init_thresholds
    );
...
typedef int (*mbcm_dnx_egr_congestion_statistics_get_f)(
    DNX_SAND_IN int unit,
    DNX_SAND_IN int core,
    DNX_SAND_INOUT int *cur_stats,   /* place current statistics output here */
    DNX_SAND_INOUT int *max_stats,   /* place maximum statistics output here */
    DNX_SAND_INOUT int *counters, /* place counters output here */
    DNX_SAND_IN  int disable_updates /* should the function disable maximum statistics updates when it collects them */
    );

typedef int (*mbcm_dnx_ofp_rates_max_credit_empty_port_set_f) (
    DNX_SAND_IN  int                 unit,
    DNX_SAND_IN  int                    arg
  );
typedef int (*mbcm_dnx_ofp_rates_max_credit_empty_port_get_f) (
    DNX_SAND_IN  int                 unit,
...
typedef uint32 (*mbcm_dnx_fabric_line_coding_set_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_FABRIC_LINE_CODING                  coding 
  ); 
typedef uint32 (*mbcm_dnx_fabric_line_coding_get_f) ( 
    DNX_SAND_IN  int                              unit, 
    DNX_SAND_IN  uint32                              link_ndx, 
    DNX_SAND_OUT SOC_DNX_FABRIC_LINE_CODING                  *coding 
  );
typedef shr_error_e (*mbcm_dnx_fmac_block_enable_get_f) (
    int unit,
    int fmac_block,
    int *enable);

typedef shr_error_e (*mbcm_dnx_fabric_link_force_signal_set_f) (
    int unit,
    int link,
    int force_signal);

typedef shr_error_e (*mbcm_dnx_fabric_link_mac_init_f) (
    int unit,
    soc_port_t logical_port);

typedef shr_error_e (*mbcm_dnx_fabric_mac_init_f) (
    int unit,
    int fmac_index);

typedef shr_error_e (*mbcm_dnx_fabric_aluwp_init_f) (
    int unit
  );
typedef shr_error_e (*mbcm_dnx_fabric_transmit_init_f) (
    int unit
  );
typedef shr_error_e (*mbcm_dnx_fabric_multicast_init_f) (
    int unit
  );
typedef shr_error_e (*mbcm_dnx_fabric_scheduler_adaptation_init_f) (
    int unit
  );
typedef shr_error_e (*mbcm_dnx_fabric_interleaving_init_f) (
    int unit
  );
typedef shr_error_e (*mbcm_dnx_fabric_dtqs_contexts_init_f) (
    int unit);
...
typedef shr_error_e (*mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_init_f) (
    int unit);

typedef shr_error_e (*mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_enable_set_f) (
    int unit,
    int enable);

typedef shr_error_e (*mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_enable_get_f) (
    int unit,
    int *enable);

typedef shr_error_e (*mbcm_dnx_fabric_cosq_control_backward_flow_control_set_f) (
    DNX_SAND_IN int                                   unit,
...
typedef shr_error_e (*mbcm_dnx_fabric_cosq_control_backward_flow_control_get_f) (
    DNX_SAND_IN int                                   unit,
    DNX_SAND_IN soc_gport_t                           port,
...
typedef shr_error_e (*mbcm_dnx_fabric_egress_core_cosq_gport_sched_set_f) (
    DNX_SAND_IN  int                                unit,
...
typedef shr_error_e (*mbcm_dnx_fabric_egress_core_cosq_gport_sched_get_f) (
    DNX_SAND_IN  int                                unit,
    DNX_SAND_IN  int                                pipe,
...
typedef shr_error_e (*mbcm_dnx_fabric_cosq_gport_rci_threshold_set_f) (
    DNX_SAND_IN  int                    unit,
...
typedef shr_error_e (*mbcm_dnx_fabric_cosq_gport_rci_threshold_get_f) (
    DNX_SAND_IN  int                    unit,
...
typedef shr_error_e (*mbcm_dnx_fabric_cosq_gport_priority_drop_threshold_set_f) (
    DNX_SAND_IN  int                                    unit,
    DNX_SAND_IN  soc_gport_t                            gport,
...
typedef shr_error_e (*mbcm_dnx_fabric_cosq_gport_priority_drop_threshold_get_f) (
    DNX_SAND_IN  int                                    unit,
    DNX_SAND_IN  soc_gport_t                            gport,
...
typedef shr_error_e (*mbcm_dnx_fabric_load_balance_init_f) (
    int unit
  );
...
typedef shr_error_e (*mbcm_dnx_fabric_force_set_f) (
    DNX_SAND_IN  int                unit, 
...
typedef uint32 (*mbcm_dnx_if_type_from_id_f) ( 
    DNX_SAND_IN  SOC_DNX_INTERFACE_ID   soc_pb_nif_id, 
    DNX_SAND_OUT SOC_DNX_INTERFACE_TYPE *interface_type 
  ); 
...
typedef shr_error_e (*mbcm_dnx_stat_counter_length_get_f) (
    int unit,
    int counter_id,
    int * length
);

typedef shr_error_e (*mbcm_dnx_stat_controlled_counter_enable_get_f) (
    int unit,
    soc_port_t port,
    int counter_id,
    int *enable,
...
typedef int (* mbcm_dnx_itm_max_latency_pkts_get_f)(
    int unit,
    int max_count,
    SOC_DNX_MAX_LATENCY_PACKETS_INFO *max_latency_packets, 
    int *actual_count
  );   
...
typedef uint32 (*mbcm_dnx_port_pp_port_set_f) ( 
    ...
    DNX_SAND_OUT shr_error_e         *success 
  ); 
...
typedef uint32 (*mbcm_dnx_port_to_pp_port_map_set_f) ( 
    DNX_SAND_IN  int                    unit, 
    DNX_SAND_IN  soc_port_t             port, 
    DNX_SAND_IN  SOC_DNX_PORT_DIRECTION direction_ndx  
  ); 
...
typedef shr_error_e (*mbcm_dnx_port_control_low_latency_set_f) (
    DNX_SAND_IN  int                     unit,
    DNX_SAND_IN  soc_port_t              port,
    DNX_SAND_IN  int                     value
 );
typedef shr_error_e (*mbcm_dnx_port_control_fec_error_detect_set_f) (
    DNX_SAND_IN  int                     unit,
    DNX_SAND_IN  soc_port_t              port,
    DNX_SAND_IN  int                     value
 );
typedef shr_error_e (*mbcm_dnx_port_control_low_latency_get_f) (
    DNX_SAND_IN  int                     unit,
    DNX_SAND_IN  soc_port_t              port,
    DNX_SAND_OUT int                     *value
 );
typedef shr_error_e (*mbcm_dnx_port_control_fec_error_detect_get_f) (
    DNX_SAND_IN  int                     unit,
    DNX_SAND_IN  soc_port_t              port,
    DNX_SAND_OUT int                     *value
 );
typedef shr_error_e (*mbcm_dnx_port_extract_cig_from_llfc_enable_set_f) (
    DNX_SAND_IN  int                     unit,
    DNX_SAND_IN  soc_port_t              port,
    DNX_SAND_IN  int                     value
 );
typedef shr_error_e (*mbcm_dnx_port_extract_cig_from_llfc_enable_get_f) (
    DNX_SAND_IN  int                     unit,
    DNX_SAND_IN  soc_port_t              port,
    DNX_SAND_OUT int                     *value
 );
...
typedef uint32 (*mbcm_dnx_sys_virtual_port_to_local_port_map_set_f) ( 
    DNX_SAND_IN  int                 unit, 
...
typedef uint32 (*mbcm_dnx_stack_port_distribution_info_set_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_STACK_PORT_DISTR_INFO *distribution_info 
  ); 
typedef uint32 (*mbcm_dnx_stack_port_distribution_info_get_f) ( 
    DNX_SAND_IN  int                unit, 
    DNX_SAND_IN  uint32                local_stack_port_ndx, 
    DNX_SAND_OUT SOC_DNX_STACK_PORT_DISTR_INFO *distribution_info 
  );
/* tdm */ 
...
typedef uint32 (*mbcm_dnx_tdm_mc_static_route_set_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_TDM_MC_STATIC_ROUTE_INFO *route_info 
  ); 
typedef uint32 (*mbcm_dnx_tdm_mc_static_route_get_f) ( 
    DNX_SAND_IN  int                   unit, 
    DNX_SAND_IN  uint32                   mc_id_route_ndx, 
    DNX_SAND_OUT SOC_DNX_TDM_MC_STATIC_ROUTE_INFO *route_info 
  ); 
...
typedef uint32 (*mbcm_dnx_tdm_direct_routing_set_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_TDM_DIRECT_ROUTING_INFO *direct_routing_info,
    DNX_SAND_IN  uint8 enable
  ); 
typedef uint32 (*mbcm_dnx_tdm_direct_routing_get_f) ( 
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  uint32                   direct_routing_profile,
    DNX_SAND_OUT SOC_DNX_TDM_DIRECT_ROUTING_INFO *direct_routing_info,
...
typedef uint32 (*mbcm_dnx_read_from_fe600_f) ( 
    DNX_SAND_IN  int                       unit, 
    DNX_SAND_IN  SOC_DNX_SR_CELL_LINK_LIST        *sr_link_list, 
...
typedef uint32 (*mbcm_dnx_cell_mc_tbl_write_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_CELL_MC_TBL_DATA                    *tbl_data 
  ); 
typedef uint32 (*mbcm_dnx_cell_mc_tbl_read_f) ( 
    DNX_SAND_IN  int                                 unit, 
    DNX_SAND_IN  uint32                                 mc_id_ndx, 
    DNX_SAND_IN  SOC_DNX_CELL_MC_TBL_INFO                    *info, 
    DNX_SAND_OUT SOC_DNX_CELL_MC_TBL_DATA                    *tbl_data 
  ); 
...
typedef uint32 (*mbcm_dnx_nif_diag_last_packet_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_PORTS_ITMH          *last_incoming_header 
  ); 
...
typedef uint32 (*mbcm_dnx_egr_ofp_thresh_type_set_f) ( 
    ...
    DNX_SAND_IN  int                         core_id,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID         ofp_ndx,
    DNX_SAND_IN  SOC_DNX_EGR_PORT_THRESH_TYPE ofp_thresh_type 
  ); 
typedef uint32 (*mbcm_dnx_egr_ofp_thresh_type_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                         core_id,
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID         ofp_ndx, 
    DNX_SAND_OUT SOC_DNX_EGR_PORT_THRESH_TYPE *ofp_thresh_type 
  ); 
typedef uint32 (*mbcm_dnx_egr_sched_drop_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core,
    DNX_SAND_IN  int                 profile,
    DNX_SAND_IN  SOC_DNX_EGR_Q_PRIO          prio_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_DROP_THRESH     *thresh, 
    DNX_SAND_OUT SOC_DNX_EGR_DROP_THRESH     *exact_thresh 
  ); 
typedef uint32 (*mbcm_dnx_egr_sched_drop_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_EGR_Q_PRIO          prio_ndx, 
    DNX_SAND_OUT SOC_DNX_EGR_DROP_THRESH     *thresh 
  ); 
...
typedef int (*mbcm_dnx_egr_dev_fc_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core,
    DNX_SAND_IN  SOC_DNX_EGR_FC_DEVICE_THRESH *thresh, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_DEVICE_THRESH *exact_thresh 
  ); 
typedef int (*mbcm_dnx_egr_dev_fc_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core,
    DNX_SAND_OUT SOC_DNX_EGR_FC_DEVICE_THRESH *thresh 
  ); 
typedef uint32 (*mbcm_dnx_egr_xaui_spaui_fc_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_INTERFACE_ID        if_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_FC_CHNIF_THRESH *thresh, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_CHNIF_THRESH *exact_thresh 
  ); 
typedef uint32 (*mbcm_dnx_egr_xaui_spaui_fc_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_INTERFACE_ID        if_ndx, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_CHNIF_THRESH *thresh 
  ); 
typedef int (*mbcm_dnx_egr_ofp_fc_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core,
    DNX_SAND_IN  SOC_DNX_EGR_Q_PRIO          prio_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_PORT_THRESH_TYPE ofp_type_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_FC_OFP_THRESH   *thresh, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_OFP_THRESH   *exact_thresh 
  ); 
...
typedef int (*mbcm_dnx_egr_ofp_fc_get_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_EGR_Q_PRIO          prio_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_PORT_THRESH_TYPE ofp_type_ndx, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_OFP_THRESH   *thresh 
  ); 
typedef uint32 (*mbcm_dnx_egr_mci_fc_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_EGR_MCI_PRIO        mci_prio_ndx, 
    DNX_SAND_IN  SOC_DNX_EGR_FC_MCI_THRESH   *thresh, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_MCI_THRESH   *exact_thresh 
  ); 
typedef uint32 (*mbcm_dnx_egr_mci_fc_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_EGR_MCI_PRIO        mci_prio_ndx, 
    DNX_SAND_OUT SOC_DNX_EGR_FC_MCI_THRESH   *thresh 
  ); 
...
typedef uint32 (*mbcm_dnx_egr_ofp_sch_mode_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_EGR_OFP_SCH_MODE    *sch_mode 
  ); 
typedef uint32 (*mbcm_dnx_egr_ofp_sch_mode_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_EGR_OFP_SCH_MODE    *sch_mode 
  ); 
typedef int (*mbcm_dnx_egr_ofp_scheduling_set_f) (
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core, 
    DNX_SAND_IN  uint32              tm_port,
    DNX_SAND_IN  uint32              cosq,
...
typedef int (*mbcm_dnx_egr_ofp_scheduling_get_f) (
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core, 
    DNX_SAND_IN  uint32              tm_port,
    DNX_SAND_IN  uint32              cosq,
...
typedef uint32 (*mbcm_dnx_mult_cud_to_port_map_set_f) (
    ...
    DNX_SAND_IN SOC_DNX_FAP_PORT_ID port  /* input (local egress) port */
  );

typedef uint32 (*mbcm_dnx_mult_cud_to_port_map_get_f) (
    DNX_SAND_IN  int          unit, /* input device */
    DNX_SAND_IN  uint32          cud,       /* input cud/outlif */
    DNX_SAND_OUT SOC_DNX_FAP_PORT_ID *port      /* output (local egress) port */
  );

/* fabric */ 
typedef uint32 (*mbcm_dnx_fabric_fc_enable_set_f) ( 
    DNX_SAND_IN  int                  unit, 
    DNX_SAND_IN  SOC_DNX_CONNECTION_DIRECTION direction_ndx, 
    DNX_SAND_IN  SOC_DNX_FABRIC_FC            *info 
  ); 
typedef uint32 (*mbcm_dnx_fabric_fc_enable_get_f) ( 
    DNX_SAND_IN  int                  unit, 
    DNX_SAND_OUT SOC_DNX_FABRIC_FC           *info_rx, 
    DNX_SAND_OUT SOC_DNX_FABRIC_FC           *info_tx 
  ); 
typedef uint32 (*mbcm_dnx_fabric_fc_shaper_set_f) ( 
    DNX_SAND_IN  int                        unit,
    DNX_SAND_IN  uint32                        link_ndx,
    DNX_SAND_IN  SOC_DNX_FABRIC_FC_SHAPER_MODE_INFO  *shaper_mode,  
    DNX_SAND_IN  SOC_DNX_FABRIC_FC_SHAPER            *info,
    DNX_SAND_OUT SOC_DNX_FABRIC_FC_SHAPER            *exact_info
  ); 
typedef uint32 (*mbcm_dnx_fabric_fc_shaper_get_f) ( 
    DNX_SAND_IN  int                         unit,
    DNX_SAND_IN  uint32                         link_ndx,
    DNX_SAND_OUT SOC_DNX_FABRIC_FC_SHAPER_MODE_INFO  *shaper_mode,  
...
typedef shr_error_e (*mbcm_dnx_fabric_stand_alone_fap_mode_get_f) ( 
    int                 unit, 
    int                 *is_single_fap_mode 
  ); 
typedef uint32 (*mbcm_dnx_fabric_connect_mode_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_FABRIC_CONNECT_MODE fabric_mode 
  ); 
typedef uint32 (*mbcm_dnx_fabric_connect_mode_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_FABRIC_CONNECT_MODE *fabric_mode 
  ); 
...
typedef shr_error_e (*mbcm_dnx_fabric_topology_status_connectivity_get_f) ( 
    int                 unit,
    int                    link_index_min,
    int                    link_index_max, 
    SOC_DNX_FABRIC_LINKS_CON_STAT_INFO_ARR *connectivity_map 
  ); 
typedef shr_error_e (*mbcm_dnx_fabric_link_status_get_f) (
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  soc_port_t         link_id,
    DNX_SAND_OUT uint32             *link_status,
    DNX_SAND_OUT uint32             *errored_token_count
  );
typedef shr_error_e (*mbcm_dnx_fabric_aldwp_config_f) ( 
    int                 unit
  );
...
typedef uint32 (*mbcm_dnx_fabric_gci_enable_set_f) ( 
    DNX_SAND_IN  int                                 unit,  
    DNX_SAND_IN  SOC_DNX_FABRIC_GCI_TYPE                type,
    DNX_SAND_IN  int                                    value
  );
...
typedef uint32 (*mbcm_dnx_fabric_gci_config_set_f) ( 
    DNX_SAND_IN  int                                 unit,  
    DNX_SAND_IN  SOC_DNX_FABRIC_GCI_CONFIG_TYPE         type,
    DNX_SAND_IN  int                                    value
  );
...
typedef uint32 (*mbcm_dnx_fabric_rci_config_set_f) ( 
    DNX_SAND_IN  int                                 unit,
    DNX_SAND_IN SOC_DNX_FABRIC_RCI_CONFIG_TYPE             rci_config_type,
    DNX_SAND_IN int                                     value
  );
...
typedef shr_error_e (*mbcm_dnx_fabric_minimal_links_to_dest_init_f) (
    int unit
  );

typedef shr_error_e (*mbcm_dnx_fabric_minimal_links_to_dest_set_f) (
    int          unit,
    soc_module_t module_id,
    int          min_links
  );

typedef shr_error_e (*mbcm_dnx_fabric_minimal_links_to_dest_get_f) (
    int             unit,
    soc_module_t    module_id,
    int            *min_links
  );

typedef shr_error_e (*mbcm_dnx_fabric_minimal_links_all_reachable_set_f) (
    int             unit,
    int             min_links
  );

typedef shr_error_e (*mbcm_dnx_fabric_minimal_links_all_reachable_get_f) (
    int          unit,
    int         *min_links
  );
 
typedef shr_error_e (*mbcm_dnx_fabric_port_enable_set_f) (
    int unit,
    soc_port_t logical_port,
    int enable);
...
typedef int (*mbcm_dnx_fabric_reachability_status_get_f) (
    DNX_SAND_IN    int                          unit,
    DNX_SAND_IN    int                          moduleid,
    DNX_SAND_IN    int                          links_max,
    DNX_SAND_OUT   uint32                       *links_array,
...
typedef int (*mbcm_dnx_ipq_destination_id_packets_base_queue_id_set_f) ( 
   DNX_SAND_IN  int                 unit,
   DNX_SAND_IN  uint32              dest_ndx,
   DNX_SAND_IN  int                 valid,
   DNX_SAND_IN  uint32              base_queue
  ); 
typedef int (*mbcm_dnx_ipq_destination_id_packets_base_queue_id_get_f) ( 
    DNX_SAND_IN  int                 unit,
    DNX_SAND_IN  uint32              dest_ndx,
    DNX_SAND_OUT int                 *valid,
    DNX_SAND_OUT uint32              *base_queue
  ); 
typedef int (*mbcm_dnx_ipq_queue_interdigitated_mode_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  uint32              queue_region, 
    DNX_SAND_IN  int                 is_interdigitated 
  ); 
typedef int (*mbcm_dnx_ipq_queue_interdigitated_mode_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  uint32              queue_region, 
    DNX_SAND_OUT int                 *is_interdigitated 
  ); 
typedef int (*mbcm_dnx_ipq_queue_to_flow_mapping_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core_id,
    DNX_SAND_IN  uint32              queue_quartet_ndx, 
    DNX_SAND_IN  SOC_DNX_IPQ_QUARTET_MAP_INFO *info 
  ); 
typedef int (*mbcm_dnx_ipq_queue_to_flow_mapping_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                 core_id,
    DNX_SAND_IN  uint32                  queue_quartet_ndx, 
    DNX_SAND_OUT SOC_DNX_IPQ_QUARTET_MAP_INFO *info 
  ); 
typedef int (*mbcm_dnx_ipq_indirect_base_queue_to_system_physical_port_set_f) (
    DNX_SAND_IN   int           unit,
    DNX_SAND_IN   uint32        entry_offset,
    DNX_SAND_IN   uint32        sys_phy_port
  );
typedef int (*mbcm_dnx_ipq_indirect_base_queue_to_system_physical_port_get_f) (
    DNX_SAND_IN   int           unit,
    DNX_SAND_IN   uint32        entry_offset,
    DNX_SAND_OUT  uint32        *sys_phy_port
  );
typedef int (*mbcm_dnx_ipq_queue_qrtt_unmap_f) ( 
    DNX_SAND_IN  int unit, 
    DNX_SAND_IN  uint32  queue_quartet_ndx 
  ); 
typedef int (*mbcm_dnx_ipq_quartet_reset_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  uint32                  queue_quartet_ndx 
  ); 
...
typedef int (*mbcm_dnx_ipq_tc_profile_set_f) (
    DNX_SAND_IN     int         unit,
    DNX_SAND_IN     uint8       is_flow_ndx,
    DNX_SAND_IN     uint32      dest_ndx,
    DNX_SAND_IN     uint32      tc_profile
  );
typedef int (*mbcm_dnx_ipq_tc_profile_get_f) (
    DNX_SAND_IN      int        unit,
    DNX_SAND_IN      uint8      is_flow_ndx,
    DNX_SAND_IN      uint32     dest_ndx,
    DNX_SAND_OUT     uint32     *tc_profile
  );
typedef int (*mbcm_dnx_ipq_traffic_class_profile_map_set_f) (
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  uint32             profile_ndx,
    DNX_SAND_IN  uint8              is_flow_profile,
    DNX_SAND_IN  uint8              is_multicast_profile,
    DNX_SAND_IN  SOC_DNX_IPQ_TR_CLS tr_cls_ndx,
    DNX_SAND_IN  SOC_DNX_IPQ_TR_CLS new_class
  );
typedef int (*mbcm_dnx_ipq_traffic_class_profile_map_get_f) (
    DNX_SAND_IN  int              unit,
    DNX_SAND_IN  uint32           profile_ndx,
    DNX_SAND_IN  uint8              is_flow_profile,
    DNX_SAND_IN  uint8              is_multicast_profile,
    DNX_SAND_IN  SOC_DNX_IPQ_TR_CLS tr_cls_ndx,
    DNX_SAND_OUT SOC_DNX_IPQ_TR_CLS *new_class
  );
...
typedef uint32 (*mbcm_dnx_itm_dram_buffs_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_ITM_DRAM_BUFFERS_INFO *dram_buffs 
  ); 
...
typedef uint32 (*mbcm_dnx_itm_glob_rcs_fc_set_f) ( 
    ...
    DNX_SAND_OUT  SOC_DNX_ITM_GLOB_RCS_FC_TH  *exact_info 
  ); 
...
typedef uint32 (*mbcm_dnx_itm_vsq_index_fc_group2global_f) ( 
    ...
    DNX_SAND_OUT SOC_DNX_ITM_VSQ_NDX   *vsq_ndx 
  ); 
...
typedef int (*mbcm_dnx_itm_min_free_resources_stat_get_f) (
    DNX_SAND_IN int unit,
    DNX_SAND_IN int core,
    DNX_SAND_IN SOC_DNX_ITM_CGM_RSRC_STAT_TYPE type,
...
typedef shr_error_e (*mbcm_dnx_fc_gen_cal_get_f) (
    DNX_SAND_IN  int                      unit,
...
typedef shr_error_e (*mbcm_dnx_fc_gen_cal_set_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_MODE                 cal_mode_ndx,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID                if_ndx,
...
typedef shr_error_e (*mbcm_dnx_fc_gen_inbnd_set_f) (
    DNX_SAND_IN  int                            unit,
    DNX_SAND_IN  soc_port_t                     port,
    DNX_SAND_IN  SOC_DNX_FC_GEN_INBND_INFO      *info
  );
typedef shr_error_e (*mbcm_dnx_fc_gen_inbnd_get_f) (
    DNX_SAND_IN  int                            unit,
    DNX_SAND_IN  soc_port_t                     port,
...
typedef shr_error_e (*mbcm_dnx_fc_rec_cal_set_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_MODE                 cal_mode_ndx,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID                if_ndx,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_INFO              *cal_conf,
...
typedef shr_error_e (*mbcm_dnx_fc_rec_cal_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_MODE                 cal_mode_ndx,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID                if_ndx,
    DNX_SAND_OUT  SOC_DNX_FC_CAL_IF_INFO              *cal_conf,
...
typedef shr_error_e (*mbcm_dnx_fc_pfc_generic_bitmap_set_f) (
    DNX_SAND_IN   int   unit,
    DNX_SAND_IN   int       priority,
    DNX_SAND_IN   uint32    bitmap_index,
    DNX_SAND_IN  SOC_DNX_FC_PFC_GENERIC_BITMAP    *pfc_bitmap
  );
typedef shr_error_e (*mbcm_dnx_fc_pfc_generic_bitmap_get_f) (
    DNX_SAND_IN   int   unit,
    DNX_SAND_IN   int       priority,
    DNX_SAND_IN   uint32    bitmap_index,
...
typedef uint32 (*mbcm_dnx_mult_eg_group_open_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_EG_ENTRY       *mc_group, 
...
typedef uint32 (*mbcm_dnx_mult_eg_group_set_f) (
    DNX_SAND_IN  int         unit,
    DNX_SAND_IN  SOC_DNX_MULT_ID         multicast_id_ndx,    /* the group mcid */
    ...
    DNX_SAND_IN  int *reps,               /* input array containing replications */
    DNX_SAND_OUT SOC_DNX_ERROR        *out_err             /* return possible errors that the caller may want to ignore */
  );
...
typedef uint32 (*mbcm_dnx_mult_eg_port_add_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_EG_ENTRY       *entry, 
    DNX_SAND_OUT SOC_DNX_ERROR            *out_err /* return possible errors that the caller may want to ignore */
  ); 
...
typedef uint32 (*mbcm_dnx_mult_eg_vlan_membership_group_open_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_EG_VLAN_MEMBERSHIP_GROUP *group 
  ); 
...
typedef uint32 (*mbcm_dnx_mult_eg_vlan_membership_port_add_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID        port,
    DNX_SAND_OUT SOC_DNX_ERROR            *out_err /* return possible errors that the caller may want to ignore */
  ); 
...
typedef uint32 (*mbcm_dnx_mult_eg_vlan_membership_bm_add_f) ( 
    DNX_SAND_IN  int                                   unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID                       multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_EG_VLAN_MEMBERSHIP_GROUP *bitmap, /* TM ports to add */
    DNX_SAND_OUT SOC_DNX_ERROR                         *out_err /* return possible errors that the caller may want to ignore */
  ); 
typedef uint32 (*mbcm_dnx_mult_eg_vlan_membership_bm_remove_f) ( 
    DNX_SAND_IN  int                                   unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID                       multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_EG_VLAN_MEMBERSHIP_GROUP *bitmap, /* TM ports to remove */
    DNX_SAND_OUT SOC_DNX_ERROR                         *out_err /* return possible errors that the caller may want to ignore */
  ); 
typedef uint32 (*mbcm_dnx_mult_eg_vlan_membership_group_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_OUT SOC_DNX_MULT_EG_VLAN_MEMBERSHIP_GROUP *group 
  ); 
typedef uint32 (*dnx_mcds_multicast_init2_f) ( 
    DNX_SAND_IN  int                 unit
  ); 
/* multicast_fabric */ 
typedef int (*mbcm_dnx_mult_fabric_traffic_class_to_multicast_cls_map_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_TR_CLS              tr_cls_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_FABRIC_CLS     new_mult_cls 
  ); 
typedef int (*mbcm_dnx_mult_fabric_traffic_class_to_multicast_cls_map_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_TR_CLS         tr_cls_ndx, 
    DNX_SAND_OUT SOC_DNX_MULT_FABRIC_CLS     *new_mult_cls 
  ); 
...
typedef int (*mbcm_dnx_mult_fabric_enhanced_set_f) ( 
    DNX_SAND_IN  int                        unit, 
    DNX_SAND_IN  DNX_SAND_U32_RANGE         *queue_range 
  ); 
typedef int (*mbcm_dnx_mult_fabric_enhanced_get_f) ( 
    DNX_SAND_IN  int                        unit, 
...
typedef uint32 (*mbcm_dnx_mult_fabric_flow_control_set_f) ( 
    DNX_SAND_IN  int                                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_FABRIC_FLOW_CONTROL_MAP   *fc_map 
  ); 

typedef uint32 (*mbcm_dnx_mult_fabric_flow_control_get_f) ( 
    DNX_SAND_IN  int                                 unit, 
    DNX_SAND_OUT SOC_DNX_MULT_FABRIC_FLOW_CONTROL_MAP   *fc_map 
  ); 

typedef uint32 (*mbcm_dnx_mult_fabric_active_links_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_FABRIC_ACTIVE_LINKS *links, 
    DNX_SAND_IN  uint8                 tbl_refresh_enable 
  ); 
typedef uint32 (*mbcm_dnx_mult_fabric_active_links_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_MULT_FABRIC_ACTIVE_LINKS *links, 
...
typedef uint32 (*mbcm_dnx_mult_does_group_exist_f) ( 
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_MULT_ID mcid,      /* MC ID of the group */
...
typedef uint32 (*mbcm_dnx_mult_ing_traffic_class_map_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ING_TR_CLS_MAP *map 
  ); 
typedef uint32 (*mbcm_dnx_mult_ing_traffic_class_map_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_MULT_ING_TR_CLS_MAP *map 
  ); 
typedef uint32 (*mbcm_dnx_mult_ing_group_open_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_ING_ENTRY      *mc_group, 
    DNX_SAND_IN  uint32                  mc_group_size, 
    DNX_SAND_OUT SOC_DNX_ERROR         *out_err             /* return possible errors that the caller may want to ignore: insufficient memory or duplicate replications */
  ); 
...
typedef uint32 (*mbcm_dnx_mult_ing_destination_add_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  SOC_DNX_MULT_ING_ENTRY      *entry, 
    DNX_SAND_OUT SOC_DNX_ERROR            *out_err /* return possible errors that the caller may want to ignore : insufficient memory or duplicate replication */
  ); 
typedef uint32 (*mbcm_dnx_mult_ing_encode_entry_f) (
    DNX_SAND_IN    int                 unit,
    DNX_SAND_IN    SOC_DNX_MULT_ING_ENTRY *ing_entry,       /* replication data */
...
typedef uint32 (*mbcm_dnx_mult_ing_group_get_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_MULT_ID             multicast_id_ndx, 
    DNX_SAND_IN  uint32                 mc_group_size, 
    DNX_SAND_OUT SOC_DNX_MULT_ING_ENTRY      *mc_group, 
    DNX_SAND_OUT uint32                  *exact_mc_group_size, 
    DNX_SAND_OUT uint8                 *is_open 
  ); 
typedef uint32 (*mbcm_dnx_mult_ing_get_group_f) (
    DNX_SAND_IN  int              unit,
    DNX_SAND_IN  SOC_DNX_MULT_ID        group_mcid,           /* group id */
    DNX_SAND_IN  uint32              mc_group_size,        /* maximum replications to return */
...
typedef uint32 (*mbcm_dnx_pkt_packet_callback_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_PKT_PACKET_TRANSFER *packet_transfer 
  ); 
typedef uint32 (*mbcm_dnx_pkt_packet_callback_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_OUT SOC_DNX_PKT_PACKET_TRANSFER *packet_transfer 
  ); 
...
typedef uint32 (*mbcm_dnx_pkt_packet_receive_mode_set_f) ( 
    DNX_SAND_IN  SOC_DNX_PKT_PACKET_RECV_MODE  recv_mode 
  ); 
typedef uint32 (*mbcm_dnx_pkt_packet_receive_mode_get_f) ( 
    DNX_SAND_OUT SOC_DNX_PKT_PACKET_RECV_MODE  *recv_mode 
  ); 
 
/* ports */ 
typedef int (*mbcm_dnx_sys_phys_to_local_port_map_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  uint32                 sys_phys_port_ndx, 
    DNX_SAND_IN  uint32                 mapped_fap_id, 
    DNX_SAND_IN  uint32                 mapped_fap_port_id 
  ); 
typedef int (*mbcm_dnx_sys_phys_to_local_port_map_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  uint32                 sys_phys_port_ndx, 
...
typedef int (*mbcm_dnx_port_to_interface_map_get_f) ( 
    ...
    DNX_SAND_IN  int                    core, 
    DNX_SAND_IN  uint32                 tm_port, 
    DNX_SAND_OUT SOC_DNX_INTERFACE_ID   *if_id, 
...
typedef uint32 (*mbcm_dnx_ports_lag_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  uint32                 lag_ndx, 
    DNX_SAND_OUT SOC_DNX_PORTS_LAG_INFO      *info_incoming, 
    DNX_SAND_OUT SOC_DNX_PORTS_LAG_INFO      *info_outgoing 
  ); 
...
typedef uint32 (*mbcm_dnx_ports_lag_member_add_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_PORT_DIRECTION                      direction_ndx, 
    DNX_SAND_IN  uint32                                 lag_ndx, 
    DNX_SAND_IN  SOC_DNX_PORTS_LAG_MEMBER                    *lag_member, 
...
typedef uint32 (*mbcm_dnx_ports_lag_sys_port_info_get_f) ( 
    DNX_SAND_IN  int                     unit, 
    DNX_SAND_IN  uint32                     sys_port, 
    DNX_SAND_OUT SOC_DNX_PORT_LAG_SYS_PORT_INFO *port_lag_info_incoming 
  ); 
...
typedef uint32 (*mbcm_dnx_port_header_type_set_f) ( 
    ...
    DNX_SAND_IN  uint32                 port_ndx, 
    DNX_SAND_IN  SOC_DNX_PORT_DIRECTION      direction_ndx, 
    DNX_SAND_IN  SOC_DNX_PORT_HEADER_TYPE    header_type 
  ); 
typedef uint32 (*mbcm_dnx_port_header_type_get_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  int                    core_id,
    DNX_SAND_IN  uint32                 port_ndx, 
    DNX_SAND_OUT SOC_DNX_PORT_HEADER_TYPE    *header_type_incoming, 
    DNX_SAND_OUT SOC_DNX_PORT_HEADER_TYPE    *header_type_outgoing 
  ); 
...
typedef uint32 (*mbcm_dnx_ports_itmh_extension_set_f) ( 
    DNX_SAND_IN  int                 unit, 
    DNX_SAND_IN  SOC_DNX_FAP_PORT_ID         port_ndx, 
...
typedef uint32 (*mbcm_dnx_ports_ftmh_extension_set_f) ( 
    DNX_SAND_IN  int                   unit, 
    DNX_SAND_IN  SOC_DNX_PORTS_FTMH_EXT_OUTLIF ext_option 
  ); 
typedef uint32 (*mbcm_dnx_ports_ftmh_extension_get_f) ( 
    DNX_SAND_IN  int                   unit, 
    DNX_SAND_OUT SOC_DNX_PORTS_FTMH_EXT_OUTLIF *ext_option 
  );
...
typedef uint32 (*mbcm_dnx_port_egr_hdr_credit_discount_type_set_f) ( 
    DNX_SAND_IN  int                 unit,
    DNX_SAND_IN  int                 core, 
    DNX_SAND_IN  SOC_DNX_PORT_HEADER_TYPE    port_hdr_type_ndx, 
    DNX_SAND_IN  SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_TYPE cr_discnt_type_ndx, 
...
typedef uint32 (*mbcm_dnx_port_egr_hdr_credit_discount_select_set_f) ( 
    ...
    DNX_SAND_IN  int                    core, 
    DNX_SAND_IN  uint32                 tm_port, 
    DNX_SAND_IN  SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_TYPE cr_discnt_type 
  ); 
typedef uint32 (*mbcm_dnx_port_egr_hdr_credit_discount_select_get_f) ( 
    DNX_SAND_IN  int                    unit, 
    DNX_SAND_IN  int                    core, 
    DNX_SAND_IN  uint32                 tm_port, 
    DNX_SAND_OUT SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_TYPE *cr_discnt_type 
  ); 
...
typedef uint32 (*mbcm_dnx_port_stacking_route_history_bitmap_set_f) ( 
    ...
    DNX_SAND_IN  int                              core_id,
    DNX_SAND_IN  uint32                              local_port_ndx,
    DNX_SAND_IN  SOC_DNX_STACK_EGR_PROG_TM_PORT_PROFILE_STACK tm_port_profile_stack,
...
typedef shr_error_e (*mbcm_dnx_port_rate_egress_ppt_set_f) (
    int unit, 
    soc_port_t port, 
    uint32 burst,
    uint32 nof_tiks 
...
typedef shr_error_e (*mbcm_dnx_port_rate_egress_ppt_get_f) (
    int unit, 
    soc_port_t port, 
    uint32 *burst,
    uint32 *nof_tiks
...
typedef uint32 (*mbcm_dnx_read_reg_f) ( 
    DNX_SAND_IN  int      unit, 
    DNX_SAND_IN  SOC_DNX_REG_ADDR*   reg, 
    DNX_SAND_IN  uint32      instance_idx, 
    DNX_SAND_OUT uint32*         val 
  ); 
...
typedef uint32 (*mbcm_dnx_status_fld_poll_f) ( 
    ...
    DNX_SAND_IN  SOC_DNX_POLL_INFO           *poll_info, 
    DNX_SAND_OUT uint8                 *success 
  ); 
typedef int (*mbcm_dnx_brdc_fsrd_blk_id_set_f) ( 
    DNX_SAND_IN  int                 unit
  ); 
typedef int (*mbcm_dnx_fsrd_blocks_low_power_init_f) (
    DNX_SAND_IN  int    unit
  );
typedef int (*mbcm_dnx_port_fsrd_block_enable_set_f) (
        int unit,
        soc_port_t logical_port,
        int enable);

typedef int (*mbcm_dnx_fsrd_block_enable_set_f) (
        int unit,
        soc_port_t fsrd_block,
        int enable);
/* mgmt */ 
...
typedef uint32 (*mbcm_dnx_hpu_ftmh_build_verify_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_FTMH            *info 
  ); 
typedef uint32 (*mbcm_dnx_hpu_otmh_build_verify_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_OTMH            *info 
  ); 
typedef uint32 (*mbcm_dnx_hpu_itmh_build_f) ( 
    DNX_SAND_IN  SOC_DNX_PORTS_ITMH          *info, 
    DNX_SAND_OUT SOC_DNX_HPU_ITMH_HDR        *itmh 
  ); 
typedef uint32 (*mbcm_dnx_hpu_itmh_parse_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_ITMH_HDR        *itmh, 
    DNX_SAND_OUT SOC_DNX_PORTS_ITMH          *info 
  ); 
typedef uint32 (*mbcm_dnx_hpu_ftmh_build_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_FTMH            *info, 
    DNX_SAND_OUT SOC_DNX_HPU_FTMH_HDR        *ftmh 
  ); 
typedef uint32 (*mbcm_dnx_hpu_ftmh_parse_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_FTMH_HDR        *ftmh, 
    DNX_SAND_OUT SOC_DNX_HPU_FTMH            *info 
  ); 
typedef uint32 (*mbcm_dnx_hpu_otmh_build_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_OTMH            *info, 
    DNX_SAND_OUT SOC_DNX_HPU_OTMH_HDR        *otmh 
  ); 
typedef uint32 (*mbcm_dnx_hpu_otmh_parse_f) ( 
    DNX_SAND_IN  SOC_DNX_HPU_OTMH_HDR        *otmh, 
    DNX_SAND_OUT SOC_DNX_HPU_OTMH            *info 
  ); 
typedef int (*mbcm_dnx_loopback_set_f) (
    DNX_SAND_IN  int                        unit,
    DNX_SAND_IN  soc_port_t                 port,
    DNX_SAND_IN  portmod_loopback_mode_t   loopback
  );
typedef int (*mbcm_dnx_loopback_get_f) (
    DNX_SAND_IN  int                        unit,
    DNX_SAND_IN  soc_port_t                 port,
    DNX_SAND_OUT portmod_loopback_mode_t   *loopback
  ); 
...
typedef uint32 (*mbcm_dnx_nif_synce_clk_div_set_f) (
    DNX_SAND_IN  int                       unit,
    DNX_SAND_IN  uint32                    synce_cfg_num,
    DNX_SAND_IN  int   clk_div
  ); 
typedef uint32 (*mbcm_dnx_nif_synce_clk_div_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  uint32                   synce_cfg_num,
    DNX_SAND_OUT int*   clk_div
  ); 

typedef uint32 (*mbcm_dnx_nif_synce_clk_squelch_set_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  uint32                   synce_cfg_num,
    DNX_SAND_IN  int                   enable
  );
typedef uint32 (*mbcm_dnx_nif_synce_clk_squelch_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  uint32                   synce_cfg_num,
    DNX_SAND_OUT int                      *enable
  );
...
typedef uint32 (*mbcm_dnx_ports_application_mapping_info_set_f) (
    DNX_SAND_IN int unit, 
    DNX_SAND_IN SOC_DNX_FAP_PORT_ID port_ndx, 
    DNX_SAND_IN SOC_DNX_PORTS_APPLICATION_MAPPING_INFO *info
  );
 
typedef uint32 (*mbcm_dnx_ports_application_mapping_info_get_f) (
    DNX_SAND_IN int unit, 
    DNX_SAND_IN SOC_DNX_FAP_PORT_ID port_ndx, 
    DNX_SAND_INOUT SOC_DNX_PORTS_APPLICATION_MAPPING_INFO *info
  ); 

/* New ofp rates */

typedef int (*mbcm_dnx_ofp_rates_port_priority_max_burst_for_fc_queues_set_f) (
    DNX_SAND_IN  int unit,
    DNX_SAND_IN  uint32 max_burst_fc_queues
    );
typedef int (*mbcm_dnx_ofp_rates_port_priority_max_burst_for_empty_queues_set_f) (
    DNX_SAND_IN  int unit,
    DNX_SAND_IN  uint32 max_burst_empty_queues
    );
typedef int (*mbcm_dnx_ofp_rates_port_priority_max_burst_for_fc_queues_get_f) (
    DNX_SAND_IN  int unit,
    DNX_SAND_OUT  uint32 *max_burst_fc_queues
    );
typedef int (*mbcm_dnx_ofp_rates_port_priority_max_burst_for_empty_queues_get_f) (
    DNX_SAND_IN  int unit,
...
/* } */
#endif
typedef int (*mbcm_dnx_ofp_rates_egq_tcg_rate_sw_set_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
    DNX_SAND_IN  uint32                tm_port,   
...
typedef int (*mbcm_dnx_ofp_rates_egq_tcg_rate_hw_set_f)(
    DNX_SAND_IN  int                unit
    );
typedef int (*mbcm_dnx_ofp_rates_egq_tcg_rate_hw_get_f) (
    DNX_SAND_IN  int                    unit,
    DNX_SAND_IN  int                    core,
    DNX_SAND_IN  uint32                 tm_port,   
    DNX_SAND_IN  uint32                 tcg_ndx, 
...
typedef int (*mbcm_dnx_ofp_rates_sch_tcg_shaper_disable_f) (
    DNX_SAND_IN     int               unit,
    DNX_SAND_IN     int               core,
    DNX_SAND_IN     uint32            base_qpair,
    DNX_SAND_IN     uint32            nof_q_pairs
    );
typedef int (*mbcm_dnx_ofp_rates_egq_tcg_max_burst_set_f)(
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  int                core,
    DNX_SAND_IN  uint32             tm_port,   
    DNX_SAND_IN  uint32             tcg_ndx, 
...
typedef int (*mbcm_dnx_ofp_rates_egq_tcg_max_burst_get_f)(
    DNX_SAND_IN  int                    unit,
    DNX_SAND_IN  int                    core,
    DNX_SAND_IN  uint32                 tm_port,   
    DNX_SAND_IN  uint32                 tcg_ndx, 
...
typedef int (*mbcm_dnx_ofp_rates_egq_port_priority_rate_sw_set_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
    DNX_SAND_IN  uint32                tm_port,   
...
typedef int (*mbcm_dnx_ofp_rates_egq_port_priority_rate_hw_set_f) (
    DNX_SAND_IN  int                unit
    );

typedef int (*mbcm_dnx_ofp_rates_sch_port_priority_rate_sw_set_f) (
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  int                core,
    DNX_SAND_IN  uint32             tm_port,   
...
typedef int (*mbcm_dnx_ofp_rates_sch_port_priority_hw_set_f) (
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  int                core
    );

typedef int (*mbcm_dnx_ofp_rates_egq_port_priority_rate_hw_get_f) (
    DNX_SAND_IN  int                    unit,
    DNX_SAND_IN  int                    core,
    DNX_SAND_IN  uint32                 tm_port,   
    DNX_SAND_IN  uint32                 port_priority, 
...
typedef int (*mbcm_dnx_ofp_rates_egq_port_priority_max_burst_set_f) (
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  int                core,
    DNX_SAND_IN  uint32             tm_port,   
    DNX_SAND_IN  uint32             port_priority, 
...
typedef int (*mbcm_dnx_ofp_rates_egq_port_priority_max_burst_get_f) (
    DNX_SAND_IN  int                    unit,
    DNX_SAND_IN  int                    core,
    DNX_SAND_IN  uint32                 tm_port,   
    DNX_SAND_IN  uint32                 port_priority, 
...
typedef int (*mbcm_dnx_ofp_rates_egress_shaper_cal_write_f) (
    ...
    DNX_SAND_IN  dnx_ofp_rates_cal_set_e                cal2set,    
    DNX_SAND_IN  SOC_DNX_OFP_RATES_EGQ_CHAN_ARB_FIELD_TYPE field_type,
    DNX_SAND_IN  uint32                                   data
    );
...
typedef int (*mbcm_dnx_drv_validate_fabric_mode_f)(
    int unit, 
    SOC_DNX_FABRIC_CONNECT_MODE *fabric_connect_mode
   );

typedef int (*mbcm_dnx_drv_prop_fap_device_mode_get_f)(
    int unit, 
    uint8 *pp_enable, 
    SOC_DNX_MGMT_TDM_MODE *tdm_mode
   );
...
typedef shr_error_e (* mbcm_dnx_fc_pfc_mapping_set_f)(
    DNX_SAND_IN int  unit,
...
typedef shr_error_e (* mbcm_dnx_fc_pfc_mapping_get_f)(
    DNX_SAND_IN int  unit,
    DNX_SAND_IN uint32                       nif_id,
    DNX_SAND_IN uint32                       src_pfc_ndx,
...
typedef shr_error_e (*mbcm_dnx_port_control_pcs_set_f) (int unit, soc_port_t port, soc_dnxc_port_pcs_t pcs);
typedef shr_error_e (*mbcm_dnx_port_control_pcs_get_f) (int unit, soc_port_t port, soc_dnxc_port_pcs_t* pcs);
typedef shr_error_e (*mbcm_dnx_port_control_power_set_f) (int unit, soc_port_t port, uint32 flags, soc_dnxc_port_power_t power);
typedef shr_error_e (*mbcm_dnx_port_control_power_get_f) (int unit, soc_port_t port, soc_dnxc_port_power_t* power);
typedef shr_error_e (*mbcm_dnx_port_control_rx_enable_set_f) (int unit, soc_port_t port, uint32 flags, int enable);
typedef shr_error_e (*mbcm_dnx_port_control_tx_enable_set_f) (int unit, soc_port_t port, int enable);
typedef shr_error_e (*mbcm_dnx_port_control_tx_nif_enable_set_f) (int unit, soc_port_t port, int enable);
typedef shr_error_e (*mbcm_dnx_port_control_rx_enable_get_f) (int unit, soc_port_t port, int* enable);
typedef shr_error_e (*mbcm_dnx_port_control_tx_enable_get_f) (int unit, soc_port_t port, int* enable);
typedef shr_error_e (*mbcm_dnx_port_control_tx_nif_enable_get_f) (int unit, soc_port_t port, int* enable);
typedef shr_error_e (*mbcm_dnx_port_control_strip_crc_set_f) (int unit, soc_port_t port, int strip_crc);
typedef shr_error_e (*mbcm_dnx_port_control_strip_crc_get_f) (int unit, soc_port_t port, int* strip_crc);
typedef shr_error_e (*mbcm_dnx_port_prbs_tx_enable_set_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int value);
typedef shr_error_e (*mbcm_dnx_port_prbs_tx_enable_get_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int* value);
typedef shr_error_e (*mbcm_dnx_port_prbs_rx_enable_set_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int value);
typedef shr_error_e (*mbcm_dnx_port_prbs_rx_enable_get_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int* value);
typedef shr_error_e (*mbcm_dnx_port_prbs_rx_status_get_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int* value);
typedef shr_error_e (*mbcm_dnx_port_prbs_polynomial_set_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int value);
typedef shr_error_e (*mbcm_dnx_port_prbs_polynomial_get_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int* value);
typedef shr_error_e (*mbcm_dnx_port_prbs_tx_invert_data_set_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int value);
typedef shr_error_e (*mbcm_dnx_port_prbs_tx_invert_data_get_f) (int unit, soc_port_t port, soc_dnxc_port_prbs_mode_t mode, int *value);
typedef shr_error_e (*mbcm_dnx_port_pfc_refresh_set_f) (int unit, soc_port_t port, int value);
typedef shr_error_e (*mbcm_dnx_port_pfc_refresh_get_f) (int unit, soc_port_t port, int *value);
typedef shr_error_e (*mbcm_dnx_local_fault_clear_f) (int unit, soc_port_t port);
typedef shr_error_e (*mbcm_dnx_remote_fault_clear_f) (int unit, soc_port_t port);
typedef shr_error_e (*mbcm_dnx_pad_size_set_f) (int unit, soc_port_t port, int value);
typedef shr_error_e (*mbcm_dnx_pad_size_get_f) (int unit, soc_port_t port, int *value);
typedef shr_error_e (*mbcm_dnx_port_reset_f) (int unit, soc_port_t port);
typedef shr_error_e (*mbcm_dnx_port_phy_control_set_f) (int unit, soc_port_t port, int phyn, int lane, int is_sys_side, soc_phy_control_t type, uint32 value);
typedef shr_error_e (*mbcm_dnx_port_phy_control_get_f) (int unit, soc_port_t port, int phyn, int lane, int is_sys_side, soc_phy_control_t type, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_phy_get_f) (int unit, soc_port_t port, uint32 flags, uint32 phy_reg_addr, uint32 *phy_data);
typedef shr_error_e (*mbcm_dnx_port_phy_set_f) (int unit, soc_port_t port, uint32 flags, uint32 phy_reg_addr, uint32 phy_data);
typedef shr_error_e (*mbcm_dnx_port_phy_modify_f) (int unit, soc_port_t port, uint32 flags, uint32 phy_reg_addr, uint32 phy_data, uint32 phy_mask);
typedef shr_error_e (*mbcm_dnx_port_mac_sa_set_f) (int unit, int port, sal_mac_addr_t mac_sa);
typedef shr_error_e (*mbcm_dnx_port_mac_sa_get_f) (int unit, int port, sal_mac_addr_t mac_sa);
typedef shr_error_e (*mbcm_dnx_port_eee_enable_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_enable_set_f)(int unit, soc_port_t port, uint32 value);
typedef shr_error_e (*mbcm_dnx_port_eee_tx_idle_time_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_tx_idle_time_set_f)(int unit, soc_port_t port, uint32 value);
typedef shr_error_e (*mbcm_dnx_port_eee_tx_wake_time_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_tx_wake_time_set_f)(int unit, soc_port_t port, uint32 value);
typedef shr_error_e (*mbcm_dnx_port_eee_link_active_duration_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_link_active_duration_set_f)(int unit, soc_port_t port, uint32 value);

typedef shr_error_e (*mbcm_dnx_port_eee_statistics_clear_f)(int unit, soc_port_t port);
typedef shr_error_e (*mbcm_dnx_port_eee_event_count_symmetric_set_f)(int unit, soc_port_t port, uint32 value);
typedef shr_error_e (*mbcm_dnx_port_eee_tx_event_count_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_tx_duration_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_rx_event_count_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_rx_duration_get_f)(int unit, soc_port_t port, uint32 *value);
typedef shr_error_e (*mbcm_dnx_port_eee_event_count_symmetric_get_f)(int unit, soc_port_t port, uint32 *value);


typedef shr_error_e (* mbcm_dnx_fc_enables_set_f)(
    DNX_SAND_IN int                           unit,
    DNX_SAND_IN SOC_DNX_FC_ENABLE_BITMAP      *cfc_enables,
    DNX_SAND_IN SOC_DNX_FC_ENABLE_BITMAP      *ena_info
    );

typedef shr_error_e (* mbcm_dnx_fc_enables_get_f)(
    DNX_SAND_IN int                           unit,
    DNX_SAND_IN SOC_DNX_FC_ENABLE_BITMAP      *cfc_enables,
    DNX_SAND_OUT SOC_DNX_FC_ENABLE_BITMAP     *ena_info
    );

typedef shr_error_e (* mbcm_dnx_fc_ilkn_mub_channel_set_f)(
    DNX_SAND_IN  int                            unit,
...
typedef shr_error_e (* mbcm_dnx_fc_ilkn_mub_channel_get_f)(
    DNX_SAND_IN  int                            unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID           ilkn_ndx,
    DNX_SAND_IN  SOC_DNX_FC_DIRECTION           direction_ndx,
    DNX_SAND_OUT uint8                          *bitmap
...
typedef shr_error_e (* mbcm_dnx_fc_ilkn_mub_gen_cal_set_f)(
    DNX_SAND_IN  int                           unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID             ilkn_ndx,
    DNX_SAND_IN  SOC_DNX_FC_ILKN_MUB_GEN_CAL      *cal_info
    );

typedef shr_error_e (* mbcm_dnx_fc_ilkn_mub_gen_cal_get_f)(
    DNX_SAND_IN  int                           unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID             ilkn_ndx,
...
typedef shr_error_e (* mbcm_dnx_fc_cat_2_tc_hcfc_bitmap_set_f)(
    DNX_SAND_IN   int                           unit,
    DNX_SAND_IN   int                           core,
    DNX_SAND_IN   int                           tc,
...
typedef shr_error_e (* mbcm_dnx_fc_cat_2_tc_hcfc_bitmap_get_f)(
    DNX_SAND_IN   int                           unit,
    DNX_SAND_IN   int                           core,
    DNX_SAND_IN   int                           tc,
    DNX_SAND_IN   int                           is_ocb_only,
...
typedef shr_error_e (* mbcm_dnx_fc_glb_hcfc_bitmap_set_f)(
    DNX_SAND_IN   int                           unit,
    DNX_SAND_IN   int                           core,
    DNX_SAND_IN   int                           is_high_prio,
    DNX_SAND_IN   int                           is_ocb_only,
...
typedef shr_error_e (* mbcm_dnx_fc_glb_hcfc_bitmap_get_f)(
    DNX_SAND_IN   int                           unit,
    DNX_SAND_IN   int                           core,
    DNX_SAND_IN   int                           is_high_prio,
    DNX_SAND_IN   int                           is_ocb_only,
...
typedef shr_error_e (* mbcm_dnx_fc_inbnd_mode_set_f)(
    DNX_SAND_IN int                           unit,
    DNX_SAND_IN soc_port_t                    port,
...
typedef shr_error_e (* mbcm_dnx_fc_inbnd_mode_get_f)(
    DNX_SAND_IN int                           unit,
    DNX_SAND_IN soc_port_t                    port,
    DNX_SAND_IN int                           is_generate,
...
typedef shr_error_e (* mbcm_dnx_fc_glb_rcs_mask_set_f)(
    DNX_SAND_IN int                           unit,
    DNX_SAND_IN int                           core,
    DNX_SAND_IN int                           is_high_prio,
    DNX_SAND_IN SOC_DNX_FC_GLB_RES_TYPE       glb_res_dst,
    DNX_SAND_IN uint32                        glb_res_src_bitmap
    );

typedef shr_error_e (* mbcm_dnx_fc_glb_rcs_mask_get_f)(
      DNX_SAND_IN int                           unit,
      DNX_SAND_IN int                           core,
      DNX_SAND_IN int                           is_high_prio,
      DNX_SAND_IN SOC_DNX_FC_GLB_RES_TYPE       glb_res_dst,
...
typedef shr_error_e (* mbcm_dnx_fc_init_pfc_mapping_f)(
      DNX_SAND_IN int  unit
    );

typedef shr_error_e (* mbcm_dnx_fc_ilkn_llfc_set_f)(
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID          ilkn_ndx,
    DNX_SAND_IN  SOC_DNX_FC_DIRECTION             direction_ndx,
    DNX_SAND_IN  SOC_DNX_FC_ILKN_LLFC_INFO        *info
  );

typedef shr_error_e (* mbcm_dnx_fc_ilkn_llfc_get_f) (
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  SOC_DNX_FC_CAL_IF_ID             ilkn_ndx,
    DNX_SAND_OUT SOC_DNX_FC_ILKN_LLFC_INFO           *rec_info,
    DNX_SAND_OUT SOC_DNX_FC_ILKN_LLFC_INFO           *gen_info
  );

typedef shr_error_e (* mbcm_dnx_port_ipg_set_f) (
    DNX_SAND_IN int         unit,
    DNX_SAND_IN soc_port_t  port,
    DNX_SAND_IN int         ipg
  );

typedef shr_error_e (* mbcm_dnx_port_ipg_get_f) (
    DNX_SAND_IN  int         unit,
    DNX_SAND_IN  soc_port_t  port,
    DNX_SAND_OUT int         *ipg
  );

typedef shr_error_e (* mbcm_dnx_port_link_get_f) (
    int unit, 
    int port, 
    int* link
  );

typedef shr_error_e (*mbcm_dnx_port_autoneg_set_f) (
    int                      unit,
    soc_port_t               port,
    int                      autoneg_en
  );

typedef shr_error_e (*mbcm_dnx_port_autoneg_get_f) (
    int                      unit,
    soc_port_t               port,
    int                      *autoneg_en
  );

typedef shr_error_e (*mbcm_dnx_port_ability_local_get_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_ability_t       *ability_mask
  );

typedef shr_error_e (*mbcm_dnx_port_ability_remote_get_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_ability_t       *ability_mask
  );

typedef shr_error_e (*mbcm_dnx_port_ability_advert_set_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_ability_t       *ability_mask
  );

typedef shr_error_e (*mbcm_dnx_port_ability_advert_get_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_ability_t       *ability_mask
  );

typedef shr_error_e (*mbcm_dnx_port_mdix_set_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_mdix_t          mode
  );

typedef shr_error_e (*mbcm_dnx_port_mdix_get_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_mdix_t          *mode
  );

typedef shr_error_e (*mbcm_dnx_port_mdix_status_get_f) (
    int                      unit,
    soc_port_t               port,
    soc_port_mdix_status_t   *status
  );

typedef shr_error_e (*mbcm_dnx_port_duplex_set_f) (
    int                      unit,
    soc_port_t               port,
    int                      duplex
  );

typedef shr_error_e (*mbcm_dnx_port_duplex_get_f) (
    int                      unit,
    soc_port_t               port,
    int                      *duplex
  );

typedef shr_error_e (*mbcm_dnx_port_nif_nof_lanes_get_f) (
    int                 unit, 
...
typedef shr_error_e (*mbcm_dnx_port_nif_quad_to_core_validate_f) (
    int                 unit
  );

typedef shr_error_e (*mbcm_dnx_port_close_path_f)(
    int                 unit,
    soc_port_t          port
  );

typedef shr_error_e (* mbcm_dnx_fc_hcfc_watchdog_set_f) (
    DNX_SAND_IN   int                           unit,
    DNX_SAND_IN   SOC_DNX_FC_CAL_IF_ID          if_ndx,
    DNX_SAND_IN   SOC_DNX_FC_HCFC_WATCHDOG      *hcfc_watchdog
  );

typedef shr_error_e (* mbcm_dnx_fc_hcfc_watchdog_get_f) (
    DNX_SAND_IN   int                           unit,
    DNX_SAND_IN   SOC_DNX_FC_CAL_IF_ID          if_ndx,
    DNX_SAND_OUT  SOC_DNX_FC_HCFC_WATCHDOG      *hcfc_watchdog
  );

typedef shr_error_e (*mbcm_dnx_port_fault_get_f) (
    int                      unit,
    soc_port_t               port,
    uint32                   *flags
  );

typedef shr_error_e (*mbcm_dnx_fabric_link_fault_get_f) (
    int                      unit,
    soc_port_t               link,
    uint32                   *flags
  );

typedef shr_error_e (*mbcm_dnx_stat_if_queue_range_set_f) (
    int                      unit,
    int                      sif_port,
    int                      is_scrubber,
    int                      min_queue,
...
typedef shr_error_e (*mbcm_dnx_stat_if_queue_range_get_f) (
    int                      unit,
    int                      sif_port,
    int                      is_scrubber,
    int*                     min_queue,
...
typedef shr_error_e (*mbcm_dnx_fc_vsq_index_group2global_f) (
    DNX_SAND_IN int                    unit,
    DNX_SAND_IN  SOC_DNX_ITM_VSQ_GROUP vsq_group,
    DNX_SAND_IN  uint32                vsq_in_group_ndx,
    DNX_SAND_IN  int                   cosq,
...
typedef shr_error_e (*mbcm_dnx_stat_oversize_set_f) (
    int                      unit,
    int                      port,
    int                      val
  );

typedef shr_error_e (*mbcm_dnx_stat_oversize_get_f) (
    int                      unit,
    int                      port,
    int                      *val
  );

typedef shr_error_e (*mbcm_dnx_fc_status_info_get_f) (
    DNX_SAND_IN int                      unit,
    DNX_SAND_IN SOC_DNX_FC_STATUS_KEY   *fc_status_key,
    DNX_SAND_OUT SOC_DNX_FC_STATUS_INFO *fc_status_info
  );

typedef shr_error_e (*mbcm_dnx_stat_counter_filter_set_f) (
    DNX_SAND_IN     int                             unit, 
    DNX_SAND_IN     SOC_DNX_CNT_SOURCE*             source,
    DNX_SAND_IN     SOC_DNX_CNT_FILTER_TYPE*        filter_array, 
    DNX_SAND_IN     int                             filter_count,
    DNX_SAND_IN     int                             is_active
  );

typedef shr_error_e (*mbcm_dnx_stat_counter_filter_get_f) (
    DNX_SAND_IN     int                             unit, 
    DNX_SAND_IN     SOC_DNX_CNT_SOURCE*             source,
    DNX_SAND_IN     int                             filter_max_count,
    DNX_SAND_OUT    SOC_DNX_CNT_FILTER_TYPE*        filter_array, 
    DNX_SAND_OUT    int*                            filter_count
  );

typedef shr_error_e (*mbcm_dnx_cnt_ingress_compensation_profile_delta_set_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
...
typedef shr_error_e (*mbcm_dnx_cnt_ingress_compensation_port_profile_set_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
...
typedef shr_error_e (*mbcm_dnx_cnt_ingress_compensation_outLif_delta_set_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
    DNX_SAND_IN  int                   commandId,
    DNX_SAND_IN  int                   src_type,
...
typedef shr_error_e (*mbcm_dnx_cnt_ingress_compensation_outLif_delta_get_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
    DNX_SAND_IN  int                   commandId,
    DNX_SAND_IN  int                   src_type,
...
typedef shr_error_e (*mbcm_dnx_cnt_ingress_compensation_port_delta_and_profile_get_f) (
    DNX_SAND_IN  int                   unit,
    DNX_SAND_IN  int                   core,
    DNX_SAND_IN  int                   commandId,
    DNX_SAND_IN  int                   src_type,
...
typedef uint32 (* mbcm_dnx_cnt_counter_bmap_mem_by_src_type_get_f)(    
    ...
    DNX_SAND_IN  SOC_DNX_CNT_SRC_TYPE     src_type,
...
typedef int (* mbcm_dnx_cnt_stif_ingress_pp_source_set_f)(
    DNX_SAND_IN int unit,
    DNX_SAND_IN int command_id, 
    DNX_SAND_IN SOC_DNX_CNT_MODE_EG_TYPE eg_type, 
    DNX_SAND_IN int counter_base
);

typedef shr_error_e (*mbcm_dnx_fc_pfc_generic_bitmap_valid_update_f) (
    DNX_SAND_IN   int                               unit,
...
typedef shr_error_e (*mbcm_dnx_fc_pfc_generic_bitmap_used_update_f) (
    DNX_SAND_IN   int                               unit,
    DNX_SAND_IN   SOC_DNX_FC_PFC_GEN_BMP_SRC_TYPE   src_type,
    DNX_SAND_IN   int                               priority,
...
typedef shr_error_e (*mbcm_dnx_port_quad_get_f) (
    DNX_SAND_IN     int                             unit,
    DNX_SAND_IN     soc_port_t                      port,
    DNX_SAND_OUT    soc_pbmp_t*                     quad_bmp
  );

typedef shr_error_e (*mbcm_dnx_port_ports_to_same_quad_get_f) (
    DNX_SAND_IN     int                             unit,
    DNX_SAND_IN     soc_port_t                      port,
    DNX_SAND_OUT    soc_pbmp_t*                     ports
  );

typedef shr_error_e (*mbcm_dnx_nif_priority_set_f) (
    DNX_SAND_IN     int                             unit,
    DNX_SAND_IN     int                             core,
...
typedef shr_error_e (*mbcm_dnx_nif_priority_get_f) (
    DNX_SAND_IN     int                             unit,
    DNX_SAND_IN     int                             core,
    DNX_SAND_IN     uint32                          quad_ilkn,
    DNX_SAND_IN     uint32                          is_ilkn,
...
typedef shr_error_e (*mbcm_dnx_fabric_link_config_ovrd_f) (
    int                             unit
  );
...
typedef shr_error_e (*mbcm_dnx_device_reset_f) (
      DNX_SAND_IN int   unit,
      DNX_SAND_IN int   mode,
      DNX_SAND_IN int   action
      );

typedef shr_error_e (*mbcm_dnx_fc_cmic_rx_set_f) (
      DNX_SAND_IN int                           unit,
      DNX_SAND_IN soc_port_t                    port,
...
typedef shr_error_e (*mbcm_dnx_fc_cmic_rx_get_f) (
      DNX_SAND_IN int                           unit,
      DNX_SAND_IN soc_port_t                    port,
...
typedef shr_error_e (*mbcm_dnx_mult_get_entry_f) (
      DNX_SAND_IN int                           unit,
...
typedef struct mbcm_dnx_functions_s {
    ...
    mbcm_dnx_fmac_block_enable_get_f              mbcm_dnx_fmac_block_enable_get;
    mbcm_dnx_fabric_link_force_signal_set_f       mbcm_dnx_fabric_link_force_signal_set;
    mbcm_dnx_fabric_link_mac_init_f               mbcm_dnx_fabric_link_mac_init;
    mbcm_dnx_fabric_mac_init_f                    mbcm_dnx_fabric_mac_init;
    mbcm_dnx_fabric_aluwp_init_f                  mbcm_dnx_fabric_aluwp_init;
    mbcm_dnx_fabric_transmit_init_f               mbcm_dnx_fabric_transmit_init;
    mbcm_dnx_fabric_multicast_init_f              mbcm_dnx_fabric_multicast_init;
    mbcm_dnx_fabric_scheduler_adaptation_init_f   mbcm_dnx_fabric_scheduler_adaptation_init;
    mbcm_dnx_fabric_interleaving_init_f           mbcm_dnx_fabric_interleaving_init;
    mbcm_dnx_fabric_dtqs_contexts_init_f          mbcm_dnx_fabric_dtqs_contexts_init;
    ...
    mbcm_dnx_sys_virtual_port_to_local_port_map_set_f mbcm_dnx_sys_virtual_port_to_local_port_map_set; 
    /* ssr functions */ 
    ...
    mbcm_dnx_fabric_link_status_get_f             mbcm_dnx_fabric_link_status_get; 
    ...
    mbcm_dnx_fabric_minimal_links_to_dest_init_f  mbcm_dnx_fabric_minimal_links_to_dest_init;
    ...
    mbcm_dnx_fabric_port_enable_set_f             mbcm_dnx_fabric_port_enable_set;
    mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_init_f mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_init;
    mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_enable_set_f mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_enable_set;
    mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_enable_get_f mbcm_dnx_fabric_delay_single_cell_in_fabric_rx_enable_get;
    ...
    mbcm_dnx_fabric_load_balance_init_f           mbcm_dnx_fabric_load_balance_init;
    ...
    mbcm_dnx_fabric_reachability_status_get_f       mbcm_dnx_fabric_reachability_status_get;
    ...
    mbcm_dnx_port_rate_egress_ppt_set_f           mbcm_dnx_port_rate_egress_ppt_set;
    mbcm_dnx_port_rate_egress_ppt_get_f           mbcm_dnx_port_rate_egress_ppt_get;
    ...
    mbcm_dnx_fsrd_blocks_low_power_init_f         mbcm_dnx_fsrd_blocks_low_power_init;
    mbcm_dnx_port_fsrd_block_enable_set_f         mbcm_dnx_port_fsrd_block_enable_set;
    mbcm_dnx_fsrd_block_enable_set_f              mbcm_dnx_fsrd_block_enable_set;
    /* mgmt functions */ 
    ...
    mbcm_dnx_nif_synce_clk_squelch_set_f          mbcm_dnx_nif_synce_clk_squelch_set;
    mbcm_dnx_nif_synce_clk_squelch_get_f          mbcm_dnx_nif_synce_clk_squelch_get;
    ...
    mbcm_dnx_egr_queuing_sch_unsch_drop_get_f     mbcm_dnx_egr_queuing_sch_unsch_drop_get;
    ...
    mbcm_dnx_egr_queuing_is_high_priority_queue_get_f         mbcm_dnx_egr_queuing_is_high_priority_queue_get;
...
extern int mbcm_dnx_deinit(int unit);

/* The argument should be in parentheses and to include the unit, i.e. (unit, arg1, arg2, ...) */
#define MBCM_DNX_DRIVER_CALL(unit, function, args) (((unit < BCM_MAX_NUM_UNITS) && mbcm_dnx_driver[unit] && mbcm_dnx_driver[unit]->function)?mbcm_dnx_driver[unit]->function args:_SHR_E_UNAVAIL)
...
#define MBCM_DNX_DRIVER_CALL_WITHOUT_DEV_ID(unit, function, args) ((mbcm_dnx_driver[unit] && mbcm_dnx_driver[unit]->function)?mbcm_dnx_driver[unit]->function args:_SHR_E_UNAVAIL)

/* The argumnet should be in parentheses and to include the unit, i.e. (unit, arg1, arg2, ...) */
#define MBCM_DNX_SOC_DRIVER_CALL(unit, function, args) (((unit < BCM_MAX_NUM_UNITS) && mbcm_dnx_driver[unit] && mbcm_dnx_driver[unit]->function)?mbcm_dnx_driver[unit]->function args: _SHR_E_UNAVAIL)

/* 
 * The argumnet should be in parentheses and to include the unit, i.e. (unit, arg1, arg2, ...).
 * The macro will return _SHR_E_UNAVAIL if the unit does not have a driver structure                                                                            .
 * The macro will return _SHR_E_NONE if the unit has a driver structure, but no implementation of the specified function.
 */
#define MBCM_DNX_SOC_DRIVER_CALL_ALLOW_NULL(unit, function, args) (((unit < BCM_MAX_NUM_UNITS) && mbcm_dnx_driver[unit]) ? (mbcm_dnx_driver[unit]->function ? mbcm_dnx_driver[unit]->function args : _SHR_E_NONE) : _SHR_E_UNAVAIL)

/*
 *  This macro will complain _SHR_E_UNAVAIL if the referenced unit does not
 *  have an SBX mbcm_sbx_driver structure, will return _SHR_E_NONE if the
