/** \file dnx/swstate/auto_generated/types/lif_mngr_types.h
 *
...
typedef struct {
     ...
     */
    sw_state_algo_res_t symmetric_global_lif;
    /**
     * sw state resource variable for the Ingress global lif.
     */
    sw_state_algo_res_t ingress_global_lif;
    /**
     * sw state resource variable for the Egress global lif.
     */
    sw_state_algo_res_t egress_global_lif;
    /**
...
typedef struct {
     ...
     */
    sw_state_algo_res_t* egress_local_lif;
} lif_mngr_sw_state_t;
