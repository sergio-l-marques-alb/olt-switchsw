/** \file dnx/swstate/auto_generated/types/meter_types.h
 *
...
typedef struct {
     ...
     */
    dnx_policer_bank_info_t banks_arr[12];
...
typedef struct {
     ...
     */
    sw_state_algo_template_t policer_ingress_db0;
    /**
     * meter ingress database-1 profiles
     */
    sw_state_algo_template_t policer_ingress_db1;
    /**
     * meter ingress database-2 profiles
     */
    sw_state_algo_template_t policer_ingress_db2;
    /**
     * meter egress database-0 profiles
     */
    sw_state_algo_template_t policer_egress_db0;
    /**
     * meter egress database-1 profiles
     */
    sw_state_algo_template_t policer_egress_db1;
} policer_template_t;
