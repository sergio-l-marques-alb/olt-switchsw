...
int example_my_array_dump(
    int unit, int my_array_idx_0);

int example_two_dimentional_array_dump(
    int unit, int index_1, int index_2);

int example_dynamic_array_dump(
    int unit, int dynamic_array_idx_0);

int example_dynamic_dynamic_array_dump(
    int unit, int first_d_index, int dynamic_index);

int example_dynamic_array_static_dump(
    int unit, int dynamic_index, int static_index);
...
int example_DNXData_array_alloc_exception_dump(
    int unit, int DNXData_array_alloc_exception_idx_0);

int example_DNXData_array_dump(
    int unit, int DNXData_array_idx_0);

int example_DNXData_array_dyn_dnxdata_dump(
    int unit, int DNXData_array_dyn_dnxdata_idx_0, int DNXData_array_dyn_dnxdata_idx_1);

int example_DNXData_array_dnxdata_dyn_dump(
    int unit, int DNXData_array_dnxdata_dyn_idx_0, int DNXData_array_dnxdata_dyn_idx_1);

int example_DNXData_array_dnxdata_dnxdata_dump(
    int unit, int DNXData_array_dnxdata_dnxdata_idx_0, int DNXData_array_dnxdata_dnxdata_idx_1);

int example_DNXData_array_static_dnxdata_dyn_dump(
    int unit, int DNXData_array_static_dnxdata_dyn_idx_0, int DNXData_array_static_dnxdata_dyn_idx_1, int DNXData_array_static_dnxdata_dyn_idx_2);

int example_DNXData_array_static_dyn_dnxdata_dump(
    int unit, int DNXData_array_static_dyn_dnxdata_idx_0, int DNXData_array_static_dyn_dnxdata_idx_1, int DNXData_array_static_dyn_dnxdata_idx_2);

int example_DNXData_array_static_dnxdata_dnxdata_dump(
    int unit, int DNXData_array_static_dnxdata_dnxdata_idx_0, int DNXData_array_static_dnxdata_dnxdata_idx_1, int DNXData_array_static_dnxdata_dnxdata_idx_2);

int example_DNXData_array_table_data_dump(
    int unit, int DNXData_array_table_data_idx_0);

int example_value_range_test_dump(
    int unit);

int example_array_range_example_dump(
    int unit, int array_range_example_idx_0);

int example_alloc_after_init_variable_dump(
    int unit, int alloc_after_init_variable_idx_0);

int example_alloc_after_init_test_dump(
    int unit, int alloc_after_init_test_idx_0);

int example_pointer_dump(
    int unit);

int example_bitmap_variable_dump(
    int unit, int bitmap_variable_idx_0);

int example_pbmp_variable_dump(
    int unit);

int example_bitmap_fixed_dump(
    int unit, int bitmap_fixed_idx_0);

int example_bitmap_dnx_data_dump(
    int unit, int bitmap_dnx_data_idx_0);

int example_buffer_dump(
    int unit, int buffer_idx_0);

int example_buffer_fixed_dump(
    int unit, int buffer_fixed_idx_0);

int example_bitmap_exclude_example_dump(
    int unit, int bitmap_exclude_example_idx_0);

int example_default_value_tree_dump(
    int unit);

int example_default_value_tree_array_dnxdata_dump(
    int unit, int array_dnxdata_idx_0);

int example_default_value_tree_array_dnxdata_array_dynamic_dump(
    int unit, int array_dnxdata_idx_0, int array_dynamic_idx_0);

int example_default_value_tree_array_dnxdata_array_dynamic_array_static_static_dump(
    int unit, int array_dnxdata_idx_0, int array_dynamic_idx_0, int array_static_static_idx_0, int array_static_static_idx_1);
...
int example_default_value_tree_array_dnxdata_array_pointer_array_static_static_dump(
    int unit, int array_dnxdata_idx_0, int array_static_static_idx_0, int array_static_static_idx_1);
...
int example_leaf_struct_buff_variable_dump(
    int unit, int buff_variable_idx_0);

int example_multi_set_example_dump(
    int unit);

int example_defragmented_chunk_example_dump(
    int unit, int defragmented_chunk_example_idx_0);
...
int example_res_tag_bitmap_test_dump(
    int unit);

int example_algo_res_dump(
    int unit);
...
int example_alloc_child_check_dump(
    int unit, int alloc_child_check_idx_0);

int example_alloc_child_check_static_array_of_p_dump(
    int unit, int alloc_child_check_idx_0, int static_array_of_p_idx_0, int static_array_of_p_idx_1);

int example_alloc_child_check_static_array_dump(
    int unit, int alloc_child_check_idx_0, int static_array_idx_0);
...
int example_large_DS_examples_large_multi_set_example_dump(
    int unit);
...
int example_large_DS_examples_large_res_tag_bitmap_test_dump(
    int unit);

int example_large_DS_examples_large_algo_res_dump(
    int unit);
