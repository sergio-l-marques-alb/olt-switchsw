/** \file dnx/swstate/auto_generated/access/dnx_mirror_access.h
 *
...
typedef int (*dnx_mirror_db_snif_ingress_profiles_mirror_set_cb)(
    int unit, sw_state_algo_res_t snif_ingress_profiles_mirror);
...
typedef int (*dnx_mirror_db_snif_ingress_profiles_snoop_set_cb)(
    int unit, sw_state_algo_res_t snif_ingress_profiles_snoop);
...
typedef int (*dnx_mirror_db_snif_ingress_profiles_stat_sampling_set_cb)(
    int unit, sw_state_algo_res_t snif_ingress_profiles_stat_sampling);
...
typedef int (*dnx_mirror_db_snif_egress_vlan_profiles_mirror_set_cb)(
    int unit, sw_state_algo_template_t snif_egress_vlan_profiles_mirror);
...
typedef int (*dnx_mirror_db_snif_egress_vlan_profiles_mirror_allocate_single_cb)(
    int unit, int core_id, uint32 flags, bcm_vlan_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*dnx_mirror_db_snif_egress_vlan_profiles_mirror_profile_get_cb)(
    int unit, int core_id, const bcm_vlan_t *profile_data, int *profile);
...
typedef int (*dnx_mirror_db_snif_ingress_vlan_profiles_mirror_set_cb)(
    int unit, sw_state_algo_template_t snif_ingress_vlan_profiles_mirror);
