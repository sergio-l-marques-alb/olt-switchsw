/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_tcam_location_diagnostic.h
 *
...
int dnx_field_tcam_location_sw_tcam_handlers_info_dump(
    int unit, int tcam_handlers_info_idx_0);

int dnx_field_tcam_location_sw_tcam_handlers_info_entries_occupation_bitmap_dump(
    int unit, int tcam_handlers_info_idx_0, int entries_occupation_bitmap_idx_0);

int dnx_field_tcam_location_sw_tcam_handlers_info_priorities_range_dump(
    int unit, int tcam_handlers_info_idx_0, int priorities_range_idx_0);

int dnx_field_tcam_location_sw_tcam_banks_occupation_bitmap_dump(
    int unit, int tcam_banks_occupation_bitmap_idx_0);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_FIELD_TCAM_LOCATION_DIAGNOSTIC_H__ */
