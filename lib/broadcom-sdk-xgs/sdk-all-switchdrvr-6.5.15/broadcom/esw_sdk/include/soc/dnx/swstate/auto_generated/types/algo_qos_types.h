/** \file dnx/swstate/auto_generated/types/algo_qos_types.h
 *
...
typedef struct {
     ...
     * INGRESS QOS
     */
    sw_state_algo_res_t ingress_qos;
    /**
     * INGRESS QOS ECN
     */
    sw_state_algo_res_t ingress_qos_ecn;
    /**
     * INGRESS QOS PHB OPCODE
     */
    sw_state_algo_res_t ingress_qos_phb_opcode;
    /**
     * INGRESS QOS REMARK_OPCODE
     */
    sw_state_algo_res_t ingress_qos_remark_opcode;
    /**
     * INGRESS QOS ECN OPCODE
     */
    sw_state_algo_res_t ingress_qos_ecn_opcode;
    /**
     * INGRESS QOS POLICER
     */
    sw_state_algo_res_t ingress_qos_policer;
    /**
     * INGRESS QOS VLAN PCP
     */
    sw_state_algo_res_t ingress_qos_vlan_pcp;
    /**
     * EGRESS QOS
     */
    sw_state_algo_res_t egress_qos;
    /**
     * EGRESS QOS OPCODE
     */
    sw_state_algo_res_t egress_qos_opcode;
    /**
     * EGRESS QOS MPLS PHP
     */
    sw_state_algo_res_t egress_qos_mpls_php;
    /**
     * EGRESS QOS PHP OPCODE
     */
    sw_state_algo_res_t egress_qos_php_opcode;
    /**
     * EGRESS QOS POLICER
     */
    sw_state_algo_res_t egress_qos_policer;
    /**
     * EGRESS QOS OAM PRIORITY MAP
     */
    sw_state_algo_res_t egress_qos_oam_pcp_map;
    /**
     * EGRESS QOS TTL PIPE PROFILE TEMPLATE
     */
    sw_state_algo_template_t qos_egress_ttl_pipe_profile;
    /**
     * INGRESS PROPAGATION PROFILE TEMPLATE
     */
    sw_state_algo_template_t qos_ingress_propagation_profile;
    /**
     * EGRESS NETWORK_QOS PROFILE TEMPLATE
     */
    sw_state_algo_template_t qos_egress_network_qos_profile;
} algo_qos_sw_state_t;
