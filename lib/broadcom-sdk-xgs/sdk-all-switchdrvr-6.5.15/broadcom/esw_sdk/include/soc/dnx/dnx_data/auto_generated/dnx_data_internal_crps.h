...
typedef enum
{
    ...
    dnx_data_crps_submodule_filter,
 ...
 *   * None
 */
int dnx_data_crps_filter_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_crps_filter_define_nof_drop_reasons,

    /**
     * Must be last one!
     */
    _dnx_data_crps_filter_define_nof
} dnx_data_crps_filter_define_e;
 ...
 *   * None
 */
uint32 dnx_data_crps_filter_nof_drop_reasons_get(
    int unit);
...
typedef enum
{
    dnx_data_crps_filter_table_drop_reason_groups,

    /**
     * Must be last one!
     */
    _dnx_data_crps_filter_table_nof
} dnx_data_crps_filter_table_e;
 ...
 *   * None
 */
const dnx_data_crps_filter_drop_reason_groups_t * dnx_data_crps_filter_drop_reason_groups_get(
    int unit,
    int name);
 ...
 *   * None
 */
shr_error_e dnx_data_crps_filter_drop_reason_groups_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)drop_reason_groups info
 * filter data - mask and profile_id values per filter group
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     drop_reason_groups - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
const dnxc_data_table_info_t * dnx_data_crps_filter_drop_reason_groups_info_get(
    int unit);
