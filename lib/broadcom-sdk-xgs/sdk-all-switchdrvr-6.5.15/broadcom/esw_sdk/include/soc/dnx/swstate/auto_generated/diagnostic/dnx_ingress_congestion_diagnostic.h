/** \file dnx/swstate/auto_generated/diagnostic/dnx_ingress_congestion_diagnostic.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/dnx_ingress_congestion_types.h>
...
typedef enum {
    ...
    DNX_INGRESS_CONGESTION_DB_PORT_BASED_VSQ_VSQ_F_MAPPING_PG_NUMQ_INFO,
...
int dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_dump(
    int unit, int port_based_vsq_idx_0, int vsq_f_mapping_idx_0);

int dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_dump(
    int unit, int port_based_vsq_idx_0, int vsq_f_mapping_idx_0);
...
int dnx_ingress_congestion_db_dram_thresholds_dump(
    int unit, int dram_thresholds_idx_0);

int dnx_ingress_congestion_db_dram_thresholds_dram_bound_thresholds_dump(
    int unit, int dram_thresholds_idx_0, int dram_bound_thresholds_idx_0);

int dnx_ingress_congestion_db_dram_thresholds_dram_recovery_fail_thresholds_dump(
    int unit, int dram_thresholds_idx_0, int dram_recovery_fail_thresholds_idx_0);
...
int dnx_ingress_congestion_db_fadt_tail_drop_thresholds_dump(
    int unit, int fadt_tail_drop_thresholds_idx_0);

int dnx_ingress_congestion_db_fadt_tail_drop_thresholds_resource_dump(
    int unit, int fadt_tail_drop_thresholds_idx_0, int resource_idx_0);

int dnx_ingress_congestion_db_fadt_tail_drop_thresholds_resource_dp_dump(
    int unit, int fadt_tail_drop_thresholds_idx_0, int resource_idx_0, int dp_idx_0);
