...
/**
 * implemented by: dnx_ofp_rate_db_qpair_burst_set
 */
typedef int (*dnx_ofp_rate_db_qpair_burst_set_cb)(
    int unit, uint32 qpair_idx_0, uint32 qpair_idx_1, uint32 burst);

/**
 * implemented by: dnx_ofp_rate_db_qpair_burst_get
 */
typedef int (*dnx_ofp_rate_db_qpair_burst_get_cb)(
    int unit, uint32 qpair_idx_0, uint32 qpair_idx_1, uint32 *burst);
...
/**
 * implemented by: dnx_ofp_rate_db_tcg_burst_set
 */
typedef int (*dnx_ofp_rate_db_tcg_burst_set_cb)(
    int unit, uint32 tcg_idx_0, uint32 tcg_idx_1, uint32 tcg_idx_2, uint32 burst);

/**
 * implemented by: dnx_ofp_rate_db_tcg_burst_get
 */
typedef int (*dnx_ofp_rate_db_tcg_burst_get_cb)(
    int unit, uint32 tcg_idx_0, uint32 tcg_idx_1, uint32 tcg_idx_2, uint32 *burst);
...
/**
 * implemented by: dnx_ofp_rate_db_shaper_enable_set
 */
typedef int (*dnx_ofp_rate_db_shaper_enable_set_cb)(
    int unit, uint32 shaper_enable);

/**
 * implemented by: dnx_ofp_rate_db_shaper_enable_get
 */
typedef int (*dnx_ofp_rate_db_shaper_enable_get_cb)(
    int unit, uint32 *shaper_enable);
...
/**
 * This structure holds the access functions for the variable dnx_ofp_rate_db_shaping_t
 */
typedef struct {
    /**
 ...
 */
typedef struct {
    dnx_ofp_rate_db_qpair_burst_set_cb set;
    dnx_ofp_rate_db_qpair_burst_get_cb get;
} dnx_ofp_rate_db_qpair_burst_cbs;
...
typedef struct {
     ...
     * Access struct for burst
     */
    dnx_ofp_rate_db_qpair_burst_cbs burst;
    /**
     * Access struct for valid
     */
 ...
 */
typedef struct {
    dnx_ofp_rate_db_tcg_burst_set_cb set;
    dnx_ofp_rate_db_tcg_burst_get_cb get;
} dnx_ofp_rate_db_tcg_burst_cbs;
...
typedef struct {
     ...
     * Access struct for burst
     */
    dnx_ofp_rate_db_tcg_burst_cbs burst;
    /**
     * Access struct for valid
     */
...
/**
 * This structure holds the access functions for the variable shaper_enable
 */
typedef struct {
    dnx_ofp_rate_db_shaper_enable_set_cb set;
    dnx_ofp_rate_db_shaper_enable_get_cb get;
} dnx_ofp_rate_db_shaper_enable_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for shaper_enable
     */
    dnx_ofp_rate_db_shaper_enable_cbs shaper_enable;
} dnx_ofp_rate_db_cbs;
