 ...
 */
/**
 * \brief Holds values of submodule hbm table mr_defaults
 * Table info:
...
typedef struct
{
     ...
     */
    uint32 value;
} dnx_data_dram_hbm_mr_defaults_t;
 ...
 */
typedef uint32(
    *dnx_data_dram_hbm_nof_hbms_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_dram_hbm_nof_channels_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_dram_hbm_mr_mask_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_dram_hbm_nof_mrs_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_dram_hbm_phy_address_mask_get_f) (
    int unit);
 ...
 *   * None
 */
typedef const dnx_data_dram_hbm_mr_defaults_t *(
    *dnx_data_dram_hbm_mr_defaults_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    /**
     * returns define data of nof_hbms
     */
    dnx_data_dram_hbm_nof_hbms_get_f nof_hbms_get;
    /**
     * returns define data of nof_channels
     */
    dnx_data_dram_hbm_nof_channels_get_f nof_channels_get;
    /**
     ...
     */
    dnx_data_dram_hbm_mr_mask_get_f mr_mask_get;
    /**
     * returns define data of nof_mrs
     */
    dnx_data_dram_hbm_nof_mrs_get_f nof_mrs_get;
    /**
     * returns define data of phy_address_mask
     */
    dnx_data_dram_hbm_phy_address_mask_get_f phy_address_mask_get;
    /**
     ...
     */
    dnx_data_dram_hbm_mr_defaults_get_f mr_defaults_get;
    /**
