...
#ifndef __SOC_DNX_API_EGR_QUEUING_INCLUDED__
/* { */
#define __SOC_DNX_API_EGR_QUEUING_INCLUDED__
 ...
 *************/
/* { */
#define SOC_DNX_EGR_OFP_SCH_WFQ_WEIGHT_MAX 255
#define SOC_DNX_NOF_EGR_QUEUING_MC_POOLS    (2) 
#define SOC_DNX_NOF_THRESH_TYPES            (16)
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_Q_PRIO_LOW=0,
  /*
   *  Egress priority for unscheduled traffic - high
   */
  SOC_DNX_EGR_Q_PRIO_HIGH=1,
  /*
   *  Number of egress priorities for unscheduled traffic - Soc_petra B.
   */
  SOC_DNX_EGR_NOF_Q_PRIO_PB=2,
  /*
   *  Egress priority in JER2_ARAD 0 - 7
   */
  SOC_DNX_EGR_Q_PRIO_0 = 0,
  SOC_DNX_EGR_Q_PRIO_1 = 1,
  SOC_DNX_EGR_Q_PRIO_2 = 2,
  SOC_DNX_EGR_Q_PRIO_3 = 3,
  SOC_DNX_EGR_Q_PRIO_4 = 4,
  SOC_DNX_EGR_Q_PRIO_5 = 5,
  SOC_DNX_EGR_Q_PRIO_6 = 6,
  SOC_DNX_EGR_Q_PRIO_7 = 7,
  /*
   *  Number of egress priorities for unscheduled traffic - JER2_ARAD.
   */
  SOC_DNX_EGR_NOF_Q_PRIO_JER2_ARAD,
  /*
   * All priorities: for thresholds set for High + Low priorities
   */
  SOC_DNX_EGR_Q_PRIO_ALL=0xFFFF
}SOC_DNX_EGR_Q_PRIO;
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_0=0,
  /*
   *  Port threshold type 1.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_1=1,
  /*
   *  Port threshold type 2.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_2=2,
  /*
   *  Port threshold type 3.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_3=3,
  /*
   *  Must be the last value. Indicates the number of threshold
   *  port types (for Soc_petra).
   */
  SOC_DNX_EGR_PORT_NOF_THRESH_TYPES_PETRA=4,
  /*
   *  Port threshold type 4.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_4=4,
  /*
   *  Port threshold type 5.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_5=5,
  /*
   *  Port threshold type 6.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_6=6,
  /*
   *  Port threshold type 7.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_7=7,
  /*
   *  Port threshold type 8.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_8=8,
  /*
   *  Port threshold type 9.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_9=9,
  /*
   *  Port threshold type 10.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_10=10,
  /*
   *  Port threshold type 11.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_11=11,
  /*
   *  Port threshold type 12.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_12=12,
  /*
   *  Port threshold type 13.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_13=13,
  /*
   *  Port threshold type 14.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_14=14,
  /*
   *  Port threshold type 15.
   */
  SOC_DNX_EGR_PORT_THRESH_TYPE_15=15,
  /*
   *  Must be the last value. Indicates the number of threshold
   *  port types (for JER2_ARAD).
   */
  SOC_DNX_EGR_PORT_NOF_THRESH_TYPES_JER2_ARAD = 16,
  SOC_DNX_EGR_PORT_NOF_THRESH_TYPES = 16
}SOC_DNX_EGR_PORT_THRESH_TYPE;
...
typedef enum
{
   ...
   *  control.
   */
  SOC_DNX_EGR_FC_MCI_ENABLE=0,
  /*
   *  Disable all MCI flow control
   */
  SOC_DNX_EGR_FC_MCI_DISABLE=1,
  /*
   ...
   *  disabled.
   */
  SOC_DNX_EGR_FC_MCI_ENABLE_ERP=2,
  /*
   *  Must be the last value.
   */
  SOC_DNX_EGR_FC_MCI_NOF_ENABLE_STATUSS=3
}SOC_DNX_EGR_FC_MCI_EN_STATUS;
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_OFP_INTERFACE_PRIO_HIGH=0,
  /*
   *  OFP priority - medium
   *  Not valid for JER2_ARAD.
   */
  SOC_DNX_EGR_OFP_INTERFACE_PRIO_MID=1,
  /*
   *  OFP priority - low
   */
  SOC_DNX_EGR_OFP_INTERFACE_PRIO_LOW=2,
  /*
   *  OFP priority - lowest.
   ...
   */
  SOC_DNX_EGR_OFP_INTERFACE_PRIO_PFC_LOWEST=3,
  /*
   *  Must be the last value. Indicates the number of OFP
   *  scheduling priorities.
   */
  SOC_DNX_EGR_OFP_CHNIF_NOF_PRIORITIES=4
}SOC_DNX_EGR_OFP_INTERFACE_PRIO;

/* $Id: jer2_jer2_jer2_tmc_api_egr_queuing.h,v 1.10 Broadcom SDK $
 *  Port priority - irrelevant, e.g. for ports mapped
 *  to non-channelized interfaces.
 */
#define SOC_DNX_EGR_OFP_INTERFACE_PRIO_NONE SOC_DNX_EGR_OFP_CHNIF_NOF_PRIORITIES;
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_HP_OVER_LP_PER_TYPE=1,
  /*
   *  All High Priority traffic (Scheduled and Unscheduled)
   ...
   */
  SOC_DNX_EGR_HP_OVER_LP_FAIR = 2,
  /*
   *  Must be the last value. Indicates the number of egress
   *  OFP scheduling modes
   */
  SOC_DNX_EGR_OFP_NOF_SCH_MODES = 3
}SOC_DNX_EGR_OFP_SCH_MODE;
...
typedef struct
{
   ...
   */
  uint32 queue_words_consumed[SOC_DNX_EGR_PORT_NOF_THRESH_TYPES];
  /*
   *  For entry with index 'i', threshold value for the number
   ...
   */
  uint32 queue_pkts_consumed[SOC_DNX_EGR_PORT_NOF_THRESH_TYPES];
    /*
   *  For entry with index 'i', threshold value for the number
   *  of total 32B packet descriptors in queues of type 'i',
  ...
  uint32 queue_pkts_consumed_min[SOC_DNX_EGR_PORT_NOF_THRESH_TYPES];

  uint32 queue_pkts_consumed_alpha[SOC_DNX_EGR_PORT_NOF_THRESH_TYPES];

}SOC_DNX_EGR_DROP_THRESH;
...
}SOC_DNX_EGR_FC_DEV_THRESH_INNER;
...
typedef struct
{
   ...
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER global;
  /*
   *  Thresholds for device scheduled egress resources
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER scheduled;
  /*
   *  Thresholds for device unscheduled egress resources
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER unscheduled;
  /*
   *  Thresholds per Service Pool for device unscheduled egress resources
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER unscheduled_pool[SOC_DNX_NOF_EGR_QUEUING_MC_POOLS]; 

}SOC_DNX_EGR_FC_DEVICE_THRESH;
...
typedef struct
{
   ...
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER mc;
}SOC_DNX_EGR_FC_OFP_THRESH;
...
typedef struct
{
   ...
   */
  SOC_DNX_EGR_OFP_INTERFACE_PRIO nif_priority;
  /*
   ...
   */
  SOC_DNX_EGR_OFP_SCH_WFQ ofp_wfq;
  /*
   ...
   */
  SOC_DNX_EGR_OFP_SCH_WFQ ofp_wfq_high;
   ...
   */
  SOC_DNX_EGR_OFP_SCH_WFQ ofp_wfq_q_pair[SOC_DNX_EGR_NOF_Q_PRIO_JER2_ARAD]; 

}SOC_DNX_EGR_OFP_SCH_INFO;
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_PORT_ONE_PRIORITY=1,
  /*
   *  Port with two priorities.
   */
  SOC_DNX_EGR_PORT_TWO_PRIORITIES=2,
  /*
   *  Port with two priorities.
   */
  SOC_DNX_EGR_PORT_FOUR_PRIORITIES=4,
  /*
   *  Port with eight priorities.
   */
  SOC_DNX_EGR_PORT_EIGHT_PRIORITIES=8,
  /*
   *  Total number of Port prioritie modes.
   */
  SOC_DNX_EGR_NOF_PORT_PRIORITY_MODES=4
}SOC_DNX_EGR_PORT_PRIORITY_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_PORT_SHAPER_DATA_MODE=0,
  /*
   *  Port shaper is in packet mode.
   */
  SOC_DNX_EGR_PORT_SHAPER_PACKET_MODE=1,  
  /*
   *  Total number of Port shaper modes.
   */
  SOC_DNX_EGR_NOF_PORT_SHAPER_MODES=2
}SOC_DNX_EGR_PORT_SHAPER_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_EGR_QUEUING_PARTITION_SCHEME_DISCRETE = 0,
  /*
   ...
   */
  SOC_DNX_EGR_QUEUING_PARTITION_SCHEME_STRICT = 1,
  /*
   * Total number of partition schemes.
   */
  SOC_DNX_NOF_EGR_QUEUING_PARTITION_SCHEMES = 2
}SOC_DNX_EGR_QUEUING_PARTITION_SCHEME;
...
typedef struct
{
   ...
   * Unicast thresholds. 
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER uc;
  /*
   ...
   * Total thresholds.
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER total;
}SOC_DNX_EGR_QUEUING_TH_DB_GLOBAL;
...
typedef struct
{
   ...
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER reserved;
}SOC_DNX_EGR_QUEUING_TH_DB_POOL;
...
typedef struct
{
   ...
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER mc_shared;
  /*
   * Reserved thresholds per Traffic Class. Only for Packet descriptors.
   */
  SOC_DNX_EGR_FC_DEV_THRESH_INNER reserved[SOC_DNX_NOF_TRAFFIC_CLASSES];
}SOC_DNX_EGR_QUEUING_TH_DB_PORT;
...
typedef struct
{
   ...
   */
  SOC_DNX_EGR_QUEUING_TH_DB_GLOBAL global;
  /*
   * DB Thresholds per Service pool
   */
  SOC_DNX_EGR_QUEUING_TH_DB_POOL pool[SOC_DNX_NOF_EGR_QUEUING_MC_POOLS];
  /*
   * DB Thresholds per Service pool and per Traffic Class.
   */
  SOC_DNX_EGR_QUEUING_TH_DB_POOL pool_tc[SOC_DNX_NOF_EGR_QUEUING_MC_POOLS][SOC_DNX_NOF_TRAFFIC_CLASSES];
  /*
   * DB Thresholds per Port Profile
   */
  SOC_DNX_EGR_QUEUING_TH_DB_PORT thresh_type[SOC_DNX_NOF_THRESH_TYPES];
}SOC_DNX_EGR_QUEUING_DEV_TH;
...
typedef struct
{
   ...
   */
  uint32 tc_group;
}SOC_DNX_EGR_QUEUING_MC_COS_MAP;
...
typedef struct
{
   ...
   *   Range: 0 - 7                                                                                                  .
   */
  SOC_DNX_TCG_NDX tcg_ndx[SOC_DNX_EGR_NOF_Q_PRIO_JER2_ARAD];
} SOC_DNX_EGR_QUEUING_TCG_INFO;
...
typedef struct  {
    ...
    int drop_dbs_th;
    int drop_pds_th_tc;
} SOC_DNX_EGR_QUEUING_CGM_INIT_THRESHOLDS;
...
/* } __SOC_DNX_API_EGR_QUEUING_INCLUDED__*/
#endif
