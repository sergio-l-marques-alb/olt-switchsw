...
/**
 * \brief returns numeric data of egress_destination_size
 * Module - 'multicast', Submodule - 'params', data - 'egress_destination_size'
 * egress destination size (depends on nof tm ports)
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     egress_destination_size - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_multicast_params_egress_destination_size_get_f) (
    int unit);

/**
 * \brief returns numeric data of mcdb_ext_format
 * Module - 'multicast', Submodule - 'params', data - 'mcdb_ext_format'
 * whether extended format to be used
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     mcdb_ext_format - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_multicast_params_mcdb_ext_format_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of egress_destination_size
     */
    dnx_data_multicast_params_egress_destination_size_get_f egress_destination_size_get;
    /**
     * returns numeric data of mcdb_ext_format
     */
    dnx_data_multicast_params_mcdb_ext_format_get_f mcdb_ext_format_get;
    /**
