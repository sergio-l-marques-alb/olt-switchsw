/** \file dnx/swstate/auto_generated/access/algo_mpls_access.h
 *
...
typedef int (*algo_mpls_db_termination_profile_set_cb)(
    int unit, sw_state_algo_template_t termination_profile);
...
typedef int (*algo_mpls_db_termination_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_mpls_termination_profile_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_mpls_db_termination_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_mpls_termination_profile_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*algo_mpls_db_termination_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_mpls_termination_profile_t *profile_data);

/**
 * implemented by: algo_mpls_db_push_profile_set
 */
typedef int (*algo_mpls_db_push_profile_set_cb)(
    int unit, sw_state_algo_template_t push_profile);
...
typedef int (*algo_mpls_db_push_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_jr_mode_mpls_push_profile_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_mpls_db_push_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_jr_mode_mpls_push_profile_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_mpls_db_push_profile_profile_data_get
 */
typedef int (*algo_mpls_db_push_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_jr_mode_mpls_push_profile_t *profile_data);

/**
 * implemented by: algo_mpls_db_label_range_profile_set
 */
typedef int (*algo_mpls_db_label_range_profile_set_cb)(
    int unit, sw_state_algo_res_t label_range_profile);
