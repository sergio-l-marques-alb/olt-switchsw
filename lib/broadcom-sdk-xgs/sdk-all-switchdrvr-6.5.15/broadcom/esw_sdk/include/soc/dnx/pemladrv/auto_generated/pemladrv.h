...
int dnx_pemladrv_virtual_register_size_in_bits_get(const int reg_id, const int field_id, int* size);

/* pemladrv_reg_info_allocate */
unsigned int dnx_pemladrv_reg_info_allocate(pemladrv_reg_info** ptr, int* size);
/* pemladrv_reg_info_de_allocate*/
unsigned int dnx_pemladrv_reg_info_de_allocate(pemladrv_reg_info* ptr, int pemla_reg_info_size);
