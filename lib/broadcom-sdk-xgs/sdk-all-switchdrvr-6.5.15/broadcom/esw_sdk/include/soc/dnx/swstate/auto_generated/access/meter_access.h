/** \file dnx/swstate/auto_generated/access/meter_access.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/meter_types.h>
...
typedef int (*dnx_meter_db_policer_templates_policer_ingress_db0_set_cb)(
    int unit, sw_state_algo_template_t policer_ingress_db0);
...
typedef int (*dnx_meter_db_policer_templates_policer_ingress_db0_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_meter_profile_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_meter_db_policer_templates_policer_ingress_db0_replace_data_cb)(
    int unit, int core_id, int profile,  const dnx_meter_profile_info_t *new_profile_data);
...
typedef int (*dnx_meter_db_policer_templates_policer_ingress_db0_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_meter_profile_info_t *profile_data);
...
typedef int (*dnx_meter_db_policer_templates_policer_ingress_db1_set_cb)(
    int unit, sw_state_algo_template_t policer_ingress_db1);
...
typedef int (*dnx_meter_db_policer_templates_policer_ingress_db2_set_cb)(
    int unit, sw_state_algo_template_t policer_ingress_db2);
...
typedef int (*dnx_meter_db_policer_templates_policer_egress_db0_set_cb)(
    int unit, sw_state_algo_template_t policer_egress_db0);
...
typedef int (*dnx_meter_db_policer_templates_policer_egress_db1_set_cb)(
    int unit, sw_state_algo_template_t policer_egress_db1);
