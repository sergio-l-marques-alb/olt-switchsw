/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_tcam_prefix_diagnostic.h
 *
...
int dnx_field_tcam_prefix_sw_banks_prefix_dump(
    int unit, int banks_prefix_idx_0);

int dnx_field_tcam_prefix_sw_banks_prefix_prefix_handler_map_dump(
    int unit, int banks_prefix_idx_0, int prefix_handler_map_idx_0);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_FIELD_TCAM_PREFIX_DIAGNOSTIC_H__ */
