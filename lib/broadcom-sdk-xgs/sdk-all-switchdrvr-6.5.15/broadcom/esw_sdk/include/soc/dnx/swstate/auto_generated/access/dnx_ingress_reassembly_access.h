/** \file dnx/swstate/auto_generated/access/dnx_ingress_reassembly_access.h
 *
...
typedef int (*dnx_ingress_reassembly_db_alloc_set_cb)(
    int unit, uint32 alloc_idx_0, sw_state_algo_res_t alloc);
...
typedef int (*dnx_ingress_reassembly_db_alloc_create_cb)(
    int unit, uint32 alloc_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
typedef int (*dnx_ingress_reassembly_db_rcy_reassembly_context_set_cb)(
    int unit, uint32 reassembly_context_idx_0, uint32 reassembly_context_idx_1, uint32 reassembly_context);
