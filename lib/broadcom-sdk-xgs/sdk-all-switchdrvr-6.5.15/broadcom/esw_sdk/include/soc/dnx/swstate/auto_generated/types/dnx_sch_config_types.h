 ...
 */
typedef struct {
    int* hr_group_bw[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES];
    int groups_bw[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES][3];
    dnx_sch_ipf_config_mode_e ipf_config_mode;
    dnx_sch_flow_swstate_info_t* flow[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES];
    dnx_sch_connector_swstate_info_t* connector[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES];
    dnx_sch_se_swstate_info_t* se[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES];
} dnx_sch_config_t;
