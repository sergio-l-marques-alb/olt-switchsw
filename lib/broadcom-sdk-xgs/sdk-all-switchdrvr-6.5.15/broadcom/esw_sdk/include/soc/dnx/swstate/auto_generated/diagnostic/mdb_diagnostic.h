...
int mdb_db_infos_em_key_format_dump(
    int unit, int em_key_format_idx_0);

int mdb_db_infos_em_key_format_format_count_dump(
    int unit, int em_key_format_idx_0);

int mdb_db_infos_em_key_format_key_to_format_map_dump(
    int unit, int em_key_format_idx_0, int key_to_format_map_idx_0);

int mdb_db_infos_em_key_format_em_bank_info_dump(
    int unit, int em_key_format_idx_0, int em_bank_info_idx_0);

int mdb_db_infos_em_key_format_em_bank_info_bank_size_used_8k_dump(
    int unit, int em_key_format_idx_0, int em_bank_info_idx_0);
...
int mdb_db_infos_db_clusters_info_dump(
    int unit, int db_idx_0, int clusters_info_idx_0);
...
int mdb_db_infos_db_clusters_info_phase_alloc_rows_dump(
    int unit, int db_idx_0, int clusters_info_idx_0, int phase_alloc_rows_idx_0);

int mdb_db_infos_db_clusters_info_big_kaps_alloc_flags_dump(
    int unit, int db_idx_0, int clusters_info_idx_0);

int mdb_db_infos_db_clusters_info_big_kaps_alloc_flags_current_dump(
    int unit, int db_idx_0, int clusters_info_idx_0);

int mdb_db_infos_capacity_dump(
    int unit, int capacity_idx_0);

int mdb_db_infos_eedb_payload_type_dump(
    int unit, int eedb_payload_type_idx_0);
...
int mdb_db_infos_mdb_cluster_infos_macro_a_cluster_assoc_dump(
    int unit, int macro_a_cluster_assoc_idx_0);

int mdb_db_infos_mdb_cluster_infos_macro_a_cluster_cache_dump(
    int unit, int macro_a_cluster_cache_idx_0, int macro_a_cluster_cache_idx_1, int macro_a_cluster_cache_idx_2);

int mdb_db_infos_mdb_cluster_infos_macro_b_cluster_assoc_dump(
    int unit, int macro_b_cluster_assoc_idx_0);

int mdb_db_infos_mdb_cluster_infos_macro_b_cluster_cache_dump(
    int unit, int macro_b_cluster_cache_idx_0, int macro_b_cluster_cache_idx_1, int macro_b_cluster_cache_idx_2);

int mdb_db_infos_mdb_cluster_infos_eedb_banks_assoc_dump(
    int unit, int eedb_banks_assoc_idx_0);

int mdb_db_infos_mdb_cluster_infos_eedb_banks_cache_dump(
    int unit, int eedb_banks_cache_idx_0, int eedb_banks_cache_idx_1, int eedb_banks_cache_idx_2);

int mdb_db_infos_mdb_cluster_infos_eedb_banks_hitbit_dump(
    int unit, int eedb_banks_hitbit_idx_0, int eedb_banks_hitbit_idx_1);

int mdb_db_infos_mdb_cluster_infos_small_kaps_bb_hitbit_dump(
    int unit, int small_kaps_bb_hitbit_idx_0, int small_kaps_bb_hitbit_idx_1);
