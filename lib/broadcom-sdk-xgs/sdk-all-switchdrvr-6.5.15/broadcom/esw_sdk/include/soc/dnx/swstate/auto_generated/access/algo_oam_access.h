/** \file dnx/swstate/auto_generated/access/algo_oam_access.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/algo_oam_types.h>
...
typedef int (*algo_oam_db_oam_group_id_set_cb)(
    int unit, sw_state_algo_res_t oam_group_id);
...
typedef int (*algo_oam_db_oam_profile_id_ing_set_cb)(
    int unit, sw_state_algo_res_t oam_profile_id_ing);
...
typedef int (*algo_oam_db_oam_profile_id_eg_set_cb)(
    int unit, sw_state_algo_res_t oam_profile_id_eg);
...
typedef int (*algo_oam_db_oam_profile_id_ing_acc_set_cb)(
    int unit, sw_state_algo_res_t oam_profile_id_ing_acc);
...
typedef int (*algo_oam_db_oam_profile_id_eg_acc_set_cb)(
    int unit, sw_state_algo_res_t oam_profile_id_eg_acc);
...
typedef int (*algo_oam_db_oam_rmep_id_below_threshold_set_cb)(
    int unit, sw_state_algo_res_t oam_rmep_id_below_threshold);
...
typedef int (*algo_oam_db_oam_rmep_id_above_threshold_set_cb)(
    int unit, sw_state_algo_res_t oam_rmep_id_above_threshold);
...
typedef int (*algo_oam_db_oam_itmh_priority_profile_set_cb)(
    int unit, sw_state_algo_template_t oam_itmh_priority_profile);
...
typedef int (*algo_oam_db_oam_itmh_priority_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_oam_itmh_priority_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_oam_db_oam_itmh_priority_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_oam_itmh_priority_t *profile_data);

/**
 * implemented by: algo_oam_db_oam_mpls_pwe_exp_ttl_profile_set
 */
typedef int (*algo_oam_db_oam_mpls_pwe_exp_ttl_profile_set_cb)(
    int unit, sw_state_algo_template_t oam_mpls_pwe_exp_ttl_profile);
...
typedef int (*algo_oam_db_oam_mpls_pwe_exp_ttl_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_oam_ttl_exp_profile_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_oam_db_oam_mpls_pwe_exp_ttl_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_oam_ttl_exp_profile_t *profile_data);

/**
 * implemented by: algo_oam_db_oamp_punt_event_prof_template_set
 */
typedef int (*algo_oam_db_oamp_punt_event_prof_template_set_cb)(
    int unit, sw_state_algo_template_t oamp_punt_event_prof_template);
...
typedef int (*algo_oam_db_oamp_punt_event_prof_template_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_oam_oamp_punt_event_profile_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_oam_db_oamp_punt_event_prof_template_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_oam_oamp_punt_event_profile_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*algo_oam_db_oamp_punt_event_prof_template_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_oam_oamp_punt_event_profile_t *profile_data);
...
typedef int (*algo_oam_db_oam_sa_mac_msb_profile_template_set_cb)(
    int unit, sw_state_algo_template_t oam_sa_mac_msb_profile_template);
...
typedef int (*algo_oam_db_eth_oam_tpid_profile_set_cb)(
    int unit, sw_state_algo_template_t eth_oam_tpid_profile);
...
typedef int (*algo_oam_db_eth_oam_tpid_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, uint16 *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_oam_db_oam_group_icc_profile_set_cb)(
    int unit, sw_state_algo_template_t oam_group_icc_profile);
...
typedef int (*algo_oam_db_oam_group_icc_profile_profile_get_cb)(
    int unit, int core_id, const uint8 *profile_data, int *profile);

/**
 * implemented by: algo_oam_db_oam_mep_profile_set
 */
typedef int (*algo_oam_db_oam_mep_profile_set_cb)(
    int unit, sw_state_algo_template_t oam_mep_profile);
...
typedef int (*algo_oam_db_oam_mep_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_oam_mep_profile_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_oam_db_oam_mep_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_oam_mep_profile_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_oam_db_oam_mep_profile_profile_data_get
 */
typedef int (*algo_oam_db_oam_mep_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_oam_mep_profile_t *profile_data);
...
typedef int (*algo_oam_db_oam_da_mac_msb_profile_template_set_cb)(
    int unit, sw_state_algo_template_t oam_da_mac_msb_profile_template);
...
typedef int (*algo_oam_db_oam_da_mac_msb_profile_template_allocate_single_cb)(
    int unit, int core_id, uint32 flags, void *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_oam_db_oam_da_mac_lsb_profile_template_set_cb)(
    int unit, sw_state_algo_template_t oam_da_mac_lsb_profile_template);
