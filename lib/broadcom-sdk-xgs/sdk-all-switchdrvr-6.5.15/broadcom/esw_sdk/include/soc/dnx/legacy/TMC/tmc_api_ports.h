...
#ifndef __SOC_DNX_API_PORTS_INCLUDED__
/* { */
#define __SOC_DNX_API_PORTS_INCLUDED__
...
#define  SOC_DNX_PORTS_SYS_PHYS_PORT_ID_MAX 4095

/*     Maximal number of LAG-s in the system                  */
#define  SOC_DNX_PORT_LAGS_MAX 1024

/*     Maximal number of mamber ports in Out-LAG              */
#define  SOC_DNX_PORTS_LAG_OUT_MEMBERS_MAX 256
 ...
 */
#define  SOC_DNX_PORTS_LAG_MEMBER_ID_MAX    (SOC_DNX_PORTS_LAG_OUT_MEMBERS_MAX-1)

/*     Maximal number of mamber ports in In-LAG               */
#define  SOC_DNX_PORTS_LAG_IN_MEMBERS_MAX SOC_DNX_NOF_FAP_PORTS

/*     Maximal number of mamber ports in In-LAG for JER2_ARAD      */
#define  SOC_DNX_PORTS_LAG_IN_MEMBERS_MAX_JER2_ARAD SOC_DNX_NOF_FAP_PORTS

/*     Maximal number of mamber ports in LAG (incoming or outgoing) */
#define  SOC_DNX_PORTS_LAG_MEMBERS_MAX       SOC_DNX_PORTS_LAG_IN_MEMBERS_MAX
#define  SOC_DNX_PORTS_LAG_MEMBERS_MAX_JER2_ARAD  SOC_DNX_PORTS_LAG_IN_MEMBERS_MAX_JER2_ARAD

/* SOC_DNX_PORT_PP_PORT flags */
#define SOC_DNX_PORT_PP_PORT_RCY_OVERLAY_PTCH 0x1

/* SOC_DNX_PORT_PP_PORT flags */

#define SOC_TEST1_PORT_PP_PORT 0x2

/* SOC_DNX_PORT_PP_PORT flags - Preserving DSCP on a per out-port bases*/
#define SOC_PRESERVING_DSCP_PORT_PP_PORT 0x4

#define SOC_MIM_SPB_PORT 0x8

#define SOC_DNX_PORT_PRD_MAX_KEY_BUILD_OFFSETS 4

#define SOC_DNX_PORT_PRD_F_PORT_EXTERNDER 0x1
/* } */
...
typedef enum
{
   ...
   */
  SOC_DNX_PORT_DIRECTION_INCOMING=0,
  /*
   *  Port direction - outgoing (OFP).
   */
  SOC_DNX_PORT_DIRECTION_OUTGOING=1,
  /*
   *  Port direction - both incoming (IFP) and outgoing (OFP).
   */
  SOC_DNX_PORT_DIRECTION_BOTH=2,
  /*
   *  Total number of Port directions.
   */
  SOC_DNX_PORT_NOF_DIRECTIONS=3
}SOC_DNX_PORT_DIRECTION;
...
typedef enum
{
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_NONE=0,
  /*
   ...
   *  Ethernet.
   */
  SOC_DNX_PORT_HEADER_TYPE_ETH=1,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_RAW=2,
  /*
   ...
   *  packet.
   */
  SOC_DNX_PORT_HEADER_TYPE_PROG=4,
  /*
   ...
   *  (FTMH).
   */
  SOC_DNX_PORT_HEADER_TYPE_CPU=5,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_STACKING=6,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_TDM=7,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_TDM_RAW = 8,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_INJECTED = 9,
    /* Same than SOC_DNX_PORT_HEADER_TYPE_INJECTED when the Port processing is PP */
  SOC_DNX_PORT_HEADER_TYPE_INJECTED_PP = 10,
  /*
   *  Port header processing type: Both. Supported direction:
   *  Incoming only. Designed to support use of injected packets with
   ...
   *  Output: FTMH (6B) + Out-LIF Extension (2B) + PPH.
   */
  SOC_DNX_PORT_HEADER_TYPE_INJECTED_2 = 11,
    /* Same than SOC_DNX_PORT_HEADER_TYPE_INJECTED_2 when the Port processing is PP */
  SOC_DNX_PORT_HEADER_TYPE_INJECTED_2_PP = 12,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_XGS_HQoS = 13,
  /*
   ...
   *  outermost Incoming/Outgoing FRC headers.
   */
  SOC_DNX_PORT_HEADER_TYPE_XGS_DiffServ = 14,
  /*
   ...
   *  outermost Incoming/Outgoing FRC headers.
   */
  SOC_DNX_PORT_HEADER_TYPE_XGS_MAC_EXT = 15,
  /*
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_TDM_PMM=16,

  SOC_DNX_PORT_HEADER_TYPE_REMOTE_CPU=17,
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_UDH_ETH=18,
   ...
   *  an MPLSoE packet.
   */
  SOC_DNX_PORT_HEADER_TYPE_MPLS_RAW=19,
  /*
   ...
   */
 SOC_DNX_PORT_HEADER_TYPE_L2_ENCAP_EXTERNAL_CPU=20,
   ...
   */
  SOC_DNX_PORT_HEADER_TYPE_MIRROR_RAW,

  /*
   *  Total number of ingress port types
   */
  SOC_DNX_PORT_NOF_HEADER_TYPES
}SOC_DNX_PORT_HEADER_TYPE;
...
typedef enum
{
   ...
   */
  SOC_DNX_PORTS_SNOOP_SIZE_BYTES_64=0,
  /*
   *  Snoop the first 192 bytes of the packet.
   */
  SOC_DNX_PORTS_SNOOP_SIZE_BYTES_192=2,
  /*
   *  Snoop the entire packet.
   */
  SOC_DNX_PORTS_SNOOP_SIZE_ALL=3,
  /*
   *  Total number of snoop sizes.
   */
  SOC_DNX_PORTS_NOF_SNOOP_SIZES=4
}SOC_DNX_PORTS_SNOOP_SIZE;
...
typedef enum
{
   ...
   */
  SOC_DNX_PORTS_FTMH_EXT_OUTLIF_NEVER=0,
  /*
   *  Add FTMH and OTMH extension only if multicast.
   */
  SOC_DNX_PORTS_FTMH_EXT_OUTLIF_IF_MC=1,
  /*
   *  Always add an FTMH and OTMH extension.
   */
  SOC_DNX_PORTS_FTMH_EXT_OUTLIF_ALWAYS=2,
  /*
   * Enlarge the outlif in the OTMH(using EEDB/EPE)
   */
  SOC_DNX_PORTS_FTMH_EXT_OUTLIF_ENLARGE=4,
  /*
   * Two hop scheduling. 
   */
  SOC_DNX_PORTS_FTMH_EXT_OUTLIF_DOUBLE_TAG=3,
  /*
   *  Number of option for the ftmh extension.
   */
  SOC_DNX_PORTS_FTMH_NOF_EXT_OUTLIFS
}SOC_DNX_PORTS_FTMH_EXT_OUTLIF;
...
typedef enum
{
   ...
   *  type A.
   */
  SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_TYPE_A=0,
  /*
   *  Egress header credit discount (AKA header compensation),
   *  type B.
   */
  SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_TYPE_B=1,
  /*
   *  Total number of egress header credit discount types.
   */
  SOC_DNX_PORT_NOF_EGR_HDR_CR_DISCOUNT_TYPES=2
}SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_TYPE;
...
typedef enum
{
   ...
   *  Default VT profile.
   */
  SOC_DNX_PORTS_VT_PROFILE_NONE=0,
  /* 
   *  Identify port as overlay recycle port.
   */
  SOC_DNX_PORTS_VT_PROFILE_OVERLAY_RCY=1,
  /* 
    *  Identify port as custom pp port.
    */
  SOC_DNX_PORTS_VT_PROFILE_CUSTOM_PP=2,
  /* 
   *  Total number of VT profiles.
   */
  SOC_DNX_PORTS_NOF_VT_PROFILES
} SOC_DNX_PORTS_VT_PROFILE;
...
typedef enum
{
   ...
   *  Default TT profile.
   */
  SOC_DNX_PORTS_TT_PROFILE_NONE=0,
  /* 
   *  Identify port as overlay recycle port.
   */
  SOC_DNX_PORTS_TT_PROFILE_OVERLAY_RCY=1,
  /* 
   *  Identify port as PON port.
   */
  SOC_DNX_PORTS_TT_PROFILE_PON=2,
  /* 
   *  Total number of TT profiles.
   */
  SOC_DNX_PORTS_NOF_TT_PROFILES
} SOC_DNX_PORTS_TT_PROFILE;
...
typedef enum
{
   ...
   *  Default FLP profile.
   */
  SOC_DNX_PORTS_FLP_PROFILE_NONE=0,
  /* 
   *  Identify port as overlay recycle port.
   */
  SOC_DNX_PORTS_FLP_PROFILE_OVERLAY_RCY=1,
  /* 
   *  Identify port as PON port(0-7).
   */
  SOC_DNX_PORTS_FLP_PROFILE_PON=2,
  /* 
   *  Identify port as OAMP.
   */
  SOC_DNX_PORTS_FLP_PROFILE_OAMP=3,
  /* 
   *  Total number of FLP profiles.
   */
  SOC_DNX_PORTS_NOF_FLP_PROFILES
} SOC_DNX_PORTS_FLP_PROFILE;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORTS_LAG_MEMBER lag_member_sys_ports[SOC_DNX_PORTS_LAG_MEMBERS_MAX];

}  SOC_DNX_PORTS_LAG_INFO;
...
typedef struct
{
   ...
   *  members of the specified LAG.
   */
  SOC_DNX_PORTS_LAG_MEMBER lag_member_sys_ports[SOC_DNX_PORTS_LAG_MEMBERS_MAX_JER2_ARAD];

}  SOC_DNX_PORTS_LAG_INFO_JER2_ARAD;
...
typedef struct
{
  ...
  */
  uint32 out_lags[SOC_DNX_NOF_LAG_GROUPS];
}SOC_DNX_PORT_LAG_SYS_PORT_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORTS_OVERRIDE_INFO dp_override;
  /*
   *  Override Traffic Class - enable and value.
   */
  SOC_DNX_PORTS_OVERRIDE_INFO tc_override;
}SOC_DNX_PORT_INBOUND_MIRROR_INFO;
...
}SOC_DNX_PORT_OUTBOUND_MIRROR_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORTS_SNOOP_SIZE size_bytes;
  /*
...
typedef struct
{
   ...
   */
  SOC_DNX_DEST_SYS_PORT_INFO src_port;
  /* 
   * This field indicates the forwarding action destination
   * data.
   */ 
  SOC_DNX_DEST_INFO destination;
}SOC_DNX_PORTS_ITMH_EXT_SRC_PORT;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORTS_ITMH_BASE base;
  /*
   *  The ITMH source port extension info.
   */
  SOC_DNX_PORTS_ITMH_EXT_SRC_PORT extension;
}SOC_DNX_PORTS_ITMH;
...
typedef struct
{
   ...
   *  multicast.)
   */
  SOC_DNX_PORTS_FTMH_EXT_OUTLIF outlif_ext_en;
  /*
   ...
   */
  uint8 dest_ext_en;
}SOC_DNX_PORTS_OTMH_EXTENSIONS_EN;
...
}SOC_DNX_PORT_EGR_HDR_CR_DISCOUNT_INFO;
...
typedef enum
{
   ...
   *  No Flow Control.
   */
  SOC_DNX_PORTS_FC_TYPE_NONE = 0,
  /*
   *  Link-Level Flow Control.
   */
  SOC_DNX_PORTS_FC_TYPE_LL = 1,
  /*
   *  Class-Based Flow Control (2 classes).
   */
  SOC_DNX_PORTS_FC_TYPE_CB2 = 2,
  /*
   *  Class-Based Flow Control (8 classes).
   */
  SOC_DNX_PORTS_FC_TYPE_CB8 = 3,
  /*
   *  Number of types in SOC_DNX_PORTS_FC_TYPE
   */
  SOC_DNX_PORTS_NOF_FC_TYPES = 4
}SOC_DNX_PORTS_FC_TYPE;
...
typedef struct
{
  ...
  /*
   *  Flags SOC_DNX_PORT_PP_PORT_XXX
   */
  uint32 flags;

} SOC_DNX_PORT_PP_PORT_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_CNT_PROCESSOR_ID processor_id;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORT_COUNTER_INFO counter;

} SOC_DNX_PORTS_FORWARDING_HEADER_INFO;
...
typedef enum
{
   ...
   *  port.
   */
  SOC_DNX_PORT_INJECTED_HDR_FORMAT_NONE = 0,
  /*
   ...
   */
  SOC_DNX_PORT_INJECTED_HDR_FORMAT_PP_PORT = 1,
  /*
   *  Number of types in SOC_DNX_PORT_INJECTED_HDR_FORMAT
   */
  SOC_DNX_PORT_NOF_INJECTED_HDR_FORMATS = 2
}SOC_DNX_PORT_INJECTED_HDR_FORMAT;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORT_INJECTED_HDR_FORMAT hdr_format;
  /*
...
} SOC_DNX_PORT_INJECTED_CPU_HEADER_INFO;
...
typedef enum
{
   ...
   *   1K groups of 16
   */
  SOC_DNX_PORT_LAG_MODE_1K_16 = 0,
  /*
   *  512 groups of 32
   */
  SOC_DNX_PORT_LAG_MODE_512_32 = 1,
  /*
   *  256 groups of 64
   */
  SOC_DNX_PORT_LAG_MODE_256_64 = 2,
  /*
   *  128 groups of 128
   */
  SOC_DNX_PORT_LAG_MODE_128_128 = 3,
  /*
   *  64 groups of 256
   */
  SOC_DNX_PORT_LAG_MODE_64_256 = 4,
  /*
   *  Total number of Port directions.
   */
  SOC_DNX_NOF_PORT_LAG_MODES = 5
}SOC_DNX_PORT_LAG_MODE;
...
} SOC_DNX_PORTS_ILKN_RETRANSMIT_CONFIG;
...
typedef struct
{
  ...
  SOC_DNX_PORTS_ILKN_RETRANSMIT_CONFIG retransmit;

} SOC_DNX_PORTS_ILKN_CONFIG;
...
} SOC_DNX_PORTS_CAUI_CONFIG;

/* 
 * Application mapping type enum used in SOC_DNX_PORTS_APPLICATION_MAPPING_INFO
 */
typedef enum
{
  SOC_DNX_PORTS_APPLICATION_MAPPING_TYPE_XGS_MAC_EXTENDER = 0,
  SOC_DNX_PORTS_APPLICATION_MAPPING_TYPE_PP_PORT_EXTENDER = 1,
  SOC_DNX_PORTS_APPLICATION_MAPPING_NOF_TYPES
} SOC_DNX_PORTS_APPLICATION_MAPPING_TYPE;
...
} SOC_DNX_PORTS_APPLICATION_MAPPING_VALUE;
...
typedef struct
{
   ...
   */
  SOC_DNX_PORTS_APPLICATION_MAPPING_TYPE type;

  /* 
   * Value per application
   */
  SOC_DNX_PORTS_APPLICATION_MAPPING_VALUE value;
   

} SOC_DNX_PORTS_APPLICATION_MAPPING_INFO;
...
} SOC_DNX_PORT_PRD_CONTROL_PLANE;
...
typedef struct {
    ...
    uint32 key_fields_values[SOC_DNX_PORT_PRD_MAX_KEY_BUILD_OFFSETS]; /*up to 4 segments of 8 bits each*/
    uint32 key_fields_masks[SOC_DNX_PORT_PRD_MAX_KEY_BUILD_OFFSETS]; /*key mask - up to 4 segments of 8 bits each*/
    uint32 priority; /*priority for this entry */                  
} SOC_DNX_PORT_PRD_FLEX_KEY_ENTRY;
...
/* } __SOC_DNX_API_PORTS_INCLUDED__*/
#endif
