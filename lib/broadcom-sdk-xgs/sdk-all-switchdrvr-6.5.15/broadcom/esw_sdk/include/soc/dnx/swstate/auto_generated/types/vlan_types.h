/** \file dnx/swstate/auto_generated/types/vlan_types.h
 *
...
typedef struct {
     ...
     * VSI
     */
    sw_state_algo_res_t vsi;
    /**
     * ACTION_ID_INGRESS
     */
    sw_state_algo_res_t action_id_ingress;
    /**
     * ACTION_ID_EGRESS
     */
    sw_state_algo_res_t action_id_egress;
    /**
     * VLAN-PORT INGRESS VIRTUAL GPORT ID
     */
    sw_state_algo_res_t vlan_port_ingress_virtual_gport_id;
    /**
     * VLAN-PORT EGRESS VIRTUAL GPORT ID
     */
    sw_state_algo_res_t vlan_port_egress_virtual_gport_id;
    /**
     * Outer vlan range profile template
     */
    sw_state_algo_template_t vlan_range_outer_profile;
    /**
     * Inner vlan range profile template
     */
    sw_state_algo_template_t vlan_range_inner_profile;
} vlan_unit_state_t;
