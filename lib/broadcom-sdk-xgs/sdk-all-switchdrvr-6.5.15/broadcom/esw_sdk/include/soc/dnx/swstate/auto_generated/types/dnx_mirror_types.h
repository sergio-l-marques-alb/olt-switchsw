/** \file dnx/swstate/auto_generated/types/dnx_mirror_types.h
 *
...
typedef struct {
     ...
     */
    int channel_to_egress_if[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES][DNX_DATA_MAX_PORT_GENERAL_MAX_NOF_CHANNELS];
    /**
     ...
     */
    sw_state_algo_res_t snif_ingress_profiles_mirror;
    /**
     * SNIF_INGRESS_PROFILES_SNOOP
     */
    sw_state_algo_res_t snif_ingress_profiles_snoop;
    /**
     * SNIF_INGRESS_PROFILES_STAT_SAMPLING
     */
    sw_state_algo_res_t snif_ingress_profiles_stat_sampling;
    /**
     * SNIF_EGRESS_VLAN_PROFILES_MIRROR
     */
    sw_state_algo_template_t snif_egress_vlan_profiles_mirror;
    /**
     * SNIF_INGRESS_VLAN_PROFILES_MIRROR
     */
    sw_state_algo_template_t snif_ingress_vlan_profiles_mirror;
} dnx_mirror_db_t;
