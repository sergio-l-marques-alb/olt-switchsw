/** \file dnx/swstate/auto_generated/access/vlan_access.h
 *
...
typedef int (*vlan_db_vsi_set_cb)(
    int unit, sw_state_algo_res_t vsi);
...
typedef int (*vlan_db_action_id_ingress_set_cb)(
    int unit, sw_state_algo_res_t action_id_ingress);
...
typedef int (*vlan_db_action_id_egress_set_cb)(
    int unit, sw_state_algo_res_t action_id_egress);
...
typedef int (*vlan_db_vlan_port_ingress_virtual_gport_id_set_cb)(
    int unit, sw_state_algo_res_t vlan_port_ingress_virtual_gport_id);
...
typedef int (*vlan_db_vlan_port_egress_virtual_gport_id_set_cb)(
    int unit, sw_state_algo_res_t vlan_port_egress_virtual_gport_id);
...
typedef int (*vlan_db_vlan_range_outer_profile_set_cb)(
    int unit, sw_state_algo_template_t vlan_range_outer_profile);
...
typedef int (*vlan_db_vlan_range_outer_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, vlan_range_profile_template_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*vlan_db_vlan_range_outer_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const vlan_range_profile_template_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: vlan_db_vlan_range_outer_profile_replace_data
 */
typedef int (*vlan_db_vlan_range_outer_profile_replace_data_cb)(
    int unit, int core_id, int profile,  const vlan_range_profile_template_t *new_profile_data);
...
typedef int (*vlan_db_vlan_range_outer_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, vlan_range_profile_template_t *profile_data);

/**
 * implemented by: vlan_db_vlan_range_outer_profile_profile_get
 */
typedef int (*vlan_db_vlan_range_outer_profile_profile_get_cb)(
    int unit, int core_id, const vlan_range_profile_template_t *profile_data, int *profile);
...
typedef int (*vlan_db_vlan_range_inner_profile_set_cb)(
    int unit, sw_state_algo_template_t vlan_range_inner_profile);
