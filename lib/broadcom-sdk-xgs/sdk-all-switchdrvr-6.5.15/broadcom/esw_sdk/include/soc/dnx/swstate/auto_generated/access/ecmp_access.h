/** \file dnx/swstate/auto_generated/access/ecmp_access.h
 *
...
typedef int (*ecmp_db_info_ecmp_res_manager_set_cb)(
    int unit, sw_state_algo_res_t ecmp_res_manager);
...
typedef int (*ecmp_db_info_ecmp_extended_res_manager_set_cb)(
    int unit, sw_state_algo_res_t ecmp_extended_res_manager);
