/** \file dnx/swstate/auto_generated/diagnostic/dnx_field_group_diagnostic.h
 *
...
typedef enum {
    ...
    DNX_FIELD_GROUP_SW_FG_INFO_CONTEXT_INFO_KEY_ID_KEY_PART_INFO,
    ...
    DNX_FIELD_GROUP_SW_FG_INFO_CONTEXT_INFO_KEY_ID_BIT_RANGE_BIT_RANGE_WAS_ALIGNED_INFO,
    DNX_FIELD_GROUP_SW_FG_INFO_CONTEXT_INFO_KEY_ID_BIT_RANGE_BIT_RANGE_ALIGNED_OFFSET_INFO,
    ...
    DNX_FIELD_GROUP_SW_FG_INFO_ACTION_SIZE_INFO,
...
int dnx_field_group_sw_fg_info_name_value_dump(
    int unit, int fg_info_idx_0, int value_idx_0);

int dnx_field_group_sw_fg_info_context_info_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0);
...
int dnx_field_group_sw_fg_info_context_info_key_id_id_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0, int id_idx_0);

int dnx_field_group_sw_fg_info_context_info_key_id_key_part_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0);
...
int dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0);

int dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0);

int dnx_field_group_sw_fg_info_context_info_qual_attach_info_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0, int qual_attach_info_idx_0);
...
int dnx_field_group_sw_fg_info_key_template_key_qual_map_dump(
    int unit, int fg_info_idx_0, int key_qual_map_idx_0);
...
int dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dump(
    int unit, int fg_info_idx_0, int actions_on_payload_info_idx_0, int actions_on_payload_info_idx_1);
...
int dnx_field_group_sw_fg_info_action_size_dump(
    int unit, int fg_info_idx_0);
...
int dnx_field_group_sw_fg_info_tcam_info_tcam_bank_ids_dump(
    int unit, int fg_info_idx_0, int tcam_bank_ids_idx_0);

int dnx_field_group_sw_ace_format_info_dump(
    int unit, int ace_format_info_idx_0);
...
int dnx_field_group_sw_ace_format_info_actions_payload_info_actions_on_payload_info_dump(
    int unit, int ace_format_info_idx_0, int actions_on_payload_info_idx_0);
...
#endif /* __DNX_FIELD_GROUP_DIAGNOSTIC_H__ */
