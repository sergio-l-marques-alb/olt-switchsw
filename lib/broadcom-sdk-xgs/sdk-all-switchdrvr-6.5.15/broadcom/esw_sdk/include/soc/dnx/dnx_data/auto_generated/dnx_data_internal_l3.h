...
typedef enum
{
    ...
    dnx_data_l3_fec_define_max_fec_id_26k_granularity,
    dnx_data_l3_fec_define_max_fec_id_52k_granularity,
    dnx_data_l3_fec_define_max_default_fec,
    dnx_data_l3_fec_define_fec_stage_map_size,
    dnx_data_l3_fec_define_max_fec_stage_map_size,
    dnx_data_l3_fec_define_nof_super_fecs_per_bank,
    dnx_data_l3_fec_define_nof_physical_fecs_per_bank,
    dnx_data_l3_fec_define_super_fec_size,
    dnx_data_l3_fec_define_fec_row_size,
    dnx_data_l3_fec_define_fec_max_nof_banks,
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_max_fec_id_26k_granularity_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_max_fec_id_52k_granularity_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_fec_stage_map_size_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_max_fec_stage_map_size_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_nof_super_fecs_per_bank_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_fec_row_size_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_fec_fec_max_nof_banks_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_l3_ecmp_define_members_table_size_in_bits,
    ...
    dnx_data_l3_ecmp_define_first_valid_ecmp_group_id,
 ...
 *   * None
 */
uint32 dnx_data_l3_ecmp_members_table_size_in_bits_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_l3_ecmp_first_valid_ecmp_group_id_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_l3_vrrp_define_exem_vrid_ip_tcam_index,
 ...
 *   * None
 */
uint32 dnx_data_l3_vrrp_exem_vrid_ip_tcam_index_get(
    int unit);
 ...
 *   * None
 */
int dnx_data_l3_hw_bug_feature_get(
    int unit,
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_l3_hw_bug_define_nof
} dnx_data_l3_hw_bug_define_e;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_l3_hw_bug_table_nof
} dnx_data_l3_hw_bug_table_e;
