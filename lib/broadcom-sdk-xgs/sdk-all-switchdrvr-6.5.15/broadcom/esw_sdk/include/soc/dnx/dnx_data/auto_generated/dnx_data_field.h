 ...
 */
typedef uint32(
    *dnx_data_field_base_ipmf1_nof_l4_ops_ranges_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of nof_l4_ops_ranges
     */
    dnx_data_field_base_ipmf1_nof_l4_ops_ranges_get_f nof_l4_ops_ranges_get;
    /**
 ...
 */
typedef uint32(
    *dnx_data_field_base_epmf_nof_l4_ops_ranges_get_f) (
    int unit);
...
typedef struct
{
     ...
     * returns define data of nof_l4_ops_ranges
     */
    dnx_data_field_base_epmf_nof_l4_ops_ranges_get_f nof_l4_ops_ranges_get;
    /**
     * returns define data of fes_key_select_for_zero_bit
     */
...
typedef struct
{
    ...
    /**
     * Number of ranges for L4 Ops
     */
    int nof_l4_ops_ranges;
    /**
 ...
 */
typedef uint32(
    *dnx_data_field_kbp_max_master_key_size_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of max_master_key_size
     */
    dnx_data_field_kbp_max_master_key_size_get_f max_master_key_size_get;
    /**
 ...
 */
typedef uint32(
    *dnx_data_field_exem_small_vmv_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_field_exem_large_vmv_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_field_exem_small_max_entry_result_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_field_exem_large_max_entry_result_size_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of small_vmv_size
     */
    dnx_data_field_exem_small_vmv_size_get_f small_vmv_size_get;
    /**
     * returns define data of large_vmv_size
     */
    dnx_data_field_exem_large_vmv_size_get_f large_vmv_size_get;
    /**
    ...
    /**
     * returns define data of small_max_entry_result_size
     */
    dnx_data_field_exem_small_max_entry_result_size_get_f small_max_entry_result_size_get;
    /**
     * returns define data of large_max_entry_result_size
     */
    dnx_data_field_exem_large_max_entry_result_size_get_f large_max_entry_result_size_get;
    /**
 ...
 */
typedef uint32(
    *dnx_data_field_common_max_val_nof_l4_ops_ranges_get_f) (
    int unit);
...
typedef struct
{
     ...
     * returns define data of nof_l4_ops_ranges
     */
    dnx_data_field_common_max_val_nof_l4_ops_ranges_get_f nof_l4_ops_ranges_get;
    /**
     * returns define data of nof_pkt_hdr_ranges
     */
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_field_hw_workarounds_feature_nof
} dnx_data_field_hw_workarounds_feature_e;
 ...
 */
typedef int(
    *dnx_data_field_hw_workarounds_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_field_hw_workarounds_ecc_wa_enable_get_f) (
    int unit);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_FIELD - HW_WORKAROUNDS:
 * {
 */
/**
 * \brief Interface for field hw_workarounds data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_field_hw_workarounds_feature_get_f feature_get;
    /**
     * returns define data of ecc_wa_enable
     */
    dnx_data_field_hw_workarounds_ecc_wa_enable_get_f ecc_wa_enable_get;
} dnx_data_if_field_hw_workarounds_t;
 ...
 * Availability of features in HW
 * {
 */
/*
 * Table value structure
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_field_hw_features_feature_nof
} dnx_data_field_hw_features_feature_e;
 ...
 */
typedef int(
    *dnx_data_field_hw_features_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_field_hw_features_switch_to_acl_context_get_f) (
    int unit);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_FIELD - HW_FEATURES:
 * {
 */
/**
 * \brief Interface for field hw_features data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_field_hw_features_feature_get_f feature_get;
    /**
     * returns define data of switch_to_acl_context
     */
    dnx_data_field_hw_features_switch_to_acl_context_get_f switch_to_acl_context_get;
} dnx_data_if_field_hw_features_t;
 ...
 * Minor changes between jr2_a0 and JR2_b0, for internal DNX_DATA usage only
 * {
 */
/*
 * Table value structure
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_field_minor_changes_j2_a0_b0_feature_nof
} dnx_data_field_minor_changes_j2_a0_b0_feature_e;
 ...
 */
typedef int(
    *dnx_data_field_minor_changes_j2_a0_b0_feature_get_f) (
    int unit,
 ...
 */
typedef uint32(
    *dnx_data_field_minor_changes_j2_a0_b0_lr_eth_is_da_mac_valid_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_field_minor_changes_j2_a0_b0_per_pp_port_pmf_profile_cs_offset_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_field_minor_changes_j2_a0_b0_tcam_result_flip_eco_get_f) (
    int unit);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_FIELD - MINOR_CHANGES_J2_A0_B0:
 * {
 */
/**
 * \brief Interface for field minor_changes_j2_a0_b0 data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_field_minor_changes_j2_a0_b0_feature_get_f feature_get;
    /**
     * returns define data of lr_eth_is_da_mac_valid
     */
    dnx_data_field_minor_changes_j2_a0_b0_lr_eth_is_da_mac_valid_get_f lr_eth_is_da_mac_valid_get;
    /**
     * returns define data of per_pp_port_pmf_profile_cs_offset
     */
    dnx_data_field_minor_changes_j2_a0_b0_per_pp_port_pmf_profile_cs_offset_get_f per_pp_port_pmf_profile_cs_offset_get;
    /**
     * returns define data of tcam_result_flip_eco
     */
    dnx_data_field_minor_changes_j2_a0_b0_tcam_result_flip_eco_get_f tcam_result_flip_eco_get;
} dnx_data_if_field_minor_changes_j2_a0_b0_t;
...
typedef struct
{
    ...
    /**
     * Interface for field hw_workarounds data
     */
    dnx_data_if_field_hw_workarounds_t hw_workarounds;
    /**
     * Interface for field hw_features data
     */
    dnx_data_if_field_hw_features_t hw_features;
    /**
     * Interface for field minor_changes_j2_a0_b0 data
     */
    dnx_data_if_field_minor_changes_j2_a0_b0_t minor_changes_j2_a0_b0;
} dnx_data_if_field_t;
