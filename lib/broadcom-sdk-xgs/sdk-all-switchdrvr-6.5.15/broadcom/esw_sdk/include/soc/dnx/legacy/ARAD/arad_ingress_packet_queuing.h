...
#define JER2_ARAD_IPQ_TR_CLS SOC_DNX_IPQ_TR_CLS

#define JER2_ARAD_IPQ_MAX_NOF_GLAG_PORTS 16

#define JER2_ARAD_IPQ_INVALID_FLOW_QUARTET          ((DNX_DATA_MAX_SCH_FLOW_NOF_FLOWS / 8 /* flow group size */) - 1)
 ...
 *************/
/* { */
#define JER2_ARAD_IPQ_Q_TO_QRTT_ID(que_id)                 SOC_DNX_IPQ_Q_TO_QRTT_ID(que_id)
#define JER2_ARAD_IPQ_QRTT_TO_Q_ID(q_que_id)               SOC_DNX_IPQ_QRTT_TO_Q_ID(q_que_id)
#define JER2_ARAD_IPQ_Q_TO_1K_ID(que_id)                   SOC_DNX_IPQ_Q_TO_1K_ID(que_id)
#define JER2_ARAD_IPQ_1K_TO_Q_ID(k_que_id)                 SOC_DNX_IPQ_1K_TO_Q_ID(k_que_id)
/* } */
 ...
 *************/
/* { */
typedef SOC_DNX_IPQ_EXPLICIT_MAPPING_MODE_INFO                 JER2_ARAD_IPQ_EXPLICIT_MAPPING_MODE_INFO;
typedef SOC_DNX_IPQ_BASEQ_MAP_INFO                             JER2_ARAD_IPQ_BASEQ_MAP_INFO;
typedef SOC_DNX_IPQ_QUARTET_MAP_INFO                           JER2_ARAD_IPQ_QUARTET_MAP_INFO;

#define JER2_ARAD_IPQ_TR_CLS_MIN        SOC_DNX_IPQ_TR_CLS_MIN
#define JER2_ARAD_IPQ_TR_CLS_MAX        SOC_DNX_IPQ_TR_CLS_MAX
typedef SOC_DNX_IPQ_TR_CLS_RNG          JER2_ARAD_IPQ_TR_CLS_RNG;

#define JER2_ARAD_IPQ_TR_CLS_RNG_LAST   SOC_DNX_IPQ_TR_CLS_RNG_LAST

/* Ingress TC Mapping Profiles (UC, Flow) */
#define JER2_ARAD_NOF_INGRESS_UC_TC_MAPPING_PROFILES    SOC_DNX_NOF_INGRESS_UC_TC_MAPPING_PROFILES
#define JER2_ARAD_NOF_INGRESS_FLOW_TC_MAPPING_PROFILES  SOC_DNX_NOF_INGRESS_FLOW_TC_MAPPING_PROFILES

/* Max & min values for Stak Lag and base_queue:      */
#define JER2_ARAD_IPQ_STACK_LAG_DOMAIN_MIN     SOC_DNX_IPQ_STACK_LAG_DOMAIN_MIN
#define JER2_ARAD_IPQ_STACK_LAG_DOMAIN_MAX     SOC_DNX_IPQ_STACK_LAG_DOMAIN_MAX

#define JER2_ARAD_IPQ_STACK_LAG_STACK_TRUNK_RESOLVE_ENTRY_MIN     SOC_DNX_IPQ_STACK_LAG_STACK_TRUNK_RESOLVE_ENTRY_MIN
#define JER2_ARAD_IPQ_STACK_LAG_STACK_TRUNK_RESOLVE_ENTRY_MAX     SOC_DNX_IPQ_STACK_LAG_STACK_TRUNK_RESOLVE_ENTRY_MAX
#define JER2_ARAD_IPQ_STACK_LAG_STACK_TRUNK_RESOLVE_ENTRY_ALL     SOC_DNX_IPQ_STACK_LAG_STACK_TRUNK_RESOLVE_ENTRY_ALL

#define JER2_ARAD_IPQ_STACK_LAG_STACK_FEC_RESOLVE_ENTRY_MIN     SOC_DNX_IPQ_STACK_LAG_STACK_FEC_RESOLVE_ENTRY_MIN
#define JER2_ARAD_IPQ_STACK_LAG_STACK_FEC_RESOLVE_ENTRY_MAX     SOC_DNX_IPQ_STACK_LAG_STACK_FEC_RESOLVE_ENTRY_MAX
#define JER2_ARAD_IPQ_STACK_LAG_STACK_FEC_RESOLVE_ENTRY_ALL     SOC_DNX_IPQ_STACK_LAG_STACK_FEC_RESOLVE_ENTRY_ALL
...
#define JER2_ARAD_IPQ_DESTINATION_ID_INVALID_QUEUE(unit) (0xffff)
/* } */
...
*********************************************************************/
int
  jer2_arad_ipq_base_q_is_valid_get(
    DNX_SAND_IN  int  unit,
...
int
  jer2_arad_ipq_traffic_class_profile_map_set(
    DNX_SAND_IN  int                unit,
...
int
  jer2_arad_ipq_traffic_class_profile_map_get(
    DNX_SAND_IN  int                unit,
    DNX_SAND_IN  JER2_ARAD_IPQ_TR_CLS_PROFILE  profile_ndx,
    DNX_SAND_IN  uint8                is_flow_profile,
    DNX_SAND_IN  uint8                is_multicast_profile,
