/** \file dnx/swstate/auto_generated/access/cosq_latency_access.h
 *
...
typedef int (*dnx_cosq_latency_db_ingress_latency_res_set_cb)(
    int unit, sw_state_algo_res_t ingress_latency_res);
...
typedef int (*dnx_cosq_latency_db_end_to_end_latency_res_set_cb)(
    int unit, sw_state_algo_res_t end_to_end_latency_res);
...
typedef int (*dnx_cosq_latency_db_queue_template_set_cb)(
    int unit, sw_state_algo_template_t queue_template);
...
typedef int (*dnx_cosq_latency_db_queue_template_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_cosq_latency_queue_template_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*dnx_cosq_latency_db_queue_template_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_cosq_latency_queue_template_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_cosq_latency_db_queue_template_replace_data_cb)(
    int unit, int core_id, int profile,  const dnx_cosq_latency_queue_template_t *new_profile_data);
...
typedef int (*dnx_cosq_latency_db_queue_template_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_cosq_latency_queue_template_t *profile_data);
...
typedef int (*dnx_cosq_latency_db_queue_template_profile_get_cb)(
    int unit, int core_id, const dnx_cosq_latency_queue_template_t *profile_data, int *profile);
