/** \file dnx/swstate/auto_generated/diagnostic/dnx_iqs_diagnostic.h
 *
...
int dnx_iqs_db_credit_request_profile_dump(
    int unit, int credit_request_profile_idx_0);
...
int dnx_iqs_db_credit_watchdog_delete_th_dump(
    int unit, int delete_th_idx_0);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_IQS_DIAGNOSTIC_H__ */
