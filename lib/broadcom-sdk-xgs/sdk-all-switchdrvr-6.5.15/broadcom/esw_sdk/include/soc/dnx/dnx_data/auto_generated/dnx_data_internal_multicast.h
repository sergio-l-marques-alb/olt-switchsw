...
typedef enum
{
    ...
    dnx_data_multicast_params_define_egress_destination_size,
    dnx_data_multicast_params_define_mcdb_ext_format,
 ...
 *   * None
 */
uint32 dnx_data_multicast_params_egress_destination_size_get(
    int unit);
 ...
 *   * None
 */
uint32 dnx_data_multicast_params_mcdb_ext_format_get(
    int unit);
