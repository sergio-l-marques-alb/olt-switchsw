...
/**
 * Total number of bits on all qualifiers selected to indicate the 2 ms bits.
 */
#define DNX_FIELD_NUM_2MSB_BITS_ON_QUALIFIERS (2)

/**
 * Number of action combinations available by using the '2msb' feature.
 */
#define DNX_FIELD_NUM_2MSB_COMBINATIONS SAL_BIT(DNX_FIELD_NUM_2MSB_BITS_ON_QUALIFIERS)
...
/**
 * Invalid indication for 'FEM adder'. See, for example, dnx_field_fem_action_entry_t
 */
#define DNX_FIELD_FEM_ADDER_INVALID ((dnx_field_fem_adder_t)(-1))
...
typedef struct {
     ...
     */
    dnx_field_action_in_group_info_t actions_on_payload_info[DNX_FIELD_NUM_2MSB_COMBINATIONS][DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_ACTION_PER_GROUP];
...
typedef struct {
     ...
     * To mark a non-existent 'adder', the value of DNX_FIELD_FEM_ADDER_INVALID must be used.
     * See dbal_enum_value_field_ipmf1_action_e.
     */
