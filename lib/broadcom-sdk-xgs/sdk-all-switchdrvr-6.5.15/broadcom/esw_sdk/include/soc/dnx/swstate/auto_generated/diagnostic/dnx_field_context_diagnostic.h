...
typedef enum {
    ...
    DNX_FIELD_CONTEXT_SW_CONTEXT_INFO_CONTEXT_IPMF1_INFO_STATE_TABLE_INFO_KEY_ID_INFO,
...
int dnx_field_context_sw_context_info_dump(
    int unit, int context_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_template_key_qual_map_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int key_qual_map_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_id_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int id_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_key_part_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_bit_range_bit_range_was_aligned_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_bit_range_bit_range_aligned_offset_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int attach_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_key_part_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_bit_range_bit_range_was_aligned_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_bit_range_bit_range_aligned_offset_dump(
    int unit, int context_info_idx_0, int key_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_template_key_qual_map_dump(
    int unit, int context_info_idx_0, int key_qual_map_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_id_dump(
    int unit, int context_info_idx_0, int id_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_key_part_dump(
    int unit, int context_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_bit_range_bit_range_was_aligned_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_bit_range_bit_range_aligned_offset_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_dump(
    int unit, int context_info_idx_0, int attach_info_idx_0);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_mode_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_is_set_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_id_dump(
    int unit, int context_info_idx_0, int id_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_key_part_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_bit_range_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_bit_range_bit_range_valid_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_bit_range_bit_range_offset_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_bit_range_bit_range_size_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_bit_range_bit_range_was_aligned_dump(
    int unit, int context_info_idx_0);

int dnx_field_context_sw_context_info_context_ipmf1_info_state_table_info_key_id_bit_range_bit_range_aligned_offset_dump(
    int unit, int context_info_idx_0);
...
int dnx_field_context_sw_context_info_name_dump(
    int unit, int context_info_idx_0, int name_idx_0);
