...
#ifndef __SOC_DNX_API_INGRESS_SCHEDULER_INCLUDED__
/* { */
#define __SOC_DNX_API_INGRESS_SCHEDULER_INCLUDED__
...
#define SOC_DNX_ING_SCH_DONT_TOUCH                (0xFFFFFFFF)
#define SOC_DNX_ING_NUMBER_OF_HIGHEST_LATENCY_PACKETS (8)
/* } */
...
typedef enum
{
   ...
   *  Local destination
   */
  SOC_DNX_ING_SCH_MESH_LOCAL=0,
  /*
   *  FAP-1 destination
   */
  SOC_DNX_ING_SCH_MESH_CON1=1,
  /*
   *  FAP-2 destination
   */
  SOC_DNX_ING_SCH_MESH_CON2=2,
  /*
   *  FAP-3 destination
   */
  SOC_DNX_ING_SCH_MESH_CON3=3,
  /*
   *  FAP-4 destination
   */
  SOC_DNX_ING_SCH_MESH_CON4=4,
  /*
   *  FAP-5 destination
   */
  SOC_DNX_ING_SCH_MESH_CON5=5,
  /*
   *  FAP-6 destination
   */
  SOC_DNX_ING_SCH_MESH_CON6=6,
  /*
   *  FAP-7 destination
   */
  SOC_DNX_ING_SCH_MESH_CON7=7,
  /*
   *  Last value of enumerator
   */
  SOC_DNX_ING_SCH_MESH_LAST=8
}SOC_DNX_ING_SCH_MESH_CONTEXTS;

#define   SOC_DNX_ING_NOF_SCH_MESH_CONTEXTSS SOC_DNX_ING_SCH_MESH_LAST
...
typedef struct
{
   ...
   *  Identifier.
   */
  SOC_DNX_ING_SCH_MESH_CONTEXTS id;
}SOC_DNX_ING_SCH_MESH_CONTEXT_INFO;
...
typedef struct
{
   ...
   */
  SOC_DNX_ING_SCH_MESH_CONTEXT_INFO contexts[SOC_DNX_ING_SCH_MESH_LAST];
  /*
   ...
   */
  SOC_DNX_ING_SCH_SHAPER total_rate_shaper;
}SOC_DNX_ING_SCH_MESH_INFO;
...
typedef struct
{
   ...
   */
  uint32 weight2;
}SOC_DNX_ING_SCH_CLOS_WFQ_ELEMENT;
...
typedef struct
{
   ...
   */
  SOC_DNX_ING_SCH_CLOS_WFQ_ELEMENT fabric_hp;
  /*
   ...
   *  2.3.9 of the UM).
   */
  SOC_DNX_ING_SCH_CLOS_WFQ_ELEMENT fabric_lp;
  /*
   ...
   *  UM).
   */
  SOC_DNX_ING_SCH_CLOS_WFQ_ELEMENT global_hp;
  /*
   ...
   */
  SOC_DNX_ING_SCH_CLOS_WFQ_ELEMENT global_lp;
}SOC_DNX_ING_SCH_CLOS_WFQS;
...
typedef struct
{
   ...
   */
  SOC_DNX_ING_SCH_SHAPER local;
  /*
   *  Shaper of the fabric unicast high priority traffic.
   */
  SOC_DNX_ING_SCH_SHAPER fabric_unicast;
  /*
   *  Shaper of the fabric multicast high priority traffic
   *  (GFMC).
   */
  SOC_DNX_ING_SCH_SHAPER fabric_multicast;

} SOC_DNX_ING_SCH_CLOS_HP_SHAPERS;
...
} SOC_DNX_ING_SCH_CLOS_LP_SHAPERS;
...
typedef struct
{
   ...
   */
  SOC_DNX_ING_SCH_CLOS_SHAPERS shapers;
  /*
   *  Holds the entire weights to be compared in 4 WFQ of two
   *  levels.
   */
  SOC_DNX_ING_SCH_CLOS_WFQS weights;
}SOC_DNX_ING_SCH_CLOS_INFO;
...
/* } __SOC_DNX_API_INGRESS_SCHEDULER_INCLUDED__*/
#endif
