/** \file dnx/swstate/auto_generated/diagnostic/dnx_sch_config_diagnostic.h
 *
...
int cosq_config_flow_dump(
    int unit, int flow_idx_0, int flow_idx_1);
...
int cosq_config_connector_dump(
    int unit, int connector_idx_0, int connector_idx_1);
...
int cosq_config_se_dump(
    int unit, int se_idx_0, int se_idx_1);
...
#endif /* __DNX_SCH_CONFIG_DIAGNOSTIC_H__ */
