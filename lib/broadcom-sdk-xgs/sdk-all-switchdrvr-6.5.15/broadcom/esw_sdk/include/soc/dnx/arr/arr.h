...
#  define ARR_MAX_NUMBER_OF_FORMATS                64

/** \brief ARR max number of fields in formats  */
#  define ARR_MAX_NUMBER_OF_FIELDS_IN_FORMATS      30
...
/**
 * \brief
 *   Initialized the ARR parsing database.
 * \param [in] unit - Unit ID
 * \param [out] arr_info - db struct to initialize
 */
shr_error_e arr_parse_file(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_arr_decode_data_type_get(
    int unit,
    uint32 *data,
    uint32 size,
    uint32 *data_type);
