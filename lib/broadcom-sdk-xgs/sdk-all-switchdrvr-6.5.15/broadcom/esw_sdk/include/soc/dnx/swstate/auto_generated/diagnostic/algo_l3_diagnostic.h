/** \file dnx/swstate/auto_generated/diagnostic/algo_l3_diagnostic.h
 *
...
typedef enum {
    ...
    ALGO_L3_DB_FEC_ALLOC_L3_FEC_HIERARCHY_INFO,
...
int algo_l3_db_source_address_table_allocation_res_tag_bitmap_dump(
    int unit);
...
int algo_l3_db_fec_alloc_l3_fec_res_mngr_fec_res_manager_dump(
    int unit, int sub_resource_id);

int algo_l3_db_fec_alloc_l3_fec_res_mngr_resource_is_part_of_pair_dump(
    int unit, int resource_is_part_of_pair_idx_0);

int algo_l3_db_fec_alloc_l3_fec_hierarchy_dump(
    int unit);

int algo_l3_db_fec_alloc_l3_fec_hierarchy_fec_hierarchy_map_dump(
    int unit, int fec_hierarchy_map_idx_0);

int algo_l3_db_fec_alloc_fec_resource_type_dump(
    int unit, int fec_resource_type_idx_0, int fec_resource_type_idx_1);
...
int algo_l3_db_algo_l3_templates_ecmp_profile_hier_table_dump(
    int unit, int ecmp_profile_hier_table_idx_0);
