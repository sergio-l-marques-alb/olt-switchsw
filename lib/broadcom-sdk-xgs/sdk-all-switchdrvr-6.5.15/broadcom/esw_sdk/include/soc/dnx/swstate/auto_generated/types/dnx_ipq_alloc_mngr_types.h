/** \file dnx/swstate/auto_generated/types/dnx_ipq_alloc_mngr_types.h
 *
...
typedef struct {
    ...
    /**
     * Max queue used as MC. only relevant when in FMQ enhanced mode
     */
    uint32 max_mc_queue;
...
/**
 * Map TC to VOQ offset
 */
typedef struct {
    /**
     * tc to voq offset mapping
     */
    uint32 tc[DNX_COSQ_NOF_TC];
} dnx_ipq_tc_map_t;
...
typedef struct {
     ...
     */
    sw_state_algo_res_t ipq_alloc_mngr;
    /**
     * TC mapping profile template for flow based forwarding
     */
    sw_state_algo_template_t tc_voq_flow_map;
    /**
     * TC mapping profile template for system port forwarding
     */
    sw_state_algo_template_t tc_sysport_map;
