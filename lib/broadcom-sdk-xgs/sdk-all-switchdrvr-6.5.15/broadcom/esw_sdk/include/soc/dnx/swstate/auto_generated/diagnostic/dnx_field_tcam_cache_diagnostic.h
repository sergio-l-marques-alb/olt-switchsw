...
int dnx_field_tcam_cache_shadow_tcam_bank_dump(
    int unit, int tcam_bank_idx_0, int tcam_bank_idx_1);

int dnx_field_tcam_cache_shadow_tcam_bank_entry_key_dump(
    int unit, int tcam_bank_idx_0, int tcam_bank_idx_1, int entry_key_idx_0, int entry_key_idx_1);

int dnx_field_tcam_cache_shadow_payload_table_dump(
    int unit, int payload_table_idx_0, int payload_table_idx_1);

int dnx_field_tcam_cache_shadow_payload_table_entry_payload_dump(
    int unit, int payload_table_idx_0, int payload_table_idx_1, int entry_payload_idx_0, int entry_payload_idx_1);
