/** \file dnx/swstate/auto_generated/access/algo_failover_access.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/algo_failover_types.h>
...
typedef int (*algo_failover_db_fec_path_select_set_cb)(
    int unit, sw_state_algo_res_t fec_path_select);
...
typedef int (*algo_failover_db_ing_path_select_set_cb)(
    int unit, sw_state_algo_res_t ing_path_select);
...
typedef int (*algo_failover_db_egr_path_select_set_cb)(
    int unit, sw_state_algo_res_t egr_path_select);
