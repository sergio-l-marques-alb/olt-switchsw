...
#define JER2_ARAD_EGQ_NIF_SCM_TBL_ENTRY_SIZE                                                 3
...
#define JER2_ARAD_IQM_VSQ_QUEUE_PARAMETERS_TABLE_GROUP_TBL_DATA SOC_DNX_IQM_VSQ_QUEUE_PARAMETERS_TABLE_GROUP_TBL_DATA
...
typedef struct
{
  ...
  uint32 parity;
}  JER2_ARAD_IRE_NIF_CTXT_MAP_TBL_DATA;

typedef struct
{
  uint32 contexts_bit_mapping[6];
  uint32 parity;
}  JER2_ARAD_IRE_NIF_PORT_TO_CTXT_BIT_MAP_TBL_DATA;
...
typedef struct
{
  ...
  uint32 port_termination_context;
  uint32 parity;
}  JER2_ARAD_IRE_RCY_CTXT_MAP_TBL_DATA;
...
typedef struct
{
  ...
  uint32 port_termination_context;
  uint32 parity;
}  JER2_ARAD_IRE_CPU_CTXT_MAP_TBL_DATA;
...
typedef struct
{
  ...
  uint32 reserved;
  uint32 parity;
}  JER2_ARAD_IDR_ETHERNET_METER_STATUS_TBL_DATA;

typedef struct
{
  uint32 time_stamp;
  uint32 level;
}  JER2_ARAD_IDR_GLOBAL_METER_STATUS_TBL_DATA;
...
typedef struct
{
  ...
  uint32 dp_ow;
  uint32 parity;
}  JER2_ARAD_IRR_SNOOP_MIRROR_TABLE0_TBL_DATA;
...
typedef struct
{
  ...
  uint32 dp_cmd_ow;
  uint32 parity;
}  JER2_ARAD_IRR_SNOOP_MIRROR_TABLE1_TBL_DATA;

typedef struct
{
  uint32 ecc;
  uint32 pcp;
}  JER2_ARAD_IRR_FREE_PCB_MEMORY_TBL_DATA;

typedef struct
{
  uint32 ecc;
  uint32 pcp;
}  JER2_ARAD_IRR_PCB_LINK_TABLE_TBL_DATA;

typedef struct
{
  uint32 ecc;
  uint32 is_pcp;
}  JER2_ARAD_IRR_IS_FREE_PCB_MEMORY_TBL_DATA;

typedef struct
{
  uint32 ecc;
  uint32 is_pcp;
}  JER2_ARAD_IRR_IS_PCB_LINK_TABLE_TBL_DATA;

typedef struct
{
  uint32 ecc;
  uint32 pointer;
}  JER2_ARAD_IRR_RPF_MEMORY_TBL_DATA;

typedef struct
{
  uint32 descriptor[3];
  uint32 ecc;
}  JER2_ARAD_IRR_MCR_MEMORY_TBL_DATA;

typedef struct
{
  uint32 descriptor[2];
  uint32 ecc;
}  JER2_ARAD_IRR_ISF_MEMORY_TBL_DATA;
...
typedef struct
{
  ...
  uint32 parity;
  uint8 is_stateful;
}  JER2_ARAD_IRR_LAG_TO_LAG_RANGE_TBL_DATA;
...
typedef struct
{
  uint32 destination;
  uint32 parity;
}  JER2_ARAD_IRR_LAG_MAPPING_TBL_DATA;

typedef struct
{
  uint32 offset;
  uint32 parity;
}  JER2_ARAD_IRR_LAG_NEXT_MEMBER_TBL_DATA;

typedef struct
{
  uint32 member;
  uint32 parity;
}  JER2_ARAD_IRR_SMOOTH_DIVISION_TBL_DATA;
...
typedef struct
{
  uint32 stack_lag;
  uint32 parity;
}  JER2_ARAD_IRR_STACK_FEC_RESOLVE_TBL_DATA;
...
{
  uint32 qdr_dll_mem;
}  JER2_ARAD_QDR_QDR_DLL_MEM_TBL_DATA;
...
typedef struct
{
  ...
  uint32 cp_class;
  uint32 cp_id;
}  JER2_ARAD_IQM_CNM_DESCRIPTOR_STATIC_TBL_DATA;

typedef struct
{
  uint32 cp_enqued1;
  uint32 cp_qsize_old;
}  JER2_ARAD_IQM_CNM_DESCRIPTOR_DYNAMIC_TBL_DATA;
...
}  JER2_ARAD_IQM_CNM_PARAMETERS_TABLE_TBL_DATA;
...
typedef struct
{
  ...
  uint32 cp_profile_2;
  uint32 cp_id;
} JER2_ARAD_IQM_CNM_DS_TBL_DATA;

typedef struct
{
  uint32 iqm_dp;
  uint32 etm_de;
}  JER2_ARAD_IQM_METER_PROCESSOR_RESULT_RESOLVE_TABLE_STATIC_TBL_DATA;
...
typedef struct
{
  ...
  uint32 cbl;
  uint32 ebl;
}  JER2_ARAD_IQM_NORMAL_DYNAMICA_TBL_DATA;
...
typedef struct
{
  ...
  uint32 cbl;
  uint32 ebl;
}  JER2_ARAD_IQM_NORMAL_DYNAMICB_TBL_DATA;
...
typedef struct
{
  ...
  uint32 cbl;
  uint32 ebl;
}  JER2_ARAD_IQM_HIGH_DYNAMICA_TBL_DATA;
...
typedef struct
{
  ...
  uint32 cbl;
  uint32 ebl;
}  JER2_ARAD_IQM_HIGH_DYNAMICB_TBL_DATA;
...
}  JER2_ARAD_IQM_CNTS_MEM_TBL_DATA;

typedef struct
{
  uint32 ovth_counter_bits[2];
}  JER2_ARAD_IQM_OVTH_MEMA_TBL_DATA;

typedef struct
{
  uint32 ovth_counter_bits[2];
}  JER2_ARAD_IQM_OVTH_MEMB_TBL_DATA;

typedef struct
{
  uint32 sop_mmu[3];
}  JER2_ARAD_IPT_SOP_MMU_TBL_DATA;


typedef struct
{
  uint32 cfg_byte_cnt[2];
}  JER2_ARAD_IPT_CFG_BYTE_CNT_TBL_DATA;

typedef struct
{
  uint32 egq_txq_wr_addr;
}  JER2_ARAD_IPT_EGQ_TXQ_WR_ADDR_TBL_DATA;

typedef struct
{
  uint32 egq_txq_rd_addr;
}  JER2_ARAD_IPT_EGQ_TXQ_RD_ADDR_TBL_DATA;
...
typedef struct
{
  ...
  uint32 dtq5_wr_addr;
  uint32 dtq6_wr_addr;
}  JER2_ARAD_IPT_FDT_TXQ_WR_ADDR_TBL_DATA;
...
typedef struct
{
  ...
  uint32 dtq5_rd_addr;
  uint32 dtq6_rd_addr;
}  JER2_ARAD_IPT_FDT_TXQ_RD_ADDR_TBL_DATA;
...
typedef struct
{
  ...
  uint32 mask2;
  uint32 mask3;
}  JER2_ARAD_IPT_GCI_BACKOFF_MASK_TBL_DATA;


typedef struct
{
  uint32 ipt_contro_l_fifo[2];
}  JER2_ARAD_FDT_IPT_CONTRO_L_FIFO_TBL_DATA;
...
}  JER2_ARAD_EGQ_QM_TBL_DATA;

typedef struct
{
  uint32 qsm;
}  JER2_ARAD_EGQ_QSM_TBL_DATA;

typedef struct
{
  uint32 dcm;
}  JER2_ARAD_EGQ_DCM_TBL_DATA;

typedef struct
{
  uint32 mc_high_queue_weight;
  uint32 uc_high_queue_weight;
}  JER2_ARAD_EGQ_DWM_NEW_TBL_DATA;
...
}  JER2_ARAD_EGQ_TC_DP_MAP_TBL_ENTRY;
...
}  JER2_ARAD_EGQ_KEY_PROFILE_MAP_INDEX_TBL_DATA;
...
typedef struct
{
  ...
  uint32 key_or_value;
  uint32 tcam_profile;
}  JER2_ARAD_EGQ_TCAM_KEY_RESOLUTION_PROFILE_TBL_DATA;

typedef struct
{
  uint32 parser_last_sys_record[8];
}  JER2_ARAD_EGQ_PARSER_LAST_SYS_RECORD_TBL_DATA;

typedef struct
{
  uint32 parser_last_nwk_record1[8];
}  JER2_ARAD_EGQ_PARSER_LAST_NWK_RECORD1_TBL_DATA;

typedef struct
{
  uint32 parser_last_nwk_record2[2];
}  JER2_ARAD_EGQ_PARSER_LAST_NWK_RECORD2_TBL_DATA;

typedef struct
{
  uint32 erpp_debug[8];
}  JER2_ARAD_EGQ_ERPP_DEBUG_TBL_DATA;
...
typedef struct
{
  ...
  uint32 egq_hp_valid;
  uint32 egq_lp_valid;
}  JER2_ARAD_CFC_RCL2_OFP_TBL_DATA;
...
}  JER2_ARAD_CFC_NIFCLSB2_OFP_TBL_DATA;
...
}  JER2_ARAD_CFC_HCFC_BITMAP_TBL_DATA;
...
typedef struct
{
  ...
  uint32 lp_ofp_valid;
  uint32 hp_ofp_valid;
}  JER2_ARAD_CFC_OOB_SCH_MAP_TBL_DATA;
...
}  JER2_ARAD_IHP_TM_PORT_SYS_PORT_CONFIG_TBL_DATA;
 ...
 */
uint32
  jer2_arad_olp_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
 ...
 */
uint32
  jer2_arad_ire_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_idr_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_irr_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_qdr_set_reps_for_tbl(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              nof_reps
  );
 ...
 */
uint32
  jer2_arad_iqm_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_ips_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );

uint32
  jer2_arad_ipt_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );

uint32
  jer2_arad_dpi_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
 ...
 */
uint32
  jer2_arad_rtp_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_egq_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_cfc_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
uint32
  jer2_arad_sch_set_reps_for_tbl(
    DNX_SAND_IN   int  unit,
    DNX_SAND_IN   uint32   nof_reps
  );
 ...
 */
int
  jer2_arad_ire_nif_ctxt_map_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_nif_ctxt_map_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ire_nif_port2ctxt_bit_map_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ire_nif_port2ctxt_bit_map_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_rcy_ctxt_map_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_rcy_ctxt_map_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_cpu_ctxt_map_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_cpu_ctxt_map_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_idr_complete_pc_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_idr_complete_pc_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_mirror_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_mirror_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_snoop_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_snoop_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_glag_to_lag_range_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_glag_to_lag_range_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_irr_smooth_division_tbl_get(
    DNX_SAND_IN   int             unit,
 ...
 */
int
  jer2_arad_irr_smooth_division_tbl_set(
    DNX_SAND_IN   int             unit,
 ...
 */
uint32
  jer2_arad_irr_glag_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
 ...
 */
uint32
  jer2_arad_irr_glag_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              lag_ndx,
    DNX_SAND_IN   uint32              port_ndx,
 ...
 */
uint32
  jer2_arad_irr_glag_next_member_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_glag_next_member_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_rlag_next_member_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_rlag_next_member_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_bdb_link_list_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_bdb_link_list_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_packet_queue_tail_pointer_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_packet_queue_tail_pointer_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_packet_queue_red_weight_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_packet_queue_red_weight_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_credit_discount_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_credit_discount_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_full_user_count_memory_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_full_user_count_memory_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_mini_multicast_user_count_memory_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_mini_multicast_user_count_memory_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_packet_queue_red_parameters_table_tbl_get(
    DNX_SAND_IN   int                                             unit,
 ...
 */
uint32
  jer2_arad_iqm_packet_queue_red_parameters_table_tbl_set(
    DNX_SAND_IN   int                                             unit,
    DNX_SAND_IN   uint32                                              rt_cls_ndx,
    DNX_SAND_IN   uint32                                             drop_precedence_ndx,
 ...
 */
int
  jer2_arad_iqm_packet_queue_red_parameters_table_tbl_fill(
    DNX_SAND_IN   int                                             unit,
    DNX_SAND_IN   JER2_ARAD_IQM_PACKET_QUEUE_RED_PARAMETERS_TABLE_TBL_DATA* IQM_packet_queue_red_parameters_table_tbl_data
  );

uint32
  jer2_arad_IQM_packet_descriptor_fifos_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_IQM_packet_descriptor_fifos_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_IQM_tx_descriptor_fifos_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_IQM_tx_descriptor_fifos_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_a_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_a_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_b_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_b_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_c_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_c_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_d_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_descriptor_rate_class_group_d_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_a_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_a_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_b_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_b_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_c_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_c_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_d_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_qsize_memory_group_d_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_a_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_a_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_b_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_b_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_c_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_c_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_d_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_vsq_average_qsize_memory_group_d_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_flow_control_parameters_table_group_tbl_get(
    DNX_SAND_IN   int             unit,
 ...
 */
int
  jer2_arad_iqm_vsq_flow_control_parameters_table_group_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              group_id,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_vsq_queue_parameters_table_group_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              group_id,
 ...
 */
int
  jer2_arad_iqm_vsq_queue_parameters_table_group_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              group_id,
    DNX_SAND_IN   uint32              vsq_rt_cls_ndx,
    DNX_SAND_IN   uint32             drop_precedence_ndx,
 ...
 */
int
  jer2_arad_iqm_vsq_queue_parameters_table_group_tbl_fill(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   JER2_ARAD_IQM_VSQ_QUEUE_PARAMETERS_TABLE_GROUP_TBL_DATA* IQM_vsq_queue_parameters_table_group_tbl_data
  );

int
  jer2_arad_iqm_vsq_flow_control_parameters_table_group_tbl_fill(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   JER2_ARAD_IQM_VSQ_FLOW_CONTROL_PARAMETERS_TABLE_GROUP_TBL_DATA* iqm_vsq_flow_control_parameters_table_group_tbl_data
  );
 ...
 */
int
  jer2_arad_iqm_system_red_parameters_table_tbl_get(
    DNX_SAND_IN   int                                       unit,
    DNX_SAND_IN   uint32                                        rt_cls_ndx,
    DNX_SAND_IN   uint32                                       drop_precedence_ndx,
 ...
 */
int
  jer2_arad_iqm_system_red_parameters_table_tbl_set(
    DNX_SAND_IN   int                                       unit,
    DNX_SAND_IN   uint32                                        rt_cls_ndx,
    DNX_SAND_IN   uint32                                       drop_precedence_ndx,
 ...
 */
int
  jer2_arad_iqm_system_red_drop_probability_values_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_system_red_drop_probability_values_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_system_red_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_iqm_system_red_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_qdr_qdr_dll_mem_tbl_get(
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  uint32                       entry_offset,
 ...
 */
uint32
  jer2_arad_qdr_qdr_dll_mem_tbl_set(
    DNX_SAND_IN  int                      unit,
    DNX_SAND_IN  uint32                       entry_offset,
 ...
 */
int
  jer2_arad_indirect_base_queue_to_system_physical_port_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32          entry_offset,
...
/*
 * Write indirect table system_physical_port_lookup_table_tbl from block IPS, CGM
 */
int
  jer2_arad_indirect_base_queue_to_system_physical_port_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32          entry_offset,
...
int
  jer2_arad_indirect_base_queue_to_system_physical_port_tbl_region_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32          entry_offset,
    DNX_SAND_IN   uint32          region_size,
    DNX_SAND_IN   uint32          system_port
  );
 ...
 */
int
  jer2_arad_ips_queue_type_lookup_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   int             core,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_type_lookup_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   int             core,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_priority_map_select_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_priority_map_select_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_priority_maps_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_priority_maps_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_size_based_thresholds_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_queue_size_based_thresholds_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_credit_balance_based_thresholds_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_credit_balance_based_thresholds_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_empty_queue_credit_balance_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_empty_queue_credit_balance_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_credit_watchdog_thresholds_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_ips_credit_watchdog_thresholds_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ips_queue_descriptor_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ips_queue_descriptor_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ips_queue_size_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ips_queue_size_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ips_system_red_max_queue_size_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_ips_system_red_max_queue_size_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_rtp_unicast_distribution_memory_for_data_cells_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_rtp_unicast_distribution_memory_for_data_cells_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_rtp_unicast_distribution_memory_for_control_cells_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_rtp_unicast_distribution_memory_for_control_cells_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_nifab_nch_scm_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_nifab_nch_scm_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
...
int
  jer2_arad_egq_per_port_lb_range_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32             entry_offset,
...
int
  jer2_arad_egq_per_port_lb_range_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_vlan_table_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_vlan_table_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_cfc_flow_control_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_cfc_flow_control_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_nifa_flow_control_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_nifa_flow_control_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_nifb_flow_control_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_nifb_flow_control_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_cpu_last_header_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_cpu_last_header_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ipt_last_header_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ipt_last_header_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_fdr_last_header_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_fdr_last_header_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_cpu_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_cpu_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ipt_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ipt_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_fdr_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_fdr_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_rqp_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_rqp_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_rqp_discard_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_rqp_discard_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_unicast_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_unicast_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_multicast_high_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_multicast_high_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_multicast_low_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_multicast_low_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_discard_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_ehp_discard_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_high_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_high_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_low_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_low_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_high_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_high_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_low_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_low_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_high_bytes_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_high_bytes_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_low_bytes_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_unicast_low_bytes_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_high_bytes_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_high_bytes_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_low_bytes_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_multicast_low_bytes_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_discard_unicast_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_discard_unicast_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_discard_multicast_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_pqp_discard_multicast_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_fqp_packet_counter_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_fqp_packet_counter_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_recycle_to_out_going_fap_port_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_recycle_to_out_going_fap_port_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_nif_a_class_based_to_ofp_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_nif_a_class_based_to_ofp_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_nif_b_class_based_to_ofp_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_nif_b_class_based_to_ofp_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_a_schedulers_based_flow_control_to_ofp_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_a_schedulers_based_flow_control_to_ofp_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_b_schedulers_based_flow_control_to_ofp_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_b_schedulers_based_flow_control_to_ofp_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_out_of_band_rx_a_calendar_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_out_of_band_rx_a_calendar_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_out_of_band_rx_b_calendar_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_out_of_band_rx_b_calendar_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_out_of_band_tx_calendar_mapping_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_out_of_band_tx_calendar_mapping_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_sch_jer2_tmc_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_sch_jer2_tmc_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_sch_scheduler_init_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_sch_force_status_message_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   int             core,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
int
  jer2_arad_mmu_dram_address_space_info_get(
    DNX_SAND_IN    int                               unit,
 ...
 */
uint32
  jer2_arad_mmu_dram_address_space_tbl_get(
    DNX_SAND_IN   int                               unit,
    DNX_SAND_IN   uint32                                dram_ndx,
    DNX_SAND_IN   uint32                                bank_ndx,
    DNX_SAND_IN   uint32                                row_ndx,
 ...
 */
uint32
  jer2_arad_mmu_dram_address_space_tbl_set(
    DNX_SAND_IN   int                               unit,
    DNX_SAND_IN   uint32                                dram_ndx,
    DNX_SAND_IN   uint32                                bank_ndx,
    DNX_SAND_IN   uint32                                row_ndx,
 ...
 */
uint32
  jer2_arad_mmu_rdfa_waddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfa_waddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfb_waddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfb_waddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfc_waddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfc_waddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfd_waddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfd_waddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfe_waddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdfe_waddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdff_waddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdff_waddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdf_raddr_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rdf_raddr_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waf_halfa_waddr_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waf_halfa_waddr_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waf_halfb_waddr_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waf_halfb_waddr_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafa_halfa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafa_halfa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafb_halfa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafb_halfa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafc_halfa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafc_halfa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafd_halfa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafd_halfa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafe_halfa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafe_halfa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waff_halfa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waff_halfa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafa_halfb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafa_halfb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafb_halfb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafb_halfb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafc_halfb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafc_halfb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafd_halfb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafd_halfb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafe_halfb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_wafe_halfb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waff_halfb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_waff_halfb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_raf_waddr_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_raf_waddr_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafa_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafa_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafb_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafb_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafc_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafc_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafd_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafd_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafe_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_rafe_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_raff_raddr_status_tbl_get(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_mmu_raff_raddr_status_tbl_set(
    DNX_SAND_IN   int             unit,
    DNX_SAND_IN   uint32              entry_offset,
...
uint32
  jer2_arad_ipt_select_source_sum_get(
    DNX_SAND_IN   int             unit,
 ...
 */
uint32
  jer2_arad_mmu_set_reps_for_tbl(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              nof_reps
  );
 ...
 */
uint32
  jer2_arad_fdt_set_reps_for_tbl(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              nof_reps
  );
 ...
 */
int
  jer2_arad_ire_nif_port_to_ctxt_bit_map_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_nif_port_to_ctxt_bit_map_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_tdm_config_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_ire_tdm_config_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_idr_context_mru_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_idr_context_mru_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_free_pcb_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_free_pcb_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_pcb_link_table_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_pcb_link_table_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_is_free_pcb_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_is_free_pcb_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_is_pcb_link_table_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_is_pcb_link_table_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_rpf_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_rpf_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_mcr_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_mcr_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_isf_memory_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_irr_isf_memory_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_irr_lag_to_lag_range_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_irr_lag_to_lag_range_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_irr_lag_mapping_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN   uint32              lag_ndx,
    DNX_SAND_IN   uint32              port_ndx,
 ...
 */
int
  jer2_arad_irr_lag_mapping_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN   uint32              lag_ndx,
    DNX_SAND_IN   uint32              port_ndx,
 ...
 */
uint32
  jer2_arad_irr_lag_next_member_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_irr_lag_next_member_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_irr_traffic_class_mapping_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  int             core_id,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_irr_traffic_class_mapping_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  int             core_id,
    DNX_SAND_IN  uint32              entry_offset,
...
int
  jer2_arad_irr_stack_trunk_resolve_table_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32             entry_offset,
...
int
  jer2_arad_irr_stack_trunk_resolve_table_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_ovth_mema_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_ovth_mema_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_ovth_memb_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_iqm_ovth_memb_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_cfg_byte_cnt_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_cfg_byte_cnt_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_egq_txq_wr_addr_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_egq_txq_wr_addr_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_egq_txq_rd_addr_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_egq_txq_rd_addr_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_fdt_txq_wr_addr_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_fdt_txq_wr_addr_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_fdt_txq_rd_addr_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_fdt_txq_rd_addr_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_gci_backoff_mask_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_ipt_gci_backoff_mask_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_fdt_ipt_contro_l_fifo_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_egq_fqp_nif_port_mux_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_egq_fqp_nif_port_mux_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_egq_pqp_nif_port_mux_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_egq_pqp_nif_port_mux_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_key_profile_map_index_tbl_get(
    DNX_SAND_IN  int             unit,
 ...
 */
uint32
  jer2_arad_egq_key_profile_map_index_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              fwd_type_ndx,
    DNX_SAND_IN  uint32              acl_profile_ndx,
 ...
 */
uint32
  jer2_arad_egq_tcam_key_resolution_profile_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_egq_tcam_key_resolution_profile_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_parser_last_sys_record_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_parser_last_sys_record_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_parser_last_nwk_record1_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_parser_last_nwk_record1_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_parser_last_nwk_record2_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_parser_last_nwk_record2_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_erpp_debug_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
...
uint32
  jer2_arad_egq_erpp_debug_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_rcl2_ofp_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_rcl2_ofp_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_nifclsb2_ofp_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_nifclsb2_ofp_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_cfc_oob_calrx_tbl_get(
    DNX_SAND_IN  int             unit,
 ...
 */
int
  jer2_arad_cfc_oob_calrx_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_oob_sch_map_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_oob_sch_map_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_cfc_oob_caltx_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_cfc_oob_caltx_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
 ...
 */
int
  jer2_arad_cfc_ilkn_calrx_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
    DNX_SAND_OUT JER2_ARAD_CFC_CALRX_TBL_DATA  *tbl_data
 ...
 */
int
  jer2_arad_cfc_ilkn_calrx_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
    DNX_SAND_IN  JER2_ARAD_CFC_CALRX_TBL_DATA  *tbl_data
...
int
  jer2_arad_cfc_hcfc_bitmap_tbl_set(
    DNX_SAND_IN  int  unit,
    DNX_SAND_IN  uint32  entry_offset,
...
int
  jer2_arad_cfc_hcfc_bitmap_tbl_get(
    DNX_SAND_IN  int  unit,
    DNX_SAND_IN  uint32  entry_offset,
 ...
 */
uint32
  jer2_arad_cfc_ilkn_sch_map_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
    DNX_SAND_OUT JER2_ARAD_CFC_OOB_SCH_MAP_TBL_DATA  *tbl_data
 ...
 */
uint32
  jer2_arad_cfc_ilkn_sch_map_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
    DNX_SAND_IN  JER2_ARAD_CFC_OOB_SCH_MAP_TBL_DATA  *tbl_data
 ...
 */
int
  jer2_arad_cfc_ilkn_caltx_tbl_get(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
    DNX_SAND_OUT JER2_ARAD_CFC_CALTX_TBL_DATA  *tbl_data
 ...
 */
int
  jer2_arad_cfc_ilkn_caltx_tbl_set(
    DNX_SAND_IN  int             unit,
    DNX_SAND_IN  SOC_DNX_FC_OOB_ID          if_ndx,
    DNX_SAND_IN  uint32              entry_offset,
    DNX_SAND_IN  JER2_ARAD_CFC_CALTX_TBL_DATA  *tbl_data
...
uint32
  jer2_arad_iqm_cnm_profile_tbl_get (
    DNX_SAND_IN  int                                   unit,
...
uint32
  jer2_arad_iqm_cnm_profile_tbl_set (
    DNX_SAND_IN  int                                   unit,
    DNX_SAND_IN  uint32                                   profile_ndx,
...
shr_error_e jer2_arad_tbl_access_deinit(DNX_SAND_IN int unit);

shr_error_e jer2_arad_tbl_access_init(DNX_SAND_IN int unit);

shr_error_e _jer2_arad_palladium_backdoor_dispatch_full_table_write(
           DNX_SAND_IN int unit,
