/** \file dnx/swstate/auto_generated/access/algo_l2_access.h
 *
...
typedef int (*algo_l2_db_event_forwarding_profile_set_cb)(
    int unit, sw_state_algo_template_t event_forwarding_profile);
...
typedef int (*algo_l2_db_event_forwarding_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_event_forwarding_profile_info_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_l2_db_event_forwarding_profile_replace_data_cb)(
    int unit, int core_id, int profile,  const dnx_event_forwarding_profile_info_t *new_profile_data);
...
typedef int (*algo_l2_db_event_forwarding_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_event_forwarding_profile_info_t *profile_data);
...
typedef int (*algo_l2_db_vsi_learning_profile_set_cb)(
    int unit, sw_state_algo_template_t vsi_learning_profile);
...
typedef int (*algo_l2_db_vsi_learning_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_vsi_learning_profile_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_l2_db_vsi_learning_profile_replace_data
 */
typedef int (*algo_l2_db_vsi_learning_profile_replace_data_cb)(
    int unit, int core_id, int profile,  const dnx_vsi_learning_profile_info_t *new_profile_data);
...
typedef int (*algo_l2_db_vsi_learning_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_vsi_learning_profile_info_t *profile_data);
...
typedef int (*algo_l2_db_vsi_aging_profile_set_cb)(
    int unit, sw_state_algo_template_t vsi_aging_profile);
...
typedef int (*algo_l2_db_vsi_aging_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_aging_profile_info_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_l2_db_vsi_aging_profile_replace_data_cb)(
    int unit, int core_id, int profile,  const dnx_aging_profile_info_t *new_profile_data);

/**
 * implemented by: algo_l2_db_vsi_aging_profile_profile_data_get
 */
typedef int (*algo_l2_db_vsi_aging_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_aging_profile_info_t *profile_data);
