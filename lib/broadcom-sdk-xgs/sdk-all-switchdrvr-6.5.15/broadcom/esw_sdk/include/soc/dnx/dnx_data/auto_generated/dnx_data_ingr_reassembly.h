...
{
    /**
     * Base address table is used for NIF ports only
     */
    dnx_data_ingr_reassembly_context_base_addr_for_nif_only,
 ...
 */
/**
 * \brief Holds values of submodule ilkn table dedicated_tdm_context
 * Table info:
...
{
    /**
     * enable/disable dedicated tdm mode
     */
    uint32 is_dedicated;
} dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t;
 ...
 *   * None
 */
typedef const dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t *(
    *dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_get_f) (
    int unit,
    int ilkn_id);
...
typedef struct
{
    ...
    /**
     * get table dedicated_tdm_context entry 
     */
    dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_get_f dedicated_tdm_context_get;
    /**
     * get general info table about table (for example key size)dedicated_tdm_context info
     */
    dnxc_data_table_info_get_f dedicated_tdm_context_info_get;
