/** \file dnx/swstate/auto_generated/access/algo_consistent_hashing_access.h
 *
...
typedef int (*consistent_hashing_manager_chm_templates_set_cb)(
    int unit, uint32 chm_templates_idx_0, sw_state_algo_template_t chm_templates);
...
typedef int (*consistent_hashing_manager_chm_templates_create_cb)(
    int unit, uint32 chm_templates_idx_0, sw_state_algo_template_create_data_t * data, void *extra_arguments);
...
typedef int (*consistent_hashing_manager_chm_templates_allocate_single_cb)(
    int unit, uint32 chm_templates_idx_0, int core_id, uint32 flags, dnx_algo_consistent_hashing_manager_template_manager_key_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*consistent_hashing_manager_chm_templates_free_single_cb)(
    int unit, uint32 chm_templates_idx_0, int core_id, int profile, uint8 *last_reference);
...
typedef int (*consistent_hashing_manager_chm_templates_profile_data_get_cb)(
    int unit, uint32 chm_templates_idx_0, int core_id, int profile, int *ref_count, dnx_algo_consistent_hashing_manager_template_manager_key_t *profile_data);
