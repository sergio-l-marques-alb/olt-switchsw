...
/**
 * \brief returns define data of nof
...
/**
 * \brief returns define data of nof_lb_keys_per_profile
...
/**
 * \brief returns define data of invalid_out_port
 * Module - 'trunk', Submodule - 'egress_trunk', data - 'invalid_out_port'
 * invalid out port for egress trunk
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     invalid_out_port - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_trunk_egress_trunk_invalid_out_port_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of nof
     */
    dnx_data_trunk_egress_trunk_nof_get_f nof_get;
    /**
     * returns define data of nof_lb_keys_per_profile
     */
    dnx_data_trunk_egress_trunk_nof_lb_keys_per_profile_get_f nof_lb_keys_per_profile_get;
    /**
     * returns define data of invalid_out_port
     */
    dnx_data_trunk_egress_trunk_invalid_out_port_get_f invalid_out_port_get;
