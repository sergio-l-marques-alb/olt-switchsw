...
int dbal_db_tables_properties_dump(
    int unit, int tables_properties_idx_0);
...
int dbal_db_dbal_dynamic_tables_dump(
    int unit, int dbal_dynamic_tables_idx_0);

int dbal_db_dbal_dynamic_tables_table_id_dump(
    int unit, int dbal_dynamic_tables_idx_0);

int dbal_db_dbal_dynamic_tables_table_name_dump(
    int unit, int dbal_dynamic_tables_idx_0, int table_name_idx_0);

int dbal_db_dbal_dynamic_tables_labels_dump(
    int unit, int dbal_dynamic_tables_idx_0, int labels_idx_0);

int dbal_db_dbal_dynamic_tables_data_dump(
    int unit, int dbal_dynamic_tables_idx_0);

int dbal_db_dbal_dynamic_tables_key_info_data_dump(
    int unit, int dbal_dynamic_tables_idx_0, int key_info_data_idx_0);

int dbal_db_dbal_dynamic_tables_multi_res_info_data_dump(
    int unit, int dbal_dynamic_tables_idx_0, int multi_res_info_data_idx_0);

int dbal_db_dbal_dynamic_tables_res_info_data_dump(
    int unit, int dbal_dynamic_tables_idx_0, int res_info_data_idx_0, int res_info_data_idx_1);

int dbal_db_dbal_dynamic_tables_access_info_dump(
    int unit, int dbal_dynamic_tables_idx_0, int access_info_idx_0);

int dbal_db_dbal_fields_dump(
    int unit, int dbal_fields_idx_0);
...
int dbal_db_dbal_ppmc_table_res_types_multi_res_info_data_sep_res_info_data_dump(
    int unit, int multi_res_info_data_sep_idx_0, int res_info_data_idx_0);
