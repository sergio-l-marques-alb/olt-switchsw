...
#ifndef __SOC_DNX_API_CNM_INCLUDED__
/* { */
#define __SOC_DNX_API_CNM_INCLUDED__
...
#define  SOC_DNX_CNM_NOF_SAMPLING_BASES (8)

/*     Number of uint32s in the CP Id field in the PDU header    */
#define  SOC_DNX_CNM_NOF_UINT32S_IN_CP_ID (2)

/*     Number of CP profiles                                   */
#define  SOC_DNX_CNM_NOF_PROFILES (8)
...
typedef enum
{
   ...
   */
  SOC_DNX_CNM_GEN_MODE_SAMPLING = 2,

  /* Same as Petra-B PP */
  SOC_DNX_CNM_GEN_MODE_DUNE_PP = 3,

  /* HiGig Mode  - JER2_ARAD ONLY */
  SOC_DNX_CNM_GEN_MODE_HIGIG = 4,

  /*
   *  Number of types in SOC_DNX_CNM_GEN_MODE
   */
  SOC_DNX_CNM_NOF_GEN_MODES
}SOC_DNX_CNM_GEN_MODE;
...
typedef enum
{
   ...
   */
  SOC_DNX_CNM_Q_SET_4_CPS = 1,
  /*
   *  Number of types in SOC_DNX_CNM_Q_SET
   */
  SOC_DNX_CNM_NOF_Q_SETS = 2
}SOC_DNX_CNM_Q_SET;
...
} SOC_DNX_CNM_CONGESTION_TEST_INFO;
...
typedef struct
{
   ...
   *  (8K-1)*64.
   */
  uint32 sampling_base[SOC_DNX_CNM_NOF_SAMPLING_BASES];
  /*
...
typedef struct
{
   ...
   */
  uint32 cp_id_6_msb[SOC_DNX_CNM_NOF_UINT32S_IN_CP_ID];
