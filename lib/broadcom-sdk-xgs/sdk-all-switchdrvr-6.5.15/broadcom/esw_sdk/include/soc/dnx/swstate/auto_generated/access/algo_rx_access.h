/** \file dnx/swstate/auto_generated/access/algo_rx_access.h
 *
...
typedef int (*algo_rx_db_trap_ingress_predefined_set_cb)(
    int unit, sw_state_algo_res_t trap_ingress_predefined);
...
typedef int (*algo_rx_db_trap_ingress_user_defined_set_cb)(
    int unit, sw_state_algo_res_t trap_ingress_user_defined);
...
typedef int (*algo_rx_db_trap_erpp_set_cb)(
    int unit, sw_state_algo_res_t trap_erpp);
...
typedef int (*algo_rx_db_trap_etpp_set_cb)(
    int unit, sw_state_algo_res_t trap_etpp);
...
typedef int (*algo_rx_db_trap_etpp_oam_set_cb)(
    int unit, sw_state_algo_res_t trap_etpp_oam);
...
typedef int (*algo_rx_db_trap_protocol_icmp_type_map_set_cb)(
    int unit, sw_state_algo_res_t trap_protocol_icmp_type_map);
...
typedef int (*algo_rx_db_trap_recycle_cmd_set_cb)(
    int unit, sw_state_algo_template_t trap_recycle_cmd);
...
typedef int (*algo_rx_db_trap_recycle_cmd_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_rx_trap_recycle_cmd_config_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_rx_db_trap_recycle_cmd_profile_data_get
 */
typedef int (*algo_rx_db_trap_recycle_cmd_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_rx_trap_recycle_cmd_config_t *profile_data);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_set
 */
typedef int (*algo_rx_db_trap_mtu_profile_set_cb)(
    int unit, sw_state_algo_template_t trap_mtu_profile);
...
/**
 * implemented by: algo_rx_db_trap_mtu_profile_create
 */
typedef int (*algo_rx_db_trap_mtu_profile_create_cb)(
    int unit, sw_state_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_allocate_single
 */
typedef int (*algo_rx_db_trap_mtu_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_rx_trap_mtu_profile_config_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_free_single
 */
typedef int (*algo_rx_db_trap_mtu_profile_free_single_cb)(
    int unit, int core_id, int profile, uint8 *last_reference);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_exchange
 */
typedef int (*algo_rx_db_trap_mtu_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_rx_trap_mtu_profile_config_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_profile_data_get
 */
typedef int (*algo_rx_db_trap_mtu_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_rx_trap_mtu_profile_config_t *profile_data);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_profile_get
 */
typedef int (*algo_rx_db_trap_mtu_profile_profile_get_cb)(
    int unit, int core_id, const dnx_rx_trap_mtu_profile_config_t *profile_data, int *profile);

/**
 * implemented by: algo_rx_db_trap_lif_ingress_set
 */
typedef int (*algo_rx_db_trap_lif_ingress_set_cb)(
    int unit, sw_state_algo_template_t trap_lif_ingress);
...
typedef int (*algo_rx_db_trap_lif_ingress_exchange_cb)(
    int unit, int core_id, uint32 flags, const bcm_gport_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_rx_db_trap_lif_ingress_profile_data_get
 */
typedef int (*algo_rx_db_trap_lif_ingress_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, bcm_gport_t *profile_data);

/**
 * implemented by: algo_rx_db_trap_lif_ingress_profile_get
 */
typedef int (*algo_rx_db_trap_lif_ingress_profile_get_cb)(
    int unit, int core_id, const bcm_gport_t *profile_data, int *profile);

/**
 * implemented by: algo_rx_db_trap_lif_etpp_set
 */
typedef int (*algo_rx_db_trap_lif_etpp_set_cb)(
    int unit, sw_state_algo_template_t trap_lif_etpp);
...
/**
 * This structure holds the access functions for the variable trap_mtu_profile
 */
typedef struct {
    algo_rx_db_trap_mtu_profile_set_cb set;
    algo_rx_db_trap_mtu_profile_get_cb get;
    algo_rx_db_trap_mtu_profile_create_cb create;
    algo_rx_db_trap_mtu_profile_allocate_single_cb allocate_single;
    algo_rx_db_trap_mtu_profile_free_single_cb free_single;
    algo_rx_db_trap_mtu_profile_exchange_cb exchange;
    algo_rx_db_trap_mtu_profile_profile_data_get_cb profile_data_get;
    algo_rx_db_trap_mtu_profile_profile_get_cb profile_get;
} algo_rx_db_trap_mtu_profile_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for trap_mtu_profile
     */
    algo_rx_db_trap_mtu_profile_cbs trap_mtu_profile;
    /**
