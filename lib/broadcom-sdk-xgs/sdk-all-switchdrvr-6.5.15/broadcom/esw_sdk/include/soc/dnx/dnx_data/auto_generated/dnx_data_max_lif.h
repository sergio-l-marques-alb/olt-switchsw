 ...
 */
#define DNX_DATA_MAX_LIF_GLOBAL_LIF_NOF_GLOBAL_L2_GPORT_LIFS (1048576)

/**
 * \brief
 * Amount of out RIFs one GLEM entry can hold for optimized GLEM usage is 4.
 */
#define DNX_DATA_MAX_LIF_GLOBAL_LIF_GLEM_RIF_OPTIMIZATION_ENABLED (0)
 ...
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_OUTLIF_POINTER_SIZE (19)

/**
 * \brief
 * The number of bits in the local outlif from GLEM.
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_LOCAL_OUTLIF_WIDTH (19)

/**
 * \brief
 * The number of bits in the outlif profile from GLEM.
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_OUTLIF_PROFILE_WIDTH (2)

/**
 * \brief
 * The number of bits in GLEM result.
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_GLEM_RESULT (21)

/**
 * \brief
 * Number of potential local outlifs in the device. Derived from the pointer size.
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_NOF_LOCAL_OUT_LIFS (524288)

/**
 * \brief
 * Size of the outlif bank used by the outlif allocation algorithm.
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_ALLOCATION_BANK_SIZE (8192)
 ...
 */
#define DNX_DATA_MAX_LIF_OUT_LIF_PHYSICAL_BANK_SIZE (4096)
