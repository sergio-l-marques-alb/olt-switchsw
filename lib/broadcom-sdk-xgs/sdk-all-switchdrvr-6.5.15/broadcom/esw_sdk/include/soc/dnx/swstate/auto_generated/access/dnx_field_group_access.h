...
/**
 * implemented by: dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_set
 */
typedef int (*dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint8 bit_range_was_aligned);

/**
 * implemented by: dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_get
 */
typedef int (*dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_get_cb)(
    int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint8 *bit_range_was_aligned);

/**
 * implemented by: dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_set
 */
typedef int (*dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, int16 bit_range_aligned_offset);

/**
 * implemented by: dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_get
 */
typedef int (*dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_get_cb)(
    int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, int16 *bit_range_aligned_offset);
...
typedef int (*dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, CONST dnx_field_action_in_group_info_t *actions_on_payload_info);
...
typedef int (*dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_get_cb)(
    int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, dnx_field_action_in_group_info_t *actions_on_payload_info);
...
typedef int (*dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dnx_action_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, dnx_field_action_t dnx_action);
...
typedef int (*dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_dont_use_valid_bit_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, uint8 dont_use_valid_bit);
...
typedef int (*dnx_field_group_sw_fg_info_actions_payload_info_actions_on_payload_info_lsb_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 actions_on_payload_info_idx_0, uint32 actions_on_payload_info_idx_1, uint8 lsb);
...
/**
 * implemented by: dnx_field_group_sw_fg_info_action_size_set
 */
typedef int (*dnx_field_group_sw_fg_info_action_size_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 action_size);

/**
 * implemented by: dnx_field_group_sw_fg_info_action_size_get
 */
typedef int (*dnx_field_group_sw_fg_info_action_size_get_cb)(
    int unit, uint32 fg_info_idx_0, uint32 *action_size);
...
/**
 * implemented by: dnx_field_group_sw_ace_format_info_name_stringncat
 */
typedef int (*dnx_field_group_sw_ace_format_info_name_stringncat_cb)(
    int unit, uint32 ace_format_info_idx_0, char *src);

/**
 * implemented by: dnx_field_group_sw_ace_format_info_name_stringncmp
 */
typedef int (*dnx_field_group_sw_ace_format_info_name_stringncmp_cb)(
    int unit, uint32 ace_format_info_idx_0, char *cmp_string, int *result);

/**
 * implemented by: dnx_field_group_sw_ace_format_info_name_stringncpy
 */
typedef int (*dnx_field_group_sw_ace_format_info_name_stringncpy_cb)(
    int unit, uint32 ace_format_info_idx_0, char *src);

/**
 * implemented by: dnx_field_group_sw_ace_format_info_name_stringlen
 */
typedef int (*dnx_field_group_sw_ace_format_info_name_stringlen_cb)(
    int unit, uint32 ace_format_info_idx_0, uint32 *size);

/**
 * implemented by: dnx_field_group_sw_ace_format_info_name_stringget
 */
typedef int (*dnx_field_group_sw_ace_format_info_name_stringget_cb)(
    int unit, uint32 ace_format_info_idx_0, char *o_string);
 ...
 */
typedef struct {
    dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_set_cb set;
    dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_get_cb get;
} dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_cbs;

/**
 * This structure holds the access functions for the variable bit_range_aligned_offset
 */
typedef struct {
    dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_set_cb set;
    dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_get_cb get;
} dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_cbs;
...
typedef struct {
     ...
     */
    dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_was_aligned_cbs bit_range_was_aligned;
    /**
     * Access struct for bit_range_aligned_offset
     */
    dnx_field_group_sw_fg_info_context_info_key_id_bit_range_bit_range_aligned_offset_cbs bit_range_aligned_offset;
 ...
 */
typedef struct {
    dnx_field_group_sw_fg_info_action_size_set_cb set;
    dnx_field_group_sw_fg_info_action_size_get_cb get;
} dnx_field_group_sw_fg_info_action_size_cbs;
...
typedef struct {
     ...
     */
    dnx_field_group_sw_fg_info_action_size_cbs action_size;
    /**
 ...
 */
typedef struct {
    dnx_field_group_sw_ace_format_info_name_stringncat_cb stringncat;
    dnx_field_group_sw_ace_format_info_name_stringncmp_cb stringncmp;
    dnx_field_group_sw_ace_format_info_name_stringncpy_cb stringncpy;
    dnx_field_group_sw_ace_format_info_name_stringlen_cb stringlen;
    dnx_field_group_sw_ace_format_info_name_stringget_cb stringget;
