...
#ifndef __SOC_DNX_API_STATISTICS_INCLUDED__
/* { */
#define __SOC_DNX_API_STATISTICS_INCLUDED__
 ...
 */
      /* ( (dnx_sand_power_of_2(31) - 1) / (SOC_DNX_DFLT_TICKS_PER_SEC/1000) ) */

/*     Number of programmable counters per Incoming FAP Port   */
#define  SOC_DNX_STAT_PER_IFP_NOF_CNTS 4
...
typedef struct
{
   ...
   */
  uint32 ifp_id[SOC_DNX_STAT_PER_IFP_NOF_CNTS];

} SOC_DNX_STAT_IFP_SELECT_INFO;
...
typedef struct
{
   ...
   *  STAG.
   */
  SOC_DNX_ITM_VSQ_GROUP vsq_grp_id;
  /*
...
typedef enum
{
  ...
  */
  SOC_DNX_IQM_GLOBAL_RESOURCE_CNT,
  /*
 ...
 SOC_DNX_IQM_ISP_PACKET_CNT,
   ...
   */
 SOC_DNX_IQM_REJECTED_PACKET_LACK_RESOURCE_DBUFFS_CNT,
  /*
   ...
   */
 SOC_DNX_IQM_REJECTED_PACKET_LACK_RESOURCE_DBD_CNT,
  /*
   ...
   */
   SOC_DNX_IQM_REJECTED_BDB_PROTCT_PKT_CNT,
  /*
   ...
   */
   SOC_DNX_IQM_REJECTED_OC_BD_PKT_CNT,
  /*
   ...
   */
   SOC_DNX_IQM_IRR_RJCT_SN_ERR_PKT_CNT,
  /*
   ...
   */
   SOC_DNX_IQM_IRR_RJCT_MC_ERR_PKT_CNT,
  /*
   ...
   */
   SOC_DNX_EGQ_PACEKT_REASSEMBLY_OUTPUT_SOP_CNT,
  /*
  ...
  */
   ...
   */
  SOC_DNX_IQM_REJECTED_CNM_PKT_CNT,
  /*
   ...
   *  Soc_petra-A.
   */
  SOC_DNX_IQM_DRAM_DYNAMIC_REJECT_PKT_CNT,
  /*
   ...
   *  Soc_petra-A.
   */
  SOC_DNX_IQM_DRAM_DYNAMIC_SIZE_CNT,
   /*
 ...
 /*
   ...
   */
  SOC_DNX_IQM_METER_A_CIR_LB_NOF_BYTES_CNT,
  /*
   *  MtrpbCblCnt: Number of bytes assigned by the committed
   *  leaky bucket of the configured index. This register is
   *  clear on read. Not valid for Soc_petra-A.
   */
  SOC_DNX_IQM_METER_B_CIR_LB_NOF_BYTES_CNT,
  /*
   *  MtrpaEblCnt: Number of bytes assigned by the excessed
   *  leaky bucket of the configured index. This register is
   *  clear on read. Not valid for Soc_petra-A.
   */
  SOC_DNX_IQM_METER_A_EIR_LB_NOF_BYTES_CNT,
  /*
   *  MtrpbEblCnt: Number of bytes assigned by the excessed
   *  leaky bucket of the configured index. This register is
   *  clear on read. Not valid for Soc_petra-A.
   */
  SOC_DNX_IQM_METER_B_EIR_LB_NOF_BYTES_CNT,
   ...
   *  for Soc_petra-A.
   */
  SOC_DNX_FCR_CREDIT_CELLS_TX_CNT,
  /*
   ...
   *  for Soc_petra-A.
   */
  SOC_DNX_FCT_FLOW_STATUS_CELLS_TX_CNT,
  /*
   *  CnmPacketsCnt:
   *  Counts the number of CNM packets from the EGQ. Not valid
   *  for Soc_petra-A.
   */
  SOC_DNX_EGQ_CNM_PACKET_CNT,
  /*
   *  PktAgedCnt: Number
   *  of aged packets. Not valid for Soc_petra-A.
   */
  SOC_DNX_EGQ_PACKET_AGED_CNT

} SOC_DNX_STAT_COUNTER_TYPE;
...
typedef struct
{
   ...
   *
   */
  DNX_SAND_64CNT  counters[SOC_DNX_NOF_COUNTER_TYPES];
} SOC_DNX_STAT_ALL_STATISTIC_COUNTERS;
...
typedef enum
{
   ...
   */
  SOC_DNX_STAT_PRINT_LEVEL_ERROR_ONLY=0,
  /*
   *  Counters that present the packet walk-through.
   */
  SOC_DNX_STAT_PRINT_LEVEL_PACKET_WALKTHROUGH=1,
  /*
   *  Represents resources counters and packet walk-through.
   */
  SOC_DNX_STAT_PRINT_LEVEL_ALL=2,
  /*
   *  Total number of counter print levels.
   */
  SOC_DNX_STAT_NOF_PRINT_LEVELS=3
}SOC_DNX_STAT_PRINT_LEVEL;
...
void
  SOC_DNX_STAT_ALL_STATISTIC_COUNTERS_clear(
    DNX_SAND_OUT SOC_DNX_STAT_ALL_STATISTIC_COUNTERS *info
  );

void
  SOC_DNX_STAT_IFP_SELECT_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_IFP_SELECT_INFO *info
  );

void
  SOC_DNX_STAT_VOQ_SELECT_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_VOQ_SELECT_INFO *info
  );

void
  SOC_DNX_STAT_VSQ_SELECT_INFO_clear(
    DNX_SAND_OUT SOC_DNX_STAT_VSQ_SELECT_INFO *info
  );


const char*
  SOC_DNX_STAT_COUNTER_TYPE_to_string(
    DNX_SAND_IN SOC_DNX_STAT_COUNTER_TYPE  counter_type,
...
void
  SOC_DNX_STAT_IFP_SELECT_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_IFP_SELECT_INFO *info
  );

void
  SOC_DNX_STAT_VOQ_SELECT_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_VOQ_SELECT_INFO *info
  );

void
  SOC_DNX_STAT_VSQ_SELECT_INFO_print(
    DNX_SAND_IN  SOC_DNX_STAT_VSQ_SELECT_INFO *info
  );
...
/* } __SOC_DNX_API_STATISTICS_INCLUDED__*/
#endif
