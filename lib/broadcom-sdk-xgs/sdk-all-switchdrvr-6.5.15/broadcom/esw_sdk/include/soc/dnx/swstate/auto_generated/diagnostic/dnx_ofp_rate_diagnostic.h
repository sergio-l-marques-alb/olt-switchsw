...
typedef enum {
    ...
    DNX_OFP_RATE_DB_SHAPER_ENABLE_INFO,
...
int dnx_ofp_rate_db_otm_dump(
    int unit, int otm_idx_0, int otm_idx_1);
...
int dnx_ofp_rate_db_qpair_dump(
    int unit, int qpair_idx_0, int qpair_idx_1);

int dnx_ofp_rate_db_qpair_rate_dump(
    int unit, int qpair_idx_0, int qpair_idx_1);

int dnx_ofp_rate_db_qpair_burst_dump(
    int unit, int qpair_idx_0, int qpair_idx_1);
...
int dnx_ofp_rate_db_tcg_dump(
    int unit, int tcg_idx_0, int tcg_idx_1, int tcg_idx_2);

int dnx_ofp_rate_db_tcg_rate_dump(
    int unit, int tcg_idx_0, int tcg_idx_1, int tcg_idx_2);

int dnx_ofp_rate_db_tcg_burst_dump(
    int unit, int tcg_idx_0, int tcg_idx_1, int tcg_idx_2);
...
int dnx_ofp_rate_db_otm_cal_dump(
    int unit, int otm_cal_idx_0, int otm_cal_idx_1);
...
int dnx_ofp_rate_db_calcal_is_modified_dump(
    int unit, int calcal_is_modified_idx_0);

int dnx_ofp_rate_db_calcal_len_dump(
    int unit, int calcal_len_idx_0);

int dnx_ofp_rate_db_shaper_enable_dump(
    int unit);
