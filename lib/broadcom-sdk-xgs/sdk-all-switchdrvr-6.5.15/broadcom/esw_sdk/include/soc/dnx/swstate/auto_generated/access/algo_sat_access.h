/** \file dnx/swstate/auto_generated/access/algo_sat_access.h
 *
...
typedef int (*algo_sat_db_sat_res_alloc_gtf_id_set_cb)(
    int unit, sw_state_algo_res_t sat_res_alloc_gtf_id);
...
typedef int (*algo_sat_db_sat_res_alloc_ctf_id_set_cb)(
    int unit, sw_state_algo_res_t sat_res_alloc_ctf_id);
...
typedef int (*algo_sat_db_sat_res_alloc_trap_id_set_cb)(
    int unit, sw_state_algo_res_t sat_res_alloc_trap_id);
...
typedef int (*algo_sat_db_sat_res_alloc_trap_data_set_cb)(
    int unit, sw_state_algo_res_t sat_res_alloc_trap_data);
...
typedef int (*algo_sat_db_sat_pkt_header_set_cb)(
    int unit, sw_state_algo_template_t sat_pkt_header);
...
typedef int (*algo_sat_db_sat_pkt_header_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_sat_gtf_pkt_hdr_tbl_info_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_sat_db_sat_pkt_header_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_sat_gtf_pkt_hdr_tbl_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_sat_db_sat_pkt_header_profile_data_get
 */
typedef int (*algo_sat_db_sat_pkt_header_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_sat_gtf_pkt_hdr_tbl_info_t *profile_data);
