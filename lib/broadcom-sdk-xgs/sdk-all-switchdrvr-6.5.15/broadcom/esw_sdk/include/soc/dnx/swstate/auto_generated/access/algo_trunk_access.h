/** \file dnx/swstate/auto_generated/access/algo_trunk_access.h
 *
...
typedef int (*algo_trunk_db_egress_trunk_set_cb)(
    int unit, sw_state_algo_template_t egress_trunk);
...
typedef int (*algo_trunk_db_egress_trunk_allocate_single_cb)(
    int unit, int core_id, uint32 flags, bcm_trunk_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_trunk_db_egress_trunk_exchange_cb)(
    int unit, int core_id, uint32 flags, const bcm_trunk_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_trunk_db_egress_trunk_profile_data_get
 */
typedef int (*algo_trunk_db_egress_trunk_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, bcm_trunk_t *profile_data);

/**
 * implemented by: algo_trunk_db_egress_trunk_profile_get
 */
typedef int (*algo_trunk_db_egress_trunk_profile_get_cb)(
    int unit, int core_id, const bcm_trunk_t *profile_data, int *profile);
