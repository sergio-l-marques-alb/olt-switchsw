/** \file dnx/swstate/auto_generated/access/dnx_sch_alloc_mngr_access.h
 *
...
typedef int (*sch_alloc_db_sch_flow_alloc_mngr_set_cb)(
    int unit, uint32 sch_flow_alloc_mngr_idx_0, uint32 sch_flow_alloc_mngr_idx_1, sw_state_algo_res_t sch_flow_alloc_mngr);
...
typedef int (*sch_alloc_db_sch_flow_alloc_mngr_create_cb)(
    int unit, uint32 sch_flow_alloc_mngr_idx_0, uint32 sch_flow_alloc_mngr_idx_1, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
typedef int (*sch_alloc_db_interface_set_cb)(
    int unit, uint32 interface_idx_0, sw_state_algo_res_t interface);
...
typedef int (*sch_alloc_db_interface_create_cb)(
    int unit, uint32 interface_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);

/**
 * implemented by: sch_alloc_db_interface_allocate_single
 */
typedef int (*sch_alloc_db_interface_allocate_single_cb)(
    int unit, uint32 interface_idx_0, uint32 flags, void *extra_arguments, int *element);

/**
 * implemented by: sch_alloc_db_interface_free_single
 */
typedef int (*sch_alloc_db_interface_free_single_cb)(
    int unit, uint32 interface_idx_0, int element);
...
typedef int (*sch_alloc_db_cl_class_alloc_mngr_set_cb)(
    int unit, sw_state_algo_template_t cl_class_alloc_mngr);
...
typedef int (*sch_alloc_db_cl_class_alloc_mngr_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_sch_cl_info_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*sch_alloc_db_cl_class_alloc_mngr_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_sch_cl_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*sch_alloc_db_cl_class_alloc_mngr_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_sch_cl_info_t *profile_data);
...
typedef struct {
    ...
    sch_alloc_db_interface_allocate_single_cb allocate_single;
    sch_alloc_db_interface_free_single_cb free_single;
