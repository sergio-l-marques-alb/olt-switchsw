...
typedef enum
{
    ...
    dnx_data_bfd_submodule_hw_bug,
    dnx_data_bfd_submodule_property,
 ...
 *   * None
 */
int dnx_data_bfd_hw_bug_feature_get(
    int unit,
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_bfd_hw_bug_define_nof
} dnx_data_bfd_hw_bug_define_e;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_bfd_hw_bug_table_nof
} dnx_data_bfd_hw_bug_table_e;
 ...
 *   * None
 */
int dnx_data_bfd_property_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_bfd_property_define_discriminator_type_update,

    /**
     * Must be last one!
     */
    _dnx_data_bfd_property_define_nof
} dnx_data_bfd_property_define_e;
 ...
 *   * None
 */
uint32 dnx_data_bfd_property_discriminator_type_update_get(
    int unit);
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_bfd_property_table_nof
} dnx_data_bfd_property_table_e;
