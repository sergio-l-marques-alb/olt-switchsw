 ...
 * Module - 'lane_map', Submodule - 'nif', data - 'resolution'
 * Nof links which nif lane mapping is allowed.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 ...
 */
typedef uint32(
    *dnx_data_lane_map_nif_resolution_get_f) (
    int unit);
...
typedef struct
{
     ...
     */
    dnx_data_lane_map_nif_resolution_get_f resolution_get;
    /**
