/** \file dnx/swstate/auto_generated/access/ppmc_access.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/ppmc_types.h>
...
typedef int (*ppmc_db_ppmc_res_manager_set_cb)(
    int unit, sw_state_algo_res_t ppmc_res_manager);
...
/**
 * implemented by: ppmc_db_ppmc_res_manager_clear_all
 */
typedef int (*ppmc_db_ppmc_res_manager_clear_all_cb)(
    int unit);
...
typedef struct {
    ...
    ppmc_db_ppmc_res_manager_clear_all_cb clear_all;
