/** \file dnx/swstate/auto_generated/access/dnx_algo_field_key_alloc_access.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/dnx_algo_field_key_alloc_types.h>
...
typedef int (*dnx_field_keys_per_stage_allocation_sw_keys_per_stage_key_stage_prog_occupation_key_occupation_bit_range_key_occ_bmp_set_cb)(
    int unit, uint32 key_stage_prog_occupation_idx_0, uint32 key_stage_prog_occupation_idx_1, uint32 key_occupation_idx_0, uint32 bit_range_key_occ_bmp_idx_0, sw_state_algo_res_t bit_range_key_occ_bmp);
...
typedef int (*dnx_field_keys_per_stage_allocation_sw_keys_per_stage_key_stage_prog_occupation_key_occupation_bit_range_key_occ_bmp_create_cb)(
    int unit, uint32 key_stage_prog_occupation_idx_0, uint32 key_stage_prog_occupation_idx_1, uint32 key_occupation_idx_0, uint32 bit_range_key_occ_bmp_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
/**
 * implemented by: dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_set
 */
typedef int (*dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_set_cb)(
    int unit, uint32 keys_availability_stage_info_idx_0, uint32 keys_availability_group_info_idx_0, uint8 availability_going_up);

/**
 * implemented by: dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_get
 */
typedef int (*dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_get_cb)(
    int unit, uint32 keys_availability_stage_info_idx_0, uint32 keys_availability_group_info_idx_0, uint8 *availability_going_up);

/**
 * implemented by: dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_set
 */
typedef int (*dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_set_cb)(
    int unit, uint32 keys_availability_stage_info_idx_0, uint32 keys_availability_group_info_idx_0, uint8 availability_odd_only);

/**
 * implemented by: dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_get
 */
typedef int (*dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_get_cb)(
    int unit, uint32 keys_availability_stage_info_idx_0, uint32 keys_availability_group_info_idx_0, uint8 *availability_odd_only);
...
/**
 * This structure holds the access functions for the variable availability_going_up
 */
typedef struct {
    dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_set_cb set;
    dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_get_cb get;
} dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_cbs;

/**
 * This structure holds the access functions for the variable availability_odd_only
 */
typedef struct {
    dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_set_cb set;
    dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_get_cb get;
} dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for availability_going_up
     */
    dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_going_up_cbs availability_going_up;
    /**
     * Access struct for availability_odd_only
     */
    dnx_field_keys_per_stage_allocation_sw_keys_availability_keys_availability_stage_info_keys_availability_group_info_availability_odd_only_cbs availability_odd_only;
    /**
