...
#ifndef __SOC_DNX_API_STACK_INCLUDED__
/* { */
#define __SOC_DNX_API_STACK_INCLUDED__
...
#define  SOC_DNX_STACK_PRUN_BMP_LEN (1)
...
typedef struct
{
   ...
   *  performed at egress.
   */
  SOC_DNX_STACK_MAX_NOF_TM_DOMAINS max_nof_tm_domains;
  /*
...
typedef struct
{
   ...
   */
  uint32 prun_bmp[SOC_DNX_STACK_PRUN_BMP_LEN];

} SOC_DNX_STACK_PORT_DISTR_INFO;
...
typedef enum
{
   ...
   */
  SOC_DNX_STACK_EGR_PROG_TM_PORT_PROFILE_STACK1 = 1,
  /*
   *  Configure stack1 port profile
   */
  SOC_DNX_STACK_EGR_PROG_TM_PORT_PROFILE_STACK2 = 2,
  /*
   *  Configure both stack port profile
   */
  SOC_DNX_STACK_EGR_PROG_TM_PORT_PROFILE_STACK_ALL = 3
}SOC_DNX_STACK_EGR_PROG_TM_PORT_PROFILE_STACK;
...
/* } __SOC_DNX_API_STACK_INCLUDED__*/
#endif
