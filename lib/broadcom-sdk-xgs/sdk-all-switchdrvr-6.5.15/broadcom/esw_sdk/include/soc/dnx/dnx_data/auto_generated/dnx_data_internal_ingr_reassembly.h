...
typedef enum
{
    dnx_data_ingr_reassembly_ilkn_table_dedicated_tdm_context,
...
/* Get Data */
/**
 * \brief get table dedicated_tdm_context entry 
 * Is this interface works in dedicated TDM context mode
 * 
 * \param [in] unit - unit #
 * \param [in] ilkn_id - interlaken id
 * 
 * \return
 *     dedicated_tdm_context - returns the relevant entry values grouped in struct - see dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
const dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_t * dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_get(
    int unit,
    int ilkn_id);
 ...
 *   * None
 */
shr_error_e dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
/* Get Table info */
/**
 * \brief get general info table about table (for example key size)dedicated_tdm_context info
 * Is this interface works in dedicated TDM context mode
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     dedicated_tdm_context - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
const dnxc_data_table_info_t * dnx_data_ingr_reassembly_ilkn_dedicated_tdm_context_info_get(
    int unit);
...
/**
 * \brief returns define data of interleaved_interface_bits
