/** \file dnx/swstate/auto_generated/diagnostic/dnx_ipq_alloc_mngr_diagnostic.h
 *
...
int dnx_ipq_alloc_mngr_db_fmq_is_fmq_allocated_dump(
    int unit);
