...
typedef struct {
    sw_state_multi_set_t large_multi_set_example;
    sw_state_htbl_t large_htb;
    sw_state_htbl_t large_index_htb;
    sw_state_occ_bm_t large_occ;
    sw_state_resource_tag_bitmap_t large_res_tag_bitmap_test;
    sw_state_algo_res_t large_algo_res;
