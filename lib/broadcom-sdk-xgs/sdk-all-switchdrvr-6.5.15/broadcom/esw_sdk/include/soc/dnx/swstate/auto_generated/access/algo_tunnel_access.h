/** \file dnx/swstate/auto_generated/access/algo_tunnel_access.h
 *
...
typedef int (*algo_tunnel_db_tunnel_ipv6_sip_profile_set_cb)(
    int unit, sw_state_algo_template_t tunnel_ipv6_sip_profile);
...
typedef int (*algo_tunnel_db_udp_ports_profile_set_cb)(
    int unit, sw_state_algo_template_t udp_ports_profile);
...
typedef int (*algo_tunnel_db_udp_ports_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, udp_ports_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_tunnel_db_udp_ports_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const udp_ports_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*algo_tunnel_db_udp_ports_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, udp_ports_t *profile_data);

/**
 * implemented by: algo_tunnel_db_udp_ports_profile_profile_get
 */
typedef int (*algo_tunnel_db_udp_ports_profile_profile_get_cb)(
    int unit, int core_id, const udp_ports_t *profile_data, int *profile);
