/** \file dnx/swstate/auto_generated/types/port_tpid_types.h
 *
...
typedef struct {
     ...
     */
    sw_state_algo_res_t bcm_tag_format_class_id_ingress;
    /**
     * SW-ID TAG-Struct Egress allocation
     */
    sw_state_algo_res_t bcm_tag_format_class_id_egress;
    /**
     * SW-ID TAG-Struct Symmetric allocation
     */
    sw_state_algo_res_t bcm_tag_format_class_id_symmetric;
    /**
     ...
     */
    sw_state_algo_res_t incoming_tag_structure_ingress;
    /**
     * HW-ID TAG-Struct Egress allocation
     */
    sw_state_algo_res_t incoming_tag_structure_egress;
 ...
 */
typedef struct {
    dbal_enum_value_field_acceptable_frame_type_filter_action_e acceptable_frame_type_template[DNX_PORT_TPID_TPID_INDEX_SIZE][DNX_PORT_TPID_TPID_INDEX_SIZE];
