/** \file dnx/swstate/auto_generated/access/algo_port_pp_access.h
 *
...
typedef int (*algo_port_pp_db_esem_default_result_profile_set_cb)(
    int unit, sw_state_algo_res_t esem_default_result_profile);
...
typedef int (*algo_port_pp_db_port_pp_tpid_profile_ingress_set_cb)(
    int unit, sw_state_algo_template_t port_pp_tpid_profile_ingress);
...
typedef int (*algo_port_pp_db_port_pp_tpid_profile_egress_set_cb)(
    int unit, sw_state_algo_template_t port_pp_tpid_profile_egress);
...
typedef int (*algo_port_pp_db_egress_acceptable_frame_type_profile_set_cb)(
    int unit, sw_state_algo_template_t egress_acceptable_frame_type_profile);
...
typedef int (*algo_port_pp_db_egress_acceptable_frame_type_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, acceptable_frame_type_template_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_port_pp_db_egress_acceptable_frame_type_profile_exchange_cb)(
    int unit, int core_id, uint32 flags, const acceptable_frame_type_template_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*algo_port_pp_db_egress_acceptable_frame_type_profile_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, acceptable_frame_type_template_t *profile_data);
...
typedef int (*algo_port_pp_db_egress_pp_port_sit_profile_set_cb)(
    int unit, sw_state_algo_template_t egress_pp_port_sit_profile);
...
typedef int (*algo_port_pp_db_egress_pp_port_sit_profile_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_sit_profile_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_port_pp_db_force_forward_mngr_set_cb)(
    int unit, sw_state_algo_template_t mngr);
...
typedef int (*algo_port_pp_db_esem_access_cmd_set_cb)(
    int unit, sw_state_algo_template_t access_cmd);
...
typedef int (*algo_port_pp_db_esem_access_cmd_allocate_single_cb)(
    int unit, int core_id, uint32 flags, dnx_esem_cmd_data_t *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
...
typedef int (*algo_port_pp_db_esem_access_cmd_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_esem_cmd_data_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*algo_port_pp_db_esem_access_cmd_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_esem_cmd_data_t *profile_data);

/**
 * implemented by: algo_port_pp_db_esem_access_cmd_profile_get
 */
typedef int (*algo_port_pp_db_esem_access_cmd_profile_get_cb)(
    int unit, int core_id, const dnx_esem_cmd_data_t *profile_data, int *profile);
