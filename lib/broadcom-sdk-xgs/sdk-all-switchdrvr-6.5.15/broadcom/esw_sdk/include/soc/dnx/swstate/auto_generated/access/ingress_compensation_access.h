/** \file dnx/swstate/auto_generated/access/ingress_compensation_access.h
 *
...
typedef int (*dnx_ingress_compensation_db_compensation_set_cb)(
    int unit, sw_state_algo_template_t compensation);
...
typedef int (*dnx_ingress_compensation_db_compensation_replace_data_cb)(
    int unit, int core_id, int profile,  const int *new_profile_data);
...
typedef int (*dnx_ingress_compensation_db_compensation_profile_get_cb)(
    int unit, int core_id, const int *profile_data, int *profile);
