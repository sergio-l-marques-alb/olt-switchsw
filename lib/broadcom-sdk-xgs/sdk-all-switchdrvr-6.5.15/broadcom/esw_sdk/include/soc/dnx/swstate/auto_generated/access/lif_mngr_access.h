/** \file dnx/swstate/auto_generated/access/lif_mngr_access.h
 *
...
/**
 * implemented by: lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_set
 */
typedef int (*lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_set_cb)(
    int unit, uint32 ingress_sbc_lif_to_global_lif_map_idx_0, int ingress_sbc_lif_to_global_lif_map);

/**
 * implemented by: lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_get
 */
typedef int (*lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_get_cb)(
    int unit, uint32 ingress_sbc_lif_to_global_lif_map_idx_0, int *ingress_sbc_lif_to_global_lif_map);

/**
 * implemented by: lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_alloc
 */
typedef int (*lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_alloc_cb)(
    int unit);

/**
 * implemented by: lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_set
 */
typedef int (*lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_set_cb)(
    int unit, uint32 ingress_dpc_lif_to_global_lif_map_idx_0, uint32 ingress_dpc_lif_to_global_lif_map_idx_1, int ingress_dpc_lif_to_global_lif_map);

/**
 * implemented by: lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_get
 */
typedef int (*lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_get_cb)(
    int unit, uint32 ingress_dpc_lif_to_global_lif_map_idx_0, uint32 ingress_dpc_lif_to_global_lif_map_idx_1, int *ingress_dpc_lif_to_global_lif_map);

/**
 * implemented by: lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_alloc
 */
typedef int (*lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_alloc_cb)(
    int unit);
...
typedef int (*lif_mngr_db_global_lif_allocation_symmetric_global_lif_set_cb)(
    int unit, sw_state_algo_res_t symmetric_global_lif);
...
typedef int (*lif_mngr_db_global_lif_allocation_ingress_global_lif_set_cb)(
    int unit, sw_state_algo_res_t ingress_global_lif);
...
typedef int (*lif_mngr_db_global_lif_allocation_egress_global_lif_set_cb)(
    int unit, sw_state_algo_res_t egress_global_lif);
...
typedef int (*lif_mngr_db_local_inlif_inlif_table_shared_by_cores_set_cb)(
    int unit, sw_state_algo_res_t inlif_table_shared_by_cores);
...
typedef int (*lif_mngr_db_local_inlif_inlif_table_dedicated_per_core_set_cb)(
    int unit, uint32 inlif_table_dedicated_per_core_idx_0, sw_state_algo_res_t inlif_table_dedicated_per_core);
...
typedef int (*lif_mngr_db_local_inlif_inlif_table_dedicated_per_core_create_cb)(
    int unit, uint32 inlif_table_dedicated_per_core_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
typedef int (*lif_mngr_db_local_inlif_inlif_table_dpc_all_cores_set_cb)(
    int unit, sw_state_algo_res_t inlif_table_dpc_all_cores);
...
typedef int (*lif_mngr_db_egress_local_lif_set_cb)(
    int unit, uint32 egress_local_lif_idx_0, sw_state_algo_res_t egress_local_lif);
...
typedef int (*lif_mngr_db_egress_local_lif_create_cb)(
    int unit, uint32 egress_local_lif_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
/**
 * This structure holds the access functions for the variable ingress_sbc_lif_to_global_lif_map
 */
typedef struct {
    lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_set_cb set;
    lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_get_cb get;
    lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_alloc_cb alloc;
} lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_cbs;

/**
 * This structure holds the access functions for the variable ingress_dpc_lif_to_global_lif_map
 */
typedef struct {
    lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_set_cb set;
    lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_get_cb get;
    lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_alloc_cb alloc;
} lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_cbs;
...
typedef struct {
    /**
     * Access struct for ingress_sbc_lif_to_global_lif_map
     */
    lif_mngr_db_lif_mapping_ingress_sbc_lif_to_global_lif_map_cbs ingress_sbc_lif_to_global_lif_map;
    /**
     * Access struct for ingress_dpc_lif_to_global_lif_map
     */
    lif_mngr_db_lif_mapping_ingress_dpc_lif_to_global_lif_map_cbs ingress_dpc_lif_to_global_lif_map;
    /**
