...
typedef enum
{
    ...
    /**
     * Are IPv6 traps supported
     */
    dnx_data_trap_erpp_ipv6_traps_en,
...
/**
 * \brief returns define data of nof_mtu_profiles_per_fwd_type
 * Module - 'trap', Submodule - 'etpp', data - 'nof_mtu_profiles_per_fwd_type'
 * Number of MTU profiles per forwarding layer type
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     nof_mtu_profiles_per_fwd_type - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_trap_etpp_nof_mtu_profiles_per_fwd_type_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns define data of nof_mtu_profiles_per_fwd_type
     */
    dnx_data_trap_etpp_nof_mtu_profiles_per_fwd_type_get_f nof_mtu_profiles_per_fwd_type_get;
    /**
