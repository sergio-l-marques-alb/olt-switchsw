...
typedef struct {
     ...
     * in 'bit_range_aligned_offset' below to DNX_FIELD_KEY_STEP_VALUE_FOR_ALIGNED_BIT (16).
     * See parameter 'do_align' in 'dnx_algo_field_key_id_bit_range_allocate()'.
     * This is only relevant for FEM handling.
     */
    uint8 bit_range_was_aligned;
    /**
     * Only meaningful if 'bit_range_was_aligned' is 'TRUE'. This is the bit, within allocated bit-range,
     ...
     * This is only relevant for FEM handling.
     */
    int16 bit_range_aligned_offset;
