...
typedef struct
{
    ...
    /**
     * returns define data of nof_global_l2_gport_lifs
     */
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_nof_dpc_local_in_lifs_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_dpc_local_inlif_array_sw_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_dpc_local_inlif_hash_sw_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_nof_sbc_local_in_lifs_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_sbc_local_inlif_array_sw_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_sbc_local_inlif_hash_sw_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_all_local_inlifs_array_sw_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_all_local_inlif_hash_sw_size_get_f) (
    int unit);
 ...
 */
typedef uint32(
    *dnx_data_lif_in_lif_in_lif_profile_allocate_orientaion_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of nof_dpc_local_in_lifs
     */
    dnx_data_lif_in_lif_nof_dpc_local_in_lifs_get_f nof_dpc_local_in_lifs_get;
    /**
     * returns numeric data of dpc_local_inlif_array_sw_size
     */
    dnx_data_lif_in_lif_dpc_local_inlif_array_sw_size_get_f dpc_local_inlif_array_sw_size_get;
    /**
     * returns numeric data of dpc_local_inlif_hash_sw_size
     */
    dnx_data_lif_in_lif_dpc_local_inlif_hash_sw_size_get_f dpc_local_inlif_hash_sw_size_get;
    /**
     * returns numeric data of nof_sbc_local_in_lifs
     */
    dnx_data_lif_in_lif_nof_sbc_local_in_lifs_get_f nof_sbc_local_in_lifs_get;
    /**
     * returns numeric data of sbc_local_inlif_array_sw_size
     */
    dnx_data_lif_in_lif_sbc_local_inlif_array_sw_size_get_f sbc_local_inlif_array_sw_size_get;
    /**
     * returns numeric data of sbc_local_inlif_hash_sw_size
     */
    dnx_data_lif_in_lif_sbc_local_inlif_hash_sw_size_get_f sbc_local_inlif_hash_sw_size_get;
    /**
     * returns numeric data of all_local_inlifs_array_sw_size
     */
    dnx_data_lif_in_lif_all_local_inlifs_array_sw_size_get_f all_local_inlifs_array_sw_size_get;
    /**
     * returns numeric data of all_local_inlif_hash_sw_size
     */
    dnx_data_lif_in_lif_all_local_inlif_hash_sw_size_get_f all_local_inlif_hash_sw_size_get;
    /**
     * returns numeric data of in_lif_profile_allocate_orientaion
     */
    dnx_data_lif_in_lif_in_lif_profile_allocate_orientaion_get_f in_lif_profile_allocate_orientaion_get;
    /**
...
typedef struct
{
    ...
    /**
     * returns define data of nof_local_out_lifs
     */
    dnx_data_lif_out_lif_nof_local_out_lifs_get_f nof_local_out_lifs_get;
    /**
     * returns define data of allocation_bank_size
     */
    ...
    /**
     * returns define data of physical_bank_size
     */
