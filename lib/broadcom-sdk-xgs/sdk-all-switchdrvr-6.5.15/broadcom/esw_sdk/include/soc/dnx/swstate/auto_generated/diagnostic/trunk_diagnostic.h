/** \file dnx/swstate/auto_generated/diagnostic/trunk_diagnostic.h
 *
...
int trunk_db_pools_dump(
    int unit, int pools_idx_0);

int trunk_db_pools_groups_dump(
    int unit, int pools_idx_0, int groups_idx_0);
...
int trunk_db_pools_groups_members_dump(
    int unit, int pools_idx_0, int groups_idx_0, int members_idx_0);
...
int trunk_db_pools_groups_pp_ports_dump(
    int unit, int pools_idx_0, int groups_idx_0, int pp_ports_idx_0);
...
int trunk_db_trunk_system_port_db_trunk_system_port_entries_dump(
    int unit, int trunk_system_port_entries_idx_0);
