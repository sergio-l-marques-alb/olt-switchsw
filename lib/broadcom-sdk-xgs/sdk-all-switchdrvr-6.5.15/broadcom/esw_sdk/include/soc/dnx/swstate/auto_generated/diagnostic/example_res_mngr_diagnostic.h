/** \file dnx/swstate/auto_generated/diagnostic/example_res_mngr_diagnostic.h
 *
...
#include <soc/dnx/swstate/auto_generated/types/example_res_mngr_types.h>
...
int algo_res_mngr_db_resource_test_input_valid_per_core_dump(
    int unit, int resource_test_input_valid_per_core_idx_0);

int algo_res_mngr_db_resource_test_input_valid_indexed_resource_dump(
    int unit, int resource_test_input_valid_indexed_resource_idx_0);

int algo_res_mngr_db_resource_test_input_valid_indexed_resource_per_core_dump(
    int unit, int resource_test_input_valid_indexed_resource_per_core_idx_0, int resource_test_input_valid_indexed_resource_per_core_idx_1);

int algo_res_mngr_db_resource_test_per_core_dump(
    int unit, int resource_test_per_core_idx_0);

int algo_res_mngr_db_resource_test_invalid_dump(
    int unit);

int algo_res_mngr_db_resource_test_indexed_resource_dump(
    int unit, int resource_test_indexed_resource_idx_0);

int algo_res_mngr_db_resource_test_indexed_resource_per_core_dump(
    int unit, int resource_test_indexed_resource_per_core_idx_0, int resource_test_indexed_resource_per_core_idx_1);
