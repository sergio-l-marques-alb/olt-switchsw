...
typedef struct
{
    ...
    /**
     * returns define data of max_burst
     */
...
typedef struct
{
    ...
    /**
     * returns define data of erp_hr
     */
    dnx_data_sch_flow_erp_hr_get_f erp_hr_get;
    /**
     * returns define data of reserved_hr
     */
    ...
    /**
     * returns define data of max_flow
     */
    ...
    /**
     * returns define data of first_hr_region
     */
    ...
    /**
     * returns define data of first_se_flow_id
     */
    ...
    /**
     * returns define data of hr_se_id_min
     */
    dnx_data_sch_flow_hr_se_id_min_get_f hr_se_id_min_get;
    /**
     * returns define data of hr_se_id_max
     */
    dnx_data_sch_flow_hr_se_id_max_get_f hr_se_id_max_get;
    /**
     * returns define data of default_credit_source_se_id
     */
...
typedef struct
{
    ...
    /**
     * returns define data of shaper_resolution
     */
...
typedef struct
{
    ...
    /**
     * returns define data of type_con_reg_end
     */
    dnx_data_sch_sch_alloc_type_con_reg_end_get_f type_con_reg_end_get;
    /**
     * returns define data of type_hr_reg_start
     */
...
typedef struct
{
    ...
    /**
     * returns define data of ps_bits
     */
...
{
    /**
     * Set couple of DLM registers to their MAX value due to hardware bug(HWJERICHO2-2480).
     */
    dnx_data_sch_hw_workarounds_dlm,

    /**
     * Must be last one!
     */
    _dnx_data_sch_hw_workarounds_feature_nof
} dnx_data_sch_hw_workarounds_feature_e;
 ...
 */
typedef int(
    *dnx_data_sch_hw_workarounds_feature_get_f) (
    int unit,
    dnx_data_sch_hw_workarounds_feature_e feature);

/*
 * SUBMODULE INTERFACE DNX_DATA_IF_SCH - HW_WORKAROUNDS:
 * {
 */
/**
 * \brief Interface for sch hw_workarounds data
 */
typedef struct
{
    /**
     * get submodule feature - disabled/enabled
     */
    dnx_data_sch_hw_workarounds_feature_get_f feature_get;
} dnx_data_if_sch_hw_workarounds_t;
...
typedef struct
{
    ...
    /**
     * Interface for sch hw_workarounds data
     */
    dnx_data_if_sch_hw_workarounds_t hw_workarounds;
} dnx_data_if_sch_t;
