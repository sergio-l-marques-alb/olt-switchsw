...
#ifndef __SOC_DNX_API_CELL_INCLUDED__
/* { */
#define __SOC_DNX_API_CELL_INCLUDED__
...
#define SOC_DNX_CELL_NOF_LINKS_IN_PATH_LINKS            (4)

#define SOC_DNX_CELL_MC_NOF_LINKS                       (2)
#define SOC_DNX_CELL_MC_DATA_IN_UINT32S                   (3)
#define SOC_DNX_CELL_MC_NOF_CHANGES                     (7)
...
typedef enum
{
   ...
   *  FE3.
   */
  SOC_DNX_CELL_FE_LOCATION_FE1 = 0,
  /*
   ...
   */
  SOC_DNX_CELL_FE_LOCATION_FE2 = 1,
  /*
   *  Total number of fabric locations.
   */
  SOC_DNX_CELL_NOF_FE_LOCATIONS = 2
}SOC_DNX_CELL_FE_LOCATION;
...
typedef struct
{
   ...
   */
  uint8            path_links[SOC_DNX_CELL_NOF_LINKS_IN_PATH_LINKS];

} SOC_DNX_SR_CELL_LINK_LIST;
...
typedef struct
{
   ...
   *  value, Range: 0 - 63.
   */
  uint32 data[SOC_DNX_CELL_MC_DATA_IN_UINT32S];

} SOC_DNX_CELL_MC_TBL_DATA;
...
typedef struct
{
   ...
   */
  SOC_DNX_CELL_FE_LOCATION fe_location;
  /*
   *  Links to get to the fabric. For an FE1 fabric (in
   *  multi-stage) or FE2 fabric (in single stage), only the
   *  first value must be configured. For an FE2 fabric in
   ...
   *  value, Range: 0 - 63.
   */
  uint32 path_links[SOC_DNX_CELL_MC_NOF_LINKS];
  /*
   ...
   */
  uint8 filter[SOC_DNX_CELL_MC_NOF_CHANGES];

} SOC_DNX_CELL_MC_TBL_INFO;
