/** \file dnx/swstate/auto_generated/diagnostic/port_tpid_diagnostic.h
 *
...
int port_tpid_db_native_ac_llvp_templates_ingress_llvp_template_dump(
    int unit, int llvp_template_idx_0);
...
int port_tpid_db_tag_struct_allocation_bcm_tag_format_class_id_symmetric_indication_dump(
    int unit, int bcm_tag_format_class_id_symmetric_indication_idx_0);
