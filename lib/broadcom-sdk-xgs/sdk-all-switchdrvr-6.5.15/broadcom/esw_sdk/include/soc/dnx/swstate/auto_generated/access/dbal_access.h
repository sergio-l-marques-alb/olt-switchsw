...
/**
 * implemented by: dbal_db_sw_tables_entries_set
 */
typedef int (*dbal_db_sw_tables_entries_set_cb)(
    int unit, uint32 sw_tables_idx_0, uint32 entries_idx_0, DNX_SW_STATE_BUFF entries);

/**
 * implemented by: dbal_db_sw_tables_entries_get
 */
typedef int (*dbal_db_sw_tables_entries_get_cb)(
    int unit, uint32 sw_tables_idx_0, uint32 entries_idx_0, DNX_SW_STATE_BUFF *entries);

/**
 * implemented by: dbal_db_sw_tables_entries_alloc
 */
typedef int (*dbal_db_sw_tables_entries_alloc_cb)(
    int unit, uint32 sw_tables_idx_0, uint32 _nof_bytes_to_alloc);

/**
 * implemented by: dbal_db_sw_tables_entries_memread
 */
typedef int (*dbal_db_sw_tables_entries_memread_cb)(
    int unit, uint32 sw_tables_idx_0, uint8 *_dst, uint32 _offset, size_t _len);

/**
 * implemented by: dbal_db_sw_tables_entries_memwrite
 */
typedef int (*dbal_db_sw_tables_entries_memwrite_cb)(
    int unit, uint32 sw_tables_idx_0, const uint8 *_src, uint32 _offset, size_t _len);

/**
 * implemented by: dbal_db_sw_tables_entries_memcmp
 */
typedef int (*dbal_db_sw_tables_entries_memcmp_cb)(
    int unit, uint32 sw_tables_idx_0, const uint8 *_buff, uint32 _offset, size_t _len, int *cmp_result);

/**
 * implemented by: dbal_db_sw_tables_entries_memset
 */
typedef int (*dbal_db_sw_tables_entries_memset_cb)(
    int unit, uint32 sw_tables_idx_0, uint32 _offset, size_t _len, int _value);
...
/**
 * implemented by: dbal_db_tables_properties_alloc
 */
typedef int (*dbal_db_tables_properties_alloc_cb)(
    int unit);
...
/**
 * implemented by: dbal_db_dbal_dynamic_tables_alloc
 */
typedef int (*dbal_db_dbal_dynamic_tables_alloc_cb)(
    int unit);
 ...
 */
typedef struct {
    dbal_db_sw_tables_entries_set_cb set;
    dbal_db_sw_tables_entries_get_cb get;
    dbal_db_sw_tables_entries_alloc_cb alloc;
    dbal_db_sw_tables_entries_memread_cb memread;
    dbal_db_sw_tables_entries_memwrite_cb memwrite;
    dbal_db_sw_tables_entries_memcmp_cb memcmp;
    dbal_db_sw_tables_entries_memset_cb memset;
 ...
 */
typedef struct {
    dbal_db_tables_properties_alloc_cb alloc;
    /**
 ...
 */
typedef struct {
    dbal_db_dbal_dynamic_tables_alloc_cb alloc;
    /**
