...
typedef struct {
     ...
     */
    dnx_ofp_rate_db_otm_t otm[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES][DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_Q_PAIRS];
    /**
     * [core][qpare index], data about qpair shaping parameters
     */
    dnx_ofp_rate_db_shaping_t qpair[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES][DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_Q_PAIRS];
    /**
     * [core][PS index][TCG index], data about TCG shaping parameters
     */
    dnx_ofp_rate_db_shaping_t tcg[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES][DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_PORT_SCHEDULERS][DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_TCG];
    /**
     * [core][calendar index], info about calendar parameters
     */
    dnx_ofp_rate_db_cal_t otm_cal[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES][DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_CALENDARS];
    /**
     * [core] Boolean, calcal is modified
     */
    uint32 calcal_is_modified[DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_CORES];
    /**
