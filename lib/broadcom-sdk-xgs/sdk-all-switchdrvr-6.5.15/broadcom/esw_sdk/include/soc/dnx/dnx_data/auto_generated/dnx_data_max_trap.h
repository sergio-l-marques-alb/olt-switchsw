 ...
 */
#define DNX_DATA_MAX_TRAP_ETPP_NOF_MTU_PROFILES (64)

/**
 * \brief
 * Number of MTU profiles per forwarding layer type
 */
#define DNX_DATA_MAX_TRAP_ETPP_NOF_MTU_PROFILES_PER_FWD_TYPE (8)
