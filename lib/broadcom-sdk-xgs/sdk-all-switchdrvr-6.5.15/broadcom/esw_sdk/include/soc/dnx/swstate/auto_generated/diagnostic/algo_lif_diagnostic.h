/** \file dnx/swstate/auto_generated/diagnostic/algo_lif_diagnostic.h
 *
...
typedef enum {
    ...
    LOCAL_OUTLIF_INFO_LOGICAL_PHASE_INFO_DBAL_VALID_COMBINATIONS_DBAL_TABLE_INFO,
    LOCAL_OUTLIF_INFO_LOGICAL_PHASE_INFO_DBAL_VALID_COMBINATIONS_DBAL_RESULT_TYPE_INFO,
...
int local_outlif_info_outlif_bank_info_dump(
    int unit, int outlif_bank_info_idx_0);
...
int local_outlif_info_outlif_bank_info_eedb_data_banks_dump(
    int unit, int outlif_bank_info_idx_0, int eedb_data_banks_idx_0);

int local_outlif_info_logical_phase_info_dump(
    int unit, int logical_phase_info_idx_0);
...
int local_outlif_info_logical_phase_info_dbal_valid_combinations_dump(
    int unit, int logical_phase_info_idx_0, int dbal_valid_combinations_idx_0);

int local_outlif_info_logical_phase_info_dbal_valid_combinations_dbal_table_dump(
    int unit, int logical_phase_info_idx_0, int dbal_valid_combinations_idx_0);

int local_outlif_info_logical_phase_info_dbal_valid_combinations_dbal_result_type_dump(
    int unit, int logical_phase_info_idx_0, int dbal_valid_combinations_idx_0);

int local_outlif_info_physical_phase_to_logical_phase_map_dump(
    int unit, int physical_phase_to_logical_phase_map_idx_0);

int local_outlif_info_eedb_banks_info_dump(
    int unit);

int local_outlif_info_eedb_banks_info_bank_occupation_bitmap_dump(
    int unit, int bank_occupation_bitmap_idx_0);

int local_outlif_info_eedb_banks_info_outlif_prefix_occupation_bitmap_dump(
    int unit, int outlif_prefix_occupation_bitmap_idx_0);
...
#endif /* __ALGO_LIF_DIAGNOSTIC_H__ */
