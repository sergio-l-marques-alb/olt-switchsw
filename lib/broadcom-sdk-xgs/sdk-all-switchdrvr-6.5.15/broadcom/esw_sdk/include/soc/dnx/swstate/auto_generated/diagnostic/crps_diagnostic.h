/** \file dnx/swstate/auto_generated/diagnostic/crps_diagnostic.h
 *
...
int dnx_crps_db_proc_dump(
    int unit, int proc_idx_0, int proc_idx_1);
...
int dnx_crps_db_proc_interface_type_hw_valid_dump(
    int unit, int proc_idx_0, int proc_idx_1, int type_hw_valid_idx_0);
...
int dnx_crps_db_proc_counter_dump(
    int unit, int proc_idx_0, int proc_idx_1, int counter_idx_0);

int dnx_crps_db_bg_thread_enable_dump(
    int unit);

int dnx_crps_db_database_dump(
    int unit, int database_idx_0, int database_idx_1);

int dnx_crps_db_database_base_engine_dump(
    int unit, int database_idx_0, int database_idx_1);

int dnx_crps_db_database_type_dump(
    int unit, int database_idx_0, int database_idx_1, int type_idx_0);
...
int dnx_crps_db_database_res_dump(
    int unit, int database_res_idx_0);
