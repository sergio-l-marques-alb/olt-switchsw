...
typedef enum
{
    ...
    dnx_data_sch_submodule_hw_workarounds,
...
/**
 * \brief returns define data of max_burst
...
/**
 * \brief returns define data of erp_hr
...
/**
 * \brief returns define data of reserved_hr
...
/**
 * \brief returns define data of max_se
...
/**
 * \brief returns define data of max_flow
...
/**
 * \brief returns define data of first_hr_region
...
/**
 * \brief returns define data of first_se_flow_id
...
/**
 * \brief returns define data of hr_se_id_min
...
/**
 * \brief returns define data of hr_se_id_max
...
/**
 * \brief returns define data of default_credit_source_se_id
...
/**
 * \brief get general info table about table (for example key size)cl_num_to_quartet_offset info
 * mapping CL number to quartet index
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     cl_num_to_quartet_offset - returns table info
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
...
typedef enum
{
    ...
    dnx_data_sch_interface_define_shaper_resolution,
...
/**
 * \brief returns define data of shaper_resolution
 * Module - 'sch', Submodule - 'interface', data - 'shaper_resolution'
 * Resolution of interface shaper
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     shaper_resolution - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnx_data_sch_interface_shaper_resolution_get(
    int unit);
...
/**
 * \brief returns define data of type_con_reg_end
...
/**
 * \brief returns define data of type_hr_reg_start
...
/**
 * \brief returns define data of scheduler_enable_key_size
...
/**
 * \brief returns define data of flow_id_pair_key_size
...
/**
 * \brief returns define data of flow_id_pair_max
...
/**
 * \brief returns define data of ps_bits
 ...
 *   * None
 */
int dnx_data_sch_hw_workarounds_feature_get(
    int unit,
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_sch_hw_workarounds_define_nof
} dnx_data_sch_hw_workarounds_define_e;
...
typedef enum
{
     ...
     * Must be last one!
     */
    _dnx_data_sch_hw_workarounds_table_nof
} dnx_data_sch_hw_workarounds_table_e;
