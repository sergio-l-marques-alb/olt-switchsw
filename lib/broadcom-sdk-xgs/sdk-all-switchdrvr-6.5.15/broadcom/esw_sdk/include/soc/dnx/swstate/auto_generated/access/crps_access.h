/** \file dnx/swstate/auto_generated/access/crps_access.h
 *
...
typedef int (*dnx_crps_db_database_res_set_cb)(
    int unit, uint32 database_res_idx_0, sw_state_algo_res_t database_res);
...
typedef int (*dnx_crps_db_database_res_create_cb)(
    int unit, uint32 database_res_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
