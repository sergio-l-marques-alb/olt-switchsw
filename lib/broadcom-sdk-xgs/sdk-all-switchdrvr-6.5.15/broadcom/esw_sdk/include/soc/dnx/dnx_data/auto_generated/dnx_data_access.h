...
/**
 * \brief returns numeric data of out_delay
 * Module - 'access', Submodule - 'mdio', data - 'out_delay'
 * number of clock delay between the rising edge of MDC and the starting data of MDIO
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     out_delay - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
typedef uint32(
    *dnx_data_access_mdio_out_delay_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of out_delay
     */
    dnx_data_access_mdio_out_delay_get_f out_delay_get;
