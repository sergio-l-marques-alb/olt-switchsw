...
#ifndef __SOC_DNX_API_ACTION_CMD_INCLUDED__
/* { */
#define __SOC_DNX_API_ACTION_CMD_INCLUDED__
...
/*Flags for SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO*/
#define SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_IN_PORT           (1 << 0)
#define SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_VSQ               (1 << 1)
#define SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_CNM_CANCEL        (1 << 2)
#define SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_TRUNK_HASH_RESULT (1 << 3)
#define SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_ECN_VALUE         (1 << 4)

/*Flags for SOC_DNX_ACTION_CMD_SNOOP_MIRROR_STAMPING_INFO*/
#define SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_STAMPING_FHEI     (1 << 0)
...
typedef enum
{
   ...
   */
  SOC_DNX_ACTION_CMD_SIZE_BYTES_64 = 0,
  /*
   *  Snoop the first 128 bytes of the packet.
   */
  SOC_DNX_ACTION_CMD_SIZE_BYTES_128 = 1,
  /*
   *  Snoop the first 192 bytes of the packet.
   */
  SOC_DNX_ACTION_CMD_SIZE_BYTES_192 = 2,

  SOC_DNX_ACTION_CMD_SIZE_BYTES_256 = 3,
  /*
   *  Snoop the whole packet
   */
  SOC_DNX_ACTION_CMD_SIZE_BYTES_ALL_PCKT = 4,
  /*
   *  Number of types in SOC_DNX_ACTION_CMD_SIZE_BYTES
   */
  SOC_DNX_ACTION_NOF_CMD_SIZE_BYTESS = 5
}SOC_DNX_ACTION_CMD_SIZE_BYTES;
...
typedef struct
{
   ...
   *  JER2_ARAD only.
   */
  SOC_DNX_ACTION_CMD_OVERRIDE outlif;
...
typedef struct {
    ...
    uint32         encap_id;
} SOC_DNX_ACTION_CMD_SNOOP_MIRROR_STAMPING_INFO;
...
typedef struct
{
  ...
  */
  uint32         valid; /*Used to specify which fields to use.
                        ...
                        SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO_*
                        */
  ...
  SOC_DNX_ACTION_CMD_SNOOP_MIRROR_STAMPING_INFO stamping;
} SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO;
...
void
  SOC_DNX_ACTION_CMD_OVERRIDE_clear(
    DNX_SAND_OUT SOC_DNX_ACTION_CMD_OVERRIDE *info
  );

void
  SOC_DNX_ACTION_CMD_clear(
    DNX_SAND_OUT SOC_DNX_ACTION_CMD *info
  );

void
    SOC_DNX_ACTION_CMD_SNOOP_MIRROR_STAMPING_INFO_clear( 
       SOC_DNX_ACTION_CMD_SNOOP_MIRROR_STAMPING_INFO *info
       );
void
  SOC_DNX_ACTION_CMD_SNOOP_INFO_clear(
    DNX_SAND_OUT SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO *info
  );

void
  SOC_DNX_ACTION_CMD_MIRROR_INFO_clear(
    DNX_SAND_OUT SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO *info
  );


const char*
  SOC_DNX_ACTION_CMD_SIZE_BYTES_to_string(
    DNX_SAND_IN  SOC_DNX_ACTION_CMD_SIZE_BYTES enum_val
  );

void
  SOC_DNX_ACTION_CMD_OVERRIDE_print(
    DNX_SAND_IN  SOC_DNX_ACTION_CMD_OVERRIDE *info
  );

void
  SOC_DNX_ACTION_CMD_print(
    DNX_SAND_IN  SOC_DNX_ACTION_CMD *info
  );

void
  SOC_DNX_ACTION_CMD_SNOOP_INFO_print(
    DNX_SAND_IN  SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO *info
  );

void
  SOC_DNX_ACTION_CMD_MIRROR_INFO_print(
    DNX_SAND_IN  SOC_DNX_ACTION_CMD_SNOOP_MIRROR_INFO *info
  );
...
/* } __SOC_DNX_API_ACTION_CMD_INCLUDED__*/
#endif
