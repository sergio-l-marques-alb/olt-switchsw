...
#ifndef __SOC_DNX_API_FLOW_CONTROL_INCLUDED__
/* { */
#define __SOC_DNX_API_FLOW_CONTROL_INCLUDED__
 ...
 *
 */
typedef uint32 SOC_DNX_FC_CAL_IF_ID;

#define SOC_DNX_FC_NOF_PP_INTF     2

#define SOC_DNX_FC_OOB_CAL_LEN_MAX 512

#define SOC_DNX_FC_PFC_GENERIC_BITMAP_SIZE 256

#define SOC_DNX_FC_HCFC_BITMAP_SIZE 512

#define SOC_DNX_FC_ILKN_MUB_GEN_CAL_LEN 8

#define  SOC_DNX_FC_OOB_CAL_REP_MIN 1
#define  SOC_DNX_FC_OOB_CAL_REP_MAX 15

#define  SOC_DNX_FC_HCFC_CHANNEL_NUM 5

/* 2^13 */
#define  SOC_DNX_FC_CAL_PAUSE_RESOLUTION_CLK_MAX    0x2000

typedef enum  
{
  SOC_DNX_FC_OOB_TX_SPEED_CORE_2 = 0,
    
  SOC_DNX_FC_OOB_TX_SPEED_CORE_4 = 1,
  
  SOC_DNX_FC_OOB_TX_SPEED_CORE_8 = 2,
  
  SOC_DNX_FC_NOF_OOB_TX_SPEED = 3
}SOC_DNX_FC_OOB_TX_SPEED;

typedef enum
{
    SOC_DNX_FC_EN = 0,

    SOC_DNX_FC_EGQ_TO_NIF_CNM_LLFC_EN = 1, 

    SOC_DNX_FC_EGQ_TO_NIF_CNM_PFC_EN = 2, 

    SOC_DNX_FC_EGQ_TO_SCH_DEVICE_EN = 3,

    SOC_DNX_FC_EGQ_TO_SCH_ERP_EN = 4, 
    
    SOC_DNX_FC_EGQ_TO_SCH_ERP_TC_EN = 5, 

    SOC_DNX_FC_EGQ_TO_SCH_IF_EN = 6,
    
    SOC_DNX_FC_EGQ_TO_SCH_PFC_EN = 7,
    
    SOC_DNX_FC_GLB_RSC_TO_EGQ_RCL_PFC_EN = 8, 

    SOC_DNX_FC_GLB_RSC_TO_HCFC_HP_CFG = 9, 

    SOC_DNX_FC_GLB_RSC_TO_HCFC_LP_CFG = 10, 

    SOC_DNX_FC_GLB_RSC_TO_NIF_LLFC_EN = 11, 
    
    SOC_DNX_FC_GLB_RSC_TO_NIF_PFC_EN = 12, 

    SOC_DNX_FC_GLB_RSC_TO_RCL_PFC_HP_CFG = 13, 

    SOC_DNX_FC_GLB_RSC_TO_RCL_PFC_LP_CFG = 14, 

    SOC_DNX_FC_ILKN_RX_TO_EGQ_PFC_EN = 15, 

    SOC_DNX_FC_ILKN_RX_TO_EGQ_PORT_EN = 16, 
    
    SOC_DNX_FC_ILKN_RX_TO_GEN_PFC_EN = 17, 

    SOC_DNX_FC_ILKN_RX_TO_NIF_FAST_LLFC_EN = 18, 

    SOC_DNX_FC_ILKN_RX_TO_RET_REQ_EN = 19, 

    SOC_DNX_FC_LLFC_VSQ_TO_NIF_EN = 20, 
    
    SOC_DNX_FC_NIF_TO_GEN_PFC_EN = 21, 

    SOC_DNX_FC_PFC_VSQ_TO_NIF_EN = 22, 

    SOC_DNX_FC_SCH_OOB_RX_EN = 23, 

    SOC_DNX_FC_SPI_OOB_RX_TO_EGQ_PFC_EN = 24, 

    SOC_DNX_FC_SPI_OOB_RX_TO_EGQ_PORT_EN = 25, 

    SOC_DNX_FC_SPI_OOB_RX_TO_GEN_PFC_EN = 26, 

    SOC_DNX_FC_SPI_OOB_RX_TO_NIF_FAST_LLFC_EN = 27, 

    SOC_DNX_FC_SPI_OOB_RX_TO_RET_REQ_EN = 28, 

    SOC_DNX_FC_STAT_VSQ_TO_HCFC_EN = 29,

    SOC_DNX_FC_EGQ_TO_SCH_LAG_EN = 30,
    SOC_DNX_FC_NOF_ENABLEs = 31
}SOC_DNX_FC_ENABLE;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_OOB_ID_A = 0,
  /*
   *  Out Of Band Flow Control Interface B. Used for Flow
   *  Control reception or generation.
   */
  SOC_DNX_FC_OOB_ID_B = 1,
  /*
   *  Number of types in SOC_DNX_FC_OOB_ID
   */
  SOC_DNX_FC_NOF_OOB_IDS = 2
}SOC_DNX_FC_OOB_ID;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_CAL_MODE_SPI_OOB = 0,
  /*
   *  Calendar-based Flow Control Mode: Interlaken Inband
   */
  SOC_DNX_FC_CAL_MODE_ILKN_INBND = 1,
  /*
   *  Calendar-based Flow Control Mode: Interlaken Out-Of-Band
   */
  SOC_DNX_FC_CAL_MODE_ILKN_OOB = 2,
  /*
   *  Number of types in SOC_DNX_FC_CAL_MODE
   */
  SOC_DNX_FC_NOF_CAL_MODES = 3
}SOC_DNX_FC_CAL_MODE;

typedef enum
{

  SOC_DNX_FC_CAL_TYPE_NONE = 0,
  SOC_DNX_FC_CAL_TYPE_SPI  = 1,
  SOC_DNX_FC_CAL_TYPE_ILKN = 2,
  SOC_DNX_FC_CAL_TYPE_HCFC = 3,
  SOC_DNX_FC_CAL_TYPE_COE  = 4,
  SOC_DNX_FC_CAL_TYPE_E2E  = 5,
  SOC_DNX_FC_NOF_TYPES
}SOC_DNX_FC_OOB_TYPE;

typedef enum
{
  SOC_DNX_FC_CAL_INB_TYPE_NONE = 0,
  SOC_DNX_FC_CAL_INB_TYPE_ILKN = 1,
  SOC_DNX_FC_CAL_INB_TYPE_COE  = 2,
  SOC_DNX_FC_CAL_INB_TYPE_E2E  = 3,
  SOC_DNX_FC_CAL_INB_NOF_TYPES
}SOC_DNX_FC_CAL_INB_TYPE;

typedef enum
{
  SOC_DNX_FC_COE_MODE_PAUSE  = 0,
  SOC_DNX_FC_COE_MODE_PFC = 1,
  SOC_DNX_FC_NOF_COE_MODES = 2
}SOC_DNX_FC_COE_MODE;

typedef enum
{
  SOC_DNX_FC_E2E_STATUS_SIZE_8B  = 0,
  SOC_DNX_FC_E2E_STATUS_SIZE_16B = 1,
  SOC_DNX_FC_E2E_STATUS_SIZE_24B = 2,
  SOC_DNX_FC_E2E_STATUS_SIZE_32B = 3,
  SOC_DNX_FC_E2E_STATUS_SIZE_48B = 4,
  SOC_DNX_FC_E2E_STATUS_SIZE_64B = 5,
  SOC_DNX_FC_NOF_E2E_STATUS_SIZE
}SOC_DNX_FC_E2E_STATUS_TYPE;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_INGR_GEN_GLB_HP_MODE_NONE = 0,
  /*
   *  Enable Ingress Flow Control generation via NIF, upon
   *  Global Resources High Priority FC indication, Link
   *  Level.
   */
  SOC_DNX_FC_INGR_GEN_GLB_HP_MODE_LL = 1,
  /*
   *  Enable Ingress Flow Control generation via NIF, upon
   *  Global Resources High Priority FC indication, Class
   *  Based.
   */
  SOC_DNX_FC_INGR_GEN_GLB_HP_MODE_CB = 2,

  SOC_DNX_FC_INGR_GEN_GLB_HP_MODE_PFC = 3,

  /* All the GLB HP options: LL+CB, LL+PFC */
  SOC_DNX_FC_INGR_GEN_GLB_HP_MODE_ALL = 4,
  /*
   *  Number of types in SOC_DNX_FC_INGR_GEN_GLB_HP_MODE
   */
  SOC_DNX_FC_NOF_INGR_GEN_GLB_HP_MODES
}SOC_DNX_FC_INGR_GEN_GLB_HP_MODE;
...
typedef enum
{
   ...
   *  handled
   */
  SOC_DNX_FC_INBND_PFC_INHERIT_DISABLED = 0,
  /*
   *  If TRUE, CBFC classes will affect lower priority
   *  classes, where the highest priority is class 0
   */
  SOC_DNX_FC_INBND_PFC_INHERIT_UP = 1,
  /*
   *  If TRUE, CBFC classes will affect lower priority
   *  classes, where the highest priority is class 7
   */
  SOC_DNX_FC_INBND_PFC_INHERIT_DOWN = 2,
  /*
   *  Number of types in SOC_DNX_FC_INBND_CB_INHERIT
   */
  SOC_DNX_FC_NOF_INBND_PFC_INHERITS = 3
}SOC_DNX_FC_INBND_PFC_INHERIT;
...
typedef struct
{
   ...
   */
  SOC_DNX_FC_INBND_PFC_INHERIT inherit;
  /*
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_REC_OFP_RP_SCH = 0x1,
  /*
   *  Flow Control Reception Reaction Point on OFP level -
   *  Egress Queues Manager (EGQ)
   */
  SOC_DNX_FC_REC_OFP_RP_EGQ = 0x2,
  /*
   *  Number of types in SOC_DNX_FC_REC_OFP_RP
   */
  SOC_DNX_FC_NOF_REC_OFP_RPS = 3
}SOC_DNX_FC_REC_OFP_RP;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_OFP_PRIORITY_NONE = 0x0,
  /*
   *  OFP FC priority - Low
   */
  SOC_DNX_FC_OFP_PRIORITY_LP = 0x1,
  /*
   *  OFP FC priority - High. HP-FC triggers also LP-FC
   */
  SOC_DNX_FC_OFP_PRIORITY_HP = 0x3,
  /*
   *  Number of types in SOC_DNX_FC_OFP_PRIORITY
   */
  SOC_DNX_FC_NOF_OFP_PRIORITYS = 3
}SOC_DNX_FC_OFP_PRIORITY;
...
typedef struct
{
   ...
   *  Scheduler/EGQ
   */
  SOC_DNX_FC_REC_OFP_RP react_point;
  /*
   ...
   */
  SOC_DNX_FC_OFP_PRIORITY priority;

} SOC_DNX_FC_REC_OFP_MAP_INFO;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_INBND_MODE_DISABLED = 0,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_INBND_MODE_LL = 1,
  /*
   ...
   *  (XAUI/SPAUI)
   */
  SOC_DNX_FC_INBND_MODE_CB = 2,
  /*
   *  Number of types in SOC_DNX_FC_INBND_MODE - petra B
   */
  SOC_DNX_FC_NOF_INBND_MODES_PB = 3,
   /* JER2_ARAD ONLY */
   SOC_DNX_FC_INBND_MODE_PFC = SOC_DNX_FC_NOF_INBND_MODES_PB,
   
   SOC_DNX_FC_INBND_MODE_SAFC = 4,

   SOC_DNX_FC_INBND_MODE_DEVICE_DISABLED = 5,

   SOC_DNX_FC_NOF_INBND_MODES = 6
}SOC_DNX_FC_INBND_MODE;
...
typedef enum
{
   ...
   *  (generation/reception)
   */
  SOC_DNX_FC_GEN_SRC_NONE = 0,
  /*
   *  FC Generation Source: VSQ LLFC
   */
  SOC_DNX_FC_GEN_SRC_VSQ_LLFC = 1,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GEN_SRC_VSQ_PFC = 2,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GEN_SRC_GLB_HIGH = 3,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GEN_SRC_GLB_LOW = 4,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GEN_SRC_VSQ_CAT2TC = 5,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GEN_SRC_NIF = 6,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GEN_SRC_CNM = 7,

  SOC_DNX_FC_NOF_GEN_SRC = 18
}SOC_DNX_FC_GEN_SRC;
...
typedef enum
{
   ...
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_BDB = 0,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_MINI_MC_DB = 1,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_MC_DB = 2,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_OCB_DB = 3,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_MIX_P0 = 4,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_MIX_P1 = 5,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_OCB_P0 = 6,
  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_OCB_P1 = 7,  

  /*
   *  Link-level Flow Control
   */
  SOC_DNX_FC_GLB_RES_TYPE_OCB = 8,

  SOC_DNX_FC_GLB_RES_TYPE_DRAM = 9,

  SOC_DNX_FC_GLB_RES_TYPE_POOL0 = 10,

  SOC_DNX_FC_GLB_RES_TYPE_POOL1 = 11,

  SOC_DNX_FC_GLB_RES_TYPE_OCB_HEADROOM = 12,

  SOC_DNX_FC_NOF_GLB_RES_TYPE = 13
}SOC_DNX_FC_GLB_RES_TYPE;
...
typedef enum
{
   ...
   *  handled
   */
  SOC_DNX_FC_INBND_CB_INHERIT_DISABLED = 0,
  /*
   *  If TRUE, CBFC classes will affect lower priority
   *  classes, where the highest priority is class 0
   */
  SOC_DNX_FC_INBND_CB_INHERIT_UP = 1,
  /*
   *  If TRUE, CBFC classes will affect lower priority
   *  classes, where the highest priority is class 7
   */
  SOC_DNX_FC_INBND_CB_INHERIT_DOWN = 2,
  /*
   *  Number of types in SOC_DNX_FC_INBND_CB_INHERIT
   */
  SOC_DNX_FC_NOF_INBND_CB_INHERITS = 3
}SOC_DNX_FC_INBND_CB_INHERIT;

typedef struct
{

  SOC_DNX_FC_GEN_SRC gen_src;
...
} SOC_DNX_FC_CAL_IF_INFO;

typedef enum
{
  SOC_DNX_FC_GEN_CAL_SRC_STE = 0,
  /*
   *  Calendar-based Flow Control source - Index Range
   *  (NIF-ID): 0 - 63.
   */
  SOC_DNX_FC_GEN_CAL_SRC_NIF = 1,
  /*
   *  Calendar-based Flow Control source - Global Resource,
   *  High Priority FC. Index Range (Glbl-Rcs-HP-Id): 0 - 2.
   */
  SOC_DNX_FC_GEN_CAL_SRC_GLB_HP = 2,
  /*
   *  Calendar-based Flow Control source - Index Range
   *  (Glbl-Rcs-LP-Id): 0 - 2.
   */
  SOC_DNX_FC_GEN_CAL_SRC_GLB_LP = 3,
  /*
   *  Invalid/non-existing source. Serves as "empty calendar
   *  entry" indication.
   */
  SOC_DNX_FC_GEN_CAL_SRC_NONE = 4,
  /*
   * Number of types in SOC_PB_FC_GEN_CAL_SRC - Petra B
   */
  SOC_DNX_FC_NOF_GEN_CAL_SRCS_PB = 5,

  /* Arad Only */
  SOC_DNX_FC_GEN_CAL_SRC_LLFC_VSQ = SOC_DNX_FC_NOF_GEN_CAL_SRCS_PB,
  ...
  /*
   *  Number of types in SOC_DNX_FC_GEN_CAL_SRC
   */
  SOC_DNX_FC_NOF_GEN_CAL_SRCS
}SOC_DNX_FC_GEN_CAL_SRC;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_BDB = 0,
  /*
   *  Global Resources Index- MIX-Buffers resource for JER2_QAX
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_MIX = SOC_DNX_FC_CAL_GLB_RCS_ID_BDB,
  /*
   *  Global Resources Index- Unicast Data Buffers
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_UNI = 1,
  /*
   *  Global Resources Index- OCB-Buffers resource for JER2_QAX
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_OCB = SOC_DNX_FC_CAL_GLB_RCS_ID_UNI,
  /*
   *  Global Resources Index- Multicast Data Buffers
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_MUL = 2,
  /*
   *  Global Resources Index- Pool-0 resource for JER2_QAX
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_P0 = SOC_DNX_FC_CAL_GLB_RCS_ID_MUL,
  /*
   *  Total number of Global Resources Indexes.
   */
  SOC_DNX_FC_NOF_CAL_GLB_RCS_IDS_JER2_ARAD = 3,
  /*
   *  Global Resources Index- OCB Data Buffers
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_OCB_DB = SOC_DNX_FC_NOF_CAL_GLB_RCS_IDS_JER2_ARAD,
  /*
   *  Global Resources Index- Pool-1 resource for JER2_QAX
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_P1 = SOC_DNX_FC_NOF_CAL_GLB_RCS_IDS_JER2_ARAD,
  /*
   *  Global Resources Index- Shared Buffers/BDs resource of Pool-0
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_MIX_P0 = 4,
  /*
   *  Global Resources Index- HEADROOM resource for JER2_QAX
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_HEADROOM = SOC_DNX_FC_CAL_GLB_RCS_ID_MIX_P0,
  /*
   *  Global Resources Index- Shared Buffers/BDs resource of Pool-1
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_MIX_P1 = 5,
  /*
   *  Total number of Global Resources Indexes for JER2_QAX.
   */
  SOC_DNX_FC_NOF_CAL_GLB_RCS_IDS_JER2_QAX = SOC_DNX_FC_CAL_GLB_RCS_ID_MIX_P1,
  /*
   *  Global Resources Index- Shared OCB-Buffers resource of Pool-0
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_OCB_P0 = 6,
  /*
   *  Global Resources Index- Shared OCB-Buffers resource of Pool-1
   */
  SOC_DNX_FC_CAL_GLB_RCS_ID_OCB_P1 = 7,
  /*
   *  Total number of Global Resources Indexes.
   */
  SOC_DNX_FC_NOF_CAL_GLB_RCS_IDS = 8
}SOC_DNX_FC_CAL_GLB_RCS_ID;
...
typedef enum
{
  ...
  SOC_DNX_FC_NOF_REC_CAL_DESTS
}SOC_DNX_FC_REC_CAL_DEST;
...
typedef struct
{
   ...
   */
  SOC_DNX_FC_GEN_CAL_SRC source;

  uint32 id;

} SOC_DNX_FC_GEN_CALENDAR;
...
typedef struct
{
   ...
   *  Point).
   */
  SOC_DNX_FC_REC_CAL_DEST destination;

  uint32 id;
  
} SOC_DNX_FC_REC_CALENDAR;
...
typedef struct
{
   ...
   *  lower priority classes
   */
  SOC_DNX_FC_INBND_CB_INHERIT inherit;
  /*
   *  If bit 'b' is set, the appropriate HR in range 128-255
   *  will stop credit generation. For XAUI/SPAUI - 8 HRs can
   *  be set as a reaction point for 8 FC classes,
...
typedef struct
{
   ...
   *  type)
   */
  SOC_DNX_FC_INBND_MODE mode;
  /*
   *  Only when CBFC mode is selected (ignored otherwise) -
   *  CBFC configuration
   *  Soc_petra only
   */
  SOC_DNX_FC_GEN_INBND_CB cb;
  /*
   *  Only when LLFC mode is selected (ignored otherwise) -
   *  LLFC configuration
   */
  SOC_DNX_FC_GEN_INBND_LL ll;

  /* Arad only */
  SOC_DNX_FC_GEN_INBND_PFC pfc;

  /* Jericho only */
  int core;

} SOC_DNX_FC_GEN_INBND_INFO;
...
typedef struct
{
   ...
   *  CBFC configuration
   */
  SOC_DNX_FC_REC_INBND_CB cb;

  SOC_DNX_FC_REC_INBND_PFC pfc;

} SOC_DNX_FC_REC_INBND_INFO;
...
typedef struct 
{
  ...
  uint32 bitmap[SOC_DNX_FC_PFC_GENERIC_BITMAP_SIZE / 32];
}SOC_DNX_FC_PFC_GENERIC_BITMAP;

typedef struct 
{
  /* 512 Bits - representing 512 HCFC FCs for Jericho, 256 HCFC FCs for Arad */
  uint32 bitmap[SOC_DNX_FC_HCFC_BITMAP_SIZE / 32];
}SOC_DNX_FC_HCFC_BITMAP;

typedef struct 
{
  /* Enable bitmap defines the set of enables */
  SHR_BITDCL bmp[_SHR_BITDCLSIZE(SOC_DNX_FC_NOF_ENABLEs)]; 
}SOC_DNX_FC_ENABLE_BITMAP;
...
typedef enum
{
   ...
   *  Mapping to EGQ PFC
   */
  SOC_DNX_FC_PFC_MAP_EGQ = 0,
  /*
   *  Mapping by using Generic PFC Bitmap
   */
  SOC_DNX_FC_PFC_MAP_GENERIC_BITMAP = 1,
  /*
   *  Number of types in SOC_DNX_FC_PFC_MAP_MODE
   */
  SOC_DNX_FC_NOF_PFC_MAP_MODE = 2
}SOC_DNX_FC_PFC_MAP_MODE;

typedef struct 
{
  /* 
   * In case mode is SOC_DNX_FC_PFC_MAP_EGQ, index is dst PFC index;
   * In case mode is SOC_DNX_FC_PFC_MAP_GENERIC_BITMAP, index is generic PFC bitmaps index;
   */
  uint32 index;

  SOC_DNX_FC_PFC_MAP_MODE mode;
...
typedef enum
{
   ...
   */
  SOC_DNX_FC_ILKN_CAL_LLFC_NONE = 0,
  /*
   *  ILKN Calendar Channel 0 indicates LLFC (RX/TX)
   */
  SOC_DNX_FC_ILKN_CAL_LLFC_CH_0 = 1,
  /*
   *  ILKN Calendar Channels 16*n (i.e. 0, 16, 32, .., 240)
   *  indicate LLFC (RX/TX)
   */
  SOC_DNX_FC_ILKN_CAL_LLFC_CH_16N = 2,
  /*
   *  Number of types in JER2_ARAD_FC_ILKN_CAL_LLFC
   */
  SOC_DNX_FC_NOF_ILKN_CAL_LLFCS = 3
}SOC_DNX_FC_ILKN_CAL_LLFC;
...
typedef struct
{
   ...
   */
  SOC_DNX_FC_ILKN_CAL_LLFC cal_channel;

} SOC_DNX_FC_ILKN_LLFC_INFO;

typedef struct
{

  SOC_DNX_FC_GEN_CALENDAR entries[SOC_DNX_FC_ILKN_MUB_GEN_CAL_LEN];
} SOC_DNX_FC_ILKN_MUB_GEN_CAL;
...
typedef struct
{
   ...
   *  clearing LLFC.
   */
  SOC_DNX_THRESH_WITH_HYST_INFO llfc;
  /*
   *  This field consists of the thresholds for setting PFC or 
   *  clearing PFC.
   */
  SOC_DNX_THRESH_WITH_HYST_INFO pfc;

} SOC_DNX_FC_PORT_FIFO_TH;
...
}SOC_DNX_FC_HCFC_WATCHDOG;

typedef enum
{
  SOC_DNX_FC_PFC_GEN_BMP_SRC_NIF =      0,
  SOC_DNX_FC_PFC_GEN_BMP_SRC_OOB =      1,
  SOC_DNX_FC_PFC_GEN_BMP_SRC_ILKN_INB = 2,
  SOC_DNX_FC_PFC_GEN_BMP_SRC_MUB =      3,
  SOC_DNX_FC_PFC_GEN_BMP_SRC_TYPES
}SOC_DNX_FC_PFC_GEN_BMP_SRC_TYPE;
...
} SOC_DNX_FC_PFC_GEN_BMP_INFO;

#define SOC_DNX_FC_INTF_TYPE_NIF      0
#define SOC_DNX_FC_INTF_TYPE_ILKN     1
#define SOC_DNX_FC_INTF_TYPE_MUB      2
#define SOC_DNX_FC_INTF_TYPE_SPI      3
#define SOC_DNX_FC_INTF_TYPE_HCFC     4

#define SOC_DNX_FC_NIF_TYPE_LLFC      0
#define SOC_DNX_FC_NIF_TYPE_PFC       1
#define SOC_DNX_FC_NIF_TYPE_SAFC      2

#define SOC_DNX_FC_CALENDAR_TYPE_LLFC 0
#define SOC_DNX_FC_CALENDAR_TYPE_CHFC 1

#define SOC_DNX_FC_SRC_TYPE_GLB       0
#define SOC_DNX_FC_SRC_TYPE_VSQ       1
#define SOC_DNX_FC_SRC_TYPE_NIF       2
#define SOC_DNX_FC_SRC_TYPE_HCFC      3

typedef struct  {
    uint32                          port;

    uint32                          intf_type;            /* SOC_DNX_FC_INTF_TYPE_XXX:     0-NIF, 1-ILKN, 2-MUB, 3-SPI, 4-HCFC */
    uint32                          is_oob;
    SOC_DNX_FC_DIRECTION            direction;

    uint32                          nif_fc_type;          /* SOC_DNX_FC_NIF_TYPE_XXX:      0-llfc, 1-pfc, 2-safc */

    uint32                          calendar_fc_type;     /* SOC_DNX_FC_CALENDAR_TYPE_XXX: 0-llfc, 1-chfc */
    uint32                          calendar_id;

    uint32                          src_type;             /* SOC_DNX_FC_SRC_TYPE_XXX:      0-global, 1-vsq, 2-nif */
    SOC_DNX_ITM_VSQ_GROUP           vsq_type;             /* A/B/C/D/E/F */
    uint32                          vsq_id;
} SOC_DNX_FC_STATUS_KEY;
...
typedef struct  {
    ...
    /* 3 calendar info */
    uint32 cal_tx_src_type;            /* SOC_DNX_FC_SRC_TYPE_XXX: 0-global, 1-vsq, 2-nif, 3-hcfc, 4-retransmit, 5-constant */
    uint32 cal_tx_src_vsq_type;        /* SOC_DNX_ITM_VSQ_GROUP:   0-A, 1-B, 2-C, 3-D, 4-E, 5-F */
    uint32 cal_tx_src_id;
    
    uint32 cal_rx_dst_type;            /* SOC_DNX_FC_REC_CAL_DEST_XXX: 0-PFC, 1-NIF, 2-2P port, 3-8P port, 4-Generic PFC bitmap */
    uint32 cal_rx_dst_id;

    /* 4 NIF info */
    uint32 nif_tx_src_id;

    SOC_DNX_FC_PFC_MAP_MODE nif_rx_dst_type[8];            /* SOC_DNX_FC_PFC_MAP_XXX: 0-PFC, 1-Generic PFC bitmap */
    uint32 nif_rx_dst_id[8];

    /* 5 Core info */
    uint32 core_id;
} SOC_DNX_FC_STATUS_INFO;
...
void SOC_DNX_FC_GEN_CALENDAR_clear(DNX_SAND_OUT SOC_DNX_FC_GEN_CALENDAR *cal_info);

void SOC_DNX_FC_GEN_INBND_INFO_clear(DNX_SAND_OUT SOC_DNX_FC_GEN_INBND_INFO *info);

void SOC_DNX_FC_GEN_INBND_CB_clear(DNX_SAND_OUT SOC_DNX_FC_GEN_INBND_CB *info);

void SOC_DNX_FC_GEN_INBND_LL_clear(DNX_SAND_OUT SOC_DNX_FC_GEN_INBND_LL *info);

void SOC_DNX_FC_REC_INBND_CB_clear(DNX_SAND_OUT SOC_DNX_FC_REC_INBND_CB *info);

void SOC_DNX_FC_GEN_INBND_PFC_clear(DNX_SAND_OUT SOC_DNX_FC_GEN_INBND_PFC *info);

void SOC_DNX_FC_REC_CALENDAR_clear(DNX_SAND_OUT SOC_DNX_FC_REC_CALENDAR *info);
