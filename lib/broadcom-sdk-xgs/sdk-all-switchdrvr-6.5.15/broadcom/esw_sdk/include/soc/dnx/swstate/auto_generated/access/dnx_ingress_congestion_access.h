/** \file dnx/swstate/auto_generated/access/dnx_ingress_congestion_access.h
 *
...
/**
 * implemented by: dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_set
 */
typedef int (*dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_set_cb)(
    int unit, uint32 port_based_vsq_idx_0, uint32 vsq_f_mapping_idx_0, uint32 pg_numq);

/**
 * implemented by: dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_get
 */
typedef int (*dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_get_cb)(
    int unit, uint32 port_based_vsq_idx_0, uint32 vsq_f_mapping_idx_0, uint32 *pg_numq);
...
typedef int (*dnx_ingress_congestion_db_algo_res_vsqe_id_set_cb)(
    int unit, uint32 vsqe_id_idx_0, sw_state_algo_res_t vsqe_id);
...
typedef int (*dnx_ingress_congestion_db_algo_res_vsqe_id_create_cb)(
    int unit, uint32 vsqe_id_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
typedef int (*dnx_ingress_congestion_db_algo_res_vsqf_id_set_cb)(
    int unit, uint32 vsqf_id_idx_0, sw_state_algo_res_t vsqf_id);
...
typedef int (*dnx_ingress_congestion_db_algo_res_vsqf_id_create_cb)(
    int unit, uint32 vsqf_id_idx_0, sw_state_algo_res_create_data_t * data, void *extra_arguments);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_a_c_set_cb)(
    int unit, uint32 vsq_rate_cls_a_c_idx_0, sw_state_algo_template_t vsq_rate_cls_a_c);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_a_c_create_cb)(
    int unit, uint32 vsq_rate_cls_a_c_idx_0, sw_state_algo_template_create_data_t * data, void *extra_arguments);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_a_c_exchange_cb)(
    int unit, uint32 vsq_rate_cls_a_c_idx_0, int core_id, uint32 flags, const dnx_ingress_congestion_queue_vsq_rate_class_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_a_c_profile_data_get_cb)(
    int unit, uint32 vsq_rate_cls_a_c_idx_0, int core_id, int profile, int *ref_count, dnx_ingress_congestion_queue_vsq_rate_class_info_t *profile_data);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_d_set_cb)(
    int unit, sw_state_algo_template_t vsq_rate_cls_d);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_d_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_ingress_congestion_queue_vsq_rate_class_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_d_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_ingress_congestion_queue_vsq_rate_class_info_t *profile_data);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_source_port_set_cb)(
    int unit, sw_state_algo_template_t vsq_rate_cls_source_port);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_source_port_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_ingress_congestion_src_port_vsq_rate_class_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_source_port_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_ingress_congestion_src_port_vsq_rate_class_info_t *profile_data);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_pg_set_cb)(
    int unit, sw_state_algo_template_t vsq_rate_cls_pg);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_pg_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_ingress_congestion_pg_vsq_rate_class_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_ingress_congestion_db_vsq_rate_class_vsq_rate_cls_pg_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_ingress_congestion_pg_vsq_rate_class_info_t *profile_data);
...
typedef int (*dnx_ingress_congestion_db_vsq_pg_tc_mapping_set_cb)(
    int unit, sw_state_algo_template_t vsq_pg_tc_mapping);
...
typedef int (*dnx_ingress_congestion_db_vsq_pg_tc_mapping_exchange_cb)(
    int unit, int core_id, uint32 flags, const dnx_ingress_congestion_vsq_tc_pg_mapping_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
...
typedef int (*dnx_ingress_congestion_db_vsq_pg_tc_mapping_profile_data_get_cb)(
    int unit, int core_id, int profile, int *ref_count, dnx_ingress_congestion_vsq_tc_pg_mapping_t *profile_data);
 ...
 */
typedef struct {
    dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_set_cb set;
    dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_get_cb get;
} dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_cbs;
...
typedef struct {
     ...
     */
    dnx_ingress_congestion_db_port_based_vsq_vsq_f_mapping_pg_numq_cbs pg_numq;
    /**
     * Access struct for src_port
     */
