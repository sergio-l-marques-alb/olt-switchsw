...
enum kbp_tap_instruction_type {
    ...
    KBP_TAP_INSTRUCTION_TYPE_EGRESS  = 1, /**< KBP TAP ingress instruction */
 ...
 * @returns KBP_OK on success or an error code otherwise.
 */
kbp_status kbp_tap_record_add_field(struct kbp_tap_record *record, char *name, uint32_t width,
