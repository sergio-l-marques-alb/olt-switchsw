...
enum kbp_blackhawk_tsc_txfir_tap_enable_enum {
    NRZ_LP_3TAP  = 0,
    NRZ_6TAP     = 1,
    PAM4_LP_3TAP = 2,
    PAM4_6TAP    = 3
 ...
 *
 * @param xpt pointer to the op2_xpt struct that contains the
 *            handle pointer
 * @param port_speed Supported speeds are 40G, 100G and 200G
 * @param port_bmp Bitmap to intialize port macro
 * @param is_nrz flag for NRZ or PAM4 mode
 * @param link_training 1. Enable 0. Disable
 *
 * @return KBP_OK on success or an error code.
 */
kbp_status kbp_device_pm_interface_init(void *xpt, int32_t port_speed, int32_t port_bmp,
