/*
 **************************************************************************************
 Copyright 2012-2018 Broadcom Corporation
...
#define KBP_SDK_VERSION "KBP SDK 1.5.5.1"
...
enum kbp_device_properties {
    ...
    KBP_DEVICE_PROP_INJECT_PARITY_ERRORS,/**< Inject the parity errors by using debug regs, few bits in both X,Y row are flipped
    ...
    KBP_DEVICE_PROP_ADV_UDA_WRITE,     /**< Enable/Disable advanced UDA write this is O3S specific, for OP its default*/
    ...
    KBP_DEVICE_PROP_STAT_RECORD_SIZE,        /**< Stats record size */
    ...
    KBP_DEVICE_PROP_TAP_INGRESS_OPCODE_EXT_LEN, /**< Number of valid bits for opcode ext field all ingress records */
    KBP_DEVICE_PROP_TAP_EGRESS_OPCODE_EXT_LEN,  /**< Number of valid bits for opcode ext field all egress records */
...
/**
 * Dumps Logical Table Registers Data for OP/OP2
 *
 * @param device Valid device handle.
 * @param ltr_no LTR number
 * @param verbose verbosity level
 *
 * @return KBP_OK on success or an error code otherwise.
 */
kbp_status kbp_device_show_ltr_regs(struct kbp_device *device, uint32_t ltr_no, uint8_t verbose);
