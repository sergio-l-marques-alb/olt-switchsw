/*
 **************************************************************************************
 Copyright 2015-2018 Broadcom Corporation
 ...
 * OR'd together to do multiple type of resets/disable to device.
 *
 ...
 *
 * @param type The device type. Currently only supported device is KBP_DEVICE_OP and KBP_DEVICE_OP2
...
/**
 * PCIe-SAT Read function to read SAT/MDIO regiter through PCIe-SAT BUS Path
 *
 * @param xpt valid xpt handle
...
/**
 * PCIe-SAT Write function to write SAT/MDIO regiter through PCIe-SAT BUS Path
 *
 * @param xpt valid xpt handle
 * @param size register size valid sizes are 16, 64 and 80
 * @param addr address of the register
