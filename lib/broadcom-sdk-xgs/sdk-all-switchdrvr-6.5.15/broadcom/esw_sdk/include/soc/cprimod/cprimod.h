 ...
 * @param [in]  offset_entry    - Encap Ordering info Offset Entry
 */
int cprimod_encap_ordering_info_sequence_offset_get(int unit, int port, uint32 queue, uint32 control, uint32 pcnt_size, uint32 qcnt_size, const cprimod_cpri_ordering_info_offset_t* offset_entry);
 ...
 */
int cprimod_tx_framer_tgen_next_bfn_set(int unit, int port, uint32 tgen_bfn);
/*! 
 ...
 */
int cprimod_tx_framer_tgen_next_bfn_get(int unit, int port, uint32* tgen_bfn);
 ...
 */
int cprimod_tx_framer_tgen_next_hfn_set(int unit, int port, uint32 tgen_hfn);
/*! 
 ...
 */
int cprimod_tx_framer_tgen_next_hfn_get(int unit, int port, uint32* tgen_hfn);
 ...
 * @param [out]  config_info     - Group Flow Configuration info.
 */
int cprimod_cpri_port_tx_vsd_ctrl_flow_get(int unit, int port, uint32 group_id, cprimod_cpri_tx_vsd_flow_info_t* config_info);
 ...
 */
int cprimod_fast_clk_bit_time_period_set(int unit, int port, cprimod_port_speed_t speed);
/*! 
