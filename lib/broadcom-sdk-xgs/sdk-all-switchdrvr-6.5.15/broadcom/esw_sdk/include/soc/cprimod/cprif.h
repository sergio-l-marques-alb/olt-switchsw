...
int cprif_encap_ordering_info_sequence_offset_get(int unit, int port, uint32 queue, uint32 control, uint32 pcnt_size, uint32 qcnt_size, const cprimod_cpri_ordering_info_offset_t* offset_entry);
...
int cprif_decap_ordering_info_sequence_offset_get(int unit, int port, uint32 queue, cprimod_cpri_ordering_info_offset_t* offset_entry);
...
/* Tx Framer TGEN next Radio Frame Number (bfn).  */
...
int cprif_cpri_rx_control_word_sync_info_get(int unit, int port, uint32* basic_frame_num, uint32* hyper_frame_num, uint32* radio_frame_num);
...
/* Add CPRI Rx VSD Group Flow  Configuration Add. */
