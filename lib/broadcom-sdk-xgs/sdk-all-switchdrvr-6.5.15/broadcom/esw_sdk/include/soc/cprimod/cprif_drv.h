...
int cprif_drv_rx_framer_agnostic_mode_set(int unit, int port, uint32 axc_id,  int enable,  cprimod_agnostic_mode_type_t mode);
...
int cprif_drv_rxpcs_tunnel_mode_set(int unit, int port, int enable, uint32 timestamp_interval);
int cprif_drv_rxpcs_tunnel_mode_get(int unit, int port, int* enable, uint32* timestamp_interval);
int cprif_drv_txpcs_agnostic_mode_set(int unit, int port, int enable, cprimod_agnostic_mode_type_t mode,  uint32 timestamp_interval);
...
int cprif_drv_fast_clk_bit_time_period_set(int unit, int port, cprimod_port_speed_t speed);
...
int cprif_drv_port_link_down_reset(int unit, int port);
