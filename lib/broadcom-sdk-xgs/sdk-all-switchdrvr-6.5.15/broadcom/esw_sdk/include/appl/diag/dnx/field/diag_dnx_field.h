 ...
 *   Relevant ENUM: Field_stage_enum_table[]
 */
#define DIAG_DNX_FIELD_OPTION_STAGE         "stage"
/**
 * \brief
 *   Keyword for the field context.
 *   Relevant ENUM: Field_context_enum_table_for_display[]
 */
 ...
 * that are used for display (diagnostics)
 */
extern sh_sand_enum_t Field_context_enum_table_for_display[];
/**
 * \brief
