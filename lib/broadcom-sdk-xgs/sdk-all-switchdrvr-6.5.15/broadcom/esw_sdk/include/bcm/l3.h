...
/* 
 * Configure DLB monitoring parameters for a DLB id derived from ECMP
 * group id
 */
...
/* 
 * Fetch DLB monitoring parameters for a DLB id derived from ECMP group
 * id
 */
...
/* Initialize bcm_l3_ecmp_dlb_mon_t structure */
