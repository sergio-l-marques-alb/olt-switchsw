...
#define BCM_COSQ_GPORT_IS_PHANTOM_PORT(_gport)  _SHR_COSQ_GPORT_IS_PHANTOM_PORT(_gport) 
...
#define BCM_COSQ_GPORT_PHANTOM_PORT_SET(_gport, _port)  \
    _SHR_COSQ_GPORT_PHANTOM_PORT_SET(_gport, _port) 

#define BCM_COSQ_GPORT_PHANTOM_PORT_GET(_gport)  \
    (!_SHR_COSQ_GPORT_IS_PHANTOM_PORT(_gport) ? -1 :  \
    _SHR_COSQ_GPORT_PHANTOM_PORT_GET(_gport)) 
