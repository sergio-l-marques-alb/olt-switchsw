...
typedef enum bcm_port_tag_struct_type_e {
    ...
    bcmNofTagStructType = 5         /* Number of tag structure types */
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_COUNT = 41           /* Must be last */
} bcm_port_match_t;
...
/* 
 * Remap the ILKN lane Id for ILKN ports. This mapping is done after port
 * is created. Port must be in disabled state before calling this API.
 * Location in the array represents the ILKN lane number (e.g.
 * ilkn_lane_id[x] holds the information for ILKN lane=x)
 */
extern int bcm_port_ilkn_lane_id_map_set(
    int unit, 
    int flags, 
    bcm_port_t port, 
    int num_of_lanes, 
...
/* 
 * Get the ILKN remap information for ILKN ports. Location in the array
 * represents the ILKN lane number (e.g. ilkn_lane_id[x] holds the
 * information for ILKN lane=x)
 */
extern int bcm_port_ilkn_lane_id_map_get(
    int unit, 
    int flags, 
    bcm_port_t port, 
    int num_of_lanes, 
