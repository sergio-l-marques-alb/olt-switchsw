...
#define BCM_SID_INITIATOR_WITH_ID   (1 << 0)   /* if set, the tunnel_id will be
                                                  given by user as input,
                                                  otherwise output from
                                                  alloc_manager */
#define BCM_SID_INITIATOR_REPLACE   (1 << 1)   /* Replace existing entry, update
                                                  existing Tunnel */

/* SRv6 SRH base initiator flags */
#define BCM_SRH_BASE_INITIATOR_WITH_ID  (1 << 0)   /* if set, the tunnel_id will
                                                      be given by user as input,
                                                      otherwise output from
                                                      alloc_manager */
#define BCM_SRH_BASE_INITIATOR_REPLACE  (1 << 1)   /* Replace existing entry,
                                                      update existing Tunnel */
#define BCM_SRH_BASE_INITIATOR_LAST_SID (1 << 2)   /* if set, SRH Base is linked
                                                      to the last SID of the
                                                      tunnel */
...
typedef struct bcm_srv6_srh_base_initiator_info_s {
    ...
    bcm_ip6_t last_sid;                 /* Last SID to encapsulate */
