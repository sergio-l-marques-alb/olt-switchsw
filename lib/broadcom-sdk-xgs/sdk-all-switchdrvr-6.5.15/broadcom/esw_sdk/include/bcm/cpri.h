...
typedef enum bcm_cpri_port_speed_e {
    bcmCpriPortSpeed1228p8 = 0,     /* 1228.8Mbps */
    bcmCpriPortSpeed2457p6 = 1,     /* 2457.6Mbps */
    bcmCpriPortSpeed3072p0 = 2,     /* 3072.0Mbps */
    bcmCpriPortSpeed4915p2 = 3,     /* 4915.2Mbps */
    bcmCpriPortSpeed6144p0 = 4,     /* 6144.0Mbps */
    bcmCpriPortSpeed9830p4 = 5,     /* 9830.4Mbps */
    bcmCpriPortSpeed10137p6 = 6,    /* 10137.6Mbps */
    bcmCpriPortSpeed12165p12 = 7,   /* 12165.12Mbps */
    bcmCpriPortSpeed24330p24 = 8    /* 24330.24G */
...
typedef enum bcm_rsvd4_msg_ts_mode_e {
    bcmRsvd4MsgTsModeWCDMA = _shrRsvd4MsgTsModeWCDMA, /*  Msg Timestamp WCDMA mode */
    bcmRsvd4MsgTsModeLTE = _shrRsvd4MsgTsModeLTE, /*  Msg Timestamp LTE mode */
    bcmRsvd4MsgTsModeGSMDL = _shrRsvd4MsgTsModeGSMDL, /*  Msg Timestamp GSM DownLink */
    bcmRsvd4MsgTsModeGSMUL = _shrRsvd4MsgTsModeGSMUL, /*  Msg Timestamp GSM UpLink */
    bcmRsvd4MsgTsModeCount = _shrRsvd4MsgTsModeCount /*  */
} bcm_rsvd4_msg_ts_mode_t;

/* RSVD4 Sync modes */
typedef enum bcm_rsvd4_sync_mode_e {
    bcmRsvd4SyncModeNoSync = 0,         /*  Sync On any message */
    bcmRsvd4SyncModeRadioFrame = 1,     /*  Sync on Radio Frame */
    bcmRsvd4SyncModeMasterFrame = 2,    /*  Sync On Master Frame */
    bcmRsvd4SyncModeTsNoSync = 3,       /*  Sync on any frame  Msg Timestamp,
                                           GSM only */
    bcmRsvd4SyncModeTsRadioFrame = 4,   /*  Sync on radio frame  Msg Timestamp,
                                           GSM only */
    bcmRsvd4SyncModeTsMasterFrame = 5   /*  Sync on master frame  Msg Timestamp,
                                           GSM only */
...
typedef enum bcm_rsvd4_tx_config_e {
    ...
    bcmRsvd4TxConfigTransmitterEnable = 5 /*  Transmitter Enable */
...
/*  Set the modulo Rule configuration */
...
/*  Set position entry configuration */
...
/*  Get position entry configuration */
...
/*  RSVD4 control message process type. */
typedef enum bcm_rsvd4_cm_process_type_e {
    bcmRsvd4ControlMsgProcEth = _shrRsvd4CtrlMsgProcFE, /* Multi Message Fast Ethernet. */
    bcmRsvd4ControlMsgProcFcb = _shrRsvd4CtrlMsgProcFCB, /* FCB */
    bcmRsvd4ControlMsgProcPayload = _shrRsvd4CtrlMsgProcPayload, /* Message Payload Extraction. */
    bcmRsvd4ControlMsgProcFull = _shrRsvd4CtrlMsgProcFull, /* Full Message. */
    bcmRsvd4ControlMsgProcFullWithTag = _shrRsvd4CtrlMsgProcFullWithTag, /* Full Message with Tag. */
    bcmRsvd4ControlMsgProcCount = _shrRsvd4CtrlMsgProcCount /* Should be last */
...
typedef struct bcm_rsvd4_control_flow_config_s {
    ...
    bcm_rsvd4_cm_process_type_t type;   /*  Message process type */
...
typedef _shr_cpri_fast_eth_config_t bcm_rsvd4_fast_eth_config_info_t;
...
typedef enum bcm_rsvd4_sync_count_cycle_e {
    bcmRsvd4SyncCountEveryMf = _shrRsvd4SyncCountCycleEveryMF, /* Every frame. */
    bcmRsvd4SyncCountUptoSixMf = _shrRsvd4SyncCountCycleUpToSixMF, /* Upto 6 MF */
    bcmRsvd4SyncCountCycleCount = _shrRsvd4SyncCountCycleCount /* Should be last */
...
typedef _shr_cpri_tag_gen_entry_t bcm_cpri_tag_gen_entry_t;
...
/*  RSVD4 Control Message Process Type. */
typedef enum bcm_rsvd4_control_msg_proc_type_e {
    bcmRsvd4CmProcEth = _shrRsvd4CtrlMsgProcFE, /* Multi Message Fast Ethernet. */
    bcmRsvd4CmProcFcb = _shrRsvd4CtrlMsgProcFCB, /* FCB */
    bcmRsvd4CmProcPayload = _shrRsvd4CtrlMsgProcPayload, /* Message Payload Extraction. */
    bcmRsvd4CmProcFull = _shrRsvd4CtrlMsgProcFull, /* Full Message. */
    bcmRsvd4CmProcFullWithTag = _shrRsvd4CtrlMsgProcFullWithTag, /* Full Message with Tag. */
    bcmRsvd4CmProcCount = _shrRsvd4CtrlMsgProcCount /* Should be last */
...
/*  Delete control flow group memeber. */
...
/*  Set RSVD4 control message ethernet configuration */
...
/*  Set RSVD4 Tx Control message raw configuration */
...
typedef enum bcm_rsvd4_cm_tunnel_crc_option_e {
    bcmRsvd4CmTunnelCrcUseRoe = _shrRsvd4CrcOptionUseRoe, /* Use CRC from ROE packet. */
    bcmRsvd4CmTunnelCrcRegenerate = _shrRsvd4CrcOptionRegenerate, /* Regenerate New CRC */
    bcmRsvd4CmTunnelCrcCount = _shrRsvd4CrcOptionCount /* Should be last */
} bcm_rsvd4_cm_tunnel_crc_option_t;

#ifndef BCM_HIDE_DISPATCHABLE

/*  set RSVD4 control message tunnel CRC configuration */
...
/*  SetRSVD4 Control Message header configuration */
...
/*  Set RSVD4 Control Message Header Lookup Entry */
...
typedef struct bcm_cpri_fast_eth_config_info_s {
    ...
    uint32 drop_min_pkt_size;       /*  min packet size to drop */
    uint32 drop_max_pkt_size;       /*  max packet size to drop */
...
#define BCM_CPRI_VSD_CONTROL_SUBCHAN_NUM_BYTES_4 _shrVsdCtrlSubchanNumBytes4 
...
/*  Retrieve Control word sync information */
...
/*  Set Encapsulation Control Queue, tag to flow mapping */
...
/*  Retrieve Rx VSD Raw Configuration */
...
/*  Get Tx VSD control flow */
extern int bcm_cpri_port_tx_cw_vsd_ctrl_flow_config_get(
    int unit, 
    int port, 
    uint16 group_id, 
    bcm_cpri_tx_vsd_flow_info_t *config);

/*  Retrieve Tx VSD control flow */
...
/*  Retrieve Tx VSD Raw flow configuration */
...
/* Register a callback routine for CPRI interrupts. */
...
/* Unregister a callback routine registered for CPRI interrupts. */
extern int bcm_cpri_port_interrupt_callback_unregister(
    int unit, 
    bcm_cpri_interrupt_type_t cpri_intr_type, 
    bcm_cpri_port_interrupt_callback_t callback);

/* Enable/Disable CPRI port RX/TX interrupts. */
...
/* Set CPRI port 1588 timestamp capture configuration for FIFO and GDPLL. */
...
/* Get CPRI port 1588 timestamp capture configuration for FIFO and GDPLL. */
...
typedef _shr_cpri_1588_timestamp_ts_config_t bcm_cpri_1588_timestamp_ts_config_t;
...
typedef _shr_cpri_fec_timestamp_config_t bcm_cpri_fec_timestamp_config_t;
...
/* Get Compression Saturation Threshold Value. */
