...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyINTReserved4Bytes = 942, /* Qualifies on INT Reserved 4 bytes
                                           ...
                                           header. */
    bcmFieldQualifyCount = 943          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionRpOamCopyToCpu = 636, /* Copies Red packet to CPU along with
                                           OAM reason code be carried to CPU */
    bcmFieldActionCount = 637           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
#define BCM_FIELD_ACTION_POSITION(array_id, position)  \
    ((((position) & BCM_FIELD_ACTION_POSITION_MASK) | \
      (((array_id) & BCM_FIELD_ACTION_ARRAY_MASK) \
...
#define BCM_FIELD_ACTION_PRIORITY(array_id, priority)  \
    ((((priority) & BCM_FIELD_ACTION_PRIORITY_MASK) | \
      ((array_id) << BCM_FIELD_ACTION_ARRAY_OFFSET) | \
...
typedef enum bcm_field_egress_flow_control_e {
    ...
    bcmFieldEgressFlowControlCount = 3  /* Always last. Not to be used. */
...
typedef enum bcm_field_egress_flow_encap_e {
    bcmFieldEgressFlowEncapAppendIncomingOuterVlan = 0, /* The incoming Outer Vlan tag will be
                                           appended in the outgoing packet */
    bcmFieldEgressFlowEncapCount = 1    /* Always last. Not to be used. */
