...
void	bcm_cpri_port_tx_cw_vsd_ctrl_flow_config_get_async(int unit, int port, uint16 group_id, bcm_cpri_tx_vsd_flow_info_t * config, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_xflow_macsec_control_get_async(int unit, uint32 flags, bcm_xflow_macsec_control_t type, uint64 * value, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_xflow_macsec_control_set_async(int unit, uint32 flags, bcm_xflow_macsec_control_t type, uint64 value, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_xflow_macsec_mtu_get_async(int unit, int flags, bcm_xflow_macsec_mtu_t mtu_sel, uint32 * mtu, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_xflow_macsec_mtu_set_async(int unit, int flags, uint32 mtu, bcm_xflow_macsec_mtu_t * mtu_sel, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_xflow_macsec_sectag_etype_get_async(int unit, bcm_xflow_macsec_sectag_ethertype_t sectag_etype_sel, uint32 * sectag_etype, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_xflow_macsec_sectag_etype_set_async(int unit, int flags, uint32 sectag_etype, bcm_xflow_macsec_sectag_ethertype_t * sectag_etype_sel, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_xflow_macsec_secure_chan_info_traverse_async(int unit, uint32 flags, bcm_xflow_macsec_chan_traverse_cb callback, void * user_data, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_xflow_macsec_station_mac_addr_get_async(int unit, bcm_mac_t mac_addr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_xflow_macsec_station_mac_addr_set_async(int unit, bcm_mac_t mac_addr, bcm_async_cb_t async_callback, void *async_cookie);
