...
typedef enum bcm_oam_control_type_e {
    ...
    bcmOAMControlCount = 27             /* Always Last. Not a usable value. */
...
#define BCM_OAM_PROFILE_LM_TYPE_DUAL_ENDED  0x2        /* When LM is done via
                                                          CCM PDU. */
#define BCM_OAM_PROFILE_LM_TYPE_SLM         0x4        /* When LM is done via
                                                          SLM/SLR PDU. */
#define BCM_OAM_PROFILE_DM_TYPE_NTP         0x8        /* Use NTP format for DM. */
#define BCM_OAM_PROFILE_LM_TYPE_NONE        0x10       /* Disable counter
                                                          stamping on LMM/LMR
                                                          SLM/SLR packets. */
...
/* Initialize an OAM ACTION key structure */
extern void bcm_oam_action_key_t_init(
    bcm_oam_action_key_t *action_key_ptr);

/* Initialize an OAM ACTION result structure */
...
/* Destroy OAM reflector encap_id. */
