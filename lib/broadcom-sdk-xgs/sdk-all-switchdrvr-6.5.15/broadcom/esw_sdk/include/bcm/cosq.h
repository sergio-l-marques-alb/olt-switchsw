...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatIOMEnqueuedPacketsBucketM = 89, /* Snapshot of bucket M arrival counter
                                           value for the epoch. This counter is
                                           valid only if
                                           bcmSwitchIomSamplingType is set to
                                           bucket type(1) */
    bcmCosqStatIOMEnqueuedPacketsBucketB = 90, /* Snapshot of bucket B arrival counter
                                           value for the epoch. This counter is
                                           valid only if
                                           bcmSwitchIomSamplingType is set to
                                           bucket type(1) */
    bcmCosqStatIOMEnqueuedPacketsBucketC = 91, /* Snapshot of bucket C arrival counter
                                           value for the epoch. This counter is
                                           valid only if
                                           bcmSwitchIomSamplingType is set to
                                           bucket type(1) */
    bcmCosqStatIOMDroppedPackets = 92,  /* Snapshot of packets drop counter
                                           value for the epoch. Configured using
                                           bcmSwitchIomSamplingSelectDropType */
    bcmCosqStatIOMDroppedBytes = 93,    /* Snapshot of bytes drop counter value
                                           for the epoch. Configured using
                                           bcmSwitchIomSamplingSelectDropType */
    bcmCosqStatIOMMaxUsage = 94,        /* Snapshot of maximum usage value for
                                           the epoch. Configured using
                                           bcmSwitchIomSamplingMaxUsageType. */
    bcmCosqStatIOMFlowControlEvents = 95, /* Snapshot of Flow Control events
                                           counter value for the epoch. */
    bcmCosqStatDiscardUCDroppedPackets = 96, /* Per port per queue WRED dropped
                                           packets. */
    bcmCosqStatMaxCount = 97            /* this should be the last one. */
} bcm_cosq_stat_t;
