...
typedef enum bcm_rx_trap_e {
    ...
    bcmRxTrapEgressTrapped2ndPass = 373, /* Egress trapped packet on 2nd pass
                                           Trap. */
    bcmRxTrapCount = 374                /* Must be last: enum count size. */
} bcm_rx_trap_t;
...
typedef struct bcm_rx_mtu_config_s {
    ...
    uint8 compressed_layer_type;    /* Compressed layer type - Only relevant for
                                       LIF/RIF */
    bcm_gport_t trap_gport;         /* Trap GPORT (Action Profile, FWD and SNP
                                       Strength */
} bcm_rx_mtu_config_t;
