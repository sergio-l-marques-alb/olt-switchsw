...
#ifndef _SHR_SW_STATE_DPP_SOC_JERICHO_TM_DRAM_WR_CRC_INTERRUPT_STATE_DIAGNOSTIC_H_
#define _SHR_SW_STATE_DPP_SOC_JERICHO_TM_DRAM_WR_CRC_INTERRUPT_STATE_DIAGNOSTIC_H_
...
/* implemented by: sw_state_dpp_soc_jericho_tm_dram_wr_crc_interrupt_state_dump */
typedef int (*sw_state_dpp_soc_jericho_tm_dram_wr_crc_interrupt_state_dump_cb)(
    int unit);
...
int sw_state_dpp_soc_jericho_tm_dram_wr_crc_interrupt_state_diagnostic_cb_init(int unit);

#endif /* BCM_WARM_BOOT_API_TEST */

#endif /* _SHR_SW_STATE_DPP_SOC_JERICHO_TM_DRAM_WR_CRC_INTERRUPT_STATE_DIAGNOSTIC_H_ */
