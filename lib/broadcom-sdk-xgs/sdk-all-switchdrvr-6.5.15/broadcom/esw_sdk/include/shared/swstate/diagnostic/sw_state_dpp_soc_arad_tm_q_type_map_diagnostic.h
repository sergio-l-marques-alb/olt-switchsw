...
#ifndef _SHR_SW_STATE_DPP_SOC_ARAD_TM_Q_TYPE_MAP_DIAGNOSTIC_H_
#define _SHR_SW_STATE_DPP_SOC_ARAD_TM_Q_TYPE_MAP_DIAGNOSTIC_H_
...
/* implemented by: sw_state_dpp_soc_arad_tm_q_type_map_dump */
typedef int (*sw_state_dpp_soc_arad_tm_q_type_map_dump_cb)(
...
int sw_state_dpp_soc_arad_tm_q_type_map_diagnostic_cb_init(int unit);

#endif /* BCM_WARM_BOOT_API_TEST */

#endif /* _SHR_SW_STATE_DPP_SOC_ARAD_TM_Q_TYPE_MAP_DIAGNOSTIC_H_ */
