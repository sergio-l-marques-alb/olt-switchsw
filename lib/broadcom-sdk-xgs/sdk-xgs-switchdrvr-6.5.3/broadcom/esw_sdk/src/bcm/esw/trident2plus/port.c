...
STATIC int
_bcm_td2p_port_mixed_sister_encap_check(int unit, bcm_port_t port, int mode);
...
static bcm_esw_port_drv_t bcm_td2p_port_drv = {
    ...
    /* mixed_sister_encap_check   */ _bcm_td2p_port_mixed_sister_encap_check,
};
...
/*
 * Function:
 *      _bcm_td2p_port_mixed_sister_encap_check
 * Purpose:
...
_bcm_td2p_port_mixed_sister_encap_check(int unit, bcm_port_t port, int mode)
{
    ...
    rv = soc_td2p_port_mixed_sister_encap_check(unit, port, mode);
