...
__cint_maddr__portmod_port_init_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 18: rv = &(s->an_cl73);break;
        case 19: rv = &(s->is_hg);break;
        case 20: rv = &(s->ext_phy_tx_params_user_flag);break;
        case 21: rv = &(s->ext_phy_tx_params);break;
        case 22: rv = &(s->polarity);break;
        case 23: rv = &(s->polarity_overwrite);break;
        case 24: rv = &(s->lane_map);break;
        case 25: rv = &(s->lane_map_overwrite);break;
        case 26: rv = &(s->fw_load_method);break;
        case 27: rv = &(s->fw_load_method_overwrite);break;
        case 28: rv = &(s->ref_clk);break;
        case 29: rv = &(s->ref_clk_overwrite);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static cint_parameter_desc_t __cint_struct_members__portmod_port_init_config_t[] = 
{
    ...
    {"int", "tx_params_user_flag", 0, 0},
    {"phymod_tx_t", "tx_params", 0, 0},
    {"int", "an_cl37", 0, 0},
    {"int", "an_cl73", 0, 0},
    {"int", "is_hg", 0, 0},
    {"int", "ext_phy_tx_params_user_flag", 0, 0},
    {"phymod_tx_t", "ext_phy_tx_params", 0, 0},
