        ...
        if (arg_profile) {
            ...
            */
            ...
            if ( 0x01 == (arg_profile & 0x0F) ) {
                ...
                /* IXIA does not have configurable field for this.
                   To test local priority match in dataset comparison algorithm, 
                   this field needs to be same as that sent by IXIA. Hence setting this to 0 */
                clock_info.scaled_log_variance = 0;
            }
        }
...
tdpll_instance_show(int unit, int low_idx, int high_idx)
{
    ...
    const char *padding[14] = {" ", " ", " ", " ", " ", " ",  /* GPIO 0-5 */
                                  " ", " ", "  ",                /* SE1, SE2, 1588 */
                                  " ", " ", "  ", "    ", "    "};       /* BS0, BS1, SLCPLL/XGPLL0, MLCPLL/XGPLL1, XGPLL3 */

    if (SOC_IS_APACHE(unit)) {
        cli_out("#  GP0  GP1  GP2  GP3  GP4  GP5  SE1  SE2  1588  BS0  BS1  XGPLL0  XGPLL1  XGPLL3  BW   PBO\n");
    } else {
...
cmd_tdpll_instance(int unit, args_t *a)
{
    ...
    char *output_str_ap[TDPLL_OUTPUT_CLOCK_NUM_MAX] =
        {"BroadSync0    ", "BroadSync1    ", "XgPll0        ", "XgPll1        ",
         "1588-Hybrid   ", "GPIO0", "GPIO1", "GPIO2", "GPIO3", "GPIO4", "GPIO5", "XgPll3        "};
#endif
...
#define TDPLL_OUTPUTCLK_USAGE_AP \
    ...
    "\t                                 | XgPll0        | XgPll1        |\n" \
    "\t                                 | 1588-Hybrid   | GPIO0 | GPIO1 |\n" \
    "\t                                 | GPIO2 | GPIO3 | GPIO4 | GPIO5 | XgPll3\n" \
    "\t TDPLL OUTputclk Set <index> ENable=<y/n>\n"                    \
    "\t                     FREQuency=<value> TSFREQuency= <value>\n"        \
    "\t                     DerivFREQuency=<value>\n"
#endif
...
cmd_tdpll_outputclk(int unit, args_t *a)
{
    ...
    char *arg_index_str_ap[TDPLL_OUTPUT_CLOCK_NUM_MAX+1] =
           {"BroadSync0", "BroadSync1", "XgPll0", "XgPll1", "1588-Hybrid",
            "GPIO0", "GPIO1", "GPIO2", "GPIO3", "GPIO4", "GPIO5", "XgPll3", 0};
#endif
...
#if defined(BCM_APACHE_SUPPORT)
    char *arg_index_str_ap[TDPLL_OUTPUT_CLOCK_NUM_MAX+1] =
        {"BroadSync0", "BroadSync1", "XgPll0", "XgPll1", "1588-Hybrid", "XgPll3", 0};
#endif
    int arg_index = 0;
    int arg_freqppt;
