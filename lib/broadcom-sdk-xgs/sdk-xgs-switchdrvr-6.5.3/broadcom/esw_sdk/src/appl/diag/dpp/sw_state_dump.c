...
void endpoint_list_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int unit ;
   ENDPOINT_LIST_PTR endpoint_list = *((ENDPOINT_LIST_PTR *) element); 
   endpoint_list_t *elt ; 
   /*
    ...
    */
   unit = 0 ;
   bcm_dpp_endp_lst_get_endp_lst_ptr_from_handle(unit,endpoint_list,&elt) ;
...
void endpoint_list_member_t_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int unit ;
   ENDPOINT_LIST_MEMBER_PTR endpoint_list_member = *((ENDPOINT_LIST_MEMBER_PTR *) element); 
   endpoint_list_member_t *elt ; 
   /*
    * This is completely against the rules of the new sw state module but, then,
    * this whole file is going to be replaced so this is a good temporary solution.
    * (Also, fix unit at '0', just, again, as a temporary solution).
    */
   unit = 0 ;
   bcm_dpp_endp_lst_get_endp_lst_m_ptr_from_handle(unit,endpoint_list_member,&elt) ;
...
/*   arraySizes_SW_DUMP[0]=BCM_MAX_NUM_UNITS; 
   ...
   arraySizes_SW_DUMP[0]=SOC_MAX_NUM_DEVICES; 
   arraySizes_SW_DUMP[1]=SOC_PPC_NOF_TRAP_CODES; 
