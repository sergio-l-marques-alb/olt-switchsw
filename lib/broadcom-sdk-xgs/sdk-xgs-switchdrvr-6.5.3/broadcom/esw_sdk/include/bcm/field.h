...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyCount = 607          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionCount = 439           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
typedef enum bcm_field_control_e {
    ...
    bcmFieldControlCount = 30           /* Always last. Not a usable value. */
} bcm_field_control_t;
