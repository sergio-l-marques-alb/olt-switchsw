 ...
 * Generated:	Fri Feb 26 16:34:12 2016
 */
...
typedef struct {
	...
	int (*cosq_ingress_port_drop_map_get)(int,bcm_port_t,uint32,bcm_cosq_ingress_port_drop_map_t,uint32,bcm_color_t *);
	int (*cosq_ingress_port_drop_map_set)(int,bcm_port_t,uint32,bcm_cosq_ingress_port_drop_map_t,uint32,bcm_color_t);
	int (*cosq_ingress_port_drop_threshold_get)(int,bcm_port_t,uint32,bcm_color_t,uint32 *);
	int (*cosq_ingress_port_drop_threshold_set)(int,bcm_port_t,uint32,bcm_color_t,uint32);
	...
	int (*cosq_resource_allocation_get)(int,uint32,bcm_cosq_allocation_resource_t,bcm_cosq_allocation_entity_t *,bcm_cosq_resource_amounts_t *);
	int (*cosq_resource_allocation_set)(int,uint32,bcm_cosq_allocation_resource_t,bcm_cosq_allocation_entity_t *,bcm_cosq_resource_amounts_t *);
	...
	int (*ipsec_sa_update_key)(int,uint32,uint32,bcm_ipsec_sa_keys_t *);
	int (*ipsec_tunnel_add)(int,uint32,uint32 *,bcm_ipsec_tunnel_info_t);
