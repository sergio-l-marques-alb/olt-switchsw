...
#define SOC_IS_JERICHO_PLUS_AND_BELOW(unit)  (SOC_IS_JERICHO(unit) && !SOC_IS_QAX(unit))
#else
#define SOC_IS_JERICHO_PLUS(unit)          (0)
#define SOC_IS_JERICHO_PLUS_A0(unit)       (0)
#define SOC_IS_JERICHO_PLUS_AND_BELOW(unit) (0)
#endif
...
#define SOC_IS_DPP(unit) (SOC_IS_ARAD(unit) || SOC_IS_ACP(unit) || SOC_IS_JERICHO_P3(unit) || SOC_IS_ARDON(unit) || SOC_IS_QAX(unit)  || SOC_IS_JERICHO_PLUS(unit))
...
#define KAPS_BBS_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_KAPS_BBS_BLKS)) ? SOC_INFO(unit).kaps_bbs_block[instance] : (-1))
...
typedef struct {
    ...
    int             nof_pmqs;
        ...
        int             kaps_bbs_block[SOC_MAX_NUM_KAPS_BBS_BLKS];
        int             pll_block;
        int             dqm_block;
        int             ecgm_block;
        int             gck_block;
