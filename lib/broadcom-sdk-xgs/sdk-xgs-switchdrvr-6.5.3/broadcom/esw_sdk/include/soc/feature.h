...
SHR_G_ENTRY(global_meter_policer_list_support), /* Return allotted policer list */ \
...
SHR_G_ENTRY(avs), /* AVS algorithm support */ \
...
SHR_G_ENTRY(l2_remote_trunk_overlay), /* L2 remote trunk overlay (BCM56560_A0/BCM56860_A0) */ \
