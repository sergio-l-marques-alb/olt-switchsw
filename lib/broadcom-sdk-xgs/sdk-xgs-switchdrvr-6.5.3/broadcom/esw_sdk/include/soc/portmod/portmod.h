...
#define PORTMOD_CL73_WO_BAM (0x1)
#define PORTMOD_CL73_W_BAM (0x2)
...
typedef struct portmod_port_init_config_s {
    ...
    int ext_phy_tx_params_user_flag;
    phymod_tx_t ext_phy_tx_params; /**< external phy tx params from config */
