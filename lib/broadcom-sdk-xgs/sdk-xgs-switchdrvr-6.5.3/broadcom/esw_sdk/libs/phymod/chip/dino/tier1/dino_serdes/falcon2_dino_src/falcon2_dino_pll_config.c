 ...
 *  Revision      :  $Id: falcon2_dino_pll_config.c 1172 2015-10-06 19:34:58Z kirand $ *
 *                                                                                    *
...
err_code_t falcon2_dino_configure_pll( const phymod_access_t *pa, enum falcon2_dino_pll_enum pll_cfg) {
 ...
 /* FALCON2_DINO_EFUN(wrc_pll_mode                                         (   0x7));   */
 /* FALCON2_DINO_EFUN(wrc_ams_pll_vco2_15g                                 (   0x0));   */
 /* FALCON2_DINO_EFUN(wrc_ams_pll_force_kvh_bw                             (   0));     */
 /* FALCON2_DINO_EFUN(wrc_ams_pll_kvh_force                                (   0));     */
 /* FALCON2_DINO_EFUN(wrc_ams_pll_vco_indicator                            (   0));     */
