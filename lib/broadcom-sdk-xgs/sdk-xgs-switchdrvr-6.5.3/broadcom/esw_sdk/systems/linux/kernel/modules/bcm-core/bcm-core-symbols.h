...
EXPORT_SYMBOL(_bcm_dpp_rx_get_converted_trap_sw_id);
...
EXPORT_SYMBOL(rhlist_add_tail);
EXPORT_SYMBOL(rhlist_create);
EXPORT_SYMBOL(rhlist_free_all);
EXPORT_SYMBOL(rhlist_get_first);
EXPORT_SYMBOL(rhlist_get_next);
#endif /* BCM_DPP_SUPPORT */
