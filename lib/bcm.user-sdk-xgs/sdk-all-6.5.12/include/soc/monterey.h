...
#define SOC_MONTEREY_NUM_EL_L2                             4
#define SOC_MONTEREY_NUM_EL_SHARED                         8
#define SOC_MONTEREY_NUM_EL_ALPM                           4
#define SOC_MONTEREY_NUM_EL_VLAN_XLATE                     4
#define SOC_MONTEREY_NUM_EL_EGR_VLAN_XLATE                 4
#define SOC_MONTEREY_NUM_EL_ING_L3_NEXT_HOP                8
#define SOC_MONTEREY_NUM_EL_L3_IPMC                        4
#define SOC_MONTEREY_NUM_EL_L2MC                           4

#define SOC_MONTEREY_RAM_OFFSET_L2_BANK                 4096
#define SOC_MONTEREY_RAM_OFFSET_L2_SHARED_BANK          8192
...
#define SOC_MONTEREY_RAM_OFFSET_ING_L3_NEXT_HOP         4096
#define SOC_MONTEREY_RAM_OFFSET_L3_IPMC                 2048
#define SOC_MONTEREY_RAM_OFFSET_L2MC                    4096
...
#define SOC_MONTEREY_NUM_ENTRIES_PER_L2_BANK           16384
#define SOC_MONTEREY_NUM_ENTRIES_L2_BANK               32768
#define SOC_MONTEREY_NUM_ENTRIES_L3_BANK               1024
#define SOC_MONTEREY_NUM_ENTRIES_L3_BANK_WIDE          512
#define SOC_MONTEREY_NUM_ENTRIES_L3_BANK_DOUBLE_WIDE   256
...
extern int soc_monterey_fc_map_shadow_create(int unit);
extern void soc_monterey_fc_map_shadow_free(int unit);
extern int
...
soc_monterey_fc_map_shadow_entry_get (int unit, soc_mem_t mem, int index,
                                      void* entry_data);
int soc_monterey_fc_map_shadow_clear (int unit, soc_mem_t mem);
...
extern int soc_monterey_fc_map_shadow_size_get (int unit, uint32* size);
extern int soc_monterey_fc_map_shadow_sync(int unit, uint32 **sync_addr);
extern int soc_monterey_fc_map_shadow_load(int unit, uint32 **load_addr);
#endif
