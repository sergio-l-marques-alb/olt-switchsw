...
#define CDMAC_MIN_RUNT_THRESHOLD  64
#define CDMAC_MAX_RUNT_THRESHOLD  96
#define CDMAC_JUMBO_MAXSZ         0x3fe8

#define CDMAC_MIN_PAD_THRESHOLD_SIZE   64
#define CDMAC_MAX_PAD_THRESHOLD_SIZE   96

#define CDMAC_RSV_MASK_WRONG_SA               (0)
#define CDMAC_RSV_MASK_STACK_VLAN_DETECT      (1)
#define CDMAC_RSV_MASK_PFC_DA_ERR             (2) /* unsupported PFC DA */
#define CDMAC_RSV_MASK_PAUSE_DA_ERR           (2) /* same bit as PFC */
#define CDMAC_RSV_MASK_RCV_TERM_OR_CODE_ERR   (3)
#define CDMAC_RSV_MASK_CRC_ERR                (4)
#define CDMAC_RSV_MASK_FRAME_LEN_ERR          (5) /* IEEE length check fail */
#define CDMAC_RSV_MASK_TRUNCATED_FRAME        (6) /* truncated/out of range */
#define CDMAC_RSV_MASK_FRAME_RCV_OK           (7)
#define CDMAC_RSV_MASK_MCAST_FRAME            (8)
#define CDMAC_RSV_MASK_BCAST_FRAME            (9)
#define CDMAC_RSV_MASK_PROMISCUOUS_FRAME     (10)
#define CDMAC_RSV_MASK_CONTROL_FRAME         (11)
#define CDMAC_RSV_MASK_PAUSE_FRAME           (12)
#define CDMAC_RSV_MASK_OPCODE_ERR            (13)
#define CDMAC_RSV_MASK_VLAN_TAG_DETECT       (14)
#define CDMAC_RSV_MASK_UCAST_FRAME           (15)
#define CDMAC_RSV_MASK_RESERVED_0            (16)
#define CDMAC_RSV_MASK_RESERVED_1            (17)
#define CDMAC_RSV_MASK_PFC_FRAME             (18)

#define CDMAC_RSV_MASK_MAX           CDMAC_RSV_MASK_PFC_FRAME
#define CDMAC_RSV_MASK_INVALID_VAL   ((1 < CDMAC_RSV_MASK_PFC_FRAME) - 1)
