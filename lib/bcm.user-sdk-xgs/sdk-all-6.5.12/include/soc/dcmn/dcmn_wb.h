...
#define _DCMN_BCM_WARM_BOOT_API_TEST_MODE_ISSU_SYNC                     (4) /*perform issu sync and exit at the end of run_cint*/
#define _DCMN_BCM_WARM_BOOT_API_TEST_MODE_ISSU_DUMP                     (5) /*perform issu dump and exit at the end of run_cint*/
...
/* sets field test mode set and suppress cr if it is needed */
