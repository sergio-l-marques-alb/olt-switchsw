...
int cprif_encap_ordering_info_sequence_offset_get(int unit, int port, uint32 queue, uint32 control, cprimod_cpri_ordering_info_offset_t* offset_entry);
...
int cprif_port_rx_interface_config_set(int unit, int port, const cprimod_port_interface_config_t* config);
int cprif_port_rx_interface_config_get(int unit, int port, cprimod_port_interface_config_t* config);

/* Speed and interface Set/Get.  */
int cprif_port_tx_interface_config_set(int unit, int port, const cprimod_port_interface_config_t* config);
...
int cprif_cpri_port_rx_gcw_config_get(int unit, int port, uint32 index, cprimod_cpri_tx_gcw_config_t* config_info);
