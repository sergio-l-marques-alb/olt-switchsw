...
/*shr_error_e soc_dnxc_vsc256_sr_cell_send_inband(int unit, const fe1600_sr_cell_t* inband_cell, fe1600_sr_cell_t* result_cell);
shr_error_e soc_dnxc_vsc256_sr_cell_send(int unit, const fe1600_sr_cell_t* cell);
shr_error_e soc_dnxc_vsc256_sr_cell_receive(int unit, fe1600_sr_cell_t* cell);*/

shr_error_e soc_dnxc_vsc256_build_payload(int unit, const dnxc_vsc256_sr_cell_t* cell, int buf_size_bytes, uint32* buf, int offset);
shr_error_e soc_dnxc_vsc256_parse_payload(int unit, const uint32 *buf, dnxc_vsc256_sr_cell_t* cell, int offset);
