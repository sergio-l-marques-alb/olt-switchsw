...
#define SOC_DNXC_FABRIC_CELL_ENTRY_MAX_SIZE_UINT32      (68)
 ...
 * Logging: field_name: entry[src_start_bit:src_start_bit+length] 
 */
shr_error_e soc_dnxc_fabric_cell_parser(int unit, soc_dnxc_fabric_cell_entry_t entry, soc_dnxc_fabric_cell_parse_table_t *parse_table, uint32 nof_lines, soc_dnxc_fabric_cell_info_t *cell_info);
