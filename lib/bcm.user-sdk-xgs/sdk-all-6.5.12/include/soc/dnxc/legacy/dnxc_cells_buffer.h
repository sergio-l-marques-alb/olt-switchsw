...
shr_error_e dnxc_cells_buffer_is_full(int unit, const cyclic_buffer_t* cells_buffer, int* is_full);
shr_error_e dnxc_cells_buffer_cells_count(int unit, const cyclic_buffer_t* cells_buffer, int* is_empty);
