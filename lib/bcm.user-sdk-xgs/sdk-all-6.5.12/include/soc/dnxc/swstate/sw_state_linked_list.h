...
#define DNX_SW_STATE_LL_INTERNAL\
    struct sw_state_ll_node_s* next;\
    struct sw_state_ll_node_s* prev

#define DNX_SW_STATE_LL_IS_NODE_VALID(node)\
    (node != NULL)

#define DNX_SW_STATE_LL_INVALID_NODE NULL
...
typedef struct sw_state_ll_node_s
{
    DNX_SW_STATE_LL_INTERNAL;   /* please don't use */
    void *key;
    void *value;
} sw_state_ll_node_impl;
...
typedef struct sw_state_ll_node_s *sw_state_ll_node_t;
...
typedef struct sw_state_ll_s
{
    ...
    char key_cmp_cb_name[SW_STATE_CB_DB_NAME_STR_SIZE];
}  *sw_state_ll_t;
...
/********** LINKED LIST MACROS ****************/
/**********************************************/
#define SW_STATE_LL_CREATE_EMPTY(module_id, ll, init_info, flags, key_type, value_type) \
    SHR_IF_ERR_EXIT(sw_state_ll_create_empty(unit, module_id, init_info, flags, sizeof(key_type), sizeof(value_type), &ll))
...
#define SW_STATE_LL_NOF_ELEMENTS(module_id, ll, nof_elements) \
    SHR_IF_ERR_EXIT(sw_state_ll_nof_elements(unit, module_id, ll, 0 /*ll_index*/, nof_elements))
...
#define SW_STATE_LL_NEXT_NODE(module_id, ll, node, next_node) \
    SHR_IF_ERR_EXIT(sw_state_ll_next_node(unit, module_id, ll, 0 /*ll_index*/, node, next_node))

#define SW_STATE_LL_PREVIOUS_NODE(module_id, ll, node, prev_node) \
    SHR_IF_ERR_EXIT(sw_state_ll_previous_node(unit, module_id, ll, 0 /*ll_index*/, node, prev_node))

#define SW_STATE_LL_ADD(module_id, ll, key, value) \
    SHR_IF_ERR_EXIT(sw_state_ll_add(unit, module_id, ll, 0 /*ll_index*/, key, value))

#define SW_STATE_LL_ADD_FIRST(module_id, ll, key, value) \
    SHR_IF_ERR_EXIT(sw_state_ll_add_first(unit, module_id, ll, 0 /*ll_index*/, key, value))

#define SW_STATE_LL_ADD_LAST(module_id, ll, key, value) \
    SHR_IF_ERR_EXIT(sw_state_ll_add_last(unit, module_id, ll, 0 /*ll_index*/, key, value))

#define SW_STATE_LL_ADD_BEFORE(module_id, ll, node, key, value) \
    SHR_IF_ERR_EXIT(sw_state_ll_add_before(unit, module_id, ll, 0 /*ll_index*/, node, key, value))

#define SW_STATE_LL_ADD_AFTER(module_id, ll, node, key, value) \
    SHR_IF_ERR_EXIT(sw_state_ll_add_after(unit, module_id, ll, 0 /*ll_index*/, node, key, value))

#define SW_STATE_LL_REMOVE_NODE(module_id, ll, node) \
    SHR_IF_ERR_EXIT(sw_state_ll_remove_node(unit, module_id, ll, 0 /*ll_index*/, node))

#define SW_STATE_LL_GET_LAST(module_id, ll, node) \
    SHR_IF_ERR_EXIT(sw_state_ll_get_last(unit, module_id, ll, 0 /*ll_index*/, node))

#define SW_STATE_LL_GET_FIRST(module_id, ll, node) \
    SHR_IF_ERR_EXIT(sw_state_ll_get_first(unit, module_id, ll, 0 /*ll_index*/, node))

#define SW_STATE_LL_FIND(module_id, ll, node, key, found) \
    SHR_IF_ERR_EXIT(sw_state_ll_find(unit, module_id, ll, 0 /*ll_index*/, node, key, found))
