...
typedef enum soc_ser_block_type_e {
    ...
    SocSerBlockTypeCount = 10   /* bcmSwitchBlockTypeCount. */
...
#define SOC_L2_SR_LOCK(s) sal_mutex_take((s)->l2x_sr_sync, sal_mutex_FOREVER)
#define SOC_L2_SR_UNLOCK(s)  sal_mutex_give((s)->l2x_sr_sync)
#else
#define SOC_L2_SR_LOCK(s)  do {} while(0)
#define SOC_L2_SR_UNLOCK(s) do {} while(0)
