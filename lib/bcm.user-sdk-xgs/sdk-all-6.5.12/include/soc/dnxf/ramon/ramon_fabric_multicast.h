...
shr_error_e soc_ramon_fabric_multicast_multi_read_info_get(int unit, const soc_dnxf_multicast_read_range_info_t **info, int *info_size);
...
#ifndef SOC_RAMON_MULTICAST_TABLE_UPDATE_READ_ENABLED
shr_error_e soc_ramon_fabric_multicast_read_info(int unit, soc_multicast_t group, int *mc_table_index, int *mc_table_entry, int *is_first_half);
#endif /* ifndef SOC_RAMON_MULTICAST_TABLE_UPDATE_READ_ENABLED */
