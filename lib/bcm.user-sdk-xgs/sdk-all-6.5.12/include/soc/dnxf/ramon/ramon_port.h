...
shr_error_e soc_ramon_port_speed_set(int unit, soc_port_t port, int speed);
shr_error_e soc_ramon_port_interface_set(int unit, soc_port_t port, soc_port_if_t intf);
shr_error_e soc_ramon_port_interface_get(int unit, soc_port_t port, soc_port_if_t* intf);
shr_error_e soc_ramon_port_speed_get(int unit, soc_port_t port, int *speed);
...
shr_error_e soc_ramon_port_sync_e_divider_set(int unit, int divider);
shr_error_e soc_ramon_port_sync_e_link_get(int unit, int is_master, int *port);
shr_error_e soc_ramon_port_sync_e_divider_get(int unit, int *divider);
...
shr_error_e soc_ramon_port_rate_egress_ppt_set(int unit, soc_port_t port, uint32 burst, uint32 nof_tiks);
shr_error_e soc_ramon_port_rate_egress_ppt_get(int unit, soc_port_t port, uint32 *burst, uint32 *nof_tiks);
