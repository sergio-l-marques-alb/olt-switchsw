...
shr_error_e soc_dnxf_fabric_modid_group_find(int unit, bcm_module_t modid, bcm_module_t* group);
shr_error_e soc_dnxf_fabric_link_status_all_get(int unit, int links_array_max_size, uint32* link_status, uint32* errored_token_count, int* links_array_count);
