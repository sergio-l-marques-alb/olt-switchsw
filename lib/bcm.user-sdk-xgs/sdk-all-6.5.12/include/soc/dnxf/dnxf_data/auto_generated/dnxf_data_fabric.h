 ...
 */
typedef uint32(
    *dnxf_data_fabric_general_local_routing_enable_get_f) (
    int unit);
...
typedef struct
{
    ...
    /**
     * returns numeric data of local_routing_enable
     */
    dnxf_data_fabric_general_local_routing_enable_get_f local_routing_enable_get;
...
typedef struct
{
     ...
     */
    diag_threshold_group_options_t threshold_group;
    /**
     * Shows the threshold stage which is used for diagnostic filtering.
     */
    diag_threshold_stage_options_t threshold_stage;
    /**
