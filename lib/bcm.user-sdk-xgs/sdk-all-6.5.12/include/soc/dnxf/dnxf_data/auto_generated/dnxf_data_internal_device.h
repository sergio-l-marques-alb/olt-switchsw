 ...
 *   * None
 */
uint32 dnxf_data_device_general_pvt_base_get(
    int unit);
 ...
 *   * None
 */
uint32 dnxf_data_device_general_pvt_factor_get(
    int unit);
...
typedef enum
{
    dnxf_data_device_access_define_mdio_int_out_delay_default,
    ...
    dnxf_data_device_access_define_schan_timeout_usec,
    dnxf_data_device_access_define_schan_intr_enable,
    dnxf_data_device_access_define_miim_timeout_usec,
...
/* Get Data */
/**
 * \brief returns define data of mdio_int_out_delay_default
 * Module - 'device', Submodule - 'access', data - 'mdio_int_out_delay_default'
 * Default in out delay of the MDIO interface
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     mdio_int_out_delay_default - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnxf_data_device_access_mdio_int_out_delay_default_get(
    int unit);
 ...
 *   * None
 */
uint32 dnxf_data_device_access_schan_timeout_usec_get(
    int unit);

/**
 * \brief returns numeric data of schan_intr_enable
 * Module - 'device', Submodule - 'access', data - 'schan_intr_enable'
 * Schan operation done is interrupt driven or by polling.
 * 
 * \param [in] unit - unit #
 * 
 ...
 *   * None
 */
uint32 dnxf_data_device_access_schan_intr_enable_get(
    int unit);

/**
 * \brief returns numeric data of miim_timeout_usec
 * Module - 'device', Submodule - 'access', data - 'miim_timeout_usec'
 ...
 *   * None
 */
uint32 dnxf_data_device_access_miim_timeout_usec_get(
    int unit);
...
typedef enum
{
    ...
    dnxf_data_device_interrupts_define_intr_all_disable,
...
/**
 * \brief returns numeric data of intr_all_disable
 * Module - 'device', Submodule - 'interrupts', data - 'intr_all_disable'
 * Are all interrupts disabled by soc property.
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     intr_all_disable - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnxf_data_device_interrupts_intr_all_disable_get(
    int unit);
...
typedef enum
{
    dnxf_data_device_ha_define_warmboot,
...
/* Get Data */
/**
 * \brief returns numeric data of warmboot
 * Module - 'device', Submodule - 'ha', data - 'warmboot'
 * specify if unit should support wb
 * 
 * \param [in] unit - unit #
 * 
 * \return
 *     warmboot - the required data value
 * \remark
 *   * Auto-generated using device data autocoder
 * \see
 *   * None
 */
uint32 dnxf_data_device_ha_warmboot_get(
    int unit);
