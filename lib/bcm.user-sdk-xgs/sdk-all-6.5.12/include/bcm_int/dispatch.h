...
typedef struct {
	...
	int (*cpri_init)(int);
	int (*cpri_port_axc_agnostic_mode_enable_set)(int,bcm_gport_t,int);
	int (*cpri_port_axc_agnostic_mode_set)(int,bcm_gport_t,bcm_cpri_agnostic_config_t *);
	...
	int (*cpri_port_encap_clear)(int,bcm_gport_t,int);
	int (*cpri_port_encap_clear_all)(int,bcm_gport_t);
	...
	int (*cpri_port_encap_roe_ordering_info_clear)(int,bcm_gport_t,int);
	...
	int (*cpri_port_rsvd4_rx_control_config_set)(int,int,bcm_rsvd4_control_config_t *);
	...
	int (*cpri_port_rsvd4_rx_tag_gen_entry_add)(int,int,int,bcm_cpri_tag_gen_entry_t *);
	int (*cpri_port_rsvd4_rx_tag_gen_entry_delete)(int,int,int,bcm_cpri_tag_gen_entry_t *);
	...
	int (*cpri_port_rx_axc_frame_get_all)(int,bcm_gport_t,int,int *,bcm_cpri_axc_frame_info_t *,int *);
	...
	int (*cpri_port_rx_cw_l1_signal_info_get)(int,int,bcm_cpri_cw_l1_protocol_info_t *);
	...
	int (*cpri_port_rx_cw_vsd_ctrl_flow_config_get)(int,int,uint16,bcm_cpri_rx_vsd_flow_info_t *);
	int (*cpri_port_rx_cw_vsd_ctrl_flow_config_set)(int,int,uint16,bcm_cpri_rx_vsd_flow_info_t *);
	...
	int (*cpri_port_rx_fec_descramble_bypass_set)(int,int,uint8);
	int (*cpri_port_rx_fec_enable_set)(int,int,uint8);
	int (*cpri_port_rx_fec_soft_reset_set)(int,int,uint8);
	int (*cpri_port_rx_fec_tick_set)(int,int,bcm_cpri_fec_tick_config_t *);
	int (*cpri_port_rx_fec_timestamp_config_set)(int,int,bcm_cpri_fec_timestamp_config_t *);
	...
	int (*cpri_port_stage_activate)(int,bcm_gport_t,bcm_cpri_stage_t);
	...
	int (*cpri_port_tx_axc_frame_get_all)(int,bcm_gport_t,int,int,bcm_cpri_axc_frame_info_t *,int *);
	int (*cpri_port_tx_cw_gcw_config_set)(int,int,uint8,bcm_cpri_tx_gcw_config_info_t *);
	int (*cpri_port_tx_cw_gcw_filter_set)(int,int,uint8,bcm_cpri_tx_gcw_tx_filter_info_t *);
	int (*cpri_port_tx_cw_l1_config_set)(int,int,bcm_cpri_cw_l1_config_info_t *);
	...
	int (*cpri_port_tx_cw_vsd_ctrl_flow_config_set)(int,int,uint16,bcm_cpri_tx_vsd_flow_info_t *);
	...
	int (*cpri_port_tx_frame_tgen_config_set)(int,bcm_gport_t,bcm_cpri_tx_frame_tgen_config_t *);
	int (*cpri_port_tx_frame_tgen_enable)(int,bcm_gport_t,int);
	...
	int (*cpri_rx_tag_config_set)(int,int,uint32,uint32);
	...
	int (*flowtracker_template_transmit_config_get)(int,bcm_flowtracker_export_template_t,bcm_flowtracker_collector_t,bcm_flowtracker_template_transmit_config_t *);
	int (*flowtracker_template_transmit_config_set)(int,bcm_flowtracker_export_template_t,bcm_flowtracker_collector_t,bcm_flowtracker_template_transmit_config_t *);
...
#endif	/* INCLUDE_L3 */
	int (*mirror_destination_count_command_get)(int,bcm_gport_t,int,uint32,bcm_mirror_profile_cmd_count_t *);
	int (*mirror_destination_count_command_set)(int,bcm_gport_t,int,uint32,bcm_mirror_profile_cmd_count_t *);
	...
	int (*multicast_encap_extension_add)(int,uint32,bcm_if_t,int,bcm_if_t *);
	int (*multicast_encap_extension_delete)(int,uint32,bcm_if_t);
	int (*multicast_encap_extension_delete_all)(int);
	int (*multicast_encap_extension_get)(int,uint32,bcm_if_t,int,bcm_if_t *,int *);
	int (*multicast_encap_extension_traverse)(int,bcm_multicast_encap_extension_cb_t,void *);
	...
	int (*port_ilkn_lane_id_map_get)(int,int,bcm_port_t,int,int *);
	int (*port_ilkn_lane_id_map_set)(int,int,bcm_port_t,int,int *);
	...
	int (*qos_map_control_get)(int,uint32,uint32,bcm_qos_map_control_type_t,uint64 *);
	int (*qos_map_control_set)(int,uint32,uint32,bcm_qos_map_control_type_t,uint64);
	...
	int (*xflow_macsec_control_get)(int,uint32,bcm_xflow_macsec_control_t,int *);
	int (*xflow_macsec_control_set)(int,uint32,bcm_xflow_macsec_control_t,int);
	int (*xflow_macsec_decrypt_flow_create)(int,uint32,bcm_xflow_macsec_decrypt_flow_info_t *,int,bcm_xflow_macsec_flow_id_t *);
	...
	int (*xflow_macsec_decrypt_policy_create)(int,uint32,bcm_xflow_macsec_decrypt_policy_info_t *,bcm_xflow_macsec_policy_id_t *);
	...
	int (*xflow_macsec_mtu_get)(int,int,uint32,uint32 *);
	int (*xflow_macsec_mtu_set)(int,int,uint32,uint32 *);
	int (*xflow_macsec_sectag_etype_get)(int,uint32,uint32 *);
	int (*xflow_macsec_sectag_etype_set)(int,int,uint32,uint32 *);
	...
	int (*xflow_macsec_secure_chan_create)(int,uint32,bcm_xflow_macsec_secure_chan_info_t *,int,bcm_xflow_macsec_secure_chan_id_t *);
	...
	int (*xflow_macsec_secure_chan_info_traverse)(int,bcm_xflow_macsec_chan_traverse_cb,void *);
	...
	int (*xflow_macsec_subport_num_get)(int,bcm_xflow_macsec_id_t,bcm_xflow_macsec_subport_num_t *);
	int (*xflow_macsec_vlan_tpid_array_get)(int,bcm_xflow_macsec_vlan_tpid_t *);
	int (*xflow_macsec_vlan_tpid_array_index_get)(int,uint32,uint8 *);
	int (*xflow_macsec_vlan_tpid_array_set)(int,bcm_xflow_macsec_vlan_tpid_t *);
