...
#define BCMI_KEYGEN_EXT_SECTION_MULTI_GRAN_1_2_4 (1 << 1)
...
typedef enum bcmi_keygen_acl_attr_s {
    ...
    BCMI_KEYGEN_ACL_ATTR_MODE_HALF = 0,
...
typedef struct bcmi_keygen_ext_field_info_s {
    ...
    bcmi_keygen_ext_section_t l0_section[BCMI_KEYGEN_EXT_SECTION_MAP_MAX];

    uint8 l0_sec_val[BCMI_KEYGEN_EXT_SECTION_MAP_MAX];

    uint16 l0_field_offset[BCMI_KEYGEN_EXT_SECTION_MAP_MAX];
