...
/**
 * \brief Replace white space by underscore in source itself
 * \par DIRECT INPUT
...
/**
 * \brief Replace white space and some other character by escape one(usually underscore) on the source string itself
 * \par DIRECT INPUT
 *   \param [in] str string to search for occurences of charactre from
 ...
 * \par DIRECT INPUT
 *   \param [in,out] str string in which the uppercase letters
