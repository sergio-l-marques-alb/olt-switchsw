...
/**
 * \brief Get handle for the next child with the same namae
 * \par DIRECT INPUT
...
/**
 * \brief Create XML node under parent befor specified sibling
 * \par DIRECT INPUT
 *   \param [in] parent - xml handle for parent node
 ...
 *   \param [in] exclude_property - property to be excluded from obtained list
...
{                                                                                                                      \
    ...
    {                                                                                                                  \
        SHR_IF_ERR_EXIT(dbx_xml_property_get_str(child_node_mac, string_mac, target_mac, RHNAME_MAX_SIZE));            \
    }                                                                                                                  \
    else                                                                                                               \
    {                                                                                                                  \
      goto exit;                                                                                                       \
...
{                                                                                                                      \
    ...
    if(child_node_mac != NULL)                                                                                         \
    {                                                                                                                  \
        if(dbx_xml_property_get_str(child_node_mac, string_mac, target_mac, RHNAME_MAX_SIZE) != _SHR_E_NONE)           \
        {                                                                                                              \
 ...
 *   RHCHDATA_GET_STR_STOP
 */
#define RHCHDATA_GET_LSTR_DEF(node_mac, childname_mac ,string_mac, target_mac, default_str)                            \
{                                                                                                                      \
    xml_node child_node_mac;                                                                                           \
    child_node_mac = dbx_xml_child_get_first(node_mac,childname_mac);                                                  \
    if(child_node_mac != NULL)                                                                                         \
    {                                                                                                                  \
        if(dbx_xml_property_get_str(child_node_mac, string_mac, target_mac, RHSTRING_MAX_SIZE) != _SHR_E_NONE)         \
        {                                                                                                              \
            strcpy(target_mac, default_str);                                                                           \
        }                                                                                                              \
    }                                                                                                                  \
...
{                                                                                                                      \
    ...
    if(child_node_mac != NULL)                                                                                         \
    {                                                                                                                  \
        if(dbx_xml_property_get_int(child_node_mac, string_mac, &target_mac) != _SHR_E_NONE)                           \
        {                                                                                                              \
            target_mac = def_value_mac;                                                                                \
        }                                                                                                              \
    }                                                                                                                  \
...
#define RHDATA_GET_STR_STOP(node_mac, string_mac, target_mac)                                                          \
        SHR_IF_ERR_EXIT(dbx_xml_property_get_str(node_mac, string_mac, target_mac, RHNAME_MAX_SIZE))
