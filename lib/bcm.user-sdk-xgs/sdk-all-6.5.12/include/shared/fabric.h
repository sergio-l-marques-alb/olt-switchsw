...
#define _SHR_FABRIC_TH_INDEX_PIPE_LEVEL_INDICATION          (0x1000000)
#define _SHR_FABRIC_TH_INDEX_CAST_PRIO_INDICATION           (0x2000000)
...
#define _BCM_FABRIC_TH_INDEX_CLASS_INDICATION       _SHR_FABRIC_TH_INDEX_CAST_PRIO_INDICATION   
...
typedef enum _shr_dnxf_threshold_type_e {
    ...
    _SHR_FABRIC_THRESHOLDS_COUNT = 39 /*This value should always be last*/
