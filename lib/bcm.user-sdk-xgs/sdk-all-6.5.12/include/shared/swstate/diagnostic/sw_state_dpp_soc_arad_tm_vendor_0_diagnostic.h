...
#ifndef _SHR_SW_STATE_DPP_SOC_ARAD_TM_VENDOR_0_DIAGNOSTIC_H_
#define _SHR_SW_STATE_DPP_SOC_ARAD_TM_VENDOR_0_DIAGNOSTIC_H_
...
int sw_state_dpp_soc_arad_tm_vendor_0_diagnostic_cb_init(int unit);

#endif /* BCM_WARM_BOOT_API_TEST */

#endif /* _SHR_SW_STATE_DPP_SOC_ARAD_TM_VENDOR_0_DIAGNOSTIC_H_ */
