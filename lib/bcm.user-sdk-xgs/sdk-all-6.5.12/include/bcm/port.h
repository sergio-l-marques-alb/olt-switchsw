...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassCount = 23              /* Last enum value. */
} bcm_port_class_t;
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_PORT_INNER_VLAN16 = 36, /* Mod/port/trunk + 16-bit Inner VLAN
                                           tag */
    BCM_PORT_MATCH_COUNT = 37           /* Must be last */
} bcm_port_match_t;
...
#define BCM_PORT_MATCH_NATIVE       0x00000004 /* Indicates Native Ethernet
                                                  settings */
#define BCM_PORT_MATCH_MIM          0x00000008 /* ISEM entry added contains an
                                                  ISID that points to a MiM LIF. */
...
typedef enum bcm_port_phy_fec_e {
    ...
    bcmPortPhyFecRs544 = _SHR_PORT_PHY_FEC_RS_544, /* Rs544 */
    bcmPortPhyFecRs272 = _SHR_PORT_PHY_FEC_RS_272, /* Rs272 */
...
typedef enum bcm_port_phy_tx_tap_mode_e {
    bcmPortPhyTxTapMode3Tap = 0, 
    bcmPortPhyTxTapMode6Tap = 1 
} bcm_port_phy_tx_tap_mode_t;

typedef enum bcm_port_phy_signalling_mode_e {
    bcmPortPhySignallingModeNRZ = 0, 
    bcmPortPhySignallingModePAM4 = 1 
