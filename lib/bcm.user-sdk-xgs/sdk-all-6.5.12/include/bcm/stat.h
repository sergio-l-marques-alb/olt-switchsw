...
typedef enum bcm_stat_counter_engine_control_e {
    ...
    bcmStatCounterOverflowMode = 4      /* Allow the user to choose the counter
                                           overflow mode */
...
typedef enum bcm_stat_counter_group_filter_e {
    bcmStatCounterGroupFilterGlobalReject = 0, 
    bcmStatCounterGroupFilterVoqTailDrop = 1, 
    bcmStatCounterGroupFilterVsqTailDrop = 2, 
    bcmStatCounterGroupFilterVsqStatistics = 3, 
    bcmStatCounterGroupFilterQueueNotValid = 4, 
    bcmStatCounterGroupFilterAll = 5, 
    bcmStatCounterGroupWred = 6, 
...
typedef enum bcm_stat_stif_record_element_type_e {
    bcmStatExternalRecordElementObj0 = 0, /* mask=-1 must be set */
    bcmStatStifRecordElementObj1 = 1,   /* mask=-1 must be set */
    bcmStatStifRecordElementObj2 = 2,   /* mask=-1 must be set */
    bcmStatStifRecordElementObj3 = 3,   /* mask=-1 must be set */
    bcmStatStifRecordElementPacketSize = 4, /* mask=-1 must be set */
    bcmStatStifRecordElementOpCode = 5, /* mask=-1 must be used. 8 bits
                                           represent 4 objs opCode */
    ...
    bcmStatStifRecordElementEgressMetaDataMultiCast = 20, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataPpDropReason = 21, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataPort = 22, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataEcnEligibleAndCni = 23, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataTrafficClass = 24, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataDropPrecedence = 25, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataObj0 = 26, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataObj1 = 27, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataObj2 = 28, /* mask=-1 must be set */
    bcmStatStifRecordElementEgressMetaDataObj3 = 29 /* mask=-1 must be set */
