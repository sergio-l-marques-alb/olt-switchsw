...
#define BCM_GPORT_SUB_TYPE_VIRTUAL          _SHR_GPORT_SUB_TYPE_VIRTUAL 
...
#define BCM_GPORT_SUB_TYPE_IS_VIRTUAL(_gport)  _SHR_GPORT_SUB_TYPE_IS_VIRTUAL(_gport) 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_GET(_gport)  _SHR_GPORT_SUB_TYPE_VIRTUAL_GET(_gport) 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_SET(_gport, _virtual_id)  _SHR_GPORT_SUB_TYPE_VIRTUAL_SET(_gport, _virtual_id) 
#define BCM_GPORT_SUB_TYPE_IS_VLAN_TRANSLATION(_gport)  _SHR_GPORT_SUB_TYPE_IS_VLAN_TRANSLATION(_gport) 
#define BCM_GPORT_SUB_TYPE_VLAN_TRANSLATION_GET(_gport)  _SHR_GPORT_SUB_TYPE_VLAN_TRANSLATION_GET(_gport) 
#define BCM_GPORT_SUB_TYPE_VLAN_TRANSLATION_SET(_gport, _vlan_translation_val)  _SHR_GPORT_SUB_TYPE_VLAN_TRANSLATION_SET(_gport, _vlan_translation_val) 
...
#define BCM_COSQ_GPORT_RCY_SET(gport)  _SHR_COSQ_GPORT_RCY_SET(gport) 
#define BCM_COSQ_GPORT_IS_RCY_MIRR(gport)  _SHR_COSQ_GPORT_IS_RCY_MIRR(gport) 
#define BCM_COSQ_GPORT_RCY_MIRR_SET(gport)  _SHR_COSQ_GPORT_RCY_MIRR_SET(gport) 

#define BCM_PORT_INVALID        -1         /* Invalid recycle mirror port. */

#define BCM_GPORT_IS_CREDIT_REQUEST_PROFILE(_gport)  _SHR_GPORT_IS_CREDIT_REQUEST_PROFILE(_gport) 
#define BCM_GPORT_CREDIT_REQUEST_PROFILE_GET(_gport)  \
    (!_SHR_GPORT_IS_CREDIT_REQUEST_PROFILE(_gport) ? -1 : \
    _SHR_GPORT_CREDIT_REQUEST_PROFILE_GET(_gport)) 
#define BCM_GPORT_CREDIT_REQUEST_PROFILE_SET(_gport, _profile)  _SHR_GPORT_CREDIT_REQUEST_PROFILE_SET(_gport, _profile) 
