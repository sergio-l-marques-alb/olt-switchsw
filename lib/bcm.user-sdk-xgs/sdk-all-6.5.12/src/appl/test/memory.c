...
#if defined (BCM_ESW_SUPPORT) || defined (BCM_SIRIUS_SUPPORT) || defined (BCM_PETRA_SUPPORT) || defined (BCM_DFE_SUPPORT) || defined (BCM_DNX_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined(BCM_POLAR_SUPPORT) || defined (BCM_DNXF_SUPPORT)
...
#endif /* BCM_POLAR_SUPPORT */
    {
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined (BCM_PETRA_SUPPORT) || defined (BCM_DFE_SUPPORT) || defined (BCM_DNX_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined (BCM_DNXF_SUPPORT)
...
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined (BCM_PETRA_SUPPORT) || defined(BCM_DNX_SUPPORT) || defined(BCM_CALADAN3_SUPPORT)
STATIC int
...
#endif /* BCM_POLAR_SUPPORT */
    {
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined (BCM_PETRA_SUPPORT) || defined(BCM_DNX_SUPPORT) || defined (BCM_DFE_SUPPORT) || defined (BCM_DNXF_SUPPORT) || defined(BCM_CALADAN3_SUPPORT)
        if (soc_mem_cache_get(u, parm->mem,
                  parm->copyno == COPYNO_ALL ?
                  MEM_BLOCK_ALL : parm->copyno)) {
                cli_out("WARNING: Caching is enabled on memory %s.%s\n",
