/*
 * $Id: trident3_vxlan.c Broadcom SDK $
 * $Copyright: (c) 2017 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    trident3_vxlan.c
...
/* "vxlan" feature's diag command list only for trident3 */
char * techsupport_vxlan_trident3_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "VXLAN" feature's software dump command list only for trident3 */
char * techsupport_vxlan_trident3_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "vxlan" feature for trident3 chipset. */
static soc_mem_t techsupport_vxlan_trident3_memory_table_list[] = {
 ...
 * "vxlan" feature for trident3 chipset. */
techsupport_reg_t techsupport_vxlan_trident3_reg_list[] = {
 ...
 * "vxlan" feature for Trident3 chipset. */
techsupport_data_t techsupport_vxlan_trident3_data = {
    techsupport_vxlan_diag_cmdlist,
    techsupport_vxlan_trident3_reg_list,
    techsupport_vxlan_trident3_memory_table_list,
    techsupport_vxlan_trident3_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_vxlan_sw_dump_cmdlist,
    techsupport_vxlan_trident3_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
