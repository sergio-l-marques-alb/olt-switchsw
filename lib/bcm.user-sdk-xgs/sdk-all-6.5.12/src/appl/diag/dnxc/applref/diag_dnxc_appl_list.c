 ...
 */
/* *INDENT-OFF* */ 
sh_sand_option_t sh_dnxc_appl_list_options[] = {
    /*name        type                  desc                                        default      ext*/
    {NULL}
};

sh_sand_man_t sh_dnxc_appl_list_man = {
    "List all application names and their IDs",
    "List all application names and their IDs. After listing the application, a certain application can be invoked"
    " Using 'dnx appl run' command",
    "dnx application list",
    "* 'dnx application list' - Show the list of applications and their IDs \n"
};
