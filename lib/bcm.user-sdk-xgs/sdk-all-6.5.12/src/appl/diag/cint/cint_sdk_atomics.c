...
static cint_parameter_desc_t __cint_sdk_typedefs[] = 
    {
        ...
        { "int", "XFLOW_MACSEC_MTU_0", 0, 0 },
        { "int", "XFLOW_MACSEC_MTU_1", 0, 0 },
        { "int", "XFLOW_MACSEC_MTU_2", 0, 0 },
        { "int", "XFLOW_MACSEC_MTU_3", 0, 0 },
        { "int", "XFLOW_MACSEC_SECTAG_ETYPE_0", 0, 0 },
        { "int", "XFLOW_MACSEC_SECTAG_ETYPE_1", 0, 0 },
        { "int", "XFLOW_MACSEC_SECTAG_ETYPE_2", 0, 0 },
        { "int", "XFLOW_MACSEC_SECTAG_ETYPE_3", 0, 0 },
        ...
        { "int", "XFLOW_MACSEC_DECRYPT_FLOW_NON_MACSEC_PKT", 0, 0 },
        { "int", "XFLOW_MACSEC_DECRYPT_FLOW_MACSEC", 0, 0 },
        { "int", "XFLOW_MACSEC_DECRYPT_FLOW_MANAGEMENT", 0, 0 },
        { "int", "XFLOW_MACSEC_DECRYPT_FLOW_KAY", 0, 0 },
        { "int", "XFLOW_MACSEC_FLOW_ETYPE_EII", 0, 0 },
        { "int", "XFLOW_MACSEC_FLOW_ETYPE_SNAP", 0, 0 },
        { "int", "XFLOW_MACSEC_FLOW_ETYPE_LLC", 0, 0 },
        { "int", "XFLOW_MACSEC_FLOW_ETYPE_MPLS", 0, 0 },
...
#endif
#ifdef CPRIMOD_SUPPORT
        { "int", "_shr_hdlc_crc_byte_order_t", 0, 0 },
        { "int", "_shr_hdlc_fcs_err_check_t", 0, 0 },
        { "int", "_shr_hdlc_fcs_size_t", 0, 0 },
        { "int", "_shr_hdlc_filling_flag_pattern_t", 0, 0 },
        { "int", "_shr_hdlc_num_flag_bytes_t", 0, 0 },
        { "int", "_shr_hdlc_crc_mode_t", 0, 0 },
        { "int", "_shr_hdlc_crc_init_val_t", 0, 0 },
        { "int", "_shr_control_schan_num_bytes_t", 0, 0 },
        { "int", "_shr_control_flow_num_bytes_t", 0, 0 },
        { "int", "_shr_cw_filter_mode_t", 0, 0 },
        { "int", "_shr_vsd_raw_map_mode_t", 0, 0 },
        { "int", "_shr_gcw_mask_t", 0, 0 },
        { "int", "_shr_control_msg_proc_type_t", 0, 0 },
        { "int", "_shr_tag_option_t", 0, 0 },
        { "int", "_shr_sync_count_cycle_t", 0, 0 },
        { "int", "_shr_cpri_crc_option_t", 0, 0 },
#endif
        { NULL }, 
    }; 
...
__cint_maddr_xflow_macsec_secure_chan_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
        ...
        case 7: rv = &(s->mtu_index_sel); break;
        case 8: rv = &(s->sectag_etype_index_sel); break;
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_secure_chan_info_t[] =
{
        ...
        { "xflow_macsec_mtu_t", "mtu_index_sel", 0, 0 },
        { "xflow_macsec_sectag_ethertype_t", "sectag_etype_index_sel", 0, 0 },
        { "uint64", "sci_mask", 0, 0 },
...
__cint_maddr_xflow_macsec_policy_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
        ...
        case 1: rv = &(s->mpls_sectag_offset); break;
        case 2: rv = &(s->sci); break;
        case 3: rv = &(s->mtu_index_sel); break;
        case 4: rv = &(s->etype_index_sel); break;
        default: rv = NULL; break;
    }
...
{
        { "uint32", "flags", 0, 0 },
        { "uint32", "mpls_sectag_offset", 0, 0 },
        { "uint64", "sci", 0, 0 },
        { "xflow_macsec_mtu_t", "mtu_index_sel", 0, 0 },
        { "xflow_macsec_sectag_ethertype_t", "etype_index_sel", 0, 0 },
        { NULL }
};
...
__cint_maddr_xflow_macsec_flow_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
        ...
        case 2: rv = &(s->tpid_index_sel); break;
        case 3: rv = &(s->etype_index_sel); break;
        case 4: rv = &(s->src_mac); break;
        case 5: rv = &(s->src_mac_mask); break;
        case 6: rv = &(s->dst_mac); break;
        case 7: rv = &(s->dst_mac_mask); break;
        case 8: rv = &(s->src_port); break;
        case 9: rv = &(s->src_port_mask); break;
        case 10: rv = &(s->udf_data); break;
        case 11: rv = &(s->udf_mask); break;
        case 12: rv = &(s->policy_id); break;
        case 13: rv = &(s->set_management_pkt); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_flow_info_t[] =
{
        ...
        { "uint8", "tpid_index_sel", 0, 0 },
        { "xflow_macsec_flow_etype_t", "etype_index_sel", 0, 0 },
