...
bcm_port_lane_to_serdes_map_t lane_to_serdes_map_orig[SOC_DNXF_DEFS_MAX_NOF_LINKS()] = { {0, 0} };
    ...
    bcm_port_t loopback_port)
{
    ...
    bcm_port_lane_to_serdes_map_t lane_to_serdes_map[SOC_DNXF_DEFS_MAX_NOF_LINKS()] = { {0, 0} };
    ...
    const uint32 *nof_lanes = dnxc_data_get(unit, "port", "general", "nof_links", NULL);
