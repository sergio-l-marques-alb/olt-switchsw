...
error:
    /*
     * If sum of current and pending DVs is less than threshhold it is OK
     * to take more tx requests.
     */
    no_tx_q_block = (_bcm_tx_q_dv_cnt() + dv_pend_count) < TX_DV_THRESHOLD;
