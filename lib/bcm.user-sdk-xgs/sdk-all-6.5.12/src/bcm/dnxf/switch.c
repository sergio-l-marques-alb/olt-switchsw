    ...
    int *arg)
{
    ...
    switch (bcm_type)
    {
        ...
        case bcmSwitchSynchronousPortClockSourceDivCtrl:
            SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_port_sync_e_divider_get, (unit, arg)));
            break;
    ...
    int arg)
{
    ...
    switch (bcm_type)
    {
        ...
        case bcmSwitchControlSync:
            ...
            break;
        case bcmSwitchControlAutoSync:
            SHR_IF_ERR_EXIT(bcm_dnxf_switch_control_get(unit, bcmSwitchStableSelect, &stable_select));
        ...
        case bcmSwitchSynchronousPortClockSourceDivCtrl:       /* updated desired divider */
            SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_port_sync_e_divider_set, (unit, arg)));
            break;
