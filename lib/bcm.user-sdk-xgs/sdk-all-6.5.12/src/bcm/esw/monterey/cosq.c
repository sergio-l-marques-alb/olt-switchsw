...
_bcm_mn_cosq_wb_alloc(int unit)
{
    ...
    soc_monterey_fc_map_shadow_size_get(unit, &shadow_size);
...
bcm_mn_cosq_reinit(int unit)
{
    ...
    soc_monterey_fc_map_shadow_load(unit, &u32_scache_ptr);
...
bcm_mn_cosq_sync(int unit)
{
    ...
    u32_scache_ptr += alloc_size / sizeof(uint32);
    soc_monterey_fc_map_shadow_sync(unit, &u32_scache_ptr);
       ...
       BCM_IF_ERROR_RETURN
        ...
        BCM_IF_ERROR_RETURN
            (bcm_mn_cosq_gport_add(unit, port, 1, BCM_COSQ_GPORT_UCAST_QUEUE_GROUP,
                                   &uc_cosq));
        BCM_IF_ERROR_RETURN
            (bcm_mn_cosq_gport_attach(unit, uc_cosq, l1_sched, 0));
        BCM_IF_ERROR_RETURN
...
STATIC int
_bcm_mn_lb_port_config_set(int unit, int port)
{
    bcm_gport_t port_sched, l0_sched;
    bcm_gport_t l1_sched;
    bcm_gport_t mc_cosq;
    ...
    for (i = 1; i <= num_of_l0; i++) {
         ...
         for (j = 0; j < num_of_l1; j++) {
              BCM_IF_ERROR_RETURN
                  (bcm_mn_cosq_gport_add(unit, port, 10,
                                        BCM_COSQ_GPORT_SCHEDULER,
                                        &l1_sched));
              BCM_IF_ERROR_RETURN
                  (bcm_mn_cosq_gport_attach(unit, l1_sched, l0_sched,
...
STATIC int
_bcm_mn_msec_port_config_set(int unit, int port)
{
    bcm_gport_t port_sched, l0_sched;
    bcm_gport_t l1_sched;
    bcm_gport_t mc_cosq;
...
_bcm_mn_internal_port_config_set(int unit, int port)
{
    if (IS_CPU_PORT(unit, port)) {
        ...
        return _bcm_mn_lb_port_config_set(unit, port);
    } else if (IS_MACSEC_PORT(unit, port)) {
        return _bcm_mn_msec_port_config_set(unit, port);
    } else {
        return SOC_E_NONE;
    }
}
...
bcm_mn_cosq_init(int unit)
{
    ...
    NUM_COS(unit) = numq;
    soc_monterey_fc_map_shadow_create(unit);
