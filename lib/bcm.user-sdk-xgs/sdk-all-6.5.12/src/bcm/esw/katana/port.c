...
#define BCM_KT_MAX_BURST_SUPPORTED             16449 

#define BCM_KT_MAX_BURST_CHECK(kbits_burst)    \
        (kbits_burst > BCM_KT_MAX_BURST_SUPPORTED) ? 1 : 0 
/*
 * Function:
                            ...
                            uint32 kbits_sec, uint32 kbits_burst)
{
    ...
    /* SDK-104583 Added this check as max burst_rate supported is 16449kbits */
    
    if ( BCM_KT_MAX_BURST_CHECK(kbits_burst) ) {
        return BCM_E_PARAM;
    }
