...
#define _FP_QUAL_FLEX_DB_ADD(_u_, _qual_, _16bit_ext_, _8bit_ext_, _4bit_ext_,    \
...
_bcm_field_td3_flex_qual_ceh_db_init(int unit)
{
    ...
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifySysHdrType,                  1, 1, 0, 2, 1, "Z0_MATCH_ID", "\0",          "COE",           "\0");
    if (soc_feature(unit, soc_feature_hgproxy_subtag_coe)) {
        _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifySubportTagPresent,           1, 1, 0, 3, 1, "Z1_MATCH_ID", "\0",          "SUBPORT_TAG",    "\0");
    }
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyNetworkTagType,              1, 1, 0, 3, 1, "Z1_MATCH_ID", "\0",          "VNTAG",          "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyVlanFormat,                  1, 1, 0, 3, 1, "Z1_MATCH_ID", "\0",          "OTAG_ITAG",      "\0");
    if (soc_feature(unit, soc_feature_CnTag)) {
        _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyCnTagPresent,                1, 1, 0, 3, 1, "Z1_MATCH_ID", "\0",          "CNTAG",          "\0");
    }
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyL2PktType,                   1, 1, 0, 3, 1, "Z1_MATCH_ID", "\0",          "ETH",            "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyPktType,                     1, 1, 0, 3, 1, "Z2_MATCH_ID", "\0",          "NSH_OVER_L2",    "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyMplsCwPresent,               1, 1, 0, 3, 2, "Z2_MATCH_ID", "Z2_MATCH_ID", "MPLS",           "MPLS_CW");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyMplsMcastEthertypePresent,   1, 0, 1, 3, 2, "Z2_MATCH_ID", "Z2_MATCH_ID", "MPLS",           "MPLS_WITH_MCAST_ETYPE");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpv4OptionHdrType,           1, 1, 0, 3, 2, "Z2_MATCH_ID", "Z2_MATCH_ID", "IPV4",           "AH");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpv6ExtensionHdrType,        1, 1, 0, 3, 2, "Z2_MATCH_ID", "Z2_MATCH_ID", "IPV6",           "AH");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyOverlayVlanFormat,           1, 1, 0, 3, 1, "Z3_MATCH_ID", "\0",          "OTAG_ITAG",      "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyOverlayL2PktType,            1, 1, 0, 3, 1, "Z3_MATCH_ID", "\0",          "ETH",            "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyOverlayPktType,              1, 1, 0, 2, 1, "Z4_MATCH_ID", "\0",          "ARP",            "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyOverlayIpv4OptionHdrType,    1, 0, 0, 2, 2, "Z4_MATCH_ID", "Z4_MATCH_ID", "IPV4",           "AH");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyOverlayIpv6ExtensionHdrType, 1, 0, 0, 2, 2, "Z4_MATCH_ID", "Z4_MATCH_ID", "IPV6",           "AH");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyNshServiceIndex,             1, 0, 0, 0, 1, "OPAQUE_2",    "\0",          "SI",             "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyNshServicePathId,            1, 0, 0, 0, 2, "OPAQUE_2",    "OPAQUE_1",    "SPID_7_0",       "SPID_23_8");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpFragPkt,                   1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "IP_FRAGMENTS", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyOuterPriTaggedPkt,           1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "OUTER_PRI_TAGGED", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpInIpPkt,                   1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "IP_IN_IP", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIntPktVersionOne,            1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "INT_VERSION_EQ_TO_ONE", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIntPktOverflowed,            1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "INT_OVERFLOW_FLAG_EQ_TO_ZERO", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIntPktFinalHop,              1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "INT_HOP_LIMIT_MORE_THAN_HOP_COUNT", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIntPktLengthValid,           1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "INT_MAX_LEN_MORE_THAN_CUR_LEN", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIntPktType,                  1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "INT_MSG_TYPE_EQ_TO_REQUEST", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpmcV4Pkt,                   1, 0, 0, 0, 1, "PARSER_2_FLEX_HVE_CHECK_RESULT_15_0", "\0", "MACDA_V4_IPMC", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpmcV6Pkt,                   1, 0, 0, 0, 1, "PARSER_2_FLEX_HVE_CHECK_RESULT_15_0", "\0", "MACDA_V6_IPMC", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpChecksumOkPkt,             1, 0, 0, 0, 1, "PARSER_2_FLEX_HVE_CHECK_RESULT_15_0", "\0", "CHECKSUMOK", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyNetworkTagMulticastPkt,      1, 0, 0, 0, 1, "PARSER_2_FLEX_HVE_CHECK_RESULT_15_0", "\0", "VNTAG_ETAG_MCAST", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyIpTtlZeroPkt,                1, 0, 0, 0, 1, "PARSER_2_FLEX_HVE_CHECK_RESULT_15_0", "\0", "IP_PKT_TTL_ZERO", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyBfdPktVersionOne,            1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "BFD_VERSION", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyGenevePktVersionZero,        1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "GENEVE_VERSION_CHECK", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyGpePktVersionZero,           1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "GPE_VERSION_CHECK", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyGenevePktWithOam,            1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "GENEVE_OAM_BIT", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyGpePktWithOam,               1, 0, 0, 0, 1, "PARSER_1_FLEX_HVE_CHECK_RESULT_15_0", "\0", "GPE_OAM_FLAG", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyInnerBfdPktVersionOne,       1, 0, 0, 0, 1, "PARSER_2_FLEX_HVE_CHECK_RESULT_15_0", "\0", "BFD_VERSION", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyTunnelTerminated,            1, 0, 0, 1, 1, "PKT_FLOW_ID_2",                       "\0", "TUNNEL_TERMINATED", "\0");
...
_field_td3_flex_presel_qual_init(int unit, _field_stage_t *stage_fc)
{
    ...
    uint32 z0_offset = 0;
    uint32 z4_offset = 0;
    uint32 key_start_offset;
    uint32 match_id_cont_0_offset;
    uint32 match_id_cont_1_offset;
    uint32 match_id_cont_2_offset;
    uint32 pkt_flow_id_2_offset;
    soc_field_info_t *field_info;
    _bcm_field_flex_qual_ceh_data_t *flex_db;
#if defined(BCM_FLOWTRACKER_SUPPORT)
    int rv;
    uint32 match_id_offset;
    ...
    for (; flex_db != NULL; flex_db = flex_db->next) {
        ...
        if (sal_strcmp(flex_db->obj_str_arr[0], "Z0_MATCH_ID") == 0) {
           offset0 = z0_offset + flex_db->ceh_info[0].offset;
        } else if (sal_strcmp(flex_db->obj_str_arr[0], "Z1_MATCH_ID") == 0) {
           offset0 = match_id_cont_0_offset + flex_db->ceh_info[0].offset;
        } else if (sal_strcmp(flex_db->obj_str_arr[0], "Z2_MATCH_ID") == 0) {
           offset0 = match_id_cont_1_offset + flex_db->ceh_info[0].offset;
        } else if (sal_strcmp(flex_db->obj_str_arr[0], "Z3_MATCH_ID") == 0) {
           offset0 = match_id_cont_2_offset + flex_db->ceh_info[0].offset;
        } else if (sal_strcmp(flex_db->obj_str_arr[0], "Z4_MATCH_ID") == 0) {
           offset0 = z4_offset + flex_db->ceh_info[0].offset;
        } else if (sal_strcmp(flex_db->obj_str_arr[0], "PKT_FLOW_ID_2") == 0) {
           offset0 = pkt_flow_id_2_offset + flex_db->ceh_info[0].offset;
        } else {
           continue;
        }
...
_field_td3_flex_extractor_qual_init(int unit, _field_stage_t *stage_fc)
{
    ...
    for (extr = 0; extr < 3; extr++) {
       flex_db = fp_flex_db[unit].flex_data;

       for (; flex_db != NULL; flex_db = flex_db->next) {
           if (extr == 0) {
              if (flex_db->sixteen_bit_ext_valid == 0) {
                 continue;
              }
              ext_sel = BCMI_KEYGEN_EXT_SECTION_L1E16;
           } else if (extr == 1) {
              if (flex_db->eight_bit_ext_valid == 0) {
                 continue;
              }
              ext_sel = BCMI_KEYGEN_EXT_SECTION_L1E8;
           } else if (extr == 2) {
              if (flex_db->four_bit_ext_valid == 0) {
                 continue;
              }
           ...
           for (obj_ct = 0; obj_ct < flex_db->num_obj; obj_ct++) {
               if (sal_strcmp(flex_db->obj_str_arr[obj_ct], "Z0_MATCH_ID") == 0) {
                   field_pos[obj_ct] = z0_match_id_pos[extr];
                   field_offset[obj_ct] = z0_match_id_offset[extr];
                   valid_field = 1;
               } else if (sal_strcmp(flex_db->obj_str_arr[obj_ct], "Z1_MATCH_ID") == 0) {
                   field_pos[obj_ct] = z1_match_id_pos[extr];
                   field_offset[obj_ct] = z1_match_id_offset[extr];
                   valid_field = 1;
               } else if (sal_strcmp(flex_db->obj_str_arr[obj_ct], "Z2_MATCH_ID") == 0) {
                   field_pos[obj_ct] = z2_match_id_pos[extr];
                   field_offset[obj_ct] = z2_match_id_offset[extr];
                   valid_field = 1;
               } else if (sal_strcmp(flex_db->obj_str_arr[obj_ct], "Z3_MATCH_ID") == 0) {
                   field_pos[obj_ct] = z3_match_id_pos[extr];
                   field_offset[obj_ct] = z3_match_id_offset[extr];
                   valid_field = 1;
               } else if (sal_strcmp(flex_db->obj_str_arr[obj_ct], "Z4_MATCH_ID") == 0) {
                   field_pos[obj_ct] = z4_match_id_pos[extr];
                   field_offset[obj_ct] = z4_match_id_offset[extr];
                   valid_field = 1;
...
_field_td3_flex_ingress_qualifiers_init(int unit, _field_stage_t *stage_fc)
{
    ...
    if ((NULL == stage_fc) || (NULL == stage_fc->input_bus.qual_list)) {
        return (BCM_E_PARAM);
    }
...
_field_td3_flex_actions_init(int unit, _field_stage_t *stage_fc)
{
    ...
    /* ERSPAN3 Actions are not supported on TD3. It should be uncommented for HX5 */
#if 0
...
_field_td3_common_actions_init(int unit, _field_stage_t *stage_fc)
{
    ...
    if (!SOC_IS_TRIDENT3(unit)) {
        ...
        /* bcmFieldActionErspan3HdrVsmIdAdd */
        _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionErspan3HdrVsmIdAdd,
                                     0, _FieldActionSetNone, 0, 0, -1);

        /* OPAQUE_3_ACTION_SET */
        _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, _bcmFieldActionOpaque3,
                                     0, _FieldActionOpaque1ActionSet, 0, 16, -1);
        /* bcmFieldActionErspan3HdrSgtAdd */
        _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionErspan3HdrSgtAdd,
                                     0, _FieldActionSetNone, 0, 0, -1);
    }
#endif
...
_field_td3_stage_quals_ibus_map_init(int unit, _field_stage_t *stage_fc)
{
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 7);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 7);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyVxlanNetworkId, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 0, 0, 24);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 8);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyVxlanHeaderBits8_31, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 1, 32, 24);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 8);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyVxlanHeaderBits8_31, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 0);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyETag, qual_flags);
    ...
    if (soc_feature(unit, soc_feature_CnTag)) {
        BCMI_KEYGEN_QUAL_CFG_INIT(unit);
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 0, 0, 32);
        BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 1);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyCnTag, qual_flags);

        BCMI_KEYGEN_QUAL_CFG_INIT(unit);
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 1, 32, 32);
        BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 1);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyCnTag, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 0, 0, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyFabricQueueTag, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 1, 32, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyFabricQueueTag, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 0, 0, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyMplsForwardingLabel, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 1, 32, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyMplsForwardingLabel, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 0, 0, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyMplsControlWord, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 1, 32, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyMplsControlWord, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 9);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 9);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyIp6FlowLabel, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TTL_FN, 2);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TOS_FN, 2);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TCP_FN, 2);
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, _bcmFieldQualifyPreLogicalTableId, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 0);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyL4Ports, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 3);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7AHashUpper, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 3, 48, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7AHashUpper, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 5, 80, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7AHashUpper, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 0, 0, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7BHashUpper, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 1, 16, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7BHashUpper, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 3, 48, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7BHashUpper, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 5, 80, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7BHashUpper, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 0, 0, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7AHashLower, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 1, 16, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7AHashLower, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 0, 0, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7BHashLower, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 1, 16, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyRtag7BHashLower, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 0);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassPort, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassL3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassL3, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassVPort, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassVPort, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassL2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassL2, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassField, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassField, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassField, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassField, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassField, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassField, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 6);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceLookupClassPort, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 7);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyUdfClass, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 7);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyUdfClass, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 0);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 216, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 200, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL2, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassL2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassL2, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 216, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 200, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 6);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcClassL3, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassL3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstClassL3, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 9);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 9);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup1, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 9);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup1, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 9);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup1, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 10);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 10);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 10);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup2, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 10);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup2, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, );
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 14, 224, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_B, 11);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 13, 208, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_C, 11);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup3, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 12, 192, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_D, 11);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyInterfaceClassMplsLookup3, qual_flags);
#endif

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 12);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 11);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_A, 0);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_B, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcModPortGport, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 10, 160, 16);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(1, BCMI_KEYGEN_EXT_SECTION_L1E2, 2, 5, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_A, 1);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(1, BCMI_KEYGEN_EXT_SECTION_L1E2, 2, 4, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_B, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcTrunk, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 10, 160, 14);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(1, BCMI_KEYGEN_EXT_SECTION_L1E2, 2, 5, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_A, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcMplsGport, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 11, 176, 14);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(1, BCMI_KEYGEN_EXT_SECTION_L1E2, 2, 4, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_B, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifySrcMplsGport, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 17, 272, 14);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyVpn, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_MAC_NORM, 1);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_L3_L4_NORM, 1);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 0, 0, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_B, 10);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyBfdYourDiscriminator, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E32, 1, 32, 32);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_A, 10);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyBfdYourDiscriminator, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 0, 0, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyPacketLength, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 1, 16, 16);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyPacketLength, qual_flags);
    ...
    SHR_BITSET(qual_flags.w, BCMI_KEYGEN_QUAL_FLAGS_NOT_IN_EM);
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 10, 88, 8);
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 12, 96, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TTL_FN, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyTtlClassZero, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 12, 96, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TTL_FN, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyTtlClassOne, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 11, 88, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TOS_FN, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyTosClassZero, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E8, 11, 88, 8);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TOS_FN, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyTosClassOne, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E4, 2, 8, 4);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(1, BCMI_KEYGEN_EXT_SECTION_L1E4, 3, 12, 4);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TCP_FN, 0);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyTcpClassZero, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E4, 2, 8, 4);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(1, BCMI_KEYGEN_EXT_SECTION_L1E4, 3, 12, 4);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_TCP_FN, 1);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_D, 7);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_AUX_TAG_C, 7);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyFibreChanVFTPri, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 4);
    ...
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 4);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyDstPort, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 152, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 153, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 5);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyDstMimGport, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 152, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 9);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 153, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 9);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyDstL3EgressNextHops, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 152, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 7);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 153, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 7);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyDstMultipath, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 152, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 8);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 153, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 8);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyDstMultipathUnderlay, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 152, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 11);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 153, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 11);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyDstL3MulticastGroup, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 152, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_0, 12);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
        (1, BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB, 4, 153, 1);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_SRC_DST_1, 12);
    BCMI_KEYGEN_QUAL_CFG_INSERT
        (unit, db, bcmFieldQualifyDstL2MulticastGroup, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_IPBM, 0, 0, 34);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_IPBM_PRESENT, 3);
    BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    if (soc_feature(unit, soc_feature_ifp_no_inports_support)) {
       BCMI_KEYGEN_QUAL_CFG_INIT(unit);
       BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_IPBM, 0, 0, 34);
       BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_IPBM_PRESENT, 1);
       BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_IPBM, 0, 0, 34);
    BCMI_KEYGEN_QUAL_CFG_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_IPBM_PRESENT, 2);
    BCMI_KEYGEN_QUAL_CFG_INSERT
                                   ...
                                   bcm_field_pkt_type_t *type)
{
    ...
    *type = bcmFieldPktTypeLastCount;
    ...
    /* Chvck if it is generic IOAM type (without IP) */
    rv = (soc_cancun_ceh_obj_field_get(unit, "Z2_MATCH_ID",
                                       "GPE_INT", &ceh_info));
    if (SOC_FAILURE(rv)) {
       LOG_ERROR(BSL_LS_BCM_FP, (BSL_META("obj_str:%s field_str:%s\n\r"),
                                                ...
                                                _field_em_action_set_t *acts_buf)
{
    ...
    if ((fa->action != bcmFieldActionIntEncapEnable) &&
        ...
        (fa->action != bcmFieldActionErspan3HdrSgtAdd) &&
        (fa->action != bcmFieldActionErspan3HdrVsmIdAdd)) {
        return BCM_E_NONE;
    }
    ...
    if ((fa->action == bcmFieldActionErspan3HdrSgtAdd) ||
        (fa->action == bcmFieldActionErspan3HdrVsmIdAdd)) {
       int _action;
       ...
       if (fa->action == bcmFieldActionErspan3HdrSgtAdd) {
          ...
          _action = _bcmFieldActionOpaque4;
       }
    ...
    switch (fa->action) {
       ...
       case bcmFieldActionErspan3HdrSgtAdd:
       case bcmFieldActionErspan3HdrVsmIdAdd:
                                              ...
                                              int num_pipe)
{
    ...
    static uint16 pbm_34_49[2];
    static uint16 pbm_50_65[2];
    static uint16 pbm_34_49_mask[2];
    static uint16 pbm_50_65_mask[2];
    ...
    for (inst = 0; inst < num_pipe; inst++) {
        rv = _bcm_field_th_qualify_set(unit, f_ent->eid,
                                   ...
                                   (uint32 *)&pbm_34_49[inst],
                                   (uint32 *)&pbm_34_49_mask[inst],
                                   _FP_QUALIFIER_ADD);
        BCM_IF_ERROR_RETURN(rv);

        rv = _bcm_field_th_qualify_set(unit, f_ent->eid,
                                   _bcmFieldQualifyInPorts_2,
                                   (uint32 *)&pbm_50_65[inst],
                                   (uint32 *)&pbm_50_65_mask[inst],
                                   _FP_QUALIFIER_ADD);
        BCM_IF_ERROR_RETURN(rv);
                               ...
                               bcm_pbmp_t mask)
{
    ...
    uint16            pbm_34_49 = 0;
    uint16            pbm_50_65 = 0;
    uint16            pbm_34_49_mask = 0;
    uint16            pbm_50_65_mask = 0;
