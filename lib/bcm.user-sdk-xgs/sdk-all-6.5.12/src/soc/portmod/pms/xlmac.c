...
/*
 * Function:
 *      _xlmac_timestamp_byte_adjust_set
 * Purpose:
 ...
 */
STATIC int
_xlmac_timestamp_byte_adjust_set(int unit, soc_port_t port, int speed)
{
    uint64 ctrl;
                                          ...
                                          portmod_port_ts_adjust_t ts_adjust, int speed)
{
    ...
    /* Set Timestamp byte adjust values */
    SOC_IF_ERROR_RETURN(_xlmac_timestamp_byte_adjust_set(unit, port, speed));
