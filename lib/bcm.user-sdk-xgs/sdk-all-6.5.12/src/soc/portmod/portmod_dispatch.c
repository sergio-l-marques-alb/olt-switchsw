...
{        
    ...
    phymod_lane_map_t_init(&portmod_port_add_info->lane_map);
...
{        
    ...
    cprimod_cpri_container_config_t_init(&portmod_cpri_axc_frame_info->container_info);
    cprimod_payload_size_info_t_init(&portmod_cpri_axc_frame_info->roe_payload_info);
    cprimod_encap_decap_data_config_t_init(&portmod_cpri_axc_frame_info->encap_data_info);
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_rx_axc_frame_get(int unit, int port, uint32 axc_id, portmod_cpri_axc_frame_info_t* frame_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_rx_axc_frame_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_rx_axc_frame_get(unit, port, pm_info, axc_id, frame_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_tx_axc_frame_get(int unit, int port, uint32 axc_id, portmod_cpri_axc_frame_info_t* frame_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_axc_frame_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_axc_frame_get(unit, port, pm_info, axc_id, frame_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_cpri_port_tx_frame_tgen_next_hfn_set(int unit, int port, uint32 hfn)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_hfn_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_hfn_set(unit, port, pm_info, hfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_frame_tgen_next_hfn_set isn't implemented for driver type"));
    }
...
int portmod_cpri_port_tx_frame_tgen_next_hfn_get(int unit, int port, uint32* hfn)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_hfn_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_hfn_get(unit, port, pm_info, hfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_frame_tgen_next_hfn_get isn't implemented for driver type"));
    }
...
int portmod_cpri_port_tx_frame_tgen_next_bfn_set(int unit, int port, uint32 bfn)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_bfn_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_bfn_set(unit, port, pm_info, bfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_frame_tgen_next_bfn_set isn't implemented for driver type"));
    }
...
int portmod_cpri_port_tx_frame_tgen_next_bfn_get(int unit, int port, uint32* bfn)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_bfn_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_next_bfn_get(unit, port, pm_info, bfn);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_frame_tgen_next_bfn_get isn't implemented for driver type"));
    }
...
int portmod_port_vcos_get(int unit, int port, const portmod_vcos_speed_config_t* speed_config_list, int size, portmod_dual_vcos_t* dual_vco)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_vcos_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_vcos_get(unit, port, speed_config_list, size, dual_vco);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
{        
    ...
    portmod_cpri_rx_vsd_config_info->schan_bytes = 0;
...
{        
    ...
    portmod_cpri_tx_vsd_config_info->schan_bytes = 0;
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_rx_gcw_config_get(int unit, int port, uint32 index, portmod_cpri_tx_gcw_config_t* config_info)
{
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_tx_control_flow_config_set(int unit, int port, uint32 flow_id, uint32 queue_num, portmod_control_msg_proc_type_t proc_type)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_config_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_config_set(unit, port, pm_info, flow_id, queue_num, proc_type);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_tx_control_flow_config_get(int unit, int port, uint32 flow_id, uint32* queue_num, portmod_control_msg_proc_type_t* proc_type)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_config_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_config_get(unit, port, pm_info, flow_id, queue_num, proc_type);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_pm_specific_capability_get(int unit, portmod_pm_capability_t* pm_cap)
{
    ...
    if(pm_cap == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("pm_cap NULL parameter"));
    }
    if(SOC_E_NONE != portmod_pm_capability_t_init(unit, pm_cap)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("pm_cap initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_pm_specific_capability_get) {
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_pm_specific_capability_get(unit, pm_cap);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_pm_specific_capability_get isn't implemented for driver type"));
    }
...
int portmod_port_pm_core_init(int unit, pm_info_t pm_info, int pport, int lport, uint32 flags, const portmod_port_add_info_t* add_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_pm_core_init) {
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_pm_core_init(unit, pm_info, pport, lport, flags, add_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_pm_core_init isn't implemented for driver type"));
    }
...
int portmod_pm_is_initialized(int unit, pm_info_t pm_info, int pport, int lport, int* is_initialized)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_pm_is_initialized) {
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_pm_is_initialized(unit, pm_info, pport, lport, is_initialized);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_speed_config_validate(int unit, int port, const portmod_speed_config_t* speed_config, portmod_pbmp_t* affected_pbmp)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_speed_config_validate) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_speed_config_validate(unit, port, speed_config, affected_pbmp);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_pm_enable(int unit, int port, int port_mode, const portmod_port_add_info_t* add_info, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_pm_enable) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_pm_enable(unit, port, pm_info, port_mode, add_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_pm_vco_reconfig(int unit, int pm_id, int is_serdes_reset, int num_vco, const portmod_vco_type_t* vco)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_pm_vco_reconfig) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_from_pm_id_get(unit, pm_id, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_pm_vco_reconfig(unit, pm_id, pm_info, is_serdes_reset, num_vco, vco);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
