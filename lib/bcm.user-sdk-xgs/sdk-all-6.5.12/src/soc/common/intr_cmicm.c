...
#endif /* defined(BCM_ESW_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined(BCM_PETRA_SUPPORT)  || defined(BCM_DFE_SUPPORT)*/
...
#endif /* (BCM_ESW_SUPPORT) || (BCM_CALADAN3_SUPPORT)  || defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT)*/
