 ...
 */
STATIC int
_soc_monterey_bond_option_to_core_clk_freq(int unit, int val)
{
    int freq;
...
soc_monterey_bond_info_init(int unit)
{
    ...
    int feature_enables[][3] = {
        ...
        {414, 1, socBondInfoFeatureEfp512HalfSlice },  /* EFP_SLICE_DEPTH      */
        {418, 1, socBondInfoFeatureVfp512HalfSlice },  /* VFP_SLICE_DEPTH      */
        {419, 1, socBondInfoFeatureNoL3            },  /* L3_ENABLE            */
        {420, 1, socBondInfoFeatureNoL3Tunnel      },  /* L3_TUNNEL_ENABLE     */
        {421, 1, socBondInfoFeatureNoVxlan         },  /* VXLAN_ENABLE         */
        {422, 1, socBondInfoFeatureNoMpls          },  /* MPLS_ENABLE          */
        {423, 1, socBondInfoFeatureNoMacsec        },  /* MACSEC_ENABLE        */
        {424, 1, socBondInfoFeatureNoReserveTunnel },  /* RESERVE_TUNNEL_ENABLE*/
        {425, 1, socBondInfoFeatureNoPreemption    },  /* PREEMPTION_ENABLE    */
        {428, 1, socBondInfoFeatureTs1588        },  /* TS_1588_BC_ENABLE    */
        {-1,  0, -1                                }   /* Always last          */
    };
    ...
    /* RTS MC Enable */
    SOC_BOND_OPTIONS_COPY(val, uint32, bond_info_regval, 426,427 );
    if (val & 0x1) {
    ...
    SOC_BOND_OPTIONS_COPY(bond_info->clmac_map, uint32, bond_info_regval, 179,188);
    SOC_BOND_OPTIONS_COPY(bond_info->xlmac_map, uint32, bond_info_regval, 173, 178);
    ...
    SHR_BITCOPY_RANGE(bond_info->tsc_sr_only, 0, bond_info_regval,189 ,198 );
    SHR_BITCOPY_RANGE(bond_info->cpri_enable, 0, bond_info_regval,199 ,246 );
