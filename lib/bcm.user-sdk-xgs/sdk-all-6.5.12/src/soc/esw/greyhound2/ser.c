...
#define _GH2_SER_TEST_MMU        (1)
#define _GH2_SER_TEST_TCAM       (1)
#define _GH2_SER_TEST_EP         (1)
#define _GH2_SER_TEST_IP0        (1)
#define _GH2_SER_TEST_IP1        (1)
#define _GH2_SER_TEST_IP2        (1)
#define _GH2_SER_TEST_IP2_SR     (1)
#define _GH2_SER_TEST_IP2_SR_SN  (1)
#define _GH2_SER_TEST_CLPORT     (1)
#define _GH2_SER_TEST_XLPORT     (1)
#define _GH2_SER_TEST_GPORT      (1)
...
/* GH2 SKUs */
#define _SOC_SER_SKIP_GH2_HR3MG  (0x1 << 0)
#define _SOC_SER_SKIP_GH2_QUARTZ (0x1 << 1) /* no L3 */
/* GH2 chip revisions */
#define _SOC_SER_SKIP_GH2_A0     (0x1 << 2)
#define _SOC_SER_SKIP_GH2_B0     (0x1 << 3)
...
} _soc_gh2_ser_info_type_t;

typedef struct _soc_gh2_ser_reg_s {
    soc_reg_t reg;
    char      *str;
    soc_mem_t mem;
} _soc_gh2_ser_reg_t;

typedef struct _soc_gh2_ser_info_s {
    _soc_gh2_ser_info_type_t    type;
    struct _soc_gh2_ser_info_s  *info; /* used for MMU */
...
static _soc_gh2_ser_info_t _soc_gh2_ip0_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        ...
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        _SOC_SER_SKIP_GH2_A0
    },
#endif /* _GH2_SER_TEST_IP0 */
    { _SOC_PARITY_TYPE_NONE } /* table terminator */
};

static _soc_gh2_ser_info_t _soc_gh2_ip1_ser_info[] = {
#if _GH2_SER_TEST_IP1
    { _SOC_PARITY_TYPE_PARITY_DUAL, NULL,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_gh2_l3_entry_regs, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    ...
    { _SOC_PARITY_TYPE_PARITY_DUAL, NULL,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, _soc_gh2_l2_entry_regs, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
...
static _soc_gh2_ser_info_t _soc_gh2_ip2_ser_info[] = {
#if _GH2_SER_TEST_IP2
    { _SOC_PARITY_TYPE_PARITY, NULL,
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        ING_RX_COUNTER_PAR_ERRf, ING_RX_COUNTER_PAR_ERRf,
        ING_RX_COUNTERm, NULL,
        ING_RX_COUNTER_PARITY_CONTROLr, PARITY_ENf, NULL,
        INVALIDr, INVALIDf, NULL,
        ING_RX_COUNTER_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
...
#endif /* _GH2_SER_TEST_IP2 */
    { _SOC_PARITY_TYPE_NONE }, /* table terminator */
};

static _soc_gh2_ser_info_t _soc_gh2_ip2_sr_ser_info[] = {
#if _GH2_SER_TEST_IP2_SR
...
#endif /* _GH2_SER_TEST_IP2_SR */
    { _SOC_PARITY_TYPE_NONE }, /* table terminator */
};

static _soc_gh2_ser_info_t _soc_gh2_ip2_sr_sn_ser_info[] = {
#if _GH2_SER_TEST_IP2_SR_SN
...
#endif /* _GH2_SER_TEST_IP2_SR_SN */
    { _SOC_PARITY_TYPE_NONE }, /* table terminator */
};

static _soc_gh2_ser_info_t _soc_gh2_ep_ser_info[] = {
#if _GH2_SER_TEST_EP
    { _SOC_PARITY_TYPE_PARITY, NULL,
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_RESI23_PAR_ERRf, EGR_RESI23_PAR_ERRf,
        INVALIDm, NULL,
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_RESI23f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_RESI23_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_GE6_PAR_ERRf, EGR_GE6_PAR_ERRf,
        INVALIDm, "EP_EDB_GE6_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_GE6f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_GE6_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL6_PAR_ERRf, EGR_XL6_PAR_ERRf,
        INVALIDm, "EP_EDB_XL6_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL6f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL6_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL7_PAR_ERRf, EGR_XL7_PAR_ERRf,
        INVALIDm, "EP_EDB_XL7_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL7f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL7_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        ...
        INVALIDm, "EP_EDB_XL8_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL8f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL8_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL9_PAR_ERRf, EGR_XL9_PAR_ERRf,
        INVALIDm, "EP_EDB_XL9_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL9f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL9_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL10_PAR_ERRf, EGR_XL10_PAR_ERRf,
        INVALIDm, "EP_EDB_XL10_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL10f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL10_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL11_PAR_ERRf, EGR_XL11_PAR_ERRf,
        INVALIDm, "EP_EDB_XL11_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL11f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL11_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL12_PAR_ERRf, EGR_XL12_PAR_ERRf,
        INVALIDm, "EP_EDB_XL12_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL12f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL12_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_XL13_PAR_ERRf, EGR_XL13_PAR_ERRf,
        INVALIDm, "EP_EDB_XL13_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_XL13f, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_XL13_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
        EGR_CL_PAR_ERRf, EGR_CL_PAR_ERRf,
        INVALIDm, "EP_EDB_CL_MEM",
        EGR_EDATABUF_PARITY_CONTROL_64r, EGR_CLf, NULL,
        INVALIDr, INVALIDf, NULL,
        EGR_CL_PARITY_STATUSr, NULL, INVALIDf,
        INVALIDr, INVALIDf,
        INVALIDr, NULL, INVALIDr, INVALIDr,
        0
    },
...
#if _GH2_SER_TEST_MMU
static _soc_gh2_ser_reg_t cbppkthdr_regs[] = {
...
static _soc_gh2_ser_reg_t gh2_soc_wred_regs[] = {
...
static _soc_gh2_ser_reg_t ipmcgroup2to31_regs[] = {
...
static _soc_gh2_ser_reg_t ipmcgroup32to63_regs[] = {
...
static _soc_gh2_ser_info_t _soc_gh2_mmu_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_MMU_PAR_WRED, NULL,
        ...
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, gh2_soc_wred_regs, INVALIDf,
    ...
    { _SOC_PARITY_TYPE_MMU_ECC_IPMCGROUP, NULL,
        ...
        MMU_IPMC_GROUP_TBL2m, "MMU_IPMC_GROUP_TBL2~31m",
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
    ...
    { _SOC_PARITY_TYPE_MMU_ECC_IPMCGROUP, NULL,
        IPMCGROUPPARITYERRORINTMASKf, IPMCGROUPPARITYERRORf,
        MMU_IPMC_GROUP_TBL3m, "MMU_IPMC_GROUP_TBL2~31m",
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, ipmcgroup2to31_regs, INVALIDf,
        INVALIDr, IPMCGROUPPARITYERROR_CLRf,
    ...
    { _SOC_PARITY_TYPE_MMU_ECC_IPMCGROUP, NULL,
        IPMCGROUPPARITYERRORINTMASKf, IPMCGROUPPARITYERRORf,
        MMU_IPMC_GROUP_TBL4m, "MMU_IPMC_GROUP_TBL2~31m",
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, ipmcgroup2to31_regs, INVALIDf,
        INVALIDr, IPMCGROUPPARITYERROR_CLRf,
    ...
    { _SOC_PARITY_TYPE_MMU_ECC_IPMCGROUP, NULL,
        IPMCGROUPPARITYERRORINTMASKf, IPMCGROUPPARITYERRORf,
        MMU_IPMC_GROUP_TBL5m, "MMU_IPMC_GROUP_TBL2~31m",
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, ipmcgroup2to31_regs, INVALIDf,
        INVALIDr, IPMCGROUPPARITYERROR_CLRf,
...
#endif /*_GH2_SER_TEST_MMU */

static _soc_gh2_ser_info_t _soc_gh2_mmu_top_ser_info[] = {
#if _GH2_SER_TEST_MMU
    { _SOC_PARITY_TYPE_MMU_SER, _soc_gh2_mmu_ser_info,
        INVALIDf, INVALIDf,
...
#if _GH2_SER_TEST_CLPORT
static _soc_gh2_ser_info_t _soc_gh2_clport_ser_info[] = {
    { _SOC_PARITY_TYPE_ECC, NULL,
...
#endif /* _GH2_SER_TEST_CLPORT */

static _soc_gh2_ser_info_t _soc_gh2_pgw_clport_ser_info[] = {
#if _GH2_SER_TEST_CLPORT
    { _SOC_PARITY_TYPE_PORT_XL, _soc_gh2_clport_ser_info,
        PM_INTRf, PM_INTRf,
...
#if _GH2_SER_TEST_XLPORT
static _soc_gh2_ser_info_t _soc_gh2_xlport_ser_info[] = {
    { _SOC_PARITY_TYPE_ECC, NULL,
        MIB_RX_MEM_ERRf, MIB_RX_MEM_ERRf,
        INVALIDm, NULL,
...
#endif /* _GH2_SER_TEST_XLPORT */

static _soc_gh2_ser_info_t _soc_gh2_pgw_xlport_ser_info[] = {
#if _GH2_SER_TEST_XLPORT
...
static _soc_gh2_ser_info_t _soc_gh2_pgw_gport_ser_info[] = {
#if _GH2_SER_TEST_GPORT
    { _SOC_PARITY_TYPE_ECC, NULL,
        TXFIFO0_DBEf, TXFIFO0_DBEf,
        INVALIDm, NULL,
...
#endif /* _GH2_SER_TEST_GPORT */
    { _SOC_PARITY_TYPE_NONE }, /* table terminator */
};

/* from FORMAT CMIC_PARITY_INTR_STATUS */
#define _GH2_PAR_MMU       (0)
#define _GH2_PAR_EP        (1)
#define _GH2_PAR_IP0       (2)
#define _GH2_PAR_IP1       (3)
#define _GH2_PAR_IP2       (4)
#define _GH2_PAR_IP2_SR    (5)
#define _GH2_PAR_IP2_SR_SN (6)
#define _GH2_PAR_GE8P0     (8)
#define _GH2_PAR_GE8P1     (9)
#define _GH2_PAR_GE8P2     (10)
#define _GH2_PAR_GE0       (11)
#define _GH2_PAR_GE1       (12)
#define _GH2_PAR_XL0       (13)
#define _GH2_PAR_XL1       (14)
#define _GH2_PAR_XL2       (15)
#define _GH2_PAR_XL3       (16)
#define _GH2_PAR_XL4       (17)
#define _GH2_PAR_XL5       (18)
#define _GH2_PAR_XL6       (19)
#define _GH2_PAR_CL        (20)

#define _GH2_X_TO_CMIC_INTR(bit) (1 << (bit)) /* Bit 0-31 */

typedef struct _soc_gh2_ser_route_block_s{
    uint32          cmic_bit;
    ...
    void            *info;
} _soc_gh2_ser_route_block_t;

static _soc_gh2_ser_route_block_t _soc_gh2_ser_route_blocks[] = {
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_MMU), SOC_BLK_MMU, 0,
        INVALIDr, INVALIDr,
        _soc_gh2_mmu_top_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_EP), SOC_BLK_EPIPE, 0,
        EGR_INTR_ENABLE_64r, EGR_INTR_STATUS_64r,
        _soc_gh2_ep_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_IP0), SOC_BLK_IPIPE, 0,
        IP0_INTR_ENABLEr, IP0_INTR_STATUSr,
        _soc_gh2_ip0_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_IP1), SOC_BLK_IPIPE, 0,
        IP1_INTR_ENABLEr, IP1_INTR_STATUSr,
        _soc_gh2_ip1_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_IP2), SOC_BLK_IPIPE, 0,
        IP2_INTR_ENABLEr, IP2_INTR_STATUSr,
        _soc_gh2_ip2_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_IP2_SR), SOC_BLK_IPIPE, 0,
        IP2_SR_INTR_ENABLEr, IP2_SR_INTR_STATUSr,
        _soc_gh2_ip2_sr_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_IP2_SR_SN), SOC_BLK_IPIPE, 0,
        IP2_SR_SN_INTR_ENABLEr, IP2_SR_SN_INTR_STATUSr,
        _soc_gh2_ip2_sr_sn_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_GE8P0), SOC_BLK_PGW_GE8P, 0,
        PGW_GE_INTR_ENABLEr, PGW_GE_INTR_STATUSr,
        _soc_gh2_pgw_gport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_GE8P1), SOC_BLK_PGW_GE8P, 1,
        PGW_GE_INTR_ENABLEr, PGW_GE_INTR_STATUSr,
        _soc_gh2_pgw_gport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_GE8P2), SOC_BLK_PGW_GE8P, 2,
        PGW_GE_INTR_ENABLEr, PGW_GE_INTR_STATUSr,
        _soc_gh2_pgw_gport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_GE0), SOC_BLK_PGW_GE, 0,
        PGW_GE_INTR_ENABLEr, PGW_GE_INTR_STATUSr,
        _soc_gh2_pgw_gport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_GE1), SOC_BLK_PGW_GE, 1,
        PGW_GE_INTR_ENABLEr, PGW_GE_INTR_STATUSr,
        _soc_gh2_pgw_gport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL0), SOC_BLK_XLPORT, 0,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL1), SOC_BLK_XLPORT, 1,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL2), SOC_BLK_XLPORT, 2,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL3), SOC_BLK_XLPORT, 3,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL4), SOC_BLK_XLPORT, 4,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL5), SOC_BLK_XLPORT, 5,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_XL6), SOC_BLK_XLPORT, 6,
        PGW_XL_INTR_ENABLEr, PGW_XL_INTR_STATUSr,
        _soc_gh2_pgw_xlport_ser_info},
    {_GH2_X_TO_CMIC_INTR(_GH2_PAR_CL), SOC_BLK_PGW_CL, 0,
        PGW_CL_INTR_ENABLEr, PGW_CL_INTR_STATUSr,
        _soc_gh2_pgw_clport_ser_info},
    { 0 } /* table terminator */
};

STATIC int
_soc_gh2_ser_process_is_per_port_mem(
    int unit,
    _soc_gh2_ser_info_type_t type)
{
...
STATIC int
_soc_gh2_ser_process_skip_disabled_mmu_port(
    int unit,
    _soc_gh2_ser_info_t *info)
{
    soc_info_t *si = &SOC_INFO(unit);
    int logical_port, phy_port, mmu_port;
    _soc_gh2_ser_reg_t *reg_ptr;
    int ptr;
...
STATIC int
_soc_gh2_ser_mem_skip(int unit, _soc_gh2_ser_info_t *info)
{
    int sku;
    int skip = FALSE;
    uint16 dev_id;
    ...
    switch (rev_id){
        case (BCM56170_A0_REV_ID):
            if (info->sku_skip & _SOC_SER_SKIP_GH2_A0) {
                skip = TRUE;
            }
            break;
        case (BCM56170_B0_REV_ID):
            if (info->sku_skip & _SOC_SER_SKIP_GH2_B0) {
                skip = TRUE;
            }
            break;
        default:
    ...
    if (FALSE == skip) {
        (void)soc_gh2_chip_sku_get(unit, &sku);
        switch (sku){
            case (SOC_GH2_SKU_HURRICANE3MG):
                if (info->sku_skip & _SOC_SER_SKIP_GH2_HR3MG) {
                    skip = TRUE;
                }
                break;
            case (SOC_GH2_SKU_QUARTZ):
                if (info->sku_skip & _SOC_SER_SKIP_GH2_QUARTZ) {
                    skip = TRUE;
                }
                break;
            default:
    ...
    if (_soc_gh2_ser_process_is_per_port_mem(unit, info->type)) {
        if (_soc_gh2_ser_process_skip_disabled_mmu_port(unit, info)) {
            skip = TRUE;
        }
    }
    return skip;
...
STATIC int
_soc_gh2_ser_2bit_ecc_mem(int unit, soc_mem_t memTable)
{
...
STATIC void
_soc_gh2_mem_parity_info(int unit, int block_info_idx, int pipe,
...
#define _SOC_GH2_MMU_E2EFC_MAX     4
static soc_reg_t e2efc_regs[_SOC_GH2_MMU_E2EFC_MAX] = {
      INVALIDr,
...
STATIC int
_soc_gh2_ser_process_mmu_e2efc(int unit,_soc_gh2_ser_info_t *info_list,
                             int info_index, int block_info_idx, char *msg)
{
    ...
    _soc_gh2_mem_parity_info(unit, block_info_idx, 0,
...
STATIC int
_soc_gh2_ser_process_port_m2l_mapping(
    int unit,
    _soc_gh2_ser_info_t *info,
    uint32 valid_val,
    int *logical_port)
...
STATIC int
_soc_gh2_ser_process_mmu_group_correct(int unit,_soc_gh2_ser_info_t *info_list,
                                       ...
                                       char *msg, int report_type)
{
    ...
    for (ptr = 0; reg_ptr[ptr].reg != INVALIDr; ptr++) {
        ...
        if (_soc_gh2_ser_process_is_per_port_mem(unit, info->type)) {
            rv = _soc_gh2_ser_process_port_m2l_mapping(
...
STATIC int
_soc_gh2_ser_process_mmu_group_ecc(int unit,_soc_gh2_ser_info_t *info_list,
                                   int info_index, int block_info_idx, char *msg)
{
    _soc_gh2_ser_info_t *info;
    _soc_gh2_ser_reg_t *reg_ptr;
...
STATIC int
_soc_gh2_ser_process_mmu_ecc2(int unit,_soc_gh2_ser_info_t *info_list,
                              int info_index, int block_info_idx, char *msg)
...
STATIC int
_soc_gh2_ser_process_mmu_ecc(int unit,_soc_gh2_ser_info_t *info_list,
                             int info_index, int block_info_idx, char *msg,
                             int correctable)
{
    _soc_gh2_ser_info_t *info;
...
STATIC int
_soc_gh2_ser_process_mmu_err(int unit, int block_info_idx,
                             soc_reg_t group_reg,
                             soc_reg_t clear_reg,
                             _soc_gh2_ser_info_t *info_list)
{
    ...
    if (info_list->type == _SOC_PARITY_TYPE_MMU_SER){
        ...
        rv = _soc_gh2_ser_process_mmu_err(unit, block_info_idx,
                                          grp_reg,
                                          clr_reg,
                                          info_list->info);
        if (SOC_FAILURE(rv)) {
    ...
    for (info_index = 0; ; info_index++) {
        ...
        case _SOC_PARITY_TYPE_MMU_ECC:
            SOC_IF_ERROR_RETURN(
                _soc_gh2_ser_process_mmu_ecc(unit, info_list, info_index,
                                             block_info_idx, mem_str, 0));
            break;
        case _SOC_PARITY_TYPE_MMU_ECC_XQ:
            SOC_IF_ERROR_RETURN(
                _soc_gh2_ser_process_mmu_ecc2(unit, info_list, info_index,
                                             block_info_idx, mem_str));
            break;
        case _SOC_PARITY_TYPE_MMU_ECC_CBPH:
            SOC_IF_ERROR_RETURN(
                _soc_gh2_ser_process_mmu_group_ecc(unit, info_list, info_index,
                                             block_info_idx, mem_str));
            break;
        case _SOC_PARITY_TYPE_MMU_PAR_E2EFC:
            SOC_IF_ERROR_RETURN(
                _soc_gh2_ser_process_mmu_e2efc(unit, info_list, info_index,
                                             block_info_idx, mem_str));
            break;
        case _SOC_PARITY_TYPE_MMU_PAR_WRED:
            SOC_IF_ERROR_RETURN(_soc_gh2_ser_process_mmu_group_correct(
...
STATIC int
_soc_gh2_ser_process_parity_hash(int unit, int block_info_idx, int port,
                                _soc_gh2_ser_info_t *info,
                                  char *mem_str,
                                 soc_block_t blocktype)
{
    _soc_gh2_ser_reg_t reg_entry[2], *reg_ptr;
    soc_reg_t reg;
    _soc_ser_correct_info_t spci;
...
STATIC int
_soc_gh2_ser_process_parity_ecc(int unit, int block_info_idx, int port,
                                _soc_gh2_ser_info_t *info,
                                char *mem_str,
...
#define _SOC_GH2_DBG_COUNTER_MAX     (12)
static soc_reg_t dbgc_regs[_SOC_GH2_DBG_COUNTER_MAX] = {
...
STATIC int
_soc_gh2_ser_process_parity_counter(int unit, int block_info_idx, int port,
                                    _soc_gh2_ser_info_t *info,
                                    char *mem_str,
                                    soc_block_t blocktype)
{
...
STATIC int
_soc_gh2_process_ser(int unit, soc_block_t block_info_idx, int inst,
...

{
    ...
    for (info_index = 0; ; info_index++) {
        ...
        if (_soc_gh2_ser_mem_skip(unit, info)) {
            continue;
        }
        ...
        LOG_VERBOSE(BSL_LS_SOC_COMMON,
                    (BSL_META_U(unit,
                                "unit %d _soc_gh2_process_ser %s analysis\n"),
                                unit, mem_str));
        ...
        switch (info->type) {
            case _SOC_PARITY_TYPE_MMU_SER:
                SOC_IF_ERROR_RETURN
                    (_soc_gh2_ser_process_mmu_err(unit, block_info_idx,
                                                  INVALIDr, INVALIDr,
                                                  info));
                    /* info points to _soc_gh2_mmu_top_ser_info[0] */
                break;
            case _SOC_PARITY_TYPE_PARITY:
                SOC_IF_ERROR_RETURN
                    (_soc_gh2_ser_process_parity_ecc(unit, block_info_idx, port,
                                                     info, mem_str, blocktype,
                                                     info->type));
                break;
            case _SOC_PARITY_TYPE_PARITY_DUAL:
                SOC_IF_ERROR_RETURN
                    (_soc_gh2_ser_process_parity_hash(unit, block_info_idx, port,
                                                      info, mem_str, blocktype));
                break;
            ...
            case _SOC_PARITY_TYPE_COUNTER:
                SOC_IF_ERROR_RETURN
                    (_soc_gh2_ser_process_parity_counter(unit, block_info_idx, port,
                                                         info, mem_str, blocktype));
                break;
...
int
soc_gh2_ser_process_all(int unit, uint32 cmic_rval)
{
    uint8       rbi;
    _soc_gh2_ser_route_block_t *rb;
    uint32      cmic_bit;
    ...
    for (rbi = 0; ; rbi++) {
        rb = &_soc_gh2_ser_route_blocks[rbi];
        ...
        SOC_IF_ERROR_RETURN(
            _soc_gh2_process_ser(unit, block_info_idx, rb->id,
...
STATIC int
_soc_gh2_mmu_ser_config(int unit, _soc_gh2_ser_info_t *info_list,
...
STATIC int
_soc_gh2_pm_ser_config(int unit, _soc_gh2_ser_info_t *info_list,
...
STATIC int
_soc_gh2_ser_enable_info(int unit, int block_info_idx, int inst, int port,
                         ...
                         soc_mem_t mem, int enable)
{
    ...
    for (info_index = 0; ; info_index++) {
        ...
        case _SOC_PARITY_TYPE_PORT_XL:
            ...
            rv =_soc_gh2_pm_ser_config(unit, info->info, block_info_idx,
        ...
        case _SOC_PARITY_TYPE_PARITY_DUAL:
            ...
            if (info->type == _SOC_PARITY_TYPE_MMU_SER) {
                rv = _soc_gh2_mmu_ser_config(unit, info->info,
...
int
_soc_gh2_mem_parity_control(int unit, soc_mem_t mem,
                            int copyno, int enable)
{
    ...
    soc_mem_t   memTable;
    int         port = REG_PORT_ANY;
    _soc_gh2_ser_info_t *info_list, *info;
    int         info_index;
    uint32      misc_cfg;
...
int
soc_gh2_ser_enable_all(int unit, int enable)
{
    _soc_gh2_ser_route_block_t *rb;
    uint8       rbi;
    int         block_info_idx;
    ...
    for (rbi = 0; ; rbi++) {
        ...
        rv = _soc_gh2_ser_enable_info(unit, block_info_idx, rb->id, port,
    ...
    soc_gh2_ser_cmic_interrupt_enable(unit, enable);

    return SOC_E_NONE;
}

static _soc_generic_ser_info_t _soc_gh2_tcam_ser_info_template[] = {
#if _GH2_SER_TEST_TCAM
    ...
    { FP_TCAMm, INVALIDm, _SOC_SER_TYPE_PARITY, _SOC_SER_PARITY_4BITS,
      _SOC_SER_INTERLEAVE_MOD2,
      { {0, 238}, {1, 238}, {239, 473}, {240, 473} }, 0, 0, 0, 0,
      _SOC_SER_FLAG_XY_READ},
...
static _soc_generic_ser_info_t *_soc_gh2_tcam_ser_info[SOC_MAX_NUM_DEVICES] = {NULL};

int
soc_gh2_tcam_ser_init(int unit)
{
    int alloc_size;
    int sku;
    ...
    alloc_size = sizeof(_soc_gh2_tcam_ser_info_template);
    if (NULL == _soc_gh2_tcam_ser_info[unit]) {
        if ((_soc_gh2_tcam_ser_info[unit] =
             sal_alloc(alloc_size, "gh2 tcam list")) == NULL) {
            return SOC_E_MEMORY;
        }
        sal_memset(_soc_gh2_tcam_ser_info[unit], 0, alloc_size);
    }
    if (sku == SOC_GH2_SKU_HURRICANE3MG ||
        sku == SOC_GH2_SKU_QUARTZ
        ) {
        /* Greyhound2 */
        sal_memcpy(
            _soc_gh2_tcam_ser_info[unit],
            &(_soc_gh2_tcam_ser_info_template),
            alloc_size);
    }
    ...
    soc_mem_scan_ser_list_register(unit, TRUE,
                                   _soc_gh2_tcam_ser_info[unit]);
#endif
    return soc_generic_ser_init(unit, _soc_gh2_tcam_ser_info[unit]);
}

void
soc_gh2_ser_fail(int unit)
{
    soc_generic_ser_process_error(unit, _soc_gh2_tcam_ser_info[unit],
                                  _SOC_PARITY_TYPE_SER);
}

#if defined(SER_TR_TEST_SUPPORT)
int
ser_test_greyhound2_mem_index_remap(int unit, ser_test_data_t *test_data,
                                  int *mem_has_ecc)
{
    int uft_bkt_bank = 0;
    int uft_le_fv = 0;
    ...
    *mem_has_ecc = 0;
    ...
    if (_soc_gh2_ser_2bit_ecc_mem(unit, test_data->mem_fv)) {
        *mem_has_ecc = 1;
    }
...
soc_ser_test_functions_t ser_gh2_test_fun;

/* Overlay memory */
const soc_ser_overlay_test_t soc_ser_gh2_overlay_mems[] = {
...
STATIC int
soc_gh2_tcam_entry_is_invalid(int unit, soc_mem_t mem, int index)
{
 ...
 *
 */
int soc_gh2_ser_inject_error(int unit, uint32 flags, soc_mem_t mem,
                            int pipeTarget, int block, int index)
{
    _soc_generic_ser_info_t *tcam_ser_info = _soc_gh2_tcam_ser_info[unit];
    soc_reg_t   parity_enable_reg = INVALIDr;
    soc_field_t hw_parity_field = INVALIDf;
    ...
    if (tcam_ser_info != NULL) {
        ...
        for (i = 0; tcam_ser_info[i].mem != INVALIDm; i++) {
            if (tcam_ser_info[i].mem == mem) {
                ...
                if (soc_gh2_tcam_entry_is_invalid(unit, mem, index)) {
                    return (SOC_E_PARAM);
                }
    ...
    for (rbi = 0; ; rbi++) {
        ...
        for (info_index = 0; ; info_index++) {
            ...
            for (i=0; soc_ser_gh2_overlay_mems[i].mem != INVALIDm; i++) {
                if ((soc_ser_gh2_overlay_mems[i].mem == mem) &&
                    (soc_ser_gh2_overlay_mems[i].base_mem == memTable)) {
                    overlay_mem = 1;
                    break;
                }
            }
            if ((memTable == mem) || (overlay_mem)) {
                ...
                if (_soc_gh2_ser_2bit_ecc_mem(unit, memTable)) {
...
STATIC soc_error_t
_ser_gh2_ser_error_injection_support(int unit, soc_mem_t mem,
                                    int pipe_target)
{
    ...
    tcam_ser_info = _soc_gh2_tcam_ser_info[unit];
 ...
 */
int soc_gh2_ser_test_mem(int unit, soc_mem_t mem,
 ...
 *
 */
int soc_gh2_ser_test(int unit, _soc_ser_test_t test_type)
{
    _soc_generic_ser_info_t *tcam_ser_info = _soc_gh2_tcam_ser_info[unit];
    int         numTCAMErr = 0;
    int         numHwMemErr   = 0;
...
void
soc_gh2_ser_test_register(int unit)
{
    /*Initialize chip-specific functions for SER testing*/
    memset(&ser_gh2_test_fun, 0, sizeof(soc_ser_test_functions_t));
    ser_gh2_test_fun.inject_error_f = &soc_gh2_ser_inject_error;
    ser_gh2_test_fun.test_mem = &soc_gh2_ser_test_mem;
    ser_gh2_test_fun.test = &soc_gh2_ser_test;
    ser_gh2_test_fun.injection_support = &_ser_gh2_ser_error_injection_support;

    soc_ser_test_functions_register(unit, &ser_gh2_test_fun);
}
