/****************************************************************************
 * File Name  :  merlin_koi_functions.h
 * Created On :  29/04/2013
 * Created By :  Kiran Divakar
 * Description:  Header file with API functions for Serdes IPs
 * Revision   :  $Id: merlin_koi_functions.h 1077 2015-07-06 14:47:39Z kirand $
 *
...
#ifndef MERLIN_KOI_API_FUNCTIONS_H
#define MERLIN_KOI_API_FUNCTIONS_H
...
/**
 * This build includes register access macros for the MERLIN/KOI core.
 */
