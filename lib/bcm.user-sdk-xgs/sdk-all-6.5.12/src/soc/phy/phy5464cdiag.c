/*
 * $Id: phy5464cdiag.c,v 1.34 Broadcom SDK $
...
,0x15,l102);return l84;}static int16 l103(l1 l34,int16 l102,int16 l40,int16
...
;}static int16 l134(int16 l71,int16 l76[4+1][4+1],int16 l77[4+1][4+1],int32
l104[4+1][4+1],int16 l7[],int16 l8[],int32 l74[4],int16*l82){int16 l84;int16
l135,l136,l40,l113,l137;int16 l112[4],l80[4];l84 = 0x0000;*l82 = 0;for(l113=0
;l113<4;l113++){l8[l113] = (int16)0x7FFF;l137 = 0;for(l135=0;l135<4;l135++){
if(l135 == l113){continue;}l40 = (((l113)<(l135))?(l113):(l135));l136 = (((l113
)>(l135))?(l113):(l135));if((l76[l136][l40+1] == 1)||(l76[l136][l40+1] == 2))
{l7[l113] = 0x0001;l8[l113] = (int16)(((((int32)l8[l113]))<(((int32)l77[l136]
[l40+1]*100)))?(((int32)l8[l113])):(((int32)l77[l136][l40+1]*100)));if(l8[
l113]>l77[l136][l40+1]*100){l74[l113] = l104[l136][l40+1];}*l82|= (0x1<<(l135*4
+l113));l137 = 1;}}if(l137==0){switch(l76[l113][0]){case 0:l7[l113] = 0x0000;
break;case 1:l7[l113] = 0x0002;break;case 2:l7[l113] = 0x0004;break;case 3:l7
[l113] = 0x0001;l84|= 0x0004;break;default:l7[l113] = -99;l84|= 0x0010;break;
}l8[l113] = l77[l113][0]*100;l74[l113] = l104[l113][0];}}for(l113=0;l113<4;
l113++){l112[l113] = l8[l113];if(l7[l113] == 0x0000)l80[l113] = 1;else l80[
l113] = 0;}if(l71!= 0){(void)l111(l112,l80);for(l113=0;l113<4;l113++){if(l7[
l113] == 0x0000)l8[l113] = l112[l113];}}return l84;}int16 l81(int16 l71,l1 l34
,int16 l73,int16 l7[],int16 l8[],int32 l74[4],int16*l82,int16 l75[4+1],int16
l76[4+1][4+1],int16 l77[4+1][4+1]){int16 l40,l84;int16 l102;int32 l104[4+1][4
+1];l102 = 0;l84 = 0x0000;l84|= l99(l34,l73);for(l40=-1;l40<(4-1);l40++){if(
l40 == -1){l102 = 0x0089;l84|= l100(l34,0,l102,l73);}else if(l40 == 0){l102 = 
0x0009;l84|= l100(l34,1,l102,l73);}l84|= l103(l34,l102,l40,l75,l76,l77,l104);
}l84|= l134(l71,l76,l77,l104,l7,l8,l74,l82);l84|= l46(l34,0x0,(int16)0x8000);
sal_usleep(1000*(1));l84|= l69(l34);return l84;}static int32 l138(uint16 l139
