...
/*Q2.Next_Protocol[10:7] use the CE16 which nibble alignment, so actually it will use the [10:4], so here ignore the [150:148] */
...
#define ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_MSB               (ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_LSB + 4)
   ...
   )
{
  ...
  prog_selection_1st_cam_tbl.packet_format_code              = ARAD_PARSER_PFC_ETH;  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
  ...
  )
{
  ...
  /* Double tags */
  {
      /* GPON classificaiton is on outer tag only */
   ...
   */
  /* one-tag */
  if (vt_programs[unit][PROG_VT_SECTION_OAM_ONE_TAG].prog_used != -1)
  {
      SET_VT_PROGRAM_SELECTION(prog_indx);
  ...
  /* Double tags */
  if (vt_programs[unit][PROG_VT_SECTION_OAM_TWO_TAGS].prog_used != -1)
  {
      SET_VT_PROGRAM_SELECTION(prog_indx);
   ...
   * {
   */      
  if (vt_programs[unit][PROG_VT_GENERALIZED_RCH0].prog_used != -1)
  {
    SET_VT_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_GENERALIZED_RCH1].prog_used != -1)
  {
    SET_VT_PROGRAM_SELECTION(prog_indx);
 ...
 */
  ...
  /*
   * Logic for IPv6 tunnels
   * 1. Outer tag
   * 2. Untagged + priority + initial-VID
   * Note : no support for double-tag.
   * {
   */
  /* 2nd pass has the higher priority */
  if (vt_programs[unit][PROG_VT_IPV6_OUTER_VID_AFTER_RECYCLE].prog_used != -1)
  {
      SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_IPV6_INITIAL_VID_AFTER_RECYCLE].prog_used != -1)
  {
      SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_IPV6_OUTER_VID].prog_used != -1)
  {
      SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_IPV6_INITIAL_VID].prog_used != -1)
  {
      SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_INDX_VD_MPLS4_OUTERVID_L1L2].prog_used != -1)
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_INDX_VD_MPLS4_INITIALVID_L1L2].prog_used != -1)
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_VDxOUTERVID].prog_used != -1)
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
  ...
  if (vt_programs[unit][PROG_VT_VDxINITIALVID].prog_used != -1)
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
   ...
   )
{
  ...
  prog_selection_2nd_cam_tbl.packet_format_code               = ARAD_PARSER_PFC_IPV6_ETH;/*6b00_0011; (should catch IHP_PFC_PART_IPV4 (3b???,3b010) or IHP_PFC_PART_IPV6 (3b???,3b011)*/
  if(ipv4_comp_mc_disable)
      prog_selection_2nd_cam_tbl.packet_format_code_mask      = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE;        /* DO not include IPV4 */
  else
      prog_selection_2nd_cam_tbl.packet_format_code_mask      = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE_ANY_IP; /* Include IPV4 */
  ...
  if (is_bridging_program) {
      prog_selection_2nd_cam_tbl.ptc_tt_profile          = ARAD_PORTS_TT_PROFILE_FORCE_BRIDGE_FWD; /* (rcy port) PTC */
  ...
  )
{
  ...
  /* 
     RCH
  */      
  if (tt_programs[unit][PROG_TT_GENERALIZED_RCH_MPLS_PROG].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_IP_DISABLE_FOR_EXPLICIT_NULL_PROG].prog_used != -1)
  { 
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_IPV4_DISABLE_FOR_EXPLICIT_NULL_PROG].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_IPV6_DISABLE_FOR_EXPLICIT_NULL_PROG].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_MPLS4_L3_L4].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_MPLS4_NOP].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_AS_ORDER_L2_L3].prog_used != -1)
  {
      SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_AS_ORDER_L2_L2].prog_used != -1)
  {
      SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_AS_ORDER_L1_L2].prog_used != -1)
  {
      SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_AS_ORDER_L1_L1].prog_used != -1)
  {
      SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_INDX_AS_ORDER_NOP].prog_used != -1)
  {
      SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  /* Must be here, or else it will match PROG_TT_IPV4_ROUTER_DIP_FOUND_PROG or PROG_TT_IP_ROUTER_CompatibleMc_2ND_PROG */
  if (tt_programs[unit][PROG_TT_IPV6_ROUTER_2ND_PROG_AFTER_RECYCLE].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_IPV6_ROUTER_COMP_DEST_FOUND].prog_used != -1)
  {  
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_PPPOE_PROG].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  if (tt_programs[unit][PROG_TT_BRIDGE_STAR_2ND_PROG].prog_used != -1 && (ipmc_second_pass_caused_by_rpf_fail(unit)|| SOC_DPP_CONFIG(unit)->pp.force_bridge_forwarding))
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
  ...
  )
{
  ...
  else
  {
      ...
      if (section_oam_enable) { /* Enabled counter mpls packet for Section OAM */
          arad_ARAD_TCAM_ACCESS_INFO_clear_and_update(&tcam_access_info,
                                                  ARAD_TCAM_BANK_OWNER_VT,
                                                  ARAD_TCAM_BANK_ENTRY_SIZE_80_BITS,
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_IPV6_TUNNEL_CASCADE_DIP_AFTER_RECYCLE:
    /* set DIP mask */
    soc_sand_bitstream_set_bit_range(entry->mask, ARAD_PP_ISEM_ACCESS_KEY_IPV6_TUNNEL_CASCADE_DIP_TCAM_DIP_LSB(unit), ARAD_PP_ISEM_ACCESS_KEY_IPV6_TUNNEL_CASCADE_DIP_TCAM_DIP_MSB(unit)); /* Mask all , take into account all entry */     
    /* set IP.protocol mask */
    soc_sand_bitstream_set_bit_range(entry->mask, 
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_IPV6_TUNNEL_CASCADE_SIP:
    ...
    /* set Compressed Destination valid mask */
    soc_sand_bitstream_set_bit_range(entry->mask, 
    ...
    /* set Compressed Destination mask */
    soc_sand_bitstream_set_bit_range(entry->mask, 
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_SECTION_OAM_PORT_ETH_VID:
    ...
    if (!isem_key->key_info.section_oam.outer_vid_valid)
    {
      soc_sand_bitstream_reset_bit_range(entry->mask, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_OUTER_VID_LSB(unit), ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_OUTER_VID_MSB(unit)); /* No outer-vid */         
    }
    if (!isem_key->key_info.section_oam.ether_type_valid)
    {
      soc_sand_bitstream_reset_bit_range(entry->mask, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_ETHERTYPE_LSB(unit), ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_ETHERTYPE_MSB(unit)); /* No ethertype */         
    }
    if (!isem_key->key_info.section_oam.port_valid)
    {
      soc_sand_bitstream_reset_bit_range(entry->mask, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_VLAN_DOMAIN_LSB, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_VLAN_DOMAIN_MSB(unit)); /* No Vlan-domain */         
    }
    break;
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_SECTION_OAM_PORT_ETH_VID_VID:
    soc_sand_bitstream_set_bit_range(entry->mask, 0, 119); /* start by Mask all  */
    ...
    if (!isem_key->key_info.section_oam.inner_vid_valid)
    {
      soc_sand_bitstream_reset_bit_range(entry->mask, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_INNER_VID_LSB(unit), ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_INNER_VID_MSB(unit)); /* No inner-vlan */		 
    }
    if (!isem_key->key_info.section_oam.ether_type_valid)
    {
      soc_sand_bitstream_reset_bit_range(entry->mask, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_ETHERTYPE_LSB(unit), ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_ETHERTYPE_MSB(unit)); /* No ethertype */ 		
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_SPOOF_SIP6_TCAM_COMPRESSION:
    ...
    break;
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_CUSTOM_PP_LSP_ECMP:
    /*ECMP bit(1b) + lsp fp(17 bits)+ ps-fp(20bits)+vlan_domain(9bits)*/
  ...
  )
{
  ...
  /*
   *  Search for the vtt_key -> entry_id hash mask table
   */
...
/* coverity[overrun-buffer-arg] */
    ...
    /* add mask info to mask hash table */
    res = soc_sand_U32_to_U8(
            entry.mask,
            ARAD_PP_ISEM_ACCESS_TCAM_KEY_LEN_BYTES,
            stream_mask
  ...
  )
{
    ...
    if(entry_exists)
    {
        ...
        if(found)
        {
            /*res = arad_pp_isem_access_tcam_isem_stream_to_keyentry(unit, global_location->tcam_db_id, stream, &entry);
            SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);*/
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL_VID_VID:
  {
    ...
    lsb = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_LSB : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_LSB);
    nof_bits = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_NOF_BITS : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_VLAN_DOMAIN_NOF_BITS(unit));
    res = soc_sand_bitstream_get_any_field(buffer, lsb, nof_bits, &isem_key->key_info.l2_pon.port); /* Returns VLAN domain */
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_SECTION_OAM_PORT_ETH_VID:
    ...
    res = soc_sand_bitstream_get_any_field(buffer, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_VLAN_DOMAIN_LSB, ARAD_PP_ISEM_ACCESS_KEY_SECTION_OAM_PORT_ETH_VID_VLAN_DOMAIN_NOF_BITS(unit), &isem_key->key_info.section_oam.port); /* Returns VLAN domain */
