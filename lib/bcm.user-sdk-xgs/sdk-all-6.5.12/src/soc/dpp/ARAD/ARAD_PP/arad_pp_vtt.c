...
void arad_pp_dbal_sw_db_ipv6_dip_np_et_tcam_property_set                  (int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 vid_type            ); /* DIPv6 */
void arad_pp_dbal_sw_db_ipv6_sip_vrf_comp_dest_tcam_property_set (int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 key_type            ); /* DIPv6 */
...
/* MPLS DB's finish */                                                                                                                                                                                                      
    ...
    { {0}, "VTT DIPv6 AFTER RECYCLE TCAM"                     , SOC_DPP_DBAL_SW_TABLE_ID_DIPv6_AFTER_RECYCLE_TCAM                    , arad_pp_dbal_sw_db_dipv6_tcam_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM           , IP_NOT_COMPRESSED     }, /* DIPv6 */
    { {0}, "VTT_GENERALIZED_RCH0_TCAM"                 , SOC_DPP_DBAL_SW_TABLE_ID_GENERALIZED_RCH0_TCAM                              , arad_pp_dbal_sw_db_generalized_rch_property_set              , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM           , 1                       }, /* RCH 0 */
    { {0}, "VTT_GENERALIZED_RCH1_TCAM"                 , SOC_DPP_DBAL_SW_TABLE_ID_GENERALIZED_RCH1_TCAM                              , arad_pp_dbal_sw_db_generalized_rch_property_set              , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM           , 0                       }, /* RCH 1 */
};
...
/* 2*/    {ARAD_PP_DBAL_VT_PROG_VDxINITIALVID                                             , arad_pp_dbal_vt_program_vdxinitialvid_property_set                           , {-1}    , 0               },
/* 3*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTERVID                                               , arad_pp_dbal_vt_program_vdxoutervid_property_set                             , {-1}    , 0               },
/* 4*/    {ARAD_PP_DBAL_VT_PROG_VDxINITIALVID_L1                                          , arad_pp_dbal_vt_program_vdxinitialvid_l1_property_set                        , {-1}    , 0               },
/* 5*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTERVID_L1                                            , arad_pp_dbal_vt_program_vdxoutervid_l1_property_set                          , {-1}    , 0               },
/* 6*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTER_INNER_VID_L1                                     , arad_pp_dbal_vt_program_vdxouter_inner_vid_property_set                      , {-1}    , 0               },
/* 7*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTER_INNER_VID_OR_OUTER_VID_L1                        , arad_pp_dbal_vt_program_vdxouter_inner_vid_or_outervid_property_set          , {-1}    , 0               },
/* 8*/    {ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_L1FRR                                       , arad_pp_dbal_vt_program_vid_l1frr_property_set                               , {-1}    , INITIAL_VID     },
/* 9*/    {ARAD_PP_DBAL_VT_PROG_VD_OUTERVID_L1FRR                                         , arad_pp_dbal_vt_program_vid_l1frr_property_set                               , {-1}    , OUTER_VID       },
/*10*/    {ARAD_PP_DBAL_VT_PROG_VD_OUTER_OR_VD_OUTER_PCP                                  , arad_pp_dbal_vt_program_outer_pcp_property_set                               , {-1}    , 0               },
/*11*/    {ARAD_PP_DBAL_VT_PROG_VD_OUTER_INNER_OR_VD_OUTER_INNER_OUTERPCP                 , arad_pp_dbal_vt_program_outer_inner_pcp_property_set                         , {-1}    , 0               },
/*12*/    {ARAD_PP_DBAL_VT_PROG_HIGH_VD_OUTER_INNER_OUTERPCP_OR_VD_OUTER_INNER_OR_VD_OUTER, arad_pp_dbal_vt_program_outer_inner_pcp_or_outer_inner_or_outer_property_set , {-1}    , 0               },
/*13*/    {ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_OR_VD_INITIALVID                            , arad_pp_dbal_vt_program_vid_vid_property_set                                 , {-1}    , INITIAL_VID     },
/*14*/    {ARAD_PP_DBAL_VT_PROG_VD_OUTER_OR_VD_OUTER                                      , arad_pp_dbal_vt_program_vid_vid_property_set                                 , {-1}    , OUTER_VID       },
/*15*/    {ARAD_PP_DBAL_VT_PROG_VD_OUTER_INNER_OR_VD_OUTER_INNER                          , arad_pp_dbal_vt_program_vid_vid_property_set                                 , {-1}    , OUTER_INNER_VID },
/*16*/    {ARAD_PP_DBAL_VT_PROG_INDX_VD_INITIALVID_FRR_L1                                 , arad_pp_dbal_vt_program_indexed_vid_l1frr_property_set                       , {-1}    , INITIAL_VID     },
/*17*/    {ARAD_PP_DBAL_VT_PROG_INDX_VD_OUTERVID_FRR_L1                                   , arad_pp_dbal_vt_program_indexed_vid_l1frr_property_set                       , {-1}    , OUTER_VID       },
/*18*/    {ARAD_PP_DBAL_VT_PROG_VDxINITIALVID_TRILL                                       , arad_pp_dbal_vt_program_vdxinitialvid_trill_property_set                     , {-1}    , 0               },
/*19*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTERVID_TRILL                                         , arad_pp_dbal_vt_program_vdxoutervid_trill_property_set                       , {-1}    , 0               },
/*20*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTER_INNER_VID_TRILL                                  , arad_pp_dbal_vt_program_vdxouter_inner_vid_trill_property_set                , {-1}    , 0               },
/*21*/    {ARAD_PP_DBAL_VT_PROG_VD_DESIGNATED_VID_TRILL                                   , arad_pp_dbal_vt_program_vd_designated_vid_trill_property_set                 , {-1}    , 0               },
/*22*/    {ARAD_PP_DBAL_VT_PROG_VDxINITIALVID_L1_L2ELI                                    , arad_pp_dbal_vt_program_vdxinitialvid_l1_l2eli_property_set                  , {-1}    , 0               },
/*23*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTERVID_L1_L2ELI                                      , arad_pp_dbal_vt_program_vdxoutervid_l1_l2eli_property_set                    , {-1}    , 0               },
/*24*/    {ARAD_PP_DBAL_VT_PROG_VDxINITIALVID_L1L2                                        , arad_pp_dbal_vt_program_vdxinitialvid_l1l2_property_set                      , {-1}    , 0               },
/*25*/    {ARAD_PP_DBAL_VT_PROG_VDxOUTERVID_L1L2                                          , arad_pp_dbal_vt_program_vdxoutervid_l1l2_property_set                        , {-1}    , 0               },
/*26*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxINITIALVID_L1                                  , arad_pp_dbal_vt_program_indexed_vdxinitialvid_property_set                   , {-1}    , MPLS_LABEL_0    },
/*27*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxOUTERVID_L1                                    , arad_pp_dbal_vt_program_indexed_vdxoutervid_property_set                     , {-1}    , MPLS_LABEL_0    },
/*28*/    {ARAD_PP_DBAL_VT_PROG_MPLS_PORT_L1                                              , arad_pp_dbal_vt_program_mpls_port_termination_property_set                     , {-1}    , MPLS_LABEL_0    },
/*29*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxINITIALVID_L3                                  , arad_pp_dbal_vt_program_indexed_vdxinitialvid_property_set                   , {-1}    , MPLS_LABEL_2    },
/*30*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxOUTERVID_L3                                    , arad_pp_dbal_vt_program_indexed_vdxoutervid_property_set                     , {-1}    , MPLS_LABEL_2    },
/*31*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxINITIALVID                                        , arad_pp_dbal_vt_program_ipv4_vdxinitial_property_set                         , {-1}    , 0               },
/*32*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxOUTERVID                                          , arad_pp_dbal_vt_program_ipv4_vdxouter_property_set                           , {-1}    , 0               },
/*33*/    {ARAD_PP_DBAL_VT_PROG_IPV4_PORT                                                 , arad_pp_dbal_vt_program_ipv4_port_termination_property_set                   , {-1}    , 0               },
/*34*/    {ARAD_PP_DBAL_VT_PROG_EVB_UN_C_TAG                                              , arad_pp_dbal_vt_program_evb_property_set                                      , {-1}    , OUTER_VID       },
/*35*/    {ARAD_PP_DBAL_VT_PROG_EVB_S_TAG                                                 , arad_pp_dbal_vt_program_evb_property_set                                      , {-1}    , OUTER_INNER_VID },
/*36*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_PRIORITY_INITIAL_VID                           , arad_pp_dbal_vt_program_double_tag_priority_property_set                      , {-1}    , 0               },
/*37*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxINITIALVID_AFTER_RCY                              , arad_pp_dbal_vt_program_ipv4_vdxinitial_recycle_property_set                 , {-1}    , 0               },
/*38*/    {ARAD_PP_DBAL_VT_PROG_IPV4_VDxOUTERVID_AFTER_RCY                                , arad_pp_dbal_vt_program_ipv4_vdxouter_recycle_property_set                   , {-1}    , 0               },
/*39*/    {ARAD_PP_DBAL_VT_PROG_SINGLE_TAG_5_TUPPLE_QINQ                                  , arad_pp_dbal_vt_program_single_tag_5tupple_qinq_property_set                 , {-1}    , 0               },
/*40*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_5_TUPPLE_QINQ                                  , arad_pp_dbal_vt_program_double_tag_5tupple_qinq_property_set                 , {-1}    , 0               },
/*41*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_TST1                                             , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*42*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_TST1                                              , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*43*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_TST1                                           , arad_pp_dbal_vt_program_tst1_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },


/*44*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_VRRP                                             , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*45*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_VRRP                                              , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*46*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_VRRP                                           , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },


/*47*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_EXP_NULL_TST1                                    , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_UNTAGGED   },
/*48*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_EXP_NULL_TST1                                     , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_ONE_TAG    },
/*49*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_EXP_NULL_TST1                                  , arad_pp_dbal_vt_program_exp_null_tst1_property_set                           , {-1}    , TST1_VID_DOUBLE_TAG },
/*50*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_PCP_1_TST2                                    , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set                    , {-1}    , TPID1           },
/*51*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_PCP_2_TST2                                    , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set                    , {-1}    , TPID2           },
/*52*/    {ARAD_PP_DBAL_VT_PROG_OUTER_PCP_1_TST2                                          , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                          , {-1}    , TPID1           },
/*53*/    {ARAD_PP_DBAL_VT_PROG_OUTER_PCP_2_TST2                                          , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                          , {-1}    , TPID2           },
/*54*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_1_TST2                                        , arad_pp_dbal_vt_program_outer_inner_tst2_property_set                        , {-1}    , TPID1           },
/*55*/    {ARAD_PP_DBAL_VT_PROG_OUTER_INNER_2_TST2                                        , arad_pp_dbal_vt_program_outer_inner_tst2_property_set                        , {-1}    , TPID2           },
/*56*/    {ARAD_PP_DBAL_VT_PROG_OUTER_1_TST2                                              , arad_pp_dbal_vt_program_outer_tst2_property_set                              , {-1}    , TPID1           },
/*57*/    {ARAD_PP_DBAL_VT_PROG_OUTER_2_TST2                                              , arad_pp_dbal_vt_program_outer_tst2_property_set                              , {-1}    , TPID2           },
/*58*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_TST2                                             , arad_pp_dbal_vt_program_untagged_tst2_property_set                           , {-1}    , 0               },
/*59*/    {ARAD_PP_DBAL_VT_PROG_VT_TEST2                                                  , arad_pp_dbal_vt_program_test2_property_set                                   , {-1}    , 0               },
/*60*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE                                               , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , OUTER_VID       },
/*61*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE_UT                                            , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , INITIAL_VID     },
/*62*/    {ARAD_PP_DBAL_VT_PROG_VT_CUSTOM_PP_PORT_TUNNEL                                  , arad_pp_dbal_vt_program_custom_pp_port_tunnel_property_set                   , {-1}    , 0               },
/*63*/    {ARAD_PP_DBAL_VT_PROG_VD_INITIALVID_VLAN_DOMAIN_L1                              , arad_pp_dbal_vt_program_vlan_domain_mpls_property_set                        , {-1}    , 0               },
/*64*/    {ARAD_PP_DBAL_VT_PROG_PON_UNTAGGED                                              , arad_pp_dbal_vt_program_pon_untagged_property_set                            , {-1}    , 0               },
/*65*/    {ARAD_PP_DBAL_VT_PROG_PON_ONE_TAG                                               , arad_pp_dbal_vt_program_pon_one_tag_property_set                             , {-1}    , 0               },
/*66*/    {ARAD_PP_DBAL_VT_PROG_PON_TWO_TAGS                                              , arad_pp_dbal_vt_program_pon_two_tags_property_set                            , {-1}    , 0               },
/*67*/    {ARAD_PP_DBAL_VT_PROG_PON_TWO_TAGS_VS_TUNNEL_ID                                 , arad_pp_dbal_vt_program_pon_two_tags_vs_tunnel_id_property_set               , {-1}    , 0               },
/*68*/    {ARAD_PP_DBAL_VT_PROG_SECTION_OAM_ONE_TAG                                       , arad_pp_dbal_vt_program_section_oam_one_tag_property_set                     , {-1}    , 0               },
/*69*/    {ARAD_PP_DBAL_VT_PROG_SECTION_OAM_TWO_TAGS                                      , arad_pp_dbal_vt_program_section_oam_two_tags_property_set                    , {-1}    , 0               },
/*70*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxINITIALVID_MPLS4_L1L2                          , arad_pp_dbal_vt_program_indexed_vdxinitialvid_mpls4_l1l2_property_set        , {-1}    , 0               },
/*71*/    {ARAD_PP_DBAL_VT_PROG_INDEXED_VDxOUTERVID_MPLS4_L1L2                            , arad_pp_dbal_vt_program_indexed_vdxoutervid_mpls4_l1l2_property_set          , {-1}    , 0               },
/*72*/    {ARAD_PP_DBAL_VT_PROG_IPV6_VDxINITIALVID                                        , arad_pp_dbal_vt_program_ipv6_vdxinitial_property_set                         , {-1}    , 0               },
/*73*/    {ARAD_PP_DBAL_VT_PROG_IPV6_VDxOUTERVID                                          , arad_pp_dbal_vt_program_ipv6_vdxouter_property_set                           , {-1}    , 0               },
/*74*/	   {ARAD_PP_DBAL_VT_PROG_IPV6_VDxINITIALVID_AFTER_RECYCLE                          , arad_pp_dbal_vt_program_ipv6_vdxinitial_property_set                         , {-1}    , 1               },
/*75*/	   {ARAD_PP_DBAL_VT_PROG_IPV6_VDxOUTERVID_AFTER_RECYCLE                            , arad_pp_dbal_vt_program_ipv6_vdxouter_property_set                           , {-1}    , 1               },
/*76*/    {ARAD_PP_DBAL_VT_PROG_GENERALIZED_RCH0                                          , arad_pp_dbal_vt_program_generalized_rch_property_set                         , {-1}    , 1               },
/*77*/    {ARAD_PP_DBAL_VT_PROG_GENERALIZED_RCH1                                          , arad_pp_dbal_vt_program_generalized_rch_property_set                         , {-1}    , 0               },
...
/*47*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP_MC             , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , EXTENDER_IP_MC       },
/*48*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP_UC             , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , EXTENDER_IP_UC       },
/*49*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB                   , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , EXTENDER_ETH         },
/*50*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L1_GAL_ONLY           , arad_pp_dbal_tt_program_indexed_mpls_l1_gal_only_property_set       , {-1}    , 0                    },
/*51*/    {ARAD_PP_DBAL_TT_PROG_INDEXED_L2_GAL_ONLY           , arad_pp_dbal_tt_program_indexed_mpls_l2_gal_only_property_set       , {-1}    , 0                    },
/*52*/    {ARAD_PP_DBAL_TT_PROG_VLAN_DOMAIN_L1                , arad_pp_dbal_tt_program_vlan_domain_mpls_property_set               , {-1}    , 0                    },
/*54*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L2_L3          , arad_pp_dbal_tt_program_index_as_order_l2_l3_property_set           , {-1}    , 0                    },
/*55*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L2_L2          , arad_pp_dbal_tt_program_index_as_order_l2_l2_property_set           , {-1}    , 0                    },
/*56*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L1_L2          , arad_pp_dbal_tt_program_index_as_order_l1_l2_property_set           , {-1}    , 0                    },
/*57*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_L1_L1          , arad_pp_dbal_tt_program_index_as_order_l1_l1_property_set           , {-1}    , 0                    },
/*58*/    {ARAD_PP_DBAL_TT_PROG_INDEX_AS_ORDER_NOP            , arad_pp_dbal_tt_program_index_as_order_nop_property_set             , {-1}    , 0                    },
/*59*/    {ARAD_PP_DBAL_TT_PROG_INDEX_MPLS4_L3_L4             , arad_pp_dbal_tt_program_indexed_mpls_l3_l2_property_set             , {-1}    , 1                    },
/*60*/    {ARAD_PP_DBAL_TT_PROG_INDEX_MPLS4_NOP               , arad_pp_dbal_tt_program_mpls4_nop_property_set                      , {-1}    , 1                    },
/*61*/    {ARAD_PP_DBAL_TT_PROG_IP_DISABLE_ON_LIF             , arad_pp_dbal_tt_program_ip_disable_on_lif_property_set              , {-1}    , 0                    },
/*62*/    {ARAD_PP_DBAL_TT_PROG_IPV4_DISABLE_ON_LIF           , arad_pp_dbal_tt_program_ip_disable_on_lif_property_set              , {-1}    , 0                    },
/*63*/    {ARAD_PP_DBAL_TT_PROG_IPV6_DISABLE_ON_LIF           , arad_pp_dbal_tt_program_ip_disable_on_lif_property_set              , {-1}    , 0                    },
/*64*/    {ARAD_PP_DBAL_TT_PROG_IPV6_ROUTER_COMP_DEST_FOUND   , arad_pp_dbal_tt_program_ipv6_router_comp_dest_found_property_set    , {-1}    , 0                    },
/*65*/    {ARAD_PP_DBAL_TT_PROG_IPV6_ROUTER_AFTER_RECYCLE     , arad_pp_dbal_tt_program_ipv6_router_property_set                    , {-1}    , 1                    },
/*66*/    {ARAD_PP_DBAL_TT_PROG_PPPOE                         , arad_pp_dbal_tt_program_pppoe_property_set                          , {-1}    , 0                    },
/*67*/    {ARAD_PP_DBAL_TT_PROG_GENERALIZED_RCH_MPLS          , arad_pp_dbal_tt_program_generalized_rch_property_mpls_set           , {-1}    , 0                    },
};
...
void arad_pp_dbal_sw_db_dipv6_tcam_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 compressed)
{
    if (g_prog_soc_prop[unit].ipv6_term_dip_sip_enable) {
        ...
        sw_db_property->qual_info[qual_num].qual_nof_bits = 32;
        qual_num++;
        sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_IN_RIF_VALID_VRF;  /* vrf */
        sw_db_property->qual_info[qual_num].qual_nof_bits = (SOC_DPP_CONFIG(unit))->pp.ip6_tunnel_term_in_tcam_vrf_nof_bits;
        qual_num++;
        sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_PACKET_FORMAT_QUALIFIER2;  /* Qualifier2: GRE_Parsed and Next_Protocol*/
        sw_db_property->qual_info[qual_num].qual_nof_bits = 11;
        qual_num++;
        sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_IRPP_IN_PORT_KEY_GEN_VAR;    /* add port_property to the key */
        sw_db_property->qual_info[qual_num].qual_nof_bits = 4;   /* port_property is 4 LSB bits */
        qual_num++;
        ...
        else
        {
            ...
            /* Split the DIP[65:32] as two qualifier for the VXLAN/GRE need to use the CE32 */
...
void arad_pp_dbal_sw_db_pon_vdxtunnelxvid_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 key_type)
{
    ...
    if (!soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "gpon_application_enable", 0)) {
        ...
        sw_db_property->qual_info[0].qual_nof_bits = 5;
    }
...
/* Set section OAM PORTxVIDxVIDxETH table properties */
void arad_pp_dbal_sw_db_section_oam_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 key_type)
{
    switch(key_type)
    {
...
/* Set DIPv6xIP.Next_ProtocolxQualifier.Next_Protocol table properties */
void arad_pp_dbal_sw_db_ipv6_dip_np_et_tcam_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 vid_type)
{
    ...
    sw_db_property->qual_info[qual_num].qual_nof_bits = 32;
    qual_num++;
    sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_HDR_IPV6_NEXT_PRTCL;  /* IP.protocol */
    qual_num++;
    sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_PACKET_FORMAT_QUALIFIER1;     /* Qualifier.protocol_type */
...
/* Set SIPv6xVRFxCompressed_Dest*Port_Property table properties */
void arad_pp_dbal_sw_db_ipv6_sip_vrf_comp_dest_tcam_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 key_type)
{
    ...
    qual_num++;
    sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_VT_TCAM_MATCH_IN_LIF_IDX; /* use result of DIP->Compressed-Destination at VT TCAM */
    sw_db_property->qual_info[qual_num].qual_nof_bits = 7;  /* &&& */
    qual_num++;
    sw_db_property->qual_info[qual_num].qual_type     = SOC_PPC_FP_QUAL_IRPP_IN_PORT_KEY_GEN_VAR;    /* add port_property to the key */
    sw_db_property->qual_info[qual_num].qual_nof_bits = 4;   /* port_property is 4 LSB bits */
...
/* Set program property for vt_vdxinitialvid_mpls program */
void arad_pp_dbal_vt_program_vdxinitialvid_l1_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    int vdxinitial_vid_index=0;
...
/* Set program property for vt_vdxoutervid_mpls program */
void arad_pp_dbal_vt_program_vdxoutervid_l1_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused )
{
    int vdxouter_vid_index =0;
...
void arad_pp_dbal_vt_program_indexed_vdxinitialvid_mpls4_l1l2_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 mpls_label )
{
    ...
    program_property->pd_bitmap_0          = (0x10);  /* */
    program_property->pd_bitmap_1          = (0x20);  /* TT for Label1 according to ISB result */
    if(database == ARAD_PP_ISEM_ACCESS_ID_ISEM_A)
    {
        arad_pp_dbal_vtt_program_property_swap( program_property );
        program_property->vtt_table_index[0]             = program_property->vtt_table_index[1] - 1;
...
void arad_pp_dbal_vt_program_ipv6_vdxinitial_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 is_recycle)
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][0] = 11; /* CE32_11: INIT_VID */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][1] = 10; /* CE32_10: DIP[31:0] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][2] = 9;  /* CE16_9: DIP[47:32] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][3] = 8;  /* CE16_8: DIP[63:48] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][4] = 5;  /* CE32_5: DIP[95:64] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][5] = 4;  /* CE32_4: DIP[127:96] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][6] = 1;  /* CE16_1: IP.NP */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][7] = 0;  /* CE16_0: Q2.NP */
}
...
void arad_pp_dbal_vt_program_ipv6_vdxouter_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 is_recycle)
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][0] = 11; /* CE32_11: OUT_VID */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][1] = 10; /* CE32_10: DIP[31:0] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][2] = 9;  /* CE16_9: DIP[47:32] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][3] = 8;  /* CE16_8: DIP[63:48] */
    program_property->qual_to_ce_info.qualifier_to_ce_id[dip_np_et_tcam_index][4] = 5;  /* CE32_5: DIP[95:64] */
...
void arad_pp_dbal_vt_program_custom_pp_port_tunnel_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->pd_bitmap_0              = (0x30); /* TCAM and ISA is relevant */
    program_property->pd_bitmap_1              = (0x00);
...
void arad_pp_dbal_vt_program_pon_one_tag_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    if (!soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "gpon_application_enable", 0)) {
        ...
        program_property->qual_to_ce_info.qualifier_to_ce_id[1][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits vlan domain */
        program_property->qual_to_ce_info.qualifier_to_ce_id[1][1] = SOC_IS_JERICHO(unit) ? 10 : 6; /* 16 bits tunnel ID */
        program_property->qual_to_ce_info.qualifier_to_ce_id[1][2] = 1; /* 16 bits outer_vid */
    }
...
void arad_pp_dbal_vt_program_section_oam_one_tag_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][0] = SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits  outer_vid*/
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][1] = 1; /* 16 bits ethernet type */
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][2] = 0; /* 16 bits vlan domain */
    program_property->pd_bitmap_0 = 0x20; /* Only TCAM relevant */
    program_property->pd_bitmap_1 = (0x0);
...
void arad_pp_dbal_vt_program_section_oam_two_tags_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][0] =  SOC_IS_JERICHO(unit) ? 11 : 7; /* 16 bits outer_vid */
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][1] = SOC_IS_JERICHO(unit) ? 10 : 6; ; /* 16 bits inner_vid */
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][2] = 1; /* 16 bits ethernet type */
    program_property->qual_to_ce_info.qualifier_to_ce_id[0][3] = 0; /* 16 bits vlan domain */
    program_property->pd_bitmap_0 = 0x20; /* Only TCAM  relevant */
    program_property->pd_bitmap_1 = (0x0);
...
void arad_pp_dbal_vt_program_generalized_rch_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 is_rch0)
{
    ...
    /* TCAM lookup is not really used; Key C is used to extract the VSI */
...
void arad_pp_dbal_tt_program_ipv6_router_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 is_recycle)
{
    ...
    if (g_prog_soc_prop[unit].ipv6_term_dip_sip_enable) {
        program_property->implicit_flag = 1;
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][0] = 10;  /* CE32_10: DIP[31:0] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][1] = 9;   /* CE16_9: DIP[47:32] */ 
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][2] = 8;   /* CE16_8: DIP[63:48] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][3] = 5;   /* CE32_5: DIP[95:64] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][4] = 4;   /* CE32_4: DIP[127:96] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][5] = 3;   /* CE16_3: VRF */
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][6] = 2;   /* CE16_2: Q2 */        
        program_property->qual_to_ce_info.qualifier_to_ce_id[dipv6_index][7] = 1;   /* CE16_1: KEY_GEN_VAR */

        if(g_prog_soc_prop[unit].nvgre_enable) {
            program_property->qual_to_ce_info.qualifier_to_ce_id[tunnel_index][0] = 11; /* CE32_11: GRE_KEY */
            program_property->qual_to_ce_info.qualifier_to_ce_id[tunnel_index][1] = 7;  /* CE16_7: GRE_CRKS */
            if (SOC_IS_L2GRE_VDC_ENABLE(unit)) {
                program_property->qual_to_ce_info.qualifier_to_ce_id[tunnel_index][2] = 6; /* CE16_6: VD */
            }
        }        
        if(g_prog_soc_prop[unit].vxlan_enable )
        {
            program_property->qual_to_ce_info.qualifier_to_ce_id[tunnel_index][0] = 11;  /* CE32_11: VXLAN_VNI */
            if (SOC_IS_VXLAN_VDC_ENABLE(unit)) {
                program_property->qual_to_ce_info.qualifier_to_ce_id[tunnel_index][1] = 7; /* CE16_7: VD */
            }
        }        
        if(g_prog_soc_prop[unit].e_o_ip_enable)
        {
            program_property->qual_to_ce_info.qualifier_to_ce_id[tunnel_index][0] = 11;  /* CE32_11: VSI */
        }
    }    
}
...
void arad_pp_dbal_tt_program_ipv6_router_comp_dest_found_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    if (g_prog_soc_prop[unit].ipv6_term_dip_sip_enable) {
        program_property->implicit_flag = 1;
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][0] = 10;  /* CE32_10: SIP[31:0] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][1] = 9;   /* CE16_9: SIP[47:32] */ 
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][2] = 8;   /* CE16_8: SIP[63:48] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][3] = 5;   /* CE32_5: SIP[95:64] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][4] = 4;   /* CE32_4: SIP[127:96] */
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][5] = 3;   /* CE16_3: VRF */
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][6] = 2;   /* CE16_2: COMP_DEST */        
        program_property->qual_to_ce_info.qualifier_to_ce_id[sip_vrf_com_dest_index][7] = 1;   /* CE16_1: KEY_GEN_VAR */
...
void arad_pp_dbal_tt_program_generalized_rch_property_mpls_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->vtt_table_index[1]             = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L1_UNINDEXED_SEM_B);
    program_property->tcam_profile                   = ARAD_TCAM_ACCESS_PROFILE_INVALID;
    program_property->pd_bitmap_0                    = (0x18);  /* TT for Label1 according to ISA result */
...
int32 arad_pp_dbal_vt_cam_tm_set(int unit, ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    prog_selection->packet_format_code       = ARAD_PARSER_PFC_RAW_AND_FTMH;  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
...
/* Set vdxinitialvid+mpls program selection */
int32 arad_pp_dbal_vt_cam_vdxinitialvid_l1_set(int unit, ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 port_profile)
{
...
/* Set vdxoutervid+mpls program selection */
...
int32 arad_pp_dbal_vt_cam_ipv4_vdxinitialvid_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    ...
    prog_selection->packet_format_code_mask      = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE; /* I think that may ARAD_PARSER_PFC_MATCH_ANY_ENCAP is more appropriate */
...
int32 arad_pp_dbal_vt_cam_ipv4_vdxoutervid_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    prog_selection->packet_format_code         = ARAD_PARSER_PFC_IPV4_ETH;  /*(PacketFormatCode[5]==0) ==> starts with ethernet and IHP_PFC_PART_IPV4 */
    prog_selection->packet_format_code_mask    = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE; /* I think that may ARAD_PARSER_PFC_MATCH_ANY_ENCAP is more appropriate */
    prog_selection->in_pp_port_vt_profile      = (0x0);
    prog_selection->in_pp_port_vt_profile_mask =  ARAD_PP_ISEM_ACCESS_VT_PROFILE_MASK_EXCEPT_INITIAL_VID;
...
int32 arad_pp_dbal_vt_cam_ipv6_vdxoutervid_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 is_recycle)
{
    prog_selection->packet_format_code         = ARAD_PARSER_PFC_IPV6_ETH;  /*(PacketFormatCode[5]==0) ==> starts with ethernet and IHP_PFC_PART_IPV6 */
    prog_selection->packet_format_code_mask    = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE; /* I think that may ARAD_PARSER_PFC_MATCH_ANY_ENCAP is more appropriate */
    prog_selection->in_pp_port_vt_profile      = SOC_PPC_PORT_DEFINED_VT_PORT_TERMINATION_CASCADE;
...
int32 arad_pp_dbal_vt_cam_untagged_vrrp_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    prog_selection->packet_format_qualifier_1      = (0x0);
    prog_selection->packet_format_qualifier_1_mask = (ARAD_PP_ISEM_ACCESS_QLFR_ETH_MASK_NXT_PROTOCOL | ARAD_PP_ISEM_ACCESS_QLFR_ETH_MASK_ENCAP);
    prog_selection->packet_format_code             = ARAD_PARSER_PFC_IPV4_ETH;  /*Ipv4, Ipv6 packets */
...
int32 arad_pp_dbal_vt_cam_vdxiniitialvid_l1_l2eli_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused )
{
    ...
    prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS2_ETH; /* At least 2 MPLS labels */
...
int32 arad_pp_dbal_vt_cam_section_oam_all_progs_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 prog_sel_pon_type)
{
    ...
    prog_selection->packet_format_code             = ARAD_PARSER_PFC_ETH;  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
    prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_TYPE;
...
int32 arad_pp_dbal_tt_cam_mpls_l3_l2_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int line, uint32 unused)
{
    ...
    else
    {
        prog_selection->packet_format_qualifier_1      = (ARAD_PP_ISEM_ACCESS_QLFR_ETH_NEXT_PROTOCOL_MPLS);
        prog_selection->packet_format_qualifier_1_mask = (0x7F);
        prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS3_ETH; /* At least 3 labels */
        prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
...
int32 arad_pp_dbal_tt_cam_mpls_l1_l1_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 is_gal)
{
    ...
    if(is_gal)
    {
        ...
        prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS2_ETH; /* Only one label in stack */
        prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS2; and bit 5 that it is ethernet packet */
    }
    else
    {
        prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS1_ETH; /* Only one label in stack */
        prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS1; and bit 5 that it is ethernet packet */
    }
...
int32 arad_pp_dbal_tt_cam_mpls_l2_l2_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    prog_selection->packet_format_qualifier_1      = (ARAD_PP_ISEM_ACCESS_QLFR_ETH_NEXT_PROTOCOL_MPLS);
    prog_selection->packet_format_qualifier_1_mask = (0x7F);
    prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS2_ETH; /* Only two labels in stack */
    prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP;
    if (SOC_IS_ARADPLUS_AND_BELOW(unit)){
...
int arad_pp_dbal_tt_cam_mldp_overlay_after_recycle_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
     ...
     prog_selection->my_mac                           = 0x1;
     prog_selection->my_mac_mask                      = 0x0;
     prog_selection->packet_format_code_mask          = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE;/* 6b11_1000 */
...
int32 arad_pp_dbal_tt_cam_mpls_l2_l3_gal_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    ...
    prog_selection->packet_format_code                            = ARAD_PARSER_PFC_MPLS3_ETH; /* at least three labels in stack */
    prog_selection->packet_format_code_mask                       = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS1; and bit 5 that it is ethernet packet */
    prog_selection->in_pp_port_tt_profile                         = (SOC_PPC_PORT_DEFINED_TT_PROFILE_EXPLICIT_NULL);
    prog_selection->in_pp_port_tt_profile_mask                    = (0x0);
    prog_selection->tcam_lookup_match                             = (0x1);
...
int32 arad_pp_dbal_tt_cam_mpls_index_as_order_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 function)
{
    ...
    switch(function)
    {
        case 1:
            prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS3_ETH; /* At least 3 labels */
            prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
            prog_selection->isa_lookup_found              = (0x1); /*VT Sem A match*/
            prog_selection->isa_lookup_found_mask    = (0x0);
            break;
        case 2:
            prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS2_ETH; /* 2 labels */
            prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
            prog_selection->isa_lookup_found              = (0x1);/*VT Sem A match*/
            prog_selection->isa_lookup_found_mask    = (0x0);
            break;
        case 3:
            prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS2_ETH; /* At least 2 labels */
            prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_AT_LEAST_MPLS2; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
            prog_selection->isa_lookup_found              = (0x0);/*VT Sem A miss*/
            prog_selection->isa_lookup_found_mask    = (0x0);
            break;
        case 4:
            prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS1_ETH; /* 1 labels */
            prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
            prog_selection->isa_lookup_found              = (0x0);
            prog_selection->isa_lookup_found_mask    = (0x0);
            break;
        case 5:
            prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS1_ETH; /* At least 3 labels */
            prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
            prog_selection->isa_lookup_found              = (0x1);
            prog_selection->isa_lookup_found_mask    = (0x0);
            break;
...
int32 arad_pp_dbal_tt_cam_mpls_index_as_order_l1_l2_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 label_num)
{
    ...
    if (label_num == 2) {
        ...
        prog_selection->packet_format_code             = ARAD_PARSER_PFC_MPLS2_ETH; /* 1 labels */
        prog_selection->packet_format_code_mask        = ARAD_PARSER_PFC_MATCH_ANY_ENCAP; /* ignore only 3:4 bits as 0:2 tell us about MPLS3; and bit 5 that it is ethernet packet */
    }
...
int32 arad_pp_dbal_tt_cam_pppoe_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    ...
    /* New field(enable_routing) for Jericho_plus and above device */
    prog_selection->enable_routing_mask             = 0x1;
...
{
    prog_selection->packet_format_code           = ARAD_PARSER_PFC_IPV6_ETH;/*6b00_0011; (should catch IHP_PFC_PART_IPV4 (3b???,3b010) or IHP_PFC_PART_IPV6 (3b???,3b011)*/
    if(g_prog_soc_prop[unit].ipv4mc_bidir_enable)
        prog_selection->packet_format_code_mask  = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE;
    else
        prog_selection->packet_format_code_mask  = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE_ANY_IP;
...
int32 arad_pp_dbal_tt_cam_tunnel_for_two_explicit_null_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection,int next_line, uint32 unused)
{
    ...
    prog_selection->packet_format_code_mask = ARAD_PARSER_PFC_MATCH_ANY_ENCAP_ANY_TYPE; /* I think that may ARAD_PARSER_PFC_MATCH_ANY_ENCAP is more appropriate */
	prog_selection->packet_format_qualifier_2       = (0x0); 
	prog_selection->packet_format_qualifier_2_mask  = (0x7EB); /* Two/three explicit NULL and next is Tunnels */
