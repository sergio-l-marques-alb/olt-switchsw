...
int ramon_hard_reset(int unit, int block_instance, uint32 en_interrupt, char *msg)
{
    ...
    rc = dnxc_interrupt_handles_corrective_action(unit, block_instance, en_interrupt, msg, DNXC_INT_CORR_ACT_SOFT_RESET, NULL, NULL);
    SHR_IF_ERR_EXIT(rc);
...
void ramon_interrupt_cb_init(int unit)
{
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_CCH_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_LCM_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_RTP_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_MCT_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_QRH_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_DCML_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_DCH_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_FSRD_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_ECI_ECC_PARITY_ERR_INT, 0, 0, ramon_intr_parity_handler, ramon_intr_parity_recurr, "Check Configuration");
