...
/*
 * Function:
 *      soc_ramon_fabric_link_status_all_get
 * Purpose:
 ...
 */
shr_error_e
soc_ramon_fabric_link_status_all_get(int unit, int links_array_max_size, uint32* link_status, uint32* errored_token_count, int* links_array_count)
{
    int i, rc;
    SHR_FUNC_INIT_VARS(unit);
    ...
    for(i=0 ; i<dnxf_data_port.general.nof_links_get(unit) && i<links_array_max_size; i++ ) {
