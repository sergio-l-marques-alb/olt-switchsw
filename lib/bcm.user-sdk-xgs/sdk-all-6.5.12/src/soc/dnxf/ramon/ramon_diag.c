...
{
    int nof_pipes, pipe_idx, block_idx, dfl_bank_idx, link_group_idx, dtm_fifo_idx, sub_bank_idx;
    ...
    soc_field_t dtm_per_dtm_fifo_field_list[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_DTM_FIFOS] = {DTM_DCH_0_MAX_OCUP_P_Nf, DTM_DCH_1_MAX_OCUP_P_Nf, DTM_DCH_2_MAX_OCUP_P_Nf, DTM_DCH_3_MAX_OCUP_P_Nf,
                                                                                 DTM_DCH_4_MAX_OCUP_P_Nf, DTM_DCH_5_MAX_OCUP_P_Nf, DTM_DCH_6_MAX_OCUP_P_Nf, DTM_DCH_7_MAX_OCUP_P_Nf}; 
    ...
    for (pipe_idx = 0;  pipe_idx < nof_pipes ; pipe_idx++)
    {
        ...
        {
            SHR_IF_ERR_EXIT(READ_LCM_DTM_MAX_OCUP_Pr(unit, block_idx, pipe_idx, reg_above_64_val));
            for (dtm_fifo_idx = 0; dtm_fifo_idx < dnxf_data_device.blocks.nof_dtm_fifos_get(unit); dtm_fifo_idx++)
            {
                fe_queues_info->dtm_queues_info[pipe_idx].nof_dtm[block_idx].fifo_max_occupancy_value[dtm_fifo_idx] = soc_reg_above_64_field32_get(unit, LCM_DTM_MAX_OCUP_Pr, reg_above_64_val, dtm_per_dtm_fifo_field_list[dtm_fifo_idx]);
            }
        }
    }
    /* DTM Queues
