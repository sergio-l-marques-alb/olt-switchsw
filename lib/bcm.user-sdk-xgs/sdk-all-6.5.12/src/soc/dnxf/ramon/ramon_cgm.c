...
/*The below small arrays are register description: name of register and its fields
  --------------------------------------------------------------------------------*/
static const soc_dnxf_cgm_registers_table_t LCM_DTM_ADMIT_TAG_TH_PROFILE_description[] = {
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DFL_PIPE_CLASS_SHARED_ADMIT_TH_METHOD_X_description[] = {  /*X means it includes both method 1 and method 2*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_ADMIT_XLR_TAG_TH_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_ADMIT_XLR_FRAG_TH_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_GCI_TAG_TH_XLR_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_GCI_FRAG_TH_XLR_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DFL_GCI_TH_METHOD_X_description[] = {  /*X means it includes both method 1 and method 2*/
    /*soc_reg_t,                                        soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_RCI_TAG_TH_XLR_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_RCI_FRAG_TH_XLR_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                          soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DFL_RCI_TH_METHOD_X_description[] = {  /*X means it includes both method 1 and method 2*/
    /*soc_reg_t,                                        soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DFL_FC_TH_METHOD_X_description[] = {  /*X means it includes both method 1 and method 2*/
    /*soc_reg_t,                                        soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_TAG_TH_XLR_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                         soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_FRAG_TH_XLR_PROFILE_description[] = {                 /*XLR means it includes both LR and NLR*/
    /*soc_reg_t,                                         soc_field_t*/
...
static const soc_dnxf_cgm_registers_table_t LCM_DTL_FIFO_DEPTH_TYPE_description[] = {
    /*soc_reg_t,                                          soc_field_t*/
    {LCM_DTL_FIFOS_DEPTH_TYPEr,                           {DTL_FIFO_DEPTH_P_0_TYPE_Nf,       DTL_FIFO_DEPTH_P_1_TYPE_Nf,       DTL_FIFO_DEPTH_P_2_TYPE_Nf }},
    {LCM_LCM_REGISTER_5r,                                 {FIELD_0_12f,                      FIELD_13_25f,                      FIELD_26_38f }},/*NLR*/
    {LCM_LCLRT_FIFOS_DEPTH_TYPEr,                         {DTL_LCLRT_FIFO_DEPTH_P_0_TYPE_Nf, DTL_LCLRT_FIFO_DEPTH_P_1_TYPE_Nf, DTL_LCLRT_FIFO_DEPTH_P_2_TYPE_Nf }},
    {LCM_LCM_REGISTER_6r,                                 {FIELD_0_12f,                      FIELD_13_25f,                      FIELD_26_38f }}/*LR*/
};

static const soc_dnxf_cgm_registers_table_t LCM_DTM_FIFO_DEPTH_TYPE_description[] = {
    /*soc_reg_t,                                          soc_field_t*/
    {LCM_DTM_FIFOS_DEPTH_TYPEr,                           {DTM_FIFO_DEPTH_P_0_TYPE_Nf, DTM_FIFO_DEPTH_P_1_TYPE_Nf }},
    {LCM_LCM_REGISTER_4r,                                 {FIELD_0_12f,                FIELD_16_28f,                 FIELD_32_44f }},
};
...
static const soc_dnxf_cgm_registers_table_t DCH_FIFOS_DEPTH_TYPE_description[] = {
    /*soc_reg_t,                                         soc_field_t*/
    {DCH_FIFOS_DEPTH_TYPEr,                              {FIFO_DEPTH_P_0_TYPE_Nf, FIFO_DEPTH_P_1_TYPE_Nf, FIFO_DEPTH_P_2_TYPE_Nf}},
};
...
const soc_dnxf_cgm_threshold_to_reg_binding_t ramon_soc_cgm_threshold_to_register_table[] = {
    /*threshold_type,                              th_handle_case               nof_registers_to_write_to    reg_description_ptr                                       action_required*/
    {_SHR_FABRIC_MID_TAG_DROP_CLASS_TH,            soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_ADMIT_TAG_TH_PROFILE_description,                  0},
    {_SHR_FABRIC_TX_LINK_LOAD_DROP_PIPE_TH,        soc_dnxf_cgm_reg_structure_1,      1,                  LCM_LINK_TH_FRAG_DROP_PROFILE_description,                 0},
    {_SHR_FABRIC_TX_FRAG_GUARANTEED_PIPE_TH,       soc_dnxf_cgm_reg_structure_1,      1,                  LCM_LINK_TH_GRNT_FRAG_PROFILE_description,                 0},
    {_SHR_FABRIC_SHARED_DROP_CLASS_TH,             soc_dnxf_cgm_reg_structure_1,      2,                  LCM_DFL_PIPE_CLASS_SHARED_ADMIT_TH_METHOD_X_description,   0}, /*X means it includes both method 1 and method 2*/
    {_SHR_FABRIC_SHARED_MC_COPIES_DROP_PRIO_TH,    soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_MC_COPIES_ADMIT_THRESHOLDS_description,            0},
    {_SHR_FABRIC_MID_FRAG_DROP_CLASS_TH,           soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_ADMIT_FRAG_TH_PROFILE_description,                 0},
    {_SHR_FABRIC_SHARED_BANK_MC_DROP_PRIO_TH,      soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_BANKS_MC_DROP_TH_description,                      0},
    {_SHR_FABRIC_TX_TAG_DROP_CLASS_TH,             soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_ADMIT_XLR_TAG_TH_PROFILE_description,              0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_DROP_CLASS_TH,            soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_ADMIT_XLR_FRAG_TH_PROFILE_description,             0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_TAG_GCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_GCI_TAG_TH_XLR_PROFILE_description,                0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_GCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_GCI_FRAG_TH_XLR_PROFILE_description,               0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_MID_TAG_GCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_GCI_TAG_TH_PROFILE_description,                    0},
    {_SHR_FABRIC_MID_FRAG_GCI_PIPE_TH,             soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_GCI_FRAG_TH_PROFILE_description,                   0},
    {_SHR_FABRIC_SHARED_GCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_GCI_TH_METHOD_X_description,                       0}, /*X means it includes both method 1 and method 2*/
    {_SHR_FABRIC_SHARED_FRAG_COPIES_GCI_PIPE_TH,   soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_GCI_COPIES_THRESHOLDS_description,                 0},
    {_SHR_FABRIC_TX_FRAG_GUARANTEED_RCI_PIPE_TH,   soc_dnxf_cgm_reg_structure_1,      1,                  LCM_LINK_RCI_GRNT_TH_PROFILE_description,                  0},
    {_SHR_FABRIC_TX_LINK_LOAD_RCI_PIPE_TH,         soc_dnxf_cgm_reg_structure_1,      1,                  LCM_LINK_RCI_TOTAL_TH_PROFILE_description,                 0},
    {_SHR_FABRIC_TX_TAG_RCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_RCI_TAG_TH_XLR_PROFILE_description,                0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_RCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_2,      1,                  LCM_DTL_RCI_FRAG_TH_XLR_PROFILE_description,               0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_MID_TAG_RCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_RCI_TAG_TH_PROFILE_description,                    0},
    {_SHR_FABRIC_MID_FRAG_RCI_PIPE_TH,             soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_RCI_FRAG_TH_PROFILE_description,                   0},
    {_SHR_FABRIC_SHARED_RCI_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DFL_RCI_TH_METHOD_X_description,                       0}, /*X means it includes both method 1 and method 2*/
    {_SHR_FABRIC_MID_MC_COPIES_FC_PRIO_TH,         soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_COPIES_RTP_FC_THRESHOLDS_description,              0},
    {_SHR_FABRIC_MID_TAG_FC_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_FC_TAG_TH_PROFILE_description,                     0},
    {_SHR_FABRIC_MID_FRAG_FC_PIPE_TH,              soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_FC_FRAG_TH_PROFILE_description,                    0},
    {_SHR_FABRIC_SHARED_FC_PIPE_TH,                soc_dnxf_cgm_reg_structure_1,      2,                  LCM_DFL_FC_TH_METHOD_X_description,                        0}, /*X means it includes both method 1 and method 2*/
    {_SHR_FABRIC_TX_TAG_FC_PIPE_TH,                soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_TAG_TH_XLR_PROFILE_description,                    0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_TX_FRAG_FC_PIPE_TH,               soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTL_FRAG_TH_XLR_PROFILE_description,                   0}, /*XLR means it includes both LR and NLR*/
    {_SHR_FABRIC_MID_MASK_FC_PIPE_TH,              soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_FC_TH_PROFILE_description,                         0},
    {_SHR_FABRIC_TX_FE1_BYPASS_LLFCFC_PIPE_TH,     soc_dnxf_cgm_reg_structure_1,      1,                  LCM_LINK_FC_TH_PROFILE_description,                        0},
    {_SHR_FABRIC_TX_FIFO_SIZE_PIPE_TH,             soc_dnxf_cgm_reg_structure_1,      2,                  LCM_DTL_FIFO_DEPTH_TYPE_description,                       (SOC_DNXF_CGM_ACTION_APPLY_SOFT_RESET | SOC_DNXF_CGM_ACTION_APPLY_OFFSET)},
    {_SHR_FABRIC_MID_FIFO_SIZE_PIPE_TH,            soc_dnxf_cgm_reg_structure_1,      1,                  LCM_DTM_FIFO_DEPTH_TYPE_description,                       (SOC_DNXF_CGM_ACTION_APPLY_SOFT_RESET | SOC_DNXF_CGM_ACTION_APPLY_OFFSET)},
    {_SHR_FABRIC_RX_FRAG_DROP_PIPE_TH,             soc_dnxf_cgm_reg_structure_2,      1,                  DCH_LINK_LEVEL_FLOW_CONTROL_description,                   0},/* DCH Thresholds*/ /*This is a special case*/
    {_SHR_FABRIC_RX_FRAG_GCI_PIPE_TH,              soc_dnxf_cgm_reg_structure_3,      1,                  DCH_LOCAL_GCI_TYPE_0_P_1_P_description,                    0},
    {_SHR_FABRIC_RX_LLFCFC_PIPE_TH,                soc_dnxf_cgm_reg_structure_4,      1,                  DCH_LINK_LEVEL_FLOW_CONTROL_P_X_description,               0},/*P_X means it includes all pipes*/
    {_SHR_FABRIC_RX_FIFO_SIZE_PIPE_TH,             soc_dnxf_cgm_reg_structure_1,      1,                  DCH_FIFOS_DEPTH_TYPE_description,                          SOC_DNXF_CGM_ACTION_APPLY_SOFT_RESET},
    {_SHR_FABRIC_RX_WFQ_DYNAMIC_WEIGHT_PIPE_TH,    soc_dnxf_cgm_reg_structure_1,      1,                  DCH_WFQ_DYN_WEIGHT_THD_description,                        0},
    {_SHR_FABRIC_MID_WFQ_DYNAMIC_WEIGHT_PIPE_TH,   soc_dnxf_cgm_reg_structure_1,      1,                  DTM_WFQ_DYN_WEIGHT_THD_description,                        0},
    {_SHR_FABRIC_TX_WFQ_DYNAMIC_WEIGHT_PIPE_TH,    soc_dnxf_cgm_reg_structure_1,      1,                  DTL_WFQ_DYN_WEIGHT_THD_description,                        0}
};

/*Function to return a pointer to the table with Ramon specific regiter information*/
    ...
    soc_port_t* links)
{
    ...
    /* All validity checks were done in the BCM layer*/
    for (ii = 0; ii<links_count ; ii++)
    {
        link=links[ii];

        /* Following funtction translates the logical link number to sections of 24 inner_links * block ID
            Example_1: Link 8 will be translated to blk_id=0 and inner_link=8
            Example_2: Link 191 will be translated to blk_id=8 and inner_link=24
            Example_3: Link 24 will be translated to blk_id=1 and inner_link=0
        */
        SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_drv_link_to_block_mapping, (unit, link, &blk_id, &inner_link, SOC_BLK_DCH)));

        /*Setting same profile to both DCH and DCL*/
        if (profile_id == 0)
        {
    ...
    soc_port_t *links)
{
    ...
    /*Read all the relevant registers */
    /*Assuming profiles over DCH and DCL are synced (checking DCH only*/
    for (blk_id = 0; blk_id < dnxf_data_device.blocks.nof_instances_dch_get(unit); blk_id++)
    {
       SHR_IF_ERR_EXIT(soc_reg32_get(unit, LCM_LINK_TH_PROFILES_MAPPINGr, blk_id, 0, &regs_values_link_th_profiles_mapping[blk_id]));
    }
    ...
    SOC_PBMP_ITER(SOC_INFO(unit).sfi.bitmap, link)
    {
        ...
        */
        ...
        {
            actual_profile = 1;/*Profile 1*/
        } else {
            actual_profile = 0;/*Profile 0*/
        }
...
/*
 *  \brief - Set value to RCI table
 *
 * RCI Table Maps 4-bits key of (Shared-RCI-level, Guaranteed-link-RCI-level) to 2-bits new RCI level.
 * RCI Table is 32 bit in total, each 2 bits related to each key:
 *                                  Key       Bits        Key       Bits       Key       Bits        Key       Bits
 *                                  (0,0) --> [1:0]    |  (0,1) --> [3:2]    | (0,2) --> [5:4]    |  (0,3) --> [7:6]
 *                                  (1,0) --> [9:8]    |  (1,1) --> [11:10]  | (1,2) --> [13:12]  |  (1,3) --> [15:14]
 *                                  (2,0) --> [17:16]  |  (2,1) --> [19:18]  | (2,2) --> [21:20]  |  (2,3) --> [23:22]
 *                                  (3,0) --> [25:24]  |  (3,1) --> [27:26]  | (3,2) --> [29:28]  |  (3,3) --> [31:30]
 * */
...
/*
 *  \brief - Get value from RCI table
 *
 * See soc_ramon_cgm_rci_resolution_set for table structure
 * */
