...
soc_ramon_fabric_links_validate_link(int unit, soc_port_t link) {
    ...
    if (link < 0 || link >= nof_links || !(SOC_PBMP_MEMBER(pbmp_valid, link))) {
...
soc_ramon_fabric_link_repeater_enable_set(int unit, soc_port_t port, int enable)
{
    ...
    soc_reg64_field32_set(unit, FMAC_GENERAL_CONFIGURATION_REGISTERr, &reg64_val, GENERAL_CONFIGURATION_REGISTER_FIELD_0f, include_empties);
