    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_access_define_mdio_int_out_delay_default].name = "mdio_int_out_delay_default";
    submodule_data->defines[dnxf_data_device_access_define_mdio_int_out_delay_default].doc = "Default in out delay of the MDIO interface";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_access_define_mdio_int_out_delay_default].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnxf_data_device_access_define_schan_timeout_usec].name = "schan_timeout_usec";
    submodule_data->defines[dnxf_data_device_access_define_schan_timeout_usec].doc = "Schan operation done is interrupt driven or by polling.";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_access_define_schan_timeout_usec].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnxf_data_device_access_define_schan_intr_enable].name = "schan_intr_enable";
    submodule_data->defines[dnxf_data_device_access_define_schan_intr_enable].doc = "Schan operation done is interrupt driven or by polling.";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_access_define_schan_intr_enable].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnxf_data_device_access_define_miim_timeout_usec].name = "miim_timeout_usec";
    submodule_data->defines[dnxf_data_device_access_define_miim_timeout_usec].doc = "MIM operation timeout.";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_access_define_miim_timeout_usec].flags |= DNXC_DATA_F_NUMERIC;
 ...
 */
uint32
dnxf_data_device_access_mdio_int_out_delay_default_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_access, dnxf_data_device_access_define_mdio_int_out_delay_default);
}
...
uint32
dnxf_data_device_access_schan_timeout_usec_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_access, dnxf_data_device_access_define_schan_timeout_usec);
}

uint32
dnxf_data_device_access_schan_intr_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_access, dnxf_data_device_access_define_schan_intr_enable);
}

uint32
dnxf_data_device_access_miim_timeout_usec_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_access, dnxf_data_device_access_define_miim_timeout_usec);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_interrupts_define_intr_all_disable].name = "intr_all_disable";
    submodule_data->defines[dnxf_data_device_interrupts_define_intr_all_disable].doc = "Are all interrupts disabled by soc property.";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_interrupts_define_intr_all_disable].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnxf_data_device_interrupts_intr_all_disable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_interrupts, dnxf_data_device_interrupts_define_intr_all_disable);
}
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_sprintf(buffer, "%s", data->property == NULL ? "" : data->property);
            break;
        case 1:
            sal_sprintf(buffer, "%s", data->suffix == NULL ? "" : data->suffix);
            break;
        case 2:
            sal_sprintf(buffer, "%d", data->num_max);
            break;
        case 3:
            sal_sprintf(buffer, "%d", data->per_port);
            break;
        case 4:
            sal_sprintf(buffer, "%s", data->err_msg == NULL ? "" : data->err_msg);
            break;
    }
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_ha_define_warmboot].name = "warmboot";
    submodule_data->defines[dnxf_data_device_ha_define_warmboot].doc = "specify if unit should support wb";
    /* Set data type flag */
    submodule_data->defines[dnxf_data_device_ha_define_warmboot].flags |= DNXC_DATA_F_NUMERIC;
 ...
 */
uint32
dnxf_data_device_ha_warmboot_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_ha, dnxf_data_device_ha_define_warmboot);
}
