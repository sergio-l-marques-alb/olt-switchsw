/*
 * $Id: sbZfFabBm9600InaHi4Selected_0Entry.c,v 1.2 Broadcom SDK $
...
uint32
sbZfFabBm9600InaHi4Selected_0Entry_Pack(sbZfFabBm9600InaHi4Selected_0Entry_t *pFrom,
                                        uint8 *pToData,
                                        uint32 nMaxToDataIndex) {
#ifdef SAND_BIG_ENDIAN_HOST
  int i;
  int size = SB_ZF_FAB_BM9600_INAHI4SELECTED_0ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_INAHI4SELECTED_0ENTRY_SIZE_IN_BYTES;
}
...
void
sbZfFabBm9600InaHi4Selected_0Entry_Unpack(sbZfFabBm9600InaHi4Selected_0Entry_t *pToStruct,
                                          uint8 *pFromData,
                                          uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfFabBm9600InaHi4Selected_0Entry_InitInstance(sbZfFabBm9600InaHi4Selected_0Entry_t *pFrame) {
