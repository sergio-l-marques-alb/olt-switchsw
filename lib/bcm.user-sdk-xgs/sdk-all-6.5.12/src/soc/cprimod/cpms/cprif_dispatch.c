...
__cprimod__dispatch__t__ cprimod_cprif_driver = {
    ...
    cprif_encap_memroy_clear,
    cprif_cpri_rx_framer_state_clear,
    cprif_decap_memroy_clear,
    ...
    cprif_tx_framer_tgen_next_bfn_set,
    cprif_tx_framer_tgen_next_bfn_get,
    cprif_tx_framer_tgen_next_hfn_set,
    cprif_tx_framer_tgen_next_hfn_get,
    ...
    NULL, /* cprimod_port_rsvd4_tx_overide_set */
    NULL, /* cprimod_port_rsvd4_tx_overide_get */
