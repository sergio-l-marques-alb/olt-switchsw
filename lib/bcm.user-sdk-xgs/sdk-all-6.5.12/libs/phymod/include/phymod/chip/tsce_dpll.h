...
int tsce_dpll_timesync_enable_set(const phymod_phy_access_t* phy, uint32_t enable);
int tsce_dpll_timesync_enable_get(const phymod_phy_access_t* phy, uint32_t* enable);

/*Set/Get timesync ts_offset*/
int tsce_dpll_timesync_offset_set(const phymod_core_access_t* core, uint32_t ts_offset);

/*Set timesync adjust*/
int tsce_dpll_timesync_adjust_set(const phymod_phy_access_t* phy, uint32_t ts_am_norm_mode);
