 ...
 */
#define _error(err_code) blackhawk_tsc_INTERNAL_print_err_msg(err_code)
 ...
 * @return Error Code
 */
err_code_t blackhawk_tsc_INTERNAL_print_err_msg(uint16_t err_code);
 ...
 */
char* blackhawk_tsc_INTERNAL_e2s_err_code(err_code_t err_code);
