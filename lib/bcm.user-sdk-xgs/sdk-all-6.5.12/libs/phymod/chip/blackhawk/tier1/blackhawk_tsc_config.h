 ...
 */
err_code_t blackhawk_tsc_version(uint32_t *api_version);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_ucode_load_verify(srds_access_t *sa__, uint8_t *ucode_image, uint16_t ucode_len);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_ucode_pram_load(srds_access_t *sa__, char const * ucode_image, uint16_t ucode_len);
...
/** For simulation - Initialize software information table
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_get_vco_from_refclk_div(uint32_t refclk_freq_hz, enum blackhawk_tsc_pll_div_enum div, uint32_t *vco_freq_khz, enum blackhawk_tsc_pll_option_enum pll_option);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_ext_loop_timing(srds_access_t *sa__, uint8_t enable);
