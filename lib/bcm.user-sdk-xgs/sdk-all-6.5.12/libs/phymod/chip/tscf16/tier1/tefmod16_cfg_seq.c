...
int tefmod16_autoneg_set(PHYMOD_ST* pc, tefmod16_an_adv_ability_t *cl73_adv)
{
  ...
  PHYMOD_IF_ERR_RETURN(READ_RX_X1_CL91_CFGr(pc, &RX_X1_CL91_CFGr_reg));
  if (cl73_adv->an_fec & TEFMOD16_FEC_CL74_SUPRTD_REQSTD) {
  ...
  if (cl73_adv->an_fec & TEFMOD16_FEC_CL91_SUPRTD_REQSTD) {
      ...
      /* Bypass error indication function */
      RX_X1_CL91_CFGr_FEC_BYP_IND_ENf_SET(RX_X1_CL91_CFGr_reg, 1);
      /* Perform error detection along with correction */
      RX_X1_CL91_CFGr_FEC_BYP_CORR_ENf_SET(RX_X1_CL91_CFGr_reg, 0);
  }
...
int tefmod16_autoneg_control(PHYMOD_ST* pc, tefmod16_an_control_t *an_control)
{
 ...
 if (an_control->enable) {
  ...
  /* Autoneg is disabled, set Bypass error indication to default value */
  if (an_control->enable == 0) {
      ...
      if (!RX_X4_PCS_CTL0r_CL91_FEC_MODEf_GET(RX_X4_PCS_CTL0r_reg) &&
          !TX_X4_TX_CTL0r_CL91_FEC_MODEf_GET(TX_X4_TX_CTL0r_reg)) {
          RX_X1_CL91_CFGr_FEC_BYP_IND_ENf_SET(RX_X1_CL91_CFGr_reg, 0);
          RX_X1_CL91_CFGr_FEC_BYP_CORR_ENf_SET(RX_X1_CL91_CFGr_reg, 0);
          PHYMOD_IF_ERR_RETURN(MODIFY_RX_X1_CL91_CFGr(pc, RX_X1_CL91_CFGr_reg));
      }
  }
...
int tefmod16_FEC_control(PHYMOD_ST* pc, tefmod16_fec_type_t fec_type, int enable, int cl74or91)
{
  ...
  PHYMOD_IF_ERR_RETURN
      (READ_RX_X1_CL91_CFGr(pc, &RX_X1_CL91_CFGr_reg));
