...
multicast_ingress_remove(16781312, 10, 0x44801001);
multicast_ingress_remove(16781312, 11, 0x44801002);
vp_remove(0x44801001);
vp_remove(0x44801002);

vp_add(0x44801003 /*LIF gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, 0x0c000001 /*Trunk gport*/, 100 /*VLAN*/, 0, 0, 0
vswitch_add(4096, 0x44801003);

multicast_ingress_add(16781312, 0x0c000001, 0x44801003);
