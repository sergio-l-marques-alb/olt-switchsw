...
if (voqs) {
    vp_add(unit, vid_prt_gport[0] /*LIF1 gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, voqs_gport[0] /*Port1*/, vid /*VLAN*/, 0, 0, vsi, 0);
    vp_add(unit, vid_prt_gport[1] /*LIF2 gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, voqs_gport[1] /*Port2*/, vid /*VLAN*/, 0, 0, vsi, 0);
    vp_add(unit, vid_prt_gport[2] /*LIF3 gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, voqs_gport[2] /*Port3*/, vid /*VLAN*/, 0, 0, vsi, 0);
}
else {
    vp_add(unit, vid_prt_gport[0] /*LIF1 gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, p[0] /*Port1*/, vid /*VLAN*/, 0, 0, vsi, 0);
    vp_add(unit, vid_prt_gport[1] /*LIF2 gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, p[1] /*Port2*/, vid /*VLAN*/, 0, 0, vsi, 0);
    vp_add(unit, vid_prt_gport[2] /*LIF3 gport*/, 3 /*BCM_VLAN_PORT_MATCH_PORT_VLAN*/, p[2] /*Port3*/, vid /*VLAN*/, 0, 0, vsi, 0);
}
