...
# Cross-Compiler
#export TOOLCHAIN_BASE_DIR = /opt/gcc-linaro-4.9.4-2017.01-x86_64_aarch64-linux-gnu
#export TOOLCHAIN_BIN_DIR  = $(TOOLCHAIN_BASE_DIR)/bin
#export LD_LIBRARY_PATH    = $(TOOLCHAIN_BASE_DIR)/lib
#export TARGET_ARCHITECTURE= aarch64-linux-gnu
#COMPILER = $(TOOLCHAIN_BIN_DIR)/aarch64-linux-gnu-
#export KERNEL_PATH        = /mnt/lib/olt-switchsw/branches/switchdrvr-4.0/lib/kernel/linux-kernel-4.9.2_gcc-linaro-4.9.4

# Cross-Compiler
export TOOLCHAIN_BASE_DIR = /opt/gcc-linaro-7.2.1-2017.11-x86_64_aarch64-linux-gnu
export TOOLCHAIN_BIN_DIR  = $(TOOLCHAIN_BASE_DIR)/bin
export LD_LIBRARY_PATH    = $(TOOLCHAIN_BASE_DIR)/lib
export TARGET_ARCHITECTURE= aarch64-linux-gnu
export COMPILER           = $(TOOLCHAIN_BIN_DIR)/aarch64-linux-gnu-
export KERNEL_PATH        = /mnt/lib/olt-switchsw/branches/switchdrvr-4.0/lib/kernel/linux-kernel-4.9.2
...
all:
	gmake -j3 -C $(SRC_PATH)/$(PLATFORM_NAME)
