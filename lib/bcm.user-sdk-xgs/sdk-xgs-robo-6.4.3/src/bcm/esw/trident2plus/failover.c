 ...
 */
typedef struct _bcm_td2p_failover_bookkeeping_s {
...
} _bcm_td2p_failover_bookkeeping_t;

STATIC _bcm_td2p_failover_bookkeeping_t  
       _bcm_td2p_failover_bk_info[BCM_MAX_NUM_UNITS] = {{ 0 }};

#define FAILOVER_INFO(_unit_)   (&_bcm_td2p_failover_bk_info[_unit_])
