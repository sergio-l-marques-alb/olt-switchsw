...
typedef struct portmod_pfc_config_s {
    uint32 type; /**< PFC Type */
    uint32 opcode; /**< PFC Opcode */
    uint32 classes; /**< PFC Classes */
    uint32 da_oui; /**< PFC OUI */
    uint32 da_nonoui; /**< PFC Non OUI */
...
/*!
 * @enum portmod_txdrv_inxs_e
 * @brief txdrv enumeration  
 */ 
typedef enum portmod_txdrv_inxs_e {
    portmod_TXDRV_XFI_INX = 0,
    portmod_TXDRV_XLAUI_INX = 1,
    portmod_TXDRV_SFI_INX = 2,
    portmod_TXDRV_SFIDAC_INX = 3,
    portmod_TXDRV_SR4_INX = 4,
    portmod_TXDRV_AN_INX = 5,
    portmod_TXDRV_DFT_INX = 6,
    portmod_TXDRV_Count
} portmod_txdrv_inxs_t;

#ifdef PORTMOD_DIAG
extern enum_mapping_t portmod_txdrv_inxs_t_mapping[];
#endif /*PORTMOD_DIAG*/

/* portmod_txdrv_inxs_t validation */
int portmod_txdrv_inxs_t_validate(int unit, portmod_txdrv_inxs_t portmod_txdrv_inxs);
#define PORTMOD_TXDRV_ENTRY_NUM (portmod_TXDRV_Count)
...
/*!
 * @struct portmod_port_config_s
 * @brief port config information. 
 */ 
typedef struct portmod_port_config_s {
    ...
    phymod_tx_t tx_drive[PORTMOD_TXDRV_ENTRY_NUM];
    int pcs_table_override;
} portmod_port_config_t;

/* portmod_port_config_t initialization and validation */
int portmod_port_config_t_validate(int unit, const portmod_port_config_t* portmod_port_config);
int portmod_port_config_t_init(int unit, portmod_port_config_t* portmod_port_config);
 ...
 */ 
#define PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD 0x1 /**< The bus support modify functionality */
#define PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD 0x2 /**< The bus support direct lane configuration */
#define PORTMOD_PORT_ADD_F_FIRMWARE_LOAD_VERIFY 0x4 /**< Verify FW loaded correctly */

#define PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD_SET(info) ((info)->flags |= PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD)
#define PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD_SET(info) ((info)->flags |= PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD)
#define PORTMOD_PORT_ADD_F_FIRMWARE_LOAD_VERIFY_SET(info) ((info)->flags |= PORTMOD_PORT_ADD_F_FIRMWARE_LOAD_VERIFY)

#define PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD_CLR(info) ((info)->flags &= ~PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD)
#define PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD_CLR(info) ((info)->flags &= ~PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD)
#define PORTMOD_PORT_ADD_F_FIRMWARE_LOAD_VERIFY_CLR(info) ((info)->flags &= ~PORTMOD_PORT_ADD_F_FIRMWARE_LOAD_VERIFY)

#define PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD_GET(info) ((info)->flags & PORTMOD_PORT_ADD_F_INIT_UNTIL_FW_LOAD ? 1 : 0)
#define PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD_GET(info) ((info)->flags & PORTMOD_PORT_ADD_F_INIT_RESUME_AFTER_FW_LOAD ? 1 : 0)
 ...
 */
int portmod_port_phy_reg_read(int unit, int port, int flags, int* value);
 ...
 * @param [in]  value           - 
 */
int portmod_port_phy_reg_write(int unit, int port, int flags, int value);
...
/*! 
 * portmod_port_adv_local_set
 *
 * @brief Port Adv Local functions 
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  val             - 
 */
int portmod_port_adv_local_set(int unit, int port, int val);
/*! 
 * portmod_port_adv_local_get
 *
 * @brief Port Adv Local functions 
 *
 * @param [in]  unit            - unit id
 ...
 * @param [out]  val             - 
 */
int portmod_port_adv_local_get(int unit, int port, int* val);
 ...
 *
 * @brief Port ability remote Adv Local get 
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [out]  name            - 
 ...
 * @param [in]  ability         - 
 */
int portmod_port_ability_adv_set(int unit, int port, const portmod_port_ability_t* ability);
/*! 
 * portmod_port_ability_adv_get
 *
 * @brief get port auto negotiation local ability 
 *
 * @param [in]  unit            - unit id
 ...
 * @param [in]  ability         - 
 */
int portmod_port_ability_adv_get(int unit, int port, const portmod_port_ability_t* ability);

/*! 
 * portmod_port_ability_adv_remote_get
 *
 ...
 * @param [in]  ability         - 
 */
int portmod_port_ability_adv_remote_get(int unit, int port, const portmod_port_ability_t* ability);
 ...
 * @param [in]  eee             - 
 */
int portmod_port_eee_get(int unit, int port, const portmod_eee_t* eee);
 ...
 * @param [in]  vlan_tag        - 
 */
int portmod_port_vlan_tag_get(int unit, int port, const portmod_vlan_tag_t* vlan_tag);

/*! 
 * portmod_ext_phy_attach
 *
 * @brief Attaches an external phy to a phy chain 
 *
 * @param [in]  unit            - unit id
 * @param [in]  phy             - internal phy index representing the starting point of a phy chain
 * @param [in]  ext_phy_access   - external phy core access entry
 */
int portmod_ext_phy_attach(int unit, int phy, const phymod_core_access_t* ext_phy_access);

/*! 
 * portmod_ext_phy_detach
 *
 * @brief Detaches the last external phy from a phy chain 
 *
 * @param [in]  unit            - unit id
 * @param [in]  phy             - internal phy index representing the starting point of a phy chain
 */
int portmod_ext_phy_detach(int unit, int phy);
