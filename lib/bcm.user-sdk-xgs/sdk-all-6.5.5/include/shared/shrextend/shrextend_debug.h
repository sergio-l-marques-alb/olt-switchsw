...
{ \
  LOG_ERROR(BSL_LOG_MODULE,          \
    (BSL_META_U(_func_unit," Error '%s' indicated, " _formatting_string "%s"), shrextend_errmsg_get(_expr), ##__VA_ARGS__) ) ; \
  _func_rv = _expr ;    \
  SHR_EXIT() ;        \
...
/*!
 * \brief This is only a 'prelude' for the main macro \ref _SHR_ERR_EXIT and
