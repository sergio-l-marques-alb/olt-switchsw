...
/*
  ...
  /*
   *  Port support PP port based mpls port termination
   */

  SOC_PPC_PORT_DEFINED_VT_PORT_TERMINATION_MPLS = 8,
...
/*
  ...
  SOC_PPC_PORT_DEFINED_TT_PROFILE_PORT_TERMINATION_MPLS = 6,
