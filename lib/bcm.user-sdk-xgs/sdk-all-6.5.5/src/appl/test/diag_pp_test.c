...
diag_pp_pkt_tm_info_bridge_test(int unit, int src_id, int dest_id, int core_id) {
    ...
    expected_pkt_tm_info.eth_meter_ptr = src_id*5 + 1; /* 5 meters associated with each port */
...
diag_pp_frwrd_lkup_info_router_test(int unit, int core_id)
{
    ...
    expected_frwrd_lkup_info.key_found = 1;
    expected_frwrd_lkup_info.lkup_res.host_info.frwrd_decision.dest_id = (SOC_IS_JERICHO(unit)) ? 4096 : 1024;
