...
STATIC int soc_qax_init_overrides_0(int unit)
{
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_SCH_SBUS_BROADCAST_IDr(unit, REG_PORT_ANY, 0x7f));
...
/*#endif QAX_MASK_NIF_OVERRIDES*/
    ...
    /* set RTP_MULTICAST_DISTRIBUTION_CONFIGURATIONr */
    SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, RTP_MULTICAST_DISTRIBUTION_CONFIGURATIONr, REG_PORT_ANY, 0, above64));
    ...
    soc_reg_above_64_field32_set(unit, RTP_MULTICAST_DISTRIBUTION_CONFIGURATIONr, above64, ALRC_MIN_NUM_OF_LINKSf, 0);
    /* ENABLE_MCL_UPDATESf is set to 1 in arad_fabric_common_regs_init (was set to 0 here but it didn't impact). It's set to 1 in Jericho also*/
    /* MAX_ALRC_BASE_INDEXf should have the default HW value (0xf) */
...
STATIC int soc_qax_init_overrides_5(int unit)
{
    ...
    /* set EGQ_GENERAL_RQP_CONFIGr */
    SOC_REG_ABOVE_64_CLEAR(above64);
    soc_reg_above_64_field32_set(unit, EGQ_GENERAL_RQP_CONFIGr, above64, RCM_MODEf, 2);
    if (SOC_IS_QUX(unit)) {
        soc_reg_above_64_field32_set(unit, EGQ_GENERAL_RQP_CONFIGr, above64, PACKET_SIZE_FILTER_ENf, 1);
    } else {
    ...
    /* set EGQ_GENERAL_RQP_DEBUG_CONFIGr */
    if (!SOC_IS_QUX(unit)) {
        SOC_REG_ABOVE_64_CLEAR(above64);
...
STATIC int soc_qax_init_overrides_6(int unit)
{
    ...
    SOC_REG_ABOVE_64_CLEAR(above64); /* set SPB_DYNAMIC_CONFIGURATIONr */
    soc_reg_above_64_field32_set(unit, SPB_DYNAMIC_CONFIGURATIONr, above64, SOC_IS_QUX(unit)?MAX_BUFFERS_THRESHOLDf:FIELD_1_6f, 0x30);
...
soc_qax_dqcf_contexts_init(int unit)
{
    ...
    /* Override the default value of PTS_PDQ_OVTH_FC_MASKr */
    SOC_REG_ABOVE_64_CLEAR(above64);
