...
int soc_jer_plus_prd_hard_stage_enable_get(int unit, int port, uint32 *en_mask)
{
    ...
    {
        int reg_port = (first_phy < 2*nof_lanes_nbi)? 0 : 1;
        SOCDNX_IF_ERR_EXIT(soc_reg32_get(unit, NBIH_PRD_ENr, reg_port, 0, en_mask));
    }
...
STATIC int
soc_jer_plus_prd_tpid_ilkn_set_get(int unit, int port, int tpid_index, uint16 *tpid_val, int to_set)
{
    uint32 offset, num_lanes;
    int reg_port;
    uint64 reg64_val;
...
STATIC int
soc_jer_plus_prd_tpid_qmlf_set_get(int unit, int port, int tpid_index, uint16 *tpid_val, int to_set)
{
...
STATIC int
soc_jer_plus_soft_stage_key_construct_ilkn_set_get(int unit, int port, int *key_build_offset_array, int to_set)
{
    uint32 offset, num_lanes;
    uint32 reg32_val;
    soc_reg_t reg;
...
STATIC int
soc_jer_plus_soft_stage_key_construct_qmlf_set_get(int unit, int port, int *key_build_offset_array, int to_set)
{
...
/*Per: QMLF or [ILKN0 and/or ILKN1]*/
int soc_jer_plus_soft_stage_key_construct_set(int unit, int port, int *key_build_offset_array)
{
    SOCDNX_INIT_FUNC_DEFS;
