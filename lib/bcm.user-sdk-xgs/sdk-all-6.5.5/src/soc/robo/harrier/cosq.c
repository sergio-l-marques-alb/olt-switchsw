    ...
    uint32 mode)
{
    ...
    SOC_IF_ERROR_RETURN(soc_QOS_CTLr_field_set
        (unit, (void *)&reg_value64, SCHEDULE_SELECTf, &temp));
...
drv_harrier_queue_count_set(int unit, uint32 port_type, uint8 count)
{
    ...
    temp = 1;
    SOC_IF_ERROR_RETURN(soc_QOS_CTLr_field_set
        (unit, (void *)&reg_value64, CPU_CTRL_ENf, &temp));

    /* Set queue number = 4 or 0 (disable) */
    num_q = (count - 1);
    SOC_IF_ERROR_RETURN(soc_QOS_CTLr_field_set
        (unit, (void *)&reg_value64, QOS_ENf, &num_q));
...
drv_harrier_queue_dfsv_set(int unit, uint8 code_point, uint8 queue_n)
{
    ...
    switch (t_code_point) {        
        ...
        case 16:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010000f, &temp));
            break;
        case 17:         
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010001f, &temp));
            break;
        case 18:         
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010010f, &temp));
            break;
        case 19:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010011f, &temp));
            break;
        case 20:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010100f, &temp));
            break;
        case 21:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010101f, &temp));
            break;
        case 22:        
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010110f, &temp));
            break;
        case 23:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_010111f, &temp));
            break;
        case 24:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011000f, &temp));
            break;
        case 25:         
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011001f, &temp));
            break;
        case 26:         
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011010f, &temp));
            break;
        case 27:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011011f, &temp));
            break;
        case 28:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011100f, &temp));
            break;
        case 29:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011101f, &temp));
            break;
        case 30:         
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011110f, &temp));
            break;
        case 31:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP1r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_011111f, &temp));
            break;
        default:
            return SOC_E_PARAM;
    }
