                ...
                int port, uint32 *led_mode)
{
    ...
    SOC_IF_ERROR_RETURN(
            REG_READ_LED_MODE_MAP_0r(unit, (void *)&mode64_val0));
    SOC_IF_ERROR_RETURN(
            REG_READ_LED_MODE_MAP_1r(unit, (void *)&mode64_val1));
    
    SOC_IF_ERROR_RETURN(soc_LED_MODE_MAP_0r_field_get
            (unit, (void *)&mode64_val0, LED_MODE_MAPf, 
            &fld32_val));
    temp0 = (fld32_val & (0x1 << port)) ? 1 : 0;
    
    SOC_IF_ERROR_RETURN(soc_LED_MODE_MAP_1r_field_get
            (unit,  (void *)&mode64_val1, LED_MODE_MAPf, 
            &fld32_val));
                ...
                int port, uint32 led_mode)
{
    ...
    SOC_IF_ERROR_RETURN(
            REG_WRITE_LED_MODE_MAP_0r(unit, (void *)&mode64_val0));
    SOC_IF_ERROR_RETURN(
            REG_WRITE_LED_MODE_MAP_1r(unit, (void *)&mode64_val1));
                ...
                int port, int *led_group)
{
    ...
    SOC_IF_ERROR_RETURN(
            REG_READ_LED_FUNC_MAPr(unit, (void *)&reg64_val));

    SOC_IF_ERROR_RETURN(soc_LED_FUNC_MAPr_field_get
            (unit, (void *)&reg64_val, LED_FUNC_MAPf, 
             (uint32 *)&fld32_val));
