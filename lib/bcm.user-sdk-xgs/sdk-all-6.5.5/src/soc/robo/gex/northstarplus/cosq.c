        ...
        switch (queue) {
            case 0:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q0_WEIGHTf, &temp));
                break;
            case 1:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q1_WEIGHTf, &temp));
                break;
            case 2:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q2_WEIGHTf, &temp));
                break;
            case 3:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q3_WEIGHTf, &temp));
                break;
            case 4:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q4_WEIGHTf, &temp));
                break;
            case 5:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q5_WEIGHTf, &temp));
                break;
            case 6:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q6_WEIGHTf, &temp));
                break;
            case 7:
                SOC_IF_ERROR_RETURN(soc_PN_QOS_WEIGHTr_field_set
                        (unit, (void *)&reg_value64, Q7_WEIGHTf, &temp));
                break;
            default:
                return SOC_E_PARAM;
        }
