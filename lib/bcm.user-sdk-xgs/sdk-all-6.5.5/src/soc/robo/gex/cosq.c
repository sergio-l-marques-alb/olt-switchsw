...
drv_gex_queue_dfsv_remap_set(int unit, uint8 dscp, uint8 prio)
{
    ...
    SOC_IF_ERROR_RETURN((DRV_SERVICES(unit)->reg_read)
        (unit, reg_addr, (void *)&reg_value, reg_len));

    temp = (uint32)prio;
    switch (dscp) {        
        case 0:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000000f, &temp));
            break;
        case 1:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000001f, &temp));
            break;
        case 2:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000010f, &temp));
            break;
        case 3:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000011f, &temp));
            break;
        case 4:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000100f, &temp));
            break;
        case 5:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000101f, &temp));
            break;
        case 6:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000110f, &temp));
            break;
        case 7:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_000111f, &temp));
            break;
        case 8:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001000f, &temp));
            break;
        case 9:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001001f, &temp));
            break;
        case 10:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001010f, &temp));
            break;
        case 11:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001011f, &temp));
            break;
        case 12:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001100f, &temp));
            break;
        case 13:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001101f, &temp));
            break;
        case 14:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001110f, &temp));
            break;
        case 15:
            SOC_IF_ERROR_RETURN(soc_QOS_DIFF_DSCP0r_field_set
                (unit, (void *)&reg_value, PRI_DSCP_001111f, &temp));
            break;            
    }
