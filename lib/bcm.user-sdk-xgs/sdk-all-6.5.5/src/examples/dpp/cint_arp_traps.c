...
arp_reply_with_mymac(unit,13,BCM_GPORT_LOCAL_CPU);
...
arp_request(unit,13,BCM_GPORT_LOCAL_CPU,1);
 
trap ARP request with TPA = MY-IP 
arp_reply_request_with_my_ip(unit,13,BCM_GPORT_LOCAL_CPU);
 
trap any ARP packet on specific incomming port
arp_request(unit,13,BCM_GPORT_LOCAL_CPU,0);
