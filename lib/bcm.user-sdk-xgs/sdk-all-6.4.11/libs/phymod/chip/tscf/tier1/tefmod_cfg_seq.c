...
int tefmod_autoneg_set(PHYMOD_ST* pc, tefmod_an_adv_ability_t *cl73_adv)
{
  ...
  if ((cl73_adv->an_bam_speed1 & 1 << TEFMOD_CL73_BAM_20GBASE_KR1) ||
      ...
      (cl73_adv->an_base_speed & 1 << TEFMOD_CL73_1GBASE_KX)) {
...
int tefmod_autoneg_lp_status_get(PHYMOD_ST* pc, uint16_t *baseP0, uint16_t *baseP1, uint16_t *baseP2, uint16_t *nextP1, uint16_t *nextP2) {
  AN_X4_LP_BASE1r_t   AN_X4_LP_BASE1r_reg;
  AN_X4_LP_BASE2r_t   AN_X4_LP_BASE2r_reg;
  AN_X4_LP_BASE3r_t   AN_X4_LP_BASE3r_reg;
  AN_X4_LP_OUI_UP2r_t AN_X4_LP_OUI_UP2r_reg;
  AN_X4_LP_OUI_UP3r_t AN_X4_LP_OUI_UP3r_reg;

  AN_X4_LP_BASE1r_CLR(  AN_X4_LP_BASE1r_reg);
  AN_X4_LP_BASE2r_CLR(  AN_X4_LP_BASE2r_reg);
  AN_X4_LP_BASE3r_CLR(  AN_X4_LP_BASE3r_reg);
  AN_X4_LP_OUI_UP2r_CLR(AN_X4_LP_OUI_UP2r_reg);
  AN_X4_LP_OUI_UP3r_CLR(AN_X4_LP_OUI_UP3r_reg);

  PHYMOD_IF_ERR_RETURN(READ_AN_X4_LP_BASE1r(pc,  &AN_X4_LP_BASE1r_reg));
  PHYMOD_IF_ERR_RETURN(READ_AN_X4_LP_BASE2r(pc,  &AN_X4_LP_BASE2r_reg));
  PHYMOD_IF_ERR_RETURN(READ_AN_X4_LP_BASE3r(pc,  &AN_X4_LP_BASE3r_reg));
  PHYMOD_IF_ERR_RETURN(READ_AN_X4_LP_OUI_UP2r(pc,&AN_X4_LP_OUI_UP2r_reg));
  PHYMOD_IF_ERR_RETURN(READ_AN_X4_LP_OUI_UP3r(pc,&AN_X4_LP_OUI_UP3r_reg));
  ...
  *nextP1 = AN_X4_LP_OUI_UP2r_GET(AN_X4_LP_OUI_UP2r_reg);
  *nextP2 = AN_X4_LP_OUI_UP3r_GET(AN_X4_LP_OUI_UP3r_reg);
