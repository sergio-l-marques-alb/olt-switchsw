...
/*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    {  "Ingress LIF bank allocation"          , "InLif"         , "IL"     , dpp_am_res_obs_inlif                      , NULL                              , cmd_diag_alloc_hw_lif_get_block   },
    {  "Egress encapsulation bank allocation" , "OutLif"        , "OL"     , dpp_am_res_obs_eg_encap                   , NULL                              , NULL                              },
    ...
    {  "OAM MEP Index for short MA name format", "OAM_MEPSort"   , "OAM_S"  , dpp_am_res_oam_mep_id_short               , NULL                              , NULL                             },
    ...
    {  "Local Common InLif"                    , "Common_Inlif"  , "LCLif"  , dpp_am_res_local_inlif_common             , NULL                              , NULL                             },
    {  "Local Wide InLif"                      , "Wide_Inlif"    , "LWLif"  , dpp_am_res_local_inlif_wide               , NULL                              , NULL                             },
    {  "Local OutLif"                          , "Local_Outlif"  , "LOLif"  , dpp_am_res_local_outlif                   , NULL                              , NULL                             },
...
cmd_result_t cmd_diag_alloc_my_in_counter_profile_test(int unit)
{
      ...
      rv = _bcm_dpp_am_local_outlif_counting_profile_set(unit, counter_profile,19000, 10000);
      if (rv != BCM_E_NONE) {
        return CMD_FAIL;
     }
