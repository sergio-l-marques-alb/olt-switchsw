...
/******************************************************************** 
 *  Function handler: glbl_info_set (section frwrd_ipv6)
 ********************************************************************/
int 
  ui_ppd_api_frwrd_ipv6_glbl_info_set(
...
{   
  ...
  soc_sand_proc_name = "soc_ppd_frwrd_ipv6_glbl_info_set"; 
 
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_IPV6_GLBL_INFO_clear(&prm_glbl_info);
  ...
  { 
    send_string_to_screen(" *** soc_ppd_frwrd_ipv6_glbl_info_get - FAIL", TRUE); 
    soc_sand_disp_result_proc(ret, "soc_ppd_frwrd_ipv6_glbl_info_get");   
    goto exit; 
  } 

  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_MC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_SNOOP_STRENGTH_ID,1)) 
  { 
    UI_MACROS_GET_NUMMERIC_VAL(SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_MC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_SNOOP_STRENGTH_ID);  
  ...
  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_MC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_FRWRD_STRENGTH_ID,1)) 
  { 
    UI_MACROS_GET_NUMMERIC_VAL(SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_MC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_FRWRD_STRENGTH_ID);  
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
  ...
  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_UC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_SNOOP_STRENGTH_ID,1)) 
  { 
    UI_MACROS_GET_NUMMERIC_VAL(SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_UC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_SNOOP_STRENGTH_ID);  
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
  ...
  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_UC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_FRWRD_STRENGTH_ID,1)) 
  { 
    UI_MACROS_GET_NUMMERIC_VAL(SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_GLBL_INFO_ROUTER_INFO_UC_DEFAULT_ACTION_VALUE_ACTION_PROFILE_FRWRD_STRENGTH_ID);  
    UI_MACROS_CHECK_GET_VAL_OF_ERROR; 
  ...
  /* Call function */
  ret = soc_ppd_frwrd_ipv6_glbl_info_set(
          unit,
          &prm_glbl_info
        );
  if (soc_sand_get_error_code_from_error_word(ret) != SOC_SAND_OK) 
  { 
    send_string_to_screen(" *** soc_ppd_frwrd_ipv6_glbl_info_set - FAIL", TRUE); 
    soc_sand_disp_result_proc(ret, "soc_ppd_frwrd_ipv6_glbl_info_set");   
    goto exit; 
  } 
...
/******************************************************************** 
 *  Function handler: glbl_info_get (section frwrd_ipv6)
 ********************************************************************/
int 
  ui_ppd_api_frwrd_ipv6_glbl_info_get(
    CURRENT_LINE *current_line 
  ) 
{   
  uint32 
  ...
  UI_MACROS_INIT_FUNCTION("ui_ppd_api_frwrd_ipv6"); 
  soc_sand_proc_name = "soc_ppd_frwrd_ipv6_glbl_info_get"; 
  ...
  SOC_PPD_FRWRD_IPV6_GLBL_INFO_print(&prm_glbl_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_IPV6_UC_ROUTE_KEY_clear(&prm_route_key);
  ...
  SOC_PPD_FRWRD_DECISION_INFO_clear(&info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_IPV6_MC_ROUTE_KEY_clear(&prm_route_key);
  SOC_PPD_FRWRD_IPV6_MC_ROUTE_INFO_clear(&prm_route_info);
  ...
  if (!get_val_of(
         ...
         &param_val,VAL_TEXT,err_msg)) 
  { 
    soc_sand_pp_ipv6_address_string_parse(param_val->value.val_text, &(prm_route_key.group));
  } 
  else 
  {    
...
{   
  ...
  SOC_PPD_FRWRD_IPV6_MC_ROUTE_INFO_print(&prm_route_info);
...
{   
  ...
  */
  ...
  while(!SOC_PPC_IP_ROUTING_TABLE_ITER_IS_END(&prm_block_range.start.payload))
  {
    ...
    {
      cli_out("|");
      soc_sand_SAND_PP_IPV6_ADDRESS_print(&prm_route_keys[i].group);
      
	    cli_out("      |%-7d", prm_route_keys[i].inrif.val);
      
      SOC_PPD_FRWRD_IPV6_MC_ROUTE_INFO_print(&prm_fec_ids[i]);
/*
      cli_out("|%-9s", SOC_PPD_FRWRD_IP_ROUTE_STATUS_to_string(prm_routes_status[i]));
      cli_out("|%-13s|", SOC_PPD_FRWRD_IP_ROUTE_LOCATION_to_string(prm_routes_location[i]));
*/
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_IPV6_VRF_INFO_clear(&prm_vrf_info);
...
{   
  ...
  SOC_PPD_FRWRD_IPV6_VRF_INFO_print(&prm_vrf_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FRWRD_IPV6_VPN_ROUTE_KEY_clear(&prm_route_key);
...
{   
  ...
  if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_SET_GLBL_INFO_SET_ID,1)) 
  { 
    ret = ui_ppd_api_frwrd_ipv6_glbl_info_set(current_line); 
  } 
  else if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_GLBL_INFO_GET_GLBL_INFO_GET_ID,1)) 
  { 
    ret = ui_ppd_api_frwrd_ipv6_glbl_info_get(current_line); 
  } 
  else if(!search_param_val_pairs(current_line,&match_index,SOC_PARAM_PPD_FRWRD_IPV6_UC_ROUTE_ADD_UC_ROUTE_ADD_ID,1)) 
  { 
