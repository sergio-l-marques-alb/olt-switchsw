...
{   
  ...
  SOC_PPD_FP_PFG_INFO_clear(&prm_info);
...
{   
  ...
  SOC_PPD_FP_PFG_INFO_print(&prm_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FP_DATABASE_INFO_clear(&prm_info);
...
{   
  ...
  SOC_PPD_FP_DATABASE_INFO_print(&prm_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_FP_DATABASE_INFO_clear(&db_info);
  SOC_PPD_FP_ENTRY_INFO_clear(&prm_info);
...
{   
  ...
  SOC_PPD_FP_ENTRY_INFO_print(&prm_info);
...
{   
  ...
  {
    SOC_PPD_FP_ENTRY_INFO_clear(&prm_entries[ndx]);
  }
  ...
  {
    SOC_PPD_FP_ENTRY_INFO_print(&prm_entries[ndx]);
  }
...
{   
  ...
  SOC_PPD_FP_DIR_EXTR_ENTRY_INFO   
    prm_info;
  SOC_SAND_SUCCESS_FAILURE   
    prm_success;
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FP_DIR_EXTR_ENTRY_INFO_clear(&prm_info);
...
{   
  ...
  SOC_PPD_FP_DIR_EXTR_ENTRY_INFO_print(&prm_info);
...
{   
  ...
  {
    SOC_PPD_FP_DIR_EXTR_ENTRY_INFO_clear(&prm_entries[idx]);
  }
  ...
  { 
    SOC_PPD_FP_DIR_EXTR_ENTRY_INFO_print(&prm_entries[idx]);
  }
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_FP_CONTROL_INDEX_clear(&prm_control_ndx);
  SOC_PPD_FP_CONTROL_INFO_clear(&prm_info);
...
{   
  ...
  SOC_PPD_FP_CONTROL_INFO_print(&prm_info);
