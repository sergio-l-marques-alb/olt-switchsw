...
/* { */
  #ifndef __DUNE_SSF__
    #include <appl/dpp/UserInterface/ui_rom_defi_petra_gfa.h>
    #include <appl/dpp/UserInterface/ui_rom_defi_gsa_petra_api.h>
   #include <appl/dpp/UserInterface/ui_rom_defi_swp_petra.h>
  #endif

  #include <appl/dpp/UserInterface/ui_rom_defi_petra_acc.h>
  #include <appl/dpp/UserInterface/ui_rom_defi_petra_api.h>
  #include <appl/dpp/UserInterface/ui_rom_defi_ptg.h>
/* } */
#if PETRA_PP
/* { */
  #include <appl/dpp/UserInterface/ui_rom_defi_petra_pp_acc.h>
...
/* } */
  ...
  /* { */
    #include <appl/dpp/UserInterface/ui_rom_defi_pb_api.h>
    #include <appl/dpp/UserInterface/ui_rom_defi_pb_pp_acc.h>
    #include <appl/dpp/UserInterface/ui_rom_defi_pb_pp_acc2.h>
  /* } */
#endif

#if LINK_PCP_LIBRARIES
/* { */
    #include <appl/dpp/UserInterface/ui_rom_defi_pcp_api.h>
/* } */
#endif
...
/* { */
  {
    ...
    "gfa",
    (PARAM *)&Gfa_params[0],
    (sizeof(Gfa_params) / sizeof(Gfa_params[0])) - 1,
    (char *)0,
    "BRD0014A - Line-card GFA Utilities.",
    "",
    0,0,
    (SUBJECT_PROC)subject_line_gfa,
    FALSE
  },
  {
    ...
    "diag",
    (PARAM *)&Diag_params[0],
    (sizeof(Diag_params) / sizeof(Diag_params[0])) - 1,
    (char *)0,
    "Generic tests",
    "",
    0,0,
    (SUBJECT_PROC)subject_diag,
    FALSE
  },
/* } */
...
#if LINK_PB_LIBRARIES
{
  ...
  "pb_api",
  (PARAM *)&soc_pb_api_params[0],
  (sizeof(soc_pb_api_params) / sizeof(soc_pb_api_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_pb_api,
  FALSE
},
{
  SUBJECT_PB_PP_ACC2_SERVICES_ID,
  "acc_pb_pp2",
  (PARAM *)&soc_pb_pp_acc2_params[0],
  (sizeof(soc_pb_pp_acc2_params) / sizeof(soc_pb_pp_acc2_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_pb_pp_acc2,
  FALSE
},
#endif
#if LINK_PB_PP_LIBRARIES
{
  ...
  "acc_pb_pp",
  (PARAM *)&soc_pb_pp_acc_params[0],
  (sizeof(soc_pb_pp_acc_params) / sizeof(soc_pb_pp_acc_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_pb_pp_acc,
  FALSE
},
#endif
#if LINK_PCP_LIBRARIES
{
  ...
  "pcp_api",
  (PARAM *)&pcp_api_params[0],
  (sizeof(pcp_api_params) / sizeof(pcp_api_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_pcp_api,
  FALSE
},
#endif
#if LINK_FAP21V_LIBRARIES
{
  ...
  "fap21v_api",
  (PARAM *)&fap21v_api_params[0],
  (sizeof(fap21v_api_params) / sizeof(fap21v_api_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_fap21v_api,
  FALSE
},
{
  SUBJECT_FAP21V_GFA_SERVICES_ID,
  "fap21v_gfa",
  (PARAM *)&fap21v_gfa_params[0],
  (sizeof(fap21v_gfa_params) / sizeof(fap21v_gfa_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_fap21v_gfa,
  FALSE
},
{
  SUBJECT_FAP21V_APP_SERVICES_ID,
  "fap21v_app",
  (PARAM *)&fap21v_app_params[0],
  (sizeof(fap21v_app_params) / sizeof(fap21v_app_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_fap21v_app,
  FALSE
},
...
#ifndef __DUNE_SSF__
{
  ...
  "gfa_petra",
  (PARAM *)&soc_petra_gfa_params[0],
  (sizeof(soc_petra_gfa_params) / sizeof(soc_petra_gfa_params[0])) - 1,
  (char *)0,
  "description.",
  "",
  0,0,
  (SUBJECT_PROC)subject_petra_gfa,
  FALSE
},
#endif
{
