 ...
 *  application. 
 */
#define DIAG_PP_DEFAULT_VPLS_GLOBAL_OUTLIF(_unit)               ((SOC_IS_JERICHO(_unit)) ? 0x3e000 : 12288)

#define DIAG_PP_DEFAULT_ROUTER_AND_MPLS_GLOBAL_OUTLIF(_unit)    ((SOC_IS_JERICHO(_unit)) ? 0x3f000 : 4096)
...
#define DIAG_PP_THIRD_DEFAULT_EGRESS_LOCAL_OUTLIF(_unit)  ((SOC_IS_JERICHO(_unit)) ? 16384 : 12288)
...
int
diag_pp_frwrd_trace_info_get(int unit, int core_id, SOC_PPD_DIAG_FRWRD_DECISION_TRACE_INFO *frwrd_trace_info, SOC_PPC_DIAG_RESULT *ret_val)
{
    int rv = 0;
    uint32 soc_sand_dev_id;
...
diag_pp_encap_info_bridge_test(int unit, int core_id) {
    ...
    SOC_PPD_DIAG_ENCAP_INFO *received_encap_info = NULL;
    SOC_PPD_DIAG_ENCAP_INFO *expected_encap_info = NULL;
...
{
    cmd_result_t result = CMD_OK;
    SOC_PPD_DIAG_TRAPS_INFO *received_traps_info = NULL;
    SOC_PPD_DIAG_TRAPS_INFO *expected_traps_info = NULL;
...
diag_pp_encap_info_vpls_test(int unit, int core_id, uint32 ac_to_pwe)
{
    ...
    if (ac_to_pwe) {
        ...
        expected_encap_info.out_ac = DIAG_PP_THIRD_DEFAULT_EGRESS_LOCAL_OUTLIF(unit);
        tm_port = 200;
        pp_port = 200;
