...
extern int memory_ser_test_init(int unit, args_t *a, void **p)
{
    ...
    config.gmo_reg = SOC_IS_ARADPLUS_AND_BELOW(unit) ? ECI_GLOBALFr : ECI_GLOBAL_MEM_OPTIONSr;
...
int memory_ser_test_run_mem(int unit, args_t *a, void *p)
{
    ...
    if (soc_mem_entry_words(unit, mem)>CMIC_SCHAN_WORDS(unit)) {
        LOG_INFO(BSL_LS_APPL_TESTS,(BSL_META_U(unit, "Memory %s length %d > CMIC_SCHAN_WORDS(unit)=%d\n"), SOC_MEM_NAME(unit, mem),
                                    soc_mem_entry_words(unit, mem),CMIC_SCHAN_WORDS(unit)));
        test_failed = 1;
        rv = BCM_E_PARAM;
        goto done;
    }
...
/*     unjustified skip list*/
       ...
       /*  jericho and above*/
         ...
         * 
         */
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_0m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_1m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_2m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_3m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_4m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_5m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_6m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_7m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_8m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_9m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_10m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_11m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_12m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_13m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_14m:
        case SCH_SCHEDULER_CREDIT_GENERATION_CALENDAR_CAL_15m:
