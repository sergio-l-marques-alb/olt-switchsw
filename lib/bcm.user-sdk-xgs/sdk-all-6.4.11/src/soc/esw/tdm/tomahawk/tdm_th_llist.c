...
**/
void
tdm_th_ll_append(struct th_ll_node *llist, unsigned char port_append, int *pointer)
{
...
**/
void
tdm_th_ll_insert(struct th_ll_node *llist, unsigned char port_insert, int idx)
{
	int i;
	struct th_ll_node *mbox,
					*right=llist,
