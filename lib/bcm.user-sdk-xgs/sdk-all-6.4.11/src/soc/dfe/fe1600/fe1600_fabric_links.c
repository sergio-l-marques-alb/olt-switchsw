...
soc_fe1600_fabric_links_isolate_set(int unit, soc_port_t link, soc_dcmn_isolation_status_t val) {
   ...
   soc_reg_t traffic_disable_bitmaps[SOC_FE1600_FABRIC_MAX_NOF_TRAFFIC_DISABLE_BMP];
   int nof_bitmaps, i;
   SOCDNX_INIT_FUNC_DEFS;
   ...
   for (i = 0; i < nof_bitmaps; i++) {
      ...
      SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, traffic_disable_bitmaps[i], REG_PORT_ANY, 0, traffic_allowed_bm));
      ...
      SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, traffic_disable_bitmaps[i], REG_PORT_ANY, 0, traffic_allowed_bm));
   }
