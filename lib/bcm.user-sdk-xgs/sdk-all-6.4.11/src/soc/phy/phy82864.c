...
_phy_82864_init_pass1(int unit, soc_port_t port)
{
	...
	SOC_IF_ERROR_RETURN
        ...
        if (repeater && core->init_config.op_datapath) {
	    ...
	    LOG_CLI((BSL_META_U(unit,"Both ULL datapath and repeater cannot be enabled simultaneously,"
            ...
            repeater = 1;
            core->init_config.op_datapath = phymodDatapathNormal; /* 1 is phymodDatapathUll*/
        }
...
phy_82864_ability_local_get(int unit, soc_port_t port, soc_port_ability_t *ability)
{
    ...
    if ((pc->speed_max == PHY82864_SPD_106G) ||
        ...
        pa_speed = SOC_PA_SPEED_11GB  | SOC_PA_SPEED_10GB;
    } else {
        pa_speed = SOC_PA_SPEED_106GB | SOC_PA_SPEED_100GB |
                   SOC_PA_SPEED_42GB | SOC_PA_SPEED_40GB |
                   SOC_PA_SPEED_11GB  | SOC_PA_SPEED_10GB;
