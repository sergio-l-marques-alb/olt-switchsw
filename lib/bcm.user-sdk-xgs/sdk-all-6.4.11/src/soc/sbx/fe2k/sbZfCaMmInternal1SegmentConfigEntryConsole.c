...
sbZfCaMmInternal1SegmentConfigEntry_Print(sbZfCaMmInternal1SegmentConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmInternal1SegmentConfigEntry:: internal1segmentconfig1=0x%02x"), (unsigned int)  pFromStruct->m_uInternal1SegmentConfig1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaMmInternal1SegmentConfigEntry:: internal1segmentconfig0=0x%08x"), (unsigned int)  pFromStruct->m_uInternal1SegmentConfig0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaMmInternal1SegmentConfigEntry_SPrint(sbZfCaMmInternal1SegmentConfigEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
