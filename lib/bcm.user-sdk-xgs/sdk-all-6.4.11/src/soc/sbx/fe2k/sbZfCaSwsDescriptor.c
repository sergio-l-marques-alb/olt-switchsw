/*
 * $Id: sbZfCaSwsDescriptor.c,v 1.2 Broadcom SDK $
...
sbZfCaSwsDescriptor_Unpack(sbZfCaSwsDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uResv0 =  (uint32)  ((pFromData)[171] >> 4) & 0x0f;

  /* Unpack Member: m_uSourceBuffer */
  (pToStruct)->m_uSourceBuffer =  (uint32)  ((pFromData)[169] >> 6) & 0x03;
  (pToStruct)->m_uSourceBuffer |=  (uint32)  (pFromData)[170] << 2;
  (pToStruct)->m_uSourceBuffer |=  (uint32)  ((pFromData)[171] & 0x0f) << 10;

  /* Unpack Member: m_uResv1 */
  (pToStruct)->m_uResv1 =  (uint32)  (pFromData)[168] ;
  (pToStruct)->m_uResv1 |=  (uint32)  ((pFromData)[169] & 0x7f) << 8;

  /* Unpack Member: m_uStreamSelector */
  (pToStruct)->m_uStreamSelector =  (uint32)  ((pFromData)[167] >> 5) & 0x07;

  /* Unpack Member: m_uBufferNumber */
  (pToStruct)->m_uBufferNumber =  (uint32)  (pFromData)[166] ;
  (pToStruct)->m_uBufferNumber |=  (uint32)  ((pFromData)[167] & 0x1f) << 8;
  ...
  (pToStruct)->m_uResv2 =  (uint32)  (pFromData)[163] ;

  /* Unpack Member: m_uReplicantCnt */
  (pToStruct)->m_uReplicantCnt =  (uint32)  ((pFromData)[161] >> 4) & 0x0f;
  (pToStruct)->m_uReplicantCnt |=  (uint32)  (pFromData)[162] << 4;

  /* Unpack Member: m_uReplicantBit */
  (pToStruct)->m_uReplicantBit =  (uint32)  ((pFromData)[161] >> 3) & 0x01;

  /* Unpack Member: m_uResv3 */
  (pToStruct)->m_uResv3 =  (uint32)  ((pFromData)[161] >> 2) & 0x01;

  /* Unpack Member: m_uDrop */
  (pToStruct)->m_uDrop =  (uint32)  ((pFromData)[161] >> 1) & 0x01;

  /* Unpack Member: m_uEnqueue */
  (pToStruct)->m_uEnqueue =  (uint32)  ((pFromData)[161] ) & 0x01;

  /* Unpack Member: m_uDqueue */
  (pToStruct)->m_uDqueue =  (uint32)  (pFromData)[160] ;

  /* Unpack Member: m_uResv4 */
  (pToStruct)->m_uResv4 =  (uint32)  ((pFromData)[157] >> 6) & 0x03;
  (pToStruct)->m_uResv4 |=  (uint32)  (pFromData)[158] << 2;
  (pToStruct)->m_uResv4 |=  (uint32)  (pFromData)[159] << 10;

  /* Unpack Member: m_uFrameLength */
  (pToStruct)->m_uFrameLength =  (uint32)  (pFromData)[156] ;
  (pToStruct)->m_uFrameLength |=  (uint32)  ((pFromData)[157] & 0x3f) << 8;
