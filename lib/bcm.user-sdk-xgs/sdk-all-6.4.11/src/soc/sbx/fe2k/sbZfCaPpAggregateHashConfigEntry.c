/*
 * $Id: sbZfCaPpAggregateHashConfigEntry.c,v 1.2 Broadcom SDK $
...
sbZfCaPpAggregateHashConfigEntry_Pack(sbZfCaPpAggregateHashConfigEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPAGGREGATEHASHCONFIGENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPAGGREGATEHASHCONFIGENTRY_SIZE_IN_BYTES;
}
