/*
 * $Id: sbZfFe2000QmQueueConfigEntryConsole.c,v 1.5 Broadcom SDK $
...
sbZfFe2000QmQueueConfigEntry_Print(sbZfFe2000QmQueueConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000QmQueueConfigEntry:: enforcepolicemarkings=0x%01x"), (unsigned int)  pFromStruct->m_uEnforcePoliceMarkings));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000QmQueueConfigEntry:: dropthresh1=0x%03x"), (unsigned int)  pFromStruct->m_uDropThresh1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000QmQueueConfigEntry:: flowcontrolthresh1=0x%03x"), (unsigned int)  pFromStruct->m_uFlowControlThresh1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000QmQueueConfigEntry:: flowcontroltarget=0x%01x"), (unsigned int)  pFromStruct->m_uFlowControlTarget));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000QmQueueConfigEntry:: maxpages=0x%03x"), (unsigned int)  pFromStruct->m_uMaxPages));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfFe2000QmQueueConfigEntry_SPrint(sbZfFe2000QmQueueConfigEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
