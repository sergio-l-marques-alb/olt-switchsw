/*
 * $Id: sbZfFe2000HdrDescLrp2Ped.c,v 1.4 Broadcom SDK $
...
sbZfFe2000HdrDescLrp2Ped_Unpack(sbZfFe2000HdrDescLrp2Ped_t *pToStruct,
  ...
  (pToStruct)->ulContinueByte =  (uint32)  (pFromData)[3] ;

  /* Unpack Member: ulHdr0 */
  (pToStruct)->ulHdr0 =  (uint32)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: ulHdr1 */
  (pToStruct)->ulHdr1 =  (uint32)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: ulHdr2 */
  (pToStruct)->ulHdr2 =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: ulHdr3 */
  (pToStruct)->ulHdr3 =  (uint32)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: ulHdr4 */
  (pToStruct)->ulHdr4 =  (uint32)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: ulHdr5 */
  (pToStruct)->ulHdr5 =  (uint32)  ((pFromData)[0] ) & 0x0f;

  /* Unpack Member: ulHdr6 */
  (pToStruct)->ulHdr6 =  (uint32)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: ulHdr7 */
  (pToStruct)->ulHdr7 =  (uint32)  ((pFromData)[7] ) & 0x0f;

  /* Unpack Member: ulHdr8 */
  (pToStruct)->ulHdr8 =  (uint32)  ((pFromData)[6] >> 4) & 0x0f;

  /* Unpack Member: ulHdr9 */
  (pToStruct)->ulHdr9 =  (uint32)  ((pFromData)[6] ) & 0x0f;

  /* Unpack Member: ulLocn0 */
  (pToStruct)->ulLocn0 =  (uint32)  (pFromData)[5] ;

  /* Unpack Member: ulLocn1 */
  (pToStruct)->ulLocn1 =  (uint32)  (pFromData)[4] ;

  /* Unpack Member: ulLocn2 */
  (pToStruct)->ulLocn2 =  (uint32)  (pFromData)[11] ;

  /* Unpack Member: ulLocn3 */
  (pToStruct)->ulLocn3 =  (uint32)  (pFromData)[10] ;

  /* Unpack Member: ulLocn4 */
  (pToStruct)->ulLocn4 =  (uint32)  (pFromData)[9] ;

  /* Unpack Member: ulLocn5 */
  (pToStruct)->ulLocn5 =  (uint32)  (pFromData)[8] ;

  /* Unpack Member: ulLocn6 */
  (pToStruct)->ulLocn6 =  (uint32)  (pFromData)[15] ;

  /* Unpack Member: ulLocn7 */
  (pToStruct)->ulLocn7 =  (uint32)  (pFromData)[14] ;

  /* Unpack Member: ulLocn8 */
  (pToStruct)->ulLocn8 =  (uint32)  (pFromData)[13] ;

  /* Unpack Member: ulLocn9 */
  (pToStruct)->ulLocn9 =  (uint32)  (pFromData)[12] ;

  /* Unpack Member: ulStr */
  (pToStruct)->ulStr =  (uint32)  ((pFromData)[19] >> 5) & 0x07;

  /* Unpack Member: ulBuffer */
  (pToStruct)->ulBuffer =  (uint32)  (pFromData)[18] ;
  (pToStruct)->ulBuffer |=  (uint32)  ((pFromData)[19] & 0x1f) << 8;

  /* Unpack Member: ulExceptIndex */
  (pToStruct)->ulExceptIndex =  (uint32)  (pFromData)[17] ;

  /* Unpack Member: ulSQueue */
  (pToStruct)->ulSQueue =  (uint32)  (pFromData)[16] ;

  /* Unpack Member: ulTc */
  (pToStruct)->ulTc =  (uint32)  ((pFromData)[23] >> 5) & 0x07;

  /* Unpack Member: ulHc */
  (pToStruct)->ulHc =  (uint32)  ((pFromData)[23] >> 4) & 0x01;

  /* Unpack Member: ulMirrorIndex */
  (pToStruct)->ulMirrorIndex =  (uint32)  ((pFromData)[23] ) & 0x0f;

  /* Unpack Member: ulCopyCnt */
  (pToStruct)->ulCopyCnt =  (uint32)  ((pFromData)[21] >> 4) & 0x0f;
  (pToStruct)->ulCopyCnt |=  (uint32)  (pFromData)[22] << 4;

  /* Unpack Member: ulCM */
  (pToStruct)->ulCM =  (uint32)  ((pFromData)[21] >> 2) & 0x03;

  /* Unpack Member: ulD */
  (pToStruct)->ulD =  (uint32)  ((pFromData)[21] >> 1) & 0x01;

  /* Unpack Member: ulEnq */
  (pToStruct)->ulEnq =  (uint32)  ((pFromData)[21] ) & 0x01;

  /* Unpack Member: ulDQueue */
  (pToStruct)->ulDQueue =  (uint32)  (pFromData)[20] ;

  /* Unpack Member: ulXferLen */
  (pToStruct)->ulXferLen =  (uint32)  ((pFromData)[26] >> 2) & 0x3f;
  (pToStruct)->ulXferLen |=  (uint32)  (pFromData)[27] << 6;

  /* Unpack Member: ulPm */
  (pToStruct)->ulPm =  (uint32)  ((pFromData)[26] ) & 0x03;

  /* Unpack Member: ulPadding0 */
  (pToStruct)->ulPadding0 =  (uint32)  ((pFromData)[25] >> 6) & 0x03;

  /* Unpack Member: ulFrameLen */
  (pToStruct)->ulFrameLen =  (uint32)  (pFromData)[24] ;
  (pToStruct)->ulFrameLen |=  (uint32)  ((pFromData)[25] & 0x3f) << 8;

  /* Unpack Member: ulPadding1 */
  (pToStruct)->ulPadding1 =  (uint32)  (pFromData)[28] ;
  (pToStruct)->ulPadding1 |=  (uint32)  (pFromData)[29] << 8;
  (pToStruct)->ulPadding1 |=  (uint32)  (pFromData)[30] << 16;
  (pToStruct)->ulPadding1 |=  (uint32)  (pFromData)[31] << 24;

  /* Unpack Member: ulPadding2 */
  (pToStruct)->ulPadding2 =  (uint32)  (pFromData)[32] ;
  (pToStruct)->ulPadding2 |=  (uint32)  (pFromData)[33] << 8;
  (pToStruct)->ulPadding2 |=  (uint32)  (pFromData)[34] << 16;
  (pToStruct)->ulPadding2 |=  (uint32)  (pFromData)[35] << 24;
