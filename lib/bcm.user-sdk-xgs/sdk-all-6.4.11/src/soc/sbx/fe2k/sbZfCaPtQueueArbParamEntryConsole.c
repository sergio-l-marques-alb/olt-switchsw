/*
 * $Id: sbZfCaPtQueueArbParamEntryConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPtQueueArbParamEntry_Print(sbZfCaPtQueueArbParamEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtQueueArbParamEntry:: ppeenqueue=0x%01x"), (unsigned int)  pFromStruct->m_uPpeEnqueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtQueueArbParamEntry:: queue=0x%02x"), (unsigned int)  pFromStruct->m_uQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtQueueArbParamEntry:: dstinterface=0x%01x"), (unsigned int)  pFromStruct->m_uDstInterface));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtQueueArbParamEntry:: dstqueue=0x%02x"), (unsigned int)  pFromStruct->m_uDstQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
