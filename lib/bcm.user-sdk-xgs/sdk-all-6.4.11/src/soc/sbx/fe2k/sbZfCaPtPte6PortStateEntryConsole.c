/*
 * $Id: sbZfCaPtPte6PortStateEntryConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPtPte6PortStateEntry_Print(sbZfCaPtPte6PortStateEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: pktinprogress=0x%01x"), (unsigned int)  pFromStruct->m_uPktInProgress));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: doubledequeued=0x%01x"), (unsigned int)  pFromStruct->m_uDoubleDequeued));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: residuebyte=0x%01x"), (unsigned int)  pFromStruct->m_uResidueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: lastpage=0x%01x"), (unsigned int)  pFromStruct->m_uLastPage));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: nextlength=0x%02x"), (unsigned int)  pFromStruct->m_uNextLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: remainingbytes=0x%02x"), (unsigned int)  pFromStruct->m_uRemainingBytes));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: pktlength=0x%04x"), (unsigned int)  pFromStruct->m_uPktLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtPte6PortStateEntry:: sourcequeue=0x%02x"), (unsigned int)  pFromStruct->m_uSourceQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaPtPte6PortStateEntry_SPrint(sbZfCaPtPte6PortStateEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
