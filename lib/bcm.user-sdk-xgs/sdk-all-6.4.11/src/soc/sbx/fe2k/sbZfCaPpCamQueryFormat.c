/*
 * $Id: sbZfCaPpCamQueryFormat.c,v 1.2 Broadcom SDK $
...
sbZfCaPpCamQueryFormat_Unpack(sbZfCaPpCamQueryFormat_t *pToStruct,
  ...
  (pToStruct)->m_uState =  (uint32)  (pFromData)[20] ;
  (pToStruct)->m_uState |=  (uint32)  (pFromData)[21] << 8;
  (pToStruct)->m_uState |=  (uint32)  (pFromData)[22] << 16;
  ...
  (pToStruct)->m_uQueryData0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uQueryData0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uQueryData0 |=  (uint32)  (pFromData)[2] << 16;
  (pToStruct)->m_uQueryData0 |=  (uint32)  (pFromData)[3] << 24;
