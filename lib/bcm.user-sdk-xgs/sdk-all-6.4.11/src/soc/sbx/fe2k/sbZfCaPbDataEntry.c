/*
 * $Id: sbZfCaPbDataEntry.c,v 1.2 Broadcom SDK $
...
uint32
sbZfCaPbDataEntry_Pack(sbZfCaPbDataEntry_t *pFrom,
                       uint8 *pToData,
                       uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_CAPBDATAENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPBDATAENTRY_SIZE_IN_BYTES;
}
...
void
sbZfCaPbDataEntry_Unpack(sbZfCaPbDataEntry_t *pToStruct,
                         uint8 *pFromData,
                         uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfCaPbDataEntry_InitInstance(sbZfCaPbDataEntry_t *pFrame) {
