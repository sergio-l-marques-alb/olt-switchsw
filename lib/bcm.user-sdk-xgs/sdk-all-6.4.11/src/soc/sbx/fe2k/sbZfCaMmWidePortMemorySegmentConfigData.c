/*
 * $Id: sbZfCaMmWidePortMemorySegmentConfigData.c,v 1.2 Broadcom SDK $
...
sbZfCaMmWidePortMemorySegmentConfigData_Unpack(sbZfCaMmWidePortMemorySegmentConfigData_t *pToStruct,
  ...
  (pToStruct)->m_uWriteAccess =  (uint32)  ((pFromData)[6] >> 7) & 0x01;
  (pToStruct)->m_uWriteAccess |=  (uint32)  ((pFromData)[7] & 0x01) << 1;

  /* Unpack Member: m_uReadAccess */
  (pToStruct)->m_uReadAccess =  (uint32)  ((pFromData)[6] >> 5) & 0x03;

  /* Unpack Member: m_uDataIntegrity */
  (pToStruct)->m_uDataIntegrity =  (uint32)  ((pFromData)[6] >> 2) & 0x07;
