/*
 * $Id: sbZfCaPtPte1MirrorPortStateEntry.c,v 1.2 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaPtPte1MirrorPortStateEntry.hx"
...
sbZfCaPtPte1MirrorPortStateEntry_Pack(sbZfCaPtPte1MirrorPortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE1MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE1MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
}
