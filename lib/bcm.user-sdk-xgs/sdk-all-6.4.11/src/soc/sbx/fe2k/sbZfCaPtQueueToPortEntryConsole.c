/*
 * $Id: sbZfCaPtQueueToPortEntryConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPtQueueToPortEntry_Print(sbZfCaPtQueueToPortEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtQueueToPortEntry:: pbsel=0x%01x"), (unsigned int)  pFromStruct->m_uPbSel));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPtQueueToPortEntry:: destinterface=0x%01x"), (unsigned int)  pFromStruct->m_uDestInterface));
  LOG_WARN(BSL_LS_SOC_COMMON,
