/*
 * $Id: sbZfCaPmProfileMemoryEntry.c,v 1.2 Broadcom SDK $
...
sbZfCaPmProfileMemoryEntry_Unpack(sbZfCaPmProfileMemoryEntry_t *pToStruct,
  ...
  (pToStruct)->m_uType2 =  (uint32)  ((pFromData)[7] >> 6) & 0x01;

  /* Unpack Member: m_uDropOnRed */
  (pToStruct)->m_uDropOnRed =  (uint32)  ((pFromData)[7] >> 5) & 0x01;

  /* Unpack Member: m_uExcessBucketNoDecrement */
  (pToStruct)->m_uExcessBucketNoDecrement =  (uint32)  ((pFromData)[7] >> 4) & 0x01;

  /* Unpack Member: m_uCommittedBucketNoDecrement */
  (pToStruct)->m_uCommittedBucketNoDecrement =  (uint32)  ((pFromData)[7] >> 3) & 0x01;

  /* Unpack Member: m_uLengthShift */
  (pToStruct)->m_uLengthShift =  (uint32)  ((pFromData)[7] ) & 0x07;
  ...
  (pToStruct)->m_uCommittedInformationRate =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uCommittedInformationRate |=  (uint32)  ((pFromData)[5] & 0x0f) << 8;

  /* Unpack Member: m_uCouplingFlag */
  (pToStruct)->m_uCouplingFlag =  (uint32)  ((pFromData)[3] >> 7) & 0x01;

  /* Unpack Member: m_uRfcMode */
  (pToStruct)->m_uRfcMode =  (uint32)  ((pFromData)[3] >> 6) & 0x01;

  /* Unpack Member: m_uColorBlind */
  (pToStruct)->m_uColorBlind =  (uint32)  ((pFromData)[3] >> 5) & 0x01;

  /* Unpack Member: m_uCommitedBucketSize */
  (pToStruct)->m_uCommitedBucketSize =  (uint32)  ((pFromData)[3] ) & 0x1f;

  /* Unpack Member: m_uExcessBurstSize */
  (pToStruct)->m_uExcessBurstSize =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;
  (pToStruct)->m_uExcessBurstSize |=  (uint32)  (pFromData)[2] << 4;
