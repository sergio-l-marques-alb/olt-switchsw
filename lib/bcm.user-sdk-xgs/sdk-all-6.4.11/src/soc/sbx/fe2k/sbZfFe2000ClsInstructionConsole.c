/*
 * $Id: sbZfFe2000ClsInstructionConsole.c,v 1.5 Broadcom SDK $
...
sbZfFe2000ClsInstruction_Print(sbZfFe2000ClsInstruction_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000ClsInstruction:: opmsb=0x%01x"), (unsigned int)  pFromStruct->uOpCodeMsb));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" oplsb=0x%01x"), (unsigned int)  pFromStruct->uOpCodeLsb));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" sfld=0x%01x"), (unsigned int)  pFromStruct->uSField));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mfld=0x%01x"), (unsigned int)  pFromStruct->uMField));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" afld=0x%02x"), (unsigned int)  pFromStruct->uAField));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfFe2000ClsInstruction_SPrint(sbZfFe2000ClsInstruction_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
