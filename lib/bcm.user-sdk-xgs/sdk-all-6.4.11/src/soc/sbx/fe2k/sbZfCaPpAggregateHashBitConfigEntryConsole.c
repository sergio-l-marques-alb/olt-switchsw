...
sbZfCaPpAggregateHashBitConfigEntry_Print(sbZfCaPpAggregateHashBitConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashBitConfigEntry:: data9=0x%08x"), (unsigned int)  pFromStruct->m_uData9));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashBitConfigEntry:: data7=0x%08x"), (unsigned int)  pFromStruct->m_uData7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashBitConfigEntry:: data5=0x%08x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashBitConfigEntry:: data3=0x%08x"), (unsigned int)  pFromStruct->m_uData3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashBitConfigEntry:: data1=0x%08x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfCaPpAggregateHashBitConfigEntry_SPrint(sbZfCaPpAggregateHashBitConfigEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
