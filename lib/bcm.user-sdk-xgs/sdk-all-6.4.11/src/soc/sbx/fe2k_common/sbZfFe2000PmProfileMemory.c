...
sbZfFe2000PmProfileMemory_Unpack(sbZfFe2000PmProfileMemory_t *pToStruct,
  ...
  (pToStruct)->uProfType =  (uint32)  ((pFromData)[0] >> 6) & 0x01;

  /* Unpack Member: uOamProfType */
  (pToStruct)->uOamProfType =  (uint32)  ((pFromData)[0] >> 4) & 0x03;
...
uint32 sbZfFe2000PmProfileMemory_Pack32(sbZfFe2000PmProfileMemory_t *pFrom, 
                                    ...
                                    uint32 nMaxToDataIndex)
{
  uint8 uBuffer[SB_ZF_FE_2000_PM_PROFMEMORY_SIZE_IN_WORDS*4];
  uint32 uIndex =0;
  uint32 *pBuffer = NULL;
  uint32 uNumberOfWords = SB_ZF_FE_2000_PM_PROFMEMORY_SIZE_IN_WORDS;
                                          ...
                                          uint32 nMaxToDataIndex)
{
  ...
  uint32 uBuffer[SB_ZF_FE_2000_PM_PROFMEMORY_SIZE_IN_WORDS*4];
  uint32 uNumberOfWords = SB_ZF_FE_2000_PM_PROFMEMORY_SIZE_IN_WORDS;
  uint32 uIndex =0;
  ...
  sbZfFe2000PmProfileMemory_Unpack(pToData , (uint8 *) &uBuffer[0], SB_ZF_FE_2000_PM_PROFMEMORY_SIZE_IN_BYTES);
  return uNumberOfWords;
}
