...
sbZfC2PmProfileTimerMemory_Unpack(sbZfC2PmProfileTimerMemory_t *pToStruct,
  ...
  (pToStruct)->uResv0 =  (uint32)  ((pFromData)[2] >> 3) & 0x1f;
  (pToStruct)->uResv0 |=  (uint32)  (pFromData)[1] << 5;
  (pToStruct)->uResv0 |=  (uint32)  (pFromData)[0] << 13;

  /* Unpack Member: uType */
  (pToStruct)->uType =  (uint32)  ((pFromData)[2] >> 2) & 0x01;

  /* Unpack Member: uProfMode */
  (pToStruct)->uProfMode =  (uint32)  ((pFromData)[2] ) & 0x03;

  /* Unpack Member: uResv1 */
  (pToStruct)->uResv1 =  (uint32)  (pFromData)[3] ;

  /* Unpack Member: uResv2 */
  (pToStruct)->uResv2 =  (uint32)  (pFromData)[7] ;
  (pToStruct)->uResv2 |=  (uint32)  (pFromData)[6] << 8;
  (pToStruct)->uResv2 |=  (uint32)  (pFromData)[5] << 16;
  (pToStruct)->uResv2 |=  (uint32)  (pFromData)[4] << 24;

  /* Unpack Member: uResv3 */
  (pToStruct)->uResv3 =  (uint32)  (pFromData)[8] ;

  /* Unpack Member: bInterrupt */
  (pToStruct)->bInterrupt =  (uint32)  ((pFromData)[9] >> 7) & 0x01;

  /* Unpack Member: bReset */
  (pToStruct)->bReset =  (uint32)  ((pFromData)[9] >> 6) & 0x01;

  /* Unpack Member: bStrict */
  (pToStruct)->bStrict =  (uint32)  ((pFromData)[9] >> 5) & 0x01;

  /* Unpack Member: bStarted */
  (pToStruct)->bStarted =  (uint32)  ((pFromData)[9] >> 4) & 0x01;

  /* Unpack Member: uDeadline */
  (pToStruct)->uDeadline =  (uint32)  (pFromData)[11] ;
  (pToStruct)->uDeadline |=  (uint32)  (pFromData)[10] << 8;
  (pToStruct)->uDeadline |=  (uint32)  ((pFromData)[9] & 0x0f) << 16;
...
uint32 sbZfC2PmProfileTimerMemory_Pack32(sbZfC2PmProfileTimerMemory_t *pFrom, 
                                              ...
                                              uint32 nMaxToDataIndex)
{
  uint8 uBuffer[SB_ZF_C2_PM_PROFTIMERMEMORY_SIZE_IN_WORDS*4];
  uint32 uIndex =0;
  uint32 *pBuffer = NULL;
  uint32 uNumberOfWords = SB_ZF_C2_PM_PROFTIMERMEMORY_SIZE_IN_WORDS;
                                               ...
                                               uint32 nMaxToDataIndex)
{
  ...
  uint32 uBuffer[SB_ZF_C2_PM_PROFTIMERMEMORY_SIZE_IN_WORDS*4];
  uint32 uNumberOfWords = SB_ZF_C2_PM_PROFTIMERMEMORY_SIZE_IN_WORDS;
  uint32 uIndex =0;
  ...
  sbZfC2PmProfileTimerMemory_Unpack(pToData , (uint8 *) &uBuffer[0], SB_ZF_C2_PM_PROFTIMERMEMORY_SIZE_IN_BYTES);
  return uNumberOfWords;
}
