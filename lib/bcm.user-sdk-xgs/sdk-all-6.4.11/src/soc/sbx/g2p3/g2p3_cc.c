/*
 * $Id: g2p3_cc.c,v 1.2 Broadcom SDK $
 *
                         ...
                         g2p3_cc_de_t de)
{
    ...
    sbZfC2PrCcTcamConfigEntryFirst_Unpack(&zTcamConfigEntryFirst, (uint8 *) &uCfgBuffer[0],
                             SB_ZF_C2PRCCTCAMCONFIGENTRY_SIZE_IN_WORDS);
    sbZfC2PrCcCamRamLastEntry_Unpack(&zLastEntryRam, (uint8 *) &uCfgRamBuffer[0],
                         ...
                         uint32 tpid)
{
    ...
    sbZfC2PrCcTcamConfigEntryFirst_Pack(&zTcamConfigEntryFirst, (uint8*)uCfgBuffer,
                           SB_ZF_C2PRCCTCAMCONFIGENTRY_SIZE_IN_BYTES);
    sbZfC2PrCcCamRamNonLastEntry_Pack(&zNonLastEntryRam, (uint8*)uCfgRamBuffer,
                              SB_ZF_C2PRCCCAMRAMLASTENTRY_SIZE_IN_BYTES);
                         ...
                         uint32 *tpid)
{
    ...
    sbZfC2PrCcTcamConfigEntryFirst_Unpack(&zTcamConfigEntryFirst, (uint8*)uCfgBuffer,
                           SB_ZF_C2PRCCTCAMCONFIGENTRY_SIZE_IN_BYTES);
    sbZfC2PrCcCamRamNonLastEntry_Unpack(&zNonLastEntryRam, (uint8*)uCfgRamBuffer,
                              SB_ZF_C2PRCCCAMRAMLASTENTRY_SIZE_IN_BYTES);
                           ...
                           g2p3_cc_de_t de)
{
    ...
    sbZfC2PrCcTcamConfigEntryNonFirst_Unpack(&zTcamConfigEntryNonFirst, (uint8 *) &uCfgBuffer[0],
                             SB_ZF_C2PRCCTCAMCONFIGENTRY_SIZE_IN_WORDS);
    sbZfC2PrCcCamRamLastEntry_Unpack(&zLastEntryRam, (uint8 *) &uCfgRamBuffer[0],
                                SB_ZF_C2PRCCCAMRAMLASTENTRY_SIZE_IN_WORDS);
    ...
    sbZfC2PrCcTcamConfigEntryNonFirst_Pack(&zTcamConfigEntryNonFirst, (uint8*)uCfgBuffer,
                           SB_ZF_C2PRCCTCAMCONFIGENTRY_SIZE_IN_BYTES);
    sbZfC2PrCcCamRamLastEntry_Pack(&zLastEntryRam, (uint8*)uCfgRamBuffer,
                              SB_ZF_C2PRCCCAMRAMLASTENTRY_SIZE_IN_BYTES);
                             ...
                             g2p3_cc_de_t de)
{
    ...
    sbZfC2PrCcTcamConfigEntry_Unpack(&zTcamConfigEntry, (uint8 *) &uCfgBuffer[0],
                             SB_ZF_C2PRCCTCAMCONFIGENTRY_SIZE_IN_WORDS);
    sbZfC2PrCcCamRamLastEntry_Unpack(&zLastEntryRam, (uint8 *) &uCfgRamBuffer[0],
                                SB_ZF_C2PRCCCAMRAMLASTENTRY_SIZE_IN_WORDS);
