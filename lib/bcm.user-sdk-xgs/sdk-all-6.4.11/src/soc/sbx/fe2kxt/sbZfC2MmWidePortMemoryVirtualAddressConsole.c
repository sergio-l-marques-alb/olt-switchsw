...
sbZfC2MmWidePortMemoryVirtualAddress_Print(sbZfC2MmWidePortMemoryVirtualAddress_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmWidePortMemoryVirtualAddress:: resv0=0x%01x"), (unsigned int)  pFromStruct->m_uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2MmWidePortMemoryVirtualAddress:: addr=0x%06x"), (unsigned int)  pFromStruct->m_uAddress));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2MmWidePortMemoryVirtualAddress_SPrint(sbZfC2MmWidePortMemoryVirtualAddress_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
