...
sbZfC2PpRxPortMaskEntry_Print(sbZfC2PpRxPortMaskEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortMaskEntry:: rxportdata1=0x%07x"), (unsigned int)  pFromStruct->m_uRxPortData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2PpRxPortMaskEntry_SPrint(sbZfC2PpRxPortMaskEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
