...
sbZfC2PtMirrorIndexEntry_Print(sbZfC2PtMirrorIndexEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtMirrorIndexEntry:: overwritehdr=0x%01x"), (unsigned int)  pFromStruct->m_uOverwriteHdr));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" higighdr=0x%01x"), (unsigned int)  pFromStruct->m_uHiGigHdr));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" dropsrcpkt=0x%01x"), (unsigned int)  pFromStruct->m_uDropSrcPkt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtMirrorIndexEntry:: hdrpresent=0x%01x"), (unsigned int)  pFromStruct->m_uHdrPresent));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtMirrorIndexEntry:: headerdata3=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderData3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" headerdata2=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderData2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtMirrorIndexEntry:: headerdata1=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" headerdata0=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderData0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
