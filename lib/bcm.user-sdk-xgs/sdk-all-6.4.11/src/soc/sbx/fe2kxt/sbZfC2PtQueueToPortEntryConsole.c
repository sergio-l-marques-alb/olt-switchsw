...
sbZfC2PtQueueToPortEntry_Print(sbZfC2PtQueueToPortEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtQueueToPortEntry:: pbsel=0x%01x"), (unsigned int)  pFromStruct->m_uPbSel));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PtQueueToPortEntry:: destinterface=0x%01x"), (unsigned int)  pFromStruct->m_uDestInterface));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2PtQueueToPortEntry_SPrint(sbZfC2PtQueueToPortEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
