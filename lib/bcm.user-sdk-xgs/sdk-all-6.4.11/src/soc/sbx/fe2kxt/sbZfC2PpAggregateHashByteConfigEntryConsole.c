...
sbZfC2PpAggregateHashByteConfigEntry_Print(sbZfC2PpAggregateHashByteConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpAggregateHashByteConfigEntry:: data1=0x%02x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2PpAggregateHashByteConfigEntry_SPrint(sbZfC2PpAggregateHashByteConfigEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
