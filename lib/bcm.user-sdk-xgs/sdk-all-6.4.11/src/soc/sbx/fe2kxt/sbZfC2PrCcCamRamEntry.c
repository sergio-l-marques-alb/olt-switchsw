...
sbZfC2PrCcCamRamEntry_Unpack(sbZfC2PrCcCamRamEntry_t *pToStruct,
  ...
  (pToStruct)->m_uData76_64 =  (uint32)  (pFromData)[8] ;
  (pToStruct)->m_uData76_64 |=  (uint32)  ((pFromData)[9] & 0x1f) << 8;

  /* Unpack Member: m_uData63_32 */
  (pToStruct)->m_uData63_32 =  (uint32)  (pFromData)[4] ;
  (pToStruct)->m_uData63_32 |=  (uint32)  (pFromData)[5] << 8;
  (pToStruct)->m_uData63_32 |=  (uint32)  (pFromData)[6] << 16;
  (pToStruct)->m_uData63_32 |=  (uint32)  (pFromData)[7] << 24;

  /* Unpack Member: m_uData31_0 */
  (pToStruct)->m_uData31_0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uData31_0 |=  (uint32)  (pFromData)[1] << 8;
  (pToStruct)->m_uData31_0 |=  (uint32)  (pFromData)[2] << 16;
  (pToStruct)->m_uData31_0 |=  (uint32)  (pFromData)[3] << 24;
