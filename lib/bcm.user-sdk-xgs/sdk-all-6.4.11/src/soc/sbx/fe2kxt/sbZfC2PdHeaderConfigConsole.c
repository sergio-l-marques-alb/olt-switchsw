...
sbZfC2PdHeaderConfig_Print(sbZfC2PdHeaderConfig_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdHeaderConfig:: spare0=0x%02x"), (unsigned int)  pFromStruct->m_uSpare0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdHeaderConfig:: spare2=0x%01x"), (unsigned int)  pFromStruct->m_uSpare2));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2PdHeaderConfig_SPrint(sbZfC2PdHeaderConfig_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
