...
sbZfC2QmDequeueState1Entry_Print(sbZfC2QmDequeueState1Entry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2QmDequeueState1Entry:: preveop=0x%01x"), (unsigned int)  pFromStruct->m_uPrevEop));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" nextpage=0x%04x"), (unsigned int)  pFromStruct->m_uNextPage));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2QmDequeueState1Entry_SPrint(sbZfC2QmDequeueState1Entry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
