...
CONST mbcm_dpp_functions_t mbcm_petrab_driver = {
    ...
    NULL, /*mbcm_dpp_fabric_mesh_check*/
    ...
    NULL, /* mbcm_dpp_mgmt_credit_worth_set_f */ 
  ...
  NULL, /*mbcm_dpp_mgmt_change_all_faps_credit_worth_unsafe*/
    ...
    NULL, /*mbcm_dpp_ofp_rates_single_port_max_burst_set*/                          
    NULL, /*mbcm_dpp_ofp_rates_single_port_max_burst_get*/
    ...
    NULL, /* mbcm_dpp_port_is_pcs_loopback */
    ...
    NULL,   /* mbcm_dpp_qsgmii_id_to_phy_pbmp_get */
