/* $Id: pb_pp_api_eg_vlan_edit.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_eg_vlan_edit.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_SET);
  ...
  res = soc_pb_pp_eg_vlan_edit_pep_info_set_verify(
          unit,
          pep_key,
          pep_info
        );
  ...
  res = soc_pb_pp_eg_vlan_edit_pep_info_set_unsafe(
          unit,
          pep_key,
          pep_info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pep_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PEP_INFO_GET);
  ...
  res = soc_pb_pp_eg_vlan_edit_pep_info_get_verify(
          unit,
          pep_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_vlan_edit_pep_info_get_unsafe(
          unit,
          pep_key,
          pep_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pep_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_COMMAND_INFO_SET);
  ...
  res = soc_pb_pp_eg_vlan_edit_command_info_set_verify(
          unit,
          command_key,
          command_info
        );
  ...
  res = soc_pb_pp_eg_vlan_edit_command_info_set_unsafe(
          unit,
          command_key,
          command_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_command_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_COMMAND_INFO_GET);
  ...
  res = soc_pb_pp_eg_vlan_edit_command_info_get_verify(
          unit,
          command_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_vlan_edit_command_info_get_unsafe(
          unit,
          command_key,
          command_info
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_command_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PORT_VLAN_TRANSMIT_OUTER_TAG_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_eg_vlan_edit_port_vlan_transmit_outer_tag_set_verify(
          unit,
          local_port_ndx,
          vid_ndx,
          transmit_outer_tag
  ...
  res = soc_pb_pp_eg_vlan_edit_port_vlan_transmit_outer_tag_set_unsafe(
          unit,
          local_port_ndx,
          vid_ndx,
          transmit_outer_tag
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_port_vlan_transmit_outer_tag_set()", local_port_ndx, vid_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PORT_VLAN_TRANSMIT_OUTER_TAG_GET);
  ...
  res = soc_pb_pp_eg_vlan_edit_port_vlan_transmit_outer_tag_get_unsafe(
          unit,
          local_port_ndx,
          vid_ndx,
          transmit_outer_tag
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_port_vlan_transmit_outer_tag_get()", local_port_ndx, vid_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_PROFILE_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_eg_vlan_edit_pcp_profile_info_set_verify(
          unit,
          pcp_profile_ndx,
          key_mapping
        );
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_profile_info_set_unsafe(
          unit,
          pcp_profile_ndx,
          key_mapping
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_profile_info_set()", pcp_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_PROFILE_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(key_mapping);

  res = soc_pb_pp_eg_vlan_edit_pcp_profile_info_get_verify(
          unit,
          pcp_profile_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_profile_info_get_unsafe(
          unit,
          pcp_profile_ndx,
          key_mapping
        );
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_profile_info_get()", pcp_profile_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_STAG_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_eg_vlan_edit_pcp_map_stag_set_verify(
          unit,
          pcp_profile_ndx,
          tag_pcp_ndx,
          tag_dei_ndx,
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_stag_set_unsafe(
          unit,
          pcp_profile_ndx,
          tag_pcp_ndx,
          tag_dei_ndx,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_map_stag_set()", pcp_profile_ndx, tag_pcp_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_STAG_GET);
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_stag_get_verify(
          unit,
          pcp_profile_ndx,
          tag_pcp_ndx,
          tag_dei_ndx
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_stag_get_unsafe(
          unit,
          pcp_profile_ndx,
          tag_pcp_ndx,
          tag_dei_ndx,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_map_stag_get()", pcp_profile_ndx, tag_pcp_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_CTAG_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_eg_vlan_edit_pcp_map_ctag_set_verify(
          unit,
          pcp_profile_ndx,
          tag_up_ndx,
          out_pcp,
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_ctag_set_unsafe(
          unit,
          pcp_profile_ndx,
          tag_up_ndx,
          out_pcp,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_map_ctag_set()", pcp_profile_ndx, tag_up_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_CTAG_GET);
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_ctag_get_verify(
          unit,
          pcp_profile_ndx,
          tag_up_ndx
        );
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_ctag_get_unsafe(
          unit,
          pcp_profile_ndx,
          tag_up_ndx,
          out_pcp,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_map_ctag_get()", pcp_profile_ndx, tag_up_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_UNTAGGED_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_eg_vlan_edit_pcp_map_untagged_set_verify(
          unit,
          pcp_profile_ndx,
          tc_ndx,
          dp_ndx,
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_untagged_set_unsafe(
          unit,
          pcp_profile_ndx,
          tc_ndx,
          dp_ndx,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_map_untagged_set()", pcp_profile_ndx, tc_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_EG_VLAN_EDIT_PCP_MAP_UNTAGGED_GET);
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_untagged_get_verify(
          unit,
          pcp_profile_ndx,
          tc_ndx,
          dp_ndx
  ...
  res = soc_pb_pp_eg_vlan_edit_pcp_map_untagged_get_unsafe(
          unit,
          pcp_profile_ndx,
          tc_ndx,
          dp_ndx,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_eg_vlan_edit_pcp_map_untagged_get()", pcp_profile_ndx, tc_ndx);
}
