...
#else
     /* KeyA */
    {3, 0, 0, SOC_PPC_FP_QUAL_IRPP_IN_PORT_KEY_GEN_VAR,   4, 20, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* PP-Port[23:20] for ERP_MSB */
    {3, 0, 1, SOC_PPC_FP_QUAL_IRPP_IN_PORT_KEY_GEN_VAR,   16, 4, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* PP-Port[19:4] for ERP_LSB */
    {3, 0, 2, SOC_PPC_FP_QUAL_HDR_ITMH,                   1, 31-24, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* ITMH TC-Bit 24 */
    {3, 0, 3, SOC_PPC_FP_QUAL_IRPP_PTC_KEY_GEN_VAR,       6, 0, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* ? */

    {3, 1, 5, SOC_PPC_FP_QUAL_IRPP_IN_PORT_KEY_GEN_VAR,   32, 32, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* PMF_INST_32_BITS_MSB_DEFAULT_DESTINATION */
    {3, 1, 6, SOC_PPC_FP_QUAL_HDR_ITMH,                   32, 0, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* ITMH 32b */
    {3, 1, 8, SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES,              3, 0, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* All zeros */
    {3, 1,10, SOC_PPC_FP_QUAL_HDR_ITMH,                    1, 31-24, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* ITMH TC-Bit 24 */
    {3, 1,15, SOC_PPC_FP_QUAL_HDR_ITMH_DEST_FWD,          20, 0, SOC_SAND_BIT(ARAD_PMF_KEY_A)}, /* Forwarding Destination according to the PortForwarding Header*/

     /* KeyB */
    {3, 0,  6, SOC_PPC_FP_QUAL_HDR_ITMH,                 32, 0, SOC_SAND_BIT(ARAD_PMF_KEY_B)}, /* ITMH 32b */
    {3, 0, 12, SOC_PPC_FP_QUAL_IRPP_PKT_HDR_TYPE,         1, 0, SOC_SAND_BIT(ARAD_PMF_KEY_B)}, /* PFC0 of IS */

    {3, 1,  1, SOC_PPC_FP_QUAL_IRPP_ALL_ONES,             6, 0, SOC_SAND_BIT(ARAD_PMF_KEY_B)}, /* All ones for snoop MSB */
    {3, 1,  2, SOC_PPC_FP_QUAL_HDR_ITMH,                  3, 5, SOC_SAND_BIT(ARAD_PMF_KEY_B)}, /* ITMH.SnoopCommand */
    {3, 1, 14, SOC_PPC_FP_QUAL_IRPP_PTC_KEY_GEN_VAR,      8, 8, SOC_SAND_BIT(ARAD_PMF_KEY_B)}, /* BYTES_TO_REMOVE_HEADER_AND_FIX: PtcKeyGenVar 15:8 */

    /* KeyC */
    {3, 0,  4, SOC_PPC_FP_QUAL_HDR_ITMH_DEST_FWD,        20, 0, SOC_SAND_BIT(ARAD_PMF_KEY_C)}, /* Forwarding Destination according to the PortForwarding Header*/
    {3, 0,  9, SOC_PPC_FP_QUAL_HDR_ITMH,                  1, 31-24, SOC_SAND_BIT(ARAD_PMF_KEY_C)}, /* ITMH TC-Bit 24 */

    {3, 1,  7, SOC_PPC_FP_QUAL_HDR_ITMH_DEST_FWD,        20, 0, SOC_SAND_BIT(ARAD_PMF_KEY_C)}, /* Forwarding Destination according to the PortForwarding Header*/
    {3, 1, 11, SOC_PPC_FP_QUAL_HDR_ITMH_DEST_FWD,         4, 0, SOC_SAND_BIT(ARAD_PMF_KEY_C)}, /* Forwarding Destination 19:16*/

    /* KeyD */
    {3, 0, 8, SOC_PPC_FP_QUAL_IRPP_ALL_ONES,            1, 0, SOC_SAND_BIT(ARAD_PMF_KEY_D)}, /* 1 one */
    {3, 0,10, SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES,          5, 0, SOC_SAND_BIT(ARAD_PMF_KEY_D)}, /* 5 zeroes */
    {3, 0,11, SOC_PPC_FP_QUAL_IRPP_PROCESSING_TYPE,     0, 0, SOC_SAND_BIT(ARAD_PMF_KEY_D)}, /* Parser-Leaf-Context */

    {3, 1, 0, SOC_PPC_FP_QUAL_HDR_ITMH_DEST_FWD,        4, 0, SOC_SAND_BIT(ARAD_PMF_KEY_D)}, /* Forwarding Destination 19:16*/
#endif
...
CONST STATIC
  ...
  /* if (oam_test) begin
        ...
        PMF_FEM_SET_BIT_SELECT(14    , 2          , 5'd5);
            ...
            /* Regular TM Program */
  /*  FES-ID,                       Shift  Action type,       Is-Always-Valid                      Key-source      Key LSB        */
  {3, 0, {SOC_SAND_MAGIC_NUM_VAL,      25-16, SOC_PPC_FP_ACTION_TYPE_SNP, TRUE},                      ARAD_PMF_KEY_B, ARAD_PMF_KEY_LSB_80}, /* All ones + Snoop in ITMH (28:25) */
  {3, 1, {SOC_SAND_MAGIC_NUM_VAL,         23, SOC_PPC_FP_ACTION_TYPE_TC, TRUE},                       ARAD_PMF_KEY_B, ARAD_PMF_KEY_LSB_0}, /* Define 3 bits for TC            */
  {3, 2, {SOC_SAND_MAGIC_NUM_VAL,         28, SOC_PPC_FP_ACTION_TYPE_DP, TRUE},                       ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_96},
  {3, 3, {SOC_SAND_MAGIC_NUM_VAL,         21, SOC_PPC_FP_ACTION_TYPE_INVALID_NEXT, FALSE},            ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_112}, /* If set disable mirror by setting 0 in next action */
  {3, 4, {SOC_SAND_MAGIC_NUM_VAL,         31, SOC_PPC_FP_ACTION_TYPE_MIRROR, TRUE},                   ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_128}, /* Always set Profile=0 if enabled */
  {3, 5, {SOC_SAND_MAGIC_NUM_VAL,         22, SOC_PPC_FP_ACTION_TYPE_PPH_TYPE, TRUE},                 ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_112}, /* ITMH 31:30 */
  {3, 6, {SOC_SAND_MAGIC_NUM_VAL,          8, SOC_PPC_FP_ACTION_TYPE_DEST, TRUE},                     ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_128}, /* destination from default FMQ */
  {3, 7, {SOC_SAND_MAGIC_NUM_VAL,          3, SOC_PPC_FP_ACTION_TYPE_DEST, FALSE},                    ARAD_PMF_KEY_C, ARAD_PMF_KEY_LSB_80}, /* check if not MC */
  {3, 8, {SOC_SAND_MAGIC_NUM_VAL,          0, SOC_PPC_FP_ACTION_TYPE_DEST, FALSE},                    ARAD_PMF_KEY_C, ARAD_PMF_KEY_LSB_0},  /* check if not MT ==0 */
  {3,10, {SOC_SAND_MAGIC_NUM_VAL,          0, SOC_PPC_FP_ACTION_TYPE_IS, FALSE},                      ARAD_PMF_KEY_B, ARAD_PMF_KEY_LSB_0}, /* In case of Ingress-Shaping, set the Ingress Shaping destination {IS,PFC[0]} */
  {3,11, {SOC_SAND_MAGIC_NUM_VAL,         20, SOC_PPC_FP_ACTION_TYPE_INVALID_NEXT, FALSE},            ARAD_PMF_KEY_B, ARAD_PMF_KEY_LSB_0}, /* If flow is MC                   */
  {3,12, {SOC_SAND_MAGIC_NUM_VAL,         30, SOC_PPC_FP_ACTION_TYPE_TC, TRUE},                       ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_96}, /*   then update TC with 2 bits only */

  {3,16, {SOC_SAND_MAGIC_NUM_VAL,          1, SOC_PPC_FP_ACTION_TYPE_SYSTEM_HEADER_PROFILE_ID, TRUE}, ARAD_PMF_KEY_D, ARAD_PMF_KEY_LSB_80}, /* header profile is coded like the destination prefix. take 3 msb (19:17) */
  {3,17, {SOC_SAND_MAGIC_NUM_VAL,          2, SOC_PPC_FP_ACTION_TYPE_FWD_OFFSET, TRUE},               ARAD_PMF_KEY_D, ARAD_PMF_KEY_LSB_0},  /* Correct the Offset for Bytes2Remove */
  {3,18, {SOC_SAND_MAGIC_NUM_VAL,          0, SOC_PPC_FP_ACTION_TYPE_BYTES_TO_REMOVE, TRUE},          ARAD_PMF_KEY_B, ARAD_PMF_KEY_LSB_80}, 
  {3,19, {SOC_SAND_MAGIC_NUM_VAL,          0, SOC_PPC_FP_ACTION_TYPE_USER_HEADER_2, TRUE},            ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_80}, /* take all 19 bit dest from itmh without encoding */
  {3,20, {SOC_SAND_MAGIC_NUM_VAL,          3, SOC_PPC_FP_ACTION_TYPE_INVALID_NEXT, FALSE},            ARAD_PMF_KEY_C, ARAD_PMF_KEY_LSB_80}, /* Invalid next if not MC */
  {3,21, {SOC_SAND_MAGIC_NUM_VAL,          6, SOC_PPC_FP_ACTION_TYPE_DEST, FALSE},                    ARAD_PMF_KEY_A, ARAD_PMF_KEY_LSB_0},  /* Dest if not MT ==0: ERP VOQ */
#endif
  ...
  )
{
  ...
  res = sw_state_access[unit].dpp.soc.arad.tm.pmf.rsources.progs.set(unit, ARAD_FP_DATABASE_STAGE_INGRESS_PMF, 0, reserved_progs);
  ...
  )
{
  ...
  res = sw_state_access[unit].dpp.soc.arad.tm.pmf.psl_info.levels_info.get(unit, ARAD_FP_DATABASE_STAGE_INGRESS_PMF /*stage*/, 0x0 /*is_tm*/, 0, &dflt_level_info);
