...
#define _ARAD_PP_OAM_OPCODE_STAMP_OFFSET(opcode)                                                                \
    (((opcode==SOC_PPD_OAM_ETHERNET_PDU_OPCODE_LMM) ||                                                          \
      ...
      (opcode==SOC_PPD_OAM_ETHERNET_PDU_OPCODE_DMM)) ? 4 : (opcode==SOC_PPD_OAM_ETHERNET_PDU_OPCODE_LMR) ||     \
      (opcode==SOC_PPD_OAM_ETHERNET_PDU_OPCODE_SLM) ? 12 : (opcode==SOC_PPD_OAM_ETHERNET_PDU_OPCODE_SLR) ? 16 : \
...
#define _ARAD_PP_OAM_TCAM_NEW_ENTRY(oam_tcam_entry_key, oam_tcam_entry_action, tcam_entry_id, is_Mpls_ignore_MDL_Jericho)             \
  do{                                                                                                              \
...
#define ADD_TCAM_ENTRY_AND_SET_WB_VAR(oam_tcam_entry_key, oam_tcam_entry_action, is_Mpls_ignore_MDL_Jericho) \
  do {  \
        uint32 tcam_last_id;  \
        ...
        _ARAD_PP_OAM_TCAM_NEW_ENTRY(oam_tcam_entry_key, oam_tcam_entry_action, tcam_last_id, is_Mpls_ignore_MDL_Jericho); \
        ++tcam_last_id; \
 ...
 */
static ARAD_PP_INTERNAL_OPCODE_INIT   internal_opcode_init[SOC_PPD_OAM_OPCODE_MAP_COUNT] = {{0}};
      ...
      if ((tunnel_termination_code == SOC_PPD_PKT_TERM_TYPE_MPLS_ETH) ||
          ...
          for (tags = 0; tags <2; tags++) {
              ...
              for (mdl = 0; mdl <= _ARAD_PP_OAM_MAX_MD_LEVEL; mdl++) {
                  ...
                  ADD_TCAM_ENTRY_AND_SET_WB_VAR(oam_tcam_entry_key, oam_tcam_entry_action, 0 );
              }
          }
      }
  }
  ...
  )
{
  ...
  SOC_PPD_PKT_TERM_TYPE tunnel_termination_code_for_MDL_Jericho = 0;
  ...
  for (tunnel_termination_code = 0; tunnel_termination_code < SOC_PPD_NOF_PKT_TERM_TYPES; tunnel_termination_code++) {
      if ((tunnel_termination_code == SOC_PPD_PKT_TERM_TYPE_MPLS_ETH) ||
          ...
          for (channel_type_ndx = 0; channel_type_ndx < _ARAD_PP_OAM_MPLS_TP_CHANNEL_TYPE_ENUM_NOF; channel_type_ndx++) {
              ...
              oam_tcam_entry_key.ttc = tunnel_termination_code;
              if (SOC_IS_JERICHO(unit) && soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "oam_over_mpls_ignore_mdl", 0)) {
                  tunnel_termination_code_for_MDL_Jericho = (tunnel_termination_code == SOC_PPD_PKT_TERM_TYPE_MPLS_ETH) ? SOC_PPC_PKT_TERM_TYPE_CW_MPLS_ETH :
                                                            (tunnel_termination_code == SOC_PPD_PKT_TERM_TYPE_MPLS2_ETH) ? SOC_PPC_PKT_TERM_TYPE_CW_MPLS2_ETH : SOC_PPC_PKT_TERM_TYPE_CW_MPLS3_ETH;
                  ...
                  oam_tcam_entry_action.oam_stamp_offset = _ARAD_PP_OAM_OPCODE_STAMP_OFFSET(SOC_PPD_OAM_ETHERNET_PDU_OPCODE_CCM);
              ...
              if (oam_tcam_entry_key.channel_type != 0) {
                  ...
                  if (is_bfd) {
                      if (channel_format == _ARAD_PP_OAM_MPLS_TP_FORMAT_TYPE_BFD_RAW) {
                          ...
                          ADD_TCAM_ENTRY_AND_SET_WB_VAR(oam_tcam_entry_key, oam_tcam_entry_action, is_Mpls_ignore_MDL_Jericho);
                      }
                  } else { /* oam */
                      if (channel_format == _ARAD_PP_OAM_MPLS_TP_FORMAT_TYPE_Y1731 || channel_format == _ARAD_PP_OAM_MPLS_TP_FORMAT_TYPE_OAM_UNKNOWN) {
                          ...
                          if (channel_format == _ARAD_PP_OAM_MPLS_TP_FORMAT_TYPE_Y1731) {
                             ...
                             /* Mapping unknown channel types to opcode CCM */
                              res = sw_state_access[unit].dpp.bcm.oam.y1731_opcode_to_intenal_opcode_map.get(unit, SOC_PPD_OAM_ETHERNET_PDU_OPCODE_CCM, &internal_opcode);
                              SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 50, exit);
  ...
  )
{
  ...
  _ARAD_PP_OAM_TCAM_NEW_ENTRY(oam_tcam_entry_key, oam_tcam_entry_action, tcam_entry_id, 0);
  ...
  )
{
  ...
  for (i=0; i < 2; i++){
      ...
      /* get internal opcode*/
      if (i==0) {
          res = sw_state_access[unit].dpp.bcm.oam.y1731_opcode_to_intenal_opcode_map.get(unit, SOC_PPD_OAM_ETHERNET_PDU_OPCODE_LMM, &internal_opcode); 
          SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 50, exit);
      } else {
          res = sw_state_access[unit].dpp.bcm.oam.y1731_opcode_to_intenal_opcode_map.get(unit, SOC_PPD_OAM_ETHERNET_PDU_OPCODE_LMR, &internal_opcode); 
          SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 50, exit);
      }
  ...
  )
{
  ...
  if (is_bfd) {
      ...
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 214, exit);
      res = sw_state_access[unit].dpp.bcm.bfd.trap_info.trap_ids.get(unit, SOC_PPD_BFD_TRAP_ID_CPU, &trap_code);
      ...
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 214, exit);
      res = sw_state_access[unit].dpp.bcm.bfd.trap_info.trap_ids.get(unit, SOC_PPD_BFD_TRAP_ID_OAMP_CC_MPLS_TP, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, oam_trap_code);
      ...
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 214, exit);
      res = sw_state_access[unit].dpp.bcm.bfd.trap_info.trap_ids.get(unit, SOC_PPD_BFD_TRAP_ID_OAMP_MPLS, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, oam_trap_code);
      res = sw_state_access[unit].dpp.soc.arad.pp.bfd.trap_code_oamp_bfd_mpls.set(unit, oam_trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 214, exit);
      res = sw_state_access[unit].dpp.bcm.bfd.trap_info.trap_ids.get(unit, SOC_PPD_BFD_TRAP_ID_OAMP_PWE, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, oam_trap_code);
      ...
      res = sw_state_access[unit].dpp.bcm.oam.trap_info.trap_ids.get(unit, SOC_PPD_OAM_TRAP_ID_RECYCLE, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      res = arad_pp_trap_frwrd_profile_info_get(unit,  /*ARAD_PP_TRAP_CODE*/trap_code, &profile_info);
      ...
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 236, exit);
      res = sw_state_access[unit].dpp.bcm.oam.trap_info.trap_ids.get(unit, SOC_PPD_OAM_TRAP_ID_SNOOP, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, oam_trap_code);
      res = sw_state_access[unit].dpp.soc.arad.pp.oam.trap_code_snoop.set(unit, oam_trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 236, exit);
      res = sw_state_access[unit].dpp.bcm.oam.trap_info.trap_ids.get(unit, SOC_PPD_OAM_TRAP_ID_ERR_LEVEL, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, oam_trap_code);
      res = sw_state_access[unit].dpp.soc.arad.pp.oam.trap_code_trap_to_cpu_level.set(unit, oam_trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 236, exit);
      res = sw_state_access[unit].dpp.bcm.oam.trap_info.trap_ids.get(unit, SOC_PPD_OAM_TRAP_ID_ERR_PASSIVE, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, oam_trap_code);
      ...
      res = sw_state_access[unit].dpp.bcm.oam.trap_info.upmep_trap_ids.get(unit, SOC_PPD_OAM_UPMEP_TRAP_ID_CPU, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      _ARAD_PP_OAM_TRAP_CODE_TO_INTERNAL(unit, trap_code, mirror_trap_code);
      ...
      /* Mirror profiles */
      res = sw_state_access[unit].dpp.bcm.oam.trap_info.mirror_ids.get(unit, SOC_PPD_OAM_MIRROR_ID_RECYCLE, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      res = sw_state_access[unit].dpp.soc.arad.pp.oam.mirror_profile_recycle.set(unit, trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 247, exit);

      res = sw_state_access[unit].dpp.bcm.oam.trap_info.mirror_ids.get(unit, SOC_PPD_OAM_MIRROR_ID_SNOOP, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      res = sw_state_access[unit].dpp.soc.arad.pp.oam.mirror_profile_snoop_to_cpu.set(unit, trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 247, exit);

      res = sw_state_access[unit].dpp.bcm.oam.trap_info.mirror_ids.get(unit, SOC_PPD_OAM_MIRROR_ID_ERR_LEVEL, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
      res = sw_state_access[unit].dpp.soc.arad.pp.oam.mirror_profile_err_level.set(unit, trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 247, exit);

      res = sw_state_access[unit].dpp.bcm.oam.trap_info.mirror_ids.get(unit, SOC_PPD_OAM_MIRROR_ID_ERR_PASSIVE, &trap_code);
      SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
    ...
    ARAD_PP_TRAP_FRWRD_ACTION_PROFILE_INFO_clear(&profile_info);
    if(is_bfd) {
        res = sw_state_access[unit].dpp.bcm.bfd.trap_info.trap_ids.get(unit, SOC_PPD_BFD_TRAP_ID_CPU, &cpu_trap_code);
    } else {
        res = sw_state_access[unit].dpp.bcm.oam.trap_info.trap_ids.get(unit, SOC_PPD_OAM_TRAP_ID_CPU, &cpu_trap_code);
    }
    SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  soc_reg_field_set(unit, IHP_OAM_COUNTER_INCREMENT_BITMAPr, &reg, OAM_COUNTER_INCREMENTf, 0x1);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 80, exit, WRITE_IHP_OAM_COUNTER_INCREMENT_BITMAPr(unit, SOC_CORE_ALL, reg));
      ...
      for (mep_type = 0; mep_type < nof_mp_types_to_set; mep_type++) {
          ...
          for (mip_type = 0; mip_type <nof_mp_types_to_set; mip_type++) {
              ...
              if (is_bfd) {
                  ...
                  oam1_key.opcode = SOC_PPD_OAM_OPCODE_MAP_BFD;
                  res = sw_state_access[unit].dpp.bcm.oam.y1731_opcode_to_intenal_opcode_map.get(unit, SOC_PPD_OAM_ETHERNET_PDU_OPCODE_CCM, &internal_opcode);
                  SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 15, exit);
                  ...
                  *meter_disable_lcl = profile_data->mip_profile_data.meter_disable;
                  ...
                  for (is_my_cfm_mac = 0; is_my_cfm_mac <=1; is_my_cfm_mac++) {
                      oam1_key.my_cfm_mac = is_my_cfm_mac;
                      for (internal_opcode = 1; internal_opcode < SOC_PPD_OAM_OPCODE_MAP_COUNT;  internal_opcode++) {
                          oam1_key.opcode = internal_opcode;
                          res = _arad_pp_oam_set_counter_disable(unit , internal_opcode, (&oam_payload), &profile_data->mep_profile_data, 0);
                          SOC_SAND_SOC_CHECK_FUNC_RESULT(res, 15, exit);
                          *meter_disable_lcl = profile_data->mip_profile_data.meter_disable;
  ...
  )
{
    ...
    *meter_disable_lcl = profile_data->mep_profile_data.meter_disable;
    ...
    if(((internal_opcode_init[internal_opcode].additional_info == ARAD_PP_OAM_OPCODE_LBM) || (internal_opcode_init[internal_opcode].additional_info == ARAD_PP_OAM_OPCODE_LBR)) &&
            oam_trap_code == SOC_PPD_TRAP_CODE_OAM_OAMP_MIRROR) {
                                                                            ...
                                                                            SOC_SAND_IN SOC_PPD_OAM_LIF_PROFILE_DATA       *profile_data)
{
    ...
    res = arad_pp_trap_mgmt_trap_code_to_internal(unit, oam_trap_code, &oam_payload.cpu_trap_code, &strength_fld_fwd, &strength_fld_snp);
    SOCDNX_SAND_IF_ERR_EXIT(res);
            ...
            for (mp_type = 0; mp_type < SOC_PPC_OAM_MP_TYPE_COUNT_PLUS; mp_type++) {
                ...
                case SOC_PPD_OAM_MP_TYPE_MEP_OR_ACTIVE_MATCH_PLUS: /* Mep active match */
                    if (SOC_PPD_OAM_IS_CLASSIFIER_ARAD_MODE(unit)) { /* Arad mode*/
                        ...
                        for (oam1_key.mip_type = SOC_PPD_OAM_MP_TYPE_ABOVE; oam1_key.mip_type <= SOC_PPC_OAM_MP_TYPE_BELOW; oam1_key.mip_type++) {
                ...
                case SOC_PPD_OAM_MP_TYPE_BELOW_PLUS: /* Drop Level */
                    ...
                    if (SOC_PPD_OAM_IS_CLASSIFIER_ARAD_MODE(unit)) {
                        ...
                        for (oam1_key.mep_type = SOC_PPD_OAM_MP_TYPE_BELOW;
                              oam1_key.mep_type < SOC_PPD_OAM_MP_TYPE_COUNT;
                              oam1_key.mep_type++) {
                            for (oam1_key.mip_type = SOC_PPD_OAM_MP_TYPE_MATCH;
                                  oam1_key.mip_type < SOC_PPD_OAM_MP_TYPE_COUNT;
                                  oam1_key.mip_type++) {
                                oam_payload.snoop_strength = 0;
                                res = sw_state_access[unit].dpp.soc.arad.pp.oam.mirror_profile_err_level.get(unit, &oam_mirror_profile);
                                SOCDNX_SAND_IF_ERR_EXIT(res);
                                                                                    ...
                                                                                    SOC_SAND_INOUT  _oam_oam_a_b_table_buffer_t *oam_buffer)
{
    ...
    oam2_key.ingress = !(classifier_mep_entry->flags & SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_UPMEP);
    oam2_key.mp_profile = classifier_mep_entry->acc_profile;
    if (oam2_key.is_bfd) { /* Accelerated BFD */
        oam2_key.my_cfm_mac = 0;
        res = sw_state_access[unit].dpp.bcm.oam.y1731_opcode_to_intenal_opcode_map.get(unit, SOC_PPD_OAM_ETHERNET_PDU_OPCODE_CCM, &internal_opcode);
        SOCDNX_SAND_IF_ERR_EXIT(res);
        oam2_key.opcode = SOC_PPD_OAM_OPCODE_MAP_BFD;
        oam_payload.forwarding_strength = _ARAD_PP_OAM_TRAP_STRENGTH;
        oam_payload.up_map = ((classifier_mep_entry->flags & SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY_FLAG_UPMEP) != 0 );
        oam_payload.meter_disable = 0;
                                                 ...
                                                 SOC_SAND_IN  SOC_PPD_OAM_LIF_PROFILE_DATA  *profile_data)
{
    ...
    for(internal_opcode=0; internal_opcode < SOC_PPD_OAM_OPCODE_MAP_COUNT; internal_opcode++)
    {
  ...
  )
{
  ...
  if ((classifier_mep_entry->mep_type == SOC_PPD_OAM_MEP_TYPE_ETH_OAM) && update != 1) {
  ...
  if (!SOC_PPD_OAM_IS_MEP_TYPE_BFD(classifier_mep_entry->mep_type) ||
      ...
      if (SOC_PPD_OAM_IS_MEP_TYPE_BFD(classifier_mep_entry->mep_type) && update != 1 && found) { /* BFD */
          LOG_ERROR(BSL_LS_SOC_OAM,
                    (BSL_META_U(unit,
      ...
      if (mep_db_entry->mep_type == SOC_PPD_OAM_MEP_TYPE_BFD_O_IPV4_1_HOP) {
          ...
          if (SOC_IS_ARADPLUS((unit))) {
              ...
              if (SOC_IS_JERICHO(unit) && reg_val) {
                  ...
                  case SOC_PPD_BFD_ACH_TYPE_PWE_CW:
                      reg_val = 0;
                      break;
                  case SOC_PPD_BFD_ACH_TYPE_GACH_CC:
                      reg_val = 1;
                      break;
                  default:
                      break;
  ...
  )
{
 ...
 LOG_DEBUG(BSL_LS_SOC_OAM,
  ...
  if (PPC_API_OAM_STORE_LOCAL_PORT_IN_MEP_DB(mep_db_entry->mep_type)) {
      if (mep_db_entry->local_port!=-1 && ((SOC_IS_ARAD_B0_AND_ABOVE(unit) && !mep_db_entry->is_upmep) || SOC_PPD_OAM_IS_MEP_TYPE_BFD(mep_db_entry->mep_type) ||
...
static uint32 arad_pp_oam_oamp_rmep_db_set_unsafe(int unit,
                                                                uint32                   rmep_index,
                                                                uint32                   mep_index,
                                                                const SOC_PPD_OAM_OAMP_RMEP_DB_ENTRY  *rmep_db_entry ,
                                                                uint8                    update )
{
    uint32  res;
  ...
  ) 
{
    ...
    if (event_type == JER_PP_OAM_API_DMA_EVENT_TYPE_STAT_EVENT) /* Event is statistics report (LM/DM) */
    {
    ...
    else /* JER_PP_OAM_API_DMA_EVENT_TYPE_EVENT */
    {
  ...
  )
{
	...
	soc_reg_field_set(unit,OAMP_PROTECTION_PACKET_CONFr,&reg32, PROTECTION_PACKET_HEADER_NUM_OF_BYTESf, SOC_PPD_OAM_FULL_PROTECTION_HEADER_SIZE);
  ...
  )
{
    ...
    if (!is_lm || (is_lm && exists_or_removing_piggy_back_down)) {
        ...
        soc_mem_t mem;
        SOC_REG_ABOVE_64_CLEAR(entry);
        GET_CCM_ENTRY( endpoint_id,  entry, mem);
        ...
        if ((SOC_IS_JERICHO(unit) || ccm_type != SOC_PPD_OAM_MEP_TYPE_ETH_OAM) && !is_lm) {
            uint32 mep_pe_prof=0;
        ...
        if ( (SOC_IS_ARADPLUS_A0(unit) &&  ccm_type == SOC_PPD_OAM_MEP_TYPE_ETH_OAM)
...
int _insert_pph(soc_reg_above_64_val_t pkt_header_reg,const PPH_base * pph_fields, int offset) {
    ...
    INSERT_INTO_REG(pkt_header_reg,offset,7, 52, 2 ,pph_fields->field_1);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 48, 4 ,pph_fields->field_2);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 41, 7, pph_fields->field_3);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 40, 1, pph_fields->field_4);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 38, 2, pph_fields->field_5);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 36, 2, pph_fields->field_6);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 35, 1, pph_fields->field_7);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 34, 1, pph_fields->field_8);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 18, 16, pph_fields->field_9);
    INSERT_INTO_REG(pkt_header_reg,offset,7, 0, 18, pph_fields->field_10);
       ...
       )
{
    ...
    if (next_is_itmh) {
		...
		header_size += _insert_itmh(unit, pkt_header, fwd_dst_info, dp, tc, 0, 0, (mep_db_entry.mep_type == SOC_PPD_OAM_MEP_TYPE_Y1731_O_MPLSTP || mep_db_entry.mep_type == SOC_PPD_OAM_MEP_TYPE_Y1731_O_PWE)); 
    }
    ...
    if (mep_db_entry.mep_type == SOC_PPD_OAM_MEP_TYPE_ETH_OAM) {
        ...
        pph.field_1 = 0;
        pph.field_2 = _ARAD_PP_OAM_FWD_CODE_MPLS; /*mpls/PWE*/
       ...
       )
{
    ...
    if (event_type == JER_PP_OAM_API_DMA_EVENT_TYPE_STAT_EVENT)
    {
...
uint32
  /* coverity explaination:the function use for diag, it's called by cmd_dpp_diag*/
  /* coverity[dead_error_begin : FALSE] */  
...
{ 
    ...
    arad_pp_diag_received_packet_info_get(unit, core_id, &rpi, &res);
   ...
   )
{
    ...
    SOC_SAND_ERR_IF_ABOVE_NOF(LIF, OAM_LIF_MAX_VALUE(unit), ARAD_PP_LIF_ID_OUT_OF_RANGE_ERR, 110, exit);
    ...
    if (*found) { /* Entry found in OEM-2, construct OAM-2 key and print */
        ...
        *found = 2; /* For printing that the key is for OAM-2 */
        ...
        if (*found) {
            ...
            /* Construct key */
            _ARAD_PP_OAM_OAM1_KEY_STRUCT_TO_KEY(act_key, *key);
...
uint32
  arad_pp_oam_diag_print_ak_unsafe(
     SOC_SAND_IN int unit,
     SOC_SAND_IN ARAD_PP_OAM_ACTION_KEY_PARAMS *provided_key_params
   ){
    uint32 res = SOC_SAND_OK;

    ARAD_PP_OAM_ACTION_KEY_PARAMS key_params;
...
{ 
    ...
    res = arad_pp_diag_received_packet_info_get(unit,core_id,&rpi,&ret_val);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
