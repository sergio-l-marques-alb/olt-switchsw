...
void
  ARAD_PP_MTR_COLOR_DECISION_INFO_clear(
    SOC_SAND_OUT ARAD_PP_MTR_COLOR_DECISION_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
void
  ARAD_PP_MTR_COLOR_RESOLUTION_INFO_clear(
    SOC_SAND_OUT ARAD_PP_MTR_COLOR_RESOLUTION_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
