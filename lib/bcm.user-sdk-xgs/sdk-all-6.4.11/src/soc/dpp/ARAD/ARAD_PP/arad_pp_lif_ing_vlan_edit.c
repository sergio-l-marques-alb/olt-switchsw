...
#define ARAD_PP_LIF_ING_VLAN_EDIT_VID_SOURCE_MAX                 (ARAD_PP_NOF_LIF_ING_VLAN_EDIT_TAG_VID_SRCS-1)
#define ARAD_PP_LIF_ING_VLAN_EDIT_PCP_DEI_SOURCE_MAX             (ARAD_PP_NOF_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRCS-1)
...
#define ARAD_PP_LIF_ING_VLAN_EDIT_PCP_DEI_SRC_TO_FLD_CASE(fld_val, src_suffix) \
  case ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_##src_suffix: \
...
#define ARAD_PP_LIF_ING_VLAN_EDIT_PCP_DEI_FLD_TO_SRC_CASE(src, src_suffix) \
  case ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_VID_SRC_FLD_VAL_##src_suffix: \
    src = ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_##src_suffix; \
    break;
...
#define ARAD_PP_LIF_ING_VLAN_EDIT_VID_SRC_TO_FLD_CASE(fld_val, src_suffix) \
  case ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_##src_suffix: \
    fld_val = ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_VID_SRC_FLD_VAL_##src_suffix; \
    break;
...
#define ARAD_PP_LIF_ING_VLAN_EDIT_VID_FLD_TO_SRC_CASE(src, src_suffix) \
  case ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_VID_SRC_FLD_VAL_##src_suffix: \
    src = ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_##src_suffix; \
    break;
  ...
  Arad_pp_procedure_desc_element_lif_ing_vlan_edit[] =
{
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_lif_ing_vlan_edit[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_LIF_ING_VLAN_EDIT_TAG_VID_SRCS-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRCS-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY, command_key, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET_VERIFY);
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO, command_info, 20, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(command_info);

  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_clear(command_info);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY_verify()",0,0);
}
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO, &(info->inner_tag), 12, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO, &(info->outer_tag), 13, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_verify()",0,0);
}
