  ...
  )
{
    ...
    ARAD_PP_FRWRD_MACT_OPER_MODE_INFO       oper_mode_info;
    int32 age_ndx;
    uint32 is_owned;
    int32 final_age;
    ...
    arad_pp_frwrd_mact_oper_mode_info_get(unit, &oper_mode_info);

    /* In some learning modes delete event is raised and in other modes aged out event is raised*/
