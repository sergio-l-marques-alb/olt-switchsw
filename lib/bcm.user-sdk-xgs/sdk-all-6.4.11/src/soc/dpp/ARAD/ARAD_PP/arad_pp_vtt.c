...
{
/*
   valid BM|    Name                                 |            Global sw db enum                          |      Pointer to 'vtt_table_property_set' function            |           Memory Type               | key type (for tcam use SOC_DPP_DBAL_ATI_***)              |  Additional Info */
    ...
    { 0, "VTT DIPv6 TCAM"                            , SOC_DPP_DBAL_SW_TABLE_ID_DIPv6_TCAM                    , arad_pp_dbal_sw_db_dipv6_tcam_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , ARAD_PP_ISEM_ACCESS_KEY_TYPE_IPV6_TUNNEL_DIP             , IP_NOT_COMPRESSED     }, /* DIPv6 */
    { 0, "VTT DIPv6 COMPRESSED TCAM"                 , SOC_DPP_DBAL_SW_TABLE_ID_DIPv6_COMPRESSED_TCAM         , arad_pp_dbal_sw_db_dipv6_tcam_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , ARAD_PP_ISEM_ACCESS_KEY_TYPE_SPOOF_SIP6_TCAM_COMPRESSION , IP_COMPRESSED         }, /*  | DIPv6 */
...
/* MPLS DB's finish */
    ...
    { 0, "VTT VRRP UNTAGGED TCAM"                    , SOC_DPP_DBAL_SW_TABLE_ID_UNTAGGED_VRRP_TCAM            , arad_pp_dbal_sw_db_vrrp_tcam_property_set                    , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , ARAD_PP_ISEM_ACCESS_KEY_TYPE_VSI_DA_DB_VRRP_TCAM         , TST1_VID_UNTAGGED       },
    { 0, "VTT VRRP ONE TAG TCAM"                     , SOC_DPP_DBAL_SW_TABLE_ID_ONE_TAG_VRRP_TCAM             , arad_pp_dbal_sw_db_vrrp_tcam_property_set                    , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , ARAD_PP_ISEM_ACCESS_KEY_TYPE_VSI_DA_DB_VRRP_TCAM         , TST1_VID_ONE_TAG        },
    { 0, "VTT VRRP DOUBLE TCAM"                      , SOC_DPP_DBAL_SW_TABLE_ID_DOUBLE_TAG_VRRP_TCAM          , arad_pp_dbal_sw_db_vrrp_tcam_property_set                    , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , ARAD_PP_ISEM_ACCESS_KEY_TYPE_VSI_DA_DB_VRRP_TCAM         , TST1_VID_DOUBLE_TAG     },
    ...
    { 0, "VTT MPLS LABEL4 UNINDEXED SEM A"           , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L4_UNINDEXED_SEM_A       , arad_pp_dbal_sw_db_mpls_unidexed_prefix_sem_property_set     , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A , 0                                                        , MPLS_LABEL_3          }, /* mpls label | bos(depend on soc property) */
    { 0, "VTT MPLS LABEL4 UNINDEXED SEM B"           , SOC_DPP_DBAL_SW_TABLE_ID_MPLS_L4_UNINDEXED_SEM_B       , arad_pp_dbal_sw_db_mpls_unidexed_prefix_sem_property_set     , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_B , 0                                                        , MPLS_LABEL_3          }, /* mpls label | bos(depend on soc property) */
    { 0, "VTT MY-VTEP-INDEX SIP VRF SEM A"           , SOC_DPP_DBAL_SW_TABLE_ID_MY_VTEP_INDEX_SIP_VRF_SEM_A   , arad_pp_dbal_sw_db_my_vtep_index_sip_vrf_sem_property_set    , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A , 0                                                        , 0                       }
};
...
/*38*/    {ARAD_PP_DBAL_VT_PROG_UNTAGGED_VRRP                                             , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_UNTAGGED   },
/*39*/    {ARAD_PP_DBAL_VT_PROG_ONE_TAG_VRRP                                              , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_ONE_TAG    },
/*40*/    {ARAD_PP_DBAL_VT_PROG_DOUBLE_TAG_VRRP                                           , arad_pp_dbal_vt_program_vrrp_property_set                                    , {-1}    , TST1_VID_DOUBLE_TAG },
...
/*35*/    {ARAD_PP_DBAL_TT_PROG_IPV4_FOR_EXPLICIT_NULL        , arad_pp_dbal_tt_program_ipv4_for_explicit_mpls_property_set         , {-1}    , 0                    },
/*36*/    {ARAD_PP_DBAL_TT_PROG_TUNNEL_TWO_EXPLICIT_NULL      , arad_pp_dbal_tt_program_tunnel_two_explicit_mpls_property_set       , {-1}    , 0                    },
/*36*/    {ARAD_PP_DBAL_TT_PROG_TUNNEL_THREE_EXPLICIT_NULL    , arad_pp_dbal_tt_program_tunnel_three_explicit_mpls_property_set     , {-1}    , 0                    }
};
...
void arad_pp_dbal_sw_db_dip_sip_vrf_tcam_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 unused) 
{
    ...
    sw_db_property->qual_info[4].qual_type = SOC_PPC_FP_QUAL_GRE_PROTOCOL_TYPE;   /* GRE.protocol_type */
...
void arad_pp_dbal_vt_program_vrrp_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 vid_type)
{
    ...
    switch(vid_type)
     ...
     case TST1_VID_UNTAGGED:
         ...
         program_property->qual_to_ce_info.qualifier_to_ce_id[0][0] = 6; /*VD*/
     ...
     case TST1_VID_ONE_TAG:
         ...
         program_property->qual_to_ce_info.qualifier_to_ce_id[0][0] = 6; /*VD*/
         program_property->qual_to_ce_info.qualifier_to_ce_id[0][1] = 5; /*Initial VID*/

         program_property->qual_to_ce_info.qualifier_to_ce_id[1][0] = 6; /*VD*/
         program_property->qual_to_ce_info.qualifier_to_ce_id[1][1] = 4; /*Outer VID*/
         break;
     case TST1_VID_DOUBLE_TAG:
         program_property->nof_keys = 3;
         program_property->vtt_table_index[0] = SW_DB_DBAL2VTT(SOC_DPP_DBAL_SW_TABLE_ID_OUTER_INNER_VD_SEM_A);
         ...
         program_property->qual_to_ce_info.qualifier_to_ce_id[0][0] = 6; /*VD*/
         program_property->qual_to_ce_info.qualifier_to_ce_id[0][1] = 4; /*Outer VID*/
         program_property->qual_to_ce_info.qualifier_to_ce_id[0][2] = 3; /*Inner VID*/
    ...
    program_property->qual_to_ce_info.qualifier_to_ce_id[tcam_indx][0] = 7; /* initial-VID/CMPRSD-OUTER*/
    program_property->qual_to_ce_info.qualifier_to_ce_id[tcam_indx][1] = 6; /* VD */
    program_property->qual_to_ce_info.qualifier_to_ce_id[tcam_indx][2] = 3; /* INNERVID/ZEROES */
    program_property->qual_to_ce_info.qualifier_to_ce_id[tcam_indx][3] = 2; /* DA */
...
int32 arad_pp_dbal_vt_cam_untagged_vrrp_set(int unit,  ARAD_PP_IHP_VTT1ST_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused)
{
    ...
    prog_selection->in_pp_port_vt_profile          = (ARAD_PP_PORT_DEFINED_VT_PROFILE_VRRP_PORT);
    prog_selection->in_pp_port_vt_profile_mask     = 0x0;
