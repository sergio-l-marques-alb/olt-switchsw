...
/* $Id: arad_pp_eg_vlan_edit.c,v 1.27 Broadcom SDK $
...
#define ARAD_PP_EG_VLAN_EDIT_KEY_MAPPING_MAX                     (ARAD_PP_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEYS-1)
...
#define ARAD_PP_EG_VLAN_EDIT_VID_SOURCE_MAX                      (ARAD_PP_NOF_EG_VLAN_EDIT_TAG_VID_SRCS-1)
#define ARAD_PP_EG_VLAN_EDIT_PCP_DEI_SOURCE_MAX                  (ARAD_PP_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_SRCS-1)
#define ARAD_PP_EG_VLAN_EDIT_TAGS_TO_REMOVE_MAX                  (2)
#define ARAD_PP_DEI_CFI_MAX                                      (1)
#define ARAD_PP_EG_VLAN_EDIT_NEW_LINK_PCP_PROFILE_NDXS           (4) /* for jer */
#define ARAD_PP_EG_VLAN_EDIT_NEW_LINK_PCP_PROFILE_NDX_MAX        (ARAD_PP_EG_VLAN_EDIT_NEW_LINK_PCP_PROFILE_NDXS-1) /* for jer */
...
#define ARAD_PP_EG_VLAN_EDIT_PCP_DEI_SRC_TO_FLD_CASE(fld_val, src_suffix) \
  case ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_##src_suffix: \
...
#define ARAD_PP_EG_VLAN_EDIT_PCP_DEI_FLD_TO_SRC_CASE(src, src_suffix) \
  ...
  src = ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_##src_suffix; \
  break;
...
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_EMPTY 0
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_OUTER_TAG 1
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_INNER_TAG 2
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_EDIT_INFO_0 3
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_EDIT_INFO_1 4
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_VSI 5

#define ARAD_PP_EG_VLAN_EDIT_VID_SRC_TO_FLD_CASE(fld_val, src_suffix) \
  case ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_##src_suffix: \
  fld_val = ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_##src_suffix; \
  break;
...
#define ARAD_PP_EG_VLAN_EDIT_VID_FLD_TO_SRC_CASE(src, src_suffix) \
  case ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_##src_suffix: \
  src = ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_##src_suffix; \
  break;
  ...
  Arad_pp_procedure_desc_element_eg_vlan_edit[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_eg_vlan_edit[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEYS-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_VLAN_EDIT_TAG_VID_SRCS-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_SRCS-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
...

  {
    ...
    "ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC).\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  {
    ARAD_PP_PKT_FRWRD_TYPE_NDX_OUT_OF_RANGE_ERR,
    "ARAD_PP_PKT_FRWRD_TYPE_NDX_OUT_OF_RANGE_ERR,",
    "Packet forward type ndx is out of range. \n\r "
    "Allowed values are  (see \n\r"
    "ARAD_PP_PKT_FRWRD_TYPE).\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  ...
  uint32
      ...
      pcp_profile_ndx, up_ndx, tc_ndx, dp_ndx;
  uint64 
      reg_val;
  ...
  inner_tpid = 0;
  inner_vid = ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_EMPTY;
  outer_pcp_dei = ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_FLD_VAL_SRC_MAP;
  outer_tpid = 0;
  outer_vid = ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_FLD_VAL_EMPTY;
  tags_to_remove = 0;

  /*arad_pp_reps_for_tbl_set_unsafe(unit, ARAD_PP_MAX_NOF_REPS);*/
  data[0] = ARAD_PP_EPNI_EGRESS_EDIT_CMD_TBL_INFO(outer_tpid, inner_tpid, outer_vid, inner_vid, outer_pcp_dei, inner_pcp_dei, tags_to_remove)
  ...
  /* In legacy mode consider tag format as tagged for TX-tagged processing */
  if (SOC_DPP_CONFIG(unit)->pp.outer_vid_existence_class_mode) {
    SOC_SAND_SOC_IF_ERROR_RETURN(res, 40, exit,WRITE_EPNI_PACKET_HAS_OUTER_VIDr(unit, REG_PORT_ANY, 0));
  } else {
    SOC_SAND_SOC_IF_ERROR_RETURN(res, 50, exit,WRITE_EPNI_PACKET_HAS_OUTER_VIDr(unit, REG_PORT_ANY, 0xfffe));
  }

  /* Init packet-is-tagged-after-eve indication for all EVEC ids */
  if (SOC_DPP_CONFIG(unit)->pp.outer_vid_existence_class_mode) {
  ...
  /* 
   * Default Mapping TC to PCP 
   * TC i , DP x to UP i 
   * DEI always 0 
   */
  pcp_profile_ndx = 0; /* Deafult PCP Profile */
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_PEP_KEY, pep_key, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_VLAN_EDIT_PEP_INFO, pep_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_PEP_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(pep_key);
  SOC_SAND_CHECK_NULL_INPUT(pep_info);

  ARAD_PP_EG_VLAN_EDIT_PEP_INFO_clear(pep_info);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_SET_VERIFY);

  res = ARAD_PP_EG_VLAN_EDIT_COMMAND_KEY_verify(unit, command_key);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO, command_info, 20, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(command_key);
  SOC_SAND_CHECK_NULL_INPUT(command_info);

  ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_clear(command_info);
  ...
  )
{
  ...
  bit_val = SOC_SAND_BOOL2NUM(key_mapping == ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_TC_DP);
  ...
  /* set UseTcDp field for jericho: a new mapping table for ROO application. 
   * Will be allocate just like the PCP_DEI_PROFILE mapping table.
   * The new mapping table differentiate between inner and outer vlan.
   * The current implementation, we allocate the same mapping value for inner and outer vlans.
   * new mapping table format:
   * {outer_use_tc_dp[3:0],  outer_use_dscp_exp[7:4], inner_user_tc_dp[11:8], inner_use_dscp_exp[15:12]}
   */
  if (SOC_IS_JERICHO(unit) && SOC_IS_JERICHO_AND_BELOW(unit)) {
      if (pcp_profile_ndx <= ARAD_PP_EG_VLAN_EDIT_NEW_LINK_PCP_PROFILE_NDX_MAX) {
          ...
          /* we allocate the same mapping value for inner and outer. */
  ...
  bit_val = SOC_SAND_BOOL2NUM(key_mapping == ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_DSCP_EXP);
  ...
  /* set MapDscpExp field for jericho. See explanation in "UseTcDp field for jericho"  */
  if (SOC_IS_JERICHO(unit) && SOC_IS_JERICHO_AND_BELOW(unit)) {
      if (pcp_profile_ndx <= ARAD_PP_EG_VLAN_EDIT_NEW_LINK_PCP_PROFILE_NDX_MAX) {
          ...
          /* we allocate the same mapping value for inner and outer vlans. */
  ...
  )
{
  ...
  if (dscp_exp_bit_val) {
       *key_mapping = ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_DSCP_EXP;
  } 
  else if (tc_dp_bit_val) {
      *key_mapping = ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_TC_DP;
  } else {
      *key_mapping = ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_PCP;
  }
  ...
  )
{
  ...
  switch(pkt_type_ndx) {
    ...
    case ARAD_PP_PKT_FRWRD_TYPE_TM:
    break;
    default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_HDR_TYPE_NDX_OUT_OF_RANGE_ERR, 20, exit);
  }

  if (pkt_type_ndx == ARAD_PP_PKT_FRWRD_TYPE_MPLS ) {
...
uint32
  ARAD_PP_EG_VLAN_EDIT_PEP_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_VLAN_EDIT_PEP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_EG_VLAN_EDIT_COMMAND_KEY_verify(
    SOC_SAND_IN  int unit,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_VLAN_EDIT_COMMAND_KEY_verify()",0,0);
}

uint32
  ARAD_PP_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO_verify()",0,0);
}

uint32
  ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_verify(
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO, &(info->inner_tag), 11, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO, &(info->outer_tag), 12, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO_verify()",0,0);
}
