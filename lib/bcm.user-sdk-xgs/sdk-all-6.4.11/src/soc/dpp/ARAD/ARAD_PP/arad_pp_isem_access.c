  ...
  Arad_pp_error_desc_element_isem_access[] =
{
  ...
  {
    PROG_SEL_INCORRECT_DEF_ALLOCATION_ERR,
    "PROG_SEL_INCORRECT_DEF_ALLOCATION_ERR",
  ...
  {
    PROG_SEL_USR_INDEX_OUT_OF_RANGE_ERR,
    "PROG_SEL_USR_INDEX_OUT_OF_RANGE_ERR",
  ...
  {
    PROG_SEL_INVALID_LIF_KEY_RANGE_ERR,
    "PROG_SEL_INVALID_LIF_KEY_RANGE_ERR",
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = vt_programs[unit][PROG_VT_TM_PROG].prog_used;
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_tm_prog_set(
     int unit,
     uint32 prog_indx, /* PROG_TM_RULE_NUM */
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_untagged_set(
     int unit,
     uint32 prog_indx0, /* PROG_VT_PON_UNTAGGED_RULE */
     uint32 prog_indx1, /* PROG_VT_PON_PRIORITY_TAG_RULE */
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_one_tag_1_set(
     int unit,
     uint32 prog_indx, /* PROG_VT_PON_ONE_TAG_RULE_NUM_0 */
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_one_tag_2_set(
     int unit,
     uint32 prog_indx, /* PROG_VT_PON_ONE_TAG_RULE_NUM_1 */
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_ignore_2nd_tag_set(
     int unit,
     uint32 prog_indx, /* PROG_VT_PON_IGNORE_2ND_TAG_RULE*/
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_two_tags_set(
     int unit,
     uint32 prog_indx, /* PROG_VT_PON_TWO_TAGS_RULE */
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_two_tags_vs_tunnel_id_set(
     int unit,
     uint32 prog_indx, /* PROG_VT_PON_TWO_TAGS_VS_TUNNEL_ID_RULE */
     uint32 prog_sel
   )
{
  uint32
  ...
  )
{
  ...
  if (vt_programs[unit][PROG_VT_TM_PROG].prog_used != -1)
  {
      ...
      {
          res = arad_pp_vtt_prog_sel_cam_key_program_1st_tm_prog_set(unit,prog_indx,vt_programs[unit][PROG_VT_TM_PROG].prog_used);
  ...
  {
    SET_VT_2_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_untagged_set(unit, prog_indx,prog_indx+1,vt_programs[unit][PROG_VT_PON_UNTAGGED].prog_used);
  ...
  if (vt_programs[unit][PROG_VT_PON_ONE_TAG].prog_used != -1) 
  {
    ...
    res = arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_one_tag_1_set(unit,prog_indx,vt_programs[unit][PROG_VT_PON_ONE_TAG].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, PROG_VT_PON_ONE_TAG, exit);

    SET_VT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_one_tag_2_set(unit,prog_indx,vt_programs[unit][PROG_VT_PON_ONE_TAG].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, PROG_VT_PON_ONE_TAG, exit);
  }
  ...
  {
    SET_VT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_two_tags_set(unit,prog_indx,vt_programs[unit][PROG_VT_PON_TWO_TAGS].prog_used);
  ...
  {
    SET_VT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_two_tags_vs_tunnel_id_set(unit,prog_indx,vt_programs[unit][PROG_VT_PON_TWO_TAGS_VS_TUNNEL_ID].prog_used);
  ...
  {
    SET_VT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_1st_vt_pon_ignore_2nd_tag_set(unit,prog_indx,vt_programs[unit][PROG_VT_PON_ONE_TAG].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, PROG_VT_PON_ONE_TAG, exit);
  }
  /* 
   * PON logic 
   ...
   * }
   */
  if ((SOC_IS_ARADPLUS_A0(unit) && SOC_DPP_CONFIG(unit)->pp.oam_statistics ) && (vt_programs[unit][PROG_VT_TM_PROG].prog_used != -1))
   {
  ...
  arad_pp_isem_access_fcoe_npv_mode_no_my_mac_set(int unit, int enable)
{
    ...
    for (i = 0; i < DPP_PP_ISEM_PROG_SEL_1ST_CAM_DEF_OFFSET(unit); i++){
        ...
        if((prog_selection_2nd_cam_tbl.llvp_prog_sel == tt_programs[unit][PROG_TT_FC_WITH_VFT_PROG].prog_used) || (prog_selection_2nd_cam_tbl.llvp_prog_sel == tt_programs[unit][PROG_TT_FC_PROG].prog_used)){
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_fc_with_vft_prog_set(
     int unit,
     uint32 prog_indx, /* PROG_TT_FC_WITH_VFT_2ND_RULE_NUM */
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_fc_prog_set(
     int unit,
     uint32 prog_indx, /* PROG_TT_FC_2ND_RULE_NUM*/
     uint32 prog_sel
   )
{
  uint32
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_ip_router_compatiblemc_2nd_prog_set(
     int unit,
     uint32 prog_indx, /* PROG_IP_ROUTER_CompatibleMc_2ND_RULE_NUM */
     uint32 prog_sel,
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_mldp_overlay_after_recycle_prog_set(
     ...
     uint32 prog_indx, /* PROG_TT_MLDP_OVERLAY_AFTER_RECYCLE_RULE_NUM */
     uint32 prog_sel
   )
{
  uint32
  ...
  )
{
  ...
  if (tt_programs[unit][PROG_TT_BFD_STAT_PROG].prog_used != -1) {
	  res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_bfd_stat_prog_set(unit,prog_indx,tt_programs[unit][PROG_TT_BFD_STAT_PROG].prog_used);
  ...
  if (tt_programs[unit][PROG_TT_OAM_STAT_PROG].prog_used != -1) {
	  ...
	  res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_oam_stat_prog_set(unit,prog_indx,tt_programs[unit][PROG_TT_OAM_STAT_PROG].prog_used);
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_mldp_overlay_after_recycle_prog_set(unit,1, prog_indx,tt_programs[unit][PROG_TT_MLDP_AFTER_RECYCLE].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, PROG_TT_MLDP_AFTER_RECYCLE, exit);

    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_mldp_overlay_after_recycle_prog_set(unit,2, prog_indx,tt_programs[unit][PROG_TT_MLDP_AFTER_RECYCLE].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, PROG_TT_MLDP_AFTER_RECYCLE, exit);
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_fc_with_vft_prog_set(unit,prog_indx,tt_programs[unit][PROG_TT_FC_WITH_VFT_PROG].prog_used);    
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_fc_prog_set(unit,prog_indx,tt_programs[unit][PROG_TT_FC_PROG].prog_used);             
    ...
    uint32 access_profile_id)
{
  uint32
    res; 
  int
    prog_indx = vt_programs[unit][PROG_VT_PON_UNTAGGED].prog_used;
  ARAD_PP_IHP_VTT1ST_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt1st_key_construction_tbl_data;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = vt_programs[unit][PROG_VT_PON_ONE_TAG].prog_used;
  ARAD_PP_IHP_VTT1ST_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt1st_key_construction_tbl_data;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = vt_programs[unit][PROG_VT_PON_TWO_TAGS].prog_used;
  ARAD_PP_IHP_VTT1ST_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt1st_key_construction_tbl_data;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = vt_programs[unit][PROG_VT_PON_TWO_TAGS_VS_TUNNEL_ID].prog_used;
  ARAD_PP_IHP_VTT1ST_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt1st_key_construction_tbl_data;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][PROG_TT_OAM_STAT_PROG].prog_used;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][PROG_TT_BFD_STAT_PROG].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][PROG_TT_FC_PROG].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][PROG_TT_FC_WITH_VFT_PROG].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  )
{
  uint32
    res;
  int
    prog_indx = tt_programs[unit][PROG_TT_MLDP_AFTER_RECYCLE].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  )
{
  ...
  if (custom_feature_vrrp_scaling_tcam)
  {
    ...
    tcam_access_info.user_data                           = ARAD_PP_ISEM_ACCESS_TCAM_VRRP_VSI_DA_PROFILE;
  ...
  else
  {
      ...
      if (custom_feature_vt_tst1) {
          ...
          if (use_small_banks_mode_efp == 1) /* use only small banks */
          {
            tcam_access_info.use_small_banks                 = ARAD_TCAM_SMALL_BANKS_FORCE;
          } else if (use_small_banks_mode_efp == 2) /* use only big banks */
          {
            tcam_access_info.use_small_banks                 = ARAD_TCAM_SMALL_BANKS_FORBID;
          }
      ...
      if (explicit_null_arad_plus_support) {
          ...
          if (use_small_banks_mode_null == 1) /* use only small banks */
          {
            tcam_access_info.use_small_banks                 = ARAD_TCAM_SMALL_BANKS_FORCE;
          } else if (use_small_banks_mode_null == 2) /* use only big banks */
          {
            tcam_access_info.use_small_banks                 = ARAD_TCAM_SMALL_BANKS_FORBID;
          }
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD_PCP_VID_VID:  
    ...
    { /* Default lookups : !pcp, !64K */   
       ...
       */
        ...
        if (prog_soc_prop.trill_mode) 
        {
          is_trill = (vt_profile == ARAD_PP_PORT_DEFINED_VT_PROFILE_TRILL || vt_profile == ARAD_PP_PORT_DEFINED_VT_PROFILE_TRILL_USE_INITIAL_VID);
        }
        else
        {
          is_trill = FALSE;
   ...
   )
{
  ...
  case ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_INITIAL_VLAN:
    *llvp_prog_sel_val = PROG_VT_VDxINITIALVID_L1;
    break;
  default:
    SOC_SAND_SET_ERROR_CODE(PROG_SEL_INVALID_LIF_KEY_RANGE_ERR, 14590, exit);
    break;
  }
   ...
   )
{
  ...
  case PROG_VT_VDxINITIALVID_L1:
    *key_mapping = ARAD_PP_L2_LIF_AC_MAP_KEY_TYPE_PORT_INITIAL_VLAN;
    break;
  default:
    SOC_SAND_SET_ERROR_CODE(PROG_SEL_INVALID_LIF_KEY_RANGE_ERR, 10, exit);
    break;
  }
  ...
  )
{
  ...
  {
    SOC_SAND_SET_ERROR_CODE(PROG_SEL_USR_INDEX_OUT_OF_RANGE_ERR, 10, exit);
  }
