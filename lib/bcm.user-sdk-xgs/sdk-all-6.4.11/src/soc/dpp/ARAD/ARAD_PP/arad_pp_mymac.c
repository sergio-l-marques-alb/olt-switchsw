...
#define ARAD_PP_MYMAC_MODE_MAX                                   (ARAD_PP_NOF_MYMAC_VRRP_MODES-1)
 ...
 *  IPV4 only.
 */
#define  ARAD_PP_MYMAC_VRRP_MODE_4K_VSI_8_VRID (0)
/*
  ...
  Arad_pp_procedure_desc_element_mymac[] =
{
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_VRRP_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_MYMAC_TRILL_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_mymac[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_MYMAC_VRRP_MODES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_VRRP_INFO_SET_UNSAFE);
  ...
  {
  case ARAD_PP_MYMAC_VRRP_MODE_ALL_VSI_BASED:
    ...
    fld_val = ARAD_PP_MYMAC_VRRP_MODE_4K_VSI_8_VRID;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_256_VSI_BASED:
    fld_val = vrrp_info->ipv6_enable ? ARAD_PP_MYMAC_VRRP_MODE_256_VSI_8_VRID_IPV4_8_VRID_IPV6 : ARAD_PP_MYMAC_VRRP_MODE_256_VSI_16_VRID;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_512_VSI_BASED:
    fld_val = vrrp_info->ipv6_enable ? ARAD_PP_MYMAC_VRRP_MODE_512_VSI_4_VRID_IPV4_4_VRID_IPV6 : ARAD_PP_MYMAC_VRRP_MODE_512_VSI_8_VRID;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_BASED:
    fld_val = vrrp_info->ipv6_enable ? ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_2_VRID_IPV4_2_VRID_IPV6 : ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_4_VRID;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_2K_VSI_BASED:
    if (vrrp_info->ipv6_enable) {
      SOC_SAND_SET_ERROR_CODE(ARAD_PP_MYMAC_MODE_IPV6_NOT_SUPPORTED_ERR, 10, exit);
    }
    fld_val = ARAD_PP_MYMAC_VRRP_MODE_2K_VSI_2_VRID;
    break;
  default:
...
#ifdef BCM_88660_A0
  if (SOC_IS_ARADPLUS(unit) && vrrp_info->mode != ARAD_PP_MYMAC_VRRP_MODE_256_VSI_BASED) {
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_VRRP_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MYMAC_VRRP_INFO, vrrp_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_VRRP_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_VRRP_INFO_GET_UNSAFE);
  ...
  if (SOC_IS_JERICHO(unit)) {
      vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_ALL_VSI_BASED;
      SOC_SAND_EXIT_NO_ERROR;
  }
  ...
  switch (fld_val)
  {
  case ARAD_PP_MYMAC_VRRP_MODE_4K_VSI_8_VRID:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_ALL_VSI_BASED;
...
#endif /* BCM_88660_A0 */  
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_256_VSI_16_VRID:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_256_VSI_BASED;
    vrrp_info->ipv6_enable = 0;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_256_VSI_8_VRID_IPV4_8_VRID_IPV6:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_256_VSI_BASED;
    vrrp_info->ipv6_enable = 1;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_512_VSI_8_VRID:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_512_VSI_BASED;
    vrrp_info->ipv6_enable = 0;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_512_VSI_4_VRID_IPV4_4_VRID_IPV6:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_512_VSI_BASED;
    vrrp_info->ipv6_enable = 1;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_4_VRID:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_BASED;
    vrrp_info->ipv6_enable = 0;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_2_VRID_IPV4_2_VRID_IPV6:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_1K_VSI_BASED;
    vrrp_info->ipv6_enable = 1;
    break;
  case ARAD_PP_MYMAC_VRRP_MODE_2K_VSI_2_VRID:
    vrrp_info->mode = ARAD_PP_MYMAC_VRRP_MODE_2K_VSI_BASED;
    vrrp_info->ipv6_enable = 0;
    break;
  }
...
STATIC uint32 
    ...
    *entry_size = 8;
    ...
    if (vrrp_info.mode != ARAD_PP_MYMAC_VRRP_MODE_ALL_VSI_BASED) {
  ...
  )
{
  ...
  res = arad_pp_mymac_vrrp_info_get(
    unit,
    &vrrp_info
    );
  SOC_SAND_CHECK_FUNC_RESULT(res, 12, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_TRILL_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_TRILL_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_MYMAC_TRILL_INFO, trill_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_TRILL_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_MYMAC_TRILL_INFO_GET_UNSAFE);
  ...
  ARAD_PP_MYMAC_TRILL_INFO_clear(trill_info);
...
uint32
  ARAD_PP_MYMAC_VRRP_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MYMAC_VRRP_INFO_verify()",0,0);
}

uint32
  ARAD_PP_MYMAC_TRILL_INFO_verify(
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_MYMAC_TRILL_INFO_verify()",0,0);
}
