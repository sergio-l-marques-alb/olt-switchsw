  ...
  )
{
    ...
    SOCDNX_SAND_IF_ERR_EXIT(soc_jer_fabric_cosq_gport_rci_threshold_set(unit, gport, 0x50, soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast));
    ...
    case soc_dpp_cosq_gport_egress_core_fifo_fabric_ucast:
        for (i = 0; i < SOC_JER_FABRIC_FDA_EGQ_NUMELS; ++i) {
            ...
            if (threshold_val == 0) {
                ...
                soc_reg_field_set(unit, FDA_FDA_EGQ_FABRIC_RCIr, &reg_val, EGQ_N_FABRIC_RCI_SELf, 1);
            }
