...
/* Adding ports to ingress MC group*/
...
int add_ingress_multicast_forwarding_with_encap(int unit, int ipmc_index, int *ports , int nof_ports, int vlan){
...
int ipmc_flows_ipmc_disabled_l3_mcast_l2_per_rif(int unit, int inP, int outP, int outP2 ,int outP3 ,int vlan1, int vlan2, int vlan3, int vlan4){
    ...
    rv = add_ingress_multicast_forwarding_with_encap(unit, ipmc_flows_info1.ipmc_mc_groups[0], ipmc_flows_info1.forwarding_ports_1, 3, vlans[0]);
    if (rv != BCM_E_NONE) {
    ...
    rv = add_ingress_multicast_forwarding_with_encap(unit, ipmc_flows_info1.ipmc_mc_groups[1], ipmc_flows_info1.forwarding_ports_2, 2, vlans[1]);
    if (rv != BCM_E_NONE) {
        printf("Error, add_ingress_multicast_forwarding_with_encap \n");
        return rv;
    }
     ...
     */
    rv = create_forwarding_entry_dip_sip(unit,ipmc_flows_info1.mc_ip_arr[0],0x0,ipmc_flows_info1.ipmc_mc_groups[0],vlans[0]);
    if (rv != BCM_E_NONE) {
    ...
    rv = create_forwarding_entry_dip_sip(unit,ipmc_flows_info1.mc_ip_arr[2],ipmc_flows_info1.src_ip_arr[2],ipmc_flows_info1.ipmc_mc_groups[2],vlans[2]);
    if (rv != BCM_E_NONE) {
        printf("Error, create_forwarding_entry_dip_sip\n");
        return rv;
    }
...
int ipmc_flows_rif_ipmc_disabled(int unit, int inP, int outP, int outP2 ,int outP3 ,int vlan1, int vlan2, int vlan3, int vlan4){
    ...
    rv = add_ingress_multicast_forwarding_with_encap(unit, ipmc_flows_info1.ipmc_mc_groups[0], ipmc_flows_info1.forwarding_ports_1, 3, vlan1); /* 4.1 */
    if (rv != BCM_E_NONE) {
        printf("Error, add_ingress_multicast_forwarding_with_encap \n");
        return rv;
    }
    ...
    if (ipmc_ssm_enable) {
        ...
        rv = add_ingress_multicast_forwarding_with_encap(unit, ipmc_flows_info1.ipmc_mc_groups[1], ipmc_flows_info1.forwarding_ports_1, 3, vlan2); /* 4.1.1 */
        if (rv != BCM_E_NONE) {
            printf("Error, add_ingress_multicast_forwarding_with_encap \n");
            return rv;
        }
        rv = add_ingress_multicast_forwarding_with_encap(unit, ipmc_flows_info1.ipmc_mc_groups[2], ipmc_flows_info1.forwarding_ports_1, 0, vlan2); /* 4.1.2 */
        if (rv != BCM_E_NONE) {
            printf("Error, add_ingress_multicast_forwarding_with_encap \n");
            return rv;
        }
    ...
    if (ipmc_egress_multicast_enable == 1) {
       rv = add_egress_multicast_forwarding(unit, ipmc_flows_info1.ipmc_mc_groups[5], ipmc_flows_info1.forwarding_ports_1, 3, vlan2); /* 4.2 */
        ...
        rv = add_ingress_multicast_forwarding_with_encap(unit, ipmc_flows_info1.ipmc_mc_groups[5], ipmc_flows_info1.forwarding_ports_1, 3, vlan2); /* 4.2 */
    }
    if (rv != BCM_E_NONE) {
