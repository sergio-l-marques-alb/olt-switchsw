...
struct cint_mpls_various_scenarios_info_s {
    ...
    bcm_mpls_label_t tunnel_label; /* pwe label 1*/
};
...
/*                 pwe_mac1                                pwe_mac2                                      vpn2_mac              */
    {0x00, 0x00, 0x00, 0x00, 0x01, 0x18}, {0x00, 0x00, 0x00, 0x00, 0x01, 0x19},  {0x00, 0x00, 0x00, 0x00, 0x01, 0x12}, 
/* dip 1*/
...
/* fec1    | fec 2*/
    0,          0,
/* tunnel_id1  | tunnel_id2  |  tunnel_id3 */
        0,            0,            0, 
/* pwe_label1  | pwe_label2  */
       3000,       4000,
/* mpls_port_id1    |    mpls_port_id2 */
        0,                    0,
/* vport_id1 */
        0,
/* tunnel_label */
...
int mpls_various_scenarios_main(int unit, int port1, int port2){
    ...
    /* configure vpn */
    rv = mpls_port__vswitch_vpls_vpn_create__set(unit, cint_mpls_various_scenarios_info.vpn_id1); /* 1 */
    if (rv != BCM_E_NONE) {
    ...
    /* configure vpn */
    rv = mpls_port__vswitch_vpls_vpn_create__set(unit, cint_mpls_various_scenarios_info.vpn_id2); /* 1 */
    if (rv != BCM_E_NONE) {
        printf("Error, in mpls_port__vswitch_vpls_vpn_create__set\n");
        return rv;
    }
    ...
    rv = mpls_various_scenarios_configure_port_properties(unit, mpls_various_scenarios_port_array ,2); /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = mpls_various_scenarios_create_l2_interfaces(unit);  /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = mpls_various_scenarios_create_l3_interfaces(unit);   /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = mpls_various_scenarios_create_egress_tunnels(unit); /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    /* Configure L3 information (router interfaces) */
    rv = mpls_various_scenarios_create_fec_entries(unit);  /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = mpls_various_scenarios_create_pwe_entries(unit); /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = mpls_various_scenarios_create_l2_forwarding(unit);  /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = mpls_various_scenarios_create_l3_forwarding(unit);  /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
...
int mpls_various_scenarios_configure_port_properties(int unit, int *port_array, int nof_ports){
    ...
    for (i=0; i< nof_ports; i++) {
        ...
        rv = port__vlan_domain__set(unit, port_array[i], port_array[i]); /* 1 */
        if (rv != BCM_E_NONE) {
        ...
        rv = port__tpid__set(unit, port_array[i], cint_mpls_various_scenarios_info.tpid, cint_mpls_various_scenarios_info.tpid); /* 1 */
        if (rv != BCM_E_NONE) {
            printf("Error, in port__tpid__set, port=%d, \n",  port_array[i]);
            return rv;
        }

        rv = bcm_vlan_gport_add(unit, cint_mpls_various_scenarios_info.vpn_id1, port_array[i], BCM_VLAN_GPORT_ADD_INGRESS_ONLY); /* 1 */
...
int mpls_various_scenarios_create_l2_interfaces(int unit){
    ...
    /* Create a vlan port*/
    rv = l2__port_vlan__create(unit, flags,  cint_mpls_various_scenarios_info.port1, cint_mpls_various_scenarios_info.vlan1, 0, &cint_mpls_various_scenarios_info.vport_id1); /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    rv = bcm_vswitch_port_add(unit, cint_mpls_various_scenarios_info.vpn_id1, cint_mpls_various_scenarios_info.vport_id1); /* 1 */
    if (rv != BCM_E_NONE) {
    ...
    rv = multicast__vlan_port_add(unit, cint_mpls_various_scenarios_info.vpn_id1, cint_mpls_various_scenarios_info.port1 , cint_mpls_various_scenarios_info.vport_id1, 0); /* 1 */
    if (rv != BCM_E_NONE) {
...
int mpls_various_scenarios_create_l3_interfaces(int unit){
    ...
    /* create rif */
    rv = l3__intf_rif__create(unit, &(l3_intf[0])); /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
    ...
    /* create rif */
    rv = l3__intf_rif__create(unit, &(l3_intf[1])); /* 1 */
    if (rv != BCM_E_NONE) {
        print rv;
        printf("Error, in l3__intf_rif__create\n");
        return rv;
...
int mpls_various_scenarios_create_l2_forwarding(int unit){
    int rv = BCM_E_NONE;
    l2__mact_properties_s mact_properties[2];
...
int mpls_various_scenarios_create_l3_forwarding(int unit){
    ...
    int rv = BCM_E_NONE;
    l3_ipv4_route_entry_utils_s route_entry[2];
...
int mpls_various_scenarios_create_egress_tunnels(int unit){
    ...
    int rv = BCM_E_NONE;
    mpls__egress_tunnel_utils_s mpls_tunnel_properties[3];
    int tunnel_index = 0;
    ...
    mpls_tunnel_properties[tunnel_index].ext_ttl = 40;
...
int mpls_various_scenarios_create_fec_entries(int unit){
    ...
    int rv = BCM_E_NONE;
    create_l3_egress_s l3_egress[2];
...
int mpls_various_scenarios_create_pwe_entries(int unit){
    ...
    mpls_port_utils_s mpls_port_properties[2];
