...
vswitch_vpls_add_network_port_1(int unit, int second_unit,  bcm_gport_t *port_id){
    ...
    if (ingress_egress_separate_ports) {
        ...
        *port_id = mpls_port_1.mpls_port_id;
        ...
        mpls_port__egress_tunnel_if_egress_only__set(unit, vswitch_vpls_info_1.tunnel_id, encap_optimized, &mpls_port_1);
        ...
        exported_egress_mpls_port_id = mpls_port_1.mpls_port_id;
    } else {
        mpls_port_1.criteria = BCM_MPLS_PORT_MATCH_LABEL;
        if (encap_optimized) {
            mpls_port_1.flags2 |= BCM_MPLS_PORT2_LEARN_ENCAP;
    ...
    if (is_gal) {
        ...
        mpls_port_1.mpls_port_id = mpls_port_1.mpls_port_id + 10; /* Should be different lif ID */
        mpls_port_1.flags2 = BCM_MPLS_PORT2_INGRESS_ONLY;
    ...
    BCM_L3_ITF_SET(pwe_encap_id, BCM_L3_ITF_TYPE_LIF, mpls_port_1.encap_id);
    ...
    mpls_port_encap_id1 = mpls_port_1.encap_id;
    if(verbose1){
...
vswitch_vpls_add_network_port_2(int unit,  bcm_gport_t *port_id){
    ...
    mpls_port_encap_id2 = mpls_port_1.encap_id;
    if(verbose1){
