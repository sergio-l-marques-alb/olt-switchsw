...
vswitch_vpls_ingress_mpls_port_create(int unit){
    ...
    BCM_L3_ITF_FEC_TO_GPORT_FORWARD_GROUP(mpls_port_1.failover_port_id, vswitch_vpls_roo_info.ecmp.ecmp_intf); /* Learning - PWE ECMP (forwarding froup) */
    ...
    BCM_GPORT_MPLS_PORT_ID_SET(mpls_port_1.mpls_port_id, mpls_port_id_temp); 
...
vswitch_vpls_egress_mpls_port_create(int unit){
    ...
    rv = mpls_port__update_network_group_id(unit, &mpls_port_1);
    if (rv != BCM_E_NONE) {
        printf("Error, vswitch_vpls_egress_mpls_port_create\n");
        return rv;
    }
    ...
    for (i = 0; i < vswitch_vpls_roo_info.ecmp_size; i++) {
        ...
        int mpls_port_id_temp;
        BCM_GPORT_SUB_TYPE_LIF_SET(mpls_port_id_temp, 0,  mpls_port_1.encap_id) ;
        BCM_GPORT_MPLS_PORT_ID_SET(mpls_port_1.mpls_port_id, mpls_port_id_temp);
        ...
        BCM_L3_ITF_SET(vswitch_vpls_roo_info.pwe_encap_id[i], BCM_L3_ITF_TYPE_LIF, mpls_port_1.encap_id);
    }
    ...
    */
    if (vswitch_vpls_roo_info.enable_routing_over_pwe) {
        ...
        */
        ...
        BCM_L3_ITF_FEC_TO_GPORT_FORWARD_GROUP(l3_egress_into_overlay.gport, vswitch_vpls_roo_info.ecmp.ecmp_intf); /* dest: fec-id instead of port */
        l3_egress_into_overlay.vlan = vswitch_vpls_roo_info.native_out_to_core_vlan; /* out-vlan */
        l3_egress_into_overlay.intf = native_ingress_intf; /* l3_intf  */
        ...
        rv = l3__ipv4_route__add(unit, 
                                 route_entry,
                                 0,     /* router instance */
                                 l3_egress_into_overlay.l3_egress_id /* data of LPM entry: cascaded fec */        
                                 ); 
        if (rv != BCM_E_NONE) {
        ...
        l3_egress_out_of_overlay.gport = vswitch_vpls_info_1.ac_in_port; /* dest: fec-id instead of port */
       ...
       /* Add LEM entry, for core to access traffic*/
        ...
        /* data of host entry */
        l3_host_simple_routing.l3a_intf  = l3_egress_out_of_overlay.l3_egress_id;
