...
/* Maximal number of MEPS supported by HW is 8K x 7 MD-levels. However, this consumes proportional
   ...
   If up and down mep aded on same lif and level this should be increased by 2. */
    ...
    rv = sw_state_htb_create(unit,&ht_indx,
                   oam_max_meps,
                   sizeof(uint32),sizeof(SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY),
...
{
	SOC_PPD_OAM_SAT_GTF_ENTRY * gtf_info_p;

	gtf_info_p = (SOC_PPD_OAM_SAT_GTF_ENTRY*)data;
	sal_free(gtf_info_p);
 }
...
_bcm_dpp_sw_db_hash_oam_sat_gtf_info_create(int unit)
{
   ...
   /*SAT can support 8 gtf*/
    rv = sw_state_htb_create(unit,&ht_indx,
                   sat_max_gtf,
                   sizeof(uint32),sizeof(SOC_PPD_OAM_SAT_GTF_ENTRY),
...
{
	SOC_PPD_OAM_SAT_CTF_ENTRY * ctf_info_p;

	ctf_info_p = (SOC_PPD_OAM_SAT_CTF_ENTRY*)data;
	sal_free(ctf_info_p);
 }
...
_bcm_dpp_sw_db_hash_oam_sat_ctf_info_create(int unit)
{
   ...
   /*SAT can support 32 ctf*/
    rv = sw_state_htb_create(unit,&ht_indx,
                   sat_max_ctf,
                   sizeof(uint32),sizeof(SOC_PPD_OAM_SAT_CTF_ENTRY),
                   "OAM info DB _bcm_dpp_sw_db_hash_oam_sat_gtf_info_create");
    BCMDNX_IF_ERR_EXIT(rv);
...
_bcm_dpp_sw_db_hash_oam_bfd_rmep_info_create(int unit)
{
    ...
    rv = sw_state_htb_create(unit,&ht_indx,
                   ...
                   sizeof(uint32),sizeof(SOC_PPD_OAM_RMEP_INFO_DATA),
...
int _bcm_dpp_oam_bfd_mep_info_db_insert_no_lock(int unit, uint32 mep_index, SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY * mep_info)
{
     ...
     */
    SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY mep_info_temp ;
 ...
 * SAT gtf info db
 */
int _bcm_dpp_oam_sat_gtf_info_db_insert(int unit, uint32 gtf_index, SOC_PPD_OAM_SAT_GTF_ENTRY * gtf_info)
{
    int rv;
    /*
     * This variable is used here only as place holder.
     */
    SOC_PPD_OAM_SAT_GTF_ENTRY gtf_info_temp ;
...
int _bcm_dpp_oam_sat_gtf_info_db_delete(int unit, uint32 gtf_id) {
    int rv;
    SOC_PPD_OAM_SAT_GTF_ENTRY gtf_info_dummy ;
 ...
 * SAT ctf info db
 */
int _bcm_dpp_oam_sat_ctf_info_db_insert(int unit, uint32 ctf_index, SOC_PPD_OAM_SAT_CTF_ENTRY * ctf_info)
{
    int rv;
    /*
     * This variable is used here only as place holder.
     */
    SOC_PPD_OAM_SAT_CTF_ENTRY ctf_info_temp ;
...
int _bcm_dpp_oam_sat_ctf_info_db_delete(int unit, uint32 ctf_id) {
    int rv;
    SOC_PPD_OAM_SAT_CTF_ENTRY ctf_info_dummy ;
...
int _bcm_dpp_oam_bfd_mep_info_db_delete_no_lock(int unit, uint32 mep_index) {
    int rv;
    SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY mep_info_dummy ;
...
int _bcm_dpp_oam_bfd_rmep_info_db_insert_no_lock(int unit, uint32 rmep_index, SOC_PPD_OAM_RMEP_INFO_DATA * rmep_info) {
     ...
     * This variable is used here only as place holder.
     */
    SOC_PPD_OAM_RMEP_INFO_DATA rmep_info_loc ;
...
int _bcm_dpp_oam_bfd_rmep_info_db_delete_no_lock(int unit, uint32 rmep_index) {
    int rv;
    SOC_PPD_OAM_RMEP_INFO_DATA rmep_info_dummy ;
