            ...
            uint32                *num_entries)
{
    ...
    if ((rv == BCM_E_NONE) || (rv==BCM_E_EXISTS)) {
         ...
         case bcmStatObjectIngPolicy:
              /* This will cause the default pool to be allocated*/
              pool_number =  BCM_STAT_FLEX_ING_POLICY_GROUP_AUTO;
              rv = _bcm_esw_stat_flex_create_ingress_table_counters(
         ...
         case bcmStatObjectIngFieldStageIngress:
              ...
              rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                        unit, IFP_POLICY_TABLEm, object,mode,
                        &base_index, &pool_number);
              break;
         ...
         case bcmStatObjectEgrFieldStageEgress:
              rv = _bcm_esw_stat_flex_create_egress_table_counters(
                        unit, EFP_POLICY_TABLEm, object,mode,
                        &base_index, &pool_number);
              break;
         case bcmStatObjectEgrMplsTunnelLabel:
              rv = _bcm_esw_stat_flex_create_egress_table_counters(
                        unit, EGR_IP_TUNNEL_MPLSm, object,mode,
                        &base_index, &pool_number);
              break;
         default:
              rv = BCM_E_PARAM;
    ...
    switch(object) {
         ...
         case bcmStatObjectIngPolicy:
             ...
             if (SOC_IS_TOMAHAWK(unit)) {
              ...
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                        unit, ingress_table,object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectIngNiv:
         case bcmStatObjectIngMplsVcLabel:
         ...
         case bcmIntStatObjectIngAgm:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                        unit, AGM_MONITOR_TABLEm, object, offset_mode,
                        base_index, pool_number);
              break;
         ...
         case bcmStatObjectEgrFieldStageEgress:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                        unit, EFP_POLICY_TABLEm, object, offset_mode,
                        base_index, pool_number);
              break;
         case bcmStatObjectEgrMplsTunnelLabel:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                        unit, EGR_IP_TUNNEL_MPLSm, object, offset_mode,
                        base_index, pool_number);
              break;
         default:
              rv = BCM_E_PARAM;
    ...
    uint32            *num_entries)
{
    ...
    case bcmStatObjectIngPort:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, PORT_TABm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngVlan:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, VLAN_TABm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngVlanXlate:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, VLAN_XLATEm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngVfi:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, VFIm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngL3Intf:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, L3_IIFm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngVrf:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, VRFm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngPolicy:
         ingress_table = VFP_POLICY_TABLEm;
             ...
             if ((mode_id < BCM_STAT_FLEX_CUSTOM_INGRESS_COUNTER_MAX_MODE) &&
                (mode_id >= BCM_CUSTOM_INGRESS_MODE_START)) {
                 ...
                 for (pool_number = 0; pool_number < BCM_STAT_TH_FLEX_COUNTER_MAX_POOL; pool_number++) {
                   ...
                   rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                             unit, ingress_table, object, mode_id,
                             &base_index, &pool_number);
                 ...
                 pool_number = BCM_STAT_FLEX_ING_POLICY_GROUP_AUTO;
                 rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                           unit, VFP_POLICY_TABLEm, object, mode_id,
                           &base_index, &pool_number);
          }
         break;
    case bcmStatObjectIngNiv:
    ...
    case bcmStatObjectIngGport:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, SOURCE_VPm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngMplsSwitchLabel:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, MPLS_ENTRYm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngMplsFrrLabel:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, L3_TUNNELm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngL3Host:
         /* To Be Completed..L3_ENTRY_2/4,EXT_IPV4/6_128_UCAST_WIDE */
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, EXT_IPV4_UCAST_WIDEm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngTrill:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, MPLS_ENTRY_EXTDm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngMimLookupId:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
    ...
    case bcmStatObjectIngVsan:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, ING_VSANm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngFcoe:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, L3_ENTRY_IPV4_MULTICASTm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngL3Route:
         /* To include L3_DEFIP_AUX_SCRATCH L3_DEFIP_ALPM_IPV4 */
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, L3_DEFIPm,object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngIpmc:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
    ...
    case bcmIntStatObjectIngAgm:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, AGM_MONITOR_TABLEm, object, mode,
                   &base_index, &pool_number);
         break;
    /* Egress Side */
    case bcmStatObjectEgrPort:
    ...
    case bcmStatObjectEgrL3Nat:
         ...
         break;
    case bcmStatObjectEgrFieldStageEgress:
          if (-1 != *stat_counter_id && (!SOC_IS_TD2P_TT2P(unit))) {
