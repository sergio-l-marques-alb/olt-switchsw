/* $Id: field.c,v 1.133 Broadcom SDK $
...
static const struct {
    ...
    {  BCM_FIELD_PKT_RES_MPLSMCKNOWN, 0x1d },
    ...
    for (slice_idx = 0; slice_idx < stage_fc->tcam_slices; slice_idx++) {
...
#if defined(BCM_TRIDENT2_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT)
            if (SOC_REG_FIELD_VALID(unit, FP_PORT_FIELD_SELm,
        ...
        for (idx = 0; idx < slice_ent_cnt; idx++) {
            ...
            if (fc->l2warm) {
                ...
                if (version > BCM_WB_VERSION_1_14) {
                   action_bmp.w = NULL;
                 ...
                 * corresponding function */
                if (version >= BCM_WB_VERSION_1_17) {
