...
#define BCM_WB_DEFAULT_VERSION            BCM_WB_VERSION_1_18
                           ...
                           _field_entry_wb_info_t *f_ent_wb_info)
{
    ...
    if ((version >= BCM_WB_VERSION_1_18) &&
    ...
    /* Retrieve SVP_type */
    if (version >= BCM_WB_VERSION_1_16) {
    ...
    if (version >= BCM_WB_VERSION_1_15) {
          ...
          LOG_DEBUG(BSL_LS_BCM_FP, (BSL_META_U(unit,
                ...
                f_ent_wb_info->action_bmp->w[0], fc->scache_pos - 4));
