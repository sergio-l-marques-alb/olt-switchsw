/*
 * $Id: field.c,v 1.100 Broadcom SDK $
...
static _sbx_fe2000_field_unit_info_t _sbx_fe2000_field[BCM_MAX_NUM_UNITS] = {{ NULL }};
 ...
 *   Parameters
 *      (in) const int flags = LOG_CLI print flags
 *      (in) const char *message = LOG_CLI message (but already processed)
 *   Notes
...
bcm_fe2000_field_init(int unit)
{
    ...
    if (BCM_E_NONE == result) {
        ...
        if (BCM_E_NONE == result) {
            ...
            LOG_DEBUG(BSL_LS_BCM_FP,
              (BSL_META_U(unit,
                          "clear and release unit %d resources\n"),
                         unit));
            _sbx_fe2000_field[unit].lock = NULL;
            _sbx_fe2000_field[unit].data = NULL;
            _sbx_fe2000_field[unit].microcode = SOC_SBX_UCODE_TYPE_NONE;
...
bcm_fe2000_field_detach(int unit)
{
    ...
    if (!_sbx_fe2000_field_glob_lock) {
        LOG_ERROR(BSL_LS_BCM_FP,
                  (BSL_META_U(unit,
                              "no FE2000 field units initialised\n")));
        return BCM_E_INIT;
    }
                                 ...
                                 bcm_pbmp_t mask)
{
    ...
    LOG_VERBOSE(BSL_LS_BCM_FP,
                (BSL_META_U(unit,
                            "(%d,%08X," FIELD_PBMP_FORMAT "," FIELD_PBMP_FORMAT
                             ")\n"),
                 unit,
                 entry,
...
/*
 *   Function
 *      _bcm_fe2000_field_counter_create
 *   Purpose
 ...
 */
int
_bcm_fe2000_field_counter_create(int unit,
                                bcm_field_entry_t entry)
{
    _FE2000_FIELD_COMMON_LOCALS;
...
/*
 *   Function
 *      _bcm_fe2000_field_counter_destroy
 *   Purpose
 ...
 */
int
_bcm_fe2000_field_counter_destroy(int unit,
                                 bcm_field_entry_t entry)
{
    _FE2000_FIELD_COMMON_LOCALS;
 ...
 */
int
_bcm_fe2000_field_counter_set(int unit,
                             bcm_field_entry_t entry,
                             int counter_num,
                             uint64 val)
{
...
/*
 *   Function
 *      _bcm_fe2000_field_counter_set32
 *   Purpose
 ...
 */
int
_bcm_fe2000_field_counter_set32(int unit,
                               bcm_field_entry_t entry,
                               int counter_num,
                               uint32 val)
{
    uint64 uuVal;
    COMPILER_64_SET(uuVal, 0, val);
    /* just let the compiler coerce the number and call the 64b version */
    return _bcm_fe2000_field_counter_set(unit, entry, counter_num, uuVal);
}

/*
 *   Function
 *      _bcm_fe2000_field_counter_get
 *   Purpose
 ...
 */
int
_bcm_fe2000_field_counter_get(int unit,
                             bcm_field_entry_t entry,
                             int counter_num,
                             uint64 *valp)
{
...
/*
 *   Function
 *      _bcm_fe2000_field_counter_get32
 *   Purpose
 ...
 */
int
_bcm_fe2000_field_counter_get32(int unit,
                               bcm_field_entry_t entry,
                               int counter_num,
                               uint32 *valp)
{
    ...
    result = _bcm_fe2000_field_counter_get(unit, entry, counter_num, &temp);
...
int
bcm_fe2000_field_stat_set(int unit,
                          int stat_id,
                          bcm_field_stat_t stat,
                          uint64 value)
{
    return _bcm_fe2000_field_counter_set(unit, stat_id, stat, value);
}

int
bcm_fe2000_field_stat_set32(int unit,
                            int stat_id,
                            bcm_field_stat_t stat,
                            uint32 value)
{
    return _bcm_fe2000_field_counter_set32(unit, stat_id, stat, value);
}

int
bcm_fe2000_field_stat_get(int unit,
                          int stat_id,
                          bcm_field_stat_t stat,
                          uint64 *value)
{
    return _bcm_fe2000_field_counter_get(unit, stat_id, stat, value);
}
                            
int
bcm_fe2000_field_stat_get32(int unit,
                            int stat_id,
                            bcm_field_stat_t stat,
                            uint32 *value)
{
    return _bcm_fe2000_field_counter_get32(unit, stat_id, stat, value);
}
                                   ...
                                   int stat_id)
{
    ...
    return _bcm_fe2000_field_counter_create(unit, entry);
}
                                   ...
                                   int stat_id)
{
    ...
    return _bcm_fe2000_field_counter_destroy(unit, entry);
}
