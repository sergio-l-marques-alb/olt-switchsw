...
int sw_state_dpp_bcm_l2_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_l2_index_control_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->index_control)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
...
int sw_state_dpp_bcm_l2_index_control_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  

   int younger_brother_node_id = 0; 
   int offset = 0; 
   _bcm_l2_cache_index_t* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(_bcm_l2_cache_index_t),"_bcm_l2_cache_index_t"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "index_control",             /* name */         
                                   sizeof(_bcm_l2_cache_index_t),    /* size of the element's type*/          
                                   0,                 /* nof pointers */ 
                                   "_bcm_l2_cache_index_t",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_l2_index_control_index_entry_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->index_entry)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
...
int sw_state_dpp_bcm_l2_index_control_index_entry_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  

   int younger_brother_node_id = 0; 
   int offset = 0; 
   _bcm_l2_cache_index_control_t* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(_bcm_l2_cache_index_control_t),"_bcm_l2_cache_index_control_t"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "index_entry",             /* name */         
                                   sizeof(_bcm_l2_cache_index_control_t),    /* size of the element's type*/          
                                   0,                 /* nof pointers */ 
                                   "_bcm_l2_cache_index_control_t",              /* param type */
                                   _BCM_NUMBER_OF_L2_CACHE_INDEX_CONTROL,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  

   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_l2_index_control_index_entry_index_type_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->index_type)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 

   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_l2_index_control_index_entry_mac_lsb_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->mac_lsb)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 

   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_l2_index_control_index_entry_port_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_l2_index_control_index_entry_prog_profile_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->prog_profile)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
...
int sw_state_dpp_bcm_l2_index_control_index_entry_index_type_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "index_type",             /* name */         
                                   sizeof(_bcm_l2_cache_index_type_e),    /* size of the element's type*/          
                                   0,                 /* nof pointers */ 
                                   "_bcm_l2_cache_index_type_e",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
...
int sw_state_dpp_bcm_l2_index_control_index_entry_mac_lsb_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
...
int sw_state_dpp_bcm_l2_index_control_index_entry_port_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
...
int sw_state_dpp_bcm_l2_index_control_index_entry_prog_profile_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
