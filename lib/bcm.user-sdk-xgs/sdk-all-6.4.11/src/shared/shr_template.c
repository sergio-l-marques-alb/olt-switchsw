                ...
                int num_template_pools)
{
    ...
    if (!sw_state_cb_db[unit].dpp.shr.template_info.pool) {
        sw_state_cb_db[unit].dpp.shr.template_info.pool = sal_alloc(num_template_pools * sizeof(_shr_template_pool_desc_cb_db_t)
                                                             ,"sw_state_cb_db[unit].dpp.shr.template_info.pool");
    }

    if (sw_state_cb_db[unit].dpp.shr.template_info.pool == NULL) {
       _SHR_E_IF_ERROR_RETURN(_SHR_E_MEMORY);
    }
...
_shr_mtemplate_destroy_data(int unit)
{
    ...
    sal_free(sw_state_cb_db[unit].dpp.shr.template_info.pool);
    sw_state_cb_db[unit].dpp.shr.template_info.pool = NULL;
    return result;
}
                                     ...
                                     int *template)
{
    ...
    SOC_SAND_MULTI_SET_PTR hash_handle;
    uint8 add_success;
    shr_template_manage_hash_compare_extras_cb_db_t extra;
    ...
    extra = sw_state_cb_db[unit].dpp.shr.template_info.pool[pool_id].extras;
