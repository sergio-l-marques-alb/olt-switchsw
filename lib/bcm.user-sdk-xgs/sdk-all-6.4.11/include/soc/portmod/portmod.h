...
#define PORTMOD_PORT_ADD_F_ELK 0x100 /**< flag for ELK */
#define PORTMOD_PORT_ADD_F_INIT_CORE_PROBE 0x200 /**< Do Core Probe. This is stage 1 of 3 stage init. INIT_UNTIL, RESUME AFTER are other 2 stages. If no flag is set - all 3 will be performed. */
#define PORTMOD_PORT_ADD_F_PORT_ATTACH_EXT_PHY_SKIP 0x400 /**< Skip external phy port attach */
...
typedef struct portmod_xphy_lane_connection_s {
    ...
    int ss_lane; /**< connected xphy system side lane */
    int ls_lane; /**< connected xphy line side lane */
