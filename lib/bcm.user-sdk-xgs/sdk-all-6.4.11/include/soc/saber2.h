...
/* Max 8 streams per linkphy port.
 * So we can support max of 8 subports per linkphy port.
 */
#define SB2_MAX_LINKPHY_SUBPORTS_PER_PORT     4
#define SB2_MAX_LINKPHY_STREAMS_PER_PORT      8
#define SB2_MAX_STREAMS_PER_SLICE             32
