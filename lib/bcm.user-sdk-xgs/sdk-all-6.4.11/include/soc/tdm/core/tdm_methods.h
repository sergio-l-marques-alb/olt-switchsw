...
LINKER_DECL int tdm_ovsb_fill_ovsb(tdm_mod_t *_tdm);
LINKER_DECL int tdm_ovsb_fill_ovsb_simple(tdm_mod_t *_tdm);
LINKER_DECL int tdm_core_vbs_scheduler_ovsb(tdm_mod_t *_tdm);
...
LINKER_DECL int tdm_core_postalloc_vmap(unsigned char **vector_map, int freq, unsigned char spd, short *yy, short *y, int lr_idx_limit, unsigned char lr_stack[TDM_AUX_SIZE], int token, const char* speed, int num_ext_ports, int vmap_wid, int vmap_len);
...
LINKER_DECL int tdm_vmap_chk_sister_1D(tdm_mod_t *_tdm);
LINKER_DECL int tdm_vmap_chk_sister_xy(tdm_mod_t *_tdm, unsigned short **vmap, int idx_x, int idx_y);
LINKER_DECL int tdm_vmap_chk_sister_col(tdm_mod_t *_tdm, unsigned short **vmap, int col_idx);
LINKER_DECL int tdm_vmap_chk_sister_2D(tdm_mod_t *_tdm, unsigned short **vmap);
LINKER_DECL int tdm_vmap_chk_same(tdm_mod_t *_tdm);
LINKER_DECL int tdm_vmap_get_port_pm(int port_token, tdm_mod_t *_tdm);
LINKER_DECL int tdm_vmap_get_port_speed(int port_token, enum port_speed_e *speeds, int phy_lo, int phy_hi);
LINKER_DECL int tdm_vmap_get_speed_slots(int port_speed);
LINKER_DECL int tdm_vmap_switch_col_xy(tdm_mod_t *_tdm, unsigned short **vmap, int col_x, int col_y);
LINKER_DECL int tdm_vmap_rotate(tdm_mod_t *_tdm, unsigned short **vmap);
LINKER_DECL int tdm_vmap_shift_1D(tdm_mod_t *_tdm, int port_token);
