...
typedef enum
{
   ...
   */
  ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET = ARAD_PP_PROC_DESC_BASE_LLP_VID_ASSIGN_FIRST,
  ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_SET_PRINT,
  ...
  ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_GET_PRINT,
...
uint32
  ARAD_PP_LLP_VID_ASSIGN_PORT_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_VID_ASSIGN_PORT_INFO *info
  );

uint32
  ARAD_PP_LLP_VID_ASSIGN_MAC_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_VID_ASSIGN_MAC_INFO *info
  );

uint32
  ARAD_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO *info
  );

uint32
  ARAD_PP_LLP_VID_ASSIGN_PRTCL_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_VID_ASSIGN_PRTCL_INFO *info
  );

uint32
  ARAD_PP_LLP_VID_ASSIGN_MATCH_RULE_verify(
