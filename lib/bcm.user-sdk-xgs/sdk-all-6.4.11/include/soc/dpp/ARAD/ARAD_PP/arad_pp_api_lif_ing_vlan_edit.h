...
/* $Id: arad_pp_api_lif_ing_vlan_edit.h,v 1.4 Broadcom SDK $
...
#ifndef __ARAD_PP_API_LIF_ING_VLAN_EDIT_INCLUDED__
/* { */
#define __ARAD_PP_API_LIF_ING_VLAN_EDIT_INCLUDED__
...
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_EMPTY          SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_EMPTY
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG      SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_INNER_TAG      SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_INNER_TAG
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_AC_EDIT_INFO   SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_AC_EDIT_INFO
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_AC_EDIT_INFO_2 SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_AC_EDIT_INFO_2
#define ARAD_PP_NOF_LIF_ING_VLAN_EDIT_TAG_VID_SRCS           SOC_PPC_NOF_LIF_ING_VLAN_EDIT_TAG_VID_SRCS_ARAD
typedef SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC                  ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC;
            
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NONE       SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NONE
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG  SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG  SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG
#define ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NEW        SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NEW
#define ARAD_PP_NOF_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRCS       SOC_PPC_NOF_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRCS
typedef SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC              ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC;

typedef SOC_PPC_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO       ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO;
typedef SOC_PPC_LIF_ING_VLAN_EDIT_COMMAND_KEY                  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY;
typedef SOC_PPC_LIF_ING_VLAN_EDIT_COMMAND_INFO                 ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO;
 ...
 *     "arad_pp_lif_ing_vlan_edit_command_id_set" API.
 *     Refer to "arad_pp_lif_ing_vlan_edit_command_id_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_lif_ing_vlan_edit_command_info_set" API.
 *     Refer to "arad_pp_lif_ing_vlan_edit_command_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_lif_ing_vlan_edit_pcp_map_stag_set" API.
 *     Refer to "arad_pp_lif_ing_vlan_edit_pcp_map_stag_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_lif_ing_vlan_edit_pcp_map_ctag_set" API.
 *     Refer to "arad_pp_lif_ing_vlan_edit_pcp_map_ctag_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_lif_ing_vlan_edit_pcp_map_untagged_set" API.
 *     Refer to "arad_pp_lif_ing_vlan_edit_pcp_map_untagged_set"
 *     API for details.
*********************************************************************/
uint32
...
/* } __ARAD_PP_API_LIF_ING_VLAN_EDIT_INCLUDED__*/
#endif
