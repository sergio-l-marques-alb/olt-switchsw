...
typedef enum
{
    ...
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4MC_FID_KAPS,
...
/* Don't change order of enums above  end*/
    ...
    SOC_DPP_DBAL_SW_TABLE_ID_VTT_LAST = SOC_DPP_DBAL_SW_TABLE_ID_MY_VTEP_INDEX_SIP_VRF_SEM_A,
...
uint32 arad_pp_dbal_entry_input_validate(int unit, SOC_DPP_DBAL_SW_TABLE_IDS table_id, ARAD_PP_FP_QUAL_VAL in_qual_vals[SOC_PPC_FP_NOF_QUALS_PER_DB_MAX]);
...
int arad_pp_dbal_program_to_string(int unit, ARAD_FP_DATABASE_STAGE stage, int cam_line, const char**str, uint8* prog_id);
