...
#define ARAD_PP_TPID_PROFILE_NDX_MIN                             (0)
#define ARAD_PP_TPID_PROFILE_NDX_MAX                             (7)
#define ARAD_PP_TPID_PROFILE_ID_MIN                              (0)
#define ARAD_PP_TPID_PROFILE_ID_MAX                              (3)
...
typedef enum
{
  ...
  ARAD_PP_LLP_PARSE_TPID_PROFILE_INFO_GET_PRINT,
  ...
  ARAD_PP_LLP_PARSE_PACKET_FORMAT_INFO_SET_PRINT,
  ...
  ARAD_PP_LLP_PARSE_PACKET_FORMAT_INFO_GET_PRINT,
...
uint32
  ARAD_PP_LLP_PARSE_TPID_VALUES_verify(
    SOC_SAND_IN  ARAD_PP_LLP_PARSE_TPID_VALUES *info
  );

uint32
  ARAD_PP_LLP_PARSE_TPID_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_PARSE_TPID_INFO *info
  );

uint32
  ARAD_PP_LLP_PARSE_TPID_PROFILE_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_PARSE_TPID_PROFILE_INFO *info
  );

uint32
  ARAD_PP_LLP_PARSE_INFO_verify(
    SOC_SAND_IN  ARAD_PP_LLP_PARSE_INFO *info
  );

uint32
  ARAD_PP_LLP_PARSE_PACKET_FORMAT_INFO_verify(
