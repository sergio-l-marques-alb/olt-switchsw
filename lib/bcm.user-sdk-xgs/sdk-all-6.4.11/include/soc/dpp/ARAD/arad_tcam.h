...
/* when adding more TCAM databases, don't use static tcam ID, use DBAL table create. it will allocate the SW handle dynamiclly */
/* TCAM DB IDs */

#define ARAD_TCAM_DB_ID_NUMBER_OF_DYNAMIC_DATABASES              (20) /* this value is not HW can be updated if needed */
#define ARAD_TCAM_DB_ID_INVALID                                  (0)
/* FLP TCAM DEFINES */
#define ARAD_PP_FRWRD_IP_TCAM_ID_BASE                            (ARAD_TCAM_DB_ID_INVALID + 0x1)
#define ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_UC_0                       (0 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE) /* for Jericho without KAPS */
#define ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_UC_1 /* Duplication */     (1 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE) /* for Jericho without KAPS */

#define ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_MC                         (2 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE) /* only in ARAD */
#define ARAD_PP_FRWRD_IP_TCAM_ID_IPV6_UC                         (3 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE) /* only in ARAD */
#define ARAD_PP_FRWRD_IP_TCAM_ID_IPV6_MC                         (4 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE) /* only in ARAD */
...
#define ARAD_PP_COMPRESSION_TCAM_ID_SIP                          (8 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE)
#define ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_MC_SSM                     (9 + ARAD_PP_FRWRD_IP_TCAM_ID_BASE)
#define ARAD_PP_FLP_LAST                                         ARAD_PP_FRWRD_IP_TCAM_ID_IPV4_MC_SSM
...
#define ARAD_PP_ISEM_ACCESS_TCAM_SRC_PORT_DA_DB_PROFILE                 (0x8 + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
...
#define ARAD_PP_ISEM_ACCESS_TCAM_TT_DIP_COMPRESSION_DB_PROFILE          (0xb + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
#define ARAD_PP_ISEM_ACCESS_TCAM_TT_IPV6_SPOOF_COMPRESSION              (0xc + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
#define ARAD_PP_ISEM_ACCESS_TCAM_TST2_PROFILE                           (0xd + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
#define ARAD_PP_ISEM_ACCESS_TCAM_TEST2_PROFILE                          (0xe + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
#define ARAD_PP_ISEM_ACCESS_TCAM_DIP_SIP_VRF_PROFILE                    (0xf + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
#define ARAD_PP_ISEM_ACCESS_TCAM_VRRP_VSI_DA_PROFILE                    (0x10 + ARAD_PP_ISEM_ACCESS_TCAM_BASE)
#define ARAD_PP_TT_LAST                                                 ARAD_PP_ISEM_ACCESS_TCAM_VRRP_VSI_DA_PROFILE

#define ARAD_PP_ISEM_ACCESS_VT_CLASSIFICATIONS_TCAM_BASE                (ARAD_PP_TT_LAST)+1
#define ARAD_PP_ISEM_ACCESS_TCAM_IPV4_MATCH_VT_DB_PROFILE               (0x0 + ARAD_PP_ISEM_ACCESS_VT_CLASSIFICATIONS_TCAM_BASE)
...
#define ARAD_PP_ISEM_ACCESS_TCAM_DYNAMIC_VALUES_BASE                     (ARAD_PP_ISEM_ACCESS_VT_CLASSIFICATIONS_TCAM_END+1)
#define ARAD_PP_ISEM_ACCESS_TCAM_DYNAMIC_VALUES_END                      (ARAD_PP_ISEM_ACCESS_TCAM_DYNAMIC_VALUES_BASE + ARAD_TCAM_DB_ID_NUMBER_OF_DYNAMIC_DATABASES)

#define ARAD_PP_ISEM_ACCESS_TCAM_END                                    (ARAD_PP_ISEM_ACCESS_TCAM_DYNAMIC_VALUES_END)
