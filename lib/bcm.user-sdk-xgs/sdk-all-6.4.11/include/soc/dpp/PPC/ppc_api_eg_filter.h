...
typedef enum
{
   ...
   *  in trap-mgmt referred by SOC_PPD_TRAP_EG_TYPE_HAIR_PIN
   */
...
typedef struct
{
   ...
   *  SOC_PPD_EG_FILTER_PORT_ENABLE. For example to set enable
   *  filtering for VSI membership and STP, set filter_mask =
   *  SOC_PPD_EG_FILTER_PORT_ENABLE_VSI_MEMBERSHIP |
   *  SOC_PPD_EG_FILTER_PORT_ENABLE_STP;
   */
  uint32 filter_mask;
  /*
