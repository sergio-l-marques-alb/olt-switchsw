...
#define  SOC_PPC_RIF_PROFILE_TO_ROUTING_ENABLERS_VECTOR_BEFORE_INIT         0x3FFFFFC;/* b 0000 0011 1111 1111 1111 1111 1111 1100 */
...
typedef struct
{
  ...
  uint8 uc_rpf_enable;
  /*
   *  If enable, use bridge V4MC forwarding.
   */
  uint8 ipmc_bridge_v4mc_enable;
  /*
