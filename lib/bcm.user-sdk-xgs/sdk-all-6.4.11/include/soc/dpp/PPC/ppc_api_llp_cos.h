...
typedef struct
{
   ...
   *  set per port-See SOC_PPD_LLP_COS_PORT_INFO.
   */
...
typedef struct
{
   ...
   *  with mapping_tbl  = SOC_PPD_LLP_COS_MAPPING_TABLE_UP_TO_DE_TC.
   ...
   *  mapping_tbl  = SOC_PPD_LLP_COS_MAPPING_TABLE_TC_TO_UP.
   ...
   *  To configure the mapping of this table use
   *  soc_ppd_llp_cos_mapping_table_entry_set(),  with
   *  mapping_tbl  = SOC_PPD_LLP_COS_MAPPING_TABLE_UP_TO_DP.
   ...
   *  To configure the mapping of this table use
   *  soc_ppd_llp_cos_mapping_table_entry_set(),  with
   *  mapping_tbl  = SOC_PPD_LLP_COS_MAPPING_TABLE_TC_TO_DP.
...
typedef struct
{
   ...
   *  value2. See SOC_PPD_LLP_COS_MAPPING_TABLE..
   */
  uint8 valid;
