...
#define  SOC_PPD_BFID_EQUAL_TO_BVID (SOC_PPC_BFID_EQUAL_TO_BVID)

/*     The B-MACT FID is '0'. Enable shared learning           */
#define  SOC_PPD_BFID_IS_0 (SOC_PPC_BFID_IS_0)

/*     flags for SOC_PPC_BMACT_ENTRY_XXX flags */
#define  SOC_PPD_BMACT_ENTRY_TYPE_FRWRD      (SOC_PPC_BMACT_ENTRY_TYPE_FRWRD)
#define  SOC_PPD_BMACT_ENTRY_TYPE_LEARN      (SOC_PPC_BMACT_ENTRY_TYPE_LEARN)
...
typedef SOC_PPC_BMACT_BVID_INFO                                SOC_PPD_BMACT_BVID_INFO;
typedef SOC_PPC_BMACT_PBB_TE_VID_RANGE                         SOC_PPD_BMACT_PBB_TE_VID_RANGE;
typedef SOC_PPC_BMACT_ENTRY_KEY                                SOC_PPD_BMACT_ENTRY_KEY;
typedef SOC_PPC_BMACT_ENTRY_INFO                               SOC_PPD_BMACT_ENTRY_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_frwrd_bmact_get_procs_ptr(void);
...
void
  ...
  void
  soc_ppd_frwrd_bmact_clan_edit_pcp_map_set_print(
    SOC_SAND_IN  int                               unit,
    SOC_SAND_IN  uint32                                pcp_profile_ndx,
    SOC_SAND_IN  SOC_SAND_PP_TC                              tc_ndx,
    SOC_SAND_IN  SOC_SAND_PP_DP                              dp_ndx,
  ...
  void
  soc_ppd_frwrd_bmact_clan_edit_pcp_map_get_print(
    SOC_SAND_IN  int                               unit,
    SOC_SAND_IN  uint32                                pcp_profile_ndx,
    SOC_SAND_IN  SOC_SAND_PP_TC                              tc_ndx,
    SOC_SAND_IN  SOC_SAND_PP_DP                              dp_ndx,
