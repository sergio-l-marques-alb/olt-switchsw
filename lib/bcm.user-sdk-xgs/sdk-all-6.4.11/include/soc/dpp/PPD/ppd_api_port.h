...
#define SOC_PPD_PORT_DEFINED_VT_PROFILE_EXTENDER_PE            SOC_PPC_PORT_DEFINED_VT_PROFILE_EXTENDER_PE
...
#define SOC_PPD_PORT_IHP_PINFO_LLR_TBL                         SOC_PPC_PORT_IHP_PINFO_LLR_TBL
#define SOC_PPD_PORT_IHP_PP_PORT_INFO_TBL                      SOC_PPC_PORT_IHP_PP_PORT_INFO_TBL
#define SOC_PPD_PORT_IHP_VTT_PP_PORT_CONFIG_TBL                SOC_PPC_PORT_IHP_VTT_PP_PORT_CONFIG_TBL
#define SOC_PPD_PORT_IHB_PINFO_FLP_TBL                         SOC_PPC_PORT_IHB_PINFO_FLP_TBL
#define SOC_PPD_PORT_EGQ_PCT_TBL                               SOC_PPC_PORT_EGQ_PCT_TBL
#define SOC_PPD_PORT_EPNI_PP_PCT_TBL                           SOC_PPC_PORT_EPNI_PP_PCT_TBL
#define SOC_PPD_PORT_EGQ_PP_PPCT_TBL                           SOC_PPC_PORT_EGQ_PP_PPCT_TBL
#define SOC_PPD_PORT_IHP_VTT_PP_PORT_VSI_PROFILE_TBL           SOC_PPC_PORT_IHP_VTT_PP_PORT_VSI_PROFILE_TBL
#define SOC_PPD_PORT_ALL_TBL                                   SOC_PPC_PORT_ALL_TBL
