...
#define SOC_PPD_FEC_TYPE_DROP                                  SOC_PPC_FEC_TYPE_DROP
#define SOC_PPD_FEC_TYPE_IP_MC                                 SOC_PPC_FEC_TYPE_IP_MC
#define SOC_PPD_FEC_TYPE_IP_UC                                 SOC_PPC_FEC_TYPE_IP_UC
#define SOC_PPD_FEC_TYPE_TRILL_MC                              SOC_PPC_FEC_TYPE_TRILL_MC
#define SOC_PPD_FEC_TYPE_TRILL_UC                              SOC_PPC_FEC_TYPE_TRILL_UC
#define SOC_PPD_FEC_TYPE_BRIDGING_INTO_TUNNEL                  SOC_PPC_FEC_TYPE_BRIDGING_INTO_TUNNEL
#define SOC_PPD_FEC_TYPE_BRIDGING_WITH_AC                      SOC_PPC_FEC_TYPE_BRIDGING_WITH_AC
#define SOC_PPD_FEC_TYPE_MPLS_LSR                              SOC_PPC_FEC_TYPE_MPLS_LSR
#define SOC_PPD_FEC_TYPE_SIMPLE_DEST                           SOC_PPC_FEC_TYPE_SIMPLE_DEST
#define SOC_PPD_FEC_TYPE_ROUTING                               SOC_PPC_FEC_TYPE_ROUTING
#define SOC_PPD_FEC_TYPE_MPLS_LSR_EEI_OUTLIF                   SOC_PPC_FEC_TYPE_MPLS_LSR_EEI_OUTLIF
#define SOC_PPD_FEC_TYPE_TUNNELING                             SOC_PPC_FEC_TYPE_TUNNELING
#define SOC_PPD_FEC_TYPE_TUNNELING_EEI_OUTLIF                  SOC_PPC_FEC_TYPE_TUNNELING_EEI_OUTLIF
#define SOC_PPD_FEC_TYPE_TUNNELING_EEI_MPLS_COMMAND            SOC_PPC_FEC_TYPE_TUNNELING_EEI_MPLS_COMMAND
#define SOC_PPD_FEC_TYPE_FORWARD                               SOC_PPC_FEC_TYPE_FORWARD
#define SOC_PPD_NOF_FEC_TYPES_ARAD                             SOC_PPC_NOF_FEC_TYPES_ARAD
typedef SOC_PPC_FEC_TYPE                                       SOC_PPD_FEC_TYPE;

#define SOC_PPD_FRWRD_FEC_RPF_MODE_NONE                        SOC_PPC_FRWRD_FEC_RPF_MODE_NONE
#define SOC_PPD_FRWRD_FEC_RPF_MODE_UC_STRICT                   SOC_PPC_FRWRD_FEC_RPF_MODE_UC_STRICT
#define SOC_PPD_FRWRD_FEC_RPF_MODE_UC_LOOSE                    SOC_PPC_FRWRD_FEC_RPF_MODE_UC_LOOSE
#define SOC_PPD_FRWRD_FEC_RPF_MODE_MC_EXPLICIT                 SOC_PPC_FRWRD_FEC_RPF_MODE_MC_EXPLICIT
#define SOC_PPD_FRWRD_FEC_RPF_MODE_MC_USE_SIP                  SOC_PPC_FRWRD_FEC_RPF_MODE_MC_USE_SIP
#define SOC_PPD_FRWRD_FEC_RPF_MODE_MC_USE_SIP_WITH_ECMP        SOC_PPC_FRWRD_FEC_RPF_MODE_MC_USE_SIP_WITH_ECMP
typedef SOC_PPC_FRWRD_FEC_RPF_MODE                             SOC_PPD_FRWRD_FEC_RPF_MODE;

#define SOC_PPD_FRWRD_FEC_PROTECT_TYPE_NONE                    SOC_PPC_FRWRD_FEC_PROTECT_TYPE_NONE
#define SOC_PPD_FRWRD_FEC_PROTECT_TYPE_FACILITY                SOC_PPC_FRWRD_FEC_PROTECT_TYPE_FACILITY
#define SOC_PPD_FRWRD_FEC_PROTECT_TYPE_PATH                    SOC_PPC_FRWRD_FEC_PROTECT_TYPE_PATH
typedef SOC_PPC_FRWRD_FEC_PROTECT_TYPE                         SOC_PPD_FRWRD_FEC_PROTECT_TYPE;

#define SOC_PPD_FRWRD_FEC_ENTRY_USE_TYPE_NONE                  SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_NONE
#define SOC_PPD_FRWRD_FEC_ENTRY_USE_TYPE_ONE_FEC               SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_ONE_FEC
#define SOC_PPD_FRWRD_FEC_ENTRY_USE_TYPE_ECMP                  SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_ECMP
#define SOC_PPD_FRWRD_FEC_ENTRY_USE_TYPE_PATH_PROTECT          SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_PATH_PROTECT
#define SOC_PPD_FRWRD_FEC_ENTRY_USE_TYPE_FACILITY_PROTECT      SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_FACILITY_PROTECT
typedef SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE                       SOC_PPD_FRWRD_FEC_ENTRY_USE_TYPE;

#define SOC_PPD_FRWRD_FEC_MATCH_RULE_TYPE_ALL                  SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_ALL
#define SOC_PPD_FRWRD_FEC_MATCH_RULE_TYPE_APP_TYPE             SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_APP_TYPE
#define SOC_PPD_FRWRD_FEC_MATCH_RULE_TYPE_ACCESSED             SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_ACCESSED
#define SOC_PPD_FRWRD_FEC_MATCH_RULE_TYPE_PATH_PROTECTED       SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_PATH_PROTECTED
#define SOC_PPD_FRWRD_FEC_MATCH_RULE_TYPE_FACILITY_PROTECTED   SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_FACILITY_PROTECTED
typedef SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE                      SOC_PPD_FRWRD_FEC_MATCH_RULE_TYPE;

typedef SOC_PPC_FRWRD_FEC_GLBL_INFO                            SOC_PPD_FRWRD_FEC_GLBL_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_RPF_INFO                       SOC_PPD_FRWRD_FEC_ENTRY_RPF_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_APP_INFO                       SOC_PPD_FRWRD_FEC_ENTRY_APP_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_INFO                           SOC_PPD_FRWRD_FEC_ENTRY_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_ACCESSED_INFO                  SOC_PPD_FRWRD_FEC_ENTRY_ACCESSED_INFO;
typedef SOC_PPC_FRWRD_FEC_PROTECT_INFO                         SOC_PPD_FRWRD_FEC_PROTECT_INFO;
typedef SOC_PPC_FRWRD_FEC_ECMP_INFO                            SOC_PPD_FRWRD_FEC_ECMP_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_USE_INFO                       SOC_PPD_FRWRD_FEC_ENTRY_USE_INFO;
typedef SOC_PPC_FRWRD_FEC_MATCH_RULE                           SOC_PPD_FRWRD_FEC_MATCH_RULE;
typedef SOC_PPC_FRWRD_FEC_ECMP_HASH_GLOBAL_INFO                SOC_PPD_FRWRD_FEC_ECMP_HASH_GLOBAL_INFO;
typedef SOC_PPC_FRWRD_FEC_ECMP_HASH_PORT_INFO                  SOC_PPD_FRWRD_FEC_ECMP_HASH_PORT_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_frwrd_fec_get_procs_ptr(void);
void
