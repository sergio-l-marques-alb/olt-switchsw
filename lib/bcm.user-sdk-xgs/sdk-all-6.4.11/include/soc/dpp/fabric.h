...
#define SOC_DPP_FABRIC_MAX_DEST_MESH_MODE            3
#define SOC_DPP_FABRIC_MAX_DEST_MESH_MC_MODE         2
#define SOC_DPP_FABRIC_MAX_MESH_REPLICATION          4
#define SOC_DPP_FABRIC_MAX_NOF_FAP_ID_MAPPED_TO_DEST 2
...
typedef enum soc_dpp_fabric_force {
    ...
    socDppFabricForceRestore = 3     /* Restore default */
...
typedef struct soc_dpp_fabric_topology_status_s {
    ...
    soc_module_t fap_id_group0_array[SOC_DPP_FABRIC_MAX_NOF_FAP_ID_MAPPED_TO_DEST];
    soc_module_t fap_id_group1_array[SOC_DPP_FABRIC_MAX_NOF_FAP_ID_MAPPED_TO_DEST];
    soc_module_t fap_id_group2_array[SOC_DPP_FABRIC_MAX_NOF_FAP_ID_MAPPED_TO_DEST];
...
typedef struct soc_dpp_fabric_queues_info_s {
    uint32 soc_dpp_fabric_dtq_data_max_occ_ctx;
    uint32 soc_dpp_fabric_dtq_data_max_occ_val;
    uint32 soc_dpp_fabric_dtq_ctrl_max_occ_ctx;
    uint32 soc_dpp_fabric_dtq_ctrl_max_occ_val;
    uint32 soc_dpp_fabric_dblf0_max_occ_ctx;
    uint32 soc_dpp_fabric_dblf0_max_occ_val;
    uint32 soc_dpp_fabric_dblf1_max_occ_ctx;
    uint32 soc_dpp_fabric_dblf1_max_occ_val;
...
/*
Receiving link status information
PARAMETERS
unit    (IN) The origin device
link_id    (IN) Link id
link_status    (IN) Link status

RETURNS
SOC_SAND OK or ERROR indication.
*/
int
  soc_fabric_link_status_get(
     int unit, 
     bcm_port_t link_id,  
     SOC_TMC_FABRIC_LINKS_STATUS_SINGLE* link_status
  );
#endif  
...
uint32
soc_dpp_fabric_sync_e_enable_set(
    int unit, 
    int is_master, 
    int port_id
);
