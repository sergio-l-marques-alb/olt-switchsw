/* $Id: pb_interrupt_service.h,v 1.8 Broadcom SDK $
...
#ifndef __SOC_PB_INTERRUPT_SERVICE_INCLUDED__
/* { */
#define __SOC_PB_INTERRUPT_SERVICE_INCLUDED__
...
typedef uint32 (*SOC_PB_INTERRUPT_SINGLE_FUNC) (SOC_SAND_IN  int, SOC_SAND_IN  SOC_PB_INTERRUPT_CAUSE  cause, SOC_SAND_OUT SOC_PB_INTERRUPT_SINGLE_STRUCT*) ;
...
typedef struct
{
   ...
   *
   */
  SOC_PB_INTERRUPT_MONITORED_CAUSE  monitored_cause[SOC_SAND_MAX_DEVICE];
  /*
   *
   */
  SOC_PB_INTERRUPT_SINGLE_FUNC clear_func;

} SOC_PB_INTERRUPT_FIELD;
...
typedef struct
{
   ...
   *
   */
  SOC_PB_INTERRUPT_FIELD            int_fields[SOC_PB_INTERRUPT_MAX_NOF_FIELD_IN_REG];
...
typedef struct
{
   ...
   *
   */
  SOC_PB_INTERRUPT_REG              int_regs[SOC_PB_INTERRUPT_MAX_NOF_REG_IN_MOD];
  /*
   *
   */
...
uint32
  soc_pb_interrupt_specific_cause_mask_unsafe(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  SOC_PB_INTERRUPT_CAUSE            cause
  );

uint32
  soc_pb_interrupt_specific_cause_unmask_unsafe(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  SOC_PB_INTERRUPT_CAUSE            cause
  );
...
uint32
  soc_pb_interrupt_specific_cause_monitor_start_unsafe(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  SOC_PB_INTERRUPT_CAUSE            cause,
    SOC_SAND_OUT SOC_PB_INTERRUPT_MONITORED_CAUSE  *handle
  );

uint32
  soc_pb_interrupt_specific_cause_monitor_stop_unsafe(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  SOC_PB_INTERRUPT_MONITORED_CAUSE  handle
  );
...
uint32
  soc_pb_interrupt_single_clear_unsafe(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  SOC_PB_INTERRUPT_MONITORED_CAUSE  cause_ptr_i,
...
/* } __SOC_PB_INTERRUPT_SERVICE_INCLUDED__*/
#endif
