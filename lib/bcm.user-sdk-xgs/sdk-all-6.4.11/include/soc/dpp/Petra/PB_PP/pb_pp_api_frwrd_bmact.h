/* $Id: pb_pp_api_frwrd_bmact.h,v 1.8 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_frwrd_bmact.h
*
...
#ifndef __SOC_PB_PP_API_FRWRD_BMACT_INCLUDED__
/* { */
#define __SOC_PB_PP_API_FRWRD_BMACT_INCLUDED__
...
#define  SOC_PB_PP_BFID_EQUAL_TO_BVID (SOC_PPC_BFID_EQUAL_TO_BVID)

/*     The B-MACT FID is '0'. Enable shared learning           */
#define  SOC_PB_PP_BFID_IS_0 (SOC_PPC_BFID_IS_0)
...
typedef SOC_PPC_BMACT_BVID_INFO                                SOC_PB_PP_BMACT_BVID_INFO;
typedef SOC_PPC_BMACT_PBB_TE_VID_RANGE                         SOC_PB_PP_BMACT_PBB_TE_VID_RANGE;
typedef SOC_PPC_BMACT_ENTRY_KEY                                SOC_PB_PP_BMACT_ENTRY_KEY;
typedef SOC_PPC_BMACT_ENTRY_INFO                               SOC_PB_PP_BMACT_ENTRY_INFO;
 ...
 *     "soc_pb_pp_frwrd_bmact_bvid_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_bmact_bvid_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_bmact_pbb_te_bvid_range_set" API.
 *     Refer to "soc_pb_pp_frwrd_bmact_pbb_te_bvid_range_set" API
 *     for details.
*********************************************************************/
uint32
...
*     Refer to "soc_pb_pp_frwrd_bmact_eg_vlan_pcp_map_set" API for
*     details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_FRWRD_BMACT_INCLUDED__*/
#endif
