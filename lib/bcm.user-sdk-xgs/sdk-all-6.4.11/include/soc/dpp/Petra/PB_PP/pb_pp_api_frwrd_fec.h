/* $Id: pb_pp_api_frwrd_fec.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_frwrd_fec.h
*
...
#ifndef __SOC_PB_PP_API_FRWRD_FEC_INCLUDED__
/* { */
#define __SOC_PB_PP_API_FRWRD_FEC_INCLUDED__
...
#define SOC_PB_PP_FEC_TYPE_DROP                                SOC_PPC_FEC_TYPE_DROP
#define SOC_PB_PP_FEC_TYPE_IP_MC                               SOC_PPC_FEC_TYPE_IP_MC
#define SOC_PB_PP_FEC_TYPE_IP_UC                               SOC_PPC_FEC_TYPE_IP_UC
#define SOC_PB_PP_FEC_TYPE_TRILL_MC                            SOC_PPC_FEC_TYPE_TRILL_MC
#define SOC_PB_PP_FEC_TYPE_TRILL_UC                            SOC_PPC_FEC_TYPE_TRILL_UC
#define SOC_PB_PP_FEC_TYPE_BRIDGING_INTO_TUNNEL                SOC_PPC_FEC_TYPE_BRIDGING_INTO_TUNNEL
#define SOC_PB_PP_FEC_TYPE_BRIDGING_WITH_AC                    SOC_PPC_FEC_TYPE_BRIDGING_WITH_AC
#define SOC_PB_PP_FEC_TYPE_MPLS_LSR                            SOC_PPC_FEC_TYPE_MPLS_LSR
#define SOC_PB_PP_NOF_FEC_TYPES                                SOC_PPC_NOF_FEC_TYPES_PB
typedef SOC_PPC_FEC_TYPE                                       SOC_PB_PP_FEC_TYPE;

#define SOC_PB_PP_FRWRD_FEC_RPF_MODE_NONE                      SOC_PPC_FRWRD_FEC_RPF_MODE_NONE
#define SOC_PB_PP_FRWRD_FEC_RPF_MODE_UC_STRICT                 SOC_PPC_FRWRD_FEC_RPF_MODE_UC_STRICT
#define SOC_PB_PP_FRWRD_FEC_RPF_MODE_UC_LOOSE                  SOC_PPC_FRWRD_FEC_RPF_MODE_UC_LOOSE
#define SOC_PB_PP_FRWRD_FEC_RPF_MODE_MC_EXPLICIT               SOC_PPC_FRWRD_FEC_RPF_MODE_MC_EXPLICIT
#define SOC_PB_PP_FRWRD_FEC_RPF_MODE_MC_USE_SIP                SOC_PPC_FRWRD_FEC_RPF_MODE_MC_USE_SIP
#define SOC_PB_PP_FRWRD_FEC_RPF_MODE_MC_USE_SIP_WITH_ECMP      SOC_PPC_FRWRD_FEC_RPF_MODE_MC_USE_SIP_WITH_ECMP
#define SOC_PB_PP_NOF_FRWRD_FEC_RPF_MODES                      SOC_PPC_NOF_FRWRD_FEC_RPF_MODES
typedef SOC_PPC_FRWRD_FEC_RPF_MODE                             SOC_PB_PP_FRWRD_FEC_RPF_MODE;

#define SOC_PB_PP_FRWRD_FEC_PROTECT_TYPE_NONE                  SOC_PPC_FRWRD_FEC_PROTECT_TYPE_NONE
#define SOC_PB_PP_FRWRD_FEC_PROTECT_TYPE_FACILITY              SOC_PPC_FRWRD_FEC_PROTECT_TYPE_FACILITY
#define SOC_PB_PP_FRWRD_FEC_PROTECT_TYPE_PATH                  SOC_PPC_FRWRD_FEC_PROTECT_TYPE_PATH
#define SOC_PB_PP_NOF_FRWRD_FEC_PROTECT_TYPES                  SOC_PPC_NOF_FRWRD_FEC_PROTECT_TYPES
typedef SOC_PPC_FRWRD_FEC_PROTECT_TYPE                         SOC_PB_PP_FRWRD_FEC_PROTECT_TYPE;

#define SOC_PB_PP_FRWRD_FEC_ENTRY_USE_TYPE_NONE                SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_NONE
#define SOC_PB_PP_FRWRD_FEC_ENTRY_USE_TYPE_ONE_FEC             SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_ONE_FEC
#define SOC_PB_PP_FRWRD_FEC_ENTRY_USE_TYPE_ECMP                SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_ECMP
#define SOC_PB_PP_FRWRD_FEC_ENTRY_USE_TYPE_PATH_PROTECT        SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_PATH_PROTECT
#define SOC_PB_PP_FRWRD_FEC_ENTRY_USE_TYPE_FACILITY_PROTECT    SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE_FACILITY_PROTECT
typedef SOC_PPC_FRWRD_FEC_ENTRY_USE_TYPE                       SOC_PB_PP_FRWRD_FEC_ENTRY_USE_TYPE;

#define SOC_PB_PP_FRWRD_FEC_MATCH_RULE_TYPE_APP_TYPE           SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_APP_TYPE
#define SOC_PB_PP_FRWRD_FEC_MATCH_RULE_TYPE_ACCESSED           SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_ACCESSED
#define SOC_PB_PP_FRWRD_FEC_MATCH_RULE_TYPE_PATH_PROTECTED     SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_PATH_PROTECTED
#define SOC_PB_PP_FRWRD_FEC_MATCH_RULE_TYPE_FACILITY_PROTECTED SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE_FACILITY_PROTECTED
typedef SOC_PPC_FRWRD_FEC_MATCH_RULE_TYPE                      SOC_PB_PP_FRWRD_FEC_MATCH_RULE_TYPE;

typedef SOC_PPC_FRWRD_FEC_GLBL_INFO                            SOC_PB_PP_FRWRD_FEC_GLBL_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_RPF_INFO                       SOC_PB_PP_FRWRD_FEC_ENTRY_RPF_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_APP_INFO                       SOC_PB_PP_FRWRD_FEC_ENTRY_APP_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_INFO                           SOC_PB_PP_FRWRD_FEC_ENTRY_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_ACCESSED_INFO                  SOC_PB_PP_FRWRD_FEC_ENTRY_ACCESSED_INFO;
typedef SOC_PPC_FRWRD_FEC_PROTECT_INFO                         SOC_PB_PP_FRWRD_FEC_PROTECT_INFO;
typedef SOC_PPC_FRWRD_FEC_ENTRY_USE_INFO                       SOC_PB_PP_FRWRD_FEC_ENTRY_USE_INFO;
typedef SOC_PPC_FRWRD_FEC_MATCH_RULE                           SOC_PB_PP_FRWRD_FEC_MATCH_RULE;
typedef SOC_PPC_FRWRD_FEC_ECMP_HASH_GLOBAL_INFO                SOC_PB_PP_FRWRD_FEC_ECMP_HASH_GLOBAL_INFO;
typedef SOC_PPC_FRWRD_FEC_ECMP_HASH_PORT_INFO                  SOC_PB_PP_FRWRD_FEC_ECMP_HASH_PORT_INFO;
 ...
 *     "soc_pb_pp_frwrd_fec_glbl_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_fec_glbl_info_set" API for
 *     details.
*********************************************************************/
uint32
 ...
 *     API.
 *     Refer to
 *     "soc_pb_pp_frwrd_fec_protection_oam_instance_status_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_fec_protection_sys_port_status_set" API.
 *     Refer to
 *     "soc_pb_pp_frwrd_fec_protection_sys_port_status_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_fec_entry_accessed_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_fec_entry_accessed_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_fec_ecmp_hashing_global_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_fec_ecmp_hashing_global_info_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_frwrd_fec_ecmp_hashing_port_info_set" API.
 *     Refer to "soc_pb_pp_frwrd_fec_ecmp_hashing_port_info_set"
 *     API for details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_FRWRD_FEC_INCLUDED__*/
#endif
