/* $Id: petra_api_ingress_traffic_mgmt.h,v 1.8 Broadcom SDK $
...
#ifndef __SOC_PETRA_API_INGRESS_TRAFFIC_MGMT_INCLUDED__
/* { */
#define __SOC_PETRA_API_INGRESS_TRAFFIC_MGMT_INCLUDED__
...
#define  SOC_PETRA_ITM_NOF_DRAM_BUFFS (SOC_TMC_ITM_NOF_DRAM_BUFFS)

/*     Maximal number of DRAM buffers used for Full Multicast. */
#define  SOC_PETRA_ITM_DBUFF_FMC_MAX (8 * 1024)
...
*     copies are required.                                    */
#define  SOC_PETRA_ITM_DBUFF_MMC_MAX (SOC_TMC_ITM_DBUFF_MMC_MAX)

#define SOC_PETRA_ITM_NOF_VSQS 356

/* $Id: petra_api_ingress_traffic_mgmt.h,v 1.8 Broadcom SDK $
* Definition values for Ingress Queue Priority
*/

#define SOC_PETRA_ITM_PRIO_MAP_BIT_SIZE       64
#define SOC_PETRA_ITM_PRIO_MAP_SIZE_IN_UINT32S  2
#define SOC_PETRA_ITM_PRIO_NOF_SEGMENTS       SOC_SAND_DIV_ROUND_UP(SOC_PETRA_NOF_QUEUES, SOC_PETRA_ITM_PRIO_MAP_BIT_SIZE)

/*
 * Drop Tail Resolution 16 bytes
 */
#define SOC_PETRA_ITM_DROP_TAIL_SIZE_RESOLUTION 16
...
*/
#define SOC_PETRA_ITM_SYS_RED_Q_SIZE_RANGES   16
#define SOC_PETRA_ITM_SYS_RED_DRP_PROBS       16
#define SOC_PETRA_ITM_SYS_RED_BUFFS_RNGS      4

  /* Maximum ITM-VSQ-Rate-Class: Value 15  */
#define SOC_PETRA_ITM_VSQ_QT_RT_CLS_MAX  15


#define SOC_PETRA_ITM_VSQ_GROUP_CTGRY_SIZE 4
#define SOC_PETRA_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS_SIZE \
  ((SOC_PETRA_NOF_TRAFFIC_CLASSES)*SOC_PETRA_ITM_VSQ_GROUP_CTGRY_SIZE)
#define SOC_PETRA_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS_SIZE ((SOC_PETRA_ITM_QT_CC_CLS_MAX+1)*2)

/*
 *  Minimal/Maximal allowed value for Queue Credit Watchdog, in milliseconds.
 */
#define SOC_PETRA_ITM_CR_WD_Q_TH_MIN_MSEC             100
#define SOC_PETRA_ITM_CR_WD_Q_TH_MAX_MSEC             500

#define SOC_PETRA_ITM_VSQ_GROUP_LAST          SOC_TMC_ITM_VSQ_GROUP_LAST_PETRA
#define SOC_PETRA_ITM_ADMIT_TSTS_LAST         SOC_TMC_ITM_ADMIT_TSTS_LAST

#define SOC_PETRA_ITM_DBUFF_SIZE_BYTES_MIN        SOC_TMC_ITM_DBUFF_SIZE_BYTES_MIN
#define SOC_PETRA_ITM_DBUFF_SIZE_BYTES_MAX        SOC_TMC_ITM_DBUFF_SIZE_BYTES_MAX
/*} */
...
#define SOC_PETRA_ITM_QT_NDX_00                                SOC_TMC_ITM_QT_NDX_00

#define SOC_PETRA_ITM_NOF_QT_NDXS                              SOC_TMC_ITM_NOF_QT_NDXS
typedef SOC_TMC_ITM_QT_NDX                                     SOC_PETRA_ITM_QT_NDX;

#define SOC_PETRA_ITM_CR_DISCNT_CLS_NDX_00                     SOC_TMC_ITM_CR_DISCNT_CLS_NDX_00
#define SOC_PETRA_ITM_NOF_CR_DISCNT_CLS_NDXS                   SOC_TMC_ITM_NOF_CR_DISCNT_CLS_NDXS
typedef SOC_TMC_ITM_CR_DISCNT_CLS_NDX                          SOC_PETRA_ITM_CR_DISCNT_CLS_NDX;

#define SOC_PETRA_ITM_DBUFF_SIZE_BYTES_256                     SOC_TMC_ITM_DBUFF_SIZE_BYTES_256
#define SOC_PETRA_ITM_DBUFF_SIZE_BYTES_512                     SOC_TMC_ITM_DBUFF_SIZE_BYTES_512
#define SOC_PETRA_ITM_DBUFF_SIZE_BYTES_1024                    SOC_TMC_ITM_DBUFF_SIZE_BYTES_1024
#define SOC_PETRA_ITM_DBUFF_SIZE_BYTES_2048                    SOC_TMC_ITM_DBUFF_SIZE_BYTES_2048
#define SOC_PETRA_ITM_NOF_DBUFF_SIZES                          SOC_TMC_ITM_NOF_DBUFF_SIZES
typedef SOC_TMC_ITM_DBUFF_SIZE_BYTES                           SOC_PETRA_ITM_DBUFF_SIZE_BYTES;

#define SOC_PETRA_ITM_VSQ_GROUPA_SZE                           SOC_TMC_ITM_ARAD_VSQ_GROUPA_SZE
#define SOC_PETRA_ITM_VSQ_GROUPB_SZE                           SOC_TMC_ITM_ARAD_VSQ_GROUPB_SZE
#define SOC_PETRA_ITM_VSQ_GROUPC_SZE                           SOC_TMC_ITM_ARAD_VSQ_GROUPC_SZE
#define SOC_PETRA_ITM_VSQ_GROUPD_SZE                           SOC_TMC_ITM_ARAD_VSQ_GROUPD_SZE
typedef SOC_TMC_ITM_VSQ_GROUP_SIZE                             SOC_PETRA_ITM_VSQ_GROUP_SIZE;

#define SOC_PETRA_ITM_VSQ_NDX_MIN                              SOC_TMC_ITM_ARAD_VSQ_NDX_MIN
#define SOC_PETRA_ITM_VSQ_NDX_MAX                              SOC_TMC_ITM_ARAD_VSQ_NDX_MAX_PETRA
typedef SOC_TMC_ITM_VSQ_NDX_RNG		                           SOC_PETRA_ITM_VSQ_NDX_RNG;

#define SOC_PETRA_ITM_ADMIT_TST_00                             SOC_TMC_ITM_ADMIT_TST_00
#define SOC_PETRA_ITM_ADMIT_TST_01                             SOC_TMC_ITM_ADMIT_TST_01
#define SOC_PETRA_ITM_ADMIT_TST_02                             SOC_TMC_ITM_ADMIT_TST_02
#define SOC_PETRA_ITM_ADMIT_TST_03                             SOC_TMC_ITM_ADMIT_TST_03
typedef SOC_TMC_ITM_ADMIT_TSTS                                 SOC_PETRA_ITM_ADMIT_TSTS;

#define SOC_PETRA_ITM_VSQ_GROUP_CTGRY                          SOC_TMC_ITM_VSQ_GROUP_CTGRY
#define SOC_PETRA_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS              SOC_TMC_ITM_VSQ_GROUP_CTGRY_TRAFFIC_CLS
#define SOC_PETRA_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS            SOC_TMC_ITM_VSQ_GROUP_CTGRY_2_3_CNCTN_CLS
#define SOC_PETRA_ITM_VSQ_GROUP_STTSTCS_TAG                    SOC_TMC_ITM_VSQ_GROUP_STTSTCS_TAG
typedef SOC_TMC_ITM_VSQ_GROUP                                  SOC_PETRA_ITM_VSQ_GROUP;

typedef SOC_TMC_ITM_DRAM_BUFFERS_INFO                          SOC_PETRA_ITM_DRAM_BUFFERS_INFO;
typedef SOC_TMC_ITM_GLOB_RCS_FC_TYPE                           SOC_PETRA_ITM_GLOB_RCS_FC_TYPE;
typedef SOC_TMC_ITM_GLOB_RCS_FC_TH                             SOC_PETRA_ITM_GLOB_RCS_FC_TH;
typedef SOC_TMC_ITM_GLOB_RCS_DROP_TH                           SOC_PETRA_ITM_GLOB_RCS_DROP_TH;
typedef SOC_TMC_ITM_QUEUE_INFO                                 SOC_PETRA_ITM_QUEUE_INFO;
typedef SOC_TMC_ITM_CATEGORY_RNGS                              SOC_PETRA_ITM_CATEGORY_RNGS;
typedef SOC_TMC_ITM_ADMIT_ONE_TEST_TMPLT                       SOC_PETRA_ITM_ADMIT_ONE_TEST_TMPLT;
typedef SOC_TMC_ITM_ADMIT_TEST_TMPLT_INFO                      SOC_PETRA_ITM_ADMIT_TEST_TMPLT_INFO;
typedef SOC_TMC_ITM_CR_REQUEST_HUNGRY_TH                       SOC_PETRA_ITM_CR_REQUEST_HUNGRY_TH;
typedef SOC_TMC_ITM_CR_REQUEST_BACKOFF_TH                      SOC_PETRA_ITM_CR_REQUEST_BACKOFF_TH;
typedef SOC_TMC_ITM_CR_REQUEST_BACKLOG_TH                      SOC_PETRA_ITM_CR_REQUEST_BACKLOG_TH;
typedef SOC_TMC_ITM_CR_REQUEST_EMPTY_Q_TH                      SOC_PETRA_ITM_CR_REQUEST_EMPTY_Q_TH;
typedef SOC_TMC_ITM_CR_REQUEST_SATISFIED_TH                    SOC_PETRA_ITM_CR_REQUEST_SATISFIED_TH;
typedef SOC_TMC_ITM_CR_WD_Q_TH                                 SOC_PETRA_ITM_CR_WD_Q_TH;
typedef SOC_TMC_ITM_CR_REQUEST_INFO                            SOC_PETRA_ITM_CR_REQUEST_INFO;
typedef SOC_TMC_ITM_CR_DISCOUNT_INFO                           SOC_PETRA_ITM_CR_DISCOUNT_INFO;
typedef SOC_TMC_ITM_WRED_QT_DP_INFO                            SOC_PETRA_ITM_WRED_QT_DP_INFO;
typedef SOC_TMC_ITM_TAIL_DROP_INFO                             SOC_PETRA_ITM_TAIL_DROP_INFO;
typedef SOC_TMC_ITM_CR_WD_INFO                                 SOC_PETRA_ITM_CR_WD_INFO;
typedef SOC_TMC_ITM_VSQ_FC_INFO                                SOC_PETRA_ITM_VSQ_FC_INFO;
typedef SOC_TMC_ITM_VSQ_TAIL_DROP_INFO                         SOC_PETRA_ITM_VSQ_TAIL_DROP_INFO;
typedef SOC_TMC_ITM_VSQ_WRED_GEN_INFO                          SOC_PETRA_ITM_VSQ_WRED_GEN_INFO;
typedef SOC_TMC_ITM_INGRESS_SHAPE_Q_RANGE                      SOC_PETRA_ITM_INGRESS_SHAPE_Q_RANGE;
typedef SOC_TMC_ITM_INGRESS_SHAPE_INFO                         SOC_PETRA_ITM_INGRESS_SHAPE_INFO;
typedef SOC_TMC_ITM_PRIORITY_MAP_TMPLT                         SOC_PETRA_ITM_PRIORITY_MAP_TMPLT;
typedef SOC_TMC_ITM_SYS_RED_DROP_PROB                          SOC_PETRA_ITM_SYS_RED_DROP_PROB;
typedef SOC_TMC_ITM_SYS_RED_QT_DP_INFO                         SOC_PETRA_ITM_SYS_RED_QT_DP_INFO;
typedef SOC_TMC_ITM_SYS_RED_QT_INFO                            SOC_PETRA_ITM_SYS_RED_QT_INFO;
typedef SOC_TMC_ITM_SYS_RED_EG_INFO                            SOC_PETRA_ITM_SYS_RED_EG_INFO;
typedef SOC_TMC_ITM_SYS_RED_GLOB_RCS_THS                       SOC_PETRA_ITM_SYS_RED_GLOB_RCS_THS;
typedef SOC_TMC_ITM_SYS_RED_GLOB_RCS_VALS                      SOC_PETRA_ITM_SYS_RED_GLOB_RCS_VALS;
typedef SOC_TMC_ITM_SYS_RED_GLOB_RCS_INFO                      SOC_PETRA_ITM_SYS_RED_GLOB_RCS_INFO;

typedef SOC_TMC_ITM_VSQ_NDX                                    SOC_PETRA_ITM_VSQ_NDX;
...
typedef enum{
   ...
   */
  SOC_PETRA_ITM_STAG_ENABLE_MODE_DISABLED=0,
  /*
   ...
   */
  SOC_PETRA_ITM_STAG_ENABLE_MODE_STAT_IF_NO_DEQ=1,
  /*
   ...
   *  traffic bandwidth.
   */
  SOC_PETRA_ITM_STAG_ENABLE_MODE_ENABLED_WITH_DEQ=2,
  /*
   *  Total number of STAG enable modes.
   */
  SOC_PETRA_ITM_NOF_STAG_ENABLE_MODES=3
}SOC_PETRA_ITM_STAG_ENABLE_MODE;
...
typedef struct
{
   ...
   */
  SOC_PETRA_ITM_STAG_ENABLE_MODE enable_mode;
  /*
...
{
  /* VSQ Queue type */
  SOC_PETRA_ITM_Q_TYPE_VSQ = 0,

  /* VOQ Queue type */
  SOC_PETRA_ITM_Q_TYPE_VOQ = 1,

  SOC_PETRA_ITM_NOF_Q_TYPES = 2
}SOC_PETRA_ITM_Q_TYPE;

typedef struct
{
  SOC_SAND_MAGIC_NUM_VAR
  /*
   *  Queue id of the queue with the maximum queue occupancy
   *  in the subset. 
   */
  uint32 id;
  /*
   *  Maximum queue size. Units: Bytes. Resolution: 16 Bytes.
   */
  uint32 max_size;
  /* 
   * Maximal size in Buffer descriptors unit.  
   * Valid only for a VSQ Queue type.
   */
  uint32 max_size_bd;

} SOC_PETRA_ITM_Q_OCCUPANCY;
 ...
 *     if set, the ECN functionality is enabled.               
 * REMARKS:         
 *   1. Enabling ECN affects Drop Precedence indication 
 *   interpretation for all traffic (and not just 
 *   ECN-eligible). Only the MSB of Drop Precedence 
 *   indication is used. Traffic marked "Red", if not dropped 
 *   internally by the device, egress with "Yellow" 
 *   indication. Yellow and Green Drop Precedence is 
 *   preserved, but the indication is single-bit: '1' means 
 *   "Yellow", '0' means "Green". 2. When ECN is enabled, 
 *   only eight snoop commands are supported 3. This is 
 *   Soc_petra-A only functionality.                             
 * RETURNS:         
 ...
 *     "soc_petra_itm_ecn_enable_set" API.                         
 *     Refer to "soc_petra_itm_ecn_enable_set" API for details.    
*********************************************************************/
uint32  
...
*        or any counter read/print API of soc_petra_stat module.
*     2. This API is considered deprecated.
*        It is replaced by the soc_petra_stat_vsq_cnt_select_set API.
* RETURNS:
*     OK or ERROR indication.
*********************************************************************/
...
*  3. Can be also read using counter read/print APIs of soc_petra_stat module.
* RETURNS:
*     OK or ERROR indication.
*********************************************************************/
 ...
 *     Queue type: VOQ or VSQ.
 *   SOC_SAND_OUT SOC_PETRA_ITM_Q_OCCUPANCY            *q_max_occ -
 *     Indicate the maximum queue occupancy and its id.
 * REMARKS:
 *   None.
 * RETURNS:
 *   OK or ERROR indication.
...
* REMARKS:
*  IMPORTANT:
*   For Soc_petra-A:if this API called after traffic was injected to the Soc_petra
...
*   This limitation does not exist for Soc_petra-B
* RETURNS:
*   OK or ERROR indication.
*********************************************************************/
uint32
  soc_petra_itm_queue_info_set(
    ...
    SOC_SAND_IN  uint32                  queue_ndx,
    SOC_SAND_IN  SOC_PETRA_ITM_QUEUE_INFO      *old_info,
    SOC_SAND_IN  SOC_PETRA_ITM_QUEUE_INFO      *info
  );
...
*     SOC_PETRA_ITM_SYS_RED_QT_DP_INFO *exact_info - To be filled
...
*     pointer to configuration structure. SOC_SAND_OUT
*     SOC_PETRA_ITM_SYS_RED_GLOB_RCS_VAL_INFO *exact_info - To be
...
/* } __SOC_PETRA_API_INGRESS_TRAFFIC_MGMT_INCLUDED__*/
#endif
