...
typedef uint32 (*mbcm_dpp_egr_queuing_global_drop_set_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
...
typedef uint32 (*mbcm_dpp_egr_queuing_global_drop_get_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
...
typedef uint32 (*mbcm_dpp_egr_queuing_sp_tc_drop_set_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    int    tc,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
...
typedef uint32 (*mbcm_dpp_egr_queuing_sp_tc_drop_get_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    int    tc,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
...
typedef uint32 (*mbcm_dpp_egr_queuing_sp_reserved_set_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    int    tc,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
...
typedef uint32 (*mbcm_dpp_egr_queuing_global_fc_set_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
    SOC_SAND_IN    int    threshold_value,
...
typedef uint32 (*mbcm_dpp_egr_queuing_global_fc_get_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
    SOC_SAND_OUT   int*   threshold_value,
...
typedef uint32 (*mbcm_dpp_egr_queuing_mc_tc_fc_set_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    int    tc,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
...
typedef uint32 (*mbcm_dpp_egr_queuing_mc_tc_fc_get_f) (
    SOC_SAND_IN    int    unit,
    SOC_SAND_IN    int    core,
    SOC_SAND_IN    int    tc,
    SOC_SAND_IN    soc_dpp_cosq_threshold_type_t threshold_type,
...
typedef uint32 (*mbcm_dpp_fabric_force_set_f) ( 
    SOC_SAND_IN  int                unit, 
...
typedef soc_error_t (*mbcm_dpp_qsgmii_offsets_add_f) (
    int                      unit,
    uint32                   phy,
    uint32                   *new_phy
  );

typedef soc_error_t (*mbcm_dpp_qsgmii_offsets_add_pbmp_f) (
    int                      unit,
    soc_pbmp_t               *pbmp,
    soc_pbmp_t               *new_pbmp
  );

typedef soc_error_t (*mbcm_dpp_qsgmii_offsets_remove_f) (
    int                      unit,
    uint32                   phy,
    uint32                   *new_phy
  );
...
typedef soc_error_t (*mbcm_dpp_qsgmii_offsets_remove_pbmp_f) (
    int                      unit,
    soc_pbmp_t               *pbmp,
    soc_pbmp_t               *new_pbmp
  );
...
typedef int (*mbcm_dpp_qsgmii_id_to_phy_pbmp_get_f)(
    const int  unit, 
    soc_port_t port, 
    uint32     id, 
...
typedef struct mbcm_dpp_functions_s {
    ...
    mbcm_dpp_qsgmii_id_to_phy_pbmp_get_f                                mbcm_dpp_qsgmii_id_to_phy_pbmp_get;
