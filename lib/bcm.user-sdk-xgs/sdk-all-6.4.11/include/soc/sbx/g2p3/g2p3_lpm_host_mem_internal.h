...
/*
 * $Id: g2p3_lpm_host_mem_internal.h,v 1.6 Broadcom SDK $
 *
...
typedef struct g2p3_lpmHostMem_s {
    ...
    uint8  *start;            /* start of host mem */
    uint8  *free;             /* start of free host mem */
    uint8  *top;              /* end of host mem */
    uint64 newAllocs;         /* number of allocs requiring raising top */
    uint64 reusedAllocs;      /* number of allocs reusing free list entry */
    uint64 deallocs;          /* number of deallocs */
    uint64 allocBytes;        /* number of bytes allocated */
    uint64 deallocBytes;      /* number of bytes allocated */
