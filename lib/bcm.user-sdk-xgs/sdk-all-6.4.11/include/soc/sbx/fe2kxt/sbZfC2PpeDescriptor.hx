...
typedef struct _sbZfC2PpeDescriptor {
  ...
  uint32 m_uRxPortData0;
  uint32 m_uReplicantCnt;
  uint32 m_bReplicantBit;
  uint32 m_uResv0;
  uint32 m_uDrop;
  uint32 m_uEnqueue;
  uint32 m_uDqueue;
  uint32 m_uRxPortData1;
...
#define SB_ZF_C2PPEDESCRIPTOR_GET_RXPORT1(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32) (pFromData)[166] << 2; \
           (nToData) |= (uint32) (pFromData)[167] << 10; \
          } while(0)
