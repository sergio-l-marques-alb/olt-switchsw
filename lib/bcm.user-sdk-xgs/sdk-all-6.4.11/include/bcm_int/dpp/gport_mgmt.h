...
int _bcm_dpp_gport_l2_intf_gport_has_remote_lif(int unit, bcm_gport_t gport_id, uint8 *remote_lif);
 ...
 */
int 
_bcm_dpp_gport_and_encap_from_fwd_decision(int unit, bcm_gport_t *gport, int *encap_id, SOC_PPD_FRWRD_DECISION_INFO  *fwd_decsion, uint32 encap_usage, uint8 force_destination);
...
/*
 * Function:
 *    _bcm_dpp_lif_to_sw_resources
 * Description:
 *    map lif to its SW resources
 * Parameters:
 *    unit -    [IN] DPP device unit number (driver internal).
 *    in_lif -  [IN] in lif
 *    out_lif -  [IN] out lif
...
/* LIF Usage */
int _bcm_dpp_lif_sw_resources_lif_usage_get(int unit, int in_lif, int out_lif, _bcm_lif_type_e *in_lif_usage, _bcm_lif_type_e *out_lif_usage);
int _bcm_dpp_lif_sw_resources_lif_usage_set(int unit, int in_lif, int out_lif, _bcm_lif_type_e in_lif_usage, _bcm_lif_type_e out_lif_usage);
...
/* store and get vsi */
int _bcm_dpp_lif_sw_resources_vsi_set(int unit, int in_lif, int vsi);
int _bcm_dpp_lif_sw_resources_vsi_get(int unit, int in_lif, int *vsi);
