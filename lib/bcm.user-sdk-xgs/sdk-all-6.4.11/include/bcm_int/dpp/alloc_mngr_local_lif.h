...
#define _BCM_DPP_AM_EGRESS_LIF_NOF_TOP_BANKS_ENTRIES_PER_TOP_BANK (_BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_HALF_BANK /_BCM_DPP_AM_EGRESS_LIF_NOF_TOP_BANKS_PER_HALF_BANK)
...
#define _BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_RANGES             (2)
#define _BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_PROFILES_PER_RANGE (1)
#define _BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_PROFILES (_BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_PROFILES_PER_RANGE * _BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_RANGES)
...
typedef struct bcm_dpp_am_local_inlif_table_bank_info_s
{
    uint8  valid;
    uint32 phase_bmp;
    bcm_dpp_am_local_inlif_six_packs_info_t packs_info[_BCM_DPP_AM_LOCAL_LIF_NOF_INLIF_HALF_ENTRIES_PER_BANK/6 + 1];
...
typedef struct bcm_dpp_alloc_mngr_local_inlif_info_s {
    ...
    bcm_dpp_am_local_inlif_table_bank_info_t        bank_info[_BCM_DPP_AM_INGRESS_LIF_NOF_BANKS];
    bcm_dpp_am_local_inlif_application_type_info_t  application_type_info[bcm_dpp_am_ingress_lif_nof_app_types];
    bcm_dpp_am_local_lif_counter_profile_info_t     counter_profile_info[_BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_PROFILES];
...
typedef struct bcm_dpp_alloc_mngr_local_outlif_info_s {
   uint8                                           initalized;
   uint8                                           lif_allocated;
   bcm_dpp_am_local_out_lif_info_t                 data_base[_BCM_DPP_AM_INGRESS_LIF_NOF_OUTLIF_IDS];
   bcm_dpp_am_local_lif_counter_profile_info_t     counter_profile_info[_BCM_DPP_AM_LOCAL_LIF_NOF_COUNTING_PROFILES];
} bcm_dpp_alloc_mngr_local_outlif_info_t;

typedef struct bcm_dpp_alloc_mngr_outlif_eedb_banks_info_s {
   arad_pp_eg_encap_eedb_bank_info_t               banks[_BCM_DPP_AM_EGRESS_LIF_NOF_EEDB_HALF_BANKS];
   arad_pp_eg_encap_eedb_top_bank_info_t           top_banks[_BCM_DPP_AM_EGRESS_LIF_NOF_TOP_BANKS];
