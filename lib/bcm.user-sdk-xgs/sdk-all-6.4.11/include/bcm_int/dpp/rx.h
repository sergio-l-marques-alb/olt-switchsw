...
int _bcm_dpp_rx_fill_destination_info_egress_trap(/*in*/ int unit, int core, int dest_port,/*out*/ SOC_PPD_TRAP_EG_ACTION_PROFILE_INFO *prm_egr_profile_info, SOC_PPD_TRAP_FRWRD_ACTION_PROFILE_INFO  *prm_profile_info);
