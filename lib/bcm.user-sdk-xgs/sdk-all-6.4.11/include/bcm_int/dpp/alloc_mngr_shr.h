...
typedef enum _dpp_am_res_e {
    ...
    /*proactive approach to enable addition of resources ater ISSU */
    dpp_am_res_ISSU_reserve_1,
    dpp_am_res_ISSU_reserve_2,
    dpp_am_res_ISSU_reserve_3,
    dpp_am_res_ISSU_reserve_4,
    dpp_am_res_ISSU_reserve_5,
...
typedef enum _dpp_am_template_e {
    ...
    /*proactive approach to enable addition of templates ater ISSU */
...
int
_bcm_dpp_template_warm_boot_setup(int unit, int template_id, int core_id, int pool_id);
