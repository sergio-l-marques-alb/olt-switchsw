...
extern int _bcm_th_aggregation_id_list_init(int unit);
extern int _bcm_th_aggregation_id_list_detach(int unit);
extern int _bcm_th_aggid_trunk_map_init(int unit);
extern int _bcm_th_aggid_trunk_map_detach(int unit);
extern int get_free_aggregation_id(int unit, int pipe);
extern int 
_bcm_th_set_repl_port_agg_map(int unit, const bcm_port_t *local_member_array,
...
#if defined(ALPM_ENABLE) && defined(INCLUDE_L3)
