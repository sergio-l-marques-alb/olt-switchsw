...
extern int _bcm_trx_lltag_vlan_translate_entry_assemble(int unit, vlan_xlate_entry_t *vent,
                                      bcm_gport_t port,
...
extern int _bcm_egr_lport_profile_entry_get(int unit, int index, int count,
                                        void **entries);
extern int _bcm_egr_lport_profile_fields32_modify(int unit, int table_id,
                                              int field_count,
                                              soc_field_t *fields,
                                              uint32 *values);
extern int _bcm_egr_lport_profile_field32_modify(int unit, int table_id,
                                             soc_field_t field,
                                             uint32 value);
...
extern int _bcm_field_trx_qset_get(bcm_field_qset_t *qset_in,
