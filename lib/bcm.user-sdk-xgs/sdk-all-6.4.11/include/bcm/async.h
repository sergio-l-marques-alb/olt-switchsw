 ...
 * Generated:	Sat Feb 20 23:52:24 2016
 */
...
void	bcm_cosq_ingress_port_drop_enable_get_async(int unit, bcm_port_t port, uint32 flags, int * enable, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_ingress_port_drop_enable_set_async(int unit, bcm_port_t port, uint32 flags, int enable, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_ingress_port_drop_map_get_async(int unit, bcm_port_t port, uint32 flags, bcm_cosq_ingress_port_drop_map_t map, uint32 key, bcm_color_t * color, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_ingress_port_drop_map_set_async(int unit, bcm_port_t port, uint32 flags, bcm_cosq_ingress_port_drop_map_t map, uint32 key, bcm_color_t color, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_ingress_port_drop_threshold_get_async(int unit, bcm_port_t port, uint32 flags, bcm_color_t color, uint32 * value, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_ingress_port_drop_threshold_set_async(int unit, bcm_port_t port, uint32 flags, bcm_color_t color, uint32 value, bcm_async_cb_t async_callback, void *async_cookie);
