...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyMyStation2Hit = 602, /* Applicable only when RIOT is enabled.
                                           ...
                                           packets. */
    bcmFieldQualifyCount = 603          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionSwapSourceIPDestIP = 425, /* Swap Destination and Source IP
                                           addresses */
    bcmFieldActionReplaceTtl = 426,     /* TTL is replaced the value programmed
    ...
    bcmFieldActionReplaceOuterVlanPriority = 433, /* Replace Outer Vlan Priority */
    ...
    bcmFieldActionIEEE1588 = 436,       /* Setting varoius parameters for 1588
                                           frames */
    bcmFieldActionCount = 437           /* Always Last. Not a usable value. */
} bcm_field_action_t;
