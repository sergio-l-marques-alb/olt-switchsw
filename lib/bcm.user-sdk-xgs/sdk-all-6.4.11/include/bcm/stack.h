...
/* Adds the module id to the local device. */
extern int bcm_stk_modid_config_add(
    int unit, 
    bcm_stk_modid_config_t *modid);

/* Deletes the module id of the local device. */
extern int bcm_stk_modid_config_delete(
    int unit, 
    bcm_stk_modid_config_t *modid);

/* Deletes all the module ids added on the local device. */
extern int bcm_stk_modid_config_delete_all(
    int unit);

/* Gets all the module ids added on the local device. */
