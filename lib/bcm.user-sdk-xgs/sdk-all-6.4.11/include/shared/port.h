...
typedef enum _shr_port_phy_control_e {
    ...
    _SHR_PORT_PHY_CONTROL_MEDIUM_TYPE = 310,
    _SHR_PORT_PHY_CONTROL_AUTONEG_ALLOW_PLL_CHANGE = 311,
    _SHR_PORT_PHY_CONTROL_FAIL_OVER_MODE = 312,
    _SHR_PORT_PHY_SHORT_CHANNEL_MODE = 313,
    _SHR_PORT_PHY_CONTROL_EYE_VAL_HZ_L = 314,
    _SHR_PORT_PHY_CONTROL_EYE_VAL_HZ_R = 315,
    _SHR_PORT_PHY_CONTROL_EYE_VAL_VT_U = 316,
    _SHR_PORT_PHY_CONTROL_EYE_VAL_VT_D = 317,
    _SHR_PORT_PHY_CONTROL_FORWARD_ERROR_CORRECTION_CL91 = 318,
    _SHR_PORT_PHY_CONTROL_SHORT_CHANNEL_MODE_STATUS = 319,
