...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_set_cb)(
    int _unit, int guaranteed_q_resource_idx_0, CONST soc_dpp_guaranteed_q_resource_t *guaranteed_q_resource);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_get_cb)(
    int _unit, int guaranteed_q_resource_idx_0, soc_dpp_guaranteed_q_resource_t *guaranteed_q_resource);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_verify_cb)(
    int _unit, int guaranteed_q_resource_idx_0);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_set_cb)(
    int _unit, int guaranteed_q_resource_idx_0, CONST soc_dpp_guaranteed_pair_t *dram);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_get_cb)(
    int _unit, int guaranteed_q_resource_idx_0, soc_dpp_guaranteed_pair_t *dram);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_total_set_cb)(
    int _unit, int guaranteed_q_resource_idx_0, uint32 total);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_dram_used_set_cb)(
    int _unit, int guaranteed_q_resource_idx_0, uint32 used);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_set_cb)(
    int _unit, int guaranteed_q_resource_idx_0, CONST soc_dpp_guaranteed_pair_t *ocb);
...
typedef int (*sw_state_dpp_soc_arad_tm_guaranteed_q_resource_ocb_get_cb)(
    int _unit, int guaranteed_q_resource_idx_0, soc_dpp_guaranteed_pair_t *ocb);
