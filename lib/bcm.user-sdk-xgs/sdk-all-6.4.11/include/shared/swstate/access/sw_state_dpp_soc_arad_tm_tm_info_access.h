...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_sysport2basequeue_set_cb)(
    int _unit, int sysport2basequeue_idx_0, CONST ARAD_SW_DB_SYSPORT_TO_BASE_QUEUE *sysport2basequeue);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_sysport2basequeue_get_cb)(
    int _unit, int sysport2basequeue_idx_0, ARAD_SW_DB_SYSPORT_TO_BASE_QUEUE *sysport2basequeue);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_sysport2basequeue_verify_cb)(
    int _unit, int sysport2basequeue_idx_0);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_sysport2basequeue_valid_flags_set_cb)(
    int _unit, int sysport2basequeue_idx_0, uint8 valid_flags);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_sysport2basequeue_base_queue_set_cb)(
    int _unit, int sysport2basequeue_idx_0, uint32 base_queue);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_queuequartet2sysport_set_cb)(
    int _unit, int queuequartet2sysport_idx_0, ARAD_SYSPORT queuequartet2sysport);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_queuequartet2sysport_verify_cb)(
    int _unit, int queuequartet2sysport_idx_0);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_rcy_channels_to_egr_nif_mapping_set_cb)(
    int _unit, int rcy_channels_to_egr_nif_mapping_idx_0, int rcy_channels_to_egr_nif_mapping_idx_1, int rcy_channels_to_egr_nif_mapping);
#endif /* LINK_ARAD_LIBRARIES*/ 
...
typedef int (*sw_state_dpp_soc_arad_tm_tm_info_rcy_channels_to_egr_nif_mapping_verify_cb)(
    int _unit, int rcy_channels_to_egr_nif_mapping_idx_0, int rcy_channels_to_egr_nif_mapping_idx_1);
#endif /* LINK_ARAD_LIBRARIES*/ 
