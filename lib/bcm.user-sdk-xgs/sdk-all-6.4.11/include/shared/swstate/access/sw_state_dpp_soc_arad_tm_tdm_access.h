...
typedef int (*sw_state_dpp_soc_arad_tm_tdm_context_map_set_cb)(
    int _unit, int context_map_idx_0, ARAD_INTERFACE_ID context_map);
...
typedef int (*sw_state_dpp_soc_arad_tm_tdm_context_map_verify_cb)(
    int _unit, int context_map_idx_0);
...
int sw_state_dpp_soc_arad_tm_tdm_access_cb_init(int _unit);
