...
typedef int (*sw_state_dpp_soc_arad_tm_q_type_ref_count_set_cb)(
    int _unit, int q_type_ref_count_idx_0, uint32 q_type_ref_count);
...
typedef int (*sw_state_dpp_soc_arad_tm_q_type_ref_count_verify_cb)(
    int _unit, int q_type_ref_count_idx_0);
...
int sw_state_dpp_soc_arad_tm_q_type_ref_count_access_cb_init(int _unit);
