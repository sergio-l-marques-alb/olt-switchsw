...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_set_cb)(
    int _unit, int occ_bm_hndl_idx_0, SOC_SAND_OCC_BM_PTR occ_bm_hndl);
...
typedef int (*sw_state_dpp_soc_arad_pp_ipv4_pat_occ_bm_hndl_verify_cb)(
    int _unit, int occ_bm_hndl_idx_0);
...
int sw_state_dpp_soc_arad_pp_ipv4_pat_access_cb_init(int _unit);
