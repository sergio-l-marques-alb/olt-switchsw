...
typedef int (*sw_state_dpp_bcm_policer_set_cb)(
    int _unit, int policer_idx_0, CONST _dpp_policer_state_t *policer);

/* implemented by: sw_state_dpp_bcm_policer_get */
typedef int (*sw_state_dpp_bcm_policer_get_cb)(
    int _unit, int policer_idx_0, _dpp_policer_state_t *policer);
...
typedef int (*sw_state_dpp_bcm_policer_policer_group_mode_set_cb)(
    int _unit, int policer_idx_0, int policer_group_idx_0, bcm_policer_group_mode_t mode);
