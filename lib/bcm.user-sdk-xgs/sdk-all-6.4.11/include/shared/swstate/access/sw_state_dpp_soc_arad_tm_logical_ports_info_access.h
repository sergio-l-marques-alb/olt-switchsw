...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_set_cb)(
    int _unit, int logical_ports_info_idx_0, CONST soc_logical_port_sw_db_t *logical_ports_info);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_get_cb)(
    int _unit, int logical_ports_info_idx_0, soc_logical_port_sw_db_t *logical_ports_info);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_verify_cb)(
    int _unit, int logical_ports_info_idx_0);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_valid_set_cb)(
    int _unit, int logical_ports_info_idx_0, int valid);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_first_phy_port_set_cb)(
    int _unit, int logical_ports_info_idx_0, int first_phy_port);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_channel_set_cb)(
    int _unit, int logical_ports_info_idx_0, int channel);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_protocol_offset_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 protocol_offset);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_flags_set_cb)(
    int _unit, int logical_ports_info_idx_0, int flags);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_core_set_cb)(
    int _unit, int logical_ports_info_idx_0, int core);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_encap_mode_set_cb)(
    int _unit, int logical_ports_info_idx_0, soc_encap_mode_t encap_mode);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_tm_port_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 tm_port);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_pp_port_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 pp_port);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_priority_mode_set_cb)(
    int _unit, int logical_ports_info_idx_0, int priority_mode);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_base_q_pair_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 base_q_pair);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_multicast_offset_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 multicast_offset);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_egr_interface_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 egr_interface);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_outlif_ext_en_set_cb)(
    int _unit, int logical_ports_info_idx_0, SOC_TMC_PORTS_FTMH_EXT_OUTLIF outlif_ext_en);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_src_ext_en_set_cb)(
    int _unit, int logical_ports_info_idx_0, int src_ext_en);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_dst_ext_en_set_cb)(
    int _unit, int logical_ports_info_idx_0, int dst_ext_en);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_first_header_size_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 first_header_size);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_header_type_out_set_cb)(
    int _unit, int logical_ports_info_idx_0, SOC_TMC_PORT_HEADER_TYPE header_type_out);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_header_type_in_set_cb)(
    int _unit, int logical_ports_info_idx_0, SOC_TMC_PORT_HEADER_TYPE header_type_in);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_pp_flags_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 pp_flags);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_fc_type_set_cb)(
    int _unit, int logical_ports_info_idx_0, SOC_TMC_PORTS_FC_TYPE fc_type);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_mirror_profile_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 mirror_profile);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_src_syst_port_ext_present_set_cb)(
    int _unit, int logical_ports_info_idx_0, int is_tm_src_syst_port_ext_present);
...
/* implemented by: sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_set */
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_set_cb)(
    int _unit, int logical_ports_info_idx_0, int is_tm_pph_present_enabled);

/* implemented by: sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_get */
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_get_cb)(
    int _unit, int logical_ports_info_idx_0, int *is_tm_pph_present_enabled);

/* implemented by: sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_verify */
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_verify_cb)(
    int _unit, int logical_ports_info_idx_0);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_stag_enabled_set_cb)(
    int _unit, int logical_ports_info_idx_0, int is_stag_enabled);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_snoop_enabled_set_cb)(
    int _unit, int logical_ports_info_idx_0, int is_snoop_enabled);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_ing_shaping_enabled_set_cb)(
    int _unit, int logical_ports_info_idx_0, int is_tm_ing_shaping_enabled);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_shaper_mode_set_cb)(
    int _unit, int logical_ports_info_idx_0, SOC_TMC_EGR_PORT_SHAPER_MODE shaper_mode);
...
typedef int (*sw_state_dpp_soc_arad_tm_logical_ports_info_peer_tm_domain_set_cb)(
    int _unit, int logical_ports_info_idx_0, uint32 peer_tm_domain);
...
typedef struct sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_cbs_s {
    sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_set_cb set;
    sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_get_cb get;
    sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_verify_cb verify;
} sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_cbs_t;
...
typedef struct sw_state_dpp_soc_arad_tm_logical_ports_info_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_logical_ports_info_is_tm_pph_present_enabled_cbs_t is_tm_pph_present_enabled;
...
int sw_state_dpp_soc_arad_tm_logical_ports_info_access_cb_init(int _unit);
