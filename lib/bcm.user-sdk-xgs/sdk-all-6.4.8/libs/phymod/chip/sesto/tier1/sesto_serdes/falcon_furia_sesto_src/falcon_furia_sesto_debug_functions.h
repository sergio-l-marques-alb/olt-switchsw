...
#include "falcon_furia_sesto_common.h"
#include "falcon_sesto_api_uc_common.h"

/** Lane User Control Function Structure in Microcode */
struct falcon_furia_sesto_usr_ctrl_func_st {
...
struct falcon_furia_sesto_usr_ctrl_dfe_func_st {
...
struct falcon_furia_sesto_usr_ctrl_disable_functions_st {
  struct falcon_furia_sesto_usr_ctrl_func_st field;
  uint16_t word;
};

/** Lane User Control Disable DFE Function Struct */
struct falcon_furia_sesto_usr_ctrl_disable_dfe_functions_st {
  struct falcon_furia_sesto_usr_ctrl_dfe_func_st field;
  uint8_t  byte;                        
};

/** Falcon Lane status Struct */
struct falcon_furia_sesto_detailed_lane_status_st {
 ...
 */ 
uint8_t falcon_furia_sesto_rdbl_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */ 
uint16_t falcon_furia_sesto_rdwl_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */ 
int8_t falcon_furia_sesto_rdbls_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */ 
int16_t falcon_furia_sesto_rdwls_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */ 
uint8_t falcon_furia_sesto_rdbc_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */ 
uint16_t falcon_furia_sesto_rdwc_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */ 
int8_t falcon_furia_sesto_rdbcs_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */ 
int16_t falcon_furia_sesto_rdwcs_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
...
/** Reads current pmd lane status and populates the provided structure of type #falcon_furia_sesto_detailed_lane_status_st.
...
/** Displays the lane status stored in the input struct of type #falcon_furia_sesto_detailed_lane_status_st.
