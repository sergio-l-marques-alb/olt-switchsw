/*
 * $Id: sbZfCaPpAggregateHashFormat.c,v 1.2 Broadcom SDK $
...
sbZfCaPpAggregateHashFormat_Unpack(sbZfCaPpAggregateHashFormat_t *pToStruct,
  ...
  (pToStruct)->m_uAggregateHash_31_28 =  (uint32)  ((pFromData)[3] >> 4) & 0x0f;

  /* Unpack Member: m_uAggregateHash_27_16 */
  (pToStruct)->m_uAggregateHash_27_16 =  (uint32)  (pFromData)[2] ;
  (pToStruct)->m_uAggregateHash_27_16 |=  (uint32)  ((pFromData)[3] & 0x0f) << 8;

  /* Unpack Member: m_uAggregateHash_15_0 */
  (pToStruct)->m_uAggregateHash_15_0 =  (uint32)  (pFromData)[0] ;
  (pToStruct)->m_uAggregateHash_15_0 |=  (uint32)  (pFromData)[1] << 8;
