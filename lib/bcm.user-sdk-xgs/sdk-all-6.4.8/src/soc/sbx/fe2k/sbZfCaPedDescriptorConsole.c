/*
 * $Id: sbZfCaPedDescriptorConsole.c,v 1.3 Broadcom SDK $
...
#include "sbZfCaPedDescriptorConsole.hx"



/* Print members in struct */
void
sbZfCaPedDescriptor_Print(sbZfCaPedDescriptor_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: cntbyte=0x%02x"), (unsigned int)  pFromStruct->m_uContinueByte));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: buffer=0x%04x"), (unsigned int)  pFromStruct->m_uBuffer));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: mridx=0x%01x"), (unsigned int)  pFromStruct->m_uMirrorIndex));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: dque=0x%02x"), (unsigned int)  pFromStruct->m_uDestinationQueue));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: srcfrmlen=0x%04x"), (unsigned int)  pFromStruct->m_uSourceFrameLength));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata3=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata7=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata11=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata15=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte15));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata19=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte19));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata23=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte23));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata27=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte27));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata31=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte31));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata35=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte35));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata39=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte39));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata43=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte43));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata47=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte47));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata51=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte51));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata55=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte55));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata59=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte59));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata63=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte63));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata67=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte67));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata71=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte71));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata75=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte75));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata79=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte79));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata83=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte83));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata87=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte87));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata91=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte91));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata95=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte95));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata99=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte99));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata103=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte103));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata107=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte107));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata111=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte111));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata115=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte115));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata119=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte119));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata123=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte123));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata127=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte127));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata131=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte131));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata135=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte135));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata139=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte139));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata143=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte143));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata147=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte147));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata151=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte151));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPedDescriptor:: pdata155=0x%02x"), (unsigned int)  pFromStruct->m_uPacketDataByte155));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfCaPedDescriptor_SPrint(sbZfCaPedDescriptor_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: cntbyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: buffer=0x%04x", (unsigned int)  pFromStruct->m_uBuffer);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: mridx=0x%01x", (unsigned int)  pFromStruct->m_uMirrorIndex);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: dque=0x%02x", (unsigned int)  pFromStruct->m_uDestinationQueue);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: srcfrmlen=0x%04x", (unsigned int)  pFromStruct->m_uSourceFrameLength);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata3=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte3);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata7=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte7);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata11=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte11);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata15=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte15);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata19=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte19);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata23=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte23);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata27=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte27);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata31=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte31);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata35=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte35);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata39=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte39);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata43=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte43);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata47=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte47);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata51=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte51);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata55=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte55);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata59=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte59);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata63=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte63);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata67=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte67);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata71=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte71);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata75=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte75);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata79=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte79);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata83=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte83);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata87=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte87);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata91=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte91);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata95=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte95);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata99=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte99);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata103=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte103);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata107=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte107);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata111=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte111);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata115=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte115);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata119=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte119);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata123=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte123);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata127=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte127);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata131=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte131);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata135=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte135);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata139=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte139);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata143=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte143);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata147=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte147);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata151=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte151);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPedDescriptor:: pdata155=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte155);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");
...
int
sbZfCaPedDescriptor_Validate(sbZfCaPedDescriptor_t *pZf) {
...
int
sbZfCaPedDescriptor_SetField(sbZfCaPedDescriptor_t *s, char* name, int value) {
