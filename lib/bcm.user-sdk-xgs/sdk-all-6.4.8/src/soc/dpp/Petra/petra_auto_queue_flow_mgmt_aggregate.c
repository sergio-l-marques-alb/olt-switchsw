  ...
  )
{
  ...
  for(agg_level_i = 0; agg_level_i < SOC_PETRA_AQFM_NOF_HIERARCY; ++agg_level_i)
  {
    for(agg_index_i = 0; agg_index_i < SOC_PETRA_AQFM_NOF_INDEX; ++agg_index_i)
    {
      ...
      soc_petra_PETRA_SCH_FLOW_clear(unit, p_flow);
  ...
  )
{
  ...
  soc_petra_PETRA_AQFM_AGG_INFO_clear(unit, &auto_agg_info);
  ...
  )
{
  ...
  SOC_PETRA_ALLOC_AND_CLEAR_STRUCT_UNIT(unit, agg_info, PETRA_AQFM_AGG_INFO);
  SOC_PETRA_ALLOC_AND_CLEAR_STRUCT_UNIT(unit, exact_agg_info, PETRA_AQFM_AGG_INFO);
  ...
  )
{
  ...
  soc_petra_PETRA_SCH_FLOW_clear(unit, &exact_flow);
  ...
  )
{
  ...
  soc_petra_PETRA_SCH_GLOBAL_PER1K_INFO_clear(&global_per1k_info);
  soc_petra_PETRA_AQFM_AGG_ITEM_INFO_clear(unit, &agg_item_info_to_set);
  ...
  )
{
  ...
  soc_petra_PETRA_AQFM_AGG_ITEM_INFO_clear(unit,&agg_item);
