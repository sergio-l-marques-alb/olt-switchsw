  ...
  )
{
	...
	case ARAD_PP_SW_DB_MULTI_SET_ETH_POLICER_ETH_METER_PROFILE:
      rv = sw_state_access[unit].dpp.soc.arad.pp.eth_policer_mtr_profile.eth_meter_profile_multi_set.get(unit, 0, multi_set_info);
      break;
    case ARAD_PP_SW_DB_MULTI_SET_ETH_POLICER_GLOBAL_METER_PROFILE:
      rv = sw_state_access[unit].dpp.soc.arad.pp.eth_policer_mtr_profile.global_meter_profile_multi_set.get(unit, 0, multi_set_info);
      break;

   case ARAD_PP_SW_DB_MULTI_SET_ETH_POLICER_ETH_METER_PROFILE_1:
      rv = sw_state_access[unit].dpp.soc.arad.pp.eth_policer_mtr_profile.eth_meter_profile_multi_set.get(unit, 1, multi_set_info);
      break;
    case ARAD_PP_SW_DB_MULTI_SET_ETH_POLICER_GLOBAL_METER_PROFILE_1:
      rv = sw_state_access[unit].dpp.soc.arad.pp.eth_policer_mtr_profile.global_meter_profile_multi_set.get(unit, 1, multi_set_info);
      break;
