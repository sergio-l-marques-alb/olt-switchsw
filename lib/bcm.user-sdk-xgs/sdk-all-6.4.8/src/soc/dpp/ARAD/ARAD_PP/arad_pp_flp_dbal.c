   ...
   )
{
  ...
  /*  qual_info[0].qual_type = SOC_PPC_FP_QUAL_HDR_IPV4_DEST_PORT;
    ...
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_program_to_tables_associate(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV4UC, ARAD_FP_DATABASE_STAGE_INGRESS_FLP, &keys_to_table_id, NULL, 1));  
    ...
    arad_pp_flp_dbal_ipv4uc_kaps_table_create(int unit)
{
    ...
    if (!is_table_initiated) {
        ...
        qual_info[0].qual_type = SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES;
        qual_info[0].qual_nof_bits = 34 - table_prefix_len; /* Align to 80bits according to the dynamic prefix len*/
        ...
        SOCDNX_IF_ERR_EXIT(arad_pp_dbal_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_KAPS, table_prefix, table_prefix_len,
                                                     SOC_DPP_DBAL_PHYSICAL_DB_TYPE_KAPS, 3, 0, qual_info, "FLP IPv4 UC KAPS"));
    ...
    arad_pp_flp_dbal_ipv4uc_rpf_kaps_table_create(int unit)
{
    ...
    if (!is_table_initiated) {
        ...
        SOCDNX_IF_ERR_EXIT(arad_pp_dbal_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_RPF_KAPS, table_prefix, table_prefix_len,
                                                     SOC_DPP_DBAL_PHYSICAL_DB_TYPE_KAPS, 3, 0, qual_info, "FLP IPv4 UC RPF KAPS"));
    }
    ...
    arad_pp_flp_dbal_ipv6uc_kaps_table_create(int unit)
{
    ...
    if (!is_table_initiated) {
        SOCDNX_IF_ERR_EXIT(arad_pp_flp_dbal_kaps_table_prefix_get(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_KAPS, &table_prefix, &table_prefix_len));
         DBAL_QUAL_INFO_CLEAR(&qual_info, SOC_PPC_FP_NOF_QUALS_PER_DB_MAX);
        /* LSB */
        qual_info[0].qual_type = SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES;
        qual_info[0].qual_nof_bits = 16;
        ...
        SOCDNX_IF_ERR_EXIT(arad_pp_dbal_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_KAPS, table_prefix, table_prefix_len,
    ...
    arad_pp_flp_dbal_ipv6mc_kaps_table_create(int unit)
{
    ...
    if (!is_table_initiated) {
        SOCDNX_IF_ERR_EXIT(arad_pp_flp_dbal_kaps_table_prefix_get(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV6MC_KAPS, &table_prefix, &table_prefix_len));
        DBAL_QUAL_INFO_CLEAR(&qual_info, SOC_PPC_FP_NOF_QUALS_PER_DB_MAX);
        /* LSB */
        qual_info[0].qual_type = SOC_PPC_FP_QUAL_IRPP_ALL_ZEROES;
        ...
        SOCDNX_IF_ERR_EXIT(arad_pp_dbal_table_create(unit, SOC_DPP_DBAL_SW_TABLE_ID_IPV6MC_KAPS, table_prefix, table_prefix_len,
    ...
    arad_pp_flp_dbal_ipv6uc_kbp_table_init(int unit)
{
    ...
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 0, 4));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_LOW;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 0, 5));
    ...
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+0));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_HIGH;
    qual_info.qual_offset = 0;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+4));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_HIGH;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+5));
    ...
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 0, 6));
    
    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_DIP_LOW;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 0, 7));    
    ...
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 1, msb_ce_offset+6));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_DIP_HIGH;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, stage, SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 1, msb_ce_offset+7));

    /* Lookup configurations */
    SOCDNX_SAND_IF_ERR_EXIT(arad_pp_ihb_flp_lookups_tbl_get_unsafe(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, &flp_lookups_tbl));
    flp_lookups_tbl.elk_lkp_valid = 0x1;
    flp_lookups_tbl.elk_wait_for_reply = 0x1;
    flp_lookups_tbl.elk_opcode = ARAD_PP_FLP_KEY_PROGRAM_IPV6UC; /*ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_UC;*/
    ...
    SOCDNX_SAND_IF_ERR_EXIT(arad_pp_ihb_flp_lookups_tbl_set_unsafe(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6UC, &flp_lookups_tbl));
    ...
    arad_pp_flp_dbal_ipv6mc_kbp_table_init(int unit)
{
    ...
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 0, 0));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_LOW;
    qual_info.qual_offset = 0;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 0, 4));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_LOW;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage, SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 0, 5));
    ...
    qual_info.qual_nof_bits = 16;
    qual_info.qual_offset = 0;
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+1));
    
    qual_info.qual_type = SOC_PPC_FP_QUAL_IRPP_VRF;
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_qualifier_full_size_get(unit, stage,qual_info.qual_type, &(qual_info.qual_full_size), &(qual_info.qual_is_in_hdr)));
    qual_info.qual_nof_bits = 16;
    qual_info.qual_offset = 0;
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+0));    

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_HIGH;
    qual_info.qual_offset = 0;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+4));    

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_SIP_HIGH;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 16; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_A, qual_info, 1, msb_ce_offset+5));    
    ...
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;              
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 0, 6));

    qual_info.qual_type = SOC_PPC_FP_QUAL_HDR_FWD_IPV6_DIP_LOW;
    qual_info.qual_offset = 32;
    qual_info.qual_nof_bits = 32; 
    qual_info.qual_full_size = 32;
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage,SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 0, 7));
    ...
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage, SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 1, msb_ce_offset+6));
    ...
    SOCDNX_IF_ERR_EXIT(arad_pp_dbal_key_inst_set(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, stage, SOC_DPP_DBAL_PROGRAM_KEY_B, qual_info, 1, msb_ce_offset+7));
    
    /* Lookup configurations */
    SOCDNX_SAND_IF_ERR_EXIT(arad_pp_ihb_flp_lookups_tbl_get_unsafe(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, &flp_lookups_tbl));
    flp_lookups_tbl.elk_lkp_valid = 0x1;
    flp_lookups_tbl.elk_wait_for_reply = 0x1;
    flp_lookups_tbl.elk_opcode = ARAD_PP_FLP_KEY_PROGRAM_IPV6MC; /*ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_MC_RPF;*/
    flp_lookups_tbl.elk_key_a_valid_bytes = 10; 
    flp_lookups_tbl.elk_key_a_msb_valid_bytes = 10; 
    flp_lookups_tbl.elk_key_b_valid_bytes = 8;  
    flp_lookups_tbl.elk_key_b_msb_valid_bytes = 7; 
    SOCDNX_SAND_IF_ERR_EXIT(arad_pp_ihb_flp_lookups_tbl_set_unsafe(unit, ARAD_PP_FLP_KEY_PROGRAM_IPV6MC, &flp_lookups_tbl));
    ...
    arad_pp_flp_dbal_ipv6uc_rpf_kbp_table_init(int unit, int prog_id)
{
    ...
    flp_lookups_tbl.elk_lkp_valid = 0x1;
    flp_lookups_tbl.elk_wait_for_reply = 0x1;
    flp_lookups_tbl.elk_opcode = ARAD_PP_FLP_KEY_PROGRAM_IPV6UC_WITH_RPF; /*ARAD_KBP_FRWRD_TABLE_OPCODE_IPV6_UC_RPF*/
    flp_lookups_tbl.elk_key_a_valid_bytes = 10; 
