...
#define SOC_PCP_BIT_TO_U32(nof_bits) (((nof_bits)+31)/32)
...
#ifdef USING_CHIP_SIM
  uint32
    key[SOC_PCP_BIT_TO_U32(CHIP_SIM_LEM_KEY_SIZE_MAX)],
    data[SOC_PCP_BIT_TO_U32(CHIP_SIM_LEM_DATA_SIZE_MAX)];
  uint8
    success;
#endif
...
#ifdef USING_CHIP_SIM
  uint32
    key_in[SOC_PCP_BIT_TO_U32(CHIP_SIM_LEM_KEY_SIZE_MAX)],
    data_out[SOC_PCP_BIT_TO_U32(CHIP_SIM_LEM_DATA_SIZE_MAX)];
  uint8
    success;
#endif
...
#ifdef USING_CHIP_SIM
  uint32
    key_out[SOC_PCP_BIT_TO_U32(CHIP_SIM_LEM_KEY_SIZE_MAX)],
    data_out[SOC_PCP_BIT_TO_U32(CHIP_SIM_LEM_DATA_SIZE_MAX)];
#else
  uint32
    fld_val2;
