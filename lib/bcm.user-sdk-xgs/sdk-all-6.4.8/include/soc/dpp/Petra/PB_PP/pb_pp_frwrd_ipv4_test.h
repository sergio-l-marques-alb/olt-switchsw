/* $Id: soc_pb_pp_frwrd_ipv4_test.h,v 1.5 Broadcom SDK $
...
#ifndef __SOC_PB_PP_FRWRD_IPV4_TEST_INCLUDED__
/* { */
#define __SOC_PB_PP_FRWRD_IPV4_TEST_INCLUDED__
...
typedef struct
{
   ...
   *  lookup key
   */
  SOC_PB_PP_DIAG_IPV4_VPN_KEY key;
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_frwrd_ipv4_test_clear_vrf
 * TYPE:
 *   PROC
 * FUNCTION:
 *   Clear all databases
 ...
 *   SOC_SAND_IN  SOC_PB_PP_FRWRD_IPV4_CLEAR_INFO *clear_info -
 *     Clear information
 * REMARKS:
 *   None
 * RETURNS:
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_frwrd_ipv4_test_print_mem
 * TYPE:
 *   PROC
 * FUNCTION:
 *   Print memory status
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_frwrd_ipv4_test_lookup
 * TYPE:
 *   PROC
 * FUNCTION:
...
/* } __SOC_PB_PP_FRWRD_IPV4_TEST_INCLUDED__*/
#endif
