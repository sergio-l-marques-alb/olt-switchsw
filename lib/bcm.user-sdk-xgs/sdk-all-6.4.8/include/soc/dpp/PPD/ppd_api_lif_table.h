...
#define SOC_PPD_LIF_ENTRY_TYPE_EMPTY                           SOC_PPC_LIF_ENTRY_TYPE_EMPTY
#define SOC_PPD_LIF_ENTRY_TYPE_AC                              SOC_PPC_LIF_ENTRY_TYPE_AC
#define SOC_PPD_LIF_ENTRY_TYPE_FIRST_AC_IN_GROUP               SOC_PPC_LIF_ENTRY_TYPE_FIRST_AC_IN_GROUP
#define SOC_PPD_LIF_ENTRY_TYPE_MIDDLE_AC_IN_GROUP              SOC_PPC_LIF_ENTRY_TYPE_MIDDLE_AC_IN_GROUP
#define SOC_PPD_LIF_ENTRY_TYPE_PWE                             SOC_PPC_LIF_ENTRY_TYPE_PWE
#define SOC_PPD_LIF_ENTRY_TYPE_ISID                            SOC_PPC_LIF_ENTRY_TYPE_ISID
#define SOC_PPD_LIF_ENTRY_TYPE_IP_TUNNEL_RIF                   SOC_PPC_LIF_ENTRY_TYPE_IP_TUNNEL_RIF
#define SOC_PPD_LIF_ENTRY_TYPE_MPLS_TUNNEL_RIF                 SOC_PPC_LIF_ENTRY_TYPE_MPLS_TUNNEL_RIF
#define SOC_PPD_LIF_ENTRY_TYPE_TRILL_NICK                      SOC_PPC_LIF_ENTRY_TYPE_TRILL_NICK
#define SOC_PPD_LIF_ENTRY_TYPE_EXTENDER                        SOC_PPC_LIF_ENTRY_TYPE_EXTENDER
#define SOC_PPD_LIF_ENTRY_TYPE_ALL                             SOC_PPC_LIF_ENTRY_TYPE_ALL
typedef SOC_PPC_LIF_ENTRY_TYPE                                 SOC_PPD_LIF_ENTRY_TYPE;

typedef SOC_PPC_LIF_ENTRY_PER_TYPE_INFO                        SOC_PPD_LIF_ENTRY_PER_TYPE_INFO;
typedef SOC_PPC_LIF_ENTRY_INFO                                 SOC_PPD_LIF_ENTRY_INFO;
typedef SOC_PPC_LIF_TBL_TRAVERSE_MATCH_RULE                    SOC_PPD_LIF_TBL_TRAVERSE_MATCH_RULE;

typedef SOC_PPC_LIF_TABLE_ENTRY_ACCESSED_INFO                  SOC_PPD_LIF_TABLE_ENTRY_ACCESSED_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_lif_table_get_procs_ptr(void);
