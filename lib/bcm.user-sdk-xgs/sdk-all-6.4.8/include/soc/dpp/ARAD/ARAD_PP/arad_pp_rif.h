...
typedef enum
{
   ...
   */
  ARAD_PP_RIF_MPLS_LABELS_RANGE_SET = ARAD_PP_PROC_DESC_BASE_RIF_FIRST,
  ARAD_PP_RIF_MPLS_LABELS_RANGE_SET_PRINT,
  ARAD_PP_RIF_MPLS_LABELS_RANGE_SET_UNSAFE,
  ARAD_PP_RIF_MPLS_LABELS_RANGE_SET_VERIFY,
  ARAD_PP_RIF_MPLS_LABELS_RANGE_GET,
  ARAD_PP_RIF_MPLS_LABELS_RANGE_GET_PRINT,
