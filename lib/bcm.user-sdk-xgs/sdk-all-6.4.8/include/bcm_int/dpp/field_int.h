...
#define _BCM_DPP_FIELD_DEV_INFO(unit)   \
    (SOC_IS_ARAD(unit) ? _bcm_arad_field_device_info :  _bcm_arad_field_device_info)
...
/* those defines are used for direct maping to the table id in the external TCAM. 
