/*
 * $Id: oam_sw_db.h,v 1.23 Broadcom SDK $
...
int _bcm_dpp_oam_bfd_mep_info_db_insert_no_lock(int unit, uint32 mep_index, SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY * mep_info);
...
int _bcm_dpp_oam_bfd_mep_info_db_update(int unit, uint32 mep_index, SOC_PPD_OAM_CLASSIFIER_MEP_ENTRY * mep_info);
...
int _bcm_dpp_oam_bfd_rmep_info_db_insert_no_lock(int unit, uint32 rmep_index, SOC_PPD_OAM_RMEP_INFO_DATA * rmep_info);
...
int _bcm_dpp_oam_bfd_rmep_to_mep_db_update(int unit, uint32 rmep_index, SOC_PPD_OAM_RMEP_INFO_DATA * rmep_info );

int _bcm_dpp_oam_sat_gtf_info_db_insert(int unit, uint32 gtf_id, SOC_PPD_OAM_SAT_GTF_ENTRY * gtf_info); 
int _bcm_dpp_oam_sat_gtf_info_db_get(int unit, uint32 gtf_id, SOC_PPD_OAM_SAT_GTF_ENTRY * gtf_info, uint8 *found);
int _bcm_dpp_oam_sat_gtf_info_db_delete(int unit, uint32 gtf_id); 
int _bcm_dpp_oam_sat_gtf_info_db_update(int unit, uint32 gtf_id, SOC_PPD_OAM_SAT_GTF_ENTRY * gtf_info); 
int _bcm_dpp_oam_sat_ctf_info_db_insert(int unit, uint32 ctf_id, SOC_PPD_OAM_SAT_CTF_ENTRY * ctf_info);
int _bcm_dpp_oam_sat_ctf_info_db_get(int unit, uint32 ctf_id, SOC_PPD_OAM_SAT_CTF_ENTRY * ctf_info, uint8 *found);
int _bcm_dpp_oam_sat_ctf_info_db_delete(int unit, uint32 ctf_id); 
int _bcm_dpp_oam_sat_ctf_info_db_update(int unit, uint32 ctf_id, SOC_PPD_OAM_SAT_CTF_ENTRY * ctf_info);
