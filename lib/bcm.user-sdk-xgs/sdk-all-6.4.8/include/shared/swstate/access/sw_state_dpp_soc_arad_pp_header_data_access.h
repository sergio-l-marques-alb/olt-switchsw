...
/* implemented by: sw_state_dpp_soc_arad_pp_header_data_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_header_data_get_size_cb)(
...
/* implemented by: sw_state_dpp_soc_arad_pp_header_data_system_headers_mode_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_header_data_system_headers_mode_get_size_cb)(
    int _unit,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_header_data_ftmh_stacking_ext_enable_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_header_data_ftmh_stacking_ext_enable_get_size_cb)(
    int _unit,int *ret_size);
...
/* implemented by: sw_state_dpp_soc_arad_pp_header_data_ftmh_lb_key_ext_en_get_size */
typedef int (*sw_state_dpp_soc_arad_pp_header_data_ftmh_lb_key_ext_en_get_size_cb)(
    int _unit,int *ret_size);
...
typedef struct sw_state_dpp_soc_arad_pp_header_data_system_headers_mode_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_header_data_system_headers_mode_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_header_data_ftmh_stacking_ext_enable_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_header_data_ftmh_stacking_ext_enable_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_header_data_ftmh_lb_key_ext_en_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_header_data_ftmh_lb_key_ext_en_get_size_cb get_size;
...
typedef struct sw_state_dpp_soc_arad_pp_header_data_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_header_data_get_size_cb get_size;
...
int sw_state_dpp_soc_arad_pp_header_data_access_cb_init(int _unit);
