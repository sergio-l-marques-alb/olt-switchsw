...
/* implemented by: sw_state_dpp_bcm_policer_get_size */
typedef int (*sw_state_dpp_bcm_policer_get_size_cb)(
...
typedef int (*sw_state_dpp_bcm_policer_policer_group_verify_cb)(
    int _unit, int policer_group_idx);

/* implemented by: sw_state_dpp_bcm_policer_policer_group_get_size */
typedef int (*sw_state_dpp_bcm_policer_policer_group_get_size_cb)(
    int _unit, int policer_group_idx,int *ret_size);
...
/* implemented by: sw_state_dpp_bcm_policer_policer_group_mode_get_size */
typedef int (*sw_state_dpp_bcm_policer_policer_group_mode_get_size_cb)(
    int _unit, int policer_group_idx,int *ret_size);
...
typedef struct sw_state_dpp_bcm_policer_policer_group_mode_cbs_s {
    ...
    sw_state_dpp_bcm_policer_policer_group_mode_get_size_cb get_size;
...
typedef struct sw_state_dpp_bcm_policer_policer_group_cbs_s {
    ...
    sw_state_dpp_bcm_policer_policer_group_get_size_cb get_size;
...
typedef struct sw_state_dpp_bcm_policer_cbs_s {
    ...
    sw_state_dpp_bcm_policer_get_size_cb get_size;
    sw_state_dpp_bcm_policer_policer_group_cbs_t policer_group;
} sw_state_dpp_bcm_policer_cbs_t;


int sw_state_dpp_bcm_policer_access_cb_init(int _unit);
