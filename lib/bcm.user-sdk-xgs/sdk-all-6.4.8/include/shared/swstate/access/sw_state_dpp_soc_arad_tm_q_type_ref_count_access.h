...
typedef int (*sw_state_dpp_soc_arad_tm_q_type_ref_count_set_cb)(
    int _unit, int q_type_ref_count_ptr_arr_idx, uint32 q_type_ref_count);
...
typedef int (*sw_state_dpp_soc_arad_tm_q_type_ref_count_verify_cb)(
    int _unit, int q_type_ref_count_ptr_arr_idx);

/* implemented by: sw_state_dpp_soc_arad_tm_q_type_ref_count_get_size */
typedef int (*sw_state_dpp_soc_arad_tm_q_type_ref_count_get_size_cb)(
    int _unit, int q_type_ref_count_ptr_arr_idx,int *ret_size);
