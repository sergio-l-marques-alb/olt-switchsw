...
adv_xlate_action_create(2 /*ActionId*/, 1 /*ut_outer=ADD*/, 0 /*ut_inner=NONE*/, 2 /*ot_outer=REPLACE*/, 0 /*ot_inner=NONE*/, 2 /*dt_outer=REPLACE*/, 0 /*dt_inner=NONE*/,
                        ...
                        0 /*NewOVID*/, 0 /*NewIVID*/,
                        0 /*Egress*/);
/* Swap outer VLAN and remove inner VLAN */
adv_xlate_action_create(3 /*ActionId*/, 1 /*ut_outer=ADD*/, 1 /*ut_inner=ADD*/, 2 /*ot_outer=REPLACE*/, 1 /*ot_inner=ADD*/, 2 /*dt_outer=REPLACE*/, 3 /*dt_inner=REMOVE*/,
                        tpid1 /*OuterTPID*/, tpid2 /*InnerTPID*/,
                        0 /*NewOVID*/, 0 /*NewIVID*/,
                        0 /*Egress*/);
/* Swap outer VLAN and add inner VLAN */
adv_xlate_action_create(4 /*ActionId*/, 1 /*ut_outer=ADD*/, 1 /*ut_inner=ADD*/, 2 /*ot_outer=REPLACE*/, 1 /*ot_inner=ADD*/, 2 /*dt_outer=REPLACE*/, 1 /*dt_inner=ADD*/,
                        tpid1 /*OuterTPID*/, tpid2 /*InnerTPID*/,
                        0 /*NewOVID*/, 0 /*NewIVID*/,
                        0 /*Egress*/);
...
/* VEP3 -> ST: Swap OVLAN; DT: Swap OVLAN and pop IVLAN */
adv_xlate_action_class_set(2 /*Single Tag Format*/, 3 /*VEP*/, 2 /*ActionId*/, 0 /*Egress*/);
adv_xlate_action_class_set(6 /*Double Tag Format*/, 3 /*VEP*/, 3 /*ActionId*/, 0 /*Egress*/);
/* VEP4 -> ST+DT: Swap OVLAN and push IVLAN */
adv_xlate_action_class_set(2 /*Single Tag Format*/, 4 /*VEP*/, 4 /*ActionId*/, 0 /*Egress*/);
adv_xlate_action_class_set(6 /*Double Tag Format*/, 4 /*VEP*/, 4 /*ActionId*/, 0 /*Egress*/);

/* VLAN Edit Profile (ID=2) for LIF1 */
adv_xlate_vep(lif1, outer_vlan1, inner_vlan, 3 /*VEP Id*/, 0 /*Egress*/);
/* VLAN Edit Profile (ID=2) for LIF2 */
adv_xlate_vep(lif2, outer_vlan2, inner_vlan, 4 /*VEP Id*/, 0 /*Egress*/);
