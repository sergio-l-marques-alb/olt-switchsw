...
void rx_los_main_thread(uint32 allowed_retries, uint32 short_sleep_usec, uint32 long_sleep_usec){    
...
void rx_los_main_thread_call(void *args){
    ...
    rx_los_main_thread(allowed_retries, short_sleep_usec, long_sleep_usec);
