...
bcm_dpp_am_calculate_nof_resource_pools(int unit, int *nof_resource_pools, int *nof_cosq_pools, int *nof_lif_pools){
    ...
    *nof_resource_pools = 0;
    ...
    /* Fill cosq resources */
    rv = _bcm_dpp_resources_fill_pool_cosq(unit,dpp_res_cosq_pool);
    BCMDNX_IF_ERR_EXIT(rv);

    rv = _bcm_dpp_resources_fill_type_cosq(unit,dpp_res_cosq_type);
    BCMDNX_IF_ERR_EXIT(rv);
    ...
    am_config->nof_am_cosq_resource_ids = 
        dpp_res_cosq_type->dpp_res_type_cosq_queue_dynamic_end - dpp_res_cosq_type->dpp_res_type_cosq_connector_cont;
