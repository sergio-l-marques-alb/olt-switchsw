  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_vlan_edit_port_vlan_transmit_outer_tag_set,(unit, local_port_ndx, vid_ndx, transmit_outer_tag));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_vlan_edit_port_vlan_transmit_outer_tag_get,(unit, local_port_ndx, vid_ndx, transmit_outer_tag));
