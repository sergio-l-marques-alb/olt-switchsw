  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_filter_ingress_vlan_membership_set,(unit, vid_ndx, ports));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_filter_ingress_vlan_membership_get,(unit, vid_ndx, ports));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_filter_ingress_vlan_membership_port_add,(unit, vid_ndx, local_port));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_filter_ingress_vlan_membership_port_remove,(unit, vid_ndx, local_port));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_filter_designated_vlan_set,(unit, local_port_ndx, vid, accept, success));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(llp_filter_designated_vlan_get,(unit, local_port_ndx, vid, accept));
