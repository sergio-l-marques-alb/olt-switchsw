  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(vsi_egress_mtu_set,(unit, vsi_profile_ndx, mtu_val));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(vsi_egress_mtu_get,(unit, vsi_profile_ndx, mtu_val));
