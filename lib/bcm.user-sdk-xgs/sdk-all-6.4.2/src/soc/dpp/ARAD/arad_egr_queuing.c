  ...
  )
{
  ...
  /* Retreive base_q_pair */
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 2000, exit, soc_port_sw_db_tm_port_to_base_q_pair_get(unit, tm_port, core, &base_q_pair));
   ...
   * Set WFQ weights.
   */
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 2355, exit, soc_port_sw_db_tm_port_to_out_port_priority_get(unit, tm_port, core, &nof_q_pairs));
  ...
  )
{
  ...
  /* Retreive base_q_pair */
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 2300, exit, soc_port_sw_db_tm_port_to_base_q_pair_get(unit, tm_port, core, &base_q_pair));
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 2455, exit, soc_port_sw_db_tm_port_to_out_port_priority_get(unit, tm_port, core, &nof_q_pairs));
  ...
  )
{
    ...
    SOCDNX_IF_ERR_EXIT(arad_egq_ppct_tbl_get_unsafe(unit,  core, base_q_pair, &tbl_data));
