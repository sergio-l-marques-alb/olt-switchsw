  ...
  )
{
  ...
  /* TO be removed once the emulation is fixed */
  ...
  )
{
  ...
  res = arad_pp_egq_pp_ppct_tbl_get_unsafe(unit, out_port_ndx, &egq_pp_ppct_tbl);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  res = arad_pp_epni_pp_pct_tbl_get_unsafe(unit, out_port_ndx, 0, &epni_pp_pct_tbl);
  ...
  res = arad_pp_egq_pp_ppct_tbl_set_unsafe(unit, out_port_ndx, &egq_pp_ppct_tbl);
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);

  res = arad_pp_epni_pp_pct_tbl_set_unsafe(unit, out_port_ndx, 0, &epni_pp_pct_tbl);
  ...
  )
{
  ...
  res = arad_pp_egq_vsi_membership_tbl_get_unsafe(unit, vsid_ndx, &egq_vsi_membership_tbl);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = arad_pp_egq_vsi_membership_tbl_set_unsafe(unit, vsid_ndx, &egq_vsi_membership_tbl);
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
  ...
  )
{
  ...
  {      
    ...
    res = arad_pp_egq_pp_ppct_tbl_get_unsafe(unit, local_port, &egq_pp_ppct_tbl);
    SOC_SAND_CHECK_FUNC_RESULT(res, 60, exit);
  
    egq_pp_ppct_tbl.pvlan_port_type = tmp;
  
    res = arad_pp_egq_pp_ppct_tbl_set_unsafe(unit, local_port, &egq_pp_ppct_tbl);
