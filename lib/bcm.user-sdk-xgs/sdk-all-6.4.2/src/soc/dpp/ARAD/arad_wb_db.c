...
#define ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_TCG_RATE \
    ARAD_NOF_TCGS
#define ARAD_WB_DB_EGR_PORT_TCG_RATE_NUM         \
    (ARAD_EGR_NOF_PS * ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_TCG_RATE)
...
#define ARAD_WB_DB_EGR_PORT_NOF_CALCAL_INSTANCES_NUM         \
    (ARAD_OFP_RATES_EGQ_NOF_CHAN_ARB)
...
#define ARAD_WB_DB_EGR_PORT_UPDATE_DEV_CHANGED_NUM         \
    (1)
...
#define ARAD_WB_DB_TM_SYSPORT2BASEQUEUE_COUNT_NUM(unit) \
            (ARAD_NOF_SYS_PHYS_PORTS_GET(unit) * SOC_DPP_DEFS_GET(unit, nof_cores))

#define ARAD_WB_DB_MODPORT2SYSPORT_COUNT_NUM(unit) \
                (ARAD_NOF_MODPORT)

typedef struct arad_wb_db_egr_port_queue_rate_config_s {
    ARAD_SW_DB_DEV_RATE    queue_rate;
}  __ATTRIBUTE_PACKED__ arad_wb_db_egr_port_queue_rate_config_t;

typedef struct arad_wb_db_egr_port_tcg_rate_config_s {
    ARAD_SW_DB_DEV_RATE    tcg_rate;
}  __ATTRIBUTE_PACKED__ arad_wb_db_egr_port_tcg_rate_config_t;
...
typedef struct arad_wb_db_egr_port_update_dev_changed_config_s {
    uint8      update_dev_changed;
}  __ATTRIBUTE_PACKED__ arad_wb_db_egr_port_update_dev_changed_config_t;
...
#define ARAD_WB_DB_LAYOUT_INIT_VARIABLE(_module, _var, _var_num)    \
            ...
            ARAD_WB_DB_LAYOUT_INIT_VARIABLE(egr_port, 
                                            update_dev_changed, 
                                            ARAD_WB_DB_EGR_PORT_UPDATE_DEV_CHANGED_NUM);
...
_arad_wb_db_egr_port_restore_queue_rate_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_QUEUE_RATE_STATE,
                                 egr_port, 
                                 queue_rate,
                                 arad_sw_db_egr_ports.port_priority_cal.queue_rate[arr_indx]);
}

STATIC uint32
_arad_wb_db_egr_port_restore_tcg_rate_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_TCG_RATE_STATE,
                                     egr_port, 
                                     tcg_rate,
                                     arad_sw_db_egr_ports.tcg_cal.tcg_rate[arr_indx1][arr_indx2],
                                     ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_TCG_RATE);
}
...
{
    ARAD_WB_DB_RESTORE_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_NOF_CALCAL_INSTANCES_STATE,
                                 egr_port, 
                                 nof_calcal_instances,
                                 arad_sw_db_egr_ports.chan_arb[arr_indx].nof_calcal_instances);
}

STATIC uint32
_arad_wb_db_egr_port_restore_calcal_length_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_SINGLE_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_CALCAL_LENGTH_STATE,
                                    egr_port, 
                                    calcal_length,
...
STATIC uint32
_arad_wb_db_egr_port_restore_update_dev_changed_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_SINGLE_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_UPDATE_DEV_CHANGED_STATE,
                                    egr_port, 
                                    update_dev_changed,
...
_arad_wb_db_restore_state(SOC_SAND_IN int unit)
{
    ...
    res = _arad_wb_db_egr_port_restore_update_dev_changed_state(unit);
...
{    
    ARAD_WB_DB_SAVE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_SAVE_TCG_RATE_STATE,
                                  egr_port, 
                                  tcg_rate, 
                                  arad_sw_db_egr_ports.tcg_cal.tcg_rate[arr_indx1][arr_indx2],
                                  ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_TCG_RATE);
...
{
    ARAD_WB_DB_SAVE_ARR_STATE(ARAD_WB_DB_EGR_PORT_SAVE_NOF_CALCAL_INSTANCES_STATE,
                              egr_port, 
                              nof_calcal_instances, 
                              arad_sw_db_egr_ports.chan_arb[arr_indx].nof_calcal_instances);
}
...
{
    ARAD_WB_DB_SAVE_SINGLE_STATE(ARAD_WB_DB_EGR_PORT_SAVE_CALCAL_LENGTH_STATE,
                                 egr_port, 
                                 calcal_length, 
                                 arad_sw_db_egr_ports.calcal_length);
}
...
STATIC uint32
_arad_wb_db_egr_port_save_update_dev_changed_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_SAVE_SINGLE_STATE(ARAD_WB_DB_EGR_PORT_SAVE_UPDATE_DEV_CHANGED_STATE,
                                 egr_port, 
                                 update_dev_changed, 
                                 arad_sw_db_egr_ports.update_dev_changed);
}
...
arad_wb_db_sync(SOC_SAND_IN int unit)
{
    ...
    res = _arad_wb_db_egr_port_save_update_dev_changed_state(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res, 80, exit);
...
{
    ARAD_WB_DB_UPDATE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_TCG_RATE_STATE,
                                    egr_port, 
                                    tcg_rate,
                                    arad_sw_db_egr_ports.tcg_cal.tcg_rate[arr_indx1][arr_indx2],
                                    ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_TCG_RATE,
...
arad_wb_db_egr_port_update_nof_calcal_instances_state(SOC_SAND_IN int unit, 
                                                      SOC_SAND_IN uint32 arr_indx)
{
    ARAD_WB_DB_UPDATE_ARR_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_NOF_CALCAL_INSTANCES_STATE,
                                egr_port, 
                                nof_calcal_instances,
                                arad_sw_db_egr_ports.chan_arb[arr_indx].nof_calcal_instances,
                                arr_indx);
...
{
    ARAD_WB_DB_UPDATE_SINGLE_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_CALCAL_LENGTH_STATE,
                                   egr_port, 
                                   calcal_length,
                                   arad_sw_db_egr_ports.calcal_length);
}
...
uint32
arad_wb_db_egr_port_update_update_dev_changed_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_UPDATE_SINGLE_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_UPDATE_DEV_CHANGED_STATE,
                                   egr_port, 
                                   update_dev_changed,
                                   arad_sw_db_egr_ports.update_dev_changed);
}
