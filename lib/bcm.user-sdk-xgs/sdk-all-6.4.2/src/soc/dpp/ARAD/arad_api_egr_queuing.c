...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_egr_queuing_ofp_tcg_set()",ofp_ndx,0);
}
  ...
  )
{
  ...
  SOC_SAND_CHECK_NULL_INPUT(tcg_info);
   ...
   res = arad_egr_queuing_ofp_tcg_get_verify(
    unit,
    ofp_ndx,    
    tcg_info
  );
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_egr_queuing_ofp_tcg_get()",ofp_ndx,0);
}
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_egr_queuing_tcg_weight_set()",ofp_ndx,tcg_ndx);
}
...
exit_semaphore:
  SOC_SAND_GIVE_DEVICE_SEMAPHORE;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in arad_egr_queuing_tcg_weight_get()",ofp_ndx,tcg_ndx);
}
