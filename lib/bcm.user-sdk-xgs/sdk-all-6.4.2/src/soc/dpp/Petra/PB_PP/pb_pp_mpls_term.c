  ...
  )
{
  ...
  if (info->bos_action.frwrd_action_strength != 0 || info->bos_action.frwrd_action_strength!=0 ||
      info->non_bos_action.frwrd_action_strength != 0 || info->non_bos_action.frwrd_action_strength!=0
    )
  {
