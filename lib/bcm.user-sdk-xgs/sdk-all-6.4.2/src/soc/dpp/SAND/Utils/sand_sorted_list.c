    ...
    )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_DESTROY);
  SOC_SAND_CHECK_NULL_INPUT(sorted_list);
  ...
  )
{
  ...
  uint32
    res;
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_ENTRY_ADD);
  ...
  )
{
  ...
  uint32
    res;
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_ENTRY_ADD_BY_ITER);
  ...
  )
{
  ...
  uint32
    res;
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_ENTRY_UPDATE);
  ...
  )
{
  ...
  uint32
    res;
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_ENTRY_REMOVE_BY_ITER);
  ...
  )
{
  ...
  uint32
    res;
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_ENTRY_LOOKUP);
  ...
  )
{
  ...
  uint32
    res;
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_ENTRY_VALUE);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_GET_NEXT);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_GET_PREV);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(SOC_SAND_SORTED_LIST_GET_FOLLOW);
  ...
  )
{
  ...
  /* create DS*/
  res = soc_sand_sorted_list_create(sorted_list);
  SOC_SAND_CHECK_FUNC_RESULT(res,20, exit);
