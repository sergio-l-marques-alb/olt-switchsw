...
CONST mbcm_dpp_functions_t mbcm_jericho_driver = {
    ...
    NULL, /* arad_port_to_pp_port_map_set */ 
    ...
    arad_sch_device_rate_entry_set,
    arad_sch_device_rate_entry_get,
    ...
    NULL, /* arad_fabric_srd_qrtt_reset */ 
    ...
    NULL,/* soc_jer_fabric_rci_config_set*/
    NULL,/* soc_jer_fabric_rci_config_get*/
    ...
    NULL, /* arad_nif_loopback_set*/
    NULL, /* arad_nif_loopback_get*/
    ...
    NULL, /*arad_egr_dsp_pp_shaper_mode_set*/
    ...
    NULL /*arad_ofp_rates_port_priority_max_burst_for_fc_queues_set*/,      
    NULL /*arad_ofp_rates_port_priority_max_burst_for_empty_queues_set*/,       
    NULL /*arad_ofp_rates_port_priority_max_burst_for_fc_queues_get*/,          
    NULL /*arad_ofp_rates_port_priority_max_burst_for_empty_queues_get*/,       
    arad_ofp_rates_sch_single_port_rate_sw_set,                     
    arad_ofp_rates_sch_single_port_rate_hw_set,                     
    NULL /*arad_ofp_rates_egq_single_port_rate_sw_set*/,                     
    NULL /*arad_ofp_rates_egq_single_port_rate_hw_set*/,                     
    arad_ofp_rates_sch_single_port_rate_hw_get,                           
    NULL /*arad_ofp_rates_egq_single_port_rate_hw_get*/,                           
    NULL /*arad_ofp_rates_single_port_max_burst_set*/,                          
    NULL /*arad_ofp_rates_single_port_max_burst_get*/,                                            
    NULL /*arad_ofp_rates_egq_interface_shaper_set*/,                                                     
    NULL /*arad_ofp_rates_egq_interface_shaper_get*/,                           
    NULL /*arad_ofp_rates_egq_tcg_rate_sw_set*/,                             
    NULL /*arad_ofp_rates_egq_tcg_rate_hw_set*/,                             
    NULL /*arad_ofp_rates_sch_tcg_rate_set*/,                                   
    NULL /*arad_ofp_rates_egq_tcg_rate_hw_get*/,                                   
    NULL /*arad_ofp_rates_sch_tcg_rate_get*/,                                   
    NULL /*arad_ofp_rates_egq_tcg_max_burst_set*/,                              
    NULL /*arad_ofp_rates_sch_tcg_max_burst_set*/,                              
    NULL /*arad_ofp_rates_egq_tcg_max_burst_get*/,                              
    NULL /*arad_ofp_rates_sch_tcg_max_burst_get*/,                              
    NULL /*arad_ofp_rates_egq_port_priority_rate_sw_set*/,                   
    NULL /*arad_ofp_rates_egq_port_priority_rate_hw_set*/,                   
    NULL /*arad_ofp_rates_sch_port_priority_rate_set*/,                         
    NULL /*arad_ofp_rates_egq_port_priority_rate_hw_get*/,                         
    NULL /*arad_ofp_rates_sch_port_priority_rate_get*/,                         
    NULL /*arad_ofp_rates_egq_port_priority_max_burst_set*/,                    
    NULL /*arad_ofp_rates_sch_port_priority_max_burst_set*/,                    
    NULL /*arad_ofp_rates_egq_port_priority_max_burst_get*/,                    
    NULL /*arad_ofp_rates_sch_port_priority_max_burst_get*/,
    ...
    NULL /* arad_port_to_dynamic_interface_map_set_unsafe */,
    NULL /* arad_port_to_dynamic_interface_unmap_set_unsafe */,
