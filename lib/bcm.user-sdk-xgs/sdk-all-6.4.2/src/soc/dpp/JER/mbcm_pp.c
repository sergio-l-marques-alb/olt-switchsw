...
CONST mbcm_pp_functions_t mbcm_pp_jericho_driver = {
    ...
    NULL, /* mbcm_pp_oam_inlif_profile_map_set */
    NULL, /* mbcm_pp_oam_inlif_profile_map_get */
    NULL, /* mbcm_pp_oam_classifier_default_profile_add */
    NULL, /* mbcm_pp_oam_classifier_default_profile_remove */
};
