...
static uint8 _bcm_dpp_vlan_edit_eg_action_mapping[BCM_MAX_NUM_UNITS][SOC_PPD_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS];
...
static _bcm_dpp_vlan_translate_action_t _bcm_dpp_vlan_edit_eg_action[BCM_MAX_NUM_UNITS][SOC_PPD_NOF_EGRESS_VLAN_EDIT_ACTION_IDS];

int
soc_dpp_wb_engine_state_init_vlan_edit(int unit)
{
    sal_memset(_bcm_dpp_vlan_edit_eg_action_mapping[unit], 0, sizeof(uint8) * SOC_PPD_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS);
    ...
    sal_memset(_bcm_dpp_vlan_edit_eg_action[unit], 0, sizeof(_bcm_dpp_vlan_translate_action_t) * SOC_PPD_NOF_EGRESS_VLAN_EDIT_ACTION_IDS);
    return SOC_E_NONE;
}
