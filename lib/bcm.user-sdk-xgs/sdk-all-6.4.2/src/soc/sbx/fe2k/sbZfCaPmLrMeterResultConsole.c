/*
 * $Id: sbZfCaPmLrMeterResultConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPmLrMeterResult_Print(sbZfCaPmLrMeterResult_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPmLrMeterResult:: drp=0x%01x"), (unsigned int)  pFromStruct->m_uDrop));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPmLrMeterResult:: pmdp=0x%01x"), (unsigned int)  pFromStruct->m_uPmuDp));
  LOG_WARN(BSL_LS_SOC_COMMON,
