/*
 * $Id: sbZfCaPbDataEntryConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPbDataEntry_Print(sbZfCaPbDataEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data23=0x%08x"), (unsigned int)  pFromStruct->m_uData23));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data20=0x%08x"), (unsigned int)  pFromStruct->m_uData20));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data17=0x%08x"), (unsigned int)  pFromStruct->m_uData17));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data14=0x%08x"), (unsigned int)  pFromStruct->m_uData14));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data11=0x%08x"), (unsigned int)  pFromStruct->m_uData11));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data8=0x%08x"), (unsigned int)  pFromStruct->m_uData8));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data5=0x%08x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPbDataEntry:: data2=0x%08x"), (unsigned int)  pFromStruct->m_uData2));
  LOG_WARN(BSL_LS_SOC_COMMON,
