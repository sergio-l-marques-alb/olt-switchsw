...
#include "sbTypes.h"
#include "sbZfC2PdPdOutputHeaderCopyBufferEntry.hx"
...
uint32
sbZfC2PdPdOutputHeaderCopyBufferEntry_Pack(sbZfC2PdPdOutputHeaderCopyBufferEntry_t *pFrom,
                                           uint8 *pToData,
                                           uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_C2PDPDOUTPUTHEADERCOPYBUFFERENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2PDPDOUTPUTHEADERCOPYBUFFERENTRY_SIZE_IN_BYTES;
}
...
void
sbZfC2PdPdOutputHeaderCopyBufferEntry_Unpack(sbZfC2PdPdOutputHeaderCopyBufferEntry_t *pToStruct,
                                             uint8 *pFromData,
                                             uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfC2PdPdOutputHeaderCopyBufferEntry_InitInstance(sbZfC2PdPdOutputHeaderCopyBufferEntry_t *pFrame) {
