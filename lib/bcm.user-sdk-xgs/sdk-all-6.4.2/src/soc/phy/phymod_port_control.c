...
STATIC int
control_handler_scrambler_set(int unit, phymod_phy_access_t *phy, uint32 value1, uint32 value2)
{
    phymod_phy_inf_config_t config;

    SOC_IF_ERROR_RETURN(phymod_phy_interface_config_get(phy, 0 /* flags */, &config));
...
STATIC int
control_handler_scrambler_get(int unit, phymod_phy_access_t *phy, uint32 param, uint32 *value)
{
    phymod_phy_inf_config_t config;
...
int soc_port_control_get_wrapper(int unit, int is_lane_control, phymod_phy_access_t *phys, int nof_phys, soc_phy_control_t control, uint32 *value)
{
...
int soc_port_control_set_wrapper(int unit, int is_lane_control, phymod_phy_access_t *phys, int nof_phys, soc_phy_control_t control, uint32 value)
{
