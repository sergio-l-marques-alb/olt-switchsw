                 ...
                 phymod_phy_init_config_t  *pm_phy_init_config)
{
    ...
    */
    ...
    for (i = 0; i < 4; i++) { 
        pm_phy_init_config->tx[i].pre = 0x0;
        pm_phy_init_config->tx[i].main = 0x64;
        pm_phy_init_config->tx[i].post = 0xc;
        pm_phy_init_config->tx[i].post2 = 0x0;
        pm_phy_init_config->tx[i].post3 = 0x0;
        pm_phy_init_config->tx[i].amp = 0x8;
    }
...
phy_tscf_an_set(int unit, soc_port_t port, int enable)
{
    ...
    if(pCfg->cl73an) {
        ...
        switch (pCfg->cl37an) {
            case TEFMOD_CL37_WO_BAM:
                an.an_mode = phymod_AN_MODE_CL37;
                break;
            case TEFMOD_CL37_W_BAM:
 ...
 */
STATIC int
tscf_firmware_mode_set(soc_phymod_ctrl_t *pmc, uint32 value)
{
    phymod_phy_access_t    *pm_phy;
 ...
 */
STATIC int
tscf_scrambler_set(soc_phymod_ctrl_t *pmc, uint32 value)
{
    phymod_phy_access_t     *pm_phy;
 ...
 */
STATIC int
tscf_tx_ppm_adjust_set(soc_phymod_ctrl_t *pmc, uint32 value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_tx_override_t tx_override;
    int                  idx;
...
phy_tscf_control_set(int unit, soc_port_t port, soc_phy_control_t type, uint32 value)
{
    ...
    case SOC_PHY_CONTROL_FIRMWARE_MODE:
        rv = tscf_firmware_mode_set(pmc, value);
        break; 
    ...
    case SOC_PHY_CONTROL_SCRAMBLER:
        rv = tscf_scrambler_set(pmc, value);
        break;
 ...
 */
STATIC int 
tscf_rx_peak_filter_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_rx_t          phymod_rx;
 ...
 */
STATIC int 
tscf_rx_vga_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_rx_t          phymod_rx;
 ...
 */
STATIC int 
tscf_rx_tap_get(soc_phymod_ctrl_t *pmc, int tap, uint32 *value)
{
    phymod_phy_access_t  *pm_phy;
    phymod_rx_t          phymod_rx;
 ...
 */
STATIC int
tscf_scrambler_get(soc_phymod_ctrl_t *pmc, uint32 *value)
{
    phymod_phy_access_t     *pm_phy;
    phymod_phy_inf_config_t config;
...
phy_tscf_control_get(int unit, soc_port_t port, soc_phy_control_t type, uint32 *value)
{
    ...
    /* RX PEAK FILTER */
    case SOC_PHY_CONTROL_RX_PEAK_FILTER:
        rv = tscf_rx_peak_filter_get(pmc, value);
        break;

    /* RX VGA */
    case SOC_PHY_CONTROL_RX_VGA:
        rv = tscf_rx_vga_get(pmc, value);
        break;

    /* RX TAP */
    case SOC_PHY_CONTROL_RX_TAP1:
        rv = tscf_rx_tap_get(pmc, 0, value);
        break;
    case SOC_PHY_CONTROL_RX_TAP2:
        rv = tscf_rx_tap_get(pmc, 1, value);
        break;
    case SOC_PHY_CONTROL_RX_TAP3:
        rv = tscf_rx_tap_get(pmc, 2, value);
        break;
    case SOC_PHY_CONTROL_RX_TAP4:
        rv = tscf_rx_tap_get(pmc, 3, value);
        break;
    case SOC_PHY_CONTROL_RX_TAP5:
        rv = tscf_rx_tap_get(pmc, 4, value);
        break;
    ...
    /* SCRAMBLER */
    case SOC_PHY_CONTROL_SCRAMBLER:
       rv = tscf_scrambler_get(pmc, value);
       break;
    case SOC_PHY_CONTROL_LANE_SWAP:
