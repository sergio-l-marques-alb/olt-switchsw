 ...
 */
STATIC int 
tsce_speed_to_interface_config_get(tsce_speed_config_t* speed_config, phymod_phy_inf_config_t* interface_config, TXDRV_INXS_t* tx_index)
{
    int port_is_higig;
    int port_num_lanes;
    int scr_enabled;
                 ...
                 phymod_phy_init_config_t  *pm_phy_init_config)
{
    ...
    */
    ...
    SOC_IF_ERROR_RETURN
        (tsce_speed_to_interface_config_get(speed_config, &(core_init_config->interface), &tx_index));
...
phy_tsce_init(int unit, soc_port_t port)
{
    ...
    SOC_IF_ERROR_RETURN
        (tsce_speed_to_interface_config_get(speed_config, &interface_config, &tx_index));
...
phy_tsce_probe(int unit, phy_ctrl_t *pc)
{
    ...
    /*
        ...
        100g_config      = si->port_100g_lane_config[port] ;
