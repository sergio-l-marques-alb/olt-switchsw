...
soc_internal_write_reg(pcid_info_t *pcid_info, uint32 address, uint32 *data)
{
    ...
    */
    ...
    switch (ainfo.reg) {
        ...
        break;
        case FF_FLUSHr:
        if (soc_reg_field_get(pcid_info->unit, FF_FLUSHr, data[0], FLUSH_FIFO_ENABLEf) == 1) {
            soc_reg_field_set(pcid_info->unit, FF_FLUSHr, data, FLUSH_FIFO_DONEf, 1);
        }        
        break;
        /*
                ...
                for(i = 1; m[i] != INVALIDm; i++) {
                    ...
                    */
                    ...
                    soc_internal_extended_write_mem
                        (pcid_info, block, acc_type, member_addr, ent);
                }
                return(0);
            }
            index++;
