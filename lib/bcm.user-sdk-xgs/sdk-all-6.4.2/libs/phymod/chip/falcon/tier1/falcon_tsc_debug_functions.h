...
/*****************************************************************************************/
/*                                                                                       */
/*  Revision      :  $Id: falcon_api_debug_functions.h 316 2014-02-18 01:31:43Z kirand $ */
/*                                                                                       */
...
/** @file falcon_api_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef SERDES_DEBUG_FUNCTIONS_H
#define SERDES_DEBUG_FUNCTIONS_H
...
struct falcon_usr_ctrl_func_st {
#ifdef FALCON
...
struct falcon_usr_ctrl_dfe_func_st {
#ifdef FALCON
...
struct falcon_usr_ctrl_disable_functions_st {
  struct falcon_usr_ctrl_func_st field;
#ifdef FALCON
  uint16_t word;
#else
  uint8_t  byte;                         
...
struct falcon_usr_ctrl_disable_dfe_functions_st {
  struct falcon_usr_ctrl_dfe_func_st field;
  uint8_t  byte;                        
};

#ifdef FALCON
/** Falcon Lane status Struct */
struct falcon_detailed_lane_status_st {
    USR_DOUBLE ppm;
 ...
 */ 
uint8_t    falcon_rdbl_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */ 
uint16_t   falcon_rdwl_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */ 
int8_t     falcon_rdbls_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */ 
int16_t    falcon_rdwls_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */ 
uint8_t    falcon_rdbc_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */ 
uint16_t   falcon_rdwc_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */ 
int8_t     falcon_rdbcs_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */ 
int16_t    falcon_rdwcs_uc_var(const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
...
#ifdef FALCON
/** Reads current pmd lane status and populates the provided structure of type falcon_detailed_lane_status_st
...
/** Displays the lane status stored in the input struct of type falcon_detailed_lane_status_st
 ...
 * @return 16bit unsigned value read from uC RAM
 */ 
uint16_t   falcon_rdw_uc_ram(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */ 
uint8_t    falcon_rdb_uc_ram(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */ 
int16_t    falcon_rdws_uc_ram(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */ 
int8_t     falcon_rdbs_uc_ram(const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
#endif
