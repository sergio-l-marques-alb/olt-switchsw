...
#define BCM_COSQ_DISCARD_VSQ_OCB_ONLY       0x1000000  /* Configure the OCB-only
                                                          VSQ, else configure
                                                          the Dram-mix VSQ. */
...
#define BCM_COSQ_GPORT_SIZE_VSQ_OCB_ONLY    0x0010     /* Configure the OCB-only
                                                          VSQ, else configure
                                                          the Dram-mix VSQ. */
...
#define BCM_COSQ_DELAY_TOLERANCE_HIGH_Q_PRIORITY 0x4        /* Specifies that the
                                                          profile is for high
                                                          priority queue. */
#define BCM_COSQ_DELAY_TOLERANCE_TOLERANCE_OCB_ONLY 0x4        /* Specifies that the
                                                          profile is for
                                                          OCB-only queues. */
...
typedef enum bcm_cosq_threshold_type_e {
    ...
    bcmCosqThresholdPacketDescriptorsMin = 12, /* Fair Adaptive Thresholds support for
                                           bcmCosqThresholdPacketDescriptors. */
    bcmCosqThresholdPacketDescriptorsMax = 13, /* Fair Adaptive Thresholds support for
                                           bcmCosqThresholdPacketDescriptors. */
    bcmCosqThresholdPacketDescriptorsAlpha = 14, /* Fair Adaptive Thresholds support for
                                           bcmCosqThresholdPacketDescriptors. */
    bcmCosqThresholdDataBuffersMin = 15, /* Fair Adaptive Thresholds support for
                                           bcmCosqThresholdDataBuffers. */
    bcmCosqThresholdDataBuffersMax = 16, /* Fair Adaptive Thresholds support for
                                           bcmCosqThresholdDataBuffers. */
    bcmCosqThresholdDataBuffersAlpha = 17 /* Fair Adaptive Thresholds support for
                                           bcmCosqThresholdDataBuffers. */
