...
extern int
_bcm_dpp_wb_counters_proc_inUse_set(int unit, uint8 inUse, uint32 proc_indx, uint32 inUse_indx);

extern int
_bcm_dpp_wb_counters_proc_inUse_get(int unit, uint8 *inUse, uint32 proc_indx, uint32 inUse_indx);
