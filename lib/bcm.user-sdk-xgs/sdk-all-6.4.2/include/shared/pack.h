 ...
 *   _SHR_PACK_U64   : Packs a uint64, advances pointer
 *   _SHR_UNPACK_U64 : Unpacks a uint64, advances pointer
...
#define _SHR_PACK_U64(_buf, _var)           \
    do{                                     \
        uint32 _u32=0;                      \
        _u32 = COMPILER_64_HI(_var);        \
        _SHR_PACK_U32(_buf, _u32);          \
        _u32 = COMPILER_64_LO(_var);        \
        _SHR_PACK_U32(_buf, _u32);          \
    } while (0)
#define _SHR_UNPACK_U64(_buf, _var)         \
    do {                                    \
        uint32 _u32h=0, _u32l=0;            \
        _SHR_UNPACK_U32(buf, _u32h);        \
        _SHR_UNPACK_U32(buf, _u32l);        \
        COMPILER_64_SET(_var, _u32h, _u32l);\
    } while(0)
#endif /* _SHR_PACK_H_ */
