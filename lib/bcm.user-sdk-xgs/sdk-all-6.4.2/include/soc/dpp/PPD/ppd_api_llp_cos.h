...
#define SOC_PPD_LLP_COS_MAPPING_TABLE_UP_TO_DE_TC              SOC_PPC_LLP_COS_MAPPING_TABLE_UP_TO_DE_TC
#define SOC_PPD_LLP_COS_MAPPING_TABLE_IPV4_TOS_TO_DP_TC_VALID  SOC_PPC_LLP_COS_MAPPING_TABLE_IPV4_TOS_TO_DP_TC_VALID
#define SOC_PPD_LLP_COS_MAPPING_TABLE_IPV6_TC_TO_DP_TC_VALID   SOC_PPC_LLP_COS_MAPPING_TABLE_IPV6_TC_TO_DP_TC_VALID
#define SOC_PPD_LLP_COS_MAPPING_TABLE_TC_TO_DP                 SOC_PPC_LLP_COS_MAPPING_TABLE_TC_TO_DP
#define SOC_PPD_LLP_COS_MAPPING_TABLE_INCOMING_UP_TO_UP        SOC_PPC_LLP_COS_MAPPING_TABLE_INCOMING_UP_TO_UP
#define SOC_PPD_LLP_COS_MAPPING_TABLE_TC_TO_UP                 SOC_PPC_LLP_COS_MAPPING_TABLE_TC_TO_UP
#define SOC_PPD_LLP_COS_MAPPING_TABLE_DE_TO_DP                 SOC_PPC_LLP_COS_MAPPING_TABLE_DE_TO_DP
#define SOC_PPD_LLP_COS_MAPPING_TABLE_UP_TO_DP                 SOC_PPC_LLP_COS_MAPPING_TABLE_UP_TO_DP
typedef SOC_PPC_LLP_COS_MAPPING_TABLE                          SOC_PPD_LLP_COS_MAPPING_TABLE;

typedef SOC_PPC_LLP_COS_GLBL_INFO                              SOC_PPD_LLP_COS_GLBL_INFO;
typedef SOC_PPC_LLP_COS_TC_INFO                                SOC_PPD_LLP_COS_TC_INFO;
typedef SOC_PPC_LLP_COS_UP_USE                                 SOC_PPD_LLP_COS_UP_USE;
typedef SOC_PPC_LLP_COS_PORT_L2_TABLE_INDEXES                  SOC_PPD_LLP_COS_PORT_L2_TABLE_INDEXES;
typedef SOC_PPC_LLP_COS_PORT_L2_INFO                           SOC_PPD_LLP_COS_PORT_L2_INFO;
typedef SOC_PPC_LLP_COS_PORT_L3_INFO                           SOC_PPD_LLP_COS_PORT_L3_INFO;
typedef SOC_PPC_LLP_COS_PORT_L4_INFO                           SOC_PPD_LLP_COS_PORT_L4_INFO;
typedef SOC_PPC_LLP_COS_PORT_INFO                              SOC_PPD_LLP_COS_PORT_INFO;
typedef SOC_PPC_LLP_COS_MAPPING_TABLE_ENTRY_INFO               SOC_PPD_LLP_COS_MAPPING_TABLE_ENTRY_INFO;
typedef SOC_PPC_LLP_COS_IPV4_SUBNET_INFO                       SOC_PPD_LLP_COS_IPV4_SUBNET_INFO;
typedef SOC_PPC_LLP_COS_PRTCL_INFO                             SOC_PPD_LLP_COS_PRTCL_INFO;
typedef SOC_PPC_LLP_COS_L4_PORT_RANGE_INFO                     SOC_PPD_LLP_COS_L4_PORT_RANGE_INFO;
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_llp_cos_get_procs_ptr(void);
