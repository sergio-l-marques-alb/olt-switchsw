...
#define  SOC_PPD_VLAN_MEMBERSHIP_BITMAP_SIZE (SOC_PPC_VLAN_MEMBERSHIP_BITMAP_SIZE)
...
CONST SOC_PROCEDURE_DESC_ELEMENT*
  soc_ppd_llp_filter_get_procs_ptr(void);
...
void
  soc_ppd_llp_filter_ingress_vlan_membership_set_print(
    SOC_SAND_IN  int                               unit,
    SOC_SAND_IN  SOC_SAND_PP_VLAN_ID                         vid_ndx,
    SOC_SAND_IN  SOC_PPD_PORT                                ports[SOC_PPD_VLAN_MEMBERSHIP_BITMAP_SIZE]
  );
