...
typedef enum
{
   ...
   */
  ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET = ARAD_PP_PROC_DESC_BASE_FRWRD_MACT_MGMT_FIRST,
  ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_VERIFY,
  ARAD_PP_FRWRD_MACT_OPER_MODE_INFO_GET_UNSAFE,
  ARAD_PP_FRWRD_MACT_AGING_INFO_SET,
  ARAD_PP_FRWRD_MACT_ONE_PASS_SET,
  ARAD_PP_FRWRD_MACT_AGING_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_AGING_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_AGING_INFO_GET_VERIFY,
  ARAD_PP_FRWRD_MACT_AGING_INFO_GET_UNSAFE,
  ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET,
  ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_AGING_EVENTS_HANDLE_INFO_GET_VERIFY,
  ...
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_GLBL_INFO_GET_VERIFY,
  ...
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_UNSAFE,
  ARAD_PP_FRWRD_MACT_MAC_LIMIT_EXCEEDED_INFO_GET_VERIFY,
  ...
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_INFO_GET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_LEARN_MSGS_DISTRIBUTION_INFO_GET_VERIFY,
  ...
  ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_SET_PRINT,
  ...
  ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET_PRINT,
  ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_GET_VERIFY,
   ...
   */
   ...
   ARAD_PP_FRWRD_MACT_LEARN_MSGS_OLP_MSG_SET,
   ARAD_PP_FRWRD_MACT_LEARN_MSGS_OLP_MSG_GET,
...
typedef enum
{
  ...
  ARAD_PP_FRWRD_MACT_TRAP_TYPE_NDX_OUT_OF_RANGE_ERR,
  ARAD_PP_FRWRD_MACT_PORT_PROFILE_NDX_OUT_OF_RANGE_ERR,
  ARAD_PP_FRWRD_MACT_EVENT_TYPE_OUT_OF_RANGE_ERR,
  ...
  ARAD_PP_FRWRD_MACT_LEARNING_MODE_OUT_OF_RANGE_ERR,
  ARAD_PP_FRWRD_MACT_SHADOW_MODE_OUT_OF_RANGE_ERR,
  ...
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_IS_LAG_OUT_OF_RANGE_ERR,
...
/*********************************************************************
* NAME:
 *   arad_pp_frwrd_mact_tunnel_mac_limit_info_set_unsafe
 * TYPE:
 *   PROC
 * FUNCTION:
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_frwrd_mact_tunnel_mac_limit_info_set_unsafe" API.
 *     Refer to "arad_pp_frwrd_mact_tunnel_mac_limit_info_set_unsafe" API
 *     for details.
*********************************************************************/
uint32
  arad_pp_frwrd_mact_tunnel_mac_limit_info_get_unsafe(
    SOC_SAND_IN  int                                            unit,
    SOC_SAND_IN  ARAD_PP_PORT                                      port,
    SOC_SAND_IN  SOC_SAND_PON_TUNNEL_ID                            tunnel_id,
...
uint32
  ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO_verify(
    SOC_SAND_IN  ARAD_PP_FRWRD_MACT_IP_COMPATIBLE_MC_INFO *info
  );

uint32
  ARAD_PP_FRWRD_MACT_AGING_INFO_verify(
    SOC_SAND_IN   int                                   unit,
    SOC_SAND_IN  ARAD_PP_FRWRD_MACT_AGING_INFO *info
  );

uint32
  ARAD_PP_FRWRD_MACT_EVENT_HANDLE_KEY_verify(
