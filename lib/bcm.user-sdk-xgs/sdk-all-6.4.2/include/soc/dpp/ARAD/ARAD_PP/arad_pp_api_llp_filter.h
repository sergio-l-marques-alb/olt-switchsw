/* $Id: arad_pp_api_llp_filter.h,v 1.3 Broadcom SDK $
...
#ifndef __ARAD_PP_API_LLP_FILTER_INCLUDED__
/* { */
#define __ARAD_PP_API_LLP_FILTER_INCLUDED__
...
#define  ARAD_PP_VLAN_MEMBERSHIP_BITMAP_SIZE (SOC_PPC_VLAN_MEMBERSHIP_BITMAP_SIZE)
 ...
 *     "arad_pp_llp_filter_ingress_vlan_membership_set" API.
 *     Refer to "arad_pp_llp_filter_ingress_vlan_membership_set"
 *     API for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_llp_filter_ingress_acceptable_frames_set" API.
 *     Refer to
 *     "arad_pp_llp_filter_ingress_acceptable_frames_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_llp_filter_designated_vlan_set" API.
 *     Refer to "arad_pp_llp_filter_designated_vlan_set" API for
 *     details.
*********************************************************************/
uint32
...
/* } __ARAD_PP_API_LLP_FILTER_INCLUDED__*/
#endif
