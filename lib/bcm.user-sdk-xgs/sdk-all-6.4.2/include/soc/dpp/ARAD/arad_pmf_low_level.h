...
#define ARAD_PMF_LOW_LEVEL_PMF_KLEAR_STAGE_INFO_GET(_ingress_pmf, _egress_pmf, _ingress_flp, _ingress_slb) \
    ((stage == SOC_PPC_FP_DATABASE_STAGE_EGRESS)? SOC_DPP_DEFS_GET(unit, _egress_pmf): \
     ...
     (stage == SOC_PPC_FP_DATABASE_STAGE_INGRESS_PMF)? SOC_DPP_DEFS_GET(unit, _ingress_pmf): 1)

#define ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_STAGE_INGRESS_SLB      (0)
#define ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_STAGE_INGRESS_FLP      (2)
#define ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_STAGE_INGRESS_PMF      (3)
#define ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_STAGE_EGRESS           (1)
#define ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_STAGE(_stage)          (ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX_STAGE_##_stage)
#define ARAD_PMF_LOW_LEVEL_CE_NDX_MAX_STAGE_INGRESS_SLB      (7)
#define ARAD_PMF_LOW_LEVEL_CE_NDX_MAX_STAGE_INGRESS_FLP      (11)
#define ARAD_PMF_LOW_LEVEL_CE_NDX_MAX_STAGE_INGRESS_PMF      (15)
#define ARAD_PMF_LOW_LEVEL_CE_NDX_MAX_STAGE_EGRESS           (7)
#define ARAD_PMF_LOW_LEVEL_CE_NDX_MAX_STAGE(_stage)          (ARAD_PMF_LOW_LEVEL_CE_NDX_MAX_STAGE_##_stage)
...
#define ARAD_PMF_LOW_LEVEL_NOF_CE_IN_PROG_GROUP               (ARAD_PMF_LOW_LEVEL_PMF_KLEAR_STAGE_INFO_GET(nof_ingress_pmf_instructions_lsb, \
                                                                 nof_egress_pmf_instructions_lsb, nof_flp_instructions_lsb, nof_slb_instructions_lsb) / 2)
...
#define ARAD_PMF_LOW_LEVEL_PMF_PGM_NDX_MAX                    (ARAD_PMF_LOW_LEVEL_PMF_KLEAR_STAGE_INFO_GET(nof_ingress_pmf_programs, \
                                                                 nof_egress_pmf_programs, nof_flp_programs, nof_slb_programs) - 1)
...
#define ARAD_PMF_LOW_LEVEL_PMF_KEY_MAX                        (ARAD_PMF_LOW_LEVEL_PMF_KLEAR_STAGE_INFO_GET(nof_ingress_pmf_keys, \
                                                                 nof_egress_pmf_keys, nof_flp_keys, nof_slb_keys) - 1)
...
#define ARAD_PMF_LOW_LEVEL_CE_NDX_MAX                         (ARAD_PMF_LOW_LEVEL_PMF_KLEAR_STAGE_INFO_GET(nof_ingress_pmf_instructions_lsb, \
                                                                 nof_egress_pmf_instructions_lsb, nof_flp_instructions_lsb, nof_slb_instructions_lsb) - 1)
