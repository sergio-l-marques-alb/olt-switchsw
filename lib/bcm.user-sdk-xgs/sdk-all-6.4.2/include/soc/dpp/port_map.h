...
int petra_soc_dpp_pp_to_local_port_get(int unit, uint32 pp_port, int core, soc_port_t *port);
int petra_soc_dpp_tm_to_local_port_get(int unit, uint32 tm_port, int core, soc_port_t *port);
