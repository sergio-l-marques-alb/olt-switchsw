...
soc_error_t soc_port_sw_db_port_add(int unit, soc_port_t port, int core, uint32 channel, uint32 flags, soc_port_if_t interface, soc_pbmp_t phy_ports);
...
soc_error_t soc_port_sw_db_port_validate_and_add(int unit, soc_port_t port, int core, uint32 channel, uint32 flags, soc_port_if_t interface, soc_pbmp_t phy_ports);
...
soc_error_t soc_port_sw_db_tm_to_local_port_get(int unit, uint32 tm_port, int core, soc_port_t *port);
soc_error_t soc_port_sw_db_pp_to_local_port_get(int unit, uint32 pp_port, int core, soc_port_t *port);
soc_error_t soc_port_sw_db_pp_is_valid_get(int unit, uint32 pp_port, int core, uint32 *is_valid);
...
soc_error_t soc_port_sw_db_tm_port_to_out_port_priority_get(int unit, uint32 tm_port, int core, uint32* nof_priorities);
soc_error_t soc_port_sw_db_pp_port_to_out_port_priority_get(int unit, uint32 pp_port, int core, uint32* nof_priorities);
...
soc_error_t soc_port_sw_db_tm_port_to_base_q_pair_get(int unit, uint32 tm_port, int core, uint32* base_q_pair);
soc_error_t soc_port_sw_db_pp_port_to_base_q_pair_get(int unit, uint32 pp_port, int core, uint32* base_q_pair);
...
soc_error_t soc_port_sw_db_protocol_offset_set(int unit, soc_port_t port, uint32 offset);
soc_error_t soc_port_sw_db_protocol_offset_get(int unit, soc_port_t port, uint32 *offset);
