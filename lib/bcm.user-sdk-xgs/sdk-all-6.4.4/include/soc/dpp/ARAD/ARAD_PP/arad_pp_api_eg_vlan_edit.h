/* $Id: arad_pp_api_eg_vlan_edit.h,v 1.4 Broadcom SDK $
...
#ifndef __ARAD_PP_API_EG_VLAN_EDIT_INCLUDED__
/* { */
#define __ARAD_PP_API_EG_VLAN_EDIT_INCLUDED__
...
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_EMPTY               SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_EMPTY
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG           SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_INNER_TAG           SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_INNER_TAG
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_0         SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_0
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_1         SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_EDIT_INFO_1
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_VSI                 SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_VSI
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_CEP_EDIT_INFO       SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_CEP_EDIT_INFO
#define ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC_PEP_EDIT            SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC_PEP_EDIT
#define ARAD_PP_NOF_EG_VLAN_EDIT_TAG_VID_SRCS                SOC_PPC_NOF_EG_VLAN_EDIT_TAG_VID_SRCS_ARAD
typedef SOC_PPC_EG_VLAN_EDIT_TAG_VID_SRC                       ARAD_PP_EG_VLAN_EDIT_TAG_VID_SRC;

#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_NONE                SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_NONE
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_MAP             SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_MAP
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG       SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG       SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_0     SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_0
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_1     SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_EDIT_INFO_1
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_CEP_EDIT_INFO   SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_CEP_EDIT_INFO
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_PEP_EDIT        SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC_PEP_EDIT
#define ARAD_PP_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_SRCS            SOC_PPC_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_SRCS
typedef SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_SRC                   ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_SRC;

#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_TC_DP       SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_TC_DP
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_PCP         SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_PCP
#define ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_DSCP_EXP    SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_DSCP_EXP
#define ARAD_PP_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEYS        SOC_PPC_NOF_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEYS_ARAD
typedef SOC_PPC_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY               ARAD_PP_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY;

typedef SOC_PPC_EG_VLAN_EDIT_PEP_INFO                          ARAD_PP_EG_VLAN_EDIT_PEP_INFO;
typedef SOC_PPC_EG_VLAN_EDIT_COMMAND_KEY                       ARAD_PP_EG_VLAN_EDIT_COMMAND_KEY;
typedef SOC_PPC_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO            ARAD_PP_EG_VLAN_EDIT_COMMAND_TAG_BUILD_INFO;
typedef SOC_PPC_EG_VLAN_EDIT_COMMAND_INFO                      ARAD_PP_EG_VLAN_EDIT_COMMAND_INFO;
 ...
 *     "arad_pp_eg_vlan_edit_pep_info_set" API.
 *     Refer to "arad_pp_eg_vlan_edit_pep_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_eg_vlan_edit_command_info_set" API.
 *     Refer to "arad_pp_eg_vlan_edit_command_info_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_eg_vlan_edit_pcp_profile_info_set" API.
 *     Refer to "arad_pp_eg_vlan_edit_pcp_profile_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_eg_vlan_edit_pcp_map_stag_set" API.
 *     Refer to "arad_pp_eg_vlan_edit_pcp_map_stag_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_eg_vlan_edit_pcp_map_ctag_set" API.
 *     Refer to "arad_pp_eg_vlan_edit_pcp_map_ctag_set" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "arad_pp_eg_vlan_edit_pcp_map_untagged_set" API.
 *     Refer to "arad_pp_eg_vlan_edit_pcp_map_untagged_set" API
 *     for details.
*********************************************************************/
uint32
 ...
 *   SOC_SAND_IN  int                                 unit -
 *     Identifier of the device to access.
 *   SOC_SAND_IN  ARAD_PP_PKT_HDR_TYPE                      pkt_type_ndx -
...
/* } __ARAD_PP_API_EG_VLAN_EDIT_INCLUDED__*/
#endif
