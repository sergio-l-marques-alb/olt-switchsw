...
enum kbp_db_properties {
    KBP_PROP_USE_MCOR,       /**< For ACL databases, use MCOR for the range at the specified offset (future use). */
    KBP_PROP_MCOR_VALUE,     /**< For ACL databases, add a most commonly occurring range (future use). */
    KBP_PROP_ALGORITHMIC,    /**< Indicates whether the database should be algorithmic or nonalgorithmic. */
    ...
    KBP_PROP_DMA_TAG,        /**< DMA Tag for the database, KAPS specfic. */
