...
#define BCM_SB2_ETH_LM_DM_RX_CHANNEL            3 /* this rx dma channel is shared with MPLS-LM/DM if it is there */
#define BCM_SB2_ETH_LM_DM_RX_GLOBAL_CHANNEL    11 /* this rx dma channel global channel id is shared with MPLS-LM/DM if it is there */
