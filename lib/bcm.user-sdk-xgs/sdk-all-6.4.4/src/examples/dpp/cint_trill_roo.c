...
trill_roo_run(int unit) {
    ...
    rv = l3__intf_rif_with_id__create(unit, 
                                      cint_trill_roo_info.my_mac,  /* my mac (global value) */
                                      cint_trill_roo_info.my_mac,  /* my mac */
                                      cint_trill_roo_info.global_vpn); /* vlan = vsi = rif = l3_if object */
    if (rv != BCM_E_NONE) {
    ...
    rv = l3__egress_only_encap__create(unit, 
                                       cint_trill_roo_info.provider_port,  /* outgoing port */
                                       cint_trill_roo_info.global_vpn, /* vlan at the LL */
                                       0, /* tunnel id */
                                       cint_trill_roo_info.remote_rbr_mac,  /* next hop mac */
                                       &native_ll_encap_id /* Contains LL eedb index (l3_if object. Type encap) */
                                       ); 
    if (rv != BCM_E_NONE) {
    ...
    rv = l3__intf_rif_with_id__create(unit, 
                                      cint_trill_roo_info.my_mac,  /* my mac (global value) */
                                      cint_trill_roo_info.my_mac,  /* my mac */
                                      cint_trill_roo_info.access_vlan /* l3_if object = rif = vsi = access vlan */
                                      ); 
    if (rv != BCM_E_NONE) {
        printf("Error, l3__intf_rif_with_id__create\n");
      return rv;
    } 
    ...
    int ll_intf; 
    int ll_encap_id; 
    rv = l3__egress__create(unit,
                            0, 
                            cint_trill_roo_info.access_port,  /* outgoing port */
                            cint_trill_roo_info.access_vlan, /* vlan at the LL: access vlan */
                            0, /* tunnel id */
                            cint_trill_roo_info.router_a_mac,  /* next hop mac */
                            &ll_intf, /* Contain the fec_id  (l3_if object. Type FEC) */
                            &ll_encap_id /* Contains LL eedb index (l3_if object. Type encap) */
                            ); 
    if (rv != BCM_E_NONE) {
