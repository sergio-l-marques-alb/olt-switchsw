...
_soc_tomahawk_tdm_calculation(int unit, int initTime, _soc_tomahawk_tdm_t *tdm)
{
    ...
    if ( tdm_th_set_tdm_tbl(&tdm->tdm_globals, &tdm->tdm_pipe_tables) == 0 ) {
        LOG_CLI((BSL_META_U(unit,
...
soc_th_granular_speed_get(int unit, soc_port_t port, int *speed)
{
    ...
    int encapHigig = IS_HG_PORT(unit, port);
    ...
    switch(fval) {
        case 44:
            *speed = encapHigig ? 106000 : 100000;
            break;
        case 27:
            *speed = encapHigig ? 53000 : 50000;
            break;
        case 25:
            *speed = encapHigig ? 42000 : 40000;
            break;
        case 16:
            *speed = encapHigig ? 27000 : 25000;
            break;
        case 18:
            *speed = encapHigig ? 21000 : 20000;
            break;
        case 13:
            *speed = encapHigig ? 11000 : 10000;
            break;
        default:
            rc = SOC_E_PARAM;
            break;
