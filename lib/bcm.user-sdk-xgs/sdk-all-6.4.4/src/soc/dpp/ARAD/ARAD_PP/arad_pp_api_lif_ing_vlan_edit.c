...
/* $Id: arad_pp_api_lif_ing_vlan_edit.c,v 1.7 Broadcom SDK $
...
*********************************************************************/
uint32
  arad_pp_lif_ing_vlan_edit_command_id_set(
    SOC_SAND_IN  int                                     unit,
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY           *command_key,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_command_id_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_command_id_get()", 0, 0);
}
...
*********************************************************************/
uint32
  arad_pp_lif_ing_vlan_edit_command_info_set(
    SOC_SAND_IN  int                                     unit,
    SOC_SAND_IN  uint32                                      command_ndx,
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO          *command_info
  )
{
  uint32
    res = SOC_SAND_OK;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_SET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_command_info_set()", command_ndx, 0);
}
...
*********************************************************************/
uint32
  arad_pp_lif_ing_vlan_edit_command_info_get(
    SOC_SAND_IN  int                                     unit,
    SOC_SAND_IN  uint32                                      command_ndx,
    SOC_SAND_OUT ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO          *command_info
  )
{
  uint32
    res = SOC_SAND_OK;

  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_GET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_command_info_get()", command_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_pcp_map_stag_set()", pcp_profile_ndx, tag_pcp_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_pcp_map_stag_get()", pcp_profile_ndx, tag_pcp_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_pcp_map_ctag_set()", pcp_profile_ndx, tag_up_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_pcp_map_ctag_get()", pcp_profile_ndx, tag_up_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_pcp_map_untagged_set()", pcp_profile_ndx, tc_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_lif_ing_vlan_edit_pcp_map_untagged_get()", pcp_profile_ndx, tc_ndx);
}

void
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO_clear(
    SOC_SAND_OUT ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO *info
  )
{
...
void
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY_clear(
    SOC_SAND_OUT ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
void
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_clear(
    SOC_SAND_OUT ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
const char*
  ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_to_string(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC enum_val
  )
{
...
const char*
  ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_to_string(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC enum_val
  )
{
...
void
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO_print(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
void
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY_print(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
...
void
  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO_print(
    SOC_SAND_IN  ARAD_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
