  ...
  )
{
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_HIGH_VD_OUTER_INNER_OR_LOW_VD_OUTER].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTER_INNER_VID_OR_OUTER_VID].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_OR_OUTER_VID_L1;
      ...
      vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VDxINITIALVID_L1].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_INITIALVID].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1;
    prog_indx++; /* adding 2 program selections in one call */
  }    
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VDxOUTERVID_L1].prog_used != -1) 
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTERVID].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1;
  ...
  if (vt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_VT_VD_OUTER_INNER].prog_used != -1)
  {
    ...
    vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_VD_OUTER_INNER_VID].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_L1;
  }  
  /* Double tag defaults } */  
...
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(
     ...
     uint32 is_port_raw_mpls, /* 1- Port support RAW MPLS */
     uint32 prog_sel
   )
{
  uint32
  ...
  } else if (is_port_raw_mpls) {
    prog_selection_2nd_cam_tbl.in_pp_port_tt_profile                     =  SOC_PPC_PORT_DEFINED_TT_PROFILE_FORCE_MY_MAC;
    prog_selection_2nd_cam_tbl.in_pp_port_tt_profile_mask                =  (0x0);
  } else {
   ...
   )
{
  ...
  prog_selection_2nd_cam_tbl.packet_format_qualifier_1                 = (ARAD_PP_ISEM_ACCESS_QLFR_ETH_NEXT_PROTOCOL_MPLS);
  prog_selection_2nd_cam_tbl.packet_format_qualifier_1_mask            = (0x7F);
  prog_selection_2nd_cam_tbl.packet_format_code                        = (ARAD_PP_ISEM_PFC_PART_MPLS2); /* Two or more labels in stack */
  prog_selection_2nd_cam_tbl.packet_format_code_mask                   = (0x19); /* ignore bits 3:4 and 0 as bits 1:2 tell us about MPLS1 up to MPLS3; and bit 5 that it is ethernet packet */
  if (is_mpls_tp_mc_mac_address) {
    prog_selection_2nd_cam_tbl.da_is_all_r_bridges                      = (0x1);
    prog_selection_2nd_cam_tbl.da_is_all_r_bridges_mask                 = (0x0);
  } else if (is_port_raw_mpls) {
   ...
   )
{
  ...
  if (ipv6_term_enable) {
      ...
      prog_selection_2nd_cam_tbl.packet_format_code_mask          = 0x1;/*6b00_0001;*/ 
  }
...
STATIC
uint32
   arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_bridge_dip6_compression_prog_set(
     int unit,
   ...
   )
{
  ...
  res = arad_pp_ihp_isem_2nd_program_selection_cam_tbl_get_unsafe(unit, prog_indx, &prog_selection_2nd_cam_tbl);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  prog_selection_2nd_cam_tbl.ptc_tt_profile                   = SOC_TMC_PORTS_TT_PROFILE_NONE;
  prog_selection_2nd_cam_tbl.ptc_tt_profile_mask              = 0x0;
  prog_selection_2nd_cam_tbl.packet_format_code     = (0x0);
  prog_selection_2nd_cam_tbl.packet_format_code_mask = (0x1F);
...
exit:
 SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_bridge_dip6_compression_prog_set", prog_indx, prog_sel);
}
  ...
  )
{
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_indx_l1_l2eli_inrif_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2ELI_INRIF].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2ELI_INRIF, exit);
    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_indx_l1_l2eli_inrif_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2ELI_INRIF].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2ELI_INRIF, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_indx_l1_l2eli_inrif_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2ELI_INRIF].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2ELI_INRIF, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2_L3ELI].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_L2_L3ELI, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2_L3ELI].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_L2_L3ELI, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2_L3ELI].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_L2_L3ELI, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_L3ELI_INRIF].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_L3ELI_INRIF, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_L3ELI_INRIF].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_L3ELI_INRIF, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_L3ELI_INRIF].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_L3ELI_INRIF, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3ELI].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3ELI, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3ELI].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3ELI, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_l3eli_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3ELI].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L2_L3ELI, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_MPLS_2].priority[unit]  = prog_indx;
    tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_MPLS_2].prog_name[unit] = ARAD_PP_DBAL_TT_PROG_MPLS_L2;

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,1,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_L2, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_L2].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_L2, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_INRIF].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_INRIF, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,1,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_INRIF].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_INRIF, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_INRIF].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_INRIF, exit);
    }
  }  
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_gal_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1_GAL].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1_GAL, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_gal_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1_GAL].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1_GAL, exit);
    }
    if (prog_soc_prop->port_raw_mpls)     
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_gal_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1_GAL].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L1_GAL, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_l2_gal_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_GAL].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_GAL, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_l2_gal_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_GAL].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_GAL, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_l2_gal_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_GAL].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2_GAL, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,prog_soc_prop->tunnel_termination_in_tt_only,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L3_L2].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L3_L2, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,1,prog_soc_prop->tunnel_termination_in_tt_only,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L3_L2].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L3_L2, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l2_set(unit,prog_indx,0,prog_soc_prop->tunnel_termination_in_tt_only,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L3_L2].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L3_L2, exit);
    }
  }
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_l2_set(unit,prog_indx,0,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2, exit);

    if (prog_soc_prop->mpls_tp_mac_address) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_l2_set(unit,prog_indx,1,0,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2, exit);
    }
    if (prog_soc_prop->port_raw_mpls) 
    {
      SET_TT_PROGRAM_SELECTION(prog_indx);
      res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_l1_l2_set(unit,prog_indx,0,1,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2].prog_used);
      SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_INDX_L1_L2, exit);
    }
  }   
  ...
  { 
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_ip_router_control_packets_prog_set(unit,prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_IP_ROUTER_2ND_PROG].prog_used, prog_soc_prop->ipv6_term_enable);
  ...
  { 
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_ip_router_compatiblemc_2nd_prog_set(unit,prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_IP_ROUTER_CompatibleMc_2ND_PROG].prog_used,prog_soc_prop->ipv4mc_bidir_enable,0);
  ...
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_bridge_dip6_compression_prog_set(unit,prog_indx,tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG].prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG, exit);
  }
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  if(SOC_DPP_CONFIG(unit)->pp.custom_feature_vt_tst2)
  {
      ...
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_1_TST2].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_2_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_2_TST2].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_1_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_1_TST2      ].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_2_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_2_TST2      ].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_1_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_1_TST2    ].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_2_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_2_TST2    ].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_1_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_1_TST2          ].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_2_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_2_TST2          ].prog_used[unit] = (last_vt_program_id - 1);

      SET_VT_PROGRAM_ID(unit, ARAD_PP_ISEM_ACCESS_PROG_VT_UNTAGGED_TST2);
      vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_UNTAGGED_TST2         ].prog_used[unit] = (last_vt_program_id - 1);
  ...
  else
  {
      ...
      if (!prog_soc_prop.port_vlan_pcp_lookup && !prog_soc_prop.match_port_vlan_critiria_64K && !prog_soc_prop.custom_feature_vt_tst1)
      {
          ...
          vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_L1].prog_used[unit] = (last_vt_program_id - 1);
          if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
          {
              ...
              vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_OR_OUTER_VID_L1].prog_used[unit] = (last_vt_program_id - 1);
          }
      ...
      else if ((prog_soc_prop.port_vlan_pcp_lookup) && (!prog_soc_prop.match_port_vlan_critiria_64K))
      {
          ...
          vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1].prog_used[unit] = (last_vt_program_id - 1);
      }
      else if ((!prog_soc_prop.port_vlan_pcp_lookup) && (prog_soc_prop.match_port_vlan_critiria_64K))
      {
      ...
      if ((!prog_soc_prop.port_vlan_pcp_lookup) && (!prog_soc_prop.match_port_vlan_critiria_64K) && (!prog_soc_prop.custom_feature_vt_tst1))
      {
          ...
          if (!prog_soc_prop.mpls_index && !prog_soc_prop.mpls_use_in_rif)
          {
              ...
              if (SOC_DPP_CONFIG(unit)->pp.port_use_outer_vlan_and_initial_vlan_enabled)
              {
                  ...
                  vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1].prog_used[unit] = (last_vt_program_id - 1);
              }
  ...
  )
{
  ...
  /* ISEM-A VLAN-Domain x Initial-VID x const 0 */
  /* TCAM   Label-1 lookup */
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst0            = ARAD_PP_MPLS_1_19_16;
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst1            = ARAD_PP_MPLS_1_15_0;
  ihp_vtt1st_key_construction_tbl_data.isa_key_valids_1       = (0x0); /* */
  ihp_vtt1st_key_construction_tbl_data.isb_key_valids_1       = (0x0); /* */
  ...
  )
{
  ...
  ihp_vtt1st_key_construction_tbl_data.key_32b_inst1      = ARAD_PP_MPLS_2_31_0;
  ...
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst2      = ARAD_PP_MPLS_1_19_16;
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst3      = ARAD_PP_MPLS_1_15_0;
  ...
  )
{
  ...
  ihp_vtt1st_key_construction_tbl_data.isb_key_valids_1       = (0x0);
  ihp_vtt1st_key_construction_tbl_data.tcam_key_valids_1      = (0x1);
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst2      = ARAD_PP_MPLS_3_19_16;
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst3      = ARAD_PP_MPLS_3_15_0;
  ...
  )
{
  ...
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst1      = ARAD_PP_ISEM_ACCESS_16B_INST_1_ONES;
  ihp_vtt1st_key_construction_tbl_data.key_32b_inst0      = ARAD_PP_ISEM_ACCESS_32B_INST_1_ZEROS;
  ihp_vtt1st_key_construction_tbl_data.key_32b_inst1      = (SOC_IS_JERICHO(unit)? 0x4138 :(ARAD_PP_ISEM_ACCESS_32B_INST_VLAN_DOMAIN));
  ihp_vtt1st_key_construction_tbl_data.isa_key_valids_1       = (0x0); /* */
  ...
  )
{
  ...
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst2      = ARAD_PP_ISEM_ACCESS_16B_INST_2_ZEROS;
  ihp_vtt1st_key_construction_tbl_data.key_16b_inst3      = (SOC_IS_JERICHO(unit)? 0x82a8 : (ARAD_PP_ISEM_ACCESS_16B_INST_VLAN_DOMAIN));
  ihp_vtt1st_key_construction_tbl_data.key_32b_inst2      = ARAD_PP_CE_IPV4_DIP_HDR2_HEADER;
  ihp_vtt1st_key_construction_tbl_data.key_32b_inst3      = ARAD_PP_ISEM_ACCESS_32B_INST_INITIAL_VID;
  ihp_vtt1st_key_construction_tbl_data.isa_key_valids_2       = (0x3);
  ihp_vtt1st_key_construction_tbl_data.isb_key_valids_2       = (0x4);
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0        = ARAD_PP_MPLS_3_19_16;
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1        = ARAD_PP_MPLS_3_15_0;
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0        = ARAD_PP_MPLS_2_19_16;
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1        = ARAD_PP_MPLS_2_15_0;
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst0            = ARAD_PP_MPLS_4_31_0;
  ihp_vtt2nd_key_construction_tbl_data.isa_key_valids_1         = (0x0);
  ...
  ihp_vtt2nd_key_construction_tbl_data.isb_key_initial_from_vt  = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.tcam_key_initial_from_vt = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2            = ARAD_PP_MPLS_3_19_16;
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst3            = ARAD_PP_MPLS_3_15_0;
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0        = ARAD_PP_MPLS_1_19_16;
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst1        = ARAD_PP_MPLS_1_15_0;
  ...
  ihp_vtt2nd_key_construction_tbl_data.isb_key_initial_from_vt  = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.tcam_key_initial_from_vt = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2          = ARAD_PP_MPLS_2_19_16;
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst3          = ARAD_PP_MPLS_2_15_0;
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.isb_key_initial_from_vt  = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.tcam_key_initial_from_vt = (0x0);
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2        = ARAD_PP_MPLS_4_19_16;
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst3        = ARAD_PP_MPLS_4_15_0;
...
STATIC
uint32
  arad_pp_vtt_2nd_lookup_program_tt_bridge_dip6_compression_prog_set(
    int unit,
    uint32 dip6_compression_access_profile_id       
  )
{
  uint32
    res; 
  int
    prog_indx = tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG].prog_used;
  ARAD_PP_IHP_VTT2ND_KEY_CONSTRUCTION_TBL_DATA
    ihp_vtt2nd_key_construction_tbl_data;
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_16b_inst2        = ARAD_PP_CE_DIP_IPV6_HDR2_HEADER_63_56_CB16;
  /*TT1 - {VSI, IPV6} SIP in TCAM */
  ihp_vtt2nd_key_construction_tbl_data.tcam_key_valids_1  = (0xC);
  ihp_vtt2nd_key_construction_tbl_data.tcam_key_valids_2  = (0x1);
  ihp_vtt2nd_key_construction_tbl_data.tcam_db_profile   =  dip6_compression_access_profile_id;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_vtt_2nd_lookup_program_tt_bridge_dip6_compression_prog_set()", 0, 0);
}
  ...
  )
{
  ...
  if (!is_vsan_from_vsi/*VSAN from VFT*/){
      ...
      ihp_vtt2nd_key_construction_tbl_data.key_16b_inst0 = ARAD_PP_CE_NATIVE_VLAN_VSI;/*VSI*/
  ...
  )
{
  ...
  ihp_vtt2nd_key_construction_tbl_data.key_32b_inst3              = (trill_mode == 1) ? (SOC_IS_JERICHO(unit)? 0x4138 : (ARAD_PP_ISEM_ACCESS_32B_INST_VLAN_DOMAIN)):ARAD_PP_ISEM_ACCESS_32B_INST_X_ZEROS(8);
  ...
  )
{
  ...
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG].prog_used != -1)
  {
    res = arad_pp_vtt_2nd_lookup_program_tt_bridge_dip6_compression_prog_set(unit, ARAD_TCAM_ACCESS_PROFILE_INVALID);
    SOC_SAND_CHECK_FUNC_RESULT(res, ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG, exit);
  }
...
#define prog_soc_prop g_prog_soc_prop[unit]
 ...
 case ARAD_PP_ISEM_ACCESS_TCAM_IPV4_TT_ETH_DB_PROFILE:
  ...
  /* Update TT program lookup */
  if (tt_programs[unit][ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG].prog_used != -1) {
    res = arad_pp_vtt_2nd_lookup_program_tt_bridge_dip6_compression_prog_set(unit, access_profile_id);  
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  if (prog_soc_prop.compression_spoof_ip6_enable || prog_soc_prop.compression_ip6_enable) {
  ...
  )
{
  ...
  if (exact_match)
  {
     ...
     */
    hash_tbl = arad_sw_db_entry_key_to_entry_id_hash_get(
                 unit
               );
...
/*#ifdef ARAD_FAST_REGISTERS_AND_FIELDS_ACCESS
      ...
      if (SOC_IS_DONE_INIT(unit))
      {
          if (BCM_UNIT_DO_HW_READ_WRITE(unit))
          {
              if (SOC_INFO(unit).ha_hw_log_access.polling)
              {
/*                LOG_ERROR(BSL_LS_SOC_HWLOG, (BSL_META_U(unit, "arad_pp_isem_access_isem_entry_add_unsafe!\n")));*/

			        SOC_SAND_SOC_IF_ERROR_RETURN(res, 1230, exit, soc_mem_write(unit, tmp_mem_name, block_id, 0, buffer));

                    SOC_INFO(unit).ha_hw_log_access.polling(
                                                      unit,
                                                      ARAD_TIMEOUT,
                                                      ARAD_MIN_POLLS,
                                                      tmp_reg_name,
...
/*#endif*/
      ...
      {        
        ...
        case 0x002:/*Notice: Table coherence             */
