  ...
  )
{
  ...
  */
  res = soc_sand_occ_bm_cache_set(tree_info_ndx->pat_tree_data.memory_use,enable_cache);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
 /*
  ...
  )
{
  ...
  */
  res = soc_sand_occ_bm_cache_commit(tree_info_ndx->pat_tree_data.memory_use,flags);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
 /*
  * if cache enabled, copy status to cache instance
  */
  ...
  )
{
  ...
  * rollback bitmap
  */
  res = soc_sand_occ_bm_cache_rollback(tree_info_ndx->pat_tree_data.memory_use,flags);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
 /*
  * if cache enabled, copy status to cache instance
  */
