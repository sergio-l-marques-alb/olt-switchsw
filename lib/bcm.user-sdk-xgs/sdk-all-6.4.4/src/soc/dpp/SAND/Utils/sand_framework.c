...
#ifdef LINK_PETRA_LIBRARIES
  #include <soc/dpp/Petra/petra_framework.h>
#endif
#ifdef LINK_FE600_LIBRARIES
  #include <soc/dpp/SOC_SAND_FE600/fe600_framework.h>
#endif
#ifdef LINK_FAP21V_LIBRARIES
  #include <soc/dpp/SOC_SAND_FAP21V/fap21v_framework.h>
#endif
#ifdef LINK_FAP20V_LIBRARIES
  #include <soc/dpp/SOC_SAND_FAP20V/fap20v_framework.h>
#endif
#ifdef LINK_FAP20M_LIBRARIES
  #include <soc/dpp/SOC_SAND_FAP20M/fap20m_framework.h>
#endif
...
#endif
#ifdef LINK_PPD_LIBRARIES
  #include <soc/dpp/PPD/ppd_api_framework.h>
#endif
#ifdef LINK_PPH_LIBRARIES
  #include <soc/dpp/PPH/pph_api_framework.h>
#endif
#ifdef LINK_OAM_LIBRARIES
  ...
  )
{
  ...
  case FAP20V_MODULE_IDENTIFIER:
    ret = disp_fap20v_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_FAP20M_LIBRARIES
  case FAP20M_MODULE_IDENTIFIER:
    ret = disp_fap20m_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_PETRA_LIBRARIES
  case SOC_PETRA_MODULE_IDENTIFIER:
  case SOC_PETRA_PP_MODULE_IDENTIFIER:
    ret = soc_petra_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_FE600_LIBRARIES
  case FE600_MODULE_IDENTIFIER:
    ret = fe600_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_FAP21V_LIBRARIES
  case FAP21V_MODULE_IDENTIFIER:
    ret = fap21v_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_TIMNA_LIBRARIES
  case TIMNA_MODULE_IDENTIFIER:
    ret = timna_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_PSS_LIBRARIES
  case FAP10M_MODULE_IDENTIFIER:
    ret = disp_fap10m_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_FE200_LIBRARIES
  case FE200_MODULE_IDENTIFIER:
    ret = disp_fe200_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_T20E_LIBRARIES
  case T20E_MODULE_IDENTIFIER:
    ret = t20e_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_PB_LIBRARIES
  case SOC_PB_MODULE_IDENTIFIER:
  case SOC_PB_PP_MODULE_IDENTIFIER:
    ret = soc_pb_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_PPH_LIBRARIES
  case PPH_MODULE_IDENTIFIER:
    ret = pph_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_OAM_LIBRARIES
  case OAM_MODULE_IDENTIFIER:
    ret = oam_disp_result(err_id,error_txt);
    break;
  #endif
  #ifdef LINK_PCP_LIBRARIES
  case PCP_MODULE_IDENTIFIER:
    ret = pcp_disp_result(err_id,error_txt);
    break;
  #endif
  ...
  for ( cur_u32 = u32_val, u8_indx = 0; u8_indx < nof_bytes; ++u8_indx)
  {
    u8_val[u8_indx] = (uint8)
      SOC_SAND_GET_BITS_RANGE(
        *cur_u32,
        (cur_u8_indx + 1) * SOC_SAND_NOF_BITS_IN_BYTE,
        cur_u8_indx * SOC_SAND_NOF_BITS_IN_BYTE
       );
