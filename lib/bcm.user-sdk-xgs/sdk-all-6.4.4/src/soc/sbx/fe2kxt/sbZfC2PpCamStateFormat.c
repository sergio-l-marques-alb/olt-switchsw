...
#include "sbTypes.h"
#include "sbZfC2PpCamStateFormat.hx"
...
sbZfC2PpCamStateFormat_Pack(sbZfC2PpCamStateFormat_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PPCAMSTATEFORMAT_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2PPCAMSTATEFORMAT_SIZE_IN_BYTES;
}
...
sbZfC2PpCamStateFormat_Unpack(sbZfC2PpCamStateFormat_t *pToStruct,
  ...
  (pToStruct)->m_uResv1 =  (uint32)  (pFromData)[3] ;

  /* Unpack Member: m_bIngress */
  (pToStruct)->m_bIngress =  (uint8)  ((pFromData)[2] >> 7) & 0x01;

  /* Unpack Member: m_bEgress */
  (pToStruct)->m_bEgress =  (uint8)  ((pFromData)[2] >> 6) & 0x01;

  /* Unpack Member: m_bCycle0 */
  (pToStruct)->m_bCycle0 =  (uint8)  ((pFromData)[2] >> 5) & 0x01;

  /* Unpack Member: m_bCycle1 */
  (pToStruct)->m_bCycle1 =  (uint8)  ((pFromData)[2] >> 4) & 0x01;

  /* Unpack Member: m_uResv0 */
  (pToStruct)->m_uResv0 =  (uint8)  ((pFromData)[2] ) & 0x07;

  /* Unpack Member: m_uState */
  (pToStruct)->m_uState =  (uint32)  (pFromData)[1] ;
