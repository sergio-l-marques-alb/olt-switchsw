...
sbZfC2PmProfileSeqGenMemory_Print(sbZfC2PmProfileSeqGenMemory_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileSeqGenMemory:: type=0x%01x"), (unsigned int)  pFromStruct->uType));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" profmode=0x%01x"), (unsigned int)  pFromStruct->uProfMode));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" resv0=0x%02x"), (unsigned int)  pFromStruct->uResv0));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfileSeqGenMemory:: resv2=0x%08x"), (unsigned int)  pFromStruct->uResv2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
