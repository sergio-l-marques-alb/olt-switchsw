      ...
      char * filename) 
{
  ...
  res= cmd_dpp_diag_psd_get_table_data_for_signals_dump(unit);
  ...
  res= cmd_dpp_diag_psd_get_registers(unit, ++line_index );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_get_registers");

  /*unprinted info -start*/
  res= cmd_dpp_diag_psd_parse_signal( line_index    ,   "term2prge_tod_1588"     , 6, 0, 127, 64, 0);
  ...
  res= cmd_dpp_diag_psd_parse_signal( line_index   ,   "term2prge_tod_ntp"     , 6, 0, 63, 0, 0);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_get_gen_header(++line_index);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_get_gen_header");

  res= cmd_dpp_diag_psd_parse_signal( ++line_index  , "sys_headers_size" , 9, 0, 31, 25, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index  , "nwk_headers_size" ,9 ,1 ,64, 58, 1  );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index  , "ees_data_action1" , 9, 2, 140, 85, 1);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index  , "ees_data_action2" , 9, 2, 84, 29, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index  , "prge_tm_port_var" , 9, 0, 98, 67, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "prge_pp_port_var" , 9, 0, 134, 103, 1);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "post_pro_data"    , 9, 0, 245, 153, 1);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");

  /*garbage start - dumping zeroes */
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "program_index"    , 0, 0, 0,    1, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  /*garbage end*/

  res= cmd_dpp_diag_psd_get_original_packet( unit, ++line_index);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_get_original_packet");

  /*garbage start - dumping zeroes */
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "bypass_data"      , 0, 0, 0,   15, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  /*garbage end*/

  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "oam_counter_value", 9, 1, 57, 26, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "dst_system_port"  , 9, 2, 157, 142, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "src_system_port"  , 9, 0, 55, 40, 1);
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "out_tm_port"      , 9, 0, 253, 246, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_get_out_pp_port(++line_index);
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "oam_id"           , 9, 1, 25, 9, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "oam_sub_type"     , 9, 1, 8, 6, 1  );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "ace_variable"     , 9, 2, 166, 159, 1  );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "vsi_variable"     , 9, 0, 23, 0, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
  ...
  res= cmd_dpp_diag_psd_parse_signal( ++line_index , "prge_out_lif"     , 9, 0, 150, 135, 1 );
  IF_CMD_ERROR_GOTO_EXIT(res, "cmd_dpp_diag_psd_parse_signal");
     ...
     int write_to_file)
{
    ...
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  prm_addr_msb,  prm_addr_lsb,  prm_fld_msb,  prm_fld_lsb, regs_val);
    ...
    )
{
    ...
    /*recieving signal raw data - to regs_val*/
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  10,  0,  255,  166, regs_val);              /*prge2post_gen_header_s [89 : 0]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    ...
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  10,  1,  255,  0, regs_val);                /*prge2post_gen_header_s [345 : 90]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    full_regs_amount = 256 / 32 ;
    bit_res_old = cmd_dpp_diag_psd_get_gen_header_line( full_regs_amount, bit_res_old, bit_res_amount ) ;

    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  10,  2,  255,  0, regs_val);                /*prge2post_gen_header_s [601 : 346]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    full_regs_amount = 256 / 32 ;
    bit_res_old = cmd_dpp_diag_psd_get_gen_header_line( full_regs_amount, bit_res_old, bit_res_amount ) ;

    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  10,  3,  165,  0, regs_val);                /*prge2post_gen_header_s [767 : 602]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    ...
    )
{
    ...
    if (tbl_data.register_src == 1) {   /* PP mode*/
        ...
        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  1,  71,  65, regs_val);     /*link2prge_link_layer_size [6 : 0]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        R0=regs_val[0];

        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  0,  62,  56, regs_val);     /*link2prge_second_enc_size [6 : 0]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        R1=regs_val[0]+R0; /*not concatenation*/

        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  2,  26,  20, regs_val);     /*link2prge_first_enc_size [6 : 0]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        R2=regs_val[0]+R1; 

        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  2,  19,  13, regs_val);     /*link2prge_fwd_headers_size [6 : 0]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        R3=regs_val[0]+R2; 
        }
        ...
        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  2,  158,  158, regs_val);   /*link2prge_dsp_ext_exist [0 : 0]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        ...
        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  0,  152,  152, regs_val);   /*link2prge_pph_type [1 : 1]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        oam_ts_exists = regs_val[0] ;
        R2 = R1 + oam_ts_exists*6 ;

        rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  0,  31,  25, regs_val);     /*link2prge_sys_headers_size [6 : 0]*/
        IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
        R3=regs_val[0];
    ...
    )
{
    ...
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  0,  255,  254, regs_val); /*link2prge_out_pp_port [1 : 0]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");

    lsb = regs_val[0];

    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  9,  1,  5,  0, regs_val);     /*link2prge_out_pp_port [7 : 2]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    ...
    )
{
    ...
    rv = soc_ppd_diag_received_packet_info_get(unit, &info);
    IF_ERROR_EXIT(rv,"soc_ppd_diag_received_packet_info_get");

    packet_header = info.packet_header;

    rv = arad_pp_diag_get_raw_signal( ARAD_IHB_ID,  12,  2,  252,  246, regs_val); /*lbp2dbg_ire_eq_bytes_to_strip [6 : 0]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    bytes_to_remove = regs_val[0];

    rv = arad_pp_diag_get_raw_signal( ARAD_IHB_ID,  12,  2,  255,  253, regs_val); /*lbp2dbg_ire_eq_bytes_to_prepend [2 : 0]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    bytes_to_add = regs_val[0];
    
    rv = arad_pp_diag_get_raw_signal( ARAD_IHB_ID,  12,  3,  2,  0, regs_val);     /*lbp2dbg_ire_eq_bytes_to_prepend [5 : 3]*/
    IF_ERROR_EXIT(rv,"arad_pp_diag_get_raw_signal");
    ...
    if (bits_to_add == 0) {
        ...
        rv = arad_pp_diag_get_raw_signal( ARAD_IHB_ID,  12,  2,  245, ( 246 - bits_to_add ) , regs_val);                 /*lbp2dbg_ire_eq_header_data*/
        IF_ERROR_GOTO_EXIT(rv,"arad_pp_diag_get_raw_signal");

        res= cmd_dpp_diag_psd_update_ftmh_base(bits_to_add);
        ...
        rv = arad_pp_diag_get_raw_signal( ARAD_IHB_ID,  12,  2,  245, 0 , regs_val);                                     /*lbp2dbg_ire_eq_header_data [447 : 202]*/
        IF_ERROR_GOTO_EXIT(rv,"arad_pp_diag_get_raw_signal");
        ...
        rv = arad_pp_diag_get_raw_signal( ARAD_IHB_ID,  12,  1,  255, ( 256 - ( bits_to_add - 246 )) , regs_val);        /*lbp2dbg_ire_eq_header_data */
        IF_ERROR_GOTO_EXIT(rv,"arad_pp_diag_get_raw_signal");
    ...
    )
{
    ...
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  11,  0,  34,  30, regs_val);    /*epe2mems_prge_instruction0_eq_addr_s [4 : 0]*/
    IF_ERROR_EXIT(rv, "arad_pp_diag_get_raw_signal");
...
**********************************************************************/
cmd_result_t
cmd_dpp_diag_psd_update_ftmh_base(int bits_to_add){
    int
        ftmh_base_offset,
    ...
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  2,  1,  63,  50, inner_regs_val);       /*parser_system_headers_packet_size [13 : 0]*/
    IF_ERROR_EXIT(rv, "arad_pp_diag_get_raw_signal");
    packet_size = inner_regs_val[0];
    cmd_dpp_diag_psd_update_ftmh_base_field(packet_size, 58, 71, ftmh_base_offset);

    /*8 bits pp_dsp - 38:31*/
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  2,  1,  30,  23, inner_regs_val);       /*parser_system_headers_dsp_ptr [7 : 0]*/
    IF_ERROR_EXIT(rv, "arad_pp_diag_get_raw_signal");
    pp_dsp = inner_regs_val[0];
    cmd_dpp_diag_psd_update_ftmh_base_field(pp_dsp, 31, 38, ftmh_base_offset);

    /*2 bits tm_action - 28:27*/
    rv = arad_pp_diag_get_raw_signal( ARAD_EPNI_ID,  2,  1,  20,  19, inner_regs_val);       /*parser_system_headers_tm_action_type [1 : 0]*/
    IF_ERROR_EXIT(rv, "arad_pp_diag_get_raw_signal");
