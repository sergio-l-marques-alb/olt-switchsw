/* $Id: ui_ppd_api_lag.c,v 1.6 Broadcom SDK $
...
{   
  ...
  SOC_PPD_LAG_INFO_clear(&prm_lag_info);
...
{   
  ...
  SOC_PPD_LAG_INFO_print(&prm_lag_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_LAG_MEMBER_clear(&prm_member);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_LAG_HASH_GLOBAL_INFO_clear(&prm_glbl_hash_info);
...
{   
  ...
  SOC_PPD_LAG_HASH_GLOBAL_INFO_print(&prm_glbl_hash_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_LAG_HASH_PORT_INFO_clear(&prm_lag_hash_info);
...
{   
  ...
  SOC_PPD_LAG_HASH_PORT_INFO_print(&prm_lag_hash_info);
...
{   
  ...
  unit = soc_ppd_get_default_unit(); 
  SOC_PPD_HASH_MASK_INFO_clear(&prm_mask_info);
...
{   
  ...
  SOC_PPD_HASH_MASK_INFO_print(&prm_mask_info);
