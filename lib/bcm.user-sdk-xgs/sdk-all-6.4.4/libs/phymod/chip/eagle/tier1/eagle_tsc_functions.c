 ...
 *  Revision      :  $Id: eagle_tsc_functions.c 820 2014-12-09 00:28:00Z kirand $  *
 *                                                                                 *
...
extern err_code_t eagle_tsc_uc_lane_idx_to_system_id(char *string , uint8_t uc_lane_idx);
...
err_code_t eagle_tsc_display_core_config( const phymod_access_t *pa ) {
  ...
  USR_MEMSET(&core_cfg, 0, sizeof(struct eagle_tsc_uc_core_config_st));
...
err_code_t eagle_tsc_read_die_temperature_double ( const phymod_access_t *pa, USR_DOUBLE *die_temp) {
    ...
    *die_temp = 410.04-0.48705*die_temp_sensor_reading; 
