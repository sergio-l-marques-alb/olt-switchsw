 ...
 *  Revision      :  $Id: eagle_pll_config.c 661 2014-08-14 23:20:49Z kirand $ *
 *                                                                             *
...
err_code_t eagle_tsc_configure_pll( const phymod_access_t *pa, enum eagle_tsc_pll_enum pll_cfg) { 
  ...
  switch (pll_cfg) {
    ...
    /* 5.0G mode NOT verified */  
    /* case EAGLE_TSC_pll_div_32x : */
    /*   pll_mode<3:0> = 0111, VCO = 5.0G, Refclk = 156.25MHz  */
    /*   wrc_pll_mode(0x7); */
    /*   break;  */
  
    /* 3.125G mode NOT verified */  
    /* case EAGLE_TSC_pll_div_20x : */
    /*   pll_mode<3:0> = 0100, VCO = 3.125G, Refclk = 156.25MHz  */
    /*   wrc_pll_mode(0x4); */
    /*   break;  */
    ...
    case EAGLE_TSC_pll_div_82p5x :         /* Divider value 82.5, VCO = 10.3125G, Refclk = 125MHz */
    ...
    case EAGLE_TSC_pll_div_87p5x :         /* Divider value 87.5, VCO = 10.9375G, Refclk = 125MHz */
    ...
    case EAGLE_TSC_pll_div_73p6x :         /* Divider value 73.6, VCO = 11.5G, Refclk = 156.25MHz */
    ...
    case EAGLE_TSC_pll_div_199p04x :       /* Divider value 199.04, VCO = 9.952G, Refclk = 25MHz */
