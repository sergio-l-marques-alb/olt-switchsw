...
/* HW Definitions */
static bcm_xgs5_bfd_hw_defs_t    bcm_td2_bfd_hw_defs;
...
bcmi_td2_bfd_init(int unit)
{
    ...
    bcm_td2_bfd_hw_defs.hw_call   = &bcm_td2_bfd_hw_calls;
    bcm_td2_bfd_hw_defs.l2        = &bcm_td2_bfd_l2_table;
    bcm_td2_bfd_hw_defs.l3_ipv4   = &bcm_td2_bfd_l3_ipv4_table;
    bcm_td2_bfd_hw_defs.l3_ipv6   = &bcm_td2_bfd_l3_ipv6_table;
    bcm_td2_bfd_hw_defs.l3_tunnel = &bcm_td2_bfd_l3_tunnel_table;
    bcm_td2_bfd_hw_defs.mpls      = &bcm_td2_bfd_mpls_table;

    /* Initialize Common XGS5 BFD module */
    BCM_IF_ERROR_RETURN
        (bcmi_xgs5_bfd_init(unit, &bcm_td2_bfd_drv, &bcm_td2_bfd_hw_defs));

    return BCM_E_NONE;
}

#else   /* BCM_TRIDENT2_SUPPORT && INCLUDE_BFD */
int bcm_esw_td2_bfd_not_empty;
