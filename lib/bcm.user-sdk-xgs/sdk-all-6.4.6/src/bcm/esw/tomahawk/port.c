...
/*
 * Function    : _bcm_th_flexport_based_speed_set
 * Description : Helper function for bcm_esw_port_speed_set, used
 *               to invoke the flexport sequence to set port speed
 * Parameters  :
 *               unit  (IN)
 *               port  (IN)
 *               speed (IN)
 * Returns     : BCM_E_XXX
 * Note        : Caller needs to ensure soc_feature_flexport_based_speed_set
 *               is defined, and verify that port is disabled
 */
bcm_error_t
_bcm_th_flexport_based_speed_set(int unit, bcm_port_t port, int speed)
{
    ...
    SOC_IF_ERROR_RETURN(soc_tomahawk_port_lanes_set(unit, &lanes_ctrl));
    ...
    /* Update port ASF setting */
    BCM_IF_ERROR_RETURN(soc_th_port_asf_mode_set(unit, port, speed,
