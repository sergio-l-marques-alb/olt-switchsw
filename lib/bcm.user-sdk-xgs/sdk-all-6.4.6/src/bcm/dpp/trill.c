...
int _bcm_dpp_trill_get_vsi_info(
    ...
    *vsi_info = NULL;
    vsi_id = vsi;
    rv = _bcm_dpp_trill_sw_db_hash_trill_vpn_find(unit, &vsi_id, (shr_htb_data_t*)(void *)vsi_info, FALSE);
...
int bcm_petra_trill_vpn_destroy(
    ...
    vsi_id = vpn;
    rv = _bcm_dpp_trill_sw_db_hash_trill_vpn_find(unit, &vsi_id, (shr_htb_data_t*)(void *)&hash_info, TRUE);
    BCMDNX_IF_ERR_EXIT(rv);
...
int
_bcm_dpp_trill_sw_db_hash_mc_trill_find(int unit, shr_htb_key_t key, shr_htb_data_t *data, int remove)
{
    int rv = BCM_E_NONE;
...
int 
_bcm_dpp_trill_sw_db_hash_mc_trill_insert(int unit, shr_htb_key_t key, shr_htb_data_t data)
{
#ifdef BCM_WARM_BOOT_SUPPORT
    int rv = BCM_E_NONE;
#endif
...
int
_bcm_dpp_trill_sw_db_hash_trill_info_find(int unit, shr_htb_key_t key, shr_htb_data_t *data, int remove)
{
    int rv = BCM_E_NONE;
...
int 
_bcm_dpp_trill_sw_db_hash_trill_info_insert(int unit, shr_htb_key_t key, shr_htb_data_t data)
{
#ifdef BCM_WARM_BOOT_SUPPORT
    int rv = BCM_E_NONE;
#endif
...
int 
_bcm_dpp_trill_sw_db_hash_trill_vpn_insert(int unit, shr_htb_key_t key, shr_htb_data_t data)
{
#ifdef BCM_WARM_BOOT_SUPPORT
    int rv = BCM_E_NONE;
#endif
...
int
_bcm_dpp_trill_sw_db_hash_trill_vpn_find(int unit, shr_htb_key_t key, shr_htb_data_t *data, int remove)
{
    int rv = BCM_E_NONE;
...
int
_bcm_dpp_trill_sw_db_hash_trill_info_iterate(int unit, shr_htb_cb_t restore_cb)
{
    int rv;
...
int
_bcm_dpp_trill_sw_db_hash_mc_trill_iterate(int unit, shr_htb_cb_t restore_cb)
{
    int rv;
...
int
_bcm_dpp_trill_sw_db_hash_trill_route_info_iterate(int unit, shr_htb_cb_t restore_cb)
{
    int rv;
...
int
_bcm_dpp_trill_sw_db_hash_trill_src_iterate(int unit, shr_htb_cb_t restore_cb)
{
    int rv;
...
int
_bcm_dpp_trill_sw_db_hash_trill_vpn_iterate(int unit, shr_htb_cb_t restore_cb)
{
    int rv;
