...
struct cint_fifo_type_test_s {
    ...
    int is_fe13;
    int fe1_threshold_values[9];
    int fe3_threshold_values[9];
    bcm_fabric_link_threshold_type_t threshold_types[9];
...
int cint_flow_control_fe3200_init_fifo_types(int unit, cint_fifo_type_test_s* fifo_types, int is_fe13)
{
    ...
    fifo_types[1].nof_thresholds_configured = 9;
    ...
    fifo_types[2].nof_thresholds_configured = 9;
...
int cint_flow_control_fe3200_retrieve_links_and_compare(int unit)
{
    ...
    int links_arr1[144];
    int rv, links_type_0, links_type_1, i;
...
{
    int i, j, rv, k ;
    int threshold_values_configured_fe1[9];
    int threshold_values_configured_fe3[9];
