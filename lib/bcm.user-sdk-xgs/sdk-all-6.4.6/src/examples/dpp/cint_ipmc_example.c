...
int add_ip4mc_entry(int unit, bcm_ip_t mc_ip, bcm_ip_t src_ip, int vlan, bcm_multicast_t mc_id){
	...
	/* Creates the entry */
    /*use add_ip4mc_sip_prefix_entry with full sip mask*/
	rv = add_ip4mc_sip_prefix_entry(unit, mc_ip, src_ip, vlan, mc_id, 0xFFFFFFFF);
	if (rv != BCM_E_NONE) {
...
*   BEFORE you call this function)
*/
int add_ip4mc_sip_prefix_entry(int unit, bcm_ip_t mc_ip, bcm_ip_t src_ip, int vlan, bcm_multicast_t mc_id, bcm_ip_t s_ip_mask){
    bcm_error_t rv = BCM_E_NONE;
...
/* Main IPv4 MC Example with sip prefix parameter*/
int run_with_sip_prefix_ipv4_mc_example(int unit, int iport, int oport, int prefix_len, int nof_dest_ports, int ipmc_index){
    bcm_error_t rv = BCM_E_NONE;
    int ingress_intf;
    ...
    s_ip_mask = bcm_ip_mask_create(prefix_len);
    ...
    rv = add_ip4mc_sip_prefix_entry(unit, mc_ip, src_ip, vlan, mc_id, s_ip_mask);
