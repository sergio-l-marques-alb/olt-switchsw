...
{
  int result;
  uint32 fg_ndx, nof_fgs = 2, dq_ndx, nof_dqs = 8, dq_min[2] = {0, 4}, dq_max[2] = {3, 7};
  bcm_field_group_config_t grp[2];
  bcm_field_data_qualifier_t data_qual[8]; 
  bcm_field_qualify_t dq_qualifier[8] = {
      /* pre */ bcmFieldQualifyL4DstPort, bcmFieldQualifyL4SrcPort, bcmFieldQualifyDstIp, bcmFieldQualifySrcIp,
      /* post */ bcmFieldQualifyHashValue, bcmFieldQualifyInPort, bcmFieldQualifyConstantZero, bcmFieldQualifyDstTrunk /*mandatory after 47 bits*/};
  uint32 dq_length[8] = {16, 16, 32, 32,
                         32, 8, 7, 16};
  uint16 dq_offset[8] = {0, 0, 0, 0,
                         80 /* 4 CRCs of 16 bits and 1 XOR of 16 bits before in the hash value */, 0, 0, 0};
  int presel_id;
