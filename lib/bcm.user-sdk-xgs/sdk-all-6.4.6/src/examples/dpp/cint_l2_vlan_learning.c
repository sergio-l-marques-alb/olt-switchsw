 ...
 *  cint
 *  l2_vlan_learning_run(0, <port_1>, <port_2>);
 ...
 *  cint cint_l2_vlan_learning.c
 *  cint
 *  l2_per_vlan_learning_run(0, <port_1>, <port_2>);
 * 
 *  run packet 1:
 *      ethernet header with DA 33 and any SA
...
int
l2_learning_out_port_set(int oPort){
    outPort = oPort;
    return 0;
}
...
l2_per_vlan_learning_run(int unit, int port_1, int port_2){
    ...
    learn_msgs.dest_port = l2_learning_info.olp_port;
