/* $Id: ui_ppd_api_eg_vlan_edit.c,v 1.6 Broadcom SDK $
                                     ...
                                     )
{
  ...
  SOC_PPD_PEP_KEY_clear(&prm_pep_key);
  SOC_PPD_EG_VLAN_EDIT_PEP_INFO_clear(&prm_pep_info);
                                     ...
                                     )
{
  ...
  SOC_PPD_EG_VLAN_EDIT_PEP_INFO_print(&prm_pep_info);
  ...
  )
{
  ...
  SOC_PPD_EG_VLAN_EDIT_COMMAND_KEY
    prm_command_key;
  SOC_PPD_EG_VLAN_EDIT_COMMAND_INFO
    prm_command_info;
  ...
  unit = soc_ppd_get_default_unit();
  SOC_PPD_EG_VLAN_EDIT_COMMAND_KEY_clear(&prm_command_key);
  SOC_PPD_EG_VLAN_EDIT_COMMAND_INFO_clear(&prm_command_info);
  ...
  )
{
  ...
  SOC_PPD_EG_VLAN_EDIT_COMMAND_INFO_print(&prm_command_info);
  ...
  )
{
  ...
  uint32
    prm_pcp_profile_ndx;
  SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY
    prm_map_key;
  ...
  )
{
  ...
  */
  ...
  cli_out("prm_map_key: %s\n",SOC_PPD_EG_VLAN_EDIT_TAG_PCP_DEI_MAP_KEY_to_string(prm_map_key));
