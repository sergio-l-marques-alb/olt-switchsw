...
/*    int rc;  */
    ...
    SOCDNX_INIT_FUNC_DEFS;
     ...
     _bcm_dpp_oam_fifo_interrupt_handler(unit, JER_PP_OAM_API_DMA_EVENT_TYPE_EVENT); /* Ignore return value: clear interrupt no matter what the result.*/
 /*    BCMDNX_IF_ERR_EXIT(rc); */
goto exit;
exit:
    SOCDNX_FUNC_RETURN;
    ...
    char* msg)
{
    ...
    if (arad_tbl_is_dynamic(unit, ecc_1b_correct_info_p->mem)) {
