/*
 * $Id: g3p1_cmds.c,v 1.35.14.6 Broadcom SDK $
...
#include <soc/sbx/g3p1/g3p1_cop_diags.h>
...
cmd_result_t
cmd_sbx_g3p1_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_print(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
...
cmd_result_t
cmd_sbx_g3p1_set (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_set(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_delete (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_delete(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_global_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_print_globals(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_global_set (int unit, args_t *args)
{
    int rv;
    char *p;
    ...
    rv = soc_sbx_g3p1_shell_set_globals(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        p = ARG_GET(args);
...
cmd_result_t
cmd_sbx_g3p1_mem_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_print_memories(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_mem_set (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_set_memories(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_constant_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_shell_print_constants(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_tmu_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_tmu_shell_print(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_tmu_set (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_tmu_shell_set(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_tmu_delete (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_tmu_shell_delete(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_ppe_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_ppe_shell_print(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_ptable_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_ptable_shell_print(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_ppe_set (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_ppe_shell_set(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_ptable_set (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_ptable_shell_set(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_cmu_get (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cmu_shell_print(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_cmu_reset (int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cmu_shell_reset(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_policer_add(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_policer_add(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_policer_remove(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_policer_remove(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_policer_remove_all(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_policer_remove_all(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_timer_add(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_timer_add(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_timer_remove(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_timer_remove(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_timer_remove_all(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_timer_remove_all(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_sequencer_add(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_sequencer_add(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_sequencer_remove(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_sequencer_remove(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_sequencer_remove_all(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_sequencer_remove_all(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {       
...
cmd_result_t
cmd_sbx_g3p1_coherent_table_add(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_coherent_table_add(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_coherent_table_remove(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_coherent_table_remove(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_coherent_table_remove_all(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_coherent_table_remove_all(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_coherent_table_get(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_coherent_table_get(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t
cmd_sbx_g3p1_coherent_table_set(int unit, args_t *args)
{
    int rv;
    ...
    rv = soc_sbx_g3p1_cop_shell_coherent_table_set(unit, ARG_CNT(args), &_ARG_CUR(args));
    if (rv == SOC_E_NONE) {
        ARG_DISCARD(args);
        rv = CMD_OK;
    } else if (rv == SOC_E_PARAM) {
...
cmd_result_t 
_cmd_g3p1_util_constants(int unit, args_t *args)
{
    int i;
    ...
    if (ARG_CNT(args)) {
        ...
        for (i = 0; i < SOC_SBX_G3P1_CONSTANT_MAX_ID; i++) {
            ...
            rv = soc_sbx_g3p1_constant_get(unit, tm->constants[i].name,
                                           &constVal);
            if (SOC_SUCCESS(rv)) {
                if (value == constVal) {
...
char cmd_sbx_g3p1_util_usage[] =
"Usage:\n"
"  32p1util help               - displays this messge\n"
"  g3p1util constants [val]             - displays G3P1 constant names matching an integer value, all if no value supplied\n"
"  g3p1util route [add|delete] [params] - Add or delete Ipv4 routes\n"
"  g3p1util field [add|delete] [params] - Add or delete field entries\n"
"  g3p1util allocator                   - displays G3P1 SDK table allocations\n";

cmd_result_t 
_cmd_g3p1_util_route(int unit, args_t *args)
{
    char            *subcmd;
    char            *cmd;
    uint32          c3_unit = 0;
    ...
    if ((sal_strcasecmp(subcmd, "add") == 0) || 
      (sal_strcasecmp(subcmd, "delete") == 0)) {
        ...
        while ((cmd = ARG_GET(args)) != NULL) {
            if (!sal_strncasecmp(cmd, "c3-unit", sal_strlen("c3-unit"))) {
                ...
                if (fte_count >= 12) {
                    cli_out("Too many fte entries, max is twelve\n");
                    return CMD_FAIL;
                }
                cmd += sal_strlen("fte") + 1;
                fte[fte_count++] = strtoul(cmd, NULL, 0);
            } else if (!sal_strncasecmp(cmd, "vrf", sal_strlen("vrf"))) {
                cmd += sal_strlen("vrf") + 1;
                vrf = strtoul(cmd, NULL, 0);
            }
            
        }

        cli_out("c3-unit: %u, ", c3_unit);
        cli_out("route-start: 0x%8.8x, ", route_start);
        cli_out("route-mask: 0x%8.8x, ", route_mask);
        cli_out("route-flags: 0x%8.8x, ", route_flags);
        cli_out("route-inc: %u, ", route_inc);
        cli_out("route-count: %u, ", route_count);
        cli_out("batch-size: %u, ", batch_size);
        cli_out("fte-count: %u, ", fte_count);
        cli_out("vrf: %u, ", vrf);
        ...
        for (i = 0; i < route_count; i++) {
            ...
            {
               rc = bcm_l3_route_delete(c3_unit, &route);
            }
            else
            {
            ...
            if (rc != BCM_E_NONE) {
                ...
                if(sal_strcasecmp(subcmd, "delete") == 0)
                {
                    cli_out("Failed to delete route %d: %s\n", i, bcm_errmsg(rc));
                }
                else
                {
                ...
                if(sal_strcasecmp(subcmd, "delete") == 0)
                {
                    cli_out("Deleted %u routes in %u micro-seconds, %f routes per second\n",
...
void _mac_fill(uint8 *out, uint64 in)
{
    int     i;
...
void _printk_mac(char *prefix, uint8 *mac, char *postfix)
{
    int     i;
...
cmd_result_t 
_cmd_g3p1_util_field(int unit, args_t *args)
{
    char                *subcmd;
    char                *cmd;
    uint32              c3_unit = 0;
...
cmd_result_t
cmd_sbx_g3p1_util(int unit, args_t *a)
{
    char *cmd, *subcmd;
    ...
    if (sbx->ucodetype != SOC_SBX_UCODE_TYPE_G3P1) {
        cli_out("ERROR: not running g3p1 microcode\n");
        return CMD_FAIL;
    }
...
char soc_sbx_g3p1_rce_get_usage[] = 
"\n"
"g3p1rceget all \n"
"g3p1rceget {ifp|efp} all\n"
"g3p1rceget {ifp|efp} <groupId> all \n"
"g3p1rceget {ifp|efp} <groupId> <entryId> \n"
;

cmd_result_t
cmd_sbx_g3p1_rce_get (int unit, args_t *args)
{
    int group_result = 0;
    int entry_result = 0;
    ...
    if (argc > 1) {
        group_result = soc_sbx_g3p1_read(argv[1], -1, &groupId);
    }

    if (argc > 2) {
        entry_result = soc_sbx_g3p1_read(argv[2], -1, &entryId);
    }

    if (!sal_strcasecmp(argv[0], "ifp")) {
        programId = 0;
    } else if (!sal_strcasecmp(argv[0], "efp")) {
        programId = 1;
    } else if (!sal_strcasecmp(argv[0], "all")) {
        _show_rce(unit);
        ARG_DISCARD(args);
        return CMD_OK;
    } else {
...
char soc_sbx_g3p1_taps_prefix_search_usage[] = "\n"
" PrefixSearch \n"
    "Search PVV: pvv port=<port> vlan1=<vlan1> vlan2=<vlan2>\n"
    "       V4:  v4 ipv4=<ipv4> ipv4mask=<ipv4mask> vrf=<vrf> dest=<0|1>\n"
    "       V6:  v6 ipv6=<ipv6> ipv6mask=<ipv6mask> vrf=<vrf> dest=<0|1>\n"
" taps to specify a taps object pointer \n"
" Search a specified prefix and dump the data \n";

cmd_result_t 
cmd_sbx_g3p1_taps_prefix_search(int unit, args_t *args)
{
    int rv;
    int vrf = 0;
    int is_dest_table = 0, is_pvv = 0, is_ipv4 = 0, is_ipv6 = 0;
    int port = 0, outer_vlan = 0, inner_vlan = 0;
    int ip_len = 0;
    ip_addr_t ipaddr = 0, ip4mask = 0;
    ...
    soc_sbx_g3p1_state_t *fe = NULL;
    soc_sbx_g3p1_tmu_table_manager_t *tm = NULL;
    soc_sbx_g3p1_entry_desc_t *ed  COMPILER_ATTRIBUTE((unused));

    parse_table_t pt;

    ed = NULL;
    sal_memset(key, 0, TAPS_MAX_KEY_SIZE_WORDS * sizeof(uint32));
    sal_memset(payload, 0, 32 * sizeof(uint32));
    ...
    parse_table_add(&pt, "ovlan", PQ_DFL | PQ_INT, 0, &outer_vlan, NULL);
    parse_table_add(&pt, "ivlan", PQ_DFL | PQ_INT, 0, &inner_vlan, NULL);
    parse_table_add(&pt, "pvv", PQ_DFL|PQ_BOOL|PQ_NO_EQ_OPT, 0, &is_pvv, NULL);
    parse_table_add(&pt, "ipv4", PQ_DFL | PQ_IP,  0, &ipaddr, NULL);
    parse_table_add(&pt, "ipv6", PQ_DFL | PQ_IP6, 0, &ip6addr, NULL);
    parse_table_add(&pt, "ipv4mask", PQ_DFL | PQ_IP,  0, &ip4mask,   NULL);
    parse_table_add(&pt, "ipv6mask", PQ_DFL | PQ_IP6, 0, &ip6mask,   NULL);
    parse_table_add(&pt, "vrf", PQ_DFL | PQ_INT, 0, &vrf, NULL);
    parse_table_add(&pt, "v4", PQ_DFL|PQ_BOOL|PQ_NO_EQ_OPT, 0, &is_ipv4, NULL);
    parse_table_add(&pt, "v6", PQ_DFL|PQ_BOOL|PQ_NO_EQ_OPT, 0, &is_ipv6, NULL);
    parse_table_add(&pt, "dest", PQ_DFL|PQ_BOOL|PQ_NO_EQ_OPT, 0, &is_dest_table, NULL);
#ifdef PTRS_ARE_64BITS
    parse_table_add(&pt, "taps", PQ_DFL | PQ_INT64, 0, &taps, NULL);
#else
    parse_table_add(&pt, "taps", PQ_DFL | PQ_INT, 0, &taps, NULL);
#endif
    ...
    tm = fe->tmu_mgr;
    if (is_pvv) {
        /* Searching in PVV table */
        ed = &tm->entries[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID];
        key[0] = 0;
        key[1] = (port << 24) | (outer_vlan << 12) | inner_vlan;
        arg.key = &key[0];
        arg.length = TAPS_IPV4_KEY_SIZE;
        arg.taps = tm->tables[SOC_SBX_G3P1_TMU_PVV2E_TABLE_ID].taps;
        arg.payload = &payload[0];
        if (taps) {
            arg.taps = (taps_handle_t)taps;            
            if (arg.taps->param.key_attr.type != TAPS_IPV4_KEY_TYPE) {
                cli_out("%s, specified taps handle key type not matching pvv option\n",FUNCTION_NAME());
                return SOC_E_PARAM;
            }
        }

        /* Print prefix infor and get the payload */
        rv = taps_prefix_search_and_dump(unit, &arg);
        if (SOC_FAILURE(rv)) {
            cli_out("%s, Fail to search key in pvv table \n",FUNCTION_NAME());
            return rv;
        }
    } else if (is_ipv4) {
        
        ip_len = bcm_ip_mask_length(ip4mask);
        arg.length = ip_len + TAPS_IPV4_MAX_VRF_SIZE;
        if (is_dest_table) {
            /* Searching is in IPV4 DA table*/
            ed = &tm->entries[SOC_SBX_G3P1_TMU_V4DA_TABLE_ID];
            arg.taps = tm->tables[SOC_SBX_G3P1_TMU_V4DA_TABLE_ID].taps;
        } else {
            /* Searching is in IPV4 SA table*/
            ed = &tm->entries[SOC_SBX_G3P1_TMU_V4SA_TABLE_ID];
            arg.taps = tm->tables[SOC_SBX_G3P1_TMU_V4SA_TABLE_ID].taps;
        }
        if (taps) {
            arg.taps = (taps_handle_t)taps;            
            if (arg.taps->param.key_attr.type != TAPS_IPV4_KEY_TYPE) {
                cli_out("%s, specified taps handle key type not v4 option \n",FUNCTION_NAME());
                return SOC_E_PARAM;
            }
        }
        ...
        rv = taps_key_shift(TAPS_IPV4_KEY_SIZE, key, 
                        arg.length, TAPS_IPV4_KEY_SIZE - arg.length);
        if (SOC_FAILURE(rv)) {
            cli_out("%s, Fail to shift ipv4 key \n",FUNCTION_NAME());
            return rv;
        }
        ...
        rv = taps_prefix_search_and_dump(unit, &arg);
        if (SOC_FAILURE(rv)) {
            cli_out("%s, Fail to search key in v4 table \n",FUNCTION_NAME());
            return rv;
        }
    } else if (is_ipv6) {
        ip_len = bcm_ip6_mask_length(ip6mask);

        if (is_dest_table) {
            /* Searching is in IPV6 DA table*/
            ed = &tm->entries[SOC_SBX_G3P1_TMU_V6DA_TABLE_ID];
            arg.taps = tm->tables[SOC_SBX_G3P1_TMU_V6DA_TABLE_ID].taps;
        } else {
            /* Searching is in IPV6 SA table*/
            ed = &tm->entries[SOC_SBX_G3P1_TMU_V6SA_TABLE_ID];
            arg.taps = tm->tables[SOC_SBX_G3P1_TMU_V6SA_TABLE_ID].taps;
        }
        if (taps) {
            arg.taps = (taps_handle_t)taps;            
            if (arg.taps->param.key_attr.type != TAPS_IPV6_KEY_TYPE) {
                cli_out("%s, specified taps handle key type not v6 option \n",FUNCTION_NAME());
                return SOC_E_PARAM;
            }
        }
        
        key[0] = vrf;
        sal_memcpy(&key[1], ip6addr, sizeof(uint32));
        sal_memcpy(&key[2], ip6addr+4, sizeof(uint32));
        sal_memcpy(&key[3], ip6addr+8, sizeof(uint32));
        sal_memcpy(&key[4], ip6addr+12, sizeof(uint32));
        arg.key = &key[0];
        arg.length = ip_len + TAPS_IPV6_MAX_VRF_SIZE;
        arg.payload = &payload[0];
        rv = taps_key_shift(TAPS_IPV6_KEY_SIZE, key,
             TAPS_IPV6_KEY_SIZE, TAPS_IPV6_KEY_SIZE - arg.length);
        if (SOC_FAILURE(rv)) {
            cli_out("Fail to shift ipv6 key \n");
            return rv;
        }
        /* Print prefix infor and get the payload */
        rv = taps_prefix_search_and_dump(unit, &arg);
        if (SOC_FAILURE(rv)) {
            cli_out("%s, Fail to search key in v6 table \n",FUNCTION_NAME());
            return rv;
        }
    } else {
        return CMD_USAGE;
