...
enable_dynamic_memories_access(int unit)
{
  ...
  soc_reg_above_64_val_t write_val_above64;
    ...
    {
         _SOC_IF_ERR_EXIT(WRITE_CFC_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_CGM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_DDP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_DQM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_FCR_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_IEP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_ILB_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit, REG_PORT_ANY , write_val));
         _SOC_IF_ERR_EXIT(WRITE_IMP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_IPSEC_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_ITE_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_KAPS_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_NBIH_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_NBIL_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit, REG_PORT_ANY , write_val));
         _SOC_IF_ERR_EXIT(WRITE_PEM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_PTS_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_SPB_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_SQM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_TAR_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_TXQ_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
    ...
    if (SOC_IS_JERICHO(unit)) {
         _SOC_IF_ERR_EXIT(WRITE_SCH_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , REG_PORT_ANY, write_val));
         _SOC_IF_ERR_EXIT(WRITE_RTP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_IHP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , SOC_CORE_ALL, write_val));
         _SOC_IF_ERR_EXIT(WRITE_FDT_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val)); 
         _SOC_IF_ERR_EXIT(WRITE_PPDB_A_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_PPDB_B_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_ECI_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_MMU_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_OAMP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_EDB_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         if (!SOC_IS_QAX(unit)) {
         _SOC_IF_ERR_EXIT(WRITE_ILKN_PMH_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit, REG_PORT_ANY , write_val));
         _SOC_IF_ERR_EXIT(WRITE_IPST_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_ILKN_PML_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , REG_PORT_ANY, write_val));
         _SOC_IF_ERR_EXIT(WRITE_IQMT_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_FDA_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_MRPS_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
         _SOC_IF_ERR_EXIT(WRITE_FSRD_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , REG_PORT_ANY, write_val));
         }
    }
...
disable_ecc_disable_dynamic_mechanism(int unit)
{
  ...
  DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 105,  WRITE_OLP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit,write_val));
  if (!SOC_IS_QAX(unit)) {
     DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IQM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit, REG_PORT_ANY, write_val));
      DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IDR_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit,write_val)); 
      DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IPT_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit,write_val));
      DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IRR_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit,write_val));
  }
  else
  {
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_CFC_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_CGM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_DDP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_DQM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_FCR_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IEP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_ILB_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit, REG_PORT_ANY , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IMP_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_IPSEC_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_ITE_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_KAPS_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_NBIH_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_NBIL_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit, REG_PORT_ANY , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_PEM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_PTS_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_SPB_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_SQM_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_TAR_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
       DISABLE_ECC_SOC_SAND_IF_ERROR_RETURN(res, 10, WRITE_TXQ_ENABLE_DYNAMIC_MEMORY_ACCESSr(unit , write_val));
...
mem_flipflop_test(int unit, args_t *a, void *pa)
{
   ...
   help_status = 0;
        ...
        parse_table_add(&pt, "StartFrom",        PQ_DFL|PQ_INT,    &default_start_from,                          &tr8_data.start_from,           NULL); 
...
int ser_test(int unit, args_t *arg, void *p) {
    ...
    if (test_params->mem != INVALIDm) {
        if (test_params->inject_only == TRUE) {
            ...
            if (SOC_FAILURE(rv)) {
                cli_out("Error during ser test mem.\n");
            }
        }
    } else {
        if (test_params->inject_only == TRUE) {
