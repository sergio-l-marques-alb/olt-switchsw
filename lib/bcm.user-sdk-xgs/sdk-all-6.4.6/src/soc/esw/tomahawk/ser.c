...
#define _SOC_IDB_OBM_NUM_DISABLE_REGS 10
    ...
    case IDB_OBM0_QUEUE_ECC_STATUSr:
        obm_queue_num = 0 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM1_QUEUE_ECC_STATUSr:
        obm_queue_num = 1 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM2_QUEUE_ECC_STATUSr:
        obm_queue_num = 2 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM3_QUEUE_ECC_STATUSr:
        obm_queue_num = 3 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM4_QUEUE_ECC_STATUSr:
        obm_queue_num = 4 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM5_QUEUE_ECC_STATUSr:
        obm_queue_num = 5 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM6_QUEUE_ECC_STATUSr:
        obm_queue_num = 6 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    case IDB_OBM7_QUEUE_ECC_STATUSr:
        obm_queue_num = 7 * _SOC_IDB_OBM_NUM_DISABLE_REGS;
        break;
    default:
        return SOC_E_PARAM;
    }
    ...
    for (i = 0; i < _SOC_IDB_OBM_NUM_DISABLE_REGS; i++) {
        soc_reg_t reg = idb_obm_reg_list[obm_queue_num + i];
        if (!SOC_REG_IS_VALID(unit, reg)) {
            continue;
        }
...
soc_th_ser_mem_mode_get(int unit, soc_mem_t mem, int *mem_mode)
{
    ...
    case SOC_E_INIT: /* BCM_E_INIT: field module is de-initialized */
        LOG_VERBOSE(BSL_LS_SOC_SER,
            (BSL_META_U(unit,
                        "unit %d, field_slice_mode_get failed: mem %s "
