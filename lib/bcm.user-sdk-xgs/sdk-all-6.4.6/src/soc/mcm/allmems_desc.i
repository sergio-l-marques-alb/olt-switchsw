 ...
 */
    ...
    /* CFMTRAP                   */ "",
    /* CGM_CNI_PRMS              */ "CNI (Congestion Notification Indication) WRED and drop threshold table. __REGGEN_NL__ Accessed by Q's Rate-Class during DEQUEUE process, to define the CNI indication of the packet. __REGGEN_NL__ Note: the table does not define packet reject options. __REGGEN_NL__",
    /* CGM_CNI_STATUS            */ "CNI (Congestion Notification Indication) WRED and drop threshold table. __REGGEN_NL__ Accessed by Q's Rate-Class during DEQUEUE process, to define the CNI indication of the packet. __REGGEN_NL__ Note: the table does not define packet reject options. __REGGEN_NL__",
    ...
    /* CGM_ETH_MTR_PTR_MAP       */ "Packet Queue Descriptor Static bits",
    /* CGM_GLBL_FR_DRAM_RJCT_TH  */ "",
    /* CGM_GLBL_FR_SRAM_RJCT_TH  */ "",
    /* CGM_HAPM                  */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_IPPPM                 */ "In-PP-Port to NifPort (static) __REGGEN_NL__ Maps incoming PP-Port7:0 to VSQs",
    /* CGM_IPP_HCP               */ "Per In-PP-Port Credit Header-Compensation __REGGEN_NL__ Accessed by In-PP-Port",
    /* CGM_IRPP_CTR_CPM          */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_IRPP_CTR_HCM          */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_IS_ING_MC             */ "Packet Queue Descriptor Static bits",
    /* CGM_MRPS_IN_DP_MAPPING    */ "Maps dp-meter-cmd, incoming dp, Ethernet-meter-dp and Ethernet-meter-invalid to MRPS in-DP and in-Drop. __REGGEN_NL__ key to the table: __REGGEN_NL__ dp-meter-cmd, incoming-dp, Ethernet-meter-dp, Ethernet-meter-invalid __REGGEN_NL__",
    /* CGM_PB_VSQ_POOL_FC_TH     */ "access by HP, Pool",
    /* CGM_PB_VSQ_PRMS           */ "Rate class.  __REGGEN_NL__ VSQs: 72 -> 135 (MIXED) __REGGEN_NL__ VSQs: 136 -> 199 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_PB_VSQ_RJCT_MASK      */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_PB_VSQ_SRAM_BUFFERS_RJCT_MAP */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_PB_VSQ_SRAM_PDS_RJCT_MAP */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_PB_VSQ_WORDS_RJCT_MAP */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_PCM                   */ "PDM-Write-FIFO memory",
    /* CGM_PP_RJCT_MASK          */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_QSPM                  */ "",
    /* CGM_SCH_CPM               */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_SCH_HCM               */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_SNP_MRR_RJCT_TABLE    */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_SNP_MRR_TM_TABLE      */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_STAT_CPM              */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_STAT_HCM              */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    ...
    /* CGM_ST_PORT_DATA          */ "",
    /* CGM_SYS_RED_QSIZE_RANGES  */ "Source Q size range thresholds. __REGGEN_NL__ Defines 16 ranges of the instantaneous Qsizes that define the 4-bit System-Q-size value (per Q rate-class) __REGGEN_NL__ Qsize below QszRngThN is defined with source-Q-size N. __REGGEN_NL__ Note:Units of 16 bytes,the value is compared to the Qsize with maximal value of 2^2416 byte.",
    /* CGM_SYS_RED_RJCT_PRMS     */ "System Red parameters: defines the reject test parameters (per Q rate-class and Drop-p).",
    /* CGM_SYS_RED_SIZE          */ "",
    /* CGM_TAR_FIFO              */ "PDM-Write-FIFO memory",
    /* CGM_TAR_FIFO_RJCT_TH      */ "access by Tar-Fifo-Index, DP",
    /* CGM_TM_CTR_CPM            */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_TM_CTR_HCM            */ "Per VOQ Credit Header-Compensation __REGGEN_NL__ Accessed by VOQ.Credit-Class(4)",
    /* CGM_VOQ_AVRG_PRMS         */ "Packet Queue Red Weight table __REGGEN_NL__ (Per VOQ.Rate-Class)",
    /* CGM_VOQ_DRAM_BLOCK_STATE  */ "Packet Queue Descriptor Static bits",
    /* CGM_VOQ_DRAM_BOUND_PRMS   */ "Dram bound thresholds",
    /* CGM_VOQ_DRAM_BOUND_STATE  */ "",
    /* CGM_VOQ_GRNTD_PRMS        */ "Guaranteed Space Parameters (static) __REGGEN_NL__ The table containes the guaranteed space defined for each Q, in Bytes, Buffers and Bdbs. __REGGEN_NL__ Q bellow these thresholds will accept packets regardless to WRED decisions. __REGGEN_NL__ (per each Q's Rate-class5:0)",
    /* CGM_VOQ_GRNTD_RJCT_MASK   */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VOQ_HCP               */ "Per In-PP-Port Credit Header-Compensation __REGGEN_NL__ Accessed by In-PP-Port",
    /* CGM_VOQ_PROFILES          */ "Packet Queue Descriptor Static bits",
    /* CGM_VOQ_SHRD_OC_RJCT_TH   */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VOQ_SIZE              */ "Packet Queue Descriptor Dynamic fields",
    /* CGM_VOQ_SRAM_DRAM_ONLY_MODE */ "",
    /* CGM_VOQ_SRAM_PDS_RJCT_PRMS */ "Packet Queue Red parameters __REGGEN_NL__ Per Q Rate Class and Drop-p.",
    /* CGM_VOQ_SRAM_WORDS_RJCT_PRMS */ "Packet Queue Red parameters __REGGEN_NL__ Per Q Rate Class and Drop-p.",
    /* CGM_VOQ_VSQS_PRMS         */ "Map VOQ to VSQ-TC (for VSQ index generation)",
    /* CGM_VOQ_WORDS_RJCT_PRMS   */ "Packet Queue Red parameters __REGGEN_NL__ Per Q Rate Class and Drop-p.",
    /* CGM_VSQA_AVRG_PRMS        */ "Virtual Queue Descriptor Rate Class",
    /* CGM_VSQA_MAX_SIZE         */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 0 -> 3 (MIXED) __REGGEN_NL__ VSQs: 4 -> 7 (OCB-Only)",
    /* CGM_VSQA_PRMS             */ "Virtual Queue Descriptor Rate Class",
    /* CGM_VSQA_SRAM_BUFFERS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQA_SRAM_BUFFERS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQA_SRAM_BUFFERS_SIZE */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 0 -> 3 (MIXED) __REGGEN_NL__ VSQs: 4 -> 7 (OCB-Only)",
    /* CGM_VSQA_SRAM_PDS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQA_SRAM_PDS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQA_SRAM_PDS_SIZE    */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 0 -> 3 (MIXED) __REGGEN_NL__ VSQs: 4 -> 7 (OCB-Only)",
    /* CGM_VSQA_WORDS_FC_PRMS    */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQA_WORDS_RJCT_PRMS  */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQA_WORDS_SIZE       */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 0 -> 3 (MIXED) __REGGEN_NL__ VSQs: 4 -> 7 (OCB-Only)",
    /* CGM_VSQA_WRED_RJCT_PRMS   */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQB_AVRG_PRMS        */ "Rate class.  __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQB_MAX_SIZE         */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQB_PRMS             */ "Rate class.  __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQB_SRAM_BUFFERS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQB_SRAM_BUFFERS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQB_SRAM_BUFFERS_SIZE */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQB_SRAM_PDS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQB_SRAM_PDS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQB_SRAM_PDS_SIZE    */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQB_WORDS_FC_PRMS    */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQB_WORDS_RJCT_PRMS  */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQB_WORDS_SIZE       */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQB_WRED_RJCT_PRMS   */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQC_AVRG_PRMS        */ "Rate class.  __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQC_MAX_SIZE         */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQC_PRMS             */ "Rate class.  __REGGEN_NL__ VSQs: 72 -> 135 (MIXED) __REGGEN_NL__ VSQs: 136 -> 199 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQC_SRAM_BUFFERS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQC_SRAM_BUFFERS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQC_SRAM_BUFFERS_SIZE */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQC_SRAM_PDS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQC_SRAM_PDS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQC_SRAM_PDS_SIZE    */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQC_WORDS_FC_PRMS    */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQC_WORDS_RJCT_PRMS  */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQC_WORDS_SIZE       */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQC_WRED_RJCT_PRMS   */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQD_AVRG_PRMS        */ "Rate class.  __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQD_MAX_SIZE         */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQD_PRMS             */ "Rate class.  __REGGEN_NL__ VSQs: 72 -> 135 (MIXED) __REGGEN_NL__ VSQs: 136 -> 199 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQD_SRAM_BUFFERS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQD_SRAM_BUFFERS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQD_SRAM_BUFFERS_SIZE */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQD_SRAM_PDS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQD_SRAM_PDS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQD_SRAM_PDS_SIZE    */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQD_WORDS_FC_PRMS    */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQD_WORDS_RJCT_PRMS  */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQD_WORDS_SIZE       */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQD_WRED_RJCT_PRMS   */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQE_AVRG_PRMS        */ "Rate class.  __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQE_MAX_SIZE         */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQE_PRMS             */ "Rate class.  __REGGEN_NL__ VSQs: 72 -> 135 (MIXED) __REGGEN_NL__ VSQs: 136 -> 199 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQE_SRAM_BUFFERS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQE_SRAM_BUFFERS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQE_SRAM_BUFFERS_SIZE */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQE_SRAM_PDS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQE_SRAM_PDS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQE_SRAM_PDS_SIZE    */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQE_WORDS_FC_PRMS    */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQE_WORDS_RJCT_PRMS  */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQE_WORDS_SIZE       */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQE_WRED_RJCT_PRMS   */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQF_AVRG_PRMS        */ "Rate class.  __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQF_MAX_SIZE         */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQF_PRMS             */ "Rate class.  __REGGEN_NL__ VSQs: 72 -> 135 (MIXED) __REGGEN_NL__ VSQs: 136 -> 199 (OCB-Only) __REGGEN_NL__ Used to access parameter tables.",
    /* CGM_VSQF_SRAM_BUFFERS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQF_SRAM_BUFFERS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQF_SRAM_BUFFERS_SIZE */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQF_SRAM_PDS_FC_PRMS */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQF_SRAM_PDS_RJCT_PRMS */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQF_SRAM_PDS_SIZE    */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQF_WORDS_FC_PRMS    */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQF_WORDS_RJCT_PRMS  */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQF_WORDS_SIZE       */ "Instantaneous size memory. __REGGEN_NL__ VSQs: 8 -> 39 (MIXED) __REGGEN_NL__ VSQs: 40 -> 71 (OCB-Only)",
    /* CGM_VSQF_WRED_RJCT_PRMS   */ "Virtual Q parameters (Per Rate-Class4:0Drop-p1:0) __REGGEN_NL__ Tail Drop thresholds & __REGGEN_NL__ Red Parameters __REGGEN_NL__ P-Drop(red) = (c1*AvgSize-c2)*PcktSize*c3",
    /* CGM_VSQ_GRNTD_RJCT_MASK   */ "Flow Control parameters (Per Rate-Class4:0)",
    /* CGM_VSQ_PG_TC_BITMAP      */ "Maps ITC to 16 VSQ-PG-Offset __REGGEN_NL__ (Offset is selected by In-PP-Port.TcBitmapIndex)",
    ...
    /* EGQ_AUXILIARY_DATA_MEMORY_AUX_TABLE */ "The auxiliary data table is used in various stages of the PP for different applications. It is a 64K bit table. Its functionality is determined by Fallback For Bridge VLAN Commands register field AuxiliaryDataTableMode as follows: __REGGEN_NL__  In Split-Horizon mode the table is used by the ERPP to determine for each AC the orientation (Hub or scope). In this mode table size is 64K x 1. __REGGEN_NL__  In PBB mode the table is used by the ETPP to determine for the first 8K source system ports th ...",
    ...
    /* EGQ_EGRESS_SHAPER_CALENDAR_SELECTOR_CCM */ "Calendars select sequence configuration memory",
    ...
    /* EGQ_EGRESS_SHAPER_PER_PORT_CREDIT_BALANCE_MEMORY_CBM */ "Credit Balance Memory. This memory holds the credit balance of the OFP.",
    ...
    /* EGQ_FREE_BUFFERS_ALLOCATION_BITMAP_MEMORY_FBM */ "Represents the dynamic status of the EGQ 12K Buffers. Each entry represents a bitmap of 64 buffers indicating, per buffer, whether it is free or occupied.",
    /* EGQ_FREE_DESCRIPTORS_ALLOCATION_BITMAP_MEMORY_FDM */ "Represents the dynamic status of the EGQ 32K Descriptors. Each entry represents a bitmap of 128 packet descriptors indicating, per descriptor, whether it is free or occupied.",
    ...
    /* EGQ_INGRESS_VLAN_EDITING_COMMAND_IVEC_TABLE */ "Ingress VLAN editing command.  __REGGEN_NL__ This table has 64 entries. It is pointed by FHEI.Ingress-VLAN-Edit-Command",
    ...
    /* EGQ_NON_CHANNELIZED_INTERFACES_SHAPER_CREDIT_MEMORY_NONCH_SCM */ "Non-chanelized Shaper Calendar Memory",
    /* EGQ_OFP_DEQUEUE_WFQ_CONFIGURATION_MEMORY_8P_DWM_8P */ "The table consist from 32 entries, one entry per Port Scheduler (group of 8 Q-Pairs). Defines the weights of the 8 traffic class groups (TCG) connected to this scheduler. Enables WFQ and SP relation between the 8 TCGs. Weight of 0 for a class indicates that this class has SP over the other classes. When all have equal weights, this implies simple RR. Maximum weight difference is 255:1. the lower the rate the higher the bandwidth. __REGGEN_NL__ Rate Calculation: __REGGEN_NL__ TCG(i) rate = (WFQ T ...",
    /* EGQ_OFP_DEQUEUE_WFQ_CONFIGURATION_MEMORY_DWM */ "The table contains 256 entries, one entry per Q-Pair. Each entry defines the weights of the UC and MC queues connected to this Q-Pair. Weight of 0 for one queue indicates that this qyeye has SP over the other. When both have equal weights, this implies simple RR. Maximum weight difference is 255:1. __REGGEN_NL__ Rate Calculation: __REGGEN_NL__ UC rate = (Q-Pair rate) * (MC weight) / (UC weight + MC weight)  __REGGEN_NL__ MC rate = (Q-Pair rate) * (UC weight) / (UC weight + MC weight)",
    /* EGQ_PACKET_PROCESSING_PER_PORT_CONFIGURATION_TABLE_PP_PPCT */ "Per PP-Port packet processing configuration table, allowing configuring port-related PP features for each one of the 256 ports. Each address corresponds with a port, with identical fields definitions per entry.",
    ...
    /* EGQ_PER_INTERFACE_BUFFERS_COUNTER_MAX_MEMORY */ "FQSM-MAX  -  maximum data buffers per interface Memory.",
    /* EGQ_PER_INTERFACE_BUFFERS_COUNTER_MEMORY */ "FQSM  - DB'S per Interface Memory.",
    /* EGQ_PER_INTERFACE_DESCRIPTORS_COUNTER_MAX_MEMORY */ "DCM-MAX  - maximum packet descriptors per Interface.",
    /* EGQ_PER_INTERFACE_DESCRIPTORS_COUNTER_MEMORY */ "Packet descriptors per Interface",
    /* EGQ_PER_PORT_BUFFERS_COUNTER_MAX_MEMORY */ "PQSM-MAX  - maximum unicast and multicast DB's per OTM-Port Memory.",
    /* EGQ_PER_PORT_BUFFERS_COUNTER_MEMORY */ "Unicast and Multicast consumed data buffers counters per OTM-Port.",
    /* EGQ_PER_PORT_BUFFERS_THRESHOLDS_MEMORY */ "Data buffers thresholds per Otm-Port-Profile table. __REGGEN_NL__ This memory defines per OTM-Port-Profile the thresholds related to data buffers tests per OTM-Port in CGM.",
    /* EGQ_PER_PORT_CONFIGURATION_TABLE_PPCT */ "Per OTM-Port Configuration Table, allowing configuring port-related features for each one of the 256 ports. Each address corresponds with a port, with identical fields definitions per entry.",
    /* EGQ_PER_PORT_DESCRIPTORS_COUNTER_MAX_MEMORY */ "PDCM-MAX  - maximum unicast and multicast packet descriptors per OTM-Port Memory.",
    /* EGQ_PER_PORT_DESCRIPTORS_COUNTER_MEMORY */ "Unicast and Multicast packet descriptors counters per OTM-Port Memory.",
    /* EGQ_PER_PORT_DESCRIPTORS_THRESHOLDS_MEMORY */ "This memory defines per OTM-Port-Profile the thresholds related to packet descriptors tests in CGM.",
    /* EGQ_PER_PORT_LB_RANGE     */ "Second Load-Blanace range for each OTM-Port. The first range is defines in PPCT table.",
    /* EGQ_PER_PORT_MAX_CREDIT_MEMORY_PMC */ "Per Port Maxmimum Credits Balance. __REGGEN_NL__ Each entry holds the maximum credit balance that the OFP can accumulate, indicating the burst size of the OFP. Each entry associated with OFP.",
    /* EGQ_PER_QPAI_MAX_CREDIT_MEMORY_QP_PMC */ "Per Q-Pair Maxmimum Credits Balance. __REGGEN_NL__ Each entry holds the maximum credit balance that the Q-Pair can accumulate, indicating the burst size of the Q-Pair. Each entry associated with Q-Pair.",
    /* EGQ_PER_QUEUE_BUFFERS_COUNTER_MAX_MEMORY */ "QQSM-MAX  -  maximum data buffers per queue Memory.",
    /* EGQ_PER_QUEUE_BUFFERS_COUNTER_MEMORY */ "QQSM  - DB'S per Queue Memory.",
    /* EGQ_PER_QUEUE_BUFFERS_THRESHOLDS_MEMORY */ "Data buffers thresholds per queue table.",
    /* EGQ_PER_QUEUE_DESCRIPTORS_COUNTER_MAX_MEMORY */ "DCM-MAX  - maximum packet descriptors per queue Memory.",
    /* EGQ_PER_QUEUE_DESCRIPTORS_COUNTER_MEMORY */ "Packet descriptors per queue Memory.",
    /* EGQ_PER_QUEUE_DESCRIPTORS_THRESHOLDS_MEMORY */ "PD's thresholds per queue table. The index to this table is CGM-PORT-PROFILE(4),Egress-Tc(3). The result is set of thresholds corresponding to per queue resources.",
    ...
    /* EGQ_PORT_CONFIGURATION_TABLE_PCT */ "Per Port Configuration Table. This table contains 256 entries. The address to this table is Q-Pair number.  __REGGEN_NL__ If SpecialFlowControl is set, then the address is as following: __REGGEN_NL__ 1. Entries 0-7 corresponding to OTM-Port 0 UC queues. __REGGEN_NL__ 2. Entries 8-15 corresponding to OTM-Port 8 UC queues. __REGGEN_NL__ 3. Entries 16-23 correspoinding to OTM-Port 0 MC queues. __REGGEN_NL__ 4. Entries 24-31 corresponding to OTM-Port 8 MC queues.  __REGGEN_NL__ 5. Entries 32-255 cor ...",
    ...
    /* EGQ_QPAIRS_SHAPER_CREDIT_MEMORY_QP_SCM */ "Q-Pairs Shaper Calendar Memory.",
    /* EGQ_QPAIR_SHAPER_CREDIT_BALANCE_MEMORY_QP_CBM */ "Credit Balance Memory. This memory holds the credit balance per Q-Pair.",
    ...
    /* EGQ_TCG_MAX_CREDIT_MEMORY_TCG_PMC */ "Per TCG Maxmimum Credits Balance. __REGGEN_NL__ Each entry holds the maximum credit balance that the TCG can accumulate, indicating the burst size of the TCG. Each entry associated with TCG.",
    ...
    /* EGQ_TCG_SHAPER_CREDIT_BALANCE_MEMORY_TCG_CBM */ "Credit Balance Memory. This memory holds the credit balance per TCG.",
    /* EGQ_TCG_SHAPER_CREDIT_CONFIGURATION_TCG_SCM */ "TCG Shaper Calendar Memory.",
    ...
    /* EGQ_TTL_SCOPE_MEMORY_TTL_SCOPE */ "For each packet, a range of allowed TTL values is defined. There are eight such TTL values, each of them 8b, and this table attaches each VSI with the allowed TTL scope values. __REGGEN_NL__ The eight TTL scope values are defined in Ttl Scope register.Each entry in this table configures 16 indexes for 16 consecutive VSI entries. each index selects a TTL value from cfg-ttl-scope register. __REGGEN_NL__",
    ...
    /* EGQ_VSI_MEMBERSHIP_MEMORY_VSI_MEMBERSHIP */ "VSI membership table configuration table, correlating each OTM port with a VSI. Each address corresponds with a VSI (0 through 4095), with identical fields definitions per entry.",
    ...
    /* EGQ_VSI_PROFILE_MEMORY_VSI_PROFILE */ "This table sets for each VSI an action profile. There are four such profiles. Each entry in this table configures sixteen consecutive VSI profile entries.",
    /* EGRESSEDITCMD             */ "",
    ...
    /* EPNI_LBG_FIFO_CONFIG      */ "There are 6 link bonding groups and one control path. For each LBG (except control path) there are  two FIFOs. Total 13 FIFOs which share the same 384 entries memory. This table contains the Link Bonding FIFOs configuration. __REGGEN_NL__ The FIFOs corresponding to LBG0 are FIFO 0 and 1, the FIFOs corresponding to LBG1 are FIFO 2 and 3, and so on. __REGGEN_NL__ The corresponding FIFO to Control path is FIFO number 12.",
    ...
    /* IEP_MCDA_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDA - Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* IEP_MCDB_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDB- Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* IHP_LIF_TABLE_AC_2_EEI    */ "This is the format of a P2P AC that is connected to a PWE or PBB.",
    ...
    /* ILB_RTN_CONFIG_TABLE      */ "Map incoming RTN traffic to modems.\n                   Access this table using concatenation 6b LCID + 5b LCPort from the RTN header.\n                   Every entry packs 8 modems, to save on ECC bits.",
    ...
    /* IMP_MCDA_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDA - Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* IMP_MCDB_IN_PP_PORT_MAP_AND_MTR_PRF_MAP */ "MCDB- Mapping In-PP-Port-Profile(8) into In-PP-Port-Size-Delta(8)\n                   Values = -128, +127\n                   Notes:\n                   - Each entry has 4 mappings\n                   - Indexes 0 - 256-1",
    ...
    /* IPS_CAM_FULL_THERSHOLD    */ "IFC CamFull Memory. __REGGEN_NL__ Threshold for DRAM/Fabric CAM full per Qtype. CAM maximum value is 'd127.",
    ...
    /* IPS_CREDIT_WATCHDOG_THRESHOLDS_TABLE */ "The values in this table hold thresholds for the credit Watchdog, in case a long time passed since the last credit for an active Queue was received, a Flow Status Message can be sent or the queue can be marked to be deleted. __REGGEN_NL__ Deleted queue will drop all the packets in the queue, in case a packet arrives when the queue is in delete state and there are still packets need to be dropped the new packet will also be dropped. __REGGEN_NL__ Queue in delete state will return to normal state, ...",
    ...
    /* IPS_CR_VAL_SEL            */ "Each source device is associated with one of two possible CreditValues. __REGGEN_NL__ Each bit in this bitmap determines if CreditValue0 or CreditValue1 is to be used. __REGGEN_NL__ This table is enabled by CrValSelEnable register.",
    ...
    /* IPS_EMPTY_QUEUE_CREDIT_BALANCE_TABLE */ "The values in this table relate to the credit balance of an empty Q, and affect its latency and credit waste. Access to this table is according to Queue Type. __REGGEN_NL__ Note: Values given here are in 2's complement",
    /* IPS_FLOW_ID_LOOKUP_TABLE  */ "Queue to egress base flow mapping- Every 4 queues are mapped to a single base flow and subflow mode. __REGGEN_NL__ Details are explained under InterdigitatedMode register.",
    ...
    /* IPS_FMS_BYP_SEL           */ "FMS may be bypassed if destination device supports Egress FMS function. __REGGEN_NL__ Following table has 1b per Destination Device, set to 1 if FMS may be bypassed. __REGGEN_NL__ This configuration is enabled by FmsEnableByp register.",
    ...
    /* IPS_QUEUE_DESCRIPTOR_TABLE */ "This memory holds most of the Q descriptor variables. __REGGEN_NL__ Caution: This table is for debug purposes and should be used with user discretion as it can effect the IPS operation. Special consideration should be given when writing to this table.",
    /* IPS_QUEUE_PRIORITY_TABLE  */ "The values in this table Determines if the Queue is High / Low priority. __REGGEN_NL__ This affects the DQCQ context selection for this Q-type. Access to this table is according to Queue Type.",
    ...
    /* IPS_QUEUE_SIZE_TABLE      */ "Q size variable of the Q descriptor. The queue size is given in 16B resolution. __REGGEN_NL__ Caution: This table is for debug purposes and should be used with user discretion as it can effect the IPS operation. Special consideration should be given when writing to this table.",
    ...
    /* IPS_SLOW_FACTOR_THRESHOLDS_TABLE */ "Slow-Factor (SF) Thresholds. __REGGEN_NL__ SlowFactor is used when exact scheduling is desired. __REGGEN_NL__ When Flow Status is SLOW, the SCH is assumed to send SLOW rate that ensures only 1 credit is inflight. This allows the IPS to respond in time to stop the SCH such that no exess credits accumulate in the IPS once the Queue is emptied. __REGGEN_NL__ The SlowFactor reflects the number of missing credits (Qsize-CrBal) and allows the SCH to use higher SLOW rates, such that more than 1 credit  ...",
    ...
    /* TAR_MCDB                  */ "128k Ingress Multicast Replication Data Base. (Physically shared with egress MLL table). Each multicast ID can result in up to 4k different copies of the incoming packet at the ingress FAP. Each copy is associated with a configurable Queue/destination System port and an OutLif. Each entry in this table can define 1 such copy, and points to the next entry in the linked list. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup and can be used by egress Packet Proc ...",
    /* TAR_MCDB_BITMAP_REPLICATION */ "128k Ingress Multicast Replication Data Base. (Physically shared with egress MLL table). Each multicast ID can result in up to 4k different copies of the incoming packet at the ingress FAP. Each copy is associated with a configurable Queue/destination System port and an OutLif. Each entry in this table can define 1 such copy, and points to the next entry in the linked list. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup and can be used by egress Packet Proc ...",
    /* TAR_MCDB_DOUBLE_REPLICATION */ "128k Ingress Multicast Replication Data Base. (Physically shared with egress MLL table). Each multicast ID can result in up to 4k different copies of the incoming packet at the ingress FAP. Each copy is associated with a configurable Queue/destination System port and an OutLif. Each entry in this table can define 1 such copy, and points to the next entry in the linked list. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup and can be used by egress Packet Proc ...",
    /* TAR_MCDB_SINGLE_REPLICATION */ "128k Ingress Multicast Replication Data Base. (Physically shared with egress MLL table). Each multicast ID can result in up to 4k different copies of the incoming packet at the ingress FAP. Each copy is associated with a configurable Queue/destination System port and an OutLif. Each entry in this table can define 1 such copy, and points to the next entry in the linked list. The OutLif can be further used at the egress FOP as a key for Egress Multicast lookup and can be used by egress Packet Proc ...",
