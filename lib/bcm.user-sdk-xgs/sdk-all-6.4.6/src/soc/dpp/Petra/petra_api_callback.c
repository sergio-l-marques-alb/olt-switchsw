/* $Id: petra_api_callback.c,v 1.6 Broadcom SDK $
...
uint32
  soc_petra_callback_function_register(
    ...
    SOC_SAND_IN  SOC_PETRA_INTERRUPT_CAUSE     interrupt_cause,
  ...
  )
{
  ...
  res = soc_petra_callback_function_register_unsafe(
          unit,
          interrupt_cause,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in soc_petra_callback_function_register()",0,0);
}

uint32
  soc_petra_callback_function_unregister(
  ...
  )
{
  ...
  res = soc_petra_interrupt_specific_cause_monitor_stop_unsafe(
  ...
  )
{
  ...
  res = soc_petra_callback_all_functions_unregister_unsafe(
          unit
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in soc_petra_callback_all_functions_unregister()",0,0);
}
