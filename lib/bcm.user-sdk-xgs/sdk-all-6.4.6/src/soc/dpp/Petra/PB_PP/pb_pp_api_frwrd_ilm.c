/* $Id: pb_pp_api_frwrd_ilm.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/src/soc_pb_pp_api_frwrd_ilm.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_GLBL_INFO_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(glbl_info);

  res = soc_pb_pp_frwrd_ilm_glbl_info_set_verify(
          unit,
          glbl_info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_glbl_info_set()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_GLBL_INFO_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(glbl_info);

  res = soc_pb_pp_frwrd_ilm_glbl_info_get_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_ilm_glbl_info_get_unsafe(
          unit,
          glbl_info
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_glbl_info_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_ADD);
  ...
  res = soc_pb_pp_frwrd_ilm_add_verify(
          unit,
          ilm_key,
          ilm_val
        );
  ...
  res = soc_pb_pp_frwrd_ilm_add_unsafe(
          unit,
          ilm_key,
          ilm_val,
          success
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_add()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_GET);
  ...
  res = soc_pb_pp_frwrd_ilm_get_verify(
          unit,
          ilm_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_ilm_get_unsafe(
          unit,
          ilm_key,
          ilm_val,
          found
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_get()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_GET_BLOCK);
  ...
  res = soc_pb_pp_frwrd_ilm_get_block_verify(
          unit,
          block_range
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_ilm_get_block_unsafe(
          unit,
          block_range,
          ilm_keys,
          ilm_vals,
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_get_block()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_REMOVE);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(ilm_key);

  res = soc_pb_pp_frwrd_ilm_remove_verify(
          unit,
          ilm_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_ilm_remove_unsafe(
          unit,
          ilm_key
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_remove()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_PP_FRWRD_ILM_TABLE_CLEAR);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  res = soc_pb_pp_frwrd_ilm_table_clear_verify(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_pp_frwrd_ilm_table_clear_unsafe(
          unit
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  SOC_PB_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_pp_frwrd_ilm_table_clear()", 0, 0);
}
