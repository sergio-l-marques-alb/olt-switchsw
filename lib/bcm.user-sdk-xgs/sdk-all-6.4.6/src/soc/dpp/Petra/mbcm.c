...
CONST mbcm_dpp_functions_t mbcm_petrab_driver = {
    ...
    NULL, /* mbcm_dpp_itm_vsq_pg_tc_profile_mapping_set */
    NULL, /* mbcm_dpp_itm_vsq_pg_tc_profile_mapping_get */
    NULL, /* mbcm_dpp_itm_vsq_pg_tc_profile_set         */
    NULL, /* mbcm_dpp_itm_vsq_pg_tc_profile_get         */
    NULL, /* mbcm_dpp_itm_vsq_pg_prm_set                */
    NULL, /* mbcm_dpp_itm_vsq_pg_prm_get                */
    NULL, /* mbcm_dpp_itm_src_vsqs_mapping_set          */
    NULL, /* mbcm_dpp_itm_src_vsqs_mapping_set          */
    NULL, /* mbcm_dpp_itm_vsq_pg_ocb_set                */
    NULL, /* mbcm_dpp_itm_vsq_pg_ocb_get                */
  ...
  NULL, /*mbcm_dpp_mgmt_change_all_faps_credit_worth_unsafe*/
    ...
    NULL, /* soc_jer_port_ability_local_get */
