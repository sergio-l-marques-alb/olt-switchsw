...
/*
 * Link Control Driver - JERICHO
 */
CONST soc_linkctrl_driver_t  soc_linkctrl_driver_jer = {
    NULL,                                       /* port mapping */
    _soc_jer_linkctrl_linkscan_hw_init,      /* ld_linkscan_hw_init */
    _soc_jer_linkctrl_linkscan_config,       /* ld_linkscan_config */
    _soc_jer_linkctrl_linkscan_pause,        /* ld_linkscan_pause */
    _soc_jer_linkctrl_linkscan_continue,     /* ld_linkscan_continue */
    _soc_jer_linkctrl_update,                /* ld_update */
    _soc_jer_linkctrl_hw_link_get            /* ld_hw_link_get */
