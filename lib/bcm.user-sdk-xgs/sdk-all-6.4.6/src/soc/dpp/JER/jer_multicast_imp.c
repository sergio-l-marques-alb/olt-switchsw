...
uint32 jer_mcds_get_replications_from_entry(
    ...
    SOC_SAND_IN    uint8   count_bm,    /* Should the function increase the bitmap replications count when returning a bitmap replication */
          ...
          case 1:
            {
                ...
                if (soc_mem_field32_get(unit, mem, mcdb_entry, NEW_FORMATf)) {
                    ...
                    *cud2 = soc_mem_field32_get(unit, IRR_MCDB_EGRESS_FORMAT_2m, mcdb_entry, OUTLIF_1f);
                    ...
                    dpp_add_egress_replication_bitmap(mcds, core, cud, *cud2, bitmap, count_bm);
                }
            }
            break;
