    ...
    jer_interrupt_mem_err_info* shadow_correct_info)
{
    ...
    *p_corrective_action = JER_INT_CORR_ACT_NONE;
    ...
    case JER_INT_DRCE_ECC_ECC_2B_ERR_INT:
                ...
                type =  DCMN_ECC_ECC2B_DC;
                break;
    case JER_INT_IHB_ECC_ECC_1B_ERR_INT:

                cnt_reg = IHB_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IPST_ECC_ECC_1B_ERR_INT:

                cnt_reg = IPST_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_NBIL_ECC_ECC_1B_ERR_INT:

                cnt_reg = NBIL_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_PPDB_A_ECC_ECC_1B_ERR_INT:

                cnt_reg = PPDB_A_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_CRPS_ECC_ECC_1B_ERR_INT:

                cnt_reg = CRPS_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCH_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCH_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_OCB_ECC_ECC_1B_ERR_INT:

                cnt_reg = OCB_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_OAMP_ECC_ECC_1B_ERR_INT:

                cnt_reg = OAMP_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCD_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCD_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FDA_ECC_ECC_1B_ERR_INT:

                cnt_reg = FDA_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IRE_ECC_ECC_1B_ERR_INT:

                cnt_reg = IRE_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_EGQ_ECC_ECC_1B_ERR_INT:

                cnt_reg = EGQ_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_ECI_ECC_ECC_1B_ERR_INT:

                cnt_reg = ECI_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FMAC_ECC_ECC_1B_ERR_INT:

                cnt_reg = FMAC_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IRR_ECC_ECC_1B_ERR_INT:

                cnt_reg = IRR_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_ILKN_PMH_ECC_ECC_1B_ERR_INT:

                cnt_reg = ILKN_PMH_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IQMT_ECC_ECC_1B_ERR_INT:

                cnt_reg = IQMT_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IDR_MMU_ECC_1B_ERR_INT:
    case JER_INT_IDR_ECC_ECC_1B_ERR_INT:

                cnt_reg = IDR_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_SCH_ECC_ECC_1B_ERR_INT:

                cnt_reg = SCH_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCF_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCF_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_RTP_ECC_ECC_1B_ERR_INT:

                cnt_reg = RTP_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FDT_ECC_ECC_1B_ERR_INT:

                cnt_reg = FDT_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IHP_ECC_ECC_1B_ERR_INT:

                cnt_reg = IHP_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_NBIH_ECC_ECC_1B_ERR_INT:

                cnt_reg = NBIH_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCC_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCC_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IQM_ECC_ECC_1B_ERR_INT:

                cnt_reg = IQM_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FDR_ECC_ECC_1B_ERR_INT:

                cnt_reg = FDR_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCG_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCG_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IPS_ECC_ECC_1B_ERR_INT:

                cnt_reg = IPS_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_EPNI_ECC_ECC_1B_ERR_INT:

                cnt_reg = EPNI_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_ILKN_PML_ECC_ECC_1B_ERR_INT:

                cnt_reg = ILKN_PML_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_MRPS_ECC_ECC_1B_ERR_INT:

                cnt_reg = MRPS_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FCR_ECC_ECC_1B_ERR_INT:

                cnt_reg = FCR_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_MMU_ECC_ECC_1B_ERR_INT:

                cnt_reg = MMU_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_OLP_ECC_ECC_1B_ERR_INT:

                cnt_reg = OLP_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_CFC_ECC_ECC_1B_ERR_INT:

                cnt_reg = CFC_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_PPDB_B_ECC_ECC_1B_ERR_INT:

                cnt_reg = PPDB_B_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FCT_ECC_ECC_1B_ERR_INT:

                cnt_reg = FCT_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_EDB_ECC_ECC_1B_ERR_INT:

                cnt_reg = EDB_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FSRD_ECC_ECC_1B_ERR_INT:

                cnt_reg = FSRD_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCA_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCA_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_IPT_ECC_ECC_1B_ERR_INT:

                cnt_reg = IPT_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCB_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCB_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_DRCE_ECC_ECC_1B_ERR_INT:

                cnt_reg = DRCE_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_ECC_ECC1B_DC;
                break;
    case JER_INT_FDR_FDR_4_P_1_ECC_1B_ERR_INT:

                cnt_reg = FDR_P_1_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_P_1_ECC_ECC1B_DC;
                break;
    ...
    case JER_INT_FDR_FDR_4_P_2_ECC_2B_ERR_INT:
                ...
                cnt_reg = FDR_P_2_ECC_2B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_P_2_ECC_ECC2B_DC;
                break;
    case JER_INT_FDR_FDR_4_P_1_ECC_2B_ERR_INT:

                cnt_reg = FDR_P_1_ECC_2B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_P_1_ECC_ECC2B_DC;
                break;
    case JER_INT_FDR_FDR_4_P_3_ECC_1B_ERR_INT:

                cnt_reg = FDR_P_3_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_P_3_ECC_ECC1B_DC;
                break;
    case JER_INT_FDR_FDR_4_P_2_ECC_1B_ERR_INT:

                cnt_reg = FDR_P_2_ECC_1B_ERR_CNTr;
                SOCDNX_IF_ERR_EXIT(soc_get_reg_first_block_id(unit,cnt_reg,&block));
                type =  DCMN_P_2_ECC_ECC1B_DC;
                break;
    default:
    ...
    if (addr_validf != 0) {
        ...
        default:
            ...
            if(rc != SOC_E_NONE) {
                ...
                *p_corrective_action = type==DCMN_ECC_ECC1B_DC ?  JER_INT_CORR_ACT_ECC_1B_FIX : JER_INT_CORR_ACT_SHADOW;
