...
{
    uint32 reg_val_iqmt_stat, reg_val, reg_val2 ,field_val=0, min_machine_clock_value, max_machine_clock_value, limit_prd;
    soc_reg_above_64_val_t data_th;
    int enable_per_port = 0, threshold_index;
    SOCDNX_INIT_FUNC_DEFS;
