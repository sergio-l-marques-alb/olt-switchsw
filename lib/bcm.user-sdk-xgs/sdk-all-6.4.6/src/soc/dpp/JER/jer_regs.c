...
int soc_jer_regs_blocks_access_check_regs(int unit)
{
    ...
    SOCDNX_IF_ERR_EXIT(READ_IHB_ACTION_DISABLEr_REG64(unit, 0, &reg64_original_value));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_IHB_ACTION_DISABLEr_REG64(unit, 0, reg64_test_value_ref));
    ...
    SOCDNX_IF_ERR_EXIT(READ_IHB_ACTION_DISABLEr_REG64(unit, 0, &reg64_test_value));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_IHB_ACTION_DISABLEr_REG64(unit, 0, reg64_original_value));
