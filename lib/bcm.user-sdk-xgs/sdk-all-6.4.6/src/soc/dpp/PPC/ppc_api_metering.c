/* $Id: ppc_api_metering.c,v 1.16 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/ppc/src/soc_ppc_api_metering.c
*
* MODULE PREFIX:  ppc
*
* FILE DESCRIPTION:
  ...
  )
{
  ...
  sal_memset(info, 0x0, sizeof(SOC_PPC_MTR_GLBL_INFO));
  info->update_all_copies = 0;
  SOC_SAND_MAGIC_NUM_SET;
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
  ...
  )
{
  ...
  info->is_ipg_compensation_enabled = 0;
  SOC_SAND_MAGIC_NUM_SET;
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
  ...
  )
{
  ...
  info->cbs = 0;
  info->ebs = 0;
  info->hierarchical_max_rate = 0;
  info->hierarchical_min_rate = 0;
  ...
  )
{
  ...
  LOG_CLI((BSL_META_U(unit,
                      "is_ipg_compensation_enabled: %u\n\r"),info->is_ipg_compensation_enabled));
exit:
  SOC_SAND_VOID_EXIT_AND_SEND_ERROR(0, 0, 0);
}
