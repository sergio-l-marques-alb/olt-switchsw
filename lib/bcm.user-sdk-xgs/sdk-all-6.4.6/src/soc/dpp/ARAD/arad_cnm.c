  ...
  )
{
  ...
  {
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  10,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, IPT_CNM_CONTORLr, REG_PORT_ANY, 0, CNM_DUNE_HEADER_FORMATf,  0x1));
  }
  else
  {
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  20,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, IPT_CNM_CONTORLr, REG_PORT_ANY, 0, CNM_DUNE_HEADER_FORMATf,  0x0));
    ...
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  40,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, IPT_CNM_CONTORLr, REG_PORT_ANY, 0, CNM_NON_DUNE_FORMAT_MODEf,  fld_val));
  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  10,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, IPT_CNM_CONTORLr, REG_PORT_ANY, 0, CNM_DUNE_HEADER_FORMATf, &fld_val));
  ...
  {
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  20,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_read(unit, IPT_CNM_CONTORLr, REG_PORT_ANY, 0, CNM_NON_DUNE_FORMAT_MODEf, &fld_val));
