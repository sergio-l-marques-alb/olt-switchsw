  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_FORMAT_GROUP_SET);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_packet_format_group_set()", pfg_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_FORMAT_GROUP_GET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_packet_format_group_get()", pfg_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_database_create()", db_id_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_database_get()", db_id_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_database_destroy()", db_id_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_entry_add()", db_id_ndx, entry_id_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_entry_get()", db_id_ndx, entry_id_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_entry_remove()", db_id_ndx, entry_id_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_database_entries_get_block()", db_id_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_direct_extraction_entry_add()", db_id_ndx, entry_id_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_direct_extraction_entry_get()", db_id_ndx, entry_id_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_direct_extraction_entry_remove()", db_id_ndx, entry_id_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_direct_extraction_db_entries_get()", db_id_ndx, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_control_set()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_control_get()", 0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_egr_db_map_set()", 0, port_profile_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_egr_db_map_get()", 0, port_profile_ndx);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_database_compress()", 0, db_id_ndx);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_QUAL_TYPE_PRESET1);

  for (qual_type_ndx = 0; qual_type_ndx < ARAD_PP_FP_NOF_QUALS_PER_DB_MAX; ++qual_type_ndx)
  {
    qual_types[qual_type_ndx] = ARAD_PP_NOF_FP_QUAL_TYPES;
  }
  ...
  switch (predefined_key)
  {
     ...
     * L2
     */
  case ARAD_PP_FP_PREDEFINED_ACL_KEY_L2:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_VLAN_FORMAT;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_VLAN_TAG;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_2ND_VLAN_TAG;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_SA;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_DA;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_ETHERTYPE;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_IRPP_SRC_PP_PORT;
  	break;

    /*
     * L3 IPv4
     */
  case ARAD_PP_FP_PREDEFINED_ACL_KEY_IPV4:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV4_L4OPS_HI;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_NEXT_PRTCL;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DF;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_MF;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_SIP;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DIP;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_SRC_PORT;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DEST_PORT;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_TOS;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_TCP_CTL;

    ARAD_PP_FP_CONTROL_INDEX_clear(&control_index);
    ARAD_PP_FP_CONTROL_INFO_clear(&control_info);
    control_index.type = ARAD_PP_FP_CONTROL_TYPE_L2_L3_KEY_IN_LIF_ENABLE;
    res = arad_pp_fp_control_get_unsafe(
            unit,
            SOC_CORE_INVALID,
            &control_index,
    ...
    {
      qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_IRPP_SRC_PP_PORT;
      qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_IN_VID;
    }
    else
    {
      qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_IRPP_IN_LIF;
    }
    break;
     ...
     * L3 IPv6
     */
  case ARAD_PP_FP_PREDEFINED_ACL_KEY_IPV6:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_L4OPS;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_SIP_HIGH;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_SIP_LOW;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_DIP_HIGH;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_DIP_LOW;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_NEXT_PRTCL;

    ARAD_PP_FP_CONTROL_INDEX_clear(&control_index);
    ARAD_PP_FP_CONTROL_INFO_clear(&control_info);
    control_index.type = ARAD_PP_FP_CONTROL_TYPE_L3_IPV6_TCP_CTL_ENABLE;
    res = arad_pp_fp_control_get_unsafe(
            unit,
            SOC_CORE_INVALID,
            &control_index,
    ...
    {
      qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_IPV6_TCP_CTL;
    }

    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_IRPP_IN_LIF;
    break;
 
  case ARAD_PP_FP_PREDEFINED_ACL_KEY_EGR_ETH:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_ETHERTYPE;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_IRPP_ETH_TAG_FORMAT;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_VLAN_TAG;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_2ND_VLAN_TAG;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_SA;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_DA;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_PP_PORT_DATA;
    break;

  case ARAD_PP_FP_PREDEFINED_ACL_KEY_EGR_IPV4:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_TOS;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_IPV4_NEXT_PROTOCOL;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_SIP;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_IPV4_DIP;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_FWD_VLAN_TAG;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_PP_PORT_DATA;
  ...
  case ARAD_PP_FP_PREDEFINED_ACL_KEY_EGR_MPLS:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_FTMH;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_PAYLOAD;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_MPLS_LABEL_ID_FWD;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_MPLS_EXP_FWD;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_HDR_MPLS_TTL_FWD;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_PP_PORT_DATA;
    break;

  case ARAD_PP_FP_PREDEFINED_ACL_KEY_EGR_TM:
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_FTMH;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_PAYLOAD;
    qual_types[qual_type_ndx++] = ARAD_PP_FP_QUAL_ERPP_PP_PORT_DATA;
    break;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_qual_type_preset()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_QUAL_VAL_ENCODE);

  ARAD_PP_FP_QUAL_VAL_clear(qual_val);

  switch (qual_val_encode->type)
  {
  case ARAD_PP_FP_QUAL_VAL_ENCODE_INFO_TYPE_FWD_DECISION:
    qual_val->type = ARAD_PP_FP_QUAL_IRPP_FWD_DEC_DEST;
  ...
  case ARAD_PP_FP_QUAL_VAL_ENCODE_INFO_TYPE_MAC_ADDRESS:
    qual_val->type = ARAD_PP_FP_QUAL_HDR_SA;
...
/* coverity[overrun-buffer-val] */
  ...
  case ARAD_PP_FP_QUAL_VAL_ENCODE_INFO_TYPE_IPV4_SUBNET:
    qual_val->type = ARAD_PP_FP_QUAL_HDR_IPV4_SIP;
  ...
  case ARAD_PP_FP_QUAL_VAL_ENCODE_INFO_TYPE_IPV6_SUBNET:
    qual_val->type = ARAD_PP_FP_QUAL_HDR_IPV6_SIP_HIGH;
  ...
  case ARAD_PP_FP_QUAL_VAL_ENCODE_INFO_TYPE_ETH_TAG_FORMAT:
    qual_val->type = ARAD_PP_FP_QUAL_IRPP_ETH_TAG_FORMAT;
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_qual_val_encode()", 0, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_FP_PACKET_DIAG_GET);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_packet_diag_get()", 0, 0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_fp_resource_diag_get()", 0, 0);
}
