...
sbZfC2PmProfilePolicerMemory_Print(sbZfC2PmProfilePolicerMemory_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfilePolicerMemory:: type=0x%01x"), (unsigned int)  pFromStruct->uType));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" lenshift=0x%01x"), (unsigned int)  pFromStruct->uLengthShift));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" cflag=0x%01x"), (unsigned int)  pFromStruct->bCouplingFlag));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfilePolicerMemory:: bcsize=0x%02x"), (unsigned int)  pFromStruct->uBktCSize));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" blind=0x%01x"), (unsigned int)  pFromStruct->bBlind));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" benodcr=0x%01x"), (unsigned int)  pFromStruct->bBktENoDecrement));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" eir=0x%05x"), (unsigned int)  pFromStruct->uEIR));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfilePolicerMemory:: ebs=0x%03x"), (unsigned int)  pFromStruct->uEBS));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" dred=0x%01x"), (unsigned int)  pFromStruct->bDropOnRed));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" bcnodcr=0x%01x"), (unsigned int)  pFromStruct->bBktCNoDecrement));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" cir=0x%05x"), (unsigned int)  pFromStruct->uCIR));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PmProfilePolicerMemory:: cbs=0x%03x"), (unsigned int)  pFromStruct->uCBS));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
