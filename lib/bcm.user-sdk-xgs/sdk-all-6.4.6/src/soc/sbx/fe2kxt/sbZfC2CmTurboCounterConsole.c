...
sbZfC2CmTurboCounter_Print(sbZfC2CmTurboCounter_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2CmTurboCounter:: parity=0x%01x"), (unsigned int)  pFromStruct->m_uParity));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" pktcnt=0x%04x"), (unsigned int)  pFromStruct->m_uPktCnt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" bytecnt=0x%06x"), (unsigned int)  pFromStruct->m_uByteCnt));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
