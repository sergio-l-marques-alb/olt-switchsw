...
sbZfC2PpCamConfigurationInstance0Entry_Print(sbZfC2PpCamConfigurationInstance0Entry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: mask6=0x%06x"), (unsigned int)  pFromStruct->m_uMask6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask5=0x%08x"), (unsigned int)  pFromStruct->m_uMask5));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: mask4=0x%08x"), (unsigned int)  pFromStruct->m_uMask4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask3=0x%08x"), (unsigned int)  pFromStruct->m_uMask3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: mask2=0x%08x"), (unsigned int)  pFromStruct->m_uMask2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask1=0x%08x"), (unsigned int)  pFromStruct->m_uMask1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: mask0=0x%08x"), (unsigned int)  pFromStruct->m_uMask0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data6=0x%06x"), (unsigned int)  pFromStruct->m_uData6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: data5=0x%08x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: data3=0x%08x"), (unsigned int)  pFromStruct->m_uData3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: data1=0x%08x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpCamConfigurationInstance0Entry:: valid=0x%01x"), (unsigned int)  pFromStruct->m_uValid));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2PpCamConfigurationInstance0Entry_SPrint(sbZfC2PpCamConfigurationInstance0Entry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
