...
sbZfC2PdPdOutputHeaderCopyBufferEntry_Print(sbZfC2PdPdOutputHeaderCopyBufferEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy7=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy7));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy6=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy6));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy5=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy5));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy4=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy4));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy3=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy3));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy2=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy2));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy1=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PdPdOutputHeaderCopyBufferEntry:: headercopy0=0x%08x"), (unsigned int)  pFromStruct->m_uHeaderCopy0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
