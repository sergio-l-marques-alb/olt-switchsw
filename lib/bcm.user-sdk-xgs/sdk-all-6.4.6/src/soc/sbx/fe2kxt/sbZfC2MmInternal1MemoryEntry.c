...
uint32
sbZfC2MmInternal1MemoryEntry_Pack(sbZfC2MmInternal1MemoryEntry_t *pFrom,
                                  uint8 *pToData,
                                  uint32 nMaxToDataIndex) {
  int i;
  int size = SB_ZF_C2MMINTERNAL1MEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMINTERNAL1MEMORYENTRY_SIZE_IN_BYTES;
}
...
void
sbZfC2MmInternal1MemoryEntry_Unpack(sbZfC2MmInternal1MemoryEntry_t *pToStruct,
                                    uint8 *pFromData,
                                    uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfC2MmInternal1MemoryEntry_InitInstance(sbZfC2MmInternal1MemoryEntry_t *pFrame) {
