...
sbZfC2PrCcTcamConfigEntry_Print(sbZfC2PrCcTcamConfigEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: mask213_192=0x%06x"), (unsigned int)  pFromStruct->m_uMask213_192));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask191_160=0x%08x"), (unsigned int)  pFromStruct->m_uMask191_160));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: mask159_128=0x%08x"), (unsigned int)  pFromStruct->m_uMask159_128));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask127_96=0x%08x"), (unsigned int)  pFromStruct->m_uMask127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: mask95_64=0x%08x"), (unsigned int)  pFromStruct->m_uMask95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" mask63_32=0x%08x"), (unsigned int)  pFromStruct->m_uMask63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: mask31_0=0x%08x"), (unsigned int)  pFromStruct->m_uMask31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data213_192=0x%06x"), (unsigned int)  pFromStruct->m_uData213_192));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: data191_160=0x%08x"), (unsigned int)  pFromStruct->m_uData191_160));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data159_128=0x%08x"), (unsigned int)  pFromStruct->m_uData159_128));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: data127_96=0x%08x"), (unsigned int)  pFromStruct->m_uData127_96));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data95_64=0x%08x"), (unsigned int)  pFromStruct->m_uData95_64));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PrCcTcamConfigEntry:: data63_32=0x%08x"), (unsigned int)  pFromStruct->m_uData63_32));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" data31_0=0x%08x"), (unsigned int)  pFromStruct->m_uData31_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
