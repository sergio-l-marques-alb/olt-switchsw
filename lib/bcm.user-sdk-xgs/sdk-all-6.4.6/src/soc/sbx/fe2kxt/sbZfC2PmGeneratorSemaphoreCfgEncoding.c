...
#include "sbTypes.h"
#include "sbZfC2PmGeneratorSemaphoreCfgEncoding.hx"
...
sbZfC2PmGeneratorSemaphoreCfgEncoding_Pack(sbZfC2PmGeneratorSemaphoreCfgEncoding_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PMPGENERATORSEMAPHORECFGENCODING_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2PMPGENERATORSEMAPHORECFGENCODING_SIZE_IN_BYTES;
}
