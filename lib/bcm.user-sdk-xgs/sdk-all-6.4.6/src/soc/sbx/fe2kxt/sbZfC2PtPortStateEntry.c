...
sbZfC2PtPortStateEntry_Unpack(sbZfC2PtPortStateEntry_t *pToStruct,
  ...
  (pToStruct)->m_uPktInProgress =  (uint32)  ((pFromData)[11] >> 6) & 0x01;

  /* Unpack Member: m_uMirror */
  (pToStruct)->m_uMirror =  (uint32)  ((pFromData)[11] >> 5) & 0x01;

  /* Unpack Member: m_uMirrorSrcDrop */
  (pToStruct)->m_uMirrorSrcDrop =  (uint32)  ((pFromData)[11] >> 4) & 0x01;

  /* Unpack Member: m_uDoubleDequeued */
  (pToStruct)->m_uDoubleDequeued =  (uint32)  ((pFromData)[11] >> 3) & 0x01;

  /* Unpack Member: m_uEopExtraBurst */
  (pToStruct)->m_uEopExtraBurst =  (uint32)  ((pFromData)[11] >> 2) & 0x01;

  /* Unpack Member: m_uResidueByte */
  (pToStruct)->m_uResidueByte =  (uint32)  ((pFromData)[10] >> 6) & 0x03;
  (pToStruct)->m_uResidueByte |=  (uint32)  ((pFromData)[11] & 0x03) << 2;

  /* Unpack Member: m_uPktRequestState */
  (pToStruct)->m_uPktRequestState =  (uint32)  ((pFromData)[10] >> 2) & 0x0f;

  /* Unpack Member: m_uLine */
  (pToStruct)->m_uLine =  (uint32)  ((pFromData)[10] >> 1) & 0x01;

  /* Unpack Member: m_uLastPage */
  (pToStruct)->m_uLastPage =  (uint32)  ((pFromData)[10] ) & 0x01;

  /* Unpack Member: m_uNextPageState */
  (pToStruct)->m_uNextPageState =  (uint32)  ((pFromData)[9] >> 6) & 0x03;

  /* Unpack Member: m_uNextPage */
  (pToStruct)->m_uNextPage =  (uint32)  ((pFromData)[8] >> 1) & 0x7f;
  (pToStruct)->m_uNextPage |=  (uint32)  ((pFromData)[9] & 0x3f) << 7;

  /* Unpack Member: m_uNextLength */
  (pToStruct)->m_uNextLength =  (uint32)  ((pFromData)[7] >> 1) & 0x7f;
  (pToStruct)->m_uNextLength |=  (uint32)  ((pFromData)[8] & 0x01) << 7;

  /* Unpack Member: m_uPage */
  (pToStruct)->m_uPage =  (uint32)  ((pFromData)[5] >> 4) & 0x0f;
  (pToStruct)->m_uPage |=  (uint32)  (pFromData)[6] << 4;
  (pToStruct)->m_uPage |=  (uint32)  ((pFromData)[7] & 0x01) << 12;
