...
sbZfC2PrCcTcamConfigEntry_Unpack(sbZfC2PrCcTcamConfigEntry_t *pToStruct,
  ...
  (pToStruct)->m_uMask213_192 =  (uint32)  (pFromData)[51] ;
  (pToStruct)->m_uMask213_192 |=  (uint32)  (pFromData)[52] << 8;
  (pToStruct)->m_uMask213_192 |=  (uint32)  ((pFromData)[53] & 0x3f) << 16;

  /* Unpack Member: m_uMask191_160 */
  (pToStruct)->m_uMask191_160 =  (uint32)  (pFromData)[47] ;
  (pToStruct)->m_uMask191_160 |=  (uint32)  (pFromData)[48] << 8;
  (pToStruct)->m_uMask191_160 |=  (uint32)  (pFromData)[49] << 16;
  (pToStruct)->m_uMask191_160 |=  (uint32)  (pFromData)[50] << 24;

  /* Unpack Member: m_uMask159_128 */
  (pToStruct)->m_uMask159_128 =  (uint32)  (pFromData)[43] ;
  (pToStruct)->m_uMask159_128 |=  (uint32)  (pFromData)[44] << 8;
  (pToStruct)->m_uMask159_128 |=  (uint32)  (pFromData)[45] << 16;
  (pToStruct)->m_uMask159_128 |=  (uint32)  (pFromData)[46] << 24;

  /* Unpack Member: m_uMask127_96 */
  (pToStruct)->m_uMask127_96 =  (uint32)  (pFromData)[39] ;
  (pToStruct)->m_uMask127_96 |=  (uint32)  (pFromData)[40] << 8;
  (pToStruct)->m_uMask127_96 |=  (uint32)  (pFromData)[41] << 16;
  (pToStruct)->m_uMask127_96 |=  (uint32)  (pFromData)[42] << 24;

  /* Unpack Member: m_uMask95_64 */
  (pToStruct)->m_uMask95_64 =  (uint32)  (pFromData)[35] ;
  (pToStruct)->m_uMask95_64 |=  (uint32)  (pFromData)[36] << 8;
  (pToStruct)->m_uMask95_64 |=  (uint32)  (pFromData)[37] << 16;
  (pToStruct)->m_uMask95_64 |=  (uint32)  (pFromData)[38] << 24;

  /* Unpack Member: m_uMask63_32 */
  (pToStruct)->m_uMask63_32 =  (uint32)  (pFromData)[31] ;
  (pToStruct)->m_uMask63_32 |=  (uint32)  (pFromData)[32] << 8;
  (pToStruct)->m_uMask63_32 |=  (uint32)  (pFromData)[33] << 16;
  (pToStruct)->m_uMask63_32 |=  (uint32)  (pFromData)[34] << 24;

  /* Unpack Member: m_uMask31_0 */
  (pToStruct)->m_uMask31_0 =  (uint32)  (pFromData)[27] ;
  (pToStruct)->m_uMask31_0 |=  (uint32)  (pFromData)[28] << 8;
  (pToStruct)->m_uMask31_0 |=  (uint32)  (pFromData)[29] << 16;
  (pToStruct)->m_uMask31_0 |=  (uint32)  (pFromData)[30] << 24;

  /* Unpack Member: m_uData213_192 */
  (pToStruct)->m_uData213_192 =  (uint32)  ((pFromData)[24] >> 2) & 0x3f;
  (pToStruct)->m_uData213_192 |=  (uint32)  (pFromData)[25] << 6;
  (pToStruct)->m_uData213_192 |=  (uint32)  (pFromData)[26] << 14;

  /* Unpack Member: m_uData191_160 */
  (pToStruct)->m_uData191_160 =  (uint32)  ((pFromData)[20] >> 2) & 0x3f;
  (pToStruct)->m_uData191_160 |=  (uint32)  (pFromData)[21] << 6;
  (pToStruct)->m_uData191_160 |=  (uint32)  (pFromData)[22] << 14;
  (pToStruct)->m_uData191_160 |=  (uint32)  (pFromData)[23] << 22;
  (pToStruct)->m_uData191_160 |=  (uint32)  ((pFromData)[24] & 0x03) << 30;

  /* Unpack Member: m_uData159_128 */
  (pToStruct)->m_uData159_128 =  (uint32)  ((pFromData)[16] >> 2) & 0x3f;
  (pToStruct)->m_uData159_128 |=  (uint32)  (pFromData)[17] << 6;
  (pToStruct)->m_uData159_128 |=  (uint32)  (pFromData)[18] << 14;
  (pToStruct)->m_uData159_128 |=  (uint32)  (pFromData)[19] << 22;
  (pToStruct)->m_uData159_128 |=  (uint32)  ((pFromData)[20] & 0x03) << 30;

  /* Unpack Member: m_uData127_96 */
  (pToStruct)->m_uData127_96 =  (uint32)  ((pFromData)[12] >> 2) & 0x3f;
  (pToStruct)->m_uData127_96 |=  (uint32)  (pFromData)[13] << 6;
  (pToStruct)->m_uData127_96 |=  (uint32)  (pFromData)[14] << 14;
  (pToStruct)->m_uData127_96 |=  (uint32)  (pFromData)[15] << 22;
  (pToStruct)->m_uData127_96 |=  (uint32)  ((pFromData)[16] & 0x03) << 30;

  /* Unpack Member: m_uData95_64 */
  (pToStruct)->m_uData95_64 =  (uint32)  ((pFromData)[8] >> 2) & 0x3f;
  (pToStruct)->m_uData95_64 |=  (uint32)  (pFromData)[9] << 6;
  (pToStruct)->m_uData95_64 |=  (uint32)  (pFromData)[10] << 14;
  (pToStruct)->m_uData95_64 |=  (uint32)  (pFromData)[11] << 22;
  (pToStruct)->m_uData95_64 |=  (uint32)  ((pFromData)[12] & 0x03) << 30;

  /* Unpack Member: m_uData63_32 */
  (pToStruct)->m_uData63_32 =  (uint32)  ((pFromData)[4] >> 2) & 0x3f;
  (pToStruct)->m_uData63_32 |=  (uint32)  (pFromData)[5] << 6;
  (pToStruct)->m_uData63_32 |=  (uint32)  (pFromData)[6] << 14;
  (pToStruct)->m_uData63_32 |=  (uint32)  (pFromData)[7] << 22;
  (pToStruct)->m_uData63_32 |=  (uint32)  ((pFromData)[8] & 0x03) << 30;

  /* Unpack Member: m_uData31_0 */
  (pToStruct)->m_uData31_0 =  (uint32)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_uData31_0 |=  (uint32)  (pFromData)[1] << 6;
  (pToStruct)->m_uData31_0 |=  (uint32)  (pFromData)[2] << 14;
  (pToStruct)->m_uData31_0 |=  (uint32)  (pFromData)[3] << 22;
  (pToStruct)->m_uData31_0 |=  (uint32)  ((pFromData)[4] & 0x03) << 30;
