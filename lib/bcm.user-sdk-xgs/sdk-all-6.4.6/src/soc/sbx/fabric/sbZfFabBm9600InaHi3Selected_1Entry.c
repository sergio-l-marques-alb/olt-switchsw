/*
 * $Id: sbZfFabBm9600InaHi3Selected_1Entry.c,v 1.2 Broadcom SDK $
...
uint32
sbZfFabBm9600InaHi3Selected_1Entry_Pack(sbZfFabBm9600InaHi3Selected_1Entry_t *pFrom,
                                        uint8 *pToData,
                                        uint32 nMaxToDataIndex) {
#ifdef SAND_BIG_ENDIAN_HOST
  int i;
  int size = SB_ZF_FAB_BM9600_INAHI3SELECTED_1ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_INAHI3SELECTED_1ENTRY_SIZE_IN_BYTES;
}
...
void
sbZfFabBm9600InaHi3Selected_1Entry_Unpack(sbZfFabBm9600InaHi3Selected_1Entry_t *pToStruct,
                                          uint8 *pFromData,
                                          uint32 nMaxToDataIndex) {
  COMPILER_UINT64 tmp;
...
void
sbZfFabBm9600InaHi3Selected_1Entry_InitInstance(sbZfFabBm9600InaHi3Selected_1Entry_t *pFrame) {
