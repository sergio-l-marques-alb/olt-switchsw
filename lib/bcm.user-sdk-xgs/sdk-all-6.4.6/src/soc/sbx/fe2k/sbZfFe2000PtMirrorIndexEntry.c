/*
 * $Id: sbZfFe2000PtMirrorIndexEntry.c,v 1.4 Broadcom SDK $
...
sbZfFe2000PtMirrorIndexEntry_Unpack(sbZfFe2000PtMirrorIndexEntry_t *pToStruct,
  ...
  (pToStruct)->m_uSpare =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;
  (pToStruct)->m_uSpare |=  (uint32)  (pFromData)[2] << 4;
  (pToStruct)->m_uSpare |=  (uint32)  (pFromData)[3] << 12;

  /* Unpack Member: m_uOverWriteHdr */
  (pToStruct)->m_uOverWriteHdr =  (uint32)  ((pFromData)[1] >> 3) & 0x01;

  /* Unpack Member: m_uHighGigHdr */
  (pToStruct)->m_uHighGigHdr =  (uint32)  ((pFromData)[1] >> 2) & 0x01;

  /* Unpack Member: m_uDropSrcPkt */
  (pToStruct)->m_uDropSrcPkt =  (uint32)  ((pFromData)[1] >> 1) & 0x01;

  /* Unpack Member: m_uHdrPresent */
  (pToStruct)->m_uHdrPresent =  (uint32)  ((pFromData)[1] ) & 0x01;

  /* Unpack Member: m_uMirrorQueue */
  (pToStruct)->m_uMirrorQueue =  (uint32)  (pFromData)[0] ;
