/*
 * $Id: sbZfCaPpStreamSelectionStateAddress.c,v 1.2 Broadcom SDK $
...
sbZfCaPpStreamSelectionStateAddress_Pack(sbZfCaPpStreamSelectionStateAddress_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPSTREAMSELECTIONSTATEADDRESS_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPSTREAMSELECTIONSTATEADDRESS_SIZE_IN_BYTES;
}
