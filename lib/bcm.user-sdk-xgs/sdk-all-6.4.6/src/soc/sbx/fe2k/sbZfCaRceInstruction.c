/*
 * $Id: sbZfCaRceInstruction.c,v 1.2 Broadcom SDK $
...
sbZfCaRceInstruction_Unpack(sbZfCaRceInstruction_t *pToStruct,
  ...
  (pToStruct)->m_uOpcodeMsb =  (uint32)  ((pFromData)[2] >> 2) & 0x03;

  /* Unpack Member: m_uOpcodeLsb */
  (pToStruct)->m_uOpcodeLsb =  (uint32)  ((pFromData)[2] ) & 0x03;

  /* Unpack Member: m_uOpcodeSuspension */
  (pToStruct)->m_uOpcodeSuspension =  (uint32)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_uOpcodeMismatch */
  (pToStruct)->m_uOpcodeMismatch =  (uint32)  ((pFromData)[1] ) & 0x0f;
