/*
 * $Id: sbZfCaPpAggregateHashFormatConsole.c,v 1.3 Broadcom SDK $
...
sbZfCaPpAggregateHashFormat_Print(sbZfCaPpAggregateHashFormat_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("CaPpAggregateHashFormat:: aggr0=0x%01x"), (unsigned int)  pFromStruct->m_uAggregateHash_31_28));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" aggr1=0x%03x"), (unsigned int)  pFromStruct->m_uAggregateHash_27_16));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" aggr2=0x%04x"), (unsigned int)  pFromStruct->m_uAggregateHash_15_0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
