...
sbZfFe2000PpInitialQueueStateEntry_Print(sbZfFe2000PpInitialQueueStateEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpInitialQueueStateEntry:: headershift=0x%02x"), (unsigned int)  pFromStruct->m_uHeaderShift));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("Fe2000PpInitialQueueStateEntry:: state=0x%06x"), (unsigned int)  pFromStruct->m_uState));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfFe2000PpInitialQueueStateEntry_SPrint(sbZfFe2000PpInitialQueueStateEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
