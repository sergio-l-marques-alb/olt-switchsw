...
int portmod_port_soft_reset_set(int unit, int port, int idx, int val)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_soft_reset_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_soft_reset_set(unit, port, pm_info, idx, val);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_port_pgw_reconfig(int unit, int port, const portmod_port_mode_info_t* pmode, int flags)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_pgw_reconfig) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_pgw_reconfig(unit, port, pm_info, pmode, flags);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
