    ...
    switch((*scPtr).shmooType)
    {
        case SHMOO_COMBO28_ADDR_CTRL_SHORT:
            if((*scPtr).dramType == SHMOO_COMBO28_DRAM_TYPE_GDDR5)
            {
                ...
                soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_FLD_UI_SHIFTf, SHMOO_COMBO28_GDDR5_INIT_ADDR_CTRL_UI_SHIFT);
                WRITE_DDRC28_AQ_L_MAX_VDL_ADDRr(unit, drc_ndx, data);
                WRITE_DDRC28_AQ_U_MAX_VDL_ADDRr(unit, drc_ndx, data);
                WRITE_DDRC28_AQ_L_MAX_VDL_CTRLr(unit, drc_ndx, data);
                WRITE_DDRC28_AQ_U_MAX_VDL_CTRLr(unit, drc_ndx, data);
        ...
        case SHMOO_COMBO28_DQS2CK:
            if((*scPtr).dramType == SHMOO_COMBO28_DRAM_TYPE_DDR4)
            {
                ...
                soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_FLD_UI_SHIFTf, SHMOO_COMBO28_DDR4_INIT_ADDR_CTRL_UI_SHIFT);
                soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_FLD_MAX_VDL_STEPf, ss.size1000UI / 2500);
                WRITE_DDRC28_AQ_L_MAX_VDL_ADDRr(unit, drc_ndx, data);
                WRITE_DDRC28_AQ_U_MAX_VDL_ADDRr(unit, drc_ndx, data);
                WRITE_DDRC28_AQ_L_MAX_VDL_CTRLr(unit, drc_ndx, data);
                WRITE_DDRC28_AQ_U_MAX_VDL_CTRLr(unit, drc_ndx, data);
...
/*A07*/                         "A07. Configure read clock\n")));
        ...
        if(dramType == SHMOO_COMBO28_DRAM_TYPE_DDR4)
        {
            ...
            soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_DQ_BYTE0_REN_STRETCH_CONFIGr, &data, SOC_PHY_FLD_A_PLUS_1f, 1);
            soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_DQ_BYTE0_REN_STRETCH_CONFIGr, &data, SOC_PHY_FLD_A_PLUS_2f, 0);
            WRITE_DDRC28_DQ_BYTE0_REN_STRETCH_CONFIGr(unit, ndx, data);
            WRITE_DDRC28_DQ_BYTE1_REN_STRETCH_CONFIGr(unit, ndx, data);
            WRITE_DDRC28_DQ_BYTE2_REN_STRETCH_CONFIGr(unit, ndx, data);
            WRITE_DDRC28_DQ_BYTE3_REN_STRETCH_CONFIGr(unit, ndx, data);
        }
        sal_usleep(SHMOO_COMBO28_SHORT_SLEEP);
...
/*A10*/                         "A10. Configure VDLs\n")));
        ...
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_DBIr(unit, ndx, data);
    /*    WRITE_DDRC28_DQ_BYTE0_WRITE_MIN_VDL_EDCr(unit, ndx, data); */
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_DBIr(unit, ndx, data);
    /*    WRITE_DDRC28_DQ_BYTE1_WRITE_MIN_VDL_EDCr(unit, ndx, data); */
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_DBIr(unit, ndx, data);
    /*    WRITE_DDRC28_DQ_BYTE2_WRITE_MIN_VDL_EDCr(unit, ndx, data); */
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_DBIr(unit, ndx, data);
    /*    WRITE_DDRC28_DQ_BYTE3_WRITE_MIN_VDL_EDCr(unit, ndx, data); */
        ...
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_DBIr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE0_READ_MIN_VDL_EDCr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_DBIr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_READ_MIN_VDL_EDCr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_DBIr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_READ_MIN_VDL_EDCr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT0r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT1r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT2r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT3r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT4r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT5r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT6r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_BIT7r(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_DBIr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_READ_MIN_VDL_EDCr(unit, ndx, data);
        
        READ_DDRC28_DQ_BYTE0_WRITE_MAX_VDL_DQSr(unit, ndx, &data);
        if(dramType == SHMOO_COMBO28_DRAM_TYPE_DDR4)
        {
        ...
        {
            READ_DDRC28_AQ_L_MAX_VDL_ADDRr(unit, ndx, &data);
            setting = size1000UI / 2500;                                                        /* 40% adjustment */
            soc_phy_ddrc28_reg_field_set(unit, SOC_PHY_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_FLD_MAX_VDL_STEPf, setting);
            WRITE_DDRC28_AQ_L_MAX_VDL_ADDRr(unit, ndx, data);
            WRITE_DDRC28_AQ_U_MAX_VDL_ADDRr(unit, ndx, data);
            WRITE_DDRC28_AQ_L_MAX_VDL_CTRLr(unit, ndx, data);
            WRITE_DDRC28_AQ_U_MAX_VDL_CTRLr(unit, ndx, data);
...
/*A13*/                         "A13. Configure FIFOs\n")));
        ...
        WRITE_DDRC28_DQ_BYTE0_REN_FIFO_CONFIGr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_REN_FIFO_CONFIGr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_REN_FIFO_CONFIGr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_REN_FIFO_CONFIGr(unit, ndx, data);
        ...
        WRITE_DDRC28_DQ_BYTE0_EDCEN_FIFO_CONFIGr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE1_EDCEN_FIFO_CONFIGr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE2_EDCEN_FIFO_CONFIGr(unit, ndx, data);
        WRITE_DDRC28_DQ_BYTE3_EDCEN_FIFO_CONFIGr(unit, ndx, data);
        sal_usleep(SHMOO_COMBO28_SHORT_SLEEP);
