...
get_link:
        ld      b,PORTDATA
        add     b,a
; since phisical ports range start from 1, in order to spare the unused byte,
; ledproc.c linkscan calback function stores link up/down data from byte z,
; so need to sub 1 from port value in order to read the right port data.
        sub     b,1
        ld      b,(b)
        tst     b,0
        ret
