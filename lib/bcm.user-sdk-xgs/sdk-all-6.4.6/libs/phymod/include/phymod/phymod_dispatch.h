...
typedef int (*__dispatch__phymod_phy_rx_signal_detect_get_f)(const phymod_phy_access_t* phy, uint32_t* rx_pmd_locked);
...
typedef int (*__dispatch__phymod_phy_intr_enable_set_f)(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t enable);
typedef int (*__dispatch__phymod_phy_intr_enable_get_f)(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* enable);
typedef int (*__dispatch__phymod_phy_intr_status_get_f)(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* intr_status);
typedef int (*__dispatch__phymod_phy_intr_status_clear_f)(const phymod_phy_access_t* phy, uint32_t intr_type);
