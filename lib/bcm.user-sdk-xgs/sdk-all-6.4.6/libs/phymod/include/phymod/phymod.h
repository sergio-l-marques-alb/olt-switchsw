 ...
 *
 * @brief Get/Set PHY interrupt enable/disable 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  intr_type       - Set type of Interrupt to be enabled/Disabled
 * @param [in]  enable          - 
 */
int phymod_phy_intr_enable_set(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t enable);
/*! 
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [in]  intr_type       - Type of Interrupt to get the enabled status
 * @param [out]  enable          - 
 */
int phymod_phy_intr_enable_get(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* enable);
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [in]  intr_type       - Type of Interrupt to get status
 * @param [out]  intr_status     - 
 */
int phymod_phy_intr_status_get(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* intr_status);
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [in]  intr_type       - Type of Interrupt to be cleared
 */
int phymod_phy_intr_status_clear(const phymod_phy_access_t* phy, uint32_t intr_type);
