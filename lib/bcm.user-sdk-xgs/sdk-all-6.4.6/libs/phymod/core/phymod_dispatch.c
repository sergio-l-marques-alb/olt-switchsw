...
int phymod_phy_intr_enable_set(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_set(phy, intr_type, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_phy_intr_enable_get(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_enable_get(phy, intr_type, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_phy_intr_status_get(const phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* intr_status)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_get(phy, intr_type, intr_status);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
...
int phymod_phy_intr_status_clear(const phymod_phy_access_t* phy, uint32_t intr_type)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_clear) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_intr_status_clear(phy, intr_type);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
