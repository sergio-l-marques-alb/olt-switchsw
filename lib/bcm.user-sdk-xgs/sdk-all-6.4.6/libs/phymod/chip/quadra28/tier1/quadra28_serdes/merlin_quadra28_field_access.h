/**************************************************************************************
 **************************************************************************************
 *  File Name     :  merlin_quadra28_field_access.h                                        *
 *  Created On    :  29/04/2013                                                       *
 *  Created By    :  Kiran Divakar                                                    *
 *  Description   :  Serdes IP Register and Field access APIs                         *
 *  Revision      :  $Id: merlin_quadra28_field_access.h 924 2015-02-24 18:08:11Z eroes $ *
 *                                                                                    *
...
/** @file merlin_quadra28_field_access.h
 * Registers and field access
 */

#ifndef MERLIN_QUADRA28_API_FIELD_ACCESS_H
#define MERLIN_QUADRA28_API_FIELD_ACCESS_H
 ...
 */
err_code_t _merlin_quadra28_pmd_rdt_field( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint16_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_quadra28_pmd_rdt_field_signed( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int16_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_quadra28_pmd_mwr_reg_byte( const phymod_access_t *pa, uint16_t addr, uint16_t mask, uint8_t lsb, uint8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_quadra28_pmd_rdt_field_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_quadra28_pmd_rdt_field_signed_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
 ...
 */
uint16_t _merlin_quadra28_pmd_rde_reg( const phymod_access_t *pa, uint16_t addr, err_code_t *err_code_p);
 ...
 * @return 16-bit unsigned value read from the field
 */
uint16_t _merlin_quadra28_pmd_rde_field( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
 ...
 */
int16_t  _merlin_quadra28_pmd_rde_field_signed( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
 ...
 */
uint8_t _merlin_quadra28_pmd_rde_field_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
 ...
 */
int8_t  _merlin_quadra28_pmd_rde_field_signed_byte( const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
