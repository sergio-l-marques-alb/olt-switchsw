...
{  
    ...
    case 40000:
        ...
        if (config->interface_type == phymodInterfaceXLAUI) {
            ...
            firmware_lane_config.MediaType = phymodFirmwareMediaTypeOptics ;
        } else if(phymodInterfaceXGMII||PHYMOD_INTF_MODES_HIGIG_GET(config)) {
            spd_intf = TEMOD_SPD_40G_X4;
        }
        break;
    case 42000:
        cl72_allowed = 1 ;
        if(phymodInterfaceXGMII||PHYMOD_INTF_MODES_HIGIG_GET(config)) {
            spd_intf = TEMOD_SPD_40G_X4;
        } else {
    ...
    if(config->interface_type == phymodInterfaceBypass) {
      ...
      case 21000: new_pll_div = TEMOD_PLL_MODE_DIV_70;  break ;
...
int _tsce_speed_id_interface_config_get(const phymod_phy_access_t* phy, int speed_id, 
                                        phymod_phy_inf_config_t* config, uint16 an_enable, 
