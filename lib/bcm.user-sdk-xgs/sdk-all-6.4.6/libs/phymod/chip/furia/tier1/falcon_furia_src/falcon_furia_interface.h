 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: falcon_furia_interface.h 816 2014-12-05 02:44:44Z kirand $   *
 *                                                                                 *
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_furia_ull_from_rmt_lpbk( const phymod_access_t *pa );

/** Switch to Normal Loppback from Remote Loopback.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon_furia_nl_from_rmt_lpbk( const phymod_access_t *pa );
