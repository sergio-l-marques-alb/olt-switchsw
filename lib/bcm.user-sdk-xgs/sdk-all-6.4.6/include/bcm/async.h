 ...
 * Generated:	Wed May 27 10:23:22 2015
 */
...
void	bcm_cosq_resource_allocation_get_async(int unit, uint32 flags, bcm_cosq_allocation_resource_t resource, bcm_cosq_allocation_entity_t * target, bcm_cosq_resource_amounts_t * amounts, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_resource_allocation_set_async(int unit, uint32 flags, bcm_cosq_allocation_resource_t resource, bcm_cosq_allocation_entity_t * target, bcm_cosq_resource_amounts_t * amounts, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_MixedSrcClassId_async(int unit, bcm_field_entry_t entry, bcm_field_src_class_t data, bcm_field_src_class_t mask, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_MixedSrcClassId_get_async(int unit, bcm_field_entry_t entry, bcm_field_src_class_t * data, bcm_field_src_class_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
#endif	/* BROADCOM_DEBUG */
void	bcm_field_source_class_mode_get_async(int unit, bcm_field_stage_t stage, bcm_pbmp_t pbm, bcm_field_src_class_mode_t * mode, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_source_class_mode_set_async(int unit, bcm_field_stage_t stage, bcm_pbmp_t pbm, bcm_field_src_class_mode_t mode, bcm_async_cb_t async_callback, void *async_cookie);
