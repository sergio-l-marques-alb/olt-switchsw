...
typedef struct {
	...
	int (*field_qualify_MixedSrcClassId)(int,bcm_field_entry_t,bcm_field_src_class_t,bcm_field_src_class_t);
	int (*field_qualify_MixedSrcClassId_get)(int,bcm_field_entry_t,bcm_field_src_class_t *,bcm_field_src_class_t *);
