...
typedef struct bcm_dpp_wb_cosq_info_s {
    ...
    uint32                   max_conns[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
    uint32                   conn_off[SOC_DPP_DEFS_MAX(NOF_CORES)] ;

    uint32                   max_ses[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
    uint32                   se_off[SOC_DPP_DEFS_MAX(NOF_CORES)] ;

    uint32                   max_flows[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
    uint32                   flow_off[SOC_DPP_DEFS_MAX(NOF_CORES)] ;

    uint32                   max_e2e_fc_data[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
    uint32                   e2e_fc_data_off[SOC_DPP_DEFS_MAX(NOF_CORES)] ;

    uint32                   max_class_data[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
    uint32                   class_data_off[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
    ...
    uint32                   gbl_data_off[SOC_DPP_DEFS_MAX(NOF_CORES)] ;
...
typedef struct bcm_dpp_wb_cosq_vsq_rate_class_data_s {
    uint32                     ref_cnt[SOC_TMC_NOF_VSQ_GROUPS]; /*A ref count for each VSQ group*/
    bcm_dpp_cosq_vsq_rate_class_info_t data;
...
typedef struct bcm_dpp_wb_cosq_gbl_data_s {
    bcm_dpp_cosq_ingress_config_t   config ;
