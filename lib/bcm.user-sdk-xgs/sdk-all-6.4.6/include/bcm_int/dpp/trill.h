...
int _bcm_dpp_trill_sw_db_hash_trill_info_iterate(int unit, shr_htb_cb_t restore_cb);
int _bcm_dpp_trill_sw_db_hash_mc_trill_iterate(int unit, shr_htb_cb_t restore_cb);
int _bcm_dpp_trill_sw_db_hash_trill_route_info_iterate(int unit, shr_htb_cb_t restore_cb);
int _bcm_dpp_trill_sw_db_hash_trill_src_iterate(int unit, shr_htb_cb_t restore_cb);
int _bcm_dpp_trill_sw_db_hash_trill_vpn_iterate(int unit, shr_htb_cb_t restore_cb);
