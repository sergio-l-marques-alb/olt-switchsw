...
typedef struct bcm_dpp_vlan_info_s {
    ...
    SOC_PPD_LIF_ID local_lif_index_drop; /* Local lif index of the vlan drop lif. */
    SOC_PPD_LIF_ID local_lif_index_simple; /* Local lif index of the vlan simple lif (vsi == vlan). */
} bcm_dpp_vlan_info_t;
