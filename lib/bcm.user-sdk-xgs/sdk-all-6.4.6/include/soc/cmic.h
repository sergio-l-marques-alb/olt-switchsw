...
/* Enable/Disable scahn override for allowing write command during warmboot */
extern int soc_schan_override_enable(int unit);
extern int soc_schan_override_disable(int unit);
