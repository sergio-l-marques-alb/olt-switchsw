...
extern int soc_th_ifp_index_invalid(int unit, soc_mem_t mem, int index);
...
#define SOC_TH_NUM_MC_QUEUES_PER_PIPE   378 /* Num MC Q's Per pipe (33 * 10)
                                               + 48 CPU queues */
...
#if !defined(BCM_TH_LATENCY_EXCLUDE)
/*
  ==========================
