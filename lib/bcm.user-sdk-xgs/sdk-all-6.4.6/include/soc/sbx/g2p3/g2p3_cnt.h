 ...
 *
 * $Id: g2p3_cnt.h,v 1.10 Broadcom SDK $
 *
...
typedef struct soc_sbx_g2p3_oam_count_s
{
    uint64    rx;
    uint64    tx;
} soc_sbx_g2p3_oam_count_t;
...
#define SOC_SBX_G2P3_VLAN_COUNT_WORDS (sizeof(soc_sbx_g2p3_vlan_count_t)/sizeof(uint64))

#define SOC_SBX_G2P3_EGRESS_COUNT_WORDS (sizeof(soc_sbx_g2p3_egress_count_t)/sizeof(uint64))
...
/**
 * soc_sbx_g2p3_counters_oam_read()
 *
 * @brief
 *
 * Read OAM counters from memory
 *
 * @param pFe       - Driver control structure
 * @param ulIndex   - Counter Index
 * @param pCount    - Pointer to src/dst counter structures
...
soc_sbx_g2p3_counters_oam_read( uint32 unit,
                                ...
                                uint8 bClearOnRead );
/**
 * soc_sbx_g2p3_counters_oam_clear()
 *
 * @brief
 *
 * Clear OAM counters
