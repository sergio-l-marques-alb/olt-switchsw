...
/*
 * $Id: sbZfCaPpPpOutHeaderCopyEntry.hx,v 1.4 Broadcom SDK $
...
#ifndef SB_ZF_CAPPPPOUTHEADERCOPYENTRY_H
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_H

#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SIZE_IN_BYTES 32
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SIZE 32
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA7_BITS "255:224"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA6_BITS "223:192"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA5_BITS "191:160"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA4_BITS "159:128"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA3_BITS "127:96"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA2_BITS "95:64"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA1_BITS "63:32"
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_M_UDATA0_BITS "31:0"


typedef struct _sbZfCaPpPpOutHeaderCopyEntry {
  uint32 m_uData7;
  uint32 m_uData6;
  uint32 m_uData5;
  uint32 m_uData4;
  ...
  uint32 m_uData1;
  uint32 m_uData0;
} sbZfCaPpPpOutHeaderCopyEntry_t;
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA7(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA6(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA5(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA4(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA3(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA2(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA1(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_SET_DATA0(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA7(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA6(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA5(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA4(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA3(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA2(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA1(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_CAPPPPOUTHEADERCOPYENTRY_GET_DATA0(nToData,pFromData,nMaxFromDataIndex) \
          do { \
