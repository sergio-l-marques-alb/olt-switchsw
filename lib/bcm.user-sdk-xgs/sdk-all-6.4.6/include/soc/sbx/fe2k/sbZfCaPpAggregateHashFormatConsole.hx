/*
 * $Id: sbZfCaPpAggregateHashFormatConsole.hx,v 1.4 Broadcom SDK $
...
char *
sbZfCaPpAggregateHashFormat_SPrint(sbZfCaPpAggregateHashFormat_t *pFromStruct, char *pcToString, uint32 lStrSize);
int
