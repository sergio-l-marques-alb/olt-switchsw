...
typedef struct soc_phy_port_sw_db_s{
    ...
    int core;           /* This is the core of the group of logical ports which
                           are assigned to this physical port. See soc_logical_port_sw_db_t.
...
soc_error_t soc_port_sw_db_wb_init(int unit);
...
soc_error_t soc_port_sw_db_first_phy_port_get(int unit, soc_port_t port, uint32* phy_port /*one based*/);
...
soc_error_t soc_port_sw_db_in_block_index_get(int unit, soc_port_t port, uint32* in_block_index /*zero based*/);
...
/* IMPORTANT NOTE: returned ports_bm include invalid ports!!! use soc_port_sw_db_valid_ports_get for valid ports only*/
soc_error_t soc_port_sw_db_ports_get(int unit, uint32 required_flags, soc_pbmp_t* ports_bm);

/* Logical port setters/getters */
soc_error_t soc_port_sw_db_core_get(int unit, soc_port_t port, int *core  /*zero based*/) ;
...
soc_error_t soc_port_sw_db_egr_if_set(int unit, soc_port_t port, uint32 egr_if);
soc_error_t soc_port_sw_db_egr_if_get(int unit, soc_port_t port, uint32* egr_if);
...
soc_error_t soc_port_sw_db_base_q_pair_set(int unit, soc_port_t port, uint32 base_q_pair);
soc_error_t soc_port_sw_db_base_q_pair_get(int unit, soc_port_t port, uint32* base_q_pair);
...
soc_error_t soc_port_sw_db_mc_offset_set(int unit, soc_port_t port, uint32 mc_offset);
soc_error_t soc_port_sw_db_mc_offset_get(int unit, soc_port_t port, uint32* mc_offset);

soc_error_t soc_port_sw_db_free_tm_ports_get(int unit, int core, soc_pbmp_t* tm_ports);

/*OTMH info*/
soc_error_t soc_port_sw_db_olif_ext_en_get(int unit, soc_port_t port, SOC_TMC_PORTS_FTMH_EXT_OUTLIF* outlif_ext_en);
soc_error_t soc_port_sw_db_olif_ext_en_set(int unit, soc_port_t port, SOC_TMC_PORTS_FTMH_EXT_OUTLIF outlif_ext_en);
soc_error_t soc_port_sw_db_src_ext_en_get(int unit, soc_port_t port, int* src_ext_en);
soc_error_t soc_port_sw_db_src_ext_en_set(int unit, soc_port_t port, int src_ext_en);
soc_error_t soc_port_sw_db_dst_ext_en_get(int unit, soc_port_t port, int* dst_ext_en);
soc_error_t soc_port_sw_db_dst_ext_en_set(int unit, soc_port_t port, int dst_ext_en);

/*Header info*/
soc_error_t soc_port_sw_db_frst_hdr_sz_set(int unit, soc_port_t port, uint32 first_hdr_sz);
soc_error_t soc_port_sw_db_frst_hdr_sz_get(int unit, soc_port_t port, uint32* first_hdr_sz);
soc_error_t soc_port_sw_db_hdr_type_out_set(int unit, soc_port_t port, SOC_TMC_PORT_HEADER_TYPE header_type_out);
soc_error_t soc_port_sw_db_hdr_type_out_get(int unit, soc_port_t port, SOC_TMC_PORT_HEADER_TYPE* header_type_out);
soc_error_t soc_port_sw_db_hdr_type_in_set(int unit, soc_port_t port, SOC_TMC_PORT_HEADER_TYPE header_type_in);
soc_error_t soc_port_sw_db_hdr_type_in_get(int unit, soc_port_t port, SOC_TMC_PORT_HEADER_TYPE* header_type_in);

/*PP port info*/
soc_error_t soc_port_sw_db_pp_port_flags_set(int unit, soc_port_t port, uint32 pp_flags);
...
soc_error_t soc_port_sw_db_pp_port_flags_get(int unit, soc_port_t port, uint32* flag);

soc_error_t soc_port_sw_db_fc_type_set(int unit, soc_port_t port, SOC_TMC_PORTS_FC_TYPE fc_type);
soc_error_t soc_port_sw_db_fc_type_get(int unit, soc_port_t port, SOC_TMC_PORTS_FC_TYPE* fc_type);
soc_error_t soc_port_sw_db_mirror_profile_set(int unit, soc_port_t port, uint32 mirror_profile);
soc_error_t soc_port_sw_db_mirror_profile_get(int unit, soc_port_t port, uint32* mirror_profile);
soc_error_t soc_port_sw_db_is_tm_src_syst_port_ext_present_set(int unit, soc_port_t port, int is_tm_src_syst_port_ext_present);
soc_error_t soc_port_sw_db_is_tm_src_syst_port_ext_present_get(int unit, soc_port_t port, int* is_tm_src_syst_port_ext_present);
soc_error_t soc_port_sw_db_is_tm_pph_present_en_set(int unit, soc_port_t port, int is_tm_pph_present_enabled);
soc_error_t soc_port_sw_db_is_tm_pph_present_en_get(int unit, soc_port_t port, int* is_tm_pph_present_enabled);
soc_error_t soc_port_sw_db_is_stag_enabled_set(int unit, soc_port_t port, int is_stag_enabled);
soc_error_t soc_port_sw_db_is_stag_enabled_get(int unit, soc_port_t port, int* is_stag_enabled);
soc_error_t soc_port_sw_db_is_snoop_enabled_set(int unit, soc_port_t port, int is_snoop_enabled);
soc_error_t soc_port_sw_db_is_snoop_en_get(int unit, soc_port_t port, int* is_snoop_enable);
soc_error_t soc_port_sw_db_is_tm_ing_shaping_enabled_set(int unit, soc_port_t port, int is_tm_ing_shaping_enabled);
soc_error_t soc_port_sw_db_is_tm_ing_shaping_en_get(int unit, soc_port_t port, int* is_tm_ing_shaping_enabled);

/*Egress Q profile map*/
soc_error_t soc_port_sw_db_shaper_mode_set(int unit, soc_port_t port, SOC_TMC_EGR_PORT_SHAPER_MODE shaper_mode);
soc_error_t soc_port_sw_db_shaper_mode_get(int unit, soc_port_t port, SOC_TMC_EGR_PORT_SHAPER_MODE* shaper_mode);

/*Peer tm domain*/
soc_error_t soc_port_sw_db_peer_tm_domain_set(int unit, soc_port_t port, uint32 peer_tm_domain);
soc_error_t soc_port_sw_db_peer_tm_domain_get(int unit, soc_port_t port, uint32* peer_tm_domain);


/* return TRUE or FALSE. On any error, just returns FALSE.  */
soc_error_t soc_port_sw_db_interface_is_virt_rcy_port(int unit, soc_port_t port);

/*Port software database snapshot tool*/
soc_error_t soc_port_sw_db_snapshot_init(int unit);
...
#define SOC_PORT_FLAGS_DISABLED                     0x10
...
extern int soc_port_sw_db_snapshot_valid[SOC_MAX_NUM_DEVICES];
extern soc_phy_port_sw_db_t phy_ports_info_snapshot[SOC_MAX_NUM_DEVICES][SOC_MAX_NUM_PORTS];
extern soc_logical_port_sw_db_t logical_ports_info_snapshot[SOC_MAX_NUM_DEVICES][SOC_MAX_NUM_PORTS];
