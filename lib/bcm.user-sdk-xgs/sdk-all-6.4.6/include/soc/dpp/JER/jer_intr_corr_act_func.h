...
#define JER_INTERRUPT_SPECIAL_MSG_SIZE             1000
...
typedef enum {
    ...
    JER_INT_CORR_ACT_ECC_1B_FIX = 0x9
...
int jer_interrupt_handles_corrective_action_for_ecc_1b(int unit,int block_instance,jer_interrupt_type interrupt_id,jer_interrupt_mem_err_info* ecc_1b_correct_info_p,char* msg);
