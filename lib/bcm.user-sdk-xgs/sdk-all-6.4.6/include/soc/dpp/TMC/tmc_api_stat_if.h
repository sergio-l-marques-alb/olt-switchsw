...
typedef enum
{
   ...
   */
  SOC_TMC_STAT_NOF_IF_REPORT_MODES = 5
...
typedef enum
{
  SOC_TMC_STAT_IF_REPORT_SIZE_61b = 0,

  SOC_TMC_STAT_IF_REPORT_SIZE_64b = 1

} SOC_TMC_STAT_IF_REPORT_SIZE;
...
typedef struct
{
  ...
  */ 
  ...
  /* if set Enable statistics reports on DeQueue - relevent to Ardon only */
   ...
   SOC_TMC_STAT_IF_REPORT_SIZE report_size;
