...
typedef enum
{
    ...
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_1_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_PCP_2_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_1_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_PCP_2_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_1_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_INNER_2_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_1_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_OUTER_2_TST2,
    ARAD_PP_ISEM_ACCESS_PROG_VT_UNTAGGED_TST2,
...
typedef enum
{
    ...
    ARAD_PP_ISEM_ACCESS_PROG_TT_MLDP_AFTER_RECYCLE,
    ...
    ARAD_PP_ISEM_ACCESS_PROG_TT_DIP6_COMPRESSION_PROG,
    /* OAM statistics*/
    ARAD_PP_ISEM_ACCESS_PROG_TT_OAM_STAT_PROG,
    ARAD_PP_ISEM_ACCESS_PROG_TT_BFD_STAT_PROG,
    /* Port extender */
    ARAD_PP_ISEM_ACCESS_PROG_TT_EXTENDER_UNTAG_CHECK,
    /* nof progs */
...
typedef enum
{
  ...
  ARAD_PP_ISEM_ACCESS_KEY_TYPE_DUMMY,
...
typedef struct
{
  uint32 pon_double_lookup_enable[ARAD_PP_SW_DB_PP_PORTS_NOF_U32];
...
uint32
  arad_pp_isem_access_fcoe_npv_mode_no_my_mac_set(int unit, int enable);
...
uint32
  arad_pp_vtt_fcf_vsan_mode_update(
    uint32 device_id, uint32 is_vsan_from_vsi
  );
