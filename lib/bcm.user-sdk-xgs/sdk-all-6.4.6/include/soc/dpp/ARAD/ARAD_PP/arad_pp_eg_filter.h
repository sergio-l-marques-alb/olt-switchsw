...
typedef enum
{
   ...
   */
  ARAD_PP_EG_FILTER_PORT_INFO_SET = ARAD_PP_PROC_DESC_BASE_EG_FILTER_FIRST,
  ARAD_PP_EG_FILTER_PORT_INFO_SET_PRINT,
  ARAD_PP_EG_FILTER_PORT_INFO_SET_UNSAFE,
  ARAD_PP_EG_FILTER_PORT_INFO_SET_VERIFY,
  ARAD_PP_EG_FILTER_PORT_INFO_GET,
  ARAD_PP_EG_FILTER_PORT_INFO_GET_PRINT,
  ...
  ARAD_PP_EG_FILTER_PVLAN_PORT_TYPE_SET_PRINT,
  ...
  ARAD_PP_EG_FILTER_PVLAN_PORT_TYPE_GET_PRINT,
...
typedef enum
{
  ...
  ARAD_PP_EG_FILTER_PVLAN_PORT_TYPE_OUT_OF_RANGE_ERR,
...
uint32
  arad_pp_eg_filter_split_horizon_out_lif_orientation_set_unsafe(
    SOC_SAND_IN  int                          unit,
    SOC_SAND_IN  ARAD_PP_AC_ID                        lif_eep_ndx,
    SOC_SAND_IN  SOC_SAND_PP_HUB_SPOKE_ORIENTATION      orientation
  );
...
uint32
  ARAD_PP_EG_FILTER_PORT_INFO_verify(
