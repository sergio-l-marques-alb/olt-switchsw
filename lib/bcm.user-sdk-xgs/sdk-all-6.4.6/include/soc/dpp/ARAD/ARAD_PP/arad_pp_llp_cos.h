...
typedef enum
{
  ...
  ARAD_PP_LLP_COS_MAPPING_TABLE_ENTRY_GET_PRINT,
  ...
  ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_SET_PRINT,
  ...
  ARAD_PP_LLP_COS_L4_PORT_RANGE_INFO_GET_PRINT,
...
uint32
  arad_pp_llp_cos_l2_next_prtcl_type_to_ndx(
    SOC_SAND_IN  ARAD_PP_L2_NEXT_PRTCL_TYPE prtcl_type,
