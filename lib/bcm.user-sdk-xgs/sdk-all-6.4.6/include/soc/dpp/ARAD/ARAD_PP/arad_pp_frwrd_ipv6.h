...
typedef enum
{
   ...
   */
  ARAD_PP_FRWRD_IPV6_GLBL_INFO_SET = ARAD_PP_PROC_DESC_BASE_FRWRD_IPV6_FIRST,
  ARAD_PP_FRWRD_IPV6_GLBL_INFO_SET_PRINT,
  ARAD_PP_FRWRD_IPV6_GLBL_INFO_SET_UNSAFE,
  ARAD_PP_FRWRD_IPV6_GLBL_INFO_SET_VERIFY,
  ARAD_PP_FRWRD_IPV6_GLBL_INFO_GET,
  ARAD_PP_FRWRD_IPV6_GLBL_INFO_GET_PRINT,
 ...
 *     "arad_pp_frwrd_ipv6_glbl_info_set_unsafe" API.
 *     Refer to "arad_pp_frwrd_ipv6_glbl_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  arad_pp_frwrd_ipv6_glbl_info_get_unsafe(
