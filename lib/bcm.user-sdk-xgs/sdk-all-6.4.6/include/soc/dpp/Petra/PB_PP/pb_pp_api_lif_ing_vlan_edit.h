/* $Id: pb_pp_api_lif_ing_vlan_edit.h,v 1.6 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_lif_ing_vlan_edit.h
*
...
#ifndef __SOC_PB_PP_API_LIF_ING_VLAN_EDIT_INCLUDED__
/* { */
#define __SOC_PB_PP_API_LIF_ING_VLAN_EDIT_INCLUDED__
...
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_EMPTY          SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_EMPTY
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG      SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_OUTER_TAG
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_INNER_TAG      SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_INNER_TAG
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC_AC_EDIT_INFO   SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC_AC_EDIT_INFO
#define SOC_PB_PP_NOF_LIF_ING_VLAN_EDIT_TAG_VID_SRCS           SOC_PPC_NOF_LIF_ING_VLAN_EDIT_TAG_VID_SRCS_PB
typedef SOC_PPC_LIF_ING_VLAN_EDIT_TAG_VID_SRC                  SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_VID_SRC;

#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NONE       SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NONE
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG  SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_OUTER_TAG
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG  SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_INNER_TAG
#define SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NEW        SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC_NEW
#define SOC_PB_PP_NOF_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRCS       SOC_PPC_NOF_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRCS
typedef SOC_PPC_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC              SOC_PB_PP_LIF_ING_VLAN_EDIT_TAG_PCP_DEI_SRC;

typedef SOC_PPC_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO       SOC_PB_PP_LIF_ING_VLAN_EDIT_COMMAND_TAG_BUILD_INFO;
typedef SOC_PPC_LIF_ING_VLAN_EDIT_COMMAND_KEY                  SOC_PB_PP_LIF_ING_VLAN_EDIT_COMMAND_KEY;
typedef SOC_PPC_LIF_ING_VLAN_EDIT_COMMAND_INFO                 SOC_PB_PP_LIF_ING_VLAN_EDIT_COMMAND_INFO;
 ...
 *     "soc_pb_pp_lif_ing_vlan_edit_command_id_set" API.
 *     Refer to "soc_pb_pp_lif_ing_vlan_edit_command_id_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_ing_vlan_edit_command_info_set" API.
 *     Refer to "soc_pb_pp_lif_ing_vlan_edit_command_info_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_ing_vlan_edit_pcp_map_stag_set" API.
 *     Refer to "soc_pb_pp_lif_ing_vlan_edit_pcp_map_stag_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_ing_vlan_edit_pcp_map_ctag_set" API.
 *     Refer to "soc_pb_pp_lif_ing_vlan_edit_pcp_map_ctag_set" API
 *     for details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_lif_ing_vlan_edit_pcp_map_untagged_set" API.
 *     Refer to "soc_pb_pp_lif_ing_vlan_edit_pcp_map_untagged_set"
 *     API for details.
*********************************************************************/
uint32
...
/* } __SOC_PB_PP_API_LIF_ING_VLAN_EDIT_INCLUDED__*/
#endif
