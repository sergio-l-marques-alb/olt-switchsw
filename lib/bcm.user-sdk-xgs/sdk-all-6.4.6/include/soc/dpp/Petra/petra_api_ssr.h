/* $Id: petra_api_ssr.h,v 1.6 Broadcom SDK $
...
#ifndef __SOC_PETRA_API_SSR_H_INCLUDED__
/* { */
#define __SOC_PETRA_API_SSR_H_INCLUDED__
...
typedef enum{
  SOC_PETRA_SW_DB_CFG_VERSION_INVALID = 0,
  SOC_PETRA_SW_DB_CFG_VERSION_NUM_0 = 1,
  SOC_PETRA_SW_DB_CFG_NOF_VERSIONS
}SOC_PETRA_SW_DB_CFG_VERSION_NUM;

#define SOC_PETRA_SW_DB_CFG_NOF_VALID_VERSIONS (SOC_PETRA_SW_DB_CFG_NOF_VERSIONS - 1)
...
/* } __SOC_PETRA_API_SSR_H_INCLUDED__*/
#endif
