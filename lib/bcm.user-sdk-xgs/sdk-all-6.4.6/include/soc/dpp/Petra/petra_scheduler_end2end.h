/* $Id: petra_scheduler_end2end.h,v 1.8 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/soc_petra/include/soc_petra_end2end_scheduler.h
*
...
#ifndef __SOC_PETRA_END2END_SCHEDULER_INCLUDED__
/* { */
#define __SOC_PETRA_END2END_SCHEDULER_INCLUDED__
...
*   Oct 18 2007
* FUNCTION:
*     See soc_petra_sch_slow_max_rates_set_unsafe
* INPUT:
*  SOC_SAND_IN  int                 unit -
*     Identifier of device to access.
...
*   Oct 18 2007
* FUNCTION:
*     See soc_petra_sch_aggregate_set_unsafe
* INPUT:
*  SOC_SAND_IN  int                 unit -
*     Identifier of device to access.
*  SOC_SAND_IN  SOC_PETRA_SCH_SE_ID          se_ndx -
...
*   Oct 18 2007
* FUNCTION:
*     See soc_petra_sch_per1k_info_set_unsafe
* INPUT:
*  SOC_SAND_IN  int                 unit -
*     Identifier of device to access.
...
*   Oct 18 2007
* FUNCTION:
*     See soc_petra_sch_flow_to_queue_mapping_set_unsafe
* INPUT:
*  SOC_SAND_IN  int                 unit -
*     Identifier of device to access.
*  SOC_SAND_IN  uint32                 quartet_ndx -
...
/* } __SOC_PETRA_END2END_SCHEDULER_INCLUDED__*/
#endif
