...
int pm4x10_port_phy_intr_enable_set(int unit, int port, pm_info_t pm_info, phymod_intr_source_t intr_src, uint32 intr_enable);
int pm4x10_port_phy_intr_enable_get(int unit, int port, pm_info_t pm_info, phymod_intr_source_t intr_src, uint32* intr_enable);

/*"port phy interrupt status get"*/
int pm4x10_port_phy_intr_status_get(int unit, int port, pm_info_t pm_info, phymod_intr_source_t intr_src, uint32* intr_status);

/*"port phy interrupt status clear"*/
int pm4x10_port_phy_intr_status_clear(int unit, int port, pm_info_t pm_info, phymod_intr_source_t intr_src);
