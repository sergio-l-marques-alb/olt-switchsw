...
typedef enum PHY82764_INTERRUPT {
    INT_M0_SLV_MISC_INTR = 4,
    INT_M0_MST_MISC_INTR = 5,
    INT_M0_SLV_MSGOUT_INTR = 6,
    INT_M0_MST_MSGOUT_INTR = 7,
    INT_MUX_PMD_LOCK_LOST = 16,
    INT_MUX_PMD_LOCK_FOUND = 17,
    INT_MUX_SIGDET_LOST = 18,
    INT_MUX_SIGDET_FOUND = 19,
    INT_PLL_10G_LOCK_LOST = 20,
    INT_PLL_10G_LOCK_FOUND = 21,
    INT_DEMUX_PMD_LOCK_LOST = 24,
    INT_DEMUX_PMD_LOCK_FOUND = 25,
    INT_DEMUX_SIGDET_LOST = 26,
    INT_DEMUX_SIGDET_FOUND = 27,
    INT_PLL_25G_LOCK_LOST = 28,
    INT_PLL_25G_LOCK_FOUND = 29,
    INT_DEMUX_PCS_MON_LOCK_LOST = 36,
    INT_DEMUX_PCS_MON_LOCK_FOUND = 37,
    INT_DEMUX_FIFOERR = 38,
    INT_DEMUX_CL73_AN_RESTARTED = 39,
    INT_DEMUX_CL73_AN_COMPLETE = 40,
    INT_MUX_PCS_MON_LOCK_LOST = 45,
    INT_MUX_PCS_MON_LOCK_FOUND = 46,
    INT_MUX_FIFOERR = 47,
    INT_MUX_CL73_AN_RESTARTED = 48,
    INT_MUX_CL73_AN_COMPLETE = 49,
    INT_MUX_CL73_AN_RESTARTED_P2 = 50,
    INT_MUX_CL73_AN_RESTARTED_P1 = 51,
    INT_MUX_CL73_AN_COMPLETE_P2 = 52,
    INT_MUX_CL73_AN_COMPLETE_P1 = 53,
    PHY82764_MAX_INT = 30
}PHY82764_INTERRUPT_T;

uint32_t intr_array[PHY82764_MAX_INT] = {
    INT_M0_SLV_MISC_INTR,
    INT_M0_MST_MISC_INTR,
    INT_M0_SLV_MSGOUT_INTR,
    INT_M0_MST_MSGOUT_INTR,
    INT_MUX_PMD_LOCK_LOST,
    INT_MUX_PMD_LOCK_FOUND,
    INT_MUX_SIGDET_LOST,
    INT_MUX_SIGDET_FOUND,
    INT_PLL_10G_LOCK_LOST,
    INT_PLL_10G_LOCK_FOUND,
    INT_DEMUX_PMD_LOCK_LOST,
    INT_DEMUX_PMD_LOCK_FOUND,
    INT_DEMUX_SIGDET_LOST,
    INT_DEMUX_SIGDET_FOUND,
    INT_PLL_25G_LOCK_LOST,
    INT_PLL_25G_LOCK_FOUND,
    INT_DEMUX_PCS_MON_LOCK_LOST,
    INT_DEMUX_PCS_MON_LOCK_FOUND,
    INT_DEMUX_FIFOERR,
    INT_DEMUX_CL73_AN_RESTARTED,
    INT_DEMUX_CL73_AN_COMPLETE,
    INT_MUX_PCS_MON_LOCK_LOST,
    INT_MUX_PCS_MON_LOCK_FOUND,
    INT_MUX_FIFOERR,
    INT_MUX_CL73_AN_RESTARTED,
    INT_MUX_CL73_AN_COMPLETE,
    INT_MUX_CL73_AN_RESTARTED_P2,
    INT_MUX_CL73_AN_RESTARTED_P1,
    INT_MUX_CL73_AN_COMPLETE_P2,
    INT_MUX_CL73_AN_COMPLETE_P1};
...
STATIC int
phy_82764_intr_enable_set(soc_phymod_ctrl_t *pmc, soc_port_t port, uint32 value);
STATIC int
phy_82764_intr_enable_get(soc_phymod_ctrl_t *pmc, soc_port_t port, uint32 *value);
STATIC int
phy_82764_intr_status_get(soc_phymod_ctrl_t *pmc, soc_port_t port, uint32 *value);
STATIC int
...
_phy_82764_init_pass2(int unit, soc_port_t port)
{
    ...
    /*Work around for to support flex of 10G To 40G Mux as part ofJira PHY-1805 */
    if ((pc->speed_max == PHY82764_SPD_20G) && (device_cfg_aux_modes->gearbox_enable == TRUE)) {
        return SOC_E_NONE;
    }
...
phy_82764_control_get(int unit, soc_port_t port, soc_phy_control_t type, uint32 *value)
{
    ...
    case SOC_PHY_CONTROL_INTR_MASK:
        rv = phy_82764_intr_enable_get(pmc, port, value);
    break;
    case SOC_PHY_CONTROL_INTR_STATUS:
        rv = phy_82764_intr_status_get(pmc, port, value);
    break;
 ...
 */
STATIC int 
phy_82764_rx_vga_set(soc_phymod_ctrl_t *pmc, soc_port_t port, int32 intf, int enable, uint32 value)
{
    phymod_phy_access_t *pm_phy;
    phymod_rx_t         phymod_rx;
    int                 idx;
...
phy_82764_control_set(int unit, soc_port_t port, soc_phy_control_t type, uint32 value)
{
    ...
    /* RX VGA */
    case SOC_PHY_CONTROL_RX_VGA:
        rv = phy_82764_rx_vga_set(pmc, port, intf, 1, value);
        break;
    case SOC_PHY_CONTROL_RX_VGA_RELEASE:
        rv = phy_82764_rx_vga_set(pmc, port, intf, 0, value);
        break;
    /* RX TAP */
    case SOC_PHY_CONTROL_RX_TAP1:
    ...
    break;
    case SOC_PHY_CONTROL_INTR_MASK:
        rv = phy_82764_intr_enable_set(pmc, port, value);
    break;
    case SOC_PHY_CONTROL_GPIO_CONFIG:
...
phy_82764_intr_enable_set(soc_phymod_ctrl_t *pmc, soc_port_t port, uint32 value)
{
    ...
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        for (int_index = 0; int_index < PHY82764_MAX_INT; int_index ++) {
            if ( value & (1 << int_index)) {
                SOC_IF_ERROR_RETURN(
                    phymod_phy_intr_enable_set(&pm_phy_copy, intr_array[int_index], 1));
            } else {
                SOC_IF_ERROR_RETURN(
                    phymod_phy_intr_enable_set(&pm_phy_copy, intr_array[int_index], 0));
            }
        }
    }
...
phy_82764_intr_enable_get(soc_phymod_ctrl_t *pmc, soc_port_t port, uint32 *value)
{
    ...
    *value = 0;
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        for (int_index = 0; int_index < PHY82764_MAX_INT; int_index ++) {
            SOC_IF_ERROR_RETURN(
                  phymod_phy_intr_enable_get(&pm_phy_copy, intr_array[int_index], &ena_get));
            if (ena_get) {
                *value |= (1 << int_index);
            }
        }
...
phy_82764_intr_status_get(soc_phymod_ctrl_t *pmc, soc_port_t port, uint32 *value)
{
    ...
    *value = 0;
    for (idx = 0; idx < pmc->num_phys; idx++) {
        ...
        for (int_index = 0; int_index < PHY82764_MAX_INT; int_index ++) {
            SOC_IF_ERROR_RETURN(
                  phymod_phy_intr_status_get(&pm_phy_copy, intr_array[int_index], &sts_get));
            if (sts_get) {
                *value |= (1 << int_index);
                SOC_IF_ERROR_RETURN(
                  phymod_phy_intr_status_clear(&pm_phy_copy, intr_array[int_index]));
            }
        }
    }
