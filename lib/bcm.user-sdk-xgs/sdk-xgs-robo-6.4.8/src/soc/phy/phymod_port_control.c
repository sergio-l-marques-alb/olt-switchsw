...
STATIC int
control_handler_interface_get (int unit, phymod_phy_access_t *phy,  uint32 param2, uint32 *intf_type)
{
    phymod_phy_inf_config_t config;
...
STATIC int
control_handler_intr_status_clr(int unit, phymod_phy_access_t *phy,  uint32 value, uint32 param2) {
...
control_handler_intr_status_get(int unit, phymod_phy_access_t *phy,  uint32 param2, uint32 *value) {
    ...
    return(phymod_phy_intr_status_get(phy, 0xFFFFFFFF, value));
}

STATIC int
control_handler_intr_enable_set(int unit, phymod_phy_access_t *phy,  uint32 value, uint32 param2) {

    SOC_IF_ERROR_RETURN(phymod_phy_intr_enable_set(phy, value, 1));

    return(phymod_phy_intr_enable_set(phy, value ^ 0xFFFFFFFF, 0));
}

STATIC int
control_handler_intr_enable_get(int unit, phymod_phy_access_t *phy,  uint32 param2, uint32 *value) {

    phymod_intr_source_t phy_intr  = 0xFFFFFFFF; /* get interrupt for all types */
    return(phymod_phy_intr_enable_get(phy, phy_intr, value));
}
...
int soc_port_control_set_wrapper(int unit, phymod_ref_clk_t ref_clock, int is_lane_control, phymod_phy_access_t *phys, int nof_phys, soc_phy_control_t control, uint32 value)
{
    ...
    case SOC_PHY_CONTROL_INTR_STATUS:
        handler = control_handler_intr_status_clr;
        lane_control_support = TRUE;
        break;
