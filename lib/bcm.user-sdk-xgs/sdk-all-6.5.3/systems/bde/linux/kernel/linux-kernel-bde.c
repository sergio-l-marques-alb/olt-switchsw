...
#else
MODULE_LICENSE("GPL");	/* Temporary: this will be removed... is just to have a successfull compilation */
#endif
...
#if defined(BCM958525) && !defined(__aarch64__)
#define REMAP_DMA_NONCACHED
#endif
...
static struct pci_device_id _id_table[] = {
    ...
    { BROADCOM_VENDOR_ID, BCM88470M_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88471_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88471P_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88471D_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88472_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88473_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88476_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88476P_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88476D_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM88476T_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
...
lkbde_cpu_pci_register(int d)
{
    ...
    case BCM88470M_DEVICE_ID:
    case BCM88471_DEVICE_ID:
    case BCM88471P_DEVICE_ID:
    case BCM88471D_DEVICE_ID:
    case BCM88472_DEVICE_ID:
    case BCM88473_DEVICE_ID:
    case BCM88476_DEVICE_ID:
    case BCM88476P_DEVICE_ID:
    case BCM88476D_DEVICE_ID:
    case BCM88476T_DEVICE_ID:
