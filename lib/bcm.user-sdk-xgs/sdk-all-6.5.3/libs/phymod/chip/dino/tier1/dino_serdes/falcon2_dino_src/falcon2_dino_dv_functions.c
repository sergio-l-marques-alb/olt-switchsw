 ...
 *  Revision      :  $Id: falcon2_dino_dv_functions.c 1172 2015-10-06 19:34:58Z kirand $ *
 *                                                                                    *
...
err_code_t falcon2_dino_loop_timing( const phymod_access_t *pa, uint8_t enable) {
    ...
    if (enable) {
        ...
        /* FALCON2_DINO_EFUN(wr_tx_pi_loop_timing_src_sel(0x0)); Through timing is default mode in Repeater cores. So never disabled */
    }
    return (ERR_CODE_NONE);
}
