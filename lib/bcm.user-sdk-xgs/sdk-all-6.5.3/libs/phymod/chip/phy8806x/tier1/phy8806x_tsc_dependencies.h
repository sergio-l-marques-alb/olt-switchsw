...
**************************************************************************************
*                                                                                    *
*  Revision      :  $Id: phy8806x_tsc_dependencies.h 947 2015-03-06 21:11:44Z kirand $ *
*                                                                                    *
 ...
 *
 *    phy8806x_tsc_pmd_wr_reg (const phymod_access_t *pa, addr, ((phy8806x_tsc_pmd_rd_reg (const phymod_access_t *pa, addr) & ~mask) | (mask & (val << lsb))));
 *
 * @param pa phymod_access_t struct
