...
int phy8806x_phy_autoneg_ability_set(const phymod_phy_access_t* phy, const phymod_autoneg_ability_t* an_ability)
{
    ...
    x_an_ability.cl37bam_cap  = BCMSWAP16(an_ability->cl37bam_cap);
    x_an_ability.an_fec       = BCMSWAP16(an_ability->an_fec);
    x_an_ability.an_cl72      = BCMSWAP16(an_ability->an_cl72);
    x_an_ability.an_hg2       = BCMSWAP16(an_ability->an_hg2);
    x_an_ability.capabilities = BCMSWAP16(an_ability->capabilities);
#else
...
int phy8806x_phy_autoneg_ability_get(const phymod_phy_access_t* phy, phymod_autoneg_ability_t* an_ability)
{
    ...
    xmodrxlen = GET_XMOD_BUF_WORD_LEN(xmodtxlen);
    ...
    an_ability->capabilities = BCMSWAP16(x_an_ability.capabilities);
#else
