...
int sw_state_dpp_soc_jericho_tm_ingress_reserved_resource_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   soc_dpp_ingress_reserved_resource_t* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(soc_dpp_ingress_reserved_resource_t),"soc_dpp_ingress_reserved_resource_t"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   ...
                                   sizeof(soc_dpp_ingress_reserved_resource_t),    /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   "soc_dpp_ingress_reserved_resource_t",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
