...
int bfd_ipv6_intf_init(int unit, int in_vlan, int out_vlan, int out_vsi, bcm_mac_t mac_address, bcm_mac_t next_hop_mac, bcm_ip6_t src_ipv6, bcm_ip6_t dst_ipv6){
    ...
    rv = create_l3_egress(unit, flags, bfd_out_port[0], out_vsi, l3_eg_int, next_hop_mac, &fec, &encap_id); 
    if (rv != BCM_E_NONE) {
...
int bfd_ipv6_ep_create(int unit, int session, int bfd_encap_id, bcm_ip6_t src_ipv6, bcm_ip6_t dst_ipv6, int endpoint_id, 
   ...
   if (is_echo) {
    ...
    bfd_endpoint_info[session].egress_if = bfd_encap_id;
    ...
    if (is_echo) {
        bfd_endpoint_info[session].local_min_echo = local_min_rx *3;
    }
...
int bfd_ipv6_ep_update(int unit, int session, int bfd_encap_id, bcm_ip6_t src_ipv6, bcm_ip6_t dst_ipv6, 
    ...
    bfd_endpoint_info[session].flags = BCM_BFD_ENDPOINT_WITH_ID | BCM_BFD_ENDPOINT_IPV6 | BCM_BFD_ENDPOINT_UPDATE | BCM_BFD_ENDPOINT_ENCAP_SET;
    if (!is_single_hop) {
        bfd_endpoint_info[session].flags |= BCM_BFD_ENDPOINT_MULTIHOP;
    }
    if (is_acc) {
    ...
    if(verbose >= 1) {
        ...
        print_ipv6_addr("   *** dst_ip6_addr",bfd_endpoint_info[session].dst_ip6_addr);
        printf("   *** priority is %d\n", bfd_endpoint_info[session].int_pri);
        /*printf("   *** authentication type is %s\n", bfd_endpoint_info[session].auth);*/
        if (auth_type != bcmBFDAuthTypeNone) {
            printf("   *** authentication index is %d\n", bfd_endpoint_info[session].auth_index);
        }
    }
    ...
    rv = bcm_bfd_endpoint_get(unit, bfd_endpoint_info[session].id, &bfd_endpoint_test_info);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
                            ...
                            uint32 local_min_tx, uint32 local_min_rx, uint32 udp_src_port, bcm_cos_t priority)
{
   ...
   /* bcm_bfd_ipv6_events_register(unit);*/
    ...
    rv=bfd_ipv6_ep_create(unit,j,bfd_encap_id, src_ipv6, dst_ipv6, endpoint_id, is_single_hop, is_acc, is_passive, is_demand, udp_src_port++, auth_type, 0, local_disc + j, remote_disc + j, priority, local_min_tx, local_min_rx);   
    if (rv != BCM_E_NONE) {
...
int bfd_ipv6_ep_create_example(int unit, int port1, int port2, int is_init, int is_single_hop, int is_acc, int is_passive, int is_demand, 
                                int endpoint_id, uint32 local_disc, uint32 remote_disc, uint32 udp_src_port, bcm_bfd_auth_type_t auth_type, uint32 auth_index, int is_inject ) {
    int in_vlan = 2;
    int out_vlan = 200;
    int out_vsi = 11;
    int rv;
 ...
 */         
    ...
    rv=bfd_ipv6_ep_create(unit,0,bfd_encap_id, src_ipv6, dst_ipv6, endpoint_id, is_single_hop, is_acc, is_passive, is_demand, udp_src_port, auth_type, 0, local_disc, remote_disc, priority, local_min_tx, local_min_rx);
    if (rv != BCM_E_NONE) {
        printf("Error in bfd_ipv6_ep_create \n");
        print rv;
        return rv;
                            ...
                            int event_on, int is_inject)
{
    ...
    for (i = 0; i < session; i++) { 
        ...
        */        
        ...
        rv=bfd_ipv6_ep_create(unit,i,bfd_encap_id, src_ipv6, dst_ipv6, endpoint_id++, is_single_hop, is_acc, is_passive, is_demand, udp_src_port++, auth_type, 0, local_disc + i, remote_disc + i, priority, local_min_tx, local_min_rx);   
        if (rv != BCM_E_NONE) {
            printf("Error in bfd_ipv6_ep_create \n");
            print rv;
            return rv;
...
int bfd_ipv6_ep_id_test(int unit, int port, int is_single_hop, int is_acc, int is_passive, int is_demand, bcm_bfd_auth_type_t auth_type, uint32 auth_index, int is_inject ) {
    ...
    /* 1. endpoint_id_zero */
    printf("\n\n--------------- %d -------------- \n", endpoint_id_zero);
    rv=bfd_ipv6_ep_create_example(unit,port,port,1,is_single_hop,is_acc,is_passive,is_demand,endpoint_id_zero,local_disc,remote_disc,udp_src_port,auth_type,auth_index,is_inject);
    if (rv != BCM_E_NONE) {
    ...
    rv=bfd_ipv6_ep_create_example(unit,port,port,0,is_single_hop,is_acc,is_passive,is_demand,endpoint_id_zero,local_disc,remote_disc, udp_src_port, auth_type, auth_index, is_inject);
    if (rv != BCM_E_EXISTS) {
        printf("Error in bfd_ipv6_ep_create_example for endpoint id %d\n", endpoint_id_zero);
        print rv;
        return rv;
    ...
    /* 2.1 */
    printf("\n\n--------------- %d -------------- \n", endpoint_id_invalid);
    rv=bfd_ipv6_ep_create_example(unit,port,port,0,is_single_hop,is_acc,is_passive,is_demand,endpoint_id_invalid,local_disc,remote_disc, udp_src_port, auth_type, auth_index, is_inject);
    if (rv != BCM_E_PARAM) {
        printf("Error in bfd_ipv6_ep_create_example for endpoint id %d\n", endpoint_id_invalid);
        print rv;
        return rv;
    ...
    rv=bfd_ipv6_ep_create_example(unit,port,port,0,is_single_hop,is_acc,is_passive,is_demand, endpoint_id_out_of_range,local_disc,remote_disc, udp_src_port, auth_type, auth_index, is_inject);
    if (rv != BCM_E_PARAM) {
        printf("Error in bfd_ipv6_ep_create_example for endpoint id %d\n", endpoint_id_out_of_range);
        print rv;
        return rv;
    ...
    /* 3. endpoint_id_rand */
    printf("\n\n--------------- %d -------------- \n", endpoint_id_rand);
    rv=bfd_ipv6_ep_create_example(unit,port,port,0,is_single_hop,is_acc,is_passive,is_demand,endpoint_id_rand,local_disc,remote_disc, udp_src_port, auth_type, auth_index, is_inject);
    if (rv != BCM_E_NONE) {
        printf("Error in bfd_ipv6_ep_create_example for endpoint id %d\n", endpoint_id_rand);
        print rv;
        return rv;
...
int bfd_ipv6_ep_udpport_test(int unit, int port, int is_single_hop, int is_acc, int is_passive, int is_demand, bcm_bfd_auth_type_t auth_type, uint32 auth_index, int is_inject ) {
    ...
    /* 1. udp_src_port_low */
    printf("\n\n--------------- udp_src_port : %d -------------- \n", udp_src_port_low);
    rv=bfd_ipv6_ep_create_example(unit,port,port,1,is_single_hop,is_acc,is_passive,is_demand,endpoint_id,local_disc,remote_disc, udp_src_port_low, auth_type, auth_index, is_inject);
    if (rv != BCM_E_NONE) {
    ...
    /* 2. udp_src_port_high */
    printf("\n\n--------------- udp_src_port : %d -------------- \n", udp_src_port_high);
    rv=bfd_ipv6_ep_create_example(unit,port,port,0,is_single_hop,is_acc,is_passive,is_demand,endpoint_id,local_disc,remote_disc, udp_src_port_high, auth_type, auth_index, is_inject);
    if (rv != BCM_E_NONE) {
...
int bfd_ipv6_ep_auth_index_test(int unit, int port, int is_single_hop, int is_acc, int is_passive, int is_demand, int is_inject ) {
    ...
    for ( auth_index=0; auth_index < auth_sha1_num; auth_index++) {
        printf("\n\n--------------- auth_index : %d -------------- \n", auth_index);
        rv=bfd_ipv6_ep_create_example(unit,port,port,is_init,is_single_hop,is_acc,is_passive,is_demand,endpoint_id,local_disc, remote_disc, udp_src_port, bcmBFDAuthTypeKeyedSHA1, auth_index, is_inject);
        if (rv != BCM_E_NONE) {
            printf("Error in bfd_ipv6_ep_create_example for endpoint %d, udp_src_port %d \n", endpoint_id, udp_src_port_low);
            print rv;
            return rv;
    ...
    for (auth_index=0; auth_index < auth_sp_num; auth_index++) {
        printf("\n\n--------------- auth_index : %d -------------- \n", auth_index);
        rv=bfd_ipv6_ep_create_example(unit,port,port,0,is_single_hop,is_acc,is_passive,is_demand,endpoint_id,local_disc, remote_disc, udp_src_port, bcmBFDAuthTypeSimplePassword, auth_index, is_inject);
        if (rv != BCM_E_NONE) {
            printf("Error in bfd_ipv6_ep_create_example for endpoint %d, udp_src_port %d \n", endpoint_id, udp_src_port_low);
            print rv;
            return rv;
...
int bfd_ipv6_ep_update_test(int unit, int port, bcm_ip6_t src_ipv6, bcm_ip6_t dst_ipv6, int endpoint_id, int is_single_hop, int is_acc, int is_passive, int is_demand, 
    ...
    int is_demand_old=0;
    uint32 local_disc_old=5010;
    uint32 remote_disc_old=10;
    ...
    verbose=1;
    rv=bfd_ipv6_ep_create_example(unit,port,port,1,is_single_hop_old,is_acc_old,is_passive_old,is_demand_old,endpoint_id,local_disc_old,remote_disc_old, 
                                udp_src_port_old, auth_type_old, auth_index_old, is_inject);
    if (rv != BCM_E_NONE) {
        printf("Error in bfd_ipv6_ep_create_example for endpoint id %d\n", endpoint_id);
        print rv;
        return rv;
    ...
    rv=bfd_ipv6_ep_update(unit, 0, bfd_encap_id, src_ipv6, dst_ipv6, endpoint_id, is_single_hop, is_acc, is_passive, is_demand, 
...
int multiple_sessions_event_check_example(int unit, int session, int port1, int port2, int is_single_hop, int is_acc, int is_passive, int is_demand, uint32 local_disc, uint32 remote_disc, 
                            bcm_bfd_auth_type_t auth_type, uint32 local_min_tx, uint32 local_min_rx, uint32 udp_src_port, bcm_cos_t priority, int is_inject, int is_init)
{
    int in_vlan = 2;
    int out_vlan = 200;
    int rv;
