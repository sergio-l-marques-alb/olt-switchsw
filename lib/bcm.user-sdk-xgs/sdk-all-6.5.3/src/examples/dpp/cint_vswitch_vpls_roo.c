    ...
    */
    ...
    /* bridging Over PWE */
        ...
        rv = create_l3_egress(unit, 
                              BCM_L3_EGRESS_ONLY|BCM_L3_WITH_ID|BCM_L3_KEEP_DSTMAC|BCM_L3_KEEP_VLAN|BCM_L3_REPLACE, 
                              vswitch_vpls_info_1.pwe_out_port,
                              vswitch_vpls_roo_info.out_to_core_vlan, 
                              tunnel_label->tunnel_id, 
                              vswitch_vpls_roo_info.mac, 
                              &vswitch_vpls_roo_info.ll_intf_id, 
