...
int route_over_extender__fec_extender_port_create(int unit, int rif_index, int host_index)
{
    ...
    l3_fec.gport = g_route_over_extender.rif_def[rif_index].sys_port;
    BCM_L3_ITF_SET(&l3_fec.intf, BCM_L3_ITF_TYPE_LIF, (g_route_over_extender.host_def[host_index].gport & 0xFFFF));
    rv = l3__egress_only_fec__create(unit, &l3_fec);

    g_route_over_extender.host_def[host_index].fec = l3_fec.l3_egress_id;
...
int route_over_extender_l2_l3_create(int unit, int rif_index, int host_index)
{
    ...
    l3_egress_encap.gport = g_route_over_extender.rif_def[rif_index].sys_port;
    ...
    l3_egress_encap.encap_id = g_route_over_extender.host_def[host_index].encap_id;
    rv = l3__egress_only_encap__create(unit, &l3_egress_encap);
    if (rv != BCM_E_NONE) {
          printf("Fail  l3__egress_only_encap__create ");
          return rv;
    }
    g_route_over_extender.host_def[host_index].encap_id = l3_egress_encap.encap_id;
