...
int arad_interrupt_handle_epniparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, corrective_action, info, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fdrprmaltoa(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_CLEAR_CHECK, (void*)&iterations, (void*)&delay_us);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fmacrxcrcerrn_int_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_NONE, (void*)array_links ,NULL);
    BCMDNX_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, (void*)array_links ,NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_fmacwrongsize_int_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fmacrxlostofsync_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_RX_LOS_HANDLE, &link, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fsrd_fsrd_syncstatuschanged_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_RX_LOS_HANDLE, &port, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ihpmacteventready(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_HANDLE_MACT_EVENT_FIFO, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ipsdeqcommandtimeout(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, DCMN_INT_CORR_ACT_INGRESS_HARD_RESET, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
