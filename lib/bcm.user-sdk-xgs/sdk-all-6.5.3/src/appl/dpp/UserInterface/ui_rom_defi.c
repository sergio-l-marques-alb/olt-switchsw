/* $Id: ui_rom_defi.c,v 1.7 Broadcom SDK $
...
#ifdef __VXWORKS__
/* { */
  #include <appl/dpp/UserInterface/ui_rom_defi_line_card.h>
#if LINK_PSS_LIBRARIES
  #include <appl/dpp/UserInterface/ui_rom_defi_pss.h>
#endif

  #include <appl/dpp/UserInterface/ui_rom_defi_fmf.h>
  #include <appl/dpp/UserInterface/ui_rom_defi_skt.h>
  #include <ui_rom_defi_negev_demo.h>
  #include <ui_rom_defi_csys.h>
    ...
    {
      {
        OFF_EQUIVALENT,
           ...
           * Casting added here just to keep the stupid compiler silent.
           */
        (long)"    Do no hook handler: Use VxWork default handler.",
          /*
           * Pointer to a function to call after symbolic value
           * has been accepted. Casting should be 'VAL_PROC_PTR'.
           * Casting to 'long' added here just to keep the stupid
...
{
  {
    ...
    " thus calling to VxWorks 'reboot()' function.)\n\r",
    "",
    {BIT(4)},
    1,
      /*
  ...
  },
  {
    ...
    0,0,0,0,0,0,0,
    "If appears, the CPU will be rebooted through calling to VxWorks 'reboot()' function.",
    "Examples:\r\n"
  ...
  },
  {
    ...
    HAS_NO_DEFAULT | MUST_APPEAR,(PARAM_VAL *)0,
    0,0,0,0,0,0,0,
    "Display the definition of a specified error status value (within vxWorks).",
    "Examples:\r\n"
  ...
  },
  {
    ...
    "See explanation of the various fields in VxWorks documentation.\r\n",
    "",
    {BIT(1)},
    1,
      /*
  ...
  },
  {
    ...
    HAS_NO_DEFAULT | MUST_APPEAR,(PARAM_VAL *)0,
    0,0,0,0,0,0,0,
    "Log out of the VxWorks system.",
    "Examples:\r\n"
    "  vx_shell logout\r\n"
    "This command logs out of the VxWorks shell. If a remote login\r\n"
    "is active (via rlogin or telnet), it is stopped, and standard\r\n"
    "I/O is restored to the console.\r\n"
    "See detailed explanation in VxWorks documentation.\r\n",
    "",
    {BIT(1)},
    1,
      /*
...
/* } */
#endif
  {
    ...
    "pss",
    (PARAM *)&Pss_params[0],
    (sizeof(Pss_params) / sizeof(Pss_params[0])) - 1,
    (char *)0,
    "PSS - Prestera Software Suite.",
    "Examples:\r\n"
    "  pss cmd \"brgSetVlanPortsTblEntry\" fields \"1 14 0 0 1 2 1 0\"\r\n"
    "Call PSS function \'brgSetVlanPortsTblEntry\'. See individual help entries.\r\n"
    "This utility is still in development stage!\r\n"
    "  pss\r\n"
    "This will result in showing a system view of all units involved in DPSS/IPC\r\n"
    "communication\r\n",
    0,0,
    (SUBJECT_PROC)subject_pss,
    TRUE
  },
#endif
  {
    SUBJECT_VX_SHELL_ID,
    "vx_shell",
    (PARAM *)&Vx_shell_params[0],
    (sizeof(Vx_shell_params) / sizeof(Vx_shell_params[0])) - 1,
    (char *)0,
    "Services related to oper. system, mostly as provided by shell of VxWorks",
    "Examples:\r\n"
    "  vx_shell reboot\r\n"
    "Results in reset of network devices and transfer of control to boot ROMs.\r\n",
    0,0,
    (SUBJECT_PROC)subject_vx_shell,
    FALSE
  },
#endif /*__VXWORKS__*/
  {
...
/* { */
...
#if LINK_PSS_LIBRARIES
  {
    ...
    "line_card",
    (PARAM *)&Line_card_params[0],
    (sizeof(Line_card_params) / sizeof(Line_card_params[0])) - 1,
    (char *)0,
    "BRD0012A - Line-card (SOC_SAND_FAP10M) Utilities.",
    "",
    0,0,
    (SUBJECT_PROC)subject_line_card,
    FALSE
  },
#endif
#endif /* __VXWORKS__ */
...
#if LINK_PSS_LIBRARIES
  {
    ...
    "demo",
    (PARAM *)&Negev_demo_params[0],
    (sizeof(Negev_demo_params) / sizeof(Negev_demo_params[0])) - 1,
    (char *)0,
    "Demo Utilities.",
    "",
    0,0,
    (SUBJECT_PROC)subject_demo,
    FALSE
  },
  {
    ...
    "",
    0,0,
    (SUBJECT_PROC)subject_gobi_demo,
    FALSE
  },
  {
    ...
    (sizeof(Negev_demo_params) / sizeof(Negev_demo_params[0])) - 1,
    (char *)0,
    "Negev demo Utilities.",
    "",
    0,0,
    (SUBJECT_PROC)subject_negev_demo,
    FALSE
  },
#endif
#endif /* __VXWORKS__ */
...
#if LINK_FAP20V_LIBRARIES
{
...
#ifdef __VXWORKS__
  {
    ...
    "csys",
    (PARAM *)&Csys_params[0],
    (sizeof(Csys_params) / sizeof(Csys_params[0])) - 1,
    (char *)0,
    "Chassis Sysetm Utilities.",
    "",
    0,0,
    (SUBJECT_PROC)subject_csys,
    FALSE
  },
  {
    SUBJECT_SKT_ID,
    "skt",
    (PARAM *)&Skt_params[0],
    (sizeof(Skt_params) / sizeof(Skt_params[0])) - 1,
    (char *)0,
    "Test suites for the SKT layer.",
    "Examples:\r\n"
    "  skt tests start server 1 port 8888\r\n"
    "Results in spawn of a new server that listens on port 8888.\r\n",
    0,0,
    (SUBJECT_PROC)subject_skt,
    FALSE
  },
#endif /*__VXWORKS__*/
/* } */
...
*  REFERENCE SYSTEM.
*ORGANIZATION:
*  ARRAY OF STRUCTURES OF TYPE 'MEMORY_BLOCK':
*  See definition in ui_pure_defi.h
*USAGE:
*  SEE ui_pure_defi.h.
*REMARKS:
*  Three setups are currently recognized:
*    OLD_MEZZANINE_4MEG_SETUP 0
*    OLD_MEZZANINE_8MEG_SETUP 1
*    NEW_MEZZANINE_8MEG_SETUP 2
*SEE ALSO:
*
********************************************************/
EXTERN CONST
   ...
   =
{
  {
    "FlashBank 1",
    (char *)FLASH1_MEM_BASE_ADRS_4MEG,
    (unsigned int)FLASH1_MEM_SIZE_4MEG,
    (unsigned int)0,
    (unsigned int)16,
    (unsigned long)(BLOCK_READ_ONLY),
    FLASH_BANK_1_EQUIVALENT
  },
  {
    "SDRAM",
    (char *)SDRAM_BASE_ADDR,
  ...
  {
    "E2PROM",
    (char *)E2PROM_BASE_ADDR,
    (unsigned int)E2PROM_SIZE,
    (unsigned int)2,
    (unsigned int)8,
    (unsigned long)(EEPROM_ACCESS | BYTE_ACCESS_ONLY),
    E2PROM_EQUIVALENT
  },
  {
    "EPLD",
    (char *)EPLD_BASE_ADDR,
    (unsigned int)EPLD_SIZE,
    (unsigned int)3,
    (unsigned int)8,
    (unsigned long)BYTE_ACCESS_ONLY,
    EPLD_EQUIVALENT
  },
#if (SIMULATE_DUNE_CHIP || SIMULATE_CHIP_SIM)
/* { */
  {
    "FE 1 regs",
    (char *)FE_1_BASE_ADDR,
    (unsigned int)sizeof(FE_REGS),
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    FE_1_REGS_EQUIVALENT
  },
  {
    "FE 2 regs",
  ...
  {
    "SOC_SAND_FAP10M 1 (sim)",
    (char *)FAP10M_1_BASE_ADDR,
    (unsigned int)sizeof(FAP10M_REGS),
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    FAP10M_1_REGS_EQUIVALENT
  ...
  {
    "SOC_SAND_FAP10M 2 (sim)",
    (char *)FAP10M_2_BASE_ADDR,
    (unsigned int)sizeof(FAP10M_REGS),
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
...
/* } */
  ...
  {
    "DP RAM",
    (char *)INTERNAL_MEM_MAP_ADDR,
    (unsigned int)INTERNAL_MEM_MAP_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)0,
    INTERNAL_DPRAM_EQUIVALENT
   ...
   =
{
  {
    "FlashBank 1",
    (char *)FLASH1_MEM_BASE_ADRS_8MEG,
    (unsigned int)FLASH1_MEM_SIZE_8MEG,
    (unsigned int)0,
    (unsigned int)16,
    (unsigned long)(BLOCK_READ_ONLY),
    FLASH_BANK_1_EQUIVALENT
...
/* } */
  ...
  {
    "GT64131_SDRAM",
    (char *)GT64131_SDRAM_BASE_ADDR,
    (unsigned int)GT64131_SDRAM_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)0,
    GT64131_SDRAM_EQUIVALENT
  ...
  {
    "GT64131_REGS",
    (char *)GT64131_REGS_BASE_ADDR,
    (unsigned int)GT64131_REGS_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)0,
    GT64131_REGS_EQUIVALENT
  ...
  {
    "PCI_IO",
    (char *)PCI_IO_BASE_ADDR,
    (unsigned int)PCI_IO_REGS_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)0,
    PCI_IO_EQUIVALENT
  ...
  {
    "PCI_MEM1",
    (char *)PCI_MEM1_BASE_ADDR,
    (unsigned int)PCI_MEM1_REGS_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)0,
    PCI_MEM1_EQUIVALENT
  ...
  {
    "PCI_MEM2",
    (char *)PCI_MEM2_BASE_ADDR,
    (unsigned int)PCI_MEM2_REGS_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)0,
    PCI_MEM2_EQUIVALENT
...
/* { */
  {
    "FTG_A",
    (char *)FTG_A_BASE_ADDR,
    (unsigned int)FTG_MEM_BYTE_SIZE,
    (unsigned int)5,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FTG_A_EQUIVALENT
  ...
  {
    "GP1_FAP20V_1",
    (char *)FAP20V_1_BASE_ADDR,
    (unsigned int)FAP20V_MEM_BYTE_SIZE,
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP20V_1_EQUIVALENT
...
/* } */
  ...
  {
    "TEVB_FLASH",
    (char *)TEVB_FLASH_ADDR,
    (unsigned int)TEVB_FLASH_SIZE,
    (unsigned int)5,
    (unsigned int)32,
    (unsigned long)0,
    TEVB_FLASH_EQUIVALENT
...
/* { */
  ...
  {
    "GP1_FAP20V_FLASH_1",
    (char *)FAP20V_FLASH_1_BASE_ADDR,
    (unsigned int)(FAP20V_FLASH_1_BYTE_SIZE*2), /*since every 2 byte in the flash is */
                                                /*accessed by one 32bit access from the */
                                                /*CPU we need to double the access address */
    (unsigned int)2,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP20V_FLASH_1_EQUIVALENT
  ...
  {
    "GP1_FAP20V_STRM_IF_1",
    (char *)FAP20V_STRM_IF_1_BASE_ADDR,
    (unsigned int)FAP20V_STRM_IF_1_BYTE_SIZE,
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP20V_STRM_IF_1_EQUIVALENT
...
/* { */
  ...
  {
    "GP1_FAP21V_1",
    (char *)FAP21V_GFA_BASE_ADDR,
    (unsigned int)FAP21V_MEM_BYTE_SIZE,
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP21V_1_EQUIVALENT
  },
  {
    "GP1_FAP21V_FSC_1",
    (char *)FAP21V_FSC_1_BASE_ADDR,
    (unsigned int)256,
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP21V_FSC_1_EQUIVALENT
  },
  {
    "GP1_FAP21V_EPLD_1",
    (char *)FAP21V_EPLD_1_BASE_ADDR,
    (unsigned int)256,
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP21V_EPLD_1_EQUIVALENT
  },
  {
    "GP1_FAP21V_FLASH_1",
    (char *)FAP21V_FLASH_1_BASE_ADDR,
    (unsigned int)(FAP21V_FLASH_1_BYTE_SIZE*2), /*since every 2 byte in the flash is */
                                                /*accessed by one 32bit access from the */
                                                /*CPU we need to double the access address */
    (unsigned int)2,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP21V_FLASH_1_EQUIVALENT
  },
  {
    "GP1_FAP21V_STRM_IF_1",
    (char *)FAP21V_STRM_IF_1_BASE_ADDR,
    (unsigned int)FAP21V_STRM_IF_1_BYTE_SIZE,
    (unsigned int)4,
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GP1_FAP21V_STRM_IF_1_EQUIVALENT
  },
/* } */
   ...
   =
{
  ...
  {
    "Gfa_petra",
    (char *)GFA_PETRA_PETRA_BASE_ADDR,
    (unsigned int)GFA_PETRA_PETRA_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GFA_PETRA_PETRA_EQUIVALENT
  },
  {
    "Gfa_stat",
    (char *)GFA_PETRA_STREAMING_BASE_ADDR,
    (unsigned int)GFA_PETRA_STREAMING_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GFA_PETRA_STATISTICS_EQUIVALENT
  },
  {
    "Gfa_io_fpga",
    (char *)GFA_PETRA_IO_FPGA_BASE_ADDR,
    (unsigned int)GFA_PETRA_IO_FPGA_SIZE,
    (unsigned int)(-1),
    (unsigned int)8,
    (unsigned long)BYTE_ACCESS_ONLY,
    GFA_PETRA_IO_FPGA_EQUIVALENT
  },
  {
    "Gfa_dffs",
    (char *)GFA_PETRA_FILE_SYSTEM_FLASH_BASE_ADDR,
    (unsigned int)GFA_PETRA_FILE_SYSTEM_FLASH_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GFA_PETRA_FILE_SYSTEM_FLASH_EQUIVALENT
  },
  {
    "Ptg_io_fpga",
    (char *)UTILS_PTG_FRONT_END_IO_FPGA_BASE_ADDR,
    (unsigned int)UTILS_PTG_FRONT_END_IO_FPGA_SIZE,
    (unsigned int)(-1),
    (unsigned int)8,
    (unsigned long)BYTE_ACCESS_ONLY,
    UTILS_PTG_FRONT_END_IO_FPGA_EQUIVALENT
  },
  {
    "Ptg_dffs",
    (char *)UTILS_PTG_FRONT_END_FILE_SYSTEM_FLASH_BASE_ADDR,
    (unsigned int)UTILS_PTG_FRONT_END_FILE_SYSTEM_FLASH_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    UTILS_PTG_FRONT_END_FILE_SYSTEM_FLASH_EQUIVALENT
  },
  {
    "Ptg_device_0",
    (char *)UTILS_PTG_FRONT_END_DEVICE_0_BASE_ADDR,
    (unsigned int)UTILS_PTG_FRONT_END_DEVICE_0_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    UTILS_PTG_FRONT_END_DEVICE_0_EQUIVALENT
  },
  {
    "Ptg_device_1",
    (char *)UTILS_PTG_FRONT_END_DEVICE_1_BASE_ADDR,
    (unsigned int)UTILS_PTG_FRONT_END_DEVICE_1_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    UTILS_PTG_FRONT_END_DEVICE_1_EQUIVALENT
  },
#endif /* LINK_PETRA_LIBRARIES */
/*
 * Last element. Do not remove.
   ...
   =
{
  ...
  {
    "Gfa_bi_petra",
    (char *)GFA_BI_PETRA_BASE_ADDR,
    (unsigned int)GFA_BI_PETRA_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GFA_BI_PETRA_EQUIVALENT
  },
  {
    "Gfa_bi_pcp",
    (char *)GFA_BI_PCP_BASE_ADDR,
    (unsigned int)GFA_BI_PCP_SIZE,
    (unsigned int)(-1),
    (unsigned int)32,
    (unsigned long)LONG_ALIGNED_WRITE_ONLY,
    GFA_BI_PCP_EQUIVALENT
  },
  {
    "Gfa_bi_io_fpga (8/32)",
    (char *)GFA_BI_IO_FPGA_BASE_ADDR,
    (unsigned int)GFA_BI_IO_FPGA_SIZE,
    (unsigned int)(-1),
    (unsigned int)8,
    (unsigned long)0,
    GFA_BI_IO_FPGA_EQUIVALENT
  },
#endif /* LINK_PETRA_LIBRARIES */
/*
 * Last element. Do not remove.
