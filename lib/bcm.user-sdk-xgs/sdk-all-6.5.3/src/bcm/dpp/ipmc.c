    ...
    void *user_data)
{
    ...
    if (flags & BCM_IPMC_IP6) {
        ...
        /* IPV4 */
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
        if (SOC_IS_JERICHO(unit) && !((soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "l3_mc_use_tcam", 0)) || SOC_DPP_CONFIG(unit)->pp.ipmc_l2_ssm_mode || ARAD_KBP_ENABLE_IPV4_MC)) {
