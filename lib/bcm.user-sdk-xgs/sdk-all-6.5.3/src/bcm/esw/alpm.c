 ...
 */
STATIC void
_bcm_esw_alpm_mem_ip6_set(int unit, _bcm_defip_cfg_t *lpm_cfg, 
...
/*
 * Function:
 *     _bcm_esw_alpm_defip128_mask_get
 * Purpose:
 ...
 */
STATIC void
_bcm_esw_alpm_defip128_mask_get(int unit, soc_mem_t mem, const void *entry,
                                ip6_addr_t ip6)
{
    uint32              ip6_field[4];
...
/*
 * Function:
 *     _bcm_esw_alpm_defip128_ipaddr_get
 * Purpose:
 ...
 */
STATIC void
_bcm_esw_alpm_defip128_ipaddr_get(int unit, soc_mem_t mem, const void *entry,
                                  ip6_addr_t ip6)
{
    uint32              ip6_field[4];
...
/*
 * Function:    
 *     _bcm_esw_alpm_defip128_ipaddr_set
 * Purpose:  
 ...
 */
STATIC void
_bcm_esw_alpm_defip128_ipaddr_set(int unit, soc_mem_t mem, uint32 *entry, 
...
/*
 * Function:    
 *     _bcm_esw_alpm_defip128_mask_set
 * Purpose:  
 ...
 */
STATIC void
_bcm_esw_alpm_defip128_mask_set(int unit, soc_mem_t mem, uint32 *entry, 
                                const ip6_addr_t ip6)
{
    uint32              ip6_field[4];
    ip6_field[3] = ((ip6[12] << 24)| (ip6[13] << 16) |
...
/*
 * Function:
 *      _bcm_esw_alpm_defip_cfg_vrf_get
 * Purpose:
 ...
 */
STATIC int
_bcm_esw_alpm_defip_cfg_vrf_get(int unit, _bcm_defip_cfg_t *lpm_cfg, 
 ...
 */
STATIC int
_bcm_esw_alpm_ent_init(int unit, _bcm_defip_cfg_t *lpm_cfg,
                       defip_entry_t *lpm_entry, int nh_ecmp_idx, uint32 *flags)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_esw_alpm_defip_cfg_vrf_get(unit, lpm_cfg, &vrf_id, &vrf_mask));
    ...
    if (ipv6) {
        ...
        _bcm_esw_alpm_mem_ip6_set(unit, lpm_cfg, lpm_entry);
...
STATIC int
_bcm_esw_alpm_128_ent_init(int unit, _bcm_defip_cfg_t *lpm_cfg,
             defip_pair_128_entry_t *lpm_entry, int nh_ecmp_idx, uint32 *flags)
{
    ...
    /* Set prefix ip address & mask. */
    _bcm_esw_alpm_defip128_ipaddr_set(unit, L3_DEFIP_PAIR_128m, 
                                      (uint32 *)lpm_entry, 
                                      lpm_cfg->defip_ip6_addr);

    _bcm_esw_alpm_defip128_mask_set(unit, L3_DEFIP_PAIR_128m, 
...
STATIC int
_bcm_esw_alpm_128_ent_parse(int unit, soc_mem_t mem, uint32 *hw_entry,
...
#if defined(BCM_APACHE_SUPPORT)
    /*
     * IPMC default route in DEFIP is supported only in LPM.
     * Verify the entry being parsed is LPM before proceeding
     */
    if (soc_feature(unit, soc_feature_ipmc_defip) &&
            (mem == L3_DEFIP_PAIR_128m) &&
            (soc_L3_DEFIP_PAIR_128m_field32_get(unit, hw_entry,
                MULTICAST_ROUTEf))) {
        int val;
        ...
        if (soc_L3_DEFIP_PAIR_128m_field32_get(unit, hw_entry,
         ...
         */
        val = soc_L3_DEFIP_PAIR_128m_field32_get(unit, hw_entry,
                EXPECTED_L3_IIFf);
 ...
 */
STATIC void 
_bcm_esw_alpm_ent_parse(int unit, _bcm_defip_cfg_t *lpm_cfg, int *nh_ecmp_idx,
 ...
 */
STATIC INLINE void
_bcm_esw_alpm_lpm_ent_parse(int unit, _bcm_defip_cfg_t *lpm_cfg, 
 ...
 */
STATIC void
_bcm_esw_alpm_mem_2_cfg(int unit, soc_mem_t mem, const void *lpm_key, 
 ...
 */
STATIC void
_bcm_esw_alpm_ent_key_get(int unit, _bcm_defip_cfg_t *lpm_cfg,
                          defip_entry_t *lpm_entry, soc_mem_t alpm_mem,
                          void *alpm_entry)
{
    bcm_ip_t v4_mask;
    ...
    /* Set prefix ip address & mask. */
    if (ipv6) {
        _bcm_esw_alpm_mem_2_cfg(unit, alpm_mem, alpm_entry, lpm_cfg);
    } else {
        /* Get ipv4 address. */
...
STATIC int
_bcm_esw_alpm_128_mem_2_cfg(int unit, soc_mem_t mem, uint32 *alpm_entry,
                            _bcm_defip_cfg_t *lpm_cfg)
{
    uint32 ip6_word[4];
 ...
 */
STATIC void
_bcm_esw_alpm_lpm_mem_2_cfg(int unit, const void *lpm_key,
                            _bcm_defip_cfg_t *lpm_cfg)
{
    uint8 *ip6;                 /* Ip6 address.       */
    uint8 mask[BCM_IP6_ADDRLEN];        /* Subnet mask.       */
 ...
 */
STATIC void
_bcm_esw_alpm_lpm_ent_key_get(int unit, _bcm_defip_cfg_t *lpm_cfg,
                              defip_entry_t *lpm_entry)
{
    ...
    /* Set prefix ip address & mask. */
    if (ipv6) {
        _bcm_esw_alpm_lpm_mem_2_cfg(unit, lpm_entry, lpm_cfg);
    } else {
        /* Get ipv4 address. */
        lpm_cfg->defip_ip_addr =
...
_bcm_esw_alpm_warmboot_walk(int unit, _bcm_l3_trvrs_data_t *trv_data)
{
    ...
    for (idx = 0; idx < idx_end; idx++) {
        ...
        for (tmp_idx = 0; tmp_idx < step_count; tmp_idx++) {
             ...
             * resides in TCAM */
            if (ALPM_PREFIX_IN_TCAM(unit, vrf_id) || (ipmc_route)) {
                ...
                _bcm_esw_alpm_lpm_ent_parse(unit, &lpm_cfg, &nh_ecmp_idx, 
                                            lpm_entry);
                _bcm_esw_alpm_lpm_ent_key_get(unit, &lpm_cfg, lpm_entry);
            ...
            for (bkti = 0; bkti < bkt_count; bkti++) {
                ...
                /* Parse the entry. */
                _bcm_esw_alpm_ent_parse(unit, &lpm_cfg, &nh_ecmp_idx, lpm_entry,
                                        alpm_mem, alpm_entry);
 ...
 */
STATIC int
_bcm_esw_alpm_128_lpm_key_get(int unit, uint32 *hw_entry,
                              _bcm_defip_cfg_t *lpm_cfg)
{
    ...
    /* Extract ip6 address. */
    _bcm_esw_alpm_defip128_ipaddr_get(unit, mem, hw_entry,
                                      lpm_cfg->defip_ip6_addr);

    /* Extract subnet mask. */
    _bcm_esw_alpm_defip128_mask_get(unit, mem, hw_entry, mask);
    lpm_cfg->defip_sub_len = bcm_ip6_mask_length(mask);
    ...
    for (idx = 0; idx < idx_end; idx++) {
        ...
        for (tmp_idx = 0; tmp_idx < step_count; tmp_idx++) {
            ...
            if (ALPM_PREFIX_IN_TCAM(unit, vrf_id) || (ipmc_route)) {
                ...
                sal_memset(&lpm_cfg, 0, sizeof(_bcm_defip_cfg_t));
                (void) _bcm_esw_alpm_128_lpm_key_get(unit, (uint32 *)lpm_entry, 
                                                     &lpm_cfg);
                (void) soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry, 
                                            &lpm_cfg.defip_vrf, &nh_ecmp_idx);
                _bcm_esw_alpm_128_ent_parse(unit, L3_DEFIP_PAIR_128m, 
                                            (uint32 *) lpm_entry, 
                                            &lpm_cfg, &nh_ecmp_idx);
                lpm_cfg.defip_index = idx;
                if (trv_data->op_cb) {
...
_bcm_esw_alpm_128_update_match(int unit, _bcm_l3_trvrs_data_t *trv_data)
{
    ...
    for (idx = (idx_end - 1); idx >= idx_start; idx--) {    
        ...
        for (tmp_idx = 0; tmp_idx < step_count; tmp_idx++) {
...
#if defined(BCM_APACHE_SUPPORT)
            if (soc_feature(unit, soc_feature_ipmc_defip)) {
                ipmc_route = soc_mem_field32_get(unit, pivot_mem,
                        lpm_entry, MULTICAST_ROUTEf);
            }
#endif

            if (ALPM_PREFIX_IN_TCAM(unit, lpm_cfg.defip_vrf) || (ipmc_route)) {
                ...
                (void) soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry, 
                                          &lpm_cfg.defip_vrf, &nh_ecmp_idx);
                _bcm_esw_alpm_128_ent_parse(unit, pivot_mem, 
                                            (uint32 *) lpm_entry, 
                                            &lpm_cfg, &nh_ecmp_idx);
                lpm_cfg.defip_index = idx;
            ...
            for (bkt_idx = 0; bkt_idx < bkt_count; bkt_idx++) {
                ...
                _bcm_esw_alpm_128_mem_2_cfg(unit, alpm_mem, 
                ...
                /* get associated data */
                _bcm_esw_alpm_128_ent_parse(unit, alpm_mem, alpm_entry, 
                                            &lpm_cfg, &nh_ecmp_idx);
    ...
    for (idx = 0; idx < def_arr_idx; idx++) {
        ...
        (void)soc_th_alpm_128_lpm_vrf_get(unit, lpm_entry, &lpm_cfg.defip_vrf,
                                          &cmp_result);
        /* Fill entry ip address & subnet mask. */
        _bcm_esw_alpm_128_mem_2_cfg(unit, alpm_mem, alpm_entry, &lpm_cfg);

        _bcm_esw_alpm_128_ent_parse(unit, alpm_mem, alpm_entry, &lpm_cfg, 
                                    &nh_ecmp_idx);
    ...
    for (idx = (idx_end - 1); idx >= idx_start; idx--) {
        ...
        for (tmp_idx = tmp_start; tmp_idx != tmp_end; tmp_idx += tmp_delta) {
            ...
            for (bkt_idx = 0; bkt_idx < bkt_count; bkt_idx++) {
                ...
                _bcm_esw_alpm_ent_key_get(unit, &lpm_cfg, lpm_entry, 
                                          alpm_mem, alpm_entry);
...
_bcm_esw_alpm_find(int unit, _bcm_defip_cfg_t *lpm_cfg, int *nh_ecmp_idx)
{
    ...
    case L3_DEFIP_PAIR_128m:
        /* Initialize lkup key. */
        BCM_IF_ERROR_RETURN(_bcm_esw_alpm_128_ent_init(unit, lpm_cfg, 
                                            &lpm_128_key, 0, &flags));
        /* Perform hw lookup. */
        ...
        _bcm_esw_alpm_128_ent_parse(unit, L3_DEFIP_PAIR_128m, 
                                    ...
                                    nh_ecmp_idx);
        /* OVERRIDE VRF Processing */ 
        _bcm_esw_alpm_128_lpm_key_get(unit, (uint32 *)&lpm_128_entry, lpm_cfg);
        soc_th_alpm_128_lpm_vrf_get(unit, &lpm_128_entry, &lpm_cfg->defip_vrf, &tmp);

        break;
    default:
        /* Initialize lkup key. */
        BCM_IF_ERROR_RETURN(_bcm_esw_alpm_ent_init(unit, lpm_cfg, &lpm_key, 0, 
                                                   &flags));
        /* Perform hw lookup. */
        ...
        /* Parse hw buffer to defip entry. */
        _bcm_esw_alpm_lpm_ent_parse(unit, lpm_cfg, nh_ecmp_idx, &lpm_entry);
        _bcm_esw_alpm_lpm_ent_key_get(unit, lpm_cfg, &lpm_entry);
