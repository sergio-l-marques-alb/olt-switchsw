...
/* VTT KBR get defines { */
/* { */
#define ARAD_PP_ISEM_ACCESS_32B_INST_CMPRSD_INNER_VID                                (SOC_IS_QAX(unit) ? 0x5b18 : (SOC_IS_JERICHO(unit)? 0x5a98 : 0x5a68))
#define ARAD_PP_ISEM_ACCESS_16B_INST_CMPRSD_INNER_VID                                (SOC_IS_QAX(unit) ? 0xb668 : (SOC_IS_JERICHO(unit)? 0xb568 : 0xb508))
#define ARAD_PP_ISEM_ACCESS_32B_INST_CMPRSD_OUTER_VID                                (SOC_IS_QAX(unit) ? 0x5af8 : (SOC_IS_JERICHO(unit)? 0x5a78 : 0x5a48))
#define ARAD_PP_ISEM_ACCESS_16B_INST_CMPRSD_OUTER_VID                                (SOC_IS_QAX(unit) ? 0xb628 : (SOC_IS_JERICHO(unit)? 0xb528 : 0xb4c8))
#define ARAD_PP_ISEM_ACCESS_32B_INST_INITIAL_VID                                     (SOC_IS_QAX(unit) ? 0x5ad8 : (SOC_IS_JERICHO(unit)? 0x5a58 : 0x5a28))
#define ARAD_PP_ISEM_ACCESS_16B_INST_INITIAL_VID                                     (SOC_IS_QAX(unit) ? 0xb5e8 : (SOC_IS_JERICHO(unit)? 0xb4e8 : 0xb488))
...
#define ARAD_PP_ISEM_ACCESS_32B_INST_IN_PORT                                         (SOC_IS_QAX(unit) ? 0x3998 : (SOC_IS_JERICHO(unit)? 0x3918 : 0x3918))
...
#define ARAD_PP_ISEM_ACCESS_32B_INST_PON_VLAN_DOMAIN                                 (SOC_IS_QAX(unit) ? 0x11b8 : (SOC_IS_JERICHO(unit)? 0x1138 : 0x1128)) /* Assumption of still 3 bits for PON.VLAN-Domain in Jericho */
#define ARAD_PP_ISEM_ACCESS_16B_INST_PON_VLAN_DOMAIN                                 (SOC_IS_QAX(unit) ? 0x23a8 : (SOC_IS_JERICHO(unit)? 0x22a8 : 0x2288)) /* Assumption of still 3 bits for PON.VLAN-Domain in Jericho */
...
#define ARAD_PP_ISEM_ACCESS_16B_INST_INITIAL_VSI_12_BIT           (SOC_IS_QAX(unit) ? 0xbae8 : (SOC_IS_JERICHO(unit)?(0xb9E8) : (0xb5e8)))
   ...
   )
{
  ...
  prog_selection_1st_cam_tbl.packet_format_code          = (0x0);  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
  prog_selection_1st_cam_tbl.packet_format_code_mask      = (0x1F);
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile         = (SOC_PPC_PORT_DEFINED_VT_PROFILE_PON_DEFAULT); /* any pon port */
   ...
   )
{
  ...
  prog_selection_1st_cam_tbl.packet_format_code          = (0x0);  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
  prog_selection_1st_cam_tbl.packet_format_code_mask      = (0x1F);
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile         = (SOC_PPC_PORT_DEFINED_VT_PROFILE_IGNORE_2ND_TAG); 
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile_mask     = (0x0);
  prog_selection_1st_cam_tbl.llvp_prog_sel                   = prog_sel;
  prog_selection_1st_cam_tbl.valid                     = (0x1);
   ...
   )
{
  ...
  prog_selection_1st_cam_tbl.packet_format_code          = (0x0);  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
  prog_selection_1st_cam_tbl.packet_format_code_mask      = (0x1F);
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile         = (SOC_PPC_PORT_DEFINED_VT_PROFILE_PON_DEFAULT); 
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile_mask     = (0x0);
  prog_selection_1st_cam_tbl.llvp_prog_sel                   = prog_sel;
  prog_selection_1st_cam_tbl.valid                     = (0x1);
   ...
   )
{
  ...
  prog_selection_1st_cam_tbl.packet_format_code          = (0x0);  /*Only PacketFormatCode[5] matters (PacketFormatCode[5]==0) ==> starts with ethernet */
  prog_selection_1st_cam_tbl.packet_format_code_mask      = (0x1F);
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile         = (SOC_PPC_PORT_DEFINED_VT_PROFILE_PON_TUNNEL_ID); 
  prog_selection_1st_cam_tbl.in_pp_port_vt_profile_mask     = (0x0);
  prog_selection_1st_cam_tbl.llvp_prog_sel                   = prog_sel;
  prog_selection_1st_cam_tbl.valid                     = (0x1);
  ...
  )
{
  ...
  /* Port Extender */
  if (SOC_IS_JERICHO(unit) && tt_programs[unit][PROG_TT_EXTENDER_UNTAG_CHECK_IP].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_UNTAG_CHECK_IP].priority[unit]  = prog_indx;
    tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_UNTAG_CHECK_IP].prog_name[unit] = ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK_IP;
  }

  if (SOC_IS_JERICHO(unit) && tt_programs[unit][PROG_TT_EXTENDER_IP_PROG].prog_used != -1)
  {
    SET_TT_PROGRAM_SELECTION(prog_indx);
    tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_CB_IP].priority[unit]  = prog_indx;
    tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_CB_IP].prog_name[unit] = ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP;
  }
...
#define prog_soc_prop g_prog_soc_prop[unit]
 ...
 /* Mac-in-MAC */
  ...
  if (SOC_DPP_CONFIG(unit)->extender.port_extender_init_status) {
       SET_TT_PROGRAM_ID(PROG_TT_EXTENDER_UNTAG_CHECK_IP);
       tt_dbal_programs[ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK_IP].prog_used[unit] = (last_tt_program_id - 1);
       SET_TT_PROGRAM_ID(PROG_TT_EXTENDER_IP_PROG);
       tt_dbal_programs[ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP].prog_used[unit] = (last_tt_program_id - 1);
  ...
  )
{
    ...
    case PROG_TT_DIP6_COMPRESSION_PROG:
      ...
      break;
    case PROG_TT_EXTENDER_UNTAG_CHECK_IP:
        prog_name = "PROG_TT_EXTENDER_UNTAG_CHECK_IP";
        break;
    ...
    case PROG_TT_TUNNEL_FOR_THREE_EXPLICIT_NULL_PROG:
        ...
        break;
    case PROG_TT_EXTENDER_IP_PROG:
        prog_name = "PROG_TT_EXTENDER_IP_PROG";
        break;
