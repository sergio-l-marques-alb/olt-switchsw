    ...
    )
{
    ...
    res = _bcm_dpp_global_lif_mapping_local_to_global_get(unit,  _BCM_DPP_GLOBAL_LIF_MAPPING_INGRESS,src_bind_info->lif_ndx,&global_lif);
    ...
    qual_vals[2].val.arr[0]= global_lif;
    ...
    qual_vals, 0/*priority*/, &tcam_payload, success);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
