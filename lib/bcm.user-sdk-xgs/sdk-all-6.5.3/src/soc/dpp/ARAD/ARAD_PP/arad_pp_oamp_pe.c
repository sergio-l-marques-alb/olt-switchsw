...
#define _ARAD_PP_OAMP_PE_NUM_DEFINED_LFEMS 5
...
STATIC uint32 _arad_pp_oamp_pe_programs_usage_init(SOC_SAND_IN  int  unit) {
    ...
    if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
       ...
       res = arad_pmf_db_fes_user_header_sizes_get( unit,
        ...
        if (SOC_IS_JERICHO(unit) && (SOC_DPP_CONFIG(unit)->pp.oam_statistics )) {
            programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM].instruction_func = _arad_pp_oamp_pe_write_inst_oamp_server_ccm_jer;
            programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM].pe_const = 0x000c0ccc;
        }
...
void _arad_pp_oamp_pe_mep_pe_init(SOC_SAND_IN uint32 unit) {
    ...
    programs[unit][ARAD_PP_OAMP_PE_PROGS_DEFAULT_CCM].mep_pe_profile = 0; /*Used in Jericho only*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER].mep_pe_profile = 1;
    programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM].mep_pe_profile = 1; /* Same as server */
    programs[unit][ARAD_PP_OAMP_PE_PROGS_ETH_TLV_ON_SERVER].mep_pe_profile = 1; /* Same as server */
    ...
    programs[unit][ARAD_PP_OAMP_PE_PROGS_UP_MEP_MAC].mep_pe_profile = 0x6; /* ARAD+ only*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_UP_MEP_UDH_DEFAULT_JER].mep_pe_profile = 0x6; /*Used in Jericho Only */
    ...
    programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_11B_END_TLV_UDH].mep_pe_profile = 0xd;
    programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_11B_END_TLV_ON_SERVER].mep_pe_profile = 2;
    programs[unit][ARAD_PP_OAMP_PE_PROGS_PPH_ADD_UDH].mep_pe_profile = 0x0;/* Ignored*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_PPH_ADD_UDH_JER].mep_pe_profile = 0x0;/* Ignored*/
    ...
    programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_48].mep_pe_profile = 0xa; /* Used in Jericho only*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_48_UDH].mep_pe_profile = 0xc; /* Used in Jericho only*/
    programs[unit][ARAD_PP_OAMP_PE_PROGS_UP_MEP_MAC_MC].mep_pe_profile = 0xb; /* used only when custom_feature_oam_itmh_mc is set*/
}
...
STATIC uint32 _arad_pp_oamp_pe_write_to_tcam(SOC_SAND_IN int unit) {
    ...
    /*Default program on Jericho for CCM packets*/
    prog_tcam_entries[tcam_ind].key  = 0;
    ...
    prog_tcam_entries[tcam_ind].dat   = programs[unit][ARAD_PP_OAMP_PE_PROGS_DEFAULT_CCM].prog_used;
    ...
    /*OAMP server on Jericho for CCM packets*/
    SET_OAMP_PE_TCAM_PACKET_TYPE(prog_tcam_entries[tcam_ind].key, ARAD_PP_OAMP_PE_TCAM_PACKET_SOURCE_MEP_GENERATED);
    SET_OAMP_PE_TCAM_PACKET_TYPE(prog_tcam_entries[tcam_ind].mask, 1); /* GENERATED + RESPONSE */
    SET_OAMP_PE_TCAM_MEP_TYPE(prog_tcam_entries[tcam_ind].key, SOC_PPC_OAM_MEP_TYPE_ETH_OAM);
    SET_OAMP_PE_TCAM_MEP_TYPE(prog_tcam_entries[tcam_ind].mask, 0);
    SET_OAMP_PE_TCAM_MEP_PROFILE(prog_tcam_entries[tcam_ind].key, 0xf);
    SET_OAMP_PE_TCAM_MEP_PROFILE(prog_tcam_entries[tcam_ind].mask, 0xf);
    SET_OAMP_PE_TCAM_MEP_PE_PROFILE_KEY(prog_tcam_entries, tcam_ind, ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM);
    SET_OAMP_PE_TCAM_MEP_PE_PROFILE(prog_tcam_entries[tcam_ind].mask, 0);
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].key, ARAD_PP_OAMP_PE_TCAM_MEP_MSG_TYPE_CCM);
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask, 0); /* Select only CCMs*/
    prog_tcam_entries[tcam_ind].dat   = programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM].prog_used;
    prog_tcam_entries[tcam_ind].valid = programs[unit][ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM].instruction_func != NULL;
    ++tcam_ind;
    ...
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].key, ARAD_PP_OAMP_PE_TCAM_MEP_MSG_TYPE_CCM);
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask, 0);
    prog_tcam_entries[tcam_ind].dat   = programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_11B_END_TLV_ON_SERVER].prog_used;
    ...
    prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_UP_MEP_MAC_MC].prog_used;
    ...
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].key, 2);
    SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask,0 );/* Only for CCMs*/
    prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_11B_END_TLV_UDH].prog_used;
    ...
    /* PPH add UDH program. Used for everything except loopback*/
     ...
     prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_DEFAULT].prog_used; /* Uses the same program as the ARAD_PP_OAMP_PE_PROGS_DEFAULT program. */
     ...
     SET_OAMP_PE_TCAM_MEP_TYPE(prog_tcam_entries[tcam_ind].mask, 0xf);
     SET_OAMP_PE_TCAM_MEP_PROFILE(prog_tcam_entries[tcam_ind].mask, 0xf);
     SET_OAMP_PE_TCAM_MEP_PE_PROFILE_KEY(prog_tcam_entries, tcam_ind, ARAD_PP_OAMP_PE_PROGS_PPH_ADD_UDH_JER);
     SET_OAMP_PE_TCAM_MEP_PE_PROFILE(prog_tcam_entries[tcam_ind].mask, 0xf);
     SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask, 0x3);
     prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_PPH_ADD_UDH_JER].prog_used;
     ...
     SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].key, ARAD_PP_OAMP_PE_TCAM_MEP_MSG_TYPE_CCM);
     SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask, 0); /* Select only CCMs*/
     prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_48].prog_used;
     ...
     SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].key, ARAD_PP_OAMP_PE_TCAM_MEP_MSG_TYPE_CCM);
     SET_OAMP_PE_TCAM_MSG_TYPE(prog_tcam_entries[tcam_ind].mask, 0); /* Select only CCMs*/
     prog_tcam_entries[tcam_ind].dat    = programs[unit][ARAD_PP_OAMP_PE_PROGS_MAID_48_UDH].prog_used;
...
uint32 _arad_pp_oamp_pe_write_inst_pph_add_udh_jer(SOC_SAND_IN int unit) {
    ...
    #14 NOP
    #15 NOP
    #16 Copy 2 bytes to buffer (bytes 9,10)
    #17 Copy 2 bytes to buffer (bytes 9,10)
...
/*  #1. copy to buffer system and encapsulation headers, and first 8 bytes of CCM PDU */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_FEM_DEF_PR(unit));
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
...
/*  #2 if OAMP_PE_OP_SEL_PDU_OFFS is multiplyer of 4, jump to TMP_REG3(`a) */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_PDU_OFFS);
    SET_OAMP_PE_OP2_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
...
/*  #5 read entry from in fifo (first 4 bytes of MEG ID - MEG-ID reserved, MEG-ID format, MEG-ID length, first byte of ccm-icc) */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_CMP2_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_NEVER);
...
/*  #6 read entry from in fifo (bytes 2,3,4,5 of ccm-icc)*/
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_CMP2_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_NEVER);
...
/*  #7 prepare address of `c in TMP_REG3*/
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
    SET_OAMP_PE_OP3_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP3_SEL_ALU_OUT);
...
/*  #8 discard byte 6 of ccm-icc, put MAID to TMP_REG4 */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_FEM2_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_FEM_DEF_PR(unit));
...
/*  #13 `a: handle pdu alligned to 4: copy MEP_ID to buffer, discard MEG-ID reserved byte, MEG-ID format byte */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_FEM_DEF_PR(unit));
...
/*  #14 read from in_fifo 4 bytes and discard them (MEG-ID length, oam-icc 1,2,3 bytes) */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_CMP2_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_NEVER);
...
/*  #15 discard oam-icc 4,5,6 bytes  and store in TMP_REG1 MAID_1 */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_FEM_DEF_PR(unit));
...
/*  #17 prepare address of `c in TMP_REG3 */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
    SET_OAMP_PE_OP3_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP3_SEL_ALU_OUT);
...
/*  #19 add TMP_REG1 and TMP_REG2 to get the 16 bits of MAID and store in TMP_REG4*/
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_TMP_REG1);
...
/*  `c:#22 next address ready in TMP_REG4, read memory at TMP_REG4 */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP3_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP3_SEL_MEM_OUT);
    SET_OAMP_PE_CMP1_ACT_BITS(reg_field, ARAD_PP_OAMP_PE_CMP_ACT_ALWAYS);
...
/*  #26 if TMP_REG2 < 24, jump to TMP_REG3 (`c) */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_MUX1_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_MUX_SRC_IN_FIFO);
    SET_OAMP_PE_MERGE1_INST_BITS(reg_field, ARAD_PP_OAMP_PE_MERGE_INST_FEM);
...
/*  #27 prepare value of 8'h3 in TMP_REG1 */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_OP1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP_SEL_INST_VAR);
    SET_OAMP_PE_OP3_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_OP3_SEL_ALU_OUT);
...
/*  #29 read 8 entries from in fifo (previous value of MAID)*/
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
...
/*  #30 copy two lower bytes, if PDU not alligned to 4*/
    SOC_REG_ABOVE_64_CLEAR(reg_data);
    SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_IN_FIFO_RD_BITS(reg_field, 1);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_FEM_DEF_PR(unit));
...
/*  #32 copy till the rest of the packet */
    SOC_SAND_SOC_IF_ERROR_RETURN(res, 13, exit,
                                 WRITE_OAMP_PE_PROGRAMm(unit, MEM_BLOCK_ALL, last_program_pointer[unit]++, reg_default_instr));
...
/*
    ...
    #5 Jump to first instruction of MAID 48 program
    #6 NOP
    #7 NOP
...
program pseudo-code:
 ...
 Add OAM statistic support
 if (SOC_IS_JERICHO(unit) && (SOC_DPP_CONFIG(unit)->pp.oam_statistics)) {
 #1 Write 2 MSB bytes (PTCH-2) to the buffer and store 2 LSB byte to TMP_REG1
 #2 Write 2 bytes MEP-Index from PKT_VAR3 to buffer
 #3 NOP
 #4 Copy 2 bytes from TMP_REG1 to buffer
 }
 #5. copy to buffer bytes 5-36
 #6. copy two buffer bytes 37,38, read the data fifo
 #7. write to buffer first two bytes of the prog. constant
 #8. copy the rest of the packet.
 */
...
/* The program adds a server part. It supports an option oam_statistics and when it presents adds 2 additional bytes of zeroes after the PTCH-2.
The program has also an option for adding an user_header_size after the ITMH.

    # Write lower two bytes of prog. variable to buffer (PTCH_2 outer), copy value of PKT REG0 to TMP_REG4
    # NOP, and set TMP_REG1 to 1
    # Read memory and store result in TMP_REG4
    # FEM1, SHIFT1 - shift left programm variable by one byte and OR it with TC/DP bits
    # NOP, Write two bytes from pkt var 1
    # Write the first byte of the first packet word, removing the two bytes bytes
    # Write one byte of TMP_REG_4 to buffer
    if (SOC_IS_JERICHO(unit) && (SOC_DPP_CONFIG(unit)->pp.oam_statistics)) {
        # Write 0x00 to buffer
        # Write 0x00 to buffer
    }
    # write the last two bytes of the first packet word, removing the two bytes bytes
    if (user_header_size) {
        ...
        # Put zeros for UDH1
        # Put zeros for UDH2
        # Copy 2 bytes shifted by 2 to buffer
    }
    # Copy the rest of the packet
...
/**
 * OAMP server instruction for CCM packets, jericho.
 * 
 * @author (05/02/2016)
 * 
 * @param unit 
...
uint32 _arad_pp_oamp_pe_write_inst_oamp_server_ccm_jer(SOC_SAND_IN int unit) {
    ...
    SET_FIRST_INSTR(fst_inst_addr, ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM);
...
if (SOC_IS_JERICHO(unit) && (SOC_DPP_CONFIG(unit)->pp.oam_statistics)) {
#4  Write 2 bytes MEP-Index from PKT_VAR3 to buffer
 }
 
#5  FEM1, SHIFT1 - shift left programm variable by one byte and OR it with TC/DP bits
#6  NOP
    Write two bytes from pkt var 1
#7  write the first byte of the first packet word, removing the two bytes bytes
#8  write one byte of TMP_REG_4 to buffer
#9  write the last two bytes of the first packet word, removing the two bytes bytes 
*/
...
/*  Write 2 bytes MEP-Index from PKT_VAR3 to buffer */
    SOC_REG_ABOVE_64_CLEAR(reg_data);
        SOC_REG_ABOVE_64_CLEAR(reg_field);
    SET_OAMP_PE_MUX1_SRC_BITS(reg_field, ARAD_PP_OAMP_PE_MUX_SRC_PKT_VAR3);
    SET_OAMP_PE_FEM1_SEL_BITS(reg_field, ARAD_PP_OAMP_PE_FEM_DEF_PR(unit));
...
STATIC uint32 _jer_pp_oamp_pe_write_pe_profiles_info(SOC_SAND_IN int unit) {
    ...
    for (prog=0 ;prog < ARAD_PP_OAMP_PE_PROGS_NOF_PROGS ; ++prog) {
        if (programs[unit][prog].prog_used != -1) {
...
)
{
    ...
    case ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER:
        *prog_name = "ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER";
        break;
    case ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM:
        *prog_name = "ARAD_PP_OAMP_PE_PROGS_OAMP_SERVER_CCM";
        break;
...
{    
    ...
    if (SOC_IS_JERICHO(unit)) {
        ...
        for (oamp_pe_id = 0; oamp_pe_id < num_oamp_pe; ++oamp_pe_id) {
            for (program_id = 0; program_id < ARAD_PP_OAMP_PE_PROGS_NOF_PROGS; program_id++) {
                if (programs[unit][program_id].prog_used == last_prog[oamp_pe_id]) {
                    _arad_pp_oamp_pe_prog_id_to_prog_name(unit, program_id, &prog_name);
                    if (num_oamp_pe > 1) {
