  ...
  )
{
  ...
  if(mac_entry_key->key_type == SOC_PPC_FRWRD_MACT_KEY_TYPE_IPV4_MC &&
                            (SOC_DPP_CONFIG(unit)->pp.ipmc_l2_ssm_mode != BCM_IPMC_SSM_DISABLE))
  {
  ...
  )
{
    ...
    {
        case SOC_PPC_FRWRD_MACT_KEY_TYPE_IPV4_MC:
            DBAL_QUAL_VAL_ENCODE_IPV4_DIP(&qual_vals[0], mac_entry_key->key_val.ipv4_mc.dip, 32);
