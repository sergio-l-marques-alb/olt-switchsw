...
/* MPLS DB's finish */                                                                                                                                                                                                      
    ...
    { 0, "VTT PORT EXTENDER PE SEMA"                 , SOC_DPP_DBAL_SW_TABLE_ID_EXTENDER_PE_SEM_A             , arad_pp_dbal_sw_db_extender_pe_sem_property_set              , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_SEM_A          , 0                       },
...
/*54*/    {ARAD_PP_DBAL_VT_PROG_EXTENDER_PE                                               , arad_pp_dbal_vt_program_extender_pe_property_set                             , {-1}    , 0               },
/*55*/    {ARAD_PP_DBAL_VT_PROG_VT_CUSTOM_PP_PORT_TUNNEL                                  , arad_pp_dbal_vt_program_custom_pp_port_tunnel_property_set                   , {-1}    , 0               }
};
...
void arad_pp_dbal_tt_program_extender_untag_check_set                   (int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 is_ip           );
...
void arad_pp_dbal_tt_program_extender_cb_set                            (int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 is_ip           );
...
/*33*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK_IP       , arad_pp_dbal_tt_program_extender_untag_check_set                    , {-1}    , 1                    },
/*34*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_UNTAG_CHECK          , arad_pp_dbal_tt_program_extender_untag_check_set                    , {-1}    , 0                    },
/*35*/    {ARAD_PP_DBAL_TT_PROG_IPV4_ROUTER_DIP_SIP_VRF       , arad_pp_dbal_tt_program_ipv4_router_dip_sip_vrf_property_set        , {-1}    , 0                    },
/*36*/    {ARAD_PP_DBAL_TT_PROG_IPV4_FOR_EXPLICIT_NULL        , arad_pp_dbal_tt_program_ipv4_for_explicit_mpls_property_set         , {-1}    , 0                    },
/*37*/    {ARAD_PP_DBAL_TT_PROG_TUNNEL_TWO_EXPLICIT_NULL      , arad_pp_dbal_tt_program_tunnel_two_explicit_mpls_property_set       , {-1}    , 0                    },
/*38*/    {ARAD_PP_DBAL_TT_PROG_TUNNEL_THREE_EXPLICIT_NULL    , arad_pp_dbal_tt_program_tunnel_three_explicit_mpls_property_set     , {-1}    , 0                    },
/*39*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB_IP                , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , 1                    },
/*40*/    {ARAD_PP_DBAL_TT_PROG_EXTENDER_CB                   , arad_pp_dbal_tt_program_extender_cb_set                             , {-1}    , 0                    }
};
...
int32 arad_pp_dbal_tt_cam_extender_untag_check_set         (int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 is_ip);
int32 arad_pp_dbal_tt_cam_extender_cb_set                  (int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 is_ip);
 ...
 *                                                                    |                                                       |          |                      */
        ...
        {ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_UNTAG_CHECK_IP       , arad_pp_dbal_tt_cam_extender_untag_check_set          , {-1}, {ARAD_PP_DBAL_TT_PROG_INVALID}, 1                    },
        ...
        {ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_CB_IP                , arad_pp_dbal_tt_cam_extender_cb_set                   , {-1}, {ARAD_PP_DBAL_TT_PROG_INVALID}, 1                    },
        {ARAD_PP_DBAL_TT_PROG_SELECTION_EXTENDER_CB                   , arad_pp_dbal_tt_cam_extender_cb_set                   , {-1}, {ARAD_PP_DBAL_TT_PROG_INVALID}, 0                    },
    ...
    for(i=0; i < ARAD_PP_DBAL_TT_NOF_PROGRAM_SELECTION; i++)
    {
        ...
        if(tt_dbal_program_selection[i].prog_name[unit] != ARAD_PP_DBAL_TT_PROG_INVALID)
        {
            ...
            while(next_line != -1)
            {
                ...
                /* default init for enable_routing */
                tt_prog_selection.enable_routing_mask = 1;
