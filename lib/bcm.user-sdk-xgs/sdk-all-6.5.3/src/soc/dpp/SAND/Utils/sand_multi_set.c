  ...
  )
{
  ...
  *multis_array_ptr_ptr = sw_state[unit]->dpp.soc.sand.multi_set->multis_array[multi_set_index] ;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR( "error in soc_sand_multi_set_get_multis_array_ptr_from_handle()",0,0);
}
/*
