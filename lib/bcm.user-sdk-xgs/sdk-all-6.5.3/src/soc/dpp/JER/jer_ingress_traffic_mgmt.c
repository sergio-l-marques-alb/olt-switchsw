      ...
      SOC_SAND_OUT soc_dpp_ingress_congestion_mgmt_t *ingress_congestion_mgmt)
{
    ...
    uint8 is_ocb_only = 0;
    soc_dpp_ingress_reserved_resource_t ingress_reserved_resource;
    soc_dpp_ingress_congestion_resource_t *resource;
    soc_jer_ocb_dram_dbuffs_bound_t *dbuffs_bdries;
      ...
      SOC_SAND_IN soc_dpp_ingress_congestion_mgmt_t *ingress_congestion_mgmt)
{
    ...
    uint8 is_ocb_only = 0;
    soc_dpp_ingress_reserved_resource_t ingress_reserved_resource;
    const soc_dpp_ingress_congestion_resource_t *resource;
