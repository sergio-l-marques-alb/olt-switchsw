...
int
	...
	soc_reg_field_set(unit, glbl_cfg_reg, &reg_val, HIERARCHICAL_MODEf, 0);
...
int
	...
	soc_reg_field_set(unit, mcdb_refresh_reg, &reg_val_b, MCDB_REFRESH_END_INDEXf, 0x13f);
