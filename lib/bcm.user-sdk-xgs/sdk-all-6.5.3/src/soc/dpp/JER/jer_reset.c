...
/*        fmc_scheduler_configs_reg_val_orig,*/
    ...
    */
    ...
    if (is_ingr) {
        ...
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, BLOCKS_SOFT_INIT_5f, fld_above64_val);/* MTRPS_EM0_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, BLOCKS_SOFT_INIT_6f, fld_above64_val);/* MTRPS_EM1_BLKID */
        ...
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_59f : BLOCKS_SOFT_INIT_55f, fld_above64_val);/* CFC_BLKID   */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_60f : BLOCKS_SOFT_INIT_56f, fld_above64_val);/* OAMP_BLKID  */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_61f : BLOCKS_SOFT_INIT_57f, fld_above64_val);/* OLP_BLKID   */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_62f : BLOCKS_SOFT_INIT_58f, fld_above64_val);/* IHP0_BLKID  */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_63f : BLOCKS_SOFT_INIT_59f, fld_above64_val);/* IHP1_BLKID  */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_64f : BLOCKS_SOFT_INIT_60f, fld_above64_val);/* IHB0_BLKID  */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_65f : BLOCKS_SOFT_INIT_61f, fld_above64_val);/* IHB1_BLKID  */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_66f : BLOCKS_SOFT_INIT_62f, fld_above64_val);/* KAPS_BLKID   */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_70f : BLOCKS_SOFT_INIT_63f, fld_above64_val);/* PPDB_A_BLKID*/
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_71f : BLOCKS_SOFT_INIT_64f, fld_above64_val);/* PPDB_B_BLKID*/
        if (is_fabric == 0x1) {
    ...
    if (is_egr) {
        ...
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_50f : BLOCKS_SOFT_INIT_46f, fld_above64_val);/* EGQ0_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_51f : BLOCKS_SOFT_INIT_47f, fld_above64_val);/* EGQ1_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_52f : BLOCKS_SOFT_INIT_48f, fld_above64_val);/* EPNI0_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_53f : BLOCKS_SOFT_INIT_49f, fld_above64_val);/* EPNI1_BLKID */
        SOCDNX_IF_ERR_EXIT(WRITE_ECI_BLOCKS_SOFT_INITr(unit, soft_init_reg_val));
        ...
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_111f : BLOCKS_SOFT_INIT_104f, fld_above64_val);/* NBIH_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_112f : BLOCKS_SOFT_INIT_105f, fld_above64_val);/* NBIL0_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_113f : BLOCKS_SOFT_INIT_106f, fld_above64_val);/* NBIL1_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_54f : BLOCKS_SOFT_INIT_50f, fld_above64_val);/* CGM0_BLKID   */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_55f : BLOCKS_SOFT_INIT_51f, fld_above64_val);/* CGM1_BLKID   */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_59f : BLOCKS_SOFT_INIT_55f, fld_above64_val);/* CFC_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_60f : BLOCKS_SOFT_INIT_56f, fld_above64_val);/* OAMP_BLKID */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_61f : BLOCKS_SOFT_INIT_57f, fld_above64_val);/* OLP_BLKID */
    ...
    if(is_egr) {
        ...
        /* NOTE: EDB must be reset before EGQ/EPNI */
        soc_reg_above_64_field_set(unit, ECI_BLOCKS_SOFT_INITr, soft_init_reg_val, SOC_IS_JERICHO_PLUS_A0(unit) ? BLOCKS_SOFT_INIT_56f : BLOCKS_SOFT_INIT_52f, fld_above64_val);/* EDB_BLKID */
        SOCDNX_IF_ERR_EXIT(WRITE_ECI_BLOCKS_SOFT_INITr(unit, soft_init_reg_val));
    ...
    int reset_action)
{
    ...
    if ((SOC_CONTROL(unit)->soc_flags & SOC_F_INITED) == 0) {
        int stable_size = soc_property_get(unit, spn_STABLE_SIZE,
        ...
        SOCDNX_IF_ERR_RETURN(shr_sw_state_init(unit, 0x0, socSwStateDataBlockRegularInit, stable_size));
