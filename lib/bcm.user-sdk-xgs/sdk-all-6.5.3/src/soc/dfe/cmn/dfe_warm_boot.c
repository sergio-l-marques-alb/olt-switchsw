...
soc_dfe_warm_boot_engine_init_buffer_struct(int unit, int buffer_id)
{
    ...
    switch (buffer_id)
    {
        case SOC_DFE_WARM_BOOT_BUFFER_MODID:
            /*Create buffer*/
            SOC_WB_ENGINE_ADD_BUFF(SOC_DFE_WARM_BOOT_ENGINE, buffer_id, "Fabric modid buffer", NULL, DFE_VER(1), 1, SOC_WB_ENGINE_PRE_RELEASE);
            SOCDNX_IF_ERR_EXIT(rv);
        ...
        case SOC_DFE_WARM_BOOT_BUFFER_MC:
            /*Create buffer*/
            SOC_WB_ENGINE_ADD_BUFF(SOC_DFE_WARM_BOOT_ENGINE, buffer_id, "MC buffer", NULL, DFE_VER(1), 1, SOC_WB_ENGINE_PRE_RELEASE);
            SOCDNX_IF_ERR_EXIT(rv);
        ...
        case SOC_DFE_WARM_BOOT_BUFFER_FIFO:
            /*Create buffer*/
            SOC_WB_ENGINE_ADD_BUFF(SOC_DFE_WARM_BOOT_ENGINE, buffer_id, "FIFO handles", NULL, DFE_VER(1), 1, SOC_WB_ENGINE_PRE_RELEASE);
            SOCDNX_IF_ERR_EXIT(rv);
        ...
        case SOC_DFE_WARM_BOOT_BUFFER_PORT:
            /*Create buffer*/
            SOC_WB_ENGINE_ADD_BUFF(SOC_DFE_WARM_BOOT_ENGINE, buffer_id, "Port params", NULL, DFE_VER(1), 1, SOC_WB_ENGINE_PRE_RELEASE);
            SOCDNX_IF_ERR_EXIT(rv);
       ...
       case SOC_DFE_WARM_BOOT_BUFFER_INTR:
            /*Create buffer*/
            SOC_WB_ENGINE_ADD_BUFF(SOC_DFE_WARM_BOOT_ENGINE, buffer_id, "Interrupts params", NULL, DFE_VER(1), 1, SOC_WB_ENGINE_PRE_RELEASE);
            SOCDNX_IF_ERR_EXIT(rv);
        ...
        case SOC_DFE_WARM_BOOT_BUFFER_ISOLATE:
            /*Create buffer*/
            SOC_WB_ENGINE_ADD_BUFF(SOC_DFE_WARM_BOOT_ENGINE, buffer_id, "Isolation params", NULL, DFE_VER(1), 1, SOC_WB_ENGINE_PRE_RELEASE);
            SOCDNX_IF_ERR_EXIT(rv);
