...
soc_ser_test_functions_t ser_hr3_test_func;
...
soc_hr3_ser_test_register(int unit)
{
    ...
    memset(&ser_hr3_test_func, 0, sizeof(soc_ser_test_functions_t));
    ser_hr3_test_func.inject_error_f = &soc_hr3_ser_inject_error;
    ser_hr3_test_func.test_mem = &soc_hr3_ser_test_mem;
    ser_hr3_test_func.test = &soc_hr3_ser_test;

    soc_ser_test_functions_register(unit, &ser_hr3_test_func);
}
