...
#define QAX_FLOW_ID_OFFSET (64*1024)
#define BCM_COSQ_FLOW_ID_QAX_ADD_OFFSET(id) (id + QAX_FLOW_ID_OFFSET)
#define BCM_COSQ_FLOW_ID_QAX_SUB_OFFSET(id) (id - QAX_FLOW_ID_OFFSET)
...
typedef struct bcm_dpp_cosq_egress_thresh_key_info_s {
    ...
    uint32                          unsch_drop_packet_descriptors_alpha_tc_dp[DPP_DEVICE_COSQ_EGR_NOF_TC][DPP_DEVICE_COSQ_EGR_NOF_DP];

    uint32                          sch_fc_packet_descriptors_min_tc[DPP_DEVICE_COSQ_EGR_NOF_TC];
    uint32                          sch_fc_packet_descriptors_alpha_tc[DPP_DEVICE_COSQ_EGR_NOF_TC];
    uint32                          sch_fc_data_buffers_min_tc[DPP_DEVICE_COSQ_EGR_NOF_TC];
    uint32                          sch_fc_data_buffers_alpha_tc[DPP_DEVICE_COSQ_EGR_NOF_TC];
...
typedef struct bcm_dpp_cosq_vsq_rate_class_wred_info_s {
    ...
    /* WRED exp. weight */
    /*uint32                          wred_exp_wq[DPP_DEVICE_COSQ_VSQ_NOF_CATEGORY_MAX];*/
...
typedef struct bcm_dpp_cosq_src_port_vsq_rate_class_info_s {
    ...
    bcm_dpp_cosq_vsq_rate_class_fc_info_t       fc;
    /*Max VSQ guaranteed occupancy threshold*/
...
int
_bcm_petra_flow_region_config_get(int unit, int core, int flow_region, uint8 *p_is_interdigitated, int *p_is_oddEven);
...
void
_bcm_petra_cosq_gport_qax_flow_id_add(bcm_gport_t *gport, int core);
