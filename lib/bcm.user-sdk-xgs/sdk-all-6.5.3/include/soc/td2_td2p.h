...
#define _TD2P_MMU_ASF_CREDIT_THRESH_OPTIMIZED_HI_40G  18
...
extern int soc_td2p_port_mixed_sister_speed_validate(int unit);
extern int soc_td2p_port_mixed_sister_encap_validate(int unit);
extern int soc_td2p_port_mixed_sister_encap_check(int unit, soc_port_t port, int mode);
