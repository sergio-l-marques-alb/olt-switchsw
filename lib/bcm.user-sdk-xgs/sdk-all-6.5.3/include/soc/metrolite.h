...
#define ML_MIN_SUBPORT_INDEX          14
#define ML_MAX_SUBPORTS               16
/* Max 6 streams per linkphy port.
 * So we can support max of 6 subports per linkphy port.
 */
#define ML_MAX_LINKPHY_SUBPORTS_PER_PORT     4
#define ML_MAX_LINKPHY_STREAMS_PER_PORT      6 
#define ML_MAX_STREAMS_PER_SLICE             24
