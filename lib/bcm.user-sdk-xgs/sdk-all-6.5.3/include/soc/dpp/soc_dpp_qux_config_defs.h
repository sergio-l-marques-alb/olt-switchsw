...
#define SOC_DPP_NOF_QUEUES_QUX                               (32*1024)
#define SOC_DPP_NOF_QUEUES_PER_PIPE_QUX                      (32*1024)
#define SOC_DPP_MAX_QUEUES_QUX                               ((32*1024) - 32)
#define SOC_DPP_OCB_MEMORY_SIZE_QUX                          (128)
#define SOC_DPP_HW_DRAM_INTERFACES_MAX_QUX                   (3)
#define SOC_DPP_NOF_COUNTER_PROCESSORS_QUX                   (16)
#define SOC_DPP_COUNTERS_PER_COUNTER_PROCESSOR_QUX           (16 * 1024)
#define SOC_DPP_NOF_SMALL_COUNTER_PROCESSORS_QUX             (2)
...
#define SOC_DPP_NOF_LOCAL_LIFS_QUX                           (128 * 1024)
...
#define SOC_DPP_NOF_LEM_LINES_QUX                            (256 * 1024)
#define SOC_DPP_NOF_LEM_BANKS_QUX                            (8)
#define SOC_DPP_LEM_PAYLOAD_WIDTH_QUX                        (45)
#define SOC_DPP_NOF_LEM_PREFIXES_QUX                         (5)
#define SOC_DPP_LPM_WIDTH_QUX                                (144)
#define SOC_DPP_NOF_LPM_LINES_QUX                            (64 * 1024)
#define SOC_DPP_NOF_LPM_PAYLOADS_QUX                         (20)
#define SOC_DPP_EEDB_WIDTH_QUX                               (18)
#define SOC_DPP_NOF_EEDB_LINES_PER_BANK_QUX                  (4096)
#define SOC_DPP_NOF_EEDB_LINES_QUX                           (80 * 1024)
...
#define SOC_DPP_NOF_FEC_PAYLOADS_QUX                         (126)
...
#define SOC_DPP_NOF_VSI_LOWERS_QUX                           (16 * 1024)
#define SOC_DPP_NOF_VSI_UPPERS_QUX                           (16 * 1024)
#define SOC_DPP_IN_RIF_NOF_BITS_QUX                          (15)
#define SOC_DPP_NOF_RIFS_QUX                                 (8 * 1024)
#define SOC_DPP_NOF_RIF_PAYLOADS_QUX                         (24)
#define SOC_DPP_OEM1_WIDSTH_QUX                              (20)
#define SOC_DPP_NOF_OEM1_LINES_QUX                           (32 * 1024)
#define SOC_DPP_NOF_OEM1_PAYLOADS_QUX                        (35)
#define SOC_DPP_OEM2_WIDSTH_QUX                              (23)
#define SOC_DPP_NOF_OEM2_LINES_QUX                           (16 * 1024)
#define SOC_DPP_NOF_OEM2_PAYLOADS_QUX                        (18)
#define SOC_DPP_RMEP_EM_WIDTH_QUX                            (27)
#define SOC_DPP_NOF_RMEP_EM_LINES_QUX                        (32 * 1024)
#define SOC_DPP_NOF_RMEP_EM_PAYLOADS_QUX                     (15)
...
#define SOC_DPP_IN_PP_PORT_FORWARDING_LOOKUP_PROFILE_NOF_BITS_QUX (5)
#define SOC_DPP_NOF_CORES_QUX                                (1)
#define SOC_DPP_MAX_MACT_LIMIT_QUX                           (256 * 1024 - 1)
...
#define SOC_DPP_EG_ENCAP_NOF_BANKS_QUX                       (20)
#define SOC_DPP_EG_ENCAP_NOF_TOP_BANKS_QUX                   (8)
...
#define SOC_DPP_OAMP_NUMBER_OF_SD_SF_DB_QUX                  (0)
#define SOC_DPP_OAMP_NUMBER_OF_SD_SF_Y_1711_DB_QUX           (0)
#define SOC_DPP_OAMP_NUMBER_OF_SD_SF_PROFILES_QUX            (0)
...
#define SOC_DPP_INLIF_BANK_MSBS_MASK_START_QUX               (0)
...
#define SOC_DPP_NOF_PM4X25_QUX                               (4)
#define SOC_DPP_NOF_PM4X10_QUX                               (8)
#define SOC_DPP_NOF_PM4X10Q_QUX                              (6)
#define SOC_DPP_PMH_BASE_LANE_QUX                            (0)
#define SOC_DPP_PML_BASE_LANE_QUX                            (16)
