...
#define SOC_QAX_NOF_INSTANCES_CGM           2
#define SOC_QAX_NOF_INSTANCES_CLP           6
...
#define SOC_QAX_NOF_INSTANCES_DRCD          1
#define SOC_QAX_NOF_INSTANCES_DRCE          1
#define SOC_QAX_NOF_INSTANCES_DRCF          1
#define SOC_QAX_NOF_INSTANCES_DRCG          1
#define SOC_QAX_NOF_INSTANCES_DRCH          1
#define SOC_QAX_NOF_INSTANCES_ECI           1
#define SOC_QAX_NOF_INSTANCES_EGQ           2
#define SOC_QAX_NOF_INSTANCES_EPNI          2
...
#define SOC_QAX_NOF_INSTANCES_IHB           2
#define SOC_QAX_NOF_INSTANCES_IHP           2
#define SOC_QAX_NOF_INSTANCES_IPS           2
...
#define SOC_QAX_NOF_INSTANCES_SCH           2
#define SOC_QAX_NOF_INSTANCES_XLP           12
#define SOC_QAX_NOF_INSTANCES_ILKN_PML      2
...
#define SOC_QAX_NOF_INSTANCES_FMAC          9
