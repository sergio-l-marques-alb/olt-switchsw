...
typedef enum
{
    ...
    ARAD_EGR_PROG_EDITOR_PROG_MPLS_EXTENDED_JER, /* Segment Routing */
...
typedef enum
{
    ...
    ARAD_EGR_PROG_EDITOR_LFEM_XTMH_FLOW_ID,
...
typedef struct
{
  ...
  uint8 customer_conn_to_np_debug;
  uint8 customer_ftmh_dsp_extension_add;
  uint8 customer_ftmh_lb_extension_add;
