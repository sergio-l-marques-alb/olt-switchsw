...
#define ARAD_PP_LEM_ACCESS_KEY_NOF_PARAMS_FOR_COUPLING_ILM  (2)
...
#define ARAD_PP_LEM_ACCESS_KEY_PREFIX_FOR_COUPLING_ILM                  (ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_COUPLING_ILM)
...
#define ARAD_PP_LEM_ACCESS_KEY_PREFIX_SIZE_IN_BITS_FOR_COUPLING_ILM     SOC_DPP_DEFS_GET(unit, nof_lem_prefixes)
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_COUPLING_ILM (20)
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_COUPLING_ILM (20)
...
#define ARAD_PP_LEM_ACCESS_GROUP_LSB                        (36-32)
#define ARAD_PP_LEM_ACCESS_GROUP_MSB                          (38-32)

#define ARAD_PP_LEM_ACCESS_ENTRY_TYPE_LSB                        (39-32)
#define ARAD_PP_LEM_ACCESS_ENTRY_TYPE_MSB                         (40-32)
...
#define  ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_COUPLING_ILM        (ARAD_PP_FLP_COUPLING_LSR_KEY_OR_MASK) /*ILM */ /* ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_1100 */
...
#define  ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_OAM_STATISTICS      (ARAD_PP_FLP_OAM_STATISTICS_KEY_OR_MASK)
#define  ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_BFD_STATISTICS      (ARAD_PP_FLP_BFD_STATISTICS_KEY_OR_MASK)
#define  ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_OAM_DOWN_UNTAGGED_STATISTICS      (ARAD_PP_FLP_OAM_DOWN_UNTAGGED_STATISTICS_KEY_OR_MASK)
#define  ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_OAM_SINGLE_TAG_STATISTICS      (ARAD_PP_FLP_OAM_SINGLE_TAG_STATISTICS_KEY_OR_MASK)
#define  ARAD_PP_LEM_ACCESS_KEY_TYPE_PREFIX_OAM_DOUBLE_TAG_STATISTICS      (ARAD_PP_FLP_OAM_DOUBLE_TAG_STATISTICS_KEY_OR_MASK)
...
typedef enum
{
   ...
   *  
   */
   ARAD_PP_LEM_ACCESS_KEY_TYPE_COUPLING_ILM, /*= ARAD_PP_FLP_COUPLING_LSR_KEY_OR_MASK,*/
  /*
   *  extended p2p
   */
   ...
   * oam_statistics
   */
  ARAD_PP_LEM_ACCESS_KEY_TYPE_OAM_STATISTICS = ARAD_PP_FLP_OAM_STATISTICS_KEY_OR_MASK,
  ARAD_PP_LEM_ACCESS_KEY_TYPE_BFD_STATISTICS = ARAD_PP_FLP_BFD_STATISTICS_KEY_OR_MASK,
  ARAD_PP_LEM_ACCESS_KEY_TYPE_OAM_DOWN_UNTAGGED_STATISTICS = ARAD_PP_FLP_OAM_DOWN_UNTAGGED_STATISTICS_KEY_OR_MASK,
  ARAD_PP_LEM_ACCESS_KEY_TYPE_OAM_SINGLE_TAG_STATISTICS = ARAD_PP_FLP_OAM_SINGLE_TAG_STATISTICS_KEY_OR_MASK,
  ARAD_PP_LEM_ACCESS_KEY_TYPE_OAM_DOUBLE_TAG_STATISTICS = ARAD_PP_FLP_OAM_DOUBLE_TAG_STATISTICS_KEY_OR_MASK,
...
/* what is the type of learning data, EEI or outlif, or none */
#define ARAD_PP_LEM_ACCESS_ASD_NONE           (ARAD_PP_FWD_DECISION_PARSE_DEST)
#define ARAD_PP_LEM_ACCESS_ASD_EEI            (ARAD_PP_FWD_DECISION_PARSE_EEI)
#define ARAD_PP_LEM_ACCESS_ASD_OUTLIF         (ARAD_PP_FWD_DECISION_PARSE_OULTIF)
#define ARAD_PP_LEM_ACCESS_ASD_OUTLIF_INVALID (ARAD_PP_FWD_DECISION_PARSE_OUTLIF_INVALID)
#define ARAD_PP_LEM_ACCESS_ASD_FORMAT_3       (ARAD_PP_FWD_DECISION_PARSE_FORMAT_3)
#define ARAD_PP_LEM_ACCESS_ASD_FORMAT_3B      (ARAD_PP_FWD_DECISION_PARSE_FORMAT_3B)
#define ARAD_PP_LEM_ACCESS_ASD_RAW_DATA       (ARAD_PP_FWD_DECISION_PARSE_RAW_DATA)
#define ARAD_PP_LEM_ACCESS_ASD_IS_LEARN       (ARAD_PP_FWD_DECISION_PARSE_IS_LEARN)
#define ARAD_PP_LEM_ACCESS_ENTRY_ACCESSED     (ARAD_PP_FWD_DECISION_PARSE_LAST << 1)
