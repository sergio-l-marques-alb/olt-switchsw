 ...
 *************/
/* { */
#define ARAD_PP_EG_ENCAP_NOF_RIF_BANKS_TYPE(rif_max_id)  ( ( rif_max_id %_BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_HALF_BANK(unit) ) ? rif_max_id / _BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_HALF_BANK(unit) + 1 :   rif_max_id / _BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_HALF_BANK(unit)    )
#define ARAD_PP_EG_ENCAP_NOF_RIF_BANKS_PHASE(rif_max_id) ( ( rif_max_id %_BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_BANK(unit) ) ? ( rif_max_id / _BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_BANK(unit) )*2 + 2  :   ( rif_max_id / _BCM_DPP_AM_EGRESS_LIF_NOF_ENTRIES_PER_BANK(unit) )*2   )
