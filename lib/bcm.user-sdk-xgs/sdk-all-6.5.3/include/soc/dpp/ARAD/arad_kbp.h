...
#define ARAD_KBP_IPV4DC_RES2_PAD_BYTES	(3)
#define ARAD_KBP_IPV4DC_RES3_PAD_BYTES	(6)
...
typedef enum
{
    ...
    ARAD_KBP_FRWRD_DB_NOF_TYPE_ARAD = ARAD_KBP_FRWRD_DB_TYPE_TRILL_MC,
    /* Exclusive*/
    ARAD_KBP_FRWRD_DB_TYPE_IPV4_DC,
    ...
    ARAD_KBP_FRWRD_DB_NOF_TYPE_ARAD_PLUS = ARAD_KBP_FRWRD_DB_TYPE_INRIF_MAPPING,
...
int
  arad_kbp_print_diag_all_entries(int unit);
