...
#define SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_INDEX_TYPE_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_MAC_LSB_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_PORT_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_PROG_PROFILE_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_INDEX_TYPE_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_MAC_LSB_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_PORT_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_PROG_PROFILE_LAYOUT_NOF_MAX_LAYOUT_NODES) 
#define SW_STATE_DPP_BCM_L2_INDEX_CONTROL_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_BCM_L2_INDEX_CONTROL_INDEX_ENTRY_LAYOUT_NOF_MAX_LAYOUT_NODES) 
#define SW_STATE_DPP_BCM_L2_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_BCM_L2_MYMAC_MSB_IS_SET_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_L2_INITIALIZED_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_BCM_PETRA_L2_FREEZE_STATE_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_MPLS_EXTENDED_LABEL_ETHER_TYPE_INDEX_TABLE_IS_SET_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_BCM_L2_INDEX_CONTROL_LAYOUT_NOF_MAX_LAYOUT_NODES) 
