...
#define SW_STATE_DPP_BCM_OAM_TRAPS_REF_COUNTER_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
...
#define SW_STATE_DPP_BCM_OAM_IS_INTERNALLY_ALLOCATED_TRAP_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
