/*
 * $Id: vlan.c 1.262.2.2 Broadcom SDK $
                       ...
                       pbmp_t ing_pbmp)
{
    ...
    return _bcm_xgs3_vlan_table_port_add(unit, vid, pbmp, ubmp, ing_pbmp,
                                         VLAN_TABm);
}
...
bcm_xgs3_vlan_port_remove(int unit, bcm_vlan_t vid, pbmp_t pbmp)
{
    ...
    return _bcm_xgs3_vlan_table_port_remove(unit, vid, pbmp, VLAN_TABm);
}
