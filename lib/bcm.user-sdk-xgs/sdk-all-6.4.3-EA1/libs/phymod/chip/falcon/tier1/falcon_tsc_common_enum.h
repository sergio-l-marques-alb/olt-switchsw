...
enum _falcon_comn_prbs_checker_mode_enum {
...
enum _falcon_comn_tx_pi_freq_jit_gen_enum {
  TX_PI_FIXED_FREQ      = 0,
...
enum _falcon_comn_rx_afe_settings_enum {
	RX_AFE_PF,
	RX_AFE_PF2,
	RX_AFE_VGA,
	RX_AFE_DFE1,
...
enum _falcon_comn_tx_afe_settings_enum {
	TX_AFE_PRE,
	TX_AFE_MAIN,
	TX_AFE_POST1,
	TX_AFE_POST2,
...
enum _falcon_comn_afe_drivermode_enum {
    DM_DEFAULT = 0,
    DM_NOT_SUPPORTED,
    DM_HALF_AMPLITUDE,
...
enum _falcon_comn_rptr_mode_enum {
    DATA_IN_SIDE,
    DIG_LPBK_SIDE
};

enum _falcon_comn_core_pwrdn_mode_enum {
	PWR_ON,
	PWRDN,
	PWRDN_DEEP,
	PWRDN_TX,
...
enum _falcon_comn_event_log_display_mode_enum {
	EVENT_LOG_HEX,
	EVENT_LOG_DECODED,
...
enum _falcon_comn_eye_scan_dir_enum {
      EYE_SCAN_HORIZ = 0,
      EYE_SCAN_VERTICAL = 1
};
