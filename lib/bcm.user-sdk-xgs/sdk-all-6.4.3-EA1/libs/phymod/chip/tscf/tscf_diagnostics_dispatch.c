...
__phymod_diagnostics__dispatch__t__ phymod_diagnostics_tscf_diagnostics_driver = {
    ...
    tscf_phy_diagnostics_get,
    tscf_phy_pmd_info_dump,
    tscf_phy_pcs_info_dump,
    tscf_phy_meas_lowber_eye,
    tscf_phy_display_lowber_eye,
    NULL, /* phymod_phy_pmd_ber_end_cmd */
    tscf_phy_meas_eye_scan_start,
    tscf_phy_read_eye_scan_stripe,
    tscf_phy_display_eye_scan_header,
    tscf_phy_display_eye_scan_stripe,
    tscf_phy_display_eye_scan_footer,
    tscf_phy_meas_eye_scan_done,
    tscf_phy_eye_scan_debug_info_dump,
