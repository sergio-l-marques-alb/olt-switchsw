...
typedef int (*__dispatch__phymod_phy_ladder_setting_to_mV_f)(const phymod_phy_access_t* phy, int8_t y, int16_t* level);
...
typedef struct __phymod_diagnostics__dispatch__s__ {
    ...
    __dispatch__phymod_phy_ladder_setting_to_mV_f                                    f_phymod_phy_ladder_setting_to_mV;
