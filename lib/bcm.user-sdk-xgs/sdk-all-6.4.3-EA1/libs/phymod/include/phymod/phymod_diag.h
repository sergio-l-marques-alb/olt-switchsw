...
int phymod_diag_eyescan_run_uc(phymod_phy_access_t *phys, int num_phys);
int phymod_diag_eyescan_run_lowber(phymod_phy_access_t *phys, int* line_rates, int num_phys, phymod_phy_eyescan_options_t* eyescan_options);
