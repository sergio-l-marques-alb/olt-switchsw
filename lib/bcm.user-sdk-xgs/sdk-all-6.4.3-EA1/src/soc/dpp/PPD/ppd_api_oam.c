  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_classifier_oam1_entries_insert_default_profile,
								(unit, profile_data, cpu_trap_code_to_mirror_profile_map, is_bfd));
...
*********************************************************************/
uint32
  soc_ppd_oam_tcam_bfd_lsp_ipv4_entry_add(
    SOC_SAND_IN  int                                 unit,
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_tcam_bfd_lsp_ipv4_entry_add,(unit, your_discriminator, in_lif, tcam_entry));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_tcam_bfd_lsp_ipv4_entry_add,(unit, your_discriminator, in_lif));
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_oam_tcam_bfd_lsp_ipv4_entry_add()", your_discriminator, 0);
}

/*********************************************************************
*      Delete BFD LSP IPv4 entry to TCAM
*     Details: in the H file. (search for prototype)
*********************************************************************/
uint32
  soc_ppd_oam_tcam_bfd_lsp_ipv4_entry_delete(
    SOC_SAND_IN  int                                 unit,
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_tcam_bfd_lsp_ipv4_entry_delete,(unit, tcam_entry));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_tcam_bfd_lsp_ipv4_entry_delete,(unit, tcam_entry));
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_oam_tcam_bfd_lsp_ipv4_entry_delete()", tcam_entry, 0);
}
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_classifier_find_mep_and_profile_by_lif_and_mdlevel,(unit, lif, md_level, is_upmep, found_mep, profile, found_profile, is_mp_type_flexible));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(oam_classifier_find_mep_and_profile_by_lif_and_mdlevel,(unit, lif, md_level, is_upmep, found_mep, profile, found_profile, is_mp_type_flexible));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_pp_pct_profile_set,(unit, local_port_ndx, oam_profile));

  SOC_PPD_DO_NOTHING_AND_EXIT;
exit:
  SOC_PPD_FUNC_PRINT(soc_ppd_oam_pp_pct_profile_set,(unit, local_port_ndx, oam_profile));
  ...
  )
{
  ...
  SOC_PPD_ARAD_ONLY_DEVICE_CALL(oam_pp_pct_profile_get,(unit, local_port_ndx, oam_profile));
