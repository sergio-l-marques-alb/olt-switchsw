  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_filter_port_info_set,(unit, out_port_ndx, port_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_filter_port_info_get,(unit, out_port_ndx, port_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_filter_vsi_port_membership_set,(unit, vsid_ndx, out_port_ndx, is_member));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_filter_vsi_port_membership_get,(unit, vsid_ndx, out_port_ndx, is_member));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(eg_filter_vsi_membership_get,(unit, vsid_ndx, ports));
