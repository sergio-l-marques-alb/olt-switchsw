  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(port_info_set,(unit, local_port_ndx, port_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(port_info_get,(unit, local_port_ndx, port_info));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(port_stp_state_set,(unit, local_port_ndx, topology_id_ndx, stp_state));
  ...
  )
{
  ...
  SOC_PPD_ARAD_TMP_DEVICE_CALL(port_stp_state_get,(unit, local_port_ndx, topology_id_ndx, stp_state));
