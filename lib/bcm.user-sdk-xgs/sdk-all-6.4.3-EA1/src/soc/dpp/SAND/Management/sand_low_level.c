...
Soc_sand_ll_timer_cnt[cnt_ndx].name, 
                 ...
                 (Soc_sand_ll_timer_cnt[cnt_ndx].total_time * 100)/Soc_sand_ll_timer_total,
                 (Soc_sand_ll_timer_cnt[cnt_ndx].total_time * 1000)/Soc_sand_ll_timer_total - ((Soc_sand_ll_timer_cnt[cnt_ndx].total_time * 100)/Soc_sand_ll_timer_total)*10
                 ));
        LOG_CLI((BSL_META(" +-----------------------------------------------------------------------------------------+\n\r")));
      }
    }
