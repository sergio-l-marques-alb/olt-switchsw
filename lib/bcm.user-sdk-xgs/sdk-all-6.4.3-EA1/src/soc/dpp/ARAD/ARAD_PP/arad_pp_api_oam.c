...
/*********************************************************************
*     Add BFD LSP IPv4 entry to TCAM
 *    Details: in the H file. (search for prototype)
*********************************************************************/
uint32
  arad_pp_oam_tcam_bfd_lsp_ipv4_entry_add(
    SOC_SAND_IN  int                                 unit,
  ...
  )
{
  ...
  res = arad_pp_oam_tcam_bfd_lsp_ipv4_entry_add_verify(
		unit,
		your_discriminator,
        in_lif,
		tcam_entry
  ...
  res = arad_pp_oam_tcam_bfd_lsp_ipv4_entry_add_unsafe(
		unit,
		your_discriminator,
        in_lif,
		tcam_entry
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_tcam_bfd_lsp_ipv4_entry_add()", 0, 0);
}
...
*********************************************************************/
uint32
  arad_pp_oam_tcam_bfd_lsp_ipv4_entry_delete(
    SOC_SAND_IN  int                                 unit,
  ...
  )
{
  ...
  res = arad_pp_oam_tcam_bfd_lsp_ipv4_entry_delete_verify(
		unit,
		tcam_entry
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = arad_pp_oam_tcam_bfd_lsp_ipv4_entry_delete_unsafe(
		unit,
		tcam_entry
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_oam_tcam_bfd_lsp_ipv4_entry_delete()", 0, 0);
}
  ...
  )
{
  ...
  res = arad_pp_oam_bfd_my_bfd_dip_ipv4_set_verify(
          unit,
          dip_index,
		  dip							
        );
  ...
  res = arad_pp_oam_bfd_my_bfd_dip_ipv4_set_unsafe(
          unit,
          dip_index,
		  dip
        );
  ...
  )
{
  ...
  res = arad_pp_oam_bfd_my_bfd_dip_ipv4_get_verify(
          unit,
          dip_index							
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = arad_pp_oam_bfd_my_bfd_dip_ipv4_get_unsafe(
          unit,
          dip_index,
		  dip
        );
  ...
  )
{
    ...
    res = arad_pp_oam_oamp_lm_dm_remove_verify(unit, endpoint_id,is_lm, num_removed , removed_index);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

    SOC_SAND_TAKE_DEVICE_SEMAPHORE;

    res = arad_pp_oam_oamp_lm_dm_remove_unsafe(unit, endpoint_id,is_lm, num_removed , removed_index);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
       ...
       )
{
    ...
    res = arad_pp_oam_oamp_loopback_set_verify(unit, endpoint_id,tx_period,mac_address ,is_added);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

    SOC_SAND_TAKE_DEVICE_SEMAPHORE;

    res = arad_pp_oam_oamp_loopback_set_unsafe(unit, endpoint_id,tx_period,mac_address ,is_added);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
       ...
       )
{
    ...
    res = arad_pp_oam_oamp_loopback_get_verify(unit, rx_packet_count, tx_packet_count,discard_count,fifo_count);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

    SOC_SAND_TAKE_DEVICE_SEMAPHORE;

    res = arad_pp_oam_oamp_loopback_get_unsafe(unit, rx_packet_count, tx_packet_count,discard_count,fifo_count);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
       ...
       )
{
    ...
    res = arad_pp_oam_oamp_loopback_get_period_verify(unit, period);
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

    SOC_SAND_TAKE_DEVICE_SEMAPHORE;

    res = arad_pp_oam_oamp_loopback_get_period_unsafe(unit, period);
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
       ...
       )
{
    ...
    res = arad_pp_oam_dma_event_handler_verify(unit );
    SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);

    SOC_SAND_TAKE_DEVICE_SEMAPHORE;

    res = arad_pp_oam_dma_event_handler_unsafe(unit );
    SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit_semaphore);
   ...
   )
{
    ...
    res = arad_pp_oam_diag_print_rx_unsafe(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res,10,exit_semaphore);
