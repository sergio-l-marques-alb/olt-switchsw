  ...
  )
{
    ...
    if (enable) 
    {
        ...
        SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  20,  exit, ARAD_REG_ACCESS_ERR,READ_IHP_SA_LOOKUP_RESULT_MAPPINGr(unit, &reg_val));
        ...
        SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  50,  exit, ARAD_REG_ACCESS_ERR,WRITE_IHP_SA_LOOKUP_RESULT_MAPPINGr(unit,  reg_val));
    }
