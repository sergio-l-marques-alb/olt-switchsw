...
#define ARAD_PP_ESEM_ENTRY_REQ_KEY_MSB                         (47)
#define ARAD_PP_ESEM_ENTRY_REQ_KEY_NOF_BITS                    SOC_SAND_RNG_COUNT(ARAD_PP_ESEM_ENTRY_REQ_KEY_LSB, ARAD_PP_ESEM_ENTRY_REQ_KEY_MSB)

#define ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_LSB                     (48)
#define ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_MSB                     (63)
#define ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_NOF_BITS                SOC_SAND_RNG_COUNT(ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_LSB, ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_MSB)

#define ARAD_PP_ESEM_ENTRY_REQ_SIZE_REGS                       (3)

#define ARAD_PP_ESEM_KEY_VD_LSB                                (28)
#define ARAD_PP_ESEM_KEY_VD_MSB                                (35)
#define ARAD_PP_ESEM_KEY_VD_NOF_BITS                           SOC_SAND_RNG_COUNT(ARAD_PP_ESEM_KEY_VD_LSB, ARAD_PP_ESEM_KEY_VD_MSB)
...
#define ARAD_PP_ESEM_KEY_VSI_DB_ID_LSB                         (36)
#define ARAD_PP_ESEM_KEY_VSI_DB_ID_MSB                         (36)
#define ARAD_PP_ESEM_KEY_VSI_DB_ID_NOF_BITS                    SOC_SAND_RNG_COUNT(ARAD_PP_ESEM_KEY_VSI_DB_ID_LSB, ARAD_PP_ESEM_KEY_VSI_DB_ID_MSB)
...
#define ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_MSB                (15)
#define ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_NOF_BITS           SOC_SAND_RNG_COUNT(ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_LSB, ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_MSB)
  ...
  )
{
  ...
  switch(esem_key->key_type)
  {
    case ARAD_PP_ESEM_KEY_TYPE_VD_VSI:
      res = soc_sand_bitstream_set_any_field(&esem_key->key_info.vd_vsi.vd, ARAD_PP_ESEM_KEY_VD_LSB, ARAD_PP_ESEM_KEY_VD_NOF_BITS, buffer);
      ...
      res = soc_sand_bitstream_set_any_field(&tmp, ARAD_PP_ESEM_KEY_VSI_DB_ID_LSB, ARAD_PP_ESEM_KEY_VSI_DB_ID_NOF_BITS, buffer);
      SOC_SAND_CHECK_FUNC_RESULT(res, 14, exit);
      break;
    case ARAD_PP_ESEM_KEY_TYPE_VD_VSI_CVID:
      res = soc_sand_bitstream_set_any_field(&esem_key->key_info.vd_cvid.vd, ARAD_PP_ESEM_KEY_VD_LSB, ARAD_PP_ESEM_KEY_VD_NOF_BITS, buffer);
  ...
  )
{
  ...
  res = soc_sand_bitstream_set_any_field(&esem_entry->out_ac, ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_LSB, ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_NOF_BITS, buffer);
  ...
  )
{
  ...
  res = soc_sand_bitstream_get_any_field(buffer, ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_LSB, ARAD_PP_ESEM_ENTRY_ESEM_PAYLOAD_NDX_NOF_BITS, &esem_entry->out_ac);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  )
{
  ...
  res = arad_pp_esem_key_to_buffer(esem_key, key_buffer);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  *found = FALSE;
  ...
  res = arad_pp_esem_entry_from_buffer(entry_buffer, esem_entry);
  ...
  )
{
  ...
  res = arad_pp_esem_key_to_buffer(esem_key, key_buffer);
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  res = arad_pp_esem_entry_to_buffer(esem_entry, entry_buffer);
  SOC_SAND_CHECK_FUNC_RESULT(res, 12, exit);
  ...
  res = soc_sand_bitstream_set_any_field(
          ...
          ARAD_PP_ESEM_ENTRY_REQ_KEY_NOF_BITS,
          buffer
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 16, exit);
  ...
  res = soc_sand_bitstream_set_any_field(
          entry_buffer,
          ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_LSB,
          ARAD_PP_ESEM_ENTRY_REQ_PAYLOAD_NOF_BITS,
          buffer
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 18, exit);
  ...
  )
{
  ...
  res = soc_sand_bitstream_set_any_field(
          &key_type,
          ARAD_PP_ESEM_ENTRY_REQ_TYPE_LSB,
          ARAD_PP_ESEM_ENTRY_REQ_TYPE_MSB - ARAD_PP_ESEM_ENTRY_REQ_TYPE_LSB + 1,
          buffer
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 18, exit);
  ...
  res = soc_sand_bitstream_set_any_field(
          key_buffer,
          ARAD_PP_ESEM_ENTRY_REQ_KEY_LSB,
          ARAD_PP_ESEM_ENTRY_REQ_KEY_MSB - ARAD_PP_ESEM_ENTRY_REQ_KEY_LSB + 1,
          buffer
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);
