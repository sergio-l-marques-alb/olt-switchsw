  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 20, exit, WRITE_IHP_LSR_ELSP_RANGEr(unit, data64));
  /* ELSP range } */
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 20, exit, WRITE_IHP_MPLS_EXP_MAPr(unit, data32));
  /* ELSP EXP MAP } */
  ...
  )
{
  ...
  /* ELSP range { */
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 20, exit, READ_IHP_LSR_ELSP_RANGEr(unit, &data64));
  ...
  /* ELSP EXP MAP { */
  data32 = 0;  
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 20, exit, READ_IHP_MPLS_EXP_MAPr(unit, &data32));
  for(fld_ndx = 0; fld_ndx < ARAD_PP_IHB_MPLS_EXP_REG_NOF_FLDS; ++fld_ndx) 
  {
