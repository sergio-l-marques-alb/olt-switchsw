...
soc_fe1600_force_signal_detect_set(int unit, int mac_instance)
{
   ...
   for(i=0 ; i<SOC_FE1600_NOF_LINKS_IN_MAC ; i++) {
       ...
       if(SOC_IS_FE1600_A0(unit)) {
           ...
           if(soc_dfe_port_pcs_64_66_fec == pcs || soc_dfe_port_pcs_64_66_bec == pcs) {
               force_signal_detect = 1;
               break;
           }
       }
...
soc_fe1600_port_probe(int unit, pbmp_t pbmp, pbmp_t *okay_pbmp, int is_init_sequence)
{
    ...
    if (!SOC_WARM_BOOT(unit)) {
        SOC_PBMP_ITER(pbmp, port) {
            ...
            SOCDNX_IF_ERR_EXIT(soc_fe1600_port_control_power_set(unit, port, 0, soc_dfe_port_power_off));
 ...
 */
soc_error_t 
soc_fe1600_port_control_pcs_set(int unit, soc_port_t port, soc_dfe_port_pcs_t pcs)
{
    ...
    if(soc_dfe_port_power_on == power) {
        SOCDNX_IF_ERR_EXIT(soc_fe1600_port_control_power_set(unit,port,rx_serdes_reset ? SOC_DFE_PORT_CONTROL_FLAGS_RX_SERDES_IGNORE : 0, soc_dfe_port_power_off));
    }
     ...
     */
    if(soc_dfe_port_power_on == power) {
        SOCDNX_IF_ERR_EXIT(soc_fe1600_port_control_power_set(unit,port, rx_serdes_reset ? SOC_DFE_PORT_CONTROL_FLAGS_RX_SERDES_IGNORE : 0, soc_dfe_port_power_on));
    }
 ...
 */
soc_error_t 
soc_fe1600_port_control_pcs_get(int unit, soc_port_t port, soc_dfe_port_pcs_t* pcs)
{
    soc_port_t inner_port;
    ...
    {
        case 0: 
            *pcs = soc_dfe_port_pcs_8_9_legacy_fec;
            break;
        case 1: 
            *pcs = soc_dfe_port_pcs_8_10;
            break;
        case 2: 
            if(rx_fec_fec_en) *pcs = soc_dfe_port_pcs_64_66_fec;
            else              *pcs = soc_dfe_port_pcs_64_66;
            break;
        case 3: 
            *pcs = soc_dfe_port_pcs_64_66_bec;
            break;
        default:
 ...
 */
soc_error_t 
soc_fe1600_port_control_power_set(int unit, soc_port_t port, uint32 flags, soc_dfe_port_power_t power)
{
    SOCDNX_INIT_FUNC_DEFS;
    SOC_FE1600_ONLY(unit);

    SOCDNX_IF_ERR_EXIT(soc_fe1600_port_control_rx_enable_set(unit, port,flags, soc_dfe_port_power_on == power ? 1 : 0));
    SOCDNX_IF_ERR_EXIT(soc_fe1600_port_control_tx_enable_set(unit, port, soc_dfe_port_power_on == power ? 1 : 0));
 ...
 */
soc_error_t 
soc_fe1600_port_control_power_get(int unit, soc_port_t port, soc_dfe_port_power_t* power)
{
    int rx,tx;
    SOCDNX_INIT_FUNC_DEFS;
    SOC_FE1600_ONLY(unit);
    ...
    if(rx && tx) {
        *power = soc_dfe_port_power_on;
    }
    else {
        *power = soc_dfe_port_power_off;
    }
...
soc_fe1600_port_loopback_set(int unit, soc_port_t port, soc_dcmn_loopback_mode_t loopback)
{
    ...
    if(soc_dcmn_loopback_mode_mac_pcs == loopback) {
        ...
        if(soc_dfe_port_pcs_64_66_fec != pcs) {
...
soc_fe1600_port_control_low_latency_get(int unit, soc_port_t port, int *value)
{
    ...
    if (! (pcs == soc_dfe_port_pcs_64_66_fec || pcs == soc_dfe_port_pcs_64_66_bec ) )
    {
         SOCDNX_EXIT_WITH_ERR(SOC_E_CONFIG, (_BSL_SOCDNX_MSG("Invalid PCS type")));
...
soc_error_t 
soc_fe1600_port_prbs_tx_enable_set(int unit, soc_port_t port, int mode, int value)
{
...
soc_error_t 
soc_fe1600_port_prbs_tx_enable_get(int unit, soc_port_t port, int mode, int* value)
{
    int blk_id, inner_port;
    uint32 reg_val32;
    soc_dfe_port_pcs_t pcs;
...
soc_error_t 
soc_fe1600_port_prbs_rx_enable_set(int unit, soc_port_t port, int mode, int value)
{
    int blk_id, inner_port;
    uint32 reg_val32;
    soc_dfe_port_pcs_t pcs;
...
soc_error_t 
soc_fe1600_port_prbs_rx_enable_get(int unit, soc_port_t port, int mode, int* value)
{
    int blk_id, inner_port;
    uint32 reg_val32;
    soc_dfe_port_pcs_t pcs;
...
soc_error_t 
soc_fe1600_port_prbs_rx_status_get(int unit, soc_port_t port, int mode, int* value)
{
    int blk_id, inner_port;
...
soc_error_t 
soc_fe1600_port_prbs_polynomial_set(int unit, soc_port_t port, int mode, int value)
{
    SOCDNX_INIT_FUNC_DEFS;
    SOC_FE1600_ONLY(unit);
...
soc_error_t 
soc_fe1600_port_prbs_polynomial_get(int unit, soc_port_t port, int mode, int* value)
{
    SOCDNX_INIT_FUNC_DEFS;
    SOC_FE1600_ONLY(unit);
...
soc_error_t 
soc_fe1600_port_prbs_tx_invert_data_set(int unit, soc_port_t port, int mode, int value)
{
    SOCDNX_INIT_FUNC_DEFS;
    SOC_FE1600_ONLY(unit);
...
soc_error_t 
soc_fe1600_port_prbs_tx_invert_data_get(int unit, soc_port_t port, int mode, int* value)
{
    SOCDNX_INIT_FUNC_DEFS;
    SOC_FE1600_ONLY(unit);
 ...
 */
soc_error_t 
soc_fe1600_port_phy_control_set(int unit, soc_port_t port, soc_phy_control_t type, uint32 value)
{
    SOCDNX_INIT_FUNC_DEFS;
 ...
 */
soc_error_t 
soc_fe1600_port_phy_control_get(int unit, soc_port_t port, soc_phy_control_t type, uint32 *value)
{
    SOCDNX_INIT_FUNC_DEFS;
