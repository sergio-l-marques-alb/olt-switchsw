...
sbZfC2PpPpOutHeaderCopyEntry_Print(sbZfC2PpPpOutHeaderCopyEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpPpOutHeaderCopyEntry:: data7=0x%08x"), (unsigned int)  pFromStruct->m_uData7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpPpOutHeaderCopyEntry:: data5=0x%08x"), (unsigned int)  pFromStruct->m_uData5));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpPpOutHeaderCopyEntry:: data3=0x%08x"), (unsigned int)  pFromStruct->m_uData3));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpPpOutHeaderCopyEntry:: data1=0x%08x"), (unsigned int)  pFromStruct->m_uData1));
  LOG_WARN(BSL_LS_SOC_COMMON,
...
char *
sbZfC2PpPpOutHeaderCopyEntry_SPrint(sbZfC2PpPpOutHeaderCopyEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
