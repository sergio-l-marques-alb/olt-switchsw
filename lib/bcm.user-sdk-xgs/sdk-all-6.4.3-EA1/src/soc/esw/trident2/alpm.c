...
alpm_vrf_handle_t*alpm_vrf_handle[SOC_MAX_NUM_DEVICES];alpm_pivot_t**
tcam_pivot[SOC_MAX_NUM_DEVICES];int soc_alpm_mode_get(int l2){if(
soc_trident2_alpm_mode_get(l2) == 1){return 1;}else{return 0;}}static int l127
(int l2,const void*entry,int*l120){int l128;uint32 l129;int l10;l10 = 
soc_mem_field32_get(l2,L3_DEFIPm,entry,MODE0f);if(l10){l129 = 
soc_mem_field32_get(l2,L3_DEFIPm,entry,IP_ADDR_MASK0f);if((l128 = _ipmask2pfx
(l129,l120))<0){return(l128);}l129 = soc_mem_field32_get(l2,L3_DEFIPm,entry,
IP_ADDR_MASK1f);if(*l120){if(l129!= 0xffffffff){return(SOC_E_PARAM);}*l120+= 
32;}else{if((l128 = _ipmask2pfx(l129,l120))<0){return(l128);}}}else{l129 = 
soc_mem_field32_get(l2,L3_DEFIPm,entry,IP_ADDR_MASK0f);if((l128 = _ipmask2pfx
(l129,l120))<0){return(l128);}}return SOC_E_NONE;}int _soc_alpm_rpf_entry(int
l2,int l130){int l131;l131 = (l130>>2)&0x3fff;l131+= SOC_ALPM_BUCKET_COUNT(l2
);return(l130&~(0x3fff<<2))|(l131<<2);}int soc_alpm_physical_idx(int l2,
soc_mem_t l24,int index,int l132){int l133 = index&1;if(l132){return
soc_trident2_l3_defip_index_map(l2,l24,index);}index>>= 1;index = 
soc_trident2_l3_defip_index_map(l2,l24,index);index<<= 1;index|= l133;return
index;}int soc_alpm_logical_idx(int l2,soc_mem_t l24,int index,int l132){int
l133 = index&1;if(l132){return soc_trident2_l3_defip_index_remap(l2,l24,index
);}index>>= 1;index = soc_trident2_l3_defip_index_remap(l2,l24,index);index
<<= 1;index|= l133;return index;}static int l134(int l2,void*entry,uint32*
prefix,uint32*l17,int*l26){int l135,l136,l10;int l120 = 0;int l128 = 
SOC_E_NONE;uint32 l137,l133;prefix[0] = prefix[1] = prefix[2] = prefix[3] = 
prefix[4] = 0;l10 = soc_mem_field32_get(l2,L3_DEFIPm,entry,MODE0f);l135 = 
soc_mem_field32_get(l2,L3_DEFIPm,entry,IP_ADDR0f);l136 = soc_mem_field32_get(
l2,L3_DEFIPm,entry,IP_ADDR_MASK0f);prefix[1] = l135;l135 = 
soc_mem_field32_get(l2,L3_DEFIPm,entry,IP_ADDR1f);l136 = soc_mem_field32_get(
l2,L3_DEFIPm,entry,IP_ADDR_MASK1f);prefix[0] = l135;if(l10){prefix[4] = 
prefix[1];prefix[3] = prefix[0];prefix[1] = prefix[0] = 0;l136 = 
soc_mem_field32_get(l2,L3_DEFIPm,entry,IP_ADDR_MASK0f);if((l128 = _ipmask2pfx
(l136,&l120))<0){return(l128);}l136 = soc_mem_field32_get(l2,L3_DEFIPm,entry,
IP_ADDR_MASK1f);if(l120){if(l136!= 0xffffffff){return(SOC_E_PARAM);}l120+= 32
;}else{if((l128 = _ipmask2pfx(l136,&l120))<0){return(l128);}}l137 = 64-l120;
if(l137<32){prefix[4]>>= l137;l133 = (((32-l137) == 32)?0:(prefix[3])<<(32-
l137));prefix[3]>>= l137;prefix[4]|= l133;}else{prefix[4] = (((l137-32) == 32
)?0:(prefix[3])>>(l137-32));prefix[3] = 0;}}else{l136 = soc_mem_field32_get(
l2,L3_DEFIPm,entry,IP_ADDR_MASK0f);if((l128 = _ipmask2pfx(l136,&l120))<0){
return(l128);}prefix[1] = (((32-l120) == 32)?0:(prefix[1])>>(32-l120));prefix
[0] = 0;}*l17 = l120;*l26 = (prefix[0] == 0)&&(prefix[1] == 0)&&(l120 == 0);
return SOC_E_NONE;}int _soc_alpm_find_in_bkt(int l2,soc_mem_t l24,int
bucket_index,int l138,uint32*l15,void*l139,int*l121,int l34){int l128;l128 = 
soc_mem_alpm_lookup(l2,l24,bucket_index,MEM_BLOCK_ANY,l138,l15,l139,l121);if(
SOC_SUCCESS(l128)){return l128;}if(SOC_ALPM_V6_SCALE_CHECK(l2,l34)){return
soc_mem_alpm_lookup(l2,l24,bucket_index+1,MEM_BLOCK_ANY,l138,l15,l139,l121);}
return l128;}static int l140(int l2,uint32*prefix,uint32 l141,int l34,int l28
,int*l142,int*l143,int*bucket_index){int l128 = SOC_E_NONE;trie_t*l144;
trie_node_t*l145 = NULL;alpm_pivot_t*l146;if(l34){l144 = VRF_PIVOT_TRIE_IPV6(
l2,l28);}else{l144 = VRF_PIVOT_TRIE_IPV4(l2,l28);}l128 = trie_find_lpm(l144,
prefix,l141,&l145);if(SOC_FAILURE(l128)){LOG_ERROR(BSL_LS_SOC_ALPM,(
BSL_META_U(l2,"Pivot find failed\n")));return l128;}l146 = (alpm_pivot_t*)
l145;*l142 = 1;*l143 = PIVOT_TCAM_INDEX(l146);*bucket_index = 
PIVOT_BUCKET_INDEX(l146);return SOC_E_NONE;}static int l147(int l2,void*l8,
soc_mem_t l24,void*l139,int*l143,int*bucket_index,int*l16,int l148){uint32 l15
[SOC_MAX_MEM_FIELD_WORDS];int l149,l28,l34;int l121;uint32 l11,l138;int l128 = 
SOC_E_NONE;int l142 = 0;l34 = soc_mem_field32_get(l2,L3_DEFIPm,l8,MODE0f);if(
...
(l149 == 0){if(soc_alpm_mode_get(l2)){return SOC_E_PARAM;}}if(l28 == 
SOC_VRF_MAX(l2)+1){l11 = 0;SOC_ALPM_GET_GLOBAL_BANK_DISABLE(l2,l138);}else{
l11 = 2;SOC_ALPM_GET_VRF_BANK_DISABLE(l2,l138);}if(l149!= SOC_L3_VRF_OVERRIDE
){if(l148){uint32 prefix[5],l141;int l26 = 0;l128 = l134(l2,l8,prefix,&l141,&
l26);if(SOC_FAILURE(l128)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,
...
defip_alpm_ipv4_entry_t l215,l216,l235;defip_alpm_ipv6_64_entry_t l217,l218,
l236;defip_aux_scratch_entry_t l13;uint32 l15[SOC_MAX_MEM_FIELD_WORDS];
soc_mem_t l24;void*l219,*l233,*l220 = NULL;int l149;int l10;int l128 = 
SOC_E_NONE,l205;uint32 l237[5],prefix[5];int l34,l28;uint32 l141;int l232;
uint32 l11,l138;int l142,l26 = 0;trie_t*trie,*l207;uint32 l238;defip_entry_t
lpm_entry,*l239;payload_t*l210 = NULL,*l240 = NULL,*l212 = NULL;trie_node_t*
l209 = NULL,*l145 = NULL;trie_t*l144 = NULL;l10 = l34 = soc_mem_field32_get(
...
l2,l8,&l149,&l28));if(l149!= SOC_L3_VRF_OVERRIDE){if(l28 == SOC_VRF_MAX(l2)+1
){l11 = 0;SOC_ALPM_GET_GLOBAL_BANK_DISABLE(l2,l138);}else{l11 = 2;
...
l237[3] = l237[4] = 0;}}}while(0);l128 = l30(l2,l237,l238,l28,l10,&lpm_entry,
0,1);l205 = l147(l2,&lpm_entry,l24,l219,&l143,&bucket_index,&l121,TRUE);(void
)l27(l2,l219,l24,l10,l149,bucket_index,0,&lpm_entry);(void)l30(l2,l237,l141,
l28,l10,&lpm_entry,0,0);if(SOC_URPF_STATUS_GET(l2)){if(SOC_SUCCESS(l128)){
l220 = ((l34)?((uint32*)&(l218)):((uint32*)&(l216)));l205 = soc_mem_read(l2,
l24,MEM_BLOCK_ANY,_soc_alpm_rpf_entry(l2,l121),l220);}}if((l238 == 0)&&
SOC_FAILURE(l205)){l239 = l34?VRF_TRIE_DEFAULT_ROUTE_IPV6(l2,l28):
...
l128 = SOC_E_NONE;l128 = l3(l2);SOC_IF_ERROR_RETURN(l128);l128 = l19(l2);
alpm_vrf_handle[l2] = sal_alloc((MAX_VRF_ID+1)*sizeof(alpm_vrf_handle_t),
"ALPM VRF Handles");if(alpm_vrf_handle[l2] == NULL){return SOC_E_MEMORY;}
tcam_pivot[l2] = sal_alloc(MAX_PIVOT_COUNT*sizeof(alpm_pivot_t*),
"ALPM pivots");if(tcam_pivot[l2] == NULL){return SOC_E_MEMORY;}sal_memset(
alpm_vrf_handle[l2],0,(MAX_VRF_ID+1)*sizeof(alpm_vrf_handle_t));sal_memset(
tcam_pivot[l2],0,MAX_PIVOT_COUNT*sizeof(alpm_pivot_t*));for(l171 = 0;l171<
MAX_PIVOT_COUNT;l171++){ALPM_TCAM_PIVOT(l2,l171) = NULL;}if(SOC_CONTROL(l2)->
alpm_bulk_retry == NULL){SOC_CONTROL(l2)->alpm_bulk_retry = sal_sem_create(
"ALPM bulk retry",sal_sem_BINARY,0);}if(SOC_CONTROL(l2)->alpm_lookup_retry == 
NULL){SOC_CONTROL(l2)->alpm_lookup_retry = sal_sem_create("ALPM lookup retry"
,sal_sem_BINARY,0);}if(SOC_CONTROL(l2)->alpm_insert_retry == NULL){
SOC_CONTROL(l2)->alpm_insert_retry = sal_sem_create("ALPM insert retry",
sal_sem_BINARY,0);}if(SOC_CONTROL(l2)->alpm_delete_retry == NULL){SOC_CONTROL
(l2)->alpm_delete_retry = sal_sem_create("ALPM delete retry",sal_sem_BINARY,0
);}l128 = soc_alpm_128_lpm_init(l2);SOC_IF_ERROR_RETURN(l128);return l128;}
static int l245(int l2){int l171,l128;alpm_pivot_t*l133;for(l171 = 0;l171<
...
soc_alpm_bucket_t));if(alpm_vrf_handle[l2])sal_free(alpm_vrf_handle[l2]);if(
tcam_pivot[l2])sal_free(tcam_pivot[l2]);alpm_vrf_handle[l2] = NULL;tcam_pivot
[l2] = NULL;return SOC_E_NONE;}int soc_alpm_deinit(int l2){l4(l2);
...
index&(0x8000)){l109[0] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2
,L3_DEFIPm)),(l15),(l96[(l2)]->l60));l109[1] = 
...
l122((l107[(l2)]),l290,l293,l120,l123,((uint16)l292<<1)|(0x8000));}}else{if(
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l6),(l96[(l2
)]->l74))){l293[0] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,
L3_DEFIPm)),(l6),(l96[(l2)]->l60));l293[1] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l6),(l96[(l2
...
index = (l292<<1)|(0x8000);}else{l293[0] = soc_meminfo_fieldinfo_field32_get(
(&SOC_MEM_INFO(l2,L3_DEFIPm)),(l8),(l96[(l2)]->l60));l293[1] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l8),(l96[(l2
)]->l62));l293[2] = 0;l293[3] = 0x80000001;if((!(SOC_IS_HURRICANE(l2)))&&(((
l96[(l2)]->l76)!= NULL))){int l288;(void)soc_alpm_lpm_vrf_get(l2,l8,(int*)&
l293[4],&l288);}else{l293[4] = 0;};index = l292;}l128 = l125((l107[(l2)]),
l290,l293,l120,index);if(SOC_FAILURE(l128)){LOG_ERROR(BSL_LS_SOC_ALPM,(
BSL_META_U(l2,"\ndel  index: H %d error %d\n"),index,l128));}}static int l295
(int l2,void*l8,int l120,int*l121){l103 l293;int l296;int l128;uint16 index = 
(0xFFFF);l296 = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm
)),(l8),(l96[(l2)]->l64));if(l296){l293[0] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l8),(l96[(l2
)]->l60));l293[1] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,
L3_DEFIPm)),(l8),(l96[(l2)]->l62));l293[2] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l8),(l96[(l2
)]->l61));l293[3] = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,
L3_DEFIPm)),(l8),(l96[(l2)]->l63));if((!(SOC_IS_HURRICANE(l2)))&&(((l96[(l2)]
->l76)!= NULL))){int l288;(void)soc_alpm_lpm_vrf_get(l2,l8,(int*)&l293[4],&
l288);}else{l293[4] = 0;};}else{l293[0] = soc_meminfo_fieldinfo_field32_get((
&SOC_MEM_INFO(l2,L3_DEFIPm)),(l8),(l96[(l2)]->l60));l293[1] = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l8),(l96[(l2
)]->l62));l293[2] = 0;l293[3] = 0x80000001;if((!(SOC_IS_HURRICANE(l2)))&&(((
l96[(l2)]->l76)!= NULL))){int l288;(void)soc_alpm_lpm_vrf_get(l2,l8,(int*)&
l293[4],&l288);}else{l293[4] = 0;};}l128 = l117((l107[(l2)]),l290,l293,l120,&
index);if(SOC_FAILURE(l128)){*l121 = 0xFFFFFFFF;return(l128);}*l121 = index;
return(SOC_E_NONE);}static uint16 l110(uint8*l111,int l112){return(
_shr_crc16b(0,l111,l112));}static int l113(int l21,int l98,int l99,l102**l114
){l102*l118;int index;if(l99>l98){return SOC_E_MEMORY;}l118 = sal_alloc(
sizeof(l102),"lpm_hash");if(l118 == NULL){return SOC_E_MEMORY;}sal_memset(
l118,0,sizeof(*l118));l118->l21 = l21;l118->l98 = l98;l118->l99 = l99;l118->
l100 = sal_alloc(l118->l99*sizeof(*(l118->l100)),"hash_table");if(l118->l100
== NULL){sal_free(l118);return SOC_E_MEMORY;}l118->l101 = sal_alloc(l118->l98
*sizeof(*(l118->l101)),"link_table");if(l118->l101 == NULL){sal_free(l118->
l100);sal_free(l118);return SOC_E_MEMORY;}for(index = 0;index<l118->l99;index
++){l118->l100[index] = (0xFFFF);}for(index = 0;index<l118->l98;index++){l118
->l101[index] = (0xFFFF);}*l114 = l118;return SOC_E_NONE;}static int l115(
l102*l116){if(l116!= NULL){sal_free(l116->l100);sal_free(l116->l101);sal_free
(l116);}return SOC_E_NONE;}static int l117(l102*l118,l104 l119,l103 entry,int
l120,uint16*l121){int l2 = l118->l21;uint16 l297;uint16 index;l297 = l110((
uint8*)entry,(32*5))%l118->l99;index = l118->l100[l297];;;while(index!= (
0xFFFF)){uint32 l15[SOC_MAX_MEM_FIELD_WORDS];l103 l109;int l298;l298 = (index
&(0x7FFF))>>1;SOC_IF_ERROR_RETURN(READ_L3_DEFIPm(l2,MEM_BLOCK_ANY,l298,l15));
l108(l2,l15,index,l109);if((*l119)(entry,l109) == 0){*l121 = (index&(0x7FFF))
>>((index&(0x8000))?1:0);;return(SOC_E_NONE);}index = l118->l101[index&(
0x7FFF)];;};return(SOC_E_NOT_FOUND);}static int l122(l102*l118,l104 l119,l103
entry,int l120,uint16 l123,uint16 l124){int l2 = l118->l21;uint16 l297;uint16
index;uint16 l299;l297 = l110((uint8*)entry,(32*5))%l118->l99;index = l118->
l100[l297];;;;l299 = (0xFFFF);if(l123!= (0xFFFF)){while(index!= (0xFFFF)){
uint32 l15[SOC_MAX_MEM_FIELD_WORDS];l103 l109;int l298;l298 = (index&(0x7FFF)
)>>1;SOC_IF_ERROR_RETURN(READ_L3_DEFIPm(l2,MEM_BLOCK_ANY,l298,l15));l108(l2,
l15,index,l109);if((*l119)(entry,l109) == 0){if(l124!= index){;if(l299 == (
0xFFFF)){l118->l100[l297] = l124;l118->l101[l124&(0x7FFF)] = l118->l101[index
&(0x7FFF)];l118->l101[index&(0x7FFF)] = (0xFFFF);}else{l118->l101[l299&(
0x7FFF)] = l124;l118->l101[l124&(0x7FFF)] = l118->l101[index&(0x7FFF)];l118->
l101[index&(0x7FFF)] = (0xFFFF);}};return(SOC_E_NONE);}l299 = index;index = 
l118->l101[index&(0x7FFF)];;}}l118->l101[l124&(0x7FFF)] = l118->l100[l297];
l118->l100[l297] = l124;return(SOC_E_NONE);}static int l125(l102*l118,l104
l119,l103 entry,int l120,uint16 l126){uint16 l297;uint16 index;uint16 l299;
l297 = l110((uint8*)entry,(32*5))%l118->l99;index = l118->l100[l297];;;l299 = 
(0xFFFF);while(index!= (0xFFFF)){if(l126 == index){;if(l299 == (0xFFFF)){l118
->l100[l297] = l118->l101[l126&(0x7FFF)];l118->l101[l126&(0x7FFF)] = (0xFFFF)
;}else{l118->l101[l299&(0x7FFF)] = l118->l101[l126&(0x7FFF)];l118->l101[l126&
(0x7FFF)] = (0xFFFF);}return(SOC_E_NONE);}l299 = index;index = l118->l101[
index&(0x7FFF)];;}return(SOC_E_NOT_FOUND);}int _ipmask2pfx(uint32 l300,int*
l301){*l301 = 0;while(l300&(1<<31)){*l301+= 1;l300<<= 1;}return((l300)?
SOC_E_PARAM:SOC_E_NONE);}int soc_alpm_lpm_ip4entry0_to_0(int l2,void*l302,
void*l303,int l304){uint32 l129;l129 = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l2,L3_DEFIPm)),(l302),(l96[(l2)]->l74));
soc_meminfo_fieldinfo_field32_set((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l303),(l96[(
l2)]->l74),(l129));l129 = soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2
,L3_DEFIPm)),(l302),(l96[(l2)]->l64));soc_meminfo_fieldinfo_field32_set((&
SOC_MEM_INFO(l2,L3_DEFIPm)),(l303),(l96[(l2)]->l64),(l129));l129 = 
...
l303),(l96[(l2)]->l60),(l129));l129 = soc_meminfo_fieldinfo_field32_get((&
SOC_MEM_INFO(l2,L3_DEFIPm)),(l302),(l96[(l2)]->l62));
soc_meminfo_fieldinfo_field32_set((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l303),(l96[(
l2)]->l62),(l129));if(((l96[(l2)]->l50)!= NULL)){l129 = 
soc_meminfo_fieldinfo_field32_get((&SOC_MEM_INFO(l2,L3_DEFIPm)),(l302),(l96[(
...
l3(int l2){int l306;int l171;int l284;int l338;uint32 l339 = 0;uint32 l337;if
...
int*bucket_index){uint32 l339 = 0;uint32 l347 = 0;int l348;soc_timeout_t l349
;int l128 = SOC_E_NONE;int l350 = 0;if(l346){SOC_IF_ERROR_RETURN(
...
alpm_vrf_handle[l2],l377);}sal_free(l393);return SOC_E_NONE;}int
soc_alpm_bucket_sanity_check(int l2,soc_mem_t l261,int index){int l128 = 
SOC_E_NONE;int l171,l258,l267,l10,l143 = -1;int l149 = 0,l28;uint32 l138 = 0;
uint32 l15[SOC_MAX_MEM_FIELD_WORDS];uint32 l398[SOC_MAX_MEM_FIELD_WORDS];int
l399,l400,l401;defip_entry_t lpm_entry;int l272,l402;soc_mem_t l24;int l192,
l264,l403,l404;int l405 = 0;soc_field_t l406[2] = {VALID0f,VALID1f};
soc_field_t l407[2] = {GLOBAL_HIGH0f,GLOBAL_HIGH1f};soc_field_t l408[2] = {
ALG_BKT_PTR0f,ALG_BKT_PTR1f};l272 = soc_mem_index_min(l2,l261);l402 = 
soc_mem_index_max(l2,l261);if((index>= 0)&&(index<l272||index>l402)){return
SOC_E_PARAM;}else if(index>= 0){l272 = index;l402 = index;}SOC_ALPM_LPM_LOCK(
l2);for(l171 = l272;l171<= l402;l171++){SOC_ALPM_LPM_UNLOCK(l2);
SOC_ALPM_LPM_LOCK(l2);l128 = soc_mem_read(l2,l261,MEM_BLOCK_ANY,l171,(void*)
l15);if(SOC_FAILURE(l128)){continue;}l10 = soc_mem_field32_get(l2,l261,(void*
)l15,MODE0f);if(l10){l264 = 1;l24 = L3_DEFIP_ALPM_IPV6_64m;l403 = 16;}else{
l264 = 2;l24 = L3_DEFIP_ALPM_IPV4m;l403 = 24;}for(l192 = 0;l192<l264;l192++){
if(soc_mem_field32_get(l2,l261,(void*)l15,l406[l192]) == 0||
soc_mem_field32_get(l2,l261,(void*)l15,l407[l192]) == 1){continue;}l404 = 
soc_mem_field32_get(l2,l261,(void*)l15,l408[l192]);if(l192 == 1){
soc_alpm_lpm_ip4entry1_to_0(l2,l15,l398,PRESERVE_HIT);}else{
soc_alpm_lpm_ip4entry0_to_0(l2,l15,l398,PRESERVE_HIT);}l128 = 
soc_alpm_lpm_vrf_get(l2,l398,&l149,&l28);if(SOC_FAILURE(l128)){continue;}if(
SOC_ALPM_V6_SCALE_CHECK(l2,l10)){l403<<= 1;}l143 = -1;for(l258 = 0;l258<l403;
l258++){l128 = _soc_alpm_mem_index(l2,l24,l404,l258,l138,&l267);if(
SOC_FAILURE(l128)){continue;}l128 = soc_mem_read(l2,l24,MEM_BLOCK_ANY,l267,(
void*)l15);if(SOC_FAILURE(l128)){break;}if(!soc_mem_field32_get(l2,l24,(void*
)l15,VALIDf)){continue;}l128 = l27(l2,(void*)l15,l24,l10,l149,l404,0,&
lpm_entry);if(SOC_FAILURE(l128)){continue;}l128 = l147(l2,(void*)&lpm_entry,
l24,(void*)l15,&l399,&l400,&l401,FALSE);if(SOC_FAILURE(l128)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tLaunched AUX operation for "
"index %d bucket %d sanity check failed\n"),l171,l404));l405++;continue;}if(
l400!= l404){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,
"\tEntry at index %d does not belong ""to bucket %d(from bucket %d)\n"),l401,
l404,l400));l405++;}if(l143 == -1){l143 = l399;continue;}if(l143!= l399){int
l409,l410;l409 = soc_alpm_logical_idx(l2,l261,l143>>1,1);l410 = 
soc_alpm_logical_idx(l2,l261,l399>>1,1);LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U
(l2,"\tAliased bucket %d(returned "
"bucket %d) found from TCAM1 %d and TCAM2 %d\n"),l404,l400,l409,l410));l405++
;}}}}SOC_ALPM_LPM_UNLOCK(l2);if(l405 == 0){LOG_INFO(BSL_LS_SOC_ALPM,(
BSL_META_U(l2,"\tMemory %s index %d Bucket sanity check passed\n"),
SOC_MEM_NAME(l2,l261),index));return SOC_E_NONE;}LOG_ERROR(BSL_LS_SOC_ALPM,(
BSL_META_U(l2,"\tMemory %s index %d Bucket sanity check failed, "
"encountered %d error(s)\n"),SOC_MEM_NAME(l2,l261),index,l405));return
SOC_E_FAIL;}int soc_alpm_pivot_sanity_check(int l2,soc_mem_t l261,int index){
int l171,l192,l286 = 0;int l267,l272,l402;int l128 = SOC_E_NONE;int*l411 = 
NULL;int l399,l400,l401;uint32 l15[SOC_MAX_MEM_FIELD_WORDS];int l131,l10 = 0,
l264 = 2;int l412,l413[2];soc_mem_t l414,l415;int l405 = 0;soc_field_t l406[2
] = {VALID0f,VALID1f};soc_field_t l407[2] = {GLOBAL_HIGH0f,GLOBAL_HIGH1f};
soc_field_t l416[2] = {NEXT_HOP_INDEX0f,NEXT_HOP_INDEX1f};soc_field_t l408[2]
= {ALG_BKT_PTR0f,ALG_BKT_PTR1f};l272 = soc_mem_index_min(l2,l261);l402 = 
soc_mem_index_max(l2,l261);if((index>= 0)&&(index<l272||index>l402)){return
SOC_E_PARAM;}else if(index>= 0){l272 = index;l402 = index;}l411 = sal_alloc(
sizeof(int)*MAX_PIVOT_COUNT,"Bucket index array");if(l411 == NULL){l128 = 
SOC_E_MEMORY;return l128;}sal_memset(l411,0xff,sizeof(int)*MAX_PIVOT_COUNT);
SOC_ALPM_LPM_LOCK(l2);for(l171 = l272;l171<= l402;l171++){SOC_ALPM_LPM_UNLOCK
(l2);SOC_ALPM_LPM_LOCK(l2);l128 = soc_mem_read(l2,l261,MEM_BLOCK_ANY,l171,(
void*)l15);if(SOC_FAILURE(l128)){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,
"\tRead memory %s index %d (original) ""return %d\n"),SOC_MEM_NAME(l2,l261),
l171,l128));l405++;continue;}l10 = soc_mem_field32_get(l2,l261,(void*)l15,
MODE0f);if(l10){l264 = 1;l415 = L3_DEFIP_ALPM_IPV6_64m;}else{l264 = 2;l415 = 
L3_DEFIP_ALPM_IPV4m;}for(l192 = 0;l192<l264;l192++){if(soc_mem_field32_get(l2
,l261,(void*)l15,l406[l192]) == 0||soc_mem_field32_get(l2,l261,(void*)l15,
l407[l192]) == 1){continue;}l131 = soc_mem_field32_get(l2,l261,(void*)l15,
l408[l192]);if(l131!= 0){if(l411[l131] == -1){l411[l131] = l171;}else{
LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tDuplicated bucket pointer "
"%d detected, in memory %s index1 %d ""and index2 %d\n"),l131,SOC_MEM_NAME(l2
,l261),l411[l131],l171));l405++;continue;}}l128 = alpm_bucket_is_assigned(l2,
l131,l10,&l286);if(l128 == SOC_E_PARAM){LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U
(l2,"\tInvalid bucket pointer %d ""detected, in memory %s index %d\n"),l131,
SOC_MEM_NAME(l2,l261),l171));l405++;continue;}if(l128>= 0&&l286 == 0){
LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tFreed bucket pointer %d "
"detected, in memory %s index %d\n"),l131,SOC_MEM_NAME(l2,l261),l171));l405++
;continue;}l414 = _soc_trident2_alpm_bkt_view_get(l2,l131<<2);if(l415!= l414)
{LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tMismatched bucket entry memory "
"type in bucket %d, expected %s, actual"" %s\n"),l131,SOC_MEM_NAME(l2,l415),
SOC_MEM_NAME(l2,l414)));l405++;continue;}l412 = soc_mem_field32_get(l2,l261,(
void*)l15,l416[l192]);if(l192 == 1){l128 = soc_alpm_lpm_ip4entry1_to_0(l2,l15
,l15,PRESERVE_HIT);if(SOC_FAILURE(l128)){continue;}}l399 = -1;l128 = l147(l2,
l15,l415,(void*)l15,&l399,&l400,&l401,FALSE);if(l399 == -1){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tLaunched AUX operation for PIVOT "
"index %d sanity check failed\n"),l171));l405++;continue;}l267 = 
soc_alpm_logical_idx(l2,l261,l399>>1,1);l128 = soc_mem_read(l2,l261,
MEM_BLOCK_ANY,l267,(void*)l15);if(SOC_FAILURE(l128)){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tRead memory %s index %d (nexthop) "
"return %d\n"),SOC_MEM_NAME(l2,l261),l267,l128));l405++;continue;}l413[0] = 
soc_mem_field32_get(l2,l261,(void*)l15,l416[0]);l413[1] = soc_mem_field32_get
(l2,l261,(void*)l15,l416[1]);if(l412!= l413[l399&1]){LOG_ERROR(
BSL_LS_SOC_ALPM,(BSL_META_U(l2,"\tDefault nexthop was not populated "
"correctly, TCAM index1 %d entry1 %d, index2 %d ""entry2 %d\n"),l171,l192,
l267,l399&1));l405++;continue;}}}SOC_ALPM_LPM_UNLOCK(l2);sal_free(l411);if(
l405 == 0){LOG_INFO(BSL_LS_SOC_ALPM,(BSL_META_U(l2,
"\tMemory %s index %d Pivot sanity check passed\n"),SOC_MEM_NAME(l2,l261),
index));return SOC_E_NONE;}LOG_ERROR(BSL_LS_SOC_ALPM,(BSL_META_U(l2,
"\tMemory %s index %d Pivot sanity check failed, ""encountered %d error(s)\n"
),SOC_MEM_NAME(l2,l261),index,l405));return SOC_E_FAIL;}
#endif
#endif /* ALPM_ENABLE */
