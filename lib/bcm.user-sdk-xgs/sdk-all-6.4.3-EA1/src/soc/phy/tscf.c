 ...
 */
STATIC int 
tscf_speed_to_interface_config_get(tscf_speed_config_t* speed_config, phymod_phy_inf_config_t* interface_config)
{
    int port_is_higig;
    int port_num_lanes;
    int fiber_pref;
                 ...
                 phymod_phy_init_config_t  *pm_phy_init_config)
{
    ...
    */
    ...
    SOC_IF_ERROR_RETURN
        (tscf_speed_to_interface_config_get(speed_config, &(core_init_config->interface)));
    ...
    */
    ...
    for (i = 0; i < MAX_NUM_LANES; i++) {
        ...
        preemphasis = soc_property_port_suffix_num_get(unit, port,
                                    ...
                                    "lane", TSCF_NO_CFG_VALUE);
        if (preemphasis != TSCF_NO_CFG_VALUE) {
...
phy_tscf_init(int unit, soc_port_t port)
{
    ...
    SOC_IF_ERROR_RETURN
        (tscf_speed_to_interface_config_get(speed_config, &interface_config));
