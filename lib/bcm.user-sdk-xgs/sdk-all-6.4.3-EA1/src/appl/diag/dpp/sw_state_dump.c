...
void ARAD_SW_DB_LAGS_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".local_to_sys"); 
   arraySizes_SW_DUMP[0]=ARAD_NOF_LOCAL_PORTS; 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) elt->local_to_sys, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
