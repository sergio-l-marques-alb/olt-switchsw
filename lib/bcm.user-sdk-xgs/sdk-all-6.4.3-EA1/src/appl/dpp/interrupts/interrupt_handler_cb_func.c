/*
 * $Id: interrupt_handler_cb_func.c,v 1.29 Broadcom SDK $
 ...
 * Init Functions
 */
void arad_interrupt_add_interrupt_handler_init(unit)
{
...
int arad_interrupt_handle_generic_none(int unit, int block_instance, arad_interrupt_type en_arad_interrupt,char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_NONE, NULL);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_NONE, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_recurring_action_handle_generic_none(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_NONE, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_cfchcfcoobrx0crcerr(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_NONE, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_cfcparityerrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, corrective_action, special_msg);
    SOCDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, corrective_action, (void*)(&shadow_correct_info), NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_egqecc_2berrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    corrective_action = ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC;
...
int arad_interrupt_handle_egqucpktportff(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_REPROGRAM_RESOURCE, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_REPROGRAM_RESOURCE, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_egqvsc256mccellsizeerr(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_NONE, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fcrecc_1berrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, corrective_action, (void*)(&ecc_1b_correct_info), NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fctunrchdestevent(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    arad_int_corr_act_type corrective_action = ARAD_INT_CORR_ACT_NONE;
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, corrective_action, &fap_id, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fcrprmecc_2berrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HARD_RESET, NULL);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_HARD_RESET, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fdrprmfdradesccntob(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HARD_RESET, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fdrprmaltoa(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_CLEAR_CHECK, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_CLEAR_CHECK, (void*)&iterations, (void*)&delay_us);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_fdrprmaltoa(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, corrective_action, special_msg);
    SOCDNX_IF_ERR_EXIT(rc);

    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg,corrective_action,array_links,NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_fdrprmifmafoa(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_HARD_RESET, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_fdrprmifmafob(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_HARD_RESET, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fdtecc_2berrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    corrective_action = ARAD_INT_CORR_ACT_HARD_RESET;
...
int arad_interrupt_handle_fmacrxcrcerrn_int_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_NONE, (void*)array_links ,NULL);
    BCMDNX_IF_ERR_EXIT(rc);
    ...
    char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, (void*)array_links ,NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_fmacwrongsize_int_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
    
    /* corrective actions */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_SHUTDOWN_FBR_LINKS, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fmacrxlostofsync_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_RX_LOS_HANDLE, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_RX_LOS_HANDLE, &link, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fsrd_fsrd_syncstatuschanged_0(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_RX_LOS_HANDLE, &port, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_fsrd_fsrd_txplllockchanged(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_REPROGRAM_RESOURCE, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_idrerrorfullmulticastrecycle(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC, NULL);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_ihbecc_1berrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ihbtcamprotectionerror(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* data collection */
    rc = arad_interrupt_data_collection_for_ihbtcamprotectionerror(unit, block_instance, en_arad_interrupt, &location, &corrective_action);
    SOCDNX_IF_ERR_EXIT(rc);

    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_TCAM_SHADOW_FROM_SW_DB, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_ihpecc_1berrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ihpisaerrortablecoherency(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ihpmacteventready(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HANDLE_MACT_EVENT_FIFO, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_HANDLE_MACT_EVENT_FIFO, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_ipsdeqcommandtimeout(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_INGRESS_HARD_RESET, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_INGRESS_HARD_RESET, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_iptcrcdeletedbuffersfifofull(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HANDLE_CRC_DEL_BUF_FIFO, NULL);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_HANDLE_CRC_DEL_BUF_FIFO, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_recurring_action_iptcrcerrpkt(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 1, ARAD_INT_CORR_ACT_INGRESS_HARD_RESET, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_nbi_link_status_change(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */   
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg , corrective_action, (void*)(&port), NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_nbiilkntxport0statuserrint(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    if (err_field_cnt0 + err_field_cnt1 + err_field_cnt2 + err_field_cnt3 > 0 ) {
        corr_act = ARAD_INT_CORR_ACT_HARD_RESET_WITHOUT_FABRIC;
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, corr_act, special_msg);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, corr_act, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_oamppendingevent(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* print info */
    rc = arad_interrupt_print_info(unit, block_instance, en_arad_interrupt, 0, ARAD_INT_CORR_ACT_HANDLE_OAMP_EVENT_FIFO, NULL);
    BCMDNX_IF_ERR_EXIT(rc);

    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_HANDLE_OAMP_EVENT_FIFO, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_rtplinkmaskchange(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    /* corrective action */
    rc = arad_interrupt_handles_corrective_action(unit, block_instance, en_arad_interrupt, msg, ARAD_INT_CORR_ACT_RTP_LINK_MASK_CHANGE, NULL, NULL);
    BCMDNX_IF_ERR_EXIT(rc);
...
int arad_interrupt_handle_schsmpbadmsg(int unit, int block_instance, arad_interrupt_type en_arad_interrupt, char *msg)
{
    ...
    if(err_cnt & 0x10000000) { /* varify that bit 28 is 1 */
         ...
         SOCDNX_IF_ERR_EXIT(rc); 
         rc = soc_reg32_get(unit, SCH_INCORRECT_STATUS_MESSAGE___REGISTER_1r, block_instance, 0, &msg_reg2);
         SOCDNX_IF_ERR_EXIT(rc); 
