                               ...
                               bcm_cosq_gport_discard_t *discard)
{
    ...
    if (SOC_IS_TOMAHAWK(unit)) {
        return bcm_th_cosq_gport_discard_set(unit, port, cosq, discard);
    }
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(unit)) {
        return bcm_th_cosq_gport_discard_get(unit, port, cosq, discard);
    }
#endif /* BCM_TOMAHAWK_SUPPORT */
#ifdef BCM_TRIDENT2_SUPPORT
    if (SOC_IS_TD2_TT2(unit)) {
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(unit)) {
        return bcm_th_cosq_gport_add(unit, port, numq, flags, gport);
    }
#endif /* BCM_TOMAHAWK_SUPPORT */
#ifdef BCM_TRIDENT2_SUPPORT
    if (SOC_IS_TD2_TT2(unit)) {
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(unit)) {
        return bcm_th_cosq_gport_delete(unit, gport);
    }
#endif /* BCM_TOMAHAWK_SUPPORT */
#ifdef BCM_TRIDENT2_SUPPORT
    if (SOC_IS_TD2_TT2(unit)) {
                         ...
                         bcm_cosq_control_t type, int arg)
{
    ...
    COMPILER_REFERENCE(kbits_burst_max);
        ...
        if (SOC_IS_TOMAHAWK(unit)) {
            BCM_IF_ERROR_RETURN
                (bcm_th_cosq_control_set(unit, gport, cosq, type, arg));
        }
#endif /* BCM_TOMAHAWK_SUPPORT */
                         ...
                         bcm_cosq_control_t type, int *arg)
{
    ...
    soc_reg_t select_reg[8] = { \
        ...
        if (SOC_IS_TOMAHAWK(unit)) {
            BCM_IF_ERROR_RETURN
                (bcm_th_cosq_control_get(unit, gport, cosq, type, arg));
        }
#endif /* BCM_TOMAHAWK_SUPPORT */
