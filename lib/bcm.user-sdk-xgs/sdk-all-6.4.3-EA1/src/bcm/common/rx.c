...
rx_thread_start(int unit)
{
    ...
    LOG_DEBUG(BSL_LS_BCM_TRACE,
              (BSL_META_U(unit,
                          "Calling sal_thread_create for RX\n")));
#endif
    /* Start rx thread. */
    ...
    LOG_DEBUG(BSL_LS_BCM_TRACE,
              (BSL_META_U(unit,
                          "sal_thread_create for RX complete\n")));
#endif
