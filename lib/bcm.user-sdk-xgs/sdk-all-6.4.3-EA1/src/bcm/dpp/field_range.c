 ...
 */
STATIC int
_bcm_dpp_field_range_info_from_qual(_bcm_dpp_field_info_t *unitData,
    ...
    if (unitData->devInfo->ranges[index].qualifier == qual) {
        LOG_DEBUG(BSL_LS_BCM_FP,
                  (BSL_META_U(unit,
                   ...
                   unitData->qualMaps[unitData->devInfo->ranges[index].qualifier][_BCM_DPP_FIELD_QUALMAP_OFFSET_FLAGS],
                   unitData->devInfo->ranges[index].rangeFlags,
                   unitData->devInfo->ranges[index].rangeBase,
                   unitData->devInfo->ranges[index].count));
        if (qualifierFlags) {
            *qualifierFlags = unitData->qualMaps[qual][_BCM_DPP_FIELD_QUALMAP_OFFSET_FLAGS];
        }
        if (rangeFlags) {
 ...
 */
STATIC int
_bcm_dpp_field_range_info_from_flags(_bcm_dpp_field_info_t *unitData,
                                     uint32 flags,
                                     bcm_field_qualify_t *qual,
                                     int32 *qualifierFlags,
                                     uint32 *rangeFlags,
                                     ...
                                     _bcm_dpp_field_range_idx_t *count)
{
    ...
    if (bcmFieldQualifyCount > unitData->devInfo->ranges[index].qualifier) {
        ...
        if (qualifierFlags) {
            *qualifierFlags = unitData->qualMaps[unitData->devInfo->ranges[index].qualifier][_BCM_DPP_FIELD_QUALMAP_OFFSET_FLAGS];
        }
        if (rangeFlags) {
            *rangeFlags = unitData->devInfo->ranges[index].rangeFlags;
        }
 ...
 */
STATIC int
_bcm_dpp_field_range_info_from_id(_bcm_dpp_field_info_t *unitData,
 ...
 */
STATIC int
_bcm_dpp_field_range_mark_inuse(_bcm_dpp_field_info_t *unitData,
                                bcm_field_range_t range,
                                int inuse)
{
    int index;
 ...
 */
STATIC int
_bcm_dpp_field_range_get(_bcm_dpp_field_info_t *unitData,
                         bcm_field_range_t range,
                         int maxCount,
                         uint32 *flags,
                         uint32 *min,
 ...
 */
STATIC int
_bcm_dpp_field_range_set_id(_bcm_dpp_field_info_t *unitData,
                            int replace,
                            bcm_field_range_t range,
                            int count,
                            uint32 *flags,
 ...
 */
STATIC int
_bcm_dpp_field_qualify_RangeCheck(_bcm_dpp_field_info_t *unitData,
                                  bcm_field_qualify_t qual,
 ...
 */
STATIC int
_bcm_dpp_field_qualify_RangeCheck_get(_bcm_dpp_field_info_t *unitData,
                                      bcm_field_qualify_t qual,
                                      bcm_field_entry_t entry,
                                      int max_count,
                                      bcm_field_range_t *range,
                                ...
                                const char *prefix)
{
    ...
    for (rangeType = 0;
        ...
        for (entryType = 0, found = FALSE;
             ...
             entryType++) {
            mapData = &(unitData->qualMaps[qual][(entryType *
            ...
            if (unitData->qualMaps[qual][_BCM_DPP_FIELD_QUALMAP_OFFSET_FLAGS] &
            ...
            } else if (unitData->qualMaps[qual][_BCM_DPP_FIELD_QUALMAP_OFFSET_FLAGS] &
 ...
 *                    BCM_E_* appropriately if not
 *   Notes
 *      This one, in keeping with behaviour of other devices, allows all types
