...
int bcm_petra_trill_vpn_create(
    ...
    if ((SOC_DPP_CONFIG(unit)->trill.transparent_service != 0) && 
        ((info->flags & BCM_BCM_TRILL_VPN_TRANSPARENT_SERVICE) != 0) &&
        ...
        bcm_gport_t port) 
{
    ...
    if (trill_vpn->flags & BCM_BCM_TRILL_VPN_TRANSPARENT_SERVICE) {
...
int _bcm_dpp_trill_vlan_editing_create(
    ...
    BCMDNX_IF_ERR_EXIT(rv);
     ...
     if ((trill_vpn->flags & BCM_BCM_TRILL_VPN_TRANSPARENT_SERVICE) != 0) {
