...
/*typedef struct bcm_dfe_rx_callback_info_s{
    bcm_rx_cb_f cb_f;
    void *cookie;
    int is_valid;
} bcm_dfe_rx_callback_info_t;

bcm_dfe_rx_callback_info_t bcm_dfe_rx_callback_info_array[BCM_UNITS_MAX];*/
    ...
    int unit)
{
    ...
    init callback info array
    for (i = 0 ; i < BCM_UNITS_MAX ; i++)
    {
        bcm_dfe_rx_callback_info_array[i].is_valid = 0;
    }
