...
int ip_tunnel_term_glbl_init(int unit, int flags){
    ip_tunnel_term_glbl_info.tunnel_vrf = 3;
    ip_tunnel_term_glbl_info.rif_vrf = 2;
    ip_tunnel_term_glbl_info.plus_1_protection = 0;
    ip_tunnel_term_glbl_info.plus_1_mc_id = 6200;
    ip_tunnel_term_glbl_info.skip_ethernet_flag = 0;
    return BCM_E_NONE;
}
...
int ipv4_tunnel_term_build_tunnel_terms(int unit, int in_port, int out_port,bcm_if_t *eg_intf_ids, bcm_gport_t *in_tunnel_gports){
    ...
    /* tunnel term 2 info: according to DIP  only*/
    bcm_tunnel_terminator_t tunnel_term_2;
    int sip2 = 0x0; /* 0.0.0.10*/
    int dip2 = 0xAB000011; /* 171.0.0.17*/
    int sip2_mask = 0x0; 
