 ...
 *
   ...
   cint
   print qos_map_l3(0);
   qos_map_id_multi_get(0);
   qos_map_l3_multi_ingress_get(0, BCM_QOS_MAP_L3|BCM_QOS_MAP_IPV4, l3_in_map_id);
   qos_map_l3_multi_ingress_get(0, BCM_QOS_MAP_L3|BCM_QOS_MAP_IPV6, l3_in_map_id);
   qos_map_l3_multi_egress_get(0, BCM_QOS_MAP_L3|BCM_QOS_MAP_IPV4, l3_eg_map_id);
   qos_map_l3_multi_egress_get(0, BCM_QOS_MAP_L3|BCM_QOS_MAP_IPV6, l3_eg_map_id);
   qos_map_id_destroy(0, l3_eg_map_id);
