                                                           ...
                                                           /* in */bcm_pbmp_t in_pbmp)
{
    ...
    result = bcm_field_qualify_Stage(unit, presel_id_up_static | BCM_FIELD_QUALIFY_PRESEL, bcmFieldStageIngress);
    if (BCM_E_NONE != result)
    {
    ...
    result = bcm_field_qualify_InPorts(unit, presel_id_up_static | BCM_FIELD_QUALIFY_PRESEL, pbm, pbm_mask);
    if (BCM_E_NONE != result)
    {
    ...
    result = bcm_field_qualify_InterfaceClassVPort(unit, presel_id_up_static | BCM_FIELD_QUALIFY_PRESEL, 0x1, 0x1);
    if (BCM_E_NONE != result)
    {
