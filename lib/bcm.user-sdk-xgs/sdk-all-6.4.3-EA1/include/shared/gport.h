...
#define _SHR_COSQ_GPORT_VSQ_CT_SET(_gport, _core_id, _category) \
             ((_gport) = 0)

#define _SHR_COSQ_GPORT_IS_VSQ_CT(_gport) \
             (0)

#define _SHR_COSQ_GPORT_VSQ_CTTC_SET(_gport, _core_id, _category, _traffic_class)  \
             ((_gport) = 0)

#define _SHR_COSQ_GPORT_IS_VSQ_CTTC(_gport) \
             (0)

#define _SHR_COSQ_GPORT_VSQ_CTCC_SET(_gport, _core_id, _category, _connection_class) \
             ((_gport) = 0)
...
#define _SHR_COSQ_GPORT_VSQ_SRC_PORT_SET(_gport, _src_port_vsq_id) \
             ((_gport) = 0)
...
#define _SHR_GPORT_LOCAL_FABRIC_SET(_gport, _link_id)\
        ...
        (((_gport) & _SHR_GPORT_PORT_MASK) << _SHR_GPORT_PORT_SHIFT))
