...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitch__Count = 905              /* Must be last.  Not a usable value. */
...
/* Initialize a bcm_switch_pkt_trace_info_s */
typedef struct bcm_switch_pkt_trace_info_s {
    uint32 ivp_raw_data[4];     /* packet trace ivp process result data */
    uint32 isw1_raw_data[8];    /* packet trace isw1 process result data */
    uint32 isw2_raw_data[16];   /* packet trace isw2 process result data */
    uint8 dest_pipe_num;        /* ingress pipeline number of the pkt trace
                                   packet */
