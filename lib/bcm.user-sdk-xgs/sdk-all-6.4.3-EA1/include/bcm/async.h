 ...
 * Generated:	Tue Aug 19 17:58:36 2014
 */
...
void	bcm_field_compress_create_async(int unit, bcm_field_compression_t options, bcm_field_compress_attr_t * c_attr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compress_destroy_async(int unit, int compress_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compress_get_async(int unit, int compress_id, bcm_field_qualify_t qual, uint64 * comp_data, uint16 alloc_size, uint32 * orig_data, uint32 * orig_mask, uint16 * size, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compress_multi_get_async(int unit, int compress_id, uint16 alloc_size, uint32 * orig_data, uint32 * comp_data, uint16 * size, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compress_multi_set_async(int unit, int compress_id, int alloc_size, uint32 * orig_data, uint32 * comp_data, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compress_set_async(int unit, int compress_id, bcm_field_qualify_t qual, int alloc_size, uint32 * orig_data, uint32 * orig_mask, uint64 comp_data, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compress_size_get_async(int unit, bcm_field_qualify_t qual, int * max_size, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_compressed_mask_length_get_async(int unit, bcm_field_qualify_t qual, int * length, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_port_get_async(int unit, bcm_port_t port, bcm_port_interface_info_t * interface_info, bcm_port_mapping_info_t * mapping_info, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_switch_pkt_trace_info_get_async(int unit, bcm_switch_pkt_trace_info_t * pkt_trace_info, bcm_async_cb_t async_callback, void *async_cookie);
