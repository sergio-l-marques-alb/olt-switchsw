...
int _bcm_dpp_am_template_oam_mep_profile_non_accelerated_data_get(int unit, int mep_id, SOC_PPD_OAM_LIF_PROFILE_DATA* data);
...
int _bcm_dpp_am_template_oam_mep_profile_non_accelerated_mapping_get(int unit, int mep_id, int *profile);
int _bcm_dpp_am_template_oam_mep_profile_non_accelerated_exchange(int unit, int flags, int mep_id, SOC_PPD_OAM_LIF_PROFILE_DATA * data,
...
int _bcm_dpp_am_template_bfd_mep_profile_non_accelerated_data_from_profile_get(int unit, int profile, SOC_PPD_OAM_LIF_PROFILE_DATA* data);
...
/* BFD IPV4 DIP - Start */
int _bcm_dpp_am_template_bfd_ipv4_dip_alloc(int unit, int flags, SOC_SAND_PP_IPV4_ADDRESS *data, int *is_allocated, int *profile_ndx);
int _bcm_dpp_am_template_bfd_ipv4_dip_free(int unit, int profile_ndx, int *is_last);
int _bcm_dpp_am_template_bfd_ipv4_dip_data_get(int unit, int profile_ndx, SOC_SAND_PP_IPV4_ADDRESS* data);
/* BFD IPV4 DIP - End */
...
#ifdef BCM_ARAD_SUPPORT
int _bcm_dpp_am_template_queue_rate_cls_mapping_mode_advance_enable(int unit);
#endif /*BCM_ARAD_SUPPORT*/
...
int
bcm_dpp_am_reassembly_context_alloc(
    int unit,
    uint32 *context);

int
bcm_dpp_am_reassembly_context_dealloc(
    int unit,
    uint32 context);
