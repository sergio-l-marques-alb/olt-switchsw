...
#define   DPP_NOF_EGRESS_VLAN_EDIT_PROFILES         (16)
#define   DPP_NOF_EGRESS_VLAN_EDIT_PROFILE_BITS     (4)
#define   DPP_EGRESS_VLAN_EDIT_PROFILE_MASK         (0xF)
...
#define BCM_DPP_VLAN_EDIT_PROFILE_VALID(unit, vlan_edit_profile, is_ingress) do {                               \
    if ( (is_ingress && (vlan_edit_profile >= DPP_NOF_INGRESS_VLAN_EDIT_PROFILES)) ||                           \
        (!is_ingress && (vlan_edit_profile >= DPP_NOF_EGRESS_VLAN_EDIT_PROFILES)))                              \
