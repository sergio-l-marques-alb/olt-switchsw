 ...
 */
#define _BCM_DPP_NOF_LOCAL_PORTS(unit) (SOC_IS_PETRAB(unit) ? SOC_TMC_NOF_FAP_PORTS_PETRA : SOC_TMC_NOF_FAP_PORTS_ARAD)
...
#define _BCM_DPP_FIELD_GROUP_STAGE_VT               0x00200000 /* field groups with qset defined by VT */
#define _BCM_DPP_FIELD_GROUP_WITH_HEADER_SELECTION  0x00400000 /* field groups with header index selection*/
#define _BCM_DPP_FIELD_GROUP_EXTENDED_IPV4_MPLS_FWRD_DB 0x00800000 /* field groups with header index selection*/
#define _BCM_DPP_FIELD_GROUP_EXTENDED_IPV6_FWRD_DB  0x01000000 /* field groups with header index selection*/
#define _BCM_DPP_FIELD_GROUP_TINFO                  0x00001EC1


typedef enum _bcm_field_vt_classification_qset_info_e {
    _BCM_DPP_VT_CLASSIFICATION_IPV4_MATCH = 0,
    _BCM_DPP_VT_CLASSIFICATION_EFP,
    _BCM_DPP_VT_CLASSIFICATION_COUNT /* always last; not a valid value */
} _bcm_field_vt_classification_qset_type_t;
...
typedef struct _bcm_dpp_field_group_s {
    ...
    _bcm_field_vt_classification_qset_type_t vt_classification;
...
typedef struct _bcm_arad_field_device_qual_info_layer_s {
    ...
    int32 i_psel_a, i_psel_b; /* chain 0,1 of map 4 */
    int32 f_l2_a, f_l2_b;     /* chain 0,1 of map 0 */
    int32 f_ipv4_a, f_ipv4_b; /* chain 0,1 of map 1 */
    int32 f_ipv6_a, f_ipv6_b; /* chain 0,1 of map 2 */
    int32 f_mpls_a, f_mpls_b; /* chain 0,1 of map 3 */
    int32 f_psel_a, f_psel_b; /* chain 0,1 of map 4 */
    int32 s_l2_a, s_l2_b;     /* chain 0,1 of map 0 */
    int32 s_ipv4_a, s_ipv4_b; /* chain 0,1 of map 1 */
    int32 s_ipv6_a, s_ipv6_b; /* chain 0,1 of map 2 */
    int32 s_mpls_a, s_mpls_b; /* chain 0,1 of map 3 */
    int32 s_psel_a, s_psel_b; /* chain 0,1 of map 4 */
    int32 e_l2_a, e_l2_b;     /* chain 0,1 of map 5 */
    int32 e_ipv4_a, e_ipv4_b; /* chain 0,1 of map 6 */
    int32 e_ipv6_a, e_ipv6_b; /* chain 0,1 of map 7 */
    int32 e_mpls_a, e_mpls_b; /* chain 0,1 of map 8 */
    int32 e_psel_a, e_psel_b; /* chain 0,1 of map 9 */
...
typedef struct _bcm_arad_field_device_action_info_layer_s {
    ...
    int32 ing_flp_a, ing_flp_b;   /* chain 0,1 of stage 2 */
    int32 ing_slb_a, ing_slb_b;   /* chain 0,1 of stage 3 */
