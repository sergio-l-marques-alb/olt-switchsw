...
typedef struct bcm_async_req_s {
	...
	union {
		...
		} field_compress_create;
		struct {
			int unit;
			int compress_id;
		} field_compress_destroy;
		struct {
			int unit;
			int compress_id;
		...
		struct {
			...
			bcm_field_qualify_t qual;
			int * max_size;
		} field_compress_size_get;
		struct {
			int unit;
			bcm_field_qualify_t qual;
			int * length;
		} field_compressed_mask_length_get;
		struct {
			int unit;
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_CREATE,
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_DESTROY,
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_GET,
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_MULTI_GET,
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_MULTI_SET,
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_SET,
	BCM_ASYNC_ENTRY_FIELD_COMPRESS_SIZE_GET,
	BCM_ASYNC_ENTRY_FIELD_COMPRESSED_MASK_LENGTH_GET,
