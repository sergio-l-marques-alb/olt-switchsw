...
typedef struct dcmn_port_default_config_s {
    int pcs;
    int speed;
    int cl72;
} dcmn_port_default_config_t;
...
soc_error_t soc_dcmn_fabric_port_probe(int unit, int port, dcmn_port_init_stage_t init_stage, int fw_verify, dcmn_port_default_config_t* default_port_config);
