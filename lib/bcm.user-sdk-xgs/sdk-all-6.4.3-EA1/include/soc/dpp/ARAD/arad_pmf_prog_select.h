 ...
 *************/
/* { */
#define ARAD_PMF_BITS_TO_U32(bits)    (((bits)+31)/32)
...
#define ARAD_PMF_NOF_LINES_LEN                  ARAD_PMF_BITS_TO_U32(ARAD_PMF_NOF_LINES)
#define ARAD_PMF_NOF_LINES_MAX_ALL_STAGES_LEN   ARAD_PMF_BITS_TO_U32(ARAD_PMF_NOF_LINES_MAX_ALL_STAGES)
#define ARAD_PMF_NOF_GROUPS                     (SOC_PPC_FP_NOF_PFGS_ARAD)
#define ARAD_PMF_GROUP_LEN                      (ARAD_PMF_BITS_TO_U32(ARAD_PMF_NOF_GROUPS))
...
#define ARAD_PMF_SEL_LINE_LEN            ARAD_PMF_BITS_TO_U32(ARAD_PMF_SEL_LINE_NOF_BITS)
...
struct ARAD_SW_DB_PMF_PSL_LINE_INFO_s;
struct ARAD_SW_DB_PMF_PSL_LEVEL_INFO_s;
...
uint32 
  arad_pmf_sel_line_hw_write(
      ...
      SOC_SAND_IN  ARAD_FP_DATABASE_STAGE            stage,
      SOC_SAND_IN  uint32                 entry_offset,
      SOC_SAND_IN   struct ARAD_SW_DB_PMF_PSL_LINE_INFO_s      *line,
