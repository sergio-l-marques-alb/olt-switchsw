...
#define SOC_PPD_NOF_EGRESS_VLAN_EDIT_ACTION_IDS             SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_IDS
#define SOC_PPD_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS        SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS
