...
} SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_FUNCTION;
...
/* Set/get the ECMP and LAG offset/shift. */
typedef struct {
  SOC_PPC_SLB_CONFIGURATION_ITEM base;

  /* 4 bits. */
  uint8 offset;
} SOC_PPC_SLB_CONFIGURATION_ITEM_HASH_OFFSET;
...
PPC_API_SLB_INTERNAL_OBJECT_LIST_ONLY_OBJECT_ACTION(CONFIGURATION_ITEM_HASH_FUNCTION)
...
PPC_API_SLB_INTERNAL_OBJECT_LIST_ONLY_OBJECT_ACTION(CONFIGURATION_ITEM_HASH_OFFSET)
