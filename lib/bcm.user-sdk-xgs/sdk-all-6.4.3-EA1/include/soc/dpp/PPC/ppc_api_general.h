...
typedef enum
{
   ...
   *  Trill packet.
   */
  SOC_PPC_L2_NEXT_PRTCL_TYPE_TRILL = 0x1,
  /*
   *  IPv4 packet.
   */
   ...
   *  MPLS packet.
   */
  SOC_PPC_L2_NEXT_PRTCL_TYPE_MPLS = 0x2,
  /*
...
/* Trap codes SOC_PPC_TRAP_CODE_USER_DEFINED_36 and SOC_PPC_TRAP_CODE_USER_DEFINED_37 used also for OAM WA */
...
typedef enum
{
 ...
 /*
  ...
  /*
   * EoTrilloE packet is not designtated vlan but with my-mac, or designated vlan but without my-mac.
...
typedef struct
{
   ...
   *  push_profile 0. See SOC_PPD_EEI.
   */
  uint32 push_profile;
  /*
...
const char*
  SOC_PPC_PKT_HDR_STK_TYPE_to_string(
    SOC_SAND_IN  SOC_PPC_PKT_HDR_STK_TYPE enum_val
  );
