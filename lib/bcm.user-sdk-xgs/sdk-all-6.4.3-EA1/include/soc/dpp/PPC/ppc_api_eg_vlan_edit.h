...
/* The Egress mapping is done from 4bits of edit profile and 4bits of tag format to 256 command IDs */
#define SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS_ARAD       (256)
#define SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_IDS_ARAD            (SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS_ARAD)
...
#define SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS            (SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_MAPPINGS_ARAD)
#define SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_IDS                 (SOC_PPC_NOF_EGRESS_VLAN_EDIT_ACTION_IDS_ARAD)
...
typedef struct
{
   ...
   *  profile is set according to the port setting. Range: 0 -
   *  15.
   */
  uint32 edit_profile;
