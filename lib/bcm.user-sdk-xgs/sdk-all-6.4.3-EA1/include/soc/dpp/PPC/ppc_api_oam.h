...
#define SOC_PPC_OAM_IS_MEP_TYPE_BFD(mep_type) \
  ((mep_type==SOC_PPC_OAM_MEP_TYPE_BFD_O_IPV4_1_HOP) || (mep_type==SOC_PPC_OAM_MEP_TYPE_BFD_O_IPV4_M_HOP) || \
   ...
   (mep_type==SOC_PPC_OAM_MEP_TYPE_BFDCC_O_MPLSTP) || (mep_type==SOC_PPC_OAM_MEP_TYPE_BFDCV_O_MPLSTP)     || \
   (mep_type==SOC_PPC_OAM_MEP_TYPE_BFD_O_PWE_GAL))
...
#define PPC_API_OAM_STORE_LOCAL_PORT_IN_MEP_DB(mep_type)       \
  ((mep_type == SOC_PPD_OAM_MEP_TYPE_BFD_O_IPV4_1_HOP) ||       \
   ...
   (mep_type == SOC_PPD_OAM_MEP_TYPE_BFD_O_MPLS) ||             \
   (mep_type == SOC_PPD_OAM_MEP_TYPE_ETH_OAM))
...
#define SOC_PPC_OAM_OPCODE_MAP_CCM    1 
#define SOC_PPC_OAM_OPCODE_MAP_LBR    2 
#define SOC_PPC_OAM_OPCODE_MAP_LBM    3
#define SOC_PPC_OAM_OPCODE_MAP_LTR    4
#define SOC_PPC_OAM_OPCODE_MAP_LTM    5 
#define SOC_PPC_OAM_OPCODE_MAP_LMR    6
#define SOC_PPC_OAM_OPCODE_MAP_LMM    7
#define SOC_PPC_OAM_OPCODE_MAP_DMR    8 
#define SOC_PPC_OAM_OPCODE_MAP_DMM    9
#define SOC_PPC_OAM_OPCODE_MAP_1DM    10 
#define SOC_PPC_OAM_OPCODE_MAP_SLM    11
#define SOC_PPC_OAM_OPCODE_MAP_SLR    11
#define SOC_PPC_OAM_OPCODE_MAP_AIS    12 
#define SOC_PPC_OAM_OPCODE_MAP_LCK    13 
#define SOC_PPC_OAM_OPCODE_MAP_LINEAR_APS    14 
#define SOC_PPC_OAM_OPCODE_MAP_DEFAULT    15
#define SOC_PPC_OAM_OPCODE_MAP_COUNT 16 /* number of ethernet internal opcodes */
...
typedef enum {
  ...
  SOC_PPC_OAM_MEP_TYPE_BFDCC_O_MPLSTP,
  SOC_PPC_OAM_MEP_TYPE_LM,
  SOC_PPC_OAM_MEP_TYPE_LM_STAT,
  SOC_PPC_OAM_MEP_TYPE_DM,
  SOC_PPC_OAM_MEP_TYPE_BFDCV_O_MPLSTP,  /*Usupported for now.*/
  SOC_PPC_OAM_MEP_TYPE_BFD_O_PWE_GAL,  /*Supported only in Arad+.*/
...
typedef struct {
    SOC_SAND_MAGIC_NUM_VAR
    SHR_BITDCL             counter_disable;
    SHR_BITDCL             meter_disable;
...
typedef struct {
    ...
    uint8 acc_profile;
    uint16 flags;  /*  is_accelerated, is_mep, is_pcp, is_dm_1588, is_upmep, and some more */
    /*oam*/
    uint8 md_level;
...
typedef struct {
    ...
    uint8 mirror_strength; /* Jericho only*/
    uint8 mirror_enable; /* Jericho only*/
...
/* RX your-discr range defined by configuration of 16 MSBs*/
#define SOC_PPC_BFD_RX_YOUR_DISCRIMINATOR_RANGE_BIT_START           16
#define SOC_PPC_BFD_DISCRIMINATOR_TO_LIF_START_MASK         0xFFFF
#define SOC_PPC_BFD_DISCRIMINATOR_TO_ACC_MEP_ID_START_MASK         (SOC_IS_JERICHO(unit)?0x3FFF: 0x1FFF) /* Should be mapped to a legal MEP-DB entry*/

#define SOC_PPC_BFD_PDU_LENGTH  0x18
#define SOC_PPC_BFD_PDU_VERSION 0x1

/* ARAD+ */
#define SOC_PPC_OAM_OAMP_NUMBER_OF_PUNT_PROFILES  4
