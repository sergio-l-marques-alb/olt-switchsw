...
typedef struct
{
  ...
  /*   
   *  InLIF profile bits assignment
   */
  SOC_PPC_PROFILE_MGMT_INLIF_PROFILE_TYPE inlif_bits[SOC_PPC_PROFILE_MGMT_INLIF_PROFILE_NOF_BITS];
  /*   
   *  OutLIF profile bits assignment
   */
  SOC_PPC_PROFILE_MGMT_OUTLIF_PROFILE_TYPE outlif_bits[SOC_PPC_PROFILE_MGMT_OUTLIF_PROFILE_NOF_BITS_MAX];
  /*   
   *  RIF profile bits assignment
   */
  SOC_PPC_PROFILE_MGMT_RIF_PROFILE_TYPE rif_bits[SOC_PPC_PROFILE_MGMT_RIF_PROFILE_NOF_BITS];
} SOC_PPC_DIAG_LIF_PROFILE_INFO;
