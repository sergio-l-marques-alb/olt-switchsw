...
#define SOC_PB_CNT_MODE_ING_NO_COLOR                           SOC_TMC_CNT_MODE_ING_NO_COLOR
#define SOC_PB_CNT_MODE_ING_COLOR_RES_LOW                      SOC_TMC_CNT_MODE_ING_COLOR_RES_LOW
#define SOC_PB_CNT_MODE_ING_COLOR_RES_HI                       SOC_TMC_CNT_MODE_ING_COLOR_RES_HI
#define SOC_PB_CNT_NOF_MODE_INGS                               SOC_TMC_CNT_NOF_MODE_INGS
typedef SOC_TMC_CNT_MODE_ING                                   SOC_PB_CNT_MODE_ING;
...
const char*
  SOC_PB_CNT_MODE_ING_to_string(
    SOC_SAND_IN  SOC_PB_CNT_MODE_ING enum_val
  );
