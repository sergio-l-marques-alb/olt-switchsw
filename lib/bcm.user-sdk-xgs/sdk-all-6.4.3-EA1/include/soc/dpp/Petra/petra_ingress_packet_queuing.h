/* $Id: petra_ingress_packet_queuing.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/soc_petra/include/soc_petra_ingress_packet_queuing.h
*
...
#ifndef __SOC_PETRA_INGRESS_PACKET_QUEUING_INCLUDED__
/* { */
#define __SOC_PETRA_INGRESS_PACKET_QUEUING_INCLUDED__
 ...
 *************/
/* { */
#define SOC_PETRA_IPQ_INVALID_FLOW_QUARTET          0x3fff
/* } */
...
/*********************************************************************
* NAME:
*     soc_petra_ingress_packet_queuing_init
* FUNCTION:
*     Initialization of the Soc_petra blocks configured in this module.
* INPUT:
*  SOC_SAND_IN  int                 unit -
...
/* } __SOC_PETRA_INGRESS_PACKET_QUEUING_INCLUDED__*/
#endif
