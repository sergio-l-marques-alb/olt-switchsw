...
typedef struct
{
   ...
   */
  SOC_TMC_ACTION_CMD_SIZE_BYTES snoop_size;
  /*
   *  Probability of Snoop execution.
   */
  uint32 snoop_prob;

} SOC_TMC_ACTION_CMD_SNOOP_INFO;
...
typedef struct
{
   ...
   *  The size of the snooped packet that is generated.
   */
  SOC_TMC_ACTION_CMD_SIZE_BYTES mirror_size;
  /*
   *  Probability of Mirror execution.
   */
  uint32 mirror_prob;

} SOC_TMC_ACTION_CMD_MIRROR_INFO;
