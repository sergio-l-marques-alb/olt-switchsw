...
int _sgmiip2x4_pll_disable(const PHYMOD_ST *pa)
{
    ...
    /* Disable PLL 0x8000 : 0x052F(XGXS_10G) 0x062f(SGMIIP2X4) */
...
int _sgmiip2x4_pll_enable(const PHYMOD_ST *pa)
{
    ...
    /* Enable PLL 0x8000 : 0x253F(XGXS_10G) 0x262f(SGMIIP2X4) */
...
int viper_xgxs_sel_enable(PHYMOD_ST *pa, uint32_t enable)
{
    ...
    PLL_AFE_TCATIMER1r_t pll_reg;

    PLL_AFE_TCATIMER1r_CLR(pll_reg);
    READ_PLL_AFE_TCATIMER1r(pa, &pll_reg);
    PLL_AFE_TCATIMER1r_XGXS_SELf_SET(pll_reg, enable);
    PHYMOD_IF_ERR_RETURN(MODIFY_PLL_AFE_TCATIMER1r(pa, pll_reg));
...
int viper_diag_topology(PHYMOD_ST *pa)
{
     ...
     uint32_t tx_lane_swap, rx_lane_swap;
