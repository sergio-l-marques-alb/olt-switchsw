                                               ...
                                               const bcm_plp_base_t_secy_sa_t * const new_sa_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_chain(pa, active_sa_handle, new_sa_handle_p, new_sa_p);
    if(rv !=0){
                                                ...
                                                const bcm_plp_base_t_secy_sa_t * const new_sa_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_switch(pa, active_sa_handle, new_sa_handle, new_sa_p);
    if(rv !=0){
                                                    ...
                                                    unsigned int * const max_sc_count_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_limits(pa, max_vport_count_p, max_rule_count_p, max_sa_count_p,max_sc_count_p);
    if(rv !=0){
                                          ...
                                          const bcm_plp_base_t_secy_vport_handle_t * const handle2_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_vport_handle_issame(pa, handle1_p, handle2_p);
	if(rv ==0 || rv ==1){
		return rv;
	}else{
                                                          ...
                                                          const bcm_plp_base_t_secy_sa_handle_t * const handle2_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_handle_issame(pa, handle1_p, handle2_p);
    if(rv ==0 || rv ==1){
        return rv;
    }else{
                                                                      ...
                                                                      const unsigned int sa_index)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_handle_sa_index_issame(pa, sa_handle, sa_index);
    if(rv ==0 || rv ==1){
        return rv;
    }else{
                                                     ...
                                                     unsigned char * const fnext_pn_written_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_nextpn_update(pa, sa_handle, next_pn_lo,next_pn_hi,fnext_pn_written_p);
    if(rv !=0){
                                                      ...
                                                      const bcm_plp_base_t_secy_device_params_t  * const device_p )
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_update(pa, device_p);
    if(rv !=0){
	                                                                      ...
	                                                                      const unsigned int bypass_length)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_crypt_auth_bypass_len_update(pa, bypass_length);
    if(rv !=0){
                                                                  ...
                                                                  const bcm_plp_base_t_secy_sc_rule_mtu_check_t * const mtucheck_rule_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_rules_mtu_check_update(pa, sci_index, mtucheck_rule_p );
    if(rv !=0){
                                                                      ...
                                                                      const bcm_plp_base_t_secy_rule_handle_t * const handle2_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_rule_handle_issame(pa, handle1_p, handle2_p );
    if(rv ==0 || rv ==1){
        return rv;
    }else{
                                                    ...
                                                    unsigned int * const sc_index_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_index_get(pa, sa_handle, sa_index_p, sc_index_p);
    if(rv !=0){
                                                      ...
                                                      unsigned int * const rule_index_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_rule_index_get(pa, rule_handle, rule_index_p);
    if(rv !=0){
                                                     ...
                                                     unsigned int * const vport_index_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_vport_index_get(pa, vport_handle, vport_index_p);
    if(rv !=0){
                                                      ...
                                                      bcm_plp_base_t_secy_sa_handle_t * const sa_handle_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_handle_get(pa, sa_index, sa_handle_p);
    if(rv !=0){
                                                      ...
                                                      bcm_plp_base_t_secy_rule_handle_t * const rule_handle_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_rule_handle_get(pa, rule_index, rule_handle_p);
    if(rv !=0){
                                                         ...
                                                         bcm_plp_base_t_secy_vport_handle_t * const vport_handle_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_vport_handle_get(pa, vport_index, vport_handle_p);
    if(rv !=0){
                                                          ...
                                                          const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_tcam_statistics_get(pa, rule_handle, stat_p, fsync);
    if(rv !=0){
	                                                     ...
	                                                     const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_rxcam_statistics_get(pa, scindex, stats_p, fsync);
    if(rv !=0){
...

{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_secy_statistics_i_get(pa, vport_handle, stats_p,fsync);
    if(rv !=0){
 ...
 * API use order:
 *      This function may be called for the SAHandle obtained via
 *      the bcm_plp_base_t_secy_sa_add(pa) function for the same macsec_side.
 *
 * @param unit (input) BCM unit number
 * @param port (input) - port number
 * @param macsec_side (input) - selects egress or ingress path
                                                              ...
                                                              const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_secy_statistics_e_get(pa, vport_handle, stats_p,fsync);
    if(rv !=0){
                                                          ...
                                                          const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_statistics_i_get(pa, sa_handle, stats_p,fsync);
    if(rv !=0){
                                                         ...
                                                         const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_statistics_e_get(pa, sa_handle, stats_p,fsync);
    if(rv !=0){
	                                                        ...
	                                                        const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_global_statistics_get(pa, stat_p,fsync);
    if(rv !=0){
                                                           ...
                                                           const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_ifc_statistics_e_get(pa, vport_handle,stats_p,fsync);
    if(rv !=0){
                                                          ...
                                                          const unsigned char fsync)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_ifc_statistics_i_get(pa, vport_handle,stats_p,fsync);
    if(rv !=0){
                                                                                         ...
                                                                                         unsigned int * const num_ifc_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_pifc_checkandclear(pa, vport_handle_pp,num_ifc_indexes_p);
    if(rv !=0){
                                                                                             ...
                                                                                             unsigned int * const num_rx_cam_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_prxcam_checkandclear(pa, rx_cam_indexes_pp, num_rx_cam_indexes_p);
    if(rv !=0){
 ...
 * This function is re-entrant for different Devices.
 *
 * This function cannot be called concurrently with bcm_plp_base_t_secy_sa_remove
                                                                                       ...
                                                                                       unsigned int * const num_sa_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_psa_checkandclear(pa, sa_handle_pp, num_sa_indexes_p);
    if(rv !=0){
                                                                                         ...
                                                                                         unsigned int * const nm_secy_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_psecy_checkandclear(pa, vport_handle_pp, nm_secy_indexes_p);
    if(rv !=0){
                                                                                 ...
                                                                                 unsigned int * const num_tcam_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_ptcam_checkandclear(pa, rule_handle_pp, num_tcam_indexes_p);
    if(rv !=0){
                                                                                    ...
                                                                                    unsigned int * const count_summary_sa_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_sa_checkandclear(pa, sa_handle, count_summary_sa_p);
    if(rv !=0){
                                                                                        ...
                                                                                        unsigned int * const count_summary_secy_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_secy_checkandclear(pa, vport_handle, count_summary_secy_p);
    if(rv !=0){
                                                                                             ...
                                                                                             unsigned int * const count_summary_tcam_global_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_tcam_global_checkandclear(pa, count_summary_tcam_global_p);
    if(rv !=0){
                                                                                     ...
                                                                                     unsigned int * const count_summary_ifc_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_device_count_summary_ifc_checkandclear(pa, vport_handle, count_summary_ifc_p);
    if(rv !=0){
                                                                           ...
                                                                           unsigned int * const num_sa_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_expired_summary_checkandclear(pa, sa_handle_pp, num_sa_indexes_p);
    if(rv !=0){
                                                                             ...
                                                                             unsigned int * const num_sa_indexes_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_sa_pnthr_summary_checkandclear(pa, sa_handle_pp, num_sa_indexes_p);
    if(rv !=0){
	                                                   ...
	                                                   const bcm_plp_base_t_secy_intr_t *secy_intr_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_intr_enable_set(pa, secy_intr_p);
    if(rv !=0){
	                                                   ...
	                                                   bcm_plp_base_t_secy_intr_t *secy_intr_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_intr_enable_get(pa, secy_intr_p);
    if(rv !=0){
	                                                   ...
	                                                   bcm_plp_base_t_secy_intr_t *secy_intr_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_intr_status_get(pa, secy_intr_p);
    if(rv !=0){
	                                               ...
	                                               const bcm_plp_base_t_secy_intr_t *secy_intr_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_intr_status_clear(pa, secy_intr_p);
    if(rv !=0){
	                                                    ...
	                                                    bcm_plp_base_t_secy_intr_t *secy_intr_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_event_status_get(pa, secy_intr_p);
    if(rv !=0){
                                                                 ...
                                                                 unsigned int *sa_buffer_p)
{
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
    IMACSEC_PLP_BASE_T_SEC_ACCESS_GET(pc,pa,macsec_side);
    rv = bcm_plp_base_t_secy_build_transform_record(pa, params,sa_buffer_p);
    if(rv !=0){
