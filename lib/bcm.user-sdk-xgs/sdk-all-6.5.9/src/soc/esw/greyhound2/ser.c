...
static _soc_gh2_ser_info_t _soc_gh2_ip0_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_ECC, NULL,
        ...
        SR_PORT_TABLEm, "SR_PORT_TABLE ECC",
        SR_PORT_TABLE_ECC_CONTROLr, ECC_ENf, NULL,
        INVALIDr, INVALIDf, NULL,
    ...
    { _SOC_PARITY_TYPE_ECC, NULL,
        ...
        LPORT_TABm, "LPORT_TABLE/LPORT_PROFILE_TABLE ECC",
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        ...
        INVALIDf, "LPORT_TABLE/LPORT_PROFILE_TABLE PARITY",
        LPORT_TABLE_ECC_CONTROLr, ECC_ENf, NULL,
        INVALIDr, INVALIDf, NULL,
...
static _soc_gh2_ser_info_t _soc_gh2_ip2_sr_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_ECC_DUAL, NULL,
        ...
        SR_FLOW_ING_COUNTER_CONTROLm, NULL,
...
static _soc_gh2_ser_reg_t gh2_soc_wred_regs[] = {
    { WRED_AVG_QSIZE_QG_PARITY_ERR_PTRr, "WRED AVG QSIZE", MMU_WRED_AVG_QSIZE_QGROUPm},
    { WRED_CONFIG_QG_PARITY_ERR_PTRr, "WRED CONFIG", MMU_WRED_CONFIG_QGROUPm},
...
static _soc_gh2_ser_reg_t ipmcgroup_regs[] = {
...
static _soc_gh2_ser_info_t _soc_gh2_mmu_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_MMU_PAR_WRED, NULL,
        WREDPARITYERRORINTMASKf, WREDPARITYERRORf,
        MMU_WRED_AVG_QSIZE_QGROUPm, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, INVALIDf, NULL,
        INVALIDr, gh2_soc_wred_regs, INVALIDf,
        INVALIDr, WREDPARITYERROR_CLRf,
...
STATIC int
_soc_gh2_ser_mem_skip(int unit, int skip_info)
{
    int sku;
    int skip = 0;
    ...
    switch (sku){
        case (SOC_GH2_SKU_HURRICANE3MG):
            if (skip_info & _SOC_SER_SKIP_GH2_HR3MG) {
                skip = 1;
            }
            break;
        case (SOC_GH2_SKU_QUARTZ):
            if (skip_info & _SOC_SER_SKIP_GH2_QUARTZ) {
                skip = 1;
            }
            break;
        default:
...

{
    ...
    for (info_index = 0; ; info_index++) {
        ...
        if (_soc_gh2_ser_mem_skip(unit, info->sku_skip)) {
            continue;
        }
...
static _soc_generic_ser_info_t _soc_gh2_tcam_ser_info_template[] = {
    ...
    { FP_GLOBAL_MASK_TCAMm, INVALIDm, _SOC_SER_TYPE_PARITY,
      ...
      { {0, 67}, {1, 67}, {68, 134}, {69, 134} }, 0, 0, 0, 0,
      _SOC_SER_FLAG_XY_READ},
