...
#ifdef BCM_CMICX_SUPPORT
STATIC soc_cmic_intr_handler_t soc_parity_intr_handlers[] = {
{L2_MGMT_TO_CMIC_INTR, soc_cmicx_parity_intr, INT_TO_PTR(L2_MGMT_TO_CMIC_INTR), "L2_MNGT INTR"},
{MMU_TO_CMIC_MEMFAIL_INTR, soc_cmicx_parity_intr, INT_TO_PTR(MMU_TO_CMIC_MEMFAIL_INTR), "PARITY INTR"},
{PIPE0_EP_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE0_EP_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE1_EP_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE1_EP_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE0_IDB_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE0_IDB_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE1_IDB_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE1_IDB_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE0_IP_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE0_IP_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE1_IP_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE1_IP_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE0_ISW4_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE0_ISW4_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PIPE1_ISW4_TO_CMIC_PERR_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PIPE1_ISW4_TO_CMIC_PERR_INTR), "PARITY INTR"},
{PM0_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM0_INTR), "PARITY INTR"},
{PM1_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM1_INTR), "PARITY INTR"},
{PM2_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM2_INTR), "PARITY INTR"},
{PM3_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM3_INTR), "PARITY INTR"},
{PM4_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM4_INTR), "PARITY INTR"},
{PM5_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM5_INTR), "PARITY INTR"},
{PM6_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM6_INTR), "PARITY INTR"},
{PM7_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM7_INTR), "PARITY INTR"},
{PM8_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM8_INTR), "PARITY INTR"},
{PM9_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM9_INTR), "PARITY INTR"},
{PM10_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM10_INTR), "PARITY INTR"},
{PM11_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM11_INTR), "PARITY INTR"},
{PM12_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM12_INTR), "PARITY INTR"},
{PM13_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM13_INTR), "PARITY INTR"},
{PM14_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM14_INTR), "PARITY INTR"},
{PM15_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM15_INTR), "PARITY INTR"},
{PM16_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM16_INTR), "PARITY INTR"},
{PM17_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM17_INTR), "PARITY INTR"},
{PM18_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM18_INTR), "PARITY INTR"},
{PM19_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM19_INTR), "PARITY INTR"},
{PM20_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM20_INTR), "PARITY INTR"},
{PM21_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM21_INTR), "PARITY INTR"},
{PM22_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM22_INTR), "PARITY INTR"},
{PM23_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM23_INTR), "PARITY INTR"},
{PM24_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM24_INTR), "PARITY INTR"},
{PM25_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM25_INTR), "PARITY INTR"},
{PM26_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM26_INTR), "PARITY INTR"},
{PM27_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM27_INTR), "PARITY INTR"},
{PM28_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM28_INTR), "PARITY INTR"},
{PM29_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM29_INTR), "PARITY INTR"},
{PM30_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM30_INTR), "PARITY INTR"},
{PM31_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM31_INTR), "PARITY INTR"},
{PM32_INTR, soc_cmicx_parity_intr, INT_TO_PTR(PM32_INTR), "PARITY INTR"},
};
#endif
...
#define _SOC_TD3_SER_TYPE_REG 0
#define _SOC_TD3_SER_TYPE_MEM 1
#define _SOC_TD3_SER_TYPE_BUS 2
#define _SOC_TD3_SER_TYPE_BUF 3
...
static _soc_td3_ser_info_t _soc_td3_mmu_top_ser_info[] = {
    { _SOC_PARITY_TYPE_MMU_SER, _soc_td3_mmu_ser_info, 0,
        INVALIDf, INVALIDf,
...
static uint32 _soc_td3_ip_pipe_fifo_bmask[] = {
    0, 0
};

#define _SOC_TD3_IPIPE0_IP0_INTR 0x00000080
#define _SOC_TD3_IPIPE1_IP0_INTR 0x00000100
static const
_soc_td3_ser_route_block_t  _soc_td3_ser_route_blocks[] = {
    { 0, MMU_TO_CMIC_MEMFAIL_INTR, /* MMU_TO_CMIC_MEMFAIL_INTR */
    ...
    { 0, PIPE0_EP_TO_CMIC_PERR_INTR, /* PIPE0_EP_TO_CMIC_PERR_INTR */
      SOC_BLK_EPIPE, 0, EGR_INTR_ENABLEr, INVALIDr, SER_FIFO_NON_EMPTYf,
      NULL, 0 },
    { 0, PIPE1_EP_TO_CMIC_PERR_INTR, /* PIPE1_EP_TO_CMIC_PERR_INTR */
      SOC_BLK_EPIPE, 1, EGR_INTR_ENABLEr, INVALIDr, SER_FIFO_NON_EMPTYf,
      NULL, 0 },
    { 0, PIPE0_IDB_TO_CMIC_PERR_INTR, /* PIPE0_IP0_TO_CMIC_PERR_INTR */
    ...
    { 0, PIPE1_IDB_TO_CMIC_PERR_INTR, /* PIPE1_IP0_TO_CMIC_PERR_INTR */
      /* Note: This is an exception for being legacy style in IP */
      SOC_BLK_IPIPE, 1, IP0_INTR_ENABLEr, IP0_INTR_STATUSr, INVALIDf,
      _soc_td3_idb_ser_info, 0 },
    { 0, PIPE0_IP_TO_CMIC_PERR_INTR, /* PIPE0_IP_TO_CMIC_PERR_INTR */
      SOC_BLK_IPIPE, 0, INVALIDr, INVALIDr, INVALIDf,
      NULL, 0 },
    { 0, PIPE1_IP_TO_CMIC_PERR_INTR, /* PIPE1_IP_TO_CMIC_PERR_INTR */
...
STATIC int
_soc_trident3_ser_enable_info(int unit, int block_info_idx, int inst, int port,
        ...
        if (rb->blocktype == blocktype) {
            ...
            *p_cmic_bit |= (cmic_bit % 32);
            ...
            if ((rb->blocktype == SOC_BLK_IPIPE)
                && (rb->cmic_bit != PIPE0_IDB_TO_CMIC_PERR_INTR)
                && (rb->cmic_bit != PIPE1_IDB_TO_CMIC_PERR_INTR)) {
                _soc_td3_ip_pipe_fifo_bmask[rb->pipe] |= (cmic_bit % 32);
            }
        }
    }
...
soc_trident3_ser_enable_parity_table_all(int unit, int enable)
{
    SOC_IF_ERROR_RETURN(soc_trident3_ser_enable_parity_table(unit,
        _SOC_TD3_SER_TYPE_MEM, (void*) SOC_IP_MEM_SER_INFO(unit), enable));
    SOC_IF_ERROR_RETURN(soc_trident3_ser_enable_parity_table(unit,
        _SOC_TD3_SER_TYPE_REG, (void*) SOC_IP_REG_SER_INFO(unit), enable));
    SOC_IF_ERROR_RETURN(soc_trident3_ser_enable_parity_table(unit,
        _SOC_TD3_SER_TYPE_MEM, (void*) SOC_EP_MEM_SER_INFO(unit), enable));
    SOC_IF_ERROR_RETURN(soc_trident3_ser_enable_parity_table(unit,
        _SOC_TD3_SER_TYPE_REG, (void*) SOC_EP_REG_SER_INFO(unit), enable));
    SOC_IF_ERROR_RETURN(soc_trident3_ser_enable_parity_table(unit,
        _SOC_TD3_SER_TYPE_MEM, (void*) SOC_MMU_MEM_SER_INFO(unit), enable));
...
soc_trident3_ser_enable_all(int unit, int enable)
{
    ...
    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_REG, SOC_BLK_IPIPE, INVALIDr,
        (void*) SOC_IP_REG_SER_INFO(unit)));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_MEM, SOC_BLK_IPIPE, ING_SER_FIFO_CTRLr,
        (void*) SOC_IP_MEM_SER_INFO(unit)));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_REG, SOC_BLK_EPIPE, INVALIDr,
        (void*) SOC_EP_REG_SER_INFO(unit)));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_MEM, SOC_BLK_EPIPE, EGR_SER_FIFO_CTRLr,
        (void*) SOC_EP_MEM_SER_INFO(unit)));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_MEM, SOC_BLK_MMU_GLB, INVALIDr,
        (void*) SOC_MMU_MEM_SER_INFO(unit)));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_BUS, SOC_BLK_IPIPE, INVALIDr,
        (void*) &_soc_bcm56870_a0_ip_bus_ser_info));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_BUF, SOC_BLK_IPIPE, INVALIDr,
        (void*) &_soc_bcm56870_a0_ip_buffer_ser_info));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_BUS, SOC_BLK_EPIPE, INVALIDr,
        (void*) &_soc_bcm56870_a0_ep_bus_ser_info));

    SOC_IF_ERROR_RETURN(_soc_trident3_ser_block_enable(unit, enable, &cmic_rval,
        _SOC_TD3_SER_TYPE_BUF, SOC_BLK_EPIPE, INVALIDr,
    ...
    for (rbi = 0; ; rbi++) {
        ...
        if (soc_feature(unit, soc_feature_cmicx)) {
            if (enable) {
                soc_cmic_intr_enable(unit, cmic_bit);
            } else {
                soc_cmic_intr_disable(unit, cmic_bit);
            }
        }
#endif
        if (rb->info == NULL) {
        ...
        rv = _soc_trident3_ser_enable_info(unit, block_info_idx, rb->id, port,
    ...
    if (enable) {
        ...
        (void)_soc_td3_tcam_wrapper_enable(unit, TRUE);
    } else {
        /* MMU disables */
        /* check trident2.c - may have to add some similar code here */

        (void)soc_ser_tcam_scan_engine_enable(unit, FALSE);
        (void)_soc_td3_tcam_wrapper_enable(unit, FALSE);
    }
    return SOC_E_NONE;
}
                            ...
                            int *ser_enable_field_position)
{
    ...
    for (i = 0; ser_en_info_list[i].mem != INVALIDm; i++) {
        if (ser_en_info_list[i].mem == mem) {
            ...
            *ser_control_mem = ser_en_info_list[i].en_ctrl.ctrl_type.en_mem;
...
_soc_trident3_ser_mmu_mem_remap(_soc_ser_correct_info_t *spci)
{
    ...
    case TCB_THRESHOLD_PROFILE_MAP_B_XPE0m:
        spci->mem = TCB_THRESHOLD_PROFILE_MAP_XPE0m;
                                  ...
                                  char *prefix_str, int mmu_base_index)
{
    ...
    switch(info_list->type) {
    case _SOC_PARITY_TYPE_MMU_SER: {
        /* When we are here, we have been called by _soc_trident3_process_ser.
...
STATIC int
_soc_trident3_ser_process_mac(int unit, int port,
                              const _soc_td3_ser_info_t *info,
                              char *prefix_str, char *mem_str)
{
    uint32 rval = 0;
    ...
    if (soc_reg_field_get(unit, info->intr_status_reg, rval, info->intr_status_field)) {
        has_error = TRUE;
    }
...
STATIC int
_soc_trident3_process_ser(int unit, int block_info_idx, int inst, int pipe,
                          ...
                          char *prefix_str)
{
    ...
    /* This func (_soc_trident3_process_ser) is called by
    ...
    for (info_index = 0; ; info_index++) { /* Loop through each info entry in the mmu_top_ser_info list */
        ...
        case _SOC_PARITY_TYPE_CLMAC:
            SOC_IF_ERROR_RETURN
                (_soc_trident3_ser_process_mac(unit, port, info,
                                                 prefix_str, mem_str));
            break;
        default:
            break;
...
STATIC int
_soc_trident3_mem_index_remap(int unit, soc_mem_t mem, int index)
{
    switch (mem) {
        case L3_DEFIPm:
...
STATIC int
_soc_trident3_tcam_only_remap(int unit, soc_mem_t *mem)
{
    if (!SOC_MEM_IS_VALID(unit, *mem)) {
        return SOC_E_PARAM;
    }
                              ...
                              char *prefix_str, int l2_mgmt_ser_fifo)
{
    ...
    case SOC_BLK_IPIPE:
        if (l2_mgmt_ser_fifo) { /* L2_MGMT_SER_FIFO is not per pipe */
            ...
            mem = ipsf[pipe];
            mask = _soc_td3_ip_pipe_fifo_bmask[pipe];
                ...
                if (non_sbus == 0) {
                    ...
                    if (l2_mgmt_ser_fifo) {
                        ...
                        spci.mem = soc_addr_to_mem_extended(unit, spci.sblk,
                                                            spci.acc_type,
                                                            spci.addr);
                        rv = _soc_trident3_tcam_only_remap(unit, &spci.mem);
                        if (rv < 0) {
                            LOG_ERROR(BSL_LS_SOC_SER,
                                (BSL_META_U(unit,
                                            "mem %s is invalid !!\n"),
                    ...
                    if (spci.mem != INVALIDm) {
                        spci.flags |= SOC_SER_REG_MEM_KNOWN;
                        spci.index = _soc_trident3_mem_index_remap(unit,
                                                                   spci.mem,
                                                                   spci.index);
                        if (!spci.double_bit) {
                        ...
                        if (SOC_MEM_INFO(unit, mem).flags & SOC_MEM_FLAG_CAM) {
                            _soc_td3_ser_tcam_control_reg_get(spci.mem,
                                                        &parity_enable_reg,
                                                        &parity_enable_field);
                        }
    ...
    for (rbi = 0; ; rbi++) {
        ...
        if ((rb->blocktype == SOC_BLK_IPIPE || rb->blocktype == SOC_BLK_EPIPE)
            ...
            if (rb->status_reg != INVALIDr) {
                 ...
                 * following for mmu
                 * so we will never call _soc_trident3_process_ser,
            ...
            processed_an_intr = 1;
            SOC_IF_ERROR_RETURN
                (_soc_trident3_process_ser(unit, block_info_idx, rb->id,
...
#ifdef BCM_CMICX_SUPPORT
    if (soc_feature(unit, soc_feature_cmicx)) {
        soc_cmic_intr_enable(unit, PTR_TO_INT(d4));
    }
#endif
...
soc_trident3_ser_register(int unit)
{
    ...
    _td3_ser_functions._soc_ser_parity_error_cmicm_intr_f =
        &soc_trident3_ser_error;
    soc_ser_function_register(unit, &_td3_ser_functions);
#ifdef BCM_CMICX_SUPPORT
    soc_cmic_intr_register(unit, soc_parity_intr_handlers,
                           sizeof(soc_parity_intr_handlers) / 
                                ...
                                _soc_ser_sram_info_t *sram_info)
{
    ...
    case L2_ENTRY_ONLY_ECCm:
        if (index < SOC_TD3_NUM_ENTRIES_L2_BANK) {
            ...
            entries_per_ram = SOC_TD3_NUM_ENTRIES_L2_BANK;
            base = index;
        } else {
    ...
    case L3_DEFIP_ALPM_ECCm:
        ...
        if (soc_trident3_get_alpm_banks(unit) == 2) {
            base = index & 0x1; /* 2 uft_bank mode */
            base_bucket = ((index >> 1) & SOC_TD3_ALPM_BKT_MASK(unit));
            LOG_VERBOSE(BSL_LS_SOC_SER,
                    (BSL_META_U(unit,
    ...
    case ING_L3_NEXT_HOPm:
        sram_info->ram_count = SOC_TD3_NUM_EL_ING_L3_NEXT_HOP;
        entries_per_ram = SOC_TD3_RAM_OFFSET_ING_L3_NEXT_HOP;
        base = index % entries_per_ram;
        break;
    default: return SOC_E_PARAM;
    }
...
int
soc_td3_ifp_slice_mode_hw_get(int unit, int pipe, int slice_num, int *slice_type,
                             int *slice_enabled)
{
    soc_reg_t ifp_cfg_r;
    ...
    rv = SOC_E_NONE;/*soc_td3_ifp_slice_mode_get(unit, pipe, slice_num,
                         ...
                         soc_mem_t in_base_mem, int in_pipe)
{
    ...
    if (dual_mode_mem) {
        if (!SOC_FAILURE(soc_td3_check_hw_global_mode(unit, base_mem,
            ...
            rv = soc_td3_ifp_slice_mode_hw_get(unit, pipe, slice_num,
...
soc_td3_ser_mem_mode_get(int unit, soc_mem_t mem, int *mem_mode)
{
    ...
    /*rv = soc_td3_field_mem_mode_get(unit, mem, mem_mode);*/
    ...
    case SOC_E_INIT: /* BCM_E_INIT: field module is de-initialized */
        LOG_VERBOSE(BSL_LS_SOC_SER,
            (BSL_META_U(unit,
                        ...
                        "Will consult soc_td3_check_hw_global_mode !!\n"),
             unit, SOC_MEM_NAME(unit, mem)));
        switch (mem) {
        case VFP_TCAMm:
        case VFP_POLICY_TABLEm:
            rv = soc_td3_check_hw_global_mode(unit,
                                             VFP_TCAMm,
                                             mem_mode);
            break;
...
STATIC int
_soc_td3_ifp_slice_mode_check(int unit, soc_mem_t mem, int slice, int *slice_skip)
{
...
#define _SOC_TD3_IFP_SLICE_MODE_WIDE 1
    ...
    *slice_skip = 0;
    ...
    LOG_VERBOSE(BSL_LS_SOC_SER,
        (BSL_META_U(unit, "_soc_td3_ifp_slice_mode_check: For mem %s, read reg %s, slice_enabled = %0d, slice_width = %0d, slice_skip = %0d\n"),
                         ...
                         int en_per_pipe_read)
{
    ...
    for (slice = 0; slice < 12; slice++) {
        ...
        SOC_IF_ERROR_RETURN(
            _soc_td3_ifp_slice_mode_check(unit, mem, slice,
                                         &slice_skip));
        if (!slice_skip) {
            if (en_per_pipe_read) {
                int i;
...
int
soc_td3_check_cache_skip(int unit, soc_mem_t mem)
{
    if (!SOC_MEM_IS_VALID(unit,mem)) {
        return 1;
    }
    ...
    switch (mem) {
        ...
        case EGR_FRAGMENT_ID_TABLE_PIPE1m:
            ...
            LOG_VERBOSE(BSL_LS_SOC_SER, (BSL_META_U(unit, "cache_skip: skipping mem %s (soc_td3_check_cache_skip)\n"), SOC_MEM_NAME(unit, mem)));
            return 1;
...
#define _SER_TEST_MEM_TD3_ALPM_MASK(num_uft_banks) ((num_uft_banks) == 4? 0x7FFF : 0x3FFF)
#define _SER_TEST_MEM_TD3_ALPM_SHIFT(num_uft_banks) ((num_uft_banks) == 4? 15 : 14)
    ...
    case L3_DEFIP_ALPM_IPV4m: /* 6:4 */
        *mem_has_ecc = 1;
        ...
        uft_bkt_bank = test_data->index_fv &
            _SER_TEST_MEM_TD3_ALPM_MASK(num_uft_banks);
        uft_le_fv = test_data->index_fv >>
            _SER_TEST_MEM_TD3_ALPM_SHIFT(num_uft_banks);
        switch (uft_le_fv) {
        ...
        test_data->index = (uft_le_ecc <<
                _SER_TEST_MEM_TD3_ALPM_SHIFT(num_uft_banks)) + uft_bkt_bank;
        break;
...
STATIC soc_error_t
soc_td3_parity_control_reg_set(int unit, ser_test_data_t *test_data, int enable)
{
    ...
    LOG_VERBOSE(BSL_LS_SOC_SER,
                  (BSL_META_U(unit,
                              "soc_td3_parity_control_reg_set READ: reg %s, rval_rdat = 0x%x, bit %d \n"),
    ...
    LOG_VERBOSE(BSL_LS_SOC_SER,
                  (BSL_META_U(unit,
                              "soc_td3_parity_control_reg_set WROTE: reg %s, rval_wdat = 0x%x, bit %d \n"),
                   SOC_REG_NAME(unit, test_data->parity_enable_reg),
                   rval,
                   test_data->tcam_parity_bit
                   ));
...
STATIC soc_error_t
_ser_td3_ser_error_injection_support(int unit, soc_mem_t mem,
                                    int pipe_target)
{
...
STATIC soc_error_t
_ser_td3_correction_info_get(int unit,
                              ...
                              int inject_only, int cmd, uint32 flags)
{
    ...
    _ser_td3_correction_info_get(unit, &corr_info);
    ...
    for (i = 0; tcams[i].mem != INVALIDm; i++) {
        if (tcams[i].mem == mem) {
            soc_ser_create_test_data(unit, tmp_entry, field_data,
                                     tcams[i].enable_reg,
                                     SOC_INVALID_TCAM_PARITY_BIT,
                                     tcams[i].enable_field, mem,
                                     tcams[i].parity_field, block, REG_PORT_ANY,
...
soc_td3_ser_tcam_test(int unit, _soc_ser_test_t test_type)
{
    ...
    for (i = 0; _soc_td3_tcam_wrapper_table[i].mem != INVALIDm; i++) {
        ...
        soc_ser_create_test_data(unit, tmp_entry, field_data,
                                 ...
                                 _soc_td3_tcam_wrapper_table[i].mem,
                                 _soc_td3_tcam_wrapper_table[i].parity_field,
                                 MEM_BLOCK_ANY, REG_PORT_ANY,
                                 SOC_MEM_ACC_TYPE(unit, _soc_td3_tcam_wrapper_table[i].mem),
                                 mem_index, &test_data);
                       ...
                       _soc_mem_ser_en_info_t *ser_info_list, soc_block_t blocktype)
{
    ...
    for (i = 0; ser_info_list[i].mem != INVALIDm; i++) {
        ...
        *p_mem_tests += num_inst_to_test;
        ...
        soc_ser_create_test_data_with_new_format(unit, tmp_entry, field_data,
                                 ser_info_list[i].en_ctrl.ctrl_type.en_reg,
                                 ser_info_list[i].en_ctrl.ctrl_type.en_mem,
                                 SOC_INVALID_TCAM_PARITY_BIT,
                                 ser_info_list[i].en_ctrl.en_fld,
                                 ser_info_list[i].en_ctrl.en_fld_position,
                                 ser_info_list[i].mem,
...
soc_td3_ser_test_register(int unit)
{
    ...
    ser_trident3_test_fun.parity_control = &soc_td3_parity_control_reg_set;
    ser_trident3_test_fun.injection_support = &_ser_td3_ser_error_injection_support;
    ser_trident3_test_fun.correction_info_get = &_ser_td3_correction_info_get;
...
STATIC soc_error_t
_soc_td3_ser_tcam_control_reg_get(soc_mem_t mem,
                                           soc_reg_t   *ser_control_reg,
                                           soc_field_t *ser_enable_field)
{
    int i;
