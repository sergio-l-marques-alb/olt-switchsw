  ...
  )
{
  ...
  for (stage = 0; stage < SOC_PPC_NOF_FP_DATABASE_STAGES; stage ++) {
      ...
      /*Init all FEM programs for all PMF programs to INVALID*/
...
In direct mapping mode the fap and its port may not be found. In this case their returned value will be ARAD_SW_DB_MODPORT2SYSPORT_GET_NOT_FOUND. 
*/
       ...
       SOC_SAND_OUT uint32*                     ref_count)
{
    ...
    SOC_DPP_CORES_ITER(core_id, core_index) {
