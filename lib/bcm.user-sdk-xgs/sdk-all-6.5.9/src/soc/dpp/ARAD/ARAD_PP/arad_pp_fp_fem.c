            ...
            if ((action_val_indx < nof_actions) && (SHR_BITGET(buffer,action_lsbs[action_val_indx]) || (!is_valid_bit))) {
                ...
                if(SOC_IS_JERICHO(unit)){
					if ((action_vals_lcl[action_val_indx].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_0)||
						...
						(action_vals_lcl[action_val_indx].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_6)||
                ...
                if (direction == ARAD_PP_FP_ACTION_BUFFER_DIRECTION_ACTION_TO_BUFFER) {
                    ...
                    if (action_val_indx < SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX - 1) {
                    	if(SOC_IS_JERICHO(unit)){
	    					if (
								...
								((action_vals_lcl[action_val_indx].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_6) && (action_vals_lcl[action_val_indx+1].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_6))||
								((action_vals_lcl[action_val_indx].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_7) && (action_vals_lcl[action_val_indx+1].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_7))
								) {
									if (len>32) {
                    ...
                    if(SOC_IS_JERICHO(unit)){
						if ((action_vals[action_val_indx2].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_0)||
							...
							(action_vals[action_val_indx2].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_6)||
