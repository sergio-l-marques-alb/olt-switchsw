...
uint32 soc_jer_ppdb_tbls_init(int unit)
{
    ...
    soc_mem_field32_set(unit, PPDB_A_TCAM_BANK_COMMANDm, table_entry, TCAM_CPU_CMD_VALIDf, 0x3);
...
static uint32  soc_jerplus_idr_tbls_init (int unit){
    ...
    SOCDNX_IF_ERR_EXIT(dcmn_fill_partial_table_with_entry(unit, IDR_DRAM_BUFFER_TYPEm, 0, 0, MEM_BLOCK_ANY, 0, 47, &table_entry));
    table_entry = 1;
    SOCDNX_IF_ERR_EXIT(dcmn_fill_partial_table_with_entry(unit, IDR_DRAM_BUFFER_TYPEm, 0, 0, MEM_BLOCK_ANY, 48, 63, &table_entry));
