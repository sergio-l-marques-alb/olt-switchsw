...
int jer_pp_kbp_sdk_ver_test(int unit)
{
    ...
    const char* kbp_sdk_ver_arr[] =       {"KBP SDK 1.4.7", "KBP SDK 1.4.8", "KBP SDK 1.4.9", "KBP SDK 1.4.10_01/16/17", "KBP SDK 1.4.11 28-03-2017"};
    const uint32 sw_sdk_ver_arr_6_5[]  = {0x65500000, 0x65600000, 0x65700000, 0x65800000, 0x65900000};
    const uint32 sw_sdk_ver_arr_6_4[]  = {0x64b00000, 0x64b00000, 0x64b00000, 0x64b00000, 0x64b00000};
