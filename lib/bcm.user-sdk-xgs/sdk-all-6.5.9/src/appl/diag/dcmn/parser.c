        ...
        prt_control_t *prt_ctr)
{
    ...
    PRT_CELL_SET("%s", next_segment_name);
...
static sh_sand_option_t macro_segment_options[] = {
...
static sh_sand_option_t parser_pfc_options[] = {
    {NULL}
};
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (i_pfc = 0; i_pfc < ARAD_PARSER_PFC_NOF; i_pfc++)
    {
        ...
        pfc_info = parser_pfc_info_get_by_sw(pfc_sw);
...
sh_sand_cmd_t sh_dpp_parser_cmds[] = {
    ...
    {"macro",     parser_macro_cmd,     NULL,                     macro_segment_options,  &parser_macro_man},
    {"pfc",       parser_pfc_cmd,       NULL,                     parser_pfc_options,     &parser_pfc_man},
...
{
    cmd_result_t result;
    SH_SAND_VERIFY(sh_dpp_parser_cmds, result);

    sh_sand_act(unit, args, sh_dpp_parser_cmds);
    ARG_DISCARD(args);
    /*
