...
/*
 * Function:
 *      bcm_trunk_local_attributes_t_init
 * Purpose:
 *      Initialize the bcm_trunk_local_attributes_t structure
 * Parameters:
 *      local_attributes - Pointer to structure which should be initialized
 * Returns:
 *      NONE
 */
 void
 bcm_trunk_local_attributes_t_init(bcm_trunk_local_attributes_t *local_attributes)
 {
    return;
 }
