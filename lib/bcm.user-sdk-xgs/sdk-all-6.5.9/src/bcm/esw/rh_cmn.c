                    ...
                    bcm_if_t *rh_intf_array)
{
    ...
    rv = _bcm_opt_ecmp_rh_add_rebalance(unit, num_entries, rh_intf_array,
                                            ...
                                            bcm_if_t *ex_new_intf_array)
{
    ...
    rv = _bcm_opt_ecmp_rh_populate_empty_entries(unit, num_entries, rh_intf_array,
 ...
 */
int
bcm_opt_l3_ecmp_rh_member_sync(int unit, uint8 **scache_ptr)
{
    int16 i;
    int j;
    bcm_if_t *rh_intf_arr_ptr = NULL;
 ...
 */
int
bcm_opt_l3_ecmp_rh_member_recover(int unit, uint8 **scache_ptr, int ecmp_max_paths)
{
    bcm_if_t **rh_intf_arr_ptr;
    int stable_size = 0;
    int intf_count;
