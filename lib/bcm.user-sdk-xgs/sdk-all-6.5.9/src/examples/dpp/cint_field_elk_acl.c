...
int frwd_default_route_rpf_config_traffic_example(int unit, int out_port) {
...
int frwd_default_route_rpf_config_traps_example(int unit) {
    ...
    /* Create traps */
    bcm_rx_trap_type_create(unit, 0, bcmRxTrapUcLooseRpfFail, &trap_handle);
