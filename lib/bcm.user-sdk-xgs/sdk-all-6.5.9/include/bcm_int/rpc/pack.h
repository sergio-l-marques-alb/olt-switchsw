...
#define	BCM_PACKLEN_BFD_ENDPOINT_INFO		383
...
#ifdef	INCLUDE_L3
#define	BCM_PACKLEN_COMPAT657_MPLS_TUNNEL_SWITCH		152
#endif	/* INCLUDE_L3 */
...
#define	BCM_PACKLEN_FIELD_GROUP_CONFIG		777
...
#define	BCM_PACKLEN_FIELD_QSET		160
...
#define	BCM_PACKLEN_L2_ADDR		282
...
#define	BCM_PACKLEN_L3_EGRESS		302
...
#define	BCM_PACKLEN_MPLS_TUNNEL_SWITCH		156
...
#define	BCM_PACKLEN_OAM_ENDPOINT_INFO		297
...
#define	BCM_PACKLEN_TRUNK_ID_INFO		8
#define	BCM_PACKLEN_TRUNK_INFO		116
#define	BCM_PACKLEN_TRUNK_LOCAL_ATTRIBUTES		8
...
#endif	/* INCLUDE_L3 */
#define	BCM_PACKLEN_UDF_ALLOC_HINTS		168
...
extern uint8 *_bcm_pack_trunk_id_info(uint8 *, bcm_trunk_id_info_t *);
extern uint8 *_bcm_unpack_trunk_id_info(uint8 *, bcm_trunk_id_info_t *);
extern uint8 *_bcm_pack_trunk_info(uint8 *, bcm_trunk_info_t *);
extern uint8 *_bcm_unpack_trunk_info(uint8 *, bcm_trunk_info_t *);
extern uint8 *_bcm_pack_trunk_local_attributes(uint8 *, bcm_trunk_local_attributes_t *);
extern uint8 *_bcm_unpack_trunk_local_attributes(uint8 *, bcm_trunk_local_attributes_t *);
