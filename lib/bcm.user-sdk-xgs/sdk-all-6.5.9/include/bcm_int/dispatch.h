...
typedef struct {
	...
	int (*cosq_ingress_port_drop_control_frame_get)(int,bcm_port_t,uint32,bcm_cosq_ingress_drop_control_frame_config_t *);
	int (*cosq_ingress_port_drop_control_frame_set)(int,bcm_port_t,uint32,bcm_cosq_ingress_drop_control_frame_config_t *);
	...
	int (*field_qualify_MacSecFlow)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_MacSecFlow_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*stat_counter_engine_enable_get)(int,uint32,bcm_stat_engine_t *,bcm_stat_engine_enable_t *);
	int (*stat_counter_engine_enable_set)(int,uint32,bcm_stat_engine_t *,bcm_stat_engine_enable_t *);
	...
	int (*stat_counter_interface_get)(int,uint32,bcm_stat_engine_t *,bcm_stat_counter_interface_t *);
	/* bcm_stat_counter_interface_key_t_init not dispatchable */
	int (*stat_counter_interface_set)(int,uint32,bcm_stat_engine_t *,bcm_stat_counter_interface_t *);
	...
	int (*stat_counter_set_mapping_get)(int,uint32,bcm_stat_engine_t *,bcm_stat_counter_set_map_t *);
	int (*stat_counter_set_mapping_set)(int,uint32,bcm_stat_engine_t *,bcm_stat_counter_set_map_t *);
	...
	int (*trunk_id_set)(int,bcm_trunk_id_info_t *,bcm_trunk_t *);
	/* bcm_trunk_info_t_init not dispatchable */
	int (*trunk_init)(int);
	int (*trunk_local_attributes_get)(int,bcm_trunk_t,uint32,bcm_trunk_local_attributes_t *);
	int (*trunk_local_attributes_set)(int,bcm_trunk_t,uint32,bcm_trunk_local_attributes_t *);
