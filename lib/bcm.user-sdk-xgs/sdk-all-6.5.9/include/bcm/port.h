...
#define BCM_PORT_IF_MII         _SHR_PORT_IF_MII /* MII Operating mode, not supported
                                              on all ports */
#define BCM_PORT_IF_GMII        _SHR_PORT_IF_GMII /* GMII Operating mode, not supported
                                              on all ports */
#define BCM_PORT_IF_SGMII       _SHR_PORT_IF_SGMII 
#define BCM_PORT_IF_TBI         _SHR_PORT_IF_TBI /* TBI interface supported on Gigabit
                                              Ethernet ports operating at
                                              gigabit speeds */
#define BCM_PORT_IF_XGMII       _SHR_PORT_IF_XGMII /* 10-Gigabit interface */
#define BCM_PORT_IF_RGMII       _SHR_PORT_IF_RGMII /* Reduced Gigabit Media Independent
                                              Interface */
#define BCM_PORT_IF_SFI         _SHR_PORT_IF_SFI /* SFI 10-Gigabit serial electrical
                                              interface */
#define BCM_PORT_IF_XFI         _SHR_PORT_IF_XFI /* XFI 10-Gigabit serial electrical
                                              interface */
#define BCM_PORT_IF_KR          _SHR_PORT_IF_KR /* Backplane 10 GbE 64B/66B interface */
#define BCM_PORT_IF_KR2         _SHR_PORT_IF_KR2 /* Backplane 2x10GbE 64B/66B
                                              interface */
#define BCM_PORT_IF_KR4         _SHR_PORT_IF_KR4 /* Backplane 4x10 GbE 64B/66B
                                              interface */
#define BCM_PORT_IF_CR          _SHR_PORT_IF_CR /* Copper 10 GbE 64B/66B interface */
#define BCM_PORT_IF_CR2         _SHR_PORT_IF_CR2 /* Copper 2x10GbE 64B/66B interface */
#define BCM_PORT_IF_CR4         _SHR_PORT_IF_CR4 /* Copper 4x10 GbE 64B/66B interface. */
#define BCM_PORT_IF_XLAUI       _SHR_PORT_IF_XLAUI /* 40 Gigabit Attachment Unit
                                              Interface */
#define BCM_PORT_IF_XLAUI2      _SHR_PORT_IF_XLAUI2 /* 40 Gigabit Attachment Unit
...
#define BCM_PORT_IF_SR          _SHR_PORT_IF_SR /* Fiber SR/LR 64B/66B interface */
#define BCM_PORT_IF_SR2         _SHR_PORT_IF_SR2 /* Fiber 2x10GbE 64B/66B interface. */
#define BCM_PORT_IF_CAUI        _SHR_PORT_IF_CAUI 
#define BCM_PORT_IF_LR          _SHR_PORT_IF_LR /* Fiber LR 64B/66B interface */
#define BCM_PORT_IF_LR4         _SHR_PORT_IF_LR4 /* Fiber LR4 64B/66B interface */
#define BCM_PORT_IF_SR4         _SHR_PORT_IF_SR4 /* Fiber SR4 64B/66B interface */
#define BCM_PORT_IF_KX          _SHR_PORT_IF_KX 
#define BCM_PORT_IF_ZR          _SHR_PORT_IF_ZR /* Fiber ZR 64B/66B interface */
#define BCM_PORT_IF_SR10        _SHR_PORT_IF_SR10 /* Fiber SR10 64B/66B interface. */
#define BCM_PORT_IF_CR10        _SHR_PORT_IF_CR10 /* Copper CR10 64B/66B interface. */
#define BCM_PORT_IF_KR10        _SHR_PORT_IF_KR10 /* Backplane KR10 64B/66B interface. */
#define BCM_PORT_IF_LR10        _SHR_PORT_IF_LR10 /* Fiber LR10 64B/66B interface. */
#define BCM_PORT_IF_OTL         _SHR_PORT_IF_OTL /* Fiber 4x25 GbE OTL interface */
#define BCM_PORT_IF_CPU         _SHR_PORT_IF_CPU 
#define BCM_PORT_IF_ER          _SHR_PORT_IF_ER /* Fiber ER 64B/66B interface */
#define BCM_PORT_IF_ER2         _SHR_PORT_IF_ER2 /* Fiber ER2 2x10G 64B/66B interface */
#define BCM_PORT_IF_ER4         _SHR_PORT_IF_ER4 /* Fiber ER4 4x10G 64B/66B interface */
#define BCM_PORT_IF_CX          _SHR_PORT_IF_CX /* Copper 10G 10B/8B interface */
#define BCM_PORT_IF_CX2         _SHR_PORT_IF_CX2 /* Copper 2x10G 10B/8B interface. */
#define BCM_PORT_IF_CX4         _SHR_PORT_IF_CX4 /* Copper 4x10G 10B/8B interface */
#define BCM_PORT_IF_CAUI_C2C    _SHR_PORT_IF_CAUI_C2C /* CAUI 100G C2C interface */
#define BCM_PORT_IF_CAUI_C2M    _SHR_PORT_IF_CAUI_C2M /* CAUI 100G C2M interface */
#define BCM_PORT_IF_VSR         _SHR_PORT_IF_VSR /* Fiber VSR 10G 64B/66B interface */
#define BCM_PORT_IF_LR2         _SHR_PORT_IF_LR2 /* Fiber 2x10Gbe LR 64B/66B interface */
#define BCM_PORT_IF_LRM         _SHR_PORT_IF_LRM /* Fiber LRM multipoint 64B/66B
                                              interface */
#define BCM_PORT_IF_XLPPI       _SHR_PORT_IF_XLPPI /* 40G parallel physical interface */
...
#define BCM_PORT_ADD_STIF_PORT              0x0200     /* Indicate it is a port
                                                          for statistics
                                                          interface */
#define BCM_PORT_ADD_MIRROR_PORT            0x0400     /* Indicate it is a port
                                                          used for mirror */
...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassProgramEditorEgressTrafficManagement = 20, /* Traffic management port Class for
                                           field stage Egress */
    bcmPortClassCount = 21              /* Last enum value. */
} bcm_port_class_t;
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_COUNT = 36           /* Must be last */
} bcm_port_match_t;
...
/* Add the GPORT ID for the specified physical port. */
extern int bcm_port_gport_add(
    int unit, 
    bcm_port_t local_port, 
    bcm_gport_t modport);

/* Delete the GPORT ID for the specified physical port. */
...
/* Get all the GPORT IDs for the specified physical port. */
...
/* Set additional data for a wide LIF. */
...
typedef struct bcm_port_resource_s {
    ...
    bcm_gport_t port;       /* Local logical port number to connect to the given
                               physical port */
...
/* Modify the Port Resources (e.g. speed, lanes, etc.) for a given port. */
...
/* 
 * Modify the Port Resources (e.g. speed, lanes, etc.) for a set of
 * ports.
 */
...
/* 
 * Iterates over the port resource configurations and calls user-provided
...
/* 
 * Configure all ports that allow TDM traffic to ingress the device. TDM
 * traffic on any other port will be dropped.
 */
...
/* 
 * Retrieve all ports that allow TDM traffic to ingress the device. TDM
 * traffic on any other port will be dropped.
 */
...
/* Initialize a port priority group configuration structure. */
...
typedef enum bcm_port_preempt_control_e {
    ...
    bcmPortPreemptControlNonFinalFragSizeTx = 6, /* The minimum size of non-final
                                           fragment of a packet in transmit
                                           direction. */
    bcmPortPreemptControlFinalFragSizeTx = 7, /* The minimum size of final fragment of
                                           a packet in transmit direction. */
    bcmPortPreemptControlNonFinalFragSizeRx = 8, /* The minimum size of non-final
                                           fragment of a packet in receive
                                           direction. */
    bcmPortPreemptControlFinalFragSizeRx = 9, /* The minimum size of final fragment of
                                           a packet in receive direction. */
...
/* Set the NIF Priority between Ports. */
...
/* Get the NIF Priority of a Port. */
...
/* bcm_port_e2efc_remote_module_enable_set */
...
/* bcm_port_e2efc_remote_port_add */
extern int bcm_port_e2efc_remote_port_add(
    int unit, 
    bcm_port_e2efc_remote_port_config_t *e2efc_rport_cfg, 
    int *rport_handle_id);

/* bcm_port_e2efc_remote_port_set */
extern int bcm_port_e2efc_remote_port_set(
    int unit, 
    int rport_handle_id, 
    bcm_port_e2efc_remote_port_config_t *e2efc_rport_cfg);

/* bcm_port_e2efc_remote_port_get */
extern int bcm_port_e2efc_remote_port_get(
    int unit, 
    int rport_handle_id, 
    bcm_port_e2efc_remote_port_config_t *e2efc_rport_cfg);

/* bcm_port_e2efc_remote_port_delete */
...
/* 
 *  Map lanes to serdeses. The API receive all lanes configuration at
 * once. Location in the array represent the lane number (e.g.
 * serdes_map[x] holds the information for lane=x).
 */
