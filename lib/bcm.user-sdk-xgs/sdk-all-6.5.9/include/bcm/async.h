...
void	bcm_oam_lif_profile_get_async(int unit, uint32 flags, bcm_gport_t lif, bcm_oam_profile_t * ingress_oam_profile, bcm_oam_profile_t * egress_oam_profile, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_oam_lif_profile_set_async(int unit, uint32 flags, bcm_gport_t lif, bcm_oam_profile_t ingress_oam_profile, bcm_oam_profile_t egress_oam_profile, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_trunk_id_set_async(int unit, bcm_trunk_id_info_t * id_info, bcm_trunk_t * tid, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trunk_init_async(int unit, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trunk_local_attributes_get_async(int unit, bcm_trunk_t tid, uint32 flags, bcm_trunk_local_attributes_t * local_attributes, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trunk_local_attributes_set_async(int unit, bcm_trunk_t tid, uint32 flags, bcm_trunk_local_attributes_t * local_attributes, bcm_async_cb_t async_callback, void *async_cookie);
