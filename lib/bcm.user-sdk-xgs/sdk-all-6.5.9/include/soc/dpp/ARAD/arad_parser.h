...
#define ARAD_PARSER_CUSTOM_MACRO_PROTO_10                  (0x9) /* UDP_Tunnel Dummy */
#define ARAD_PARSER_CUSTOM_MACRO_PROTO_11                  (0xa) /* PTP (1588) - start */
#define ARAD_PARSER_CUSTOM_MACRO_PROTO_12                  (0xb) /* PTP (1588) - end or GTP store value 4 */
...
#define ARAD_PARSER_CUSTOM_MACRO_PROTO_15                  (0xe) /* FCoE encap or UDP_Tunnel MPLS dst port or GTP port 2123 */
