...
#define KBP_SDK_VERSION "KBP SDK 1.4.11"
...
enum kbp_device_flush_flags {
    KBP_DEVICE_FLUSH_DEVICE_RESET = 1,    /**< Reset the device */
    KBP_DEVICE_FLUSH_CONFIG_RESOURCE = 2, /**< Configures the resource: AB, UDA, range, LPT, etc. */
    KBP_DEVICE_FLUSH_ENTRIES = 4,         /**< Flush the entries */
    KBP_DEVICE_FLUSH_LTRS = 8,            /**< Flush the LTRs */
    KBP_DEVICE_FLUSH_PARALLEL = 16        /**< Enables parallel flush, to flush entries and LTRs of that SMT handle */
};
