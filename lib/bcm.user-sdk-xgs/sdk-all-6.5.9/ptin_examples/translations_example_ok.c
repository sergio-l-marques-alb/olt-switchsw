...
vp_add(0x44801001 /*LIF2*/, BCM_VLAN_PORT_MATCH_PORT_VLAN /*Criteria*/, 10 /*Port2*/, 333 /*OVID2*/, 0 /*IVID2*/, 0 /*TunnelID*/, 0 /*VSI*/, 0 /*Flags*/);
...
adv_xlate_action_create(5 /*ActionId*/, 1 /*ut_outer=ADD*/, 0 /*ut_inner=NONE*/, 2 /*ot_outer=REPLACE*/, 0 /*ot_inner=NONE*/, 2 /*dt_outer=REPLACE*/, 0 /*dt_inner=NONE*/,
                        outer_tpid /*OuterTPID*/, inner_tpid /*InnerTPID*/,
                        0 /*NewOVID*/, 0 /*NewIVID*/,
                        0 /*Egress*/);

/* VLAN Edit Profile (ID=2) for LIF1 */
adv_xlate_vep(0x44801000 /*LIF1*/, 100 /*NewOVID1*/, 1000 /*NewIVID1*/, 2 /*VEP Id*/, 0 /*Egress*/);
/* VLAN Edit Profile (ID=2) for LIF2 */
adv_xlate_vep(0x44801001 /*LIF2*/, 333 /*NewOVID2*/, 1333 /*NewIVID2*/, 2 /*VEP Id*/, 0 /*Egress*/);
...
adv_xlate_action_class_set(2 /*Single Tag Format*/, 2 /*VEP*/, 5 /*ActionId*/, 0 /*Egress*/);
adv_xlate_action_class_set(6 /*Double Tag Format*/, 2 /*VEP*/, 5 /*ActionId*/, 0 /*Egress*/);
