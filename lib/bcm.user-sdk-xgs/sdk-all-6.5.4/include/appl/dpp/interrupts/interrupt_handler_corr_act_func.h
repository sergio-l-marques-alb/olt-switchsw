...
int arad_interrupt_data_collection_for_ihbtcamprotectionerror(int unit, int block_instance, arad_interrupt_type interrupt_id, ARAD_TCAM_LOCATION *location, dcmn_int_corr_act_type* corrective_action);
