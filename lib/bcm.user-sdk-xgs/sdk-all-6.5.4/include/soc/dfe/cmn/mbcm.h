...
typedef soc_error_t (*mbcm_dfe_fabric_flow_control_mid_fifo_size_threshold_set_f) (int unit, soc_dfe_fabric_link_fifo_type_index_t type_index, soc_dcmn_fabric_pipe_t pipe, int is_fe1, int is_fe3, int value);
