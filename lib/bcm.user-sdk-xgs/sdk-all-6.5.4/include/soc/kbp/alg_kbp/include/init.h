...
enum kbp_device_lane_speed {
    ...
    KBP_INIT_LANE_25 = 7,       /**< 25G SerDes. */
    KBP_INIT_LANE_25_7 = 8,     /**< 25.7G SerDes. */
    KBP_INIT_LANE_28 = 9,       /**< 28G SerDes. */
    KBP_INIT_LANE_INVALID = 10
};
...
/**
 * Logs serdes registers in Addres, Data and Name format.
 * @param config Configuration structure initialized appropriately.
 *
 * @return KBP_OK on success or an error code.
 */

kbp_status kbp_device_interface_dump_serdes_regs(struct kbp_device_config *config, FILE *fp);

/**
 * Logs core registers in Addres, Data and Name format.
 * @param config Configuration structure initialized appropriately.
 *
 * @return KBP_OK on success or an error code.
 */

kbp_status kbp_device_interface_dump_core_regs(struct kbp_device_config *config, FILE *fp);
