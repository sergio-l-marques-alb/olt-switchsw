...
int portmod_common_phy_mdio_c45_reg_read(void* user_acc, uint32_t core_addr, uint32_t reg_addr, uint32_t *val);
int portmod_common_phy_mdio_c45_reg_write(void* user_acc, uint32_t core_addr, uint32_t reg_addr, uint32_t val);
...
int portmod_intf_mode_from_port_intf(int unit,
                                    soc_port_if_t interface,
