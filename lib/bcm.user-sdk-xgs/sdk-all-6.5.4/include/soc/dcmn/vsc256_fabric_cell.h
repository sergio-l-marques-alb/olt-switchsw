/*
 * $Id: vsc256_fabric_cell.h,v 1.6 Broadcom SDK $
 *
...
/*Build VSC128 header from vsc256_sr_cell_t*/
...
#define VSC256_VSC128_INBAND_CELL_NOF_COMMANDS 1
#define VSC256_VSC256_INBAND_CELL_NOF_COMMANDS 2*/
...
/*soc_error_t soc_vsc256_sr_cell_send_inband(int unit, const fe1600_sr_cell_t* inband_cell, fe1600_sr_cell_t* result_cell);
soc_error_t soc_vsc256_sr_cell_send(int unit, const fe1600_sr_cell_t* cell);
soc_error_t soc_vsc256_sr_cell_receive(int unit, fe1600_sr_cell_t* cell);*/
