...
typedef uint32 (*mbcm_dpp_cnt_lif_counting_range_get_f)(
    SOC_SAND_IN int                  unit,
    SOC_SAND_IN SOC_TMC_CNT_SRC_TYPE source,
    SOC_SAND_IN int                  range_id,
...
typedef uint32 (*mbcm_dpp_mult_cud_to_port_map_set_f) (
    ...
    SOC_SAND_IN uint32              flags,/* flags */
...
typedef uint32 (*mbcm_dpp_itm_vsq_pg_tc_profile_mapping_set_f) (
    SOC_SAND_IN int unit,
    SOC_SAND_IN int core_id,
    SOC_SAND_IN uint32 vsq_id,
    SOC_SAND_IN int pg_tc_profile
   );
typedef uint32 (*mbcm_dpp_itm_vsq_pg_tc_profile_mapping_get_f) (
    SOC_SAND_IN int unit,
    SOC_SAND_IN int core_id,
    SOC_SAND_IN uint32 src_pp_port,
    SOC_SAND_OUT int *pg_tc_profile
   );
typedef uint32 (*mbcm_dpp_itm_vsq_pg_tc_profile_set_f) (
    SOC_SAND_IN int unit,
    SOC_SAND_IN int core_id,
    SOC_SAND_IN int pg_tc_profile_id,
    SOC_SAND_IN uint32 pg_tc_bitmap
   );
typedef uint32 (*mbcm_dpp_itm_vsq_pg_tc_profile_get_f) (
    SOC_SAND_IN int         unit,
    SOC_SAND_IN int         core_id,
    SOC_SAND_IN int      pg_tc_profile_id,
    SOC_SAND_OUT uint32     *pg_tc_bitmap
   );
typedef uint32 (*mbcm_dpp_itm_vsq_pg_prm_set_f)(
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32              vsq_rt_cls_ndx,
    SOC_SAND_IN  SOC_TMC_ITM_VSQ_PG_PRM  *info
  );
typedef uint32 (*mbcm_dpp_itm_vsq_pg_prm_get_f)(
    SOC_SAND_IN  int                 unit,
    SOC_SAND_IN  uint32              vsq_rt_cls_ndx,
    SOC_SAND_OUT SOC_TMC_ITM_VSQ_PG_PRM  *info
  );

typedef uint32 (*mbcm_dpp_itm_src_vsqs_mapping_set_f)(
       SOC_SAND_IN int unit,
       SOC_SAND_IN int core_id,
...
typedef uint32 (*mbcm_dpp_itm_src_vsqs_mapping_get_f)(
       SOC_SAND_IN int unit,
       SOC_SAND_IN int core_id,
       SOC_SAND_IN int src_pp_port,
...
typedef uint32 (*mbcm_dpp_itm_vsq_src_port_get_f) (
       SOC_SAND_IN int    unit,
       SOC_SAND_IN int    core_id,
       SOC_SAND_IN int    src_port_vsq_index,
...
typedef uint32 (*mbcm_dpp_itm_vsq_pg_mapping_get_f) (
       SOC_SAND_IN int     unit,
       SOC_SAND_IN int     core_id,
...
typedef uint32 (*mbcm_dpp_itm_vsq_src_reserve_set_f)(
   SOC_SAND_IN  int                     unit,
   SOC_SAND_IN  int                     core_id,
...
typedef uint32 (*mbcm_dpp_itm_vsq_src_reserve_get_f)(
   SOC_SAND_IN  int                     unit,
   SOC_SAND_IN  int                     core_id,
   SOC_SAND_IN  SOC_TMC_ITM_VSQ_GROUP   vsq_type,
   SOC_SAND_IN  uint32                  vsq_rt_cls_ndx,
...
typedef uint32 (*mbcm_dpp_itm_resource_allocation_set_f)(
   SOC_SAND_IN  int                     unit,
   SOC_SAND_IN  int                     core_id,
...
typedef uint32 (*mbcm_dpp_itm_resource_allocation_get_f)(
   SOC_SAND_IN  int                     unit,
   SOC_SAND_IN  int                     core_id,
   SOC_SAND_IN  uint8                   pool_id,
   SOC_SAND_IN  uint8                   is_ocb_only,
...
typedef uint32 (*mbcm_dpp_itm_global_resource_allocation_set_f)(
   SOC_SAND_IN int                                  unit, 
   SOC_SAND_IN int                                  core, 
   SOC_SAND_IN SOC_TMC_ITM_INGRESS_CONGESTION_MGMT  *ingress_congestion_mgmt
   );
typedef uint32 (*mbcm_dpp_itm_global_resource_allocation_get_f)(
   SOC_SAND_IN int                                  unit, 
   SOC_SAND_IN int                                  core, 
...
typedef uint32 (*mbcm_dpp_ingress_drop_status_f) (
    SOC_SAND_IN int   unit,
...
typedef uint32 (*mbcm_dpp_mult_eg_vlan_membership_bm_add_f) ( 
    SOC_SAND_IN  int                                   unit, 
    SOC_SAND_IN  SOC_TMC_MULT_ID                       multicast_id_ndx, 
    SOC_SAND_IN  SOC_TMC_MULT_EG_VLAN_MEMBERSHIP_GROUP *bitmap, /* TM ports to add */
    SOC_SAND_OUT SOC_TMC_ERROR                         *out_err /* return possible errors that the caller may want to ignore */
  ); 
typedef uint32 (*mbcm_dpp_mult_eg_vlan_membership_bm_remove_f) ( 
    SOC_SAND_IN  int                                   unit, 
    SOC_SAND_IN  SOC_TMC_MULT_ID                       multicast_id_ndx, 
    SOC_SAND_IN  SOC_TMC_MULT_EG_VLAN_MEMBERSHIP_GROUP *bitmap, /* TM ports to remove */
    SOC_SAND_OUT SOC_TMC_ERROR                         *out_err /* return possible errors that the caller may want to ignore */
  ); 
...
#define MBCM_DPP_DRIVER_CALL_VOID(unit, function, args) do { \
                                                            if ((unit < BCM_MAX_NUM_UNITS) && mbcm_dpp_driver[unit] && mbcm_dpp_driver[unit]->function)\
