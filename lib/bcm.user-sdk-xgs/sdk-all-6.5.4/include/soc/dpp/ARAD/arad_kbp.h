...
#define ARAD_KBP_CR_SUPPORTED_VERSION 0
#define ARAD_KBP_IS_CR_MODE (((soc_property_get(unit, spn_HA_HW_JOURNAL_MODE, HW_LOG_MODE_Disabled) != HW_LOG_MODE_Disabled)?1:0)&&ARAD_KBP_CR_SUPPORTED_VERSION)
