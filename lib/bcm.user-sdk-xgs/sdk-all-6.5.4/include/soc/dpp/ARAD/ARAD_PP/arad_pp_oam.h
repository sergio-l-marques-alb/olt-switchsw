...
#define ARAD_PP_OAM_OAMP_MEP_DB_MEP_ENTRIES_NOF(_unit) (SOC_DPP_DEFS_GET((_unit), oamp_number_of_meps))
...
#define ARAD_PP_OAM_OAMP_MEP_DB_LM_DM_CHAIN_NEXT(_unit, _entry)        ((_entry) + (SOC_IS_QAX(_unit) ? 1024 : 1))
#define ARAD_PP_OAM_OAMP_MEP_DB_LM_DM_CHAIN_PREV(_unit, _entry)        ((_entry) - (SOC_IS_QAX(_unit) ? 1024 : 1))

#define OAMP_MEP_DB_ENTRY_ID_TO_BLOCK(__entry_id)               ((__entry_id)>>10)
#define OAMP_MEP_DB_ENTRY_ID_TO_INDEX(__entry_id)               ((__entry_id)&((1<<10)-1))
