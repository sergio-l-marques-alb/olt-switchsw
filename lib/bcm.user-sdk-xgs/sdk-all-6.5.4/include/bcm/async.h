...
void	bcm_ipsec_sa_create_async(int unit, uint32 flags, uint32 * spi_id, bcm_ipsec_sa_info_t * sa, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ipsec_sa_delete_async(int unit, uint32 flags, uint32 spi_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ipsec_sa_key_update_async(int unit, uint32 flags, uint32 spi_id, bcm_ipsec_sa_keys_t * sa_keys, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ipsec_sa_to_tunnel_map_set_async(int unit, uint32 tunnel_id, uint32 spi_id, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_rx_lif_mtu_get_async(int unit, uint32 flags, bcm_port_t port, uint32 * mtu, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_rx_lif_mtu_set_async(int unit, uint32 flags, bcm_port_t port, uint32 mtu, bcm_async_cb_t async_callback, void *async_cookie);
