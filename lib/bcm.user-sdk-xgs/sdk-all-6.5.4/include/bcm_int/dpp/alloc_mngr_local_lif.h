...
#define BCM_DPP_AM_LOCAL_OUT_LIF_HALF_BANK_IN_RANGE(unit, bank_id) (bank_id<_BCM_DPP_AM_EGRESS_LIF_NOF_EEDB_HALF_BANKS(unit))
#define BCM_DPP_AM_LOCAL_OUT_LIF_REGULAR_HALF_BANK_IN_RANGE(unit, bank_id) (bank_id<_BCM_DPP_AM_EGRESS_LIF_NOF_EEDB_REGULAR_HALF_BANKS(unit))
