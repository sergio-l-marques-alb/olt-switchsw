...
#define SW_STATE_DPP_SOC_CONFIG_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_CONFIG_AUTOSYNC_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_SOC_CONFIG_VERSION_LAYOUT_NOF_MAX_LAYOUT_NODES) 
