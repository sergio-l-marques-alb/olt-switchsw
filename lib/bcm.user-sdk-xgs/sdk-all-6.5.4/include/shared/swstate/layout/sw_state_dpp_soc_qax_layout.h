...
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_PROTOCOL_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_ADDR_IPV4_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_ADDR_IPV6_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_ADDR_IPV4_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_ADDR_IPV6_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_PROTOCOL_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_LOCAL_IP_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_PROTOCOL_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_ADDR_IPV4_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_ADDR_IPV6_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES (1) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_ADDR_IPV4_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_ADDR_IPV6_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES) 
#define SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_LAYOUT_NOF_MAX_LAYOUT_NODES (1 + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_PROTOCOL_LAYOUT_NOF_MAX_LAYOUT_NODES + SW_STATE_DPP_SOC_QAX_IPSEC_TUNNEL_REMOTE_IP_ADDR_LAYOUT_NOF_MAX_LAYOUT_NODES) 
...
int sw_state_dpp_soc_qax_ipsec_tunnel_local_ip_protocol_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_local_ip_addr_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_local_ip_addr_ipv4_addr_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_local_ip_addr_ipv6_addr_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_remote_ip_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_remote_ip_protocol_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_remote_ip_addr_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_remote_ip_addr_ipv4_addr_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
int sw_state_dpp_soc_qax_ipsec_tunnel_remote_ip_addr_ipv6_addr_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id);
