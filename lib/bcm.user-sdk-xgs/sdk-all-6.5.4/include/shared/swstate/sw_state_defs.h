...
#define SW_STATE_DO_JOURNALING(flags)\
    SW_STATE_DO_AUTOSYNC(flags & SW_STATE_ALLOW_AUTOSYNC)
...
typedef struct soc_dcmn_sw_state_s {
    soc_dcmn_cr_t  crash_recovery;
} soc_dcmn_sw_state_t;
