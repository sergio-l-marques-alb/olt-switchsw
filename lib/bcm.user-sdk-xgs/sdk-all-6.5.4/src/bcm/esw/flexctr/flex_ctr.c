     ...
     if (!soc_feature(unit, soc_feature_flex_counter_opaque_stat_id)) {
        ...
        *stat_counter_id = i;
        if (stat_counter_map[unit] != NULL) {
            stat_counter_map[unit][i].mode = mode;
            stat_counter_map[unit][i].group = group;
            stat_counter_map[unit][i].object = object;
            stat_counter_map[unit][i].pool = pool_number;
            stat_counter_map[unit][i].base_idx = base_idx;
            stat_counter_map[unit][i].used = 1;
            stat_counter_map[unit][i].pipe = 0;
        }
#endif
    }
}
    ...
    if ((rv == BCM_E_NONE) || (rv==BCM_E_EXISTS)) {
         ...
         case bcmStatObjectIngPort:
              rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                        unit, PORT_TABm, FIRST_LKUP, object,mode,
         ...
         case bcmStatObjectIngVlanXlate:
              rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                        unit, VLAN_XLATEm, FIRST_LKUP, object,mode,
                        &base_index,&pool_number);
              break;
         case bcmStatObjectIngVlanXlateSecondLookup:
              ...
              if (soc_feature(unit,soc_feature_ing_vlan_xlate_second_lookup)) {
                  rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                          unit, VLAN_XLATEm, SECOND_LKUP, object,mode,
                          &base_index,&pool_number);
              } else
#endif
              {
         ...
         case bcmStatObjectIngVrf:
              rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                        unit, VRFm, FIRST_LKUP, object,mode,
                        &base_index,&pool_number);
              break;
         ...
         case bcmStatObjectIngFcoe:
              rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                        unit, L3_ENTRY_IPV4_MULTICASTm, FIRST_LKUP, object,mode,
                        &base_index,&pool_number);
              break;
         ...
         case bcmStatObjectEgrPort:
              rv = _bcm_esw_stat_flex_create_egress_table_counters(
                        unit, EGR_PORTm, FIRST_LKUP, object,mode,
                        &base_index,&pool_number);
              break;
         ...
         case bcmStatObjectEgrVlanXlate:
              rv = _bcm_esw_stat_flex_create_egress_table_counters(
                        unit, EGR_VLAN_XLATEm, FIRST_LKUP, object,mode,
                        &base_index,&pool_number);
              break;
         case bcmStatObjectEgrVlanXlateSecondLookup:
              ...
              if (soc_feature(unit, soc_feature_egr_vlan_xlate_second_lookup)) {
                  rv = _bcm_esw_stat_flex_create_egress_table_counters(
                          unit, EGR_VLAN_XLATEm, SECOND_LKUP, object,mode,
                          &base_index,&pool_number);
              } else
#endif
              {
         ...
         case bcmStatObjectEgrL2Gre:
              rv = _bcm_esw_stat_flex_create_egress_table_counters(
                        unit, EGR_DVP_ATTRIBUTE_1m, FIRST_LKUP, object,mode,
                        &base_index,&pool_number);
              break;
            ...
            uint32 stat_counter_id)
{
    ...
    switch((int32)object) {
         ...
         case bcmStatObjectIngPort:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                        unit, PORT_TABm, FIRST_LKUP, object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectIngVlan:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
         ...
         case bcmStatObjectIngVlanXlate:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                        unit, VLAN_XLATEm, FIRST_LKUP, object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectIngVlanXlateSecondLookup:
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
              if (soc_feature(unit,soc_feature_ing_vlan_xlate_second_lookup)) {
                  rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                          unit, VLAN_XLATEm, SECOND_LKUP, object,offset_mode,
                          base_index,pool_number);
              } else
#endif
              {
         ...
         case bcmStatObjectIngVrf:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                        unit, VRFm, FIRST_LKUP, object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectIngPolicy:
         ...
         case bcmStatObjectIngFcoe:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
                        unit, L3_ENTRY_IPV4_MULTICASTm, FIRST_LKUP, object, offset_mode,
                        base_index, pool_number);
              break;
         case bcmStatObjectIngL3Route:
              rv = _bcm_esw_stat_flex_destroy_ingress_table_counters(
         ...
         case bcmStatObjectEgrPort:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                        unit, EGR_PORTm, FIRST_LKUP, object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectEgrVlan:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
         ...
         case bcmStatObjectEgrVlanXlate:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                        unit, EGR_VLAN_XLATEm, FIRST_LKUP, object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectEgrVlanXlateSecondLookup:
#if defined(BCM_APACHE_SUPPORT)
              if (soc_feature(unit, soc_feature_egr_vlan_xlate_second_lookup)) {
                  rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                          unit, EGR_VLAN_XLATEm, SECOND_LKUP, object,offset_mode,
                          base_index,pool_number);
              } else
#endif
              {
         ...
         case bcmStatObjectEgrL2Gre:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                        unit, EGR_DVP_ATTRIBUTE_1m , FIRST_LKUP, object,offset_mode,
                        base_index,pool_number);
              break;
         case bcmStatObjectEgrVxlan:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
         ...
         case bcmStatObjectEgrFieldStageEgress:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
                        unit, EFP_POLICY_TABLEm, FIRST_LKUP, object, offset_mode,
                        base_index, pool_number);
              break;
         case bcmStatObjectEgrMplsTunnelLabel:
              rv = _bcm_esw_stat_flex_destroy_egress_table_counters(
    ...
    if (BCM_SUCCESS(rv)) {
        ...
        if (direction == bcmStatFlexDirectionIngress) {
            ...
            } else if (_bcm_esw_stat_flex_delete_ingress_mode(
...
void _bcm_esw_stat_flex_init_pkt_attr_bits(int unit)
{
   ...
   if (SOC_IS_TD2_TT2(unit)) {
       ...
       if (SOC_IS_TOMAHAWK(unit)) {
           egr_pkt_attr_uncmprsd_bits_g.egr_port = 8; /* For tomahawk 8 bits */
       } else {
       ...
       if (SOC_IS_TOMAHAWK(unit)) {
           ing_pkt_attr_uncmprsd_bits_g.ing_port = 8; /* FOR tomahawk, 8 bits */
       } else {
            ...
            uint32 *mode_id)
{
    ...
    uint8                                     temp_count=0;
    uint8                                     max_count=0;
    uint8         *map_array[bcmStatGroupModeAttrIntPriMplsLabelThird+1] = {NULL};
#ifdef BCM_APACHE_SUPPORT
    uint8                                     cng_3_bits = 0;
    uint8                                     phb_3_bits = 0;
    uint8                                     cng_2_bits = 0;
    ...
    uint32            *num_entries)
{
    ...
    if (direction == bcmStatFlexDirectionIngress) {
        ...
        mode = mode - BCM_STAT_FLEX_COUNTER_MAX_MODE;
        flex_egress_mode = sal_alloc(sizeof(bcm_stat_flex_egress_mode_t),
                                      "flex_egress_mod");
        if (flex_egress_mode == NULL) {
            return BCM_E_MEMORY;
    ...
    case bcmStatObjectIngPort:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, PORT_TABm, FIRST_LKUP, object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngVlan:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
    ...
    case bcmStatObjectIngVlanXlate:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, VLAN_XLATEm, FIRST_LKUP, object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngVlanXlateSecondLookup:
#if defined(BCM_TRIDENT2PLUS_SUPPORT)
         if (soc_feature(unit,soc_feature_ing_vlan_xlate_second_lookup)) {
             rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                     unit, VLAN_XLATEm, SECOND_LKUP, object,mode_id,
                     &base_index,&pool_number);
         } else
#endif
         {
    ...
    case bcmStatObjectIngVrf:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, VRFm, FIRST_LKUP, object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngPolicy:
         ingress_table = VFP_POLICY_TABLEm;
    ...
    case bcmStatObjectIngFcoe:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
                   unit, L3_ENTRY_IPV4_MULTICASTm, FIRST_LKUP, object,mode_id,
                   &base_index,&pool_number);
         break;
    case bcmStatObjectIngL3Route:
         rv = _bcm_esw_stat_flex_create_ingress_table_counters(
