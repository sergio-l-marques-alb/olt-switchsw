    ...
    bcm_ipsec_sa_info_t *sa)
{
    ...
    if(SOC_IS_QAX(unit))           /* QAX only programs */
        BCMDNX_IF_ERR_EXIT(soc_qax_ipsec_sa_create(unit, flags, spi_id, sa));
    ...
    bcm_ipsec_sa_keys_t *sa_keys)
{
    ...
    if(SOC_IS_QAX(unit))           /* QAX only programs */
        BCMDNX_IF_ERR_EXIT(soc_qax_ipsec_sa_key_update(unit, flags, spi_id, sa_keys));
    ...
    bcm_ipsec_tunnel_info_t *tunnel_info)
{
    ...
    if(SOC_IS_QAX(unit))           /* QAX only programs */
        BCMDNX_IF_ERR_EXIT(soc_qax_ipsec_tunnel_add(unit, flags, tunnel_id, tunnel_info));
