...
TEST(55,    "Memory hashing",           TSEL+T56640+T56850,            test_generic_hash_init, test_generic_hash_done, test_generic_hash,      1,      0)
TEST(56,    "Memory hash overflow Ins", TSEL+T56640+T56850,            test_generic_hash_ov_init, test_generic_hash_done, test_generic_hash_ov,
                                                                                                                                        1,      0)
...
TEST(100,   "VLAN xlate Overflow Ins",  (T56624|T56820|T56450|T56560)&(~T56640), tr_vlan_xlate_ov_test_init, tr_vlan_xlate_test_done, tr_vlan_xlate_test_ov,
                                                                                                                                        1,      0)
TEST(101,   "VLAN xlate Hashing",       (T56624|T56820|T56450|T56850|T56960)&(~T56640), tr_vlan_xlate_hash_test_init, tr_vlan_xlate_test_done, tr_vlan_xlate_test_hash,
                                                                                                                                        1,      0)
TEST(102,   "Egr VLAN xlate Ovrflw Ins", (T56624|T56820|T56450|T56560)&(~T56640), tr_egr_vlan_xlate_ov_test_init, tr_egr_vlan_xlate_test_done, tr_egr_vlan_xlate_test_ov,
                                                                                                                                        1,      0)
TEST(103,   "Egr VLAN xlate Hashing",   (T56624|T56820|T56450|T56850|T56960)&(~T56640), tr_egr_vlan_xlate_hash_test_init, tr_egr_vlan_xlate_test_done, tr_egr_vlan_xlate_test_hash,
                                                                                                                                        1,      0)
#ifdef BCM_TRIUMPH_SUPPORT
TEST(104,   "MPLS Overflow Ins",        (T56624|T56450|T56560)&(~T56640), tr_mpls_ov_test_init, tr_mpls_test_done,     tr_mpls_test_ov,        1,      0)
TEST(105,   "MPLS Hashing",             (T56624|T56450|T56850|T56960)&(~T56640), tr_mpls_hash_test_init, tr_mpls_test_done,   tr_mpls_test_hash,      1,      0)
...
#endif
#ifdef BCM_ARAD_SUPPORT
TEST(156,     "Export dump", DPP_ALL, 0 ,0, diag_dnx_export_dump_test, 1, 0)
#endif
...
#endif
#if defined (BCM_DPP_SUPPORT) && defined (BCM_ARAD_SUPPORT) && !defined (__KERNEL__) && defined (_SHR_SW_STATE_EXM) 
TEST(160,     "SW_STATE",          DPP_ALL,       sw_state_test_init,       sw_state_test_done,        sw_state_test,      1, 0) 
#endif
#if defined (BCM_DPP_SUPPORT) && defined (BCM_ARAD_SUPPORT)
TEST(161,     "OAMP",          DPP_ALL,       oamp_test_init,       oamp_test_done,        oamp_test,      1, 0) 
#endif
#if defined (BCM_DPP_SUPPORT) && defined (BCM_ARAD_SUPPORT) && !defined (__KERNEL__)
...
TEST(514,       "FlexPort test",        T56860,                 flexport_test_init,     flexport_test_cleanup,          flexport_test,          1,      0)
#endif
#if defined(BCM_TRIDENT2_SUPPORT)
