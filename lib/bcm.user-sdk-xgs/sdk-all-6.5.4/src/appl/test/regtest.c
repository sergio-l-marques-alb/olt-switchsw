    ...
    if(SOC_IS_DFE(unit)) { 
        ...
        if (SOC_IS_JERICHO_PLUS_A0(unit)) {
            switch(ainfo->reg) {
                ...
                case CGM_CGM_MAP_IF_2_THr:
                case CGM_CGM_MC_INTERFACE_MAP_THr:
                case CGM_CGM_MC_PD_TC_FC_THr:
                case CGM_CGM_QUEUE_IS_DISABLEDr:
                case CGM_CGM_UC_PD_INTERFACE_FC_MAX_THr:
                case CGM_CGM_UC_PD_INTERFACE_FC_MIN_THr:
                case CGM_CGM_UC_SIZE_256_INTERFACE_FC_MAX_THr:
                case CGM_CGM_UC_SIZE_256_INTERFACE_FC_MIN_THr:
                case CGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_ALPHAr:
                case CGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_MAXIMUM_THRESHOLDSr:
                case CGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_MINIMUM_THRESHOLDSr:
                case CGM_CONGESTION_MANAGEMENT_GLOBAL_DB_THRESHOLDSr:
                case CGM_CONGESTION_MANAGEMENT_GLOBAL_FLOW_CONTROL_THRESHOLDSr:
                case CGM_CONGESTION_MANAGEMENT_GLOBAL_PD_THRESHOLDSr:
                case CGM_CONGESTION_MANAGEMENT_MULTICAST_FLOW_CONTROL_PER_TC_THREHOSLDSr:
                case CGM_CONGESTION_MANAGEMENT_PD_SERVICE_POOL_THRESHOLDSr:

                    
                case CHIP_CONFIGr:
                case CHIP_INDACC_CTLSTSr:
                case CHIP_INDACC_WDATAr:
                case CHIP_SBUS_CFGr:
                case CHIP_SWRSTr:
                case CHIP_TESTr:
                ...
                case FDR_FDR_INTERRUPT_REGISTER_1_TESTr:
                case FDR_FDR_INTERRUPT_REGISTER_2_TESTr:
                case FDR_FDR_INTERRUPT_REGISTER_3_TESTr:
                case FDR_FDR_INTERRUPT_REGISTER_4_TESTr:

                    
                case IHP_PARSER_PEM_PROGRAM_ENCOUNTEREDr:


                    
                case KAPS_BBS_BB_GLOBAL_CONFIGr:
                case KAPS_BBS_INTERRUPT_MASK_REGISTERr:
                case KAPS_BBS_KAPS_BB_ERROR_REGISTER_MASKr:
                case KAPS_BBS_KAPS_BB_ERROR_REGISTER_TESTr:
