...
void SOC_SAND_MULTI_SET_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   int unit ;
   SOC_SAND_MULTI_SET_PTR multi_set = *((SOC_SAND_MULTI_SET_PTR *) element) ; 
   SOC_SAND_MULTI_SET_INFO *elt ; 
   /*
    * This is completely against the rules of the new sw state module but, then,
    * this whole file is going to be replaced so this is a good temporary solution.
    * (Also, fix unit at '0', just, again, as a temporary solution).
    */
   unit = 0 ;
   soc_sand_multi_set_get_multis_array_ptr_from_handle(unit,multi_set,&elt) ;
...
void SOC_SAND_HASH_TABLE_INFO_SW_DUMP_PRINT(void* element, char* variableName){ 
   char variableNameWithPath[SW_STATE_DUMP_STRING_LENGTH_MAX]; 
   SOC_SAND_HASH_TABLE_INFO *elt ; 
   SOC_SAND_HASH_TABLE_PTR elt_handle ;
   int unit ; 
   /*
    * Temporary solution. To be replaced by new printout module for new 'sw state'
    */
   unit = 0 ;
   elt_handle = *((SOC_SAND_HASH_TABLE_PTR*)element);
   soc_sand_hash_table_get_hashs_array_ptr_from_handle(unit,elt_handle,&elt) ;
...
void ARAD_SW_DB_DEVICE_SW_DUMP_PRINT(void* element, char* variableName){ 
   ...
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".lag"); 
   ARAD_LAGS_INFO_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->lag), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".tdm"); 
   ARAD_TDM_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->tdm), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".q_type_map"); 
   arraySizes_SW_DUMP[0]=SOC_TMC_ITM_NOF_QT_NDXS; 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) sw_state[0]->dpp.soc.arad.tm->q_type_ref_count, uint32_SW_DUMP_PRINT, 0, sizeof(uint32)); 
   arraySizes_SW_DUMP[0]=ARAD_SW_DB_NOF_DYNAMIC_QUEUE_TYPES; 
   printArray(arraySizes_SW_DUMP, 0, 1, variableNameWithPath, (void**) sw_state[0]->dpp.soc.arad.tm->q_type_map, uint8_SW_DUMP_PRINT, 0, sizeof(uint8)); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".cell"); 
   ARAD_CELL_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->cell), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".dram"); 
   ARAD_DRAM_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->dram), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   ...
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".vsi"); 
   ARAD_SW_DB_VSI_SW_DUMP_PRINT((void*) sw_state[0]->dpp.soc.arad.tm->vsi, variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".pmf"); 
   arraySizes_SW_DUMP[0]=SOC_PPC_NOF_FP_DATABASE_STAGES; 
   ...
   ARAD_INTERRUPTS_SW_DUMP_PRINT((void*) (sw_state[0]->dpp.soc.arad.tm->interrupts), variableNameWithPath); 
   SW_STATE_DUMP_SAFE_STRCPY(variableNameWithPath, variableName);     
   SW_STATE_DUMP_SAFE_STRCAT(variableNameWithPath, ".*modport2sysport"); 

      ARAD_SYSPORT_SW_DUMP_PRINT((void*) sw_state[0]->dpp.soc.arad.tm->modport2sysport, variableNameWithPath); 
