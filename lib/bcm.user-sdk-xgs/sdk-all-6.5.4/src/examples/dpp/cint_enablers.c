...
int in_rif_enablers(int unit,int ipmc_group_start, int nof_of_fix_bits, int inPort, int outPort1, int outPort2, int outPort3)
{
    ...
    int rv= BCM_E_NONE,profileNumber ,fix_bits, enablers;
    int vrf, ipmc_group, ipmc_group_v6;
    ...
    rv = bcm_rx_trap_type_create(unit,BCM_RX_TRAP_WITH_ID,bcmRxTrapUcLooseRpfFail,&trapId);
    if (rv != BCM_E_NONE) {
