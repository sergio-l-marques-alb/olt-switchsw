 ...
 *
 * File:        phyegphy28.c
 * Purpose:     PHY driver for BCM EGPHY28
 */
#include <sal/types.h>
...
#if defined(INCLUDE_PHY_EGPHY28)
...
#define PHY_IS_BCM56160(_pc) (PHY_MODEL_CHECK((_pc), \
                                  PHY_BCM56160GPHY_OUI,  \
                                  PHY_BCM56160GPHY_MODEL))

STATIC int
phy_egphy28_speed_set(int unit, soc_port_t port, int speed);
STATIC int
phy_egphy28_duplex_set(int unit, soc_port_t port, int duplex);
STATIC int
phy_egphy28_master_set(int unit, soc_port_t port, int master);
STATIC int
phy_egphy28_ability_advert_set(int unit, soc_port_t port, soc_port_ability_t *ability);
STATIC int
phy_egphy28_autoneg_set(int unit, soc_port_t port, int autoneg);
STATIC int
phy_egphy28_mdix_set(int unit, soc_port_t port, soc_port_mdix_t mode);
STATIC int
phy_egphy28_ability_local_get(int unit, soc_port_t port, soc_port_ability_t *ability);

STATIC int
phy_egphy28_control_set(int unit, soc_port_t port,
...
STATIC int
_phy_egphy28_cl45_reg_write(int unit, phy_ctrl_t *pc, uint32 flags, 
                         uint8 dev_addr, uint16 reg_addr, uint16 val)
{
    ...
    SOC_IF_ERROR_RETURN
        (PHYEGPHY28_REG_WRITE(unit, pc, flags, 0x00, 0x0E, val));
...
STATIC int
_phy_egphy28_cl45_reg_modify(int unit, phy_ctrl_t *pc, uint32 flags, 
                          uint8 dev_addr, uint16 reg_addr, uint16 val, 
                          uint16 mask)
{
    ...
    SOC_IF_ERROR_RETURN
        (PHYEGPHY28_CL45_REG_READ(unit, pc, flags, dev_addr, reg_addr, &value));

    value = (val & mask) | (value & ~mask);

    SOC_IF_ERROR_RETURN
        (PHYEGPHY28_CL45_REG_WRITE(unit, pc, flags, dev_addr, reg_addr, value));
...
STATIC int
_phy_egphy28_blk_top_lvl_reg_read(int unit, phy_ctrl_t *pc, uint32 flags, 
                         uint16 reg_offset, uint16 *val)
{

    /* Write register 0x17 with the top level reg offset to read (handled in PHYEGPHY28_REG_READ) */
    /* Read register 0x15 to get the value */
    SOC_IF_ERROR_RETURN
        (PHYEGPHY28_REG_READ(unit, pc, flags, (0x0D00|(reg_offset & 0xff)), 0x15, val));
...
/*
 * Function:
 *      _phy_egphy28_blk_top_lvl_reg_write
 * Purpose:
...
STATIC int
_phy_egphy28_blk_top_lvl_reg_write(int unit, phy_ctrl_t *pc, uint32 flags, 
                                  uint16 reg_offset, uint16 val)
{

    /* Write register 0x17 with the top level reg offset to write (handled in PHYEGPHY28_REG_WRITE) */
    /* Write register 0x15 the value to write to the top level register offset */
    SOC_IF_ERROR_RETURN
        (PHYEGPHY28_REG_WRITE(unit, pc, flags, (0x0D00|(reg_offset & 0xff)), 0x15, val));
...
STATIC int
_phy_egphy28_blk_top_lvl_reg_modify(int unit, phy_ctrl_t *pc, uint32 flags,
                          uint16 reg_offset, uint16 val, uint16 mask)
{
    ...
    SOC_IF_ERROR_RETURN
        (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, flags, 
                                          reg_offset, &value));
    value = (val & mask) | (value & ~mask);

    /* Write register 0x17 with the top level reg offset to read */
    SOC_IF_ERROR_RETURN
        (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, flags, 
                                          reg_offset, value));
 ...
 */
int
phy_egphy28_toplvl_reg_read(int unit, soc_port_t port, int flags, uint8 reg_offset, uint16 *data)
{
    phy_ctrl_t    *pc;
    ...
    LOG_VERBOSE(BSL_LS_SOC_PHY,
                (BSL_META_U(unit,
                            "entered phy_egphy28_toplvl_reg_read: "
    ...
    INT_MCU_LOCK(unit);
    pc->phy_id =  PHYEGPHY28_SLICE_ADDR(pc, 4);
    rv = pc->write(unit, pc->phy_id, 0x1c, reg_data);
    if (SOC_FAILURE(rv)) {
        pc->phy_id =  PHYEGPHY28_DEV_PHY_ID_ORIG(pc);
        INT_MCU_UNLOCK(unit);
        return rv;
    }

    pc->phy_id =  PHYEGPHY28_SLICE_ADDR(pc, 2);
 ...
 */
int
phy_egphy28_toplvl_reg_write(int unit, soc_port_t port, int flags, uint8 reg_offset, uint16 data)
{
    phy_ctrl_t *pc;
    uint16 reg_data;
    ...
    LOG_VERBOSE(BSL_LS_SOC_PHY,
                (BSL_META_U(unit,
                            "entered phy_egphy28_toplvl_reg_write: "
    ...
    INT_MCU_LOCK(unit);
    pc->phy_id =  PHYEGPHY28_SLICE_ADDR(pc, 5);
...
#ifdef EGPHY28_RDB_READ_ENABLED
/*
 * Function:
 *     phy_egphy28_rdb_reg_read
 * Purpose:
 *     RDB register read
 * Parameters:
                              ...
                              uint16 reg_addr, uint16 *data)
{
    ...
    PHYEGPHY28_LEGACY_ACCESS_MODE(unit, pc);   /* quit RDB assess mode */

    return (rv);
}
#endif /* EGPHY28_RDB_READ_ENABLED */

/*
 * Function:
 *     phy_egphy28_rdb_reg_write
 * Purpose:
 *     RDB register write
 * Parameters:
 *     reg_addr - RDB register address
 ...
 */
STATIC int
phy_egphy28_rdb_reg_write(int unit, phy_ctrl_t *pc,
                               uint16 reg_addr, uint16 data)
{
    int rv;
 ...
 */
STATIC int
phy_egphy28_medium_status(int unit, soc_port_t port, soc_port_medium_t *medium)
{
 ...
 */
STATIC int
phy_egphy28_medium_config_set(int unit, soc_port_t port, 
                           ...
                           soc_phy_config_t  *cfg)
{
    ...
    SOC_IF_ERROR_RETURN
        (phy_egphy28_speed_set(unit, port, cfg->force_speed));
    SOC_IF_ERROR_RETURN
        (phy_egphy28_duplex_set(unit, port, cfg->force_duplex));
    SOC_IF_ERROR_RETURN
        (phy_egphy28_master_set(unit, port, cfg->master));
    SOC_IF_ERROR_RETURN
        (phy_egphy28_ability_advert_set(unit, port, &cfg->advert_ability));
    SOC_IF_ERROR_RETURN
        (phy_egphy28_autoneg_set(unit, port, cfg->autoneg_enable));
    SOC_IF_ERROR_RETURN
        (phy_egphy28_mdix_set(unit, port, cfg->mdix));
...
STATIC int
phy_egphy28_medium_config_get(int unit, soc_port_t port, 
                           soc_port_medium_t medium,
                           soc_phy_config_t *cfg)
{
    phy_ctrl_t    *pc;
...
STATIC int
_phy_egphy28_mdi_pair_set(int unit, soc_port_t port, uint32 mdi_pair_map)
{
    phy_ctrl_t *pc;
    uint16  reg_val;
    pc = EXT_PHY_SW_STATE(unit, port);
    ...
    LOG_INFO(BSL_LS_SOC_PORT,
             (BSL_META_U(unit,
                         "_phy_egphy28_mdi_pair_set port %d\n"), port));

    return SOC_E_NONE;
}

STATIC int
_phy_egphy28_ieee_compliance_setup(int unit, soc_port_t port)
{
    phy_ctrl_t *pc;
    pc = EXT_PHY_SW_STATE(unit, port);

    if (!PHY_IS_BCM56160(pc)) {
        return SOC_E_NONE;
    }

    /* Set AFE_TX_CONFIG_0(0x1E4) to 0x00C0 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E4, 0x00C0));

    /* Set AFE_VDAC_OTHERS_0(0x1E7) to 0xB008 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E7, 0xB008));

    /* Set AFE_RXCONFIG_2(0x1E2) to 0x02E3 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E2, 0x02E3));

    /* Set AFE_RXCONFIG_0(0x1E0) to 0x0D11 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E0, 0x0D11));

    /* Set AFE_RX_LP_COUNTER(0x1E3) to 0x7FC0 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E3, 0x7FC0));

    /* Set TEMPSEN_OTHERS(0x1EB) to 0x6B40 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1EB, 0x6B40));

    /* Set AFE_HPF_TRIM_OTHERS(0x1E8) to 0x0213 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E8, 0x0213));

    /* Set AFE_TX_CONFIG_1(0x1E9) to 0x0020 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x1E9, 0x0020));

    /* Set CORE_SHD18_000(0x28) to 0x210B */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x28, 0x4C30));

    /* Set DSP_TAP10(0x125) to 0x210B */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0x125, 0x211B));

    /* Set CORE_BASE1E(0xE) to 0x0013 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0xE, 0x0013));

    /* Set CORE_EXPB0(0xB0) to 0x000C */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0xB0, 0x000C));

    /* Set CORE_EXPB0(0xB0) to 0x0000 */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_rdb_reg_write(unit, pc, 0xB0, 0x0000));
...
STATIC int
_phy_egphy28_reset_setup(int unit, soc_port_t port)
{
    phy_ctrl_t        *pc;
    uint16             tmp;
    uint16             phy_addr;
    ...
    if (soc_phy_primary_and_offset_get(unit, port, &primary_port, &index) == SOC_E_NONE) {
        ...
        PHYEGPHY28_DEV_PHY_ID_ORIG(pc) = pc->phy_id;
        PHYEGPHY28_DEV_PHY_SLICE(pc) = index;
        PHYEGPHY28_DEV_SET_BASE_ADDR(pc); /* phy address of port 0 */

        SOC_IF_ERROR_RETURN
            (phy_egphy28_control_set( unit, port, SOC_PHY_CONTROL_PORT_PRIMARY, primary_port));
        SOC_IF_ERROR_RETURN
            (phy_egphy28_control_set( unit, port, SOC_PHY_CONTROL_PORT_OFFSET, index ));
    } else {
        LOG_WARN(BSL_LS_SOC_PHY,
                 (BSL_META_U(unit,
                             "_phy_egphy28_reset_setup: Config property 'phy_port_primary_and_offset' not set for u=%d, p=%d\n"),
                             unit, port));
        ...
        SOC_IF_ERROR_RETURN
            (phy_egphy28_control_set( unit, port, SOC_PHY_CONTROL_PORT_PRIMARY, 
    ...
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MII_POWER_CTRLr(unit, pc, 0x0, 1U<<5));
    ...
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MII_CTRLr(unit, pc, tmp, MII_CTRL_PD));

#if DISABLE_CLK125
    /* Reduce EMI emissions by disabling the CLK125 pin if not used */
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_SPARE_CTRL_3r(unit, pc, 0, 1));
#endif
    ...
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MII_ECRr(unit, pc, 0x0020, 0x0020));

#if AUTO_MDIX_WHEN_AN_DIS
    /* Enable Auto-MDIX When autoneg disabled */
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MII_MISC_CTRLr(unit, pc, 0x0200, 0x0200));
#endif

    /* Enable extended packet length (4.5k through 25k) */
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, 0x4000, 0x4000));

    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MISC_1000X_CTRL2r(unit, pc, 0x0001, 0x0001));

    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_AUX_CTRLr(unit, pc, 0x0002, 0x0002));

    /* Configure LED selectors */
    tmp = ((pc->ledmode[1] & 0xf) << 4) | (pc->ledmode[0] & 0xf);
    SOC_IF_ERROR_RETURN
        (WRITE_PHYEGPHY28_LED_SELECTOR_1r(unit, pc, tmp));

    tmp = ((pc->ledmode[3] & 0xf) << 4) | (pc->ledmode[2] & 0xf);
    SOC_IF_ERROR_RETURN
        (WRITE_PHYEGPHY28_LED_SELECTOR_2r(unit, pc, tmp));

    tmp = (pc->ledctrl & 0x3ff);
    SOC_IF_ERROR_RETURN
        (WRITE_PHYEGPHY28_LED_CTRLr(unit, pc, tmp));

    SOC_IF_ERROR_RETURN
        (WRITE_PHYEGPHY28_EXP_LED_SELECTORr(unit, pc, pc->ledselect));
    ...
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_AUX_CTRLr(unit, pc, 0x0040, 0x0040));

        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, 0x0c00, 0x0c00));
        SOC_IF_ERROR_RETURN(
        ...
        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, 0x0400, 0x0c00));
    ...
    if (phy_mdi_pair_map) {
        SOC_IF_ERROR_RETURN(
            _phy_egphy28_mdi_pair_set(unit, port, phy_mdi_pair_map));
    }
    ...
    SOC_IF_ERROR_RETURN
        (_phy_egphy28_ieee_compliance_setup(unit, port));
 ...
 */
STATIC int
phy_egphy28_init(int unit, soc_port_t port)
{
    phy_ctrl_t         *pc;
    ...
    SOC_IF_ERROR_RETURN
        (_phy_egphy28_reset_setup(unit, port));

    /* Advertise all possible by default */
    SOC_IF_ERROR_RETURN
        (phy_egphy28_ability_local_get(unit, port, &pc->copper.advert_ability));

    SOC_IF_ERROR_RETURN
        (phy_egphy28_medium_config_set(unit, port, 0, &pc->copper)); 
...
STATIC int
phy_egphy28_enable_set(int unit, soc_port_t port, int enable)
{
    phy_ctrl_t    *pc;
    soc_timeout_t  to;
    ...
    SOC_IF_ERROR_RETURN
        (MODIFY_PHYEGPHY28_MII_CTRLr(unit, pc, power_down, MII_CTRL_PD));
    ...
    if (!enable) {
        if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_ENABLED)) {
            ...
            do {
                SOC_IF_ERROR_RETURN
                    (READ_PHYEGPHY28_MII_STATr(unit, pc, &mii_stat));

                if (soc_timeout_check(&to)) {
                    LOG_WARN(BSL_LS_SOC_PHY,
                             (BSL_META_U(unit,
                                         "phy_egphy28.c: link didn't go down after power down: u=%d p=%d\n"),
                              unit, port));
                    break;
                }
...
/*
 * Function:
 *      phy_egphy28_enable_get
 * Purpose:
 *      Enable or disable the physical interface for a EGPHY28 device.
 * Parameters:
 *      unit - StrataSwitch unit #.
 *      port - StrataSwitch port #.
...
STATIC int
phy_egphy28_enable_get(int unit, soc_port_t port, int *enable)
{
    SOC_IF_ERROR_RETURN
...
/*
 * Function:
 *      phy_egphy28_link_get
 * Purpose:
 *      Determine the current link up/down status for a EGPHY28 device.
 * Parameters:
 *      unit - StrataSwitch unit #.
 *      port - StrataSwitch port #.
...
STATIC int
phy_egphy28_link_get(int unit, soc_port_t port, int *link)
{
...
STATIC int
phy_egphy28_duplex_get(int unit, soc_port_t port, int *duplex)
{
    SOC_IF_ERROR_RETURN
...
/*
 * Function:
 *      phy_egphy28_speed_get
 * Purpose:
 *      Get the current operating speed for a EGPHY28 device.
 * Parameters:
 *      unit - StrataSwitch unit #.
 *      port - StrataSwitch port #.
 *      duplex - (OUT) Boolean, true indicates full duplex, false
...
STATIC int
phy_egphy28_speed_get(int unit, soc_port_t port, int *speed)
{
    SOC_IF_ERROR_RETURN
...
/*
 * Function:
 *      phy_egphy28_master_get
 * Purpose:
 *      Get the current master mode for a EGPHY28 device.
 * Parameters:
 *      unit - StrataSwitch unit #.
 *      port - StrataSwitch port #.
...
STATIC int
phy_egphy28_master_get(int unit, soc_port_t port, int *master)
{
    SOC_IF_ERROR_RETURN
...
STATIC int
phy_egphy28_autoneg_get(int unit, soc_port_t port,
...
/*
 * Function:
 *      phy_egphy28_ability_advert_set
 * Purpose:
...
phy_egphy28_ability_advert_set(int unit, soc_port_t port, soc_port_ability_t *ability)
{
    ...
    if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_CAPABLE)) {
        ...
        if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_ENABLED)) {
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_EEE_ADVr(unit, pc, eee_ability, 0x0006));
        } else {
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_EEE_ADVr(unit, pc, 0x0000, 0x0006));
        }
    }
...
/*
 * Function:
 *      phy_egphy28_ability_advert_get
 * Purpose:
...
STATIC int
phy_egphy28_ability_advert_get(int unit, soc_port_t port, soc_port_ability_t *ability)
{
    phy_ctrl_t *pc;
    uint16      eee_ability = 0;
    ...
    if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_CAPABLE)) {
        SOC_IF_ERROR_RETURN
            (READ_PHYEGPHY28_EEE_ADVr(unit, pc, &eee_ability));
        if (eee_ability & 0x04) {
...
/*
 * Function:
 *      phy_egphy28_ability_remote_get
 * Purpose:
...
STATIC int
phy_egphy28_ability_remote_get(int unit, soc_port_t port, soc_port_ability_t *ability)
{
    phy_ctrl_t       *pc;
    ...
    if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_CAPABLE)) {
        SOC_IF_ERROR_RETURN
            (READ_PHYEGPHY28_EEE_RESOLUTION_STATr(unit, pc, &eee_resolution));
...
STATIC int
phy_egphy28_lb_set(int unit, soc_port_t port, int enable)
{
    phy_ctrl_t *pc;
    int link = FALSE;
    ...
    pc = EXT_PHY_SW_STATE(unit, port);
        ...
        if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_CAPABLE)) {
            if (enable) {
                ...
                SOC_IF_ERROR_RETURN(
                    phy_egphy28_link_get(unit, port, &link));
                if (link == TRUE) {
                    SOC_IF_ERROR_RETURN(
                        PHY_LINKUP_EVT(pc->pd, unit, port));
                } else {
...
STATIC int
phy_egphy28_lb_get(int unit, soc_port_t port, int *enable)
{
...
STATIC int
phy_egphy28_interface_set(int unit, soc_port_t port, soc_port_if_t pif)
{
...
STATIC int
phy_egphy28_interface_get(int unit, soc_port_t port, soc_port_if_t *pif)
{
    phy_ctrl_t *pc;
...
phy_egphy28_mdix_set(int unit, soc_port_t port, soc_port_mdix_t mode)
{
    ...
    case SOC_PORT_MDIX_AUTO:
        ...
        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_MII_ECRr(unit, pc, 0, 0x4000));
        ...
        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_MII_MISC_CTRLr(unit, pc, 0, 0x0200));
        break;
    ...
    case SOC_PORT_MDIX_NORMAL:
        SOC_IF_ERROR_RETURN(phy_egphy28_speed_get(unit, port, &speed));
        if (speed == 0 || speed == 10 || speed == 100) {
            /* Set bit 14 for manual MDI crossover */
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_MII_ECRr(unit, pc, 0x4000, 0x4000));

            SOC_IF_ERROR_RETURN
                (WRITE_PHYEGPHY28_TEST1r(unit, pc, 0));
        } else {
    ...
    case SOC_PORT_MDIX_XOVER:
        ...
        if (speed == 0 || speed == 10 || speed == 100) {
            ...
            SOC_IF_ERROR_RETURN
                (WRITE_PHYEGPHY28_TEST1r(unit, pc, 0x0080));
        } else {
            return SOC_E_UNAVAIL;
        }
        break;
 ...
 */
STATIC int
_phy_egphy28_mdix_wb_update(int unit, soc_port_t port)
{
    phy_ctrl_t    *pc;
    int            speed;
    int            mode = 0;
    ...
    SOC_IF_ERROR_RETURN (READ_PHYEGPHY28_MII_ECRr(unit, pc, &val));
    if(val & 0x4000) {
        SOC_IF_ERROR_RETURN(phy_egphy28_speed_get(unit, port, &speed));
        if (speed == 0 || speed == 10 || speed == 100) {
            SOC_IF_ERROR_RETURN (READ_PHYEGPHY28_TEST1r(unit, pc, &val));
            if (0 == val) {
        ...
        SOC_IF_ERROR_RETURN (READ_PHYEGPHY28_MII_MISC_CTRLr(unit, pc,&val));
        if (val & 0x200) {
 ...
 */
STATIC int
phy_egphy28_mdix_get(int unit, soc_port_t port, soc_port_mdix_t *mode)
{
    phy_ctrl_t    *pc;
    int            speed;
    ...
    if (SOC_WARM_BOOT(unit)) {
        return _phy_egphy28_mdix_wb_update(unit, port);
    }
#endif /* defined(BCM_WARM_BOOT_SUPPORT) */
 ...
 */
STATIC int
phy_egphy28_mdix_status_get(int unit, soc_port_t port, 
                         soc_port_mdix_status_t *status)
{
    ...
    SOC_IF_ERROR_RETURN
        (READ_PHYEGPHY28_MII_ESRr(unit, pc, &tmp));
...
STATIC int
_phy_egphy28_power_mode_set (int unit, soc_port_t port, int mode)
{
    phy_ctrl_t    *pc;
    ...
    if (mode == SOC_PHY_CONTROL_POWER_LOW) {
        ...
        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_AUTO_POWER_DOWNr(unit,pc,
                        PHY_EGPHY28_AUTO_PWRDWN_EN,
                        PHY_EGPHY28_AUTO_PWRDWN_EN));
 ...
 */
STATIC int
_phy_egphy28_eee_enable(int unit, soc_port_t port, int enable)
{
    phy_ctrl_t *pc;
    ...
    if (enable == 1) {
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_EEE_ADVr(unit, pc, 0x0006, 0x0006));
                     ...
                     soc_phy_control_t type, uint32 value)
{
    ...
    case SOC_PHY_CONTROL_POWER:
            rv = _phy_egphy28_power_mode_set(unit,port,value);
        break;
    ...
    case SOC_PHY_CONTROL_DLL_POWER_AUTO:
        ...
        */
        if(1 == value) { /* enable */
            SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_SPARE_CTRL_3r(unit, pc,
                        0,
                        PHY_EGPHY28_SPARE_CTRL3_REG_DLL_AUTO_PWR_DOWN));
    ...
    case SOC_PHY_CONTROL_POWER_AUTO_WAKE_TIME:
        if (value <= PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_MAX) {

            /* at least one unit */
            if (value < PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_UNIT) {
                value = PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_UNIT;
            }
        } else { /* anything more then max, set to the max */
            value = PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_MAX;
        }
        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_AUTO_POWER_DOWNr(unit,pc,
                      value/PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_UNIT,
                      PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_MASK));
        break;

    case SOC_PHY_CONTROL_POWER_AUTO_SLEEP_TIME:
        /* sleep time configuration is either 2.7s or 5.4 s, default is 2.7s */
        if (value < PHY_EGPHY28_AUTO_PWRDWN_SLEEP_MAX) {
            data = 0; /* anything less than 5.4s, default to 2.7s */
        } else {
            data = PHY_EGPHY28_AUTO_PWRDWN_SLEEP_MASK;
        }
        SOC_IF_ERROR_RETURN
            (MODIFY_PHYEGPHY28_AUTO_POWER_DOWNr(unit,pc,
                      data,
                      PHY_EGPHY28_AUTO_PWRDWN_SLEEP_MASK));
        break;
    ...
    case SOC_PHY_CONTROL_CLOCK_ENABLE:
        ...
        SOC_IF_ERROR_RETURN
            (phy_egphy28_toplvl_reg_read(unit, port, primary, 0x0, &data));
        if ( value ) {
            SOC_IF_ERROR_RETURN
                (phy_egphy28_toplvl_reg_write(unit, port, primary, 0x0, 
    ...
    case SOC_PHY_CONTROL_EEE:
        ...
        if (value == 1) {
            /* Enable Native EEE */
            SOC_IF_ERROR_RETURN
                (_phy_egphy28_eee_enable(unit, port, 1));
            saved_autoneg = pc->copper.autoneg_enable;
            /* Initiate AN */
            SOC_IF_ERROR_RETURN
                (phy_egphy28_autoneg_set(unit, port, 1));
            pc->copper.autoneg_enable = saved_autoneg;
            PHY_FLAGS_SET(unit, pc->port, PHY_FLAGS_EEE_ENABLED);
            PHY_FLAGS_CLR(unit, pc->port, PHY_FLAGS_EEE_MODE);
        } else {
            SOC_IF_ERROR_RETURN
                (_phy_egphy28_eee_enable(unit, port, 0));
                /* Initiate AN if administratively enabled */
            SOC_IF_ERROR_RETURN
                (phy_egphy28_autoneg_set(unit, port, pc->copper.autoneg_enable ? 1 : 0));
            PHY_FLAGS_CLR(unit, pc->port, PHY_FLAGS_EEE_ENABLED);
    ...
    case SOC_PHY_CONTROL_EEE_STATISTICS_CLEAR:
        ...
        if (value == 1) {
            ...
            SOC_IF_ERROR_RETURN
               (MODIFY_PHYEGPHY28_EXP_MII_BUF_CNTL_STAT1r(unit, pc, 
                                                        0x1000, 0x1000));

            /* Read all the stats to clear */
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_TX_EVENTSr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_TX_EVENTSr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_TX_DURATIONr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_TX_DURATIONr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_RX_EVENTSr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_RX_EVENTSr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_RX_DURATIONr(unit, pc, &data));
            SOC_IF_ERROR_RETURN
                (READ_PHYEGPHY28_EXP_EEE_RX_DURATIONr(unit, pc, &data));
    ...
    case SOC_PHY_CONTROL_LOOPBACK_EXTERNAL:
        if (value) {
            ...
            saved_autoneg = pc->copper.autoneg_enable;
            SOC_IF_ERROR_RETURN
                (phy_egphy28_autoneg_set(unit, port, 0));
            pc->copper.autoneg_enable = saved_autoneg;
            
            saved_speed = pc->copper.force_speed;
            SOC_IF_ERROR_RETURN
                (phy_egphy28_speed_set(unit, port, 1000));
            pc->copper.force_speed = saved_speed;

            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_MII_GB_CTRLr(unit, pc, (1U << 12 | 1U << 11), (1U << 12 | 1U << 11)));
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, (1U << 15 | 1U << 10), (1U << 15 | 1U << 10)));
        } else {
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_MII_GB_CTRLr(unit, pc, 0, (1U << 12 | 1U << 11)));
            SOC_IF_ERROR_RETURN
                (MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, 0, (1U << 15 | 1U << 10)));
            SOC_IF_ERROR_RETURN
                (phy_egphy28_speed_set(unit, port, pc->copper.force_speed));
            SOC_IF_ERROR_RETURN
                (phy_egphy28_autoneg_set(unit, port, pc->copper.autoneg_enable ? 1 : 0));
        }
        break;
 ...
 */
STATIC int
phy_egphy28_control_get(int unit, soc_port_t port,
                     soc_phy_control_t type, uint32 *value)
{
    int rv;
    phy_ctrl_t *pc;
    ...
    case SOC_PHY_CONTROL_POWER_AUTO_SLEEP_TIME:
        SOC_IF_ERROR_RETURN
            (READ_PHYEGPHY28_AUTO_POWER_DOWNr(unit,pc, &data));

        if (data & PHY_EGPHY28_AUTO_PWRDWN_SLEEP_MASK) {
            *value = PHY_EGPHY28_AUTO_PWRDWN_SLEEP_MAX;
        } else {
            *value = 2700;
        }
        break;
    ...
    case SOC_PHY_CONTROL_POWER_AUTO_WAKE_TIME:
        ...
        data &= PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_MASK;
        *value = data * PHY_EGPHY28_AUTO_PWRDWN_WAKEUP_UNIT;
        break;
    ...
    case SOC_PHY_CONTROL_CLOCK_ENABLE:
        ...
        SOC_IF_ERROR_RETURN
            (soc_phyctrl_offset_get(unit, port, &offset));
        if (phy_egphy28_toplvl_reg_read(unit, port, primary, 0x0, &data) == SOC_E_NONE) {
    ...
    case SOC_PHY_CONTROL_EEE_RECEIVE_EVENTS:
        ...
        SOC_IF_ERROR_RETURN
            (PHYEGPHY28_REG_MODIFY(unit, pc, 0x00, 0x0FAF,0x15, 0x0, 1U<<14)); /* exp af */
        SOC_IF_ERROR_RETURN
            (READ_PHYEGPHY28_EXP_EEE_RX_EVENTSr(unit, pc, &data));
        temp = data;
        SOC_IF_ERROR_RETURN
            (PHYEGPHY28_REG_MODIFY(unit, pc, 0x00, 0x0FAF,0x15, 1U<<14, 1U<<14)); /* exp af */
        SOC_IF_ERROR_RETURN
            (READ_PHYEGPHY28_EXP_EEE_RX_EVENTSr(unit, pc, &data));
        temp |= (data << 16);
        *value = temp;
    ...
    case SOC_PHY_CONTROL_LOOPBACK_EXTERNAL:
         SOC_IF_ERROR_RETURN
             (READ_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, &data));
 ...
 */
STATIC int
phy_egphy28_cable_diag(int unit, soc_port_t port,
                    soc_port_cable_diag_t *status)
{
    int rv, rv2, i;
    phy_ctrl_t *pc;
    ...
    if (rv <= 0) {      /* don't reset if > 0 -- link was up */
        rv2 = _phy_egphy28_reset_setup(unit, port);
        if (SOC_SUCCESS(rv2)) {
            rv2 = phy_egphy28_medium_config_set(unit, port, SOC_PORT_MEDIUM_COPPER, &pc->copper);
        }
    }
    if (rv >= 0 && rv2 < 0) {
        return rv2;
 ...
 */
STATIC int
phy_egphy28_probe(int unit, phy_ctrl_t *pc)
{
    uint16 id0, id1;
    int rv = SOC_E_NOT_FOUND;

    if (READ_PHYEGPHY28_MII_PHY_ID0r(unit, pc, &id0) < 0) {
        return rv;
    }
    if (READ_PHYEGPHY28_MII_PHY_ID1r(unit, pc, &id1) < 0) {
        return rv;
    }

    switch (PHY_MODEL(id0, id1)) {

    case PHY_BCM53134_MODEL:
    case PHY_BCM56160GPHY_MODEL:
        rv = SOC_E_NONE;
    break;
    ...
    pc->size = sizeof(PHYEGPHY28_DEV_DESC_t);
...
STATIC int
phy_egphy28_link_up(int unit, soc_port_t port)
{
    phy_ctrl_t *pc;
    int speed;
    ...
    if (speed == 100) {
        ...
        if(value & (1U << 13)) {
                SOC_IF_ERROR_RETURN
                    (PHYEGPHY28_REG_MODIFY(unit, pc, 0x00, 0x0FF5,0x15, 0x0<<10, 0x3<<10)); /* exp reg f5 */
        } else {
                SOC_IF_ERROR_RETURN
                    (PHYEGPHY28_REG_MODIFY(unit, pc, 0x00, 0x0FF5,0x15, 0x1<<10, 0x3<<10)); /* exp reg f5 */
        }
    }
    ...
    if (PHY_FLAGS_TST(unit, port, PHY_FLAGS_EEE_ENABLED)) { /* EEE */
        sal_usleep(10000);    
        SOC_IF_ERROR_RETURN(
            READ_PHYEGPHY28_AUTO_POWER_DOWNr(unit, pc, &phy_auto));
        if ((phy_auto & PHY_EGPHY28_AUTO_PWRDWN_EN) != 0) {
            /* Disable PHY Auto Power-Down mode */
            SOC_IF_ERROR_RETURN(
                MODIFY_PHYEGPHY28_AUTO_POWER_DOWNr(unit, pc,
                    0, PHY_EGPHY28_AUTO_PWRDWN_EN));
        }
        SOC_IF_ERROR_RETURN(
            MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, (1U << 11), (1U << 11)));
        SOC_IF_ERROR_RETURN(
            WRITE_PHY_REG(unit, pc, 0x17, 0x001a));
        SOC_IF_ERROR_RETURN(
            WRITE_PHY_REG(unit, pc, 0x15, 0x0003));
        SOC_IF_ERROR_RETURN(
            MODIFY_PHYEGPHY28_MII_AUX_CTRLr(unit, pc, 0, (1U << 11)));
        if ((phy_auto & PHY_EGPHY28_AUTO_PWRDWN_EN) != 0) {
            /* Enable PHY Auto Power-Down mode */
            SOC_IF_ERROR_RETURN(
                MODIFY_PHYEGPHY28_AUTO_POWER_DOWNr(unit, pc,
                    PHY_EGPHY28_AUTO_PWRDWN_EN, PHY_EGPHY28_AUTO_PWRDWN_EN));
        }
    }
...
STATIC int
phy_egphy28_link_down(int unit, soc_port_t port)
{
    phy_ctrl_t *pc;
    uint16  phy_auto;
...
STATIC int
phy_egphy28_cable_diag_dispatch(int unit, soc_port_t port,
            soc_port_cable_diag_t *status)
{
        SOC_IF_ERROR_RETURN(
            phy_egphy28_cable_diag(unit, port, status));

    return SOC_E_NONE;
}

void _phy_egphy28_encode_egress_message_mode(soc_port_phy_timesync_event_message_egress_mode_t mode,
...
void _phy_egphy28_encode_ingress_message_mode(soc_port_phy_timesync_event_message_ingress_mode_t mode,
                                            int offset, uint16 *value)
{
...
void _phy_egphy28_decode_egress_message_mode(uint16 value, int offset,
...
void _phy_egphy28_decode_ingress_message_mode(uint16 value, int offset,
...
void _phy_egphy28_encode_gmode(soc_port_phy_timesync_global_mode_t mode,
                                            uint16 *value)
{
...
void _phy_egphy28_decode_gmode(uint16 value,
...
void _phy_egphy28_encode_framesync_mode(soc_port_phy_timesync_framesync_mode_t mode,
                                            uint16 *value)
{
...
void _phy_egphy28_decode_framesync_mode(uint16 value,
...
void _phy_egphy28_encode_syncout_mode(soc_port_phy_timesync_syncout_mode_t mode,
                                            uint16 *value)
{
...
void _phy_egphy28_decode_syncout_mode(uint16 value,
...
STATIC int
phy_egphy28_timesync_config_set(int unit, soc_port_t port, soc_port_phy_timesync_config_t *conf)
{
    phy_ctrl_t *pc;
    ...
    offset = PHYEGPHY28_DEV_PHY_SLICE(pc);
    ...
    do {
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_FLAGS) {
            ...
            if (conf->flags & SOC_PORT_PHY_TIMESYNC_ENABLE) {
                ...
                SOC_IF_ERROR_BREAK
                    (PHYEGPHY28_REG_MODIFY(unit, pc, 0x00, 0x0FF5,0x15, 1U<<0, 1U<<0), rv); /* exp reg f5 */
            } else {
                SOC_IF_ERROR_BREAK
                    (PHYEGPHY28_REG_MODIFY(unit, pc, 0x00, 0x0FF5,0x15, 0, 1U<<0), rv); /* exp reg f5 */
            }

            /* pc->phy_id =  PHYEGPHY28_SLICE_ADDR(pc, 0); */
            pc->phy_id =  PHYEGPHY28_DEV_PHY_ID_BASE(pc);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x10, en_control_reg, 
                                           ((1U << (offset + 8)) | (1U << offset))), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x10, &en_control_reg), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x12, tx_capture_en_reg, 
                                           (1U << offset)), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x13, rx_capture_en_reg, 
                                           (1U << (offset + 8))), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x4f, nse_nco_6, 
                                           (1U << 13)), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x34, rx_crc_control_reg), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x32, tx_control_reg), rv);
                                              
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x33, rx_control_reg), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x47, nse_nco_2c, 
                                               (1U << 14)), rv);
        }
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_ITPID) {
            /* VLAN TAG register */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x35, conf->itpid), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_OTPID) {
            /* OUTER VLAN TAG register */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x36, conf->otpid), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_OTPID2) {
            /* INNER VLAN TAG register */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x52, conf->otpid2), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TS_DIVIDER) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4b, conf->ts_divider & 0xfff), rv);
        }
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_LINK_DELAY) {
            pc->phy_id =  PHYEGPHY28_DEV_PHY_ID_ORIG(pc);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x6f, conf->rx_link_delay & 0xffff), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x70, (conf->rx_link_delay >> 16) & 0xffff), rv);
            pc->phy_id =  PHYEGPHY28_DEV_PHY_ID_BASE(pc);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_ORIGINAL_TIMECODE) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x25, (uint16)(conf->original_timecode.nanoseconds & 0xffff)), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x26, (uint16)((conf->original_timecode.nanoseconds >> 16) & 0xffff)), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x27, (uint16)(COMPILER_64_LO(conf->original_timecode.seconds) & 0xffff)), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x28, (uint16)((COMPILER_64_LO(conf->original_timecode.seconds) >> 16) & 0xffff)), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x29, (uint16)(COMPILER_64_HI(conf->original_timecode.seconds) & 0xffff)), rv);

        }
        mask = 0;

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_GMODE) {
            _phy_egphy28_encode_gmode(conf->gmode,&gmode);
            mask |= (0x3 << 14);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_FRAMESYNC_MODE) {
            _phy_egphy28_encode_framesync_mode(conf->framesync.mode, &framesync_mode);
            mask |= (0xf << 2) |  (0x1 << 11);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x51, length_threshold), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x50, event_offset), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_SYNCOUT_MODE) {
            _phy_egphy28_encode_syncout_mode(conf->syncout.mode, &syncout_mode);
            mask |= (0x3 << 0);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x48, interval & 0xffff), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x49, 
                    ((pulse_2_length & 0x3) << 14) | ((interval >> 16) & 0x3fff)), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4a, 
                    ((pulse_1_length & 0x1ff) << 7) | ((pulse_2_length >> 2) & 0x7f)), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4e, 
                    (uint16)(COMPILER_64_LO(conf->syncout.syncout_ts) & 0xffff)), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4d, 
                    (uint16)((COMPILER_64_LO(conf->syncout.syncout_ts) >> 16) & 0xffff)), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4c, 
                    (uint16)(COMPILER_64_HI(conf->syncout.syncout_ts) & 0xffff)), rv);
        }

        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x4f, (gmode << 14) |
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_TIMESTAMP_OFFSET) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x15 + offset, (uint16)(conf->tx_timestamp_offset & 0xffff)), rv);

            if (offset < 4 ) {
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x63, 
                        ((conf->tx_timestamp_offset & 0xf0000) >> ((4 - offset) << 2)), 0xf << (offset << 2)), rv);
            } else {
                uint16 offset1 = offset - 4;
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x64, 
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_TIMESTAMP_OFFSET) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x1d + offset, (uint16)(conf->rx_timestamp_offset & 0xffff)), rv);

            if (offset < 4 ) {
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x65, 
                        ((conf->rx_timestamp_offset & 0xf0000) >> ((4 - offset) << 2)), 0xf << (offset << 2)), rv);
            } else {
                uint16 offset1 = offset - 4;
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x66, 
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_SYNC_MODE) {
            _phy_egphy28_encode_egress_message_mode(conf->tx_sync_mode, 0, &value);
            mask |= 0x3 << 0;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_DELAY_REQUEST_MODE) {
            _phy_egphy28_encode_egress_message_mode(conf->tx_delay_request_mode, 2, &value);
            mask |= 0x3 << 2;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_PDELAY_REQUEST_MODE) {
            _phy_egphy28_encode_egress_message_mode(conf->tx_pdelay_request_mode, 4, &value);
            mask |= 0x3 << 4;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_PDELAY_RESPONSE_MODE) {
            _phy_egphy28_encode_egress_message_mode(conf->tx_pdelay_response_mode, 6, &value);
            mask |= 0x3 << 6;
        }
        ...
        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x11, value, mask), rv); 

        value = 0;
        mask = 0;

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_SYNC_MODE) {
            _phy_egphy28_encode_ingress_message_mode(conf->rx_sync_mode, 0, &value);
            mask |= 0x3 << 0;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_DELAY_REQUEST_MODE) {
            _phy_egphy28_encode_ingress_message_mode(conf->rx_delay_request_mode, 2, &value);
            mask |= 0x3 << 2;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_PDELAY_REQUEST_MODE) {
            _phy_egphy28_encode_ingress_message_mode(conf->rx_pdelay_request_mode, 4, &value);
            mask |= 0x3 << 4;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_PDELAY_RESPONSE_MODE) {
            _phy_egphy28_encode_ingress_message_mode(conf->rx_pdelay_response_mode, 6, &value);
            mask |= 0x3 << 6;
        }
                                                
                                                
        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x12, value << 8, mask << 8), rv); 
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_REF_PHASE) {
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x38, (uint16)(COMPILER_64_LO(conf->phy_1588_dpll_ref_phase) & 0xffff)), rv);

            /* Initial ref phase [31:16]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x39, (uint16)((COMPILER_64_LO(conf->phy_1588_dpll_ref_phase) >> 16) & 0xffff)), rv);

            /*  Initial ref phase [47:32] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x3a, (uint16)(COMPILER_64_HI(conf->phy_1588_dpll_ref_phase) & 0xffff)), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_REF_PHASE_DELTA) {
            /* Ref phase delta [15:0] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x3b, (uint16)(conf->phy_1588_dpll_ref_phase_delta & 0xffff)), rv);

            /* Ref phase delta [31:16]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x3c, (uint16)((conf->phy_1588_dpll_ref_phase_delta >> 16) & 0xffff)), rv);
        }
        ...
        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x3d, (conf->phy_1588_dpll_k1 & 0xff)<<8 | (conf->phy_1588_dpll_k2 & 0xff), mask ), rv);

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_K3) {
            /* DPLL K3 */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x3e, conf->phy_1588_dpll_k3 & 0xff), rv);
        }
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_LOOP_FILTER) {
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x3f, (uint16)(COMPILER_64_LO(conf->phy_1588_dpll_loop_filter) & 0xffff)), rv);

            /* Initial loop filter[31:16]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x40, (uint16)((COMPILER_64_LO(conf->phy_1588_dpll_loop_filter) >> 16) & 0xffff)), rv);

            /*  Initial loop filter[47:32] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x41, (uint16)(COMPILER_64_HI(conf->phy_1588_dpll_loop_filter) & 0xffff)), rv);

            /* Initial loop filter[63:48]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x42, (uint16)((COMPILER_64_HI(conf->phy_1588_dpll_loop_filter) >> 16) & 0xffff)), rv);
        }
...
STATIC int
phy_egphy28_timesync_config_get(int unit, soc_port_t port, soc_port_phy_timesync_config_t *conf)
{
    phy_ctrl_t *pc;
    int offset, rv = SOC_E_NONE;
    ...
    do {
        ...
        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4f, &nse_nco_6), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_FLAGS) {
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x12, &tx_capture_en_reg), rv); 
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x34, &rx_crc_control_reg), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x32, &tx_control_reg), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x47, &nse_nco_2c), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_GMODE) {
            _phy_egphy28_decode_gmode((nse_nco_6  >> 14),&gmode);
            conf->gmode = gmode;
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_FRAMESYNC_MODE) {
            _phy_egphy28_decode_framesync_mode((nse_nco_6  >> 2), &framesync_mode);
            conf->framesync.mode = framesync_mode;
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x51, &temp1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x50, &temp2), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_SYNCOUT_MODE) {
            _phy_egphy28_decode_syncout_mode((nse_nco_6  >> 0), &syncout_mode);
            conf->syncout.mode = syncout_mode;

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x48, &temp1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x49, &temp2), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4a, &temp3), rv);
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4e, &temp1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4d, &temp2), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4c, &temp3), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_ITPID) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x35, &conf->itpid), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_OTPID) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x36, &conf->otpid), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_OTPID2) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x52, &conf->otpid2), rv);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TS_DIVIDER) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4b, &conf->ts_divider), rv);
        }
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_LINK_DELAY) {
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x6f, &temp1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x70, &temp2), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_ORIGINAL_TIMECODE) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x25, &temp1), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x26, &temp2), rv);

            conf->original_timecode.nanoseconds = ((uint32)temp2 << 16) | temp1; 

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x27, &temp1), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x28, &temp2), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x29, &temp3), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_TIMESTAMP_OFFSET) {
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x15 + offset, &temp1), rv);
            if (offset < 4 ) {
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x63, &temp2), rv);
                temp32 = (temp2 & (0xf << (offset << 2))) << ((4 - offset) << 2);
            } else {
                uint16 offset1 = offset - 4;
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x64, &temp2), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_TIMESTAMP_OFFSET) {
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x1d + offset, &temp1), rv);
            if (offset < 4 ) {
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x65, &temp2), rv);
                temp32 = (temp2 & (0xf << (offset << 2))) << ((4 - offset) << 2);
            } else {
                uint16 offset1 = offset - 4;
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x66, &temp2), rv);
                temp32 = (temp2 & (0xf << (offset1 << 2))) << ((4 - offset1) << 2);
            }
        ...
        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x11, &value), rv); 

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_SYNC_MODE) {
            _phy_egphy28_decode_egress_message_mode(value, 0, &conf->tx_sync_mode);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_DELAY_REQUEST_MODE) {
            _phy_egphy28_decode_egress_message_mode(value, 2, &conf->tx_delay_request_mode);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_PDELAY_REQUEST_MODE) {
            _phy_egphy28_decode_egress_message_mode(value, 4, &conf->tx_pdelay_request_mode);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_TX_PDELAY_RESPONSE_MODE) {
            _phy_egphy28_decode_egress_message_mode(value, 6, &conf->tx_pdelay_response_mode);
        }

        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x12, &value), rv); 

        value >>= 8;

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_SYNC_MODE) {
            _phy_egphy28_decode_ingress_message_mode(value, 0, &conf->rx_sync_mode);
        }

        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_DELAY_REQUEST_MODE) {
            _phy_egphy28_decode_ingress_message_mode(value, 2, &conf->rx_delay_request_mode);
        }
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_RX_PDELAY_RESPONSE_MODE) {
            _phy_egphy28_decode_ingress_message_mode(value, 6, &conf->rx_pdelay_response_mode);
        }
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_REF_PHASE) {
            /* Initial ref phase [15:0] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x38, &temp1), rv);

            /* Initial ref phase [31:16]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x39, &temp2), rv);

            /*  Initial ref phase [47:32] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x3a, &temp3), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_REF_PHASE_DELTA) {
            /* Ref phase delta [15:0] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x3b, &temp1), rv);

            /* Ref phase delta [31:16]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x3c, &temp2), rv);
        ...
        /* DPLL K1 & K2 */
        SOC_IF_ERROR_BREAK
            (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x3d, &temp1 ), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_K3) {
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x3e, &temp1), rv);
        ...
        if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_LOOP_FILTER) {
            /* Initial loop filter[15:0] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x3f, &temp1), rv);

            /* Initial loop filter[31:16]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x40, &temp2), rv);

            /*  Initial loop filter[47:32] */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x41, &temp3), rv);

            /* Initial loop filter[63:48]  */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x42, &temp4), rv);
...
STATIC int
phy_egphy28_timesync_control_set(int unit, soc_port_t port, soc_port_control_phy_timesync_t type, uint64 value)
{
    phy_ctrl_t *pc;
    uint16 temp1, temp2;
    uint32 value0;
    ...
    do {
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_NCOADDEND:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x44, (uint16)COMPILER_64_LO(value)), rv);
            break;

        case SOC_PORT_CONTROL_PHY_TIMESYNC_FRAMESYNC:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x4f, &temp1), rv);
            temp2 = ((temp1 | (0x3 << 14) | (0x1 << 12)) & ~(0xf << 2)) | (0x1 << 5);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4f, temp2), rv);
            sal_udelay(1);
            temp2 &= ~((0x1 << 5) | (0x1 << 12));
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4f, temp2), rv);
            sal_udelay(1);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x4f, temp1), rv);
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_LOCAL_TIME:
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x45, (uint16)(COMPILER_64_LO(value) & 0xffff)), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x46, (uint16)((COMPILER_64_LO(value) >> 16) & 0xffff)), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_modify(unit, pc, 0, 0x47, (uint16)(COMPILER_64_HI(value) & 0xfff), 0xfff), rv);
            break;
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_LOAD_CONTROL:
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x2e, temp1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x2f, temp2), rv);
            break;
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_INTERRUPT_MASK:
            ...
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x30, temp1), rv);
            break;
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_TX_TIMESTAMP_OFFSET:
            ...
            /* tx_timestamp_offset */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x15 + offset, (uint16)(value0 & 0xffff)), rv);
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_RX_TIMESTAMP_OFFSET:
            ...
            /* rx_timestamp_offset */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_write(unit, pc, 0, 0x1d + offset, (uint16)(value0 & 0xffff)), rv);
...
STATIC int
phy_egphy28_timesync_control_get(int unit, soc_port_t port, soc_port_control_phy_timesync_t type, uint64 *value)
{
    phy_ctrl_t *pc;
    uint16 value0;
    uint16 value1;
    ...
    do {
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_HEARTBEAT_TIMESTAMP:
            SOC_IF_ERROR_BREAK
                (WRITE_PHYEGPHY28_EXP_READ_START_END_CTRLr(unit, pc, 0x1), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x56, &value0), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x57, &value1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x58, &value2), rv);

            SOC_IF_ERROR_BREAK
                (WRITE_PHYEGPHY28_EXP_READ_START_END_CTRLr(unit, pc, 0x2), rv);
            SOC_IF_ERROR_BREAK
                (WRITE_PHYEGPHY28_EXP_READ_START_END_CTRLr(unit, pc, 0x0), rv);
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_CAPTURE_TIMESTAMP:
            SOC_IF_ERROR_BREAK
                (WRITE_PHYEGPHY28_EXP_READ_START_END_CTRLr(unit, pc, 0x4), rv);

            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x53, &value0), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x54, &value1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x55, &value2), rv);

            SOC_IF_ERROR_BREAK
                (WRITE_PHYEGPHY28_EXP_READ_START_END_CTRLr(unit, pc, 0x8), rv);
            SOC_IF_ERROR_BREAK
                (WRITE_PHYEGPHY28_EXP_READ_START_END_CTRLr(unit, pc, 0x0), rv);
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_NCOADDEND:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x44, &value0), rv);
            /* *value = value0; */
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_LOCAL_TIME:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x45, &value0), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x46, &value1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x47, &value2), rv);
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_LOAD_CONTROL:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x2e, &value1), rv);
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x2f, &value2), rv);
            value0 = 0;
            if (value1 & (1U << 11)) {
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_INTERRUPT:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x31, &value1), rv);
            value0 = 0;
            if (value1 & (1U << 1)) {
        ...
        case SOC_PORT_CONTROL_PHY_TIMESYNC_INTERRUPT_MASK:
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x30, &value1), rv);
            value0 = 0;
            if (value1 & (1U << 1)) {
        ...
        /* tx_timestamp_offset */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x15 + offset, &value1), rv);
            if (offset < 4 ) {
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x63, &value2), rv);
                temp32 = (value2 & (0xf << (offset << 2))) << ((4 - offset) << 2);
            } else {
                uint16 offset1 = offset - 4;
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x64, &value2), rv);
        ...
        /* rx_timestamp_offset */
            SOC_IF_ERROR_BREAK
                (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x1d + offset, &value1), rv);
            if (offset < 4 ) {
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x65, &value2), rv);
                temp32 = (value2 & (0xf << (offset << 2))) << ((4 - offset) << 2);
            } else {
                uint16 offset1 = offset - 4;
                SOC_IF_ERROR_BREAK
                    (_phy_egphy28_blk_top_lvl_reg_read(unit, pc, 0, 0x66, &value2), rv);
                temp32 = (value2 & (0xf << (offset1 << 2))) << ((4 - offset1) << 2);
            }
            /* *value = temp32 | value1; */
            COMPILER_64_SET((*value), 0, (uint32)(temp32 | value1));
...
phy_driver_t phy_egphy28drv_ge = {
    "egphy28 Gigabit PHY Driver",
    phy_egphy28_init,
    phy_fe_ge_reset,
    phy_egphy28_link_get,
    phy_egphy28_enable_set,
    ...
    phy_egphy28_interface_get,
    NULL,                       /* Deprecated */
    phy_egphy28_link_up,          /* Link up event */
    phy_egphy28_link_down,
    phy_egphy28_mdix_set,
    phy_egphy28_mdix_get,
    phy_egphy28_mdix_status_get,
    phy_egphy28_medium_config_set,
    phy_egphy28_medium_config_get,
    phy_egphy28_medium_status,
    phy_egphy28_cable_diag_dispatch,
    NULL,                        /* phy_link_change */
    phy_egphy28_control_set,       /* phy_control_set */ 
    phy_egphy28_control_get,       /* phy_control_get */
    phy_ge_reg_read,
    phy_ge_reg_write,
    phy_ge_reg_modify,
    NULL,                        /* Phy notify event */    
    phy_egphy28_probe,             /* pd_probe  */
    phy_egphy28_ability_advert_set,/* pd_ability_advert_set */
    phy_egphy28_ability_advert_get,/* pd_ability_advert_get */
    phy_egphy28_ability_remote_get,/* pd_ability_remote_get */
    phy_egphy28_ability_local_get, /* pd_ability_local_get  */
    NULL,                        /* pd_firmware_set */    
    phy_egphy28_timesync_config_set,
    phy_egphy28_timesync_config_get,
    phy_egphy28_timesync_control_set,
    phy_egphy28_timesync_control_get
};

#else /* INCLUDE_PHY_EGPHY28 */
int _phy_egphy28_not_empty;
