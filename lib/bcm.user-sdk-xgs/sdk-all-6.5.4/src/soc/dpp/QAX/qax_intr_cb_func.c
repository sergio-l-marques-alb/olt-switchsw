...
{
    int i,nof_interrupts;

    soc_qax_nof_interrupts(unit,&nof_interrupts);

    for (i=0;i<nof_interrupts;i++) {
        dcmn_intr_add_handler_ext(unit, i, 0,0,qax_intr_handle_generic_none,NULL,"dummy int message");
