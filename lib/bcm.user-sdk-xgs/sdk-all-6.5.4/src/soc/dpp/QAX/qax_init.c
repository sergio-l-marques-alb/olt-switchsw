 ...
 */
STATIC int
soc_qax_dtq_contexts_init_single_pipe_clos(int unit)
{
    SOCDNX_INIT_FUNC_DEFS;
 ...
 */
STATIC int
soc_qax_dtq_contexts_init_dual_pipe_clos(int unit)
{
    SOCDNX_INIT_FUNC_DEFS;
 ...
 */
STATIC int
soc_qax_dtq_contexts_init_triple_pipe_clos(int unit)
{
    SOCDNX_INIT_FUNC_DEFS;
...
soc_qax_dtq_contexts_init(int unit)
{
    ...
    if (is_mesh){
        soc_qax_dtq_contexts_init_mesh(unit);
    } else {
        nof_pipes = SOC_DPP_CONFIG(unit)->arad->init.fabric.fabric_pipe_map_config.nof_pipes;
        switch (nof_pipes) {
        case 1:
            soc_qax_dtq_contexts_init_single_pipe_clos(unit);
            break;
        case 2:
            soc_qax_dtq_contexts_init_dual_pipe_clos(unit);
            break;
        case 3:
            soc_qax_dtq_contexts_init_triple_pipe_clos(unit);
            break;
        default:
