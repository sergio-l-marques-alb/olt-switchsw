  ...
  )
{
    ...
    case socLbModemStatsPkts:
        ...
        SOCDNX_IF_ERR_EXIT(rv);
        *value = soc_reg_above_64_field64_get(unit, reg, reg_abv64, FRAGMENT_CNT_Nf);            
        break;
    case socLbModemStatsOctets:
        ...
        rv = soc_reg_above_64_get(unit, reg, REG_PORT_ANY, modem_id, reg_abv64);
        SOCDNX_IF_ERR_EXIT(rv);
        *value = soc_reg_above_64_field64_get(unit, reg, reg_abv64, BYTE_CNT_Nf);            
        break;
    default:
  ...
  )
{
    ...
    if (is_global) {
        ...
        case socLbStatsOctets:
            reg = lb_egr_stats_reg_info[type].reg;
            rv = soc_reg64_get(unit, reg, REG_PORT_ANY, lbg_id, &reg_val64);
            SOCDNX_IF_ERR_EXIT(rv);
