...
/* VTT KBR get defines { */
/* { */
#define ARAD_PP_ISEM_ACCESS_32B_INST_CMPRSD_INNER_VID                                (SOC_IS_JERICHO_PLUS(unit) ? 0x5b18 : (SOC_IS_JERICHO(unit)? 0x5a98 : 0x5a68))
#define ARAD_PP_ISEM_ACCESS_16B_INST_CMPRSD_INNER_VID                                (SOC_IS_JERICHO_PLUS(unit) ? 0xb668 : (SOC_IS_JERICHO(unit)? 0xb568 : 0xb508))
#define ARAD_PP_ISEM_ACCESS_32B_INST_CMPRSD_OUTER_VID                                (SOC_IS_JERICHO_PLUS(unit) ? 0x5af8 : (SOC_IS_JERICHO(unit)? 0x5a78 : 0x5a48))
#define ARAD_PP_ISEM_ACCESS_16B_INST_CMPRSD_OUTER_VID                                (SOC_IS_JERICHO_PLUS(unit) ? 0xb628 : (SOC_IS_JERICHO(unit)? 0xb528 : 0xb4c8))
#define ARAD_PP_ISEM_ACCESS_32B_INST_INITIAL_VID                                     (SOC_IS_JERICHO_PLUS(unit) ? 0x5ad8 : (SOC_IS_JERICHO(unit)? 0x5a58 : 0x5a28))
#define ARAD_PP_ISEM_ACCESS_16B_INST_INITIAL_VID                                     (SOC_IS_JERICHO_PLUS(unit) ? 0xb5e8 : (SOC_IS_JERICHO(unit)? 0xb4e8 : 0xb488))
...
#define ARAD_PP_ISEM_ACCESS_32B_INST_IN_PORT                                         (SOC_IS_JERICHO_PLUS(unit) ? 0x3998 : (SOC_IS_JERICHO(unit)? 0x3918 : 0x3918))
...
#define ARAD_PP_ISEM_ACCESS_32B_INST_PON_VLAN_DOMAIN                                 (SOC_IS_JERICHO_PLUS(unit) ? 0x11b8 : (SOC_IS_JERICHO(unit)? 0x1138 : 0x1128)) /* Assumption of still 3 bits for PON.VLAN-Domain in Jericho */
#define ARAD_PP_ISEM_ACCESS_16B_INST_PON_VLAN_DOMAIN                                 (SOC_IS_JERICHO_PLUS(unit) ? 0x23a8 : (SOC_IS_JERICHO(unit)? 0x22a8 : 0x2288)) /* Assumption of still 3 bits for PON.VLAN-Domain in Jericho */
