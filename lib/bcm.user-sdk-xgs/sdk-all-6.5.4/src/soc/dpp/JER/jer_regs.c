...
int soc_jer_init_brdc_blk_id_set(int unit)
{
    ...
    if (SOC_DPP_DEFS_GET(unit, nof_instances_fmac) > 0)
    {
        if (SOC_IS_QAX(unit)) { /*elij - temp fix*/
            for (index=0 ; index < (9 - 1) ; index++) {
              SOCDNX_IF_ERR_EXIT(WRITE_FMAC_SBUS_BROADCAST_IDr(unit, index, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_FMAC,FMAC_BRDC_ID )));
    ...
    if (!SOC_IS_QAX(unit)) {
        ...
        for (index=0 ; index < SOC_DPP_DEFS_GET(unit, nof_instances_fsrd) - 1 ; index++) {
          SOCDNX_IF_ERR_EXIT(WRITE_FSRD_SBUS_BROADCAST_IDr(unit, index, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_FSRD,FSRD_BRDC_ID )));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_CGM_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_CGM,CGM_BRDC_ID )));
    SOCDNX_IF_ERR_EXIT(WRITE_CGM_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_CGM,CGM_BRDC_ID )));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_EGQ_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_EGQ,EGQ_BRDC_ID )));
    SOCDNX_IF_ERR_EXIT(WRITE_EGQ_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_EGQ,EGQ_BRDC_ID )));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_EPNI_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_EPNI,EPNI_BRDC_ID )));
    SOCDNX_IF_ERR_EXIT(WRITE_EPNI_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_EPNI,EPNI_BRDC_ID )));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_IHB_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IHB,IHB_BRDC_ID )));
    SOCDNX_IF_ERR_EXIT(WRITE_IHB_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IHB,IHB_BRDC_ID )));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_IHP_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IHP,IHP_BRDC_ID )));
    SOCDNX_IF_ERR_EXIT(WRITE_IHP_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IHP,IHP_BRDC_ID )));
    ...
    SOCDNX_IF_ERR_EXIT(WRITE_IPS_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IPS,IPS_BRDC_ID )));
    SOCDNX_IF_ERR_EXIT(WRITE_IPS_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IPS,IPS_BRDC_ID )));
    ...
    if (!SOC_IS_QAX(unit)) {
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_IQM_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IQM,IQM_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_IQM_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_IQM,IQM_BRDC_ID )));
    ...
    if (SOC_IS_QAX(unit)) {
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_SCH_SBUS_BROADCAST_IDr(unit, 0, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_SCH,SCH_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_SCH_SBUS_BROADCAST_IDr(unit, 1, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_SCH,SCH_BRDC_ID )));
    }
    ...
    if (!SOC_IS_QAX(unit)) {
        ...
        SOCDNX_IF_ERR_EXIT(WRITE_DRCA_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCB_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCC_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCD_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCE_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCF_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCG_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
        SOCDNX_IF_ERR_EXIT(WRITE_DRCH_SBUS_BROADCAST_IDr(unit, SOC_DPP_GET_BLOCK_TYPE_SCHAN_ID(unit,SOC_BLK_BRDC_DRC,DRC_BRDC_ID )));
