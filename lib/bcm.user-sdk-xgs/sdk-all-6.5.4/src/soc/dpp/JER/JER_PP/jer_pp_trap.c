...
* out_lif_profile (IN) - Out-LIF-Profile which needs to be mapped to MTU profile
* mtu_profile (IN)    - the mapped MTU profile
* mtu_val    (IN)     - mtu value of mapped MTU profile
* Return:    (soc_error_t)
*******************************************************************************/
soc_error_t soc_jer_eg_etpp_out_lif_mtu_map_set(int unit,uint32 out_lif_profile, uint32 mtu_profile, uint32 mtu_val)
{
    ...
    {
        SOCDNX_EXIT_WITH_ERR(SOC_E_EXISTS, (_BSL_SOCDNX_MSG("Invalid mtu profile")));
    }
    ...
    SHR_BITCOPY_RANGE(data_above_64,                                    /*dest*/
                     out_lif_profile*ETPP_EPNI_NOF_MTU_PROFILES_BIT,    /*dest offset*/
                     &mtu_profile,                                      /*src*/
                     0,                                                 /*src offset*/
