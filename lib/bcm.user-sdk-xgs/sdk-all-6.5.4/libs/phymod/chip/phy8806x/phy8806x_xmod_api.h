...
#define XMOD_CORE_CMDS_COUNT                        0x1e    /* LAST ENTRY */
...
#define XMOD_ETHERNET_CMDS_COUNT                    0x51    /* LAST ENTRY */
...
#define WRITE_XMOD_ARG_BUFF(_xmodbuf, _argbuff, _arglen) \
    { \
	sal_memcpy((void*)_xmodbuf, (void*)_argbuff, _arglen); \
	_xmodbuf+=_arglen; \
    }
#define READ_XMOD_ARG_BUFF(_xmodbuf, _argbuff, _arglen) \
    { \
	sal_memcpy((void*)_argbuff, (void*)_xmodbuf, _arglen); \
	_xmodbuf+=_arglen; \
    }
...
/*!
 * @struct xmod_firmware_lane_config_s
...
typedef struct xmod_firmware_lane_config_s {
    ...
    xmod_firmware_media_type_t  MediaType;              /* Media Type */
...
/* XMOD_PHY_TX_GET */
extern int xmod_phy_tx_get(OUT xmod_tx_t tx);
#define XMOD_PHY_TX_GET_IN_LEN   (0)
...
/* XMOD_PHY_RX_GET */
extern int xmod_phy_rx_get(OUT xmod_rx_t rx);
#define XMOD_PHY_RX_GET_IN_LEN   (0)
...
#define XMOD_PHY_FEC_ENABLE_GET_IN_LEN   (0)
...
#define XMOD_PHY_FEC_ENABLE_SET_IN_LEN   (sizeof(uint32_t))
...
#define XMOD_PHY_CL72_STATUS_GET_IN_LEN   (0)
...
#define XMOD_BFCMAP_PORT_CONFIG_GET_IN_LEN   (sizeof(uint32_t) + sizeof(uint32_t) + sizeof(uint32_t))
