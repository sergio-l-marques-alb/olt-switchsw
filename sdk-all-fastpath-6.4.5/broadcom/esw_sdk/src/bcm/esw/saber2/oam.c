...
#define BCM_SB2_OAM_MP_GROUP_TCAM_ATOM_DISABLE_WAR 1


#if defined (BCM_SB2_OAM_MP_GROUP_TCAM_ATOM_DISABLE_WAR)
#define BCM_SB2_TCAM_ATOMICITY_DISABLE(unit) BCM_IF_ERROR_RETURN(soc_reg_field32_modify(unit, AUX_ARB_CONTROL_2r,\
					REG_PORT_ANY, TCAM_ATOMIC_WRITE_ENABLEf, 0)) 	
#define BCM_SB2_TCAM_ATOMICITY_ENABLE(unit) BCM_IF_ERROR_RETURN(soc_reg_field32_modify(unit, AUX_ARB_CONTROL_2r,\
...
#define _BCM_SB2_ETH_LM_DM_OAM_PM_EVENT_TYPE(event_type) (event_type == bcmOAMEventEthLmDmRawData)
#define _BCM_SB2_MPLS_LM_DM_OAM_PM_EVENT_TYPE(event_type) (event_type == bcmOAMEventMplsLmDmRawData)
 ...
 * the mapping table. 
 */
#define _BCM_SB2_OLP_HEADER_TYPE_TX 0
#define _BCM_SB2_OLP_HEADER_TYPE_RX 1 

/* OLP_HEADER_SUBTYPE filled with one of the following values */
/* Down mep subtypes */
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_CCM             0x01
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_LM              0x02
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_DM              0x03
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_OTHER_OC        0x04
#define _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_CCM                 0x05
#define _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_LM                  0x06
#define _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_DM                  0x07
#define _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_OTHER_OC            0x08
#define _BCM_SB2_OLP_HEADER_SUBTYPE_BFD                     0x09
#define _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_DLM           0x0A
#define _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_DM            0x0B
#define _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_DLM_DM        0x0C
#define _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_ILM           0x0D
#define _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_ILM_DM        0x0E
/* Up mep subtypes */
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_CCM             0x11
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_LM              0x12
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_DM              0x13
#define _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_OTHER_OC        0x14

/* KEY formation logic for EGR_OLP_HEADER_TYPE_MAPPING table */
#define _BCM_SB2_OAM_OLP_HDR_MAP_DIR_DOWN_OR_IFP 0
#define _BCM_SB2_OAM_OLP_HDR_MAP_DIR_UP          1 
#define _BCM_SB2_NO_OF_BITS_COMP_HDR 5
#define _BCM_SB2_OAM_OLP_HDR_TYPE_MAP_KEY_FORM(dir, comp_hdr) \
                    (dir << _BCM_SB2_NO_OF_BITS_COMP_HDR) | comp_hdr

#define _BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(comp_hdr) \
        _BCM_SB2_OAM_OLP_HDR_TYPE_MAP_KEY_FORM(_BCM_SB2_OAM_OLP_HDR_MAP_DIR_DOWN_OR_IFP,\
                                                comp_hdr)
#define _BCM_SB2_OAM_OLP_HDR_TYPE_MAP_UPMEP_KEY_FORM(comp_hdr) \
        _BCM_SB2_OAM_OLP_HDR_TYPE_MAP_KEY_FORM(_BCM_SB2_OAM_OLP_HDR_MAP_DIR_UP,\
                                                comp_hdr)
...
#define ETH_LM_DM_COSQ_INVALID          0xFFFF
...
#define MPLS_LM_DM_MAX_SESSIONS          128
...
#define MPLS_LM_DM_VCCV_TYPE_1           1 /* Channel ACH */
#define MPLS_LM_DM_VCCV_TYPE_2           2 /* RAL */
#define MPLS_LM_DM_VCCV_TYPE_3           3 /* TTL */
#define MPLS_LM_DM_VCCV_TYPE_4           4 /* GAL over PW */
...
int _bcm_sb2_oam_get_new_ctr_pool_id(bcm_oam_endpoint_info_t *ep_info_p, int *pool_id)
{
    /* Counter pool allocations inorder to allow hierarchical
     * test cases. 
     * For example, a PW data packet can increment
     * LSP as well as section MEP counters. So we need to allocate
     * different pool ids for different types of endpoints.
     * This is required since HW cannot simulaneously increment two different 
     * counter indexes in same pool
     *
     * Pool 0 has more allocations since it is twice the size of Pool 1 and 2.
     *
     * Pool 0 - Ethernet  : Port + Svlan, Port + Cvlan 
     *          MPLS LM/DM: LSP, Section MEP Port + SVlan, Section MEP Port + Cvlan
     *          BHH       : LSP, Section MEP Port + SVlan, Section MEP Port + Cvlan
     *
     * Pool 1 - Ethernet  : Port MEP 
     *          MPLS LM/DM: Section MEP Port
     *          BHH       : Section MEP Port
     *           
     * Pool 2 - Ethernet  : Port + Svlan + Cvlan 
     *          MPLS LM/DM: PW, Section MEP Port + SVlan + Cvlan
     *          BHH       : PW, Section MEP Port + SVlan + Cvlan
     *
     *
     */
    switch(ep_info_p->type) {
        ...
        case bcmOAMEndpointTypeEthernet:
            if(ep_info_p->flags & BCM_OAM_ENDPOINT_MATCH_INNER_VLAN) {
                *pool_id = 0; /* C Vlan */
            } else if(ep_info_p->flags & 
                    BCM_OAM_ENDPOINT_MATCH_OUTER_AND_INNER_VLAN) {
                *pool_id = 2; /* S + C Vlan */
            } else if((ep_info_p->vlan == 0) && (ep_info_p->inner_vlan == 0)) {
                *pool_id = 1; /* Port MEP */
            } else {
                *pool_id = 0; /* S vlan */
            }
...
_bcm_sb2_oam_key_type_from_endpoint_get(bcm_oam_endpoint_type_t type,
                                        ...
                                        bcm_vlan_t inner_vlan, int *key_type)
{
    ...
    } else if (flags & BCM_OAM_ENDPOINT_PBB_TE) {
...
_bcm_sb2_tpid_entry_delete(int unit, int index, int tpid_type) 
{
    ...
    if (tpid_type == BCM_OAM_TPID_TYPE_OUTER) {
        ...
        if (0 == SB2_OAM_OUTER_TPID_REF_COUNT(unit, index)) {
            SB2_OAM_OUTER_TPID_ENTRY(unit, index) = BCM_OAM_DEFAULT_TPID;
...
int _bcm_sb2_opcode_flags_to_opcode_group_index(uint32 opcode_flags, 
                                                ...
                                                int *index_list, int *num_index)
{
    switch(opcode_flags) {
        ...
        case BCM_OAM_OPCODE_CCM_IN_HW:
            if (BHH_TYPE(type)) {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_CCM;
            } else {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_CCM;
            }
            *num_index = 1;
            break;
        ...
        case BCM_OAM_OPCODE_LBM_MC_DROP:       
            if (BHH_TYPE(type)) {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LBM;
            } else {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LBM;
            }
            *num_index = 1;
            break;
        ...
        case BCM_OAM_OPCODE_LBR_DROP:          
            if (BHH_TYPE(type)) {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LBR;
            } else {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LBR;
            }
            *num_index = 1;
            break;
        ...
        case BCM_OAM_OPCODE_LTM_DROP:          
            if (BHH_TYPE(type)) {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LTM;
            } else {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LTM;
            }
            *num_index = 1;
            break;
        ...
        case BCM_OAM_OPCODE_LTR_DROP:          
            if (BHH_TYPE(type)) {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LTR;
            } else {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LTR;
            }
            *num_index = 1;
            break;
        ...
        case BCM_OAM_OPCODE_OTHER_DROP:          
            if (BHH_TYPE(type)) {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_OTHER_1;
                index_list[1] = _BCM_SB2_OPCODE_GROUP_BHH_OAM_OTHER_2;
            } else {
                index_list[0] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_OTHER_1;
                index_list[1] = _BCM_SB2_OPCODE_GROUP_ETH_OAM_OTHER_2;
            }
            *num_index = 2;
            break;
...
int
_bcm_sb2_oam_mpls_lm_dm_opcode_to_opcode_group_index(uint32 opcode,
                                                     int *opcode_group)
{
    int rv = BCM_E_NONE;
    switch(opcode) {
        case bcmOamMplsLmDmOpcodeTypeLm:
            *opcode_group =_BCM_SB2_OPCODE_GROUP_MPLS_LM; 
            break;
        case bcmOamMplsLmDmOpcodeTypeDm:
            *opcode_group = _BCM_SB2_OPCODE_GROUP_MPLS_DM;
            break;
        case bcmOamMplsLmDmOpcodeTypeIlm:
            *opcode_group = _BCM_SB2_OPCODE_GROUP_MPLS_ILM;
            break;
        case bcmOamMplsLmDmOpcodeTypeLmPlusDm:
            *opcode_group = _BCM_SB2_OPCODE_GROUP_MPLS_LM_PLUS_DM;
            break;
        case bcmOamMplsLmDmOpcodeTypeIlmPlusDm:
            *opcode_group = _BCM_SB2_OPCODE_GROUP_MPLS_ILM_PLUS_DM;
            break;
        default:
            rv = BCM_E_PARAM;
            break;
...
int _bcm_sb2_opcode_to_opcode_group_index (_bcm_oam_hash_data_t *h_data_p,
                                           uint32 opcode)
{
    int opcode_group = -1;
    ...
    if (MPLS_LM_DM_ENDPOINT_TYPE(h_data_p)) {
        BCM_IF_ERROR_RETURN(
                  _bcm_sb2_oam_mpls_lm_dm_opcode_to_opcode_group_index(opcode,
                                                               &opcode_group));
        return opcode_group;
    }
    ...
    switch(opcode) {
        case _BCM_OAM_OPCODE_TYPE_CCM:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_CCM;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_CCM;
            }
            break;
        case _BCM_OAM_OPCODE_TYPE_LBR:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LBR;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LBR;
            }
            break;
        case _BCM_OAM_OPCODE_TYPE_LBM:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LBM;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LBM;
            }
            break;
        case _BCM_OAM_OPCODE_TYPE_LTR:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LTR;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LTR;
            }
            break;
        case _BCM_OAM_OPCODE_TYPE_LTM:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_LTM;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_LTM;
            }
            break;
        ...
        case _BCM_OAM_OPCODE_TYPE_SLR:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_OTHER_1;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_OTHER_1;
            }
            break;
        ...
        case _BCM_OAM_OPCODE_TYPE_DMR:
            if (BHH_EP_TYPE(h_data_p)) {
                opcode_group = _BCM_SB2_OPCODE_GROUP_BHH_OAM_OTHER_2;
            } else {
                opcode_group = _BCM_SB2_OPCODE_GROUP_ETH_OAM_OTHER_2;
            }
            break;
    } 
 ...
 */
STATIC int
_bcm_sb2_oam_opcode_profile_entry_set(int unit, bcm_oam_endpoint_type_t type,
                                      soc_mem_t mem,
                                      uint32 flags,
                                      void *entry)
{
    ...
    for (bp = 0; bp < opcode_count; bp++) {
        ...
        if(ep_opcode != 0)
        {
            rv =  _bcm_sb2_opcode_flags_to_opcode_group_index(ep_opcode, type,
            ...
            for(index = 0; index < num_index; index++)
            {
                ...
                soc_mem_field32_set(unit, mem, actual_entry, LOW_MDL_ACTIONf,
                        _BCM_SB2_OAM_OC_PROF_DROP);
            }
        }
    }
                                            ...
                                            void *entry)
{
    ...
    for (opcode = bcmOamMplsLmDmOpcodeTypeLm; 
        ...
        rv = _sb2_oam_opcode_control_field_set(unit, &hash_data, bcmOAMActionCopyToCpu, 
                mem, opcode, _BCM_OAM_COPY_TO_CPU,
                entry);
        if (BCM_FAILURE(rv)) {
            return rv;
        }
        ...
        rv = _sb2_oam_opcode_control_field_set(unit, &hash_data, bcmOAMActionDrop,
                mem, opcode, _BCM_OAM_DROP_PACKET,
                entry);
        if (BCM_FAILURE(rv)) {
            return rv;
        }
                                       ...
                                       void *entry)
{
    ...
    rv = _bcm_sb2_oam_opcode_profile_entry_set(unit, bcmOAMEndpointTypeEthernet,
                                                 mem, opcode, entry);
    if (BCM_FAILURE(rv)) {
        return rv;
    }
    /* Initialize for BHH OAM. Using one of the types of BHH endpoints */
    rv = _bcm_sb2_oam_opcode_profile_entry_set(unit, bcmOAMEndpointTypeBHHMPLS,
                                                 mem, opcode, entry);
    if (BCM_FAILURE(rv)) {
        return rv;
    }
...
int
_bcm_sb2_mpls_lmdm_ach_type_counter_enable(int unit, int opcode)
{
    int index = 0;
                            ...
                            egr_mp_group_entry_t *egr_mp_grp_key_p)
{
    ...
    if (!BHH_EP_TYPE(h_data_p)) {
        ...
        if (h_data_p->flags & BCM_OAM_ENDPOINT_PBB_TE) {
            ...
            soc_EGR_MP_GROUPm_field32_set
                (unit, egr_mp_grp_key_p, VPf, h_data_p->vp);
            ...
            if (MPLS_LM_DM_ENDPOINT_TYPE(h_data_p)) {
                ...
                soc_EGR_MP_GROUPm_field32_set
                    (unit, egr_mp_grp_key_p, GLPf, h_data_p->dglp);
            }
        ...
        if(!BHH_EP_MPLS_SECTION_TYPE(h_data_p)){
            /* BHH Domain, Key = MPLS_LMDM_LSP_MEPID 
               BHH API have been using L3_EGRESS type in 
               bcm_oam_endpoint_info_t.intf field. 
               However for supporting LM/DM on Saber2 this should be DVP_EGRESS type,
            ...
            if (BCM_XGS3_L3_EGRESS_IDX_VALID(unit, h_data_p->egress_if)) {
                soc_EGR_MP_GROUPm_field32_set (unit, egr_mp_grp_key_p, MEPIDf, 
                        h_data_p->name);
            } else {
...
{
    /* Set the search key type. */
    soc_MP_GROUPm_field32_set 
        (unit, mp_group_key_p, KEY_TYPEf, h_data_p->oam_domain);
    ...
    if (!BHH_EP_TYPE(h_data_p)) {
        ...
        if (h_data_p->flags & BCM_OAM_ENDPOINT_PBB_TE) {
            /* Vp field contains virtual port. */
            soc_MP_GROUPm_field32_set 
                (unit, mp_group_key_p, VPf, h_data_p->vp);
            ...
            if (MPLS_LM_DM_ENDPOINT_TYPE(h_data_p)) {
                ...
                /* Set VLAN ID in search key. */
                soc_MP_GROUPm_field32_set
                    (unit, mp_group_key_p, SVIDf, h_data_p->vlan);

                soc_MP_GROUPm_field32_set
                    (unit, mp_group_key_p, CVIDf, h_data_p->inner_vlan);

                /* SGLP contains generic logical port. */
                soc_MP_GROUPm_field32_set
                    (unit, mp_group_key_p, GLPf, h_data_p->sglp);
            }
       }
    } 
#if defined(INCLUDE_BHH)
                            ...
                            bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    for (index = 0; index < 2; index++) { 
        ...
        if (ep_info_p->lm_pdu_ctr_field_size == bcmOamLmCounterSize32Bit) {
            soc_mem_field32_set(unit, mems[index], &entry,
                                LM_COUNTER_SAMPLE_SIZEf, 0);
            soc_mem_field32_set(unit, mems[index], &entry,
                                LM_PDU_COUNTER_FIELD_SIZEf, 0);
        } else if (ep_info_p->lm_pdu_ctr_field_size == bcmOamLmCounterSize64Bit) {
            soc_mem_field32_set(unit, mems[index], &entry,
...
_bcm_sb2_oam_lm_counters_hw_values_reset(int unit, int pool_id, int index)
{
    ...
    ep_info.lm_pdu_ctr_field_size = bcmOamLmCounterSize32Bit;
 ...
 */
STATIC int
_bcm_sb2_oam_counter_set(int unit,
                         bcm_oam_endpoint_info_t *ep_info_p,
                         uint32 *entry,
                         shr_idxres_element_t *ctr_index,
                         int *ctr_field_id,
                         int *pool_id) 
{
    ...
    if ((1 == ctr1_valid) && (1 == ctr2_valid)) {
        ...
        BCM_IF_ERROR_RETURN(_bcm_sb2_oam_get_new_ctr_pool_id(ep_info_p, pool_id));
                                  ...
                                  bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if (BCM_SUCCESS
        ...
        if (hash_data->tx_ctr == _BCM_OAM_INVALID_INDEX) {
            ...
            rv = _bcm_sb2_oam_counter_set(unit,
                    ep_info_p,
                                ...
                                bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if ((tag_type == _BCM_OAM_DOMAIN_SVLAN) || 
        (tag_type == _BCM_OAM_DOMAIN_S_PLUS_CVLAN) ||
        (tag_type == _BCM_SB2_OAM_DOMAIN_MPLS_SECTION_SVLAN) ||
        (tag_type == _BCM_SB2_OAM_DOMAIN_MPLS_SECTION_S_PLUS_CVLAN)) { 
    ...
    if ((tag_type == _BCM_OAM_DOMAIN_CVLAN) || 
        /* C or S+C */
        (tag_type == _BCM_OAM_DOMAIN_S_PLUS_CVLAN)||
        (tag_type == _BCM_SB2_OAM_DOMAIN_MPLS_SECTION_CVLAN) ||
        (tag_type == _BCM_SB2_OAM_DOMAIN_MPLS_SECTION_S_PLUS_CVLAN)) { 
        rv = _bcm_sb2_tpid_entry_add(unit, 
    ...
    if ((ep_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT)) {
        if (ep_info_p->lm_counter_base_id != _BCM_OAM_LM_COUNTER_IDX_INVALID) {
            ...
            switch(pool){
                ...
                case 2:
                    ...
                    soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_3_IDf, 
                            (ep_info_p->lm_counter_base_id & 0xFFFF));
                    soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_3_ACTIONf, 1);
                    break;
            }
        }
        ...
        if (ep_p->flags & BCM_OAM_ENDPOINT_UP_FACING) {
            ...
            soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_1_LOCATIONf, 0); 
            soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_2_LOCATIONf, 0); 
            soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_3_LOCATIONf, 0); 
        } else {
            /* TX counter is located in EP */
            soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_1_LOCATIONf, 1); 
            soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_2_LOCATIONf, 1); 
            soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_3_LOCATIONf, 1); 
        } 
    } else {
        soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_1_ACTIONf, 0); 
        soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_2_ACTIONf, 0);
        soc_LMEP_1m_field32_set(unit, &entry_1, COUNTER_3_ACTIONf, 0);
    }
                             ...
                             bcm_oam_endpoint_info_t *ep_info_p)
{
    ...
    if (ep_p->opcode_flags & _BCM_SB2_OAM_OPCODE_MASK) {
        ...
        rv = _bcm_sb2_oam_opcode_profile_entry_set(unit, h_data_p->type, opcode_profile_mem,
                ep_p->opcode_flags,
                                    ...
                                    _bcm_oam_hash_data_t *h_data_p)
{
    ...
    if ((0 != cur_rmep_ccm_defect) || (0 != cur_rmep_last_rdi)) {
        ...
        if (BCM_FAILURE(rv)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "OAM(unit %d) Error: Group state (GID=%d) table read"
                                   " failed - %s.\n"), unit, h_data_p->ep_id, bcm_errmsg(rv)));
            return (rv);
        }
...
_bcm_sb2_oam_tpid_decrement_ref_count(int unit, _bcm_oam_hash_data_t *h_data_p)
{
    ...
    if (((tag_type == _BCM_OAM_DOMAIN_SVLAN) || 
        ...
        rv = _bcm_sb2_tpid_lkup(unit, h_data_p->outer_tpid,
                                BCM_OAM_TPID_TYPE_OUTER, &index);
        if (BCM_SUCCESS(rv)) {
            rv = _bcm_sb2_tpid_entry_delete(unit, index,
                                            BCM_OAM_TPID_TYPE_OUTER);
            if (BCM_FAILURE(rv)) {
                LOG_ERROR(BSL_LS_BCM_OAM,
                          (BSL_META_U(unit,
                                      "OAM(unit %d) Error: L3 entry config failed in TPID "
    ...
    if (((tag_type == _BCM_OAM_DOMAIN_CVLAN) || 
        ...
        /* C or S+C */
        rv = _bcm_sb2_tpid_lkup(unit, h_data_p->inner_tpid,
        ...
        /* CoE port */
        rv = _bcm_sb2_tpid_lkup(unit, h_data_p->subport_tpid,
                                ...
                                bcm_trunk_t *trunk_id)
{
    ...
    if (BCM_GPORT_IS_MPLS_PORT(ep_info_p->gport)) {
        *svp = local_id;
        rv = _bcm_esw_modid_is_local(unit, module_id, &is_local);
        if(BCM_SUCCESS(rv) && (is_local)) {
            _BCM_SB2_OAM_MOD_PORT_TO_GLP(unit, module_id, port_id, 0,
                                  ...
                                  bcm_oam_endpoint_info_t *ep_info_p)
{
     ...
     */
    if(_bcm_sb2_oam_mepid_validate(unit, ep_info_p)) {
    ...
    if((MPLS_LM_DM_ENDPOINT_TYPE(ep_info_p)) &&
       ...
       (ep_info_p->lm_pdu_ctr_field_size == bcmOamLmCounterSize64Bit)) {
        return (BCM_E_PARAM);
    }
...
_bcm_sb2_oam_olp_header_type_mapping_set(int unit) 
{
    ...
    _bcm_oam_olp_hdr_type_map_t olp_hdr_type_map[] = {
        ...
        /* BFD */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_BFD_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_BFD
        },
        ...
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
         ...
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_CCM
        },
        /* LM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_LM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_LM
        },
        /* DM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_DM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_DM
        },
        /* Other opcodes */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_OTHER_OC_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_OTHER_OC
        },

        /* BHH OAM */
        /* CCM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_BHH_CCM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_CCM
        },
        /* LM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_BHH_LM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_LM
        },
        /* DM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_BHH_DM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_DM
        },
        /* Other opcodes */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_BHH_OTHER_OC_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_BHH_OTHER_OC
        },
        ...
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
         ...
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_DLM
        },
        /* DM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_MPLS_LMDM_DM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_DM
        },
        /* DLM + DM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_MPLS_LMDM_DLM_DM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_DLM_DM
        },
        /* ILM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_MPLS_LMDM_ILM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_ILM
        },
        /* ILM + DM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_DOWNMEP_KEY_FORM(
                                _BCM_SB2_MPLS_LMDM_ILM_DM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, _BCM_SB2_OLP_HEADER_SUBTYPE_MPLS_LMDM_ILM_DM
        },

        /* SAT OLP_HDR_TYPE_COMPRESSED is set in SAT code */

        /* UP Mep Entries. UP MEPs are valid only for ETH OAM */

        /* ETH OAM */
        /* CCM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_UPMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_CCM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, 
         _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_CCM
        },
        /* LM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_UPMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_LM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, 
         _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_LM
        },
        /* DM */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_UPMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_DM_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, 
         _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_DM
        },
        /* Other opcodes */
        {_BCM_SB2_OAM_OLP_HDR_TYPE_MAP_UPMEP_KEY_FORM(
                                _BCM_SB2_ETH_OAM_OTHER_OC_OLP_HDR_TYPE_COMPRESSED),
         _BCM_SB2_OLP_HEADER_TYPE_RX, 
         _BCM_SB2_OLP_HEADER_SUBTYPE_ETH_OAM_UPMEP_OTHER_OC
        },
...
_bcm_sb2_oam_sync(int unit)
{
    ...
    if (oc->ukernel_not_ready == 0) {
        /* To store MA indicies used for BHH endpoint*/
        alloc_size += _SHR_BITDCLSIZE (oc->ma_idx_count);

        /* To store BHH endpoint group id values*/
        alloc_size += sizeof(short) * oc->bhh_endpoint_count;

        /* To store BHH endpoint VPN values*/
        alloc_size += sizeof(short) * oc->bhh_endpoint_count;
    }
#endif
    ...
    for (mdl = 0; mdl < _BCM_OAM_EP_LEVEL_COUNT; mdl++) {
        ...
        if (mdl_bitmap & (1 << mdl)) {
            ...
            if (soc_feature(unit, soc_feature_bhh) &&
                ...
                rv = READ_MA_INDEXm (unit, MEM_BLOCK_ANY,
                                     ma_base_idx + _BCM_OAM_EP_LEVEL_MAX + 1,
                                     &ma_idx_entry);
                if (BCM_FAILURE(rv)) {
                    LOG_ERROR(BSL_LS_BCM_OAM,
                              (BSL_META_U(unit,
                ...
                if (BCM_FAILURE(rv)) {
                    LOG_ERROR(BSL_LS_BCM_OAM,
                              (BSL_META_U(unit,
                              "BHH(unit %d) Error: ukernel msg failed for"
                              " EP=%d %s.\n"), unit, bhh_endpoint_index, bcm_errmsg(rv)));
                    goto cleanup;
                }
                ...
                h_data_p->active_mdl_bitmap = soc_MP_GROUPm_field32_get(unit,
                                                                    mp_group_entry,
                                                                    MDL_BITMAP_ACTIVEf);
                /* Read endpoint type for MP_GROUP entry */
                key_type = soc_MP_GROUPm_field32_get(unit,
                                                 mp_group_entry,
                                                 KEY_TYPEf);
                switch (key_type) {
                    case _BCM_SB2_OAM_DOMAIN_MPLS_SECTION:
                        h_data_p->type = bcmOAMEndpointTypeBhhSection;
                        h_data_p->sglp = soc_MP_GROUPm_field32_get(unit,
                                                         mp_group_entry, GLPf);
                        break;
                ...
                if (h_data_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) {
                    h_data_p->rx_ctr = soc_MP_GROUPm_field32_get(unit, mp_group_entry,
                                                   CTR1_BASE_PTRf);
                }
...
#endif
        {
            ...
            lmep_type = soc_MP_GROUPm_field32_get(unit, mp_group_entry, 
                                                   KEY_TYPEf);
 ...
 */
STATIC int
_bcm_sb2_oam_lmep_tx_config_recover(int unit)
{
    _bcm_gport_dest_t       gport_dest;   /* Gport specification.             */
    bcm_gport_t             gport;        /* Gport value.                     */
    ...
    for (index = 0; index < oc->lmep_count; index++) {
        ...
        if (soc_MAID_REDUCTIONm_field32_get(unit, &maid_red_ent, VALIDf)) {
            ...
            level = soc_LMEP_1m_field32_get(unit, &lmep_entry, MDLf);
                                  ...
                                  uint8 **oam_scache)
{
    ...
    rv = _bcm_sb2_oam_lmep_tx_config_recover(unit);
    if (BCM_FAILURE(rv)) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                  (BSL_META_U(unit,
...
_bcm_sb2_oam_reinit(int unit)
{
    ...
    rv = _bcm_sb2_oam_wb_endpoints_recover(unit, stable_size, &oam_scache);
    if (BCM_FAILURE(rv)) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                  (BSL_META_U(unit,
...
bcm_sb2_oam_init(int unit)
{
...
#if defined(INCLUDE_ETH_LM_DM)     
    shr_eth_lm_dm_msg_ctrl_init_t eth_msg_init;
    uint8 eth_lm_dm_ukernel_not_ready = 0;
#endif

#if defined(INCLUDE_MPLS_LM_DM)     
    shr_mpls_lm_dm_msg_ctrl_init_t mpls_lm_dm_msg_init;
#endif
 ...
 if (soc_feature(unit, soc_feature_eth_lm_dm)) {
        ...
        /* Core #2 is used for eth_lm_dm in Saber2*/
        if(SOC_E_NONE != soc_cmic_uc_msg_active_wait(unit, 2))
        {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "uKernel Not Ready, ETH_LM_DM not started\n")));
            eth_lm_dm_ukernel_not_ready = 1;
        }
#endif
    }
    ...
    oc->eth_lm_dm_sess_count = soc_property_get(unit, spn_ETH_LM_DM_NUM_SESSIONS, 128);
    ...
    if (SOC_E_NONE != soc_cmic_uc_msg_active_wait(unit, MPLS_LM_DM_UC_NUM))
    {
    ...
    rv = shr_aidxres_list_create(&(oc->ing_lm_ctr_pool[0]), 0, 
                         _BCM_SB2_MAX_OAM_LM_CTRS_POOL_0 - 1, 0, 
                         _BCM_SB2_MAX_OAM_LM_CTRS_POOL_0 - 1, 8, 
                         "ing_lm_idx pool1");
    if (BCM_FAILURE(rv)) {
        _bcm_sb2_oam_control_free(unit, oc);
        return (rv);
    ...
    rv = shr_aidxres_list_create(&(oc->ing_lm_ctr_pool[1]), 0, 
                         _BCM_SB2_MAX_OAM_LM_CTRS_POOL_1 - 1, 0,
                         _BCM_SB2_MAX_OAM_LM_CTRS_POOL_1 - 1, 8,
                         "ing_lm_idx pool2");
    if (BCM_FAILURE(rv)) {
        _bcm_sb2_oam_control_free(unit, oc);
        return (rv);
    ...
    rv = shr_aidxres_list_create(&(oc->ing_lm_ctr_pool[2]), 0, 
                         _BCM_SB2_MAX_OAM_LM_CTRS_POOL_2 - 1, 0,
                         _BCM_SB2_MAX_OAM_LM_CTRS_POOL_2 - 1, 8,
                         "ing_lm_idx pool3");
    if (BCM_FAILURE(rv)) {
        _bcm_sb2_oam_control_free(unit, oc);
        return (rv);
     ...
     */ 
    oc->eth_lm_dm_cpu_cosq = soc_property_get(unit, spn_ETH_LM_DM_COSQ, ETH_LM_DM_COSQ_INVALID);
    ...
    oc->eth_lm_dm_dmabuf_reply = soc_cm_salloc(unit, sizeof(shr_eth_lm_dm_msg_ctrl_t),
                         "ETH_LM_DM uC reply");
    ...
    /*
     * Start ETH_LM_DM application in BTE (Broadcom Task Engine) uController.
     * Determine which uController is running ETH_LM_DM by choosing the first
     * uC that returns successfully.
     */
    for (uc = 0; uc < CMICM_NUM_UCS; uc++) {
        rv = soc_cmic_uc_appl_init(unit, uc, MOS_MSG_CLASS_ETH_LM_DM,
                       _ETH_LM_DM_UC_MSG_TIMEOUT_USECS,
                       ETH_LM_DM_SDK_VERSION,
                       ETH_LM_DM_UC_MIN_VERSION, NULL, NULL);
        if (SOC_E_NONE == rv) {
            /* ETH_LM_DM started successfully */
            oc->eth_lm_dm_uc_num = uc;
            break;
        }
    }

    if (uc >= CMICM_NUM_UCS) {  /* Could not find or start ETH_LM_DM appl */
        _bcm_sb2_oam_control_free(unit, oc);
        return (BCM_E_INTERNAL);
    }
    ...
    eth_msg_init.rx_channel         = oc->eth_lm_dm_rx_channel;

     /* Pack control message data into DMA buffer */
    buffer     = oc->eth_lm_dm_dma_buffer;
    buffer_ptr = shr_eth_lm_dm_msg_ctrl_init_pack(buffer, &eth_msg_init);
    buffer_len = buffer_ptr - buffer;
    ...
    if (oc->eth_lm_dm_pm_event_thread_id == NULL) {
        if (sal_thread_create("bcmETHLMDM", SAL_THREAD_STKSZ,
    ...
    oc->eth_lm_dm_pm_event_thread_kill = 0;
    ...
    if(soc_feature(unit, soc_feature_bhh)) {
        ...
        if(ukernel_not_ready == 0){
            ...
            oc->dmabuf_reply = soc_cm_salloc(unit, sizeof(bhh_sdk_msg_ctrl_t),
                                             "BHH uC reply");
            if (!oc->dmabuf_reply) {
                _bcm_sb2_oam_control_free(unit, oc);
                return (BCM_E_MEMORY);
            }
            sal_memset(oc->dmabuf_reply, 0, sizeof(bhh_sdk_msg_ctrl_t));
    ...
    if(oc->mpls_lm_dm_ukernel_ready) {
         ...
         * between SDK Host and uController (BTE).
         */
        oc->mpls_lm_dm_dma_buffer_len = sizeof(shr_mpls_lm_dm_msg_ctrl_t);
        ...
        sal_memset(oc->mpls_lm_dm_dmabuf_reply, 0, sizeof(shr_mpls_lm_dm_msg_ctrl_t));
        ...
        rv = soc_cmic_uc_appl_init(unit, MPLS_LM_DM_UC_NUM, MOS_MSG_CLASS_MPLS_LM_DM,
                ...
                MPLS_LM_DM_UC_MIN_VERSION, NULL, NULL);
            ...
            if (SOC_E_NONE == rv) {
                ...
                LOG_ERROR(BSL_LS_BCM_OAM, (BSL_META_U(unit,
                    "OAM(unit %d) Error: MPLS LM DM init failed\n"), unit));
                _bcm_sb2_oam_control_free(unit, oc);
                return (BCM_E_INTERNAL);
            }
        ...
        buffer_ptr = shr_mpls_lm_dm_msg_ctrl_init_pack(buffer, &mpls_lm_dm_msg_init);
        buffer_len = buffer_ptr - buffer;
        ...
        if (oc->mpls_lm_dm_pm_event_thread_id == NULL) {
            if (sal_thread_create("bcmMPLSLMDM", SAL_THREAD_STKSZ,
        ...
        oc->mpls_lm_dm_pm_event_thread_kill = 0;
    }
#endif
...
bcm_sb2_oam_detach(int unit)
{
    ...
    if ( oc->eth_lm_dm_pm_event_thread_id) {
        oc->eth_lm_dm_pm_event_thread_kill = 1;
         ...
         *to free _bcm_oam_control_t below and we will loose reference to the thread*/
        timeout = sal_time_usecs() + 5000000;
        while (oc->eth_lm_dm_pm_event_thread_id != NULL) {
            if (sal_time_usecs() < timeout) {
                /*give some time to already running eth lm dm thread to schedule and exit*/
                sal_usleep(1000);
            } else {
                /*timeout*/
                LOG_ERROR(BSL_LS_BCM_OAM,
...
/* MPLS_LM_DM specific */
    ...
    if(oc->mpls_lm_dm_ukernel_ready) {
        ...
        if ( oc->mpls_lm_dm_pm_event_thread_id) {
            oc->mpls_lm_dm_pm_event_thread_kill = 1;
             ...
             *to free _bcm_oam_control_t below and we will loose reference to the thread*/
            timeout = sal_time_usecs() + 5000000;
            while (oc->mpls_lm_dm_pm_event_thread_id != NULL) {
                if (sal_time_usecs() < timeout) {
                    /*give some time to already running mpls lm dm thread to schedule and exit*/
                    sal_usleep(1000);
                } else {
                    /*timeout*/
                    LOG_ERROR(BSL_LS_BCM_OAM,
...
{
    int svp = hash_data->vp;
    egr_dvp_attribute_entry_t entry;
    
    sal_memset(&entry, 0, sizeof(entry));

    BCM_IF_ERROR_RETURN(READ_EGR_DVP_ATTRIBUTEm(unit, MEM_BLOCK_ANY, svp, &entry));
    if (BHH_EP_TYPE(hash_data)) {
    ...
    BCM_IF_ERROR_RETURN(WRITE_EGR_DVP_ATTRIBUTEm(unit, MEM_BLOCK_ANY, svp, &entry));
...
_bcm_sb2_oam_mpls_lsp_mpls_table_downmep_enable(int unit, _bcm_oam_hash_data_t *hash_data, int enable)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_tr_mpls_lock(unit));
    BCM_IF_ERROR_RETURN(WRITE_MPLS_ENTRYm(unit, MEM_BLOCK_ALL, mpls_index,
                       &mpls_entry));
    bcm_tr_mpls_unlock(unit);
...
_bcm_sb2_oam_mpls_pw_svp_table_downmep_enable(int unit, _bcm_oam_hash_data_t *hash_data, int enable)
{
    ...
    /* Store the VCCV_TYPE in hash_data for MPLS_LM_DM */
    if (MPLS_LM_DM_ENDPOINT_TYPE(hash_data)) {
        hash_data->vccv_type = vccv_type;
    }


    BCM_IF_ERROR_RETURN(bcm_tr_mpls_lock(unit));

    if(vccv_type == MPLS_LM_DM_VCCV_TYPE_4) {
...
bcm_sb2_oam_endpoint_create(int unit, bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if (MPLS_LM_DM_PW_ENDPOINT_TYPE(endpoint_info)) {
        BCM_IF_ERROR_RETURN(_bcm_sb2_oam_mpls_lmdm_pw_svp_get(unit, 
                         ...
                         bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if (h_data_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) {
        ...
        endpoint_info->lm_pdu_ctr_field_size = 
            soc_mem_field32_get(unit, mems[0], &lm_entry, LM_PDU_COUNTER_FIELD_SIZEf);
                                  ...
                                  void *profile) 
{
    ...
    opcode_group_index = _bcm_sb2_opcode_to_opcode_group_index(h_data_p,
                                                               oam_opcode);
    ...
    switch (action) {
        ...
        case bcmOAMActionFwdAsData:
            ...
            set_value = _BCM_SB2_OAM_OC_PROF_NORMAL_SWITCHING;
            break;
        ...
        case bcmOAMActionFwd:
            ...
            set_value = value;/* Passed value says it is DGLP1 or 2 */
            break;
        ...
        case bcmOAMActionProcessInHw:
            if((oam_opcode == _BCM_OAM_OPCODE_TYPE_LBM) ||
               (oam_opcode == _BCM_OAM_OPCODE_TYPE_LBR)){
                ...
                set_value = _BCM_SB2_OAM_OC_PROF_FWD_TO_HW_LB_ENGINE;
            } else if(oam_opcode == _BCM_OAM_OPCODE_TYPE_CCM) {
                fields[0] = UC_MY_STATION_HIT_ACTIONf;
                fields[1] = UC_MY_STATION_MISS_ACTIONf;
                fields[2] = MC_ACTIONf;
                num_fields = 3;
                set_value = _BCM_SB2_OAM_OC_PROF_FWD_TO_HW_ENGINE;
            }
            break;
        ...
        case bcmOAMActionDrop:
            ...
            set_value = _BCM_SB2_OAM_OC_PROF_DROP;
            break;
                ...
                if (BCM_OAM_OPCODE_GET(*action, opcode_i)) {
                    switch (action_i) {
                        case bcmOAMActionCountEnable:
                            if (MPLS_LM_DM_ENDPOINT_TYPE(h_data_p)) {
                                rv = _bcm_sb2_mpls_lmdm_ach_type_counter_enable(unit, opcode_i);
                            } else {
                                rv = _sb2_oam_counter_control_set(unit, opcode_i, 1);
                            }
                            if (BCM_FAILURE(rv)) {
                               LOG_ERROR(BSL_LS_BCM_OAM,
                                         (BSL_META_U(unit,
                        ...
                        case bcmOAMActionMCProcessInInternalOamEngine:
                            rv = _sb2_oam_opcode_control_field_set(unit, h_data_p,
                                      action_i, mem, opcode_i, 
                                      _BCM_OAM_GENERATE_LBR_IN_HW, profile); 
                            break_the_loop = 1;
                        ...
                        case bcmOAMActionSampleLmCounter:
                            ...
                            /* Fall thru */
                        case bcmOAMActionSampleTimeStamp:
                            /* value param doesnt matter for this. sending 0*/
                            rv = _sb2_oam_opcode_control_field_set(unit, h_data_p,
                                      action_i, mem, opcode_i,
                                      0, profile);
                            break;
...
STATIC int
_bcm_sb2_oam_bhh_mpls_router_alert_label_get(_mpls_label_t *mpls)
{
    return _bcm_sb2_oam_bhh_mpls_label_get(SHR_BHH_MPLS_ROUTER_ALERT_LABEL,
                                      0, 0, 0, mpls);
}
                                ...
                                int *mpls_count, bcm_if_t *l3_intf_id)
{
    ...
    if (packet_flags & _BHH_ENCAP_PKT_MPLS_ROUTER_ALERT) {
        _bcm_sb2_oam_bhh_mpls_router_alert_label_get(&mpls[count++]);
    }
    ...
    if (BCM_GPORT_IS_MPLS_PORT(h_data_p->gport)) {
        ...
        if (BCM_FAILURE
            ...
            _bcm_sb2_oam_bhh_mpls_label_get(mpls_port.egress_label.label,
    ...
    if (!BHH_EP_MPLS_SECTION_TYPE(h_data_p)) {
        ...
        if((h_data_p->type == bcmOAMEndpointTypeBhhSectionInnervlan) ||
           (h_data_p->type == bcmOAMEndpointTypeBhhSectionOuterPlusInnerVlan)){
            ...
            if (BCM_SUCCESS(bcm_esw_port_untagged_vlan_get(unit, port, &vid))) {
                if (vid == l2->vlan_tag_inner.tci.vid) {
                    l2->vlan_tag_inner.tpid = 0;  /* Set to 0 to indicate untagged */
                }
            }
        }
                                ...
                                _eth_l2_header_t *l2)
{
   ...
   if (h_data_p->inner_tpid) {
    ...
    l2->inner_vlan_tag.tci.prio = h_data_p->vlan_pri;
...
_bcm_sb2_oam_olp_l2_header_get(int unit, int cpu_dglp, soc_olp_l2_hdr_t *l2)
{
    ...
    sal_memset(&lmep_entry, 0, sizeof(lmep_entry_t));
    sal_memset(&eolp_dgpp_cfg, 0, sizeof(eolp_dgpp_cfg));
    sal_memset(&eolp_cfg, 0, sizeof(eolp_dgpp_cfg));

    index = cpu_dglp;

    /* Get MAC SA of OLP*/
    SOC_IF_ERROR_RETURN(
            rv = READ_EGR_OLP_DGPP_CONFIGm(unit, MEM_BLOCK_ANY,
                index, &eolp_dgpp_cfg));
    if (BCM_FAILURE(rv)) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                (BSL_META_U(unit,
...
#endif /* INCLUDE_ETH_LM_DM || INCLUDE_MPLS_LM_DM*/
                                ...
                                uint8 *buffer, _l2_header_t *l2)
{
    ...
    if((type == bcmOAMEndpointTypeBhhSectionInnervlan) ||
       (type == bcmOAMEndpointTypeBhhSectionOuterPlusInnerVlan)){
        /*Inner Vlan Tag */
        tmp = (l2->vlan_tag_inner.tpid << 16) | ((l2->vlan_tag_inner.tci.prio & 0x7) << 13) |
            ((l2->vlan_tag_inner.tci.cfi & 0x1) << 12) | (l2->vlan_tag_inner.tci.vid & 0xfff);
        _BHH_ENCAP_PACK_U32(buffer, tmp);
    }
 ...
 */
STATIC int
_bcm_sb2_oam_bhh_encap_build_pack(int unit, bcm_port_t port,
                             _bcm_oam_hash_data_t *h_data_p,
                             uint32 packet_flags,
                             uint8 *buffer,
                            uint32 *encap_length)
{
    ...
    if (packet_flags & _BHH_ENCAP_PKT_MPLS_ROUTER_ALERT) {
        BCM_IF_ERROR_RETURN
            (_bcm_sb2_oam_bhh_mpls_router_alert_label_get(&mpls_r_alert));
    }

    if (packet_flags & _BHH_ENCAP_PKT_MPLS) {
        etype = SHR_BHH_L2_ETYPE_MPLS_UCAST;
        BCM_IF_ERROR_RETURN
            (_bcm_sb2_oam_bhh_mpls_labels_get(unit, h_data_p,
                                             packet_flags,    
                                             _BHH_MPLS_MAX_LABELS,
                                             &pw_label,
                                             mpls_labels, 
 ...
 */
STATIC int
_bcm_sb2_oam_bhh_encap_create(int unit, bcm_port_t port_id,
                         _bcm_oam_hash_data_t *h_data_p,
                         uint8 *encap_data,
                         uint8  *encap_type,
                         uint32 *encap_length)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_sb2_oam_bhh_encap_build_pack(unit, port_id,
                                      h_data_p,
                                      packet_flags,
                                      encap_data,
                                  encap_length));
 ...
 *      int_pri         - internal priority of LM packets
 *      port_id         - (IN) Port.
 *      module_id       - (IN) Module id
 *      flags           - (IN) Input flags for creating OLP Tx header 
 *      endpoint_config - (IN/OUT) Pointer to BHH endpoint structure.
                         ...
                         uint8  mep_type)
{
    ...
    SOC_OLP_TX_PRI(&olp_tx_hdr) = (int_pri & 0xf); 
    SOC_OLP_TX_HDR_STYPE(&olp_tx_hdr) = mep_type; /* D-MEP = 0, U-MEp =1*/
    SOC_OLP_TX_PORT(&olp_tx_hdr) = (uint16)((port_id & 0xff) | ((module_id & 0xff)<<8));
    
    if (!(flags & BCM_OAM_LOSS_SLM)) { 
        SOC_OLP_TX_CTR1_LOCATION(&olp_tx_hdr) = ~mep_type; /* D-MEP(IP) = 0, U-MEP(EP) =1*/
        SOC_OLP_TX_CTR1_ID(&olp_tx_hdr) = h_data_p->tx_ctr;
        SOC_OLP_TX_CTR1_ACTION(&olp_tx_hdr) = 2;                    /* Sample the counter */
    ...
    */
    ...
    if (is_remote) {
        ...
        if (BCM_FAILURE(rv) || (reply_len != 0)) {
            LOG_ERROR(BSL_LS_BCM_OAM,
                      (BSL_META_U(unit,
                                  "BHH(unit %d) Error: Endpoint create (EP=%d) - %s.\n"),
                       unit, endpoint_info->id, bcm_errmsg(rv)));
            return (BCM_E_INTERNAL);
        }
    } else {
        ...
        if (BHH_EP_MPLS_SECTION_TYPE(hash_data)) {
            ...
            if (endpoint_info->type == bcmOAMEndpointTypeBHHMPLS) {
                ...
                if (BCM_FAILURE(rv)) {
                    LOG_ERROR(BSL_LS_BCM_OAM,
                            (BSL_META_U(unit,
                                        "OAM(unit %d) Error: SVP table update "
                                        "failed (EP=%d) - %s.\n"),
                                        unit, endpoint_info->id, 
                                        bcm_errmsg(rv)));
                    _bcm_sb2_oam_endpoint_cleanup(unit, 0, *hash_key, hash_data);
         ...
         */
        if (encap) {
            rv = _bcm_sb2_oam_bhh_encap_create(unit, 
                          port_id, 
                          hash_data,
                          msg_sess.encap_data,
                          &msg_sess.encap_type,
 ...
 */
STATIC int
_bcm_sb2_oam_bhh_fp_init(int unit)
{
    int rv = BCM_E_NONE;
    _bcm_oam_control_t   *oc;            /* OAM control structure.        */
...
_bcm_sb2_oam_bhh_hw_init(int unit)
{
    ...
    if(oc->ukernel_not_ready == 0){
        ...
        rv = _bcm_sb2_oam_bhh_fp_init(unit);
    }
...
_bcm_sb2_oam_eth_lm_dm_hw_init(int unit)
{
    ...
    /* check user configured COSq */
    if (oc->eth_lm_dm_cpu_cosq == ETH_LM_DM_COSQ_INVALID) {
        oc->eth_lm_dm_cpu_cosq = BCM_SB2_ETH_LM_DM_CPU_COS;
    }
    ...
    /*
     * Hard-coding the chan_id and cosq as suggested by uC team for 
     * Saber_2 testing of core-2 on CMC-2
     */


    chan_id = BCM_SB2_ETH_LM_DM_UC_PKT_DMA_RX_CHANNEL;

    rv = _bcm_common_rx_queue_channel_set(unit, oc->eth_lm_dm_cpu_cosq, chan_id);
    if(!BCM_SUCCESS(rv)) {
        LOG_ERROR(BSL_LS_BCM_OAM,
                (BSL_META_U(unit,
    ...
    bcm_oam_endpoint_type_t type, uint8 *buffer, _l2_header_t *l2)
{
    ...
    if((type == bcmOAMEndpointTypeMplsLmDmSectionInnervlan) ||
       (type == bcmOAMEndpointTypeMplsLmDmSectionOuterPlusInnerVlan)){
        /*Inner Vlan Tag */
        tmp = (l2->vlan_tag_inner.tpid << 16) | ((l2->vlan_tag_inner.tci.prio & 0x7) << 13) |
            ((l2->vlan_tag_inner.tci.cfi & 0x1) << 12) | (l2->vlan_tag_inner.tci.vid & 0xfff);
    ...
    if (BCM_GPORT_IS_MPLS_PORT(h_data_p->gport)) {
        ...
        if (BCM_FAILURE
            ...
            if (h_data_p->type == bcmOAMEndpointTypeMplsLmDmPw &&
                h_data_p->vccv_type == MPLS_LM_DM_VCCV_TYPE_3) {
                mpls_port.egress_label.ttl = 0x1;
            }
    ...
    uint8 *buffer, uint16 *encap_length)
{
    ...
    if (packet_flags & _MPLS_LM_DM_ENCAP_PKT_MPLS) {
...
_bcm_sb2_oam_mpls_lm_dm_encap_create(int unit,  _bcm_oam_hash_data_t *h_data_p,
     uint8 *encap_data, uint16 *encap_length, uint32 packet_flags)
{
    ...
    /* Build header/labels and pack in buffer */
    BCM_IF_ERROR_RETURN
        (_bcm_sb2_oam_mpls_lm_dm_encap_build_pack(unit, h_data_p->dglp, 
    ...
    bcm_oam_loss_t *loss_p) 
{
    ...
    shr_mpls_lm_dm_msg_ctrl_loss_add_t loss_add_msg;
    int my_mod_id = 0;
    int cpu_dglp = 0; 
    int cpu_port = 0;
    int rv = 0;
    ...
    if (h_data_p->mpls_lm_dm_int_flag & SHR_MPLS_LM_DM_FLAG_LOSS_ADDED) {
        return BCM_E_EXISTS;
    }
    ...
    /* ------------------------------------------ */
    if (h_data_p->mpls_lm_dm_uc_session_id == 0 ) {
        ...
        h_data_p->mpls_lm_dm_uc_session_id = session_id;
    } else {
        session_id = h_data_p->mpls_lm_dm_uc_session_id;
    }
    ...
    /* Create L2 Encap */
    /* --------------- */
    rv = _bcm_sb2_oam_mpls_lm_dm_encap_create(unit, h_data_p, 
    ...
    /* Set Port number */
    SOC_OLP_TX_PORT(&olp_oam_header) = h_data_p->dglp;
    ...
    SOC_OLP_TX_OAM_OFFSET(&olp_oam_header) = 
        ((loss_add_msg.l2_encap_length + 24) - 14) >> 1;
    ...
    buffer_after_pack_p = shr_mpls_lm_dm_msg_ctrl_loss_add_pack(buffer_p, 
                                                                &loss_add_msg);
    ...
    if (loss_p->flags & BCM_OAM_COMBINED_LOSS_DELAY) {
        if (h_data_p->mpls_lm_dm_int_flag & SHR_MPLS_LM_DM_FLAG_DELAY_ADDED) {
            /* Both Loss & Delay have been added */
            (loss_p->flags & BCM_OAM_LOSS_SLM ) ? 
                (h_data_p->mpls_lm_dm_int_flag |= SHR_MPLS_LM_DM_FLAG_PKT_TYPE_ILM_DM) :
                (h_data_p->mpls_lm_dm_int_flag |= SHR_MPLS_LM_DM_FLAG_PKT_TYPE_DLM_DM);
        } 
    } else {
        (loss_p->flags & BCM_OAM_LOSS_SLM ) ? 
            (h_data_p->mpls_lm_dm_int_flag |= SHR_MPLS_LM_DM_FLAG_PKT_TYPE_ILM) :
            (h_data_p->mpls_lm_dm_int_flag |= SHR_MPLS_LM_DM_FLAG_PKT_TYPE_DLM);
    }
    h_data_p->mpls_lm_dm_int_flag |= SHR_MPLS_LM_DM_FLAG_LOSS_ADDED;
    return rv;    
}
    ...
    bcm_oam_delay_t *delay_p) 
{
    ...
    soc_olp_l2_hdr_t olp_l2_header;
    soc_olp_tx_hdr_t olp_oam_header;
    shr_mpls_lm_dm_msg_ctrl_delay_add_t delay_add_msg;
    int my_mod_id = 0;
    int cpu_dglp = 0; 
    int cpu_port = 0;
    int rv = 0;
    ...
    /* Active or Passive mode */
    if (!(delay_p->flags & BCM_OAM_LOSS_TX_ENABLE)) {
     ...
     */
    SOC_OLP_TX_OAM_OFFSET(&olp_oam_header) = 
        ((delay_add_msg.l2_encap_length + 16 ) - 14) >> 1;
    ...
    /* --------------------- */
    buffer_p = oc->mpls_lm_dm_dma_buffer;
    buffer_after_pack_p = shr_mpls_lm_dm_msg_ctrl_delay_add_pack(buffer_p, 
                                                                &delay_add_msg);
    buffer_len = buffer_after_pack_p - buffer_p;
    ...
    /* Set the packet type in hash data */
    h_data_p->mpls_lm_dm_int_flag |= SHR_MPLS_LM_DM_FLAG_PKT_TYPE_DM;
    return rv;    
}
    ...
    bcm_oam_delay_t *delay_p) 
{
    ...
    delay_del_msg.sess_id = h_data_p->mpls_lm_dm_uc_session_id;
    ...
    h_data_p->mpls_lm_dm_int_flag &= ~(SHR_MPLS_LM_DM_FLAG_PKT_TYPE_DM);
    h_data_p->mpls_lm_dm_int_flag &= ~(SHR_MPLS_LM_DM_FLAG_DELAY_ADDED);

    /* Free the session Id in hash data */
    if (!(h_data_p->mpls_lm_dm_int_flag & SHR_MPLS_LM_DM_FLAG_LOSS_ADDED)) {
            shr_idxres_list_free(oc->mpls_lm_dm_pool, 
                    (shr_idxres_element_t)h_data_p->mpls_lm_dm_uc_session_id);
        h_data_p->mpls_lm_dm_uc_session_id = 0;
    }
    ...
    bcm_oam_loss_t *loss_p) 
{
    ...
    loss_del_msg.sess_id = h_data_p->mpls_lm_dm_uc_session_id;
    ...
    bcm_oam_loss_t *loss_p) 
{
    ...
    loss_get_req.sess_id = h_data_p->mpls_lm_dm_uc_session_id;
    ...
    bcm_oam_delay_t *delay_p) 
{
    ...
    shr_mpls_lm_dm_msg_ctrl_delay_data_t delay_get_rsp;
    int rv = 0;
    ...
    delay_get_req.sess_id = h_data_p->mpls_lm_dm_uc_session_id;
    ...
    /* ---------------------- */
    buffer_p = oc->mpls_lm_dm_dma_buffer;
    buffer_after_pack_p = shr_mpls_lm_dm_msg_ctrl_delay_data_unpack(buffer_p, 
                                                                &delay_get_rsp);
    buffer_len = buffer_after_pack_p - buffer_p;
...
bcm_sb2_oam_loopback_add(int unit, bcm_oam_loopback_t *loopback_p)
{
     ...
     * Set period
     */
    msg.period  = _sb2_ccm_intervals[_bcm_sb2_oam_ccm_msecs_to_hw_encode(loopback_p->period)];
...
bcm_sb2_oam_loss_add(int unit, bcm_oam_loss_t *loss_p)
{
   ...
   /* Get the Trunk, Port and Mod-id info for this G-port */
    ...
    /* Check endpoint status. */
    rv = shr_idxres_list_elem_state(oc->mep_pool, sess_id);
    if ((BCM_E_EXISTS != rv)) {
        /* Endpoint not in use. */
        LOG_ERROR(BSL_LS_BCM_OAM,
                  (BSL_META_U(unit,
    ...
    is_replace = ((h_data_p->flags & BCM_OAM_ENDPOINT_REPLACE) != 0);
   ...
   /* Set end-point type(dir) from the hash data flag*/
	...
	if((!h_data_p->eth_lm_dm_int_flag & _ETH_LM_DM_F_SESSION_IS_SET) 
         || (is_replace)) {
        ...
        BCM_IF_ERROR_RETURN(bcm_esw_stk_my_modid_get(unit, &cpu_modid));
        cpu_port = 0;
       ...
       /* Create or Update */
       session_flags = (is_replace) ? 0 : SHR_ETH_LM_DM_SESS_SET_F_CREATE;
       ...
       if (h_data_p->flags & BCM_OAM_ENDPOINT_LOSS_MEASUREMENT) {
           ...
           LOG_ERROR(BSL_LS_BCM_OAM,
                   (BSL_META_U(unit,
                               "ETH_LM_DM(unit %d) Error: loss measurement not available (EP=%d) - %s.\n"),
                    unit, loss_p->id, bcm_errmsg(rv)));
           _BCM_OAM_UNLOCK(oc);
           return (rv);
       ...
       if(BCM_FAILURE(rv)) {
        ...
        h_data_p->eth_lm_dm_int_flag |= _ETH_LM_DM_F_SESSION_IS_SET;	
	}
    ...
    h_data_p->eth_lm_dm_int_flag |=  _ETH_LM_DM_F_LM_IS_SET;                  
...
bcm_sb2_oam_loss_delete(int unit, bcm_oam_loss_t *loss_p)
{
    ...
    if ( MPLS_LM_DM_ENDPOINT_TYPE(h_data_p) ) {
        if (oc->mpls_lm_dm_ukernel_ready) {
            rv = _bcm_sb2_mpls_lm_dm_loss_delete(unit, h_data_p, loss_p);
            _BCM_OAM_UNLOCK(oc);
            return rv;
        } else {
            return BCM_E_UNAVAIL;
    ...
    if (h_data_p->type == bcmOAMEndpointTypeBHHMPLS ||
        ...
        if(!(h_data_p->eth_lm_dm_int_flag &&  _ETH_LM_DM_F_DM_IS_SET)) {
        ...
        /* Pack control message data into DMA buffer */
        buffer     = oc->eth_lm_dm_dma_buffer;
        buffer_ptr = shr_eth_lm_dm_msg_ctrl_sess_delete_pack(buffer, &msg);
        buffer_len = buffer_ptr - buffer;
   ...
   /* Get the Trunk, Port and Mod-id info for this G-port */
    ...
    if((!h_data_p->eth_lm_dm_int_flag & _ETH_LM_DM_F_SESSION_IS_SET) 
        ...
        if (h_data_p->flags & BCM_OAM_ENDPOINT_DELAY_MEASUREMENT) {
            ...
            LOG_ERROR(BSL_LS_BCM_OAM,
                    (BSL_META_U(unit,
                                "ETH_LM_DM(unit %d) Error: delay measurement not available (EP=%d) - %s.\n"),
                     unit, delay_p->id, bcm_errmsg(rv)));
            _BCM_OAM_UNLOCK(oc);
            return (rv);
    ...
    h_data_p->eth_lm_dm_int_flag |=  _ETH_LM_DM_F_DM_IS_SET;
...
bcm_sb2_oam_delay_delete(int unit, bcm_oam_delay_t *delay_p)
{
    ...
    if (h_data_p->type == bcmOAMEndpointTypeBHHMPLS ||
        ...
        if(!(h_data_p->eth_lm_dm_int_flag &&  _ETH_LM_DM_F_LM_IS_SET)) {
        shr_eth_lm_dm_msg_ctrl_sess_delete_t msg;
...
{
    if (!(sal_memcmp(profile_info1, profile_info2,
                              ...
                              bcm_oam_pm_profile_t profile_id)
{
    ...
    if (h_data_p->type == bcmOAMEndpointTypeEthernet) {
        ...
        msg_profile_attach.sess_id = endpoint_id;
    } else if (BHH_EP_TYPE(h_data_p)) {
        msg_class = MOS_MSG_CLASS_BHH;
                                             ...
                                             bcm_oam_pm_stats_t *stats_ptr)
{
    ...
    stats_ptr->DM_avg = stats_msg->DM_avg;       
                            ...
                            bcm_oam_endpoint_t endpoint_id, bcm_oam_pm_stats_t *stats_ptr)
{
    ...
    int rv = BCM_E_NONE;
    bcm_oam_pm_profile_t profile_id = -1;
    uint16 sess_id = 0;
    uint8                    msg_class = 0;
    uint16                   reply_len = 0;
    uint8                    msg_subclass = 0;
    ...
    _bcm_sb2_oam_copy_stats_msg_to_stats_ptr(&stats_msg, stats_ptr);
                                             ...
                                             mos_msg_data_t *event_msg)
{
    ...
    _bcm_oam_pm_event_handler_t *event_handler_p;
    ...
    /* Loop over registered callbacks
     */
    for (event_handler_p = oc->pm_event_handler_list_p;
            event_handler_p != NULL;
            event_handler_p = event_handler_p->next_p) {
        if (SHR_BITGET(event_handler_p->event_types.w,
                    event_type)) {
            ...
            is_updated = _bcm_sb2_update_dma_buffer_into_raw_buffer(
                    oc->unit, event_type, dma_buffer, raw_data);
            if (is_updated) {
                event_handler_p->cb(oc->unit, 
                        event_type, 
                                        ...
                                        bcm_oam_event_type_t event_type)
{
    ...
    int          *pm_event_thread_kill = NULL;
    int          uc_num = -1;
    uint8        msg_class = 0;
  

    if (_BCM_SB2_ETH_LM_DM_OAM_PM_EVENT_TYPE(event_type)) {
        pm_event_thread_id = &(oc->eth_lm_dm_pm_event_thread_id);
        pm_event_thread_kill = &(oc->eth_lm_dm_pm_event_thread_kill);
#if defined (INCLUDE_ETH_LM_DM)
        uc_num = oc->eth_lm_dm_uc_num;
#endif
        msg_class = MOS_MSG_CLASS_ETH_LM_DM_EVENT;
    } else if (_BCM_SB2_MPLS_LM_DM_OAM_PM_EVENT_TYPE(event_type)) {
        pm_event_thread_id = &(oc->mpls_lm_dm_pm_event_thread_id);
        pm_event_thread_kill = &(oc->mpls_lm_dm_pm_event_thread_kill);
#if defined (INCLUDE_MPLS_LM_DM)
        uc_num = oc->mpls_lm_dm_uc_num;
#endif
    ...
    *pm_event_thread_id   = sal_thread_self();
    *pm_event_thread_kill = 0;
    ...
    while (1) {
        ...
        if (BCM_FAILURE(rv) || (*pm_event_thread_kill)) {
            break;  /*  Thread exit */
        } else {
...
_bcm_sb2_oam_pm_ethlmdm_callback_thread(void *param)
{
    ...
    _bcm_oam_pm_callback_thread_func(oc, bcmOAMEventEthLmDmRawData);
}
#endif
#if defined (INCLUDE_MPLS_LM_DM)
STATIC void
_bcm_sb2_oam_pm_mplslmdm_callback_thread(void *param)
{
    ...
    _bcm_oam_pm_callback_thread_func(oc, bcmOAMEventMplsLmDmRawData);
}
#endif
