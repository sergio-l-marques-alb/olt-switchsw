...
int rv;
verbose = 2; 
rv = ipv6_tunnel_term_example(0,<in_port>,<out_port>);
...
int ipv6_tunnel_term_example(int unit, int in_port, int out_port){
	...
	rv = ipv6_tunnel_term_build_tunnel_terms(unit,in_port,out_port,eg_intf_ids,in_tunnel_gports); 
	if (rv != BCM_E_NONE) {
...
int ipv6_tunnel_term_build_tunnel_terms(int unit, int in_port, int out_port,bcm_if_t *eg_intf_ids, bcm_gport_t *in_tunnel_gports){
    int rv;
    ...
    dip1[15]= 0x88;    dip1[14]= 0x88;    dip1[13]= 0x88;    dip1[12]= 0x88;
    dip1[11]= 0x77;    dip1[10]= 0x77;    dip1[9] = 0x77;    dip1[8] = 0x77;
    dip1[7] = 0x66;    dip1[6] = 0x66;    dip1[5] = 0x66;    dip1[4] = 0x66;
    dip1[3] = 0x55;    dip1[2] = 0x55;    dip1[1] = 0x55;    dip1[0] = 0x35;

    dip_mask1[15]= 0xFF;    dip_mask1[14]= 0xFF;    dip_mask1[13]= 0xFF;    dip_mask1[12]= 0xFF;
    dip_mask1[11]= 0xFF;    dip_mask1[10]= 0xFF;    dip_mask1[9] = 0xFF;    dip_mask1[8] = 0xFF;
    dip_mask1[7] = 0xFF;    dip_mask1[6] = 0xFF;    dip_mask1[5] = 0xFF;    dip_mask1[4] = 0xFF;
    dip_mask1[3] = 0xFF;    dip_mask1[2] = 0xFF;    dip_mask1[1] = 0xFF;    dip_mask1[0] = 0xFF;
    ...
    dip_mask2[15]= 0xFF;    dip_mask2[14]= 0xFF;    dip_mask2[13]= 0xFF;    dip_mask2[12]= 0xFF;
    dip_mask2[11]= 0xFF;    dip_mask2[10]= 0xFF;    dip_mask2[9] = 0xFF;    dip_mask2[8] = 0xFF;
    dip_mask2[7] = 0xFF;    dip_mask2[6] = 0xFF;    dip_mask2[5] = 0xFF;    dip_mask2[4] = 0xFF;
    dip_mask2[3] = 0xFF;    dip_mask2[2] = 0xFF;    dip_mask2[1] = 0xFF;    dip_mask2[0] = 0xFF;
    ...
    /* key is DIP6 */
    sal_memcpy(tunnel_term_1.dip6, dip1, 16);
    sal_memcpy(tunnel_term_1.dip6_mask, dip_mask1, 16);
    tunnel_term_1.tunnel_if = tunnel_rif;
    tunnel_term_1.type = bcmTunnelTypeIpAnyIn6; /* this is IPv4 termination */
    ...
    /* key is DIP6 */
    sal_memcpy(tunnel_term_2.dip6, dip2, 16);
    sal_memcpy(tunnel_term_2.dip6_mask, dip_mask2, 16);
    tunnel_term_2.tunnel_if = -1; /* means don't overwite RIF */
    tunnel_term_2.type = bcmTunnelTypeIpAnyIn6;/* this is IPv4 termination */
