...
route_over_ac_s g_route_over_ac = {   /*               host MAC                 | host ipv4 address |  gport  |   vlan_o | vlan_i  |  edit profile  |  fec |outLiF | encap_id  */  
                                        { { {0x00, 0x00, 0x11, 0x11, 0x11, 0x11},    0x11111111     ,    -1   ,     10   ,  100    ,        10      ,   -1  , -1    ,    0},                                                                                                                                                           
                                          { {0x00, 0x00, 0x22, 0x22, 0x22, 0x22},    0x22222222     ,    -1   ,     20   ,    0    ,        11      ,   -1  , -1    ,    0},                                                                                                                                                           
                                          { {0x00, 0x00, 0x33, 0x33, 0x33, 0x33},    0x33333333     ,    -1   ,     30   ,  300    ,        10      ,   -1  , -1    ,    0}},
