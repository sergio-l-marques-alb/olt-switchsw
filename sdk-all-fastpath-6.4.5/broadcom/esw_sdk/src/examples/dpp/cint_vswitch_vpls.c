...
vswitch_vpls_run(int unit, int second_unit, int extend_example){
    ...
    if (second_unit >= 0)
    {
        rv = mpls_port__vswitch_vpls_vpn_create__set_(second_unit, vswitch_vpls_info_1.vpn_id);
        if (rv != BCM_E_NONE) {
            printf("Error, in mpls_port__vswitch_vpls_vpn_create__set\n");
            return rv;
        }
    ...
    if (is_device_or_above(unit,JERICHO) && encap_optimized) {
            ...
            bshell (0, "mod IRR_MCDB_EGRESS_FORMAT_1 84027 1 PP_DSP_1B=0xff PP_DSP_1A=0xca OUTLIF_1=0x3e001 LINK_PTR=85027 ENTRY_FORMAT=0");
            bshell (0, "mod IRR_MCDB_EGRESS_FORMAT_1 85027 1 PP_DSP_1B=0xff PP_DSP_1A=0xc8 OUTLIF_1=0x3e000 LINK_PTR=86027 ENTRY_FORMAT=0");
            bshell (0, "mod IRR_MCDB_EGRESS_FORMAT_2 86027 1 OUTLIF_1=258048 NEW_FORMAT=2 LINK_PTR=0x3fffa ENTRY_FORMAT=1 BMP_PTR=1");
            bshell (0, "mod IRR_MCDB_EGRESS_FORMAT_1 0x3fffa 1 PP_DSP_1B=0xff PP_DSP_1A=0xc8 OUTLIF_1=0x5000 LINK_PTR=0x3fffb ENTRY_FORMAT=0");
            bshell (0, "mod IRR_MCDB_EGRESS_FORMAT_1 0x3fffb 1 PP_DSP_1B=0xff PP_DSP_1A=0xca OUTLIF_1=0x5002 LINK_PTR=0 ENTRY_FORMAT=0");
    }
...
/* create VPN */
int
mpls_port__vswitch_vpls_vpn_create__set_(int unit, bcm_vpn_t vpn){
    bcm_mpls_vpn_config_t vpn_info;
