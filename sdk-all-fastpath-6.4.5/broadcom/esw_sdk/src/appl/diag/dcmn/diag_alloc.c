...
/*---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    {  "Ingress LIF bank allocation"          , "InLif"         , "IL"     , dpp_am_res_obs_inlif                      , 1                        , NULL                              , cmd_diag_alloc_hw_lif_get_block   },
    {  "Egress encapsulation bank allocation" , "OutLif"        , "OL"     , dpp_am_res_obs_eg_encap                   , 1                        , NULL                              , NULL                              },
