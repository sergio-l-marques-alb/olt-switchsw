...
sbZfC2PpRxPortDataEntry_Print(sbZfC2PpRxPortDataEntry_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortDataEntry:: mask1=0x%07x"), (unsigned int)  pFromStruct->m_uMask1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("C2PpRxPortDataEntry:: data0=0x%08x"), (unsigned int)  pFromStruct->m_uData0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
char *
sbZfC2PpRxPortDataEntry_SPrint(sbZfC2PpRxPortDataEntry_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  uint32 WrCnt = 0x0;
