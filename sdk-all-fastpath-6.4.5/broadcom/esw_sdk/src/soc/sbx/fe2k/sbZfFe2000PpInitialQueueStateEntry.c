/*
 * $Id: sbZfFe2000PpInitialQueueStateEntry.c,v 1.4 Broadcom SDK $
...
sbZfFe2000PpInitialQueueStateEntry_Pack(sbZfFe2000PpInitialQueueStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FE2000PPINITIALQUEUESTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FE2000PPINITIALQUEUESTATEENTRY_SIZE_IN_BYTES;
}
