/* $Id: pb_api_action_cmd.c,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_TM/src/soc_pb_api_action_cmd.c
*
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_ACTION_CMD_SNOOP_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_action_cmd_snoop_set_verify(
          unit,
          action_ndx,
          info
        );
  ...
  res = soc_pb_action_cmd_snoop_set_unsafe(
          unit,
          action_ndx,
          info
        );
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_action_cmd_snoop_set()", action_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_ACTION_CMD_SNOOP_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_action_cmd_snoop_get_verify(
          unit,
          action_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_action_cmd_snoop_get_unsafe(
          unit,
          action_ndx,
          info
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_action_cmd_snoop_get()", action_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_ACTION_CMD_MIRROR_SET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_action_cmd_mirror_set_verify(
          unit,
          action_ndx,
          info
        );
  ...
  res = soc_pb_action_cmd_mirror_set_unsafe(
          unit,
          action_ndx,
          info
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_action_cmd_mirror_set()", action_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(SOC_PB_ACTION_CMD_MIRROR_GET);

  SOC_SAND_CHECK_DRIVER_AND_DEVICE;

  SOC_SAND_CHECK_NULL_INPUT(info);

  res = soc_pb_action_cmd_mirror_get_verify(
          unit,
          action_ndx
        );
  SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
  ...
  res = soc_pb_action_cmd_mirror_get_unsafe(
          unit,
          action_ndx,
          info
        );
...
exit_semaphore:
  ...
  SOC_PB_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_pb_action_cmd_mirror_get()", action_ndx, 0);
}
...
void
  SOC_PB_ACTION_CMD_SNOOP_INFO_clear(
    SOC_SAND_OUT SOC_PB_ACTION_CMD_SNOOP_MIRROR_INFO *info
  )
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(0);
  SOC_SAND_CHECK_NULL_INPUT(info);
