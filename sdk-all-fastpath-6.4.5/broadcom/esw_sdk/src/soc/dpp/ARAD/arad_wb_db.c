...
#define ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_NOF_CALCAL_INSTANCES  \
...
#define ARAD_WB_DB_EGR_PORT_NOF_CALCAL_INSTANCES_NUM         \
    (SOC_DPP_DEFS_MAX(NOF_CORES) * SOC_DPP_DEFS_MAX(NOF_CHANNELIZED_CALENDARS))
...
typedef struct arad_wb_db_egr_port_priority_shaper_config_s {
    ARAD_SW_DB_DEV_EGR_SCH_PORT_PRIORITY_SHAPER priority_shaper;
}  __ATTRIBUTE_PACKED__ arad_wb_db_egr_port_priority_shaper_config_t;

typedef struct arad_wb_db_egr_port_tcg_shaper_config_s { 
    ARAD_SW_DB_DEV_EGR_SCH_TCG_SHAPER tcg_shaper;
}  __ATTRIBUTE_PACKED__ arad_wb_db_egr_port_tcg_shaper_config_t;

typedef struct arad_wb_db_egr_port_nof_calcal_instances_config_s {
    ARAD_SW_DB_DEV_EGR_CHAN_ARB     nof_calcal_instances;
...
STATIC uint32
_arad_wb_db_egr_port_restore_priority_rates_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_PRIORITY_RATES_STATE,
                                     egr_port, 
                                     priority_shaper,
                                     arad_sw_db_egr_ports.port_priority[arr_indx1][arr_indx2],
                                     ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_RATES);
}

STATIC uint32
_arad_wb_db_egr_port_restore_tcg_shaper_rates_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_TCG_SHAPER_RATES_STATE,
                                     egr_port, 
                                     tcg_shaper,
                                     arad_sw_db_egr_ports.tcg_shaper[arr_indx1][arr_indx2],
                                     ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_RATES);
}
...
_arad_wb_db_egr_port_restore_nof_calcal_instances_state(SOC_SAND_IN int unit)
{
    ARAD_WB_DB_RESTORE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_NOF_CALCAL_INSTANCES_STATE,
                                 egr_port, 
                                 nof_calcal_instances,
                                 arad_sw_db_egr_ports.chan_arb[arr_indx1][arr_indx2],
                                 ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_NOF_CALCAL_INSTANCES);
}
...
{
    ARAD_WB_DB_RESTORE_ARR_STATE(ARAD_WB_DB_EGR_PORT_RESTORE_ERP_INTERFACE_STATE,
                                 egr_port, 
                                 erp_interface,
                                 arad_sw_db_egr_ports.erp_interface_id[arr_indx]);
}
...
_arad_wb_db_restore_state(SOC_SAND_IN int unit)
{
    ...
    res = _arad_wb_db_egr_port_restore_priority_rates_state(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);

    res = _arad_wb_db_egr_port_restore_tcg_shaper_rates_state(unit);
    ...
    res = sw_state_access[unit].dpp.bcm._switch.interrupts_event_storm_nominal.get(unit, &value);
...
STATIC uint32
_arad_wb_db_egr_port_priority_save_rates_state(SOC_SAND_IN int unit) 
{
    ARAD_WB_DB_SAVE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_SAVE_PRIORITY_RATES_STATE,
                                    egr_port, 
                                    priority_shaper,
                                    arad_sw_db_egr_ports.port_priority[arr_indx1][arr_indx2],
                                    ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_RATES);
...
STATIC uint32
_arad_wb_db_egr_port_tcg_shaper_save_rates_state(SOC_SAND_IN int unit) 
{
    ARAD_WB_DB_SAVE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_SAVE_TCG_SHAPER_RATES_STATE,
                                    egr_port, 
                                    tcg_shaper,
                                    arad_sw_db_egr_ports.tcg_shaper[arr_indx1][arr_indx2],
                                    ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_RATES);
...
{
    ARAD_WB_DB_SAVE_ARR_STATE(ARAD_WB_DB_EGR_PORT_SAVE_ERP_INTERFACE_STATE,
                              egr_port, 
                              erp_interface, 
                              arad_sw_db_egr_ports.erp_interface_id[arr_indx]);
}
...
arad_wb_db_sync(SOC_SAND_IN int unit)
{
    ...
    res = _arad_wb_db_egr_port_priority_save_rates_state(unit);
    SOC_SAND_CHECK_FUNC_RESULT(res, 40, exit);

    res = _arad_wb_db_egr_port_tcg_shaper_save_rates_state(unit);
                ...
                SOC_SAND_IN ARAD_SW_DB_DEVICE *arad_sw_db)
{
    ...
    if (SOC_WARM_BOOT(unit)) {
        ...
        size = 0;
        rv = soc_dpp_scache_ptr_get(unit, wb_handle, socDppScacheRetrieve, fegr_ports,
...
uint32
arad_wb_db_egr_port_priority_update_rates_state(SOC_SAND_IN int unit, 
                                       SOC_SAND_IN uint32 arr_indx1, 
                                       SOC_SAND_IN uint32 arr_indx2)
{
    ARAD_WB_DB_UPDATE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_PRIORITY_RATES_STATE,
                                    egr_port, 
                                    priority_shaper,
                                    arad_sw_db_egr_ports.port_priority[arr_indx1][arr_indx2],
                                    ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_RATES,
...
uint32
arad_wb_db_egr_tcg_shaper_update_rates_state(SOC_SAND_IN int unit, 
                                       SOC_SAND_IN uint32 arr_indx1, 
                                       SOC_SAND_IN uint32 arr_indx2) 
{
    ARAD_WB_DB_UPDATE_DBL_ARR_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_TCG_SHAPER_RATES_STATE,
                                    egr_port, 
                                    tcg_shaper,
                                    arad_sw_db_egr_ports.tcg_shaper[arr_indx1][arr_indx2],
                                    ARAD_WB_DB_EGR_PORT_DBL_ARR_INER_SIZE_RATES,
...
arad_wb_db_egr_port_update_erp_interface_state(SOC_SAND_IN int unit,
                                               SOC_SAND_IN uint32 arr_indx)
{
    ARAD_WB_DB_UPDATE_ARR_STATE(ARAD_WB_DB_EGR_PORT_UPDATE_ERP_INTERFACE_STATE,
                                egr_port, 
                                erp_interface,
                                arad_sw_db_egr_ports.erp_interface_id[arr_indx],
                                arr_indx);
