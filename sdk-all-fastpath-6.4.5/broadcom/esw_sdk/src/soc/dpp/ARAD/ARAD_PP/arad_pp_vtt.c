...
void arad_pp_dbal_sw_db_mpls_eli_indexed_sem_property_set        (int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 not_in_use   );
...
{
/*
   valid   |    Name                            |             Global sw db enum                          |      Pointer to 'vtt_table_property_set' function            |           Memory Type               | Additional
   bitmask |                                    |                                                        |                                                              |                                     |    Info     */
    ...
    { 0, "VTT INITIAL VID TCAM"                 , SOC_DPP_DBAL_SW_TABLE_ID_INITIAL_VID_TCAM              , arad_pp_dbal_sw_db_vid_tcam_property_set                     , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , 0                                                        , INITIAL_VID           }, /* initial vlan id (dummy)*/
    { 0, "VTT OUTER VID TCAM"                   , SOC_DPP_DBAL_SW_TABLE_ID_OUTER_VID_TCAM                , arad_pp_dbal_sw_db_vid_tcam_property_set                     , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , 0                                                        , OUTER_VID             }, /* initial vlan id  (dummy)*/
...
/* MPLS DB's finish */
    ...
    { 0, "VTT TRILL INGRESS NICKNAME SEM A"     , SOC_DPP_DBAL_SW_TABLE_ID_TRILL_TCAM                    , arad_pp_dbal_sw_db_trill_tcam_property_set                   , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , 0                                                        , 0                     },
    ...
    { 0, "VTT DIP SIP INITIAL VID TCAM"         , SOC_DPP_DBAL_SW_TABLE_ID_DIP_SIP_INITIAL_VID_TCAM      , arad_pp_dbal_sw_db_dip_sip_tcam_property_set                 , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , 0                                                        , INITIAL_VID           },
    { 0, "VTT DIP SIP OUTER VID TCAM"           , SOC_DPP_DBAL_SW_TABLE_ID_DIP_SIP_OUTER_VID_TCAM        , arad_pp_dbal_sw_db_dip_sip_tcam_property_set                 , SOC_DPP_DBAL_PHYSICAL_DB_TYPE_TCAM  , 0                                                        , OUTER_VID             },
 ...
 *   |                                                          |                                                                     |  Program */
    {ARAD_PP_DBAL_VT_PROG_TM                                    , arad_pp_dbal_vt_program_tm_property_set                             , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1                   , arad_pp_dbal_vt_program_vdxinitialvid_property_set                  , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1                     , arad_pp_dbal_vt_program_vdxoutervid_property_set                    , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_L1              , arad_pp_dbal_vt_program_vdxouter_inner_vid_property_set             , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_OR_OUTER_VID_L1 , arad_pp_dbal_vt_program_vdxouter_inner_vid_or_outervid_property_set , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_TRILL                , arad_pp_dbal_vt_program_vdxinitialvid_trill_property_set            , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_TRILL                  , arad_pp_dbal_vt_program_vdxoutervid_trill_property_set              , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_TRILL           , arad_pp_dbal_vt_program_vdxouter_inner_vid_trill_property_set       , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VD_DESIGNATED_VID_TRILL            , arad_pp_dbal_vt_program_vd_designated_vid_trill_property_set        , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1_L2ELI             , arad_pp_dbal_vt_program_vdxinitialvid_l1_l2eli_property_set         , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1_L2ELI               , arad_pp_dbal_vt_program_vdxoutervid_l1_l2eli_property_set           , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1L2                 , arad_pp_dbal_vt_program_vdxinitialvid_l1l2_property_set             , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1L2                   , arad_pp_dbal_vt_program_vdxoutervid_l1l2_property_set               , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L1           , arad_pp_dbal_vt_program_indexed_vdxinitialvid_property_set          , {-1}    , MPLS_LABEL_0 },
    {ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L1             , arad_pp_dbal_vt_program_indexed_vdxoutervid_property_set            , {-1}    , MPLS_LABEL_0 },
    {ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L3           , arad_pp_dbal_vt_program_indexed_vdxinitialvid_property_set          , {-1}    , MPLS_LABEL_2 },
    {ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L3             , arad_pp_dbal_vt_program_indexed_vdxoutervid_property_set            , {-1}    , MPLS_LABEL_2 },
    {ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID                 , arad_pp_dbal_vt_program_ipv4_vdxinitial_property_set                , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID                   , arad_pp_dbal_vt_program_ipv4_vdxouter_property_set                  , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID_AFTER_RCY       , arad_pp_dbal_vt_program_ipv4_vdxinitial_recycle_property_set        , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID_AFTER_RCY         , arad_pp_dbal_vt_program_ipv4_vdxouter_recycle_property_set          , {-1}    , 0            },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_1_TST2             , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set           , {-1}    , TPID1        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_2_TST2             , arad_pp_dbal_vt_program_outer_inner_pcp_tst2_property_set           , {-1}    , TPID2        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_1_TST2                   , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                 , {-1}    , TPID1        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_2_TST2                   , arad_pp_dbal_vt_program_outer_pcp_tst2_property_set                 , {-1}    , TPID2        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_1_TST2                 , arad_pp_dbal_vt_program_outer_inner_tst2_property_set               , {-1}    , TPID1        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_2_TST2                 , arad_pp_dbal_vt_program_outer_inner_tst2_property_set               , {-1}    , TPID2        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_1_TST2                       , arad_pp_dbal_vt_program_outer_tst2_property_set                     , {-1}    , TPID1        },
    {ARAD_PP_DBAL_VT_PROG_VT_OUTER_2_TST2                       , arad_pp_dbal_vt_program_outer_tst2_property_set                     , {-1}    , TPID2        },
    {ARAD_PP_DBAL_VT_PROG_VT_UNTAGGED_TST2                      , arad_pp_dbal_vt_program_untagged_tst2_property_set                  , {-1}    , 0            }
};
...
uint32 arad_pp_dbal_vt_program_init(int unit)
{
    ...
    if(g_prog_soc_prop[unit].custom_feature_vt_tst2)
    {
        ...
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_1_TST2].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_2_TST2].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_1_TST2      ].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_2_TST2      ].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_1_TST2    ].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_2_TST2    ].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_1_TST2          ].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_OUTER_2_TST2          ].prog_used[unit] = last_dbal_vt_program_id++;
        vt_dbal_programs[ARAD_PP_DBAL_VT_PROG_VT_UNTAGGED_TST2         ].prog_used[unit] = last_dbal_vt_program_id++;
    }
...
uint32 arad_pp_dbal_vtt_cam_init(int unit)
{
    ...
    if(g_prog_soc_prop[unit].custom_feature_vt_tst2)
    {
        ...
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_PCP_1_TST2].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_1_TST2;
        priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_PCP_2_TST2].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_PCP_2_TST2].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_PCP_2_TST2;
        priority++;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_PCP_1_TST2      ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_PCP_1_TST2      ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_1_TST2;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_PCP_2_TST2      ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_PCP_2_TST2      ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_PCP_2_TST2;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_1_TST2    ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_1_TST2    ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_1_TST2;
        priority++;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_2_TST2    ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_INNER_2_TST2    ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_INNER_2_TST2;
        priority++;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_1_TST2          ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_1_TST2          ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_1_TST2;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_2_TST2          ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_OUTER_2_TST2          ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_OUTER_2_TST2;

        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_UNTAGGED_TST2         ].priority[unit]  = priority++;
        vt_dbal_program_selection[ARAD_PP_DBAL_VT_PROG_SELECTION_UNTAGGED_TST2         ].prog_name[unit] = ARAD_PP_DBAL_VT_PROG_VT_UNTAGGED_TST2;
    }
...
void arad_pp_dbal_sw_db_dip_sip_tcam_property_set(int unit, ARAD_PP_DBAL_VTT_SW_DB_PROPERTY* sw_db_property, uint32 vid_type)
{
    ...
    /*sw_db_property->prefix = ARAD_PP_ISEM_ACCESS_TCAM_IPV4_TT_ETH_DB_PROFILE;*/
}
            ...
            for(j=0; j < program_property.nof_keys; j++)
            {
                ...
                if(!(vtt_tables[sw_db_index].valid_bitmask & (1 << unit)))
                {
                    ...
                    res = arad_pp_dbal_table_create(unit, vtt_tables[sw_db_index].dbal_sw_db_id,
                                                          ...
                                                          ARAD_PP_ISEM_ACCESS_NOF_BITS_PREFIX,
...
void arad_pp_dbal_vt_program_ipv4_vdxinitial_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->tcam_profile        = (g_prog_soc_prop[unit].ipv4_term_dip_sip_enable) ? ARAD_PP_ISEM_ACCESS_TCAM_IPV4_TT_ETH_DB_PROFILE : ARAD_TCAM_ACCESS_PROFILE_INVALID;
                                               ...
                                               SOC_DPP_DBAL_SW_TABLE_IDS  dbal_tables_id[3])
{
    ...
    *nof_tables = 0;
    ...
    if( dbal_tables_id[0]  != SOC_DPP_DBAL_SW_TABLE_ID_INVALID)
    {
         ...
         {
              if(tables_mem[i] != ARAD_PP_ISEM_ACCESS_ID_TCAM)
                  dbal_tables_id[i] += tables_mem[i];
