...
#define ARAD_PP_EG_ENCAP_EEP_TYPE_NDX_MAX                        (ARAD_PP_NOF_EG_ENCAP_EEP_TYPES-1)
#define ARAD_PP_EG_ENCAP_DEPTH_MAX                               (ARAD_PP_NOF_EG_ENCAP_EEP_TYPES-1)
#define ARAD_PP_EG_ENCAP_PROFILE_NDX_MAX                         (7)
...
#define ARAD_PP_EG_ENCAP_PUSH_PROFILE_MAX                        (7)
...
#define ARAD_PP_EG_ENCAP_EXP_MARK_MODE_MAX                       (ARAD_PP_NOF_EG_ENCAP_EXP_MARK_MODES-1)
#define ARAD_PP_EG_ENCAP_CW_MAX                                  (SOC_SAND_U32_MAX)
#define ARAD_PP_EG_ENCAP_ENTRY_TYPE_MAX                          (ARAD_PP_NOF_EG_ENCAP_ENTRY_TYPES-1)
#define ARAD_PP_EG_ENCAP_ACCESS_PHASE_MAX                        (ARAD_PP_NOF_EG_ENCAP_ACCESS_PHASE_TYPES-1)
...
#define ARAD_PP_EG_ENCAP_UPDATE_FIELD_DROP(entry, flags, val)   \
    if(flags & ARAD_PP_EG_ENCAP_ENTRY_UPDATE_DROP) {            \
        entry.drop = val;                                       \
    }
...
#define ARAD_PP_EG_ENCAP_GET_FIELD_NEXT_LIF(entry, flags, val)   \
    if(flags & ARAD_PP_EG_ENCAP_ENTRY_UPDATE_NEXT_LIF) {            \
...
#define ARAD_PP_EG_ENCAP_PRGE_MEM_ERSPAN_FORMAT_SET(__device_id, __prio, __trunc, __span_id, __data) \
    (__data)[1] = (ARAD_PP_EG_ENCAP_ERSPAN_VERSION << 28); \
     (__data)[0] = (((__prio << 13)) | ((__trunc) << 10) | (__span_id) );

#define ARAD_PP_EG_ENCAP_PRGE_MEM_ERSPAN_FORMAT_SPAN_ID_GET(__span_id, __data) \
    (__span_id) = (((__data)[0]) & 0x3ff); 
...
typedef enum {
  ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_NONE = 0,
  /*
   * Ether IP and VXLAN encapsulation 
   */
  ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_ETHER_IP = 1,

  #ifdef BCM_88660_A0     
  /*
   * VxLan encapsulation for arad+. It's the same value than EoIP.
   */
  ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_VXLAN = 1,
  #endif

  /*
   * Basic GRE (4B) encapsulation
   */
      ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_BASIC_GRE = 2,
  /*
   *  Inhance GRE (8B) encapsulation
   */
  ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_ENHANCE_GRE = 3
} ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD; 
  ...
  Arad_pp_procedure_desc_element_eg_encap[] =
{
   ...
   */
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_SET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_GET_PRINT),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_RANGE_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_ENTRY_TYPE_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_ENTRY_TYPE_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_ENTRY_TYPE_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_GET_UNSAFE),
  ...
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_GET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_GLBL_INFO_SET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_GLBL_INFO_SET_UNSAFE),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_GLBL_INFO_SET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_GLBL_INFO_GET),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_GLBL_INFO_GET_VERIFY),
  SOC_PROCEDURE_DESC_ELEMENT_DEF(ARAD_PP_EG_ENCAP_GLBL_INFO_GET_UNSAFE),
  ...
  Arad_pp_error_desc_element_eg_encap[] =
{
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_ENCAP_EEP_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_ENCAP_EXP_MARK_MODES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
  ...
  },
  {
    ...
    "The range is: 0 - ARAD_PP_NOF_EG_ENCAP_ENTRY_TYPES-1.\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  /*
...

  {
    ...
    "as configured using arad_pp_eg_encap_range_info_set().\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
    ...
    "to 12K-1, as configured using arad_pp_eg_encap_range_info_set().\n\r ",
    SOC_SAND_SVR_ERR,
    FALSE
  },
  {
...
/* convert logical encapsulation mode (in struct ARAD_PP_EG_ENCAP_IPV4_ENCAP_INFO) to encapsulation mode hw (in struct ARAD_PP_EG_ENCAP_ACCESS_IP_TUNNEL_ENTRY_FORMAT) */
STATIC uint32 SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_TO_ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD( int unit, 
    ...
    case (SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_NONE) :
        *encapsulation_mode_hw = ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_NONE;
    break;
    case (SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_ETHER_IP) :
        *encapsulation_mode_hw = ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_ETHER_IP;
    break;
    case (SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_BASIC_GRE) :
        *encapsulation_mode_hw = ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_BASIC_GRE;
    break;
    case (SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_ENHANCE_GRE) :
        *encapsulation_mode_hw = ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_ENHANCE_GRE;
    break;
    case (SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_VXLAN) : 
        *encapsulation_mode_hw = ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_VXLAN;
    break;
    default: 
        /* unsupported type */
        res = SOC_SAND_ERR;
...
/* convert encapsulation mode hw (in struct: ARAD_PP_EG_ENCAP_ACCESS_IP_TUNNEL_ENTRY_FORMAT) to logical encapsulation mode (in struct ARAD_PP_EG_ENCAP_IPV4_ENCAP_INFO) */
STATIC uint32 
SOC_PPC_EG_ENCAP_ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_TO_ENCAPSULATION_MODE(int unit, 
                                                                                  uint32 encapsulation_mode_hw, 
                                                                                  SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE* encapsulation_mode) {
    int vxlan_mode;
    uint32 res;
    ...
    case (ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_NONE) :
        *encapsulation_mode = SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_NONE;
    break;
    case (ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_ETHER_IP) : /* and ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_VXLAN */
    ...
    break;
    case (ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_BASIC_GRE) :
        *encapsulation_mode = SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_BASIC_GRE;
    break;
    case (ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_ENHANCE_GRE) :
...
STATIC uint32
  arad_pp_eg_encap_data_entry_get_unsafe(
    ...
    SOC_SAND_OUT ARAD_PP_EG_ENCAP_ENTRY_INFO                 *encap_info,
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_RANGE_INFO_SET_UNSAFE);

  

  SOC_SAND_CHECK_NULL_INPUT(range_info);

  SOC_SAND_SOC_IF_ERROR_RETURN(res, 10, exit, READ_EPNI_EEDB_OUTLIF_ACCESSr(unit, REG_PORT_ANY, &val64));
  fld_val = soc_reg64_field_get(unit, EPNI_EEDB_OUTLIF_ACCESSr, val64, EEDB_OUTLIF_ACCESSf);


  fld_vals[0] = COMPILER_64_LO(fld_val);
  fld_vals[1] = COMPILER_64_HI(fld_val);
  for (ndx=0; ndx < ARAD_PP_EG_ENCAP_NOF_BANKS(unit); ndx++) {
    switch(range_info->bank_access_phase[ndx]) 
    {
    case (ARAD_PP_EG_ENCAP_ACCESS_PHASE_ONE):
    case (ARAD_PP_EG_ENCAP_ACCESS_PHASE_TWO):
    case (ARAD_PP_EG_ENCAP_ACCESS_PHASE_THREE):
        case (ARAD_PP_EG_ENCAP_ACCESS_PHASE_FOUR):

        tmp = range_info->bank_access_phase[ndx];
        if(16 > ndx) {
            res = soc_sand_bitstream_set_any_field(&tmp, ndx*2, 2, &(fld_vals[0]));
        } else {
            res = soc_sand_bitstream_set_any_field(&tmp, (ndx - 16)*2, 2, &(fld_vals[1]));        
        }
  ...
  COMPILER_64_SET(fld_val, fld_vals[1], fld_vals[0]);    

  soc_reg64_field_set(unit, EPNI_EEDB_OUTLIF_ACCESSr, &val64, EEDB_OUTLIF_ACCESSf, fld_val);
  SOC_DPP_ALLOW_WARMBOOT_WRITE(WRITE_EPNI_EEDB_OUTLIF_ACCESSr(unit, REG_PORT_ANY, val64), rv);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_RANGE_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_RANGE_INFO, range_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_RANGE_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_RANGE_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(range_info);

  ARAD_PP_EG_ENCAP_RANGE_INFO_clear(range_info);
  ...
  for (ndx=0; ndx < ARAD_PP_EG_ENCAP_NOF_BANKS(unit); ndx++) {
      ...
      if(16 > ndx) {
          res = soc_sand_bitstream_get_any_field(&(fld_vals[0]), ndx*2, 2, &range_info->bank_access_phase[ndx]);
      } else {
          res = soc_sand_bitstream_get_any_field(&(fld_vals[1]), (ndx - 16)*2, 2, &range_info->bank_access_phase[ndx]);
      }
      SOC_SAND_CHECK_FUNC_RESULT(res, 20+ndx, exit);
  }
...
uint32
    arad_pp_eg_encap_lif_field_get_unsafe(
      ...
      SOC_SAND_OUT  uint32                               *next_outlif
  )
{
    uint32
     res = SOC_SAND_OK;
    ...
    SOC_SAND_CHECK_NULL_INPUT(next_outlif);
    ...
    if(eep_type == ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_AC) {
        ...
        ARAD_PP_EG_ENCAP_GET_FIELD_DROP(entry,flags,next_outlif);
    }
        ...
        ARAD_PP_EG_ENCAP_GET_FIELD_NEXT_LIF(entry,flags,next_outlif);
        ARAD_PP_EG_ENCAP_GET_FIELD_DROP(entry,flags,next_outlif);
    }
        ...
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
        if(flags & ARAD_PP_EG_ENCAP_ENTRY_UPDATE_NEXT_LIF){
            *next_outlif = entry.next_outlif_lsb;
        }
        ARAD_PP_EG_ENCAP_GET_FIELD_DROP(entry,flags,next_outlif);
    }
  ...
  )
{
    ...
    if(eep_type == ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_AC) {
        ...
        ARAD_PP_EG_ENCAP_UPDATE_FIELD_DROP(entry,flags,next_outlif);
        ...
        if(flags & ARAD_PP_EG_ENCAP_ENTRY_UPDATE_NEXT_LIF) {
            entry.next_outlif = next_outlif;
            entry.next_outlif_valid = next_outlif != 0;
        }
        ARAD_PP_EG_ENCAP_UPDATE_FIELD_DROP(entry,flags,next_outlif);
        ...
        SOC_SAND_CHECK_FUNC_RESULT(res, 10, exit);
        if(flags & ARAD_PP_EG_ENCAP_ENTRY_UPDATE_NEXT_LIF){
            entry.next_outlif_lsb = next_outlif;
            entry.next_outlif_valid = next_outlif != 0;
        }
        ARAD_PP_EG_ENCAP_UPDATE_FIELD_DROP(entry,flags,next_outlif);
  ...
  )
{
  ...
  for (ind = 0; ind < ARAD_PP_EG_ENCAP_DATA_INFO_MAX_SIZE; ind++) {
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LIF_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_DATA_INFO, data_info, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(next_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_NEXT_EEP_OUT_OF_RANGE_ERR, 30, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_AC_ENTRY_ADD_UNSAFE);

  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 10, exit);
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_eg_encap_ac_entry_add_unsafe()", lif_eep_ndx, 0);
}
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_AC_ENTRY_ADD_VERIFY);

  SOC_SAND_SET_ERROR_CODE(ARAD_PP_FEATURE_NOT_SUPPORTED_ERR, 10, exit);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in arad_pp_eg_encap_ac_entry_add_verify()", lif_eep_ndx, 0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LIF_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_SWAP_INFO, swap_info, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(next_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_NEXT_EEP_OUT_OF_RANGE_ERR, 30, exit);
  ...
  )
{
 ...
 /* Push commands in HW implementations is 0 + push_profile */
  ...
  tbl_data.outlif_profile = pwe_info->outlif_profile;
    ...
    /* Set Egress Protection data - might need to receive indication about 1/4 entry existance, to
       check before the setting
    if (SOC_IS_JERICHO(unit)) {
        tbl_data.protection_pointer = pwe_info->protection_pointer; 
        if (SOC_DPP_IS_PROTECTION_EGRESS_COUPLED(unit)) {
            tbl_data.protection_pointer |= ((pwe_info->protection_path) << JER_PP_EG_ENCAP_PROTECTION_PATH_BIT_NUM);
        }
    }
    */
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LIF_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_PWE_INFO, pwe_info, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(next_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_NEXT_EEP_OUT_OF_RANGE_ERR, 30, exit);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(lif_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LIF_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_POP_INFO, pop_info, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(next_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_NEXT_EEP_OUT_OF_RANGE_ERR, 30, exit);
  ...
  )
{
  ...
  res = ARAD_PP_EG_ENCAP_VSI_ENCAP_INFO_verify(unit, vsi_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);

  SOC_SAND_ERR_IF_ABOVE_NOF(lif_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LL_EEP_OUT_OF_RANGE_ERR, 30, exit);

  SOC_SAND_ERR_IF_ABOVE_NOF(next_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LL_EEP_OUT_OF_RANGE_ERR, 40, exit);
  ...
  )
{
  ...
  {
    /* 2nd encapsulation */
    ee_entry_tbl_data.mpls2_command = ARAD_PP_MPLS_COMMAND_TYPE_PUSH + mpls_encap_info->tunnels[1].push_profile;
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(tunnel_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_IP_TUNNEL_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_MPLS_ENCAP_INFO, mpls_encap_info, 20, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(ll_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LL_EEP_OUT_OF_RANGE_ERR, 30, exit);
  ...
  )
{
  ...
  SOC_PPC_EG_ENCAP_ENCAPSULATION_MODE_TO_ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD(unit, ipv4_encap_info->dest.encapsulation_mode, &(tbl_data.encapsulation_mode));
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_NOF(tunnel_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_IP_TUNNEL_EEP_NDX_OUT_OF_RANGE_ERR, 5, exit);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_IPV4_ENCAP_INFO, ipv4_encap_info, 10, exit);

  ARAD_PP_EG_ENCAP_NDX_OF_TYPE_VERIFY(tunnel_eep_ndx);

  SOC_SAND_ERR_IF_ABOVE_NOF(ll_eep, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LL_EEP_OUT_OF_RANGE_ERR, 20, exit);
...
STATIC uint32
  arad_pp_eg_encap_ipv6_sip_entry_from_prge_buffer(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_OUT  ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO       *ipv6_encap_info,
...
STATIC uint32
  arad_pp_eg_encap_ipv6_entry_to_data_buffer(
    ...
    SOC_SAND_IN  ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO       *ipv6_encap_info,
    SOC_SAND_OUT  ARAD_PP_EG_ENCAP_DATA_INFO            *data_info
  )
{
    uint32
  ...
  )
{
    ...
    ARAD_PP_EG_ENCAP_PRGE_MEM_ERSPAN_FORMAT_SET(unit, ARAD_PP_EG_ENCAP_ERSPAN_PRIO_VAL, ARAD_PP_EG_ENCAP_ERSPAN_TRUNC_VAL, mirror_encap_info->tunnel.erspan_id, erspan_hdr);
...
STATIC SOC_PPC_EG_ENCAP_ENTRY_TYPE
  arad_pp_eg_encap_data_entry_exact_type_get_unsafe(
    SOC_SAND_IN  int                                      unit,
    SOC_SAND_IN  ARAD_PP_EG_ENCAP_DATA_INFO          *tbl_data
  )
{
    ...
    case ARAD_PRGE_DATA_ENTRY_LSBS_IPV6_TUNNEL:
        return ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV6_ENCAP;
        break;
    case ARAD_PRGE_DATA_ENTRY_LSBS_ROO_VXLAN: 
        return ARAD_PP_EG_ENCAP_ENTRY_TYPE_OVERLAY_ARP_ENCAP; 
        break;
    default: 
        return ARAD_PP_EG_ENCAP_ENTRY_TYPE_DATA;
        break;
    }
}
  ...
  )
{
    ...
    ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO ipv6_encap_info;
    ...
    { 
    case (ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV6_ENCAP): 
        ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO_clear(&ipv6_encap_info);
        ...
        exact_data_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV6_ENCAP;
        soc_sand_os_memcpy(&exact_data_info->entry_val.ipv6_encap_info,&ipv6_encap_info,sizeof(ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO));

        break;

    default: 
        exact_data_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_DATA;
        break;
    }
exit:
  ...
  )
{
    uint32
      res = SOC_SAND_OK;
    ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO       
        ipv6_encap_info;
    ARAD_PP_EG_ENCAP_ENTRY_INFO
        encap_entry_info[1];
    uint8
        next_eep_valid;
    uint32
    ...
    if(arad_pp_eg_encap_data_entry_exact_type_get_unsafe(unit,&(encap_entry_info->entry_val.data_info)) == ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV6_ENCAP) {
  ...
  )
{
  ...
  ARAD_PP_EG_ENCAP_DATA_INFO_clear(&data_info);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO, ipv6_encap_info, 10, exit);
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_MIRROR_ENCAP_INFO, mirror_encap_info, 20, exit);
  ...
  )
{
  ...
  /* get prge data l2 */
  res = arad_pp_epni_prge_data_tbl_get_unsafe(unit, prge_tbl_mirror_base + mirror_ndx + 16, &prge_data_l2);
  SOC_SAND_CHECK_FUNC_RESULT(res, 30, exit);
  ...
  )
{
  ...
  res = ARAD_PP_EG_ENCAP_LL_INFO_verify(unit, ll_encap_info);
  SOC_SAND_CHECK_FUNC_RESULT(res, 20, exit);

  SOC_SAND_ERR_IF_ABOVE_NOF(ll_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LL_EEP_OUT_OF_RANGE_ERR, 30, exit);
  ...
  )
{
  ...
  ARAD_PP_EG_ENCAP_ENTRY_INFO encap_entry_info[ARAD_PP_NOF_EG_ENCAP_EEP_TYPES];
  uint32 next_eep[ARAD_PP_NOF_EG_ENCAP_EEP_TYPES];
  uint32 nof_entries;
  ...
  /* in ROO LL eedb entries in jericho,
     eedb entry contains a 1/4 entry and an additional table entry (CfgEtherTypeIndex table) */
      ...
      if (encap_entry_info[0].entry_type == SOC_PPC_EG_ENCAP_ENTRY_TYPE_ROO_LL_ENCAP) {
          ...
          /* remove 1/4 entry if exist */
          if (encap_entry_info[0].entry_val.overlay_arp_encap_info.nof_tags != 0) {
  ...
  if (SOC_IS_ARADPLUS_AND_BELOW(unit)) {
        ARAD_PP_EG_ENCAP_ACCESS_MPLS_TUNNEL_ENTRY_FORMAT tbl_data;
      /* clear data entry */
      soc_sand_os_memset(&tbl_data, 0x0, sizeof(tbl_data));
      res = arad_pp_eg_encap_access_mpls_tunnel_format_tbl_set_unsafe(
              unit,
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(eep_type_ndx, ARAD_PP_EG_ENCAP_EEP_TYPE_NDX_MAX, ARAD_PP_EG_ENCAP_EEP_TYPE_NDX_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_EEP_NDX_OUT_OF_RANGE_ERR, 20, exit);
  ...
  )
{
  ...
  ARAD_PP_EG_ENCAP_EEP_TYPE
    eep_type_ndx = ARAD_PP_EG_ENCAP_EEP_TYPE_LL;
  ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE
  ...
  ARAD_PP_EG_ENCAP_ENTRY_INFO_clear(encap_info);
  ...
  encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_LL_ENCAP;
  ...
  )
{
  ...
  ARAD_PP_EG_ENCAP_ACCESS_DATA_ENTRY_FORMAT
    tbl_data;
  ARAD_PP_EG_ENCAP_EEP_TYPE
    eep_type_ndx = ARAD_PP_EG_ENCAP_EEP_TYPE_DATA;
  ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE
    cur_eep_type = ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_NONE;
...
{ 
  ...
  ARAD_PP_EG_ENCAP_ACCESS_OUT_RIF_ENTRY_FORMAT
    tbl_data;
  ARAD_PP_EG_ENCAP_EEP_TYPE
    eep_type_ndx = ARAD_PP_EG_ENCAP_EEP_TYPE_VSI;
  ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE
    cur_eep_type = ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_NONE;
  ...
  encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_VSI;
  ...
  )
{
  ...
  ARAD_PP_EG_ENCAP_ACCESS_MPLS_TUNNEL_ENTRY_FORMAT
    tbl_data;
  ARAD_PP_EG_ENCAP_EEP_TYPE
    eep_type_ndx = ARAD_PP_EG_ENCAP_EEP_TYPE_LIF_EEP;
  ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE
    cur_eep_type = ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_NONE;
  ...
  if (tbl_data.mpls1_command == ARAD_PP_EG_ENCAP_MPLS1_COMMAND_SWAP_val)
  {
    ...
    encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_SWAP_CMND;
  }
  else if (tbl_data.mpls1_command == ARAD_PP_EG_ENCAP_MPLS1_COMMAND_POP_val)
  {
    ...
    encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_POP_CMND;
  }
  else
  {
    /* PWE */
    ...
    encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_PWE;

    /* Egress Protection info */
    /*
    encap_info->entry_val.pwe_info.protection_pointer = 0;
    encap_info->entry_val.pwe_info.protection_path = 0;

    if (SOC_IS_JERICHO(unit)) {
        encap_info->entry_val.pwe_info.protection_pointer = tbl_data.protection_pointer;

        if (SOC_DPP_IS_PROTECTION_EGRESS_COUPLED(unit)) {
            encap_info->entry_val.pwe_info.protection_path = tbl_data.protection_pointer >> ER_PP_EG_ENCAP_PROTECTION_PATH_BIT_NUM;
        }
    } */
  }
  ...
  )
{
  ...
  switch(tbl_data_entry_type)
  {
    case (ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_IP):
        ...
        SOC_PPC_EG_ENCAP_ARAD_PP_EG_ENCAP_ENCAPSULATION_MODE_HW_FLD_TO_ENCAPSULATION_MODE(unit, 
        ...
        *next_eep = ip_tunnel_format_tbl_data.next_outlif;
        ...
        encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV4_ENCAP;
        break;
      case (ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_MPLS_TUNNEL):
        ...
        encap_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_MPLS_ENCAP;
        ...
        *next_eep = ee_entry_tbl_data.next_outlif;
        ...
        /* Nof tunnels */
        if (encap_info->entry_val.mpls_encap_info.tunnels[0].push_profile <= ARAD_PP_EG_ENCAP_MPLS1_COMMAND_PUSH_UPPER_LIMIT_val)
        {
          ++encap_info->entry_val.mpls_encap_info.nof_tunnels;
        }
        if ((encap_info->entry_val.mpls_encap_info.tunnels[1].push_profile <= ARAD_PP_EG_ENCAP_MPLS1_COMMAND_PUSH_UPPER_LIMIT_val) &&
            (encap_info->entry_val.mpls_encap_info.tunnels[1].tunnel_label != 0))
        {
          ++encap_info->entry_val.mpls_encap_info.nof_tunnels;
        }
  ...
  )
{
  ...
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_TRILL:
    *entry_type =  ARAD_PP_EG_ENCAP_ENTRY_TYPE_NULL;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_MPLS:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_PWE;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_DATA_IPV6:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV6_ENCAP;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_DATA:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_DATA;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_LINK_LAYER:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_LL_ENCAP;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_MPLS_SWAP:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_SWAP_CMND;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_MPLS_TUNNEL:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_MPLS_ENCAP;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_IP:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_IPV4_ENCAP;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_RIF:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_VSI;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_OUT_AC:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_AC;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_MPLS_POP:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_POP_CMND;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_DATA_ARP_OVERLAY: 
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_OVERLAY_ARP_ENCAP;
    break;
  case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_ROO_LINK_LAYER:
    *entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_ROO_LL_ENCAP; 
    break;
  default:
    SOC_SAND_SET_ERROR_CODE(ARAD_PP_EG_ENCAP_EEP_TYPE_NDX_OUT_OF_RANGE_ERR, 40, exit);
  }
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_ENTRY_TYPE_GET_UNSAFE);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_ENTRY_TYPE_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(depth, ARAD_PP_NOF_EG_ENCAP_EEP_TYPES - 1, ARAD_PP_EG_ENCAP_DEPTH_OUT_OF_RANGE_ERR, 5, exit);
  ...
  *nof_entries = 0; 
  ...
  {
    ARAD_PP_EG_ENCAP_ENTRY_INFO_clear(&encap_entry_info[depth_i]);
    ...
    if (cur_eep_ndx != ARAD_PP_EG_ENCAP_NEXT_EEP_INVALID) {
      ...
      case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_MPLS_TUNNEL:
          /* 
                  ...
                  */
          if ((eep_type_ndx == ARAD_PP_EG_ENCAP_EEP_TYPE_LIF_EEP) && (depth_i == 0)) {
              res = arad_pp_eg_encap_lif_entry_get_unsafe(
                        unit,
                        cur_eep_ndx,
                        &encap_entry_info[depth_i],
      ...
      case ARAD_PP_EG_ENCAP_EEDB_ACCESS_TYPE_NONE:
        ...
        break;
      default:
        SOC_SAND_SET_ERROR_CODE(ARAD_PP_EG_ENCAP_EEP_TYPE_NDX_OUT_OF_RANGE_ERR, 100, exit);
        break;
      }
    }

    if (depth_i != ARAD_PP_NOF_EG_ENCAP_EEP_TYPES)
    {
   ...
   )
{
    ...
    ARAD_PP_EG_ENCAP_OVERLAY_ARP_ENCAP_INFO overlay_arp_encap_info; 

    ARAD_PP_EG_ENCAP_DATA_INFO *data_info; 
    ...
    /* update entry type */
    exact_data_info->entry_type = ARAD_PP_EG_ENCAP_ENTRY_TYPE_OVERLAY_ARP_ENCAP;

    soc_sand_os_memcpy(&exact_data_info->entry_val.overlay_arp_encap_info, 
                       &overlay_arp_encap_info, 
                       sizeof(ARAD_PP_EG_ENCAP_OVERLAY_ARP_ENCAP_INFO));
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_SET_VERIFY);
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO, profile_info, 20, exit);
...
{
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_GET_UNSAFE);
  ...
  profile_info->exp_mark_mode = ARAD_PP_EG_ENCAP_EXP_MARK_MODE_FROM_PUSH_PROFILE;
...
{
  uint32 res;
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO, glbl_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_GET_VERIFY);
...
{
  uint32 res;
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(glbl_info);

  ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_clear(glbl_info);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_GLBL_INFO_SET_UNSAFE);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_GLBL_INFO_SET_VERIFY);

  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_GLBL_INFO, glbl_info, 10, exit);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_GLBL_INFO_GET_VERIFY);
  ...
  )
{
  ...
  SOC_SAND_INIT_ERROR_DEFINITIONS(ARAD_PP_EG_ENCAP_GLBL_INFO_GET_UNSAFE);

  SOC_SAND_CHECK_NULL_INPUT(glbl_info);

  ARAD_PP_EG_ENCAP_GLBL_INFO_clear(glbl_info);
  ...
  )
{
  ...
  for (ndx=0; ndx<SOC_DPP_DEFS_MAX(EG_ENCAP_NOF_BANKS); ndx++) {
      SOC_SAND_ERR_IF_ABOVE_MAX(info->bank_access_phase[ndx], ARAD_PP_EG_ENCAP_ACCESS_PHASE_MAX, ARAD_PP_NOF_EG_ENCAP_ACCESS_PHASE_OUT_OF_RANGE_ERROR,
                            30+ndx, exit);
  }
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_RANGE_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_SWAP_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_DATA_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_PWE_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_POP_INTO_ETH_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  if (info->pop_type != ARAD_PP_MPLS_COMMAND_TYPE_POP) {
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_POP_INTO_ETH_INFO, &(info->ethernet_info), 12, exit);
  SOC_SAND_ERR_IF_OUT_OF_RANGE(info->pop_next_header, ARAD_PP_PKT_FRWRD_TYPE_BRIDGE, ARAD_PP_PKT_FRWRD_TYPE_MPLS, ARAD_PP_EG_ENCAP_POP_INFO_PKT_FRWRD_TYPE_OUT_OF_RANGE_ERR, 13, exit);
  
  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_POP_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_MPLS_TUNNEL_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  for (ind = 0; ind < ARAD_PP_EG_ENCAP_MPLS_MAX_NOF_TUNNELS; ++ind)
  {
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_MPLS_TUNNEL_INFO, &(info->tunnels[ind]), 10, exit);
  }
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->out_vsi, ARAD_PP_EG_ENCAP_OUT_VSI_MAX, ARAD_PP_EG_ENCAP_OUT_VSI_OUT_OF_RANGE_ERR, 20, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_MPLS_ENCAP_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_IPV4_TUNNEL_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_IPV4_TUNNEL_INFO, &(info->dest), 10, exit);
  SOC_SAND_ERR_IF_ABOVE_MAX(info->out_vsi, ARAD_PP_EG_ENCAP_OUT_VSI_MAX, ARAD_PP_EG_ENCAP_OUT_VSI_OUT_OF_RANGE_ERR, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_IPV4_ENCAP_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_IPV6_TUNNEL_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_IPV6_TUNNEL_INFO, &(info->tunnel), 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_IPV6_ENCAP_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_MIRROR_TUNNEL_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_MIRROR_TUNNEL_INFO, &(info->tunnel), 10, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_MIRROR_ENCAP_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  if (info->out_ac_valid) {
      SOC_SAND_ERR_IF_ABOVE_NOF(info->out_ac_lsb, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_AC_ID_OUT_OF_RANGE_ERR, 30, exit); 
  }

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_LL_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_VSI_ENCAP_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->exp_mark_mode, ARAD_PP_EG_ENCAP_EXP_MARK_MODE_MAX, ARAD_PP_EG_ENCAP_EXP_MARK_MODE_OUT_OF_RANGE_ERR, 13, exit);
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_PUSH_PROFILE_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_PUSH_EXP_KEY_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_PWE_GLBL_INFO_verify()",0,0);
}
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_GLBL_INFO_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->vsi, ARAD_PP_VSI_ID_MAX, ARAD_PP_VSI_ID_OUT_OF_RANGE_ERR, 10, exit);
  SOC_SAND_ERR_IF_ABOVE_NOF(info->out_ac, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_AC_ID_OUT_OF_RANGE_ERR, 11, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_SWAP_INFO, &(info->swap_info), 12, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_PWE_INFO, &(info->pwe_info), 13, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_POP_INFO, &(info->pop_info), 14, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_MPLS_ENCAP_INFO, &(info->mpls_encap_info), 15, exit);
  ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_IPV4_ENCAP_INFO, &(info->ipv4_encap_info), 16, exit);
  res = ARAD_PP_EG_ENCAP_LL_INFO_verify(unit, &(info->ll_info));
  SOC_SAND_CHECK_FUNC_RESULT(res, 17, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_ENTRY_VALUE_verify()",0,0);
}
  ...
  )
{
  ...
  SOC_SAND_ERR_IF_ABOVE_MAX(info->entry_type, ARAD_PP_EG_ENCAP_ENTRY_TYPE_MAX, ARAD_PP_EG_ENCAP_ENTRY_TYPE_OUT_OF_RANGE_ERR, 10, exit);
  res = ARAD_PP_EG_ENCAP_ENTRY_VALUE_verify(unit, &(info->entry_val));
  SOC_SAND_CHECK_FUNC_RESULT(res, 11, exit);

  SOC_SAND_MAGIC_NUM_VERIFY(info);

exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_ENTRY_INFO_verify()",0,0);
}
...
uint32
   ARAD_PP_EG_ENCAP_TRILL_INFO_verify(
      SOC_SAND_IN int                          unit, 
...
exit:
    SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_TRILL_INFO_verify()", 0, 0); 
}
...
{   
  ...
  if (SOC_IS_ARADPLUS(unit)) {
      ...
      ARAD_PP_EG_ENCAP_DATA_INFO data_info;  /* eedb entry of type "data_entry" */
...
uint32 
ARAD_PP_EG_ENCAP_OVERLAY_ARP_ENCAP_INFO_verify(SOC_SAND_IN ARAD_PP_EG_ENCAP_OVERLAY_ARP_ENCAP_INFO *info) { 
    SOC_SAND_INIT_ERROR_DEFINITIONS_NO_DEVID(0); 
    SOC_SAND_CHECK_NULL_INPUT(info); 
...
exit:
    SOC_SAND_EXIT_AND_SEND_ERROR("error in ARAD_PP_EG_ENCAP_OVERLAY_ARP_ENCAP_INFO_verify()", 0, 0); 
}
   ...
   ) 
{
  uint32
    ...
    SOC_SAND_ERR_IF_ABOVE_NOF(overlay_ll_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LIF_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
    ARAD_PP_STRUCT_VERIFY(ARAD_PP_EG_ENCAP_OVERLAY_ARP_ENCAP_INFO, ll_encap_info, 20, exit);
...
soc_error_t
    ...
    /* check input */
    SOC_SAND_ERR_IF_ABOVE_NOF(trill_eep_ndx, SOC_DPP_DEFS_GET(unit, nof_out_lifs), ARAD_PP_EG_ENCAP_LIF_EEP_NDX_OUT_OF_RANGE_ERR, 10, exit);
    res = ARAD_PP_EG_ENCAP_TRILL_INFO_verify(unit, trill_encap_info); 
    SOC_SAND_CHECK_FUNC_RESULT(res, 11, exit);
    ...
    tbl_data.next_outlif = ll_eep_ndx; 
    tbl_data.next_outlif_valid = ll_eep_is_valid; 
