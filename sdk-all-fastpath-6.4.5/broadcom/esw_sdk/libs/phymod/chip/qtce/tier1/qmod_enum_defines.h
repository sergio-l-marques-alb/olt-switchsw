...
h#8 $Copyright: Copyright 2012 Broadcom Corporation.
h#8 This program is the proprietary software of Broadcom Corporation
h#8 and/or its licensors, and may only be used, duplicated, modified
h#8 or distributed pursuant to the terms and conditions of a separate,
h#8 written license agreement executed between you and Broadcom
h#8 (an "Authorized License").  Except as set forth in an Authorized
h#8 License, Broadcom grants no license (express or implied), right
h#8 to use, or waiver of any kind with respect to the Software, and
h#8 Broadcom expressly reserves all rights in and to the Software
h#8 and all intellectual property rights therein.  IF YOU HAVE
h#8 NO AUTHORIZED LICENSE, THEN YOU HAVE NO RIGHT TO USE THIS SOFTWARE
h#8 IN ANY WAY, AND SHOULD IMMEDIATELY NOTIFY BROADCOM AND DISCONTINUE
h#8 ALL USE OF THE SOFTWARE.  
h#8  
h#8 Except as expressly set forth in the Authorized License,
h#8  
h#8 1.     This program, including its structure, sequence and organization,
h#8 constitutes the valuable trade secrets of Broadcom, and you shall use
h#8 all reasonable efforts to protect the confidentiality thereof,
h#8 and to use this information only in connection with your use of
h#8 Broadcom integrated circuit products.
h#8  
h#8 2.     TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE SOFTWARE IS
h#8 PROVIDED "AS IS" AND WITH ALL FAULTS AND BROADCOM MAKES NO PROMISES,
h#8 REPRESENTATIONS OR WARRANTIES, EITHER EXPRESS, IMPLIED, STATUTORY,
h#8 OR OTHERWISE, WITH RESPECT TO THE SOFTWARE.  BROADCOM SPECIFICALLY
h#8 DISCLAIMS ANY AND ALL IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY,
h#8 NONINFRINGEMENT, FITNESS FOR A PARTICULAR PURPOSE, LACK OF VIRUSES,
h#8 ACCURACY OR COMPLETENESS, QUIET ENJOYMENT, QUIET POSSESSION OR
h#8 CORRESPONDENCE TO DESCRIPTION. YOU ASSUME THE ENTIRE RISK ARISING
h#8 OUT OF USE OR PERFORMANCE OF THE SOFTWARE.
h#8 
h#8 3.     TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL
h#8 BROADCOM OR ITS LICENSORS BE LIABLE FOR (i) CONSEQUENTIAL,
h#8 INCIDENTAL, SPECIAL, INDIRECT, OR EXEMPLARY DAMAGES WHATSOEVER
h#8 ARISING OUT OF OR IN ANY WAY RELATING TO YOUR USE OF OR INABILITY
h#8 TO USE THE SOFTWARE EVEN IF BROADCOM HAS BEEN ADVISED OF THE
h#8 POSSIBILITY OF SUCH DAMAGES; OR (ii) ANY AMOUNT IN EXCESS OF
h#8 THE AMOUNT ACTUALLY PAID FOR THE SOFTWARE ITSELF OR USD 1.00,
h#8 WHICHEVER IS GREATER. THESE LIMITATIONS SHALL APPLY NOTWITHSTANDING
h#8 ANY FAILURE OF ESSENTIAL PURPOSE OF ANY LIMITED REMEDY.$                                               
 */                                                                     
...
qmod_core_select selects for programming, any combination of 3
core of the PHY.
This is only applicable to the 12x10 version of the TSCE core.
A '1' in the latter part of the enum selects the core.
...
typedef enum {
  QMOD_SC_MODE_HT_WITH_BASIC_OVERRIDE = 0   ,  /*!< QMOD_SC_MODE_HT_WITH_BASIC_OVERRIDE    */
  QMOD_SC_MODE_HT_OVERRIDE        ,  /*!< QMOD_SC_MODE_HT_OVERRIDE               */
  QMOD_SC_MODE_ST                 ,  /*!< QMOD_SC_MODE_ST                        */
  QMOD_SC_MODE_ST_OVERRIDE        ,  /*!< QMOD_SC_MODE_ST_OVERRIDE               */
  QMOD_SC_MODE_AN_CL37            ,  /*!< QMOD_SC_MODE_AN_CL37                   */
  QMOD_SC_MODE_AN_CL73            ,  /*!< QMOD_SC_MODE_AN_CL73                   */
  QMOD_SC_MODE_BYPASS             ,  /*!< QMOD_SC_MODE_BYPASS                    */
  QMOD_SC_MODE_ILLEGAL              /*!< QMOD_SC_MODE_ILLEGAL                   */
} sc_mode_type;
...
/*!
\brief
This array associates the enum #qmod_core_select enum with a
bit mask.
The index is the #qmod_core_select enum value.  The value for
each entry is
