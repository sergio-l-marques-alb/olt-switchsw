...
extern int viper_lpi_disable            (const PHYMOD_ST *pa);
...
extern int viper_remote_loopback_ena    (const PHYMOD_ST *pa, uint8_t enable);
...
extern int viper_phy_enable_set(const PHYMOD_ST *pa, int enable);
