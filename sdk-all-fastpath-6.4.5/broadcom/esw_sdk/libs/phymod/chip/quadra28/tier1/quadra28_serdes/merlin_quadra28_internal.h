 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: merlin_quadra28_internal.h 947 2015-03-06 21:11:44Z kirand $ *
 *                                                                                *
...
/** @file merlin_quadra28_internal.h
 * Internal API functions
 */

#ifndef MERLIN_QUADRA28_API_INTERNAL_H
#define MERLIN_QUADRA28_API_INTERNAL_H

#define SDK_STATIC static


#include "merlin_quadra28_functions.h"
#include "merlin_quadra28_common.h"
#include "merlin_quadra28_field_access.h"
#include "common/srds_api_err_code.h"
#include "merlin_quadra28_interface.h"
#include "merlin_quadra28_debug_functions.h"
 ...
 * as part of merlin_quadra28_display_core_state_line()
 ...
 */
static err_code_t _merlin_display_event( const phymod_access_t *pa, uint8_t event_id, uint8_t entry_len, uint8_t prev_cursor, uint8_t curr_cursor, uint8_t post_cursor, uint8_t *supp_info);
...
/*-----------------------------*/
/** Read current merlin_quadra28 core status.
 * @param *istate Current merlin_quadra28 core status read back and populated by the API
...
/*-----------------------------*/
/** Read current merlin_quadra28 lane status.
 * @param *istate Current merlin_quadra28 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _merlin_quadra28_get_osr_mode( const phymod_access_t *pa, merlin_quadra28_osr_mode_st *mode);
 ...
 * Along with merlin_quadra28_core_clkgate(), all lanes should also be clock gated using merlin_quadra28_lane_clkgate() to complete a Core Clockgate
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin_quadra28_functions.c.
 *
