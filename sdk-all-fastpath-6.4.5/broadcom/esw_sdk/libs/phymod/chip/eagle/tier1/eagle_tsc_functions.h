 ...
 *  Revision      :  $Id: eagle_tsc_functions.h 898 2015-02-04 23:22:17Z eroes $ *
 *                                                                                 *
 ...
 * Distinct '__err' and '|| __err' are intended to silence static code
 * analyzers (such as Coverity) without generating additional code. */
#define EPFUN(fun) do {err_code_t __err = (fun); *err_code_p |= __err; if (*err_code_p || __err) return(0); } while(0)
