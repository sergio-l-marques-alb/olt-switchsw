...
{       
    ...
    uint16_t vl = _falcon_ladder_setting_to_mV(var, ladder_range);    
    return (vl);
}
...
SDK_STATIC err_code_t _falcon_tsc_read_lane_state( const phymod_access_t *pa, falcon_tsc_lane_state_st *istate) {  
  ...
  state.p1_lvl = _falcon_ladder_setting_to_mV((int8_t)state.p1_lvl, 0);
  ESTM(state.m1_lvl = rd_rx_phase_thresh_sel());
  state.m1_lvl = _falcon_ladder_setting_to_mV((int8_t)state.m1_lvl, 0);
