/* $Id: pb_pp_eg_ac.h,v 1.7 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_eg_ac.h
*
...
#ifndef __SOC_PB_PP_EG_AC_INCLUDED__
/* { */
#define __SOC_PB_PP_EG_AC_INCLUDED__
...
typedef enum
{
  ...
  SOC_PB_PP_EG_AC_PORT_CVID_INFO_GET_PRINT,
  SOC_PB_PP_EG_AC_PORT_CVID_INFO_GET_UNSAFE,
  SOC_PB_PP_EG_AC_PORT_CVID_INFO_GET_VERIFY,
  SOC_PB_PP_EG_AC_PORT_CVID_MAP,
  SOC_PB_PP_EG_AC_PORT_CVID_MAP_PRINT,
  SOC_PB_PP_EG_AC_PORT_CVID_MAP_UNSAFE,
  SOC_PB_PP_EG_AC_PORT_CVID_MAP_VERIFY,
  SOC_PB_PP_EG_AC_PORT_VSI_MAP,
  SOC_PB_PP_EG_AC_PORT_VSI_MAP_PRINT,
  SOC_PB_PP_EG_AC_PORT_VSI_MAP_UNSAFE,
  SOC_PB_PP_EG_AC_PORT_VSI_MAP_VERIFY,
  SOC_PB_PP_EG_AC_GET_PROCS_PTR,
  SOC_PB_PP_EG_AC_GET_ERRS_PTR,
  /*
   ...
   */
  SOC_PB_PP_EG_AC_PROCEDURE_DESC_LAST
} SOC_PB_PP_EG_AC_PROCEDURE_DESC;
...
typedef enum
{
   ...
   * Auto generated. Do not edit following section {
   */
  SOC_PB_PP_EG_AC_SUCCESS_OUT_OF_RANGE_ERR = SOC_PB_PP_ERR_DESC_BASE_EG_AC_FIRST,
 ...
 *     "soc_pb_pp_eg_ac_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_eg_ac_info_set_unsafe" API for details.
*********************************************************************/
uint32
  soc_pb_pp_eg_ac_info_get_unsafe(
    SOC_SAND_IN  int                                 unit,
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_eg_ac_mp_info_set_unsafe" API.
 *     Refer to "soc_pb_pp_eg_ac_mp_info_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_eg_ac_mp_info_get_unsafe(
