/* $Id: pb_pp_api_llp_vid_assign.h,v 1.6 Broadcom SDK $
...
/******************************************************************
*
* FILENAME:       DuneDriver/Soc_petra/SOC_PB_PP/include/soc_pb_pp_api_llp_vid_assign.h
*
...
#ifndef __SOC_PB_PP_API_LLP_VID_ASSIGN_INCLUDED__
/* { */
#define __SOC_PB_PP_API_LLP_VID_ASSIGN_INCLUDED__
...
#define SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE_TAGGED        SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE_TAGGED
#define SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE_UNTAGGED      SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE_UNTAGGED
#define SOC_PB_PP_NOF_LLP_VID_ASSIGN_MATCH_RULE_TYPES          SOC_PPC_NOF_LLP_VID_ASSIGN_MATCH_RULE_TYPES
typedef SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE_TYPE                 SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE;

typedef SOC_PPC_LLP_VID_ASSIGN_PORT_INFO                       SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_MAC_INFO                        SOC_PB_PP_LLP_VID_ASSIGN_MAC_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_IPV4_SUBNET_INFO                SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_PRTCL_INFO                      SOC_PB_PP_LLP_VID_ASSIGN_PRTCL_INFO;
typedef SOC_PPC_LLP_VID_ASSIGN_MATCH_RULE                      SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE;
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_llp_vid_assign_port_info_set
 * TYPE:
 *   PROC
 * FUNCTION:
 ...
 *     "soc_pb_pp_llp_vid_assign_port_info_set" API.
 *     Refer to "soc_pb_pp_llp_vid_assign_port_info_set" API for
 *     details.
*********************************************************************/
uint32
  soc_pb_pp_llp_vid_assign_port_info_get(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  int                                 core_id,
    SOC_SAND_IN  SOC_PB_PP_PORT                                local_port_ndx,
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_llp_vid_assign_mac_based_add
 * TYPE:
 *   PROC
 * FUNCTION:
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_llp_vid_assign_mac_based_remove
 * TYPE:
 *   PROC
 * FUNCTION:
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_llp_vid_assign_mac_based_get
 * TYPE:
 *   PROC
 * FUNCTION:
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_llp_vid_assign_mac_based_get_block
 * TYPE:
 *   PROC
 * FUNCTION:
 *   Get VLAN ID assignment information according to source
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_vid_assign_ipv4_subnet_based_set" API.
 *     Refer to "soc_pb_pp_llp_vid_assign_ipv4_subnet_based_set"
 *     API for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_vid_assign_ipv4_subnet_based_get(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  uint32                                  entry_ndx,
...
/*********************************************************************
* NAME:
 *   soc_pb_pp_llp_vid_assign_protocol_based_set
 * TYPE:
 *   PROC
 * FUNCTION:
...
/*********************************************************************
*     Gets the configuration set by the
 *     "soc_pb_pp_llp_vid_assign_protocol_based_set" API.
 *     Refer to "soc_pb_pp_llp_vid_assign_protocol_based_set" API
 *     for details.
*********************************************************************/
uint32
  soc_pb_pp_llp_vid_assign_protocol_based_get(
    SOC_SAND_IN  int                                 unit,
    SOC_SAND_IN  uint32                                  port_profile_ndx,
    SOC_SAND_IN  uint16                                  ether_type_ndx,
...
void
  SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO_clear(
    SOC_SAND_OUT SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_MAC_INFO_clear(
    SOC_SAND_OUT SOC_PB_PP_LLP_VID_ASSIGN_MAC_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_clear(
    SOC_SAND_OUT SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_PRTCL_INFO_clear(
    SOC_SAND_OUT SOC_PB_PP_LLP_VID_ASSIGN_PRTCL_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_clear(
    SOC_SAND_OUT SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE *info
  );

#if SOC_PB_PP_DEBUG_IS_LVL1

const char*
  SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE_to_string(
    SOC_SAND_IN  SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_TYPE enum_val
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO_print(
    SOC_SAND_IN  SOC_PB_PP_LLP_VID_ASSIGN_PORT_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_MAC_INFO_print(
    SOC_SAND_IN  SOC_PB_PP_LLP_VID_ASSIGN_MAC_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO_print(
    SOC_SAND_IN  SOC_PB_PP_LLP_VID_ASSIGN_IPV4_SUBNET_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_PRTCL_INFO_print(
    SOC_SAND_IN  SOC_PB_PP_LLP_VID_ASSIGN_PRTCL_INFO *info
  );

void
  SOC_PB_PP_LLP_VID_ASSIGN_MATCH_RULE_print(
...
/* } __SOC_PB_PP_API_LLP_VID_ASSIGN_INCLUDED__*/
#endif
