...
#define SOC_DPP_ADD_ARAD_VARS_DEPRECATED_CODE \
    ...
    for (i = SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY; i <= SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY_LAST; i+=WB_ENGINE_SORTED_LIST_INNER_VARS_NUM ) {                                                                                                            \
        SOC_DPP_WB_ENGINE_ADD_COMPLEX_DS_SORTED_LIST_DYNAMIC(i,                                                                                                                                                                                               \
                             ...
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)]),                                                                                \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)].init_info.key_size),                                                             \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)].init_info.list_size),                                                            \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)].list_data.ptr_size),                                                             \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)].init_info.data_size),                                                            \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)].list_data.memory_use->buffer_size),                                              \
                             (Arad_sw_db.arad_device_sw_db[unit]->tcam.tcam_db_priorities[((i-SOC_DPP_WB_ENGINE_VAR_TCAM_DB_PRIORITY)/WB_ENGINE_SORTED_LIST_INNER_VARS_NUM)].list_data.memory_use->support_cache),                                            \
                             VERSION(1));                                                                                                                                                                                                                     \
    }                                                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                              \
    /* arad_sw_db module - sand data structs */                                                                                                                                                                                                               \
