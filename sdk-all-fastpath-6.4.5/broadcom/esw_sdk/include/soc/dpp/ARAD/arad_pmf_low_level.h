...
typedef struct
{
  ...
  uint32 entry_bitmap[SOC_DPP_DEFS_MAX_TCAM_NOF_BANKS][SOC_DPP_DEFS_MAX_TCAM_NOF_LINES_IN_LONGS];
...
typedef struct
{
   ...
   */
  uint32 pfgs_db_pmb[ARAD_PMF_NOF_GROUPS][ARAD_BIT_TO_U32(ARAD_PMF_NOF_DBS)];
  /*
   *  the Db always in use because they have no preselectors.
   */
  uint32 default_db_pmb[ARAD_BIT_TO_U32(ARAD_PMF_NOF_DBS)];
  /* 
...
typedef struct
{
    ...
    uint32 pgm_db_pmb[ARAD_PMF_NOF_PROGS][ARAD_BIT_TO_U32(ARAD_PMF_NOF_DBS)]; 
