...
typedef struct soc_dpp_config_arad_s {
    ...
    soc_pbmp_t reserved_tm_ports[SOC_DPP_DEFS_MAX(NOF_CORES)]; /* for dynamic nif */
...
int soc_arad_allocate_tm_port_in_range_and_recycle_channel(int unit, int core, int max_port, int *tm_port, uint32 *channel);
