...
typedef struct
{
  ...
  SOC_SAND_SORTED_LIST_INFO tcam_db_priorities[ARAD_TCAM_MAX_NOF_LISTS];
...
#if defined(INCLUDE_KBP) && !defined(BCM_88030)
    PARSER_HINT_PTR ARAD_KBP_FRWRD_IP          *kbp_frwrd_ip;
    PARSER_HINT_PTR ARAD_KBP_INFO              *kbp_info;
#endif /* defined(INCLUDE_KBP) && !defined(BCM_88030) */
