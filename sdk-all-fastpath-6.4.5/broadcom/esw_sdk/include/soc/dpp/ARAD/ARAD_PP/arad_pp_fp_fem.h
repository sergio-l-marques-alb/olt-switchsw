...
#define ARAD_PP_FP_FEM_ACTION_LOCAL_LSB_JERICHO(_first_lsb, _action_length)  \
            (((_first_lsb + _action_length) <= (ARAD_PP_FP_FEM_ACTION_LSB_TO_FES_LSB(_first_lsb) + 32))? _first_lsb : \
...
#define ARAD_PP_FP_FEM_ACTION_LOCAL_LSB(_first_lsb, _action_length)  \
            (SOC_IS_JERICHO(unit)? ARAD_PP_FP_FEM_ACTION_LOCAL_LSB_JERICHO(_first_lsb, _action_length) : ARAD_PP_FP_FEM_ACTION_LOCAL_LSB_ARAD(_first_lsb, _action_length) )
