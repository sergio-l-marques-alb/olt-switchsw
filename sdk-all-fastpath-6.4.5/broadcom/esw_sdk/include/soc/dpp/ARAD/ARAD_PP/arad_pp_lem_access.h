...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IPV4_MC      (14)
#define ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_IP_HOST      (32)
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IP_HOST      (12)
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_TRILL_ADJ    (8)
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM0_IN_BITS_FOR_IP_SPOOF_DHCP       (41) /* SA 41 LSBs*/
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IP_SPOOF_DHCP       (16) /* In-AC */
...
#define ARAD_PP_LEM_ACCESS_KEY_PARAM1_IN_BITS_FOR_IPV4_SPOOF_STATIC(unit) \
      (SOC_DPP_L3_SRC_BIND_IPV4_SUBNET_OR_ARP_ENABLE(unit) ? (12) /* FID(VSI) */ : (16) /* In-AC */)
...
#define ARAD_PP_LEM_ACCESS_IS_DYN_LSB                        (42-32)
#define ARAD_PP_LEM_ACCESS_DROP_SA                           (41-32)
...
typedef enum
{
   ...
   *  Number of key types
   */
   ARAD_PP_LEM_ACCESS_NOF_KEY_TYPES = ARAD_PP_FLP_KEY_OR_MASK_LAST /*= 0x24 ,*/
...
#define ARAD_PP_LEM_ACCESS_ASD_OUTLIF_INVALID (ARAD_PP_FWD_DECISION_PARSE_OULTIF_INVALID)
