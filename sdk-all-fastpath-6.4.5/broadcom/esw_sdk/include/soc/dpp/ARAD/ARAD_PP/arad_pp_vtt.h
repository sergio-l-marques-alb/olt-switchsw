...
/* Start of VT Programs */
    ...
    /* Trill */
    ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_TRILL,
    ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_TRILL,
    ARAD_PP_DBAL_VT_PROG_VT_VDxOUTER_INNER_VID_TRILL,
    ARAD_PP_DBAL_VT_PROG_VT_VD_DESIGNATED_VID_TRILL,

    ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1_L2ELI,
    ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1_L2ELI,

    ARAD_PP_DBAL_VT_PROG_VT_VDxINITIALVID_L1L2,
    ARAD_PP_DBAL_VT_PROG_VT_VDxOUTERVID_L1L2,

    ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L1,
    ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L1,
    ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxINITIALVID_L3,
    ARAD_PP_DBAL_VT_PROG_VT_INDEXED_VDxOUTERVID_L3,

    ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID,
    ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID,
    ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxINITIALVID_AFTER_RCY,
    ARAD_PP_DBAL_VT_PROG_VT_IPV4_VDxOUTERVID_AFTER_RCY,
...
typedef enum
{
    INITIAL_VID,
    OUTER_VID,
    TRILL_ONE_TAG = OUTER_VID,
    OUTER_INNER_VID,
    TRILL_TWO_TAG = OUTER_INNER_VID,
    TRILL_DESIGNATED_VID
