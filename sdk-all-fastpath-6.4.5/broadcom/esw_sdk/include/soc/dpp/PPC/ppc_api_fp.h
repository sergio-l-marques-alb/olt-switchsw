...
#define SOC_PPC_FP_DATABASE_INFO_FLAGS_STAGE_VT_EXTENDED     (1 << 10) /* databases in the KBP that are defined in init for VT stage */
...
typedef enum
{
   ...
   *  MPLS Label 4 (20b)
   */
  SOC_PPC_FP_QUAL_HDR_MPLS_LABEL4 = 71,
  /*
   *  MPLS Experimental Use 4 (3b)
   */
  SOC_PPC_FP_QUAL_HDR_MPLS_EXP4 = 72,
  /*
   *  MPLS Time-To-Live 4 (8b)
   */
  SOC_PPC_FP_QUAL_HDR_MPLS_TTL4 = 73,
  /*
   *  MPLS Bottom-of-Stack 4 (32b)
   */
  SOC_PPC_FP_QUAL_HDR_MPLS_BOS4 = 74,
  /*
  ...
  */
  ...
  /*new oam qual*/
    ...
    SOC_PPC_FP_QUAL_GRE_FLAG_VER_PRTCL,
