...
#define SOC_IS_BCM88773_A0(unit) (CMDEV(unit).dev.dev_id == BCM88773_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88773_A0_REV_ID)
#define SOC_IS_BCM88774(unit) (CMDEV(unit).dev.dev_id == BCM88774_DEVICE_ID)
#define SOC_IS_BCM88774_A0(unit) (CMDEV(unit).dev.dev_id == BCM88774_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88774_A0_REV_ID)
#define SOC_IS_BCM88775(unit) (CMDEV(unit).dev.dev_id == BCM88775_DEVICE_ID)
#define SOC_IS_BCM88775_A0(unit) (CMDEV(unit).dev.dev_id == BCM88775_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88775_A0_REV_ID)
#define SOC_IS_BCM88776(unit) (CMDEV(unit).dev.dev_id == BCM88776_DEVICE_ID)
#define SOC_IS_BCM88776_A0(unit) (CMDEV(unit).dev.dev_id == BCM88776_DEVICE_ID && CMDEV(unit).dev.rev_id == BCM88776_A0_REV_ID)
