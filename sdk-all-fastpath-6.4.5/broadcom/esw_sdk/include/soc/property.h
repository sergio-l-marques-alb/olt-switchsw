...
/* This specifies the external PHY device is present. */
 ...
 * \[:<queue config>\]\[:i - inactive port or m - management port>\].
...
/* If the BCM88750 is connected with links 0 - 11, 16 - 27, 32 - 43, 48 - 59, 64 - 75, 80 - 91, 96 - 107, 112 - 123 (first 12 in every 16 links group), and the secondary switch is used, then its secondary TX FIFOs can use the memory of the unused links, thus increasing their capacity by 330 144 entries.  */
