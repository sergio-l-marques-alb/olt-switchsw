...
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_enable_set_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_enable_get_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_rx_enable_set_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_rx_enable_get_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_rx_status_get_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_polynomial_set_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_polynomial_get_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int* value);
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_invert_data_set_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int value);
typedef soc_error_t (*mbcm_dfe_port_prbs_tx_invert_data_get_f) (int unit, soc_port_t port, portmod_prbs_mode_t mode, int *value);
