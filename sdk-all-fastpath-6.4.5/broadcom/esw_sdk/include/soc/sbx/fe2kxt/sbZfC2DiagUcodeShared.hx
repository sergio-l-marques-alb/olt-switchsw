...
typedef struct _sbZfC2DiagUcodeShared {
  uint32 m_ulMemSizeMm0N0;
  uint32 m_ulMemSizeMm0N1;
  uint32 m_ulMemSizeMm0W;
  uint32 m_ulMemSizeMm1N0;
  uint32 m_ulMemSizeMm1N1;
  uint32 m_ulMemSizeMm1W;
  uint32 m_ulRandomSeed;
