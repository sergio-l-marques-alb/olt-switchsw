...
typedef enum bcm_field_stat_action_e {
    bcmFieldStatActionIncrement = 0,    /* Increment the stat. */
    bcmFieldStatActionIncrementCancel = 1, /* Do not increment the stat. */
    bcmFieldStatActionSample = 2,       /* Sample the stat value to the packet. */
    bcmFieldStatActionCount = 3         /* Always Last. Not a usable value. */
...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyStageIngressExactMatch = 469, /*  Field Processor pipeline ingress
                                           exact match stage. */
    bcmFieldQualifyCount = 470          /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_AppType_e {
    ...
    bcmFieldAppTypeCount = 35           /* Always Last. Not a usable value. */
} bcm_field_AppType_t;
...
typedef enum bcm_field_olp_header_type_e {
    ...
    bcmFieldOlpHeaderTypeEthOamLm = 4,  /* Ethernet Oam LM packet */
    bcmFieldOlpHeaderTypeEthOamDm = 5,  /* Ethernet Oam DM packet */
    ...
    bcmFieldOlpHeaderTypeSat = 15,      /* Service Activation Test */
    bcmFieldOlpHeaderTypeOtherAch = 16, /* OAM packets with other ACH types */
    bcmFieldOlpHeaderTypeCount = 17     /* Always Last. Not a usable value. */
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionCount = 369           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
#define BCM_FIELD_PRESEL_ENTRY_SET(presel_id, id)  (presel_id = id | BCM_FIELD_QUALIFY_PRESEL) 
...
typedef enum bcm_field_fabric_header_e {
    ...
    bcmFieldFabricHeaderEthernetLearn = 6, /* regular Ethernet, stacking FTMH with
                                           DSP Extension and PPH fabric header */
    bcmFieldFabricHeaderCount = 7       /* Always Last. Not a usable value. */
...
typedef enum bcm_field_hint_type_e {
    ...
    bcmFieldHintTypeCount = 3           /* Always Last. Not a usable value. */
