...
#define _BCM_DPP_AM_NOF_GLOBAL_LIFS(_unit) (SOC_DPP_DEFS_GET(_unit, nof_global_lifs))

#define _BCM_DPP_AM_GLOBAL_LIF_NOF_ENTRIES_PER_BANK (4*1024)

#define _BCM_DPP_AM_NOF_GLOBAL_LIF_BANKS(_unit) (_BCM_DPP_AM_NOF_GLOBAL_LIFS(_unit) / _BCM_DPP_AM_GLOBAL_LIF_NOF_ENTRIES_PER_BANK)

#define _BCM_DPP_AM_MAX_GLOBAL_LIF_BANKS (SOC_DPP_DEFS_MAX(NOF_GLOBAL_LIFS) / _BCM_DPP_AM_GLOBAL_LIF_NOF_ENTRIES_PER_BANK)
...
#define _BCM_DPP_AM_GLOBAL_LIF_ID_IS_LEGAL(_unit, _global_lif_id)                                 \
        (((_global_lif_id) < _BCM_DPP_AM_NOF_GLOBAL_LIFS(_unit))                                       \
        && ((_global_lif_id) >= 0))
