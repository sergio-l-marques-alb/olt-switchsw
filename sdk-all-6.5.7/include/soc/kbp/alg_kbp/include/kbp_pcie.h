 ...
 *            handle pointer
 * @param dev_config Holds MDIO read/write callback function. To perform SAT/ESAT bus write/read
 * @return KBP_OK on success or an error code
 */

kbp_status kbp_pcie_reset(void *xpt, struct kbp_device_config *dev_config);
