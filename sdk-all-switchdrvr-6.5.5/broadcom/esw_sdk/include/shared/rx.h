...
typedef enum _shr_rx_decap_tunnel_e {
    ...
    _SHR_RX_DECAP_MPLS_1LABELCW   = 8, /* Decap MPLS 1 Label, Control
                                           Word present */
    _SHR_RX_DECAP_MPLS_2LABELCW   = 9, /* Decap MPLS 2 Label, Control
                                           Word present */
    _SHR_RX_DECAP_MPLS_1LABEL   = 10,  /* Decap MPLS 1 Label, no
                                           Control Word */
    _SHR_RX_DECAP_MPLS_2LABEL   = 11,  /* Decap MPLS 2 Label, no
                                           Control Word */
