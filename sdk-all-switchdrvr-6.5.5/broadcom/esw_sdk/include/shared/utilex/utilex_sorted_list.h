 ...
 * feature is enabled (See utilex_sorted_list_create()).
...
} UTILEX_SORTED_LIST_CMP_FUNC_TYPE;
 ...
 */
/* typedef struct UTILEX_SORTED_LIST_INFO_T*  UTILEX_SORTED_LIST_PTR_WORKAROUND; */
/*
...
typedef struct
{
  ...
  UTILEX_SORTED_LIST_CMP_FUNC_TYPE cmp_func_type;
...
/* } */
/*
 * This is an identifier of an element of type UTILEX_SORTED_LIST_INFO
 *
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_init(
  int unit,
  uint32 max_nof_lists);
/*********************************************************************
* NAME:
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_clear_all_tmps(
  int unit);
/*********************************************************************
* NAME:
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_create(
  int unit,
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_clear(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list);
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_destroy(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list);
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_entry_add(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
...
*    int                                  unit -
*     Identifier of the device to access.
*    UTILEX_SORTED_LIST_INFO        *sorted_list -
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_entry_update(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER iter,
  UTILEX_SORTED_LIST_KEY * const key,
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_entry_add_by_iter(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER pos,
  uint8 before,
...
/*********************************************************************
* NAME:
*     utilex_sorted_list_entry_remove
* TYPE:
*   PROC
* DATE:
*   May 19 2015
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_entry_remove_by_iter(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER iter);
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_entry_lookup(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_KEY * const key,
  UTILEX_SORTED_LIST_DATA * const data,
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_entry_value(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER iter,
  UTILEX_SORTED_LIST_KEY * const key,
...
*       use UTILEX_SORTED_LIST_ITER_BEGIN(list,iter)
*     - to check if the iterator get to the end of the table use.
*       use UTILEX_SORTED_LIST_ITER_END(list,iter)
* RETURNS:
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_next(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER * iter,
  UTILEX_SORTED_LIST_KEY * const key,
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_prev(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER * iter,
  UTILEX_SORTED_LIST_KEY * const key,
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_follow(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER * iter,
  uint8 forward,
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_size_for_save(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  uint32 * size);
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_save(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  uint8 * buffer,
  uint32 buffer_size_bytes,
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_load(
  int unit,
  uint8 ** buffer,
  UTILEX_SORTED_LIST_SW_DB_ENTRY_GET get_entry_fun,
  UTILEX_SORTED_LIST_SW_DB_ENTRY_SET set_entry_fun,
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_print(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
 ...
 */
uint32 utilex_print_indices(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list);
/*
 * Print specified sorted list.
 */
uint32 utilex_print_list(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list);
...
uint32 utilex_SAND_SORTED_LIST_INFO_clear(
  int unit,
  UTILEX_SORTED_LIST_PTR info);

uint32 utilex_SAND_SORTED_LIST_INFO_print(
  int unit,
  UTILEX_SORTED_LIST_PTR info);
/* } */
#endif
...
*     utilex_db_prio_list_priority_value_decode().
*   This procedure is only valid when 'indices' feature is enabled
*   on specified sorted list.
* RETURNS:
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_find_higher_eq_key(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_KEY * const key,
  UTILEX_SORTED_LIST_ITER * iter,
...
*   OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_find_lower_eq_key(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_KEY * const key,
  UTILEX_SORTED_LIST_ITER * iter,
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_num_elements(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  uint32 * num_elements);
/*********************************************************************
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_is_indices_enabled(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  uint8 * is_enabled);
/*********************************************************************
...
*     Only meaningful if the 'indices' feature is enabled ('indices'
*     element in UTILEX_SORTED_LIST_T is allocated). Note that this
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_iter_from_indices(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  uint32 index_in_indices,
  UTILEX_SORTED_LIST_ITER * iter);
...
*     OK or ERROR indication.
*********************************************************************/
uint32 utilex_sorted_list_get_index_from_iter(
  int unit,
  UTILEX_SORTED_LIST_PTR sorted_list,
  UTILEX_SORTED_LIST_ITER iter,
  uint32 * index_in_indices);
