...
typedef struct soc_dpp_config_pp_s {
  ...
  uint8   custom_feature_mpls_port_termination; /* If set Port termination is supported */
  SOC_PPC_LIF_ID custom_feature_mpls_port_termination_lif_id[3]; /* In-LIF-ID for termination of Port, 
...
#define SOC_DPP_CONFIG_CUSTOM_PP_PORT_IS_VENDOR2() (SOC_DPP_CONFIG(unit)->pp.custom_feature_pp_port == 2)
  ...
  uint8 l3_route_vrf_update_ipv4; /* This soc_property is used to enable the feaure of updating private FWD and RPF VRF for IPv4 programs.
                                   * Binary flag.
                                   */

  uint8 l3_route_vrf_update_ipv6; /* This soc_property is used to enable the feaure of updating private FWD and RPF VRF for IPv6 programs.
                                   * Binary flag.
                                   */
