...
typedef enum
{
    ...
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_LEM,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_KAPS,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_FWD_KBP,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_RPF_KBP,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_ROUTE_SCALE_LEM,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_ROUTE_SCALE_SHORT_KAPS,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_ROUTE_SCALE_LONG_KAPS,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_RPF_LEM,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV4UC_VRF_UPDATE_RPF_KAPS,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_ROUTE,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_RPF_KAPS,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_FWD_KBP,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_RPF_KBP,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_ROUTE_SCALE_SHORT_LEM,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_ROUTE_SCALE_LONG_LEM,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_ROUTE_SCALE_SHORT_KAPS,
    SOC_DPP_DBAL_SW_TABLE_ID_IPV6UC_VRF_UPDATE_ROUTE_SCALE_LONG_KAPS,
    ...
    SOC_DPP_DBAL_SW_TABLE_ID_MPLS_PORT_L2_L1IDX_SEM_A,
