...
#ifndef _T3P1_PPE_DIAGS_H
#define _T3P1_PPE_DIAGS_H
...
int soc_sbx_t3p1_ppe_table_shell_print(int unit, int eid, int argc, char **argv);



extern soc_sbx_t3p1_ppe_ptable_cfg_t soc_sbx_t3p1_ppe_ptable_cfg;
extern char soc_sbx_t3p1_ptable_get_usage[];
extern char soc_sbx_t3p1_ptable_set_usage[];
extern int soc_sbx_t3p1_ptable_shell_set(int unit, int argc, char **argv);
extern int soc_sbx_t3p1_ptable_shell_print(int unit, int argc, char **argv);

int soc_sbx_t3p1_ppe_shell_print(int unit, int argc, char **argv);

int soc_sbx_t3p1_ppe_shell_set(int unit, int argc, char **argv);

/** Diagnostic shell set operation usage message */
extern char soc_sbx_t3p1_ppe_set_usage[];
/** Diagnostic shell print operation usage message */
extern char soc_sbx_t3p1_ppe_get_usage[];
