...
int portmod_xphy_primary_core_num_set(int unit, uint32 xphy_addr, uint16 primary_core_num);
int portmod_xphy_primary_core_num_get(int unit, uint32 xphy_addr, uint16* primary_core_num);
...
portmod_port_line_to_sys_intf_map(const phymod_phy_access_t* line_phy_acc, const phymod_phy_access_t* sys_phy_acc,
                                  soc_port_t port, int data_rate, int ref_clk, const uint32 phy_init_flags,
