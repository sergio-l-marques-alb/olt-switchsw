...
typedef struct {
    ...
    int             nof_pmqs;
        ...
        int             nif_ilu_block[SOC_MAX_NUM_NIF_ILU_BLKS];
        int             nif_cdu_block[SOC_MAX_NUM_NIF_CDU_BLKS];
        int             nif_nmg_block[SOC_MAX_NUM_NIF_NMG_BLKS];
        ...
        int             eqm_block[SOC_MAX_NUM_EQM_BLKS];
        int             eps_spr_block[SOC_MAX_NUM_EPS_SPR_BLKS];
        int             fqp_block[SOC_MAX_NUM_FQP_BLKS];
        int             dha_block[SOC_MAX_NUM_DHA_BLKS];
        int             dhb_block[SOC_MAX_NUM_DHB_BLKS];
        int             mdb_block;
...
#ifdef CRASH_RECOVERY_SUPPORT
#define SOC_CR_ENABALED(unit) (SOC_UNIT_NUM_VALID(unit) && SOC_IS_JERICHO(unit) && (SOC_CONTROL(unit))->crash_recovery && SOC_IS_DONE_INIT(unit))
