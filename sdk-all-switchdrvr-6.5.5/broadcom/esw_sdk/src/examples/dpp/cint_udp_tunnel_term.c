/*
 * $Id: cint_vlan_egress_membership.c$
...
int udp_tunnel_term_init_tunnel_terminators(int unit)
{
    ...
    udp_tunnel_term_init_tunnel_terminator(unit, g_udp_tunnel_term.udp_tunnel_ipv4_dst_port_1);
    if (rv != BCM_E_NONE) {
    ...
    udp_tunnel_term_init_tunnel_terminator(unit, g_udp_tunnel_term.udp_tunnel_ipv4_dst_port_2);
    if (rv != BCM_E_NONE) {
        printf("Error, udp_tunnel_term_init_tunnel_terminator\n");
        return rv;
    }
    ...
    udp_tunnel_term_init_tunnel_terminator(unit, g_udp_tunnel_term.udp_tunnel_ipv6_dst_port_1);
    if (rv != BCM_E_NONE) {
        printf("Error, udp_tunnel_term_init_tunnel_terminator\n");
        return rv;
    }
    ...
    udp_tunnel_term_init_tunnel_terminator(unit, g_udp_tunnel_term.udp_tunnel_ipv6_dst_port_2);
    if (rv != BCM_E_NONE) {
        printf("Error, udp_tunnel_term_init_tunnel_terminator\n");
        return rv;
    }
    ...
    udp_tunnel_term_init_tunnel_terminator(unit, g_udp_tunnel_term.udp_tunnel_mpls_dst_port_1);
    if (rv != BCM_E_NONE) {
        printf("Error, udp_tunnel_term_init_tunnel_terminator\n");
        return rv;
    }
    ...
    udp_tunnel_term_init_tunnel_terminator(unit, g_udp_tunnel_term.udp_tunnel_mpls_dst_port_2);
    if (rv != BCM_E_NONE) {
        printf("Error, udp_tunnel_term_init_tunnel_terminator\n");
        return rv;
    }
