...
CINT_FWRAPPER_CREATE_RP4(int, int, 0, 0,
                         ...
                         int, int, unit, 0, 0,
                         int, int, core, 0, 0,
                         match_t*, match_t, match, 1, 0,
                         signal_output_t*, signal_output_t, signal_output, 1, 0);
...
static cint_function_t __cint_functions[] = {
        CINT_FWRAPPER_ENTRY(dpp_dsig_get),
...
static cint_parameter_desc_t __cint_struct_members__signal_output[] = {
        ...
        { "int",            "size",         0, 0 },
        { "uint32",         "value",        0, MAX_DEBUG_SIGNAL_INT_SIZE},
        { "char",           "print_value",  0, MAX_DEBUG_SIGNAL_SIZE * 2 + 8},
