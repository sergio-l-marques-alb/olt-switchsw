...
*****************************************************/
shr_error_e dbal_encode_type_string_to_id(
  int unit,
  char *str,
...
*    mem_encode_type_id -
*****************************************************/
shr_error_e dbal_mem_encode_type_string_to_id(
  int unit,
  char *str,
  dbal_value_encode_types_e * mem_encode_type_id);
/*! ****************************************************
* \brief
...
*    None
*****************************************************/
char *dbal_encode_type_to_string(
  int unit,
  dbal_value_encode_types_e encode_type_id);
/*! ****************************************************
* \brief
...
/*! ****************************************************
* \brief
* translate key mode ID to string. In case of unknown id, a default unknown string will be returned
*
*  \par DIRECT INPUT:
*    \param [in] unit
*    \param [in] key_mode_id - \n
*      ID to translate
*  \par INDIRECT INPUT:
*    None
*  \par DIRECT OUTPUT:
...
*    None
*****************************************************/
char *dbal_key_mode_to_string(
  int unit,
  dbal_field_key_mode_e key_mode_id);
/*! ****************************************************
* \brief
* translate access type ID to string. In case of unknown id, a default unknown string will be returned
*
*  \par DIRECT INPUT:
*    \param [in] unit
*    \param [in] access_type_id - \n
*      ID to translate
*  \par INDIRECT INPUT:
*    None
*  \par DIRECT OUTPUT:
...
*    None
*****************************************************/
char *dbal_access_type_to_string(
  int unit,
