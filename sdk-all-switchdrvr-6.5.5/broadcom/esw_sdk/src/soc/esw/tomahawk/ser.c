...
extern _soc_mem_ser_en_info_t _soc_bcm56965_a0_ip_mem_ser_info[];
extern _soc_reg_ser_en_info_t _soc_bcm56965_a0_ip_reg_ser_info[];
extern _soc_mem_ser_en_info_t _soc_bcm56965_a0_ep_mem_ser_info[];
extern _soc_reg_ser_en_info_t _soc_bcm56965_a0_ep_reg_ser_info[];
extern _soc_mem_ser_en_info_t _soc_bcm56965_a0_mmu_mem_ser_info[];
#endif

_soc_mem_ser_en_info_t *_soc_generic_ip_mem_ser_info;
_soc_mem_ser_en_info_t *_soc_generic_ep_mem_ser_info;
_soc_mem_ser_en_info_t *_soc_generic_mmu_mem_ser_info;
...
void soc_th_ser_init_data_structure(int unit)
{
    int ix;
    int array_size;

    array_size = sizeof(_soc_th_ser_block_info)/sizeof(_soc_th_ser_block_info_t);

    /* Point to correct data structure based on chip type */
#if defined(BCM_56960_A0)
    if (SOC_IS_TOMAHAWK(unit) && !SOC_IS_TOMAHAWKPLUS(unit)) {
        for (ix=0; ix < array_size; ix++) {
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "IPIPE mems") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56960_a0_ip_mem_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "IPIPE regs")== 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56960_a0_ip_reg_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name,"EPIPE mems") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56960_a0_ep_mem_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "EPIPE regs") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56960_a0_ep_reg_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "MMU mems") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56960_a0_mmu_mem_ser_info;
            }
        }
        _soc_generic_ip_mem_ser_info = (_soc_mem_ser_en_info_t *)
                                       &_soc_bcm56960_a0_ip_mem_ser_info;
        _soc_generic_ep_mem_ser_info = (_soc_mem_ser_en_info_t *)
                                       &_soc_bcm56960_a0_ep_mem_ser_info;
        _soc_generic_mmu_mem_ser_info = (_soc_mem_ser_en_info_t *)
    ...
    if (SOC_IS_TOMAHAWKPLUS(unit)) {
        for (ix=0; ix < array_size; ix++) {
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "IPIPE mems") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56965_a0_ip_mem_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "IPIPE regs")== 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56965_a0_ip_reg_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name,"EPIPE mems") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56965_a0_ep_mem_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "EPIPE regs") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56965_a0_ep_reg_ser_info;
            }
            if (sal_strcmp(_soc_th_ser_block_info[ix].name, "MMU mems") == 0) {
                _soc_th_ser_block_info[ix].info = &_soc_bcm56965_a0_mmu_mem_ser_info;
            }
        }
        _soc_generic_ip_mem_ser_info = (_soc_mem_ser_en_info_t *)
                                       &_soc_bcm56965_a0_ip_mem_ser_info;
        _soc_generic_ep_mem_ser_info = (_soc_mem_ser_en_info_t *)
                                       &_soc_bcm56965_a0_ep_mem_ser_info;
        _soc_generic_mmu_mem_ser_info = (_soc_mem_ser_en_info_t *)
                                       &_soc_bcm56965_a0_mmu_mem_ser_info;
    }
#endif
}
                              ...
                              char *prefix_str, int l2_mgmt_ser_fifo)
{
    ...
    case SOC_BLK_IPIPE:
        ...
        ser_info_table = _soc_generic_ip_mem_ser_info;
    ...
    case SOC_BLK_EPIPE:
        ...
        ser_info_table = _soc_generic_ep_mem_ser_info;
        break;
...
soc_tomahawk_tcam_ser_init(int unit)
{
    ...
    /* Based on chip type, init control data info */
    soc_th_ser_init_data_structure(unit);
...
{
    int i, j;
    _soc_mem_ser_en_info_t *ser_info_table[4];

    ser_info_table[0] = _soc_generic_ip_mem_ser_info;
    ser_info_table[1] = _soc_generic_ep_mem_ser_info;
    ser_info_table[2] = _soc_generic_mmu_mem_ser_info;
    ser_info_table[3] = NULL;
...
int soc_th_ser_single_bit_error_enable_set(int unit, int enable)
{
    ...
    if (SOC_IS_TOMAHAWKPLUS(unit)) {
#if defined(BCM_56965_A0)
        mem_ser_info_all[0] = _soc_bcm56965_a0_ip_mem_ser_info;
        mem_ser_info_all[1] = _soc_bcm56965_a0_ep_mem_ser_info;
        mem_ser_info_all[2] = _soc_bcm56965_a0_mmu_mem_ser_info;
#endif
    } else {
#if defined(BCM_56960_A0)
        mem_ser_info_all[0] = _soc_bcm56960_a0_ip_mem_ser_info;
        mem_ser_info_all[1] = _soc_bcm56960_a0_ep_mem_ser_info;
        mem_ser_info_all[2] = _soc_bcm56960_a0_mmu_mem_ser_info;
#endif
    }
...
int soc_th_ser_single_bit_error_enable_get(int unit, int *enable)
{
    ...
    if (SOC_IS_TOMAHAWKPLUS(unit)) {
#if defined(BCM_56965_A0)
        mem_ser_info = _soc_bcm56965_a0_mmu_mem_ser_info;
#endif
    } else {
#if defined(BCM_56960_A0)
        mem_ser_info = _soc_bcm56960_a0_mmu_mem_ser_info;
#endif
    }
...
soc_th_ser_hardware_test(int unit, _soc_ser_test_t test_type) {
    ...
    _soc_mem_ser_en_info_t *fifo_parity = NULL;
    _soc_reg_ser_en_info_t *reg_parity_info = NULL;
    ser_reg_test_data_t reg_test_data;
    int reg_failed = 0, reg_tests = 0;
    int i, j;
    ...
    for (i = 0; _soc_th_ser_block_info[i].blocktype != 0; i++) {
        /* for register test*/
        if ((_soc_th_ser_block_info[i].type == _SOC_TH_SER_TYPE_REG) &&
            ((_soc_th_ser_block_info[i].blocktype == SOC_BLK_IPIPE) ||
             (_soc_th_ser_block_info[i].blocktype == SOC_BLK_EPIPE) )) {

            reg_parity_info = _soc_th_ser_block_info[i].info;

            for (j = 0; reg_parity_info[j].reg != INVALIDr; j++) {
                if (!SOC_REG_IS_VALID(unit, reg_parity_info[j].en_reg)) {
                   LOG_WARN(BSL_LS_SOC_SER,
                            (BSL_META_U(unit,
                              "unit %d, reg %s is INVALID or not valid "
                              "or parity is disabled for this register !!\n"),
                              unit, SOC_REG_NAME(unit, reg_parity_info[j].reg)));
                   continue;
                }

                /* create data for reg */
                soc_ser_create_reg_test_data(unit, tmp_entry, field_data,
                                             reg_parity_info[j].en_reg,
                                             reg_parity_info[j].en_fld,
                                             reg_parity_info[j].reg,
                                             INVALIDf,
                                             REG_PORT_ANY, 0,
                                             &reg_test_data);

                /* test reg*/
                if (ser_test_reg(unit, &reg_test_data, &reg_failed) < 0) {
                    LOG_VERBOSE(BSL_LS_SOC_SER,
                                (BSL_META_U(unit,
                                 "Reg %s test failed.\n"),
                                 SOC_REG_NAME(unit,reg_parity_info[j].reg)));
                }
                reg_tests ++;
            }
        }
    ...
    LOG_CLI((BSL_META_U(unit, "\nH/W registers tested on unit %d: %d\n"),
             unit, reg_tests));
    LOG_CLI((BSL_META_U(unit, "H/W registers tests passed:\t%d\n"),
             reg_tests - reg_failed));
    LOG_CLI((BSL_META_U(unit, "H/W register tests failed:\t%d\n\n"), reg_failed));

    (void) _soc_th_refresh_modify(unit, 1); /* re-enable refresh */
    return (mem_failed + reg_failed);
}
