...
{
    int                     rv;
    int                     jer_ingress_field_list_size; 
    int                     jer_plus_ingress_field_list_size; 
    int                     qax_ingress_field_list_size; 
    int                     jer_egress_field_list_size; 
    int                     jer_plus_egress_field_list_size; 
    int                     qax_egress_field_list_size;
    int                     field_index;
    ...
    soc_field_t jer_ingress_field_list[] = {BLOCKS_SOFT_INIT_1f,  BLOCKS_SOFT_INIT_2f,  BLOCKS_SOFT_INIT_3f,  BLOCKS_SOFT_INIT_4f,  BLOCKS_SOFT_INIT_5f,  BLOCKS_SOFT_INIT_6f,  BLOCKS_SOFT_INIT_8f,  BLOCKS_SOFT_INIT_9f, 
    ...
    soc_field_t jer_plus_ingress_field_list[] = {BLOCKS_SOFT_INIT_1f,  BLOCKS_SOFT_INIT_2f,  BLOCKS_SOFT_INIT_3f,  BLOCKS_SOFT_INIT_4f,  BLOCKS_SOFT_INIT_5f,  BLOCKS_SOFT_INIT_6f,  BLOCKS_SOFT_INIT_8f,  BLOCKS_SOFT_INIT_9f, 
                                                 BLOCKS_SOFT_INIT_10f, BLOCKS_SOFT_INIT_19f, BLOCKS_SOFT_INIT_20f, BLOCKS_SOFT_INIT_22f, BLOCKS_SOFT_INIT_23f, BLOCKS_SOFT_INIT_24f, BLOCKS_SOFT_INIT_25f, BLOCKS_SOFT_INIT_26f, 
    ...
    soc_field_t qax_ingress_field_list[] = {BLOCKS_SOFT_INIT_23f,  BLOCKS_SOFT_INIT_1f,   BLOCKS_SOFT_INIT_2f,   BLOCKS_SOFT_INIT_9f,  BLOCKS_SOFT_INIT_22f, BLOCKS_SOFT_INIT_24f,  BLOCKS_SOFT_INIT_25f,  BLOCKS_SOFT_INIT_55f, 
    ...
    soc_field_t jer_egress_field_list[] = { BLOCKS_SOFT_INIT_33f, BLOCKS_SOFT_INIT_104f, BLOCKS_SOFT_INIT_105f, BLOCKS_SOFT_INIT_106f, BLOCKS_SOFT_INIT_50f, BLOCKS_SOFT_INIT_51f, 
                                            BLOCKS_SOFT_INIT_55f, BLOCKS_SOFT_INIT_56f,  BLOCKS_SOFT_INIT_57f};
    soc_field_t jer_plus_egress_field_list[] = {BLOCKS_SOFT_INIT_33f, BLOCKS_SOFT_INIT_111f, BLOCKS_SOFT_INIT_112f, BLOCKS_SOFT_INIT_113f, BLOCKS_SOFT_INIT_54f, BLOCKS_SOFT_INIT_55f, 
                                                BLOCKS_SOFT_INIT_59f, BLOCKS_SOFT_INIT_60f,  BLOCKS_SOFT_INIT_61f};
    soc_field_t qax_egress_field_list[] = { BLOCKS_SOFT_INIT_33f, BLOCKS_SOFT_INIT_97f, BLOCKS_SOFT_INIT_98f, BLOCKS_SOFT_INIT_99f, BLOCKS_SOFT_INIT_20f, BLOCKS_SOFT_INIT_55f, 
                                            BLOCKS_SOFT_INIT_56f, BLOCKS_SOFT_INIT_57f, BLOCKS_SOFT_INIT_53f};


    SOCDNX_INIT_FUNC_DEFS;

    jer_ingress_field_list_size         = sizeof(jer_ingress_field_list)        / sizeof(jer_ingress_field_list[0]);
    jer_plus_ingress_field_list_size    = sizeof(jer_plus_ingress_field_list)   / sizeof(jer_plus_ingress_field_list[0]);
    qax_ingress_field_list_size         = sizeof(qax_ingress_field_list)        / sizeof(qax_ingress_field_list[0]);
    jer_egress_field_list_size          = sizeof(jer_egress_field_list)         / sizeof(jer_egress_field_list[0]);
    jer_plus_egress_field_list_size     = sizeof(jer_plus_egress_field_list)    / sizeof(jer_plus_egress_field_list[0]);
    qax_egress_field_list_size          = sizeof(qax_egress_field_list)         / sizeof(qax_egress_field_list[0]);

    if (SOC_IS_JERICHO_PLUS(unit)) 
    {
        ingress_field_list      = jer_plus_ingress_field_list;
        ingress_field_list_size = jer_plus_ingress_field_list_size;
        egress_field_list       = jer_plus_egress_field_list;
        egress_field_list_size  = jer_plus_egress_field_list_size;
    } 
    else if (SOC_IS_QAX(unit)) 
    {
        ingress_field_list      = qax_ingress_field_list;
        ingress_field_list_size = qax_ingress_field_list_size;
        egress_field_list       = qax_egress_field_list;
        egress_field_list_size  = qax_egress_field_list_size;
    } 
    else 
    {
        ingress_field_list      = jer_ingress_field_list;
        ingress_field_list_size = jer_ingress_field_list_size;
        egress_field_list       = jer_egress_field_list;
        egress_field_list_size  = jer_egress_field_list_size;
    }
