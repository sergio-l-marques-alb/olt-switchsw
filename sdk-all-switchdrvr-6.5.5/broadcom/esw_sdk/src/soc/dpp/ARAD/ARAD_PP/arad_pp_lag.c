  ...
  Arad_pp_lb_hash_map_table[] =
{
  ...
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_MPLS3_ETH,1), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_MPLSX5_LABEL4,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  ...
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS1_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV4,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX1,        ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS2_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV4,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX2_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS3_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV4,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},

  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS1_ETH,1), ARAD_PP_LB_VECTOR_INDEX_L4, ARAD_PP_LB_VECTOR_INDEX_IPV4,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX1,        ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS2_ETH,1), ARAD_PP_LB_VECTOR_INDEX_L4, ARAD_PP_LB_VECTOR_INDEX_IPV4,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX2_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV4_MPLS3_ETH,1), ARAD_PP_LB_VECTOR_INDEX_L4, ARAD_PP_LB_VECTOR_INDEX_IPV4,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},

  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV6,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX1,        ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV6,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX2_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH,0), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV6,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH,1), ARAD_PP_LB_VECTOR_INDEX_L4, ARAD_PP_LB_VECTOR_INDEX_IPV6,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX1,        ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH,1), ARAD_PP_LB_VECTOR_INDEX_L4, ARAD_PP_LB_VECTOR_INDEX_IPV6,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX2_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH,1), ARAD_PP_LB_VECTOR_INDEX_L4, ARAD_PP_LB_VECTOR_INDEX_IPV6,   ARAD_PP_LB_VECTOR_INDEX_CALC,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
...
CONST STATIC ARAD_PP_LB_HASH_MAP
  Arad_pp_lb_hash_map_table_speculative_l4_support[] =
{
  ...
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS1_ETH,1), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_L4,   ARAD_PP_LB_VECTOR_INDEX_IPV6,     ARAD_PP_LB_VECTOR_INDEX_MPLSX1,        ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS2_ETH,1), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_L4,   ARAD_PP_LB_VECTOR_INDEX_IPV6,     ARAD_PP_LB_VECTOR_INDEX_MPLSX2_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_LB_PFC_OFFSET(ARAD_PARSER_PKT_HDR_STK_TYPE_IPV6_MPLS3_ETH,1), ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_L4,   ARAD_PP_LB_VECTOR_INDEX_IPV6,     ARAD_PP_LB_VECTOR_INDEX_MPLSX3_LABEL1, ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  ...
  )
{
  ...
  if (soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "speculative_L4_support", 0)) {
      res = arad_pp_lag_set_pfc_profile_tbl(unit, sizeof(Arad_pp_lb_hash_map_table_speculative_l4_support) / sizeof(ARAD_PP_LB_HASH_MAP), Arad_pp_lb_hash_map_table_speculative_l4_support);
  ...
  SHR_BITSET(&plc_profile_bitmap, ARAD_PMF_PGM_SEL_PARSER_PROFILE_MPLS_5);
  SHR_BITSET(&plc_profile_bitmap, ARAD_PMF_PGM_SEL_PARSER_PROFILE_FCOE_VFT);
  SHR_BITSET(&plc_profile_bitmap, ARAD_PMF_PGM_SEL_PARSER_PROFILE_GAL_GACH_BFD);
  SHR_BITSET(&plc_profile_bitmap, ARAD_PMF_PGM_SEL_PARSER_PROFILE_PP_L4);
  if (((SOC_DPP_CONFIG(unit)->pp.bfd_ipv4_single_hop) || (SOC_DPP_CONFIG(unit)->pp.bfd_ipv6_enable == SOC_DPP_ARAD_BFD_IPV6_SUPPORT_WITH_LEM)) ){
      SHR_BITSET(&plc_profile_bitmap, ARAD_PMF_PGM_SEL_PARSER_PROFILE_BFD_SINGLE_HOP);
  }
...
uint8
  arad_pp_lag_is_symetric(
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  uint32                      lag_ndx,
    SOC_SAND_IN SOC_PPC_LAG_INFO           *in_lag_info,
    SOC_SAND_IN SOC_PPC_LAG_INFO           *out_lag_info
  )
{
  uint32
    indx,
...
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in SOC_PPC_LAG_INFO_verify()",0,0);
}
  ...
  )
{
    ...
    for(core_id = 0; core_id < cores_num ; core_id++)
    {
        ...
        if(ecmp_valid ) {
            ...
            bcm_petra_l3_egress_get(unit,resolution_fec,&egr);
