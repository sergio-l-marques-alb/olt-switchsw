/*
 * $Id: ilkn_drv.c,v 1.16 Broadcom SDK $
 *
 ...
 *      soc_ilkn_drv_reset
 * Purpose:
 *      put ilkn drv in reset
 * Parameters:
 *      unit     - (IN) Unit number.
 *      ilkn_id  - (IN) ILKN id.
 *      enable   - is port enabled
 * Returns:
 *      SOC_E_xxx
 */
STATIC soc_error_t 
...
soc_ilkn_drv_init(int unit, soc_port_t port)
{
    ...
    /*set fragmentation mode: set ILKN ports as segmented*/
    no_frag = 0;
...
/*
 * Function:
 *      soc_ilkn_drv_num_of_lanes_set
 * Purpose:
 *      Set the number of lanes without reinitialize the port
 * Parameters:
 *      unit - unit number.
 *      port - Port number.
 *      num_of_lanes - the number of lanes to set
 * Comments: 
 *      This feature is supported for ilkn with num of lanes < 12
 *      You con't increase the number over the init number of lanes.
 * Returns:
 *      SOC_E_XXX
 */
soc_error_t
 ...
 * Purpose:
 *      Set ILKN in the specified speed.
 * Parameters:
 *      unit - unit number.
 *      port - port number.
 *      speed - speed to set
 ...
 * Purpose:
 *      Set a ILKN into/out-of loopback mode
 * Parameters:
 *      unit - unit number.
 *      port - port number.
 ...
 * Purpose:
 *      Get current ILKN loopback mode setting.
 * Parameters:
 *      unit - unit number.
 *      port - port number.
...
/*
 * Function:
 *      soc_ilkn_link_status_clear
 * Purpose:
 *      Clear current ILKN link latch status.
 * Parameters:
 *      unit - unit number.
 *      port - port number.
 * Returns:
...
CONST mac_driver_t soc_ilkn_driver = {
    "DPP ILKN Driver",              /* drv_name */
    soc_ilkn_drv_init,              /* md_init  */
    soc_ilkn_drv_enable_set,        /* md_enable_set */
    NULL,                           /* md_enable_get */
    NULL,                           /* md_duplex_set */
    NULL,                           /* md_duplex_get */
    soc_ilkn_drv_speed_set,         /* md_speed_set */
    NULL,                           /* md_speed_get */
    NULL,                           /* md_pause_set */
    NULL,                           /* md_pause_get */
    NULL,                           /* md_pause_addr_set */
    NULL,                           /* md_pause_addr_get */
    soc_ilkn_drv_loopback_set,      /* md_lb_set */
    soc_ilkn_drv_loopback_get,      /* md_lb_get */
