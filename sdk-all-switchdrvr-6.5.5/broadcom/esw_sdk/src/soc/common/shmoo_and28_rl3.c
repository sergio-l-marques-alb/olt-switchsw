...
/* BEGIN: TEMPORARY */
#ifndef CONFIG_SPIDER2
#define CONFIG_SPIDER2
#endif

#if defined(CONFIG_SPIDER2)
#define CHIP_IS_SPIDER2             TRUE
#else
#define CHIP_IS_SPIDER2             FALSE
#endif

#ifndef BCM_AND28_RL3_SUPPORT
#define BCM_AND28_RL3_SUPPORT
#endif
/* END: TEMPORARY */
