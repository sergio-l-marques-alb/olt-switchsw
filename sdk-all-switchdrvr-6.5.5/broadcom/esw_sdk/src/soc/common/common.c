...
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_CALADAN3_SUPPORT)|| defined(BCM_DPP_SUPPORT)|| defined(BCM_DFE_SUPPORT) || defined(PORTMOD_SUPPORT)
int
...
#if defined(BCM_CALADAN3_SUPPORT) || defined(BCM_DPP_SUPPORT)|| defined(BCM_DFE_SUPPORT) || defined(BCM_DNX_SUPPORT)
...
#if defined(BCM_DPP_SUPPORT) || defined(BCM_DFE_SUPPORT) || defined(BCM_DNX_SUPPORT)
    if (SOC_IS_SAND(unit)) {
...
#endif /* defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_CALADAN3_SUPPORT)|| defined(BCM_DPP_SUPPORT)|| defined(BCM_DFE_SUPPORT) || defined(PORTMOD_SUPPORT)*/
