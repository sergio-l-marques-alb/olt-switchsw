                ...
                uint64 *data0, uint64 *data1)
{
    ...
    soc_ARLA_MACr_field_set(unit, (void *)&reg_val64,
        MAC_ADDR_INDXf, (void *)&mac_field);

    rv = REG_WRITE_ARLA_MACr(unit, (void *)&reg_val64);
    if (SOC_FAILURE(rv)) {
        MEM_UNLOCK(unit, INDEX(MAC2VLANm));
        return rv;
    }
                ...
                mac2vlan_entry_t *mv_entry, uint32 *index)
{
    ...
    SOC_IF_ERROR_RETURN(_drv_harrier_mem_macvlan_locate(
                    unit, ent_mac_addr, (void *)&mv_entry0, 
                    (void *)&mv_entry1));
    ...
    if (loc_valid){
        SOC_IF_ERROR_RETURN(DRV_MEM_FIELD_GET
                        (unit, DRV_MEM_MACVLAN, DRV_MEM_FIELD_MAC,
                        (uint32 *)&mv_entry1, (void *)&mac_field));
        SAL_MAC_ADDR_FROM_UINT64(loc_mac_addr, mac_field);
        if (!SAL_MAC_ADDR_CMP(loc_mac_addr, ent_mac_addr)){
            mv_entry = &mv_entry1;
            *index = HARRIER_MACVLAN_BIN1;
...
_drv_harrier_mem_macvlan_write(int unit, uint32 *entry, uint32 flags)
{
    ...
    _drv_harrier_mem_macvlan_locate(unit, ent_mac_addr, 
                (void *)&mv_entry0, (void *)&mv_entry1);
    
    /* get MAC 0/1 */
    SOC_IF_ERROR_RETURN(DRV_MEM_FIELD_GET
                (unit, DRV_MEM_MACVLAN, DRV_MEM_FIELD_MAC,
                (uint32 *)&mv_entry0, (void *)&mac_field));
...
mem_search_valid_start:
        ...
        for (count = 0; count < SOC_TIMEOUT_VAL; count++) {
            ...
            REG_READ_ARLA_SRCH_RSLTr(unit,(void *)&entry0);
                    
            if (flags & DRV_MEM_OP_SEARCH_PORT) {
                soc_ARLA_SRCH_RSLTr_field_get(unit, (void *)&entry0,
            ...
            /* MAC Address */
            soc_ARLA_SRCH_RSLTr_field_get(unit, (void *)&entry0,
                ARLA_SRCH_RSLT_ADDRf, (void *)&temp_mac_field);
            if ((rv = DRV_MEM_FIELD_SET(unit, 
                    DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
                    entry, (void *)&temp_mac_field)) < 0){
                goto mem_search_valid_get;
            }
...
mem_search_valid_get:
    ...
    /* delete by MAC */    
        ...
        if ((rv = DRV_MEM_FIELD_GET(unit, 
                DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
                key, (void *)&rw_mac_field)) < 0) {
            goto mem_search_exit;
        }
        SAL_MAC_ADDR_FROM_UINT64(mac_addr_rw, rw_mac_field);
        if ((rv = REG_WRITE_ARLA_MACr(unit, (void *)&rw_mac_field)) < 0) {
            goto mem_search_exit;
        }
        ...
        if ((rv = REG_READ_ARLA_ENTRY_0r(unit, (void *)&entry0)) < 0) {
            goto mem_search_exit;
        }

        if ((rv = REG_READ_ARLA_ENTRY_1r(unit, (void *)&entry1)) < 0) {
            goto mem_search_exit;
        }
        ...
        if (flags & DRV_MEM_OP_REPLACE) {
            ...
            soc_ARLA_ENTRY_0r_field_get(unit, (void *)&entry0,
            ...
            soc_ARLA_ENTRY_1r_field_get(unit, (void *)&entry1,
            ...
            if (temp_valid1) {
                ...
                /* get mac_addr */
                soc_ARLA_ENTRY_0r_field_get(unit, (void *)&entry0,
                    ARL_MACADDRf, (void *)&temp_mac_field);
                SAL_MAC_ADDR_FROM_UINT64(temp_mac_addr, temp_mac_field);
        ...
        for (i = 0; i < ROBO_HARRIER_L2_BUCKET_SIZE; i++){
            ...
            *index = i;
            ...
            if (temp_mac_addr[0] & 0x01) { /* The input is the mcast address */
                if ((rv = DRV_MEM_FIELD_SET(unit, 
                        DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
                        (uint32 *)rep_entry, (void *)&temp_mac_field)) < 0){
                    goto mem_search_exit;
                }
                value = 0;
                soc_ARLA_ENTRY_0r_field_get(unit, (uint32 *)input,
...
_drv_harrier_mem_arl_entry_delete(int unit, uint8 *mac_addr, uint32 vid, int index)
{
    ...
    /* write MAC Addr */
    if ((rv = REG_READ_ARLA_MACr(unit, (void *)&reg_val64)) < 0) {
    ...
    if ((rv = REG_WRITE_ARLA_MACr(unit, (void *)&reg_val64)) < 0) {
        goto marl_entry_delete_exit;
    }
    ...
    if (index == 0) {
        ...
        /* Clear entire entry */
        COMPILER_64_ZERO(reg_val64);
        if ((rv = REG_WRITE_ARLA_ENTRY_0r(unit, (void *)&reg_val64)) < 0) {
            goto marl_entry_delete_exit;
        }
        ...
        /* Clear entire entry */
        COMPILER_64_ZERO(reg_val64);
        if ((rv = REG_WRITE_ARLA_ENTRY_1r(unit, (void *)&reg_val64)) < 0) {
            goto marl_entry_delete_exit;
        }
...
drv_harrier_mem_insert(int unit, uint32 mem, uint32 *entry, uint32 flags)
{
    ...
    if (rv == SOC_E_EXISTS) {
        ...
        if (!sal_memcmp(&output, entry, 
            ...
            if ((rv = DRV_MEM_FIELD_GET(unit, 
                    DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
                    (uint32 *)&output, (void *)&mac_field_output)) < 0) {
                goto mem_insert_exit;
            }
            if ((rv = DRV_MEM_FIELD_GET(unit, 
                    DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
                    entry, (void *)&mac_field_entry)) < 0) {
                goto mem_insert_exit;
            }
    ...
    if ((rv = DRV_MEM_FIELD_GET(unit, DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
            entry, (void *)&mac_field)) < 0) {
        goto mem_insert_exit;
    }
    SAL_MAC_ADDR_FROM_UINT64(mac_addr, mac_field);
    
    soc_ARLA_ENTRY_0r_field_set(unit, (void *)&entry_reg,
        ARL_MACADDRf, (void *)&mac_field);
    ...
    if (index == 0){ /* entry 0 */
        ...
        if ((rv = REG_WRITE_ARLA_ENTRY_0r(unit, (void *)&entry_reg)) < 0) {
            goto mem_insert_exit;
        }
    } else { /* entry 1 */
        ...
        if ((rv = REG_WRITE_ARLA_ENTRY_1r(unit, (void *)&entry_reg)) < 0) {
            goto mem_insert_exit;
        }
    }
        ...
        if (rv == SOC_E_EXISTS) {
            if (index == 0) {
                ...
                if ((rv = REG_READ_ARLA_ENTRY_0r(
                    unit, (void *)&entry_reg)) < 0) {
                    goto mem_delete_exit;
                }
                /* check static bit if set */
                if (!ag_static_mode){
                    soc_ARLA_ENTRY_0r_field_get(unit, (void *)&entry_reg,
                        ARL_STATICf, &temp);
                    if (temp) {
                        LOG_INFO(BSL_LS_SOC_MEM,
                                 (BSL_META_U(unit,
                ...
                /* check static bit if set */
                if (!ag_static_mode){
                    soc_ARLA_ENTRY_1r_field_get(unit, (void *)&entry_reg,
                        ARL_STATICf, &temp);
                    if (temp) {
                        LOG_INFO(BSL_LS_SOC_MEM,
                                 (BSL_META_U(unit,
            ...
            if ((rv = DRV_MEM_FIELD_GET(unit, DRV_MEM_ARL, DRV_MEM_FIELD_MAC, 
                    (uint32 *)&output, (void *)&temp_mac_field)) < 0) {
                goto mem_delete_exit;
            }
