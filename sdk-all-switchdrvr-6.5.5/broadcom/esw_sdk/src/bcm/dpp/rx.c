...
int bcm_petra_rx_mtu_set(int unit,bcm_rx_mtu_config_t *config)
{
    ...
    if (SOC_IS_JERICHO_PLUS(unit) && (config->flags & BCM_RX_MTU_RIF)) 
    {
        BCMDNX_ERR_EXIT_MSG(BCM_E_UNAVAIL, (_BSL_BCM_MSG("API unavailable on Jericho Plus / QAX"))); 
    }
