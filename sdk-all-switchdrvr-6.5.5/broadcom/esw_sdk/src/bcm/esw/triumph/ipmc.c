...
#endif
        {
            mod = SOC_MEM_FIELD32_VALUE_MAX(unit, L3_IPMCm, MODULE_IDf);
        }
        ...
        bcm_ipmc_addr_t *ipmc, int *match)
{
    ...
    if (SOC_MEM_IS_VALID(unit, L3_IPMC_1m)) {
        ...
        modid_max = SOC_MEM_FIELD32_VALUE_MAX(unit, L3_IPMC_1m, MODULE_IDf);
    } else {
        ...
        modid_max = SOC_MEM_FIELD32_VALUE_MAX(unit, L3_IPMCm, MODULE_IDf);
    }
