/**************************************************************************************
**************************************************************************************
*  File Name     :  phy8806x_tsc_field_access.h                                        *
*  Created On    :  29/04/2013                                                       *
*  Created By    :  Kiran Divakar                                                    *
*  Description   :  Serdes IP Register and Field access APIs                         *
*  Revision      :  $Id: phy8806x_tsc_field_access.h 925 2015-02-24 23:23:58Z kirand $ *
*                                                                                    *
...
/** @file phy8806x_tsc_field_access.h
 * Registers and field access
 */

#ifndef PHY8806X_TSC_API_FIELD_ACCESS_H
#define PHY8806X_TSC_API_FIELD_ACCESS_H
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _phy8806x_tsc_pmd_rdt_field_byte (const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _phy8806x_tsc_pmd_rdt_field_signed_byte (const phymod_access_t *pa, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
